...
import com.azure.resourcemanager.windfall.fluent.models.OperationInner;
import com.azure.resourcemanager.windfall.models.OperationListResult;
...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    OperationsClientImpl(MicrosoftWindfallImpl client) {
        this.service =
    ...
    /**
     * The interface defining all the services for MicrosoftWindfallOperations to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "MicrosoftWindfallOpe")
    private interface OperationsService {
        @Headers({"Content-Type: application/json"})
        @Get("/providers/Microsoft.Windfall/operations")
