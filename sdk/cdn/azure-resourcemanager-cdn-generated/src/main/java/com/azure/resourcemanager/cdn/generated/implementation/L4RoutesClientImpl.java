...
import com.azure.resourcemanager.cdn.generated.models.L4RouteListResult;
...
public final class L4RoutesClientImpl implements L4RoutesClient {
    /** The proxy service used to perform REST calls. */
    private final L4RoutesService service;

    /** The service client containing this operation class. */
    private final CdnManagementClientImpl client;

    /**
     * Initializes an instance of L4RoutesClientImpl.
     *
     * @param client the instance of the service client containing this operation class.
     */
    L4RoutesClientImpl(CdnManagementClientImpl client) {
        this.service = RestProxy.create(L4RoutesService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for CdnManagementClientL4Routes to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "CdnManagementClientL")
    public interface L4RoutesService {
        ...
        Mono<Response<L4RouteListResult>> listByEndpoint(
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<L4RouteInner>> get(
            @HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("profileName") String profileName,
            @PathParam("endpointName") String endpointName,
        ...
        Mono<Response<Flux<ByteBuffer>>> create(
            ...
            @PathParam("subscriptionId") String subscriptionId,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") L4RouteInner route,
            @HeaderParam("Accept") String accept,
            Context context);
        ...
        Mono<Response<Flux<ByteBuffer>>> update(
            ...
            @PathParam("subscriptionId") String subscriptionId,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") L4RouteUpdatePropertiesParameters routeUpdateProperties,
            @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<L4RouteListResult>> listByEndpointNext(
     ...
     * @return result of the request to list L4 routes along with {@link PagedResponse} on successful completion of
     *     {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<L4RouteInner>> listByEndpointSinglePageAsync(
                ...
                context ->
                    service
                        .listByEndpoint(
                            ...
                            accept,
                            context))
            .<PagedResponse<L4RouteInner>>map(
                res ->
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return result of the request to list L4 routes as paginated response with {@link PagedFlux}.
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<L4RouteInner> listByEndpointAsync(
        String resourceGroupName, String profileName, String endpointName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<L4RouteInner> listByEndpoint(
        String resourceGroupName, String profileName, String endpointName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<L4RouteInner>> getWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<L4RouteInner> getAsync(
        String resourceGroupName, String profileName, String endpointName, String routeName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<L4RouteInner> getWithResponse(
        String resourceGroupName, String profileName, String endpointName, String routeName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public L4RouteInner get(String resourceGroupName, String profileName, String endpointName, String routeName) {
    ...
    private PollerFlux<PollResult<L4RouteInner>, L4RouteInner> beginCreateAsync(
        String resourceGroupName, String profileName, String endpointName, String routeName, L4RouteInner route) {
        Mono<Response<Flux<ByteBuffer>>> mono =
            createWithResponseAsync(resourceGroupName, profileName, endpointName, routeName, route);
        return this
            .client
            .<L4RouteInner, L4RouteInner>getLroResult(
                mono, this.client.getHttpPipeline(), L4RouteInner.class, L4RouteInner.class, this.client.getContext());
    }
    ...
    private PollerFlux<PollResult<L4RouteInner>, L4RouteInner> beginCreateAsync(
        ...
        return this
            .client
            .<L4RouteInner, L4RouteInner>getLroResult(
                mono, this.client.getHttpPipeline(), L4RouteInner.class, L4RouteInner.class, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<L4RouteInner>, L4RouteInner> beginCreate(
        String resourceGroupName, String profileName, String endpointName, String routeName, L4RouteInner route) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<L4RouteInner> createAsync(
        String resourceGroupName, String profileName, String endpointName, String routeName, L4RouteInner route) {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<L4RouteInner>, L4RouteInner> beginUpdateAsync(
        String resourceGroupName,
        String profileName,
        String endpointName,
        String routeName,
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<L4RouteInner>, L4RouteInner> beginUpdate(
        String resourceGroupName,
        String profileName,
        String endpointName,
        String routeName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<L4RouteInner> updateAsync(
        String resourceGroupName,
        String profileName,
        String endpointName,
        String routeName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<L4RouteInner>> listByEndpointNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<L4RouteInner>> listByEndpointNextSinglePageAsync(String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        if (this.client.getEndpoint() == null) {
