...
public final class UrlFileNameMatchConditionParameters {
    ...
    private UrlFileNameMatchConditionParametersType typeName;
     ...
     */
    public UrlFileNameMatchConditionParametersType typeName() {
     ...
     */
    public UrlFileNameMatchConditionParameters withTypeName(UrlFileNameMatchConditionParametersType typeName) {
            ...
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException(
                        "Missing required property typeName in model UrlFileNameMatchConditionParameters"));
        }
        if (operator() == null) {
            throw LOGGER
                .logExceptionAsError(
