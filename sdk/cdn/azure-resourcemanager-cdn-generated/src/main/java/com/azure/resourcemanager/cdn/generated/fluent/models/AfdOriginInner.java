...
public final class AfdOriginInner extends ProxyResource {
    ...
    public String originPorts() {
        return this.innerProperties() == null ? null : this.innerProperties().originPorts();
    }
     ...
     * @return the AfdOriginInner object itself.
     */
    public AfdOriginInner withOriginPorts(String originPorts) {
        if (this.innerProperties() == null) {
            this.innerProperties = new AfdOriginProperties();
        }
        this.innerProperties().withOriginPorts(originPorts);
        return this;
    }
    ...
    public ClientIpPreservationState clientIpPreservationState() {
        return this.innerProperties() == null ? null : this.innerProperties().clientIpPreservationState();
    }
     ...
     * @return the AfdOriginInner object itself.
     */
    public AfdOriginInner withClientIpPreservationState(ClientIpPreservationState clientIpPreservationState) {
        if (this.innerProperties() == null) {
            this.innerProperties = new AfdOriginProperties();
        }
        this.innerProperties().withClientIpPreservationState(clientIpPreservationState);
        return this;
    }
