...
public final class AfdOriginGroupUpdateParameters {
    ...
    public SessionAffinityType sessionAffinityType() {
        return this.innerProperties() == null ? null : this.innerProperties().sessionAffinityType();
    }
     ...
     * @return the AfdOriginGroupUpdateParameters object itself.
     */
    public AfdOriginGroupUpdateParameters withSessionAffinityType(SessionAffinityType sessionAffinityType) {
        if (this.innerProperties() == null) {
            this.innerProperties = new AfdOriginGroupUpdatePropertiesParameters();
        }
        this.innerProperties().withSessionAffinityType(sessionAffinityType);
        return this;
    }
     ...
     * @return the AfdOriginGroupUpdateParameters object itself.
     */
    public AfdOriginGroupUpdateParameters withRouteType(RouteType routeType) {
        if (this.innerProperties() == null) {
            this.innerProperties = new AfdOriginGroupUpdatePropertiesParameters();
        }
