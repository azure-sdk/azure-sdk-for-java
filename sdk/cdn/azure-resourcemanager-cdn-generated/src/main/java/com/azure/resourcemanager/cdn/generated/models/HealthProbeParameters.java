...
public final class HealthProbeParameters {
    ...
    /*
     * The valid range of ports for health probes for TCP/UDP would typically be from 1024-65535. This range excludes
     * the reserved ports and allows for a wide range of available ports to use for health probes
     */
    ...
    /**
     * Get the probePort property: The valid range of ports for health probes for TCP/UDP would typically be from
     * 1024-65535. This range excludes the reserved ports and allows for a wide range of available ports to use for
     * health probes.
     *
    ...
    /**
     * Set the probePort property: The valid range of ports for health probes for TCP/UDP would typically be from
     * 1024-65535. This range excludes the reserved ports and allows for a wide range of available ports to use for
     * health probes.
     *
     ...
     * @return the HealthProbeParameters object itself.
     */
    public HealthProbeParameters withProbePort(Integer probePort) {
