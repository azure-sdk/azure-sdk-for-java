...
public final class PoliciesImpl implements Policies {
    ...
    public Response<CdnWebApplicationFirewallPolicy> getByResourceGroupWithResponse(String resourceGroupName,
    ...
    public CdnWebApplicationFirewallPolicy getById(String id) {
        ...
        if (policyName == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(String.format(
                "The resource ID '%s' is not valid. Missing path segment 'cdnWebApplicationFirewallPolicies'.", id)));
        }
