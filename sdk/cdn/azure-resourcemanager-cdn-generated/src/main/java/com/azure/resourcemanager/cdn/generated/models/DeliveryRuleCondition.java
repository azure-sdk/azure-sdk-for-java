 ...
 */
@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, property = "name", defaultImpl = DeliveryRuleCondition.class, visible = true)
...
public class DeliveryRuleCondition {
    ...
    private MatchVariable name;

    /**
     * Creates an instance of DeliveryRuleCondition class.
     */
    public DeliveryRuleCondition() {
        this.name = MatchVariable.fromString("DeliveryRuleCondition");
    }
