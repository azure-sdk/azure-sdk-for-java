...
public final class AfdEndpointsImpl implements AfdEndpoints {
    private static final ClientLogger LOGGER = new ClientLogger(AfdEndpointsImpl.class);
    ...
    public AfdEndpointsImpl(AfdEndpointsClient innerClient,
    ...
    public PagedIterable<AfdEndpoint> listByProfile(String resourceGroupName, String profileName) {
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new AfdEndpointImpl(inner1, this.manager()));
    }
    ...
    public Response<AfdEndpoint> getWithResponse(String resourceGroupName, String profileName, String endpointName,
        Context context) {
    ...
    public Response<ValidateCustomDomainOutput> validateCustomDomainWithResponse(String resourceGroupName,
        ...
        Response<ValidateCustomDomainOutputInner> inner = this.serviceClient().validateCustomDomainWithResponse(
    ...
    public ValidateCustomDomainOutput validateCustomDomain(String resourceGroupName, String profileName,
        String endpointName, ValidateCustomDomainInput customDomainProperties) {
        ValidateCustomDomainOutputInner inner = this.serviceClient().validateCustomDomain(resourceGroupName,
            profileName, endpointName, customDomainProperties);
        if (inner != null) {
    ...
    public AfdEndpoint getById(String id) {
        ...
        String endpointName = ResourceManagerUtils.getValueFromIdByName(id, "afdEndpoints");
