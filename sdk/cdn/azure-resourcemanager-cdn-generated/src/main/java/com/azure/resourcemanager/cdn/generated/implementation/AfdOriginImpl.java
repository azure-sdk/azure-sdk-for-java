...
public final class AfdOriginImpl implements AfdOrigin, AfdOrigin.Definition, AfdOrigin.Update {
    ...
    public String originPorts() {
        return this.innerModel().originPorts();
    }

    public ClientIpPreservationState clientIpPreservationState() {
        return this.innerModel().clientIpPreservationState();
    }
    ...
    public AfdOriginImpl withOriginPorts(String originPorts) {
        if (isInCreateMode()) {
            this.innerModel().withOriginPorts(originPorts);
            return this;
        } else {
            this.updateOriginUpdateProperties.withOriginPorts(originPorts);
            return this;
        }
    }

    public AfdOriginImpl withClientIpPreservationState(ClientIpPreservationState clientIpPreservationState) {
        if (isInCreateMode()) {
            this.innerModel().withClientIpPreservationState(clientIpPreservationState);
            return this;
        } else {
            this.updateOriginUpdateProperties.withClientIpPreservationState(clientIpPreservationState);
            return this;
        }
    }
