...
public final class AfdOriginImpl implements AfdOrigin, AfdOrigin.Definition, AfdOrigin.Update {
    ...
    public AfdOrigin create() {
        this.innerObject = serviceManager.serviceClient().getAfdOrigins().create(resourceGroupName, profileName,
            originGroupName, originName, this.innerModel(), Context.NONE);
        return this;
    }

    public AfdOrigin create(Context context) {
        this.innerObject = serviceManager.serviceClient().getAfdOrigins().create(resourceGroupName, profileName,
            originGroupName, originName, this.innerModel(), context);
        return this;
    }
    ...
    public AfdOrigin apply() {
        this.innerObject = serviceManager.serviceClient().getAfdOrigins().update(resourceGroupName, profileName,
            originGroupName, originName, updateOriginUpdateProperties, Context.NONE);
        return this;
    }

    public AfdOrigin apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getAfdOrigins().update(resourceGroupName, profileName,
            originGroupName, originName, updateOriginUpdateProperties, context);
        return this;
    }
    ...
    AfdOriginImpl(AfdOriginInner innerObject, com.azure.resourcemanager.cdn.generated.CdnManager serviceManager) {
        ...
        this.originGroupName = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "originGroups");
        this.originName = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "origins");
    }

    public AfdOrigin refresh() {
        this.innerObject = serviceManager.serviceClient().getAfdOrigins()
            .getWithResponse(resourceGroupName, profileName, originGroupName, originName, Context.NONE).getValue();
        return this;
    }

    public AfdOrigin refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getAfdOrigins()
            .getWithResponse(resourceGroupName, profileName, originGroupName, originName, context).getValue();
        return this;
    }
    ...
    public AfdOriginImpl withEnforceCertificateNameCheck(Boolean enforceCertificateNameCheck) {
        if (isInCreateMode()) {
            this.innerModel().withEnforceCertificateNameCheck(enforceCertificateNameCheck);
            return this;
        } else {
            this.updateOriginUpdateProperties.withEnforceCertificateNameCheck(enforceCertificateNameCheck);
            return this;
        }
    }
