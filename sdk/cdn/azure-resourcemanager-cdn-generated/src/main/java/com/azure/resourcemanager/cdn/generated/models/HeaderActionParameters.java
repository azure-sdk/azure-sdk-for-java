...
public final class HeaderActionParameters {
    ...
    private HeaderActionParametersType typeName;
     ...
     */
    public HeaderActionParametersType typeName() {
     ...
     */
    public HeaderActionParameters withTypeName(HeaderActionParametersType typeName) {
    ...
    public void validate() {
        if (typeName() == null) {
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException("Missing required property typeName in model HeaderActionParameters"));
        }
