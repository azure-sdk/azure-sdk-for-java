...
import com.azure.resourcemanager.cdn.generated.models.ManagedServiceIdentity;
import com.azure.resourcemanager.cdn.generated.models.Profile;
import com.azure.resourcemanager.cdn.generated.models.ProfileLogScrubbing;
import com.azure.resourcemanager.cdn.generated.models.ProfileProvisioningState;
...
public final class ProfileImpl implements Profile, Profile.Definition, Profile.Update {
    ...
    public ProfileLogScrubbing logScrubbing() {
        return this.innerModel().logScrubbing();
    }
    ...
    public Profile create() {
        this.innerObject = serviceManager.serviceClient().getProfiles().create(resourceGroupName, profileName,
    ...
    public Profile apply() {
        this.innerObject = serviceManager.serviceClient().getProfiles().update(resourceGroupName, profileName,
            updateProfileUpdateParameters, Context.NONE);
        return this;
    }

    public Profile apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getProfiles().update(resourceGroupName, profileName,
            updateProfileUpdateParameters, context);
        return this;
    }
    ...
    public Profile refresh() {
        this.innerObject = serviceManager.serviceClient().getProfiles()
            .getByResourceGroupWithResponse(resourceGroupName, profileName, Context.NONE).getValue();
        return this;
    }

    public Profile refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getProfiles()
            .getByResourceGroupWithResponse(resourceGroupName, profileName, context).getValue();
        return this;
    }

    public void migrationCommit() {
        serviceManager.profiles().migrationCommit(resourceGroupName, profileName);
    }

    public void migrationCommit(Context context) {
        serviceManager.profiles().migrationCommit(resourceGroupName, profileName, context);
    }
    ...
    public Response<SupportedOptimizationTypesListResult> listSupportedOptimizationTypesWithResponse(Context context) {
        return serviceManager.profiles().listSupportedOptimizationTypesWithResponse(resourceGroupName, profileName,
            context);
    }
    ...
    public ProfileImpl withIdentity(ManagedServiceIdentity identity) {
        if (isInCreateMode()) {
            this.innerModel().withIdentity(identity);
            return this;
        } else {
            this.updateProfileUpdateParameters.withIdentity(identity);
            return this;
        }
    }

    public ProfileImpl withOriginResponseTimeoutSeconds(Integer originResponseTimeoutSeconds) {
        if (isInCreateMode()) {
            this.innerModel().withOriginResponseTimeoutSeconds(originResponseTimeoutSeconds);
            return this;
        } else {
            this.updateProfileUpdateParameters.withOriginResponseTimeoutSeconds(originResponseTimeoutSeconds);
            return this;
        }
    }

    public ProfileImpl withLogScrubbing(ProfileLogScrubbing logScrubbing) {
        if (isInCreateMode()) {
            this.innerModel().withLogScrubbing(logScrubbing);
            return this;
        } else {
            this.updateProfileUpdateParameters.withLogScrubbing(logScrubbing);
            return this;
        }
    }
