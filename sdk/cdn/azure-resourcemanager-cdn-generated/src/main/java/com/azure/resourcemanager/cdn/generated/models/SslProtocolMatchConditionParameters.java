...
public final class SslProtocolMatchConditionParameters {
    ...
    private SslProtocolMatchConditionParametersType typeName;
     ...
     */
    public SslProtocolMatchConditionParametersType typeName() {
     ...
     */
    public SslProtocolMatchConditionParameters withTypeName(SslProtocolMatchConditionParametersType typeName) {
            ...
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException(
                        "Missing required property typeName in model SslProtocolMatchConditionParameters"));
        }
        if (operator() == null) {
            throw LOGGER
                .logExceptionAsError(
