...
public final class RuleSetsImpl implements RuleSets {
    ...
    public RuleSet create(String resourceGroupName, String profileName, String ruleSetName, Context context) {
        RuleSetInner inner = this.serviceClient().create(resourceGroupName, profileName, ruleSetName, context);
        if (inner != null) {
            return new RuleSetImpl(inner, this.manager());
        } else {
            return null;
