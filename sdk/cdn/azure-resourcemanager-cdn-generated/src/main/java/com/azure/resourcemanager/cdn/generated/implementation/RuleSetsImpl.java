...
public final class RuleSetsImpl implements RuleSets {
    ...
    public Response<RuleSet> getWithResponse(String resourceGroupName, String profileName, String ruleSetName,
        Context context) {
    ...
    public Response<RuleSet> createWithResponse(String resourceGroupName, String profileName, String ruleSetName,
        Context context) {
        Response<RuleSetInner> inner
