...
public final class AfdEndpointUpdateParameters {
    ...
    public ResourceReference dedicatedVip() {
        return this.innerProperties() == null ? null : this.innerProperties().dedicatedVip();
    }
     ...
     * @return the AfdEndpointUpdateParameters object itself.
     */
    public AfdEndpointUpdateParameters withDedicatedVip(ResourceReference dedicatedVip) {
        if (this.innerProperties() == null) {
            this.innerProperties = new AfdEndpointPropertiesUpdateParameters();
        }
        this.innerProperties().withDedicatedVip(dedicatedVip);
        return this;
    }
