 ...
 */
@Fluent
public final class CacheKeyQueryStringActionParameters extends DeliveryRuleActionParameters {
    /*
     * The typeName property.
     */
    private DeliveryRuleActionParametersType typeName
        = DeliveryRuleActionParametersType.DELIVERY_RULE_CACHE_KEY_QUERY_STRING_BEHAVIOR_ACTION_PARAMETERS;
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("queryStringBehavior".equals(fieldName)) {
                    ...
                    deserializedCacheKeyQueryStringActionParameters.typeName
