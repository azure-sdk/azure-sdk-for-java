...
public final class CacheConfiguration {
     ...
     */
    @JsonProperty(value = "isNegativeCachingEnabled")
    private RuleIsNegativeCachingEnabled isNegativeCachingEnabled;
    ...
    /**
     * Get the isNegativeCachingEnabled property: Indicates whether negative caching is enabled.
     *
     * @return the isNegativeCachingEnabled value.
     */
    public RuleIsNegativeCachingEnabled isNegativeCachingEnabled() {
        return this.isNegativeCachingEnabled;
    }

    /**
     * Set the isNegativeCachingEnabled property: Indicates whether negative caching is enabled.
     *
     * @param isNegativeCachingEnabled the isNegativeCachingEnabled value to set.
     * @return the CacheConfiguration object itself.
     */
    public CacheConfiguration withIsNegativeCachingEnabled(RuleIsNegativeCachingEnabled isNegativeCachingEnabled) {
        this.isNegativeCachingEnabled = isNegativeCachingEnabled;
        return this;
    }
