 ...
 */
@Fluent
public final class HostnameMatchConditionParameters extends DeliveryRuleConditionParameters {
    /*
     * The typeName property.
     */
    private DeliveryRuleConditionParametersType typeName
        = DeliveryRuleConditionParametersType.DELIVERY_RULE_HOST_NAME_CONDITION_PARAMETERS;
    ...
    /**
     * Creates an instance of HostnameMatchConditionParameters class.
     */
     ...
     * @return the HostnameMatchConditionParameters object itself.
     */
        ...
        if (operator() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property operator in model HostnameMatchConditionParameters"));
        }
    }
    ...
    /**
     * Reads an instance of HostnameMatchConditionParameters from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of HostnameMatchConditionParameters if the JsonReader was pointing to an instance of it, or
     * null if it was pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the HostnameMatchConditionParameters.
     */
    public static HostnameMatchConditionParameters fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            HostnameMatchConditionParameters deserializedHostnameMatchConditionParameters
                = new HostnameMatchConditionParameters();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("operator".equals(fieldName)) {
                    deserializedHostnameMatchConditionParameters.operator
                        = HostnameOperator.fromString(reader.getString());
                } else if ("typeName".equals(fieldName)) {
                    deserializedHostnameMatchConditionParameters.typeName
                        = DeliveryRuleConditionParametersType.fromString(reader.getString());
                } else if ("negateCondition".equals(fieldName)) {
                    deserializedHostnameMatchConditionParameters.negateCondition
                        = reader.getNullable(JsonReader::getBoolean);
                } else if ("matchValues".equals(fieldName)) {
                    List<String> matchValues = reader.readArray(reader1 -> reader1.getString());
                    deserializedHostnameMatchConditionParameters.matchValues = matchValues;
                    ...
                    deserializedHostnameMatchConditionParameters.transforms = transforms;
                } else {
                    reader.skipChildren();
                }
            }
