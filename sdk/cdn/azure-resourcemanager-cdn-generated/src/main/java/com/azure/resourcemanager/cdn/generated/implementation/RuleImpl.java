...
public final class RuleImpl implements Rule, Rule.Definition, Rule.Update {
    ...
    public Rule create() {
        this.innerObject = serviceManager.serviceClient().getRules().create(resourceGroupName, profileName, ruleSetName,
    ...
    public Rule apply() {
        this.innerObject = serviceManager.serviceClient().getRules().update(resourceGroupName, profileName, ruleSetName,
            ruleName, updateRuleUpdateProperties, Context.NONE);
        return this;
    }

    public Rule apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getRules().update(resourceGroupName, profileName, ruleSetName,
            ruleName, updateRuleUpdateProperties, context);
        return this;
    }
    ...
    RuleImpl(RuleInner innerObject, com.azure.resourcemanager.cdn.generated.CdnManager serviceManager) {
        ...
        this.ruleSetName = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "ruleSets");
    ...
    public Rule refresh() {
        this.innerObject = serviceManager.serviceClient().getRules()
            .getWithResponse(resourceGroupName, profileName, ruleSetName, ruleName, Context.NONE).getValue();
        return this;
    }

    public Rule refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getRules()
            .getWithResponse(resourceGroupName, profileName, ruleSetName, ruleName, context).getValue();
        return this;
    }
