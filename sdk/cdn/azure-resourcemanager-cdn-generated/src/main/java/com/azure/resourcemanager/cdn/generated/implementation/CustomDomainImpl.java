...
public final class CustomDomainImpl implements CustomDomain, CustomDomain.Definition {
    ...
    public CustomDomain create() {
        this.innerObject = serviceManager.serviceClient().getCustomDomains().create(resourceGroupName, profileName,
            endpointName, customDomainName, createCustomDomainProperties, Context.NONE);
        return this;
    }

    public CustomDomain create(Context context) {
        this.innerObject = serviceManager.serviceClient().getCustomDomains().create(resourceGroupName, profileName,
            endpointName, customDomainName, createCustomDomainProperties, context);
        return this;
    }
    ...
    public CustomDomain refresh() {
        this.innerObject = serviceManager.serviceClient().getCustomDomains()
            .getWithResponse(resourceGroupName, profileName, endpointName, customDomainName, Context.NONE).getValue();
        return this;
    }

    public CustomDomain refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getCustomDomains()
            .getWithResponse(resourceGroupName, profileName, endpointName, customDomainName, context).getValue();
        return this;
    }

    public CustomDomain disableCustomHttps() {
        return serviceManager.customDomains().disableCustomHttps(resourceGroupName, profileName, endpointName,
            customDomainName);
    }

    public CustomDomain disableCustomHttps(Context context) {
        return serviceManager.customDomains().disableCustomHttps(resourceGroupName, profileName, endpointName,
            customDomainName, context);
    }

    public CustomDomain enableCustomHttps() {
        return serviceManager.customDomains().enableCustomHttps(resourceGroupName, profileName, endpointName,
            customDomainName);
    }

    public CustomDomain enableCustomHttps(CustomDomainHttpsParameters customDomainHttpsParameters, Context context) {
        return serviceManager.customDomains().enableCustomHttps(resourceGroupName, profileName, endpointName,
