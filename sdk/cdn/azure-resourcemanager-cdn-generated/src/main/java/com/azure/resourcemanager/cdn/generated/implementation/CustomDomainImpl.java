...
public final class CustomDomainImpl implements CustomDomain, CustomDomain.Definition {
    ...
    public CustomDomain disableCustomHttps(Context context) {
        return serviceManager
            .customDomains()
            .disableCustomHttps(resourceGroupName, profileName, endpointName, customDomainName, context);
    }

    public CustomDomain enableCustomHttps(CustomDomainHttpsParameters customDomainHttpsParameters) {
        return serviceManager
            .customDomains()
            .enableCustomHttps(
