...
public final class AfdDomainImpl implements AfdDomain, AfdDomain.Definition, AfdDomain.Update {
    ...
    public ResourceReference preValidatedCustomDomainResourceId() {
        return this.innerModel().preValidatedCustomDomainResourceId();
    }
    ...
    public AfdDomain create() {
        this.innerObject = serviceManager.serviceClient().getAfdCustomDomains().create(resourceGroupName, profileName,
            customDomainName, this.innerModel(), Context.NONE);
        return this;
    }

    public AfdDomain create(Context context) {
        this.innerObject = serviceManager.serviceClient().getAfdCustomDomains().create(resourceGroupName, profileName,
            customDomainName, this.innerModel(), context);
        return this;
    }
    ...
    public AfdDomain apply() {
        this.innerObject = serviceManager.serviceClient().getAfdCustomDomains().update(resourceGroupName, profileName,
            customDomainName, updateCustomDomainUpdateProperties, Context.NONE);
        return this;
    }

    public AfdDomain apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getAfdCustomDomains().update(resourceGroupName, profileName,
            customDomainName, updateCustomDomainUpdateProperties, context);
        return this;
    }
    ...
    AfdDomainImpl(AfdDomainInner innerObject, com.azure.resourcemanager.cdn.generated.CdnManager serviceManager) {
        ...
        this.customDomainName = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "customDomains");
    }

    public AfdDomain refresh() {
        this.innerObject = serviceManager.serviceClient().getAfdCustomDomains()
            .getWithResponse(resourceGroupName, profileName, customDomainName, Context.NONE).getValue();
        return this;
    }

    public AfdDomain refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getAfdCustomDomains()
            .getWithResponse(resourceGroupName, profileName, customDomainName, context).getValue();
        return this;
    }

    public void refreshValidationToken() {
        serviceManager.afdCustomDomains().refreshValidationToken(resourceGroupName, profileName, customDomainName);
    }

    public void refreshValidationToken(Context context) {
        serviceManager.afdCustomDomains().refreshValidationToken(resourceGroupName, profileName, customDomainName,
            context);
    }
    ...
    public AfdDomainImpl withExtendedProperties(Map<String, String> extendedProperties) {
    ...
    public AfdDomainImpl withPreValidatedCustomDomainResourceId(ResourceReference preValidatedCustomDomainResourceId) {
        if (isInCreateMode()) {
            this.innerModel().withPreValidatedCustomDomainResourceId(preValidatedCustomDomainResourceId);
            return this;
        } else {
            this.updateCustomDomainUpdateProperties
                .withPreValidatedCustomDomainResourceId(preValidatedCustomDomainResourceId);
            return this;
        }
    }
