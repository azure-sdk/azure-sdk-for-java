...
import com.azure.resourcemanager.cdn.generated.models.AfdDomainReferencedRoutePath;
...
public final class AfdDomainImpl implements AfdDomain, AfdDomain.Definition, AfdDomain.Update {
    ...
    public List<AfdDomainReferencedRoutePath> referencedRoutePaths() {
        List<AfdDomainReferencedRoutePath> inner = this.innerModel().referencedRoutePaths();
        if (inner != null) {
    ...
    public AfdDomainImpl withPreValidatedCustomDomainResourceId(ResourceReference preValidatedCustomDomainResourceId) {
        if (isInCreateMode()) {
            ...
            this
                .updateCustomDomainUpdateProperties
