...
public final class AfdProfilesClientImpl implements AfdProfilesClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<CheckEndpointNameAvailabilityOutputInner> checkEndpointNameAvailabilityAsync(String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<CheckNameAvailabilityOutputInner> checkHostnameAvailabilityAsync(String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ValidateSecretOutputInner> validateSecretAsync(String resourceGroupName, String profileName,
