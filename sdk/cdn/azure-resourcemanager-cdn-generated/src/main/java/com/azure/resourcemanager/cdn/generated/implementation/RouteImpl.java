...
public final class RouteImpl implements Route, Route.Definition, Route.Update {
    ...
    public Route create() {
        this.innerObject = serviceManager.serviceClient().getRoutes().create(resourceGroupName, profileName,
            endpointName, routeName, this.innerModel(), Context.NONE);
        return this;
    }

    public Route create(Context context) {
        this.innerObject = serviceManager.serviceClient().getRoutes().create(resourceGroupName, profileName,
            endpointName, routeName, this.innerModel(), context);
        return this;
    }
    ...
    public Route apply() {
        this.innerObject = serviceManager.serviceClient().getRoutes().update(resourceGroupName, profileName,
            endpointName, routeName, updateRouteUpdateProperties, Context.NONE);
        return this;
    }

    public Route apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getRoutes().update(resourceGroupName, profileName,
            endpointName, routeName, updateRouteUpdateProperties, context);
        return this;
    }
    ...
    public Route refresh() {
        this.innerObject = serviceManager.serviceClient().getRoutes()
            .getWithResponse(resourceGroupName, profileName, endpointName, routeName, Context.NONE).getValue();
        return this;
    }

    public Route refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getRoutes()
            .getWithResponse(resourceGroupName, profileName, endpointName, routeName, context).getValue();
        return this;
    }

    public RouteImpl withCustomDomains(List<ActivatedResourceReference> customDomains) {
        if (isInCreateMode()) {
    ...
    public RouteImpl withCacheConfiguration(AfdRouteCacheConfiguration cacheConfiguration) {
        if (isInCreateMode()) {
            ...
            this.updateRouteUpdateProperties.withCacheConfiguration(cacheConfiguration);
            return this;
        }
    }
