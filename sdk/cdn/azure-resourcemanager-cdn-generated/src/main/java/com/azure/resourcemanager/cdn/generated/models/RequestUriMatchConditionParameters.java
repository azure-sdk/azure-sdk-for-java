...
public final class RequestUriMatchConditionParameters {
    ...
    private RequestUriMatchConditionParametersType typeName;
     ...
     */
    public RequestUriMatchConditionParametersType typeName() {
     ...
     */
    public RequestUriMatchConditionParameters withTypeName(RequestUriMatchConditionParametersType typeName) {
            ...
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException(
                        "Missing required property typeName in model RequestUriMatchConditionParameters"));
        }
        if (operator() == null) {
            throw LOGGER
                .logExceptionAsError(
