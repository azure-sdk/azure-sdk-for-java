...
public final class QueryStringMatchConditionParameters {
    ...
    private QueryStringMatchConditionParametersType typeName;
     ...
     */
    public QueryStringMatchConditionParametersType typeName() {
     ...
     */
    public QueryStringMatchConditionParameters withTypeName(QueryStringMatchConditionParametersType typeName) {
            ...
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException(
                        "Missing required property typeName in model QueryStringMatchConditionParameters"));
        }
        if (operator() == null) {
            throw LOGGER
                .logExceptionAsError(
