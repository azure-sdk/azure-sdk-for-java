...
@JsonSubTypes({
    ...
    @JsonSubTypes.Type(name = "CustomErrorPageUrl", value = DeliveryRuleCustomErrorPageAction.class),
    @JsonSubTypes.Type(name = "OverrideResponseStatusCode", value = DeliveryRuleOverrideResponseStatusCodeAction.class)
})
@Immutable
