 ...
 */
@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, property = "name", defaultImpl = DeliveryRuleAction.class, visible = true)
...
public class DeliveryRuleAction {
    ...
    private DeliveryRuleActionValue name;

    /**
     * Creates an instance of DeliveryRuleAction class.
     */
    public DeliveryRuleAction() {
        this.name = DeliveryRuleActionValue.fromString("DeliveryRuleAction");
    }
