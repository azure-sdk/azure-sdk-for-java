 ...
 */
@Fluent
public final class SocketAddrMatchConditionParameters extends DeliveryRuleConditionParameters {
    /*
     * The typeName property.
     */
    private DeliveryRuleConditionParametersType typeName
        = DeliveryRuleConditionParametersType.DELIVERY_RULE_SOCKET_ADDR_CONDITION_PARAMETERS;
        ...
        if (operator() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property operator in model SocketAddrMatchConditionParameters"));
        }
    }
    ...
    /**
     * Reads an instance of SocketAddrMatchConditionParameters from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of SocketAddrMatchConditionParameters if the JsonReader was pointing to an instance of it, or
     * null if it was pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the SocketAddrMatchConditionParameters.
     */
    public static SocketAddrMatchConditionParameters fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            SocketAddrMatchConditionParameters deserializedSocketAddrMatchConditionParameters
                = new SocketAddrMatchConditionParameters();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("operator".equals(fieldName)) {
                    deserializedSocketAddrMatchConditionParameters.operator
                        = SocketAddrOperator.fromString(reader.getString());
                } else if ("typeName".equals(fieldName)) {
                    deserializedSocketAddrMatchConditionParameters.typeName
                        = DeliveryRuleConditionParametersType.fromString(reader.getString());
                } else if ("negateCondition".equals(fieldName)) {
                    deserializedSocketAddrMatchConditionParameters.negateCondition
                        = reader.getNullable(JsonReader::getBoolean);
                } else if ("matchValues".equals(fieldName)) {
                    List<String> matchValues = reader.readArray(reader1 -> reader1.getString());
                    deserializedSocketAddrMatchConditionParameters.matchValues = matchValues;
                    ...
                    deserializedSocketAddrMatchConditionParameters.transforms = transforms;
                } else {
                    reader.skipChildren();
                }
            }
