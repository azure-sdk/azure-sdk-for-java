...
public final class SocketAddrMatchConditionParameters {
    ...
    private SocketAddrMatchConditionParametersType typeName;
     ...
     */
    public SocketAddrMatchConditionParametersType typeName() {
     ...
     */
    public SocketAddrMatchConditionParameters withTypeName(SocketAddrMatchConditionParametersType typeName) {
            ...
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException(
                        "Missing required property typeName in model SocketAddrMatchConditionParameters"));
        }
        if (operator() == null) {
            throw LOGGER
                .logExceptionAsError(
