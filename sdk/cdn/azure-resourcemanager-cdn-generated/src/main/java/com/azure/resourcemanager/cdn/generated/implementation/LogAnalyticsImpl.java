...
public final class LogAnalyticsImpl implements LogAnalytics {
    ...
    public Response<MetricsResponse> getLogAnalyticsMetricsWithResponse(String resourceGroupName, String profileName,
        ...
        Response<MetricsResponseInner> inner = this.serviceClient()
            .getLogAnalyticsMetricsWithResponse(resourceGroupName, profileName, metrics, dateTimeBegin, dateTimeEnd,
                granularity, customDomains, protocols, groupBy, continents, countryOrRegions, context);
        if (inner != null) {
    ...
    public MetricsResponse getLogAnalyticsMetrics(String resourceGroupName, String profileName, List<LogMetric> metrics,
        ...
        MetricsResponseInner inner = this.serviceClient()
            .getLogAnalyticsMetrics(resourceGroupName, profileName, metrics, dateTimeBegin, dateTimeEnd, granularity,
                customDomains, protocols);
        if (inner != null) {
    ...
    public Response<RankingsResponse> getLogAnalyticsRankingsWithResponse(String resourceGroupName, String profileName,
        ...
        Response<RankingsResponseInner> inner = this.serviceClient()
            .getLogAnalyticsRankingsWithResponse(resourceGroupName, profileName, rankings, metrics, maxRanking,
                dateTimeBegin, dateTimeEnd, customDomains, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
    ...
    public RankingsResponse getLogAnalyticsRankings(String resourceGroupName, String profileName,
        ...
        RankingsResponseInner inner = this.serviceClient()
            .getLogAnalyticsRankings(resourceGroupName, profileName, rankings, metrics, maxRanking, dateTimeBegin,
                dateTimeEnd);
        if (inner != null) {
    ...
    public Response<WafMetricsResponse> getWafLogAnalyticsMetricsWithResponse(String resourceGroupName,
        ...
        Response<WafMetricsResponseInner> inner = this.serviceClient()
            .getWafLogAnalyticsMetricsWithResponse(resourceGroupName, profileName, metrics, dateTimeBegin, dateTimeEnd,
                granularity, actions, groupBy, ruleTypes, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
    ...
    public WafMetricsResponse getWafLogAnalyticsMetrics(String resourceGroupName, String profileName,
        ...
        WafMetricsResponseInner inner = this.serviceClient()
    ...
    public Response<WafRankingsResponse> getWafLogAnalyticsRankingsWithResponse(String resourceGroupName,
        ...
        Context context) {
        Response<WafRankingsResponseInner> inner = this.serviceClient()
            .getWafLogAnalyticsRankingsWithResponse(resourceGroupName, profileName, metrics, dateTimeBegin, dateTimeEnd,
                maxRanking, rankings, actions, ruleTypes, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
    ...
    public WafRankingsResponse getWafLogAnalyticsRankings(String resourceGroupName, String profileName,
        ...
        WafRankingsResponseInner inner = this.serviceClient()
            .getWafLogAnalyticsRankings(resourceGroupName, profileName, metrics, dateTimeBegin, dateTimeEnd, maxRanking,
                rankings);
        if (inner != null) {
