...
public final class ClientPortMatchConditionParameters {
    ...
    private ClientPortMatchConditionParametersType typeName;
     ...
     */
    public ClientPortMatchConditionParametersType typeName() {
     ...
     */
    public ClientPortMatchConditionParameters withTypeName(ClientPortMatchConditionParametersType typeName) {
            ...
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException(
                        "Missing required property typeName in model ClientPortMatchConditionParameters"));
        }
        if (operator() == null) {
            throw LOGGER
                .logExceptionAsError(
