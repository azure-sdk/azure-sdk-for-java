...
public final class ResourceUsagesClientImpl implements ResourceUsagesClient {
    ...
    /**
     * The interface defining all the services for CdnManagementClientResourceUsages to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{$host}")
    ...
    public interface ResourceUsagesService {
        ...
        Mono<Response<ResourceUsageListResult>> list(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ResourceUsageListResult>> listNext(@PathParam(value = "nextLink", encoded = true) String nextLink,
    ...
    private PagedFlux<ResourceUsageInner> listAsync() {
