...
public final class CdnWebApplicationFirewallPolicyImpl implements CdnWebApplicationFirewallPolicy,
    ...
    CdnWebApplicationFirewallPolicyImpl(String name,
    ...
    public CdnWebApplicationFirewallPolicy apply() {
        this.innerObject = serviceManager.serviceClient().getPolicies().update(resourceGroupName, policyName,
            updateCdnWebApplicationFirewallPolicyPatchParameters, Context.NONE);
        return this;
    }

    public CdnWebApplicationFirewallPolicy apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getPolicies().update(resourceGroupName, policyName,
            updateCdnWebApplicationFirewallPolicyPatchParameters, context);
        return this;
    }

    CdnWebApplicationFirewallPolicyImpl(CdnWebApplicationFirewallPolicyInner innerObject,
        com.azure.resourcemanager.cdn.generated.CdnManager serviceManager) {
        this.innerObject = innerObject;
        this.serviceManager = serviceManager;
        this.resourceGroupName = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "resourceGroups");
        this.policyName
            = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "cdnWebApplicationFirewallPolicies");
    }
    ...
    public CdnWebApplicationFirewallPolicyImpl withExtendedProperties(Map<String, String> extendedProperties) {
