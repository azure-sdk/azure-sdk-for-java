...
import com.azure.resourcemanager.cdn.generated.models.DeepCreatedCustomDomain;
...
public final class EndpointImpl implements Endpoint, Endpoint.Definition, Endpoint.Update {
    ...
    public List<DeepCreatedCustomDomain> customDomains() {
        List<DeepCreatedCustomDomain> inner = this.innerModel().customDomains();
        if (inner != null) {
            return Collections.unmodifiableList(inner);
        } else {
            return Collections.emptyList();
    ...
    public Endpoint create() {
        this.innerObject = serviceManager.serviceClient().getEndpoints().create(resourceGroupName, profileName,
    ...
    public Endpoint apply() {
        this.innerObject = serviceManager.serviceClient().getEndpoints().update(resourceGroupName, profileName,
    ...
    public Response<ValidateCustomDomainOutput>
        ...
        return serviceManager.endpoints().validateCustomDomainWithResponse(resourceGroupName, profileName, endpointName,
    ...
    public ValidateCustomDomainOutput validateCustomDomain(ValidateCustomDomainInput customDomainProperties) {
        return serviceManager.endpoints().validateCustomDomain(resourceGroupName, profileName, endpointName,
