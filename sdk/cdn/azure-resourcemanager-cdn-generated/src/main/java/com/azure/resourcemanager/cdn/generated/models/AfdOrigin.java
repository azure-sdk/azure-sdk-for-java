...
public interface AfdOrigin {
    ...
    /**
     * Gets the originGroupName property: The name of the origin group which contains this origin.
     *
    ...
    /**
     * Gets the originPorts property: The ports used for the TCP/UDP connection to the customer's backend. Must be
     * between 1024 and 65535 excluding reserved ports. The ports can be a comma separated list or a valid range like
     * 5050-5090.
     *
     * @return the originPorts value.
     */
    String originPorts();

    /**
     * Gets the clientIpPreservationState property: Preserves the client side source IP allowing the back-end to see the
     * IP address of the client. This can then be used by applications for applying any rules. Valid options are
     * 'Enabled' or 'Disabled'.
     *
     * @return the clientIpPreservationState value.
     */
    ...
    /**
     * Gets the enforceCertificateNameCheck property: Whether to enable certificate name check at origin level.
     *
    ...
    interface DefinitionStages {
        ...
        interface WithCreate
            extends DefinitionStages.WithAzureOrigin,
                ...
                DefinitionStages.WithOriginPorts,
                DefinitionStages.WithClientIpPreservationState,
                ...
                DefinitionStages.WithEnforceCertificateNameCheck {
            /**
        ...
        interface WithOriginHostHeader {
             ...
             * you leave this blank, the request hostname determines this value. Azure Front Door origins, such as Web
             * Apps, Blob Storage, and Cloud Services require this host header value to match the origin hostname by
             ...
             *     blank, the request hostname determines this value. Azure Front Door origins, such as Web Apps, Blob
             *     Storage, and Cloud Services require this host header value to match the origin hostname by default.
             *     This overrides the host header defined at Endpoint.
             * @return the next definition stage.
             */
            WithCreate withOriginHostHeader(String originHostHeader);
        }
        /** The stage of the AfdOrigin definition allowing to specify originPorts. */
        interface WithOriginPorts {
            /**
             * Specifies the originPorts property: The ports used for the TCP/UDP connection to the customer's backend.
             * Must be between 1024 and 65535 excluding reserved ports. The ports can be a comma separated list or a
             * valid range like 5050-5090.
             *
             * @param originPorts The ports used for the TCP/UDP connection to the customer's backend. Must be between
             *     1024 and 65535 excluding reserved ports. The ports can be a comma separated list or a valid range
             *     like 5050-5090.
             * @return the next definition stage.
             */
            WithCreate withOriginPorts(String originPorts);
        }
        /** The stage of the AfdOrigin definition allowing to specify clientIpPreservationState. */
        interface WithClientIpPreservationState {
            /**
             * Specifies the clientIpPreservationState property: Preserves the client side source IP allowing the
             * back-end to see the IP address of the client. This can then be used by applications for applying any
             * rules. Valid options are 'Enabled' or 'Disabled'.
             *
             * @param clientIpPreservationState Preserves the client side source IP allowing the back-end to see the IP
             *     address of the client. This can then be used by applications for applying any rules. Valid options
             *     are 'Enabled' or 'Disabled'.
             * @return the next definition stage.
             */
            WithCreate withClientIpPreservationState(ClientIpPreservationState clientIpPreservationState);
        }
        ...
        interface WithSharedPrivateLinkResource {
             ...
             * @return the next definition stage.
             */
            WithCreate withSharedPrivateLinkResource(SharedPrivateLinkResourceProperties sharedPrivateLinkResource);
        }
        ...
        /** The stage of the AfdOrigin definition allowing to specify enforceCertificateNameCheck. */
        interface WithEnforceCertificateNameCheck {
            /**
             * Specifies the enforceCertificateNameCheck property: Whether to enable certificate name check at origin
             * level.
             *
             * @param enforceCertificateNameCheck Whether to enable certificate name check at origin level.
             * @return the next definition stage.
             */
            WithCreate withEnforceCertificateNameCheck(Boolean enforceCertificateNameCheck);
        }
    }
    /**
    ...
    interface UpdateStages {
        ...
        /** The stage of the AfdOrigin update allowing to specify originPorts. */
        interface WithOriginPorts {
            /**
             * Specifies the originPorts property: The ports used for the TCP/UDP connection to the customer's backend.
             * Must be between 1024 and 65535 excluding reserved ports. The ports can be a comma separated list or a
             ...
             * @return the next definition stage.
             */
            Update withOriginPorts(String originPorts);
        }
        /** The stage of the AfdOrigin update allowing to specify clientIpPreservationState. */
        interface WithClientIpPreservationState {
            /**
             * Specifies the clientIpPreservationState property: Preserves the client side source IP allowing the
             * back-end to see the IP address of the client. This can then be used by applications for applying any
             ...
             * @return the next definition stage.
             */
            Update withClientIpPreservationState(ClientIpPreservationState clientIpPreservationState);
        }
        ...
        /** The stage of the AfdOrigin update allowing to specify enforceCertificateNameCheck. */
        interface WithEnforceCertificateNameCheck {
            /**
             * Specifies the enforceCertificateNameCheck property: Whether to enable certificate name check at origin
             * level.
             ...
             * @return the next definition stage.
             */
            Update withEnforceCertificateNameCheck(Boolean enforceCertificateNameCheck);
        }
    }
    /**
