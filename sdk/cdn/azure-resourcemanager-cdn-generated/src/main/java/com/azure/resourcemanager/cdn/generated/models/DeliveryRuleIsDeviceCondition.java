...
public final class DeliveryRuleIsDeviceCondition extends DeliveryRuleCondition {
     ...
     */
    private MatchVariable name = MatchVariable.IS_DEVICE;
    ...
    /**
     * Reads an instance of DeliveryRuleIsDeviceCondition from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of DeliveryRuleIsDeviceCondition if the JsonReader was pointing to an instance of it, or null
     * if it was pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the DeliveryRuleIsDeviceCondition.
     */
    public static DeliveryRuleIsDeviceCondition fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            DeliveryRuleIsDeviceCondition deserializedDeliveryRuleIsDeviceCondition
                = new DeliveryRuleIsDeviceCondition();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("parameters".equals(fieldName)) {
                    deserializedDeliveryRuleIsDeviceCondition.parameters
                        = IsDeviceMatchConditionParameters.fromJson(reader);
                } else if ("name".equals(fieldName)) {
                    deserializedDeliveryRuleIsDeviceCondition.name = MatchVariable.fromString(reader.getString());
                } else {
                    reader.skipChildren();
                }
            }

            return deserializedDeliveryRuleIsDeviceCondition;
        });
    }
}
