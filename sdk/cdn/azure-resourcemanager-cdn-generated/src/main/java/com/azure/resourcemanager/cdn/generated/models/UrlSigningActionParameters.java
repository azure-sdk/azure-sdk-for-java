 ...
 */
@Fluent
public final class UrlSigningActionParameters extends DeliveryRuleActionParameters {
    /*
     * The typeName property.
     */
    private DeliveryRuleActionParametersType typeName
        = DeliveryRuleActionParametersType.DELIVERY_RULE_URL_SIGNING_ACTION_PARAMETERS;
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("typeName".equals(fieldName)) {
                    deserializedUrlSigningActionParameters.typeName
