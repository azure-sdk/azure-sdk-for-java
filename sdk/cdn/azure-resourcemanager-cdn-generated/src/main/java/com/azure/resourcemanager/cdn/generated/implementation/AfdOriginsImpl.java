...
public final class AfdOriginsImpl implements AfdOrigins {
    ...
    public AfdOriginsImpl(AfdOriginsClient innerClient,
        com.azure.resourcemanager.cdn.generated.CdnManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public PagedIterable<AfdOrigin> listByOriginGroup(String resourceGroupName, String profileName,
        String originGroupName) {
        PagedIterable<AfdOriginInner> inner
            = this.serviceClient().listByOriginGroup(resourceGroupName, profileName, originGroupName);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new AfdOriginImpl(inner1, this.manager()));
    }
    ...
    public Response<AfdOrigin> getWithResponse(String resourceGroupName, String profileName, String originGroupName,
        String originName, Context context) {
        Response<AfdOriginInner> inner = this.serviceClient().getWithResponse(resourceGroupName, profileName,
            originGroupName, originName, context);
        if (inner != null) {
    ...
    public AfdOrigin getById(String id) {
        ...
        String originName = ResourceManagerUtils.getValueFromIdByName(id, "origins");
        if (originName == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
                String.format("The resource ID '%s' is not valid. Missing path segment 'origins'.", id)));
        }
        return this.getWithResponse(resourceGroupName, profileName, originGroupName, originName, Context.NONE)
            .getValue();
    }
