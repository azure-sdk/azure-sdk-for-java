...
public final class RequestHeaderMatchConditionParameters {
    ...
    private RequestHeaderMatchConditionParametersType typeName;
     ...
     */
    public RequestHeaderMatchConditionParametersType typeName() {
     ...
     */
    public RequestHeaderMatchConditionParameters withTypeName(RequestHeaderMatchConditionParametersType typeName) {
            ...
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException(
                        "Missing required property typeName in model RequestHeaderMatchConditionParameters"));
        }
        if (operator() == null) {
            throw LOGGER
                .logExceptionAsError(
