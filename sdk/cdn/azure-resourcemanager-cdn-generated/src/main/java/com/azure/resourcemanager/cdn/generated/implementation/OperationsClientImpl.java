...
import com.azure.resourcemanager.cdn.generated.models.OperationsListResult;
...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    OperationsClientImpl(CdnManagementClientImpl client) {
        this.service
    ...
    public interface OperationsService {
        ...
        Mono<Response<OperationsListResult>> list(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<OperationsListResult>> listNext(@PathParam(value = "nextLink", encoded = true) String nextLink,
