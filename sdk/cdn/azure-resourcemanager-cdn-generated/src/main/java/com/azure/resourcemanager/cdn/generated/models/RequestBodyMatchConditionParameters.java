 ...
 */
@Fluent
public final class RequestBodyMatchConditionParameters extends DeliveryRuleConditionParameters {
    /*
     * The typeName property.
     */
    private DeliveryRuleConditionParametersType typeName
        = DeliveryRuleConditionParametersType.DELIVERY_RULE_REQUEST_BODY_CONDITION_PARAMETERS;
     ...
     */
    public RequestBodyMatchConditionParameters withOperator(RequestBodyOperator operator) {
     ...
     * @return the RequestBodyMatchConditionParameters object itself.
     */
    public RequestBodyMatchConditionParameters withNegateCondition(Boolean negateCondition) {
     ...
     * @return the RequestBodyMatchConditionParameters object itself.
     */
    public RequestBodyMatchConditionParameters withMatchValues(List<String> matchValues) {
     ...
     * @return the RequestBodyMatchConditionParameters object itself.
     */
    public RequestBodyMatchConditionParameters withTransforms(List<Transform> transforms) {
        ...
        if (operator() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property operator in model RequestBodyMatchConditionParameters"));
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(RequestBodyMatchConditionParameters.class);
    ...
    /**
     * Reads an instance of RequestBodyMatchConditionParameters from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of RequestBodyMatchConditionParameters if the JsonReader was pointing to an instance of it,
     * or null if it was pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the RequestBodyMatchConditionParameters.
     */
    public static RequestBodyMatchConditionParameters fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            RequestBodyMatchConditionParameters deserializedRequestBodyMatchConditionParameters
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("operator".equals(fieldName)) {
                    deserializedRequestBodyMatchConditionParameters.operator
                        = RequestBodyOperator.fromString(reader.getString());
                } else if ("typeName".equals(fieldName)) {
                    deserializedRequestBodyMatchConditionParameters.typeName
                        = DeliveryRuleConditionParametersType.fromString(reader.getString());
                } else if ("negateCondition".equals(fieldName)) {
                    deserializedRequestBodyMatchConditionParameters.negateCondition
                        = reader.getNullable(JsonReader::getBoolean);
                } else if ("matchValues".equals(fieldName)) {
                    List<String> matchValues = reader.readArray(reader1 -> reader1.getString());
                    deserializedRequestBodyMatchConditionParameters.matchValues = matchValues;
                    ...
                    deserializedRequestBodyMatchConditionParameters.transforms = transforms;
                } else {
                    reader.skipChildren();
                }
            }

            return deserializedRequestBodyMatchConditionParameters;
        });
    }
}
