...
public final class RequestBodyMatchConditionParameters {
    ...
    private RequestBodyMatchConditionParametersType typeName;
     ...
     */
    public RequestBodyMatchConditionParametersType typeName() {
     ...
     */
    public RequestBodyMatchConditionParameters withTypeName(RequestBodyMatchConditionParametersType typeName) {
            ...
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException(
                        "Missing required property typeName in model RequestBodyMatchConditionParameters"));
        }
        if (operator() == null) {
            throw LOGGER
                .logExceptionAsError(
