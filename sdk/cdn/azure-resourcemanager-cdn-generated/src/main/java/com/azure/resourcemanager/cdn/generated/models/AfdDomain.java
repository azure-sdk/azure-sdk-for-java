...
public interface AfdDomain {
    ...
    /**
     * Gets the extendedProperties property: Key-Value pair representing migration properties for domains.
     *
    ...
    /**
     * Gets the referencedRoutePaths property: The JSON object list that contains the overall picture of how routes are
     * used for the shared custom domain across different profiles.
     *
     * @return the referencedRoutePaths value.
     */
    List<AfdDomainReferencedRoutePath> referencedRoutePaths();
    ...
    /**
     * Gets the profileName property: The name of the profile which holds the domain.
     *
    ...
    /**
     * Gets the preValidatedCustomDomainResourceId property: Resource reference to the Azure resource where custom
    ...
    interface DefinitionStages {
        ...
        interface WithCreate
            extends DefinitionStages.WithHostname,
                ...
                DefinitionStages.WithTlsSettings,
                DefinitionStages.WithAzureDnsZone,
                DefinitionStages.WithPreValidatedCustomDomainResourceId {
            /**
        ...
        /** The stage of the AfdDomain definition allowing to specify extendedProperties. */
        interface WithExtendedProperties {
            /**
             * Specifies the extendedProperties property: Key-Value pair representing migration properties for domains..
             *
        ...
        /** The stage of the AfdDomain definition allowing to specify preValidatedCustomDomainResourceId. */
        interface WithPreValidatedCustomDomainResourceId {
            /**
             * Specifies the preValidatedCustomDomainResourceId property: Resource reference to the Azure resource where
             * custom domain ownership was prevalidated.
             *
             * @param preValidatedCustomDomainResourceId Resource reference to the Azure resource where custom domain
             *     ownership was prevalidated.
             * @return the next definition stage.
             */
            WithCreate withPreValidatedCustomDomainResourceId(ResourceReference preValidatedCustomDomainResourceId);
        }
    }
    /**
    ...
    interface Update
        extends UpdateStages.WithTlsSettings,
            UpdateStages.WithAzureDnsZone,
            UpdateStages.WithPreValidatedCustomDomainResourceId {
        /**
    ...
    interface UpdateStages {
        ...
        /** The stage of the AfdDomain update allowing to specify preValidatedCustomDomainResourceId. */
        interface WithPreValidatedCustomDomainResourceId {
            /**
             * Specifies the preValidatedCustomDomainResourceId property: Resource reference to the Azure resource where
             * custom domain ownership was prevalidated.
             ...
             * @return the next definition stage.
             */
            Update withPreValidatedCustomDomainResourceId(ResourceReference preValidatedCustomDomainResourceId);
        }
    }
    /**
     ...
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     */
    void refreshValidationToken(Context context);
}
