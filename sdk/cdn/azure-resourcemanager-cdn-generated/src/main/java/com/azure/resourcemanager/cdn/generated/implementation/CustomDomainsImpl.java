...
public final class CustomDomainsImpl implements CustomDomains {
    ...
    public CustomDomainsImpl(CustomDomainsClient innerClient,
        com.azure.resourcemanager.cdn.generated.CdnManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public PagedIterable<CustomDomain> listByEndpoint(String resourceGroupName, String profileName,
        String endpointName) {
    ...
    public PagedIterable<CustomDomain> listByEndpoint(String resourceGroupName, String profileName, String endpointName,
        Context context) {
        PagedIterable<CustomDomainInner> inner
    ...
    public Response<CustomDomain> getWithResponse(String resourceGroupName, String profileName, String endpointName,
        String customDomainName, Context context) {
        Response<CustomDomainInner> inner = this.serviceClient().getWithResponse(resourceGroupName, profileName,
    ...
    public CustomDomain get(String resourceGroupName, String profileName, String endpointName,
    ...
    public CustomDomain delete(String resourceGroupName, String profileName, String endpointName,
        String customDomainName) {
        CustomDomainInner inner
    ...
    public CustomDomain disableCustomHttps(String resourceGroupName, String profileName, String endpointName,
        String customDomainName) {
        CustomDomainInner inner
    ...
    public CustomDomain disableCustomHttps(String resourceGroupName, String profileName, String endpointName,
        String customDomainName, Context context) {
        CustomDomainInner inner = this.serviceClient().disableCustomHttps(resourceGroupName, profileName, endpointName,
            customDomainName, context);
        if (inner != null) {
            return new CustomDomainImpl(inner, this.manager());
        } else {
            return null;
    ...
    public CustomDomain enableCustomHttps(String resourceGroupName, String profileName, String endpointName,
        String customDomainName) {
        CustomDomainInner inner
    ...
    public CustomDomain enableCustomHttps(String resourceGroupName, String profileName, String endpointName,
        ...
        CustomDomainInner inner = this.serviceClient().enableCustomHttps(resourceGroupName, profileName, endpointName,
            customDomainName, customDomainHttpsParameters, context);
        if (inner != null) {
            return new CustomDomainImpl(inner, this.manager());
        } else {
            return null;
    ...
    public CustomDomain getById(String id) {
        ...
        String customDomainName = ResourceManagerUtils.getValueFromIdByName(id, "customDomains");
        if (customDomainName == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
                String.format("The resource ID '%s' is not valid. Missing path segment 'customDomains'.", id)));
        }
        return this.getWithResponse(resourceGroupName, profileName, endpointName, customDomainName, Context.NONE)
            .getValue();
    }
