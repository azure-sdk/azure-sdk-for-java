...
public final class UrlPathMatchConditionParameters {
    ...
    private UrlPathMatchConditionParametersType typeName;
     ...
     */
    public UrlPathMatchConditionParametersType typeName() {
     ...
     */
    public UrlPathMatchConditionParameters withTypeName(UrlPathMatchConditionParametersType typeName) {
            ...
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException(
                        "Missing required property typeName in model UrlPathMatchConditionParameters"));
        }
        if (operator() == null) {
            throw LOGGER
                .logExceptionAsError(
