...
/** Resource collection API of AfdCustomDomains. */
public interface AfdCustomDomains {
    /**
     ...
     */
    PagedIterable<AfdDomain> listByProfile(String resourceGroupName, String profileName);
     ...
     * @return result of the request to list domains as paginated response with {@link PagedIterable}.
     */
    PagedIterable<AfdDomain> listByProfile(String resourceGroupName, String profileName, Context context);
     ...
     */
    AfdDomain get(String resourceGroupName, String profileName, String customDomainName);
     ...
     */
    Response<AfdDomain> getWithResponse(
     ...
     */
    ValidationToken refreshValidationToken(String resourceGroupName, String profileName, String customDomainName);
     ...
     *     resource group and profile along with {@link Response}.
     */
    Response<AfdDomain> getByIdWithResponse(String id, Context context);
    ...
    /**
     * Begins definition for a new AfdDomain resource.
     *
     * @param name resource name.
     * @return the first stage of the new AfdDomain definition.
     */
    AfdDomain.DefinitionStages.Blank define(String name);
}
