...
public final class AfdEndpointImpl implements AfdEndpoint, AfdEndpoint.Definition, AfdEndpoint.Update {
    ...
    public AfdEndpoint create() {
        this.innerObject = serviceManager.serviceClient().getAfdEndpoints().create(resourceGroupName, profileName,
            endpointName, this.innerModel(), Context.NONE);
        return this;
    }

    public AfdEndpoint create(Context context) {
        this.innerObject = serviceManager.serviceClient().getAfdEndpoints().create(resourceGroupName, profileName,
            endpointName, this.innerModel(), context);
        return this;
    }
    ...
    public AfdEndpoint apply() {
        this.innerObject = serviceManager.serviceClient().getAfdEndpoints().update(resourceGroupName, profileName,
            endpointName, updateEndpointUpdateProperties, Context.NONE);
        return this;
    }

    public AfdEndpoint apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getAfdEndpoints().update(resourceGroupName, profileName,
            endpointName, updateEndpointUpdateProperties, context);
        return this;
    }
    ...
    AfdEndpointImpl(AfdEndpointInner innerObject, com.azure.resourcemanager.cdn.generated.CdnManager serviceManager) {
        ...
        this.endpointName = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "afdEndpoints");
    }

    public AfdEndpoint refresh() {
        this.innerObject = serviceManager.serviceClient().getAfdEndpoints()
            .getWithResponse(resourceGroupName, profileName, endpointName, Context.NONE).getValue();
        return this;
    }

    public AfdEndpoint refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getAfdEndpoints()
            .getWithResponse(resourceGroupName, profileName, endpointName, context).getValue();
        return this;
    }
    ...
    public Response<ValidateCustomDomainOutput>
        ...
        return serviceManager.afdEndpoints().validateCustomDomainWithResponse(resourceGroupName, profileName,
            endpointName, customDomainProperties, context);
    }

    public ValidateCustomDomainOutput validateCustomDomain(ValidateCustomDomainInput customDomainProperties) {
        return serviceManager.afdEndpoints().validateCustomDomain(resourceGroupName, profileName, endpointName,
