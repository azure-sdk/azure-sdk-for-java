...
public final class AfdEndpointImpl implements AfdEndpoint, AfdEndpoint.Definition, AfdEndpoint.Update {
    ...
    public ResourceReference dedicatedVip() {
        return this.innerModel().dedicatedVip();
    }
    ...
    public AfdEndpointImpl withAutoGeneratedDomainNameLabelScope(
    ...
    public AfdEndpointImpl withDedicatedVip(ResourceReference dedicatedVip) {
        if (isInCreateMode()) {
            this.innerModel().withDedicatedVip(dedicatedVip);
            return this;
        } else {
            this.updateEndpointUpdateProperties.withDedicatedVip(dedicatedVip);
            return this;
        }
    }
