...
import com.azure.resourcemanager.cdn.generated.models.OriginProvisioningState;
...
public final class OriginImpl implements Origin, Origin.Definition, Origin.Update {
    ...
    public Origin create() {
        this.innerObject = serviceManager.serviceClient().getOrigins().create(resourceGroupName, profileName,
            endpointName, originName, this.innerModel(), Context.NONE);
        return this;
    }

    public Origin create(Context context) {
        this.innerObject = serviceManager.serviceClient().getOrigins().create(resourceGroupName, profileName,
            endpointName, originName, this.innerModel(), context);
        return this;
    }
    ...
    public Origin apply() {
        this.innerObject = serviceManager.serviceClient().getOrigins().update(resourceGroupName, profileName,
            endpointName, originName, updateOriginUpdateProperties, Context.NONE);
        return this;
    }

    public Origin apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getOrigins().update(resourceGroupName, profileName,
            endpointName, originName, updateOriginUpdateProperties, context);
        return this;
    }
    ...
    public Origin refresh() {
        this.innerObject = serviceManager.serviceClient().getOrigins()
            .getWithResponse(resourceGroupName, profileName, endpointName, originName, Context.NONE).getValue();
        return this;
    }

    public Origin refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getOrigins()
            .getWithResponse(resourceGroupName, profileName, endpointName, originName, context).getValue();
        return this;
    }
