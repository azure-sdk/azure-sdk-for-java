 ...
 */
@Fluent
public final class RemoteAddressMatchConditionParameters extends DeliveryRuleConditionParameters {
    /*
     * The typeName property.
     */
    private DeliveryRuleConditionParametersType typeName
        = DeliveryRuleConditionParametersType.DELIVERY_RULE_REMOTE_ADDRESS_CONDITION_PARAMETERS;
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("operator".equals(fieldName)) {
                    ...
                    deserializedRemoteAddressMatchConditionParameters.typeName
