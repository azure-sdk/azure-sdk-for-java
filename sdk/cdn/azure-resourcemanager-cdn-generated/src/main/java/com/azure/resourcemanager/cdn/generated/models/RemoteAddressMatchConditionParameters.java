...
public final class RemoteAddressMatchConditionParameters {
    ...
    private RemoteAddressMatchConditionParametersType typeName;
     ...
     */
    public RemoteAddressMatchConditionParametersType typeName() {
     ...
     */
    public RemoteAddressMatchConditionParameters withTypeName(RemoteAddressMatchConditionParametersType typeName) {
            ...
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException(
                        "Missing required property typeName in model RemoteAddressMatchConditionParameters"));
        }
        if (operator() == null) {
            throw LOGGER
                .logExceptionAsError(
