...
public final class AfdOriginGroupImpl implements AfdOriginGroup, AfdOriginGroup.Definition, AfdOriginGroup.Update {
    ...
    public SessionAffinityType sessionAffinityType() {
        return this.innerModel().sessionAffinityType();
    }
    ...
    public AfdOriginGroupImpl withSessionAffinityType(SessionAffinityType sessionAffinityType) {
        if (isInCreateMode()) {
            this.innerModel().withSessionAffinityType(sessionAffinityType);
            return this;
        } else {
            this.updateOriginGroupUpdateProperties.withSessionAffinityType(sessionAffinityType);
            return this;
        }
    }

    public AfdOriginGroupImpl withRouteType(RouteType routeType) {
        if (isInCreateMode()) {
            this.innerModel().withRouteType(routeType);
            return this;
        } else {
            this.updateOriginGroupUpdateProperties.withRouteType(routeType);
            return this;
        }
    }
