...
public final class RouteConfigurationOverrideActionParameters {
    ...
    private RouteConfigurationOverrideActionParametersType typeName;
     ...
     */
    public RouteConfigurationOverrideActionParametersType typeName() {
     ...
     */
    public RouteConfigurationOverrideActionParameters withTypeName(
        RouteConfigurationOverrideActionParametersType typeName) {
            ...
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException(
                        "Missing required property typeName in model RouteConfigurationOverrideActionParameters"));
        }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(RouteConfigurationOverrideActionParameters.class);
}
