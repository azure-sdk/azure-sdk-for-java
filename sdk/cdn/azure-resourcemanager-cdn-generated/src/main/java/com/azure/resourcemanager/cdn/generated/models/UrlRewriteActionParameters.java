 ...
 */
@Fluent
public final class UrlRewriteActionParameters extends DeliveryRuleActionParameters {
    /*
     * The typeName property.
     */
    private DeliveryRuleActionParametersType typeName
        = DeliveryRuleActionParametersType.DELIVERY_RULE_URL_REWRITE_ACTION_PARAMETERS;
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("sourcePattern".equals(fieldName)) {
                    ...
                    deserializedUrlRewriteActionParameters.typeName
