 ...
 */
@Fluent
public final class IsDeviceMatchConditionParameters extends DeliveryRuleConditionParameters {
    /*
     * The typeName property.
     */
    private DeliveryRuleConditionParametersType typeName
        = DeliveryRuleConditionParametersType.DELIVERY_RULE_IS_DEVICE_CONDITION_PARAMETERS;
     ...
     */
    private List<IsDeviceMatchValue> matchValues;
     ...
     */
    public List<IsDeviceMatchValue> matchValues() {
     ...
     * @return the IsDeviceMatchConditionParameters object itself.
     */
    public IsDeviceMatchConditionParameters withMatchValues(List<IsDeviceMatchValue> matchValues) {
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("operator".equals(fieldName)) {
                    ...
                    deserializedIsDeviceMatchConditionParameters.typeName
                    ...
                    List<IsDeviceMatchValue> matchValues
                        = reader.readArray(reader1 -> IsDeviceMatchValue.fromString(reader1.getString()));
