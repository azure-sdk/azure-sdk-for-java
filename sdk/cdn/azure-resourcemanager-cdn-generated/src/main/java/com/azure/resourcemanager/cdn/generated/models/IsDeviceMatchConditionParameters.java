...
public final class IsDeviceMatchConditionParameters {
    ...
    private IsDeviceMatchConditionParametersType typeName;
     ...
     */
    public IsDeviceMatchConditionParametersType typeName() {
     ...
     */
    public IsDeviceMatchConditionParameters withTypeName(IsDeviceMatchConditionParametersType typeName) {
            ...
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException(
                        "Missing required property typeName in model IsDeviceMatchConditionParameters"));
        }
        if (operator() == null) {
            throw LOGGER
                .logExceptionAsError(
