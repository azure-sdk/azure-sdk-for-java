...
public final class ServerPortMatchConditionParameters {
    ...
    private ServerPortMatchConditionParametersType typeName;
     ...
     */
    public ServerPortMatchConditionParametersType typeName() {
     ...
     */
    public ServerPortMatchConditionParameters withTypeName(ServerPortMatchConditionParametersType typeName) {
            ...
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException(
                        "Missing required property typeName in model ServerPortMatchConditionParameters"));
        }
        if (operator() == null) {
            throw LOGGER
                .logExceptionAsError(
