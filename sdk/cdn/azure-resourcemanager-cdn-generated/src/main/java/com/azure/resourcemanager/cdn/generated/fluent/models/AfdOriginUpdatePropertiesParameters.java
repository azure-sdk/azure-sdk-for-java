...
import com.azure.resourcemanager.cdn.generated.models.ClientIpPreservationState;
...
public class AfdOriginUpdatePropertiesParameters {
    ...
    /*
     * The ports used for the TCP/UDP connection to the customer's backend. Must be between 1024 and 65535 excluding
     * reserved ports. The ports can be a comma separated list or a valid range like 5050-5090
     */
    @JsonProperty(value = "OriginPorts")
    private String originPorts;

    /*
     * Preserves the client side source IP allowing the back-end to see the IP address of the client. This can then be
     * used by applications for applying any rules. Valid options are 'Enabled' or 'Disabled'
     */
    @JsonProperty(value = "ClientIPPreservationState")
    private ClientIpPreservationState clientIpPreservationState;
    ...
    /**
     * Get the originPorts property: The ports used for the TCP/UDP connection to the customer's backend. Must be
     ...
     */
    public String originPorts() {
        return this.originPorts;
    }

    /**
     * Set the originPorts property: The ports used for the TCP/UDP connection to the customer's backend. Must be
     * between 1024 and 65535 excluding reserved ports. The ports can be a comma separated list or a valid range like
     * 5050-5090.
     *
     * @param originPorts the originPorts value to set.
     * @return the AfdOriginUpdatePropertiesParameters object itself.
     */
    public AfdOriginUpdatePropertiesParameters withOriginPorts(String originPorts) {
        this.originPorts = originPorts;
        return this;
    }

    /**
     * Get the clientIpPreservationState property: Preserves the client side source IP allowing the back-end to see the
     ...
     */
    public ClientIpPreservationState clientIpPreservationState() {
        return this.clientIpPreservationState;
    }

    /**
     * Set the clientIpPreservationState property: Preserves the client side source IP allowing the back-end to see the
     * IP address of the client. This can then be used by applications for applying any rules. Valid options are
     * 'Enabled' or 'Disabled'.
     *
     * @param clientIpPreservationState the clientIpPreservationState value to set.
     * @return the AfdOriginUpdatePropertiesParameters object itself.
     */
    public AfdOriginUpdatePropertiesParameters withClientIpPreservationState(
        ClientIpPreservationState clientIpPreservationState) {
        this.clientIpPreservationState = clientIpPreservationState;
        return this;
    }
