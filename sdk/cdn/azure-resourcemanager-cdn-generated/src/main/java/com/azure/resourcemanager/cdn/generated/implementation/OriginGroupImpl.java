...
public final class OriginGroupImpl implements OriginGroup, OriginGroup.Definition, OriginGroup.Update {
    ...
    public OriginGroup create() {
        this.innerObject = serviceManager.serviceClient().getOriginGroups().create(resourceGroupName, profileName,
            endpointName, originGroupName, this.innerModel(), Context.NONE);
        return this;
    }

    public OriginGroup create(Context context) {
        this.innerObject = serviceManager.serviceClient().getOriginGroups().create(resourceGroupName, profileName,
            endpointName, originGroupName, this.innerModel(), context);
        return this;
    }
    ...
    public OriginGroup apply() {
        this.innerObject = serviceManager.serviceClient().getOriginGroups().update(resourceGroupName, profileName,
            endpointName, originGroupName, updateOriginGroupUpdateProperties, Context.NONE);
        return this;
    }

    public OriginGroup apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getOriginGroups().update(resourceGroupName, profileName,
            endpointName, originGroupName, updateOriginGroupUpdateProperties, context);
        return this;
    }
    ...
    public OriginGroup refresh() {
        this.innerObject = serviceManager.serviceClient().getOriginGroups()
            .getWithResponse(resourceGroupName, profileName, endpointName, originGroupName, Context.NONE).getValue();
        return this;
    }

    public OriginGroup refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getOriginGroups()
            .getWithResponse(resourceGroupName, profileName, endpointName, originGroupName, context).getValue();
        return this;
    }
    ...
    public OriginGroupImpl withTrafficRestorationTimeToHealedOrNewEndpointsInMinutes(
        ...
        if (isInCreateMode()) {
            this.innerModel().withTrafficRestorationTimeToHealedOrNewEndpointsInMinutes(
                trafficRestorationTimeToHealedOrNewEndpointsInMinutes);
            return this;
        } else {
            this.updateOriginGroupUpdateProperties.withTrafficRestorationTimeToHealedOrNewEndpointsInMinutes(
                trafficRestorationTimeToHealedOrNewEndpointsInMinutes);
            return this;
        }
    }
    ...
    public OriginGroupImpl withResponseBasedOriginErrorDetectionSettings(
        ...
        if (isInCreateMode()) {
            ...
            this.updateOriginGroupUpdateProperties
