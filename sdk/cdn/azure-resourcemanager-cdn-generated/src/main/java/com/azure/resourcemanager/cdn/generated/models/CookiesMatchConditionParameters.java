...
public final class CookiesMatchConditionParameters {
    ...
    private CookiesMatchConditionParametersType typeName;
     ...
     */
    public CookiesMatchConditionParametersType typeName() {
     ...
     */
    public CookiesMatchConditionParameters withTypeName(CookiesMatchConditionParametersType typeName) {
            ...
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException(
                        "Missing required property typeName in model CookiesMatchConditionParameters"));
        }
        if (operator() == null) {
            throw LOGGER
                .logExceptionAsError(
