 ...
 */
@Fluent
public final class CookiesMatchConditionParameters extends DeliveryRuleConditionParameters {
    /*
     * The typeName property.
     */
    private DeliveryRuleConditionParametersType typeName
        = DeliveryRuleConditionParametersType.DELIVERY_RULE_COOKIES_CONDITION_PARAMETERS;
     ...
     * @return An instance of CookiesMatchConditionParameters if the JsonReader was pointing to an instance of it, or
     * null if it was pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the CookiesMatchConditionParameters.
     */
    public static CookiesMatchConditionParameters fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            CookiesMatchConditionParameters deserializedCookiesMatchConditionParameters
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("operator".equals(fieldName)) {
                    deserializedCookiesMatchConditionParameters.operator
                        = CookiesOperator.fromString(reader.getString());
                } else if ("typeName".equals(fieldName)) {
                    deserializedCookiesMatchConditionParameters.typeName
                        = DeliveryRuleConditionParametersType.fromString(reader.getString());
                } else if ("selector".equals(fieldName)) {
                    deserializedCookiesMatchConditionParameters.selector = reader.getString();
                } else if ("negateCondition".equals(fieldName)) {
                    deserializedCookiesMatchConditionParameters.negateCondition
                        = reader.getNullable(JsonReader::getBoolean);
                } else if ("matchValues".equals(fieldName)) {
                    List<String> matchValues = reader.readArray(reader1 -> reader1.getString());
                    deserializedCookiesMatchConditionParameters.matchValues = matchValues;
                    ...
                    deserializedCookiesMatchConditionParameters.transforms = transforms;
                } else {
                    reader.skipChildren();
                }
            }

            return deserializedCookiesMatchConditionParameters;
        });
    }
}
