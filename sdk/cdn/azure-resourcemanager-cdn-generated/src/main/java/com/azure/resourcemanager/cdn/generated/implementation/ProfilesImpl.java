...
public final class ProfilesImpl implements Profiles {
    ...
    public CanMigrateResult canMigrate(String resourceGroupName, CanMigrateParameters canMigrateParameters,
        Context context) {
        CanMigrateResultInner inner = this.serviceClient().canMigrate(resourceGroupName, canMigrateParameters, context);
        if (inner != null) {
            return new CanMigrateResultImpl(inner, this.manager());
        } else {
            return null;
    ...
    public Response<SupportedOptimizationTypesListResult>
    ...
    public SupportedOptimizationTypesListResult listSupportedOptimizationTypes(String resourceGroupName,
        String profileName) {
