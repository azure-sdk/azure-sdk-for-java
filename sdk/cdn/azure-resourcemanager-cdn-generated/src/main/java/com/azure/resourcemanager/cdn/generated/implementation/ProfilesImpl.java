...
public final class ProfilesImpl implements Profiles {
    ...
    public Response<CanMigrateResult> canMigrateWithResponse(
        String resourceGroupName, CanMigrateParameters canMigrateParameters, Context context) {
        Response<CanMigrateResultInner> inner =
            this.serviceClient().canMigrateWithResponse(resourceGroupName, canMigrateParameters, context);
        if (inner != null) {
            return new SimpleResponse<>(
                inner.getRequest(),
                inner.getStatusCode(),
                inner.getHeaders(),
                new CanMigrateResultImpl(inner.getValue(), this.manager()));
        } else {
            return null;
        }
    }

    public CanMigrateResult canMigrate(String resourceGroupName, CanMigrateParameters canMigrateParameters) {
        CanMigrateResultInner inner = this.serviceClient().canMigrate(resourceGroupName, canMigrateParameters);
        if (inner != null) {
            return new CanMigrateResultImpl(inner, this.manager());
        } else {
            return null;
        }
    }

    public MigrateResult migrate(String resourceGroupName, MigrationParameters migrationParameters) {
        MigrateResultInner inner = this.serviceClient().migrate(resourceGroupName, migrationParameters);
        if (inner != null) {
            return new MigrateResultImpl(inner, this.manager());
        } else {
            return null;
        }
    }

    public MigrateResult migrate(String resourceGroupName, MigrationParameters migrationParameters, Context context) {
        MigrateResultInner inner = this.serviceClient().migrate(resourceGroupName, migrationParameters, context);
        if (inner != null) {
            return new MigrateResultImpl(inner, this.manager());
        } else {
            return null;
    ...
    public void migrationCommit(String resourceGroupName, String profileName) {
        this.serviceClient().migrationCommit(resourceGroupName, profileName);
    }

    public void migrationCommit(String resourceGroupName, String profileName, Context context) {
        this.serviceClient().migrationCommit(resourceGroupName, profileName, context);
    }
