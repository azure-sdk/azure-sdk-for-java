...
public final class OriginGroupOverrideActionParameters {
    ...
    private OriginGroupOverrideActionParametersType typeName;
     ...
     */
    public OriginGroupOverrideActionParametersType typeName() {
     ...
     */
    public OriginGroupOverrideActionParameters withTypeName(OriginGroupOverrideActionParametersType typeName) {
            ...
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException(
                        "Missing required property typeName in model OriginGroupOverrideActionParameters"));
        }
        if (originGroup() == null) {
            throw LOGGER
                .logExceptionAsError(
