 ...
 */
@Fluent
public final class OriginGroupOverrideActionParameters extends DeliveryRuleActionParameters {
    /*
     * The typeName property.
     */
    private DeliveryRuleActionParametersType typeName
        = DeliveryRuleActionParametersType.DELIVERY_RULE_ORIGIN_GROUP_OVERRIDE_ACTION_PARAMETERS;
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("originGroup".equals(fieldName)) {
                    ...
                    deserializedOriginGroupOverrideActionParameters.typeName
