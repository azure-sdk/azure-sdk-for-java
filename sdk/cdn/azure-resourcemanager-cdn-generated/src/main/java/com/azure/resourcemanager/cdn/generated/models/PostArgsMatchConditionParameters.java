...
public final class PostArgsMatchConditionParameters {
    ...
    private PostArgsMatchConditionParametersType typeName;
     ...
     */
    public PostArgsMatchConditionParametersType typeName() {
     ...
     */
    public PostArgsMatchConditionParameters withTypeName(PostArgsMatchConditionParametersType typeName) {
            ...
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException(
                        "Missing required property typeName in model PostArgsMatchConditionParameters"));
        }
        if (operator() == null) {
            throw LOGGER
                .logExceptionAsError(
