...
public final class HttpVersionMatchConditionParameters {
    ...
    private HttpVersionMatchConditionParametersType typeName;
     ...
     */
    public HttpVersionMatchConditionParametersType typeName() {
     ...
     */
    public HttpVersionMatchConditionParameters withTypeName(HttpVersionMatchConditionParametersType typeName) {
            ...
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException(
                        "Missing required property typeName in model HttpVersionMatchConditionParameters"));
        }
        if (operator() == null) {
            throw LOGGER
                .logExceptionAsError(
