...
public final class AfdDomainProperties extends AfdDomainUpdatePropertiesParameters {
    ...
    /*
     * The JSON object list that contains the overall picture of how routes are used for the shared custom domain
     * across different profiles.
     */
    @JsonProperty(value = "referencedRoutePaths", access = JsonProperty.Access.WRITE_ONLY)
    private List<AfdDomainReferencedRoutePath> referencedRoutePaths;
    ...
    /**
     * Get the referencedRoutePaths property: The JSON object list that contains the overall picture of how routes are
    ...
    public List<AfdDomainReferencedRoutePath> referencedRoutePaths() {
        return this.referencedRoutePaths;
    }
    ...
    public void validate() {
        ...
        if (referencedRoutePaths() != null) {
            referencedRoutePaths().forEach(e -> e.validate());
        }
    }
