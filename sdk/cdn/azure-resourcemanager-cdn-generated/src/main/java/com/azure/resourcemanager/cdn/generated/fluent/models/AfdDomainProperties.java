...
public final class AfdDomainProperties extends AfdDomainUpdatePropertiesParameters {
     ...
     */
    @JsonProperty(value = "referencedRoutePath", access = JsonProperty.Access.WRITE_ONLY)
    private AfdDomainReferencedRoutePathList referencedRoutePath;
    ...
    /**
     * Get the referencedRoutePath property: The JSON object list that contains the overall picture of how routes are
    ...
    public AfdDomainReferencedRoutePathList referencedRoutePath() {
        return this.referencedRoutePath;
    }
    ...
    public void validate() {
        ...
        if (referencedRoutePath() != null) {
            referencedRoutePath().validate();
        }
    }
