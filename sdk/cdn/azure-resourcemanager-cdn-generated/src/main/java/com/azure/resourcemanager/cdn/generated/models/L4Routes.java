...
/** Resource collection API of L4Routes. */
public interface L4Routes {
    /**
     ...
     */
    PagedIterable<L4Route> listByEndpoint(String resourceGroupName, String profileName, String endpointName);
     ...
     * @return result of the request to list L4 routes as paginated response with {@link PagedIterable}.
     */
    PagedIterable<L4Route> listByEndpoint(
     ...
     */
    Response<L4Route> getWithResponse(
     ...
     *     profile, and AzureFrontDoor endpoint.
     */
    L4Route get(String resourceGroupName, String profileName, String endpointName, String routeName);
     ...
     *     profile, and AzureFrontDoor endpoint along with {@link Response}.
     */
    Response<L4Route> getByIdWithResponse(String id, Context context);
    ...
    /**
     * Begins definition for a new L4Route resource.
     *
     * @param name resource name.
     * @return the first stage of the new L4Route definition.
     */
    L4Route.DefinitionStages.Blank define(String name);
}
