...
public final class AfdProfilesImpl implements AfdProfiles {
    ...
    public Response<CheckEndpointNameAvailabilityOutput> checkEndpointNameAvailabilityWithResponse(
        ...
        Response<CheckEndpointNameAvailabilityOutputInner> inner
            = this.serviceClient().checkEndpointNameAvailabilityWithResponse(resourceGroupName, profileName,
    ...
    public Response<CheckNameAvailabilityOutput> checkHostnameAvailabilityWithResponse(String resourceGroupName,
        ...
        Response<CheckNameAvailabilityOutputInner> inner = this.serviceClient().checkHostnameAvailabilityWithResponse(
    ...
    public CheckNameAvailabilityOutput checkHostnameAvailability(String resourceGroupName, String profileName,
        ...
        CheckNameAvailabilityOutputInner inner = this.serviceClient().checkHostnameAvailability(resourceGroupName,
            profileName, checkHostnameAvailabilityInput);
        if (inner != null) {
    ...
    public Response<ValidateSecretOutput> validateSecretWithResponse(String resourceGroupName, String profileName,
        ...
        Response<ValidateSecretOutputInner> inner = this.serviceClient().validateSecretWithResponse(resourceGroupName,
            profileName, validateSecretInput, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
