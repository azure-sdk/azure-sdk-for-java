...
public final class LoadBalancingSettingsParameters {
     ...
     */
    @JsonProperty(value = "capacityConsciousThreshold")
    private Integer capacityConsciousThreshold;
    ...
    /**
     * Get the capacityConsciousThreshold property: The threshold at which additional backends are added for capacity
     * based load balancing.
     *
     * @return the capacityConsciousThreshold value.
     */
    public Integer capacityConsciousThreshold() {
        return this.capacityConsciousThreshold;
    }

    /**
     * Set the capacityConsciousThreshold property: The threshold at which additional backends are added for capacity
     * based load balancing.
     *
     * @param capacityConsciousThreshold the capacityConsciousThreshold value to set.
     * @return the LoadBalancingSettingsParameters object itself.
     */
    public LoadBalancingSettingsParameters withCapacityConsciousThreshold(Integer capacityConsciousThreshold) {
        this.capacityConsciousThreshold = capacityConsciousThreshold;
        return this;
    }
