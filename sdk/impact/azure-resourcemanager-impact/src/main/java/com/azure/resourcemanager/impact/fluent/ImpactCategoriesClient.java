...
public interface ImpactCategoriesClient {
    ...
    PagedIterable<ImpactCategoryInner> list();
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<ImpactCategoryInner> list(String categoryName, String resourceType, Context context);
    ...
    Response<ImpactCategoryInner> getWithResponse(String impactCategoryName, Context context);
