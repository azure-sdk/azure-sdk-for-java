...
public final class ImpactCategoriesClientImpl implements ImpactCategoriesClient {
    ...
    public interface ImpactCategoriesService {
        ...
        Mono<Response<ImpactCategoryListResult>> list(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ImpactCategoryInner>> get(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
    ...
    private Mono<PagedResponse<ImpactCategoryInner>> listSinglePageAsync(String categoryName, String resourceType) {
    ...
    private PagedFlux<ImpactCategoryInner> listAsync(String categoryName, String resourceType) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<ImpactCategoryInner> listAsync() {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<ImpactCategoryInner> listAsync(String categoryName, String resourceType, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<ImpactCategoryInner> list() {
        final String categoryName = null;
        final String resourceType = null;
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<ImpactCategoryInner> list(String categoryName, String resourceType, Context context) {
