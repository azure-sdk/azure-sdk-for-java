...
public final class ImpactCategoriesImpl implements ImpactCategories {
    ...
    public PagedIterable<ImpactCategory> list() {
        PagedIterable<ImpactCategoryInner> inner = this.serviceClient().list();
        return ResourceManagerUtils.mapPage(inner, inner1 -> new ImpactCategoryImpl(inner1, this.manager()));
    }

    public PagedIterable<ImpactCategory> list(String categoryName, String resourceType, Context context) {
        PagedIterable<ImpactCategoryInner> inner = this.serviceClient().list(categoryName, resourceType, context);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new ImpactCategoryImpl(inner1, this.manager()));
    }
