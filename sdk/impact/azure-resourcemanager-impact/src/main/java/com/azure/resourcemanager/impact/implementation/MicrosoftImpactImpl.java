...
public final class MicrosoftImpactImpl implements MicrosoftImpact {
    ...
    /**
     * The TopologyImpactsClient object to access its operations.
     */
    private final TopologyImpactsClient topologyImpacts;

    /**
     * Gets the TopologyImpactsClient object to access its operations.
     * 
     * @return the TopologyImpactsClient object.
     */
    public TopologyImpactsClient getTopologyImpacts() {
        return this.topologyImpacts;
    }
    ...
    MicrosoftImpactImpl(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter, Duration defaultPollInterval,
        ...
        this.topologyImpacts = new TopologyImpactsClientImpl(this);
