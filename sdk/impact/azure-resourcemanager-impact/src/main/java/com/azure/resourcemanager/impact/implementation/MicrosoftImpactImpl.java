...
public final class MicrosoftImpactImpl implements MicrosoftImpact {
    ...
    /**
     * The UploadServicesClient object to access its operations.
     */
    private final UploadServicesClient uploadServices;

    /**
     * Gets the UploadServicesClient object to access its operations.
     * 
     * @return the UploadServicesClient object.
     */
    public UploadServicesClient getUploadServices() {
    ...
    MicrosoftImpactImpl(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter, Duration defaultPollInterval,
        ...
        this.uploadServices = new UploadServicesClientImpl(this);
