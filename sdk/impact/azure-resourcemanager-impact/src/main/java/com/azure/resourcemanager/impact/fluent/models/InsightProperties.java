...
public final class InsightProperties implements JsonSerializable<InsightProperties> {
     ...
     * @return the InsightProperties object itself.
     */
    public InsightProperties withAdditionalDetails(Object additionalDetails) {
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeUntypedField("additionalDetails", this.additionalDetails);
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("category".equals(fieldName)) {
                    ...
                    deserializedInsightProperties.additionalDetails = reader.readUntyped();
                } else {
                    reader.skipChildren();
                }
            }
