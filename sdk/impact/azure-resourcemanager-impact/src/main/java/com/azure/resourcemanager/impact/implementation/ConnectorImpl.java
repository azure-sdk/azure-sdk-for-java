...
public final class ConnectorImpl implements Connector, Connector.Definition, Connector.Update {
    ...
    public OffsetDateTime lastRunTimestamp() {
        return this.innerModel().lastRunTimestamp();
    }
    ...
    public ConnectorImpl withConnectorType(Platform connectorType) {
        if (isInCreateMode()) {
            this.innerModel().withConnectorType(connectorType);
            return this;
        } else {
            this.updateProperties.withConnectorType(connectorType);
            return this;
        }
    }

    public ConnectorImpl withFilters(String filters) {
        if (isInCreateMode()) {
            this.innerModel().withFilters(filters);
            return this;
        } else {
            this.updateProperties.withFilters(filters);
            return this;
        }
    }
