...
- [Create](#topologyimpacts_create)
- [Delete](#topologyimpacts_delete)
- [Get](#topologyimpacts_get)
- [List](#topologyimpacts_list)
...
public final class ConnectorsCreateOrUpdateSamples {
    ...
    public static void connectorsCreateOrUpdate(com.azure.resourcemanager.impact.ImpactManager manager) {
        manager.connectors()
            ...
            .withConnectorType(Platform.AZURE_MONITOR)
...
public final class ConnectorsDeleteSamples {
    /*
     * x-ms-original-file:
     * specification/impact/resource-manager/Microsoft.Impact/preview/2023-12-01-preview/examples/Connectors_Delete.json
     */
    /**
...
public final class ConnectorsGetSamples {
    /*
     * x-ms-original-file:
     * specification/impact/resource-manager/Microsoft.Impact/preview/2023-12-01-preview/examples/Connectors_Get.json
     */
    /**
...
public final class ConnectorsUpdateSamples {
    /*
     * x-ms-original-file:
     * specification/impact/resource-manager/Microsoft.Impact/preview/2023-12-01-preview/examples/Connectors_Update.json
     */
    /**
    ...
    public static void connectorsUpdate(com.azure.resourcemanager.impact.ImpactManager manager) {
        ...
        resource.update().withConnectorType(Platform.AZURE_MONITOR).withFilters("test filters").apply();
    }
}
```
...
public final class ImpactCategoriesGetSamples {
    /*
     * x-ms-original-file:
     * specification/impact/resource-manager/Microsoft.Impact/preview/2023-12-01-preview/examples/ImpactCategories_Get.
     * json
     */
    /**
...
public final class InsightsCreateSamples {
    /*
     * x-ms-original-file:
     * specification/impact/resource-manager/Microsoft.Impact/preview/2023-12-01-preview/examples/Insights_Create.json
     */
    /**
...
public final class InsightsDeleteSamples {
    /*
     * x-ms-original-file:
     * specification/impact/resource-manager/Microsoft.Impact/preview/2023-12-01-preview/examples/Insights_Delete.json
     */
    /**
...
public final class OperationsListSamples {
    /*
     * x-ms-original-file:
     * specification/impact/resource-manager/Microsoft.Impact/preview/2023-12-01-preview/examples/Operations_List.json
     */
    /**
...
public final class WorkloadImpactsCreateSamples {
    ...
    public static void reportingAvailabilityRelatedImpact(com.azure.resourcemanager.impact.ImpactManager manager) {
        manager.workloadImpacts()
            ...
            .withWorkload(new Workload().withContext("webapp/scenario1").withToolset(Toolset.OTHER))
            .withClientIncidentDetails(
                new ClientIncidentDetails().withClientIncidentId("AA123").withClientIncidentSource(IncidentSource.JIRA))
            .create();
    }
...
public final class WorkloadImpactsDeleteSamples {
    /*
     * x-ms-original-file:
     * specification/impact/resource-manager/Microsoft.Impact/preview/2023-12-01-preview/examples/WorkloadImpact_Delete.
     * json
     */
    /**
...
public final class WorkloadImpactsGetSamples {
    /*
     * x-ms-original-file:
     * specification/impact/resource-manager/Microsoft.Impact/preview/2023-12-01-preview/examples/WorkloadImpact_Get.
     * json
     */
    /**
