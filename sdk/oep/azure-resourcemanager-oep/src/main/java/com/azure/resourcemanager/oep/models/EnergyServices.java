...
public interface EnergyServices {
     ...
     */
    DataPartitionAddOrRemoveRequest addPartition(String resourceGroupName, String resourceName);
     ...
     * @return defines the partition add/ delete action properties.
     */
    DataPartitionAddOrRemoveRequest removePartition(String resourceGroupName, String resourceName);
