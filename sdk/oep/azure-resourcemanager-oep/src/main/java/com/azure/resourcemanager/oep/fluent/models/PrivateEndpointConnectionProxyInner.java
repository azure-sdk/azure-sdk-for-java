...
public final class PrivateEndpointConnectionProxyInner extends ProxyResource {
     ...
     */
    public PrivateEndpointConnectionProxyInner withEtag(String etag) {
        this.etag = etag;
        return this;
    }
     ...
     * @return the PrivateEndpointConnectionProxyInner object itself.
     */
    public PrivateEndpointConnectionProxyInner withProvisioningState(
        PrivateEndpointConnectionProxyProvisioningState provisioningState) {
        if (this.innerProperties() == null) {
            this.innerProperties = new PrivateEndpointConnectionProxyProperties();
        }
