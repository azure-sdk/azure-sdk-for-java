...
import com.azure.resourcemanager.oep.fluent.PrivateEndpointConnectionsClient;
import com.azure.resourcemanager.oep.fluent.models.PrivateEndpointConnectionInner;
import com.azure.resourcemanager.oep.models.PrivateEndpointConnectionListResult;
...
public final class PrivateEndpointConnectionsClientImpl implements PrivateEndpointConnectionsClient {
     ...
     */
    PrivateEndpointConnectionsClientImpl(OpenEnergyPlatformManagementServiceAPIsImpl client) {
        this.service =
            RestProxy
                .create(
    ...
    /**
     * The interface defining all the services for OpenEnergyPlatformManagementServiceAPIsPrivateEndpointConnections to
    ...
    public interface PrivateEndpointConnectionsService {
        ...
        Mono<Response<PrivateEndpointConnectionListResult>> listByOakInstance(
    ...
    private Mono<PagedResponse<PrivateEndpointConnectionInner>> listByOakInstanceSinglePageAsync(
    ...
    private PagedFlux<PrivateEndpointConnectionInner> listByOakInstanceAsync(
        String resourceGroupName, String resourceName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<PrivateEndpointConnectionInner> listByOakInstance(
        String resourceGroupName, String resourceName) {
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the specified private endpoint connection associated with the OAK Instance along with {@link Response} on
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the specified private endpoint connection associated with the OAK Instance on successful completion of
     *     {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
