...
import com.azure.resourcemanager.oep.models.PrivateEndpointConnectionProvisioningState;
...
public final class PrivateEndpointConnectionImpl
    ...
    public PrivateEndpointConnectionImpl withExistingEnergyService(String resourceGroupName, String resourceName) {
    ...
    PrivateEndpointConnectionImpl(String name, com.azure.resourcemanager.oep.OepManager serviceManager) {
    ...
    PrivateEndpointConnectionImpl(
        PrivateEndpointConnectionInner innerObject, com.azure.resourcemanager.oep.OepManager serviceManager) {
