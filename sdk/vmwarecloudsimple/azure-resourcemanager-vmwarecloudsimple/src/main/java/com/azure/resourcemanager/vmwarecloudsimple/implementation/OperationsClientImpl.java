...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    OperationsClientImpl(VMwareCloudSimpleImpl client) {
        this.service =
    ...
    /**
     * The interface defining all the services for VMwareCloudSimpleOperations to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{$host}")
    ...
    private interface OperationsService {
        ...
        Mono<Response<AvailableOperationsListResponse>> list(
        ...
        @Headers({"Content-Type: application/json"})
        @Get(
            "/subscriptions/{subscriptionId}/providers/Microsoft.VMwareCloudSimple/locations/{regionId}"
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<AvailableOperationsListResponse>> listNext(
    ...
    private Mono<PagedResponse<AvailableOperationInner>> listSinglePageAsync() {
        ...
        return FluxUtil
            ...
            .<PagedResponse<AvailableOperationInner>>map(
                res ->
