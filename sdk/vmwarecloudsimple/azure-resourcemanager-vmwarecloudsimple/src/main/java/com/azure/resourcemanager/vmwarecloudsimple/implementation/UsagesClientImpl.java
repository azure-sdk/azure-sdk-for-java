...
public final class UsagesClientImpl implements UsagesClient {
    ...
    /**
     * The interface defining all the services for VMwareCloudSimpleUsages to be used by the proxy service to perform
     * REST calls.
     */
    @Host("{$host}")
    ...
    public PagedIterable<UsageInner> list(String regionId) {
        final String filter = null;
        return new PagedIterable<>(listAsync(regionId, filter));
    }
    ...
    public PagedIterable<UsageInner> list(String regionId, String filter, Context context) {
        return new PagedIterable<>(listAsync(regionId, filter, context));
    }
