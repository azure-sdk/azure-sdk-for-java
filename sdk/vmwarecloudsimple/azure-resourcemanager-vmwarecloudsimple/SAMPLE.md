...
public final class DedicatedCloudNodesDeleteSamples {
    ...
    public static void deleteDedicatedCloudNode(
        com.azure.resourcemanager.vmwarecloudsimple.VMwareCloudSimpleManager manager) {
        manager.dedicatedCloudNodes().deleteByResourceGroupWithResponse("myResourceGroup", "myNode", Context.NONE);
    }
}
```
...
public final class OperationsGetSamples {
    ...
    public static void getFailedOperationResult(
        ...
        manager
            .operations()
            .getWithResponse(
                "westus2", "https://management.azure.com/", "d030bb3f-7d53-11e9-8e09-9a86872085ff", Context.NONE);
    }
    ...
    public static void getOperationResult(
        ...
        manager
            .operations()
            .getWithResponse(
                "westus2", "https://management.azure.com/", "f8e1c8f1-7d52-11e9-8e07-9a86872085ff", Context.NONE);
    }
}
```
...
public final class VirtualMachinesDeleteSamples {
    ...
    public static void deleteVirtualMachine(
        ...
        manager
            .virtualMachines()
            .delete("myResourceGroup", "https://management.azure.com/", "myVirtualMachine", Context.NONE);
    }
}
```
...
public final class VirtualMachinesStartSamples {
    ...
    public static void startVirtualMachine(
        ...
        manager
            .virtualMachines()
            .start("myResourceGroup", "https://management.azure.com/", "myVirtualMachine", Context.NONE);
    }
}
```
