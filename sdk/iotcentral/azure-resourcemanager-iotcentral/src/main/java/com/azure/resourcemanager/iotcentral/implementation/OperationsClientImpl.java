...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    OperationsClientImpl(IotCentralClientImpl client) {
        this.service =
    ...
    /**
     * The interface defining all the services for IotCentralClientOperations to be used by the proxy service to perform
     * REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "IotCentralClientOper")
