...
/**
 * Entry point to IotCentralManager.
...
public final class IotCentralManager {
    ...
    private IotCentralManager(HttpPipeline httpPipeline, AzureProfile profile, Duration defaultPollInterval) {
        ...
        this.clientObject = new IotCentralClientBuilder().pipeline(httpPipeline)
    ...
    public static IotCentralManager authenticate(HttpPipeline httpPipeline, AzureProfile profile) {
        Objects.requireNonNull(httpPipeline, "'httpPipeline' cannot be null.");
        Objects.requireNonNull(profile, "'profile' cannot be null.");
        return new IotCentralManager(httpPipeline, profile, null);
    }
    ...
    public static final class Configurable {
        ...
        private static final Map<String, String> PROPERTIES
            = CoreUtils.getProperties("azure-resourcemanager-iotcentral.properties");
    ...
    /**
     * Gets wrapped service client IotCentralClient providing direct access to the underlying auto-generated API
     * implementation, based on Azure REST API.
     * 
     * @return Wrapped service client IotCentralClient.
     */
