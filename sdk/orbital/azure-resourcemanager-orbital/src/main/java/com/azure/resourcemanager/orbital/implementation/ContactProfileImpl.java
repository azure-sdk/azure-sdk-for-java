...
public final class ContactProfileImpl implements ContactProfile, ContactProfile.Definition, ContactProfile.Update {
    ...
    public ContactProfile create() {
        this.innerObject = serviceManager.serviceClient().getContactProfiles().createOrUpdate(resourceGroupName,
            contactProfileName, this.innerModel(), Context.NONE);
        return this;
    }

    public ContactProfile create(Context context) {
        this.innerObject = serviceManager.serviceClient().getContactProfiles().createOrUpdate(resourceGroupName,
            contactProfileName, this.innerModel(), context);
        return this;
    }
    ...
    public ContactProfile apply() {
        this.innerObject = serviceManager.serviceClient().getContactProfiles().updateTags(resourceGroupName,
            contactProfileName, updateParameters, Context.NONE);
        return this;
    }

    public ContactProfile apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getContactProfiles().updateTags(resourceGroupName,
            contactProfileName, updateParameters, context);
        return this;
    }
    ...
    public ContactProfile refresh() {
        this.innerObject = serviceManager.serviceClient().getContactProfiles()
            .getByResourceGroupWithResponse(resourceGroupName, contactProfileName, Context.NONE).getValue();
        return this;
    }

    public ContactProfile refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getContactProfiles()
            .getByResourceGroupWithResponse(resourceGroupName, contactProfileName, context).getValue();
        return this;
    }
