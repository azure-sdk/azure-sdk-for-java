...
public final class SpacecraftImpl implements Spacecraft, Spacecraft.Definition, Spacecraft.Update {
    ...
    public Spacecraft create() {
        this.innerObject = serviceManager.serviceClient().getSpacecrafts().createOrUpdate(resourceGroupName,
            spacecraftName, this.innerModel(), Context.NONE);
        return this;
    }

    public Spacecraft create(Context context) {
        this.innerObject = serviceManager.serviceClient().getSpacecrafts().createOrUpdate(resourceGroupName,
            spacecraftName, this.innerModel(), context);
        return this;
    }
    ...
    public Spacecraft apply() {
        this.innerObject = serviceManager.serviceClient().getSpacecrafts().updateTags(resourceGroupName, spacecraftName,
    ...
    public Spacecraft refresh() {
        this.innerObject = serviceManager.serviceClient().getSpacecrafts()
            .getByResourceGroupWithResponse(resourceGroupName, spacecraftName, Context.NONE).getValue();
        return this;
    }

    public Spacecraft refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getSpacecrafts()
            .getByResourceGroupWithResponse(resourceGroupName, spacecraftName, context).getValue();
        return this;
    }
