...
import com.azure.resourcemanager.orbital.models.SpacecraftsListAvailableContactsNextResponse;
...
public final class SpacecraftsClientImpl implements SpacecraftsClient {
    ...
    private interface SpacecraftsService {
        ...
        @ExpectedResponses({200, 202})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<SpacecraftsListAvailableContactsNextResponse> listAvailableContactsNext(
            @PathParam(value = "nextLink", encoded = true) String nextLink,
            @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept,
            Context context);
