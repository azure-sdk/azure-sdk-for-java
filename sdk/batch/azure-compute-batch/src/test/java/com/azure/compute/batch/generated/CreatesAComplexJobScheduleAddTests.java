...
@Disabled
public final class CreatesAComplexJobScheduleAddTests extends BatchClientTestBase {
    @Test
    @Disabled
    public void testCreatesAComplexJobScheduleAddTests() {
        // method invocation
        batchClient
            .createJobSchedule(
                                    ...
                                    .setPool(
                                        new BatchPoolSpecification("STANDARD_D2S_V3")
                                            ...
                                            .setStartTask(new BatchStartTask("myprogram2.exe")
                                                ...
                                                .setUserIdentity(
                                                    new UserIdentity().setAutoUser(new AutoUserSpecification()
