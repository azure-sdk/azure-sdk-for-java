...
@Disabled
public final class GetAVirtualMachineConfigurationPoolWithExtensionsTests extends BatchClientTestBase {
    @Test
    @Disabled
    public void testGetAVirtualMachineConfigurationPoolWithExtensionsTests() {
        // method invocation
        BatchPool response = batchClient.getPoolInternal("pool", null, null, null, new RequestConditions());
        ...
        List<VMExtension> responseVirtualMachineConfigurationExtensions
            = responseVirtualMachineConfiguration.getExtensions();
        VMExtension responseVirtualMachineConfigurationExtensionsFirstItem
            = responseVirtualMachineConfigurationExtensions.iterator().next();
        Assertions.assertNotNull(responseVirtualMachineConfigurationExtensionsFirstItem);
        Assertions.assertEquals("batchextension1", responseVirtualMachineConfigurationExtensionsFirstItem.getName());
        Assertions.assertEquals("Microsoft.Azure.KeyVault",
            responseVirtualMachineConfigurationExtensionsFirstItem.getPublisher());
        Assertions.assertEquals("KeyVaultForLinux", responseVirtualMachineConfigurationExtensionsFirstItem.getType());
        Assertions.assertEquals("2.0", responseVirtualMachineConfigurationExtensionsFirstItem.getTypeHandlerVersion());
        Assertions.assertEquals(true,
            responseVirtualMachineConfigurationExtensionsFirstItem.isAutoUpgradeMinorVersion());
        Assertions.assertEquals(true,
            responseVirtualMachineConfigurationExtensionsFirstItem.isEnableAutomaticUpgrade());
        Assertions.assertNotNull(responseVirtualMachineConfigurationExtensionsFirstItem.getSettings());
        ...
        // verify property "targetNodeCommunicationMode"
        Assertions.assertEquals(BatchNodeCommunicationMode.CLASSIC, response.getTargetNodeCommunicationMode());
