...
@Disabled
public final class GetAPoolWithAcceleratedNetworkingTests extends BatchClientTestBase {
    @Test
    @Disabled
    public void testGetAPoolWithAcceleratedNetworkingTests() {
        // method invocation
        ...
        Assertions.assertEquals("0x8DB4792BE8566A2", response.getETag());
        ...
        Assertions.assertEquals("standard_d1_v2", response.getVmSize());
        ...
        // verify property "networkConfiguration"
        NetworkConfiguration responseNetworkConfiguration = response.getNetworkConfiguration();
        Assertions.assertNotNull(responseNetworkConfiguration);
        Assertions.assertEquals(DynamicVNetAssignmentScope.NONE,
            responseNetworkConfiguration.getDynamicVNetAssignmentScope());
        Assertions.assertEquals(true, responseNetworkConfiguration.isEnableAcceleratedNetworking());
