 ...
 */
@Fluent
public final class CreateBatchJobOptions {
    /*
     ...
     * @return the CreateBatchJobOptions object itself.
     */
    @Generated
    public CreateBatchJobOptions setTimeOutInSeconds(Integer timeOutInSeconds) {
