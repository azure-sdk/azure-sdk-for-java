 ...
 */
@Fluent
public final class GetApplicationOptions {
     ...
     * @return the GetApplicationOptions object itself.
     */
    @Generated
    public GetApplicationOptions setTimeOutInSeconds(Integer timeOutInSeconds) {
