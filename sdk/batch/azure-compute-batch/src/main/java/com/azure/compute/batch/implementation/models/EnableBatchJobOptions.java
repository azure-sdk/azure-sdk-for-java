 ...
 */
@Fluent
public final class EnableBatchJobOptions {
    /*
     ...
     * @return the EnableBatchJobOptions object itself.
     */
    @Generated
    public EnableBatchJobOptions setTimeOutInSeconds(Integer timeOutInSeconds) {
