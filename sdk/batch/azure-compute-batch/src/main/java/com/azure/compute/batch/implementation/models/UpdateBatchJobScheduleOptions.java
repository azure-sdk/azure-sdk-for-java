 ...
 */
@Fluent
public final class UpdateBatchJobScheduleOptions {
    /*
     ...
     * @return the UpdateBatchJobScheduleOptions object itself.
     */
    @Generated
    public UpdateBatchJobScheduleOptions setTimeOutInSeconds(Integer timeOutInSeconds) {
