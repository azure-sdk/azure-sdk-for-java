...
public final class FileProperties implements JsonSerializable<FileProperties> {
     ...
     */
    @Generated
    private FileProperties(OffsetDateTime lastModified, int contentLength) {
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeIntField("contentLength", this.contentLength);
