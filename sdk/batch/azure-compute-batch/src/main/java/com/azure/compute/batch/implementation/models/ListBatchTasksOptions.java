 ...
 */
@Fluent
public final class ListBatchTasksOptions {
    /*
     ...
     * @return the ListBatchTasksOptions object itself.
     */
    @Generated
    public ListBatchTasksOptions setTimeOutInSeconds(Integer timeOutInSeconds) {
     ...
     */
    @Generated
    public ListBatchTasksOptions setMaxPageSize(Integer maxPageSize) {
