 ...
 */
@Fluent
public final class ListBatchNodeExtensionsOptions {
    /*
     ...
     * @return the ListBatchNodeExtensionsOptions object itself.
     */
    @Generated
    public ListBatchNodeExtensionsOptions setTimeOutInSeconds(Integer timeOutInSeconds) {
     ...
     */
    @Generated
    public ListBatchNodeExtensionsOptions setMaxPageSize(Integer maxPageSize) {
