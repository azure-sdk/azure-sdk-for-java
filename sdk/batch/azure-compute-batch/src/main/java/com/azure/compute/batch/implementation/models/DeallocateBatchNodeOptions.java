 ...
 */
@Fluent
public final class DeallocateBatchNodeOptions {
    /*
     ...
     * @return the DeallocateBatchNodeOptions object itself.
     */
    @Generated
    public DeallocateBatchNodeOptions setTimeOutInSeconds(Integer timeOutInSeconds) {
     ...
     */
    @Generated
    public DeallocateBatchNodeOptions setParameters(BatchNodeDeallocateContent parameters) {
