 ...
 */
@Fluent
public final class ReactivateBatchTaskOptions {
    /*
     ...
     * @return the ReactivateBatchTaskOptions object itself.
     */
    @Generated
    public ReactivateBatchTaskOptions setTimeOutInSeconds(Integer timeOutInSeconds) {
