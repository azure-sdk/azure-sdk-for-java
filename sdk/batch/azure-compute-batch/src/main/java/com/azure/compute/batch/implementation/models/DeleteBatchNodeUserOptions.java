 ...
 */
@Fluent
public final class DeleteBatchNodeUserOptions {
    /*
     ...
     * @return the DeleteBatchNodeUserOptions object itself.
     */
    @Generated
    public DeleteBatchNodeUserOptions setTimeOutInSeconds(Integer timeOutInSeconds) {
