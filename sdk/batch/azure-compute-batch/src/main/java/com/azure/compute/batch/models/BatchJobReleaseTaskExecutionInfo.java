...
public final class BatchJobReleaseTaskExecutionInfo {
    ...
    private BatchJobReleaseTaskState state;
    ...
    @Generated
    @JsonCreator
    private BatchJobReleaseTaskExecutionInfo(@JsonProperty(value = "startTime") OffsetDateTime startTime,
        @JsonProperty(value = "state") BatchJobReleaseTaskState state) {
    ...
    /**
     * Get the endTime property: The time at which the Job Release Task completed. This property is set only if the
    ...
    /**
     * Get the taskRootDirectoryUrl property: The URL to the root directory of the Job Release Task on the Compute
     * Node.
     * 
