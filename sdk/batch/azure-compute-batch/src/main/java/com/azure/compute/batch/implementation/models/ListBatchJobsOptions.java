 ...
 */
@Fluent
public final class ListBatchJobsOptions {
    /*
     ...
     * @return the ListBatchJobsOptions object itself.
     */
    @Generated
    public ListBatchJobsOptions setTimeOutInSeconds(Integer timeOutInSeconds) {
     ...
     */
    @Generated
    public ListBatchJobsOptions setMaxPageSize(Integer maxPageSize) {
