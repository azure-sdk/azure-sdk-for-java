 ...
 */
@Fluent
public final class CreateBatchPoolOptions {
    /*
     ...
     * @return the CreateBatchPoolOptions object itself.
     */
    @Generated
    public CreateBatchPoolOptions setTimeOutInSeconds(Integer timeOutInSeconds) {
