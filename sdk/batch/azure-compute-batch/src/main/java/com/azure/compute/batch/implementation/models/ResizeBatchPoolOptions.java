 ...
 */
@Fluent
public final class ResizeBatchPoolOptions {
    /*
     ...
     * @return the ResizeBatchPoolOptions object itself.
     */
    @Generated
    public ResizeBatchPoolOptions setTimeOutInSeconds(Integer timeOutInSeconds) {
