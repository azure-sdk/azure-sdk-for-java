 ...
 */
@Fluent
public final class StartBatchNodeOptions {
    /*
     ...
     * @return the StartBatchNodeOptions object itself.
     */
    @Generated
    public StartBatchNodeOptions setTimeOutInSeconds(Integer timeOutInSeconds) {
