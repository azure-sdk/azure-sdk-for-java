 ...
 */
@Fluent
public final class CreateBatchTaskOptions {
    /*
     ...
     * @return the CreateBatchTaskOptions object itself.
     */
    @Generated
    public CreateBatchTaskOptions setTimeOutInSeconds(Integer timeOutInSeconds) {
