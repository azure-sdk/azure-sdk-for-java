 ...
 */
@Fluent
public final class UpdateBatchJobOptions {
    /*
     ...
     * @return the UpdateBatchJobOptions object itself.
     */
    @Generated
    public UpdateBatchJobOptions setTimeOutInSeconds(Integer timeOutInSeconds) {
