...
public final class BatchJobScheduleStatistics implements JsonSerializable<BatchJobScheduleStatistics> {
     ...
     */
    @Generated
    private final int numSucceededTasks;
     ...
     */
    @Generated
    private final int numTaskRetries;
    ...
    /**
     * Creates an instance of BatchJobScheduleStatistics class.
     * 
    ...
    private BatchJobScheduleStatistics(String url, OffsetDateTime startTime, OffsetDateTime lastUpdateTime,
        Duration userCpuTime, Duration kernelCpuTime, Duration wallClockTime, int readIOps, int writeIOps,
        double readIOGiB, double writeIOGiB, int numSucceededTasks, int numFailedTasks, int numTaskRetries,
        Duration waitTime) {
        this.url = url;
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeIntField("readIOps", this.readIOps);
        jsonWriter.writeIntField("writeIOps", this.writeIOps);
        jsonWriter.writeDoubleField("readIOGiB", this.readIOGiB);
        jsonWriter.writeDoubleField("writeIOGiB", this.writeIOGiB);
        jsonWriter.writeIntField("numSucceededTasks", this.numSucceededTasks);
        jsonWriter.writeIntField("numFailedTasks", this.numFailedTasks);
        jsonWriter.writeIntField("numTaskRetries", this.numTaskRetries);
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("url".equals(fieldName)) {
                    ...
                    readIOps = reader.getInt();
                } else if ("writeIOps".equals(fieldName)) {
                    writeIOps = reader.getInt();
                    ...
                    numSucceededTasks = reader.getInt();
                } else if ("numFailedTasks".equals(fieldName)) {
                    numFailedTasks = reader.getInt();
                } else if ("numTaskRetries".equals(fieldName)) {
                    numTaskRetries = reader.getInt();
