 ...
 */
@Fluent
public final class StopBatchPoolResizeOptions {
    /*
     ...
     * @return the StopBatchPoolResizeOptions object itself.
     */
    @Generated
    public StopBatchPoolResizeOptions setTimeOutInSeconds(Integer timeOutInSeconds) {
