 ...
 */
@Fluent
public final class UploadBatchNodeLogsOptions {
    /*
     ...
     * @return the UploadBatchNodeLogsOptions object itself.
     */
    @Generated
    public UploadBatchNodeLogsOptions setTimeOutInSeconds(Integer timeOutInSeconds) {
