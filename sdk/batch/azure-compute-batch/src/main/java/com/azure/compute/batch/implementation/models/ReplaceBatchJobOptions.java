 ...
 */
@Fluent
public final class ReplaceBatchJobOptions {
    /*
     ...
     * @return the ReplaceBatchJobOptions object itself.
     */
    @Generated
    public ReplaceBatchJobOptions setTimeOutInSeconds(Integer timeOutInSeconds) {
