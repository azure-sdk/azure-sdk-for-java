 ...
 */
@Fluent
public final class DeleteBatchPoolOptions {
    /*
     ...
     * @return the DeleteBatchPoolOptions object itself.
     */
    @Generated
    public DeleteBatchPoolOptions setTimeOutInSeconds(Integer timeOutInSeconds) {
