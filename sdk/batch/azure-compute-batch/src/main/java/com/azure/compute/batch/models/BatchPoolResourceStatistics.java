...
public final class BatchPoolResourceStatistics implements JsonSerializable<BatchPoolResourceStatistics> {
    ...
    private BatchPoolResourceStatistics(OffsetDateTime startTime, OffsetDateTime lastUpdateTime,
        ...
        int diskReadIOps, int diskWriteIOps, double diskReadGiB, double diskWriteGiB, double networkReadGiB,
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeIntField("diskReadIOps", this.diskReadIOps);
        jsonWriter.writeIntField("diskWriteIOps", this.diskWriteIOps);
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("startTime".equals(fieldName)) {
                    ...
                    diskReadIOps = reader.getInt();
                } else if ("diskWriteIOps".equals(fieldName)) {
                    diskWriteIOps = reader.getInt();
