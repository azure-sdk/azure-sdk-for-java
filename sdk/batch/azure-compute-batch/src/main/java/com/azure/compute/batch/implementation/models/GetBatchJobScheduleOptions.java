 ...
 */
@Fluent
public final class GetBatchJobScheduleOptions {
    /*
     ...
     * @return the GetBatchJobScheduleOptions object itself.
     */
    @Generated
    public GetBatchJobScheduleOptions setTimeOutInSeconds(Integer timeOutInSeconds) {
     ...
     */
    @Generated
    public GetBatchJobScheduleOptions setSelect(List<String> select) {
        this.select = select;
        return this;
    }
     ...
     */
    @Generated
    public GetBatchJobScheduleOptions setExpand(List<String> expand) {
        this.expand = expand;
        return this;
    }
}
