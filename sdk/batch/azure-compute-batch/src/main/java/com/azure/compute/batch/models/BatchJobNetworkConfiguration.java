...
public final class BatchJobNetworkConfiguration {
    ...
    @Generated
    @JsonCreator
    public BatchJobNetworkConfiguration(@JsonProperty(value = "subnetId") String subnetId) {
     ...
     * VirtualMachineConfiguration Pool. The virtual network must be in the same region and subscription as the Azure
