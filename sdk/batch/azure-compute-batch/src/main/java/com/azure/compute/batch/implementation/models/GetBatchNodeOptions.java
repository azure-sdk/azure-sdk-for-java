 ...
 */
@Fluent
public final class GetBatchNodeOptions {
    /*
     ...
     * @return the GetBatchNodeOptions object itself.
     */
    @Generated
    public GetBatchNodeOptions setTimeOutInSeconds(Integer timeOutInSeconds) {
