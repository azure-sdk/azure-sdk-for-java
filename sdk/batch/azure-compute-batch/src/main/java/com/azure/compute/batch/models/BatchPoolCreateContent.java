...
public final class BatchPoolCreateContent implements JsonSerializable<BatchPoolCreateContent> {
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeJsonField("cloudServiceConfiguration", this.cloudServiceConfiguration);
    ...
    public static BatchPoolCreateContent fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            CloudServiceConfiguration cloudServiceConfiguration = null;
            ...
            List<String> applicationLicenses = null;
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("id".equals(fieldName)) {
                ...
                } else if ("cloudServiceConfiguration".equals(fieldName)) {
                    cloudServiceConfiguration = CloudServiceConfiguration.fromJson(reader);
                    ...
                    applicationLicenses = reader.readArray(reader1 -> reader1.getString());
            ...
            deserializedBatchPoolCreateContent.cloudServiceConfiguration = cloudServiceConfiguration;
            ...
            deserializedBatchPoolCreateContent.applicationLicenses = applicationLicenses;
