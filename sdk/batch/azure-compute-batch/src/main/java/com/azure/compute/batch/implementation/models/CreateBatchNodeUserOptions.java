 ...
 */
@Fluent
public final class CreateBatchNodeUserOptions {
    /*
     ...
     * @return the CreateBatchNodeUserOptions object itself.
     */
    @Generated
    public CreateBatchNodeUserOptions setTimeOutInSeconds(Integer timeOutInSeconds) {
