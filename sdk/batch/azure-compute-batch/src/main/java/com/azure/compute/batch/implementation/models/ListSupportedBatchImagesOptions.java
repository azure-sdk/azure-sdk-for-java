 ...
 */
@Fluent
public final class ListSupportedBatchImagesOptions {
    /*
     ...
     * @return the ListSupportedBatchImagesOptions object itself.
     */
    @Generated
    public ListSupportedBatchImagesOptions setTimeOutInSeconds(Integer timeOutInSeconds) {
     ...
     */
    @Generated
    public ListSupportedBatchImagesOptions setMaxPageSize(Integer maxPageSize) {
