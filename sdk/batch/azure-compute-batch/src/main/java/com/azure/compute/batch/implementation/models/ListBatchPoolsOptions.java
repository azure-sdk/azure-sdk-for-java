...
package com.azure.compute.batch.implementation.models;
 ...
 */
@Fluent
public final class ListBatchPoolsOptions {
    /*
     ...
     * @return the ListBatchPoolsOptions object itself.
     */
    @Generated
    public ListBatchPoolsOptions setTimeOutInSeconds(Integer timeOutInSeconds) {
     ...
     */
    @Generated
    public ListBatchPoolsOptions setMaxPageSize(Integer maxPageSize) {
     ...
     */
    @Generated
    public ListBatchPoolsOptions setSelect(List<String> select) {
        this.select = select;
        return this;
    }
     ...
     */
    @Generated
    public ListBatchPoolsOptions setExpand(List<String> expand) {
        this.expand = expand;
        return this;
    }
}
