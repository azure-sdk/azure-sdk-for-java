 ...
 */
@Fluent
public final class DeleteBatchTaskOptions {
    /*
     ...
     * @return the DeleteBatchTaskOptions object itself.
     */
    @Generated
    public DeleteBatchTaskOptions setTimeOutInSeconds(Integer timeOutInSeconds) {
