 ...
 */
@Fluent
public final class TerminateBatchTaskOptions {
    /*
     ...
     * @return the TerminateBatchTaskOptions object itself.
     */
    @Generated
    public TerminateBatchTaskOptions setTimeOutInSeconds(Integer timeOutInSeconds) {
