 ...
 */
@Fluent
public final class CreateBatchJobScheduleOptions {
    /*
     ...
     * @return the CreateBatchJobScheduleOptions object itself.
     */
    @Generated
    public CreateBatchJobScheduleOptions setTimeOutInSeconds(Integer timeOutInSeconds) {
