...
public final class DatabaseProperties implements JsonSerializable<DatabaseProperties> {
    ...
    /*
     * Access database using keys - default is enabled. This property can be Enabled/Disabled to allow or deny access
     * with those. Can be updated even after database is created.
     */
    ...
    /**
     * Get the accessKeysAuthentication property: Access database using keys - default is enabled. This property can be
    ...
    /**
     * Set the accessKeysAuthentication property: Access database using keys - default is enabled. This property can be
     * Enabled/Disabled to allow or deny access with those. Can be updated even after database is created.
     * 
