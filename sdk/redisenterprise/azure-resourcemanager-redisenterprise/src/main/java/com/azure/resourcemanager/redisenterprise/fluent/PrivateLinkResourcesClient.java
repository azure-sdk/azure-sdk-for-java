...
public interface PrivateLinkResourcesClient {
    ...
    PagedIterable<PrivateLinkInner> listByCluster(String resourceGroupName, String clusterName);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<PrivateLinkInner> listByCluster(String resourceGroupName, String clusterName, Context context);
}
