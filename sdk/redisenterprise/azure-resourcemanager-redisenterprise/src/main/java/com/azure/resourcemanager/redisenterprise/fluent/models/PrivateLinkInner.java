...
@Fluent
public final class PrivateLinkInner extends ProxyResource {
    /*
    ...
    /** Creates an instance of PrivateLinkInner class. */
    public PrivateLinkInner() {
    }
     ...
     * @return the PrivateLinkInner object itself.
     */
    public PrivateLinkInner withGroupId(String groupId) {
     ...
     * @return the PrivateLinkInner object itself.
     */
    public PrivateLinkInner withRequiredMembers(List<String> requiredMembers) {
        if (this.innerProperties() == null) {
            this.innerProperties = new PrivateLinkProperties();
        }
     ...
     * @return the PrivateLinkInner object itself.
     */
    public PrivateLinkInner withRequiredZoneNames(List<String> requiredZoneNames) {
        if (this.innerProperties() == null) {
            this.innerProperties = new PrivateLinkProperties();
        }
     ...
     * @return the PrivateLinkInner object itself.
     */
    public PrivateLinkInner withProvisioningState(ProvisioningState provisioningState) {
        if (this.innerProperties() == null) {
            this.innerProperties = new PrivateLinkProperties();
        }
