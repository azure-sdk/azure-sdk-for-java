...
public interface Database {
    ...
    /**
     * Gets the accessKeysAuthentication property: Access database using keys - default is enabled. This property can be
     * Enabled/Disabled to allow or deny access with those. Can be updated even after database is created.
     * 
    ...
    interface DefinitionStages {
        ...
        interface WithAccessKeysAuthentication {
            /**
             * Specifies the accessKeysAuthentication property: Access database using keys - default is enabled. This
             * property can be Enabled/Disabled to allow or deny access with those. Can be updated even after database
             * is created..
             * 
             * @param accessKeysAuthentication Access database using keys - default is enabled. This property can be
             * Enabled/Disabled to allow or deny access with those. Can be updated even after database is created.
             * @return the next definition stage.
             */
     ...
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     */
    void forceLinkToReplicationGroup(ForceLinkParameters parameters);
     ...
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     */
    void forceLinkToReplicationGroup(ForceLinkParameters parameters, Context context);
