...
public final class ManagedServiceIdentityType extends ExpandableStringEnum<ManagedServiceIdentityType> {
    ...
    /** Static value systemAssignedIdentity for ManagedServiceIdentityType. */
    public static final ManagedServiceIdentityType SYSTEM_ASSIGNED_IDENTITY = fromString("systemAssignedIdentity");

    /** Static value userAssignedIdentity for ManagedServiceIdentityType. */
    public static final ManagedServiceIdentityType USER_ASSIGNED_IDENTITY = fromString("userAssignedIdentity");
