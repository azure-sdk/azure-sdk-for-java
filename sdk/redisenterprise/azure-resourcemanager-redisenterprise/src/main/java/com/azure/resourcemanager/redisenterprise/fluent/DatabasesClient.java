...
public interface DatabasesClient {
    ...
    SyncPoller<PollResult<Void>, Void> beginFlush(
        String resourceGroupName, String clusterName, String databaseName, Object parameters, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    void flush(String resourceGroupName, String clusterName, String databaseName, Object parameters, Context context);
}
