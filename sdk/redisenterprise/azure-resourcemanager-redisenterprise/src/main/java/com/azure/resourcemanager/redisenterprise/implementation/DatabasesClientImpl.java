...
public final class DatabasesClientImpl implements DatabasesClient {
    ...
    public interface DatabasesService {
        ...
        Mono<Response<Flux<ByteBuffer>>> create(
            ...
            @PathParam("clusterName") String clusterName,
            @PathParam("databaseName") String databaseName,
            @BodyParam("application/json") DatabaseCreateOrUpdate resource,
            @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({200, 202})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Flux<ByteBuffer>>> fush(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("clusterName") String clusterName,
            @PathParam("databaseName") String databaseName,
            @BodyParam("application/json") FlushParameters body,
            @HeaderParam("Accept") String accept,
            Context context);
    ...
    private Mono<Response<Flux<ByteBuffer>>> createWithResponseAsync(
        String resourceGroupName, String clusterName, String databaseName, DatabaseCreateOrUpdate resource) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    private Mono<Response<Flux<ByteBuffer>>> createWithResponseAsync(
        ...
        String clusterName,
        String databaseName,
        DatabaseCreateOrUpdate resource,
        Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
    ...
    public SyncPoller<PollResult<DatabaseInner>, DatabaseInner> beginCreate(
        String resourceGroupName, String clusterName, String databaseName, DatabaseCreateOrUpdate resource) {
        return this.beginCreateAsync(resourceGroupName, clusterName, databaseName, resource).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<DatabaseInner>, DatabaseInner> beginCreate(
        ...
        DatabaseCreateOrUpdate resource,
        Context context) {
        return this.beginCreateAsync(resourceGroupName, clusterName, databaseName, resource, context).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<DatabaseInner>, DatabaseInner> beginUpdate(
        String resourceGroupName, String clusterName, String databaseName, Object properties) {
        return this.beginUpdateAsync(resourceGroupName, clusterName, databaseName, properties).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<DatabaseInner>, DatabaseInner> beginUpdate(
        String resourceGroupName, String clusterName, String databaseName, Object properties, Context context) {
        return this.beginUpdateAsync(resourceGroupName, clusterName, databaseName, properties, context).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginExportRdb(
        String resourceGroupName, String clusterName, String databaseName, ExportParameters body) {
        return this.beginExportRdbAsync(resourceGroupName, clusterName, databaseName, body).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginExportRdb(
        String resourceGroupName, String clusterName, String databaseName, ExportParameters body, Context context) {
        return this.beginExportRdbAsync(resourceGroupName, clusterName, databaseName, body, context).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginForceUnlink(
        String resourceGroupName, String clusterName, String databaseName, ForceUnlinkParameters body) {
        return this.beginForceUnlinkAsync(resourceGroupName, clusterName, databaseName, body).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginForceUnlink(
        ...
        ForceUnlinkParameters body,
        Context context) {
        return this.beginForceUnlinkAsync(resourceGroupName, clusterName, databaseName, body, context).getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> fushWithResponseAsync(
        String resourceGroupName, String clusterName, String databaseName, FlushParameters body) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<Void>, Void> beginFushAsync(
        String resourceGroupName, String clusterName, String databaseName, FlushParameters body) {
        Mono<Response<Flux<ByteBuffer>>> mono =
            fushWithResponseAsync(resourceGroupName, clusterName, databaseName, body);
        return this
            .client
            .<Void, Void>getLroResult(
                mono, this.client.getHttpPipeline(), Void.class, Void.class, this.client.getContext());
    ...
    private PollerFlux<PollResult<Void>, Void> beginFushAsync(
        ...
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono =
            fushWithResponseAsync(resourceGroupName, clusterName, databaseName, body, context);
        return this
            .client
            .<Void, Void>getLroResult(mono, this.client.getHttpPipeline(), Void.class, Void.class, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<Void>, Void> beginFush(
        String resourceGroupName, String clusterName, String databaseName, FlushParameters body) {
        return this.beginFushAsync(resourceGroupName, clusterName, databaseName, body).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginFush(
        String resourceGroupName, String clusterName, String databaseName, FlushParameters body, Context context) {
        return this.beginFushAsync(resourceGroupName, clusterName, databaseName, body, context).getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> fushAsync(
        String resourceGroupName, String clusterName, String databaseName, FlushParameters body) {
        return beginFushAsync(resourceGroupName, clusterName, databaseName, body)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<Void> fushAsync(
        String resourceGroupName, String clusterName, String databaseName, FlushParameters body, Context context) {
        return beginFushAsync(resourceGroupName, clusterName, databaseName, body, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    public void fush(String resourceGroupName, String clusterName, String databaseName, FlushParameters body) {
        fushAsync(resourceGroupName, clusterName, databaseName, body).block();
    }
    ...
    public void fush(
        String resourceGroupName, String clusterName, String databaseName, FlushParameters body, Context context) {
        fushAsync(resourceGroupName, clusterName, databaseName, body, context).block();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginImportRdb(
        String resourceGroupName, String clusterName, String databaseName, ImportParameters body) {
        return this.beginImportRdbAsync(resourceGroupName, clusterName, databaseName, body).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginImportRdb(
        String resourceGroupName, String clusterName, String databaseName, ImportParameters body, Context context) {
        return this.beginImportRdbAsync(resourceGroupName, clusterName, databaseName, body, context).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<AccessKeysInner>, AccessKeysInner> beginRegenerateKey(
        String resourceGroupName, String clusterName, String databaseName, RegenerateKeyParameters body) {
        return this.beginRegenerateKeyAsync(resourceGroupName, clusterName, databaseName, body).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<AccessKeysInner>, AccessKeysInner> beginRegenerateKey(
        ...
        Context context) {
        return this
            .beginRegenerateKeyAsync(resourceGroupName, clusterName, databaseName, body, context)
            .getSyncPoller();
    }
