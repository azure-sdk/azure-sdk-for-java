...
public final class HealthMonitorsClientImpl implements HealthMonitorsClient {
     ...
     * @return the current health status of all monitors of a virtual machine along with {@link PagedResponse} on
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the current health status of all monitors of a virtual machine as paginated response with {@link
     *     PagedFlux}.
     */
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the current health status of a monitor of a virtual machine along with {@link Response} on successful
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the current health status of a monitor of a virtual machine on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the current health status of a monitor of a virtual machine along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
     ...
     *     the last 24 hours) along with {@link PagedResponse} on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
     ...
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the health state changes of a monitor of a virtual machine within the provided time window (default is
     *     the last 24 hours) as paginated response with {@link PagedFlux}.
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
     ...
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the health state changes of a monitor of a virtual machine within the provided time window (default is
     *     the last 24 hours) as paginated response with {@link PagedIterable}.
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the health state change of a monitor of a virtual machine at the provided timestamp along with {@link
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the health state change of a monitor of a virtual machine at the provided timestamp on successful
     *     completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ...
    public HealthMonitorStateChangeInner getStateChange(
        ...
        String timestampUnix) {
        final String expand = null;
        return getStateChangeWithResponse(
                subscriptionId,
                resourceGroupName,
                providerName,
                resourceCollectionName,
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return information about the current health statuses of the monitors along with {@link PagedResponse} on
     *     successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return information about the health state changes of the monitor within the provided time window along with
