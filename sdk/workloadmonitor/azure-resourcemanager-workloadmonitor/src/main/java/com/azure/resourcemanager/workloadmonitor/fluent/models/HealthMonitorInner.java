...
@Fluent
public final class HealthMonitorInner extends ProxyResource {
    /*
     * Properties of the monitor's health status.
     */
    @JsonProperty(value = "properties")
    private HealthMonitorProperties innerProperties;

    /** Creates an instance of HealthMonitorInner class. */
    public HealthMonitorInner() {
    }

    /**
     * Get the innerProperties property: Properties of the monitor's health status.
     *
    ...
    public HealthMonitorInner withMonitorName(String monitorName) {
        if (this.innerProperties() == null) {
            this.innerProperties = new HealthMonitorProperties();
        }
    ...
    public String parentMonitorName() {
        return this.innerProperties() == null ? null : this.innerProperties().parentMonitorName();
    }
    ...
    public HealthMonitorInner withParentMonitorName(String parentMonitorName) {
        ...
        this.innerProperties().withParentMonitorName(parentMonitorName);
        return this;
    }
    ...
    public String lastReportedTimestamp() {
        return this.innerProperties() == null ? null : this.innerProperties().lastReportedTimestamp();
    }
    ...
    public HealthMonitorInner withLastReportedTimestamp(String lastReportedTimestamp) {
        ...
        this.innerProperties().withLastReportedTimestamp(lastReportedTimestamp);
        return this;
    }
