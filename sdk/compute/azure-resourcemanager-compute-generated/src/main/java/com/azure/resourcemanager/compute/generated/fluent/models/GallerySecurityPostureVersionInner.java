 ...
 */
@Fluent
public final class GallerySecurityPostureVersionInner extends Resource {
    /*
    ...
    /**
     * Creates an instance of GallerySecurityPostureVersionInner class.
     */
    public GallerySecurityPostureVersionInner() {
    }
     ...
     */
    @Override
    public GallerySecurityPostureVersionInner withLocation(String location) {
     ...
     */
    @Override
    public GallerySecurityPostureVersionInner withTags(Map<String, String> tags) {
        super.withTags(tags);
        return this;
    }
     ...
     * @return the GallerySecurityPostureVersionInner object itself.
     */
    public GallerySecurityPostureVersionInner withExcludeFromLatest(Boolean excludeFromLatest) {
     ...
     * @return the GallerySecurityPostureVersionInner object itself.
     */
    public GallerySecurityPostureVersionInner withEndOfLifeDate(OffsetDateTime endOfLifeDate) {
        if (this.innerProperties() == null) {
            this.innerProperties = new GallerySecurityPostureVersionProperties();
        }
     ...
     * @return the GallerySecurityPostureVersionInner object itself.
     */
    public GallerySecurityPostureVersionInner withSettings(List<PostureSetting> settings) {
        if (this.innerProperties() == null) {
            this.innerProperties = new GallerySecurityPostureVersionProperties();
        }
     ...
     * @return the GallerySecurityPostureVersionInner object itself.
     */
    public GallerySecurityPostureVersionInner withTargetLocations(List<TargetRegion> targetLocations) {
        if (this.innerProperties() == null) {
            this.innerProperties = new GallerySecurityPostureVersionProperties();
        }
    ...
    /**
     * Reads an instance of GallerySecurityPostureVersionInner from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of GallerySecurityPostureVersionInner if the JsonReader was pointing to an instance of it, or
     * null if it was pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the GallerySecurityPostureVersionInner.
     */
    public static GallerySecurityPostureVersionInner fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            GallerySecurityPostureVersionInner deserializedGallerySecurityPostureVersionInner
                = new GallerySecurityPostureVersionInner();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("id".equals(fieldName)) {
                    deserializedGallerySecurityPostureVersionInner.id = reader.getString();
                } else if ("name".equals(fieldName)) {
                    deserializedGallerySecurityPostureVersionInner.name = reader.getString();
                } else if ("type".equals(fieldName)) {
                    deserializedGallerySecurityPostureVersionInner.type = reader.getString();
                } else if ("location".equals(fieldName)) {
                    deserializedGallerySecurityPostureVersionInner.withLocation(reader.getString());
                } else if ("tags".equals(fieldName)) {
                    Map<String, String> tags = reader.readMap(reader1 -> reader1.getString());
                    deserializedGallerySecurityPostureVersionInner.withTags(tags);
                } else if ("properties".equals(fieldName)) {
                    deserializedGallerySecurityPostureVersionInner.innerProperties
            ...
            return deserializedGallerySecurityPostureVersionInner;
        });
    }
}
