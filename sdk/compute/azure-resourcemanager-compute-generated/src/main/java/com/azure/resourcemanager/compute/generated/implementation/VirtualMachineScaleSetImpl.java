...
public final class VirtualMachineScaleSetImpl
    ...
    public void invokeUpgrade() {
        serviceManager.virtualMachineScaleSets().invokeUpgrade(resourceGroupName, vmScaleSetName);
    }

    public void invokeUpgrade(VirtualMachineScaleSetVMInstanceIDs vmInstanceIDs, Context context) {
        serviceManager
            .virtualMachineScaleSets()
            .invokeUpgrade(resourceGroupName, vmScaleSetName, vmInstanceIDs, context);
    }
