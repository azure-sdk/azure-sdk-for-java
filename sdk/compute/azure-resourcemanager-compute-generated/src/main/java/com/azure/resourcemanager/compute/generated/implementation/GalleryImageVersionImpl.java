...
public final class GalleryImageVersionImpl
    ...
    public GalleryImageVersionImpl withValidationsProfile(ValidationsProfile validationsProfile) {
        if (isInCreateMode()) {
            this.innerModel().withValidationsProfile(validationsProfile);
            return this;
        } else {
            this.updateGalleryImageVersion.withValidationsProfile(validationsProfile);
            return this;
        }
    }
