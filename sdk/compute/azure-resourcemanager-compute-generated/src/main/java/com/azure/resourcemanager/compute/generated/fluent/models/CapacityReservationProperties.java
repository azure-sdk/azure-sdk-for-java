...
public final class CapacityReservationProperties {
    ...
    /*
     * This is the readonly property that is populated and set in the response to specify the Maximum Fault Domain
     * Count that capacity reservation support using the VM Size.<br><br>Minimum api-version: 2022-08-01.
     */
    @JsonProperty(value = "maximumFaultDomainCountSupported", access = JsonProperty.Access.WRITE_ONLY)
    private Integer maximumFaultDomainCountSupported;
    ...
    /**
     * Get the maximumFaultDomainCountSupported property: This is the readonly property that is populated and set in the
     * response to specify the Maximum Fault Domain Count that capacity reservation support using the VM
     * Size.&lt;br&gt;&lt;br&gt;Minimum api-version: 2022-08-01.
     *
     * @return the maximumFaultDomainCountSupported value.
     */
    public Integer maximumFaultDomainCountSupported() {
        return this.maximumFaultDomainCountSupported;
    }
