 ...
 */
public interface CommunityGallerySecurityPosturesClient {
    /**
    ...
    Response<CommunitySecurityPostureInner> getWithResponse(String location, String publicGalleryName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    CommunitySecurityPostureInner get(String location, String publicGalleryName, String securityPostureName);
}
