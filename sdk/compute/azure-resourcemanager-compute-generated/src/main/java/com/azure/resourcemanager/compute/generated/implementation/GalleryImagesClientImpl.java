...
public final class GalleryImagesClientImpl implements GalleryImagesClient {
    ...
    private interface GalleryImagesService {
        ...
        @Get(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/galleries"
                + "/{galleryName}/images/{galleryImageName}/latestVersionName")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Mono<Response<LatestGalleryImageVersionInner>> getLatestVersionName(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("galleryName") String galleryName,
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<GalleryImageInner>, GalleryImageInner> beginUpdateAsync(
        String resourceGroupName, String galleryName, String galleryImageName, GalleryImageUpdate galleryImage) {
        Mono<Response<Flux<ByteBuffer>>> mono =
     ...
     * @param galleryName The name of the Shared Image Gallery from which the Image Definitions are to be retrieved.
     * @param galleryImageName The name of the gallery image definition to be retrieved.
     * @param location The location to query for the latest version name.
     * @throws IllegalArgumentException thrown if parameters fail the validation.
     * @throws ApiErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the gallery image version with latest version in a particular region along with {@link Response} on
     *     successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<LatestGalleryImageVersionInner>> getLatestVersionNameWithResponseAsync(
        String resourceGroupName, String galleryName, String galleryImageName, String location) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<LatestGalleryImageVersionInner>> getLatestVersionNameWithResponseAsync(
        String resourceGroupName, String galleryName, String galleryImageName, String location, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     * @throws ApiErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the gallery image version with latest version in a particular region on successful completion of {@link
     *     Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<LatestGalleryImageVersionInner> getLatestVersionNameAsync(
        String resourceGroupName, String galleryName, String galleryImageName, String location) {
        return getLatestVersionNameWithResponseAsync(resourceGroupName, galleryName, galleryImageName, location)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     * @throws ApiErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the gallery image version with latest version in a particular region.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public LatestGalleryImageVersionInner getLatestVersionName(
        String resourceGroupName, String galleryName, String galleryImageName) {
        final String location = null;
        return getLatestVersionNameAsync(resourceGroupName, galleryName, galleryImageName, location).block();
    }
     ...
     * @throws ApiErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the gallery image version with latest version in a particular region along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<LatestGalleryImageVersionInner> getLatestVersionNameWithResponse(
        String resourceGroupName, String galleryName, String galleryImageName, String location, Context context) {
        return getLatestVersionNameWithResponseAsync(
                resourceGroupName, galleryName, galleryImageName, location, context)
            .block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<GalleryImageInner>> listByGallerySinglePageAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<GalleryImageInner> listByGalleryAsync(
        String resourceGroupName, String galleryName, Context context) {
        return new PagedFlux<>(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<GalleryImageInner>> listByGalleryNextSinglePageAsync(String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        if (this.client.getEndpoint() == null) {
