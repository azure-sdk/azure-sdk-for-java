 ...
 */
@Fluent
public final class DiskRestorePointInner extends ProxyResource {
    /*
     ...
     */
    public DiskRestorePointInner withResourceName(String resourceName) {
     ...
     * @return the DiskRestorePointInner object itself.
     */
    public DiskRestorePointInner withPurchasePlan(DiskPurchasePlan purchasePlan) {
        if (this.innerProperties() == null) {
            this.innerProperties = new DiskRestorePointProperties();
        }
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeStringField("name", this.resourceName);
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("id".equals(fieldName)) {
                    ...
                    deserializedDiskRestorePointInner.systemData = SystemData.fromJson(reader);
                } else {
                    reader.skipChildren();
                }
            }
