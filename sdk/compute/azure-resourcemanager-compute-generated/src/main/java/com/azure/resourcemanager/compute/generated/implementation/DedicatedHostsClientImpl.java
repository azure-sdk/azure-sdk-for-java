...
public final class DedicatedHostsClientImpl implements DedicatedHostsClient {
    ...
    public interface DedicatedHostsService {
        ...
        Mono<Response<Flux<ByteBuffer>>> createOrUpdate(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("hostGroupName") String hostGroupName,
            @PathParam("hostName") String hostname, @BodyParam("application/json") DedicatedHostInner parameters,
            @HeaderParam("Accept") String accept, Context context);
        ...
        Mono<Response<Flux<ByteBuffer>>> update(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("hostGroupName") String hostGroupName,
            @PathParam("hostName") String hostname, @BodyParam("application/json") DedicatedHostUpdate parameters,
            @HeaderParam("Accept") String accept, Context context);
    ...
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String resourceGroupName,
        ...
        return FluxUtil.withContext(context -> service.createOrUpdate(this.client.getEndpoint(), apiVersion,
            this.client.getSubscriptionId(), resourceGroupName, hostGroupName, hostname, parameters, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String resourceGroupName,
        ...
        return service.createOrUpdate(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(),
            resourceGroupName, hostGroupName, hostname, parameters, accept, context);
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> updateWithResponseAsync(String resourceGroupName, String hostGroupName,
        ...
        return service.update(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(), resourceGroupName,
            hostGroupName, hostname, parameters, accept, context);
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> deleteWithResponseAsync(String resourceGroupName, String hostGroupName,
        ...
        return service.delete(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(), resourceGroupName,
            hostGroupName, hostname, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<DedicatedHostInner>, DedicatedHostInner> beginRestartAsync(String resourceGroupName,
        String hostGroupName, String hostname) {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<DedicatedHostInner>, DedicatedHostInner> beginRestart(String resourceGroupName,
        String hostGroupName, String hostname) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DedicatedHostInner> restartAsync(String resourceGroupName, String hostGroupName, String hostname) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public DedicatedHostInner restart(String resourceGroupName, String hostGroupName, String hostname) {
        return restartAsync(resourceGroupName, hostGroupName, hostname).block();
    }
    ...
    public DedicatedHostInner restart(String resourceGroupName, String hostGroupName, String hostname,
        Context context) {
        return restartAsync(resourceGroupName, hostGroupName, hostname, context).block();
    }
