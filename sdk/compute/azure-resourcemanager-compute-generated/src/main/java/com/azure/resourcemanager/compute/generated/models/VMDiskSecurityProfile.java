...
public final class VMDiskSecurityProfile {
     ...
     * NonPersistedVMGuestState for not persisting firmware state in the VMGuestState blob. **Note:** It can be set for
     ...
     * encryption of just the VMGuestState blob, and NonPersistedVMGuestState for not persisting firmware state in the
