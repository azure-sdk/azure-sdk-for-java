...
public final class VirtualMachinesImpl implements VirtualMachines {
    ...
    public AttachDetachDataDisksResponse attachDetachDataDisks(
        String resourceGroupName, String vmName, AttachDetachDataDisksRequest parameters) {
        AttachDetachDataDisksResponseInner inner =
            this.serviceClient().attachDetachDataDisks(resourceGroupName, vmName, parameters);
        if (inner != null) {
            return new AttachDetachDataDisksResponseImpl(inner, this.manager());
        } else {
            return null;
        }
    }
