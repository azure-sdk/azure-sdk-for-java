...
public final class VirtualMachinesImpl implements VirtualMachines {
    ...
    public VirtualMachine attachDetachDataDisks(String resourceGroupName, String vmName,
        AttachDetachDataDisksRequest parameters) {
        VirtualMachineInner inner = this.serviceClient().attachDetachDataDisks(resourceGroupName, vmName, parameters);
        if (inner != null) {
            return new VirtualMachineImpl(inner, this.manager());
        } else {
            return null;
