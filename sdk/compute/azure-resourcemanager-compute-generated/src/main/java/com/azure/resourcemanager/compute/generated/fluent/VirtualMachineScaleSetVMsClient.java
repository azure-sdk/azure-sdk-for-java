...
public interface VirtualMachineScaleSetVMsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    void invokeUpgrade(String resourceGroupName, String vmScaleSetName, String instanceId);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    void invokeUpgrade(String resourceGroupName, String vmScaleSetName, String instanceId, Context context);
