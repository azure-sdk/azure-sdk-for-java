...
public final class DisksClientImpl implements DisksClient {
    ...
    public interface DisksService {
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<AccessUriInner>> grantAccessOnVmssvmInstance(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("vmssName") String vmssName,
            @PathParam("diskName") String diskName,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") GrantAccessData grantAccessData,
            @HeaderParam("Accept") String accept,
     ...
     *
     * @param resourceGroupName The name of the resource group.
     * @param vmssName The name of the VirtualmachineScaleSet managing the managed disk. The name can't be changed after
     *     the disk is created. Supported characters for the name are a-z, A-Z, 0-9, _ and -. The maximum name length is
     *     80 characters.
     * @param diskName The name of the managed disk that is being created. The name can't be changed after the disk is
     *     created. Supported characters for the name are a-z, A-Z, 0-9, _ and -. The maximum name length is 80
     *     characters.
     * @param grantAccessData Access data object supplied in the body of the get disk access operation. The supported
     *     accessLevel for this action is 'ReadForDiskInspection' only.
     * @throws IllegalArgumentException thrown if parameters fail the validation.
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a disk access SAS uri along with {@link Response} on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<AccessUriInner>> grantAccessOnVmssvmInstanceWithResponseAsync(
        String resourceGroupName, String vmssName, String diskName, GrantAccessData grantAccessData) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
        ...
        if (vmssName == null) {
            return Mono.error(new IllegalArgumentException("Parameter vmssName is required and cannot be null."));
        }
        if (diskName == null) {
            return Mono.error(new IllegalArgumentException("Parameter diskName is required and cannot be null."));
        }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<AccessUriInner>> grantAccessOnVmssvmInstanceWithResponseAsync(
        String resourceGroupName, String vmssName, String diskName, GrantAccessData grantAccessData, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<AccessUriInner> grantAccessOnVmssvmInstanceAsync(
        String resourceGroupName, String vmssName, String diskName, GrantAccessData grantAccessData) {
        return grantAccessOnVmssvmInstanceWithResponseAsync(resourceGroupName, vmssName, diskName, grantAccessData)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<AccessUriInner> grantAccessOnVmssvmInstanceWithResponse(
        String resourceGroupName, String vmssName, String diskName, GrantAccessData grantAccessData, Context context) {
        return grantAccessOnVmssvmInstanceWithResponseAsync(
                resourceGroupName, vmssName, diskName, grantAccessData, context)
            .block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public AccessUriInner grantAccessOnVmssvmInstance(
        String resourceGroupName, String vmssName, String diskName, GrantAccessData grantAccessData) {
        return grantAccessOnVmssvmInstanceWithResponse(
                resourceGroupName, vmssName, diskName, grantAccessData, Context.NONE)
            .getValue();
    }
