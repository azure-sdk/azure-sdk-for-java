...
public final class CloudServiceRolesClientImpl implements CloudServiceRolesClient {
    ...
    private Mono<Response<CloudServiceRoleInner>> getWithResponseAsync(
        String resourceGroupName, String cloudServiceName, String roleName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<CloudServiceRoleInner> getAsync(String resourceGroupName, String cloudServiceName, String roleName) {
        return getWithResponseAsync(resourceGroupName, cloudServiceName, roleName)
    ...
    public Response<CloudServiceRoleInner> getWithResponse(
        String resourceGroupName, String cloudServiceName, String roleName, Context context) {
        return getWithResponseAsync(resourceGroupName, cloudServiceName, roleName, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public CloudServiceRoleInner get(String resourceGroupName, String cloudServiceName, String roleName) {
        return getWithResponse(resourceGroupName, cloudServiceName, roleName, Context.NONE).getValue();
    }
