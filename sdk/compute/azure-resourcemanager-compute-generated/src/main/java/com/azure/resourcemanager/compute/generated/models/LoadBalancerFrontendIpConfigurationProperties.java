...
public final class LoadBalancerFrontendIpConfigurationProperties {
    ...
    private SubResourceAutoGenerated publicIpAddress;

    /*
     * The reference to the virtual network subnet resource.
     */
    @JsonProperty(value = "subnet")
    private SubResourceAutoGenerated subnet;
     ...
     */
    public SubResourceAutoGenerated publicIpAddress() {
     ...
     */
    public LoadBalancerFrontendIpConfigurationProperties withPublicIpAddress(SubResourceAutoGenerated publicIpAddress) {
     ...
     */
    public SubResourceAutoGenerated subnet() {
        return this.subnet;
    }
     ...
     * @return the LoadBalancerFrontendIpConfigurationProperties object itself.
     */
    public LoadBalancerFrontendIpConfigurationProperties withSubnet(SubResourceAutoGenerated subnet) {
        this.subnet = subnet;
        return this;
    }
