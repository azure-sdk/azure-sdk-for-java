...
public interface Snapshot {
    ...
    /**
     * Gets the supportedCapabilities property: List of supported capabilities (like Accelerated Networking) for the
    ...
    interface DefinitionStages {
        ...
        interface WithSupportedCapabilities {
             ...
             * Networking) for the image from which the source disk from the snapshot was originally created..
             *
             * @param supportedCapabilities List of supported capabilities (like Accelerated Networking) for the image
             *     from which the source disk from the snapshot was originally created.
             * @return the next definition stage.
             */
