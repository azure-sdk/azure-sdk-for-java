...
public final class DiskInspectionsClientImpl implements DiskInspectionsClient {
    ...
    private PollerFlux<PollResult<Void>, Void> beginCreateAsync(String location,
        RunDiskInspectionInput runDiskInspectionInput) {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<Void>, Void> beginCreate(String location,
        RunDiskInspectionInput runDiskInspectionInput) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> createAsync(String location, RunDiskInspectionInput runDiskInspectionInput) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> createAsync(String location, RunDiskInspectionInput runDiskInspectionInput, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public void create(String location, RunDiskInspectionInput runDiskInspectionInput) {
        createAsync(location, runDiskInspectionInput).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public void create(String location, RunDiskInspectionInput runDiskInspectionInput, Context context) {
        createAsync(location, runDiskInspectionInput, context).block();
    }
