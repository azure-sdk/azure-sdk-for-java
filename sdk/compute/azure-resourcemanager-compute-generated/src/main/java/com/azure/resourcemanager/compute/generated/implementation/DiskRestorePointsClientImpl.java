...
public final class DiskRestorePointsClientImpl implements DiskRestorePointsClient {
    ...
    public interface DiskRestorePointsService {
        ...
        Mono<Response<List<DiskRestorePointInner>>> listByRestorePoint(@HostParam("$host") String endpoint,
     ...
     * @return array of DiskRestorePoint along with {@link Response} on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<List<DiskRestorePointInner>>> listByRestorePointWithResponseAsync(String resourceGroupName,
    ...
    private Mono<Response<List<DiskRestorePointInner>>> listByRestorePointWithResponseAsync(String resourceGroupName,
        ...
        return service.listByRestorePoint(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(),
     ...
     * @throws CloudErrorAutoGeneratedException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return array of DiskRestorePoint on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<List<DiskRestorePointInner>> listByRestorePointAsync(String resourceGroupName,
        String restorePointCollectionName, String vmRestorePointName) {
        return listByRestorePointWithResponseAsync(resourceGroupName, restorePointCollectionName, vmRestorePointName)
     ...
     * @throws CloudErrorAutoGeneratedException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return array of DiskRestorePoint along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<List<DiskRestorePointInner>> listByRestorePointWithResponse(String resourceGroupName,
        String restorePointCollectionName, String vmRestorePointName, Context context) {
        return listByRestorePointWithResponseAsync(resourceGroupName, restorePointCollectionName, vmRestorePointName,
            context).block();
    }
     ...
     * @throws CloudErrorAutoGeneratedException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return array of DiskRestorePoint.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public List<DiskRestorePointInner> listByRestorePoint(String resourceGroupName, String restorePointCollectionName,
        String vmRestorePointName) {
        return listByRestorePointWithResponse(resourceGroupName, restorePointCollectionName, vmRestorePointName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DiskRestorePointInner> getAsync(String resourceGroupName, String restorePointCollectionName,
