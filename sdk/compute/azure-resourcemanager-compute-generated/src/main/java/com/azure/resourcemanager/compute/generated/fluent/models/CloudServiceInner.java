...
import com.azure.resourcemanager.compute.generated.models.SystemDataAutoGenerated;
...
public final class CloudServiceInner extends Resource {
     ...
     * @return the CloudServiceInner object itself.
     */
    public CloudServiceInner withSystemData(SystemDataAutoGenerated systemData) {
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("id".equals(fieldName)) {
                    ...
                    deserializedCloudServiceInner.systemData = SystemDataAutoGenerated.fromJson(reader);
