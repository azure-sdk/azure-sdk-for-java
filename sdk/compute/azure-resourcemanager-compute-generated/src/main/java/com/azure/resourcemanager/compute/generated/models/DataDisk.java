...
public final class DataDisk {
    ...
    /*
     * Specifies how the virtual machine disk should be created. Possible values are<br>**Attach:** This value is used
     * when you are using a specialized disk to create the virtual machine.<br>**FromImage:** This value is used when
     * you are using an image to create the virtual machine data disk. If you are using a platform image, you should
     * also use the imageReference element described above. If you are using a marketplace image, you should also use
     * the plan element previously described. <br>**Empty:** This value is used when creating an empty data disk.
     * <br>**Copy:** This value is used to create a data disk from a snapshot.<br>**Restore:** This value is used to
     ...
     * from the virtual machine. Supported values: **ForceDetach.** detachOption: **ForceDetach** is applicable only
     * for managed data disks. If a previous detachment attempt of the data disk did not complete due to an unexpected
     * failure from the virtual machine and the disk is still not released then use force-detach as a last resort
     * option to detach the disk forcibly from the VM. All writes might not have been flushed when using this detach
     * behavior. **This feature is still in preview** mode and is not supported for VirtualMachineScaleSet. To
    ...
    /**
     * Get the createOption property: Specifies how the virtual machine disk should be created. Possible values
     * are&lt;br&gt;**Attach:** This value is used when you are using a specialized disk to create the virtual
     * machine.&lt;br&gt;**FromImage:** This value is used when you are using an image to create the virtual machine
     * data disk. If you are using a platform image, you should also use the imageReference element described above. If
     * you are using a marketplace image, you should also use the plan element previously described.
     * &lt;br&gt;**Empty:** This value is used when creating an empty data disk. &lt;br&gt;**Copy:** This value is used
     * to create a data disk from a snapshot.&lt;br&gt;**Restore:** This value is used to create a data disk from a
     * disk restore point.
     * 
    ...
    /**
     * Set the createOption property: Specifies how the virtual machine disk should be created. Possible values
     * are&lt;br&gt;**Attach:** This value is used when you are using a specialized disk to create the virtual
     * machine.&lt;br&gt;**FromImage:** This value is used when you are using an image to create the virtual machine
     * data disk. If you are using a platform image, you should also use the imageReference element described above. If
     * you are using a marketplace image, you should also use the plan element previously described.
