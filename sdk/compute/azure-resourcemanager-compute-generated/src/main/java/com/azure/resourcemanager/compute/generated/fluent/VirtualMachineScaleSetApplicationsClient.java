...
public interface VirtualMachineScaleSetApplicationsClient {
    ...
    Response<VirtualMachineApplicationsProxyResourceListResultInner> listWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    VirtualMachineApplicationsProxyResourceListResultInner list(String resourceGroupName, String vmScaleSetName);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<VMApplicationProxyResourceInner> getWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    VMApplicationProxyResourceInner get(String resourceGroupName, String vmScaleSetName, String applicationName);
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<VMApplicationProxyResourceInner>, VMApplicationProxyResourceInner> beginPut(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    VMApplicationProxyResourceInner put(
        String resourceGroupName,
        String vmScaleSetName,
        String applicationName,
        VMApplicationProxyResourceInner application);
