...
public final class GallerySecurityPostureInner extends Resource {
    ...
    /**
     * Reads an instance of GallerySecurityPostureInner from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of GallerySecurityPostureInner if the JsonReader was pointing to an instance of it, or null
     * if it was pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the GallerySecurityPostureInner.
     */
    public static GallerySecurityPostureInner fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            GallerySecurityPostureInner deserializedGallerySecurityPostureInner = new GallerySecurityPostureInner();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("id".equals(fieldName)) {
                    deserializedGallerySecurityPostureInner.id = reader.getString();
                } else if ("name".equals(fieldName)) {
                    deserializedGallerySecurityPostureInner.name = reader.getString();
                } else if ("type".equals(fieldName)) {
                    deserializedGallerySecurityPostureInner.type = reader.getString();
                } else if ("location".equals(fieldName)) {
                    deserializedGallerySecurityPostureInner.withLocation(reader.getString());
                } else if ("tags".equals(fieldName)) {
                    Map<String, String> tags = reader.readMap(reader1 -> reader1.getString());
                    deserializedGallerySecurityPostureInner.withTags(tags);
                } else if ("properties".equals(fieldName)) {
                    deserializedGallerySecurityPostureInner.innerProperties
            ...
            return deserializedGallerySecurityPostureInner;
        });
    }
}
