...
import com.azure.resourcemanager.compute.generated.models.VirtualMachineScaleSetMigrationInfo;
...
public final class AvailabilitySetImpl implements AvailabilitySet, AvailabilitySet.Definition, AvailabilitySet.Update {
    ...
    public VirtualMachineScaleSetMigrationInfo virtualMachineScaleSetMigrationInfo() {
        return this.innerModel().virtualMachineScaleSetMigrationInfo();
    }
    ...
    AvailabilitySetImpl(AvailabilitySetInner innerObject,
    ...
    public Response<Void> cancelMigrationToVirtualMachineScaleSetWithResponse(Context context) {
        return serviceManager.availabilitySets()
            .cancelMigrationToVirtualMachineScaleSetWithResponse(resourceGroupName, availabilitySetName, context);
    }

    public void cancelMigrationToVirtualMachineScaleSet() {
        serviceManager.availabilitySets()
            .cancelMigrationToVirtualMachineScaleSet(resourceGroupName, availabilitySetName);
    }

    public void convertToVirtualMachineScaleSet() {
        serviceManager.availabilitySets().convertToVirtualMachineScaleSet(resourceGroupName, availabilitySetName);
    }

    public void convertToVirtualMachineScaleSet(ConvertToVirtualMachineScaleSetInput parameters, Context context) {
        serviceManager.availabilitySets()
            .convertToVirtualMachineScaleSet(resourceGroupName, availabilitySetName, parameters, context);
    }

    public Response<Void> startMigrationToVirtualMachineScaleSetWithResponse(MigrateToVirtualMachineScaleSetInput body,
        Context context) {
        return serviceManager.availabilitySets()
            .startMigrationToVirtualMachineScaleSetWithResponse(resourceGroupName, availabilitySetName, body, context);
    }

    public void startMigrationToVirtualMachineScaleSet(MigrateToVirtualMachineScaleSetInput body) {
        serviceManager.availabilitySets()
            .startMigrationToVirtualMachineScaleSet(resourceGroupName, availabilitySetName, body);
    }

    public Response<Void> validateMigrationToVirtualMachineScaleSetWithResponse(
        MigrateToVirtualMachineScaleSetInput body, Context context) {
        return serviceManager.availabilitySets()
            .validateMigrationToVirtualMachineScaleSetWithResponse(resourceGroupName, availabilitySetName, body,
                context);
    }

    public void validateMigrationToVirtualMachineScaleSet(MigrateToVirtualMachineScaleSetInput body) {
        serviceManager.availabilitySets()
            .validateMigrationToVirtualMachineScaleSet(resourceGroupName, availabilitySetName, body);
    }
