...
public final class GalleryImagesImpl implements GalleryImages {
    ...
    public LatestGalleryImageVersion getLatestVersionName(
        String resourceGroupName, String galleryName, String galleryImageName) {
        LatestGalleryImageVersionInner inner =
            this.serviceClient().getLatestVersionName(resourceGroupName, galleryName, galleryImageName);
        if (inner != null) {
            return new LatestGalleryImageVersionImpl(inner, this.manager());
        } else {
            return null;
        }
    }

    public Response<LatestGalleryImageVersion> getLatestVersionNameWithResponse(
        String resourceGroupName, String galleryName, String galleryImageName, String location, Context context) {
        Response<LatestGalleryImageVersionInner> inner =
            this
                .serviceClient()
                .getLatestVersionNameWithResponse(resourceGroupName, galleryName, galleryImageName, location, context);
        if (inner != null) {
            return new SimpleResponse<>(
                inner.getRequest(),
                inner.getStatusCode(),
                inner.getHeaders(),
                new LatestGalleryImageVersionImpl(inner.getValue(), this.manager()));
        } else {
            return null;
        }
    }
