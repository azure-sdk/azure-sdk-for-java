...
public final class VirtualMachineScaleSetsClientImpl implements VirtualMachineScaleSetsClient {
    ...
    public interface VirtualMachineScaleSetsService {
        ...
        Mono<Response<VirtualMachineScaleSetListResult>> listByLocation(@HostParam("$host") String endpoint,
            @PathParam("location") int location, @QueryParam("api-version") String apiVersion,
    ...
    private Mono<PagedResponse<VirtualMachineScaleSetInner>> listByLocationSinglePageAsync(int location) {
    ...
    private PagedFlux<VirtualMachineScaleSetInner> listByLocationAsync(int location) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<VirtualMachineScaleSetInner> listByLocationAsync(int location, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<VirtualMachineScaleSetInner> listByLocation(int location) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<VirtualMachineScaleSetInner> listByLocation(int location, Context context) {
    ...
    private Mono<Response<RecoveryWalkResponseInner>>
        ...
        return service.forceRecoveryServiceFabricPlatformUpdateDomainWalk(this.client.getEndpoint(), resourceGroupName,
            vmScaleSetName, apiVersion, this.client.getSubscriptionId(), platformUpdateDomain, zone, placementGroupId,
            accept, context);
    }
