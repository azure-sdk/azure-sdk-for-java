...
public final class VirtualMachineScaleSetsClientImpl implements VirtualMachineScaleSetsClient {
    ...
    public interface VirtualMachineScaleSetsService {
        ...
        @Headers({"Content-Type: application/json"})
        @Post(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachineScaleSets/{vmScaleSetName}/invokeupgrade")
        @ExpectedResponses({200, 202})
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Mono<Response<Flux<ByteBuffer>>> invokeUpgrade(
            @HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("vmScaleSetName") String vmScaleSetName,
            @QueryParam("api-version") String apiVersion,
        ...
        Mono<Response<RecoveryWalkResponseInner>> forceRecoveryServiceFabricPlatformUpdateDomainWalk(
            ...
            @QueryParam("placementGroupId") String placementGroupId,
            @HeaderParam("Accept") String accept,
            Context context);
     ...
     * @return all the VM scale sets under the specified subscription for the specified location along with {@link
     ...
     * @throws ApiErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return describes a Virtual Machine Scale Set along with {@link Response} on successful completion of {@link
     *     Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ...
    public SyncPoller<PollResult<Void>, Void> beginDeallocate(
        ...
        Context context) {
        return this
            .beginDeallocateAsync(resourceGroupName, vmScaleSetName, hibernate, vmInstanceIDs, context)
            .getSyncPoller();
    }
    ...
    private Mono<Void> deallocateAsync(
        ...
        Boolean hibernate,
        VirtualMachineScaleSetVMInstanceIDs vmInstanceIDs) {
        return beginDeallocateAsync(resourceGroupName, vmScaleSetName, hibernate, vmInstanceIDs)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<Void> deallocateAsync(
        ...
        VirtualMachineScaleSetVMInstanceIDs vmInstanceIDs,
        Context context) {
        return beginDeallocateAsync(resourceGroupName, vmScaleSetName, hibernate, vmInstanceIDs, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private PollerFlux<PollResult<Void>, Void> beginDeleteInstancesAsync(
        ...
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono =
            deleteInstancesWithResponseAsync(resourceGroupName, vmScaleSetName, vmInstanceIDs, forceDeletion, context);
        return this
            .client
            .<Void, Void>getLroResult(mono, this.client.getHttpPipeline(), Void.class, Void.class, context);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDeleteInstances(
        ...
        final Boolean forceDeletion = null;
        return this
            .beginDeleteInstancesAsync(resourceGroupName, vmScaleSetName, vmInstanceIDs, forceDeletion)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDeleteInstances(
        ...
        Context context) {
        return this
            .beginDeleteInstancesAsync(resourceGroupName, vmScaleSetName, vmInstanceIDs, forceDeletion, context)
            .getSyncPoller();
    }
    ...
    private Mono<Void> deleteInstancesAsync(
        ...
        VirtualMachineScaleSetVMInstanceRequiredIDs vmInstanceIDs,
        Boolean forceDeletion) {
        return beginDeleteInstancesAsync(resourceGroupName, vmScaleSetName, vmInstanceIDs, forceDeletion)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     * @throws ApiErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the status of a VM scale set instance along with {@link Response} on successful completion of {@link
     *     Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ...
    public SyncPoller<PollResult<Void>, Void> beginPowerOff(
        ...
        Context context) {
        return this
            .beginPowerOffAsync(resourceGroupName, vmScaleSetName, skipShutdown, vmInstanceIDs, context)
            .getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<Void>, Void> beginReapply(
        String resourceGroupName, String vmScaleSetName, Context context) {
    ...
    private Mono<Void> reapplyAsync(String resourceGroupName, String vmScaleSetName) {
        return beginReapplyAsync(resourceGroupName, vmScaleSetName)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<Void> reapplyAsync(String resourceGroupName, String vmScaleSetName, Context context) {
        return beginReapplyAsync(resourceGroupName, vmScaleSetName, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginPerformMaintenance(
        ...
        Context context) {
        return this
            .beginPerformMaintenanceAsync(resourceGroupName, vmScaleSetName, vmInstanceIDs, context)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginUpdateInstances(
        ...
        Context context) {
        return this
            .beginUpdateInstancesAsync(resourceGroupName, vmScaleSetName, vmInstanceIDs, context)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginReimage(
        ...
        Context context) {
        return this
            .beginReimageAsync(resourceGroupName, vmScaleSetName, vmScaleSetReimageInput, context)
            .getSyncPoller();
    }
    ...
    /**
     * Invoke upgrade on deferred rolling upgrade for OS disks in the virtual machines in a VM scale set.
     *
     * @param resourceGroupName The name of the resource group.
     * @param vmScaleSetName The name of the VM scale set.
     * @param vmInstanceIDs A list of virtual machine instance IDs from the VM scale set.
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> invokeUpgradeWithResponseAsync(
        String resourceGroupName, String vmScaleSetName, VirtualMachineScaleSetVMInstanceIDs vmInstanceIDs) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<Void>, Void> beginInvokeUpgradeAsync(
        String resourceGroupName, String vmScaleSetName, VirtualMachineScaleSetVMInstanceIDs vmInstanceIDs) {
        Mono<Response<Flux<ByteBuffer>>> mono =
            invokeUpgradeWithResponseAsync(resourceGroupName, vmScaleSetName, vmInstanceIDs);
        return this
            .client
            .<Void, Void>getLroResult(
                mono, this.client.getHttpPipeline(), Void.class, Void.class, this.client.getContext());
    ...
    private PollerFlux<PollResult<Void>, Void> beginInvokeUpgradeAsync(
        ...
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono =
            invokeUpgradeWithResponseAsync(resourceGroupName, vmScaleSetName, vmInstanceIDs, context);
        return this
            .client
            .<Void, Void>getLroResult(mono, this.client.getHttpPipeline(), Void.class, Void.class, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<Void>, Void> beginInvokeUpgrade(String resourceGroupName, String vmScaleSetName) {
        final VirtualMachineScaleSetVMInstanceIDs vmInstanceIDs = null;
        return this.beginInvokeUpgradeAsync(resourceGroupName, vmScaleSetName, vmInstanceIDs).getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<Void>, Void> beginInvokeUpgrade(
        String resourceGroupName,
        String vmScaleSetName,
        VirtualMachineScaleSetVMInstanceIDs vmInstanceIDs,
        Context context) {
        return this.beginInvokeUpgradeAsync(resourceGroupName, vmScaleSetName, vmInstanceIDs, context).getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> invokeUpgradeAsync(
        String resourceGroupName, String vmScaleSetName, VirtualMachineScaleSetVMInstanceIDs vmInstanceIDs) {
        return beginInvokeUpgradeAsync(resourceGroupName, vmScaleSetName, vmInstanceIDs)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> invokeUpgradeAsync(String resourceGroupName, String vmScaleSetName) {
        final VirtualMachineScaleSetVMInstanceIDs vmInstanceIDs = null;
        return beginInvokeUpgradeAsync(resourceGroupName, vmScaleSetName, vmInstanceIDs)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    ...
    private Mono<Void> invokeUpgradeAsync(
        ...
        VirtualMachineScaleSetVMInstanceIDs vmInstanceIDs,
        Context context) {
        return beginInvokeUpgradeAsync(resourceGroupName, vmScaleSetName, vmInstanceIDs, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public void invokeUpgrade(String resourceGroupName, String vmScaleSetName) {
        final VirtualMachineScaleSetVMInstanceIDs vmInstanceIDs = null;
        invokeUpgradeAsync(resourceGroupName, vmScaleSetName, vmInstanceIDs).block();
    }
    ...
    public void invokeUpgrade(
        ...
        VirtualMachineScaleSetVMInstanceIDs vmInstanceIDs,
        Context context) {
        invokeUpgradeAsync(resourceGroupName, vmScaleSetName, vmInstanceIDs, context).block();
    }
    ...
    public RecoveryWalkResponseInner forceRecoveryServiceFabricPlatformUpdateDomainWalk(
        ...
        final String zone = null;
        final String placementGroupId = null;
        return forceRecoveryServiceFabricPlatformUpdateDomainWalkWithResponse(
                resourceGroupName, vmScaleSetName, platformUpdateDomain, zone, placementGroupId, Context.NONE)
            .getValue();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginSetOrchestrationServiceState(
        String resourceGroupName, String vmScaleSetName, OrchestrationServiceStateInput parameters, Context context) {
        return this
            .beginSetOrchestrationServiceStateAsync(resourceGroupName, vmScaleSetName, parameters, context)
            .getSyncPoller();
    }
