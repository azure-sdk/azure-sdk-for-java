...
public interface CapacityReservationGroup {
    ...
    interface DefinitionStages {
        ...
        interface WithSharingProfile {
             ...
             *     reservation group resource. Pls. keep in mind the capacity reservation group resource generally can
             *     be shared across subscriptions belonging to a single azure AAD tenant or cross AAD tenant if there is
             *     a trust relationship established between the AAD tenants. **Note:** Minimum api-version: 2023-09-01.
