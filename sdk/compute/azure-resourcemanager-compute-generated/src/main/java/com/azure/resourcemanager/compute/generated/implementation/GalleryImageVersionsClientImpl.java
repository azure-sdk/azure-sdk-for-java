...
import com.azure.resourcemanager.compute.generated.models.GalleryImageVersionList;
...
public final class GalleryImageVersionsClientImpl implements GalleryImageVersionsClient {
    ...
    public interface GalleryImageVersionsService {
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Mono<Response<LatestVersionInner>> getLatest(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("galleryName") String galleryName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<GalleryImageVersionInner> getAsync(
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(
        ...
        Context context) {
        return this
            .beginDeleteAsync(resourceGroupName, galleryName, galleryImageName, galleryImageVersionName, context)
            .getSyncPoller();
    }
     ...
     * @throws ApiErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return latestVersion is an ARM resource along with {@link Response} on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<LatestVersionInner>> getLatestWithResponseAsync(
     ...
     * @throws ApiErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return latestVersion is an ARM resource on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<LatestVersionInner> getLatestAsync(
        String resourceGroupName, String galleryName, String galleryImageName) {
        return getLatestWithResponseAsync(resourceGroupName, galleryName, galleryImageName)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     * @throws ApiErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return latestVersion is an ARM resource along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<LatestVersionInner> getLatestWithResponse(
        String resourceGroupName, String galleryName, String galleryImageName, Context context) {
        return getLatestWithResponseAsync(resourceGroupName, galleryName, galleryImageName, context).block();
    }
     ...
     * @throws ApiErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return latestVersion is an ARM resource.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public LatestVersionInner getLatest(String resourceGroupName, String galleryName, String galleryImageName) {
        return getLatestWithResponse(resourceGroupName, galleryName, galleryImageName, Context.NONE).getValue();
    }
