...
public final class VirtualMachineExtensionImpl
    ...
    public VirtualMachineExtensionImpl withSuppressFailures(Boolean suppressFailures) {
        if (isInCreateMode()) {
    ...
    public VirtualMachineExtensionImpl withProvisioningState(String provisioningState) {
