...
public final class DiskInner extends Resource {
     ...
     * @return the DiskInner object itself.
     */
    public DiskInner withPurchasePlan(DiskPurchasePlan purchasePlan) {
        if (this.innerProperties() == null) {
            this.innerProperties = new DiskProperties();
        }
    ...
    public void validate() {
        ...
        if (location() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Missing required property location in model DiskInner"));
        }
    }
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("id".equals(fieldName)) {
                    ...
                    deserializedDiskInner.managedBy = reader.getString();
                } else if ("managedByExtended".equals(fieldName)) {
                    List<String> managedByExtended = reader.readArray(reader1 -> reader1.getString());
                    deserializedDiskInner.managedByExtended = managedByExtended;
                } else if ("sku".equals(fieldName)) {
                    deserializedDiskInner.sku = DiskSku.fromJson(reader);
                } else if ("zones".equals(fieldName)) {
                    List<String> zones = reader.readArray(reader1 -> reader1.getString());
                    deserializedDiskInner.zones = zones;
                } else if ("extendedLocation".equals(fieldName)) {
                    deserializedDiskInner.extendedLocation = ExtendedLocation.fromJson(reader);
