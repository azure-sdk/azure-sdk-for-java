...
public final class LogAnalyticsClientImpl implements LogAnalyticsClient {
    ...
    public interface LogAnalyticsService {
        ...
        Mono<Response<Flux<ByteBuffer>>> exportThrottledRequests(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("location") String location, @BodyParam("application/json") ThrottledRequestsInput body,
    ...
    private Mono<Response<Flux<ByteBuffer>>> exportRequestRateByIntervalWithResponseAsync(String location,
        ...
        return FluxUtil
            .withContext(context -> service.exportRequestRateByInterval(this.client.getEndpoint(), apiVersion,
    ...
    private Mono<Response<Flux<ByteBuffer>>> exportRequestRateByIntervalWithResponseAsync(String location,
        ...
        return service.exportRequestRateByInterval(this.client.getEndpoint(), apiVersion,
            this.client.getSubscriptionId(), location, parameters, accept, context);
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> exportThrottledRequestsWithResponseAsync(String location,
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.exportThrottledRequests(this.client.getEndpoint(), apiVersion,
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> exportThrottledRequestsWithResponseAsync(String location,
        ThrottledRequestsInput body, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.exportThrottledRequests(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(),
            location, body, accept, context);
    }
    ...
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<LogAnalyticsOperationResultInner>, LogAnalyticsOperationResultInner>
        beginExportThrottledRequestsAsync(String location, ThrottledRequestsInput body) {
        Mono<Response<Flux<ByteBuffer>>> mono = exportThrottledRequestsWithResponseAsync(location, body);
        return this.client.<LogAnalyticsOperationResultInner, LogAnalyticsOperationResultInner>getLroResult(mono,
            this.client.getHttpPipeline(), LogAnalyticsOperationResultInner.class,
            LogAnalyticsOperationResultInner.class, this.client.getContext());
    }
    ...
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<LogAnalyticsOperationResultInner>, LogAnalyticsOperationResultInner>
        beginExportThrottledRequestsAsync(String location, ThrottledRequestsInput body, Context context) {
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono = exportThrottledRequestsWithResponseAsync(location, body, context);
        return this.client.<LogAnalyticsOperationResultInner, LogAnalyticsOperationResultInner>getLroResult(mono,
            this.client.getHttpPipeline(), LogAnalyticsOperationResultInner.class,
            LogAnalyticsOperationResultInner.class, context);
    }
    ...
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<LogAnalyticsOperationResultInner>, LogAnalyticsOperationResultInner>
        beginExportThrottledRequests(String location, ThrottledRequestsInput body) {
        return this.beginExportThrottledRequestsAsync(location, body).getSyncPoller();
    }
    ...
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<LogAnalyticsOperationResultInner>, LogAnalyticsOperationResultInner>
        beginExportThrottledRequests(String location, ThrottledRequestsInput body, Context context) {
        return this.beginExportThrottledRequestsAsync(location, body, context).getSyncPoller();
    }
    ...
    private Mono<LogAnalyticsOperationResultInner> exportThrottledRequestsAsync(String location,
        ThrottledRequestsInput body) {
        return beginExportThrottledRequestsAsync(location, body).last().flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<LogAnalyticsOperationResultInner> exportThrottledRequestsAsync(String location,
        ThrottledRequestsInput body, Context context) {
        return beginExportThrottledRequestsAsync(location, body, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public LogAnalyticsOperationResultInner exportThrottledRequests(String location, ThrottledRequestsInput body) {
        return exportThrottledRequestsAsync(location, body).block();
    }
    ...
    public LogAnalyticsOperationResultInner exportThrottledRequests(String location, ThrottledRequestsInput body,
        Context context) {
        return exportThrottledRequestsAsync(location, body, context).block();
    }
}
