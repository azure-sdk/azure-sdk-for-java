...
public final class VirtualMachineImpl implements VirtualMachine, VirtualMachine.Definition, VirtualMachine.Update {
    ...
    public VirtualMachine attachDetachDataDisks(AttachDetachDataDisksRequest parameters) {
        return serviceManager.virtualMachines().attachDetachDataDisks(resourceGroupName, vmName, parameters);
    }

    public VirtualMachine attachDetachDataDisks(AttachDetachDataDisksRequest parameters, Context context) {
