...
public final class VirtualMachineImpl implements VirtualMachine, VirtualMachine.Definition, VirtualMachine.Update {
    ...
    public void migrateToVMScaleSet() {
        serviceManager.virtualMachines().migrateToVMScaleSet(resourceGroupName, vmName);
    }

    public void migrateToVMScaleSet(MigrateVMToVirtualMachineScaleSetInput parameters, Context context) {
        serviceManager.virtualMachines().migrateToVMScaleSet(resourceGroupName, vmName, parameters, context);
    }
