...
public final class GalleryScriptVersionImpl
    ...
    public GalleryScriptVersionImpl withPublishingProfile(GalleryScriptVersionPublishingProfile publishingProfile) {
        if (isInCreateMode()) {
            this.innerModel().withPublishingProfile(publishingProfile);
            return this;
        } else {
            this.updateGalleryScriptVersion.withPublishingProfile(publishingProfile);
            return this;
        }
    }

    public GalleryScriptVersionImpl withSafetyProfile(GalleryScriptVersionSafetyProfile safetyProfile) {
        if (isInCreateMode()) {
            this.innerModel().withSafetyProfile(safetyProfile);
            return this;
        } else {
            this.updateGalleryScriptVersion.withSafetyProfile(safetyProfile);
            return this;
        }
    }
