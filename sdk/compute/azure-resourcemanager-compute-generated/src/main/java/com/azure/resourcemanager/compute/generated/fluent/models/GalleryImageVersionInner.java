...
public final class GalleryImageVersionInner extends Resource {
    ...
    /**
     * Set the validationsProfile property: This is the validations profile of a Gallery Image Version.
     *
     * @param validationsProfile the validationsProfile value to set.
     * @return the GalleryImageVersionInner object itself.
     */
    public GalleryImageVersionInner withValidationsProfile(ValidationsProfile validationsProfile) {
        if (this.innerProperties() == null) {
            this.innerProperties = new GalleryImageVersionProperties();
        }
        this.innerProperties().withValidationsProfile(validationsProfile);
        return this;
    }
