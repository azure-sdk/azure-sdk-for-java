...
public final class CommunitySecurityPostureVersionInner extends PirCommunityGalleryResource {
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeJsonField("securityPosture", this.securityPosture);
        return jsonWriter.writeEndObject();
    }

    /**
     * Reads an instance of CommunitySecurityPostureVersionInner from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of CommunitySecurityPostureVersionInner if the JsonReader was pointing to an instance of it,
     * or null if it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the CommunitySecurityPostureVersionInner.
     */
    public static CommunitySecurityPostureVersionInner fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            CommunitySecurityPostureVersionInner deserializedCommunitySecurityPostureVersionInner
                = new CommunitySecurityPostureVersionInner();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("name".equals(fieldName)) {
                    deserializedCommunitySecurityPostureVersionInner.name = reader.getString();
                } else if ("type".equals(fieldName)) {
                    deserializedCommunitySecurityPostureVersionInner.type = reader.getString();
                } else if ("identifier".equals(fieldName)) {
                    deserializedCommunitySecurityPostureVersionInner.innerIdentifier
                        = CommunityGalleryIdentifier.fromJson(reader);
                } else if ("properties".equals(fieldName)) {
                    deserializedCommunitySecurityPostureVersionInner.innerProperties
                        = CommunitySecurityPostureVersionProperties.fromJson(reader);
                } else if ("securityPosture".equals(fieldName)) {
                    deserializedCommunitySecurityPostureVersionInner.securityPosture
                        = CommunitySecurityPostureInner.fromJson(reader);
                } else {
                    reader.skipChildren();
                }
            }

            return deserializedCommunitySecurityPostureVersionInner;
        });
    }
}
