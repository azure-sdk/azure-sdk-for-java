...
public final class VirtualMachineScaleSetExtensionImpl implements VirtualMachineScaleSetExtension,
    ...
    public VirtualMachineScaleSetExtensionImpl withExtensionName(String extensionName) {
    ...
    public VirtualMachineScaleSetExtensionImpl withSuppressFailures(Boolean suppressFailures) {
        if (isInCreateMode()) {
    ...
    public VirtualMachineScaleSetExtensionImpl withName(String name) {
        this.updateExtensionParameters.withName(name);
        return this;
    }
