...
public final class VirtualMachineScaleSetExtensionsImpl implements VirtualMachineScaleSetExtensions {
    ...
    public VirtualMachineScaleSetExtensionsImpl(VirtualMachineScaleSetExtensionsClient innerClient,
    ...
    public PagedIterable<VirtualMachineScaleSetExtension> list(String resourceGroupName, String vmScaleSetName) {
        ...
        return ResourceManagerUtils.mapPage(inner,
            inner1 -> new VirtualMachineScaleSetExtensionImpl(inner1, this.manager()));
    }
    ...
    public Response<VirtualMachineScaleSetExtension> getWithResponse(String resourceGroupName, String vmScaleSetName,
        String vmssExtensionName, String expand, Context context) {
        Response<VirtualMachineScaleSetExtensionInner> inner = this.serviceClient()
            .getWithResponse(resourceGroupName, vmScaleSetName, vmssExtensionName, expand, context);
        if (inner != null) {
    ...
    public VirtualMachineScaleSetExtension get(String resourceGroupName, String vmScaleSetName,
    ...
    public VirtualMachineScaleSetExtension createOrUpdate(String resourceGroupName, String vmScaleSetName,
        String vmssExtensionName, VirtualMachineScaleSetExtensionInner extensionParameters) {
        VirtualMachineScaleSetExtensionInner inner = this.serviceClient()
    ...
    public VirtualMachineScaleSetExtension update(String resourceGroupName, String vmScaleSetName,
        String vmssExtensionName, VirtualMachineScaleSetExtensionUpdate extensionParameters) {
        VirtualMachineScaleSetExtensionInner inner
            = this.serviceClient().update(resourceGroupName, vmScaleSetName, vmssExtensionName, extensionParameters);
        if (inner != null) {
            return new VirtualMachineScaleSetExtensionImpl(inner, this.manager());
        } else {
            return null;
