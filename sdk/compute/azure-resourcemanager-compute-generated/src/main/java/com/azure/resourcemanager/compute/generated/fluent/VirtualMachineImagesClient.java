...
public interface VirtualMachineImagesClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<List<VirtualMachineImageInner>> listWithPropertiesWithResponse(String location, String publisherName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    List<VirtualMachineImageInner> listWithProperties(String location, String publisherName, String offer, String skus);
}
