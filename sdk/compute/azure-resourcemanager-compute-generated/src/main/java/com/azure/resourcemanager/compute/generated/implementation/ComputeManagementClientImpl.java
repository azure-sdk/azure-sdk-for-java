...
public final class ComputeManagementClientImpl implements ComputeManagementClient {
    ...
    /**
     * The DiagnosticOperationsClient object to access its operations.
     */
    private final DiagnosticOperationsClient diagnosticOperations;

    /**
     * Gets the DiagnosticOperationsClient object to access its operations.
     * 
     * @return the DiagnosticOperationsClient object.
     */
    public DiagnosticOperationsClient getDiagnosticOperations() {
        return this.diagnosticOperations;
    }

    /**
     * The DiskInspectionsClient object to access its operations.
     */
    private final DiskInspectionsClient diskInspections;

    /**
     * Gets the DiskInspectionsClient object to access its operations.
     * 
     * @return the DiskInspectionsClient object.
     */
    public DiskInspectionsClient getDiskInspections() {
        return this.diskInspections;
    }
    ...
    /**
     * The DiskInspectionStorageConfigurationsClient object to access its operations.
     */
    private final DiskInspectionStorageConfigurationsClient diskInspectionStorageConfigurations;

    /**
     * Gets the DiskInspectionStorageConfigurationsClient object to access its operations.
     * 
     * @return the DiskInspectionStorageConfigurationsClient object.
     */
    public DiskInspectionStorageConfigurationsClient getDiskInspectionStorageConfigurations() {
        return this.diskInspectionStorageConfigurations;
    }

    /**
     * The SpotPlacementRecommendersClient object to access its operations.
     */
    private final SpotPlacementRecommendersClient spotPlacementRecommenders;

    /**
     * Gets the SpotPlacementRecommendersClient object to access its operations.
     * 
     * @return the SpotPlacementRecommendersClient object.
     */
    public SpotPlacementRecommendersClient getSpotPlacementRecommenders() {
        return this.spotPlacementRecommenders;
    }
    ...
    /**
     * The AttributeBasedVMSizeRecommendersClient object to access its operations.
     */
    private final AttributeBasedVMSizeRecommendersClient attributeBasedVMSizeRecommenders;

    /**
     * Gets the AttributeBasedVMSizeRecommendersClient object to access its operations.
     * 
     * @return the AttributeBasedVMSizeRecommendersClient object.
     */
    public AttributeBasedVMSizeRecommendersClient getAttributeBasedVMSizeRecommenders() {
        return this.attributeBasedVMSizeRecommenders;
    }
    ...
    ComputeManagementClientImpl(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter,
        ...
        this.diagnosticOperations = new DiagnosticOperationsClientImpl(this);
        this.diskInspections = new DiskInspectionsClientImpl(this);
        this.diagnostics = new DiagnosticsClientImpl(this);
        this.diskInspectionStorageConfigurations = new DiskInspectionStorageConfigurationsClientImpl(this);
        this.spotPlacementRecommenders = new SpotPlacementRecommendersClientImpl(this);
        this.spotPlacementScores = new SpotPlacementScoresClientImpl(this);
        this.attributeBasedVMSizeRecommenders = new AttributeBasedVMSizeRecommendersClientImpl(this);
