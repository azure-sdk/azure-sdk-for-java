...
public final class ComputeManagementClientImpl implements ComputeManagementClient {
    ...
    /**
     * The GallerySecurityPosturesClient object to access its operations.
     */
    private final GallerySecurityPosturesClient gallerySecurityPostures;

    /**
     * Gets the GallerySecurityPosturesClient object to access its operations.
     * 
     * @return the GallerySecurityPosturesClient object.
     */
    public GallerySecurityPosturesClient getGallerySecurityPostures() {
        return this.gallerySecurityPostures;
    }

    /**
     * The GallerySecurityPostureVersionsClient object to access its operations.
     */
    private final GallerySecurityPostureVersionsClient gallerySecurityPostureVersions;

    /**
     * Gets the GallerySecurityPostureVersionsClient object to access its operations.
     * 
     * @return the GallerySecurityPostureVersionsClient object.
     */
    public GallerySecurityPostureVersionsClient getGallerySecurityPostureVersions() {
        return this.gallerySecurityPostureVersions;
    }
    ...
    /**
     * The CommunityGallerySecurityPosturesClient object to access its operations.
     */
    private final CommunityGallerySecurityPosturesClient communityGallerySecurityPostures;

    /**
     * Gets the CommunityGallerySecurityPosturesClient object to access its operations.
     * 
     * @return the CommunityGallerySecurityPosturesClient object.
     */
    public CommunityGallerySecurityPosturesClient getCommunityGallerySecurityPostures() {
        return this.communityGallerySecurityPostures;
    }

    /**
     * The CommunityGallerySecurityPostureVersionsClient object to access its operations.
     */
    private final CommunityGallerySecurityPostureVersionsClient communityGallerySecurityPostureVersions;

    /**
     * Gets the CommunityGallerySecurityPostureVersionsClient object to access its operations.
     * 
     * @return the CommunityGallerySecurityPostureVersionsClient object.
     */
    public CommunityGallerySecurityPostureVersionsClient getCommunityGallerySecurityPostureVersions() {
        return this.communityGallerySecurityPostureVersions;
    }
    ...
    ComputeManagementClientImpl(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter,
        ...
        this.gallerySecurityPostures = new GallerySecurityPosturesClientImpl(this);
        this.gallerySecurityPostureVersions = new GallerySecurityPostureVersionsClientImpl(this);
        ...
        this.communityGallerySecurityPostures = new CommunityGallerySecurityPosturesClientImpl(this);
        this.communityGallerySecurityPostureVersions = new CommunityGallerySecurityPostureVersionsClientImpl(this);
