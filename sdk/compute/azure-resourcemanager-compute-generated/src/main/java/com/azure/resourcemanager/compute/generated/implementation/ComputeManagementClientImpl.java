...
public final class ComputeManagementClientImpl implements ComputeManagementClient {
    ...
    /** The VirtualMachineScaleSetApplicationsClient object to access its operations. */
    private final VirtualMachineScaleSetApplicationsClient virtualMachineScaleSetApplications;

    /**
     * Gets the VirtualMachineScaleSetApplicationsClient object to access its operations.
     *
     * @return the VirtualMachineScaleSetApplicationsClient object.
     */
    public VirtualMachineScaleSetApplicationsClient getVirtualMachineScaleSetApplications() {
        return this.virtualMachineScaleSetApplications;
    }
    ...
    /** The VirtualMachineScaleSetVirtualMachineApplicationsClient object to access its operations. */
    private final VirtualMachineScaleSetVirtualMachineApplicationsClient
        virtualMachineScaleSetVirtualMachineApplications;

    /**
     * Gets the VirtualMachineScaleSetVirtualMachineApplicationsClient object to access its operations.
     *
     * @return the VirtualMachineScaleSetVirtualMachineApplicationsClient object.
     */
    public VirtualMachineScaleSetVirtualMachineApplicationsClient
        getVirtualMachineScaleSetVirtualMachineApplications() {
        return this.virtualMachineScaleSetVirtualMachineApplications;
    }
    ...
    /** The VirtualMachineApplicationsClient object to access its operations. */
    private final VirtualMachineApplicationsClient virtualMachineApplications;

    /**
     * Gets the VirtualMachineApplicationsClient object to access its operations.
     *
     * @return the VirtualMachineApplicationsClient object.
     */
    public VirtualMachineApplicationsClient getVirtualMachineApplications() {
        return this.virtualMachineApplications;
    }
    ...
    ComputeManagementClientImpl(
        ...
        this.virtualMachineScaleSetApplications = new VirtualMachineScaleSetApplicationsClientImpl(this);
        ...
        this.virtualMachineScaleSetVirtualMachineApplications =
            new VirtualMachineScaleSetVirtualMachineApplicationsClientImpl(this);
        ...
        this.virtualMachineApplications = new VirtualMachineApplicationsClientImpl(this);
