...
import com.azure.resourcemanager.compute.generated.fluent.models.VirtualMachineExtensionProperties;
 ...
 */
@Fluent
public final class VirtualMachineExtension extends ResourceWithOptionalLocation {
    /*
     ...
     */
    public VirtualMachineExtension withForceUpdateTag(String forceUpdateTag) {
     ...
     * @return the VirtualMachineExtension object itself.
     */
    public VirtualMachineExtension withPublisher(String publisher) {
        if (this.innerProperties() == null) {
            this.innerProperties = new VirtualMachineExtensionProperties();
        }
     ...
     * @return the VirtualMachineExtension object itself.
     */
    public VirtualMachineExtension withTypePropertiesType(String type) {
        if (this.innerProperties() == null) {
            this.innerProperties = new VirtualMachineExtensionProperties();
        }
     ...
     * @return the VirtualMachineExtension object itself.
     */
    public VirtualMachineExtension withTypeHandlerVersion(String typeHandlerVersion) {
        if (this.innerProperties() == null) {
            this.innerProperties = new VirtualMachineExtensionProperties();
        }
     ...
     * @return the VirtualMachineExtension object itself.
     */
    public VirtualMachineExtension withAutoUpgradeMinorVersion(Boolean autoUpgradeMinorVersion) {
        if (this.innerProperties() == null) {
            this.innerProperties = new VirtualMachineExtensionProperties();
        }
     ...
     * @return the VirtualMachineExtension object itself.
     */
    public VirtualMachineExtension withEnableAutomaticUpgrade(Boolean enableAutomaticUpgrade) {
        if (this.innerProperties() == null) {
            this.innerProperties = new VirtualMachineExtensionProperties();
        }
     ...
     * @return the VirtualMachineExtension object itself.
     */
    public VirtualMachineExtension withSettings(Object settings) {
        if (this.innerProperties() == null) {
            this.innerProperties = new VirtualMachineExtensionProperties();
        }
     ...
     * @return the VirtualMachineExtension object itself.
     */
    public VirtualMachineExtension withProtectedSettings(Object protectedSettings) {
        if (this.innerProperties() == null) {
            this.innerProperties = new VirtualMachineExtensionProperties();
        }
     ...
     * @return the VirtualMachineExtension object itself.
     */
    public VirtualMachineExtension withInstanceView(VirtualMachineExtensionInstanceView instanceView) {
        if (this.innerProperties() == null) {
            this.innerProperties = new VirtualMachineExtensionProperties();
        }
     ...
     * @return the VirtualMachineExtension object itself.
     */
    public VirtualMachineExtension withSuppressFailures(Boolean suppressFailures) {
        if (this.innerProperties() == null) {
            this.innerProperties = new VirtualMachineExtensionProperties();
        }
     ...
     * @return the VirtualMachineExtension object itself.
     */
    public VirtualMachineExtension withProvisionAfterExtensions(List<String> provisionAfterExtensions) {
        if (this.innerProperties() == null) {
            this.innerProperties = new VirtualMachineExtensionProperties();
        }
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("id".equals(fieldName)) {
                    ...
                    deserializedVirtualMachineExtension.withLocation(reader.getString());
                } else if ("tags".equals(fieldName)) {
                    Map<String, String> tags = reader.readMap(reader1 -> reader1.getString());
                    deserializedVirtualMachineExtension.withTags(tags);
                } else if ("properties".equals(fieldName)) {
                    deserializedVirtualMachineExtension.innerProperties
