...
public interface Disk {
    ...
    /**
     * Gets the extendedLocation property: The extended location where the disk will be created. Extended location
     * cannot be changed.
     * 
    ...
    /**
     * Gets the burstingEnabled property: Set to true to enable bursting beyond the provisioned performance target of
    ...
    interface DefinitionStages {
        ...
        interface WithCreate extends DefinitionStages.WithTags, DefinitionStages.WithSku, DefinitionStages.WithZones,
            DefinitionStages.WithExtendedLocation, DefinitionStages.WithOsType, DefinitionStages.WithHyperVGeneration,
            DefinitionStages.WithPurchasePlan, DefinitionStages.WithSupportedCapabilities,
            DefinitionStages.WithCreationData, DefinitionStages.WithDiskSizeGB,
            DefinitionStages.WithEncryptionSettingsCollection, DefinitionStages.WithDiskIopsReadWrite,
            DefinitionStages.WithDiskMBpsReadWrite, DefinitionStages.WithDiskIopsReadOnly,
            DefinitionStages.WithDiskMBpsReadOnly, DefinitionStages.WithEncryption, DefinitionStages.WithMaxShares,
            DefinitionStages.WithNetworkAccessPolicy, DefinitionStages.WithDiskAccessId, DefinitionStages.WithTier,
            DefinitionStages.WithBurstingEnabled, DefinitionStages.WithSupportsHibernation,
            DefinitionStages.WithSecurityProfile, DefinitionStages.WithCompletionPercent,
            DefinitionStages.WithPublicNetworkAccess, DefinitionStages.WithDataAccessAuthMode,
        ...
        interface WithExtendedLocation {
            /**
             * Specifies the extendedLocation property: The extended location where the disk will be created. Extended
             * location cannot be changed..
             * 
             * @param extendedLocation The extended location where the disk will be created. Extended location cannot be
             * changed.
             * @return the next definition stage.
             */
        ...
        interface WithPurchasePlan {
            /**
             * Specifies the purchasePlan property: Purchase plan information for the the image from which the OS disk
             * was created. E.g. - {name: 2019-Datacenter, publisher: MicrosoftWindowsServer, product: WindowsServer}.
             * 
             * @param purchasePlan Purchase plan information for the the image from which the OS disk was created. E.g.
             * - {name: 2019-Datacenter, publisher: MicrosoftWindowsServer, product: WindowsServer}.
             * @return the next definition stage.
             */
            WithCreate withPurchasePlan(DiskPurchasePlan purchasePlan);
        }

        /**
         * The stage of the Disk definition allowing to specify supportedCapabilities.
         */
        interface WithSupportedCapabilities {
            /**
             * Specifies the supportedCapabilities property: List of supported capabilities for the image from which the
             * OS disk was created..
             * 
             * @param supportedCapabilities List of supported capabilities for the image from which the OS disk was
             * created.
             * @return the next definition stage.
             */
            WithCreate withSupportedCapabilities(SupportedCapabilities supportedCapabilities);
        }
        ...
        interface WithDiskSizeGB {
             ...
             * indicates a resize. Resizes are only allowed if the disk is not attached to a running VM, and can only
        ...
        interface WithBurstingEnabled {
            /**
             * Specifies the burstingEnabled property: Set to true to enable bursting beyond the provisioned performance
             * target of the disk. Bursting is disabled by default. Does not apply to Ultra disks..
             * 
             * @param burstingEnabled Set to true to enable bursting beyond the provisioned performance target of the
        ...
        /**
         * The stage of the Disk definition allowing to specify completionPercent.
         */
        interface WithCompletionPercent {
            /**
             * Specifies the completionPercent property: Percentage complete for the background copy when a resource is
             * created via the CopyStart operation..
             * 
             * @param completionPercent Percentage complete for the background copy when a resource is created via the
             * CopyStart operation.
             * @return the next definition stage.
             */
        ...
        /**
         * The stage of the Disk definition allowing to specify publicNetworkAccess.
         */
        interface WithPublicNetworkAccess {
            /**
             * Specifies the publicNetworkAccess property: Policy for controlling export on the disk..
             * 
     ...
     */
    interface Update extends UpdateStages.WithTags, UpdateStages.WithSku, UpdateStages.WithOsType,
        UpdateStages.WithDiskSizeGB, UpdateStages.WithEncryptionSettingsCollection, UpdateStages.WithDiskIopsReadWrite,
        UpdateStages.WithDiskMBpsReadWrite, UpdateStages.WithDiskIopsReadOnly, UpdateStages.WithDiskMBpsReadOnly,
        UpdateStages.WithMaxShares, UpdateStages.WithEncryption, UpdateStages.WithNetworkAccessPolicy,
        UpdateStages.WithDiskAccessId, UpdateStages.WithTier, UpdateStages.WithBurstingEnabled,
        UpdateStages.WithPurchasePlan, UpdateStages.WithSupportedCapabilities, UpdateStages.WithSupportsHibernation,
        UpdateStages.WithPublicNetworkAccess, UpdateStages.WithDataAccessAuthMode,
    ...
    interface UpdateStages {
        ...
        interface WithPurchasePlan {
            /**
             * Specifies the purchasePlan property: Purchase plan information to be added on the OS disk.
             * 
             * @param purchasePlan Purchase plan information to be added on the OS disk.
             * @return the next definition stage.
             */
            Update withPurchasePlan(DiskPurchasePlan purchasePlan);
        }
        ...
        /**
         * The stage of the Disk update allowing to specify publicNetworkAccess.
         */
        interface WithPublicNetworkAccess {
            /**
             * Specifies the publicNetworkAccess property: Policy for controlling export on the disk..
     ...
     * @throws com.azure.resourcemanager.compute.generated.models.CloudErrorAutoGeneratedException thrown if the request
