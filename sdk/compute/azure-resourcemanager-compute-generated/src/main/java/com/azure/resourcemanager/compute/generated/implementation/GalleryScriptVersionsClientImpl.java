...
public final class GalleryScriptVersionsClientImpl implements GalleryScriptVersionsClient {
     ...
     * @param resourceGroupName The name of the resource group.
     * @param galleryName The name of the Gallery in which the Script Definition resides.
     * @param galleryScriptName The name of the gallery Script Definition in which the Script Version is to be updated.
     * @param galleryScriptVersionName The name of the gallery Script Version to be updated. Needs to follow semantic
     * version name pattern: The allowed characters are digit and period. Digits must be within the range of a 32-bit
     * integer. Format: &lt;MajorVersion&gt;.&lt;MinorVersion&gt;.&lt;Patch&gt;.
     ...
     * @param resourceGroupName The name of the resource group.
     * @param galleryName The name of the Gallery in which the Script Definition resides.
     * @param galleryScriptName The name of the gallery Script Definition in which the Script Version resides.
     ...
     * @param resourceGroupName The name of the resource group.
     * @param galleryName The name of the Gallery in which the Script Definition resides.
     * @param galleryScriptName The name of the Gallery Script Definition from which the Script Versions are to be
     * listed.
     * @throws IllegalArgumentException thrown if parameters fail the validation.
     * @throws ApiErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
