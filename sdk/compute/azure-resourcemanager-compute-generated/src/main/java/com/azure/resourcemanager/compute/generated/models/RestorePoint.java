...
import com.azure.resourcemanager.compute.generated.fluent.models.RestorePointProperties;
 ...
 */
@Fluent
public final class RestorePoint extends ProxyResource {
    /*
    ...
    /**
     * Creates an instance of RestorePoint class.
     */
    public RestorePoint() {
    }
     ...
     * @return the RestorePoint object itself.
     */
    public RestorePoint withExcludeDisks(List<ApiEntityReference> excludeDisks) {
     ...
     * @return the RestorePoint object itself.
     */
    public RestorePoint withSourceMetadata(RestorePointSourceMetadata sourceMetadata) {
        if (this.innerProperties() == null) {
            this.innerProperties = new RestorePointProperties();
        }
     ...
     * @return the RestorePoint object itself.
     */
    public RestorePoint withConsistencyMode(ConsistencyModeTypes consistencyMode) {
        if (this.innerProperties() == null) {
            this.innerProperties = new RestorePointProperties();
        }
     ...
     * @return the RestorePoint object itself.
     */
    public RestorePoint withTimeCreated(OffsetDateTime timeCreated) {
        if (this.innerProperties() == null) {
            this.innerProperties = new RestorePointProperties();
        }
     ...
     * @return the RestorePoint object itself.
     */
    public RestorePoint withSourceRestorePoint(ApiEntityReference sourceRestorePoint) {
        if (this.innerProperties() == null) {
            this.innerProperties = new RestorePointProperties();
        }
