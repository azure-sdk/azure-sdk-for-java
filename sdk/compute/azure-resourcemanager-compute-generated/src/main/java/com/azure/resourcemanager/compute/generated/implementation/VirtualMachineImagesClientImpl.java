...
public final class VirtualMachineImagesClientImpl implements VirtualMachineImagesClient {
    ...
    public interface VirtualMachineImagesService {
        ...
        Mono<Response<List<VirtualMachineImageResourceInner>>> list(@HostParam("$host") String endpoint,
            ...
            @QueryParam("includeScheduledForDeprecation") Boolean includeScheduledForDeprecation,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @HeaderParam("Accept") String accept, Context context);
     ...
     * @param includeScheduledForDeprecation The includeScheduledForDeprecation parameter.
     * @throws IllegalArgumentException thrown if parameters fail the validation.
     * @throws ApiErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
    ...
    private Mono<Response<List<VirtualMachineImageResourceInner>>> listWithResponseAsync(String location,
        ...
        Boolean includeScheduledForDeprecation) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return FluxUtil
            .withContext(context -> service.list(this.client.getEndpoint(), location, publisherName, offer, skus,
                expand, top, orderby, includeScheduledForDeprecation, apiVersion, this.client.getSubscriptionId(),
                accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<List<VirtualMachineImageResourceInner>>> listWithResponseAsync(String location,
        String publisherName, String offer, String skus, String expand, Integer top, String orderby,
        Boolean includeScheduledForDeprecation, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service.list(this.client.getEndpoint(), location, publisherName, offer, skus, expand, top, orderby,
            includeScheduledForDeprecation, apiVersion, this.client.getSubscriptionId(), accept, context);
    }
    ...
    private Mono<List<VirtualMachineImageResourceInner>> listAsync(String location, String publisherName, String offer,
        ...
        final Boolean includeScheduledForDeprecation = null;
        return listWithResponseAsync(location, publisherName, offer, skus, expand, top, orderby,
            includeScheduledForDeprecation).flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
    ...
    public Response<List<VirtualMachineImageResourceInner>> listWithResponse(String location, String publisherName,
        String offer, String skus, String expand, Integer top, String orderby, Boolean includeScheduledForDeprecation,
        Context context) {
        return listWithResponseAsync(location, publisherName, offer, skus, expand, top, orderby,
            includeScheduledForDeprecation, context).block();
    }
    ...
    public List<VirtualMachineImageResourceInner> list(String location, String publisherName, String offer,
        ...
        final String orderby = null;
        final Boolean includeScheduledForDeprecation = null;
        return listWithResponse(location, publisherName, offer, skus, expand, top, orderby,
            includeScheduledForDeprecation, Context.NONE).getValue();
    }
