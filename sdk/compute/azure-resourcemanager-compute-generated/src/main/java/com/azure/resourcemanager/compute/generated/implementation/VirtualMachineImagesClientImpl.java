...
public final class VirtualMachineImagesClientImpl implements VirtualMachineImagesClient {
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a list of virtual machine image publishers for the specified Azure location along with
    ...
    private Mono<PagedResponse<VirtualMachineImageResourceInner>> listPublishersSinglePageAsync(String location,
        ...
        context = this.client.mergeContext(context);
        return service
            .listPublishers(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(), location, accept,
                context)
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a list of virtual machine image publishers for the specified Azure location as paginated response with
     * {@link PagedFlux}.
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<VirtualMachineImageResourceInner> listPublishersAsync(String location) {
        return new PagedFlux<>(() -> listPublishersSinglePageAsync(location),
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<VirtualMachineImageResourceInner> listPublishersAsync(String location, Context context) {
        return new PagedFlux<>(() -> listPublishersSinglePageAsync(location, context),
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<VirtualMachineImageResourceInner> listPublishers(String location) {
        return new PagedIterable<>(listPublishersAsync(location));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<VirtualMachineImageResourceInner> listPublishers(String location, Context context) {
        return new PagedIterable<>(listPublishersAsync(location, context));
    }
    ...
    private Mono<PagedResponse<VirtualMachineImageResourceInner>> listOffersSinglePageAsync(String location,
        ...
        context = this.client.mergeContext(context);
        return service
            .listOffers(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(), location, publisherName,
                accept, context)
            .map(res -> new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(),
                res.getValue().value(), res.getValue().nextLink(), null));
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a list of virtual machine image offers for the specified location and publisher as paginated response
     * with {@link PagedFlux}.
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<VirtualMachineImageResourceInner> listOffersAsync(String location, String publisherName) {
        return new PagedFlux<>(() -> listOffersSinglePageAsync(location, publisherName),
    ...
    private PagedFlux<VirtualMachineImageResourceInner> listOffersAsync(String location, String publisherName,
        Context context) {
        return new PagedFlux<>(() -> listOffersSinglePageAsync(location, publisherName, context),
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<VirtualMachineImageResourceInner> listOffers(String location, String publisherName) {
        return new PagedIterable<>(listOffersAsync(location, publisherName));
    }
    ...
    public PagedIterable<VirtualMachineImageResourceInner> listOffers(String location, String publisherName,
        Context context) {
        return new PagedIterable<>(listOffersAsync(location, publisherName, context));
    }
    ...
    private Mono<PagedResponse<VirtualMachineImageResourceInner>> listSkusSinglePageAsync(String location,
        ...
        context = this.client.mergeContext(context);
        return service
            .listSkus(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(), location, publisherName,
                offer, accept, context)
            .map(res -> new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(),
                res.getValue().value(), res.getValue().nextLink(), null));
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a list of virtual machine image SKUs for the specified location, publisher, and offer as paginated
     * response with {@link PagedFlux}.
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<VirtualMachineImageResourceInner> listSkusAsync(String location, String publisherName,
        String offer) {
        return new PagedFlux<>(() -> listSkusSinglePageAsync(location, publisherName, offer),
    ...
    private PagedFlux<VirtualMachineImageResourceInner> listSkusAsync(String location, String publisherName,
        ...
        return new PagedFlux<>(() -> listSkusSinglePageAsync(location, publisherName, offer, context),
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<VirtualMachineImageResourceInner> listSkus(String location, String publisherName,
        String offer) {
        return new PagedIterable<>(listSkusAsync(location, publisherName, offer));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<VirtualMachineImageResourceInner> listSkus(String location, String publisherName, String offer,
        Context context) {
        return new PagedIterable<>(listSkusAsync(location, publisherName, offer, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<VirtualMachineImageResourceInner>> listSinglePageAsync(String location,
    ...
    private Mono<PagedResponse<VirtualMachineImageResourceInner>> listSinglePageAsync(String location,
        ...
        context = this.client.mergeContext(context);
        return service
            .list(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(), location, publisherName,
                offer, skus, expand, top, orderby, accept, context)
            .map(res -> new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(),
                res.getValue().value(), res.getValue().nextLink(), null));
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a list of all virtual machine image versions for the specified location, publisher, offer, and SKU as
     * paginated response with {@link PagedFlux}.
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<VirtualMachineImageResourceInner> listAsync(String location, String publisherName, String offer,
        String skus, String expand, Integer top, String orderby) {
        return new PagedFlux<>(() -> listSinglePageAsync(location, publisherName, offer, skus, expand, top, orderby),
    ...
    private PagedFlux<VirtualMachineImageResourceInner> listAsync(String location, String publisherName, String offer,
        ...
        return new PagedFlux<>(
            () -> listSinglePageAsync(location, publisherName, offer, skus, expand, top, orderby, context),
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<VirtualMachineImageResourceInner> list(String location, String publisherName, String offer,
        String skus) {
        final String expand = null;
        final Integer top = null;
        final String orderby = null;
        return new PagedIterable<>(listAsync(location, publisherName, offer, skus, expand, top, orderby));
    }
    ...
    public PagedIterable<VirtualMachineImageResourceInner> list(String location, String publisherName, String offer,
        String skus, String expand, Integer top, String orderby, Context context) {
        return new PagedIterable<>(listAsync(location, publisherName, offer, skus, expand, top, orderby, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<VirtualMachineImageInner> getAsync(String location, String publisherName, String offer, String skus,
        String version) {
