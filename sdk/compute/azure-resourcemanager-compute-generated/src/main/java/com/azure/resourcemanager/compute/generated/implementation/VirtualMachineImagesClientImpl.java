...
import com.azure.resourcemanager.compute.generated.models.VirtualMachineImagesWithPropertiesListResult;
...
public final class VirtualMachineImagesClientImpl implements VirtualMachineImagesClient {
    ...
    public interface VirtualMachineImagesService {
        ...
        @Headers({ "Content-Type: application/json" })
        @Get("/subscriptions/{subscriptionId}/providers/Microsoft.Compute/locations/{location}/publishers/{publisherName}/offers/{offer}/skus/{skus}/versions")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
