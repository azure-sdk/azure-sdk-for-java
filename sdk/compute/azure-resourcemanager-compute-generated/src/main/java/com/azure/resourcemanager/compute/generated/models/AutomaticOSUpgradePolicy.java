...
public final class AutomaticOSUpgradePolicy {
     ...
     * on a per-VM basis that an OS upgrade from rolling upgrades is incoming, via IMDS. The upgrade then defers until
     * the upgrade is invoked via an InvokeUpgrade call.
     */
     ...
     * via IMDS. The upgrade then defers until the upgrade is invoked via an InvokeUpgrade call.
     *
