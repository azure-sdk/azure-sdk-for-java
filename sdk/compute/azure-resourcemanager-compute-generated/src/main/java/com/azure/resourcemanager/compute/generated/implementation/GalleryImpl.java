...
public final class GalleryImpl implements Gallery, Gallery.Definition, Gallery.Update {
    ...
    public GalleryImpl withSoftDeletePolicy(SoftDeletePolicy softDeletePolicy) {
        if (isInCreateMode()) {
            this.innerModel().withSoftDeletePolicy(softDeletePolicy);
            return this;
        } else {
            this.updateGallery.withSoftDeletePolicy(softDeletePolicy);
            return this;
        }
    }
