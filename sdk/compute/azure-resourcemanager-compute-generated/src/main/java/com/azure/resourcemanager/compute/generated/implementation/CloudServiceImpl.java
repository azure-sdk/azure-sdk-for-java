...
public final class CloudServiceImpl implements CloudService, CloudService.Definition, CloudService.Update {
    ...
    public String packageUrl() {
        return this.innerModel().packageUrl();
    }
    ...
    public String configurationUrl() {
        return this.innerModel().configurationUrl();
    }

    public Boolean startCloudService() {
        return this.innerModel().startCloudService();
    }

    public Boolean allowModelOverride() {
        return this.innerModel().allowModelOverride();
    }
    ...
    public CloudServiceRoleProfile roleProfile() {
        return this.innerModel().roleProfile();
    }
    ...
    public CloudServiceExtensionProfile extensionProfile() {
        return this.innerModel().extensionProfile();
    }
    ...
    CloudServiceImpl(
        CloudServiceInner innerObject, com.azure.resourcemanager.compute.generated.ComputeManager serviceManager) {
    ...
    public CloudServiceImpl withPackageUrl(String packageUrl) {
        this.innerModel().withPackageUrl(packageUrl);
        return this;
    }

    public CloudServiceImpl withConfiguration(String configuration) {
        this.innerModel().withConfiguration(configuration);
        return this;
    }

    public CloudServiceImpl withConfigurationUrl(String configurationUrl) {
        this.innerModel().withConfigurationUrl(configurationUrl);
        return this;
    }

    public CloudServiceImpl withStartCloudService(Boolean startCloudService) {
        this.innerModel().withStartCloudService(startCloudService);
        return this;
    }

    public CloudServiceImpl withAllowModelOverride(Boolean allowModelOverride) {
        this.innerModel().withAllowModelOverride(allowModelOverride);
        return this;
    }

    public CloudServiceImpl withUpgradeMode(CloudServiceUpgradeMode upgradeMode) {
        this.innerModel().withUpgradeMode(upgradeMode);
        return this;
    }

    public CloudServiceImpl withRoleProfile(CloudServiceRoleProfile roleProfile) {
        this.innerModel().withRoleProfile(roleProfile);
        return this;
    }

    public CloudServiceImpl withOsProfile(CloudServiceOsProfile osProfile) {
        this.innerModel().withOsProfile(osProfile);
        return this;
    }

    public CloudServiceImpl withNetworkProfile(CloudServiceNetworkProfile networkProfile) {
        this.innerModel().withNetworkProfile(networkProfile);
        return this;
    }

    public CloudServiceImpl withExtensionProfile(CloudServiceExtensionProfile extensionProfile) {
        this.innerModel().withExtensionProfile(extensionProfile);
        return this;
    }
