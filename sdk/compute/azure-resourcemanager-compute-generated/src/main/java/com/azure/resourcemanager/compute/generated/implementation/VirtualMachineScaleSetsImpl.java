...
public final class VirtualMachineScaleSetsImpl implements VirtualMachineScaleSets {
    ...
    public void invokeUpgrade(String resourceGroupName, String vmScaleSetName) {
        this.serviceClient().invokeUpgrade(resourceGroupName, vmScaleSetName);
    }
    ...
    public void invokeUpgrade(
        ...
        VirtualMachineScaleSetVMInstanceIDs vmInstanceIDs,
        Context context) {
        this.serviceClient().invokeUpgrade(resourceGroupName, vmScaleSetName, vmInstanceIDs, context);
    }
