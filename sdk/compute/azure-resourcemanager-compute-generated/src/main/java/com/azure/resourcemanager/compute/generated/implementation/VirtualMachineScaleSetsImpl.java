...
public final class VirtualMachineScaleSetsImpl implements VirtualMachineScaleSets {
    ...
    public PagedIterable<VirtualMachineScaleSet> listByLocation(int location) {
    ...
    public PagedIterable<VirtualMachineScaleSet> listByLocation(int location, Context context) {
