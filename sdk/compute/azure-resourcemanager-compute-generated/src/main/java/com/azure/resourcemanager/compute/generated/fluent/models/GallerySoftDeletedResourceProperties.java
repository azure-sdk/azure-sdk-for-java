...
public final class GallerySoftDeletedResourceProperties
     ...
     */
    private String softDeletedArtifactType;
     ...
     * @return the GallerySoftDeletedResourceProperties object itself.
     */
    public GallerySoftDeletedResourceProperties withSoftDeletedArtifactType(String softDeletedArtifactType) {
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeStringField("softDeletedArtifactType", this.softDeletedArtifactType);
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("resourceArmId".equals(fieldName)) {
                    ...
                    deserializedGallerySoftDeletedResourceProperties.softDeletedArtifactType = reader.getString();
