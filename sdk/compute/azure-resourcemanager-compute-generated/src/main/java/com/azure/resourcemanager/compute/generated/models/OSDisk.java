...
public final class OSDisk {
     ...
     * you are using an image to create the virtual machine. If you are using a platform image, you should also use the
     ...
     * If you are using a platform image, you should also use the imageReference element described above. If you are
     * using a marketplace image, you should also use the plan element previously described.
     * 
