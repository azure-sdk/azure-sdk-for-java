    ...
    public Response<AccessUri> grantAccessOnVmssvmInstanceWithResponse(
        ...
        if (inner != null) {
            return new SimpleResponse<>(
                ...
                inner.getStatusCode(),
                inner.getHeaders(),
                new AccessUriImpl(inner.getValue(), this.manager()));
        } else {
            return null;
        }
    }

    public AccessUri grantAccessOnVmssvmInstance(
        String resourceGroupName, String vmssName, String diskName, GrantAccessData grantAccessData) {
        AccessUriInner inner =
            this.serviceClient().grantAccessOnVmssvmInstance(resourceGroupName, vmssName, diskName, grantAccessData);
        if (inner != null) {
            return new AccessUriImpl(inner, this.manager());
        } else {
            return null;
