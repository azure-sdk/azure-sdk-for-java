 ...
 * imageReference element described above. If you are using a marketplace image, you should also use the plan element
 * previously described. &lt;br&gt;**Empty:** This value is used when creating an empty data disk. &lt;br&gt;**Copy:**
 * This value is used to create a data disk from a snapshot.&lt;br&gt;**Restore:** This value is used to create a data
 * disk from a disk restore point.
 */
