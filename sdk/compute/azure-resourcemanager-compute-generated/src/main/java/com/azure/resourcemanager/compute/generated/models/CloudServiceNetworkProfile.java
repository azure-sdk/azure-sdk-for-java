...
public final class CloudServiceNetworkProfile {
    ...
    private SubResourceAutoGenerated swappableCloudService;
     ...
     */
    public SubResourceAutoGenerated swappableCloudService() {
     ...
     * @return the CloudServiceNetworkProfile object itself.
     */
    public CloudServiceNetworkProfile withSwappableCloudService(SubResourceAutoGenerated swappableCloudService) {
    ...
    public void validate() {
        ...
        if (swappableCloudService() != null) {
            swappableCloudService().validate();
        }
    }
}
