...
public final class GalleryScriptVersionInner extends Resource {
    ...
    /**
     * Get the innerProperties property: Describes the properties of a gallery script version.
     * 
     ...
     */
    public GalleryScriptVersionInner withPublishingProfile(GalleryScriptVersionPublishingProfile publishingProfile) {
     ...
     * @return the GalleryScriptVersionInner object itself.
     */
    public GalleryScriptVersionInner withSafetyProfile(GalleryScriptVersionSafetyProfile safetyProfile) {
        if (this.innerProperties() == null) {
            this.innerProperties = new GalleryScriptVersionProperties();
        }
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("id".equals(fieldName)) {
                    ...
                    deserializedGalleryScriptVersionInner.innerProperties
