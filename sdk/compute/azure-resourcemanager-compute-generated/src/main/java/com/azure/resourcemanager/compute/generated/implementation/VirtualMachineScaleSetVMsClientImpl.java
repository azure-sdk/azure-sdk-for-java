...
public final class VirtualMachineScaleSetVMsClientImpl implements VirtualMachineScaleSetVMsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<Void>, Void> beginAttachDetachDataDisksAsync(
        String resourceGroupName, String vmScaleSetName, String instanceId, AttachDetachDataDisksRequest parameters) {
        Mono<Response<Flux<ByteBuffer>>> mono =
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<Void>, Void> beginAttachDetachDataDisks(
        String resourceGroupName, String vmScaleSetName, String instanceId, AttachDetachDataDisksRequest parameters) {
        return this
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> attachDetachDataDisksAsync(
        String resourceGroupName, String vmScaleSetName, String instanceId, AttachDetachDataDisksRequest parameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public void attachDetachDataDisks(
        String resourceGroupName, String vmScaleSetName, String instanceId, AttachDetachDataDisksRequest parameters) {
        attachDetachDataDisksAsync(resourceGroupName, vmScaleSetName, instanceId, parameters).block();
    }
    ...
    public void attachDetachDataDisks(
        ...
        AttachDetachDataDisksRequest parameters,
        Context context) {
        attachDetachDataDisksAsync(resourceGroupName, vmScaleSetName, instanceId, parameters, context).block();
    }
