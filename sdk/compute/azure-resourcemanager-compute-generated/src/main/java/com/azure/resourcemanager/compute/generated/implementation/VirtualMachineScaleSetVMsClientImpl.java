...
public final class VirtualMachineScaleSetVMsClientImpl implements VirtualMachineScaleSetVMsClient {
    ...
    public interface VirtualMachineScaleSetVMsService {
        ...
        @ExpectedResponses({200, 202})
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Mono<Response<Flux<ByteBuffer>>> attachDetachDataDisks(
            @HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("vmScaleSetName") String vmScaleSetName,
            @PathParam("instanceId") String instanceId,
    ...
    public SyncPoller<PollResult<Void>, Void> beginReimage(
        ...
        final VirtualMachineScaleSetVMReimageParameters vmScaleSetVMReimageInput = null;
        return this
            .beginReimageAsync(resourceGroupName, vmScaleSetName, instanceId, vmScaleSetVMReimageInput)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginReimage(
        ...
        Context context) {
        return this
            .beginReimageAsync(resourceGroupName, vmScaleSetName, instanceId, vmScaleSetVMReimageInput, context)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<VirtualMachineScaleSetVMInner>, VirtualMachineScaleSetVMInner> beginUpdate(
        ...
        Context context) {
        return this
            .beginUpdateAsync(resourceGroupName, vmScaleSetName, instanceId, parameters, context)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(
        String resourceGroupName, String vmScaleSetName, String instanceId, Boolean forceDeletion, Context context) {
        return this
            .beginDeleteAsync(resourceGroupName, vmScaleSetName, instanceId, forceDeletion, context)
            .getSyncPoller();
    }
     ...
     * @throws ApiErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a virtual machine from a VM scale set along with {@link Response} on successful completion of {@link
     *     Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<VirtualMachineScaleSetVMInner> getAsync(
        String resourceGroupName, String vmScaleSetName, String instanceId) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<VirtualMachineScaleSetVMInstanceViewInner> getInstanceViewAsync(
        String resourceGroupName, String vmScaleSetName, String instanceId) {
    ...
    public SyncPoller<PollResult<Void>, Void> beginPowerOff(
        String resourceGroupName, String vmScaleSetName, String instanceId, Boolean skipShutdown, Context context) {
        return this
            .beginPowerOffAsync(resourceGroupName, vmScaleSetName, instanceId, skipShutdown, context)
            .getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> startAsync(String resourceGroupName, String vmScaleSetName, String instanceId) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<RetrieveBootDiagnosticsDataResultInner> retrieveBootDiagnosticsDataAsync(
        String resourceGroupName, String vmScaleSetName, String instanceId) {
    ...
    public RetrieveBootDiagnosticsDataResultInner retrieveBootDiagnosticsData(
        String resourceGroupName, String vmScaleSetName, String instanceId) {
        final Integer sasUriExpirationTimeInMinutes = null;
        return retrieveBootDiagnosticsDataWithResponse(
                resourceGroupName, vmScaleSetName, instanceId, sasUriExpirationTimeInMinutes, Context.NONE)
            .getValue();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginPerformMaintenance(
        String resourceGroupName, String vmScaleSetName, String instanceId, Context context) {
        return this
            .beginPerformMaintenanceAsync(resourceGroupName, vmScaleSetName, instanceId, context)
            .getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> simulateEvictionAsync(String resourceGroupName, String vmScaleSetName, String instanceId) {
     ...
     * @throws ApiErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return response for attach and detach data disks request along with {@link Response} on successful completion of
     *     {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> attachDetachDataDisksWithResponseAsync(
     ...
     * @throws ApiErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the {@link PollerFlux} for polling of response for attach and detach data disks request.
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<AttachDetachDataDisksResponseInner>, AttachDetachDataDisksResponseInner>
        ...
        return this
            .client
            .<AttachDetachDataDisksResponseInner, AttachDetachDataDisksResponseInner>getLroResult(
                mono,
                this.client.getHttpPipeline(),
                AttachDetachDataDisksResponseInner.class,
                AttachDetachDataDisksResponseInner.class,
                this.client.getContext());
    }
    ...
    private PollerFlux<PollResult<AttachDetachDataDisksResponseInner>, AttachDetachDataDisksResponseInner>
        ...
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono =
            attachDetachDataDisksWithResponseAsync(resourceGroupName, vmScaleSetName, instanceId, parameters, context);
        return this
            .client
            .<AttachDetachDataDisksResponseInner, AttachDetachDataDisksResponseInner>getLroResult(
                mono,
     ...
     * @throws ApiErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the {@link SyncPoller} for polling of response for attach and detach data disks request.
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<AttachDetachDataDisksResponseInner>, AttachDetachDataDisksResponseInner>
        beginAttachDetachDataDisks(
            ...
            AttachDetachDataDisksRequest parameters) {
        return this
            .beginAttachDetachDataDisksAsync(resourceGroupName, vmScaleSetName, instanceId, parameters)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<AttachDetachDataDisksResponseInner>, AttachDetachDataDisksResponseInner>
        beginAttachDetachDataDisks(
            ...
            Context context) {
        return this
            .beginAttachDetachDataDisksAsync(resourceGroupName, vmScaleSetName, instanceId, parameters, context)
            .getSyncPoller();
    }
     ...
     * @throws ApiErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return response for attach and detach data disks request on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<AttachDetachDataDisksResponseInner> attachDetachDataDisksAsync(
        String resourceGroupName, String vmScaleSetName, String instanceId, AttachDetachDataDisksRequest parameters) {
        return beginAttachDetachDataDisksAsync(resourceGroupName, vmScaleSetName, instanceId, parameters)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     * @throws ApiErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return response for attach and detach data disks request.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public AttachDetachDataDisksResponseInner attachDetachDataDisks(
        String resourceGroupName, String vmScaleSetName, String instanceId, AttachDetachDataDisksRequest parameters) {
    ...
    public SyncPoller<PollResult<RunCommandResultInner>, RunCommandResultInner> beginRunCommand(
        ...
        Context context) {
        return this
            .beginRunCommandAsync(resourceGroupName, vmScaleSetName, instanceId, parameters, context)
            .getSyncPoller();
    }
