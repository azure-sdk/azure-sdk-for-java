...
public final class VirtualMachineScaleSetVMsClientImpl implements VirtualMachineScaleSetVMsClient {
    ...
    public interface VirtualMachineScaleSetVMsService {
        ...
        @Headers({"Content-Type: application/json"})
        @Post(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachineScaleSets/{vmScaleSetName}/virtualMachines/{instanceId}/invokeupgrade")
        @ExpectedResponses({200, 202})
        @UnexpectedResponseExceptionType(ApiErrorException.class)
    ...
    private PollerFlux<PollResult<Void>, Void> beginInvokeUpgradeAsync(
        String resourceGroupName, String vmScaleSetName, String instanceId) {
        Mono<Response<Flux<ByteBuffer>>> mono =
            invokeUpgradeWithResponseAsync(resourceGroupName, vmScaleSetName, instanceId);
        return this
            .client
            .<Void, Void>getLroResult(
                mono, this.client.getHttpPipeline(), Void.class, Void.class, this.client.getContext());
    ...
    private PollerFlux<PollResult<Void>, Void> beginInvokeUpgradeAsync(
        ...
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono =
            invokeUpgradeWithResponseAsync(resourceGroupName, vmScaleSetName, instanceId, context);
        return this
            .client
            .<Void, Void>getLroResult(mono, this.client.getHttpPipeline(), Void.class, Void.class, context);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginInvokeUpgrade(
        String resourceGroupName, String vmScaleSetName, String instanceId) {
        return this.beginInvokeUpgradeAsync(resourceGroupName, vmScaleSetName, instanceId).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginInvokeUpgrade(
        String resourceGroupName, String vmScaleSetName, String instanceId, Context context) {
        return this.beginInvokeUpgradeAsync(resourceGroupName, vmScaleSetName, instanceId, context).getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> invokeUpgradeAsync(String resourceGroupName, String vmScaleSetName, String instanceId) {
        return beginInvokeUpgradeAsync(resourceGroupName, vmScaleSetName, instanceId)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<Void> invokeUpgradeAsync(
        String resourceGroupName, String vmScaleSetName, String instanceId, Context context) {
        return beginInvokeUpgradeAsync(resourceGroupName, vmScaleSetName, instanceId, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public void invokeUpgrade(String resourceGroupName, String vmScaleSetName, String instanceId) {
        invokeUpgradeAsync(resourceGroupName, vmScaleSetName, instanceId).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public void invokeUpgrade(String resourceGroupName, String vmScaleSetName, String instanceId, Context context) {
        invokeUpgradeAsync(resourceGroupName, vmScaleSetName, instanceId, context).block();
    }
