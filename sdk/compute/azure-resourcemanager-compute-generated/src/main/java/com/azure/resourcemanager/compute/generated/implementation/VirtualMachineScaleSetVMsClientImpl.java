...
public final class VirtualMachineScaleSetVMsClientImpl implements VirtualMachineScaleSetVMsClient {
    ...
    public SyncPoller<PollResult<Void>, Void> beginApproveRollingUpgrade(
        String resourceGroupName, String vmScaleSetName, String instanceId, Context context) {
        return this
            .beginApproveRollingUpgradeAsync(resourceGroupName, vmScaleSetName, instanceId, context)
            .getSyncPoller();
    }
    ...
    private Mono<Void> approveRollingUpgradeAsync(String resourceGroupName, String vmScaleSetName, String instanceId) {
        return beginApproveRollingUpgradeAsync(resourceGroupName, vmScaleSetName, instanceId)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<Void> approveRollingUpgradeAsync(
        String resourceGroupName, String vmScaleSetName, String instanceId, Context context) {
        return beginApproveRollingUpgradeAsync(resourceGroupName, vmScaleSetName, instanceId, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
