...
import com.azure.resourcemanager.compute.generated.models.ExpandTypesForGetVMs;
...
public final class VirtualMachinesClientImpl implements VirtualMachinesClient {
    ...
    public interface VirtualMachinesService {
        ...
        Mono<Response<VirtualMachineListResult>> listByResourceGroup(
            ...
            @QueryParam("$expand") ExpandTypesForGetVMs expand,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @HeaderParam("Accept") String accept,
            Context context);
    ...
    private Mono<PagedResponse<VirtualMachineInner>> listByResourceGroupSinglePageAsync(
        String resourceGroupName, String filter, ExpandTypesForGetVMs expand) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<VirtualMachineInner>> listByResourceGroupSinglePageAsync(
        String resourceGroupName, String filter, ExpandTypesForGetVMs expand, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    private PagedFlux<VirtualMachineInner> listByResourceGroupAsync(String resourceGroupName) {
        ...
        final ExpandTypesForGetVMs expand = null;
        return new PagedFlux<>(
            () -> listByResourceGroupSinglePageAsync(resourceGroupName, filter, expand),
            nextLink -> listNextSinglePageAsync(nextLink));
    }
    ...
    private Mono<PagedResponse<VirtualMachineInner>> listSinglePageAsync(
        String statusOnly, String filter, ExpandTypesForGetVMs expand) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<VirtualMachineInner>> listSinglePageAsync(
        String statusOnly, String filter, ExpandTypesForGetVMs expand, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<VirtualMachineInner> listAsync(String statusOnly, String filter, ExpandTypesForGetVMs expand) {
        return new PagedFlux<>(
