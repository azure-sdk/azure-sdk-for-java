...
public interface CapacityReservation {
    ...
    /**
     * Gets the maximumFaultDomainCountSupported property: This is the readonly property that is populated and set in
     * the response to specify the Maximum Fault Domain Count that capacity reservation support using the VM
     * Size.&lt;br&gt;&lt;br&gt;Minimum api-version: 2022-08-01.
     *
     * @return the maximumFaultDomainCountSupported value.
     */
    Integer maximumFaultDomainCountSupported();
