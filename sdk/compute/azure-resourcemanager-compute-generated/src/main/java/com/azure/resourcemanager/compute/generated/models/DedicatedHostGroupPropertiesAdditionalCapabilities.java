...
public final class DedicatedHostGroupPropertiesAdditionalCapabilities {
     ...
     * resoure needs to be set true as well. The value is defaulted to 'false'
     ...
     * UltraSSDEnabled flag for the resoure needs to be set true as well. The value is defaulted to 'false' when not
