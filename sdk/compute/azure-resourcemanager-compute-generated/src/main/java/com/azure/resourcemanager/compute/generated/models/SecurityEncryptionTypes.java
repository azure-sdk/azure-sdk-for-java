 ...
 * NonPersistedVMGuestState for not persisting firmware state in the VMGuestState blob. **Note:** It can be set for only
 * Confidential VMs.
 */
public final class SecurityEncryptionTypes extends ExpandableStringEnum<SecurityEncryptionTypes> {
    ...
    /** Static value NonPersistedVMGuestState for SecurityEncryptionTypes. */
    public static final SecurityEncryptionTypes NON_PERSISTED_VMGUEST_STATE = fromString("NonPersistedVMGuestState");
