...
import com.azure.resourcemanager.compute.generated.models.SharedGalleryImageVersionList;
...
public final class SharedGalleryImageVersionsClientImpl implements SharedGalleryImageVersionsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<SharedGalleryImageVersionInner> getAsync(String location, String galleryUniqueName,
