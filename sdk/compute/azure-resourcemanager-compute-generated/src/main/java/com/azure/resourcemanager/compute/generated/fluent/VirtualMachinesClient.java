...
public interface VirtualMachinesClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<VirtualMachineInner>, VirtualMachineInner>
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<VirtualMachineInner>, VirtualMachineInner> beginAttachDetachDataDisks(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    VirtualMachineInner attachDetachDataDisks(String resourceGroupName, String vmName,
