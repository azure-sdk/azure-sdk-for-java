...
public interface VirtualMachinesClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String vmName);
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<Void>, Void> beginPowerOff(String resourceGroupName, String vmName);
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<AttachDetachDataDisksResponseInner>, AttachDetachDataDisksResponseInner>
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    AttachDetachDataDisksResponseInner attachDetachDataDisks(
