...
public final class GalleryImageVersionsImpl implements GalleryImageVersions {
    ...
    public Response<LatestVersion> getLatestWithResponse(
        String resourceGroupName, String galleryName, String galleryImageName, Context context) {
        Response<LatestVersionInner> inner =
            this.serviceClient().getLatestWithResponse(resourceGroupName, galleryName, galleryImageName, context);
        if (inner != null) {
            return new SimpleResponse<>(
                inner.getRequest(),
                inner.getStatusCode(),
                inner.getHeaders(),
                new LatestVersionImpl(inner.getValue(), this.manager()));
        } else {
            return null;
        }
    }

    public LatestVersion getLatest(String resourceGroupName, String galleryName, String galleryImageName) {
        LatestVersionInner inner = this.serviceClient().getLatest(resourceGroupName, galleryName, galleryImageName);
        if (inner != null) {
            return new LatestVersionImpl(inner, this.manager());
        } else {
            return null;
        }
    }
