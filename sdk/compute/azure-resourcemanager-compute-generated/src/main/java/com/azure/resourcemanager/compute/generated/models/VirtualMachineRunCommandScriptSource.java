...
/**
 * Describes the script sources for run command. Use only one these script sources: script, scriptUri, commandId,
...
public final class VirtualMachineRunCommandScriptSource
    ...
    /*
     * Specifies a commandId of predefined built-in script. commandIds available for Linux listed at
     ...
     */
    private VirtualMachineRunCommandScriptSourceScriptShell scriptShell;
    ...
    /**
     * Get the commandId property: Specifies a commandId of predefined built-in script. commandIds available for Linux
     * listed at https://aka.ms/RunCommandManagedLinux#available-commands, Windows at
     * https://aka.ms/RunCommandManagedWindows#available-commands.
     * 
    ...
    /**
     * Set the commandId property: Specifies a commandId of predefined built-in script. commandIds available for Linux
     * listed at https://aka.ms/RunCommandManagedLinux#available-commands, Windows at
     * https://aka.ms/RunCommandManagedWindows#available-commands.
     * 
     ...
     */
    public VirtualMachineRunCommandScriptSourceScriptShell scriptShell() {
     ...
     */
    public VirtualMachineRunCommandScriptSource
        withScriptShell(VirtualMachineRunCommandScriptSourceScriptShell scriptShell) {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("script".equals(fieldName)) {
                    ...
                    deserializedVirtualMachineRunCommandScriptSource.scriptShell
                        = VirtualMachineRunCommandScriptSourceScriptShell.fromString(reader.getString());
