...
public final class VirtualMachineScaleSetExtensionInner extends SubResourceReadOnly {
    ...
    /**
     * Get the vmType property: Resource type.
     * 
    ...
    /**
     * Get the vmName property: Resource name.
     * 
    ...
    /**
     * Set the vmName property: Resource name.
     * 
     * @param vmName the vmName value to set.
     * @return the VirtualMachineScaleSetExtensionInner object itself.
     */
    public VirtualMachineScaleSetExtensionInner withVmName(String vmName) {
        this.vmName = vmName;
        return this;
    }
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeStringField("name", this.vmName);
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("id".equals(fieldName)) {
                    ...
                    deserializedVirtualMachineScaleSetExtensionInner.vmType = reader.getString();
                } else if ("name".equals(fieldName)) {
                    deserializedVirtualMachineScaleSetExtensionInner.vmName = reader.getString();
                } else {
                    reader.skipChildren();
                }
            }
