...
@Fluent
public final class VMGalleryApplicationInner {
    /*
    ...
    /*
     * Contains instanceView of the VMApplication if $expand=instanceView is specified
     */
     ...
     * @return the VMGalleryApplicationInner object itself.
     */
    public VMGalleryApplicationInner withTags(String tags) {
        this.tags = tags;
        return this;
    }
     ...
     * @return the VMGalleryApplicationInner object itself.
     */
    public VMGalleryApplicationInner withOrder(Integer order) {
        this.order = order;
        return this;
    }
     ...
     * @return the VMGalleryApplicationInner object itself.
     */
    public VMGalleryApplicationInner withPackageReferenceId(String packageReferenceId) {
     ...
     * @return the VMGalleryApplicationInner object itself.
     */
    public VMGalleryApplicationInner withConfigurationReference(String configurationReference) {
     ...
     * @return the VMGalleryApplicationInner object itself.
     */
    public VMGalleryApplicationInner withTreatFailureAsDeploymentFailure(Boolean treatFailureAsDeploymentFailure) {
     ...
     * @return the VMGalleryApplicationInner object itself.
     */
    public VMGalleryApplicationInner withEnableAutomaticUpgrade(Boolean enableAutomaticUpgrade) {
        this.enableAutomaticUpgrade = enableAutomaticUpgrade;
        return this;
    }

    /**
     * Get the instanceView property: Contains instanceView of the VMApplication if $expand=instanceView is specified.
     *
            ...
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException(
                        "Missing required property packageReferenceId in model VMGalleryApplicationInner"));
        }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(VMGalleryApplicationInner.class);
}
