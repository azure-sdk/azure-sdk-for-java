...
public final class VirtualMachineScaleSetVMExtensionInner extends SubResourceReadOnly {
     ...
     * @return the VirtualMachineScaleSetVMExtensionInner object itself.
     */
    public VirtualMachineScaleSetVMExtensionInner withType(String type) {
        if (this.innerProperties() == null) {
            this.innerProperties = new VirtualMachineExtensionProperties();
        }
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("id".equals(fieldName)) {
                    ...
                    deserializedVirtualMachineScaleSetVMExtensionInner.vmType = reader.getString();
                } else if ("name".equals(fieldName)) {
                    deserializedVirtualMachineScaleSetVMExtensionInner.vmName = reader.getString();
                } else {
                    reader.skipChildren();
                }
            }
