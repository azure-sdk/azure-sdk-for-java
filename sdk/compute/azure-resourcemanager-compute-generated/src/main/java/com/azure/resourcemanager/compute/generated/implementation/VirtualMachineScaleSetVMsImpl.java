...
public final class VirtualMachineScaleSetVMsImpl implements VirtualMachineScaleSetVMs {
    ...
    public void invokeUpgrade(String resourceGroupName, String vmScaleSetName, String instanceId) {
        this.serviceClient().invokeUpgrade(resourceGroupName, vmScaleSetName, instanceId);
    }

    public void invokeUpgrade(String resourceGroupName, String vmScaleSetName, String instanceId, Context context) {
        this.serviceClient().invokeUpgrade(resourceGroupName, vmScaleSetName, instanceId, context);
    }
