...
public final class VirtualMachineScaleSetVMsImpl implements VirtualMachineScaleSetVMs {
    ...
    public VirtualMachineScaleSetVMsImpl(VirtualMachineScaleSetVMsClient innerClient,
    ...
    public Response<VirtualMachineScaleSetVM> getWithResponse(String resourceGroupName, String vmScaleSetName,
    ...
    public Response<VirtualMachineScaleSetVMInstanceView> getInstanceViewWithResponse(String resourceGroupName,
    ...
    public VirtualMachineScaleSetVMInstanceView getInstanceView(String resourceGroupName, String vmScaleSetName,
        String instanceId) {
    ...
    public RetrieveBootDiagnosticsDataResult retrieveBootDiagnosticsData(String resourceGroupName,
    ...
    public VirtualMachineScaleSetVM attachDetachDataDisks(String resourceGroupName, String vmScaleSetName,
    ...
    public VirtualMachineScaleSetVM attachDetachDataDisks(String resourceGroupName, String vmScaleSetName,
        ...
        VirtualMachineScaleSetVMInner inner = this.serviceClient().attachDetachDataDisks(resourceGroupName,
