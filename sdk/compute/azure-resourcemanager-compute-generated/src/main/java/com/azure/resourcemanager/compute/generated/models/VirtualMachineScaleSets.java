...
public interface VirtualMachineScaleSets {
     ...
     */
    PagedIterable<VirtualMachineScaleSet> listByLocation(int location);
     ...
     * with {@link PagedIterable}.
     */
    PagedIterable<VirtualMachineScaleSet> listByLocation(int location, Context context);
     ...
     */
    Response<VirtualMachineScaleSet> getByResourceGroupWithResponse(String resourceGroupName, String vmScaleSetName,
        ExpandTypesForGetVMScaleSets expand, Context context);
     ...
     */
    Response<VirtualMachineScaleSetInstanceView> getInstanceViewWithResponse(String resourceGroupName,
     ...
     */
    PagedIterable<UpgradeOperationHistoricalStatusInfo> getOSUpgradeHistory(String resourceGroupName,
     ...
     */
    RecoveryWalkResponse forceRecoveryServiceFabricPlatformUpdateDomainWalk(String resourceGroupName,
     ...
     * @return describes a Virtual Machine Scale Set along with {@link Response}.
     */
    Response<VirtualMachineScaleSet> getByIdWithResponse(String id, ExpandTypesForGetVMScaleSets expand,
        Context context);
