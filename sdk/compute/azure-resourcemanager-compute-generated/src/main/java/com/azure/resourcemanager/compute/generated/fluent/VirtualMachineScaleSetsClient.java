...
public interface VirtualMachineScaleSetsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<Void>, Void> beginInvokeUpgrade(String resourceGroupName, String vmScaleSetName);
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<Void>, Void> beginInvokeUpgrade(
        String resourceGroupName,
        String vmScaleSetName,
        VirtualMachineScaleSetVMInstanceIDs vmInstanceIDs,
        Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    void invokeUpgrade(String resourceGroupName, String vmScaleSetName);
