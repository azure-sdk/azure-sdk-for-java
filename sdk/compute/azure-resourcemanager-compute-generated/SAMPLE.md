...
import com.azure.resourcemanager.compute.generated.models.FilterDefinition;
import com.azure.resourcemanager.compute.generated.models.HardwareProfile;
import com.azure.resourcemanager.compute.generated.models.ImageReference;
import com.azure.resourcemanager.compute.generated.models.LinuxConfiguration;
import com.azure.resourcemanager.compute.generated.models.LinuxPatchAssessmentMode;
...
import com.azure.resourcemanager.compute.generated.models.Plan;
import com.azure.resourcemanager.compute.generated.models.ProxyAgentSettings;
import com.azure.resourcemanager.compute.generated.models.ProxyAgentSettingsImds;
import com.azure.resourcemanager.compute.generated.models.ProxyAgentSettingsImdsAccessControlProfile;
import com.azure.resourcemanager.compute.generated.models.ProxyAgentSettingsWireserver;
import com.azure.resourcemanager.compute.generated.models.ProxyAgentSettingsWireserverAccessControlProfile;
import com.azure.resourcemanager.compute.generated.models.PublicIpAddressSku;
import com.azure.resourcemanager.compute.generated.models.PublicIpAddressSkuName;
import com.azure.resourcemanager.compute.generated.models.PublicIpAddressSkuTier;
import com.azure.resourcemanager.compute.generated.models.PublicIpAllocationMethod;
import com.azure.resourcemanager.compute.generated.models.ResourceIdentityType;
import com.azure.resourcemanager.compute.generated.models.RuleDefinition;
import com.azure.resourcemanager.compute.generated.models.ScheduledEventsProfile;
import com.azure.resourcemanager.compute.generated.models.SecurityEncryptionTypes;
import com.azure.resourcemanager.compute.generated.models.SecurityProfile;
import com.azure.resourcemanager.compute.generated.models.SecurityTypes;
...
public final class VirtualMachinesCreateOrUpdateSamples {
     ...
     * x-ms-original-file:
     * specification/compute/resource-manager/Microsoft.Compute/ComputeRP/stable/2024-03-01/examples/
     * virtualMachineExamples/VirtualMachine_Create_WithProxyAgentEnabledAndConfiguredAuthRules.json
     */
    /**
     * Sample code: Create a VM with ProxyAgent enabled and configured host endpoint access control.
     * 
     * @param manager Entry point to ComputeManager.
     */
    public static void createAVMWithProxyAgentEnabledAndConfiguredHostEndpointAccessControl(
        com.azure.resourcemanager.compute.generated.ComputeManager manager) {
        manager.virtualMachines().define("myVM").withRegion("westus").withExistingResourceGroup("myResourceGroup")
            .withHardwareProfile(new HardwareProfile().withVmSize(VirtualMachineSizeTypes.STANDARD_D2S_V3))
            .withStorageProfile(new StorageProfileInner()
            ...
            .withSecurityProfile(
                new SecurityProfile().withProxyAgentSettings(new ProxyAgentSettings().withEnabled(true)
                    .withImds(new ProxyAgentSettingsImds().withAccessControlProfile(
                        new ProxyAgentSettingsImdsAccessControlProfile().withMode(Mode.ENFORCE)
                            .withRules(mapOf("/metadata/identity",
                                Arrays.asList(new RuleDefinition().withFilters(
                                    Arrays.asList(new FilterDefinition().withUsername("testUser"))))))))
                    .withWireserver(
                        new ProxyAgentSettingsWireserver()
                            .withAccessControlProfile(
                                new ProxyAgentSettingsWireserverAccessControlProfile().withMode(Mode.AUDIT)
                                    .withRules(
                                        mapOf("/machine",
                                            Arrays.asList(
                                                new RuleDefinition()
                                                    .withQueryParameters(mapOf("comp", "goalstate", "version", "1"))
                                                    .withFilters(Arrays.asList(
                                                        new FilterDefinition().withProcessName("guestagent.exe"))),
                                                new RuleDefinition().withQueryParameters(mapOf("comp", "health"))
                                                    .withFilters(Arrays.asList(
                                                        new FilterDefinition().withProcessName("guestagent.exe"),
                                                        new FilterDefinition().withProcessName("winpa.exe"))))))))))
            .create();
    }
