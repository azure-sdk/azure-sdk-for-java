...
- [ListSoftDeletedResourcesByArtifactName](#softdelete_listsoftdeletedresourcesbyartifactname)
...
### SoftDelete_ListSoftDeletedResourcesByArtifactName

```java
/**
 * Samples for SoftDelete ListSoftDeletedResourcesByArtifactName.
 */
public final class SoftDeleteListSoftDeletedResourcesByArtifactNameSamples {
    /*
     * x-ms-original-file:
     * specification/compute/resource-manager/Microsoft.Compute/GalleryRP/stable/2024-03-03/examples/galleryExamples/
    ...
    public static void listSoftDeletedResourcesOfAnArtifactInTheGallery(
        com.azure.resourcemanager.compute.generated.ComputeManager manager) {
        manager.softDeletes()
            .listSoftDeletedResourcesByArtifactName("myResourceGroup", "myGalleryName", "images", "myGalleryImageName",
                com.azure.core.util.Context.NONE);
    }
}
```
