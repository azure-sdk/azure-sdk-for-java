...
- [Post](#attributebasedvmsizerecommender_post)
...
- [Get](#spotplacementrecommender_get)
- [Post](#spotplacementrecommender_post)
...
### AttributeBasedVMSizeRecommender_Post
...
public final class DiskInspectionCreateSamples {
    ...
    public static void
        ...
        manager.diskInspections()
            .create("eastus", new RunDiskInspectionInput().withResourceId(
                ...
                .withManifest("diagnostic")
                .withUploadSasUri("testSasUri"), com.azure.core.util.Context.NONE);
    }
}
```
...
public final class DiskInspectionStorageConfigurationRegisterSamples {
    ...
    public static void createARequestForRegisteringAStorageAccountInformation(
        com.azure.resourcemanager.compute.generated.ComputeManager manager) {
        manager.diskInspectionStorageConfigurations()
            .registerWithResponse("eastus", new StorageConfigurationInput().withStorageAccountId(
