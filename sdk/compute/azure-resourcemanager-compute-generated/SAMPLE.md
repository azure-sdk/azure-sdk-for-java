                        ...
                        new GalleryImageVersionUefiSettings()
                            ...
                            .withAdditionalSignatures(
                                new UefiKeySignatures()
                                    .withKek(Arrays.asList(new UefiKey().withValue(Arrays.asList("<sha256 value>"))))
                                    .withDb(Arrays.asList(new UefiKey().withValue(Arrays.asList("<x509 value>"))))
                                    .withDbx(Arrays.asList(new UefiKey().withValue(Arrays.asList("<x509 value>")))))))
            .create();
    }
