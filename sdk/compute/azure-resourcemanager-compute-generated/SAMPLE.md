...
public final class CommunityGallerySecurityPostureVersionsGetSamples {
    ...
    public static void
        ...
        manager.communityGallerySecurityPostureVersions()
            .getWithResponse("myLocation", "publicGalleryName", "myGallerySecurityPostureName",
                "myGallerySecurityPostureVersionName", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class CommunityGallerySecurityPosturesGetSamples {
    ...
    public static void
        ...
        manager.communityGallerySecurityPostures()
            .getWithResponse("myLocation", "publicGalleryName", "myGallerySecurityPostureName",
                com.azure.core.util.Context.NONE);
    }
}
...
public final class GallerySecurityPostureVersionsCreateOrUpdateSamples {
    ...
    public static void createOrUpdateASimpleGallerySecurityPostureVersion(
        com.azure.resourcemanager.compute.generated.ComputeManager manager) {
        manager.gallerySecurityPostureVersions()
            .define("1.0.0")
            .withRegion("West US")
            ...
            .withVirtualMachineExtensions(new VirtualMachineExtensionAutoGenerated())
            .create();
    }
}
```
...
public final class GallerySecurityPostureVersionsDeleteSamples {
    ...
    public static void
        ...
        manager.gallerySecurityPostureVersions()
            .delete("myResourceGroup", "myGalleryName", "myGallerySecurityPostureName", "1.0.0",
                com.azure.core.util.Context.NONE);
    }
}
```
...
public final class GallerySecurityPostureVersionsGetSamples {
    ...
    public static void
        ...
        manager.gallerySecurityPostureVersions()
            .getWithResponse("myResourceGroup", "myGalleryName", "myGallerySecurityPostureName", "1.0.0", null,
                com.azure.core.util.Context.NONE);
    }
}
```
...
public final class GallerySecurityPostureVersionsUpdateSamples {
    ...
    public static void
        ...
        GallerySecurityPostureVersion resource = manager.gallerySecurityPostureVersions()
            .getWithResponse("myResourceGroup", "myGalleryName", "myGallerySecurityPostureName", "1.0.0", null,
                com.azure.core.util.Context.NONE)
            .getValue();
        resource.update()
...
public final class GallerySecurityPosturesCreateOrUpdateSamples {
    ...
    public static void createOrUpdateASimpleGallerySecurityPosture(
        com.azure.resourcemanager.compute.generated.ComputeManager manager) {
        manager.gallerySecurityPostures()
            .define("myGallerySecurityPostureName")
            .withRegion("West US")
            .withExistingGallery("myResourceGroup", "myGalleryName")
            .withDescription("This is the gallery security posture description.")
            .withEula("This is the gallery security posture EULA.")
            .withPrivacyStatementUri("myPrivacyStatementUri}")
            .withReleaseNoteUri("myReleaseNoteUri")
            .withEndOfLifeDate(OffsetDateTime.parse("2022-03-20T09:12:28Z"))
            .withOsType(OperatingSystemTypes.WINDOWS)
            .withApplicableResourceTypes(Arrays.asList("vmss"))
            .create();
    }
}
```
...
public final class GallerySecurityPosturesDeleteSamples {
    ...
    public static void
        ...
        manager.gallerySecurityPostures()
            .delete("myResourceGroup", "myGalleryName", "myGallerySecurityPostureName",
                com.azure.core.util.Context.NONE);
    }
}
```
...
public final class GallerySecurityPosturesGetSamples {
    ...
    public static void getAGallerySecurityPosture(com.azure.resourcemanager.compute.generated.ComputeManager manager) {
        manager.gallerySecurityPostures()
            .getWithResponse("myResourceGroup", "myGalleryName", "myGallerySecurityPostureName",
                com.azure.core.util.Context.NONE);
    }
}
```
...
public final class GallerySecurityPosturesUpdateSamples {
    ...
    public static void
        ...
        GallerySecurityPosture resource = manager.gallerySecurityPostures()
            .getWithResponse("myResourceGroup", "myGalleryName", "myGallerySecurityPostureName",
                com.azure.core.util.Context.NONE)
            .getValue();
        resource.update()
