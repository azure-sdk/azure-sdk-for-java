...
public final class ImageAnalysisAsyncClient {
    ...
    public Mono<Response<BinaryData>> analyzeStreamWithResponse(
            BinaryData imageContents, RequestOptions requestOptions) {
        return this.serviceClient.analyzeStreamWithResponseAsync(imageContents, requestOptions);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> analyzeUrlWithResponse(BinaryData imageContents, RequestOptions requestOptions) {
        return this.serviceClient.analyzeUrlWithResponseAsync(imageContents, requestOptions);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<ImageAnalysisResult> analyzeStream(
            BinaryData imageContents,
            List<VisualFeatures> visualFeatures,
            String modelName,
            String language,
            String smartCropsAspectRatios,
        ...
        if (language != null) {
            requestOptions.addQueryParam("langauge", language, false);
        }
        if (smartCropsAspectRatios != null) {
            requestOptions.addQueryParam("smartcrops-aspect-ratios", smartCropsAspectRatios, false);
        }
        ...
        return analyzeStreamWithResponse(imageContents, requestOptions)
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<ImageAnalysisResult> analyzeStream(BinaryData imageContents) {
        // Generated convenience method for analyzeStreamWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return analyzeStreamWithResponse(imageContents, requestOptions)
                .flatMap(FluxUtil::toMono)
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<ImageAnalysisResult> analyzeUrl(
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<ImageAnalysisResult> analyzeUrl(ImageUrl imageContents) {
        // Generated convenience method for analyzeUrlWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return analyzeUrlWithResponse(BinaryData.fromObject(imageContents), requestOptions)
                .flatMap(FluxUtil::toMono)
