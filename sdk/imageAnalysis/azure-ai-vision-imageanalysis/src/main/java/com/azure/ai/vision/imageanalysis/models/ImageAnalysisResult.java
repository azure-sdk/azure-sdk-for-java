...
public final class ImageAnalysisResult {
    /*
     * An AdultResult for the immage.
     */
    @Generated
    @JsonProperty(value = "adultResult")
    private AdultResult adultResult;
    ...
    private ImagePredictionResult customModelResult;
    ...
    private ImageMetadataApiModel metadata;
    ...
    private ImageAnalysisResult(
            @JsonProperty(value = "metadata") ImageMetadataApiModel metadata,
    ...
    /**
     * Get the adultResult property: An AdultResult for the immage.
     *
     * @return the adultResult value.
     */
    @Generated
    public AdultResult getAdultResult() {
     ...
     */
    @Generated
    public ImagePredictionResult getCustomModelResult() {
     ...
     */
    @Generated
    public ImageMetadataApiModel getMetadata() {
