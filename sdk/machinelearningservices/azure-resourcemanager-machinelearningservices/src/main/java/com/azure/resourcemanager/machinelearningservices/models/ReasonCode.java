...
public final class ReasonCode extends ExpandableStringEnum<ReasonCode> {
    /** Static value NotSpecified for ReasonCode. */
    public static final ReasonCode NOT_SPECIFIED = fromString("NotSpecified");

    /** Static value NotAvailableForRegion for ReasonCode. */
    public static final ReasonCode NOT_AVAILABLE_FOR_REGION = fromString("NotAvailableForRegion");
