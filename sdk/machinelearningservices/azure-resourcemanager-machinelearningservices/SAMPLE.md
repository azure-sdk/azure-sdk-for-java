...
import com.azure.resourcemanager.machinelearningservices.models.BatchDeploymentProperties;
import com.azure.resourcemanager.machinelearningservices.models.BatchLoggingLevel;
import com.azure.resourcemanager.machinelearningservices.models.BatchOutputAction;
import com.azure.resourcemanager.machinelearningservices.models.BatchRetrySettings;
import com.azure.resourcemanager.machinelearningservices.models.CodeConfiguration;
import com.azure.resourcemanager.machinelearningservices.models.IdAssetReference;
import com.azure.resourcemanager.machinelearningservices.models.ManagedServiceIdentity;
import com.azure.resourcemanager.machinelearningservices.models.ManagedServiceIdentityType;
import com.azure.resourcemanager.machinelearningservices.models.ResourceConfiguration;
import com.azure.resourcemanager.machinelearningservices.models.Sku;
import com.azure.resourcemanager.machinelearningservices.models.SkuTier;
...
public final class BatchDeploymentsCreateOrUpdateSamples {
    ...
    public static void createOrUpdateBatchDeployment(
        com.azure.resourcemanager.machinelearningservices.MachineLearningServicesManager manager) throws IOException {
        manager
            .batchDeployments()
...
```java
import com.azure.resourcemanager.machinelearningservices.models.BatchEndpointDefaults;
import com.azure.resourcemanager.machinelearningservices.models.BatchEndpointProperties;
...
import com.azure.resourcemanager.machinelearningservices.models.ManagedServiceIdentityType;
import com.azure.resourcemanager.machinelearningservices.models.PartialManagedServiceIdentity;
import java.io.IOException;
import java.util.HashMap;
import java.util.Map;
...
```java
import com.azure.resourcemanager.machinelearningservices.models.CodeContainerProperties;
import java.util.HashMap;
import java.util.Map;
...
```java
import com.azure.resourcemanager.machinelearningservices.models.CodeVersionProperties;
import java.util.HashMap;
import java.util.Map;
...
```java
import com.azure.resourcemanager.machinelearningservices.models.ComponentContainerProperties;
import java.util.HashMap;
import java.util.Map;
...
import com.azure.core.management.serializer.SerializerFactory;
import com.azure.core.util.serializer.SerializerEncoding;
import com.azure.resourcemanager.machinelearningservices.models.ComponentVersionProperties;
import java.io.IOException;
import java.util.HashMap;
import java.util.Map;
...
import com.azure.resourcemanager.machinelearningservices.models.AksSchemaProperties;
...
```java
import com.azure.resourcemanager.machinelearningservices.models.DataContainerProperties;
import com.azure.resourcemanager.machinelearningservices.models.DataType;
import java.util.HashMap;
import java.util.Map;
...
```java
import com.azure.resourcemanager.machinelearningservices.models.UriFileDataVersion;
import java.util.HashMap;
import java.util.Map;
...
```java
import com.azure.resourcemanager.machinelearningservices.models.AccountKeyDatastoreCredentials;
import com.azure.resourcemanager.machinelearningservices.models.AccountKeyDatastoreSecrets;
import com.azure.resourcemanager.machinelearningservices.models.AzureBlobDatastore;
import com.azure.resourcemanager.machinelearningservices.models.AzureDataLakeGen1Datastore;
import com.azure.resourcemanager.machinelearningservices.models.AzureDataLakeGen2Datastore;
import com.azure.resourcemanager.machinelearningservices.models.AzureFileDatastore;
import com.azure.resourcemanager.machinelearningservices.models.ServicePrincipalDatastoreCredentials;
...
```java
import com.azure.resourcemanager.machinelearningservices.models.EnvironmentContainerProperties;
import java.util.HashMap;
import java.util.Map;
...
```java
import com.azure.resourcemanager.machinelearningservices.models.BuildContext;
import com.azure.resourcemanager.machinelearningservices.models.EnvironmentVersionProperties;
import com.azure.resourcemanager.machinelearningservices.models.InferenceContainerProperties;
import com.azure.resourcemanager.machinelearningservices.models.Route;
import java.util.HashMap;
import java.util.Map;
...
import com.azure.core.management.serializer.SerializerFactory;
import com.azure.core.util.serializer.SerializerEncoding;
import com.azure.resourcemanager.machinelearningservices.models.AmlToken;
import com.azure.resourcemanager.machinelearningservices.models.CommandJob;
import com.azure.resourcemanager.machinelearningservices.models.CommandJobLimits;
import com.azure.resourcemanager.machinelearningservices.models.Goal;
import com.azure.resourcemanager.machinelearningservices.models.GridSamplingAlgorithm;
import com.azure.resourcemanager.machinelearningservices.models.JobService;
import com.azure.resourcemanager.machinelearningservices.models.LiteralJobInput;
import com.azure.resourcemanager.machinelearningservices.models.MedianStoppingPolicy;
import com.azure.resourcemanager.machinelearningservices.models.Mpi;
import com.azure.resourcemanager.machinelearningservices.models.Objective;
import com.azure.resourcemanager.machinelearningservices.models.OutputDeliveryMode;
import com.azure.resourcemanager.machinelearningservices.models.PipelineJob;
import com.azure.resourcemanager.machinelearningservices.models.ResourceConfiguration;
import com.azure.resourcemanager.machinelearningservices.models.SweepJob;
import com.azure.resourcemanager.machinelearningservices.models.SweepJobLimits;
import com.azure.resourcemanager.machinelearningservices.models.TensorFlow;
import com.azure.resourcemanager.machinelearningservices.models.TrialComponent;
import com.azure.resourcemanager.machinelearningservices.models.UriFileJobOutput;
import java.io.IOException;
import java.time.Duration;
import java.util.HashMap;
import java.util.Map;
...
public final class JobsGetSamples {
     ...
     * @param manager Entry point to MachineLearningServicesManager.
     */
    public static void getSweepJob(
        com.azure.resourcemanager.machinelearningservices.MachineLearningServicesManager manager) {
        manager.jobs().getWithResponse("test-rg", "my-aml-workspace", "string", Context.NONE);
    }
...
public final class JobsListSamples {
     ...
     * @param manager Entry point to MachineLearningServicesManager.
     */
    public static void listSweepJob(
        com.azure.resourcemanager.machinelearningservices.MachineLearningServicesManager manager) {
        manager.jobs().list("test-rg", "my-aml-workspace", null, "string", "string", null, Context.NONE);
    }
}
...
public final class ModelContainersCreateOrUpdateSamples {
    /*
     * x-ms-original-file: specification/machinelearningservices/resource-manager/Microsoft.MachineLearningServices/stable/2022-05-01/examples/ModelContainer/createOrUpdate.json
     */
    /**
...
```java
import com.azure.resourcemanager.machinelearningservices.models.FlavorData;
import com.azure.resourcemanager.machinelearningservices.models.ModelVersionProperties;
import java.util.HashMap;
import java.util.Map;
...
```java
import com.azure.resourcemanager.machinelearningservices.models.CodeConfiguration;
import com.azure.resourcemanager.machinelearningservices.models.ContainerResourceRequirements;
import com.azure.resourcemanager.machinelearningservices.models.ContainerResourceSettings;
import com.azure.resourcemanager.machinelearningservices.models.DefaultScaleSettings;
import com.azure.resourcemanager.machinelearningservices.models.KubernetesOnlineDeployment;
import com.azure.resourcemanager.machinelearningservices.models.ManagedOnlineDeployment;
import com.azure.resourcemanager.machinelearningservices.models.ManagedServiceIdentity;
import com.azure.resourcemanager.machinelearningservices.models.ManagedServiceIdentityType;
import com.azure.resourcemanager.machinelearningservices.models.OnlineRequestSettings;
import com.azure.resourcemanager.machinelearningservices.models.ProbeSettings;
import com.azure.resourcemanager.machinelearningservices.models.Sku;
import com.azure.resourcemanager.machinelearningservices.models.SkuTier;
import com.azure.resourcemanager.machinelearningservices.models.UserAssignedIdentity;
import java.time.Duration;
...
```java
import com.azure.core.util.Context;
import com.azure.resourcemanager.machinelearningservices.models.ContainerType;
...
import com.azure.resourcemanager.machinelearningservices.models.PartialSku;
import com.azure.resourcemanager.machinelearningservices.models.SkuTier;
import java.util.HashMap;
import java.util.Map;
...
public final class OnlineEndpointsGetSamples {
    /*
     * x-ms-original-file: specification/machinelearningservices/resource-manager/Microsoft.MachineLearningServices/stable/2022-05-01/examples/OnlineEndpoint/get.json
     */
    /**
...
public final class OnlineEndpointsListSamples {
    /*
     * x-ms-original-file: specification/machinelearningservices/resource-manager/Microsoft.MachineLearningServices/stable/2022-05-01/examples/OnlineEndpoint/list.json
     */
    /**
...
```java
import com.azure.core.util.Context;
import com.azure.resourcemanager.machinelearningservices.models.KeyType;
...
public final class OnlineEndpointsRegenerateKeysSamples {
    /*
     * x-ms-original-file: specification/machinelearningservices/resource-manager/Microsoft.MachineLearningServices/stable/2022-05-01/examples/OnlineEndpoint/regenerateKeys.json
     */
    /**
...
```java
import com.azure.resourcemanager.machinelearningservices.models.ConnectionCategory;
import com.azure.resourcemanager.machinelearningservices.models.NoneAuthTypeWorkspaceConnectionProperties;
...
```java
import com.azure.resourcemanager.machinelearningservices.models.EncryptionKeyVaultProperties;
