...
public final class PipelinesClientImpl implements PipelinesClient {
    ...
    public interface PipelinesService {
        ...
        Mono<Response<PipelineInner>> getByResourceGroup(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @QueryParam("api-version") String apiVersion,
            @PathParam("pipelineName") String pipelineName, @HeaderParam("Accept") String accept, Context context);

        @Headers({ "Content-Type: application/json" })
        @Patch("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DevOps/pipelines/{pipelineName}")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<PipelineInner>> update(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @QueryParam("api-version") String apiVersion,
            @PathParam("pipelineName") String pipelineName,
    ...
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String resourceGroupName,
        String pipelineName, PipelineInner createOperationParameters) {
        ...
        if (createOperationParameters == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter createOperationParameters is required and cannot be null."));
        } else {
        ...
        return FluxUtil
            .withContext(context -> service.createOrUpdate(this.client.getEndpoint(), this.client.getSubscriptionId(),
                resourceGroupName, this.client.getApiVersion(), pipelineName, createOperationParameters, accept,
                context))
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String resourceGroupName,
        String pipelineName, PipelineInner createOperationParameters, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service.createOrUpdate(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            this.client.getApiVersion(), pipelineName, createOperationParameters, accept, context);
    }
    ...
    public SyncPoller<PollResult<PipelineInner>, PipelineInner> beginCreateOrUpdate(String resourceGroupName,
        String pipelineName, PipelineInner createOperationParameters) {
        return this.beginCreateOrUpdateAsync(resourceGroupName, pipelineName, createOperationParameters)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<PipelineInner>, PipelineInner> beginCreateOrUpdate(String resourceGroupName,
        String pipelineName, PipelineInner createOperationParameters, Context context) {
        return this.beginCreateOrUpdateAsync(resourceGroupName, pipelineName, createOperationParameters, context)
            .getSyncPoller();
    }
    ...
    private Mono<PipelineInner> createOrUpdateAsync(String resourceGroupName, String pipelineName,
        PipelineInner createOperationParameters) {
        return beginCreateOrUpdateAsync(resourceGroupName, pipelineName, createOperationParameters).last()
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PipelineInner> createOrUpdateAsync(String resourceGroupName, String pipelineName,
        PipelineInner createOperationParameters, Context context) {
        return beginCreateOrUpdateAsync(resourceGroupName, pipelineName, createOperationParameters, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public PipelineInner createOrUpdate(String resourceGroupName, String pipelineName,
        PipelineInner createOperationParameters) {
        ...
        return FluxUtil
            .withContext(
                context -> service.getByResourceGroup(this.client.getEndpoint(), this.client.getSubscriptionId(),
                    resourceGroupName, this.client.getApiVersion(), pipelineName, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<PipelineInner>> getByResourceGroupWithResponseAsync(String resourceGroupName,
        ...
        return service.getByResourceGroup(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            this.client.getApiVersion(), pipelineName, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<PipelineInner>> updateWithResponseAsync(String resourceGroupName, String pipelineName,
        ...
        if (updateOperationParameters == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter updateOperationParameters is required and cannot be null."));
        } else {
        ...
        return FluxUtil
            .withContext(
                context -> service.update(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
                    this.client.getApiVersion(), pipelineName, updateOperationParameters, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<PipelineInner>> updateWithResponseAsync(String resourceGroupName, String pipelineName,
        PipelineUpdateParameters updateOperationParameters, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PipelineInner> updateAsync(String resourceGroupName, String pipelineName,
        PipelineUpdateParameters updateOperationParameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<PipelineInner> updateWithResponse(String resourceGroupName, String pipelineName,
        PipelineUpdateParameters updateOperationParameters, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public PipelineInner update(String resourceGroupName, String pipelineName,
        PipelineUpdateParameters updateOperationParameters) {
        return updateWithResponse(resourceGroupName, pipelineName, updateOperationParameters, Context.NONE).getValue();
    }
    ...
    public void delete(String resourceGroupName, String pipelineName) {
        deleteWithResponse(resourceGroupName, pipelineName, Context.NONE);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return result of a request to list all Azure Pipelines under a given scope as paginated response with
     * {@link PagedFlux}.
     */
