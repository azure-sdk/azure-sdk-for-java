...
public final class AzureDevOpsImpl implements AzureDevOps {
     ...
     */
    AzureDevOpsImpl(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter, Duration defaultPollInterval,
    ...
    private static final ClientLogger LOGGER = new ClientLogger(AzureDevOpsImpl.class);
}
