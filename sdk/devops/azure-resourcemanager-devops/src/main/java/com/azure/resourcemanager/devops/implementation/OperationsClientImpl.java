...
import com.azure.resourcemanager.devops.models.OperationListResult;
...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    OperationsClientImpl(AzureDevOpsImpl client) {
        this.service =
    ...
    /**
     * The interface defining all the services for AzureDevOpsOperations to be used by the proxy service to perform REST
     * calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "AzureDevOpsOperation")
     ...
     * @return result of a request to list all operations supported by Microsoft.DevOps resource provider along with
