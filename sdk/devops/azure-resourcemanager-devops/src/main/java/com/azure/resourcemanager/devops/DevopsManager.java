...
public final class DevopsManager {
    ...
    private DevopsManager(HttpPipeline httpPipeline, AzureProfile profile, Duration defaultPollInterval) {
        ...
        this.clientObject = new AzureDevOpsBuilder().pipeline(httpPipeline)
     ...
     * @return the devops service API instance.
     */
    public static DevopsManager authenticate(HttpPipeline httpPipeline, AzureProfile profile) {
        Objects.requireNonNull(httpPipeline, "'httpPipeline' cannot be null.");
        Objects.requireNonNull(profile, "'profile' cannot be null.");
        return new DevopsManager(httpPipeline, profile, null);
    }
    ...
    public static final class Configurable {
        ...
        private static final Map<String, String> PROPERTIES
            = CoreUtils.getProperties("azure-resourcemanager-devops.properties");
        ...
        public DevopsManager authenticate(TokenCredential credential, AzureProfile profile) {
            ...
            userAgentBuilder.append("azsdk-java")
                .append("-")
                .append("com.azure.resourcemanager.devops")
                .append("/")
    ...
    /**
     * Gets the resource collection API of PipelineTemplateDefinitions.
     * 
    ...
    /**
     * Gets wrapped service client AzureDevOps providing direct access to the underlying auto-generated API
     * implementation, based on Azure REST API.
     * 
     * @return Wrapped service client AzureDevOps.
     */
