...
public final class SharedImageImpl implements SharedImage, SharedImage.Definition, SharedImage.Update {
    ...
    public SharedImageImpl withExistingSharedgallery(String resourceGroupName, String labName,
    ...
    public SharedImage create() {
        this.innerObject
            = serviceManager.serviceClient().getSharedImages().createOrUpdateWithResponse(resourceGroupName, labName,
                sharedGalleryName, name, this.innerModel(), Context.NONE).getValue();
        return this;
    }

    public SharedImage create(Context context) {
        this.innerObject = serviceManager.serviceClient().getSharedImages()
            .createOrUpdateWithResponse(resourceGroupName, labName, sharedGalleryName, name, this.innerModel(), context)
            .getValue();
        return this;
    }
    ...
    public SharedImage apply() {
        this.innerObject = serviceManager.serviceClient().getSharedImages()
            .updateWithResponse(resourceGroupName, labName, sharedGalleryName, name, updateSharedImage, Context.NONE)
            .getValue();
        return this;
    }
    ...
    SharedImageImpl(SharedImageInner innerObject,
    ...
    public SharedImage refresh() {
        ...
        this.innerObject = serviceManager.serviceClient().getSharedImages()
            .getWithResponse(resourceGroupName, labName, sharedGalleryName, name, localExpand, Context.NONE).getValue();
        return this;
    }
    ...
    public SharedImage refresh(Context context) {
        String localExpand = null;
        this.innerObject = serviceManager.serviceClient().getSharedImages()
            .getWithResponse(resourceGroupName, labName, sharedGalleryName, name, localExpand, context).getValue();
        return this;
    }
