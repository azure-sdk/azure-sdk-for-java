...
public final class ServiceRunnerImpl implements ServiceRunner, ServiceRunner.Definition, ServiceRunner.Update {
    ...
    public ServiceRunner create() {
        this.innerObject = serviceManager.serviceClient().getServiceRunners().createOrUpdate(resourceGroupName, labName,
    ...
    public ServiceRunner refresh() {
        this.innerObject = serviceManager.serviceClient().getServiceRunners()
