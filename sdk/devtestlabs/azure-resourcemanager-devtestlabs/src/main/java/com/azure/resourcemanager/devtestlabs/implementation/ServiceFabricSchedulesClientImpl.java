...
public final class ServiceFabricSchedulesClientImpl implements ServiceFabricSchedulesClient {
    ...
    /**
     * The interface defining all the services for DevTestLabsClientServiceFabricSchedules to be used by the proxy
    ...
    private Mono<PagedResponse<ScheduleInner>> listSinglePageAsync(
        ...
        if (serviceFabricName == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter serviceFabricName is required and cannot be null."));
        }
    ...
    public PagedIterable<ScheduleInner> list(
        ...
        return new PagedIterable<>(
            listAsync(resourceGroupName, labName, username, serviceFabricName, expand, filter, top, orderby));
    }
