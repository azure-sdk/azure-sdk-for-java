...
public interface BastionHosts {
     ...
     * @return contains a list of bastionHosts and their properties as paginated response with {@link PagedIterable}.
     */
    PagedIterable<BastionHost> list(String resourceGroupName, String labName, String virtualNetworkName, String filter,
     ...
     */
    Response<BastionHost> getWithResponse(String resourceGroupName, String labName, String virtualNetworkName,
