...
public final class LabSecretImpl implements LabSecret, LabSecret.Definition, LabSecret.Update {
    ...
    public LabSecret apply() {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getLabSecrets()
                .update(resourceGroupName, labName, name, updateSecret, Context.NONE);
        return this;
    }
    ...
    public LabSecret apply(Context context) {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getLabSecrets()
                .update(resourceGroupName, labName, name, updateSecret, context);
        return this;
    }
    ...
    public LabSecretImpl withIdentity(IdentityProperties identity) {
