...
public final class LabSecretImpl implements LabSecret, LabSecret.Definition, LabSecret.Update {
    ...
    public LabSecret create() {
        this.innerObject = serviceManager.serviceClient().getLabSecrets().createOrUpdate(resourceGroupName, labName,
    ...
    public LabSecret apply() {
        this.innerObject = serviceManager.serviceClient().getLabSecrets()
            .updateWithResponse(resourceGroupName, labName, name, updateSecret, Context.NONE).getValue();
        return this;
    }

    public LabSecret apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getLabSecrets()
            .updateWithResponse(resourceGroupName, labName, name, updateSecret, context).getValue();
        return this;
    }
    ...
    public LabSecret refresh() {
        this.innerObject = serviceManager.serviceClient().getLabSecrets()
            .getWithResponse(resourceGroupName, labName, name, Context.NONE).getValue();
        return this;
    }

    public LabSecret refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getLabSecrets()
            .getWithResponse(resourceGroupName, labName, name, context).getValue();
        return this;
    }
