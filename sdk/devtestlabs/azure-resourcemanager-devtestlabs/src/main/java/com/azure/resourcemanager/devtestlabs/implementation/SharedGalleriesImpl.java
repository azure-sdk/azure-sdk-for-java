...
public final class SharedGalleriesImpl implements SharedGalleries {
    ...
    public PagedIterable<SharedGallery> list(String resourceGroupName, String labName, String expand, String filter,
    ...
    public Response<SharedGallery> getWithResponse(String resourceGroupName, String labName, String name, String expand,
        Context context) {
