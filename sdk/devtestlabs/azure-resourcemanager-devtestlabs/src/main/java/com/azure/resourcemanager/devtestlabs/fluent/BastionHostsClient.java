...
public interface BastionHostsClient {
    ...
    Response<BastionHostInner> getWithResponse(String resourceGroupName, String labName, String virtualNetworkName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    BastionHostInner createOrUpdate(String resourceGroupName, String labName, String virtualNetworkName, String name,
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    BastionHostInner createOrUpdate(String resourceGroupName, String labName, String virtualNetworkName, String name,
        BastionHostInner bastionHost, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String labName, String virtualNetworkName,
        String name);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<BastionHostInner> updateWithResponse(String resourceGroupName, String labName, String virtualNetworkName,
        String name, BastionHostFragment bastionHost, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    BastionHostInner update(String resourceGroupName, String labName, String virtualNetworkName, String name,
