...
public final class VirtualMachineSchedulesImpl implements VirtualMachineSchedules {
    ...
    public Response<Schedule> getWithResponse(String resourceGroupName, String labName, String virtualMachineName,
        ...
        Response<ScheduleInner> inner = this.serviceClient().getWithResponse(resourceGroupName, labName,
            virtualMachineName, name, expand, context);
        if (inner != null) {
    ...
    public Response<Schedule> createOrUpdateWithResponse(String resourceGroupName, String labName,
        ...
        Response<ScheduleInner> inner = this.serviceClient().createOrUpdateWithResponse(resourceGroupName, labName,
            virtualMachineName, name, schedule, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
                new ScheduleImpl(inner.getValue(), this.manager()));
        } else {
    ...
    public Response<Schedule> updateWithResponse(String resourceGroupName, String labName, String virtualMachineName,
        ...
        Response<ScheduleInner> inner = this.serviceClient().updateWithResponse(resourceGroupName, labName,
            virtualMachineName, name, schedule, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
                new ScheduleImpl(inner.getValue(), this.manager()));
