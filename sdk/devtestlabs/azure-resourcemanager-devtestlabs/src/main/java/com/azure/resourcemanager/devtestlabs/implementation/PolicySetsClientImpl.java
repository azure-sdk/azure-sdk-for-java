...
public final class PolicySetsClientImpl implements PolicySetsClient {
    ...
    public interface PolicySetsService {
        ...
        @Get("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DevTestLab/labs/{labName}/policysets")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<PolicySetList>> list(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<PolicySetList>> listNext(@PathParam(value = "nextLink", encoded = true) String nextLink,
    ...
    private Mono<PagedResponse<PolicySetInner>> listSinglePageAsync(String resourceGroupName, String labName,
        ...
        return FluxUtil
            ...
            .<PagedResponse<PolicySetInner>>map(res -> new PagedResponseBase<>(res.getRequest(), res.getStatusCode(),
    ...
    private PagedFlux<PolicySetInner> listAsync(String resourceGroupName, String labName, String filter, Integer top,
        String orderby) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<PolicySetInner> list(String resourceGroupName, String labName, String filter, Integer top,
        String orderby, Context context) {
