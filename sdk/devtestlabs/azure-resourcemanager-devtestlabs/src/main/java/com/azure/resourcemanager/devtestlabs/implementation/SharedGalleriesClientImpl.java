...
public final class SharedGalleriesClientImpl implements SharedGalleriesClient {
    ...
    private interface SharedGalleriesService {
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<SharedGalleryInner>> createOrUpdate(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("labName") String labName,
            @PathParam("name") String name,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") SharedGalleryInner sharedGallery,
            @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<SharedGalleryInner>> update(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("labName") String labName,
            @PathParam("name") String name,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") SharedGalleryFragment sharedGallery,
            @HeaderParam("Accept") String accept,
            Context context);
    ...
    private PagedFlux<SharedGalleryInner> listAsync(
        String resourceGroupName, String labName, String expand, String filter, Integer top, String orderby) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<SharedGalleryInner> list(
        String resourceGroupName,
        String labName,
        String expand,
        String filter,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<SharedGalleryInner> getAsync(String resourceGroupName, String labName, String name, String expand) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<SharedGalleryInner> getWithResponse(
        String resourceGroupName, String labName, String name, String expand, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<SharedGalleryInner>> createOrUpdateWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<SharedGalleryInner> createOrUpdateAsync(
        String resourceGroupName, String labName, String name, SharedGalleryInner sharedGallery) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public SharedGalleryInner createOrUpdate(
        String resourceGroupName, String labName, String name, SharedGalleryInner sharedGallery) {
        return createOrUpdateAsync(resourceGroupName, labName, name, sharedGallery).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<SharedGalleryInner> createOrUpdateWithResponse(
        String resourceGroupName, String labName, String name, SharedGalleryInner sharedGallery, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<SharedGalleryInner>> updateWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<SharedGalleryInner> updateAsync(
        String resourceGroupName, String labName, String name, SharedGalleryFragment sharedGallery) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public SharedGalleryInner update(
        String resourceGroupName, String labName, String name, SharedGalleryFragment sharedGallery) {
        return updateAsync(resourceGroupName, labName, name, sharedGallery).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<SharedGalleryInner> updateWithResponse(
        String resourceGroupName, String labName, String name, SharedGalleryFragment sharedGallery, Context context) {
