...
import com.azure.resourcemanager.devtestlabs.fluent.models.FormulaPropertiesInner;
import java.time.OffsetDateTime;
import java.util.List;
import java.util.Map;

/** An immutable client-side representation of FormulaProperties. */
public interface FormulaProperties {
    /**
    ...
    /**
     * Gets the name property: The name of the virtual machine or environment.
     *
    ...
    /**
     * Gets the location property: The location of the new virtual machine or environment.
     *
    ...
    /**
     * Gets the securityProfile property: Option to apply more security protection for VMs.
     *
    ...
    /**
     * Gets the systemDataPropertiesSystemData property: Azure Resource Manager metadata containing createdBy and
    ...
    /**
     * Gets the idPropertiesId property: Fully qualified resource ID for the resource. E.g.
    ...
    /**
     * Gets the systemDataLabVmsStartupSystemData property: Azure Resource Manager metadata containing createdBy and
     * modifiedBy information.
     *
    ...
    /**
     * Gets the idLabVmsStartupId property: Fully qualified resource ID for the resource. E.g.
     * "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/{resourceProviderNamespace}/{resourceType}/{resourceName}".
     *
    ...
    /**
     * Gets the inner com.azure.resourcemanager.devtestlabs.fluent.models.FormulaPropertiesInner object.
     *
     * @return the inner object.
     */
    FormulaPropertiesInner innerModel();
}
