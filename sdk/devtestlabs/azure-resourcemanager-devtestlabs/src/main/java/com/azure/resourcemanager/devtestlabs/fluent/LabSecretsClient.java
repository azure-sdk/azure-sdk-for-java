...
public interface LabSecretsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<LabSecretInner> list(String resourceGroupName, String labName, String filter, Integer top,
    ...
    SyncPoller<PollResult<LabSecretInner>, LabSecretInner> beginCreateOrUpdate(String resourceGroupName, String labName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<LabSecretInner> updateWithResponse(String resourceGroupName, String labName, String name,
