...
public final class SharedGalleryImpl implements SharedGallery, SharedGallery.Definition, SharedGallery.Update {
    ...
    public SharedGallery create() {
        this.innerObject = serviceManager.serviceClient().getSharedGalleries()
    ...
    public SharedGallery apply() {
        this.innerObject = serviceManager.serviceClient().getSharedGalleries()
            .updateWithResponse(resourceGroupName, labName, name, updateSharedGallery, Context.NONE).getValue();
        return this;
    }

    public SharedGallery apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getSharedGalleries()
            .updateWithResponse(resourceGroupName, labName, name, updateSharedGallery, context).getValue();
        return this;
    }
