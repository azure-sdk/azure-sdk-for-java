...
public final class BastionHostImpl implements BastionHost, BastionHost.Definition, BastionHost.Update {
    ...
    public BastionHostImpl withExistingVirtualnetwork(String resourceGroupName, String labName,
    ...
    public BastionHost create() {
        this.innerObject = serviceManager.serviceClient().getBastionHosts().createOrUpdate(resourceGroupName, labName,
            virtualNetworkName, name, this.innerModel(), Context.NONE);
        return this;
    }

    public BastionHost create(Context context) {
        this.innerObject = serviceManager.serviceClient().getBastionHosts().createOrUpdate(resourceGroupName, labName,
            virtualNetworkName, name, this.innerModel(), context);
        return this;
    }
    ...
    public BastionHost apply() {
        this.innerObject = serviceManager.serviceClient().getBastionHosts()
            .updateWithResponse(resourceGroupName, labName, virtualNetworkName, name, updateBastionHost, Context.NONE)
            .getValue();
        return this;
    }
    ...
    public BastionHost refresh() {
        this.innerObject = serviceManager.serviceClient().getBastionHosts()
            .getWithResponse(resourceGroupName, labName, virtualNetworkName, name, Context.NONE).getValue();
        return this;
    }

    public BastionHost refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getBastionHosts()
            .getWithResponse(resourceGroupName, labName, virtualNetworkName, name, context).getValue();
        return this;
    }
