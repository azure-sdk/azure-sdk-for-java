...
public final class ApplicableSchedulePropertiesInner {
    ...
    public EnableStatus statusNotificationSettingsStatus() {
        return this.innerLabVmsShutdown() == null ? null
     ...
     */
    public ApplicableSchedulePropertiesInner
        withTargetResourceIdLabVmsStartupTargetResourceId(String targetResourceId) {
        if (this.innerLabVmsStartup() == null) {
            this.innerLabVmsStartup = new ScheduleInner();
        }
     ...
     */
    public ApplicableSchedulePropertiesInner
        withTimeDailyRecurrenceTimeLabVmsStartupTimeDailyRecurrenceTime(String timeDailyRecurrenceTime) {
        if (this.innerLabVmsStartup() == null) {
            this.innerLabVmsStartup = new ScheduleInner();
        }
     ...
     */
    public ApplicableSchedulePropertiesInner
        withNotificationLocaleLabVmsStartupNotificationLocale(String notificationLocale) {
        if (this.innerLabVmsStartup() == null) {
            this.innerLabVmsStartup = new ScheduleInner();
        }
