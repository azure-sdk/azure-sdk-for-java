...
public final class ScheduleImpl implements Schedule, Schedule.Definition, Schedule.Update {
    ...
    public Schedule create() {
        this.innerObject = serviceManager.serviceClient().getGlobalSchedules()
    ...
    public Schedule apply() {
        this.innerObject = serviceManager.serviceClient().getGlobalSchedules()
            .updateWithResponse(resourceGroupName, name, updateSchedule, Context.NONE).getValue();
        return this;
    }

    public Schedule apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getGlobalSchedules()
            .updateWithResponse(resourceGroupName, name, updateSchedule, context).getValue();
        return this;
    }
