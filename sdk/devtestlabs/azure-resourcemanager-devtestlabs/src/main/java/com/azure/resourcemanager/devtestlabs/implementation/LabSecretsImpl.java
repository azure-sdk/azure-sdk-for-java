...
public final class LabSecretsImpl implements LabSecrets {
    ...
    public LabSecretsImpl(LabSecretsClient innerClient,
    ...
    public PagedIterable<LabSecret> list(String resourceGroupName, String labName, String filter, Integer top,
