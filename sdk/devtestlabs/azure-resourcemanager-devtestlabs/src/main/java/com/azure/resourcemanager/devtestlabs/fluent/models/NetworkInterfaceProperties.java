...
public final class NetworkInterfaceProperties {
    ...
    private SharedPublicIpAddressConfiguration innerSharedPublicIpAddressConfiguration;
    ...
    /**
     * Get the innerSharedPublicIpAddressConfiguration property: The configuration for sharing a public IP address
    ...
    public List<InboundNatRule> inboundNatRules() {
        return this.innerSharedPublicIpAddressConfiguration() == null
            ? null
            : this.innerSharedPublicIpAddressConfiguration().inboundNatRules();
    }
     ...
     * @return the NetworkInterfaceProperties object itself.
     */
    public NetworkInterfaceProperties withInboundNatRules(List<InboundNatRule> inboundNatRules) {
        if (this.innerSharedPublicIpAddressConfiguration() == null) {
            this.innerSharedPublicIpAddressConfiguration = new SharedPublicIpAddressConfiguration();
        }
