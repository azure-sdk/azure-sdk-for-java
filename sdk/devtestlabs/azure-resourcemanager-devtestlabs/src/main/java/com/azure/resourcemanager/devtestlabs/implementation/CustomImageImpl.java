...
public final class CustomImageImpl implements CustomImage, CustomImage.Definition, CustomImage.Update {
    ...
    public CustomImage create() {
        this.innerObject = serviceManager.serviceClient().getCustomImages().createOrUpdate(resourceGroupName, labName,
    ...
    public CustomImage apply() {
        this.innerObject = serviceManager.serviceClient().getCustomImages()
            .updateWithResponse(resourceGroupName, labName, name, updateCustomImage, Context.NONE).getValue();
        return this;
    }

    public CustomImage apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getCustomImages()
            .updateWithResponse(resourceGroupName, labName, name, updateCustomImage, context).getValue();
        return this;
    }
