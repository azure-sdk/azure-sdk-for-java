...
public final class LabVirtualMachineImpl
    ...
    public LabVirtualMachine create() {
        this.innerObject = serviceManager.serviceClient().getVirtualMachines().createOrUpdate(resourceGroupName,
            labName, name, this.innerModel(), Context.NONE);
        return this;
    }

    public LabVirtualMachine create(Context context) {
        this.innerObject = serviceManager.serviceClient().getVirtualMachines().createOrUpdate(resourceGroupName,
            labName, name, this.innerModel(), context);
        return this;
    }
    ...
    public LabVirtualMachine apply() {
        this.innerObject = serviceManager.serviceClient().getVirtualMachines()
            .updateWithResponse(resourceGroupName, labName, name, updateLabVirtualMachine, Context.NONE).getValue();
        return this;
    }

    public LabVirtualMachine apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getVirtualMachines()
            .updateWithResponse(resourceGroupName, labName, name, updateLabVirtualMachine, context).getValue();
        return this;
    }
    ...
    public Response<Void> clearArtifactResultsWithResponse(Context context) {
        return serviceManager.virtualMachines().clearArtifactResultsWithResponse(resourceGroupName, labName, name,
            context);
    }
    ...
    public Response<RdpConnection> getRdpFileContentsWithResponse(Context context) {
        return serviceManager.virtualMachines().getRdpFileContentsWithResponse(resourceGroupName, labName, name,
            context);
    }
    ...
    public Response<ApplicableSchedule> listApplicableSchedulesWithResponse(Context context) {
        return serviceManager.virtualMachines().listApplicableSchedulesWithResponse(resourceGroupName, labName, name,
            context);
    }
