...
public final class LabVirtualMachineImpl
    ...
    public LabVirtualMachineImpl withSecurityProfile(SecurityProfile securityProfile) {
    ...
    public LabVirtualMachineImpl withIdentity(IdentityProperties identity) {
        this.updateLabVirtualMachine.withIdentity(identity);
        return this;
    }
