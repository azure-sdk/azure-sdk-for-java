...
public final class LabSecretsClientImpl implements LabSecretsClient {
    ...
    public interface LabSecretsService {
        @Headers({ "Content-Type: application/json" })
        @Get("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DevTestLab/labs/{labName}/secrets")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<LabSecretList>> list(@HostParam("$host") String endpoint,
        ...
        @Headers({ "Content-Type: application/json" })
        @Get("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DevTestLab/labs/{labName}/secrets/{name}")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<LabSecretInner>> get(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("labName") String labName,
        ...
        @Headers({ "Content-Type: application/json" })
        @Put("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DevTestLab/labs/{labName}/secrets/{name}")
        ...
        Mono<Response<Flux<ByteBuffer>>> createOrUpdate(@HostParam("$host") String endpoint,
            ...
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("labName") String labName,
            @PathParam("name") String name, @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") LabSecretInner labSecret, @HeaderParam("Accept") String accept,
            Context context);

        @Headers({ "Content-Type: application/json" })
        @Delete("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DevTestLab/labs/{labName}/secrets/{name}")
        ...
        @Headers({ "Content-Type: application/json" })
        @Patch("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DevTestLab/labs/{labName}/secrets/{name}")
        @ExpectedResponses({ 201 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<LabSecretInner>> update(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("labName") String labName,
            @PathParam("name") String name, @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") SecretFragment secret, @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<LabSecretList>> listNext(@PathParam(value = "nextLink", encoded = true) String nextLink,
    ...
    private Mono<PagedResponse<LabSecretInner>> listSinglePageAsync(String resourceGroupName, String labName,
        ...
        return FluxUtil
            .withContext(context -> service.list(this.client.getEndpoint(), this.client.getSubscriptionId(),
                resourceGroupName, labName, filter, top, orderby, this.client.getApiVersion(), accept, context))
            .<PagedResponse<LabSecretInner>>map(res -> new PagedResponseBase<>(res.getRequest(), res.getStatusCode(),
    ...
    private Mono<PagedResponse<LabSecretInner>> listSinglePageAsync(String resourceGroupName, String labName,
        ...
        return service
            .list(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName, labName, filter, top,
    ...
    private PagedFlux<LabSecretInner> listAsync(String resourceGroupName, String labName, String filter, Integer top,
        String orderby) {
        return new PagedFlux<>(() -> listSinglePageAsync(resourceGroupName, labName, filter, top, orderby),
    ...
    private PagedFlux<LabSecretInner> listAsync(String resourceGroupName, String labName, String filter, Integer top,
        ...
        return new PagedFlux<>(() -> listSinglePageAsync(resourceGroupName, labName, filter, top, orderby, context),
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<LabSecretInner> list(String resourceGroupName, String labName, String filter, Integer top,
        String orderby, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<LabSecretInner> getWithResponse(String resourceGroupName, String labName, String name,
        Context context) {
    ...
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String resourceGroupName, String labName,
        String name, LabSecretInner labSecret) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return FluxUtil
            .withContext(context -> service.createOrUpdate(this.client.getEndpoint(), this.client.getSubscriptionId(),
                resourceGroupName, labName, name, this.client.getApiVersion(), labSecret, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String resourceGroupName, String labName,
        String name, LabSecretInner labSecret, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service.createOrUpdate(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            labName, name, this.client.getApiVersion(), labSecret, accept, context);
    }
    ...
    private PollerFlux<PollResult<LabSecretInner>, LabSecretInner> beginCreateOrUpdateAsync(String resourceGroupName,
        String labName, String name, LabSecretInner labSecret) {
        Mono<Response<Flux<ByteBuffer>>> mono
            = createOrUpdateWithResponseAsync(resourceGroupName, labName, name, labSecret);
        return this.client.<LabSecretInner, LabSecretInner>getLroResult(mono, this.client.getHttpPipeline(),
            LabSecretInner.class, LabSecretInner.class, this.client.getContext());
    }
    ...
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<LabSecretInner>, LabSecretInner> beginCreateOrUpdateAsync(String resourceGroupName,
        String labName, String name, LabSecretInner labSecret, Context context) {
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono
            = createOrUpdateWithResponseAsync(resourceGroupName, labName, name, labSecret, context);
        return this.client.<LabSecretInner, LabSecretInner>getLroResult(mono, this.client.getHttpPipeline(),
            LabSecretInner.class, LabSecretInner.class, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<LabSecretInner>, LabSecretInner> beginCreateOrUpdate(String resourceGroupName,
        String labName, String name, LabSecretInner labSecret) {
        return this.beginCreateOrUpdateAsync(resourceGroupName, labName, name, labSecret).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<LabSecretInner>, LabSecretInner> beginCreateOrUpdate(String resourceGroupName,
        String labName, String name, LabSecretInner labSecret, Context context) {
        return this.beginCreateOrUpdateAsync(resourceGroupName, labName, name, labSecret, context).getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<LabSecretInner> createOrUpdateAsync(String resourceGroupName, String labName, String name,
        LabSecretInner labSecret) {
        return beginCreateOrUpdateAsync(resourceGroupName, labName, name, labSecret).last()
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<LabSecretInner> createOrUpdateAsync(String resourceGroupName, String labName, String name,
        LabSecretInner labSecret, Context context) {
        return beginCreateOrUpdateAsync(resourceGroupName, labName, name, labSecret, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public LabSecretInner createOrUpdate(String resourceGroupName, String labName, String name,
        LabSecretInner labSecret) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<LabSecretInner>> updateWithResponseAsync(String resourceGroupName, String labName,
        String name, SecretFragment secret) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return FluxUtil
            .withContext(context -> service.update(this.client.getEndpoint(), this.client.getSubscriptionId(),
                resourceGroupName, labName, name, this.client.getApiVersion(), secret, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<LabSecretInner>> updateWithResponseAsync(String resourceGroupName, String labName,
        ...
        return service.update(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName, labName,
            name, this.client.getApiVersion(), secret, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<LabSecretInner> updateAsync(String resourceGroupName, String labName, String name,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<LabSecretInner> updateWithResponse(String resourceGroupName, String labName, String name,
    ...
    public LabSecretInner update(String resourceGroupName, String labName, String name, SecretFragment secret) {
        return updateWithResponse(resourceGroupName, labName, name, secret, Context.NONE).getValue();
    }
