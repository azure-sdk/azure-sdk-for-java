...
public final class LabSecretsClientImpl implements LabSecretsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<LabSecretInner>, LabSecretInner> beginUpdateAsync(
        String resourceGroupName, String labName, String name, SecretFragment secret) {
        Mono<Response<Flux<ByteBuffer>>> mono = updateWithResponseAsync(resourceGroupName, labName, name, secret);
        return this
            .client
            .<LabSecretInner, LabSecretInner>getLroResult(
                mono,
    ...
    private PollerFlux<PollResult<LabSecretInner>, LabSecretInner> beginUpdateAsync(
        ...
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono =
            updateWithResponseAsync(resourceGroupName, labName, name, secret, context);
        return this
            .client
            .<LabSecretInner, LabSecretInner>getLroResult(
                mono, this.client.getHttpPipeline(), LabSecretInner.class, LabSecretInner.class, context);
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<LabSecretInner>, LabSecretInner> beginUpdate(
        String resourceGroupName, String labName, String name, SecretFragment secret) {
        return this.beginUpdateAsync(resourceGroupName, labName, name, secret).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<LabSecretInner>, LabSecretInner> beginUpdate(
        String resourceGroupName, String labName, String name, SecretFragment secret, Context context) {
        return this.beginUpdateAsync(resourceGroupName, labName, name, secret, context).getSyncPoller();
    }
    ...
    private Mono<LabSecretInner> updateAsync(
        String resourceGroupName, String labName, String name, SecretFragment secret) {
        return beginUpdateAsync(resourceGroupName, labName, name, secret)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<LabSecretInner> updateAsync(
        String resourceGroupName, String labName, String name, SecretFragment secret, Context context) {
        return beginUpdateAsync(resourceGroupName, labName, name, secret, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public LabSecretInner update(
        String resourceGroupName, String labName, String name, SecretFragment secret, Context context) {
        return updateAsync(resourceGroupName, labName, name, secret, context).block();
    }
