...
public final class FormulaPropertiesInner {
    ...
    public SecurityProfile securityProfile() {
        return this.innerFormulaContent() == null ? null : this.innerFormulaContent().securityProfile();
    }
     ...
     * @return the FormulaPropertiesInner object itself.
     */
    public FormulaPropertiesInner withSecurityProfile(SecurityProfile securityProfile) {
        if (this.innerFormulaContent() == null) {
            this.innerFormulaContent = new LabVirtualMachineCreationParameterInner();
        }
        this.innerFormulaContent().withSecurityProfile(securityProfile);
        return this;
    }
