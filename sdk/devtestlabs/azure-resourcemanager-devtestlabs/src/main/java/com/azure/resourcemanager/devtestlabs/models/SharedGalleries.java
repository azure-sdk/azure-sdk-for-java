...
public interface SharedGalleries {
     ...
     */
    PagedIterable<SharedGallery> list(String resourceGroupName, String labName);
     ...
     * @return contains a list of sharedGalleries and their properties as paginated response with {@link PagedIterable}.
     */
    PagedIterable<SharedGallery> list(String resourceGroupName, String labName, String expand, String filter,
     ...
     */
    Response<SharedGallery> getWithResponse(String resourceGroupName, String labName, String name, String expand,
        Context context);
     ...
     */
    SharedGallery get(String resourceGroupName, String labName, String name);
     ...
     * @return shared gallery along with {@link Response}.
     */
    SharedGallery getById(String id);
     ...
     * @return shared gallery along with {@link Response}.
     */
    Response<SharedGallery> getByIdWithResponse(String id, String expand, Context context);
    ...
    /**
     * Begins definition for a new SharedGallery resource.
     * 
     * @param name resource name.
     * @return the first stage of the new SharedGallery definition.
     */
    SharedGallery.DefinitionStages.Blank define(String name);
}
