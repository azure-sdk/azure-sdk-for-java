...
public final class FormulasClientImpl implements FormulasClient {
    ...
    /**
     * The interface defining all the services for DevTestLabsClientFormulas to be used by the proxy service to perform
     * REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "DevTestLabsClientFor")
    private interface FormulasService {
    ...
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(
        ...
        if (formula == null) {
            return Mono.error(new IllegalArgumentException("Parameter formula is required and cannot be null."));
        } else {
            formula.validate();
        }
        final String accept = "application/json";
    ...
    public FormulaInner createOrUpdate(String resourceGroupName, String labName, String name, FormulaInner formula) {
        return createOrUpdateAsync(resourceGroupName, labName, name, formula).block();
    }
    ...
    public FormulaInner update(String resourceGroupName, String labName, String name, FormulaFragment formula) {
        return updateAsync(resourceGroupName, labName, name, formula).block();
    }
