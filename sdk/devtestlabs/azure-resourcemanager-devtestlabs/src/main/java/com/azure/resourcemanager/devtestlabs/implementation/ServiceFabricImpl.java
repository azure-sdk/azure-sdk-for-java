...
public final class ServiceFabricImpl implements ServiceFabric, ServiceFabric.Definition, ServiceFabric.Update {
    ...
    public ServiceFabric create() {
        this.innerObject = serviceManager.serviceClient().getServiceFabrics().createOrUpdate(resourceGroupName, labName,
    ...
    public ServiceFabric apply() {
        this.innerObject = serviceManager.serviceClient().getServiceFabrics()
    ...
    public ServiceFabric apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getServiceFabrics()
            .updateWithResponse(resourceGroupName, labName, username, name, updateServiceFabric, context).getValue();
        return this;
    }
    ...
    public Response<ApplicableSchedule> listApplicableSchedulesWithResponse(Context context) {
        return serviceManager.serviceFabrics().listApplicableSchedulesWithResponse(resourceGroupName, labName, username,
            name, context);
    }
