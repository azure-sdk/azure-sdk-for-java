...
public final class ServiceFabricSchedulesImpl implements ServiceFabricSchedules {
    ...
    public PagedIterable<Schedule> list(String resourceGroupName, String labName, String username,
        ...
        PagedIterable<ScheduleInner> inner = this.serviceClient().list(resourceGroupName, labName, username,
            serviceFabricName, expand, filter, top, orderby, context);
        return Utils.mapPage(inner, inner1 -> new ScheduleImpl(inner1, this.manager()));
    }
    ...
    public Response<Schedule> getWithResponse(String resourceGroupName, String labName, String username,
        ...
        Response<ScheduleInner> inner = this.serviceClient().getWithResponse(resourceGroupName, labName, username,
            serviceFabricName, name, expand, context);
        if (inner != null) {
    ...
    public Response<Schedule> createOrUpdateWithResponse(String resourceGroupName, String labName, String username,
        ...
        Response<ScheduleInner> inner = this.serviceClient().createOrUpdateWithResponse(resourceGroupName, labName,
            username, serviceFabricName, name, schedule, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
                new ScheduleImpl(inner.getValue(), this.manager()));
        } else {
    ...
    public Schedule createOrUpdate(String resourceGroupName, String labName, String username, String serviceFabricName,
        ...
        ScheduleInner inner = this.serviceClient().createOrUpdate(resourceGroupName, labName, username,
            serviceFabricName, name, schedule);
        if (inner != null) {
            return new ScheduleImpl(inner, this.manager());
        } else {
            return null;
    ...
    public Response<Void> deleteWithResponse(String resourceGroupName, String labName, String username,
        ...
        return this.serviceClient().deleteWithResponse(resourceGroupName, labName, username, serviceFabricName, name,
            context);
    }
    ...
    public Response<Schedule> updateWithResponse(String resourceGroupName, String labName, String username,
        ...
        Response<ScheduleInner> inner = this.serviceClient().updateWithResponse(resourceGroupName, labName, username,
            serviceFabricName, name, schedule, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
                new ScheduleImpl(inner.getValue(), this.manager()));
        } else {
