...
public final class FormulaImpl implements Formula, Formula.Definition, Formula.Update {
    ...
    public FormulaImpl withSecurityProfile(SecurityProfile securityProfile) {
    ...
    public FormulaImpl withIdentity(IdentityProperties identity) {
        this.updateFormula.withIdentity(identity);
        return this;
    }
