...
public final class FormulaImpl implements Formula, Formula.Definition, Formula.Update {
    ...
    public Formula create() {
        this.innerObject = serviceManager.serviceClient().getFormulas().createOrUpdate(resourceGroupName, labName, name,
    ...
    public Formula apply() {
        this.innerObject = serviceManager.serviceClient().getFormulas()
            .updateWithResponse(resourceGroupName, labName, name, updateFormula, Context.NONE).getValue();
        return this;
    }

    public Formula apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getFormulas()
            .updateWithResponse(resourceGroupName, labName, name, updateFormula, context).getValue();
        return this;
    }
