...
public final class LabImpl implements Lab, Lab.Definition, Lab.Update {
    ...
    public Lab create() {
        this.innerObject = serviceManager.serviceClient().getLabs().createOrUpdate(resourceGroupName, name,
    ...
    public Lab apply() {
        this.innerObject = serviceManager.serviceClient().getLabs()
            .updateWithResponse(resourceGroupName, name, updateLab, Context.NONE).getValue();
        return this;
    }

    public Lab apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getLabs()
            .updateWithResponse(resourceGroupName, name, updateLab, context).getValue();
        return this;
    }
    ...
    public Lab refresh() {
        ...
        this.innerObject = serviceManager.serviceClient().getLabs()
            .getByResourceGroupWithResponse(resourceGroupName, name, localExpand, Context.NONE).getValue();
        return this;
    }
    ...
    public Lab refresh(Context context) {
        String localExpand = null;
        this.innerObject = serviceManager.serviceClient().getLabs()
            .getByResourceGroupWithResponse(resourceGroupName, name, localExpand, context).getValue();
        return this;
    }
    ...
    public Response<GenerateUploadUriResponse>
        ...
        return serviceManager.labs().generateUploadUriWithResponse(resourceGroupName, name, generateUploadUriParameter,
            context);
    }
