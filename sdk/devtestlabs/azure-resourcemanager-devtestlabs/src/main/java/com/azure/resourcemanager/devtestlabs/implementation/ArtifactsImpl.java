...
public final class ArtifactsImpl implements Artifacts {
    ...
    public Response<Artifact> getWithResponse(String resourceGroupName, String labName, String artifactSourceName,
        ...
        Response<ArtifactInner> inner = this.serviceClient().getWithResponse(resourceGroupName, labName,
            artifactSourceName, name, expand, context);
        if (inner != null) {
    ...
    public Response<ArmTemplateInfo> generateArmTemplateWithResponse(String resourceGroupName, String labName,
        ...
        Context context) {
        Response<ArmTemplateInfoInner> inner = this.serviceClient().generateArmTemplateWithResponse(resourceGroupName,
            labName, artifactSourceName, name, generateArmTemplateRequest, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
    ...
    public ArmTemplateInfo generateArmTemplate(String resourceGroupName, String labName, String artifactSourceName,
        ...
        ArmTemplateInfoInner inner = this.serviceClient().generateArmTemplate(resourceGroupName, labName,
            artifactSourceName, name, generateArmTemplateRequest);
        if (inner != null) {
