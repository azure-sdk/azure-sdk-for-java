...
public final class LabsGenerateUploadUriSamples {
    /*
     * x-ms-original-file:
     * specification/devtestlabs/resource-manager/Microsoft.DevTestLab/stable/2021-09-01/examples/Labs_GenerateUploadUri
     * .json
     */
    /**
    ...
    public static void labsGenerateUploadUri(com.azure.resourcemanager.devtestlabs.DevTestLabsManager manager) {
        manager.labs().generateUploadUriWithResponse("resourceGroupName", "exampleLab",
