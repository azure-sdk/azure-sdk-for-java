...
public final class FormulasUpdateSamples {
    /*
     * x-ms-original-file:
     * specification/devtestlabs/resource-manager/Microsoft.DevTestLab/stable/2021-09-01/examples/Formulas_Update.json
     */
    /**
    ...
    public static void formulasUpdate(com.azure.resourcemanager.devtestlabs.DevTestLabsManager manager) {
        Formula resource = manager.formulas()
            .getWithResponse("resourceGroupName", "exampleLab", "{formulaName}", null, com.azure.core.util.Context.NONE)
            .getValue();
