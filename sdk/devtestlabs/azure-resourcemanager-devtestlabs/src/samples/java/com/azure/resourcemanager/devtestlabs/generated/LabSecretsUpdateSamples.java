...
public final class LabSecretsUpdateSamples {
    /*
     * x-ms-original-file:
     * specification/devtestlabs/resource-manager/Microsoft.DevTestLab/stable/2021-09-01/examples/LabSecrets_Update.json
     */
    /**
    ...
    public static void labSecretsUpdate(com.azure.resourcemanager.devtestlabs.DevTestLabsManager manager) {
        LabSecret resource = manager.labSecrets()
            .getWithResponse("resourceGroupName", "exampleLab", "{secretName}", com.azure.core.util.Context.NONE)
            .getValue();
