...
public final class ArtifactSourcesUpdateSamples {
    /*
     * x-ms-original-file:
     * specification/devtestlabs/resource-manager/Microsoft.DevTestLab/stable/2021-09-01/examples/ArtifactSources_Update
     * .json
     */
    /**
    ...
    public static void artifactSourcesUpdate(com.azure.resourcemanager.devtestlabs.DevTestLabsManager manager) {
        ArtifactSource resource = manager.artifactSources().getWithResponse("resourceGroupName", "exampleLab",
            "artifactSourceName", null, com.azure.core.util.Context.NONE).getValue();
