...
public final class VirtualMachinesStartSamples {
    /*
     * x-ms-original-file:
     * specification/devtestlabs/resource-manager/Microsoft.DevTestLab/stable/2021-09-01/examples/VirtualMachines_Start.
     * json
     */
    /**
    ...
    public static void virtualMachinesStart(com.azure.resourcemanager.devtestlabs.DevTestLabsManager manager) {
        manager.virtualMachines().start("resourceGroupName", "exampleLab", "vmName001",
