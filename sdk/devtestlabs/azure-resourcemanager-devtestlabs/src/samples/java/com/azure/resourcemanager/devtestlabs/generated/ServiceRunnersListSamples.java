...
public final class ServiceRunnersListSamples {
    /*
     * x-ms-original-file:
     * specification/devtestlabs/resource-manager/Microsoft.DevTestLab/stable/2021-09-01/examples/ServiceRunners_List.
     * json
     */
    /**
    ...
    public static void serviceRunnersList(com.azure.resourcemanager.devtestlabs.DevTestLabsManager manager) {
        manager.serviceRunners().list("resourceGroupName", "exampleLab", null, null, null,
