...
public final class SharedImagesUpdateSamples {
    /*
     * x-ms-original-file:
     * specification/devtestlabs/resource-manager/Microsoft.DevTestLab/stable/2021-09-01/examples/SharedImages_Update.
     * json
     */
    /**
    ...
    public static void sharedImagesUpdate(com.azure.resourcemanager.devtestlabs.DevTestLabsManager manager) {
        SharedImage resource = manager.sharedImages().getWithResponse("resourceGroupName", "exampleLab",
            "{sharedGalleryName}", "{name}", null, com.azure.core.util.Context.NONE).getValue();
