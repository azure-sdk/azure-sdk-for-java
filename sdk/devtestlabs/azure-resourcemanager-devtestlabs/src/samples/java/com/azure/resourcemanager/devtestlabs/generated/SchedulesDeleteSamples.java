...
public final class SchedulesDeleteSamples {
    /*
     * x-ms-original-file:
     * specification/devtestlabs/resource-manager/Microsoft.DevTestLab/stable/2021-09-01/examples/Schedules_Delete.json
     */
    /**
    ...
    public static void schedulesDelete(com.azure.resourcemanager.devtestlabs.DevTestLabsManager manager) {
        manager.schedules().deleteWithResponse("resourceGroupName", "exampleLab", "{scheduleName}",
