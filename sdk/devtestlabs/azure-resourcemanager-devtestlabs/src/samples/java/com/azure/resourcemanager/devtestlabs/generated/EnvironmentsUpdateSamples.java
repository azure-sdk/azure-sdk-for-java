...
public final class EnvironmentsUpdateSamples {
    /*
     * x-ms-original-file:
     * specification/devtestlabs/resource-manager/Microsoft.DevTestLab/stable/2021-09-01/examples/Environments_Update.
     * json
     */
    /**
    ...
    public static void environmentsUpdate(com.azure.resourcemanager.devtestlabs.DevTestLabsManager manager) {
        DtlEnvironment resource = manager.environments().getWithResponse("resourceGroupName", "exampleLab", "@me",
