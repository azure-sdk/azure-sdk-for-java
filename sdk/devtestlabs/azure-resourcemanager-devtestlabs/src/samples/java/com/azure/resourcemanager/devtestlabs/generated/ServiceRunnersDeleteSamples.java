...
public final class ServiceRunnersDeleteSamples {
    /*
     * x-ms-original-file:
     * specification/devtestlabs/resource-manager/Microsoft.DevTestLab/stable/2021-09-01/examples/ServiceRunners_Delete.
     * json
     */
    /**
    ...
    public static void serviceRunnersDelete(com.azure.resourcemanager.devtestlabs.DevTestLabsManager manager) {
        manager.serviceRunners().delete("resourceGroupName", "exampleLab", "{servicerunnerName}",
