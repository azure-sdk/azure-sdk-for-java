...
public final class FormulasCreateOrUpdateSamples {
    ...
    public static void formulasCreateOrUpdate(com.azure.resourcemanager.devtestlabs.DevTestLabsManager manager) {
        manager.formulas().define("{formulaName}").withRegion("westcentralus")
            .withExistingLab("resourceGroupName", "exampleLab").withDescription("Formula using a Linux base")
            .withLocationPropertiesLocation("westcentralus").withNotes("Ubuntu Server 20.10").withSize("Standard_B1ms")
            .withUsername("user").withIsAuthenticationWithSshKey(false).withLabSubnetName("DtlexampleLabSubnet")
            .withLabVirtualNetworkId("/virtualnetworks/dtlexampleLab").withDisallowPublicIpAddress(true)
            ...
            .withAllowClaim(false).withStorageType(StorageType.STANDARD).withOffer("0001-com-ubuntu-server-groovy")
            .withPublisher("canonical").withSku("20_10").withOsTypeGalleryImageReferenceOsType("Linux")
            .withVersion("latest")
            .withInboundNatRules(
