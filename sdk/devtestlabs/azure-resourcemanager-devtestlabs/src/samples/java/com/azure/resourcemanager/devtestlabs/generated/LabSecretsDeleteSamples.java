...
public final class LabSecretsDeleteSamples {
    /*
     * x-ms-original-file:
     * specification/devtestlabs/resource-manager/Microsoft.DevTestLab/stable/2021-09-01/examples/LabSecrets_Delete.json
     */
    /**
    ...
    public static void labSecretsDelete(com.azure.resourcemanager.devtestlabs.DevTestLabsManager manager) {
        manager.labSecrets().delete("resourceGroupName", "exampleLab", "{secretName}",
