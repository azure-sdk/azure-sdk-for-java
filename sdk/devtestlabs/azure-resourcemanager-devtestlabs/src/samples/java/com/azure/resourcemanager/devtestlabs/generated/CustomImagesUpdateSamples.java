...
public final class CustomImagesUpdateSamples {
    /*
     * x-ms-original-file:
     * specification/devtestlabs/resource-manager/Microsoft.DevTestLab/stable/2021-09-01/examples/CustomImages_Update.
     * json
     */
    /**
    ...
    public static void customImagesUpdate(com.azure.resourcemanager.devtestlabs.DevTestLabsManager manager) {
        CustomImage resource = manager.customImages().getWithResponse("resourceGroupName", "exampleLab",
