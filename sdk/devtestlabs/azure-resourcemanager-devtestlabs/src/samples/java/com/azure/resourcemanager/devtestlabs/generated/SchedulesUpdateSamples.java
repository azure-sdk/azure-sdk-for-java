...
public final class SchedulesUpdateSamples {
    /*
     * x-ms-original-file:
     * specification/devtestlabs/resource-manager/Microsoft.DevTestLab/stable/2021-09-01/examples/Schedules_Update.json
     */
    /**
    ...
    public static void schedulesUpdate(com.azure.resourcemanager.devtestlabs.DevTestLabsManager manager) {
        manager.schedules().updateWithResponse("resourceGroupName", "exampleLab", "{scheduleName}",
