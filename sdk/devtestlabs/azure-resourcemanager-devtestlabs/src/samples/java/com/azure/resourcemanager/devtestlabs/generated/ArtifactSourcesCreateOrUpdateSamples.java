...
public final class ArtifactSourcesCreateOrUpdateSamples {
    ...
    public static void artifactSourcesCreateOrUpdate(com.azure.resourcemanager.devtestlabs.DevTestLabsManager manager) {
        manager.artifactSources().define("artifactSourceName").withRegion("westcentralus")
            ...
            .withSourceType(SourceControlType.fromString("{sourceType}")).withFolderPath("{folderPath}")
            .withArmTemplateFolderPath("{armTemplateFolderPath}").withBranchRef("{branchRef}")
            .withSecurityToken("{securityToken}").withStatus(EnableStatus.fromString("{status}")).create();
    }
