...
public final class VirtualNetworksListSamples {
    /*
     * x-ms-original-file:
     * specification/devtestlabs/resource-manager/Microsoft.DevTestLab/stable/2021-09-01/examples/VirtualNetworks_List.
     * json
     */
    /**
    ...
    public static void virtualNetworksList(com.azure.resourcemanager.devtestlabs.DevTestLabsManager manager) {
        manager.virtualNetworks().list("resourceGroupName", "exampleLab", null, null, null, null,
