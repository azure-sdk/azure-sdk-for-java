...
public final class PoliciesUpdateSamples {
    /*
     * x-ms-original-file:
     * specification/devtestlabs/resource-manager/Microsoft.DevTestLab/stable/2021-09-01/examples/Policies_Update.json
     */
    /**
    ...
    public static void policiesUpdate(com.azure.resourcemanager.devtestlabs.DevTestLabsManager manager) {
        Policy resource = manager.policies().getWithResponse("resourceGroupName", "exampleLab", "{policySetName}",
