...
public final class VirtualMachinesUpdateSamples {
    /*
     * x-ms-original-file:
     * specification/devtestlabs/resource-manager/Microsoft.DevTestLab/stable/2021-09-01/examples/VirtualMachines_Update
     * .json
     */
    /**
    ...
    public static void virtualMachinesUpdate(com.azure.resourcemanager.devtestlabs.DevTestLabsManager manager) {
        LabVirtualMachine resource = manager.virtualMachines()
            .getWithResponse("resourceGroupName", "exampleLab", "vmName001", null, com.azure.core.util.Context.NONE)
            .getValue();
