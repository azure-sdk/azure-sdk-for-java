...
public final class CostsCreateOrUpdateSamples {
    /*
     * x-ms-original-file:
     * specification/devtestlabs/resource-manager/Microsoft.DevTestLab/stable/2021-09-01/examples/Costs_CreateOrUpdate.
     * json
     */
    /**
    ...
    public static void costsCreateOrUpdate(com.azure.resourcemanager.devtestlabs.DevTestLabsManager manager) {
        manager.costs().define("targetCost").withRegion((String) null)
            .withExistingLab("resourceGroupName", "exampleLab").withCurrencyCode("USD")
            .withStartDateTime(OffsetDateTime.parse("2020-12-01T00:00:00Z"))
            .withEndDateTime(OffsetDateTime.parse("2020-12-31T23:59:59Z")).withStatus(TargetCostStatus.ENABLED)
            .withTarget(100)
            .withCostThresholds(Arrays.asList(
                new CostThresholdProperties().withThresholdId("00000000-0000-0000-0000-000000000001")
                    ...
                    .withSendNotificationWhenExceeded(CostThresholdStatus.DISABLED).withThresholdValue(25.0D),
                new CostThresholdProperties().withThresholdId("00000000-0000-0000-0000-000000000002")
                    ...
                    .withSendNotificationWhenExceeded(CostThresholdStatus.ENABLED).withThresholdValue(50.0D),
                new CostThresholdProperties().withThresholdId("00000000-0000-0000-0000-000000000003")
                    .withDisplayOnChart(CostThresholdStatus.DISABLED)
                    .withSendNotificationWhenExceeded(CostThresholdStatus.DISABLED).withThresholdValue(75.0D),
                new CostThresholdProperties().withThresholdId("00000000-0000-0000-0000-000000000004")
                    .withDisplayOnChart(CostThresholdStatus.DISABLED)
                    .withSendNotificationWhenExceeded(CostThresholdStatus.DISABLED).withThresholdValue(100.0D),
                new CostThresholdProperties().withThresholdId("00000000-0000-0000-0000-000000000005")
                    .withDisplayOnChart(CostThresholdStatus.DISABLED)
                    .withSendNotificationWhenExceeded(CostThresholdStatus.DISABLED).withThresholdValue(125.0D)))
            ...
            .withCycleType(ReportingCycleType.CALENDAR_MONTH).create();
    }
}
