...
public final class VirtualNetworksDeleteSamples {
    /*
     * x-ms-original-file:
     * specification/devtestlabs/resource-manager/Microsoft.DevTestLab/stable/2021-09-01/examples/VirtualNetworks_Delete
     * .json
     */
    /**
    ...
    public static void virtualNetworksDelete(com.azure.resourcemanager.devtestlabs.DevTestLabsManager manager) {
        manager.virtualNetworks().delete("resourceGroupName", "exampleLab", "dtlexampleLab",
