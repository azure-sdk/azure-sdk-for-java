...
public final class SharedGalleriesUpdateSamples {
    /*
     * x-ms-original-file:
     * specification/devtestlabs/resource-manager/Microsoft.DevTestLab/stable/2021-09-01/examples/SharedGalleries_Update
     * .json
     */
    /**
    ...
    public static void sharedGalleriesUpdate(com.azure.resourcemanager.devtestlabs.DevTestLabsManager manager) {
        SharedGallery resource = manager.sharedGalleries().getWithResponse("resourceGroupName", "exampleLab",
            "{sharedGalleryName}", null, com.azure.core.util.Context.NONE).getValue();
