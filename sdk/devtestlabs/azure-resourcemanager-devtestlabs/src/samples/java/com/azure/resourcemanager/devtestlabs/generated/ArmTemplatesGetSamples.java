...
public final class ArmTemplatesGetSamples {
    /*
     * x-ms-original-file:
     * specification/devtestlabs/resource-manager/Microsoft.DevTestLab/stable/2021-09-01/examples/ArmTemplates_Get.json
     */
    /**
    ...
    public static void armTemplatesGet(com.azure.resourcemanager.devtestlabs.DevTestLabsManager manager) {
        manager.armTemplates().getWithResponse("resourceGroupName", "exampleLab", "artifactSourceName",
