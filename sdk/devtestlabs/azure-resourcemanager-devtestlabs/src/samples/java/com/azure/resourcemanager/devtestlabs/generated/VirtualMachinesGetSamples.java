...
public final class VirtualMachinesGetSamples {
    /*
     * x-ms-original-file:
     * specification/devtestlabs/resource-manager/Microsoft.DevTestLab/stable/2021-09-01/examples/VirtualMachines_Get.
     * json
     */
    /**
    ...
    public static void virtualMachinesGet(com.azure.resourcemanager.devtestlabs.DevTestLabsManager manager) {
        manager.virtualMachines().getWithResponse("resourceGroupName", "exampleLab", "vmName001", null,
