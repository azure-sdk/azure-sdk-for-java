...
public final class VirtualMachinesListSamples {
    /*
     * x-ms-original-file:
     * specification/devtestlabs/resource-manager/Microsoft.DevTestLab/stable/2021-09-01/examples/VirtualMachines_List.
     * json
     */
    /**
    ...
    public static void virtualMachinesList(com.azure.resourcemanager.devtestlabs.DevTestLabsManager manager) {
        manager.virtualMachines().list("resourceGroupName", "exampleLab", null, null, null, null,
