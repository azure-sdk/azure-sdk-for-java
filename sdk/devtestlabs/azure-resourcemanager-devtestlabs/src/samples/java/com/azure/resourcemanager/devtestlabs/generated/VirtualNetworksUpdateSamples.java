...
public final class VirtualNetworksUpdateSamples {
    /*
     * x-ms-original-file:
     * specification/devtestlabs/resource-manager/Microsoft.DevTestLab/stable/2021-09-01/examples/VirtualNetworks_Update
     * .json
     */
    /**
    ...
    public static void virtualNetworksUpdate(com.azure.resourcemanager.devtestlabs.DevTestLabsManager manager) {
        VirtualNetwork resource = manager.virtualNetworks()
            .getWithResponse("resourceGroupName", "exampleLab", "dtlexampleLab", null, com.azure.core.util.Context.NONE)
            .getValue();
