...
public final class BastionHostsDeleteSamples {
    /*
     * x-ms-original-file:
     * specification/devtestlabs/resource-manager/Microsoft.DevTestLab/stable/2021-09-01/examples/BastionHosts_Delete.
     * json
     */
    /**
    ...
    public static void bastionHostsDelete(com.azure.resourcemanager.devtestlabs.DevTestLabsManager manager) {
        manager.bastionHosts().delete("resourceGroupName", "exampleLab", "dtlexampleLab", "{bastionHostName}",
