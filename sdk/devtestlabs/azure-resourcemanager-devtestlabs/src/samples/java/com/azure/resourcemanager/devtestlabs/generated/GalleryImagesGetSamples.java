...
public final class GalleryImagesGetSamples {
    /*
     * x-ms-original-file:
     * specification/devtestlabs/resource-manager/Microsoft.DevTestLab/stable/2021-09-01/examples/GalleryImages_Get.json
     */
    /**
    ...
    public static void galleryImagesGet(com.azure.resourcemanager.devtestlabs.DevTestLabsManager manager) {
        manager.galleryImages().getWithResponse("resourceGroupName", "exampleLab", "{name}",
