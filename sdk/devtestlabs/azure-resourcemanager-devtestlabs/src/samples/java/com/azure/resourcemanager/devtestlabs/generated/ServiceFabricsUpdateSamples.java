...
public final class ServiceFabricsUpdateSamples {
    /*
     * x-ms-original-file:
     * specification/devtestlabs/resource-manager/Microsoft.DevTestLab/stable/2021-09-01/examples/ServiceFabrics_Update.
     * json
     */
    /**
    ...
    public static void serviceFabricsUpdate(com.azure.resourcemanager.devtestlabs.DevTestLabsManager manager) {
        ServiceFabric resource = manager.serviceFabrics().getWithResponse("resourceGroupName", "exampleLab",
            "UserName001", "serviceFabricName", null, com.azure.core.util.Context.NONE).getValue();
