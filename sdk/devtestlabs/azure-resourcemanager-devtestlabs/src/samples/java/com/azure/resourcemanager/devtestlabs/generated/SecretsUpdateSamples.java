...
public final class SecretsUpdateSamples {
    /*
     * x-ms-original-file:
     * specification/devtestlabs/resource-manager/Microsoft.DevTestLab/stable/2021-09-01/examples/Secrets_Update.json
     */
    /**
    ...
    public static void secretsUpdate(com.azure.resourcemanager.devtestlabs.DevTestLabsManager manager) {
        Secret resource = manager.secrets().getWithResponse("resourceGroupName", "exampleLab", "UserName001",
            "{secretName}", null, com.azure.core.util.Context.NONE).getValue();
