...
public final class BastionHostsUpdateSamples {
    /*
     * x-ms-original-file:
     * specification/devtestlabs/resource-manager/Microsoft.DevTestLab/stable/2021-09-01/examples/BastionHosts_Update.
     * json
     */
    /**
    ...
    public static void bastionHostsUpdate(com.azure.resourcemanager.devtestlabs.DevTestLabsManager manager) {
        BastionHost resource = manager.bastionHosts().getWithResponse("resourceGroupName", "exampleLab",
            "dtlexampleLab", "{bastionHostName}", com.azure.core.util.Context.NONE).getValue();
