...
public final class CustomImagesDeleteSamples {
    /*
     * x-ms-original-file:
     * specification/devtestlabs/resource-manager/Microsoft.DevTestLab/stable/2021-09-01/examples/CustomImages_Delete.
     * json
     */
    /**
    ...
    public static void customImagesDelete(com.azure.resourcemanager.devtestlabs.DevTestLabsManager manager) {
        manager.customImages().delete("resourceGroupName", "exampleLab", "customImageName",
