...
public final class ArtifactSourcesDeleteSamples {
    /*
     * x-ms-original-file:
     * specification/devtestlabs/resource-manager/Microsoft.DevTestLab/stable/2021-09-01/examples/ArtifactSources_Delete
     * .json
     */
    /**
    ...
    public static void artifactSourcesDelete(com.azure.resourcemanager.devtestlabs.DevTestLabsManager manager) {
        manager.artifactSources().deleteWithResponse("resourceGroupName", "exampleLab", "artifactSourceName",
