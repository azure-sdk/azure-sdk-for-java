...
public final class GlobalSchedulesUpdateSamples {
    /*
     * x-ms-original-file:
     * specification/devtestlabs/resource-manager/Microsoft.DevTestLab/stable/2021-09-01/examples/GlobalSchedules_Update
     * .json
     */
    /**
    ...
    public static void globalSchedulesUpdate(com.azure.resourcemanager.devtestlabs.DevTestLabsManager manager) {
        Schedule resource = manager.globalSchedules().getByResourceGroupWithResponse("resourceGroupName",
            "labvmautostart", null, com.azure.core.util.Context.NONE).getValue();
