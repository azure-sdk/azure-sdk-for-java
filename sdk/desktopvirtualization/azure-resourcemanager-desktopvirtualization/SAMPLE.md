...
public final class ActiveSessionHostConfigurationsGetSamples {
    /*
     * x-ms-original-file:
     * specification/desktopvirtualization/resource-manager/Microsoft.DesktopVirtualization/preview/2024-04-08-preview/
...
public final class SessionHostConfigurationsCreateOrUpdateSamples {
    ...
    public static void sessionHostConfigurationsCreate(
        ...
        manager.sessionHostConfigurations()
            .createOrUpdateWithResponse("resourceGroup1", "hostPool1", new SessionHostConfigurationInner()
