...
public interface ScalingPlans {
     ...
     * @return list of scaling plan definitions as paginated response with {@link PagedIterable}.
     */
    PagedIterable<ScalingPlan> listByResourceGroup(String resourceGroupName, Integer pageSize, Boolean isDescending,
     ...
     */
    Response<ScalingPlan> getByResourceGroupWithResponse(String resourceGroupName, String scalingPlanName,
        Context context);
