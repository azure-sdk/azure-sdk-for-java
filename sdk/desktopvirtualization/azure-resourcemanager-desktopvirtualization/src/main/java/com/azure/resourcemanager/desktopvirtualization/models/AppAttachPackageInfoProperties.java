...
public final class AppAttachPackageInfoProperties {
     ...
     */
    @JsonProperty(value = "isPackageTimestamped")
    ...
    /**
     * Get the packageFullName property: Identifier including the package version, for Msix packages it is the full
     * name from the appxmanifest.xml.
     * 
    ...
    /**
     * Set the packageFullName property: Identifier including the package version, for Msix packages it is the full
     * name from the appxmanifest.xml.
     * 
