...
public final class SessionHostManagementOperationStatusImpl implements SessionHostManagementOperationStatus {
    ...
    SessionHostManagementOperationStatusImpl(
        SessionHostManagementOperationStatusInner innerObject,
        ...
        if (inner != null) {
            return Collections
                .unmodifiableList(
                    inner
                        .stream()
                        .map(inner1 -> new SessionHostManagementOperationStatusImpl(inner1, this.manager()))
