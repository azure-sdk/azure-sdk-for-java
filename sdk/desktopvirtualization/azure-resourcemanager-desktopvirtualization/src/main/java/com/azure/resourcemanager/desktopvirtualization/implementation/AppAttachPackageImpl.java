...
public final class AppAttachPackageImpl
    ...
    public AppAttachPackage create() {
        this.innerObject = serviceManager.serviceClient().getAppAttachPackages()
    ...
    public AppAttachPackage create(Context context) {
        this.innerObject = serviceManager.serviceClient().getAppAttachPackages()
            .createOrUpdateWithResponse(resourceGroupName, appAttachPackageName, this.innerModel(), context).getValue();
        return this;
    }
    ...
    AppAttachPackageImpl(AppAttachPackageInner innerObject,
        ...
        this.appAttachPackageName = Utils.getValueFromIdByName(innerObject.id(), "appAttachPackages");
    }

    public AppAttachPackage refresh() {
        this.innerObject = serviceManager.serviceClient().getAppAttachPackages()
            .getByResourceGroupWithResponse(resourceGroupName, appAttachPackageName, Context.NONE).getValue();
        return this;
    }

    public AppAttachPackage refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getAppAttachPackages()
            .getByResourceGroupWithResponse(resourceGroupName, appAttachPackageName, context).getValue();
        return this;
    }
    ...
    public AppAttachPackageImpl withManagedBy(String managedBy) {
        this.innerModel().withManagedBy(managedBy);
        return this;
    }

    public AppAttachPackageImpl withKind(String kind) {
        this.innerModel().withKind(kind);
        return this;
    }

    public AppAttachPackageImpl withIdentity(ResourceModelWithAllowedPropertySetIdentity identity) {
        this.innerModel().withIdentity(identity);
        return this;
    }

    public AppAttachPackageImpl withSku(ResourceModelWithAllowedPropertySetSku sku) {
        this.innerModel().withSku(sku);
        return this;
    }

    public AppAttachPackageImpl withPlan(ResourceModelWithAllowedPropertySetPlan plan) {
