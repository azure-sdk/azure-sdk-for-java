...
public final class SessionHostManagementsOperationStatusClientImpl
    ...
    SessionHostManagementsOperationStatusClientImpl(DesktopVirtualizationApiClientImpl client) {
        this.service =
            RestProxy
                .create(
                    SessionHostManagementsOperationStatusService.class,
    ...
    public interface SessionHostManagementsOperationStatusService {
        ...
        @Get(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DesktopVirtualization/hostPools/{hostPoolName}/sessionHostManagements/default/operationStatuses/{operationId}")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<SessionHostManagementOperationStatusInner>> get(
        ...
        @Headers({"Content-Type: application/json"})
        @Get(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DesktopVirtualization/hostPools/{hostPoolName}/sessionHostManagements/default/operationStatuses")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<SessionHostManagementOperationStatusList>> list(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            ...
            @QueryParam("isInitiatingOperation") Boolean isInitiatingOperation,
            @HeaderParam("Accept") String accept,
            Context context);
    ...
    public Mono<Response<SessionHostManagementOperationStatusInner>> getWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<SessionHostManagementOperationStatusInner>> getWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<SessionHostManagementOperationStatusInner> getAsync(
        String resourceGroupName, String hostPoolName, String operationId) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<SessionHostManagementOperationStatusInner> getWithResponse(
        String resourceGroupName, String hostPoolName, String operationId, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public SessionHostManagementOperationStatusInner get(
        String resourceGroupName, String hostPoolName, String operationId) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<SessionHostManagementOperationStatusInner>> listSinglePageAsync(
    ...
    public PagedFlux<SessionHostManagementOperationStatusInner> listAsync(
        String resourceGroupName,
        String hostPoolName,
        Boolean isLatest,
        String type,
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<SessionHostManagementOperationStatusInner> listAsync(
        String resourceGroupName,
        String hostPoolName,
        Boolean isLatest,
        String type,
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<SessionHostManagementOperationStatusInner> list(
        String resourceGroupName, String hostPoolName) {
        final Boolean isLatest = null;
        final String type = null;
        final Boolean isNonTerminal = null;
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<SessionHostManagementOperationStatusInner>> listNextSinglePageAsync(
