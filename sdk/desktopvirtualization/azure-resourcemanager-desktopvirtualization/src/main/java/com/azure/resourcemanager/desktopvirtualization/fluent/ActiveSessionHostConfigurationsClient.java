...
public interface ActiveSessionHostConfigurationsClient {
    ...
    Mono<Response<ActiveSessionHostConfigurationInner>> getWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<ActiveSessionHostConfigurationInner> getWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<ActiveSessionHostConfigurationInner> listByHostPool(
        String resourceGroupName, String hostPoolName, Context context);
}
