...
public final class ApplicationGroupImpl
    ...
    public ApplicationGroup create(Context context) {
        this.innerObject = serviceManager.serviceClient().getApplicationGroups()
            .createOrUpdateWithResponse(resourceGroupName, applicationGroupName, this.innerModel(), context).getValue();
        return this;
    }
    ...
    public ApplicationGroup apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getApplicationGroups()
            .updateWithResponse(resourceGroupName, applicationGroupName, updateApplicationGroup, context).getValue();
        return this;
    }
    ...
    public ApplicationGroup refresh() {
        this.innerObject = serviceManager.serviceClient().getApplicationGroups()
            .getByResourceGroupWithResponse(resourceGroupName, applicationGroupName, Context.NONE).getValue();
        return this;
    }

    public ApplicationGroup refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getApplicationGroups()
            .getByResourceGroupWithResponse(resourceGroupName, applicationGroupName, context).getValue();
        return this;
    }
