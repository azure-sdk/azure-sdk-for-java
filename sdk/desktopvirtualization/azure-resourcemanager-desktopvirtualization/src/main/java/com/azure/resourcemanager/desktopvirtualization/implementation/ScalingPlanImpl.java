...
public final class ScalingPlanImpl implements ScalingPlan, ScalingPlan.Definition, ScalingPlan.Update {
    ...
    public List<ScalingPlanPooledScheduleProperties> schedules() {
        List<ScalingPlanPooledScheduleProperties> inner = this.innerModel().schedules();
        if (inner != null) {
    ...
    public ScalingPlanImpl withSchedules(List<ScalingPlanPooledScheduleProperties> schedules) {
        if (isInCreateMode()) {
