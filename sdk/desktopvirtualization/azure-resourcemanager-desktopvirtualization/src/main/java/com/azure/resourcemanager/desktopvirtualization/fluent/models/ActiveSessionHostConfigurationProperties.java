...
public final class ActiveSessionHostConfigurationProperties {
     ...
     * @return the ActiveSessionHostConfigurationProperties object itself.
     */
    public ActiveSessionHostConfigurationProperties withCustomConfigurationScriptUrl(
     ...
     * @return the ActiveSessionHostConfigurationProperties object itself.
     */
    public ActiveSessionHostConfigurationProperties withVmAdminCredentials(
     ...
     * @return the ActiveSessionHostConfigurationProperties object itself.
     */
    public ActiveSessionHostConfigurationProperties withBootDiagnosticsInfo(
    ...
    public void validate() {
        ...
        if (vmAdminCredentials() == null) {
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException(
                        "Missing required property vmAdminCredentials in model"
