...
public final class SessionHostManagementsClientImpl implements SessionHostManagementsClient {
    ...
    SessionHostManagementsClientImpl(DesktopVirtualizationApiClientImpl client) {
        this.service =
            RestProxy
                .create(SessionHostManagementsService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }
    ...
    public interface SessionHostManagementsService {
        ...
        Mono<Response<SessionHostManagementInner>> get(
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<SessionHostManagementInner>> createOrUpdate(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<SessionHostManagementInner>> update(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<SessionHostManagementList>> listByHostPool(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
    ...
    public Mono<Response<SessionHostManagementInner>> getWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<SessionHostManagementInner>> getWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<SessionHostManagementInner> getWithResponse(
        String resourceGroupName, String hostPoolName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<SessionHostManagementInner>> createOrUpdateWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<SessionHostManagementInner>> createOrUpdateWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<SessionHostManagementInner> createOrUpdateAsync(
        String resourceGroupName, String hostPoolName, SessionHostManagementInner sessionHostManagement) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<SessionHostManagementInner> createOrUpdateWithResponse(
        String resourceGroupName,
        String hostPoolName,
        SessionHostManagementInner sessionHostManagement,
        Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public SessionHostManagementInner createOrUpdate(
        String resourceGroupName, String hostPoolName, SessionHostManagementInner sessionHostManagement) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<SessionHostManagementInner>> updateWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<SessionHostManagementInner>> updateWithResponseAsync(
        String resourceGroupName,
        String hostPoolName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<SessionHostManagementInner> updateWithResponse(
        String resourceGroupName,
        String hostPoolName,
        SessionHostManagementPatch sessionHostManagement,
        Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<SessionHostManagementInner>> listByHostPoolSinglePageAsync(
        String resourceGroupName, String hostPoolName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                ...
                context ->
                    service
                        .listByHostPool(
                            ...
                            accept,
                            context))
            .<PagedResponse<SessionHostManagementInner>>map(
                res ->
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<SessionHostManagementInner> listByHostPoolAsync(
        String resourceGroupName, String hostPoolName, Context context) {
        return new PagedFlux<>(
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<SessionHostManagementInner> listByHostPool(
        String resourceGroupName, String hostPoolName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<SessionHostManagementInner>> listByHostPoolNextSinglePageAsync(
