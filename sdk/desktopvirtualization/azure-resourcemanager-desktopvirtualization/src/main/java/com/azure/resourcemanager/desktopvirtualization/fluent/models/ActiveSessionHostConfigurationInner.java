...
public final class ActiveSessionHostConfigurationInner extends ProxyResource {
    ...
    private ActiveSessionHostConfigurationProperties innerProperties = new ActiveSessionHostConfigurationProperties();
    ...
    public ActiveSessionHostConfigurationInner() {
    }
     ...
     * @return the ActiveSessionHostConfigurationInner object itself.
     */
    public ActiveSessionHostConfigurationInner withFriendlyName(String friendlyName) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ActiveSessionHostConfigurationProperties();
        }
     ...
     * @return the ActiveSessionHostConfigurationInner object itself.
     */
    public ActiveSessionHostConfigurationInner withVmTags(Map<String, String> vmTags) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ActiveSessionHostConfigurationProperties();
        }
     ...
     * @return the ActiveSessionHostConfigurationInner object itself.
     */
    public ActiveSessionHostConfigurationInner withVmLocation(String vmLocation) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ActiveSessionHostConfigurationProperties();
        }
     ...
     * @return the ActiveSessionHostConfigurationInner object itself.
     */
    public ActiveSessionHostConfigurationInner withVmResourceGroup(String vmResourceGroup) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ActiveSessionHostConfigurationProperties();
        }
     ...
     * @return the ActiveSessionHostConfigurationInner object itself.
     */
    public ActiveSessionHostConfigurationInner withVmNamePrefix(String vmNamePrefix) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ActiveSessionHostConfigurationProperties();
        }
     ...
     * @return the ActiveSessionHostConfigurationInner object itself.
     */
    public ActiveSessionHostConfigurationInner withAvailabilityZones(List<Integer> availabilityZones) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ActiveSessionHostConfigurationProperties();
        }
     ...
     * @return the ActiveSessionHostConfigurationInner object itself.
     */
    public ActiveSessionHostConfigurationInner withNetworkInfo(NetworkInfoProperties networkInfo) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ActiveSessionHostConfigurationProperties();
        }
     ...
     * @return the ActiveSessionHostConfigurationInner object itself.
     */
    public ActiveSessionHostConfigurationInner withVmSizeId(String vmSizeId) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ActiveSessionHostConfigurationProperties();
        }
     ...
     * @return the ActiveSessionHostConfigurationInner object itself.
     */
    public ActiveSessionHostConfigurationInner withDiskInfo(DiskInfoProperties diskInfo) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ActiveSessionHostConfigurationProperties();
        }
     ...
     * @return the ActiveSessionHostConfigurationInner object itself.
     */
    public ActiveSessionHostConfigurationInner withCustomConfigurationScriptUrl(String customConfigurationScriptUrl) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ActiveSessionHostConfigurationProperties();
        }
     ...
     * @return the ActiveSessionHostConfigurationInner object itself.
     */
    public ActiveSessionHostConfigurationInner withImageInfo(ImageInfoProperties imageInfo) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ActiveSessionHostConfigurationProperties();
        }
     ...
     * @return the ActiveSessionHostConfigurationInner object itself.
     */
    public ActiveSessionHostConfigurationInner withDomainInfo(DomainInfoProperties domainInfo) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ActiveSessionHostConfigurationProperties();
        }
     ...
     * @return the ActiveSessionHostConfigurationInner object itself.
     */
    public ActiveSessionHostConfigurationInner withSecurityInfo(SecurityInfoProperties securityInfo) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ActiveSessionHostConfigurationProperties();
        }
     ...
     * @return the ActiveSessionHostConfigurationInner object itself.
     */
    public ActiveSessionHostConfigurationInner withVmAdminCredentials(
     ...
     * @return the ActiveSessionHostConfigurationInner object itself.
     */
    public ActiveSessionHostConfigurationInner withBootDiagnosticsInfo(
            ...
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException(
                        "Missing required property innerProperties in model ActiveSessionHostConfigurationInner"));
        } else {
            innerProperties().validate();
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(ActiveSessionHostConfigurationInner.class);
}
