...
public final class WorkspacePatch implements JsonSerializable<WorkspacePatch> {
     ...
     */
    private WorkspacePatchProperties properties;
    ...
    /**
     * Get the properties property: Detailed properties for Workspace.
     * 
     * @return the properties value.
     */
    public WorkspacePatchProperties properties() {
        return this.properties;
    }

    /**
     * Set the properties property: Detailed properties for Workspace.
     * 
     * @param properties the properties value to set.
     * @return the WorkspacePatch object itself.
     */
    public WorkspacePatch withProperties(WorkspacePatchProperties properties) {
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("tags".equals(fieldName)) {
                    ...
                    deserializedWorkspacePatch.properties = WorkspacePatchProperties.fromJson(reader);
                } else {
                    reader.skipChildren();
                }
            }
