...
public final class SessionHostConfigurationPatchProperties {
     ...
     * @return the SessionHostConfigurationPatchProperties object itself.
     */
    public SessionHostConfigurationPatchProperties withCustomConfigurationScriptUrl(
     ...
     * @return the SessionHostConfigurationPatchProperties object itself.
     */
    public SessionHostConfigurationPatchProperties withVmAdminCredentials(
        KeyVaultCredentialsPatchProperties vmAdminCredentials) {
     ...
     * @return the SessionHostConfigurationPatchProperties object itself.
     */
    public SessionHostConfigurationPatchProperties withBootDiagnosticsInfo(
        BootDiagnosticsInfoPatchProperties bootDiagnosticsInfo) {
