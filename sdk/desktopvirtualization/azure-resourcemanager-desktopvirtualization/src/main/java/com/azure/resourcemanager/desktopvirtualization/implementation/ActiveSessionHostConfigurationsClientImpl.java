...
public final class ActiveSessionHostConfigurationsClientImpl implements ActiveSessionHostConfigurationsClient {
    ...
    ActiveSessionHostConfigurationsClientImpl(DesktopVirtualizationApiClientImpl client) {
        this.service =
            RestProxy
                .create(
                    ActiveSessionHostConfigurationsService.class,
    ...
    public interface ActiveSessionHostConfigurationsService {
        ...
        Mono<Response<ActiveSessionHostConfigurationInner>> get(
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ActiveSessionHostConfigurationList>> listByHostPool(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
    ...
    public Mono<Response<ActiveSessionHostConfigurationInner>> getWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ActiveSessionHostConfigurationInner>> getWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ActiveSessionHostConfigurationInner> getWithResponse(
        String resourceGroupName, String hostPoolName, Context context) {
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return activeSessionHostConfigurationList along with {@link PagedResponse} on successful completion of {@link
     *     Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<ActiveSessionHostConfigurationInner>> listByHostPoolSinglePageAsync(
        String resourceGroupName, String hostPoolName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                ...
                context ->
                    service
                        .listByHostPool(
                            ...
                            accept,
                            context))
            .<PagedResponse<ActiveSessionHostConfigurationInner>>map(
                res ->
    ...
    public PagedFlux<ActiveSessionHostConfigurationInner> listByHostPoolAsync(
        String resourceGroupName, String hostPoolName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<ActiveSessionHostConfigurationInner> listByHostPoolAsync(
        String resourceGroupName, String hostPoolName, Context context) {
        return new PagedFlux<>(
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<ActiveSessionHostConfigurationInner> listByHostPool(
        String resourceGroupName, String hostPoolName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<ActiveSessionHostConfigurationInner>> listByHostPoolNextSinglePageAsync(
        String nextLink) {
        if (nextLink == null) {
