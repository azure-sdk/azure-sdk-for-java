...
public final class ActiveSessionHostConfigurationsClientImpl implements ActiveSessionHostConfigurationsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ActiveSessionHostConfigurationInner>> getWithResponseAsync(String resourceGroupName,
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<ActiveSessionHostConfigurationInner>>
        listByHostPoolSinglePageAsync(String resourceGroupName, String hostPoolName, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<ActiveSessionHostConfigurationInner> listByHostPoolAsync(String resourceGroupName,
        String hostPoolName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<ActiveSessionHostConfigurationInner>> listByHostPoolNextSinglePageAsync(String nextLink,
        Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
