...
public final class ApplicationGroupsClientImpl implements ApplicationGroupsClient {
    ...
    public interface ApplicationGroupsService {
        ...
        Mono<Response<ApplicationGroupList>> listBySubscription(@HostParam("$host") String endpoint,
        ...
        Mono<Response<ApplicationGroupInner>> createOrUpdate(@HostParam("$host") String endpoint,
            ...
            @BodyParam("application/json") ApplicationGroupInner resource, @HeaderParam("Accept") String accept,
            Context context);
        ...
        Mono<Response<ApplicationGroupInner>> update(@HostParam("$host") String endpoint,
            ...
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("applicationGroupName") String applicationGroupName,
            @BodyParam("application/json") ApplicationGroupPatch properties, @HeaderParam("Accept") String accept,
            Context context);
        ...
        @Headers({ "Content-Type: application/json" })
        @Get("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DesktopVirtualization/applicationGroups/{applicationGroupName}/list")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
    ...
    private Mono<PagedResponse<ApplicationGroupInner>> listBySubscriptionSinglePageAsync(String filter) {
    ...
    public PagedFlux<ApplicationGroupInner> listBySubscriptionAsync(String filter) {
        return new PagedFlux<>(() -> listBySubscriptionSinglePageAsync(filter),
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<ApplicationGroupInner> listBySubscriptionAsync() {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<ApplicationGroupInner> listBySubscriptionAsync(String filter, Context context) {
        return new PagedFlux<>(() -> listBySubscriptionSinglePageAsync(filter, context),
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<ApplicationGroupInner> listBySubscription() {
        final String filter = null;
        return new PagedIterable<>(listBySubscriptionAsync(filter));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<ApplicationGroupInner> listBySubscription(String filter, Context context) {
        return new PagedIterable<>(listBySubscriptionAsync(filter, context));
    }
    ...
    private PagedFlux<ApplicationGroupInner> listByResourceGroupAsync(String resourceGroupName, String filter,
        ...
        return new PagedFlux<>(() -> listByResourceGroupSinglePageAsync(resourceGroupName, filter, pageSize,
            isDescending, initialSkip, context), nextLink -> listByResourceGroupNextSinglePageAsync(nextLink, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ApplicationGroupInner>> getByResourceGroupWithResponseAsync(String resourceGroupName,
    ...
    public Mono<Response<ApplicationGroupInner>> createOrUpdateWithResponseAsync(String resourceGroupName,
        String applicationGroupName, ApplicationGroupInner resource) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return FluxUtil
            .withContext(context -> service.createOrUpdate(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, applicationGroupName, resource, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ApplicationGroupInner>> createOrUpdateWithResponseAsync(String resourceGroupName,
        String applicationGroupName, ApplicationGroupInner resource, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    public Mono<ApplicationGroupInner> createOrUpdateAsync(String resourceGroupName, String applicationGroupName,
        ApplicationGroupInner resource) {
        return createOrUpdateWithResponseAsync(resourceGroupName, applicationGroupName, resource)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
    ...
    public Response<ApplicationGroupInner> createOrUpdateWithResponse(String resourceGroupName,
        String applicationGroupName, ApplicationGroupInner resource, Context context) {
        return createOrUpdateWithResponseAsync(resourceGroupName, applicationGroupName, resource, context).block();
    }
    ...
    public ApplicationGroupInner createOrUpdate(String resourceGroupName, String applicationGroupName,
        ApplicationGroupInner resource) {
        return createOrUpdateWithResponse(resourceGroupName, applicationGroupName, resource, Context.NONE).getValue();
    }
    ...
    public Mono<Response<ApplicationGroupInner>> updateWithResponseAsync(String resourceGroupName,
        String applicationGroupName, ApplicationGroupPatch properties) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return FluxUtil
            .withContext(context -> service.update(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, applicationGroupName, properties, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ApplicationGroupInner>> updateWithResponseAsync(String resourceGroupName,
        String applicationGroupName, ApplicationGroupPatch properties, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service.update(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, applicationGroupName, properties, accept, context);
    }
    ...
    public Mono<ApplicationGroupInner> updateAsync(String resourceGroupName, String applicationGroupName,
        ApplicationGroupPatch properties) {
        return updateWithResponseAsync(resourceGroupName, applicationGroupName, properties)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
    ...
    public Response<ApplicationGroupInner> updateWithResponse(String resourceGroupName, String applicationGroupName,
        ApplicationGroupPatch properties, Context context) {
        return updateWithResponseAsync(resourceGroupName, applicationGroupName, properties, context).block();
    }
    ...
    public ApplicationGroupInner update(String resourceGroupName, String applicationGroupName,
        ApplicationGroupPatch properties) {
        return updateWithResponse(resourceGroupName, applicationGroupName, properties, Context.NONE).getValue();
    }
    ...
    private Mono<Response<Void>> deleteWithResponseAsync(String resourceGroupName, String applicationGroupName,
        ...
        return service.delete(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, applicationGroupName, accept, context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return list of StartMenuItem definitions along with {@link PagedResponse} on successful completion of
     * {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
