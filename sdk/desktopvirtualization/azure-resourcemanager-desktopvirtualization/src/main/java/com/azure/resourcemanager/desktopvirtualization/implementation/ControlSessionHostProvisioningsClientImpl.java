...
public final class ControlSessionHostProvisioningsClientImpl implements ControlSessionHostProvisioningsClient {
    ...
    private PollerFlux<PollResult<Void>, Void> beginPostAsync(String resourceGroupName, String hostPoolName,
        ...
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono
            = postWithResponseAsync(resourceGroupName, hostPoolName, hostPoolProvisioningControlParameter, context);
        return this.client.<Void, Void>getLroResult(mono, this.client.getHttpPipeline(), Void.class, Void.class,
            context);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginPost(String resourceGroupName, String hostPoolName,
        HostPoolProvisioningControlParameter hostPoolProvisioningControlParameter) {
        return this.beginPostAsync(resourceGroupName, hostPoolName, hostPoolProvisioningControlParameter)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginPost(String resourceGroupName, String hostPoolName,
        HostPoolProvisioningControlParameter hostPoolProvisioningControlParameter, Context context) {
        return this.beginPostAsync(resourceGroupName, hostPoolName, hostPoolProvisioningControlParameter, context)
            .getSyncPoller();
    }
    ...
    private Mono<Void> postAsync(String resourceGroupName, String hostPoolName,
        HostPoolProvisioningControlParameter hostPoolProvisioningControlParameter, Context context) {
        return beginPostAsync(resourceGroupName, hostPoolName, hostPoolProvisioningControlParameter, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    public void post(String resourceGroupName, String hostPoolName,
        HostPoolProvisioningControlParameter hostPoolProvisioningControlParameter) {
        postAsync(resourceGroupName, hostPoolName, hostPoolProvisioningControlParameter).block();
    }
    ...
    public void post(String resourceGroupName, String hostPoolName,
        HostPoolProvisioningControlParameter hostPoolProvisioningControlParameter, Context context) {
        postAsync(resourceGroupName, hostPoolName, hostPoolProvisioningControlParameter, context).block();
    }
}
