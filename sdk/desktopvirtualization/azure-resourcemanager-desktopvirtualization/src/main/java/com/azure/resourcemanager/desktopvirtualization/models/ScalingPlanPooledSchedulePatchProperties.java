 ...
 */
@Fluent
public final class ScalingPlanPooledSchedulePatchProperties
    implements JsonSerializable<ScalingPlanPooledSchedulePatchProperties> {
    /*
     ...
     */
    private ScalingMethodType scalingMethod;
    ...
    /**
     * Creates an instance of ScalingPlanPooledSchedulePatchProperties class.
     */
    public ScalingPlanPooledSchedulePatchProperties() {
    }
     ...
     * @return the ScalingPlanPooledSchedulePatchProperties object itself.
     */
    public ScalingPlanPooledSchedulePatchProperties withName(String name) {
        this.name = name;
        return this;
    }
     ...
     * @return the ScalingPlanPooledSchedulePatchProperties object itself.
     */
    public ScalingPlanPooledSchedulePatchProperties withDaysOfWeek(List<DayOfWeek> daysOfWeek) {
     ...
     * @return the ScalingPlanPooledSchedulePatchProperties object itself.
     */
    public ScalingPlanPooledSchedulePatchProperties withScalingMethod(ScalingMethodType scalingMethod) {
     ...
     * @return the ScalingPlanPooledSchedulePatchProperties object itself.
     */
    public ScalingPlanPooledSchedulePatchProperties withCreateDelete(CreateDeleteProperties createDelete) {
     ...
     * @return the ScalingPlanPooledSchedulePatchProperties object itself.
     */
    public ScalingPlanPooledSchedulePatchProperties withRampUpStartTime(Time rampUpStartTime) {
     ...
     * @return the ScalingPlanPooledSchedulePatchProperties object itself.
     */
    public ScalingPlanPooledSchedulePatchProperties withRampUpMinimumHostsPct(Integer rampUpMinimumHostsPct) {
     ...
     * @return the ScalingPlanPooledSchedulePatchProperties object itself.
     */
    public ScalingPlanPooledSchedulePatchProperties withRampUpCapacityThresholdPct(Integer rampUpCapacityThresholdPct) {
     ...
     * @return the ScalingPlanPooledSchedulePatchProperties object itself.
     */
    public ScalingPlanPooledSchedulePatchProperties withPeakStartTime(Time peakStartTime) {
     ...
     * @return the ScalingPlanPooledSchedulePatchProperties object itself.
     */
    public ScalingPlanPooledSchedulePatchProperties withRampDownStartTime(Time rampDownStartTime) {
     ...
     * @return the ScalingPlanPooledSchedulePatchProperties object itself.
     */
    public ScalingPlanPooledSchedulePatchProperties withRampDownMinimumHostsPct(Integer rampDownMinimumHostsPct) {
     ...
     * @return the ScalingPlanPooledSchedulePatchProperties object itself.
     */
    public ScalingPlanPooledSchedulePatchProperties withRampDownForceLogoffUsers(Boolean rampDownForceLogoffUsers) {
     ...
     * @return the ScalingPlanPooledSchedulePatchProperties object itself.
     */
    public ScalingPlanPooledSchedulePatchProperties withRampDownStopHostsWhen(StopHostsWhen rampDownStopHostsWhen) {
     ...
     * @return the ScalingPlanPooledSchedulePatchProperties object itself.
     */
    public ScalingPlanPooledSchedulePatchProperties withRampDownWaitTimeMinutes(Integer rampDownWaitTimeMinutes) {
     ...
     * @return the ScalingPlanPooledSchedulePatchProperties object itself.
     */
    public ScalingPlanPooledSchedulePatchProperties withOffPeakStartTime(Time offPeakStartTime) {
    ...
    /**
     * Reads an instance of ScalingPlanPooledSchedulePatchProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of ScalingPlanPooledSchedulePatchProperties if the JsonReader was pointing to an instance of
     * it, or null if it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the ScalingPlanPooledSchedulePatchProperties.
     */
    public static ScalingPlanPooledSchedulePatchProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ScalingPlanPooledSchedulePatchProperties deserializedScalingPlanPooledSchedulePatchProperties
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("name".equals(fieldName)) {
                    deserializedScalingPlanPooledSchedulePatchProperties.name = reader.getString();
                    ...
                    deserializedScalingPlanPooledSchedulePatchProperties.daysOfWeek = daysOfWeek;
                } else if ("scalingMethod".equals(fieldName)) {
                    deserializedScalingPlanPooledSchedulePatchProperties.scalingMethod
                        = ScalingMethodType.fromString(reader.getString());
                } else if ("createDelete".equals(fieldName)) {
                    deserializedScalingPlanPooledSchedulePatchProperties.createDelete
                        = CreateDeleteProperties.fromJson(reader);
                } else if ("rampUpStartTime".equals(fieldName)) {
                    deserializedScalingPlanPooledSchedulePatchProperties.rampUpStartTime = Time.fromJson(reader);
                } else if ("rampUpLoadBalancingAlgorithm".equals(fieldName)) {
                    deserializedScalingPlanPooledSchedulePatchProperties.rampUpLoadBalancingAlgorithm
                        = SessionHostLoadBalancingAlgorithm.fromString(reader.getString());
                } else if ("rampUpMinimumHostsPct".equals(fieldName)) {
                    deserializedScalingPlanPooledSchedulePatchProperties.rampUpMinimumHostsPct
                        = reader.getNullable(JsonReader::getInt);
                } else if ("rampUpCapacityThresholdPct".equals(fieldName)) {
                    deserializedScalingPlanPooledSchedulePatchProperties.rampUpCapacityThresholdPct
                        = reader.getNullable(JsonReader::getInt);
                } else if ("peakStartTime".equals(fieldName)) {
                    deserializedScalingPlanPooledSchedulePatchProperties.peakStartTime = Time.fromJson(reader);
                } else if ("peakLoadBalancingAlgorithm".equals(fieldName)) {
                    deserializedScalingPlanPooledSchedulePatchProperties.peakLoadBalancingAlgorithm
                        = SessionHostLoadBalancingAlgorithm.fromString(reader.getString());
                } else if ("rampDownStartTime".equals(fieldName)) {
                    deserializedScalingPlanPooledSchedulePatchProperties.rampDownStartTime = Time.fromJson(reader);
                } else if ("rampDownLoadBalancingAlgorithm".equals(fieldName)) {
                    deserializedScalingPlanPooledSchedulePatchProperties.rampDownLoadBalancingAlgorithm
                        = SessionHostLoadBalancingAlgorithm.fromString(reader.getString());
                } else if ("rampDownMinimumHostsPct".equals(fieldName)) {
                    deserializedScalingPlanPooledSchedulePatchProperties.rampDownMinimumHostsPct
                        = reader.getNullable(JsonReader::getInt);
                } else if ("rampDownCapacityThresholdPct".equals(fieldName)) {
                    deserializedScalingPlanPooledSchedulePatchProperties.rampDownCapacityThresholdPct
                        = reader.getNullable(JsonReader::getInt);
                } else if ("rampDownForceLogoffUsers".equals(fieldName)) {
                    deserializedScalingPlanPooledSchedulePatchProperties.rampDownForceLogoffUsers
                        = reader.getNullable(JsonReader::getBoolean);
                } else if ("rampDownStopHostsWhen".equals(fieldName)) {
                    deserializedScalingPlanPooledSchedulePatchProperties.rampDownStopHostsWhen
                        = StopHostsWhen.fromString(reader.getString());
                } else if ("rampDownWaitTimeMinutes".equals(fieldName)) {
                    deserializedScalingPlanPooledSchedulePatchProperties.rampDownWaitTimeMinutes
                        = reader.getNullable(JsonReader::getInt);
                } else if ("rampDownNotificationMessage".equals(fieldName)) {
                    deserializedScalingPlanPooledSchedulePatchProperties.rampDownNotificationMessage
                        = reader.getString();
                } else if ("offPeakStartTime".equals(fieldName)) {
                    deserializedScalingPlanPooledSchedulePatchProperties.offPeakStartTime = Time.fromJson(reader);
                } else if ("offPeakLoadBalancingAlgorithm".equals(fieldName)) {
                    deserializedScalingPlanPooledSchedulePatchProperties.offPeakLoadBalancingAlgorithm
                        = SessionHostLoadBalancingAlgorithm.fromString(reader.getString());
                } else {
                    reader.skipChildren();
                }
            ...
            return deserializedScalingPlanPooledSchedulePatchProperties;
        });
    }
}
