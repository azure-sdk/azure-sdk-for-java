...
public final class SessionHostConfigurationsClientImpl implements SessionHostConfigurationsClient {
    ...
    /**
     * The interface defining all the services for DesktopVirtualizationApiClientSessionHostConfigurations to be used
    ...
    public interface SessionHostConfigurationsService {
        ...
        Mono<Response<SessionHostConfigurationInner>> createOrUpdate(@HostParam("$host") String endpoint,
    ...
    public Mono<Response<SessionHostConfigurationInner>> createOrUpdateWithResponseAsync(String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<SessionHostConfigurationInner>> createOrUpdateWithResponseAsync(String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<SessionHostConfigurationInner> createOrUpdateWithResponse(String resourceGroupName,
        String hostPoolName, SessionHostConfigurationInner sessionHostConfiguration, Context context) {
    ...
    public SessionHostConfigurationInner createOrUpdate(String resourceGroupName, String hostPoolName,
        SessionHostConfigurationInner sessionHostConfiguration) {
        return createOrUpdateWithResponse(resourceGroupName, hostPoolName, sessionHostConfiguration, Context.NONE)
            .getValue();
    }
