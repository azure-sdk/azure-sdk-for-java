...
public final class SessionHostOperationsClientImpl implements SessionHostOperationsClient {
    ...
    SessionHostOperationsClientImpl(DesktopVirtualizationApiClientImpl client) {
        this.service =
            RestProxy
                .create(SessionHostOperationsService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }
    ...
    public interface SessionHostOperationsService {
        ...
        Mono<Response<Void>> retryProvisioning(
    ...
    public Mono<Response<Void>> retryProvisioningWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Void>> retryProvisioningWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<Void> retryProvisioningWithResponse(
        String resourceGroupName, String hostPoolName, String sessionHostname, Context context) {
