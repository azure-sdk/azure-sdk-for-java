...
public final class InitiateSessionHostUpdatesClientImpl implements InitiateSessionHostUpdatesClient {
    ...
    public interface InitiateSessionHostUpdatesService {
        ...
        Mono<Response<Void>> post(@HostParam("$host") String endpoint, @QueryParam("api-version") String apiVersion,
    ...
    public Mono<Response<Void>> postWithResponseAsync(String resourceGroupName, String hostPoolName,
        ...
        return FluxUtil
            .withContext(context -> service.post(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, hostPoolName, updateSessionHostsRequestBody, accept,
                context))
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Void>> postWithResponseAsync(String resourceGroupName, String hostPoolName,
        ...
        return service.post(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, hostPoolName, updateSessionHostsRequestBody, accept, context);
    }
    ...
    public Response<Void> postWithResponse(String resourceGroupName, String hostPoolName,
        UpdateSessionHostsRequestBody updateSessionHostsRequestBody, Context context) {
        return postWithResponseAsync(resourceGroupName, hostPoolName, updateSessionHostsRequestBody, context).block();
    }
