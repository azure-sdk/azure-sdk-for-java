...
public final class InitiateSessionHostUpdatesClientImpl implements InitiateSessionHostUpdatesClient {
    ...
    public SyncPoller<PollResult<Void>, Void> beginPost(String resourceGroupName, String hostPoolName,
        UpdateSessionHostsRequestBody updateSessionHostsRequestBody, Context context) {
        return this.beginPostAsync(resourceGroupName, hostPoolName, updateSessionHostsRequestBody, context)
            .getSyncPoller();
    }
    ...
    public Mono<Void> postAsync(String resourceGroupName, String hostPoolName,
        UpdateSessionHostsRequestBody updateSessionHostsRequestBody) {
        return beginPostAsync(resourceGroupName, hostPoolName, updateSessionHostsRequestBody).last()
    ...
    private Mono<Void> postAsync(String resourceGroupName, String hostPoolName,
        UpdateSessionHostsRequestBody updateSessionHostsRequestBody, Context context) {
        return beginPostAsync(resourceGroupName, hostPoolName, updateSessionHostsRequestBody, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
