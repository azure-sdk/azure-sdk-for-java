...
public final class ScalingPlanPersonalScheduleInner extends ProxyResource {
     ...
     */
    private ScalingPlanPersonalScheduleProperties properties;
     ...
     */
    public ScalingPlanPersonalScheduleInner withProperties(ScalingPlanPersonalScheduleProperties properties) {
        ...
        if (properties() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property properties in model ScalingPlanPersonalScheduleInner"));
        } else {
            properties().validate();
        }
    }
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("id".equals(fieldName)) {
                    ...
                    deserializedScalingPlanPersonalScheduleInner.properties
