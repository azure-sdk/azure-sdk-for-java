...
public final class ActiveSessionHostConfigurationsImpl implements ActiveSessionHostConfigurations {
    ...
    public ActiveSessionHostConfigurationsImpl(
        ActiveSessionHostConfigurationsClient innerClient,
        com.azure.resourcemanager.desktopvirtualization.DesktopVirtualizationManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public Response<ActiveSessionHostConfiguration> getWithResponse(
    ...
    public PagedIterable<ActiveSessionHostConfiguration> listByHostPool(
        String resourceGroupName, String hostPoolName, Context context) {
        PagedIterable<ActiveSessionHostConfigurationInner> inner =
