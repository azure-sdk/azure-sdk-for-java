...
public final class DesktopVirtualizationApiClientImpl implements DesktopVirtualizationApiClient {
    ...
    /**
     * The ControlSessionHostProvisioningsClient object to access its operations.
     */
    private final ControlSessionHostProvisioningsClient controlSessionHostProvisionings;
     ...
     */
    public ControlSessionHostProvisioningsClient getControlSessionHostProvisionings() {
        return this.controlSessionHostProvisionings;
    }
    ...
    /**
     * The SessionHostProvisioningStatusesClient object to access its operations.
     */
    private final SessionHostProvisioningStatusesClient sessionHostProvisioningStatuses;

    /**
     * Gets the SessionHostProvisioningStatusesClient object to access its operations.
     * 
     * @return the SessionHostProvisioningStatusesClient object.
     */
    public SessionHostProvisioningStatusesClient getSessionHostProvisioningStatuses() {
        return this.sessionHostProvisioningStatuses;
    }
    ...
    DesktopVirtualizationApiClientImpl(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter,
        ...
        this.controlSessionHostProvisionings = new ControlSessionHostProvisioningsClientImpl(this);
        this.sessionHostManagementsUpdateStatus = new SessionHostManagementsUpdateStatusClientImpl(this);
        this.sessionHostProvisioningStatuses = new SessionHostProvisioningStatusesClientImpl(this);
