...
public final class DesktopsClientImpl implements DesktopsClient {
    ...
    public interface DesktopsService {
        ...
        Mono<Response<DesktopInner>> update(@HostParam("$host") String endpoint,
            ...
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("applicationGroupName") String applicationGroupName,
            @PathParam("desktopName") String desktopName, @BodyParam("application/json") DesktopPatch properties,
            @HeaderParam("Accept") String accept, Context context);
     ...
     * @param applicationGroupName The name of the application group.
     * @param desktopName The name of the desktop within the specified desktop group.
     * @param properties Object containing Desktop definitions.
     * @throws IllegalArgumentException thrown if parameters fail the validation.
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
    ...
    public Mono<Response<DesktopInner>> updateWithResponseAsync(String resourceGroupName, String applicationGroupName,
        String desktopName, DesktopPatch properties) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return FluxUtil
            .withContext(context -> service.update(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, applicationGroupName, desktopName, properties,
                accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<DesktopInner>> updateWithResponseAsync(String resourceGroupName, String applicationGroupName,
        ...
        return service.update(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, applicationGroupName, desktopName, properties, accept, context);
    }
    ...
    public Mono<DesktopInner> updateAsync(String resourceGroupName, String applicationGroupName, String desktopName,
        ...
        return updateWithResponseAsync(resourceGroupName, applicationGroupName, desktopName, properties)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
    ...
    public Response<DesktopInner> updateWithResponse(String resourceGroupName, String applicationGroupName,
        String desktopName, DesktopPatch properties, Context context) {
        return updateWithResponseAsync(resourceGroupName, applicationGroupName, desktopName, properties, context)
            .block();
    }
    ...
    public DesktopInner update(String resourceGroupName, String applicationGroupName, String desktopName,
        DesktopPatch properties) {
        return updateWithResponse(resourceGroupName, applicationGroupName, desktopName, properties, Context.NONE)
            .getValue();
    }
