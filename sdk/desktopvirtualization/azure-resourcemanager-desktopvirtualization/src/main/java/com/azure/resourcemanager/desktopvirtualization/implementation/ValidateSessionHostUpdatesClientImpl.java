...
public final class ValidateSessionHostUpdatesClientImpl implements ValidateSessionHostUpdatesClient {
    ...
    ValidateSessionHostUpdatesClientImpl(DesktopVirtualizationApiClientImpl client) {
        this.service =
            RestProxy
                .create(
                    ValidateSessionHostUpdatesService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginPost(String resourceGroupName, String hostPoolName) {
        final ValidateSessionHostUpdateRequestBodyInner validateSessionHostUpdateRequestBody = null;
        return this
            .beginPostAsync(resourceGroupName, hostPoolName, validateSessionHostUpdateRequestBody)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginPost(
        ...
        Context context) {
        return this
            .beginPostAsync(resourceGroupName, hostPoolName, validateSessionHostUpdateRequestBody, context)
            .getSyncPoller();
    }
    ...
    public Mono<Void> postAsync(
        ...
        String hostPoolName,
        ValidateSessionHostUpdateRequestBodyInner validateSessionHostUpdateRequestBody) {
        return beginPostAsync(resourceGroupName, hostPoolName, validateSessionHostUpdateRequestBody)
            .last()
    ...
    private Mono<Void> postAsync(
        ...
        ValidateSessionHostUpdateRequestBodyInner validateSessionHostUpdateRequestBody,
        Context context) {
        return beginPostAsync(resourceGroupName, hostPoolName, validateSessionHostUpdateRequestBody, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
