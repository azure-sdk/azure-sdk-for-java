...
public final class SessionHostInner extends ProxyResource {
     ...
     */
    private SessionHostProperties properties;
     ...
     */
    public SessionHostInner withProperties(SessionHostProperties properties) {
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("id".equals(fieldName)) {
                    ...
                    deserializedSessionHostInner.properties = SessionHostProperties.fromJson(reader);
