...
public final class MsixPackageInner extends ProxyResource {
     ...
     */
    private MsixPackageProperties properties;
     ...
     */
    public MsixPackageInner withProperties(MsixPackageProperties properties) {
    ...
    public void validate() {
        if (properties() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Missing required property properties in model MsixPackageInner"));
        } else {
            properties().validate();
        }
    }
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("id".equals(fieldName)) {
                    ...
                    deserializedMsixPackageInner.properties = MsixPackageProperties.fromJson(reader);
