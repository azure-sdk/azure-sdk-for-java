        ...
        if (location() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property location in model ResourceModelWithAllowedPropertySet"));
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(ResourceModelWithAllowedPropertySet.class);
