...
/**
 * An immutable client-side representation of ScalingPlanPooledSchedulePut.
 */
public interface ScalingPlanPooledSchedulePut {
    /**
    ...
    /**
     * Gets the inner com.azure.resourcemanager.desktopvirtualization.fluent.models.ScalingPlanPooledSchedulePutInner
     * object.
     * 
     * @return the inner object.
     */
    ScalingPlanPooledSchedulePutInner innerModel();

    /**
     * The entirety of the ScalingPlanPooledSchedulePut definition.
     */
    ...
    /**
     * The ScalingPlanPooledSchedulePut definition stages.
     */
    interface DefinitionStages {
        /**
         * The first stage of the ScalingPlanPooledSchedulePut definition.
         */
        interface Blank extends WithParentResource {
        }

        /**
         * The stage of the ScalingPlanPooledSchedulePut definition allowing to specify parent resource.
         */
        ...
        /**
         * The stage of the ScalingPlanPooledSchedulePut definition which contains all the minimum required properties
        ...
        interface WithCreate extends DefinitionStages.WithDaysOfWeek, DefinitionStages.WithRampUpStartTime,
             ...
             */
            ScalingPlanPooledSchedulePut create();
             ...
             * @return the created resource.
             */
            ScalingPlanPooledSchedulePut create(Context context);
        }

        /**
         * The stage of the ScalingPlanPooledSchedulePut definition allowing to specify daysOfWeek.
         */
        ...
        /**
         * The stage of the ScalingPlanPooledSchedulePut definition allowing to specify rampUpStartTime.
         */
        ...
        /**
         * The stage of the ScalingPlanPooledSchedulePut definition allowing to specify rampUpLoadBalancingAlgorithm.
         */
        ...
        /**
         * The stage of the ScalingPlanPooledSchedulePut definition allowing to specify rampUpMinimumHostsPct.
         */
        ...
        /**
         * The stage of the ScalingPlanPooledSchedulePut definition allowing to specify rampUpCapacityThresholdPct.
         */
        interface WithRampUpCapacityThresholdPct {
             ...
             * @return the next definition stage.
             */
            WithCreate withRampUpCapacityThresholdPct(int rampUpCapacityThresholdPct);
        }

        /**
         * The stage of the ScalingPlanPooledSchedulePut definition allowing to specify peakStartTime.
         */
        ...
        /**
         * The stage of the ScalingPlanPooledSchedulePut definition allowing to specify peakLoadBalancingAlgorithm.
         */
        ...
        /**
         * The stage of the ScalingPlanPooledSchedulePut definition allowing to specify rampDownStartTime.
         */
        ...
        /**
         * The stage of the ScalingPlanPooledSchedulePut definition allowing to specify rampDownLoadBalancingAlgorithm.
         */
        ...
        /**
         * The stage of the ScalingPlanPooledSchedulePut definition allowing to specify rampDownMinimumHostsPct.
         */
        ...
        /**
         * The stage of the ScalingPlanPooledSchedulePut definition allowing to specify rampDownCapacityThresholdPct.
         */
        interface WithRampDownCapacityThresholdPct {
             ...
             * @return the next definition stage.
             */
            WithCreate withRampDownCapacityThresholdPct(int rampDownCapacityThresholdPct);
        }

        /**
         * The stage of the ScalingPlanPooledSchedulePut definition allowing to specify rampDownForceLogoffUsers.
         */
        ...
        /**
         * The stage of the ScalingPlanPooledSchedulePut definition allowing to specify rampDownStopHostsWhen.
         */
        ...
        /**
         * The stage of the ScalingPlanPooledSchedulePut definition allowing to specify rampDownWaitTimeMinutes.
         */
        ...
        /**
         * The stage of the ScalingPlanPooledSchedulePut definition allowing to specify rampDownNotificationMessage.
         */
        ...
        /**
         * The stage of the ScalingPlanPooledSchedulePut definition allowing to specify offPeakStartTime.
         */
        ...
        /**
         * The stage of the ScalingPlanPooledSchedulePut definition allowing to specify offPeakLoadBalancingAlgorithm.
         */
    ...
    /**
     * Begins update for the ScalingPlanPooledSchedulePut resource.
     * 
     * @return the stage of resource update.
     */
    ScalingPlanPooledSchedulePut.Update update();

    /**
     * The template for ScalingPlanPooledSchedulePut update.
     */
    interface Update extends UpdateStages.WithDaysOfWeek, UpdateStages.WithRampUpStartTime,
        UpdateStages.WithRampUpLoadBalancingAlgorithm, UpdateStages.WithRampUpMinimumHostsPct,
        UpdateStages.WithRampUpCapacityThresholdPct, UpdateStages.WithPeakStartTime,
        UpdateStages.WithPeakLoadBalancingAlgorithm, UpdateStages.WithRampDownStartTime,
        UpdateStages.WithRampDownLoadBalancingAlgorithm, UpdateStages.WithRampDownMinimumHostsPct,
        UpdateStages.WithRampDownCapacityThresholdPct, UpdateStages.WithRampDownForceLogoffUsers,
        UpdateStages.WithRampDownStopHostsWhen, UpdateStages.WithRampDownWaitTimeMinutes,
        UpdateStages.WithRampDownNotificationMessage, UpdateStages.WithOffPeakStartTime,
         ...
         */
        ScalingPlanPooledSchedulePut apply();
         ...
         * @return the updated resource.
         */
        ScalingPlanPooledSchedulePut apply(Context context);
    }

    /**
     * The ScalingPlanPooledSchedulePut update stages.
     */
    interface UpdateStages {
        /**
         * The stage of the ScalingPlanPooledSchedulePut update allowing to specify daysOfWeek.
         */
        interface WithDaysOfWeek {
            /**
             * Specifies the daysOfWeek property: Set of days of the week on which this schedule is active..
        ...
        /**
         * The stage of the ScalingPlanPooledSchedulePut update allowing to specify rampUpStartTime.
         */
        interface WithRampUpStartTime {
            /**
             * Specifies the rampUpStartTime property: Starting time for ramp up period..
        ...
        /**
         * The stage of the ScalingPlanPooledSchedulePut update allowing to specify rampUpLoadBalancingAlgorithm.
         */
        interface WithRampUpLoadBalancingAlgorithm {
            /**
             * Specifies the rampUpLoadBalancingAlgorithm property: Load balancing algorithm for ramp up period..
        ...
        /**
         * The stage of the ScalingPlanPooledSchedulePut update allowing to specify rampUpMinimumHostsPct.
         */
        interface WithRampUpMinimumHostsPct {
            /**
             * Specifies the rampUpMinimumHostsPct property: Minimum host percentage for ramp up period..
        ...
        /**
         * The stage of the ScalingPlanPooledSchedulePut update allowing to specify rampUpCapacityThresholdPct.
         */
        interface WithRampUpCapacityThresholdPct {
            /**
             * Specifies the rampUpCapacityThresholdPct property: Capacity threshold for ramp up period..
        ...
        /**
         * The stage of the ScalingPlanPooledSchedulePut update allowing to specify peakStartTime.
         */
        interface WithPeakStartTime {
            /**
             * Specifies the peakStartTime property: Starting time for peak period..
        ...
        /**
         * The stage of the ScalingPlanPooledSchedulePut update allowing to specify peakLoadBalancingAlgorithm.
         */
        interface WithPeakLoadBalancingAlgorithm {
            /**
             * Specifies the peakLoadBalancingAlgorithm property: Load balancing algorithm for peak period..
        ...
        /**
         * The stage of the ScalingPlanPooledSchedulePut update allowing to specify rampDownStartTime.
         */
        interface WithRampDownStartTime {
            /**
             * Specifies the rampDownStartTime property: Starting time for ramp down period..
        ...
        /**
         * The stage of the ScalingPlanPooledSchedulePut update allowing to specify rampDownLoadBalancingAlgorithm.
         */
        interface WithRampDownLoadBalancingAlgorithm {
            /**
             * Specifies the rampDownLoadBalancingAlgorithm property: Load balancing algorithm for ramp down period..
        ...
        /**
         * The stage of the ScalingPlanPooledSchedulePut update allowing to specify rampDownMinimumHostsPct.
         */
        interface WithRampDownMinimumHostsPct {
            /**
             * Specifies the rampDownMinimumHostsPct property: Minimum host percentage for ramp down period..
        ...
        /**
         * The stage of the ScalingPlanPooledSchedulePut update allowing to specify rampDownCapacityThresholdPct.
         */
        interface WithRampDownCapacityThresholdPct {
            /**
             * Specifies the rampDownCapacityThresholdPct property: Capacity threshold for ramp down period..
        ...
        /**
         * The stage of the ScalingPlanPooledSchedulePut update allowing to specify rampDownForceLogoffUsers.
         */
        interface WithRampDownForceLogoffUsers {
            /**
             * Specifies the rampDownForceLogoffUsers property: Should users be logged off forcefully from hosts..
        ...
        /**
         * The stage of the ScalingPlanPooledSchedulePut update allowing to specify rampDownStopHostsWhen.
         */
        interface WithRampDownStopHostsWhen {
            /**
             * Specifies the rampDownStopHostsWhen property: Specifies when to stop hosts during ramp down period..
        ...
        /**
         * The stage of the ScalingPlanPooledSchedulePut update allowing to specify rampDownWaitTimeMinutes.
         */
        interface WithRampDownWaitTimeMinutes {
            /**
             * Specifies the rampDownWaitTimeMinutes property: Number of minutes to wait to stop hosts during ramp down
        ...
        /**
         * The stage of the ScalingPlanPooledSchedulePut update allowing to specify rampDownNotificationMessage.
         */
        interface WithRampDownNotificationMessage {
            /**
             * Specifies the rampDownNotificationMessage property: Notification message for users during ramp down
        ...
        /**
         * The stage of the ScalingPlanPooledSchedulePut update allowing to specify offPeakStartTime.
         */
        interface WithOffPeakStartTime {
            /**
             * Specifies the offPeakStartTime property: Starting time for off-peak period..
        ...
        /**
         * The stage of the ScalingPlanPooledSchedulePut update allowing to specify offPeakLoadBalancingAlgorithm.
         */
        interface WithOffPeakLoadBalancingAlgorithm {
            /**
             * Specifies the offPeakLoadBalancingAlgorithm property: Load balancing algorithm for off-peak period..
     ...
     */
    ScalingPlanPooledSchedulePut refresh();
     ...
     * @return the refreshed resource.
     */
    ScalingPlanPooledSchedulePut refresh(Context context);
}
