...
public interface ScalingPlansClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Mono<ScalingPlanInner> createAsync(String resourceGroupName, String scalingPlanName, ScalingPlanInner resource);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ScalingPlanInner create(String resourceGroupName, String scalingPlanName, ScalingPlanInner resource);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Mono<ScalingPlanInner> updateAsync(String resourceGroupName, String scalingPlanName, ScalingPlanPatch properties);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ScalingPlanInner update(String resourceGroupName, String scalingPlanName, ScalingPlanPatch properties);
