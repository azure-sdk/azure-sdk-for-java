...
public final class ScalingPlanPooledSchedulesClientImpl implements ScalingPlanPooledSchedulesClient {
    ...
    public interface ScalingPlanPooledSchedulesService {
        ...
        Mono<Response<ScalingPlanPooledSchedulePutInner>> get(@HostParam("$host") String endpoint,
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ScalingPlanPooledSchedulePutInner>> create(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("scalingPlanName") String scalingPlanName,
            @PathParam("scalingPlanScheduleName") String scalingPlanScheduleName,
            @BodyParam("application/json") ScalingPlanPooledSchedulePutInner scalingPlanSchedule,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ScalingPlanPooledSchedulePutInner>> update(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("scalingPlanName") String scalingPlanName,
            @PathParam("scalingPlanScheduleName") String scalingPlanScheduleName,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ScalingPlanPooledScheduleList>> list(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
    ...
    public Mono<Response<ScalingPlanPooledSchedulePutInner>> getWithResponseAsync(String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ScalingPlanPooledSchedulePutInner>> getWithResponseAsync(String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<ScalingPlanPooledSchedulePutInner> getAsync(String resourceGroupName, String scalingPlanName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ScalingPlanPooledSchedulePutInner> getWithResponse(String resourceGroupName, String scalingPlanName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ScalingPlanPooledSchedulePutInner get(String resourceGroupName, String scalingPlanName,
        String scalingPlanScheduleName) {
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return represents a ScalingPlanPooledSchedule properties that can be put along with {@link Response} on
     * successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<ScalingPlanPooledSchedulePutInner>> createWithResponseAsync(String resourceGroupName,
        String scalingPlanName, String scalingPlanScheduleName, ScalingPlanPooledSchedulePutInner scalingPlanSchedule) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ScalingPlanPooledSchedulePutInner>> createWithResponseAsync(String resourceGroupName,
        String scalingPlanName, String scalingPlanScheduleName, ScalingPlanPooledSchedulePutInner scalingPlanSchedule,
        Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return represents a ScalingPlanPooledSchedule properties that can be put on successful completion of
     * {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<ScalingPlanPooledSchedulePutInner> createAsync(String resourceGroupName, String scalingPlanName,
        String scalingPlanScheduleName, ScalingPlanPooledSchedulePutInner scalingPlanSchedule) {
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return represents a ScalingPlanPooledSchedule properties that can be put along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ScalingPlanPooledSchedulePutInner> createWithResponse(String resourceGroupName,
        String scalingPlanName, String scalingPlanScheduleName, ScalingPlanPooledSchedulePutInner scalingPlanSchedule,
        Context context) {
        return createWithResponseAsync(resourceGroupName, scalingPlanName, scalingPlanScheduleName, scalingPlanSchedule,
            context).block();
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return represents a ScalingPlanPooledSchedule properties that can be put.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ScalingPlanPooledSchedulePutInner create(String resourceGroupName, String scalingPlanName,
        String scalingPlanScheduleName, ScalingPlanPooledSchedulePutInner scalingPlanSchedule) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<ScalingPlanPooledSchedulePutInner>> updateWithResponseAsync(String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ScalingPlanPooledSchedulePutInner>> updateWithResponseAsync(String resourceGroupName,
        String scalingPlanName, String scalingPlanScheduleName, ScalingPlanPooledSchedulePatch scalingPlanSchedule,
        Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<ScalingPlanPooledSchedulePutInner> updateAsync(String resourceGroupName, String scalingPlanName,
        String scalingPlanScheduleName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ScalingPlanPooledSchedulePutInner> updateWithResponse(String resourceGroupName,
        String scalingPlanName, String scalingPlanScheduleName, ScalingPlanPooledSchedulePatch scalingPlanSchedule,
        Context context) {
        return updateWithResponseAsync(resourceGroupName, scalingPlanName, scalingPlanScheduleName, scalingPlanSchedule,
            context).block();
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ScalingPlanPooledSchedulePutInner update(String resourceGroupName, String scalingPlanName,
        String scalingPlanScheduleName) {
        final ScalingPlanPooledSchedulePatch scalingPlanSchedule = null;
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<ScalingPlanPooledSchedulePutInner>> listSinglePageAsync(String resourceGroupName,
        ...
        return FluxUtil
            ...
            .<PagedResponse<ScalingPlanPooledSchedulePutInner>>map(res -> new PagedResponseBase<>(res.getRequest(),
    ...
    public PagedFlux<ScalingPlanPooledSchedulePutInner> listAsync(String resourceGroupName, String scalingPlanName,
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<ScalingPlanPooledSchedulePutInner> listAsync(String resourceGroupName, String scalingPlanName,
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<ScalingPlanPooledSchedulePutInner> list(String resourceGroupName, String scalingPlanName) {
        final Integer pageSize = null;
        final Boolean isDescending = null;
        final Integer initialSkip = null;
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<ScalingPlanPooledSchedulePutInner>> listNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
