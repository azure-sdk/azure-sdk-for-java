...
public interface SessionHostManagementsOperationStatusClient {
    ...
    Mono<Response<SessionHostManagementOperationStatusInner>> getWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Mono<SessionHostManagementOperationStatusInner> getAsync(
        String resourceGroupName, String hostPoolName, String operationId);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<SessionHostManagementOperationStatusInner> getWithResponse(
    ...
    PagedFlux<SessionHostManagementOperationStatusInner> listAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<SessionHostManagementOperationStatusInner> list(
        String resourceGroupName,
        String hostPoolName,
        Boolean isLatest,
        String type,
