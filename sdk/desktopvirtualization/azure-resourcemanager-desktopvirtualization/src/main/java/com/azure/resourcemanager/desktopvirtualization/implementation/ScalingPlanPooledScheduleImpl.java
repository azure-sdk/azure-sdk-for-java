...
public final class ScalingPlanPooledScheduleImpl
    ...
    public ScalingPlanPooledSchedule create() {
        this.innerObject
            = serviceManager.serviceClient().getScalingPlanPooledSchedules().createWithResponse(resourceGroupName,
    ...
    public ScalingPlanPooledSchedule create(Context context) {
        this.innerObject = serviceManager.serviceClient().getScalingPlanPooledSchedules()
    ...
    public ScalingPlanPooledSchedule apply() {
        this.innerObject
            = serviceManager.serviceClient().getScalingPlanPooledSchedules().updateWithResponse(resourceGroupName,
