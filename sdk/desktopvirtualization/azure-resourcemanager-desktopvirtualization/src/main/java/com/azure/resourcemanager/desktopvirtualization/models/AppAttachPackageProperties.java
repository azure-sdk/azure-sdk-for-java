...
public final class AppAttachPackageProperties {
     ...
     */
    @JsonProperty(value = "packageOwnerName")
    ...
    /**
     * Get the packageOwnerName property: Specific name of package owner, is "AppAttach" for native app attach
     * packages.
     * 
    ...
    /**
     * Set the packageOwnerName property: Specific name of package owner, is "AppAttach" for native app attach
     * packages.
     * 
