...
@Fluent
public final class SessionHostConfigurationPatch {
    /*
     ...
     * @return the SessionHostConfigurationPatch object itself.
     */
    public SessionHostConfigurationPatch withNetworkInfo(NetworkInfoProperties networkInfo) {
        if (this.innerProperties() == null) {
            this.innerProperties = new SessionHostConfigurationPatchProperties();
        }
     ...
     * @return the SessionHostConfigurationPatch object itself.
     */
    public SessionHostConfigurationPatch withBootDiagnosticsInfo(
