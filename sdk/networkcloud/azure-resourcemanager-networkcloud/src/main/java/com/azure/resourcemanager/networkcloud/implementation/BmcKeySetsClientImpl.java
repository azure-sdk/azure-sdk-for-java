...
public final class BmcKeySetsClientImpl implements BmcKeySetsClient {
    ...
    public interface BmcKeySetsService {
        ...
        Mono<Response<BmcKeySetList>> listBySubscription(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<BmcKeySetList>> listByResourceGroup(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<BmcKeySetInner>> listByResourceGroupSinglePageAsync(String resourceGroupName,
        String clusterName) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<BmcKeySetInner> createOrUpdateAsync(String resourceGroupName, String clusterName,
        String bmcKeySetName) {
        final BmcKeySetInner bmcKeySetParameters = null;
        return beginCreateOrUpdateAsync(resourceGroupName, clusterName, bmcKeySetName, bmcKeySetParameters).last()
            .flatMap(this.client::getLroFinalResultOrError);
