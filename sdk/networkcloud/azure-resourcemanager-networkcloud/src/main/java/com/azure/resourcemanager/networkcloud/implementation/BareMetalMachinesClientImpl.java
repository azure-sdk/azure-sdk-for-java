...
public final class BareMetalMachinesClientImpl implements BareMetalMachinesClient {
    ...
    public interface BareMetalMachinesService {
        ...
        @Headers({ "Content-Type: application/json" })
        @Post("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetworkCloud/bareMetalMachines/{bareMetalMachineName}/validateHardware")
        @ExpectedResponses({ 202, 204 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Flux<ByteBuffer>>> validateHardware(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("bareMetalMachineName") String bareMetalMachineName,
            @BodyParam("application/json") BareMetalMachineValidateHardwareParameters bareMetalMachineValidateHardwareParameters,
            @HeaderParam("Accept") String accept, Context context);
    ...
    private PollerFlux<PollResult<BareMetalMachineInner>, BareMetalMachineInner>
        beginCreateOrUpdateAsync(String resourceGroupName, String bareMetalMachineName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<BareMetalMachineInner>, BareMetalMachineInner>
        beginCreateOrUpdate(String resourceGroupName, String bareMetalMachineName) {
        final BareMetalMachineInner bareMetalMachineParameters = null;
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<Void>, Void> beginPowerOffAsync(String resourceGroupName, String bareMetalMachineName,
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<Void>, Void> beginPowerOffAsync(String resourceGroupName,
        String bareMetalMachineName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<Void>, Void> beginReimageAsync(String resourceGroupName,
        String bareMetalMachineName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<Void>, Void> beginReimageAsync(String resourceGroupName, String bareMetalMachineName,
        Context context) {
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<Void>, Void> beginReplaceAsync(String resourceGroupName, String bareMetalMachineName,
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<Void>, Void> beginReplaceAsync(String resourceGroupName,
        String bareMetalMachineName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<Void>, Void> beginRestartAsync(String resourceGroupName,
        String bareMetalMachineName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<Void>, Void> beginRestartAsync(String resourceGroupName, String bareMetalMachineName,
        Context context) {
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<Void>, Void> beginRunCommandAsync(String resourceGroupName,
        String bareMetalMachineName, BareMetalMachineRunCommandParameters bareMetalMachineRunCommandParameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<Void>, Void> beginRunDataExtractsAsync(String resourceGroupName,
        String bareMetalMachineName,
        BareMetalMachineRunDataExtractsParameters bareMetalMachineRunDataExtractsParameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<Void>, Void> beginRunDataExtracts(String resourceGroupName,
        String bareMetalMachineName) {
        final BareMetalMachineRunDataExtractsParameters bareMetalMachineRunDataExtractsParameters = null;
        return this.beginRunDataExtractsAsync(resourceGroupName, bareMetalMachineName,
            bareMetalMachineRunDataExtractsParameters).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginRunDataExtracts(String resourceGroupName,
        ...
        BareMetalMachineRunDataExtractsParameters bareMetalMachineRunDataExtractsParameters, Context context) {
        return this.beginRunDataExtractsAsync(resourceGroupName, bareMetalMachineName,
            bareMetalMachineRunDataExtractsParameters, context).getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<Void>, Void> beginRunReadCommandsAsync(String resourceGroupName,
        String bareMetalMachineName,
        BareMetalMachineRunReadCommandsParameters bareMetalMachineRunReadCommandsParameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<Void>, Void> beginRunReadCommands(String resourceGroupName,
        String bareMetalMachineName) {
        final BareMetalMachineRunReadCommandsParameters bareMetalMachineRunReadCommandsParameters = null;
        return this.beginRunReadCommandsAsync(resourceGroupName, bareMetalMachineName,
            bareMetalMachineRunReadCommandsParameters).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginRunReadCommands(String resourceGroupName,
        ...
        BareMetalMachineRunReadCommandsParameters bareMetalMachineRunReadCommandsParameters, Context context) {
        return this.beginRunReadCommandsAsync(resourceGroupName, bareMetalMachineName,
            bareMetalMachineRunReadCommandsParameters, context).getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<Void>, Void> beginUncordonAsync(String resourceGroupName,
        String bareMetalMachineName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<Void>, Void> beginUncordonAsync(String resourceGroupName, String bareMetalMachineName,
        Context context) {
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> validateHardwareWithResponseAsync(String resourceGroupName,
        String bareMetalMachineName,
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.validateHardware(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, bareMetalMachineName,
                bareMetalMachineValidateHardwareParameters, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> validateHardwareWithResponseAsync(String resourceGroupName,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.validateHardware(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, bareMetalMachineName,
            bareMetalMachineValidateHardwareParameters, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<Void>, Void> beginValidateHardwareAsync(String resourceGroupName,
        String bareMetalMachineName,
        BareMetalMachineValidateHardwareParameters bareMetalMachineValidateHardwareParameters) {
        Mono<Response<Flux<ByteBuffer>>> mono = validateHardwareWithResponseAsync(resourceGroupName,
            bareMetalMachineName, bareMetalMachineValidateHardwareParameters);
        return this.client.<Void, Void>getLroResult(mono, this.client.getHttpPipeline(), Void.class, Void.class,
            this.client.getContext());
    }
    ...
    private PollerFlux<PollResult<Void>, Void> beginValidateHardwareAsync(String resourceGroupName,
        ...
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono = validateHardwareWithResponseAsync(resourceGroupName,
            bareMetalMachineName, bareMetalMachineValidateHardwareParameters, context);
        return this.client.<Void, Void>getLroResult(mono, this.client.getHttpPipeline(), Void.class, Void.class,
            context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<Void>, Void> beginValidateHardware(String resourceGroupName,
        String bareMetalMachineName) {
        final BareMetalMachineValidateHardwareParameters bareMetalMachineValidateHardwareParameters = null;
        return this.beginValidateHardwareAsync(resourceGroupName, bareMetalMachineName,
            bareMetalMachineValidateHardwareParameters).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginValidateHardware(String resourceGroupName,
        ...
        BareMetalMachineValidateHardwareParameters bareMetalMachineValidateHardwareParameters, Context context) {
        return this.beginValidateHardwareAsync(resourceGroupName, bareMetalMachineName,
            bareMetalMachineValidateHardwareParameters, context).getSyncPoller();
    }
    ...
    private Mono<Void> validateHardwareAsync(String resourceGroupName, String bareMetalMachineName,
        BareMetalMachineValidateHardwareParameters bareMetalMachineValidateHardwareParameters) {
        return beginValidateHardwareAsync(resourceGroupName, bareMetalMachineName,
            bareMetalMachineValidateHardwareParameters).last().flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<Void> validateHardwareAsync(String resourceGroupName, String bareMetalMachineName,
        BareMetalMachineValidateHardwareParameters bareMetalMachineValidateHardwareParameters, Context context) {
        return beginValidateHardwareAsync(resourceGroupName, bareMetalMachineName,
            bareMetalMachineValidateHardwareParameters, context).last().flatMap(this.client::getLroFinalResultOrError);
    }
