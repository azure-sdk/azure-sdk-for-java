...
public final class BmcKeySetImpl implements BmcKeySet, BmcKeySet.Definition, BmcKeySet.Update {
    ...
    public BmcKeySet create() {
        this.innerObject = serviceManager.serviceClient().getBmcKeySets().createOrUpdate(resourceGroupName, clusterName,
            bmcKeySetName, this.innerModel(), Context.NONE);
        return this;
    }

    public BmcKeySet create(Context context) {
        this.innerObject = serviceManager.serviceClient().getBmcKeySets().createOrUpdate(resourceGroupName, clusterName,
            bmcKeySetName, this.innerModel(), context);
        return this;
    }
    ...
    public BmcKeySet apply() {
        this.innerObject = serviceManager.serviceClient().getBmcKeySets().update(resourceGroupName, clusterName,
            bmcKeySetName, updateBmcKeySetUpdateParameters, Context.NONE);
        return this;
    }

    public BmcKeySet apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getBmcKeySets().update(resourceGroupName, clusterName,
            bmcKeySetName, updateBmcKeySetUpdateParameters, context);
        return this;
    }
    ...
    public BmcKeySet refresh() {
        this.innerObject = serviceManager.serviceClient().getBmcKeySets()
            .getWithResponse(resourceGroupName, clusterName, bmcKeySetName, Context.NONE).getValue();
        return this;
    }

    public BmcKeySet refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getBmcKeySets()
            .getWithResponse(resourceGroupName, clusterName, bmcKeySetName, context).getValue();
        return this;
    }
