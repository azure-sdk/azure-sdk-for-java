...
public interface Cluster {
    ...
    /**
     * Gets the commandOutputSettings property: CommandOutputSettings represents the settings for commands run within
     * the cluster such as bare metal machine run read-only commands.
     * 
    ...
    interface DefinitionStages {
        ...
        interface WithAggregatorOrSingleRackDefinition {
             ...
             * rack.
             * 
             * The rack definition that is intended to reflect only a single rack in a single rack cluster, or an
        ...
        interface WithCommandOutputSettings {
            /**
             * Specifies the commandOutputSettings property: CommandOutputSettings represents the settings for commands
             * run within the cluster such as bare metal machine run read-only commands.
             * 
             * The settings for commands run in this cluster, such as bare metal machine run read only commands and data
             * extracts..
             * 
             * @param commandOutputSettings CommandOutputSettings represents the settings for commands run within the
        ...
        interface WithComputeDeploymentThreshold {
             ...
             * 
             * The validation threshold indicating the allowable failures of compute machines during environment
