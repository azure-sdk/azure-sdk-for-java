    ...
    public void validate() {
        if (strategyType() == null) {
            throw LOGGER.logExceptionAsError(
                new IllegalArgumentException("Missing required property strategyType in model ClusterUpdateStrategy"));
        }
        if (thresholdType() == null) {
            throw LOGGER.logExceptionAsError(
                new IllegalArgumentException("Missing required property thresholdType in model ClusterUpdateStrategy"));
        }
    }
