...
public final class VolumeImpl implements Volume, Volume.Definition, Volume.Update {
    ...
    public Volume create() {
        this.innerObject = serviceManager.serviceClient().getVolumes().createOrUpdate(resourceGroupName, volumeName,
    ...
    public Volume apply() {
        this.innerObject = serviceManager.serviceClient().getVolumes()
            .updateWithResponse(resourceGroupName, volumeName, updateVolumeUpdateParameters, Context.NONE).getValue();
        return this;
    }

    public Volume apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getVolumes()
            .updateWithResponse(resourceGroupName, volumeName, updateVolumeUpdateParameters, context).getValue();
        return this;
    }
    ...
    public Volume refresh() {
        this.innerObject = serviceManager.serviceClient().getVolumes()
            .getByResourceGroupWithResponse(resourceGroupName, volumeName, Context.NONE).getValue();
        return this;
    }

    public Volume refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getVolumes()
            .getByResourceGroupWithResponse(resourceGroupName, volumeName, context).getValue();
        return this;
    }
