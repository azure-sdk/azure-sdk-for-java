...
public final class L2NetworkImpl implements L2Network, L2Network.Definition, L2Network.Update {
    ...
    public L2Network create() {
        this.innerObject = serviceManager.serviceClient().getL2Networks().createOrUpdate(resourceGroupName,
            l2NetworkName, this.innerModel(), Context.NONE);
        return this;
    }

    public L2Network create(Context context) {
        this.innerObject = serviceManager.serviceClient().getL2Networks().createOrUpdate(resourceGroupName,
            l2NetworkName, this.innerModel(), context);
        return this;
    }
    ...
    public L2Network apply() {
        this.innerObject = serviceManager.serviceClient().getL2Networks()
    ...
    public L2Network apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getL2Networks()
            .updateWithResponse(resourceGroupName, l2NetworkName, updateL2NetworkUpdateParameters, context).getValue();
        return this;
    }
    ...
    public L2Network refresh() {
        this.innerObject = serviceManager.serviceClient().getL2Networks()
            .getByResourceGroupWithResponse(resourceGroupName, l2NetworkName, Context.NONE).getValue();
        return this;
    }

    public L2Network refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getL2Networks()
            .getByResourceGroupWithResponse(resourceGroupName, l2NetworkName, context).getValue();
        return this;
    }
