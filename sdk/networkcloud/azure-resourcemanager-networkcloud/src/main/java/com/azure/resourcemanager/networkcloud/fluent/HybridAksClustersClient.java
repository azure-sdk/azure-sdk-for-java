...
public interface HybridAksClustersClient {
    ...
    Response<HybridAksClusterInner> getByResourceGroupWithResponse(String resourceGroupName,
    ...
    SyncPoller<PollResult<HybridAksClusterInner>, HybridAksClusterInner> beginCreateOrUpdate(String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<HybridAksClusterInner> updateWithResponse(String resourceGroupName, String hybridAksClusterName,
