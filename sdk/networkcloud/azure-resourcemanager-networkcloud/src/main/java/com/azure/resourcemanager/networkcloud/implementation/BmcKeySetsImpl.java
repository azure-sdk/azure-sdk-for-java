...
public final class BmcKeySetsImpl implements BmcKeySets {
    ...
    public PagedIterable<BmcKeySet> listBySubscription(String clusterName) {
        PagedIterable<BmcKeySetInner> inner = this.serviceClient().listBySubscription(clusterName);
        return Utils.mapPage(inner, inner1 -> new BmcKeySetImpl(inner1, this.manager()));
    }

    public PagedIterable<BmcKeySet> listBySubscription(String clusterName, Context context) {
        PagedIterable<BmcKeySetInner> inner = this.serviceClient().listBySubscription(clusterName, context);
        return Utils.mapPage(inner, inner1 -> new BmcKeySetImpl(inner1, this.manager()));
    }

    public PagedIterable<BmcKeySet> listByResourceGroup(String resourceGroupName, String clusterName) {
        PagedIterable<BmcKeySetInner> inner = this.serviceClient().listByResourceGroup(resourceGroupName, clusterName);
        return Utils.mapPage(inner, inner1 -> new BmcKeySetImpl(inner1, this.manager()));
    }

    public PagedIterable<BmcKeySet> listByResourceGroup(String resourceGroupName, String clusterName, Context context) {
