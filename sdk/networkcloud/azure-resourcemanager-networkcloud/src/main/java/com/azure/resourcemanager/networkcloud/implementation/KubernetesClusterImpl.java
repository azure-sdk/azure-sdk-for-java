...
public final class KubernetesClusterImpl
    ...
    public KubernetesCluster create() {
        this.innerObject = serviceManager.serviceClient().getKubernetesClusters().createOrUpdate(resourceGroupName,
            kubernetesClusterName, this.innerModel(), Context.NONE);
        return this;
    }

    public KubernetesCluster create(Context context) {
        this.innerObject = serviceManager.serviceClient().getKubernetesClusters().createOrUpdate(resourceGroupName,
            kubernetesClusterName, this.innerModel(), context);
        return this;
    }
    ...
    public KubernetesCluster apply() {
        this.innerObject = serviceManager.serviceClient().getKubernetesClusters().update(resourceGroupName,
            kubernetesClusterName, updateKubernetesClusterUpdateParameters, Context.NONE);
        return this;
    }

    public KubernetesCluster apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getKubernetesClusters().update(resourceGroupName,
            kubernetesClusterName, updateKubernetesClusterUpdateParameters, context);
        return this;
    }
    ...
    public KubernetesCluster refresh() {
        this.innerObject = serviceManager.serviceClient().getKubernetesClusters()
            .getByResourceGroupWithResponse(resourceGroupName, kubernetesClusterName, Context.NONE).getValue();
        return this;
    }

    public KubernetesCluster refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getKubernetesClusters()
            .getByResourceGroupWithResponse(resourceGroupName, kubernetesClusterName, context).getValue();
        return this;
    }

    public OperationStatusResult
        restartNode(KubernetesClusterRestartNodeParameters kubernetesClusterRestartNodeParameters) {
        return serviceManager.kubernetesClusters().restartNode(resourceGroupName, kubernetesClusterName,
