...
public final class L3NetworkImpl implements L3Network, L3Network.Definition, L3Network.Update {
    ...
    public L3Network create() {
        this.innerObject = serviceManager.serviceClient().getL3Networks().createOrUpdate(resourceGroupName,
            l3NetworkName, this.innerModel(), Context.NONE);
        return this;
    }

    public L3Network create(Context context) {
        this.innerObject = serviceManager.serviceClient().getL3Networks().createOrUpdate(resourceGroupName,
            l3NetworkName, this.innerModel(), context);
        return this;
    }
    ...
    public L3Network apply() {
        this.innerObject = serviceManager.serviceClient().getL3Networks()
    ...
    public L3Network apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getL3Networks()
            .updateWithResponse(resourceGroupName, l3NetworkName, updateL3NetworkUpdateParameters, context).getValue();
        return this;
    }
    ...
    public L3Network refresh() {
        this.innerObject = serviceManager.serviceClient().getL3Networks()
            .getByResourceGroupWithResponse(resourceGroupName, l3NetworkName, Context.NONE).getValue();
        return this;
    }

    public L3Network refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getL3Networks()
            .getByResourceGroupWithResponse(resourceGroupName, l3NetworkName, context).getValue();
        return this;
    }
