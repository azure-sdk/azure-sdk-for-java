...
public final class TrunkedNetworksClientImpl implements TrunkedNetworksClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<TrunkedNetworkInner>, TrunkedNetworkInner>
        beginCreateOrUpdateAsync(String resourceGroupName, String trunkedNetworkName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<TrunkedNetworkInner>, TrunkedNetworkInner>
        beginCreateOrUpdate(String resourceGroupName, String trunkedNetworkName) {
        final TrunkedNetworkInner trunkedNetworkParameters = null;
