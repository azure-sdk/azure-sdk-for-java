...
public final class VirtualMachineProperties {
    ...
    /*
     * The resource ID of the bare metal machine or edge cluster node that hosts the virtual machine.
     */
    ...
    /**
     * Get the bareMetalMachineId property: The resource ID of the bare metal machine or edge cluster node that hosts
     * the virtual machine.
     * 
