...
public final class HybridAksClusterImpl
    ...
    public HybridAksCluster create() {
        this.innerObject = serviceManager.serviceClient().getHybridAksClusters().createOrUpdate(resourceGroupName,
            hybridAksClusterName, this.innerModel(), Context.NONE);
        return this;
    }

    public HybridAksCluster create(Context context) {
        this.innerObject = serviceManager.serviceClient().getHybridAksClusters().createOrUpdate(resourceGroupName,
            hybridAksClusterName, this.innerModel(), context);
        return this;
    }
    ...
    public HybridAksCluster apply() {
        this.innerObject = serviceManager.serviceClient().getHybridAksClusters().updateWithResponse(resourceGroupName,
            hybridAksClusterName, updateHybridAksClusterUpdateParameters, Context.NONE).getValue();
        return this;
    }

    public HybridAksCluster apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getHybridAksClusters().updateWithResponse(resourceGroupName,
            hybridAksClusterName, updateHybridAksClusterUpdateParameters, context).getValue();
        return this;
    }

    HybridAksClusterImpl(HybridAksClusterInner innerObject,
    ...
    public HybridAksCluster refresh() {
        this.innerObject = serviceManager.serviceClient().getHybridAksClusters()
            .getByResourceGroupWithResponse(resourceGroupName, hybridAksClusterName, Context.NONE).getValue();
        return this;
    }

    public HybridAksCluster refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getHybridAksClusters()
            .getByResourceGroupWithResponse(resourceGroupName, hybridAksClusterName, context).getValue();
        return this;
    }
