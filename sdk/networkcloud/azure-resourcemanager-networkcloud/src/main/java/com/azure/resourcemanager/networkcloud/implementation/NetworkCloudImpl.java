...
public final class NetworkCloudImpl implements NetworkCloud {
    ...
    /**
     * The EdgeClusterMachineSkusClient object to access its operations.
     */
    private final EdgeClusterMachineSkusClient edgeClusterMachineSkus;
     ...
     */
    public EdgeClusterMachineSkusClient getEdgeClusterMachineSkus() {
        return this.edgeClusterMachineSkus;
    }

    /**
     * The EdgeClusterRuntimeVersionsClient object to access its operations.
     */
    private final EdgeClusterRuntimeVersionsClient edgeClusterRuntimeVersions;
     ...
     */
    public EdgeClusterRuntimeVersionsClient getEdgeClusterRuntimeVersions() {
        return this.edgeClusterRuntimeVersions;
    }

    /**
     * The EdgeClusterSkusClient object to access its operations.
     */
    private final EdgeClusterSkusClient edgeClusterSkus;
     ...
     */
    public EdgeClusterSkusClient getEdgeClusterSkus() {
        return this.edgeClusterSkus;
    }

    /**
     * The EdgeClustersClient object to access its operations.
     */
    private final EdgeClustersClient edgeClusters;
     ...
     */
    public EdgeClustersClient getEdgeClusters() {
        return this.edgeClusters;
    }
    ...
    /**
     * The RegistrationHubsClient object to access its operations.
     */
    private final RegistrationHubsClient registrationHubs;
     ...
     */
    public RegistrationHubsClient getRegistrationHubs() {
        return this.registrationHubs;
    }
    ...
    /**
     * The EdgeClusterNodesClient object to access its operations.
     */
    private final EdgeClusterNodesClient edgeClusterNodes;
     ...
     */
    public EdgeClusterNodesClient getEdgeClusterNodes() {
        return this.edgeClusterNodes;
    }
    ...
    /**
     * The RegistrationHubImagesClient object to access its operations.
     */
    private final RegistrationHubImagesClient registrationHubImages;
     ...
     */
    public RegistrationHubImagesClient getRegistrationHubImages() {
        return this.registrationHubImages;
    }

    /**
     * The RegistrationHubMachinesClient object to access its operations.
     */
    private final RegistrationHubMachinesClient registrationHubMachines;
     ...
     */
    public RegistrationHubMachinesClient getRegistrationHubMachines() {
        return this.registrationHubMachines;
    }
    ...
    NetworkCloudImpl(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter, Duration defaultPollInterval,
        ...
        this.edgeClusterMachineSkus = new EdgeClusterMachineSkusClientImpl(this);
        this.edgeClusterRuntimeVersions = new EdgeClusterRuntimeVersionsClientImpl(this);
        this.edgeClusterSkus = new EdgeClusterSkusClientImpl(this);
        this.edgeClusters = new EdgeClustersClientImpl(this);
        ...
        this.registrationHubs = new RegistrationHubsClientImpl(this);
        ...
        this.edgeClusterNodes = new EdgeClusterNodesClientImpl(this);
        this.agentPools = new AgentPoolsClientImpl(this);
        this.kubernetesClusterFeatures = new KubernetesClusterFeaturesClientImpl(this);
        this.registrationHubImages = new RegistrationHubImagesClientImpl(this);
        this.registrationHubMachines = new RegistrationHubMachinesClientImpl(this);
