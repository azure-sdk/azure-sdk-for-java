...
public final class MetricsConfigurationsClientImpl implements MetricsConfigurationsClient {
    ...
    public interface MetricsConfigurationsService {
        ...
        @Get("/subscriptions/{subscriptionId}/providers/Microsoft.NetworkCloud/clusters/{clusterName}/metricsConfigurations")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ClusterMetricsConfigurationList>> listBySubscription(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ClusterMetricsConfigurationList>> listByResourceGroup(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
     ...
     * @return a list of metrics configurations of the cluster in the provided subscription along with
     * {@link PagedResponse} on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<ClusterMetricsConfigurationInner>>
        listBySubscriptionSinglePageAsync(String clusterName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<ClusterMetricsConfigurationInner>> listBySubscriptionSinglePageAsync(String clusterName,
        Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a list of metrics configurations of the clusters in the provided resource group along with
     * {@link PagedResponse} on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<ClusterMetricsConfigurationInner>>
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<ClusterMetricsConfigurationInner> listByResourceGroupAsync(String resourceGroupName,
        String clusterName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<ClusterMetricsConfigurationInner> listByResourceGroup(String resourceGroupName,
        String clusterName) {
    ...
    public SyncPoller<PollResult<ClusterMetricsConfigurationInner>, ClusterMetricsConfigurationInner>
        ...
        final ClusterMetricsConfigurationInner metricsConfigurationParameters = null;
        return this.beginCreateOrUpdateAsync(resourceGroupName, clusterName, metricsConfigurationName,
    ...
    public SyncPoller<PollResult<ClusterMetricsConfigurationInner>, ClusterMetricsConfigurationInner>
        beginCreateOrUpdate(String resourceGroupName, String clusterName, String metricsConfigurationName,
            ClusterMetricsConfigurationInner metricsConfigurationParameters, Context context) {
        return this.beginCreateOrUpdateAsync(resourceGroupName, clusterName, metricsConfigurationName,
            metricsConfigurationParameters, context).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<ClusterMetricsConfigurationInner>, ClusterMetricsConfigurationInner>
        ...
        final ClusterMetricsConfigurationPatchParameters metricsConfigurationUpdateParameters = null;
        return this.beginUpdateAsync(resourceGroupName, clusterName, metricsConfigurationName,
            metricsConfigurationUpdateParameters).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<ClusterMetricsConfigurationInner>, ClusterMetricsConfigurationInner> beginUpdate(
        ...
        ClusterMetricsConfigurationPatchParameters metricsConfigurationUpdateParameters, Context context) {
        return this.beginUpdateAsync(resourceGroupName, clusterName, metricsConfigurationName,
            metricsConfigurationUpdateParameters, context).getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<ClusterMetricsConfigurationInner>> listBySubscriptionNextSinglePageAsync(String nextLink,
        Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
