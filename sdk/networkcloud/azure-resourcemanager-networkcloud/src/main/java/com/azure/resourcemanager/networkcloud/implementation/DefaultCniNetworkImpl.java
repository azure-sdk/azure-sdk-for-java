...
public final class DefaultCniNetworkImpl
    ...
    public DefaultCniNetwork create() {
        this.innerObject = serviceManager.serviceClient().getDefaultCniNetworks().createOrUpdate(resourceGroupName,
            defaultCniNetworkName, this.innerModel(), Context.NONE);
        return this;
    }

    public DefaultCniNetwork create(Context context) {
        this.innerObject = serviceManager.serviceClient().getDefaultCniNetworks().createOrUpdate(resourceGroupName,
            defaultCniNetworkName, this.innerModel(), context);
        return this;
    }
    ...
    public DefaultCniNetwork apply() {
        this.innerObject = serviceManager.serviceClient().getDefaultCniNetworks().updateWithResponse(resourceGroupName,
            defaultCniNetworkName, updateDefaultCniNetworkUpdateParameters, Context.NONE).getValue();
        return this;
    }

    public DefaultCniNetwork apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getDefaultCniNetworks().updateWithResponse(resourceGroupName,
            defaultCniNetworkName, updateDefaultCniNetworkUpdateParameters, context).getValue();
        return this;
    }

    DefaultCniNetworkImpl(DefaultCniNetworkInner innerObject,
    ...
    public DefaultCniNetwork refresh() {
        this.innerObject = serviceManager.serviceClient().getDefaultCniNetworks()
            .getByResourceGroupWithResponse(resourceGroupName, defaultCniNetworkName, Context.NONE).getValue();
        return this;
    }

    public DefaultCniNetwork refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getDefaultCniNetworks()
            .getByResourceGroupWithResponse(resourceGroupName, defaultCniNetworkName, context).getValue();
        return this;
    }
