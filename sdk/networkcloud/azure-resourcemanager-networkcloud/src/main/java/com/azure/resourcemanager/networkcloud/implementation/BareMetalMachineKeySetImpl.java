...
public final class BareMetalMachineKeySetImpl
    ...
    public BareMetalMachineKeySet create() {
        this.innerObject = serviceManager.serviceClient().getBareMetalMachineKeySets().createOrUpdate(resourceGroupName,
            clusterName, bareMetalMachineKeySetName, this.innerModel(), Context.NONE);
        return this;
    }

    public BareMetalMachineKeySet create(Context context) {
        this.innerObject = serviceManager.serviceClient().getBareMetalMachineKeySets().createOrUpdate(resourceGroupName,
            clusterName, bareMetalMachineKeySetName, this.innerModel(), context);
        return this;
    }
    ...
    public BareMetalMachineKeySet apply() {
        this.innerObject = serviceManager.serviceClient().getBareMetalMachineKeySets().update(resourceGroupName,
            clusterName, bareMetalMachineKeySetName, updateBareMetalMachineKeySetUpdateParameters, Context.NONE);
        return this;
    }

    public BareMetalMachineKeySet apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getBareMetalMachineKeySets().update(resourceGroupName,
            clusterName, bareMetalMachineKeySetName, updateBareMetalMachineKeySetUpdateParameters, context);
        return this;
    }
    ...
    public BareMetalMachineKeySet refresh() {
        this.innerObject = serviceManager.serviceClient().getBareMetalMachineKeySets()
            .getWithResponse(resourceGroupName, clusterName, bareMetalMachineKeySetName, Context.NONE).getValue();
        return this;
    }

    public BareMetalMachineKeySet refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getBareMetalMachineKeySets()
            .getWithResponse(resourceGroupName, clusterName, bareMetalMachineKeySetName, context).getValue();
        return this;
    }
