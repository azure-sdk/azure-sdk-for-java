...
/**
 * DefaultCniNetwork represents the user-managed portions of the default CNI (pod) network that is created in support
 * of a Hybrid AKS Cluster.
 */
@Fluent
public final class DefaultCniNetworkInner extends Resource {
    ...
    /**
     * Get the cniAsNumber property: The autonomous system number that the fabric expects to peer with, derived from
    ...
    /**
     * Get the ipv4ConnectedPrefix property: The IPV4 prefix (CIDR) assigned to this default CNI network. It is
    ...
    /**
     * Set the ipv4ConnectedPrefix property: The IPV4 prefix (CIDR) assigned to this default CNI network. It is
     * required when the IP allocation type
     * is IPV4 or DualStack.
     * 
    ...
    /**
     * Get the ipv6ConnectedPrefix property: The IPV6 prefix (CIDR) assigned to this default CNI network. It is
     * required when the IP allocation type
    ...
    /**
     * Set the ipv6ConnectedPrefix property: The IPV6 prefix (CIDR) assigned to this default CNI network. It is
     * required when the IP allocation type
     * is IPV6 or DualStack.
     * 
