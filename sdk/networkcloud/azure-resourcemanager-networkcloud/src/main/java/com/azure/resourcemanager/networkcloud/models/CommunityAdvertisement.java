    ...
    public void validate() {
        if (communities() == null) {
            throw LOGGER.logExceptionAsError(
                new IllegalArgumentException("Missing required property communities in model CommunityAdvertisement"));
        }
        if (subnetPrefix() == null) {
            throw LOGGER.logExceptionAsError(
                new IllegalArgumentException("Missing required property subnetPrefix in model CommunityAdvertisement"));
        }
    }
