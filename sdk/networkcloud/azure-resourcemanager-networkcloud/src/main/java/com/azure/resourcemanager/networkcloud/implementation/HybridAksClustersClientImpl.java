...
public final class HybridAksClustersClientImpl implements HybridAksClustersClient {
    ...
    public interface HybridAksClustersService {
        ...
        Mono<Response<HybridAksClusterList>> list(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @HeaderParam("Accept") String accept, Context context);

        @Headers({ "Content-Type: application/json" })
        @Get("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetworkCloud/hybridAksClusters")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<HybridAksClusterList>> listByResourceGroup(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @HeaderParam("Accept") String accept,
            Context context);

        @Headers({ "Content-Type: application/json" })
        @Get("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetworkCloud/hybridAksClusters/{hybridAksClusterName}")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<HybridAksClusterInner>> getByResourceGroup(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("hybridAksClusterName") String hybridAksClusterName, @HeaderParam("Accept") String accept,
            Context context);

        @Headers({ "Content-Type: application/json" })
        @Put("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetworkCloud/hybridAksClusters/{hybridAksClusterName}")
        ...
        @Headers({ "Content-Type: application/json" })
        @Delete("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetworkCloud/hybridAksClusters/{hybridAksClusterName}")
        ...
        @Headers({ "Content-Type: application/json" })
        @Patch("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetworkCloud/hybridAksClusters/{hybridAksClusterName}")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<HybridAksClusterInner>> update(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("hybridAksClusterName") String hybridAksClusterName,
        ...
        @Headers({ "Content-Type: application/json" })
        @Post("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetworkCloud/hybridAksClusters/{hybridAksClusterName}/restartNode")
    ...
    private Mono<PagedResponse<HybridAksClusterInner>> listSinglePageAsync() {
        ...
        return FluxUtil
            ...
            .<PagedResponse<HybridAksClusterInner>>map(res -> new PagedResponseBase<>(res.getRequest(),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<HybridAksClusterInner>> getByResourceGroupWithResponseAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(context -> service.getByResourceGroup(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, hybridAksClusterName, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<HybridAksClusterInner>> getByResourceGroupWithResponseAsync(String resourceGroupName,
        String hybridAksClusterName, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the additional details related to the provided Hybrid AKS provisioned cluster along with
     * {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<HybridAksClusterInner> getByResourceGroupWithResponse(String resourceGroupName,
        String hybridAksClusterName, Context context) {
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return hybridAksCluster represents the additional details regarding the Hybrid AKS cluster along with
     * {@link Response} on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String resourceGroupName,
        String hybridAksClusterName, HybridAksClusterInner hybridAksClusterParameters) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return FluxUtil
            .withContext(context -> service.createOrUpdate(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, hybridAksClusterName, hybridAksClusterParameters,
                accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String resourceGroupName,
        String hybridAksClusterName, HybridAksClusterInner hybridAksClusterParameters, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    private PollerFlux<PollResult<HybridAksClusterInner>, HybridAksClusterInner> beginCreateOrUpdateAsync(
        ...
        return this.client.<HybridAksClusterInner, HybridAksClusterInner>getLroResult(mono,
            this.client.getHttpPipeline(), HybridAksClusterInner.class, HybridAksClusterInner.class,
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<HybridAksClusterInner>, HybridAksClusterInner>
        beginCreateOrUpdateAsync(String resourceGroupName, String hybridAksClusterName) {
    ...
    private PollerFlux<PollResult<HybridAksClusterInner>, HybridAksClusterInner> beginCreateOrUpdateAsync(
        ...
        Context context) {
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono = createOrUpdateWithResponseAsync(resourceGroupName, hybridAksClusterName,
            hybridAksClusterParameters, context);
        return this.client.<HybridAksClusterInner, HybridAksClusterInner>getLroResult(mono,
            this.client.getHttpPipeline(), HybridAksClusterInner.class, HybridAksClusterInner.class, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<HybridAksClusterInner>, HybridAksClusterInner>
        beginCreateOrUpdate(String resourceGroupName, String hybridAksClusterName) {
        final HybridAksClusterInner hybridAksClusterParameters = null;
        return this.beginCreateOrUpdateAsync(resourceGroupName, hybridAksClusterName, hybridAksClusterParameters)
            .getSyncPoller();
    }
    ...
    private Mono<HybridAksClusterInner> createOrUpdateAsync(String resourceGroupName, String hybridAksClusterName,
        ...
        return beginCreateOrUpdateAsync(resourceGroupName, hybridAksClusterName, hybridAksClusterParameters).last()
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<HybridAksClusterInner> createOrUpdateAsync(String resourceGroupName, String hybridAksClusterName,
        HybridAksClusterInner hybridAksClusterParameters, Context context) {
    ...
    private Mono<Response<Flux<ByteBuffer>>> deleteWithResponseAsync(String resourceGroupName,
        ...
        return service.delete(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, hybridAksClusterName, accept, context);
    }
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String hybridAksClusterName) {
        return beginDeleteAsync(resourceGroupName, hybridAksClusterName).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String hybridAksClusterName, Context context) {
        return beginDeleteAsync(resourceGroupName, hybridAksClusterName, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<HybridAksClusterInner>> updateWithResponseAsync(String resourceGroupName,
        String hybridAksClusterName, HybridAksClusterPatchParameters hybridAksClusterUpdateParameters) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return FluxUtil
            .withContext(context -> service.update(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, hybridAksClusterName,
                hybridAksClusterUpdateParameters, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<HybridAksClusterInner>> updateWithResponseAsync(String resourceGroupName,
        ...
        return service.update(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, hybridAksClusterName, hybridAksClusterUpdateParameters, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<HybridAksClusterInner> updateWithResponse(String resourceGroupName, String hybridAksClusterName,
        HybridAksClusterPatchParameters hybridAksClusterUpdateParameters, Context context) {
        return updateWithResponseAsync(resourceGroupName, hybridAksClusterName, hybridAksClusterUpdateParameters,
            context).block();
    }
    ...
    public HybridAksClusterInner update(String resourceGroupName, String hybridAksClusterName) {
        final HybridAksClusterPatchParameters hybridAksClusterUpdateParameters = null;
        return updateWithResponse(resourceGroupName, hybridAksClusterName, hybridAksClusterUpdateParameters,
    ...
    private Mono<Response<Flux<ByteBuffer>>> restartNodeWithResponseAsync(String resourceGroupName,
        String hybridAksClusterName, HybridAksClusterRestartNodeParameters hybridAksClusterRestartNodeParameters) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return FluxUtil
            .withContext(context -> service.restartNode(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, hybridAksClusterName,
                hybridAksClusterRestartNodeParameters, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<Void>, Void> beginRestartNodeAsync(String resourceGroupName,
        String hybridAksClusterName, HybridAksClusterRestartNodeParameters hybridAksClusterRestartNodeParameters) {
        Mono<Response<Flux<ByteBuffer>>> mono = restartNodeWithResponseAsync(resourceGroupName, hybridAksClusterName,
    ...
    private PollerFlux<PollResult<Void>, Void> beginRestartNodeAsync(String resourceGroupName,
        ...
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono = restartNodeWithResponseAsync(resourceGroupName, hybridAksClusterName,
            hybridAksClusterRestartNodeParameters, context);
        return this.client.<Void, Void>getLroResult(mono, this.client.getHttpPipeline(), Void.class, Void.class,
            context);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginRestartNode(String resourceGroupName, String hybridAksClusterName,
        ...
        return this.beginRestartNodeAsync(resourceGroupName, hybridAksClusterName,
            hybridAksClusterRestartNodeParameters, context).getSyncPoller();
    }
