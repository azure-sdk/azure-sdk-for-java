...
public interface BareMetalMachine {
    ...
    interface DefinitionStages {
         ...
         */
        interface WithCreate extends DefinitionStages.WithTags, DefinitionStages.WithHardwareInventory,
            DefinitionStages.WithHardwareValidationStatus {
            /**
        ...
        /**
         * The stage of the BareMetalMachine definition allowing to specify hardwareInventory.
         */
        interface WithHardwareInventory {
            /**
             * Specifies the hardwareInventory property: HardwareInventory represents the hardware configuration of this
             * machine as exposed to the customer, including information acquired from the model/sku information and
             * from the ironic inspector..
             * 
             * @param hardwareInventory HardwareInventory represents the hardware configuration of this machine as
             * exposed to the customer, including information acquired from the model/sku information and from the
             * ironic inspector.
             * @return the next definition stage.
             */
            WithCreate withHardwareInventory(HardwareInventory hardwareInventory);
        }

        /**
         * The stage of the BareMetalMachine definition allowing to specify hardwareValidationStatus.
         */
        interface WithHardwareValidationStatus {
            /**
             * Specifies the hardwareValidationStatus property: HardwareValidationStatus represents the latest hardware
             * validation details performed for this bare metal machine..
             * 
             * @param hardwareValidationStatus HardwareValidationStatus represents the latest hardware validation
             * details performed for this bare metal machine.
             * @return the next definition stage.
             */
            WithCreate withHardwareValidationStatus(HardwareValidationStatus hardwareValidationStatus);
        }
    }
