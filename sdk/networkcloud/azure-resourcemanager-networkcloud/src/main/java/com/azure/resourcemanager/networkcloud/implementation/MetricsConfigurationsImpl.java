...
public final class MetricsConfigurationsImpl implements MetricsConfigurations {
    ...
    public PagedIterable<ClusterMetricsConfiguration> listByResourceGroup(String resourceGroupName,
        String clusterName) {
        PagedIterable<ClusterMetricsConfigurationInner> inner
    ...
    public PagedIterable<ClusterMetricsConfiguration> listByResourceGroup(String resourceGroupName, String clusterName,
        Context context) {
        PagedIterable<ClusterMetricsConfigurationInner> inner
