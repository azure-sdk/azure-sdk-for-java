...
public final class ClusterManagerImpl implements ClusterManager, ClusterManager.Definition, ClusterManager.Update {
    ...
    public ClusterManager create() {
        this.innerObject = serviceManager.serviceClient().getClusterManagers().createOrUpdate(resourceGroupName,
            clusterManagerName, this.innerModel(), Context.NONE);
        return this;
    }

    public ClusterManager create(Context context) {
        this.innerObject = serviceManager.serviceClient().getClusterManagers().createOrUpdate(resourceGroupName,
            clusterManagerName, this.innerModel(), context);
        return this;
    }
    ...
    public ClusterManager apply() {
        this.innerObject = serviceManager.serviceClient().getClusterManagers().updateWithResponse(resourceGroupName,
            clusterManagerName, updateClusterManagerUpdateParameters, Context.NONE).getValue();
        return this;
    }

    public ClusterManager apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getClusterManagers()
    ...
    public ClusterManager refresh() {
        this.innerObject = serviceManager.serviceClient().getClusterManagers()
            .getByResourceGroupWithResponse(resourceGroupName, clusterManagerName, Context.NONE).getValue();
        return this;
    }

    public ClusterManager refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getClusterManagers()
            .getByResourceGroupWithResponse(resourceGroupName, clusterManagerName, context).getValue();
        return this;
    }
