...
public final class CniBgpConfiguration {
    ...
    /**
     * Get the bgpPeers property: The list of BgpPeer entities that the Hybrid AKS cluster will peer with in addition
     * to peering that occurs automatically with the switch fabric.
     * 
    ...
    /**
     * Set the bgpPeers property: The list of BgpPeer entities that the Hybrid AKS cluster will peer with in addition
     * to peering that occurs automatically with the switch fabric.
     * 
    ...
    /**
     * Get the serviceExternalPrefixes property: The subnet blocks in CIDR format for Kubernetes service external IPs
    ...
    /**
     * Set the serviceExternalPrefixes property: The subnet blocks in CIDR format for Kubernetes service external IPs
     * to be advertised over BGP.
     * 
     ...
     * Load balancer IPs will only be advertised if they
     * are within one of these blocks.
     * 
