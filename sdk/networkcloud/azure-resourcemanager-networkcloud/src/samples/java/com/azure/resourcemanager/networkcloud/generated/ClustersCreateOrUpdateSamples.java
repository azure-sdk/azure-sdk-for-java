...
public final class ClustersCreateOrUpdateSamples {
    /*
     * x-ms-original-file:
     * specification/networkcloud/resource-manager/Microsoft.NetworkCloud/stable/2023-07-01/examples/Clusters_Create.
     * json
     */
    /**
    ...
    public static void createOrUpdateCluster(com.azure.resourcemanager.networkcloud.NetworkCloudManager manager) {
        manager.clusters().define("clusterName").withRegion("location").withExistingResourceGroup("resourceGroupName")
            ...
            .withAggregatorOrSingleRackDefinition(new RackDefinition()
                .withBareMetalMachineConfigurationData(Arrays.asList(
                    ...
                    new BareMetalMachineConfigurationData()
                        .withBmcCredentials(new AdministrativeCredentials()
                            .withPassword("fakeTokenPlaceholder").withUsername("username"))
                ...
                .withRackLocation("Foo Datacenter, Floor 3, Aisle 9, Rack 2").withRackSerialNumber("AA1234")
                .withRackSkuId(
            ...
            .withClusterType(ClusterType.SINGLE_RACK).withClusterVersion("1.0.0")
            .withNetworkFabricId(
            ...
            .withClusterServicePrincipal(
                new ServicePrincipalInformation().withApplicationId("12345678-1234-1234-1234-123456789012")
                    .withPassword("fakeTokenPlaceholder").withPrincipalId("00000008-0004-0004-0004-000000000012")
