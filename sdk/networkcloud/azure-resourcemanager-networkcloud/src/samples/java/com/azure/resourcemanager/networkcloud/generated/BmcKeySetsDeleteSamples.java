...
public final class BmcKeySetsDeleteSamples {
    /*
     * x-ms-original-file:
     * specification/networkcloud/resource-manager/Microsoft.NetworkCloud/stable/2023-07-01/examples/BmcKeySets_Delete.
     * json
     */
    /**
    ...
    public static void deleteBaseboardManagementControllerKeySetOfCluster(
        ...
        manager.bmcKeySets().delete("resourceGroupName", "clusterName", "bmcKeySetName",
