...
public final class TrunkedNetworksCreateOrUpdateSamples {
    ...
    public static void
        ...
        manager.trunkedNetworks().define("trunkedNetworkName").withRegion("location")
            ...
            .withTags(mapOf("key1", "fakeTokenPlaceholder", "key2", "fakeTokenPlaceholder")).withInterfaceName("eth0")
            .create();
    }
