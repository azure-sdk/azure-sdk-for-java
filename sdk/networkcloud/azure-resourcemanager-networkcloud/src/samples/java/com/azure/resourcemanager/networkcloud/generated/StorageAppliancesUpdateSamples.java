...
public final class StorageAppliancesUpdateSamples {
    ...
    public static void patchStorageAppliance(com.azure.resourcemanager.networkcloud.NetworkCloudManager manager) {
        StorageAppliance resource = manager.storageAppliances().getByResourceGroupWithResponse("resourceGroupName",
            "storageApplianceName", com.azure.core.util.Context.NONE).getValue();
        resource.update().withTags(mapOf("key1", "fakeTokenPlaceholder", "key2", "fakeTokenPlaceholder"))
            .withSerialNumber("BM1219XXX").apply();
    }
