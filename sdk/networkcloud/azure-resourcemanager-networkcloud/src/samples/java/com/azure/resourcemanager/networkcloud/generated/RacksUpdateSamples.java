...
public final class RacksUpdateSamples {
    /*
     * x-ms-original-file:
     * specification/networkcloud/resource-manager/Microsoft.NetworkCloud/stable/2023-07-01/examples/Racks_Patch.json
     */
    /**
    ...
    public static void patchRack(com.azure.resourcemanager.networkcloud.NetworkCloudManager manager) {
        ...
        resource.update().withTags(mapOf("key1", "fakeTokenPlaceholder", "key2", "fakeTokenPlaceholder"))
            .withRackLocation("Rack 2B").withRackSerialNumber("RACK_SERIAL_NUMBER").apply();
    }
