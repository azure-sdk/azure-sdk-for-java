...
public final class ConsolesCreateOrUpdateSamples {
    /*
     * x-ms-original-file:
     * specification/networkcloud/resource-manager/Microsoft.NetworkCloud/stable/2023-07-01/examples/Consoles_Create.
     * json
     */
    /**
    ...
    public static void
        ...
        manager.consoles().define("default").withRegion("location")
            ...
            .withEnabled(ConsoleEnabled.TRUE).withSshPublicKey(new SshPublicKey().withKeyData("fakeTokenPlaceholder"))
            .withTags(mapOf("key1", "fakeTokenPlaceholder", "key2", "fakeTokenPlaceholder"))
            .withExpiration(OffsetDateTime.parse("2022-06-01T01:27:03.008Z")).create();
    }
