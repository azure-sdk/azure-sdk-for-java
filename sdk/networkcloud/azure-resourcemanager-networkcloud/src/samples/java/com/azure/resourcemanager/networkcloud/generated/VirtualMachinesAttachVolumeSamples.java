...
public final class VirtualMachinesAttachVolumeSamples {
     ...
     * VirtualMachines_AttachVolume.json
     */
    /**
     ...
     */
    public static void
        attachVolumeToVirtualMachine(com.azure.resourcemanager.networkcloud.NetworkCloudManager manager) {
        manager.virtualMachines().attachVolume("resourceGroupName", "virtualMachineName",
