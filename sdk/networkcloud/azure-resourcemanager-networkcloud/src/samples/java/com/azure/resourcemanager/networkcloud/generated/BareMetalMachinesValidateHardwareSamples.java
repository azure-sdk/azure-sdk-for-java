...
public final class BareMetalMachinesValidateHardwareSamples {
     ...
     * BareMetalMachines_ValidateHardware.json
     */
    /**
     ...
     */
    public static void
        validateTheBareMetalMachineHardware(com.azure.resourcemanager.networkcloud.NetworkCloudManager manager) {
        manager.bareMetalMachines().validateHardware(
            "resourceGroupName", "bareMetalMachineName", new BareMetalMachineValidateHardwareParameters()
