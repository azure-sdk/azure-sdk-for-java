...
public final class HybridAksClustersCreateOrUpdateSamples {
    ...
    public static void createOrUpdateHybridAKSProvisionedClusterData(
        ...
        manager.hybridAksClusters().define("hybridAksClusterName").withRegion("location")
            ...
            .withWorkerCount(8L).withTags(mapOf("key1", "fakeTokenPlaceholder", "key2", "fakeTokenPlaceholder"))
            .create();
    }
