...
public final class AgentPoolsUpdateSamples {
    /*
     * x-ms-original-file:
     * specification/networkcloud/resource-manager/Microsoft.NetworkCloud/stable/2023-07-01/examples/AgentPools_Patch.
     * json
     */
    /**
    ...
    public static void
        ...
        resource.update().withTags(mapOf("key1", "fakeTokenPlaceholder", "key2", "fakeTokenPlaceholder")).withCount(3L)
            .withUpgradeSettings(new AgentPoolUpgradeSettings().withMaxSurge("1")).apply();
    }
