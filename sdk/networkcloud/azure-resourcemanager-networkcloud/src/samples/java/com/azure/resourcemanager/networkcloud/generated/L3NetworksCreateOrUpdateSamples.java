...
public final class L3NetworksCreateOrUpdateSamples {
    /*
     * x-ms-original-file:
     * specification/networkcloud/resource-manager/Microsoft.NetworkCloud/stable/2023-07-01/examples/L3Networks_Create.
     * json
     */
    /**
    ...
    public static void createOrUpdateL3Network(com.azure.resourcemanager.networkcloud.NetworkCloudManager manager) {
        manager.l3Networks().define("l3NetworkName").withRegion("location")
            ...
            .withVlan(12L).withTags(mapOf("key1", "fakeTokenPlaceholder", "key2", "fakeTokenPlaceholder"))
            .withInterfaceName("eth0").withIpAllocationType(IpAllocationType.DUAL_STACK)
            .withIpv4ConnectedPrefix("198.51.100.0/24").withIpv6ConnectedPrefix("2001:db8::/64").create();
    }
