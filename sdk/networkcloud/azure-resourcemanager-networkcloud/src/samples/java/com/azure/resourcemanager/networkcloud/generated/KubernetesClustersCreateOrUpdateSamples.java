...
public final class KubernetesClustersCreateOrUpdateSamples {
    /*
     * x-ms-original-file:
     * specification/networkcloud/resource-manager/Microsoft.NetworkCloud/stable/2023-07-01/examples/
    ...
    public static void
        ...
        manager.kubernetesClusters().define("kubernetesClusterName").withRegion("location")
            ...
            .withControlPlaneNodeConfiguration(new ControlPlaneNodeConfiguration()
                ...
                .withAvailabilityZones(Arrays.asList("1", "2", "3")).withCount(3L).withVmSkuName("NC_G4_v1"))
            .withInitialAgentPoolConfigurations(Arrays.asList(new InitialAgentPoolConfiguration()
                ...
                .withAvailabilityZones(Arrays.asList("1", "2", "3")).withCount(3L)
                .withLabels(Arrays.asList(new KubernetesLabel().withKey("fakeTokenPlaceholder").withValue("true")))
                .withMode(AgentPoolMode.SYSTEM).withName("SystemPool-1")
                .withTaints(Arrays.asList(new KubernetesLabel().withKey("fakeTokenPlaceholder").withValue("true")))
                .withUpgradeSettings(new AgentPoolUpgradeSettings().withMaxSurge("1")).withVmSkuName("NC_M16_v1")))
            ...
            .withNetworkConfiguration(new NetworkConfiguration()
                ...
                .withBgpServiceLoadBalancerConfiguration(new BgpServiceLoadBalancerConfiguration()
                    .withBgpAdvertisements(Arrays.asList(new BgpAdvertisement()
                        .withAdvertiseToFabric(AdvertiseToFabric.TRUE).withCommunities(Arrays.asList("64512:100"))
                        .withIpAddressPools(Arrays.asList("pool1")).withPeers(Arrays.asList("peer1"))))
                    .withBgpPeers(Arrays.asList(new ServiceLoadBalancerBgpPeer().withBfdEnabled(BfdEnabled.FALSE)
                        .withBgpMultiHop(BgpMultiHop.FALSE).withHoldTime("P300s").withKeepAliveTime("P300s")
                        .withMyAsn(64512L).withName("peer1").withPeerAddress("203.0.113.254").withPeerAsn(64497L)
                        .withPeerPort(179L)))
                    .withFabricPeeringEnabled(FabricPeeringEnabled.TRUE).withIpAddressPools(
                        Arrays.asList(new IpAddressPool().withAddresses(Arrays.asList("198.51.102.0/24"))
                            .withAutoAssign(BfdEnabled.TRUE).withName("pool1").withOnlyUseHostIps(BfdEnabled.TRUE))))
                ...
                .withCniNetworkId(
                    "/subscriptions/123e4567-e89b-12d3-a456-426655440000/resourceGroups/resourceGroupName/providers/Microsoft.NetworkCloud/l3Networks/l3NetworkName")
                .withDnsServiceIp("198.51.101.2").withPodCidrs(Arrays.asList("198.51.100.0/24"))
