...
import com.azure.resourcemanager.elasticsan.fluent.ElasticSanClient;
import com.azure.resourcemanager.elasticsan.implementation.ElasticSanClientBuilder;
...
import com.azure.resourcemanager.elasticsan.implementation.SkusOperationGroupsImpl;
...
public final class ElasticSanManager {
    ...
    private SkusOperationGroups skusOperationGroups;

    private final ElasticSanClient clientObject;
    ...
    private ElasticSanManager(HttpPipeline httpPipeline, AzureProfile profile, Duration defaultPollInterval) {
        ...
        this.clientObject = new ElasticSanClientBuilder().pipeline(httpPipeline)
    ...
    /**
     * Gets the resource collection API of SkusOperationGroups.
     * 
     * @return Resource collection API of SkusOperationGroups.
     */
    public SkusOperationGroups skusOperationGroups() {
        if (this.skusOperationGroups == null) {
            this.skusOperationGroups = new SkusOperationGroupsImpl(clientObject.getSkusOperationGroups(), this);
        }
        return skusOperationGroups;
    }

    /**
     * Gets wrapped service client ElasticSanClient providing direct access to the underlying auto-generated API
     * implementation, based on Azure REST API.
     * 
     * @return Wrapped service client ElasticSanClient.
     */
    public ElasticSanClient serviceClient() {
