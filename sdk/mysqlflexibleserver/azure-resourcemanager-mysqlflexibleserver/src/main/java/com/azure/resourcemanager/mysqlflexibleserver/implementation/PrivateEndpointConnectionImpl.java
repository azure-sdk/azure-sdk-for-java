...
public final class PrivateEndpointConnectionImpl
    ...
    public PrivateEndpointConnectionImpl withExistingFlexibleServer(String resourceGroupName, String serverName) {
    ...
    PrivateEndpointConnectionImpl(
        String name, com.azure.resourcemanager.mysqlflexibleserver.MySqlManager serviceManager) {
