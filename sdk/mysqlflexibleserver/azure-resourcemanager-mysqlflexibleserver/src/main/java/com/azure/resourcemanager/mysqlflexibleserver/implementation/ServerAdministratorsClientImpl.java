...
import com.azure.resourcemanager.mysqlflexibleserver.models.ServerAdministratorResourceListResult;
...
public final class ServerAdministratorsClientImpl implements ServerAdministratorsClient {
     ...
     */
    ServerAdministratorsClientImpl(MySqlManagementClientImpl client) {
        this.service =
            RestProxy
    ...
    /**
     * The interface defining all the services for MySqlManagementClientServerAdministrators to be used by the proxy
