    ...
    public static OperationProgressResponseType fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            try (JsonReader readerToUse = reader.bufferObject()) {
                ...
                } else if ("RestoreSnapshotResponseSubTask".equals(discriminatorValue)) {
                    return RestoreSnapshotResponseSubTask.fromJson(readerToUse.reset());
                } else if ("RestoreSnapshotResponse".equals(discriminatorValue)) {
                    return RestoreSnapshotResponseType.fromJson(readerToUse.reset());
                } else {
