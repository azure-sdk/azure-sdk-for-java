...
public final class FirewallRuleImpl implements FirewallRule, FirewallRule.Definition, FirewallRule.Update {
    ...
    FirewallRuleImpl(String name, com.azure.resourcemanager.mysqlflexibleserver.MySqlManager serviceManager) {
    ...
    FirewallRuleImpl(
        FirewallRuleInner innerObject, com.azure.resourcemanager.mysqlflexibleserver.MySqlManager serviceManager) {
