...
import com.azure.resourcemanager.mysqlflexibleserver.models.WaitStatisticsResultList;
...
public final class WaitStatisticsClientImpl implements WaitStatisticsClient {
    ...
    /**
     * The interface defining all the services for MySqlManagementClientWaitStatistics to be used by the proxy service
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a list of wait statistics as paginated response with {@link PagedFlux}.
     */
