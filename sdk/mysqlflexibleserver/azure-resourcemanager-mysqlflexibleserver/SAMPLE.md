...
public final class AdvancedThreatProtectionSettingsGetSamples {
    /*
     * x-ms-original-file:
     * specification/mysql/resource-manager/Microsoft.DBforMySQL/FlexibleServers/preview/2024-02-01-preview/examples/
...
public final class AzureADAdministratorsCreateOrUpdateSamples {
    ...
    public static void
        ...
        manager.azureADAdministrators().define(AdministratorName.ACTIVE_DIRECTORY)
            ...
            .withSid("c6b82b90-a647-49cb-8a62-0d2d3cb7ac7c").withTenantId("c12b7025-bfe2-46c1-b463-993b5e4cd467")
...
public final class AzureADAdministratorsDeleteSamples {
    ...
    public static void
        ...
        manager.azureADAdministrators().delete("testrg", "mysqltestsvc4", AdministratorName.ACTIVE_DIRECTORY,
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class BackupsGetSamples {
    ...
    public static void getABackupForAServer(com.azure.resourcemanager.mysqlflexibleserver.MySqlManager manager) {
        manager.backups().getWithResponse("TestGroup", "mysqltestserver", "daily_20210615T160516",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class CheckNameAvailabilityExecuteSamples {
    /*
     * x-ms-original-file:
     * specification/mysql/resource-manager/Microsoft.DBforMySQL/ServiceOperations/preview/2023-12-01-preview/examples/
...
public final class ConfigurationsBatchUpdateSamples {
    ...
    public static void configurationList(com.azure.resourcemanager.mysqlflexibleserver.MySqlManager manager) {
        manager.configurations().batchUpdate("testrg", "mysqltestserver",
...
public final class ConfigurationsListByServerSamples {
    ...
    public static void
        ...
        manager.configurations().listByServer("testrg", "mysqltestserver", null, null, 1, 8,
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class FirewallRulesCreateOrUpdateSamples {
    ...
    public static void createAFirewallRule(com.azure.resourcemanager.mysqlflexibleserver.MySqlManager manager) {
        manager.firewallRules().define("rule1").withExistingFlexibleServer("TestGroup", "testserver")
...
public final class OperationResultsGetSamples {
    ...
    public static void operationResultsGet(com.azure.resourcemanager.mysqlflexibleserver.MySqlManager manager) {
        manager.operationResults().getWithResponse("westus", "00000000-0000-0000-0000-000000000000",
            com.azure.core.util.Context.NONE);
    }
}
```
