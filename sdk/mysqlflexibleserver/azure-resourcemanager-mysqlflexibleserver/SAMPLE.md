...
public final class AdvisorsGetSamples {
    /*
     * x-ms-original-file: specification/mysql/resource-manager/Microsoft.DBforMySQL/legacy/stable/2018-06-01/examples/AdvisorsGet.json
     */
    /**
...
public final class AdvisorsListByServerSamples {
    /*
     * x-ms-original-file: specification/mysql/resource-manager/Microsoft.DBforMySQL/legacy/stable/2018-06-01/examples/AdvisorsListByServer.json
     */
    /**
...
public final class CheckNameAvailabilityExecuteSamples {
    ...
    public static void nameAvailability(com.azure.resourcemanager.mysqlflexibleserver.MySqlManager manager) {
        manager
            ...
            .executeWithResponse(
                new NameAvailabilityRequest().withName("name1").withType("Microsoft.DBforMySQL"),
...
public final class DatabasesCreateOrUpdateSamples {
    /*
     * x-ms-original-file: specification/mysql/resource-manager/Microsoft.DBforMySQL/legacy/stable/2017-12-01/examples/DatabaseCreate.json
     */
    /**
...
public final class DatabasesGetSamples {
    /*
     * x-ms-original-file: specification/mysql/resource-manager/Microsoft.DBforMySQL/legacy/stable/2017-12-01/examples/DatabaseGet.json
     */
    /**
...
public final class DatabasesListByServerSamples {
    /*
     * x-ms-original-file: specification/mysql/resource-manager/Microsoft.DBforMySQL/legacy/stable/2017-12-01/examples/DatabaseListByServer.json
     */
    /**
...
public final class FirewallRulesCreateOrUpdateSamples {
    /*
     * x-ms-original-file: specification/mysql/resource-manager/Microsoft.DBforMySQL/legacy/stable/2017-12-01/examples/FirewallRuleCreate.json
     */
    /**
...
public final class LocationBasedRecommendedActionSessionsOperationStatusGetSamples {
    /*
     * x-ms-original-file: specification/mysql/resource-manager/Microsoft.DBforMySQL/legacy/stable/2018-06-01/examples/RecommendedActionSessionOperationStatus.json
     */
    /**
...
public final class OperationsListSamples {
    /*
     * x-ms-original-file: specification/mysql/resource-manager/Microsoft.DBforMySQL/legacy/stable/2017-12-01/examples/OperationList.json
     */
    /**
...
public final class PrivateEndpointConnectionsGetSamples {
    /*
     * x-ms-original-file: specification/mysql/resource-manager/Microsoft.DBforMySQL/legacy/stable/2018-06-01/examples/PrivateEndpointConnectionGet.json
     */
    /**
...
public final class PrivateEndpointConnectionsListByServerSamples {
    /*
     * x-ms-original-file: specification/mysql/resource-manager/Microsoft.DBforMySQL/legacy/stable/2018-06-01/examples/PrivateEndpointConnectionList.json
     */
    /**
...
public final class PrivateLinkResourcesGetSamples {
    /*
     * x-ms-original-file: specification/mysql/resource-manager/Microsoft.DBforMySQL/legacy/stable/2018-06-01/examples/PrivateLinkResourcesGet.json
     */
    /**
...
public final class PrivateLinkResourcesListByServerSamples {
    /*
     * x-ms-original-file: specification/mysql/resource-manager/Microsoft.DBforMySQL/legacy/stable/2018-06-01/examples/PrivateLinkResourcesList.json
     */
    /**
...
public final class QueryTextsGetSamples {
    /*
     * x-ms-original-file: specification/mysql/resource-manager/Microsoft.DBforMySQL/legacy/stable/2018-06-01/examples/QueryTextsGet.json
     */
    /**
...
public final class RecommendedActionsListByServerSamples {
    /*
     * x-ms-original-file: specification/mysql/resource-manager/Microsoft.DBforMySQL/legacy/stable/2018-06-01/examples/RecommendedActionsListByServer.json
     */
    /**
...
public final class RecoverableServersGetSamples {
    /*
     * x-ms-original-file: specification/mysql/resource-manager/Microsoft.DBforMySQL/legacy/stable/2017-12-01/examples/RecoverableServersGet.json
     */
    /**
...
public final class ReplicasListByServerSamples {
    /*
     * x-ms-original-file: specification/mysql/resource-manager/Microsoft.DBforMySQL/legacy/stable/2017-12-01/examples/ReplicasListByServer.json
     */
    /**
     * Sample code: ReplicasListByServer.
     *
...
public final class ServerAdministratorsDeleteSamples {
    /*
     * x-ms-original-file: specification/mysql/resource-manager/Microsoft.DBforMySQL/legacy/stable/2017-12-01/examples/ServerAdminDelete.json
     */
    /**
...
public final class ServerAdministratorsGetSamples {
    /*
     * x-ms-original-file: specification/mysql/resource-manager/Microsoft.DBforMySQL/legacy/stable/2017-12-01/examples/ServerAdminGet.json
     */
    /**
    ...
    public static void serverAdministratorGet(com.azure.resourcemanager.mysqlflexibleserver.MySqlManager manager) {
        manager.serverAdministrators().getWithResponse("testrg", "mysqltestsvc4", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class ServerAdministratorsListSamples {
    ...
    public static void getAListOfServerAdministrators(
        com.azure.resourcemanager.mysqlflexibleserver.MySqlManager manager) {
        manager.serverAdministrators().list("testrg", "mysqltestsvc4", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class ServerBasedPerformanceTierListSamples {
    /*
     * x-ms-original-file: specification/mysql/resource-manager/Microsoft.DBforMySQL/legacy/stable/2017-12-01/examples/PerformanceTiersListByServer.json
     */
    /**
     * Sample code: PerformanceTiersList.
     *
     ...
     */
    public static void performanceTiersList(com.azure.resourcemanager.mysqlflexibleserver.MySqlManager manager) {
        manager.serverBasedPerformanceTiers().list("testrg", "mysqltestsvc1", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class ServerKeysGetSamples {
    /*
     * x-ms-original-file: specification/mysql/resource-manager/Microsoft.DBforMySQL/legacy/stable/2020-01-01/examples/ServerKeyGet.json
     */
    /**
    ...
    public static void configurationList(com.azure.resourcemanager.mysqlflexibleserver.MySqlManager manager) {
        manager
            ...
            .listUpdateConfigurations(
                "testrg", "mysqltestsvc1", new ConfigurationListResultInner(), com.azure.core.util.Context.NONE);
    }
}
```
...
public final class ServerSecurityAlertPoliciesListByServerSamples {
    /*
     * x-ms-original-file: specification/mysql/resource-manager/Microsoft.DBforMySQL/legacy/stable/2017-12-01/examples/ServerSecurityAlertsListByServer.json
     */
    /**
...
public final class ServersCreateSamples {
    ...
    /*
     * x-ms-original-file: specification/mysql/resource-manager/Microsoft.DBforMySQL/legacy/stable/2017-12-01/examples/ServerCreatePointInTimeRestore.json
     */
    /**
...
public final class ServersGetByResourceGroupSamples {
    ...
    public static void serverGet(com.azure.resourcemanager.mysqlflexibleserver.MySqlManager manager) {
        manager.servers().getByResourceGroupWithResponse("testrg", "mysqltestsvc4", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class ServersListSamples {
    /*
     * x-ms-original-file: specification/mysql/resource-manager/Microsoft.DBforMySQL/legacy/stable/2017-12-01/examples/ServerList.json
     */
    /**
...
public final class ServersListByResourceGroupSamples {
    /*
     * x-ms-original-file: specification/mysql/resource-manager/Microsoft.DBforMySQL/legacy/stable/2017-12-01/examples/ServerListByResourceGroup.json
     */
    /**
...
public final class ServersRestartSamples {
    /*
     * x-ms-original-file: specification/mysql/resource-manager/Microsoft.DBforMySQL/legacy/stable/2017-12-01/examples/ServerRestart.json
     */
    /**
...
public final class ServersUpdateSamples {
    ...
    public static void serverUpdate(com.azure.resourcemanager.mysqlflexibleserver.MySqlManager manager) {
        Server resource =
            manager
                .servers()
                .getByResourceGroupWithResponse("testrg", "mysqltestsvc4", com.azure.core.util.Context.NONE)
                .getValue();
        resource
            .update()
    ...
    public static void serverUpgrade(com.azure.resourcemanager.mysqlflexibleserver.MySqlManager manager) {
        manager
            ...
            .upgrade(
                "TestGroup",
                "testserver",
                new ServerUpgradeParameters().withTargetServerVersion("5.7"),
                com.azure.core.util.Context.NONE);
    }
}
```
...
public final class TopQueryStatisticsListByServerSamples {
    /*
     * x-ms-original-file: specification/mysql/resource-manager/Microsoft.DBforMySQL/legacy/stable/2018-06-01/examples/TopQueryStatisticsListByServer.json
     */
    /**
...
public final class VirtualNetworkRulesDeleteSamples {
    /*
     * x-ms-original-file: specification/mysql/resource-manager/Microsoft.DBforMySQL/legacy/stable/2017-12-01/examples/VirtualNetworkRulesDelete.json
     */
    /**
...
public final class VirtualNetworkRulesGetSamples {
    /*
     * x-ms-original-file: specification/mysql/resource-manager/Microsoft.DBforMySQL/legacy/stable/2017-12-01/examples/VirtualNetworkRulesGet.json
     */
    /**
...
public final class VirtualNetworkRulesListByServerSamples {
    /*
     * x-ms-original-file: specification/mysql/resource-manager/Microsoft.DBforMySQL/legacy/stable/2017-12-01/examples/VirtualNetworkRulesList.json
     */
    /**
...
public final class WaitStatisticsListByServerSamples {
    /*
     * x-ms-original-file: specification/mysql/resource-manager/Microsoft.DBforMySQL/legacy/stable/2018-06-01/examples/WaitStatisticsListByServer.json
     */
    /**
