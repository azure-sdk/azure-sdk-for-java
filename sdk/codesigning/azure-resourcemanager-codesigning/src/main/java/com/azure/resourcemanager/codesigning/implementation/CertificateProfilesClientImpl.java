...
public final class CertificateProfilesClientImpl implements CertificateProfilesClient {
     ...
     */
    CertificateProfilesClientImpl(CodeSigningManagementClientForTestingImpl client) {
    ...
    /**
     * The interface defining all the services for CodeSigningManagementClientForTestingCertificateProfiles to be used
    ...
    public interface CertificateProfilesService {
        ...
        Mono<Response<CertificateProfileListResult>> listByCodeSigningAccount(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<CertificateProfileInner>> get(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("accountName") String accountName,
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Void>> revokeCertificate(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("accountName") String accountName,
