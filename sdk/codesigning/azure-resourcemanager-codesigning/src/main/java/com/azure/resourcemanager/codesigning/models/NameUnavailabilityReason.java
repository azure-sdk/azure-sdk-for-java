...
/**
 * The reason that a code signing account name could not be used. The Reason element is only returned if nameAvailable
 * is false.
 */
public final class NameUnavailabilityReason extends ExpandableStringEnum<NameUnavailabilityReason> {
    /**
     * Static value AccountNameInvalid for NameUnavailabilityReason.
     */
