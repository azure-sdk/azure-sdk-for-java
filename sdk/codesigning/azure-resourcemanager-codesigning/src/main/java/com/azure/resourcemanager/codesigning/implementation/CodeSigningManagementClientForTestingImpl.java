...
/**
 * Initializes a new instance of the CodeSigningManagementClientForTestingImpl type.
 */
@ServiceClient(builder = CodeSigningManagementClientForTestingBuilder.class)
public final class CodeSigningManagementClientForTestingImpl implements CodeSigningManagementClientForTesting {
    /**
    ...
    /**
     * Initializes an instance of CodeSigningManagementClientForTesting client.
     * 
     ...
     */
    CodeSigningManagementClientForTestingImpl(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter,
    ...
    private static final ClientLogger LOGGER = new ClientLogger(CodeSigningManagementClientForTestingImpl.class);
}
