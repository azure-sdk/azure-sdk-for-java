...
/** Resource collection API of CertificateProfileOperations. */
public interface CertificateProfileOperations {
    /**
     ...
     * @return the paginated list of certificate profiles as paginated response with {@link PagedIterable}.
     */
    PagedIterable<CertificateProfile> listByCodeSigningAccount(
     ...
     */
    Response<CertificateProfile> getWithResponse(
