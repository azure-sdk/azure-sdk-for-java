...
public interface CheckNameAvailabilityResult {
    ...
    /**
     * Gets the reason property: The reason that a code signing account name could not be used. The Reason element is
    ...
    /**
     * Gets the inner com.azure.resourcemanager.codesigning.fluent.models.CheckNameAvailabilityResultInner object.
     * 
