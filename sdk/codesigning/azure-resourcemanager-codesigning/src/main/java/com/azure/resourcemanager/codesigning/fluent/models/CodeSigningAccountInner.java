        ...
        if (location() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property location in model CodeSigningAccountInner"));
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(CodeSigningAccountInner.class);
