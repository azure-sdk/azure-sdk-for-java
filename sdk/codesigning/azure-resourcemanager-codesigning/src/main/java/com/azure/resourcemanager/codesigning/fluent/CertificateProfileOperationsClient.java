...
public interface CertificateProfileOperationsClient {
    /**
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<CertificateProfileInner> listByCodeSigningAccount(
    ...
    SyncPoller<PollResult<CertificateProfileInner>, CertificateProfileInner> beginCreate(
    ...
    CertificateProfileInner create(
        String resourceGroupName, String accountName, String profileName, CertificateProfileInner certificateProfile);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<CertificateProfileInner> getWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<CertificateProfileInner> updateWithResponse(
        String resourceGroupName,
        String accountName,
        String profileName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    CertificateProfileInner update(
        String resourceGroupName,
        String accountName,
        String profileName,
        CertificateProfilePatch certificateProfilePatch);
