...
public final class CodeSigningAccountsClientImpl implements CodeSigningAccountsClient {
    ...
    /**
     * Lists code signing accounts within a resource group.
     * 
     ...
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
     * @param accountName Code Signing account name.
     * @param resource Parameters to create the code signing account.
     * @throws IllegalArgumentException thrown if parameters fail the validation.
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     ...
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
     * @param accountName Code Signing account name.
     * @param properties Parameters supplied to update code signing account.
     * @throws IllegalArgumentException thrown if parameters fail the validation.
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return code signing account resource along with {@link Response} on successful completion of {@link Mono}.
