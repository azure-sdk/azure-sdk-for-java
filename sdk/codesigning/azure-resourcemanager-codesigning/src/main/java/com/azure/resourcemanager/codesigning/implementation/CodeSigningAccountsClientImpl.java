...
public final class CodeSigningAccountsClientImpl implements CodeSigningAccountsClient {
     ...
     */
    private final CodeSigningManagementClientForTestingImpl client;
     ...
     */
    CodeSigningAccountsClientImpl(CodeSigningManagementClientForTestingImpl client) {
    ...
    /**
     * The interface defining all the services for CodeSigningManagementClientForTestingCodeSigningAccounts to be used
    ...
    public interface CodeSigningAccountsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<CodeSigningAccountListResult>> list(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<CodeSigningAccountListResult>> listByResourceGroup(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<CodeSigningAccountInner>> getByResourceGroup(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<CodeSigningAccountInner>, CodeSigningAccountInner> beginUpdateAsync(
