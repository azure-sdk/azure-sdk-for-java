...
public final class CertificateProfileImpl implements CertificateProfile, CertificateProfile.Definition {
    ...
    public CertificateProfile create() {
        this.innerObject = serviceManager.serviceClient().getCertificateProfiles().create(resourceGroupName,
            accountName, profileName, this.innerModel(), Context.NONE);
        return this;
    }

    public CertificateProfile create(Context context) {
        this.innerObject = serviceManager.serviceClient().getCertificateProfiles().create(resourceGroupName,
            accountName, profileName, this.innerModel(), context);
        return this;
    }
    ...
    public CertificateProfile refresh() {
        this.innerObject = serviceManager.serviceClient().getCertificateProfiles()
            .getWithResponse(resourceGroupName, accountName, profileName, Context.NONE).getValue();
        return this;
    }

    public CertificateProfile refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getCertificateProfiles()
            .getWithResponse(resourceGroupName, accountName, profileName, context).getValue();
        return this;
    }

    public Response<Void> revokeCertificateWithResponse(RevokeCertificate body, Context context) {
        return serviceManager.certificateProfiles().revokeCertificateWithResponse(resourceGroupName, accountName,
            profileName, body, context);
    }
