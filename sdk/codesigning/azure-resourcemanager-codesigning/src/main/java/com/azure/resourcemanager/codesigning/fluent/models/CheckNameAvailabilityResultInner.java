...
import com.azure.resourcemanager.codesigning.models.Reason;
...
public final class CheckNameAvailabilityResultInner {
    ...
    /*
     * The reason that a code signing account name could not be used. The Reason element is only returned if
    ...
    /**
     * Get the reason property: The reason that a code signing account name could not be used. The Reason element is
