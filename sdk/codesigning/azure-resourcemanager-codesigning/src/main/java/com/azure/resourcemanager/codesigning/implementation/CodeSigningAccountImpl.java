...
public final class CodeSigningAccountImpl
    ...
    public CodeSigningAccount create() {
        this.innerObject = serviceManager.serviceClient().getCodeSigningAccounts().create(resourceGroupName,
            accountName, this.innerModel(), Context.NONE);
        return this;
    }

    public CodeSigningAccount create(Context context) {
        this.innerObject = serviceManager.serviceClient().getCodeSigningAccounts().create(resourceGroupName,
            accountName, this.innerModel(), context);
        return this;
    }
    ...
    public CodeSigningAccount apply() {
        this.innerObject = serviceManager.serviceClient().getCodeSigningAccounts().update(resourceGroupName,
            accountName, updateProperties, Context.NONE);
        return this;
    }

    public CodeSigningAccount apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getCodeSigningAccounts().update(resourceGroupName,
            accountName, updateProperties, context);
        return this;
    }
    ...
    public CodeSigningAccount refresh() {
        this.innerObject = serviceManager.serviceClient().getCodeSigningAccounts()
