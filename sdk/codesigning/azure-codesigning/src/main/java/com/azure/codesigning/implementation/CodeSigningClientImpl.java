...
import com.azure.codesigning.models.CodeSignResult;
...
public final class CodeSigningClientImpl {
     ...
     * @param serviceVersion Service version.
     */
    public CodeSigningClientImpl(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter, String region,
    ...
    public interface CodeSigningClientService {
        ...
        Mono<Response<BinaryData>> getSignRootCertificate(@HostParam("region") String region,
            ...
            @PathParam("certificateProfileName") String certificateProfileName, @HeaderParam("accept") String accept,
        ...
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        @UnexpectedResponseExceptionType(HttpResponseException.class)
        Mono<Response<BinaryData>> listSignEkus(@HostParam("region") String region,
            @QueryParam("api-version") String apiVersion,
            @PathParam("codeSigningAccountName") String codeSigningAccountName,
            @PathParam("certificateProfileName") String certificateProfileName, @HeaderParam("accept") String accept,
            RequestOptions requestOptions, Context context);
        ...
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        @UnexpectedResponseExceptionType(HttpResponseException.class)
        Response<BinaryData> listSignEkusSync(@HostParam("region") String region,
            @QueryParam("api-version") String apiVersion,
            @PathParam("codeSigningAccountName") String codeSigningAccountName,
            @PathParam("certificateProfileName") String certificateProfileName, @HeaderParam("accept") String accept,
            RequestOptions requestOptions, Context context);
        ...
        Mono<Response<BinaryData>> sign(@HostParam("region") String region,
            ...
            @PathParam("codeSigningAccountName") String codeSigningAccountName,
            @PathParam("certificateProfileName") String certificateProfileName, @HeaderParam("accept") String accept,
            @BodyParam("application/json") BinaryData codeSigningSubmissionOptions, RequestOptions requestOptions,
            Context context);
        ...
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        @UnexpectedResponseExceptionType(HttpResponseException.class)
        Mono<Response<BinaryData>> listSignEkusNext(@PathParam(value = "nextLink", encoded = true) String nextLink,
            @HostParam("region") String region, @HeaderParam("accept") String accept, RequestOptions requestOptions,
            Context context);
        ...
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        @UnexpectedResponseExceptionType(HttpResponseException.class)
        Response<BinaryData> listSignEkusNextSync(@PathParam(value = "nextLink", encoded = true) String nextLink,
            @HostParam("region") String region, @HeaderParam("accept") String accept, RequestOptions requestOptions,
            Context context);
    }
    ...
    public Mono<Response<BinaryData>> getSignRootCertificateWithResponseAsync(String codeSigningAccountName,
        String certificateProfileName, RequestOptions requestOptions) {
        final String accept = "application/json, application/x-x509-ca-cert";
        return FluxUtil.withContext(
            context -> service.getSignRootCertificate(this.getRegion(), this.getServiceVersion().getVersion(),
                codeSigningAccountName, certificateProfileName, accept, requestOptions, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<BinaryData> getSignRootCertificateWithResponse(String codeSigningAccountName,
        String certificateProfileName, RequestOptions requestOptions) {
        final String accept = "application/json, application/x-x509-ca-cert";
        return service.getSignRootCertificateSync(this.getRegion(), this.getServiceVersion().getVersion(),
            codeSigningAccountName, certificateProfileName, accept, requestOptions, Context.NONE);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<BinaryData>> listSignEkusSinglePageAsync(String codeSigningAccountName,
        String certificateProfileName, RequestOptions requestOptions) {
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.listSignEkus(this.getRegion(), this.getServiceVersion().getVersion(),
                codeSigningAccountName, certificateProfileName, accept, requestOptions, context))
    ...
    public PagedFlux<BinaryData> listSignEkusAsync(String codeSigningAccountName, String certificateProfileName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<BinaryData> listSignEkusSinglePage(String codeSigningAccountName,
        String certificateProfileName, RequestOptions requestOptions) {
        final String accept = "application/json";
        Response<BinaryData> res = service.listSignEkusSync(this.getRegion(), this.getServiceVersion().getVersion(),
            codeSigningAccountName, certificateProfileName, accept, requestOptions, Context.NONE);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<BinaryData> listSignEkus(String codeSigningAccountName, String certificateProfileName,
        RequestOptions requestOptions) {
        RequestOptions requestOptionsForNextPage = new RequestOptions();
        requestOptionsForNextPage.setContext(
            requestOptions != null && requestOptions.getContext() != null ? requestOptions.getContext() : Context.NONE);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<BinaryData>> signWithResponseAsync(String codeSigningAccountName,
        String certificateProfileName, BinaryData codeSigningSubmissionOptions, RequestOptions requestOptions) {
        final String accept = "application/json";
        return FluxUtil.withContext(
            context -> service.sign(this.getRegion(), this.getServiceVersion().getVersion(), codeSigningAccountName,
                certificateProfileName, accept, codeSigningSubmissionOptions, requestOptions, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> signWithResponse(String codeSigningAccountName, String certificateProfileName,
        BinaryData codeSigningSubmissionOptions, RequestOptions requestOptions) {
        final String accept = "application/json";
        return service.signSync(this.getRegion(), this.getServiceVersion().getVersion(), codeSigningAccountName,
            certificateProfileName, accept, codeSigningSubmissionOptions, requestOptions, Context.NONE);
    }
    ...
    public PollerFlux<BinaryData, BinaryData> beginSignAsync(String codeSigningAccountName,
        String certificateProfileName, BinaryData codeSigningSubmissionOptions, RequestOptions requestOptions) {
        return PollerFlux.create(Duration.ofSeconds(1),
            () -> this.signWithResponseAsync(codeSigningAccountName, certificateProfileName,
                codeSigningSubmissionOptions, requestOptions),
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<BinaryData, BinaryData> beginSign(String codeSigningAccountName, String certificateProfileName,
        BinaryData codeSigningSubmissionOptions, RequestOptions requestOptions) {
        return SyncPoller.createPoller(Duration.ofSeconds(1),
            () -> this.signWithResponse(codeSigningAccountName, certificateProfileName, codeSigningSubmissionOptions,
                requestOptions),
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public PollerFlux<PollOperationDetails, CodeSignResult> beginSignWithModelAsync(String codeSigningAccountName,
        String certificateProfileName, BinaryData codeSigningSubmissionOptions, RequestOptions requestOptions) {
        return PollerFlux.create(Duration.ofSeconds(1),
            () -> this.signWithResponseAsync(codeSigningAccountName, certificateProfileName,
                codeSigningSubmissionOptions, requestOptions),
            ...
            TypeReference.createInstance(CodeSignResult.class));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollOperationDetails, CodeSignResult> beginSignWithModel(String codeSigningAccountName,
        String certificateProfileName, BinaryData codeSigningSubmissionOptions, RequestOptions requestOptions) {
        return SyncPoller.createPoller(Duration.ofSeconds(1),
            () -> this.signWithResponse(codeSigningAccountName, certificateProfileName, codeSigningSubmissionOptions,
                requestOptions),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<BinaryData>> listSignEkusNextSinglePageAsync(String nextLink,
        RequestOptions requestOptions) {
        final String accept = "application/json";
        return FluxUtil
            .withContext(
                context -> service.listSignEkusNext(nextLink, this.getRegion(), accept, requestOptions, context))
            .map(res -> new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(),
                getValues(res.getValue(), "value"), getNextLink(res.getValue(), "nextLink"), null));
    }
