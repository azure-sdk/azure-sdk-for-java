...
public final class CodeSigningClientBuilder implements HttpTrait<CodeSigningClientBuilder>,
    ConfigurationTrait<CodeSigningClientBuilder>, TokenCredentialTrait<CodeSigningClientBuilder> {
    @Generated
    ...
    @Generated
    private static final Map<String, String> PROPERTIES = CoreUtils.getProperties("azure-codesigning.properties");
     ...
     */
    @Generated
    private CodeSigningServiceVersion serviceVersion;
    ...
    private CodeSigningClientImpl buildInnerClient() {
        ...
        CodeSigningClientImpl client = new CodeSigningClientImpl(localPipeline,
            JacksonAdapter.createDefaultSerializerAdapter(), this.region, localServiceVersion);
        return client;
    }
