...
public final class CodeSigningAsyncClient {
    @Generated
    private final CodeSigningClientImpl serviceClient;
    ...
    public Mono<Response<BinaryData>> getSignRootCertificateWithResponse(String codeSigningAccountName,
        String certificateProfileName, RequestOptions requestOptions) {
        return this.serviceClient.getSignRootCertificateWithResponseAsync(codeSigningAccountName,
            certificateProfileName, requestOptions);
    }
    ...
    public PagedFlux<BinaryData> listSignEkus(String codeSigningAccountName, String certificateProfileName,
    ...
    public PollerFlux<BinaryData, BinaryData> beginSign(String codeSigningAccountName, String certificateProfileName,
        BinaryData codeSigningSubmissionOptions, RequestOptions requestOptions) {
        return this.serviceClient.beginSignAsync(codeSigningAccountName, certificateProfileName,
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public PollerFlux<PollOperationDetails, CodeSignResult> beginSign(String codeSigningAccountName,
        String certificateProfileName, CodeSigningSubmissionOptions codeSigningSubmissionOptions) {
        // Generated convenience method for beginSignWithModel
        RequestOptions requestOptions = new RequestOptions();
        return serviceClient.beginSignWithModelAsync(codeSigningAccountName, certificateProfileName,
            BinaryData.fromObject(codeSigningSubmissionOptions), requestOptions);
    }
}
