...
public final class CodeSigningClient {
    ...
    public Response<BinaryData> getSignRootCertificateWithResponse(String codeSigningAccountName,
        ...
        return this.serviceClient.getSignRootCertificateWithResponse(codeSigningAccountName, certificateProfileName,
            requestOptions);
    }
    ...
    public SyncPoller<BinaryData, BinaryData> beginSign(String codeSigningAccountName, String certificateProfileName,
        ...
        return this.serviceClient.beginSign(codeSigningAccountName, certificateProfileName,
    ...
    public PagedIterable<ExtendedKeyUsage> listSignEkus(String codeSigningAccountName, String certificateProfileName) {
        ...
        RequestOptions requestOptions = new RequestOptions();
        return serviceClient.listSignEkus(codeSigningAccountName, certificateProfileName, requestOptions)
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollOperationDetails, CodeSignResult> beginSign(String codeSigningAccountName,
        ...
        RequestOptions requestOptions = new RequestOptions();
        return serviceClient.beginSignWithModel(codeSigningAccountName, certificateProfileName,
