...
public final class ServicesImpl implements Services {
    ...
    public ServicesImpl(
        ServicesClient innerClient, com.azure.resourcemanager.windowsiot.WindowsiotManager serviceManager) {
    ...
    public PagedIterable<DeviceService> listByResourceGroup(String resourceGroupName) {
        ...
        return Utils.mapPage(inner, inner1 -> new DeviceServiceImpl(inner1, this.manager()));
    }
