...
public final class ServicesClientImpl implements ServicesClient {
     ...
     * @return the non-security related metadata of a Windows IoT Device Service along with {@link Response} on
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the non-security related metadata of a Windows IoT Device Service on successful completion of {@link
     *     Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
     ...
     *
     * <p>Create or update the metadata of a Windows IoT Device Service. The usual pattern to modify a property is to
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the description of the Windows IoT Device Service along with {@link Response} on successful completion of
     *     {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the description of the Windows IoT Device Service on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
     ...
     *
     * <p>Updates the metadata of a Windows IoT Device Service. The usual pattern to modify a property is to retrieve
     * the Windows IoT Device Service metadata and security metadata, and then combine them with the modified values in
     * a new body to update the Windows IoT Device Service.
     *
     * @param resourceGroupName The name of the resource group that contains the Windows IoT Device Service.
     * @param deviceName The name of the Windows IoT Device Service.
     * @param deviceService The Windows IoT Device Service metadata and security metadata.
    ...
    private Mono<DeviceServiceInner> deleteAsync(String resourceGroupName, String deviceName) {
        return deleteWithResponseAsync(resourceGroupName, deviceName).flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the properties indicating whether a given Windows IoT Device Service name is available on successful
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the JSON-serialized array of DeviceService objects with a next link along with {@link PagedResponse} on
     *     successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
