...
public final class SharedKeysOperationsClientImpl implements SharedKeysOperationsClient {
    ...
    /**
     * The interface defining all the services for OperationalInsightsManagementClientSharedKeysOperations to be used
    ...
    public interface SharedKeysOperationsService {
        ...
        Mono<Response<SharedKeysInner>> getSharedKeys(@HostParam("$host") String endpoint,
