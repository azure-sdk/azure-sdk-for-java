...
public final class SharedKeysOperationsClientImpl implements SharedKeysOperationsClient {
    ...
    public interface SharedKeysOperationsService {
        ...
        Mono<Response<SharedKeysInner>> list(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<SharedKeysInner>> get(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("workspaceName") String workspaceName,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @HeaderParam("Accept") String accept, Context context);
    }
    ...
    private Mono<Response<SharedKeysInner>> listWithResponseAsync(String resourceGroupName, String workspaceName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<SharedKeysInner> listAsync(String resourceGroupName, String workspaceName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<SharedKeysInner> listWithResponse(String resourceGroupName, String workspaceName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public SharedKeysInner list(String resourceGroupName, String workspaceName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<SharedKeysInner>> getWithResponseAsync(String resourceGroupName, String workspaceName) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<SharedKeysInner> getAsync(String resourceGroupName, String workspaceName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<SharedKeysInner> getWithResponse(String resourceGroupName, String workspaceName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public SharedKeysInner get(String resourceGroupName, String workspaceName) {
