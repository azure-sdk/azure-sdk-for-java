...
/**
 * An instance of this class provides access to all the operations defined in SharedKeysOperationOperationsClient.
 */
public final class SharedKeysOperationOperationsClientImpl implements SharedKeysOperationOperationsClient {
    /**
     * The proxy service used to perform REST calls.
     */
    private final SharedKeysOperationOperationsService service;
    ...
    /**
     * Initializes an instance of SharedKeysOperationOperationsClientImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    SharedKeysOperationOperationsClientImpl(OperationalInsightsManagementClientImpl client) {
        this.service = RestProxy.create(SharedKeysOperationOperationsService.class, client.getHttpPipeline(),
            client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for OperationalInsightsManagementClientSharedKeysOperationOperations to
     * be used by the proxy service to perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "OperationalInsightsM")
    public interface SharedKeysOperationOperationsService {
        ...
        Mono<Response<SharedKeysInner>> regenerate(@HostParam("$host") String endpoint,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<SharedKeysInner>> regenerateWithResponseAsync(String resourceGroupName, String workspaceName,
        Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
