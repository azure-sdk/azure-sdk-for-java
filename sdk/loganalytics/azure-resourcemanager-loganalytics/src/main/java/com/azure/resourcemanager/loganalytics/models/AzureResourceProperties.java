...
public class AzureResourceProperties implements JsonSerializable<AzureResourceProperties> {
     ...
     * @return the AzureResourceProperties object itself.
     */
    AzureResourceProperties withSystemData(SystemDataAutoGenerated systemData) {
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("id".equals(fieldName)) {
                    ...
                    deserializedAzureResourceProperties.systemData = SystemDataAutoGenerated.fromJson(reader);
                } else {
                    reader.skipChildren();
                }
            }
