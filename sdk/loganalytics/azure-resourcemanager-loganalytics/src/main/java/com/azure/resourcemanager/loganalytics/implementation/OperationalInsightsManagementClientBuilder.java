...
public final class OperationalInsightsManagementClientBuilder {
     ...
     */
    public OperationalInsightsManagementClientBuilder subscriptionId(String subscriptionId) {
     ...
     * @return the OperationalInsightsManagementClientBuilder.
     */
    public OperationalInsightsManagementClientBuilder endpoint(String endpoint) {
     ...
     * @return the OperationalInsightsManagementClientBuilder.
     */
    public OperationalInsightsManagementClientBuilder environment(AzureEnvironment environment) {
     ...
     * @return the OperationalInsightsManagementClientBuilder.
     */
    public OperationalInsightsManagementClientBuilder serializerAdapter(SerializerAdapter serializerAdapter) {
    ...
    public OperationalInsightsManagementClientImpl buildClient() {
        ...
        OperationalInsightsManagementClientImpl client = new OperationalInsightsManagementClientImpl(localPipeline,
