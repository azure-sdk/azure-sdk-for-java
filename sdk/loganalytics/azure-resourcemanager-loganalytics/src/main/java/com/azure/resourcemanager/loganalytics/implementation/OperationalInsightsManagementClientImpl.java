...
public final class OperationalInsightsManagementClientImpl implements OperationalInsightsManagementClient {
    ...
    /**
     * The SharedKeysOperationOperationsClient object to access its operations.
     */
    private final SharedKeysOperationOperationsClient sharedKeysOperationOperations;

    /**
     * Gets the SharedKeysOperationOperationsClient object to access its operations.
     * 
     * @return the SharedKeysOperationOperationsClient object.
     */
    public SharedKeysOperationOperationsClient getSharedKeysOperationOperations() {
        return this.sharedKeysOperationOperations;
    }
     ...
     */
    OperationalInsightsManagementClientImpl(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter,
        ...
        this.sharedKeysOperationOperations = new SharedKeysOperationOperationsClientImpl(this);
