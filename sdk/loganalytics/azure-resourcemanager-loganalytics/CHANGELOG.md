...
#### `models.AzureResourceProperties` was modified

* `com.azure.core.management.SystemData systemData()` -> `models.SystemDataAutoGenerated systemData()`

#### `models.SystemDataAutoGenerated` was modified

* `withCreatedByType(models.CreatedByType)` was removed
* `models.CreatedByType createdByType()` -> `models.IdentityType createdByType()`
* `models.CreatedByType lastModifiedByType()` -> `models.IdentityType lastModifiedByType()`
...
#### `models.LogAnalyticsQueryPackQuery` was modified
...
#### `models.SharedKeysOperations` was modified

* `getSharedKeys(java.lang.String,java.lang.String)` was removed
* `regenerate(java.lang.String,java.lang.String)` was removed
* `regenerateWithResponse(java.lang.String,java.lang.String,com.azure.core.util.Context)` was removed
* `getSharedKeysWithResponse(java.lang.String,java.lang.String,com.azure.core.util.Context)` was removed
...
* `models.SharedKeysOperationOperations` was added
...
* `toJson(com.azure.json.JsonWriter)` was added
* `withLastModifiedByType(models.IdentityType)` was added
* `fromJson(com.azure.json.JsonReader)` was added
* `withCreatedByType(models.IdentityType)` was added
...
* `sharedKeysOperationOperations()` was added
