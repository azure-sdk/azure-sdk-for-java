...
public final class StorageTasksCreateSamples {
    /*
     * x-ms-original-file: specification/storagetasks/resource-manager/Microsoft.StorageTasks/stable/2023-01-01/examples/storageTasksCrud/PutStorageTask.json
     */
    /**
     ...
     * @param manager Entry point to StorageTasksManager.
     */
    public static void putStorageTask(com.azure.resourcemanager.storagetasks.StorageTasksManager manager) {
        manager
            .storageTasks()
            .define("mytask1")
            .withRegion("westus")
...
public final class StorageTasksDeleteSamples {
    /*
     * x-ms-original-file: specification/storagetasks/resource-manager/Microsoft.StorageTasks/stable/2023-01-01/examples/storageTasksCrud/DeleteStorageTask.json
     */
    /**
     ...
     * @param manager Entry point to StorageTasksManager.
     */
    public static void deleteStorageTask(com.azure.resourcemanager.storagetasks.StorageTasksManager manager) {
...
public final class StorageTasksGetByResourceGroupSamples {
    /*
     * x-ms-original-file: specification/storagetasks/resource-manager/Microsoft.StorageTasks/stable/2023-01-01/examples/storageTasksCrud/GetStorageTask.json
     */
    /**
     ...
     * @param manager Entry point to StorageTasksManager.
     */
    public static void getStorageTask(com.azure.resourcemanager.storagetasks.StorageTasksManager manager) {
...
public final class StorageTasksReportListSamples {
    /*
     * x-ms-original-file: specification/storagetasks/resource-manager/Microsoft.StorageTasks/stable/2023-01-01/examples/storageTasksList/ListStorageTasksRunReportSummary.json
     */
    /**
     * Sample code: ListStorageTasksByResourceGroup.
     *
