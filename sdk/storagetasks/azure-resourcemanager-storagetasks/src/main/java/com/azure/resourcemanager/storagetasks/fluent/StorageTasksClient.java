...
public interface StorageTasksClient {
    ...
    SyncPoller<PollResult<StorageTaskInner>, StorageTaskInner> beginCreate(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<StorageTaskInner> getByResourceGroupWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<StorageTaskInner>, StorageTaskInner> beginUpdate(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<StorageTaskPreviewActionInner> previewActionsWithResponse(
