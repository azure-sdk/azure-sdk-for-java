...
public final class StorageTasksClientImpl implements StorageTasksClient {
    ...
    public interface StorageTasksService {
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<StorageTaskInner>> getByResourceGroup(
            @HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("storageTaskName") String storageTaskName,
            @QueryParam("api-version") String apiVersion,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<StorageTasksListResult>> list(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @HeaderParam("Accept") String accept,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<StorageTasksListResult>> listByResourceGroup(
            @HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
        ...
        @Headers({"Content-Type: application/json"})
        @Post("/subscriptions/{subscriptionId}/providers/Microsoft.StorageTasks/locations/{location}/previewActions")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<StorageTaskPreviewActionInner>> previewActions(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
    ...
    private PollerFlux<PollResult<StorageTaskInner>, StorageTaskInner> beginCreateAsync(
        String resourceGroupName, String storageTaskName, StorageTaskInner parameters) {
        Mono<Response<Flux<ByteBuffer>>> mono = createWithResponseAsync(resourceGroupName, storageTaskName, parameters);
        return this
            .client
            .<StorageTaskInner, StorageTaskInner>getLroResult(
                mono,
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<StorageTaskInner>, StorageTaskInner> beginCreate(
        String resourceGroupName, String storageTaskName, StorageTaskInner parameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<StorageTaskInner> createAsync(
        String resourceGroupName, String storageTaskName, StorageTaskInner parameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<StorageTaskInner>> getByResourceGroupWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<StorageTaskInner> getByResourceGroupWithResponse(
        String resourceGroupName, String storageTaskName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<StorageTaskInner>, StorageTaskInner> beginUpdateAsync(
        String resourceGroupName, String storageTaskName, StorageTaskUpdateParameters parameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<StorageTaskInner>, StorageTaskInner> beginUpdate(
        String resourceGroupName, String storageTaskName, StorageTaskUpdateParameters parameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<StorageTaskInner> updateAsync(
        String resourceGroupName, String storageTaskName, StorageTaskUpdateParameters parameters) {
                ...
                context ->
                    service
                        .list(
                            ...
                            accept,
                            context))
            .<PagedResponse<StorageTaskInner>>map(
                res ->
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<StorageTaskInner>> listByResourceGroupSinglePageAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<StorageTaskPreviewActionInner>> previewActionsWithResponseAsync(
        String location, StorageTaskPreviewActionInner parameters) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<StorageTaskPreviewActionInner>> previewActionsWithResponseAsync(
        String location, StorageTaskPreviewActionInner parameters, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<StorageTaskPreviewActionInner> previewActionsAsync(
        String location, StorageTaskPreviewActionInner parameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<StorageTaskPreviewActionInner> previewActionsWithResponse(
        String location, StorageTaskPreviewActionInner parameters, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<StorageTaskInner>> listBySubscriptionNextSinglePageAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<StorageTaskInner>> listByResourceGroupNextSinglePageAsync(
        String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
