...
public final class ReportOperationUpdateSamples {
    ...
    public static void
        ...
        manager.reportOperations()
            .update("testReportName", new ReportResourcePatch().withProperties(new ReportProperties()
                .withOfferGuid("0000")
                .withTimeZone("GMT Standard Time")
                .withTriggerTime(OffsetDateTime.parse("2022-03-04T05:11:56.197Z"))
                .withResources(Arrays.asList(new ResourceMetadata().withResourceId(
...
public final class ReportsListSamples {
    ...
    public static void
        ...
        manager.reports()
            .list("1", 100, null, "00000000-0000-0000-0000-000000000000", "00000000-0000-0000-0000-000000000000",
                com.azure.core.util.Context.NONE);
    }
}
```
...
public final class SnapshotOperationDownloadSamples {
    ...
    public static void snapshotDownloadComplianceReport(
        ...
        manager.snapshotOperations()
            .download("testReportName", "testSnapshotName",
...
public final class SnapshotOperationGetSamples {
    ...
    public static void
        ...
        manager.snapshotOperations()
            .getWithResponse("testReportName", "testSnapshot", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class SnapshotsListSamples {
    ...
    public static void
        ...
        manager.snapshots()
            .list("testReportName", "1", 100, null, "00000000-0000-0000-0000-000000000000",
