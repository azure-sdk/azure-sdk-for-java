...
public final class ReportsCheckNameAvailabilityWithResponseMockTests {
    ...
    public void testCheckNameAvailabilityWithResponse() throws Exception {
        String responseStr = "{\"nameAvailable\":false,\"reason\":\"AlreadyExists\",\"message\":\"yrmewipmvekdx\"}";
        ...
        CheckNameAvailabilityResponse response = manager.reports()
            .checkNameAvailabilityWithResponse("zdjtxvzflbqv",
                new CheckNameAvailabilityRequest().withName("qvlgafcqusrdvetn").withType("dtutnwldu"),
        ...
        Assertions.assertEquals("yrmewipmvekdx", response.message());
    }
}
