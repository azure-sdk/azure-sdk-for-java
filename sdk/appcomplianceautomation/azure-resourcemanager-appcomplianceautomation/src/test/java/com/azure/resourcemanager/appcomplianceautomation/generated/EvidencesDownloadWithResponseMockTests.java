...
public final class EvidencesDownloadWithResponseMockTests {
    @Test
    public void testDownloadWithResponse() throws Exception {
        String responseStr = "{\"evidenceFile\":{\"url\":\"mbnkb\"}}";
        ...
        EvidenceFileDownloadResponse response = manager.evidences()
            .downloadWithResponse("bgsxgnxfyqonmpq", "xwdofdb",
                new EvidenceFileDownloadRequest().withReportCreatorTenantId("qxeiiqbimhtmwwi")
                    .withOfferGuid("ehfqpofvwbc"),
