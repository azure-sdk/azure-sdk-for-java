...
public final class WebhooksDeleteByResourceGroupWithResponseMockTests {
    @Test
    public void testDeleteWithResponse() throws Exception {
        ...
        manager.webhooks()
            .deleteByResourceGroupWithResponse("ynenlsvxeizz", "wklnsrmffeyc", com.azure.core.util.Context.NONE);
