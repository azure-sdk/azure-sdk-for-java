...
public final class CheckNameAvailabilityRequestTests {
    ...
    public void testDeserialize() throws Exception {
        CheckNameAvailabilityRequest model
            = BinaryData.fromString("{\"name\":\"debfqkkrbmpukgri\",\"type\":\"lzlfbxzpuz\"}")
                .toObject(CheckNameAvailabilityRequest.class);
        Assertions.assertEquals("debfqkkrbmpukgri", model.name());
        Assertions.assertEquals("lzlfbxzpuz", model.type());
    }

    @org.junit.jupiter.api.Test
    public void testSerialize() throws Exception {
        CheckNameAvailabilityRequest model
            = new CheckNameAvailabilityRequest().withName("debfqkkrbmpukgri").withType("lzlfbxzpuz");
