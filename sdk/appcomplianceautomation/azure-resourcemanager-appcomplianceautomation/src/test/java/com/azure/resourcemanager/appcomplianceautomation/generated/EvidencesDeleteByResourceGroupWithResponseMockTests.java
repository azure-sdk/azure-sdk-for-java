...
public final class EvidencesDeleteByResourceGroupWithResponseMockTests {
    @Test
    public void testDeleteWithResponse() throws Exception {
        ...
        manager.evidences().deleteByResourceGroupWithResponse("ickpz", "cpopmxel", com.azure.core.util.Context.NONE);
