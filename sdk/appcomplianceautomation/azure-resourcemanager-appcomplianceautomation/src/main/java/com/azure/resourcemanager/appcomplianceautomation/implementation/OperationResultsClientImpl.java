...
public final class OperationResultsClientImpl implements OperationResultsClient {
     ...
     */
    OperationResultsClientImpl(AppComplianceAutomationToolForMicrosoft365Impl client) {
        this.service =
    ...
    /**
     * The interface defining all the services for AppComplianceAutomationToolForMicrosoft365OperationResults to be used
    ...
    private interface OperationResultsService {
        ...
        @Get("/providers/Microsoft.AppComplianceAutomation/operationResults/{operationId}")
    ...
    private Mono<Response<Flux<ByteBuffer>>> getWithResponseAsync(String operationId) {
        ...
        return FluxUtil
            .withContext(
                context ->
                    service.get(this.client.getEndpoint(), this.client.getApiVersion(), operationId, accept, context))
    ...
    private PollerFlux<PollResult<Void>, Void> beginGetAsync(String operationId) {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<Void>, Void> beginGetAsync(String operationId, Context context) {
        context = this.client.mergeContext(context);
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<Void>, Void> beginGet(String operationId) {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<Void>, Void> beginGet(String operationId, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> getAsync(String operationId) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> getAsync(String operationId, Context context) {
    ...
    public void get(String operationId, Context context) {
        getAsync(operationId, context).block();
    }
}
