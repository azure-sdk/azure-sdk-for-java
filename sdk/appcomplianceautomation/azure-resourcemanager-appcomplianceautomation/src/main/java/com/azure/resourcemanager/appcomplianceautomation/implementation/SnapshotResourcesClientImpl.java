...
/**
 * An instance of this class provides access to all the operations defined in SnapshotResourcesClient.
 */
public final class SnapshotResourcesClientImpl implements SnapshotResourcesClient {
    /**
     * The proxy service used to perform REST calls.
     */
    private final SnapshotResourcesService service;
    ...
    /**
     * Initializes an instance of SnapshotResourcesClientImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    SnapshotResourcesClientImpl(AppComplianceAutomationToolForMicrosoft365Impl client) {
        this.service
            = RestProxy.create(SnapshotResourcesService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for AppComplianceAutomationToolForMicrosoft365SnapshotResources to be
     * used by the proxy service to perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "AppComplianceAutomat")
    public interface SnapshotResourcesService {
        @Headers({ "Content-Type: application/json" })
        @Get("/providers/Microsoft.AppComplianceAutomation/reports/{reportName}/snapshots")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<SnapshotResourceListResult>> listByReportResource(@HostParam("$host") String endpoint,
            ...
            @QueryParam("offerGuid") String offerGuid, @PathParam("reportName") String reportName,
    ...
    private Mono<PagedResponse<SnapshotResourceInner>> listByReportResourceSinglePageAsync(String reportName,
        String skipToken, Integer top, String select, String reportCreatorTenantId, String offerGuid) {
        ...
        return FluxUtil
            .withContext(context -> service.listByReportResource(this.client.getEndpoint(), this.client.getApiVersion(),
                skipToken, top, select, reportCreatorTenantId, offerGuid, reportName, accept, context))
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<SnapshotResourceInner>> listByReportResourceSinglePageAsync(String reportName,
        String skipToken, Integer top, String select, String reportCreatorTenantId, String offerGuid, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service
            .listByReportResource(this.client.getEndpoint(), this.client.getApiVersion(), skipToken, top, select,
                reportCreatorTenantId, offerGuid, reportName, accept, context)
    ...
    private PagedFlux<SnapshotResourceInner> listByReportResourceAsync(String reportName, String skipToken, Integer top,
        String select, String reportCreatorTenantId, String offerGuid) {
        return new PagedFlux<>(() -> listByReportResourceSinglePageAsync(reportName, skipToken, top, select,
            reportCreatorTenantId, offerGuid), nextLink -> listByReportResourceNextSinglePageAsync(nextLink));
    }
    ...
    private PagedFlux<SnapshotResourceInner> listByReportResourceAsync(String reportName, String skipToken, Integer top,
        ...
        return new PagedFlux<>(() -> listByReportResourceSinglePageAsync(reportName, skipToken, top, select,
            reportCreatorTenantId, offerGuid, context),
    ...
    public PagedIterable<SnapshotResourceInner> listByReportResource(String reportName) {
        ...
        return new PagedIterable<>(
            listByReportResourceAsync(reportName, skipToken, top, select, reportCreatorTenantId, offerGuid));
    }
    ...
    public PagedIterable<SnapshotResourceInner> listByReportResource(String reportName, String skipToken, Integer top,
        String select, String reportCreatorTenantId, String offerGuid, Context context) {
        return new PagedIterable<>(
            listByReportResourceAsync(reportName, skipToken, top, select, reportCreatorTenantId, offerGuid, context));
    }
