...
public final class SnapshotOperationsImpl implements SnapshotOperations {
    ...
    public DownloadResponse download(String reportName, String snapshotName, DownloadType downloadType) {
        DownloadResponseInner inner = this.serviceClient().download(reportName, snapshotName, downloadType);
        if (inner != null) {
    ...
    public DownloadResponse download(
        ...
        String offerGuid,
        Context context) {
        DownloadResponseInner inner =
            this
                .serviceClient()
                .download(reportName, snapshotName, downloadType, reportCreatorTenantId, offerGuid, context);
        if (inner != null) {
            return new DownloadResponseImpl(inner, this.manager());
        } else {
            return null;
