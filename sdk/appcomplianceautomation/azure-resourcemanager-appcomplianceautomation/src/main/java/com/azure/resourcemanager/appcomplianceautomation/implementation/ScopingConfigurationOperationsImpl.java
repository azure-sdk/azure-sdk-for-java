...
public final class ScopingConfigurationOperationsImpl implements ScopingConfigurationOperations {
    private static final ClientLogger LOGGER = new ClientLogger(ScopingConfigurationOperationsImpl.class);

    private final ScopingConfigurationOperationsClient innerClient;

    private final com.azure.resourcemanager.appcomplianceautomation.AppComplianceAutomationManager serviceManager;

    public ScopingConfigurationOperationsImpl(ScopingConfigurationOperationsClient innerClient,
    ...
    private ScopingConfigurationOperationsClient serviceClient() {
