...
public final class ReportsClientImpl implements ReportsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<ManagementError>, ManagementError> beginSyncCertRecordAsync(String reportName,
        SyncCertRecordRequest body) {
        Mono<Response<Flux<ByteBuffer>>> mono = syncCertRecordWithResponseAsync(reportName, body);
        return this.client.<ManagementError, ManagementError>getLroResult(mono, this.client.getHttpPipeline(),
            ManagementError.class, ManagementError.class, this.client.getContext());
    }
    ...
    private PollerFlux<PollResult<ManagementError>, ManagementError> beginSyncCertRecordAsync(String reportName,
        ...
        return this.client.<ManagementError, ManagementError>getLroResult(mono, this.client.getHttpPipeline(),
            ManagementError.class, ManagementError.class, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<ManagementError>, ManagementError> beginSyncCertRecord(String reportName,
        SyncCertRecordRequest body) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ManagementError> syncCertRecordAsync(String reportName, SyncCertRecordRequest body) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ManagementError> syncCertRecordAsync(String reportName, SyncCertRecordRequest body, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ManagementError syncCertRecord(String reportName, SyncCertRecordRequest body) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ManagementError syncCertRecord(String reportName, SyncCertRecordRequest body, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<ManagementError>, ManagementError> beginFixAsync(String reportName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<ManagementError>, ManagementError> beginFixAsync(String reportName, Context context) {
        context = this.client.mergeContext(context);
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<ManagementError>, ManagementError> beginFix(String reportName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<ManagementError>, ManagementError> beginFix(String reportName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ManagementError> fixAsync(String reportName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ManagementError> fixAsync(String reportName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ManagementError fix(String reportName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ManagementError fix(String reportName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<ManagementError>, ManagementError> beginVerifyAsync(String reportName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<ManagementError>, ManagementError> beginVerify(String reportName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<ManagementError>, ManagementError> beginVerify(String reportName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ManagementError> verifyAsync(String reportName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ManagementError> verifyAsync(String reportName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ManagementError verify(String reportName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ManagementError verify(String reportName, Context context) {
