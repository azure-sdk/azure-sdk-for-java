...
public final class ReportsClientImpl implements ReportsClient {
    ...
    public interface ReportsService {
        ...
        Mono<Response<ReportResourceList>> list(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ReportResourceList>> listNext(@PathParam(value = "nextLink", encoded = true) String nextLink,
    ...
    private Mono<PagedResponse<ReportResourceInner>> listSinglePageAsync(String skipToken, Integer top, String select,
        ...
        return FluxUtil
            .withContext(context -> service.list(this.client.getEndpoint(), this.client.getApiVersion(), skipToken, top,
                select, offerGuid, reportCreatorTenantId, accept, context))
    ...
    private Mono<PagedResponse<ReportResourceInner>> listSinglePageAsync(String skipToken, Integer top, String select,
        ...
        return service
            .list(this.client.getEndpoint(), this.client.getApiVersion(), skipToken, top, select, offerGuid,
    ...
    private PagedFlux<ReportResourceInner> listAsync(String skipToken, Integer top, String select, String offerGuid,
        String reportCreatorTenantId) {
        return new PagedFlux<>(() -> listSinglePageAsync(skipToken, top, select, offerGuid, reportCreatorTenantId),
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<ReportResourceInner> list(String skipToken, Integer top, String select, String offerGuid,
        String reportCreatorTenantId, Context context) {
