...
public final class SnapshotOperationsClientImpl implements SnapshotOperationsClient {
    ...
    private interface SnapshotOperationsService {
        ...
        Mono<Response<Flux<ByteBuffer>>> download(
            ...
            @QueryParam("downloadType") DownloadType downloadType,
    ...
    private Mono<Response<Flux<ByteBuffer>>> downloadWithResponseAsync(
        ...
        if (downloadType == null) {
            return Mono.error(new IllegalArgumentException("Parameter downloadType is required and cannot be null."));
        }
        final String accept = "application/json";
        return FluxUtil
            .withContext(
    ...
    private PollerFlux<PollResult<DownloadResponseInner>, DownloadResponseInner> beginDownloadAsync(
        ...
        Mono<Response<Flux<ByteBuffer>>> mono =
            downloadWithResponseAsync(reportName, snapshotName, downloadType, reportCreatorTenantId, offerGuid);
        return this
            .client
    ...
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<DownloadResponseInner>, DownloadResponseInner> beginDownloadAsync(
        String reportName, String snapshotName, DownloadType downloadType) {
    ...
    private PollerFlux<PollResult<DownloadResponseInner>, DownloadResponseInner> beginDownloadAsync(
        ...
        Mono<Response<Flux<ByteBuffer>>> mono =
            downloadWithResponseAsync(
                reportName, snapshotName, downloadType, reportCreatorTenantId, offerGuid, context);
        return this
            .client
            .<DownloadResponseInner, DownloadResponseInner>getLroResult(
    ...
    public SyncPoller<PollResult<DownloadResponseInner>, DownloadResponseInner> beginDownload(
        ...
        final String reportCreatorTenantId = null;
        final String offerGuid = null;
        return beginDownloadAsync(reportName, snapshotName, downloadType, reportCreatorTenantId, offerGuid)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<DownloadResponseInner>, DownloadResponseInner> beginDownload(
        ...
        String offerGuid,
        Context context) {
        return beginDownloadAsync(reportName, snapshotName, downloadType, reportCreatorTenantId, offerGuid, context)
            .getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public DownloadResponseInner download(String reportName, String snapshotName, DownloadType downloadType) {
        final String reportCreatorTenantId = null;
        final String offerGuid = null;
        return downloadAsync(reportName, snapshotName, downloadType, reportCreatorTenantId, offerGuid).block();
    }
    ...
    public DownloadResponseInner download(
        ...
        String offerGuid,
        Context context) {
        return downloadAsync(reportName, snapshotName, downloadType, reportCreatorTenantId, offerGuid, context).block();
    }
}
