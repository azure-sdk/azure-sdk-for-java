...
public final class ProviderActionsClientImpl implements ProviderActionsClient {
    ...
    public interface ProviderActionsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<GetCollectionCountResponseInner>> getCollectionCount(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @HeaderParam("accept") String accept,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<GetOverviewStatusResponseInner>> getOverviewStatus(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @HeaderParam("accept") String accept,
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Flux<ByteBuffer>>> onboard(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @HeaderParam("accept") String accept,
        ...
        @ExpectedResponses({ 200, 202 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Flux<ByteBuffer>>> triggerEvaluation(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @HeaderParam("accept") String accept,
    ...
    private PollerFlux<PollResult<ManagementError>, ManagementError> beginOnboardAsync(OnboardRequest body) {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<ManagementError>, ManagementError> beginOnboard(OnboardRequest body) {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<ManagementError>, ManagementError> beginOnboard(OnboardRequest body, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ManagementError> onboardAsync(OnboardRequest body) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ManagementError> onboardAsync(OnboardRequest body, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ManagementError onboard(OnboardRequest body) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ManagementError onboard(OnboardRequest body, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<ManagementError>, ManagementError>
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<ManagementError>, ManagementError>
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ManagementError> triggerEvaluationAsync(TriggerEvaluationRequest body) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ManagementError> triggerEvaluationAsync(TriggerEvaluationRequest body, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ManagementError triggerEvaluation(TriggerEvaluationRequest body) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ManagementError triggerEvaluation(TriggerEvaluationRequest body, Context context) {
