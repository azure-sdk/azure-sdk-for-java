...
public final class SnapshotsClientImpl implements SnapshotsClient {
    ...
    private PollerFlux<PollResult<ManagementError>, ManagementError> beginDownloadAsync(String reportName,
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<ManagementError>, ManagementError> beginDownload(String reportName,
        String snapshotName, SnapshotDownloadRequest body) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ManagementError> downloadAsync(String reportName, String snapshotName, SnapshotDownloadRequest body) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ManagementError download(String reportName, String snapshotName, SnapshotDownloadRequest body) {
