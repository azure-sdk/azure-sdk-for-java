...
public interface ProviderActionsClient {
    ...
    SyncPoller<PollResult<ManagementError>, ManagementError> beginOnboard(OnboardRequest body);
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<ManagementError>, ManagementError> beginOnboard(OnboardRequest body, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ManagementError onboard(OnboardRequest body);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ManagementError onboard(OnboardRequest body, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<ManagementError>, ManagementError> beginTriggerEvaluation(TriggerEvaluationRequest body);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ManagementError triggerEvaluation(TriggerEvaluationRequest body);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ManagementError triggerEvaluation(TriggerEvaluationRequest body, Context context);
