...
public interface ReportsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<ReportResourceInner> listByTenant(String skipToken, Integer top, String select, String filter,
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<ManagementError>, ManagementError> beginSyncCertRecord(String reportName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ManagementError syncCertRecord(String reportName, SyncCertRecordRequest body, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<ManagementError>, ManagementError> beginFix(String reportName);
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<ManagementError>, ManagementError> beginFix(String reportName, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ManagementError fix(String reportName);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ManagementError fix(String reportName, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<ManagementError>, ManagementError> beginVerify(String reportName);
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<ManagementError>, ManagementError> beginVerify(String reportName, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ManagementError verify(String reportName);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ManagementError verify(String reportName, Context context);
}
