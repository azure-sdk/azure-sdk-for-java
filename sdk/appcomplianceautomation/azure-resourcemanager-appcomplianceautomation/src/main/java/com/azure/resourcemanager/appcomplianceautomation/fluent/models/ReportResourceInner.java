        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("id".equals(fieldName)) {
                    deserializedReportResourceInner.withId(reader.getString());
                } else if ("name".equals(fieldName)) {
                    deserializedReportResourceInner.withName(reader.getString());
                } else if ("type".equals(fieldName)) {
                    deserializedReportResourceInner.withType(reader.getString());
