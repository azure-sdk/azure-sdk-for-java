...
public interface OperationResultsClient {
    ...
    SyncPoller<PollResult<Void>, Void> beginGet(String operationId);
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<Void>, Void> beginGet(String operationId, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    void get(String operationId, Context context);
}
