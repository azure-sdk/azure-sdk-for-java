...
public final class EvidencesClientImpl implements EvidencesClient {
     ...
     */
    EvidencesClientImpl(AppComplianceAutomationToolForMicrosoft365Impl client) {
        this.service
    ...
    /**
     * The interface defining all the services for AppComplianceAutomationToolForMicrosoft365Evidences to be used by the
    ...
    public interface EvidencesService {
        ...
        Mono<Response<EvidenceFileDownloadResponseInner>> download(@HostParam("$host") String endpoint,
            ...
            @BodyParam("application/json") EvidenceFileDownloadRequest parameters, @HeaderParam("Accept") String accept,
            Context context);
    ...
    private Mono<Response<EvidenceFileDownloadResponseInner>> downloadWithResponseAsync(String reportName,
        String evidenceName, EvidenceFileDownloadRequest parameters) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return FluxUtil
            .withContext(context -> service.download(this.client.getEndpoint(), this.client.getApiVersion(), reportName,
                evidenceName, parameters, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<EvidenceFileDownloadResponseInner>> downloadWithResponseAsync(String reportName,
        String evidenceName, EvidenceFileDownloadRequest parameters, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    private Mono<EvidenceFileDownloadResponseInner> downloadAsync(String reportName, String evidenceName,
        EvidenceFileDownloadRequest parameters) {
        return downloadWithResponseAsync(reportName, evidenceName, parameters)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
    ...
    public Response<EvidenceFileDownloadResponseInner> downloadWithResponse(String reportName, String evidenceName,
        EvidenceFileDownloadRequest parameters, Context context) {
        return downloadWithResponseAsync(reportName, evidenceName, parameters, context).block();
    }
    ...
    public EvidenceFileDownloadResponseInner download(String reportName, String evidenceName,
        EvidenceFileDownloadRequest parameters) {
        return downloadWithResponse(reportName, evidenceName, parameters, Context.NONE).getValue();
    }
