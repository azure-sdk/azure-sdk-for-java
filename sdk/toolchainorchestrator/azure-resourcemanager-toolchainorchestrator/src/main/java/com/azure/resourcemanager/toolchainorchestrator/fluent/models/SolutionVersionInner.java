 ...
 */
@Fluent
public final class SolutionVersionInner extends Resource {
    /*
     ...
     */
    @Override
    public SolutionVersionInner withLocation(String location) {
     ...
     */
    @Override
    public SolutionVersionInner withTags(Map<String, String> tags) {
        super.withTags(tags);
        return this;
    }
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("id".equals(fieldName)) {
                    ...
                    deserializedSolutionVersionInner.withLocation(reader.getString());
                } else if ("tags".equals(fieldName)) {
                    Map<String, String> tags = reader.readMap(reader1 -> reader1.getString());
                    deserializedSolutionVersionInner.withTags(tags);
