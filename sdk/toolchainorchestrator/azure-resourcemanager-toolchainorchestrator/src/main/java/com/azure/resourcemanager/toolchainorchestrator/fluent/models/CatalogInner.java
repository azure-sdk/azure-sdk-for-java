...
public final class CatalogInner extends Resource {
    ...
    /**
     * Get the extendedLocation property: Edge location of the Catalog.
     * 
    ...
    /**
     * Set the extendedLocation property: Edge location of the Catalog.
     * 
     * @param extendedLocation the extendedLocation value to set.
     * @return the CatalogInner object itself.
     */
    public CatalogInner withExtendedLocation(ExtendedLocation extendedLocation) {
    ...
    public void validate() {
        ...
        if (extendedLocation() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Missing required property extendedLocation in model CatalogInner"));
        } else {
            extendedLocation().validate();
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(CatalogInner.class);
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("id".equals(fieldName)) {
                    ...
                    deserializedCatalogInner.extendedLocation = ExtendedLocation.fromJson(reader);
