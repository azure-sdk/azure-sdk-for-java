...
public interface SolutionsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    SolutionInner createOrUpdate(String resourceGroupName, String solutionName, SolutionInner resource);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    SolutionInner update(String resourceGroupName, String solutionName, SolutionTagsUpdate properties);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    SolutionInner update(String resourceGroupName, String solutionName, SolutionTagsUpdate properties, Context context);
    ...
    PagedIterable<SolutionInner> listByResourceGroup(String resourceGroupName);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<SolutionInner> listByResourceGroup(String resourceGroupName, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<SolutionInner> list(Context context);
}
