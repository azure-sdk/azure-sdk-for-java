...
public final class NetworkSettingsClientImpl implements NetworkSettingsClient {
    ...
    public interface NetworkSettingsService {
        ...
        Mono<Response<NetworkSettingsResourceInner>> create(@HostParam("$host") String endpoint,
            ...
            @BodyParam("application/json") NetworkSettingsResourceInner resource, @HeaderParam("Accept") String accept,
            Context context);
        ...
        Mono<Response<NetworkSettingsResourceInner>> update(@HostParam("$host") String endpoint,
            ...
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("networkSettingsName") String networkSettingsName,
            @BodyParam("application/json") NetworkSettingsResourceUpdate properties,
            @HeaderParam("Accept") String accept, Context context);
     ...
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
     * @param networkSettingsName Name of the GitHub.Network resource.
     * @param resource GitHub.Network networkSettings resource create parameters.
     * @throws IllegalArgumentException thrown if parameters fail the validation.
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return gitHub.Network networkSettings resource along with {@link Response} on successful completion of
    ...
    private Mono<Response<NetworkSettingsResourceInner>> createWithResponseAsync(String resourceGroupName,
        String networkSettingsName, NetworkSettingsResourceInner resource) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return FluxUtil
            .withContext(context -> service.create(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, networkSettingsName, resource, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<NetworkSettingsResourceInner>> createWithResponseAsync(String resourceGroupName,
        String networkSettingsName, NetworkSettingsResourceInner resource, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service.create(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, networkSettingsName, resource, accept, context);
    }
    ...
    private Mono<NetworkSettingsResourceInner> createAsync(String resourceGroupName, String networkSettingsName,
        NetworkSettingsResourceInner resource) {
        return createWithResponseAsync(resourceGroupName, networkSettingsName, resource)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
    ...
    public Response<NetworkSettingsResourceInner> createWithResponse(String resourceGroupName,
        String networkSettingsName, NetworkSettingsResourceInner resource, Context context) {
        return createWithResponseAsync(resourceGroupName, networkSettingsName, resource, context).block();
    }
    ...
    public NetworkSettingsResourceInner create(String resourceGroupName, String networkSettingsName,
        NetworkSettingsResourceInner resource) {
        return createWithResponse(resourceGroupName, networkSettingsName, resource, Context.NONE).getValue();
    }
     ...
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
     * @param networkSettingsName Name of the GitHub.Network resource.
     * @param properties Parameters for updating the properties of the GitHub.Network resource.
     * @throws IllegalArgumentException thrown if parameters fail the validation.
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return gitHub.Network networkSettings resource along with {@link Response} on successful completion of
    ...
    private Mono<Response<NetworkSettingsResourceInner>> updateWithResponseAsync(String resourceGroupName,
        String networkSettingsName, NetworkSettingsResourceUpdate properties) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return FluxUtil
            .withContext(context -> service.update(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, networkSettingsName, properties, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<NetworkSettingsResourceInner>> updateWithResponseAsync(String resourceGroupName,
        String networkSettingsName, NetworkSettingsResourceUpdate properties, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service.update(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, networkSettingsName, properties, accept, context);
    }
    ...
    private Mono<NetworkSettingsResourceInner> updateAsync(String resourceGroupName, String networkSettingsName,
        NetworkSettingsResourceUpdate properties) {
        return updateWithResponseAsync(resourceGroupName, networkSettingsName, properties)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
    ...
    public Response<NetworkSettingsResourceInner> updateWithResponse(String resourceGroupName,
        String networkSettingsName, NetworkSettingsResourceUpdate properties, Context context) {
        return updateWithResponseAsync(resourceGroupName, networkSettingsName, properties, context).block();
    }
    ...
    public NetworkSettingsResourceInner update(String resourceGroupName, String networkSettingsName,
        NetworkSettingsResourceUpdate properties) {
        return updateWithResponse(resourceGroupName, networkSettingsName, properties, Context.NONE).getValue();
    }
