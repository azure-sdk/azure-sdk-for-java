...
import com.azure.resourcemanager.githubnetwork.fluent.models.OperationInner;
import com.azure.resourcemanager.githubnetwork.models.OperationListResult;
...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    OperationsClientImpl(GitHubNetworkClientImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for GitHubNetworkClientOperations to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "GitHubNetworkClientO")
    public interface OperationsService {
        @Headers({ "Content-Type: application/json" })
        @Get("/providers/GitHub.Network/operations")
