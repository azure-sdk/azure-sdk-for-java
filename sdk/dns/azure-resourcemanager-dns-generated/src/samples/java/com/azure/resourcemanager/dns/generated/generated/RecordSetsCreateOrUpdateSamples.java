...
public final class RecordSetsCreateOrUpdateSamples {
    ...
    public static void createSRVRecordset(com.azure.resourcemanager.dns.generated.DnsManager manager) {
        manager.recordSets().createOrUpdateWithResponse("rg1", "zone1", "record1", RecordType.SRV,
    ...
    public static void createCNAMERecordset(com.azure.resourcemanager.dns.generated.DnsManager manager) {
        manager.recordSets().createOrUpdateWithResponse("rg1", "zone1", "record1", RecordType.CNAME,
            new RecordSetInner().withMetadata(mapOf("key1", "fakeTokenPlaceholder")).withTtl(3600L).withCnameRecord(
                new CnameRecord().withCname("contoso.com")),
            null, null, com.azure.core.util.Context.NONE);
    }
    ...
    public static void createDSRecordset(com.azure.resourcemanager.dns.generated.DnsManager manager) {
        manager.recordSets().createOrUpdateWithResponse("rg1", "zone1", "record1", RecordType.DS,
            new RecordSetInner().withMetadata(mapOf("key1", "fakeTokenPlaceholder")).withTtl(3600L)
                .withDsRecords(Arrays.asList(new DsRecord().withKeyTag(60485).withAlgorithm(5).withDigest(
                    new Digest().withAlgorithmType(1).withValue("2BB183AF5F22588179A53B0A98631FAD1A292118")))),
            null, null, com.azure.core.util.Context.NONE);
    }
    ...
    public static void createNAPTRRecordset(com.azure.resourcemanager.dns.generated.DnsManager manager) {
        manager.recordSets().createOrUpdateWithResponse("rg1", "zone1", "record1", RecordType.NAPTR,
            new RecordSetInner().withMetadata(mapOf("key1", "fakeTokenPlaceholder")).withTtl(3600L)
                .withNaptrRecords(Arrays.asList(new NaptrRecord().withOrder(100).withPreference(10).withFlags("U")
                    .withServices("E2U+sip").withRegexp("!^.*$!sip:user@example.com!").withReplacement(""))),
            null, null, com.azure.core.util.Context.NONE);
    }
    ...
    public static void createNSRecordset(com.azure.resourcemanager.dns.generated.DnsManager manager) {
        manager.recordSets().createOrUpdateWithResponse("rg1", "zone1", "record1", RecordType.NS,
            new RecordSetInner().withMetadata(mapOf("key1", "fakeTokenPlaceholder")).withTtl(3600L)
    ...
    public static void
        ...
        manager.recordSets().createOrUpdateWithResponse("rg1", "zone1", "record1", RecordType.A, new RecordSetInner()
            .withMetadata(mapOf("key1", "fakeTokenPlaceholder")).withTtl(3600L)
    ...
    public static void createARecordset(com.azure.resourcemanager.dns.generated.DnsManager manager) {
        manager.recordSets().createOrUpdateWithResponse("rg1", "zone1", "record1", RecordType.A,
            new RecordSetInner().withMetadata(mapOf("key1", "fakeTokenPlaceholder")).withTtl(3600L)
    ...
    public static void createTLSARecordset(com.azure.resourcemanager.dns.generated.DnsManager manager) {
        manager.recordSets().createOrUpdateWithResponse("rg1", "zone1", "record1", RecordType.TLSA,
            new RecordSetInner().withMetadata(mapOf("key1", "fakeTokenPlaceholder")).withTtl(3600L)
                .withTlsaRecords(Arrays.asList(new TlsaRecord().withUsage(3).withSelector(1).withMatchingType(1)
    ...
    public static void createTXTRecordset(com.azure.resourcemanager.dns.generated.DnsManager manager) {
        manager.recordSets().createOrUpdateWithResponse("rg1", "zone1", "record1", RecordType.TXT,
            new RecordSetInner().withMetadata(mapOf("key1", "fakeTokenPlaceholder")).withTtl(3600L)
    ...
    public static void createCAARecordset(com.azure.resourcemanager.dns.generated.DnsManager manager) {
        manager.recordSets().createOrUpdateWithResponse("rg1", "zone1", "record1", RecordType.CAA,
    ...
    public static void createPTRRecordset(com.azure.resourcemanager.dns.generated.DnsManager manager) {
        manager.recordSets().createOrUpdateWithResponse("rg1", "0.0.127.in-addr.arpa", "1", RecordType.PTR,
            new RecordSetInner().withMetadata(mapOf("key1", "fakeTokenPlaceholder")).withTtl(3600L)
    ...
    public static void createMXRecordset(com.azure.resourcemanager.dns.generated.DnsManager manager) {
        manager.recordSets().createOrUpdateWithResponse("rg1", "zone1", "record1", RecordType.MX,
            new RecordSetInner().withMetadata(mapOf("key1", "fakeTokenPlaceholder")).withTtl(3600L)
    ...
    public static void createSOARecordset(com.azure.resourcemanager.dns.generated.DnsManager manager) {
        manager.recordSets().createOrUpdateWithResponse("rg1", "zone1", "@", RecordType.SOA,
            new RecordSetInner().withMetadata(mapOf("key1", "fakeTokenPlaceholder")).withTtl(3600L).withSoaRecord(
                new SoaRecord().withHost("ns1.contoso.com").withEmail("hostmaster.contoso.com").withSerialNumber(1L)
                    .withRefreshTime(3600L).withRetryTime(300L).withExpireTime(2419200L).withMinimumTtl(300L)),
            null, null, com.azure.core.util.Context.NONE);
    }
