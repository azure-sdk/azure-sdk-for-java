...
public final class SpacesImpl implements Spaces {
    ...
    public SpacesImpl(SpacesClient innerClient,
    ...
    public PagedIterable<Space> list() {
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new SpaceImpl(inner1, this.manager()));
    }
    ...
    public PagedIterable<Space> listByResourceGroup(String resourceGroupName, Integer top, Integer skip,
        Integer maxPageSize, String filter, List<String> select, List<String> expand, List<String> orderBy,
        Context context) {
        PagedIterable<SpaceInner> inner = this.serviceClient().listByResourceGroup(resourceGroupName, top, skip,
    ...
    public Response<Void> deleteByResourceGroupWithResponse(String resourceGroupName, String spaceName,
        Context context) {
