...
public final class BusinessProcessVersionsImpl implements BusinessProcessVersions {
    ...
    public PagedIterable<BusinessProcessVersion> listByBusinessProcess(String resourceGroupName, String spaceName,
        ...
        PagedIterable<BusinessProcessVersionInner> inner = this.serviceClient()
    ...
    public PagedIterable<BusinessProcessVersion> listByBusinessProcess(String resourceGroupName, String spaceName,
        ...
        PagedIterable<BusinessProcessVersionInner> inner = this.serviceClient()
            .listByBusinessProcess(resourceGroupName, spaceName, applicationName, businessProcessName, top, skip,
    ...
    public Response<BusinessProcessVersion> getWithResponse(String resourceGroupName, String spaceName,
        ...
        Response<BusinessProcessVersionInner> inner = this.serviceClient()
            .getWithResponse(resourceGroupName, spaceName, applicationName, businessProcessName, businessProcessVersion,
                context);
        if (inner != null) {
