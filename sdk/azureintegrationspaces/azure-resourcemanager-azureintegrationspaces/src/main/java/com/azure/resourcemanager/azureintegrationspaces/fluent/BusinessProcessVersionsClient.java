...
public interface BusinessProcessVersionsClient {
    ...
    PagedIterable<BusinessProcessVersionInner> listByBusinessProcess(String resourceGroupName, String spaceName,
    ...
    Response<BusinessProcessVersionInner> getWithResponse(String resourceGroupName, String spaceName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    BusinessProcessVersionInner get(String resourceGroupName, String spaceName, String applicationName,
