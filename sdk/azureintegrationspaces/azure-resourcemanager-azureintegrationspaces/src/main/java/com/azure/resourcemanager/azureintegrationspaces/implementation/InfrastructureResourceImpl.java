...
public final class InfrastructureResourceImpl
    ...
    public InfrastructureResource create() {
        this.innerObject
            = serviceManager.serviceClient().getInfrastructureResources().createOrUpdateWithResponse(resourceGroupName,
                spaceName, infrastructureResourceName, this.innerModel(), Context.NONE).getValue();
        return this;
    }
    ...
    public InfrastructureResource create(Context context) {
        this.innerObject
            = serviceManager.serviceClient().getInfrastructureResources().createOrUpdateWithResponse(resourceGroupName,
                spaceName, infrastructureResourceName, this.innerModel(), context).getValue();
        return this;
    }

    InfrastructureResourceImpl(String name,
    ...
    public InfrastructureResource apply() {
        this.innerObject = serviceManager.serviceClient().getInfrastructureResources()
            .patchWithResponse(resourceGroupName, spaceName, infrastructureResourceName, updateProperties, Context.NONE)
            .getValue();
        return this;
    }
    ...
    InfrastructureResourceImpl(InfrastructureResourceInner innerObject,
        com.azure.resourcemanager.azureintegrationspaces.AzureintegrationspacesManager serviceManager) {
        ...
        this.infrastructureResourceName
            = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "infrastructureResources");
    }

    public InfrastructureResource refresh() {
        this.innerObject = serviceManager.serviceClient().getInfrastructureResources()
            .getWithResponse(resourceGroupName, spaceName, infrastructureResourceName, Context.NONE).getValue();
        return this;
    }

    public InfrastructureResource refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getInfrastructureResources()
            .getWithResponse(resourceGroupName, spaceName, infrastructureResourceName, context).getValue();
        return this;
    }
