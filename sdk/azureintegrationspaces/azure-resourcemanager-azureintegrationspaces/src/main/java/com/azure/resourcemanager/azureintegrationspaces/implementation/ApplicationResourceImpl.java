...
public final class ApplicationResourceImpl
    ...
    public ApplicationResourceImpl withExistingApplication(String resourceGroupName, String spaceName,
    ...
    public ApplicationResource create() {
        this.innerObject
            = serviceManager.serviceClient().getApplicationResources().createOrUpdateWithResponse(resourceGroupName,
                spaceName, applicationName, resourceName, this.innerModel(), Context.NONE).getValue();
        return this;
    }
    ...
    public ApplicationResource create(Context context) {
        this.innerObject
            = serviceManager.serviceClient().getApplicationResources().createOrUpdateWithResponse(resourceGroupName,
                spaceName, applicationName, resourceName, this.innerModel(), context).getValue();
        return this;
    }
    ...
    public ApplicationResource apply() {
        this.innerObject = serviceManager.serviceClient().getApplicationResources().patchWithResponse(resourceGroupName,
            spaceName, applicationName, resourceName, updateProperties, Context.NONE).getValue();
        return this;
    }

    public ApplicationResource apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getApplicationResources()
            .patchWithResponse(resourceGroupName, spaceName, applicationName, resourceName, updateProperties, context)
            .getValue();
        return this;
    }
    ...
    ApplicationResourceImpl(ApplicationResourceInner innerObject,
        ...
        this.resourceName = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "resources");
    }

    public ApplicationResource refresh() {
        this.innerObject = serviceManager.serviceClient().getApplicationResources()
            .getWithResponse(resourceGroupName, spaceName, applicationName, resourceName, Context.NONE).getValue();
        return this;
    }

    public ApplicationResource refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getApplicationResources()
            .getWithResponse(resourceGroupName, spaceName, applicationName, resourceName, context).getValue();
        return this;
    }
