...
public final class ApplicationResourceImpl
    ...
    public ApplicationResource create() {
        this.innerObject = serviceManager.serviceClient()
            ...
            .createOrUpdateWithResponse(resourceGroupName, spaceName, applicationName, resourceName, this.innerModel(),
                Context.NONE)
            .getValue();
        return this;
    }
    ...
    public ApplicationResource apply() {
        this.innerObject = serviceManager.serviceClient()
            .getApplicationResources()
            .patchWithResponse(resourceGroupName, spaceName, applicationName, resourceName, updateProperties,
                Context.NONE)
            .getValue();
        return this;
    }
