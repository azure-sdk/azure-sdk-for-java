...
public interface SpacesClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<SpaceInner> listByResourceGroup(String resourceGroupName, Integer top, Integer skip,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<SpaceInner> createOrUpdateWithResponse(String resourceGroupName, String spaceName, SpaceInner resource,
        Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<SpaceInner> patchWithResponse(String resourceGroupName, String spaceName, SpaceUpdate properties,
        Context context);
