...
public final class BusinessProcessesImpl implements BusinessProcesses {
    ...
    public BusinessProcessesImpl(BusinessProcessesClient innerClient,
        com.azure.resourcemanager.azureintegrationspaces.AzureintegrationspacesManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public PagedIterable<BusinessProcess> listByApplication(String resourceGroupName, String spaceName,
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new BusinessProcessImpl(inner1, this.manager()));
    }
    ...
    public PagedIterable<BusinessProcess> listByApplication(String resourceGroupName, String spaceName,
        ...
        PagedIterable<BusinessProcessInner> inner = this.serviceClient().listByApplication(resourceGroupName, spaceName,
            applicationName, top, skip, maxPageSize, filter, select, expand, orderBy, context);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new BusinessProcessImpl(inner1, this.manager()));
    }

    public Response<BusinessProcess> getWithResponse(String resourceGroupName, String spaceName, String applicationName,
        String businessProcessName, Context context) {
        Response<BusinessProcessInner> inner = this.serviceClient().getWithResponse(resourceGroupName, spaceName,
            applicationName, businessProcessName, context);
        if (inner != null) {
    ...
    public BusinessProcess get(String resourceGroupName, String spaceName, String applicationName,
    ...
    public Response<Void> deleteWithResponse(String resourceGroupName, String spaceName, String applicationName,
        String businessProcessName, Context context) {
        return this.serviceClient().deleteWithResponse(resourceGroupName, spaceName, applicationName,
            businessProcessName, context);
    }
    ...
    public BusinessProcess getById(String id) {
        ...
        String businessProcessName = ResourceManagerUtils.getValueFromIdByName(id, "businessProcesses");
        if (businessProcessName == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
                String.format("The resource ID '%s' is not valid. Missing path segment 'businessProcesses'.", id)));
        }
        return this.getWithResponse(resourceGroupName, spaceName, applicationName, businessProcessName, Context.NONE)
            .getValue();
    }
