...
public final class BusinessProcessesImpl implements BusinessProcesses {
    ...
    public PagedIterable<BusinessProcess> listByApplication(String resourceGroupName, String spaceName,
        ...
        PagedIterable<BusinessProcessInner> inner = this.serviceClient()
            .listByApplication(resourceGroupName, spaceName, applicationName, top, skip, maxPageSize, filter, select,
    ...
    public Response<BusinessProcess> getWithResponse(String resourceGroupName, String spaceName, String applicationName,
        ...
        Response<BusinessProcessInner> inner = this.serviceClient()
