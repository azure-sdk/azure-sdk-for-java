...
public final class ApplicationsImpl implements Applications {
    ...
    public Response<SaveOrGetBusinessProcessDevelopmentArtifactResponse>
        ...
        Response<SaveOrGetBusinessProcessDevelopmentArtifactResponseInner> inner = this.serviceClient()
            .getBusinessProcessDevelopmentArtifactWithResponse(resourceGroupName, spaceName, applicationName, body,
                context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
    ...
    public Response<ListBusinessProcessDevelopmentArtifactsResponse>
        ...
        Response<ListBusinessProcessDevelopmentArtifactsResponseInner> inner = this.serviceClient()
            .listBusinessProcessDevelopmentArtifactsWithResponse(resourceGroupName, spaceName, applicationName,
                context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
    ...
    public Response<SaveOrGetBusinessProcessDevelopmentArtifactResponse>
        ...
        Response<SaveOrGetBusinessProcessDevelopmentArtifactResponseInner> inner = this.serviceClient()
            .saveBusinessProcessDevelopmentArtifactWithResponse(resourceGroupName, spaceName, applicationName, body,
                context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
                new SaveOrGetBusinessProcessDevelopmentArtifactResponseImpl(inner.getValue(), this.manager()));
