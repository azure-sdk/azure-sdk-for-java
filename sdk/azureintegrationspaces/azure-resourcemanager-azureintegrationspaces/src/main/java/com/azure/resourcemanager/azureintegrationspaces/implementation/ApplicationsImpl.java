...
public final class ApplicationsImpl implements Applications {
    ...
    public PagedIterable<Application> listBySpace(String resourceGroupName, String spaceName, Integer top, Integer skip,
        Integer maxPageSize, String filter, List<String> select, List<String> expand, List<String> orderBy,
        Context context) {
        PagedIterable<ApplicationInner> inner = this.serviceClient().listBySpace(resourceGroupName, spaceName, top,
            skip, maxPageSize, filter, select, expand, orderBy, context);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new ApplicationImpl(inner1, this.manager()));
    }

    public Response<Application> getWithResponse(String resourceGroupName, String spaceName, String applicationName,
        Context context) {
    ...
    public Response<Void> deleteBusinessProcessDevelopmentArtifactWithResponse(String resourceGroupName,
        ...
        Context context) {
        return this.serviceClient().deleteBusinessProcessDevelopmentArtifactWithResponse(resourceGroupName, spaceName,
            applicationName, body, context);
    }
    ...
    public void deleteBusinessProcessDevelopmentArtifact(String resourceGroupName, String spaceName,
        ...
        this.serviceClient().deleteBusinessProcessDevelopmentArtifact(resourceGroupName, spaceName, applicationName,
            body);
    }
    ...
    public Response<SaveOrGetBusinessProcessDevelopmentArtifactResponse>
        ...
        Response<SaveOrGetBusinessProcessDevelopmentArtifactResponseInner> inner
            = this.serviceClient().getBusinessProcessDevelopmentArtifactWithResponse(resourceGroupName, spaceName,
                applicationName, body, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
    ...
    public SaveOrGetBusinessProcessDevelopmentArtifactResponse getBusinessProcessDevelopmentArtifact(
        ...
        SaveOrGetBusinessProcessDevelopmentArtifactResponseInner inner = this.serviceClient()
    ...
    public Response<ListBusinessProcessDevelopmentArtifactsResponse>
        ...
        Response<ListBusinessProcessDevelopmentArtifactsResponseInner> inner
            = this.serviceClient().listBusinessProcessDevelopmentArtifactsWithResponse(resourceGroupName, spaceName,
    ...
    public ListBusinessProcessDevelopmentArtifactsResponse
        ...
        ListBusinessProcessDevelopmentArtifactsResponseInner inner = this.serviceClient()
    ...
    public Response<SaveOrGetBusinessProcessDevelopmentArtifactResponse>
        ...
        Response<SaveOrGetBusinessProcessDevelopmentArtifactResponseInner> inner
            = this.serviceClient().saveBusinessProcessDevelopmentArtifactWithResponse(resourceGroupName, spaceName,
                applicationName, body, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
                new SaveOrGetBusinessProcessDevelopmentArtifactResponseImpl(inner.getValue(), this.manager()));
    ...
    public Response<Void> validateBusinessProcessDevelopmentArtifactWithResponse(String resourceGroupName,
        ...
        Context context) {
        return this.serviceClient().validateBusinessProcessDevelopmentArtifactWithResponse(resourceGroupName, spaceName,
            applicationName, body, context);
    }
    ...
    public void validateBusinessProcessDevelopmentArtifact(String resourceGroupName, String spaceName,
        ...
        this.serviceClient().validateBusinessProcessDevelopmentArtifact(resourceGroupName, spaceName, applicationName,
            body);
    }
    ...
    public Application getById(String id) {
        ...
        String spaceName = ResourceManagerUtils.getValueFromIdByName(id, "spaces");
        if (spaceName == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
