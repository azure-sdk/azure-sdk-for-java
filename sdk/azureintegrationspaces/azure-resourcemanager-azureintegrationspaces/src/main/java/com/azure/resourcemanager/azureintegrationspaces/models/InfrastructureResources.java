...
public interface InfrastructureResources {
     ...
     * @return the response of a InfrastructureResource list operation as paginated response with {@link PagedIterable}.
     */
    PagedIterable<InfrastructureResource> listBySpace(String resourceGroupName, String spaceName, Integer top,
     ...
     */
    Response<InfrastructureResource> getWithResponse(String resourceGroupName, String spaceName,
