...
public final class InfrastructureResourcesImpl implements InfrastructureResources {
    ...
    public InfrastructureResourcesImpl(InfrastructureResourcesClient innerClient,
    ...
    public PagedIterable<InfrastructureResource> listBySpace(String resourceGroupName, String spaceName) {
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new InfrastructureResourceImpl(inner1, this.manager()));
    }

    public PagedIterable<InfrastructureResource> listBySpace(String resourceGroupName, String spaceName, Integer top,
        Integer skip, Integer maxPageSize, String filter, List<String> select, List<String> expand,
        List<String> orderBy, Context context) {
        PagedIterable<InfrastructureResourceInner> inner = this.serviceClient().listBySpace(resourceGroupName,
            spaceName, top, skip, maxPageSize, filter, select, expand, orderBy, context);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new InfrastructureResourceImpl(inner1, this.manager()));
    }

    public Response<InfrastructureResource> getWithResponse(String resourceGroupName, String spaceName,
    ...
    public Response<Void> deleteWithResponse(String resourceGroupName, String spaceName,
        String infrastructureResourceName, Context context) {
        return this.serviceClient().deleteWithResponse(resourceGroupName, spaceName, infrastructureResourceName,
            context);
    }
    ...
    public InfrastructureResource getById(String id) {
        ...
        String infrastructureResourceName = ResourceManagerUtils.getValueFromIdByName(id, "infrastructureResources");
        if (infrastructureResourceName == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(String
                .format("The resource ID '%s' is not valid. Missing path segment 'infrastructureResources'.", id)));
        }
