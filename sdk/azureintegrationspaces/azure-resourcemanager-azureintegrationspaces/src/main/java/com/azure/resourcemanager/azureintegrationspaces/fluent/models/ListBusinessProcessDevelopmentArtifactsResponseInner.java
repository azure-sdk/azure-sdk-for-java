...
public final class ListBusinessProcessDevelopmentArtifactsResponseInner {
     ...
     */
    public ListBusinessProcessDevelopmentArtifactsResponseInner
        withValue(List<SaveOrGetBusinessProcessDevelopmentArtifactResponseInner> value) {
        this.value = value;
        return this;
    }
    ...
    public void validate() {
        if (value() == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
                "Missing required property value in model ListBusinessProcessDevelopmentArtifactsResponseInner"));
        } else {
