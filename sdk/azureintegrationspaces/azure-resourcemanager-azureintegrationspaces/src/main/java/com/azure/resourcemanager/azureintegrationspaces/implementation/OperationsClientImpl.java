...
import com.azure.resourcemanager.azureintegrationspaces.models.OperationListResult;
...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    OperationsClientImpl(MicrosoftIntegrationSpacesImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for MicrosoftIntegrationSpacesOperations to be used by the proxy service
    ...
    public interface OperationsService {
        ...
        @Get("/providers/Microsoft.IntegrationSpaces/operations")
