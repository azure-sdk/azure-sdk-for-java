...
public final class SaveOrGetBusinessProcessDevelopmentArtifactResponseInner {
     ...
     */
    public SaveOrGetBusinessProcessDevelopmentArtifactResponseInner
        withProperties(BusinessProcessDevelopmentArtifactProperties properties) {
    ...
    public void validate() {
        if (name() == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
                "Missing required property name in model SaveOrGetBusinessProcessDevelopmentArtifactResponseInner"));
        }
        if (properties() != null) {
            properties().validate();
        }
