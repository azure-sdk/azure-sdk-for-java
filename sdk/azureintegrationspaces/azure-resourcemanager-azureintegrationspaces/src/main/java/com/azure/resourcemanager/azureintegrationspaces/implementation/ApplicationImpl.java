...
public final class ApplicationImpl implements Application, Application.Definition, Application.Update {
    ...
    public Application create() {
        this.innerObject = serviceManager.serviceClient().getApplications()
            .createOrUpdateWithResponse(resourceGroupName, spaceName, applicationName, this.innerModel(), Context.NONE)
            .getValue();
        return this;
    }
    ...
    public Application apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getApplications()
            .patchWithResponse(resourceGroupName, spaceName, applicationName, updateProperties, context).getValue();
        return this;
    }
    ...
    ApplicationImpl(ApplicationInner innerObject,
        ...
        this.spaceName = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "spaces");
        this.applicationName = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "applications");
    }

    public Application refresh() {
        this.innerObject = serviceManager.serviceClient().getApplications()
            .getWithResponse(resourceGroupName, spaceName, applicationName, Context.NONE).getValue();
        return this;
    }

    public Application refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getApplications()
            .getWithResponse(resourceGroupName, spaceName, applicationName, context).getValue();
        return this;
    }
    ...
    public Response<Void> deleteBusinessProcessDevelopmentArtifactWithResponse(
        ...
        return serviceManager.applications().deleteBusinessProcessDevelopmentArtifactWithResponse(resourceGroupName,
            spaceName, applicationName, body, context);
    }

    public void deleteBusinessProcessDevelopmentArtifact(GetOrDeleteBusinessProcessDevelopmentArtifactRequest body) {
        serviceManager.applications().deleteBusinessProcessDevelopmentArtifact(resourceGroupName, spaceName,
            applicationName, body);
    }

    public Response<SaveOrGetBusinessProcessDevelopmentArtifactResponse>
        getBusinessProcessDevelopmentArtifactWithResponse(GetOrDeleteBusinessProcessDevelopmentArtifactRequest body,
            Context context) {
        return serviceManager.applications().getBusinessProcessDevelopmentArtifactWithResponse(resourceGroupName,
            spaceName, applicationName, body, context);
    }

    public SaveOrGetBusinessProcessDevelopmentArtifactResponse
        getBusinessProcessDevelopmentArtifact(GetOrDeleteBusinessProcessDevelopmentArtifactRequest body) {
        return serviceManager.applications().getBusinessProcessDevelopmentArtifact(resourceGroupName, spaceName,
            applicationName, body);
    }
    ...
    public Response<ListBusinessProcessDevelopmentArtifactsResponse>
        ...
        return serviceManager.applications().listBusinessProcessDevelopmentArtifactsWithResponse(resourceGroupName,
            spaceName, applicationName, context);
    }

    public ListBusinessProcessDevelopmentArtifactsResponse listBusinessProcessDevelopmentArtifacts() {
        return serviceManager.applications().listBusinessProcessDevelopmentArtifacts(resourceGroupName, spaceName,
            applicationName);
    }

    public Response<SaveOrGetBusinessProcessDevelopmentArtifactResponse>
        saveBusinessProcessDevelopmentArtifactWithResponse(SaveOrValidateBusinessProcessDevelopmentArtifactRequest body,
            Context context) {
        return serviceManager.applications().saveBusinessProcessDevelopmentArtifactWithResponse(resourceGroupName,
            spaceName, applicationName, body, context);
    }

    public SaveOrGetBusinessProcessDevelopmentArtifactResponse
        saveBusinessProcessDevelopmentArtifact(SaveOrValidateBusinessProcessDevelopmentArtifactRequest body) {
        return serviceManager.applications().saveBusinessProcessDevelopmentArtifact(resourceGroupName, spaceName,
            applicationName, body);
    }
    ...
    public Response<Void> validateBusinessProcessDevelopmentArtifactWithResponse(
        ...
        return serviceManager.applications().validateBusinessProcessDevelopmentArtifactWithResponse(resourceGroupName,
            spaceName, applicationName, body, context);
    }

    public void
        validateBusinessProcessDevelopmentArtifact(SaveOrValidateBusinessProcessDevelopmentArtifactRequest body) {
        serviceManager.applications().validateBusinessProcessDevelopmentArtifact(resourceGroupName, spaceName,
            applicationName, body);
    }
