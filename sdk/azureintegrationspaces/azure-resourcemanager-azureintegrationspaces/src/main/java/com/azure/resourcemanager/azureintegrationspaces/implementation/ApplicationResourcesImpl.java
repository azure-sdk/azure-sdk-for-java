...
public final class ApplicationResourcesImpl implements ApplicationResources {
    ...
    public ApplicationResourcesImpl(ApplicationResourcesClient innerClient,
        com.azure.resourcemanager.azureintegrationspaces.AzureintegrationspacesManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public PagedIterable<ApplicationResource> listByApplication(String resourceGroupName, String spaceName,
    ...
    public PagedIterable<ApplicationResource> listByApplication(String resourceGroupName, String spaceName,
        ...
        PagedIterable<ApplicationResourceInner> inner = this.serviceClient().listByApplication(resourceGroupName,
            spaceName, applicationName, top, skip, maxPageSize, filter, select, expand, orderBy, context);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new ApplicationResourceImpl(inner1, this.manager()));
    }

    public Response<ApplicationResource> getWithResponse(String resourceGroupName, String spaceName,
        String applicationName, String resourceName, Context context) {
        Response<ApplicationResourceInner> inner = this.serviceClient().getWithResponse(resourceGroupName, spaceName,
            applicationName, resourceName, context);
        if (inner != null) {
    ...
    public ApplicationResource get(String resourceGroupName, String spaceName, String applicationName,
        String resourceName) {
    ...
    public Response<Void> deleteWithResponse(String resourceGroupName, String spaceName, String applicationName,
        ...
        return this.serviceClient().deleteWithResponse(resourceGroupName, spaceName, applicationName, resourceName,
            context);
    }
    ...
    public ApplicationResource getById(String id) {
        ...
        String resourceName = ResourceManagerUtils.getValueFromIdByName(id, "resources");
        if (resourceName == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
                String.format("The resource ID '%s' is not valid. Missing path segment 'resources'.", id)));
        }
        return this.getWithResponse(resourceGroupName, spaceName, applicationName, resourceName, Context.NONE)
            .getValue();
    }
