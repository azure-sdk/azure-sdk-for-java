...
public final class SpaceImpl implements Space, Space.Definition, Space.Update {
    ...
    public Space create() {
        this.innerObject = serviceManager.serviceClient().getSpaces()
            .createOrUpdateWithResponse(resourceGroupName, spaceName, this.innerModel(), Context.NONE).getValue();
        return this;
    }

    public Space create(Context context) {
        this.innerObject = serviceManager.serviceClient().getSpaces()
            .createOrUpdateWithResponse(resourceGroupName, spaceName, this.innerModel(), context).getValue();
        return this;
    }

    SpaceImpl(String name,
    ...
    public Space apply() {
        this.innerObject = serviceManager.serviceClient().getSpaces()
            .patchWithResponse(resourceGroupName, spaceName, updateProperties, Context.NONE).getValue();
        return this;
    }

    public Space apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getSpaces()
            .patchWithResponse(resourceGroupName, spaceName, updateProperties, context).getValue();
        return this;
    }

    SpaceImpl(SpaceInner innerObject,
        com.azure.resourcemanager.azureintegrationspaces.AzureintegrationspacesManager serviceManager) {
    ...
    public Space refresh() {
        this.innerObject = serviceManager.serviceClient().getSpaces()
            .getByResourceGroupWithResponse(resourceGroupName, spaceName, Context.NONE).getValue();
        return this;
    }

    public Space refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getSpaces()
            .getByResourceGroupWithResponse(resourceGroupName, spaceName, context).getValue();
        return this;
    }
