...
public final class BusinessProcessImpl implements BusinessProcess, BusinessProcess.Definition, BusinessProcess.Update {
    ...
    public BusinessProcessImpl withExistingApplication(String resourceGroupName, String spaceName,
    ...
    public BusinessProcess create() {
        this.innerObject
            = serviceManager.serviceClient().getBusinessProcesses().createOrUpdateWithResponse(resourceGroupName,
                spaceName, applicationName, businessProcessName, this.innerModel(), Context.NONE).getValue();
        return this;
    }
    ...
    public BusinessProcess create(Context context) {
        this.innerObject
            = serviceManager.serviceClient().getBusinessProcesses().createOrUpdateWithResponse(resourceGroupName,
                spaceName, applicationName, businessProcessName, this.innerModel(), context).getValue();
        return this;
    }

    BusinessProcessImpl(String name,
    ...
    public BusinessProcess apply() {
        this.innerObject = serviceManager.serviceClient().getBusinessProcesses().patchWithResponse(resourceGroupName,
            spaceName, applicationName, businessProcessName, updateProperties, Context.NONE).getValue();
        return this;
    }

    public BusinessProcess apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getBusinessProcesses().patchWithResponse(resourceGroupName,
            spaceName, applicationName, businessProcessName, updateProperties, context).getValue();
        return this;
    }

    BusinessProcessImpl(BusinessProcessInner innerObject,
        com.azure.resourcemanager.azureintegrationspaces.AzureintegrationspacesManager serviceManager) {
        ...
        this.businessProcessName = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "businessProcesses");
    }

    public BusinessProcess refresh() {
        this.innerObject = serviceManager.serviceClient().getBusinessProcesses()
    ...
    public BusinessProcess refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getBusinessProcesses()
            .getWithResponse(resourceGroupName, spaceName, applicationName, businessProcessName, context).getValue();
        return this;
    }
    ...
    public BusinessProcessImpl
        withBusinessProcessMapping(Map<String, BusinessProcessMappingItem> businessProcessMapping) {
        if (isInCreateMode()) {
