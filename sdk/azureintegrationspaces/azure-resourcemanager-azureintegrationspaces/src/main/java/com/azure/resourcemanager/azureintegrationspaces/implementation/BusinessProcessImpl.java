...
public final class BusinessProcessImpl implements BusinessProcess, BusinessProcess.Definition, BusinessProcess.Update {
    ...
    public BusinessProcess create() {
        this.innerObject = serviceManager.serviceClient()
            ...
            .createOrUpdateWithResponse(resourceGroupName, spaceName, applicationName, businessProcessName,
    ...
    public BusinessProcess apply() {
        this.innerObject = serviceManager.serviceClient()
            .getBusinessProcesses()
            .patchWithResponse(resourceGroupName, spaceName, applicationName, businessProcessName, updateProperties,
                Context.NONE)
            .getValue();
        return this;
    }
