                            ...
                            new TrackingProfileDefinition().withSchema(
                                ...
                                .withTrackingDefinitions(mapOf("Fulfillment", new FlowTrackingDefinition()
                                    ...
                                    .withEvents(mapOf("Completed",
                                        ...
                                        new TrackingEventDefinition().withOperationType("Action")
                                            .withOperationName("ShippedPO")
                                            .withProperties(mapOf("ShipPriority", mapOf(), "TrackingID", mapOf())))),
                                    "PurchaseOrder",
                                    new FlowTrackingDefinition()
                                        ...
                                        .withEvents(mapOf("Processing",
                                            new TrackingEventDefinition().withOperationType("Action")
                                                .withOperationName("ApprovedPO")
                                                .withProperties(mapOf("ApprovalStatus", mapOf(), "ApproverName",
                                                    mapOf(), "POAmount", mapOf())),
                                            "Received",
                                            new TrackingEventDefinition().withOperationType("Trigger")
                                                .withOperationName("manual")
                                                .withProperties(mapOf("City", mapOf(), "Product", mapOf(), "Quantity",
                                                    mapOf(), "State", mapOf()))))))))),
                com.azure.core.util.Context.NONE);
    }
