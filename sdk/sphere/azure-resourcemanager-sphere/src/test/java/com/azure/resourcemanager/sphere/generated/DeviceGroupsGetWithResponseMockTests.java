...
public final class DeviceGroupsGetWithResponseMockTests {
    ...
    public void testGetWithResponse() throws Exception {
        String responseStr
            = "{\"properties\":{\"description\":\"uwhhmhykojoxafn\",\"osFeedType\":\"Retail\",\"updatePolicy\":\"No3rdPartyAppUpdates\",\"allowCrashDumpsCollection\":\"Disabled\",\"regionalDataBoundary\":\"None\",\"hasDeployment\":true,\"provisioningState\":\"Canceled\"},\"id\":\"yhbpkkpw\",\"name\":\"reqnovvqfov\",\"type\":\"jxywsuws\"}";
        ...
        DeviceGroup response = manager.deviceGroups()
            .getWithResponse("kulpiujwaasi", "qiiobyuqer", "qlpqwcciuq", "bdbutauvf", com.azure.core.util.Context.NONE)
            .getValue();

        Assertions.assertEquals("uwhhmhykojoxafn", response.properties().description());
