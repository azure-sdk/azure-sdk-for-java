...
public final class ProductsListByCatalogMockTests {
    ...
    public void testListByCatalog() throws Exception {
        String responseStr
            = "{\"value\":[{\"properties\":{\"description\":\"pcjwv\",\"provisioningState\":\"Deleting\"},\"id\":\"d\",\"name\":\"mgxcxrslpm\",\"type\":\"twuoegrpkhjwni\"}]}";
        ...
        PagedIterable<Product> response
            = manager.products().listByCatalog("pkeqdcvdrhvoo", "sotbob", com.azure.core.util.Context.NONE);

        Assertions.assertEquals("pcjwv", response.iterator().next().properties().description());
    }
}
