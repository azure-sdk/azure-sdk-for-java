...
public final class ProductInnerTests {
    ...
    public void testDeserialize() throws Exception {
        ProductInner model = BinaryData.fromString(
            "{\"properties\":{\"description\":\"w\",\"provisioningState\":\"Provisioning\"},\"id\":\"vwryoqpso\",\"name\":\"cctazakljlahbc\",\"type\":\"yffdfdos\"}")
            .toObject(ProductInner.class);
        Assertions.assertEquals("w", model.properties().description());
    }

    @org.junit.jupiter.api.Test
    public void testSerialize() throws Exception {
        ProductInner model = new ProductInner().withProperties(new ProductProperties().withDescription("w"));
