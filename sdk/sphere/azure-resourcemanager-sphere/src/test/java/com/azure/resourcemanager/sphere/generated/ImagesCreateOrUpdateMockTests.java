...
public final class ImagesCreateOrUpdateMockTests {
    ...
    public void testCreateOrUpdate() throws Exception {
        String responseStr
            = "{\"properties\":{\"image\":\"mpgcjefuzmuvpbt\",\"imageId\":\"um\",\"imageName\":\"p\",\"regionalDataBoundary\":\"EU\",\"uri\":\"mnzb\",\"description\":\"hjpglkf\",\"componentId\":\"hdneuelfph\",\"imageType\":\"WifiFirmware\",\"provisioningState\":\"Succeeded\"},\"id\":\"zfikd\",\"name\":\"wwquuvxzxclvithh\",\"type\":\"zonosgg\"}";
        ...
        Image response = manager.images()
            .define("hvhgureod")
            .withExistingCatalog("nzmnsikvm", "qzeqqkdltfzxm")
            .withProperties(new ImageProperties().withImage("bdagxt")
                .withImageId("qdxbxwa")
                .withRegionalDataBoundary(RegionalDataBoundary.EU))
            .create();

        Assertions.assertEquals("mpgcjefuzmuvpbt", response.properties().image());
        Assertions.assertEquals("um", response.properties().imageId());
