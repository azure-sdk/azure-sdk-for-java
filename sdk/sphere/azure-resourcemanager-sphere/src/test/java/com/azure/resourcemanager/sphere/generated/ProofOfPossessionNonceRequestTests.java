...
public final class ProofOfPossessionNonceRequestTests {
    ...
    public void testDeserialize() throws Exception {
        ProofOfPossessionNonceRequest model = BinaryData.fromString("{\"proofOfPossessionNonce\":\"osvexcsonpclhoc\"}")
            .toObject(ProofOfPossessionNonceRequest.class);
        Assertions.assertEquals("osvexcsonpclhoc", model.proofOfPossessionNonce());
    }

    @org.junit.jupiter.api.Test
    public void testSerialize() throws Exception {
        ProofOfPossessionNonceRequest model
            = new ProofOfPossessionNonceRequest().withProofOfPossessionNonce("osvexcsonpclhoc");
