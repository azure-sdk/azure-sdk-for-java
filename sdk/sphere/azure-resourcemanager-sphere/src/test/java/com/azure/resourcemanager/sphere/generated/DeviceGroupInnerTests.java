...
public final class DeviceGroupInnerTests {
    ...
    public void testDeserialize() throws Exception {
        DeviceGroupInner model = BinaryData.fromString(
            "{\"properties\":{\"description\":\"msbzjhcrz\",\"osFeedType\":\"RetailEval\",\"updatePolicy\":\"No3rdPartyAppUpdates\",\"allowCrashDumpsCollection\":\"Enabled\",\"regionalDataBoundary\":\"EU\",\"hasDeployment\":false,\"provisioningState\":\"Succeeded\"},\"id\":\"rgqjbpfzfsinzg\",\"name\":\"f\",\"type\":\"jrwzox\"}")
            .toObject(DeviceGroupInner.class);
        Assertions.assertEquals("msbzjhcrz", model.properties().description());
    ...
    public void testSerialize() throws Exception {
        DeviceGroupInner model
            = new DeviceGroupInner().withProperties(new DeviceGroupProperties().withDescription("msbzjhcrz")
