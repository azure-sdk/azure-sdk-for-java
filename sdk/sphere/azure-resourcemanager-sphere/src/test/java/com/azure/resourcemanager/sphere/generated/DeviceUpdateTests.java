...
public final class DeviceUpdateTests {
    ...
    public void testDeserialize() throws Exception {
        DeviceUpdate model = BinaryData.fromString("{\"properties\":{\"deviceGroupId\":\"nhijggmebfsi\"}}")
            .toObject(DeviceUpdate.class);
        Assertions.assertEquals("nhijggmebfsi", model.properties().deviceGroupId());
    }

    @org.junit.jupiter.api.Test
    public void testSerialize() throws Exception {
        DeviceUpdate model
            = new DeviceUpdate().withProperties(new DeviceUpdateProperties().withDeviceGroupId("nhijggmebfsi"));
