...
public final class DeviceGroupsCountDevicesWithResponseMockTests {
    ...
    public void testCountDevicesWithResponse() throws Exception {
        String responseStr = "{\"value\":1572322989}";
        ...
        CountDevicesResponse response = manager.deviceGroups()
            .countDevicesWithResponse("suiizynkedyat", "wyhqmibzyhwits", "ypyynpcdpumnzg", "wznm",
                com.azure.core.util.Context.NONE)
            .getValue();

        Assertions.assertEquals(1572322989, response.value());
    }
}
