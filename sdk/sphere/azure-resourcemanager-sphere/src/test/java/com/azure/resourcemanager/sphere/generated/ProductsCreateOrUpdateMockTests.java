...
public final class ProductsCreateOrUpdateMockTests {
    ...
    public void testCreateOrUpdate() throws Exception {
        String responseStr
            = "{\"properties\":{\"description\":\"mhrkwofyyvoqacp\",\"provisioningState\":\"Succeeded\"},\"id\":\"btgiwbwoenwas\",\"name\":\"rtdtkcnqxw\",\"type\":\"p\"}";
        ...
        Product response = manager.products()
            .define("uejrjxgc")
            .withExistingCatalog("apvhelxprgly", "tddckcb")
            .withProperties(new ProductProperties().withDescription("brh"))
            .create();

        Assertions.assertEquals("mhrkwofyyvoqacp", response.properties().description());
    }
}
