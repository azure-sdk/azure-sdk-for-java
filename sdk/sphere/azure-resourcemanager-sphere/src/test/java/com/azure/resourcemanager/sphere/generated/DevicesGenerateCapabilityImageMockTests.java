...
public final class DevicesGenerateCapabilityImageMockTests {
    ...
    public void testGenerateCapabilityImage() throws Exception {
        ...
        ManagementError response = manager.devices()
            .generateCapabilityImage("dxdigr", "guufzd", "syqtfi", "whbotzingamv", "phoszqz",
                new GenerateCapabilityImageRequest().withCapabilities(
                    Arrays.asList(CapabilityType.FIELD_SERVICING, CapabilityType.APPLICATION_DEVELOPMENT)),
