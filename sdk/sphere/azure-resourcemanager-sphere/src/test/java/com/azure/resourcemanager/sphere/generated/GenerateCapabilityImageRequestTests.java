...
public final class GenerateCapabilityImageRequestTests {
    ...
    public void testDeserialize() throws Exception {
        GenerateCapabilityImageRequest model
            = BinaryData.fromString("{\"capabilities\":[\"ApplicationDevelopment\",\"ApplicationDevelopment\"]}")
    ...
    public void testSerialize() throws Exception {
        GenerateCapabilityImageRequest model = new GenerateCapabilityImageRequest().withCapabilities(
            Arrays.asList(CapabilityType.APPLICATION_DEVELOPMENT, CapabilityType.APPLICATION_DEVELOPMENT));
