...
public final class ProductsCountDevicesWithResponseMockTests {
    ...
    public void testCountDevicesWithResponse() throws Exception {
        String responseStr = "{\"value\":1662682497}";
        ...
        CountDevicesResponse response = manager.products()
            .countDevicesWithResponse("qsluicp", "ggkzzlvmbmpa", "modfvuefywsbpfvm", com.azure.core.util.Context.NONE)
            .getValue();

        Assertions.assertEquals(1662682497, response.value());
    }
}
