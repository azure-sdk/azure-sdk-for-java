...
public final class DeviceGroupsCreateOrUpdateMockTests {
    ...
    public void testCreateOrUpdate() throws Exception {
        String responseStr
            = "{\"properties\":{\"description\":\"kywggxkallatmel\",\"osFeedType\":\"Retail\",\"updatePolicy\":\"No3rdPartyAppUpdates\",\"allowCrashDumpsCollection\":\"Disabled\",\"regionalDataBoundary\":\"EU\",\"hasDeployment\":false,\"provisioningState\":\"Succeeded\"},\"id\":\"vvcnayr\",\"name\":\"yrnxxmueedn\",\"type\":\"rdvstkwqqtch\"}";
        ...
        DeviceGroup response = manager.deviceGroups()
            .define("h")
            .withExistingProduct("iknsorgjh", "bldtlww", "lkdmtncvokotllxd")
            .withProperties(new DeviceGroupProperties().withDescription("ocogj")
        ...
        Assertions.assertEquals("kywggxkallatmel", response.properties().description());
