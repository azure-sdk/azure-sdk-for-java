...
public interface Catalog {
     ...
     */
    PagedIterable<DeviceGroup> listDeviceGroups(ListDeviceGroupsRequest body);
     ...
     * @return the response of a DeviceGroup list operation as paginated response with {@link PagedIterable}.
     */
    PagedIterable<DeviceGroup> listDeviceGroups(ListDeviceGroupsRequest body, String filter, Integer top, Integer skip,
     ...
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     */
    void uploadImage(ImageInner body);
     ...
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     */
    void uploadImage(ImageInner body, Context context);
}
