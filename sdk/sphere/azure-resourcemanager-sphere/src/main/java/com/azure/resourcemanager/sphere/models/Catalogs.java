...
public interface Catalogs {
     ...
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     */
    void uploadImage(String resourceGroupName, String catalogName, ImageInner body);
     ...
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     */
    void uploadImage(String resourceGroupName, String catalogName, ImageInner body, Context context);
