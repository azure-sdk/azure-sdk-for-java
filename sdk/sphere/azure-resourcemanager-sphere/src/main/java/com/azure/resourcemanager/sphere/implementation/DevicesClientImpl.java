...
public final class DevicesClientImpl implements DevicesClient {
     ...
     */
    DevicesClientImpl(AzureSphereClientImpl client) {
        this.service = RestProxy.create(DevicesService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for AzureSphereClientDevices to be used by the proxy service to perform
     * REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "AzureSphereClientDev")
    public interface DevicesService {
        ...
        Mono<Response<Flux<ByteBuffer>>> createOrUpdate(@HostParam("endpoint") String endpoint,
            ...
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("catalogName") String catalogName,
            @PathParam("productName") String productName, @PathParam("deviceGroupName") String deviceGroupName,
            @PathParam("deviceName") String deviceName, @HeaderParam("accept") String accept,
            @BodyParam("application/json") DeviceInner resource, Context context);
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<DevicesUpdateResponse> update(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("catalogName") String catalogName,
            @PathParam("productName") String productName, @PathParam("deviceGroupName") String deviceGroupName,
            @PathParam("deviceName") String deviceName, @HeaderParam("accept") String accept,
            @BodyParam("application/json") DeviceUpdate properties, Context context);
        ...
        Mono<Response<Flux<ByteBuffer>>> generateCapabilityImage(@HostParam("endpoint") String endpoint,
            ...
            @PathParam("productName") String productName, @PathParam("deviceGroupName") String deviceGroupName,
            @PathParam("deviceName") String deviceName, @HeaderParam("accept") String accept,
            @BodyParam("application/json") GenerateCapabilityImageRequest body, Context context);
    ...
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(context -> service.createOrUpdate(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, catalogName, productName, deviceGroupName,
                deviceName, accept, resource, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DevicesUpdateResponse> updateWithResponseAsync(String resourceGroupName, String catalogName,
        ...
        return FluxUtil
            .withContext(context -> service.update(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, catalogName, productName, deviceGroupName,
                deviceName, accept, properties, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<DevicesUpdateResponse> updateWithResponseAsync(String resourceGroupName, String catalogName,
        ...
        return service.update(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, catalogName, productName, deviceGroupName, deviceName, accept, properties, context);
    }
    ...
    private Mono<DeviceInner> updateAsync(String resourceGroupName, String catalogName, String productName,
        ...
        return updateWithResponseAsync(resourceGroupName, catalogName, productName, deviceGroupName, deviceName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public DevicesUpdateResponse updateWithResponse(String resourceGroupName, String catalogName, String productName,
    ...
    public DeviceInner update(String resourceGroupName, String catalogName, String productName, String deviceGroupName,
        ...
        return updateWithResponse(resourceGroupName, catalogName, productName, deviceGroupName, deviceName, properties,
    ...
    private Mono<Response<Flux<ByteBuffer>>> generateCapabilityImageWithResponseAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(context -> service.generateCapabilityImage(this.client.getEndpoint(),
                ...
                productName, deviceGroupName, deviceName, accept, body, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<ManagementError>, ManagementError> beginGenerateCapabilityImageAsync(
        ...
        Mono<Response<Flux<ByteBuffer>>> mono = generateCapabilityImageWithResponseAsync(resourceGroupName, catalogName,
            productName, deviceGroupName, deviceName, body);
    ...
    private PollerFlux<PollResult<ManagementError>, ManagementError> beginGenerateCapabilityImageAsync(
        ...
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono = generateCapabilityImageWithResponseAsync(resourceGroupName, catalogName,
            productName, deviceGroupName, deviceName, body, context);
        return this.client.<ManagementError, ManagementError>getLroResult(mono, this.client.getHttpPipeline(),
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<ManagementError>, ManagementError> beginGenerateCapabilityImage(
        String resourceGroupName, String catalogName, String productName, String deviceGroupName, String deviceName,
        GenerateCapabilityImageRequest body) {
        return this
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ManagementError> generateCapabilityImageAsync(String resourceGroupName, String catalogName,
        String productName, String deviceGroupName, String deviceName, GenerateCapabilityImageRequest body) {
        return beginGenerateCapabilityImageAsync(resourceGroupName, catalogName, productName, deviceGroupName,
            deviceName, body).last().flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<ManagementError> generateCapabilityImageAsync(String resourceGroupName, String catalogName,
        ...
        Context context) {
        return beginGenerateCapabilityImageAsync(resourceGroupName, catalogName, productName, deviceGroupName,
            deviceName, body, context).last().flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ManagementError generateCapabilityImage(String resourceGroupName, String catalogName, String productName,
