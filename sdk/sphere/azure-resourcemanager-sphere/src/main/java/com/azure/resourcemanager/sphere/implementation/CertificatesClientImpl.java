...
public final class CertificatesClientImpl implements CertificatesClient {
     ...
     */
    CertificatesClientImpl(AzureSphereClientImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for AzureSphereClientCertificates to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "AzureSphereClientCer")
    public interface CertificatesService {
        ...
        Mono<Response<ProofOfPossessionNonceResponseInner>> retrieveProofOfPossessionNonce(
            ...
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("catalogName") String catalogName,
            @PathParam("serialNumber") String serialNumber, @HeaderParam("accept") String accept,
            @BodyParam("application/json") ProofOfPossessionNonceRequest body, Context context);
     ...
     * @param catalogName Name of catalog.
     * @param serialNumber Serial number of the certificate. Use '.default' to get current active certificate.
     * @param body Proof of possession nonce request body.
     * @throws IllegalArgumentException thrown if parameters fail the validation.
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
    ...
    private Mono<Response<ProofOfPossessionNonceResponseInner>> retrieveProofOfPossessionNonceWithResponseAsync(
        String resourceGroupName, String catalogName, String serialNumber, ProofOfPossessionNonceRequest body) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return FluxUtil
            .withContext(context -> service.retrieveProofOfPossessionNonce(this.client.getEndpoint(),
                ...
                serialNumber, accept, body, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<ProofOfPossessionNonceResponseInner>> retrieveProofOfPossessionNonceWithResponseAsync(
        ...
        return service.retrieveProofOfPossessionNonce(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, catalogName, serialNumber, accept, body, context);
    }
    ...
    private Mono<ProofOfPossessionNonceResponseInner> retrieveProofOfPossessionNonceAsync(String resourceGroupName,
        String catalogName, String serialNumber, ProofOfPossessionNonceRequest body) {
        return retrieveProofOfPossessionNonceWithResponseAsync(resourceGroupName, catalogName, serialNumber, body)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
    ...
    public ProofOfPossessionNonceResponseInner retrieveProofOfPossessionNonce(String resourceGroupName,
        String catalogName, String serialNumber, ProofOfPossessionNonceRequest body) {
        return retrieveProofOfPossessionNonceWithResponse(resourceGroupName, catalogName, serialNumber, body,
