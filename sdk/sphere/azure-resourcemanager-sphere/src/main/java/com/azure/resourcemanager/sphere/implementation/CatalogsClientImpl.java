...
public final class CatalogsClientImpl implements CatalogsClient {
     ...
     */
    private final AzureSphereClientImpl client;
     ...
     */
    CatalogsClientImpl(AzureSphereClientImpl client) {
        this.service = RestProxy.create(CatalogsService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for AzureSphereClientCatalogs to be used by the proxy service to perform
     * REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "AzureSphereClientCat")
    public interface CatalogsService {
        ...
        Mono<Response<Flux<ByteBuffer>>> createOrUpdate(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("catalogName") String catalogName,
            @HeaderParam("accept") String accept, @BodyParam("application/json") CatalogInner resource,
            Context context);
        ...
        Mono<Response<CatalogInner>> update(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("catalogName") String catalogName,
            @HeaderParam("accept") String accept, @BodyParam("application/json") CatalogUpdate properties,
            Context context);
        ...
        Mono<Response<DeviceGroupListResult>> listDeviceGroups(@HostParam("endpoint") String endpoint,
            ...
            @QueryParam("$top") Integer top, @QueryParam("$skip") Integer skip,
            @QueryParam("$maxpagesize") Integer maxpagesize, @PathParam("catalogName") String catalogName,
            @HeaderParam("accept") String accept, @BodyParam("application/json") ListDeviceGroupsRequest body,
            Context context);
        ...
        Mono<Response<Flux<ByteBuffer>>> uploadImage(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("catalogName") String catalogName,
            @HeaderParam("accept") String accept, @BodyParam("application/json") ImageInner body, Context context);
    ...
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(context -> service.createOrUpdate(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, catalogName, accept, resource, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<CatalogInner>> updateWithResponseAsync(String resourceGroupName, String catalogName,
        ...
        return FluxUtil
            .withContext(context -> service.update(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, catalogName, accept, properties, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<CatalogInner>> updateWithResponseAsync(String resourceGroupName, String catalogName,
        ...
        return service.update(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, catalogName, accept, properties, context);
    }
     ...
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
     * @param catalogName Name of catalog.
     * @param body List device groups for catalog.
     * @param filter Filter the result list using the given expression.
     * @param top The number of result items to return.
     * @param skip The number of result items to skip.
     * @param maxpagesize The maximum number of result items per page.
    ...
    private Mono<PagedResponse<DeviceGroupInner>> listDeviceGroupsSinglePageAsync(String resourceGroupName,
        String catalogName, ListDeviceGroupsRequest body, String filter, Integer top, Integer skip,
        Integer maxpagesize) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<DeviceGroupInner>> listDeviceGroupsSinglePageAsync(String resourceGroupName,
        String catalogName, ListDeviceGroupsRequest body, String filter, Integer top, Integer skip, Integer maxpagesize,
        Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        return service
            .listDeviceGroups(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
                resourceGroupName, filter, top, skip, maxpagesize, catalogName, accept, body, context)
            .map(res -> new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(),
                res.getValue().value(), res.getValue().nextLink(), null));
    }
    ...
    private PagedFlux<DeviceGroupInner> listDeviceGroupsAsync(String resourceGroupName, String catalogName,
        ListDeviceGroupsRequest body, String filter, Integer top, Integer skip, Integer maxpagesize) {
        return new PagedFlux<>(
            () -> listDeviceGroupsSinglePageAsync(resourceGroupName, catalogName, body, filter, top, skip, maxpagesize),
    ...
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<DeviceGroupInner> listDeviceGroupsAsync(String resourceGroupName, String catalogName,
        ListDeviceGroupsRequest body, String filter, Integer top, Integer skip, Integer maxpagesize, Context context) {
        return new PagedFlux<>(() -> listDeviceGroupsSinglePageAsync(resourceGroupName, catalogName, body, filter, top,
            skip, maxpagesize, context), nextLink -> listDeviceGroupsNextSinglePageAsync(nextLink, context));
    }
    ...
    public PagedIterable<DeviceGroupInner> listDeviceGroups(String resourceGroupName, String catalogName,
        ...
        final Integer maxpagesize = null;
        return new PagedIterable<>(
            listDeviceGroupsAsync(resourceGroupName, catalogName, body, filter, top, skip, maxpagesize));
    }
    ...
    public PagedIterable<DeviceGroupInner> listDeviceGroups(String resourceGroupName, String catalogName,
        ListDeviceGroupsRequest body, String filter, Integer top, Integer skip, Integer maxpagesize, Context context) {
        return new PagedIterable<>(
            listDeviceGroupsAsync(resourceGroupName, catalogName, body, filter, top, skip, maxpagesize, context));
    }
     ...
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
     * @param catalogName Name of catalog.
     * @param body Image upload request body.
     * @throws IllegalArgumentException thrown if parameters fail the validation.
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the {@link Response} on successful completion of {@link Mono}.
    ...
    private Mono<Response<Flux<ByteBuffer>>> uploadImageWithResponseAsync(String resourceGroupName, String catalogName,
        ...
        return FluxUtil
            .withContext(context -> service.uploadImage(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, catalogName, accept, body, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> uploadImageWithResponseAsync(String resourceGroupName, String catalogName,
        ImageInner body, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    private PollerFlux<PollResult<Void>, Void> beginUploadImageAsync(String resourceGroupName, String catalogName,
        ImageInner body) {
        Mono<Response<Flux<ByteBuffer>>> mono = uploadImageWithResponseAsync(resourceGroupName, catalogName, body);
        return this.client.<Void, Void>getLroResult(mono, this.client.getHttpPipeline(), Void.class, Void.class,
            this.client.getContext());
    }
    ...
    private PollerFlux<PollResult<Void>, Void> beginUploadImageAsync(String resourceGroupName, String catalogName,
        ...
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono
            = uploadImageWithResponseAsync(resourceGroupName, catalogName, body, context);
        return this.client.<Void, Void>getLroResult(mono, this.client.getHttpPipeline(), Void.class, Void.class,
            context);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginUploadImage(String resourceGroupName, String catalogName,
        ImageInner body) {
        return this.beginUploadImageAsync(resourceGroupName, catalogName, body).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginUploadImage(String resourceGroupName, String catalogName,
        ImageInner body, Context context) {
        return this.beginUploadImageAsync(resourceGroupName, catalogName, body, context).getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> uploadImageAsync(String resourceGroupName, String catalogName, ImageInner body) {
        return beginUploadImageAsync(resourceGroupName, catalogName, body).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<Void> uploadImageAsync(String resourceGroupName, String catalogName, ImageInner body,
        Context context) {
        return beginUploadImageAsync(resourceGroupName, catalogName, body, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public void uploadImage(String resourceGroupName, String catalogName, ImageInner body) {
        uploadImageAsync(resourceGroupName, catalogName, body).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public void uploadImage(String resourceGroupName, String catalogName, ImageInner body, Context context) {
        uploadImageAsync(resourceGroupName, catalogName, body, context).block();
    }
