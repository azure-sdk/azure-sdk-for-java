...
public interface Device {
     ...
     * @return the response.
     */
    ManagementError generateCapabilityImage(GenerateCapabilityImageRequest body);
     ...
     * @return the response.
     */
    ManagementError generateCapabilityImage(GenerateCapabilityImageRequest body, Context context);
}
