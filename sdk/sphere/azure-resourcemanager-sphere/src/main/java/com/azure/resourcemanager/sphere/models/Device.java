...
public interface Device {
    ...
    /**
     * Gets the name property: Device name.
     * 
     ...
     */
    SignedCapabilityImageResponse generateCapabilityImage(GenerateCapabilityImageRequest body);
     ...
     * @return signed device capability image response.
     */
    SignedCapabilityImageResponse generateCapabilityImage(GenerateCapabilityImageRequest body, Context context);
}
