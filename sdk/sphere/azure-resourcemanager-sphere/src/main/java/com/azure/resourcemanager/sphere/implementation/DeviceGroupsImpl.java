...
public final class DeviceGroupsImpl implements DeviceGroups {
    ...
    public void claimDevices(String resourceGroupName, String catalogName, String productName, String deviceGroupName,
        ...
        this.serviceClient().claimDevices(resourceGroupName, catalogName, productName, deviceGroupName, body);
    }

    public void claimDevices(String resourceGroupName, String catalogName, String productName, String deviceGroupName,
        ClaimDevicesRequest body, Context context) {
        this.serviceClient().claimDevices(resourceGroupName, catalogName, productName, deviceGroupName, body, context);
    }

    public Response<CountDeviceResponse> countDevicesWithResponse(String resourceGroupName, String catalogName,
        String productName, String deviceGroupName, Context context) {
        Response<CountDeviceResponseInner> inner = this.serviceClient().countDevicesWithResponse(resourceGroupName,
