...
import com.azure.resourcemanager.sphere.implementation.models.PagedOperation;
...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    OperationsClientImpl(AzureSphereClientImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for AzureSphereClientOperations to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "AzureSphereClientOpe")
