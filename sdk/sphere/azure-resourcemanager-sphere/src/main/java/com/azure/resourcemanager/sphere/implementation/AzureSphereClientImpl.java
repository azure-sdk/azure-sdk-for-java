...
import com.azure.resourcemanager.sphere.fluent.AzureSphereClient;
...
/**
 * Initializes a new instance of the AzureSphereClientImpl type.
 */
@ServiceClient(builder = AzureSphereClientBuilder.class)
public final class AzureSphereClientImpl implements AzureSphereClient {
    /**
     * Server parameter.
     */
    ...
    /**
     * Initializes an instance of AzureSphereClient client.
     * 
     ...
     */
    AzureSphereClientImpl(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter, Duration defaultPollInterval,
    ...
    private static final ClientLogger LOGGER = new ClientLogger(AzureSphereClientImpl.class);
}
