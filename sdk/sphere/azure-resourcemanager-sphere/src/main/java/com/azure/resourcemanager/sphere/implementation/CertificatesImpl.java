...
public final class CertificatesImpl implements Certificates {
    ...
    public Response<ProofOfPossessionNonceResponse> retrieveProofOfPossessionNonceWithResponse(String resourceGroupName,
        String catalogName, String serialNumber, ProofOfPossessionNonceRequest body, Context context) {
        Response<ProofOfPossessionNonceResponseInner> inner = this.serviceClient()
            .retrieveProofOfPossessionNonceWithResponse(resourceGroupName, catalogName, serialNumber, body, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
    ...
    public ProofOfPossessionNonceResponse retrieveProofOfPossessionNonce(String resourceGroupName, String catalogName,
        String serialNumber, ProofOfPossessionNonceRequest body) {
        ProofOfPossessionNonceResponseInner inner
            = this.serviceClient().retrieveProofOfPossessionNonce(resourceGroupName, catalogName, serialNumber, body);
        if (inner != null) {
