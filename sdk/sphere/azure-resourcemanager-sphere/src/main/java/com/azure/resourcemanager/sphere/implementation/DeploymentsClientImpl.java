...
public final class DeploymentsClientImpl implements DeploymentsClient {
     ...
     */
    DeploymentsClientImpl(AzureSphereClientImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for AzureSphereClientDeployments to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "AzureSphereClientDep")
    public interface DeploymentsService {
        ...
        Mono<Response<Flux<ByteBuffer>>> createOrUpdate(@HostParam("endpoint") String endpoint,
            ...
            @BodyParam("application/json") DeploymentInner resource, Context context);
    ...
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(context -> service.createOrUpdate(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, catalogName, productName, deviceGroupName,
                deploymentName, accept, resource, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
