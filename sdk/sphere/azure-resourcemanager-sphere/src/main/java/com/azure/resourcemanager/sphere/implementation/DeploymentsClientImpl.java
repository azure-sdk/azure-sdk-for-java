...
public final class DeploymentsClientImpl implements DeploymentsClient {
    ...
    private Mono<PagedResponse<DeploymentInner>> listByDeviceGroupSinglePageAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(context -> service.listByDeviceGroup(this.client.getEndpoint(), filter, top, skip, maxpagesize,
    ...
    private Mono<PagedResponse<DeploymentInner>> listByDeviceGroupSinglePageAsync(String resourceGroupName,
        ...
        return service
            .listByDeviceGroup(this.client.getEndpoint(), filter, top, skip, maxpagesize, this.client.getApiVersion(),
