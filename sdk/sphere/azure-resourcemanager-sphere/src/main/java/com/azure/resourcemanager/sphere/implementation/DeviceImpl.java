...
public final class DeviceImpl implements Device, Device.Definition, Device.Update {
    ...
    public SignedCapabilityImageResponse generateCapabilityImage(GenerateCapabilityImageRequest body) {
        return serviceManager.devices().generateCapabilityImage(resourceGroupName, catalogName, productName,
            deviceGroupName, deviceName, body);
    }

    public SignedCapabilityImageResponse generateCapabilityImage(GenerateCapabilityImageRequest body, Context context) {
        return serviceManager.devices().generateCapabilityImage(resourceGroupName, catalogName, productName,
            deviceGroupName, deviceName, body, context);
    }
