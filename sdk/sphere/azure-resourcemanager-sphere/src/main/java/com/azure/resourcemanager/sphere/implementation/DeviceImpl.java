...
public final class DeviceImpl implements Device, Device.Definition, Device.Update {
    ...
    public Device create() {
        this.innerObject = serviceManager.serviceClient()
            .getDevices()
            .createOrUpdate(resourceGroupName, catalogName, productName, deviceGroupName, deviceName, this.innerModel(),
                Context.NONE);
        return this;
    }
    ...
    public Device apply() {
        this.innerObject = serviceManager.serviceClient()
            .getDevices()
            .updateWithResponse(resourceGroupName, catalogName, productName, deviceGroupName, deviceName,
    ...
    public ManagementError generateCapabilityImage(GenerateCapabilityImageRequest body) {
        return serviceManager.devices()
            .generateCapabilityImage(resourceGroupName, catalogName, productName, deviceGroupName, deviceName, body);
    }

    public ManagementError generateCapabilityImage(GenerateCapabilityImageRequest body, Context context) {
        return serviceManager.devices()
            .generateCapabilityImage(resourceGroupName, catalogName, productName, deviceGroupName, deviceName, body,
                context);
    }
