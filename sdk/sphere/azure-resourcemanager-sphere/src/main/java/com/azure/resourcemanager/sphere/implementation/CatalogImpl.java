...
public final class CatalogImpl implements Catalog, Catalog.Definition, Catalog.Update {
    ...
    public PagedIterable<Deployment> listDeployments(String filter, Integer top, Integer skip, Integer maxpagesize,
        Context context) {
        return serviceManager.catalogs()
    ...
    public void uploadImage(ImageInner body) {
        serviceManager.catalogs().uploadImage(resourceGroupName, catalogName, body);
    }

    public void uploadImage(ImageInner body, Context context) {
        serviceManager.catalogs().uploadImage(resourceGroupName, catalogName, body, context);
    }
