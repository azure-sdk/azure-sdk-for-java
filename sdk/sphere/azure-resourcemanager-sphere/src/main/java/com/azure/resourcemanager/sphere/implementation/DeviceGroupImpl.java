...
public final class DeviceGroupImpl implements DeviceGroup, DeviceGroup.Definition, DeviceGroup.Update {
    ...
    public void claimDevices(ClaimDevicesRequest body) {
        serviceManager.deviceGroups().claimDevices(resourceGroupName, catalogName, productName, deviceGroupName, body);
    }

    public void claimDevices(ClaimDevicesRequest body, Context context) {
        serviceManager.deviceGroups()
            .claimDevices(resourceGroupName, catalogName, productName, deviceGroupName, body, context);
    }
