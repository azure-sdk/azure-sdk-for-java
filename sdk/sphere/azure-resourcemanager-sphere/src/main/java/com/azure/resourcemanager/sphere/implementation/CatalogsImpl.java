...
public final class CatalogsImpl implements Catalogs {
    ...
    public PagedIterable<DeviceGroup> listDeviceGroups(String resourceGroupName, String catalogName,
        ...
        PagedIterable<DeviceGroupInner> inner
            = this.serviceClient().listDeviceGroups(resourceGroupName, catalogName, body);
    ...
    public PagedIterable<DeviceGroup> listDeviceGroups(String resourceGroupName, String catalogName,
        ...
        PagedIterable<DeviceGroupInner> inner = this.serviceClient()
            .listDeviceGroups(resourceGroupName, catalogName, body, filter, top, skip, maxpagesize, context);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new DeviceGroupImpl(inner1, this.manager()));
    }
    ...
    public void uploadImage(String resourceGroupName, String catalogName, ImageInner body) {
        this.serviceClient().uploadImage(resourceGroupName, catalogName, body);
    }

    public void uploadImage(String resourceGroupName, String catalogName, ImageInner body, Context context) {
        this.serviceClient().uploadImage(resourceGroupName, catalogName, body, context);
    }
