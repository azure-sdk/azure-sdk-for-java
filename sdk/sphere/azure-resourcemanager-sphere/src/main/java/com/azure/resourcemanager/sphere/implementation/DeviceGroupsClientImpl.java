...
public final class DeviceGroupsClientImpl implements DeviceGroupsClient {
     ...
     */
    DeviceGroupsClientImpl(AzureSphereClientImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for AzureSphereClientDeviceGroups to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{endpoint}")
    ...
    public interface DeviceGroupsService {
        ...
        Mono<Response<DeviceGroupInner>> get(@HostParam("endpoint") String endpoint,
        ...
        Mono<Response<Flux<ByteBuffer>>> createOrUpdate(@HostParam("endpoint") String endpoint,
            ...
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("catalogName") String catalogName,
            @PathParam("productName") String productName, @PathParam("deviceGroupName") String deviceGroupName,
            @HeaderParam("accept") String accept, @BodyParam("application/json") DeviceGroupInner resource,
            Context context);
        ...
        Mono<Response<Flux<ByteBuffer>>> update(@HostParam("endpoint") String endpoint,
            ...
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("catalogName") String catalogName,
            @PathParam("productName") String productName, @PathParam("deviceGroupName") String deviceGroupName,
            @HeaderParam("accept") String accept, @BodyParam("application/json") DeviceGroupUpdate properties,
            Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<DeviceGroupListResult>> listByProduct(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
        ...
        Mono<Response<Flux<ByteBuffer>>> claimDevices(@HostParam("endpoint") String endpoint,
            ...
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("catalogName") String catalogName,
            @PathParam("productName") String productName, @PathParam("deviceGroupName") String deviceGroupName,
            @HeaderParam("accept") String accept, @BodyParam("application/json") ClaimDevicesRequest body,
            Context context);
    ...
    private Mono<Response<Flux<ByteBuffer>>> updateWithResponseAsync(String resourceGroupName, String catalogName,
        ...
        return service.update(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, catalogName, productName, deviceGroupName, accept, properties, context);
    }
     ...
     * @param productName Name of product.
     * @param deviceGroupName Name of device group.
     * @param body Bulk claim devices request body.
     * @throws IllegalArgumentException thrown if parameters fail the validation.
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the {@link Response} on successful completion of {@link Mono}.
    ...
    private Mono<Response<Flux<ByteBuffer>>> claimDevicesWithResponseAsync(String resourceGroupName, String catalogName,
        String productName, String deviceGroupName, ClaimDevicesRequest body) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> claimDevicesWithResponseAsync(String resourceGroupName, String catalogName,
        String productName, String deviceGroupName, ClaimDevicesRequest body, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service.claimDevices(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, catalogName, productName, deviceGroupName, accept, body,
            context);
    }
    ...
    private PollerFlux<PollResult<Void>, Void> beginClaimDevicesAsync(String resourceGroupName, String catalogName,
        String productName, String deviceGroupName, ClaimDevicesRequest body) {
        Mono<Response<Flux<ByteBuffer>>> mono
            = claimDevicesWithResponseAsync(resourceGroupName, catalogName, productName, deviceGroupName, body);
        return this.client.<Void, Void>getLroResult(mono, this.client.getHttpPipeline(), Void.class, Void.class,
            this.client.getContext());
    }
    ...
    private PollerFlux<PollResult<Void>, Void> beginClaimDevicesAsync(String resourceGroupName, String catalogName,
        ...
        Mono<Response<Flux<ByteBuffer>>> mono = claimDevicesWithResponseAsync(resourceGroupName, catalogName,
            productName, deviceGroupName, body, context);
        return this.client.<Void, Void>getLroResult(mono, this.client.getHttpPipeline(), Void.class, Void.class,
            context);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginClaimDevices(String resourceGroupName, String catalogName,
        String productName, String deviceGroupName, ClaimDevicesRequest body) {
        return this.beginClaimDevicesAsync(resourceGroupName, catalogName, productName, deviceGroupName, body)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginClaimDevices(String resourceGroupName, String catalogName,
        String productName, String deviceGroupName, ClaimDevicesRequest body, Context context) {
        return this.beginClaimDevicesAsync(resourceGroupName, catalogName, productName, deviceGroupName, body, context)
            .getSyncPoller();
    }
    ...
    private Mono<Void> claimDevicesAsync(String resourceGroupName, String catalogName, String productName,
        String deviceGroupName, ClaimDevicesRequest body) {
        return beginClaimDevicesAsync(resourceGroupName, catalogName, productName, deviceGroupName, body).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> claimDevicesAsync(String resourceGroupName, String catalogName, String productName,
        String deviceGroupName, ClaimDevicesRequest body, Context context) {
        return beginClaimDevicesAsync(resourceGroupName, catalogName, productName, deviceGroupName, body, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    public void claimDevices(String resourceGroupName, String catalogName, String productName, String deviceGroupName,
        ...
        claimDevicesAsync(resourceGroupName, catalogName, productName, deviceGroupName, body).block();
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    public void claimDevices(String resourceGroupName, String catalogName, String productName, String deviceGroupName,
        ClaimDevicesRequest body, Context context) {
        claimDevicesAsync(resourceGroupName, catalogName, productName, deviceGroupName, body, context).block();
    }
