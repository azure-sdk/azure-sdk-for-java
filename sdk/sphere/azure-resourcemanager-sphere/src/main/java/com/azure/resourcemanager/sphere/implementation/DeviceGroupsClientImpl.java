...
public final class DeviceGroupsClientImpl implements DeviceGroupsClient {
    ...
    private Mono<PagedResponse<DeviceGroupInner>> listByProductSinglePageAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(context -> service.listByProduct(this.client.getEndpoint(), filter, top, skip, maxpagesize,
    ...
    private Mono<PagedResponse<DeviceGroupInner>> listByProductSinglePageAsync(String resourceGroupName,
        ...
        return service
            .listByProduct(this.client.getEndpoint(), filter, top, skip, maxpagesize, this.client.getApiVersion(),
