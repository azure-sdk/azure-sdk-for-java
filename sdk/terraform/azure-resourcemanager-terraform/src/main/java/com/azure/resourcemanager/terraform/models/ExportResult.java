...
public final class ExportResult implements JsonSerializable<ExportResult> {
     ...
     */
    public ExportResult withConfiguration(String configuration) {
     ...
     * @return the ExportResult object itself.
     */
    public ExportResult withSkippedResources(List<String> skippedResources) {
     ...
     * @return the ExportResult object itself.
     */
    public ExportResult withErrors(List<ManagementError> errors) {
        this.errors = errors;
        return this;
    }
