...
public final class OperationStatusInner implements JsonSerializable<OperationStatusInner> {
    ...
    /**
     * Get the id property: The operation status resource id.
     * 
     * @return the id value.
     */
    public String id() {
    ...
    /**
     * Set the id property: The operation status resource id.
     * 
    ...
    /**
     * Get the resourceId property: The fully qualified resource id of the resource for which the operation was
     * performed.
     * 
    ...
    /**
     * Get the percentComplete property: The progress percentage of the operation, ranges from 0 to 100.
     * 
    ...
    /**
     * Set the percentComplete property: The progress percentage of the operation, ranges from 0 to 100.
     * 
     * @param percentComplete the percentComplete value to set.
     * @return the OperationStatusInner object itself.
     */
    public OperationStatusInner withPercentComplete(Double percentComplete) {
        this.percentComplete = percentComplete;
        return this;
    }

    /**
     * Get the properties property: The Terraform export result.
     * 
    ...
    /**
     * Set the properties property: The Terraform export result.
     * 
     * @param properties the properties value to set.
     * @return the OperationStatusInner object itself.
     */
    public OperationStatusInner withProperties(ExportResult properties) {
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("id".equals(fieldName)) {
                    ...
                    deserializedOperationStatusInner.properties = ExportResult.fromJson(reader);
