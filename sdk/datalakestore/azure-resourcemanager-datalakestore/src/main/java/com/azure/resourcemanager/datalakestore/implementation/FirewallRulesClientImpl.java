...
public final class FirewallRulesClientImpl implements FirewallRulesClient {
     ...
     */
    FirewallRulesClientImpl(DataLakeStoreAccountManagementClientImpl client) {
        this.service =
    ...
    /**
     * The interface defining all the services for DataLakeStoreAccountManagementClientFirewallRules to be used by the
