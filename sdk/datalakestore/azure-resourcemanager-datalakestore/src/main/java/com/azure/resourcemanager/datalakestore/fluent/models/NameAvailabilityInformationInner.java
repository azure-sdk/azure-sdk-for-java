...
public final class NameAvailabilityInformationInner {
    ...
    /**
     * Get the reason property: The reason why the Data Lake Store account name is not available, if nameAvailable is
     * false.
     *
    ...
    /**
     * Get the message property: The message describing why the Data Lake Store account name is not available, if
