...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    OperationsClientImpl(DataLakeStoreAccountManagementClientImpl client) {
        this.service =
    ...
    /**
     * The interface defining all the services for DataLakeStoreAccountManagementClientOperations to be used by the
     ...
     * @return the list of available operations for Data Lake Store along with {@link Response} on successful completion
     *     of {@link Mono}.
     */
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the list of available operations for Data Lake Store on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
