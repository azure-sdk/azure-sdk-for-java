...
public interface LotsOperationsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<LotSummaryInner> listByBillingAccount(String billingAccountId, String filter,
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<LotSummaryInner> listByCustomer(String billingAccountId, String customerId, String filter,
        Context context);
}
