...
public final class BalanceProperties {
     ...
     */
    @JsonProperty(value = "refundedOverageCredits", access = JsonProperty.Access.WRITE_ONLY)
    private BigDecimal refundedOverageCredits;
    ...
    /**
     * Get the refundedOverageCredits property: Refunded Overage Credits.
     *
     * @return the refundedOverageCredits value.
     */
    public BigDecimal refundedOverageCredits() {
        return this.refundedOverageCredits;
    }
