...
public final class LotSource extends ExpandableStringEnum<LotSource> {
    ...
    /**
     * Static value AwardedCredit for LotSource.
     */
    public static final LotSource AWARDED_CREDIT = fromString("AwardedCredit");

    /**
     * Static value ServiceSpecificCredit for LotSource.
     */
    public static final LotSource SERVICE_SPECIFIC_CREDIT = fromString("ServiceSpecificCredit");
