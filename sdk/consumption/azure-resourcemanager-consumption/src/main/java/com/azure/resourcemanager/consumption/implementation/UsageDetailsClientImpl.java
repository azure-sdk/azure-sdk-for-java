...
public final class UsageDetailsClientImpl implements UsageDetailsClient {
    ...
    public interface UsageDetailsService {
        ...
        Mono<Response<UsageDetailsListResult>> list(@HostParam("$host") String endpoint,
            @PathParam(value = "scope", encoded = true) String scope, @QueryParam("$expand") String expand,
    ...
    private Mono<PagedResponse<UsageDetailInner>> listSinglePageAsync(String scope, String expand, String filter,
        ...
        return FluxUtil
            .withContext(context -> service.list(this.client.getEndpoint(), scope, expand, filter, skiptoken, top,
                this.client.getApiVersion(), metric, accept, context))
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<UsageDetailInner>> listSinglePageAsync(String scope, String expand, String filter,
        String skiptoken, Integer top, Metrictype metric, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service
            .list(this.client.getEndpoint(), scope, expand, filter, skiptoken, top, this.client.getApiVersion(), metric,
                accept, context)
    ...
    private PagedFlux<UsageDetailInner> listAsync(String scope, String expand, String filter, String skiptoken,
        ...
        return new PagedFlux<>(() -> listSinglePageAsync(scope, expand, filter, skiptoken, top, metric, context),
