...
public final class ReservationRecommendationDetailsClientImpl implements ReservationRecommendationDetailsClient {
    ...
    public interface ReservationRecommendationDetailsService {
        ...
        Mono<Response<ReservationRecommendationDetailsModelInner>> get(@HostParam("$host") String endpoint,
            ...
            @QueryParam("region") String region, @QueryParam("term") String term,
     ...
     * @param term Specify length of reservation recommendation term. Specify in ISO 8601 Duration. Allowed values:
     * ['P1M', 'P1Y', 'P3Y'].
    ...
    private Mono<Response<ReservationRecommendationDetailsModelInner>> getWithResponseAsync(String resourceScope,
        Scope scope, String region, String term, LookBackPeriod lookBackPeriod, String product, String filter) {
    ...
    private Mono<Response<ReservationRecommendationDetailsModelInner>> getWithResponseAsync(String resourceScope,
        ...
        return service.get(this.client.getEndpoint(), this.client.getApiVersion(), resourceScope, scope, region, term,
            lookBackPeriod, product, filter, accept, context);
    }
    ...
    private Mono<ReservationRecommendationDetailsModelInner> getAsync(String resourceScope, Scope scope, String region,
        String term, LookBackPeriod lookBackPeriod, String product) {
    ...
    public Response<ReservationRecommendationDetailsModelInner> getWithResponse(String resourceScope, Scope scope,
        String region, String term, LookBackPeriod lookBackPeriod, String product, String filter, Context context) {
        return getWithResponseAsync(resourceScope, scope, region, term, lookBackPeriod, product, filter, context)
            .block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ReservationRecommendationDetailsModelInner get(String resourceScope, Scope scope, String region, String term,
