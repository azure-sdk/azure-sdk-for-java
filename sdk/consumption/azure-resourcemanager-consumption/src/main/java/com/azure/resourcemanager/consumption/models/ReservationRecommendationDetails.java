...
public interface ReservationRecommendationDetails {
     ...
     */
    Response<ReservationRecommendationDetailsModel> getWithResponse(String resourceScope, Scope scope, String region,
        String term, LookBackPeriod lookBackPeriod, String product, String filter, Context context);
     ...
     */
    ReservationRecommendationDetailsModel get(String resourceScope, Scope scope, String region, String term,
