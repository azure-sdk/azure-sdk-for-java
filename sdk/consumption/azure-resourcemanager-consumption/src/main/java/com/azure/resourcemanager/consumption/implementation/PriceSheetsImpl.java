...
public final class PriceSheetsImpl implements PriceSheets {
    ...
    public Response<PriceSheetResultAutoGenerated> getWithResponse(
        String expand, String skiptoken, Integer top, Context context) {
        Response<PriceSheetResultAutoGeneratedInner> inner =
            this.serviceClient().getWithResponse(expand, skiptoken, top, context);
        if (inner != null) {
            return new SimpleResponse<>(
                inner.getRequest(),
                inner.getStatusCode(),
                inner.getHeaders(),
                new PriceSheetResultAutoGeneratedImpl(inner.getValue(), this.manager()));
        } else {
            return null;
        }
    }

    public PriceSheetResultAutoGenerated get() {
        PriceSheetResultAutoGeneratedInner inner = this.serviceClient().get();
        if (inner != null) {
            return new PriceSheetResultAutoGeneratedImpl(inner, this.manager());
        } else {
            return null;
        }
    }

    public Response<PriceSheetResultAutoGenerated> getByBillingPeriodWithResponse(
        String billingPeriodName, String expand, String skiptoken, Integer top, Context context) {
        Response<PriceSheetResultAutoGeneratedInner> inner =
            this.serviceClient().getByBillingPeriodWithResponse(billingPeriodName, expand, skiptoken, top, context);
        if (inner != null) {
    ...
    public PriceSheetResultAutoGenerated getByBillingPeriod(String billingPeriodName) {
        PriceSheetResultAutoGeneratedInner inner = this.serviceClient().getByBillingPeriod(billingPeriodName);
        if (inner != null) {
            return new PriceSheetResultAutoGeneratedImpl(inner, this.manager());
        } else {
            return null;
