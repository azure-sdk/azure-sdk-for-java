...
public final class PriceSheetsClientImpl implements PriceSheetsClient {
    ...
    public interface PriceSheetsService {
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<PriceSheetResultAutoGeneratedInner>> get(
            @HostParam("$host") String endpoint,
            @QueryParam("$expand") String expand,
            @QueryParam("$skiptoken") String skiptoken,
            @QueryParam("$top") Integer top,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<PriceSheetResultAutoGeneratedInner>> getByBillingPeriod(
            @HostParam("$host") String endpoint,
            @QueryParam("$expand") String expand,
            @QueryParam("$skiptoken") String skiptoken,
            @QueryParam("$top") Integer top,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<PriceSheetResultAutoGeneratedInner>> getWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PriceSheetResultAutoGeneratedInner> getAsync() {
        final String expand = null;
        final String skiptoken = null;
        final Integer top = null;
        return getWithResponseAsync(expand, skiptoken, top).flatMap(res -> Mono.justOrEmpty(res.getValue()));
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<PriceSheetResultAutoGeneratedInner> getWithResponse(
        String expand, String skiptoken, Integer top, Context context) {
        return getWithResponseAsync(expand, skiptoken, top, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public PriceSheetResultAutoGeneratedInner get() {
        final String expand = null;
        final String skiptoken = null;
        final Integer top = null;
        return getWithResponse(expand, skiptoken, top, Context.NONE).getValue();
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<PriceSheetResultAutoGeneratedInner>> getByBillingPeriodWithResponseAsync(
        String billingPeriodName, String expand, String skiptoken, Integer top) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PriceSheetResultAutoGeneratedInner> getByBillingPeriodAsync(String billingPeriodName) {
        final String expand = null;
        final String skiptoken = null;
        final Integer top = null;
        return getByBillingPeriodWithResponseAsync(billingPeriodName, expand, skiptoken, top)
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<PriceSheetResultAutoGeneratedInner> getByBillingPeriodWithResponse(
        String billingPeriodName, String expand, String skiptoken, Integer top, Context context) {
        return getByBillingPeriodWithResponseAsync(billingPeriodName, expand, skiptoken, top, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public PriceSheetResultAutoGeneratedInner getByBillingPeriod(String billingPeriodName) {
        final String expand = null;
        final String skiptoken = null;
        final Integer top = null;
        return getByBillingPeriodWithResponse(billingPeriodName, expand, skiptoken, top, Context.NONE).getValue();
