...
public final class LegacyReservationTransaction extends ReservationTransactionInner {
    ...
    /**
     * Reads an instance of LegacyReservationTransaction from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of LegacyReservationTransaction if the JsonReader was pointing to an instance of it, or null
     * if it was pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the LegacyReservationTransaction.
     */
    public static LegacyReservationTransaction fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            LegacyReservationTransaction deserializedLegacyReservationTransaction = new LegacyReservationTransaction();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("id".equals(fieldName)) {
                    deserializedLegacyReservationTransaction.id = reader.getString();
                } else if ("name".equals(fieldName)) {
                    deserializedLegacyReservationTransaction.name = reader.getString();
                } else if ("type".equals(fieldName)) {
                    deserializedLegacyReservationTransaction.type = reader.getString();
                } else if ("tags".equals(fieldName)) {
                    List<String> tags = reader.readArray(reader1 -> reader1.getString());
                    deserializedLegacyReservationTransaction.tags = tags;
                } else if ("properties".equals(fieldName)) {
                    deserializedLegacyReservationTransaction.innerProperties
            ...
            return deserializedLegacyReservationTransaction;
        });
    }
}
