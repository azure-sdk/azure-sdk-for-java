...
public final class NetworkTapImpl implements NetworkTap, NetworkTap.Definition, NetworkTap.Update {
    ...
    public NetworkTap create() {
        this.innerObject = serviceManager.serviceClient().getNetworkTaps().create(resourceGroupName, networkTapName,
    ...
    public NetworkTap apply() {
        this.innerObject = serviceManager.serviceClient().getNetworkTaps().update(resourceGroupName, networkTapName,
    ...
    public NetworkTap refresh() {
        this.innerObject = serviceManager.serviceClient().getNetworkTaps()
            .getByResourceGroupWithResponse(resourceGroupName, networkTapName, Context.NONE).getValue();
        return this;
    }

    public NetworkTap refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getNetworkTaps()
            .getByResourceGroupWithResponse(resourceGroupName, networkTapName, context).getValue();
        return this;
    }
