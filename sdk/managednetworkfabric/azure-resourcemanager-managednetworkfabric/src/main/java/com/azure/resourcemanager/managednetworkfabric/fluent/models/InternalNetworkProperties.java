...
/** InternalNetworkProperties define the resource properties. */
@Fluent
public final class InternalNetworkProperties extends AnnotationResource {
    ...
    private List<InternalNetworkPropertiesConnectedIPv4SubnetsItem> connectedIPv4Subnets;

    /*
     * List with object connectedIPv6Subnets.
     */
    @JsonProperty(value = "connectedIPv6Subnets")
    private List<InternalNetworkPropertiesConnectedIPv6SubnetsItem> connectedIPv6Subnets;
     ...
     */
    public InternalNetworkProperties withVlanId(Integer vlanId) {
        this.vlanId = vlanId;
        return this;
    }
    ...
    /**
     * Get the bfdForStaticRoutesDisabledOnResources property: List of resources the L2 Isolation Domain is disabled on.
