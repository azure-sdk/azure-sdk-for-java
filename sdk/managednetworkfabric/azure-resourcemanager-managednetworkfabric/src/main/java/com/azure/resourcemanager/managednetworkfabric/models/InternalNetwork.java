...
public interface InternalNetwork {
    ...
    /**
     * Gets the bfdForStaticRoutesDisabledOnResources property: List of resources the L2 Isolation Domain is disabled
    ...
    interface DefinitionStages {
        ...
        interface WithCreate
            extends DefinitionStages.WithVlanId,
     ...
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     */
    void updateBfdForStaticRoutesState(UpdateAdministrativeState body);
     ...
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     */
    void updateBfdForStaticRoutesState(UpdateAdministrativeState body, Context context);
}
