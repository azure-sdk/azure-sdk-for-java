...
public final class NetworkRacksClientImpl implements NetworkRacksClient {
    ...
    public SyncPoller<PollResult<NetworkRackInner>, NetworkRackInner> beginCreate(
        String resourceGroupName, String networkRackName, NetworkRackInner body) {
        return beginCreateAsync(resourceGroupName, networkRackName, body).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<NetworkRackInner>, NetworkRackInner> beginCreate(
        String resourceGroupName, String networkRackName, NetworkRackInner body, Context context) {
        return beginCreateAsync(resourceGroupName, networkRackName, body, context).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<NetworkRackInner>, NetworkRackInner> beginUpdate(
        String resourceGroupName, String networkRackName, NetworkRackPatch body) {
        return beginUpdateAsync(resourceGroupName, networkRackName, body).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<NetworkRackInner>, NetworkRackInner> beginUpdate(
        String resourceGroupName, String networkRackName, NetworkRackPatch body, Context context) {
        return beginUpdateAsync(resourceGroupName, networkRackName, body, context).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String networkRackName) {
        return beginDeleteAsync(resourceGroupName, networkRackName).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(
        String resourceGroupName, String networkRackName, Context context) {
        return beginDeleteAsync(resourceGroupName, networkRackName, context).getSyncPoller();
    }
