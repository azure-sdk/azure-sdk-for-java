...
public final class L3IsolationDomainsClientImpl implements L3IsolationDomainsClient {
    ...
    public interface L3IsolationDomainsService {
        ...
        @Post(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers"
                + "/Microsoft.ManagedNetworkFabric/l3IsolationDomains/{l3IsolationDomainName}/updateAdminState")
        ...
        @Post(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers"
                + "/Microsoft.ManagedNetworkFabric/l3IsolationDomains/{l3IsolationDomainName}/updateOptionBAdminState")
        @ExpectedResponses({202})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Flux<ByteBuffer>>> updateOptionBAdminState(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @QueryParam("api-version") String apiVersion,
    ...
    public SyncPoller<PollResult<L3IsolationDomainInner>, L3IsolationDomainInner> beginCreate(
        String resourceGroupName, String l3IsolationDomainName, L3IsolationDomainInner body) {
        return beginCreateAsync(resourceGroupName, l3IsolationDomainName, body).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<L3IsolationDomainInner>, L3IsolationDomainInner> beginCreate(
        String resourceGroupName, String l3IsolationDomainName, L3IsolationDomainInner body, Context context) {
        return beginCreateAsync(resourceGroupName, l3IsolationDomainName, body, context).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<L3IsolationDomainInner>, L3IsolationDomainInner> beginUpdate(
        String resourceGroupName, String l3IsolationDomainName, L3IsolationDomainPatch body) {
        return beginUpdateAsync(resourceGroupName, l3IsolationDomainName, body).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<L3IsolationDomainInner>, L3IsolationDomainInner> beginUpdate(
        String resourceGroupName, String l3IsolationDomainName, L3IsolationDomainPatch body, Context context) {
        return beginUpdateAsync(resourceGroupName, l3IsolationDomainName, body, context).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String l3IsolationDomainName) {
        return beginDeleteAsync(resourceGroupName, l3IsolationDomainName).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(
        String resourceGroupName, String l3IsolationDomainName, Context context) {
        return beginDeleteAsync(resourceGroupName, l3IsolationDomainName, context).getSyncPoller();
    }
    ...
    private PollerFlux<PollResult<Void>, Void> beginUpdateAdminStateAsync(
        String resourceGroupName, String l3IsolationDomainName, UpdateAdministrativeState body) {
        Mono<Response<Flux<ByteBuffer>>> mono =
            updateAdminStateWithResponseAsync(resourceGroupName, l3IsolationDomainName, body);
        return this
            .client
            .<Void, Void>getLroResult(
                mono, this.client.getHttpPipeline(), Void.class, Void.class, this.client.getContext());
    ...
    private PollerFlux<PollResult<Void>, Void> beginUpdateAdminStateAsync(
        ...
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono =
            updateAdminStateWithResponseAsync(resourceGroupName, l3IsolationDomainName, body, context);
        return this
            .client
            .<Void, Void>getLroResult(mono, this.client.getHttpPipeline(), Void.class, Void.class, context);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginUpdateAdminState(
        String resourceGroupName, String l3IsolationDomainName, UpdateAdministrativeState body) {
        return beginUpdateAdminStateAsync(resourceGroupName, l3IsolationDomainName, body).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginUpdateAdminState(
        String resourceGroupName, String l3IsolationDomainName, UpdateAdministrativeState body, Context context) {
        return beginUpdateAdminStateAsync(resourceGroupName, l3IsolationDomainName, body, context).getSyncPoller();
    }
    ...
    private Mono<Void> updateAdminStateAsync(
        String resourceGroupName, String l3IsolationDomainName, UpdateAdministrativeState body) {
        return beginUpdateAdminStateAsync(resourceGroupName, l3IsolationDomainName, body)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<Void> updateAdminStateAsync(
        String resourceGroupName, String l3IsolationDomainName, UpdateAdministrativeState body, Context context) {
        return beginUpdateAdminStateAsync(resourceGroupName, l3IsolationDomainName, body, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    public void updateAdminState(
        String resourceGroupName, String l3IsolationDomainName, UpdateAdministrativeState body) {
        updateAdminStateAsync(resourceGroupName, l3IsolationDomainName, body).block();
    }
    ...
    public void updateAdminState(
        String resourceGroupName, String l3IsolationDomainName, UpdateAdministrativeState body, Context context) {
        updateAdminStateAsync(resourceGroupName, l3IsolationDomainName, body, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> updateOptionBAdminStateWithResponseAsync(
        String resourceGroupName, String l3IsolationDomainName, UpdateAdministrativeState body) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<Void>, Void> beginUpdateOptionBAdminStateAsync(
        String resourceGroupName, String l3IsolationDomainName, UpdateAdministrativeState body) {
        Mono<Response<Flux<ByteBuffer>>> mono =
            updateOptionBAdminStateWithResponseAsync(resourceGroupName, l3IsolationDomainName, body);
        return this
            .client
            .<Void, Void>getLroResult(
                mono, this.client.getHttpPipeline(), Void.class, Void.class, this.client.getContext());
    ...
    private PollerFlux<PollResult<Void>, Void> beginUpdateOptionBAdminStateAsync(
        ...
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono =
            updateOptionBAdminStateWithResponseAsync(resourceGroupName, l3IsolationDomainName, body, context);
        return this
            .client
            .<Void, Void>getLroResult(mono, this.client.getHttpPipeline(), Void.class, Void.class, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<Void>, Void> beginUpdateOptionBAdminState(
        String resourceGroupName, String l3IsolationDomainName, UpdateAdministrativeState body) {
        return beginUpdateOptionBAdminStateAsync(resourceGroupName, l3IsolationDomainName, body).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginUpdateOptionBAdminState(
        String resourceGroupName, String l3IsolationDomainName, UpdateAdministrativeState body, Context context) {
        return beginUpdateOptionBAdminStateAsync(resourceGroupName, l3IsolationDomainName, body, context)
            .getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> updateOptionBAdminStateAsync(
        String resourceGroupName, String l3IsolationDomainName, UpdateAdministrativeState body) {
        return beginUpdateOptionBAdminStateAsync(resourceGroupName, l3IsolationDomainName, body)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public void updateOptionBAdminState(
        String resourceGroupName, String l3IsolationDomainName, UpdateAdministrativeState body) {
        updateOptionBAdminStateAsync(resourceGroupName, l3IsolationDomainName, body).block();
    }
    ...
    public void updateOptionBAdminState(
        String resourceGroupName, String l3IsolationDomainName, UpdateAdministrativeState body, Context context) {
        updateOptionBAdminStateAsync(resourceGroupName, l3IsolationDomainName, body, context).block();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginClearArpTable(
        String resourceGroupName, String l3IsolationDomainName, EnableDisableOnResources body) {
        return beginClearArpTableAsync(resourceGroupName, l3IsolationDomainName, body).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginClearArpTable(
        String resourceGroupName, String l3IsolationDomainName, EnableDisableOnResources body, Context context) {
        return beginClearArpTableAsync(resourceGroupName, l3IsolationDomainName, body, context).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginClearNeighborTable(
        String resourceGroupName, String l3IsolationDomainName, EnableDisableOnResources body) {
        return beginClearNeighborTableAsync(resourceGroupName, l3IsolationDomainName, body).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginClearNeighborTable(
        String resourceGroupName, String l3IsolationDomainName, EnableDisableOnResources body, Context context) {
        return beginClearNeighborTableAsync(resourceGroupName, l3IsolationDomainName, body, context).getSyncPoller();
    }
