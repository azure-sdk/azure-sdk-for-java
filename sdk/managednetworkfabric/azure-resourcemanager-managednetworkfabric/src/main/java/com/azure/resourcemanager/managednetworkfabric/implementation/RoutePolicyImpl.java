...
public final class RoutePolicyImpl implements RoutePolicy, RoutePolicy.Definition, RoutePolicy.Update {
    ...
    public List<RoutePolicyPropertiesStatementsItem> statements() {
        List<RoutePolicyPropertiesStatementsItem> inner = this.innerModel().statements();
        if (inner != null) {
    ...
    public RoutePolicyImpl withStatements(List<RoutePolicyPropertiesStatementsItem> statements) {
