...
public final class RoutePolicyImpl implements RoutePolicy, RoutePolicy.Definition, RoutePolicy.Update {
    ...
    public RoutePolicy create() {
        this.innerObject = serviceManager.serviceClient().getRoutePolicies().create(resourceGroupName, routePolicyName,
    ...
    public RoutePolicy apply() {
        this.innerObject = serviceManager.serviceClient().getRoutePolicies().update(resourceGroupName, routePolicyName,
    ...
    public RoutePolicy refresh() {
        this.innerObject = serviceManager.serviceClient().getRoutePolicies()
            .getByResourceGroupWithResponse(resourceGroupName, routePolicyName, Context.NONE).getValue();
        return this;
    }

    public RoutePolicy refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getRoutePolicies()
            .getByResourceGroupWithResponse(resourceGroupName, routePolicyName, context).getValue();
        return this;
    }
