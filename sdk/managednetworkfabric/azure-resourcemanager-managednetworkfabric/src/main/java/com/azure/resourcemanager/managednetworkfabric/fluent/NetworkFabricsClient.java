...
public interface NetworkFabricsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<ValidationResultPropertiesInner>, ValidationResultPropertiesInner> beginValidateConfiguration(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ValidationResultPropertiesInner validateConfiguration(String resourceGroupName, String networkFabricName);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ValidationResultPropertiesInner validateConfiguration(
        String resourceGroupName, String networkFabricName, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<Void>, Void> beginRestoreConfig(String resourceGroupName, String networkFabricName);
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<Void>, Void> beginUpgrade(String resourceGroupName, String networkFabricName);
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<Void>, Void> beginGetManagementNetworkConfigurationStatus(
        String resourceGroupName, String networkFabricName);
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<Void>, Void> beginEnableNniLayer2(
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<Void>, Void> beginEnableNniLayer3(
        String resourceGroupName, String networkFabricName, List<String> body);
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<Void>, Void> beginDisableNniLayer2(
        String resourceGroupName, String networkFabricName, List<String> body);
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<Void>, Void> beginDisableNniLayer3(
        String resourceGroupName, String networkFabricName, List<String> body);
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<NniStatusPropertiesInner>, NniStatusPropertiesInner> beginGetNniStatus(
        String resourceGroupName, String networkFabricName);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    NniStatusPropertiesInner getNniStatus(String resourceGroupName, String networkFabricName);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    NniStatusPropertiesInner getNniStatus(String resourceGroupName, String networkFabricName, Context context);
}
