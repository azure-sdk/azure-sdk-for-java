...
public final class AccessControlListImpl
    ...
    public AccessControlList create() {
        this.innerObject = serviceManager.serviceClient().getAccessControlLists().create(resourceGroupName,
            accessControlListName, this.innerModel(), Context.NONE);
        return this;
    }

    public AccessControlList create(Context context) {
        this.innerObject = serviceManager.serviceClient().getAccessControlLists().create(resourceGroupName,
            accessControlListName, this.innerModel(), context);
        return this;
    }
    ...
    public AccessControlList apply() {
        this.innerObject = serviceManager.serviceClient().getAccessControlLists().update(resourceGroupName,
            accessControlListName, updateBody, Context.NONE);
        return this;
    }

    public AccessControlList apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getAccessControlLists().update(resourceGroupName,
            accessControlListName, updateBody, context);
        return this;
    }
    ...
    public AccessControlList refresh() {
        this.innerObject = serviceManager.serviceClient().getAccessControlLists()
            .getByResourceGroupWithResponse(resourceGroupName, accessControlListName, Context.NONE).getValue();
        return this;
    }

    public AccessControlList refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getAccessControlLists()
            .getByResourceGroupWithResponse(resourceGroupName, accessControlListName, context).getValue();
        return this;
    }

    public CommonPostActionResponseForStateUpdate updateAdministrativeState(UpdateAdministrativeState body) {
        return serviceManager.accessControlLists().updateAdministrativeState(resourceGroupName, accessControlListName,
            body);
    }
