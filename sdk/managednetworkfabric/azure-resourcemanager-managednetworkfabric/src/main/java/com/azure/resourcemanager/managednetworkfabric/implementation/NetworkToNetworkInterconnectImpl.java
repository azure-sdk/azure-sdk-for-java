...
public final class NetworkToNetworkInterconnectImpl implements NetworkToNetworkInterconnect,
    ...
    public NetworkToNetworkInterconnect create() {
        this.innerObject = serviceManager.serviceClient().getNetworkToNetworkInterconnects().create(resourceGroupName,
            networkFabricName, networkToNetworkInterconnectName, this.innerModel(), Context.NONE);
        return this;
    }

    public NetworkToNetworkInterconnect create(Context context) {
        this.innerObject = serviceManager.serviceClient().getNetworkToNetworkInterconnects().create(resourceGroupName,
            networkFabricName, networkToNetworkInterconnectName, this.innerModel(), context);
        return this;
    }
    ...
    public NetworkToNetworkInterconnect apply() {
        this.innerObject = serviceManager.serviceClient().getNetworkToNetworkInterconnects().update(resourceGroupName,
            networkFabricName, networkToNetworkInterconnectName, updateBody, Context.NONE);
        return this;
    }

    public NetworkToNetworkInterconnect apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getNetworkToNetworkInterconnects().update(resourceGroupName,
            networkFabricName, networkToNetworkInterconnectName, updateBody, context);
        return this;
    }
    ...
    public NetworkToNetworkInterconnect refresh() {
        this.innerObject = serviceManager.serviceClient().getNetworkToNetworkInterconnects()
    ...
    public CommonPostActionResponseForStateUpdate
        ...
        return serviceManager.networkToNetworkInterconnects().updateNpbStaticRouteBfdAdministrativeState(
    ...
    public CommonPostActionResponseForStateUpdate updateAdministrativeState(UpdateAdministrativeState body) {
        return serviceManager.networkToNetworkInterconnects().updateAdministrativeState(resourceGroupName,
