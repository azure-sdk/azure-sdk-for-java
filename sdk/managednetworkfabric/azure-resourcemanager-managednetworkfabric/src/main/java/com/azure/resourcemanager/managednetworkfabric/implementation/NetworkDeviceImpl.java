...
public final class NetworkDeviceImpl implements NetworkDevice, NetworkDevice.Definition, NetworkDevice.Update {
    ...
    public String deviceName() {
        return this.innerModel().deviceName();
    }
    ...
    public NetworkDeviceImpl withNetworkDeviceSku(String networkDeviceSku) {
        if (isInCreateMode()) {
            ...
            this.updateBody.withNetworkDeviceSku(networkDeviceSku);
            return this;
        }
    }

    public NetworkDeviceImpl withNetworkDeviceRole(String networkDeviceRole) {
        if (isInCreateMode()) {
            this.innerModel().withNetworkDeviceRole(networkDeviceRole);
            return this;
        } else {
            this.updateBody.withNetworkDeviceRole(networkDeviceRole);
            return this;
        }
    }

    public NetworkDeviceImpl withDeviceName(String deviceName) {
        if (isInCreateMode()) {
            this.innerModel().withDeviceName(deviceName);
            return this;
        } else {
            this.updateBody.withDeviceName(deviceName);
            return this;
        }
    }
