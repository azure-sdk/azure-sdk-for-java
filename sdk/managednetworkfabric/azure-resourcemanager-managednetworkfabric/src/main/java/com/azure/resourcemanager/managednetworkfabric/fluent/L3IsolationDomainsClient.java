...
public interface L3IsolationDomainsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    void updateAdminState(String resourceGroupName, String l3IsolationDomainName, UpdateAdministrativeState body);
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<Void>, Void> beginUpdateOptionBAdminState(
        String resourceGroupName, String l3IsolationDomainName, UpdateAdministrativeState body);
