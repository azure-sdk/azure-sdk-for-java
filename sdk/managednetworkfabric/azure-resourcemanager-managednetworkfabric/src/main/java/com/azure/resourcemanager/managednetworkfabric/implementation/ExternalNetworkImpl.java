...
public final class ExternalNetworkImpl implements ExternalNetwork, ExternalNetwork.Definition, ExternalNetwork.Update {
    ...
    public ExternalNetwork create() {
        this.innerObject = serviceManager.serviceClient().getExternalNetworks().create(resourceGroupName,
            l3IsolationDomainName, externalNetworkName, this.innerModel(), Context.NONE);
        return this;
    }

    public ExternalNetwork create(Context context) {
        this.innerObject = serviceManager.serviceClient().getExternalNetworks().create(resourceGroupName,
            l3IsolationDomainName, externalNetworkName, this.innerModel(), context);
        return this;
    }
    ...
    public ExternalNetwork apply() {
        this.innerObject = serviceManager.serviceClient().getExternalNetworks().update(resourceGroupName,
            l3IsolationDomainName, externalNetworkName, updateBody, Context.NONE);
        return this;
    }

    public ExternalNetwork apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getExternalNetworks().update(resourceGroupName,
            l3IsolationDomainName, externalNetworkName, updateBody, context);
        return this;
    }
    ...
    public ExternalNetwork refresh() {
        this.innerObject = serviceManager.serviceClient().getExternalNetworks()
            .getWithResponse(resourceGroupName, l3IsolationDomainName, externalNetworkName, Context.NONE).getValue();
        return this;
    }

    public ExternalNetwork refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getExternalNetworks()
            .getWithResponse(resourceGroupName, l3IsolationDomainName, externalNetworkName, context).getValue();
        return this;
    }

    public CommonPostActionResponseForStateUpdate updateAdministrativeState(UpdateAdministrativeState body) {
        return serviceManager.externalNetworks().updateAdministrativeState(resourceGroupName, l3IsolationDomainName,
    ...
    public CommonPostActionResponseForStateUpdate
        ...
        return serviceManager.externalNetworks().updateStaticRouteBfdAdministrativeState(resourceGroupName,
