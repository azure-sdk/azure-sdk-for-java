...
public interface NetworkDevice {
    ...
    /**
     * Gets the deviceName property: deviceName will be used for setting the hostName of the device.
     *
    ...
    interface DefinitionStages {
        ...
        interface WithCreate
            extends DefinitionStages.WithTags,
                ...
                DefinitionStages.WithDeviceName,
        ...
        interface WithNetworkDeviceRole {
             ...
             * @return the next definition stage.
             */
            WithCreate withNetworkDeviceRole(String networkDeviceRole);
        }
        /** The stage of the NetworkDevice definition allowing to specify deviceName. */
        interface WithDeviceName {
            /**
             * Specifies the deviceName property: deviceName will be used for setting the hostName of the device..
             *
             * @param deviceName deviceName will be used for setting the hostName of the device.
             * @return the next definition stage.
             */
            WithCreate withDeviceName(String deviceName);
        }
    ...
    interface Update
        extends UpdateStages.WithTags,
            UpdateStages.WithNetworkDeviceSku,
            UpdateStages.WithNetworkDeviceRole,
            UpdateStages.WithDeviceName,
    ...
    interface UpdateStages {
        ...
        /** The stage of the NetworkDevice update allowing to specify networkDeviceSku. */
        interface WithNetworkDeviceSku {
            /**
             * Specifies the networkDeviceSku property: Network Device SKU name..
             *
             ...
             * @return the next definition stage.
             */
            Update withNetworkDeviceSku(String networkDeviceSku);
        }
        /** The stage of the NetworkDevice update allowing to specify networkDeviceRole. */
        interface WithNetworkDeviceRole {
            /**
             * Specifies the networkDeviceRole property: networkDeviceRole is the device role: Example: CE | ToR..
             *
             ...
             * @return the next definition stage.
             */
            Update withNetworkDeviceRole(String networkDeviceRole);
        }
        /** The stage of the NetworkDevice update allowing to specify deviceName. */
        interface WithDeviceName {
            /**
             * Specifies the deviceName property: deviceName will be used for setting the hostName of the device..
             *
             ...
             * @return the next definition stage.
             */
            Update withDeviceName(String deviceName);
        }
