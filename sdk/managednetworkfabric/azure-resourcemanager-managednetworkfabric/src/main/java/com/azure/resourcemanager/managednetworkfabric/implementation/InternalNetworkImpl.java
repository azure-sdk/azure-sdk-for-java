...
import com.azure.resourcemanager.managednetworkfabric.models.InternalNetworkPropertiesConnectedIPv6SubnetsItem;
...
public final class InternalNetworkImpl implements InternalNetwork, InternalNetwork.Definition, InternalNetwork.Update {
    ...
    public List<InternalNetworkPropertiesConnectedIPv4SubnetsItem> connectedIPv4Subnets() {
        List<InternalNetworkPropertiesConnectedIPv4SubnetsItem> inner = this.innerModel().connectedIPv4Subnets();
        if (inner != null) {
    ...
    public List<InternalNetworkPropertiesConnectedIPv6SubnetsItem> connectedIPv6Subnets() {
        List<InternalNetworkPropertiesConnectedIPv6SubnetsItem> inner = this.innerModel().connectedIPv6Subnets();
        if (inner != null) {
            return Collections.unmodifiableList(inner);
        } else {
            return Collections.emptyList();
    ...
    public void updateAdminState(UpdateAdministrativeState body) {
        serviceManager
            .internalNetworks()
            .updateAdminState(resourceGroupName, l3IsolationDomainName, internalNetworkName, body);
    }

    public void updateAdminState(UpdateAdministrativeState body, Context context) {
        serviceManager
            .internalNetworks()
            .updateAdminState(resourceGroupName, l3IsolationDomainName, internalNetworkName, body, context);
    }

    public void updateBgpState(UpdateAdministrativeState body) {
        serviceManager
            .internalNetworks()
            .updateBgpState(resourceGroupName, l3IsolationDomainName, internalNetworkName, body);
    }

    public void updateBgpState(UpdateAdministrativeState body, Context context) {
        serviceManager
            .internalNetworks()
            .updateBgpState(resourceGroupName, l3IsolationDomainName, internalNetworkName, body, context);
    }

    public void updateBfdForBgpState(UpdateAdministrativeState body) {
        serviceManager
            .internalNetworks()
            .updateBfdForBgpState(resourceGroupName, l3IsolationDomainName, internalNetworkName, body);
    }

    public void updateBfdForBgpState(UpdateAdministrativeState body, Context context) {
        serviceManager
            .internalNetworks()
            .updateBfdForBgpState(resourceGroupName, l3IsolationDomainName, internalNetworkName, body, context);
    }
    ...
    public void updateBfdForStaticRoutesState(UpdateAdministrativeState body) {
        serviceManager
            .internalNetworks()
            .updateBfdForStaticRoutesState(resourceGroupName, l3IsolationDomainName, internalNetworkName, body);
    }

    public void updateBfdForStaticRoutesState(UpdateAdministrativeState body, Context context) {
        serviceManager
            .internalNetworks()
    ...
    public InternalNetworkImpl withVlanId(Integer vlanId) {
    ...
    public InternalNetworkImpl withConnectedIPv4Subnets(
        List<InternalNetworkPropertiesConnectedIPv4SubnetsItem> connectedIPv4Subnets) {
        this.innerModel().withConnectedIPv4Subnets(connectedIPv4Subnets);
        return this;
    }

    public InternalNetworkImpl withConnectedIPv6Subnets(
        List<InternalNetworkPropertiesConnectedIPv6SubnetsItem> connectedIPv6Subnets) {
