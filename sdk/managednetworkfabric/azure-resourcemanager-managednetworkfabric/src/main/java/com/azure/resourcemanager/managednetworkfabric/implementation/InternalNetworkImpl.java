...
public final class InternalNetworkImpl implements InternalNetwork, InternalNetwork.Definition, InternalNetwork.Update {
    ...
    public InternalNetwork create() {
        this.innerObject = serviceManager.serviceClient().getInternalNetworks().create(resourceGroupName,
            l3IsolationDomainName, internalNetworkName, this.innerModel(), Context.NONE);
        return this;
    }

    public InternalNetwork create(Context context) {
        this.innerObject = serviceManager.serviceClient().getInternalNetworks().create(resourceGroupName,
            l3IsolationDomainName, internalNetworkName, this.innerModel(), context);
        return this;
    }
    ...
    public InternalNetwork apply() {
        this.innerObject = serviceManager.serviceClient().getInternalNetworks().update(resourceGroupName,
            l3IsolationDomainName, internalNetworkName, updateBody, Context.NONE);
        return this;
    }

    public InternalNetwork apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getInternalNetworks().update(resourceGroupName,
            l3IsolationDomainName, internalNetworkName, updateBody, context);
        return this;
    }
    ...
    public InternalNetwork refresh() {
        this.innerObject = serviceManager.serviceClient().getInternalNetworks()
            .getWithResponse(resourceGroupName, l3IsolationDomainName, internalNetworkName, Context.NONE).getValue();
        return this;
    }

    public InternalNetwork refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getInternalNetworks()
            .getWithResponse(resourceGroupName, l3IsolationDomainName, internalNetworkName, context).getValue();
        return this;
    }

    public CommonPostActionResponseForStateUpdate updateAdministrativeState(UpdateAdministrativeState body) {
        return serviceManager.internalNetworks().updateAdministrativeState(resourceGroupName, l3IsolationDomainName,
    ...
    public CommonPostActionResponseForStateUpdate updateBgpAdministrativeState(UpdateAdministrativeState body) {
        return serviceManager.internalNetworks().updateBgpAdministrativeState(resourceGroupName, l3IsolationDomainName,
            internalNetworkName, body);
    }
    ...
    public CommonPostActionResponseForStateUpdate
        ...
        return serviceManager.internalNetworks().updateStaticRouteBfdAdministrativeState(resourceGroupName,
