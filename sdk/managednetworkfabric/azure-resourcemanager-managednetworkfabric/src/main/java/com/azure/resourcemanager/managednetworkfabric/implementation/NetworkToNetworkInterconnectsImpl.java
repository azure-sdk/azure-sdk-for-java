...
public final class NetworkToNetworkInterconnectsImpl implements NetworkToNetworkInterconnects {
    ...
    public Response<NetworkToNetworkInterconnect> getWithResponse(String resourceGroupName, String networkFabricName,
        ...
        Response<NetworkToNetworkInterconnectInner> inner = this.serviceClient().getWithResponse(resourceGroupName,
            networkFabricName, networkToNetworkInterconnectName, context);
        if (inner != null) {
    ...
    public CommonPostActionResponseForStateUpdate updateNpbStaticRouteBfdAdministrativeState(String resourceGroupName,
        ...
        CommonPostActionResponseForStateUpdateInner inner
            = this.serviceClient().updateNpbStaticRouteBfdAdministrativeState(resourceGroupName, networkFabricName,
    ...
    public CommonPostActionResponseForStateUpdate updateAdministrativeState(String resourceGroupName,
        String networkFabricName, String networkToNetworkInterconnectName, UpdateAdministrativeState body,
        Context context) {
        CommonPostActionResponseForStateUpdateInner inner = this.serviceClient().updateAdministrativeState(
