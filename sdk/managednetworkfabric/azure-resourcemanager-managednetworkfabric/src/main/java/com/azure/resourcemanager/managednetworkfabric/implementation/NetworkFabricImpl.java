...
public final class NetworkFabricImpl implements NetworkFabric, NetworkFabric.Definition, NetworkFabric.Update {
    ...
    public NetworkFabric create() {
        this.innerObject = serviceManager.serviceClient().getNetworkFabrics().create(resourceGroupName,
            networkFabricName, this.innerModel(), Context.NONE);
        return this;
    }

    public NetworkFabric create(Context context) {
        this.innerObject = serviceManager.serviceClient().getNetworkFabrics().create(resourceGroupName,
            networkFabricName, this.innerModel(), context);
        return this;
    }
    ...
    public NetworkFabric apply() {
        this.innerObject = serviceManager.serviceClient().getNetworkFabrics().update(resourceGroupName,
            networkFabricName, updateBody, Context.NONE);
        return this;
    }

    public NetworkFabric apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getNetworkFabrics().update(resourceGroupName,
            networkFabricName, updateBody, context);
        return this;
    }
    ...
    public NetworkFabric refresh() {
        this.innerObject = serviceManager.serviceClient().getNetworkFabrics()
            .getByResourceGroupWithResponse(resourceGroupName, networkFabricName, Context.NONE).getValue();
        return this;
    }

    public NetworkFabric refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getNetworkFabrics()
            .getByResourceGroupWithResponse(resourceGroupName, networkFabricName, context).getValue();
        return this;
    }
    ...
    public CommonPostActionResponseForStateUpdate
        ...
        return serviceManager.networkFabrics().updateWorkloadManagementBfdConfiguration(resourceGroupName,
    ...
    public CommonPostActionResponseForStateUpdate
        ...
        return serviceManager.networkFabrics().updateWorkloadManagementBfdConfiguration(resourceGroupName,
            networkFabricName, body, context);
    }

    public CommonPostActionResponseForStateUpdate
        updateInfraManagementBfdConfiguration(UpdateAdministrativeState body) {
        return serviceManager.networkFabrics().updateInfraManagementBfdConfiguration(resourceGroupName,
            networkFabricName, body);
    }
