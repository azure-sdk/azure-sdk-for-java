...
public final class RoutePolicyProperties extends AnnotationResource {
    ...
    private List<RoutePolicyPropertiesStatementsItem> statements;
     ...
     */
    public RoutePolicyProperties withStatements(List<RoutePolicyPropertiesStatementsItem> statements) {
