...
public final class NetworkInterfacesClientImpl implements NetworkInterfacesClient {
    ...
    /**
     * The interface defining all the services for AzureNetworkFabricManagementServiceApiNetworkInterfaces to be used
    ...
    public
        ...
        return this.beginUpdateAdministrativeStateAsync(resourceGroupName, networkDeviceName, networkInterfaceName,
