...
public final class NetworkInterfacesClientImpl implements NetworkInterfacesClient {
    ...
    public interface NetworkInterfacesService {
        ...
        @Post(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers"
                + "/Microsoft.ManagedNetworkFabric/networkDevices/{networkDeviceName}/networkInterfaces"
                + "/{networkInterfaceName}/updateAdminState")
        @ExpectedResponses({202})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Flux<ByteBuffer>>> updateAdminState(
            ...
            @PathParam("networkDeviceName") String networkDeviceName,
            @PathParam("networkInterfaceName") String networkInterfaceName,
            @BodyParam("application/json") UpdateAdminStateProperties body,
            @HeaderParam("Accept") String accept,
            Context context);
    ...
    public SyncPoller<PollResult<NetworkInterfaceInner>, NetworkInterfaceInner> beginCreate(
        String resourceGroupName, String networkDeviceName, String networkInterfaceName, NetworkInterfaceInner body) {
        return beginCreateAsync(resourceGroupName, networkDeviceName, networkInterfaceName, body).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<NetworkInterfaceInner>, NetworkInterfaceInner> beginUpdate(
        String resourceGroupName, String networkDeviceName, String networkInterfaceName, NetworkInterfacePatch body) {
        return beginUpdateAsync(resourceGroupName, networkDeviceName, networkInterfaceName, body).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(
        String resourceGroupName, String networkDeviceName, String networkInterfaceName) {
        return beginDeleteAsync(resourceGroupName, networkDeviceName, networkInterfaceName).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(
        String resourceGroupName, String networkDeviceName, String networkInterfaceName, Context context) {
        return beginDeleteAsync(resourceGroupName, networkDeviceName, networkInterfaceName, context).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<InterfaceStatusInner>, InterfaceStatusInner> beginGetStatus(
        String resourceGroupName, String networkDeviceName, String networkInterfaceName) {
        return beginGetStatusAsync(resourceGroupName, networkDeviceName, networkInterfaceName).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<InterfaceStatusInner>, InterfaceStatusInner> beginGetStatus(
        String resourceGroupName, String networkDeviceName, String networkInterfaceName, Context context) {
        return beginGetStatusAsync(resourceGroupName, networkDeviceName, networkInterfaceName, context).getSyncPoller();
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> updateAdminStateWithResponseAsync(
        ...
        String networkDeviceName,
        String networkInterfaceName,
        UpdateAdminStateProperties body) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    private PollerFlux<PollResult<Void>, Void> beginUpdateAdminStateAsync(
        ...
        UpdateAdminStateProperties body) {
        Mono<Response<Flux<ByteBuffer>>> mono =
            updateAdminStateWithResponseAsync(resourceGroupName, networkDeviceName, networkInterfaceName, body);
        return this
            .client
            .<Void, Void>getLroResult(
                mono, this.client.getHttpPipeline(), Void.class, Void.class, this.client.getContext());
    ...
    public SyncPoller<PollResult<Void>, Void> beginUpdateAdminState(
        ...
        String networkInterfaceName,
        UpdateAdminStateProperties body) {
        return beginUpdateAdminStateAsync(resourceGroupName, networkDeviceName, networkInterfaceName, body)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginUpdateAdminState(
        ...
        UpdateAdminStateProperties body,
        Context context) {
        return beginUpdateAdminStateAsync(resourceGroupName, networkDeviceName, networkInterfaceName, body, context)
            .getSyncPoller();
    }
    ...
    public void updateAdminState(
        ...
        String networkInterfaceName,
        UpdateAdminStateProperties body) {
        updateAdminStateAsync(resourceGroupName, networkDeviceName, networkInterfaceName, body).block();
    }
    ...
    public void updateAdminState(
        ...
        UpdateAdminStateProperties body,
        Context context) {
        updateAdminStateAsync(resourceGroupName, networkDeviceName, networkInterfaceName, body, context).block();
    }
