...
public class Layer3IpPrefixProperties {
    /*
     * IPv4 Address Prefix of CE-PE interconnect links. Default value is 172.31.0.0/31. The values can be specified at
    ...
    /*
     * IPv6 Address Prefix of CE-PE interconnect links. Default value is 3FFE:FFFF:0:CD30::a0/126. The values can be
    ...
    /*
     * Secondary IPv4 Address Prefix of CE-PE interconnect links. Default value is 172.31.0.20/31. The values can be
     * specified at the time of creation or can be updated afterwards. Any update to the values post-provisioning may
     * disrupt traffic. The 1st and 3rd IPs are to be configured on CE1 and CE2 for Option B interfaces. The 2nd and
     * 4th IPs are to be configured on PE1 and PE2 for Option B interfaces.
     */
    ...
    /*
     * Secondary IPv6 Address Prefix of CE-PE interconnect links. Default value is 3FFE:FFFF:0:CD30::a4/126. The values
     ...
     * 172.31.0.0/31. The values can be specified at the time of creation or can be updated afterwards. Any update to
