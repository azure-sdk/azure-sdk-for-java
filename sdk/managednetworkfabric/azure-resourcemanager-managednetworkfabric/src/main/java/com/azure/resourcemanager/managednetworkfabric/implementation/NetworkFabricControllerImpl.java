...
public final class NetworkFabricControllerImpl
    ...
    public NetworkFabricController create() {
        this.innerObject = serviceManager.serviceClient().getNetworkFabricControllers().create(resourceGroupName,
            networkFabricControllerName, this.innerModel(), Context.NONE);
        return this;
    }

    public NetworkFabricController create(Context context) {
        this.innerObject = serviceManager.serviceClient().getNetworkFabricControllers().create(resourceGroupName,
            networkFabricControllerName, this.innerModel(), context);
        return this;
    }
    ...
    public NetworkFabricController apply() {
        this.innerObject = serviceManager.serviceClient().getNetworkFabricControllers().update(resourceGroupName,
            networkFabricControllerName, updateBody, Context.NONE);
        return this;
    }

    public NetworkFabricController apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getNetworkFabricControllers().update(resourceGroupName,
            networkFabricControllerName, updateBody, context);
        return this;
    }
    ...
    public NetworkFabricController refresh() {
        this.innerObject = serviceManager.serviceClient().getNetworkFabricControllers()
            .getByResourceGroupWithResponse(resourceGroupName, networkFabricControllerName, Context.NONE).getValue();
        return this;
    }

    public NetworkFabricController refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getNetworkFabricControllers()
            .getByResourceGroupWithResponse(resourceGroupName, networkFabricControllerName, context).getValue();
        return this;
    }
