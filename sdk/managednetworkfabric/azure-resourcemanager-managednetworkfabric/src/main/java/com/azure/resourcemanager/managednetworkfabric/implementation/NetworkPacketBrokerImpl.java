...
public final class NetworkPacketBrokerImpl
    ...
    public NetworkPacketBroker create() {
        this.innerObject = serviceManager.serviceClient().getNetworkPacketBrokers().create(resourceGroupName,
            networkPacketBrokerName, this.innerModel(), Context.NONE);
        return this;
    }

    public NetworkPacketBroker create(Context context) {
        this.innerObject = serviceManager.serviceClient().getNetworkPacketBrokers().create(resourceGroupName,
            networkPacketBrokerName, this.innerModel(), context);
        return this;
    }
    ...
    public NetworkPacketBroker apply() {
        this.innerObject = serviceManager.serviceClient().getNetworkPacketBrokers().update(resourceGroupName,
            networkPacketBrokerName, updateBody, Context.NONE);
        return this;
    }

    public NetworkPacketBroker apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getNetworkPacketBrokers().update(resourceGroupName,
            networkPacketBrokerName, updateBody, context);
        return this;
    }
    ...
    public NetworkPacketBroker refresh() {
        this.innerObject = serviceManager.serviceClient().getNetworkPacketBrokers()
            .getByResourceGroupWithResponse(resourceGroupName, networkPacketBrokerName, Context.NONE).getValue();
        return this;
    }

    public NetworkPacketBroker refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getNetworkPacketBrokers()
            .getByResourceGroupWithResponse(resourceGroupName, networkPacketBrokerName, context).getValue();
        return this;
    }
