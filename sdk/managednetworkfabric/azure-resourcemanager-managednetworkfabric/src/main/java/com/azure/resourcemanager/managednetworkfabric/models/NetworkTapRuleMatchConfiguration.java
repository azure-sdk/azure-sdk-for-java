...
public final class NetworkTapRuleMatchConfiguration {
     ...
     */
    public NetworkTapRuleMatchConfiguration withMatchConfigurationName(String matchConfigurationName) {
     ...
     * @return the NetworkTapRuleMatchConfiguration object itself.
     */
    public NetworkTapRuleMatchConfiguration withSequenceNumber(Long sequenceNumber) {
     ...
     * @return the NetworkTapRuleMatchConfiguration object itself.
     */
    public NetworkTapRuleMatchConfiguration withMatchConditions(List<NetworkTapRuleMatchCondition> matchConditions) {
     ...
     * @return the NetworkTapRuleMatchConfiguration object itself.
     */
    public NetworkTapRuleMatchConfiguration withActions(List<NetworkTapRuleAction> actions) {
