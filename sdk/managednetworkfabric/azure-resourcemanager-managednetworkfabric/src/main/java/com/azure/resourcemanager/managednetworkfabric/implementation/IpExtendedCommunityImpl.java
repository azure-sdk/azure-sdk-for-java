...
public final class IpExtendedCommunityImpl
    ...
    public IpExtendedCommunity create() {
        this.innerObject = serviceManager.serviceClient().getIpExtendedCommunities().create(resourceGroupName,
            ipExtendedCommunityName, this.innerModel(), Context.NONE);
        return this;
    }

    public IpExtendedCommunity create(Context context) {
        this.innerObject = serviceManager.serviceClient().getIpExtendedCommunities().create(resourceGroupName,
            ipExtendedCommunityName, this.innerModel(), context);
        return this;
    }
    ...
    public IpExtendedCommunity apply() {
        this.innerObject = serviceManager.serviceClient().getIpExtendedCommunities().update(resourceGroupName,
            ipExtendedCommunityName, updateBody, Context.NONE);
        return this;
    }

    public IpExtendedCommunity apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getIpExtendedCommunities().update(resourceGroupName,
            ipExtendedCommunityName, updateBody, context);
        return this;
    }
    ...
    public IpExtendedCommunity refresh() {
        this.innerObject = serviceManager.serviceClient().getIpExtendedCommunities()
            .getByResourceGroupWithResponse(resourceGroupName, ipExtendedCommunityName, Context.NONE).getValue();
        return this;
    }

    public IpExtendedCommunity refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getIpExtendedCommunities()
            .getByResourceGroupWithResponse(resourceGroupName, ipExtendedCommunityName, context).getValue();
        return this;
    }
