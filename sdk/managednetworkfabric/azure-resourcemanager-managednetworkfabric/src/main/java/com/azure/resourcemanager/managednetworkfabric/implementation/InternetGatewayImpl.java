...
public final class InternetGatewayImpl implements InternetGateway, InternetGateway.Definition, InternetGateway.Update {
    ...
    public InternetGateway create() {
        this.innerObject = serviceManager.serviceClient().getInternetGateways().create(resourceGroupName,
            internetGatewayName, this.innerModel(), Context.NONE);
        return this;
    }

    public InternetGateway create(Context context) {
        this.innerObject = serviceManager.serviceClient().getInternetGateways().create(resourceGroupName,
            internetGatewayName, this.innerModel(), context);
        return this;
    }
    ...
    public InternetGateway apply() {
        this.innerObject = serviceManager.serviceClient().getInternetGateways().update(resourceGroupName,
            internetGatewayName, updateBody, Context.NONE);
        return this;
    }

    public InternetGateway apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getInternetGateways().update(resourceGroupName,
            internetGatewayName, updateBody, context);
        return this;
    }
    ...
    public InternetGateway refresh() {
        this.innerObject = serviceManager.serviceClient().getInternetGateways()
            .getByResourceGroupWithResponse(resourceGroupName, internetGatewayName, Context.NONE).getValue();
        return this;
    }

    public InternetGateway refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getInternetGateways()
            .getByResourceGroupWithResponse(resourceGroupName, internetGatewayName, context).getValue();
        return this;
    }
