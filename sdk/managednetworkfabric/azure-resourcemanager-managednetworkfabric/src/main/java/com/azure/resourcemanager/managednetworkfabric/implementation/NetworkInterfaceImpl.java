...
public final class NetworkInterfaceImpl
    ...
    public NetworkInterface create() {
        this.innerObject = serviceManager.serviceClient().getNetworkInterfaces().create(resourceGroupName,
            networkDeviceName, networkInterfaceName, this.innerModel(), Context.NONE);
        return this;
    }

    public NetworkInterface create(Context context) {
        this.innerObject = serviceManager.serviceClient().getNetworkInterfaces().create(resourceGroupName,
            networkDeviceName, networkInterfaceName, this.innerModel(), context);
        return this;
    }
    ...
    public NetworkInterface apply() {
        this.innerObject = serviceManager.serviceClient().getNetworkInterfaces().update(resourceGroupName,
            networkDeviceName, networkInterfaceName, updateBody, Context.NONE);
        return this;
    }

    public NetworkInterface apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getNetworkInterfaces().update(resourceGroupName,
            networkDeviceName, networkInterfaceName, updateBody, context);
        return this;
    }
    ...
    public NetworkInterface refresh() {
        this.innerObject = serviceManager.serviceClient().getNetworkInterfaces()
            .getWithResponse(resourceGroupName, networkDeviceName, networkInterfaceName, Context.NONE).getValue();
        return this;
    }

    public NetworkInterface refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getNetworkInterfaces()
            .getWithResponse(resourceGroupName, networkDeviceName, networkInterfaceName, context).getValue();
        return this;
    }

    public CommonPostActionResponseForStateUpdate updateAdministrativeState(UpdateAdministrativeState body) {
        return serviceManager.networkInterfaces().updateAdministrativeState(resourceGroupName, networkDeviceName,
            networkInterfaceName, body);
    }
