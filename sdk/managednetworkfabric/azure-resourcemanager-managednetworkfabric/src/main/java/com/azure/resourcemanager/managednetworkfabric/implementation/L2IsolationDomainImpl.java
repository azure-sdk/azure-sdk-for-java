...
public final class L2IsolationDomainImpl
    ...
    public L2IsolationDomain create() {
        this.innerObject = serviceManager.serviceClient().getL2IsolationDomains().create(resourceGroupName,
            l2IsolationDomainName, this.innerModel(), Context.NONE);
        return this;
    }

    public L2IsolationDomain create(Context context) {
        this.innerObject = serviceManager.serviceClient().getL2IsolationDomains().create(resourceGroupName,
            l2IsolationDomainName, this.innerModel(), context);
        return this;
    }
    ...
    public L2IsolationDomain apply() {
        this.innerObject = serviceManager.serviceClient().getL2IsolationDomains().update(resourceGroupName,
            l2IsolationDomainName, updateBody, Context.NONE);
        return this;
    }

    public L2IsolationDomain apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getL2IsolationDomains().update(resourceGroupName,
            l2IsolationDomainName, updateBody, context);
        return this;
    }
    ...
    public L2IsolationDomain refresh() {
        this.innerObject = serviceManager.serviceClient().getL2IsolationDomains()
            .getByResourceGroupWithResponse(resourceGroupName, l2IsolationDomainName, Context.NONE).getValue();
        return this;
    }

    public L2IsolationDomain refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getL2IsolationDomains()
            .getByResourceGroupWithResponse(resourceGroupName, l2IsolationDomainName, context).getValue();
        return this;
    }

    public CommonPostActionResponseForDeviceUpdate updateAdministrativeState(UpdateAdministrativeState body) {
        return serviceManager.l2IsolationDomains().updateAdministrativeState(resourceGroupName, l2IsolationDomainName,
            body);
    }
