...
public final class IpPrefixImpl implements IpPrefix, IpPrefix.Definition, IpPrefix.Update {
    ...
    public IpPrefix create() {
        this.innerObject = serviceManager.serviceClient().getIpPrefixes().create(resourceGroupName, ipPrefixName,
    ...
    public IpPrefix apply() {
        this.innerObject = serviceManager.serviceClient().getIpPrefixes().update(resourceGroupName, ipPrefixName,
    ...
    public IpPrefix refresh() {
        this.innerObject = serviceManager.serviceClient().getIpPrefixes()
            .getByResourceGroupWithResponse(resourceGroupName, ipPrefixName, Context.NONE).getValue();
        return this;
    }

    public IpPrefix refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getIpPrefixes()
            .getByResourceGroupWithResponse(resourceGroupName, ipPrefixName, context).getValue();
        return this;
    }
