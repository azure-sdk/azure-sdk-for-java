...
public final class IpCommunityImpl implements IpCommunity, IpCommunity.Definition, IpCommunity.Update {
    ...
    public IpCommunity create() {
        this.innerObject = serviceManager.serviceClient().getIpCommunities().create(resourceGroupName, ipCommunityName,
    ...
    public IpCommunity apply() {
        this.innerObject = serviceManager.serviceClient().getIpCommunities().update(resourceGroupName, ipCommunityName,
    ...
    public IpCommunity refresh() {
        this.innerObject = serviceManager.serviceClient().getIpCommunities()
            .getByResourceGroupWithResponse(resourceGroupName, ipCommunityName, Context.NONE).getValue();
        return this;
    }

    public IpCommunity refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getIpCommunities()
            .getByResourceGroupWithResponse(resourceGroupName, ipCommunityName, context).getValue();
        return this;
    }
