...
public final class NetworkRackImpl implements NetworkRack, NetworkRack.Definition, NetworkRack.Update {
    ...
    public NetworkRack create() {
        this.innerObject = serviceManager.serviceClient().getNetworkRacks().create(resourceGroupName, networkRackName,
    ...
    public NetworkRack apply() {
        this.innerObject = serviceManager.serviceClient().getNetworkRacks().update(resourceGroupName, networkRackName,
    ...
    public NetworkRack refresh() {
        this.innerObject = serviceManager.serviceClient().getNetworkRacks()
            .getByResourceGroupWithResponse(resourceGroupName, networkRackName, Context.NONE).getValue();
        return this;
    }

    public NetworkRack refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getNetworkRacks()
            .getByResourceGroupWithResponse(resourceGroupName, networkRackName, context).getValue();
        return this;
    }
