...
public final class InternetGatewayRuleImpl
    ...
    public InternetGatewayRule create() {
        this.innerObject = serviceManager.serviceClient().getInternetGatewayRules().create(resourceGroupName,
            internetGatewayRuleName, this.innerModel(), Context.NONE);
        return this;
    }

    public InternetGatewayRule create(Context context) {
        this.innerObject = serviceManager.serviceClient().getInternetGatewayRules().create(resourceGroupName,
            internetGatewayRuleName, this.innerModel(), context);
        return this;
    }
    ...
    public InternetGatewayRule apply() {
        this.innerObject = serviceManager.serviceClient().getInternetGatewayRules().update(resourceGroupName,
            internetGatewayRuleName, updateBody, Context.NONE);
        return this;
    }

    public InternetGatewayRule apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getInternetGatewayRules().update(resourceGroupName,
            internetGatewayRuleName, updateBody, context);
        return this;
    }
    ...
    public InternetGatewayRule refresh() {
        this.innerObject = serviceManager.serviceClient().getInternetGatewayRules()
            .getByResourceGroupWithResponse(resourceGroupName, internetGatewayRuleName, Context.NONE).getValue();
        return this;
    }

    public InternetGatewayRule refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getInternetGatewayRules()
            .getByResourceGroupWithResponse(resourceGroupName, internetGatewayRuleName, context).getValue();
        return this;
    }
