...
public final class InternalNetworksImpl implements InternalNetworks {
    ...
    public Response<InternalNetwork> getWithResponse(String resourceGroupName, String l3IsolationDomainName,
        ...
        Response<InternalNetworkInner> inner = this.serviceClient().getWithResponse(resourceGroupName,
            l3IsolationDomainName, internalNetworkName, context);
        if (inner != null) {
    ...
    public CommonPostActionResponseForStateUpdate updateBgpAdministrativeState(String resourceGroupName,
        String l3IsolationDomainName, String internalNetworkName, UpdateAdministrativeState body) {
        CommonPostActionResponseForStateUpdateInner inner = this.serviceClient()
    ...
    public CommonPostActionResponseForStateUpdate updateStaticRouteBfdAdministrativeState(String resourceGroupName,
        ...
        CommonPostActionResponseForStateUpdateInner inner
            = this.serviceClient().updateStaticRouteBfdAdministrativeState(resourceGroupName, l3IsolationDomainName,
