...
public final class InternalNetworksImpl implements InternalNetworks {
    ...
    public void updateAdminState(
        ...
        this.serviceClient().updateAdminState(resourceGroupName, l3IsolationDomainName, internalNetworkName, body);
    }
    ...
    public void updateBgpState(
        ...
        String internalNetworkName,
        UpdateAdministrativeState body) {
        this.serviceClient().updateBgpState(resourceGroupName, l3IsolationDomainName, internalNetworkName, body);
    }
    ...
    public void updateBfdForBgpState(
        ...
        String internalNetworkName,
        UpdateAdministrativeState body) {
        this.serviceClient().updateBfdForBgpState(resourceGroupName, l3IsolationDomainName, internalNetworkName, body);
    }
