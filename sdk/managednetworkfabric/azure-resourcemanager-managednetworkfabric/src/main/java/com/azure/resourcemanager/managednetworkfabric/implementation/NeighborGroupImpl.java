...
public final class NeighborGroupImpl implements NeighborGroup, NeighborGroup.Definition, NeighborGroup.Update {
    ...
    public NeighborGroup create() {
        this.innerObject = serviceManager.serviceClient().getNeighborGroups().create(resourceGroupName,
            neighborGroupName, this.innerModel(), Context.NONE);
        return this;
    }

    public NeighborGroup create(Context context) {
        this.innerObject = serviceManager.serviceClient().getNeighborGroups().create(resourceGroupName,
            neighborGroupName, this.innerModel(), context);
        return this;
    }
    ...
    public NeighborGroup apply() {
        this.innerObject = serviceManager.serviceClient().getNeighborGroups().update(resourceGroupName,
            neighborGroupName, updateBody, Context.NONE);
        return this;
    }

    public NeighborGroup apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getNeighborGroups().update(resourceGroupName,
            neighborGroupName, updateBody, context);
        return this;
    }
    ...
    public NeighborGroup refresh() {
        this.innerObject = serviceManager.serviceClient().getNeighborGroups()
            .getByResourceGroupWithResponse(resourceGroupName, neighborGroupName, Context.NONE).getValue();
        return this;
    }

    public NeighborGroup refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getNeighborGroups()
            .getByResourceGroupWithResponse(resourceGroupName, neighborGroupName, context).getValue();
        return this;
    }
