...
public final class NetworkDevicePatchParametersProperties extends AnnotationResource {
     ...
     */
    public NetworkDevicePatchParametersProperties withNetworkDeviceSku(String networkDeviceSku) {
     ...
     * @return the NetworkDevicePatchParametersProperties object itself.
     */
    public NetworkDevicePatchParametersProperties withNetworkDeviceRole(String networkDeviceRole) {
     ...
     * @return the NetworkDevicePatchParametersProperties object itself.
     */
    public NetworkDevicePatchParametersProperties withDeviceName(String deviceName) {
