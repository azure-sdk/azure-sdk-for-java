        ...
        InternetGatewayRule resource =
            manager
                ...
                .getByResourceGroupWithResponse(
                    "example-rg", "example-internetGatewayRule", com.azure.core.util.Context.NONE)
                .getValue();
        resource.update().withTags(mapOf("key3311", "1234")).apply();
    }
    ...
    public static void l2IsolationDomainsUpdateMaximumSetGen(
        ...
        L2IsolationDomain resource =
            manager
                ...
                .getByResourceGroupWithResponse("example-rg", "example-l2Domain", com.azure.core.util.Context.NONE)
                .getValue();
        resource.update().withTags(mapOf("keyID", "keyValue")).withMtu(6000).withAnnotation("annotation1").apply();
    }
        ...
        NetworkPacketBroker resource =
            manager
                ...
                .getByResourceGroupWithResponse(
                    "example-rg", "example-networkPacketBroker", com.azure.core.util.Context.NONE)
                .getValue();
        resource.update().withTags(mapOf("key8772", "1234")).apply();
    }
    ...
    public static void networkRacksUpdateMaximumSetGen(
        ...
        NetworkRack resource =
            manager
                ...
                .getByResourceGroupWithResponse("example-rg", "example-rack", com.azure.core.util.Context.NONE)
                .getValue();
        resource.update().withTags(mapOf("keyID", "keyValue")).apply();
    }
