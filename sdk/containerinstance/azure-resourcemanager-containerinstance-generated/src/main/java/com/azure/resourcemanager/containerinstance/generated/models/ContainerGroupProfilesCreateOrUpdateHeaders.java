...
/**
 * The ContainerGroupProfilesCreateOrUpdateHeaders model.
 */
@Fluent
public final class ContainerGroupProfilesCreateOrUpdateHeaders {
    /*
    ...
    /**
     * Creates an instance of ContainerGroupProfilesCreateOrUpdateHeaders class.
     * 
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public ContainerGroupProfilesCreateOrUpdateHeaders(HttpHeaders rawHeaders) {
     ...
     * @return the ContainerGroupProfilesCreateOrUpdateHeaders object itself.
     */
    public ContainerGroupProfilesCreateOrUpdateHeaders withXMsCorrelationRequestId(String xMsCorrelationRequestId) {
