...
public final class ContainerGroupsClientImpl implements ContainerGroupsClient {
    ...
    private PagedFlux<ListResultContainerGroupInner> listAsync() {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ContainerGroupInner> updateAsync(String resourceGroupName, String containerGroupName,
        Resource resource) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<List<String>>>
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<List<String>> getOutboundNetworkDependenciesEndpointsAsync(String resourceGroupName,
        String containerGroupName) {
