...
public final class Volume implements JsonSerializable<Volume> {
     ...
     */
    private Map<String, String> secretReference;
    ...
    /**
     * Get the secretReference property: The secret reference volume.
     * 
     * @return the secretReference value.
     */
    public Map<String, String> secretReference() {
        return this.secretReference;
    }

    /**
     * Set the secretReference property: The secret reference volume.
     * 
     * @param secretReference the secretReference value to set.
     * @return the Volume object itself.
     */
    public Volume withSecretReference(Map<String, String> secretReference) {
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeMapField("secretReference", this.secretReference,
    ...
    public static Volume fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                } else if ("secretReference".equals(fieldName)) {
                    Map<String, String> secretReference = reader.readMap(reader1 -> reader1.getString());
                    deserializedVolume.secretReference = secretReference;
