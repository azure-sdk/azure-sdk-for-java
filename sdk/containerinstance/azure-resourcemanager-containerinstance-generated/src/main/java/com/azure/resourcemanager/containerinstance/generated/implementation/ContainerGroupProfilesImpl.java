...
public final class ContainerGroupProfilesImpl implements ContainerGroupProfiles {
    ...
    public Response<ContainerGroupProfile> updateWithResponse(String resourceGroupName,
        String containerGroupProfileName, Resource containerGroupProfile, Context context) {
        ContainerGroupProfilesUpdateResponse inner = this.serviceClient()
            .updateWithResponse(resourceGroupName, containerGroupProfileName, containerGroupProfile, context);
        if (inner != null) {
    ...
    public ContainerGroupProfile update(String resourceGroupName, String containerGroupProfileName) {
        ContainerGroupProfileInner inner = this.serviceClient().update(resourceGroupName, containerGroupProfileName);
        if (inner != null) {
