...
public final class ContainersImpl implements Containers {
    ...
    public Response<Logs> listLogsWithResponse(String resourceGroupName, String containerGroupName,
        String containerName, Integer tail, Boolean timestamps, Context context) {
        Response<LogsInner> inner = this.serviceClient().listLogsWithResponse(resourceGroupName, containerGroupName,
            containerName, tail, timestamps, context);
        if (inner != null) {
    ...
    public Response<ContainerExecResponse> executeCommandWithResponse(String resourceGroupName,
        String containerGroupName, String containerName, ContainerExecRequest containerExecRequest, Context context) {
        Response<ContainerExecResponseInner> inner = this.serviceClient().executeCommandWithResponse(resourceGroupName,
            containerGroupName, containerName, containerExecRequest, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
    ...
    public ContainerExecResponse executeCommand(String resourceGroupName, String containerGroupName,
        String containerName, ContainerExecRequest containerExecRequest) {
        ContainerExecResponseInner inner = this.serviceClient().executeCommand(resourceGroupName, containerGroupName,
            containerName, containerExecRequest);
        if (inner != null) {
    ...
    public Response<ContainerAttachResponse> attachWithResponse(String resourceGroupName, String containerGroupName,
