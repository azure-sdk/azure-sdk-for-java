...
public final class ContainersImpl implements Containers {
    ...
    public Response<Logs> listLogsWithResponse(String resourceGroupName, String containerGroupName,
        ...
        Response<LogsInner> inner = this.serviceClient()
    ...
    public Response<ContainerExecResponse> executeCommandWithResponse(String resourceGroupName,
        ...
        Response<ContainerExecResponseInner> inner = this.serviceClient()
            .executeCommandWithResponse(resourceGroupName, containerGroupName, containerName, containerExecRequest,
                context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
    ...
    public ContainerExecResponse executeCommand(String resourceGroupName, String containerGroupName,
        ...
        ContainerExecResponseInner inner = this.serviceClient()
