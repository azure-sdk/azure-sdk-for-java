...
public final class AzureFileVolume implements JsonSerializable<AzureFileVolume> {
    ...
    /**
     * Get the storageAccountKeyReference property: The reference to the storage account access key used to access the
     * Azure File share.
     * 
     * @return the storageAccountKeyReference value.
     */
    public String storageAccountKeyReference() {
        return this.storageAccountKeyReference;
    }

    /**
     * Set the storageAccountKeyReference property: The reference to the storage account access key used to access the
     * Azure File share.
     * 
     * @param storageAccountKeyReference the storageAccountKeyReference value to set.
     * @return the AzureFileVolume object itself.
     */
    public AzureFileVolume withStorageAccountKeyReference(String storageAccountKeyReference) {
        this.storageAccountKeyReference = storageAccountKeyReference;
        return this;
    }
