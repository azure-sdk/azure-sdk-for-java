...
public final class EnvironmentVariable implements JsonSerializable<EnvironmentVariable> {
     ...
     */
    private String secureValueReference;
    ...
    /**
     * Get the secureValueReference property: The reference of the secure environment variable.
     * 
     * @return the secureValueReference value.
     */
    public String secureValueReference() {
        return this.secureValueReference;
    }

    /**
     * Set the secureValueReference property: The reference of the secure environment variable.
     * 
     * @param secureValueReference the secureValueReference value to set.
     * @return the EnvironmentVariable object itself.
     */
    public EnvironmentVariable withSecureValueReference(String secureValueReference) {
        this.secureValueReference = secureValueReference;
        return this;
    }
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeStringField("secureValueReference", this.secureValueReference);
    ...
    public static EnvironmentVariable fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                } else if ("secureValueReference".equals(fieldName)) {
                    deserializedEnvironmentVariable.secureValueReference = reader.getString();
                } else {
                    reader.skipChildren();
                }
            }
