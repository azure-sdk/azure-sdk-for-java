...
public final class ContainerGroupInner extends Resource {
    ...
    public Integer provisioningTimeoutInSeconds() {
        return this.innerProperties() == null ? null : this.innerProperties().provisioningTimeoutInSeconds();
    }
     ...
     * @return the ContainerGroupInner object itself.
     */
    public ContainerGroupInner withProvisioningTimeoutInSeconds(Integer provisioningTimeoutInSeconds) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ContainerGroupPropertiesProperties();
        }
        this.innerProperties().withProvisioningTimeoutInSeconds(provisioningTimeoutInSeconds);
        return this;
    }
    ...
    public IsCustomProvisioningTimeout isCustomProvisioningTimeout() {
        return this.innerProperties() == null ? null : this.innerProperties().isCustomProvisioningTimeout();
    }
