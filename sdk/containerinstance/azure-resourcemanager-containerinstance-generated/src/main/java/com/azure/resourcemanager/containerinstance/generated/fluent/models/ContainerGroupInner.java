...
public final class ContainerGroupInner extends Resource {
     ...
     * @return the ContainerGroupInner object itself.
     */
    public ContainerGroupInner withSecrets(List<SecretReference> secrets) {
    ...
    public void validate() {
        ...
        if (location() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Missing required property location in model ContainerGroupInner"));
        }
    }
