...
public final class ContainerGroupsImpl implements ContainerGroups {
    ...
    public PagedIterable<ListResultContainerGroup> list() {
        PagedIterable<ListResultContainerGroupInner> inner = this.serviceClient().list();
        return ResourceManagerUtils.mapPage(inner, inner1 -> new ListResultContainerGroupImpl(inner1, this.manager()));
    }

    public PagedIterable<ListResultContainerGroup> list(Context context) {
        PagedIterable<ListResultContainerGroupInner> inner = this.serviceClient().list(context);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new ListResultContainerGroupImpl(inner1, this.manager()));
    }

    public PagedIterable<ListResultContainerGroup> listByResourceGroup(String resourceGroupName) {
        PagedIterable<ListResultContainerGroupInner> inner
            = this.serviceClient().listByResourceGroup(resourceGroupName);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new ListResultContainerGroupImpl(inner1, this.manager()));
    }

    public PagedIterable<ListResultContainerGroup> listByResourceGroup(String resourceGroupName, Context context) {
        PagedIterable<ListResultContainerGroupInner> inner
            = this.serviceClient().listByResourceGroup(resourceGroupName, context);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new ListResultContainerGroupImpl(inner1, this.manager()));
    }

    public Response<ContainerGroup> getByResourceGroupWithResponse(String resourceGroupName, String containerGroupName,
        Context context) {
    ...
    public Response<ContainerGroup> updateWithResponse(String resourceGroupName, String containerGroupName,
    ...
    public ContainerGroup getById(String id) {
        ...
        String containerGroupName = ResourceManagerUtils.getValueFromIdByName(id, "containerGroups");
        if (containerGroupName == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
                String.format("The resource ID '%s' is not valid. Missing path segment 'containerGroups'.", id)));
        }
