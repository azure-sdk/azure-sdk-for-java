...
/**
 * The ContainerGroupProfilesUpdateHeaders model.
 */
@Fluent
public final class ContainerGroupProfilesUpdateHeaders {
    /*
    ...
    /**
     * Creates an instance of ContainerGroupProfilesUpdateHeaders class.
     * 
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public ContainerGroupProfilesUpdateHeaders(HttpHeaders rawHeaders) {
     ...
     * @return the ContainerGroupProfilesUpdateHeaders object itself.
     */
    public ContainerGroupProfilesUpdateHeaders withXMsCorrelationRequestId(String xMsCorrelationRequestId) {
