...
public class ContainerGroupProperties {
    ...
    public Integer retryTimeoutMinutes() {
        return this.innerProperties() == null ? null : this.innerProperties().retryTimeoutMinutes();
    }
     ...
     * @return the ContainerGroupProperties object itself.
     */
    public ContainerGroupProperties withRetryTimeoutMinutes(Integer retryTimeoutMinutes) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ContainerGroupPropertiesProperties();
        }
        this.innerProperties().withRetryTimeoutMinutes(retryTimeoutMinutes);
        return this;
    }
