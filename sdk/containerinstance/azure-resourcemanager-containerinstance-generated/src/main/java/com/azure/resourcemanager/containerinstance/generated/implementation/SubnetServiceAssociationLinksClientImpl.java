...
public final class SubnetServiceAssociationLinksClientImpl implements SubnetServiceAssociationLinksClient {
    ...
    private interface SubnetServiceAssociationLinksService {
        @Headers({"Content-Type: application/json"})
        @Delete(
            "/subscriptions/{subscriptionId}/resourcegroups/{resourceGroup}/providers/Microsoft.Network/virtualNetworks"
                + "/{virtualNetworkName}/subnets/{subnetName}/providers/Microsoft.ContainerInstance"
    ...
    private Mono<Response<Flux<ByteBuffer>>> deleteWithResponseAsync(
        String resourceGroup, String virtualNetworkName, String subnetName) {
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> deleteWithResponseAsync(
        String resourceGroup, String virtualNetworkName, String subnetName, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    private PollerFlux<PollResult<Void>, Void> beginDeleteAsync(
        String resourceGroup, String virtualNetworkName, String subnetName) {
        Mono<Response<Flux<ByteBuffer>>> mono = deleteWithResponseAsync(resourceGroup, virtualNetworkName, subnetName);
        return this
            .client
    ...
    private PollerFlux<PollResult<Void>, Void> beginDeleteAsync(
        ...
        Mono<Response<Flux<ByteBuffer>>> mono =
            deleteWithResponseAsync(resourceGroup, virtualNetworkName, subnetName, context);
        return this
            .client
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(
        String resourceGroup, String virtualNetworkName, String subnetName) {
        return beginDeleteAsync(resourceGroup, virtualNetworkName, subnetName).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(
        String resourceGroup, String virtualNetworkName, String subnetName, Context context) {
        return beginDeleteAsync(resourceGroup, virtualNetworkName, subnetName, context).getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> deleteAsync(String resourceGroup, String virtualNetworkName, String subnetName) {
        return beginDeleteAsync(resourceGroup, virtualNetworkName, subnetName)
            .last()
    ...
    private Mono<Void> deleteAsync(
        String resourceGroup, String virtualNetworkName, String subnetName, Context context) {
        return beginDeleteAsync(resourceGroup, virtualNetworkName, subnetName, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public void delete(String resourceGroup, String virtualNetworkName, String subnetName) {
        deleteAsync(resourceGroup, virtualNetworkName, subnetName).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public void delete(String resourceGroup, String virtualNetworkName, String subnetName, Context context) {
        deleteAsync(resourceGroup, virtualNetworkName, subnetName, context).block();
    }
}
