...
public final class ContainerGroupProfilePropertiesProperties
     ...
     */
    private List<Long> registeredRevisions;
     ...
     * @return the ContainerGroupProfilePropertiesProperties object itself.
     */
    public ContainerGroupProfilePropertiesProperties withShutdownGracePeriod(OffsetDateTime shutdownGracePeriod) {
     ...
     * @return the ContainerGroupProfilePropertiesProperties object itself.
     */
    public ContainerGroupProfilePropertiesProperties withTimeToLive(OffsetDateTime timeToLive) {
     ...
     * @return the ContainerGroupProfilePropertiesProperties object itself.
     */
    public ContainerGroupProfilePropertiesProperties withSecurityContext(SecurityContextDefinition securityContext) {
     ...
     * @return the ContainerGroupProfilePropertiesProperties object itself.
     */
    public ContainerGroupProfilePropertiesProperties withRevision(Long revision) {
     ...
     * @return the ContainerGroupProfilePropertiesProperties object itself.
     */
    public ContainerGroupProfilePropertiesProperties withRegisteredRevisions(List<Long> registeredRevisions) {
     ...
     * @return the ContainerGroupProfilePropertiesProperties object itself.
     */
    public ContainerGroupProfilePropertiesProperties withUseKrypton(Boolean useKrypton) {
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("sku".equals(fieldName)) {
                    ...
                    deserializedContainerGroupProfilePropertiesProperties.shutdownGracePeriod = reader
                    ...
                    deserializedContainerGroupProfilePropertiesProperties.timeToLive = reader
                        .getNullable(nonNullReader -> CoreUtils.parseBestOffsetDateTime(nonNullReader.getString()));
                    ...
                    deserializedContainerGroupProfilePropertiesProperties.securityContext
                    ...
                    List<Long> registeredRevisions = reader.readArray(reader1 -> reader1.getLong());
                    deserializedContainerGroupProfilePropertiesProperties.registeredRevisions = registeredRevisions;
                } else if ("useKrypton".equals(fieldName)) {
                    deserializedContainerGroupProfilePropertiesProperties.useKrypton
