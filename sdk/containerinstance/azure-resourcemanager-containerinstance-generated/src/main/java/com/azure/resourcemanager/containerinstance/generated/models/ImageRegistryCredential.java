...
public final class ImageRegistryCredential implements JsonSerializable<ImageRegistryCredential> {
    ...
    /**
     * Get the passwordReference property: The reference for the private registry password.
     * 
    ...
    /**
     * Set the passwordReference property: The reference for the private registry password.
     * 
     * @param passwordReference the passwordReference value to set.
     * @return the ImageRegistryCredential object itself.
     */
    public ImageRegistryCredential withPasswordReference(String passwordReference) {
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("server".equals(fieldName)) {
                    ...
                    deserializedImageRegistryCredential.passwordReference = reader.getString();
