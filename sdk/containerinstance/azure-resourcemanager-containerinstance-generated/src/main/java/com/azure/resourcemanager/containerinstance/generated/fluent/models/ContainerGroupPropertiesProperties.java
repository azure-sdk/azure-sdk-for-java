...
import com.azure.resourcemanager.containerinstance.generated.models.IsCustomProvisioningTimeout;
...
public final class ContainerGroupPropertiesProperties {
    ...
    /*
     * Time in seconds in which a container group deployment would timeout and fail. The allowed maximum value is 1800
     * seconds. If value is not provided, property is given maximum value by default.
     */
    @JsonProperty(value = "provisioningTimeoutInSeconds")
    private Integer provisioningTimeoutInSeconds;

    /*
     * Flag indicating whether a custom value was provided for the provisioningTimeoutInSeconds property
     */
    @JsonProperty(value = "isCustomProvisioningTimeout", access = JsonProperty.Access.WRITE_ONLY)
    private IsCustomProvisioningTimeout isCustomProvisioningTimeout;
     ...
     */
    public ContainerGroupPropertiesProperties withContainers(List<Container> containers) {
    ...
    /**
     * Get the provisioningTimeoutInSeconds property: Time in seconds in which a container group deployment would
     ...
     */
    public Integer provisioningTimeoutInSeconds() {
        return this.provisioningTimeoutInSeconds;
    }

    /**
     * Set the provisioningTimeoutInSeconds property: Time in seconds in which a container group deployment would
     * timeout and fail. The allowed maximum value is 1800 seconds. If value is not provided, property is given maximum
     * value by default.
     *
     * @param provisioningTimeoutInSeconds the provisioningTimeoutInSeconds value to set.
     * @return the ContainerGroupPropertiesProperties object itself.
     */
    public ContainerGroupPropertiesProperties withProvisioningTimeoutInSeconds(Integer provisioningTimeoutInSeconds) {
        this.provisioningTimeoutInSeconds = provisioningTimeoutInSeconds;
        return this;
    }

    /**
     * Get the isCustomProvisioningTimeout property: Flag indicating whether a custom value was provided for the
     * provisioningTimeoutInSeconds property.
     *
     * @return the isCustomProvisioningTimeout value.
     */
    public IsCustomProvisioningTimeout isCustomProvisioningTimeout() {
        return this.isCustomProvisioningTimeout;
    }
     ...
     * @return the ContainerGroupPropertiesProperties object itself.
     */
    public ContainerGroupPropertiesProperties withVolumes(List<Volume> volumes) {
     ...
     * @return the ContainerGroupPropertiesProperties object itself.
     */
    public ContainerGroupPropertiesProperties withSubnetIds(List<ContainerGroupSubnetId> subnetIds) {
     ...
     * @return the ContainerGroupPropertiesProperties object itself.
     */
    public ContainerGroupPropertiesProperties withInitContainers(List<InitContainerDefinition> initContainers) {
     ...
     * @return the ContainerGroupPropertiesProperties object itself.
     */
    public ContainerGroupPropertiesProperties withExtensions(List<DeploymentExtensionSpec> extensions) {
