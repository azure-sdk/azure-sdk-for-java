...
public final class ContainerGroupPropertiesProperties {
    ...
    /*
     * The retry timeout from 1 to 30 minutes for container group
     */
    @JsonProperty(value = "retryTimeoutMinutes")
    private Integer retryTimeoutMinutes;
    ...
    /**
     * Get the retryTimeoutMinutes property: The retry timeout from 1 to 30 minutes for container group.
     *
     * @return the retryTimeoutMinutes value.
     */
    public Integer retryTimeoutMinutes() {
        return this.retryTimeoutMinutes;
    }

    /**
     * Set the retryTimeoutMinutes property: The retry timeout from 1 to 30 minutes for container group.
     *
     * @param retryTimeoutMinutes the retryTimeoutMinutes value to set.
     * @return the ContainerGroupPropertiesProperties object itself.
     */
    public ContainerGroupPropertiesProperties withRetryTimeoutMinutes(Integer retryTimeoutMinutes) {
