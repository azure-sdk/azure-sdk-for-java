 ...
 */
@Fluent
public final class ContainerGroupPropertiesProperties implements JsonSerializable<ContainerGroupPropertiesProperties> {
    /*
    ...
    /**
     * Get the secrets property: The secret references that will be referenced within the container group.
     * 
    ...
    /**
     * Set the secrets property: The secret references that will be referenced within the container group.
     * 
     * @param secrets the secrets value to set.
     * @return the ContainerGroupPropertiesProperties object itself.
     */
    public ContainerGroupPropertiesProperties withSecrets(List<SecretReference> secrets) {
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("containers".equals(fieldName)) {
                    ...
                    deserializedContainerGroupPropertiesProperties.secrets = secrets;
