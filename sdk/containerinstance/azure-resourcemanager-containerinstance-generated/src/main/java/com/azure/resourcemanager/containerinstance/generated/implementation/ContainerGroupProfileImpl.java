...
public final class ContainerGroupProfileImpl
    ...
    public OffsetDateTime shutdownGracePeriod() {
        return this.innerModel().shutdownGracePeriod();
    }
    ...
    public OffsetDateTime timeToLive() {
        return this.innerModel().timeToLive();
    }
    ...
    public SecurityContextDefinition securityContext() {
        return this.innerModel().securityContext();
    }
    ...
    public List<Long> registeredRevisions() {
        List<Long> inner = this.innerModel().registeredRevisions();
        if (inner != null) {
            return Collections.unmodifiableList(inner);
        } else {
            return Collections.emptyList();
    ...
    public Boolean useKrypton() {
        return this.innerModel().useKrypton();
    }
    ...
    public ContainerGroupProfile apply() {
        this.innerObject = serviceManager.serviceClient()
            .getCGProfileOperations()
            .updateWithResponse(resourceGroupName, containerGroupProfileName, updateProperties, Context.NONE)
            .getValue();
        return this;
    }
    ...
    public ContainerGroupProfile apply(Context context) {
        this.innerObject = serviceManager.serviceClient()
            .getCGProfileOperations()
            .updateWithResponse(resourceGroupName, containerGroupProfileName, updateProperties, context)
            .getValue();
        return this;
    }
    ...
    public ContainerGroupProfileImpl withShutdownGracePeriod(OffsetDateTime shutdownGracePeriod) {
        this.innerModel().withShutdownGracePeriod(shutdownGracePeriod);
        return this;
    }
    ...
    public ContainerGroupProfileImpl withTimeToLive(OffsetDateTime timeToLive) {
        this.innerModel().withTimeToLive(timeToLive);
        return this;
    }
    ...
    public ContainerGroupProfileImpl withSecurityContext(SecurityContextDefinition securityContext) {
        this.innerModel().withSecurityContext(securityContext);
        return this;
    }

    public ContainerGroupProfileImpl withRevision(Long revision) {
        this.innerModel().withRevision(revision);
        return this;
    }

    public ContainerGroupProfileImpl withRegisteredRevisions(List<Long> registeredRevisions) {
        this.innerModel().withRegisteredRevisions(registeredRevisions);
        return this;
    }

    public ContainerGroupProfileImpl withUseKrypton(Boolean useKrypton) {
        this.innerModel().withUseKrypton(useKrypton);
        return this;
    }
