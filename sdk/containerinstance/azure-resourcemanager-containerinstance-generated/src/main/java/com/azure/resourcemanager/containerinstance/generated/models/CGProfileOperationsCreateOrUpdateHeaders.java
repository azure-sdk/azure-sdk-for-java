...
/**
 * The CGProfileOperationsCreateOrUpdateHeaders model.
 */
@Fluent
public final class CGProfileOperationsCreateOrUpdateHeaders {
    ...
    /**
     * Creates an instance of CGProfileOperationsCreateOrUpdateHeaders class.
     * 
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public CGProfileOperationsCreateOrUpdateHeaders(HttpHeaders rawHeaders) {
     ...
     * @return the CGProfileOperationsCreateOrUpdateHeaders object itself.
     */
    public CGProfileOperationsCreateOrUpdateHeaders withXMsCorrelationRequestId(String xMsCorrelationRequestId) {
