...
import com.azure.resourcemanager.containerinstance.generated.fluent.models.ListResultContainerGroupPropertiesProperties;
 ...
 */
@Fluent
public class ListResultContainerGroupProperties implements JsonSerializable<ListResultContainerGroupProperties> {
    /*
    ...
    /**
     * Creates an instance of ListResultContainerGroupProperties class.
     */
    public ListResultContainerGroupProperties() {
    }
     ...
     * @return the ListResultContainerGroupProperties object itself.
     */
    public ListResultContainerGroupProperties withIdentity(ContainerGroupIdentity identity) {
    ...
    ListResultContainerGroupProperties
        withInnerProperties(ListResultContainerGroupPropertiesProperties innerProperties) {
     ...
     * @return the ListResultContainerGroupProperties object itself.
     */
    public ListResultContainerGroupProperties withSecretReferences(List<SecretReference> secretReferences) {
     ...
     * @return the ListResultContainerGroupProperties object itself.
     */
    public ListResultContainerGroupProperties withContainers(List<Container> containers) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ListResultContainerGroupPropertiesProperties();
        }
     ...
     * @return the ListResultContainerGroupProperties object itself.
     */
    public ListResultContainerGroupProperties withRestartPolicy(ContainerGroupRestartPolicy restartPolicy) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ListResultContainerGroupPropertiesProperties();
        }
     ...
     * @return the ListResultContainerGroupProperties object itself.
     */
    public ListResultContainerGroupProperties withIpAddress(IpAddress ipAddress) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ListResultContainerGroupPropertiesProperties();
        }
     ...
     * @return the ListResultContainerGroupProperties object itself.
     */
    public ListResultContainerGroupProperties withOsType(OperatingSystemTypes osType) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ListResultContainerGroupPropertiesProperties();
        }
     ...
     * @return the ListResultContainerGroupProperties object itself.
     */
    public ListResultContainerGroupProperties withVolumes(List<Volume> volumes) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ListResultContainerGroupPropertiesProperties();
        }
     ...
     * @return the ListResultContainerGroupProperties object itself.
     */
    public ListResultContainerGroupProperties withDiagnostics(ContainerGroupDiagnostics diagnostics) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ListResultContainerGroupPropertiesProperties();
        }
     ...
     * @return the ListResultContainerGroupProperties object itself.
     */
    public ListResultContainerGroupProperties withSubnetIds(List<ContainerGroupSubnetId> subnetIds) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ListResultContainerGroupPropertiesProperties();
        }
     ...
     * @return the ListResultContainerGroupProperties object itself.
     */
    public ListResultContainerGroupProperties withDnsConfig(DnsConfiguration dnsConfig) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ListResultContainerGroupPropertiesProperties();
        }
     ...
     * @return the ListResultContainerGroupProperties object itself.
     */
    public ListResultContainerGroupProperties withSku(ContainerGroupSku sku) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ListResultContainerGroupPropertiesProperties();
        }
     ...
     * @return the ListResultContainerGroupProperties object itself.
     */
    public ListResultContainerGroupProperties withEncryptionProperties(EncryptionProperties encryptionProperties) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ListResultContainerGroupPropertiesProperties();
        }
     ...
     * @return the ListResultContainerGroupProperties object itself.
     */
    public ListResultContainerGroupProperties withInitContainers(List<InitContainerDefinition> initContainers) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ListResultContainerGroupPropertiesProperties();
        }
     ...
     * @return the ListResultContainerGroupProperties object itself.
     */
    public ListResultContainerGroupProperties withExtensions(List<DeploymentExtensionSpec> extensions) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ListResultContainerGroupPropertiesProperties();
        }
     ...
     * @return the ListResultContainerGroupProperties object itself.
     */
    public ListResultContainerGroupProperties withPriority(ContainerGroupPriority priority) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ListResultContainerGroupPropertiesProperties();
        }
     ...
     * @return the ListResultContainerGroupProperties object itself.
     */
    public ListResultContainerGroupProperties withIdentityAcls(IdentityAcls identityAcls) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ListResultContainerGroupPropertiesProperties();
        }
        ...
        if (innerProperties() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property innerProperties in model ListResultContainerGroupProperties"));
        } else {
            innerProperties().validate();
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(ListResultContainerGroupProperties.class);
    ...
    /**
     * Reads an instance of ListResultContainerGroupProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of ListResultContainerGroupProperties if the JsonReader was pointing to an instance of it, or
     * null if it was pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the ListResultContainerGroupProperties.
     */
    public static ListResultContainerGroupProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ListResultContainerGroupProperties deserializedListResultContainerGroupProperties
                = new ListResultContainerGroupProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("properties".equals(fieldName)) {
                    deserializedListResultContainerGroupProperties.innerProperties
                        = ListResultContainerGroupPropertiesProperties.fromJson(reader);
                } else if ("identity".equals(fieldName)) {
                    deserializedListResultContainerGroupProperties.identity = ContainerGroupIdentity.fromJson(reader);
                } else {
                    reader.skipChildren();
                }
            }

            return deserializedListResultContainerGroupProperties;
        });
    }
}
