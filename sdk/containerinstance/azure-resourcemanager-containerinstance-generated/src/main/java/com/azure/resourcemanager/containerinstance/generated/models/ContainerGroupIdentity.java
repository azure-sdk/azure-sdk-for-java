...
public final class ContainerGroupIdentity {
    ...
    /**
     * Get the tenantId property: The tenant id associated with the container group. This property will only be
     * provided for a system assigned identity.
     * 
    ...
    /**
     * Get the type property: The type of identity used for the container group. The type 'SystemAssigned,
    ...
    /**
     * Set the type property: The type of identity used for the container group. The type 'SystemAssigned,
     * UserAssigned' includes both an implicitly created identity and a set of user assigned identities. The type
     * 'None' will remove any identities from the container group.
     * 
