...
public interface SubnetServiceAssociationLinksClient {
    ...
    SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroup, String virtualNetworkName, String subnetName);
    ...
    void delete(String resourceGroup, String virtualNetworkName, String subnetName);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    void delete(String resourceGroup, String virtualNetworkName, String subnetName, Context context);
}
