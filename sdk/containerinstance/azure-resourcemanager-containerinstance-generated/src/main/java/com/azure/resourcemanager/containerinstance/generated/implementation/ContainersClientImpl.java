...
public final class ContainersClientImpl implements ContainersClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ContainerExecResponseInner> executeCommandAsync(String resourceGroupName, String containerGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ContainerAttachResponseInner> attachAsync(String resourceGroupName, String containerGroupName,
