...
public interface ContainerGroup {
    ...
    /**
     * Gets the secrets property: The secret references that will be referenced within the container group.
     * 
    ...
    /**
     * Gets the containerGroupProfile property: The reference container group profile properties.
     * 
     * @return the containerGroupProfile value.
     */
    ContainerGroupProfileReferenceDefinition containerGroupProfile();

    /**
     * Gets the standbyPoolProfile property: The reference standby pool profile properties.
     * 
     * @return the standbyPoolProfile value.
     */
    StandbyPoolProfileDefinition standbyPoolProfile();

    /**
     * Gets the isCreatedFromStandbyPool property: The flag indicating whether the container group is created by standby
     * pool.
     * 
     * @return the isCreatedFromStandbyPool value.
     */
    Boolean isCreatedFromStandbyPool();
    ...
    interface DefinitionStages {
        ...
        interface WithCreate extends DefinitionStages.WithTags, DefinitionStages.WithZones,
            DefinitionStages.WithIdentity, DefinitionStages.WithSecrets, DefinitionStages.WithImageRegistryCredentials,
            DefinitionStages.WithRestartPolicy, DefinitionStages.WithIpAddress, DefinitionStages.WithVolumes,
            DefinitionStages.WithDiagnostics, DefinitionStages.WithSubnetIds, DefinitionStages.WithDnsConfig,
            ...
            DefinitionStages.WithPriority, DefinitionStages.WithContainerGroupProfile,
            DefinitionStages.WithStandbyPoolProfile {
            /**
        ...
        /**
         * The stage of the ContainerGroup definition allowing to specify secrets.
         */
        interface WithSecrets {
            /**
             * Specifies the secrets property: The secret references that will be referenced within the container
             * group..
             * 
             * @param secrets The secret references that will be referenced within the container group.
             * @return the next definition stage.
             */
            WithCreate withSecrets(List<SecretReference> secrets);
        }
        ...
        /**
         * The stage of the ContainerGroup definition allowing to specify extensions.
         */
        ...
        /**
         * The stage of the ContainerGroup definition allowing to specify confidentialComputeProperties.
         */
        ...
        /**
         * The stage of the ContainerGroup definition allowing to specify priority.
         */
        ...
        /**
         * The stage of the ContainerGroup definition allowing to specify containerGroupProfile.
         */
        interface WithContainerGroupProfile {
            /**
             * Specifies the containerGroupProfile property: The reference container group profile properties..
             * 
             * @param containerGroupProfile The reference container group profile properties.
             * @return the next definition stage.
             */
            WithCreate withContainerGroupProfile(ContainerGroupProfileReferenceDefinition containerGroupProfile);
        }

        /**
         * The stage of the ContainerGroup definition allowing to specify standbyPoolProfile.
         */
        interface WithStandbyPoolProfile {
            /**
             * Specifies the standbyPoolProfile property: The reference standby pool profile properties..
             * 
             * @param standbyPoolProfile The reference standby pool profile properties.
             * @return the next definition stage.
             */
            WithCreate withStandbyPoolProfile(StandbyPoolProfileDefinition standbyPoolProfile);
        }
    }

    /**
     * Begins update for the ContainerGroup resource.
     * 
     * @return the stage of resource update.
     */
    ContainerGroup.Update update();

    /**
     * The template for ContainerGroup update.
     */
    interface Update extends UpdateStages.WithTags, UpdateStages.WithZones, UpdateStages.WithIdentity,
        UpdateStages.WithSecrets, UpdateStages.WithContainers, UpdateStages.WithImageRegistryCredentials,
        UpdateStages.WithRestartPolicy, UpdateStages.WithIpAddress, UpdateStages.WithOsType, UpdateStages.WithVolumes,
        UpdateStages.WithDiagnostics, UpdateStages.WithSubnetIds, UpdateStages.WithDnsConfig, UpdateStages.WithSku,
        UpdateStages.WithEncryptionProperties, UpdateStages.WithInitContainers, UpdateStages.WithExtensions,
        UpdateStages.WithConfidentialComputeProperties, UpdateStages.WithPriority,
        UpdateStages.WithContainerGroupProfile, UpdateStages.WithStandbyPoolProfile {
        /**
         * Executes the update request.
         * 
         * @return the updated resource.
         */
        ContainerGroup apply();
         ...
         * @return the updated resource.
         */
        ContainerGroup apply(Context context);
    }

    /**
     * The ContainerGroup update stages.
     */
    interface UpdateStages {
        /**
         * The stage of the ContainerGroup update allowing to specify tags.
         */
        interface WithTags {
            /**
             * Specifies the tags property: Resource tags..
        ...
        /**
         * The stage of the ContainerGroup update allowing to specify zones.
         */
        interface WithZones {
            /**
             * Specifies the zones property: The zones for the container group..
        ...
        interface WithIdentity {
             ...
             * @return the next definition stage.
             */
            Update withIdentity(ContainerGroupIdentity identity);
        }

        /**
         * The stage of the ContainerGroup update allowing to specify secrets.
         */
        interface WithSecrets {
            /**
             * Specifies the secrets property: The secret references that will be referenced within the container
             ...
             * @return the next definition stage.
             */
            Update withSecrets(List<SecretReference> secrets);
        }

        /**
         * The stage of the ContainerGroup update allowing to specify containers.
         */
        interface WithContainers {
            /**
             * Specifies the containers property: The containers within the container group..
             ...
             * @return the next definition stage.
             */
            Update withContainers(List<Container> containers);
        }
        ...
        /**
         * The stage of the ContainerGroup update allowing to specify osType.
         */
        interface WithOsType {
            /**
             * Specifies the osType property: The operating system type required by the containers in the container
        ...
        interface WithDiagnostics {
             ...
             * @return the next definition stage.
             */
            Update withDiagnostics(ContainerGroupDiagnostics diagnostics);
        }

        /**
         * The stage of the ContainerGroup update allowing to specify subnetIds.
         */
        interface WithSubnetIds {
            /**
             * Specifies the subnetIds property: The subnet resource IDs for a container group..
             ...
             * @return the next definition stage.
             */
            Update withSubnetIds(List<ContainerGroupSubnetId> subnetIds);
        }
        ...
        interface WithDnsConfig {
             ...
             * @return the next definition stage.
             */
            Update withDnsConfig(DnsConfiguration dnsConfig);
        }

        /**
         * The stage of the ContainerGroup update allowing to specify sku.
         */
        interface WithSku {
            /**
             * Specifies the sku property: The SKU for a container group..
             ...
             * @return the next definition stage.
             */
            Update withSku(ContainerGroupSku sku);
        }

        /**
         * The stage of the ContainerGroup update allowing to specify encryptionProperties.
         */
        interface WithEncryptionProperties {
            /**
             * Specifies the encryptionProperties property: The encryption properties for a container group..
        ...
        /**
         * The stage of the ContainerGroup update allowing to specify initContainers.
         */
        interface WithInitContainers {
            /**
             * Specifies the initContainers property: The init containers for a container group..
             ...
             * @return the next definition stage.
             */
            Update withInitContainers(List<InitContainerDefinition> initContainers);
        }

        /**
         * The stage of the ContainerGroup update allowing to specify extensions.
         */
        interface WithExtensions {
            /**
             * Specifies the extensions property: extensions used by virtual kubelet.
             ...
             * @return the next definition stage.
             */
            Update withExtensions(List<DeploymentExtensionSpec> extensions);
        }

        /**
         * The stage of the ContainerGroup update allowing to specify confidentialComputeProperties.
         */
        interface WithConfidentialComputeProperties {
            /**
             * Specifies the confidentialComputeProperties property: The properties for confidential container group.
             ...
             * @return the next definition stage.
             */
            Update withConfidentialComputeProperties(ConfidentialComputeProperties confidentialComputeProperties);
        }

        /**
         * The stage of the ContainerGroup update allowing to specify priority.
         */
        interface WithPriority {
            /**
             * Specifies the priority property: The priority of the container group..
             ...
             * @return the next definition stage.
             */
            Update withPriority(ContainerGroupPriority priority);
        }

        /**
         * The stage of the ContainerGroup update allowing to specify containerGroupProfile.
         */
        interface WithContainerGroupProfile {
            /**
             * Specifies the containerGroupProfile property: The reference container group profile properties..
             ...
             * @return the next definition stage.
             */
            Update withContainerGroupProfile(ContainerGroupProfileReferenceDefinition containerGroupProfile);
        }

        /**
         * The stage of the ContainerGroup update allowing to specify standbyPoolProfile.
         */
        interface WithStandbyPoolProfile {
            /**
             * Specifies the standbyPoolProfile property: The reference standby pool profile properties..
             ...
             * @return the next definition stage.
             */
            Update withStandbyPoolProfile(StandbyPoolProfileDefinition standbyPoolProfile);
        }
    }
