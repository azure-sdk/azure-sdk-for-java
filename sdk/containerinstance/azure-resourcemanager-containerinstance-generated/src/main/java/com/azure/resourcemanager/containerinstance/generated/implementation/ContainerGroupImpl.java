...
public final class ContainerGroupImpl implements ContainerGroup, ContainerGroup.Definition, ContainerGroup.Update {
    ...
    public Integer provisioningTimeoutInSeconds() {
        return this.innerModel().provisioningTimeoutInSeconds();
    }

    public IsCustomProvisioningTimeout isCustomProvisioningTimeout() {
        return this.innerModel().isCustomProvisioningTimeout();
    }
    ...
    ContainerGroupImpl(
        ...
        this.containerGroupName = Utils.getValueFromIdByName(innerObject.id(), "containerGroups");
    }
    ...
    public ContainerGroupImpl withProvisioningTimeoutInSeconds(Integer provisioningTimeoutInSeconds) {
        this.innerModel().withProvisioningTimeoutInSeconds(provisioningTimeoutInSeconds);
        return this;
    }
    ...
    public ContainerGroupImpl withExtensions(List<DeploymentExtensionSpec> extensions) {
