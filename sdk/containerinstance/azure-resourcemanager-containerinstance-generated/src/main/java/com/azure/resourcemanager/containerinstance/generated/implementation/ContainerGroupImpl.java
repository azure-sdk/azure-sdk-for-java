...
public final class ContainerGroupImpl implements ContainerGroup, ContainerGroup.Definition, ContainerGroup.Update {
    ...
    public ContainerGroupImpl withSecretReferences(List<SecretReference> secretReferences) {
        this.innerModel().withSecretReferences(secretReferences);
        return this;
    }
    ...
    public ContainerGroupImpl withIdentityAcls(IdentityAcls identityAcls) {
        this.innerModel().withIdentityAcls(identityAcls);
        return this;
    }
}
