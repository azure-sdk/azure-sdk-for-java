...
public final class ContainerGroupImpl implements ContainerGroup, ContainerGroup.Definition, ContainerGroup.Update {
    ...
    public ContainerGroup create() {
        this.innerObject = serviceManager.serviceClient().getContainerGroups().createOrUpdate(resourceGroupName,
            containerGroupName, this.innerModel(), Context.NONE);
        return this;
    }

    public ContainerGroup create(Context context) {
        this.innerObject = serviceManager.serviceClient().getContainerGroups().createOrUpdate(resourceGroupName,
            containerGroupName, this.innerModel(), context);
        return this;
    }
    ...
    public ContainerGroup refresh() {
        this.innerObject = serviceManager.serviceClient().getContainerGroups()
            .getByResourceGroupWithResponse(resourceGroupName, containerGroupName, Context.NONE).getValue();
        return this;
    }

    public ContainerGroup refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getContainerGroups()
            .getByResourceGroupWithResponse(resourceGroupName, containerGroupName, context).getValue();
        return this;
    }
