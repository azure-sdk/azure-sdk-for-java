...
public final class ContainerGroupImpl implements ContainerGroup, ContainerGroup.Definition, ContainerGroup.Update {
    ...
    public Integer retryTimeoutMinutes() {
        return this.innerModel().retryTimeoutMinutes();
    }
    ...
    public ContainerGroupImpl withRetryTimeoutMinutes(Integer retryTimeoutMinutes) {
        this.innerModel().withRetryTimeoutMinutes(retryTimeoutMinutes);
        return this;
    }
