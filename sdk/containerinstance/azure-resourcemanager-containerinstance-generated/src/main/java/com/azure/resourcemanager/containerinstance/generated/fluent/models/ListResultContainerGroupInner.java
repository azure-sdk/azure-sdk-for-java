...
public final class ListResultContainerGroupInner extends Resource {
     ...
     */
    public ListResultContainerGroupInner withZones(List<String> zones) {
        this.zones = zones;
        return this;
    }
     ...
     */
    @Override
    public ListResultContainerGroupInner withTags(Map<String, String> tags) {
        super.withTags(tags);
        return this;
    }
     ...
     * @return the ListResultContainerGroupInner object itself.
     */
    public ListResultContainerGroupInner withSecretReferences(List<SecretReference> secretReferences) {
     ...
     * @return the ListResultContainerGroupInner object itself.
     */
    public ListResultContainerGroupInner withContainers(List<Container> containers) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ListResultContainerGroupPropertiesProperties();
        }
     ...
     * @return the ListResultContainerGroupInner object itself.
     */
    public ListResultContainerGroupInner withVolumes(List<Volume> volumes) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ListResultContainerGroupPropertiesProperties();
        }
     ...
     * @return the ListResultContainerGroupInner object itself.
     */
    public ListResultContainerGroupInner withSubnetIds(List<ContainerGroupSubnetId> subnetIds) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ListResultContainerGroupPropertiesProperties();
        }
     ...
     * @return the ListResultContainerGroupInner object itself.
     */
    public ListResultContainerGroupInner withInitContainers(List<InitContainerDefinition> initContainers) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ListResultContainerGroupPropertiesProperties();
        }
     ...
     * @return the ListResultContainerGroupInner object itself.
     */
    public ListResultContainerGroupInner withExtensions(List<DeploymentExtensionSpec> extensions) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ListResultContainerGroupPropertiesProperties();
        }
