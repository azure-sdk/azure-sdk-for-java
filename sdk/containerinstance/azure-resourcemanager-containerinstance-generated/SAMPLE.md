...
public final class ContainerGroupsCreateOrUpdateSamples {
    /*
     * x-ms-original-file:
     * specification/containerinstance/resource-manager/Microsoft.ContainerInstance/preview/2024-10-01-preview/examples/
    ...
    public static void containerGroupCreateOrUpdateWithStandbyPool(
        ...
        manager.containerGroups()
            ...
            .withOsType((OperatingSystemTypes) null)
        ...
        manager.containerGroups()
            ...
            .withIdentity(new ContainerGroupIdentity().withType(ResourceIdentityType.SYSTEM_ASSIGNED_USER_ASSIGNED)
                .withUserAssignedIdentities(mapOf(
                    ...
                    new UserAssignedIdentities())))
            .withSecrets(Arrays.asList(new SecretReference().withName("envSecretRef")
                .withIdentity(
                    "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/myResourceGroup/providers/Microsoft.ManagedIdentity/userAssignedIdentities/identity-name")
