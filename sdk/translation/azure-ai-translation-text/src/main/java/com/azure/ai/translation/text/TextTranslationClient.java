...
public final class TextTranslationClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public GetSupportedLanguagesResult getSupportedLanguages(List<LanguageScope> scopes, String acceptLanguage,
        String ifNoneMatch) {
     ...
     * @return the response.
     */
    private List<DictionaryExampleItem> lookupDictionaryExamples(String sourceLanguage, String targetLanguage,
