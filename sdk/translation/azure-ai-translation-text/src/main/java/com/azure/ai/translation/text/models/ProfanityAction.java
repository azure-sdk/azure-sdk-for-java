...
public final class ProfanityAction extends ExpandableStringEnum<ProfanityAction> {
    ...
    @Generated public static final ProfanityAction NO_ACTION = fromString("NoAction");

    /** Static value Marked for ProfanityAction. */
    @Generated public static final ProfanityAction MARKED = fromString("Marked");

    /** Static value Deleted for ProfanityAction. */
    @Generated public static final ProfanityAction DELETED = fromString("Deleted");
