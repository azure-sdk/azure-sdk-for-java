...
public final class TextTranslationAsyncClient {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<List<TranslatedTextItem>> translate(List<String> targetLanguages, List<InputTextItem> body,
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<List<BreakSentenceItem>> findSentenceBoundaries(List<InputTextItem> body, String clientTraceId,
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<List<BreakSentenceItem>> findSentenceBoundaries(List<InputTextItem> body) {
        // Generated convenience method for findSentenceBoundariesWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return findSentenceBoundariesWithResponse(BinaryData.fromObject(body), requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(TYPE_REFERENCE_LIST_BREAK_SENTENCE_ITEM));
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<GetSupportedLanguagesResult> getSupportedLanguages(String clientTraceId, String scope,
