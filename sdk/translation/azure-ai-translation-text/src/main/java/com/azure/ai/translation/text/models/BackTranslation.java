...
public final class BackTranslation {
    ...
    private BackTranslation(
            @JsonProperty(value = "normalizedText") String normalizedText,
            @JsonProperty(value = "displayText") String displayText,
            @JsonProperty(value = "numExamples") int numExamples,
