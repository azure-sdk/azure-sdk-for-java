...
public final class TranslateTarget implements JsonSerializable<TranslateTarget> {
    ...
    /*
     * Desired tone of target translation. Default is 'informal'
     */
    @Generated
    private String tone;
     ...
     */
    @Generated
    private List<String> adaptiveDatasetIds;
    ...
    /**
     * Get the tone property: Desired tone of target translation. Default is 'informal'.
     * 
    ...
    /**
     * Set the tone property: Desired tone of target translation. Default is 'informal'.
     * 
    ...
    /**
     * Get the adaptiveDatasetIds property: Reference dataset ID having sentence pair to generate adaptive customized
     * translation.
     * 
     * @return the adaptiveDatasetIds value.
     */
    @Generated
    public List<String> getAdaptiveDatasetIds() {
        return this.adaptiveDatasetIds;
    }

    /**
     * Set the adaptiveDatasetIds property: Reference dataset ID having sentence pair to generate adaptive customized
     * translation.
     * 
     * @param adaptiveDatasetIds the adaptiveDatasetIds value to set.
     * @return the TranslateTarget object itself.
     */
    @Generated
    public TranslateTarget setAdaptiveDatasetIds(List<String> adaptiveDatasetIds) {
        this.adaptiveDatasetIds = adaptiveDatasetIds;
        return this;
    }
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeArrayField("adaptiveDatasetIds", this.adaptiveDatasetIds,
    ...
    public static TranslateTarget fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            String tone = null;
            String gender = null;
            List<String> adaptiveDatasetIds = null;
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                } else if ("adaptiveDatasetIds".equals(fieldName)) {
                    adaptiveDatasetIds = reader.readArray(reader1 -> reader1.getString());
            ...
            deserializedTranslateTarget.adaptiveDatasetIds = adaptiveDatasetIds;
