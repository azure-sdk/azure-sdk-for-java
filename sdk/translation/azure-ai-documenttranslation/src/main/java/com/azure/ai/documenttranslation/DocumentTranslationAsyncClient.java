...
import com.azure.ai.documenttranslation.implementation.DocumentTranslationClientImpl;
import com.azure.ai.documenttranslation.implementation.MultipartFormDataHelper;
import com.azure.ai.documenttranslation.models.DocumentTranslateContent;
...
/**
 * Initializes a new instance of the asynchronous DocumentTranslationClient type.
 */
@ServiceClient(builder = DocumentTranslationClientBuilder.class, isAsync = true)
public final class DocumentTranslationAsyncClient {
    @Generated
    private final DocumentTranslationClientImpl serviceClient;

    /**
     * Initializes an instance of DocumentTranslationAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    DocumentTranslationAsyncClient(DocumentTranslationClientImpl serviceClient) {
     ...
     * <td>String</td>
     * <td>No</td>
     * <td>Specifies source language of the input document.
     * If this parameter isn't specified, automatic language detection is applied to determine the source language.
     * For example if the source document is written in English, then use sourceLanguage=en</td>
     * </tr>
     * <tr>
     * <td>category</td>
     * <td>String</td>
     ...
     * Possible values are: true (default) or false.</td>
     * </tr>
     * </table>
    ...
    public Mono<BinaryData> documentTranslate(String targetLanguage, DocumentTranslateContent documentTranslateContent,
        ...
        return documentTranslateWithResponse(targetLanguage,
            new MultipartFormDataHelper(requestOptions)
                .serializeFileField("document", documentTranslateContent.getDocument(),
                    documentTranslateContent.getDocumentFilename())
                .serializeJsonField("glossary", documentTranslateContent.getGlossary()).end().getRequestBody(),
