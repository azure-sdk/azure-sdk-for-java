...
package com.azure.ai.documenttranslation.implementation;

import com.azure.ai.documenttranslation.DocumentTranslationServiceVersion;
...
public final class DocumentTranslationClientImpl {
    ...
    /**
     * Supported document Translation endpoints (protocol and hostname, for example:
     * https://{TranslatorResourceName}.cognitiveservices.azure.com/translator).
     */
    private final String endpoint;

    /**
     * Gets Supported document Translation endpoints (protocol and hostname, for example:
     * https://{TranslatorResourceName}.cognitiveservices.azure.com/translator).
     * 
     ...
     * 
     * @param endpoint Supported document Translation endpoints (protocol and hostname, for example:
     * https://{TranslatorResourceName}.cognitiveservices.azure.com/translator).
