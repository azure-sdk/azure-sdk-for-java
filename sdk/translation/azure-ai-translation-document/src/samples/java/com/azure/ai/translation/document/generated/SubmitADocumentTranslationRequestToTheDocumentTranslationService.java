    ...
    public static void main(String[] args) {
        DocumentTranslationClient documentTranslationClient
            = new DocumentTranslationClientBuilder().credential(new DefaultAzureCredentialBuilder().build())
                .endpoint("{endpoint}")
                .buildClient();
        // BEGIN:com.azure.ai.translation.document.generated.begintranslation.submitadocumenttranslationrequesttothedocumenttranslationservice
        SyncPoller<TranslationStatusResult, TranslationStatusResult> response
            = documentTranslationClient
                .beginBeginTranslation(
        ...
        // END:com.azure.ai.translation.document.generated.begintranslation.submitadocumenttranslationrequesttothedocumenttranslationservice
    }
}
