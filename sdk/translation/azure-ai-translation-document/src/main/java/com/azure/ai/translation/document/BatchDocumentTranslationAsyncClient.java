...
import com.azure.ai.translation.document.implementation.DocumentTranslationOperationsImpl;
...
import com.azure.ai.translation.document.models.SupportedStorageSources;
...
public final class BatchDocumentTranslationAsyncClient {
    @Generated
    private final DocumentTranslationOperationsImpl serviceClient;
     ...
     */
    @Generated
    BatchDocumentTranslationAsyncClient(DocumentTranslationOperationsImpl serviceClient) {
    ...
    public Mono<Response<Void>> startTranslationWithResponse(BinaryData startTranslationDetails,
        RequestOptions requestOptions) {
        return this.serviceClient.startTranslationWithResponseAsync(startTranslationDetails, requestOptions);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> startTranslation(StartTranslationDetails startTranslationDetails) {
        // Generated convenience method for startTranslationWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return startTranslationWithResponse(BinaryData.fromObject(startTranslationDetails), requestOptions)
     ...
     * @param orderBy the sorting query for the collection (ex: 'CreatedDateTimeUtc asc',
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<TranslationStatus> getTranslationsStatus(Integer top, Integer skip, Integer maxpagesize,
        List<String> ids, List<String> statuses, OffsetDateTime createdDateTimeUtcStart,
        ...
        if (ids != null) {
            requestOptions.addQueryParam("ids", ids.stream().map(paramItemValue -> Objects.toString(paramItemValue, ""))
                .collect(Collectors.joining(",")), false);
        }
        if (statuses != null) {
            requestOptions.addQueryParam("statuses", statuses.stream()
        ...
        if (orderBy != null) {
            requestOptions.addQueryParam("$orderBy", orderBy.stream()
                .map(paramItemValue -> Objects.toString(paramItemValue, "")).collect(Collectors.joining(",")), false);
        }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<DocumentStatus> getDocumentsStatus(String id, Integer top, Integer skip, Integer maxpagesize,
        List<String> ids, List<String> statuses, OffsetDateTime createdDateTimeUtcStart,
        OffsetDateTime createdDateTimeUtcEnd, List<String> orderBy) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<SupportedFileFormats> getSupportedDocumentFormats() {
        // Generated convenience method for getSupportedDocumentFormatsWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getSupportedDocumentFormatsWithResponse(requestOptions).flatMap(FluxUtil::toMono)
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<SupportedFileFormats> getSupportedGlossaryFormats() {
        // Generated convenience method for getSupportedGlossaryFormatsWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getSupportedGlossaryFormatsWithResponse(requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(SupportedFileFormats.class));
    }
     ...
     * @throws ResourceModifiedException thrown if the request is rejected by server on status code 409.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return list of supported storage sources on successful completion of {@link Mono}.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<SupportedStorageSources> getSupportedStorageSources() {
        // Generated convenience method for getSupportedStorageSourcesWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getSupportedStorageSourcesWithResponse(requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(SupportedStorageSources.class));
    }
}
