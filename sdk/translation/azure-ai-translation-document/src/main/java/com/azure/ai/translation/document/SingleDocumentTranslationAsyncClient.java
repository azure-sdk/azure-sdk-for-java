...
/**
 * Initializes a new instance of the asynchronous SingleDocumentTranslationClient type.
 */
@ServiceClient(builder = SingleDocumentTranslationClientBuilder.class, isAsync = true)
public final class SingleDocumentTranslationAsyncClient {

    @Generated
    private final SingleDocumentTranslationClientImpl serviceClient;

    /**
     * Initializes an instance of SingleDocumentTranslationAsyncClient class.
     *
     * @param serviceClient the service client implementation.
     */
    @Generated
    SingleDocumentTranslationAsyncClient(SingleDocumentTranslationClientImpl serviceClient) {
     ...
     * @param translateQuery Specifies the input string is designed to be submitted to a GPT model for translation.
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<BinaryData> translate(String targetLanguage, DocumentTranslateContent documentTranslateContent,
        String sourceLanguage, String category, Boolean allowFallback, Boolean translateQuery,
        ...
        if (translateQuery != null) {
            requestOptions.addQueryParam("translateQuery", String.valueOf(translateQuery), false);
        }
