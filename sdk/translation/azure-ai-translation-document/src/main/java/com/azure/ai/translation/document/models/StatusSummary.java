...
public final class StatusSummary {
    ...
    private int totalCharacterCharged;
    ...
    private StatusSummary(@JsonProperty(value = "total") int total, @JsonProperty(value = "failed") int failed,
        ...
        @JsonProperty(value = "totalCharacterCharged") int totalCharacterCharged) {
        this.total = total;
        this.failed = failed;
     ...
     */
    @Generated
    public int getTotalCharacterCharged() {
