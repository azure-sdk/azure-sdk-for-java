...
public final class TranslationBatch implements JsonSerializable<TranslationBatch> {
    ...
    /**
     * Get the options property: The batch operation options.
     * 
    ...
    /**
     * Set the options property: The batch operation options.
     * 
     * @param options the options value to set.
     * @return the TranslationBatch object itself.
     */
    @Generated
    public TranslationBatch setOptions(BatchOptions options) {
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("inputs".equals(fieldName)) {
                    ...
                    options = BatchOptions.fromJson(reader);
                } else {
                    reader.skipChildren();
                }
            }
            TranslationBatch deserializedTranslationBatch = new TranslationBatch(inputs);
            deserializedTranslationBatch.options = options;

            return deserializedTranslationBatch;
        });
    }
}
