 ...
 */
@Fluent
public final class TargetInput implements JsonSerializable<TargetInput> {
    /*
    ...
    /**
     * Reads an instance of TargetInput from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of TargetInput if the JsonReader was pointing to an instance of it, or null if it was
     * pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the TargetInput.
     */
    @Generated
    public static TargetInput fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            TargetInput deserializedTargetInput = new TargetInput(targetUrl, language);
            deserializedTargetInput.category = category;
            deserializedTargetInput.glossaries = glossaries;
