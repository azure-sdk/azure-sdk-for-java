...
/**
 * An instance of this class provides access to all the operations defined in DocumentTranslationOperations.
 */
public final class DocumentTranslationOperationsImpl {
    /**
     * The proxy service used to perform REST calls.
     */
    private final DocumentTranslationOperationsService service;
    ...
    /**
     * Initializes an instance of DocumentTranslationOperationsImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    DocumentTranslationOperationsImpl(BatchDocumentTranslationClientImpl client) {
        this.service = RestProxy.create(DocumentTranslationOperationsService.class, client.getHttpPipeline(),
    ...
    /**
     * The interface defining all the services for BatchDocumentTranslationClientDocumentTranslationOperations to be
     * used by the proxy service to perform REST calls.
     */
    @Host("{endpoint}/translator/text/batch/v1.1")
    @ServiceInterface(name = "BatchDocumentTransla")
    public interface DocumentTranslationOperationsService {
        @Post("/batches")
     ...
     *                     ]
     *                     options (Optional): {
     *                         pdfOutputAdditionalFormat: String(None/OpenXmlWord) (Optional)
     *                     }
     *                     storageSource: String(AzureBlob) (Optional)
     *                 }
     *             ]
    ...
    public Mono<Response<Void>> startTranslationWithResponseAsync(BinaryData startTranslationDetails,
        RequestOptions requestOptions) {
        final String accept = "application/json";
        return FluxUtil.withContext(context -> service.startTranslation(this.client.getEndpoint(),
            this.client.getServiceVersion().getVersion(), accept, startTranslationDetails, requestOptions, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<Void> startTranslationWithResponse(BinaryData startTranslationDetails,
        RequestOptions requestOptions) {
        final String accept = "application/json";
        return service.startTranslationSync(this.client.getEndpoint(), this.client.getServiceVersion().getVersion(),
     ...
     * <td>Integer</td>
     * <td>No</td>
     * <td>$top indicates the total number of records the user wants to be returned across
     * all pages.
     * 
     ...
     * about it instead of just ignoring the query options.</td>
     * </tr>
     * <tr>
     * <td>$skip</td>
     * <td>Integer</td>
     * <td>No</td>
     * <td>$skip indicates the number of records to skip from the list of records held by
     ...
     * client informing about it instead of just ignoring the query options.</td>
     * </tr>
     * <tr>
     * <td>$maxpagesize</td>
     * <td>Integer</td>
     * <td>No</td>
     * <td>$maxpagesize is the maximum items returned in a page. If more items are
     * requested via $top (or $top is not specified and there are more items to be
     * returned), @nextLink will contain the link to the next page.
     * 
     * 
     ...
     * if the specified page size is smaller than the server's default page size.</td>
     * </tr>
     * <tr>
     * <td>ids</td>
     * <td>List&lt;String&gt;</td>
     * <td>No</td>
     * <td>Ids to use in filtering. In the form of "," separated string.</td>
     * </tr>
     * <tr>
     * <td>statuses</td>
     * <td>List&lt;String&gt;</td>
     * <td>No</td>
     * <td>Statuses to use in filtering. In the form of "," separated string.</td>
     * </tr>
     * <tr>
     * <td>createdDateTimeUtcStart</td>
     * <td>OffsetDateTime</td>
     * <td>No</td>
     * <td>the start datetime to get items after</td>
     * </tr>
     * <tr>
     * <td>createdDateTimeUtcEnd</td>
     * <td>OffsetDateTime</td>
     * <td>No</td>
     * <td>the end datetime to get items before</td>
     * </tr>
     * <tr>
     * <td>$orderBy</td>
     * <td>List&lt;String&gt;</td>
     * <td>No</td>
     * <td>the sorting query for the collection (ex: 'CreatedDateTimeUtc asc',
     * 'CreatedDateTimeUtc desc'). In the form of "," separated string.</td>
     * </tr>
     * </table>
     ...
     *         totalCharacterCharged: int (Required)
     *     }
     * }
     * }</pre>
     * 
    ...
    private Mono<PagedResponse<BinaryData>> getTranslationsStatusSinglePageAsync(RequestOptions requestOptions) {
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.getTranslationsStatus(this.client.getEndpoint(),
    ...
    private PagedResponse<BinaryData> getTranslationsStatusSinglePage(RequestOptions requestOptions) {
        final String accept = "application/json";
        Response<BinaryData> res = service.getTranslationsStatusSync(this.client.getEndpoint(),
    ...
    public Mono<Response<BinaryData>> getDocumentStatusWithResponseAsync(String id, String documentId,
        RequestOptions requestOptions) {
        final String accept = "application/json";
        return FluxUtil.withContext(context -> service.getDocumentStatus(this.client.getEndpoint(),
            this.client.getServiceVersion().getVersion(), id, documentId, accept, requestOptions, context));
    }
    ...
    public Response<BinaryData> getDocumentStatusWithResponse(String id, String documentId,
        RequestOptions requestOptions) {
        final String accept = "application/json";
        return service.getDocumentStatusSync(this.client.getEndpoint(), this.client.getServiceVersion().getVersion(),
            id, documentId, accept, requestOptions, Context.NONE);
    }
    ...
    public Mono<Response<BinaryData>> getTranslationStatusWithResponseAsync(String id, RequestOptions requestOptions) {
        final String accept = "application/json";
        return FluxUtil.withContext(context -> service.getTranslationStatus(this.client.getEndpoint(),
    ...
    public Response<BinaryData> getTranslationStatusWithResponse(String id, RequestOptions requestOptions) {
        final String accept = "application/json";
        return service.getTranslationStatusSync(this.client.getEndpoint(), this.client.getServiceVersion().getVersion(),
    ...
    public Mono<Response<BinaryData>> cancelTranslationWithResponseAsync(String id, RequestOptions requestOptions) {
        final String accept = "application/json";
        return FluxUtil.withContext(context -> service.cancelTranslation(this.client.getEndpoint(),
            this.client.getServiceVersion().getVersion(), id, accept, requestOptions, context));
    }
    ...
    public Response<BinaryData> cancelTranslationWithResponse(String id, RequestOptions requestOptions) {
        final String accept = "application/json";
        return service.cancelTranslationSync(this.client.getEndpoint(), this.client.getServiceVersion().getVersion(),
            id, accept, requestOptions, Context.NONE);
    }
    ...
    private Mono<PagedResponse<BinaryData>> getDocumentsStatusSinglePageAsync(String id,
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.getDocumentsStatus(this.client.getEndpoint(),
                this.client.getServiceVersion().getVersion(), id, accept, requestOptions, context))
            .map(res -> new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(),
                getValues(res.getValue(), "value"), getNextLink(res.getValue(), "nextLink"), null));
    }
    ...
    private PagedResponse<BinaryData> getDocumentsStatusSinglePage(String id, RequestOptions requestOptions) {
        final String accept = "application/json";
        Response<BinaryData> res = service.getDocumentsStatusSync(this.client.getEndpoint(),
    ...
    public Mono<Response<BinaryData>> getSupportedDocumentFormatsWithResponseAsync(RequestOptions requestOptions) {
        final String accept = "application/json";
        return FluxUtil.withContext(context -> service.getSupportedDocumentFormats(this.client.getEndpoint(),
            this.client.getServiceVersion().getVersion(), accept, requestOptions, context));
    }
    ...
    public Response<BinaryData> getSupportedDocumentFormatsWithResponse(RequestOptions requestOptions) {
        final String accept = "application/json";
        return service.getSupportedDocumentFormatsSync(this.client.getEndpoint(),
            this.client.getServiceVersion().getVersion(), accept, requestOptions, Context.NONE);
    }
    ...
    public Mono<Response<BinaryData>> getSupportedGlossaryFormatsWithResponseAsync(RequestOptions requestOptions) {
        final String accept = "application/json";
        return FluxUtil.withContext(context -> service.getSupportedGlossaryFormats(this.client.getEndpoint(),
            this.client.getServiceVersion().getVersion(), accept, requestOptions, context));
    }
    ...
    public Response<BinaryData> getSupportedGlossaryFormatsWithResponse(RequestOptions requestOptions) {
        final String accept = "application/json";
        return service.getSupportedGlossaryFormatsSync(this.client.getEndpoint(),
            this.client.getServiceVersion().getVersion(), accept, requestOptions, Context.NONE);
    }
     ...
     * @throws ResourceNotFoundException thrown if the request is rejected by server on status code 404.
     * @throws ResourceModifiedException thrown if the request is rejected by server on status code 409.
     * @return list of supported storage sources along with {@link Response} on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> getSupportedStorageSourcesWithResponseAsync(RequestOptions requestOptions) {
        final String accept = "application/json";
        return FluxUtil.withContext(context -> service.getSupportedStorageSources(this.client.getEndpoint(),
            this.client.getServiceVersion().getVersion(), accept, requestOptions, context));
    }
     ...
     * @throws ResourceNotFoundException thrown if the request is rejected by server on status code 404.
     * @throws ResourceModifiedException thrown if the request is rejected by server on status code 409.
     * @return list of supported storage sources along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<BinaryData> getSupportedStorageSourcesWithResponse(RequestOptions requestOptions) {
        final String accept = "application/json";
        return service.getSupportedStorageSourcesSync(this.client.getEndpoint(),
            this.client.getServiceVersion().getVersion(), accept, requestOptions, Context.NONE);
    }
