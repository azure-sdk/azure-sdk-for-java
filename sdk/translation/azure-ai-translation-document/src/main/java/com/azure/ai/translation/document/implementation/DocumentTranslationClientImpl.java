...
public final class DocumentTranslationClientImpl {
    ...
    public interface DocumentTranslationClientService {
        ...
        Mono<Response<Void>> beginTranslation(@HostParam("endpoint") String endpoint,
        ...
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        @UnexpectedResponseExceptionType(HttpResponseException.class)
        Response<Void> beginTranslationSync(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @HeaderParam("Content-Type") String contentType,
            @HeaderParam("Accept") String accept, @BodyParam("application/json") BinaryData body,
            RequestOptions requestOptions, Context context);
    ...
    private Mono<Response<Void>> beginTranslationWithResponseAsync(BinaryData body, RequestOptions requestOptions) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<Void> beginTranslationWithResponse(BinaryData body, RequestOptions requestOptions) {
        final String contentType = "application/json";
        final String accept = "application/json";
    ...
    public PollerFlux<BinaryData, BinaryData> beginBeginTranslationAsync(BinaryData body,
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<BinaryData, BinaryData> beginBeginTranslation(BinaryData body, RequestOptions requestOptions) {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<TranslationStatusResult, TranslationStatusResult> beginBeginTranslationWithModel(BinaryData body,
        RequestOptions requestOptions) {
        return SyncPoller.createPoller(Duration.ofSeconds(1),
            () -> this.beginTranslationWithResponse(body, requestOptions),
            new SyncDefaultPollingStrategy<>(new PollingStrategyOptions(this.getHttpPipeline())
