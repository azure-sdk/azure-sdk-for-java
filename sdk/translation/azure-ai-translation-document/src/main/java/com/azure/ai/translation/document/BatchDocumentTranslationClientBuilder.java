...
import com.azure.ai.translation.document.implementation.BatchDocumentTranslationClientImpl;
...
public final class BatchDocumentTranslationClientBuilder implements HttpTrait<BatchDocumentTranslationClientBuilder>,
    ConfigurationTrait<BatchDocumentTranslationClientBuilder>, EndpointTrait<BatchDocumentTranslationClientBuilder> {
    @Generated
    ...
    public BatchDocumentTranslationAsyncClient buildAsyncClient() {
        return new BatchDocumentTranslationAsyncClient(buildInnerClient().getDocumentTranslationOperations());
    }
    ...
    public BatchDocumentTranslationClient buildClient() {
        return new BatchDocumentTranslationClient(buildInnerClient().getDocumentTranslationOperations());
    }
