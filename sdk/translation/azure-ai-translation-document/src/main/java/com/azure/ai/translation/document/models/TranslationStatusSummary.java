...
public final class TranslationStatusSummary implements JsonSerializable<TranslationStatusSummary> {
     ...
     */
    @Generated
    private Long totalImageScansCharged;
     ...
     */
    @Generated
    public Long getTotalImageScansCharged() {
    ...
    public static TranslationStatusSummary fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            Long totalImageScansCharged = null;
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("total".equals(fieldName)) {
                    ...
                    totalImageScansCharged = reader.getNullable(JsonReader::getLong);
                } else {
                    reader.skipChildren();
                }
            }
            ...
            deserializedTranslationStatusSummary.totalImageScansCharged = totalImageScansCharged;
