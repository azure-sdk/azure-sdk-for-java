...
public final class TranslationStatusResult implements JsonSerializable<TranslationStatusResult> {
     ...
     */
    @Generated
    private TranslationStatusResult(String translationId, OffsetDateTime createdOn, OffsetDateTime lastUpdatedOn,
    ...
    /**
     * Get the translationId property: Id of the translation operation.
     * 
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeStringField("id", this.translationId);
    ...
    public static TranslationStatusResult fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            TranslationStatusResult deserializedTranslationStatusResult
                = new TranslationStatusResult(translationId, createdOn, lastUpdatedOn, status, summary);
