...
import com.azure.resourcemanager.relay.models.OperationListResult;
...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    OperationsClientImpl(RelayApiImpl client) {
        this.service =
    ...
    /**
     * The interface defining all the services for RelayApiOperations to be used by the proxy service to perform REST
     * calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "RelayApiOperations")
     ...
     * @return result of the request to list Relay operations along with {@link PagedResponse} on successful completion
     *     of {@link Mono}.
     */
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return result of the request to list Relay operations as paginated response with {@link PagedFlux}.
     */
