...
public final class OperationsListMockTests {
    ...
    public void testList() throws Exception {
        ...
        Assertions.assertEquals("kcqvkocrc", response.iterator().next().display().provider());
        Assertions.assertEquals("kwt", response.iterator().next().display().resource());
        Assertions.assertEquals("xbnjbiksq", response.iterator().next().display().operation());
        Assertions.assertEquals("lssai", response.iterator().next().display().description());
