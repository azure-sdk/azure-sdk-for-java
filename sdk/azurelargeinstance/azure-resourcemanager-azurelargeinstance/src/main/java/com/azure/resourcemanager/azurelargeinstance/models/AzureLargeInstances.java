...
public interface AzureLargeInstances {
     ...
     */
    OperationStatusResult restart(String resourceGroupName, String azureLargeInstanceName, ForceState body);
     ...
     * @return the current status of an async operation.
     */
    OperationStatusResult shutdown(String resourceGroupName, String azureLargeInstanceName, Object body);
     ...
     * @return the current status of an async operation.
     */
    OperationStatusResult start(String resourceGroupName, String azureLargeInstanceName, Object body);
     ...
     * @return the current status of an async operation.
     */
    OperationStatusResult start(String resourceGroupName, String azureLargeInstanceName, Object body, Context context);
}
