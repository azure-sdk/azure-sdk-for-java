...
public interface AzureLargeInstances {
     ...
     * @return the current status of an async operation.
     */
    OperationStatusResult restart(String resourceGroupName, String azureLargeInstanceName, Context context);
     ...
     *     {@link Response}.
     */
    Response<AzureLargeInstance> getByResourceGroupWithResponse(
