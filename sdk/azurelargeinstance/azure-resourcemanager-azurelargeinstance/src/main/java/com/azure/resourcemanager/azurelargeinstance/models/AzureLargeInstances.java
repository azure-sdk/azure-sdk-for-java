...
public interface AzureLargeInstances {
     ...
     * @return the current status of an async operation.
     */
    OperationStatusResult shutdown(String resourceGroupName, String azureLargeInstanceName, Map<String, Object> body);
     ...
     * @return the current status of an async operation.
     */
    OperationStatusResult start(String resourceGroupName, String azureLargeInstanceName, Map<String, Object> body);
