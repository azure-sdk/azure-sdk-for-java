...
import com.azure.resourcemanager.azurelargeinstance.models.AzureLargeStorageInstanceListResult;
...
public final class AzureLargeStorageInstancesClientImpl implements AzureLargeStorageInstancesClient {
    ...
    AzureLargeStorageInstancesClientImpl(AzurelargeinstanceManagementClientImpl client) {
        this.service =
            RestProxy
                .create(
                    AzureLargeStorageInstancesService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }
    ...
    public interface AzureLargeStorageInstancesService {
        ...
        @Get("/subscriptions/{subscriptionId}/providers/Microsoft.AzureLargeInstance/azureLargeStorageInstance")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<AzureLargeStorageInstanceListResult>> list(
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<AzureLargeStorageInstanceListResult>> listByResourceGroup(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<AzureLargeStorageInstanceInner>> getByResourceGroup(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
        ...
        @UnexpectedResponseExceptionType(
            ...
            code = {501})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<AzureLargeStorageInstanceInner>> create(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @QueryParam("api-version") String apiVersion,
            @PathParam("azureLargeStorageInstanceName") String azureLargeStorageInstanceName,
            @BodyParam("application/json") AzureLargeStorageInstanceInner requestBodyParameters,
            @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<AzureLargeStorageInstanceInner>> update(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
                ...
                context ->
                    service
                        .list(
                            ...
                            accept,
                            context))
            .<PagedResponse<AzureLargeStorageInstanceInner>>map(
                res ->
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a list of AzureLargeStorageInstances in the specified subscription and resource group along with {@link
     *     PagedResponse} on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<AzureLargeStorageInstanceInner>> listByResourceGroupSinglePageAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<AzureLargeStorageInstanceInner> listByResourceGroupAsync(
        String resourceGroupName, Context context) {
        return new PagedFlux<>(
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<AzureLargeStorageInstanceInner> listByResourceGroup(
        String resourceGroupName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<AzureLargeStorageInstanceInner>> getByResourceGroupWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<AzureLargeStorageInstanceInner> getByResourceGroupAsync(
        String resourceGroupName, String azureLargeStorageInstanceName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<AzureLargeStorageInstanceInner> getByResourceGroupWithResponse(
        String resourceGroupName, String azureLargeStorageInstanceName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public AzureLargeStorageInstanceInner getByResourceGroup(
        String resourceGroupName, String azureLargeStorageInstanceName) {
    ...
    /**
     * Creates an Azure Large Storage Instance resource.
     *
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
     * @param azureLargeStorageInstanceName Name of the AzureLargeStorageInstance.
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<AzureLargeStorageInstanceInner>> createWithResponseAsync(
        String resourceGroupName,
        String azureLargeStorageInstanceName,
        AzureLargeStorageInstanceInner requestBodyParameters) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<AzureLargeStorageInstanceInner> createAsync(
        String resourceGroupName,
        String azureLargeStorageInstanceName,
        AzureLargeStorageInstanceInner requestBodyParameters) {
        return createWithResponseAsync(resourceGroupName, azureLargeStorageInstanceName, requestBodyParameters)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<AzureLargeStorageInstanceInner> createWithResponse(
        String resourceGroupName,
        String azureLargeStorageInstanceName,
        AzureLargeStorageInstanceInner requestBodyParameters,
        Context context) {
        return createWithResponseAsync(resourceGroupName, azureLargeStorageInstanceName, requestBodyParameters, context)
            .block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public AzureLargeStorageInstanceInner create(
        String resourceGroupName,
        String azureLargeStorageInstanceName,
        AzureLargeStorageInstanceInner requestBodyParameters) {
        return createWithResponse(resourceGroupName, azureLargeStorageInstanceName, requestBodyParameters, Context.NONE)
            .getValue();
    }
     ...
     *
     * <p>Patches the Tags field of a Azure Large Storage Instance for the specified subscription, resource group, and
     * instance name.
     *
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
     * @param azureLargeStorageInstanceName Name of the AzureLargeStorageInstance.
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<AzureLargeStorageInstanceInner>> updateWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<AzureLargeStorageInstanceInner> updateAsync(
        String resourceGroupName, String azureLargeStorageInstanceName, Tags tagsParameter) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<AzureLargeStorageInstanceInner> updateWithResponse(
        String resourceGroupName, String azureLargeStorageInstanceName, Tags tagsParameter, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public AzureLargeStorageInstanceInner update(
        String resourceGroupName, String azureLargeStorageInstanceName, Tags tagsParameter) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> deleteAsync(String resourceGroupName, String azureLargeStorageInstanceName) {
        return deleteWithResponseAsync(resourceGroupName, azureLargeStorageInstanceName)
    ...
    public Response<Void> deleteWithResponse(
        String resourceGroupName, String azureLargeStorageInstanceName, Context context) {
        return deleteWithResponseAsync(resourceGroupName, azureLargeStorageInstanceName, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public void delete(String resourceGroupName, String azureLargeStorageInstanceName) {
        deleteWithResponse(resourceGroupName, azureLargeStorageInstanceName, Context.NONE);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<AzureLargeStorageInstanceInner>> listBySubscriptionNextSinglePageAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<AzureLargeStorageInstanceInner>> listByResourceGroupNextSinglePageAsync(
        String nextLink) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
