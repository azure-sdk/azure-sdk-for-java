...
public interface AzureLargeStorageInstancesClient {
    ...
    Response<AzureLargeStorageInstanceInner> getByResourceGroupWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<AzureLargeStorageInstanceInner> createWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    AzureLargeStorageInstanceInner create(
        String resourceGroupName,
        String azureLargeStorageInstanceName,
        AzureLargeStorageInstanceInner requestBodyParameters);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<AzureLargeStorageInstanceInner> updateWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    AzureLargeStorageInstanceInner update(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<Void> deleteWithResponse(String resourceGroupName, String azureLargeStorageInstanceName, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    void delete(String resourceGroupName, String azureLargeStorageInstanceName);
}
