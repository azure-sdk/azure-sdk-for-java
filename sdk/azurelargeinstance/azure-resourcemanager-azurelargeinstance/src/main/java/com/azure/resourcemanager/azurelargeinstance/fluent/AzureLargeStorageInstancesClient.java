...
public interface AzureLargeStorageInstancesClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<AzureLargeStorageInstanceInner> createWithResponse(String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    AzureLargeStorageInstanceInner create(String resourceGroupName, String azureLargeStorageInstanceName,
