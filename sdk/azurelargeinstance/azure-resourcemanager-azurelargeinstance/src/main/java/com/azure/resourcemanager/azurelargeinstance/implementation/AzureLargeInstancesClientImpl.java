...
public final class AzureLargeInstancesClientImpl implements AzureLargeInstancesClient {
    ...
    public interface AzureLargeInstancesService {
        ...
        Mono<Response<Flux<ByteBuffer>>> restart(@HostParam("$host") String endpoint,
            ...
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("azureLargeInstanceName") String azureLargeInstanceName,
            @BodyParam("application/json") ForceState body, @HeaderParam("Accept") String accept, Context context);
    ...
    private Mono<Response<Flux<ByteBuffer>>> restartWithResponseAsync(String resourceGroupName,
        String azureLargeInstanceName, ForceState body) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return FluxUtil
            .withContext(context -> service.restart(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, azureLargeInstanceName, body, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> restartWithResponseAsync(String resourceGroupName,
        String azureLargeInstanceName, ForceState body, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service.restart(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, azureLargeInstanceName, body, accept, context);
    }
    ...
    private PollerFlux<PollResult<OperationStatusResultInner>, OperationStatusResultInner>
        beginRestartAsync(String resourceGroupName, String azureLargeInstanceName, ForceState body) {
        Mono<Response<Flux<ByteBuffer>>> mono
            = restartWithResponseAsync(resourceGroupName, azureLargeInstanceName, body);
    ...
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<OperationStatusResultInner>, OperationStatusResultInner>
        beginRestartAsync(String resourceGroupName, String azureLargeInstanceName, ForceState body, Context context) {
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono
            = restartWithResponseAsync(resourceGroupName, azureLargeInstanceName, body, context);
        return this.client.<OperationStatusResultInner, OperationStatusResultInner>getLroResult(mono,
    ...
    public SyncPoller<PollResult<OperationStatusResultInner>, OperationStatusResultInner>
        beginRestart(String resourceGroupName, String azureLargeInstanceName, ForceState body) {
        return this.beginRestartAsync(resourceGroupName, azureLargeInstanceName, body).getSyncPoller();
    }
    ...
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<OperationStatusResultInner>, OperationStatusResultInner>
        beginRestart(String resourceGroupName, String azureLargeInstanceName, ForceState body, Context context) {
        return this.beginRestartAsync(resourceGroupName, azureLargeInstanceName, body, context).getSyncPoller();
    }
    ...
    private Mono<OperationStatusResultInner> restartAsync(String resourceGroupName, String azureLargeInstanceName,
        ForceState body) {
        return beginRestartAsync(resourceGroupName, azureLargeInstanceName, body).last()
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<OperationStatusResultInner> restartAsync(String resourceGroupName, String azureLargeInstanceName,
        ForceState body, Context context) {
        return beginRestartAsync(resourceGroupName, azureLargeInstanceName, body, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    public OperationStatusResultInner restart(String resourceGroupName, String azureLargeInstanceName,
        ForceState body) {
        return restartAsync(resourceGroupName, azureLargeInstanceName, body).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public OperationStatusResultInner restart(String resourceGroupName, String azureLargeInstanceName, ForceState body,
        Context context) {
        return restartAsync(resourceGroupName, azureLargeInstanceName, body, context).block();
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> shutdownWithResponseAsync(String resourceGroupName,
        String azureLargeInstanceName, Object body) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> shutdownWithResponseAsync(String resourceGroupName,
        String azureLargeInstanceName, Object body, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<OperationStatusResultInner>, OperationStatusResultInner>
        beginShutdownAsync(String resourceGroupName, String azureLargeInstanceName, Object body) {
        Mono<Response<Flux<ByteBuffer>>> mono
            = shutdownWithResponseAsync(resourceGroupName, azureLargeInstanceName, body);
        return this.client.<OperationStatusResultInner, OperationStatusResultInner>getLroResult(mono,
            this.client.getHttpPipeline(), OperationStatusResultInner.class, OperationStatusResultInner.class,
            this.client.getContext());
    }
    ...
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<OperationStatusResultInner>, OperationStatusResultInner>
        beginShutdownAsync(String resourceGroupName, String azureLargeInstanceName, Object body, Context context) {
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono
            = shutdownWithResponseAsync(resourceGroupName, azureLargeInstanceName, body, context);
        return this.client.<OperationStatusResultInner, OperationStatusResultInner>getLroResult(mono,
            this.client.getHttpPipeline(), OperationStatusResultInner.class, OperationStatusResultInner.class, context);
    }
    ...
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<OperationStatusResultInner>, OperationStatusResultInner>
        beginShutdown(String resourceGroupName, String azureLargeInstanceName, Object body) {
        return this.beginShutdownAsync(resourceGroupName, azureLargeInstanceName, body).getSyncPoller();
    }
    ...
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<OperationStatusResultInner>, OperationStatusResultInner>
        beginShutdown(String resourceGroupName, String azureLargeInstanceName, Object body, Context context) {
        return this.beginShutdownAsync(resourceGroupName, azureLargeInstanceName, body, context).getSyncPoller();
    }
    ...
    private Mono<OperationStatusResultInner> shutdownAsync(String resourceGroupName, String azureLargeInstanceName,
        Object body) {
        return beginShutdownAsync(resourceGroupName, azureLargeInstanceName, body).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<OperationStatusResultInner> shutdownAsync(String resourceGroupName, String azureLargeInstanceName,
        ...
        return beginShutdownAsync(resourceGroupName, azureLargeInstanceName, body, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public OperationStatusResultInner shutdown(String resourceGroupName, String azureLargeInstanceName, Object body) {
        return shutdownAsync(resourceGroupName, azureLargeInstanceName, body).block();
    }
    ...
    public OperationStatusResultInner shutdown(String resourceGroupName, String azureLargeInstanceName, Object body,
        Context context) {
        return shutdownAsync(resourceGroupName, azureLargeInstanceName, body, context).block();
    }
    ...
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<OperationStatusResultInner>, OperationStatusResultInner>
        beginStartAsync(String resourceGroupName, String azureLargeInstanceName, Object body) {
        Mono<Response<Flux<ByteBuffer>>> mono = startWithResponseAsync(resourceGroupName, azureLargeInstanceName, body);
        return this.client.<OperationStatusResultInner, OperationStatusResultInner>getLroResult(mono,
            this.client.getHttpPipeline(), OperationStatusResultInner.class, OperationStatusResultInner.class,
            this.client.getContext());
    }
    ...
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<OperationStatusResultInner>, OperationStatusResultInner>
        beginStartAsync(String resourceGroupName, String azureLargeInstanceName, Object body, Context context) {
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono
            = startWithResponseAsync(resourceGroupName, azureLargeInstanceName, body, context);
        return this.client.<OperationStatusResultInner, OperationStatusResultInner>getLroResult(mono,
            this.client.getHttpPipeline(), OperationStatusResultInner.class, OperationStatusResultInner.class, context);
    }
    ...
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<OperationStatusResultInner>, OperationStatusResultInner>
        beginStart(String resourceGroupName, String azureLargeInstanceName, Object body) {
        return this.beginStartAsync(resourceGroupName, azureLargeInstanceName, body).getSyncPoller();
    }
    ...
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<OperationStatusResultInner>, OperationStatusResultInner>
        beginStart(String resourceGroupName, String azureLargeInstanceName, Object body, Context context) {
        return this.beginStartAsync(resourceGroupName, azureLargeInstanceName, body, context).getSyncPoller();
    }
    ...
    private Mono<OperationStatusResultInner> startAsync(String resourceGroupName, String azureLargeInstanceName,
        Object body) {
        return beginStartAsync(resourceGroupName, azureLargeInstanceName, body).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<OperationStatusResultInner> startAsync(String resourceGroupName, String azureLargeInstanceName,
        Object body, Context context) {
        return beginStartAsync(resourceGroupName, azureLargeInstanceName, body, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public OperationStatusResultInner start(String resourceGroupName, String azureLargeInstanceName, Object body) {
        return startAsync(resourceGroupName, azureLargeInstanceName, body).block();
    }
    ...
    public OperationStatusResultInner start(String resourceGroupName, String azureLargeInstanceName, Object body,
        Context context) {
        return startAsync(resourceGroupName, azureLargeInstanceName, body, context).block();
    }
