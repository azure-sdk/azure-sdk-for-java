...
public final class AzureLargeInstancesClientImpl implements AzureLargeInstancesClient {
    ...
    public interface AzureLargeInstancesService {
        ...
        @Headers({ "Content-Type: application/json" })
        @Put("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AzureLargeInstance/azureLargeInstances/{azureLargeInstanceName}")
        @ExpectedResponses({ 200, 201 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<AzureLargeInstanceInner>> create(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("azureLargeInstanceName") String azureLargeInstanceName,
            @BodyParam("application/json") AzureLargeInstanceInner azurelargeinstanceproperties,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @Headers({ "Content-Type: application/json" })
        @Delete("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AzureLargeInstance/azureLargeInstances/{azureLargeInstanceName}")
    ...
    /**
     * Create a Azure Large Instance.
     * 
     * Create an Azure Large Instance Resource allowing you to see the provisioned resource.
     * 
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
     * @param azureLargeInstanceName Name of the AzureLargeInstance.
     * @param azurelargeinstanceproperties Request body that contains the azure large instance.
     * @throws IllegalArgumentException thrown if parameters fail the validation.
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<AzureLargeInstanceInner>> createWithResponseAsync(String resourceGroupName,
        String azureLargeInstanceName, AzureLargeInstanceInner azurelargeinstanceproperties) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        if (azurelargeinstanceproperties == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter azurelargeinstanceproperties is required and cannot be null."));
        } else {
            azurelargeinstanceproperties.validate();
        }
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.create(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, azureLargeInstanceName,
                azurelargeinstanceproperties, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<AzureLargeInstanceInner>> createWithResponseAsync(String resourceGroupName,
        String azureLargeInstanceName, AzureLargeInstanceInner azurelargeinstanceproperties, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service.create(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, azureLargeInstanceName, azurelargeinstanceproperties, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<AzureLargeInstanceInner> createAsync(String resourceGroupName, String azureLargeInstanceName,
        AzureLargeInstanceInner azurelargeinstanceproperties) {
        return createWithResponseAsync(resourceGroupName, azureLargeInstanceName, azurelargeinstanceproperties)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<AzureLargeInstanceInner> createWithResponse(String resourceGroupName, String azureLargeInstanceName,
        AzureLargeInstanceInner azurelargeinstanceproperties, Context context) {
        return createWithResponseAsync(resourceGroupName, azureLargeInstanceName, azurelargeinstanceproperties, context)
            .block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public AzureLargeInstanceInner create(String resourceGroupName, String azureLargeInstanceName,
        AzureLargeInstanceInner azurelargeinstanceproperties) {
        return createWithResponse(resourceGroupName, azureLargeInstanceName, azurelargeinstanceproperties, Context.NONE)
            .getValue();
    }
     ...
     * 
     * Delete the azure large instance after physical decomission is completed.
     * 
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
     * @param azureLargeInstanceName Name of the AzureLargeInstance.
     * @throws IllegalArgumentException thrown if parameters fail the validation.
    ...
    private PollerFlux<PollResult<Void>, Void> beginDeleteAsync(String resourceGroupName,
        String azureLargeInstanceName) {
        Mono<Response<Flux<ByteBuffer>>> mono = deleteWithResponseAsync(resourceGroupName, azureLargeInstanceName);
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<Void>, Void> beginDeleteAsync(String resourceGroupName, String azureLargeInstanceName,
        Context context) {
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono
            = deleteWithResponseAsync(resourceGroupName, azureLargeInstanceName, context);
        return this.client.<Void, Void>getLroResult(mono, this.client.getHttpPipeline(), Void.class, Void.class,
            context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String azureLargeInstanceName) {
        return this.beginDeleteAsync(resourceGroupName, azureLargeInstanceName).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String azureLargeInstanceName,
        Context context) {
        return this.beginDeleteAsync(resourceGroupName, azureLargeInstanceName, context).getSyncPoller();
    }
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String azureLargeInstanceName) {
        return beginDeleteAsync(resourceGroupName, azureLargeInstanceName).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> deleteAsync(String resourceGroupName, String azureLargeInstanceName, Context context) {
        return beginDeleteAsync(resourceGroupName, azureLargeInstanceName, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    public void delete(String resourceGroupName, String azureLargeInstanceName) {
        deleteAsync(resourceGroupName, azureLargeInstanceName).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public void delete(String resourceGroupName, String azureLargeInstanceName, Context context) {
        deleteAsync(resourceGroupName, azureLargeInstanceName, context).block();
    }
