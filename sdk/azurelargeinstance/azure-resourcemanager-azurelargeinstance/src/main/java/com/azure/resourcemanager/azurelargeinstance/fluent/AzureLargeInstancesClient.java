...
public interface AzureLargeInstancesClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    OperationStatusResultInner restart(String resourceGroupName, String azureLargeInstanceName, ForceState body);
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<OperationStatusResultInner>, OperationStatusResultInner> beginShutdown(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    OperationStatusResultInner start(String resourceGroupName, String azureLargeInstanceName, Map<String, Object> body);
