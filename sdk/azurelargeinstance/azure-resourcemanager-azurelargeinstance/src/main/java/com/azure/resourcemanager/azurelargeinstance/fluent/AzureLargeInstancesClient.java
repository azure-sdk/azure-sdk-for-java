...
public interface AzureLargeInstancesClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    OperationStatusResultInner restart(String resourceGroupName, String azureLargeInstanceName, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<AzureLargeInstanceInner> getByResourceGroupWithResponse(
        String resourceGroupName, String azureLargeInstanceName, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<AzureLargeInstanceInner> putWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    AzureLargeInstanceInner put(String resourceGroupName, String azureLargeInstanceName);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<AzureLargeInstanceInner> updateWithResponse(
