...
package com.azure.resourcemanager.azurelargeinstance.fluent;
...
public interface AzureLargeInstancesClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<AzureLargeInstanceInner> createWithResponse(String resourceGroupName, String azureLargeInstanceName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    AzureLargeInstanceInner create(String resourceGroupName, String azureLargeInstanceName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    AzureLargeInstanceInner update(String resourceGroupName, String azureLargeInstanceName, Tags tagsParameter);
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String azureLargeInstanceName);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    void delete(String resourceGroupName, String azureLargeInstanceName);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    void delete(String resourceGroupName, String azureLargeInstanceName, Context context);
}
