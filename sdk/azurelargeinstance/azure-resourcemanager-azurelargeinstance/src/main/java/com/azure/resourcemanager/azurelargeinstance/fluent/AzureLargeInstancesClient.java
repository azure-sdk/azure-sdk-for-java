...
public interface AzureLargeInstancesClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    OperationStatusResultInner shutdown(String resourceGroupName, String azureLargeInstanceName, Object body);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    OperationStatusResultInner start(String resourceGroupName, String azureLargeInstanceName, Object body);
