...
public final class AzureLargeInstancesImpl implements AzureLargeInstances {
    ...
    public OperationStatusResult restart(String resourceGroupName, String azureLargeInstanceName, ForceState body) {
        OperationStatusResultInner inner
            = this.serviceClient().restart(resourceGroupName, azureLargeInstanceName, body);
        if (inner != null) {
    ...
    public OperationStatusResult restart(String resourceGroupName, String azureLargeInstanceName, ForceState body,
        Context context) {
        OperationStatusResultInner inner
            = this.serviceClient().restart(resourceGroupName, azureLargeInstanceName, body, context);
        if (inner != null) {
            return new OperationStatusResultImpl(inner, this.manager());
        } else {
            return null;
    ...
    public OperationStatusResult shutdown(String resourceGroupName, String azureLargeInstanceName, Object body) {
        OperationStatusResultInner inner
            = this.serviceClient().shutdown(resourceGroupName, azureLargeInstanceName, body);
        if (inner != null) {
            return new OperationStatusResultImpl(inner, this.manager());
        } else {
            return null;
    ...
    public OperationStatusResult shutdown(String resourceGroupName, String azureLargeInstanceName, Object body,
        Context context) {
        OperationStatusResultInner inner
            = this.serviceClient().shutdown(resourceGroupName, azureLargeInstanceName, body, context);
        if (inner != null) {
            return new OperationStatusResultImpl(inner, this.manager());
        } else {
            return null;
    ...
    public OperationStatusResult start(String resourceGroupName, String azureLargeInstanceName, Object body) {
        OperationStatusResultInner inner = this.serviceClient().start(resourceGroupName, azureLargeInstanceName, body);
        if (inner != null) {
            return new OperationStatusResultImpl(inner, this.manager());
        } else {
            return null;
    ...
    public OperationStatusResult start(String resourceGroupName, String azureLargeInstanceName, Object body,
        Context context) {
        OperationStatusResultInner inner
            = this.serviceClient().start(resourceGroupName, azureLargeInstanceName, body, context);
        if (inner != null) {
            return new OperationStatusResultImpl(inner, this.manager());
        } else {
            return null;
