...
public final class AzureLargeInstancesImpl implements AzureLargeInstances {
    ...
    public OperationStatusResult restart(String resourceGroupName, String azureLargeInstanceName, Context context) {
        OperationStatusResultInner inner =
            this.serviceClient().restart(resourceGroupName, azureLargeInstanceName, context);
        if (inner != null) {
            return new OperationStatusResultImpl(inner, this.manager());
        } else {
            return null;
    ...
    public Response<Void> deleteByResourceGroupWithResponse(
        String resourceGroupName, String azureLargeInstanceName, Context context) {
        return this.serviceClient().deleteWithResponse(resourceGroupName, azureLargeInstanceName, context);
    }

    public void deleteByResourceGroup(String resourceGroupName, String azureLargeInstanceName) {
        this.serviceClient().delete(resourceGroupName, azureLargeInstanceName);
    }

    public AzureLargeInstance getById(String id) {
        ...
        String azureLargeInstanceName = Utils.getValueFromIdByName(id, "azureLargeInstance");
            ...
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException(
                        String
                            .format(
                                "The resource ID '%s' is not valid. Missing path segment 'azureLargeInstance'.", id)));
        }
        return this.getByResourceGroupWithResponse(resourceGroupName, azureLargeInstanceName, Context.NONE).getValue();
    }

    public Response<AzureLargeInstance> getByIdWithResponse(String id, Context context) {
        String resourceGroupName = Utils.getValueFromIdByName(id, "resourceGroups");
        if (resourceGroupName == null) {
            throw LOGGER
                .logExceptionAsError(
        ...
        return this.getByResourceGroupWithResponse(resourceGroupName, azureLargeInstanceName, context);
    }
    ...
    public void deleteById(String id) {
        ...
        this.deleteByResourceGroupWithResponse(resourceGroupName, azureLargeInstanceName, Context.NONE);
    }
    ...
    public Response<Void> deleteByIdWithResponse(String id, Context context) {
        ...
        return this.deleteByResourceGroupWithResponse(resourceGroupName, azureLargeInstanceName, context);
    }
    ...
    public AzureLargeInstanceImpl define(String name) {
        return new AzureLargeInstanceImpl(name, this.manager());
    }
}
