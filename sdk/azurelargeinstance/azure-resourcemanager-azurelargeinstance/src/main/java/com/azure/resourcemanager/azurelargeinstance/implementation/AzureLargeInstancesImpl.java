...
public final class AzureLargeInstancesImpl implements AzureLargeInstances {
    ...
    public Response<Void> deleteByResourceGroupWithResponse(String resourceGroupName, String azureLargeInstanceName,
        Context context) {
    ...
    public AzureLargeInstance getById(String id) {
        ...
        String azureLargeInstanceName = Utils.getValueFromIdByName(id, "azureLargeInstances");
        if (azureLargeInstanceName == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
                String.format("The resource ID '%s' is not valid. Missing path segment 'azureLargeInstances'.", id)));
        }
