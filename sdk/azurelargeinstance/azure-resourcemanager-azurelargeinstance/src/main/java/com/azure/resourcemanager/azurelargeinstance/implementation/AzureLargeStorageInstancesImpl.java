...
public final class AzureLargeStorageInstancesImpl implements AzureLargeStorageInstances {
    ...
    public AzureLargeStorageInstance getById(String id) {
        ...
        String azureLargeStorageInstanceName = Utils.getValueFromIdByName(id, "azureLargeStorageInstance");
            ...
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException(
                        String
                            .format(
                                "The resource ID '%s' is not valid. Missing path segment 'azureLargeStorageInstance'.",
                                id)));
        }
        return this
