...
public final class AzureLargeInstanceUpdateSamples {
    ...
    public static void updateTagsFieldOfAnAzureLargeInstance(com.azure.resourcemanager.azurelargeinstance.AzureLargeInstanceManager manager) {
        manager.azureLargeInstances().updateWithResponse("myResourceGroup", "myALInstance", new Tags().withTags(mapOf("testkey", "fakeTokenPlaceholder")), com.azure.core.util.Context.NONE);
    }
    ...
    public static void deleteTagsFieldOfAnAzureLargeInstance(com.azure.resourcemanager.azurelargeinstance.AzureLargeInstanceManager manager) {
        manager.azureLargeInstances().updateWithResponse("myResourceGroup", "myALInstance", new Tags().withTags(mapOf()), com.azure.core.util.Context.NONE);
    }
