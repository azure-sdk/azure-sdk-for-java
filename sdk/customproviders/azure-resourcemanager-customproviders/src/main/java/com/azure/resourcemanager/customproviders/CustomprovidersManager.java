...
/**
 * Entry point to CustomprovidersManager.
...
public final class CustomprovidersManager {
    ...
    private CustomprovidersManager(HttpPipeline httpPipeline, AzureProfile profile, Duration defaultPollInterval) {
        ...
        this.clientObject = new CustomprovidersBuilder().pipeline(httpPipeline)
     ...
     * @return the Customproviders service API instance.
     */
    public static CustomprovidersManager authenticate(HttpPipeline httpPipeline, AzureProfile profile) {
        Objects.requireNonNull(httpPipeline, "'httpPipeline' cannot be null.");
        Objects.requireNonNull(profile, "'profile' cannot be null.");
        return new CustomprovidersManager(httpPipeline, profile, null);
    }
    ...
    public static final class Configurable {
        ...
        private static final Map<String, String> PROPERTIES
            = CoreUtils.getProperties("azure-resourcemanager-customproviders.properties");
    ...
    /**
     * Gets the resource collection API of CustomResourceProviders. It manages CustomRPManifest.
     * 
    ...
    /**
     * Gets the resource collection API of Associations. It manages Association.
     * 
    ...
    /**
     * Gets wrapped service client Customproviders providing direct access to the underlying auto-generated API
     * implementation, based on Azure REST API.
     * 
     * @return Wrapped service client Customproviders.
     */
