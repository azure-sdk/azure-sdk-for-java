...
public final class CustomRPManifestImpl
    ...
    CustomRPManifestImpl(CustomRPManifestInner innerObject,
        com.azure.resourcemanager.customproviders.CustomprovidersManager serviceManager) {
        this.innerObject = innerObject;
        this.serviceManager = serviceManager;
        this.resourceGroupName = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "resourceGroups");
        this.resourceProviderName = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "resourceProviders");
    }
