...
import com.azure.resourcemanager.customproviders.models.ResourceProviderOperationList;
...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    OperationsClientImpl(CustomprovidersImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for CustomprovidersOperations to be used by the proxy service to perform
     * REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "CustomprovidersOpera")
    public interface OperationsService {
        @Headers({ "Content-Type: application/json" })
        @Get("/providers/Microsoft.CustomProviders/operations")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ResourceProviderOperationList>> list(@HostParam("$host") String endpoint,
