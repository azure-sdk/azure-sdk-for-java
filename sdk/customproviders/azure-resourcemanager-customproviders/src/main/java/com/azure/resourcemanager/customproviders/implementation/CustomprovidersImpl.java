...
public final class CustomprovidersImpl implements Customproviders {
     ...
     */
    CustomprovidersImpl(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter, Duration defaultPollInterval,
    ...
    private static final ClientLogger LOGGER = new ClientLogger(CustomprovidersImpl.class);
}
