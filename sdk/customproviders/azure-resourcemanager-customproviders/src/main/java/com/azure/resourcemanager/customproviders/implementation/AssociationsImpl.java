...
public final class AssociationsImpl implements Associations {
    ...
    public AssociationsImpl(AssociationsClient innerClient,
    ...
    public Association getById(String id) {
        String scope = ResourceManagerUtils.getValueFromIdByParameterName(id,
            "/{scope}/providers/Microsoft.CustomProviders/associations/{associationName}", "scope");
        if (scope == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
                String.format("The resource ID '%s' is not valid. Missing path segment 'scope'.", id)));
        }
        String associationName = ResourceManagerUtils.getValueFromIdByParameterName(id,
            "/{scope}/providers/Microsoft.CustomProviders/associations/{associationName}", "associationName");
