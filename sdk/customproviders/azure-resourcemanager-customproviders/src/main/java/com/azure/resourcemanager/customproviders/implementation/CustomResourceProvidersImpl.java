...
public final class CustomResourceProvidersImpl implements CustomResourceProviders {
    ...
    public CustomResourceProvidersImpl(CustomResourceProvidersClient innerClient,
    ...
    public Response<CustomRPManifest> getByResourceGroupWithResponse(String resourceGroupName,
    ...
    public PagedIterable<CustomRPManifest> listByResourceGroup(String resourceGroupName) {
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new CustomRPManifestImpl(inner1, this.manager()));
    }
    ...
    public CustomRPManifest getById(String id) {
        ...
        String resourceProviderName = ResourceManagerUtils.getValueFromIdByName(id, "resourceProviders");
