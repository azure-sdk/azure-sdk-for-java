...
public final class CustomResourceProvidersClientImpl implements CustomResourceProvidersClient {
    ...
    CustomResourceProvidersClientImpl(CustomprovidersImpl client) {
        this.service = RestProxy.create(CustomResourceProvidersService.class, client.getHttpPipeline(),
    ...
    public interface CustomResourceProvidersService {
        ...
        Mono<Response<Flux<ByteBuffer>>> createOrUpdate(@HostParam("$host") String endpoint,
            ...
            @BodyParam("application/json") CustomRPManifestInner resourceProvider, @HeaderParam("Accept") String accept,
            Context context);
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<CustomRPManifestInner>> getByResourceGroup(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("resourceProviderName") String resourceProviderName,
            @QueryParam("api-version") String apiVersion, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<CustomRPManifestInner>> update(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("resourceProviderName") String resourceProviderName,
            @QueryParam("api-version") String apiVersion,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ListByCustomRPManifest>> listByResourceGroup(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ListByCustomRPManifest>> list(@HostParam("$host") String endpoint,
    ...
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String resourceGroupName,
        String resourceProviderName, CustomRPManifestInner resourceProvider) {
        ...
        return FluxUtil
            .withContext(context -> service.createOrUpdate(this.client.getEndpoint(), this.client.getSubscriptionId(),
                resourceGroupName, resourceProviderName, this.client.getApiVersion(), resourceProvider, accept,
                context))
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String resourceGroupName,
        String resourceProviderName, CustomRPManifestInner resourceProvider, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service.createOrUpdate(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            resourceProviderName, this.client.getApiVersion(), resourceProvider, accept, context);
    }
    ...
    private PollerFlux<PollResult<CustomRPManifestInner>, CustomRPManifestInner> beginCreateOrUpdateAsync(
        ...
        return this.client.<CustomRPManifestInner, CustomRPManifestInner>getLroResult(mono,
            this.client.getHttpPipeline(), CustomRPManifestInner.class, CustomRPManifestInner.class,
    ...
    private PollerFlux<PollResult<CustomRPManifestInner>, CustomRPManifestInner> beginCreateOrUpdateAsync(
        ...
        return this.client.<CustomRPManifestInner, CustomRPManifestInner>getLroResult(mono,
            this.client.getHttpPipeline(), CustomRPManifestInner.class, CustomRPManifestInner.class, context);
    }
    ...
    public SyncPoller<PollResult<CustomRPManifestInner>, CustomRPManifestInner> beginCreateOrUpdate(
        String resourceGroupName, String resourceProviderName, CustomRPManifestInner resourceProvider) {
        return this.beginCreateOrUpdateAsync(resourceGroupName, resourceProviderName, resourceProvider).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<CustomRPManifestInner>, CustomRPManifestInner> beginCreateOrUpdate(
        String resourceGroupName, String resourceProviderName, CustomRPManifestInner resourceProvider,
        Context context) {
        return this.beginCreateOrUpdateAsync(resourceGroupName, resourceProviderName, resourceProvider, context)
            .getSyncPoller();
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a manifest file that defines the custom resource provider resources on successful completion of
     * {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<CustomRPManifestInner> createOrUpdateAsync(String resourceGroupName, String resourceProviderName,
        CustomRPManifestInner resourceProvider) {
        return beginCreateOrUpdateAsync(resourceGroupName, resourceProviderName, resourceProvider).last()
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<CustomRPManifestInner> createOrUpdateAsync(String resourceGroupName, String resourceProviderName,
        CustomRPManifestInner resourceProvider, Context context) {
        return beginCreateOrUpdateAsync(resourceGroupName, resourceProviderName, resourceProvider, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public CustomRPManifestInner createOrUpdate(String resourceGroupName, String resourceProviderName,
        CustomRPManifestInner resourceProvider) {
    ...
    private Mono<Response<Flux<ByteBuffer>>> deleteWithResponseAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(context -> service.delete(this.client.getEndpoint(), this.client.getSubscriptionId(),
                resourceGroupName, resourceProviderName, this.client.getApiVersion(), accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String resourceProviderName) {
        return this.beginDeleteAsync(resourceGroupName, resourceProviderName).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String resourceProviderName,
        Context context) {
        return this.beginDeleteAsync(resourceGroupName, resourceProviderName, context).getSyncPoller();
    }
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String resourceProviderName) {
        return beginDeleteAsync(resourceGroupName, resourceProviderName).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String resourceProviderName, Context context) {
        return beginDeleteAsync(resourceGroupName, resourceProviderName, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the custom resource provider manifest along with {@link Response} on successful completion of
     * {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<CustomRPManifestInner>> getByResourceGroupWithResponseAsync(String resourceGroupName,
        String resourceProviderName) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<CustomRPManifestInner> getByResourceGroupWithResponse(String resourceGroupName,
        String resourceProviderName, Context context) {
    ...
    public CustomRPManifestInner getByResourceGroup(String resourceGroupName, String resourceProviderName) {
        return getByResourceGroupWithResponse(resourceGroupName, resourceProviderName, Context.NONE).getValue();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<CustomRPManifestInner>> updateWithResponseAsync(String resourceGroupName,
        String resourceProviderName, ResourceProvidersUpdate patchableResource) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return FluxUtil
            .withContext(
                context -> service.update(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
                    resourceProviderName, this.client.getApiVersion(), patchableResource, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<CustomRPManifestInner>> updateWithResponseAsync(String resourceGroupName,
        String resourceProviderName, ResourceProvidersUpdate patchableResource, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<CustomRPManifestInner> updateAsync(String resourceGroupName, String resourceProviderName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<CustomRPManifestInner> updateWithResponse(String resourceGroupName, String resourceProviderName,
        ResourceProvidersUpdate patchableResource, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public CustomRPManifestInner update(String resourceGroupName, String resourceProviderName,
        ResourceProvidersUpdate patchableResource) {
        return updateWithResponse(resourceGroupName, resourceProviderName, patchableResource, Context.NONE).getValue();
    }
    ...
    private Mono<PagedResponse<CustomRPManifestInner>> listByResourceGroupSinglePageAsync(String resourceGroupName) {
        ...
        return FluxUtil
            ...
            .<PagedResponse<CustomRPManifestInner>>map(res -> new PagedResponseBase<>(res.getRequest(),
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return all the custom resource providers within a resource group as paginated response with
     * {@link PagedIterable}.
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return list of custom resource providers along with {@link PagedResponse} on successful completion of
     * {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
