...
public final class AssociationsClientImpl implements AssociationsClient {
    ...
    public interface AssociationsService {
        ...
        Mono<Response<Flux<ByteBuffer>>> createOrUpdate(@HostParam("$host") String endpoint,
            ...
            @BodyParam("application/json") AssociationInner association, @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<AssociationsList>> listAll(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<AssociationsList>> listAllNext(@PathParam(value = "nextLink", encoded = true) String nextLink,
    ...
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String scope, String associationName,
        AssociationInner association) {
        ...
        return FluxUtil
            .withContext(context -> service.createOrUpdate(this.client.getEndpoint(), scope, associationName,
                this.client.getApiVersion(), association, accept, context))
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String scope, String associationName,
        AssociationInner association, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service.createOrUpdate(this.client.getEndpoint(), scope, associationName, this.client.getApiVersion(),
            association, accept, context);
    }
    ...
    private PollerFlux<PollResult<AssociationInner>, AssociationInner> beginCreateOrUpdateAsync(String scope,
        String associationName, AssociationInner association) {
    ...
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<AssociationInner>, AssociationInner> beginCreateOrUpdateAsync(String scope,
        String associationName, AssociationInner association, Context context) {
        context = this.client.mergeContext(context);
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<AssociationInner>, AssociationInner> beginCreateOrUpdate(String scope,
        String associationName, AssociationInner association) {
        return this.beginCreateOrUpdateAsync(scope, associationName, association).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<AssociationInner>, AssociationInner> beginCreateOrUpdate(String scope,
        String associationName, AssociationInner association, Context context) {
        return this.beginCreateOrUpdateAsync(scope, associationName, association, context).getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<AssociationInner> createOrUpdateAsync(String scope, String associationName,
        AssociationInner association) {
        return beginCreateOrUpdateAsync(scope, associationName, association).last()
    ...
    private Mono<AssociationInner> createOrUpdateAsync(String scope, String associationName,
        AssociationInner association, Context context) {
        return beginCreateOrUpdateAsync(scope, associationName, association, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> deleteWithResponseAsync(String scope, String associationName) {
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.delete(this.client.getEndpoint(), scope, associationName,
    ...
    private Mono<Response<Flux<ByteBuffer>>> deleteWithResponseAsync(String scope, String associationName,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.delete(this.client.getEndpoint(), scope, associationName, this.client.getApiVersion(), accept,
            context);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String scope, String associationName) {
        return this.beginDeleteAsync(scope, associationName).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String scope, String associationName, Context context) {
        return this.beginDeleteAsync(scope, associationName, context).getSyncPoller();
    }
    ...
    private Mono<Response<AssociationInner>> getWithResponseAsync(String scope, String associationName) {
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.get(this.client.getEndpoint(), scope, associationName,
                this.client.getApiVersion(), accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<AssociationInner>> getWithResponseAsync(String scope, String associationName,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.get(this.client.getEndpoint(), scope, associationName, this.client.getApiVersion(), accept,
            context);
    }
    ...
    public AssociationInner get(String scope, String associationName) {
        return getWithResponse(scope, associationName, Context.NONE).getValue();
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return all association for the given scope along with {@link PagedResponse} on successful completion of
     * {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<AssociationInner>> listAllSinglePageAsync(String scope) {
        ...
        return FluxUtil.withContext(
            context -> service.listAll(this.client.getEndpoint(), scope, this.client.getApiVersion(), accept, context))
    ...
    private Mono<PagedResponse<AssociationInner>> listAllSinglePageAsync(String scope, Context context) {
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.listAll(this.client.getEndpoint(), scope, this.client.getApiVersion(), accept, context)
