...
public interface CustomResourceProvidersClient {
    ...
    SyncPoller<PollResult<CustomRPManifestInner>, CustomRPManifestInner> beginCreateOrUpdate(String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<CustomRPManifestInner> getByResourceGroupWithResponse(String resourceGroupName,
