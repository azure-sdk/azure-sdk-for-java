...
public final class GiVersionsListByLocationMockTests {
    ...
    public void testListByLocation() throws Exception {
        String responseStr
            = "{\"value\":[{\"properties\":{\"version\":\"zinkfkbgbzbowxeq\"},\"id\":\"ljmygvkzqkjjeokb\",\"name\":\"efezrxcczurtlei\",\"type\":\"q\"}]}";
        ...
        PagedIterable<GiVersion> response = manager.giVersions()
            .listByLocation("mcmuapc", SystemShapes.EXA_DB_XS, "dbevwqqxeysko", com.azure.core.util.Context.NONE);

        Assertions.assertEquals("zinkfkbgbzbowxeq", response.iterator().next().properties().version());
    }
}
