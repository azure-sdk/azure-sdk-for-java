...
import oracle.database.implementation.models.DbServerListResult;
...
public final class DbServersClientImpl implements DbServersClient {
     ...
     */
    DbServersClientImpl(DatabaseClientImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for DatabaseClientDbServers to be used by the proxy service to perform
     * REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "DatabaseClientDbServ")
