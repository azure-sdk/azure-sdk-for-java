...
import oracle.database.implementation.models.DnsPrivateViewListResult;
...
public final class DnsPrivateViewsClientImpl implements DnsPrivateViewsClient {
     ...
     */
    DnsPrivateViewsClientImpl(DatabaseClientImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for DatabaseClientDnsPrivateViews to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "DatabaseClientDnsPri")
    public interface DnsPrivateViewsService {
        ...
        Mono<Response<DnsPrivateViewInner>> get(@HostParam("endpoint") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<DnsPrivateViewListResult>> listByLocation(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
