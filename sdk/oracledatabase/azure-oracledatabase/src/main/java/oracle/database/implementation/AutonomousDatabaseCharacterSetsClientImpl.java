...
public final class AutonomousDatabaseCharacterSetsClientImpl implements AutonomousDatabaseCharacterSetsClient {
     ...
     */
    AutonomousDatabaseCharacterSetsClientImpl(DatabaseClientImpl client) {
    ...
    /**
     * The interface defining all the services for DatabaseClientAutonomousDatabaseCharacterSets to be used by the proxy
