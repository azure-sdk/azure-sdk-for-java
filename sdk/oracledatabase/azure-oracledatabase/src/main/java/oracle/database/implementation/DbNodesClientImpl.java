...
import oracle.database.implementation.models.DbNodeListResult;
...
public final class DbNodesClientImpl implements DbNodesClient {
     ...
     */
    DbNodesClientImpl(DatabaseClientImpl client) {
        this.service = RestProxy.create(DbNodesService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for DatabaseClientDbNodes to be used by the proxy service to perform REST
     * calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "DatabaseClientDbNode")
    public interface DbNodesService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<DbNodeListResult>> listByParent(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
    ...
    private Mono<Response<Flux<ByteBuffer>>> actionWithResponseAsync(String resourceGroupName,
        ...
        return service.action(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, cloudvmclustername, dbnodeocid, contentType, accept, body, context);
    }
