...
import oracle.database.implementation.models.GiMinorVersionListResult;
...
public final class GiMinorVersionsClientImpl implements GiMinorVersionsClient {
     ...
     */
    GiMinorVersionsClientImpl(DatabaseClientImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for DatabaseClientGiMinorVersions to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "DatabaseClientGiMino")
