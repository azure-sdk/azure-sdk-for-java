...
public final class DnsPrivateZonesClientImpl implements DnsPrivateZonesClient {
     ...
     */
    DnsPrivateZonesClientImpl(DatabaseClientImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for DatabaseClientDnsPrivateZones to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{endpoint}")
