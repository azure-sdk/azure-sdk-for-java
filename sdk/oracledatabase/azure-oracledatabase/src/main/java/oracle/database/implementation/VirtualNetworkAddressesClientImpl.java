...
import oracle.database.implementation.models.VirtualNetworkAddressListResult;
...
public final class VirtualNetworkAddressesClientImpl implements VirtualNetworkAddressesClient {
     ...
     */
    VirtualNetworkAddressesClientImpl(DatabaseClientImpl client) {
    ...
    /**
     * The interface defining all the services for DatabaseClientVirtualNetworkAddresses to be used by the proxy service
     * to perform REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "DatabaseClientVirtua")
    public interface VirtualNetworkAddressesService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<VirtualNetworkAddressListResult>> listByParent(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
