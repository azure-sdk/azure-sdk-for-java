...
public final class CloudExadataInfrastructureProperties
     ...
     */
    private List<DefinedFileSystemConfiguration> definedFileSystemConfiguration;
    ...
    /**
     * Get the definedFileSystemConfiguration property: Defined file system configurations.
     * 
     * @return the definedFileSystemConfiguration value.
     */
    public List<DefinedFileSystemConfiguration> definedFileSystemConfiguration() {
    ...
    /**
     * Get the databaseServerType property: The database server model type of the cloud Exadata infrastructure resource.
     * 
     * @return the databaseServerType value.
     */
    ...
    /**
     * Set the databaseServerType property: The database server model type of the cloud Exadata infrastructure resource.
     * 
     * @param databaseServerType the databaseServerType value to set.
     * @return the CloudExadataInfrastructureProperties object itself.
     */
    public CloudExadataInfrastructureProperties withDatabaseServerType(String databaseServerType) {
        this.databaseServerType = databaseServerType;
        return this;
    }

    /**
     * Get the storageServerType property: The storage server model type of the cloud Exadata infrastructure resource.
     * 
     * @return the storageServerType value.
     */
    ...
    /**
     * Set the storageServerType property: The storage server model type of the cloud Exadata infrastructure resource.
     * 
     * @param storageServerType the storageServerType value to set.
     * @return the CloudExadataInfrastructureProperties object itself.
     */
    public CloudExadataInfrastructureProperties withStorageServerType(String storageServerType) {
    ...
    public static CloudExadataInfrastructureProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                } else if ("definedFileSystemConfiguration".equals(fieldName)) {
                    List<DefinedFileSystemConfiguration> definedFileSystemConfiguration
                        = reader.readArray(reader1 -> DefinedFileSystemConfiguration.fromJson(reader1));
                    deserializedCloudExadataInfrastructureProperties.definedFileSystemConfiguration
                ...
                } else if ("databaseServerType".equals(fieldName)) {
                    deserializedCloudExadataInfrastructureProperties.databaseServerType = reader.getString();
                } else if ("storageServerType".equals(fieldName)) {
                    deserializedCloudExadataInfrastructureProperties.storageServerType = reader.getString();
