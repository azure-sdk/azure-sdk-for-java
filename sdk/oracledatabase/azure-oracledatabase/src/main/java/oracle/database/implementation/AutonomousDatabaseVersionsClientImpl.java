...
public final class AutonomousDatabaseVersionsClientImpl implements AutonomousDatabaseVersionsClient {
     ...
     */
    AutonomousDatabaseVersionsClientImpl(DatabaseClientImpl client) {
    ...
    /**
     * The interface defining all the services for DatabaseClientAutonomousDatabaseVersions to be used by the proxy
