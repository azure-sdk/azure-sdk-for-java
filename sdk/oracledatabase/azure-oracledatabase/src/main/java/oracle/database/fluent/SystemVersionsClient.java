...
package oracle.database.fluent;
...
public interface SystemVersionsClient {
    ...
    Response<SystemVersionInner> getWithResponse(String location, String systemversionname, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<SystemVersionInner> listByLocation(String location, Context context);
}
