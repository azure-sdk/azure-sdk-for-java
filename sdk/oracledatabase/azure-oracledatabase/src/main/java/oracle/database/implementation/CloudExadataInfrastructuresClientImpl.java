...
import oracle.database.fluent.models.CloudExadataInfrastructureInner;
import oracle.database.implementation.models.CloudExadataInfrastructureListResult;
import oracle.database.models.CloudExadataInfrastructureUpdate;
...
public final class CloudExadataInfrastructuresClientImpl implements CloudExadataInfrastructuresClient {
     ...
     */
    CloudExadataInfrastructuresClientImpl(DatabaseClientImpl client) {
    ...
    /**
     * The interface defining all the services for DatabaseClientCloudExadataInfrastructures to be used by the proxy
     * service to perform REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "DatabaseClientCloudE")
    public interface CloudExadataInfrastructuresService {
        ...
        Mono<Response<CloudExadataInfrastructureListResult>> list(@HostParam("endpoint") String endpoint,
        ...
        Mono<Response<Flux<ByteBuffer>>> createOrUpdate(@HostParam("endpoint") String endpoint,
            ...
            @BodyParam("application/json") CloudExadataInfrastructureInner resource, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<CloudExadataInfrastructureInner>> getByResourceGroup(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("cloudexadatainfrastructurename") String cloudexadatainfrastructurename,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<CloudExadataInfrastructureListResult>> listByResourceGroup(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
        ...
        @ExpectedResponses({ 200, 202 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Flux<ByteBuffer>>> addStorageCapacity(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("cloudexadatainfrastructurename") String cloudexadatainfrastructurename,
            @HeaderParam("Accept") String accept, Context context);
    ...
    private Mono<Response<Flux<ByteBuffer>>> updateWithResponseAsync(String resourceGroupName,
        ...
        return service.update(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, cloudexadatainfrastructurename, contentType, accept, properties, context);
    }
