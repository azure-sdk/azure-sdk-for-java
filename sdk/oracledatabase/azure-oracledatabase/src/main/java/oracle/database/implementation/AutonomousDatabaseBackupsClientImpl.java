...
public final class AutonomousDatabaseBackupsClientImpl implements AutonomousDatabaseBackupsClient {
     ...
     */
    AutonomousDatabaseBackupsClientImpl(DatabaseClientImpl client) {
    ...
    /**
     * The interface defining all the services for DatabaseClientAutonomousDatabaseBackups to be used by the proxy
     * service to perform REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "DatabaseClientAutono")
    public interface AutonomousDatabaseBackupsService {
        ...
        Mono<Response<Flux<ByteBuffer>>> update(@HostParam("endpoint") String endpoint,
            ...
            @BodyParam("application/json") AutonomousDatabaseBackupInner properties, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<AutonomousDatabaseBackupListResult>> listByParent(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
    ...
    private Mono<Response<Flux<ByteBuffer>>> updateWithResponseAsync(String resourceGroupName,
        String autonomousdatabasename, String adbbackupid, AutonomousDatabaseBackupInner properties) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> updateWithResponseAsync(String resourceGroupName,
        String autonomousdatabasename, String adbbackupid, AutonomousDatabaseBackupInner properties, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service.update(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, autonomousdatabasename, adbbackupid, contentType, accept, properties, context);
    }
    ...
    private PollerFlux<PollResult<AutonomousDatabaseBackupInner>, AutonomousDatabaseBackupInner> beginUpdateAsync(
        String resourceGroupName, String autonomousdatabasename, String adbbackupid,
        AutonomousDatabaseBackupInner properties) {
        Mono<Response<Flux<ByteBuffer>>> mono
    ...
    private PollerFlux<PollResult<AutonomousDatabaseBackupInner>, AutonomousDatabaseBackupInner> beginUpdateAsync(
        String resourceGroupName, String autonomousdatabasename, String adbbackupid,
        AutonomousDatabaseBackupInner properties, Context context) {
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono
    ...
    private Mono<AutonomousDatabaseBackupInner> updateAsync(String resourceGroupName, String autonomousdatabasename,
        String adbbackupid, AutonomousDatabaseBackupInner properties) {
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<AutonomousDatabaseBackupInner> updateAsync(String resourceGroupName, String autonomousdatabasename,
        String adbbackupid, AutonomousDatabaseBackupInner properties, Context context) {
