...
import oracle.database.models.VirtualNetworkAddressProperties;
...
public final class VirtualNetworkAddressImpl
    ...
    VirtualNetworkAddressImpl(String name, oracle.database.DatabaseManager serviceManager) {
    ...
    VirtualNetworkAddressImpl(VirtualNetworkAddressInner innerObject, oracle.database.DatabaseManager serviceManager) {
