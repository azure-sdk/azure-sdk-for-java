...
public final class SystemVersionsClientImpl implements SystemVersionsClient {
     ...
     */
    SystemVersionsClientImpl(DatabaseClientImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for DatabaseClientSystemVersions to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "DatabaseClientSystem")
