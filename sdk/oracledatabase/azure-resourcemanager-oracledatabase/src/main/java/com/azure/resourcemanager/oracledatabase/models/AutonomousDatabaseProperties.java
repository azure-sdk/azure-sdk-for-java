...
public final class AutonomousDatabaseProperties extends AutonomousDatabaseBaseProperties {
    ...
    /*
     * The list of Azure IDs of standby databases located in Autonomous Data Guard remote regions that are associated
     * with the source database. Note that for Autonomous Database Serverless instances, standby databases located in
     * the same region as the source primary database do not have Azure IDs.
     */
    ...
    /**
     * Get the peerDbIds property: The list of Azure IDs of standby databases located in Autonomous Data Guard remote
     * regions that are associated with the source database. Note that for Autonomous Database Serverless instances,
     * standby databases located in the same region as the source primary database do not have Azure IDs.
     * 
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("adminPassword".equals(fieldName)) {
                    ...
                    deserializedAutonomousDatabaseProperties.withComputeCount(reader.getNullable(JsonReader::getFloat));
                    ...
                    deserializedAutonomousDatabaseProperties.peerDbIds = peerDbIds;
                    ...
                    deserializedAutonomousDatabaseProperties.isRemoteDataGuardEnabled
                    ...
                    deserializedAutonomousDatabaseProperties.failedDataRecoveryInSeconds
                    ...
                    deserializedAutonomousDatabaseProperties.lifecycleDetails = reader.getString();
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedAutonomousDatabaseProperties.provisioningState
                        = AzureResourceProvisioningState.fromString(reader.getString());
                } else if ("lifecycleState".equals(fieldName)) {
                    deserializedAutonomousDatabaseProperties.lifecycleState
                    ...
                    deserializedAutonomousDatabaseProperties.ociUrl = reader.getString();
                    ...
                    deserializedAutonomousDatabaseProperties.timeCreated = reader
                        .getNullable(nonNullReader -> CoreUtils.parseBestOffsetDateTime(nonNullReader.getString()));
                } else if ("timeMaintenanceBegin".equals(fieldName)) {
                    deserializedAutonomousDatabaseProperties.timeMaintenanceBegin = reader
                        .getNullable(nonNullReader -> CoreUtils.parseBestOffsetDateTime(nonNullReader.getString()));
                } else if ("timeMaintenanceEnd".equals(fieldName)) {
                    deserializedAutonomousDatabaseProperties.timeMaintenanceEnd = reader
                        .getNullable(nonNullReader -> CoreUtils.parseBestOffsetDateTime(nonNullReader.getString()));
                } else if ("actualUsedDataStorageSizeInTbs".equals(fieldName)) {
                    deserializedAutonomousDatabaseProperties.actualUsedDataStorageSizeInTbs
                        = reader.getNullable(JsonReader::getDouble);
                } else if ("allocatedStorageSizeInTbs".equals(fieldName)) {
                    deserializedAutonomousDatabaseProperties.allocatedStorageSizeInTbs
                        = reader.getNullable(JsonReader::getDouble);
                } else if ("apexDetails".equals(fieldName)) {
                    deserializedAutonomousDatabaseProperties.apexDetails = ApexDetailsType.fromJson(reader);
                    ...
                    deserializedAutonomousDatabaseProperties.availableUpgradeVersions = availableUpgradeVersions;
                } else if ("connectionStrings".equals(fieldName)) {
                    deserializedAutonomousDatabaseProperties.connectionStrings = ConnectionStringType.fromJson(reader);
                } else if ("connectionUrls".equals(fieldName)) {
                    deserializedAutonomousDatabaseProperties.connectionUrls = ConnectionUrlType.fromJson(reader);
                } else if ("dataSafeStatus".equals(fieldName)) {
                    deserializedAutonomousDatabaseProperties.dataSafeStatus
                    ...
                    deserializedAutonomousDatabaseProperties.inMemoryAreaInGbs = reader.getNullable(JsonReader::getInt);
                } else if ("nextLongTermBackupTimeStamp".equals(fieldName)) {
                    deserializedAutonomousDatabaseProperties.nextLongTermBackupTimestamp = reader
                        .getNullable(nonNullReader -> CoreUtils.parseBestOffsetDateTime(nonNullReader.getString()));
                    ...
                    deserializedAutonomousDatabaseProperties.isPreview = reader.getNullable(JsonReader::getBoolean);
                    ...
                    deserializedAutonomousDatabaseProperties.memoryPerOracleComputeUnitInGbs
                        = reader.getNullable(JsonReader::getInt);
                    ...
                    deserializedAutonomousDatabaseProperties.operationsInsightsStatus
                    ...
                    deserializedAutonomousDatabaseProperties.privateEndpoint = reader.getString();
                } else if ("provisionableCpus".equals(fieldName)) {
                    List<Integer> provisionableCpus = reader.readArray(reader1 -> reader1.getInt());
                    deserializedAutonomousDatabaseProperties.provisionableCpus = provisionableCpus;
                    ...
                    deserializedAutonomousDatabaseProperties.serviceConsoleUrl = reader.getString();
                } else if ("sqlWebDeveloperUrl".equals(fieldName)) {
                    deserializedAutonomousDatabaseProperties.sqlWebDeveloperUrl = reader.getString();
                    ...
                    deserializedAutonomousDatabaseProperties.supportedRegionsToCloneTo = supportedRegionsToCloneTo;
                } else if ("timeDataGuardRoleChanged".equals(fieldName)) {
                    deserializedAutonomousDatabaseProperties.timeDataGuardRoleChanged = reader.getString();
                } else if ("timeDeletionOfFreeAutonomousDatabase".equals(fieldName)) {
                    deserializedAutonomousDatabaseProperties.timeDeletionOfFreeAutonomousDatabase = reader.getString();
                } else if ("timeLocalDataGuardEnabled".equals(fieldName)) {
                    deserializedAutonomousDatabaseProperties.timeLocalDataGuardEnabled = reader.getString();
                } else if ("timeOfLastFailover".equals(fieldName)) {
                    deserializedAutonomousDatabaseProperties.timeOfLastFailover = reader.getString();
                } else if ("timeOfLastRefresh".equals(fieldName)) {
                    deserializedAutonomousDatabaseProperties.timeOfLastRefresh = reader.getString();
                } else if ("timeOfLastRefreshPoint".equals(fieldName)) {
                    deserializedAutonomousDatabaseProperties.timeOfLastRefreshPoint = reader.getString();
                } else if ("timeOfLastSwitchover".equals(fieldName)) {
                    deserializedAutonomousDatabaseProperties.timeOfLastSwitchover = reader.getString();
                } else if ("timeReclamationOfFreeAutonomousDatabase".equals(fieldName)) {
                    deserializedAutonomousDatabaseProperties.timeReclamationOfFreeAutonomousDatabase
                        = reader.getString();
                } else if ("usedDataStorageSizeInGbs".equals(fieldName)) {
                    deserializedAutonomousDatabaseProperties.usedDataStorageSizeInGbs
                        = reader.getNullable(JsonReader::getInt);
                } else if ("usedDataStorageSizeInTbs".equals(fieldName)) {
                    deserializedAutonomousDatabaseProperties.usedDataStorageSizeInTbs
                        = reader.getNullable(JsonReader::getInt);
                } else if ("ocid".equals(fieldName)) {
                    deserializedAutonomousDatabaseProperties.ocid = reader.getString();
