...
import com.azure.resourcemanager.oracledatabase.models.GiMinorVersionListResult;
...
public final class GiMinorVersionsClientImpl implements GiMinorVersionsClient {
     ...
     */
    GiMinorVersionsClientImpl(OracleDatabaseResourceManagerImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for OracleDatabaseResourceManagerGiMinorVersions to be used by the proxy
    ...
    public interface GiMinorVersionsService {
        ...
        Mono<Response<GiMinorVersionListResult>> listByParent(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<GiMinorVersionInner>> get(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("location") String location, @PathParam("giversionname") String giversionname,
    ...
    private Mono<PagedResponse<GiMinorVersionInner>> listByParentSinglePageAsync(String location, String giversionname,
        ...
        return service
            .listByParent(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
                location, giversionname, shapeFamily, zone, accept, context)
    ...
    private PagedFlux<GiMinorVersionInner> listByParentAsync(String location, String giversionname,
        ShapeFamily shapeFamily, String zone, Context context) {
        return new PagedFlux<>(() -> listByParentSinglePageAsync(location, giversionname, shapeFamily, zone, context),
    ...
    public PagedIterable<GiMinorVersionInner> listByParent(String location, String giversionname) {
        final ShapeFamily shapeFamily = null;
        final String zone = null;
        return new PagedIterable<>(listByParentAsync(location, giversionname, shapeFamily, zone));
    }
    ...
    public PagedIterable<GiMinorVersionInner> listByParent(String location, String giversionname,
        ShapeFamily shapeFamily, String zone, Context context) {
        return new PagedIterable<>(listByParentAsync(location, giversionname, shapeFamily, zone, context));
    }
    ...
    public Response<GiMinorVersionInner> getWithResponse(String location, String giversionname,
        String giMinorVersionName, Context context) {
        return getWithResponseAsync(location, giversionname, giMinorVersionName, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<GiMinorVersionInner>> listByParentNextSinglePageAsync(String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        if (this.client.getEndpoint() == null) {
