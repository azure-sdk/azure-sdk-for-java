...
public final class DbSystemShapesClientImpl implements DbSystemShapesClient {
     ...
     */
    DbSystemShapesClientImpl(OracleDatabaseResourceManagerForTestingImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for OracleDatabaseResourceManagerForTestingDbSystemShapes to be used by
