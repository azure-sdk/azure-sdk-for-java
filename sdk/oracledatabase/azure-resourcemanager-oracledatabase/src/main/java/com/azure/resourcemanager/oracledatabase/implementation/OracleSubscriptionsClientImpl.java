...
public final class OracleSubscriptionsClientImpl implements OracleSubscriptionsClient {
     ...
     */
    OracleSubscriptionsClientImpl(OracleDatabaseResourceManagerForTestingImpl client) {
    ...
    /**
     * The interface defining all the services for OracleDatabaseResourceManagerForTestingOracleSubscriptions to be used
