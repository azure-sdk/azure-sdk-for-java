...
public final class CloudVmClustersClientImpl implements CloudVmClustersClient {
     ...
     */
    CloudVmClustersClientImpl(OracleDatabaseResourceManagerForTestingImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for OracleDatabaseResourceManagerForTestingCloudVmClusters to be used by
