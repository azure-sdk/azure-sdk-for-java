...
import com.azure.resourcemanager.oracledatabase.models.FlexComponentListResult;
...
public final class FlexComponentsClientImpl implements FlexComponentsClient {
     ...
     */
    FlexComponentsClientImpl(OracleDatabaseResourceManagerImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for OracleDatabaseResourceManagerFlexComponents to be used by the proxy
    ...
    public interface FlexComponentsService {
        ...
        Mono<Response<FlexComponentListResult>> listByParent(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<FlexComponentInner>> get(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
