        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("id".equals(fieldName)) {
                    deserializedSystemVersionInner.withId(reader.getString());
                } else if ("name".equals(fieldName)) {
                    deserializedSystemVersionInner.withName(reader.getString());
                } else if ("type".equals(fieldName)) {
                    deserializedSystemVersionInner.withType(reader.getString());
