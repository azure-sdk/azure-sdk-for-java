...
public final class PeerDbDetails implements JsonSerializable<PeerDbDetails> {
    /*
     * The Azure ID of the Disaster Recovery peer database, which is located in a different region from the current peer
     * database.
     */
    ...
    /**
     * Get the peerDbId property: The Azure ID of the Disaster Recovery peer database, which is located in a different
    ...
    /**
     * Set the peerDbId property: The Azure ID of the Disaster Recovery peer database, which is located in a different
     * region from the current peer database.
     * 
