        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("id".equals(fieldName)) {
                    deserializedVirtualNetworkAddressInner.withId(reader.getString());
                } else if ("name".equals(fieldName)) {
                    deserializedVirtualNetworkAddressInner.withName(reader.getString());
                } else if ("type".equals(fieldName)) {
                    deserializedVirtualNetworkAddressInner.withType(reader.getString());
