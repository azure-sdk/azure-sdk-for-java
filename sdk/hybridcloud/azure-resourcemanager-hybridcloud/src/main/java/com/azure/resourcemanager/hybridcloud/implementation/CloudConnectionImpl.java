...
public final class CloudConnectionImpl implements CloudConnection, CloudConnection.Definition, CloudConnection.Update {
    ...
    public ResourceReference cloudConnectorId() {
        return this.innerModel().cloudConnectorId();
    }
    ...
    private CloudConnectionTagsObject updateParameters;
    ...
    public CloudConnectionImpl update() {
        this.updateParameters = new CloudConnectionTagsObject();
        return this;
    }
    ...
    public CloudConnectionImpl withCloudConnectorId(ResourceReference cloudConnectorId) {
        this.innerModel().withCloudConnectorId(cloudConnectorId);
        return this;
    }
