...
public final class CloudConnectorsImpl implements CloudConnectors {
    ...
    public Response<DiscoverResources> discoverResourcesWithResponse(
        String resourceGroupName, String cloudConnectorName, Context context) {
        Response<DiscoverResourcesInner> inner =
            this.serviceClient().discoverResourcesWithResponse(resourceGroupName, cloudConnectorName, context);
        if (inner != null) {
            return new SimpleResponse<>(
                inner.getRequest(),
                inner.getStatusCode(),
                inner.getHeaders(),
                new DiscoverResourcesImpl(inner.getValue(), this.manager()));
        } else {
            return null;
        }
    }

    public DiscoverResources discoverResources(String resourceGroupName, String cloudConnectorName) {
        DiscoverResourcesInner inner = this.serviceClient().discoverResources(resourceGroupName, cloudConnectorName);
        if (inner != null) {
            return new DiscoverResourcesImpl(inner, this.manager());
        } else {
            return null;
        }
    }
