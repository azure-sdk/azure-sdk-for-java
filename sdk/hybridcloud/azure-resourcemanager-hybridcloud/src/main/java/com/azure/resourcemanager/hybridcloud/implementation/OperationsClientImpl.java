...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    OperationsClientImpl(HybridcloudImpl client) {
        this.service =
    ...
    /**
     * The interface defining all the services for HybridcloudOperations to be used by the proxy service to perform REST
     * calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "HybridcloudOperation")
