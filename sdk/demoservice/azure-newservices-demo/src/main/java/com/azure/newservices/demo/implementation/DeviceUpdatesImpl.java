...
public final class DeviceUpdatesImpl {
     ...
     */
    DeviceUpdatesImpl(DemoNewServiceClientImpl client) {
        this.service =
    ...
    /**
     * The interface defining all the services for DemoNewServiceClientDeviceUpdates to be used by the proxy service to
     * perform REST calls.
     */
    @Host("https://{endpoint}")
