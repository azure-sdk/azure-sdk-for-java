...
package com.azure.newservices.demo.implementation;
...
public final class DeviceManagementsImpl {
    ...
    private final DemoNewServiceClientImpl client;
     ...
     */
    DeviceManagementsImpl(DemoNewServiceClientImpl client) {
        this.service =
                RestProxy.create(
    ...
    /**
     * The interface defining all the services for DemoNewServiceClientDeviceManagements to be used by the proxy service
     * to perform REST calls.
     */
    @Host("https://{endpoint}")
    @ServiceInterface(name = "DemoNewServiceClient")
