...
public interface PrivateZonesClient {
    ...
    SyncPoller<PollResult<PrivateZoneInner>, PrivateZoneInner> beginCreateOrUpdate(String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<PrivateZoneInner>, PrivateZoneInner> beginUpdate(String resourceGroupName,
        String privateZoneName, PrivateZoneInner parameters);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<PrivateZoneInner> getByResourceGroupWithResponse(String resourceGroupName, String privateZoneName,
        Context context);
