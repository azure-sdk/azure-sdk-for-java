...
import com.azure.resourcemanager.privatedns.generated.models.RecordSetListResult;
...
public final class RecordSetsClientImpl implements RecordSetsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<RecordSetInner> createOrUpdateAsync(String resourceGroupName, String privateZoneName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<RecordSetInner> updateAsync(String resourceGroupName, String privateZoneName, RecordType recordType,
        String relativeRecordSetName, RecordSetInner parameters) {
        final String ifMatch = null;
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> deleteAsync(String resourceGroupName, String privateZoneName, RecordType recordType,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<RecordSetInner> getAsync(String resourceGroupName, String privateZoneName, RecordType recordType,
        String relativeRecordSetName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<RecordSetInner> listAsync(String resourceGroupName, String privateZoneName) {
        final Integer top = null;
        final String recordsetnamesuffix = null;
        return new PagedFlux<>(() -> listSinglePageAsync(resourceGroupName, privateZoneName, top, recordsetnamesuffix),
            nextLink -> listNextSinglePageAsync(nextLink));
