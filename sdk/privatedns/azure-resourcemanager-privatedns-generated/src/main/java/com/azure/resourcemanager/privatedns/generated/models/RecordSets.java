...
public interface RecordSets {
     ...
     */
    Response<RecordSet> createOrUpdateWithResponse(String resourceGroupName, String privateZoneName,
     ...
     * zone.
     */
    RecordSet createOrUpdate(String resourceGroupName, String privateZoneName, RecordType recordType,
     ...
     * zone along with {@link Response}.
     */
    Response<RecordSet> updateWithResponse(String resourceGroupName, String privateZoneName, RecordType recordType,
     ...
     * zone.
     */
    RecordSet update(String resourceGroupName, String privateZoneName, RecordType recordType,
        String relativeRecordSetName, RecordSetInner parameters);
     ...
     */
    Response<RecordSet> getWithResponse(String resourceGroupName, String privateZoneName, RecordType recordType,
     ...
     * @return a record set.
     */
    RecordSet get(String resourceGroupName, String privateZoneName, RecordType recordType,
     ...
     * @return the response to a record set list operation as paginated response with {@link PagedIterable}.
     */
    PagedIterable<RecordSet> list(String resourceGroupName, String privateZoneName, Integer top,
