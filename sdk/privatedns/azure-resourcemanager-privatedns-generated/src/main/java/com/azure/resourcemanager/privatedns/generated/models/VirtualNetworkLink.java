...
public interface VirtualNetworkLink {
    ...
    /**
     * Gets the resolutionPolicy property: The resolution policy on the virtual network link. Only applicable for
     * virtual network links to privatelink zones, and for A,AAAA,CNAME queries. When set to 'NxDomainRedirect', Azure
     * DNS resolver falls back to public resolution if private dns query resolution results in non-existent domain
     * response.
     * 
    ...
    interface DefinitionStages {
        ...
        interface WithCreate extends DefinitionStages.WithTags, DefinitionStages.WithEtag,
            DefinitionStages.WithVirtualNetwork, DefinitionStages.WithRegistrationEnabled,
            DefinitionStages.WithResolutionPolicy, DefinitionStages.WithIfMatch, DefinitionStages.WithIfNoneMatch {
            /**
        ...
        /**
         * The stage of the VirtualNetworkLink definition allowing to specify resolutionPolicy.
         */
        interface WithResolutionPolicy {
            /**
             * Specifies the resolutionPolicy property: The resolution policy on the virtual network link. Only
             * applicable for virtual network links to privatelink zones, and for A,AAAA,CNAME queries. When set to
             * 'NxDomainRedirect', Azure DNS resolver falls back to public resolution if private dns query resolution
             * results in non-existent domain response..
             * 
             * @param resolutionPolicy The resolution policy on the virtual network link. Only applicable for virtual
             * network links to privatelink zones, and for A,AAAA,CNAME queries. When set to 'NxDomainRedirect', Azure
             * DNS resolver falls back to public resolution if private dns query resolution results in non-existent
             * domain response.
             * @return the next definition stage.
             */
            WithCreate withResolutionPolicy(ResolutionPolicy resolutionPolicy);
        }
     ...
     */
    interface Update extends UpdateStages.WithTags, UpdateStages.WithEtag, UpdateStages.WithVirtualNetwork,
        UpdateStages.WithRegistrationEnabled, UpdateStages.WithResolutionPolicy, UpdateStages.WithIfMatch {
        /**
    ...
    interface UpdateStages {
        ...
        /**
         * The stage of the VirtualNetworkLink update allowing to specify resolutionPolicy.
         */
        interface WithResolutionPolicy {
            /**
             * Specifies the resolutionPolicy property: The resolution policy on the virtual network link. Only
             ...
             * @return the next definition stage.
             */
            Update withResolutionPolicy(ResolutionPolicy resolutionPolicy);
        }
