...
public final class PrivateZonesImpl implements PrivateZones {
    ...
    public PrivateZonesImpl(PrivateZonesClient innerClient,
    ...
    public Response<PrivateZone> getByResourceGroupWithResponse(String resourceGroupName, String privateZoneName,
        Context context) {
    ...
    public PagedIterable<PrivateZone> list() {
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new PrivateZoneImpl(inner1, this.manager()));
    }
