...
public final class CassandraResourcesCreateUpdateCassandraTableSamples {
    ...
    public static void
        ...
        manager.cassandraResources().defineUpdateCassandraTable("tableName").withRegion("West US")
            ...
            .withResource(new CassandraTableResource().withId("tableName").withDefaultTtl(100).withSchema(
                new CassandraSchema().withColumns(Arrays.asList(new Column().withName("columnA").withType("Ascii")))
...
public final class DatabaseAccountsCreateOrUpdateSamples {
    ...
    public static void cosmosDBRestoreDatabaseAccountCreateUpdateJson(
        ...
        manager.databaseAccounts().define("ddb1").withRegion("westus").withExistingResourceGroup("rg1")
            ...
            .withMinimalTlsVersion(MinimalTlsVersion.TLS).create();
    }
    ...
    public static void
        ...
        manager.databaseAccounts().define("ddb1").withRegion("westus").withExistingResourceGroup("rg1")
            ...
            .withTags(mapOf()).withKind(DatabaseAccountKind.MONGO_DB)
            ...
            .withCapacity(new Capacity().withTotalThroughputLimit(2000)).withMinimalTlsVersion(MinimalTlsVersion.TLS12)
            .withEnableBurstCapacity(true).create();
    }
...
public final class DatabaseAccountsOfflineRegionSamples {
    ...
    public static void
        ...
        manager.databaseAccounts().offlineRegion("rg1", "ddb1", new RegionForOnlineOffline(),
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class DatabaseAccountsOnlineRegionSamples {
    ...
    public static void
        ...
        manager.databaseAccounts().onlineRegion("rg1", "ddb1", new RegionForOnlineOffline(),
            com.azure.core.util.Context.NONE);
    }
}
```
    ...
    public static void
        ...
        resource.update().withTags(mapOf("dept", "finance")).withIdentity(new ManagedServiceIdentity()
            ...
            .withBackupPolicy(new PeriodicModeBackupPolicy().withPeriodicModeProperties(
                new PeriodicModeProperties().withBackupIntervalInMinutes(240).withBackupRetentionIntervalInHours(720)
            ...
            .withMinimalTlsVersion(MinimalTlsVersion.TLS).withEnableBurstCapacity(true).apply();
    }
...
public final class GremlinResourcesGetGremlinGraphSamples {
    /*
     * x-ms-original-file:
     * specification/cosmos-db/resource-manager/Microsoft.DocumentDB/stable/2024-05-15/examples/CosmosDBGremlinGraphGet.
     * json
     */
    /**
...
public final class GremlinResourcesListGremlinGraphsSamples {
    /*
     * x-ms-original-file:
     * specification/cosmos-db/resource-manager/Microsoft.DocumentDB/stable/2024-05-15/examples/CosmosDBGremlinGraphList
     * .json
     */
    /**
...
public final class LocationsListSamples {
    /*
     * x-ms-original-file:
     * specification/cosmos-db/resource-manager/Microsoft.DocumentDB/stable/2024-05-15/examples/CosmosDBLocationList.
     * json
     */
    /**
...
public final class ServiceListSamples {
    /*
     * x-ms-original-file:
     * specification/cosmos-db/resource-manager/Microsoft.DocumentDB/stable/2024-05-15/examples/CosmosDBServicesList.
     * json
     */
    /**
...
public final class SqlResourcesDeleteSqlTriggerSamples {
    /*
     * x-ms-original-file:
     * specification/cosmos-db/resource-manager/Microsoft.DocumentDB/stable/2024-05-15/examples/CosmosDBSqlTriggerDelete
     * .json
     */
    /**
...
public final class SqlResourcesGetSqlContainerSamples {
    /*
     * x-ms-original-file:
     * specification/cosmos-db/resource-manager/Microsoft.DocumentDB/stable/2024-05-15/examples/CosmosDBSqlContainerGet.
     * json
     */
    /**
...
public final class SqlResourcesGetSqlDatabaseSamples {
    /*
     * x-ms-original-file:
     * specification/cosmos-db/resource-manager/Microsoft.DocumentDB/stable/2024-05-15/examples/CosmosDBSqlDatabaseGet.
     * json
     */
    /**
...
public final class SqlResourcesGetSqlTriggerSamples {
    /*
     * x-ms-original-file:
     * specification/cosmos-db/resource-manager/Microsoft.DocumentDB/stable/2024-05-15/examples/CosmosDBSqlTriggerGet.
     * json
     */
    /**
...
public final class SqlResourcesListSqlContainersSamples {
    /*
     * x-ms-original-file:
     * specification/cosmos-db/resource-manager/Microsoft.DocumentDB/stable/2024-05-15/examples/CosmosDBSqlContainerList
     * .json
     */
    /**
...
public final class SqlResourcesListSqlDatabasesSamples {
    /*
     * x-ms-original-file:
     * specification/cosmos-db/resource-manager/Microsoft.DocumentDB/stable/2024-05-15/examples/CosmosDBSqlDatabaseList.
     * json
     */
    /**
...
public final class SqlResourcesListSqlTriggersSamples {
    /*
     * x-ms-original-file:
     * specification/cosmos-db/resource-manager/Microsoft.DocumentDB/stable/2024-05-15/examples/CosmosDBSqlTriggerList.
     * json
     */
    /**
...
public final class TableResourcesDeleteTableSamples {
    /*
     * x-ms-original-file:
     * specification/cosmos-db/resource-manager/Microsoft.DocumentDB/stable/2024-05-15/examples/CosmosDBTableDelete.json
     */
    /**
...
public final class TableResourcesGetTableSamples {
    /*
     * x-ms-original-file:
     * specification/cosmos-db/resource-manager/Microsoft.DocumentDB/stable/2024-05-15/examples/CosmosDBTableGet.json
     */
    /**
...
public final class TableResourcesListTablesSamples {
    /*
     * x-ms-original-file:
     * specification/cosmos-db/resource-manager/Microsoft.DocumentDB/stable/2024-05-15/examples/CosmosDBTableList.json
     */
    /**
