...
- [AbortSegment](#cassandrarepair_abortsegment)
- [Create](#cassandrarepair_create)
- [Delete](#cassandrarepair_delete)
- [GetClusterStatus](#cassandrarepair_getclusterstatus)
- [GetTableStatus](#cassandrarepair_gettablestatus)
- [List](#cassandrarepair_list)
- [ListSegments](#cassandrarepair_listsegments)
- [Pause](#cassandrarepair_pause)
- [Resume](#cassandrarepair_resume)
- [Show](#cassandrarepair_show)
- [Update](#cassandrarepair_update)
...
public final class CassandraClustersCreateUpdateSamples {
    ...
    public static void cosmosDBManagedCassandraClusterCreate(
        ...
        manager
            ...
            .withTags(mapOf())
            .withProperties(
                new ClusterResourcePropertiesAutoGenerated()
                    .withDelegatedManagementSubnetId(
                        "/subscriptions/536e130b-d7d6-4ac7-98a5-de20d69588d2/resourceGroups/customer-vnet-rg/providers/Microsoft.Network/virtualNetworks/customer-vnet/subnets/management")
                    .withCassandraVersion("3.11")
                    .withClusterNameOverride("ClusterNameIllegalForAzureResource")
...
public final class CassandraClustersUpdateSamples {
    ...
    public static void cosmosDBManagedCassandraClusterPatch(
        com.azure.resourcemanager.cosmos.generated.CosmosDBManager manager) {
        ClusterResourceAutoGenerated resource =
            manager
                .cassandraClusters()
                .getWithResponse("cassandra-prod-rg", "cassandra-prod", com.azure.core.util.Context.NONE)
                .getValue();
...
public final class CassandraDataCentersCreateUpdateSamples {
    ...
    public static void cosmosDBManagedCassandraDataCenterCreate(
        ...
        manager
            ...
            .withExistingCassandraCluster("cassandra-prod-rg", "cassandra-prod")
            .withProperties(
                new DataCenterResourcePropertiesAutoGenerated()
                    .withDataCenterLocation("West US 2")
                    .withDelegatedSubnetId(
                        "/subscriptions/536e130b-d7d6-4ac7-98a5-de20d69588d2/resourceGroups/customer-vnet-rg/providers/Microsoft.Network/virtualNetworks/customer-vnet/subnets/dc1-subnet")
                    .withNodeCount(9)
...
public final class CassandraDataCentersUpdateSamples {
    ...
    public static void cosmosDBManagedCassandraDataCenterUpdate(
        com.azure.resourcemanager.cosmos.generated.CosmosDBManager manager) {
        DataCenterResourceAutoGenerated resource =
            manager
                .cassandraDataCenters()
                .getWithResponse("cassandra-prod-rg", "cassandra-prod", "dc1", com.azure.core.util.Context.NONE)
                .getValue();
...
### CassandraRepair_GetClusterStatus
...
### CassandraRepair_GetTableStatus
...
### CassandraRepair_Pause

```java
/** Samples for CassandraRepair Pause. */
public final class CassandraRepairPauseSamples {
    /*
     * x-ms-original-file: specification/cosmos-db/resource-manager/Microsoft.DocumentDB/preview/2023-03-15-preview/examples/CosmosDBManagedCassandraClusterRepairPause.json
     */
    /**
     * Sample code: CosmosDBManagedCassandraClusterRepairPause.
     *
     * @param manager Entry point to CosmosDBManager.
     */
    public static void cosmosDBManagedCassandraClusterRepairPause(
        com.azure.resourcemanager.cosmos.generated.CosmosDBManager manager) {
        manager
            .cassandraRepairs()
            .pause(
...
public final class OperationsListSamples {
    /*
     * x-ms-original-file: specification/cosmos-db/resource-manager/Microsoft.DocumentDB/preview/2023-03-01-preview/examples/CosmosDBOperationsList.json
     */
    /**
