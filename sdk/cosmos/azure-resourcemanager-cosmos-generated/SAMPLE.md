...
public final class CassandraClustersDeallocateSamples {
    ...
    public static void
        ...
        manager.cassandraClusters().deallocate("cassandra-prod-rg", "cassandra-prod", null,
...
public final class CassandraClustersGetBackupSamples {
    ...
    public static void
        ...
        manager.cassandraClusters().getBackupWithResponse("cassandra-prod-rg", "cassandra-prod", "1611250348",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class CassandraClustersGetByResourceGroupSamples {
    ...
    public static void
        ...
        manager.cassandraClusters().getByResourceGroupWithResponse("cassandra-prod-rg", "cassandra-prod",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class CassandraClustersGetCommandAsyncResourceSamples {
    ...
    public static void
        ...
        manager.cassandraClusters().getCommandAsyncResourceWithResponse("cassandra-prod-rg", "cassandra-prod",
...
public final class CassandraClustersInvokeCommandSamples {
    ...
    public static void cosmosDBManagedCassandraCommand(
        ...
        manager.cassandraClusters().invokeCommand("cassandra-prod-rg", "cassandra-prod",
...
public final class CassandraClustersInvokeCommandAsyncResourceSamples {
    ...
    public static void cosmosDBManagedCassandraCommandAsync(
        com.azure.resourcemanager.cosmos.generated.CosmosDBManager manager) throws IOException {
        manager.cassandraClusters().invokeCommandAsyncResource("cassandra-prod-rg", "cassandra-prod",
            new CommandPostBody().withCommand("nodetool")
                .withArguments(SerializerFactory.createDefaultManagementSerializerAdapter()
                    .deserialize("{\"status\":\"\"}", Object.class, SerializerEncoding.JSON))
                .withHost("10.0.1.12"),
...
public final class CassandraClustersListBackupsSamples {
    ...
    public static void
        ...
        manager.cassandraClusters().listBackups("cassandra-prod-rg", "cassandra-prod",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class CassandraClustersListCommandSamples {
    ...
    public static void
        ...
        manager.cassandraClusters().listCommand("cassandra-prod-rg", "cassandra-prod",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class CassandraClustersStatusSamples {
    ...
    public static void
        ...
        manager.cassandraClusters().statusWithResponse("cassandra-prod-rg", "cassandra-prod",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class CassandraClustersUpdateSamples {
    ...
    public static void
        ...
        ClusterResource resource = manager.cassandraClusters()
            ...
            .getValue();
        resource.update().withTags(mapOf("owner", "mike"))
...
public final class CassandraDataCentersCreateUpdateSamples {
    ...
    public static void
        ...
        manager.cassandraDataCenters().define("dc1").withExistingCassandraCluster("cassandra-prod-rg", "cassandra-prod")
...
public final class CassandraDataCentersDeleteSamples {
    ...
    public static void
        ...
        manager.cassandraDataCenters().delete("cassandra-prod-rg", "cassandra-prod", "dc1",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class CassandraDataCentersGetSamples {
    ...
    public static void
        ...
        manager.cassandraDataCenters().getWithResponse("cassandra-prod-rg", "cassandra-prod", "dc1",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class CassandraDataCentersUpdateSamples {
    ...
    public static void
        ...
        DataCenterResource resource = manager.cassandraDataCenters()
            .getWithResponse("cassandra-prod-rg", "cassandra-prod", "dc1", com.azure.core.util.Context.NONE).getValue();
        resource.update().withProperties(new DataCenterResourceProperties().withDataCenterLocation("West US 2")
            .withDelegatedSubnetId(
                "/subscriptions/536e130b-d7d6-4ac7-98a5-de20d69588d2/resourceGroups/customer-vnet-rg/providers/Microsoft.Network/virtualNetworks/customer-vnet/subnets/dc1-subnet")
            .withNodeCount(9).withBase64EncodedCassandraYamlFragment("fakeTokenPlaceholder")).apply();
    }
}
```
...
public final class CassandraResourcesCreateUpdateCassandraKeyspaceSamples {
    ...
    public static void
        ...
        manager.cassandraResources().defineUpdateCassandraKeyspace("keyspaceName").withRegion("West US")
            .withExistingDatabaseAccount("rg1", "ddb1")
            .withResource(new CassandraKeyspaceResource().withId("keyspaceName")).withTags(mapOf())
...
public final class CassandraResourcesCreateUpdateCassandraTableSamples {
    ...
    public static void
        ...
        manager.cassandraResources().defineUpdateCassandraTable("tableName").withRegion("West US")
            .withExistingCassandraKeyspace("rg1", "ddb1", "keyspaceName")
            .withResource(
                new CassandraTableResource().withId("tableName").withDefaultTtl(100)
...
public final class CassandraResourcesCreateUpdateCassandraViewSamples {
    ...
    public static void
        ...
        manager.cassandraResources().defineUpdateCassandraView("viewname").withRegion((String) null)
            .withExistingCassandraKeyspace("rg1", "ddb1", "keyspacename")
...
public final class CassandraResourcesDeleteCassandraKeyspaceSamples {
    ...
    public static void
        ...
        manager.cassandraResources().deleteCassandraKeyspace("rg1", "ddb1", "keyspaceName",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class CassandraResourcesDeleteCassandraTableSamples {
    ...
    public static void
        ...
        manager.cassandraResources().deleteCassandraTable("rg1", "ddb1", "keyspaceName", "tableName",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class CassandraResourcesDeleteCassandraViewSamples {
    ...
    public static void cosmosDBCassandraViewDelete(com.azure.resourcemanager.cosmos.generated.CosmosDBManager manager) {
        manager.cassandraResources().deleteCassandraView("rg1", "ddb1", "keyspacename", "viewname",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class CassandraResourcesGetCassandraKeyspaceSamples {
    ...
    public static void
        ...
        manager.cassandraResources().getCassandraKeyspaceWithResponse("rg1", "ddb1", "keyspaceName",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class CassandraResourcesGetCassandraKeyspaceThroughputSamples {
    ...
    public static void
        ...
        manager.cassandraResources().getCassandraKeyspaceThroughputWithResponse("rg1", "ddb1", "keyspaceName",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class CassandraResourcesGetCassandraTableSamples {
    ...
    public static void cosmosDBCassandraTableGet(com.azure.resourcemanager.cosmos.generated.CosmosDBManager manager) {
        manager.cassandraResources().getCassandraTableWithResponse("rg1", "ddb1", "keyspaceName", "tableName",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class CassandraResourcesGetCassandraTableThroughputSamples {
    ...
    public static void
        ...
        manager.cassandraResources().getCassandraTableThroughputWithResponse("rg1", "ddb1", "keyspaceName", "tableName",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class CassandraResourcesGetCassandraViewSamples {
    ...
    public static void cosmosDBCassandraViewGet(com.azure.resourcemanager.cosmos.generated.CosmosDBManager manager) {
        manager.cassandraResources().getCassandraViewWithResponse("rg1", "ddb1", "keyspacename", "viewname",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class CassandraResourcesGetCassandraViewThroughputSamples {
    ...
    public static void
        ...
        manager.cassandraResources().getCassandraViewThroughputWithResponse("rg1", "ddb1", "keyspacename", "viewname",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class CassandraResourcesListCassandraTablesSamples {
    ...
    public static void cosmosDBCassandraTableList(com.azure.resourcemanager.cosmos.generated.CosmosDBManager manager) {
        manager.cassandraResources().listCassandraTables("rgName", "ddb1", "keyspaceName",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class CassandraResourcesListCassandraViewsSamples {
    ...
    public static void cosmosDBCassandraViewList(com.azure.resourcemanager.cosmos.generated.CosmosDBManager manager) {
        manager.cassandraResources().listCassandraViews("rgName", "ddb1", "keyspacename",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class CassandraResourcesMigrateCassandraKeyspaceToAutoscaleSamples {
    ...
    public static void cosmosDBCassandraKeyspaceMigrateToAutoscale(
        com.azure.resourcemanager.cosmos.generated.CosmosDBManager manager) {
        manager.cassandraResources().migrateCassandraKeyspaceToAutoscale("rg1", "ddb1", "keyspaceName",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class CassandraResourcesMigrateCassandraKeyspaceToManualThroughputSamples {
    ...
    public static void cosmosDBCassandraKeyspaceMigrateToManualThroughput(
        com.azure.resourcemanager.cosmos.generated.CosmosDBManager manager) {
        manager.cassandraResources().migrateCassandraKeyspaceToManualThroughput("rg1", "ddb1", "keyspaceName",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class CassandraResourcesMigrateCassandraTableToAutoscaleSamples {
    ...
    public static void
        ...
        manager.cassandraResources().migrateCassandraTableToAutoscale("rg1", "ddb1", "keyspaceName", "tableName",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class CassandraResourcesMigrateCassandraTableToManualThroughputSamples {
    ...
    public static void cosmosDBCassandraTableMigrateToManualThroughput(
        com.azure.resourcemanager.cosmos.generated.CosmosDBManager manager) {
        manager.cassandraResources().migrateCassandraTableToManualThroughput("rg1", "ddb1", "keyspaceName", "tableName",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class CassandraResourcesMigrateCassandraViewToAutoscaleSamples {
    ...
    public static void
        ...
        manager.cassandraResources().migrateCassandraViewToAutoscale("rg1", "ddb1", "keyspacename", "viewname",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class CassandraResourcesMigrateCassandraViewToManualThroughputSamples {
    ...
    public static void cosmosDBCassandraViewMigrateToManualThroughput(
        com.azure.resourcemanager.cosmos.generated.CosmosDBManager manager) {
        manager.cassandraResources().migrateCassandraViewToManualThroughput("rg1", "ddb1", "keyspacename", "viewname",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class CassandraResourcesUpdateCassandraKeyspaceThroughputSamples {
    ...
    public static void
        ...
        manager.cassandraResources().updateCassandraKeyspaceThroughput(
            "rg1", "ddb1", "keyspaceName", new ThroughputSettingsUpdateParameters().withLocation("West US")
...
public final class CassandraResourcesUpdateCassandraTableThroughputSamples {
    ...
    public static void
        ...
        manager.cassandraResources().updateCassandraTableThroughput(
            "rg1", "ddb1", "keyspaceName", "tableName", new ThroughputSettingsUpdateParameters().withLocation("West US")
                .withTags(mapOf()).withResource(new ThroughputSettingsResource().withThroughput(400)),
            com.azure.core.util.Context.NONE);
    }
    ...
    public static void
        ...
        manager.cassandraResources()
            .updateCassandraViewThroughput(
                "rg1", "ddb1", "keyspacename", "viewname", new ThroughputSettingsUpdateParameters().withTags(mapOf())
...
public final class CollectionListMetricDefinitionsSamples {
    ...
    public static void
        ...
        manager.collections().listMetricDefinitions("rg1", "ddb1", "databaseRid", "collectionRid",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class CollectionListMetricsSamples {
    ...
    public static void
        ...
        manager.collections().listMetrics("rg1", "ddb1", "databaseRid", "collectionRid",
...
public final class CollectionListUsagesSamples {
    ...
    public static void cosmosDBCollectionGetUsages(com.azure.resourcemanager.cosmos.generated.CosmosDBManager manager) {
        manager.collections().listUsages("rg1", "ddb1", "databaseRid", "collectionRid",
...
public final class CollectionPartitionListMetricsSamples {
    ...
    public static void
        ...
        manager.collectionPartitions().listMetrics("rg1", "ddb1", "databaseRid", "collectionRid",
...
public final class CollectionPartitionListUsagesSamples {
     ...
     */
    public static void cosmosDBCollectionGetUsages(com.azure.resourcemanager.cosmos.generated.CosmosDBManager manager) {
        manager.collectionPartitions().listUsages("rg1", "ddb1", "databaseRid", "collectionRid",
            "$filter=name.value eq 'Partition Storage'", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class CollectionRegionListMetricsSamples {
    ...
    public static void
        ...
        manager.collectionRegions().listMetrics("rg1", "ddb1", "North Europe", "databaseRid", "collectionRid",
            "$filter=(name.value eq 'Total Requests') and timeGrain eq duration'PT5M' and startTime eq '2017-11-19T23:53:55.2780000Z' and endTime eq '2017-11-20T00:13:55.2780000Z",
            com.azure.core.util.Context.NONE);
    }
}
...
public final class DataTransferJobsCancelSamples {
    /*
     * x-ms-original-file:
     * specification/cosmos-db/resource-manager/Microsoft.DocumentDB/preview/2024-05-15-preview/examples/data-transfer-
...
public final class DataTransferJobsCreateSamples {
    ...
    public static void
        ...
        manager.dataTransferJobs().define("j1").withExistingDatabaseAccount("rg1", "ddb1")
...
public final class DatabaseListMetricsSamples {
    ...
    public static void cosmosDBDatabaseGetMetrics(com.azure.resourcemanager.cosmos.generated.CosmosDBManager manager) {
        manager.databases().listMetrics("rg1", "ddb1", "rid",
            "$filter=(name.value eq 'Total Requests') and timeGrain eq duration'PT5M' and startTime eq '2017-11-19T23:53:55.2780000Z' and endTime eq '2017-11-20T00:13:55.2780000Z",
            com.azure.core.util.Context.NONE);
    }
}
...
public final class DatabaseListUsagesSamples {
    ...
    public static void cosmosDBDatabaseGetUsages(com.azure.resourcemanager.cosmos.generated.CosmosDBManager manager) {
        manager.databases().listUsages("rg1", "ddb1", "databaseRid", "$filter=name.value eq 'Storage'",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class DatabaseAccountRegionListMetricsSamples {
    ...
    public static void
        cosmosDBDatabaseAccountRegionGetMetrics(com.azure.resourcemanager.cosmos.generated.CosmosDBManager manager) {
        manager.databaseAccountRegions().listMetrics("rg1", "ddb1", "North Europe",
            "$filter=(name.value eq 'Total Requests') and timeGrain eq duration'PT5M' and startTime eq '2017-11-19T23:53:55.2780000Z' and endTime eq '2017-11-20T00:13:55.2780000Z",
            com.azure.core.util.Context.NONE);
    }
}
...
public final class DatabaseAccountsCreateOrUpdateSamples {
    ...
    public static void
        ...
        manager.databaseAccounts().define("ddb1").withRegion("westus").withExistingResourceGroup("rg1")
            ...
            .withEnablePerRegionPerPartitionAutoscale(true).create();
    }
...
public final class DatabaseAccountsFailoverPriorityChangeSamples {
    ...
    public static void cosmosDBDatabaseAccountFailoverPriorityChange(
        com.azure.resourcemanager.cosmos.generated.CosmosDBManager manager) {
        manager.databaseAccounts().failoverPriorityChange("rg1", "ddb1-failover",
...
public final class DatabaseAccountsListConnectionStringsSamples {
    ...
    public static void cosmosDBDatabaseAccountListConnectionStringsMongo(
        com.azure.resourcemanager.cosmos.generated.CosmosDBManager manager) {
        manager.databaseAccounts().listConnectionStringsWithResponse("rg1", "mongo-ddb1",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class DatabaseAccountsListMetricsSamples {
    ...
    public static void
        ...
        manager.databaseAccounts().listMetrics("rg1", "ddb1",
            "$filter=(name.value eq 'Total Requests') and timeGrain eq duration'PT5M' and startTime eq '2017-11-19T23:53:55.2780000Z' and endTime eq '2017-11-20T00:13:55.2780000Z",
            com.azure.core.util.Context.NONE);
    }
}
...
public final class DatabaseAccountsListUsagesSamples {
    ...
    public static void
        ...
        manager.databaseAccounts().listUsages("rg1", "ddb1", "$filter=name.value eq 'Storage'",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class DatabaseAccountsOfflineRegionSamples {
    ...
    public static void
        ...
        manager.databaseAccounts().offlineRegion("rg1", "ddb1", new RegionForOnlineOffline().withRegion("North Europe"),
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class DatabaseAccountsOnlineRegionSamples {
    ...
    public static void
        ...
        manager.databaseAccounts().onlineRegion("rg1", "ddb1", new RegionForOnlineOffline().withRegion("North Europe"),
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class DatabaseAccountsRegenerateKeySamples {
    ...
    public static void
        ...
        manager.databaseAccounts().regenerateKey("rg1", "ddb1",
...
public final class DatabaseAccountsUpdateSamples {
    ...
    public static void
        ...
        DatabaseAccountGetResults resource = manager.databaseAccounts()
            .getByResourceGroupWithResponse("rg1", "ddb1", com.azure.core.util.Context.NONE).getValue();
        resource.update().withTags(mapOf("dept", "finance")).withIdentity(new ManagedServiceIdentity()
            ...
            .withBackupPolicy(new PeriodicModeBackupPolicy()
                .withPeriodicModeProperties(new PeriodicModeProperties().withBackupIntervalInMinutes(240)
                    .withBackupRetentionIntervalInHours(720).withBackupStorageRedundancy(BackupStorageRedundancy.GEO)))
            .withNetworkAclBypass(NetworkAclBypass.AZURE_SERVICES)
            .withNetworkAclBypassResourceIds(Arrays.asList(
                "/subscriptions/subId/resourcegroups/rgName/providers/Microsoft.Synapse/workspaces/workspaceName"))
            ...
            .withEnablePriorityBasedExecution(true).withDefaultPriorityLevel(DefaultPriorityLevel.LOW)
            .withEnablePerRegionPerPartitionAutoscale(true).apply();
    }
...
public final class GraphResourcesCreateUpdateGraphSamples {
    ...
    public static void cosmosDBGraphCreateUpdate(com.azure.resourcemanager.cosmos.generated.CosmosDBManager manager) {
        manager.graphResources().define("graphName").withRegion("West US").withExistingDatabaseAccount("rg1", "ddb1")
            .withResource(new GraphResource().withId("graphName")).withTags(mapOf())
            .withOptions(new CreateUpdateOptions()).create();
    }
...
public final class GremlinResourcesCreateUpdateGremlinDatabaseSamples {
    ...
    public static void
        ...
        manager.gremlinResources().defineUpdateGremlinDatabase("databaseName").withRegion("West US")
            .withExistingDatabaseAccount("rg1", "ddb1")
            .withResource(new GremlinDatabaseResource().withId("databaseName")).withTags(mapOf())
            .withOptions(new CreateUpdateOptions()).create();
    }
...
public final class GremlinResourcesCreateUpdateGremlinGraphSamples {
    ...
    public static void
        ...
        manager.gremlinResources().defineUpdateGremlinGraph("graphName").withRegion("West US")
...
public final class GremlinResourcesDeleteGremlinDatabaseSamples {
    ...
    public static void
        ...
        manager.gremlinResources().deleteGremlinDatabase("rg1", "ddb1", "databaseName",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class GremlinResourcesDeleteGremlinGraphSamples {
    ...
    public static void cosmosDBGremlinGraphDelete(com.azure.resourcemanager.cosmos.generated.CosmosDBManager manager) {
        manager.gremlinResources().deleteGremlinGraph("rg1", "ddb1", "databaseName", "graphName",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class GremlinResourcesGetGremlinDatabaseSamples {
    ...
    public static void cosmosDBGremlinDatabaseGet(com.azure.resourcemanager.cosmos.generated.CosmosDBManager manager) {
        manager.gremlinResources().getGremlinDatabaseWithResponse("rg1", "ddb1", "databaseName",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class GremlinResourcesGetGremlinDatabaseThroughputSamples {
    ...
    public static void
        ...
        manager.gremlinResources().getGremlinDatabaseThroughputWithResponse("rg1", "ddb1", "databaseName",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class GremlinResourcesGetGremlinGraphSamples {
    ...
    public static void cosmosDBGremlinGraphGet(com.azure.resourcemanager.cosmos.generated.CosmosDBManager manager) {
        manager.gremlinResources().getGremlinGraphWithResponse("rgName", "ddb1", "databaseName", "graphName",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class GremlinResourcesGetGremlinGraphThroughputSamples {
    ...
    public static void
        ...
        manager.gremlinResources().getGremlinGraphThroughputWithResponse("rg1", "ddb1", "databaseName", "graphName",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class GremlinResourcesListGremlinGraphsSamples {
    ...
    public static void cosmosDBGremlinGraphList(com.azure.resourcemanager.cosmos.generated.CosmosDBManager manager) {
        manager.gremlinResources().listGremlinGraphs("rgName", "ddb1", "databaseName",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class GremlinResourcesMigrateGremlinDatabaseToAutoscaleSamples {
    ...
    public static void
        ...
        manager.gremlinResources().migrateGremlinDatabaseToAutoscale("rg1", "ddb1", "databaseName",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class GremlinResourcesMigrateGremlinDatabaseToManualThroughputSamples {
    ...
    public static void cosmosDBGremlinDatabaseMigrateToManualThroughput(
        com.azure.resourcemanager.cosmos.generated.CosmosDBManager manager) {
        manager.gremlinResources().migrateGremlinDatabaseToManualThroughput("rg1", "ddb1", "databaseName",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class GremlinResourcesMigrateGremlinGraphToManualThroughputSamples {
    ...
    public static void cosmosDBGremlinGraphMigrateToManualThroughput(
        com.azure.resourcemanager.cosmos.generated.CosmosDBManager manager) {
        manager.gremlinResources().migrateGremlinGraphToManualThroughput("rg1", "ddb1", "databaseName", "graphName",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class GremlinResourcesRetrieveContinuousBackupInformationSamples {
    ...
    public static void
        ...
        manager.gremlinResources().retrieveContinuousBackupInformation("rgName", "ddb1", "databaseName", "graphName",
...
public final class GremlinResourcesUpdateGremlinDatabaseThroughputSamples {
    ...
    public static void
        ...
        manager.gremlinResources().updateGremlinDatabaseThroughput(
...
public final class GremlinResourcesUpdateGremlinGraphThroughputSamples {
    ...
    public static void
        ...
        manager.gremlinResources().updateGremlinGraphThroughput(
            "rg1", "ddb1", "databaseName", "graphName", new ThroughputSettingsUpdateParameters().withLocation("West US")
                .withTags(mapOf()).withResource(new ThroughputSettingsResource().withThroughput(400)),
            com.azure.core.util.Context.NONE);
    }
...
public final class MongoClustersCheckNameAvailabilitySamples {
    /*
     * x-ms-original-file:
     * specification/cosmos-db/resource-manager/Microsoft.DocumentDB/preview/2024-05-15-preview/examples/mongo-cluster/
...
public final class MongoClustersDeleteFirewallRuleSamples {
    ...
    public static void
        ...
        manager.mongoClusters().deleteFirewallRule("TestGroup", "myMongoCluster", "rule1",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class MongoDBResourcesCreateUpdateMongoDBCollectionSamples {
    ...
    public static void
        ...
        manager.mongoDBResources().defineUpdateMongoDBCollection("collectionName").withRegion("West US")
...
public final class MongoDBResourcesCreateUpdateMongoDBDatabaseSamples {
    ...
    public static void
        ...
        manager.mongoDBResources().defineUpdateMongoDBDatabase("databaseName").withRegion("West US")
            .withExistingDatabaseAccount("rg1", "ddb1")
            .withResource(new MongoDBDatabaseResource().withId("databaseName")).withTags(mapOf())
            .withOptions(new CreateUpdateOptions()).create();
    }
...
public final class MongoDBResourcesCreateUpdateMongoRoleDefinitionSamples {
    ...
    public static void
        ...
        manager.mongoDBResources().defineUpdateMongoRoleDefinition("myMongoRoleDefinitionId")
            .withExistingDatabaseAccount("myResourceGroupName", "myAccountName").withRoleName("myRoleName")
            ...
            .withRoles(Arrays.asList(new Role().withDb("sales").withRole("myInheritedRole"))).create();
    }
}
```
...
public final class MongoDBResourcesCreateUpdateMongoUserDefinitionSamples {
    ...
    public static void
        ...
        manager.mongoDBResources().defineUpdateMongoUserDefinition("myMongoUserDefinitionId")
            .withExistingDatabaseAccount("myResourceGroupName", "myAccountName").withUsername("myUserName")
            .withPassword("myPassword").withDatabaseName("sales").withCustomData("My custom data")
            .withRoles(Arrays.asList(new Role().withDb("sales").withRole("myReadRole"))).withMechanisms("SCRAM-SHA-256")
            .create();
    }
}
```
...
public final class MongoDBResourcesDeleteMongoDBCollectionSamples {
    ...
    public static void
        ...
        manager.mongoDBResources().deleteMongoDBCollection("rg1", "ddb1", "databaseName", "collectionName",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class MongoDBResourcesDeleteMongoDBDatabaseSamples {
    ...
    public static void
        ...
        manager.mongoDBResources().deleteMongoDBDatabase("rg1", "ddb1", "databaseName",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class MongoDBResourcesDeleteMongoRoleDefinitionSamples {
    ...
    public static void
        ...
        manager.mongoDBResources().deleteMongoRoleDefinition("myMongoRoleDefinitionId", "myResourceGroupName",
...
public final class MongoDBResourcesDeleteMongoUserDefinitionSamples {
    ...
    public static void
        ...
        manager.mongoDBResources().deleteMongoUserDefinition("myMongoUserDefinitionId", "myResourceGroupName",
            "myAccountName", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class MongoDBResourcesGetMongoDBCollectionSamples {
    ...
    public static void
        ...
        manager.mongoDBResources().getMongoDBCollectionWithResponse("rgName", "ddb1", "databaseName", "collectionName",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class MongoDBResourcesGetMongoDBCollectionThroughputSamples {
    ...
    public static void
        ...
        manager.mongoDBResources().getMongoDBCollectionThroughputWithResponse("rg1", "ddb1", "databaseName",
...
public final class MongoDBResourcesGetMongoDBDatabaseSamples {
    ...
    public static void cosmosDBMongoDBDatabaseGet(com.azure.resourcemanager.cosmos.generated.CosmosDBManager manager) {
        manager.mongoDBResources().getMongoDBDatabaseWithResponse("rg1", "ddb1", "databaseName",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class MongoDBResourcesGetMongoDBDatabaseThroughputSamples {
    ...
    public static void
        ...
        manager.mongoDBResources().getMongoDBDatabaseThroughputWithResponse("rg1", "ddb1", "databaseName",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class MongoDBResourcesGetMongoRoleDefinitionSamples {
    ...
    public static void
        ...
        manager.mongoDBResources().getMongoRoleDefinitionWithResponse("myMongoRoleDefinitionId", "myResourceGroupName",
            "myAccountName", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class MongoDBResourcesGetMongoUserDefinitionSamples {
    ...
    public static void
        ...
        manager.mongoDBResources().getMongoUserDefinitionWithResponse("myMongoUserDefinitionId", "myResourceGroupName",
            "myAccountName", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class MongoDBResourcesListMongoDBCollectionPartitionMergeSamples {
    ...
    public static void
        ...
        manager.mongoDBResources().listMongoDBCollectionPartitionMerge("rgName", "ddb1", "databaseName",
            "collectionName", new MergeParameters().withIsDryRun(false), com.azure.core.util.Context.NONE);
    }
}
```
...
public final class MongoDBResourcesListMongoDBCollectionsSamples {
    ...
    public static void
        ...
        manager.mongoDBResources().listMongoDBCollections("rgName", "ddb1", "databaseName",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class MongoDBResourcesListMongoRoleDefinitionsSamples {
    ...
    public static void
        ...
        manager.mongoDBResources().listMongoRoleDefinitions("myResourceGroupName", "myAccountName",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class MongoDBResourcesListMongoUserDefinitionsSamples {
    ...
    public static void
        ...
        manager.mongoDBResources().listMongoUserDefinitions("myResourceGroupName", "myAccountName",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class MongoDBResourcesMigrateMongoDBCollectionToAutoscaleSamples {
    ...
    public static void cosmosDBMongoDBCollectionMigrateToAutoscale(
        com.azure.resourcemanager.cosmos.generated.CosmosDBManager manager) {
        manager.mongoDBResources().migrateMongoDBCollectionToAutoscale("rg1", "ddb1", "databaseName", "collectionName",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class MongoDBResourcesMigrateMongoDBCollectionToManualThroughputSamples {
    ...
    public static void cosmosDBMongoDBCollectionMigrateToManualThroughput(
        com.azure.resourcemanager.cosmos.generated.CosmosDBManager manager) {
        manager.mongoDBResources().migrateMongoDBCollectionToManualThroughput("rg1", "ddb1", "databaseName",
            "collectionName", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class MongoDBResourcesMigrateMongoDBDatabaseToManualThroughputSamples {
    ...
    public static void cosmosDBMongoDBDatabaseMigrateToManualThroughput(
        com.azure.resourcemanager.cosmos.generated.CosmosDBManager manager) {
        manager.mongoDBResources().migrateMongoDBDatabaseToManualThroughput("rg1", "ddb1", "databaseName",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class MongoDBResourcesMongoDBContainerRetrieveThroughputDistributionSamples {
    ...
    public static void cosmosDBMongoDBCollectionRetrieveThroughputDistribution(
        com.azure.resourcemanager.cosmos.generated.CosmosDBManager manager) {
        manager.mongoDBResources().mongoDBContainerRetrieveThroughputDistribution("rg1", "ddb1", "databaseName",
            "collectionName",
...
public final class MongoDBResourcesMongoDBDatabasePartitionMergeSamples {
    ...
    public static void
        ...
        manager.mongoDBResources().mongoDBDatabasePartitionMerge("rgName", "ddb1", "databaseName",
...
public final class MongoDBResourcesMongoDBDatabaseRedistributeThroughputSamples {
    ...
    public static void cosmosDBMongoDBDatabaseRedistributeThroughput(
        com.azure.resourcemanager.cosmos.generated.CosmosDBManager manager) {
        manager.mongoDBResources().mongoDBDatabaseRedistributeThroughput("rg1", "ddb1", "databaseName",
            new RedistributeThroughputParameters().withResource(
...
public final class MongoDBResourcesMongoDBDatabaseRetrieveThroughputDistributionSamples {
    ...
    public static void cosmosDBMongoDBDatabaseRetrieveThroughputDistribution(
        com.azure.resourcemanager.cosmos.generated.CosmosDBManager manager) {
        manager.mongoDBResources().mongoDBDatabaseRetrieveThroughputDistribution("rg1", "ddb1", "databaseName",
            new RetrieveThroughputParameters()
                .withResource(new RetrieveThroughputPropertiesResource().withPhysicalPartitionIds(
                    Arrays.asList(new PhysicalPartitionId().withId("0"), new PhysicalPartitionId().withId("1")))),
            com.azure.core.util.Context.NONE);
...
public final class MongoDBResourcesRetrieveContinuousBackupInformationSamples {
    ...
    public static void
        ...
        manager.mongoDBResources().retrieveContinuousBackupInformation("rgName", "ddb1", "databaseName",
            "collectionName", new ContinuousBackupRestoreLocation().withLocation("North Europe"),
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class MongoDBResourcesUpdateMongoDBCollectionThroughputSamples {
    ...
    public static void
        ...
        manager.mongoDBResources().updateMongoDBCollectionThroughput("rg1", "ddb1", "databaseName", "collectionName",
...
public final class MongoDBResourcesUpdateMongoDBDatabaseThroughputSamples {
    ...
    public static void
        ...
        manager.mongoDBResources().updateMongoDBDatabaseThroughput(
            "rg1", "ddb1", "databaseName", new ThroughputSettingsUpdateParameters().withLocation("West US")
                .withTags(mapOf()).withResource(new ThroughputSettingsResource().withThroughput(400)),
            com.azure.core.util.Context.NONE);
    }
...
public final class NotebookWorkspacesCreateOrUpdateSamples {
    ...
    public static void
        ...
        manager.notebookWorkspaces().define(NotebookWorkspaceName.DEFAULT).withExistingDatabaseAccount("rg1", "ddb1")
            .create();
    }
}
```
...
public final class NotebookWorkspacesDeleteSamples {
    ...
    public static void
        ...
        manager.notebookWorkspaces().delete("rg1", "ddb1", NotebookWorkspaceName.DEFAULT,
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class NotebookWorkspacesListConnectionInfoSamples {
    ...
    public static void cosmosDBNotebookWorkspaceListConnectionInfo(
        com.azure.resourcemanager.cosmos.generated.CosmosDBManager manager) {
        manager.notebookWorkspaces().listConnectionInfoWithResponse("rg1", "ddb1", NotebookWorkspaceName.DEFAULT,
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class NotebookWorkspacesRegenerateAuthTokenSamples {
    ...
    public static void cosmosDBNotebookWorkspaceRegenerateAuthToken(
        com.azure.resourcemanager.cosmos.generated.CosmosDBManager manager) {
        manager.notebookWorkspaces().regenerateAuthToken("rg1", "ddb1", NotebookWorkspaceName.DEFAULT,
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class NotebookWorkspacesStartSamples {
    ...
    public static void
        ...
        manager.notebookWorkspaces().start("rg1", "ddb1", NotebookWorkspaceName.DEFAULT,
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class PartitionKeyRangeIdListMetricsSamples {
    ...
    public static void
        cosmosDBDatabaseAccountRegionGetMetrics(com.azure.resourcemanager.cosmos.generated.CosmosDBManager manager) {
        manager.partitionKeyRangeIds().listMetrics("rg1", "ddb1", "databaseRid", "collectionRid", "0",
            "$filter=(name.value eq 'Max RUs Per Second') and timeGrain eq duration'PT1M' and startTime eq '2017-11-19T23:53:55.2780000Z' and endTime eq '2017-11-20T23:58:55.2780000Z",
            com.azure.core.util.Context.NONE);
    }
}
...
public final class PartitionKeyRangeIdRegionListMetricsSamples {
    ...
    public static void
        cosmosDBDatabaseAccountRegionGetMetrics(com.azure.resourcemanager.cosmos.generated.CosmosDBManager manager) {
        manager.partitionKeyRangeIdRegions().listMetrics("rg1", "ddb1", "West US", "databaseRid", "collectionRid", "0",
            "$filter=(name.value eq 'Max RUs Per Second') and timeGrain eq duration'PT1M' and startTime eq '2017-11-19T23:53:55.2780000Z' and endTime eq '2017-11-20T23:58:55.2780000Z",
            com.azure.core.util.Context.NONE);
    }
}
...
public final class PercentileListMetricsSamples {
    ...
    public static void
        cosmosDBDatabaseAccountRegionGetMetrics(com.azure.resourcemanager.cosmos.generated.CosmosDBManager manager) {
        manager.percentiles().listMetrics("rg1", "ddb1",
...
public final class PercentileSourceTargetListMetricsSamples {
    ...
    public static void
        cosmosDBDatabaseAccountRegionGetMetrics(com.azure.resourcemanager.cosmos.generated.CosmosDBManager manager) {
        manager.percentileSourceTargets().listMetrics("rg1", "ddb1", "West Central US", "East US",
            "$filter=(name.value eq 'Probabilistic Bounded Staleness') and timeGrain eq duration'PT5M' and startTime eq '2017-11-19T23:53:55.2780000Z' and endTime eq '2017-11-20T00:13:55.2780000Z",
            com.azure.core.util.Context.NONE);
    }
}
...
public final class PercentileTargetListMetricsSamples {
    ...
    public static void
        cosmosDBDatabaseAccountRegionGetMetrics(com.azure.resourcemanager.cosmos.generated.CosmosDBManager manager) {
        manager.percentileTargets().listMetrics("rg1", "ddb1", "East US",
            "$filter=(name.value eq 'Probabilistic Bounded Staleness') and timeGrain eq duration'PT5M' and startTime eq '2017-11-19T23:53:55.2780000Z' and endTime eq '2017-11-20T00:13:55.2780000Z",
            com.azure.core.util.Context.NONE);
    }
}
...
public final class PrivateEndpointConnectionsDeleteSamples {
    ...
    public static void deletesAPrivateEndpointConnectionWithAGivenName(
        com.azure.resourcemanager.cosmos.generated.CosmosDBManager manager) {
        manager.privateEndpointConnections().delete("rg1", "ddb1", "privateEndpointConnectionName",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class RestorableDatabaseAccountsGetByLocationSamples {
    ...
    public static void
        ...
        manager.restorableDatabaseAccounts().getByLocationWithResponse("West US",
...
public final class RestorableGremlinDatabasesListSamples {
    ...
    public static void
        ...
        manager.restorableGremlinDatabases().list("WestUS", "d9b26648-2f53-4541-b3d8-3044f4f9810d",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class RestorableGremlinGraphsListSamples {
    ...
    public static void
        ...
        manager.restorableGremlinGraphs().list("WestUS", "98a570f2-63db-4117-91f0-366327b7b353", "PD5DALigDgw=", null,
...
public final class RestorableGremlinResourcesListSamples {
    ...
    public static void
        ...
        manager.restorableGremlinResources().list("WestUS", "d9b26648-2f53-4541-b3d8-3044f4f9810d", "WestUS",
            "06/01/2022 4:56", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class RestorableMongodbCollectionsListSamples {
    ...
    public static void
        ...
        manager.restorableMongodbCollections().list("WestUS", "98a570f2-63db-4117-91f0-366327b7b353", "PD5DALigDgw=",
...
public final class RestorableMongodbDatabasesListSamples {
    ...
    public static void
        ...
        manager.restorableMongodbDatabases().list("WestUS", "d9b26648-2f53-4541-b3d8-3044f4f9810d",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class RestorableMongodbResourcesListSamples {
    ...
    public static void
        ...
        manager.restorableMongodbResources().list("WestUS", "d9b26648-2f53-4541-b3d8-3044f4f9810d", "WestUS",
            "06/01/2022 4:56", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class RestorableSqlContainersListSamples {
    ...
    public static void
        ...
        manager.restorableSqlContainers().list("WestUS", "98a570f2-63db-4117-91f0-366327b7b353", "3fu-hg==", null, null,
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class RestorableSqlDatabasesListSamples {
    ...
    public static void
        ...
        manager.restorableSqlDatabases().list("WestUS", "d9b26648-2f53-4541-b3d8-3044f4f9810d",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class RestorableSqlResourcesListSamples {
    ...
    public static void
        ...
        manager.restorableSqlResources().list("WestUS", "d9b26648-2f53-4541-b3d8-3044f4f9810d", "WestUS",
            "06/01/2022 4:56", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class RestorableTableResourcesListSamples {
    ...
    public static void
        ...
        manager.restorableTableResources().list("WestUS", "d9b26648-2f53-4541-b3d8-3044f4f9810d", "WestUS",
            "06/01/2022 4:56", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class RestorableTablesListSamples {
    ...
    public static void cosmosDBRestorableTableList(com.azure.resourcemanager.cosmos.generated.CosmosDBManager manager) {
        manager.restorableTables().list("WestUS", "98a570f2-63db-4117-91f0-366327b7b353", null, null,
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class ServiceCreateSamples {
    ...
    public static void
        ...
        manager.services().define("SqlDedicatedGateway").withExistingDatabaseAccount("rg1", "ddb1")
            .withInstanceSize(ServiceSize.COSMOS_D4S).withInstanceCount(1)
            .withServiceType(ServiceType.SQL_DEDICATED_GATEWAY).create();
    }
    ...
    public static void dataTransferServiceCreate(com.azure.resourcemanager.cosmos.generated.CosmosDBManager manager) {
        manager.services().define("DataTransfer").withExistingDatabaseAccount("rg1", "ddb1")
            .withInstanceSize(ServiceSize.COSMOS_D4S).withInstanceCount(1).withServiceType(ServiceType.DATA_TRANSFER)
            .create();
    }
    ...
    public static void
        ...
        manager.services().define("MaterializedViewsBuilder").withExistingDatabaseAccount("rg1", "ddb1")
            .withInstanceSize(ServiceSize.COSMOS_D4S).withInstanceCount(1)
            .withServiceType(ServiceType.MATERIALIZED_VIEWS_BUILDER).create();
    }
    ...
    public static void
        ...
        manager.services().define("GraphAPICompute").withExistingDatabaseAccount("rg1", "ddb1")
            .withInstanceSize(ServiceSize.COSMOS_D4S).withInstanceCount(1).withServiceType(ServiceType.GRAPH_APICOMPUTE)
            .create();
    }
}
```
...
public final class SqlResourcesCreateUpdateClientEncryptionKeySamples {
    ...
    public static void
        ...
        manager.sqlResources().defineUpdateClientEncryptionKey("cekName")
...
public final class SqlResourcesCreateUpdateSqlDatabaseSamples {
    ...
    public static void
        ...
        manager.sqlResources().defineUpdateSqlDatabase("databaseName").withRegion("West US")
            .withExistingDatabaseAccount("rg1", "ddb1").withResource(new SqlDatabaseResource().withId("databaseName"))
            .withTags(mapOf()).withOptions(new CreateUpdateOptions()).create();
    }
...
public final class SqlResourcesCreateUpdateSqlRoleAssignmentSamples {
    ...
    public static void
        ...
        manager.sqlResources().defineUpdateSqlRoleAssignment("myRoleAssignmentId")
            ...
            .withPrincipalId("myPrincipalId").create();
    }
}
```
...
public final class SqlResourcesCreateUpdateSqlRoleDefinitionSamples {
    ...
    public static void
        ...
        manager.sqlResources().defineUpdateSqlRoleDefinition("myRoleDefinitionId")
            .withExistingDatabaseAccount("myResourceGroupName", "myAccountName").withRoleName("myRoleName")
...
public final class SqlResourcesCreateUpdateSqlStoredProcedureSamples {
    ...
    public static void
        ...
        manager.sqlResources().defineUpdateSqlStoredProcedure("storedProcedureName").withRegion((String) null)
...
public final class SqlResourcesCreateUpdateSqlTriggerSamples {
    ...
    public static void
        ...
        manager.sqlResources().defineUpdateSqlTrigger("triggerName").withRegion((String) null)
            .withExistingContainer("rg1", "ddb1", "databaseName", "containerName")
...
public final class SqlResourcesDeleteSqlContainerSamples {
    ...
    public static void cosmosDBSqlContainerDelete(com.azure.resourcemanager.cosmos.generated.CosmosDBManager manager) {
        manager.sqlResources().deleteSqlContainer("rg1", "ddb1", "databaseName", "containerName",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class SqlResourcesDeleteSqlRoleAssignmentSamples {
    ...
    public static void
        ...
        manager.sqlResources().deleteSqlRoleAssignment("myRoleAssignmentId", "myResourceGroupName", "myAccountName",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class SqlResourcesDeleteSqlRoleDefinitionSamples {
    ...
    public static void
        ...
        manager.sqlResources().deleteSqlRoleDefinition("myRoleDefinitionId", "myResourceGroupName", "myAccountName",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class SqlResourcesDeleteSqlStoredProcedureSamples {
    ...
    public static void
        ...
        manager.sqlResources().deleteSqlStoredProcedure("rg1", "ddb1", "databaseName", "containerName",
...
public final class SqlResourcesDeleteSqlTriggerSamples {
    ...
    public static void cosmosDBSqlTriggerDelete(com.azure.resourcemanager.cosmos.generated.CosmosDBManager manager) {
        manager.sqlResources().deleteSqlTrigger("rg1", "ddb1", "databaseName", "containerName", "triggerName",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class SqlResourcesDeleteSqlUserDefinedFunctionSamples {
    ...
    public static void
        ...
        manager.sqlResources().deleteSqlUserDefinedFunction("rg1", "ddb1", "databaseName", "containerName",
...
public final class SqlResourcesGetClientEncryptionKeySamples {
    ...
    public static void
        ...
        manager.sqlResources().getClientEncryptionKeyWithResponse("rgName", "accountName", "databaseName", "cekName",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class SqlResourcesGetSqlContainerSamples {
    ...
    public static void cosmosDBSqlContainerGet(com.azure.resourcemanager.cosmos.generated.CosmosDBManager manager) {
        manager.sqlResources().getSqlContainerWithResponse("rgName", "ddb1", "databaseName", "containerName",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class SqlResourcesGetSqlDatabaseSamples {
     ...
     */
    public static void cosmosDBSqlDatabaseGet(com.azure.resourcemanager.cosmos.generated.CosmosDBManager manager) {
        manager.sqlResources().getSqlDatabaseWithResponse("rg1", "ddb1", "databaseName",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class SqlResourcesGetSqlDatabaseThroughputSamples {
    ...
    public static void
        ...
        manager.sqlResources().getSqlDatabaseThroughputWithResponse("rg1", "ddb1", "databaseName",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class SqlResourcesGetSqlRoleAssignmentSamples {
    ...
    public static void
        ...
        manager.sqlResources().getSqlRoleAssignmentWithResponse("myRoleAssignmentId", "myResourceGroupName",
            "myAccountName", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class SqlResourcesGetSqlRoleDefinitionSamples {
    ...
    public static void
        ...
        manager.sqlResources().getSqlRoleDefinitionWithResponse("myRoleDefinitionId", "myResourceGroupName",
            "myAccountName", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class SqlResourcesGetSqlTriggerSamples {
    ...
    public static void cosmosDBSqlTriggerGet(com.azure.resourcemanager.cosmos.generated.CosmosDBManager manager) {
        manager.sqlResources().getSqlTriggerWithResponse("rgName", "ddb1", "databaseName", "containerName",
...
public final class SqlResourcesGetSqlUserDefinedFunctionSamples {
    ...
    public static void
        ...
        manager.sqlResources().getSqlUserDefinedFunctionWithResponse("rgName", "ddb1", "databaseName", "containerName",
            "userDefinedFunctionName", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class SqlResourcesListClientEncryptionKeysSamples {
    ...
    public static void
        ...
        manager.sqlResources().listClientEncryptionKeys("rgName", "accountName", "databaseName",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class SqlResourcesListSqlContainerPartitionMergeSamples {
    ...
    public static void
        ...
        manager.sqlResources().listSqlContainerPartitionMerge("rgName", "ddb1", "databaseName", "containerName",
            new MergeParameters().withIsDryRun(false), com.azure.core.util.Context.NONE);
    }
}
```
...
public final class SqlResourcesListSqlRoleAssignmentsSamples {
    ...
    public static void
        ...
        manager.sqlResources().listSqlRoleAssignments("myResourceGroupName", "myAccountName",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class SqlResourcesListSqlRoleDefinitionsSamples {
    ...
    public static void
        ...
        manager.sqlResources().listSqlRoleDefinitions("myResourceGroupName", "myAccountName",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class SqlResourcesListSqlStoredProceduresSamples {
    ...
    public static void
        ...
        manager.sqlResources().listSqlStoredProcedures("rgName", "ddb1", "databaseName", "containerName",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class SqlResourcesListSqlTriggersSamples {
    ...
    public static void cosmosDBSqlTriggerList(com.azure.resourcemanager.cosmos.generated.CosmosDBManager manager) {
        manager.sqlResources().listSqlTriggers("rgName", "ddb1", "databaseName", "containerName",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class SqlResourcesListSqlUserDefinedFunctionsSamples {
    ...
    public static void
        ...
        manager.sqlResources().listSqlUserDefinedFunctions("rgName", "ddb1", "databaseName", "containerName",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class SqlResourcesMigrateSqlContainerToManualThroughputSamples {
    ...
    public static void cosmosDBSqlContainerMigrateToManualThroughput(
        com.azure.resourcemanager.cosmos.generated.CosmosDBManager manager) {
        manager.sqlResources().migrateSqlContainerToManualThroughput("rg1", "ddb1", "databaseName", "containerName",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class SqlResourcesMigrateSqlDatabaseToAutoscaleSamples {
    ...
    public static void
        ...
        manager.sqlResources().migrateSqlDatabaseToAutoscale("rg1", "ddb1", "databaseName",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class SqlResourcesMigrateSqlDatabaseToManualThroughputSamples {
    ...
    public static void cosmosDBSqlDatabaseMigrateToManualThroughput(
        com.azure.resourcemanager.cosmos.generated.CosmosDBManager manager) {
        manager.sqlResources().migrateSqlDatabaseToManualThroughput("rg1", "ddb1", "databaseName",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class SqlResourcesRetrieveContinuousBackupInformationSamples {
    ...
    public static void
        ...
        manager.sqlResources().retrieveContinuousBackupInformation("rgName", "ddb1", "databaseName", "containerName",
            new ContinuousBackupRestoreLocation().withLocation("North Europe"), com.azure.core.util.Context.NONE);
    }
}
```
...
public final class SqlResourcesSqlContainerRedistributeThroughputSamples {
    ...
    public static void
        ...
        manager.sqlResources().sqlContainerRedistributeThroughput("rg1", "ddb1", "databaseName", "containerName",
            new RedistributeThroughputParameters().withResource(
                new RedistributeThroughputPropertiesResource().withThroughputPolicy(ThroughputPolicyType.CUSTOM)
                    .withTargetPhysicalPartitionThroughputInfo(
                        Arrays.asList(new PhysicalPartitionThroughputInfoResource().withId("0").withThroughput(5000.0D),
...
public final class SqlResourcesSqlDatabasePartitionMergeSamples {
    ...
    public static void
        ...
        manager.sqlResources().sqlDatabasePartitionMerge("rgName", "ddb1", "databaseName",
            new MergeParameters().withIsDryRun(false), com.azure.core.util.Context.NONE);
    }
}
```
...
public final class SqlResourcesSqlDatabaseRedistributeThroughputSamples {
    ...
    public static void
        ...
        manager.sqlResources().sqlDatabaseRedistributeThroughput("rg1", "ddb1", "databaseName",
            new RedistributeThroughputParameters().withResource(
                new RedistributeThroughputPropertiesResource().withThroughputPolicy(ThroughputPolicyType.CUSTOM)
                    .withTargetPhysicalPartitionThroughputInfo(
                        Arrays.asList(new PhysicalPartitionThroughputInfoResource().withId("0").withThroughput(5000.0D),
...
public final class SqlResourcesSqlDatabaseRetrieveThroughputDistributionSamples {
    ...
    public static void cosmosDBSqlDatabaseRetrieveThroughputDistribution(
        com.azure.resourcemanager.cosmos.generated.CosmosDBManager manager) {
        manager.sqlResources().sqlDatabaseRetrieveThroughputDistribution("rg1", "ddb1", "databaseName",
            new RetrieveThroughputParameters()
                .withResource(new RetrieveThroughputPropertiesResource().withPhysicalPartitionIds(
                    Arrays.asList(new PhysicalPartitionId().withId("0"), new PhysicalPartitionId().withId("1")))),
            com.azure.core.util.Context.NONE);
...
public final class SqlResourcesUpdateSqlContainerThroughputSamples {
    ...
    public static void
        ...
        manager.sqlResources().updateSqlContainerThroughput("rg1", "ddb1", "databaseName", "containerName",
            new ThroughputSettingsUpdateParameters().withLocation("West US").withTags(mapOf())
                .withResource(new ThroughputSettingsResource().withThroughput(400)),
            com.azure.core.util.Context.NONE);
    }
...
public final class SqlResourcesUpdateSqlDatabaseThroughputSamples {
    ...
    public static void
        ...
        manager.sqlResources().updateSqlDatabaseThroughput(
            "rg1", "ddb1", "databaseName", new ThroughputSettingsUpdateParameters().withLocation("West US")
                .withTags(mapOf()).withResource(new ThroughputSettingsResource().withThroughput(400)),
            com.azure.core.util.Context.NONE);
    }
...
public final class TableResourcesCreateUpdateTableSamples {
    ...
    public static void cosmosDBTableReplace(com.azure.resourcemanager.cosmos.generated.CosmosDBManager manager) {
        manager.tableResources().define("tableName").withRegion("West US").withExistingDatabaseAccount("rg1", "ddb1")
            .withResource(new TableResource().withId("tableName")).withTags(mapOf())
            .withOptions(new CreateUpdateOptions()).create();
    }
...
public final class TableResourcesGetTableThroughputSamples {
    ...
    public static void cosmosDBTableThroughputGet(com.azure.resourcemanager.cosmos.generated.CosmosDBManager manager) {
        manager.tableResources().getTableThroughputWithResponse("rg1", "ddb1", "tableName",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class TableResourcesMigrateTableToManualThroughputSamples {
    ...
    public static void
        ...
        manager.tableResources().migrateTableToManualThroughput("rg1", "ddb1", "tableName",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class TableResourcesRetrieveContinuousBackupInformationSamples {
    ...
    public static void
        ...
        manager.tableResources().retrieveContinuousBackupInformation("rgName", "ddb1", "tableName1",
            new ContinuousBackupRestoreLocation().withLocation("North Europe"), com.azure.core.util.Context.NONE);
    }
}
```
...
public final class TableResourcesUpdateTableThroughputSamples {
    ...
    public static void
        ...
        manager.tableResources().updateTableThroughput(
...
public final class ThroughputPoolAccountOperationCreateSamples {
    /*
     * x-ms-original-file:
     * specification/cosmos-db/resource-manager/Microsoft.DocumentDB/preview/2024-05-15-preview/examples/throughputPool/
    ...
    public static void
        ...
        manager.throughputPoolAccountOperations().define("db1").withExistingThroughputPool("rg1", "tp1")
            ...
            .withAccountLocation("West US").create();
    }
}
```
...
public final class ThroughputPoolAccountOperationGetSamples {
    ...
    public static void
        ...
        manager.throughputPoolAccountOperations().getWithResponse("rgName", "tp1", "db1",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class ThroughputPoolOperationCreateOrUpdateSamples {
    ...
    public static void
        ...
        manager.throughputPoolOperations().define("tp1").withRegion("westus2").withExistingResourceGroup("rg1")
            .withTags(mapOf()).withMaxThroughput(10000).create();
    }
...
public final class ThroughputPoolOperationUpdateSamples {
    ...
    public static void
        ...
        ThroughputPoolResource resource = manager.throughputPoolOperations()
            .getByResourceGroupWithResponse("rg1", "tp1", com.azure.core.util.Context.NONE).getValue();
