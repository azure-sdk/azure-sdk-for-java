...
public final class RestorableSqlContainersImpl implements RestorableSqlContainers {
    ...
    public PagedIterable<RestorableSqlContainerGetResultAutoGenerated> list(String location, String instanceId) {
        PagedIterable<RestorableSqlContainerGetResultAutoGeneratedInner> inner =
            this.serviceClient().list(location, instanceId);
        return Utils
            .mapPage(inner, inner1 -> new RestorableSqlContainerGetResultAutoGeneratedImpl(inner1, this.manager()));
    }

    public PagedIterable<RestorableSqlContainerGetResultAutoGenerated> list(
        String location,
        String instanceId,
        String restorableSqlDatabaseRid,
        String startTime,
