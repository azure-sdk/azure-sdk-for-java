...
import com.azure.resourcemanager.cosmos.generated.fluent.models.MongoClusterProperties;
...
public final class MongoClusterUpdate {
    ...
    /**
     * Set the clusterStatus property: A status of the mongo cluster.
     *
     * @param clusterStatus the clusterStatus value to set.
     * @return the MongoClusterUpdate object itself.
     */
    public MongoClusterUpdate withClusterStatus(MongoClusterStatus clusterStatus) {
        if (this.innerProperties() == null) {
            this.innerProperties = new MongoClusterProperties();
        }
        this.innerProperties().withClusterStatus(clusterStatus);
        return this;
    }
