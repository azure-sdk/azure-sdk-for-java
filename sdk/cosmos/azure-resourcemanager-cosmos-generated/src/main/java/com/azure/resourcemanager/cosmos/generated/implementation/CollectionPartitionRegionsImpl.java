...
public final class CollectionPartitionRegionsImpl implements CollectionPartitionRegions {
    ...
    public CollectionPartitionRegionsImpl(CollectionPartitionRegionsClient innerClient,
        com.azure.resourcemanager.cosmos.generated.CosmosDBManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public PagedIterable<PartitionMetric> listMetrics(String resourceGroupName, String accountName, String region,
        ...
        PagedIterable<PartitionMetricInner> inner = this.serviceClient().listMetrics(resourceGroupName, accountName,
            region, databaseRid, collectionRid, filter);
    ...
    public PagedIterable<PartitionMetric> listMetrics(String resourceGroupName, String accountName, String region,
        ...
        PagedIterable<PartitionMetricInner> inner = this.serviceClient().listMetrics(resourceGroupName, accountName,
            region, databaseRid, collectionRid, filter, context);
        return Utils.mapPage(inner, inner1 -> new PartitionMetricImpl(inner1, this.manager()));
    }
