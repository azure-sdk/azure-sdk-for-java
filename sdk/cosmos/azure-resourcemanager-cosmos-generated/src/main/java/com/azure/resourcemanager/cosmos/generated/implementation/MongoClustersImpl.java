...
public final class MongoClustersImpl implements MongoClusters {
    ...
    public MongoClustersImpl(
        MongoClustersClient innerClient, com.azure.resourcemanager.cosmos.generated.CosmosDBManager serviceManager) {
    ...
    public Response<MongoCluster> getWithResponse(String resourceGroupName, String mongoClusterName, Context context) {
        Response<MongoClusterInner> inner =
            this.serviceClient().getWithResponse(resourceGroupName, mongoClusterName, context);
        if (inner != null) {
    ...
    public MongoCluster get(String resourceGroupName, String mongoClusterName) {
        MongoClusterInner inner = this.serviceClient().get(resourceGroupName, mongoClusterName);
        if (inner != null) {
    ...
    public MongoCluster getById(String id) {
        ...
        return this.getWithResponse(resourceGroupName, mongoClusterName, Context.NONE).getValue();
    }
    ...
    public Response<MongoCluster> getByIdWithResponse(String id, Context context) {
        ...
        return this.getWithResponse(resourceGroupName, mongoClusterName, context);
    }
