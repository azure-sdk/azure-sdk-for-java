...
@JsonSubTypes({
    @JsonSubTypes.Type(name = "DataTransfer", value = DataTransferServiceResourceCreateUpdateProperties.class),
    @JsonSubTypes.Type(
        name = "SqlDedicatedGateway",
        value = SqlDedicatedGatewayServiceResourceCreateUpdateProperties.class),
    @JsonSubTypes.Type(name = "GraphAPICompute", value = GraphApiComputeServiceResourceCreateUpdateProperties.class),
    @JsonSubTypes.Type(
        name = "MaterializedViewsBuilder",
        value = MaterializedViewsBuilderServiceResourceCreateUpdateProperties.class) })
@Fluent
