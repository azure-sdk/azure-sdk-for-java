...
public final class CosmosDBManagementClientImpl implements CosmosDBManagementClient {
    ...
    /** The CassandraRepairsClient object to access its operations. */
    private final CassandraRepairsClient cassandraRepairs;

    /**
     * Gets the CassandraRepairsClient object to access its operations.
     *
     * @return the CassandraRepairsClient object.
     */
    public CassandraRepairsClient getCassandraRepairs() {
        return this.cassandraRepairs;
    }
    ...
    CosmosDBManagementClientImpl(
        ...
        this.cassandraRepairs = new CassandraRepairsClientImpl(this);
