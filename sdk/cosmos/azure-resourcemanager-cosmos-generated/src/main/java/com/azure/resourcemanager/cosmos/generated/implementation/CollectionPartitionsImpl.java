...
public final class CollectionPartitionsImpl implements CollectionPartitions {
    ...
    public CollectionPartitionsImpl(CollectionPartitionsClient innerClient,
    ...
    public PagedIterable<PartitionUsage> listUsages(String resourceGroupName, String accountName, String databaseRid,
    ...
    public PagedIterable<PartitionUsage> listUsages(String resourceGroupName, String accountName, String databaseRid,
        String collectionRid, String filter, Context context) {
        PagedIterable<PartitionUsageInner> inner = this.serviceClient().listUsages(resourceGroupName, accountName,
            databaseRid, collectionRid, filter, context);
        return Utils.mapPage(inner, inner1 -> new PartitionUsageImpl(inner1, this.manager()));
    }
