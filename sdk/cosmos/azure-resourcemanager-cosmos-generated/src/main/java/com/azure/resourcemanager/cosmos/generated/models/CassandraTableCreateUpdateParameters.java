...
public final class CassandraTableCreateUpdateParameters extends ArmResourceProperties {
    ...
    /**
     * Reads an instance of CassandraTableCreateUpdateParameters from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of CassandraTableCreateUpdateParameters if the JsonReader was pointing to an instance of it,
     * or null if it was pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the CassandraTableCreateUpdateParameters.
     */
    public static CassandraTableCreateUpdateParameters fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            CassandraTableCreateUpdateParameters deserializedCassandraTableCreateUpdateParameters
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("id".equals(fieldName)) {
                    deserializedCassandraTableCreateUpdateParameters.id = reader.getString();
                } else if ("name".equals(fieldName)) {
                    deserializedCassandraTableCreateUpdateParameters.name = reader.getString();
                } else if ("type".equals(fieldName)) {
                    deserializedCassandraTableCreateUpdateParameters.type = reader.getString();
                } else if ("location".equals(fieldName)) {
                    deserializedCassandraTableCreateUpdateParameters.withLocation(reader.getString());
            ...
            return deserializedCassandraTableCreateUpdateParameters;
        });
    }
}
