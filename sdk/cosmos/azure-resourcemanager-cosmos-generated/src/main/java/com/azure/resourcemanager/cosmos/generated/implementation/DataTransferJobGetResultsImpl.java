...
import com.azure.resourcemanager.cosmos.generated.models.DataTransferJobMode;
...
public final class DataTransferJobGetResultsImpl
    ...
    DataTransferJobGetResultsImpl(DataTransferJobGetResultsInner innerObject,
    ...
    public DataTransferJobGetResults create() {
        this.innerObject = serviceManager.serviceClient().getDataTransferJobs()
    ...
    public DataTransferJobGetResults create(Context context) {
        this.innerObject = serviceManager.serviceClient().getDataTransferJobs()
            .createWithResponse(resourceGroupName, accountName, jobName, createJobCreateParameters, context).getValue();
        return this;
    }

    DataTransferJobGetResultsImpl(String name,
        com.azure.resourcemanager.cosmos.generated.CosmosDBManager serviceManager) {
    ...
    public DataTransferJobGetResults refresh() {
        this.innerObject = serviceManager.serviceClient().getDataTransferJobs()
            .getWithResponse(resourceGroupName, accountName, jobName, Context.NONE).getValue();
        return this;
    }

    public DataTransferJobGetResults refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getDataTransferJobs()
            .getWithResponse(resourceGroupName, accountName, jobName, context).getValue();
        return this;
    }
    ...
    public Response<DataTransferJobGetResults> completeWithResponse(Context context) {
        return serviceManager.dataTransferJobs().completeWithResponse(resourceGroupName, accountName, jobName, context);
    }

    public DataTransferJobGetResults complete() {
        return serviceManager.dataTransferJobs().complete(resourceGroupName, accountName, jobName);
    }
