...
import com.azure.resourcemanager.cosmos.generated.models.SqlContainerCreateUpdateParametersAutoGenerated;
...
public interface SqlResourcesClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<SqlContainerGetResultsAutoGeneratedInner> listSqlContainers(
        String resourceGroupName, String accountName, String databaseName);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<SqlContainerGetResultsAutoGeneratedInner> getSqlContainerWithResponse(
        String resourceGroupName, String accountName, String databaseName, String containerName, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    SqlContainerGetResultsAutoGeneratedInner getSqlContainer(
        String resourceGroupName, String accountName, String databaseName, String containerName);
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<SqlContainerGetResultsAutoGeneratedInner>, SqlContainerGetResultsAutoGeneratedInner>
        beginCreateUpdateSqlContainer(
            String resourceGroupName,
            String accountName,
            String databaseName,
            String containerName,
            SqlContainerCreateUpdateParametersAutoGenerated createUpdateSqlContainerParameters);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    SqlContainerGetResultsAutoGeneratedInner createUpdateSqlContainer(
        String resourceGroupName,
        String accountName,
        String databaseName,
        String containerName,
