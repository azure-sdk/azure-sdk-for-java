...
import com.azure.resourcemanager.cosmos.generated.models.RestorableGremlinDatabasesListResult;
...
public final class RestorableGremlinDatabasesClientImpl implements RestorableGremlinDatabasesClient {
    ...
    private interface RestorableGremlinDatabasesService {
        @Headers({"Content-Type: application/json"})
        @Get(
            "/subscriptions/{subscriptionId}/providers/Microsoft.DocumentDB/locations/{location}"
                + "/restorableDatabaseAccounts/{instanceId}/restorableGremlinDatabases")
