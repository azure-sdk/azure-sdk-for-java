...
import com.azure.resourcemanager.cosmos.generated.fluent.models.SqlTriggerCreateUpdateProperties;
...
public final class SqlTriggerCreateUpdateParameters extends ArmResourceProperties {
    ...
    public void validate() {
        ...
        if (location() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property location in model SqlTriggerCreateUpdateParameters"));
        }
        if (identity() != null) {
            identity().validate();
        }
