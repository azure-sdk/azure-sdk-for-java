...
import com.azure.resourcemanager.cosmos.generated.fluent.models.RetrieveThroughputProperties;
...
public final class RetrieveThroughputParameters extends ArmResourceProperties {
    ...
    public void validate() {
        ...
        if (location() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property location in model RetrieveThroughputParameters"));
        }
        if (identity() != null) {
            identity().validate();
        }
    ...
    /**
     * Reads an instance of RetrieveThroughputParameters from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of RetrieveThroughputParameters if the JsonReader was pointing to an instance of it, or null
     * if it was pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the RetrieveThroughputParameters.
     */
    public static RetrieveThroughputParameters fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            RetrieveThroughputParameters deserializedRetrieveThroughputParameters = new RetrieveThroughputParameters();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("id".equals(fieldName)) {
                    deserializedRetrieveThroughputParameters.id = reader.getString();
                } else if ("name".equals(fieldName)) {
                    deserializedRetrieveThroughputParameters.name = reader.getString();
                } else if ("type".equals(fieldName)) {
                    deserializedRetrieveThroughputParameters.type = reader.getString();
                } else if ("location".equals(fieldName)) {
                    deserializedRetrieveThroughputParameters.withLocation(reader.getString());
                } else if ("tags".equals(fieldName)) {
                    Map<String, String> tags = reader.readMap(reader1 -> reader1.getString());
                    deserializedRetrieveThroughputParameters.withTags(tags);
                } else if ("identity".equals(fieldName)) {
                    deserializedRetrieveThroughputParameters.withIdentity(ManagedServiceIdentity.fromJson(reader));
                } else if ("properties".equals(fieldName)) {
                    deserializedRetrieveThroughputParameters.innerProperties
                        = RetrieveThroughputProperties.fromJson(reader);
                } else {
                    reader.skipChildren();
                }
            }

            return deserializedRetrieveThroughputParameters;
        });
    }
}
