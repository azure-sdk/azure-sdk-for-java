...
public final class CassandraTableGetResultsImpl
    ...
    public CassandraTableGetResults create() {
        this.innerObject = serviceManager.serviceClient()
            ...
            .createUpdateCassandraTable(resourceGroupName, accountName, keyspaceName, tableName,
                createCreateUpdateCassandraTableParameters, Context.NONE);
        return this;
    }
    ...
    public CassandraTableGetResults create(Context context) {
        this.innerObject = serviceManager.serviceClient()
            .getCassandraResources()
            .createUpdateCassandraTable(resourceGroupName, accountName, keyspaceName, tableName,
                createCreateUpdateCassandraTableParameters, context);
        return this;
    }
    ...
    public CassandraTableGetResults apply() {
        this.innerObject = serviceManager.serviceClient()
            .getCassandraResources()
            .createUpdateCassandraTable(resourceGroupName, accountName, keyspaceName, tableName,
                updateCreateUpdateCassandraTableParameters, Context.NONE);
        return this;
    }
    ...
    public CassandraTableGetResults apply(Context context) {
        this.innerObject = serviceManager.serviceClient()
            .getCassandraResources()
            .createUpdateCassandraTable(resourceGroupName, accountName, keyspaceName, tableName,
                updateCreateUpdateCassandraTableParameters, context);
        return this;
    }
