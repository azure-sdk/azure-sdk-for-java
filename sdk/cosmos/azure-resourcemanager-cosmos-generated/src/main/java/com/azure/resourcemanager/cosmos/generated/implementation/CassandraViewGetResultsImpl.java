...
public final class CassandraViewGetResultsImpl
    ...
    public CassandraViewGetResultsImpl withExistingCassandraKeyspace(String resourceGroupName, String accountName,
        String keyspaceName) {
    ...
    public CassandraViewGetResults create() {
        this.innerObject
            = serviceManager.serviceClient().getCassandraResources().createUpdateCassandraView(resourceGroupName,
                accountName, keyspaceName, viewName, createCreateUpdateCassandraViewParameters, Context.NONE);
        return this;
    }

    public CassandraViewGetResults create(Context context) {
        this.innerObject = serviceManager.serviceClient().getCassandraResources().createUpdateCassandraView(
            resourceGroupName, accountName, keyspaceName, viewName, createCreateUpdateCassandraViewParameters, context);
        return this;
    }

    CassandraViewGetResultsImpl(String name,
    ...
    public CassandraViewGetResults apply() {
        this.innerObject
            = serviceManager.serviceClient().getCassandraResources().createUpdateCassandraView(resourceGroupName,
                accountName, keyspaceName, viewName, updateCreateUpdateCassandraViewParameters, Context.NONE);
        return this;
    }

    public CassandraViewGetResults apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getCassandraResources().createUpdateCassandraView(
            resourceGroupName, accountName, keyspaceName, viewName, updateCreateUpdateCassandraViewParameters, context);
        return this;
    }

    CassandraViewGetResultsImpl(CassandraViewGetResultsInner innerObject,
        com.azure.resourcemanager.cosmos.generated.CosmosDBManager serviceManager) {
    ...
    public CassandraViewGetResults refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getCassandraResources()
            .getCassandraViewWithResponse(resourceGroupName, accountName, keyspaceName, viewName, context).getValue();
        return this;
    }
