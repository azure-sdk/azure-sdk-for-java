...
public interface CassandraDataCentersClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<DataCenterResourceAutoGeneratedInner> list(String resourceGroupName, String clusterName);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<DataCenterResourceAutoGeneratedInner> list(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<DataCenterResourceAutoGeneratedInner> getWithResponse(
        String resourceGroupName, String clusterName, String dataCenterName, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    DataCenterResourceAutoGeneratedInner get(String resourceGroupName, String clusterName, String dataCenterName);
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<DataCenterResourceAutoGeneratedInner>, DataCenterResourceAutoGeneratedInner>
        beginCreateUpdate(
            String resourceGroupName,
            String clusterName,
            String dataCenterName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    DataCenterResourceAutoGeneratedInner createUpdate(
        String resourceGroupName, String clusterName, String dataCenterName, DataCenterResourceAutoGeneratedInner body);
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<DataCenterResourceAutoGeneratedInner>, DataCenterResourceAutoGeneratedInner> beginUpdate(
        String resourceGroupName, String clusterName, String dataCenterName, DataCenterResourceAutoGeneratedInner body);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    DataCenterResourceAutoGeneratedInner update(
        String resourceGroupName, String clusterName, String dataCenterName, DataCenterResourceAutoGeneratedInner body);
