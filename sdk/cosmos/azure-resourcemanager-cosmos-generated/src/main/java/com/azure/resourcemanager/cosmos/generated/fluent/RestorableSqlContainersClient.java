...
public interface RestorableSqlContainersClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<RestorableSqlContainerGetResultAutoGeneratedInner> list(String location, String instanceId);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<RestorableSqlContainerGetResultAutoGeneratedInner> list(
        String location,
        String instanceId,
        String restorableSqlDatabaseRid,
        String startTime,
