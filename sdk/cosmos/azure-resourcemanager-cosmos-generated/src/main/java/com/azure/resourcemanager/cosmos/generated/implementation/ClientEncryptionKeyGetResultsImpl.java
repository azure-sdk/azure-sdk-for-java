...
public final class ClientEncryptionKeyGetResultsImpl implements ClientEncryptionKeyGetResults,
    ClientEncryptionKeyGetResults.Definition, ClientEncryptionKeyGetResults.Update {
    ...
    public ClientEncryptionKeyGetResultsImpl withExistingSqlDatabase(String resourceGroupName, String accountName,
        String databaseName) {
    ...
    public ClientEncryptionKeyGetResults create() {
        this.innerObject = serviceManager.serviceClient().getSqlResources().createUpdateClientEncryptionKey(
            resourceGroupName, accountName, databaseName, clientEncryptionKeyName,
            createCreateUpdateClientEncryptionKeyParameters, Context.NONE);
        return this;
    }
    ...
    public ClientEncryptionKeyGetResults create(Context context) {
        this.innerObject = serviceManager.serviceClient().getSqlResources().createUpdateClientEncryptionKey(
            resourceGroupName, accountName, databaseName, clientEncryptionKeyName,
            createCreateUpdateClientEncryptionKeyParameters, context);
        return this;
    }

    ClientEncryptionKeyGetResultsImpl(String name,
    ...
    public ClientEncryptionKeyGetResults apply() {
        this.innerObject = serviceManager.serviceClient().getSqlResources().createUpdateClientEncryptionKey(
            resourceGroupName, accountName, databaseName, clientEncryptionKeyName,
            updateCreateUpdateClientEncryptionKeyParameters, Context.NONE);
        return this;
    }
    ...
    public ClientEncryptionKeyGetResults apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getSqlResources().createUpdateClientEncryptionKey(
            resourceGroupName, accountName, databaseName, clientEncryptionKeyName,
            updateCreateUpdateClientEncryptionKeyParameters, context);
        return this;
    }

    ClientEncryptionKeyGetResultsImpl(ClientEncryptionKeyGetResultsInner innerObject,
        com.azure.resourcemanager.cosmos.generated.CosmosDBManager serviceManager) {
    ...
    public ClientEncryptionKeyGetResults refresh() {
        this.innerObject
            = serviceManager.serviceClient().getSqlResources().getClientEncryptionKeyWithResponse(resourceGroupName,
                accountName, databaseName, clientEncryptionKeyName, Context.NONE).getValue();
        return this;
    }
    ...
    public ClientEncryptionKeyGetResults refresh(Context context) {
        this.innerObject
            = serviceManager.serviceClient().getSqlResources().getClientEncryptionKeyWithResponse(resourceGroupName,
                accountName, databaseName, clientEncryptionKeyName, context).getValue();
        return this;
    }
