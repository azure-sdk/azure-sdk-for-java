...
import com.azure.resourcemanager.cosmos.generated.implementation.CopyJobsImpl;
...
import com.azure.resourcemanager.cosmos.generated.implementation.FleetAnalyticsImpl;
import com.azure.resourcemanager.cosmos.generated.implementation.FleetsImpl;
import com.azure.resourcemanager.cosmos.generated.implementation.FleetspaceAccountsImpl;
import com.azure.resourcemanager.cosmos.generated.implementation.FleetspacesImpl;
...
import com.azure.resourcemanager.cosmos.generated.implementation.MongoMIResourcesImpl;
...
public final class CosmosDBManager {
    ...
    private MongoMIResources mongoMIResources;
    ...
    private FleetspaceAccounts fleetspaceAccounts;
    ...
    /**
     * Gets the resource collection API of CopyJobs. It manages CopyJobGetResults.
     * 
     * @return Resource collection API of CopyJobs.
     */
    public CopyJobs copyJobs() {
        if (this.copyJobs == null) {
            this.copyJobs = new CopyJobsImpl(clientObject.getCopyJobs(), this);
        }
        return copyJobs;
    }
     ...
     * CassandraTableGetResults, CassandraViewGetResults, CassandraRoleDefinitionResource,
     ...
     * GremlinGraphGetResults, GremlinRoleDefinitionResource, GremlinRoleAssignmentResource.
     * 
    ...
    /**
     * Gets the resource collection API of MongoMIResources. It manages MongoMIRoleDefinitionResource,
     * MongoMIRoleAssignmentResource.
     * 
     * @return Resource collection API of MongoMIResources.
     */
    public MongoMIResources mongoMIResources() {
        if (this.mongoMIResources == null) {
            this.mongoMIResources = new MongoMIResourcesImpl(clientObject.getMongoMIResources(), this);
        }
        return mongoMIResources;
    }

    /**
     * Gets the resource collection API of Fleets. It manages FleetResource.
     * 
    ...
    /**
     * Gets the resource collection API of FleetAnalytics. It manages FleetAnalyticsResource.
     * 
     * @return Resource collection API of FleetAnalytics.
     */
    public FleetAnalytics fleetAnalytics() {
        if (this.fleetAnalytics == null) {
            this.fleetAnalytics = new FleetAnalyticsImpl(clientObject.getFleetAnalytics(), this);
        }
        return fleetAnalytics;
    }

    /**
     * Gets the resource collection API of Fleetspaces. It manages FleetspaceResource.
     * 
    ...
    /**
     * Gets the resource collection API of FleetspaceAccounts. It manages FleetspaceAccountResource.
     * 
     * @return Resource collection API of FleetspaceAccounts.
     */
    public FleetspaceAccounts fleetspaceAccounts() {
        if (this.fleetspaceAccounts == null) {
            this.fleetspaceAccounts = new FleetspaceAccountsImpl(clientObject.getFleetspaceAccounts(), this);
        }
        return fleetspaceAccounts;
    }
