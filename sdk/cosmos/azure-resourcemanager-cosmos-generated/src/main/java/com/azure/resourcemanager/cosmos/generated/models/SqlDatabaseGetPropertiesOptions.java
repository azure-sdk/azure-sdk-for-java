...
public final class SqlDatabaseGetPropertiesOptions extends OptionsResource {
     ...
     * @return An instance of SqlDatabaseGetPropertiesOptions if the JsonReader was pointing to an instance of it, or
     * null if it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the SqlDatabaseGetPropertiesOptions.
     */
    public static SqlDatabaseGetPropertiesOptions fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            SqlDatabaseGetPropertiesOptions deserializedSqlDatabaseGetPropertiesOptions
                = new SqlDatabaseGetPropertiesOptions();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("throughput".equals(fieldName)) {
                    deserializedSqlDatabaseGetPropertiesOptions.withThroughput(reader.getNullable(JsonReader::getInt));
                } else if ("autoscaleSettings".equals(fieldName)) {
                    deserializedSqlDatabaseGetPropertiesOptions
