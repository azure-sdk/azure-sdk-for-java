...
public final class DataTransferJobsClientImpl implements DataTransferJobsClient {
    ...
    private interface DataTransferJobsService {
        ...
        @Post(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DocumentDB"
                + "/databaseAccounts/{accountName}/dataTransferJobs/{jobName}/pause")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        ...
        @Post(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DocumentDB"
                + "/databaseAccounts/{accountName}/dataTransferJobs/{jobName}/resume")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        ...
        @Post(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DocumentDB"
                + "/databaseAccounts/{accountName}/dataTransferJobs/{jobName}/cancel")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
    ...
    public DataTransferJobGetResultsInner pause(String resourceGroupName, String accountName, String jobName) {
        return pauseAsync(resourceGroupName, accountName, jobName).block();
    }
    ...
    public DataTransferJobGetResultsInner resume(String resourceGroupName, String accountName, String jobName) {
        return resumeAsync(resourceGroupName, accountName, jobName).block();
    }
    ...
    public DataTransferJobGetResultsInner cancel(String resourceGroupName, String accountName, String jobName) {
        return cancelAsync(resourceGroupName, accountName, jobName).block();
    }
