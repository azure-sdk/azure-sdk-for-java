...
/**
 * An immutable client-side representation of GremlinRoleDefinitionResource.
 */
public interface GremlinRoleDefinitionResource {
    /**
    ...
    /**
     * Gets the assignableScopes property: A set of fully qualified Scopes at or below which Gremlin Role Assignments
     ...
     */
    List<PermissionAutoGenerated4> permissions();
    ...
    /**
     * Gets the inner com.azure.resourcemanager.cosmos.generated.fluent.models.GremlinRoleDefinitionResourceInner
     * object.
     * 
     * @return the inner object.
     */
    GremlinRoleDefinitionResourceInner innerModel();

    /**
     * The entirety of the GremlinRoleDefinitionResource definition.
     */
    ...
    /**
     * The GremlinRoleDefinitionResource definition stages.
     */
    interface DefinitionStages {
        /**
         * The first stage of the GremlinRoleDefinitionResource definition.
         */
        interface Blank extends WithParentResource {
        }

        /**
         * The stage of the GremlinRoleDefinitionResource definition allowing to specify parent resource.
         */
        ...
        /**
         * The stage of the GremlinRoleDefinitionResource definition which contains all the minimum required properties
        ...
        interface WithCreate extends DefinitionStages.WithIdPropertiesId, DefinitionStages.WithRoleName,
             ...
             */
            GremlinRoleDefinitionResource create();
             ...
             * @return the created resource.
             */
            GremlinRoleDefinitionResource create(Context context);
        }

        /**
         * The stage of the GremlinRoleDefinitionResource definition allowing to specify idPropertiesId.
         */
        ...
        /**
         * The stage of the GremlinRoleDefinitionResource definition allowing to specify roleName.
         */
        ...
        /**
         * The stage of the GremlinRoleDefinitionResource definition allowing to specify typePropertiesType.
         */
        ...
        /**
         * The stage of the GremlinRoleDefinitionResource definition allowing to specify assignableScopes.
         */
        interface WithAssignableScopes {
            /**
             * Specifies the assignableScopes property: A set of fully qualified Scopes at or below which Gremlin Role
             ...
             * 
             * @param assignableScopes A set of fully qualified Scopes at or below which Gremlin Role Assignments may be
        ...
        /**
         * The stage of the GremlinRoleDefinitionResource definition allowing to specify permissions.
         */
        interface WithPermissions {
             ...
             * @return the next definition stage.
             */
            WithCreate withPermissions(List<PermissionAutoGenerated4> permissions);
        }
    }

    /**
     * Begins update for the GremlinRoleDefinitionResource resource.
     * 
     * @return the stage of resource update.
     */
    GremlinRoleDefinitionResource.Update update();

    /**
     * The template for GremlinRoleDefinitionResource update.
     */
    interface Update extends UpdateStages.WithIdPropertiesId, UpdateStages.WithRoleName,
         ...
         */
        GremlinRoleDefinitionResource apply();
         ...
         * @return the updated resource.
         */
        GremlinRoleDefinitionResource apply(Context context);
    }

    /**
     * The GremlinRoleDefinitionResource update stages.
     */
    interface UpdateStages {
        /**
         * The stage of the GremlinRoleDefinitionResource update allowing to specify idPropertiesId.
         */
        interface WithIdPropertiesId {
            /**
             * Specifies the idPropertiesId property: The path id for the Role Definition..
        ...
        /**
         * The stage of the GremlinRoleDefinitionResource update allowing to specify roleName.
         */
        interface WithRoleName {
            /**
             * Specifies the roleName property: A user-friendly name for the Role Definition. Must be unique for the
        ...
        /**
         * The stage of the GremlinRoleDefinitionResource update allowing to specify typePropertiesType.
         */
        interface WithTypePropertiesType {
            /**
             * Specifies the typePropertiesType property: Indicates whether the Role Definition was built-in or user
        ...
        /**
         * The stage of the GremlinRoleDefinitionResource update allowing to specify assignableScopes.
         */
        interface WithAssignableScopes {
            /**
             * Specifies the assignableScopes property: A set of fully qualified Scopes at or below which Gremlin Role
        ...
        /**
         * The stage of the GremlinRoleDefinitionResource update allowing to specify permissions.
         */
        interface WithPermissions {
            /**
             * Specifies the permissions property: The set of operations allowed through this Role Definition..
             ...
             * @return the next definition stage.
             */
            Update withPermissions(List<PermissionAutoGenerated4> permissions);
        }
    }
     ...
     */
    GremlinRoleDefinitionResource refresh();
     ...
     * @return the refreshed resource.
     */
    GremlinRoleDefinitionResource refresh(Context context);
}
