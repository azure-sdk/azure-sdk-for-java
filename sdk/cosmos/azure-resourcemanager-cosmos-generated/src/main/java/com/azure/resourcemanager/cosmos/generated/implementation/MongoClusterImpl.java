...
public final class MongoClusterImpl implements MongoCluster, MongoCluster.Definition, MongoCluster.Update {
    ...
    MongoClusterImpl(
        MongoClusterInner innerObject, com.azure.resourcemanager.cosmos.generated.CosmosDBManager serviceManager) {
    ...
    public MongoCluster refresh() {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getMongoClusters()
                .getWithResponse(resourceGroupName, mongoClusterName, Context.NONE)
                .getValue();
        return this;
    }
    ...
    public MongoCluster refresh(Context context) {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getMongoClusters()
                .getWithResponse(resourceGroupName, mongoClusterName, context)
                .getValue();
        return this;
    }
    ...
    public MongoClusterImpl withClusterStatus(MongoClusterStatus clusterStatus) {
        if (isInCreateMode()) {
            this.innerModel().withClusterStatus(clusterStatus);
            return this;
        } else {
            this.updateParameters.withClusterStatus(clusterStatus);
            return this;
        }
    }
