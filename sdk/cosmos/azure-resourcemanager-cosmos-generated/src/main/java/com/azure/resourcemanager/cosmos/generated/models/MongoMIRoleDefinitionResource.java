...
/**
 * An immutable client-side representation of MongoMIRoleDefinitionResource.
 */
public interface MongoMIRoleDefinitionResource {
    /**
    ...
    /**
     * Gets the assignableScopes property: A set of fully qualified Scopes at or below which MongoMI Role Assignments
    ...
    /**
     * Gets the inner com.azure.resourcemanager.cosmos.generated.fluent.models.MongoMIRoleDefinitionResourceInner
     * object.
     * 
     * @return the inner object.
     */
    MongoMIRoleDefinitionResourceInner innerModel();

    /**
     * The entirety of the MongoMIRoleDefinitionResource definition.
     */
    ...
    /**
     * The MongoMIRoleDefinitionResource definition stages.
     */
    interface DefinitionStages {
        /**
         * The first stage of the MongoMIRoleDefinitionResource definition.
         */
        interface Blank extends WithParentResource {
        }

        /**
         * The stage of the MongoMIRoleDefinitionResource definition allowing to specify parent resource.
         */
        ...
        /**
         * The stage of the MongoMIRoleDefinitionResource definition which contains all the minimum required properties
        ...
        interface WithCreate extends DefinitionStages.WithIdPropertiesId, DefinitionStages.WithRoleName,
             ...
             */
            MongoMIRoleDefinitionResource create();
             ...
             * @return the created resource.
             */
            MongoMIRoleDefinitionResource create(Context context);
        }

        /**
         * The stage of the MongoMIRoleDefinitionResource definition allowing to specify idPropertiesId.
         */
        ...
        /**
         * The stage of the MongoMIRoleDefinitionResource definition allowing to specify roleName.
         */
        ...
        /**
         * The stage of the MongoMIRoleDefinitionResource definition allowing to specify typePropertiesType.
         */
        ...
        /**
         * The stage of the MongoMIRoleDefinitionResource definition allowing to specify assignableScopes.
         */
        interface WithAssignableScopes {
            /**
             * Specifies the assignableScopes property: A set of fully qualified Scopes at or below which MongoMI Role
             ...
             * 
             * @param assignableScopes A set of fully qualified Scopes at or below which MongoMI Role Assignments may be
        ...
        /**
         * The stage of the MongoMIRoleDefinitionResource definition allowing to specify permissions.
         */
        interface WithPermissions {
             ...
             * @return the next definition stage.
             */
            WithCreate withPermissions(List<PermissionAutoGenerated3> permissions);
        }
    }

    /**
     * Begins update for the MongoMIRoleDefinitionResource resource.
     * 
     * @return the stage of resource update.
     */
    MongoMIRoleDefinitionResource.Update update();

    /**
     * The template for MongoMIRoleDefinitionResource update.
     */
    interface Update extends UpdateStages.WithIdPropertiesId, UpdateStages.WithRoleName,
         ...
         */
        MongoMIRoleDefinitionResource apply();
         ...
         * @return the updated resource.
         */
        MongoMIRoleDefinitionResource apply(Context context);
    }

    /**
     * The MongoMIRoleDefinitionResource update stages.
     */
    interface UpdateStages {
        /**
         * The stage of the MongoMIRoleDefinitionResource update allowing to specify idPropertiesId.
         */
        interface WithIdPropertiesId {
            /**
             * Specifies the idPropertiesId property: The path id for the Role Definition..
        ...
        /**
         * The stage of the MongoMIRoleDefinitionResource update allowing to specify roleName.
         */
        interface WithRoleName {
            /**
             * Specifies the roleName property: A user-friendly name for the Role Definition. Must be unique for the
        ...
        /**
         * The stage of the MongoMIRoleDefinitionResource update allowing to specify typePropertiesType.
         */
        interface WithTypePropertiesType {
            /**
             * Specifies the typePropertiesType property: Indicates whether the Role Definition was built-in or user
        ...
        /**
         * The stage of the MongoMIRoleDefinitionResource update allowing to specify assignableScopes.
         */
        interface WithAssignableScopes {
            /**
             * Specifies the assignableScopes property: A set of fully qualified Scopes at or below which MongoMI Role
        ...
        /**
         * The stage of the MongoMIRoleDefinitionResource update allowing to specify permissions.
         */
        interface WithPermissions {
            /**
             * Specifies the permissions property: The set of operations allowed through this Role Definition..
             ...
             * @return the next definition stage.
             */
            Update withPermissions(List<PermissionAutoGenerated3> permissions);
        }
    }
     ...
     */
    MongoMIRoleDefinitionResource refresh();
     ...
     * @return the refreshed resource.
     */
    MongoMIRoleDefinitionResource refresh(Context context);
}
