...
@Fluent
public final class DataCenterResourcePropertiesAutoGenerated {
    /*
    ...
    /*
     * If the data center has Availability Zone feature, apply it to the Virtual Machine ScaleSet that host the
    ...
    /** Creates an instance of DataCenterResourcePropertiesAutoGenerated class. */
    public DataCenterResourcePropertiesAutoGenerated() {
    }
     ...
     * @return the DataCenterResourcePropertiesAutoGenerated object itself.
     */
    public DataCenterResourcePropertiesAutoGenerated withProvisioningState(
     ...
     * @return the DataCenterResourcePropertiesAutoGenerated object itself.
     */
    public DataCenterResourcePropertiesAutoGenerated withDataCenterLocation(String dataCenterLocation) {
     ...
     * @return the DataCenterResourcePropertiesAutoGenerated object itself.
     */
    public DataCenterResourcePropertiesAutoGenerated withDelegatedSubnetId(String delegatedSubnetId) {
     ...
     * @return the DataCenterResourcePropertiesAutoGenerated object itself.
     */
    public DataCenterResourcePropertiesAutoGenerated withNodeCount(Integer nodeCount) {
     ...
     * @return the DataCenterResourcePropertiesAutoGenerated object itself.
     */
    public DataCenterResourcePropertiesAutoGenerated withBase64EncodedCassandraYamlFragment(
     ...
     * @return the DataCenterResourcePropertiesAutoGenerated object itself.
     */
    public DataCenterResourcePropertiesAutoGenerated withManagedDiskCustomerKeyUri(String managedDiskCustomerKeyUri) {
     ...
     * @return the DataCenterResourcePropertiesAutoGenerated object itself.
     */
    public DataCenterResourcePropertiesAutoGenerated withBackupStorageCustomerKeyUri(
     ...
     * @return the DataCenterResourcePropertiesAutoGenerated object itself.
     */
    public DataCenterResourcePropertiesAutoGenerated withSku(String sku) {
        this.sku = sku;
        return this;
    }
     ...
     * @return the DataCenterResourcePropertiesAutoGenerated object itself.
     */
    public DataCenterResourcePropertiesAutoGenerated withDiskSku(String diskSku) {
     ...
     * @return the DataCenterResourcePropertiesAutoGenerated object itself.
     */
    public DataCenterResourcePropertiesAutoGenerated withDiskCapacity(Integer diskCapacity) {
     ...
     * @return the DataCenterResourcePropertiesAutoGenerated object itself.
     */
    public DataCenterResourcePropertiesAutoGenerated withAvailabilityZone(Boolean availabilityZone) {
     ...
     * @return the DataCenterResourcePropertiesAutoGenerated object itself.
     */
    public DataCenterResourcePropertiesAutoGenerated withAuthenticationMethodLdapProperties(
