 ...
 */
@Fluent
public final class MongoMIRoleDefinitionResourceProperties
    implements JsonSerializable<MongoMIRoleDefinitionResourceProperties> {
    /*
    ...
    /*
     * A set of fully qualified Scopes at or below which MongoMI Role Assignments may be created using this Role
     ...
     */
    private List<PermissionAutoGenerated3> permissions;

    /**
     * Creates an instance of MongoMIRoleDefinitionResourceProperties class.
     */
     ...
     * @return the MongoMIRoleDefinitionResourceProperties object itself.
     */
    public MongoMIRoleDefinitionResourceProperties withId(String id) {
        this.id = id;
        return this;
    }
     ...
     * @return the MongoMIRoleDefinitionResourceProperties object itself.
     */
    public MongoMIRoleDefinitionResourceProperties withRoleName(String roleName) {
     ...
     * @return the MongoMIRoleDefinitionResourceProperties object itself.
     */
    public MongoMIRoleDefinitionResourceProperties withType(RoleDefinitionType type) {
        this.type = type;
        return this;
    }

    /**
     * Get the assignableScopes property: A set of fully qualified Scopes at or below which MongoMI Role Assignments may
    ...
    /**
     * Set the assignableScopes property: A set of fully qualified Scopes at or below which MongoMI Role Assignments may
     * be created using this Role Definition. This will allow application of this Role Definition on the entire database
     * account or any underlying Database / Collection. Must have at least one element. Scopes higher than Database
     * account are not enforceable as assignable Scopes. Note that resources referenced in assignable Scopes need not
     * exist.
     ...
     * @return the MongoMIRoleDefinitionResourceProperties object itself.
     */
    public MongoMIRoleDefinitionResourceProperties withAssignableScopes(List<String> assignableScopes) {
     ...
     * @return the MongoMIRoleDefinitionResourceProperties object itself.
     */
    public MongoMIRoleDefinitionResourceProperties withPermissions(List<PermissionAutoGenerated3> permissions) {
    ...
    /**
     * Reads an instance of MongoMIRoleDefinitionResourceProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of MongoMIRoleDefinitionResourceProperties if the JsonReader was pointing to an instance of
     * it, or null if it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the MongoMIRoleDefinitionResourceProperties.
     */
    public static MongoMIRoleDefinitionResourceProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            MongoMIRoleDefinitionResourceProperties deserializedMongoMIRoleDefinitionResourceProperties
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("id".equals(fieldName)) {
                    deserializedMongoMIRoleDefinitionResourceProperties.id = reader.getString();
                } else if ("roleName".equals(fieldName)) {
                    deserializedMongoMIRoleDefinitionResourceProperties.roleName = reader.getString();
                } else if ("type".equals(fieldName)) {
                    deserializedMongoMIRoleDefinitionResourceProperties.type
                    ...
                    deserializedMongoMIRoleDefinitionResourceProperties.assignableScopes = assignableScopes;
                } else if ("permissions".equals(fieldName)) {
                    List<PermissionAutoGenerated3> permissions
                        = reader.readArray(reader1 -> PermissionAutoGenerated3.fromJson(reader1));
                    deserializedMongoMIRoleDefinitionResourceProperties.permissions = permissions;
                } else {
                    reader.skipChildren();
                }
            }

            return deserializedMongoMIRoleDefinitionResourceProperties;
        });
    }
}
