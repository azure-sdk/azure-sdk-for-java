...
import com.azure.resourcemanager.cosmos.generated.models.RestorableSqlContainersListResult;
import com.azure.resourcemanager.cosmos.generated.models.RestorableSqlContainersListResultAutoGenerated;
...
public final class RestorableSqlContainersClientImpl implements RestorableSqlContainersClient {
    ...
    /**
     * The interface defining all the services for CosmosDBManagementClientRestorableSqlContainers to be used by the
    ...
    public interface RestorableSqlContainersService {
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<RestorableSqlContainersListResultAutoGenerated>> list(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("location") String location,
    ...
    public PagedIterable<RestorableSqlContainerGetResultInner> list(String location, String instanceId) {
        ...
        final String startTime = null;
        final String endTime = null;
        return new PagedIterable<>(listAsync(location, instanceId, restorableSqlDatabaseRid, startTime, endTime));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<RestorableSqlContainerGetResultAutoGeneratedInner>> listSinglePageAsync(
        String location, String instanceId, String restorableSqlDatabaseRid, String startTime, String endTime) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                ...
                context ->
                    service
                        .list(
                            ...
                            accept,
                            context))
            .<PagedResponse<RestorableSqlContainerGetResultAutoGeneratedInner>>map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(), null, null))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<RestorableSqlContainerGetResultAutoGeneratedInner> listAsync(
        String location, String instanceId, String restorableSqlDatabaseRid, String startTime, String endTime) {
        return new PagedFlux<>(
            () -> listSinglePageAsync(location, instanceId, restorableSqlDatabaseRid, startTime, endTime));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<RestorableSqlContainerGetResultAutoGeneratedInner> listAsync(String location, String instanceId) {
        final String restorableSqlDatabaseRid = null;
        final String startTime = null;
        final String endTime = null;
        return new PagedFlux<>(
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<RestorableSqlContainerGetResultAutoGeneratedInner> list(String location, String instanceId) {
        final String restorableSqlDatabaseRid = null;
        final String startTime = null;
        final String endTime = null;
        return new PagedIterable<>(listAsync(location, instanceId, restorableSqlDatabaseRid, startTime, endTime));
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<RestorableSqlContainerGetResultAutoGeneratedInner> list(
        String location,
        String instanceId,
        String restorableSqlDatabaseRid,
        String startTime,
