...
public final class CassandraDataCentersImpl implements CassandraDataCenters {
    ...
    public PagedIterable<DataCenterResourceAutoGenerated> list(String resourceGroupName, String clusterName) {
        PagedIterable<DataCenterResourceAutoGeneratedInner> inner =
            this.serviceClient().list(resourceGroupName, clusterName);
        return Utils.mapPage(inner, inner1 -> new DataCenterResourceAutoGeneratedImpl(inner1, this.manager()));
    }

    public PagedIterable<DataCenterResourceAutoGenerated> list(
    ...
    public Response<DataCenterResourceAutoGenerated> getWithResponse(
        String resourceGroupName, String clusterName, String dataCenterName, Context context) {
        Response<DataCenterResourceAutoGeneratedInner> inner =
            this.serviceClient().getWithResponse(resourceGroupName, clusterName, dataCenterName, context);
        if (inner != null) {
            return new SimpleResponse<>(
                inner.getRequest(),
                inner.getStatusCode(),
                inner.getHeaders(),
                new DataCenterResourceAutoGeneratedImpl(inner.getValue(), this.manager()));
        } else {
            return null;
        }
    }

    public DataCenterResourceAutoGenerated get(String resourceGroupName, String clusterName, String dataCenterName) {
        DataCenterResourceAutoGeneratedInner inner =
            this.serviceClient().get(resourceGroupName, clusterName, dataCenterName);
        if (inner != null) {
            return new DataCenterResourceAutoGeneratedImpl(inner, this.manager());
        } else {
            return null;
        }
    }
    ...
    public DataCenterResourceImpl defineUpdate(String name) {
        return new DataCenterResourceImpl(name, this.manager());
    }

    public DataCenterResourceAutoGeneratedImpl defineUpdate(String name) {
        return new DataCenterResourceAutoGeneratedImpl(name, this.manager());
    }
}
