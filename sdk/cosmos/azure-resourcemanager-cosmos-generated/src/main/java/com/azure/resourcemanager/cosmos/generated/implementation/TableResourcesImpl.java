...
public final class TableResourcesImpl implements TableResources {
    ...
    public ThroughputSettingsGetResults updateTableThroughput(String resourceGroupName, String accountName,
        ...
        ThroughputSettingsGetResultsInner inner = this.serviceClient().updateTableThroughput(resourceGroupName,
            accountName, tableName, updateThroughputParameters);
        if (inner != null) {
            return new ThroughputSettingsGetResultsImpl(inner, this.manager());
        } else {
            return null;
    ...
    public ThroughputSettingsGetResults updateTableThroughput(String resourceGroupName, String accountName,
        ...
        ThroughputSettingsGetResultsInner inner = this.serviceClient().updateTableThroughput(resourceGroupName,
            accountName, tableName, updateThroughputParameters, context);
        if (inner != null) {
            return new ThroughputSettingsGetResultsImpl(inner, this.manager());
        } else {
            return null;
    ...
    public BackupInformation retrieveContinuousBackupInformation(String resourceGroupName, String accountName,
        ...
        BackupInformationInner inner = this.serviceClient().retrieveContinuousBackupInformation(resourceGroupName,
            accountName, tableName, location);
        if (inner != null) {
