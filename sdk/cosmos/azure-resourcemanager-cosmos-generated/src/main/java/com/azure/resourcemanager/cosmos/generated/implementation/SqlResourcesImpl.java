...
public final class SqlResourcesImpl implements SqlResources {
    ...
    public PagedIterable<SqlContainerGetResultsAutoGenerated> listSqlContainers(
        String resourceGroupName, String accountName, String databaseName) {
        PagedIterable<SqlContainerGetResultsAutoGeneratedInner> inner =
            this.serviceClient().listSqlContainers(resourceGroupName, accountName, databaseName);
        return Utils.mapPage(inner, inner1 -> new SqlContainerGetResultsAutoGeneratedImpl(inner1, this.manager()));
    }
    ...
    public Response<SqlContainerGetResultsAutoGenerated> getSqlContainerWithResponse(
        String resourceGroupName, String accountName, String databaseName, String containerName, Context context) {
        Response<SqlContainerGetResultsAutoGeneratedInner> inner =
            this
                .serviceClient()
                .getSqlContainerWithResponse(resourceGroupName, accountName, databaseName, containerName, context);
        if (inner != null) {
            return new SimpleResponse<>(
                ...
                inner.getStatusCode(),
                inner.getHeaders(),
                new SqlContainerGetResultsAutoGeneratedImpl(inner.getValue(), this.manager()));
        } else {
            return null;
        }
    }

    public SqlContainerGetResultsAutoGenerated getSqlContainer(
        String resourceGroupName, String accountName, String databaseName, String containerName) {
        SqlContainerGetResultsAutoGeneratedInner inner =
            this.serviceClient().getSqlContainer(resourceGroupName, accountName, databaseName, containerName);
        if (inner != null) {
            return new SqlContainerGetResultsAutoGeneratedImpl(inner, this.manager());
        } else {
            return null;
        }
    }
    ...
    public SqlContainerGetResultsAutoGeneratedImpl defineUpdateSqlContainer(String name) {
        return new SqlContainerGetResultsAutoGeneratedImpl(name, this.manager());
    }
}
