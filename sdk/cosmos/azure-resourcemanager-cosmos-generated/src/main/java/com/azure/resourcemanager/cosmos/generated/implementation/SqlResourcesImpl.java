...
public final class SqlResourcesImpl implements SqlResources {
    ...
    public Response<ThroughputSettingsGetResults> getSqlContainerThroughputWithResponse(String resourceGroupName,
        ...
        Response<ThroughputSettingsGetResultsInner> inner = this.serviceClient()
            .getSqlContainerThroughputWithResponse(resourceGroupName, accountName, databaseName, containerName,
                context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
                new ThroughputSettingsGetResultsImpl(inner.getValue(), this.manager()));
    ...
    public ThroughputSettingsGetResults updateSqlContainerThroughput(String resourceGroupName, String accountName,
        ...
        ThroughputSettingsGetResultsInner inner = this.serviceClient()
            .updateSqlContainerThroughput(resourceGroupName, accountName, databaseName, containerName,
    ...
    public Response<ClientEncryptionKeyGetResults> getClientEncryptionKeyWithResponse(String resourceGroupName,
        ...
        Response<ClientEncryptionKeyGetResultsInner> inner = this.serviceClient()
            .getClientEncryptionKeyWithResponse(resourceGroupName, accountName, databaseName, clientEncryptionKeyName,
                context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
    ...
    public ClientEncryptionKeyGetResults getClientEncryptionKey(String resourceGroupName, String accountName,
        ...
        ClientEncryptionKeyGetResultsInner inner = this.serviceClient()
    ...
    public Response<SqlStoredProcedureGetResults> getSqlStoredProcedureWithResponse(String resourceGroupName,
        ...
        Response<SqlStoredProcedureGetResultsInner> inner = this.serviceClient()
            .getSqlStoredProcedureWithResponse(resourceGroupName, accountName, databaseName, containerName,
    ...
    public SqlStoredProcedureGetResults getSqlStoredProcedure(String resourceGroupName, String accountName,
        ...
        SqlStoredProcedureGetResultsInner inner = this.serviceClient()
            .getSqlStoredProcedure(resourceGroupName, accountName, databaseName, containerName, storedProcedureName);
        if (inner != null) {
    ...
    public Response<SqlUserDefinedFunctionGetResults> getSqlUserDefinedFunctionWithResponse(String resourceGroupName,
        ...
        Context context) {
        Response<SqlUserDefinedFunctionGetResultsInner> inner = this.serviceClient()
            .getSqlUserDefinedFunctionWithResponse(resourceGroupName, accountName, databaseName, containerName,
    ...
    public SqlUserDefinedFunctionGetResults getSqlUserDefinedFunction(String resourceGroupName, String accountName,
        ...
        SqlUserDefinedFunctionGetResultsInner inner = this.serviceClient()
            .getSqlUserDefinedFunction(resourceGroupName, accountName, databaseName, containerName,
    ...
    public void deleteSqlUserDefinedFunction(String resourceGroupName, String accountName, String databaseName,
        ...
        this.serviceClient()
            .deleteSqlUserDefinedFunction(resourceGroupName, accountName, databaseName, containerName,
                userDefinedFunctionName);
    }
    ...
    public PagedIterable<SqlTriggerGetResults> listSqlTriggers(String resourceGroupName, String accountName,
        String databaseName, String containerName, Context context) {
        PagedIterable<SqlTriggerGetResultsInner> inner = this.serviceClient()
            .listSqlTriggers(resourceGroupName, accountName, databaseName, containerName, context);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new SqlTriggerGetResultsImpl(inner1, this.manager()));
    }
    ...
    public Response<SqlTriggerGetResults> getSqlTriggerWithResponse(String resourceGroupName, String accountName,
        ...
        Response<SqlTriggerGetResultsInner> inner = this.serviceClient()
            .getSqlTriggerWithResponse(resourceGroupName, accountName, databaseName, containerName, triggerName,
                context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
    ...
    public SqlTriggerGetResults getSqlTrigger(String resourceGroupName, String accountName, String databaseName,
        ...
        SqlTriggerGetResultsInner inner = this.serviceClient()
    ...
    public SqlStoredProcedureGetResults getSqlStoredProcedureById(String id) {
        ...
        return this
            .getSqlStoredProcedureWithResponse(resourceGroupName, accountName, databaseName, containerName,
                storedProcedureName, Context.NONE)
            .getValue();
    }
