...
@Fluent
public final class CommandPublicResourceInner {
    /*
     ...
     */
    @JsonProperty(value = "cassandraStopStart")
     ...
     * @return the CommandPublicResourceInner object itself.
     */
    public CommandPublicResourceInner withArguments(Map<String, String> arguments) {
     ...
     * @return the CommandPublicResourceInner object itself.
     */
    public CommandPublicResourceInner withStatus(String status) {
        this.status = status;
        return this;
    }
