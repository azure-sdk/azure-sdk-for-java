...
public final class GraphResourceGetResultsImpl
    ...
    public GraphResourceGetResults create() {
        this.innerObject = serviceManager.serviceClient().getGraphResources().createUpdateGraph(resourceGroupName,
            accountName, graphName, createCreateUpdateGraphParameters, Context.NONE);
        return this;
    }

    public GraphResourceGetResults create(Context context) {
        this.innerObject = serviceManager.serviceClient().getGraphResources().createUpdateGraph(resourceGroupName,
            accountName, graphName, createCreateUpdateGraphParameters, context);
        return this;
    }

    GraphResourceGetResultsImpl(String name,
    ...
    public GraphResourceGetResults apply() {
        this.innerObject = serviceManager.serviceClient().getGraphResources().createUpdateGraph(resourceGroupName,
            accountName, graphName, updateCreateUpdateGraphParameters, Context.NONE);
        return this;
    }

    public GraphResourceGetResults apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getGraphResources().createUpdateGraph(resourceGroupName,
            accountName, graphName, updateCreateUpdateGraphParameters, context);
        return this;
    }

    GraphResourceGetResultsImpl(GraphResourceGetResultsInner innerObject,
        com.azure.resourcemanager.cosmos.generated.CosmosDBManager serviceManager) {
    ...
    public GraphResourceGetResults refresh() {
        this.innerObject = serviceManager.serviceClient().getGraphResources()
            .getGraphWithResponse(resourceGroupName, accountName, graphName, Context.NONE).getValue();
        return this;
    }

    public GraphResourceGetResults refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getGraphResources()
            .getGraphWithResponse(resourceGroupName, accountName, graphName, context).getValue();
        return this;
    }
