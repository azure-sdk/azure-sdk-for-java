...
public final class FleetspaceAccountResourceInner extends ProxyResource {
     ...
     * @return the FleetspaceAccountResourceInner object itself.
     */
    public FleetspaceAccountResourceInner withAccountResourceIdentifier(String accountResourceIdentifier) {
        if (this.innerProperties() == null) {
            this.innerProperties = new FleetspaceAccountProperties();
        }
     ...
     * @return the FleetspaceAccountResourceInner object itself.
     */
    public FleetspaceAccountResourceInner withAccountLocation(String accountLocation) {
        if (this.innerProperties() == null) {
            this.innerProperties = new FleetspaceAccountProperties();
        }
