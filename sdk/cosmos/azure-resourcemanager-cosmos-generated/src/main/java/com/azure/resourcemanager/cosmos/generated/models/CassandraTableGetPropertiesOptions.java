...
public final class CassandraTableGetPropertiesOptions extends OptionsResource {
     ...
     * @return An instance of CassandraTableGetPropertiesOptions if the JsonReader was pointing to an instance of it, or
     * null if it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the CassandraTableGetPropertiesOptions.
     */
    public static CassandraTableGetPropertiesOptions fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            CassandraTableGetPropertiesOptions deserializedCassandraTableGetPropertiesOptions
                = new CassandraTableGetPropertiesOptions();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("throughput".equals(fieldName)) {
                    deserializedCassandraTableGetPropertiesOptions
            ...
            return deserializedCassandraTableGetPropertiesOptions;
        });
    }
}
