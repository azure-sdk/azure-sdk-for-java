...
public final class CassandraKeyspaceGetResultsImpl
    ...
    public CassandraKeyspaceGetResults create() {
        this.innerObject = serviceManager.serviceClient().getCassandraResources().createUpdateCassandraKeyspace(
            resourceGroupName, accountName, keyspaceName, createCreateUpdateCassandraKeyspaceParameters, Context.NONE);
        return this;
    }

    public CassandraKeyspaceGetResults create(Context context) {
        this.innerObject = serviceManager.serviceClient().getCassandraResources().createUpdateCassandraKeyspace(
            resourceGroupName, accountName, keyspaceName, createCreateUpdateCassandraKeyspaceParameters, context);
        return this;
    }

    CassandraKeyspaceGetResultsImpl(String name,
    ...
    public CassandraKeyspaceGetResults apply() {
        this.innerObject = serviceManager.serviceClient().getCassandraResources().createUpdateCassandraKeyspace(
            resourceGroupName, accountName, keyspaceName, updateCreateUpdateCassandraKeyspaceParameters, Context.NONE);
        return this;
    }

    public CassandraKeyspaceGetResults apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getCassandraResources().createUpdateCassandraKeyspace(
            resourceGroupName, accountName, keyspaceName, updateCreateUpdateCassandraKeyspaceParameters, context);
        return this;
    }

    CassandraKeyspaceGetResultsImpl(CassandraKeyspaceGetResultsInner innerObject,
        com.azure.resourcemanager.cosmos.generated.CosmosDBManager serviceManager) {
    ...
    public CassandraKeyspaceGetResults refresh() {
        this.innerObject = serviceManager.serviceClient().getCassandraResources()
            .getCassandraKeyspaceWithResponse(resourceGroupName, accountName, keyspaceName, Context.NONE).getValue();
        return this;
    }

    public CassandraKeyspaceGetResults refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getCassandraResources()
            .getCassandraKeyspaceWithResponse(resourceGroupName, accountName, keyspaceName, context).getValue();
        return this;
    }
