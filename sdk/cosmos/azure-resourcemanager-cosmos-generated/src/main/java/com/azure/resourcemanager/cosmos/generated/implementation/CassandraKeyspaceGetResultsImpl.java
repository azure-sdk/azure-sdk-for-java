...
public final class CassandraKeyspaceGetResultsImpl
    ...
    public CassandraKeyspaceGetResults create() {
        this.innerObject = serviceManager.serviceClient()
            ...
            .createUpdateCassandraKeyspace(resourceGroupName, accountName, keyspaceName,
                createCreateUpdateCassandraKeyspaceParameters, Context.NONE);
        return this;
    }
    ...
    public CassandraKeyspaceGetResults create(Context context) {
        this.innerObject = serviceManager.serviceClient()
            .getCassandraResources()
            .createUpdateCassandraKeyspace(resourceGroupName, accountName, keyspaceName,
                createCreateUpdateCassandraKeyspaceParameters, context);
        return this;
    }
    ...
    public CassandraKeyspaceGetResults apply() {
        this.innerObject = serviceManager.serviceClient()
            .getCassandraResources()
            .createUpdateCassandraKeyspace(resourceGroupName, accountName, keyspaceName,
                updateCreateUpdateCassandraKeyspaceParameters, Context.NONE);
        return this;
    }
    ...
    public CassandraKeyspaceGetResults apply(Context context) {
        this.innerObject = serviceManager.serviceClient()
            .getCassandraResources()
            .createUpdateCassandraKeyspace(resourceGroupName, accountName, keyspaceName,
                updateCreateUpdateCassandraKeyspaceParameters, context);
        return this;
    }
