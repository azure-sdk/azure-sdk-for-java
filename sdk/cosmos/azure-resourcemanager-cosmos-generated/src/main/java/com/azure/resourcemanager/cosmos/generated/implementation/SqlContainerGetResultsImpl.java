...
public final class SqlContainerGetResultsImpl
    ...
    public SqlContainerGetResultsImpl withExistingSqlDatabase(String resourceGroupName, String accountName,
        String databaseName) {
    ...
    public SqlContainerGetResults create() {
        this.innerObject = serviceManager.serviceClient().getSqlResources().createUpdateSqlContainer(resourceGroupName,
            accountName, databaseName, containerName, createCreateUpdateSqlContainerParameters, Context.NONE);
        return this;
    }

    public SqlContainerGetResults create(Context context) {
        this.innerObject = serviceManager.serviceClient().getSqlResources().createUpdateSqlContainer(resourceGroupName,
            accountName, databaseName, containerName, createCreateUpdateSqlContainerParameters, context);
        return this;
    }
    ...
    public SqlContainerGetResults apply() {
        this.innerObject = serviceManager.serviceClient().getSqlResources().createUpdateSqlContainer(resourceGroupName,
            accountName, databaseName, containerName, updateCreateUpdateSqlContainerParameters, Context.NONE);
        return this;
    }

    public SqlContainerGetResults apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getSqlResources().createUpdateSqlContainer(resourceGroupName,
            accountName, databaseName, containerName, updateCreateUpdateSqlContainerParameters, context);
        return this;
    }

    SqlContainerGetResultsImpl(SqlContainerGetResultsInner innerObject,
    ...
    public PhysicalPartitionStorageInfoCollection listSqlContainerPartitionMerge(MergeParameters mergeParameters) {
        return serviceManager.sqlResources().listSqlContainerPartitionMerge(resourceGroupName, accountName,
            databaseName, containerName, mergeParameters);
    }

    public PhysicalPartitionStorageInfoCollection listSqlContainerPartitionMerge(MergeParameters mergeParameters,
        Context context) {
        return serviceManager.sqlResources().listSqlContainerPartitionMerge(resourceGroupName, accountName,
            databaseName, containerName, mergeParameters, context);
    }

    public BackupInformation retrieveContinuousBackupInformation(ContinuousBackupRestoreLocation location) {
        return serviceManager.sqlResources().retrieveContinuousBackupInformation(resourceGroupName, accountName,
            databaseName, containerName, location);
    }

    public BackupInformation retrieveContinuousBackupInformation(ContinuousBackupRestoreLocation location,
        Context context) {
        return serviceManager.sqlResources().retrieveContinuousBackupInformation(resourceGroupName, accountName,
            databaseName, containerName, location, context);
    }
