...
public final class SqlContainerGetResultsImpl
    ...
    public SqlContainerGetResults create() {
        this.innerObject = serviceManager.serviceClient()
            .getSqlResources()
            .createUpdateSqlContainer(resourceGroupName, accountName, databaseName, containerName,
                createCreateUpdateSqlContainerParameters, Context.NONE);
        return this;
    }
    ...
    public SqlContainerGetResults create(Context context) {
        this.innerObject = serviceManager.serviceClient()
            .getSqlResources()
            .createUpdateSqlContainer(resourceGroupName, accountName, databaseName, containerName,
                createCreateUpdateSqlContainerParameters, context);
        return this;
    }
    ...
    public SqlContainerGetResults apply() {
        this.innerObject = serviceManager.serviceClient()
            .getSqlResources()
            .createUpdateSqlContainer(resourceGroupName, accountName, databaseName, containerName,
                updateCreateUpdateSqlContainerParameters, Context.NONE);
        return this;
    }
    ...
    public SqlContainerGetResults apply(Context context) {
        this.innerObject = serviceManager.serviceClient()
            .getSqlResources()
            .createUpdateSqlContainer(resourceGroupName, accountName, databaseName, containerName,
                updateCreateUpdateSqlContainerParameters, context);
        return this;
    }
    ...
    public BackupInformation retrieveContinuousBackupInformation(ContinuousBackupRestoreLocation location) {
        return serviceManager.sqlResources()
