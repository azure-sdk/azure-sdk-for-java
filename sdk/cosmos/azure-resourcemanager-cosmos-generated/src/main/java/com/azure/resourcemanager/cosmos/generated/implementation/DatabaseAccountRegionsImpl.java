...
public final class DatabaseAccountRegionsImpl implements DatabaseAccountRegions {
    ...
    public DatabaseAccountRegionsImpl(DatabaseAccountRegionsClient innerClient,
        com.azure.resourcemanager.cosmos.generated.CosmosDBManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public PagedIterable<Metric> listMetrics(String resourceGroupName, String accountName, String region,
        String filter) {
    ...
    public PagedIterable<Metric> listMetrics(String resourceGroupName, String accountName, String region, String filter,
        Context context) {
        PagedIterable<MetricInner> inner
