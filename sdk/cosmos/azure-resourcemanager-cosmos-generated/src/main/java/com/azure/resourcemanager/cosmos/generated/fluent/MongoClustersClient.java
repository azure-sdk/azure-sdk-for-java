...
public interface MongoClustersClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<MongoClusterInner> getWithResponse(String resourceGroupName, String mongoClusterName, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    MongoClusterInner get(String resourceGroupName, String mongoClusterName);
