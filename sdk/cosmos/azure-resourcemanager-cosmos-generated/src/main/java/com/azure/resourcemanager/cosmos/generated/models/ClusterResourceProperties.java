...
public final class ClusterResourceProperties {
    ...
    /*
     * Which connection method Managed Cassandra should use to conenct to Azure resources it needs. 'None' is the
     * deafukt which means conenct directly, 'Vpn' will connect through a VPN endpoint for added security and
     * simplicity.
     */
    @JsonProperty(value = "azureConnectionMethod")
    private AzureConnectionMethod azureConnectionMethod;

    /*
     * If AzureConnectionMethod is VPN, the resource id of the private link resource that is used establish a private
     * link to the Azure services used by the cluster
     */
    @JsonProperty(value = "privateLinkResourceId", access = JsonProperty.Access.WRITE_ONLY)
    private String privateLinkResourceId;

    /*
     * If AzureConnectionMethod is VPN, the list of subscriptions that are automatically approved to connect to the
     * private link resource that is used establish a private link to the Azure services used by the cluster
     */
    @JsonProperty(value = "privateLinkAutoApproveSubscriptions")
    private List<String> privateLinkAutoApproveSubscriptions;
    ...
    /**
     * Get the azureConnectionMethod property: Which connection method Managed Cassandra should use to conenct to Azure
     * resources it needs. 'None' is the deafukt which means conenct directly, 'Vpn' will connect through a VPN endpoint
     * for added security and simplicity.
     *
     * @return the azureConnectionMethod value.
     */
    public AzureConnectionMethod azureConnectionMethod() {
        return this.azureConnectionMethod;
    }

    /**
     * Set the azureConnectionMethod property: Which connection method Managed Cassandra should use to conenct to Azure
     * resources it needs. 'None' is the deafukt which means conenct directly, 'Vpn' will connect through a VPN endpoint
     * for added security and simplicity.
     *
     ...
     * @return the ClusterResourceProperties object itself.
     */
    public ClusterResourceProperties withAzureConnectionMethod(AzureConnectionMethod azureConnectionMethod) {
        this.azureConnectionMethod = azureConnectionMethod;
        return this;
    }

    /**
     * Get the privateLinkResourceId property: If AzureConnectionMethod is VPN, the resource id of the private link
     * resource that is used establish a private link to the Azure services used by the cluster.
     *
    ...
    /**
     * Get the privateLinkAutoApproveSubscriptions property: If AzureConnectionMethod is VPN, the list of subscriptions
     * that are automatically approved to connect to the private link resource that is used establish a private link to
     * the Azure services used by the cluster.
     *
     * @return the privateLinkAutoApproveSubscriptions value.
     */
    public List<String> privateLinkAutoApproveSubscriptions() {
        return this.privateLinkAutoApproveSubscriptions;
    }

    /**
     * Set the privateLinkAutoApproveSubscriptions property: If AzureConnectionMethod is VPN, the list of subscriptions
     * that are automatically approved to connect to the private link resource that is used establish a private link to
     * the Azure services used by the cluster.
     *
     * @param privateLinkAutoApproveSubscriptions the privateLinkAutoApproveSubscriptions value to set.
     * @return the ClusterResourceProperties object itself.
     */
    public ClusterResourceProperties withPrivateLinkAutoApproveSubscriptions(
        List<String> privateLinkAutoApproveSubscriptions) {
        this.privateLinkAutoApproveSubscriptions = privateLinkAutoApproveSubscriptions;
        return this;
    }
