...
public final class DatabaseAccountGetResultsInner extends ArmResourceProperties {
    ...
    /**
     * Set the keysMetadata property: The object that represents the metadata for the Account Keys of the Cosmos DB
     * account.
     *
     * @param keysMetadata the keysMetadata value to set.
     * @return the DatabaseAccountGetResultsInner object itself.
     */
    public DatabaseAccountGetResultsInner withKeysMetadata(DatabaseAccountKeysMetadata keysMetadata) {
        if (this.innerProperties() == null) {
            this.innerProperties = new DatabaseAccountGetProperties();
        }
