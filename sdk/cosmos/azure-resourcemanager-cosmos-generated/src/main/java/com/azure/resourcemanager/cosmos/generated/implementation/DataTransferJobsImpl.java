...
public final class DataTransferJobsImpl implements DataTransferJobs {
    ...
    public DataTransferJobsImpl(DataTransferJobsClient innerClient,
        com.azure.resourcemanager.cosmos.generated.CosmosDBManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public Response<DataTransferJobGetResults> getWithResponse(String resourceGroupName, String accountName,
    ...
    public Response<DataTransferJobGetResults> pauseWithResponse(String resourceGroupName, String accountName,
        String jobName, Context context) {
        Response<DataTransferJobGetResultsInner> inner
    ...
    public Response<DataTransferJobGetResults> resumeWithResponse(String resourceGroupName, String accountName,
        String jobName, Context context) {
        Response<DataTransferJobGetResultsInner> inner
    ...
    public Response<DataTransferJobGetResults> cancelWithResponse(String resourceGroupName, String accountName,
        String jobName, Context context) {
        Response<DataTransferJobGetResultsInner> inner
    ...
    public PagedIterable<DataTransferJobGetResults> listByDatabaseAccount(String resourceGroupName,
        String accountName) {
    ...
    public PagedIterable<DataTransferJobGetResults> listByDatabaseAccount(String resourceGroupName, String accountName,
        Context context) {
        PagedIterable<DataTransferJobGetResultsInner> inner
    ...
    public DataTransferJobGetResults getById(String id) {
        ...
        if (jobName == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
                String.format("The resource ID '%s' is not valid. Missing path segment 'dataTransferJobs'.", id)));
        }
