...
public interface CassandraClustersClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    CommandPublicResourceInner invokeAsyncCommand(String resourceGroupName, String clusterName, CommandPostBody body);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<CassandraClusterRestoreResultInner> restoreBackupWithResponse(String resourceGroupName, String clusterName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    CassandraClusterRestoreResultInner restoreBackup(String resourceGroupName, String clusterName, String backupId);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<CassandraClusterRestoreInfoInner> getRestoreWithResponse(String resourceGroupName, String clusterName,
        String backupId, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    CassandraClusterRestoreInfoInner getRestore(String resourceGroupName, String clusterName, String backupId);
