...
public interface CassandraClustersClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<CommandOutputInner>, CommandOutputInner> beginListCommand(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    CommandOutputInner listCommand(String resourceGroupName, String clusterName);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    CommandOutputInner listCommand(String resourceGroupName, String clusterName, Context context);
