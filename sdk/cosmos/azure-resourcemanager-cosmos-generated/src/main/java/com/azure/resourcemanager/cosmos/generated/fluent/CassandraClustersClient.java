...
public interface CassandraClustersClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<CassandraClusterRestoreResultInner> getRestoreWithResponse(String resourceGroupName, String clusterName,
        String backupId, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    CassandraClusterRestoreResultInner getRestore(String resourceGroupName, String clusterName, String backupId);
