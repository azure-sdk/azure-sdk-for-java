...
public final class DatabaseAccountsClientImpl implements DatabaseAccountsClient {
    ...
    public interface DatabaseAccountsService {
        ...
        Mono<Response<DatabaseAccountGetResultsInner>> get(
    ...
    private Mono<Response<DatabaseAccountGetResultsInner>> getWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DatabaseAccountGetResultsInner> getAsync(String resourceGroupName, String accountName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<DatabaseAccountGetResultsInner> getWithResponse(
        String resourceGroupName, String accountName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public DatabaseAccountGetResultsInner get(String resourceGroupName, String accountName) {
