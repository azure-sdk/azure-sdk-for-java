...
public final class MongoDBResourcesImpl implements MongoDBResources {
    ...
    public PagedIterable<MongoDBDatabaseGetResults> listMongoDBDatabases(String resourceGroupName, String accountName) {
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new MongoDBDatabaseGetResultsImpl(inner1, this.manager()));
    }
    ...
    public PagedIterable<MongoDBCollectionGetResults> listMongoDBCollections(String resourceGroupName,
        ...
        return ResourceManagerUtils.mapPage(inner,
            inner1 -> new MongoDBCollectionGetResultsImpl(inner1, this.manager()));
    }
    ...
    public PagedIterable<MongoRoleDefinitionGetResults> listMongoRoleDefinitions(String resourceGroupName,
        ...
        return ResourceManagerUtils.mapPage(inner,
            inner1 -> new MongoRoleDefinitionGetResultsImpl(inner1, this.manager()));
    }
    ...
    public PagedIterable<MongoUserDefinitionGetResults> listMongoUserDefinitions(String resourceGroupName,
        ...
        return ResourceManagerUtils.mapPage(inner,
            inner1 -> new MongoUserDefinitionGetResultsImpl(inner1, this.manager()));
    }
    ...
    public MongoDBDatabaseGetResults getMongoDBDatabaseById(String id) {
        ...
        String databaseName = ResourceManagerUtils.getValueFromIdByName(id, "mongodbDatabases");
    ...
    public MongoDBCollectionGetResults getMongoDBCollectionById(String id) {
        ...
        String collectionName = ResourceManagerUtils.getValueFromIdByName(id, "collections");
    ...
    public MongoRoleDefinitionGetResults getMongoRoleDefinitionById(String id) {
        String mongoRoleDefinitionId = ResourceManagerUtils.getValueFromIdByName(id, "mongodbRoleDefinitions");
    ...
    public MongoUserDefinitionGetResults getMongoUserDefinitionById(String id) {
        String mongoUserDefinitionId = ResourceManagerUtils.getValueFromIdByName(id, "mongodbUserDefinitions");
