...
public final class MongoDBResourcesImpl implements MongoDBResources {
    ...
    public Response<ThroughputSettingsGetResults> getMongoDBCollectionThroughputWithResponse(String resourceGroupName,
        String accountName, String databaseName, String collectionName, Context context) {
        Response<ThroughputSettingsGetResultsInner> inner = this.serviceClient()
            .getMongoDBCollectionThroughputWithResponse(resourceGroupName, accountName, databaseName, collectionName,
                context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
                new ThroughputSettingsGetResultsImpl(inner.getValue(), this.manager()));
    ...
    public ThroughputSettingsGetResults updateMongoDBCollectionThroughput(String resourceGroupName, String accountName,
        ...
        ThroughputSettingsGetResultsInner inner = this.serviceClient()
            .updateMongoDBCollectionThroughput(resourceGroupName, accountName, databaseName, collectionName,
    ...
    public BackupInformation retrieveContinuousBackupInformation(String resourceGroupName, String accountName,
        ...
        BackupInformationInner inner = this.serviceClient()
            .retrieveContinuousBackupInformation(resourceGroupName, accountName, databaseName, collectionName,
                location);
        if (inner != null) {
    ...
    public BackupInformation retrieveContinuousBackupInformation(String resourceGroupName, String accountName,
        ...
        BackupInformationInner inner = this.serviceClient()
            .retrieveContinuousBackupInformation(resourceGroupName, accountName, databaseName, collectionName, location,
                context);
        if (inner != null) {
            return new BackupInformationImpl(inner, this.manager());
        } else {
    ...
    public MongoDBCollectionGetResults getMongoDBCollectionById(String id) {
        ...
        return this
            .getMongoDBCollectionWithResponse(resourceGroupName, accountName, databaseName, collectionName,
                Context.NONE)
            .getValue();
    }
