...
public final class FleetspaceAccountProperties implements JsonSerializable<FleetspaceAccountProperties> {
    ...
    /**
     * Get the accountResourceIdentifier property: The resource identifier of global database account in the Fleetspace
     * Account.
     * 
    ...
    /**
     * Set the accountResourceIdentifier property: The resource identifier of global database account in the Fleetspace
     * Account.
     * 
     * @param accountResourceIdentifier the accountResourceIdentifier value to set.
     * @return the FleetspaceAccountProperties object itself.
     */
    public FleetspaceAccountProperties withAccountResourceIdentifier(String accountResourceIdentifier) {
        this.accountResourceIdentifier = accountResourceIdentifier;
        return this;
    }

    /**
     * Get the accountLocation property: The location of global database account in the Fleetspace Account.
     * 
    ...
    /**
     * Set the accountLocation property: The location of global database account in the Fleetspace Account.
     * 
     * @param accountLocation the accountLocation value to set.
     * @return the FleetspaceAccountProperties object itself.
     */
    public FleetspaceAccountProperties withAccountLocation(String accountLocation) {
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("provisioningState".equals(fieldName)) {
                    ...
                    deserializedFleetspaceAccountProperties.accountResourceIdentifier = reader.getString();
                } else if ("accountLocation".equals(fieldName)) {
                    deserializedFleetspaceAccountProperties.accountLocation = reader.getString();
                } else {
                    reader.skipChildren();
                }
            }
