...
public final class FullTextPath implements JsonSerializable<FullTextPath> {
    /*
     * A string containing the path of the full text index.
     */
    private String path;

    /*
     * A string containing the language of the full text index.
     */
    ...
    /**
     * Get the path property: A string containing the path of the full text index.
     * 
    ...
    /**
     * Set the path property: A string containing the path of the full text index.
     * 
    ...
    /**
     * Get the language property: A string containing the language of the full text index.
     * 
    ...
    /**
     * Set the language property: A string containing the language of the full text index.
     * 
    ...
    public void validate() {
        ...
        if (language() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Missing required property language in model FullTextPath"));
        }
    }
