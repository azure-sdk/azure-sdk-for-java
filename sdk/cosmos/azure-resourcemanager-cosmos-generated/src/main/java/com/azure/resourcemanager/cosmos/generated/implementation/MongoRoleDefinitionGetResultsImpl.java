...
public final class MongoRoleDefinitionGetResultsImpl implements MongoRoleDefinitionGetResults,
    MongoRoleDefinitionGetResults.Definition, MongoRoleDefinitionGetResults.Update {
    ...
    public MongoRoleDefinitionGetResults create() {
        this.innerObject = serviceManager.serviceClient().getMongoDBResources().createUpdateMongoRoleDefinition(
            mongoRoleDefinitionId, resourceGroupName, accountName, createCreateUpdateMongoRoleDefinitionParameters,
            Context.NONE);
        return this;
    }
    ...
    MongoRoleDefinitionGetResultsImpl(String name,
    ...
    public MongoRoleDefinitionGetResults apply() {
        this.innerObject = serviceManager.serviceClient().getMongoDBResources().createUpdateMongoRoleDefinition(
            mongoRoleDefinitionId, resourceGroupName, accountName, updateCreateUpdateMongoRoleDefinitionParameters,
            Context.NONE);
        return this;
    }
    ...
    MongoRoleDefinitionGetResultsImpl(MongoRoleDefinitionGetResultsInner innerObject,
        com.azure.resourcemanager.cosmos.generated.CosmosDBManager serviceManager) {
