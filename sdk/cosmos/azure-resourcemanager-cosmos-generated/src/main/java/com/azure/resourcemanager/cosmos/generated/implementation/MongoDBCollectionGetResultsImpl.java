...
public final class MongoDBCollectionGetResultsImpl
    ...
    public MongoDBCollectionGetResults create() {
        this.innerObject = serviceManager.serviceClient()
            .getMongoDBResources()
            .createUpdateMongoDBCollection(resourceGroupName, accountName, databaseName, collectionName,
                createCreateUpdateMongoDBCollectionParameters, Context.NONE);
        return this;
    }
    ...
    public MongoDBCollectionGetResults create(Context context) {
        this.innerObject = serviceManager.serviceClient()
            .getMongoDBResources()
            .createUpdateMongoDBCollection(resourceGroupName, accountName, databaseName, collectionName,
                createCreateUpdateMongoDBCollectionParameters, context);
        return this;
    }
    ...
    public MongoDBCollectionGetResults apply() {
        this.innerObject = serviceManager.serviceClient()
            .getMongoDBResources()
            .createUpdateMongoDBCollection(resourceGroupName, accountName, databaseName, collectionName,
                updateCreateUpdateMongoDBCollectionParameters, Context.NONE);
        return this;
    }
    ...
    public MongoDBCollectionGetResults apply(Context context) {
        this.innerObject = serviceManager.serviceClient()
            .getMongoDBResources()
            .createUpdateMongoDBCollection(resourceGroupName, accountName, databaseName, collectionName,
                updateCreateUpdateMongoDBCollectionParameters, context);
        return this;
    }
    ...
    public BackupInformation retrieveContinuousBackupInformation(ContinuousBackupRestoreLocation location) {
        return serviceManager.mongoDBResources()
