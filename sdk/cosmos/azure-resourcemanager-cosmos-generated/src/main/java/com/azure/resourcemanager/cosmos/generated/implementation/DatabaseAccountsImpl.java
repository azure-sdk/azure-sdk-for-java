...
public final class DatabaseAccountsImpl implements DatabaseAccounts {
    ...
    public Response<DatabaseAccountGetResults> getWithResponse(
    ...
    public DatabaseAccountGetResults get(String resourceGroupName, String accountName) {
        DatabaseAccountGetResultsInner inner = this.serviceClient().get(resourceGroupName, accountName);
        if (inner != null) {
