...
public final class MongoDBResourcesClientImpl implements MongoDBResourcesClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<Void>, Void> beginMongoDBContainerRedistributeThroughputAsync(
        String resourceGroupName,
        String accountName,
        String databaseName,
        String collectionName,
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<Void>, Void> beginMongoDBContainerRedistributeThroughput(
        String resourceGroupName,
        String accountName,
        String databaseName,
        String collectionName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> mongoDBContainerRedistributeThroughputAsync(
        String resourceGroupName,
        String accountName,
        String databaseName,
        String collectionName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public void mongoDBContainerRedistributeThroughput(
        String resourceGroupName,
        String accountName,
        String databaseName,
        String collectionName,
    ...
    private Mono<MongoRoleDefinitionGetResultsInner> getMongoRoleDefinitionAsync(
        ...
        return getMongoRoleDefinitionWithResponseAsync(mongoRoleDefinitionId, resourceGroupName, accountName)
            .flatMap(
                (Response<MongoRoleDefinitionGetResultsInner> res) -> {
                    if (res.getValue() != null) {
                        return Mono.just(res.getValue());
                    } else {
                        return Mono.empty();
    ...
    private Mono<MongoUserDefinitionGetResultsInner> getMongoUserDefinitionAsync(
        ...
        return getMongoUserDefinitionWithResponseAsync(mongoUserDefinitionId, resourceGroupName, accountName)
            .flatMap(
                (Response<MongoUserDefinitionGetResultsInner> res) -> {
                    if (res.getValue() != null) {
                        return Mono.just(res.getValue());
                    } else {
                        return Mono.empty();
