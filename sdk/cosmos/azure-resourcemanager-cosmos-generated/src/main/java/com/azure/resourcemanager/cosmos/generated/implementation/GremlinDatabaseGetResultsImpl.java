...
public final class GremlinDatabaseGetResultsImpl
    ...
    public GremlinDatabaseGetResults create() {
        this.innerObject = serviceManager.serviceClient().getGremlinResources().createUpdateGremlinDatabase(
            resourceGroupName, accountName, databaseName, createCreateUpdateGremlinDatabaseParameters, Context.NONE);
        return this;
    }
    ...
    GremlinDatabaseGetResultsImpl(String name,
    ...
    public GremlinDatabaseGetResults apply() {
        this.innerObject = serviceManager.serviceClient().getGremlinResources().createUpdateGremlinDatabase(
            resourceGroupName, accountName, databaseName, updateCreateUpdateGremlinDatabaseParameters, Context.NONE);
        return this;
    }
    ...
    GremlinDatabaseGetResultsImpl(GremlinDatabaseGetResultsInner innerObject,
        com.azure.resourcemanager.cosmos.generated.CosmosDBManager serviceManager) {
    ...
    public GremlinDatabaseGetResults refresh() {
        this.innerObject = serviceManager.serviceClient().getGremlinResources()
            .getGremlinDatabaseWithResponse(resourceGroupName, accountName, databaseName, Context.NONE).getValue();
        return this;
    }

    public GremlinDatabaseGetResults refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getGremlinResources()
            .getGremlinDatabaseWithResponse(resourceGroupName, accountName, databaseName, context).getValue();
        return this;
    }
