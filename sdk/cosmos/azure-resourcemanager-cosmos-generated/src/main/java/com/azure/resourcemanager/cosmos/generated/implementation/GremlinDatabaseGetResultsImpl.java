...
public final class GremlinDatabaseGetResultsImpl
    ...
    public GremlinDatabaseGetResults create() {
        this.innerObject = serviceManager.serviceClient()
            .getGremlinResources()
            .createUpdateGremlinDatabase(resourceGroupName, accountName, databaseName,
                createCreateUpdateGremlinDatabaseParameters, Context.NONE);
        return this;
    }
    ...
    public GremlinDatabaseGetResults create(Context context) {
        this.innerObject = serviceManager.serviceClient()
            .getGremlinResources()
            .createUpdateGremlinDatabase(resourceGroupName, accountName, databaseName,
                createCreateUpdateGremlinDatabaseParameters, context);
        return this;
    }
    ...
    public GremlinDatabaseGetResults apply() {
        this.innerObject = serviceManager.serviceClient()
            .getGremlinResources()
            .createUpdateGremlinDatabase(resourceGroupName, accountName, databaseName,
                updateCreateUpdateGremlinDatabaseParameters, Context.NONE);
        return this;
    }
    ...
    public GremlinDatabaseGetResults apply(Context context) {
        this.innerObject = serviceManager.serviceClient()
            .getGremlinResources()
            .createUpdateGremlinDatabase(resourceGroupName, accountName, databaseName,
                updateCreateUpdateGremlinDatabaseParameters, context);
        return this;
    }
