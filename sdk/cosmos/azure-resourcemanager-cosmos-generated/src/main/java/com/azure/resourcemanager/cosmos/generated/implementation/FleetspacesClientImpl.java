...
import com.azure.resourcemanager.cosmos.generated.models.FleetspaceListResult;
...
public final class FleetspacesClientImpl implements FleetspacesClient {
    ...
    private PagedFlux<FleetspaceResourceInner> listAsync(String resourceGroupName, String fleetName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<FleetspaceResourceInner> getAsync(String resourceGroupName, String fleetName, String fleetspaceName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<FleetspaceResourceInner>, FleetspaceResourceInner>
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<FleetspaceResourceInner> updateAsync(String resourceGroupName, String fleetName,
        String fleetspaceName) {
        final FleetspaceUpdate body = null;
        return beginUpdateAsync(resourceGroupName, fleetName, fleetspaceName, body).last()
            .flatMap(this.client::getLroFinalResultOrError);
