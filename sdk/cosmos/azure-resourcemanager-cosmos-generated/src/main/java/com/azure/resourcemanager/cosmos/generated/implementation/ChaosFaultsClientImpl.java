...
import com.azure.resourcemanager.cosmos.generated.models.ChaosFaultListResponse;
...
public final class ChaosFaultsClientImpl implements ChaosFaultsClient {
    ...
    private Mono<Response<Flux<ByteBuffer>>> enableDisableWithResponseAsync(String resourceGroupName,
        String accountName, String chaosFault, ChaosFaultResourceInner chaosFaultRequest) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ChaosFaultResourceInner> getAsync(String resourceGroupName, String accountName, String chaosFault) {
