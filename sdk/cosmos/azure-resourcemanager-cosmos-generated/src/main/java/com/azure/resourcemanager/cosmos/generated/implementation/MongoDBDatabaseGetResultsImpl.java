...
public final class MongoDBDatabaseGetResultsImpl
    ...
    public MongoDBDatabaseGetResults create() {
        this.innerObject = serviceManager.serviceClient()
            .getMongoDBResources()
            .createUpdateMongoDBDatabase(resourceGroupName, accountName, databaseName,
                createCreateUpdateMongoDBDatabaseParameters, Context.NONE);
        return this;
    }
    ...
    public MongoDBDatabaseGetResults create(Context context) {
        this.innerObject = serviceManager.serviceClient()
            .getMongoDBResources()
            .createUpdateMongoDBDatabase(resourceGroupName, accountName, databaseName,
                createCreateUpdateMongoDBDatabaseParameters, context);
        return this;
    }
    ...
    public MongoDBDatabaseGetResults apply() {
        this.innerObject = serviceManager.serviceClient()
            .getMongoDBResources()
            .createUpdateMongoDBDatabase(resourceGroupName, accountName, databaseName,
                updateCreateUpdateMongoDBDatabaseParameters, Context.NONE);
        return this;
    }
    ...
    public MongoDBDatabaseGetResults apply(Context context) {
        this.innerObject = serviceManager.serviceClient()
            .getMongoDBResources()
            .createUpdateMongoDBDatabase(resourceGroupName, accountName, databaseName,
                updateCreateUpdateMongoDBDatabaseParameters, context);
        return this;
    }
