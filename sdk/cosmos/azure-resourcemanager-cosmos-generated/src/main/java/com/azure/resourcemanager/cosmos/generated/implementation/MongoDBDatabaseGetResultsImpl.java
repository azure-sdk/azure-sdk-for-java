...
public final class MongoDBDatabaseGetResultsImpl
    ...
    public MongoDBDatabaseGetResults create() {
        this.innerObject = serviceManager.serviceClient().getMongoDBResources().createUpdateMongoDBDatabase(
            resourceGroupName, accountName, databaseName, createCreateUpdateMongoDBDatabaseParameters, Context.NONE);
        return this;
    }
    ...
    MongoDBDatabaseGetResultsImpl(String name,
    ...
    public MongoDBDatabaseGetResults apply() {
        this.innerObject = serviceManager.serviceClient().getMongoDBResources().createUpdateMongoDBDatabase(
            resourceGroupName, accountName, databaseName, updateCreateUpdateMongoDBDatabaseParameters, Context.NONE);
        return this;
    }
    ...
    MongoDBDatabaseGetResultsImpl(MongoDBDatabaseGetResultsInner innerObject,
        com.azure.resourcemanager.cosmos.generated.CosmosDBManager serviceManager) {
    ...
    public MongoDBDatabaseGetResults refresh() {
        this.innerObject = serviceManager.serviceClient().getMongoDBResources()
            .getMongoDBDatabaseWithResponse(resourceGroupName, accountName, databaseName, Context.NONE).getValue();
        return this;
    }

    public MongoDBDatabaseGetResults refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getMongoDBResources()
            .getMongoDBDatabaseWithResponse(resourceGroupName, accountName, databaseName, context).getValue();
        return this;
    }

    public PhysicalPartitionStorageInfoCollection mongoDBDatabasePartitionMerge(MergeParameters mergeParameters) {
        return serviceManager.mongoDBResources().mongoDBDatabasePartitionMerge(resourceGroupName, accountName,
            databaseName, mergeParameters);
    }

    public PhysicalPartitionStorageInfoCollection mongoDBDatabasePartitionMerge(MergeParameters mergeParameters,
        Context context) {
        return serviceManager.mongoDBResources().mongoDBDatabasePartitionMerge(resourceGroupName, accountName,
            databaseName, mergeParameters, context);
    }
