...
public final class NotebookWorkspaceImpl
    ...
    public NotebookWorkspace create() {
        this.innerObject = serviceManager.serviceClient().getNotebookWorkspaces().createOrUpdate(resourceGroupName,
            accountName, notebookWorkspaceName, createNotebookCreateUpdateParameters, Context.NONE);
        return this;
    }

    public NotebookWorkspace create(Context context) {
        this.innerObject = serviceManager.serviceClient().getNotebookWorkspaces().createOrUpdate(resourceGroupName,
            accountName, notebookWorkspaceName, createNotebookCreateUpdateParameters, context);
        return this;
    }

    NotebookWorkspaceImpl(NotebookWorkspaceName name,
    ...
    public NotebookWorkspace apply() {
        this.innerObject = serviceManager.serviceClient().getNotebookWorkspaces().createOrUpdate(resourceGroupName,
            accountName, notebookWorkspaceName, updateNotebookCreateUpdateParameters, Context.NONE);
        return this;
    }

    public NotebookWorkspace apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getNotebookWorkspaces().createOrUpdate(resourceGroupName,
            accountName, notebookWorkspaceName, updateNotebookCreateUpdateParameters, context);
        return this;
    }

    NotebookWorkspaceImpl(NotebookWorkspaceInner innerObject,
        com.azure.resourcemanager.cosmos.generated.CosmosDBManager serviceManager) {
    ...
    public NotebookWorkspace refresh() {
        this.innerObject = serviceManager.serviceClient().getNotebookWorkspaces()
            .getWithResponse(resourceGroupName, accountName, notebookWorkspaceName, Context.NONE).getValue();
        return this;
    }

    public NotebookWorkspace refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getNotebookWorkspaces()
            .getWithResponse(resourceGroupName, accountName, notebookWorkspaceName, context).getValue();
        return this;
    }

    public Response<NotebookWorkspaceConnectionInfoResult> listConnectionInfoWithResponse(Context context) {
        return serviceManager.notebookWorkspaces().listConnectionInfoWithResponse(resourceGroupName, accountName,
            notebookWorkspaceName, context);
    }

    public NotebookWorkspaceConnectionInfoResult listConnectionInfo() {
        return serviceManager.notebookWorkspaces().listConnectionInfo(resourceGroupName, accountName,
