...
public interface CassandraClusters {
     ...
     * @return response of /command api.
     */
    CommandOutput listCommand(String resourceGroupName, String clusterName);
     ...
     * @return response of /command api.
     */
    CommandOutput listCommand(String resourceGroupName, String clusterName, Context context);
