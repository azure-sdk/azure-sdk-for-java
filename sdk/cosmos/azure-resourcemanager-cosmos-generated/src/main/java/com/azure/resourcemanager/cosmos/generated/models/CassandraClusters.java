...
public interface CassandraClusters {
     ...
     */
    PagedIterable<ClusterResource> listBySubscription();
     ...
     * @return list of managed Cassandra clusters as paginated response with {@link PagedIterable}.
     */
    PagedIterable<ClusterResource> listBySubscription(Context context);
     ...
     */
    Response<ClusterResource> getWithResponse(String resourceGroupName, String clusterName, Context context);
     ...
     */
    ClusterResource get(String resourceGroupName, String clusterName);
     ...
     * @return list of managed Cassandra clusters as paginated response with {@link PagedIterable}.
     */
    PagedIterable<ClusterResourceAutoGenerated> listBySubscription();
     ...
     * @return list of managed Cassandra clusters as paginated response with {@link PagedIterable}.
     */
    PagedIterable<ClusterResourceAutoGenerated> listBySubscription(Context context);
     ...
     * @return list of managed Cassandra clusters as paginated response with {@link PagedIterable}.
     */
    PagedIterable<ClusterResourceAutoGenerated> listByResourceGroup(String resourceGroupName);
     ...
     * @return list of managed Cassandra clusters as paginated response with {@link PagedIterable}.
     */
    PagedIterable<ClusterResourceAutoGenerated> listByResourceGroup(String resourceGroupName, Context context);
     ...
     * @return the properties of a managed Cassandra cluster along with {@link Response}.
     */
    Response<ClusterResourceAutoGenerated> getWithResponse(
        String resourceGroupName, String clusterName, Context context);
     ...
     * @return the properties of a managed Cassandra cluster.
     */
    ClusterResourceAutoGenerated get(String resourceGroupName, String clusterName);
     ...
     *     Response}.
     */
    Response<CassandraClusterPublicStatusAutoGenerated> statusWithResponse(
        String resourceGroupName, String clusterName, Context context);
     ...
     * @return the CPU, memory, and disk usage statistics for each Cassandra node in a cluster.
     */
    CassandraClusterPublicStatusAutoGenerated status(String resourceGroupName, String clusterName);
     ...
     */
    ClusterResource.DefinitionStages.Blank defineUpdate(String name);

    /**
     * Begins definition for a new ClusterResourceAutoGenerated resource.
     *
     * @param name resource name.
     * @return the first stage of the new ClusterResourceAutoGenerated definition.
     */
    ClusterResourceAutoGenerated.DefinitionStages.Blank defineUpdate(String name);
}
