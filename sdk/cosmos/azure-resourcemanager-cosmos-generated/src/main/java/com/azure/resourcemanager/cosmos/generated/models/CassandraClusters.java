...
public interface CassandraClusters {
     ...
     * @return resource representing a command.
     */
    CommandPublicResource invokeCommandAsync(
     ...
     */
    ListCommands listCommand(String resourceGroupName, String clusterName);
     ...
     * @return list of commands for cluster.
     */
    ListCommands listCommand(String resourceGroupName, String clusterName, Context context);
     ...
     * @return list of details about commands that were run asynchronously.
     */
    ListCommands getCommandAsync(String resourceGroupName, String clusterName, String commandId, Context context);
