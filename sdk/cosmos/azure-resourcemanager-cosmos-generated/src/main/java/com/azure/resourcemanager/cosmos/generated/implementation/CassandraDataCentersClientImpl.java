...
import com.azure.resourcemanager.cosmos.generated.models.ListDataCenters;
import com.azure.resourcemanager.cosmos.generated.models.ListDataCentersAutoGenerated;
...
public final class CassandraDataCentersClientImpl implements CassandraDataCentersClient {
    ...
    public interface CassandraDataCentersService {
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ListDataCentersAutoGenerated>> list(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("clusterName") String clusterName,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<DataCenterResourceAutoGeneratedInner>> get(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("clusterName") String clusterName,
        ...
        Mono<Response<Flux<ByteBuffer>>> createUpdate(
            ...
            @PathParam("dataCenterName") String dataCenterName,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") DataCenterResourceAutoGeneratedInner body,
            @HeaderParam("Accept") String accept,
            Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DataCenterResourceInner> getAsync(
        String resourceGroupName, String clusterName, String dataCenterName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<DataCenterResourceAutoGeneratedInner>> listSinglePageAsync(
        String resourceGroupName, String clusterName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                ...
                context ->
                    service
                        .list(
                            ...
                            accept,
                            context))
            .<PagedResponse<DataCenterResourceAutoGeneratedInner>>map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(), null, null))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<DataCenterResourceAutoGeneratedInner> listAsync(String resourceGroupName, String clusterName) {
        return new PagedFlux<>(() -> listSinglePageAsync(resourceGroupName, clusterName));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<DataCenterResourceAutoGeneratedInner> listAsync(
        String resourceGroupName, String clusterName, Context context) {
        return new PagedFlux<>(() -> listSinglePageAsync(resourceGroupName, clusterName, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<DataCenterResourceAutoGeneratedInner> list(String resourceGroupName, String clusterName) {
        return new PagedIterable<>(listAsync(resourceGroupName, clusterName));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<DataCenterResourceAutoGeneratedInner> list(
        String resourceGroupName, String clusterName, Context context) {
        return new PagedIterable<>(listAsync(resourceGroupName, clusterName, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<DataCenterResourceAutoGeneratedInner>> getWithResponseAsync(
        String resourceGroupName, String clusterName, String dataCenterName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DataCenterResourceAutoGeneratedInner> getAsync(
        String resourceGroupName, String clusterName, String dataCenterName) {
        return getWithResponseAsync(resourceGroupName, clusterName, dataCenterName)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<DataCenterResourceAutoGeneratedInner> getWithResponse(
        String resourceGroupName, String clusterName, String dataCenterName, Context context) {
        return getWithResponseAsync(resourceGroupName, clusterName, dataCenterName, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public DataCenterResourceAutoGeneratedInner get(
        String resourceGroupName, String clusterName, String dataCenterName) {
        return getWithResponse(resourceGroupName, clusterName, dataCenterName, Context.NONE).getValue();
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> createUpdateWithResponseAsync(
        ...
        String clusterName,
        String dataCenterName,
        DataCenterResourceAutoGeneratedInner body) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<DataCenterResourceAutoGeneratedInner>, DataCenterResourceAutoGeneratedInner>
        ...
        return this
            .client
            .<DataCenterResourceAutoGeneratedInner, DataCenterResourceAutoGeneratedInner>getLroResult(
                mono,
                this.client.getHttpPipeline(),
                DataCenterResourceAutoGeneratedInner.class,
                DataCenterResourceAutoGeneratedInner.class,
                this.client.getContext());
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<DataCenterResourceAutoGeneratedInner>, DataCenterResourceAutoGeneratedInner>
        beginCreateUpdate(
            String resourceGroupName,
            String clusterName,
            String dataCenterName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DataCenterResourceAutoGeneratedInner> createUpdateAsync(
        String resourceGroupName,
        String clusterName,
        String dataCenterName,
        DataCenterResourceAutoGeneratedInner body) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public DataCenterResourceAutoGeneratedInner createUpdate(
        String resourceGroupName,
        String clusterName,
        String dataCenterName,
        DataCenterResourceAutoGeneratedInner body) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DataCenterResourceAutoGeneratedInner> updateAsync(
        String resourceGroupName,
        String clusterName,
        String dataCenterName,
        DataCenterResourceAutoGeneratedInner body) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public DataCenterResourceAutoGeneratedInner update(
        String resourceGroupName,
        String clusterName,
        String dataCenterName,
        DataCenterResourceAutoGeneratedInner body) {
