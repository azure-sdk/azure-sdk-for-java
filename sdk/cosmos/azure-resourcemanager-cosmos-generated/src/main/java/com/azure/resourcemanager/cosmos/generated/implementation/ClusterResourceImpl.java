...
public final class ClusterResourceImpl implements ClusterResource, ClusterResource.Definition, ClusterResource.Update {
    ...
    public ClusterResource create() {
        this.innerObject = serviceManager.serviceClient().getCassandraClusters().createUpdate(resourceGroupName,
    ...
    public ClusterResource apply() {
        this.innerObject = serviceManager.serviceClient().getCassandraClusters().update(resourceGroupName, clusterName,
    ...
    ClusterResourceImpl(ClusterResourceInner innerObject,
        com.azure.resourcemanager.cosmos.generated.CosmosDBManager serviceManager) {
        this.innerObject = innerObject;
        this.serviceManager = serviceManager;
        this.resourceGroupName = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "resourceGroups");
        this.clusterName = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "cassandraClusters");
    }

    public ClusterResource refresh() {
        this.innerObject = serviceManager.serviceClient().getCassandraClusters()
    ...
    public CommandPublicResource invokeCommandAsync(CommandPostBody body) {
        return serviceManager.cassandraClusters().invokeCommandAsync(resourceGroupName, clusterName, body);
    }

    public CommandPublicResource invokeCommandAsync(CommandPostBody body, Context context) {
        return serviceManager.cassandraClusters().invokeCommandAsync(resourceGroupName, clusterName, body, context);
    }
    ...
    public void deallocate(String xMsForceDeallocate, Context context) {
