...
public final class ClusterResourceImpl implements ClusterResource, ClusterResource.Definition, ClusterResource.Update {
    ...
    public CommandPublicResource invokeAsyncCommand(CommandPostBody body) {
        return serviceManager.cassandraClusters().invokeAsyncCommand(resourceGroupName, clusterName, body);
    }

    public CommandPublicResource invokeAsyncCommand(CommandPostBody body, Context context) {
        return serviceManager.cassandraClusters().invokeAsyncCommand(resourceGroupName, clusterName, body, context);
    }
