...
@Fluent
public final class CassandraClusterPublicStatusAutoGeneratedInner {
    /*
     * The eTag property.
     */
    ...
    private List<CassandraClusterPublicStatusDataCentersItemAutoGenerated> dataCenters;

    /** Creates an instance of CassandraClusterPublicStatusAutoGeneratedInner class. */
    public CassandraClusterPublicStatusAutoGeneratedInner() {
    }
     ...
     * @return the CassandraClusterPublicStatusAutoGeneratedInner object itself.
     */
    public CassandraClusterPublicStatusAutoGeneratedInner withEtag(String etag) {
        this.etag = etag;
        return this;
    }
     ...
     * @return the CassandraClusterPublicStatusAutoGeneratedInner object itself.
     */
    public CassandraClusterPublicStatusAutoGeneratedInner withReaperStatus(ManagedCassandraReaperStatus reaperStatus) {
     ...
     * @return the CassandraClusterPublicStatusAutoGeneratedInner object itself.
     */
    public CassandraClusterPublicStatusAutoGeneratedInner withConnectionErrors(List<ConnectionError> connectionErrors) {
     ...
     * @return the CassandraClusterPublicStatusAutoGeneratedInner object itself.
     */
    public CassandraClusterPublicStatusAutoGeneratedInner withDataCenters(
