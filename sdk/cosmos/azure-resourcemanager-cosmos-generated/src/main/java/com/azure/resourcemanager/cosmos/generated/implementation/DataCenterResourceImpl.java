...
public final class DataCenterResourceImpl
    ...
    public DataCenterResource create() {
        this.innerObject = serviceManager.serviceClient().getCassandraDataCenters().createUpdate(resourceGroupName,
            clusterName, dataCenterName, this.innerModel(), Context.NONE);
        return this;
    }

    public DataCenterResource create(Context context) {
        this.innerObject = serviceManager.serviceClient().getCassandraDataCenters().createUpdate(resourceGroupName,
            clusterName, dataCenterName, this.innerModel(), context);
        return this;
    }
    ...
    public DataCenterResource apply() {
        this.innerObject = serviceManager.serviceClient().getCassandraDataCenters().update(resourceGroupName,
            clusterName, dataCenterName, this.innerModel(), Context.NONE);
        return this;
    }
    ...
    DataCenterResourceImpl(DataCenterResourceInner innerObject,
    ...
    public DataCenterResource refresh() {
        this.innerObject = serviceManager.serviceClient().getCassandraDataCenters()
            .getWithResponse(resourceGroupName, clusterName, dataCenterName, Context.NONE).getValue();
        return this;
    }

    public DataCenterResource refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getCassandraDataCenters()
            .getWithResponse(resourceGroupName, clusterName, dataCenterName, context).getValue();
        return this;
    }
