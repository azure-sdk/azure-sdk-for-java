...
public final class NotebookWorkspacesImpl implements NotebookWorkspaces {
    ...
    public NotebookWorkspacesImpl(NotebookWorkspacesClient innerClient,
    ...
    public Response<NotebookWorkspace> getWithResponse(String resourceGroupName, String accountName,
    ...
    public NotebookWorkspace get(String resourceGroupName, String accountName,
    ...
    public Response<NotebookWorkspaceConnectionInfoResult> listConnectionInfoWithResponse(String resourceGroupName,
        String accountName, NotebookWorkspaceName notebookWorkspaceName, Context context) {
        Response<NotebookWorkspaceConnectionInfoResultInner> inner = this.serviceClient()
    ...
    public NotebookWorkspaceConnectionInfoResult listConnectionInfo(String resourceGroupName, String accountName,
        NotebookWorkspaceName notebookWorkspaceName) {
    ...
    public NotebookWorkspace getById(String id) {
        ...
        if (notebookWorkspaceNameLocal == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
                String.format("The resource ID '%s' is not valid. Missing path segment 'notebookWorkspaces'.", id)));
        }
