...
public final class TableGetResultsImpl implements TableGetResults, TableGetResults.Definition, TableGetResults.Update {
    ...
    public TableGetResults create() {
        this.innerObject = serviceManager.serviceClient()
            .getTableResources()
            .createUpdateTable(resourceGroupName, accountName, tableName, createCreateUpdateTableParameters,
                Context.NONE);
        return this;
    }
    ...
    public TableGetResults create(Context context) {
        this.innerObject = serviceManager.serviceClient()
            .getTableResources()
            .createUpdateTable(resourceGroupName, accountName, tableName, createCreateUpdateTableParameters, context);
        return this;
    }
    ...
    public TableGetResults apply() {
        this.innerObject = serviceManager.serviceClient()
            .getTableResources()
            .createUpdateTable(resourceGroupName, accountName, tableName, updateCreateUpdateTableParameters,
                Context.NONE);
        return this;
    }
    ...
    public TableGetResults apply(Context context) {
        this.innerObject = serviceManager.serviceClient()
            .getTableResources()
            .createUpdateTable(resourceGroupName, accountName, tableName, updateCreateUpdateTableParameters, context);
        return this;
    }
    ...
    public BackupInformation retrieveContinuousBackupInformation(ContinuousBackupRestoreLocation location) {
        return serviceManager.tableResources()
