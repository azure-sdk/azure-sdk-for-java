...
import com.azure.resourcemanager.cosmos.generated.models.RestorableTableResourcesListResult;
...
public final class RestorableTableResourcesClientImpl implements RestorableTableResourcesClient {
    ...
    private interface RestorableTableResourcesService {
        @Headers({"Content-Type: application/json"})
        @Get(
            "/subscriptions/{subscriptionId}/providers/Microsoft.DocumentDB/locations/{location}"
                + "/restorableDatabaseAccounts/{instanceId}/restorableTableResources")
