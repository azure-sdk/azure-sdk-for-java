 ...
 */
@Fluent
public final class MongoMIRoleDefinitionResourceInner extends ProxyResource {
    /*
     * Properties to create and update an Azure Cosmos DB MongoMI Role Definition.
     */
    private MongoMIRoleDefinitionResourceProperties innerProperties;
    ...
    /**
     * Get the innerProperties property: Properties to create and update an Azure Cosmos DB MongoMI Role Definition.
     * 
     ...
     * @return the MongoMIRoleDefinitionResourceInner object itself.
     */
    public MongoMIRoleDefinitionResourceInner withIdPropertiesId(String id) {
        if (this.innerProperties() == null) {
            this.innerProperties = new MongoMIRoleDefinitionResourceProperties();
        }
     ...
     * @return the MongoMIRoleDefinitionResourceInner object itself.
     */
    public MongoMIRoleDefinitionResourceInner withPermissions(List<PermissionAutoGenerated3> permissions) {
        if (this.innerProperties() == null) {
            this.innerProperties = new MongoMIRoleDefinitionResourceProperties();
        }
     ...
     * @return An instance of MongoMIRoleDefinitionResourceInner if the JsonReader was pointing to an instance of it, or
     * null if it was pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the MongoMIRoleDefinitionResourceInner.
     */
    public static MongoMIRoleDefinitionResourceInner fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            MongoMIRoleDefinitionResourceInner deserializedMongoMIRoleDefinitionResourceInner
                = new MongoMIRoleDefinitionResourceInner();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("id".equals(fieldName)) {
                    deserializedMongoMIRoleDefinitionResourceInner.id = reader.getString();
                } else if ("name".equals(fieldName)) {
                    deserializedMongoMIRoleDefinitionResourceInner.name = reader.getString();
                } else if ("type".equals(fieldName)) {
                    deserializedMongoMIRoleDefinitionResourceInner.type = reader.getString();
                } else if ("properties".equals(fieldName)) {
                    deserializedMongoMIRoleDefinitionResourceInner.innerProperties
                        = MongoMIRoleDefinitionResourceProperties.fromJson(reader);
                } else if ("systemData".equals(fieldName)) {
                    deserializedMongoMIRoleDefinitionResourceInner.systemData = SystemData.fromJson(reader);
                } else {
                    reader.skipChildren();
                }
            }

            return deserializedMongoMIRoleDefinitionResourceInner;
        });
    }
}
