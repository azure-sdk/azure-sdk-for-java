...
import com.azure.resourcemanager.cosmos.generated.models.CapacityModeChangeTransitionState;
...
public final class DatabaseAccountGetResultsImpl
    ...
    public CapacityMode capacityMode() {
        return this.innerModel().capacityMode();
    }

    public CapacityModeChangeTransitionState capacityModeChangeTransitionState() {
        return this.innerModel().capacityModeChangeTransitionState();
    }
    ...
    public Boolean enablePriorityBasedExecution() {
        return this.innerModel().enablePriorityBasedExecution();
    }

    public DefaultPriorityLevel defaultPriorityLevel() {
        return this.innerModel().defaultPriorityLevel();
    }

    public Boolean enablePerRegionPerPartitionAutoscale() {
        return this.innerModel().enablePerRegionPerPartitionAutoscale();
    }
    ...
    public DatabaseAccountGetResults create() {
        this.innerObject = serviceManager.serviceClient().getDatabaseAccounts().createOrUpdate(resourceGroupName,
            accountName, createCreateUpdateParameters, Context.NONE);
        return this;
    }

    public DatabaseAccountGetResults create(Context context) {
        this.innerObject = serviceManager.serviceClient().getDatabaseAccounts().createOrUpdate(resourceGroupName,
            accountName, createCreateUpdateParameters, context);
        return this;
    }

    DatabaseAccountGetResultsImpl(String name,
    ...
    public DatabaseAccountGetResults apply() {
        this.innerObject = serviceManager.serviceClient().getDatabaseAccounts().update(resourceGroupName, accountName,
            updateUpdateParameters, Context.NONE);
        return this;
    }

    public DatabaseAccountGetResults apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getDatabaseAccounts().update(resourceGroupName, accountName,
            updateUpdateParameters, context);
        return this;
    }

    DatabaseAccountGetResultsImpl(DatabaseAccountGetResultsInner innerObject,
        com.azure.resourcemanager.cosmos.generated.CosmosDBManager serviceManager) {
    ...
    public DatabaseAccountGetResults refresh() {
        this.innerObject = serviceManager.serviceClient().getDatabaseAccounts()
    ...
    public Response<DatabaseAccountListConnectionStringsResult> listConnectionStringsWithResponse(Context context) {
        return serviceManager.databaseAccounts().listConnectionStringsWithResponse(resourceGroupName, accountName,
            context);
    }
    ...
    public DatabaseAccountGetResultsImpl withCapacityMode(CapacityMode capacityMode) {
        if (isInCreateMode()) {
            this.createCreateUpdateParameters.withCapacityMode(capacityMode);
            return this;
        } else {
            this.updateUpdateParameters.withCapacityMode(capacityMode);
            return this;
        }
    }
    ...
    public DatabaseAccountGetResultsImpl withCustomerManagedKeyStatus(String customerManagedKeyStatus) {
        if (isInCreateMode()) {
            this.createCreateUpdateParameters.withCustomerManagedKeyStatus(customerManagedKeyStatus);
            return this;
        } else {
            this.updateUpdateParameters.withCustomerManagedKeyStatus(customerManagedKeyStatus);
            return this;
        }
    }

    public DatabaseAccountGetResultsImpl withEnablePriorityBasedExecution(Boolean enablePriorityBasedExecution) {
        if (isInCreateMode()) {
            this.createCreateUpdateParameters.withEnablePriorityBasedExecution(enablePriorityBasedExecution);
            return this;
        } else {
            this.updateUpdateParameters.withEnablePriorityBasedExecution(enablePriorityBasedExecution);
            return this;
        }
    }

    public DatabaseAccountGetResultsImpl withDefaultPriorityLevel(DefaultPriorityLevel defaultPriorityLevel) {
        if (isInCreateMode()) {
            this.createCreateUpdateParameters.withDefaultPriorityLevel(defaultPriorityLevel);
            return this;
        } else {
            this.updateUpdateParameters.withDefaultPriorityLevel(defaultPriorityLevel);
            return this;
        }
    }
    ...
    public DatabaseAccountGetResultsImpl
        ...
        if (isInCreateMode()) {
            this.createCreateUpdateParameters
                .withEnablePerRegionPerPartitionAutoscale(enablePerRegionPerPartitionAutoscale);
            return this;
        } else {
            this.updateUpdateParameters.withEnablePerRegionPerPartitionAutoscale(enablePerRegionPerPartitionAutoscale);
            return this;
        }
    }
