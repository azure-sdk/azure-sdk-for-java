...
public final class DatabaseAccountGetResultsImpl
    ...
    public Boolean enableAllVersionsAndDeletesChangeFeed() {
        return this.innerModel().enableAllVersionsAndDeletesChangeFeed();
    }
    ...
    public void failoverPriorityChange(FailoverPolicies failoverParameters, Context context) {
        serviceManager.databaseAccounts()
    ...
    public Response<DatabaseAccountListConnectionStringsResult> listConnectionStringsWithResponse(Context context) {
        return serviceManager.databaseAccounts()
    ...
    public DatabaseAccountGetResultsImpl
        ...
        if (isInCreateMode()) {
            this.createCreateUpdateParameters
                .withEnableAllVersionsAndDeletesChangeFeed(enableAllVersionsAndDeletesChangeFeed);
            return this;
        } else {
            this.updateUpdateParameters
                .withEnableAllVersionsAndDeletesChangeFeed(enableAllVersionsAndDeletesChangeFeed);
            return this;
        }
    }
