...
public final class DatabaseAccountGetResultsImpl
    ...
    public DatabaseAccountGetResultsImpl withKeysMetadata(DatabaseAccountKeysMetadata keysMetadata) {
        if (isInCreateMode()) {
            this.createCreateUpdateParameters.withKeysMetadata(keysMetadata);
            return this;
        } else {
            this.updateUpdateParameters.withKeysMetadata(keysMetadata);
            return this;
        }
    }
