...
@Fluent
public class SqlContainerResourceAutoGenerated {
    /*
    ...
    /** Creates an instance of SqlContainerResourceAutoGenerated class. */
    public SqlContainerResourceAutoGenerated() {
    }
     ...
     * @return the SqlContainerResourceAutoGenerated object itself.
     */
    public SqlContainerResourceAutoGenerated withId(String id) {
        this.id = id;
        return this;
    }
     ...
     * @return the SqlContainerResourceAutoGenerated object itself.
     */
    public SqlContainerResourceAutoGenerated withIndexingPolicy(IndexingPolicy indexingPolicy) {
     ...
     * @return the SqlContainerResourceAutoGenerated object itself.
     */
    public SqlContainerResourceAutoGenerated withPartitionKey(ContainerPartitionKey partitionKey) {
     ...
     * @return the SqlContainerResourceAutoGenerated object itself.
     */
    public SqlContainerResourceAutoGenerated withDefaultTtl(Integer defaultTtl) {
     ...
     * @return the SqlContainerResourceAutoGenerated object itself.
     */
    public SqlContainerResourceAutoGenerated withUniqueKeyPolicy(UniqueKeyPolicy uniqueKeyPolicy) {
     ...
     * @return the SqlContainerResourceAutoGenerated object itself.
     */
    public SqlContainerResourceAutoGenerated withConflictResolutionPolicy(
     ...
     * @return the SqlContainerResourceAutoGenerated object itself.
     */
    public SqlContainerResourceAutoGenerated withClientEncryptionPolicy(ClientEncryptionPolicy clientEncryptionPolicy) {
     ...
     * @return the SqlContainerResourceAutoGenerated object itself.
     */
    public SqlContainerResourceAutoGenerated withAnalyticalStorageTtl(Long analyticalStorageTtl) {
     ...
     * @return the SqlContainerResourceAutoGenerated object itself.
     */
    public SqlContainerResourceAutoGenerated withRestoreParameters(ResourceRestoreParameters restoreParameters) {
     ...
     * @return the SqlContainerResourceAutoGenerated object itself.
     */
    public SqlContainerResourceAutoGenerated withCreateMode(CreateMode createMode) {
            ...
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException(
                        "Missing required property id in model SqlContainerResourceAutoGenerated"));
        }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(SqlContainerResourceAutoGenerated.class);
}
