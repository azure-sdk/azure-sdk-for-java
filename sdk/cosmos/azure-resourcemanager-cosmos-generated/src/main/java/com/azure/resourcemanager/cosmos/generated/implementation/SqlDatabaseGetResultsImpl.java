...
public final class SqlDatabaseGetResultsImpl
    ...
    public SqlDatabaseGetResults create() {
        this.innerObject = serviceManager.serviceClient().getSqlResources().createUpdateSqlDatabase(resourceGroupName,
            accountName, databaseName, createCreateUpdateSqlDatabaseParameters, Context.NONE);
        return this;
    }

    public SqlDatabaseGetResults create(Context context) {
        this.innerObject = serviceManager.serviceClient().getSqlResources().createUpdateSqlDatabase(resourceGroupName,
            accountName, databaseName, createCreateUpdateSqlDatabaseParameters, context);
        return this;
    }

    SqlDatabaseGetResultsImpl(String name, com.azure.resourcemanager.cosmos.generated.CosmosDBManager serviceManager) {
    ...
    public SqlDatabaseGetResults apply() {
        this.innerObject = serviceManager.serviceClient().getSqlResources().createUpdateSqlDatabase(resourceGroupName,
            accountName, databaseName, updateCreateUpdateSqlDatabaseParameters, Context.NONE);
        return this;
    }

    public SqlDatabaseGetResults apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getSqlResources().createUpdateSqlDatabase(resourceGroupName,
            accountName, databaseName, updateCreateUpdateSqlDatabaseParameters, context);
        return this;
    }

    SqlDatabaseGetResultsImpl(SqlDatabaseGetResultsInner innerObject,
    ...
    public SqlDatabaseGetResults refresh() {
        this.innerObject = serviceManager.serviceClient().getSqlResources()
            .getSqlDatabaseWithResponse(resourceGroupName, accountName, databaseName, Context.NONE).getValue();
        return this;
    }

    public SqlDatabaseGetResults refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getSqlResources()
            .getSqlDatabaseWithResponse(resourceGroupName, accountName, databaseName, context).getValue();
        return this;
    }

    public PhysicalPartitionStorageInfoCollection sqlDatabasePartitionMerge(MergeParameters mergeParameters) {
        return serviceManager.sqlResources().sqlDatabasePartitionMerge(resourceGroupName, accountName, databaseName,
            mergeParameters);
    }
