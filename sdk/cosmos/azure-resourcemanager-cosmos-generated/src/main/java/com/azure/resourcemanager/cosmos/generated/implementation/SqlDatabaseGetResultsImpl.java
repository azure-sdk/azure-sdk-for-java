...
public final class SqlDatabaseGetResultsImpl
    ...
    public SqlDatabaseGetResults create() {
        this.innerObject = serviceManager.serviceClient()
            .getSqlResources()
            .createUpdateSqlDatabase(resourceGroupName, accountName, databaseName,
                createCreateUpdateSqlDatabaseParameters, Context.NONE);
        return this;
    }
    ...
    public SqlDatabaseGetResults apply() {
        this.innerObject = serviceManager.serviceClient()
            .getSqlResources()
            .createUpdateSqlDatabase(resourceGroupName, accountName, databaseName,
                updateCreateUpdateSqlDatabaseParameters, Context.NONE);
        return this;
    }
    ...
    public SqlDatabaseGetResults apply(Context context) {
        this.innerObject = serviceManager.serviceClient()
            .getSqlResources()
            .createUpdateSqlDatabase(resourceGroupName, accountName, databaseName,
                updateCreateUpdateSqlDatabaseParameters, context);
        return this;
    }
