...
public final class MongoClustersClientImpl implements MongoClustersClient {
    ...
    public interface MongoClustersService {
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<MongoClusterInner>> get(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<MongoClusterInner>> getWithResponseAsync(String resourceGroupName, String mongoClusterName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<MongoClusterInner>> getWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<MongoClusterInner> getAsync(String resourceGroupName, String mongoClusterName) {
        return getWithResponseAsync(resourceGroupName, mongoClusterName)
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<MongoClusterInner> getWithResponse(
        String resourceGroupName, String mongoClusterName, Context context) {
        return getWithResponseAsync(resourceGroupName, mongoClusterName, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public MongoClusterInner get(String resourceGroupName, String mongoClusterName) {
        return getWithResponse(resourceGroupName, mongoClusterName, Context.NONE).getValue();
    }
