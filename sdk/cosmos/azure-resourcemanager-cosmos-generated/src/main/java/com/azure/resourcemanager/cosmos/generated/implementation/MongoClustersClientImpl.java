...
import com.azure.resourcemanager.cosmos.generated.models.FirewallRuleListResult;
import com.azure.resourcemanager.cosmos.generated.models.MongoClusterListResult;
...
public final class MongoClustersClientImpl implements MongoClustersClient {
    ...
    public interface MongoClustersService {
        ...
        Mono<Response<MongoClusterListResult>> list(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<MongoClusterListResult>> listByResourceGroup(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
        ...
        Mono<Response<Flux<ByteBuffer>>> createOrUpdate(@HostParam("$host") String endpoint,
            ...
            @BodyParam("application/json") MongoClusterInner parameters, @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<MongoClusterInner>> getByResourceGroup(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
        ...
        Mono<Response<Flux<ByteBuffer>>> update(@HostParam("$host") String endpoint,
            ...
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("mongoClusterName") String mongoClusterName,
            @BodyParam("application/json") MongoClusterUpdate parameters, @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({ 200, 201 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Flux<ByteBuffer>>> createOrUpdateFirewallRule(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("mongoClusterName") String mongoClusterName,
        ...
        @ExpectedResponses({ 202, 204 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Flux<ByteBuffer>>> deleteFirewallRule(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("mongoClusterName") String mongoClusterName,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<FirewallRuleInner>> getFirewallRule(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("mongoClusterName") String mongoClusterName,
            @PathParam("firewallRuleName") String firewallRuleName, @HeaderParam("Accept") String accept,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<FirewallRuleListResult>> listFirewallRules(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("mongoClusterName") String mongoClusterName, @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ListConnectionStringsResultInner>> listConnectionStrings(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("mongoClusterName") String mongoClusterName, @HeaderParam("Accept") String accept,
            Context context);
    ...
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String resourceGroupName,
        String mongoClusterName, MongoClusterInner parameters) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return FluxUtil
            .withContext(context -> service.createOrUpdate(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, mongoClusterName, parameters, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String resourceGroupName,
        String mongoClusterName, MongoClusterInner parameters, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    private PollerFlux<PollResult<MongoClusterInner>, MongoClusterInner>
        beginCreateOrUpdateAsync(String resourceGroupName, String mongoClusterName, MongoClusterInner parameters) {
    ...
    private Mono<MongoClusterInner> createOrUpdateAsync(String resourceGroupName, String mongoClusterName,
        MongoClusterInner parameters) {
        return beginCreateOrUpdateAsync(resourceGroupName, mongoClusterName, parameters).last()
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<MongoClusterInner> createOrUpdateAsync(String resourceGroupName, String mongoClusterName,
        MongoClusterInner parameters, Context context) {
        return beginCreateOrUpdateAsync(resourceGroupName, mongoClusterName, parameters, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> updateWithResponseAsync(String resourceGroupName, String mongoClusterName,
        MongoClusterUpdate parameters, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service.update(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, mongoClusterName, parameters, accept, context);
    }
    ...
    private PollerFlux<PollResult<MongoClusterInner>, MongoClusterInner> beginUpdateAsync(String resourceGroupName,
        String mongoClusterName, MongoClusterUpdate parameters) {
        Mono<Response<Flux<ByteBuffer>>> mono
    ...
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<MongoClusterInner>, MongoClusterInner> beginUpdateAsync(String resourceGroupName,
        String mongoClusterName, MongoClusterUpdate parameters, Context context) {
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono
    ...
    private Mono<MongoClusterInner> updateAsync(String resourceGroupName, String mongoClusterName,
        MongoClusterUpdate parameters) {
        return beginUpdateAsync(resourceGroupName, mongoClusterName, parameters).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<MongoClusterInner> updateAsync(String resourceGroupName, String mongoClusterName,
        MongoClusterUpdate parameters, Context context) {
        return beginUpdateAsync(resourceGroupName, mongoClusterName, parameters, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateFirewallRuleWithResponseAsync(String resourceGroupName,
        String mongoClusterName, String firewallRuleName, FirewallRuleInner parameters) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.createOrUpdateFirewallRule(this.client.getEndpoint(),
                this.client.getApiVersion(), this.client.getSubscriptionId(), resourceGroupName, mongoClusterName,
                firewallRuleName, parameters, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateFirewallRuleWithResponseAsync(String resourceGroupName,
        String mongoClusterName, String firewallRuleName, FirewallRuleInner parameters, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.createOrUpdateFirewallRule(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, mongoClusterName, firewallRuleName, parameters, accept,
            context);
    }
    ...
    private PollerFlux<PollResult<FirewallRuleInner>, FirewallRuleInner> beginCreateOrUpdateFirewallRuleAsync(
        ...
        Mono<Response<Flux<ByteBuffer>>> mono = createOrUpdateFirewallRuleWithResponseAsync(resourceGroupName,
            mongoClusterName, firewallRuleName, parameters);
    ...
    private PollerFlux<PollResult<FirewallRuleInner>, FirewallRuleInner> beginCreateOrUpdateFirewallRuleAsync(
        ...
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono = createOrUpdateFirewallRuleWithResponseAsync(resourceGroupName,
            mongoClusterName, firewallRuleName, parameters, context);
        return this.client.<FirewallRuleInner, FirewallRuleInner>getLroResult(mono, this.client.getHttpPipeline(),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<FirewallRuleInner> createOrUpdateFirewallRuleAsync(String resourceGroupName, String mongoClusterName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public FirewallRuleInner createOrUpdateFirewallRule(String resourceGroupName, String mongoClusterName,
        String firewallRuleName, FirewallRuleInner parameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> deleteFirewallRuleWithResponseAsync(String resourceGroupName,
        String mongoClusterName, String firewallRuleName) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.deleteFirewallRule(this.client.getEndpoint(), this.client.getApiVersion(),
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> deleteFirewallRuleWithResponseAsync(String resourceGroupName,
        String mongoClusterName, String firewallRuleName, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.deleteFirewallRule(this.client.getEndpoint(), this.client.getApiVersion(),
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<Void>, Void> beginDeleteFirewallRuleAsync(String resourceGroupName,
        String mongoClusterName, String firewallRuleName) {
        Mono<Response<Flux<ByteBuffer>>> mono
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<Void>, Void> beginDeleteFirewallRule(String resourceGroupName, String mongoClusterName,
    ...
    public SyncPoller<PollResult<Void>, Void> beginDeleteFirewallRule(String resourceGroupName, String mongoClusterName,
        ...
        return this.beginDeleteFirewallRuleAsync(resourceGroupName, mongoClusterName, firewallRuleName, context)
            .getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> deleteFirewallRuleAsync(String resourceGroupName, String mongoClusterName,
        String firewallRuleName) {
        return beginDeleteFirewallRuleAsync(resourceGroupName, mongoClusterName, firewallRuleName).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<Void> deleteFirewallRuleAsync(String resourceGroupName, String mongoClusterName,
        String firewallRuleName, Context context) {
        return beginDeleteFirewallRuleAsync(resourceGroupName, mongoClusterName, firewallRuleName, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<FirewallRuleInner>> getFirewallRuleWithResponseAsync(String resourceGroupName,
        String mongoClusterName, String firewallRuleName) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.getFirewallRule(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, mongoClusterName, firewallRuleName, accept,
                context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<FirewallRuleInner>> getFirewallRuleWithResponseAsync(String resourceGroupName,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.getFirewallRule(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, mongoClusterName, firewallRuleName, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<FirewallRuleInner> getFirewallRuleAsync(String resourceGroupName, String mongoClusterName,
        String firewallRuleName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<FirewallRuleInner> getFirewallRuleWithResponse(String resourceGroupName, String mongoClusterName,
        String firewallRuleName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public FirewallRuleInner getFirewallRule(String resourceGroupName, String mongoClusterName,
        String firewallRuleName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<FirewallRuleInner>> listFirewallRulesSinglePageAsync(String resourceGroupName,
        String mongoClusterName) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.listFirewallRules(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, mongoClusterName, accept, context))
    ...
    private Mono<PagedResponse<FirewallRuleInner>> listFirewallRulesSinglePageAsync(String resourceGroupName,
        ...
        context = this.client.mergeContext(context);
        return service
            .listFirewallRules(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
                resourceGroupName, mongoClusterName, accept, context)
            .map(res -> new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(),
                res.getValue().value(), res.getValue().nextLink(), null));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<FirewallRuleInner> listFirewallRulesAsync(String resourceGroupName, String mongoClusterName) {
        return new PagedFlux<>(() -> listFirewallRulesSinglePageAsync(resourceGroupName, mongoClusterName),
    ...
    private PagedFlux<FirewallRuleInner> listFirewallRulesAsync(String resourceGroupName, String mongoClusterName,
        Context context) {
        return new PagedFlux<>(() -> listFirewallRulesSinglePageAsync(resourceGroupName, mongoClusterName, context),
    ...
    private Mono<PagedResponse<FirewallRuleInner>> listFirewallRulesNextSinglePageAsync(String nextLink,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.listFirewallRulesNext(nextLink, this.client.getEndpoint(), accept, context)
            .map(res -> new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(),
                res.getValue().value(), res.getValue().nextLink(), null));
    }
}
