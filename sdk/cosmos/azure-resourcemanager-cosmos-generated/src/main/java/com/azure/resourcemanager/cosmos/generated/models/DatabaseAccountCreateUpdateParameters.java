...
public final class DatabaseAccountCreateUpdateParameters extends ArmResourceProperties {
    ...
    /**
     * Set the keysMetadata property: This property is ignored during the update/create operation, as the metadata is
     * read-only. The object represents the metadata for the Account Keys of the Cosmos DB account.
     *
     * @param keysMetadata the keysMetadata value to set.
     * @return the DatabaseAccountCreateUpdateParameters object itself.
     */
    public DatabaseAccountCreateUpdateParameters withKeysMetadata(DatabaseAccountKeysMetadata keysMetadata) {
        if (this.innerProperties() == null) {
            this.innerProperties = new DatabaseAccountCreateUpdateProperties();
        }
        this.innerProperties().withKeysMetadata(keysMetadata);
        return this;
    }
