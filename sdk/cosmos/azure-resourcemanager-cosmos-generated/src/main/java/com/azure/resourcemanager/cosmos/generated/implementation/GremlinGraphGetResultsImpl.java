...
public final class GremlinGraphGetResultsImpl
    ...
    public GremlinGraphGetResultsImpl withExistingGremlinDatabase(String resourceGroupName, String accountName,
        String databaseName) {
    ...
    public GremlinGraphGetResults create() {
        this.innerObject
            = serviceManager.serviceClient().getGremlinResources().createUpdateGremlinGraph(resourceGroupName,
                accountName, databaseName, graphName, createCreateUpdateGremlinGraphParameters, Context.NONE);
        return this;
    }

    public GremlinGraphGetResults create(Context context) {
        this.innerObject = serviceManager.serviceClient().getGremlinResources().createUpdateGremlinGraph(
            resourceGroupName, accountName, databaseName, graphName, createCreateUpdateGremlinGraphParameters, context);
        return this;
    }
    ...
    public GremlinGraphGetResults apply() {
        this.innerObject
            = serviceManager.serviceClient().getGremlinResources().createUpdateGremlinGraph(resourceGroupName,
                accountName, databaseName, graphName, updateCreateUpdateGremlinGraphParameters, Context.NONE);
        return this;
    }

    public GremlinGraphGetResults apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getGremlinResources().createUpdateGremlinGraph(
            resourceGroupName, accountName, databaseName, graphName, updateCreateUpdateGremlinGraphParameters, context);
        return this;
    }

    GremlinGraphGetResultsImpl(GremlinGraphGetResultsInner innerObject,
        ...
        this.databaseName = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "gremlinDatabases");
        this.graphName = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "graphs");
    }

    public GremlinGraphGetResults refresh() {
        this.innerObject = serviceManager.serviceClient().getGremlinResources()
    ...
    public GremlinGraphGetResults refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getGremlinResources()
            .getGremlinGraphWithResponse(resourceGroupName, accountName, databaseName, graphName, context).getValue();
        return this;
    }

    public BackupInformation retrieveContinuousBackupInformation(ContinuousBackupRestoreLocation location) {
        return serviceManager.gremlinResources().retrieveContinuousBackupInformation(resourceGroupName, accountName,
            databaseName, graphName, location);
    }

    public BackupInformation retrieveContinuousBackupInformation(ContinuousBackupRestoreLocation location,
        Context context) {
        return serviceManager.gremlinResources().retrieveContinuousBackupInformation(resourceGroupName, accountName,
            databaseName, graphName, location, context);
    }
