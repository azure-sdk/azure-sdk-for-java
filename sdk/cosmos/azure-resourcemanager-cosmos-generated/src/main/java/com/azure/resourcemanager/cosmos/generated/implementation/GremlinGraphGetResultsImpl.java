...
public final class GremlinGraphGetResultsImpl
    ...
    public GremlinGraphGetResults create() {
        this.innerObject = serviceManager.serviceClient()
            .getGremlinResources()
            .createUpdateGremlinGraph(resourceGroupName, accountName, databaseName, graphName,
                createCreateUpdateGremlinGraphParameters, Context.NONE);
        return this;
    }
    ...
    public GremlinGraphGetResults create(Context context) {
        this.innerObject = serviceManager.serviceClient()
            .getGremlinResources()
            .createUpdateGremlinGraph(resourceGroupName, accountName, databaseName, graphName,
                createCreateUpdateGremlinGraphParameters, context);
        return this;
    }
    ...
    public GremlinGraphGetResults apply() {
        this.innerObject = serviceManager.serviceClient()
            .getGremlinResources()
            .createUpdateGremlinGraph(resourceGroupName, accountName, databaseName, graphName,
                updateCreateUpdateGremlinGraphParameters, Context.NONE);
        return this;
    }
    ...
    public GremlinGraphGetResults apply(Context context) {
        this.innerObject = serviceManager.serviceClient()
            .getGremlinResources()
            .createUpdateGremlinGraph(resourceGroupName, accountName, databaseName, graphName,
                updateCreateUpdateGremlinGraphParameters, context);
        return this;
    }
    ...
    public BackupInformation retrieveContinuousBackupInformation(ContinuousBackupRestoreLocation location) {
        return serviceManager.gremlinResources()
