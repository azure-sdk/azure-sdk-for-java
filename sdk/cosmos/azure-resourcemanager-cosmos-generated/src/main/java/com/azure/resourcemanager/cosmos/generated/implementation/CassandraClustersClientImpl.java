...
public final class CassandraClustersClientImpl implements CassandraClustersClient {
    ...
    public interface CassandraClustersService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<CassandraClusterRestoreResultInner>> getRestore(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("clusterName") String clusterName,
            @PathParam("backupId") String backupId, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<CassandraClusterRestoreResultInner>> getRestoreWithResponseAsync(String resourceGroupName,
        String clusterName, String backupId) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<CassandraClusterRestoreResultInner> getRestoreAsync(String resourceGroupName, String clusterName,
        String backupId) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<CassandraClusterRestoreResultInner> getRestoreWithResponse(String resourceGroupName,
        String clusterName, String backupId, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public CassandraClusterRestoreResultInner getRestore(String resourceGroupName, String clusterName,
        String backupId) {
