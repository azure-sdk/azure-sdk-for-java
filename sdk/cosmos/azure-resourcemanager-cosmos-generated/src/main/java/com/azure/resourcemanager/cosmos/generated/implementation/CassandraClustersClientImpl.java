...
public final class CassandraClustersClientImpl implements CassandraClustersClient {
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the status of all nodes in the cluster (as returned by 'nodetool status') along with {@link Response} on
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the {@link PollerFlux} for polling of the status of all nodes in the cluster (as returned by 'nodetool
     *     status').
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the {@link SyncPoller} for polling of the status of all nodes in the cluster (as returned by 'nodetool
     *     status').
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the status of all nodes in the cluster (as returned by 'nodetool status') on successful completion of
     *     {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
