...
public final class CassandraClustersClientImpl implements CassandraClustersClient {
    ...
    public interface CassandraClustersService {
        ...
        @ExpectedResponses({202})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Flux<ByteBuffer>>> invokeCommandAsync(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("clusterName") String clusterName,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Flux<ByteBuffer>>> listCommand(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("clusterName") String clusterName,
        ...
        @ExpectedResponses({202})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Flux<ByteBuffer>>> getCommandAsync(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("clusterName") String clusterName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> invokeCommandAsyncWithResponseAsync(
        String resourceGroupName, String clusterName, CommandPostBody body) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<CommandPublicResourceInner>, CommandPublicResourceInner> beginInvokeCommandAsyncAsync(
        String resourceGroupName, String clusterName, CommandPostBody body) {
        Mono<Response<Flux<ByteBuffer>>> mono =
            invokeCommandAsyncWithResponseAsync(resourceGroupName, clusterName, body);
        return this
            .client
            .<CommandPublicResourceInner, CommandPublicResourceInner>getLroResult(
                mono,
                this.client.getHttpPipeline(),
                CommandPublicResourceInner.class,
                CommandPublicResourceInner.class,
                this.client.getContext());
    }
    ...
    private PollerFlux<PollResult<CommandPublicResourceInner>, CommandPublicResourceInner> beginInvokeCommandAsyncAsync(
        ...
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono =
            invokeCommandAsyncWithResponseAsync(resourceGroupName, clusterName, body, context);
        return this
            .client
            .<CommandPublicResourceInner, CommandPublicResourceInner>getLroResult(
                mono,
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<CommandPublicResourceInner>, CommandPublicResourceInner> beginInvokeCommandAsync(
        String resourceGroupName, String clusterName, CommandPostBody body) {
        return this.beginInvokeCommandAsyncAsync(resourceGroupName, clusterName, body).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<CommandPublicResourceInner>, CommandPublicResourceInner> beginInvokeCommandAsync(
        String resourceGroupName, String clusterName, CommandPostBody body, Context context) {
        return this.beginInvokeCommandAsyncAsync(resourceGroupName, clusterName, body, context).getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<CommandPublicResourceInner> invokeCommandAsyncAsync(
        String resourceGroupName, String clusterName, CommandPostBody body) {
        return beginInvokeCommandAsyncAsync(resourceGroupName, clusterName, body)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<CommandPublicResourceInner> invokeCommandAsyncAsync(
        String resourceGroupName, String clusterName, CommandPostBody body, Context context) {
        return beginInvokeCommandAsyncAsync(resourceGroupName, clusterName, body, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public CommandPublicResourceInner invokeCommandAsync(
        String resourceGroupName, String clusterName, CommandPostBody body) {
        return invokeCommandAsyncAsync(resourceGroupName, clusterName, body).block();
    }
    ...
    public CommandPublicResourceInner invokeCommandAsync(
        String resourceGroupName, String clusterName, CommandPostBody body, Context context) {
        return invokeCommandAsyncAsync(resourceGroupName, clusterName, body, context).block();
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return list of commands for cluster along with {@link Response} on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> listCommandWithResponseAsync(
        String resourceGroupName, String clusterName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the {@link PollerFlux} for polling of list of commands for cluster.
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<ListCommandsInner>, ListCommandsInner> beginListCommandAsync(
        String resourceGroupName, String clusterName) {
        Mono<Response<Flux<ByteBuffer>>> mono = listCommandWithResponseAsync(resourceGroupName, clusterName);
        return this
            .client
            .<ListCommandsInner, ListCommandsInner>getLroResult(
                mono,
                this.client.getHttpPipeline(),
                ListCommandsInner.class,
                ListCommandsInner.class,
                this.client.getContext());
    }
    ...
    private PollerFlux<PollResult<ListCommandsInner>, ListCommandsInner> beginListCommandAsync(
        String resourceGroupName, String clusterName, Context context) {
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono = listCommandWithResponseAsync(resourceGroupName, clusterName, context);
        return this
            .client
            .<ListCommandsInner, ListCommandsInner>getLroResult(
                mono, this.client.getHttpPipeline(), ListCommandsInner.class, ListCommandsInner.class, context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the {@link SyncPoller} for polling of list of commands for cluster.
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<ListCommandsInner>, ListCommandsInner> beginListCommand(
        String resourceGroupName, String clusterName) {
        return this.beginListCommandAsync(resourceGroupName, clusterName).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<ListCommandsInner>, ListCommandsInner> beginListCommand(
        String resourceGroupName, String clusterName, Context context) {
        return this.beginListCommandAsync(resourceGroupName, clusterName, context).getSyncPoller();
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return list of commands for cluster on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ListCommandsInner> listCommandAsync(String resourceGroupName, String clusterName) {
        return beginListCommandAsync(resourceGroupName, clusterName)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ListCommandsInner> listCommandAsync(String resourceGroupName, String clusterName, Context context) {
        return beginListCommandAsync(resourceGroupName, clusterName, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return list of commands for cluster.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ListCommandsInner listCommand(String resourceGroupName, String clusterName) {
        return listCommandAsync(resourceGroupName, clusterName).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ListCommandsInner listCommand(String resourceGroupName, String clusterName, Context context) {
        return listCommandAsync(resourceGroupName, clusterName, context).block();
    }

    /**
     * Get list of details about commands that were run asynchronously. Use "all" as commandId to list all commands in
     * three days associated with the cluster.
     *
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
     * @param clusterName Managed Cassandra cluster name.
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return list of details about commands that were run asynchronously along with {@link Response} on successful
     *     completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> getCommandAsyncWithResponseAsync(
        String resourceGroupName, String clusterName, String commandId) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> getCommandAsyncWithResponseAsync(
        String resourceGroupName, String clusterName, String commandId, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the {@link PollerFlux} for polling of list of details about commands that were run asynchronously.
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<ListCommandsInner>, ListCommandsInner> beginGetCommandAsyncAsync(
        String resourceGroupName, String clusterName, String commandId) {
        Mono<Response<Flux<ByteBuffer>>> mono =
            getCommandAsyncWithResponseAsync(resourceGroupName, clusterName, commandId);
        return this
            .client
            .<ListCommandsInner, ListCommandsInner>getLroResult(
                mono,
    ...
    private PollerFlux<PollResult<ListCommandsInner>, ListCommandsInner> beginGetCommandAsyncAsync(
        ...
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono =
            getCommandAsyncWithResponseAsync(resourceGroupName, clusterName, commandId, context);
        return this
            .client
            .<ListCommandsInner, ListCommandsInner>getLroResult(
                mono, this.client.getHttpPipeline(), ListCommandsInner.class, ListCommandsInner.class, context);
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the {@link SyncPoller} for polling of list of details about commands that were run asynchronously.
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<ListCommandsInner>, ListCommandsInner> beginGetCommandAsync(
        String resourceGroupName, String clusterName, String commandId) {
        return this.beginGetCommandAsyncAsync(resourceGroupName, clusterName, commandId).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<ListCommandsInner>, ListCommandsInner> beginGetCommandAsync(
        String resourceGroupName, String clusterName, String commandId, Context context) {
        return this.beginGetCommandAsyncAsync(resourceGroupName, clusterName, commandId, context).getSyncPoller();
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return list of details about commands that were run asynchronously on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ListCommandsInner> getCommandAsyncAsync(
        String resourceGroupName, String clusterName, String commandId) {
        return beginGetCommandAsyncAsync(resourceGroupName, clusterName, commandId)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<ListCommandsInner> getCommandAsyncAsync(
        String resourceGroupName, String clusterName, String commandId, Context context) {
        return beginGetCommandAsyncAsync(resourceGroupName, clusterName, commandId, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return list of details about commands that were run asynchronously.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ListCommandsInner getCommandAsync(String resourceGroupName, String clusterName, String commandId) {
        return getCommandAsyncAsync(resourceGroupName, clusterName, commandId).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ListCommandsInner getCommandAsync(
        String resourceGroupName, String clusterName, String commandId, Context context) {
        return getCommandAsyncAsync(resourceGroupName, clusterName, commandId, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> deallocateAsync(String resourceGroupName, String clusterName, Boolean xMsForceDeallocate) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> deallocateAsync(String resourceGroupName, String clusterName) {
        final Boolean xMsForceDeallocate = null;
        return beginDeallocateAsync(resourceGroupName, clusterName, xMsForceDeallocate)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<CassandraClusterPublicStatusInner> statusAsync(String resourceGroupName, String clusterName) {
