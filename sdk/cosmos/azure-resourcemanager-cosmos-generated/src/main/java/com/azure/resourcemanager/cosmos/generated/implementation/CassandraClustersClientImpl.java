...
public final class CassandraClustersClientImpl implements CassandraClustersClient {
    ...
    public interface CassandraClustersService {
        ...
        @ExpectedResponses({ 200, 202 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Flux<ByteBuffer>>> invokeCommandAsync(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("clusterName") String clusterName,
            @QueryParam("api-version") String apiVersion, @BodyParam("application/json") CommandPostBody body,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ListCommandsInner>> getCommandAsync(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("clusterName") String clusterName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> invokeCommandAsyncWithResponseAsync(String resourceGroupName,
        String clusterName, CommandPostBody body) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        return FluxUtil
            .withContext(
                context -> service.invokeCommandAsync(this.client.getEndpoint(), this.client.getSubscriptionId(),
                    resourceGroupName, clusterName, this.client.getApiVersion(), body, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> invokeCommandAsyncWithResponseAsync(String resourceGroupName,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.invokeCommandAsync(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            clusterName, this.client.getApiVersion(), body, accept, context);
    }
    ...
    private PollerFlux<PollResult<CommandPublicResourceInner>, CommandPublicResourceInner>
        beginInvokeCommandAsyncAsync(String resourceGroupName, String clusterName, CommandPostBody body) {
        Mono<Response<Flux<ByteBuffer>>> mono
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<CommandPublicResourceInner> invokeCommandAsyncAsync(String resourceGroupName, String clusterName,
        CommandPostBody body) {
        return beginInvokeCommandAsyncAsync(resourceGroupName, clusterName, body).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<CommandPublicResourceInner> invokeCommandAsyncAsync(String resourceGroupName, String clusterName,
        CommandPostBody body, Context context) {
        return beginInvokeCommandAsyncAsync(resourceGroupName, clusterName, body, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public CommandPublicResourceInner invokeCommandAsync(String resourceGroupName, String clusterName,
        CommandPostBody body) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ListCommandsInner>> getCommandAsyncWithResponseAsync(String resourceGroupName,
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.getCommandAsync(this.client.getEndpoint(), this.client.getSubscriptionId(),
    ...
    private Mono<Response<ListCommandsInner>> getCommandAsyncWithResponseAsync(String resourceGroupName,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.getCommandAsync(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            clusterName, commandId, this.client.getApiVersion(), accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ListCommandsInner> getCommandAsyncAsync(String resourceGroupName, String clusterName,
        String commandId) {
        return getCommandAsyncWithResponseAsync(resourceGroupName, clusterName, commandId)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ListCommandsInner> getCommandAsyncWithResponse(String resourceGroupName, String clusterName,
        String commandId, Context context) {
        return getCommandAsyncWithResponseAsync(resourceGroupName, clusterName, commandId, context).block();
    }
    ...
    public ListCommandsInner getCommandAsync(String resourceGroupName, String clusterName, String commandId) {
        return getCommandAsyncWithResponse(resourceGroupName, clusterName, commandId, Context.NONE).getValue();
    }
