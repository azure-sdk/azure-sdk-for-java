...
public final class CassandraClustersClientImpl implements CassandraClustersClient {
    ...
    public interface CassandraClustersService {
        ...
        @Headers({ "Content-Type: application/json" })
        @Post("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DocumentDB/cassandraClusters/{clusterName}/invokeAsyncCommand")
        @ExpectedResponses({ 200, 202 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Flux<ByteBuffer>>> invokeAsyncCommand(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("clusterName") String clusterName,
            @QueryParam("api-version") String apiVersion, @BodyParam("application/json") CommandPostBody body,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @Headers({ "Content-Type: application/json" })
        @Post("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DocumentDB/cassandraClusters/{clusterName}/backupRestores/{backupId}")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<CassandraClusterRestoreResultInner>> restoreBackup(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("clusterName") String clusterName,
            @PathParam("backupId") String backupId, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @Headers({ "Content-Type: application/json" })
        @Get("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DocumentDB/cassandraClusters/{clusterName}/backupRestores/{backupId}")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<CassandraClusterRestoreInfoInner>> getRestore(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("clusterName") String clusterName,
            @PathParam("backupId") String backupId, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, Context context);
    ...
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<ClusterResourceInner>, ClusterResourceInner>
        beginUpdateAsync(String resourceGroupName, String clusterName, ClusterResourceInner body) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> invokeAsyncCommandWithResponseAsync(String resourceGroupName,
        String clusterName, CommandPostBody body) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        return FluxUtil
            .withContext(
                context -> service.invokeAsyncCommand(this.client.getEndpoint(), this.client.getSubscriptionId(),
                    resourceGroupName, clusterName, this.client.getApiVersion(), body, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> invokeAsyncCommandWithResponseAsync(String resourceGroupName,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.invokeAsyncCommand(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            clusterName, this.client.getApiVersion(), body, accept, context);
    }
    ...
    private PollerFlux<PollResult<CommandPublicResourceInner>, CommandPublicResourceInner>
        beginInvokeAsyncCommandAsync(String resourceGroupName, String clusterName, CommandPostBody body) {
        Mono<Response<Flux<ByteBuffer>>> mono
            = invokeAsyncCommandWithResponseAsync(resourceGroupName, clusterName, body);
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<CommandPublicResourceInner>, CommandPublicResourceInner> beginInvokeAsyncCommandAsync(
        String resourceGroupName, String clusterName, CommandPostBody body, Context context) {
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono
            = invokeAsyncCommandWithResponseAsync(resourceGroupName, clusterName, body, context);
        return this.client.<CommandPublicResourceInner, CommandPublicResourceInner>getLroResult(mono,
    ...
    public SyncPoller<PollResult<CommandPublicResourceInner>, CommandPublicResourceInner>
        beginInvokeAsyncCommand(String resourceGroupName, String clusterName, CommandPostBody body) {
        return this.beginInvokeAsyncCommandAsync(resourceGroupName, clusterName, body).getSyncPoller();
    }
    ...
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<CommandPublicResourceInner>, CommandPublicResourceInner>
        beginInvokeAsyncCommand(String resourceGroupName, String clusterName, CommandPostBody body, Context context) {
        return this.beginInvokeAsyncCommandAsync(resourceGroupName, clusterName, body, context).getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<CommandPublicResourceInner> invokeAsyncCommandAsync(String resourceGroupName, String clusterName,
        CommandPostBody body) {
        return beginInvokeAsyncCommandAsync(resourceGroupName, clusterName, body).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<CommandPublicResourceInner> invokeAsyncCommandAsync(String resourceGroupName, String clusterName,
        CommandPostBody body, Context context) {
        return beginInvokeAsyncCommandAsync(resourceGroupName, clusterName, body, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public CommandPublicResourceInner invokeAsyncCommand(String resourceGroupName, String clusterName,
        CommandPostBody body) {
        return invokeAsyncCommandAsync(resourceGroupName, clusterName, body).block();
    }
    ...
    public CommandPublicResourceInner invokeAsyncCommand(String resourceGroupName, String clusterName,
        CommandPostBody body, Context context) {
        return invokeAsyncCommandAsync(resourceGroupName, clusterName, body, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ListCommandsInner> getCommandAsyncResourceAsync(String resourceGroupName, String clusterName,
        String commandId) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<CassandraClusterRestoreResultInner>> restoreBackupWithResponseAsync(String resourceGroupName,
        String clusterName, String backupId) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.restoreBackup(this.client.getEndpoint(), this.client.getSubscriptionId(),
                resourceGroupName, clusterName, backupId, this.client.getApiVersion(), accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<CassandraClusterRestoreResultInner>> restoreBackupWithResponseAsync(String resourceGroupName,
        String clusterName, String backupId, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.restoreBackup(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            clusterName, backupId, this.client.getApiVersion(), accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<CassandraClusterRestoreResultInner> restoreBackupAsync(String resourceGroupName, String clusterName,
        String backupId) {
        return restoreBackupWithResponseAsync(resourceGroupName, clusterName, backupId)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<CassandraClusterRestoreResultInner> restoreBackupWithResponse(String resourceGroupName,
        String clusterName, String backupId, Context context) {
        return restoreBackupWithResponseAsync(resourceGroupName, clusterName, backupId, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public CassandraClusterRestoreResultInner restoreBackup(String resourceGroupName, String clusterName,
        String backupId) {
        return restoreBackupWithResponse(resourceGroupName, clusterName, backupId, Context.NONE).getValue();
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return information about a restore that has been triggered along with {@link Response} on successful completion
     * of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<CassandraClusterRestoreInfoInner>> getRestoreWithResponseAsync(String resourceGroupName,
        String clusterName, String backupId) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.getRestore(this.client.getEndpoint(), this.client.getSubscriptionId(),
                resourceGroupName, clusterName, backupId, this.client.getApiVersion(), accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<CassandraClusterRestoreInfoInner>> getRestoreWithResponseAsync(String resourceGroupName,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.getRestore(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            clusterName, backupId, this.client.getApiVersion(), accept, context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return information about a restore that has been triggered on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<CassandraClusterRestoreInfoInner> getRestoreAsync(String resourceGroupName, String clusterName,
        String backupId) {
        return getRestoreWithResponseAsync(resourceGroupName, clusterName, backupId)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return information about a restore that has been triggered along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<CassandraClusterRestoreInfoInner> getRestoreWithResponse(String resourceGroupName,
        String clusterName, String backupId, Context context) {
        return getRestoreWithResponseAsync(resourceGroupName, clusterName, backupId, context).block();
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return information about a restore that has been triggered.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public CassandraClusterRestoreInfoInner getRestore(String resourceGroupName, String clusterName, String backupId) {
        return getRestoreWithResponse(resourceGroupName, clusterName, backupId, Context.NONE).getValue();
    }
