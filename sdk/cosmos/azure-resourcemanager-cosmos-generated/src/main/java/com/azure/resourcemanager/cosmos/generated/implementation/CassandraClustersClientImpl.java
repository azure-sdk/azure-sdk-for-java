...
public final class CassandraClustersClientImpl implements CassandraClustersClient {
    ...
    public interface CassandraClustersService {
        ...
        Mono<Response<Flux<ByteBuffer>>> deallocate(@HostParam("$host") String endpoint,
            ...
            @HeaderParam("x-ms-force-deallocate") Boolean xMsForceDeallocate, @HeaderParam("Accept") String accept,
            Context context);
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> deallocateWithResponseAsync(String resourceGroupName, String clusterName,
        Boolean xMsForceDeallocate, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
