...
public final class SqlStoredProcedureGetResultsImpl implements SqlStoredProcedureGetResults,
    SqlStoredProcedureGetResults.Definition, SqlStoredProcedureGetResults.Update {
    ...
    public SqlStoredProcedureGetResultsImpl withExistingContainer(String resourceGroupName, String accountName,
    ...
    public SqlStoredProcedureGetResults create() {
        this.innerObject = serviceManager.serviceClient().getSqlResources().createUpdateSqlStoredProcedure(
            resourceGroupName, accountName, databaseName, containerName, storedProcedureName,
            createCreateUpdateSqlStoredProcedureParameters, Context.NONE);
        return this;
    }
    ...
    public SqlStoredProcedureGetResults create(Context context) {
        this.innerObject = serviceManager.serviceClient().getSqlResources().createUpdateSqlStoredProcedure(
            resourceGroupName, accountName, databaseName, containerName, storedProcedureName,
            createCreateUpdateSqlStoredProcedureParameters, context);
        return this;
    }

    SqlStoredProcedureGetResultsImpl(String name,
    ...
    public SqlStoredProcedureGetResults apply() {
        this.innerObject = serviceManager.serviceClient().getSqlResources().createUpdateSqlStoredProcedure(
            resourceGroupName, accountName, databaseName, containerName, storedProcedureName,
            updateCreateUpdateSqlStoredProcedureParameters, Context.NONE);
        return this;
    }
    ...
    public SqlStoredProcedureGetResults apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getSqlResources().createUpdateSqlStoredProcedure(
            resourceGroupName, accountName, databaseName, containerName, storedProcedureName,
            updateCreateUpdateSqlStoredProcedureParameters, context);
        return this;
    }

    SqlStoredProcedureGetResultsImpl(SqlStoredProcedureGetResultsInner innerObject,
        com.azure.resourcemanager.cosmos.generated.CosmosDBManager serviceManager) {
    ...
    public SqlStoredProcedureGetResults refresh() {
        this.innerObject
            = serviceManager.serviceClient().getSqlResources().getSqlStoredProcedureWithResponse(resourceGroupName,
                accountName, databaseName, containerName, storedProcedureName, Context.NONE).getValue();
        return this;
    }
    ...
    public SqlStoredProcedureGetResults refresh(Context context) {
        this.innerObject
            = serviceManager.serviceClient().getSqlResources().getSqlStoredProcedureWithResponse(resourceGroupName,
                accountName, databaseName, containerName, storedProcedureName, context).getValue();
        return this;
    }
