...
public final class SqlStoredProcedureGetResultsImpl implements SqlStoredProcedureGetResults,
    ...
    public SqlStoredProcedureGetResults create() {
        this.innerObject = serviceManager.serviceClient()
            .getSqlResources()
            .createUpdateSqlStoredProcedure(resourceGroupName, accountName, databaseName, containerName,
                storedProcedureName, createCreateUpdateSqlStoredProcedureParameters, Context.NONE);
        return this;
    }
    ...
    public SqlStoredProcedureGetResults create(Context context) {
        this.innerObject = serviceManager.serviceClient()
            .getSqlResources()
            .createUpdateSqlStoredProcedure(resourceGroupName, accountName, databaseName, containerName,
                storedProcedureName, createCreateUpdateSqlStoredProcedureParameters, context);
        return this;
    }
    ...
    public SqlStoredProcedureGetResults apply() {
        this.innerObject = serviceManager.serviceClient()
            .getSqlResources()
            .createUpdateSqlStoredProcedure(resourceGroupName, accountName, databaseName, containerName,
                storedProcedureName, updateCreateUpdateSqlStoredProcedureParameters, Context.NONE);
        return this;
    }
    ...
    public SqlStoredProcedureGetResults apply(Context context) {
        this.innerObject = serviceManager.serviceClient()
            .getSqlResources()
            .createUpdateSqlStoredProcedure(resourceGroupName, accountName, databaseName, containerName,
                storedProcedureName, updateCreateUpdateSqlStoredProcedureParameters, context);
        return this;
    }
