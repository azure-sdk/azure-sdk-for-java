...
public final class MongoUserDefinitionGetResultsImpl implements MongoUserDefinitionGetResults,
    MongoUserDefinitionGetResults.Definition, MongoUserDefinitionGetResults.Update {
    ...
    public MongoUserDefinitionGetResults create() {
        this.innerObject = serviceManager.serviceClient().getMongoDBResources().createUpdateMongoUserDefinition(
    ...
    MongoUserDefinitionGetResultsImpl(String name,
    ...
    public MongoUserDefinitionGetResults apply() {
        this.innerObject = serviceManager.serviceClient().getMongoDBResources().createUpdateMongoUserDefinition(
            mongoUserDefinitionId, resourceGroupName, accountName, updateCreateUpdateMongoUserDefinitionParameters,
            Context.NONE);
        return this;
    }
    ...
    MongoUserDefinitionGetResultsImpl(MongoUserDefinitionGetResultsInner innerObject,
        com.azure.resourcemanager.cosmos.generated.CosmosDBManager serviceManager) {
