...
public final class CassandraClustersImpl implements CassandraClusters {
    ...
    public CommandOutput listCommand(String resourceGroupName, String clusterName) {
        CommandOutputInner inner = this.serviceClient().listCommand(resourceGroupName, clusterName);
        if (inner != null) {
            return new CommandOutputImpl(inner, this.manager());
        } else {
            return null;
    ...
    public CommandOutput listCommand(String resourceGroupName, String clusterName, Context context) {
        CommandOutputInner inner = this.serviceClient().listCommand(resourceGroupName, clusterName, context);
        if (inner != null) {
            return new CommandOutputImpl(inner, this.manager());
        } else {
            return null;
