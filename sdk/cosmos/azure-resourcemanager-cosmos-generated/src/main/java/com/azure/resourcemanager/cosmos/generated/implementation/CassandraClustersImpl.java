...
public final class CassandraClustersImpl implements CassandraClusters {
    ...
    public CommandPublicResource invokeCommandAsync(
    ...
    public ListCommands listCommand(String resourceGroupName, String clusterName) {
        ListCommandsInner inner = this.serviceClient().listCommand(resourceGroupName, clusterName);
        if (inner != null) {
    ...
    public ListCommands listCommand(String resourceGroupName, String clusterName, Context context) {
        ListCommandsInner inner = this.serviceClient().listCommand(resourceGroupName, clusterName, context);
        if (inner != null) {
            return new ListCommandsImpl(inner, this.manager());
        } else {
            return null;
    ...
    public ListCommands getCommandAsync(
        String resourceGroupName, String clusterName, String commandId, Context context) {
        ListCommandsInner inner =
            this.serviceClient().getCommandAsync(resourceGroupName, clusterName, commandId, context);
        if (inner != null) {
            return new ListCommandsImpl(inner, this.manager());
        } else {
            return null;
