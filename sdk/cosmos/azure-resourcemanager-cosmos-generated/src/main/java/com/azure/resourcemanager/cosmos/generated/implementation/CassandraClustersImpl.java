...
public final class CassandraClustersImpl implements CassandraClusters {
    ...
    public PagedIterable<ClusterResource> listBySubscription() {
        PagedIterable<ClusterResourceInner> inner = this.serviceClient().listBySubscription();
        return Utils.mapPage(inner, inner1 -> new ClusterResourceImpl(inner1, this.manager()));
    }

    public PagedIterable<ClusterResource> listBySubscription(Context context) {
        PagedIterable<ClusterResourceInner> inner = this.serviceClient().listBySubscription(context);
        return Utils.mapPage(inner, inner1 -> new ClusterResourceImpl(inner1, this.manager()));
    }
    ...
    public Response<ClusterResource> getWithResponse(String resourceGroupName, String clusterName, Context context) {
    ...
    public ClusterResource get(String resourceGroupName, String clusterName) {
        ClusterResourceInner inner = this.serviceClient().get(resourceGroupName, clusterName);
        if (inner != null) {
    ...
    public PagedIterable<ClusterResourceAutoGenerated> listBySubscription() {
        PagedIterable<ClusterResourceAutoGeneratedInner> inner = this.serviceClient().listBySubscription();
        return Utils.mapPage(inner, inner1 -> new ClusterResourceAutoGeneratedImpl(inner1, this.manager()));
    }

    public PagedIterable<ClusterResourceAutoGenerated> listBySubscription(Context context) {
        PagedIterable<ClusterResourceAutoGeneratedInner> inner = this.serviceClient().listBySubscription(context);
        return Utils.mapPage(inner, inner1 -> new ClusterResourceAutoGeneratedImpl(inner1, this.manager()));
    }

    public PagedIterable<ClusterResourceAutoGenerated> listByResourceGroup(String resourceGroupName) {
        PagedIterable<ClusterResourceAutoGeneratedInner> inner =
            this.serviceClient().listByResourceGroup(resourceGroupName);
        return Utils.mapPage(inner, inner1 -> new ClusterResourceAutoGeneratedImpl(inner1, this.manager()));
    }

    public PagedIterable<ClusterResourceAutoGenerated> listByResourceGroup(String resourceGroupName, Context context) {
        PagedIterable<ClusterResourceAutoGeneratedInner> inner =
            this.serviceClient().listByResourceGroup(resourceGroupName, context);
        return Utils.mapPage(inner, inner1 -> new ClusterResourceAutoGeneratedImpl(inner1, this.manager()));
    }

    public Response<ClusterResourceAutoGenerated> getWithResponse(
        String resourceGroupName, String clusterName, Context context) {
        Response<ClusterResourceAutoGeneratedInner> inner =
            this.serviceClient().getWithResponse(resourceGroupName, clusterName, context);
        if (inner != null) {
            return new SimpleResponse<>(
                inner.getRequest(),
                inner.getStatusCode(),
                inner.getHeaders(),
                new ClusterResourceAutoGeneratedImpl(inner.getValue(), this.manager()));
        } else {
            return null;
        }
    }

    public ClusterResourceAutoGenerated get(String resourceGroupName, String clusterName) {
        ClusterResourceAutoGeneratedInner inner = this.serviceClient().get(resourceGroupName, clusterName);
        if (inner != null) {
            return new ClusterResourceAutoGeneratedImpl(inner, this.manager());
        } else {
            return null;
        }
    }
    ...
    public Response<CassandraClusterPublicStatusAutoGenerated> statusWithResponse(
        String resourceGroupName, String clusterName, Context context) {
        Response<CassandraClusterPublicStatusAutoGeneratedInner> inner =
            this.serviceClient().statusWithResponse(resourceGroupName, clusterName, context);
        if (inner != null) {
            return new SimpleResponse<>(
                inner.getRequest(),
                inner.getStatusCode(),
                inner.getHeaders(),
                new CassandraClusterPublicStatusAutoGeneratedImpl(inner.getValue(), this.manager()));
        } else {
            return null;
        }
    }

    public CassandraClusterPublicStatusAutoGenerated status(String resourceGroupName, String clusterName) {
        CassandraClusterPublicStatusAutoGeneratedInner inner =
            this.serviceClient().status(resourceGroupName, clusterName);
        if (inner != null) {
            return new CassandraClusterPublicStatusAutoGeneratedImpl(inner, this.manager());
        } else {
            return null;
        }
    }
    ...
    public ClusterResource getById(String id) {
        ...
        return this.getWithResponse(resourceGroupName, clusterName, Context.NONE).getValue();
    }
    ...
    public Response<ClusterResource> getByIdWithResponse(String id, Context context) {
        ...
        return this.getWithResponse(resourceGroupName, clusterName, context);
    }
    ...
    public ClusterResourceImpl defineUpdate(String name) {
        return new ClusterResourceImpl(name, this.manager());
    }

    public ClusterResourceAutoGeneratedImpl defineUpdate(String name) {
        return new ClusterResourceAutoGeneratedImpl(name, this.manager());
    }
}
