...
public final class CassandraClustersImpl implements CassandraClusters {
    ...
    public CassandraClustersImpl(CassandraClustersClient innerClient,
    ...
    public PagedIterable<ClusterResource> list() {
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new ClusterResourceImpl(inner1, this.manager()));
    }
    ...
    public Response<ClusterResource> getByResourceGroupWithResponse(String resourceGroupName, String clusterName,
        Context context) {
    ...
    public CommandPublicResource invokeAsyncCommand(String resourceGroupName, String clusterName,
        CommandPostBody body) {
        CommandPublicResourceInner inner
            = this.serviceClient().invokeAsyncCommand(resourceGroupName, clusterName, body);
        if (inner != null) {
            return new CommandPublicResourceImpl(inner, this.manager());
        } else {
            return null;
        }
    }

    public CommandPublicResource invokeAsyncCommand(String resourceGroupName, String clusterName, CommandPostBody body,
        Context context) {
        CommandPublicResourceInner inner
            = this.serviceClient().invokeAsyncCommand(resourceGroupName, clusterName, body, context);
        if (inner != null) {
            return new CommandPublicResourceImpl(inner, this.manager());
        } else {
            return null;
    ...
    public PagedIterable<CommandPublicResource> listCommand(String resourceGroupName, String clusterName) {
        PagedIterable<CommandPublicResourceInner> inner
            = this.serviceClient().listCommand(resourceGroupName, clusterName);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new CommandPublicResourceImpl(inner1, this.manager()));
    }

    public PagedIterable<CommandPublicResource> listCommand(String resourceGroupName, String clusterName,
        Context context) {
        PagedIterable<CommandPublicResourceInner> inner
            = this.serviceClient().listCommand(resourceGroupName, clusterName, context);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new CommandPublicResourceImpl(inner1, this.manager()));
    }

    public Response<ListCommands> getCommandAsyncResourceWithResponse(String resourceGroupName, String clusterName,
        String commandId, Context context) {
        Response<ListCommandsInner> inner = this.serviceClient()
            .getCommandAsyncResourceWithResponse(resourceGroupName, clusterName, commandId, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
                new ListCommandsImpl(inner.getValue(), this.manager()));
        } else {
            return null;
        }
    }

    public ListCommands getCommandAsyncResource(String resourceGroupName, String clusterName, String commandId) {
        ListCommandsInner inner
            = this.serviceClient().getCommandAsyncResource(resourceGroupName, clusterName, commandId);
        if (inner != null) {
            return new ListCommandsImpl(inner, this.manager());
        } else {
            return null;
        }
    }
    ...
    public PagedIterable<BackupResource> listBackups(String resourceGroupName, String clusterName) {
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new BackupResourceImpl(inner1, this.manager()));
    }
    ...
    public Response<BackupResource> getBackupWithResponse(String resourceGroupName, String clusterName, String backupId,
        Context context) {
    ...
    public Response<CassandraClusterRestoreResult> restoreBackupWithResponse(String resourceGroupName,
        String clusterName, String backupId, Context context) {
        Response<CassandraClusterRestoreResultInner> inner
            = this.serviceClient().restoreBackupWithResponse(resourceGroupName, clusterName, backupId, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
                new CassandraClusterRestoreResultImpl(inner.getValue(), this.manager()));
        } else {
            return null;
        }
    }

    public CassandraClusterRestoreResult restoreBackup(String resourceGroupName, String clusterName, String backupId) {
        CassandraClusterRestoreResultInner inner
            = this.serviceClient().restoreBackup(resourceGroupName, clusterName, backupId);
        if (inner != null) {
            return new CassandraClusterRestoreResultImpl(inner, this.manager());
        } else {
            return null;
        }
    }

    public Response<CassandraClusterRestoreInfo> getRestoreWithResponse(String resourceGroupName, String clusterName,
        String backupId, Context context) {
        Response<CassandraClusterRestoreInfoInner> inner
            = this.serviceClient().getRestoreWithResponse(resourceGroupName, clusterName, backupId, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
                new CassandraClusterRestoreInfoImpl(inner.getValue(), this.manager()));
        } else {
            return null;
        }
    }

    public CassandraClusterRestoreInfo getRestore(String resourceGroupName, String clusterName, String backupId) {
        CassandraClusterRestoreInfoInner inner
            = this.serviceClient().getRestore(resourceGroupName, clusterName, backupId);
        if (inner != null) {
            return new CassandraClusterRestoreInfoImpl(inner, this.manager());
        } else {
            return null;
        }
    }
    ...
    public void deallocate(String resourceGroupName, String clusterName, String xMsForceDeallocate, Context context) {
        this.serviceClient().deallocate(resourceGroupName, clusterName, xMsForceDeallocate, context);
    }
    ...
    public Response<CassandraClusterPublicStatus> statusWithResponse(String resourceGroupName, String clusterName,
        Context context) {
    ...
    public ClusterResource getById(String id) {
        ...
        String clusterName = ResourceManagerUtils.getValueFromIdByName(id, "cassandraClusters");
        if (clusterName == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
                String.format("The resource ID '%s' is not valid. Missing path segment 'cassandraClusters'.", id)));
        }
