...
public final class CassandraClustersImpl implements CassandraClusters {
    ...
    public CommandPublicResource invokeCommandAsyncResource(String resourceGroupName, String clusterName,
        CommandPostBody body) {
        CommandPublicResourceInner inner
            = this.serviceClient().invokeCommandAsyncResource(resourceGroupName, clusterName, body);
        if (inner != null) {
    ...
    public CommandPublicResource invokeCommandAsyncResource(String resourceGroupName, String clusterName,
        ...
        CommandPublicResourceInner inner
            = this.serviceClient().invokeCommandAsyncResource(resourceGroupName, clusterName, body, context);
        if (inner != null) {
            return new CommandPublicResourceImpl(inner, this.manager());
        } else {
            return null;
    ...
    public Response<ListCommands> getCommandAsyncResourceWithResponse(String resourceGroupName, String clusterName,
        ...
        Response<ListCommandsInner> inner = this.serviceClient().getCommandAsyncResourceWithResponse(resourceGroupName,
            clusterName, commandId, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
