...
public final class CassandraClustersImpl implements CassandraClusters {
    ...
    public CommandPublicResource invokeCommandAsync(String resourceGroupName, String clusterName,
        CommandPostBody body) {
        CommandPublicResourceInner inner
            = this.serviceClient().invokeCommandAsync(resourceGroupName, clusterName, body);
        if (inner != null) {
    ...
    public CommandPublicResource invokeCommandAsync(String resourceGroupName, String clusterName, CommandPostBody body,
        Context context) {
        CommandPublicResourceInner inner
            = this.serviceClient().invokeCommandAsync(resourceGroupName, clusterName, body, context);
        if (inner != null) {
            return new CommandPublicResourceImpl(inner, this.manager());
        } else {
            return null;
    ...
    public Response<ListCommands> getCommandAsyncWithResponse(String resourceGroupName, String clusterName,
        String commandId, Context context) {
        Response<ListCommandsInner> inner
            = this.serviceClient().getCommandAsyncWithResponse(resourceGroupName, clusterName, commandId, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
    ...
    public ListCommands getCommandAsync(String resourceGroupName, String clusterName, String commandId) {
        ListCommandsInner inner = this.serviceClient().getCommandAsync(resourceGroupName, clusterName, commandId);
        if (inner != null) {
