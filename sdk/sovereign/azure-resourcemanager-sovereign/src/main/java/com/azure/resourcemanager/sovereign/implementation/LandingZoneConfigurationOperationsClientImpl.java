...
public final class LandingZoneConfigurationOperationsClientImpl implements LandingZoneConfigurationOperationsClient {
    ...
    public interface LandingZoneConfigurationOperationsService {
        ...
        Mono<Response<LandingZoneConfigurationResourceListResult>> list(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<LandingZoneConfigurationResourceListResult>> listNext(
    ...
    private Mono<PagedResponse<LandingZoneConfigurationResourceInner>> listSinglePageAsync(String resourceGroupName,
    ...
    private PagedFlux<LandingZoneConfigurationResourceInner> listAsync(String resourceGroupName,
        String landingZoneAccountName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<LandingZoneConfigurationResourceInner> list(String resourceGroupName,
        String landingZoneAccountName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<LandingZoneConfigurationResourceInner>> listNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
