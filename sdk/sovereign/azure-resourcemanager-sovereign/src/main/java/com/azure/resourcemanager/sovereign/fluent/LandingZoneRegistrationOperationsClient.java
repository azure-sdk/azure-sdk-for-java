...
public interface LandingZoneRegistrationOperationsClient {
    ...
    PagedIterable<LandingZoneRegistrationResourceInner> listBySubscription(String landingZoneAccountName);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<LandingZoneRegistrationResourceInner> listByResourceGroup(String resourceGroupName,
    ...
    Response<LandingZoneRegistrationResourceInner> getWithResponse(String resourceGroupName,
    ...
    SyncPoller<PollResult<LandingZoneRegistrationResourceInner>, LandingZoneRegistrationResourceInner> beginCreate(
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<LandingZoneRegistrationResourceInner>, LandingZoneRegistrationResourceInner> beginUpdate(
        String resourceGroupName, String landingZoneAccountName, String landingZoneRegistrationName,
