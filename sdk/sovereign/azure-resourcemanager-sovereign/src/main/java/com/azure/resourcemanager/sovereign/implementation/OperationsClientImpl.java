...
import com.azure.resourcemanager.sovereign.models.OperationListResult;
...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    OperationsClientImpl(MicrosoftSovereignImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for MicrosoftSovereignOperations to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "MicrosoftSovereignOp")
