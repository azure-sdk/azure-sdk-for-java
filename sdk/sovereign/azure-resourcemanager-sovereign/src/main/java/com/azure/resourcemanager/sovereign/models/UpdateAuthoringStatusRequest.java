...
/**
 * The request to update authoring status of a configuration.
 */
@Fluent
public final class UpdateAuthoringStatusRequest implements JsonSerializable<UpdateAuthoringStatusRequest> {
    ...
    /**
     * Get the authoringStatus property: The value of the authoring status to be updated.
     * 
    ...
    /**
     * Set the authoringStatus property: The value of the authoring status to be updated.
     * 
