...
public final class PolicyInitiativeAssignmentProperties
    ...
    /**
     * Get the assignmentParameters property: The parameters for the assignment of policy initiatives.
     * 
     * @return the assignmentParameters value.
     */
    public Map<String, Object> assignmentParameters() {
        return this.assignmentParameters;
    }

    /**
     * Set the assignmentParameters property: The parameters for the assignment of policy initiatives.
     * 
     * @param assignmentParameters the assignmentParameters value to set.
     * @return the PolicyInitiativeAssignmentProperties object itself.
     */
    public PolicyInitiativeAssignmentProperties withAssignmentParameters(Map<String, Object> assignmentParameters) {
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("policyInitiativeId".equals(fieldName)) {
                    ...
                    Map<String, Object> assignmentParameters = reader.readMap(reader1 -> reader1.readUntyped());
