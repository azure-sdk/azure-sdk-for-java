...
package com.azure.resourcemanager.sovereign;
...
import com.azure.resourcemanager.sovereign.implementation.LandingZoneAccountOperationsImpl;
import com.azure.resourcemanager.sovereign.implementation.LandingZoneConfigurationOperationsImpl;
import com.azure.resourcemanager.sovereign.implementation.LandingZoneRegistrationOperationsImpl;
import com.azure.resourcemanager.sovereign.implementation.MicrosoftSovereignBuilder;
import com.azure.resourcemanager.sovereign.implementation.OperationsImpl;
...
import com.azure.resourcemanager.sovereign.models.LandingZoneRegistrationOperations;
import com.azure.resourcemanager.sovereign.models.Operations;
...
/**
 * Entry point to SovereignManager.
 */
public final class SovereignManager {
    private Operations operations;

    private LandingZoneAccountOperations landingZoneAccountOperations;

    private LandingZoneConfigurationOperations landingZoneConfigurationOperations;

    private LandingZoneRegistrationOperations landingZoneRegistrationOperations;

    private final MicrosoftSovereign clientObject;

    private SovereignManager(HttpPipeline httpPipeline, AzureProfile profile, Duration defaultPollInterval) {
        Objects.requireNonNull(httpPipeline, "'httpPipeline' cannot be null.");
        Objects.requireNonNull(profile, "'profile' cannot be null.");
        this.clientObject = new MicrosoftSovereignBuilder().pipeline(httpPipeline)
     ...
     */
    public static SovereignManager authenticate(TokenCredential credential, AzureProfile profile) {
     ...
     * @return the sovereign service API instance.
     */
    public static SovereignManager authenticate(HttpPipeline httpPipeline, AzureProfile profile) {
        Objects.requireNonNull(httpPipeline, "'httpPipeline' cannot be null.");
        Objects.requireNonNull(profile, "'profile' cannot be null.");
        return new SovereignManager(httpPipeline, profile, null);
    }

    /**
     * Gets a Configurable instance that can be used to create SovereignManager with optional configuration.
     * 
     * @return the Configurable instance allowing configurations.
     */
    public static Configurable configure() {
        return new SovereignManager.Configurable();
    }
    ...
    public static final class Configurable {
        ...
        private static final Map<String, String> PROPERTIES
            = CoreUtils.getProperties("azure-resourcemanager-sovereign.properties");
