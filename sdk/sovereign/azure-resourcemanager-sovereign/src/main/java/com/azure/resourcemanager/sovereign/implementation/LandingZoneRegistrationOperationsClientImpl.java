...
import com.azure.resourcemanager.sovereign.models.LandingZoneRegistrationResourceListResult;
...
public final class LandingZoneRegistrationOperationsClientImpl implements LandingZoneRegistrationOperationsClient {
     ...
     */
    LandingZoneRegistrationOperationsClientImpl(MicrosoftSovereignImpl client) {
    ...
    /**
     * The interface defining all the services for MicrosoftSovereignLandingZoneRegistrationOperations to be used by the
    ...
    public interface LandingZoneRegistrationOperationsService {
        ...
        Mono<Response<LandingZoneRegistrationResourceListResult>> list(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<LandingZoneRegistrationResourceInner>> get(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
        ...
        Mono<Response<Flux<ByteBuffer>>> create(@HostParam("$host") String endpoint,
            ...
            @PathParam("landingZoneAccountName") String landingZoneAccountName,
            @PathParam("landingZoneRegistrationName") String landingZoneRegistrationName,
            @BodyParam("application/json") LandingZoneRegistrationResourceInner resource,
            @HeaderParam("Accept") String accept, Context context);
        ...
        Mono<Response<Flux<ByteBuffer>>> update(@HostParam("$host") String endpoint,
            ...
            @PathParam("landingZoneAccountName") String landingZoneAccountName,
            @PathParam("landingZoneRegistrationName") String landingZoneRegistrationName,
            @BodyParam("application/json") LandingZoneRegistrationResourceUpdate properties,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<LandingZoneRegistrationResourceListResult>> listNext(
    ...
    private Mono<PagedResponse<LandingZoneRegistrationResourceInner>> listSinglePageAsync(String resourceGroupName,
    ...
    private PagedFlux<LandingZoneRegistrationResourceInner> listAsync(String resourceGroupName,
        String landingZoneAccountName) {
        return new PagedFlux<>(() -> listSinglePageAsync(resourceGroupName, landingZoneAccountName),
    ...
    private PagedFlux<LandingZoneRegistrationResourceInner> listAsync(String resourceGroupName,
        String landingZoneAccountName, Context context) {
        return new PagedFlux<>(() -> listSinglePageAsync(resourceGroupName, landingZoneAccountName, context),
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<LandingZoneRegistrationResourceInner> list(String resourceGroupName,
        String landingZoneAccountName) {
        return new PagedIterable<>(listAsync(resourceGroupName, landingZoneAccountName));
    }
    ...
    public PagedIterable<LandingZoneRegistrationResourceInner> list(String resourceGroupName,
        String landingZoneAccountName, Context context) {
        return new PagedIterable<>(listAsync(resourceGroupName, landingZoneAccountName, context));
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> createWithResponseAsync(String resourceGroupName,
        ...
        return service.create(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, landingZoneAccountName, landingZoneRegistrationName, resource, accept, context);
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> updateWithResponseAsync(String resourceGroupName,
        ...
        return service.update(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, landingZoneAccountName, landingZoneRegistrationName, properties, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<LandingZoneRegistrationResourceInner>> listNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
