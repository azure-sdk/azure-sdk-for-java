...
public final class ProviderInstancesCreateSamples {
    ...
    public static void createASAPMonitor(com.azure.resourcemanager.hanaonazure.HanaManager manager) {
        manager.providerInstances().define("myProviderInstance")
            .withExistingSapMonitor("myResourceGroup", "mySapMonitor").withTypePropertiesType("hana")
            .withProperties(
                "{\"hostname\":\"10.0.0.6\",\"dbName\":\"SYSTEMDB\",\"sqlPort\":30013,\"dbUsername\":\"SYSTEM\",\"dbPassword\":\"PASSWORD\"}")
            .withMetadata("{\"key\":\"value\"}").create();
    }
}
```
...
public final class SapMonitorsCreateSamples {
     ...
     */
    public static void createASAPMonitor(com.azure.resourcemanager.hanaonazure.HanaManager manager) {
        manager.sapMonitors().define("mySapMonitor").withRegion("westus").withExistingResourceGroup("myResourceGroup")
            ...
            .withEnableCustomerAnalytics(true).withLogAnalyticsWorkspaceId("00000000-0000-0000-0000-000000000000")
...
public final class SapMonitorsGetByResourceGroupSamples {
     ...
     */
    public static void getPropertiesOfASAPMonitor(com.azure.resourcemanager.hanaonazure.HanaManager manager) {
        manager.sapMonitors().getByResourceGroupWithResponse("myResourceGroup", "mySapMonitor",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class SapMonitorsUpdateSamples {
     ...
     * x-ms-original-file:
     * specification/hanaonazure/resource-manager/Microsoft.HanaOnAzure/preview/2020-02-07-preview/examples/
     * SapMonitors_PatchTags_Delete.json
     */
    /**
