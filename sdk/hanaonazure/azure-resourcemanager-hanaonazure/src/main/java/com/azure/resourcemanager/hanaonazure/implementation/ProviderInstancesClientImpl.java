...
public final class ProviderInstancesClientImpl implements ProviderInstancesClient {
    ...
    /**
     * The interface defining all the services for HanaManagementClientProviderInstances to be used by the proxy
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the response from the List provider instances operation as paginated response with {@link PagedFlux}.
     */
    ...
    private PagedFlux<ProviderInstanceInner> listAsync(String resourceGroupName, String sapMonitorName,
        Context context) {
        return new PagedFlux<>(() -> listSinglePageAsync(resourceGroupName, sapMonitorName, context),
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the response from the List provider instances operation as paginated response with {@link PagedIterable}.
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    ...
    private Mono<Response<Flux<ByteBuffer>>> createWithResponseAsync(String resourceGroupName, String sapMonitorName,
        ...
        return FluxUtil
            .withContext(context -> service.create(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, sapMonitorName, providerInstanceName,
    ...
    private Mono<Response<Flux<ByteBuffer>>> createWithResponseAsync(String resourceGroupName, String sapMonitorName,
        ...
        return service.create(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, sapMonitorName, providerInstanceName, providerInstanceParameter, accept, context);
    }
    ...
    public SyncPoller<PollResult<ProviderInstanceInner>, ProviderInstanceInner> beginCreate(String resourceGroupName,
        ...
        return this.beginCreateAsync(resourceGroupName, sapMonitorName, providerInstanceName, providerInstanceParameter)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String sapMonitorName,
        String providerInstanceName) {
        return this.beginDeleteAsync(resourceGroupName, sapMonitorName, providerInstanceName).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String sapMonitorName,
        String providerInstanceName, Context context) {
        return this.beginDeleteAsync(resourceGroupName, sapMonitorName, providerInstanceName, context).getSyncPoller();
    }
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String sapMonitorName, String providerInstanceName,
        Context context) {
        return beginDeleteAsync(resourceGroupName, sapMonitorName, providerInstanceName, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
