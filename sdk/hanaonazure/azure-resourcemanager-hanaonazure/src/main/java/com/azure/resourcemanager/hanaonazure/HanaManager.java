...
package com.azure.resourcemanager.hanaonazure;
...
public final class HanaManager {
    ...
    public static HanaManager authenticate(HttpPipeline httpPipeline, AzureProfile profile) {
        Objects.requireNonNull(httpPipeline, "'httpPipeline' cannot be null.");
        Objects.requireNonNull(profile, "'profile' cannot be null.");
        return new HanaManager(httpPipeline, profile, null);
    }
    ...
    public static final class Configurable {
        ...
        private static final Map<String, String> PROPERTIES
            = CoreUtils.getProperties("azure-resourcemanager-hanaonazure.properties");
         ...
         * @return the Hana service API instance.
         */
        public HanaManager authenticate(TokenCredential credential, AzureProfile profile) {
            Objects.requireNonNull(credential, "'credential' cannot be null.");
            Objects.requireNonNull(profile, "'profile' cannot be null.");
