...
public interface SapMonitorsClient {
    ...
    Response<SapMonitorInner> getByResourceGroupWithResponse(String resourceGroupName, String sapMonitorName,
        Context context);
    ...
    SyncPoller<PollResult<SapMonitorInner>, SapMonitorInner> beginCreate(String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<SapMonitorInner> updateWithResponse(String resourceGroupName, String sapMonitorName, Tags tagsParameter,
        Context context);
