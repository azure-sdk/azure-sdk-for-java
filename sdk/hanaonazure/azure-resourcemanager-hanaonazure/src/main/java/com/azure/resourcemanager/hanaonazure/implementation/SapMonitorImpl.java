...
public final class SapMonitorImpl implements SapMonitor, SapMonitor.Definition, SapMonitor.Update {
    ...
    public SapMonitor create() {
        this.innerObject = serviceManager.serviceClient().getSapMonitors().create(resourceGroupName, sapMonitorName,
    ...
    public SapMonitor apply() {
        this.innerObject = serviceManager.serviceClient().getSapMonitors()
            .updateWithResponse(resourceGroupName, sapMonitorName, updateTagsParameter, Context.NONE).getValue();
        return this;
    }

    public SapMonitor apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getSapMonitors()
            .updateWithResponse(resourceGroupName, sapMonitorName, updateTagsParameter, context).getValue();
        return this;
    }
    ...
    SapMonitorImpl(SapMonitorInner innerObject, com.azure.resourcemanager.hanaonazure.HanaManager serviceManager) {
        ...
        this.sapMonitorName = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "sapMonitors");
    }

    public SapMonitor refresh() {
        this.innerObject = serviceManager.serviceClient().getSapMonitors()
            .getByResourceGroupWithResponse(resourceGroupName, sapMonitorName, Context.NONE).getValue();
        return this;
    }

    public SapMonitor refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getSapMonitors()
            .getByResourceGroupWithResponse(resourceGroupName, sapMonitorName, context).getValue();
        return this;
    }
