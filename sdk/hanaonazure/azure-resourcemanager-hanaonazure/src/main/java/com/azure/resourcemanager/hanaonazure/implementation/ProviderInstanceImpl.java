...
public final class ProviderInstanceImpl implements ProviderInstance, ProviderInstance.Definition {
    ...
    public ProviderInstance create() {
        this.innerObject = serviceManager.serviceClient().getProviderInstances().create(resourceGroupName,
            sapMonitorName, providerInstanceName, this.innerModel(), Context.NONE);
        return this;
    }

    public ProviderInstance create(Context context) {
        this.innerObject = serviceManager.serviceClient().getProviderInstances().create(resourceGroupName,
            sapMonitorName, providerInstanceName, this.innerModel(), context);
        return this;
    }
    ...
    public ProviderInstance refresh() {
        this.innerObject = serviceManager.serviceClient().getProviderInstances()
            .getWithResponse(resourceGroupName, sapMonitorName, providerInstanceName, Context.NONE).getValue();
        return this;
    }

    public ProviderInstance refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getProviderInstances()
            .getWithResponse(resourceGroupName, sapMonitorName, providerInstanceName, context).getValue();
        return this;
    }
