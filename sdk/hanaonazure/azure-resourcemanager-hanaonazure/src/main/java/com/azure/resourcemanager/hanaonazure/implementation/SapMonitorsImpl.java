...
public final class SapMonitorsImpl implements SapMonitors {
    ...
    public SapMonitorsImpl(SapMonitorsClient innerClient,
    ...
    public PagedIterable<SapMonitor> list() {
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new SapMonitorImpl(inner1, this.manager()));
    }
    ...
    public Response<SapMonitor> getByResourceGroupWithResponse(String resourceGroupName, String sapMonitorName,
        Context context) {
    ...
    public SapMonitor getById(String id) {
        ...
        String sapMonitorName = ResourceManagerUtils.getValueFromIdByName(id, "sapMonitors");
