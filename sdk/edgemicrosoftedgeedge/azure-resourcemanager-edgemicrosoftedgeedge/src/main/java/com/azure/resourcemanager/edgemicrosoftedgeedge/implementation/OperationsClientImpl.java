...
import com.azure.resourcemanager.edgemicrosoftedgeedge.models.OperationListResult;
...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    OperationsClientImpl(MicrosoftEdgeImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for MicrosoftEdgeOperations to be used by the proxy service to perform
     * REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "MicrosoftEdgeOperati")
    public interface OperationsService {
        @Headers({ "Content-Type: application/json" })
        @Get("/providers/Microsoft.Edge/operations")
