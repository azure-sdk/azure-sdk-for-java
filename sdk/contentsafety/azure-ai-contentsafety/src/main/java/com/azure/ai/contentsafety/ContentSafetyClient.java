...
public final class ContentSafetyClient {
    ...
    public Response<BinaryData> detectTextJailbreakWithResponse(BinaryData body, RequestOptions requestOptions) {
        return this.serviceClient.detectTextJailbreakWithResponse(body, requestOptions);
    }
    ...
    public Response<BinaryData> detectTextProtectedMaterialWithResponse(
        ...
        return this.serviceClient.detectTextProtectedMaterialWithResponse(body, requestOptions);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public AnalyzeTextJailbreakResult detectTextJailbreak(AnalyzeTextJailbreakOptions body) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public AnalyzeTextProtectedMaterialResult detectTextProtectedMaterial(AnalyzeTextProtectedMaterialOptions body) {
