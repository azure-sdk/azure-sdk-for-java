...
public final class AvailableInplaceUpgradeOSImpl implements AvailableInplaceUpgradeOS {
    ...
    public AvailableInplaceUpgradeOSImpl(AvailableInplaceUpgradeOSClient innerClient,
        com.azure.resourcemanager.testbase.TestBaseManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public PagedIterable<AvailableInplaceUpgradeOSResource> list(String resourceGroupName, String testBaseAccountName,
    ...
    public Response<AvailableInplaceUpgradeOSResource> getWithResponse(String resourceGroupName,
        String testBaseAccountName, String availableInplaceUpgradeOSResourceName, Context context) {
        Response<AvailableInplaceUpgradeOSResourceInner> inner = this.serviceClient().getWithResponse(resourceGroupName,
            testBaseAccountName, availableInplaceUpgradeOSResourceName, context);
        if (inner != null) {
    ...
    public AvailableInplaceUpgradeOSResource get(String resourceGroupName, String testBaseAccountName,
