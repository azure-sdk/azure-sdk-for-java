...
public interface ImageDefinitionsClient {
    ...
    PagedIterable<ImageDefinitionResourceInner> listByTestBaseAccount(
    ...
    Response<ImageDefinitionResourceInner> createWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ImageDefinitionResourceInner create(
        String resourceGroupName,
        String testBaseAccountName,
        String imageDefinitionName,
        ImageDefinitionResourceInner parameters);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<ImageDefinitionResourceInner> getWithResponse(
