...
public final class TestBaseAccountAvailableOSsClientImpl implements TestBaseAccountAvailableOSsClient {
    /** The proxy service used to perform REST calls. */
    private final TestBaseAccountAvailableOSsService service;

    /** The service client containing this operation class. */
    private final RestApiForTestBaseImpl client;

    /**
     * Initializes an instance of TestBaseAccountAvailableOSsClientImpl.
     *
     * @param client the instance of the service client containing this operation class.
     */
    TestBaseAccountAvailableOSsClientImpl(RestApiForTestBaseImpl client) {
        this.service =
            RestProxy
                .create(
                    TestBaseAccountAvailableOSsService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for RestApiForTestBaseTestBaseAccountAvailableOSs to be used by the proxy
     * service to perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "RestApiForTestBaseTe")
    public interface TestBaseAccountAvailableOSsService {
