...
public final class CredentialsImpl implements Credentials {
    ...
    public CredentialsImpl(
        CredentialsClient innerClient, com.azure.resourcemanager.testbase.TestBaseManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public PagedIterable<CredentialResource> listByTestBaseAccount(
    ...
    public Response<CredentialResource> getWithResponse(
