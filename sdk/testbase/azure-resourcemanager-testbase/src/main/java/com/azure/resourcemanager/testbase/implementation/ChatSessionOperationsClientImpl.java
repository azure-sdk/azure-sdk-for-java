...
public final class ChatSessionOperationsClientImpl implements ChatSessionOperationsClient {
    ...
    ChatSessionOperationsClientImpl(TestBaseImpl client) {
        this.service =
            RestProxy
                .create(ChatSessionOperationsService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }
    ...
    public interface ChatSessionOperationsService {
        ...
        Mono<Response<Flux<ByteBuffer>>> chat(
            ...
            @BodyParam("application/json") ChatRequest parameters,
    ...
    private Mono<Response<Flux<ByteBuffer>>> chatWithResponseAsync(
    ...
    private PollerFlux<PollResult<ChatResponseInner>, ChatResponseInner> beginChatAsync(
        String resourceGroupName, String testBaseAccountName, String chatSessionName, ChatRequest parameters) {
        Mono<Response<Flux<ByteBuffer>>> mono =
            chatWithResponseAsync(resourceGroupName, testBaseAccountName, chatSessionName, parameters);
        return this
            .client
            .<ChatResponseInner, ChatResponseInner>getLroResult(
                mono,
                this.client.getHttpPipeline(),
                ChatResponseInner.class,
                ChatResponseInner.class,
    ...
    private PollerFlux<PollResult<ChatResponseInner>, ChatResponseInner> beginChatAsync(
        ...
        return this
            .client
            .<ChatResponseInner, ChatResponseInner>getLroResult(
                mono, this.client.getHttpPipeline(), ChatResponseInner.class, ChatResponseInner.class, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<ChatResponseInner>, ChatResponseInner> beginChat(
        String resourceGroupName, String testBaseAccountName, String chatSessionName, ChatRequest parameters) {
    ...
    public SyncPoller<PollResult<ChatResponseInner>, ChatResponseInner> beginChat(
        ...
        Context context) {
        return this
            .beginChatAsync(resourceGroupName, testBaseAccountName, chatSessionName, parameters, context)
            .getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ChatResponseInner> chatAsync(
        String resourceGroupName, String testBaseAccountName, String chatSessionName, ChatRequest parameters) {
        return beginChatAsync(resourceGroupName, testBaseAccountName, chatSessionName, parameters)
            .last()
    ...
    private Mono<ChatResponseInner> chatAsync(
        ...
        ChatRequest parameters,
        Context context) {
        return beginChatAsync(resourceGroupName, testBaseAccountName, chatSessionName, parameters, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
