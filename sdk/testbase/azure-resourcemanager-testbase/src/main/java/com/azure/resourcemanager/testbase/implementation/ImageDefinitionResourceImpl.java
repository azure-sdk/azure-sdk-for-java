...
public final class ImageDefinitionResourceImpl implements ImageDefinitionResource, ImageDefinitionResource.Definition {
    ...
    ImageDefinitionResourceImpl(ImageDefinitionResourceInner innerObject,
    ...
    public ImageDefinitionResourceImpl withExistingTestBaseAccount(String resourceGroupName,
    ...
    public ImageDefinitionResource create() {
        this.innerObject = serviceManager.serviceClient().getImageDefinitions().createWithResponse(resourceGroupName,
            testBaseAccountName, imageDefinitionName, this.innerModel(), Context.NONE).getValue();
        return this;
    }

    public ImageDefinitionResource create(Context context) {
        this.innerObject = serviceManager.serviceClient().getImageDefinitions()
            .createWithResponse(resourceGroupName, testBaseAccountName, imageDefinitionName, this.innerModel(), context)
            .getValue();
        return this;
    }
    ...
    public ImageDefinitionResource refresh() {
        this.innerObject = serviceManager.serviceClient().getImageDefinitions()
            .getWithResponse(resourceGroupName, testBaseAccountName, imageDefinitionName, Context.NONE).getValue();
        return this;
    }

    public ImageDefinitionResource refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getImageDefinitions()
            .getWithResponse(resourceGroupName, testBaseAccountName, imageDefinitionName, context).getValue();
        return this;
    }
