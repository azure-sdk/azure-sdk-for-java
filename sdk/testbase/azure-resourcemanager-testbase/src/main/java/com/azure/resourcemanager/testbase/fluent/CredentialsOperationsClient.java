...
public interface CredentialsOperationsClient {
    ...
    Response<CredentialResourceInner> createWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    CredentialResourceInner create(
        String resourceGroupName,
        String testBaseAccountName,
        String credentialName,
        CredentialResourceInner parameters);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<CredentialResourceInner> updateWithResponse(
        String resourceGroupName,
        String testBaseAccountName,
        String credentialName,
        CredentialResourceInner parameters,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    CredentialResourceInner update(
        String resourceGroupName,
        String testBaseAccountName,
        String credentialName,
        CredentialResourceInner parameters);
