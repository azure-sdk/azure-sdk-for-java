...
public final class PackageRunTestParameters {
    ...
    /*
     * The tested custom image id. 'osName', 'release', 'buildVersion' and 'mediaPackageVersion' would be ignored when
     * it's eligible.'
     */
    ...
    /**
     * Creates an instance of PackageRunTestParameters class.
     */
    ...
    /**
     * Get the customImageId property: The tested custom image id. 'osName', 'release', 'buildVersion' and
    ...
    /**
     * Set the customImageId property: The tested custom image id. 'osName', 'release', 'buildVersion' and
     * 'mediaPackageVersion' would be ignored when it's eligible.'.
     * 
     * @param customImageId the customImageId value to set.
     * @return the PackageRunTestParameters object itself.
     */
    public PackageRunTestParameters withCustomImageId(String customImageId) {
