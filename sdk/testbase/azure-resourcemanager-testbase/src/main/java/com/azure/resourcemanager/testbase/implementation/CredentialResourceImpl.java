...
public final class CredentialResourceImpl
    ...
    public CredentialResource create() {
        this.innerObject = serviceManager.serviceClient().getCredentialsOperations()
            .createWithResponse(resourceGroupName, testBaseAccountName, credentialName, this.innerModel(), Context.NONE)
            .getValue();
        return this;
    }
    ...
    public CredentialResource apply() {
        this.innerObject = serviceManager.serviceClient().getCredentialsOperations()
            .updateWithResponse(resourceGroupName, testBaseAccountName, credentialName, this.innerModel(), Context.NONE)
            .getValue();
        return this;
    }
