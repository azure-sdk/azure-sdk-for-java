...
public interface OSUpdates {
     ...
     */
    PagedIterable<OSUpdateResource> list(String resourceGroupName, String testBaseAccountName, String packageName,
     ...
     */
    Response<OSUpdateResource> getWithResponse(String resourceGroupName, String testBaseAccountName, String packageName,
        String osUpdateResourceName, Context context);
     ...
     */
    OSUpdateResource get(String resourceGroupName, String testBaseAccountName, String packageName,
