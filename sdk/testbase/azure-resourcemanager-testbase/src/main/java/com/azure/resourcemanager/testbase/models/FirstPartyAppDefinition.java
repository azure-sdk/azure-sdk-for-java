...
public final class FirstPartyAppDefinition {
    ...
    /**
     * Get the interopExecutionMode property: Specifies how the first party applications should be interoperated with
     * user's application.
     *
    ...
    /**
     * Set the interopExecutionMode property: Specifies how the first party applications should be interoperated with
     * user's application.
     *
