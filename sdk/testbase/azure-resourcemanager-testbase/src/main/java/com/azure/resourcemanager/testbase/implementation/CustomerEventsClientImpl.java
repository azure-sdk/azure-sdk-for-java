...
public final class CustomerEventsClientImpl implements CustomerEventsClient {
    ...
    public SyncPoller<PollResult<CustomerEventResourceInner>, CustomerEventResourceInner> beginCreate(
        ...
        CustomerEventResourceInner parameters) {
        return this
            .beginCreateAsync(resourceGroupName, testBaseAccountName, customerEventName, parameters)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<CustomerEventResourceInner>, CustomerEventResourceInner> beginCreate(
        ...
        Context context) {
        return this
            .beginCreateAsync(resourceGroupName, testBaseAccountName, customerEventName, parameters, context)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(
        String resourceGroupName, String testBaseAccountName, String customerEventName, Context context) {
        return this
            .beginDeleteAsync(resourceGroupName, testBaseAccountName, customerEventName, context)
            .getSyncPoller();
    }
