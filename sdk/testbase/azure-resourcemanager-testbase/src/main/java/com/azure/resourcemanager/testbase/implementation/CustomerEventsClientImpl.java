...
public final class CustomerEventsClientImpl implements CustomerEventsClient {
    ...
    public interface CustomerEventsService {
        ...
        @Get("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.TestBase/testBaseAccounts/{testBaseAccountName}/customerEvents")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<CustomerEventListResult>> listByTestBaseAccount(@HostParam("$host") String endpoint,
        ...
        @Headers({ "Content-Type: application/json" })
        @Put("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.TestBase/testBaseAccounts/{testBaseAccountName}/customerEvents/{customerEventName}")
        ...
        Mono<Response<Flux<ByteBuffer>>> create(@HostParam("$host") String endpoint,
            ...
            @PathParam("customerEventName") String customerEventName, @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") CustomerEventResourceInner parameters, @HeaderParam("Accept") String accept,
            Context context);

        @Headers({ "Content-Type: application/json" })
        @Delete("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.TestBase/testBaseAccounts/{testBaseAccountName}/customerEvents/{customerEventName}")
        ...
        @Headers({ "Content-Type: application/json" })
        @Get("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.TestBase/testBaseAccounts/{testBaseAccountName}/customerEvents/{customerEventName}")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<CustomerEventResourceInner>> get(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("testBaseAccountName") String testBaseAccountName,
            @PathParam("customerEventName") String customerEventName, @QueryParam("api-version") String apiVersion,
     ...
     * @return a list of Test Base Customer Events along with {@link PagedResponse} on successful completion of
     * {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<CustomerEventResourceInner>>
        ...
        return FluxUtil
            ...
            .<PagedResponse<CustomerEventResourceInner>>map(res -> new PagedResponseBase<>(res.getRequest(),
    ...
    private PagedFlux<CustomerEventResourceInner> listByTestBaseAccountAsync(String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<CustomerEventResourceInner> listByTestBaseAccount(String resourceGroupName,
        String testBaseAccountName) {
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the Customer Notification Event resource along with {@link Response} on successful completion of
     * {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> createWithResponseAsync(String resourceGroupName,
        String testBaseAccountName, String customerEventName, CustomerEventResourceInner parameters) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return FluxUtil
            .withContext(
                context -> service.create(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
                    testBaseAccountName, customerEventName, this.client.getApiVersion(), parameters, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> createWithResponseAsync(String resourceGroupName,
        String testBaseAccountName, String customerEventName, CustomerEventResourceInner parameters, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    private PollerFlux<PollResult<CustomerEventResourceInner>, CustomerEventResourceInner> beginCreateAsync(
        ...
        return this.client.<CustomerEventResourceInner, CustomerEventResourceInner>getLroResult(mono,
            this.client.getHttpPipeline(), CustomerEventResourceInner.class, CustomerEventResourceInner.class,
    ...
    private PollerFlux<PollResult<CustomerEventResourceInner>, CustomerEventResourceInner> beginCreateAsync(
        String resourceGroupName, String testBaseAccountName, String customerEventName,
        CustomerEventResourceInner parameters, Context context) {
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono
            = createWithResponseAsync(resourceGroupName, testBaseAccountName, customerEventName, parameters, context);
        return this.client.<CustomerEventResourceInner, CustomerEventResourceInner>getLroResult(mono,
            this.client.getHttpPipeline(), CustomerEventResourceInner.class, CustomerEventResourceInner.class, context);
    }
    ...
    public SyncPoller<PollResult<CustomerEventResourceInner>, CustomerEventResourceInner> beginCreate(
        String resourceGroupName, String testBaseAccountName, String customerEventName,
        CustomerEventResourceInner parameters) {
        return this.beginCreateAsync(resourceGroupName, testBaseAccountName, customerEventName, parameters)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<CustomerEventResourceInner>, CustomerEventResourceInner> beginCreate(
        String resourceGroupName, String testBaseAccountName, String customerEventName,
        CustomerEventResourceInner parameters, Context context) {
        return this.beginCreateAsync(resourceGroupName, testBaseAccountName, customerEventName, parameters, context)
            .getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<CustomerEventResourceInner> createAsync(String resourceGroupName, String testBaseAccountName,
        String customerEventName, CustomerEventResourceInner parameters) {
        return beginCreateAsync(resourceGroupName, testBaseAccountName, customerEventName, parameters).last()
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<CustomerEventResourceInner> createAsync(String resourceGroupName, String testBaseAccountName,
        String customerEventName, CustomerEventResourceInner parameters, Context context) {
        return beginCreateAsync(resourceGroupName, testBaseAccountName, customerEventName, parameters, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public CustomerEventResourceInner create(String resourceGroupName, String testBaseAccountName,
        String customerEventName, CustomerEventResourceInner parameters) {
    ...
    private Mono<Response<Flux<ByteBuffer>>> deleteWithResponseAsync(String resourceGroupName,
        String testBaseAccountName, String customerEventName) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return FluxUtil
            .withContext(
                context -> service.delete(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
                    testBaseAccountName, customerEventName, this.client.getApiVersion(), accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> deleteWithResponseAsync(String resourceGroupName,
        String testBaseAccountName, String customerEventName, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<Void>, Void> beginDeleteAsync(String resourceGroupName, String testBaseAccountName,
        String customerEventName, Context context) {
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String testBaseAccountName,
        String customerEventName) {
        return this.beginDeleteAsync(resourceGroupName, testBaseAccountName, customerEventName).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String testBaseAccountName,
        String customerEventName, Context context) {
        return this.beginDeleteAsync(resourceGroupName, testBaseAccountName, customerEventName, context)
            .getSyncPoller();
    }
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String testBaseAccountName, String customerEventName) {
        return beginDeleteAsync(resourceGroupName, testBaseAccountName, customerEventName).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String testBaseAccountName, String customerEventName,
        Context context) {
        return beginDeleteAsync(resourceGroupName, testBaseAccountName, customerEventName, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<CustomerEventResourceInner>> getWithResponseAsync(String resourceGroupName,
        String testBaseAccountName, String customerEventName) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<CustomerEventResourceInner> getAsync(String resourceGroupName, String testBaseAccountName,
        String customerEventName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<CustomerEventResourceInner> getWithResponse(String resourceGroupName, String testBaseAccountName,
        String customerEventName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public CustomerEventResourceInner get(String resourceGroupName, String testBaseAccountName,
        String customerEventName) {
        return getWithResponse(resourceGroupName, testBaseAccountName, customerEventName, Context.NONE).getValue();
    }
