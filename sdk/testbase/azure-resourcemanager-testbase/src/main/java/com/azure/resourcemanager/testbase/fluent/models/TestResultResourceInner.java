...
public final class TestResultResourceInner extends ProxyResource {
    ...
    /** Creates an instance of TestResultResourceInner class. */
    public TestResultResourceInner() {
    }
     ...
     * @return the TestResultResourceInner object itself.
     */
    public TestResultResourceInner withCustomImageId(String customImageId) {
        if (this.innerProperties() == null) {
            this.innerProperties = new TestResultProperties();
        }
     ...
     * @return the TestResultResourceInner object itself.
     */
    public TestResultResourceInner withCustomImageDisplayName(String customImageDisplayName) {
        if (this.innerProperties() == null) {
            this.innerProperties = new TestResultProperties();
        }
    ...
    public InplaceUpgradeProperties inplaceUpgradeProperties() {
        return this.innerProperties() == null ? null : this.innerProperties().inplaceUpgradeProperties();
    }
     ...
     * @return the TestResultResourceInner object itself.
     */
    public TestResultResourceInner withInplaceUpgradeProperties(InplaceUpgradeProperties inplaceUpgradeProperties) {
        if (this.innerProperties() == null) {
            this.innerProperties = new TestResultProperties();
        }
        this.innerProperties().withInplaceUpgradeProperties(inplaceUpgradeProperties);
        return this;
    }
    ...
    public OffsetDateTime testStartTime() {
        return this.innerProperties() == null ? null : this.innerProperties().testStartTime();
    }
     ...
     * @return the TestResultResourceInner object itself.
     */
    public TestResultResourceInner withTestStartTime(OffsetDateTime testStartTime) {
        if (this.innerProperties() == null) {
            this.innerProperties = new TestResultProperties();
        }
        this.innerProperties().withTestStartTime(testStartTime);
        return this;
    }
    ...
    public OffsetDateTime testEndTime() {
        return this.innerProperties() == null ? null : this.innerProperties().testEndTime();
    }
     ...
     * @return the TestResultResourceInner object itself.
     */
    public TestResultResourceInner withTestEndTime(OffsetDateTime testEndTime) {
        if (this.innerProperties() == null) {
            this.innerProperties = new TestResultProperties();
        }
        this.innerProperties().withTestEndTime(testEndTime);
        return this;
    }
     ...
     * @return the TestResultResourceInner object itself.
     */
    public TestResultResourceInner withFirstPartyApps(List<TestResultFirstPartyAppDefinition> firstPartyApps) {
        if (this.innerProperties() == null) {
            this.innerProperties = new TestResultProperties();
        }
