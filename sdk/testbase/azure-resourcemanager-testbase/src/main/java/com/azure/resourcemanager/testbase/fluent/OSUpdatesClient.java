...
public interface OSUpdatesClient {
    ...
    PagedIterable<OSUpdateResourceInner> list(String resourceGroupName, String testBaseAccountName, String packageName,
    ...
    Response<OSUpdateResourceInner> getWithResponse(String resourceGroupName, String testBaseAccountName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    OSUpdateResourceInner get(String resourceGroupName, String testBaseAccountName, String packageName,
