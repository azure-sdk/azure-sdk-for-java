...
public final class Command {
     ...
     */
    @JsonProperty(value = "install1PAppBefore")
    private Boolean install1PAppBefore;

    /*
     * Specifies whether the command is assigned to be executed before in-place upgrade.
     */
    @JsonProperty(value = "preUpgrade")
    private Boolean preUpgrade;

    /*
     * Specifies whether the command is assigned to be executed after in-place upgrade.
     */
    @JsonProperty(value = "postUpgrade")
    private Boolean postUpgrade;

    /*
     * Specifies whether to enroll Intune before the command.
     */
    @JsonProperty(value = "enrollIntuneBefore")
    private Boolean enrollIntuneBefore;

    /**
     * Creates an instance of Command class.
     */
    public Command() {
    }
    ...
    /**
     * Get the install1PAppBefore property: Specifies whether to install first party applications before running the
     * command.
     * 
     * @return the install1PAppBefore value.
     */
    public Boolean install1PAppBefore() {
        return this.install1PAppBefore;
    }

    /**
     * Set the install1PAppBefore property: Specifies whether to install first party applications before running the
     * command.
     * 
     * @param install1PAppBefore the install1PAppBefore value to set.
     * @return the Command object itself.
     */
    public Command withInstall1PAppBefore(Boolean install1PAppBefore) {
        this.install1PAppBefore = install1PAppBefore;
        return this;
    }

    /**
     * Get the preUpgrade property: Specifies whether the command is assigned to be executed before in-place upgrade.
     * 
     * @return the preUpgrade value.
     */
    ...
    /**
     * Set the preUpgrade property: Specifies whether the command is assigned to be executed before in-place upgrade.
     * 
     * @param preUpgrade the preUpgrade value to set.
     * @return the Command object itself.
     */
    public Command withPreUpgrade(Boolean preUpgrade) {
        this.preUpgrade = preUpgrade;
        return this;
    }

    /**
     * Get the postUpgrade property: Specifies whether the command is assigned to be executed after in-place upgrade.
     * 
     * @return the postUpgrade value.
     */
    ...
    /**
     * Set the postUpgrade property: Specifies whether the command is assigned to be executed after in-place upgrade.
     * 
     * @param postUpgrade the postUpgrade value to set.
     * @return the Command object itself.
     */
    public Command withPostUpgrade(Boolean postUpgrade) {
        this.postUpgrade = postUpgrade;
        return this;
    }

    /**
     * Get the enrollIntuneBefore property: Specifies whether to enroll Intune before the command.
     * 
     * @return the enrollIntuneBefore value.
     */
    public Boolean enrollIntuneBefore() {
        return this.enrollIntuneBefore;
    }

    /**
     * Set the enrollIntuneBefore property: Specifies whether to enroll Intune before the command.
     * 
     * @param enrollIntuneBefore the enrollIntuneBefore value to set.
     * @return the Command object itself.
     */
    public Command withEnrollIntuneBefore(Boolean enrollIntuneBefore) {
