...
public final class EmailEventsImpl implements EmailEvents {
    ...
    public EmailEventsImpl(EmailEventsClient innerClient,
    ...
    public Response<EmailEventResource> getWithResponse(String resourceGroupName, String testBaseAccountName,
        String emailEventResourceName, Context context) {
        Response<EmailEventResourceInner> inner = this.serviceClient().getWithResponse(resourceGroupName,
            testBaseAccountName, emailEventResourceName, context);
        if (inner != null) {
