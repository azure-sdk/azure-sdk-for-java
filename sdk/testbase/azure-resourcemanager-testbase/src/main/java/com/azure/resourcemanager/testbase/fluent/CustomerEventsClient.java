...
public interface CustomerEventsClient {
    ...
    PagedIterable<CustomerEventResourceInner> listByTestBaseAccount(String resourceGroupName,
    ...
    SyncPoller<PollResult<CustomerEventResourceInner>, CustomerEventResourceInner> beginCreate(String resourceGroupName,
    ...
    CustomerEventResourceInner create(String resourceGroupName, String testBaseAccountName, String customerEventName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<CustomerEventResourceInner> getWithResponse(String resourceGroupName, String testBaseAccountName,
        String customerEventName, Context context);
