...
public interface FlightingRingsClient {
    ...
    Response<FlightingRingResourceInner> getWithResponse(String resourceGroupName, String testBaseAccountName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    FlightingRingResourceInner get(String resourceGroupName, String testBaseAccountName,
