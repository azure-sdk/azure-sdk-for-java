...
public final class PackageUpdateParameters {
     ...
     * @return the PackageUpdateParameters object itself.
     */
    public PackageUpdateParameters withDraftPackageId(String draftPackageId) {
     ...
     * @return the PackageUpdateParameters object itself.
     */
    public PackageUpdateParameters withInplaceUpgradeOSPair(InplaceUpgradeOSInfo inplaceUpgradeOSPair) {
        if (this.innerProperties() == null) {
            this.innerProperties = new PackageUpdateParameterProperties();
        }
     ...
     * @return the PackageUpdateParameters object itself.
     */
    public PackageUpdateParameters withFirstPartyApps(List<FirstPartyAppDefinition> firstPartyApps) {
        if (this.innerProperties() == null) {
            this.innerProperties = new PackageUpdateParameterProperties();
        }
     ...
     * @return the PackageUpdateParameters object itself.
     */
    public PackageUpdateParameters withIntuneEnrollmentMetadata(IntuneEnrollmentMetadata intuneEnrollmentMetadata) {
        if (this.innerProperties() == null) {
            this.innerProperties = new PackageUpdateParameterProperties();
        }
