...
public interface ActionRequestsOperations {
     ...
     */
    Response<ActionRequest> getWithResponse(String resourceGroupName, String testBaseAccountName,
     ...
     * @return the paginated response with {@link PagedIterable}.
     */
    PagedIterable<ActionRequest> list(String resourceGroupName, String testBaseAccountName, String requestType,
