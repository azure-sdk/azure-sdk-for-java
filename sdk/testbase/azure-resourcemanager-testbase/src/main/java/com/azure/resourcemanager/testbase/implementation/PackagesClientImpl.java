...
public final class PackagesClientImpl implements PackagesClient {
    ...
    public SyncPoller<PollResult<PackageResourceInner>, PackageResourceInner> beginCreate(
        ...
        Context context) {
        return this
            .beginCreateAsync(resourceGroupName, testBaseAccountName, packageName, parameters, context)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<PackageResourceInner>, PackageResourceInner> beginUpdate(
        ...
        Context context) {
        return this
            .beginUpdateAsync(resourceGroupName, testBaseAccountName, packageName, parameters, context)
            .getSyncPoller();
    }
