...
public final class FirstPartyAppsClientImpl implements FirstPartyAppsClient {
    ...
    public interface FirstPartyAppsService {
        ...
        Mono<Response<FirstPartyAppListResult>> list(
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<FirstPartyAppResourceInner>> get(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("testBaseAccountName") String testBaseAccountName,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<FirstPartyAppListResult>> listNext(
    ...
    private Mono<PagedResponse<FirstPartyAppResourceInner>> listSinglePageAsync(
                ...
                context ->
                    service
                        .list(
                            ...
                            accept,
                            context))
            .<PagedResponse<FirstPartyAppResourceInner>>map(
                res ->
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<FirstPartyAppResourceInner> listAsync(
        String resourceGroupName, String testBaseAccountName, Context context) {
        return new PagedFlux<>(
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<FirstPartyAppResourceInner> list(
        String resourceGroupName, String testBaseAccountName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<FirstPartyAppResourceInner>> getWithResponseAsync(
        ...
        if (firstPartyAppResourceName == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
                        "Parameter firstPartyAppResourceName is required and cannot be null."));
        }
        final String accept = "application/json";
        return FluxUtil
            .withContext(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<FirstPartyAppResourceInner> getAsync(
        String resourceGroupName, String testBaseAccountName, String firstPartyAppResourceName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<FirstPartyAppResourceInner> getWithResponse(
        String resourceGroupName, String testBaseAccountName, String firstPartyAppResourceName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public FirstPartyAppResourceInner get(
        String resourceGroupName, String testBaseAccountName, String firstPartyAppResourceName) {
