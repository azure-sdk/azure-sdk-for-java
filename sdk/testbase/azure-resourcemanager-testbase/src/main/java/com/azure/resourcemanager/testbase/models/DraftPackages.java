...
public interface DraftPackages {
     ...
     * @return a list of Test Base Draft Packages as paginated response with {@link PagedIterable}.
     */
    PagedIterable<DraftPackageResource> listByTestBaseAccount(
     ...
     */
    Response<DraftPackageResource> getWithResponse(
        String resourceGroupName, String testBaseAccountName, String draftPackageName, Context context);
     ...
     */
    Response<DraftPackageGetPathResponse> getPathWithResponse(
        String resourceGroupName, String testBaseAccountName, String draftPackageName, Context context);
