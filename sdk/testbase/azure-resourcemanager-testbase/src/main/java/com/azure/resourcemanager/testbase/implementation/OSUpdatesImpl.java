...
public final class OSUpdatesImpl implements OSUpdates {
    ...
    public OSUpdatesImpl(OSUpdatesClient innerClient,
        com.azure.resourcemanager.testbase.TestBaseManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public PagedIterable<OSUpdateResource> list(String resourceGroupName, String testBaseAccountName,
    ...
    public Response<OSUpdateResource> getWithResponse(String resourceGroupName, String testBaseAccountName,
        String packageName, String osUpdateResourceName, Context context) {
        Response<OSUpdateResourceInner> inner = this.serviceClient().getWithResponse(resourceGroupName,
            testBaseAccountName, packageName, osUpdateResourceName, context);
        if (inner != null) {
    ...
    public OSUpdateResource get(String resourceGroupName, String testBaseAccountName, String packageName,
