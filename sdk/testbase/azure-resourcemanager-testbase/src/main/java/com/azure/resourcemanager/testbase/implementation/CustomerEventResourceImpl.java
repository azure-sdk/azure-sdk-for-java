...
public final class CustomerEventResourceImpl implements CustomerEventResource, CustomerEventResource.Definition {
    ...
    CustomerEventResourceImpl(CustomerEventResourceInner innerObject,
    ...
    public CustomerEventResource create() {
        this.innerObject = serviceManager.serviceClient().getCustomerEvents().create(resourceGroupName,
            testBaseAccountName, customerEventName, this.innerModel(), Context.NONE);
        return this;
    }

    public CustomerEventResource create(Context context) {
        this.innerObject = serviceManager.serviceClient().getCustomerEvents().create(resourceGroupName,
            testBaseAccountName, customerEventName, this.innerModel(), context);
        return this;
    }
    ...
    public CustomerEventResource refresh() {
        this.innerObject = serviceManager.serviceClient().getCustomerEvents()
            .getWithResponse(resourceGroupName, testBaseAccountName, customerEventName, Context.NONE).getValue();
        return this;
    }

    public CustomerEventResource refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getCustomerEvents()
            .getWithResponse(resourceGroupName, testBaseAccountName, customerEventName, context).getValue();
        return this;
    }
