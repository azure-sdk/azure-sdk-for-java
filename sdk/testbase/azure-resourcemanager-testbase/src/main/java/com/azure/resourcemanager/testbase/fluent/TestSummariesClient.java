...
public interface TestSummariesClient {
    ...
    PagedIterable<TestSummaryResourceInner> list(String resourceGroupName, String testBaseAccountName);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<TestSummaryResourceInner> list(String resourceGroupName, String testBaseAccountName, Context context);
    ...
    Response<TestSummaryResourceInner> getWithResponse(String resourceGroupName, String testBaseAccountName,
