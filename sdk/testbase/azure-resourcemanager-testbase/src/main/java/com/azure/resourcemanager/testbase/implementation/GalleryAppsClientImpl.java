...
public final class GalleryAppsClientImpl implements GalleryAppsClient {
    ...
    public interface GalleryAppsService {
        ...
        @Get("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.TestBase/testBaseAccounts/{testBaseAccountName}/galleryApps")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<GalleryAppListResult>> list(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("testBaseAccountName") String testBaseAccountName, @QueryParam("api-version") String apiVersion,
            @QueryParam("keyword") String keyword, @QueryParam("applicationType") ApplicationType applicationType,
            @QueryParam("orderBy") OrderBy orderBy, @QueryParam("top") Integer top,
            @HeaderParam("Accept") String accept, Context context);

        @Headers({ "Content-Type: application/json" })
        @Get("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.TestBase/testBaseAccounts/{testBaseAccountName}/galleryApps/{galleryAppName}")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<GalleryAppResourceInner>> get(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<GalleryAppListResult>> listNext(@PathParam(value = "nextLink", encoded = true) String nextLink,
    ...
    private Mono<PagedResponse<GalleryAppResourceInner>> listSinglePageAsync(String resourceGroupName,
        String testBaseAccountName, String keyword, ApplicationType applicationType, OrderBy orderBy, Integer top) {
        ...
        return FluxUtil
            .withContext(context -> service.list(this.client.getEndpoint(), this.client.getSubscriptionId(),
                resourceGroupName, testBaseAccountName, this.client.getApiVersion(), keyword, applicationType, orderBy,
                top, accept, context))
            .<PagedResponse<GalleryAppResourceInner>>map(res -> new PagedResponseBase<>(res.getRequest(),
    ...
    private Mono<PagedResponse<GalleryAppResourceInner>> listSinglePageAsync(String resourceGroupName,
        ...
        return service
            .list(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName, testBaseAccountName,
                this.client.getApiVersion(), keyword, applicationType, orderBy, top, accept, context)
    ...
    private PagedFlux<GalleryAppResourceInner> listAsync(String resourceGroupName, String testBaseAccountName,
        String keyword, ApplicationType applicationType, OrderBy orderBy, Integer top) {
    ...
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<GalleryAppResourceInner> listAsync(String resourceGroupName, String testBaseAccountName,
        String keyword, ApplicationType applicationType, OrderBy orderBy, Integer top, Context context) {
        return new PagedFlux<>(() -> listSinglePageAsync(resourceGroupName, testBaseAccountName, keyword,
            applicationType, orderBy, top, context), nextLink -> listNextSinglePageAsync(nextLink, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<GalleryAppResourceInner>> getWithResponseAsync(String resourceGroupName,
    ...
    private Mono<Response<GalleryAppResourceInner>> getWithResponseAsync(String resourceGroupName,
        ...
        return service.get(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            testBaseAccountName, galleryAppName, this.client.getApiVersion(), accept, context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a gallery application to prepare a test run for a Test Base Account on successful completion of
     * {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<GalleryAppResourceInner> getAsync(String resourceGroupName, String testBaseAccountName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<GalleryAppResourceInner> getWithResponse(String resourceGroupName, String testBaseAccountName,
