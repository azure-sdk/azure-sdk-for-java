 ...
 */
public interface AvailableInplaceUpgradeOSClient {
    /**
    ...
    PagedIterable<AvailableInplaceUpgradeOSResourceInner> list(String resourceGroupName, String testBaseAccountName,
    ...
    Response<AvailableInplaceUpgradeOSResourceInner> getWithResponse(String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    AvailableInplaceUpgradeOSResourceInner get(String resourceGroupName, String testBaseAccountName,
