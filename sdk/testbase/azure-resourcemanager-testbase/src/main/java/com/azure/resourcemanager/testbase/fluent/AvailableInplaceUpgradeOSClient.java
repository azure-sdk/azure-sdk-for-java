...
public interface AvailableInplaceUpgradeOSClient {
    ...
    PagedIterable<AvailableInplaceUpgradeOSResourceInner> list(
    ...
    Response<AvailableInplaceUpgradeOSResourceInner> getWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    AvailableInplaceUpgradeOSResourceInner get(
