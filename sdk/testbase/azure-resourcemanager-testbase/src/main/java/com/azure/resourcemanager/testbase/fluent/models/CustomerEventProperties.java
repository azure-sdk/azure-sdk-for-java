...
public final class CustomerEventProperties {
    ...
    /**
     * Creates an instance of CustomerEventProperties class.
     */
    ...
    public void validate() {
        if (eventName() == null) {
            throw LOGGER.logExceptionAsError(
                new IllegalArgumentException("Missing required property eventName in model CustomerEventProperties"));
        }
        if (receivers() == null) {
            throw LOGGER.logExceptionAsError(
                new IllegalArgumentException("Missing required property receivers in model CustomerEventProperties"));
        } else {
