...
public final class PackagesImpl implements Packages {
    ...
    public Response<PackageResource> getWithResponse(String resourceGroupName, String testBaseAccountName,
    ...
    public Response<DownloadUrlResponse> getDownloadUrlWithResponse(String resourceGroupName,
        ...
        Response<DownloadUrlResponseInner> inner = this.serviceClient().getDownloadUrlWithResponse(resourceGroupName,
            testBaseAccountName, packageName, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
    ...
    public DownloadUrlResponse getDownloadUrl(String resourceGroupName, String testBaseAccountName,
        String packageName) {
    ...
    public PackagesRunTestResponse runTestWithResponse(String resourceGroupName, String testBaseAccountName,
        ...
        return this.serviceClient().runTestWithResponse(resourceGroupName, testBaseAccountName, packageName, parameters,
            context);
    }
