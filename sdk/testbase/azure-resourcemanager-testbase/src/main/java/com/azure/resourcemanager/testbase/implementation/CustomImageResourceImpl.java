...
public final class CustomImageResourceImpl implements CustomImageResource, CustomImageResource.Definition {
    ...
    CustomImageResourceImpl(
        CustomImageResourceInner innerObject, com.azure.resourcemanager.testbase.TestBaseManager serviceManager) {
    ...
    public CustomImageResource create() {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getCustomImages()
                .create(resourceGroupName, testBaseAccountName, customImageName, this.innerModel(), Context.NONE);
        return this;
    }
    ...
    public CustomImageResource create(Context context) {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getCustomImages()
                .create(resourceGroupName, testBaseAccountName, customImageName, this.innerModel(), context);
        return this;
    }
    ...
    public CustomImageResource refresh() {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getCustomImages()
                .getWithResponse(resourceGroupName, testBaseAccountName, customImageName, Context.NONE)
                .getValue();
        return this;
    }
    ...
    public CustomImageResource refresh(Context context) {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getCustomImages()
                .getWithResponse(resourceGroupName, testBaseAccountName, customImageName, context)
                .getValue();
        return this;
    }
