...
public final class DraftPackageResourceImpl
    ...
    public DraftPackageResource create() {
        this.innerObject = serviceManager.serviceClient().getDraftPackages().createWithResponse(resourceGroupName,
            testBaseAccountName, draftPackageName, this.innerModel(), Context.NONE).getValue();
        return this;
    }

    public DraftPackageResource create(Context context) {
        this.innerObject = serviceManager.serviceClient().getDraftPackages()
            .createWithResponse(resourceGroupName, testBaseAccountName, draftPackageName, this.innerModel(), context)
            .getValue();
        return this;
    }
    ...
    public DraftPackageResource apply() {
        this.innerObject = serviceManager.serviceClient().getDraftPackages().updateWithResponse(resourceGroupName,
            testBaseAccountName, draftPackageName, updateParameters, Context.NONE).getValue();
        return this;
    }
    ...
    DraftPackageResourceImpl(DraftPackageResourceInner innerObject,
    ...
    public DraftPackageResource refresh() {
        this.innerObject = serviceManager.serviceClient().getDraftPackages()
            .getWithResponse(resourceGroupName, testBaseAccountName, draftPackageName, Context.NONE).getValue();
        return this;
    }

    public DraftPackageResource refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getDraftPackages()
            .getWithResponse(resourceGroupName, testBaseAccountName, draftPackageName, context).getValue();
        return this;
    }

    public Response<DraftPackageGetPathResponse> getPathWithResponse(Context context) {
        return serviceManager.draftPackages().getPathWithResponse(resourceGroupName, testBaseAccountName,
            draftPackageName, context);
    }
    ...
    public void copyFromPackage(CopyFromPackageOperationParameters parameters) {
        serviceManager.draftPackages().copyFromPackage(resourceGroupName, testBaseAccountName, draftPackageName,
            parameters);
    }
    ...
    public void extractFile(ExtractFileOperationParameters parameters) {
        serviceManager.draftPackages().extractFile(resourceGroupName, testBaseAccountName, draftPackageName,
            parameters);
    }

    public void extractFile(ExtractFileOperationParameters parameters, Context context) {
        serviceManager.draftPackages().extractFile(resourceGroupName, testBaseAccountName, draftPackageName, parameters,
            context);
    }

    public void generateFoldersAndScripts(GenerateOperationParameters parameters) {
        serviceManager.draftPackages().generateFoldersAndScripts(resourceGroupName, testBaseAccountName,
            draftPackageName, parameters);
    }
