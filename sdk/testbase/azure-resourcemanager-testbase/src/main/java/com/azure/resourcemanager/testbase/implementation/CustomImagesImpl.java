...
public final class CustomImagesImpl implements CustomImages {
    ...
    public CustomImagesImpl(
        CustomImagesClient innerClient, com.azure.resourcemanager.testbase.TestBaseManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public PagedIterable<CustomImageResource> listByTestBaseAccount(
    ...
    public Response<CustomImageResource> getWithResponse(
    ...
    public Response<VerificationResult> checkImageNameAvailabilityWithResponse(
        String resourceGroupName,
        String testBaseAccountName,
        ImageNameCheckAvailabilityParameters parameters,
        Context context) {
        Response<VerificationResultInner> inner =
            this
                .serviceClient()
    ...
    public VerificationResult checkImageNameAvailability(
