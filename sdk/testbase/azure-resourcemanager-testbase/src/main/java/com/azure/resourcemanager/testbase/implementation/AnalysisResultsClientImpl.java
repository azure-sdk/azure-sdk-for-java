...
public final class AnalysisResultsClientImpl implements AnalysisResultsClient {
    ...
    public interface AnalysisResultsService {
        ...
        @Get("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.TestBase/testBaseAccounts/{testBaseAccountName}/packages/{packageName}/testResults/{testResultName}/analysisResults")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<AnalysisResultListResult>> list(@HostParam("$host") String endpoint,
        ...
        @Headers({ "Content-Type: application/json" })
        @Get("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.TestBase/testBaseAccounts/{testBaseAccountName}/packages/{packageName}/testResults/{testResultName}/analysisResults/{analysisResultName}")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<AnalysisResultSingletonResourceInner>> get(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("testBaseAccountName") String testBaseAccountName, @PathParam("packageName") String packageName,
            @PathParam("testResultName") String testResultName,
    ...
    private Mono<PagedResponse<AnalysisResultSingletonResourceInner>> listSinglePageAsync(String resourceGroupName,
        String testBaseAccountName, String packageName, String testResultName, AnalysisResultType analysisResultType) {
        ...
        return FluxUtil
            ...
            .<PagedResponse<AnalysisResultSingletonResourceInner>>map(res -> new PagedResponseBase<>(res.getRequest(),
    ...
    private Mono<PagedResponse<AnalysisResultSingletonResourceInner>> listSinglePageAsync(String resourceGroupName,
        ...
        return service
            .list(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName, testBaseAccountName,
                packageName, testResultName, analysisResultType, this.client.getApiVersion(), accept, context)
    ...
    private PagedFlux<AnalysisResultSingletonResourceInner> listAsync(String resourceGroupName,
        String testBaseAccountName, String packageName, String testResultName, AnalysisResultType analysisResultType) {
        return new PagedFlux<>(() -> listSinglePageAsync(resourceGroupName, testBaseAccountName, packageName,
            testResultName, analysisResultType));
    }
    ...
    private PagedFlux<AnalysisResultSingletonResourceInner> listAsync(String resourceGroupName,
        ...
        Context context) {
        return new PagedFlux<>(() -> listSinglePageAsync(resourceGroupName, testBaseAccountName, packageName,
            testResultName, analysisResultType, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<AnalysisResultSingletonResourceInner> list(String resourceGroupName,
        String testBaseAccountName, String packageName, String testResultName, AnalysisResultType analysisResultType) {
    ...
    public PagedIterable<AnalysisResultSingletonResourceInner> list(String resourceGroupName,
        String testBaseAccountName, String packageName, String testResultName, AnalysisResultType analysisResultType,
        Context context) {
        return new PagedIterable<>(listAsync(resourceGroupName, testBaseAccountName, packageName, testResultName,
            analysisResultType, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<AnalysisResultSingletonResourceInner>> getWithResponseAsync(String resourceGroupName,
        String testBaseAccountName, String packageName, String testResultName, AnalysisResultName analysisResultName) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    private Mono<Response<AnalysisResultSingletonResourceInner>> getWithResponseAsync(String resourceGroupName,
        ...
        return service.get(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            testBaseAccountName, packageName, testResultName, analysisResultName, this.client.getApiVersion(), accept,
            context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<AnalysisResultSingletonResourceInner> getAsync(String resourceGroupName, String testBaseAccountName,
        String packageName, String testResultName, AnalysisResultName analysisResultName) {
        return getWithResponseAsync(resourceGroupName, testBaseAccountName, packageName, testResultName,
            analysisResultName).flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<AnalysisResultSingletonResourceInner> getWithResponse(String resourceGroupName,
        String testBaseAccountName, String packageName, String testResultName, AnalysisResultName analysisResultName,
        Context context) {
        return getWithResponseAsync(resourceGroupName, testBaseAccountName, packageName, testResultName,
            analysisResultName, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public AnalysisResultSingletonResourceInner get(String resourceGroupName, String testBaseAccountName,
        String packageName, String testResultName, AnalysisResultName analysisResultName) {
        return getWithResponse(resourceGroupName, testBaseAccountName, packageName, testResultName, analysisResultName,
