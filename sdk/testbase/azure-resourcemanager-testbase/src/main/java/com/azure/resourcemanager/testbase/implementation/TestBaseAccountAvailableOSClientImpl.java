...
public final class TestBaseAccountAvailableOSClientImpl implements TestBaseAccountAvailableOSClient {
    /** The proxy service used to perform REST calls. */
    private final TestBaseAccountAvailableOSService service;

    /** The service client containing this operation class. */
    private final RestApiForTestBaseImpl client;

    /**
     * Initializes an instance of TestBaseAccountAvailableOSClientImpl.
     *
     * @param client the instance of the service client containing this operation class.
     */
    TestBaseAccountAvailableOSClientImpl(RestApiForTestBaseImpl client) {
        this.service =
            RestProxy
                .create(
                    TestBaseAccountAvailableOSService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for RestApiForTestBaseTestBaseAccountAvailableOS to be used by the proxy
     * service to perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "RestApiForTestBaseTe")
    public interface TestBaseAccountAvailableOSService {
