...
public final class PackageResourceImpl implements PackageResource, PackageResource.Definition, PackageResource.Update {
    ...
    public String draftPackageId() {
        return this.innerModel().draftPackageId();
    }
    ...
    public PackageResource create() {
        this.innerObject = serviceManager.serviceClient().getPackages().create(resourceGroupName, testBaseAccountName,
            packageName, this.innerModel(), Context.NONE);
        return this;
    }

    public PackageResource create(Context context) {
        this.innerObject = serviceManager.serviceClient().getPackages().create(resourceGroupName, testBaseAccountName,
            packageName, this.innerModel(), context);
        return this;
    }
    ...
    public PackageResource apply() {
        this.innerObject = serviceManager.serviceClient().getPackages().update(resourceGroupName, testBaseAccountName,
            packageName, updateParameters, Context.NONE);
        return this;
    }

    public PackageResource apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getPackages().update(resourceGroupName, testBaseAccountName,
            packageName, updateParameters, context);
        return this;
    }

    PackageResourceImpl(PackageResourceInner innerObject,
    ...
    public PackageResource refresh() {
        this.innerObject = serviceManager.serviceClient().getPackages()
            .getWithResponse(resourceGroupName, testBaseAccountName, packageName, Context.NONE).getValue();
        return this;
    }

    public PackageResource refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getPackages()
            .getWithResponse(resourceGroupName, testBaseAccountName, packageName, context).getValue();
        return this;
    }
    ...
    public Response<DownloadUrlResponse> getDownloadUrlWithResponse(Context context) {
        return serviceManager.packages().getDownloadUrlWithResponse(resourceGroupName, testBaseAccountName, packageName,
            context);
    }
    ...
    public PackagesRunTestResponse runTestWithResponse(PackageRunTestParameters parameters, Context context) {
        return serviceManager.packages().runTestWithResponse(resourceGroupName, testBaseAccountName, packageName,
            parameters, context);
    }
    ...
    public PackageResourceImpl withDraftPackageId(String draftPackageId) {
        if (isInCreateMode()) {
            this.innerModel().withDraftPackageId(draftPackageId);
            return this;
        } else {
            this.updateParameters.withDraftPackageId(draftPackageId);
            return this;
        }
    }
    ...
    public PackageResourceImpl withInplaceUpgradeOSPair(InplaceUpgradeOSInfo inplaceUpgradeOSPair) {
        if (isInCreateMode()) {
    ...
    public PackageResourceImpl withFirstPartyApps(List<FirstPartyAppDefinition> firstPartyApps) {
        if (isInCreateMode()) {
    ...
    public PackageResourceImpl withIntuneEnrollmentMetadata(IntuneEnrollmentMetadata intuneEnrollmentMetadata) {
        if (isInCreateMode()) {
