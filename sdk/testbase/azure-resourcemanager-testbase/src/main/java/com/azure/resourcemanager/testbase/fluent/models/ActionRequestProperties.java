...
public final class ActionRequestProperties {
     ...
     */
    public ActionRequestProperties
        withPreReleaseAccessRequestSpec(PreReleaseAccessRequestSpec preReleaseAccessRequestSpec) {
    ...
    public void validate() {
        if (requestType() == null) {
            throw LOGGER.logExceptionAsError(
                new IllegalArgumentException("Missing required property requestType in model ActionRequestProperties"));
        }
