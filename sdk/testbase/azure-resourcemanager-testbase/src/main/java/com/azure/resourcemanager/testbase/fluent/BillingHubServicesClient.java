...
public interface BillingHubServicesClient {
    ...
    Response<BillingHubGetFreeHourBalanceResponseInner> getFreeHourBalanceWithResponse(String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<BillingHubGetUsageResponseInner> getUsageWithResponse(String resourceGroupName, String testBaseAccountName,
