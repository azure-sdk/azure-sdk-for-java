...
public final class FavoriteProcessProperties {
    /*
     * The actual name of the favorite process. It will be equal to resource name except for the scenario that the
     * process name contains characters that are not allowed in the resource name.
     */
    @JsonProperty(value = "actualProcessName", required = true)
    private String actualProcessName;

    /**
     * Creates an instance of FavoriteProcessProperties class.
     */
