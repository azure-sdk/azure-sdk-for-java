...
public final class FreeHourBalancesImpl implements FreeHourBalances {
    ...
    public FreeHourBalancesImpl(
        FreeHourBalancesClient innerClient, com.azure.resourcemanager.testbase.TestBaseManager serviceManager) {
    ...
    public PagedIterable<FreeHourBalanceResource> list(
    ...
    public Response<FreeHourBalanceResource> getWithResponse(
        String resourceGroupName,
        String testBaseAccountName,
        FreeHourBalanceName freeHourBalanceName,
        Context context) {
        Response<FreeHourBalanceResourceInner> inner =
            this.serviceClient().getWithResponse(resourceGroupName, testBaseAccountName, freeHourBalanceName, context);
        if (inner != null) {
    ...
    public FreeHourBalanceResource get(
