...
public final class CredentialsClientImpl implements CredentialsClient {
    ...
    public interface CredentialsService {
        ...
        Mono<Response<CredentialListResult>> listByTestBaseAccount(
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<CredentialResourceInner>> get(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("testBaseAccountName") String testBaseAccountName,
    ...
    private Mono<PagedResponse<CredentialResourceInner>> listByTestBaseAccountSinglePageAsync(
                ...
                context ->
                    service
                        .listByTestBaseAccount(
                            ...
                            accept,
                            context))
            .<PagedResponse<CredentialResourceInner>>map(
                res ->
    ...
    private PagedFlux<CredentialResourceInner> listByTestBaseAccountAsync(
        String resourceGroupName, String testBaseAccountName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<CredentialResourceInner> listByTestBaseAccount(
        String resourceGroupName, String testBaseAccountName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<CredentialResourceInner>> getWithResponseAsync(
        String resourceGroupName, String testBaseAccountName, String credentialName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<CredentialResourceInner> getAsync(
        String resourceGroupName, String testBaseAccountName, String credentialName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<CredentialResourceInner> getWithResponse(
        String resourceGroupName, String testBaseAccountName, String credentialName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<CredentialResourceInner>> listByTestBaseAccountNextSinglePageAsync(
