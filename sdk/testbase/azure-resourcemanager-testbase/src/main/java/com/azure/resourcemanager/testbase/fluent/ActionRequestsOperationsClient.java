...
public interface ActionRequestsOperationsClient {
    ...
    Response<ActionRequestInner> getWithResponse(String resourceGroupName, String testBaseAccountName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<ActionRequestInner> putWithResponse(String resourceGroupName, String testBaseAccountName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<Void> deleteWithResponse(String resourceGroupName, String testBaseAccountName, String actionRequestName,
        Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<ActionRequestInner> list(String resourceGroupName, String testBaseAccountName, String requestType,
