...
public final class TestSummaryProperties {
     ...
     */
    @JsonProperty(value = "inplaceUpgradesTestSummary")
    private OSUpdatesTestSummary inplaceUpgradesTestSummary;
    ...
    /**
     * Creates an instance of TestSummaryProperties class.
     */
    ...
    /**
     * Get the inplaceUpgradesTestSummary property: The result summary of tests triggered by in-place upgrades.
     * 
     * @return the inplaceUpgradesTestSummary value.
     */
    public OSUpdatesTestSummary inplaceUpgradesTestSummary() {
        return this.inplaceUpgradesTestSummary;
    }

    /**
     * Set the inplaceUpgradesTestSummary property: The result summary of tests triggered by in-place upgrades.
     * 
     * @param inplaceUpgradesTestSummary the inplaceUpgradesTestSummary value to set.
     * @return the TestSummaryProperties object itself.
     */
    public TestSummaryProperties withInplaceUpgradesTestSummary(OSUpdatesTestSummary inplaceUpgradesTestSummary) {
        this.inplaceUpgradesTestSummary = inplaceUpgradesTestSummary;
        return this;
    }
    ...
    public void validate() {
        ...
        if (inplaceUpgradesTestSummary() != null) {
            inplaceUpgradesTestSummary().validate();
        }
    }
}
