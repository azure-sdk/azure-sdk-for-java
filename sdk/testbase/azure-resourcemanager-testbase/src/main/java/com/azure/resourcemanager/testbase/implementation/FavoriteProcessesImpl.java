...
public final class FavoriteProcessesImpl implements FavoriteProcesses {
    ...
    public FavoriteProcessesImpl(FavoriteProcessesClient innerClient,
        com.azure.resourcemanager.testbase.TestBaseManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public PagedIterable<FavoriteProcessResource> list(String resourceGroupName, String testBaseAccountName,
        String packageName) {
    ...
    public Response<Void> deleteWithResponse(String resourceGroupName, String testBaseAccountName, String packageName,
        ...
        return this.serviceClient().deleteWithResponse(resourceGroupName, testBaseAccountName, packageName,
            favoriteProcessResourceName, context);
    }
    ...
    public Response<FavoriteProcessResource> getWithResponse(String resourceGroupName, String testBaseAccountName,
        String packageName, String favoriteProcessResourceName, Context context) {
        Response<FavoriteProcessResourceInner> inner = this.serviceClient().getWithResponse(resourceGroupName,
            testBaseAccountName, packageName, favoriteProcessResourceName, context);
        if (inner != null) {
    ...
    public FavoriteProcessResource get(String resourceGroupName, String testBaseAccountName, String packageName,
        String favoriteProcessResourceName) {
        FavoriteProcessResourceInner inner = this.serviceClient().get(resourceGroupName, testBaseAccountName,
            packageName, favoriteProcessResourceName);
        if (inner != null) {
    ...
    public FavoriteProcessResource getById(String id) {
        ...
        if (favoriteProcessResourceName == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
                String.format("The resource ID '%s' is not valid. Missing path segment 'favoriteProcesses'.", id)));
        }
        return this.getWithResponse(resourceGroupName, testBaseAccountName, packageName, favoriteProcessResourceName,
    ...
    public void deleteById(String id) {
        ...
        this.deleteWithResponse(resourceGroupName, testBaseAccountName, packageName, favoriteProcessResourceName,
            Context.NONE);
    }
    ...
    public Response<Void> deleteByIdWithResponse(String id, Context context) {
        ...
        return this.deleteWithResponse(resourceGroupName, testBaseAccountName, packageName, favoriteProcessResourceName,
            context);
    }
