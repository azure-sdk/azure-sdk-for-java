...
public final class ImageDefinitionsImpl implements ImageDefinitions {
    ...
    public ImageDefinitionsImpl(
        ImageDefinitionsClient innerClient, com.azure.resourcemanager.testbase.TestBaseManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public PagedIterable<ImageDefinitionResource> listByTestBaseAccount(
    ...
    public Response<ImageDefinitionResource> getWithResponse(
        String resourceGroupName, String testBaseAccountName, String imageDefinitionName, Context context) {
        Response<ImageDefinitionResourceInner> inner =
            this.serviceClient().getWithResponse(resourceGroupName, testBaseAccountName, imageDefinitionName, context);
        if (inner != null) {
    ...
    public ImageDefinitionResource get(
    ...
    public Response<Void> deleteWithResponse(
        ...
        return this
            .serviceClient()
            .deleteWithResponse(resourceGroupName, testBaseAccountName, imageDefinitionName, context);
    }
            ...
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException(
                        String
                            .format(
                                "The resource ID '%s' is not valid. Missing path segment 'imageDefinitions'.", id)));
        }
        return this
