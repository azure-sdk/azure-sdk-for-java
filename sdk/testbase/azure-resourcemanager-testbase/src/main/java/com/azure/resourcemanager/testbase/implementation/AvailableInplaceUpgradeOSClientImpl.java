...
public final class AvailableInplaceUpgradeOSClientImpl implements AvailableInplaceUpgradeOSClient {
    ...
    AvailableInplaceUpgradeOSClientImpl(TestBaseImpl client) {
        this.service =
            RestProxy
                .create(
                    AvailableInplaceUpgradeOSService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }
    ...
    public interface AvailableInplaceUpgradeOSService {
        ...
        Mono<Response<AvailableInplaceUpgradeOSListResult>> list(
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<AvailableInplaceUpgradeOSResourceInner>> get(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("testBaseAccountName") String testBaseAccountName,
    ...
    private Mono<PagedResponse<AvailableInplaceUpgradeOSResourceInner>> listSinglePageAsync(
                ...
                context ->
                    service
                        .list(
                            ...
                            accept,
                            context))
            .<PagedResponse<AvailableInplaceUpgradeOSResourceInner>>map(
                res ->
    ...
    private PagedFlux<AvailableInplaceUpgradeOSResourceInner> listAsync(
        String resourceGroupName, String testBaseAccountName, OsUpdateType osUpdateType) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<AvailableInplaceUpgradeOSResourceInner> list(
        String resourceGroupName, String testBaseAccountName, OsUpdateType osUpdateType) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<AvailableInplaceUpgradeOSResourceInner>> getWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<AvailableInplaceUpgradeOSResourceInner> getAsync(
        String resourceGroupName, String testBaseAccountName, String availableInplaceUpgradeOSResourceName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<AvailableInplaceUpgradeOSResourceInner> getWithResponse(
        String resourceGroupName,
        String testBaseAccountName,
        String availableInplaceUpgradeOSResourceName,
        Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public AvailableInplaceUpgradeOSResourceInner get(
        String resourceGroupName, String testBaseAccountName, String availableInplaceUpgradeOSResourceName) {
        return getWithResponse(
                resourceGroupName, testBaseAccountName, availableInplaceUpgradeOSResourceName, Context.NONE)
            .getValue();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<AvailableInplaceUpgradeOSResourceInner>> listNextSinglePageAsync(
