...
public final class ActionRequestsOperationsClientImpl implements ActionRequestsOperationsClient {
    ...
    public interface ActionRequestsOperationsService {
        ...
        Mono<Response<ActionRequestInner>> get(
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ActionRequests>> list(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("testBaseAccountName") String testBaseAccountName,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ActionRequests>> listNext(
    ...
    private Mono<Response<ActionRequestInner>> getWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ActionRequestInner> getAsync(
        String resourceGroupName, String testBaseAccountName, String actionRequestName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ActionRequestInner> getWithResponse(
        String resourceGroupName, String testBaseAccountName, String actionRequestName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<ActionRequestInner>> listSinglePageAsync(
                ...
                context ->
                    service
                        .list(
                            ...
                            accept,
                            context))
            .<PagedResponse<ActionRequestInner>>map(
                res ->
    ...
    private PagedFlux<ActionRequestInner> listAsync(
        String resourceGroupName, String testBaseAccountName, String requestType, Integer top) {
        return new PagedFlux<>(
            () -> listSinglePageAsync(resourceGroupName, testBaseAccountName, requestType, top),
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<ActionRequestInner> list(
        String resourceGroupName, String testBaseAccountName, String requestType, Integer top, Context context) {
