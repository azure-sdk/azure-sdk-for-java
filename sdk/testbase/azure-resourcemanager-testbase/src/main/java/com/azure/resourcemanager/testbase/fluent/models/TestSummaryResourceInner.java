...
public final class TestSummaryResourceInner extends ProxyResource {
    ...
    /**
     * Creates an instance of TestSummaryResourceInner class.
     */
    public TestSummaryResourceInner() {
    }
    ...
    public OSUpdatesTestSummary inplaceUpgradesTestSummary() {
        return this.innerProperties() == null ? null : this.innerProperties().inplaceUpgradesTestSummary();
    }
     ...
     * @return the TestSummaryResourceInner object itself.
     */
    public TestSummaryResourceInner withInplaceUpgradesTestSummary(OSUpdatesTestSummary inplaceUpgradesTestSummary) {
        if (this.innerProperties() == null) {
            this.innerProperties = new TestSummaryProperties();
        }
        this.innerProperties().withInplaceUpgradesTestSummary(inplaceUpgradesTestSummary);
        return this;
    }
