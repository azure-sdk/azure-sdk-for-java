...
public final class TestBaseAccountResourceImpl
    ...
    public TestBaseAccountResource create() {
        this.innerObject = serviceManager.serviceClient().getTestBaseAccounts().create(resourceGroupName,
            testBaseAccountName, this.innerModel(), createRestore, Context.NONE);
        return this;
    }

    public TestBaseAccountResource create(Context context) {
        this.innerObject = serviceManager.serviceClient().getTestBaseAccounts().create(resourceGroupName,
            testBaseAccountName, this.innerModel(), createRestore, context);
        return this;
    }
    ...
    public TestBaseAccountResource apply() {
        this.innerObject = serviceManager.serviceClient().getTestBaseAccounts().update(resourceGroupName,
            testBaseAccountName, updateParameters, Context.NONE);
        return this;
    }

    public TestBaseAccountResource apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getTestBaseAccounts().update(resourceGroupName,
            testBaseAccountName, updateParameters, context);
        return this;
    }

    TestBaseAccountResourceImpl(TestBaseAccountResourceInner innerObject,
    ...
    public TestBaseAccountResource refresh() {
        this.innerObject = serviceManager.serviceClient().getTestBaseAccounts()
            .getByResourceGroupWithResponse(resourceGroupName, testBaseAccountName, Context.NONE).getValue();
        return this;
    }

    public TestBaseAccountResource refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getTestBaseAccounts()
            .getByResourceGroupWithResponse(resourceGroupName, testBaseAccountName, context).getValue();
        return this;
    }
    ...
    public Response<FileUploadUrlResponse> getFileUploadUrlWithResponse(GetFileUploadUrlParameters parameters,
        Context context) {
        return serviceManager.testBaseAccounts().getFileUploadUrlWithResponse(resourceGroupName, testBaseAccountName,
            parameters, context);
    }
    ...
    public Response<CheckNameAvailabilityResult>
        checkPackageNameAvailabilityWithResponse(PackageCheckNameAvailabilityParameters parameters, Context context) {
        return serviceManager.testBaseAccounts().checkPackageNameAvailabilityWithResponse(resourceGroupName,
            testBaseAccountName, parameters, context);
    }

    public CheckNameAvailabilityResult checkPackageNameAvailability(PackageCheckNameAvailabilityParameters parameters) {
        return serviceManager.testBaseAccounts().checkPackageNameAvailability(resourceGroupName, testBaseAccountName,
            parameters);
    }
    ...
    public TestBaseAccountResourceImpl withIdentity(SystemAssignedServiceIdentity identity) {
        if (isInCreateMode()) {
