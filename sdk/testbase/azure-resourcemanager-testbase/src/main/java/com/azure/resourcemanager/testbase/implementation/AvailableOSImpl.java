...
public final class AvailableOSImpl implements AvailableOS {
    ...
    public AvailableOSImpl(AvailableOSClient innerClient,
        com.azure.resourcemanager.testbase.TestBaseManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public PagedIterable<AvailableOSResource> list(String resourceGroupName, String testBaseAccountName,
    ...
    public Response<AvailableOSResource> getWithResponse(String resourceGroupName, String testBaseAccountName,
        String availableOSResourceName, Context context) {
        Response<AvailableOSResourceInner> inner = this.serviceClient().getWithResponse(resourceGroupName,
            testBaseAccountName, availableOSResourceName, context);
        if (inner != null) {
    ...
    public AvailableOSResource get(String resourceGroupName, String testBaseAccountName,
