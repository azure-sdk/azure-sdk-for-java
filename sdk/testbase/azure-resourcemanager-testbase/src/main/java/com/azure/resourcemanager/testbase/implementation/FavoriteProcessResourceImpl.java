...
public final class FavoriteProcessResourceImpl implements FavoriteProcessResource, FavoriteProcessResource.Definition {
    ...
    FavoriteProcessResourceImpl(FavoriteProcessResourceInner innerObject,
    ...
    public FavoriteProcessResourceImpl withExistingPackage(String resourceGroupName, String testBaseAccountName,
        String packageName) {
    ...
    public FavoriteProcessResource create() {
        this.innerObject = serviceManager.serviceClient().getFavoriteProcesses().createWithResponse(resourceGroupName,
            testBaseAccountName, packageName, favoriteProcessResourceName, this.innerModel(), Context.NONE).getValue();
        return this;
    }

    public FavoriteProcessResource create(Context context) {
        this.innerObject = serviceManager.serviceClient().getFavoriteProcesses().createWithResponse(resourceGroupName,
            testBaseAccountName, packageName, favoriteProcessResourceName, this.innerModel(), context).getValue();
        return this;
    }
    ...
    public FavoriteProcessResource refresh() {
        this.innerObject = serviceManager.serviceClient().getFavoriteProcesses().getWithResponse(resourceGroupName,
            testBaseAccountName, packageName, favoriteProcessResourceName, Context.NONE).getValue();
        return this;
    }

    public FavoriteProcessResource refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getFavoriteProcesses()
