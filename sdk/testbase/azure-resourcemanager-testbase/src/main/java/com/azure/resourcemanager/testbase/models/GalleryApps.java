...
/**
 * Resource collection API of GalleryApps.
 */
public interface GalleryApps {
    /**
     ...
     */
    PagedIterable<GalleryAppResource> list(String resourceGroupName, String testBaseAccountName);
     ...
     * @return a list of currently available gallery applications as paginated response with {@link PagedIterable}.
     */
    PagedIterable<GalleryAppResource> list(String resourceGroupName, String testBaseAccountName, String keyword,
     ...
     */
    Response<GalleryAppResource> getWithResponse(String resourceGroupName, String testBaseAccountName,
     ...
     */
    GalleryAppResource get(String resourceGroupName, String testBaseAccountName, String galleryAppName);
}
