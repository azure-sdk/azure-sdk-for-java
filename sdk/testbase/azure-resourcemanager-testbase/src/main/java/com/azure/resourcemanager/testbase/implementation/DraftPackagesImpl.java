...
public final class DraftPackagesImpl implements DraftPackages {
    ...
    public DraftPackagesImpl(
        DraftPackagesClient innerClient, com.azure.resourcemanager.testbase.TestBaseManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public PagedIterable<DraftPackageResource> listByTestBaseAccount(
    ...
    public PagedIterable<DraftPackageResource> listByTestBaseAccount(
        ...
        PagedIterable<DraftPackageResourceInner> inner =
            this
                .serviceClient()
                .listByTestBaseAccount(resourceGroupName, testBaseAccountName, packageName, editPackage, context);
        return Utils.mapPage(inner, inner1 -> new DraftPackageResourceImpl(inner1, this.manager()));
    }
    ...
    public Response<Void> deleteWithResponse(
        ...
        return this
            .serviceClient()
            .deleteWithResponse(resourceGroupName, testBaseAccountName, draftPackageName, context);
    }
    ...
    public Response<DraftPackageResource> getWithResponse(
        String resourceGroupName, String testBaseAccountName, String draftPackageName, Context context) {
    ...
    public Response<DraftPackageGetPathResponse> getPathWithResponse(
        String resourceGroupName, String testBaseAccountName, String draftPackageName, Context context) {
        Response<DraftPackageGetPathResponseInner> inner =
            this.serviceClient().getPathWithResponse(resourceGroupName, testBaseAccountName, draftPackageName, context);
        if (inner != null) {
            return new SimpleResponse<>(
                inner.getRequest(),
                inner.getStatusCode(),
