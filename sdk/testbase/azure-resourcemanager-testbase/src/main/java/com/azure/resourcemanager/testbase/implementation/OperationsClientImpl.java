...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    OperationsClientImpl(TestBaseImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for TestBaseOperations to be used by the proxy service to perform REST
     * calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "TestBaseOperations")
     ...
     * @return a list of operations supported by the resource provider along with {@link PagedResponse} on successful
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a list of operations supported by the resource provider as paginated response with {@link PagedFlux}.
     */
