...
public final class FlightingRingsImpl implements FlightingRings {
    ...
    public FlightingRingsImpl(FlightingRingsClient innerClient,
    ...
    public Response<FlightingRingResource> getWithResponse(String resourceGroupName, String testBaseAccountName,
        String flightingRingResourceName, Context context) {
        Response<FlightingRingResourceInner> inner = this.serviceClient().getWithResponse(resourceGroupName,
            testBaseAccountName, flightingRingResourceName, context);
        if (inner != null) {
    ...
    public FlightingRingResource get(String resourceGroupName, String testBaseAccountName,
