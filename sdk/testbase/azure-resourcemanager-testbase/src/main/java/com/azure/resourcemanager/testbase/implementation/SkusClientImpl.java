...
public final class SkusClientImpl implements SkusClient {
     ...
     */
    SkusClientImpl(TestBaseImpl client) {
        this.service = RestProxy.create(SkusService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for TestBaseSkus to be used by the proxy service to perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "TestBaseSkus")
    public interface SkusService {
        @Headers({ "Content-Type: application/json" })
        @Get("/subscriptions/{subscriptionId}/providers/Microsoft.TestBase/skus")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<TestBaseAccountSkuListResult>> list(@HostParam("$host") String endpoint,
     ...
     * @return a list of Test Base Account SKUs along with {@link PagedResponse} on successful completion of
     * {@link Mono}.
     */
    ...
    private Mono<PagedResponse<TestBaseAccountSkuInner>> listSinglePageAsync() {
        ...
        return FluxUtil
            ...
            .<PagedResponse<TestBaseAccountSkuInner>>map(res -> new PagedResponseBase<>(res.getRequest(),
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a list of Test Base Account SKUs as paginated response with {@link PagedFlux}.
     */
