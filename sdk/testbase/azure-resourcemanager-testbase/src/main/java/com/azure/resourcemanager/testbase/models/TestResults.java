...
public interface TestResults {
     ...
     */
    PagedIterable<TestResultResource> list(String resourceGroupName, String testBaseAccountName, String packageName,
     ...
     */
    PagedIterable<TestResultResource> list(String resourceGroupName, String testBaseAccountName, String packageName,
        OsUpdateType osUpdateType, String filter, Context context);
     ...
     */
    Response<TestResultResource> getWithResponse(String resourceGroupName, String testBaseAccountName,
     ...
     */
    TestResultResource get(String resourceGroupName, String testBaseAccountName, String packageName,
     ...
     */
    Response<DownloadUrlResponse> getDownloadUrlWithResponse(String resourceGroupName, String testBaseAccountName,
        String packageName, String testResultName, Context context);
     ...
     */
    Response<DownloadUrlResponse> getVideoDownloadUrlWithResponse(String resourceGroupName, String testBaseAccountName,
        String packageName, String testResultName, Context context);
     ...
     */
    DownloadUrlResponse getVideoDownloadUrl(String resourceGroupName, String testBaseAccountName, String packageName,
        String testResultName);
     ...
     */
    Response<DownloadUrlResponse> getConsoleLogDownloadUrlWithResponse(String resourceGroupName,
     ...
     */
    DownloadUrlResponse getConsoleLogDownloadUrl(String resourceGroupName, String testBaseAccountName,
