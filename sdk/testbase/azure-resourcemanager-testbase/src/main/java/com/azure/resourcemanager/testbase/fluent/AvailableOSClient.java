...
public interface AvailableOSClient {
    ...
    PagedIterable<AvailableOSResourceInner> list(String resourceGroupName, String testBaseAccountName,
    ...
    Response<AvailableOSResourceInner> getWithResponse(String resourceGroupName, String testBaseAccountName,
