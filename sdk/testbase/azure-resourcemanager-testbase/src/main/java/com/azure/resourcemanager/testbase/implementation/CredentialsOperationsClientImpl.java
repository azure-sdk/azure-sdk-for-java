...
public final class CredentialsOperationsClientImpl implements CredentialsOperationsClient {
    ...
    CredentialsOperationsClientImpl(TestBaseImpl client) {
        this.service =
            RestProxy
                .create(CredentialsOperationsService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }
    ...
    public interface CredentialsOperationsService {
        ...
        Mono<Response<CredentialResourceInner>> create(
            ...
            @BodyParam("application/json") CredentialResourceInner parameters,
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<CredentialResourceInner>> update(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("testBaseAccountName") String testBaseAccountName,
    ...
    private Mono<Response<CredentialResourceInner>> createWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<CredentialResourceInner> createAsync(
        String resourceGroupName,
        String testBaseAccountName,
        String credentialName,
        CredentialResourceInner parameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<CredentialResourceInner> createWithResponse(
        String resourceGroupName,
        String testBaseAccountName,
        String credentialName,
        CredentialResourceInner parameters,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public CredentialResourceInner create(
        String resourceGroupName,
        String testBaseAccountName,
        String credentialName,
        CredentialResourceInner parameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<CredentialResourceInner>> updateWithResponseAsync(
        String resourceGroupName,
        String testBaseAccountName,
        String credentialName,
        CredentialResourceInner parameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<CredentialResourceInner> updateAsync(
        String resourceGroupName,
        String testBaseAccountName,
        String credentialName,
        CredentialResourceInner parameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<CredentialResourceInner> updateWithResponse(
        String resourceGroupName,
        String testBaseAccountName,
        String credentialName,
        CredentialResourceInner parameters,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public CredentialResourceInner update(
        String resourceGroupName,
        String testBaseAccountName,
        String credentialName,
        CredentialResourceInner parameters) {
