...
public final class CustomerEventsImpl implements CustomerEvents {
    ...
    public CustomerEventsImpl(CustomerEventsClient innerClient,
        com.azure.resourcemanager.testbase.TestBaseManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public PagedIterable<CustomerEventResource> listByTestBaseAccount(String resourceGroupName,
    ...
    public Response<CustomerEventResource> getWithResponse(String resourceGroupName, String testBaseAccountName,
    ...
    public CustomerEventResource getById(String id) {
        ...
        if (customerEventName == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
                String.format("The resource ID '%s' is not valid. Missing path segment 'customerEvents'.", id)));
        }
