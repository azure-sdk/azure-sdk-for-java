...
public interface TestBaseAccounts {
     ...
     * @return a list of Test Base Accounts as paginated response with {@link PagedIterable}.
     */
    PagedIterable<TestBaseAccountResource> listByResourceGroup(String resourceGroupName, Boolean getDeleted,
        Context context);
     ...
     */
    Response<TestBaseAccountResource> getByResourceGroupWithResponse(String resourceGroupName,
     ...
     */
    Response<FileUploadUrlResponse> getFileUploadUrlWithResponse(String resourceGroupName, String testBaseAccountName,
     ...
     */
    Response<CheckNameAvailabilityResult> checkPackageNameAvailabilityWithResponse(String resourceGroupName,
     ...
     */
    CheckNameAvailabilityResult checkPackageNameAvailability(String resourceGroupName, String testBaseAccountName,
