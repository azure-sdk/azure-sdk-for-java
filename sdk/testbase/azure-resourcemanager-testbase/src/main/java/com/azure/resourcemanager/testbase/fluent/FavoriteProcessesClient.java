...
public interface FavoriteProcessesClient {
    ...
    PagedIterable<FavoriteProcessResourceInner> list(String resourceGroupName, String testBaseAccountName,
        String packageName);
    ...
    Response<FavoriteProcessResourceInner> createWithResponse(String resourceGroupName, String testBaseAccountName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    FavoriteProcessResourceInner create(String resourceGroupName, String testBaseAccountName, String packageName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<Void> deleteWithResponse(String resourceGroupName, String testBaseAccountName, String packageName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<FavoriteProcessResourceInner> getWithResponse(String resourceGroupName, String testBaseAccountName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    FavoriteProcessResourceInner get(String resourceGroupName, String testBaseAccountName, String packageName,
        String favoriteProcessResourceName);
}
