...
public interface AnalysisResultsClient {
    ...
    PagedIterable<AnalysisResultSingletonResourceInner> list(String resourceGroupName, String testBaseAccountName,
    ...
    Response<AnalysisResultSingletonResourceInner> getWithResponse(String resourceGroupName, String testBaseAccountName,
        String packageName, String testResultName, AnalysisResultName analysisResultName, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    AnalysisResultSingletonResourceInner get(String resourceGroupName, String testBaseAccountName, String packageName,
