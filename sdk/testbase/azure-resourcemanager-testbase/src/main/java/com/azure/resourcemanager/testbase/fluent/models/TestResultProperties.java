...
import com.azure.resourcemanager.testbase.models.InplaceUpgradeProperties;
import com.azure.resourcemanager.testbase.models.TestResultAnalysisSummary;
import com.azure.resourcemanager.testbase.models.TestResultFirstPartyAppDefinition;
...
public final class TestResultProperties {
     ...
     */
    @JsonProperty(value = "inplaceUpgradeProperties")
    private InplaceUpgradeProperties inplaceUpgradeProperties;

    /*
     * The time when test starts.
     */
    @JsonProperty(value = "testStartTime")
    private OffsetDateTime testStartTime;

    /*
     * The time when test ends.
     */
    @JsonProperty(value = "testEndTime")
    private OffsetDateTime testEndTime;

    /*
     * The list of first party applications tested along with the package.
     */
    @JsonProperty(value = "firstPartyApps")
    private List<TestResultFirstPartyAppDefinition> firstPartyApps;

    /**
     * Creates an instance of TestResultProperties class.
     */
     ...
     * @return the TestResultProperties object itself.
     */
    public TestResultProperties withCustomImageId(String customImageId) {
     ...
     * @return the TestResultProperties object itself.
     */
    public TestResultProperties withCustomImageDisplayName(String customImageDisplayName) {
    ...
    /**
     * Get the inplaceUpgradeProperties property: Properties for inplace upgrade test.
     * 
     * @return the inplaceUpgradeProperties value.
     */
    public InplaceUpgradeProperties inplaceUpgradeProperties() {
        return this.inplaceUpgradeProperties;
    }

    /**
     * Set the inplaceUpgradeProperties property: Properties for inplace upgrade test.
     * 
     * @param inplaceUpgradeProperties the inplaceUpgradeProperties value to set.
     * @return the TestResultProperties object itself.
     */
    public TestResultProperties withInplaceUpgradeProperties(InplaceUpgradeProperties inplaceUpgradeProperties) {
        this.inplaceUpgradeProperties = inplaceUpgradeProperties;
        return this;
    }

    /**
     * Get the testStartTime property: The time when test starts.
     * 
     * @return the testStartTime value.
     */
    public OffsetDateTime testStartTime() {
        return this.testStartTime;
    }

    /**
     * Set the testStartTime property: The time when test starts.
     * 
     * @param testStartTime the testStartTime value to set.
     * @return the TestResultProperties object itself.
     */
    public TestResultProperties withTestStartTime(OffsetDateTime testStartTime) {
        this.testStartTime = testStartTime;
        return this;
    }

    /**
     * Get the testEndTime property: The time when test ends.
     * 
     * @return the testEndTime value.
     */
    public OffsetDateTime testEndTime() {
        return this.testEndTime;
    }

    /**
     * Set the testEndTime property: The time when test ends.
     * 
     * @param testEndTime the testEndTime value to set.
     * @return the TestResultProperties object itself.
     */
    public TestResultProperties withTestEndTime(OffsetDateTime testEndTime) {
        this.testEndTime = testEndTime;
        return this;
    }

    /**
     * Get the firstPartyApps property: The list of first party applications tested along with the package.
     * 
     * @return the firstPartyApps value.
     */
    public List<TestResultFirstPartyAppDefinition> firstPartyApps() {
        return this.firstPartyApps;
    }

    /**
     * Set the firstPartyApps property: The list of first party applications tested along with the package.
     * 
     * @param firstPartyApps the firstPartyApps value to set.
     * @return the TestResultProperties object itself.
     */
    public TestResultProperties withFirstPartyApps(List<TestResultFirstPartyAppDefinition> firstPartyApps) {
    ...
    public void validate() {
        ...
        if (inplaceUpgradeProperties() != null) {
            inplaceUpgradeProperties().validate();
        }
