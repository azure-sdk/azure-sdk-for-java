...
/**
 * The properties of the Test Base Draft Package.
 */
@Fluent
public final class DraftPackageProperties {
    /*
     * Application name
     */
     ...
     */
    @JsonProperty(value = "editPackage")
    ...
    /**
     * Creates an instance of DraftPackageProperties class.
     */
    public DraftPackageProperties() {
    }
     ...
     * @return the DraftPackageProperties object itself.
     */
    public DraftPackageProperties withApplicationName(String applicationName) {
     ...
     * @return the DraftPackageProperties object itself.
     */
    public DraftPackageProperties withVersion(String version) {
     ...
     * @return the DraftPackageProperties object itself.
     */
    public DraftPackageProperties withAppFileName(String appFileName) {
     ...
     * @return the DraftPackageProperties object itself.
     */
    public DraftPackageProperties withSourceType(DraftPackageSourceType sourceType) {
     ...
     * @return the DraftPackageProperties object itself.
     */
    public DraftPackageProperties withUseSample(Boolean useSample) {
     ...
     * @return the DraftPackageProperties object itself.
     */
    public DraftPackageProperties withComments(String comments) {
     ...
     * @return the DraftPackageProperties object itself.
     */
    public DraftPackageProperties withIntuneMetadata(DraftPackageIntuneAppMetadata intuneMetadata) {
     ...
     * @return the DraftPackageProperties object itself.
     */
    public DraftPackageProperties withHighlightedFiles(List<HighlightedFile> highlightedFiles) {
     ...
     * @return the DraftPackageProperties object itself.
     */
    public DraftPackageProperties withPackageTags(Map<String, String> packageTags) {
     ...
     * @return the DraftPackageProperties object itself.
     */
    public DraftPackageProperties withEditPackage(Boolean editPackage) {
     ...
     * @return the DraftPackageProperties object itself.
     */
    public DraftPackageProperties withPackageId(String packageId) {
     ...
     * @return the DraftPackageProperties object itself.
     */
    public DraftPackageProperties withUseAutofill(Boolean useAutofill) {
     ...
     * @return the DraftPackageProperties object itself.
     */
    public DraftPackageProperties withExecutableLaunchCommand(String executableLaunchCommand) {
     ...
     * @return the DraftPackageProperties object itself.
     */
    public DraftPackageProperties withProcessName(String processName) {
     ...
     * @return the DraftPackageProperties object itself.
     */
    public DraftPackageProperties withTabState(TabState tabState) {
     ...
     * @return the DraftPackageProperties object itself.
     */
    public DraftPackageProperties withTestTypes(List<TestType> testTypes) {
     ...
     * @return the DraftPackageProperties object itself.
     */
    public DraftPackageProperties withTargetOSList(List<TargetOSInfo> targetOSList) {
     ...
     * @return the DraftPackageProperties object itself.
     */
    public DraftPackageProperties withInplaceUpgradeOSPair(InplaceUpgradeOSInfo inplaceUpgradeOSPair) {
     ...
     * @return the DraftPackageProperties object itself.
     */
    public DraftPackageProperties withFlightingRing(String flightingRing) {
     ...
     * @return the DraftPackageProperties object itself.
     */
    public DraftPackageProperties withFirstPartyApps(List<FirstPartyAppDefinition> firstPartyApps) {
     ...
     * @return the DraftPackageProperties object itself.
     */
    public DraftPackageProperties withGalleryApps(List<GalleryAppDefinition> galleryApps) {
     ...
     * @return the DraftPackageProperties object itself.
     */
    public DraftPackageProperties withTests(List<Test> tests) {
        this.tests = tests;
        return this;
    }
     ...
     * @return the DraftPackageProperties object itself.
     */
    public DraftPackageProperties withIntuneEnrollmentMetadata(IntuneEnrollmentMetadata intuneEnrollmentMetadata) {
