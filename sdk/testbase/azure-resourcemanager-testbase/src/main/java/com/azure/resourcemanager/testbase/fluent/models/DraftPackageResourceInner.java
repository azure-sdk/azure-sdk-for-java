 ...
 */
@Fluent
public final class DraftPackageResourceInner extends ProxyResource {
    /*
     * Test Base Draft Package properties.
     */
    @JsonProperty(value = "properties")
    private DraftPackageProperties innerProperties;
    ...
    /**
     * Creates an instance of DraftPackageResourceInner class.
     */
    public DraftPackageResourceInner() {
    }
     ...
     * @return the DraftPackageResourceInner object itself.
     */
    public DraftPackageResourceInner withApplicationName(String applicationName) {
        if (this.innerProperties() == null) {
            this.innerProperties = new DraftPackageProperties();
        }
     ...
     * @return the DraftPackageResourceInner object itself.
     */
    public DraftPackageResourceInner withVersion(String version) {
        if (this.innerProperties() == null) {
            this.innerProperties = new DraftPackageProperties();
        }
    ...
    public String draftPackagePath() {
        return this.innerProperties() == null ? null : this.innerProperties().draftPackagePath();
    }

    /**
     * Get the workingPath property: The relative path for a temporarily folder for package creation work.
     * 
     * @return the workingPath value.
     */
    public String workingPath() {
        return this.innerProperties() == null ? null : this.innerProperties().workingPath();
    }
     ...
     * @return the DraftPackageResourceInner object itself.
     */
    public DraftPackageResourceInner withAppFileName(String appFileName) {
        if (this.innerProperties() == null) {
            this.innerProperties = new DraftPackageProperties();
        }
     ...
     * @return the DraftPackageResourceInner object itself.
     */
    public DraftPackageResourceInner withSourceType(DraftPackageSourceType sourceType) {
        if (this.innerProperties() == null) {
            this.innerProperties = new DraftPackageProperties();
        }
     ...
     * @return the DraftPackageResourceInner object itself.
     */
    public DraftPackageResourceInner withUseSample(Boolean useSample) {
        if (this.innerProperties() == null) {
            this.innerProperties = new DraftPackageProperties();
        }
     ...
     * @return the DraftPackageResourceInner object itself.
     */
    public DraftPackageResourceInner withComments(String comments) {
        if (this.innerProperties() == null) {
            this.innerProperties = new DraftPackageProperties();
        }
     ...
     * @return the DraftPackageResourceInner object itself.
     */
    public DraftPackageResourceInner withIntuneMetadata(DraftPackageIntuneAppMetadata intuneMetadata) {
        if (this.innerProperties() == null) {
            this.innerProperties = new DraftPackageProperties();
        }
     ...
     * @return the DraftPackageResourceInner object itself.
     */
    public DraftPackageResourceInner withHighlightedFiles(List<HighlightedFile> highlightedFiles) {
        if (this.innerProperties() == null) {
            this.innerProperties = new DraftPackageProperties();
        }
     ...
     * @return the DraftPackageResourceInner object itself.
     */
    public DraftPackageResourceInner withPackageTags(Map<String, String> packageTags) {
        if (this.innerProperties() == null) {
            this.innerProperties = new DraftPackageProperties();
        }
    ...
    /**
     * Get the editPackage property: Specifies whether this draft package is used to edit a package.
     * 
     * @return the editPackage value.
     */
    public Boolean editPackage() {
        return this.innerProperties() == null ? null : this.innerProperties().editPackage();
    }

    /**
     * Set the editPackage property: Specifies whether this draft package is used to edit a package.
     * 
     * @param editPackage the editPackage value to set.
     * @return the DraftPackageResourceInner object itself.
     */
    public DraftPackageResourceInner withEditPackage(Boolean editPackage) {
        if (this.innerProperties() == null) {
            this.innerProperties = new DraftPackageProperties();
        }
        this.innerProperties().withEditPackage(editPackage);
        return this;
    }
     ...
     * @return the DraftPackageResourceInner object itself.
     */
    public DraftPackageResourceInner withPackageId(String packageId) {
        if (this.innerProperties() == null) {
            this.innerProperties = new DraftPackageProperties();
        }
     ...
     * @return the DraftPackageResourceInner object itself.
     */
    public DraftPackageResourceInner withUseAutofill(Boolean useAutofill) {
        if (this.innerProperties() == null) {
            this.innerProperties = new DraftPackageProperties();
        }
    ...
    /**
     * Get the executableLaunchCommand property: The executable launch command for script auto-fill. Will be used to
     * run the application.
     * 
    ...
    /**
     * Set the executableLaunchCommand property: The executable launch command for script auto-fill. Will be used to
     * run the application.
     * 
     * @param executableLaunchCommand the executableLaunchCommand value to set.
     * @return the DraftPackageResourceInner object itself.
     */
    public DraftPackageResourceInner withExecutableLaunchCommand(String executableLaunchCommand) {
        if (this.innerProperties() == null) {
            this.innerProperties = new DraftPackageProperties();
        }
     ...
     * @return the DraftPackageResourceInner object itself.
     */
    public DraftPackageResourceInner withProcessName(String processName) {
        if (this.innerProperties() == null) {
            this.innerProperties = new DraftPackageProperties();
        }
     ...
     * @return the DraftPackageResourceInner object itself.
     */
    public DraftPackageResourceInner withTabState(TabState tabState) {
        if (this.innerProperties() == null) {
            this.innerProperties = new DraftPackageProperties();
        }
     ...
     * @return the DraftPackageResourceInner object itself.
     */
    public DraftPackageResourceInner withTestTypes(List<TestType> testTypes) {
        if (this.innerProperties() == null) {
            this.innerProperties = new DraftPackageProperties();
        }
     ...
     * @return the DraftPackageResourceInner object itself.
     */
    public DraftPackageResourceInner withTargetOSList(List<TargetOSInfo> targetOSList) {
        if (this.innerProperties() == null) {
            this.innerProperties = new DraftPackageProperties();
        }
     ...
     * @return the DraftPackageResourceInner object itself.
     */
    public DraftPackageResourceInner withInplaceUpgradeOSPair(InplaceUpgradeOSInfo inplaceUpgradeOSPair) {
        if (this.innerProperties() == null) {
            this.innerProperties = new DraftPackageProperties();
        }
     ...
     * @return the DraftPackageResourceInner object itself.
     */
    public DraftPackageResourceInner withFlightingRing(String flightingRing) {
        if (this.innerProperties() == null) {
            this.innerProperties = new DraftPackageProperties();
        }
     ...
     * @return the DraftPackageResourceInner object itself.
     */
    public DraftPackageResourceInner withFirstPartyApps(List<FirstPartyAppDefinition> firstPartyApps) {
        if (this.innerProperties() == null) {
            this.innerProperties = new DraftPackageProperties();
        }
     ...
     * @return the DraftPackageResourceInner object itself.
     */
    public DraftPackageResourceInner withGalleryApps(List<GalleryAppDefinition> galleryApps) {
        if (this.innerProperties() == null) {
            this.innerProperties = new DraftPackageProperties();
        }
     ...
     * @return the DraftPackageResourceInner object itself.
     */
    public DraftPackageResourceInner withTests(List<Test> tests) {
        if (this.innerProperties() == null) {
            this.innerProperties = new DraftPackageProperties();
        }
     ...
     * @return the DraftPackageResourceInner object itself.
     */
    public DraftPackageResourceInner withIntuneEnrollmentMetadata(IntuneEnrollmentMetadata intuneEnrollmentMetadata) {
        if (this.innerProperties() == null) {
            this.innerProperties = new DraftPackageProperties();
        }
