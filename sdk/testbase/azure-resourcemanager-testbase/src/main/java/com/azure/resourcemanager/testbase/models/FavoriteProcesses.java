...
public interface FavoriteProcesses {
     ...
     */
    PagedIterable<FavoriteProcessResource> list(String resourceGroupName, String testBaseAccountName,
        String packageName);
     ...
     */
    Response<FavoriteProcessResource> getWithResponse(String resourceGroupName, String testBaseAccountName,
     ...
     */
    FavoriteProcessResource get(String resourceGroupName, String testBaseAccountName, String packageName,
        String favoriteProcessResourceName);
