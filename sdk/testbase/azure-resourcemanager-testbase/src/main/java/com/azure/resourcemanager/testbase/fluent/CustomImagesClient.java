...
public interface CustomImagesClient {
    ...
    SyncPoller<PollResult<CustomImageResourceInner>, CustomImageResourceInner> beginCreate(String resourceGroupName,
    ...
    CustomImageResourceInner create(String resourceGroupName, String testBaseAccountName, String customImageName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<CustomImageResourceInner> getWithResponse(String resourceGroupName, String testBaseAccountName,
        String customImageName, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<VerificationResultInner> checkImageNameAvailabilityWithResponse(String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    VerificationResultInner checkImageNameAvailability(String resourceGroupName, String testBaseAccountName,
