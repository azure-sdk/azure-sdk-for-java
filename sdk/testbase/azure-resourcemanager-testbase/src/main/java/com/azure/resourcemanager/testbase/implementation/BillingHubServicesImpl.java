...
public final class BillingHubServicesImpl implements BillingHubServices {
    ...
    public BillingHubServicesImpl(BillingHubServicesClient innerClient,
        com.azure.resourcemanager.testbase.TestBaseManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public Response<BillingHubGetFreeHourBalanceResponse> getFreeHourBalanceWithResponse(String resourceGroupName,
    ...
    public BillingHubGetFreeHourBalanceResponse getFreeHourBalance(String resourceGroupName,
    ...
    public Response<BillingHubGetUsageResponse> getUsageWithResponse(String resourceGroupName,
        String testBaseAccountName, BillingHubGetUsageRequest getUsageRequest, Context context) {
        Response<BillingHubGetUsageResponseInner> inner = this.serviceClient().getUsageWithResponse(resourceGroupName,
            testBaseAccountName, getUsageRequest, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
