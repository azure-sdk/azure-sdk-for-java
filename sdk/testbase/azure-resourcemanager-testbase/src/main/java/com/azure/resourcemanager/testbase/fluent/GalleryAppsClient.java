...
public interface GalleryAppsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<GalleryAppResourceInner> list(String resourceGroupName, String testBaseAccountName, String keyword,
    ...
    Response<GalleryAppResourceInner> getWithResponse(String resourceGroupName, String testBaseAccountName,
