...
public final class VHDsListByTestBaseAccountSamples {
    /*
     * x-ms-original-file:
     * specification/testbase/resource-manager/Microsoft.TestBase/preview/2023-11-01-preview/examples/VHDsList.json
     */
    /**
    ...
    public static void vHDsList(com.azure.resourcemanager.testbase.TestBaseManager manager) {
        manager.vHDs().listByTestBaseAccount("contoso-rg1", "contoso-testBaseAccount1",
