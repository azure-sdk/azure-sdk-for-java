...
public final class GalleryAppsListSamples {
    /*
     * x-ms-original-file:
     * specification/testbase/resource-manager/Microsoft.TestBase/preview/2023-11-01-preview/examples/GalleryAppsList.
     * json
     */
    /**
    ...
    public static void galleryAppsList(com.azure.resourcemanager.testbase.TestBaseManager manager) {
        manager.galleryApps().list("contoso-rg", "contoso-testBaseAccount", "office", ApplicationType.WINGET,
            OrderBy.RELEVANCE, 2, com.azure.core.util.Context.NONE);
    }
}
