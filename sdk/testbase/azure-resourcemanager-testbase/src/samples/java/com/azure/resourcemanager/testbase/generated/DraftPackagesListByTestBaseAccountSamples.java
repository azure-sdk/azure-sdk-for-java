...
public final class DraftPackagesListByTestBaseAccountSamples {
    /*
     * x-ms-original-file:
     * specification/testbase/resource-manager/Microsoft.TestBase/preview/2023-11-01-preview/examples/DraftPackagesList.
     * json
     */
    /**
    ...
    public static void draftPackagesList(com.azure.resourcemanager.testbase.TestBaseManager manager) {
        manager.draftPackages().listByTestBaseAccount("contoso-rg", "contoso-testBaseAccount", null, null,
