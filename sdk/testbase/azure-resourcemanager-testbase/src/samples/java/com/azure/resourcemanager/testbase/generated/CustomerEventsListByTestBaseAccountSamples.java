...
public final class CustomerEventsListByTestBaseAccountSamples {
    /*
     * x-ms-original-file:
     * specification/testbase/resource-manager/Microsoft.TestBase/preview/2022-04-01-preview/examples/CustomerEventsList
     * .json
     */
    /**
    ...
    public static void customerEventsList(com.azure.resourcemanager.testbase.TestBaseManager manager) {
        manager.customerEvents().listByTestBaseAccount("contoso-rg1", "contoso-testBaseAccount1",
