...
public final class PackagesRunTestSamples {
    /*
     * x-ms-original-file:
     * specification/testbase/resource-manager/Microsoft.TestBase/preview/2023-11-01-preview/examples/PackageRunTest.
     * json
     */
    /**
    ...
    public static void packageRunTest(com.azure.resourcemanager.testbase.TestBaseManager manager) {
        manager.packages().runTestWithResponse("contoso-rg1", "contoso-testBaseAccount1", "contoso-package2",
            new PackageRunTestParameters().withTestType(TestType.OUT_OF_BOX_TEST)
                .withOsUpdateType(OsUpdateType.SECURITY_UPDATE).withOsName("Windows 10 21H1")
