...
public final class TestResultsGetDownloadUrlSamples {
    ...
    public static void testResultGetDownloadURL(com.azure.resourcemanager.testbase.TestBaseManager manager) {
        manager.testResults().getDownloadUrlWithResponse("contoso-rg1", "contoso-testBaseAccount1", "contoso-package2",
            "Windows-10-1909-99b1f80d-03a9-4148-997f-806ba5bac8e0", com.azure.core.util.Context.NONE);
    }
}
