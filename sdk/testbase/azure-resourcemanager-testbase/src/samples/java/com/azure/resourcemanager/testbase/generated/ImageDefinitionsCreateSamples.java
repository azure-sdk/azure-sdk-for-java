...
public final class ImageDefinitionsCreateSamples {
    ...
    public static void imageDefinitionCreate(com.azure.resourcemanager.testbase.TestBaseManager manager) {
        manager.imageDefinitions().define("contoso-image-def")
            .withExistingTestBaseAccount("contoso-rg1", "contoso-testBaseAccount1")
            .withArchitecture(ImageArchitecture.X64).withOsState(ImageOSState.GENERALIZED)
            .withSecurityType(ImageSecurityType.STANDARD).create();
    }
}
