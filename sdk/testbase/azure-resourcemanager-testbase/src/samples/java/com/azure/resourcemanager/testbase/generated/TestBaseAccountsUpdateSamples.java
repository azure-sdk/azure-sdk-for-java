...
public final class TestBaseAccountsUpdateSamples {
    ...
    public static void testBaseAccountUpdate(com.azure.resourcemanager.testbase.TestBaseManager manager) {
        TestBaseAccountResource resource = manager.testBaseAccounts()
            .getByResourceGroupWithResponse("contoso-rg1", "contoso-testBaseAccount1", com.azure.core.util.Context.NONE)
            .getValue();
