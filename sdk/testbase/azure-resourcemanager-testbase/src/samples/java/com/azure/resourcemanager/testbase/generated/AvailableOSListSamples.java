...
public final class AvailableOSListSamples {
    /*
     * x-ms-original-file:
     * specification/testbase/resource-manager/Microsoft.TestBase/preview/2022-04-01-preview/examples/AvailableOSsList.
     * json
     */
    /**
    ...
    public static void availableOSsList(com.azure.resourcemanager.testbase.TestBaseManager manager) {
        manager.availableOS().list("contoso-rg", "contoso-testBaseAccount", OsUpdateType.SECURITY_UPDATE,
