...
public final class CustomImagesGetSamples {
    /*
     * x-ms-original-file:
     * specification/testbase/resource-manager/Microsoft.TestBase/preview/2023-11-01-preview/examples/CustomImageGet.
     * json
     */
    /**
    ...
    public static void customImageGet(com.azure.resourcemanager.testbase.TestBaseManager manager) {
        manager.customImages().getWithResponse("contoso-rg1", "contoso-testBaseAccount1",
            "image-2cfb2edc-13bc-4d54-8d6e-38b2a233b003", com.azure.core.util.Context.NONE);
    }
}
