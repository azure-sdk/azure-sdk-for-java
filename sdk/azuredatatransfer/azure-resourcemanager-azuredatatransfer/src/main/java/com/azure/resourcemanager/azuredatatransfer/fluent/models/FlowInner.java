    ...
    public void validate() {
        ...
        if (location() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Missing required property location in model FlowInner"));
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(FlowInner.class);
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("id".equals(fieldName)) {
                    ...
                    deserializedFlowInner.properties = FlowProperties.fromJson(reader);
