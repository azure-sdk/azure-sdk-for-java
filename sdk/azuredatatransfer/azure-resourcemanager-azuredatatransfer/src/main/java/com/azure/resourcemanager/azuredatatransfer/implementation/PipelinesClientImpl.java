...
public final class PipelinesClientImpl implements PipelinesClient {
    ...
    public interface PipelinesService {
        ...
        Mono<Response<Flux<ByteBuffer>>> executeAction(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("pipelineName") String pipelineName,
            @QueryParam("api-version") String apiVersion, @BodyParam("application/json") Action action,
            @HeaderParam("Accept") String accept, Context context);
    ...
    private PollerFlux<PollResult<PipelineInner>, PipelineInner> beginCreateOrUpdateAsync(String resourceGroupName,
        ...
        return this.client.<PipelineInner, PipelineInner>getLroResult(mono, this.client.getHttpPipeline(),
            PipelineInner.class, PipelineInner.class, context);
    }
    ...
    private Mono<PipelineInner> createOrUpdateAsync(String resourceGroupName, String pipelineName,
        ...
        return beginCreateOrUpdateAsync(resourceGroupName, pipelineName, pipeline, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String pipelineName, Context context) {
        return beginDeleteAsync(resourceGroupName, pipelineName, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<PipelineInner> updateAsync(String resourceGroupName, String pipelineName, PipelinesPatch pipeline,
        Context context) {
        return beginUpdateAsync(resourceGroupName, pipelineName, pipeline, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> approveConnectionWithResponseAsync(String resourceGroupName,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.approveConnection(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            pipelineName, this.client.getApiVersion(), connection, accept, context);
    }
    ...
    private Mono<ConnectionInner> approveConnectionAsync(String resourceGroupName, String pipelineName,
        ...
        return beginApproveConnectionAsync(resourceGroupName, pipelineName, connection, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> rejectConnectionWithResponseAsync(String resourceGroupName,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.rejectConnection(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            pipelineName, this.client.getApiVersion(), connection, accept, context);
    }
    ...
    private Mono<ConnectionInner> rejectConnectionAsync(String resourceGroupName, String pipelineName,
        ResourceBody connection, Context context) {
        return beginRejectConnectionAsync(resourceGroupName, pipelineName, connection, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> executeActionWithResponseAsync(String resourceGroupName,
        String pipelineName, Action action) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.executeAction(this.client.getEndpoint(), this.client.getSubscriptionId(),
                resourceGroupName, pipelineName, this.client.getApiVersion(), action, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> executeActionWithResponseAsync(String resourceGroupName,
        String pipelineName, Action action, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.executeAction(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            pipelineName, this.client.getApiVersion(), action, accept, context);
    }
    ...
    private PollerFlux<PollResult<PipelineInner>, PipelineInner> beginExecuteActionAsync(String resourceGroupName,
        String pipelineName, Action action) {
        Mono<Response<Flux<ByteBuffer>>> mono = executeActionWithResponseAsync(resourceGroupName, pipelineName, action);
        return this.client.<PipelineInner, PipelineInner>getLroResult(mono, this.client.getHttpPipeline(),
            PipelineInner.class, PipelineInner.class, this.client.getContext());
    }
    ...
    private PollerFlux<PollResult<PipelineInner>, PipelineInner> beginExecuteActionAsync(String resourceGroupName,
        ...
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono
            = executeActionWithResponseAsync(resourceGroupName, pipelineName, action, context);
        return this.client.<PipelineInner, PipelineInner>getLroResult(mono, this.client.getHttpPipeline(),
            PipelineInner.class, PipelineInner.class, context);
    }
    ...
    public SyncPoller<PollResult<PipelineInner>, PipelineInner> beginExecuteAction(String resourceGroupName,
        String pipelineName, Action action) {
        return this.beginExecuteActionAsync(resourceGroupName, pipelineName, action).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<PipelineInner>, PipelineInner> beginExecuteAction(String resourceGroupName,
        String pipelineName, Action action, Context context) {
        return this.beginExecuteActionAsync(resourceGroupName, pipelineName, action, context).getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PipelineInner> executeActionAsync(String resourceGroupName, String pipelineName, Action action) {
        return beginExecuteActionAsync(resourceGroupName, pipelineName, action).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<PipelineInner> executeActionAsync(String resourceGroupName, String pipelineName, Action action,
        Context context) {
        return beginExecuteActionAsync(resourceGroupName, pipelineName, action, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public PipelineInner executeAction(String resourceGroupName, String pipelineName, Action action) {
        return executeActionAsync(resourceGroupName, pipelineName, action).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public PipelineInner executeAction(String resourceGroupName, String pipelineName, Action action, Context context) {
        return executeActionAsync(resourceGroupName, pipelineName, action, context).block();
    }
