...
/**
 * An instance of this class provides access to all the operations defined in ListFlowsByPipelinesClient.
 */
public final class ListFlowsByPipelinesClientImpl implements ListFlowsByPipelinesClient {
    /**
     * The proxy service used to perform REST calls.
     */
    private final ListFlowsByPipelinesService service;
    ...
    /**
     * Initializes an instance of ListFlowsByPipelinesClientImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    ListFlowsByPipelinesClientImpl(AzuredatatransferrpImpl client) {
        this.service = RestProxy.create(ListFlowsByPipelinesService.class, client.getHttpPipeline(),
            client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for AzuredatatransferrpListFlowsByPipelines to be used by the proxy
     * service to perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "AzuredatatransferrpL")
    public interface ListFlowsByPipelinesService {
        ...
        Mono<Response<ListFlowsByPipelineResultInner>> list(@HostParam("$host") String endpoint,
            ...
            @QueryParam("api-version") String apiVersion, @BodyParam("application/json") ConnectionIdList connections,
    ...
    private Mono<Response<ListFlowsByPipelineResultInner>> listWithResponseAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(context -> service.list(this.client.getEndpoint(), this.client.getSubscriptionId(),
                resourceGroupName, pipelineName, this.client.getApiVersion(), connections, accept, context))
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ListFlowsByPipelineResultInner>> listWithResponseAsync(String resourceGroupName,
        String pipelineName, ConnectionIdList connections, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service.list(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName, pipelineName,
            this.client.getApiVersion(), connections, accept, context);
    }
    ...
    public Response<ListFlowsByPipelineResultInner> listWithResponse(String resourceGroupName, String pipelineName,
        ...
        return listWithResponseAsync(resourceGroupName, pipelineName, connections, context).block();
    }
