...
public interface PipelinesClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<ConnectionInner>, ConnectionInner> beginApproveConnection(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ConnectionInner approveConnection(
        String resourceGroupName, String pipelineName, ResourceBody connection, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<ConnectionInner>, ConnectionInner> beginRejectConnection(
        String resourceGroupName, String pipelineName, ResourceBody connection);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ConnectionInner rejectConnection(
        String resourceGroupName, String pipelineName, ResourceBody connection, Context context);
