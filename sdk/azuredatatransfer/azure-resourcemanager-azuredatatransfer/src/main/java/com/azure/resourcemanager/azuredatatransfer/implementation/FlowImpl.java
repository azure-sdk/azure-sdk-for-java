...
public final class FlowImpl implements Flow, Flow.Definition, Flow.Update {
    ...
    public Flow create() {
        this.innerObject = serviceManager.serviceClient().getFlows().createOrUpdate(resourceGroupName, connectionName,
            flowName, this.innerModel(), Context.NONE);
        return this;
    }

    public Flow create(Context context) {
        this.innerObject = serviceManager.serviceClient().getFlows().createOrUpdate(resourceGroupName, connectionName,
            flowName, this.innerModel(), context);
        return this;
    }
    ...
    public Flow apply() {
        this.innerObject = serviceManager.serviceClient().getFlows().update(resourceGroupName, connectionName, flowName,
            updateFlow, Context.NONE);
        return this;
    }
    ...
    public Flow refresh() {
        this.innerObject = serviceManager.serviceClient().getFlows()
            .getWithResponse(resourceGroupName, connectionName, flowName, Context.NONE).getValue();
        return this;
    }

    public Flow refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getFlows()
            .getWithResponse(resourceGroupName, connectionName, flowName, context).getValue();
        return this;
    }
