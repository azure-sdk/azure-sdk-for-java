...
public interface Pipeline {
    ...
    /**
     * Gets the properties property: Properties of pipeline.
     * 
    ...
    /**
     * Gets the identity property: The managed identity of the pipeline resource, if configured.
     * 
    ...
    /**
     * Gets the inner com.azure.resourcemanager.azuredatatransfer.fluent.models.PipelineInner object.
     * 
    ...
    interface DefinitionStages {
        ...
        /**
         * The stage of the Pipeline definition allowing to specify properties.
         */
        interface WithProperties {
            /**
             * Specifies the properties property: Properties of pipeline.
             * 
             * @param properties Properties of pipeline.
             * @return the next definition stage.
             */
            WithCreate withProperties(PipelineProperties properties);
        }

        /**
         * The stage of the Pipeline definition allowing to specify identity.
         */
        interface WithIdentity {
            /**
             * Specifies the identity property: The managed identity of the pipeline resource, if configured..
             * 
             * @param identity The managed identity of the pipeline resource, if configured.
             * @return the next definition stage.
             */
    ...
    interface UpdateStages {
        ...
        /**
         * The stage of the Pipeline update allowing to specify properties.
         */
        interface WithProperties {
            /**
             * Specifies the properties property: Properties of pipelines patch body..
             * 
             * @param properties Properties of pipelines patch body.
             * @return the next definition stage.
             */
            Update withProperties(PipelinesPatchProperties properties);
        }

        /**
         * The stage of the Pipeline update allowing to specify identity.
         */
        interface WithIdentity {
            /**
             * Specifies the identity property: The managed identity of the pipeline resource, if configured..
     ...
     */
    Connection approveConnection(ResourceBody connection);
     ...
     * @return the connection resource definition.
     */
    Connection approveConnection(ResourceBody connection, Context context);
     ...
     * @return the connection resource definition.
     */
    Connection rejectConnection(ResourceBody connection);
     ...
     * @return the connection resource definition.
     */
    Connection rejectConnection(ResourceBody connection, Context context);
}
