...
import com.azure.resourcemanager.azuredatatransfer.models.OperationListResult;
...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    OperationsClientImpl(AzuredatatransferrpImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for AzuredatatransferrpOperations to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "AzuredatatransferrpO")
    ...
    /**
     * Lists all of the available Microsoft.AzureDataTransfer REST API operations.
     * 
