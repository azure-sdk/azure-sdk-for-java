...
public final class AzuredatatransferrpImpl implements Azuredatatransferrp {
    ...
    /**
     * The ListPendingConnectionsClient object to access its operations.
     */
    private final ListPendingConnectionsClient listPendingConnections;
     ...
     */
    public ListPendingConnectionsClient getListPendingConnections() {
        return this.listPendingConnections;
    }

    /**
     * The ListPendingFlowsClient object to access its operations.
     */
    private final ListPendingFlowsClient listPendingFlows;
     ...
     */
    public ListPendingFlowsClient getListPendingFlows() {
        return this.listPendingFlows;
    }
    ...
    /**
     * The ListSchemasClient object to access its operations.
     */
    private final ListSchemasClient listSchemas;
     ...
     */
    public ListSchemasClient getListSchemas() {
        return this.listSchemas;
    }

    /**
     * The ListFlowsByPipelinesClient object to access its operations.
     */
    private final ListFlowsByPipelinesClient listFlowsByPipelines;

    /**
     * Gets the ListFlowsByPipelinesClient object to access its operations.
     * 
     * @return the ListFlowsByPipelinesClient object.
     */
    public ListFlowsByPipelinesClient getListFlowsByPipelines() {
        return this.listFlowsByPipelines;
    }
    ...
    AzuredatatransferrpImpl(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter,
        ...
        this.listPendingConnections = new ListPendingConnectionsClientImpl(this);
        this.listPendingFlows = new ListPendingFlowsClientImpl(this);
        this.pipelines = new PipelinesClientImpl(this);
        this.listSchemas = new ListSchemasClientImpl(this);
        this.listFlowsByPipelines = new ListFlowsByPipelinesClientImpl(this);
