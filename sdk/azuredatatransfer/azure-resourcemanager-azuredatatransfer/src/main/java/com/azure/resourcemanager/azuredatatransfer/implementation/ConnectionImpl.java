...
public final class ConnectionImpl implements Connection, Connection.Definition, Connection.Update {
    ...
    public Connection create() {
        this.innerObject = serviceManager.serviceClient().getConnections().createOrUpdate(resourceGroupName,
            connectionName, this.innerModel(), Context.NONE);
        return this;
    }

    public Connection create(Context context) {
        this.innerObject = serviceManager.serviceClient().getConnections().createOrUpdate(resourceGroupName,
            connectionName, this.innerModel(), context);
        return this;
    }
    ...
    public Connection apply() {
        this.innerObject = serviceManager.serviceClient().getConnections().update(resourceGroupName, connectionName,
            updateConnection, Context.NONE);
        return this;
    }
    ...
    public Connection refresh() {
        this.innerObject = serviceManager.serviceClient().getConnections()
            .getByResourceGroupWithResponse(resourceGroupName, connectionName, Context.NONE).getValue();
        return this;
    }

    public Connection refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getConnections()
            .getByResourceGroupWithResponse(resourceGroupName, connectionName, context).getValue();
        return this;
    }
