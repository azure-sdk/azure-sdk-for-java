...
public class FlowProperties implements JsonSerializable<FlowProperties> {
     ...
     * @return the FlowProperties object itself.
     */
    public FlowProperties withCustomerManagedKeyVaultUri(String customerManagedKeyVaultUri) {
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("connection".equals(fieldName)) {
                    ...
                    deserializedFlowProperties.customerManagedKeyVaultUri = reader.getString();
                } else {
                    reader.skipChildren();
                }
            }
