...
public final class AssetEndpointProfilesCreateOrReplaceSamples {
    /*
     * x-ms-original-file:
     * specification/deviceregistry/resource-manager/Microsoft.DeviceRegistry/preview/2023-11-01-preview/examples/
     * Create_AssetEndpointProfile.json
     */
    /**
     * Sample code: Create an Asset Endpoint Profile.
     * 
     * @param manager Entry point to DeviceRegistryManager.
     */
    public static void
        createAnAssetEndpointProfile(com.azure.resourcemanager.deviceregistry.DeviceRegistryManager manager) {
...
public final class AssetEndpointProfilesDeleteSamples {
     ...
     * x-ms-original-file:
     * specification/deviceregistry/resource-manager/Microsoft.DeviceRegistry/preview/2023-11-01-preview/examples/
     * Delete_AssetEndpointProfile.json
     */
    /**
     * Sample code: Delete an Asset Endpoint Profile.
     * 
     * @param manager Entry point to DeviceRegistryManager.
     */
    public static void
        deleteAnAssetEndpointProfile(com.azure.resourcemanager.deviceregistry.DeviceRegistryManager manager) {
...
public final class AssetEndpointProfilesGetByResourceGroupSamples {
     ...
     * x-ms-original-file:
     * specification/deviceregistry/resource-manager/Microsoft.DeviceRegistry/preview/2023-11-01-preview/examples/
     * Get_AssetEndpointProfile.json
     */
    /**
     * Sample code: Get an Asset Endpoint Profile.
     * 
     * @param manager Entry point to DeviceRegistryManager.
     */
    public static void
        getAnAssetEndpointProfile(com.azure.resourcemanager.deviceregistry.DeviceRegistryManager manager) {
...
public final class AssetEndpointProfilesListSamples {
     ...
     */
    /**
     * Sample code: List Asset Endpoint Profiles in a Subscription.
     * 
     * @param manager Entry point to DeviceRegistryManager.
     */
    public static void listAssetEndpointProfilesInASubscription(
...
public final class AssetEndpointProfilesListByResourceGroupSamples {
     ...
     */
    /**
     * Sample code: List Asset Endpoint Profiles in a Resource Group.
     * 
     * @param manager Entry point to DeviceRegistryManager.
     */
    public static void listAssetEndpointProfilesInAResourceGroup(
        com.azure.resourcemanager.deviceregistry.DeviceRegistryManager manager) {
...
public final class AssetEndpointProfilesUpdateSamples {
     ...
     * x-ms-original-file:
     * specification/deviceregistry/resource-manager/Microsoft.DeviceRegistry/preview/2023-11-01-preview/examples/
     * Update_AssetEndpointProfile.json
     */
    /**
     * Sample code: Patch an Asset Endpoint Profile.
     * 
     * @param manager Entry point to DeviceRegistryManager.
     */
    public static void
        patchAnAssetEndpointProfile(com.azure.resourcemanager.deviceregistry.DeviceRegistryManager manager) {
...
public final class AssetsCreateOrReplaceSamples {
     ...
     */
    /**
     * Sample code: Create an Asset Without Display Name.
     * 
     * @param manager Entry point to DeviceRegistryManager.
     */
    public static void
        createAnAssetWithoutDisplayName(com.azure.resourcemanager.deviceregistry.DeviceRegistryManager manager) {
        manager.assets().define("my-asset").withRegion("West Europe").withExistingResourceGroup("myResourceGroup")
            .withExtendedLocation(new ExtendedLocation().withType("CustomLocation").withName(
                "/subscriptions/00000000-0000-0000-0000-000000000000/resourcegroups/myResourceGroup/providers/microsoft.extendedlocation/customlocations/location1"))
            .withTags(mapOf("site", "building-1"))
            .withProperties(new AssetProperties().withAssetType("MyAssetType").withEnabled(true)
                .withExternalAssetId("8ZBA6LRHU0A458969").withDescription("This is a sample Asset")
                ...
                .withDataPoints(Arrays.asList(
                    new DataPoint().withDataSource("nsu=http://microsoft.com/Opc/OpcPlc/;s=FastUInt1")
                        ...
                        .withObservabilityMode(DataPointsObservabilityMode.COUNTER).withDataPointConfiguration(
                    ...
                    new DataPoint().withDataSource("nsu=http://microsoft.com/Opc/OpcPlc/;s=FastUInt2")
                        ...
                        .withObservabilityMode(DataPointsObservabilityMode.NONE).withDataPointConfiguration(
     ...
     */
    /**
     * Sample code: Create an Asset With External Asset Id.
     * 
     * @param manager Entry point to DeviceRegistryManager.
     */
    public static void
        createAnAssetWithExternalAssetId(com.azure.resourcemanager.deviceregistry.DeviceRegistryManager manager) {
        manager.assets().define("my-asset").withRegion("West Europe").withExistingResourceGroup("myResourceGroup")
            .withExtendedLocation(new ExtendedLocation().withType("CustomLocation").withName(
                "/subscriptions/00000000-0000-0000-0000-000000000000/resourcegroups/myResourceGroup/providers/microsoft.extendedlocation/customlocations/location1"))
            .withTags(mapOf("site", "building-1"))
            .withProperties(new AssetProperties().withAssetType("MyAssetType").withEnabled(true)
                .withExternalAssetId("8ZBA6LRHU0A458969").withDisplayName("AssetDisplayName")
     ...
     */
    /**
     * Sample code: Create an Asset Without External Asset Id.
     * 
     * @param manager Entry point to DeviceRegistryManager.
     */
    public static void
        createAnAssetWithoutExternalAssetId(com.azure.resourcemanager.deviceregistry.DeviceRegistryManager manager) {
        manager.assets().define("my-asset").withRegion("West Europe").withExistingResourceGroup("myResourceGroup")
            .withExtendedLocation(new ExtendedLocation().withType("CustomLocation").withName(
                "/subscriptions/00000000-0000-0000-0000-000000000000/resourcegroups/myResourceGroup/providers/microsoft.extendedlocation/customlocations/location1"))
            .withTags(mapOf("site", "building-1"))
            .withProperties(new AssetProperties().withAssetType("MyAssetType").withEnabled(true)
                .withDisplayName("AssetDisplayName").withDescription("This is a sample Asset")
                .withAssetEndpointProfileUri("https://www.example.com/myAssetEndpointProfile")
                .withManufacturer("Contoso").withManufacturerUri("https://www.contoso.com/manufacturerUri")
                .withModel("ContosoModel").withProductCode("fakeTokenPlaceholder").withHardwareRevision("1.0")
                .withSoftwareRevision("2.0").withDocumentationUri("https://www.example.com/manual")
...
public final class AssetsDeleteSamples {
     ...
     * @param manager Entry point to DeviceRegistryManager.
     */
    public static void deleteAnAsset(com.azure.resourcemanager.deviceregistry.DeviceRegistryManager manager) {
...
public final class AssetsGetByResourceGroupSamples {
     ...
     * x-ms-original-file:
     * specification/deviceregistry/resource-manager/Microsoft.DeviceRegistry/preview/2023-11-01-preview/examples/
     * Get_Asset_With_SyncStatus.json
     */
    /**
     * Sample code: Get an Asset with Sync Status.
     * 
     * @param manager Entry point to DeviceRegistryManager.
     */
    public static void
        getAnAssetWithSyncStatus(com.azure.resourcemanager.deviceregistry.DeviceRegistryManager manager) {
     ...
     */
    /**
     * Sample code: Get an Asset.
     * 
     * @param manager Entry point to DeviceRegistryManager.
     */
    public static void getAnAsset(com.azure.resourcemanager.deviceregistry.DeviceRegistryManager manager) {
        manager.assets().getByResourceGroupWithResponse("myResourceGroup", "my-asset",
            com.azure.core.util.Context.NONE);
    }
}
...
public final class AssetsListSamples {
     ...
     * x-ms-original-file:
     * specification/deviceregistry/resource-manager/Microsoft.DeviceRegistry/preview/2023-11-01-preview/examples/
     * List_Assets_Subscription.json
     */
    /**
     * Sample code: List Assets in a Subscription.
     * 
     * @param manager Entry point to DeviceRegistryManager.
     */
    public static void
        listAssetsInASubscription(com.azure.resourcemanager.deviceregistry.DeviceRegistryManager manager) {
...
public final class AssetsListByResourceGroupSamples {
     ...
     * x-ms-original-file:
     * specification/deviceregistry/resource-manager/Microsoft.DeviceRegistry/preview/2023-11-01-preview/examples/
     * List_Assets_ResourceGroup.json
     */
    /**
     * Sample code: List Assets in a Resource Group.
     * 
     * @param manager Entry point to DeviceRegistryManager.
     */
    public static void
        listAssetsInAResourceGroup(com.azure.resourcemanager.deviceregistry.DeviceRegistryManager manager) {
...
public final class AssetsUpdateSamples {
     ...
     */
    /**
     * Sample code: Patch an Asset.
     * 
     * @param manager Entry point to DeviceRegistryManager.
     */
    public static void patchAnAsset(com.azure.resourcemanager.deviceregistry.DeviceRegistryManager manager) {
...
public final class OperationStatusGetSamples {
     ...
     * x-ms-original-file:
     * specification/deviceregistry/resource-manager/Microsoft.DeviceRegistry/preview/2023-11-01-preview/examples/
     * Get_OperationStatus.json
     */
    /**
     * Sample code: Get the status of an async operation.
     * 
     * @param manager Entry point to DeviceRegistryManager.
     */
    public static void
        getTheStatusOfAnAsyncOperation(com.azure.resourcemanager.deviceregistry.DeviceRegistryManager manager) {
...
public final class OperationsListSamples {
     ...
     * x-ms-original-file:
     * specification/deviceregistry/resource-manager/Microsoft.DeviceRegistry/preview/2023-11-01-preview/examples/
     * List_Operations.json
     */
    /**
     * Sample code: Returns list of operations.
     * 
     * @param manager Entry point to DeviceRegistryManager.
     */
    public static void returnsListOfOperations(com.azure.resourcemanager.deviceregistry.DeviceRegistryManager manager) {
