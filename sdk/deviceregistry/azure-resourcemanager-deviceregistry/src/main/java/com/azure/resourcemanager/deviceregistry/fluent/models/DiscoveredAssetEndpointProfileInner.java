...
public final class DiscoveredAssetEndpointProfileInner extends Resource {
     ...
     */
    @Override
    public DiscoveredAssetEndpointProfileInner withTags(Map<String, String> tags) {
        super.withTags(tags);
        return this;
    }
    ...
    public void validate() {
        ...
        if (location() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property location in model DiscoveredAssetEndpointProfileInner"));
        }
    }
