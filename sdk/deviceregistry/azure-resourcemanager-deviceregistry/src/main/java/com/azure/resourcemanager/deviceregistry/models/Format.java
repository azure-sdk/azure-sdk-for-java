...
public final class Format extends ExpandableStringEnum<Format> {
    /**
     * Static value JsonSchema/draft-07 for Format.
     */
    public static final Format JSON_SCHEMA_DRAFT_07 = fromString("JsonSchema/draft-07");

    /**
     * Static value Delta/1.0 for Format.
     */
