...
public final class SchemaRegistriesClientImpl implements SchemaRegistriesClient {
    ...
    /**
     * Initializes an instance of SchemaRegistriesClientImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    SchemaRegistriesClientImpl(DeviceRegistryClientImpl client) {
        this.service
            = RestProxy.create(SchemaRegistriesService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for DeviceRegistryClientSchemaRegistries to be used by the proxy service
    ...
    public interface SchemaRegistriesService {
        ...
        Mono<Response<SchemaRegistryInner>> getByResourceGroup(@HostParam("endpoint") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<SchemaRegistryListResult>> listByResourceGroup(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<SchemaRegistryListResult>> listByResourceGroupNext(
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a SchemaRegistry on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<SchemaRegistryInner> getByResourceGroupAsync(String resourceGroupName, String schemaRegistryName) {
        return getByResourceGroupWithResponseAsync(resourceGroupName, schemaRegistryName)
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public SchemaRegistryInner getByResourceGroup(String resourceGroupName, String schemaRegistryName) {
        return getByResourceGroupWithResponse(resourceGroupName, schemaRegistryName, Context.NONE).getValue();
    }
    ...
    private PollerFlux<PollResult<SchemaRegistryInner>, SchemaRegistryInner>
        beginCreateOrReplaceAsync(String resourceGroupName, String schemaRegistryName, SchemaRegistryInner resource) {
        Mono<Response<Flux<ByteBuffer>>> mono
            = createOrReplaceWithResponseAsync(resourceGroupName, schemaRegistryName, resource);
        return this.client.<SchemaRegistryInner, SchemaRegistryInner>getLroResult(mono, this.client.getHttpPipeline(),
            SchemaRegistryInner.class, SchemaRegistryInner.class, this.client.getContext());
    }
    ...
    private Mono<SchemaRegistryInner> createOrReplaceAsync(String resourceGroupName, String schemaRegistryName,
        ...
        return beginCreateOrReplaceAsync(resourceGroupName, schemaRegistryName, resource).last()
    ...
    private PollerFlux<PollResult<SchemaRegistryInner>, SchemaRegistryInner> beginUpdateAsync(String resourceGroupName,
        String schemaRegistryName, SchemaRegistryUpdate properties) {
        Mono<Response<Flux<ByteBuffer>>> mono
            = updateWithResponseAsync(resourceGroupName, schemaRegistryName, properties);
        return this.client.<SchemaRegistryInner, SchemaRegistryInner>getLroResult(mono, this.client.getHttpPipeline(),
            SchemaRegistryInner.class, SchemaRegistryInner.class, this.client.getContext());
    }
    ...
    private Mono<SchemaRegistryInner> updateAsync(String resourceGroupName, String schemaRegistryName,
        ...
        return beginUpdateAsync(resourceGroupName, schemaRegistryName, properties).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private PollerFlux<PollResult<Void>, Void> beginDeleteAsync(String resourceGroupName, String schemaRegistryName) {
        Mono<Response<Flux<ByteBuffer>>> mono = deleteWithResponseAsync(resourceGroupName, schemaRegistryName);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> deleteAsync(String resourceGroupName, String schemaRegistryName) {
        return beginDeleteAsync(resourceGroupName, schemaRegistryName).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private PagedFlux<SchemaRegistryInner> listByResourceGroupAsync(String resourceGroupName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<SchemaRegistryInner> listAsync() {
