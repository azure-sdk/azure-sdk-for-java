...
import com.azure.resourcemanager.deviceregistry.models.AssetEndpointProfileListResult;
...
public final class AssetEndpointProfilesClientImpl implements AssetEndpointProfilesClient {
     ...
     */
    private final DeviceRegistryMgmtClientImpl client;
     ...
     */
    AssetEndpointProfilesClientImpl(DeviceRegistryMgmtClientImpl client) {
    ...
    /**
     * The interface defining all the services for DeviceRegistryMgmtClientAssetEndpointProfiles to be used by the proxy
     * service to perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "DeviceRegistryMgmtCl")
    public interface AssetEndpointProfilesService {
        ...
        Mono<Response<AssetEndpointProfileListResult>> list(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<AssetEndpointProfileListResult>> listByResourceGroup(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<AssetEndpointProfileInner>> getByResourceGroup(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
        ...
        Mono<Response<Flux<ByteBuffer>>> createOrReplace(@HostParam("$host") String endpoint,
            ...
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("assetEndpointProfileName") String assetEndpointProfileName,
            @BodyParam("application/json") AssetEndpointProfileInner resource, @HeaderParam("Accept") String accept,
            Context context);
        ...
        Mono<Response<Flux<ByteBuffer>>> update(@HostParam("$host") String endpoint,
            ...
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("assetEndpointProfileName") String assetEndpointProfileName,
            @BodyParam("application/json") AssetEndpointProfileUpdate properties, @HeaderParam("Accept") String accept,
            Context context);
    ...
    private Mono<Response<Flux<ByteBuffer>>> createOrReplaceWithResponseAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(context -> service.createOrReplace(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, assetEndpointProfileName, resource, accept,
                context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> createOrReplaceWithResponseAsync(String resourceGroupName,
        ...
        return service.createOrReplace(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, assetEndpointProfileName, resource, accept, context);
    }
     ...
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
     * @param assetEndpointProfileName Asset Endpoint Profile name parameter.
     * @param properties The resource properties to be updated. test.
     * @throws IllegalArgumentException thrown if parameters fail the validation.
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return asset Endpoint Profile definition along with {@link Response} on successful completion of {@link Mono}.
    ...
    private Mono<Response<Flux<ByteBuffer>>> updateWithResponseAsync(String resourceGroupName,
        ...
        return FluxUtil.withContext(context -> service.update(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, assetEndpointProfileName, properties, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> updateWithResponseAsync(String resourceGroupName,
        ...
        return service.update(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, assetEndpointProfileName, properties, accept, context);
    }
