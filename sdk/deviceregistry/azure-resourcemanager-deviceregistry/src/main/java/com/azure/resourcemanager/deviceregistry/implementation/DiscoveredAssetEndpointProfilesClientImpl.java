...
public final class DiscoveredAssetEndpointProfilesClientImpl implements DiscoveredAssetEndpointProfilesClient {
     ...
     */
    DiscoveredAssetEndpointProfilesClientImpl(DeviceRegistryClientImpl client) {
    ...
    /**
     * The interface defining all the services for DeviceRegistryClientDiscoveredAssetEndpointProfiles to be used by the
