...
public final class Event {
    ...
    /**
     * Get the eventNotifier property: The address of the notifier of the event in the asset (e.g. URL) so that a
     * client can access the event on the asset.
     * 
    ...
    /**
     * Set the eventNotifier property: The address of the notifier of the event in the asset (e.g. URL) so that a
     * client can access the event on the asset.
     * 
    ...
    public void validate() {
        if (eventNotifier() == null) {
            throw LOGGER.logExceptionAsError(
                new IllegalArgumentException("Missing required property eventNotifier in model Event"));
        }
    }
