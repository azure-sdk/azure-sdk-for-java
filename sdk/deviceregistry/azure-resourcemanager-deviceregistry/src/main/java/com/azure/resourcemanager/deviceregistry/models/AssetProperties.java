...
public final class AssetProperties {
    ...
    /*
     * A reference to the asset endpoint profile (connection information) used by brokers to connect to an endpoint
    ...
    /**
     * Get the assetEndpointProfileUri property: A reference to the asset endpoint profile (connection information)
     * used by brokers to connect to an endpoint that provides data points for this asset. Must have the format
     * &lt;ModuleCR.metadata.namespace&gt;/&lt;ModuleCR.metadata.name&gt;.
     * 
    ...
    /**
     * Set the assetEndpointProfileUri property: A reference to the asset endpoint profile (connection information)
     * used by brokers to connect to an endpoint that provides data points for this asset. Must have the format
     * &lt;ModuleCR.metadata.namespace&gt;/&lt;ModuleCR.metadata.name&gt;.
     * 
     ...
     * asset type capability and have per-data point configuration. See below for more details for the definition of
     * the dataPoints element.
     * 
