...
public final class AssetImpl implements Asset, Asset.Definition, Asset.Update {
    ...
    public Asset create() {
        this.innerObject = serviceManager.serviceClient().getAssets().createOrReplace(resourceGroupName, assetName,
    ...
    public Asset apply() {
        this.innerObject = serviceManager.serviceClient().getAssets().update(resourceGroupName, assetName,
    ...
    public Asset refresh() {
        this.innerObject = serviceManager.serviceClient().getAssets()
            .getByResourceGroupWithResponse(resourceGroupName, assetName, Context.NONE).getValue();
        return this;
    }

    public Asset refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getAssets()
            .getByResourceGroupWithResponse(resourceGroupName, assetName, context).getValue();
        return this;
    }
