...
public final class BillingContainersClientImpl implements BillingContainersClient {
     ...
     */
    BillingContainersClientImpl(DeviceRegistryClientImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for DeviceRegistryClientBillingContainers to be used by the proxy service
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<BillingContainerInner>> getWithResponseAsync(String billingContainerName, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<BillingContainerInner>> listSinglePageAsync(Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<BillingContainerInner> listAsync(Context context) {
