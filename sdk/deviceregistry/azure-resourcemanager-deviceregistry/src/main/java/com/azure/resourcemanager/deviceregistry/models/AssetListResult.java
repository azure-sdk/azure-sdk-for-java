...
public final class AssetListResult {
    ...
    /**
     * Set the value property: The Asset items on this page.
     * 
     * @param value the value value to set.
     * @return the AssetListResult object itself.
     */
    public AssetListResult withValue(List<AssetInner> value) {
        this.value = value;
        return this;
    }
     ...
     * @return the AssetListResult object itself.
     */
    public AssetListResult withNextLink(String nextLink) {
    ...
    public void validate() {
        if (value() == null) {
            throw LOGGER.logExceptionAsError(
                new IllegalArgumentException("Missing required property value in model AssetListResult"));
        } else {
