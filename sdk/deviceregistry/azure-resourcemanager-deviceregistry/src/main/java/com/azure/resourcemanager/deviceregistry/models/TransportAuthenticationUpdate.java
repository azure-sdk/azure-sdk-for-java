...
public final class TransportAuthenticationUpdate {
     ...
     * keys that can be used by the southbound connector connecting to the shop floor/OT device. The accepted
     * extensions are .der for certificates and .pfx/.pem for private keys.
     * 
