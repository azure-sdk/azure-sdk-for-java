...
public final class AssetEndpointProfileUpdateProperties {
    ...
    private UserAuthenticationUpdate userAuthentication;

    /*
     * Defines the authentication mechanism for the southbound connector connecting to the shop floor/OT device.
     */
    @JsonProperty(value = "transportAuthentication")
    private TransportAuthenticationUpdate transportAuthentication;
     ...
     */
    public UserAuthenticationUpdate userAuthentication() {
     ...
     * @return the AssetEndpointProfileUpdateProperties object itself.
     */
    public AssetEndpointProfileUpdateProperties withUserAuthentication(UserAuthenticationUpdate userAuthentication) {
     ...
     */
    public TransportAuthenticationUpdate transportAuthentication() {
     ...
     */
    public AssetEndpointProfileUpdateProperties
        withTransportAuthentication(TransportAuthenticationUpdate transportAuthentication) {
        this.transportAuthentication = transportAuthentication;
        return this;
    }

    /**
     * Get the additionalConfiguration property: Contains connectivity type specific further configuration (e.g. OPC
     * UA, Modbus, ONVIF).
     * 
    ...
    /**
     * Set the additionalConfiguration property: Contains connectivity type specific further configuration (e.g. OPC
     * UA, Modbus, ONVIF).
     * 
