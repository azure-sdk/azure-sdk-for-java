...
public final class DiscoveredAssetsClientImpl implements DiscoveredAssetsClient {
     ...
     */
    DiscoveredAssetsClientImpl(DeviceRegistryClientImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for DeviceRegistryClientDiscoveredAssets to be used by the proxy service
