...
public final class SchemaRegistryInner extends Resource {
     ...
     */
    @Override
    public SchemaRegistryInner withTags(Map<String, String> tags) {
        super.withTags(tags);
        return this;
    }
    ...
    public void validate() {
        ...
        if (location() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Missing required property location in model SchemaRegistryInner"));
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(SchemaRegistryInner.class);
