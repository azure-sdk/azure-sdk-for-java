...
public final class AuthenticationMethod extends ExpandableStringEnum<AuthenticationMethod> {
    /**
     * Static value Anonymous for AuthenticationMethod.
     */
    public static final AuthenticationMethod ANONYMOUS = fromString("Anonymous");

    /**
     * Static value Certificate for AuthenticationMethod.
     */
    public static final AuthenticationMethod CERTIFICATE = fromString("Certificate");

    /**
     * Static value UsernamePassword for AuthenticationMethod.
     */
