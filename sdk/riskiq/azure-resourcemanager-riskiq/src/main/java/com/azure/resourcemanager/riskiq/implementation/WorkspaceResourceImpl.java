...
public final class WorkspaceResourceImpl
    ...
    WorkspaceResourceImpl(String name, com.azure.resourcemanager.riskiq.EasmManager serviceManager) {
    ...
    WorkspaceResourceImpl(
        WorkspaceResourceInner innerObject, com.azure.resourcemanager.riskiq.EasmManager serviceManager) {
