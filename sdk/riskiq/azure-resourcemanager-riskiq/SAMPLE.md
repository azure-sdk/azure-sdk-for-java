...
public final class LabelsCreateAndUpdateSamples {
     ...
     */
    public static void labels(com.azure.resourcemanager.riskiq.EasmManager manager) {
        manager
            .labels()
...
public final class OperationsListSamples {
     ...
     * @param manager Entry point to EasmManager.
     */
    public static void operations(com.azure.resourcemanager.riskiq.EasmManager manager) {
...
public final class TasksGetByWorkspaceSamples {
     ...
     * @param manager Entry point to EasmManager.
     */
    public static void tasks(com.azure.resourcemanager.riskiq.EasmManager manager) {
        manager
            .tasks()
            .getByWorkspaceWithResponse(
