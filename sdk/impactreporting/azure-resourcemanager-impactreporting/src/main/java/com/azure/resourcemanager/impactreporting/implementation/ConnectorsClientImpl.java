...
public final class ConnectorsClientImpl implements ConnectorsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ConnectorInner>> updateWithResponseAsync(String connectorName, ConnectorInner properties) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ConnectorInner> updateAsync(String connectorName, ConnectorInner properties) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ConnectorInner> updateWithResponse(String connectorName, ConnectorInner properties,
        Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ConnectorInner update(String connectorName, ConnectorInner properties) {
