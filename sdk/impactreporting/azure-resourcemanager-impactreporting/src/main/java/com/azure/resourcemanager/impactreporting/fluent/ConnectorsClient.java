...
public interface ConnectorsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<ConnectorInner> updateWithResponse(String connectorName, ConnectorInner properties, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ConnectorInner update(String connectorName, ConnectorInner properties);
