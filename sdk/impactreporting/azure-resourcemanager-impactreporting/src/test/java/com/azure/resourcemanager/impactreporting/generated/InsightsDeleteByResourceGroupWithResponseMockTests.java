...
public final class InsightsDeleteByResourceGroupWithResponseMockTests {
    @Test
    public void testDeleteWithResponse() throws Exception {
        ...
        manager.insights().deleteByResourceGroupWithResponse("wfudwpzntxhdzhl", "qj", com.azure.core.util.Context.NONE);
