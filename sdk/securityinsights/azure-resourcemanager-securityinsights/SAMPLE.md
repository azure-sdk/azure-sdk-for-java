...
public final class ActionsCreateOrUpdateSamples {
    /*
     * x-ms-original-file:
     * specification/securityinsights/resource-manager/Microsoft.SecurityInsights/preview/2024-01-01-preview/examples/
...
```java
import com.azure.resourcemanager.securityinsights.models.Constant111;
...
public final class EntityQueryTemplatesListSamples {
    ...
    public static void
        ...
        manager.entityQueryTemplates().list("myRg", "myWorkspace", Constant111.ACTIVITY,
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class UpdateRecommendationSamples {
    ...
    public static void
        ...
        manager.updates().recommendationWithResponse("myRg", "myWorkspace",
            UUID.fromString("6d4b54eb-8684-4aa3-a156-3aa37b8014bc"), new RecommendationPatch().withState(State.ACTIVE),
            com.azure.core.util.Context.NONE);
    }
}
```
