...
- [Get](#systems_get)
- [GetAll](#systems_getall)
- [ListActions](#systems_listactions)
- [PerformAction](#systems_performaction)
...
public final class BusinessApplicationAgentsCreateOrUpdateSamples {
    ...
    public static void businessApplicationAgentsCreateOrUpdate(
        ...
        manager.businessApplicationAgents().define("3d69632b-0b60-4af3-8720-77f01a25d34a")
            .withExistingWorkspace("myRg", "myWorkspace").create();
    }
}
```
...
public final class BusinessApplicationAgentsListSamples {
    ...
    public static void
        ...
        manager.businessApplicationAgents().list("myRg", "myWorkspace", null, null, null, null, null,
            com.azure.core.util.Context.NONE);
    }
}
```
        ...
        manager.dataConnectorDefinitions().createOrUpdateWithResponse("myRg", "myWorkspace",
            ...
            new CustomizableConnectorDefinition().withEtag("\"0300bf09-0000-0000-0000-5c37296e0000\"")
                .withConnectorUiConfig(new CustomizableConnectorUiConfig().withTitle("GitHub Enterprise Audit Log")
                    ...
                    .withSampleQueries(Arrays.asList(new SampleQuery().withDescription("All logs")
...
```java
import com.azure.resourcemanager.securityinsights.models.Constant119;
...
public final class EntityQueryTemplatesListSamples {
    ...
    public static void
        ...
        manager.entityQueryTemplates().list("myRg", "myWorkspace", Constant119.ACTIVITY,
            com.azure.core.util.Context.NONE);
    }
}
```
...
/**
 * Samples for Systems GetAll.
 */
public final class SystemsGetAllSamples {
    /*
     * x-ms-original-file:
     * specification/securityinsights/resource-manager/Microsoft.SecurityInsights/preview/2024-03-01-preview/examples/
     * businessApplicationAgents/systems/Systems_GetAll.json
     */
    /**
    ...
    public static void systemsGetAll(com.azure.resourcemanager.securityinsights.SecurityInsightsManager manager) {
        manager.systems().getAll("myRg", "myWorkspace", "247b377a-7137-4b3c-bf15-df1d3260ef1b", null, null, null, null,
            null, com.azure.core.util.Context.NONE);
    }
}
```
...
public final class SystemsListActionsSamples {
    ...
    public static void listActions(com.azure.resourcemanager.securityinsights.SecurityInsightsManager manager) {
        manager.systems().listActionsWithResponse("myRg", "myWorkspace", "247b377a-7137-4b3c-bf15-df1d3260ef1b",
            "3d69632b-0b60-4af3-8720-77f01a25d34a", com.azure.core.util.Context.NONE);
    }
}
```

### Systems_PerformAction
...
public final class UpdateRecommendationSamples {
    ...
    public static void
        ...
        manager.updates().recommendation("myRg", "myWorkspace", UUID.fromString("6d4b54eb-8684-4aa3-a156-3aa37b8014bc"),
            Arrays.asList(new RecommendationPatch().withState(State.ACTIVE)), com.azure.core.util.Context.NONE);
    }
}
```
