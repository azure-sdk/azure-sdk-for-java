...
public final class IncidentsRunPlaybookSamples {
    /*
     * x-ms-original-file: specification/securityinsights/resource-manager/Microsoft.SecurityInsights/preview/2022-09-01-preview/examples/manualTrigger/AutomationRules_ManualTriggerPlaybook.json
     */
    /**
...
/** Samples for Overview List. */
public final class OverviewListSamples {
    /*
     * x-ms-original-file: specification/securityinsights/resource-manager/Microsoft.SecurityInsights/preview/2022-09-01-preview/examples/overview/GetAllOverviewSections.json
     */
    /**
     * Sample code: Get all overview sections.
     *
     * @param manager Entry point to SecurityInsightsManager.
     */
    public static void getAllOverviewSections(
        com.azure.resourcemanager.securityinsights.SecurityInsightsManager manager) {
        manager.overviews().listWithResponse("myRg", "myWorkspace", "Analytics", Context.NONE);
    }
}
```
