...
- [Get](#contentpackageoperation_get)
...
public final class ContentPackageOperationGetSamples {
    ...
    public static void getAPackage(com.azure.resourcemanager.securityinsights.SecurityInsightsManager manager) {
        manager
            ...
            .getWithResponse(
                "myRg", "myWorkspace", "azuresentinel.azure-sentinel-solution-ciscoumbrella", Context.NONE);
    }
}
```
...
public final class ContentPackageOperationInstallSamples {
    /*
     * x-ms-original-file: specification/securityinsights/resource-manager/Microsoft.SecurityInsights/preview/2022-11-01-preview/examples/ContentPackages/InstallPackage.json
     */
    /**
...
public final class ContentPackagesListSamples {
    ...
    public static void getAllAvailablePackages(
        com.azure.resourcemanager.securityinsights.SecurityInsightsManager manager) {
        manager.contentPackages().list("myRg", "myWorkspace", null, null, null, null, Context.NONE);
    }
}
```
...
public final class ContentTemplatesListSamples {
    /*
     * x-ms-original-file: specification/securityinsights/resource-manager/Microsoft.SecurityInsights/preview/2022-11-01-preview/examples/ContentTemplates/GetTemplates.json
     */
    /**
    ...
    public static void getAllInstalledTemplates(
        com.azure.resourcemanager.securityinsights.SecurityInsightsManager manager) {
        manager.contentTemplates().list("myRg", "myWorkspace", null, null, null, null, Context.NONE);
    }
}
```
