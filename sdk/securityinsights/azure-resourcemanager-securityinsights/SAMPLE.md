...
public final class SummariesGetSamples {
    /*
     * x-ms-original-file: specification/securityinsights/resource-manager/Microsoft.SecurityInsights/preview/2023-03-01-preview/examples/dynamicSummaries/GetSummaryById.json
     */
    /**
...
/** Samples for Summaries List. */
public final class SummariesListSamples {
    /*
     * x-ms-original-file: specification/securityinsights/resource-manager/Microsoft.SecurityInsights/preview/2023-03-01-preview/examples/dynamicSummaries/GetSummaries.json
     */
    /**
     * Sample code: Get all summaries.
     *
     * @param manager Entry point to SecurityInsightsManager.
     */
    public static void getAllSummaries(com.azure.resourcemanager.securityinsights.SecurityInsightsManager manager) {
        manager.summaries().list("myRg", "myWorkspace", Context.NONE);
    }
}
```
