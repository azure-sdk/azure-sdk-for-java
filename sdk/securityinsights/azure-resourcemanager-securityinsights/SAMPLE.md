...
- [CountFromCondition](#threatintelligenceindicator_countfromcondition)
...
- [QueryFromCondition](#threatintelligenceindicator_queryfromcondition)
...
```java
import com.azure.core.util.Context;
import com.azure.resourcemanager.securityinsights.models.Constant92;
...
public final class EntityQueryTemplatesListSamples {
    ...
    public static void getAllEntityQueryTemplates(
        com.azure.resourcemanager.securityinsights.SecurityInsightsManager manager) {
        manager.entityQueryTemplates().list("myRg", "myWorkspace", Constant92.ACTIVITY, Context.NONE);
    }
}
```
...
### ThreatIntelligenceIndicator_CountFromCondition
...
### ThreatIntelligenceIndicator_QueryFromCondition
