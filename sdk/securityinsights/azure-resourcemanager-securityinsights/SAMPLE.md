...
```java
import com.azure.core.util.Context;
import com.azure.resourcemanager.securityinsights.models.Constant84;
...
public final class EntityQueryTemplatesListSamples {
    ...
    public static void getAllEntityQueryTemplates(
        com.azure.resourcemanager.securityinsights.SecurityInsightsManager manager) {
        manager.entityQueryTemplates().list("myRg", "myWorkspace", Constant84.ACTIVITY, Context.NONE);
    }
}
```
...
/** Samples for Get Recommendations. */
public final class GetRecommendationsSamples {
    /*
    ...
    public static void getRecommendationsList(
        com.azure.resourcemanager.securityinsights.SecurityInsightsManager manager) {
        manager.gets().recommendationsWithResponse("myRg", "myWorkspace", Context.NONE);
    }
}
```
