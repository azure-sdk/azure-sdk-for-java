        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("id".equals(fieldName)) {
                    ...
                    deserializedIdentity.name = reader.getString();
                } else if ("type".equals(fieldName)) {
                    deserializedIdentity.type = reader.getString();
                } else if ("properties".equals(fieldName)) {
                    deserializedIdentity.innerProperties = TIObjectCommonProperties.fromJson(reader);
                } else if ("systemData".equals(fieldName)) {
                    deserializedIdentity.systemData = SystemData.fromJson(reader);
                } else if ("kind".equals(fieldName)) {
                    deserializedIdentity.kind = TIObjectKind.fromString(reader.getString());
                } else {
                    reader.skipChildren();
                }
            }
