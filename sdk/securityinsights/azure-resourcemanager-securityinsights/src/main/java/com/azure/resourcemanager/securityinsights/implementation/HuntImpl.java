...
public final class HuntImpl implements Hunt, Hunt.Definition, Hunt.Update {
    ...
    public Hunt create() {
        this.innerObject = serviceManager.serviceClient().getHunts()
    ...
    public Hunt refresh() {
        this.innerObject = serviceManager.serviceClient().getHunts()
            .getWithResponse(resourceGroupName, workspaceName, huntId, Context.NONE).getValue();
        return this;
    }

    public Hunt refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getHunts()
            .getWithResponse(resourceGroupName, workspaceName, huntId, context).getValue();
        return this;
    }
