...
@Fluent
public final class ConnectorDefinitionBaseArmObjectWrapperWithConverter extends ResourceWithEtag {
    /*
     * Gets or sets the nested level of properties which contains the resource content
     */
    @JsonProperty(value = "properties", required = true)
    private ConnectorDefinitionBase innerProperties = new ConnectorDefinitionBase();

    /** Creates an instance of ConnectorDefinitionBaseArmObjectWrapperWithConverter class. */
    public ConnectorDefinitionBaseArmObjectWrapperWithConverter() {
    }

    /**
     * Get the innerProperties property: Gets or sets the nested level of properties which contains the resource
     * content.
     *
    ...
    /** {@inheritDoc} */
    @Override
    public ConnectorDefinitionBaseArmObjectWrapperWithConverter withEtag(String etag) {
        super.withEtag(etag);
        return this;
    }
     ...
     * @return the ConnectorDefinitionBaseArmObjectWrapperWithConverter object itself.
     */
    public ConnectorDefinitionBaseArmObjectWrapperWithConverter withCreatedTimeUtc(OffsetDateTime createdTimeUtc) {
     ...
     * @return the ConnectorDefinitionBaseArmObjectWrapperWithConverter object itself.
     */
    public ConnectorDefinitionBaseArmObjectWrapperWithConverter withLastModifiedUtc(OffsetDateTime lastModifiedUtc) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ConnectorDefinitionBase();
        }
                ...
                .logExceptionAsError(
                    new IllegalArgumentException(
                        "Missing required property innerProperties in model"
                            + " ConnectorDefinitionBaseArmObjectWrapperWithConverter"));
        } else {
    ...
    private static final ClientLogger LOGGER =
        new ClientLogger(ConnectorDefinitionBaseArmObjectWrapperWithConverter.class);
}
