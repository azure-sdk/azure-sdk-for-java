 ...
 */
@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, property = "kind", defaultImpl = NrtAlertRule.class, visible = true)
@JsonTypeName("NRT")
@Fluent
public final class NrtAlertRule extends AlertRuleInner {
     ...
     * @return the NrtAlertRule object itself.
     */
    public NrtAlertRule withSubTechniques(List<String> subTechniques) {
        if (this.innerProperties() == null) {
            this.innerProperties = new NrtAlertRuleProperties();
        }
