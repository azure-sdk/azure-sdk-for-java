...
@Fluent
public final class IncidentProperties {
    /*
     ...
     */
    @JsonProperty(value = "providerIncidentId", access = JsonProperty.Access.WRITE_ONLY)
    ...
    public void validate() {
        ...
        if (severity() == null) {
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException("Missing required property severity in model IncidentProperties"));
        }
        if (status() == null) {
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException("Missing required property status in model IncidentProperties"));
        }
        if (title() == null) {
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException("Missing required property title in model IncidentProperties"));
        }
    }
