...
public final class ContentTemplatesImpl implements ContentTemplates {
    ...
    public PagedIterable<TemplateModelAutoGenerated> list(String resourceGroupName, String workspaceName) {
        PagedIterable<TemplateModelAutoGeneratedInner> inner =
            this.serviceClient().list(resourceGroupName, workspaceName);
        return Utils.mapPage(inner, inner1 -> new TemplateModelAutoGeneratedImpl(inner1, this.manager()));
    }

    public PagedIterable<TemplateModelAutoGenerated> list(
