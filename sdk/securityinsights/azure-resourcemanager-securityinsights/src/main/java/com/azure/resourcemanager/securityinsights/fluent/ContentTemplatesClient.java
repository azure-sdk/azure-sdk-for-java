...
public interface ContentTemplatesClient {
    ...
    PagedIterable<TemplateInner> list(String resourceGroupName, String sentinelWorkspaceName);
    ...
    Response<TemplateInner> getWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    TemplateInner get(String resourceGroupName, String sentinelWorkspaceName, String templateId);
