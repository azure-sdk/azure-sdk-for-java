...
public final class TemplatesClientImpl implements TemplatesClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<TemplateInner> getAsync(
        String resourceGroupName, String operationalInsightsResourceProvider, String workspaceName, String templateId) {
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return list all the installed templates along with {@link PagedResponse} on successful completion of {@link
     *     Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
