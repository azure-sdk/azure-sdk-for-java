...
public final class BookmarkRelationsClientImpl implements BookmarkRelationsClient {
    ...
    public interface BookmarkRelationsService {
        ...
        Mono<Response<RelationList>> list(@HostParam("$host") String endpoint,
            ...
            @PathParam("bookmarkId") String bookmarkId, @QueryParam("$filter") String filter,
        ...
        Mono<Response<RelationInner>> get(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("workspaceName") String workspaceName,
            @PathParam("bookmarkId") String bookmarkId, @PathParam("relationName") String relationName,
    ...
    private Mono<PagedResponse<RelationInner>> listSinglePageAsync(String resourceGroupName, String workspaceName,
        String bookmarkId, String filter, String orderby, Integer top, String skipToken) {
        ...
        return FluxUtil
            .withContext(context -> service.list(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(),
                resourceGroupName, workspaceName, bookmarkId, filter, orderby, top, skipToken, accept, context))
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<RelationInner>> listSinglePageAsync(String resourceGroupName, String workspaceName,
        String bookmarkId, String filter, String orderby, Integer top, String skipToken, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service
            .list(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(), resourceGroupName,
                workspaceName, bookmarkId, filter, orderby, top, skipToken, accept, context)
    ...
    private PagedFlux<RelationInner> listAsync(String resourceGroupName, String workspaceName, String bookmarkId,
        ...
        return new PagedFlux<>(() -> listSinglePageAsync(resourceGroupName, workspaceName, bookmarkId, filter, orderby,
    ...
    private Mono<Response<RelationInner>> getWithResponseAsync(String resourceGroupName, String workspaceName,
        String bookmarkId, String relationName) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return FluxUtil
            .withContext(context -> service.get(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(),
                resourceGroupName, workspaceName, bookmarkId, relationName, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<RelationInner>> getWithResponseAsync(String resourceGroupName, String workspaceName,
        String bookmarkId, String relationName, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service.get(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(), resourceGroupName,
            workspaceName, bookmarkId, relationName, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<RelationInner> getAsync(String resourceGroupName, String workspaceName, String bookmarkId,
        String relationName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<RelationInner> getWithResponse(String resourceGroupName, String workspaceName, String bookmarkId,
    ...
    private Mono<Response<RelationInner>> createOrUpdateWithResponseAsync(String resourceGroupName,
        String workspaceName, String bookmarkId, String relationName, RelationInner relation) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return FluxUtil
            .withContext(context -> service.createOrUpdate(this.client.getEndpoint(), apiVersion,
                this.client.getSubscriptionId(), resourceGroupName, workspaceName, bookmarkId, relationName, relation,
                accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<RelationInner>> createOrUpdateWithResponseAsync(String resourceGroupName,
        String workspaceName, String bookmarkId, String relationName, RelationInner relation, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service.createOrUpdate(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(),
            resourceGroupName, workspaceName, bookmarkId, relationName, relation, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<RelationInner> createOrUpdateAsync(String resourceGroupName, String workspaceName, String bookmarkId,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public RelationInner createOrUpdate(String resourceGroupName, String workspaceName, String bookmarkId,
        String relationName, RelationInner relation) {
        return createOrUpdateWithResponse(resourceGroupName, workspaceName, bookmarkId, relationName, relation,
