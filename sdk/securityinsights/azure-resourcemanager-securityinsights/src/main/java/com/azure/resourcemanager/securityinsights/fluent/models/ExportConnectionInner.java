...
public final class ExportConnectionInner extends ResourceWithEtag {
    ...
    public Integer runFrequencyInMinutes() {
        return this.innerProperties() == null ? null : this.innerProperties().runFrequencyInMinutes();
    }
     ...
     * @return the ExportConnectionInner object itself.
     */
    public ExportConnectionInner withRunFrequencyInMinutes(Integer runFrequencyInMinutes) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ExportConnectionProperties();
        }
        this.innerProperties().withRunFrequencyInMinutes(runFrequencyInMinutes);
        return this;
    }
