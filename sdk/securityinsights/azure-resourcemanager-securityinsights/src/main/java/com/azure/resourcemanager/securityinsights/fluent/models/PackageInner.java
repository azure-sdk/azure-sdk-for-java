...
public final class PackageInner extends ResourceWithEtag {
     ...
     * @return the PackageInner object itself.
     */
    public PackageInner withIsNew(Boolean isNew) {
        if (this.innerProperties() == null) {
            this.innerProperties = new PackageProperties();
        }
     ...
     * @return the PackageInner object itself.
     */
    public PackageInner withIsPreview(Boolean isPreview) {
        if (this.innerProperties() == null) {
            this.innerProperties = new PackageProperties();
        }
     ...
     * @return the PackageInner object itself.
     */
    public PackageInner withIsFeatured(Boolean isFeatured) {
        if (this.innerProperties() == null) {
            this.innerProperties = new PackageProperties();
        }
     ...
     * @return the PackageInner object itself.
     */
    public PackageInner withPublisherDisplayName(String publisherDisplayName) {
        if (this.innerProperties() == null) {
            this.innerProperties = new PackageProperties();
        }
     ...
     * @return the PackageInner object itself.
     */
    public PackageInner withSource(PackageSource source) {
        if (this.innerProperties() == null) {
            this.innerProperties = new PackageProperties();
        }
     ...
     * @return the PackageInner object itself.
     */
    public PackageInner withAuthor(Author author) {
        if (this.innerProperties() == null) {
            this.innerProperties = new PackageProperties();
        }
     ...
     * @return the PackageInner object itself.
     */
    public PackageInner withSupport(Support support) {
        if (this.innerProperties() == null) {
            this.innerProperties = new PackageProperties();
        }
     ...
     * @return the PackageInner object itself.
     */
    public PackageInner withDependencies(Dependency dependencies) {
        if (this.innerProperties() == null) {
            this.innerProperties = new PackageProperties();
        }
     ...
     * @return the PackageInner object itself.
     */
    public PackageInner withCategories(Category categories) {
        if (this.innerProperties() == null) {
            this.innerProperties = new PackageProperties();
        }
    ...
    public String packageContent() {
        return this.innerProperties() == null ? null : this.innerProperties().packageContent();
    }
     ...
     * @return the PackageInner object itself.
     */
    public PackageInner withPackageContent(String packageContent) {
        if (this.innerProperties() == null) {
            this.innerProperties = new PackageProperties();
        }
        this.innerProperties().withPackageContent(packageContent);
        return this;
    }
