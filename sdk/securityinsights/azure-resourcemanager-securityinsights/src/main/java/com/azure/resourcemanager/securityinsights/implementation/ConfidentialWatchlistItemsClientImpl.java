...
/** An instance of this class provides access to all the operations defined in ConfidentialWatchlistItemsClient. */
public final class ConfidentialWatchlistItemsClientImpl implements ConfidentialWatchlistItemsClient {
    /** The proxy service used to perform REST calls. */
    private final ConfidentialWatchlistItemsService service;

    /** The service client containing this operation class. */
    private final SecurityInsightsImpl client;

    /**
     * Initializes an instance of ConfidentialWatchlistItemsClientImpl.
     *
     * @param client the instance of the service client containing this operation class.
     */
    ConfidentialWatchlistItemsClientImpl(SecurityInsightsImpl client) {
        this.service =
            RestProxy
                .create(
                    ConfidentialWatchlistItemsService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for SecurityInsightsConfidentialWatchlistItems to be used by the proxy
     * service to perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "SecurityInsightsConf")
    private interface ConfidentialWatchlistItemsService {
        ...
        @Get(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OperationalInsights"
                + "/workspaces/{workspaceName}/providers/Microsoft.SecurityInsights/confidentialWatchlists"
                + "/{watchlistAlias}/watchlistItems/{watchlistItemId}")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
     ...
     * @return all confidential watchlist Items along with {@link PagedResponse} on successful completion of {@link
     *     Mono}.
     */
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return all confidential watchlist Items as paginated response with {@link PagedFlux}.
     */
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a confidential watchlist item along with {@link Response} on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a confidential watchlist item on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
