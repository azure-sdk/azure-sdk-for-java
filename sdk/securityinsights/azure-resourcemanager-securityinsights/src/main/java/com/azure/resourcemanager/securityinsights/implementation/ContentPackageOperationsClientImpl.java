...
public final class ContentPackageOperationsClientImpl implements ContentPackageOperationsClient {
    ...
    public PackageModelInner get(String resourceGroupName, String workspaceName, String packageId) {
        return getAsync(resourceGroupName, workspaceName, packageId).block();
    }
    ...
    public PackageModelInner install(
        ...
        String packageId,
        PackageInstallationProperties packageInstallationProperties) {
        return installAsync(resourceGroupName, workspaceName, packageId, packageInstallationProperties).block();
    }
    ...
    public void uninstall(String resourceGroupName, String workspaceName, String packageId) {
        uninstallAsync(resourceGroupName, workspaceName, packageId).block();
    }
