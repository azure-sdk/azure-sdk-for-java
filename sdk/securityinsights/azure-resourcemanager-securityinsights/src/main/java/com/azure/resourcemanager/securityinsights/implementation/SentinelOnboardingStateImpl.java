...
public final class SentinelOnboardingStateImpl implements SentinelOnboardingState, SentinelOnboardingState.Definition {
    ...
    public SentinelOnboardingState create() {
        this.innerObject
            = serviceManager.serviceClient().getSentinelOnboardingStates().createWithResponse(resourceGroupName,
                workspaceName, sentinelOnboardingStateName, this.innerModel(), Context.NONE).getValue();
        return this;
    }
    ...
    public SentinelOnboardingState create(Context context) {
        this.innerObject
            = serviceManager.serviceClient().getSentinelOnboardingStates().createWithResponse(resourceGroupName,
                workspaceName, sentinelOnboardingStateName, this.innerModel(), context).getValue();
        return this;
    }
    ...
    public SentinelOnboardingState refresh() {
        this.innerObject = serviceManager.serviceClient().getSentinelOnboardingStates()
            .getWithResponse(resourceGroupName, workspaceName, sentinelOnboardingStateName, Context.NONE).getValue();
        return this;
    }

    public SentinelOnboardingState refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getSentinelOnboardingStates()
            .getWithResponse(resourceGroupName, workspaceName, sentinelOnboardingStateName, context).getValue();
        return this;
    }
