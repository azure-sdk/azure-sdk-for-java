...
public final class WatchlistItemImpl implements WatchlistItem, WatchlistItem.Definition, WatchlistItem.Update {
    ...
    public WatchlistItem create() {
        this.innerObject
            = serviceManager.serviceClient().getWatchlistItems().createOrUpdateWithResponse(resourceGroupName,
                workspaceName, watchlistAlias, watchlistItemId, this.innerModel(), Context.NONE).getValue();
        return this;
    }
    ...
    public WatchlistItem create(Context context) {
        this.innerObject
            = serviceManager.serviceClient().getWatchlistItems().createOrUpdateWithResponse(resourceGroupName,
                workspaceName, watchlistAlias, watchlistItemId, this.innerModel(), context).getValue();
        return this;
    }
    ...
    public WatchlistItem refresh() {
        this.innerObject = serviceManager.serviceClient().getWatchlistItems()
    ...
    public WatchlistItem refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getWatchlistItems()
            .getWithResponse(resourceGroupName, workspaceName, watchlistAlias, watchlistItemId, context).getValue();
        return this;
    }
