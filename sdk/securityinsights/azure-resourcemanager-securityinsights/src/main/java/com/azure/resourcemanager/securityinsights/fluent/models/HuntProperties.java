...
public final class HuntProperties {
    ...
    /*
     * The sequential identifier for the hunt in a workspace
     */
    @JsonProperty(value = "huntSequenceNumber")
    private Integer huntSequenceNumber;
    ...
    /**
     * Get the huntSequenceNumber property: The sequential identifier for the hunt in a workspace.
     *
     * @return the huntSequenceNumber value.
     */
    public Integer huntSequenceNumber() {
        return this.huntSequenceNumber;
    }

    /**
     * Set the huntSequenceNumber property: The sequential identifier for the hunt in a workspace.
     *
     * @param huntSequenceNumber the huntSequenceNumber value to set.
     * @return the HuntProperties object itself.
     */
    public HuntProperties withHuntSequenceNumber(Integer huntSequenceNumber) {
        this.huntSequenceNumber = huntSequenceNumber;
        return this;
    }
