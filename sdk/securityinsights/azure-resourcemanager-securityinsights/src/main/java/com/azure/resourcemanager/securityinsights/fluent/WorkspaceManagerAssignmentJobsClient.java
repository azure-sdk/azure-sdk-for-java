 ...
 */
public interface WorkspaceManagerAssignmentJobsClient {
    /**
    ...
    PagedIterable<JobInner> list(String resourceGroupName, String workspaceName, String workspaceManagerAssignmentName);
    ...
    Response<JobInner> createWithResponse(String resourceGroupName, String workspaceName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<JobInner> getWithResponse(String resourceGroupName, String workspaceName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    JobInner get(String resourceGroupName, String workspaceName, String workspaceManagerAssignmentName, String jobName);
