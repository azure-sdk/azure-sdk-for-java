...
public final class ThreatIntelligenceIndicatorsClientImpl implements ThreatIntelligenceIndicatorsClient {
    ...
    private Mono<Response<ThreatIntelligenceInformationInner>> createIndicatorWithResponseAsync(
        ...
        return FluxUtil
            .withContext(context -> service.createIndicator(this.client.getEndpoint(), apiVersion,
    ...
    private Mono<Response<ThreatIntelligenceInformationInner>> createIndicatorWithResponseAsync(
        ...
        return service.createIndicator(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(),
            resourceGroupName, workspaceName, threatIntelligenceProperties, accept, context);
    }
    ...
    private Mono<Response<ThreatIntelligenceInformationInner>> getWithResponseAsync(String resourceGroupName,
        ...
        return service.get(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(), resourceGroupName,
            workspaceName, name, accept, context);
    }
    ...
    private Mono<Response<ThreatIntelligenceInformationInner>> createWithResponseAsync(String resourceGroupName,
        ...
        return service.create(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(), resourceGroupName,
            workspaceName, name, threatIntelligenceProperties, accept, context);
    }
    ...
    private Mono<PagedResponse<ThreatIntelligenceInformationInner>> queryIndicatorsSinglePageAsync(
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.queryIndicators(this.client.getEndpoint(), apiVersion,
    ...
    private Mono<PagedResponse<ThreatIntelligenceInformationInner>> queryIndicatorsSinglePageAsync(
        ...
        context = this.client.mergeContext(context);
        return service
            .queryIndicators(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(), resourceGroupName,
                workspaceName, threatIntelligenceFilteringCriteria, accept, context)
    ...
    private Mono<Response<Void>> appendTagsWithResponseAsync(String resourceGroupName, String workspaceName,
        ...
        return FluxUtil
            .withContext(
                context -> service.appendTags(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(),
                    resourceGroupName, workspaceName, name, threatIntelligenceAppendTags, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<Void>> appendTagsWithResponseAsync(String resourceGroupName, String workspaceName,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.appendTags(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(),
            resourceGroupName, workspaceName, name, threatIntelligenceAppendTags, accept, context);
    }
    ...
    private Mono<Response<ThreatIntelligenceInformationInner>> replaceTagsWithResponseAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(
                context -> service.replaceTags(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(),
                    resourceGroupName, workspaceName, name, threatIntelligenceReplaceTags, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<ThreatIntelligenceInformationInner>> replaceTagsWithResponseAsync(String resourceGroupName,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.replaceTags(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(),
            resourceGroupName, workspaceName, name, threatIntelligenceReplaceTags, accept, context);
    }
