...
/** An instance of this class provides access to all the operations defined in ConfidentialWatchlistsClient. */
public final class ConfidentialWatchlistsClientImpl implements ConfidentialWatchlistsClient {
    /** The proxy service used to perform REST calls. */
    private final ConfidentialWatchlistsService service;

    /** The service client containing this operation class. */
    private final SecurityInsightsImpl client;

    /**
     * Initializes an instance of ConfidentialWatchlistsClientImpl.
     *
     * @param client the instance of the service client containing this operation class.
     */
    ConfidentialWatchlistsClientImpl(SecurityInsightsImpl client) {
        this.service =
            RestProxy
                .create(ConfidentialWatchlistsService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for SecurityInsightsConfidentialWatchlists to be used by the proxy
     * service to perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "SecurityInsightsConf")
    private interface ConfidentialWatchlistsService {
        @Headers({"Content-Type: application/json"})
        @Get(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OperationalInsights"
                + "/workspaces/{workspaceName}/providers/Microsoft.SecurityInsights/confidentialWatchlists")
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<ConfidentialWatchlistsDeleteResponse> delete(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<ConfidentialWatchlistsCreateOrUpdateResponse> createOrUpdate(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
    ...
    /**
     * Gets all confidential watchlists, without watchlist items.
     *
     ...
     * @return all confidential watchlists, without watchlist items along with {@link PagedResponse} on successful
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return all confidential watchlists, without watchlist items as paginated response with {@link PagedFlux}.
     */
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return all confidential watchlists, without watchlist items as paginated response with {@link PagedIterable}.
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    ...
    /**
     * Gets a confidential watchlist, without its watchlist items.
     *
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
     * @param workspaceName The name of the workspace.
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a confidential watchlist, without its watchlist items along with {@link Response} on successful
     *     completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a confidential watchlist, without its watchlist items on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a confidential watchlist, without its watchlist items.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a confidential watchlist, without its watchlist items along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ConfidentialWatchlistsDeleteResponse> deleteWithResponseAsync(
        String resourceGroupName, String workspaceName, String watchlistAlias) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String workspaceName, String watchlistAlias) {
        return deleteWithResponseAsync(resourceGroupName, workspaceName, watchlistAlias)
            .flatMap((ConfidentialWatchlistsDeleteResponse res) -> Mono.empty());
    }
    ...
    /**
     * Create or update a confidential Watchlist and its Watchlist Items (bulk creation, e.g. through text/csv content
     * type). To create a Watchlist and its Items, we should call this endpoint with either rawContent or a valid SAR
     * URI and contentType properties. The rawContent is mainly used for small watchlist (content size below 3.8 MB).
     * The SAS URI enables the creation of large watchlist, where the content size can go up to 500 MB. The status of
     * processing such large file can be polled through the URL returned in Azure-AsyncOperation header.
     *
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
     * @param workspaceName The name of the workspace.
     * @param watchlistAlias Watchlist Alias.
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ConfidentialWatchlistsCreateOrUpdateResponse> createOrUpdateWithResponseAsync(
    ...
    private Mono<WatchlistInner> createOrUpdateAsync(
        ...
        return createOrUpdateWithResponseAsync(resourceGroupName, workspaceName, watchlistAlias, watchlist)
            .flatMap(
                (ConfidentialWatchlistsCreateOrUpdateResponse res) -> {
                    if (res.getValue() != null) {
                        return Mono.just(res.getValue());
                    } else {
                        return Mono.empty();
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ConfidentialWatchlistsCreateOrUpdateResponse createOrUpdateWithResponse(
        String resourceGroupName,
        String workspaceName,
        String watchlistAlias,
        WatchlistInner watchlist,
