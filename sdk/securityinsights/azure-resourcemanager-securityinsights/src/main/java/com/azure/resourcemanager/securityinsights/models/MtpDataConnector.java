...
public final class MtpDataConnector extends DataConnectorInner {
    ...
    /**
     * Reads an instance of MtpDataConnector from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of MtpDataConnector if the JsonReader was pointing to an instance of it, or null if it was
     * pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the MtpDataConnector.
     */
    public static MtpDataConnector fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            MtpDataConnector deserializedMtpDataConnector = new MtpDataConnector();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("id".equals(fieldName)) {
                    deserializedMtpDataConnector.id = reader.getString();
                } else if ("name".equals(fieldName)) {
                    deserializedMtpDataConnector.name = reader.getString();
                } else if ("type".equals(fieldName)) {
                    deserializedMtpDataConnector.type = reader.getString();
                } else if ("etag".equals(fieldName)) {
                    deserializedMtpDataConnector.withEtag(reader.getString());
                } else if ("systemData".equals(fieldName)) {
                    deserializedMtpDataConnector.systemData = SystemData.fromJson(reader);
                } else if ("kind".equals(fieldName)) {
                    deserializedMtpDataConnector.kind = DataConnectorKind.fromString(reader.getString());
                } else if ("properties".equals(fieldName)) {
                    deserializedMtpDataConnector.innerProperties = MtpDataConnectorProperties.fromJson(reader);
                } else {
                    reader.skipChildren();
                }
            }

            return deserializedMtpDataConnector;
        });
    }
}
