...
public final class ThreatIntelligenceAlertRuleTemplate extends AlertRuleTemplateInner {
    ...
    /**
     * Reads an instance of ThreatIntelligenceAlertRuleTemplate from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of ThreatIntelligenceAlertRuleTemplate if the JsonReader was pointing to an instance of it,
     * or null if it was pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the ThreatIntelligenceAlertRuleTemplate.
     */
    public static ThreatIntelligenceAlertRuleTemplate fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ThreatIntelligenceAlertRuleTemplate deserializedThreatIntelligenceAlertRuleTemplate
                = new ThreatIntelligenceAlertRuleTemplate();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("id".equals(fieldName)) {
                    deserializedThreatIntelligenceAlertRuleTemplate.id = reader.getString();
                } else if ("name".equals(fieldName)) {
                    deserializedThreatIntelligenceAlertRuleTemplate.name = reader.getString();
                } else if ("type".equals(fieldName)) {
                    deserializedThreatIntelligenceAlertRuleTemplate.type = reader.getString();
                } else if ("systemData".equals(fieldName)) {
                    deserializedThreatIntelligenceAlertRuleTemplate.systemData = SystemData.fromJson(reader);
                } else if ("kind".equals(fieldName)) {
                    deserializedThreatIntelligenceAlertRuleTemplate.kind = AlertRuleKind.fromString(reader.getString());
                } else if ("properties".equals(fieldName)) {
                    deserializedThreatIntelligenceAlertRuleTemplate.innerProperties
                        = ThreatIntelligenceAlertRuleTemplateProperties.fromJson(reader);
                } else {
                    reader.skipChildren();
                }
            }

            return deserializedThreatIntelligenceAlertRuleTemplate;
        });
    }
}
