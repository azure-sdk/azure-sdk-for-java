...
/** An immutable client-side representation of TemplateModelAutoGenerated. */
public interface TemplateModelAutoGenerated {
    /**
    ...
    /**
     * Gets the tags property: The tags of the content item.
     *
    ...
    /**
     * Gets the inner com.azure.resourcemanager.securityinsights.fluent.models.TemplateModelAutoGeneratedInner object.
     *
     * @return the inner object.
     */
    TemplateModelAutoGeneratedInner innerModel();

    /** The entirety of the TemplateModelAutoGenerated definition. */
    ...
    /** The TemplateModelAutoGenerated definition stages. */
    interface DefinitionStages {
        /** The first stage of the TemplateModelAutoGenerated definition. */
        interface Blank extends WithParentResource {
        }
        /** The stage of the TemplateModelAutoGenerated definition allowing to specify parent resource. */
        interface WithParentResource {
             ...
             */
            WithContentId withExistingWorkspace(String resourceGroupName, String workspaceName);
        }
        /** The stage of the TemplateModelAutoGenerated definition allowing to specify contentId. */
        interface WithContentId {
             ...
             * @return the next definition stage.
             */
            WithVersion withContentId(String contentId);
        }
        /** The stage of the TemplateModelAutoGenerated definition allowing to specify version. */
        interface WithVersion {
             ...
             * @return the next definition stage.
             */
            WithDisplayName withVersion(String version);
        }
        /** The stage of the TemplateModelAutoGenerated definition allowing to specify displayName. */
        interface WithDisplayName {
             ...
             * @return the next definition stage.
             */
            WithContentKind withDisplayName(String displayName);
        }
        /** The stage of the TemplateModelAutoGenerated definition allowing to specify contentKind. */
        interface WithContentKind {
             ...
             * @return the next definition stage.
             */
            WithSource withContentKind(Kind contentKind);
        }
        /** The stage of the TemplateModelAutoGenerated definition allowing to specify source. */
        ...
        /**
         * The stage of the TemplateModelAutoGenerated definition which contains all the minimum required properties for
        ...
        interface WithCreate
             ...
             */
            TemplateModelAutoGenerated create();
             ...
             * @return the created resource.
             */
            TemplateModelAutoGenerated create(Context context);
        }
        /** The stage of the TemplateModelAutoGenerated definition allowing to specify tags. */
        interface WithTags {
            /**
             * Specifies the tags property: The tags of the content item.
             *
             * @param tags The tags of the content item.
             * @return the next definition stage.
             */
            WithCreate withTags(List<String> tags);
        }
        /** The stage of the TemplateModelAutoGenerated definition allowing to specify parentId. */
        interface WithParentId {
            /**
             * Specifies the parentId property: Full parent resource ID of the content item the template is for. This is
             * the full resource ID including the scope (subscription and resource group).
             *
             * @param parentId Full parent resource ID of the content item the template is for. This is the full
             *     resource ID including the scope (subscription and resource group).
             * @return the next definition stage.
             */
            WithCreate withParentId(String parentId);
        }
        /** The stage of the TemplateModelAutoGenerated definition allowing to specify author. */
        ...
        /** The stage of the TemplateModelAutoGenerated definition allowing to specify support. */
        ...
        /** The stage of the TemplateModelAutoGenerated definition allowing to specify dependencies. */
        ...
        /** The stage of the TemplateModelAutoGenerated definition allowing to specify categories. */
        ...
        /** The stage of the TemplateModelAutoGenerated definition allowing to specify providers. */
        ...
        /** The stage of the TemplateModelAutoGenerated definition allowing to specify firstPublishDate. */
        ...
        /** The stage of the TemplateModelAutoGenerated definition allowing to specify lastPublishDate. */
        ...
        /** The stage of the TemplateModelAutoGenerated definition allowing to specify customVersion. */
        ...
        /** The stage of the TemplateModelAutoGenerated definition allowing to specify contentSchemaVersion. */
        ...
        /** The stage of the TemplateModelAutoGenerated definition allowing to specify icon. */
        interface WithIcon {
            /**
        ...
        /** The stage of the TemplateModelAutoGenerated definition allowing to specify threatAnalysisTactics. */
        ...
        /** The stage of the TemplateModelAutoGenerated definition allowing to specify threatAnalysisTechniques. */
        ...
        /** The stage of the TemplateModelAutoGenerated definition allowing to specify previewImages. */
        ...
        /** The stage of the TemplateModelAutoGenerated definition allowing to specify previewImagesDark. */
        ...
        /** The stage of the TemplateModelAutoGenerated definition allowing to specify packageId. */
        ...
        /** The stage of the TemplateModelAutoGenerated definition allowing to specify packageKind. */
        ...
        /** The stage of the TemplateModelAutoGenerated definition allowing to specify packageName. */
        ...
        /** The stage of the TemplateModelAutoGenerated definition allowing to specify mainTemplate. */
        interface WithMainTemplate {
            /**
             * Specifies the mainTemplate property: The JSON string of the template.
             *
             * @param mainTemplate The JSON string of the template.
             * @return the next definition stage.
             */
    ...
    /**
     * Begins update for the TemplateModelAutoGenerated resource.
     *
     * @return the stage of resource update.
     */
    TemplateModelAutoGenerated.Update update();

    /** The template for TemplateModelAutoGenerated update. */
    interface Update
         ...
         */
        TemplateModelAutoGenerated apply();
         ...
         * @return the updated resource.
         */
        TemplateModelAutoGenerated apply(Context context);
    }
    /** The TemplateModelAutoGenerated update stages. */
    interface UpdateStages {
        /** The stage of the TemplateModelAutoGenerated update allowing to specify tags. */
        interface WithTags {
            /**
             * Specifies the tags property: The tags of the content item.
             *
        ...
        /** The stage of the TemplateModelAutoGenerated update allowing to specify contentId. */
        interface WithContentId {
            /**
             * Specifies the contentId property: Static ID for the content. Used to identify dependencies and content
             * from solutions or community. Hard-coded/static for out of the box content and solutions. Dynamic for
        ...
        /** The stage of the TemplateModelAutoGenerated update allowing to specify parentId. */
        interface WithParentId {
            /**
             * Specifies the parentId property: Full parent resource ID of the content item the template is for. This is
             * the full resource ID including the scope (subscription and resource group).
        ...
        /** The stage of the TemplateModelAutoGenerated update allowing to specify version. */
        interface WithVersion {
            /**
             * Specifies the version property: Version of the content. Default and recommended format is numeric (e.g.
             * 1, 1.0, 1.0.0, 1.0.0.0), following ARM metadata best practices. Can also be any string, but then we
        ...
        /** The stage of the TemplateModelAutoGenerated update allowing to specify displayName. */
        interface WithDisplayName {
            /**
             * Specifies the displayName property: The display name of the template.
             *
        ...
        /** The stage of the TemplateModelAutoGenerated update allowing to specify contentKind. */
        interface WithContentKind {
            /**
             * Specifies the contentKind property: The kind of content the template is for..
             *
        ...
        /** The stage of the TemplateModelAutoGenerated update allowing to specify source. */
        interface WithSource {
            /**
             * Specifies the source property: Source of the content. This is where/how it was created..
             *
        ...
        /** The stage of the TemplateModelAutoGenerated update allowing to specify author. */
        interface WithAuthor {
            /**
             * Specifies the author property: The creator of the content item..
             *
        ...
        /** The stage of the TemplateModelAutoGenerated update allowing to specify support. */
        interface WithSupport {
            /**
             * Specifies the support property: Support information for the template - type, name, contact information.
             *
        ...
        /** The stage of the TemplateModelAutoGenerated update allowing to specify dependencies. */
        interface WithDependencies {
            /**
             * Specifies the dependencies property: Dependencies for the content item, what other content items it
             * requires to work. Can describe more complex dependencies using a recursive/nested structure. For a single
        ...
        /** The stage of the TemplateModelAutoGenerated update allowing to specify categories. */
        interface WithCategories {
            /**
             * Specifies the categories property: Categories for the item.
             *
        ...
        /** The stage of the TemplateModelAutoGenerated update allowing to specify providers. */
        interface WithProviders {
            /**
             * Specifies the providers property: Providers for the content item.
             *
        ...
        /** The stage of the TemplateModelAutoGenerated update allowing to specify firstPublishDate. */
        interface WithFirstPublishDate {
            /**
             * Specifies the firstPublishDate property: first publish date content item.
             *
        ...
        /** The stage of the TemplateModelAutoGenerated update allowing to specify lastPublishDate. */
        interface WithLastPublishDate {
            /**
             * Specifies the lastPublishDate property: last publish date for the content item.
             *
        ...
        /** The stage of the TemplateModelAutoGenerated update allowing to specify customVersion. */
        interface WithCustomVersion {
            /**
             * Specifies the customVersion property: The custom version of the content. A optional free text.
             *
        ...
        /** The stage of the TemplateModelAutoGenerated update allowing to specify contentSchemaVersion. */
        interface WithContentSchemaVersion {
            /**
             * Specifies the contentSchemaVersion property: Schema version of the content. Can be used to distinguish
             * between different flow based on the schema version.
        ...
        /** The stage of the TemplateModelAutoGenerated update allowing to specify icon. */
        interface WithIcon {
            /**
             * Specifies the icon property: the icon identifier. this id can later be fetched from the content metadata.
             *
        ...
        /** The stage of the TemplateModelAutoGenerated update allowing to specify threatAnalysisTactics. */
        interface WithThreatAnalysisTactics {
            /**
             * Specifies the threatAnalysisTactics property: the tactics the resource covers.
             *
        ...
        /** The stage of the TemplateModelAutoGenerated update allowing to specify threatAnalysisTechniques. */
        interface WithThreatAnalysisTechniques {
            /**
             * Specifies the threatAnalysisTechniques property: the techniques the resource covers, these have to be
             * aligned with the tactics being used.
        ...
        /** The stage of the TemplateModelAutoGenerated update allowing to specify previewImages. */
        interface WithPreviewImages {
            /**
             * Specifies the previewImages property: preview image file names. These will be taken from the solution
             * artifacts.
        ...
        /** The stage of the TemplateModelAutoGenerated update allowing to specify previewImagesDark. */
        interface WithPreviewImagesDark {
            /**
             * Specifies the previewImagesDark property: preview image file names. These will be taken from the solution
             * artifacts. used for dark theme support.
        ...
        /** The stage of the TemplateModelAutoGenerated update allowing to specify packageId. */
        interface WithPackageId {
            /**
             * Specifies the packageId property: the package Id contains this template.
             *
        ...
        /** The stage of the TemplateModelAutoGenerated update allowing to specify packageKind. */
        interface WithPackageKind {
            /**
             * Specifies the packageKind property: the packageKind of the package contains this template.
             *
        ...
        /** The stage of the TemplateModelAutoGenerated update allowing to specify packageName. */
        interface WithPackageName {
            /**
             * Specifies the packageName property: the name of the package contains this template.
             *
        ...
        /** The stage of the TemplateModelAutoGenerated update allowing to specify mainTemplate. */
        interface WithMainTemplate {
            /**
             * Specifies the mainTemplate property: The JSON string of the template.
             *
     ...
     */
    TemplateModelAutoGenerated refresh();
     ...
     * @return the refreshed resource.
     */
    TemplateModelAutoGenerated refresh(Context context);
}
