...
public final class ExportConnectionProperties {
    ...
    /*
     * The next export run time in the format of a UTC date string.
     */
    @JsonProperty(value = "nextScheduledTime")
    private String nextScheduledTime;

    /*
     * Export frequency of connection in minutes (int)
     */
    @JsonProperty(value = "runFrequencyInMinutes")
    ...
    /**
     * Get the nextScheduledTime property: The next export run time in the format of a UTC date string.
     *
    ...
    /**
     * Set the nextScheduledTime property: The next export run time in the format of a UTC date string.
     *
    ...
    /**
     * Get the runFrequencyInMinutes property: Export frequency of connection in minutes (int).
     *
     * @return the runFrequencyInMinutes value.
     */
    public Integer runFrequencyInMinutes() {
        return this.runFrequencyInMinutes;
    }

    /**
     * Set the runFrequencyInMinutes property: Export frequency of connection in minutes (int).
     *
     * @param runFrequencyInMinutes the runFrequencyInMinutes value to set.
     * @return the ExportConnectionProperties object itself.
     */
    public ExportConnectionProperties withRunFrequencyInMinutes(Integer runFrequencyInMinutes) {
