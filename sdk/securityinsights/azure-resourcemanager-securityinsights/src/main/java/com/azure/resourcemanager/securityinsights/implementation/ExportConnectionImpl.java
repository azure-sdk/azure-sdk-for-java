...
public final class ExportConnectionImpl implements ExportConnection, ExportConnection.Definition {
    ...
    public Integer runFrequencyInMinutes() {
        return this.innerModel().runFrequencyInMinutes();
    }
    ...
    public ExportConnectionImpl withRunFrequencyInMinutes(Integer runFrequencyInMinutes) {
        this.innerModel().withRunFrequencyInMinutes(runFrequencyInMinutes);
        return this;
    }
}
