...
public final class SummariesClientImpl implements SummariesClient {
    ...
    private interface SummariesService {
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<SummariesCreateOrUpdateResponse> createOrUpdate(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<SummariesCreateOrUpdateResponse> createOrUpdateWithResponseAsync(
    ...
    private Mono<SummaryInner> createOrUpdateAsync(
        String resourceGroupName, String workspaceName, String summaryId, SummaryInner summary) {
        return createOrUpdateWithResponseAsync(resourceGroupName, workspaceName, summaryId, summary)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public SummariesCreateOrUpdateResponse createOrUpdateWithResponse(
        String resourceGroupName, String workspaceName, String summaryId, SummaryInner summary, Context context) {
        return createOrUpdateWithResponseAsync(resourceGroupName, workspaceName, summaryId, summary, context).block();
    }
    ...
    public SummaryInner createOrUpdate(
        String resourceGroupName, String workspaceName, String summaryId, SummaryInner summary) {
        return createOrUpdateWithResponse(resourceGroupName, workspaceName, summaryId, summary, Context.NONE)
            .getValue();
    }
