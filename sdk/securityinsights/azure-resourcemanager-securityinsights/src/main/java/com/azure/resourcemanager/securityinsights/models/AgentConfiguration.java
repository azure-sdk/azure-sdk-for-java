 ...
 */
@Immutable
public class AgentConfiguration implements JsonSerializable<AgentConfiguration> {
    /*
     * Type of the agent
     */
    private AgentType type = AgentType.fromString("AgentConfiguration");
        ...
        return jsonReader.readObject(reader -> {
            ...
            try (JsonReader readerToUse = reader.bufferObject()) {
                ...
                if ("SAP".equals(discriminatorValue)) {
                    return SapAgentConfiguration.fromJson(readerToUse.reset());
                } else {
    ...
    static AgentConfiguration fromJsonKnownDiscriminator(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("type".equals(fieldName)) {
                    deserializedAgentConfiguration.type = AgentType.fromString(reader.getString());
                } else {
                    reader.skipChildren();
                }
            }
