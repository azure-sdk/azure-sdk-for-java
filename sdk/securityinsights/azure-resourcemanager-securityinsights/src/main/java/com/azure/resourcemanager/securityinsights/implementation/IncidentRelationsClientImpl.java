...
public final class IncidentRelationsClientImpl implements IncidentRelationsClient {
    ...
    /**
     * Initializes an instance of IncidentRelationsClientImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    IncidentRelationsClientImpl(SecurityInsightsImpl client) {
        this.service
            = RestProxy.create(IncidentRelationsService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for SecurityInsightsIncidentRelations to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{$host}")
    ...
    public interface IncidentRelationsService {
        ...
        Mono<Response<RelationList>> list(@HostParam("$host") String endpoint,
            ...
            @PathParam("incidentId") String incidentId, @QueryParam("$filter") String filter,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<RelationInner>> get(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("workspaceName") String workspaceName,
            @PathParam("incidentId") String incidentId, @PathParam("relationName") String relationName,
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<RelationInner>> createOrUpdate(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("workspaceName") String workspaceName,
            @PathParam("incidentId") String incidentId, @PathParam("relationName") String relationName,
            @BodyParam("application/json") RelationInner relation, @HeaderParam("Accept") String accept,
            Context context);
     ...
     * @return all relations for a given incident along with {@link PagedResponse} on successful completion of
     * {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<RelationInner>> listSinglePageAsync(String resourceGroupName, String workspaceName,
        String incidentId, String filter, String orderby, Integer top, String skipToken) {
        ...
        return FluxUtil
            .withContext(context -> service.list(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, workspaceName, incidentId, filter, orderby, top,
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<RelationInner>> listSinglePageAsync(String resourceGroupName, String workspaceName,
        String incidentId, String filter, String orderby, Integer top, String skipToken, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service
            .list(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
                resourceGroupName, workspaceName, incidentId, filter, orderby, top, skipToken, accept, context)
    ...
    private PagedFlux<RelationInner> listAsync(String resourceGroupName, String workspaceName, String incidentId,
        ...
        return new PagedFlux<>(() -> listSinglePageAsync(resourceGroupName, workspaceName, incidentId, filter, orderby,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<RelationInner>> getWithResponseAsync(String resourceGroupName, String workspaceName,
        String incidentId, String relationName) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return FluxUtil
            .withContext(context -> service.get(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, workspaceName, incidentId, relationName, accept,
                context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<RelationInner>> getWithResponseAsync(String resourceGroupName, String workspaceName,
        String incidentId, String relationName, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service.get(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, workspaceName, incidentId, relationName, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<RelationInner> getAsync(String resourceGroupName, String workspaceName, String incidentId,
        String relationName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<RelationInner> getWithResponse(String resourceGroupName, String workspaceName, String incidentId,
        String relationName, Context context) {
        return getWithResponseAsync(resourceGroupName, workspaceName, incidentId, relationName, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<RelationInner>> createOrUpdateWithResponseAsync(String resourceGroupName,
        String workspaceName, String incidentId, String relationName, RelationInner relation) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return FluxUtil
            .withContext(context -> service.createOrUpdate(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, workspaceName, incidentId, relationName, relation,
                accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<RelationInner>> createOrUpdateWithResponseAsync(String resourceGroupName,
        String workspaceName, String incidentId, String relationName, RelationInner relation, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<RelationInner> createOrUpdateAsync(String resourceGroupName, String workspaceName, String incidentId,
        String relationName, RelationInner relation) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<RelationInner> createOrUpdateWithResponse(String resourceGroupName, String workspaceName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public RelationInner createOrUpdate(String resourceGroupName, String workspaceName, String incidentId,
        String relationName, RelationInner relation) {
        return createOrUpdateWithResponse(resourceGroupName, workspaceName, incidentId, relationName, relation,
