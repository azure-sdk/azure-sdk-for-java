...
public final class RecommendationInner {
    ...
    public void validate() {
        ...
        if (creationTimeUtc() == null) {
            throw LOGGER.logExceptionAsError(
                new IllegalArgumentException("Missing required property creationTimeUtc in model RecommendationInner"));
        }
        ...
        if (lastModifiedTimeUtc() == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
                "Missing required property lastModifiedTimeUtc in model RecommendationInner"));
        }
        if (suggestions() == null) {
            throw LOGGER.logExceptionAsError(
                new IllegalArgumentException("Missing required property suggestions in model RecommendationInner"));
        } else {
