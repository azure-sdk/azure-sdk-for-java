...
public interface ContentTemplates {
     ...
     */
    PagedIterable<TemplateModel> list(String resourceGroupName, String workspaceName);
     ...
     * - properties/dependantTemplates as paginated response with {@link PagedIterable}.
     */
    PagedIterable<TemplateModel> list(String resourceGroupName, String workspaceName, String filter, String orderby,
        String expand, String search, Boolean count, Integer top, Integer skip, String skipToken, Context context);
}
