...
public final class PackageProperties {
    ...
    /**
     * Get the contentId property: The package id.
     *
    ...
    /**
     * Set the contentId property: The package id.
     *
    ...
    public void validate() {
        if (contentId() == null) {
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException("Missing required property contentId in model PackageProperties"));
        }
        if (contentKind() == null) {
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException("Missing required property contentKind in model PackageProperties"));
        }
        if (version() == null) {
            throw LOGGER
                .logExceptionAsError(
