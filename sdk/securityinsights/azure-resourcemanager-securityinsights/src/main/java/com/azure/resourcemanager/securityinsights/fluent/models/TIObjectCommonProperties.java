        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("data".equals(fieldName)) {
                    ...
                    deserializedTIObjectCommonProperties.createdBy = UserInfoAutoGenerated.fromJson(reader);
                    ...
                    deserializedTIObjectCommonProperties.lastModifiedBy = UserInfoAutoGenerated.fromJson(reader);
