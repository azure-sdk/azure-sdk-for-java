...
public final class OperationAutoGeneratedInner {
     ...
     * @return the OperationAutoGeneratedInner object itself.
     */
    public OperationAutoGeneratedInner withName(String name) {
        this.name = name;
        return this;
    }
     ...
     * @return the OperationAutoGeneratedInner object itself.
     */
    public OperationAutoGeneratedInner withOrigin(String origin) {
        this.origin = origin;
        return this;
    }
     ...
     * @return the OperationAutoGeneratedInner object itself.
     */
    public OperationAutoGeneratedInner withIsDataAction(Boolean isDataAction) {
