...
public final class IncidentsClientImpl implements IncidentsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> runPlaybookAsync(String resourceGroupName, String workspaceName, String incidentIdentifier) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public void runPlaybook(String resourceGroupName, String workspaceName, String incidentIdentifier) {
        final ManualTriggerRequestBody requestBody = null;
        runPlaybookWithResponse(resourceGroupName, workspaceName, incidentIdentifier, requestBody, Context.NONE);
    }
