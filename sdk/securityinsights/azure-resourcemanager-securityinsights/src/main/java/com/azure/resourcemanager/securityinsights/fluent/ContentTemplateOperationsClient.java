...
public interface ContentTemplateOperationsClient {
    ...
    Response<TemplateModelAutoGeneratedInner> installWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    TemplateModelAutoGeneratedInner install(
        String resourceGroupName,
        String workspaceName,
        String templateId,
        TemplatePropertiesAutoGenerated templateInstallationProperties);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<TemplateModelAutoGeneratedInner> getWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    TemplateModelAutoGeneratedInner get(String resourceGroupName, String workspaceName, String templateId);
