...
public final class Tier extends ExpandableStringEnum<Tier> {
    /** Static value Microsoft for Tier. */
    public static final Tier MICROSOFT = fromString("Microsoft");

    /** Static value Partner for Tier. */
    public static final Tier PARTNER = fromString("Partner");

    /** Static value Community for Tier. */
    public static final Tier COMMUNITY = fromString("Community");
