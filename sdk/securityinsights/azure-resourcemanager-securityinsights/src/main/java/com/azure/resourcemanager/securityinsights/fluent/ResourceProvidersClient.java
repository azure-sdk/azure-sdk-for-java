...
public interface ResourceProvidersClient {
    ...
    Response<EnrichmentIpGeodataAutoGeneratedInner> listGeodataByIpWithResponse(String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    EnrichmentIpGeodataAutoGeneratedInner listGeodataByIp(String resourceGroupName, String workspaceName,
