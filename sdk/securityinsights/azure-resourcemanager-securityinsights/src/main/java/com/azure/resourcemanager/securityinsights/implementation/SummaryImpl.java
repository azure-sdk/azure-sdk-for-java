    ...
    public Summary create() {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getSummaries()
                .createOrUpdate(resourceGroupName, workspaceName, summaryId, this.innerModel(), Context.NONE);
        return this;
    }
    ...
    public Summary create(Context context) {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getSummaries()
                .createOrUpdate(resourceGroupName, workspaceName, summaryId, this.innerModel(), context);
        return this;
    }
