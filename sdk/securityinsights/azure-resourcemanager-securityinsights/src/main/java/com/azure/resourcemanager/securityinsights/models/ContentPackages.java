...
public interface ContentPackages {
     ...
     */
    PagedIterable<Package> list(String resourceGroupName, String sentinelWorkspaceName);
     ...
     */
    Response<Package> getWithResponse(
     ...
     */
    Package get(String resourceGroupName, String sentinelWorkspaceName, String packageId);
     ...
     */
    Response<Package> installWithResponse(
        String resourceGroupName,
        String sentinelWorkspaceName,
        String packageId,
     ...
     * @return represents a Package in Azure Security Insights along with {@link Response}.
     */
    Response<Package> uninstallWithResponse(
        String resourceGroupName, String sentinelWorkspaceName, String packageId, Context context);
     ...
     * @return represents a Package in Azure Security Insights.
     */
    Package uninstall(String resourceGroupName, String sentinelWorkspaceName, String packageId);
}
