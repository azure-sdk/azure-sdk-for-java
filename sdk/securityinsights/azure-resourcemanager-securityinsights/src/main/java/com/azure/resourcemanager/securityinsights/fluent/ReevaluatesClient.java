 ...
 */
public interface ReevaluatesClient {
    /**
    ...
    Response<ReevaluateResponseInner> recommendationWithResponse(String resourceGroupName, String workspaceName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ReevaluateResponseInner recommendation(String resourceGroupName, String workspaceName, UUID recommendationId);
}
