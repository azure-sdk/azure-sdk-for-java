...
public final class DataConnectorDefinitionsClientImpl implements DataConnectorDefinitionsClient {
    ...
    public interface DataConnectorDefinitionsService {
        ...
        Mono<Response<ConnectorDefinitionBaseArmCollectionWrapperInner>> list(
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ConnectorDefinitionBaseArmObjectWrapperInner>> get(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("workspaceName") String workspaceName,
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ConnectorDefinitionBaseArmObjectWrapperInner>> createOrUpdate(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("workspaceName") String workspaceName,
            ...
            @BodyParam("application/json")
                ConnectorDefinitionBaseArmObjectWrapperWithConverter connectorDefinitionInput,
            @HeaderParam("Accept") String accept,
            Context context);
    ...
    private Mono<Response<ConnectorDefinitionBaseArmCollectionWrapperInner>> listWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ConnectorDefinitionBaseArmCollectionWrapperInner> listAsync(
        String resourceGroupName, String workspaceName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ConnectorDefinitionBaseArmCollectionWrapperInner> listWithResponse(
        String resourceGroupName, String workspaceName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ConnectorDefinitionBaseArmCollectionWrapperInner list(String resourceGroupName, String workspaceName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ConnectorDefinitionBaseArmObjectWrapperInner>> getWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ConnectorDefinitionBaseArmObjectWrapperInner> getAsync(
        String resourceGroupName, String workspaceName, String dataConnectorDefinitionName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ConnectorDefinitionBaseArmObjectWrapperInner> getWithResponse(
        String resourceGroupName, String workspaceName, String dataConnectorDefinitionName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ConnectorDefinitionBaseArmObjectWrapperInner get(
        String resourceGroupName, String workspaceName, String dataConnectorDefinitionName) {
     ...
     * @param workspaceName The name of the workspace.
     * @param dataConnectorDefinitionName The data connector definition name.
     * @param connectorDefinitionInput Encapsulate the data connector definition object.
     * @throws IllegalArgumentException thrown if parameters fail the validation.
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return encapsulate the data connector definition object along with {@link Response} on successful completion of
     *     {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ConnectorDefinitionBaseArmObjectWrapperInner>> createOrUpdateWithResponseAsync(
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return encapsulate the data connector definition object on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ConnectorDefinitionBaseArmObjectWrapperInner> createOrUpdateAsync(
        String resourceGroupName,
        String workspaceName,
        String dataConnectorDefinitionName,
        ConnectorDefinitionBaseArmObjectWrapperWithConverter connectorDefinitionInput) {
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return encapsulate the data connector definition object along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ConnectorDefinitionBaseArmObjectWrapperInner> createOrUpdateWithResponse(
        String resourceGroupName,
        String workspaceName,
        String dataConnectorDefinitionName,
        ConnectorDefinitionBaseArmObjectWrapperWithConverter connectorDefinitionInput,
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return encapsulate the data connector definition object.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ConnectorDefinitionBaseArmObjectWrapperInner createOrUpdate(
        String resourceGroupName,
        String workspaceName,
        String dataConnectorDefinitionName,
        ConnectorDefinitionBaseArmObjectWrapperWithConverter connectorDefinitionInput) {
