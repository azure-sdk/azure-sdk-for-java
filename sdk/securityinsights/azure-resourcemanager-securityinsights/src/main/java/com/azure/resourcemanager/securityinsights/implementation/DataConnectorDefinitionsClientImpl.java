...
public final class DataConnectorDefinitionsClientImpl implements DataConnectorDefinitionsClient {
    ...
    public interface DataConnectorDefinitionsService {
        ...
        Mono<Response<DataConnectorDefinitionArmCollectionWrapper>> list(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<DataConnectorDefinitionInner>> get(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("workspaceName") String workspaceName,
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<DataConnectorDefinitionInner>> createOrUpdate(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("workspaceName") String workspaceName,
            @PathParam("dataConnectorDefinitionName") String dataConnectorDefinitionName,
    ...
    private Mono<Response<DataConnectorDefinitionInner>> getWithResponseAsync(String resourceGroupName,
        ...
        if (dataConnectorDefinitionName == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter dataConnectorDefinitionName is required and cannot be null."));
        }
        final String apiVersion = "2024-01-01-preview";
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.get(this.client.getEndpoint(), this.client.getSubscriptionId(),
                resourceGroupName, workspaceName, dataConnectorDefinitionName, apiVersion, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<DataConnectorDefinitionInner>> getWithResponseAsync(String resourceGroupName,
        String workspaceName, String dataConnectorDefinitionName, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service.get(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName, workspaceName,
            dataConnectorDefinitionName, apiVersion, accept, context);
    }
    ...
    private Mono<Response<DataConnectorDefinitionInner>> createOrUpdateWithResponseAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(context -> service.createOrUpdate(this.client.getEndpoint(), this.client.getSubscriptionId(),
                resourceGroupName, workspaceName, dataConnectorDefinitionName, apiVersion, connectorDefinitionInput,
                accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<DataConnectorDefinitionInner>> createOrUpdateWithResponseAsync(String resourceGroupName,
        ...
        return service.createOrUpdate(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            workspaceName, dataConnectorDefinitionName, apiVersion, connectorDefinitionInput, accept, context);
    }
    ...
    public Response<DataConnectorDefinitionInner> createOrUpdateWithResponse(String resourceGroupName,
        ...
        Context context) {
        return createOrUpdateWithResponseAsync(resourceGroupName, workspaceName, dataConnectorDefinitionName,
            connectorDefinitionInput, context).block();
    }
    ...
    private Mono<Response<Void>> deleteWithResponseAsync(String resourceGroupName, String workspaceName,
        ...
        return service.delete(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            workspaceName, dataConnectorDefinitionName, apiVersion, accept, context);
    }
