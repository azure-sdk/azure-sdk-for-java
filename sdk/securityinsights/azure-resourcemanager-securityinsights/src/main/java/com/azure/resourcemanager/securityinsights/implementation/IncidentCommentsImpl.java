...
public final class IncidentCommentsImpl implements IncidentComments {
    ...
    public PagedIterable<IncidentComment> list(String resourceGroupName, String workspaceName, String incidentId,
        ...
        PagedIterable<IncidentCommentInner> inner = this.serviceClient().list(resourceGroupName, workspaceName,
            incidentId, filter, orderby, top, skipToken, context);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new IncidentCommentImpl(inner1, this.manager()));
    }
    ...
    public Response<IncidentComment> getWithResponse(String resourceGroupName, String workspaceName, String incidentId,
        ...
        Response<IncidentCommentInner> inner = this.serviceClient().getWithResponse(resourceGroupName, workspaceName,
            incidentId, incidentCommentId, context);
        if (inner != null) {
    ...
    public Response<Void> deleteWithResponse(String resourceGroupName, String workspaceName, String incidentId,
        String incidentCommentId, Context context) {
        return this.serviceClient().deleteWithResponse(resourceGroupName, workspaceName, incidentId, incidentCommentId,
            context);
    }
