...
public final class HuntRelationInner extends ResourceWithEtag {
     ...
     * @return the HuntRelationInner object itself.
     */
    public HuntRelationInner withRelatedResourceName(String relatedResourceName) {
        if (this.innerProperties() == null) {
            this.innerProperties = new HuntRelationProperties();
        }
        this.innerProperties().withRelatedResourceName(relatedResourceName);
        return this;
    }
     ...
     * @return the HuntRelationInner object itself.
     */
    public HuntRelationInner withRelationType(String relationType) {
        if (this.innerProperties() == null) {
            this.innerProperties = new HuntRelationProperties();
        }
        this.innerProperties().withRelationType(relationType);
        return this;
    }
     ...
     * @return the HuntRelationInner object itself.
     */
    public HuntRelationInner withRelatedResourceKind(RelatedResourceKind relatedResourceKind) {
        if (this.innerProperties() == null) {
            this.innerProperties = new HuntRelationProperties();
        }
        this.innerProperties().withRelatedResourceKind(relatedResourceKind);
        return this;
    }
