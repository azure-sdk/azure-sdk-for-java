...
public final class ContentTemplateOperationsClientImpl implements ContentTemplateOperationsClient {
    ...
    ContentTemplateOperationsClientImpl(SecurityInsightsImpl client) {
        this.service = RestProxy.create(ContentTemplateOperationsService.class, client.getHttpPipeline(),
    ...
    public interface ContentTemplateOperationsService {
        ...
        Mono<Response<TemplateModelInner>> install(@HostParam("$host") String endpoint,
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<TemplateModelInner>> get(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("workspaceName") String workspaceName,
    ...
    private Mono<Response<TemplateModelInner>> installWithResponseAsync(String resourceGroupName, String workspaceName,
        ...
        return FluxUtil
            .withContext(
                context -> service.install(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(),
                    resourceGroupName, workspaceName, templateId, templateInstallationProperties, accept, context))
    ...
    private Mono<Response<TemplateModelInner>> installWithResponseAsync(String resourceGroupName, String workspaceName,
        ...
        return service.install(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(),
            resourceGroupName, workspaceName, templateId, templateInstallationProperties, accept, context);
    }
    ...
    private Mono<Response<TemplateModelInner>> getWithResponseAsync(String resourceGroupName, String workspaceName,
        ...
        return service.get(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(), resourceGroupName,
            workspaceName, templateId, accept, context);
    }
