...
public final class ContentTemplateOperationsClientImpl implements ContentTemplateOperationsClient {
    ...
    public interface ContentTemplateOperationsService {
        ...
        @Put(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OperationalInsights"
                + "/workspaces/{workspaceName}/providers/Microsoft.SecurityInsights/contentTemplates/{templateId}")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<TemplateModelAutoGeneratedInner>> install(
            ...
            @BodyParam("application/json") TemplatePropertiesAutoGenerated templateInstallationProperties,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<TemplateModelAutoGeneratedInner>> get(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
    ...
    private Mono<Response<TemplateModelAutoGeneratedInner>> installWithResponseAsync(
        String resourceGroupName,
        String workspaceName,
        String templateId,
        TemplatePropertiesAutoGenerated templateInstallationProperties) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<TemplateModelAutoGeneratedInner> installAsync(
        String resourceGroupName,
        String workspaceName,
        String templateId,
        TemplatePropertiesAutoGenerated templateInstallationProperties) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<TemplateModelAutoGeneratedInner> installWithResponse(
        String resourceGroupName,
        String workspaceName,
        String templateId,
        TemplatePropertiesAutoGenerated templateInstallationProperties,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public TemplateModelAutoGeneratedInner install(
        String resourceGroupName,
        String workspaceName,
        String templateId,
        TemplatePropertiesAutoGenerated templateInstallationProperties) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<TemplateModelAutoGeneratedInner>> getWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<TemplateModelAutoGeneratedInner> getAsync(
        String resourceGroupName, String workspaceName, String templateId) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<TemplateModelAutoGeneratedInner> getWithResponse(
        String resourceGroupName, String workspaceName, String templateId, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public TemplateModelAutoGeneratedInner get(String resourceGroupName, String workspaceName, String templateId) {
