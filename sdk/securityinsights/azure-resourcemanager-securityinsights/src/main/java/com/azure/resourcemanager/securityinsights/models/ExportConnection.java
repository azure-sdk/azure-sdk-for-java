...
public interface ExportConnection {
    ...
    /**
     * Gets the nextScheduledTime property: The next export run time in the format of a UTC date string.
     *
    ...
    /**
     * Gets the runFrequencyInMinutes property: Export frequency of connection in minutes (int).
     *
     * @return the runFrequencyInMinutes value.
     */
    Integer runFrequencyInMinutes();
    ...
    interface DefinitionStages {
        ...
        interface WithCreate
            extends DefinitionStages.WithEtag,
                ...
                DefinitionStages.WithRunFrequencyInMinutes {
            /**
        ...
        interface WithNextScheduledTime {
            /**
             * Specifies the nextScheduledTime property: The next export run time in the format of a UTC date string..
             *
             * @param nextScheduledTime The next export run time in the format of a UTC date string.
             * @return the next definition stage.
             */
            WithCreate withNextScheduledTime(String nextScheduledTime);
        }
        /** The stage of the ExportConnection definition allowing to specify runFrequencyInMinutes. */
        interface WithRunFrequencyInMinutes {
            /**
             * Specifies the runFrequencyInMinutes property: Export frequency of connection in minutes (int).
             *
             * @param runFrequencyInMinutes Export frequency of connection in minutes (int).
             * @return the next definition stage.
             */
            WithCreate withRunFrequencyInMinutes(Integer runFrequencyInMinutes);
        }
    }
    /**
