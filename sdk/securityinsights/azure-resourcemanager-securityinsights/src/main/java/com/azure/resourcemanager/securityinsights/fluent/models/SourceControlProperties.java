...
public final class SourceControlProperties {
    ...
    private RepositoryAutoGenerated repository;
     ...
     */
    public RepositoryAutoGenerated repository() {
     ...
     * @return the SourceControlProperties object itself.
     */
    public SourceControlProperties withRepository(RepositoryAutoGenerated repository) {
