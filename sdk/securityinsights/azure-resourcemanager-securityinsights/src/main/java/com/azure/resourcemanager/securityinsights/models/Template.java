...
public interface Template {
    ...
    /**
     * Gets the dependantTemplates property: Dependencies for the content item, what other content items it requires to
    ...
    /**
     * Gets the mainTemplate property: The main template of the template.
     *
     * @return the mainTemplate value.
     */
    ContentMainTemplate mainTemplate();
