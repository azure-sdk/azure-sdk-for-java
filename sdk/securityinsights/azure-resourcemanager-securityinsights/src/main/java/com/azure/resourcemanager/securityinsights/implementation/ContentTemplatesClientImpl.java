...
import com.azure.resourcemanager.securityinsights.models.TemplateListAutoGenerated;
...
public final class ContentTemplatesClientImpl implements ContentTemplatesClient {
    ...
    public interface ContentTemplatesService {
        ...
        @Get(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OperationalInsights"
                + "/workspaces/{workspaceName}/providers/Microsoft.SecurityInsights/contentTemplates")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<TemplateListAutoGenerated>> list(
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<TemplateListAutoGenerated>> listNext(
    ...
    private Mono<PagedResponse<TemplateModelAutoGeneratedInner>> listSinglePageAsync(
                ...
                context ->
                    service
                        .list(
                            ...
                            accept,
                            context))
            .<PagedResponse<TemplateModelAutoGeneratedInner>>map(
                res ->
    ...
    private PagedFlux<TemplateModelAutoGeneratedInner> listAsync(
        String resourceGroupName, String workspaceName, String filter, String orderby, Integer top, String skipToken) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<TemplateModelAutoGeneratedInner> listAsync(String resourceGroupName, String workspaceName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<TemplateModelAutoGeneratedInner> list(String resourceGroupName, String workspaceName) {
        final String filter = null;
        final String orderby = null;
        final Integer top = null;
        final String skipToken = null;
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<TemplateModelAutoGeneratedInner> list(
        String resourceGroupName,
        String workspaceName,
        String filter,
        String orderby,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<TemplateModelAutoGeneratedInner>> listNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<TemplateModelAutoGeneratedInner>> listNextSinglePageAsync(
