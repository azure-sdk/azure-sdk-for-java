...
public interface HuntRelation {
    ...
    interface DefinitionStages {
        ...
        interface WithCreate
            extends DefinitionStages.WithEtag,
                DefinitionStages.WithRelatedResourceId,
                DefinitionStages.WithRelatedResourceName,
                DefinitionStages.WithRelationType,
                DefinitionStages.WithRelatedResourceKind,
        ...
        /** The stage of the HuntRelation definition allowing to specify relatedResourceName. */
        interface WithRelatedResourceName {
            /**
             * Specifies the relatedResourceName property: The name of the related resource.
             *
             * @param relatedResourceName The name of the related resource.
             * @return the next definition stage.
             */
            WithCreate withRelatedResourceName(String relatedResourceName);
        }
        /** The stage of the HuntRelation definition allowing to specify relationType. */
        interface WithRelationType {
            /**
             * Specifies the relationType property: The type of the hunt relation.
             *
             * @param relationType The type of the hunt relation.
             * @return the next definition stage.
             */
            WithCreate withRelationType(String relationType);
        }
        /** The stage of the HuntRelation definition allowing to specify relatedResourceKind. */
        interface WithRelatedResourceKind {
            /**
             * Specifies the relatedResourceKind property: The resource that the relation is related to.
             *
             * @param relatedResourceKind The resource that the relation is related to.
             * @return the next definition stage.
             */
            WithCreate withRelatedResourceKind(RelatedResourceKind relatedResourceKind);
        }
    ...
    interface Update
        extends UpdateStages.WithEtag,
            UpdateStages.WithRelatedResourceId,
            UpdateStages.WithRelatedResourceName,
            UpdateStages.WithRelationType,
            UpdateStages.WithRelatedResourceKind,
    ...
    interface UpdateStages {
        ...
        /** The stage of the HuntRelation update allowing to specify relatedResourceName. */
        interface WithRelatedResourceName {
            /**
             * Specifies the relatedResourceName property: The name of the related resource.
             *
             ...
             * @return the next definition stage.
             */
            Update withRelatedResourceName(String relatedResourceName);
        }
        /** The stage of the HuntRelation update allowing to specify relationType. */
        interface WithRelationType {
            /**
             * Specifies the relationType property: The type of the hunt relation.
             *
             ...
             * @return the next definition stage.
             */
            Update withRelationType(String relationType);
        }
        /** The stage of the HuntRelation update allowing to specify relatedResourceKind. */
        interface WithRelatedResourceKind {
            /**
             * Specifies the relatedResourceKind property: The resource that the relation is related to.
             *
             ...
             * @return the next definition stage.
             */
            Update withRelatedResourceKind(RelatedResourceKind relatedResourceKind);
        }
