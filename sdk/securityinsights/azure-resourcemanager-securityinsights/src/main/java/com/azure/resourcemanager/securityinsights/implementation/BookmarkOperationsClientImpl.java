...
public final class BookmarkOperationsClientImpl implements BookmarkOperationsClient {
    ...
    /**
     * The interface defining all the services for SecurityInsightsBookmarkOperations to be used by the proxy service
    ...
    private Mono<Response<BookmarkExpandResponseInner>> expandWithResponseAsync(String resourceGroupName,
        ...
        return service.expand(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(), resourceGroupName,
            workspaceName, bookmarkId, parameters, accept, context);
    }
