...
public final class DataConnectorsCheckRequirementsOperationsImpl implements DataConnectorsCheckRequirementsOperations {
    ...
    public Response<DataConnectorRequirementsState> postWithResponse(String resourceGroupName, String workspaceName,
        ...
        Response<DataConnectorRequirementsStateInner> inner = this.serviceClient().postWithResponse(resourceGroupName,
            workspaceName, dataConnectorsCheckRequirements, context);
        if (inner != null) {
