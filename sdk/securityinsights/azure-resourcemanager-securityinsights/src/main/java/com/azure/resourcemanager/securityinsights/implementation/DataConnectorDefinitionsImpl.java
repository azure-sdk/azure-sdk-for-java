...
public final class DataConnectorDefinitionsImpl implements DataConnectorDefinitions {
    ...
    public Response<DataConnectorDefinitionArmCollectionWrapper> listWithResponse(
        String resourceGroupName, String workspaceName, Context context) {
        Response<DataConnectorDefinitionArmCollectionWrapperInner> inner =
        ...
        if (inner != null) {
            return new SimpleResponse<>(
                ...
                inner.getStatusCode(),
                inner.getHeaders(),
                new DataConnectorDefinitionArmCollectionWrapperImpl(inner.getValue(), this.manager()));
        } else {
            return null;
        }
    }

    public DataConnectorDefinitionArmCollectionWrapper list(String resourceGroupName, String workspaceName) {
        DataConnectorDefinitionArmCollectionWrapperInner inner =
            this.serviceClient().list(resourceGroupName, workspaceName);
        if (inner != null) {
            return new DataConnectorDefinitionArmCollectionWrapperImpl(inner, this.manager());
        } else {
            return null;
        }
    }

    public Response<DataConnectorDefinition> getWithResponse(
        String resourceGroupName, String workspaceName, String dataConnectorDefinitionName, Context context) {
        Response<DataConnectorDefinitionInner> inner =
            this
                .serviceClient()
    ...
    public DataConnectorDefinition get(
    ...
    public Response<DataConnectorDefinition> createOrUpdateWithResponse(
    ...
    public DataConnectorDefinition createOrUpdate(
        String resourceGroupName,
        String workspaceName,
        String dataConnectorDefinitionName,
        DataConnectorDefinitionInner connectorDefinitionInput) {
