...
public final class ProductPackageModelInner extends ResourceWithEtag {
     ...
     * @return the ProductPackageModelInner object itself.
     */
    public ProductPackageModelInner withMetadataResourceId(String metadataResourceId) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ProductPackageProperties();
        }
        this.innerProperties().withMetadataResourceId(metadataResourceId);
        return this;
    }
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("id".equals(fieldName)) {
                    ...
                    deserializedProductPackageModelInner.withEtag(reader.getString());
