...
public final class ProductTemplateOperationsClientImpl implements ProductTemplateOperationsClient {
    ...
    ProductTemplateOperationsClientImpl(SecurityInsightsImpl client) {
        this.service = RestProxy.create(ProductTemplateOperationsService.class, client.getHttpPipeline(),
    ...
    public interface ProductTemplateOperationsService {
        ...
        Mono<Response<ProductTemplateModelInner>> get(@HostParam("$host") String endpoint,
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ProductTemplateModelInner>> getWithResponseAsync(String resourceGroupName,
        String workspaceName, String templateId, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
