...
public final class WorkspaceManagerAssignmentsImpl implements WorkspaceManagerAssignments {
    ...
    public PagedIterable<WorkspaceManagerAssignment> list(String resourceGroupName, String workspaceName) {
        ...
        return Utils.mapPage(inner, inner1 -> new WorkspaceManagerAssignmentImpl(inner1, this.manager()));
    }
    ...
    public Response<WorkspaceManagerAssignment> getWithResponse(String resourceGroupName, String workspaceName,
        ...
        Response<WorkspaceManagerAssignmentInner> inner = this.serviceClient().getWithResponse(resourceGroupName,
            workspaceName, workspaceManagerAssignmentName, context);
        if (inner != null) {
    ...
    public WorkspaceManagerAssignment getById(String id) {
        ...
        String workspaceManagerAssignmentName = Utils.getValueFromIdByName(id, "workspaceManagerAssignments");
