...
public interface AlertRuleOperationsClient {
    ...
    SyncPoller<PollResult<Void>, Void> beginTriggerRuleRun(String resourceGroupName, String workspaceName,
    ...
    void triggerRuleRun(String resourceGroupName, String workspaceName, String ruleId,
