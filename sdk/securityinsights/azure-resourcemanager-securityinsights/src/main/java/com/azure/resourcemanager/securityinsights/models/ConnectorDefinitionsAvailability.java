...
public final class ConnectorDefinitionsAvailability {
    ...
    /**
     * Get the status property: The exposure status of the connector to the customers. Available values are 0-4
    ...
    /**
     * Set the status property: The exposure status of the connector to the customers. Available values are 0-4
     * (0=None, 1=Available, 2=FeatureFlag, 3=Internal).
     * 
