...
public final class PackageModelAutoGeneratedInner extends ResourceWithEtag {
     ...
     */
    public PackageModelAutoGeneratedInner withContentId(String contentId) {
     ...
     * @return the PackageModelAutoGeneratedInner object itself.
     */
    public PackageModelAutoGeneratedInner withContentKind(PackageKind contentKind) {
        if (this.innerProperties() == null) {
            this.innerProperties = new PackagePropertiesAutoGenerated();
        }
     ...
     * @return the PackageModelAutoGeneratedInner object itself.
     */
    public PackageModelAutoGeneratedInner withThreatAnalysisTechniques(List<String> threatAnalysisTechniques) {
        if (this.innerProperties() == null) {
            this.innerProperties = new PackagePropertiesAutoGenerated();
        }
