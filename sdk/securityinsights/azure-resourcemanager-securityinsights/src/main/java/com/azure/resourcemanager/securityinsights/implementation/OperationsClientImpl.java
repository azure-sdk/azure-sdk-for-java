...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    OperationsClientImpl(SecurityInsightsImpl client) {
        this.service =
    ...
    /**
     * The interface defining all the services for SecurityInsightsOperations to be used by the proxy service to perform
     * REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "SecurityInsightsOper")
     ...
     * @return lists the operations available in the SecurityInsights RP along with {@link PagedResponse} on successful
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return lists the operations available in the SecurityInsights RP as paginated response with {@link PagedFlux}.
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<OperationAutoGeneratedInner> listAsync() {
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return lists the operations available in the SecurityInsights RP as paginated response with {@link
     *     PagedIterable}.
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
