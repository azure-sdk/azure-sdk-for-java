...
public final class SystemsClientImpl implements SystemsClient {
    ...
    private Mono<PagedResponse<SystemInner>> listSinglePageAsync(String resourceGroupName, String workspaceName,
        ...
        return service
            .list(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName, workspaceName,
                agentResourceName, this.client.getApiVersion(), accept, context)
    ...
    private PagedFlux<SystemInner> listAsync(String resourceGroupName, String workspaceName, String agentResourceName) {
        return new PagedFlux<>(() -> listSinglePageAsync(resourceGroupName, workspaceName, agentResourceName),
    ...
    private PagedFlux<SystemInner> listAsync(String resourceGroupName, String workspaceName, String agentResourceName,
        Context context) {
        return new PagedFlux<>(() -> listSinglePageAsync(resourceGroupName, workspaceName, agentResourceName, context),
    ...
    public PagedIterable<SystemInner> list(String resourceGroupName, String workspaceName, String agentResourceName) {
        return new PagedIterable<>(listAsync(resourceGroupName, workspaceName, agentResourceName));
    }
    ...
    public PagedIterable<SystemInner> list(String resourceGroupName, String workspaceName, String agentResourceName,
        Context context) {
        return new PagedIterable<>(listAsync(resourceGroupName, workspaceName, agentResourceName, context));
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return list all pending actions for a system to perform along with {@link PagedResponse} on successful
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return list all pending actions for a system to perform as paginated response with {@link PagedFlux}.
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
