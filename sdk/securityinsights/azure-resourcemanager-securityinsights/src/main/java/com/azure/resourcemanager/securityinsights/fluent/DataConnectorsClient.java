...
public interface DataConnectorsClient {
    ...
    PagedIterable<DataConnectorInner> list(String resourceGroupName, String workspaceName);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<DataConnectorInner> list(String resourceGroupName, String workspaceName, Context context);
