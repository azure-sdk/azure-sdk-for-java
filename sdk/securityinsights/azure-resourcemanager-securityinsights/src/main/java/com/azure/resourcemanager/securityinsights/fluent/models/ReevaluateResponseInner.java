    ...
    public void validate() {
        if (lastEvaluatedTimeUtc() == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
                "Missing required property lastEvaluatedTimeUtc in model ReevaluateResponseInner"));
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(ReevaluateResponseInner.class);
}
