...
public interface Systems {
     ...
     */
    Response<SystemResource> getWithResponse(String resourceGroupName, String workspaceName, String agentResourceName,
     ...
     * @return the system.
     */
    SystemResource get(String resourceGroupName, String workspaceName, String agentResourceName,
     ...
     */
    PagedIterable<SystemResource> list(String resourceGroupName, String workspaceName, String agentResourceName);
     ...
     * @return the system along with {@link Response}.
     */
    SystemResource getById(String id);
     ...
     * @return the system along with {@link Response}.
     */
    Response<SystemResource> getByIdWithResponse(String id, Context context);
    ...
    /**
     * Begins definition for a new SystemResource resource.
     * 
     * @param name resource name.
     * @return the first stage of the new SystemResource definition.
     */
    SystemResource.DefinitionStages.Blank define(String name);
}
