...
public final class ResourceProvidersClientImpl implements ResourceProvidersClient {
    ...
    private Mono<Response<EnrichmentIpGeodataAutoGeneratedInner>> listGeodataByIpWithResponseAsync(
        ...
        return FluxUtil
            .withContext(context -> service.listGeodataByIp(this.client.getEndpoint(), apiVersion,
    ...
    private Mono<Response<EnrichmentIpGeodataAutoGeneratedInner>> listGeodataByIpWithResponseAsync(
        ...
        return service.listGeodataByIp(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(),
            resourceGroupName, workspaceName, enrichmentType, ipAddressBody, accept, context);
    }
    ...
    private Mono<Response<EnrichmentDomainWhoisInner>> listWhoisByDomainWithResponseAsync(String resourceGroupName,
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.listWhoisByDomain(this.client.getEndpoint(), apiVersion,
    ...
    private Mono<Response<EnrichmentDomainWhoisInner>> listWhoisByDomainWithResponseAsync(String resourceGroupName,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.listWhoisByDomain(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(),
            resourceGroupName, workspaceName, enrichmentType, domainBody, accept, context);
    }
