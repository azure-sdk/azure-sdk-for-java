...
@Fluent
public final class RepositoryAutoGenerated {
    /*
     * Url of repository.
     */
    ...
    /** Creates an instance of RepositoryAutoGenerated class. */
    public RepositoryAutoGenerated() {
    }
     ...
     * @return the RepositoryAutoGenerated object itself.
     */
    public RepositoryAutoGenerated withUrl(String url) {
        this.url = url;
        return this;
    }
     ...
     * @return the RepositoryAutoGenerated object itself.
     */
    public RepositoryAutoGenerated withBranch(String branch) {
        this.branch = branch;
        return this;
    }
     ...
     * @return the RepositoryAutoGenerated object itself.
     */
    public RepositoryAutoGenerated withDisplayUrl(String displayUrl) {
     ...
     * @return the RepositoryAutoGenerated object itself.
     */
    public RepositoryAutoGenerated withDeploymentLogsUrl(String deploymentLogsUrl) {
     ...
     * @return the RepositoryAutoGenerated object itself.
     */
    public RepositoryAutoGenerated withPathMapping(List<ContentPathMap> pathMapping) {
