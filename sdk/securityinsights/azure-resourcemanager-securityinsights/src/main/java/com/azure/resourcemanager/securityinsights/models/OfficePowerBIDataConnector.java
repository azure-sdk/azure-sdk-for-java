...
public final class OfficePowerBIDataConnector extends DataConnectorInner {
    ...
    /**
     * Reads an instance of OfficePowerBIDataConnector from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of OfficePowerBIDataConnector if the JsonReader was pointing to an instance of it, or null if
     * it was pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the OfficePowerBIDataConnector.
     */
    public static OfficePowerBIDataConnector fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            OfficePowerBIDataConnector deserializedOfficePowerBIDataConnector = new OfficePowerBIDataConnector();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("id".equals(fieldName)) {
                    deserializedOfficePowerBIDataConnector.id = reader.getString();
                } else if ("name".equals(fieldName)) {
                    deserializedOfficePowerBIDataConnector.name = reader.getString();
                } else if ("type".equals(fieldName)) {
                    deserializedOfficePowerBIDataConnector.type = reader.getString();
                } else if ("etag".equals(fieldName)) {
                    deserializedOfficePowerBIDataConnector.withEtag(reader.getString());
                } else if ("systemData".equals(fieldName)) {
                    deserializedOfficePowerBIDataConnector.systemData = SystemData.fromJson(reader);
                } else if ("kind".equals(fieldName)) {
                    deserializedOfficePowerBIDataConnector.kind = DataConnectorKind.fromString(reader.getString());
                } else if ("properties".equals(fieldName)) {
                    deserializedOfficePowerBIDataConnector.innerProperties
                        = OfficePowerBIDataConnectorProperties.fromJson(reader);
                } else {
                    reader.skipChildren();
                }
            }

            return deserializedOfficePowerBIDataConnector;
        });
    }
}
