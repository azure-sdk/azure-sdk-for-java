...
public final class SecurityInsightsImpl implements SecurityInsights {
    ...
    /**
     * The BusinessApplicationAgentsClient object to access its operations.
     */
    private final BusinessApplicationAgentsClient businessApplicationAgents;
     ...
     */
    public BusinessApplicationAgentsClient getBusinessApplicationAgents() {
        return this.businessApplicationAgents;
    }

    /**
     * The BusinessApplicationAgentOperationsClient object to access its operations.
     */
    private final BusinessApplicationAgentOperationsClient businessApplicationAgentOperations;
     ...
     */
    public BusinessApplicationAgentOperationsClient getBusinessApplicationAgentOperations() {
        return this.businessApplicationAgentOperations;
    }

    /**
     * The SystemsClient object to access its operations.
     */
    private final SystemsClient systems;
     ...
     */
    public SystemsClient getSystems() {
        return this.systems;
    }
    ...
    SecurityInsightsImpl(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter, Duration defaultPollInterval,
        ...
        this.businessApplicationAgents = new BusinessApplicationAgentsClientImpl(this);
        this.businessApplicationAgentOperations = new BusinessApplicationAgentOperationsClientImpl(this);
        this.systems = new SystemsClientImpl(this);
