...
public final class SecurityInsightsImpl implements SecurityInsights {
    ...
    /** The IncidentCreationRulesClient object to access its operations. */
    private final IncidentCreationRulesClient incidentCreationRules;

    /**
     * Gets the IncidentCreationRulesClient object to access its operations.
     *
     * @return the IncidentCreationRulesClient object.
     */
    public IncidentCreationRulesClient getIncidentCreationRules() {
        return this.incidentCreationRules;
    }
    ...
    SecurityInsightsImpl(
        ...
        this.incidentCreationRules = new IncidentCreationRulesClientImpl(this);
