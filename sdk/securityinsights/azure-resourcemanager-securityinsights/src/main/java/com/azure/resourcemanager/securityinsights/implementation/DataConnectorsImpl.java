...
public final class DataConnectorsImpl implements DataConnectors {
    ...
    public Response<DataConnector> createOrUpdateWithResponse(String resourceGroupName, String workspaceName,
        ...
        Response<DataConnectorInner> inner = this.serviceClient().createOrUpdateWithResponse(resourceGroupName,
            workspaceName, dataConnectorId, dataConnector, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
                new DataConnectorImpl(inner.getValue(), this.manager()));
        } else {
    ...
    public Response<Void> connectWithResponse(String resourceGroupName, String workspaceName, String dataConnectorId,
        ...
        return this.serviceClient().connectWithResponse(resourceGroupName, workspaceName, dataConnectorId, connectBody,
            context);
    }
