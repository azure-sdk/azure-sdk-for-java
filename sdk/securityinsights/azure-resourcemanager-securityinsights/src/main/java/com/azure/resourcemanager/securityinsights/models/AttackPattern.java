...
public final class AttackPattern extends TIObjectInner {
    ...
    /**
     * Reads an instance of AttackPattern from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of AttackPattern if the JsonReader was pointing to an instance of it, or null if it was
     * pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the AttackPattern.
     */
    public static AttackPattern fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            AttackPattern deserializedAttackPattern = new AttackPattern();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("id".equals(fieldName)) {
                    deserializedAttackPattern.id = reader.getString();
                } else if ("name".equals(fieldName)) {
                    deserializedAttackPattern.name = reader.getString();
                } else if ("type".equals(fieldName)) {
                    deserializedAttackPattern.type = reader.getString();
                } else if ("properties".equals(fieldName)) {
                    deserializedAttackPattern.innerProperties = TIObjectCommonProperties.fromJson(reader);
                } else if ("systemData".equals(fieldName)) {
                    deserializedAttackPattern.systemData = SystemData.fromJson(reader);
                } else if ("kind".equals(fieldName)) {
                    deserializedAttackPattern.kind = TIObjectKind.fromString(reader.getString());
                } else {
                    reader.skipChildren();
                }
            }

            return deserializedAttackPattern;
        });
    }
}
