...
public final class MdatpCheckRequirements extends DataConnectorsCheckRequirements {
     ...
     */
    MdatpCheckRequirementsProperties innerProperties() {
    ...
    /**
     * Reads an instance of MdatpCheckRequirements from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of MdatpCheckRequirements if the JsonReader was pointing to an instance of it, or null if it
     * was pointing to JSON null.
     * @throws IOException If an error occurs while reading the MdatpCheckRequirements.
     */
    public static MdatpCheckRequirements fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            MdatpCheckRequirements deserializedMdatpCheckRequirements = new MdatpCheckRequirements();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("kind".equals(fieldName)) {
                    deserializedMdatpCheckRequirements.kind = DataConnectorKind.fromString(reader.getString());
                } else if ("properties".equals(fieldName)) {
                    deserializedMdatpCheckRequirements.innerProperties
                        = MdatpCheckRequirementsProperties.fromJson(reader);
                } else {
                    reader.skipChildren();
                }
            }

            return deserializedMdatpCheckRequirements;
        });
    }
}
