...
public final class SourceControlImpl implements SourceControl, SourceControl.Definition {
    ...
    public SourceControl create() {
        this.innerObject = serviceManager.serviceClient().getSourceControlsOperations()
    ...
    public SourceControl refresh() {
        this.innerObject = serviceManager.serviceClient().getSourceControlsOperations()
            .getWithResponse(resourceGroupName, workspaceName, sourceControlId, Context.NONE).getValue();
        return this;
    }

    public SourceControl refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getSourceControlsOperations()
            .getWithResponse(resourceGroupName, workspaceName, sourceControlId, context).getValue();
        return this;
    }

    public Response<Warning> deleteWithResponse(RepositoryAccessProperties repositoryAccess, Context context) {
        return serviceManager.sourceControlsOperations().deleteWithResponse(resourceGroupName, workspaceName,
            sourceControlId, repositoryAccess, context);
    }

    public Warning delete(RepositoryAccessProperties repositoryAccess) {
        return serviceManager.sourceControlsOperations().delete(resourceGroupName, workspaceName, sourceControlId,
            repositoryAccess);
    }
