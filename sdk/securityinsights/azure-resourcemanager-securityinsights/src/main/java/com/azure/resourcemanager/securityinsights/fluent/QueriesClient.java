...
public interface QueriesClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<Void> deleteWithResponse(String resourceGroupName, String workspaceName, String queryId, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<QueryInner> createOrUpdateWithResponse(
