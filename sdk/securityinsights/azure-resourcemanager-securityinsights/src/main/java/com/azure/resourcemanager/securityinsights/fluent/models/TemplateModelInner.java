 ...
 */
@Fluent
public final class TemplateModelInner extends ResourceWithEtag {
    /*
     * template properties
     */
    ...
    /**
     * Get the packageVersion property: Version of the package. Default and recommended format is numeric (e.g. 1,
     * 1.0, 1.0.0, 1.0.0.0), following ARM metadata best practices. Can also be any string, but then we cannot
    ...
    /**
     * Set the packageVersion property: Version of the package. Default and recommended format is numeric (e.g. 1,
     * 1.0, 1.0.0, 1.0.0.0), following ARM metadata best practices. Can also be any string, but then we cannot
     * guarantee any version checks.
     * 
     ...
     * 1.0.0, 1.0.0.0), following ARM metadata best practices. Can also be any string, but then we cannot guarantee
     * any version checks.
     * 
