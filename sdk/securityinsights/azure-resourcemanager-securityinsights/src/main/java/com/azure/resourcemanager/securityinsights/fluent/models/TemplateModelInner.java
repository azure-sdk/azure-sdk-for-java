...
public final class TemplateModelInner extends ResourceWithEtag {
    ...
    /**
     * Get the packageId property: Static ID for the content. Used to identify dependencies and content from solutions
    ...
    /**
     * Set the packageId property: Static ID for the content. Used to identify dependencies and content from solutions
     * or community. Hard-coded/static for out of the box content and solutions. Can be optionally set for user created
     * content to define dependencies. If an active content item is made from a metadata, both will have the same
     * contentId.
     *
