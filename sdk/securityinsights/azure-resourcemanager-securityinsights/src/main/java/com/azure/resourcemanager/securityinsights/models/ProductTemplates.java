...
/**
 * Resource collection API of ProductTemplates.
 */
public interface ProductTemplates {
    /**
     ...
     */
    PagedIterable<ProductTemplateModel> list(String resourceGroupName, String workspaceName);
     ...
     * @return all templates in the catalog as paginated response with {@link PagedIterable}.
     */
    PagedIterable<ProductTemplateModel> list(String resourceGroupName, String workspaceName, String filter,
