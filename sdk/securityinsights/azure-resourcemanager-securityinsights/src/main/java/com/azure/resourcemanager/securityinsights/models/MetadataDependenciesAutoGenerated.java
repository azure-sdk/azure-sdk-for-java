 ...
 */
@Fluent
public final class MetadataDependenciesAutoGenerated {
    /*
    ...
    private List<MetadataDependenciesAutoGenerated> criteria;

    /** Creates an instance of MetadataDependenciesAutoGenerated class. */
    public MetadataDependenciesAutoGenerated() {
    }
     ...
     * @return the MetadataDependenciesAutoGenerated object itself.
     */
    public MetadataDependenciesAutoGenerated withContentId(String contentId) {
     ...
     * @return the MetadataDependenciesAutoGenerated object itself.
     */
    public MetadataDependenciesAutoGenerated withKind(String kind) {
        this.kind = kind;
        return this;
    }
     ...
     * @return the MetadataDependenciesAutoGenerated object itself.
     */
    public MetadataDependenciesAutoGenerated withVersion(String version) {
     ...
     * @return the MetadataDependenciesAutoGenerated object itself.
     */
    public MetadataDependenciesAutoGenerated withName(String name) {
        this.name = name;
        return this;
    }
     ...
     * @return the MetadataDependenciesAutoGenerated object itself.
     */
    public MetadataDependenciesAutoGenerated withOperator(Operator operator) {
     ...
     */
    public List<MetadataDependenciesAutoGenerated> criteria() {
     ...
     * @return the MetadataDependenciesAutoGenerated object itself.
     */
    public MetadataDependenciesAutoGenerated withCriteria(List<MetadataDependenciesAutoGenerated> criteria) {
