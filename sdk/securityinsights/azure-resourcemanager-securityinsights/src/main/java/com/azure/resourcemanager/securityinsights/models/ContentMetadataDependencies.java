 ...
 */
@Fluent
public final class ContentMetadataDependencies {
    /*
    ...
    private List<ContentMetadataDependencies> criteria;

    /** Creates an instance of ContentMetadataDependencies class. */
    public ContentMetadataDependencies() {
    }
     ...
     * @return the ContentMetadataDependencies object itself.
     */
    public ContentMetadataDependencies withContentId(String contentId) {
     ...
     * @return the ContentMetadataDependencies object itself.
     */
    public ContentMetadataDependencies withKind(Kind kind) {
        this.kind = kind;
        return this;
    }
     ...
     * @return the ContentMetadataDependencies object itself.
     */
    public ContentMetadataDependencies withVersion(String version) {
     ...
     * @return the ContentMetadataDependencies object itself.
     */
    public ContentMetadataDependencies withName(String name) {
        this.name = name;
        return this;
    }
     ...
     * @return the ContentMetadataDependencies object itself.
     */
    public ContentMetadataDependencies withOperator(Operator operator) {
     ...
     */
    public List<ContentMetadataDependencies> criteria() {
     ...
     * @return the ContentMetadataDependencies object itself.
     */
    public ContentMetadataDependencies withCriteria(List<ContentMetadataDependencies> criteria) {
