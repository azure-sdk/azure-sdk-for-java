...
public final class PackagesClientImpl implements PackagesClient {
     ...
     */
    PackagesClientImpl(SecurityInsightsImpl client) {
        this.service = RestProxy.create(PackagesService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for SecurityInsightsPackages to be used by the proxy service to perform
     * REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "SecurityInsightsPack")
    private interface PackagesService {
        ...
        @Get(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers"
                ...
                + "/Microsoft.SecurityInsights/packages")
        ...
        @Get(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers"
                + "/{operationalInsightsResourceProvider}/workspaces/{workspaceName}/providers"
                + "/Microsoft.SecurityInsights/packages/{packageId}")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
