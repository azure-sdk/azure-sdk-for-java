...
public final class BookmarkImpl implements Bookmark, Bookmark.Definition, Bookmark.Update {
    ...
    public Bookmark create() {
        this.innerObject = serviceManager.serviceClient().getBookmarks()
    ...
    public Bookmark refresh() {
        this.innerObject = serviceManager.serviceClient().getBookmarks()
            .getWithResponse(resourceGroupName, workspaceName, bookmarkId, Context.NONE).getValue();
        return this;
    }

    public Bookmark refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getBookmarks()
            .getWithResponse(resourceGroupName, workspaceName, bookmarkId, context).getValue();
        return this;
    }
