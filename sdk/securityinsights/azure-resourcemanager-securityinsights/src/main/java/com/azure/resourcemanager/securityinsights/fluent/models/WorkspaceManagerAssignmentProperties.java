...
public final class WorkspaceManagerAssignmentProperties {
    ...
    /**
     * Get the targetResourceName property: The name of the workspace manager group targeted by the workspace manager
     * assignment.
     *
    ...
    /**
     * Set the targetResourceName property: The name of the workspace manager group targeted by the workspace manager
     * assignment.
     *
