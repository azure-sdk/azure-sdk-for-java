...
public final class SentinelOnboardingStatesImpl implements SentinelOnboardingStates {
    ...
    public Response<SentinelOnboardingState> getWithResponse(String resourceGroupName, String workspaceName,
        ...
        Response<SentinelOnboardingStateInner> inner = this.serviceClient().getWithResponse(resourceGroupName,
            workspaceName, sentinelOnboardingStateName, context);
        if (inner != null) {
    ...
    public Response<Void> deleteWithResponse(String resourceGroupName, String workspaceName,
        String sentinelOnboardingStateName, Context context) {
        return this.serviceClient().deleteWithResponse(resourceGroupName, workspaceName, sentinelOnboardingStateName,
            context);
    }
