 ...
 * Data connector.
 */
@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, property = "kind", defaultImpl = DataConnectorInner.class, visible = true)
...
@JsonSubTypes({
    ...
    @JsonSubTypes.Type(name = "RestApiPoller", value = RestApiPollerDataConnector.class),
...
public class DataConnectorInner extends ResourceWithEtag {
    ...
    public DataConnectorInner() {
        this.kind = DataConnectorKind.fromString("DataConnector");
    }
