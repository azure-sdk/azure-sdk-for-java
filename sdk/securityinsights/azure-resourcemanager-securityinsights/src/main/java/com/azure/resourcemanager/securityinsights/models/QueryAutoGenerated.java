 ...
 */
@Fluent
public final class QueryAutoGenerated implements JsonSerializable<QueryAutoGenerated> {
    /*
    ...
    /**
     * Reads an instance of QueryAutoGenerated from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of QueryAutoGenerated if the JsonReader was pointing to an instance of it, or null if it was
     * pointing to JSON null.
     * @throws IOException If an error occurs while reading the QueryAutoGenerated.
     */
    public static QueryAutoGenerated fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            QueryAutoGenerated deserializedQueryAutoGenerated = new QueryAutoGenerated();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("condition".equals(fieldName)) {
                    deserializedQueryAutoGenerated.condition = QueryCondition.fromJson(reader);
                } else if ("sortBy".equals(fieldName)) {
                    deserializedQueryAutoGenerated.sortBy = QuerySortBy.fromJson(reader);
                } else if ("maxPageSize".equals(fieldName)) {
                    deserializedQueryAutoGenerated.maxPageSize = reader.getNullable(JsonReader::getInt);
                } else if ("minPageSize".equals(fieldName)) {
                    deserializedQueryAutoGenerated.minPageSize = reader.getNullable(JsonReader::getInt);
                } else {
                    reader.skipChildren();
                }
            }

            return deserializedQueryAutoGenerated;
        });
    }
}
