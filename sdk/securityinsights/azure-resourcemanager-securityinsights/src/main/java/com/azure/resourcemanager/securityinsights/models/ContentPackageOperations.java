...
public interface ContentPackageOperations {
    ...
    /**
     * Begins definition for a new PackageModel resource.
     * 
     * @param name resource name.
     * @return the first stage of the new PackageModel definition.
     */
    PackageModel.DefinitionStages.Blank define(String name);
}
