...
public interface IpGeodatas {
     ...
     */
    Response<EnrichmentIpGeodata> getWithResponse(String resourceGroupName,
     ...
     */
    EnrichmentIpGeodata get(String resourceGroupName, EnrichmentIpAddressModel enrichmentIpAddress);
}
