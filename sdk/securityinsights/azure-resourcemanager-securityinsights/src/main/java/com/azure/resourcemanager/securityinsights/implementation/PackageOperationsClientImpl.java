...
public final class PackageOperationsClientImpl implements PackageOperationsClient {
     ...
     */
    PackageOperationsClientImpl(SecurityInsightsImpl client) {
        this.service =
    ...
    /**
     * The interface defining all the services for SecurityInsightsPackageOperations to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{$host}")
    ...
    private interface PackageOperationsService {
        ...
        @Post(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers"
                ...
                + "/Microsoft.SecurityInsights/packages/{packageId}/install")
        ...
        @Post(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers"
                + "/{operationalInsightsResourceProvider}/workspaces/{workspaceName}/providers"
                + "/Microsoft.SecurityInsights/packages/{packageId}/uninstall")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
