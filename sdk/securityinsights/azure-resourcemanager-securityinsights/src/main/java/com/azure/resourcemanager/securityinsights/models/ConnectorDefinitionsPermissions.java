...
public final class ConnectorDefinitionsPermissions {
    ...
    /**
     * Get the resourceProvider property: Gets or sets the resource provider permissions required for the user to
     * create connections.
     * 
    ...
    /**
     * Set the resourceProvider property: Gets or sets the resource provider permissions required for the user to
     * create connections.
     * 
