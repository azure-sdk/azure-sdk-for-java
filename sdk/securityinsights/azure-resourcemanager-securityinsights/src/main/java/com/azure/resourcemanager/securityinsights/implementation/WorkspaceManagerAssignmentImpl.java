...
public final class WorkspaceManagerAssignmentImpl
        ...
        this.innerObject =
            serviceManager
                ...
                .createOrUpdateWithResponse(
                    resourceGroupName, workspaceName, workspaceManagerAssignmentName, this.innerModel(), Context.NONE)
                .getValue();
        return this;
    }
    ...
    public WorkspaceManagerAssignment create(Context context) {
        this.innerObject =
            serviceManager
                ...
                .getWorkspaceManagerAssignments()
                .createOrUpdateWithResponse(
                    resourceGroupName, workspaceName, workspaceManagerAssignmentName, this.innerModel(), context)
                .getValue();
        return this;
    }

    WorkspaceManagerAssignmentImpl(
    ...
    WorkspaceManagerAssignmentImpl(
        WorkspaceManagerAssignmentInner innerObject,
