...
public final class WorkspaceManagerAssignmentImpl
    ...
    public WorkspaceManagerAssignment create() {
        this.innerObject = serviceManager.serviceClient().getWorkspaceManagerAssignments()
    ...
    public WorkspaceManagerAssignment create(Context context) {
        this.innerObject = serviceManager.serviceClient().getWorkspaceManagerAssignments().createOrUpdateWithResponse(
            resourceGroupName, workspaceName, workspaceManagerAssignmentName, this.innerModel(), context).getValue();
        return this;
    }
    ...
    WorkspaceManagerAssignmentImpl(WorkspaceManagerAssignmentInner innerObject,
        ...
        this.workspaceManagerAssignmentName
            = Utils.getValueFromIdByName(innerObject.id(), "workspaceManagerAssignments");
    }

    public WorkspaceManagerAssignment refresh() {
        this.innerObject = serviceManager.serviceClient().getWorkspaceManagerAssignments()
            .getWithResponse(resourceGroupName, workspaceName, workspaceManagerAssignmentName, Context.NONE).getValue();
        return this;
    }

    public WorkspaceManagerAssignment refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getWorkspaceManagerAssignments()
            .getWithResponse(resourceGroupName, workspaceName, workspaceManagerAssignmentName, context).getValue();
        return this;
    }
