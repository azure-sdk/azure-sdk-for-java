...
public final class PackageModelInner extends ResourceWithEtag {
     ...
     */
    public PackageModelInner withPackageId(String packageId) {
     ...
     * @return the PackageModelInner object itself.
     */
    public PackageModelInner withPackageKind(PackageKind packageKind) {
        if (this.innerProperties() == null) {
            this.innerProperties = new PackageProperties();
        }
     ...
     * @return the PackageModelInner object itself.
     */
    public PackageModelInner withInstalledVersion(String installedVersion) {
        if (this.innerProperties() == null) {
            this.innerProperties = new PackageProperties();
        }
     ...
     * @return the PackageModelInner object itself.
     */
    public PackageModelInner withResourceId(String resourceId) {
        if (this.innerProperties() == null) {
            this.innerProperties = new PackageProperties();
        }
     ...
     * @return the PackageModelInner object itself.
     */
    public PackageModelInner withIsNew(Boolean isNew) {
        if (this.innerProperties() == null) {
            this.innerProperties = new PackageProperties();
        }
     ...
     * @return the PackageModelInner object itself.
     */
    public PackageModelInner withIsPreview(Boolean isPreview) {
        if (this.innerProperties() == null) {
            this.innerProperties = new PackageProperties();
        }
     ...
     * @return the PackageModelInner object itself.
     */
    public PackageModelInner withIsFeatured(Boolean isFeatured) {
        if (this.innerProperties() == null) {
            this.innerProperties = new PackageProperties();
        }
     ...
     * @return the PackageModelInner object itself.
     */
    public PackageModelInner withThreatAnalyticsTechniques(List<String> threatAnalyticsTechniques) {
        if (this.innerProperties() == null) {
            this.innerProperties = new PackageProperties();
        }
     ...
     * @return the PackageModelInner object itself.
     */
    public PackageModelInner withPackageItems(String packageItems) {
        if (this.innerProperties() == null) {
            this.innerProperties = new PackageProperties();
        }
