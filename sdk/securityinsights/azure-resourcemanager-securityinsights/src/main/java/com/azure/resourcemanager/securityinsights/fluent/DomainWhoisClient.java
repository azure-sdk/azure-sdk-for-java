...
public interface DomainWhoisClient {
    ...
    Response<EnrichmentDomainWhoisInner> getWithResponse(String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    EnrichmentDomainWhoisInner get(String resourceGroupName, EnrichmentDomainModel enrichmentDomain);
}
