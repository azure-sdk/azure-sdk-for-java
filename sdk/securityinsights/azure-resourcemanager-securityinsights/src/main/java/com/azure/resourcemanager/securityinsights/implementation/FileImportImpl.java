...
public final class FileImportImpl implements FileImport, FileImport.Definition {
    ...
    public FileImport create() {
        this.innerObject = serviceManager.serviceClient().getFileImports()
    ...
    public FileImport create(Context context) {
        this.innerObject = serviceManager.serviceClient().getFileImports()
            .createWithResponse(resourceGroupName, workspaceName, fileImportId, this.innerModel(), context).getValue();
        return this;
    }
    ...
    public FileImport refresh() {
        this.innerObject = serviceManager.serviceClient().getFileImports()
            .getWithResponse(resourceGroupName, workspaceName, fileImportId, Context.NONE).getValue();
        return this;
    }

    public FileImport refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getFileImports()
            .getWithResponse(resourceGroupName, workspaceName, fileImportId, context).getValue();
        return this;
    }
