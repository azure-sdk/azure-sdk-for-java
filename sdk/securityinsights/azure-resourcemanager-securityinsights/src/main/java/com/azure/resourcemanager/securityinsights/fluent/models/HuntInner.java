...
public final class HuntInner extends ResourceWithEtag {
    ...
    public Integer huntSequenceNumber() {
        return this.innerProperties() == null ? null : this.innerProperties().huntSequenceNumber();
    }
     ...
     * @return the HuntInner object itself.
     */
    public HuntInner withHuntSequenceNumber(Integer huntSequenceNumber) {
        if (this.innerProperties() == null) {
            this.innerProperties = new HuntProperties();
        }
        this.innerProperties().withHuntSequenceNumber(huntSequenceNumber);
        return this;
    }
