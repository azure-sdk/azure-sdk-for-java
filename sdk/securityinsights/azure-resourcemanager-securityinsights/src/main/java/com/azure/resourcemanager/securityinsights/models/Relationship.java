...
public final class Relationship extends TIObjectInner {
    ...
    /**
     * Reads an instance of Relationship from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of Relationship if the JsonReader was pointing to an instance of it, or null if it was
     * pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the Relationship.
     */
    public static Relationship fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            Relationship deserializedRelationship = new Relationship();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("id".equals(fieldName)) {
                    deserializedRelationship.id = reader.getString();
                } else if ("name".equals(fieldName)) {
                    deserializedRelationship.name = reader.getString();
                } else if ("type".equals(fieldName)) {
                    deserializedRelationship.type = reader.getString();
                } else if ("properties".equals(fieldName)) {
                    deserializedRelationship.innerProperties = TIObjectCommonProperties.fromJson(reader);
                } else if ("systemData".equals(fieldName)) {
                    deserializedRelationship.systemData = SystemData.fromJson(reader);
                } else if ("kind".equals(fieldName)) {
                    deserializedRelationship.kind = TIObjectKind.fromString(reader.getString());
                } else {
                    reader.skipChildren();
                }
            }

            return deserializedRelationship;
        });
    }
}
