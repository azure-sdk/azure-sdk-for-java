...
public final class IncidentsImpl implements Incidents {
    ...
    public Response<Object> runPlaybookWithResponse(String resourceGroupName, String workspaceName,
        ...
        return this.serviceClient().runPlaybookWithResponse(resourceGroupName, workspaceName, incidentIdentifier,
            requestBody, context);
    }
    ...
    public Response<TeamInformation> createTeamWithResponse(String resourceGroupName, String workspaceName,
        ...
        Response<TeamInformationInner> inner = this.serviceClient().createTeamWithResponse(resourceGroupName,
            workspaceName, incidentId, teamProperties, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
