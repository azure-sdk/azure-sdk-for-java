 ...
 */
public interface ProductTemplatesClient {
    /**
    ...
    PagedIterable<ProductTemplateModelInner> list(String resourceGroupName, String workspaceName);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<ProductTemplateModelInner> list(String resourceGroupName, String workspaceName, String filter,
