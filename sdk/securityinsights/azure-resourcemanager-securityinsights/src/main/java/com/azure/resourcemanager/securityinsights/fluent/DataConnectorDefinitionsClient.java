...
public interface DataConnectorDefinitionsClient {
    ...
    Response<ConnectorDefinitionBaseArmCollectionWrapperInner> listWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ConnectorDefinitionBaseArmCollectionWrapperInner list(String resourceGroupName, String workspaceName);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<ConnectorDefinitionBaseArmObjectWrapperInner> getWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ConnectorDefinitionBaseArmObjectWrapperInner get(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<ConnectorDefinitionBaseArmObjectWrapperInner> createOrUpdateWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ConnectorDefinitionBaseArmObjectWrapperInner createOrUpdate(
        String resourceGroupName,
        String workspaceName,
        String dataConnectorDefinitionName,
        ConnectorDefinitionBaseArmObjectWrapperWithConverter connectorDefinitionInput);
