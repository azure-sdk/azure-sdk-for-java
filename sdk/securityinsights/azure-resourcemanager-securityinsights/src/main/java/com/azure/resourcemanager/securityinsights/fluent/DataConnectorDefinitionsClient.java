...
public interface DataConnectorDefinitionsClient {
    ...
    Response<DataConnectorDefinitionArmCollectionWrapperInner> listWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    DataConnectorDefinitionArmCollectionWrapperInner list(String resourceGroupName, String workspaceName);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<DataConnectorDefinitionInner> getWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    DataConnectorDefinitionInner get(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<DataConnectorDefinitionInner> createOrUpdateWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    DataConnectorDefinitionInner createOrUpdate(
        String resourceGroupName,
        String workspaceName,
        String dataConnectorDefinitionName,
        DataConnectorDefinitionInner connectorDefinitionInput);
