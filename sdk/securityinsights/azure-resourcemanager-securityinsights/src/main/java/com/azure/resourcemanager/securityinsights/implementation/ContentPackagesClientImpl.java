...
public final class ContentPackagesClientImpl implements ContentPackagesClient {
    ...
    public interface ContentPackagesService {
        ...
        @Get(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OperationalInsights"
                + "/workspaces/{workspaceName}/providers/Microsoft.SecurityInsights/contentPackages")
        ...
        @Get(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OperationalInsights"
                + "/workspaces/{workspaceName}/providers/Microsoft.SecurityInsights/contentPackages/{packageId}")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
    ...
    private Mono<PackageModelInner> getAsync(String resourceGroupName, String workspaceName, String packageId) {
        ...
        final Integer top = null;
        final String skipToken = null;
        return getWithResponseAsync(resourceGroupName, workspaceName, packageId, filter, orderby, top, skipToken)
    ...
    public Response<PackageModelInner> getWithResponse(
        ...
        return getWithResponseAsync(
                resourceGroupName, workspaceName, packageId, filter, orderby, top, skipToken, context)
            .block();
    }
    ...
    public PackageModelInner get(String resourceGroupName, String workspaceName, String packageId) {
        ...
        return getWithResponse(
                resourceGroupName, workspaceName, packageId, filter, orderby, top, skipToken, Context.NONE)
            .getValue();
    }
