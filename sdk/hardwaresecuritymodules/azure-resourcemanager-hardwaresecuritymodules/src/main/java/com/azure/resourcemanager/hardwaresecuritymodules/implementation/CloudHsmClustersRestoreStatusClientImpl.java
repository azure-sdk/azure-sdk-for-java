...
/**
 * An instance of this class provides access to all the operations defined in CloudHsmClustersRestoreStatusClient.
 */
public final class CloudHsmClustersRestoreStatusClientImpl implements CloudHsmClustersRestoreStatusClient {
    /**
     * The proxy service used to perform REST calls.
     */
    private final CloudHsmClustersRestoreStatusService service;
    ...
    /**
     * Initializes an instance of CloudHsmClustersRestoreStatusClientImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    CloudHsmClustersRestoreStatusClientImpl(AzureHsmResourceProviderImpl client) {
        this.service = RestProxy.create(CloudHsmClustersRestoreStatusService.class, client.getHttpPipeline(),
            client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for AzureHsmResourceProviderCloudHsmClustersRestoreStatus to be used by
     * the proxy service to perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "AzureHsmResourceProv")
    public interface CloudHsmClustersRestoreStatusService {
        @Headers({ "Content-Type: application/json" })
        @Get("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HardwareSecurityModules/cloudHsmClusters/{cloudHsmClusterName}/restore/{jobId}/pending")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<CloudHsmClustersRestoreStatusGetResponse> get(@HostParam("$host") String endpoint,
    ...
    private Mono<CloudHsmClustersRestoreStatusGetResponse> getWithResponseAsync(String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public CloudHsmClustersRestoreStatusGetResponse getWithResponse(String resourceGroupName,
        String cloudHsmClusterName, String jobId, Context context) {
