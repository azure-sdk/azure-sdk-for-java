...
public final class PrivateEndpointConnectionsClientImpl implements PrivateEndpointConnectionsClient {
     ...
     */
    PrivateEndpointConnectionsClientImpl(AzureHsmResourceProviderImpl client) {
        this.service =
            RestProxy
                .create(
    ...
    /**
     * The interface defining all the services for AzureHsmResourceProviderPrivateEndpointConnections to be used by the
     ...
     * @return list of private endpoint connections associated with the specified resource along with {@link
     *     PagedResponse} on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<PrivateEndpointConnectionInner>> listByCloudHsmClusterSinglePageAsync(
    ...
    private PagedFlux<PrivateEndpointConnectionInner> listByCloudHsmClusterAsync(
        String resourceGroupName, String cloudHsmClusterName) {
        return new PagedFlux<>(
            () -> listByCloudHsmClusterSinglePageAsync(resourceGroupName, cloudHsmClusterName),
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<PrivateEndpointConnectionInner> listByCloudHsmCluster(
        String resourceGroupName, String cloudHsmClusterName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<PrivateEndpointConnectionInner>> listByCloudHsmClusterNextSinglePageAsync(
        String nextLink) {
        if (nextLink == null) {
    ...
    private Mono<PagedResponse<PrivateEndpointConnectionInner>> listByCloudHsmClusterNextSinglePageAsync(
        ...
        context = this.client.mergeContext(context);
        return service
            .listByCloudHsmClusterNext(nextLink, this.client.getEndpoint(), accept, context)
            .map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(),
