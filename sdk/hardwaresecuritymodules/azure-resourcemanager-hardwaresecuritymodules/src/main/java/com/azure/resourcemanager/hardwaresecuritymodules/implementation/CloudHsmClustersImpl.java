...
public final class CloudHsmClustersImpl implements CloudHsmClusters {
    ...
    public CloudHsmClustersImpl(
        CloudHsmClustersClient innerClient,
        com.azure.resourcemanager.hardwaresecuritymodules.HardwareSecurityModulesManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public Response<CloudHsmCluster> getByResourceGroupWithResponse(
    ...
    public PagedIterable<CloudHsmCluster> listByResourceGroup(String resourceGroupName) {
        ...
        return Utils.mapPage(inner, inner1 -> new CloudHsmClusterImpl(inner1, this.manager()));
    }

    public PagedIterable<CloudHsmCluster> listByResourceGroup(
