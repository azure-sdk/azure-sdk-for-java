...
public final class CloudHsmClustersImpl implements CloudHsmClusters {
    ...
    public BackupResult preBackup(String resourceGroupName, String cloudHsmClusterName) {
        BackupResultInner inner = this.serviceClient().preBackup(resourceGroupName, cloudHsmClusterName);
        if (inner != null) {
    ...
    public BackupResult preBackup(String resourceGroupName, String cloudHsmClusterName,
        ...
        BackupResultInner inner
            = this.serviceClient().preBackup(resourceGroupName, cloudHsmClusterName, backupRequestProperties, context);
        if (inner != null) {
            return new BackupResultImpl(inner, this.manager());
        } else {
            return null;
    ...
    public RestoreResult preRestore(String resourceGroupName, String cloudHsmClusterName) {
        RestoreResultInner inner = this.serviceClient().preRestore(resourceGroupName, cloudHsmClusterName);
        if (inner != null) {
