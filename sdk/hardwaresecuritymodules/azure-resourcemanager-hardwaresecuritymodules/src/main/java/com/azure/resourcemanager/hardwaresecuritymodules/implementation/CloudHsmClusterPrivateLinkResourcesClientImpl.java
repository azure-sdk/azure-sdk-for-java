...
public final class CloudHsmClusterPrivateLinkResourcesClientImpl implements CloudHsmClusterPrivateLinkResourcesClient {
    ...
    CloudHsmClusterPrivateLinkResourcesClientImpl(AzureHsmResourceProviderImpl client) {
        this.service =
            RestProxy
                .create(
                    CloudHsmClusterPrivateLinkResourcesService.class,
    ...
    public interface CloudHsmClusterPrivateLinkResourcesService {
        ...
        Mono<Response<PrivateLinkResourceListResultInner>> listByCloudHsmCluster(
    ...
    private Mono<Response<PrivateLinkResourceListResultInner>> listByCloudHsmClusterWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PrivateLinkResourceListResultInner> listByCloudHsmClusterAsync(
        String resourceGroupName, String cloudHsmClusterName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<PrivateLinkResourceListResultInner> listByCloudHsmClusterWithResponse(
        String resourceGroupName, String cloudHsmClusterName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public PrivateLinkResourceListResultInner listByCloudHsmCluster(
        String resourceGroupName, String cloudHsmClusterName) {
