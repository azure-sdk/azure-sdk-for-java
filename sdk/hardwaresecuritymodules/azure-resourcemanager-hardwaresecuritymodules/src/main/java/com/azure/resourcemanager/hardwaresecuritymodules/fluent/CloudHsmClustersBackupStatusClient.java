 ...
 */
public interface CloudHsmClustersBackupStatusClient {
    /**
    ...
    CloudHsmClustersBackupStatusGetResponse getWithResponse(String resourceGroupName, String cloudHsmClusterName,
