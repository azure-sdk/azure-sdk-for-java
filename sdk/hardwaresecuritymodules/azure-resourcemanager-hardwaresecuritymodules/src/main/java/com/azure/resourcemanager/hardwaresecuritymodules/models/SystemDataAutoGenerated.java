...
public final class SystemDataAutoGenerated {
    ...
    /**
     * Get the createdBy property: The identity that created dedicated hsm resource.
     *
    ...
    /**
     * Set the createdBy property: The identity that created dedicated hsm resource.
     *
    ...
    /**
     * Get the createdByType property: The type of identity that created dedicated hsm resource.
     *
    ...
    /**
     * Set the createdByType property: The type of identity that created dedicated hsm resource.
     *
     * @param createdByType the createdByType value to set.
     * @return the SystemDataAutoGenerated object itself.
     */
    public SystemDataAutoGenerated withCreatedByType(IdentityType createdByType) {
        this.createdByType = createdByType;
        return this;
    }

    /**
     * Get the createdAt property: The timestamp of dedicated hsm resource creation (UTC).
     *
    ...
    /**
     * Set the createdAt property: The timestamp of dedicated hsm resource creation (UTC).
     *
    ...
    /**
     * Get the lastModifiedBy property: The identity that last modified dedicated hsm resource.
     *
    ...
    /**
     * Set the lastModifiedBy property: The identity that last modified dedicated hsm resource.
     *
    ...
    /**
     * Get the lastModifiedByType property: The type of identity that last modified dedicated hsm resource.
     *
    ...
    /**
     * Set the lastModifiedByType property: The type of identity that last modified dedicated hsm resource.
     *
     * @param lastModifiedByType the lastModifiedByType value to set.
     * @return the SystemDataAutoGenerated object itself.
     */
    public SystemDataAutoGenerated withLastModifiedByType(IdentityType lastModifiedByType) {
        this.lastModifiedByType = lastModifiedByType;
        return this;
    }

    /**
     * Get the lastModifiedAt property: The timestamp of dedicated hsm resource last modification (UTC).
     *
    ...
    /**
     * Set the lastModifiedAt property: The timestamp of dedicated hsm resource last modification (UTC).
     *
