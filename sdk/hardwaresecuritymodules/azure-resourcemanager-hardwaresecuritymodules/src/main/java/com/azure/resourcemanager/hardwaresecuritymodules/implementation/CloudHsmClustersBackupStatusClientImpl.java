...
/**
 * An instance of this class provides access to all the operations defined in CloudHsmClustersBackupStatusClient.
 */
public final class CloudHsmClustersBackupStatusClientImpl implements CloudHsmClustersBackupStatusClient {
    /**
     * The proxy service used to perform REST calls.
     */
    private final CloudHsmClustersBackupStatusService service;
    ...
    /**
     * Initializes an instance of CloudHsmClustersBackupStatusClientImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    CloudHsmClustersBackupStatusClientImpl(AzureHsmResourceProviderImpl client) {
        this.service = RestProxy.create(CloudHsmClustersBackupStatusService.class, client.getHttpPipeline(),
            client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for AzureHsmResourceProviderCloudHsmClustersBackupStatus to be used by
     * the proxy service to perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "AzureHsmResourceProv")
    public interface CloudHsmClustersBackupStatusService {
        @Headers({ "Content-Type: application/json" })
        @Get("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HardwareSecurityModules/cloudHsmClusters/{cloudHsmClusterName}/backup/{jobId}/pending")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<CloudHsmClustersBackupStatusGetResponse> get(@HostParam("$host") String endpoint,
    ...
    private Mono<CloudHsmClustersBackupStatusGetResponse> getWithResponseAsync(String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<BackupResultInner> getAsync(String resourceGroupName, String cloudHsmClusterName, String jobId) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public CloudHsmClustersBackupStatusGetResponse getWithResponse(String resourceGroupName, String cloudHsmClusterName,
