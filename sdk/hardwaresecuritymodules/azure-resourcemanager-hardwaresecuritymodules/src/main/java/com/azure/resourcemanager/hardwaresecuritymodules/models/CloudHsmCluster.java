...
public interface CloudHsmCluster {
     ...
     * @return backup operation Result.
     */
    BackupResult validateBackup(BackupRequestProperties backupRequestProperties, Context context);
     ...
     * @return restore operation properties.
     */
    RestoreResult validateRestore(RestoreRequestProperties restoreRequestProperties, Context context);
