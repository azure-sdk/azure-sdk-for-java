...
public interface CloudHsmCluster {
     ...
     * @return backup operation Result.
     */
    BackupResult preBackup(BackupRequestProperties backupRequestProperties, Context context);
     ...
     * @return restore operation properties.
     */
    RestoreResult preRestore(RestoreRequestProperties restoreRequestProperties, Context context);
