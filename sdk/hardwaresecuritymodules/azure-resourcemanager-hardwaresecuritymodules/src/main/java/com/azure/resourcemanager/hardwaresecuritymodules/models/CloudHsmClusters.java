...
public interface CloudHsmClusters {
     ...
     */
    BackupResult validateBackup(String resourceGroupName, String cloudHsmClusterName);
     ...
     */
    RestoreResult validateRestore(String resourceGroupName, String cloudHsmClusterName);
