 ...
 */
@Fluent
public class BackupRestoreBaseResult implements JsonSerializable<BackupRestoreBaseResult> {
    /*
    ...
    /**
     * Creates an instance of BackupRestoreBaseResult class.
     */
    public BackupRestoreBaseResult() {
    }
     ...
     * @return the BackupRestoreBaseResult object itself.
     */
    BackupRestoreBaseResult withStatus(BackupRestoreOperationStatus status) {
        this.status = status;
        return this;
    }
     ...
     * @return the BackupRestoreBaseResult object itself.
     */
    public BackupRestoreBaseResult withStatusDetails(String statusDetails) {
     ...
     * @return the BackupRestoreBaseResult object itself.
     */
    public BackupRestoreBaseResult withError(ManagementError error) {
        this.error = error;
        return this;
    }
     ...
     * @return the BackupRestoreBaseResult object itself.
     */
    BackupRestoreBaseResult withStartTime(OffsetDateTime startTime) {
     ...
     * @return the BackupRestoreBaseResult object itself.
     */
    BackupRestoreBaseResult withEndTime(OffsetDateTime endTime) {
     ...
     * @return the BackupRestoreBaseResult object itself.
     */
    public BackupRestoreBaseResult withJobId(String jobId) {
        this.jobId = jobId;
        return this;
    }
    ...
    /**
     * Reads an instance of BackupRestoreBaseResult from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of BackupRestoreBaseResult if the JsonReader was pointing to an instance of it, or null if it
     * was pointing to JSON null.
     * @throws IOException If an error occurs while reading the BackupRestoreBaseResult.
     */
    public static BackupRestoreBaseResult fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            BackupRestoreBaseResult deserializedBackupRestoreBaseResult = new BackupRestoreBaseResult();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("status".equals(fieldName)) {
                    deserializedBackupRestoreBaseResult.status
                        = BackupRestoreOperationStatus.fromString(reader.getString());
                } else if ("statusDetails".equals(fieldName)) {
                    deserializedBackupRestoreBaseResult.statusDetails = reader.getString();
                } else if ("error".equals(fieldName)) {
                    deserializedBackupRestoreBaseResult.error = ManagementError.fromJson(reader);
                } else if ("startTime".equals(fieldName)) {
                    deserializedBackupRestoreBaseResult.startTime = reader
                        .getNullable(nonNullReader -> CoreUtils.parseBestOffsetDateTime(nonNullReader.getString()));
                } else if ("endTime".equals(fieldName)) {
                    deserializedBackupRestoreBaseResult.endTime = reader
                        .getNullable(nonNullReader -> CoreUtils.parseBestOffsetDateTime(nonNullReader.getString()));
                } else if ("jobId".equals(fieldName)) {
                    deserializedBackupRestoreBaseResult.jobId = reader.getString();
                } else {
                    reader.skipChildren();
                }
            }

            return deserializedBackupRestoreBaseResult;
        });
    }
}
