...
public final class CloudHsmClustersClientImpl implements CloudHsmClustersClient {
    ...
    public interface CloudHsmClustersService {
        ...
        Mono<Response<Flux<ByteBuffer>>> createOrUpdate(
            ...
            @BodyParam("application/json") CloudHsmClusterInner body,
        ...
        Mono<Response<Flux<ByteBuffer>>> update(
            ...
            @PathParam("cloudHsmClusterName") String cloudHsmClusterName,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") CloudHsmClusterPatchParameters body,
            @HeaderParam("Accept") String accept,
            Context context);
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<CloudHsmClusterInner>> getByResourceGroup(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("cloudHsmClusterName") String cloudHsmClusterName,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<CloudHsmClusterListResult>> listByResourceGroup(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<CloudHsmClusterListResult>> list(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @QueryParam("$skiptoken") String skiptoken,
            @QueryParam("api-version") String apiVersion,
    ...
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(
        String resourceGroupName, String cloudHsmClusterName, CloudHsmClusterInner body) {
        ...
        final String apiVersion = "2022-08-31-preview";
    ...
    private PollerFlux<PollResult<CloudHsmClusterInner>, CloudHsmClusterInner> beginCreateOrUpdateAsync(
        ...
        return this
            .client
            .<CloudHsmClusterInner, CloudHsmClusterInner>getLroResult(
                mono,
    ...
    private PollerFlux<PollResult<CloudHsmClusterInner>, CloudHsmClusterInner> beginCreateOrUpdateAsync(
        ...
        return this
            .client
            .<CloudHsmClusterInner, CloudHsmClusterInner>getLroResult(
                mono, this.client.getHttpPipeline(), CloudHsmClusterInner.class, CloudHsmClusterInner.class, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<CloudHsmClusterInner> createOrUpdateAsync(
        String resourceGroupName, String cloudHsmClusterName, CloudHsmClusterInner body) {
        return beginCreateOrUpdateAsync(resourceGroupName, cloudHsmClusterName, body)
            .last()
    ...
    private Mono<CloudHsmClusterInner> createOrUpdateAsync(
        String resourceGroupName, String cloudHsmClusterName, CloudHsmClusterInner body, Context context) {
        return beginCreateOrUpdateAsync(resourceGroupName, cloudHsmClusterName, body, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public CloudHsmClusterInner createOrUpdate(
        String resourceGroupName, String cloudHsmClusterName, CloudHsmClusterInner body) {
    ...
    private Mono<Response<Flux<ByteBuffer>>> updateWithResponseAsync(
        String resourceGroupName, String cloudHsmClusterName, CloudHsmClusterPatchParameters body) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<CloudHsmClusterInner>, CloudHsmClusterInner> beginUpdate(
        String resourceGroupName, String cloudHsmClusterName, CloudHsmClusterPatchParameters body) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<CloudHsmClusterInner> updateAsync(
        String resourceGroupName, String cloudHsmClusterName, CloudHsmClusterPatchParameters body) {
        return beginUpdateAsync(resourceGroupName, cloudHsmClusterName, body)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<CloudHsmClusterInner> updateAsync(
        String resourceGroupName, String cloudHsmClusterName, CloudHsmClusterPatchParameters body, Context context) {
        return beginUpdateAsync(resourceGroupName, cloudHsmClusterName, body, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public CloudHsmClusterInner update(
        String resourceGroupName, String cloudHsmClusterName, CloudHsmClusterPatchParameters body) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<CloudHsmClusterInner>> getByResourceGroupWithResponseAsync(
        String resourceGroupName, String cloudHsmClusterName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<CloudHsmClusterInner>> getByResourceGroupWithResponseAsync(
        String resourceGroupName, String cloudHsmClusterName, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<CloudHsmClusterInner> getByResourceGroupWithResponse(
        String resourceGroupName, String cloudHsmClusterName, Context context) {
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String cloudHsmClusterName) {
        return beginDeleteAsync(resourceGroupName, cloudHsmClusterName)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String cloudHsmClusterName, Context context) {
        return beginDeleteAsync(resourceGroupName, cloudHsmClusterName, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<CloudHsmClusterInner>> listByResourceGroupSinglePageAsync(
                ...
                context ->
                    service
                        .listByResourceGroup(
                            ...
                            accept,
                            context))
            .<PagedResponse<CloudHsmClusterInner>>map(
                res ->
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<CloudHsmClusterInner> listByResourceGroupAsync(
        String resourceGroupName, String skiptoken, Context context) {
        return new PagedFlux<>(
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<CloudHsmClusterInner> listByResourceGroup(
        String resourceGroupName, String skiptoken, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<CloudHsmClusterInner>> listByResourceGroupNextSinglePageAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<CloudHsmClusterInner>> listBySubscriptionNextSinglePageAsync(
        String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
