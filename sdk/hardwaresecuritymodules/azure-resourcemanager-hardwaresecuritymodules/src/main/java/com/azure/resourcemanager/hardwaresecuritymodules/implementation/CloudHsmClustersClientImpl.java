...
public final class CloudHsmClustersClientImpl implements CloudHsmClustersClient {
    ...
    public interface CloudHsmClustersService {
        ...
        @ExpectedResponses({ 200, 202 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Flux<ByteBuffer>>> validateBackup(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("cloudHsmClusterName") String cloudHsmClusterName, @QueryParam("api-version") String apiVersion,
        ...
        @ExpectedResponses({ 200, 202 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Flux<ByteBuffer>>> validateRestore(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("cloudHsmClusterName") String cloudHsmClusterName, @QueryParam("api-version") String apiVersion,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> validateBackupWithResponseAsync(String resourceGroupName,
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.validateBackup(this.client.getEndpoint(), this.client.getSubscriptionId(),
    ...
    private Mono<Response<Flux<ByteBuffer>>> validateBackupWithResponseAsync(String resourceGroupName,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.validateBackup(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<BackupResultInner>, BackupResultInner> beginValidateBackupAsync(
        String resourceGroupName, String cloudHsmClusterName, BackupRequestProperties backupRequestProperties) {
        Mono<Response<Flux<ByteBuffer>>> mono
            = validateBackupWithResponseAsync(resourceGroupName, cloudHsmClusterName, backupRequestProperties);
    ...
    private PollerFlux<PollResult<BackupResultInner>, BackupResultInner>
        beginValidateBackupAsync(String resourceGroupName, String cloudHsmClusterName) {
    ...
    private PollerFlux<PollResult<BackupResultInner>, BackupResultInner> beginValidateBackupAsync(
        ...
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono
            = validateBackupWithResponseAsync(resourceGroupName, cloudHsmClusterName, backupRequestProperties, context);
        return this.client.<BackupResultInner, BackupResultInner>getLroResult(mono, this.client.getHttpPipeline(),
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<BackupResultInner>, BackupResultInner> beginValidateBackup(String resourceGroupName,
        String cloudHsmClusterName) {
        final BackupRequestProperties backupRequestProperties = null;
        return this.beginValidateBackupAsync(resourceGroupName, cloudHsmClusterName, backupRequestProperties)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<BackupResultInner>, BackupResultInner> beginValidateBackup(String resourceGroupName,
        String cloudHsmClusterName, BackupRequestProperties backupRequestProperties, Context context) {
        return this.beginValidateBackupAsync(resourceGroupName, cloudHsmClusterName, backupRequestProperties, context)
            .getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<BackupResultInner> validateBackupAsync(String resourceGroupName, String cloudHsmClusterName,
        BackupRequestProperties backupRequestProperties) {
        return beginValidateBackupAsync(resourceGroupName, cloudHsmClusterName, backupRequestProperties).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<BackupResultInner> validateBackupAsync(String resourceGroupName, String cloudHsmClusterName,
        ...
        return beginValidateBackupAsync(resourceGroupName, cloudHsmClusterName, backupRequestProperties, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public BackupResultInner validateBackup(String resourceGroupName, String cloudHsmClusterName) {
        final BackupRequestProperties backupRequestProperties = null;
        return validateBackupAsync(resourceGroupName, cloudHsmClusterName, backupRequestProperties).block();
    }
    ...
    public BackupResultInner validateBackup(String resourceGroupName, String cloudHsmClusterName,
        BackupRequestProperties backupRequestProperties, Context context) {
        return validateBackupAsync(resourceGroupName, cloudHsmClusterName, backupRequestProperties, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> validateRestoreWithResponseAsync(String resourceGroupName,
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.validateRestore(this.client.getEndpoint(), this.client.getSubscriptionId(),
    ...
    private Mono<Response<Flux<ByteBuffer>>> validateRestoreWithResponseAsync(String resourceGroupName,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.validateRestore(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<RestoreResultInner>, RestoreResultInner> beginValidateRestoreAsync(
        String resourceGroupName, String cloudHsmClusterName, RestoreRequestProperties restoreRequestProperties) {
        Mono<Response<Flux<ByteBuffer>>> mono
            = validateRestoreWithResponseAsync(resourceGroupName, cloudHsmClusterName, restoreRequestProperties);
    ...
    private PollerFlux<PollResult<RestoreResultInner>, RestoreResultInner>
        beginValidateRestoreAsync(String resourceGroupName, String cloudHsmClusterName) {
    ...
    private PollerFlux<PollResult<RestoreResultInner>, RestoreResultInner> beginValidateRestoreAsync(
        ...
        Context context) {
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono = validateRestoreWithResponseAsync(resourceGroupName, cloudHsmClusterName,
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<RestoreResultInner>, RestoreResultInner> beginValidateRestore(String resourceGroupName,
        String cloudHsmClusterName) {
        final RestoreRequestProperties restoreRequestProperties = null;
        return this.beginValidateRestoreAsync(resourceGroupName, cloudHsmClusterName, restoreRequestProperties)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<RestoreResultInner>, RestoreResultInner> beginValidateRestore(String resourceGroupName,
        String cloudHsmClusterName, RestoreRequestProperties restoreRequestProperties, Context context) {
        return this.beginValidateRestoreAsync(resourceGroupName, cloudHsmClusterName, restoreRequestProperties, context)
            .getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<RestoreResultInner> validateRestoreAsync(String resourceGroupName, String cloudHsmClusterName,
        RestoreRequestProperties restoreRequestProperties) {
        return beginValidateRestoreAsync(resourceGroupName, cloudHsmClusterName, restoreRequestProperties).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<RestoreResultInner> validateRestoreAsync(String resourceGroupName, String cloudHsmClusterName,
        ...
        return beginValidateRestoreAsync(resourceGroupName, cloudHsmClusterName, restoreRequestProperties, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public RestoreResultInner validateRestore(String resourceGroupName, String cloudHsmClusterName) {
        final RestoreRequestProperties restoreRequestProperties = null;
        return validateRestoreAsync(resourceGroupName, cloudHsmClusterName, restoreRequestProperties).block();
    }
    ...
    public RestoreResultInner validateRestore(String resourceGroupName, String cloudHsmClusterName,
        RestoreRequestProperties restoreRequestProperties, Context context) {
        return validateRestoreAsync(resourceGroupName, cloudHsmClusterName, restoreRequestProperties, context).block();
    }
