...
public final class CloudHsmClusterPrivateEndpointConnectionsClientImpl
    ...
    CloudHsmClusterPrivateEndpointConnectionsClientImpl(AzureHsmResourceProviderImpl client) {
        this.service =
            RestProxy
                .create(
                    CloudHsmClusterPrivateEndpointConnectionsService.class,
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String cloudHsmClusterName, String peConnectionName) {
        return beginDeleteAsync(resourceGroupName, cloudHsmClusterName, peConnectionName)
            .last()
    ...
    private Mono<Void> deleteAsync(
        String resourceGroupName, String cloudHsmClusterName, String peConnectionName, Context context) {
        return beginDeleteAsync(resourceGroupName, cloudHsmClusterName, peConnectionName, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
