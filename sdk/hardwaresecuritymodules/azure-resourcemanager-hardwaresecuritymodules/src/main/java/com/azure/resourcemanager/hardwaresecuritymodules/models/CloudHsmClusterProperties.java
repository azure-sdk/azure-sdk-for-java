...
public final class CloudHsmClusterProperties implements JsonSerializable<CloudHsmClusterProperties> {
    ...
    /*
     * False: Non-FIPS Mode with single-factor authentication. True: FIPS Approved Mode with single-factor
     * authentication
     */
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeBooleanField("fipsApprovedMode", this.fipsApprovedMode);
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("activationState".equals(fieldName)) {
                    ...
                    deserializedCloudHsmClusterProperties.autoGeneratedDomainNameLabelScope = reader.getString();
                } else if ("fipsApprovedMode".equals(fieldName)) {
                    deserializedCloudHsmClusterProperties.fipsApprovedMode = reader.getNullable(JsonReader::getBoolean);
                    ...
                    deserializedCloudHsmClusterProperties.publicNetworkAccess = reader.getString();
