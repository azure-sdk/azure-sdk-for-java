...
public final class CloudHsmClusterProperties {
     ...
     */
    @JsonProperty(value = "fipsApprovedMode")
    private Boolean fipsApprovedMode;
    ...
    /**
     * Set the activationState property: State of security domain activation.
     * 
     * @param activationState the activationState value to set.
     * @return the CloudHsmClusterProperties object itself.
     */
    public CloudHsmClusterProperties withActivationState(String activationState) {
    ...
    /**
     * Get the fipsApprovedMode property: False: Non-FIPS Mode with-single factor authentication. True: FIPS approved
     * Mode with single-factor authentication.
     * 
     * @return the fipsApprovedMode value.
     */
    public Boolean fipsApprovedMode() {
        return this.fipsApprovedMode;
    }

    /**
     * Set the fipsApprovedMode property: False: Non-FIPS Mode with-single factor authentication. True: FIPS approved
     * Mode with single-factor authentication.
     * 
     * @param fipsApprovedMode the fipsApprovedMode value to set.
     * @return the CloudHsmClusterProperties object itself.
     */
    public CloudHsmClusterProperties withFipsApprovedMode(Boolean fipsApprovedMode) {
        this.fipsApprovedMode = fipsApprovedMode;
        return this;
    }
