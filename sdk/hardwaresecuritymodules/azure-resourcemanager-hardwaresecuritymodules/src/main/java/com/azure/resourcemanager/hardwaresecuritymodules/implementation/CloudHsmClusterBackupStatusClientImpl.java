...
public final class CloudHsmClusterBackupStatusClientImpl implements CloudHsmClusterBackupStatusClient {
    ...
    public interface CloudHsmClusterBackupStatusService {
        ...
        Mono<CloudHsmClusterBackupStatusGetResponse> get(@HostParam("$host") String endpoint,
    ...
    private Mono<CloudHsmClusterBackupStatusGetResponse> getWithResponseAsync(String resourceGroupName,
