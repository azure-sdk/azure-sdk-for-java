...
public final class CloudHsmClusterPrivateEndpointConnectionsImpl implements CloudHsmClusterPrivateEndpointConnections {
    ...
    public CloudHsmClusterPrivateEndpointConnectionsImpl(
        CloudHsmClusterPrivateEndpointConnectionsClient innerClient,
    ...
    public Response<PrivateEndpointConnection> getWithResponse(
        String resourceGroupName, String cloudHsmClusterName, String peConnectionName, Context context) {
    ...
    public PrivateEndpointConnection get(
        String resourceGroupName, String cloudHsmClusterName, String peConnectionName) {
    ...
    public PrivateEndpointConnection getById(String id) {
        ...
        String cloudHsmClusterName = Utils.getValueFromIdByName(id, "cloudHsmClusters");
            ...
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException(
                        String
                            .format(
                                "The resource ID '%s' is not valid. Missing path segment 'cloudHsmClusters'.", id)));
        }
        String peConnectionName = Utils.getValueFromIdByName(id, "privateEndpointConnections");
