 ...
 */
public interface CloudHsmClustersRestoreStatusClient {
    /**
    ...
    CloudHsmClustersRestoreStatusGetResponse getWithResponse(String resourceGroupName, String cloudHsmClusterName,
