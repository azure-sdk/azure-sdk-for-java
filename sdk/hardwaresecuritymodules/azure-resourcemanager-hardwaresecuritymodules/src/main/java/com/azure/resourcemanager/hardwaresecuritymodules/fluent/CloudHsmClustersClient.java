...
public interface CloudHsmClustersClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<BackupResultInner>, BackupResultInner> beginValidateBackup(String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    BackupResultInner validateBackup(String resourceGroupName, String cloudHsmClusterName);
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<RestoreResultInner>, RestoreResultInner> beginValidateRestore(String resourceGroupName,
        String cloudHsmClusterName);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    RestoreResultInner validateRestore(String resourceGroupName, String cloudHsmClusterName);
