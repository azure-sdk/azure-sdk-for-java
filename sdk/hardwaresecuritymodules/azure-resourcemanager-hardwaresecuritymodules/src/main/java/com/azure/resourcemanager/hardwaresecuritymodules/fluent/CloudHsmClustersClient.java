...
public interface CloudHsmClustersClient {
    ...
    SyncPoller<PollResult<CloudHsmClusterInner>, CloudHsmClusterInner> beginCreateOrUpdate(
    ...
    CloudHsmClusterInner createOrUpdate(
        String resourceGroupName, String cloudHsmClusterName, CloudHsmClusterInner body);
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<CloudHsmClusterInner>, CloudHsmClusterInner> beginUpdate(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<CloudHsmClusterInner> getByResourceGroupWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<CloudHsmClusterInner> listByResourceGroup(
