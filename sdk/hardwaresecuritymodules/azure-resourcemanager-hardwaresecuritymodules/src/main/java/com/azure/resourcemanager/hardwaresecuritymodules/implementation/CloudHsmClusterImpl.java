...
public final class CloudHsmClusterImpl implements CloudHsmCluster, CloudHsmCluster.Definition, CloudHsmCluster.Update {
    ...
    public RestoreProperties restoreProperties() {
        return this.innerModel().restoreProperties();
    }

    public BackupProperties backupProperties() {
        return this.innerModel().backupProperties();
    }
    ...
    public CloudHsmClusterImpl withRestoreProperties(RestoreProperties restoreProperties) {
        this.innerModel().withRestoreProperties(restoreProperties);
        return this;
    }

    public CloudHsmClusterImpl withBackupProperties(BackupProperties backupProperties) {
        if (isInCreateMode()) {
            this.innerModel().withBackupProperties(backupProperties);
            return this;
        } else {
            this.updateBody.withBackupProperties(backupProperties);
            return this;
        }
    }
