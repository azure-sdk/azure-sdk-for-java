...
public final class CloudHsmClusterImpl implements CloudHsmCluster, CloudHsmCluster.Definition, CloudHsmCluster.Update {
    ...
    public BackupResult validateBackup() {
        return serviceManager.cloudHsmClusters().validateBackup(resourceGroupName, cloudHsmClusterName);
    }

    public BackupResult validateBackup(BackupRequestProperties backupRequestProperties, Context context) {
    ...
    public RestoreResult validateRestore() {
        return serviceManager.cloudHsmClusters().validateRestore(resourceGroupName, cloudHsmClusterName);
    }

    public RestoreResult validateRestore(RestoreRequestProperties restoreRequestProperties, Context context) {
        return serviceManager.cloudHsmClusters()
