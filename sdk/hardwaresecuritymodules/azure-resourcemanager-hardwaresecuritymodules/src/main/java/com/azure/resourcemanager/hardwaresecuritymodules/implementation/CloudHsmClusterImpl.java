...
public final class CloudHsmClusterImpl implements CloudHsmCluster, CloudHsmCluster.Definition, CloudHsmCluster.Update {
    ...
    public BackupResult preBackup() {
        return serviceManager.cloudHsmClusters().preBackup(resourceGroupName, cloudHsmClusterName);
    }

    public BackupResult preBackup(BackupRequestProperties backupRequestProperties, Context context) {
        return serviceManager.cloudHsmClusters()
            .preBackup(resourceGroupName, cloudHsmClusterName, backupRequestProperties, context);
    }
    ...
    public RestoreResult preRestore() {
        return serviceManager.cloudHsmClusters().preRestore(resourceGroupName, cloudHsmClusterName);
    }

    public RestoreResult preRestore(RestoreRequestProperties restoreRequestProperties, Context context) {
        return serviceManager.cloudHsmClusters()
            .preRestore(resourceGroupName, cloudHsmClusterName, restoreRequestProperties, context);
    }
