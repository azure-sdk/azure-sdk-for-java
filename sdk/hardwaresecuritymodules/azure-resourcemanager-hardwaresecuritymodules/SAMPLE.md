...
- [ValidateBackup](#cloudhsmclusters_validatebackup)
- [ValidateRestore](#cloudhsmclusters_validaterestore)
...
### CloudHsmClusters_ValidateBackup

```java
import com.azure.resourcemanager.hardwaresecuritymodules.models.BackupRequestProperties;

/**
 * Samples for CloudHsmClusters ValidateBackup.
 */
public final class CloudHsmClustersValidateBackupSamples {
    /*
     * x-ms-original-file:
     * specification/hardwaresecuritymodules/resource-manager/Microsoft.HardwareSecurityModules/stable/2024-06-30/
     * examples/CloudHsmCluster_CreateOrValidate_Backup_MaximumSet_Gen.json
    ...
    public static void cloudHsmClusterValidateBackupValidationMaximumSetGen(
        com.azure.resourcemanager.hardwaresecuritymodules.HardwareSecurityModulesManager manager) {
        manager.cloudHsmClusters()
            .validateBackup("rgcloudhsm", "chsm1",
                new BackupRequestProperties()
                    .withAzureStorageBlobContainerUri(
                        "https://myaccount.blob.core.windows.net/sascontainer/sasContainer")
                    .withToken("fakeTokenPlaceholder"),
...
### CloudHsmClusters_ValidateRestore

```java
import com.azure.resourcemanager.hardwaresecuritymodules.models.RestoreRequestProperties;

/**
 * Samples for CloudHsmClusters ValidateRestore.
 */
public final class CloudHsmClustersValidateRestoreSamples {
    /*
     * x-ms-original-file:
     * specification/hardwaresecuritymodules/resource-manager/Microsoft.HardwareSecurityModules/stable/2024-06-30/
     * examples/CloudHsmCluster_RequestOrValidate_Restore_MaximumSet_Gen.json
    ...
    public static void cloudHsmClusterValidateRestoreMaximumSetGen(
        com.azure.resourcemanager.hardwaresecuritymodules.HardwareSecurityModulesManager manager) {
        manager.cloudHsmClusters()
            .validateRestore("rgcloudhsm", "chsm1",
                new RestoreRequestProperties()
                    .withAzureStorageBlobContainerUri(
                        "https://myaccount.blob.core.windows.net/sascontainer/sasContainer")
                    .withBackupId("backupId"),
