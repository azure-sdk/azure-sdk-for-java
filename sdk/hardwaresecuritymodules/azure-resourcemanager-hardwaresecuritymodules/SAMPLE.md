...
- [PreBackup](#cloudhsmclusters_prebackup)
- [PreRestore](#cloudhsmclusters_prerestore)
- [Restore](#cloudhsmclusters_restore)
- [Update](#cloudhsmclusters_update)

## CloudHsmClustersBackupStatus

- [Get](#cloudhsmclustersbackupstatus_get)

## CloudHsmClustersRestoreStatus

- [Get](#cloudhsmclustersrestorestatus_get)
...
public final class CloudHsmClustersBackupSamples {
     ...
     * x-ms-original-file:
     * specification/hardwaresecuritymodules/resource-manager/Microsoft.HardwareSecurityModules/stable/2024-06-30/
     * examples/CloudHsmCluster_CreateOrValidate_Backup_MaximumSet_Gen.json
     */
    /**
...
public final class CloudHsmClustersGetByResourceGroupSamples {
     ...
     * x-ms-original-file:
     * specification/hardwaresecuritymodules/resource-manager/Microsoft.HardwareSecurityModules/stable/2024-06-30/
     * examples/CloudHsmCluster_Get_MaximumSet_Gen.json
     */
    /**
...
public final class CloudHsmClustersListSamples {
     ...
     * x-ms-original-file:
     * specification/hardwaresecuritymodules/resource-manager/Microsoft.HardwareSecurityModules/stable/2024-06-30/
     * examples/CloudHsmCluster_ListBySubscription_MaximumSet_Gen.json
     */
    /**
...
public final class CloudHsmClustersListByResourceGroupSamples {
     ...
     * x-ms-original-file:
     * specification/hardwaresecuritymodules/resource-manager/Microsoft.HardwareSecurityModules/stable/2024-06-30/
     * examples/CloudHsmCluster_ListByResourceGroup_MaximumSet_Gen.json
     */
    /**
...
### CloudHsmClusters_PreBackup

```java
import com.azure.resourcemanager.hardwaresecuritymodules.models.BackupRequestProperties;

/**
 * Samples for CloudHsmClusters PreBackup.
 */
public final class CloudHsmClustersPreBackupSamples {
    /*
     * x-ms-original-file:
     * specification/hardwaresecuritymodules/resource-manager/Microsoft.HardwareSecurityModules/stable/2024-06-30/
     * examples/CloudHsmCluster_CreateOrValidate_Backup_MaximumSet_Gen.json
     */
    /**
     * Sample code: CloudHsmCluster_PreBackup_Validation_MaximumSet_Gen.
     * 
     * @param manager Entry point to HardwareSecurityModulesManager.
     */
    public static void cloudHsmClusterPreBackupValidationMaximumSetGen(
        com.azure.resourcemanager.hardwaresecuritymodules.HardwareSecurityModulesManager manager) {
        manager.cloudHsmClusters()
            .preBackup("rgcloudhsm", "chsm1",
                new BackupRequestProperties()
                    .withAzureStorageBlobContainerUri(
                        "https://myaccount.blob.core.windows.net/sascontainer/sasContainer")
                    .withToken("fakeTokenPlaceholder"),
...
### CloudHsmClustersBackupStatus_Get

```java
/**
 * Samples for CloudHsmClustersBackupStatus Get.
 */
public final class CloudHsmClustersBackupStatusGetSamples {
    /*
     * x-ms-original-file:
     * specification/hardwaresecuritymodules/resource-manager/Microsoft.HardwareSecurityModules/stable/2024-06-30/
     * examples/CloudHsmCluster_Backup_Pending_MaximumSet_Gen.json
     */
    /**
    ...
    public static void cloudHsmClusterGetBackupStatusMaximumSetGen(
        com.azure.resourcemanager.hardwaresecuritymodules.HardwareSecurityModulesManager manager) {
        manager.cloudHsmClustersBackupStatus()
...
### CloudHsmClustersRestoreStatus_Get

```java
/**
 * Samples for CloudHsmClustersRestoreStatus Get.
 */
public final class CloudHsmClustersRestoreStatusGetSamples {
    /*
     * x-ms-original-file:
     * specification/hardwaresecuritymodules/resource-manager/Microsoft.HardwareSecurityModules/stable/2024-06-30/
     * examples/CloudHsmCluster_Restore_Pending_MaximumSet_Gen.json
     */
    /**
    ...
    public static void cloudHsmClusterGetRestoreStatusMaximumSetGen(
        com.azure.resourcemanager.hardwaresecuritymodules.HardwareSecurityModulesManager manager) {
        manager.cloudHsmClustersRestoreStatus()
            .getWithResponse("rgcloudhsm", "chsm1", "572a45927fc240e1ac075de27371680b",
                com.azure.core.util.Context.NONE);
    }
}
...
public final class PrivateEndpointConnectionsListByCloudHsmClusterSamples {
     ...
     * x-ms-original-file:
     * specification/hardwaresecuritymodules/resource-manager/Microsoft.HardwareSecurityModules/stable/2024-06-30/
     * examples/CloudHsmClusterPrivateEndpointConnection_ListByCloudHsmCluster_MaximumSet_Gen.json
     */
    /**
