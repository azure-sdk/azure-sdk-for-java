...
package com.azure.developer.signing;
...
import com.azure.developer.signing.implementation.CertificateProfileOperationsImpl;
import com.azure.developer.signing.models.ExtendedKeyUsage;
import com.azure.developer.signing.models.OperationStatusSignResultError;
import com.azure.developer.signing.models.SigningPayloadOptions;
import com.azure.developer.signing.models.SignResult;
...
public final class SigningAsyncClient {
     ...
     */
    @Generated
    SigningAsyncClient(CertificateProfileOperationsImpl serviceClient) {
    ...
    public Mono<Response<BinaryData>> getSigningStatusWithResponse(String accountName, String certificateProfile,
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> getSignRootCertificateWithResponse(String accountName, String certificateProfile,
    ...
    public PagedFlux<BinaryData> listExtendedKeyUsages(String accountName, String certificateProfile,
        RequestOptions requestOptions) {
     ...
     * <tr><td>client-version</td><td>String</td><td>No</td><td>An optional client version.</td></tr>
     * <tr><td>x-correlation-id</td><td>String</td><td>No</td><td>An identifier used to batch multiple
     * requests.</td></tr>
     * </table>
    ...
    public PollerFlux<BinaryData, BinaryData> beginSign(String accountName, String certificateProfile, BinaryData body,
        RequestOptions requestOptions) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<OperationStatusSignResultError> getSigningStatus(String accountName, String certificateProfile,
        String operationId) {
    ...
    public PagedFlux<ExtendedKeyUsage> listExtendedKeyUsages(String accountName, String certificateProfile) {
        ...
        return PagedFlux.create(() -> (continuationTokenParam, pageSizeParam) -> {
            ...
            return flux.map(pagedResponse -> new PagedResponseBase<Void, ExtendedKeyUsage>(pagedResponse.getRequest(),
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public PollerFlux<PollOperationDetails, SignResult> beginSign(String accountName, String certificateProfile,
