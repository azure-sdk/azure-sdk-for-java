...
import com.azure.developer.signing.implementation.SigningClientImpl;
...
public final class SigningClientBuilder implements HttpTrait<SigningClientBuilder>,
    ConfigurationTrait<SigningClientBuilder>, TokenCredentialTrait<SigningClientBuilder> {
    @Generated
    ...
    @Generated
    private static final Map<String, String> PROPERTIES = CoreUtils.getProperties("azure-developer-signing.properties");
     ...
     */
    @Generated
    private SigningServiceVersion serviceVersion;
    ...
    private SigningClientImpl buildInnerClient() {
        ...
        SigningClientImpl client = new SigningClientImpl(localPipeline, JacksonAdapter.createDefaultSerializerAdapter(),
            this.region, localServiceVersion);
        return client;
    }
    ...
    public SigningAsyncClient buildAsyncClient() {
        return new SigningAsyncClient(buildInnerClient().getCertificateProfileOperations());
    }
    ...
    public SigningClient buildClient() {
        return new SigningClient(buildInnerClient().getCertificateProfileOperations());
    }
