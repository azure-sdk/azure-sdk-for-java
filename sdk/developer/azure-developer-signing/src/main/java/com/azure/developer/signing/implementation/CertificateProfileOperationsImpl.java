...
package com.azure.developer.signing.implementation;
...
import com.azure.developer.signing.SigningServiceVersion;
...
public final class CertificateProfileOperationsImpl {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> signWithResponse(String accountName, String certificateProfile, BinaryData body,
        RequestOptions requestOptions) {
        final String contentType = "application/json";
        final String accept = "application/json";
    ...
    public PollerFlux<BinaryData, BinaryData> beginSignAsync(String accountName, String certificateProfile,
        ...
        return PollerFlux.create(Duration.ofSeconds(1),
            ...
            new com.azure.developer.signing.implementation.OperationLocationPollingStrategy<>(
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<BinaryData, BinaryData> beginSign(String accountName, String certificateProfile, BinaryData body,
        RequestOptions requestOptions) {
        return SyncPoller.createPoller(Duration.ofSeconds(1),
            () -> this.signWithResponse(accountName, certificateProfile, body, requestOptions),
            new com.azure.developer.signing.implementation.SyncOperationLocationPollingStrategy<>(
                new PollingStrategyOptions(this.client.getHttpPipeline())
