...
public final class SkusClientImpl implements SkusClient {
    ...
    private interface SkusService {
        ...
        Mono<Response<SkuList>> listByOffer(
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<SkuList>> listByOfferNext(
    ...
    private Mono<PagedResponse<SkuInner>> listByOfferSinglePageAsync(
    ...
    private PagedFlux<SkuInner> listByOfferAsync(
        String resourceGroupName, String clusterName, String publisherName, String offerName, String expand) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<SkuInner> listByOffer(
        String resourceGroupName, String clusterName, String publisherName, String offerName) {
        final String expand = null;
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<SkuInner>> getWithResponseAsync(
        String resourceGroupName,
        String clusterName,
        String publisherName,
        String offerName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<SkuInner> getAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<SkuInner> getWithResponse(
        String resourceGroupName,
        String clusterName,
        String publisherName,
        String offerName,
    ...
    private Mono<PagedResponse<SkuInner>> listByOfferNextSinglePageAsync(String nextLink, Context context) {
        ...
        context = this.client.mergeContext(context);
        return service
            .listByOfferNext(nextLink, this.client.getEndpoint(), accept, context)
            .map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(),
