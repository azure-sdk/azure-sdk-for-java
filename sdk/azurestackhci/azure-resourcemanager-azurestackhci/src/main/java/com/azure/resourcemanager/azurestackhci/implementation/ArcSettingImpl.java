...
public final class ArcSettingImpl implements ArcSetting, ArcSetting.Definition, ArcSetting.Update {
    ...
    public ArcSetting create() {
        this.innerObject = serviceManager.serviceClient().getArcSettings()
    ...
    public ArcSetting create(Context context) {
        this.innerObject = serviceManager.serviceClient().getArcSettings()
            .createWithResponse(resourceGroupName, clusterName, arcSettingName, this.innerModel(), context).getValue();
        return this;
    }
    ...
    public ArcSetting apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getArcSettings()
            .updateWithResponse(resourceGroupName, clusterName, arcSettingName, updateArcSetting, context).getValue();
        return this;
    }
    ...
    public ArcSetting refresh() {
        this.innerObject = serviceManager.serviceClient().getArcSettings()
            .getWithResponse(resourceGroupName, clusterName, arcSettingName, Context.NONE).getValue();
        return this;
    }

    public ArcSetting refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getArcSettings()
            .getWithResponse(resourceGroupName, clusterName, arcSettingName, context).getValue();
        return this;
    }

    public Response<PasswordCredential> generatePasswordWithResponse(Context context) {
        return serviceManager.arcSettings().generatePasswordWithResponse(resourceGroupName, clusterName, arcSettingName,
            context);
    }
    ...
    public Response<ArcSetting> consentAndInstallDefaultExtensionsWithResponse(Context context) {
        return serviceManager.arcSettings().consentAndInstallDefaultExtensionsWithResponse(resourceGroupName,
            clusterName, arcSettingName, context);
    }

    public ArcSetting consentAndInstallDefaultExtensions() {
        return serviceManager.arcSettings().consentAndInstallDefaultExtensions(resourceGroupName, clusterName,
            arcSettingName);
    }
