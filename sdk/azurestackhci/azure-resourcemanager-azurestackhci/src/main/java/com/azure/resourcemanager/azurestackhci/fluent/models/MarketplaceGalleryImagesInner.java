        ...
        if (location() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property location in model MarketplaceGalleryImagesInner"));
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(MarketplaceGalleryImagesInner.class);
