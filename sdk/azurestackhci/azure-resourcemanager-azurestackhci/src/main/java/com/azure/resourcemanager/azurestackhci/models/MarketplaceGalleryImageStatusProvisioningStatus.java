...
public final class MarketplaceGalleryImageStatusProvisioningStatus {
     ...
     */
    public MarketplaceGalleryImageStatusProvisioningStatus withOperationId(String operationId) {
     ...
     * @return the MarketplaceGalleryImageStatusProvisioningStatus object itself.
     */
    public MarketplaceGalleryImageStatusProvisioningStatus withStatus(Status status) {
        this.status = status;
        return this;
    }
