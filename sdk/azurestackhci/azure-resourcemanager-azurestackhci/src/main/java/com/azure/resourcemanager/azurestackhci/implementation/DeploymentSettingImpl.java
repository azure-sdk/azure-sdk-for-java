...
public final class DeploymentSettingImpl
    ...
    public DeploymentSetting create() {
        this.innerObject = serviceManager.serviceClient().getDeploymentSettings().createOrUpdate(resourceGroupName,
            clusterName, deploymentSettingsName, this.innerModel(), Context.NONE);
        return this;
    }

    public DeploymentSetting create(Context context) {
        this.innerObject = serviceManager.serviceClient().getDeploymentSettings().createOrUpdate(resourceGroupName,
            clusterName, deploymentSettingsName, this.innerModel(), context);
        return this;
    }
    ...
    DeploymentSettingImpl(DeploymentSettingInner innerObject,
        ...
        this.deploymentSettingsName = Utils.getValueFromIdByName(innerObject.id(), "deploymentSettings");
    }

    public DeploymentSetting refresh() {
        this.innerObject = serviceManager.serviceClient().getDeploymentSettings()
            .getWithResponse(resourceGroupName, clusterName, deploymentSettingsName, Context.NONE).getValue();
        return this;
    }

    public DeploymentSetting refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getDeploymentSettings()
            .getWithResponse(resourceGroupName, clusterName, deploymentSettingsName, context).getValue();
        return this;
    }
