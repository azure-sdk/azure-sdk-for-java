...
public final class PublishersClientImpl implements PublishersClient {
    ...
    private interface PublishersService {
        ...
        Mono<Response<PublisherList>> listByCluster(
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<PublisherList>> listByClusterNext(
    ...
    private Mono<PagedResponse<PublisherInner>> listByClusterSinglePageAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<PublisherInner> listByClusterAsync(
        String resourceGroupName, String clusterName, Context context) {
        return new PagedFlux<>(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<PublisherInner> getWithResponse(
        String resourceGroupName, String clusterName, String publisherName, Context context) {
