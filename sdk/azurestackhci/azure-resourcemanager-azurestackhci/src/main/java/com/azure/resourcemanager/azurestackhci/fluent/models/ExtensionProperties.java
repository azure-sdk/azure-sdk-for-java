...
public final class ExtensionProperties {
    ...
    /**
     * Get the typeHandlerVersion property: Specifies the version of the script handler. Latest version would be used
     * if not specified.
     * 
    ...
    /**
     * Set the typeHandlerVersion property: Specifies the version of the script handler. Latest version would be used
     * if not specified.
     * 
    ...
    public Boolean autoUpgradeMinorVersion() {
        return this.innerExtensionParameters() == null ? null
