...
public final class UpdateRunImpl implements UpdateRun, UpdateRun.Definition, UpdateRun.Update {
    ...
    public UpdateRun refresh() {
        this.innerObject = serviceManager.serviceClient().getUpdateRuns()
            .getWithResponse(resourceGroupName, clusterName, updateName, updateRunName, Context.NONE).getValue();
        return this;
    }

    public UpdateRun refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getUpdateRuns()
            .getWithResponse(resourceGroupName, clusterName, updateName, updateRunName, context).getValue();
        return this;
    }
