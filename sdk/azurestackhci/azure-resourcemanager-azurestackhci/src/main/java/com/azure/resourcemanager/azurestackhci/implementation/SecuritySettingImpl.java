...
public final class SecuritySettingImpl implements SecuritySetting, SecuritySetting.Definition, SecuritySetting.Update {
    ...
    public SecuritySetting create() {
        this.innerObject = serviceManager.serviceClient().getSecuritySettings().createOrUpdate(resourceGroupName,
            clusterName, securitySettingsName, this.innerModel(), Context.NONE);
        return this;
    }

    public SecuritySetting create(Context context) {
        this.innerObject = serviceManager.serviceClient().getSecuritySettings().createOrUpdate(resourceGroupName,
            clusterName, securitySettingsName, this.innerModel(), context);
        return this;
    }
    ...
    SecuritySettingImpl(SecuritySettingInner innerObject,
        ...
        this.securitySettingsName = Utils.getValueFromIdByName(innerObject.id(), "securitySettings");
    }

    public SecuritySetting refresh() {
        this.innerObject = serviceManager.serviceClient().getSecuritySettings()
            .getWithResponse(resourceGroupName, clusterName, securitySettingsName, Context.NONE).getValue();
        return this;
    }

    public SecuritySetting refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getSecuritySettings()
            .getWithResponse(resourceGroupName, clusterName, securitySettingsName, context).getValue();
        return this;
    }
