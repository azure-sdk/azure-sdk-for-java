...
public final class EdgeDevicesClientImpl implements EdgeDevicesClient {
    ...
    private Mono<Response<EdgeDeviceInner>> getWithResponseAsync(String resourceUri, String edgeDeviceName) {
        ...
        return FluxUtil.withContext(
            context -> service.get(this.client.getEndpoint(), apiVersion, resourceUri, edgeDeviceName, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<EdgeDeviceInner>> getWithResponseAsync(String resourceUri, String edgeDeviceName,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.get(this.client.getEndpoint(), apiVersion, resourceUri, edgeDeviceName, accept, context);
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String resourceUri, String edgeDeviceName,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.createOrUpdate(this.client.getEndpoint(), apiVersion, resourceUri, edgeDeviceName, resource,
            accept, context);
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> deleteWithResponseAsync(String resourceUri, String edgeDeviceName) {
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.delete(this.client.getEndpoint(), apiVersion, resourceUri, edgeDeviceName,
                accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> deleteWithResponseAsync(String resourceUri, String edgeDeviceName,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.delete(this.client.getEndpoint(), apiVersion, resourceUri, edgeDeviceName, accept, context);
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> validateWithResponseAsync(String resourceUri, String edgeDeviceName,
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.validate(this.client.getEndpoint(), apiVersion, resourceUri, edgeDeviceName,
    ...
    private Mono<Response<Flux<ByteBuffer>>> validateWithResponseAsync(String resourceUri, String edgeDeviceName,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.validate(this.client.getEndpoint(), apiVersion, resourceUri, edgeDeviceName, validateRequest,
            accept, context);
    }
