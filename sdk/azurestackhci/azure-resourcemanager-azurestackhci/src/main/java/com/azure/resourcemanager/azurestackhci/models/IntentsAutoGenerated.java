 ...
 */
@Immutable
public final class IntentsAutoGenerated implements JsonSerializable<IntentsAutoGenerated> {
    /*
    ...
    /**
     * Reads an instance of IntentsAutoGenerated from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of IntentsAutoGenerated if the JsonReader was pointing to an instance of it, or null if it
     * was pointing to JSON null.
     * @throws IOException If an error occurs while reading the IntentsAutoGenerated.
     */
    public static IntentsAutoGenerated fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            IntentsAutoGenerated deserializedIntentsAutoGenerated = new IntentsAutoGenerated();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("scope".equals(fieldName)) {
                    deserializedIntentsAutoGenerated.scope = reader.getNullable(JsonReader::getLong);
                } else if ("intentType".equals(fieldName)) {
                    deserializedIntentsAutoGenerated.intentType = reader.getNullable(JsonReader::getLong);
                } else if ("isComputeIntentSet".equals(fieldName)) {
                    deserializedIntentsAutoGenerated.isComputeIntentSet = reader.getNullable(JsonReader::getBoolean);
                } else if ("isStorageIntentSet".equals(fieldName)) {
                    deserializedIntentsAutoGenerated.isStorageIntentSet = reader.getNullable(JsonReader::getBoolean);
                } else if ("isOnlyStorage".equals(fieldName)) {
                    deserializedIntentsAutoGenerated.isOnlyStorage = reader.getNullable(JsonReader::getBoolean);
                } else if ("isManagementIntentSet".equals(fieldName)) {
                    deserializedIntentsAutoGenerated.isManagementIntentSet = reader.getNullable(JsonReader::getBoolean);
                } else if ("isStretchIntentSet".equals(fieldName)) {
                    deserializedIntentsAutoGenerated.isStretchIntentSet = reader.getNullable(JsonReader::getBoolean);
                } else if ("isOnlyStretch".equals(fieldName)) {
                    deserializedIntentsAutoGenerated.isOnlyStretch = reader.getNullable(JsonReader::getBoolean);
                } else if ("isNetworkIntentType".equals(fieldName)) {
                    deserializedIntentsAutoGenerated.isNetworkIntentType = reader.getNullable(JsonReader::getBoolean);
                } else if ("intentName".equals(fieldName)) {
                    deserializedIntentsAutoGenerated.intentName = reader.getString();
                } else if ("intentAdapters".equals(fieldName)) {
                    List<String> intentAdapters = reader.readArray(reader1 -> reader1.getString());
                    deserializedIntentsAutoGenerated.intentAdapters = intentAdapters;
                } else if ("overrideVirtualSwitchConfiguration".equals(fieldName)) {
                    deserializedIntentsAutoGenerated.overrideVirtualSwitchConfiguration
                        = reader.getNullable(JsonReader::getBoolean);
                } else if ("virtualSwitchConfigurationOverrides".equals(fieldName)) {
                    deserializedIntentsAutoGenerated.virtualSwitchConfigurationOverrides
                        = VirtualSwitchConfigurationOverridesAutoGenerated.fromJson(reader);
                } else if ("overrideQosPolicy".equals(fieldName)) {
                    deserializedIntentsAutoGenerated.overrideQosPolicy = reader.getNullable(JsonReader::getBoolean);
                } else if ("qosPolicyOverrides".equals(fieldName)) {
                    deserializedIntentsAutoGenerated.qosPolicyOverrides = QosPolicyOverrides.fromJson(reader);
                } else if ("overrideAdapterProperty".equals(fieldName)) {
                    deserializedIntentsAutoGenerated.overrideAdapterProperty
                        = reader.getNullable(JsonReader::getBoolean);
                } else if ("adapterPropertyOverrides".equals(fieldName)) {
                    deserializedIntentsAutoGenerated.adapterPropertyOverrides
                        = AdapterPropertyOverridesAutoGenerated.fromJson(reader);
                } else {
                    reader.skipChildren();
                }
            }

            return deserializedIntentsAutoGenerated;
        });
    }
}
