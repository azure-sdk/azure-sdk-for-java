...
public final class EdgeDeviceImpl implements EdgeDevice, EdgeDevice.Definition, EdgeDevice.Update {
    ...
    public EdgeDevice create() {
        this.innerObject = serviceManager.serviceClient().getEdgeDevices().createOrUpdate(resourceUri, edgeDeviceName,
    ...
    EdgeDeviceImpl(EdgeDeviceInner innerObject,
        ...
        this.edgeDeviceName = Utils.getValueFromIdByParameterName(innerObject.id(),
            "/{resourceUri}/providers/Microsoft.AzureStackHCI/edgeDevices/{edgeDeviceName}", "edgeDeviceName");
    }

    public EdgeDevice refresh() {
        this.innerObject = serviceManager.serviceClient().getEdgeDevices()
            .getWithResponse(resourceUri, edgeDeviceName, Context.NONE).getValue();
        return this;
    }

    public EdgeDevice refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getEdgeDevices()
            .getWithResponse(resourceUri, edgeDeviceName, context).getValue();
        return this;
    }
