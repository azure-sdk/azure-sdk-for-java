...
public final class ClusterImpl implements Cluster, Cluster.Definition, Cluster.Update {
    ...
    public Cluster create() {
        this.innerObject = serviceManager.serviceClient().getClusters()
            .createWithResponse(resourceGroupName, clusterName, this.innerModel(), Context.NONE).getValue();
        return this;
    }

    public Cluster create(Context context) {
        this.innerObject = serviceManager.serviceClient().getClusters()
            .createWithResponse(resourceGroupName, clusterName, this.innerModel(), context).getValue();
        return this;
    }
    ...
    public Cluster apply() {
        this.innerObject = serviceManager.serviceClient().getClusters()
            .updateWithResponse(resourceGroupName, clusterName, updateCluster, Context.NONE).getValue();
        return this;
    }

    public Cluster apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getClusters()
            .updateWithResponse(resourceGroupName, clusterName, updateCluster, context).getValue();
        return this;
    }
    ...
    public Cluster extendSoftwareAssuranceBenefit(SoftwareAssuranceChangeRequest softwareAssuranceChangeRequest) {
        return serviceManager.clusters().extendSoftwareAssuranceBenefit(resourceGroupName, clusterName,
