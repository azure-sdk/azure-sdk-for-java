...
public final class HciUpdateImpl implements HciUpdate, HciUpdate.Definition, HciUpdate.Update {
    ...
    public HciUpdate create() {
        this.innerObject = serviceManager.serviceClient().getUpdates()
            .putWithResponse(resourceGroupName, clusterName, updateName, this.innerModel(), Context.NONE).getValue();
        return this;
    }

    public HciUpdate create(Context context) {
        this.innerObject = serviceManager.serviceClient().getUpdates()
            .putWithResponse(resourceGroupName, clusterName, updateName, this.innerModel(), context).getValue();
        return this;
    }
    ...
    public HciUpdate refresh() {
        this.innerObject = serviceManager.serviceClient().getUpdates()
            .getWithResponse(resourceGroupName, clusterName, updateName, Context.NONE).getValue();
        return this;
    }

    public HciUpdate refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getUpdates()
            .getWithResponse(resourceGroupName, clusterName, updateName, context).getValue();
        return this;
    }
