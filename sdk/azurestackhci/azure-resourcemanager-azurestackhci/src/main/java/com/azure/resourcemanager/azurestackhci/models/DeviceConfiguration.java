...
public final class DeviceConfiguration {
     ...
     */
    @JsonProperty(value = "nicDetails", required = true)
    ...
    public void validate() {
        if (nicDetails() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Missing required property nicDetails in model DeviceConfiguration"));
        } else {
            nicDetails().forEach(e -> e.validate());
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(DeviceConfiguration.class);
}
