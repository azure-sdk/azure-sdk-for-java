...
public interface Update {
    ...
    interface DefinitionStages {
        ...
        interface WithCreate
            extends DefinitionStages.WithLocation,
                DefinitionStages.WithInstalledDate,
                DefinitionStages.WithDescription,
                DefinitionStages.WithState,
                DefinitionStages.WithPrerequisites,
                DefinitionStages.WithComponentVersions,
                DefinitionStages.WithRebootRequired,
                DefinitionStages.WithHealthState,
                DefinitionStages.WithHealthCheckResult,
                DefinitionStages.WithHealthCheckDate,
                DefinitionStages.WithPackagePath,
                DefinitionStages.WithPackageSizeInMb,
                DefinitionStages.WithDisplayName,
                DefinitionStages.WithVersion,
                DefinitionStages.WithPublisher,
                DefinitionStages.WithReleaseLink,
                DefinitionStages.WithAvailabilityType,
                DefinitionStages.WithPackageType,
                DefinitionStages.WithAdditionalProperties,
                DefinitionStages.WithProgressPercentage,
                DefinitionStages.WithNotifyMessage {
            /**
        ...
        /** The stage of the Update definition allowing to specify location. */
        ...
        /** The stage of the Update definition allowing to specify installedDate. */
        ...
        /** The stage of the Update definition allowing to specify description. */
        ...
        /** The stage of the Update definition allowing to specify state. */
        interface WithState {
            /**
        ...
        /** The stage of the Update definition allowing to specify prerequisites. */
        ...
        /** The stage of the Update definition allowing to specify componentVersions. */
        ...
        /** The stage of the Update definition allowing to specify rebootRequired. */
        ...
        /** The stage of the Update definition allowing to specify healthState. */
        ...
        /** The stage of the Update definition allowing to specify healthCheckResult. */
        ...
        /** The stage of the Update definition allowing to specify healthCheckDate. */
        ...
        /** The stage of the Update definition allowing to specify packagePath. */
        ...
        /** The stage of the Update definition allowing to specify packageSizeInMb. */
        ...
        /** The stage of the Update definition allowing to specify displayName. */
        ...
        /** The stage of the Update definition allowing to specify version. */
        ...
        /** The stage of the Update definition allowing to specify publisher. */
        ...
        /** The stage of the Update definition allowing to specify releaseLink. */
        ...
        /** The stage of the Update definition allowing to specify availabilityType. */
        ...
        /** The stage of the Update definition allowing to specify packageType. */
        ...
        /** The stage of the Update definition allowing to specify additionalProperties. */
        interface WithAdditionalProperties {
             ...
             *     the stamp OEM family and hardware model information when an update is flagged as Invalid for the
             *     stamp based on OEM type.
             * @return the next definition stage.
             */
            WithCreate withAdditionalProperties(String additionalProperties);
        }
        /** The stage of the Update definition allowing to specify progressPercentage. */
        ...
        /** The stage of the Update definition allowing to specify notifyMessage. */
    ...
    interface Update
        extends UpdateStages.WithInstalledDate,
            UpdateStages.WithDescription,
            UpdateStages.WithState,
            UpdateStages.WithPrerequisites,
            UpdateStages.WithComponentVersions,
            UpdateStages.WithRebootRequired,
            UpdateStages.WithHealthState,
            UpdateStages.WithHealthCheckResult,
            UpdateStages.WithHealthCheckDate,
            UpdateStages.WithPackagePath,
            UpdateStages.WithPackageSizeInMb,
            UpdateStages.WithDisplayName,
            UpdateStages.WithVersion,
            UpdateStages.WithPublisher,
            UpdateStages.WithReleaseLink,
            UpdateStages.WithAvailabilityType,
            UpdateStages.WithPackageType,
            UpdateStages.WithAdditionalProperties,
            UpdateStages.WithProgressPercentage,
            UpdateStages.WithNotifyMessage {
        /**
    ...
    interface UpdateStages {
        /** The stage of the Update update allowing to specify installedDate. */
        interface WithInstalledDate {
            /**
             * Specifies the installedDate property: Date that the update was installed..
             *
        ...
        /** The stage of the Update update allowing to specify description. */
        interface WithDescription {
            /**
             * Specifies the description property: Description of the update..
             *
        ...
        /** The stage of the Update update allowing to specify state. */
        interface WithState {
            /**
             * Specifies the state property: State of the update as it relates to this stamp..
             *
        ...
        /** The stage of the Update update allowing to specify prerequisites. */
        interface WithPrerequisites {
            /**
             * Specifies the prerequisites property: If update State is HasPrerequisite, this property contains an array
             * of objects describing prerequisite updates before installing this update. Otherwise, it is empty..
        ...
        /** The stage of the Update update allowing to specify componentVersions. */
        interface WithComponentVersions {
            /**
             * Specifies the componentVersions property: An array of component versions for a Solution Bundle update,
             * and an empty array otherwise. .
        ...
        /** The stage of the Update update allowing to specify rebootRequired. */
        interface WithRebootRequired {
            /**
             * Specifies the rebootRequired property: The rebootRequired property..
             *
        ...
        /** The stage of the Update update allowing to specify healthState. */
        interface WithHealthState {
            /**
             * Specifies the healthState property: Overall health state for update-specific health checks..
             *
        ...
        /** The stage of the Update update allowing to specify healthCheckResult. */
        interface WithHealthCheckResult {
            /**
             * Specifies the healthCheckResult property: An array of PrecheckResult objects..
             *
        ...
        /** The stage of the Update update allowing to specify healthCheckDate. */
        interface WithHealthCheckDate {
            /**
             * Specifies the healthCheckDate property: Last time the package-specific checks were run..
             *
        ...
        /** The stage of the Update update allowing to specify packagePath. */
        interface WithPackagePath {
            /**
             * Specifies the packagePath property: Path where the update package is available..
             *
        ...
        /** The stage of the Update update allowing to specify packageSizeInMb. */
        interface WithPackageSizeInMb {
            /**
             * Specifies the packageSizeInMb property: Size of the package. This value is a combination of the size from
             * update metadata and size of the payload that results from the live scan operation for OS update content..
        ...
        /** The stage of the Update update allowing to specify displayName. */
        interface WithDisplayName {
            /**
             * Specifies the displayName property: Display name of the Update.
             *
        ...
        /** The stage of the Update update allowing to specify version. */
        interface WithVersion {
            /**
             * Specifies the version property: Version of the update..
             *
        ...
        /** The stage of the Update update allowing to specify publisher. */
        interface WithPublisher {
            /**
             * Specifies the publisher property: Publisher of the update package..
             *
        ...
        /** The stage of the Update update allowing to specify releaseLink. */
        interface WithReleaseLink {
            /**
             * Specifies the releaseLink property: Link to release notes for the update..
             *
        ...
        /** The stage of the Update update allowing to specify availabilityType. */
        interface WithAvailabilityType {
            /**
             * Specifies the availabilityType property: Indicates the way the update content can be downloaded..
             *
        ...
        /** The stage of the Update update allowing to specify packageType. */
        interface WithPackageType {
            /**
             * Specifies the packageType property: Customer-visible type of the update..
             *
        ...
        /** The stage of the Update update allowing to specify additionalProperties. */
        interface WithAdditionalProperties {
            /**
             * Specifies the additionalProperties property: Extensible KV pairs serialized as a string. This is
             * currently used to report the stamp OEM family and hardware model information when an update is flagged as
        ...
        /** The stage of the Update update allowing to specify progressPercentage. */
        interface WithProgressPercentage {
            /**
             * Specifies the progressPercentage property: Progress percentage of ongoing operation. Currently this
             * property is only valid when the update is in the Downloading state, where it maps to how much of the
        ...
        /** The stage of the Update update allowing to specify notifyMessage. */
        interface WithNotifyMessage {
            /**
             * Specifies the notifyMessage property: Brief message with instructions for updates of AvailabilityType
             * Notify..
