...
public interface UpdatesClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<Void>, Void> beginPost(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<UpdateInner> putWithResponse(
        String resourceGroupName, String clusterName, String updateName, UpdateInner updateProperties, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<UpdateInner> getWithResponse(
        String resourceGroupName, String clusterName, String updateName, Context context);
