...
public final class Intents {
     ...
     * validation.
     */
    @JsonProperty(value = "overrideVirtualSwitchConfiguration")
    private Boolean overrideVirtualSwitchConfiguration;

    /*
     * Set virtualSwitch ConfigurationOverrides for cluster.
     */
    @JsonProperty(value = "virtualSwitchConfigurationOverrides")
     ...
     * validation.
     */
    @JsonProperty(value = "overrideQosPolicy")
    private Boolean overrideQosPolicy;

    /*
     * Set QoS PolicyOverrides for cluster.
     */
    @JsonProperty(value = "qosPolicyOverrides")
     ...
     * validation.
     */
    @JsonProperty(value = "overrideAdapterProperty")
    private Boolean overrideAdapterProperty;

    /*
     * Set Adapter PropertyOverrides for cluster.
     */
    @JsonProperty(value = "adapterPropertyOverrides")
    private AdapterPropertyOverrides adapterPropertyOverrides;

    /**
     * Creates an instance of Intents class.
     */
    public Intents() {
    }
     ...
     * @return the Intents object itself.
     */
    public Intents withName(String name) {
        this.name = name;
        return this;
    }
     ...
     * @return the Intents object itself.
     */
    public Intents withTrafficType(List<String> trafficType) {
     ...
     * @return the Intents object itself.
     */
    public Intents withAdapter(List<String> adapter) {
     ...
     * @return the Intents object itself.
     */
    public Intents withOverrideVirtualSwitchConfiguration(Boolean overrideVirtualSwitchConfiguration) {
     ...
     */
    public VirtualSwitchConfigurationOverrides virtualSwitchConfigurationOverrides() {
     ...
     * @return the Intents object itself.
     */
    public Intents withVirtualSwitchConfigurationOverrides(
     ...
     * @return the Intents object itself.
     */
    public Intents withOverrideQosPolicy(Boolean overrideQosPolicy) {
     ...
     * @return the Intents object itself.
     */
    public Intents withQosPolicyOverrides(QosPolicyOverrides qosPolicyOverrides) {
     ...
     * @return the Intents object itself.
     */
    public Intents withOverrideAdapterProperty(Boolean overrideAdapterProperty) {
     ...
     */
    public AdapterPropertyOverrides adapterPropertyOverrides() {
     ...
     * @return the Intents object itself.
     */
    public Intents withAdapterPropertyOverrides(AdapterPropertyOverrides adapterPropertyOverrides) {
