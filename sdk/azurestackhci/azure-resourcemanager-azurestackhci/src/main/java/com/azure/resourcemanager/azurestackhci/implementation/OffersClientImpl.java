...
public final class OffersClientImpl implements OffersClient {
    ...
    public interface OffersService {
        ...
        Mono<Response<OfferList>> listByPublisher(
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<OfferList>> listByCluster(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("clusterName") String clusterName,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<OfferList>> listByPublisherNext(
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<OfferList>> listByClusterNext(
            @PathParam(value = "nextLink", encoded = true) String nextLink,
            @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept,
            Context context);
    ...
    private Mono<PagedResponse<OfferInner>> listByPublisherSinglePageAsync(
    ...
    private PagedFlux<OfferInner> listByPublisherAsync(
        String resourceGroupName, String clusterName, String publisherName, String expand) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<OfferInner> listByPublisher(
        String resourceGroupName, String clusterName, String publisherName) {
        final String expand = null;
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<OfferInner>> listByClusterSinglePageAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<OfferInner> listByClusterAsync(
        String resourceGroupName, String clusterName, String expand, Context context) {
        return new PagedFlux<>(
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<OfferInner> listByCluster(
        String resourceGroupName, String clusterName, String expand, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<OfferInner>> getWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<OfferInner> getAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<OfferInner> getWithResponse(
        String resourceGroupName,
        String clusterName,
        String publisherName,
        String offerName,
