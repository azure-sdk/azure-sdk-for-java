...
public final class UpdateRunsClientImpl implements UpdateRunsClient {
    ...
    public interface UpdateRunsService {
        ...
        @Get(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AzureStackHCI"
                + "/clusters/{clusterName}/updates/{updateName}/updateRuns")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<UpdateRunList>> list(
        ...
        @Delete(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AzureStackHCI"
                + "/clusters/{clusterName}/updates/{updateName}/updateRuns/{updateRunName}")
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<UpdateRunInner>> put(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("clusterName") String clusterName,
            ...
            @PathParam("updateRunName") String updateRunName,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") UpdateRunInner updateRunsProperties,
            @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<UpdateRunList>> listNext(
    ...
    private Mono<PagedResponse<UpdateRunInner>> listSinglePageAsync(
    ...
    private PagedFlux<UpdateRunInner> listAsync(String resourceGroupName, String clusterName, String updateName) {
        return new PagedFlux<>(
            () -> listSinglePageAsync(resourceGroupName, clusterName, updateName),
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<UpdateRunInner> listAsync(
        String resourceGroupName, String clusterName, String updateName, Context context) {
        return new PagedFlux<>(
            () -> listSinglePageAsync(resourceGroupName, clusterName, updateName, context),
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<UpdateRunInner> list(
        String resourceGroupName, String clusterName, String updateName, Context context) {
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(
        String resourceGroupName, String clusterName, String updateName, String updateRunName) {
        return beginDeleteAsync(resourceGroupName, clusterName, updateName, updateRunName).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(
        String resourceGroupName, String clusterName, String updateName, String updateRunName, Context context) {
        return beginDeleteAsync(resourceGroupName, clusterName, updateName, updateRunName, context).getSyncPoller();
    }
    ...
    private Mono<Void> deleteAsync(
        String resourceGroupName, String clusterName, String updateName, String updateRunName) {
        return beginDeleteAsync(resourceGroupName, clusterName, updateName, updateRunName)
            .last()
    ...
    private Mono<Void> deleteAsync(
        String resourceGroupName, String clusterName, String updateName, String updateRunName, Context context) {
        return beginDeleteAsync(resourceGroupName, clusterName, updateName, updateRunName, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<UpdateRunInner>> putWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<UpdateRunInner> putAsync(
        String resourceGroupName,
        String clusterName,
        String updateName,
        String updateRunName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<UpdateRunInner> putWithResponse(
        String resourceGroupName,
        String clusterName,
        String updateName,
        String updateRunName,
        ...
        return putWithResponseAsync(
                resourceGroupName, clusterName, updateName, updateRunName, updateRunsProperties, context)
            .block();
    }
    ...
    public UpdateRunInner put(
        ...
        return putWithResponse(
                resourceGroupName, clusterName, updateName, updateRunName, updateRunsProperties, Context.NONE)
            .getValue();
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the Update run for a specified update along with {@link Response} on successful completion of {@link
     *     Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<UpdateRunInner> getAsync(
        String resourceGroupName, String clusterName, String updateName, String updateRunName) {
