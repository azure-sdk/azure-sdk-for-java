...
public final class VirtualNetworksOperationsImpl implements VirtualNetworksOperations {
    ...
    public VirtualNetworks getByResourceGroup(String resourceGroupName, String virtualNetworkName) {
        VirtualNetworksInner inner = this.serviceClient().getByResourceGroup(resourceGroupName, virtualNetworkName);
        if (inner != null) {
