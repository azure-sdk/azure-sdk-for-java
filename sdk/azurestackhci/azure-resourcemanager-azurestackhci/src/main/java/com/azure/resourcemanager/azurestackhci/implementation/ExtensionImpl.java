...
public final class ExtensionImpl implements Extension, Extension.Definition, Extension.Update {
    ...
    public Extension create() {
        this.innerObject = serviceManager.serviceClient().getExtensions().create(resourceGroupName, clusterName,
            arcSettingName, extensionName, this.innerModel(), Context.NONE);
        return this;
    }

    public Extension create(Context context) {
        this.innerObject = serviceManager.serviceClient().getExtensions().create(resourceGroupName, clusterName,
            arcSettingName, extensionName, this.innerModel(), context);
        return this;
    }
    ...
    public Extension apply() {
        this.innerObject = serviceManager.serviceClient().getExtensions().update(resourceGroupName, clusterName,
            arcSettingName, extensionName, updateExtension, Context.NONE);
        return this;
    }

    public Extension apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getExtensions().update(resourceGroupName, clusterName,
            arcSettingName, extensionName, updateExtension, context);
        return this;
    }
    ...
    public Extension refresh() {
        this.innerObject = serviceManager.serviceClient().getExtensions()
            .getWithResponse(resourceGroupName, clusterName, arcSettingName, extensionName, Context.NONE).getValue();
        return this;
    }

    public Extension refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getExtensions()
            .getWithResponse(resourceGroupName, clusterName, arcSettingName, extensionName, context).getValue();
        return this;
    }

    public void upgrade(ExtensionUpgradeParameters extensionUpgradeParameters) {
        serviceManager.extensions().upgrade(resourceGroupName, clusterName, arcSettingName, extensionName,
