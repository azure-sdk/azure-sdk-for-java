...
public final class SandboxCustomImageImpl
    ...
    public SandboxCustomImage create() {
        this.innerObject = serviceManager.serviceClient().getSandboxCustomImages().createOrUpdate(resourceGroupName,
            clusterName, sandboxCustomImageName, this.innerModel(), Context.NONE);
        return this;
    }

    public SandboxCustomImage create(Context context) {
        this.innerObject = serviceManager.serviceClient().getSandboxCustomImages().createOrUpdate(resourceGroupName,
            clusterName, sandboxCustomImageName, this.innerModel(), context);
        return this;
    }
    ...
    public SandboxCustomImage apply() {
        this.innerObject = serviceManager.serviceClient().getSandboxCustomImages().update(resourceGroupName,
            clusterName, sandboxCustomImageName, this.innerModel(), Context.NONE);
        return this;
    }
    ...
    public SandboxCustomImage refresh() {
        this.innerObject = serviceManager.serviceClient().getSandboxCustomImages()
            .getWithResponse(resourceGroupName, clusterName, sandboxCustomImageName, Context.NONE).getValue();
        return this;
    }

    public SandboxCustomImage refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getSandboxCustomImages()
            .getWithResponse(resourceGroupName, clusterName, sandboxCustomImageName, context).getValue();
        return this;
    }
