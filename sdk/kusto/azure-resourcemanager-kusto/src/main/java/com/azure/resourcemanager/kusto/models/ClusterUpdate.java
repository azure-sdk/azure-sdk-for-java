        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("id".equals(fieldName)) {
                    deserializedClusterUpdate.id = reader.getString();
                } else if ("name".equals(fieldName)) {
                    deserializedClusterUpdate.name = reader.getString();
                } else if ("type".equals(fieldName)) {
                    deserializedClusterUpdate.type = reader.getString();
                } else if ("tags".equals(fieldName)) {
                    Map<String, String> tags = reader.readMap(reader1 -> reader1.getString());
                    deserializedClusterUpdate.tags = tags;
                } else if ("location".equals(fieldName)) {
                    deserializedClusterUpdate.location = reader.getString();
                } else if ("sku".equals(fieldName)) {
                    deserializedClusterUpdate.sku = AzureSku.fromJson(reader);
                } else if ("zones".equals(fieldName)) {
                    List<String> zones = reader.readArray(reader1 -> reader1.getString());
                    deserializedClusterUpdate.zones = zones;
                } else if ("identity".equals(fieldName)) {
                    deserializedClusterUpdate.identity = Identity.fromJson(reader);
