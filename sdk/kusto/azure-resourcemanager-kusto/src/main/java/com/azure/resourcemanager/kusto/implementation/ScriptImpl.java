...
public final class ScriptImpl implements Script, Script.Definition, Script.Update {
    ...
    public Script create() {
        this.innerObject = serviceManager.serviceClient().getScripts().createOrUpdate(resourceGroupName, clusterName,
            databaseName, scriptName, this.innerModel(), Context.NONE);
        return this;
    }

    public Script create(Context context) {
        this.innerObject = serviceManager.serviceClient().getScripts().createOrUpdate(resourceGroupName, clusterName,
            databaseName, scriptName, this.innerModel(), context);
        return this;
    }
    ...
    public Script apply() {
        this.innerObject = serviceManager.serviceClient().getScripts().update(resourceGroupName, clusterName,
            databaseName, scriptName, this.innerModel(), Context.NONE);
        return this;
    }
    ...
    public Script refresh() {
        this.innerObject = serviceManager.serviceClient().getScripts()
            .getWithResponse(resourceGroupName, clusterName, databaseName, scriptName, Context.NONE).getValue();
        return this;
    }

    public Script refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getScripts()
            .getWithResponse(resourceGroupName, clusterName, databaseName, scriptName, context).getValue();
        return this;
    }
