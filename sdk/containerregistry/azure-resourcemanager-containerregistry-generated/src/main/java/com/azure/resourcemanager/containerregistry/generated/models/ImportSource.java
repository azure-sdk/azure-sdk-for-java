...
public final class ImportSource {
     ...
     */
    @JsonProperty(value = "cacheRuleResourceId")
    private String cacheRuleResourceId;
    ...
    /**
     * Get the cacheRuleResourceId property: The resource identifier of the source Cache Rule.
     * 
     * @return the cacheRuleResourceId value.
     */
    public String cacheRuleResourceId() {
        return this.cacheRuleResourceId;
    }

    /**
     * Set the cacheRuleResourceId property: The resource identifier of the source Cache Rule.
     * 
     * @param cacheRuleResourceId the cacheRuleResourceId value to set.
     * @return the ImportSource object itself.
     */
    public ImportSource withCacheRuleResourceId(String cacheRuleResourceId) {
        this.cacheRuleResourceId = cacheRuleResourceId;
        return this;
    }
