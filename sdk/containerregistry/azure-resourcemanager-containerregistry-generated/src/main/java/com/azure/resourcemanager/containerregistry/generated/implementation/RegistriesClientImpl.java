...
import com.azure.resourcemanager.containerregistry.generated.models.PrivateLinkResourceListResult;
import com.azure.resourcemanager.containerregistry.generated.models.RegenerateCredentialParameters;
import com.azure.resourcemanager.containerregistry.generated.models.RegistryListResult;
...
public final class RegistriesClientImpl implements RegistriesClient {
    ...
    public interface RegistriesService {
        ...
        @Headers({ "Content-Type: application/json" })
        @Post("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerRegistry/registries/{registryName}/checkCacheRuleArtifactSyncEstimate")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<CacheRuleArtifactSyncEstimateResultInner>> checkCacheRuleArtifactSyncEstimate(
    ...
    /**
     * Checks the contents of an upstream repository and executes the query of a cache rule's artifact sync scope
     * filter.
     * 
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
     * @param registryName The name of the container registry.
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the result of a request to check the cache rule artifact sync estimate along with {@link Response} on
     * successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<CacheRuleArtifactSyncEstimateResultInner>>
        checkCacheRuleArtifactSyncEstimateWithResponseAsync(String resourceGroupName, String registryName,
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.checkCacheRuleArtifactSyncEstimate(this.client.getEndpoint(), apiVersion,
                this.client.getSubscriptionId(), resourceGroupName, registryName, cacheRuleCreateParameters, accept,
                context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<CacheRuleArtifactSyncEstimateResultInner>>
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.checkCacheRuleArtifactSyncEstimate(this.client.getEndpoint(), apiVersion,
            this.client.getSubscriptionId(), resourceGroupName, registryName, cacheRuleCreateParameters, accept,
            context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the result of a request to check the cache rule artifact sync estimate on successful completion of
     * {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<CacheRuleArtifactSyncEstimateResultInner> checkCacheRuleArtifactSyncEstimateAsync(
        String resourceGroupName, String registryName, CacheRuleInner cacheRuleCreateParameters) {
        return checkCacheRuleArtifactSyncEstimateWithResponseAsync(resourceGroupName, registryName,
            cacheRuleCreateParameters).flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the result of a request to check the cache rule artifact sync estimate along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<CacheRuleArtifactSyncEstimateResultInner> checkCacheRuleArtifactSyncEstimateWithResponse(
        String resourceGroupName, String registryName, CacheRuleInner cacheRuleCreateParameters, Context context) {
        return checkCacheRuleArtifactSyncEstimateWithResponseAsync(resourceGroupName, registryName,
            cacheRuleCreateParameters, context).block();
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the result of a request to check the cache rule artifact sync estimate.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public CacheRuleArtifactSyncEstimateResultInner checkCacheRuleArtifactSyncEstimate(String resourceGroupName,
        String registryName, CacheRuleInner cacheRuleCreateParameters) {
        return checkCacheRuleArtifactSyncEstimateWithResponse(resourceGroupName, registryName,
            cacheRuleCreateParameters, Context.NONE).getValue();
    }
