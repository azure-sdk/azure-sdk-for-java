...
public final class TaskRunImpl implements TaskRun, TaskRun.Definition, TaskRun.Update {
    ...
    public TaskRun create() {
        this.innerObject = serviceManager.serviceClient().getTaskRuns().create(resourceGroupName, registryName,
            taskRunName, this.innerModel(), Context.NONE);
        return this;
    }

    public TaskRun create(Context context) {
        this.innerObject = serviceManager.serviceClient().getTaskRuns().create(resourceGroupName, registryName,
            taskRunName, this.innerModel(), context);
        return this;
    }
    ...
    public TaskRun apply() {
        this.innerObject = serviceManager.serviceClient().getTaskRuns().update(resourceGroupName, registryName,
            taskRunName, updateUpdateParameters, Context.NONE);
        return this;
    }

    public TaskRun apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getTaskRuns().update(resourceGroupName, registryName,
            taskRunName, updateUpdateParameters, context);
        return this;
    }
    ...
    public TaskRun refresh() {
        this.innerObject = serviceManager.serviceClient().getTaskRuns()
            .getWithResponse(resourceGroupName, registryName, taskRunName, Context.NONE).getValue();
        return this;
    }

    public TaskRun refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getTaskRuns()
            .getWithResponse(resourceGroupName, registryName, taskRunName, context).getValue();
        return this;
    }
