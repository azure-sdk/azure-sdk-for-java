...
public final class CacheRulesImpl implements CacheRules {
    ...
    public PagedIterable<CacheRule> listAsync(String resourceGroupName, String registryName) {
        PagedIterable<CacheRuleInner> inner = this.serviceClient().listAsync(resourceGroupName, registryName);
        return Utils.mapPage(inner, inner1 -> new CacheRuleImpl(inner1, this.manager()));
    }

    public PagedIterable<CacheRule> listAsync(String resourceGroupName, String registryName, Context context) {
        PagedIterable<CacheRuleInner> inner = this.serviceClient().listAsync(resourceGroupName, registryName, context);
        return Utils.mapPage(inner, inner1 -> new CacheRuleImpl(inner1, this.manager()));
    }

    public Response<CacheRule> getAsyncWithResponse(
        String resourceGroupName, String registryName, String cacheRuleName, Context context) {
        Response<CacheRuleInner> inner =
            this.serviceClient().getAsyncWithResponse(resourceGroupName, registryName, cacheRuleName, context);
        if (inner != null) {
    ...
    public CacheRule getAsync(String resourceGroupName, String registryName, String cacheRuleName) {
        CacheRuleInner inner = this.serviceClient().getAsync(resourceGroupName, registryName, cacheRuleName);
        if (inner != null) {
    ...
    public CacheRule getAsyncById(String id) {
        ...
        return this.getAsyncWithResponse(resourceGroupName, registryName, cacheRuleName, Context.NONE).getValue();
    }

    public Response<CacheRule> getAsyncByIdWithResponse(String id, Context context) {
        String resourceGroupName = Utils.getValueFromIdByName(id, "resourceGroups");
        if (resourceGroupName == null) {
            throw LOGGER
                .logExceptionAsError(
        ...
        return this.getAsyncWithResponse(resourceGroupName, registryName, cacheRuleName, context);
    }
