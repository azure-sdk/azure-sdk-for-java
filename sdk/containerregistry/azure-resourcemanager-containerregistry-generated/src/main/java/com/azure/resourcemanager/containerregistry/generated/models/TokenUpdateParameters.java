...
public final class TokenUpdateParameters {
    ...
    /**
     * Get the credentials property: The properties of the credentials that can be used for authenticating the token.
     * 
    ...
    /**
     * Set the credentials property: The properties of the credentials that can be used for authenticating the token.
     * 
