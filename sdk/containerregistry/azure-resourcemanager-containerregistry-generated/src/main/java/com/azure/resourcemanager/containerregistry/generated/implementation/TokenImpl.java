...
public final class TokenImpl implements Token, Token.Definition, Token.Update {
    ...
    public Token create() {
        this.innerObject = serviceManager.serviceClient().getTokens().create(resourceGroupName, registryName, tokenName,
    ...
    public Token apply() {
        this.innerObject = serviceManager.serviceClient().getTokens().update(resourceGroupName, registryName, tokenName,
            updateTokenUpdateParameters, Context.NONE);
        return this;
    }

    public Token apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getTokens().update(resourceGroupName, registryName, tokenName,
            updateTokenUpdateParameters, context);
        return this;
    }
    ...
    public Token refresh() {
        this.innerObject = serviceManager.serviceClient().getTokens()
            .getWithResponse(resourceGroupName, registryName, tokenName, Context.NONE).getValue();
        return this;
    }

    public Token refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getTokens()
            .getWithResponse(resourceGroupName, registryName, tokenName, context).getValue();
        return this;
    }
