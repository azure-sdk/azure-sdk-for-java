...
public final class ExportPipelineImpl implements ExportPipeline, ExportPipeline.Definition {
    ...
    ExportPipelineImpl(ExportPipelineInner innerObject,
    ...
    public ExportPipeline create() {
        this.innerObject = serviceManager.serviceClient().getExportPipelines().create(resourceGroupName, registryName,
            exportPipelineName, this.innerModel(), Context.NONE);
        return this;
    }

    public ExportPipeline create(Context context) {
        this.innerObject = serviceManager.serviceClient().getExportPipelines().create(resourceGroupName, registryName,
            exportPipelineName, this.innerModel(), context);
        return this;
    }

    ExportPipelineImpl(String name,
        com.azure.resourcemanager.containerregistry.generated.ContainerRegistryManager serviceManager) {
    ...
    public ExportPipeline refresh() {
        this.innerObject = serviceManager.serviceClient().getExportPipelines()
            .getWithResponse(resourceGroupName, registryName, exportPipelineName, Context.NONE).getValue();
        return this;
    }

    public ExportPipeline refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getExportPipelines()
            .getWithResponse(resourceGroupName, registryName, exportPipelineName, context).getValue();
        return this;
    }
