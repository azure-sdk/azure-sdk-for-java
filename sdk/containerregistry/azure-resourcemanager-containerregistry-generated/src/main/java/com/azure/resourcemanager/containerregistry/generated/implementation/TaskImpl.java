...
public final class TaskImpl implements Task, Task.Definition, Task.Update {
    ...
    public Task create() {
        this.innerObject = serviceManager.serviceClient().getTasks().create(resourceGroupName, registryName, taskName,
    ...
    public Task apply() {
        this.innerObject = serviceManager.serviceClient().getTasks().update(resourceGroupName, registryName, taskName,
            updateTaskUpdateParameters, Context.NONE);
        return this;
    }

    public Task apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getTasks().update(resourceGroupName, registryName, taskName,
            updateTaskUpdateParameters, context);
        return this;
    }
    ...
    public Task refresh() {
        this.innerObject = serviceManager.serviceClient().getTasks()
            .getWithResponse(resourceGroupName, registryName, taskName, Context.NONE).getValue();
        return this;
    }

    public Task refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getTasks()
            .getWithResponse(resourceGroupName, registryName, taskName, context).getValue();
        return this;
    }
