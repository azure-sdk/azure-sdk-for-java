...
public final class ScopeMapImpl implements ScopeMap, ScopeMap.Definition, ScopeMap.Update {
    ...
    public ScopeMap create() {
        this.innerObject = serviceManager.serviceClient().getScopeMaps().create(resourceGroupName, registryName,
            scopeMapName, this.innerModel(), Context.NONE);
        return this;
    }

    public ScopeMap create(Context context) {
        this.innerObject = serviceManager.serviceClient().getScopeMaps().create(resourceGroupName, registryName,
            scopeMapName, this.innerModel(), context);
        return this;
    }
    ...
    public ScopeMap apply() {
        this.innerObject = serviceManager.serviceClient().getScopeMaps().update(resourceGroupName, registryName,
            scopeMapName, updateScopeMapUpdateParameters, Context.NONE);
        return this;
    }

    public ScopeMap apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getScopeMaps().update(resourceGroupName, registryName,
            scopeMapName, updateScopeMapUpdateParameters, context);
        return this;
    }
    ...
    public ScopeMap refresh() {
        this.innerObject = serviceManager.serviceClient().getScopeMaps()
            .getWithResponse(resourceGroupName, registryName, scopeMapName, Context.NONE).getValue();
        return this;
    }

    public ScopeMap refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getScopeMaps()
            .getWithResponse(resourceGroupName, registryName, scopeMapName, context).getValue();
        return this;
    }
