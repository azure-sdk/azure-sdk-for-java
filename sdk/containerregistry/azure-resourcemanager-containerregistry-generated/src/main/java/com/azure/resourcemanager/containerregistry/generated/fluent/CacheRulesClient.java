...
public interface CacheRulesClient {
    ...
    PagedIterable<CacheRuleInner> listAsync(String resourceGroupName, String registryName);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<CacheRuleInner> listAsync(String resourceGroupName, String registryName, Context context);
    ...
    Response<CacheRuleInner> getAsyncWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    CacheRuleInner getAsync(String resourceGroupName, String registryName, String cacheRuleName);
