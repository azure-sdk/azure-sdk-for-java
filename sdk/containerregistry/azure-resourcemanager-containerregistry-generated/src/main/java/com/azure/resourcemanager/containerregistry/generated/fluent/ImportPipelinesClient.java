...
public interface ImportPipelinesClient {
    ...
    Response<ImportPipelineInner> getWithResponse(String resourceGroupName, String registryName,
    ...
    SyncPoller<PollResult<ImportPipelineInner>, ImportPipelineInner> beginCreate(String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<Void> deleteWithResponse(String resourceGroupName, String registryName, String importPipelineName,
        Context context);
