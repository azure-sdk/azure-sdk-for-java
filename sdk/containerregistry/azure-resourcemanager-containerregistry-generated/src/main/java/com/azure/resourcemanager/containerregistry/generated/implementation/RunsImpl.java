...
public final class RunsImpl implements Runs {
    ...
    public RunsImpl(RunsClient innerClient,
    ...
    public PagedIterable<Run> list(String resourceGroupName, String registryName, String filter, Integer top,
        Context context) {
    ...
    public Response<RunGetLogResult> getLogSasUrlWithResponse(String resourceGroupName, String registryName,
