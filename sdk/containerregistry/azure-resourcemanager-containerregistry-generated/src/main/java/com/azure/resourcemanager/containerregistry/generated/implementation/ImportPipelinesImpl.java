...
public final class ImportPipelinesImpl implements ImportPipelines {
    ...
    public ImportPipelinesImpl(ImportPipelinesClient innerClient,
    ...
    public PagedIterable<ImportPipeline> list(String resourceGroupName, String registryName) {
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new ImportPipelineImpl(inner1, this.manager()));
    }
    ...
    public Response<ImportPipeline> getWithResponse(String resourceGroupName, String registryName,
    ...
    public Response<Void> deleteWithResponse(String resourceGroupName, String registryName, String importPipelineName,
        Context context) {
        return this.serviceClient().deleteWithResponse(resourceGroupName, registryName, importPipelineName, context);
    }
    ...
    public ImportPipeline getById(String id) {
        ...
        String importPipelineName = ResourceManagerUtils.getValueFromIdByName(id, "importPipelines");
        if (importPipelineName == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
                String.format("The resource ID '%s' is not valid. Missing path segment 'importPipelines'.", id)));
        }
    ...
    public void deleteById(String id) {
        ...
        this.deleteWithResponse(resourceGroupName, registryName, importPipelineName, Context.NONE);
    }
    ...
    public Response<Void> deleteByIdWithResponse(String id, Context context) {
        ...
        return this.deleteWithResponse(resourceGroupName, registryName, importPipelineName, context);
    }
