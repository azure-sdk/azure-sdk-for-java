...
public final class TokensClientImpl implements TokensClient {
    ...
    public SyncPoller<PollResult<TokenInner>, TokenInner> beginCreate(
        ...
        Context context) {
        return this
            .beginCreateAsync(resourceGroupName, registryName, tokenName, tokenCreateParameters, context)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<TokenInner>, TokenInner> beginUpdate(
        ...
        Context context) {
        return this
            .beginUpdateAsync(resourceGroupName, registryName, tokenName, tokenUpdateParameters, context)
            .getSyncPoller();
    }
