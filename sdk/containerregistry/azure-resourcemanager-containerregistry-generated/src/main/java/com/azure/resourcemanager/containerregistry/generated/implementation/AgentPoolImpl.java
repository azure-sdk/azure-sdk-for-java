...
public final class AgentPoolImpl implements AgentPool, AgentPool.Definition, AgentPool.Update {
    ...
    public AgentPool create() {
        this.innerObject = serviceManager.serviceClient().getAgentPools().create(resourceGroupName, registryName,
    ...
    public AgentPool apply() {
        this.innerObject = serviceManager.serviceClient().getAgentPools().update(resourceGroupName, registryName,
            agentPoolName, updateUpdateParameters, Context.NONE);
        return this;
    }

    public AgentPool apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getAgentPools().update(resourceGroupName, registryName,
            agentPoolName, updateUpdateParameters, context);
        return this;
    }
    ...
    public AgentPool refresh() {
        this.innerObject = serviceManager.serviceClient().getAgentPools()
            .getWithResponse(resourceGroupName, registryName, agentPoolName, Context.NONE).getValue();
        return this;
    }

    public AgentPool refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getAgentPools()
            .getWithResponse(resourceGroupName, registryName, agentPoolName, context).getValue();
        return this;
    }

    public Response<AgentPoolQueueStatus> getQueueStatusWithResponse(Context context) {
        return serviceManager.agentPools().getQueueStatusWithResponse(resourceGroupName, registryName, agentPoolName,
            context);
    }
