 ...
 */
@Fluent
public final class ArchiveVersionListResult {
    /*
     * The list of export pipelines. Since this list may be incomplete, the nextLink field should be used to request
     * the next list of export pipelines.
     */
     ...
     * @return the ArchiveVersionListResult object itself.
     */
    public ArchiveVersionListResult withValue(List<ArchiveVersionInner> value) {
        this.value = value;
        return this;
    }
     ...
     * @return the ArchiveVersionListResult object itself.
     */
    public ArchiveVersionListResult withNextLink(String nextLink) {
