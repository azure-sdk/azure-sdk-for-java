...
import com.azure.resourcemanager.containerregistry.generated.fluent.models.ConnectedRegistryUpdateParametersProperties;
...
public final class ConnectedRegistryUpdateParameters implements JsonSerializable<ConnectedRegistryUpdateParameters> {
     ...
     */
    private ConnectedRegistryUpdateParametersProperties innerProperties;
    ...
    /**
     * Get the syncProperties property: The parameters for updating the sync properties of the connected registry with
     * its parent.
     * 
    ...
    /**
     * Set the syncProperties property: The parameters for updating the sync properties of the connected registry with
     * its parent.
     * 
    ...
    public ConnectedRegistryUpdateParameters withSyncProperties(SyncUpdateProperties syncProperties) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ConnectedRegistryUpdateParametersProperties();
        }
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("properties".equals(fieldName)) {
                    deserializedConnectedRegistryUpdateParameters.innerProperties
                        = ConnectedRegistryUpdateParametersProperties.fromJson(reader);
                } else {
                    reader.skipChildren();
                }
            }
