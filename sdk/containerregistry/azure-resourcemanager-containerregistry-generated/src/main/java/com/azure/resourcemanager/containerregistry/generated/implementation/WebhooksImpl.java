...
public final class WebhooksImpl implements Webhooks {
    ...
    public Response<Webhook> getWithResponse(String resourceGroupName, String registryName, String webhookName,
        Context context) {
    ...
    public Response<EventInfo> pingWithResponse(String resourceGroupName, String registryName, String webhookName,
        Context context) {
    ...
    public PagedIterable<Event> listEvents(String resourceGroupName, String registryName, String webhookName,
        ...
        PagedIterable<EventInner> inner
            = this.serviceClient().listEvents(resourceGroupName, registryName, webhookName, skipToken, context);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new EventImpl(inner1, this.manager()));
    }

    public Response<CallbackConfig> getCallbackConfigWithResponse(String resourceGroupName, String registryName,
