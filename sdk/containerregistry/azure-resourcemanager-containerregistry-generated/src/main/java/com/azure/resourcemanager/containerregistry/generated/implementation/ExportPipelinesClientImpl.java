...
public final class ExportPipelinesClientImpl implements ExportPipelinesClient {
    ...
    public interface ExportPipelinesService {
        ...
        Mono<Response<ExportPipelineListResult>> list(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ExportPipelineListResult> listSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("registryName") String registryName,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ExportPipelineInner>> get(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("registryName") String registryName,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ExportPipelineInner> getSync(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("registryName") String registryName,
            @PathParam("exportPipelineName") String exportPipelineName, @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Response<ExportPipelineListResult> listNextSync(@PathParam(value = "nextLink", encoded = true) String nextLink,
    ...
    private Mono<PagedResponse<ExportPipelineInner>> listSinglePageAsync(String resourceGroupName,
        String registryName) {
        ...
        return FluxUtil
            ...
            .<PagedResponse<ExportPipelineInner>>map(res -> new PagedResponseBase<>(res.getRequest(),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<ExportPipelineInner> listSinglePage(String resourceGroupName, String registryName) {
        if (this.client.getEndpoint() == null) {
        ...
        final String accept = "application/json";
        Response<ExportPipelineListResult> res
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ExportPipelineInner>> getWithResponseAsync(String resourceGroupName, String registryName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ExportPipelineInner> getAsync(String resourceGroupName, String registryName,
        String exportPipelineName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ExportPipelineInner> getWithResponse(String resourceGroupName, String registryName,
        ...
        if (exportPipelineName == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter exportPipelineName is required and cannot be null."));
        }
        final String accept = "application/json";
    ...
    private Mono<Response<Flux<ByteBuffer>>> createWithResponseAsync(String resourceGroupName, String registryName,
        ...
        return FluxUtil
            .withContext(context -> service.create(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, registryName, exportPipelineName,
                exportPipelineCreateParameters, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Response<BinaryData> createWithResponse(String resourceGroupName, String registryName,
        ...
        return service.createSync(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, registryName, exportPipelineName,
            exportPipelineCreateParameters, accept, Context.NONE);
    }
    ...
    private PollerFlux<PollResult<ExportPipelineInner>, ExportPipelineInner> beginCreateAsync(String resourceGroupName,
        ...
        return this.client.<ExportPipelineInner, ExportPipelineInner>getLroResult(mono, this.client.getHttpPipeline(),
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<ExportPipelineInner>, ExportPipelineInner> beginCreate(String resourceGroupName,
        String registryName, String exportPipelineName, ExportPipelineInner exportPipelineCreateParameters) {
        Response<BinaryData> response
            = createWithResponse(resourceGroupName, registryName, exportPipelineName, exportPipelineCreateParameters);
        return this.client.<ExportPipelineInner, ExportPipelineInner>getLroResult(response, ExportPipelineInner.class,
            ExportPipelineInner.class, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<ExportPipelineInner>, ExportPipelineInner> beginCreate(String resourceGroupName,
        String registryName, String exportPipelineName, ExportPipelineInner exportPipelineCreateParameters,
        Context context) {
        Response<BinaryData> response = createWithResponse(resourceGroupName, registryName, exportPipelineName,
            exportPipelineCreateParameters, context);
        return this.client.<ExportPipelineInner, ExportPipelineInner>getLroResult(response, ExportPipelineInner.class,
            ExportPipelineInner.class, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ExportPipelineInner> createAsync(String resourceGroupName, String registryName,
        String exportPipelineName, ExportPipelineInner exportPipelineCreateParameters) {
    ...
    public ExportPipelineInner create(String resourceGroupName, String registryName, String exportPipelineName,
        ...
        return beginCreate(resourceGroupName, registryName, exportPipelineName, exportPipelineCreateParameters)
            .getFinalResult();
    }
    ...
    public ExportPipelineInner create(String resourceGroupName, String registryName, String exportPipelineName,
        ...
        return beginCreate(resourceGroupName, registryName, exportPipelineName, exportPipelineCreateParameters, context)
            .getFinalResult();
    }
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String registryName, String exportPipelineName) {
        return deleteWithResponseAsync(resourceGroupName, registryName, exportPipelineName)
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<Void> deleteWithResponse(String resourceGroupName, String registryName, String exportPipelineName,
        Context context) {
        if (this.client.getEndpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
    ...
    public void delete(String resourceGroupName, String registryName, String exportPipelineName) {
        deleteWithResponse(resourceGroupName, registryName, exportPipelineName, Context.NONE);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<ExportPipelineInner> listNextSinglePage(String nextLink) {
        if (nextLink == null) {
            throw LOGGER.atError()
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<ExportPipelineInner> listNextSinglePage(String nextLink, Context context) {
        if (nextLink == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(ExportPipelinesClientImpl.class);
}
