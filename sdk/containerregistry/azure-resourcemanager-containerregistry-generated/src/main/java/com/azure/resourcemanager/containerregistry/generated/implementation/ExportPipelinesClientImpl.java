...
public final class ExportPipelinesClientImpl implements ExportPipelinesClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<ExportPipelineInner>> listSinglePageAsync(String resourceGroupName, String registryName,
        Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
    ...
    private Mono<Response<ExportPipelineInner>> getWithResponseAsync(String resourceGroupName, String registryName,
        ...
        return service.get(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(), resourceGroupName,
            registryName, exportPipelineName, accept, context);
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> createWithResponseAsync(String resourceGroupName, String registryName,
        ...
        return service.create(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(), resourceGroupName,
            registryName, exportPipelineName, exportPipelineCreateParameters, accept, context);
    }
    ...
    public SyncPoller<PollResult<ExportPipelineInner>, ExportPipelineInner> beginCreate(String resourceGroupName,
        String registryName, String exportPipelineName, ExportPipelineInner exportPipelineCreateParameters,
        Context context) {
        return this.beginCreateAsync(resourceGroupName, registryName, exportPipelineName,
            exportPipelineCreateParameters, context).getSyncPoller();
    }
