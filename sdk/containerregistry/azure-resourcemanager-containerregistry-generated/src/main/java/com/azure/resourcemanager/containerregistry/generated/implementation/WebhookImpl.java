...
public final class WebhookImpl implements Webhook, Webhook.Definition, Webhook.Update {
    ...
    public Webhook create() {
        this.innerObject = serviceManager.serviceClient().getWebhooks().create(resourceGroupName, registryName,
            webhookName, createWebhookCreateParameters, Context.NONE);
        return this;
    }

    public Webhook create(Context context) {
        this.innerObject = serviceManager.serviceClient().getWebhooks().create(resourceGroupName, registryName,
            webhookName, createWebhookCreateParameters, context);
        return this;
    }

    WebhookImpl(String name,
    ...
    public Webhook apply() {
        this.innerObject = serviceManager.serviceClient().getWebhooks().update(resourceGroupName, registryName,
            webhookName, updateWebhookUpdateParameters, Context.NONE);
        return this;
    }

    public Webhook apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getWebhooks().update(resourceGroupName, registryName,
            webhookName, updateWebhookUpdateParameters, context);
        return this;
    }

    WebhookImpl(WebhookInner innerObject,
        com.azure.resourcemanager.containerregistry.generated.ContainerRegistryManager serviceManager) {
    ...
    public Webhook refresh() {
        this.innerObject = serviceManager.serviceClient().getWebhooks()
            .getWithResponse(resourceGroupName, registryName, webhookName, Context.NONE).getValue();
        return this;
    }

    public Webhook refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getWebhooks()
            .getWithResponse(resourceGroupName, registryName, webhookName, context).getValue();
        return this;
    }
    ...
    public PagedIterable<Event> listEvents(String skipToken, Context context) {
        return serviceManager.webhooks().listEvents(resourceGroupName, registryName, webhookName, skipToken, context);
    }

    public Response<CallbackConfig> getCallbackConfigWithResponse(Context context) {
        return serviceManager.webhooks().getCallbackConfigWithResponse(resourceGroupName, registryName, webhookName,
            context);
    }
