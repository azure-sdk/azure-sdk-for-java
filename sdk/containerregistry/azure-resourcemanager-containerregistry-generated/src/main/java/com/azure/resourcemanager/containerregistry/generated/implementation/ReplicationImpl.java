...
public final class ReplicationImpl implements Replication, Replication.Definition, Replication.Update {
    ...
    public Replication create() {
        this.innerObject = serviceManager.serviceClient().getReplications().create(resourceGroupName, registryName,
            replicationName, this.innerModel(), Context.NONE);
        return this;
    }

    public Replication create(Context context) {
        this.innerObject = serviceManager.serviceClient().getReplications().create(resourceGroupName, registryName,
            replicationName, this.innerModel(), context);
        return this;
    }

    ReplicationImpl(String name,
    ...
    public Replication apply() {
        this.innerObject = serviceManager.serviceClient().getReplications().update(resourceGroupName, registryName,
            replicationName, updateReplicationUpdateParameters, Context.NONE);
        return this;
    }

    public Replication apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getReplications().update(resourceGroupName, registryName,
            replicationName, updateReplicationUpdateParameters, context);
        return this;
    }

    ReplicationImpl(ReplicationInner innerObject,
        com.azure.resourcemanager.containerregistry.generated.ContainerRegistryManager serviceManager) {
        this.innerObject = innerObject;
        this.serviceManager = serviceManager;
        this.resourceGroupName = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "resourceGroups");
        this.registryName = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "registries");
        this.replicationName = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "replications");
    }

    public Replication refresh() {
        this.innerObject = serviceManager.serviceClient().getReplications()
            .getWithResponse(resourceGroupName, registryName, replicationName, Context.NONE).getValue();
        return this;
    }

    public Replication refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getReplications()
            .getWithResponse(resourceGroupName, registryName, replicationName, context).getValue();
        return this;
    }
