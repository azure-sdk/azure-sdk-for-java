...
public final class CredentialSetImpl implements CredentialSet, CredentialSet.Definition, CredentialSet.Update {
    ...
    public CredentialSet create() {
        this.innerObject = serviceManager.serviceClient().getCredentialSets().create(resourceGroupName, registryName,
            credentialSetName, this.innerModel(), Context.NONE);
        return this;
    }

    public CredentialSet create(Context context) {
        this.innerObject = serviceManager.serviceClient().getCredentialSets().create(resourceGroupName, registryName,
            credentialSetName, this.innerModel(), context);
        return this;
    }
    ...
    public CredentialSet apply() {
        this.innerObject = serviceManager.serviceClient().getCredentialSets().update(resourceGroupName, registryName,
            credentialSetName, updateCredentialSetUpdateParameters, Context.NONE);
        return this;
    }

    public CredentialSet apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getCredentialSets().update(resourceGroupName, registryName,
            credentialSetName, updateCredentialSetUpdateParameters, context);
        return this;
    }
    ...
    public CredentialSet refresh() {
        this.innerObject = serviceManager.serviceClient().getCredentialSets()
            .getWithResponse(resourceGroupName, registryName, credentialSetName, Context.NONE).getValue();
        return this;
    }

    public CredentialSet refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getCredentialSets()
            .getWithResponse(resourceGroupName, registryName, credentialSetName, context).getValue();
        return this;
    }
