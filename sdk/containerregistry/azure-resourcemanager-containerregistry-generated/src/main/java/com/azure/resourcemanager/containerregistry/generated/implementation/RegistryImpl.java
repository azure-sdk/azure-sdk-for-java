...
import com.azure.resourcemanager.containerregistry.generated.models.MetadataSearch;
...
public final class RegistryImpl implements Registry, Registry.Definition, Registry.Update {
    ...
    public MetadataSearch metadataSearch() {
        return this.innerModel().metadataSearch();
    }
    ...
    public Registry create() {
        this.innerObject = serviceManager.serviceClient().getRegistries().create(resourceGroupName, registryName,
    ...
    public Registry apply() {
        this.innerObject = serviceManager.serviceClient().getRegistries().update(resourceGroupName, registryName,
            updateRegistryUpdateParameters, Context.NONE);
        return this;
    }

    public Registry apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getRegistries().update(resourceGroupName, registryName,
            updateRegistryUpdateParameters, context);
        return this;
    }
    ...
    public Registry refresh() {
        this.innerObject = serviceManager.serviceClient().getRegistries()
            .getByResourceGroupWithResponse(resourceGroupName, registryName, Context.NONE).getValue();
        return this;
    }

    public Registry refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getRegistries()
            .getByResourceGroupWithResponse(resourceGroupName, registryName, context).getValue();
        return this;
    }
    ...
    public Response<RegistryListCredentialsResult> regenerateCredentialWithResponse(
        ...
        return serviceManager.registries().regenerateCredentialWithResponse(resourceGroupName, registryName,
    ...
    public RegistryListCredentialsResult
        ...
        return serviceManager.registries().regenerateCredential(resourceGroupName, registryName,
            regenerateCredentialParameters);
    }

    public Response<CacheRuleArtifactSyncEstimateResult>
        checkCacheRuleArtifactSyncEstimateWithResponse(CacheRuleInner cacheRuleCreateParameters, Context context) {
        return serviceManager.registries().checkCacheRuleArtifactSyncEstimateWithResponse(resourceGroupName,
            registryName, cacheRuleCreateParameters, context);
    }

    public CacheRuleArtifactSyncEstimateResult
        checkCacheRuleArtifactSyncEstimate(CacheRuleInner cacheRuleCreateParameters) {
        return serviceManager.registries().checkCacheRuleArtifactSyncEstimate(resourceGroupName, registryName,
    ...
    public GenerateCredentialsResult generateCredentials(GenerateCredentialsParameters generateCredentialsParameters) {
        return serviceManager.registries().generateCredentials(resourceGroupName, registryName,
    ...
    public Response<SourceUploadDefinition> getBuildSourceUploadUrlWithResponse(Context context) {
        return serviceManager.registries().getBuildSourceUploadUrlWithResponse(resourceGroupName, registryName,
            context);
    }
    ...
    public RegistryImpl withMetadataSearch(MetadataSearch metadataSearch) {
        if (isInCreateMode()) {
            this.innerModel().withMetadataSearch(metadataSearch);
            return this;
        } else {
            this.updateRegistryUpdateParameters.withMetadataSearch(metadataSearch);
            return this;
        }
    }
