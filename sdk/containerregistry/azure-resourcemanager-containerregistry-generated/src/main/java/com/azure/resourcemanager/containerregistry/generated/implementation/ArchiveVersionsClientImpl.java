...
public final class ArchiveVersionsClientImpl implements ArchiveVersionsClient {
    ...
    public interface ArchiveVersionsService {
        ...
        Mono<Response<ArchiveVersionListResult>> list(
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ArchiveVersionInner>> get(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            ...
            @PathParam("packageType") String packageType,
            @PathParam("archiveName") String archiveName,
            @PathParam("archiveVersionName") String archiveVersionName,
            @HeaderParam("Accept") String accept,
            Context context);
     ...
     * @return the result of a request to list export pipelines for a container registry along with {@link
     *     PagedResponse} on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<ArchiveVersionInner>> listSinglePageAsync(
                ...
                context ->
                    service
                        .list(
                            ...
                            accept,
                            context))
            .<PagedResponse<ArchiveVersionInner>>map(
                res ->
    ...
    private PagedFlux<ArchiveVersionInner> listAsync(
        String resourceGroupName, String registryName, String packageType, String archiveName) {
        return new PagedFlux<>(
            () -> listSinglePageAsync(resourceGroupName, registryName, packageType, archiveName),
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<ArchiveVersionInner> list(
        String resourceGroupName, String registryName, String packageType, String archiveName) {
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the properties of the archive version along with {@link Response} on successful completion of {@link
     *     Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ArchiveVersionInner>> getWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ArchiveVersionInner> getAsync(
        String resourceGroupName,
        String registryName,
        String packageType,
        String archiveName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ArchiveVersionInner> getWithResponse(
        String resourceGroupName,
        String registryName,
        String packageType,
        String archiveName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ArchiveVersionInner get(
        String resourceGroupName,
        String registryName,
        String packageType,
        String archiveName,
        ...
        return getWithResponse(
                resourceGroupName, registryName, packageType, archiveName, archiveVersionName, Context.NONE)
            .getValue();
    }
    ...
    private PollerFlux<PollResult<ArchiveVersionInner>, ArchiveVersionInner> beginCreateAsync(
        String resourceGroupName,
        String registryName,
        String packageType,
        String archiveName,
        ...
        return this
            .client
            .<ArchiveVersionInner, ArchiveVersionInner>getLroResult(
                mono,
                this.client.getHttpPipeline(),
                ArchiveVersionInner.class,
                ArchiveVersionInner.class,
    ...
    private PollerFlux<PollResult<ArchiveVersionInner>, ArchiveVersionInner> beginCreateAsync(
        ...
        return this
            .client
            .<ArchiveVersionInner, ArchiveVersionInner>getLroResult(
                mono, this.client.getHttpPipeline(), ArchiveVersionInner.class, ArchiveVersionInner.class, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<ArchiveVersionInner>, ArchiveVersionInner> beginCreate(
        String resourceGroupName,
        String registryName,
        String packageType,
        String archiveName,
        String archiveVersionName) {
        return this
            .beginCreateAsync(resourceGroupName, registryName, packageType, archiveName, archiveVersionName)
            .getSyncPoller();
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return an object that represents an export pipeline for a container registry on successful completion of {@link
     *     Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ArchiveVersionInner> createAsync(
        String resourceGroupName,
        String registryName,
        String packageType,
        String archiveName,
        String archiveVersionName) {
        return beginCreateAsync(resourceGroupName, registryName, packageType, archiveName, archiveVersionName)
            .last()
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ArchiveVersionInner create(
        String resourceGroupName,
        String registryName,
        String packageType,
        String archiveName,
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(
        ...
        String archiveVersionName) {
        return this
            .beginDeleteAsync(resourceGroupName, registryName, packageType, archiveName, archiveVersionName)
            .getSyncPoller();
    }
    ...
    private Mono<Void> deleteAsync(
        ...
        String archiveName,
        String archiveVersionName) {
        return beginDeleteAsync(resourceGroupName, registryName, packageType, archiveName, archiveVersionName)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
