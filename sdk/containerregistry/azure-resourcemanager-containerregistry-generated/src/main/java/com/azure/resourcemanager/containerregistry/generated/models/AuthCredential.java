...
public final class AuthCredential {
     ...
     */
    @JsonProperty(value = "credentialHealth")
    ...
    /**
     * Get the credentialHealth property: The health of the auth credential.
     * 
    ...
    /**
     * Set the credentialHealth property: The health of the auth credential.
     * 
     * @param credentialHealth the credentialHealth value to set.
     * @return the AuthCredential object itself.
     */
    public AuthCredential withCredentialHealth(CredentialHealth credentialHealth) {
