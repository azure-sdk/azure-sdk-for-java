...
public interface CacheRule {
    ...
    /**
     * Gets the targetRepository property: Target repository specified in docker pull command.
    ...
    /**
     * Gets the artifactSyncStatus property: The status of artifact sync.
     * 
    ...
    /**
     * Gets the artifactSyncScopeFilterProperties property: The scope filter properties of artifact sync.
     * 
    ...
    interface DefinitionStages {
         ...
         */
        interface WithCreate extends DefinitionStages.WithCredentialSetResourceId,
            DefinitionStages.WithSourceRepository, DefinitionStages.WithTargetRepository,
            DefinitionStages.WithArtifactSyncStatus, DefinitionStages.WithArtifactSyncScopeFilterProperties {
            /**
        ...
        interface WithTargetRepository {
            /**
             * Specifies the targetRepository property: Target repository specified in docker pull command.
             * Eg: docker pull myregistry.azurecr.io/{targetRepository}:{tag}.
             * 
        ...
        /**
         * The stage of the CacheRule definition allowing to specify artifactSyncStatus.
         */
        interface WithArtifactSyncStatus {
            /**
             * Specifies the artifactSyncStatus property: The status of artifact sync..
             * 
             * @param artifactSyncStatus The status of artifact sync.
             * @return the next definition stage.
             */
            WithCreate withArtifactSyncStatus(ArtifactSyncStatus artifactSyncStatus);
        }

        /**
         * The stage of the CacheRule definition allowing to specify artifactSyncScopeFilterProperties.
         */
        interface WithArtifactSyncScopeFilterProperties {
            /**
             * Specifies the artifactSyncScopeFilterProperties property: The scope filter properties of artifact sync..
             * 
             * @param artifactSyncScopeFilterProperties The scope filter properties of artifact sync.
             * @return the next definition stage.
             */
            WithCreate withArtifactSyncScopeFilterProperties(
                ArtifactSyncScopeFilterProperties artifactSyncScopeFilterProperties);
        }
    }
     ...
     */
    interface Update extends UpdateStages.WithCredentialSetResourceId, UpdateStages.WithArtifactSyncStatus,
        UpdateStages.WithArtifactSyncScopeFilterProperties {
        /**
    ...
    interface UpdateStages {
        ...
        /**
         * The stage of the CacheRule update allowing to specify artifactSyncStatus.
         */
        interface WithArtifactSyncStatus {
            /**
             * Specifies the artifactSyncStatus property: The status of artifact sync..
             ...
             * @return the next definition stage.
             */
            Update withArtifactSyncStatus(ArtifactSyncStatus artifactSyncStatus);
        }

        /**
         * The stage of the CacheRule update allowing to specify artifactSyncScopeFilterProperties.
         */
        interface WithArtifactSyncScopeFilterProperties {
            /**
             * Specifies the artifactSyncScopeFilterProperties property: The scope filter properties of artifact sync..
             ...
             * @return the next definition stage.
             */
            Update withArtifactSyncScopeFilterProperties(
                ArtifactSyncScopeFilterProperties artifactSyncScopeFilterProperties);
        }
    }
