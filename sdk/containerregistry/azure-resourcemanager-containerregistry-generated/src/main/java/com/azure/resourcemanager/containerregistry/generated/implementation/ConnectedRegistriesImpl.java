...
public final class ConnectedRegistriesImpl implements ConnectedRegistries {
    ...
    public ConnectedRegistriesImpl(ConnectedRegistriesClient innerClient,
    ...
    public PagedIterable<ConnectedRegistry> list(String resourceGroupName, String registryName, String filter,
        Context context) {
    ...
    public Response<ConnectedRegistry> getWithResponse(String resourceGroupName, String registryName,
    ...
    public ConnectedRegistry getById(String id) {
        ...
        if (connectedRegistryName == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
                String.format("The resource ID '%s' is not valid. Missing path segment 'connectedRegistries'.", id)));
        }
