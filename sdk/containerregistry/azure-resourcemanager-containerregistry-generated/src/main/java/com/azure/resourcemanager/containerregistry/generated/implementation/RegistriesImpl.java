...
public final class RegistriesImpl implements Registries {
    ...
    public Response<RegistryNameStatus>
    ...
    public Response<RegistryListCredentialsResult> listCredentialsWithResponse(String resourceGroupName,
    ...
    public Response<RegistryListCredentialsResult> regenerateCredentialWithResponse(String resourceGroupName,
        String registryName, RegenerateCredentialParameters regenerateCredentialParameters, Context context) {
        Response<RegistryListCredentialsResultInner> inner = this.serviceClient()
    ...
    public RegistryListCredentialsResult regenerateCredential(String resourceGroupName, String registryName,
        RegenerateCredentialParameters regenerateCredentialParameters) {
        RegistryListCredentialsResultInner inner = this.serviceClient().regenerateCredential(resourceGroupName,
    ...
    public Response<RegistryUsageListResult> listUsagesWithResponse(String resourceGroupName, String registryName,
        Context context) {
    ...
    public Response<PrivateLinkResource> getPrivateLinkResourceWithResponse(String resourceGroupName,
    ...
    public Response<CacheRuleArtifactSyncEstimateResult> checkCacheRuleArtifactSyncEstimateWithResponse(
        String resourceGroupName, String registryName, CacheRuleInner cacheRuleCreateParameters, Context context) {
        Response<CacheRuleArtifactSyncEstimateResultInner> inner
            = this.serviceClient().checkCacheRuleArtifactSyncEstimateWithResponse(resourceGroupName, registryName,
                cacheRuleCreateParameters, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
                new CacheRuleArtifactSyncEstimateResultImpl(inner.getValue(), this.manager()));
        } else {
            return null;
        }
    }

    public CacheRuleArtifactSyncEstimateResult checkCacheRuleArtifactSyncEstimate(String resourceGroupName,
        String registryName, CacheRuleInner cacheRuleCreateParameters) {
        CacheRuleArtifactSyncEstimateResultInner inner = this.serviceClient()
            .checkCacheRuleArtifactSyncEstimate(resourceGroupName, registryName, cacheRuleCreateParameters);
        if (inner != null) {
            return new CacheRuleArtifactSyncEstimateResultImpl(inner, this.manager());
        } else {
            return null;
        }
    }

    public GenerateCredentialsResult generateCredentials(String resourceGroupName, String registryName,
    ...
    public GenerateCredentialsResult generateCredentials(String resourceGroupName, String registryName,
        ...
        GenerateCredentialsResultInner inner = this.serviceClient().generateCredentials(resourceGroupName, registryName,
