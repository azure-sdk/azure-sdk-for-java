...
public final class ExportPipelinesImpl implements ExportPipelines {
    ...
    public ExportPipelinesImpl(ExportPipelinesClient innerClient,
    ...
    public PagedIterable<ExportPipeline> list(String resourceGroupName, String registryName) {
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new ExportPipelineImpl(inner1, this.manager()));
    }
    ...
    public Response<ExportPipeline> getWithResponse(String resourceGroupName, String registryName,
    ...
    public Response<Void> deleteWithResponse(String resourceGroupName, String registryName, String exportPipelineName,
        Context context) {
        return this.serviceClient().deleteWithResponse(resourceGroupName, registryName, exportPipelineName, context);
    }
    ...
    public ExportPipeline getById(String id) {
        ...
        String exportPipelineName = ResourceManagerUtils.getValueFromIdByName(id, "exportPipelines");
        if (exportPipelineName == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
                String.format("The resource ID '%s' is not valid. Missing path segment 'exportPipelines'.", id)));
        }
    ...
    public void deleteById(String id) {
        ...
        this.deleteWithResponse(resourceGroupName, registryName, exportPipelineName, Context.NONE);
    }
    ...
    public Response<Void> deleteByIdWithResponse(String id, Context context) {
        ...
        return this.deleteWithResponse(resourceGroupName, registryName, exportPipelineName, context);
    }
