...
public final class PrivateEndpointConnectionsImpl implements PrivateEndpointConnections {
    ...
    public PagedIterable<PrivateEndpointConnection> list(String resourceGroupName, String registryName) {
        PagedIterable<PrivateEndpointConnectionInner> inner
            = this.serviceClient().list(resourceGroupName, registryName);
    ...
    public PagedIterable<PrivateEndpointConnection> list(String resourceGroupName, String registryName,
        Context context) {
        PagedIterable<PrivateEndpointConnectionInner> inner
            = this.serviceClient().list(resourceGroupName, registryName, context);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new PrivateEndpointConnectionImpl(inner1, this.manager()));
    }

    public Response<PrivateEndpointConnection> getWithResponse(String resourceGroupName, String registryName,
    ...
    public PrivateEndpointConnection get(String resourceGroupName, String registryName,
        String privateEndpointConnectionName) {
        PrivateEndpointConnectionInner inner
            = this.serviceClient().get(resourceGroupName, registryName, privateEndpointConnectionName);
        if (inner != null) {
    ...
    public void delete(String resourceGroupName, String registryName, String privateEndpointConnectionName) {
        this.serviceClient().delete(resourceGroupName, registryName, privateEndpointConnectionName);
    }

    public void delete(String resourceGroupName, String registryName, String privateEndpointConnectionName,
        Context context) {
        this.serviceClient().delete(resourceGroupName, registryName, privateEndpointConnectionName, context);
    }
    ...
    public PrivateEndpointConnection getById(String id) {
        ...
        return this.getWithResponse(resourceGroupName, registryName, privateEndpointConnectionName, Context.NONE)
            .getValue();
    }
    ...
    public Response<PrivateEndpointConnection> getByIdWithResponse(String id, Context context) {
        ...
        return this.getWithResponse(resourceGroupName, registryName, privateEndpointConnectionName, context);
    }
    ...
    public void deleteById(String id) {
        ...
        this.delete(resourceGroupName, registryName, privateEndpointConnectionName, Context.NONE);
    }
    ...
    public void deleteByIdWithResponse(String id, Context context) {
        ...
        this.delete(resourceGroupName, registryName, privateEndpointConnectionName, context);
    }
