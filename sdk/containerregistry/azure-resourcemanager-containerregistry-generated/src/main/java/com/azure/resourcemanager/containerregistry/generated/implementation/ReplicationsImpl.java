...
public final class ReplicationsImpl implements Replications {
    ...
    public ReplicationsImpl(ReplicationsClient innerClient,
        com.azure.resourcemanager.containerregistry.generated.ContainerRegistryManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public Response<Replication> getWithResponse(String resourceGroupName, String registryName, String replicationName,
        Context context) {
    ...
    public Replication getById(String id) {
        ...
        String replicationName = ResourceManagerUtils.getValueFromIdByName(id, "replications");
