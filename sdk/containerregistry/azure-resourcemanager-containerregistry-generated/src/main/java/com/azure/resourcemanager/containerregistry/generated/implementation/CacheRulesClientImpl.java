...
import com.azure.resourcemanager.containerregistry.generated.models.CacheRulesListResult;
...
public final class CacheRulesClientImpl implements CacheRulesClient {
    ...
    public interface CacheRulesService {
        ...
        @Get(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerRegistry"
                + "/registries/{registryName}/cacheRules")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<CacheRulesListResult>> listAsync(
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<CacheRuleInner>> getAsync(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<CacheRulesListResult>> listAsyncNext(
    ...
    private Mono<PagedResponse<CacheRuleInner>> listAsyncSinglePageAsync(
    ...
    private PagedFlux<CacheRuleInner> listAsyncAsync(String resourceGroupName, String registryName) {
        return new PagedFlux<>(
            () -> listAsyncSinglePageAsync(resourceGroupName, registryName),
            nextLink -> listAsyncNextSinglePageAsync(nextLink));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<CacheRuleInner> listAsyncAsync(String resourceGroupName, String registryName, Context context) {
        return new PagedFlux<>(
            () -> listAsyncSinglePageAsync(resourceGroupName, registryName, context),
            nextLink -> listAsyncNextSinglePageAsync(nextLink, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<CacheRuleInner> listAsync(String resourceGroupName, String registryName) {
        return new PagedIterable<>(listAsyncAsync(resourceGroupName, registryName));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<CacheRuleInner> listAsync(String resourceGroupName, String registryName, Context context) {
        return new PagedIterable<>(listAsyncAsync(resourceGroupName, registryName, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<CacheRuleInner>> getAsyncWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<CacheRuleInner> getAsyncAsync(String resourceGroupName, String registryName, String cacheRuleName) {
        return getAsyncWithResponseAsync(resourceGroupName, registryName, cacheRuleName)
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<CacheRuleInner> getAsyncWithResponse(
        String resourceGroupName, String registryName, String cacheRuleName, Context context) {
        return getAsyncWithResponseAsync(resourceGroupName, registryName, cacheRuleName, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public CacheRuleInner getAsync(String resourceGroupName, String registryName, String cacheRuleName) {
        return getAsyncWithResponse(resourceGroupName, registryName, cacheRuleName, Context.NONE).getValue();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(
        String resourceGroupName, String registryName, String cacheRuleName) {
        return beginDeleteAsync(resourceGroupName, registryName, cacheRuleName).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(
        String resourceGroupName, String registryName, String cacheRuleName, Context context) {
        return beginDeleteAsync(resourceGroupName, registryName, cacheRuleName, context).getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<CacheRuleInner>> listAsyncNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.listAsyncNext(nextLink, this.client.getEndpoint(), accept, context))
            .<PagedResponse<CacheRuleInner>>map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<CacheRuleInner>> listAsyncNextSinglePageAsync(String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        if (this.client.getEndpoint() == null) {
        ...
        context = this.client.mergeContext(context);
        return service
            .listAsyncNext(nextLink, this.client.getEndpoint(), accept, context)
            .map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(),
