...
public final class CacheRulesClientImpl implements CacheRulesClient {
    ...
    private PagedFlux<CacheRuleInner> listAsync(String resourceGroupName, String registryName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<CacheRuleInner> getAsync(String resourceGroupName, String registryName, String cacheRuleName) {
