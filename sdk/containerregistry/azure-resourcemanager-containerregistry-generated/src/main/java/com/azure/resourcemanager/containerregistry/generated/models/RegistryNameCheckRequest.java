...
public final class RegistryNameCheckRequest implements JsonSerializable<RegistryNameCheckRequest> {
    ...
    /**
     * Get the resourceGroupName property: The resource group name of the container registry.
     * 
    ...
    /**
     * Set the resourceGroupName property: The resource group name of the container registry.
     * 
     * @param resourceGroupName the resourceGroupName value to set.
     * @return the RegistryNameCheckRequest object itself.
     */
    public RegistryNameCheckRequest withResourceGroupName(String resourceGroupName) {
        this.resourceGroupName = resourceGroupName;
        return this;
    }

    /**
     * Get the autoGeneratedDomainNameLabelScope property: The auto generated domain name label of the container
     * registry. This value defaults to "Unsecure".
     * 
    ...
    /**
     * Set the autoGeneratedDomainNameLabelScope property: The auto generated domain name label of the container
     * registry. This value defaults to "Unsecure".
     * 
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("name".equals(fieldName)) {
                    ...
                    deserializedRegistryNameCheckRequest.resourceGroupName = reader.getString();
                } else if ("autoGeneratedDomainNameLabelScope".equals(fieldName)) {
                    deserializedRegistryNameCheckRequest.autoGeneratedDomainNameLabelScope
