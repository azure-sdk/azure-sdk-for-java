    ...
    public CacheRule refresh() {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getCacheRules()
                .getAsyncWithResponse(resourceGroupName, registryName, cacheRuleName, Context.NONE)
                .getValue();
        return this;
    }
    ...
    public CacheRule refresh(Context context) {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getCacheRules()
                .getAsyncWithResponse(resourceGroupName, registryName, cacheRuleName, context)
                .getValue();
        return this;
    }
