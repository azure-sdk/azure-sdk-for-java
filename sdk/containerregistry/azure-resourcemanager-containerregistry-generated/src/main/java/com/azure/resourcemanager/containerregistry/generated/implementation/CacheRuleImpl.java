...
public final class CacheRuleImpl implements CacheRule, CacheRule.Definition, CacheRule.Update {
    ...
    public ArtifactSyncStatus artifactSyncStatus() {
        return this.innerModel().artifactSyncStatus();
    }

    public ArtifactSyncScopeFilterProperties artifactSyncScopeFilterProperties() {
        return this.innerModel().artifactSyncScopeFilterProperties();
    }
    ...
    public CacheRule create() {
        this.innerObject = serviceManager.serviceClient().getCacheRules().create(resourceGroupName, registryName,
            cacheRuleName, this.innerModel(), Context.NONE);
        return this;
    }

    public CacheRule create(Context context) {
        this.innerObject = serviceManager.serviceClient().getCacheRules().create(resourceGroupName, registryName,
            cacheRuleName, this.innerModel(), context);
        return this;
    }
    ...
    public CacheRule apply() {
        this.innerObject = serviceManager.serviceClient().getCacheRules().update(resourceGroupName, registryName,
            cacheRuleName, updateCacheRuleUpdateParameters, Context.NONE);
        return this;
    }

    public CacheRule apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getCacheRules().update(resourceGroupName, registryName,
            cacheRuleName, updateCacheRuleUpdateParameters, context);
        return this;
    }
    ...
    public CacheRule refresh() {
        this.innerObject = serviceManager.serviceClient().getCacheRules()
            .getWithResponse(resourceGroupName, registryName, cacheRuleName, Context.NONE).getValue();
        return this;
    }

    public CacheRule refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getCacheRules()
            .getWithResponse(resourceGroupName, registryName, cacheRuleName, context).getValue();
        return this;
    }
    ...
    public CacheRuleImpl withArtifactSyncStatus(ArtifactSyncStatus artifactSyncStatus) {
        if (isInCreateMode()) {
            this.innerModel().withArtifactSyncStatus(artifactSyncStatus);
            return this;
        } else {
            this.updateCacheRuleUpdateParameters.withArtifactSyncStatus(artifactSyncStatus);
            return this;
        }
    }
    ...
    public CacheRuleImpl
        ...
        if (isInCreateMode()) {
            this.innerModel().withArtifactSyncScopeFilterProperties(artifactSyncScopeFilterProperties);
            return this;
        } else {
            this.updateCacheRuleUpdateParameters
                .withArtifactSyncScopeFilterProperties(artifactSyncScopeFilterProperties);
            return this;
        }
    }
