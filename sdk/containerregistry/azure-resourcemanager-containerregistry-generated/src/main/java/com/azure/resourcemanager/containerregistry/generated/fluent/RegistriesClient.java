...
public interface RegistriesClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<CacheRuleArtifactSyncEstimateResultInner> checkCacheRuleArtifactSyncEstimateWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    CacheRuleArtifactSyncEstimateResultInner checkCacheRuleArtifactSyncEstimate(String resourceGroupName,
