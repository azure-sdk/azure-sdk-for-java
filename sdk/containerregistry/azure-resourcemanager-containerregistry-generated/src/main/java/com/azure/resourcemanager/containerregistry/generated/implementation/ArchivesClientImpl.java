...
import com.azure.resourcemanager.containerregistry.generated.models.ArchiveListResult;
...
public final class ArchivesClientImpl implements ArchivesClient {
    ...
    public interface ArchivesService {
        ...
        Mono<Response<ArchiveListResult>> list(
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ArchiveInner>> get(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
        ...
        Mono<Response<Flux<ByteBuffer>>> create(
            ...
            @PathParam("packageType") String packageType,
            @PathParam("archiveName") String archiveName,
            @BodyParam("application/json") ArchiveInner archiveCreateParameters,
            @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ArchiveInner>> update(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ArchiveListResult>> listNext(
    ...
    private Mono<PagedResponse<ArchiveInner>> listSinglePageAsync(
                ...
                context ->
                    service
                        .list(
                            ...
                            accept,
                            context))
            .<PagedResponse<ArchiveInner>>map(
                res ->
    ...
    private PagedFlux<ArchiveInner> listAsync(String resourceGroupName, String registryName, String packageType) {
        return new PagedFlux<>(
            () -> listSinglePageAsync(resourceGroupName, registryName, packageType),
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<ArchiveInner> listAsync(
        String resourceGroupName, String registryName, String packageType, Context context) {
        return new PagedFlux<>(
            () -> listSinglePageAsync(resourceGroupName, registryName, packageType, context),
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<ArchiveInner> list(
        String resourceGroupName, String registryName, String packageType, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ArchiveInner>> getWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ArchiveInner> getAsync(
        String resourceGroupName, String registryName, String packageType, String archiveName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ArchiveInner> getWithResponse(
        String resourceGroupName, String registryName, String packageType, String archiveName, Context context) {
    ...
    private PollerFlux<PollResult<ArchiveInner>, ArchiveInner> beginCreateAsync(
        String resourceGroupName,
        String registryName,
        String packageType,
        String archiveName,
        ...
        Mono<Response<Flux<ByteBuffer>>> mono =
            createWithResponseAsync(resourceGroupName, registryName, packageType, archiveName, archiveCreateParameters);
        return this
            .client
            .<ArchiveInner, ArchiveInner>getLroResult(
                mono, this.client.getHttpPipeline(), ArchiveInner.class, ArchiveInner.class, this.client.getContext());
    }
    ...
    private PollerFlux<PollResult<ArchiveInner>, ArchiveInner> beginCreateAsync(
        ...
        Mono<Response<Flux<ByteBuffer>>> mono =
            createWithResponseAsync(
                resourceGroupName, registryName, packageType, archiveName, archiveCreateParameters, context);
        return this
            .client
            .<ArchiveInner, ArchiveInner>getLroResult(
                mono, this.client.getHttpPipeline(), ArchiveInner.class, ArchiveInner.class, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<ArchiveInner>, ArchiveInner> beginCreate(
        String resourceGroupName,
        String registryName,
        String packageType,
        String archiveName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ArchiveInner> createAsync(
        String resourceGroupName,
        String registryName,
        String packageType,
        String archiveName,
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(
        String resourceGroupName, String registryName, String packageType, String archiveName, Context context) {
        return this
            .beginDeleteAsync(resourceGroupName, registryName, packageType, archiveName, context)
            .getSyncPoller();
    }
    ...
    private Mono<Void> deleteAsync(
        String resourceGroupName, String registryName, String packageType, String archiveName) {
        return beginDeleteAsync(resourceGroupName, registryName, packageType, archiveName)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<Void> deleteAsync(
        String resourceGroupName, String registryName, String packageType, String archiveName, Context context) {
        return beginDeleteAsync(resourceGroupName, registryName, packageType, archiveName, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ArchiveInner>> updateWithResponseAsync(
        String resourceGroupName,
        String registryName,
        String packageType,
        String archiveName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ArchiveInner> updateAsync(
        String resourceGroupName,
        String registryName,
        String packageType,
        String archiveName,
        ...
        return updateWithResponseAsync(
                resourceGroupName, registryName, packageType, archiveName, archiveUpdateParameters)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ArchiveInner> updateWithResponse(
        String resourceGroupName,
        String registryName,
        String packageType,
        String archiveName,
        ...
        Context context) {
        return updateWithResponseAsync(
                resourceGroupName, registryName, packageType, archiveName, archiveUpdateParameters, context)
            .block();
    }
    ...
    public ArchiveInner update(
        ...
        return updateWithResponse(
                resourceGroupName, registryName, packageType, archiveName, archiveUpdateParameters, Context.NONE)
            .getValue();
    }
