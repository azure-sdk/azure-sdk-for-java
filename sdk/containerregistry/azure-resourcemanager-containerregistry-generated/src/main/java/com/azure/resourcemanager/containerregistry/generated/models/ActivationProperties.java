 ...
 */
@Immutable
public class ActivationProperties implements JsonSerializable<ActivationProperties> {
    /*
    ...
    /**
     * Set the status property: The activation status of the connected registry.
     * 
     * @param status the status value to set.
     * @return the ActivationProperties object itself.
     */
    ActivationProperties withStatus(ActivationStatus status) {
        this.status = status;
        return this;
    }
