...
public final class PipelineRunImpl implements PipelineRun, PipelineRun.Definition {
    ...
    public PipelineRun create() {
        this.innerObject = serviceManager.serviceClient().getPipelineRuns().create(resourceGroupName, registryName,
            pipelineRunName, this.innerModel(), Context.NONE);
        return this;
    }

    public PipelineRun create(Context context) {
        this.innerObject = serviceManager.serviceClient().getPipelineRuns().create(resourceGroupName, registryName,
            pipelineRunName, this.innerModel(), context);
        return this;
    }

    PipelineRunImpl(String name,
        com.azure.resourcemanager.containerregistry.generated.ContainerRegistryManager serviceManager) {
    ...
    public PipelineRun refresh() {
        this.innerObject = serviceManager.serviceClient().getPipelineRuns()
            .getWithResponse(resourceGroupName, registryName, pipelineRunName, Context.NONE).getValue();
        return this;
    }

    public PipelineRun refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getPipelineRuns()
            .getWithResponse(resourceGroupName, registryName, pipelineRunName, context).getValue();
        return this;
    }
