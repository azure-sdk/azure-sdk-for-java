    ...
    public void validate() {
        if (mode() == null) {
            throw LOGGER.logExceptionAsError(
                new IllegalArgumentException("Missing required property mode in model ConnectedRegistryProperties"));
        }
        if (activation() != null) {
            activation().validate();
        }
        if (parent() == null) {
            throw LOGGER.logExceptionAsError(
                new IllegalArgumentException("Missing required property parent in model ConnectedRegistryProperties"));
        } else {
            parent().validate();
        }
        if (loginServer() != null) {
