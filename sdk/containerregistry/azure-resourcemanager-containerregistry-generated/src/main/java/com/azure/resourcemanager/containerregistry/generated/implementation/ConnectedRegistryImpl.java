...
public final class ConnectedRegistryImpl
    ...
    public ConnectedRegistry create() {
        this.innerObject = serviceManager.serviceClient().getConnectedRegistries().create(resourceGroupName,
            registryName, connectedRegistryName, this.innerModel(), Context.NONE);
        return this;
    }

    public ConnectedRegistry create(Context context) {
        this.innerObject = serviceManager.serviceClient().getConnectedRegistries().create(resourceGroupName,
            registryName, connectedRegistryName, this.innerModel(), context);
        return this;
    }
    ...
    public ConnectedRegistry apply() {
        this.innerObject = serviceManager.serviceClient().getConnectedRegistries().update(resourceGroupName,
            registryName, connectedRegistryName, updateConnectedRegistryUpdateParameters, Context.NONE);
        return this;
    }

    public ConnectedRegistry apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getConnectedRegistries().update(resourceGroupName,
            registryName, connectedRegistryName, updateConnectedRegistryUpdateParameters, context);
        return this;
    }
    ...
    public ConnectedRegistry refresh() {
        this.innerObject = serviceManager.serviceClient().getConnectedRegistries()
            .getWithResponse(resourceGroupName, registryName, connectedRegistryName, Context.NONE).getValue();
        return this;
    }

    public ConnectedRegistry refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getConnectedRegistries()
            .getWithResponse(resourceGroupName, registryName, connectedRegistryName, context).getValue();
        return this;
    }
