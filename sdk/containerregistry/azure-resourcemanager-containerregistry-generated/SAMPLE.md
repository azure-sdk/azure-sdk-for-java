...
public final class ArchivesCreateSamples {
    ...
    public static void archiveCreate(com.azure.resourcemanager.containerregistry.generated.ContainerRegistryManager manager) {
        manager.archives().define("myArchiveName").withExistingPackage("myResourceGroup", "myRegistry", "rpm").withPackageSource(new ArchivePackageSourceProperties().withType(PackageSourceType.REMOTE).withUrl("string")).withPublishedVersion("string").withRepositoryEndpointPrefix("string").create();
    }
}
```
...
public final class WebhooksListEventsSamples {
    ...
    public static void webhookListEvents(com.azure.resourcemanager.containerregistry.generated.ContainerRegistryManager manager) {
        manager.webhooks().listEvents("myResourceGroup", "myRegistry", "myWebhook", null, com.azure.core.util.Context.NONE);
    }
}
```
