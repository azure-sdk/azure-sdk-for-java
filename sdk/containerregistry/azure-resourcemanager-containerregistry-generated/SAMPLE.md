...
public final class RegistriesImportImageSamples {
    /*
     * x-ms-original-file:
     * specification/containerregistry/resource-manager/Microsoft.ContainerRegistry/preview/2025-06-01-preview/examples/
...
public final class ArchivesUpdateSamples {
    ...
    public static void
        ...
        Archive resource = manager.archives()
...
public final class TasksUpdateSamples {
     ...
     * x-ms-original-file:
     * specification/containerregistry/resource-manager/Microsoft.ContainerRegistry/preview/2025-06-01-preview/examples/
     * ManagedIdentity/TasksUpdate_WithLoginIdentity.json
     */
    /**
...
public final class ImportPipelinesDeleteSamples {
    ...
    public static void
        ...
        manager.importPipelines()
            .deleteWithResponse("myResourceGroup", "myRegistry", "myImportPipeline", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class PipelineRunsDeleteSamples {
    ...
    public static void
        ...
        manager.pipelineRuns()
            .deleteWithResponse("myResourceGroup", "myRegistry", "myPipelineRun", com.azure.core.util.Context.NONE);
    }
}
```
...
import com.azure.resourcemanager.containerregistry.generated.models.PipelineTargetType;
import com.azure.resourcemanager.containerregistry.generated.models.ResourceIdentityType;
import com.azure.resourcemanager.containerregistry.generated.models.StorageAccessMode;
import java.util.Arrays;
...
public final class ExportPipelinesCreateSamples {
    ...
    public static void
        ...
        manager.exportPipelines()
            ...
            .withRegion("westus")
            .withIdentity(new IdentityProperties().withType(ResourceIdentityType.SYSTEM_ASSIGNED))
            .withTarget(new ExportPipelineTargetProperties().withType(PipelineTargetType.AZURE_STORAGE_BLOB_CONTAINER)
...
public final class TasksCreateSamples {
     ...
     * x-ms-original-file:
     * specification/containerregistry/resource-manager/Microsoft.ContainerRegistry/preview/2025-06-01-preview/examples/
     * ManagedIdentity/TasksCreate_WithLoginIdentity.json
     */
    /**
...
public final class ExportPipelinesDeleteSamples {
    ...
    public static void
        ...
        manager.exportPipelines()
            .deleteWithResponse("myResourceGroup", "myRegistry", "myExportPipeline", com.azure.core.util.Context.NONE);
    }
}
```
