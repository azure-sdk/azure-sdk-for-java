...
- [GetAsync](#cacherules_getasync)
- [ListAsync](#cacherules_listasync)
...
public final class CacheRulesDeleteSamples {
    ...
    public static void cacheRuleDelete(
        com.azure.resourcemanager.containerregistry.generated.ContainerRegistryManager manager) {
        manager.cacheRules().delete("myResourceGroup", "myRegistry", "myCacheRule", Context.NONE);
    }
}
```
...
### CacheRules_ListAsync

```java
import com.azure.core.util.Context;

/** Samples for CacheRules ListAsync. */
public final class CacheRulesListAsyncSamples {
    /*
    ...
    public static void cacheRuleList(
        com.azure.resourcemanager.containerregistry.generated.ContainerRegistryManager manager) {
        manager.cacheRules().listAsync("myResourceGroup", "myRegistry", Context.NONE);
    }
}
```
...
public final class CacheRulesUpdateSamples {
    ...
    public static void cacheRuleUpdate(
        ...
        CacheRule resource =
            manager
                .cacheRules()
                .getAsyncWithResponse("myResourceGroup", "myRegistry", "myCacheRule", Context.NONE)
                .getValue();
        resource
            .update()
            .withCredentialSetResourceId(
...
public final class CredentialSetsListSamples {
    ...
    public static void credentialSetList(
        com.azure.resourcemanager.containerregistry.generated.ContainerRegistryManager manager) {
        manager.credentialSets().list("myResourceGroup", "myRegistry", Context.NONE);
    }
}
```
...
public final class CredentialSetsUpdateSamples {
    ...
    public static void credentialSetUpdate(
        ...
        CredentialSet resource =
            manager
                .credentialSets()
                .getWithResponse("myResourceGroup", "myRegistry", "myCredentialSet", Context.NONE)
                .getValue();
        resource
            .update()
            .withAuthCredentials(
