...
public final class TaskHubsGetWithResponseMockTests {
    @Test
    public void testGetWithResponse() throws Exception {
        String responseStr
            = "{\"properties\":{\"provisioningState\":\"Canceled\",\"dashboardUrl\":\"masxazjpqyegu\"},\"id\":\"hb\",\"name\":\"xhejjzzvdud\",\"type\":\"wdslfhotwmcy\"}";
        ...
        TaskHub response = manager.taskHubs()
            .getWithResponse("njeaseipheofloke", "y", "enjbdlwtgrhp", com.azure.core.util.Context.NONE)
            .getValue();
