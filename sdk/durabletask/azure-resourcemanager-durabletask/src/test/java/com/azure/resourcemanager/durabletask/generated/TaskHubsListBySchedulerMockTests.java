...
public final class TaskHubsListBySchedulerMockTests {
    ...
    public void testListByScheduler() throws Exception {
        String responseStr
            = "{\"value\":[{\"properties\":{\"provisioningState\":\"Deleting\",\"dashboardUrl\":\"fsoppusuesnzw\"},\"id\":\"jbavorxzdm\",\"name\":\"hctbqvudwxdn\",\"type\":\"nvowgujju\"}]}";
        ...
        PagedIterable<TaskHub> response
            = manager.taskHubs().listByScheduler("pwlbjnpg", "cftadeh", com.azure.core.util.Context.NONE);
