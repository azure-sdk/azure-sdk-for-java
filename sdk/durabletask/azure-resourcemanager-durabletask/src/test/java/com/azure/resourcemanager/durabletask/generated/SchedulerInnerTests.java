...
public final class SchedulerInnerTests {
    ...
    public void testDeserialize() throws Exception {
        ...
        Assertions.assertEquals("pzvgnwzsymglzufc", model.properties().endpoint());
    ...
    public void testSerialize() throws Exception {
        SchedulerInner model = new SchedulerInner().withLocation("hab")
            ...
            .withProperties(new SchedulerProperties().withEndpoint("pzvgnwzsymglzufc")
                .withIpAllowlist(Arrays.asList("kohdbiha"))
