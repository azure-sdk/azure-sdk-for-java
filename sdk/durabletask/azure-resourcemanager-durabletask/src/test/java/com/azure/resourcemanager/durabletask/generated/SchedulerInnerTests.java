...
public final class SchedulerInnerTests {
    ...
    public void testDeserialize() throws Exception {
        ...
        Assertions.assertEquals(RedundancyState.NONE, model.properties().sku().redundancyState());
    }
    ...
    public void testSerialize() throws Exception {
        SchedulerInner model = new SchedulerInner().withLocation("hab")
            ...
            .withProperties(new SchedulerProperties().withIpAllowlist(Arrays.asList("kohdbiha"))
                .withSku(new SchedulerSku().withName("ufhfcbjysa")
                    .withCapacity(437058664)
                    .withRedundancyState(RedundancyState.NONE)));
