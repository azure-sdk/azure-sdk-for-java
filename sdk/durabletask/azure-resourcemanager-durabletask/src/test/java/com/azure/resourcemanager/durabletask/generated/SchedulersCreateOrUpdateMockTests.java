    ...
    public void testCreateOrUpdate() throws Exception {
        ...
        Scheduler response = manager.schedulers()
            ...
            .withProperties(new SchedulerProperties().withIpAllowlist(Arrays.asList("hvpmoue", "hd"))
                .withSku(new SchedulerSku().withName("xibqeojnx")
                    .withCapacity(2010157167)
                    .withRedundancyState(RedundancyState.ZONE)))
            .create();
        ...
        Assertions.assertEquals(RedundancyState.ZONE, response.properties().sku().redundancyState());
    }
