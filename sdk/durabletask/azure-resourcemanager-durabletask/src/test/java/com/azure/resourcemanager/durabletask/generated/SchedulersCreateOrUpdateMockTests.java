...
public final class SchedulersCreateOrUpdateMockTests {
    ...
    public void testCreateOrUpdate() throws Exception {
        ...
        Scheduler response = manager.schedulers()
            ...
            .withProperties(new SchedulerProperties().withEndpoint("dtocj")
                .withIpAllowlist(Arrays.asList("hvpmoue", "hd"))
        ...
        Assertions.assertEquals("thz", response.properties().endpoint());
