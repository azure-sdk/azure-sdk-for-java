...
public interface SchedulersClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    SchedulerInner update(String resourceGroupName, String schedulerName, SchedulerInner properties);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    SchedulerInner update(String resourceGroupName, String schedulerName, SchedulerInner properties, Context context);
