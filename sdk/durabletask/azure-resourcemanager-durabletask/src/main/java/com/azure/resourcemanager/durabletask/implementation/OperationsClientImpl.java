...
import com.azure.resourcemanager.durabletask.implementation.models.OperationListResult;
...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    OperationsClientImpl(DurableTaskClientImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for DurableTaskClientOperations to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "DurableTaskClientOpe")
