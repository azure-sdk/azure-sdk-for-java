...
public final class SchedulerSku implements JsonSerializable<SchedulerSku> {
    ...
    /**
     * Set the redundancyState property: Indicates whether the current SKU configuration is zone redundant.
     * 
     * @param redundancyState the redundancyState value to set.
     * @return the SchedulerSku object itself.
     */
    public SchedulerSku withRedundancyState(RedundancyState redundancyState) {
