...
public final class CodePackagesClientImpl implements CodePackagesClient {
    ...
    public interface CodePackagesService {
     ...
     *
     * <p>Gets the logs for the container of the specified code package of the service replica.
     *
    ...
    public ContainerLogsInner getContainerLogs(
        ...
        String codePackageName) {
        final Integer tail = null;
        return getContainerLogsWithResponse(
                resourceGroupName,
                applicationResourceName,
                serviceResourceName,
                replicaName,
