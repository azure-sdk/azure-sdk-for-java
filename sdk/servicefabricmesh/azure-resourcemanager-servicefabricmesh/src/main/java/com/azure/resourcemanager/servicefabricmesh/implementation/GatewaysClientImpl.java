...
public final class GatewaysClientImpl implements GatewaysClient {
     ...
     *
     * <p>Creates a gateway resource with the specified name, description and properties. If a gateway resource with the
    ...
    public GatewayResourceDescriptionInner create(
        ...
        String gatewayResourceName,
        GatewayResourceDescriptionInner gatewayResourceDescription) {
        return createWithResponse(resourceGroupName, gatewayResourceName, gatewayResourceDescription, Context.NONE)
            .getValue();
    }
     ...
     *
     * <p>Gets the information about the gateway resource with the given name. The information include the description
    ...
    public GatewayResourceDescriptionInner getByResourceGroup(String resourceGroupName, String gatewayResourceName) {
        return getByResourceGroupWithResponse(resourceGroupName, gatewayResourceName, Context.NONE).getValue();
    }

    /**
     * Deletes the gateway resource.
     *
     * <p>Deletes the gateway resource identified by the name.
     *
     * @param resourceGroupName Azure resource group name.
     * @param gatewayResourceName The identity of the gateway.
     * @throws IllegalArgumentException thrown if parameters fail the validation.
    ...
    public void delete(String resourceGroupName, String gatewayResourceName) {
        deleteWithResponse(resourceGroupName, gatewayResourceName, Context.NONE);
    }

    /**
     * Gets all the gateway resources in a given resource group.
     *
     * <p>Gets the information about all gateway resources in a given resource group. The information include the
