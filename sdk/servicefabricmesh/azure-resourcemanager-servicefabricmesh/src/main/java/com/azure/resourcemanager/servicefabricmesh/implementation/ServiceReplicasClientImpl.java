...
public final class ServiceReplicasClientImpl implements ServiceReplicasClient {
    ...
    public interface ServiceReplicasService {
     ...
     *
     * <p>Gets the information about the service replica with the given name. The information include the description
    ...
    public ServiceReplicaDescriptionInner get(
        ...
        return getWithResponse(
                resourceGroupName, applicationResourceName, serviceResourceName, replicaName, Context.NONE)
            .getValue();
    }
     ...
     *
     * <p>Gets the information about all replicas of a given service of an application. The information includes the
