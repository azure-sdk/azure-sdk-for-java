...
public class SecretResourceProperties extends SecretResourcePropertiesBase {
    ...
    /*
     * The type of the content stored in the secret value. The value of this property is opaque to Service Fabric. Once
     * set, the value of this property cannot be changed.
     */
    @JsonProperty(value = "contentType")
    private String contentType;

    /** Creates an instance of SecretResourceProperties class. */
