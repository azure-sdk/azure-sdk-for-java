...
public final class NetworksClientImpl implements NetworksClient {
     ...
     *
     * <p>Creates a network resource with the specified name, description and properties. If a network resource with the
    ...
    public NetworkResourceDescriptionInner create(
        ...
        String networkResourceName,
        NetworkResourceDescriptionInner networkResourceDescription) {
        return createWithResponse(resourceGroupName, networkResourceName, networkResourceDescription, Context.NONE)
            .getValue();
    }
     ...
     *
     * <p>Gets the information about the network resource with the given name. The information include the description
    ...
    public NetworkResourceDescriptionInner getByResourceGroup(String resourceGroupName, String networkResourceName) {
        return getByResourceGroupWithResponse(resourceGroupName, networkResourceName, Context.NONE).getValue();
    }

    /**
     * Deletes the network resource.
     *
     * <p>Deletes the network resource identified by the name.
     *
     * @param resourceGroupName Azure resource group name.
     * @param networkResourceName The identity of the network.
     * @throws IllegalArgumentException thrown if parameters fail the validation.
    ...
    public void delete(String resourceGroupName, String networkResourceName) {
        deleteWithResponse(resourceGroupName, networkResourceName, Context.NONE);
    }

    /**
     * Gets all the network resources in a given resource group.
     *
     * <p>Gets the information about all network resources in a given resource group. The information include the
