...
public final class SecretValuesClientImpl implements SecretValuesClient {
    ...
    public interface SecretValuesService {
     ...
     *
     * <p>Creates a new value of the specified secret resource. The name of the value is typically the version
    ...
    public SecretValueResourceDescriptionInner get(
        String resourceGroupName, String secretResourceName, String secretValueResourceName) {
        return getWithResponse(resourceGroupName, secretResourceName, secretValueResourceName, Context.NONE).getValue();
    }
    ...
    public void delete(String resourceGroupName, String secretResourceName, String secretValueResourceName) {
        deleteWithResponse(resourceGroupName, secretResourceName, secretValueResourceName, Context.NONE);
    }
    ...
    public SecretValueInner listValue(
        String resourceGroupName, String secretResourceName, String secretValueResourceName) {
        return listValueWithResponse(resourceGroupName, secretResourceName, secretValueResourceName, Context.NONE)
            .getValue();
    }
