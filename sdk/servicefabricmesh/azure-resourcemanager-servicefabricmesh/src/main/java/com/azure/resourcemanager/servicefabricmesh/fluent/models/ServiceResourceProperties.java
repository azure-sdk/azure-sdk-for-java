...
public final class ServiceResourceProperties extends ProvisionedResourceProperties {
    ...
    /*
     * Describes the set of code packages that forms the service. A code package describes the container and the
     * properties for running it. All the code packages are started together on the same host and share the same
     * context (network, process etc.).
     */
    ...
    /*
     * When the service's health state is not 'Ok', this additional details from service fabric Health Manager for the
