...
public final class ApplicationsClientImpl implements ApplicationsClient {
     ...
     *
     * <p>Creates an application resource with the specified name, description and properties. If an application
    ...
    public ApplicationResourceDescriptionInner create(
        ...
        return createWithResponse(
                resourceGroupName, applicationResourceName, applicationResourceDescription, Context.NONE)
            .getValue();
    }
     ...
     *
     * <p>Gets the information about the application resource with the given name. The information include the
    ...
    public ApplicationResourceDescriptionInner getByResourceGroup(
        String resourceGroupName, String applicationResourceName) {
        return getByResourceGroupWithResponse(resourceGroupName, applicationResourceName, Context.NONE).getValue();
    }

    /**
     * Deletes the application resource.
     *
     * <p>Deletes the application resource identified by the name.
     *
     * @param resourceGroupName Azure resource group name.
     * @param applicationResourceName The identity of the application.
     * @throws IllegalArgumentException thrown if parameters fail the validation.
    ...
    public void delete(String resourceGroupName, String applicationResourceName) {
        deleteWithResponse(resourceGroupName, applicationResourceName, Context.NONE);
    }

    /**
     * Gets all the application resources in a given resource group.
     *
     * <p>Gets the information about all application resources in a given resource group. The information include the
     * description and other properties of the Application.
     *
     * @param resourceGroupName Azure resource group name.
     * @throws IllegalArgumentException thrown if parameters fail the validation.
