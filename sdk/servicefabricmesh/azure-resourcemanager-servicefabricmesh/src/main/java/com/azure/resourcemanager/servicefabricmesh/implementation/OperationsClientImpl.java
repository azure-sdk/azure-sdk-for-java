...
import com.azure.resourcemanager.servicefabricmesh.models.OperationListResult;
...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    OperationsClientImpl(ServiceFabricMeshManagementClientImpl client) {
        this.service =
    ...
    /**
     * The interface defining all the services for ServiceFabricMeshManagementClientOperations to be used by the proxy
     ...
     * @return describes the result of the request to list Service Fabric operations along with {@link PagedResponse} on
