...
public final class PrivateEndpointConnectionImpl
    ...
    public PrivateEndpointConnectionImpl withExistingAttestationProvider(String resourceGroupName,
        String providerName) {
    ...
    public PrivateEndpointConnection create() {
        this.innerObject
            = serviceManager.serviceClient().getPrivateEndpointConnections().createWithResponse(resourceGroupName,
                providerName, privateEndpointConnectionName, this.innerModel(), Context.NONE).getValue();
        return this;
    }
    ...
    public PrivateEndpointConnection create(Context context) {
        this.innerObject
            = serviceManager.serviceClient().getPrivateEndpointConnections().createWithResponse(resourceGroupName,
                providerName, privateEndpointConnectionName, this.innerModel(), context).getValue();
        return this;
    }
