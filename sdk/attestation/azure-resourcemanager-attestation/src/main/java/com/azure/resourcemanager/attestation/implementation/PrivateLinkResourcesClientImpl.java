...
public final class PrivateLinkResourcesClientImpl implements PrivateLinkResourcesClient {
    ...
    public interface PrivateLinkResourcesService {
        ...
        Mono<Response<PrivateLinkResourceListResultInner>> listByProvider(
    ...
    private Mono<Response<PrivateLinkResourceListResultInner>> listByProviderWithResponseAsync(
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the private link resources supported for the attestation provider on successful completion of {@link
     *     Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PrivateLinkResourceListResultInner> listByProviderAsync(
        String resourceGroupName, String providerName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<PrivateLinkResourceListResultInner> listByProviderWithResponse(
        String resourceGroupName, String providerName, Context context) {
