 ...
 */
@Immutable
public final class PatientTimelinePatientResult {
    /*
    ...
    /**
     * Creates an instance of PatientTimelinePatientResult class.
     * 
    ...
    @Generated
    @JsonCreator
    private PatientTimelinePatientResult(@JsonProperty(value = "patientId") String patientId,
