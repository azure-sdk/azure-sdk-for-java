...
package com.azure.health.insights.patienttimeline.implementation;
...
import com.azure.health.insights.patienttimeline.AzureHealthInsightsServiceVersion;
import com.azure.health.insights.patienttimeline.models.PatientTimelineInferenceResult;
...
/**
 * Initializes a new instance of the PatientTimelineClient type.
 */
public final class PatientTimelineClientImpl {
    /**
     * The proxy service used to perform REST calls.
     */
    private final PatientTimelineClientService service;
    ...
    /**
     * Initializes an instance of PatientTimelineClient client.
     * 
     * @param endpoint Supported Cognitive Services endpoints (protocol and hostname, for example:
     * https://westus2.api.cognitive.microsoft.com).
     * @param serviceVersion Service version.
     */
    public PatientTimelineClientImpl(String endpoint, AzureHealthInsightsServiceVersion serviceVersion) {
     ...
     * @param serviceVersion Service version.
     */
    public PatientTimelineClientImpl(HttpPipeline httpPipeline, String endpoint,
     ...
     * @param serviceVersion Service version.
     */
    public PatientTimelineClientImpl(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter, String endpoint,
        AzureHealthInsightsServiceVersion serviceVersion) {
        ...
        this.service
            = RestProxy.create(PatientTimelineClientService.class, this.httpPipeline, this.getSerializerAdapter());
    }

    /**
     * The interface defining all the services for PatientTimelineClient to be used by the proxy service to perform
     * REST calls.
     */
    @Host("{endpoint}/health-insights")
    @ServiceInterface(name = "PatientTimelineClien")
    public interface PatientTimelineClientService {
        @Post("/patient-timeline/jobs")
        @ExpectedResponses({ 202 })
        @UnexpectedResponseExceptionType(value = ClientAuthenticationException.class, code = { 401 })
        @UnexpectedResponseExceptionType(value = ResourceNotFoundException.class, code = { 404 })
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        @UnexpectedResponseExceptionType(HttpResponseException.class)
        Mono<Response<BinaryData>> inferPatientTimeline(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @HeaderParam("accept") String accept,
            @BodyParam("application/json") BinaryData patientTimelineData, RequestOptions requestOptions,
            Context context);
        ...
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        @UnexpectedResponseExceptionType(HttpResponseException.class)
        Response<BinaryData> inferPatientTimelineSync(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @HeaderParam("accept") String accept,
            @BodyParam("application/json") BinaryData patientTimelineData, RequestOptions requestOptions,
            Context context);
    }
     ...
     * }</pre>
     * 
     * @param patientTimelineData The body of the Patient Timeline request.
    ...
    private Mono<Response<BinaryData>> inferPatientTimelineWithResponseAsync(BinaryData patientTimelineData,
        ...
        return FluxUtil.withContext(context -> service.inferPatientTimeline(this.getEndpoint(),
            this.getServiceVersion().getVersion(), accept, patientTimelineData, requestOptionsLocal, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Response<BinaryData> inferPatientTimelineWithResponse(BinaryData patientTimelineData,
        RequestOptions requestOptions) {
        final String accept = "application/json";
        RequestOptions requestOptionsLocal = requestOptions == null ? new RequestOptions() : requestOptions;
        String repeatabilityRequestId = UUID.randomUUID().toString();
        ...
        return service.inferPatientTimelineSync(this.getEndpoint(), this.getServiceVersion().getVersion(), accept,
            patientTimelineData, requestOptionsLocal, Context.NONE);
    }
    ...
    public PollerFlux<BinaryData, BinaryData> beginInferPatientTimelineAsync(BinaryData patientTimelineData,
        RequestOptions requestOptions) {
        return PollerFlux.create(Duration.ofSeconds(1),
            () -> this.inferPatientTimelineWithResponseAsync(patientTimelineData, requestOptions),
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<BinaryData, BinaryData> beginInferPatientTimeline(BinaryData patientTimelineData,
        RequestOptions requestOptions) {
        return SyncPoller.createPoller(Duration.ofSeconds(1),
            () -> this.inferPatientTimelineWithResponse(patientTimelineData, requestOptions),
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public PollerFlux<PollOperationDetails, PatientTimelineInferenceResult>
        beginInferPatientTimelineWithModelAsync(BinaryData patientTimelineData, RequestOptions requestOptions) {
        return PollerFlux.create(Duration.ofSeconds(1),
            () -> this.inferPatientTimelineWithResponseAsync(patientTimelineData, requestOptions),
            new com.azure.core.experimental.util.polling.OperationLocationPollingStrategy<>(
                new PollingStrategyOptions(this.getHttpPipeline())
            ...
            TypeReference.createInstance(PatientTimelineInferenceResult.class));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollOperationDetails, PatientTimelineInferenceResult>
        beginInferPatientTimelineWithModel(BinaryData patientTimelineData, RequestOptions requestOptions) {
        return SyncPoller.createPoller(Duration.ofSeconds(1),
            () -> this.inferPatientTimelineWithResponse(patientTimelineData, requestOptions),
            new com.azure.core.experimental.util.polling.SyncOperationLocationPollingStrategy<>(
                new PollingStrategyOptions(this.getHttpPipeline())
