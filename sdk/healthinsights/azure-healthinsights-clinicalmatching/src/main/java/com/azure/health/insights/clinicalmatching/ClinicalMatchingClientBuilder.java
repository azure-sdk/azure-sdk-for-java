...
public final class ClinicalMatchingClientBuilder
    ...
    KeyCredentialTrait<ClinicalMatchingClientBuilder>, EndpointTrait<ClinicalMatchingClientBuilder> {
    @Generated
    ...
    @Generated
    @Override
    public ClinicalMatchingClientBuilder credential(KeyCredential keyCredential) {
    ...
    public ClinicalMatchingClient buildClient() {
        return new ClinicalMatchingClient(buildInnerClient());
    }

    private static final ClientLogger LOGGER = new ClientLogger(ClinicalMatchingClientBuilder.class);
}
