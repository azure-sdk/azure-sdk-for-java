...
public final class WidgetsImpl {
    ...
    public interface WidgetsService {
        ...
        Mono<Response<BinaryData>> getWidgetSecure(@HostParam("endpoint") String endpoint,
        ...
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        @UnexpectedResponseExceptionType(HttpResponseException.class)
        Response<BinaryData> getWidgetSecureSync(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("widgetName") String widgetName,
            @HeaderParam("Accept") String accept, RequestOptions requestOptions, Context context);
    ...
    public Mono<Response<BinaryData>> getWidgetSecureWithResponseAsync(String widgetName,
        RequestOptions requestOptions) {
        final String accept = "application/json";
        return FluxUtil.withContext(context -> service.getWidgetSecure(this.client.getEndpoint(),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<BinaryData> getWidgetSecureWithResponse(String widgetName, RequestOptions requestOptions) {
        final String accept = "application/json";
        return service.getWidgetSecureSync(this.client.getEndpoint(), this.client.getServiceVersion().getVersion(),
