...
public final class WidgetManagerAsyncClient {
    ...
    public Mono<Response<BinaryData>> getWidgetSecureWithResponse(String widgetName, RequestOptions requestOptions) {
        return this.serviceClient.getWidgetSecureWithResponseAsync(widgetName, requestOptions);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<WidgetSuite> getWidgetSecure(String widgetName) {
        // Generated convenience method for getWidgetSecureWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getWidgetSecureWithResponse(widgetName, requestOptions).flatMap(FluxUtil::toMono)
