...
public final class WidgetManagerAsyncClient {
    ...
    public Mono<Response<BinaryData>> getWidget2WithResponse(String widgetName, RequestOptions requestOptions) {
        return this.serviceClient.getWidget2WithResponseAsync(widgetName, requestOptions);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Widget> getWidget2(String widgetName) {
        // Generated convenience method for getWidget2WithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getWidget2WithResponse(widgetName, requestOptions)
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public PollerFlux<PollResult, Void> beginDeleteWidget(String widgetName) {
