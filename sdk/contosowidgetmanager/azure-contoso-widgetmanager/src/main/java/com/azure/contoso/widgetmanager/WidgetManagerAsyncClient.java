...
public final class WidgetManagerAsyncClient {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public PollerFlux<BinaryData, Void> beginDeleteWidget2(String widgetName, RequestOptions requestOptions) {
        return this.serviceClient.beginDeleteWidget2Async(widgetName, requestOptions);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public PollerFlux<ResourceOperationStatusWidgetWidgetError, Void> beginDeleteWidget2(String widgetName) {
        // Generated convenience method for beginDeleteWidget2WithModel
        RequestOptions requestOptions = new RequestOptions();
        return serviceClient.beginDeleteWidget2WithModelAsync(widgetName, requestOptions);
    }
