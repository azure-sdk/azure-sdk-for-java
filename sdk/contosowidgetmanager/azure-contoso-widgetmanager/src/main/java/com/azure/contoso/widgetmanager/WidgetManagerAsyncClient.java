...
public final class WidgetManagerAsyncClient {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<ResourceOperationStatusWidgetSuiteWidgetSuiteError> getWidgetOperationStatus(
        ...
        return getWidgetOperationStatusWithResponse(widgetName, operationId, requestOptions)
                ...
                .map(
                        protocolMethodData ->
                                protocolMethodData.toObject(ResourceOperationStatusWidgetSuiteWidgetSuiteError.class));
    }
        ...
        return PagedFlux.create(
                () ->
                        (continuationToken, pageSize) -> {
                            ...
                            return flux.map(
                                    pagedResponse ->
                                            new PagedResponseBase<Void, WidgetSuite>(
