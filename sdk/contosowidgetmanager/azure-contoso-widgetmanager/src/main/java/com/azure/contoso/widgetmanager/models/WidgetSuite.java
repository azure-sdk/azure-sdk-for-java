...
public final class WidgetSuite implements JsonSerializable<WidgetSuite> {
    ...
    static {
        JsonMergePatchHelper.setWidgetSuiteAccessor((model, jsonMergePatchEnabled) -> {
    ...
    public static WidgetSuite fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            FakedSharedModel sharedModel = null;
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("name".equals(fieldName)) {
                    ...
                    sharedModel = FakedSharedModel.fromJson(reader);
                } else {
                    reader.skipChildren();
                }
            }
            WidgetSuite deserializedWidgetSuite = new WidgetSuite();
            deserializedWidgetSuite.name = name;
            deserializedWidgetSuite.manufacturerId = manufacturerId;
            deserializedWidgetSuite.sharedModel = sharedModel;
