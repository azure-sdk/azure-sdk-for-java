...
public final class WidgetManagerClientImpl {
    ...
    public interface WidgetManagerClientService {
        ...
        Mono<Response<BinaryData>> getWidget2(
    ...
    public Mono<Response<BinaryData>> getWidget2WithResponseAsync(String widgetName, RequestOptions requestOptions) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<BinaryData> getWidget2WithResponse(String widgetName, RequestOptions requestOptions) {
        return getWidget2WithResponseAsync(widgetName, requestOptions).block();
    }
