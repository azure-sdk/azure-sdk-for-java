...
public final class WidgetManagerClient {
    ...
    public Response<BinaryData> getWidget2WithResponse(String widgetName, RequestOptions requestOptions) {
        return this.client.getWidget2WithResponse(widgetName, requestOptions).block();
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Widget getWidget2(String widgetName) {
        // Generated convenience method for getWidget2WithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getWidget2WithResponse(widgetName, requestOptions).getValue().toObject(Widget.class);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult, Void> beginDeleteWidget(String widgetName) {
