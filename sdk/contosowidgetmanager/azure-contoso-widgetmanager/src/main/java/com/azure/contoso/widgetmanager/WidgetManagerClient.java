...
public final class WidgetManagerClient {
     ...
     */
    @Generated
    WidgetManagerClient(WidgetManagerClientImpl serviceClient) {
    ...
    public SyncPoller<BinaryData, BinaryData> beginCreateOrUpdateWidget(
        ...
        // Convenience API is not generated, as operation 'createOrUpdateWidget' is 'application/merge-patch+json'
