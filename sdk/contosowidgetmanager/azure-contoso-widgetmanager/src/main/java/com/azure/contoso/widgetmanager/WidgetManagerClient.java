...
public final class WidgetManagerClient {
    ...
    public SyncPoller<BinaryData, Void> beginDeleteWidget2(String widgetName, RequestOptions requestOptions) {
        return this.client.beginDeleteWidget2(widgetName, requestOptions).getSyncPoller();
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<ResourceOperationStatusWidgetWidgetError, Void> beginDeleteWidget2(String widgetName) {
        // Generated convenience method for beginDeleteWidget2WithModel
        RequestOptions requestOptions = new RequestOptions();
        return client.beginDeleteWidget2(widgetName).getSyncPoller();
    }
