...
public final class WidgetManagerClient {
    ...
    public Response<BinaryData> getWidgetSecureWithResponse(String widgetName, RequestOptions requestOptions) {
        return this.serviceClient.getWidgetSecureWithResponse(widgetName, requestOptions);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public WidgetSuite getWidgetSecure(String widgetName) {
        // Generated convenience method for getWidgetSecureWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getWidgetSecureWithResponse(widgetName, requestOptions).getValue().toObject(WidgetSuite.class);
    }
