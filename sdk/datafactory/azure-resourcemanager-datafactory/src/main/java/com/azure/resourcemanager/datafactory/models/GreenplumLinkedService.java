...
public final class GreenplumLinkedService extends LinkedService {
    ...
    public AzureKeyVaultSecretReference pwdV1() {
        return this.innerTypeProperties() == null ? null : this.innerTypeProperties().pwdV1();
    }
     ...
     * @return the GreenplumLinkedService object itself.
     */
    public GreenplumLinkedService withPwdV1(AzureKeyVaultSecretReference pwdV1) {
        if (this.innerTypeProperties() == null) {
            this.innerTypeProperties = new GreenplumLinkedServiceTypeProperties();
        }
        this.innerTypeProperties().withPwdV1(pwdV1);
        return this;
    }
