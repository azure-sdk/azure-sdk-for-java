...
public final class AzureSqlDatabaseLinkedService extends LinkedService {
     ...
     */
    public AzureSqlDatabaseLinkedService withAuthenticationType(AzureSqlDatabaseAuthenticationType authenticationType) {
    ...
    /**
     * Get the username property: The user name to be used when connecting to server. Type: string.
     * 
    ...
    /**
     * Set the username property: The user name to be used when connecting to server. Type: string.
     * 
     * @param username the username value to set.
     * @return the AzureSqlDatabaseLinkedService object itself.
     */
    public AzureSqlDatabaseLinkedService withUsername(Object username) {
        if (this.innerTypeProperties() == null) {
            this.innerTypeProperties = new AzureSqlDatabaseLinkedServiceTypeProperties();
        }
     ...
     * @return the AzureSqlDatabaseLinkedService object itself.
     */
    public AzureSqlDatabaseLinkedService withServicePrincipalCredentialType(Object servicePrincipalCredentialType) {
        if (this.innerTypeProperties() == null) {
            this.innerTypeProperties = new AzureSqlDatabaseLinkedServiceTypeProperties();
        }
     ...
     * @return the AzureSqlDatabaseLinkedService object itself.
     */
    public AzureSqlDatabaseLinkedService withServicePrincipalCredential(SecretBase servicePrincipalCredential) {
        if (this.innerTypeProperties() == null) {
            this.innerTypeProperties = new AzureSqlDatabaseLinkedServiceTypeProperties();
        }
    ...
    /**
     * Get the connectionString property: The connection string, used by legacy version. Type: string, SecureString or
    ...
    /**
     * Set the connectionString property: The connection string, used by legacy version. Type: string, SecureString or
     * AzureKeyVaultSecretReference. Type: string, SecureString or AzureKeyVaultSecretReference.
     * 
     ...
     * recommended version. Type: string.
     * 
     ...
     * @return the AzureSqlDatabaseLinkedService object itself.
     */
    public AzureSqlDatabaseLinkedService withServer(Object server) {
        if (this.innerTypeProperties() == null) {
            this.innerTypeProperties = new AzureSqlDatabaseLinkedServiceTypeProperties();
        }
    ...
    /**
     * Get the database property: The name of the database, used by recommended version. Type: string.
     * 
    ...
    /**
     * Set the database property: The name of the database, used by recommended version. Type: string.
     * 
     * @param database the database value to set.
     * @return the AzureSqlDatabaseLinkedService object itself.
     */
    public AzureSqlDatabaseLinkedService withDatabase(Object database) {
        if (this.innerTypeProperties() == null) {
            this.innerTypeProperties = new AzureSqlDatabaseLinkedServiceTypeProperties();
        }
     ...
     * server, used by recommended version. Type: string.
     * 
     ...
     * @return the AzureSqlDatabaseLinkedService object itself.
     */
    public AzureSqlDatabaseLinkedService withEncrypt(Object encrypt) {
        if (this.innerTypeProperties() == null) {
            this.innerTypeProperties = new AzureSqlDatabaseLinkedServiceTypeProperties();
        }
     ...
     * the certificate chain to validate trust, used by recommended version. Type: Boolean.
     * 
     ...
     * @return the AzureSqlDatabaseLinkedService object itself.
     */
    public AzureSqlDatabaseLinkedService withTrustServerCertificate(Object trustServerCertificate) {
        if (this.innerTypeProperties() == null) {
            this.innerTypeProperties = new AzureSqlDatabaseLinkedServiceTypeProperties();
        }
     ...
     * @return the AzureSqlDatabaseLinkedService object itself.
     */
    public AzureSqlDatabaseLinkedService withHostnameInCertificate(Object hostnameInCertificate) {
        if (this.innerTypeProperties() == null) {
            this.innerTypeProperties = new AzureSqlDatabaseLinkedServiceTypeProperties();
        }
     ...
     * @return the AzureSqlDatabaseLinkedService object itself.
     */
    public AzureSqlDatabaseLinkedService withApplicationIntent(Object applicationIntent) {
        if (this.innerTypeProperties() == null) {
            this.innerTypeProperties = new AzureSqlDatabaseLinkedServiceTypeProperties();
        }
     ...
     * terminating the attempt and generating an error, used by recommended version. Type: integer.
     * 
     ...
     * @return the AzureSqlDatabaseLinkedService object itself.
     */
    public AzureSqlDatabaseLinkedService withConnectTimeout(Object connectTimeout) {
        if (this.innerTypeProperties() == null) {
            this.innerTypeProperties = new AzureSqlDatabaseLinkedServiceTypeProperties();
        }
     ...
     * @return the AzureSqlDatabaseLinkedService object itself.
     */
    public AzureSqlDatabaseLinkedService withConnectRetryCount(Object connectRetryCount) {
        if (this.innerTypeProperties() == null) {
            this.innerTypeProperties = new AzureSqlDatabaseLinkedServiceTypeProperties();
        }
     ...
     * @return the AzureSqlDatabaseLinkedService object itself.
     */
    public AzureSqlDatabaseLinkedService withConnectRetryInterval(Object connectRetryInterval) {
        if (this.innerTypeProperties() == null) {
            this.innerTypeProperties = new AzureSqlDatabaseLinkedServiceTypeProperties();
        }
     ...
     * @return the AzureSqlDatabaseLinkedService object itself.
     */
    public AzureSqlDatabaseLinkedService withLoadBalanceTimeout(Object loadBalanceTimeout) {
        if (this.innerTypeProperties() == null) {
            this.innerTypeProperties = new AzureSqlDatabaseLinkedServiceTypeProperties();
        }
     ...
     * command and generating an error, used by recommended version. Type: integer.
     * 
     ...
     * @return the AzureSqlDatabaseLinkedService object itself.
     */
    public AzureSqlDatabaseLinkedService withCommandTimeout(Object commandTimeout) {
        if (this.innerTypeProperties() == null) {
            this.innerTypeProperties = new AzureSqlDatabaseLinkedServiceTypeProperties();
        }
     ...
     * recommended version. Type: Boolean.
     * 
     ...
     * @return the AzureSqlDatabaseLinkedService object itself.
     */
    public AzureSqlDatabaseLinkedService withIntegratedSecurity(Object integratedSecurity) {
        if (this.innerTypeProperties() == null) {
            this.innerTypeProperties = new AzureSqlDatabaseLinkedServiceTypeProperties();
        }
     ...
     * is down, used by recommended version. Type: string.
     * 
     ...
     * @return the AzureSqlDatabaseLinkedService object itself.
     */
    public AzureSqlDatabaseLinkedService withFailoverPartner(Object failoverPartner) {
        if (this.innerTypeProperties() == null) {
            this.innerTypeProperties = new AzureSqlDatabaseLinkedServiceTypeProperties();
        }
     ...
     * connection string, used by recommended version. Type: integer.
     * 
     ...
     * @return the AzureSqlDatabaseLinkedService object itself.
     */
    public AzureSqlDatabaseLinkedService withMaxPoolSize(Object maxPoolSize) {
        if (this.innerTypeProperties() == null) {
            this.innerTypeProperties = new AzureSqlDatabaseLinkedServiceTypeProperties();
        }
     ...
     * @return the AzureSqlDatabaseLinkedService object itself.
     */
    public AzureSqlDatabaseLinkedService withMinPoolSize(Object minPoolSize) {
        if (this.innerTypeProperties() == null) {
            this.innerTypeProperties = new AzureSqlDatabaseLinkedServiceTypeProperties();
        }
     ...
     * any other batch on that connection, used by recommended version. Type: Boolean.
     * 
     ...
     * @return the AzureSqlDatabaseLinkedService object itself.
     */
    public AzureSqlDatabaseLinkedService withMultipleActiveResultSets(Object multipleActiveResultSets) {
        if (this.innerTypeProperties() == null) {
            this.innerTypeProperties = new AzureSqlDatabaseLinkedServiceTypeProperties();
        }
    ...
    /**
     * Get the multiSubnetFailover property: If your application is connecting to an AlwaysOn availability group (AG)
     * on different subnets, setting MultiSubnetFailover=true provides faster detection of and connection to the
     * (currently) active server, used by recommended version. Type: Boolean.
     * 
    ...
    /**
     * Set the multiSubnetFailover property: If your application is connecting to an AlwaysOn availability group (AG)
     * on different subnets, setting MultiSubnetFailover=true provides faster detection of and connection to the
     * (currently) active server, used by recommended version. Type: Boolean.
     * 
     ...
     * @return the AzureSqlDatabaseLinkedService object itself.
     */
    public AzureSqlDatabaseLinkedService withMultiSubnetFailover(Object multiSubnetFailover) {
        if (this.innerTypeProperties() == null) {
            this.innerTypeProperties = new AzureSqlDatabaseLinkedServiceTypeProperties();
        }
     ...
     * server, used by recommended version. Type: integer.
     * 
     ...
     * @return the AzureSqlDatabaseLinkedService object itself.
     */
    public AzureSqlDatabaseLinkedService withPacketSize(Object packetSize) {
        if (this.innerTypeProperties() == null) {
            this.innerTypeProperties = new AzureSqlDatabaseLinkedServiceTypeProperties();
        }
    ...
    /**
     * Get the pooling property: Indicate whether the connection will be pooled or explicitly opened every time that
     * the connection is requested, used by recommended version. Type: Boolean.
     * 
    ...
    /**
     * Set the pooling property: Indicate whether the connection will be pooled or explicitly opened every time that
     * the connection is requested, used by recommended version. Type: Boolean.
     * 
     * @param pooling the pooling value to set.
     * @return the AzureSqlDatabaseLinkedService object itself.
     */
    public AzureSqlDatabaseLinkedService withPooling(Object pooling) {
        if (this.innerTypeProperties() == null) {
            this.innerTypeProperties = new AzureSqlDatabaseLinkedServiceTypeProperties();
        }
