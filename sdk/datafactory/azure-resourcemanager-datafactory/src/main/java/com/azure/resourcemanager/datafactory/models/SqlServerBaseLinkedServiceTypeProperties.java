...
public class SqlServerBaseLinkedServiceTypeProperties {
    /*
     * The connection string, used by legacy version. Type: string, SecureString or AzureKeyVaultSecretReference. Type:
    ...
    /*
     * The name or network address of the instance of SQL Server to which to connect, used by recommended version.
     * Type: string.
     */
    ...
    /*
     * The name of the database, used by recommended version. Type: string.
     */
     ...
     * used by recommended version. Type: Boolean.
     */
     ...
     * name from the Data Source is used for certificate validation, used by recommended version. Type: string.
     */
     ...
     * ReadOnly and ReadWrite. Type: string.
     */
     ...
     * generating an error, used by recommended version. Type: integer.
     */
     ...
     * recommended version. This must be an integer between 0 and 255. Type: integer.
     */
     ...
     * connection failure, used by recommended version. This must be an integer between 1 and 60. Type: integer.
     */
     ...
     * recommended version. Type: integer.
     */
     ...
     * used by recommended version. Type: integer.
     */
    @JsonProperty(value = "commandTimeout")
    private Object commandTimeout;

    /*
     * Indicate whether User ID and Password are specified in the connection (when false) or whether the current
     * Windows account credentials are used for authentication (when true), used by recommended version. Type: Boolean.
     */
     ...
     * by recommended version. Type: Boolean.
     */
     ...
     */
    public SqlServerBaseLinkedServiceTypeProperties withConnectionString(Object connectionString) {
