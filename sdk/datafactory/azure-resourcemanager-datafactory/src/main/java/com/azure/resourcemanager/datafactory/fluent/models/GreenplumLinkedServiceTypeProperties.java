...
public final class GreenplumLinkedServiceTypeProperties
     ...
     */
    private AzureKeyVaultSecretReference pwdV1;
    ...
    /**
     * Get the pwdV1 property: The Azure key vault secret reference of password in connection string.
     * 
     * @return the pwdV1 value.
     */
    public AzureKeyVaultSecretReference pwdV1() {
        return this.pwdV1;
    }

    /**
     * Set the pwdV1 property: The Azure key vault secret reference of password in connection string.
     * 
     * @param pwdV1 the pwdV1 value to set.
     * @return the GreenplumLinkedServiceTypeProperties object itself.
     */
    public GreenplumLinkedServiceTypeProperties withPwdV1(AzureKeyVaultSecretReference pwdV1) {
        this.pwdV1 = pwdV1;
        return this;
    }
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeJsonField("pwd", this.pwdV1);
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("connectionString".equals(fieldName)) {
                    ...
                    deserializedGreenplumLinkedServiceTypeProperties.pwdV1
