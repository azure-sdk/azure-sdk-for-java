...
public final class AzurePostgreSqlLinkedServiceTypeProperties
        ...
        if (server() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property server in model AzurePostgreSqlLinkedServiceTypeProperties"));
        }
        if (username() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property username in model AzurePostgreSqlLinkedServiceTypeProperties"));
        }
        if (database() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property database in model AzurePostgreSqlLinkedServiceTypeProperties"));
        }
        if (sslMode() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property sslMode in model AzurePostgreSqlLinkedServiceTypeProperties"));
        }
        if (password() != null) {
            password().validate();
        }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(AzurePostgreSqlLinkedServiceTypeProperties.class);
