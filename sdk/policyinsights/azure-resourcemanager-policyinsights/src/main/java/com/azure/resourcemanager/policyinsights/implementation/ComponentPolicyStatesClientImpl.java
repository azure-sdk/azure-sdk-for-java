...
public final class ComponentPolicyStatesClientImpl implements ComponentPolicyStatesClient {
    ...
    private interface ComponentPolicyStatesService {
        @Headers({"Content-Type: application/json"})
        @Post(
            "/subscriptions/{subscriptionId}/providers/Microsoft.PolicyInsights/componentPolicyStates"
                + "/{componentPolicyStatesResource}/queryResults")
        ...
        @Post(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.PolicyInsights"
                + "/componentPolicyStates/{componentPolicyStatesResource}/queryResults")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        ...
        @Headers({"Content-Type: application/json"})
        @Post(
            "/{resourceId}/providers/Microsoft.PolicyInsights/componentPolicyStates/{componentPolicyStatesResource}"
                + "/queryResults")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        ...
        @Post(
            "/subscriptions/{subscriptionId}/providers/{authorizationNamespace}/policyDefinitions"
                + "/{policyDefinitionName}/providers/Microsoft.PolicyInsights/componentPolicyStates"
                + "/{componentPolicyStatesResource}/queryResults")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        ...
        @Post(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/{authorizationNamespace}"
                + "/policyAssignments/{policyAssignmentName}/providers/Microsoft.PolicyInsights/componentPolicyStates"
                + "/{componentPolicyStatesResource}/queryResults")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ComponentPolicyStatesQueryResultsInner> listQueryResultsForSubscriptionAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ComponentPolicyStatesQueryResultsInner> listQueryResultsForResourceGroupAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ComponentPolicyStatesQueryResultsInner> listQueryResultsForResourceAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ComponentPolicyStatesQueryResultsInner> listQueryResultsForResourceWithResponse(
        String resourceId,
        ComponentPolicyStatesResource componentPolicyStatesResource,
        Integer top,
        String orderBy,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ComponentPolicyStatesQueryResultsInner> listQueryResultsForPolicyDefinitionAsync(
        String subscriptionId,
        String policyDefinitionName,
        ComponentPolicyStatesResource componentPolicyStatesResource) {
        final Integer top = null;
