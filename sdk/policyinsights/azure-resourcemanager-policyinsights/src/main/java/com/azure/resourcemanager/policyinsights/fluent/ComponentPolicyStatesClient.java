...
public interface ComponentPolicyStatesClient {
    ...
    Response<ComponentPolicyStatesQueryResultsInner> listQueryResultsForSubscriptionWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<ComponentPolicyStatesQueryResultsInner> listQueryResultsForResourceGroupWithResponse(
        String subscriptionId,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<ComponentPolicyStatesQueryResultsInner> listQueryResultsForResourceWithResponse(
        String resourceId,
        ComponentPolicyStatesResource componentPolicyStatesResource,
        Integer top,
        String orderBy,
