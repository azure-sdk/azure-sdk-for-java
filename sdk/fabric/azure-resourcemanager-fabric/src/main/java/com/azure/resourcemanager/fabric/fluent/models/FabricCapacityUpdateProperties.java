...
public final class FabricCapacityUpdateProperties implements JsonSerializable<FabricCapacityUpdateProperties> {
     ...
     */
    private CapacityAdministrationUpdate administration;
     ...
     */
    public FabricCapacityUpdateProperties withAdministration(CapacityAdministrationUpdate administration) {
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("administration".equals(fieldName)) {
                    deserializedFabricCapacityUpdateProperties.administration
                        = CapacityAdministrationUpdate.fromJson(reader);
                } else {
                    reader.skipChildren();
                }
            }
