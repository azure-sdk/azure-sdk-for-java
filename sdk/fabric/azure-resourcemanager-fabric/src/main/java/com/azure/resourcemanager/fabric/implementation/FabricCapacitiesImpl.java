...
public final class FabricCapacitiesImpl implements FabricCapacities {
    ...
    public Response<Void> deleteByResourceGroupWithResponse(String resourceGroupName, String capacityName,
        Context context) {
        return this.serviceClient().deleteWithResponse(resourceGroupName, capacityName, context);
    }
    ...
    public void deleteById(String id) {
        ...
        this.deleteByResourceGroupWithResponse(resourceGroupName, capacityName, Context.NONE);
    }
    ...
    public Response<Void> deleteByIdWithResponse(String id, Context context) {
        ...
        return this.deleteByResourceGroupWithResponse(resourceGroupName, capacityName, context);
    }
