...
public final class FabricCapacitiesClientImpl implements FabricCapacitiesClient {
     ...
     */
    private final MicrosoftFabricManagementServiceImpl client;
     ...
     */
    FabricCapacitiesClientImpl(MicrosoftFabricManagementServiceImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for MicrosoftFabricManagementServiceFabricCapacities to be used by the
     * proxy service to perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "MicrosoftFabricManag")
    public interface FabricCapacitiesService {
        ...
        Mono<Response<FabricCapacityListResult>> list(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<RpSkuEnumerationForNewResourceResult>> listSkus(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<FabricCapacityListResult>> listByResourceGroup(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<FabricCapacityInner>> getByResourceGroup(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
        ...
        Mono<Response<Flux<ByteBuffer>>> createOrUpdate(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("capacityName") String capacityName,
            @BodyParam("application/json") FabricCapacityInner resource, @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<FabricCapacityInner>> update(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("capacityName") String capacityName,
            @BodyParam("application/json") FabricCapacityUpdate properties, @HeaderParam("Accept") String accept,
            Context context);
    ...
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(context -> service.createOrUpdate(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, capacityName, resource, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<FabricCapacityInner>> updateWithResponseAsync(String resourceGroupName, String capacityName,
        ...
        return FluxUtil
            .withContext(context -> service.update(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, capacityName, properties, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<FabricCapacityInner>> updateWithResponseAsync(String resourceGroupName, String capacityName,
        ...
        return service.update(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, capacityName, properties, accept, context);
    }
    ...
    private Mono<FabricCapacityInner> updateAsync(String resourceGroupName, String capacityName,
        FabricCapacityUpdate properties) {
        return updateWithResponseAsync(resourceGroupName, capacityName, properties)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<FabricCapacityInner> updateWithResponse(String resourceGroupName, String capacityName,
        FabricCapacityUpdate properties, Context context) {
        return updateWithResponseAsync(resourceGroupName, capacityName, properties, context).block();
    }
    ...
    public FabricCapacityInner update(String resourceGroupName, String capacityName, FabricCapacityUpdate properties) {
        return updateWithResponse(resourceGroupName, capacityName, properties, Context.NONE).getValue();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Void>> deleteWithResponseAsync(String resourceGroupName, String capacityName) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String capacityName) {
        return deleteWithResponseAsync(resourceGroupName, capacityName).flatMap(ignored -> Mono.empty());
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<Void> deleteWithResponse(String resourceGroupName, String capacityName, Context context) {
        return deleteWithResponseAsync(resourceGroupName, capacityName, context).block();
    }
    ...
    public void delete(String resourceGroupName, String capacityName) {
        deleteWithResponse(resourceGroupName, capacityName, Context.NONE);
    }
