...
public final class FabricCapacityImpl implements FabricCapacity, FabricCapacity.Definition, FabricCapacity.Update {
    ...
    public FabricCapacity apply() {
        this.innerObject = serviceManager.serviceClient()
            .getFabricCapacities()
            .updateWithResponse(resourceGroupName, capacityName, updateProperties, Context.NONE)
            .getValue();
        return this;
    }
    ...
    public FabricCapacity apply(Context context) {
        this.innerObject = serviceManager.serviceClient()
            .getFabricCapacities()
            .updateWithResponse(resourceGroupName, capacityName, updateProperties, context)
            .getValue();
        return this;
    }
    ...
    public FabricCapacityImpl withSku(RpSkuUpdate sku) {
        this.updateProperties.withSku(sku);
        return this;
    }

    public FabricCapacityImpl withAdministration(CapacityAdministrationUpdate administration) {
