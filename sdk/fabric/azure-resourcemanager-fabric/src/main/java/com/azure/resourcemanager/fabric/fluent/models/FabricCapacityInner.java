    ...
    public void validate() {
        if (properties() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Missing required property properties in model FabricCapacityInner"));
        } else {
            properties().validate();
        }
        if (sku() == null) {
        ...
        if (location() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Missing required property location in model FabricCapacityInner"));
        }
    }
