...
public interface FabricCapacitiesClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<FabricCapacityInner> updateWithResponse(String resourceGroupName, String capacityName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<Void> deleteWithResponse(String resourceGroupName, String capacityName, Context context);
