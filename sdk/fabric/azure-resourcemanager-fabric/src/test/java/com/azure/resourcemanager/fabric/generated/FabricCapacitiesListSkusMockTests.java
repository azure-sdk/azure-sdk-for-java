...
public final class FabricCapacitiesListSkusMockTests {
    ...
    public void testListSkus() throws Exception {
        String responseStr
            = "{\"value\":[{\"resourceType\":\"bqqwxrj\",\"name\":\"eallnwsubisnj\",\"locations\":[\"pmng\",\"zscxaqwo\",\"chcbonqvpkvlrxnj\",\"ase\"]}]}";
        ...
        Assertions.assertEquals("bqqwxrj", response.iterator().next().resourceType());
        Assertions.assertEquals("eallnwsubisnj", response.iterator().next().name());
        Assertions.assertEquals("pmng", response.iterator().next().locations().get(0));
    }
}
