...
public final class AvailableClusterPoolVersionsClientImpl implements AvailableClusterPoolVersionsClient {
    ...
    public interface AvailableClusterPoolVersionsService {
        ...
        Mono<Response<ClusterPoolVersionsListResult>> listByLocation(
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ClusterPoolVersionsListResult>> listByLocationNext(
    ...
    private Mono<PagedResponse<ClusterPoolVersionInner>> listByLocationSinglePageAsync(String location) {
                ...
                context ->
                    service
                        .listByLocation(
                            ...
                            accept,
                            context))
            .<PagedResponse<ClusterPoolVersionInner>>map(
                res ->
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<ClusterPoolVersionInner>> listByLocationSinglePageAsync(
    ...
    private PagedFlux<ClusterPoolVersionInner> listByLocationAsync(String location) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<ClusterPoolVersionInner> listByLocationAsync(String location, Context context) {
        return new PagedFlux<>(
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<ClusterPoolVersionInner> listByLocation(String location) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<ClusterPoolVersionInner> listByLocation(String location, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<ClusterPoolVersionInner>> listByLocationNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<ClusterPoolVersionInner>> listByLocationNextSinglePageAsync(
