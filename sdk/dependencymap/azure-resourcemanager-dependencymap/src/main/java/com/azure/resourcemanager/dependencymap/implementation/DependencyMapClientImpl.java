...
/**
 * Initializes a new instance of the DependencyMapClientImpl type.
 */
@ServiceClient(builder = DependencyMapClientBuilder.class)
public final class DependencyMapClientImpl implements DependencyMapClient {
    /**
     * Service host.
     */
    ...
    /**
     * Initializes an instance of DependencyMapClient client.
     * 
     ...
     */
    DependencyMapClientImpl(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter,
    ...
    private static final ClientLogger LOGGER = new ClientLogger(DependencyMapClientImpl.class);
}
