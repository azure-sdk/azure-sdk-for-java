...
public final class DiscoverySourcesClientImpl implements DiscoverySourcesClient {
     ...
     */
    DiscoverySourcesClientImpl(DependencyMapClientImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for DependencyMapClientDiscoverySources to be used by the proxy service
     * to perform REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "DependencyMapClientD")
