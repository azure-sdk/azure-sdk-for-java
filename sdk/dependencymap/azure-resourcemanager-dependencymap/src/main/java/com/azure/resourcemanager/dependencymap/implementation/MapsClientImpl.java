...
public final class MapsClientImpl implements MapsClient {
     ...
     */
    MapsClientImpl(DependencyMapClientImpl client) {
        this.service = RestProxy.create(MapsService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for DependencyMapClientMaps to be used by the proxy service to perform
     * REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "DependencyMapClientM")
