...
import com.azure.resourcemanager.dependencymap.implementation.models.OperationListResult;
...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    private final DependencyMapClientImpl client;
     ...
     */
    OperationsClientImpl(DependencyMapClientImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for DependencyMapClientOperations to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "DependencyMapClientO")
    public interface OperationsService {
        @Headers({ "Content-Type: application/json" })
        @Get("/providers/Microsoft.DependencyMap/operations")
