...
public final class SuppressionListAddressesDeleteSamples {
    ...
    public static void
        ...
        manager.suppressionListAddresses().deleteWithResponse("MyResourceGroup", "MyEmailServiceResource",
            "mydomain.com", "aaaa1111-bbbb-2222-3333-aaaa11112222", "11112222-3333-4444-5555-999999999999",
            com.azure.core.util.Context.NONE);
    }
}
```
