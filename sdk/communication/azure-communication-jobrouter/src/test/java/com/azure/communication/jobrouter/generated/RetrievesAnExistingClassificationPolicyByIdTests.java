...
public final class RetrievesAnExistingClassificationPolicyByIdTests extends JobRouterAdministrationClientTestBase {
    ...
    public void testRetrievesAnExistingClassificationPolicyByIdTests() {
        ...
        Assertions.assertEquals("conditional", responseQueueSelectorAttachmentsFirstItem.getKind());
        ...
        Assertions.assertEquals("static", responsePrioritizationRule.getKind());
        ...
        Assertions.assertEquals("passThrough", responseWorkerSelectorAttachmentsFirstItem.getKind());
    }
}
