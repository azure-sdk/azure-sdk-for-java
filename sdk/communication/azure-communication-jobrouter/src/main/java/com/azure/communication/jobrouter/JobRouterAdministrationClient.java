...
public final class JobRouterAdministrationClient {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    ExceptionPolicyInternal getExceptionPolicy(String exceptionPolicyId) {
        ...
        return getExceptionPolicyWithResponse(exceptionPolicyId, requestOptions).getValue()
            .toObject(ExceptionPolicyInternal.class);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<ExceptionPolicyInternal> listExceptionPolicies() {
