...
import com.azure.communication.messages.implementation.models.CreateConversationRequest;
...
public final class ConversationAdministrationAsyncClient {
    ...
    public Mono<Response<BinaryData>> createConversationWithResponse(BinaryData createConversationRequest,
        RequestOptions requestOptions) {
        return this.serviceClient.createConversationWithResponseAsync(createConversationRequest, requestOptions);
    }
     ...
     * Creates a new conversation. This is only for create operation.
     * 
     * @param initialMessage An intial message within the conversation.
    ...
    public Mono<CommunicationConversation> createConversation(Message initialMessage) {
        ...
        CreateConversationRequest createConversationRequestObj
            = new CreateConversationRequest().setInitialMessage(initialMessage);
        BinaryData createConversationRequest = BinaryData.fromObject(createConversationRequestObj);
        return createConversationWithResponse(createConversationRequest, requestOptions).flatMap(FluxUtil::toMono)
    ...
    public Mono<CommunicationConversation> createConversation() {
        // Generated convenience method for createConversationWithResponse
        RequestOptions requestOptions = new RequestOptions();
        CreateConversationRequest createConversationRequestObj = new CreateConversationRequest();
        BinaryData createConversationRequest = BinaryData.fromObject(createConversationRequestObj);
        return createConversationWithResponse(createConversationRequest, requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(CommunicationConversation.class));
    }
