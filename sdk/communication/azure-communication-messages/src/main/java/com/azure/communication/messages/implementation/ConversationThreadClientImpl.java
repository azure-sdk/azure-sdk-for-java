...
import com.azure.communication.messages.ConversationThreadServiceVersion;
...
/**
 * Initializes a new instance of the ConversationThreadClient type.
 */
public final class ConversationThreadClientImpl {
    /**
     * The proxy service used to perform REST calls.
     */
    private final ConversationThreadClientService service;
     ...
     * Service version.
     */
    private final ConversationThreadServiceVersion serviceVersion;
     ...
     */
    public ConversationThreadServiceVersion getServiceVersion() {
    ...
    /**
     * Initializes an instance of ConversationThreadClient client.
     * 
     * @param endpoint The communication resource, for example https://my-resource.communication.azure.com.
     * @param serviceVersion Service version.
     */
    public ConversationThreadClientImpl(String endpoint, ConversationThreadServiceVersion serviceVersion) {
     ...
     * @param serviceVersion Service version.
     */
    public ConversationThreadClientImpl(HttpPipeline httpPipeline, String endpoint,
        ConversationThreadServiceVersion serviceVersion) {
     ...
     * @param serviceVersion Service version.
     */
    public ConversationThreadClientImpl(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter, String endpoint,
        ConversationThreadServiceVersion serviceVersion) {
        ...
        this.service
            = RestProxy.create(ConversationThreadClientService.class, this.httpPipeline, this.getSerializerAdapter());
    }

    /**
     * The interface defining all the services for ConversationThreadClient to be used by the proxy service to perform
     * REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "ConversationThreadCl")
    public interface ConversationThreadClientService {
        ...
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        @UnexpectedResponseExceptionType(HttpResponseException.class)
        Mono<Response<BinaryData>> sendMessage(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("conversationId") String conversationId,
            @HeaderParam("Content-Type") String contentType, @HeaderParam("Accept") String accept,
            @BodyParam("application/json") BinaryData options, RequestOptions requestOptions, Context context);
        ...
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        @UnexpectedResponseExceptionType(HttpResponseException.class)
        Response<BinaryData> sendMessageSync(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("conversationId") String conversationId,
            @HeaderParam("Content-Type") String contentType, @HeaderParam("Accept") String accept,
            @BodyParam("application/json") BinaryData options, RequestOptions requestOptions, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> sendMessageWithResponseAsync(String conversationId, BinaryData options,
        RequestOptions requestOptions) {
        final String contentType = "application/json";
        final String accept = "application/json";
        RequestOptions requestOptionsLocal = requestOptions == null ? new RequestOptions() : requestOptions;
        ...
        return FluxUtil
            .withContext(context -> service.sendMessage(this.getEndpoint(), this.getServiceVersion().getVersion(),
                conversationId, contentType, accept, options, requestOptionsLocal, context));
    }
    ...
    public Response<BinaryData> sendMessageWithResponse(String conversationId, BinaryData options,
        ...
        return service.sendMessageSync(this.getEndpoint(), this.getServiceVersion().getVersion(), conversationId,
            contentType, accept, options, requestOptionsLocal, Context.NONE);
    }
