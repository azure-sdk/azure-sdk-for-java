...
public final class ConversationAdministrationClient {
    ...
    public Response<BinaryData> createConversationWithResponse(BinaryData createConversationRequest,
        ...
        return this.serviceClient.createConversationWithResponse(createConversationRequest, requestOptions);
    }
    ...
    public CommunicationConversation createConversation(Message initialMessage) {
        ...
        return createConversationWithResponse(createConversationRequest, requestOptions).getValue()
