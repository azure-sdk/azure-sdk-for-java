...
public final class ManagedEnvironmentImpl
    ...
    ManagedEnvironmentImpl(String name, com.azure.resourcemanager.app.ContainerAppsApiManager serviceManager) {
    ...
    ManagedEnvironmentImpl(
        ManagedEnvironmentInner innerObject, com.azure.resourcemanager.app.ContainerAppsApiManager serviceManager) {
