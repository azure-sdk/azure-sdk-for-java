...
public final class ManagedEnvironmentsDiagnosticsImpl implements ManagedEnvironmentsDiagnostics {
    ...
    public ManagedEnvironment getRoot(String resourceGroupName, String name) {
        ManagedEnvironmentInner inner = this.serviceClient().getRoot(resourceGroupName, name);
        if (inner != null) {
    ...
    public Response<ManagedEnvironment> getRootWithResponse(String resourceGroupName, String name, Context context) {
        Response<ManagedEnvironmentInner> inner =
            this.serviceClient().getRootWithResponse(resourceGroupName, name, context);
        if (inner != null) {
