...
import com.azure.resourcemanager.app.fluent.ManagedEnvironmentDiagnosticsClient;
...
public final class ManagedEnvironmentDiagnosticsClientImpl implements ManagedEnvironmentDiagnosticsClient {
    ...
    private interface ManagedEnvironmentDiagnosticsService {
        ...
        @Get(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.App"
                + "/managedEnvironments/{name}/detectors")
        ...
        @Get(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.App"
                + "/managedEnvironments/{name}/detectors/{detectorName}")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(DefaultErrorResponseErrorException.class)
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DiagnosticsCollectionInner> listDetectorsAsync(String resourceGroupName, String name) {
        return listDetectorsWithResponseAsync(resourceGroupName, name)
            .flatMap(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public DiagnosticsCollectionInner listDetectors(String resourceGroupName, String name) {
        return listDetectorsAsync(resourceGroupName, name).block();
    }
    ...
    public Response<DiagnosticsCollectionInner> listDetectorsWithResponse(
        String resourceGroupName, String name, Context context) {
        return listDetectorsWithResponseAsync(resourceGroupName, name, context).block();
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<DiagnosticsInner>> getDetectorWithResponseAsync(
        String resourceGroupName, String name, String detectorName, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DiagnosticsInner> getDetectorAsync(String resourceGroupName, String name, String detectorName) {
        return getDetectorWithResponseAsync(resourceGroupName, name, detectorName)
            .flatMap(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public DiagnosticsInner getDetector(String resourceGroupName, String name, String detectorName) {
        return getDetectorAsync(resourceGroupName, name, detectorName).block();
    }
    ...
    public Response<DiagnosticsInner> getDetectorWithResponse(
        String resourceGroupName, String name, String detectorName, Context context) {
        return getDetectorWithResponseAsync(resourceGroupName, name, detectorName, context).block();
    }
}
