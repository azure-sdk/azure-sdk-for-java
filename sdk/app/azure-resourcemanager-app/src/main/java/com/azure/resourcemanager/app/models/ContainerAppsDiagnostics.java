...
public interface ContainerAppsDiagnostics {
     ...
     */
    Diagnostics getDetector(String resourceGroupName, String containerAppName, String name);
     ...
     */
    ContainerApp getRoot(String resourceGroupName, String name);
     ...
     */
    Response<ContainerApp> getRootWithResponse(String resourceGroupName, String name, Context context);
}
