...
import com.azure.resourcemanager.app.models.ContainerAppsDiagnostics;
import com.azure.resourcemanager.app.models.Diagnostics;
import com.azure.resourcemanager.app.models.Revision;
...
public final class ContainerAppsDiagnosticsImpl implements ContainerAppsDiagnostics {
    ...
    public Diagnostics getDetector(String resourceGroupName, String containerAppName, String name) {
        DiagnosticsInner inner = this.serviceClient().getDetector(resourceGroupName, containerAppName, name);
        if (inner != null) {
    ...
    public Response<Diagnostics> getDetectorWithResponse(
        ...
        Response<DiagnosticsInner> inner =
            this.serviceClient().getDetectorWithResponse(resourceGroupName, containerAppName, name, context);
        if (inner != null) {
    ...
    public ContainerApp getRoot(String resourceGroupName, String name) {
        ContainerAppInner inner = this.serviceClient().getRoot(resourceGroupName, name);
        if (inner != null) {
    ...
    public Response<ContainerApp> getRootWithResponse(String resourceGroupName, String name, Context context) {
        Response<ContainerAppInner> inner = this.serviceClient().getRootWithResponse(resourceGroupName, name, context);
        if (inner != null) {
            return new SimpleResponse<>(
                inner.getRequest(),
                inner.getStatusCode(),
