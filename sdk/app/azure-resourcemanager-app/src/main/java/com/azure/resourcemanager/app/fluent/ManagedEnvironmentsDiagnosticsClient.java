...
public interface ManagedEnvironmentsDiagnosticsClient {
    ...
    ManagedEnvironmentInner getRoot(String resourceGroupName, String name);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<ManagedEnvironmentInner> getRootWithResponse(String resourceGroupName, String name, Context context);
}
