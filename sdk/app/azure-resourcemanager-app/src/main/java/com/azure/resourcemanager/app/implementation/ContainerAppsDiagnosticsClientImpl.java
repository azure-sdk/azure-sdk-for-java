...
import com.azure.resourcemanager.app.fluent.ContainerAppsDiagnosticsClient;
...
public final class ContainerAppsDiagnosticsClientImpl implements ContainerAppsDiagnosticsClient {
    ...
    private interface ContainerAppsDiagnosticsService {
        ...
        @Get(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.App/containerApps"
                + "/{containerAppName}/detectors/{name}")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(DefaultErrorResponseErrorException.class)
        ...
        @Get(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.App/containerApps"
                + "/{containerAppName}/detectorproperties/revisionsApi/revisions/{name}")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(DefaultErrorResponseErrorException.class)
        ...
        @Get(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.App/containerApps"
                + "/{name}/detectorproperties/rootApi/")
        @ExpectedResponses({200})
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DiagnosticsInner> getDetectorAsync(String resourceGroupName, String containerAppName, String name) {
        return getDetectorWithResponseAsync(resourceGroupName, containerAppName, name)
            .flatMap(
                (Response<DiagnosticsInner> res) -> {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public DiagnosticsInner getDetector(String resourceGroupName, String containerAppName, String name) {
        return getDetectorAsync(resourceGroupName, containerAppName, name).block();
    }
    ...
    public Response<DiagnosticsInner> getDetectorWithResponse(
        String resourceGroupName, String containerAppName, String name, Context context) {
        return getDetectorWithResponseAsync(resourceGroupName, containerAppName, name, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ContainerAppInner>> getRootWithResponseAsync(String resourceGroupName, String name) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ContainerAppInner> getRootAsync(String resourceGroupName, String name) {
        return getRootWithResponseAsync(resourceGroupName, name)
            .flatMap(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ContainerAppInner getRoot(String resourceGroupName, String name) {
        return getRootAsync(resourceGroupName, name).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ContainerAppInner> getRootWithResponse(String resourceGroupName, String name, Context context) {
        return getRootWithResponseAsync(resourceGroupName, name, context).block();
    }
