...
@ServiceClient(builder = RuntimeRegistrationClientBuilder.class)
public final class RuntimeRegistrationClient {
    @Generated private final RuntimeRegistrationAsyncClient client;

    /**
     * Initializes an instance of RuntimeRegistrationClient class.
     *
     * @param client the async client.
     */
    @Generated
    RuntimeRegistrationClient(RuntimeRegistrationAsyncClient client) {
        this.client = client;
    }
    ...
    public Response<BinaryData> deviceRegistrationStatusLookupWithResponse(
        ...
        return this.client
                .deviceRegistrationStatusLookupWithResponse(idScope, registrationId, deviceRegistration, requestOptions)
                .block();
    }
    ...
    public SyncPoller<BinaryData, BinaryData> beginRegisterDevice(
            String idScope, String registrationId, BinaryData deviceRegistration, RequestOptions requestOptions) {
        return this.client
                .beginRegisterDevice(idScope, registrationId, deviceRegistration, requestOptions)
                .getSyncPoller();
    }
}
