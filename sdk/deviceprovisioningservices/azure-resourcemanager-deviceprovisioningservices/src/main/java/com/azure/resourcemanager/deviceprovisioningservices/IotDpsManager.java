...
public final class IotDpsManager {
    ...
    private IotDpsManager(HttpPipeline httpPipeline, AzureProfile profile, Duration defaultPollInterval) {
        ...
        this.clientObject = new IotDpsClientBuilder().pipeline(httpPipeline)
    ...
    public static IotDpsManager authenticate(HttpPipeline httpPipeline, AzureProfile profile) {
        Objects.requireNonNull(httpPipeline, "'httpPipeline' cannot be null.");
        Objects.requireNonNull(profile, "'profile' cannot be null.");
        return new IotDpsManager(httpPipeline, profile, null);
    }
    ...
    /**
     * Gets wrapped service client IotDpsClient providing direct access to the underlying auto-generated API
     * implementation, based on Azure REST API.
     * 
     * @return Wrapped service client IotDpsClient.
     */
