...
public final class CertificateResponseInner extends ProxyResource {
     ...
     * @return An instance of CertificateResponseInner if the JsonReader was pointing to an instance of it, or null if
     * it was pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the CertificateResponseInner.
     */
    public static CertificateResponseInner fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            CertificateResponseInner deserializedCertificateResponseInner = new CertificateResponseInner();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("id".equals(fieldName)) {
                    deserializedCertificateResponseInner.id = reader.getString();
                } else if ("name".equals(fieldName)) {
                    deserializedCertificateResponseInner.name = reader.getString();
                } else if ("type".equals(fieldName)) {
                    deserializedCertificateResponseInner.type = reader.getString();
                } else if ("properties".equals(fieldName)) {
                    deserializedCertificateResponseInner.properties = CertificateProperties.fromJson(reader);
                } else if ("etag".equals(fieldName)) {
                    deserializedCertificateResponseInner.etag = reader.getString();
                } else if ("systemData".equals(fieldName)) {
                    deserializedCertificateResponseInner.systemData = SystemData.fromJson(reader);
                } else {
                    reader.skipChildren();
                }
            }

            return deserializedCertificateResponseInner;
        });
    }
}
