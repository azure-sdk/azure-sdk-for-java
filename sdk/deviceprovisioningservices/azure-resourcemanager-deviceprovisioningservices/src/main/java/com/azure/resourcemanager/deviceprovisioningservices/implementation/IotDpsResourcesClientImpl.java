...
public final class IotDpsResourcesClientImpl implements IotDpsResourcesClient {
    ...
    public interface IotDpsResourcesService {
        ...
        Mono<Response<Void>> failover(
            ...
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("provisioningServiceName") String provisioningServiceName,
            @BodyParam("application/json") CustomerInitiatedFailoverInput dpsFailoverDescription,
            @HeaderParam("Accept") String accept,
            Context context);
    ...
    private Mono<Response<Void>> failoverWithResponseAsync(
        String resourceGroupName,
        String provisioningServiceName,
        CustomerInitiatedFailoverInput dpsFailoverDescription) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
        ...
        if (dpsFailoverDescription == null) {
            return Mono
                .error(
                    new IllegalArgumentException("Parameter dpsFailoverDescription is required and cannot be null."));
        } else {
    ...
    private Mono<Void> failoverAsync(
        ...
        String provisioningServiceName,
        CustomerInitiatedFailoverInput dpsFailoverDescription) {
        return failoverWithResponseAsync(resourceGroupName, provisioningServiceName, dpsFailoverDescription)
    ...
    public Response<Void> failoverWithResponse(
        ...
        CustomerInitiatedFailoverInput dpsFailoverDescription,
        Context context) {
        return failoverWithResponseAsync(resourceGroupName, provisioningServiceName, dpsFailoverDescription, context)
            .block();
    }
    ...
    public void failover(
        ...
        String provisioningServiceName,
        CustomerInitiatedFailoverInput dpsFailoverDescription) {
        failoverWithResponse(resourceGroupName, provisioningServiceName, dpsFailoverDescription, Context.NONE);
    }
