...
#### `models.VMwareToAzStackHciProtectedItemCustomProps` was removed
...
#### `models.HyperVToAzStackHciPlannedFailoverCustomProps` was removed

#### `models.WorkflowModelSystemData` was removed

#### `models.HyperVToAzStackHciProtectedItemCustomProps` was removed
...
#### `models.HyperVToAzStackHciRecoveryPointCustomProps` was removed
...
#### `models.VMwareToAzStackHciRepExtnCustomProps` was removed

#### `models.VMwareToAzStackHciPlannedFailoverCustomProps` was removed
...
#### `models.ReplicationExtensionModel` was modified

* `models.ReplicationExtensionModelSystemData systemData()` -> `com.azure.core.management.SystemData systemData()`
...
* `fluent.DataReplicationMgmtClient serviceClient()` -> `fluent.DataReplicationClient serviceClient()`
...
* `models.PrivateEndpointConnectionProxies` was added
...
* `models.JobModelCustomProperties` was added

* `models.PrivateLinkServiceConnectionState` was added

* `models.VMwareToAzStackHCIProtectedItemModelCustomProperties` was added
...
* `models.VMwareToAzStackHCIReplicationExtensionModelCustomProperties` was added
...
* `models.HyperVToAzStackHCIProtectedItemModelCustomProperties` was added

* `models.FabricAgentModel$Definition` was added

* `models.VMwareFabricAgentModelCustomProperties` was added

* `models.JobModelCustomPropertiesAffectedObjectDetailsType` was added
...
* `models.HyperVToAzStackHCIPlannedFailoverModelCustomProperties` was added
...
* `implementation.models.ReplicationExtensionModelListResult` was added
...
* `models.VMwareToAzStackHCIRecoveryPointModelCustomProperties` was added
...
* `models.LocationBasedOperationResults` was added
...
* `implementation.models.PrivateEndpointConnectionProxyListResult` was added

* `models.HyperVToAzStackHCIProtectedItemModelCustomPropertiesUpdate` was added
...
* `models.HyperVToAzStackHCIReplicationExtensionModelCustomProperties` was added
...
* `models.VMwareToAzStackHCIPlannedFailoverModelCustomProperties` was added

* `models.VMwareToAzStackHCIProtectedItemModelCustomPropertiesUpdate` was added
...
* `models.HyperVToAzStackHCIRecoveryPointModelCustomProperties` was added
...
* `privateEndpointConnectionProxies()` was added
* `locationBasedOperationResults()` was added
