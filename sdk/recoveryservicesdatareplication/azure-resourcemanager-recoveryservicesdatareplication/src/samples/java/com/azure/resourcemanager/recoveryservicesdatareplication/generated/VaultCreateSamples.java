...
public final class VaultCreateSamples {
    ...
    public static void vaultCreate(
        ...
        manager.vaults().define("4").withRegion("eck").withExistingResourceGroup("rgrecoveryservicesdatareplication")
            .withTags(mapOf("key5359", "fakeTokenPlaceholder"))
            .withProperties(new VaultModelProperties().withVaultType(ReplicationVaultType.DISASTER_RECOVERY)).create();
    }
