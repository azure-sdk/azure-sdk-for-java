...
public final class EmailConfigurationCreateSamples {
    ...
    public static void emailConfigurationCreate(
        ...
        manager.emailConfigurations().define("0").withExistingReplicationVault("rgrecoveryservicesdatareplication", "4")
            .withProperties(new EmailConfigurationModelProperties().withSendToOwners(true)
                .withCustomEmailAddresses(Arrays.asList("ketvbducyailcny")).withLocale("vpnjxjvdqtebnucyxiyrjiko"))
            .create();
    }
}
