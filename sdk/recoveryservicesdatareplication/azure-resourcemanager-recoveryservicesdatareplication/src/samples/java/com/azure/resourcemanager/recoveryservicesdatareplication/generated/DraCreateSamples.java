...
public final class DraCreateSamples {
    ...
    public static void draCreate(
        ...
        manager.dras().define("M").withExistingReplicationFabric("rgrecoveryservicesdatareplication", "wPR")
            .withProperties(new DraModelProperties().withMachineId("envzcoijbqhtrpncbjbhk").withMachineName("y")
                .withAuthenticationIdentity(new IdentityModel().withTenantId("joclkkdovixwapephhxaqtefubhhmq")
                    .withApplicationId("cwktzrwajuvfyyymfstpey").withObjectId("khsiaqfbpuhp")
                    .withAudience("dkjobanyqgzenivyxhvavottpc").withAadAuthority("bubwwbowfhdmujrt"))
