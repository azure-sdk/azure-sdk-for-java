...
public final class EmailConfigurationsClientImpl implements EmailConfigurationsClient {
     ...
     */
    EmailConfigurationsClientImpl(DataReplicationClientImpl client) {
    ...
    /**
     * The interface defining all the services for DataReplicationClientEmailConfigurations to be used by the proxy
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<EmailConfigurationModelInner>> createWithResponseAsync(String resourceGroupName,
        String vaultName, String emailConfigurationName, EmailConfigurationModelInner resource, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service.create(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, vaultName, emailConfigurationName, contentType, accept, resource, context);
    }
    ...
    public Response<EmailConfigurationModelInner> createWithResponse(String resourceGroupName, String vaultName,
        ...
        return createWithResponseAsync(resourceGroupName, vaultName, emailConfigurationName, resource, context).block();
    }
