...
public final class DeploymentPreflightsClientImpl implements DeploymentPreflightsClient {
     ...
     */
    DeploymentPreflightsClientImpl(DataReplicationClientImpl client) {
    ...
    /**
     * The interface defining all the services for DataReplicationClientDeploymentPreflights to be used by the proxy
    ...
    public Response<DeploymentPreflightModelInner> postWithResponse(String resourceGroupName, String deploymentId,
        ...
        return postWithResponseAsync(resourceGroupName, deploymentId, body, context).block();
    }
