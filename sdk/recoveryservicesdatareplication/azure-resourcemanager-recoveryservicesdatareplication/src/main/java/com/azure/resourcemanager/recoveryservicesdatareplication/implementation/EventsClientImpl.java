...
public final class EventsClientImpl implements EventsClient {
     ...
     */
    EventsClientImpl(DataReplicationClientImpl client) {
        this.service = RestProxy.create(EventsService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for DataReplicationClientEvents to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{endpoint}")
