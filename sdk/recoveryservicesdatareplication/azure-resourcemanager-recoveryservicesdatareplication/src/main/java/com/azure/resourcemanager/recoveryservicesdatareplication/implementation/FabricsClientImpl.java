...
public final class FabricsClientImpl implements FabricsClient {
     ...
     */
    FabricsClientImpl(DataReplicationClientImpl client) {
        this.service = RestProxy.create(FabricsService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for DataReplicationClientFabrics to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{endpoint}")
    ...
    private Mono<Response<Flux<ByteBuffer>>> createWithResponseAsync(String resourceGroupName, String fabricName,
        ...
        return service.create(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, fabricName, contentType, accept, resource, context);
    }
    ...
    private PollerFlux<PollResult<FabricModelInner>, FabricModelInner> beginCreateAsync(String resourceGroupName,
        ...
        Mono<Response<Flux<ByteBuffer>>> mono
            = createWithResponseAsync(resourceGroupName, fabricName, resource, context);
        return this.client.<FabricModelInner, FabricModelInner>getLroResult(mono, this.client.getHttpPipeline(),
    ...
    public SyncPoller<PollResult<FabricModelInner>, FabricModelInner> beginCreate(String resourceGroupName,
        String fabricName, FabricModelInner resource) {
        return this.beginCreateAsync(resourceGroupName, fabricName, resource).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<FabricModelInner>, FabricModelInner> beginCreate(String resourceGroupName,
        String fabricName, FabricModelInner resource, Context context) {
        return this.beginCreateAsync(resourceGroupName, fabricName, resource, context).getSyncPoller();
    }
    ...
    private Mono<FabricModelInner> createAsync(String resourceGroupName, String fabricName, FabricModelInner resource,
        Context context) {
        return beginCreateAsync(resourceGroupName, fabricName, resource, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    public FabricModelInner create(String resourceGroupName, String fabricName, FabricModelInner resource) {
        return createAsync(resourceGroupName, fabricName, resource).block();
    }
    ...
    public FabricModelInner create(String resourceGroupName, String fabricName, FabricModelInner resource,
        Context context) {
        return createAsync(resourceGroupName, fabricName, resource, context).block();
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> updateWithResponseAsync(String resourceGroupName, String fabricName,
        ...
        return service.update(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, fabricName, contentType, accept, properties, context);
    }
    ...
    private PollerFlux<PollResult<FabricModelInner>, FabricModelInner> beginUpdateAsync(String resourceGroupName,
        ...
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono
            = updateWithResponseAsync(resourceGroupName, fabricName, properties, context);
        return this.client.<FabricModelInner, FabricModelInner>getLroResult(mono, this.client.getHttpPipeline(),
            FabricModelInner.class, FabricModelInner.class, context);
    }
    ...
    public SyncPoller<PollResult<FabricModelInner>, FabricModelInner> beginUpdate(String resourceGroupName,
        String fabricName, FabricModelUpdate properties) {
        return this.beginUpdateAsync(resourceGroupName, fabricName, properties).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<FabricModelInner>, FabricModelInner> beginUpdate(String resourceGroupName,
        String fabricName, FabricModelUpdate properties, Context context) {
        return this.beginUpdateAsync(resourceGroupName, fabricName, properties, context).getSyncPoller();
    }
    ...
    private Mono<FabricModelInner> updateAsync(String resourceGroupName, String fabricName,
        FabricModelUpdate properties, Context context) {
        return beginUpdateAsync(resourceGroupName, fabricName, properties, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    public FabricModelInner update(String resourceGroupName, String fabricName, FabricModelUpdate properties) {
        return updateAsync(resourceGroupName, fabricName, properties).block();
    }
    ...
    public FabricModelInner update(String resourceGroupName, String fabricName, FabricModelUpdate properties,
        Context context) {
        return updateAsync(resourceGroupName, fabricName, properties, context).block();
    }
