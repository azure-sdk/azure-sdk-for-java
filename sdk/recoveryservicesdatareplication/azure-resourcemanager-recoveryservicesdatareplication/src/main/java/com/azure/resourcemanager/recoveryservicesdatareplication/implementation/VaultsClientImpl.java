...
public final class VaultsClientImpl implements VaultsClient {
     ...
     */
    VaultsClientImpl(DataReplicationClientImpl client) {
        this.service = RestProxy.create(VaultsService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for DataReplicationClientVaults to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{endpoint}")
    ...
    private Mono<Response<Flux<ByteBuffer>>> createWithResponseAsync(String resourceGroupName, String vaultName,
        ...
        return service.create(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, vaultName, contentType, accept, resource, context);
    }
    ...
    private PollerFlux<PollResult<VaultModelInner>, VaultModelInner> beginCreateAsync(String resourceGroupName,
        ...
        Mono<Response<Flux<ByteBuffer>>> mono
            = createWithResponseAsync(resourceGroupName, vaultName, resource, context);
        return this.client.<VaultModelInner, VaultModelInner>getLroResult(mono, this.client.getHttpPipeline(),
    ...
    public SyncPoller<PollResult<VaultModelInner>, VaultModelInner> beginCreate(String resourceGroupName,
        String vaultName, VaultModelInner resource) {
        return this.beginCreateAsync(resourceGroupName, vaultName, resource).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<VaultModelInner>, VaultModelInner> beginCreate(String resourceGroupName,
        String vaultName, VaultModelInner resource, Context context) {
        return this.beginCreateAsync(resourceGroupName, vaultName, resource, context).getSyncPoller();
    }
    ...
    private Mono<VaultModelInner> createAsync(String resourceGroupName, String vaultName, VaultModelInner resource,
        Context context) {
        return beginCreateAsync(resourceGroupName, vaultName, resource, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    public VaultModelInner create(String resourceGroupName, String vaultName, VaultModelInner resource) {
        return createAsync(resourceGroupName, vaultName, resource).block();
    }
    ...
    public VaultModelInner create(String resourceGroupName, String vaultName, VaultModelInner resource,
        Context context) {
        return createAsync(resourceGroupName, vaultName, resource, context).block();
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> updateWithResponseAsync(String resourceGroupName, String vaultName,
        ...
        return service.update(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, vaultName, contentType, accept, properties, context);
    }
    ...
    private PollerFlux<PollResult<VaultModelInner>, VaultModelInner> beginUpdateAsync(String resourceGroupName,
        ...
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono
            = updateWithResponseAsync(resourceGroupName, vaultName, properties, context);
        return this.client.<VaultModelInner, VaultModelInner>getLroResult(mono, this.client.getHttpPipeline(),
            VaultModelInner.class, VaultModelInner.class, context);
    }
    ...
    public SyncPoller<PollResult<VaultModelInner>, VaultModelInner> beginUpdate(String resourceGroupName,
        String vaultName, VaultModelUpdate properties) {
        return this.beginUpdateAsync(resourceGroupName, vaultName, properties).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<VaultModelInner>, VaultModelInner> beginUpdate(String resourceGroupName,
        String vaultName, VaultModelUpdate properties, Context context) {
        return this.beginUpdateAsync(resourceGroupName, vaultName, properties, context).getSyncPoller();
    }
    ...
    private Mono<VaultModelInner> updateAsync(String resourceGroupName, String vaultName, VaultModelUpdate properties,
        Context context) {
        return beginUpdateAsync(resourceGroupName, vaultName, properties, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    public VaultModelInner update(String resourceGroupName, String vaultName, VaultModelUpdate properties) {
        return updateAsync(resourceGroupName, vaultName, properties).block();
    }
    ...
    public VaultModelInner update(String resourceGroupName, String vaultName, VaultModelUpdate properties,
        Context context) {
        return updateAsync(resourceGroupName, vaultName, properties, context).block();
    }
