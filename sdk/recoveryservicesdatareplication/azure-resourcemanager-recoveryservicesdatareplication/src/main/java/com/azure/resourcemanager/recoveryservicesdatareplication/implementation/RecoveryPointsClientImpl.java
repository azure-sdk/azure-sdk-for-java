...
public final class RecoveryPointsClientImpl implements RecoveryPointsClient {
     ...
     */
    RecoveryPointsClientImpl(DataReplicationClientImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for DataReplicationClientRecoveryPoints to be used by the proxy service
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the response of a RecoveryPointModel list operation along with {@link PagedResponse} on successful
     * completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
