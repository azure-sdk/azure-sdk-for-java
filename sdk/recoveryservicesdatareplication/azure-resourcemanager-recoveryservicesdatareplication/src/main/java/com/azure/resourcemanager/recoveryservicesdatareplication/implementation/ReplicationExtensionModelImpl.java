...
public final class ReplicationExtensionModelImpl
    ...
    public ReplicationExtensionModel create() {
        this.innerObject = serviceManager.serviceClient().getReplicationExtensions().create(resourceGroupName,
            vaultName, replicationExtensionName, this.innerModel(), Context.NONE);
        return this;
    }

    public ReplicationExtensionModel create(Context context) {
        this.innerObject = serviceManager.serviceClient().getReplicationExtensions().create(resourceGroupName,
            vaultName, replicationExtensionName, this.innerModel(), context);
        return this;
    }
    ...
    public ReplicationExtensionModel refresh() {
        this.innerObject = serviceManager.serviceClient().getReplicationExtensions()
            .getWithResponse(resourceGroupName, vaultName, replicationExtensionName, Context.NONE).getValue();
        return this;
    }

    public ReplicationExtensionModel refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getReplicationExtensions()
            .getWithResponse(resourceGroupName, vaultName, replicationExtensionName, context).getValue();
        return this;
    }
