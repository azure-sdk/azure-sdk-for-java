...
public final class ProtectedItemModelImpl implements ProtectedItemModel, ProtectedItemModel.Definition {
    ...
    public ProtectedItemModel create() {
        this.innerObject = serviceManager.serviceClient().getProtectedItems().create(resourceGroupName, vaultName,
            protectedItemName, this.innerModel(), Context.NONE);
        return this;
    }

    public ProtectedItemModel create(Context context) {
        this.innerObject = serviceManager.serviceClient().getProtectedItems().create(resourceGroupName, vaultName,
            protectedItemName, this.innerModel(), context);
        return this;
    }
    ...
    public ProtectedItemModel refresh() {
        this.innerObject = serviceManager.serviceClient().getProtectedItems()
            .getWithResponse(resourceGroupName, vaultName, protectedItemName, Context.NONE).getValue();
        return this;
    }

    public ProtectedItemModel refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getProtectedItems()
            .getWithResponse(resourceGroupName, vaultName, protectedItemName, context).getValue();
        return this;
    }
