...
public final class PoliciesClientImpl implements PoliciesClient {
     ...
     */
    PoliciesClientImpl(DataReplicationClientImpl client) {
        this.service = RestProxy.create(PoliciesService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for DataReplicationClientPolicies to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{endpoint}")
    ...
    private Mono<Response<Flux<ByteBuffer>>> createWithResponseAsync(String resourceGroupName, String vaultName,
        ...
        return service.create(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, vaultName, policyName, contentType, accept, resource, context);
    }
    ...
    private PollerFlux<PollResult<PolicyModelInner>, PolicyModelInner> beginCreateAsync(String resourceGroupName,
        ...
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono
            = createWithResponseAsync(resourceGroupName, vaultName, policyName, resource, context);
        return this.client.<PolicyModelInner, PolicyModelInner>getLroResult(mono, this.client.getHttpPipeline(),
            PolicyModelInner.class, PolicyModelInner.class, context);
    }
    ...
    public SyncPoller<PollResult<PolicyModelInner>, PolicyModelInner> beginCreate(String resourceGroupName,
        String vaultName, String policyName, PolicyModelInner resource) {
        return this.beginCreateAsync(resourceGroupName, vaultName, policyName, resource).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<PolicyModelInner>, PolicyModelInner> beginCreate(String resourceGroupName,
        String vaultName, String policyName, PolicyModelInner resource, Context context) {
        return this.beginCreateAsync(resourceGroupName, vaultName, policyName, resource, context).getSyncPoller();
    }
    ...
    private Mono<PolicyModelInner> createAsync(String resourceGroupName, String vaultName, String policyName,
        ...
        return beginCreateAsync(resourceGroupName, vaultName, policyName, resource, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    public PolicyModelInner create(String resourceGroupName, String vaultName, String policyName,
        PolicyModelInner resource) {
        return createAsync(resourceGroupName, vaultName, policyName, resource).block();
    }
    ...
    public PolicyModelInner create(String resourceGroupName, String vaultName, String policyName,
        PolicyModelInner resource, Context context) {
        return createAsync(resourceGroupName, vaultName, policyName, resource, context).block();
    }
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String vaultName, String policyName, Context context) {
        return beginDeleteAsync(resourceGroupName, vaultName, policyName, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
