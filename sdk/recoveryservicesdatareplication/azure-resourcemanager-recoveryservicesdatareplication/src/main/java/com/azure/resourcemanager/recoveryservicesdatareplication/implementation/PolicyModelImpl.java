...
public final class PolicyModelImpl implements PolicyModel, PolicyModel.Definition {
    ...
    public PolicyModel create() {
        this.innerObject = serviceManager.serviceClient().getPolicies().create(resourceGroupName, vaultName, policyName,
    ...
    public PolicyModel refresh() {
        this.innerObject = serviceManager.serviceClient().getPolicies()
            .getWithResponse(resourceGroupName, vaultName, policyName, Context.NONE).getValue();
        return this;
    }

    public PolicyModel refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getPolicies()
            .getWithResponse(resourceGroupName, vaultName, policyName, context).getValue();
        return this;
    }
