...
/**
 * Initializes a new instance of the DataReplicationClientImpl type.
 */
@ServiceClient(builder = DataReplicationClientBuilder.class)
public final class DataReplicationClientImpl implements DataReplicationClient {
    /**
     * Service host.
     */
    ...
    /**
     * Initializes an instance of DataReplicationClient client.
     * 
     ...
     */
    DataReplicationClientImpl(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter,
    ...
    private static final ClientLogger LOGGER = new ClientLogger(DataReplicationClientImpl.class);
}
