...
public final class CheckNameAvailabilitiesClientImpl implements CheckNameAvailabilitiesClient {
     ...
     */
    CheckNameAvailabilitiesClientImpl(DataReplicationClientImpl client) {
    ...
    /**
     * The interface defining all the services for DataReplicationClientCheckNameAvailabilities to be used by the proxy
    ...
    public Response<CheckNameAvailabilityResponseModelInner> postWithResponse(String location,
        CheckNameAvailabilityModel body, Context context) {
        return postWithResponseAsync(location, body, context).block();
    }
