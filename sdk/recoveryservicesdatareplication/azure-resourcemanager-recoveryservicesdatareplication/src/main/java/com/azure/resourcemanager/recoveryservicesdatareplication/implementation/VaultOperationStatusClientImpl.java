...
public final class VaultOperationStatusClientImpl implements VaultOperationStatusClient {
    ...
    VaultOperationStatusClientImpl(DataReplicationMgmtClientImpl client) {
        this.service = RestProxy.create(VaultOperationStatusService.class, client.getHttpPipeline(),
            client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for DataReplicationMgmtClientVaultOperationStatus to be used by the
