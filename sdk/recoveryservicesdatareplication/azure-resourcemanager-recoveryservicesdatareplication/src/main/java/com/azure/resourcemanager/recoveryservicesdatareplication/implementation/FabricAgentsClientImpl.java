...
public final class FabricAgentsClientImpl implements FabricAgentsClient {
     ...
     */
    FabricAgentsClientImpl(DataReplicationClientImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for DataReplicationClientFabricAgents to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{endpoint}")
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> createWithResponseAsync(String resourceGroupName, String fabricName,
        String fabricAgentName, FabricAgentModelInner resource, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service.create(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, fabricName, fabricAgentName, contentType, accept, resource, context);
    }
    ...
    private PollerFlux<PollResult<FabricAgentModelInner>, FabricAgentModelInner> beginCreateAsync(
        ...
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono
            = createWithResponseAsync(resourceGroupName, fabricName, fabricAgentName, resource, context);
        return this.client.<FabricAgentModelInner, FabricAgentModelInner>getLroResult(mono,
    ...
    public SyncPoller<PollResult<FabricAgentModelInner>, FabricAgentModelInner> beginCreate(String resourceGroupName,
        ...
        return this.beginCreateAsync(resourceGroupName, fabricName, fabricAgentName, resource).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<FabricAgentModelInner>, FabricAgentModelInner> beginCreate(String resourceGroupName,
        ...
        return this.beginCreateAsync(resourceGroupName, fabricName, fabricAgentName, resource, context).getSyncPoller();
    }
    ...
    private Mono<FabricAgentModelInner> createAsync(String resourceGroupName, String fabricName, String fabricAgentName,
        ...
        return beginCreateAsync(resourceGroupName, fabricName, fabricAgentName, resource, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    public FabricAgentModelInner create(String resourceGroupName, String fabricName, String fabricAgentName,
        FabricAgentModelInner resource) {
        return createAsync(resourceGroupName, fabricName, fabricAgentName, resource).block();
    }
    ...
    public FabricAgentModelInner create(String resourceGroupName, String fabricName, String fabricAgentName,
        FabricAgentModelInner resource, Context context) {
        return createAsync(resourceGroupName, fabricName, fabricAgentName, resource, context).block();
    }
