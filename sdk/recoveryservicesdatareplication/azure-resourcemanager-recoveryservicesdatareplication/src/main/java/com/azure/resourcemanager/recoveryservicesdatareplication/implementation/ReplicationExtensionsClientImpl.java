...
public final class ReplicationExtensionsClientImpl implements ReplicationExtensionsClient {
     ...
     */
    ReplicationExtensionsClientImpl(DataReplicationClientImpl client) {
    ...
    /**
     * The interface defining all the services for DataReplicationClientReplicationExtensions to be used by the proxy
    ...
    public interface ReplicationExtensionsService {
        ...
        Mono<Response<ReplicationExtensionModelInner>> get(@HostParam("endpoint") String endpoint,
        ...
        Mono<Response<Flux<ByteBuffer>>> create(@HostParam("endpoint") String endpoint,
            ...
            @BodyParam("application/json") ReplicationExtensionModelInner resource, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ReplicationExtensionModelListResult>> list(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("vaultName") String vaultName,
            @HeaderParam("Accept") String accept, Context context);
    ...
    private Mono<Response<Flux<ByteBuffer>>> createWithResponseAsync(String resourceGroupName, String vaultName,
        String replicationExtensionName, ReplicationExtensionModelInner resource) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> createWithResponseAsync(String resourceGroupName, String vaultName,
        String replicationExtensionName, ReplicationExtensionModelInner resource, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service.create(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, vaultName, replicationExtensionName, contentType, accept, resource, context);
    }
    ...
    private PollerFlux<PollResult<ReplicationExtensionModelInner>, ReplicationExtensionModelInner> beginCreateAsync(
        ...
        ReplicationExtensionModelInner resource) {
    ...
    private PollerFlux<PollResult<ReplicationExtensionModelInner>, ReplicationExtensionModelInner> beginCreateAsync(
        String resourceGroupName, String vaultName, String replicationExtensionName,
        ReplicationExtensionModelInner resource, Context context) {
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono
            = createWithResponseAsync(resourceGroupName, vaultName, replicationExtensionName, resource, context);
        return this.client.<ReplicationExtensionModelInner, ReplicationExtensionModelInner>getLroResult(mono,
            this.client.getHttpPipeline(), ReplicationExtensionModelInner.class, ReplicationExtensionModelInner.class,
            context);
    }
    ...
    public SyncPoller<PollResult<ReplicationExtensionModelInner>, ReplicationExtensionModelInner> beginCreate(
        String resourceGroupName, String vaultName, String replicationExtensionName,
        ReplicationExtensionModelInner resource) {
        return this.beginCreateAsync(resourceGroupName, vaultName, replicationExtensionName, resource).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<ReplicationExtensionModelInner>, ReplicationExtensionModelInner> beginCreate(
        String resourceGroupName, String vaultName, String replicationExtensionName,
        ReplicationExtensionModelInner resource, Context context) {
        return this.beginCreateAsync(resourceGroupName, vaultName, replicationExtensionName, resource, context)
            .getSyncPoller();
    }
    ...
    private Mono<ReplicationExtensionModelInner> createAsync(String resourceGroupName, String vaultName,
        String replicationExtensionName, ReplicationExtensionModelInner resource, Context context) {
        return beginCreateAsync(resourceGroupName, vaultName, replicationExtensionName, resource, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    public ReplicationExtensionModelInner create(String resourceGroupName, String vaultName,
        String replicationExtensionName, ReplicationExtensionModelInner resource) {
        return createAsync(resourceGroupName, vaultName, replicationExtensionName, resource).block();
    }
    ...
    public ReplicationExtensionModelInner create(String resourceGroupName, String vaultName,
        String replicationExtensionName, ReplicationExtensionModelInner resource, Context context) {
        return createAsync(resourceGroupName, vaultName, replicationExtensionName, resource, context).block();
    }
