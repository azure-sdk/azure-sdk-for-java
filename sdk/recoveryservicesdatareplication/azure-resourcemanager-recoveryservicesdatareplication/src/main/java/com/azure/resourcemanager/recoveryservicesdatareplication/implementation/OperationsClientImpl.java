...
import com.azure.resourcemanager.recoveryservicesdatareplication.implementation.models.OperationListResult;
...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    OperationsClientImpl(DataReplicationClientImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for DataReplicationClientOperations to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{endpoint}")
