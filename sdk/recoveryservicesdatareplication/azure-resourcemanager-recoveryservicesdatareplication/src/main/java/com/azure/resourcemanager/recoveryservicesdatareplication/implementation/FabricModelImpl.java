...
public final class FabricModelImpl implements FabricModel, FabricModel.Definition, FabricModel.Update {
    ...
    public FabricModel create() {
        this.innerObject = serviceManager.serviceClient().getFabrics().create(resourceGroupName, fabricName,
    ...
    public FabricModel apply() {
        this.innerObject = serviceManager.serviceClient().getFabrics().update(resourceGroupName, fabricName, updateBody,
            Context.NONE);
        return this;
    }
    ...
    public FabricModel refresh() {
        this.innerObject = serviceManager.serviceClient().getFabrics()
            .getByResourceGroupWithResponse(resourceGroupName, fabricName, Context.NONE).getValue();
        return this;
    }

    public FabricModel refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getFabrics()
            .getByResourceGroupWithResponse(resourceGroupName, fabricName, context).getValue();
        return this;
    }
