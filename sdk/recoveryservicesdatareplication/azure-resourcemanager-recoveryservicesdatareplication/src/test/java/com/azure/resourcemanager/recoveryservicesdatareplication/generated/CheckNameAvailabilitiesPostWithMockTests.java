...
public final class CheckNameAvailabilitiesPostWithMockTests {
    @Test
    public void testPostWithResponse() throws Exception {
        String responseStr = "{\"nameAvailable\":true,\"reason\":\"lnf\",\"message\":\"y\"}";
        ...
        CheckNameAvailabilityResponseModel response = manager.checkNameAvailabilities()
            .postWithResponse("qi", new CheckNameAvailabilityModel().withName("reuykbbmnwagl").withType("xoe"),
                com.azure.core.util.Context.NONE)
            .getValue();

        Assertions.assertEquals(true, response.nameAvailable());
        Assertions.assertEquals("lnf", response.reason());
