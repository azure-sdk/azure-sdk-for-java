...
public final class ManagedServiceIdentityTests {
    ...
    public void testDeserialize() throws Exception {
        ManagedServiceIdentity model = BinaryData.fromString(
            "{\"principalId\":\"gc\",\"tenantId\":\"wclxxwrl\",\"type\":\"SystemAssigned,UserAssigned\",\"userAssignedIdentities\":{\"hxbnjbiksqrg\":{\"clientId\":\"kcqvkocrc\",\"principalId\":\"kwt\"},\"bvmgxsabkyqduuji\":{\"clientId\":\"sainqpjwnzl\",\"principalId\":\"fmppe\"},\"rwjfe\":{\"clientId\":\"jczdzevndh\",\"principalId\":\"wpdappdsbdkv\"}}}")
    ...
    public void testSerialize() throws Exception {
        ManagedServiceIdentity model
            = new ManagedServiceIdentity().withType(ManagedServiceIdentityType.SYSTEM_ASSIGNED_USER_ASSIGNED)
                .withUserAssignedIdentities(mapOf("hxbnjbiksqrg", new UserAssignedIdentity(), "bvmgxsabkyqduuji",
                    new UserAssignedIdentity(), "rwjfe", new UserAssignedIdentity()));
