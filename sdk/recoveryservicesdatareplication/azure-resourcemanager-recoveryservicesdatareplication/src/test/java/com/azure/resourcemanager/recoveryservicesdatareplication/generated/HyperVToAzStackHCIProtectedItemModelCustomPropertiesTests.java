...
public final class HyperVToAzStackHCIProtectedItemModelCustomPropertiesTests {
    ...
    public void testDeserialize() throws Exception {
        HyperVToAzStackHCIProtectedItemModelCustomProperties model = BinaryData.fromString(
        ...
        Assertions.assertEquals(false, model.nicsToInclude().get(0).isStaticIpMigrationEnabled());
    ...
    public void testSerialize() throws Exception {
        HyperVToAzStackHCIProtectedItemModelCustomProperties model
            = new HyperVToAzStackHCIProtectedItemModelCustomProperties().withTargetHciClusterId("iykzkdncjdx")
