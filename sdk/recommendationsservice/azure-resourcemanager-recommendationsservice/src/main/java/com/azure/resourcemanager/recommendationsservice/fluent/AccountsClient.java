...
public interface AccountsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<AccountResourceInner> getByResourceGroupWithResponse(String resourceGroupName, String accountName,
        Context context);
    ...
    SyncPoller<PollResult<AccountResourceInner>, AccountResourceInner> beginCreateOrUpdate(String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<AccountResourceInner>, AccountResourceInner> beginUpdate(String resourceGroupName,
