...
public final class AccountsImpl implements Accounts {
    ...
    public Response<AccountResource> getByResourceGroupWithResponse(String resourceGroupName, String accountName,
        Context context) {
    ...
    public Response<AccountStatus> getStatusWithResponse(String resourceGroupName, String accountName,
        Context context) {
