...
import com.azure.resourcemanager.recommendationsservice.fluent.models.OperationInner;
import com.azure.resourcemanager.recommendationsservice.models.OperationListResult;
...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    OperationsClientImpl(RecommendationsServiceImpl client) {
        this.service =
    ...
    /**
     * The interface defining all the services for RecommendationsServiceOperations to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{$host}")
    ...
    public interface OperationsService {
        ...
        @Get("/providers/Microsoft.RecommendationsService/operations")
