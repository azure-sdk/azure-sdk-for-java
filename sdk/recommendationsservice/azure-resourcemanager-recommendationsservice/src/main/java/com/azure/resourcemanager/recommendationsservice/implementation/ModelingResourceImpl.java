...
public final class ModelingResourceImpl
    ...
    ModelingResourceImpl(String name,
    ...
    ModelingResourceImpl(ModelingResourceInner innerObject,
        com.azure.resourcemanager.recommendationsservice.RecommendationsServiceManager serviceManager) {
        this.innerObject = innerObject;
        this.serviceManager = serviceManager;
        this.resourceGroupName = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "resourceGroups");
        this.accountName = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "accounts");
        this.modelingName = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "modeling");
    }
