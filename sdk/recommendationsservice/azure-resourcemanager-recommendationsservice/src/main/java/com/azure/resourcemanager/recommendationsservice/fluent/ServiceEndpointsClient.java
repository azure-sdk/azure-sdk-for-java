...
public interface ServiceEndpointsClient {
    ...
    Response<ServiceEndpointResourceInner> getWithResponse(String resourceGroupName, String accountName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ServiceEndpointResourceInner createOrUpdate(String resourceGroupName, String accountName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ServiceEndpointResourceInner update(String resourceGroupName, String accountName, String serviceEndpointName,
