...
public final class ModelingsClientImpl implements ModelingsClient {
    ...
    public interface ModelingsService {
        @Headers({ "Content-Type: application/json" })
        @Get("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecommendationsService/accounts/{accountName}/modeling")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ModelingResourceList>> listByAccountResource(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("accountName") String accountName,
            @HeaderParam("Accept") String accept, Context context);

        @Headers({ "Content-Type: application/json" })
        @Get("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecommendationsService/accounts/{accountName}/modeling/{modelingName}")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ModelingResourceInner>> get(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("accountName") String accountName,
            @PathParam("modelingName") String modelingName, @HeaderParam("Accept") String accept, Context context);

        @Headers({ "Content-Type: application/json" })
        @Put("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecommendationsService/accounts/{accountName}/modeling/{modelingName}")
        @ExpectedResponses({ 200, 201 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Flux<ByteBuffer>>> createOrUpdate(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("accountName") String accountName,
            @PathParam("modelingName") String modelingName, @BodyParam("application/json") ModelingResourceInner body,
            @HeaderParam("Accept") String accept, Context context);

        @Headers({ "Content-Type: application/json" })
        @Patch("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecommendationsService/accounts/{accountName}/modeling/{modelingName}")
        @ExpectedResponses({ 200, 202 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Flux<ByteBuffer>>> update(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("accountName") String accountName,
            @PathParam("modelingName") String modelingName, @BodyParam("application/json") ModelingPatchResource body,
            @HeaderParam("Accept") String accept, Context context);

        @Headers({ "Content-Type: application/json" })
        @Delete("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecommendationsService/accounts/{accountName}/modeling/{modelingName}")
    ...
    private Mono<PagedResponse<ModelingResourceInner>> listByAccountResourceSinglePageAsync(String resourceGroupName,
        String accountName) {
        ...
        return FluxUtil
            ...
            .<PagedResponse<ModelingResourceInner>>map(res -> new PagedResponseBase<>(res.getRequest(),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ModelingResourceInner>> getWithResponseAsync(String resourceGroupName, String accountName,
        String modelingName) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        return FluxUtil
            .withContext(context -> service.get(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, accountName, modelingName, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ModelingResourceInner>> getWithResponseAsync(String resourceGroupName, String accountName,
        String modelingName, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service.get(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, accountName, modelingName, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ModelingResourceInner> getWithResponse(String resourceGroupName, String accountName,
        String modelingName, Context context) {
    ...
    public ModelingResourceInner get(String resourceGroupName, String accountName, String modelingName) {
        return getWithResponse(resourceGroupName, accountName, modelingName, Context.NONE).getValue();
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String resourceGroupName,
        String accountName, String modelingName, ModelingResourceInner body) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return FluxUtil
            .withContext(context -> service.createOrUpdate(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, accountName, modelingName, body, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String resourceGroupName,
        String accountName, String modelingName, ModelingResourceInner body, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    private PollerFlux<PollResult<ModelingResourceInner>, ModelingResourceInner> beginCreateOrUpdateAsync(
        ...
        return this.client.<ModelingResourceInner, ModelingResourceInner>getLroResult(mono,
            this.client.getHttpPipeline(), ModelingResourceInner.class, ModelingResourceInner.class,
    ...
    private PollerFlux<PollResult<ModelingResourceInner>, ModelingResourceInner> beginCreateOrUpdateAsync(
        ...
        return this.client.<ModelingResourceInner, ModelingResourceInner>getLroResult(mono,
            this.client.getHttpPipeline(), ModelingResourceInner.class, ModelingResourceInner.class, context);
    }
    ...
    public SyncPoller<PollResult<ModelingResourceInner>, ModelingResourceInner> beginCreateOrUpdate(
        String resourceGroupName, String accountName, String modelingName, ModelingResourceInner body) {
        return this.beginCreateOrUpdateAsync(resourceGroupName, accountName, modelingName, body).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<ModelingResourceInner>, ModelingResourceInner> beginCreateOrUpdate(
        String resourceGroupName, String accountName, String modelingName, ModelingResourceInner body,
        Context context) {
        return this.beginCreateOrUpdateAsync(resourceGroupName, accountName, modelingName, body, context)
            .getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ModelingResourceInner> createOrUpdateAsync(String resourceGroupName, String accountName,
        String modelingName, ModelingResourceInner body) {
        return beginCreateOrUpdateAsync(resourceGroupName, accountName, modelingName, body).last()
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ModelingResourceInner> createOrUpdateAsync(String resourceGroupName, String accountName,
        String modelingName, ModelingResourceInner body, Context context) {
        return beginCreateOrUpdateAsync(resourceGroupName, accountName, modelingName, body, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ModelingResourceInner createOrUpdate(String resourceGroupName, String accountName, String modelingName,
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ModelingResourceInner createOrUpdate(String resourceGroupName, String accountName, String modelingName,
        ModelingResourceInner body, Context context) {
    ...
    private Mono<Response<Flux<ByteBuffer>>> updateWithResponseAsync(String resourceGroupName, String accountName,
        String modelingName, ModelingPatchResource body) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> updateWithResponseAsync(String resourceGroupName, String accountName,
        String modelingName, ModelingPatchResource body, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service.update(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, accountName, modelingName, body, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<ModelingResourceInner>, ModelingResourceInner> beginUpdate(String resourceGroupName,
        String accountName, String modelingName, ModelingPatchResource body) {
        return this.beginUpdateAsync(resourceGroupName, accountName, modelingName, body).getSyncPoller();
    }
    ...
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<ModelingResourceInner>, ModelingResourceInner> beginUpdate(String resourceGroupName,
        String accountName, String modelingName, ModelingPatchResource body, Context context) {
        return this.beginUpdateAsync(resourceGroupName, accountName, modelingName, body, context).getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ModelingResourceInner> updateAsync(String resourceGroupName, String accountName, String modelingName,
        ModelingPatchResource body) {
        return beginUpdateAsync(resourceGroupName, accountName, modelingName, body).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ModelingResourceInner> updateAsync(String resourceGroupName, String accountName, String modelingName,
        ModelingPatchResource body, Context context) {
        return beginUpdateAsync(resourceGroupName, accountName, modelingName, body, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ModelingResourceInner update(String resourceGroupName, String accountName, String modelingName,
        ModelingPatchResource body) {
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String accountName,
        String modelingName) {
        return this.beginDeleteAsync(resourceGroupName, accountName, modelingName).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String accountName,
        String modelingName, Context context) {
        return this.beginDeleteAsync(resourceGroupName, accountName, modelingName, context).getSyncPoller();
    }
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String accountName, String modelingName) {
        return beginDeleteAsync(resourceGroupName, accountName, modelingName).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String accountName, String modelingName, Context context) {
        return beginDeleteAsync(resourceGroupName, accountName, modelingName, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
