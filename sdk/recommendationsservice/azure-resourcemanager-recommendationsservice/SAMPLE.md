...
public final class AccountsCheckNameAvailabilitySamples {
    /*
     * x-ms-original-file:
     * specification/recommendationsservice/resource-manager/Microsoft.RecommendationsService/preview/2022-03-01-preview
     * /examples/Accounts_CheckNameAvailabilityAvailable.json
     */
    /**
    ...
    public static void checkNameAvailabilityOfRecommendationsServiceAccountNameAvailable(
        ...
        manager.accounts()
            .checkNameAvailabilityWithResponse(new CheckNameAvailabilityRequest().withName("sampleAccount")
                .withType("Microsoft.RecommendationsService/accounts"), com.azure.core.util.Context.NONE);
    }

    /*
     * x-ms-original-file:
     * specification/recommendationsservice/resource-manager/Microsoft.RecommendationsService/preview/2022-03-01-preview
     * /examples/Accounts_CheckNameAvailabilityUnavailable.json
     */
    /**
...
public final class AccountsCreateOrUpdateSamples {
    ...
    public static void createOrUpdateRecommendationsServiceAccountResource(
        ...
        manager.accounts()
            ...
            .withProperties(new AccountResourceProperties().withConfiguration(AccountConfiguration.CAPACITY)
                .withEndpointAuthentications(Arrays.asList(new EndpointAuthentication().withAadTenantId("tenant")
                    .withPrincipalId("oid")
     ...
     * x-ms-original-file:
     * specification/recommendationsservice/resource-manager/Microsoft.RecommendationsService/preview/2022-03-01-preview
     * /examples/Accounts_CreateOrUpdateWithManagedIdentity.json
     */
    /**
...
public final class AccountsDeleteSamples {
    ...
    public static void deleteRecommendationsServiceAccountResource(
        com.azure.resourcemanager.recommendationsservice.RecommendationsServiceManager manager) {
        manager.accounts().delete("rg", "sampleAccount", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class AccountsGetByResourceGroupSamples {
    ...
    public static void getRecommendationsServiceAccountResource(
        com.azure.resourcemanager.recommendationsservice.RecommendationsServiceManager manager) {
        manager.accounts().getByResourceGroupWithResponse("rg", "sampleAccount", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class AccountsGetStatusSamples {
     ...
     * x-ms-original-file:
     * specification/recommendationsservice/resource-manager/Microsoft.RecommendationsService/preview/2022-03-01-preview
     * /examples/Accounts_GetStatus_ModelingExists.json
     */
    /**
    ...
    public static void getRecommendationsServiceAccountStatusModelingResourceExists(
        com.azure.resourcemanager.recommendationsservice.RecommendationsServiceManager manager) {
        manager.accounts().getStatusWithResponse("rg", "sampleAccount", com.azure.core.util.Context.NONE);
    }

    /*
     * x-ms-original-file:
     * specification/recommendationsservice/resource-manager/Microsoft.RecommendationsService/preview/2022-03-01-preview
     * /examples/Accounts_GetStatus_NoModelingExists.json
     */
    /**
...
public final class AccountsListByResourceGroupSamples {
    ...
    public static void getRecommendationsServiceAccountResourcesByResourceGroup(
        com.azure.resourcemanager.recommendationsservice.RecommendationsServiceManager manager) {
        manager.accounts().listByResourceGroup("rg", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class AccountsUpdateSamples {
    ...
    public static void updateExistingRecommendationsServiceAccountResource(
        ...
        AccountResource resource = manager.accounts()
            .getByResourceGroupWithResponse("rg", "sampleAccount", com.azure.core.util.Context.NONE)
            .getValue();
        resource.update()
            .withTags(mapOf("Environment", "Test"))
            .withProperties(new AccountPatchResourceProperties()
                .withEndpointAuthentications(Arrays.asList(
                    new EndpointAuthentication().withAadTenantId("tenant")
                        .withPrincipalId("oid")
                        .withPrincipalType(PrincipalType.USER),
                    new EndpointAuthentication().withAadTenantId("tenant")
                        .withPrincipalId("oid2")
                        .withPrincipalType(PrincipalType.USER)))
                .withCors(Arrays.asList(new CorsRule().withAllowedOrigins(Arrays.asList("http://siteA.com"))
     ...
     * x-ms-original-file:
     * specification/recommendationsservice/resource-manager/Microsoft.RecommendationsService/preview/2022-03-01-preview
     * /examples/Accounts_UpdateWithManagedIdentity.json
     */
    /**
...
public final class ModelingCreateOrUpdateSamples {
     ...
     * x-ms-original-file:
     * specification/recommendationsservice/resource-manager/Microsoft.RecommendationsService/preview/2022-03-01-preview
     * /examples/Modeling_CreateOrUpdate.json
     */
    /**
    ...
    public static void createOrUpdateModelingResource(
        ...
        manager.modelings()
            ...
            .withTags(mapOf("Environment", "Prod"))
            .withProperties(new ModelingResourceProperties().withFeatures(ModelingFeatures.STANDARD)
                .withFrequency(ModelingFrequency.HIGH)
                .withSize(ModelingSize.MEDIUM)
                .withInputData(new ModelingInputData()
...
public final class ModelingDeleteSamples {
     ...
     */
    public static void
        deleteModelingResource(com.azure.resourcemanager.recommendationsservice.RecommendationsServiceManager manager) {
        manager.modelings().delete("rg", "sampleAccount", "c1", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class ModelingGetSamples {
     ...
     */
    public static void
        getModelingResource(com.azure.resourcemanager.recommendationsservice.RecommendationsServiceManager manager) {
        manager.modelings().getWithResponse("rg", "sampleAccount", "c1", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class ModelingListByAccountResourceSamples {
     ...
     * x-ms-original-file:
     * specification/recommendationsservice/resource-manager/Microsoft.RecommendationsService/preview/2022-03-01-preview
     * /examples/Modeling_ListByAccountResource.json
     */
    /**
    ...
    public static void getModelingResourcesByRecommendationsServiceAccountResource(
        com.azure.resourcemanager.recommendationsservice.RecommendationsServiceManager manager) {
        manager.modelings().listByAccountResource("rg", "sampleAccount", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class ModelingUpdateSamples {
     ...
     */
    public static void
        updateModelingResource(com.azure.resourcemanager.recommendationsservice.RecommendationsServiceManager manager) {
        ModelingResource resource = manager.modelings()
            .getWithResponse("rg", "sampleAccount", "c1", com.azure.core.util.Context.NONE)
            .getValue();
        resource.update()
            .withTags(mapOf("Environment", "Test"))
            .withProperties(new ModelingPatchResourceProperties().withInputData(new ModelingInputData()
                .withConnectionString("https://storageAccount.blob.core.windows.net/container/root")))
            .apply();
    }
...
public final class OperationStatusesGetSamples {
     ...
     * x-ms-original-file:
     * specification/recommendationsservice/resource-manager/Microsoft.RecommendationsService/preview/2022-03-01-preview
     * /examples/OperationStatuses_Get.json
     */
    /**
     ...
     */
    public static void
        getOperationStatus(com.azure.resourcemanager.recommendationsservice.RecommendationsServiceManager manager) {
...
public final class ServiceEndpointsCreateOrUpdateSamples {
     ...
     * x-ms-original-file:
     * specification/recommendationsservice/resource-manager/Microsoft.RecommendationsService/preview/2022-03-01-preview
     * /examples/ServiceEndpoints_CreateOrUpdate.json
     */
    /**
...
public final class ServiceEndpointsDeleteSamples {
     ...
     * x-ms-original-file:
     * specification/recommendationsservice/resource-manager/Microsoft.RecommendationsService/preview/2022-03-01-preview
     * /examples/ServiceEndpoints_Delete.json
     */
    /**
    ...
    public static void deleteServiceEndpointResource(
        com.azure.resourcemanager.recommendationsservice.RecommendationsServiceManager manager) {
        manager.serviceEndpoints().delete("rg", "sampleAccount", "s1", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class ServiceEndpointsGetSamples {
     ...
     * x-ms-original-file:
     * specification/recommendationsservice/resource-manager/Microsoft.RecommendationsService/preview/2022-03-01-preview
     * /examples/ServiceEndpoints_Get.json
     */
    /**
    ...
    public static void getServiceEndpointResource(
        com.azure.resourcemanager.recommendationsservice.RecommendationsServiceManager manager) {
        manager.serviceEndpoints().getWithResponse("rg", "sampleAccount", "s1", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class ServiceEndpointsListByAccountResourceSamples {
     ...
     * x-ms-original-file:
     * specification/recommendationsservice/resource-manager/Microsoft.RecommendationsService/preview/2022-03-01-preview
     * /examples/ServiceEndpoints_ListByAccountResource.json
     */
    /**
    ...
    public static void getServiceEndpointResourcesByRecommendationsServiceAccountResource(
        com.azure.resourcemanager.recommendationsservice.RecommendationsServiceManager manager) {
        manager.serviceEndpoints().listByAccountResource("rg", "sampleAccount", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class ServiceEndpointsUpdateSamples {
     ...
     * x-ms-original-file:
     * specification/recommendationsservice/resource-manager/Microsoft.RecommendationsService/preview/2022-03-01-preview
     * /examples/ServiceEndpoints_Update.json
     */
    /**
    ...
    public static void updateServiceEndpointResource(
        com.azure.resourcemanager.recommendationsservice.RecommendationsServiceManager manager) {
        ServiceEndpointResource resource = manager.serviceEndpoints()
            .getWithResponse("rg", "sampleAccount", "s1", com.azure.core.util.Context.NONE)
            .getValue();
