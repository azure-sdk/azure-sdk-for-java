...
public final class VolumesClientImpl implements VolumesClient {
    ...
    public interface VolumesService {
        ...
        @Headers({ "Content-Type: application/json" })
        @Post("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetApp/netAppAccounts/{accountName}/capacityPools/{poolName}/volumes/{volumeName}/peerClusterForOnPremMigration")
        @ExpectedResponses({ 200, 202 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Flux<ByteBuffer>>> peerClusterForOnPremMigration(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("accountName") String accountName,
            @PathParam("poolName") String poolName, @PathParam("volumeName") String volumeName,
            @QueryParam("api-version") String apiVersion,
        ...
        @Headers({ "Content-Type: application/json" })
        @Post("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetApp/netAppAccounts/{accountName}/capacityPools/{poolName}/volumes/{volumeName}/createOnPremMigrationReplication")
        @ExpectedResponses({ 200, 202 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Flux<ByteBuffer>>> createOnPremMigrationReplication(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("accountName") String accountName,
            @PathParam("poolName") String poolName, @PathParam("volumeName") String volumeName,
            @QueryParam("api-version") String apiVersion, @HeaderParam("Accept") String accept, Context context);
        ...
        @Headers({ "Content-Type: application/json" })
        @Post("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetApp/netAppAccounts/{accountName}/capacityPools/{poolName}/volumes/{volumeName}/finalizeOnPremMigration")
        @ExpectedResponses({ 202 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Flux<ByteBuffer>>> finalizeOnPremMigration(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("accountName") String accountName,
            @PathParam("poolName") String poolName, @PathParam("volumeName") String volumeName,
            @QueryParam("api-version") String apiVersion, @HeaderParam("Accept") String accept, Context context);
    ...
    private PollerFlux<PollResult<Void>, Void> beginReestablishReplicationAsync(String resourceGroupName,
        String accountName, String poolName, String volumeName, ReestablishReplicationRequest body, Context context) {
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono = reestablishReplicationWithResponseAsync(resourceGroupName, accountName,
    ...
    private PollerFlux<PollResult<Void>, Void> beginAuthorizeReplicationAsync(String resourceGroupName,
        String accountName, String poolName, String volumeName, AuthorizeRequest body, Context context) {
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono = authorizeReplicationWithResponseAsync(resourceGroupName, accountName,
            poolName, volumeName, body, context);
        return this.client.<Void, Void>getLroResult(mono, this.client.getHttpPipeline(), Void.class, Void.class,
            context);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginReInitializeReplication(String resourceGroupName, String accountName,
        String poolName, String volumeName) {
        return this.beginReInitializeReplicationAsync(resourceGroupName, accountName, poolName, volumeName)
            .getSyncPoller();
    }
    ...
    private Mono<Void> reInitializeReplicationAsync(String resourceGroupName, String accountName, String poolName,
        String volumeName, Context context) {
        return beginReInitializeReplicationAsync(resourceGroupName, accountName, poolName, volumeName, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> peerClusterForOnPremMigrationWithResponseAsync(String resourceGroupName,
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.peerClusterForOnPremMigration(this.client.getEndpoint(),
                this.client.getSubscriptionId(), resourceGroupName, accountName, poolName, volumeName,
                this.client.getApiVersion(), body, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> peerClusterForOnPremMigrationWithResponseAsync(String resourceGroupName,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.peerClusterForOnPremMigration(this.client.getEndpoint(), this.client.getSubscriptionId(),
            resourceGroupName, accountName, poolName, volumeName, this.client.getApiVersion(), body, accept, context);
    }
    ...
    private PollerFlux<PollResult<ClusterPeerCommandResponseInner>, ClusterPeerCommandResponseInner>
        beginPeerClusterForOnPremMigrationAsync(String resourceGroupName, String accountName, String poolName,
            String volumeName, PeerClusterForVolumeMigrationRequest body) {
        Mono<Response<Flux<ByteBuffer>>> mono = peerClusterForOnPremMigrationWithResponseAsync(resourceGroupName,
            accountName, poolName, volumeName, body);
    ...
    public SyncPoller<PollResult<ClusterPeerCommandResponseInner>, ClusterPeerCommandResponseInner>
        beginPeerClusterForOnPremMigration(String resourceGroupName, String accountName, String poolName,
            String volumeName, PeerClusterForVolumeMigrationRequest body) {
        return this.beginPeerClusterForOnPremMigrationAsync(resourceGroupName, accountName, poolName, volumeName, body)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<ClusterPeerCommandResponseInner>, ClusterPeerCommandResponseInner>
        beginPeerClusterForOnPremMigration(String resourceGroupName, String accountName, String poolName,
            String volumeName, PeerClusterForVolumeMigrationRequest body, Context context) {
        return this
            .beginPeerClusterForOnPremMigrationAsync(resourceGroupName, accountName, poolName, volumeName, body,
                context)
            .getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ClusterPeerCommandResponseInner> peerClusterForOnPremMigrationAsync(String resourceGroupName,
        String accountName, String poolName, String volumeName, PeerClusterForVolumeMigrationRequest body) {
        return beginPeerClusterForOnPremMigrationAsync(resourceGroupName, accountName, poolName, volumeName, body)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ClusterPeerCommandResponseInner peerClusterForOnPremMigration(String resourceGroupName, String accountName,
        String poolName, String volumeName, PeerClusterForVolumeMigrationRequest body) {
        return peerClusterForOnPremMigrationAsync(resourceGroupName, accountName, poolName, volumeName, body).block();
    }
    ...
    public ClusterPeerCommandResponseInner peerClusterForOnPremMigration(String resourceGroupName, String accountName,
        ...
        return peerClusterForOnPremMigrationAsync(resourceGroupName, accountName, poolName, volumeName, body, context)
            .block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> createOnPremMigrationReplicationWithResponseAsync(String resourceGroupName,
        String accountName, String poolName, String volumeName) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.createOnPremMigrationReplication(this.client.getEndpoint(),
                this.client.getSubscriptionId(), resourceGroupName, accountName, poolName, volumeName,
                this.client.getApiVersion(), accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> createOnPremMigrationReplicationWithResponseAsync(String resourceGroupName,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.createOnPremMigrationReplication(this.client.getEndpoint(), this.client.getSubscriptionId(),
            resourceGroupName, accountName, poolName, volumeName, this.client.getApiVersion(), accept, context);
    }
    ...
    private PollerFlux<PollResult<SvmPeerCommandResponseInner>, SvmPeerCommandResponseInner>
        beginCreateOnPremMigrationReplicationAsync(String resourceGroupName, String accountName, String poolName,
            String volumeName) {
        Mono<Response<Flux<ByteBuffer>>> mono
            = createOnPremMigrationReplicationWithResponseAsync(resourceGroupName, accountName, poolName, volumeName);
    ...
    private PollerFlux<PollResult<SvmPeerCommandResponseInner>, SvmPeerCommandResponseInner>
        beginCreateOnPremMigrationReplicationAsync(String resourceGroupName, String accountName, String poolName,
            String volumeName, Context context) {
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono = createOnPremMigrationReplicationWithResponseAsync(resourceGroupName,
    ...
    public SyncPoller<PollResult<SvmPeerCommandResponseInner>, SvmPeerCommandResponseInner>
        beginCreateOnPremMigrationReplication(String resourceGroupName, String accountName, String poolName,
            String volumeName) {
        return this.beginCreateOnPremMigrationReplicationAsync(resourceGroupName, accountName, poolName, volumeName)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<SvmPeerCommandResponseInner>, SvmPeerCommandResponseInner>
        beginCreateOnPremMigrationReplication(String resourceGroupName, String accountName, String poolName,
            String volumeName, Context context) {
        return this
            .beginCreateOnPremMigrationReplicationAsync(resourceGroupName, accountName, poolName, volumeName, context)
            .getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<SvmPeerCommandResponseInner> createOnPremMigrationReplicationAsync(String resourceGroupName,
        String accountName, String poolName, String volumeName) {
        return beginCreateOnPremMigrationReplicationAsync(resourceGroupName, accountName, poolName, volumeName).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<SvmPeerCommandResponseInner> createOnPremMigrationReplicationAsync(String resourceGroupName,
        String accountName, String poolName, String volumeName, Context context) {
        return beginCreateOnPremMigrationReplicationAsync(resourceGroupName, accountName, poolName, volumeName, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public SvmPeerCommandResponseInner createOnPremMigrationReplication(String resourceGroupName, String accountName,
        String poolName, String volumeName) {
        return createOnPremMigrationReplicationAsync(resourceGroupName, accountName, poolName, volumeName).block();
    }
    ...
    public SvmPeerCommandResponseInner createOnPremMigrationReplication(String resourceGroupName, String accountName,
        String poolName, String volumeName, Context context) {
        return createOnPremMigrationReplicationAsync(resourceGroupName, accountName, poolName, volumeName, context)
            .block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> finalizeOnPremMigrationWithResponseAsync(String resourceGroupName,
        String accountName, String poolName, String volumeName) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        return FluxUtil
            .withContext(
                context -> service.finalizeOnPremMigration(this.client.getEndpoint(), this.client.getSubscriptionId(),
                    resourceGroupName, accountName, poolName, volumeName, this.client.getApiVersion(), accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> finalizeOnPremMigrationWithResponseAsync(String resourceGroupName,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.finalizeOnPremMigration(this.client.getEndpoint(), this.client.getSubscriptionId(),
            resourceGroupName, accountName, poolName, volumeName, this.client.getApiVersion(), accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<Void>, Void> beginFinalizeOnPremMigrationAsync(String resourceGroupName,
        String accountName, String poolName, String volumeName) {
        Mono<Response<Flux<ByteBuffer>>> mono
            = finalizeOnPremMigrationWithResponseAsync(resourceGroupName, accountName, poolName, volumeName);
        return this.client.<Void, Void>getLroResult(mono, this.client.getHttpPipeline(), Void.class, Void.class,
            this.client.getContext());
    }
    ...
    private PollerFlux<PollResult<Void>, Void> beginFinalizeOnPremMigrationAsync(String resourceGroupName,
        ...
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono
            = finalizeOnPremMigrationWithResponseAsync(resourceGroupName, accountName, poolName, volumeName, context);
        return this.client.<Void, Void>getLroResult(mono, this.client.getHttpPipeline(), Void.class, Void.class,
            context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<Void>, Void> beginFinalizeOnPremMigration(String resourceGroupName, String accountName,
        String poolName, String volumeName) {
        return this.beginFinalizeOnPremMigrationAsync(resourceGroupName, accountName, poolName, volumeName)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginFinalizeOnPremMigration(String resourceGroupName, String accountName,
        String poolName, String volumeName, Context context) {
        return this.beginFinalizeOnPremMigrationAsync(resourceGroupName, accountName, poolName, volumeName, context)
            .getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> finalizeOnPremMigrationAsync(String resourceGroupName, String accountName, String poolName,
        String volumeName) {
        return beginFinalizeOnPremMigrationAsync(resourceGroupName, accountName, poolName, volumeName).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<Void> finalizeOnPremMigrationAsync(String resourceGroupName, String accountName, String poolName,
        String volumeName, Context context) {
        return beginFinalizeOnPremMigrationAsync(resourceGroupName, accountName, poolName, volumeName, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public void finalizeOnPremMigration(String resourceGroupName, String accountName, String poolName,
        String volumeName) {
        finalizeOnPremMigrationAsync(resourceGroupName, accountName, poolName, volumeName).block();
    }
    ...
    public void finalizeOnPremMigration(String resourceGroupName, String accountName, String poolName,
        String volumeName, Context context) {
        finalizeOnPremMigrationAsync(resourceGroupName, accountName, poolName, volumeName, context).block();
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> performReplicationTransferWithResponseAsync(String resourceGroupName,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.performReplicationTransfer(this.client.getEndpoint(), this.client.getSubscriptionId(),
            resourceGroupName, accountName, poolName, volumeName, this.client.getApiVersion(), accept, context);
    }
    ...
    private PollerFlux<PollResult<Void>, Void> beginPerformReplicationTransferAsync(String resourceGroupName,
        String accountName, String poolName, String volumeName, Context context) {
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono = performReplicationTransferWithResponseAsync(resourceGroupName,
            accountName, poolName, volumeName, context);
        return this.client.<Void, Void>getLroResult(mono, this.client.getHttpPipeline(), Void.class, Void.class,
            context);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginPerformReplicationTransfer(String resourceGroupName,
        String accountName, String poolName, String volumeName) {
        return this.beginPerformReplicationTransferAsync(resourceGroupName, accountName, poolName, volumeName)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginPerformReplicationTransfer(String resourceGroupName,
        String accountName, String poolName, String volumeName, Context context) {
        return this.beginPerformReplicationTransferAsync(resourceGroupName, accountName, poolName, volumeName, context)
            .getSyncPoller();
    }
    ...
    private Mono<Void> performReplicationTransferAsync(String resourceGroupName, String accountName, String poolName,
        String volumeName, Context context) {
        return beginPerformReplicationTransferAsync(resourceGroupName, accountName, poolName, volumeName, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    public void performReplicationTransfer(String resourceGroupName, String accountName, String poolName,
        String volumeName) {
        performReplicationTransferAsync(resourceGroupName, accountName, poolName, volumeName).block();
    }
    ...
    public void performReplicationTransfer(String resourceGroupName, String accountName, String poolName,
        String volumeName, Context context) {
        performReplicationTransferAsync(resourceGroupName, accountName, poolName, volumeName, context).block();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginPoolChange(String resourceGroupName, String accountName,
        String poolName, String volumeName, PoolChangeRequest body, Context context) {
        return this.beginPoolChangeAsync(resourceGroupName, accountName, poolName, volumeName, body, context)
            .getSyncPoller();
    }
    ...
    private Mono<Void> poolChangeAsync(String resourceGroupName, String accountName, String poolName, String volumeName,
        ...
        return beginPoolChangeAsync(resourceGroupName, accountName, poolName, volumeName, body, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginRelocate(String resourceGroupName, String accountName,
        String poolName, String volumeName, RelocateVolumeRequest body, Context context) {
        return this.beginRelocateAsync(resourceGroupName, accountName, poolName, volumeName, body, context)
            .getSyncPoller();
    }
    ...
    private Mono<Void> relocateAsync(String resourceGroupName, String accountName, String poolName, String volumeName,
        ...
        return beginRelocateAsync(resourceGroupName, accountName, poolName, volumeName, body, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginFinalizeRelocation(String resourceGroupName, String accountName,
        String poolName, String volumeName, Context context) {
        return this.beginFinalizeRelocationAsync(resourceGroupName, accountName, poolName, volumeName, context)
            .getSyncPoller();
    }
    ...
    private Mono<Void> finalizeRelocationAsync(String resourceGroupName, String accountName, String poolName,
        String volumeName, Context context) {
        return beginFinalizeRelocationAsync(resourceGroupName, accountName, poolName, volumeName, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginRevertRelocation(String resourceGroupName, String accountName,
        String poolName, String volumeName, Context context) {
        return this.beginRevertRelocationAsync(resourceGroupName, accountName, poolName, volumeName, context)
            .getSyncPoller();
    }
    ...
    private Mono<Void> revertRelocationAsync(String resourceGroupName, String accountName, String poolName,
        String volumeName, Context context) {
        return beginRevertRelocationAsync(resourceGroupName, accountName, poolName, volumeName, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
