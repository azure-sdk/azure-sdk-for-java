...
/** An immutable client-side representation of MediaServiceAutoGenerated. */
public interface MediaServiceAutoGenerated {
    /**
    ...
    /**
     * Gets the inner com.azure.resourcemanager.mediaservices.fluent.models.MediaServiceAutoGeneratedInner object.
     *
     * @return the inner object.
     */
    MediaServiceAutoGeneratedInner innerModel();

    /** The entirety of the MediaServiceAutoGenerated definition. */
    ...
    /** The MediaServiceAutoGenerated definition stages. */
    interface DefinitionStages {
        /** The first stage of the MediaServiceAutoGenerated definition. */
        interface Blank extends WithLocation {
        }
        /** The stage of the MediaServiceAutoGenerated definition allowing to specify location. */
        ...
        /** The stage of the MediaServiceAutoGenerated definition allowing to specify parent resource. */
        ...
        /**
         * The stage of the MediaServiceAutoGenerated definition which contains all the minimum required properties for
        ...
        interface WithCreate
             ...
             */
            MediaServiceAutoGenerated create();
             ...
             * @return the created resource.
             */
            MediaServiceAutoGenerated create(Context context);
        }
        /** The stage of the MediaServiceAutoGenerated definition allowing to specify tags. */
        interface WithTags {
            /**
        ...
        /** The stage of the MediaServiceAutoGenerated definition allowing to specify identity. */
        ...
        /** The stage of the MediaServiceAutoGenerated definition allowing to specify storageAccounts. */
        ...
        /** The stage of the MediaServiceAutoGenerated definition allowing to specify storageAuthentication. */
        ...
        /** The stage of the MediaServiceAutoGenerated definition allowing to specify encryption. */
        ...
        /** The stage of the MediaServiceAutoGenerated definition allowing to specify keyDelivery. */
        ...
        /** The stage of the MediaServiceAutoGenerated definition allowing to specify publicNetworkAccess. */
    ...
    /**
     * Begins update for the MediaServiceAutoGenerated resource.
     *
     * @return the stage of resource update.
     */
    MediaServiceAutoGenerated.Update update();

    /** The template for MediaServiceAutoGenerated update. */
    interface Update
         ...
         */
        MediaServiceAutoGenerated apply();
         ...
         * @return the updated resource.
         */
        MediaServiceAutoGenerated apply(Context context);
    }
    /** The MediaServiceAutoGenerated update stages. */
    interface UpdateStages {
        /** The stage of the MediaServiceAutoGenerated update allowing to specify tags. */
        interface WithTags {
            /**
             * Specifies the tags property: Resource tags..
             *
        ...
        /** The stage of the MediaServiceAutoGenerated update allowing to specify identity. */
        interface WithIdentity {
            /**
             * Specifies the identity property: The Managed Identity for the Media Services account..
             *
        ...
        /** The stage of the MediaServiceAutoGenerated update allowing to specify storageAccounts. */
        interface WithStorageAccounts {
            /**
             * Specifies the storageAccounts property: The storage accounts for this resource..
             *
        ...
        /** The stage of the MediaServiceAutoGenerated update allowing to specify storageAuthentication. */
        interface WithStorageAuthentication {
            /**
             * Specifies the storageAuthentication property: The storageAuthentication property..
             *
        ...
        /** The stage of the MediaServiceAutoGenerated update allowing to specify encryption. */
        interface WithEncryption {
            /**
             * Specifies the encryption property: The account encryption properties..
             *
        ...
        /** The stage of the MediaServiceAutoGenerated update allowing to specify keyDelivery. */
        interface WithKeyDelivery {
            /**
             * Specifies the keyDelivery property: The Key Delivery properties for Media Services account..
             *
        ...
        /** The stage of the MediaServiceAutoGenerated update allowing to specify publicNetworkAccess. */
        interface WithPublicNetworkAccess {
            /**
             * Specifies the publicNetworkAccess property: Whether or not public network access is allowed for resources
             * under the Media Services account..
     ...
     */
    MediaServiceAutoGenerated refresh();
     ...
     * @return the refreshed resource.
     */
    MediaServiceAutoGenerated refresh(Context context);
