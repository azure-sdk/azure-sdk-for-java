...
public final class MediaServicesOperationResultsImpl implements MediaServicesOperationResults {
    ...
    public MediaServiceAutoGenerated get(String locationName, String operationId) {
        MediaServiceAutoGeneratedInner inner = this.serviceClient().get(locationName, operationId);
        if (inner != null) {
