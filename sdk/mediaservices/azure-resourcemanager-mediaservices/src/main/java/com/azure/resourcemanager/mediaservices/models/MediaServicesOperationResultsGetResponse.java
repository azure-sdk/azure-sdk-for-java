...
public final class MediaServicesOperationResultsGetResponse
    extends ResponseBase<MediaServicesOperationResultsGetHeaders, MediaServiceAutoGeneratedInner> {
    /**
    ...
    public MediaServicesOperationResultsGetResponse(
        ...
        MediaServiceAutoGeneratedInner value,
     ...
     */
    @Override
    public MediaServiceAutoGeneratedInner getValue() {
