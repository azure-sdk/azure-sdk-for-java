...
public class Format {
     ...
     * index for thumbnails. Only applicable to thumbnails. {AudioStream} -
     * string "Audio" plus audio stream number(start from 1). {Bitrate} - The
     * audio/video bitrate in kbps. Not applicable to thumbnails. {Codec} - The
     * type of the audio/video codec. {Resolution} - The video resolution. Any
