...
@Fluent
public final class MediaServiceAutoGeneratedInner extends Resource {
    /*
     * The resource properties.
     */
    @JsonProperty(value = "properties")
    private MediaServicePropertiesAutoGenerated innerProperties;
    ...
    /** Creates an instance of MediaServiceAutoGeneratedInner class. */
    public MediaServiceAutoGeneratedInner() {
    }
     ...
     * @return the MediaServiceAutoGeneratedInner object itself.
     */
    public MediaServiceAutoGeneratedInner withIdentity(MediaServiceIdentity identity) {
    ...
    /** {@inheritDoc} */
    @Override
    public MediaServiceAutoGeneratedInner withLocation(String location) {
    ...
    /** {@inheritDoc} */
    @Override
    public MediaServiceAutoGeneratedInner withTags(Map<String, String> tags) {
        super.withTags(tags);
        return this;
    }
     ...
     * @return the MediaServiceAutoGeneratedInner object itself.
     */
    public MediaServiceAutoGeneratedInner withStorageAccounts(List<StorageAccount> storageAccounts) {
        if (this.innerProperties() == null) {
            this.innerProperties = new MediaServicePropertiesAutoGenerated();
        }
     ...
     * @return the MediaServiceAutoGeneratedInner object itself.
     */
    public MediaServiceAutoGeneratedInner withStorageAuthentication(StorageAuthentication storageAuthentication) {
        if (this.innerProperties() == null) {
            this.innerProperties = new MediaServicePropertiesAutoGenerated();
        }
     ...
     * @return the MediaServiceAutoGeneratedInner object itself.
     */
    public MediaServiceAutoGeneratedInner withEncryption(AccountEncryption encryption) {
        if (this.innerProperties() == null) {
            this.innerProperties = new MediaServicePropertiesAutoGenerated();
        }
     ...
     * @return the MediaServiceAutoGeneratedInner object itself.
     */
    public MediaServiceAutoGeneratedInner withKeyDelivery(KeyDelivery keyDelivery) {
        if (this.innerProperties() == null) {
            this.innerProperties = new MediaServicePropertiesAutoGenerated();
        }
     ...
     * @return the MediaServiceAutoGeneratedInner object itself.
     */
    public MediaServiceAutoGeneratedInner withPublicNetworkAccess(PublicNetworkAccess publicNetworkAccess) {
        if (this.innerProperties() == null) {
            this.innerProperties = new MediaServicePropertiesAutoGenerated();
        }
