...
public interface MediaservicesClient {
    ...
    PagedIterable<MediaServiceInner> list(String resourceGroupName);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<MediaServiceInner> list(String resourceGroupName, Context context);
    ...
    Response<MediaServiceInner> getWithResponse(String resourceGroupName, String accountName, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    MediaServiceInner get(String resourceGroupName, String accountName);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<MediaServiceInner> listBySubscription();
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<MediaServiceInner> listBySubscription(Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<MediaServiceAutoGeneratedInner> list(String resourceGroupName);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<MediaServiceAutoGeneratedInner> list(String resourceGroupName, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<MediaServiceAutoGeneratedInner> getWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    MediaServiceAutoGeneratedInner get(String resourceGroupName, String accountName);
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<MediaServiceAutoGeneratedInner>, MediaServiceAutoGeneratedInner> beginCreateOrUpdate(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    MediaServiceAutoGeneratedInner createOrUpdate(
        String resourceGroupName, String accountName, MediaServiceAutoGeneratedInner parameters);
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<MediaServiceAutoGeneratedInner>, MediaServiceAutoGeneratedInner> beginUpdate(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    MediaServiceAutoGeneratedInner update(
        String resourceGroupName, String accountName, MediaServiceUpdateAutoGenerated parameters);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<MediaServiceAutoGeneratedInner> listBySubscription();
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<MediaServiceAutoGeneratedInner> listBySubscription(Context context);
}
