...
import com.azure.resourcemanager.mediaservices.fluent.models.MediaServicePropertiesAutoGenerated;
...
@Fluent
public final class MediaServiceUpdateAutoGenerated {
    /*
     * Resource tags.
     */
    ...
    /** Creates an instance of MediaServiceUpdateAutoGenerated class. */
     ...
     * @return the MediaServiceUpdateAutoGenerated object itself.
     */
    public MediaServiceUpdateAutoGenerated withTags(Map<String, String> tags) {
        this.tags = tags;
        return this;
    }
     ...
     * @return the MediaServiceUpdateAutoGenerated object itself.
     */
    public MediaServiceUpdateAutoGenerated withIdentity(MediaServiceIdentity identity) {
     ...
     * @return the MediaServiceUpdateAutoGenerated object itself.
     */
    public MediaServiceUpdateAutoGenerated withStorageAccounts(List<StorageAccount> storageAccounts) {
     ...
     * @return the MediaServiceUpdateAutoGenerated object itself.
     */
    public MediaServiceUpdateAutoGenerated withStorageAuthentication(StorageAuthentication storageAuthentication) {
        if (this.innerProperties() == null) {
            this.innerProperties = new MediaServicePropertiesAutoGenerated();
        }
     ...
     * @return the MediaServiceUpdateAutoGenerated object itself.
     */
    public MediaServiceUpdateAutoGenerated withEncryption(AccountEncryption encryption) {
        if (this.innerProperties() == null) {
            this.innerProperties = new MediaServicePropertiesAutoGenerated();
        }
     ...
     * @return the MediaServiceUpdateAutoGenerated object itself.
     */
    public MediaServiceUpdateAutoGenerated withKeyDelivery(KeyDelivery keyDelivery) {
        if (this.innerProperties() == null) {
            this.innerProperties = new MediaServicePropertiesAutoGenerated();
        }
     ...
     * @return the MediaServiceUpdateAutoGenerated object itself.
     */
    public MediaServiceUpdateAutoGenerated withPublicNetworkAccess(PublicNetworkAccess publicNetworkAccess) {
        if (this.innerProperties() == null) {
            this.innerProperties = new MediaServicePropertiesAutoGenerated();
        }
