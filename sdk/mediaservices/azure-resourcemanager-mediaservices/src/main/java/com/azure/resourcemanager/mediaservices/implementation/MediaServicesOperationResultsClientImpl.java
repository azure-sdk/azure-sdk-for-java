...
public final class MediaServicesOperationResultsClientImpl implements MediaServicesOperationResultsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<MediaServiceAutoGeneratedInner> getAsync(String locationName, String operationId) {
        return getWithResponseAsync(locationName, operationId).flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public MediaServiceAutoGeneratedInner get(String locationName, String operationId) {
        return getWithResponse(locationName, operationId, Context.NONE).getValue();
    }
}
