...
public final class TransactionNodeImpl implements TransactionNode, TransactionNode.Definition, TransactionNode.Update {
    ...
    public TransactionNode create() {
        this.innerObject = serviceManager.serviceClient().getTransactionNodes().create(blockchainMemberName,
            transactionNodeName, resourceGroupName, this.innerModel(), Context.NONE);
        return this;
    }

    public TransactionNode create(Context context) {
        this.innerObject = serviceManager.serviceClient().getTransactionNodes().create(blockchainMemberName,
            transactionNodeName, resourceGroupName, this.innerModel(), context);
        return this;
    }
    ...
    public TransactionNode apply() {
        this.innerObject = serviceManager.serviceClient().getTransactionNodes().updateWithResponse(blockchainMemberName,
            transactionNodeName, resourceGroupName, updateTransactionNode, Context.NONE).getValue();
        return this;
    }

    public TransactionNode apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getTransactionNodes().updateWithResponse(blockchainMemberName,
            transactionNodeName, resourceGroupName, updateTransactionNode, context).getValue();
        return this;
    }

    TransactionNodeImpl(TransactionNodeInner innerObject,
        com.azure.resourcemanager.blockchain.BlockchainManager serviceManager) {
        this.innerObject = innerObject;
        this.serviceManager = serviceManager;
        this.blockchainMemberName = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "blockchainMembers");
        this.transactionNodeName = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "transactionNodes");
        this.resourceGroupName = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "resourceGroups");
    }

    public TransactionNode refresh() {
        this.innerObject = serviceManager.serviceClient().getTransactionNodes()
            .getWithResponse(blockchainMemberName, transactionNodeName, resourceGroupName, Context.NONE).getValue();
        return this;
    }

    public TransactionNode refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getTransactionNodes()
            .getWithResponse(blockchainMemberName, transactionNodeName, resourceGroupName, context).getValue();
        return this;
    }

    public Response<ApiKeyCollection> listApiKeysWithResponse(Context context) {
        return serviceManager.transactionNodes().listApiKeysWithResponse(blockchainMemberName, transactionNodeName,
            resourceGroupName, context);
    }

    public ApiKeyCollection listApiKeys() {
        return serviceManager.transactionNodes().listApiKeys(blockchainMemberName, transactionNodeName,
            resourceGroupName);
    }

    public Response<ApiKeyCollection> listRegenerateApiKeysWithResponse(ApiKey apiKey, Context context) {
        return serviceManager.transactionNodes().listRegenerateApiKeysWithResponse(blockchainMemberName,
            transactionNodeName, resourceGroupName, apiKey, context);
    }

    public ApiKeyCollection listRegenerateApiKeys() {
        return serviceManager.transactionNodes().listRegenerateApiKeys(blockchainMemberName, transactionNodeName,
            resourceGroupName);
    }
