...
public final class TransactionNodesImpl implements TransactionNodes {
    ...
    public TransactionNodesImpl(TransactionNodesClient innerClient,
        com.azure.resourcemanager.blockchain.BlockchainManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public Response<TransactionNode> getWithResponse(String blockchainMemberName, String transactionNodeName,
        String resourceGroupName, Context context) {
        Response<TransactionNodeInner> inner = this.serviceClient().getWithResponse(blockchainMemberName,
            transactionNodeName, resourceGroupName, context);
        if (inner != null) {
    ...
    public PagedIterable<TransactionNode> list(String blockchainMemberName, String resourceGroupName) {
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new TransactionNodeImpl(inner1, this.manager()));
    }
    ...
    public Response<ApiKeyCollection> listApiKeysWithResponse(String blockchainMemberName, String transactionNodeName,
        String resourceGroupName, Context context) {
        Response<ApiKeyCollectionInner> inner = this.serviceClient().listApiKeysWithResponse(blockchainMemberName,
            transactionNodeName, resourceGroupName, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
    ...
    public ApiKeyCollection listApiKeys(String blockchainMemberName, String transactionNodeName,
    ...
    public Response<ApiKeyCollection> listRegenerateApiKeysWithResponse(String blockchainMemberName,
        String transactionNodeName, String resourceGroupName, ApiKey apiKey, Context context) {
        Response<ApiKeyCollectionInner> inner = this.serviceClient().listRegenerateApiKeysWithResponse(
    ...
    public ApiKeyCollection listRegenerateApiKeys(String blockchainMemberName, String transactionNodeName,
        String resourceGroupName) {
        ApiKeyCollectionInner inner
    ...
    public TransactionNode getById(String id) {
        String blockchainMemberName = ResourceManagerUtils.getValueFromIdByName(id, "blockchainMembers");
        if (blockchainMemberName == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
                String.format("The resource ID '%s' is not valid. Missing path segment 'blockchainMembers'.", id)));
        }
        String transactionNodeName = ResourceManagerUtils.getValueFromIdByName(id, "transactionNodes");
        if (transactionNodeName == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
                String.format("The resource ID '%s' is not valid. Missing path segment 'transactionNodes'.", id)));
        }
        ...
        return this.getWithResponse(blockchainMemberName, transactionNodeName, resourceGroupName, Context.NONE)
            .getValue();
    }
