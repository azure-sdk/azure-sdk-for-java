...
public final class BlockchainMemberImpl
    ...
    public BlockchainMember create() {
        this.innerObject = serviceManager.serviceClient().getBlockchainMembers().create(blockchainMemberName,
    ...
    public BlockchainMember apply() {
        this.innerObject = serviceManager.serviceClient().getBlockchainMembers()
    ...
    public BlockchainMember apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getBlockchainMembers()
            .updateWithResponse(blockchainMemberName, resourceGroupName, updateBlockchainMember, context).getValue();
        return this;
    }

    BlockchainMemberImpl(BlockchainMemberInner innerObject,
    ...
    public BlockchainMember refresh() {
        this.innerObject = serviceManager.serviceClient().getBlockchainMembers()
            .getByResourceGroupWithResponse(resourceGroupName, blockchainMemberName, Context.NONE).getValue();
        return this;
    }

    public BlockchainMember refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getBlockchainMembers()
            .getByResourceGroupWithResponse(resourceGroupName, blockchainMemberName, context).getValue();
        return this;
    }

    public Response<ApiKeyCollection> listApiKeysWithResponse(Context context) {
        return serviceManager.blockchainMembers().listApiKeysWithResponse(blockchainMemberName, resourceGroupName,
            context);
    }
    ...
    public Response<ApiKeyCollection> listRegenerateApiKeysWithResponse(ApiKey apiKey, Context context) {
        return serviceManager.blockchainMembers().listRegenerateApiKeysWithResponse(blockchainMemberName,
            resourceGroupName, apiKey, context);
    }
