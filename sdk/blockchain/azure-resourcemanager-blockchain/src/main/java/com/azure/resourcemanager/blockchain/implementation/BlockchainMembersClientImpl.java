...
public final class BlockchainMembersClientImpl implements BlockchainMembersClient {
    ...
    public interface BlockchainMembersService {
        ...
        Mono<Response<BlockchainMemberInner>> getByResourceGroup(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("blockchainMemberName") String blockchainMemberName, @HeaderParam("Accept") String accept,
            Context context);
        ...
        Mono<Response<Flux<ByteBuffer>>> create(@HostParam("$host") String endpoint,
            ...
            @BodyParam("application/json") BlockchainMemberInner blockchainMember, @HeaderParam("Accept") String accept,
            Context context);
        ...
        Mono<Response<Flux<ByteBuffer>>> delete(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("blockchainMemberName") String blockchainMemberName, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<BlockchainMemberInner>> update(@HostParam("$host") String endpoint,
            @PathParam("blockchainMemberName") String blockchainMemberName,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<BlockchainMemberCollection>> listByResourceGroup(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<BlockchainMemberCollection>> list(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ConsortiumMemberCollection>> listConsortiumMembers(@HostParam("$host") String endpoint,
            @PathParam("blockchainMemberName") String blockchainMemberName,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @HeaderParam("Accept") String accept,
            Context context);
    ...
    private Mono<Response<BlockchainMemberInner>> getByResourceGroupWithResponseAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(context -> service.getByResourceGroup(this.client.getEndpoint(), resourceGroupName,
                this.client.getApiVersion(), this.client.getSubscriptionId(), blockchainMemberName, accept, context))
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<BlockchainMemberInner>> getByResourceGroupWithResponseAsync(String resourceGroupName,
        String blockchainMemberName, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service.getByResourceGroup(this.client.getEndpoint(), resourceGroupName, this.client.getApiVersion(),
            this.client.getSubscriptionId(), blockchainMemberName, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<BlockchainMemberInner> getByResourceGroupWithResponse(String resourceGroupName,
        String blockchainMemberName, Context context) {
    ...
    public BlockchainMemberInner getByResourceGroup(String resourceGroupName, String blockchainMemberName) {
        return getByResourceGroupWithResponse(resourceGroupName, blockchainMemberName, Context.NONE).getValue();
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> createWithResponseAsync(String blockchainMemberName,
        String resourceGroupName, BlockchainMemberInner blockchainMember) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return FluxUtil
            .withContext(
                context -> service.create(this.client.getEndpoint(), blockchainMemberName, this.client.getApiVersion(),
                    this.client.getSubscriptionId(), resourceGroupName, blockchainMember, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> createWithResponseAsync(String blockchainMemberName,
        String resourceGroupName, BlockchainMemberInner blockchainMember, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.create(this.client.getEndpoint(), blockchainMemberName, this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, blockchainMember, accept, context);
    }
    ...
    private PollerFlux<PollResult<BlockchainMemberInner>, BlockchainMemberInner> beginCreateAsync(
        ...
        return this.client.<BlockchainMemberInner, BlockchainMemberInner>getLroResult(mono,
            this.client.getHttpPipeline(), BlockchainMemberInner.class, BlockchainMemberInner.class,
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<BlockchainMemberInner>, BlockchainMemberInner>
        beginCreateAsync(String blockchainMemberName, String resourceGroupName) {
    ...
    private PollerFlux<PollResult<BlockchainMemberInner>, BlockchainMemberInner> beginCreateAsync(
        ...
        return this.client.<BlockchainMemberInner, BlockchainMemberInner>getLroResult(mono,
            this.client.getHttpPipeline(), BlockchainMemberInner.class, BlockchainMemberInner.class, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<BlockchainMemberInner>, BlockchainMemberInner> beginCreate(String blockchainMemberName,
        String resourceGroupName) {
        final BlockchainMemberInner blockchainMember = null;
        return this.beginCreateAsync(blockchainMemberName, resourceGroupName, blockchainMember).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<BlockchainMemberInner>, BlockchainMemberInner> beginCreate(String blockchainMemberName,
        String resourceGroupName, BlockchainMemberInner blockchainMember, Context context) {
        return this.beginCreateAsync(blockchainMemberName, resourceGroupName, blockchainMember, context)
            .getSyncPoller();
    }
    ...
    private Mono<BlockchainMemberInner> createAsync(String blockchainMemberName, String resourceGroupName,
        ...
        return beginCreateAsync(blockchainMemberName, resourceGroupName, blockchainMember).last()
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<BlockchainMemberInner> createAsync(String blockchainMemberName, String resourceGroupName,
        BlockchainMemberInner blockchainMember, Context context) {
        return beginCreateAsync(blockchainMemberName, resourceGroupName, blockchainMember, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> deleteWithResponseAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(context -> service.delete(this.client.getEndpoint(), resourceGroupName,
                this.client.getApiVersion(), this.client.getSubscriptionId(), blockchainMemberName, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> deleteWithResponseAsync(String resourceGroupName,
        ...
        return service.delete(this.client.getEndpoint(), resourceGroupName, this.client.getApiVersion(),
            this.client.getSubscriptionId(), blockchainMemberName, context);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String blockchainMemberName) {
        return this.beginDeleteAsync(resourceGroupName, blockchainMemberName).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String blockchainMemberName,
        Context context) {
        return this.beginDeleteAsync(resourceGroupName, blockchainMemberName, context).getSyncPoller();
    }
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String blockchainMemberName) {
        return beginDeleteAsync(resourceGroupName, blockchainMemberName).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String blockchainMemberName, Context context) {
        return beginDeleteAsync(resourceGroupName, blockchainMemberName, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<BlockchainMemberInner>> updateWithResponseAsync(String blockchainMemberName,
        String resourceGroupName, BlockchainMemberUpdate blockchainMember) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return FluxUtil
            .withContext(
                context -> service.update(this.client.getEndpoint(), blockchainMemberName, this.client.getApiVersion(),
                    this.client.getSubscriptionId(), resourceGroupName, blockchainMember, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<BlockchainMemberInner>> updateWithResponseAsync(String blockchainMemberName,
        String resourceGroupName, BlockchainMemberUpdate blockchainMember, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.update(this.client.getEndpoint(), blockchainMemberName, this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, blockchainMember, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<BlockchainMemberInner> updateWithResponse(String blockchainMemberName, String resourceGroupName,
        BlockchainMemberUpdate blockchainMember, Context context) {
    ...
    public BlockchainMemberInner update(String blockchainMemberName, String resourceGroupName) {
        final BlockchainMemberUpdate blockchainMember = null;
        return updateWithResponse(blockchainMemberName, resourceGroupName, blockchainMember, Context.NONE).getValue();
    }
    ...
    private Mono<PagedResponse<BlockchainMemberInner>> listByResourceGroupSinglePageAsync(String resourceGroupName) {
        ...
        return FluxUtil
            ...
            .<PagedResponse<BlockchainMemberInner>>map(res -> new PagedResponseBase<>(res.getRequest(),
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return collection of consortium payload along with {@link PagedResponse} on successful completion of
     * {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<ConsortiumMemberInner>> listConsortiumMembersSinglePageAsync(String blockchainMemberName,
        String resourceGroupName) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.listConsortiumMembers(this.client.getEndpoint(), blockchainMemberName,
                this.client.getApiVersion(), this.client.getSubscriptionId(), resourceGroupName, accept, context))
            .<PagedResponse<ConsortiumMemberInner>>map(res -> new PagedResponseBase<>(res.getRequest(),
                res.getStatusCode(), res.getHeaders(), res.getValue().value(), res.getValue().nextLink(), null))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<PagedResponse<ConsortiumMemberInner>> listConsortiumMembersSinglePageAsync(String blockchainMemberName,
        ...
        context = this.client.mergeContext(context);
        return service
            .listConsortiumMembers(this.client.getEndpoint(), blockchainMemberName, this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, accept, context)
            .map(res -> new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(),
                res.getValue().value(), res.getValue().nextLink(), null));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<ConsortiumMemberInner> listConsortiumMembersAsync(String blockchainMemberName,
        String resourceGroupName) {
        return new PagedFlux<>(() -> listConsortiumMembersSinglePageAsync(blockchainMemberName, resourceGroupName),
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<ConsortiumMemberInner> listConsortiumMembers(String blockchainMemberName,
        String resourceGroupName) {
    ...
    private Mono<Response<ApiKeyCollectionInner>> listApiKeysWithResponseAsync(String blockchainMemberName,
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.listApiKeys(this.client.getEndpoint(), blockchainMemberName,
                this.client.getApiVersion(), this.client.getSubscriptionId(), resourceGroupName, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<ApiKeyCollectionInner>> listApiKeysWithResponseAsync(String blockchainMemberName,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.listApiKeys(this.client.getEndpoint(), blockchainMemberName, this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, accept, context);
    }
    ...
    public ApiKeyCollectionInner listApiKeys(String blockchainMemberName, String resourceGroupName) {
        return listApiKeysWithResponse(blockchainMemberName, resourceGroupName, Context.NONE).getValue();
    }
    ...
    private Mono<Response<ApiKeyCollectionInner>> listRegenerateApiKeysWithResponseAsync(String blockchainMemberName,
        String resourceGroupName, ApiKey apiKey) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return FluxUtil
            .withContext(context -> service.listRegenerateApiKeys(this.client.getEndpoint(), blockchainMemberName,
                this.client.getApiVersion(), this.client.getSubscriptionId(), resourceGroupName, apiKey, accept,
                context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ApiKeyCollectionInner>> listRegenerateApiKeysWithResponseAsync(String blockchainMemberName,
        String resourceGroupName, ApiKey apiKey, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.listRegenerateApiKeys(this.client.getEndpoint(), blockchainMemberName,
    ...
    public ApiKeyCollectionInner listRegenerateApiKeys(String blockchainMemberName, String resourceGroupName) {
        final ApiKey apiKey = null;
        return listRegenerateApiKeysWithResponse(blockchainMemberName, resourceGroupName, apiKey, Context.NONE)
            .getValue();
    }
    ...
    private Mono<PagedResponse<ConsortiumMemberInner>> listConsortiumMembersNextSinglePageAsync(String nextLink,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.listConsortiumMembersNext(nextLink, this.client.getEndpoint(), accept, context)
            .map(res -> new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(),
                res.getValue().value(), res.getValue().nextLink(), null));
    }
}
