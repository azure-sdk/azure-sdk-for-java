...
public final class BlockchainMemberOperationResultsClientImpl implements BlockchainMemberOperationResultsClient {
    ...
    BlockchainMemberOperationResultsClientImpl(BlockchainManagementClientImpl client) {
        this.service = RestProxy.create(BlockchainMemberOperationResultsService.class, client.getHttpPipeline(),
            client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for BlockchainManagementClientBlockchainMemberOperationResults to be
     * used by the proxy service to perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "BlockchainManagement")
    public interface BlockchainMemberOperationResultsService {
    ...
    private Mono<Response<OperationResultInner>> getWithResponseAsync(String locationName, String operationId) {
        ...
        return FluxUtil
            .withContext(context -> service.get(this.client.getEndpoint(), locationName, operationId,
    ...
    private Mono<Response<OperationResultInner>> getWithResponseAsync(String locationName, String operationId,
        ...
        return service.get(this.client.getEndpoint(), locationName, operationId, this.client.getApiVersion(),
