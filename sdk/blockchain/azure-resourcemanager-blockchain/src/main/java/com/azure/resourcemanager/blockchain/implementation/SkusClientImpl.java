...
public final class SkusClientImpl implements SkusClient {
     ...
     */
    SkusClientImpl(BlockchainManagementClientImpl client) {
        this.service = RestProxy.create(SkusService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for BlockchainManagementClientSkus to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{$host}")
    ...
    public interface SkusService {
        ...
        Mono<Response<ResourceTypeSkuCollectionInner>> list(@HostParam("$host") String endpoint,
     ...
     * @return collection of the resource type Sku along with {@link Response} on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ResourceTypeSkuCollectionInner>> listWithResponseAsync() {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ResourceTypeSkuCollectionInner>> listWithResponseAsync(Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return collection of the resource type Sku on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ResourceTypeSkuCollectionInner> listAsync() {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ResourceTypeSkuCollectionInner> listWithResponse(Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ResourceTypeSkuCollectionInner list() {
