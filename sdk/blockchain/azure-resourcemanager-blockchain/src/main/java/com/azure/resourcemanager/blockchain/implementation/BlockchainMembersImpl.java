...
public final class BlockchainMembersImpl implements BlockchainMembers {
    ...
    public BlockchainMembersImpl(BlockchainMembersClient innerClient,
        com.azure.resourcemanager.blockchain.BlockchainManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public Response<BlockchainMember> getByResourceGroupWithResponse(String resourceGroupName,
    ...
    public PagedIterable<BlockchainMember> listByResourceGroup(String resourceGroupName) {
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new BlockchainMemberImpl(inner1, this.manager()));
    }
    ...
    public PagedIterable<ConsortiumMember> listConsortiumMembers(String blockchainMemberName,
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new ConsortiumMemberImpl(inner1, this.manager()));
    }

    public PagedIterable<ConsortiumMember> listConsortiumMembers(String blockchainMemberName, String resourceGroupName,
        Context context) {
        PagedIterable<ConsortiumMemberInner> inner
    ...
    public Response<ApiKeyCollection> listApiKeysWithResponse(String blockchainMemberName, String resourceGroupName,
        Context context) {
