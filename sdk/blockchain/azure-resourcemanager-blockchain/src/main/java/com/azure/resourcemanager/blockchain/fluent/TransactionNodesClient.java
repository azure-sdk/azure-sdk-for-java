...
public interface TransactionNodesClient {
    ...
    Response<TransactionNodeInner> getWithResponse(String blockchainMemberName, String transactionNodeName,
    ...
    SyncPoller<PollResult<TransactionNodeInner>, TransactionNodeInner> beginCreate(String blockchainMemberName,
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<Void>, Void> beginDelete(String blockchainMemberName, String transactionNodeName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<TransactionNodeInner> updateWithResponse(String blockchainMemberName, String transactionNodeName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<ApiKeyCollectionInner> listApiKeysWithResponse(String blockchainMemberName, String transactionNodeName,
        String resourceGroupName, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ApiKeyCollectionInner listApiKeys(String blockchainMemberName, String transactionNodeName,
        String resourceGroupName);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<ApiKeyCollectionInner> listRegenerateApiKeysWithResponse(String blockchainMemberName,
