...
public interface BlockchainMembersClient {
    ...
    Response<BlockchainMemberInner> getByResourceGroupWithResponse(String resourceGroupName,
    ...
    SyncPoller<PollResult<BlockchainMemberInner>, BlockchainMemberInner> beginCreate(String blockchainMemberName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<BlockchainMemberInner> updateWithResponse(String blockchainMemberName, String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<ApiKeyCollectionInner> listApiKeysWithResponse(String blockchainMemberName, String resourceGroupName,
        Context context);
