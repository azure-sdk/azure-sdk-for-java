...
import com.azure.resourcemanager.blockchain.models.ResourceProviderOperationCollection;
...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    OperationsClientImpl(BlockchainManagementClientImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for BlockchainManagementClientOperations to be used by the proxy service
    ...
    public interface OperationsService {
        ...
        Mono<Response<ResourceProviderOperationCollection>> list(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ResourceProviderOperationCollection>> listNext(
     ...
     * @return collection of operation payload which is exposed in the response of the resource provider along with
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return collection of operation payload which is exposed in the response of the resource provider as paginated
