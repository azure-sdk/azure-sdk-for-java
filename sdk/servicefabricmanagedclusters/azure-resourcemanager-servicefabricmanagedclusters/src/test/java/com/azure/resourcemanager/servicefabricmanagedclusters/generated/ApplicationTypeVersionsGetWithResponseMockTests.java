...
public final class ApplicationTypeVersionsGetWithResponseMockTests {
    ...
    public void testGetWithResponse() throws Exception {
        String responseStr
            = "{\"properties\":{\"provisioningState\":\"ohu\",\"appPackageUrl\":\"swtwkozzwc\"},\"tags\":{\"j\":\"bawpfajnjwltlwt\"},\"location\":\"ktalhsnvkcdmxz\",\"id\":\"oaimlnw\",\"name\":\"aaomylweazu\",\"type\":\"cse\"}";
        ...
        ApplicationTypeVersionResource response = manager.applicationTypeVersions()
            .getWithResponse("rgaehvvibrxjj", "toqbeitpkxztmoob", "lftidgfcwqmpim", "qxzhem",
                com.azure.core.util.Context.NONE)
            .getValue();

        Assertions.assertEquals("bawpfajnjwltlwt", response.tags().get("j"));
        Assertions.assertEquals("ktalhsnvkcdmxz", response.location());
        Assertions.assertEquals("swtwkozzwc", response.appPackageUrl());
    }
}
