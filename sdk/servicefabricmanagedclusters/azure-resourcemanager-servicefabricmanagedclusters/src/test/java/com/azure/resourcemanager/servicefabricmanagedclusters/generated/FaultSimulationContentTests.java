...
public final class FaultSimulationContentTests {
    ...
    public void testDeserialize() throws Exception {
        FaultSimulationContent model = BinaryData.fromString(
            "{\"faultKind\":\"FaultSimulationContent\",\"force\":true,\"constraints\":{\"expirationTime\":\"2021-05-04T06:37:39Z\"}}")
            .toObject(FaultSimulationContent.class);
        Assertions.assertEquals(true, model.force());
        Assertions.assertEquals(OffsetDateTime.parse("2021-05-04T06:37:39Z"), model.constraints().expirationTime());
    }
    ...
    public void testSerialize() throws Exception {
        FaultSimulationContent model = new FaultSimulationContent().withForce(true)
            .withConstraints(
                new FaultSimulationConstraints().withExpirationTime(OffsetDateTime.parse("2021-05-04T06:37:39Z")));
