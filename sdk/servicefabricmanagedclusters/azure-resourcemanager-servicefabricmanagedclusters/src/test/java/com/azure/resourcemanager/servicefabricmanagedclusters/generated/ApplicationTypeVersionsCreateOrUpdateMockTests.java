...
public final class ApplicationTypeVersionsCreateOrUpdateMockTests {
    ...
    public void testCreateOrUpdate() throws Exception {
        String responseStr
            = "{\"properties\":{\"provisioningState\":\"Succeeded\",\"appPackageUrl\":\"xtxj\"},\"tags\":{\"ssjhoiftxfkf\":\"eafidltugsresm\",\"ucb\":\"egprhptil\"},\"location\":\"tgdqohmcwsldriz\",\"id\":\"pwbralllibphbqz\",\"name\":\"izakak\",\"type\":\"nkjpdnjzha\"}";
        ...
        ApplicationTypeVersionResource response = manager.applicationTypeVersions()
            .define("zvulj")
            .withExistingApplicationType("obrjlnacgcc", "knh", "kizvytn")
            .withRegion("tg")
            .withTags(mapOf("jbjsvgjrwh", "isdos", "nwm", "yvycytdclxgcckn", "a", "tmvpdvjdhtt", "rjdqnsdfzp",
                "fedxihchrphkm"))
            .withAppPackageUrl("roylaxxu")
            .create();

        Assertions.assertEquals("eafidltugsresm", response.tags().get("ssjhoiftxfkf"));
        Assertions.assertEquals("tgdqohmcwsldriz", response.location());
        Assertions.assertEquals("xtxj", response.appPackageUrl());
    }
