...
public final class ManagedUnsupportedVMSizesGetWithResponseMockTests {
    ...
    public void testGetWithResponse() throws Exception {
        String responseStr
            = "{\"properties\":{\"size\":\"rkywuhpsvfuu\"},\"id\":\"tlwexxwlalniexz\",\"name\":\"zpgepqty\",\"type\":\"wwpgdakchzyvlixq\"}";
        ...
        ManagedVMSize response = manager.managedUnsupportedVMSizes()
            .getWithResponse("wumuaslzk", "rrwoycqucwyhahn", com.azure.core.util.Context.NONE)
            .getValue();
