...
public final class ManagedVMSizesGetWithResponseMockTests {
    @Test
    public void testGetWithResponse() throws Exception {
        String responseStr = "{\"properties\":{\"size\":\"xa\"},\"id\":\"uy\",\"name\":\"p\",\"type\":\"sdaultxij\"}";
        ...
        ManagedVMSize response = manager.managedVMSizes()
            .getWithResponse("qwpwyawbzasqbuc", "jg", com.azure.core.util.Context.NONE)
            .getValue();
