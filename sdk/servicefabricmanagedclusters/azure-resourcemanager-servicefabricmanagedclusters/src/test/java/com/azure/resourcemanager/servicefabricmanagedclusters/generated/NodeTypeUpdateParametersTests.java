...
public final class NodeTypeUpdateParametersTests {
    ...
    public void testDeserialize() throws Exception {
        NodeTypeUpdateParameters model = BinaryData.fromString(
            "{\"tags\":{\"xdtnkdmkqjjlw\":\"zxnfaaz\",\"aysjkixqtnqttez\":\"envrkpyouaibrebq\",\"akpjpqqmtedlt\":\"wfff\",\"auyqncygupkv\":\"mjihyeozphv\"},\"sku\":{\"name\":\"dscwxqupevzhf\",\"tier\":\"otxhojujby\",\"capacity\":1731267363}}")
            .toObject(NodeTypeUpdateParameters.class);
        Assertions.assertEquals("zxnfaaz", model.tags().get("xdtnkdmkqjjlw"));
        Assertions.assertEquals("dscwxqupevzhf", model.sku().name());
        Assertions.assertEquals("otxhojujby", model.sku().tier());
        Assertions.assertEquals(1731267363, model.sku().capacity());
    }
    ...
    public void testSerialize() throws Exception {
        NodeTypeUpdateParameters model = new NodeTypeUpdateParameters()
            ...
            .withSku(new NodeTypeSku().withName("dscwxqupevzhf").withTier("otxhojujby").withCapacity(1731267363));
