...
public final class FaultSimulationConstraintsTests {
    ...
    public void testDeserialize() throws Exception {
        FaultSimulationConstraints model = BinaryData.fromString("{\"expirationTime\":\"2021-08-29T18:49:11Z\"}")
            .toObject(FaultSimulationConstraints.class);
        Assertions.assertEquals(OffsetDateTime.parse("2021-08-29T18:49:11Z"), model.expirationTime());
    }

    @org.junit.jupiter.api.Test
    public void testSerialize() throws Exception {
        FaultSimulationConstraints model
            = new FaultSimulationConstraints().withExpirationTime(OffsetDateTime.parse("2021-08-29T18:49:11Z"));
