...
public final class ManagedVMSizesListMockTests {
    @Test
    public void testList() throws Exception {
        String responseStr
            = "{\"value\":[{\"properties\":{\"size\":\"azlnqnmcjngzqdqx\"},\"id\":\"jw\",\"name\":\"yfu\",\"type\":\"zsvtuikzhajqgl\"}]}";
        ...
        PagedIterable<ManagedVMSize> response = manager.managedVMSizes().list("um", com.azure.core.util.Context.NONE);
