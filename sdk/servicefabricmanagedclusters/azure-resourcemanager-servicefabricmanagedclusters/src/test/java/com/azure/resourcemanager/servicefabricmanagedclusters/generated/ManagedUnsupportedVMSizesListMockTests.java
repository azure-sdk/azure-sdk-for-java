...
public final class ManagedUnsupportedVMSizesListMockTests {
    ...
    public void testList() throws Exception {
        String responseStr
            = "{\"value\":[{\"properties\":{\"size\":\"xmysuxswqrntv\"},\"id\":\"ijpstte\",\"name\":\"qqpwcyyuf\",\"type\":\"runcuwmqspkcd\"}]}";
        ...
        PagedIterable<ManagedVMSize> response
            = manager.managedUnsupportedVMSizes().list("rkcxkj", com.azure.core.util.Context.NONE);
