...
public final class ApplicationTypesGetWithResponseMockTests {
    ...
    public void testGetWithResponse() throws Exception {
        String responseStr
            = "{\"properties\":{\"provisioningState\":\"unzo\"},\"tags\":{\"dyuib\":\"hcxgkmoyx\",\"zydvfvf\":\"mfdn\",\"vhmgorffukis\":\"jnaeois\"},\"location\":\"w\",\"id\":\"hwplefaxvx\",\"name\":\"l\",\"type\":\"btgn\"}";
        ...
        ApplicationTypeResource response = manager.applicationTypes()
            .getWithResponse("rafwgckhocxvdf", "fwafqrouda", "pavehhr", com.azure.core.util.Context.NONE)
            .getValue();

        Assertions.assertEquals("hcxgkmoyx", response.tags().get("dyuib"));
