...
public final class ApplicationTypesGetWithResponseMockTests {
    ...
    public void testGetWithResponse() throws Exception {
        String responseStr
            = "{\"properties\":{\"provisioningState\":\"talhsnvkcdmxzr\"},\"tags\":{\"azul\":\"imlnwiaaomylw\",\"jhlfzswpchwahf\":\"sethwwn\",\"wlyxgncxyk\":\"ousnfepgfewe\"},\"location\":\"djhlimm\",\"id\":\"x\",\"name\":\"h\",\"type\":\"cporxvxcjz\"}";
        ...
        ApplicationTypeResource response = manager.applicationTypes()
            .getWithResponse("hujswtwkozzwcul", "bawpfajnjwltlwt", "j", com.azure.core.util.Context.NONE)
            .getValue();

        Assertions.assertEquals("imlnwiaaomylw", response.tags().get("azul"));
        Assertions.assertEquals("djhlimm", response.location());
    }
}
