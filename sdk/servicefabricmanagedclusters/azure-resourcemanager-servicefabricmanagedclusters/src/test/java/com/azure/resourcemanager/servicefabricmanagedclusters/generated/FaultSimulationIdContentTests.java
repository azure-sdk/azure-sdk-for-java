...
public final class FaultSimulationIdContentTests {
    ...
    public void testDeserialize() throws Exception {
        FaultSimulationIdContent model
            = BinaryData.fromString("{\"simulationId\":\"evfdnwnwm\"}").toObject(FaultSimulationIdContent.class);
        Assertions.assertEquals("evfdnwnwm", model.simulationId());
    }

    @org.junit.jupiter.api.Test
    public void testSerialize() throws Exception {
        FaultSimulationIdContent model = new FaultSimulationIdContent().withSimulationId("evfdnwnwm");
