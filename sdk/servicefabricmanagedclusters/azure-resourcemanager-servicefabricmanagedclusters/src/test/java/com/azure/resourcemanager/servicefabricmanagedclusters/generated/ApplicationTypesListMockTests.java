...
public final class ApplicationTypesListMockTests {
    ...
    public void testList() throws Exception {
        String responseStr
            = "{\"value\":[{\"properties\":{\"provisioningState\":\"jcivmmg\"},\"tags\":{\"uvyinzqodfvpgs\":\"fiwrxgkn\"},\"location\":\"xgsg\",\"id\":\"fgzdjtxvz\",\"name\":\"lbqvgaqvlgafcqu\",\"type\":\"rdve\"}]}";
        ...
        PagedIterable<ApplicationTypeResource> response
            = manager.applicationTypes().list("qizxfpxtgqscjavf", "juhdqazkmtgguwpi", com.azure.core.util.Context.NONE);

        Assertions.assertEquals("fiwrxgkn", response.iterator().next().tags().get("uvyinzqodfvpgs"));
        Assertions.assertEquals("xgsg", response.iterator().next().location());
    }
}
