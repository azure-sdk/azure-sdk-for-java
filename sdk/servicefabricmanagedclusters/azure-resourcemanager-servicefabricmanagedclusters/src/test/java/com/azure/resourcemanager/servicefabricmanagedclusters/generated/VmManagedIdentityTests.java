...
public final class VmManagedIdentityTests {
    ...
    public void testDeserialize() throws Exception {
        VmManagedIdentity model
            = BinaryData.fromString("{\"userAssignedIdentities\":[\"yvblmhvkzu\",\"bxvvyhg\",\"opbyrqufegxu\",\"wz\"]}")
                .toObject(VmManagedIdentity.class);
        Assertions.assertEquals("yvblmhvkzu", model.userAssignedIdentities().get(0));
    }

    @org.junit.jupiter.api.Test
    public void testSerialize() throws Exception {
        VmManagedIdentity model = new VmManagedIdentity()
            .withUserAssignedIdentities(Arrays.asList("yvblmhvkzu", "bxvvyhg", "opbyrqufegxu", "wz"));
