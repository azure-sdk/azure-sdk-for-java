...
public final class NodeTypesListMockTests {
    @Test
    public void testList() throws Exception {
        String responseStr
            = "{\"value\":[{\"resourceType\":\"ixtmkzjvkviirhgf\",\"sku\":{\"name\":\"sdp\",\"tier\":\"atzv\"},\"capacity\":{\"minimum\":1946908693,\"maximum\":39003903,\"default\":1015396503,\"scaleType\":\"Automatic\"}}]}";
        ...
        PagedIterable<NodeTypeAvailableSku> response
            = manager.nodeTypes().list("mpizru", "n", "qxpxiwfcngjsaa", com.azure.core.util.Context.NONE);
