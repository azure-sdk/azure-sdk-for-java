...
public final class NodeTypeImpl implements NodeType, NodeType.Definition, NodeType.Update {
    ...
    public void deallocate(NodeTypeActionParameters parameters) {
        serviceManager.nodeTypes().deallocate(resourceGroupName, clusterName, nodeTypeName, parameters);
    }

    public void deallocate(NodeTypeActionParameters parameters, Context context) {
        serviceManager.nodeTypes().deallocate(resourceGroupName, clusterName, nodeTypeName, parameters, context);
    }
    ...
    public void redeploy(NodeTypeActionParameters parameters) {
        serviceManager.nodeTypes().redeploy(resourceGroupName, clusterName, nodeTypeName, parameters);
    }

    public void redeploy(NodeTypeActionParameters parameters, Context context) {
        serviceManager.nodeTypes().redeploy(resourceGroupName, clusterName, nodeTypeName, parameters, context);
    }
    ...
    public void start(NodeTypeActionParameters parameters) {
        serviceManager.nodeTypes().start(resourceGroupName, clusterName, nodeTypeName, parameters);
    }
