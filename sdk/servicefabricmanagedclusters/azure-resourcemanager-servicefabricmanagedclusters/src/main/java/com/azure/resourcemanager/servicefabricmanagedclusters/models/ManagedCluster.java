...
public interface ManagedCluster {
    ...
    /**
     * Gets the enableAutoOSUpgrade property: Enables automatic OS upgrade for node types created using OS images with
    ...
    /**
     * Gets the allocatedOutboundPorts property: The number of outbound ports allocated for SNAT for each node in the
    ...
    /**
     * Gets the vMImage property: The VM image the node types are configured with. This property controls the Service
    ...
    interface DefinitionStages {
        ...
        interface WithCreate
            ...
            DefinitionStages.WithAutoGeneratedDomainNameLabelScope, DefinitionStages.WithAllocatedOutboundPorts,
        ...
        interface WithEnableAutoOSUpgrade {
            /**
             * Specifies the enableAutoOSUpgrade property: Enables automatic OS upgrade for node types created using OS
             * images with version 'latest'. The default value for this setting is false..
             * 
             * @param enableAutoOSUpgrade Enables automatic OS upgrade for node types created using OS images with
             * version 'latest'. The default value for this setting is false.
             * @return the next definition stage.
             */
        ...
        /**
         * The stage of the ManagedCluster definition allowing to specify allocatedOutboundPorts.
         */
        interface WithAllocatedOutboundPorts {
            /**
             * Specifies the allocatedOutboundPorts property: The number of outbound ports allocated for SNAT for each
             * node in the backend pool of the default load balancer. The default value is 0 which provides dynamic port
             * allocation based on pool size..
             * 
             * @param allocatedOutboundPorts The number of outbound ports allocated for SNAT for each node in the
             * backend pool of the default load balancer. The default value is 0 which provides dynamic port allocation
             * based on pool size.
             * @return the next definition stage.
             */
            WithCreate withAllocatedOutboundPorts(Integer allocatedOutboundPorts);
        }

        /**
         * The stage of the ManagedCluster definition allowing to specify vMImage.
         */
        interface WithVMImage {
            /**
             * Specifies the vMImage property: The VM image the node types are configured with. This property controls
             * the Service Fabric component packages to be used for the cluster. Allowed values are: 'Windows'. The
             * default value is 'Windows'..
             * 
             * @param vMImage The VM image the node types are configured with. This property controls the Service Fabric
             * component packages to be used for the cluster. Allowed values are: 'Windows'. The default value is
             * 'Windows'.
             * @return the next definition stage.
             */
     ...
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     */
    void startFaultSimulation(FaultSimulationContent parameters);
     ...
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     */
    void startFaultSimulation(FaultSimulationContent parameters, Context context);
