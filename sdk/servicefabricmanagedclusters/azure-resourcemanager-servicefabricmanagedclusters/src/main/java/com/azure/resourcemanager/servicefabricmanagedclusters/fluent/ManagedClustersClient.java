...
public interface ManagedClustersClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    void startFaultSimulation(String resourceGroupName, String clusterName, FaultSimulationContent parameters);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<ManagedMaintenanceWindowStatusInner>
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ManagedMaintenanceWindowStatusInner managedMaintenanceWindowStatusGet(String resourceGroupName, String clusterName);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<ManagedAzResiliencyStatusInner> managedAzResiliencyStatusGetWithResponse(String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ManagedAzResiliencyStatusInner managedAzResiliencyStatusGet(String resourceGroupName, String clusterName);
}
