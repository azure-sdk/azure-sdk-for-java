...
public final class ManagedClusterImpl implements ManagedCluster, ManagedCluster.Definition, ManagedCluster.Update {
    ...
    public void startFaultSimulation(FaultSimulationContent parameters) {
        serviceManager.managedClusters().startFaultSimulation(resourceGroupName, clusterName, parameters);
    }

    public void startFaultSimulation(FaultSimulationContent parameters, Context context) {
    ...
    public Response<Void> postWithResponse(Context context) {
        return serviceManager.managedClusters().postWithResponse(resourceGroupName, clusterName, context);
    }

    public void post() {
        serviceManager.managedClusters().post(resourceGroupName, clusterName);
    }

    public Response<ManagedMaintenanceWindowStatus> managedMaintenanceWindowStatusGetWithResponse(Context context) {
        return serviceManager.managedClusters()
            .managedMaintenanceWindowStatusGetWithResponse(resourceGroupName, clusterName, context);
    }

    public ManagedMaintenanceWindowStatus managedMaintenanceWindowStatusGet() {
        return serviceManager.managedClusters().managedMaintenanceWindowStatusGet(resourceGroupName, clusterName);
    }

    public Response<ManagedAzResiliencyStatus> managedAzResiliencyStatusGetWithResponse(Context context) {
        return serviceManager.managedClusters()
            .managedAzResiliencyStatusGetWithResponse(resourceGroupName, clusterName, context);
    }

    public ManagedAzResiliencyStatus managedAzResiliencyStatusGet() {
        return serviceManager.managedClusters().managedAzResiliencyStatusGet(resourceGroupName, clusterName);
    }
