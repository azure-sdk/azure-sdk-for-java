...
public final class ManagedClustersClientImpl implements ManagedClustersClient {
    ...
    public interface ManagedClustersService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ManagedMaintenanceWindowStatusInner>> managedMaintenanceWindowStatusGet(
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ManagedAzResiliencyStatusInner>> managedAzResiliencyStatusGet(
            @HostParam("endpoint") String endpoint, @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("clusterName") String clusterName,
            @HeaderParam("Accept") String accept, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ManagedMaintenanceWindowStatusInner>>
        managedMaintenanceWindowStatusGetWithResponseAsync(String resourceGroupName, String clusterName) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.managedMaintenanceWindowStatusGet(this.client.getEndpoint(),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ManagedMaintenanceWindowStatusInner>> managedMaintenanceWindowStatusGetWithResponseAsync(
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.managedMaintenanceWindowStatusGet(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, clusterName, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ManagedMaintenanceWindowStatusInner> managedMaintenanceWindowStatusGetAsync(String resourceGroupName,
        String clusterName) {
        return managedMaintenanceWindowStatusGetWithResponseAsync(resourceGroupName, clusterName)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ManagedMaintenanceWindowStatusInner>
        managedMaintenanceWindowStatusGetWithResponse(String resourceGroupName, String clusterName, Context context) {
        return managedMaintenanceWindowStatusGetWithResponseAsync(resourceGroupName, clusterName, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ManagedMaintenanceWindowStatusInner managedMaintenanceWindowStatusGet(String resourceGroupName,
        String clusterName) {
        return managedMaintenanceWindowStatusGetWithResponse(resourceGroupName, clusterName, Context.NONE).getValue();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ManagedAzResiliencyStatusInner>>
        managedAzResiliencyStatusGetWithResponseAsync(String resourceGroupName, String clusterName) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return FluxUtil
            .withContext(
                context -> service.managedAzResiliencyStatusGet(this.client.getEndpoint(), this.client.getApiVersion(),
                    this.client.getSubscriptionId(), resourceGroupName, clusterName, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ManagedAzResiliencyStatusInner>>
        managedAzResiliencyStatusGetWithResponseAsync(String resourceGroupName, String clusterName, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.managedAzResiliencyStatusGet(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, clusterName, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ManagedAzResiliencyStatusInner> managedAzResiliencyStatusGetAsync(String resourceGroupName,
        String clusterName) {
        return managedAzResiliencyStatusGetWithResponseAsync(resourceGroupName, clusterName)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ManagedAzResiliencyStatusInner> managedAzResiliencyStatusGetWithResponse(String resourceGroupName,
        String clusterName, Context context) {
        return managedAzResiliencyStatusGetWithResponseAsync(resourceGroupName, clusterName, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ManagedAzResiliencyStatusInner managedAzResiliencyStatusGet(String resourceGroupName, String clusterName) {
        return managedAzResiliencyStatusGetWithResponse(resourceGroupName, clusterName, Context.NONE).getValue();
    }
