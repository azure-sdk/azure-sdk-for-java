...
public final class ManagedVMSizesImpl implements ManagedVMSizes {
    private static final ClientLogger LOGGER = new ClientLogger(ManagedVMSizesImpl.class);

    private final ManagedVMSizesClient innerClient;

    private final com.azure.resourcemanager.servicefabricmanagedclusters.ServicefabricmanagedclustersManager serviceManager;

    public ManagedVMSizesImpl(ManagedVMSizesClient innerClient,
    ...
    private ManagedVMSizesClient serviceClient() {
