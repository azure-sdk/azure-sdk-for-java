...
public interface NodeType {
    ...
    /**
     * Gets the vmInstanceCount property: The number of nodes in the node type. **Values:** -1 - Use when auto scale
    ...
    /**
     * Gets the zoneBalance property: Setting this to true allows stateless node types to scale out without equal
    ...
    interface DefinitionStages {
        ...
        interface WithVmInstanceCount {
            /**
             * Specifies the vmInstanceCount property: The number of nodes in the node type. **Values:** -1 - Use when
             * auto scale rules are configured or sku.capacity is defined 0 - Not supported &gt;0 - Use for manual
             * scale..
             * 
             * @param vmInstanceCount The number of nodes in the node type. **Values:** -1 - Use when auto scale rules
             * are configured or sku.capacity is defined 0 - Not supported &gt;0 - Use for manual scale.
             * @return the next definition stage.
             */
        ...
        /**
         * The stage of the NodeType definition allowing to specify zoneBalance.
         */
        interface WithZoneBalance {
            /**
             * Specifies the zoneBalance property: Setting this to true allows stateless node types to scale out without
             * equal distribution across zones..
             * 
             * @param zoneBalance Setting this to true allows stateless node types to scale out without equal
             * distribution across zones.
             * @return the next definition stage.
             */
     ...
     */
    void deallocate(NodeTypeActionParameters parameters);
     ...
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     */
    void deallocate(NodeTypeActionParameters parameters, Context context);
     ...
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     */
    void redeploy(NodeTypeActionParameters parameters);
     ...
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     */
    void redeploy(NodeTypeActionParameters parameters, Context context);
     ...
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     */
    void start(NodeTypeActionParameters parameters);
