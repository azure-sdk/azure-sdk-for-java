...
public final class PublicIPAddressConfiguration implements JsonSerializable<PublicIPAddressConfiguration> {
     ...
     */
    public PublicIPAddressConfiguration withName(String name) {
        this.name = name;
        return this;
    }
     ...
     * @return the PublicIPAddressConfiguration object itself.
     */
    public PublicIPAddressConfiguration withPublicIPAddressVersion(PublicIPAddressVersion publicIPAddressVersion) {
        ...
        if (name() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property name in model PublicIPAddressConfiguration"));
        }
        if (ipTags() != null) {
    ...
    private static final ClientLogger LOGGER = new ClientLogger(PublicIPAddressConfiguration.class);
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("name".equals(fieldName)) {
                    deserializedPublicIPAddressConfiguration.name = reader.getString();
                    ...
                    deserializedPublicIPAddressConfiguration.publicIPAddressVersion
