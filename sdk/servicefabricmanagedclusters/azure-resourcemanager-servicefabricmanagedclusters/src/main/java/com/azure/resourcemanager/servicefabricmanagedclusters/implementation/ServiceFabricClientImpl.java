...
import com.azure.resourcemanager.servicefabricmanagedclusters.fluent.ManagedVMSizesClient;
...
/**
 * Initializes a new instance of the ServiceFabricClientImpl type.
 */
@ServiceClient(builder = ServiceFabricClientBuilder.class)
public final class ServiceFabricClientImpl implements ServiceFabricClient {
    /**
     * Service host.
     */
    ...
    /**
     * The ManagedVMSizesClient object to access its operations.
     */
    private final ManagedVMSizesClient managedVMSizes;

    /**
     * Gets the ManagedVMSizesClient object to access its operations.
     * 
     * @return the ManagedVMSizesClient object.
     */
    public ManagedVMSizesClient getManagedVMSizes() {
        return this.managedVMSizes;
    }
    ...
    /**
     * Initializes an instance of ServiceFabricClient client.
     * 
     ...
     */
    ServiceFabricClientImpl(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter,
        ...
        this.managedVMSizes = new ManagedVMSizesClientImpl(this);
    ...
    private static final ClientLogger LOGGER = new ClientLogger(ServiceFabricClientImpl.class);
}
