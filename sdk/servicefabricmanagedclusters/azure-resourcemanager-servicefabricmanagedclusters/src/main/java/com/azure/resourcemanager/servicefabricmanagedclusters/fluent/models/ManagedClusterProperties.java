...
public final class ManagedClusterProperties implements JsonSerializable<ManagedClusterProperties> {
    ...
    /*
     * This property is the entry point to using a public CA cert for your cluster cert. It specifies the level of reuse
     * allowed for the custom FQDN created, matching the subject of the public CA cert.
     */
