...
#### `models.ManagedMaintenanceWindowStatuses` was removed

#### `models.PublicIpAddressVersion` was removed

#### `ServiceFabricManagedClustersManager` was removed

#### `models.ManagedUnsupportedVMSizes` was removed
...
#### `models.NodeTypeSkus` was removed
...
#### `models.ManagedApplyMaintenanceWindows` was removed

#### `models.VmssExtension` was removed

#### `models.IpConfigurationPublicIpAddressConfiguration` was removed

#### `models.ManagedAzResiliencyStatuses` was removed
...
* `models.ManagedVMSizes` was added
...
* `managedMaintenanceWindowStatusGet(java.lang.String,java.lang.String)` was added
...
* `post(java.lang.String,java.lang.String)` was added
* `managedMaintenanceWindowStatusGetWithResponse(java.lang.String,java.lang.String,com.azure.core.util.Context)` was added
...
* `managedAzResiliencyStatusGet(java.lang.String,java.lang.String)` was added
* `postWithResponse(java.lang.String,java.lang.String,com.azure.core.util.Context)` was added
* `listFaultSimulation(java.lang.String,java.lang.String,com.azure.core.util.Context)` was added
* `managedAzResiliencyStatusGetWithResponse(java.lang.String,java.lang.String,com.azure.core.util.Context)` was added
...
* `stopFaultSimulation(models.FaultSimulationIdContent)` was added
* `managedMaintenanceWindowStatusGet()` was added
* `post()` was added
* `listFaultSimulation(com.azure.core.util.Context)` was added
...
* `getFaultSimulationWithResponse(models.FaultSimulationIdContent,com.azure.core.util.Context)` was added
* `startFaultSimulation(models.FaultSimulationContent,com.azure.core.util.Context)` was added
* `postWithResponse(com.azure.core.util.Context)` was added
* `getFaultSimulation(models.FaultSimulationIdContent)` was added
* `managedMaintenanceWindowStatusGetWithResponse(com.azure.core.util.Context)` was added
* `managedAzResiliencyStatusGetWithResponse(com.azure.core.util.Context)` was added
* `startFaultSimulation(models.FaultSimulationContent)` was added
* `managedAzResiliencyStatusGet()` was added
* `listFaultSimulation()` was added
