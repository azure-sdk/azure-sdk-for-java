...
public final class ClustersClientImpl implements ClustersClient {
    ...
    public interface ClustersService {
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Void>> triggerUpgradePost(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("clusterName") String clusterName,
    ...
    private Mono<Response<AvailableClustersListInner>> listAvailableClusterRegionWithResponseAsync() {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<AvailableClustersListInner> listAvailableClusterRegionAsync() {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ClusterInner> updateAsync(String resourceGroupName, String clusterName, ClusterInner parameters) {
    ...
    /**
     * Remove cluster preferences on whatever upgrades are scheduled.
     *
     * @param resourceGroupName Name of the resource group within the azure subscription.
     * @param clusterName The name of the Event Hubs Cluster.
     * @throws IllegalArgumentException thrown if parameters fail the validation.
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Void>> triggerUpgradePostWithResponseAsync(String resourceGroupName, String clusterName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Void>> triggerUpgradePostWithResponseAsync(
        String resourceGroupName, String clusterName, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> triggerUpgradePostAsync(String resourceGroupName, String clusterName) {
        return triggerUpgradePostWithResponseAsync(resourceGroupName, clusterName).flatMap(ignored -> Mono.empty());
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<Void> triggerUpgradePostWithResponse(
        String resourceGroupName, String clusterName, Context context) {
        return triggerUpgradePostWithResponseAsync(resourceGroupName, clusterName, context).block();
    }
    ...
    public void triggerUpgradePost(String resourceGroupName, String clusterName) {
        triggerUpgradePostWithResponse(resourceGroupName, clusterName, Context.NONE);
    }
