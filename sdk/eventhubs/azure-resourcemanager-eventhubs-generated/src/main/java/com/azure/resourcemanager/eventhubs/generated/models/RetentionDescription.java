...
public final class RetentionDescription {
    ...
    /*
     * Number of hours to retain the events for this Event Hub. If cleanupPolicy is Compact the returned value of this
     * property is Long.MaxValue
     */
    @JsonProperty(value = "retentionTimeInHours")
    private Long retentionTimeInHours;

    /*
     * The minimum time a message will remain ineligible for compaction in the log. Only applicable for logs that are
     * being compacted.
     */
