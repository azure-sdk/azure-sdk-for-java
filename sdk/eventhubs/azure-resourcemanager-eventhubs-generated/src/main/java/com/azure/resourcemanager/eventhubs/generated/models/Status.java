...
public final class Status extends ExpandableStringEnum<Status> {
    /** Static value Scheduled for Status. */
    public static final Status SCHEDULED = fromString("Scheduled");

    /** Static value Running for Status. */
    public static final Status RUNNING = fromString("Running");

    /** Static value Terminated for Status. */
    public static final Status TERMINATED = fromString("Terminated");
