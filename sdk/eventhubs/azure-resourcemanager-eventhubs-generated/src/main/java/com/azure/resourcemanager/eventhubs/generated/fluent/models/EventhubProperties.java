...
public final class EventhubProperties {
    ...
    /*
     * Denotes the type of timestamp the message will hold. Two types of timestamp types AppendTime, CreateTime.
     ...
     * Default value is AppendTime. If you are using AMQP protocol, CreateTime equals AppendTime for now and will full
     * have runtime support later.
     */
    @JsonProperty(value = "messageTimestampType")
    private TimestampType messageTimestampType;

    /*
     * Denotes the unique identifier for event hub and is generated by service while creating topic. This identifier
     * can be used in kafka runtime apis wherever a UUID is required e.g Fetch & Delete Topic. This identifier is not
     ...
     * @return the EventhubProperties object itself.
     */
    public EventhubProperties withMessageTimestampType(TimestampType messageTimestampType) {
