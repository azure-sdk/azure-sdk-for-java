...
public final class EventHubManagementClientImpl implements EventHubManagementClient {
    ...
    /** The UpgradeWindowsClient object to access its operations. */
    private final UpgradeWindowsClient upgradeWindows;

    /**
     * Gets the UpgradeWindowsClient object to access its operations.
     *
     * @return the UpgradeWindowsClient object.
     */
    public UpgradeWindowsClient getUpgradeWindows() {
        return this.upgradeWindows;
    }

    /** The UpgradeWindowHistoriesClient object to access its operations. */
    private final UpgradeWindowHistoriesClient upgradeWindowHistories;

    /**
     * Gets the UpgradeWindowHistoriesClient object to access its operations.
     *
     * @return the UpgradeWindowHistoriesClient object.
     */
    public UpgradeWindowHistoriesClient getUpgradeWindowHistories() {
        return this.upgradeWindowHistories;
    }

    /** The UpgradeWindowTriggersClient object to access its operations. */
    private final UpgradeWindowTriggersClient upgradeWindowTriggers;

    /**
     * Gets the UpgradeWindowTriggersClient object to access its operations.
     *
     * @return the UpgradeWindowTriggersClient object.
     */
    public UpgradeWindowTriggersClient getUpgradeWindowTriggers() {
        return this.upgradeWindowTriggers;
    }
    ...
    EventHubManagementClientImpl(
        ...
        this.upgradeWindows = new UpgradeWindowsClientImpl(this);
        this.upgradeWindowHistories = new UpgradeWindowHistoriesClientImpl(this);
        this.upgradeWindowTriggers = new UpgradeWindowTriggersClientImpl(this);
    }
