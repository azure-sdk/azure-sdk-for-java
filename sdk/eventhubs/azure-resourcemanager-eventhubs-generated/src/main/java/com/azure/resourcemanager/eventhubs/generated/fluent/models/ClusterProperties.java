...
import com.azure.resourcemanager.eventhubs.generated.models.ClusterUpgrade;
...
public final class ClusterProperties {
    ...
    /*
     * List of cluster upgrades performed onto this cluster
     */
    @JsonProperty(value = "clusterUpgradeList", access = JsonProperty.Access.WRITE_ONLY)
    private List<ClusterUpgrade> clusterUpgradeList;
    ...
    /**
     * Get the clusterUpgradeList property: List of cluster upgrades performed onto this cluster.
     *
     * @return the clusterUpgradeList value.
     */
    public List<ClusterUpgrade> clusterUpgradeList() {
        return this.clusterUpgradeList;
    }
    ...
    public void validate() {
        if (clusterUpgradeList() != null) {
            clusterUpgradeList().forEach(e -> e.validate());
        }
    }
}
