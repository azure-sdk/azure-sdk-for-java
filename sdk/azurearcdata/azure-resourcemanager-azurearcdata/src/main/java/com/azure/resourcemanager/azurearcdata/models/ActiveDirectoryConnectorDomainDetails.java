...
public final class ActiveDirectoryConnectorDomainDetails {
     ...
     * null
     */
    @JsonProperty(value = "domainControllers")
    ...
    /**
     * Get the realm property: Name (uppercase) of the Active Directory domain that this AD connector will be
     * associated with.
     * 
    ...
    /**
     * Set the realm property: Name (uppercase) of the Active Directory domain that this AD connector will be
     * associated with.
     * 
