...
public final class SqlServerDatabasesClientImpl implements SqlServerDatabasesClient {
    ...
    public interface SqlServerDatabasesService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<SqlServerDatabaseResourceInner>> update(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("sqlServerInstanceName") String sqlServerInstanceName,
            @PathParam("databaseName") String databaseName, @QueryParam("api-version") String apiVersion,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<Void> deleteWithResponse(String resourceGroupName, String sqlServerInstanceName,
        String databaseName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<SqlServerDatabaseResourceInner>> updateWithResponseAsync(String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<SqlServerDatabaseResourceInner> updateWithResponse(String resourceGroupName,
        String sqlServerInstanceName, String databaseName, SqlServerDatabaseUpdate sqlServerDatabaseUpdate,
        Context context) {
        return updateWithResponseAsync(resourceGroupName, sqlServerInstanceName, databaseName, sqlServerDatabaseUpdate,
            context).block();
    ...
    public SqlServerDatabaseResourceInner update(String resourceGroupName, String sqlServerInstanceName,
        String databaseName, SqlServerDatabaseUpdate sqlServerDatabaseUpdate) {
        return updateWithResponse(resourceGroupName, sqlServerInstanceName, databaseName, sqlServerDatabaseUpdate,
            Context.NONE).getValue();
    }
