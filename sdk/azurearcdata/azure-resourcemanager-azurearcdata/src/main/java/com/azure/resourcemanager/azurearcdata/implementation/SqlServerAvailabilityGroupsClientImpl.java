...
public final class SqlServerAvailabilityGroupsClientImpl implements SqlServerAvailabilityGroupsClient {
    ...
    public interface SqlServerAvailabilityGroupsService {
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<SqlServerAvailabilityGroupResourceInner>> detailView(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("sqlServerInstanceName") String sqlServerInstanceName,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<SqlServerAvailabilityGroupResourceInner>> failover(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("sqlServerInstanceName") String sqlServerInstanceName,
    ...
    private Mono<SqlServerAvailabilityGroupResourceInner> createAsync(
        ...
        return createWithResponseAsync(
                resourceGroupName, sqlServerInstanceName, availabilityGroupName, sqlServerAvailabilityGroupResource)
    ...
    private Mono<Void> deleteAsync(
        String resourceGroupName, String sqlServerInstanceName, String availabilityGroupName) {
        return deleteWithResponseAsync(resourceGroupName, sqlServerInstanceName, availabilityGroupName)
    ...
    public Response<Void> deleteWithResponse(
        String resourceGroupName, String sqlServerInstanceName, String availabilityGroupName, Context context) {
        return deleteWithResponseAsync(resourceGroupName, sqlServerInstanceName, availabilityGroupName, context)
            .block();
    }
    ...
    public void delete(String resourceGroupName, String sqlServerInstanceName, String availabilityGroupName) {
        deleteWithResponse(resourceGroupName, sqlServerInstanceName, availabilityGroupName, Context.NONE);
    }
    ...
    private Mono<SqlServerAvailabilityGroupResourceInner> updateAsync(
        ...
        return updateWithResponseAsync(
                resourceGroupName, sqlServerInstanceName, availabilityGroupName, sqlServerAvailabilityGroupUpdate)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<SqlServerAvailabilityGroupResourceInner> detailViewAsync(
        String resourceGroupName, String sqlServerInstanceName, String availabilityGroupName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<SqlServerAvailabilityGroupResourceInner> detailViewWithResponse(
        String resourceGroupName, String sqlServerInstanceName, String availabilityGroupName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public SqlServerAvailabilityGroupResourceInner detailView(
        String resourceGroupName, String sqlServerInstanceName, String availabilityGroupName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<SqlServerAvailabilityGroupResourceInner>> failoverWithResponseAsync(
        String resourceGroupName, String sqlServerInstanceName, String availabilityGroupName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<SqlServerAvailabilityGroupResourceInner> failoverAsync(
        String resourceGroupName, String sqlServerInstanceName, String availabilityGroupName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<SqlServerAvailabilityGroupResourceInner> failoverWithResponse(
        String resourceGroupName, String sqlServerInstanceName, String availabilityGroupName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public SqlServerAvailabilityGroupResourceInner failover(
        String resourceGroupName, String sqlServerInstanceName, String availabilityGroupName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<SqlServerAvailabilityGroupResourceInner> forceFailoverAllowDataLossAsync(
        String resourceGroupName, String sqlServerInstanceName, String availabilityGroupName) {
        return forceFailoverAllowDataLossWithResponseAsync(
                resourceGroupName, sqlServerInstanceName, availabilityGroupName)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
    ...
    public Response<SqlServerAvailabilityGroupResourceInner> forceFailoverAllowDataLossWithResponse(
        String resourceGroupName, String sqlServerInstanceName, String availabilityGroupName, Context context) {
        return forceFailoverAllowDataLossWithResponseAsync(
                resourceGroupName, sqlServerInstanceName, availabilityGroupName, context)
            .block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public SqlServerAvailabilityGroupResourceInner forceFailoverAllowDataLoss(
        String resourceGroupName, String sqlServerInstanceName, String availabilityGroupName) {
        return forceFailoverAllowDataLossWithResponse(
                resourceGroupName, sqlServerInstanceName, availabilityGroupName, Context.NONE)
            .getValue();
    }
