...
public interface FailoverGroupsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<FailoverGroupResourceInner> list(
    ...
    SyncPoller<PollResult<FailoverGroupResourceInner>, FailoverGroupResourceInner> beginCreate(
    ...
    FailoverGroupResourceInner create(
        String resourceGroupName,
        String sqlManagedInstanceName,
        String failoverGroupName,
        FailoverGroupResourceInner failoverGroupResource);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<FailoverGroupResourceInner> getWithResponse(
        String resourceGroupName, String sqlManagedInstanceName, String failoverGroupName, Context context);
