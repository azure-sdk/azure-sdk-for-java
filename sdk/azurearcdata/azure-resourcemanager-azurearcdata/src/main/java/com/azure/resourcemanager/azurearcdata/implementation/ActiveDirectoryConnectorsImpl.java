...
public final class ActiveDirectoryConnectorsImpl implements ActiveDirectoryConnectors {
    ...
    public ActiveDirectoryConnectorsImpl(ActiveDirectoryConnectorsClient innerClient,
    ...
    public PagedIterable<ActiveDirectoryConnectorResource> list(String resourceGroupName, String dataControllerName) {
        ...
        return ResourceManagerUtils.mapPage(inner,
            inner1 -> new ActiveDirectoryConnectorResourceImpl(inner1, this.manager()));
    }
    ...
    public Response<ActiveDirectoryConnectorResource> getWithResponse(String resourceGroupName,
        String dataControllerName, String activeDirectoryConnectorName, Context context) {
        Response<ActiveDirectoryConnectorResourceInner> inner = this.serviceClient().getWithResponse(resourceGroupName,
            dataControllerName, activeDirectoryConnectorName, context);
        if (inner != null) {
    ...
    public ActiveDirectoryConnectorResource get(String resourceGroupName, String dataControllerName,
    ...
    public ActiveDirectoryConnectorResource getById(String id) {
        ...
        if (dataControllerName == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
                String.format("The resource ID '%s' is not valid. Missing path segment 'dataControllers'.", id)));
        }
        String activeDirectoryConnectorName
            = ResourceManagerUtils.getValueFromIdByName(id, "activeDirectoryConnectors");
        if (activeDirectoryConnectorName == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(String
                .format("The resource ID '%s' is not valid. Missing path segment 'activeDirectoryConnectors'.", id)));
        }
        return this.getWithResponse(resourceGroupName, dataControllerName, activeDirectoryConnectorName, Context.NONE)
            .getValue();
    }
