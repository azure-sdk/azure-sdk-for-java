...
public final class ActiveDirectoryConnectorResourceImpl
    ...
    public ActiveDirectoryConnectorResource create() {
        this.innerObject = serviceManager.serviceClient().getActiveDirectoryConnectors().create(resourceGroupName,
            dataControllerName, activeDirectoryConnectorName, this.innerModel(), Context.NONE);
        return this;
    }

    public ActiveDirectoryConnectorResource create(Context context) {
        this.innerObject = serviceManager.serviceClient().getActiveDirectoryConnectors().create(resourceGroupName,
            dataControllerName, activeDirectoryConnectorName, this.innerModel(), context);
        return this;
    }
    ...
    public ActiveDirectoryConnectorResource refresh() {
        this.innerObject = serviceManager.serviceClient().getActiveDirectoryConnectors()
    ...
    public ActiveDirectoryConnectorResource refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getActiveDirectoryConnectors()
            .getWithResponse(resourceGroupName, dataControllerName, activeDirectoryConnectorName, context).getValue();
        return this;
    }
