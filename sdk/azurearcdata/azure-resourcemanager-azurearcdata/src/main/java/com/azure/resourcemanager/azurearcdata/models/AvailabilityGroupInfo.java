...
public final class AvailabilityGroupInfo {
     ...
     */
    @JsonProperty(value = "automatedBackupPreferenceDescription")
     ...
     */
    @JsonProperty(value = "clusterTypeDescription")
    ...
    /**
     * Set the automatedBackupPreferenceDescription property: Preferred location for performing backups on the
     * availability databases in this availability group.
     *
     * @param automatedBackupPreferenceDescription the automatedBackupPreferenceDescription value to set.
     * @return the AvailabilityGroupInfo object itself.
     */
    public AvailabilityGroupInfo withAutomatedBackupPreferenceDescription(String automatedBackupPreferenceDescription) {
        this.automatedBackupPreferenceDescription = automatedBackupPreferenceDescription;
        return this;
    }
     ...
     * @return the AvailabilityGroupInfo object itself.
     */
    public AvailabilityGroupInfo withVersion(Integer version) {
    ...
    /**
     * Set the clusterTypeDescription property: SQL Server availability group cluster type description.
     *
     * @param clusterTypeDescription the clusterTypeDescription value to set.
     * @return the AvailabilityGroupInfo object itself.
     */
    public AvailabilityGroupInfo withClusterTypeDescription(String clusterTypeDescription) {
     ...
     * @return the AvailabilityGroupInfo object itself.
     */
    public AvailabilityGroupInfo withRequiredSynchronizedSecondariesToCommit(
        Integer requiredSynchronizedSecondariesToCommit) {
    ...
    /**
     * Set the primaryReplica property: Name of the server instance that is hosting the current primary replica.
     *
     * @param primaryReplica the primaryReplica value to set.
     * @return the AvailabilityGroupInfo object itself.
     */
    public AvailabilityGroupInfo withPrimaryReplica(String primaryReplica) {
    ...
    /**
     * Set the primaryRecoveryHealthDescription property: Indicates the recovery health of the primary replica.
     *
     * @param primaryRecoveryHealthDescription the primaryRecoveryHealthDescription value to set.
     * @return the AvailabilityGroupInfo object itself.
     */
    public AvailabilityGroupInfo withPrimaryRecoveryHealthDescription(String primaryRecoveryHealthDescription) {
        this.primaryRecoveryHealthDescription = primaryRecoveryHealthDescription;
        return this;
    }
    ...
    /**
     * Set the secondaryRecoveryHealthDescription property: Indicates the recovery health of a secondary replica.
     *
     * @param secondaryRecoveryHealthDescription the secondaryRecoveryHealthDescription value to set.
     * @return the AvailabilityGroupInfo object itself.
     */
    public AvailabilityGroupInfo withSecondaryRecoveryHealthDescription(String secondaryRecoveryHealthDescription) {
        this.secondaryRecoveryHealthDescription = secondaryRecoveryHealthDescription;
        return this;
    }
    ...
    /**
     * Set the synchronizationHealthDescription property: Reflects a roll-up of the synchronization health of all
     * availability replicas in the availability group.
     *
     * @param synchronizationHealthDescription the synchronizationHealthDescription value to set.
     * @return the AvailabilityGroupInfo object itself.
     */
    public AvailabilityGroupInfo withSynchronizationHealthDescription(String synchronizationHealthDescription) {
