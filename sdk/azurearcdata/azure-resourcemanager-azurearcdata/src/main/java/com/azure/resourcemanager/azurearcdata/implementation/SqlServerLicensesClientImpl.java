...
public final class SqlServerLicensesClientImpl implements SqlServerLicensesClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<SqlServerLicenseInner>> listSinglePageAsync(Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<SqlServerLicenseInner> listAsync(Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<SqlServerLicenseInner> listByResourceGroupAsync(String resourceGroupName, Context context) {
    ...
    public Response<SqlServerLicenseInner> getByResourceGroupWithResponse(String resourceGroupName,
        String sqlServerLicenseName, Context context) {
        return getByResourceGroupWithResponseAsync(resourceGroupName, sqlServerLicenseName, context).block();
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<SqlServerLicenseInner>> createWithResponseAsync(String resourceGroupName,
        String sqlServerLicenseName, SqlServerLicenseInner sqlServerLicense, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    public Response<SqlServerLicenseInner> createWithResponse(String resourceGroupName, String sqlServerLicenseName,
        ...
        return createWithResponseAsync(resourceGroupName, sqlServerLicenseName, sqlServerLicense, context).block();
    }
    ...
    public Response<Void> deleteWithResponse(String resourceGroupName, String sqlServerLicenseName, Context context) {
        return deleteWithResponseAsync(resourceGroupName, sqlServerLicenseName, context).block();
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<SqlServerLicenseInner>> updateWithResponseAsync(String resourceGroupName,
        String sqlServerLicenseName, SqlServerLicenseUpdate parameters, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    public Response<SqlServerLicenseInner> updateWithResponse(String resourceGroupName, String sqlServerLicenseName,
        ...
        return updateWithResponseAsync(resourceGroupName, sqlServerLicenseName, parameters, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<SqlServerLicenseInner>> listNextSinglePageAsync(String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        if (this.client.getEndpoint() == null) {
