...
public final class ActiveDirectoryConnectorDnsDetails {
    ...
    /**
     * Get the preferK8SDnsForPtrLookups property: Flag indicating whether to prefer Kubernetes DNS server response
     * over AD DNS server response for IP address lookups.
     * 
    ...
    /**
     * Set the preferK8SDnsForPtrLookups property: Flag indicating whether to prefer Kubernetes DNS server response
     * over AD DNS server response for IP address lookups.
     * 
