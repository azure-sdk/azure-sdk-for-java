...
public final class FailoverGroupsImpl implements FailoverGroups {
    ...
    public FailoverGroupsImpl(
        FailoverGroupsClient innerClient, com.azure.resourcemanager.azurearcdata.AzureArcDataManager serviceManager) {
    ...
    public PagedIterable<FailoverGroupResource> list(String resourceGroupName, String sqlManagedInstanceName) {
        ...
        return Utils.mapPage(inner, inner1 -> new FailoverGroupResourceImpl(inner1, this.manager()));
    }

    public PagedIterable<FailoverGroupResource> list(
    ...
    public Response<FailoverGroupResource> getWithResponse(
        String resourceGroupName, String sqlManagedInstanceName, String failoverGroupName, Context context) {
        Response<FailoverGroupResourceInner> inner =
            this.serviceClient().getWithResponse(resourceGroupName, sqlManagedInstanceName, failoverGroupName, context);
        if (inner != null) {
    ...
    public FailoverGroupResource get(
