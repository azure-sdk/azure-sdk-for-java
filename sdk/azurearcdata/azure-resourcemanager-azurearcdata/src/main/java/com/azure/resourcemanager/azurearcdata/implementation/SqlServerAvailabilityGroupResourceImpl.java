...
public final class SqlServerAvailabilityGroupResourceImpl implements SqlServerAvailabilityGroupResource,
    ...
    public SqlServerAvailabilityGroupResource create() {
        this.innerObject
            = serviceManager.serviceClient().getSqlServerAvailabilityGroups().createWithResponse(resourceGroupName,
                sqlServerInstanceName, availabilityGroupName, this.innerModel(), Context.NONE).getValue();
        return this;
    }
    ...
    public SqlServerAvailabilityGroupResource create(Context context) {
        this.innerObject
            = serviceManager.serviceClient().getSqlServerAvailabilityGroups().createWithResponse(resourceGroupName,
                sqlServerInstanceName, availabilityGroupName, this.innerModel(), context).getValue();
        return this;
    }
    ...
    public SqlServerAvailabilityGroupResource apply() {
        this.innerObject = serviceManager.serviceClient().getSqlServerAvailabilityGroups().update(resourceGroupName,
            sqlServerInstanceName, availabilityGroupName, updateSqlServerAvailabilityGroupUpdate, Context.NONE);
        return this;
    }

    public SqlServerAvailabilityGroupResource apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getSqlServerAvailabilityGroups().update(resourceGroupName,
            sqlServerInstanceName, availabilityGroupName, updateSqlServerAvailabilityGroupUpdate, context);
        return this;
    }
    ...
    public SqlServerAvailabilityGroupResource refresh() {
        this.innerObject = serviceManager.serviceClient().getSqlServerAvailabilityGroups()
            .getWithResponse(resourceGroupName, sqlServerInstanceName, availabilityGroupName, Context.NONE).getValue();
        return this;
    }

    public SqlServerAvailabilityGroupResource refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getSqlServerAvailabilityGroups()
            .getWithResponse(resourceGroupName, sqlServerInstanceName, availabilityGroupName, context).getValue();
        return this;
    }

    public Response<SqlServerAvailabilityGroupResource> detailViewWithResponse(Context context) {
        return serviceManager.sqlServerAvailabilityGroups().detailViewWithResponse(resourceGroupName,
            sqlServerInstanceName, availabilityGroupName, context);
    }

    public SqlServerAvailabilityGroupResource detailView() {
        return serviceManager.sqlServerAvailabilityGroups().detailView(resourceGroupName, sqlServerInstanceName,
            availabilityGroupName);
    }

    public Response<SqlServerAvailabilityGroupResource> failoverWithResponse(Context context) {
        return serviceManager.sqlServerAvailabilityGroups().failoverWithResponse(resourceGroupName,
            sqlServerInstanceName, availabilityGroupName, context);
    }

    public SqlServerAvailabilityGroupResource failover() {
        return serviceManager.sqlServerAvailabilityGroups().failover(resourceGroupName, sqlServerInstanceName,
            availabilityGroupName);
    }

    public Response<SqlServerAvailabilityGroupResource> forceFailoverAllowDataLossWithResponse(Context context) {
        return serviceManager.sqlServerAvailabilityGroups().forceFailoverAllowDataLossWithResponse(resourceGroupName,
            sqlServerInstanceName, availabilityGroupName, context);
    }
    ...
    public SqlServerAvailabilityGroupResource forceFailoverAllowDataLoss() {
        return serviceManager.sqlServerAvailabilityGroups().forceFailoverAllowDataLoss(resourceGroupName,
            sqlServerInstanceName, availabilityGroupName);
    }
