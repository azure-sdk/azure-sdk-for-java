...
public final class SqlServerAvailabilityGroupResourceImpl
    ...
    public SqlServerAvailabilityGroupResource create() {
        this.innerObject =
            serviceManager
                ...
                .createWithResponse(
                    resourceGroupName, sqlServerInstanceName, availabilityGroupName, this.innerModel(), Context.NONE)
                .getValue();
        return this;
    }
    ...
    public SqlServerAvailabilityGroupResource create(Context context) {
        this.innerObject =
            serviceManager
                ...
                .getSqlServerAvailabilityGroups()
                .createWithResponse(
                    resourceGroupName, sqlServerInstanceName, availabilityGroupName, this.innerModel(), context)
                .getValue();
        return this;
    }
    ...
    SqlServerAvailabilityGroupResourceImpl(
        ...
        this.availabilityGroupName = Utils.getValueFromIdByName(innerObject.id(), "availabilityGroups");
    }
