...
public final class SqlServerInstanceImpl
    ...
    public SqlServerInstance apply() {
        this.innerObject = serviceManager.serviceClient().getSqlServerInstances()
            .updateWithResponse(resourceGroupName, sqlServerInstanceName, updateParameters, Context.NONE).getValue();
        return this;
    }

    public SqlServerInstance apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getSqlServerInstances()
            .updateWithResponse(resourceGroupName, sqlServerInstanceName, updateParameters, context).getValue();
        return this;
    }
