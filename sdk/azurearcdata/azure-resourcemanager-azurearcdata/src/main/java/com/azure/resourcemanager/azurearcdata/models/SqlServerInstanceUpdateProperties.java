 ...
 */
@Fluent
public final class SqlServerInstanceUpdateProperties implements JsonSerializable<SqlServerInstanceUpdateProperties> {
    /*
     * SQL Server version.
     */
    ...
    /**
     * Creates an instance of SqlServerInstanceUpdateProperties class.
     */
     ...
     * @return the SqlServerInstanceUpdateProperties object itself.
     */
    public SqlServerInstanceUpdateProperties withVersion(SqlVersion version) {
     ...
     * @return the SqlServerInstanceUpdateProperties object itself.
     */
    public SqlServerInstanceUpdateProperties withEdition(EditionType edition) {
     ...
     * @return the SqlServerInstanceUpdateProperties object itself.
     */
    public SqlServerInstanceUpdateProperties withCores(String cores) {
        this.cores = cores;
        return this;
    }
     ...
     * @return the SqlServerInstanceUpdateProperties object itself.
     */
    public SqlServerInstanceUpdateProperties withInstanceName(String instanceName) {
     ...
     * @return the SqlServerInstanceUpdateProperties object itself.
     */
    public SqlServerInstanceUpdateProperties withHostType(HostType hostType) {
     ...
     * @return the SqlServerInstanceUpdateProperties object itself.
     */
    public SqlServerInstanceUpdateProperties withFailoverCluster(FailoverCluster failoverCluster) {
     ...
     * @return the SqlServerInstanceUpdateProperties object itself.
     */
    public SqlServerInstanceUpdateProperties withBackupPolicy(BackupPolicy backupPolicy) {
     ...
     * @return the SqlServerInstanceUpdateProperties object itself.
     */
    public SqlServerInstanceUpdateProperties withUpgradeLockedUntil(OffsetDateTime upgradeLockedUntil) {
     ...
     * @return the SqlServerInstanceUpdateProperties object itself.
     */
    public SqlServerInstanceUpdateProperties withMonitoring(Monitoring monitoring) {
     ...
     * @return the SqlServerInstanceUpdateProperties object itself.
     */
    public SqlServerInstanceUpdateProperties withMigration(Migration migration) {
     ...
     * @return the SqlServerInstanceUpdateProperties object itself.
     */
    public SqlServerInstanceUpdateProperties withClientConnection(ClientConnection clientConnection) {
     ...
     * @return the SqlServerInstanceUpdateProperties object itself.
     */
    public SqlServerInstanceUpdateProperties withServiceType(ServiceType serviceType) {
    ...
    /**
     * Reads an instance of SqlServerInstanceUpdateProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of SqlServerInstanceUpdateProperties if the JsonReader was pointing to an instance of it, or
     * null if it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the SqlServerInstanceUpdateProperties.
     */
    public static SqlServerInstanceUpdateProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            SqlServerInstanceUpdateProperties deserializedSqlServerInstanceUpdateProperties
                = new SqlServerInstanceUpdateProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("version".equals(fieldName)) {
                    deserializedSqlServerInstanceUpdateProperties.version = SqlVersion.fromString(reader.getString());
                } else if ("edition".equals(fieldName)) {
                    deserializedSqlServerInstanceUpdateProperties.edition = EditionType.fromString(reader.getString());
                } else if ("containerResourceId".equals(fieldName)) {
                    deserializedSqlServerInstanceUpdateProperties.containerResourceId = reader.getString();
                } else if ("createTime".equals(fieldName)) {
                    deserializedSqlServerInstanceUpdateProperties.createTime = reader.getString();
                } else if ("vCore".equals(fieldName)) {
                    deserializedSqlServerInstanceUpdateProperties.vCore = reader.getString();
                } else if ("cores".equals(fieldName)) {
                    deserializedSqlServerInstanceUpdateProperties.cores = reader.getString();
                } else if ("status".equals(fieldName)) {
                    deserializedSqlServerInstanceUpdateProperties.status
                        = ConnectionStatus.fromString(reader.getString());
                } else if ("patchLevel".equals(fieldName)) {
                    deserializedSqlServerInstanceUpdateProperties.patchLevel = reader.getString();
                } else if ("collation".equals(fieldName)) {
                    deserializedSqlServerInstanceUpdateProperties.collation = reader.getString();
                } else if ("dbMasterKeyExists".equals(fieldName)) {
                    deserializedSqlServerInstanceUpdateProperties.dbMasterKeyExists
                        = reader.getNullable(JsonReader::getBoolean);
                } else if ("isHadrEnabled".equals(fieldName)) {
                    deserializedSqlServerInstanceUpdateProperties.isHadrEnabled
                        = reader.getNullable(JsonReader::getBoolean);
                } else if ("traceFlags".equals(fieldName)) {
                    List<Integer> traceFlags = reader.readArray(reader1 -> reader1.getInt());
                    deserializedSqlServerInstanceUpdateProperties.traceFlags = traceFlags;
                } else if ("currentVersion".equals(fieldName)) {
                    deserializedSqlServerInstanceUpdateProperties.currentVersion = reader.getString();
                } else if ("instanceName".equals(fieldName)) {
                    deserializedSqlServerInstanceUpdateProperties.instanceName = reader.getString();
                } else if ("tcpDynamicPorts".equals(fieldName)) {
                    deserializedSqlServerInstanceUpdateProperties.tcpDynamicPorts = reader.getString();
                } else if ("tcpStaticPorts".equals(fieldName)) {
                    deserializedSqlServerInstanceUpdateProperties.tcpStaticPorts = reader.getString();
                } else if ("productId".equals(fieldName)) {
                    deserializedSqlServerInstanceUpdateProperties.productId = reader.getString();
                } else if ("licenseType".equals(fieldName)) {
                    deserializedSqlServerInstanceUpdateProperties.licenseType
                        = ArcSqlServerLicenseType.fromString(reader.getString());
                } else if ("azureDefenderStatusLastUpdated".equals(fieldName)) {
                    deserializedSqlServerInstanceUpdateProperties.azureDefenderStatusLastUpdated = reader
                        .getNullable(nonNullReader -> CoreUtils.parseBestOffsetDateTime(nonNullReader.getString()));
                } else if ("azureDefenderStatus".equals(fieldName)) {
                    deserializedSqlServerInstanceUpdateProperties.azureDefenderStatus
                        = DefenderStatus.fromString(reader.getString());
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedSqlServerInstanceUpdateProperties.provisioningState = reader.getString();
                } else if ("lastInventoryUploadTime".equals(fieldName)) {
                    deserializedSqlServerInstanceUpdateProperties.lastInventoryUploadTime = reader
                        .getNullable(nonNullReader -> CoreUtils.parseBestOffsetDateTime(nonNullReader.getString()));
                } else if ("lastUsageUploadTime".equals(fieldName)) {
                    deserializedSqlServerInstanceUpdateProperties.lastUsageUploadTime = reader
                        .getNullable(nonNullReader -> CoreUtils.parseBestOffsetDateTime(nonNullReader.getString()));
                } else if ("hostType".equals(fieldName)) {
                    deserializedSqlServerInstanceUpdateProperties.hostType = HostType.fromString(reader.getString());
                } else if ("alwaysOnRole".equals(fieldName)) {
                    deserializedSqlServerInstanceUpdateProperties.alwaysOnRole
                        = AlwaysOnRole.fromString(reader.getString());
                } else if ("failoverCluster".equals(fieldName)) {
                    deserializedSqlServerInstanceUpdateProperties.failoverCluster = FailoverCluster.fromJson(reader);
                } else if ("backupPolicy".equals(fieldName)) {
                    deserializedSqlServerInstanceUpdateProperties.backupPolicy = BackupPolicy.fromJson(reader);
                } else if ("upgradeLockedUntil".equals(fieldName)) {
                    deserializedSqlServerInstanceUpdateProperties.upgradeLockedUntil = reader
                        .getNullable(nonNullReader -> CoreUtils.parseBestOffsetDateTime(nonNullReader.getString()));
                } else if ("monitoring".equals(fieldName)) {
                    deserializedSqlServerInstanceUpdateProperties.monitoring = Monitoring.fromJson(reader);
                } else if ("migration".equals(fieldName)) {
                    deserializedSqlServerInstanceUpdateProperties.migration = Migration.fromJson(reader);
                } else if ("clientConnection".equals(fieldName)) {
                    deserializedSqlServerInstanceUpdateProperties.clientConnection = ClientConnection.fromJson(reader);
                } else if ("serviceType".equals(fieldName)) {
                    deserializedSqlServerInstanceUpdateProperties.serviceType
            ...
            return deserializedSqlServerInstanceUpdateProperties;
        });
    }
}
