...
public final class PostgresInstancesClientImpl implements PostgresInstancesClient {
    ...
    /**
     * The interface defining all the services for AzureArcDataManagementClientPostgresInstances to be used by the
    ...
    private PollerFlux<PollResult<PostgresInstanceInner>, PostgresInstanceInner> beginCreateAsync(
        ...
        return this.client.<PostgresInstanceInner, PostgresInstanceInner>getLroResult(mono,
            this.client.getHttpPipeline(), PostgresInstanceInner.class, PostgresInstanceInner.class, context);
    }
    ...
    public SyncPoller<PollResult<PostgresInstanceInner>, PostgresInstanceInner> beginCreate(String resourceGroupName,
        String postgresInstanceName, PostgresInstanceInner resource) {
        return this.beginCreateAsync(resourceGroupName, postgresInstanceName, resource).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<PostgresInstanceInner>, PostgresInstanceInner> beginCreate(String resourceGroupName,
        String postgresInstanceName, PostgresInstanceInner resource, Context context) {
        return this.beginCreateAsync(resourceGroupName, postgresInstanceName, resource, context).getSyncPoller();
    }
    ...
    private Mono<PostgresInstanceInner> createAsync(String resourceGroupName, String postgresInstanceName,
        ...
        return beginCreateAsync(resourceGroupName, postgresInstanceName, resource, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String postgresInstanceName) {
        return this.beginDeleteAsync(resourceGroupName, postgresInstanceName).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String postgresInstanceName,
        Context context) {
        return this.beginDeleteAsync(resourceGroupName, postgresInstanceName, context).getSyncPoller();
    }
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String postgresInstanceName, Context context) {
        return beginDeleteAsync(resourceGroupName, postgresInstanceName, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<PostgresInstanceInner>> updateWithResponseAsync(String resourceGroupName,
        String postgresInstanceName, PostgresInstanceUpdate parameters, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
