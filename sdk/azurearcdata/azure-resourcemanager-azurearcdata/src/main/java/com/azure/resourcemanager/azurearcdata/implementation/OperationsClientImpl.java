...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    OperationsClientImpl(AzureArcDataManagementClientImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for AzureArcDataManagementClientOperations to be used by the proxy
     ...
     * @return result of the request to list Azure Data Services on Azure Arc operations along with
