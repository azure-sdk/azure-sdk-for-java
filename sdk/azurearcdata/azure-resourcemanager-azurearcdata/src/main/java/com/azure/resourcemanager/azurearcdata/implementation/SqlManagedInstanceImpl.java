...
public final class SqlManagedInstanceImpl
    ...
    public SqlManagedInstance create() {
        this.innerObject = serviceManager.serviceClient().getSqlManagedInstances().create(resourceGroupName,
            sqlManagedInstanceName, this.innerModel(), Context.NONE);
        return this;
    }

    public SqlManagedInstance create(Context context) {
        this.innerObject = serviceManager.serviceClient().getSqlManagedInstances().create(resourceGroupName,
            sqlManagedInstanceName, this.innerModel(), context);
        return this;
    }
    ...
    public SqlManagedInstance apply() {
        this.innerObject = serviceManager.serviceClient().getSqlManagedInstances()
            .updateWithResponse(resourceGroupName, sqlManagedInstanceName, updateParameters, Context.NONE).getValue();
        return this;
    }

    public SqlManagedInstance apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getSqlManagedInstances()
            .updateWithResponse(resourceGroupName, sqlManagedInstanceName, updateParameters, context).getValue();
        return this;
    }
    ...
    public SqlManagedInstance refresh() {
        this.innerObject = serviceManager.serviceClient().getSqlManagedInstances()
            .getByResourceGroupWithResponse(resourceGroupName, sqlManagedInstanceName, Context.NONE).getValue();
        return this;
    }

    public SqlManagedInstance refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getSqlManagedInstances()
            .getByResourceGroupWithResponse(resourceGroupName, sqlManagedInstanceName, context).getValue();
        return this;
    }
