...
public final class PostgresInstanceImpl
    ...
    public PostgresInstance create() {
        this.innerObject = serviceManager.serviceClient().getPostgresInstances().create(resourceGroupName,
            postgresInstanceName, this.innerModel(), Context.NONE);
        return this;
    }

    public PostgresInstance create(Context context) {
        this.innerObject = serviceManager.serviceClient().getPostgresInstances().create(resourceGroupName,
            postgresInstanceName, this.innerModel(), context);
        return this;
    }
    ...
    public PostgresInstance apply() {
        this.innerObject = serviceManager.serviceClient().getPostgresInstances()
            .updateWithResponse(resourceGroupName, postgresInstanceName, updateParameters, Context.NONE).getValue();
        return this;
    }

    public PostgresInstance apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getPostgresInstances()
            .updateWithResponse(resourceGroupName, postgresInstanceName, updateParameters, context).getValue();
        return this;
    }
    ...
    public PostgresInstance refresh() {
        this.innerObject = serviceManager.serviceClient().getPostgresInstances()
            .getByResourceGroupWithResponse(resourceGroupName, postgresInstanceName, Context.NONE).getValue();
        return this;
    }

    public PostgresInstance refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getPostgresInstances()
            .getByResourceGroupWithResponse(resourceGroupName, postgresInstanceName, context).getValue();
        return this;
    }
