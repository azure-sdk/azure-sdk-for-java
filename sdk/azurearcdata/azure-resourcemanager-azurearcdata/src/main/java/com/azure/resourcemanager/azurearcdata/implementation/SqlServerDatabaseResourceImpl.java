...
public final class SqlServerDatabaseResourceImpl
    ...
    public SqlServerDatabaseResource create() {
        this.innerObject = serviceManager.serviceClient().getSqlServerDatabases()
    ...
    public SqlServerDatabaseResource apply() {
        this.innerObject = serviceManager.serviceClient().getSqlServerDatabases().updateWithResponse(resourceGroupName,
            sqlServerInstanceName, databaseName, updateSqlServerDatabaseUpdate, Context.NONE).getValue();
        return this;
    }

    public SqlServerDatabaseResource apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getSqlServerDatabases().updateWithResponse(resourceGroupName,
            sqlServerInstanceName, databaseName, updateSqlServerDatabaseUpdate, context).getValue();
        return this;
    }
    ...
    public SqlServerDatabaseResource refresh() {
        this.innerObject = serviceManager.serviceClient().getSqlServerDatabases()
            .getWithResponse(resourceGroupName, sqlServerInstanceName, databaseName, Context.NONE).getValue();
        return this;
    }

    public SqlServerDatabaseResource refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getSqlServerDatabases()
            .getWithResponse(resourceGroupName, sqlServerInstanceName, databaseName, context).getValue();
        return this;
    }
