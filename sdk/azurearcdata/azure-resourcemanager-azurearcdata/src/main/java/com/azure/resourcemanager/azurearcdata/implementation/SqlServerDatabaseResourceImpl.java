...
public final class SqlServerDatabaseResourceImpl
    ...
    public SqlServerDatabaseResourceImpl withExistingSqlServerInstance(
    ...
    public SqlServerDatabaseResource create() {
        this.innerObject =
            serviceManager
                ...
                .createWithResponse(
                    resourceGroupName, sqlServerInstanceName, databaseName, this.innerModel(), Context.NONE)
                .getValue();
        return this;
    }
    ...
    public SqlServerDatabaseResource apply() {
        this.innerObject =
            serviceManager
                ...
                .getSqlServerDatabases()
                .updateWithResponse(
                    resourceGroupName, sqlServerInstanceName, databaseName, updateSqlServerDatabaseUpdate, Context.NONE)
                .getValue();
        return this;
    }
    ...
    public SqlServerDatabaseResource apply(Context context) {
        this.innerObject =
            serviceManager
                ...
                .getSqlServerDatabases()
                .updateWithResponse(
                    resourceGroupName, sqlServerInstanceName, databaseName, updateSqlServerDatabaseUpdate, context)
                .getValue();
        return this;
    }

    SqlServerDatabaseResourceImpl(
        SqlServerDatabaseResourceInner innerObject,
