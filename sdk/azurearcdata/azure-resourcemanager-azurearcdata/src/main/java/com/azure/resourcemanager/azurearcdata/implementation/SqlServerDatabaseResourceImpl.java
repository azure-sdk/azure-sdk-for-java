...
public final class SqlServerDatabaseResourceImpl
    ...
    public SqlServerDatabaseResource apply() {
        this.innerObject = serviceManager.serviceClient().getSqlServerDatabases().update(resourceGroupName,
            sqlServerInstanceName, databaseName, updateSqlServerDatabaseUpdate, Context.NONE);
        return this;
    }

    public SqlServerDatabaseResource apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getSqlServerDatabases().update(resourceGroupName,
            sqlServerInstanceName, databaseName, updateSqlServerDatabaseUpdate, context);
        return this;
    }
