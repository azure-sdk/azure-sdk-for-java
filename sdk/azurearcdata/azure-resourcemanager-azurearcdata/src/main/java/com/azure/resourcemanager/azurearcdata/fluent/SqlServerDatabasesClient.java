...
public interface SqlServerDatabasesClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<Void> deleteWithResponse(String resourceGroupName, String sqlServerInstanceName, String databaseName,
        Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<SqlServerDatabaseResourceInner> updateWithResponse(String resourceGroupName, String sqlServerInstanceName,
