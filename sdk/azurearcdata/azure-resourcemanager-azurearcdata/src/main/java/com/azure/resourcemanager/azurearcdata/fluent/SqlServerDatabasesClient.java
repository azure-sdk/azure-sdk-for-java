...
public interface SqlServerDatabasesClient {
    ...
    Response<SqlServerDatabaseResourceInner> createWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<SqlServerDatabaseResourceInner> getWithResponse(
        String resourceGroupName, String sqlServerInstanceName, String databaseName, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<SqlServerDatabaseResourceInner> updateWithResponse(
        String resourceGroupName,
        String sqlServerInstanceName,
        String databaseName,
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<SqlServerDatabaseResourceInner> list(
