...
public final class ActiveDirectoryConnectorsCreateSamples {
    /*
     * x-ms-original-file:
     * specification/azurearcdata/resource-manager/Microsoft.AzureArcData/preview/2023-01-15-preview/examples/
...
public final class SqlServerDatabasesDeleteSamples {
    ...
    public static void deletesADatabaseResource(com.azure.resourcemanager.azurearcdata.AzureArcDataManager manager) {
        manager.sqlServerDatabases().deleteWithResponse("testrg", "testsqlManagedInstance", "testdb",
            com.azure.core.util.Context.NONE);
    }
}
```
    ...
    public static void
        ...
        manager.sqlServerInstances().define("testsqlServerInstance").withRegion("northeurope")
            ...
            .withProperties(new SqlServerInstanceProperties().withVersion(SqlVersion.SQL_SERVER_2012)
                .withEdition(EditionType.DEVELOPER).withContainerResourceId("Resource id of hosting Arc Machine")
                .withVCore("4").withCores("4").withStatus(ConnectionStatus.REGISTERED).withPatchLevel("patchlevel")
                .withCollation("collation").withCurrentVersion("2012").withInstanceName("name of instance")
                .withTcpDynamicPorts("1433").withTcpStaticPorts("1433").withProductId("sql id")
                ...
                .withAzureDefenderStatus(DefenderStatus.PROTECTED).withHostType(HostType.PHYSICAL_SERVER))
            .create();
    }
