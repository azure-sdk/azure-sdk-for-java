...
public final class LicensesClientImpl implements LicensesClient {
    ...
    /**
     * The interface defining all the services for HybridComputeManagementClientLicenses to be used by the proxy
    ...
    public interface LicensesService {
        ...
        Mono<Response<Flux<ByteBuffer>>> validateLicense(@HostParam("$host") String endpoint,
            ...
            @BodyParam("application/json") LicenseValidateModel parameters, @HeaderParam("Accept") String accept,
            Context context);
    ...
    private Mono<Response<Flux<ByteBuffer>>> validateLicenseWithResponseAsync(LicenseValidateModel parameters) {
    ...
    private PollerFlux<PollResult<LicenseInner>, LicenseInner>
        beginValidateLicenseAsync(LicenseValidateModel parameters) {
    ...
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<LicenseInner>, LicenseInner>
        beginValidateLicenseAsync(LicenseValidateModel parameters, Context context) {
        context = this.client.mergeContext(context);
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<LicenseInner>, LicenseInner> beginValidateLicense(LicenseValidateModel parameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<LicenseInner> validateLicenseAsync(LicenseValidateModel parameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<LicenseInner> validateLicenseAsync(LicenseValidateModel parameters, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public LicenseInner validateLicense(LicenseValidateModel parameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public LicenseInner validateLicense(LicenseValidateModel parameters, Context context) {
