...
public final class NetworkConfigurationsImpl implements NetworkConfigurations {
    ...
    public NetworkConfigurationsImpl(NetworkConfigurationsClient innerClient,
    ...
    public Response<NetworkConfiguration> createOrUpdateWithResponse(String resourceUri,
    ...
    public Response<NetworkConfiguration> updateWithResponse(String resourceUri, NetworkConfigurationInner parameters,
        Context context) {
        Response<NetworkConfigurationInner> inner
