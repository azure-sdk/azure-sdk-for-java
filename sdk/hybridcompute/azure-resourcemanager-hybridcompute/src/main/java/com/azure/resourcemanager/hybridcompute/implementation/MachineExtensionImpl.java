...
public final class MachineExtensionImpl
    ...
    public MachineExtension create() {
        this.innerObject = serviceManager.serviceClient().getMachineExtensions().createOrUpdate(resourceGroupName,
            machineName, extensionName, this.innerModel(), Context.NONE);
        return this;
    }

    public MachineExtension create(Context context) {
        this.innerObject = serviceManager.serviceClient().getMachineExtensions().createOrUpdate(resourceGroupName,
            machineName, extensionName, this.innerModel(), context);
        return this;
    }
    ...
    public MachineExtension apply() {
        this.innerObject = serviceManager.serviceClient().getMachineExtensions().update(resourceGroupName, machineName,
            extensionName, updateExtensionParameters, Context.NONE);
        return this;
    }

    public MachineExtension apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getMachineExtensions().update(resourceGroupName, machineName,
            extensionName, updateExtensionParameters, context);
        return this;
    }
    ...
    public MachineExtension refresh() {
        this.innerObject = serviceManager.serviceClient().getMachineExtensions()
            .getWithResponse(resourceGroupName, machineName, extensionName, Context.NONE).getValue();
        return this;
    }

    public MachineExtension refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getMachineExtensions()
            .getWithResponse(resourceGroupName, machineName, extensionName, context).getValue();
        return this;
    }
