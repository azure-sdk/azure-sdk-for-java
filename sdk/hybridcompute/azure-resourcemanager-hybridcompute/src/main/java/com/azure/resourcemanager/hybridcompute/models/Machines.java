...
public interface Machines {
     ...
     * @return describes a hybrid machine along with {@link Response}.
     */
    Response<Machine> getByIdWithResponse(String id, InstanceViewTypes expand, Context context);
    ...
    /**
     * Begins definition for a new Machine resource.
     * 
     * @param name resource name.
     * @return the first stage of the new Machine definition.
     */
    Machine.DefinitionStages.Blank define(String name);
}
