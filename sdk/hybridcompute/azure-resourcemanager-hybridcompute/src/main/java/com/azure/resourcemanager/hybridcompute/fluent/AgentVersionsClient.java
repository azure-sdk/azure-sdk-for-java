...
public interface AgentVersionsClient {
    ...
    Response<AgentVersionsListInner> listWithResponse(String osType, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<AgentVersionInner> getWithResponse(String osType, String version, Context context);
