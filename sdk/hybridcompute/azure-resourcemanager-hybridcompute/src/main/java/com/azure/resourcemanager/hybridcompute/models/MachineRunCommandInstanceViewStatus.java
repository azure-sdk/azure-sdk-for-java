...
@Fluent
public final class MachineRunCommandInstanceViewStatus {
    /*
     * The status code.
     */
    ...
    /** Creates an instance of MachineRunCommandInstanceViewStatus class. */
    public MachineRunCommandInstanceViewStatus() {
    }
     ...
     * @return the MachineRunCommandInstanceViewStatus object itself.
     */
    public MachineRunCommandInstanceViewStatus withCode(String code) {
        this.code = code;
        return this;
    }
     ...
     * @return the MachineRunCommandInstanceViewStatus object itself.
     */
    public MachineRunCommandInstanceViewStatus withLevel(StatusLevelTypes level) {
        this.level = level;
        return this;
    }
     ...
     * @return the MachineRunCommandInstanceViewStatus object itself.
     */
    public MachineRunCommandInstanceViewStatus withDisplayStatus(String displayStatus) {
     ...
     * @return the MachineRunCommandInstanceViewStatus object itself.
     */
    public MachineRunCommandInstanceViewStatus withMessage(String message) {
     ...
     * @return the MachineRunCommandInstanceViewStatus object itself.
     */
    public MachineRunCommandInstanceViewStatus withTime(OffsetDateTime time) {
        this.time = time;
        return this;
    }
