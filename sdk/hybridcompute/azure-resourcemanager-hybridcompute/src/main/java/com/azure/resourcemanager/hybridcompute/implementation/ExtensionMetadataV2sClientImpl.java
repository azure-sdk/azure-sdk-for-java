...
public final class ExtensionMetadataV2sClientImpl implements ExtensionMetadataV2sClient {
    ...
    private Mono<Response<ExtensionValueV2Inner>> getWithResponseAsync(String location, String publisher,
        ...
        return service.get(this.client.getEndpoint(), this.client.getApiVersion(), location, publisher, extensionType,
            version, accept, context);
    }
    ...
    private Mono<PagedResponse<ExtensionValueV2Inner>> listSinglePageAsync(String location, String publisher,
        ...
        context = this.client.mergeContext(context);
        return service
            .list(this.client.getEndpoint(), this.client.getApiVersion(), location, publisher, extensionType, accept,
                context)
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<ExtensionValueV2Inner>> listNextSinglePageAsync(String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        if (this.client.getEndpoint() == null) {
