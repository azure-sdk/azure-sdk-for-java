...
public final class NetworkConfigurationProperties {
     ...
     */
    public NetworkConfigurationProperties
        withNetworkConfigurationScopeResourceId(String networkConfigurationScopeResourceId) {
    ...
    public void validate() {
        if (networkConfigurationScopeResourceId() == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
                "Missing required property networkConfigurationScopeResourceId in model NetworkConfigurationProperties"));
        }
