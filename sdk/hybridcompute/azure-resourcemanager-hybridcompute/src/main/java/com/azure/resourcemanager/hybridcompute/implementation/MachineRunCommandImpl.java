...
public final class MachineRunCommandImpl
    ...
    public MachineRunCommand create() {
        this.innerObject = serviceManager.serviceClient().getMachineRunCommands().createOrUpdate(resourceGroupName,
            machineName, runCommandName, this.innerModel(), Context.NONE);
        return this;
    }

    public MachineRunCommand create(Context context) {
        this.innerObject = serviceManager.serviceClient().getMachineRunCommands().createOrUpdate(resourceGroupName,
            machineName, runCommandName, this.innerModel(), context);
        return this;
    }
    ...
    public MachineRunCommand apply() {
        this.innerObject = serviceManager.serviceClient().getMachineRunCommands().update(resourceGroupName, machineName,
            runCommandName, updateRunCommandProperties, Context.NONE);
        return this;
    }

    public MachineRunCommand apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getMachineRunCommands().update(resourceGroupName, machineName,
            runCommandName, updateRunCommandProperties, context);
        return this;
    }
    ...
    public MachineRunCommand refresh() {
        this.innerObject = serviceManager.serviceClient().getMachineRunCommands()
            .getWithResponse(resourceGroupName, machineName, runCommandName, Context.NONE).getValue();
        return this;
    }

    public MachineRunCommand refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getMachineRunCommands()
            .getWithResponse(resourceGroupName, machineName, runCommandName, context).getValue();
        return this;
    }
