...
public final class Processor implements JsonSerializable<Processor> {
    ...
    /**
     * Set the name property: The name of the processor.
     * 
    ...
    /**
     * Set the numberOfCores property: The total number of physical cores on the processor.
     * 
     * @param numberOfCores the numberOfCores value to set.
     * @return the Processor object itself.
     */
    public Processor withNumberOfCores(Integer numberOfCores) {
