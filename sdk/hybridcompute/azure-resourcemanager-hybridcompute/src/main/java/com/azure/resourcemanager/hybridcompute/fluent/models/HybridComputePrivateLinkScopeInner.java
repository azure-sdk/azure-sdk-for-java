        ...
        if (location() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property location in model HybridComputePrivateLinkScopeInner"));
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(HybridComputePrivateLinkScopeInner.class);
