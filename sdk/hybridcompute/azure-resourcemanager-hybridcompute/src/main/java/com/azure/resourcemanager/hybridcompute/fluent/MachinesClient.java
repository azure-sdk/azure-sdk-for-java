...
public interface MachinesClient {
    ...
    Response<MachineInner> createOrUpdateWithResponse(String resourceGroupName, String machineName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<MachineInner> updateWithResponse(String resourceGroupName, String machineName, MachineUpdate parameters,
        Context context);
