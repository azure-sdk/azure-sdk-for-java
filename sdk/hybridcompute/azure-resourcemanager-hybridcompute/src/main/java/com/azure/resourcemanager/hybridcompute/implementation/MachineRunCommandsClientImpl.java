...
public final class MachineRunCommandsClientImpl implements MachineRunCommandsClient {
    ...
    public interface MachineRunCommandsService {
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<MachineRunCommandInner>> get(
            @HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("machineName") String machineName,
            @PathParam("runCommandName") String runCommandName,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<MachineRunCommandsListResult>> list(
            @HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("machineName") String machineName,
    ...
    private PollerFlux<PollResult<MachineRunCommandInner>, MachineRunCommandInner> beginCreateOrUpdateAsync(
        ...
        return this
            .client
            .<MachineRunCommandInner, MachineRunCommandInner>getLroResult(
                mono,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<MachineRunCommandInner> createOrUpdateAsync(
        String resourceGroupName,
        String machineName,
        String runCommandName,
        MachineRunCommandInner runCommandProperties) {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<MachineRunCommandInner>, MachineRunCommandInner> beginUpdate(
        String resourceGroupName,
        String machineName,
        String runCommandName,
        MachineRunCommandUpdate runCommandProperties) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<MachineRunCommandInner> updateAsync(
        String resourceGroupName,
        String machineName,
        String runCommandName,
        MachineRunCommandUpdate runCommandProperties) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<MachineRunCommandInner>> getWithResponseAsync(
        String resourceGroupName, String machineName, String runCommandName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<MachineRunCommandInner> getWithResponse(
        String resourceGroupName, String machineName, String runCommandName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<MachineRunCommandInner>> listSinglePageAsync(
                ...
                context ->
                    service
                        .list(
                            ...
                            accept,
                            context))
            .<PagedResponse<MachineRunCommandInner>>map(
                res ->
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<MachineRunCommandInner> listAsync(
        String resourceGroupName, String machineName, String expand, Context context) {
        return new PagedFlux<>(
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<MachineRunCommandInner> list(
        String resourceGroupName, String machineName, String expand, Context context) {
