...
public final class LicenseProfileImpl implements LicenseProfile, LicenseProfile.Definition, LicenseProfile.Update {
    ...
    public LicenseProfile create() {
        this.innerObject = serviceManager.serviceClient().getLicenseProfiles().createOrUpdate(resourceGroupName,
            machineName, this.innerModel(), Context.NONE);
        return this;
    }

    public LicenseProfile create(Context context) {
        this.innerObject = serviceManager.serviceClient().getLicenseProfiles().createOrUpdate(resourceGroupName,
            machineName, this.innerModel(), context);
        return this;
    }
    ...
    public LicenseProfile apply() {
        this.innerObject = serviceManager.serviceClient().getLicenseProfiles().update(resourceGroupName, machineName,
    ...
    public LicenseProfile refresh() {
        this.innerObject = serviceManager.serviceClient().getLicenseProfiles()
            .getWithResponse(resourceGroupName, machineName, Context.NONE).getValue();
        return this;
    }

    public LicenseProfile refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getLicenseProfiles()
            .getWithResponse(resourceGroupName, machineName, context).getValue();
        return this;
    }
