...
public final class LicenseProfileImpl implements LicenseProfile, LicenseProfile.Definition, LicenseProfile.Update {
    ...
    public LicenseProfileSubscriptionStatus subscriptionStatusIotEnterpriseProfileSubscriptionStatus() {
        return this.innerModel().subscriptionStatusIotEnterpriseProfileSubscriptionStatus();
    }

    public OffsetDateTime billingStartDateIotEnterpriseProfileBillingStartDate() {
        return this.innerModel().billingStartDateIotEnterpriseProfileBillingStartDate();
    }

    public OffsetDateTime disenrollmentDateIotEnterpriseProfileDisenrollmentDate() {
        return this.innerModel().disenrollmentDateIotEnterpriseProfileDisenrollmentDate();
    }

    public List<ProductFeature> productFeaturesIotEnterpriseProfileProductFeatures() {
        List<ProductFeature> inner = this.innerModel().productFeaturesIotEnterpriseProfileProductFeatures();
        if (inner != null) {
            return Collections.unmodifiableList(inner);
        } else {
            return Collections.emptyList();
    ...
    public LicenseProfileImpl withSubscriptionStatusIotEnterpriseProfileSubscriptionStatus(
    ...
    public LicenseProfileImpl withProductFeaturesIotEnterpriseProfileProductFeatures(
    ...
    public LicenseProfileImpl withProductFeaturesIotEnterpriseProfileProductFeaturesForUpdate(
