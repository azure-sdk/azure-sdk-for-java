...
public interface LicenseProfile {
    ...
    /**
     * Gets the subscriptionStatus property: Indicates the subscription status of the Windows Server.
     *
    ...
    /**
     * Gets the subscriptionStatusIotEnterpriseProfileSubscriptionStatus property: Indicates the subscription status of
    ...
    /**
     * Gets the billingStartDateIotEnterpriseProfileBillingStartDate property: The timestamp in UTC when the billing
     * starts.
     *
     * @return the billingStartDateIotEnterpriseProfileBillingStartDate value.
     */
    OffsetDateTime billingStartDateIotEnterpriseProfileBillingStartDate();

    /**
     * Gets the disenrollmentDateIotEnterpriseProfileDisenrollmentDate property: The timestamp in UTC when the user
     * disenrolled the feature.
     *
     * @return the disenrollmentDateIotEnterpriseProfileDisenrollmentDate value.
     */
    OffsetDateTime disenrollmentDateIotEnterpriseProfileDisenrollmentDate();

    /**
     * Gets the productFeaturesIotEnterpriseProfileProductFeatures property: The list of product features.
     *
    ...
    interface DefinitionStages {
        ...
        interface WithCreate
            extends DefinitionStages.WithTags,
                DefinitionStages.WithSoftwareAssuranceCustomer,
                DefinitionStages.WithAssignedLicense,
                DefinitionStages.WithSubscriptionStatus,
                DefinitionStages.WithProductFeatures,
                DefinitionStages.WithSubscriptionStatusIotEnterpriseProfileSubscriptionStatus,
                DefinitionStages.WithProductFeaturesIotEnterpriseProfileProductFeatures {
            /**
        ...
        interface WithSubscriptionStatus {
            /**
             * Specifies the subscriptionStatus property: Indicates the subscription status of the Windows Server..
             *
             * @param subscriptionStatus Indicates the subscription status of the Windows Server.
             * @return the next definition stage.
             */
        ...
        /**
         * The stage of the LicenseProfile definition allowing to specify
         * subscriptionStatusIotEnterpriseProfileSubscriptionStatus.
         */
        interface WithSubscriptionStatusIotEnterpriseProfileSubscriptionStatus {
            /**
             * Specifies the subscriptionStatusIotEnterpriseProfileSubscriptionStatus property: Indicates the
             * subscription status of the Windows IoT Enterprise..
             *
             * @param subscriptionStatusIotEnterpriseProfileSubscriptionStatus Indicates the subscription status of the
             *     Windows IoT Enterprise.
             * @return the next definition stage.
             */
            WithCreate withSubscriptionStatusIotEnterpriseProfileSubscriptionStatus(
                LicenseProfileSubscriptionStatus subscriptionStatusIotEnterpriseProfileSubscriptionStatus);
        }

        /**
         * The stage of the LicenseProfile definition allowing to specify
         * productFeaturesIotEnterpriseProfileProductFeatures.
         */
        interface WithProductFeaturesIotEnterpriseProfileProductFeatures {
            /**
             * Specifies the productFeaturesIotEnterpriseProfileProductFeatures property: The list of product features..
             *
             * @param productFeaturesIotEnterpriseProfileProductFeatures The list of product features.
             * @return the next definition stage.
             */
            WithCreate withProductFeaturesIotEnterpriseProfileProductFeatures(
                List<ProductFeature> productFeaturesIotEnterpriseProfileProductFeatures);
        }
    }
    ...
    interface Update
        extends UpdateStages.WithTags,
            UpdateStages.WithSoftwareAssuranceCustomer,
            UpdateStages.WithAssignedLicense,
            UpdateStages.WithSubscriptionStatus,
            UpdateStages.WithProductFeatures,
            UpdateStages.WithSubscriptionStatusIotEnterpriseProfileSubscriptionStatus,
            UpdateStages.WithProductFeaturesIotEnterpriseProfileProductFeatures {
        /**
    ...
    interface UpdateStages {
        ...
        /**
         * The stage of the LicenseProfile update allowing to specify
         * subscriptionStatusIotEnterpriseProfileSubscriptionStatus.
         */
        interface WithSubscriptionStatusIotEnterpriseProfileSubscriptionStatus {
            /**
             ...
             * @return the next definition stage.
             */
            Update withSubscriptionStatusIotEnterpriseProfileSubscriptionStatus(
        ...
        interface WithProductFeaturesIotEnterpriseProfileProductFeatures {
            /**
             * Specifies the productFeaturesIotEnterpriseProfileProductFeatures property: The list of product feature
             * updates..
             *
             * @param productFeaturesIotEnterpriseProfileProductFeatures The list of product feature updates.
             * @return the next definition stage.
             */
            Update withProductFeaturesIotEnterpriseProfileProductFeaturesForUpdate(
