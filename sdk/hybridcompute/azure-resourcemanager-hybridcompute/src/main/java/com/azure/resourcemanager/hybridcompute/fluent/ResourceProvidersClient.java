...
public interface ResourceProvidersClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<MachineExtensionSetupInner>, MachineExtensionSetupInner> beginSetupExtensions(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    MachineExtensionSetupInner setupExtensions(String resourceGroupName, String machineName,
