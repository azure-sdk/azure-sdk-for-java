...
public final class LicenseProfilesCreateOrUpdateSamples {
    ...
    public static void
        ...
        manager.licenseProfiles().define().withRegion("eastus2euap").withExistingMachine("myResourceGroup", "myMachine")
            ...
            .withProductFeatures(Arrays.asList(new ProductFeature().withName("HotPatching")
                .withSubscriptionStatus(LicenseProfileSubscriptionStatus.ENABLED)))
            .create();
    }
}
...
public final class LicenseProfilesUpdateSamples {
    ...
    public static void updateALicenseProfile(com.azure.resourcemanager.hybridcompute.HybridComputeManager manager) {
        ...
        resource.update().withSoftwareAssuranceCustomer(true).withAssignedLicense("{LicenseResourceId}")
            ...
            .withProductType(LicenseProfileProductType.WINDOWS_SERVER)
            .withProductFeaturesForUpdate(Arrays.asList(new ProductFeatureUpdate().withName("HotPatching")
                .withSubscriptionStatus(LicenseProfileSubscriptionStatusUpdate.ENABLE)))
            .apply();
    }
}
...
public final class LicensesCreateOrUpdateSamples {
    /*
     * x-ms-original-file:
     * specification/hybridcompute/resource-manager/Microsoft.HybridCompute/preview/2024-04-09-preview/examples/license/
    ...
    public static void createOrUpdateALicense(com.azure.resourcemanager.hybridcompute.HybridComputeManager manager) {
        manager.licenses().define("{licenseName}").withRegion("eastus2euap")
            .withExistingResourceGroup("myResourceGroup").withLicenseType(LicenseType.ESU)
            .withLicenseDetails(
                new LicenseDetails().withState(LicenseState.ACTIVATED).withTarget(LicenseTarget.WINDOWS_SERVER_2012)
                    .withEdition(LicenseEdition.DATACENTER).withType(LicenseCoreType.P_CORE).withProcessors(6))
            .create();
    }
}
```
...
public final class LicensesValidateLicenseSamples {
    ...
    public static void validateALicense(com.azure.resourcemanager.hybridcompute.HybridComputeManager manager) {
        manager.licenses().validateLicense(
            new LicenseInner().withLocation("eastus2euap").withLicenseType(LicenseType.ESU).withLicenseDetails(
                new LicenseDetails().withState(LicenseState.ACTIVATED).withTarget(LicenseTarget.WINDOWS_SERVER_2012)
                    .withEdition(LicenseEdition.DATACENTER).withType(LicenseCoreType.P_CORE).withProcessors(6)),
            com.azure.core.util.Context.NONE);
    }
...
public final class MachineExtensionsCreateOrUpdateSamples {
    ...
    public static void
        ...
        manager.machineExtensions().define("CustomScriptExtension").withRegion("eastus2euap")
            .withExistingMachine("myResourceGroup", "myMachine")
            .withProperties(new MachineExtensionProperties().withPublisher("Microsoft.Compute")
                .withType("CustomScriptExtension").withTypeHandlerVersion("1.10").withSettings(
...
public final class MachineRunCommandsCreateOrUpdateSamples {
    ...
    public static void createOrUpdateARunCommand(com.azure.resourcemanager.hybridcompute.HybridComputeManager manager) {
        manager.machineRunCommands().define("myRunCommand").withRegion("eastus2")
            .withExistingMachine("myResourceGroup", "myMachine")
            ...
            .withErrorBlobUri("https://mystorageaccount.blob.core.windows.net/mycontainer/MyScriptError.txt").create();
    }
}
```
...
public final class MachinesAssessPatchesSamples {
    /*
     * x-ms-original-file:
     * specification/hybridcompute/resource-manager/Microsoft.HybridCompute/preview/2024-04-09-preview/examples/machine/
...
public final class MachinesInstallPatchesSamples {
    ...
    public static void
        ...
        manager.machines().installPatches("myResourceGroupName", "myMachineName",
            new MachineInstallPatchesParameters().withMaximumDuration("PT4H")
...
public final class NetworkConfigurationsCreateOrUpdateSamples {
     ...
     * x-ms-original-file:
     * specification/hybridcompute/resource-manager/Microsoft.HybridCompute/preview/2024-04-09-preview/examples/
     * networkConfiguration/NetworkConfigurationsUpdate.json
     */
    /**
     ...
     */
    public static void
        networkConfigurationsUpdate(com.azure.resourcemanager.hybridcompute.HybridComputeManager manager) {
        manager.networkConfigurations().createOrUpdateWithResponse(
            ...
            new NetworkConfigurationInner().withNetworkConfigurationScopeResourceId(
                "/subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/hybridRG/providers/Microsoft.HybridCompute/privateLinkScopes/newScope"),
            com.azure.core.util.Context.NONE);
    }
     ...
     * x-ms-original-file:
     * specification/hybridcompute/resource-manager/Microsoft.HybridCompute/preview/2024-04-09-preview/examples/
     * networkConfiguration/NetworkConfigurationsCreate.json
     */
    /**
     ...
     */
    public static void
        networkConfigurationsCreate(com.azure.resourcemanager.hybridcompute.HybridComputeManager manager) {
        manager.networkConfigurations().createOrUpdateWithResponse(
            "subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/hybridRG/providers/Microsoft.HybridCompute/machines/testMachine",
            new NetworkConfigurationInner().withLocation("westus").withNetworkConfigurationScopeResourceId(
...
public final class NetworkConfigurationsGetSamples {
     ...
     * x-ms-original-file:
     * specification/hybridcompute/resource-manager/Microsoft.HybridCompute/preview/2024-04-09-preview/examples/
     * networkConfiguration/NetworkConfigurationsGet.json
     */
    /**
    ...
    public static void networkConfigurationsGet(com.azure.resourcemanager.hybridcompute.HybridComputeManager manager) {
        manager.networkConfigurations().getWithResponse(
            "subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/hybridRG/providers/Microsoft.HybridCompute/machines/testMachine",
            com.azure.core.util.Context.NONE);
    }
}
...
public final class NetworkConfigurationsUpdateSamples {
     ...
     * x-ms-original-file:
     * specification/hybridcompute/resource-manager/Microsoft.HybridCompute/preview/2024-04-09-preview/examples/
     * networkConfiguration/NetworkConfigurationsPatch.json
     */
    /**
    ...
    public static void
        ...
        manager.networkConfigurations().updateWithResponse(
            "subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/hybridRG/providers/Microsoft.HybridCompute/machines/testMachine",
            new NetworkConfigurationInner().withNetworkConfigurationScopeResourceId(
                "/subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/hybridRG/providers/Microsoft.HybridCompute/privateLinkScopes/newScope"),
            com.azure.core.util.Context.NONE);
...
public final class PrivateLinkScopesCreateOrUpdateSamples {
    ...
    public static void privateLinkScopeCreate(com.azure.resourcemanager.hybridcompute.HybridComputeManager manager) {
        manager.privateLinkScopes().define("my-privatelinkscope").withRegion("westus")
...
public final class ResourceProviderUpgradeExtensionsSamples {
    ...
    public static void upgradeMachineExtensions(com.azure.resourcemanager.hybridcompute.HybridComputeManager manager) {
        manager.resourceProviders().upgradeExtensions("myResourceGroup", "myMachine",
