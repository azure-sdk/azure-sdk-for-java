...
public final class ConfigurationsCreateInResourceGroupSamples {
    ...
    public static void putConfigurations(com.azure.resourcemanager.advisor.AdvisorManager manager) {
        manager.configurations().define(ConfigurationName.DEFAULT).withExistingResourceGroup("resourceGroup")
            .withExclude(true).withLowCpuThreshold(CpuThreshold.FIVE).withDuration(DurationModel.SEVEN)
            .withDigests(Arrays.asList(new DigestConfig().withName("digestConfigName").withActionGroupResourceId(
                ...
                .withLanguage("en").withState(DigestConfigState.ACTIVE)))
            .create();
    }
}
```
...
public final class ConfigurationsCreateInSubscriptionSamples {
     ...
     */
    public static void putConfigurations(com.azure.resourcemanager.advisor.AdvisorManager manager) {
        manager.configurations().createInSubscriptionWithResponse(ConfigurationName.DEFAULT, new ConfigDataInner()
            .withExclude(true).withLowCpuThreshold(CpuThreshold.FIVE).withDuration(DurationModel.SEVEN)
            .withDigests(Arrays.asList(new DigestConfig().withName("digestConfigName").withActionGroupResourceId(
                "/subscriptions/subscriptionId/resourceGroups/resourceGroup/providers/microsoft.insights/actionGroups/actionGroupName")
                .withFrequency(30)
...
public final class RecommendationsGetGenerateStatusSamples {
    ...
    public static void getGenerateStatus(com.azure.resourcemanager.advisor.AdvisorManager manager) {
        manager.recommendations().getGenerateStatusWithResponse(UUID.fromString("123e4567-e89b-12d3-a456-426614174000"),
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class ResourceProviderPredictSamples {
    ...
    public static void predict(com.azure.resourcemanager.advisor.AdvisorManager manager) throws IOException {
        manager.resourceProviders().predictWithResponse(new PredictionRequest()
            .withPredictionType(PredictionType.PREDICTIVE_RIGHTSIZING)
            .withExtendedProperties(SerializerFactory.createDefaultManagementSerializerAdapter().deserialize(
...
public final class SuppressionsCreateSamples {
    ...
    public static void createSuppression(com.azure.resourcemanager.advisor.AdvisorManager manager) {
        manager.suppressions().define("suppressionName1").withExistingRecommendation("resourceUri", "recommendationId")
            .withTtl("07:00:00:00").create();
    }
}
```
...
public final class SuppressionsDeleteSamples {
    ...
    public static void deleteSuppression(com.azure.resourcemanager.advisor.AdvisorManager manager) {
        manager.suppressions().deleteWithResponse("resourceUri", "recommendationId", "suppressionName1",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class SuppressionsGetSamples {
    ...
    public static void getSuppressionDetail(com.azure.resourcemanager.advisor.AdvisorManager manager) {
        manager.suppressions().getWithResponse("resourceUri", "recommendationId", "suppressionName1",
            com.azure.core.util.Context.NONE);
    }
}
```
