...
public final class ConfigurationsImpl implements Configurations {
    ...
    public ConfigData createInSubscriptionDuration(
        ...
        ConfigDataInner inner =
            this.serviceClient().createInSubscriptionDuration(configurationName, configurationType, configContract);
        if (inner != null) {
    ...
    public Response<ConfigData> createInResourceGroupDurationWithResponse(
    ...
    public ConfigData createInResourceGroupDuration(
        String resourceGroup,
        ConfigurationName configurationName,
        ConfigurationNameAutoGenerated configurationType,
        ConfigDataInner configContract) {
        ConfigDataInner inner =
            this
                .serviceClient()
                .createInResourceGroupDuration(resourceGroup, configurationName, configurationType, configContract);
        if (inner != null) {
            return new ConfigDataImpl(inner, this.manager());
        } else {
            return null;
