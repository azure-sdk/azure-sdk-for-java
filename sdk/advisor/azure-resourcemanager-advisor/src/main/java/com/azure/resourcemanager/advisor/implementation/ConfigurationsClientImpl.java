...
import com.azure.resourcemanager.advisor.models.ConfigurationNameAutoGenerated;
...
public final class ConfigurationsClientImpl implements ConfigurationsClient {
    ...
    public interface ConfigurationsService {
        ...
        @Headers({"Content-Type: application/json"})
        @Put(
            "/subscriptions/{subscriptionId}/providers/Microsoft.Advisor/configurations/{configurationName}/v2/{configurationType}")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ConfigDataInner>> createInSubscriptionDuration(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("configurationName") ConfigurationName configurationName,
            @PathParam("configurationType") ConfigurationNameAutoGenerated configurationType,
        ...
        @Headers({"Content-Type: application/json"})
        @Put(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroup}/providers/Microsoft.Advisor/configurations/{configurationName}/v2/{configurationType}")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ConfigDataInner>> createInResourceGroupDuration(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroup") String resourceGroup,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ConfigDataInner>> createInSubscriptionDurationWithResponseAsync(
        ConfigurationName configurationName,
        ConfigurationNameAutoGenerated configurationType,
        ...
        if (configurationType == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter configurationType is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ConfigDataInner> createInSubscriptionDurationAsync(
        ConfigurationName configurationName,
        ConfigurationNameAutoGenerated configurationType,
        ConfigDataInner configContract) {
        return createInSubscriptionDurationWithResponseAsync(configurationName, configurationType, configContract)
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ConfigDataInner> createInSubscriptionDurationWithResponse(
        ConfigurationName configurationName,
        ConfigurationNameAutoGenerated configurationType,
        ConfigDataInner configContract,
        Context context) {
        return createInSubscriptionDurationWithResponseAsync(
                configurationName, configurationType, configContract, context)
            .block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ConfigDataInner createInSubscriptionDuration(
        ConfigurationName configurationName,
        ConfigurationNameAutoGenerated configurationType,
        ConfigDataInner configContract) {
        return createInSubscriptionDurationWithResponse(
                configurationName, configurationType, configContract, Context.NONE)
            .getValue();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ConfigDataInner>> createInResourceGroupDurationWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ConfigDataInner> createInResourceGroupDurationAsync(
        String resourceGroup,
        ConfigurationName configurationName,
        ConfigurationNameAutoGenerated configurationType,
        ConfigDataInner configContract) {
        return createInResourceGroupDurationWithResponseAsync(
                resourceGroup, configurationName, configurationType, configContract)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ConfigDataInner> createInResourceGroupDurationWithResponse(
        String resourceGroup,
        ConfigurationName configurationName,
        ConfigurationNameAutoGenerated configurationType,
        ConfigDataInner configContract,
        Context context) {
        return createInResourceGroupDurationWithResponseAsync(
                resourceGroup, configurationName, configurationType, configContract, context)
            .block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ConfigDataInner createInResourceGroupDuration(
        String resourceGroup,
        ConfigurationName configurationName,
        ConfigurationNameAutoGenerated configurationType,
        ConfigDataInner configContract) {
        return createInResourceGroupDurationWithResponse(
                resourceGroup, configurationName, configurationType, configContract, Context.NONE)
            .getValue();
    }
