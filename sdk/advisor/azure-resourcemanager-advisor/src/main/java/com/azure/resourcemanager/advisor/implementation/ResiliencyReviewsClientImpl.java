...
public final class ResiliencyReviewsClientImpl implements ResiliencyReviewsClient {
    ...
    private Mono<PagedResponse<ResiliencyReviewInner>> listSinglePageAsync(Integer top, Integer skip, String filter,
        ...
        return service
            .list(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(), top, skip,
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<ResiliencyReviewInner> listAsync(Integer top, Integer skip, String filter, Context context) {
        return new PagedFlux<>(() -> listSinglePageAsync(top, skip, filter, context),
    ...
    public PagedIterable<ResiliencyReviewInner> list() {
        ...
        final Integer skip = null;
        final String filter = null;
        return new PagedIterable<>(listAsync(top, skip, filter));
    }
    ...
    public PagedIterable<ResiliencyReviewInner> list(Integer top, Integer skip, String filter, Context context) {
        return new PagedIterable<>(listAsync(top, skip, filter, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ResiliencyReviewInner>> getWithResponseAsync(String reviewId, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    public Response<ResiliencyReviewInner> getWithResponse(String reviewId, Context context) {
        return getWithResponseAsync(reviewId, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<ResiliencyReviewInner>> listNextSinglePageAsync(String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        if (this.client.getEndpoint() == null) {
