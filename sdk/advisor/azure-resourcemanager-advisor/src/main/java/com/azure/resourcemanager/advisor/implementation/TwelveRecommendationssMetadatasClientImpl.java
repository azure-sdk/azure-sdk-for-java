...
/** An instance of this class provides access to all the operations defined in TwelveRecommendationssMetadatasClient. */
public final class TwelveRecommendationssMetadatasClientImpl implements TwelveRecommendationssMetadatasClient {
    /** The proxy service used to perform REST calls. */
    private final TwelveRecommendationssMetadatasService service;

    /** The service client containing this operation class. */
    private final AdvisorManagementClientImpl client;

    /**
     * Initializes an instance of TwelveRecommendationssMetadatasClientImpl.
     *
     * @param client the instance of the service client containing this operation class.
     */
    TwelveRecommendationssMetadatasClientImpl(AdvisorManagementClientImpl client) {
        this.service =
            RestProxy
                .create(
                    TwelveRecommendationssMetadatasService.class,
    ...
    /**
     * The interface defining all the services for AdvisorManagementClientTwelveRecommendationssMetadatas to be used by
     * the proxy service to perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "AdvisorManagementCli")
    private interface TwelveRecommendationssMetadatasService {
