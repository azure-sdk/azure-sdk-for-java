...
public final class AdvisorScoresClientImpl implements AdvisorScoresClient {
    ...
    public interface AdvisorScoresService {
        ...
        Mono<Response<AdvisorScoreResponseInner>> list(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<AdvisorScoreEntityInner>> get(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
    ...
    private Mono<Response<AdvisorScoreResponseInner>> listWithResponseAsync() {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<AdvisorScoreResponseInner>> listWithResponseAsync(Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<AdvisorScoreResponseInner> listAsync() {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<AdvisorScoreResponseInner> listWithResponse(Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public AdvisorScoreResponseInner list() {
