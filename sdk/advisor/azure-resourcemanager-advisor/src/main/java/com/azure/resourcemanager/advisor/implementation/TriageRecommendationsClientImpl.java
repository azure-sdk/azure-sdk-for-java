...
public final class TriageRecommendationsClientImpl implements TriageRecommendationsClient {
    ...
    private Mono<PagedResponse<TriageRecommendationInner>> listSinglePageAsync(String reviewId, Integer top,
        ...
        return service
            .list(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(), reviewId,
    ...
    private PagedFlux<TriageRecommendationInner> listAsync(String reviewId, Integer top, Integer skip,
        Context context) {
        return new PagedFlux<>(() -> listSinglePageAsync(reviewId, top, skip, context),
    ...
    public PagedIterable<TriageRecommendationInner> list(String reviewId) {
        final Integer top = null;
        final Integer skip = null;
        return new PagedIterable<>(listAsync(reviewId, top, skip));
    }
    ...
    public PagedIterable<TriageRecommendationInner> list(String reviewId, Integer top, Integer skip, Context context) {
        return new PagedIterable<>(listAsync(reviewId, top, skip, context));
    }
    ...
    public Response<TriageRecommendationInner> getWithResponse(String reviewId, String recommendationId,
        Context context) {
        return getWithResponseAsync(reviewId, recommendationId, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Void>> approveTriageRecommendationWithResponseAsync(String reviewId, String recommendationId,
        Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.approveTriageRecommendation(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), reviewId, recommendationId, accept, context);
    }
    ...
    public Response<Void> approveTriageRecommendationWithResponse(String reviewId, String recommendationId,
        Context context) {
        return approveTriageRecommendationWithResponseAsync(reviewId, recommendationId, context).block();
    }
    ...
    private Mono<Response<Void>> rejectTriageRecommendationWithResponseAsync(String reviewId, String recommendationId,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.rejectTriageRecommendation(this.client.getEndpoint(), this.client.getApiVersion(),
    ...
    private Mono<Response<Void>> resetTriageRecommendationWithResponseAsync(String reviewId, String recommendationId,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.resetTriageRecommendation(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), reviewId, recommendationId, accept, context);
    }
    ...
    public Response<Void> resetTriageRecommendationWithResponse(String reviewId, String recommendationId,
        Context context) {
        return resetTriageRecommendationWithResponseAsync(reviewId, recommendationId, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<TriageRecommendationInner>> listNextSinglePageAsync(String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        if (this.client.getEndpoint() == null) {
