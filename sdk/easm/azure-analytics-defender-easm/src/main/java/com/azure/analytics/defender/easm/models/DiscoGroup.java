...
public final class DiscoGroup implements JsonSerializable<DiscoGroup> {
     ...
     * @return the DiscoGroup object itself.
     */
    @Generated
    public DiscoGroup setDescription(String description) {
     ...
     */
    @Generated
    public DiscoGroup setTier(String tier) {
        this.tier = tier;
        return this;
    }
     ...
     */
    @Generated
    public DiscoGroup setFrequencyMilliseconds(Long frequencyMilliseconds) {
     ...
     */
    @Generated
    public DiscoGroup setSeeds(List<DiscoSource> seeds) {
        this.seeds = seeds;
        return this;
    }
     ...
     */
    @Generated
    public DiscoGroup setNames(List<String> names) {
        this.names = names;
        return this;
    }
     ...
     */
    @Generated
    public DiscoGroup setExcludes(List<DiscoSource> excludes) {
     ...
     */
    @Generated
    public DiscoGroup setTemplateId(String templateId) {
