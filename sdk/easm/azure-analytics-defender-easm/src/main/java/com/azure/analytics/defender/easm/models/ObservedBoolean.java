        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("firstSeen".equals(fieldName)) {
                    deserializedObservedBoolean.setFirstSeen(reader
                        .getNullable(nonNullReader -> CoreUtils.parseBestOffsetDateTime(nonNullReader.getString())));
                } else if ("lastSeen".equals(fieldName)) {
                    deserializedObservedBoolean.setLastSeen(reader
                        .getNullable(nonNullReader -> CoreUtils.parseBestOffsetDateTime(nonNullReader.getString())));
                } else if ("count".equals(fieldName)) {
                    deserializedObservedBoolean.setCount(reader.getNullable(JsonReader::getLong));
                } else if ("recent".equals(fieldName)) {
                    deserializedObservedBoolean.setRecent(reader.getNullable(JsonReader::getBoolean));
