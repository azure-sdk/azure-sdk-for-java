        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("firstSeen".equals(fieldName)) {
                    deserializedObservedInteger.setFirstSeen(reader
                        .getNullable(nonNullReader -> CoreUtils.parseBestOffsetDateTime(nonNullReader.getString())));
                } else if ("lastSeen".equals(fieldName)) {
                    deserializedObservedInteger.setLastSeen(reader
                        .getNullable(nonNullReader -> CoreUtils.parseBestOffsetDateTime(nonNullReader.getString())));
                } else if ("count".equals(fieldName)) {
                    deserializedObservedInteger.setCount(reader.getNullable(JsonReader::getLong));
                } else if ("recent".equals(fieldName)) {
                    deserializedObservedInteger.setRecent(reader.getNullable(JsonReader::getBoolean));
