...
public final class DomainAssetResource extends AssetResource {
     ...
     */
    @Generated
    private DomainAssetResource(DomainAsset asset) {
        this.asset = asset;
    }
    ...
    /**
     * Reads an instance of DomainAssetResource from the JsonReader.
     *
     * @param jsonReader The JsonReader being read.
     * @return An instance of DomainAssetResource if the JsonReader was pointing to an instance of it, or null if it was
     * pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the DomainAssetResource.
     */
    @Generated
    public static DomainAssetResource fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("id".equals(fieldName)) {
                    ...
                    asset = DomainAsset.fromJson(reader);
