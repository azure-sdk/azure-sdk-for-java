...
public final class AsAssetResource extends AssetResource {
    ...
    public static AsAssetResource fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            deserializedAsAssetResource.setDisplayName(displayName);
            deserializedAsAssetResource.setUuid(uuid);
            deserializedAsAssetResource.setCreatedDate(createdDate);
            deserializedAsAssetResource.setUpdatedDate(updatedDate);
            deserializedAsAssetResource.setState(state);
            deserializedAsAssetResource.setExternalId(externalId);
            deserializedAsAssetResource.setLabels(labels);
            deserializedAsAssetResource.setWildcard(wildcard);
            deserializedAsAssetResource.setDiscoGroupName(discoGroupName);
            deserializedAsAssetResource.setAuditTrail(auditTrail);
            deserializedAsAssetResource.setReason(reason);
