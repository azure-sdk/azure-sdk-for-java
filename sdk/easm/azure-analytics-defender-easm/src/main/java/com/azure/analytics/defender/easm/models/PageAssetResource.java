...
public final class PageAssetResource extends AssetResource {
     ...
     */
    @Generated
    private PageAssetResource(PageAsset asset) {
        this.asset = asset;
    }
    ...
    /**
     * Reads an instance of PageAssetResource from the JsonReader.
     *
     * @param jsonReader The JsonReader being read.
     * @return An instance of PageAssetResource if the JsonReader was pointing to an instance of it, or null if it was
     * pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the PageAssetResource.
     */
    @Generated
    public static PageAssetResource fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("id".equals(fieldName)) {
                    ...
                    asset = PageAsset.fromJson(reader);
            ...
            PageAssetResource deserializedPageAssetResource = new PageAssetResource(asset);
            deserializedPageAssetResource.setId(id);
            deserializedPageAssetResource.setName(name);
            deserializedPageAssetResource.setDisplayName(displayName);
            deserializedPageAssetResource.setUuid(uuid);
            deserializedPageAssetResource.setCreatedDate(createdDate);
            deserializedPageAssetResource.setUpdatedDate(updatedDate);
            deserializedPageAssetResource.setState(state);
            deserializedPageAssetResource.setExternalId(externalId);
            deserializedPageAssetResource.setLabels(labels);
            deserializedPageAssetResource.setWildcard(wildcard);
            deserializedPageAssetResource.setDiscoGroupName(discoGroupName);
            deserializedPageAssetResource.setAuditTrail(auditTrail);
            deserializedPageAssetResource.setReason(reason);
            deserializedPageAssetResource.kind = kind;
            return deserializedPageAssetResource;
        });
    }
}
