...
import com.azure.analytics.defender.easm.models.LogAnalyticsDataConnection;
...
public class DataConnectionsValidateDataConnection {
    public static void main(String[] args) {
        ...
        ValidateResult response = easmClient.validateDataConnection("ThisisaDataConnection",
            new LogAnalyticsDataConnection(new LogAnalyticsDataConnectionProperties().setApiKey("fakeTokenPlaceholder")
