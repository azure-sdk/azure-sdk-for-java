...
public final class SqlMiTargetProperties extends TargetProperties {
    ...
    public void validate() {
        ...
        if (targetAuthenticationType() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property targetAuthenticationType in model SqlMiTargetProperties"));
        }
        if (targetVault() != null) {
        ...
        if (connectionServerName() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property connectionServerName in model SqlMiTargetProperties"));
        }
    }
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("targetAuthenticationType".equals(fieldName)) {
                    ...
                    deserializedSqlMiTargetProperties.provisioningState
