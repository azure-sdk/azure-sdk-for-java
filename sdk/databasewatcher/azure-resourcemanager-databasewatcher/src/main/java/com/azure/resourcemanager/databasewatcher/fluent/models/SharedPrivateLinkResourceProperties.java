...
public final class SharedPrivateLinkResourceProperties
    ...
    /*
     * The DNS zone to be included in the DNS name of the shared private link. Value is required for Azure Data Explorer
     * clusters and SQL managed instances. The value to use is the second segment of the host FQDN name of the resource
     * that the shared private link resource is for.
     */
