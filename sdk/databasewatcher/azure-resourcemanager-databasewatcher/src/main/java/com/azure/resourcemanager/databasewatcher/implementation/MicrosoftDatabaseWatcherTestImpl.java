...
/**
 * Initializes a new instance of the MicrosoftDatabaseWatcherTestImpl type.
 */
@ServiceClient(builder = MicrosoftDatabaseWatcherTestBuilder.class)
public final class MicrosoftDatabaseWatcherTestImpl implements MicrosoftDatabaseWatcherTest {
    /**
    ...
    /**
     * Initializes an instance of MicrosoftDatabaseWatcherTest client.
     * 
     ...
     */
    MicrosoftDatabaseWatcherTestImpl(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter,
        ...
        this.apiVersion = "2024-07-19-preview";
    ...
    private static final ClientLogger LOGGER = new ClientLogger(MicrosoftDatabaseWatcherTestImpl.class);
}
