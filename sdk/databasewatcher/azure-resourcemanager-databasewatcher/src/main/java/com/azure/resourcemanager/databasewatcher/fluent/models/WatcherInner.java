    ...
    public void validate() {
        ...
        if (location() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Missing required property location in model WatcherInner"));
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(WatcherInner.class);
