...
public final class SharedPrivateLinkResourceImpl
    ...
    public SharedPrivateLinkResource create() {
        this.innerObject = serviceManager.serviceClient().getSharedPrivateLinkResources().create(resourceGroupName,
            watcherName, sharedPrivateLinkResourceName, this.innerModel(), Context.NONE);
        return this;
    }

    public SharedPrivateLinkResource create(Context context) {
        this.innerObject = serviceManager.serviceClient().getSharedPrivateLinkResources().create(resourceGroupName,
            watcherName, sharedPrivateLinkResourceName, this.innerModel(), context);
        return this;
    }
    ...
    public SharedPrivateLinkResource refresh() {
        this.innerObject = serviceManager.serviceClient().getSharedPrivateLinkResources()
            .getWithResponse(resourceGroupName, watcherName, sharedPrivateLinkResourceName, Context.NONE).getValue();
        return this;
    }

    public SharedPrivateLinkResource refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getSharedPrivateLinkResources()
            .getWithResponse(resourceGroupName, watcherName, sharedPrivateLinkResourceName, context).getValue();
        return this;
    }
