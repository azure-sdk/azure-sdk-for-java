...
public interface SharedPrivateLinkResource {
    ...
    /**
     * Gets the dnsZone property: The DNS zone to be included in the DNS name of the shared private link. Value is
     * required for Azure Data Explorer clusters and SQL managed instances. The value to use is the second segment of
     * the host FQDN name of the resource that the shared private link resource is for.
     * 
    ...
    interface DefinitionStages {
        ...
        interface WithDnsZone {
            /**
             * Specifies the dnsZone property: The DNS zone to be included in the DNS name of the shared private link.
             * Value is required for Azure Data Explorer clusters and SQL managed instances. The value to use is the
             * second segment of the host FQDN name of the resource that the shared private link resource is for..
             * 
             * @param dnsZone The DNS zone to be included in the DNS name of the shared private link. Value is required
             * for Azure Data Explorer clusters and SQL managed instances. The value to use is the second segment of the
             * host FQDN name of the resource that the shared private link resource is for.
             * @return the next definition stage.
             */
