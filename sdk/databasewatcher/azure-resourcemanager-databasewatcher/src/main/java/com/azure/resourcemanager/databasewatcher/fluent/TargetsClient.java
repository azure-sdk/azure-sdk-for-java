...
public interface TargetsClient {
    ...
    PagedIterable<TargetInner> listByParent(String resourceGroupName, String watcherName);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<TargetInner> listByParent(String resourceGroupName, String watcherName, Context context);
