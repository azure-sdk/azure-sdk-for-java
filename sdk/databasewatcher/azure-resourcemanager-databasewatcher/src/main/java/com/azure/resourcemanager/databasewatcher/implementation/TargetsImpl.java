...
public final class TargetsImpl implements Targets {
    ...
    public PagedIterable<Target> listByParent(String resourceGroupName, String watcherName) {
        PagedIterable<TargetInner> inner = this.serviceClient().listByParent(resourceGroupName, watcherName);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new TargetImpl(inner1, this.manager()));
    }

    public PagedIterable<Target> listByParent(String resourceGroupName, String watcherName, Context context) {
        PagedIterable<TargetInner> inner = this.serviceClient().listByParent(resourceGroupName, watcherName, context);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new TargetImpl(inner1, this.manager()));
    }
