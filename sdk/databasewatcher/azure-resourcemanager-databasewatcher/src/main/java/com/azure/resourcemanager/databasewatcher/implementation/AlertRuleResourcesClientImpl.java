...
public final class AlertRuleResourcesClientImpl implements AlertRuleResourcesClient {
     ...
     */
    AlertRuleResourcesClientImpl(DatabaseWatcherClientImpl client) {
    ...
    /**
     * The interface defining all the services for DatabaseWatcherClientAlertRuleResources to be used by the proxy
