...
import com.azure.resourcemanager.databasewatcher.models.OperationListResult;
...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    OperationsClientImpl(MicrosoftDatabaseWatcherTestImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for MicrosoftDatabaseWatcherTestOperations to be used by the proxy
