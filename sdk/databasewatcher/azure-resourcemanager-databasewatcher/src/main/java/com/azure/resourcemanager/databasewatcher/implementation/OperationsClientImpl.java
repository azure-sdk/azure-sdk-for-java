...
import com.azure.resourcemanager.databasewatcher.implementation.models.OperationListResult;
...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    OperationsClientImpl(DatabaseWatcherClientImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for DatabaseWatcherClientOperations to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{endpoint}")
