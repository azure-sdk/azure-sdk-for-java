...
/**
 * Initializes a new instance of the DatabaseWatcherClientImpl type.
 */
@ServiceClient(builder = DatabaseWatcherClientBuilder.class)
public final class DatabaseWatcherClientImpl implements DatabaseWatcherClient {
    /**
     * Service host.
     */
    ...
    /**
     * Initializes an instance of DatabaseWatcherClient client.
     * 
     ...
     */
    DatabaseWatcherClientImpl(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter,
    ...
    private static final ClientLogger LOGGER = new ClientLogger(DatabaseWatcherClientImpl.class);
}
