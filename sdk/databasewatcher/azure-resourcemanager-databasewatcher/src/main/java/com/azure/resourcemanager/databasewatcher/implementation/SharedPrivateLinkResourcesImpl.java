...
public final class SharedPrivateLinkResourcesImpl implements SharedPrivateLinkResources {
    ...
    public PagedIterable<SharedPrivateLinkResource> listByParent(String resourceGroupName, String watcherName) {
        PagedIterable<SharedPrivateLinkResourceInner> inner
            = this.serviceClient().listByParent(resourceGroupName, watcherName);
