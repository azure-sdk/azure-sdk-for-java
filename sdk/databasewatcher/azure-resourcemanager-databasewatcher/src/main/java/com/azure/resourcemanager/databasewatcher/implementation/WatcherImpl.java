...
public final class WatcherImpl implements Watcher, Watcher.Definition, Watcher.Update {
    ...
    public Watcher create() {
        this.innerObject = serviceManager.serviceClient().getWatchers().createOrUpdate(resourceGroupName, watcherName,
    ...
    public Watcher apply() {
        this.innerObject = serviceManager.serviceClient().getWatchers().update(resourceGroupName, watcherName,
    ...
    public Watcher refresh() {
        this.innerObject = serviceManager.serviceClient().getWatchers()
            .getByResourceGroupWithResponse(resourceGroupName, watcherName, Context.NONE).getValue();
        return this;
    }

    public Watcher refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getWatchers()
            .getByResourceGroupWithResponse(resourceGroupName, watcherName, context).getValue();
        return this;
    }
