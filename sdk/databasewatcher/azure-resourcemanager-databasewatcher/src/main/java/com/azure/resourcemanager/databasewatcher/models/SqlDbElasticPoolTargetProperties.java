...
public final class SqlDbElasticPoolTargetProperties extends TargetProperties {
    /*
     * The ARM ResourceId of an Azure SQL DB elastic pool target.
     */
    @JsonProperty(value = "sqlEpResourceId", required = true)
    private String sqlEpResourceId;

    /*
     * The ARM ResourceId of the anchor database used to connect to an elastic pool.
     */
    ...
    /**
     * Get the sqlEpResourceId property: The ARM ResourceId of an Azure SQL DB elastic pool target.
     * 
    ...
    /**
     * Set the sqlEpResourceId property: The ARM ResourceId of an Azure SQL DB elastic pool target.
     * 
    ...
    /**
     * Get the anchorDatabaseResourceId property: The ARM ResourceId of the anchor database used to connect to an
     * elastic pool.
     * 
    ...
    /**
     * Set the anchorDatabaseResourceId property: The ARM ResourceId of the anchor database used to connect to an
     * elastic pool.
     * 
