...
public final class SqlVmTargetProperties extends TargetProperties {
    /*
     * The ARM ResourceId of an Azure SQL VM target.
     */
    ...
    /**
     * Get the sqlVmResourceId property: The ARM ResourceId of an Azure SQL VM target.
     * 
    ...
    /**
     * Set the sqlVmResourceId property: The ARM ResourceId of an Azure SQL VM target.
     * 
     ...
     */
    @Override
    public SqlVmTargetProperties withTargetCollectionStatus(StringModel targetCollectionStatus) {
