...
public final class SqlVmTargetProperties extends TargetProperties {
    ...
    public void validate() {
        ...
        if (targetAuthenticationType() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property targetAuthenticationType in model SqlVmTargetProperties"));
        }
        if (targetVault() != null) {
        ...
        if (connectionServerName() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property connectionServerName in model SqlVmTargetProperties"));
        }
    }
