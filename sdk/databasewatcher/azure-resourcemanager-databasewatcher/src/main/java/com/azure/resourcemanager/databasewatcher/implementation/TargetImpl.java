...
public final class TargetImpl implements Target, Target.Definition, Target.Update {
    ...
    public Target create() {
        this.innerObject = serviceManager.serviceClient().getTargets()
    ...
    public Target refresh() {
        this.innerObject = serviceManager.serviceClient().getTargets()
            .getWithResponse(resourceGroupName, watcherName, targetName, Context.NONE).getValue();
        return this;
    }

    public Target refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getTargets()
            .getWithResponse(resourceGroupName, watcherName, targetName, context).getValue();
        return this;
    }
