...
public final class HealthValidationsClientImpl implements HealthValidationsClient {
     ...
     */
    HealthValidationsClientImpl(DatabaseWatcherClientImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for DatabaseWatcherClientHealthValidations to be used by the proxy
