...
public final class SqlDbSingleDatabaseTargetProperties extends TargetProperties {
    /*
     * The ARM ResourceId of an Azure SQL DB single database target.
     */
    ...
    /**
     * Get the sqlDbResourceId property: The ARM ResourceId of an Azure SQL DB single database target.
     * 
    ...
    /**
     * Set the sqlDbResourceId property: The ARM ResourceId of an Azure SQL DB single database target.
     * 
     ...
     */
    @Override
    public SqlDbSingleDatabaseTargetProperties withTargetCollectionStatus(StringModel targetCollectionStatus) {
