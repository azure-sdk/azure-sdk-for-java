...
public final class SqlDbSingleDatabaseTargetProperties extends TargetProperties {
    ...
    /**
     * Get the sqlDbResourceId property: The Azure resource ID of an Azure SQL DB single database target.
     * 
    ...
    /**
     * Set the sqlDbResourceId property: The Azure resource ID of an Azure SQL DB single database target.
     * 
