...
public final class TargetsClientImpl implements TargetsClient {
     ...
     */
    TargetsClientImpl(MicrosoftDatabaseWatcherTestImpl client) {
        this.service = RestProxy.create(TargetsService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for MicrosoftDatabaseWatcherTestTargets to be used by the proxy service
    ...
    public interface TargetsService {
        ...
        Mono<Response<TargetListResult>> listByWatcher(@HostParam("$host") String endpoint,
