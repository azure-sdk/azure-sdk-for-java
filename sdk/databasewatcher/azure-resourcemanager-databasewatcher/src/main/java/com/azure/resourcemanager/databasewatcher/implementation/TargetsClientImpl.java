...
public final class TargetsClientImpl implements TargetsClient {
     ...
     */
    TargetsClientImpl(DatabaseWatcherClientImpl client) {
        this.service = RestProxy.create(TargetsService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for DatabaseWatcherClientTargets to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{endpoint}")
