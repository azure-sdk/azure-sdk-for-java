...
import com.azure.resourcemanager.databasewatcher.models.TargetListResult;
...
public final class TargetsClientImpl implements TargetsClient {
     ...
     */
    TargetsClientImpl(MicrosoftDatabaseWatcherImpl client) {
        this.service = RestProxy.create(TargetsService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for MicrosoftDatabaseWatcherTargets to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{$host}")
    ...
    public interface TargetsService {
        ...
        Mono<Response<TargetListResult>> listByParent(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<TargetListResult>> listByParentNext(
    ...
    private Mono<PagedResponse<TargetInner>> listByParentSinglePageAsync(String resourceGroupName, String watcherName) {
    ...
    private PagedFlux<TargetInner> listByParentAsync(String resourceGroupName, String watcherName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<TargetInner> listByParentAsync(String resourceGroupName, String watcherName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<TargetInner> listByParent(String resourceGroupName, String watcherName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<TargetInner> listByParent(String resourceGroupName, String watcherName, Context context) {
    ...
    private Mono<Response<TargetInner>> createOrUpdateWithResponseAsync(String resourceGroupName, String watcherName,
        ...
        return FluxUtil
            .withContext(context -> service.createOrUpdate(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, watcherName, targetName, resource, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<TargetInner>> listByParentNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<TargetInner>> listByParentNextSinglePageAsync(String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        if (this.client.getEndpoint() == null) {
