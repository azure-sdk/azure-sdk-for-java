...
```java
import com.azure.resourcemanager.avs.models.AzureResourceManagerCommonTypesSystemAssignedServiceIdentityUpdate;
...
public final class PrivateCloudsUpdateSamples {
    ...
    public static void privateCloudsUpdate(com.azure.resourcemanager.avs.AvsManager manager) {
        PrivateCloud resource = manager.privateClouds()
            ...
            .getValue();
        resource.update()
            .withIdentity(new AzureResourceManagerCommonTypesSystemAssignedServiceIdentityUpdate()
