...
- [ListByPrivateCloud](#provisionednetworks_listbyprivatecloud)
...
public final class ClustersUpdateSamples {
    ...
    public static void clustersUpdate(com.azure.resourcemanager.avs.AvsManager manager) {
        ...
        resource.update().withDisplayName("renamedCluster1").withClusterSize(4)
            .withVsanDatastoreName("renamedDatastore1").apply();
    }
}
```
...
public final class PlacementPoliciesCreateOrUpdateSamples {
    ...
    public static void placementPoliciesCreateOrUpdate(com.azure.resourcemanager.avs.AvsManager manager) {
        manager.placementPolicies().define("policy1").withExistingCluster("group1", "cloud1", "cluster1")
            .withProperties(new VmHostPlacementPolicyProperties().withVmMembers(Arrays.asList(
                ...
                .withAffinityType(AffinityType.ANTI_AFFINITY).withAffinityStrength(AffinityStrength.MUST)
...
public final class PrivateCloudsCreateOrUpdateSamples {
    ...
    public static void privateCloudsCreateOrUpdate(com.azure.resourcemanager.avs.AvsManager manager) {
        manager.privateClouds().define("cloud1").withRegion("eastus2").withExistingResourceGroup("group1")
            ...
            .withManagementCluster(new ManagementCluster().withDisplayName("renamedCluster1").withClusterSize(4)
                .withVsanDatastoreName("renamedDatastore1"))
            .withNetworkBlock("192.168.48.0/22").create();
    }
    ...
    public static void privateCloudsCreateOrUpdateStretched(com.azure.resourcemanager.avs.AvsManager manager) {
        manager.privateClouds().define("cloud1").withRegion("eastus2").withExistingResourceGroup("group1")
            .withSku(new Sku().withName("AV36")).withTags(mapOf())
            .withManagementCluster(new ManagementCluster().withDisplayName("renamedCluster1").withClusterSize(4))
            .withAvailability(new AvailabilityProperties().withStrategy(AvailabilityStrategy.DUAL_ZONE).withZone(1)
                .withSecondaryZone(2))
            .withNetworkBlock("192.168.48.0/22").create();
    }
...
public final class PrivateCloudsUpdateSamples {
    ...
    public static void privateCloudsUpdate(com.azure.resourcemanager.avs.AvsManager manager) {
        ...
        resource.update()
            ...
            .withDisplayName("renamedDatacenter1")
            .withManagementCluster(new ManagementCluster().withDisplayName("renamedCluster1").withClusterSize(4)
                .withVsanDatastoreName("renamedDatastore1"))
    ...
    public static void privateCloudsUpdateStretched(com.azure.resourcemanager.avs.AvsManager manager) {
        PrivateCloud resource = manager.privateClouds()
            .getByResourceGroupWithResponse("group1", "cloud1", com.azure.core.util.Context.NONE).getValue();
        resource
            .update().withDisplayName("renamedDatacenter1").withManagementCluster(new ManagementCluster()
                .withDisplayName("renamedCluster1").withClusterSize(4).withVsanDatastoreName("renamedDatastore1"))
            .apply();
    }
}
```
...
public final class ProvisionedNetworksGetSamples {
    /*
     * x-ms-original-file:
     * specification/vmware/resource-manager/Microsoft.AVS/stable/2023-09-01/examples/ProvisionedNetworks_Get.json
     */
    /**
...
### ProvisionedNetworks_ListByPrivateCloud

```java
/**
 * Samples for ProvisionedNetworks ListByPrivateCloud.
 */
public final class ProvisionedNetworksListByPrivateCloudSamples {
    /*
     * x-ms-original-file: specification/vmware/resource-manager/Microsoft.AVS/stable/2023-09-01/examples/
     * ProvisionedNetworks_ListByPrivateCloud.json
     */
    /**
     * Sample code: ProvisionedNetworks_ListByPrivateCloud.
     * 
     * @param manager Entry point to AvsManager.
     */
    public static void provisionedNetworksListByPrivateCloud(com.azure.resourcemanager.avs.AvsManager manager) {
        manager.provisionedNetworks().listByPrivateCloud("group1", "cloud1", com.azure.core.util.Context.NONE);
    }
}
```
    ...
    public static void workloadNetworksCreateDhcp(com.azure.resourcemanager.avs.AvsManager manager) {
        manager.workloadNetworks().defineDhcp("dhcp1").withExistingPrivateCloud("group1", "cloud1")
            .withProperties(new WorkloadNetworkDhcpServer().withDisplayName("dhcpConfigurations1").withRevision(1L)
                .withServerAddress("40.1.5.1/24").withLeaseTime(86400))
            .create();
    }
}
```
...
public final class WorkloadNetworksUpdateDhcpSamples {
    ...
    public static void workloadNetworksUpdateDhcp(com.azure.resourcemanager.avs.AvsManager manager) {
        ...
        resource.update().withProperties(new WorkloadNetworkDhcpServerUpdate().withRevision(1L)
            .withServerAddress("40.1.5.1/24").withLeaseTime(86400)).apply();
    }
}
```
