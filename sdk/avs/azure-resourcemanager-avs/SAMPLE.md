...
public final class LocationsCheckTrialAvailabilitySamples {
    ...
    /*
     * x-ms-original-file: specification/vmware/resource-manager/Microsoft.AVS/stable/2021-12-01/examples/Locations_CheckTrialAvailabilityWithSku.json
     */
    /**
    ...
    public static void locationsCheckTrialAvailabilityWithSku(com.azure.resourcemanager.avs.AvsManager manager) {
        manager.locations().checkTrialAvailabilityWithResponse("eastus", "avs52t", Context.NONE);
    }
}
```
