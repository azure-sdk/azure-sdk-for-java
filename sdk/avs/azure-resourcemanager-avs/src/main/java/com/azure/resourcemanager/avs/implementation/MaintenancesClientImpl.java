...
import com.azure.resourcemanager.avs.models.MaintenanceListResult;
...
public final class MaintenancesClientImpl implements MaintenancesClient {
     ...
     */
    @Host("{$host}")
    @ServiceInterface(name = "AvsClientMaintenance")
    public interface MaintenancesService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<MaintenanceInner>> get(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("privateCloudName") String privateCloudName,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<MaintenanceInner>> initiateChecks(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("privateCloudName") String privateCloudName,
            @PathParam("maintenanceName") String maintenanceName, @HeaderParam("Accept") String accept,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<MaintenanceInner>> reschedule(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("privateCloudName") String privateCloudName,
            @PathParam("maintenanceName") String maintenanceName,
            @BodyParam("application/json") MaintenanceReschedule body, @HeaderParam("Accept") String accept,
            Context context);
        ...
        Mono<Response<MaintenanceInner>> schedule(@HostParam("$host") String endpoint,
            ...
            @PathParam("privateCloudName") String privateCloudName,
            @PathParam("maintenanceName") String maintenanceName,
            @BodyParam("application/json") MaintenanceSchedule body, @HeaderParam("Accept") String accept,
            Context context);
    ...
    private PagedFlux<MaintenanceInner> listAsync(String resourceGroupName, String privateCloudName,
        ...
        Context context) {
        return new PagedFlux<>(
            () -> listSinglePageAsync(resourceGroupName, privateCloudName, stateName, status, from, to, context),
    ...
    public PagedIterable<MaintenanceInner> list(String resourceGroupName, String privateCloudName) {
        ...
        final OffsetDateTime from = null;
        final OffsetDateTime to = null;
        return new PagedIterable<>(listAsync(resourceGroupName, privateCloudName, stateName, status, from, to));
    }
    ...
    public PagedIterable<MaintenanceInner> list(String resourceGroupName, String privateCloudName,
        ...
        return new PagedIterable<>(
            listAsync(resourceGroupName, privateCloudName, stateName, status, from, to, context));
    }
    ...
    public Response<MaintenanceInner> getWithResponse(String resourceGroupName, String privateCloudName,
        String maintenanceName, Context context) {
        return getWithResponseAsync(resourceGroupName, privateCloudName, maintenanceName, context).block();
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<MaintenanceInner>> initiateChecksWithResponseAsync(String resourceGroupName,
        String privateCloudName, String maintenanceName, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.initiateChecks(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, privateCloudName, maintenanceName, accept, context);
    }
    ...
    public Response<MaintenanceInner> initiateChecksWithResponse(String resourceGroupName, String privateCloudName,
        String maintenanceName, Context context) {
        return initiateChecksWithResponseAsync(resourceGroupName, privateCloudName, maintenanceName, context).block();
    }
    ...
    private Mono<Response<MaintenanceInner>> rescheduleWithResponseAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(context -> service.reschedule(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, privateCloudName, maintenanceName, body, accept,
                context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<MaintenanceInner>> rescheduleWithResponseAsync(String resourceGroupName,
        String privateCloudName, String maintenanceName, MaintenanceReschedule body, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.reschedule(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, privateCloudName, maintenanceName, body, accept,
            context);
    }
    ...
    public Response<MaintenanceInner> rescheduleWithResponse(String resourceGroupName, String privateCloudName,
        ...
        return rescheduleWithResponseAsync(resourceGroupName, privateCloudName, maintenanceName, body, context).block();
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<MaintenanceInner>> scheduleWithResponseAsync(String resourceGroupName,
        String privateCloudName, String maintenanceName, MaintenanceSchedule body, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.schedule(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, privateCloudName, maintenanceName, body, accept, context);
    }
    ...
    public Response<MaintenanceInner> scheduleWithResponse(String resourceGroupName, String privateCloudName,
        ...
        return scheduleWithResponseAsync(resourceGroupName, privateCloudName, maintenanceName, body, context).block();
    }
