...
public final class ClusterUpdate implements JsonSerializable<ClusterUpdate> {
     ...
     */
    public ClusterUpdate withSku(AzureResourceManagerCommonTypesSkuUpdate sku) {
        this.sku = sku;
        return this;
    }
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("sku".equals(fieldName)) {
                    deserializedClusterUpdate.sku = AzureResourceManagerCommonTypesSkuUpdate.fromJson(reader);
