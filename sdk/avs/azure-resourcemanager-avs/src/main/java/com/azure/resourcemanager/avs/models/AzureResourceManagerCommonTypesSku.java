 ...
 */
@Fluent
public final class AzureResourceManagerCommonTypesSku {
    /*
    ...
    /**
     * Creates an instance of AzureResourceManagerCommonTypesSku class.
     */
    public AzureResourceManagerCommonTypesSku() {
    }
     ...
     * @return the AzureResourceManagerCommonTypesSku object itself.
     */
    public AzureResourceManagerCommonTypesSku withName(String name) {
        this.name = name;
        return this;
    }
     ...
     * @return the AzureResourceManagerCommonTypesSku object itself.
     */
    public AzureResourceManagerCommonTypesSku withTier(SkuTier tier) {
        this.tier = tier;
        return this;
    }
     ...
     * @return the AzureResourceManagerCommonTypesSku object itself.
     */
    public AzureResourceManagerCommonTypesSku withSize(String size) {
        this.size = size;
        return this;
    }
     ...
     * @return the AzureResourceManagerCommonTypesSku object itself.
     */
    public AzureResourceManagerCommonTypesSku withFamily(String family) {
        this.family = family;
        return this;
    }
     ...
     * @return the AzureResourceManagerCommonTypesSku object itself.
     */
    public AzureResourceManagerCommonTypesSku withCapacity(Integer capacity) {
