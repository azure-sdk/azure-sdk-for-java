...
import com.azure.resourcemanager.avs.models.AzureResourceManagerCommonTypesSkuUpdate;
...
public final class PrivateCloudImpl implements PrivateCloud, PrivateCloud.Definition, PrivateCloud.Update {
    ...
    public PrivateCloudImpl withVirtualNetworkId(String virtualNetworkId) {
    ...
    public PrivateCloudImpl withDnsZoneType(DnsZoneType dnsZoneType) {
        if (isInCreateMode()) {
            this.innerModel().withDnsZoneType(dnsZoneType);
            return this;
        } else {
    ...
    public PrivateCloudImpl withSku(AzureResourceManagerCommonTypesSkuUpdate sku) {
        this.updatePrivateCloudUpdate.withSku(sku);
        return this;
    }

    public PrivateCloudImpl withIdentity(AzureResourceManagerCommonTypesSystemAssignedServiceIdentityUpdate identity) {
