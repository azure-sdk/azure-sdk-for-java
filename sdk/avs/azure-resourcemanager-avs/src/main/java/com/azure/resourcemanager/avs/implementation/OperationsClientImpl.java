...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    OperationsClientImpl(AvsClientImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for AvsClientOperations to be used by the proxy service to perform REST
     * calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "AvsClientOperations")
     ...
     * @return pageable list of operations along with {@link PagedResponse} on successful completion of {@link Mono}.
     */
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return pageable list of operations as paginated response with {@link PagedFlux}.
     */
