...
public final class PrivateCloudsImpl implements PrivateClouds {
    ...
    public Response<AdminCredentials> listAdminCredentialsWithResponse(String resourceGroupName,
        ...
        Response<AdminCredentialsInner> inner
            = this.serviceClient().listAdminCredentialsWithResponse(resourceGroupName, privateCloudName, body, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
    ...
    public AdminCredentials listAdminCredentials(String resourceGroupName, String privateCloudName, Object body) {
        AdminCredentialsInner inner
            = this.serviceClient().listAdminCredentials(resourceGroupName, privateCloudName, body);
        if (inner != null) {
    ...
    public void rotateNsxtPassword(String resourceGroupName, String privateCloudName, Object body) {
        this.serviceClient().rotateNsxtPassword(resourceGroupName, privateCloudName, body);
    }

    public void rotateNsxtPassword(String resourceGroupName, String privateCloudName, Object body, Context context) {
        this.serviceClient().rotateNsxtPassword(resourceGroupName, privateCloudName, body, context);
    }

    public void rotateVcenterPassword(String resourceGroupName, String privateCloudName, Object body) {
        this.serviceClient().rotateVcenterPassword(resourceGroupName, privateCloudName, body);
    }

    public void rotateVcenterPassword(String resourceGroupName, String privateCloudName, Object body, Context context) {
        this.serviceClient().rotateVcenterPassword(resourceGroupName, privateCloudName, body, context);
    }
