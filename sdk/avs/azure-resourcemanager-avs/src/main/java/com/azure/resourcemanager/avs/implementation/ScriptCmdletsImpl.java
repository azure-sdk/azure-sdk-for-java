...
public final class ScriptCmdletsImpl implements ScriptCmdlets {
    ...
    public PagedIterable<ScriptCmdlet> listByScriptPackage(String resourceGroupName, String privateCloudName,
        String scriptPackageName) {
        PagedIterable<ScriptCmdletInner> inner
            = this.serviceClient().listByScriptPackage(resourceGroupName, privateCloudName, scriptPackageName);
    ...
    public PagedIterable<ScriptCmdlet> listByScriptPackage(String resourceGroupName, String privateCloudName,
        ...
        PagedIterable<ScriptCmdletInner> inner
            = this.serviceClient().listByScriptPackage(resourceGroupName, privateCloudName, scriptPackageName, context);
        return Utils.mapPage(inner, inner1 -> new ScriptCmdletImpl(inner1, this.manager()));
    }
    ...
    public Response<ScriptCmdlet> getWithResponse(String resourceGroupName, String privateCloudName,
        ...
        Response<ScriptCmdletInner> inner = this.serviceClient().getWithResponse(resourceGroupName, privateCloudName,
            scriptPackageName, scriptCmdletName, context);
        if (inner != null) {
