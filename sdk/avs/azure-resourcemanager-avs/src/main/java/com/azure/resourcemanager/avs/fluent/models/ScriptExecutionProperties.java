...
public final class ScriptExecutionProperties {
    ...
    private Map<String, Map<String, Object>> namedOutputs;
     ...
     * @return the ScriptExecutionProperties object itself.
     */
    public ScriptExecutionProperties withNamedOutputs(Map<String, Map<String, Object>> namedOutputs) {
    ...
    public void validate() {
        ...
        if (timeout() == null) {
            throw LOGGER.logExceptionAsError(
                new IllegalArgumentException("Missing required property timeout in model ScriptExecutionProperties"));
        }
    }
