...
public final class PrivateCloudsClientImpl implements PrivateCloudsClient {
    ...
    public interface PrivateCloudsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<PrivateCloudInner>> getByResourceGroup(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
        ...
        Mono<Response<Flux<ByteBuffer>>> createOrUpdate(@HostParam("$host") String endpoint,
            ...
            @BodyParam("application/json") PrivateCloudInner resource, @HeaderParam("Accept") String accept,
            Context context);
        ...
        Mono<Response<Flux<ByteBuffer>>> update(@HostParam("$host") String endpoint,
            ...
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("privateCloudName") String privateCloudName,
            @BodyParam("application/json") PrivateCloudUpdate properties, @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<AdminCredentialsInner>> listAdminCredentials(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("privateCloudName") String privateCloudName, @BodyParam("application/json") Object body,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Flux<ByteBuffer>>> rotateNsxtPassword(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("privateCloudName") String privateCloudName, @BodyParam("application/json") Object body,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<PrivateCloudListResult>> listByResourceGroupNext(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String resourceGroupName,
        String privateCloudName, PrivateCloudInner resource) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String resourceGroupName,
        String privateCloudName, PrivateCloudInner resource, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    private PollerFlux<PollResult<PrivateCloudInner>, PrivateCloudInner>
        beginCreateOrUpdateAsync(String resourceGroupName, String privateCloudName, PrivateCloudInner resource) {
    ...
    private PollerFlux<PollResult<PrivateCloudInner>, PrivateCloudInner> beginCreateOrUpdateAsync(
        String resourceGroupName, String privateCloudName, PrivateCloudInner resource, Context context) {
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PrivateCloudInner> createOrUpdateAsync(String resourceGroupName, String privateCloudName,
        PrivateCloudInner resource, Context context) {
    ...
    private Mono<Response<Flux<ByteBuffer>>> updateWithResponseAsync(String resourceGroupName, String privateCloudName,
        ...
        return FluxUtil
            .withContext(context -> service.update(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, privateCloudName, properties, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> updateWithResponseAsync(String resourceGroupName, String privateCloudName,
        PrivateCloudUpdate properties, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service.update(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, privateCloudName, properties, accept, context);
    }
    ...
    private PollerFlux<PollResult<PrivateCloudInner>, PrivateCloudInner> beginUpdateAsync(String resourceGroupName,
        String privateCloudName, PrivateCloudUpdate properties) {
        Mono<Response<Flux<ByteBuffer>>> mono
            = updateWithResponseAsync(resourceGroupName, privateCloudName, properties);
        return this.client.<PrivateCloudInner, PrivateCloudInner>getLroResult(mono, this.client.getHttpPipeline(),
            PrivateCloudInner.class, PrivateCloudInner.class, this.client.getContext());
    }
    ...
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<PrivateCloudInner>, PrivateCloudInner> beginUpdateAsync(String resourceGroupName,
        String privateCloudName, PrivateCloudUpdate properties, Context context) {
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono
            = updateWithResponseAsync(resourceGroupName, privateCloudName, properties, context);
        return this.client.<PrivateCloudInner, PrivateCloudInner>getLroResult(mono, this.client.getHttpPipeline(),
            PrivateCloudInner.class, PrivateCloudInner.class, context);
    }
    ...
    public SyncPoller<PollResult<PrivateCloudInner>, PrivateCloudInner> beginUpdate(String resourceGroupName,
        String privateCloudName, PrivateCloudUpdate properties) {
        return this.beginUpdateAsync(resourceGroupName, privateCloudName, properties).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<PrivateCloudInner>, PrivateCloudInner> beginUpdate(String resourceGroupName,
        String privateCloudName, PrivateCloudUpdate properties, Context context) {
        return this.beginUpdateAsync(resourceGroupName, privateCloudName, properties, context).getSyncPoller();
    }
    ...
    private Mono<PrivateCloudInner> updateAsync(String resourceGroupName, String privateCloudName,
        PrivateCloudUpdate properties) {
        return beginUpdateAsync(resourceGroupName, privateCloudName, properties).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<PrivateCloudInner> updateAsync(String resourceGroupName, String privateCloudName,
        PrivateCloudUpdate properties, Context context) {
        return beginUpdateAsync(resourceGroupName, privateCloudName, properties, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public PrivateCloudInner update(String resourceGroupName, String privateCloudName, PrivateCloudUpdate properties) {
        return updateAsync(resourceGroupName, privateCloudName, properties).block();
    }
    ...
    public PrivateCloudInner update(String resourceGroupName, String privateCloudName, PrivateCloudUpdate properties,
        Context context) {
        return updateAsync(resourceGroupName, privateCloudName, properties, context).block();
    }
    ...
    private Mono<Response<AdminCredentialsInner>> listAdminCredentialsWithResponseAsync(String resourceGroupName,
        String privateCloudName, Object body) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return FluxUtil
            .withContext(context -> service.listAdminCredentials(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, privateCloudName, body, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<AdminCredentialsInner>> listAdminCredentialsWithResponseAsync(String resourceGroupName,
        String privateCloudName, Object body, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    private Mono<AdminCredentialsInner> listAdminCredentialsAsync(String resourceGroupName, String privateCloudName,
        Object body) {
        return listAdminCredentialsWithResponseAsync(resourceGroupName, privateCloudName, body)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
    ...
    public Response<AdminCredentialsInner> listAdminCredentialsWithResponse(String resourceGroupName,
        String privateCloudName, Object body, Context context) {
        return listAdminCredentialsWithResponseAsync(resourceGroupName, privateCloudName, body, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public AdminCredentialsInner listAdminCredentials(String resourceGroupName, String privateCloudName, Object body) {
        return listAdminCredentialsWithResponse(resourceGroupName, privateCloudName, body, Context.NONE).getValue();
    }
    ...
    private PollerFlux<PollResult<Void>, Void> beginRotateNsxtPasswordAsync(String resourceGroupName,
        String privateCloudName, Object body) {
        Mono<Response<Flux<ByteBuffer>>> mono
            = rotateNsxtPasswordWithResponseAsync(resourceGroupName, privateCloudName, body);
        return this.client.<Void, Void>getLroResult(mono, this.client.getHttpPipeline(), Void.class, Void.class,
            this.client.getContext());
    }
    ...
    private PollerFlux<PollResult<Void>, Void> beginRotateNsxtPasswordAsync(String resourceGroupName,
        ...
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono
            = rotateNsxtPasswordWithResponseAsync(resourceGroupName, privateCloudName, body, context);
        return this.client.<Void, Void>getLroResult(mono, this.client.getHttpPipeline(), Void.class, Void.class,
            context);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginRotateNsxtPassword(String resourceGroupName, String privateCloudName,
        Object body) {
        return this.beginRotateNsxtPasswordAsync(resourceGroupName, privateCloudName, body).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginRotateNsxtPassword(String resourceGroupName, String privateCloudName,
        ...
        return this.beginRotateNsxtPasswordAsync(resourceGroupName, privateCloudName, body, context).getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> rotateNsxtPasswordAsync(String resourceGroupName, String privateCloudName, Object body) {
        return beginRotateNsxtPasswordAsync(resourceGroupName, privateCloudName, body).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<Void> rotateNsxtPasswordAsync(String resourceGroupName, String privateCloudName, Object body,
        Context context) {
        return beginRotateNsxtPasswordAsync(resourceGroupName, privateCloudName, body, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public void rotateNsxtPassword(String resourceGroupName, String privateCloudName, Object body) {
        rotateNsxtPasswordAsync(resourceGroupName, privateCloudName, body).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public void rotateNsxtPassword(String resourceGroupName, String privateCloudName, Object body, Context context) {
        rotateNsxtPasswordAsync(resourceGroupName, privateCloudName, body, context).block();
    }
    ...
    private PollerFlux<PollResult<Void>, Void> beginRotateVcenterPasswordAsync(String resourceGroupName,
        String privateCloudName, Object body) {
        Mono<Response<Flux<ByteBuffer>>> mono
            = rotateVcenterPasswordWithResponseAsync(resourceGroupName, privateCloudName, body);
        return this.client.<Void, Void>getLroResult(mono, this.client.getHttpPipeline(), Void.class, Void.class,
            this.client.getContext());
    }
    ...
    private PollerFlux<PollResult<Void>, Void> beginRotateVcenterPasswordAsync(String resourceGroupName,
        ...
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono
            = rotateVcenterPasswordWithResponseAsync(resourceGroupName, privateCloudName, body, context);
        return this.client.<Void, Void>getLroResult(mono, this.client.getHttpPipeline(), Void.class, Void.class,
            context);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginRotateVcenterPassword(String resourceGroupName,
        String privateCloudName, Object body) {
        return this.beginRotateVcenterPasswordAsync(resourceGroupName, privateCloudName, body).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginRotateVcenterPassword(String resourceGroupName,
        String privateCloudName, Object body, Context context) {
        return this.beginRotateVcenterPasswordAsync(resourceGroupName, privateCloudName, body, context).getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> rotateVcenterPasswordAsync(String resourceGroupName, String privateCloudName, Object body) {
        return beginRotateVcenterPasswordAsync(resourceGroupName, privateCloudName, body).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<Void> rotateVcenterPasswordAsync(String resourceGroupName, String privateCloudName, Object body,
        Context context) {
        return beginRotateVcenterPasswordAsync(resourceGroupName, privateCloudName, body, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public void rotateVcenterPassword(String resourceGroupName, String privateCloudName, Object body) {
        rotateVcenterPasswordAsync(resourceGroupName, privateCloudName, body).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public void rotateVcenterPassword(String resourceGroupName, String privateCloudName, Object body, Context context) {
        rotateVcenterPasswordAsync(resourceGroupName, privateCloudName, body, context).block();
    }
