...
public final class HcxEnterpriseSitesClientImpl implements HcxEnterpriseSitesClient {
    ...
    public interface HcxEnterpriseSitesService {
        ...
        Mono<Response<HcxEnterpriseSiteList>> list(@HostParam("$host") String endpoint,
     ...
     * @return a paged list of HCX Enterprise Sites along with {@link PagedResponse} on successful completion of
     * {@link Mono}.
     */
        ...
        return FluxUtil
            .withContext(
                context -> service.get(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
                    privateCloudName, hcxEnterpriseSiteName, this.client.getApiVersion(), accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<HcxEnterpriseSiteInner>> createOrUpdateWithResponseAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(context -> service.createOrUpdate(this.client.getEndpoint(), this.client.getSubscriptionId(),
                resourceGroupName, privateCloudName, hcxEnterpriseSiteName, this.client.getApiVersion(),
                hcxEnterpriseSite, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<HcxEnterpriseSiteInner>> createOrUpdateWithResponseAsync(String resourceGroupName,
        ...
        return service.createOrUpdate(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            privateCloudName, hcxEnterpriseSiteName, this.client.getApiVersion(), hcxEnterpriseSite, accept, context);
    }
    ...
    public Response<HcxEnterpriseSiteInner> createOrUpdateWithResponse(String resourceGroupName,
        ...
        Context context) {
        return createOrUpdateWithResponseAsync(resourceGroupName, privateCloudName, hcxEnterpriseSiteName,
            hcxEnterpriseSite, context).block();
    }
