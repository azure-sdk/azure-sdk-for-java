...
public final class ScriptCmdletProperties {
     ...
     */
    @JsonProperty(value = "audience", required = true, access = JsonProperty.Access.WRITE_ONLY)
    ...
    /**
     * Get the audience property: Specifies whether a script cmdlet is intended to be invoked only through automation
