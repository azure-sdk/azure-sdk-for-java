...
public final class VirtualMachinesClientImpl implements VirtualMachinesClient {
    ...
    public interface VirtualMachinesService {
        ...
        Mono<Response<VirtualMachinesList>> list(@HostParam("$host") String endpoint,
    ...
    private Mono<PagedResponse<VirtualMachineInner>> listSinglePageAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(context -> service.list(this.client.getEndpoint(), this.client.getSubscriptionId(),
                resourceGroupName, this.client.getApiVersion(), privateCloudName, clusterName, accept, context))
    ...
    private Mono<PagedResponse<VirtualMachineInner>> listSinglePageAsync(String resourceGroupName,
        ...
        return service
            .list(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
                this.client.getApiVersion(), privateCloudName, clusterName, accept, context)
        ...
        return FluxUtil
            .withContext(
                context -> service.get(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
                    this.client.getApiVersion(), privateCloudName, clusterName, virtualMachineId, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> restrictMovementWithResponseAsync(String resourceGroupName,
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.restrictMovement(this.client.getEndpoint(), this.client.getSubscriptionId(),
                resourceGroupName, this.client.getApiVersion(), privateCloudName, clusterName, virtualMachineId,
                restrictMovement, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> restrictMovementWithResponseAsync(String resourceGroupName,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.restrictMovement(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            this.client.getApiVersion(), privateCloudName, clusterName, virtualMachineId, restrictMovement, accept,
            context);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginRestrictMovement(String resourceGroupName, String privateCloudName,
        ...
        return this.beginRestrictMovementAsync(resourceGroupName, privateCloudName, clusterName, virtualMachineId,
            restrictMovement).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginRestrictMovement(String resourceGroupName, String privateCloudName,
        ...
        return this.beginRestrictMovementAsync(resourceGroupName, privateCloudName, clusterName, virtualMachineId,
            restrictMovement, context).getSyncPoller();
    }
