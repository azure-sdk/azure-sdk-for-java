...
public interface Addons {
     ...
     */
    PagedIterable<Addon> listByPrivateCloud(String resourceGroupName, String privateCloudName);
     ...
     * @return the response of a Addon list operation as paginated response with {@link PagedIterable}.
     */
    PagedIterable<Addon> listByPrivateCloud(String resourceGroupName, String privateCloudName, Context context);
