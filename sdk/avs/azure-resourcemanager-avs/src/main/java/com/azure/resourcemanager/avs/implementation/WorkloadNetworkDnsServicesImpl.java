...
public final class WorkloadNetworkDnsServicesImpl implements WorkloadNetworkDnsServices {
    ...
    public PagedIterable<WorkloadNetworkDnsService> listByPrivateCloud(String resourceGroupName,
    ...
    public void deleteDnsService(String resourceGroupName, String privateCloudName, String dnsServiceId) {
        this.serviceClient().deleteDnsService(resourceGroupName, privateCloudName, dnsServiceId);
    }

    public void deleteDnsService(String resourceGroupName, String privateCloudName, String dnsServiceId,
        Context context) {
        this.serviceClient().deleteDnsService(resourceGroupName, privateCloudName, dnsServiceId, context);
    }
    ...
    public void deleteDnsServiceById(String id) {
        ...
        this.deleteDnsService(resourceGroupName, privateCloudName, dnsServiceId, Context.NONE);
    }
    ...
    public void deleteDnsServiceByIdWithResponse(String id, Context context) {
        ...
        this.deleteDnsService(resourceGroupName, privateCloudName, dnsServiceId, context);
    }
