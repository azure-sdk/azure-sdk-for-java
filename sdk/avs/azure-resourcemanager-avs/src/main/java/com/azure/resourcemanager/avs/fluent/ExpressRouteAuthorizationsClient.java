 ...
 */
public interface ExpressRouteAuthorizationsClient {
    /**
    ...
    PagedIterable<ExpressRouteAuthorizationInner> listByPrivateCloud(String resourceGroupName, String privateCloudName);
