...
public interface ScriptPackages {
     ...
     */
    PagedIterable<ScriptPackage> listByPrivateCloud(String resourceGroupName, String privateCloudName);
     ...
     * @return the response of a ScriptPackage list operation as paginated response with {@link PagedIterable}.
     */
    PagedIterable<ScriptPackage> listByPrivateCloud(String resourceGroupName, String privateCloudName, Context context);
