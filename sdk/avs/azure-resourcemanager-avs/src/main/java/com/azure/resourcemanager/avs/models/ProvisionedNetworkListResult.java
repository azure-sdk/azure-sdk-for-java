 ...
 */
@Fluent
public final class ProvisionedNetworkListResult {
    /*
    ...
    /**
     * Set the value property: The ProvisionedNetwork items on this page.
     * 
     * @param value the value value to set.
     * @return the ProvisionedNetworkListResult object itself.
     */
    public ProvisionedNetworkListResult withValue(List<ProvisionedNetworkInner> value) {
        this.value = value;
        return this;
    }
     ...
     * @return the ProvisionedNetworkListResult object itself.
     */
    public ProvisionedNetworkListResult withNextLink(String nextLink) {
    ...
    public void validate() {
        if (value() == null) {
            throw LOGGER.logExceptionAsError(
                new IllegalArgumentException("Missing required property value in model ProvisionedNetworkListResult"));
        } else {
