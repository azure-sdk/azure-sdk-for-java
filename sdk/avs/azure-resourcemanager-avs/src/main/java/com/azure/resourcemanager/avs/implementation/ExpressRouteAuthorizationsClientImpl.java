...
import com.azure.resourcemanager.avs.models.ExpressRouteAuthorizationListResult;
import java.nio.ByteBuffer;
import reactor.core.publisher.Flux;
import reactor.core.publisher.Mono;

/**
 * An instance of this class provides access to all the operations defined in ExpressRouteAuthorizationsClient.
 */
public final class ExpressRouteAuthorizationsClientImpl implements ExpressRouteAuthorizationsClient {
    /**
     * The proxy service used to perform REST calls.
     */
    private final ExpressRouteAuthorizationsService service;
    ...
    /**
     * Initializes an instance of ExpressRouteAuthorizationsClientImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    ExpressRouteAuthorizationsClientImpl(AvsClientImpl client) {
        this.service = RestProxy.create(ExpressRouteAuthorizationsService.class, client.getHttpPipeline(),
            client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for AvsClientExpressRouteAuthorizations to be used by the proxy service
     * to perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "AvsClientExpressRout")
    public interface ExpressRouteAuthorizationsService {
        ...
        Mono<Response<ExpressRouteAuthorizationListResult>> listByPrivateCloud(@HostParam("$host") String endpoint,
        ...
        Mono<Response<Flux<ByteBuffer>>> createOrUpdate(@HostParam("$host") String endpoint,
            ...
            @BodyParam("application/json") ExpressRouteAuthorizationInner resource,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ExpressRouteAuthorizationListResult>> listByPrivateCloudNext(
    ...
    private Mono<PagedResponse<ExpressRouteAuthorizationInner>>
    ...
    private PagedFlux<ExpressRouteAuthorizationInner> listByPrivateCloudAsync(String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<ExpressRouteAuthorizationInner> listByPrivateCloud(String resourceGroupName,
        String privateCloudName) {
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return an ExpressRoute Circuit Authorization by name in a private cloud on successful completion of
     * {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ...
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String resourceGroupName,
        String privateCloudName, String authorizationName, ExpressRouteAuthorizationInner resource) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return FluxUtil
            .withContext(context -> service.createOrUpdate(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, privateCloudName, authorizationName, resource,
                accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String resourceGroupName,
        String privateCloudName, String authorizationName, ExpressRouteAuthorizationInner resource, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service.createOrUpdate(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, privateCloudName, authorizationName, resource, accept,
            context);
    }
    ...
    private PollerFlux<PollResult<ExpressRouteAuthorizationInner>, ExpressRouteAuthorizationInner>
        beginCreateOrUpdateAsync(String resourceGroupName, String privateCloudName, String authorizationName,
            ExpressRouteAuthorizationInner resource) {
        Mono<Response<Flux<ByteBuffer>>> mono
            = createOrUpdateWithResponseAsync(resourceGroupName, privateCloudName, authorizationName, resource);
    ...
    private PollerFlux<PollResult<ExpressRouteAuthorizationInner>, ExpressRouteAuthorizationInner>
        beginCreateOrUpdateAsync(String resourceGroupName, String privateCloudName, String authorizationName,
            ExpressRouteAuthorizationInner resource, Context context) {
        context = this.client.mergeContext(context);
    ...
    public SyncPoller<PollResult<ExpressRouteAuthorizationInner>, ExpressRouteAuthorizationInner> beginCreateOrUpdate(
        ...
        ExpressRouteAuthorizationInner resource) {
        return this.beginCreateOrUpdateAsync(resourceGroupName, privateCloudName, authorizationName, resource)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<ExpressRouteAuthorizationInner>, ExpressRouteAuthorizationInner> beginCreateOrUpdate(
        String resourceGroupName, String privateCloudName, String authorizationName,
        ExpressRouteAuthorizationInner resource, Context context) {
        return this.beginCreateOrUpdateAsync(resourceGroupName, privateCloudName, authorizationName, resource, context)
            .getSyncPoller();
    }
    ...
    private Mono<ExpressRouteAuthorizationInner> createOrUpdateAsync(String resourceGroupName, String privateCloudName,
        String authorizationName, ExpressRouteAuthorizationInner resource) {
        return beginCreateOrUpdateAsync(resourceGroupName, privateCloudName, authorizationName, resource).last()
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ExpressRouteAuthorizationInner> createOrUpdateAsync(String resourceGroupName, String privateCloudName,
        String authorizationName, ExpressRouteAuthorizationInner resource, Context context) {
        return beginCreateOrUpdateAsync(resourceGroupName, privateCloudName, authorizationName, resource, context)
    ...
    public ExpressRouteAuthorizationInner createOrUpdate(String resourceGroupName, String privateCloudName,
        String authorizationName, ExpressRouteAuthorizationInner resource) {
        return createOrUpdateAsync(resourceGroupName, privateCloudName, authorizationName, resource).block();
    }
    ...
    public ExpressRouteAuthorizationInner createOrUpdate(String resourceGroupName, String privateCloudName,
        String authorizationName, ExpressRouteAuthorizationInner resource, Context context) {
        return createOrUpdateAsync(resourceGroupName, privateCloudName, authorizationName, resource, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<ExpressRouteAuthorizationInner>> listByPrivateCloudNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
