...
public interface CloudLinks {
     ...
     */
    PagedIterable<CloudLink> listByPrivateCloud(String resourceGroupName, String privateCloudName);
     ...
     * @return the response of a CloudLink list operation as paginated response with {@link PagedIterable}.
     */
    PagedIterable<CloudLink> listByPrivateCloud(String resourceGroupName, String privateCloudName, Context context);
