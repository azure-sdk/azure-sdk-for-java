...
public final class WorkloadNetworksClientImpl implements WorkloadNetworksClient {
    ...
    private Mono<PagedResponse<WorkloadNetworkDnsServiceInner>> listDnsServiceSinglePageAsync(String resourceGroupName,
        ...
        context = this.client.mergeContext(context);
        return service
            .listDnsService(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
                resourceGroupName, privateCloudName, workloadNetworkName, accept, context)
            .map(res -> new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(),
                res.getValue().value(), res.getValue().nextLink(), null));
    }
    ...
    private PagedFlux<WorkloadNetworkDnsServiceInner> listDnsServiceAsync(String resourceGroupName,
        String privateCloudName, String workloadNetworkName, Context context) {
        return new PagedFlux<>(
            () -> listDnsServiceSinglePageAsync(resourceGroupName, privateCloudName, workloadNetworkName, context),
            nextLink -> listDnsServiceNextSinglePageAsync(nextLink, context));
    }
    ...
    public PagedIterable<WorkloadNetworkDnsServiceInner> listDnsService(String resourceGroupName,
        String privateCloudName, String workloadNetworkName) {
        return new PagedIterable<>(listDnsServiceAsync(resourceGroupName, privateCloudName, workloadNetworkName));
    }
    ...
    public PagedIterable<WorkloadNetworkDnsServiceInner> listDnsService(String resourceGroupName,
        ...
        return new PagedIterable<>(
            listDnsServiceAsync(resourceGroupName, privateCloudName, workloadNetworkName, context));
    }
    ...
    public SyncPoller<PollResult<WorkloadNetworkSegmentInner>, WorkloadNetworkSegmentInner> beginUpdateSegment(
        ...
        WorkloadNetworkSegmentInner workloadNetworkSegment) {
        return this
            .beginUpdateSegmentAsync(resourceGroupName, privateCloudName, workloadNetworkName, segmentId,
                workloadNetworkSegment)
            .getSyncPoller();
    }
    ...
    public WorkloadNetworkSegmentInner updateSegment(String resourceGroupName, String privateCloudName,
        String workloadNetworkName, String segmentId, WorkloadNetworkSegmentInner workloadNetworkSegment) {
        return updateSegmentAsync(resourceGroupName, privateCloudName, workloadNetworkName, segmentId,
            workloadNetworkSegment).block();
    }
    ...
    public SyncPoller<PollResult<WorkloadNetworkVMGroupInner>, WorkloadNetworkVMGroupInner> beginCreateVMGroup(
        ...
        WorkloadNetworkVMGroupInner workloadNetworkVMGroup) {
        return this
            .beginCreateVMGroupAsync(resourceGroupName, privateCloudName, workloadNetworkName, vmGroupId,
    ...
    public WorkloadNetworkVMGroupInner createVMGroup(String resourceGroupName, String privateCloudName,
        String workloadNetworkName, String vmGroupId, WorkloadNetworkVMGroupInner workloadNetworkVMGroup) {
        return createVMGroupAsync(resourceGroupName, privateCloudName, workloadNetworkName, vmGroupId,
    ...
    private Mono<PagedResponse<WorkloadNetworkDnsServiceInner>> listDnsServiceNextSinglePageAsync(String nextLink,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.listDnsServiceNext(nextLink, this.client.getEndpoint(), accept, context)
            .map(res -> new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(),
                res.getValue().value(), res.getValue().nextLink(), null));
    }
