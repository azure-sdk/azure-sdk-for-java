...
public final class LocationsClientImpl implements LocationsClient {
    ...
    public interface LocationsService {
        ...
        Mono<Response<TrialInner>> checkTrialAvailability(@HostParam("$host") String endpoint,
            ...
            @QueryParam("api-version") String apiVersion, @BodyParam("application/json") Sku sku,
    ...
    private Mono<Response<TrialInner>> checkTrialAvailabilityWithResponseAsync(String location, Sku sku) {
        ...
        return FluxUtil
            .withContext(context -> service.checkTrialAvailability(this.client.getEndpoint(),
                this.client.getSubscriptionId(), location, this.client.getApiVersion(), sku, accept, context))
    ...
    private Mono<Response<TrialInner>> checkTrialAvailabilityWithResponseAsync(String location, Sku sku,
        ...
        return service.checkTrialAvailability(this.client.getEndpoint(), this.client.getSubscriptionId(), location,
            this.client.getApiVersion(), sku, accept, context);
    }
