...
public interface ScriptExecutionsClient {
    ...
    PagedIterable<ScriptExecutionInner> listByPrivateCloud(String resourceGroupName, String privateCloudName);
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    ScriptExecutionInner createOrUpdate(String resourceGroupName, String privateCloudName, String scriptExecutionName,
        ScriptExecutionInner resource, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ScriptExecutionInner getExecutionLogs(String resourceGroupName, String privateCloudName, String scriptExecutionName,
