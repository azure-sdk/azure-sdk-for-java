...
public interface WorkloadNetworkVmGroupsClient {
    ...
    PagedIterable<WorkloadNetworkVMGroupInner> listByPrivateCloud(String resourceGroupName, String privateCloudName);
    ...
    WorkloadNetworkVMGroupInner updateVmGroup(String resourceGroupName, String privateCloudName, String vmGroupId,
        WorkloadNetworkVMGroupUpdate properties);
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    WorkloadNetworkVMGroupInner updateVmGroup(String resourceGroupName, String privateCloudName, String vmGroupId,
        WorkloadNetworkVMGroupUpdate properties, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<Void>, Void> beginDeleteVmGroup(String resourceGroupName, String privateCloudName,
        String vmGroupId);
