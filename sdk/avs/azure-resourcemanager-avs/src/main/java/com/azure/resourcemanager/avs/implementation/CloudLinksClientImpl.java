...
import com.azure.resourcemanager.avs.models.CloudLinkListResult;
...
public final class CloudLinksClientImpl implements CloudLinksClient {
    ...
    public interface CloudLinksService {
        ...
        Mono<Response<CloudLinkListResult>> listByPrivateCloud(@HostParam("$host") String endpoint,
        ...
        Mono<Response<Flux<ByteBuffer>>> createOrUpdate(@HostParam("$host") String endpoint,
            ...
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("privateCloudName") String privateCloudName, @PathParam("cloudLinkName") String cloudLinkName,
            @BodyParam("application/json") CloudLinkInner resource, @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<CloudLinkListResult>> listByPrivateCloudNext(
    ...
    private Mono<PagedResponse<CloudLinkInner>> listByPrivateCloudSinglePageAsync(String resourceGroupName,
    ...
    private PagedFlux<CloudLinkInner> listByPrivateCloudAsync(String resourceGroupName, String privateCloudName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<CloudLinkInner> listByPrivateCloud(String resourceGroupName, String privateCloudName) {
    ...
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String resourceGroupName,
        String privateCloudName, String cloudLinkName, CloudLinkInner resource) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return FluxUtil
            .withContext(context -> service.createOrUpdate(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, privateCloudName, cloudLinkName, resource, accept,
                context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String resourceGroupName,
        String privateCloudName, String cloudLinkName, CloudLinkInner resource, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    private PollerFlux<PollResult<CloudLinkInner>, CloudLinkInner> beginCreateOrUpdateAsync(String resourceGroupName,
        ...
        Mono<Response<Flux<ByteBuffer>>> mono
            = createOrUpdateWithResponseAsync(resourceGroupName, privateCloudName, cloudLinkName, resource);
    ...
    private PollerFlux<PollResult<CloudLinkInner>, CloudLinkInner> beginCreateOrUpdateAsync(String resourceGroupName,
        ...
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono
            = createOrUpdateWithResponseAsync(resourceGroupName, privateCloudName, cloudLinkName, resource, context);
        return this.client.<CloudLinkInner, CloudLinkInner>getLroResult(mono, this.client.getHttpPipeline(),
    ...
    public SyncPoller<PollResult<CloudLinkInner>, CloudLinkInner> beginCreateOrUpdate(String resourceGroupName,
        String privateCloudName, String cloudLinkName, CloudLinkInner resource) {
        return this.beginCreateOrUpdateAsync(resourceGroupName, privateCloudName, cloudLinkName, resource)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<CloudLinkInner>, CloudLinkInner> beginCreateOrUpdate(String resourceGroupName,
        String privateCloudName, String cloudLinkName, CloudLinkInner resource, Context context) {
        return this.beginCreateOrUpdateAsync(resourceGroupName, privateCloudName, cloudLinkName, resource, context)
            .getSyncPoller();
    }
    ...
    private Mono<CloudLinkInner> createOrUpdateAsync(String resourceGroupName, String privateCloudName,
        String cloudLinkName, CloudLinkInner resource) {
        return beginCreateOrUpdateAsync(resourceGroupName, privateCloudName, cloudLinkName, resource).last()
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<CloudLinkInner> createOrUpdateAsync(String resourceGroupName, String privateCloudName,
        String cloudLinkName, CloudLinkInner resource, Context context) {
        return beginCreateOrUpdateAsync(resourceGroupName, privateCloudName, cloudLinkName, resource, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    public CloudLinkInner createOrUpdate(String resourceGroupName, String privateCloudName, String cloudLinkName,
        CloudLinkInner resource) {
        return createOrUpdateAsync(resourceGroupName, privateCloudName, cloudLinkName, resource).block();
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    public CloudLinkInner createOrUpdate(String resourceGroupName, String privateCloudName, String cloudLinkName,
        CloudLinkInner resource, Context context) {
        return createOrUpdateAsync(resourceGroupName, privateCloudName, cloudLinkName, resource, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<CloudLinkInner>> listByPrivateCloudNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
