...
import com.azure.resourcemanager.avs.models.ScriptPackageListResult;
...
public final class ScriptPackagesClientImpl implements ScriptPackagesClient {
    ...
    public interface ScriptPackagesService {
        ...
        Mono<Response<ScriptPackageListResult>> listByPrivateCloud(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ScriptPackageListResult>> listByPrivateCloudNext(
    ...
    private Mono<PagedResponse<ScriptPackageInner>> listByPrivateCloudSinglePageAsync(String resourceGroupName,
    ...
    private PagedFlux<ScriptPackageInner> listByPrivateCloudAsync(String resourceGroupName, String privateCloudName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<ScriptPackageInner> listByPrivateCloud(String resourceGroupName, String privateCloudName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<ScriptPackageInner>> listByPrivateCloudNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
