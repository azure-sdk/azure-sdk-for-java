...
public final class DatastoresImpl implements Datastores {
    ...
    public PagedIterable<Datastore> listByCluster(String resourceGroupName, String privateCloudName,
        String clusterName) {
    ...
    public PagedIterable<Datastore> listByCluster(String resourceGroupName, String privateCloudName, String clusterName,
        Context context) {
        PagedIterable<DatastoreInner> inner
    ...
    public Response<Datastore> getWithResponse(String resourceGroupName, String privateCloudName, String clusterName,
        ...
        Response<DatastoreInner> inner = this.serviceClient().getWithResponse(resourceGroupName, privateCloudName,
            clusterName, datastoreName, context);
        if (inner != null) {
