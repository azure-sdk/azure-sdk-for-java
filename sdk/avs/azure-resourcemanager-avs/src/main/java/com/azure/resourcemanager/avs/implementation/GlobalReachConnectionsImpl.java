...
public final class GlobalReachConnectionsImpl implements GlobalReachConnections {
    ...
    public PagedIterable<GlobalReachConnection> listByPrivateCloud(String resourceGroupName, String privateCloudName) {
    ...
    public Response<GlobalReachConnection> getWithResponse(String resourceGroupName, String privateCloudName,
        ...
        Response<GlobalReachConnectionInner> inner = this.serviceClient().getWithResponse(resourceGroupName,
            privateCloudName, globalReachConnectionName, context);
        if (inner != null) {
