...
public final class AddonsClientImpl implements AddonsClient {
    ...
    public interface AddonsService {
        ...
        Mono<Response<AddonList>> list(@HostParam("$host") String endpoint,
        ...
        Mono<Response<Flux<ByteBuffer>>> createOrUpdate(@HostParam("$host") String endpoint,
            ...
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("privateCloudName") String privateCloudName, @PathParam("addonName") String addonName,
            @QueryParam("api-version") String apiVersion, @BodyParam("application/json") AddonInner addon,
            @HeaderParam("Accept") String accept, Context context);
    ...
    private Mono<Response<AddonInner>> getWithResponseAsync(String resourceGroupName, String privateCloudName,
        ...
        return FluxUtil
            .withContext(context -> service.get(this.client.getEndpoint(), this.client.getSubscriptionId(),
                resourceGroupName, privateCloudName, addonName, this.client.getApiVersion(), accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<AddonInner>> getWithResponseAsync(String resourceGroupName, String privateCloudName,
        ...
        return service.get(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            privateCloudName, addonName, this.client.getApiVersion(), accept, context);
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(context -> service.createOrUpdate(this.client.getEndpoint(), this.client.getSubscriptionId(),
                resourceGroupName, privateCloudName, addonName, this.client.getApiVersion(), addon, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String resourceGroupName,
        ...
        return service.createOrUpdate(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            privateCloudName, addonName, this.client.getApiVersion(), addon, accept, context);
    }
