...
public final class ScriptCmdletsClientImpl implements ScriptCmdletsClient {
    ...
    public interface ScriptCmdletsService {
        ...
        Mono<Response<ScriptCmdletListResult>> listByScriptPackage(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ScriptCmdletListResult>> listByScriptPackageNext(
    ...
    private Mono<PagedResponse<ScriptCmdletInner>> listByScriptPackageSinglePageAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(context -> service.listByScriptPackage(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, privateCloudName, scriptPackageName, accept,
                context))
    ...
    private Mono<PagedResponse<ScriptCmdletInner>> listByScriptPackageSinglePageAsync(String resourceGroupName,
        ...
        return service.listByScriptPackage(this.client.getEndpoint(), this.client.getApiVersion(),
    ...
    private PagedFlux<ScriptCmdletInner> listByScriptPackageAsync(String resourceGroupName, String privateCloudName,
        String scriptPackageName) {
        return new PagedFlux<>(
            () -> listByScriptPackageSinglePageAsync(resourceGroupName, privateCloudName, scriptPackageName),
            nextLink -> listByScriptPackageNextSinglePageAsync(nextLink));
    }
    ...
    private PagedFlux<ScriptCmdletInner> listByScriptPackageAsync(String resourceGroupName, String privateCloudName,
        ...
        return new PagedFlux<>(
            () -> listByScriptPackageSinglePageAsync(resourceGroupName, privateCloudName, scriptPackageName, context),
            nextLink -> listByScriptPackageNextSinglePageAsync(nextLink, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<ScriptCmdletInner> listByScriptPackage(String resourceGroupName, String privateCloudName,
        String scriptPackageName) {
        return new PagedIterable<>(listByScriptPackageAsync(resourceGroupName, privateCloudName, scriptPackageName));
    }
    ...
    public PagedIterable<ScriptCmdletInner> listByScriptPackage(String resourceGroupName, String privateCloudName,
        ...
        return new PagedIterable<>(
            listByScriptPackageAsync(resourceGroupName, privateCloudName, scriptPackageName, context));
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a cmdlet available for script execution along with {@link Response} on successful completion of
     * {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<ScriptCmdletInner>> listByScriptPackageNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
        ...
        return FluxUtil
            .withContext(
                context -> service.listByScriptPackageNext(nextLink, this.client.getEndpoint(), accept, context))
            .<PagedResponse<ScriptCmdletInner>>map(res -> new PagedResponseBase<>(res.getRequest(), res.getStatusCode(),
                res.getHeaders(), res.getValue().value(), res.getValue().nextLink(), null))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<PagedResponse<ScriptCmdletInner>> listByScriptPackageNextSinglePageAsync(String nextLink,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.listByScriptPackageNext(nextLink, this.client.getEndpoint(), accept, context)
            .map(res -> new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(),
                res.getValue().value(), res.getValue().nextLink(), null));
    }
}
