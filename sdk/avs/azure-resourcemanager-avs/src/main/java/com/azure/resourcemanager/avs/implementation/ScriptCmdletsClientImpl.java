...
public final class ScriptCmdletsClientImpl implements ScriptCmdletsClient {
    ...
    public interface ScriptCmdletsService {
        ...
        Mono<Response<ScriptCmdletInner>> get(@HostParam("$host") String endpoint,
            ...
            @PathParam("scriptCmdletName") String scriptCmdletName, @QueryParam("api-version") String apiVersion,
     ...
     * @return pageable list of scripts/cmdlets along with {@link PagedResponse} on successful completion of
     * {@link Mono}.
     */
    ...
    private Mono<PagedResponse<ScriptCmdletInner>> listSinglePageAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(context -> service.list(this.client.getEndpoint(), this.client.getSubscriptionId(),
                resourceGroupName, privateCloudName, this.client.getApiVersion(), scriptPackageName, accept, context))
    ...
    private Mono<PagedResponse<ScriptCmdletInner>> listSinglePageAsync(String resourceGroupName,
        ...
        return service
            .list(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName, privateCloudName,
                this.client.getApiVersion(), scriptPackageName, accept, context)
    ...
    private Mono<Response<ScriptCmdletInner>> getWithResponseAsync(String resourceGroupName, String privateCloudName,
        ...
        return FluxUtil
            .withContext(context -> service.get(this.client.getEndpoint(), this.client.getSubscriptionId(),
                resourceGroupName, privateCloudName, scriptPackageName, scriptCmdletName, this.client.getApiVersion(),
                accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<ScriptCmdletInner>> getWithResponseAsync(String resourceGroupName, String privateCloudName,
        ...
        return service.get(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            privateCloudName, scriptPackageName, scriptCmdletName, this.client.getApiVersion(), accept, context);
    }
