...
public final class HcxEnterpriseSitesImpl implements HcxEnterpriseSites {
    ...
    public PagedIterable<HcxEnterpriseSite> listByPrivateCloud(String resourceGroupName, String privateCloudName) {
    ...
    public Response<Void> deleteWithResponse(String resourceGroupName, String privateCloudName,
        String hcxEnterpriseSiteName, Context context) {
        return this.serviceClient().deleteWithResponse(resourceGroupName, privateCloudName, hcxEnterpriseSiteName,
            context);
    }
