...
public final class ScriptSecureStringExecutionParameterTests {
    ...
    public void testDeserialize() throws Exception {
        ScriptSecureStringExecutionParameter model
            = BinaryData.fromString("{\"type\":\"SecureValue\",\"secureValue\":\"oupfgfb\",\"name\":\"jub\"}")
                .toObject(ScriptSecureStringExecutionParameter.class);
        Assertions.assertEquals("jub", model.name());
        Assertions.assertEquals("oupfgfb", model.secureValue());
    }

    @org.junit.jupiter.api.Test
    public void testSerialize() throws Exception {
        ScriptSecureStringExecutionParameter model
            = new ScriptSecureStringExecutionParameter().withName("jub").withSecureValue("oupfgfb");
