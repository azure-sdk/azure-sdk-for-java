...
public final class WorkloadNetworkDnsZonesListTests {
    ...
    public void testDeserialize() throws Exception {
        ...
        Assertions.assertEquals("tcj", model.value().get(0).properties().displayName());
        Assertions.assertEquals("zevndhkrwpdappds", model.value().get(0).properties().domain().get(0));
        Assertions.assertEquals("ltmrldh", model.value().get(0).properties().dnsServerIps().get(0));
        Assertions.assertEquals("tyxolniwpwc", model.value().get(0).properties().sourceIp());
        Assertions.assertEquals(51671761473157258L, model.value().get(0).properties().dnsServices());
        Assertions.assertEquals(6655543031987188756L, model.value().get(0).properties().revision());
