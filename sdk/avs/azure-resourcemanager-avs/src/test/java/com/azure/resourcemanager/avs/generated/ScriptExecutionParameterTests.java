...
public final class ScriptExecutionParameterTests {
    ...
    public void testDeserialize() throws Exception {
        ScriptExecutionParameter model = BinaryData.fromString("{\"type\":\"ScriptExecutionParameter\",\"name\":\"w\"}")
    ...
    public void testSerialize() throws Exception {
        ScriptExecutionParameter model = new ScriptExecutionParameter().withName("w");
