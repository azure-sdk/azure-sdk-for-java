...
public final class ScriptStringExecutionParameterTests {
    ...
    public void testDeserialize() throws Exception {
        ScriptStringExecutionParameter model
            = BinaryData.fromString("{\"type\":\"Value\",\"value\":\"hgkfmin\",\"name\":\"g\"}")
                .toObject(ScriptStringExecutionParameter.class);
        Assertions.assertEquals("g", model.name());
        Assertions.assertEquals("hgkfmin", model.value());
    }

    @org.junit.jupiter.api.Test
    public void testSerialize() throws Exception {
        ScriptStringExecutionParameter model = new ScriptStringExecutionParameter().withName("g").withValue("hgkfmin");
