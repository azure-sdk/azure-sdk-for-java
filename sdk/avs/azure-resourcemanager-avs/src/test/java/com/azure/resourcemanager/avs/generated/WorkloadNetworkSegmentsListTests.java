...
public final class WorkloadNetworkSegmentsListTests {
    ...
    public void testDeserialize() throws Exception {
        ...
        Assertions.assertEquals("fwnfnb", model.value().get(0).properties().displayName());
        Assertions.assertEquals("fionl", model.value().get(0).properties().connectedGateway());
        Assertions.assertEquals("tqgtzxdpnqbqq", model.value().get(0).properties().subnet().dhcpRanges().get(0));
        Assertions.assertEquals("scxaq", model.value().get(0).properties().subnet().gatewayAddress());
        Assertions.assertEquals(4565931014747924245L, model.value().get(0).properties().revision());
