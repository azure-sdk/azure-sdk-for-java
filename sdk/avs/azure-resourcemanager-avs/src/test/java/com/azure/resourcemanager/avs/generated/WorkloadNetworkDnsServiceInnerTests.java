...
public final class WorkloadNetworkDnsServiceInnerTests {
    ...
    public void testDeserialize() throws Exception {
        ...
        Assertions.assertEquals("iqihn", model.properties().dnsServiceIp());
        Assertions.assertEquals("ngbwjz", model.properties().defaultDnsZone());
        Assertions.assertEquals("ygxgispemvtz", model.properties().fqdnZones().get(0));
        Assertions.assertEquals(DnsServiceLogLevelEnum.INFO, model.properties().logLevel());
        Assertions.assertEquals(6873951751389434508L, model.properties().revision());
    }

    @org.junit.jupiter.api.Test
    public void testSerialize() throws Exception {
        WorkloadNetworkDnsServiceInner model = new WorkloadNetworkDnsServiceInner()
            .withProperties(new WorkloadNetworkDnsServiceProperties().withDisplayName("v")
