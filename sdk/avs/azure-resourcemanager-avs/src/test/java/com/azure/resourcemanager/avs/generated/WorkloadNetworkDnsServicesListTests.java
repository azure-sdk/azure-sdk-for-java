...
public final class WorkloadNetworkDnsServicesListTests {
    ...
    public void testDeserialize() throws Exception {
        ...
        Assertions.assertEquals("njaqwixjspro", model.value().get(0).properties().displayName());
        Assertions.assertEquals("cputegjvwmfdats", model.value().get(0).properties().dnsServiceIp());
        Assertions.assertEquals("dvpjhulsuuvmk", model.value().get(0).properties().defaultDnsZone());
        Assertions.assertEquals("k", model.value().get(0).properties().fqdnZones().get(0));
        Assertions.assertEquals(DnsServiceLogLevelEnum.FATAL, model.value().get(0).properties().logLevel());
        Assertions.assertEquals(2940506045911652561L, model.value().get(0).properties().revision());
