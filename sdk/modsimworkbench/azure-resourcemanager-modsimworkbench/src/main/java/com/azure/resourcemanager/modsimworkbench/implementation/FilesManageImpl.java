...
public final class FilesManageImpl implements FilesManage {
    private FilesManageInner innerObject;

    private final com.azure.resourcemanager.modsimworkbench.ModsimworkbenchManager serviceManager;

    FilesManageImpl(
        FilesManageInner innerObject, com.azure.resourcemanager.modsimworkbench.ModsimworkbenchManager serviceManager) {
    ...
    public FilesManageInner innerModel() {
