...
public interface FileRequestOperationsClient {
    /**
    ...
    SyncPoller<PollResult<FileDownloadSasUriInner>, FileDownloadSasUriInner> beginGetDownloadUri(
    ...
    FileDownloadSasUriInner getDownloadUri(
        String resourceGroupName, String workbenchName, String chamberName, String requestName);
