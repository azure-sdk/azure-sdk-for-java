 ...
 */
@Fluent
public final class DataflowOperationDetails implements JsonSerializable<DataflowOperationDetails> {
    /*
     * Type of operation.
     */
    ...
    /**
     * Creates an instance of DataflowOperationDetails class.
     */
    public DataflowOperationDetails() {
    }
     ...
     * @return the DataflowOperationDetails object itself.
     */
    public DataflowOperationDetails withOperationType(OperationType operationType) {
     ...
     * @return the DataflowOperationDetails object itself.
     */
    public DataflowOperationDetails withName(String name) {
        this.name = name;
        return this;
    }
     ...
     * @return the DataflowOperationDetails object itself.
     */
    public DataflowOperationDetails withSourceSettings(DataflowSourceOperationSettings sourceSettings) {
     ...
     * @return the DataflowOperationDetails object itself.
     */
    public DataflowOperationDetails withDestinationSettings(DataflowDestinationOperationSettings destinationSettings) {
        ...
        if (operationType() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property operationType in model DataflowOperationDetails"));
        }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(DataflowOperationDetails.class);
    ...
    /**
     * Reads an instance of DataflowOperationDetails from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of DataflowOperationDetails if the JsonReader was pointing to an instance of it, or null if
     * it was pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the DataflowOperationDetails.
     */
    public static DataflowOperationDetails fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            DataflowOperationDetails deserializedDataflowOperationDetails = new DataflowOperationDetails();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("operationType".equals(fieldName)) {
                    deserializedDataflowOperationDetails.operationType = OperationType.fromString(reader.getString());
                } else if ("name".equals(fieldName)) {
                    deserializedDataflowOperationDetails.name = reader.getString();
                } else if ("sourceSettings".equals(fieldName)) {
                    deserializedDataflowOperationDetails.sourceSettings
                        = DataflowSourceOperationSettings.fromJson(reader);
                } else if ("builtInTransformationSettings".equals(fieldName)) {
                    deserializedDataflowOperationDetails.builtInTransformationSettings
                        = DataflowBuiltInTransformationSettings.fromJson(reader);
                } else if ("destinationSettings".equals(fieldName)) {
                    deserializedDataflowOperationDetails.destinationSettings
            ...
            return deserializedDataflowOperationDetails;
        });
    }
}
