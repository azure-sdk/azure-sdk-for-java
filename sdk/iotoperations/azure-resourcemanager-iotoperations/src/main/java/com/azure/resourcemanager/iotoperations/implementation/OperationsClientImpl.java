...
import com.azure.resourcemanager.iotoperations.fluent.models.OperationInner;
import com.azure.resourcemanager.iotoperations.implementation.models.OperationListResult;
...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    OperationsClientImpl(IoTOperationsClientImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for IoTOperationsClientOperations to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "IoTOperationsClientO")
