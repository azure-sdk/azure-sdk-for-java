 ...
 */
@Fluent
public final class KafkaSettings implements JsonSerializable<KafkaSettings> {
    /*
    ...
    /**
     * Creates an instance of KafkaSettings class.
     */
     ...
     * @return the KafkaSettings object itself.
     */
    public KafkaSettings withAuthentication(DataflowEndpointKafkaAuthentication authentication) {
     ...
     * @return the KafkaSettings object itself.
     */
    public KafkaSettings withConsumerGroupId(String consumerGroupId) {
     ...
     * @return the KafkaSettings object itself.
     */
    public KafkaSettings withHost(String host) {
        this.host = host;
        return this;
    }
     ...
     * @return the KafkaSettings object itself.
     */
    public KafkaSettings withBatching(DataflowEndpointKafkaBatching batching) {
     ...
     * @return the KafkaSettings object itself.
     */
    public KafkaSettings withCopyMqttProperties(OperationalMode copyMqttProperties) {
     ...
     * @return the KafkaSettings object itself.
     */
    public KafkaSettings withCompression(DataflowEndpointKafkaCompression compression) {
     ...
     * @return the KafkaSettings object itself.
     */
    public KafkaSettings withKafkaAcks(DataflowEndpointKafkaAcks kafkaAcks) {
     ...
     * @return the KafkaSettings object itself.
     */
    public KafkaSettings withPartitionStrategy(DataflowEndpointKafkaPartitionStrategy partitionStrategy) {
     ...
     * @return the KafkaSettings object itself.
     */
    public KafkaSettings withTls(TlsProperties tls) {
        this.tls = tls;
        return this;
    }
     ...
     * @return the KafkaSettings object itself.
     */
    public KafkaSettings withCloudEventAttributes(CloudEventAttributeType cloudEventAttributes) {
    ...
    public void validate() {
        if (authentication() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Missing required property authentication in model KafkaSettings"));
        } else {
            authentication().validate();
        }
        if (host() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Missing required property host in model KafkaSettings"));
        }
        if (batching() != null) {
            batching().validate();
        }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(KafkaSettings.class);
    ...
    /**
     * Reads an instance of KafkaSettings from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of KafkaSettings if the JsonReader was pointing to an instance of it, or null if it was
     * pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the KafkaSettings.
     */
    public static KafkaSettings fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            KafkaSettings deserializedKafkaSettings = new KafkaSettings();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("authentication".equals(fieldName)) {
                    deserializedKafkaSettings.authentication = DataflowEndpointKafkaAuthentication.fromJson(reader);
                } else if ("host".equals(fieldName)) {
                    deserializedKafkaSettings.host = reader.getString();
                } else if ("consumerGroupId".equals(fieldName)) {
                    deserializedKafkaSettings.consumerGroupId = reader.getString();
                } else if ("batching".equals(fieldName)) {
                    deserializedKafkaSettings.batching = DataflowEndpointKafkaBatching.fromJson(reader);
                } else if ("copyMqttProperties".equals(fieldName)) {
                    deserializedKafkaSettings.copyMqttProperties = OperationalMode.fromString(reader.getString());
                } else if ("compression".equals(fieldName)) {
                    deserializedKafkaSettings.compression
                        = DataflowEndpointKafkaCompression.fromString(reader.getString());
                } else if ("kafkaAcks".equals(fieldName)) {
                    deserializedKafkaSettings.kafkaAcks = DataflowEndpointKafkaAcks.fromString(reader.getString());
                } else if ("partitionStrategy".equals(fieldName)) {
                    deserializedKafkaSettings.partitionStrategy
                        = DataflowEndpointKafkaPartitionStrategy.fromString(reader.getString());
                } else if ("tls".equals(fieldName)) {
                    deserializedKafkaSettings.tls = TlsProperties.fromJson(reader);
                } else if ("cloudEventAttributes".equals(fieldName)) {
                    deserializedKafkaSettings.cloudEventAttributes
            ...
            return deserializedKafkaSettings;
        });
    }
}
