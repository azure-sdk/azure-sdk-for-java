...
public final class BrokersClientImpl implements BrokersClient {
     ...
     */
    BrokersClientImpl(IoTOperationsClientImpl client) {
        this.service = RestProxy.create(BrokersService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for IoTOperationsClientBrokers to be used by the proxy service to perform
     * REST calls.
     */
    @Host("{endpoint}")
