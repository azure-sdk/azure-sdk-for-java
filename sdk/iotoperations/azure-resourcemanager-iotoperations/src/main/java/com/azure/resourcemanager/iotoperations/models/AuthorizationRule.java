...
public final class AuthorizationRule implements JsonSerializable<AuthorizationRule> {
     ...
     */
    private PrincipalDetails principals;
     ...
     */
    public PrincipalDetails principals() {
     ...
     * @return the AuthorizationRule object itself.
     */
    public AuthorizationRule withPrincipals(PrincipalDetails principals) {
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("brokerResources".equals(fieldName)) {
                    ...
                    deserializedAuthorizationRule.principals = PrincipalDetails.fromJson(reader);
