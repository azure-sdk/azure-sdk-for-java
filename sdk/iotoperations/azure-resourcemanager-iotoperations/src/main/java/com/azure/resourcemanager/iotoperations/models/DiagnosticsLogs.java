...
public final class DiagnosticsLogs implements JsonSerializable<DiagnosticsLogs> {
     ...
     */
    private OpenTelemetryLogExportConfig opentelemetryExportConfig;
     ...
     */
    public OpenTelemetryLogExportConfig opentelemetryExportConfig() {
     ...
     */
    public DiagnosticsLogs withOpentelemetryExportConfig(OpenTelemetryLogExportConfig opentelemetryExportConfig) {
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("opentelemetryExportConfig".equals(fieldName)) {
                    deserializedDiagnosticsLogs.opentelemetryExportConfig
                        = OpenTelemetryLogExportConfig.fromJson(reader);
