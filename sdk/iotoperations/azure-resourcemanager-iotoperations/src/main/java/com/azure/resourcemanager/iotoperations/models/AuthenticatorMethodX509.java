 ...
 */
@Fluent
public final class AuthenticatorMethodX509 implements JsonSerializable<AuthenticatorMethodX509> {
    /*
    ...
    /**
     * Creates an instance of AuthenticatorMethodX509 class.
     */
    public AuthenticatorMethodX509() {
    }
     ...
     * @return the AuthenticatorMethodX509 object itself.
     */
    public AuthenticatorMethodX509
     ...
     * @return the AuthenticatorMethodX509 object itself.
     */
    public AuthenticatorMethodX509 withTrustedClientCaCert(String trustedClientCaCert) {
    ...
    /**
     * Reads an instance of AuthenticatorMethodX509 from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of AuthenticatorMethodX509 if the JsonReader was pointing to an instance of it, or null if it
     * was pointing to JSON null.
     * @throws IOException If an error occurs while reading the AuthenticatorMethodX509.
     */
    public static AuthenticatorMethodX509 fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            AuthenticatorMethodX509 deserializedAuthenticatorMethodX509 = new AuthenticatorMethodX509();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("authorizationAttributes".equals(fieldName)) {
                    ...
                    deserializedAuthenticatorMethodX509.authorizationAttributes = authorizationAttributes;
                } else if ("trustedClientCaCert".equals(fieldName)) {
                    deserializedAuthenticatorMethodX509.trustedClientCaCert = reader.getString();
                } else {
                    reader.skipChildren();
                }
            }

            return deserializedAuthenticatorMethodX509;
        });
    }
}
