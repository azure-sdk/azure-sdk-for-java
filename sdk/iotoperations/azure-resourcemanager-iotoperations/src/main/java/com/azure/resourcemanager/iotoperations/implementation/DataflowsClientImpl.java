...
public final class DataflowsClientImpl implements DataflowsClient {
     ...
     */
    DataflowsClientImpl(IoTOperationsClientImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for IoTOperationsClientDataflows to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{endpoint}")
