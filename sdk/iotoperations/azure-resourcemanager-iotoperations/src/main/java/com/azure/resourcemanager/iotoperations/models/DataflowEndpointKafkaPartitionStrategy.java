...
public final class DataflowEndpointKafkaPartitionStrategy
    ...
    /**
     * Static value Default for DataflowEndpointKafkaPartitionStrategy.
     */
    public static final DataflowEndpointKafkaPartitionStrategy DEFAULT = fromString("Default");

    /**
     * Static value Static for DataflowEndpointKafkaPartitionStrategy.
     */
    public static final DataflowEndpointKafkaPartitionStrategy STATIC = fromString("Static");

    /**
     * Static value Topic for DataflowEndpointKafkaPartitionStrategy.
     */
    public static final DataflowEndpointKafkaPartitionStrategy TOPIC = fromString("Topic");

    /**
     * Static value Property for DataflowEndpointKafkaPartitionStrategy.
     */
