 ...
 */
@Fluent
public final class InstanceResourceInner extends Resource {
    /*
    ...
    public void validate() {
        ...
        if (extendedLocation() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property extendedLocation in model InstanceResourceInner"));
        } else {
        ...
        if (location() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Missing required property location in model InstanceResourceInner"));
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(InstanceResourceInner.class);
    ...
    /**
     * Reads an instance of InstanceResourceInner from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of InstanceResourceInner if the JsonReader was pointing to an instance of it, or null if it
     * was pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the InstanceResourceInner.
     */
    public static InstanceResourceInner fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            InstanceResourceInner deserializedInstanceResourceInner = new InstanceResourceInner();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("id".equals(fieldName)) {
                    ...
                    deserializedInstanceResourceInner.withLocation(reader.getString());
            ...
            return deserializedInstanceResourceInner;
        });
    }
}
