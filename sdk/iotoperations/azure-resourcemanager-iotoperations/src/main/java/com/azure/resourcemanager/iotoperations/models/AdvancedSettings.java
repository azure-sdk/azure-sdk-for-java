...
public final class AdvancedSettings implements JsonSerializable<AdvancedSettings> {
     ...
     */
    private CertManagerCertConfig internalCerts;
     ...
     */
    public CertManagerCertConfig internalCerts() {
     ...
     * @return the AdvancedSettings object itself.
     */
    public AdvancedSettings withInternalCerts(CertManagerCertConfig internalCerts) {
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("clients".equals(fieldName)) {
                    ...
                    deserializedAdvancedSettings.internalCerts = CertManagerCertConfig.fromJson(reader);
                } else {
                    reader.skipChildren();
                }
            }
