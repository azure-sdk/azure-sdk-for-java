...
public final class Metrics implements JsonSerializable<Metrics> {
     ...
     */
    private OpenTelemetryExportConfig opentelemetryExportConfig;
    ...
    /**
     * Get the opentelemetryExportConfig property: The open telemetry export configuration.
     * 
     * @return the opentelemetryExportConfig value.
     */
    public OpenTelemetryExportConfig opentelemetryExportConfig() {
        return this.opentelemetryExportConfig;
    }

    /**
     * Set the opentelemetryExportConfig property: The open telemetry export configuration.
     * 
     * @param opentelemetryExportConfig the opentelemetryExportConfig value to set.
     * @return the Metrics object itself.
     */
    public Metrics withOpentelemetryExportConfig(OpenTelemetryExportConfig opentelemetryExportConfig) {
    ...
    public void validate() {
        if (opentelemetryExportConfig() != null) {
            opentelemetryExportConfig().validate();
        }
    }
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeJsonField("opentelemetryExportConfig", this.opentelemetryExportConfig);
    ...
    public static Metrics fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("opentelemetryExportConfig".equals(fieldName)) {
                    deserializedMetrics.opentelemetryExportConfig = OpenTelemetryExportConfig.fromJson(reader);
                } else if ("prometheusPort".equals(fieldName)) {
