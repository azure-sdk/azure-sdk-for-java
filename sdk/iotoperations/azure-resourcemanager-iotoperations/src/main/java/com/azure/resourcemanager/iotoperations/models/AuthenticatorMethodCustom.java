 ...
 */
@Fluent
public final class AuthenticatorMethodCustom implements JsonSerializable<AuthenticatorMethodCustom> {
    /*
    ...
    /**
     * Creates an instance of AuthenticatorMethodCustom class.
     */
    public AuthenticatorMethodCustom() {
    }
     ...
     * @return the AuthenticatorMethodCustom object itself.
     */
    public AuthenticatorMethodCustom withAuth(BrokerAuthenticatorCustomAuth auth) {
        this.auth = auth;
        return this;
    }
     ...
     * @return the AuthenticatorMethodCustom object itself.
     */
    public AuthenticatorMethodCustom withCaCertConfigMap(String caCertConfigMap) {
     ...
     * @return the AuthenticatorMethodCustom object itself.
     */
    public AuthenticatorMethodCustom withEndpoint(String endpoint) {
     ...
     * @return the AuthenticatorMethodCustom object itself.
     */
    public AuthenticatorMethodCustom withHeaders(Map<String, String> headers) {
        ...
        if (endpoint() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property endpoint in model AuthenticatorMethodCustom"));
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(AuthenticatorMethodCustom.class);
    ...
    /**
     * Reads an instance of AuthenticatorMethodCustom from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of AuthenticatorMethodCustom if the JsonReader was pointing to an instance of it, or null if
     * it was pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the AuthenticatorMethodCustom.
     */
    public static AuthenticatorMethodCustom fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            AuthenticatorMethodCustom deserializedAuthenticatorMethodCustom = new AuthenticatorMethodCustom();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("endpoint".equals(fieldName)) {
                    deserializedAuthenticatorMethodCustom.endpoint = reader.getString();
                } else if ("auth".equals(fieldName)) {
                    deserializedAuthenticatorMethodCustom.auth = BrokerAuthenticatorCustomAuth.fromJson(reader);
                } else if ("caCertConfigMap".equals(fieldName)) {
                    deserializedAuthenticatorMethodCustom.caCertConfigMap = reader.getString();
                } else if ("headers".equals(fieldName)) {
                    Map<String, String> headers = reader.readMap(reader1 -> reader1.getString());
                    deserializedAuthenticatorMethodCustom.headers = headers;
                } else {
                    reader.skipChildren();
                }
            }

            return deserializedAuthenticatorMethodCustom;
        });
    }
}
