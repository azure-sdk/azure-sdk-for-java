...
public final class Traces implements JsonSerializable<Traces> {
     ...
     * @return the Traces object itself.
     */
    public Traces withOpentelemetryExportConfig(OpenTelemetryExportConfig opentelemetryExportConfig) {
    ...
    public static Traces fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                } else if ("opentelemetryExportConfig".equals(fieldName)) {
                    deserializedTraces.opentelemetryExportConfig = OpenTelemetryExportConfig.fromJson(reader);
