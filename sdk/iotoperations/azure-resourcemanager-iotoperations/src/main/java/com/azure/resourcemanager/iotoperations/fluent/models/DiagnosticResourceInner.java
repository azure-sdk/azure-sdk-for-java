...
public final class DiagnosticResourceInner extends ProxyResource {
     ...
     */
    public DiagnosticResourceInner withProperties(DiagnosticProperties properties) {
     ...
     * @return the DiagnosticResourceInner object itself.
     */
    public DiagnosticResourceInner withExtendedLocation(ExtendedLocation extendedLocation) {
        ...
        if (extendedLocation() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property extendedLocation in model DiagnosticResourceInner"));
        } else {
            extendedLocation().validate();
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(DiagnosticResourceInner.class);
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("id".equals(fieldName)) {
                    ...
                    deserializedDiagnosticResourceInner.extendedLocation = ExtendedLocation.fromJson(reader);
                } else if ("properties".equals(fieldName)) {
                    deserializedDiagnosticResourceInner.properties = DiagnosticProperties.fromJson(reader);
