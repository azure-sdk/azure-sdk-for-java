...
public final class BrokerAuthorizationsClientImpl implements BrokerAuthorizationsClient {
     ...
     */
    BrokerAuthorizationsClientImpl(IoTOperationsClientImpl client) {
    ...
    /**
     * The interface defining all the services for IoTOperationsClientBrokerAuthorizations to be used by the proxy
