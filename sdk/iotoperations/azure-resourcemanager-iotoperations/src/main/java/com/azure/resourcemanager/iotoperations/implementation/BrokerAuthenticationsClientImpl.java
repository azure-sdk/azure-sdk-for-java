...
public final class BrokerAuthenticationsClientImpl implements BrokerAuthenticationsClient {
     ...
     */
    BrokerAuthenticationsClientImpl(IoTOperationsClientImpl client) {
    ...
    /**
     * The interface defining all the services for IoTOperationsClientBrokerAuthentications to be used by the proxy
