...
public final class BrokerResourceDefinitionMethods extends ExpandableStringEnum<BrokerResourceDefinitionMethods> {
    /**
     * Static value Connect for BrokerResourceDefinitionMethods.
     */
    public static final BrokerResourceDefinitionMethods CONNECT = fromString("Connect");

    /**
     * Static value Publish for BrokerResourceDefinitionMethods.
     */
    public static final BrokerResourceDefinitionMethods PUBLISH = fromString("Publish");

    /**
     * Static value Subscribe for BrokerResourceDefinitionMethods.
     */
