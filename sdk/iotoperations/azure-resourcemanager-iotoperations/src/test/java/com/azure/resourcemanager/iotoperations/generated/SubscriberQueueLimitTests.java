...
public final class SubscriberQueueLimitTests {
    ...
    public void testDeserialize() throws Exception {
        SubscriberQueueLimit model
            = BinaryData.fromString("{\"length\":7669621975136808076,\"strategy\":\"DropOldest\"}")
                .toObject(SubscriberQueueLimit.class);
        Assertions.assertEquals(7669621975136808076L, model.length());
        Assertions.assertEquals(SubscriberMessageDropStrategy.DROP_OLDEST, model.strategy());
    }

    @org.junit.jupiter.api.Test
    public void testSerialize() throws Exception {
        SubscriberQueueLimit model = new SubscriberQueueLimit().withLength(7669621975136808076L)
