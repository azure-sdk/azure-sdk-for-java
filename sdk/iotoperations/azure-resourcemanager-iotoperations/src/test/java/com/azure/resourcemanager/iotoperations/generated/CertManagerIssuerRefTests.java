...
public final class CertManagerIssuerRefTests {
    ...
    public void testDeserialize() throws Exception {
        CertManagerIssuerRef model
            = BinaryData.fromString("{\"group\":\"cwif\",\"kind\":\"Issuer\",\"name\":\"ttgzfbis\"}")
                .toObject(CertManagerIssuerRef.class);
        Assertions.assertEquals("cwif", model.group());
        Assertions.assertEquals(CertManagerIssuerKind.ISSUER, model.kind());
        Assertions.assertEquals("ttgzfbis", model.name());
    }

    @org.junit.jupiter.api.Test
    public void testSerialize() throws Exception {
        CertManagerIssuerRef model
            = new CertManagerIssuerRef().withGroup("cwif").withKind(CertManagerIssuerKind.ISSUER).withName("ttgzfbis");
