...
public final class VolumeClaimResourceRequirementsTests {
    ...
    public void testDeserialize() throws Exception {
        VolumeClaimResourceRequirements model = BinaryData.fromString(
            "{\"limits\":{\"pkwlhz\":\"vsovmyokac\"},\"requests\":{\"cciw\":\"pxjmflbvvnchr\",\"wkuofoskghsauu\":\"zjuqkhrsaj\"}}")
            .toObject(VolumeClaimResourceRequirements.class);
        Assertions.assertEquals("vsovmyokac", model.limits().get("pkwlhz"));
        Assertions.assertEquals("pxjmflbvvnchr", model.requests().get("cciw"));
    }

    @org.junit.jupiter.api.Test
    public void testSerialize() throws Exception {
        VolumeClaimResourceRequirements model
            = new VolumeClaimResourceRequirements().withLimits(mapOf("pkwlhz", "vsovmyokac"))
                .withRequests(mapOf("cciw", "pxjmflbvvnchr", "wkuofoskghsauu", "zjuqkhrsaj"));
