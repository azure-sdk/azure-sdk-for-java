...
public final class TlsPropertiesTests {
    ...
    public void testDeserialize() throws Exception {
        TlsProperties model
            = BinaryData.fromString("{\"mode\":\"Enabled\",\"trustedCaCertificateConfigMapRef\":\"clewyhm\"}")
                .toObject(TlsProperties.class);
        Assertions.assertEquals(OperationalMode.ENABLED, model.mode());
        Assertions.assertEquals("clewyhm", model.trustedCaCertificateConfigMapRef());
    }

    @org.junit.jupiter.api.Test
    public void testSerialize() throws Exception {
        TlsProperties model
            = new TlsProperties().withMode(OperationalMode.ENABLED).withTrustedCaCertificateConfigMapRef("clewyhm");
