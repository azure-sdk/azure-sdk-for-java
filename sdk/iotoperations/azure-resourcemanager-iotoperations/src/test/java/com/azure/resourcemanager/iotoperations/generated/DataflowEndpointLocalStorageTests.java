...
public final class DataflowEndpointLocalStorageTests {
    ...
    public void testDeserialize() throws Exception {
        DataflowEndpointLocalStorage model = BinaryData.fromString("{\"persistentVolumeClaimRef\":\"wp\"}")
            .toObject(DataflowEndpointLocalStorage.class);
        Assertions.assertEquals("wp", model.persistentVolumeClaimRef());
    }

    @org.junit.jupiter.api.Test
    public void testSerialize() throws Exception {
        DataflowEndpointLocalStorage model = new DataflowEndpointLocalStorage().withPersistentVolumeClaimRef("wp");
