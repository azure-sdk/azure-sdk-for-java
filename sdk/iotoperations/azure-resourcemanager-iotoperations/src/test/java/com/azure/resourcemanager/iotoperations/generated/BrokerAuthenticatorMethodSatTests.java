...
public final class BrokerAuthenticatorMethodSatTests {
    ...
    public void testDeserialize() throws Exception {
        BrokerAuthenticatorMethodSat model
            = BinaryData.fromString("{\"audiences\":[\"rzpwvlqdqgbiq\",\"lihkaetcktvfc\",\"vf\"]}")
                .toObject(BrokerAuthenticatorMethodSat.class);
        Assertions.assertEquals("rzpwvlqdqgbiq", model.audiences().get(0));
    }

    @org.junit.jupiter.api.Test
    public void testSerialize() throws Exception {
        BrokerAuthenticatorMethodSat model
            = new BrokerAuthenticatorMethodSat().withAudiences(Arrays.asList("rzpwvlqdqgbiq", "lihkaetcktvfc", "vf"));
