...
public final class ManagedServiceIdentityTests {
    ...
    public void testDeserialize() throws Exception {
        ManagedServiceIdentity model = BinaryData.fromString(
            "{\"principalId\":\"mayhuybbkpodepoo\",\"tenantId\":\"nuvamiheogna\",\"type\":\"SystemAssigned\",\"userAssignedIdentities\":{\"ciqihnhung\":{\"principalId\":\"heotusiv\",\"clientId\":\"v\"}}}")
    ...
    public void testSerialize() throws Exception {
        ManagedServiceIdentity model = new ManagedServiceIdentity().withType(ManagedServiceIdentityType.SYSTEM_ASSIGNED)
            .withUserAssignedIdentities(mapOf("ciqihnhung", new UserAssignedIdentity()));
