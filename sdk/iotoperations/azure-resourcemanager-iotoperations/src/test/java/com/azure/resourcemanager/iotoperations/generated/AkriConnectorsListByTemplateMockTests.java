...
public final class AkriConnectorsListByTemplateMockTests {
    ...
    public void testListByTemplate() throws Exception {
        String responseStr
            = "{\"value\":[{\"properties\":{\"provisioningState\":\"Accepted\"},\"extendedLocation\":{\"name\":\"xcnqmxqpswokmvkh\",\"type\":\"CustomLocation\"},\"id\":\"dhbemzqkzszu\",\"name\":\"iwtglxxhljfpg\",\"type\":\"icrmnzh\"}]}";
        ...
        PagedIterable<AkriConnectorResource> response = manager.akriConnectors()
            .listByTemplate("gqjxgpnrhgovfgp", "kqmhhaowjr", "zvuporqzdfuydz", com.azure.core.util.Context.NONE);

        Assertions.assertEquals("xcnqmxqpswokmvkh", response.iterator().next().extendedLocation().name());
