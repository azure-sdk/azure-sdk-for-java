...
public final class DataflowEndpointAuthenticationServiceAccountTokenTests {
    ...
    public void testDeserialize() throws Exception {
        DataflowEndpointAuthenticationServiceAccountToken model = BinaryData.fromString("{\"audience\":\"vkg\"}")
            .toObject(DataflowEndpointAuthenticationServiceAccountToken.class);
        Assertions.assertEquals("vkg", model.audience());
    }

    @org.junit.jupiter.api.Test
    public void testSerialize() throws Exception {
        DataflowEndpointAuthenticationServiceAccountToken model
            = new DataflowEndpointAuthenticationServiceAccountToken().withAudience("vkg");
