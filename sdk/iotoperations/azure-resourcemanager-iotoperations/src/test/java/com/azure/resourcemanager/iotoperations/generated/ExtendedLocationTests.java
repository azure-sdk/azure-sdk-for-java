...
public final class ExtendedLocationTests {
    ...
    public void testDeserialize() throws Exception {
        ExtendedLocation model = BinaryData.fromString("{\"name\":\"fpdvhpfxxypi\",\"type\":\"CustomLocation\"}")
    ...
    public void testSerialize() throws Exception {
        ExtendedLocation model
            = new ExtendedLocation().withName("fpdvhpfxxypi").withType(ExtendedLocationType.CUSTOM_LOCATION);
