...
public final class BrokerAuthenticatorMethodX509AttributesTests {
    ...
    public void testDeserialize() throws Exception {
        BrokerAuthenticatorMethodX509Attributes model = BinaryData.fromString(
            "{\"attributes\":{\"jwbhqwalmuz\":\"ibx\",\"zjancuxr\":\"oxaepd\",\"bavxbniwdjswzt\":\"d\",\"xbzpfzab\":\"dbpgnxytxhp\"},\"subject\":\"lcuhxwtctyqiklb\"}")
            .toObject(BrokerAuthenticatorMethodX509Attributes.class);
        Assertions.assertEquals("ibx", model.attributes().get("jwbhqwalmuz"));
        Assertions.assertEquals("lcuhxwtctyqiklb", model.subject());
    }
    ...
    public void testSerialize() throws Exception {
        BrokerAuthenticatorMethodX509Attributes model = new BrokerAuthenticatorMethodX509Attributes()
            .withAttributes(
                mapOf("jwbhqwalmuz", "ibx", "zjancuxr", "oxaepd", "bavxbniwdjswzt", "d", "xbzpfzab", "dbpgnxytxhp"))
            .withSubject("lcuhxwtctyqiklb");
