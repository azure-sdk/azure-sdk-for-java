...
public final class BrokerAuthenticatorMethodX509AttributesTests {
    ...
    public void testDeserialize() throws Exception {
        BrokerAuthenticatorMethodX509Attributes model
            = BinaryData.fromString("{\"attributes\":{\"cewiipfpub\":\"uijfqk\"},\"subject\":\"ibwwiftohqkv\"}")
                .toObject(BrokerAuthenticatorMethodX509Attributes.class);
        Assertions.assertEquals("uijfqk", model.attributes().get("cewiipfpub"));
        Assertions.assertEquals("ibwwiftohqkv", model.subject());
    }

    @org.junit.jupiter.api.Test
    public void testSerialize() throws Exception {
        BrokerAuthenticatorMethodX509Attributes model
            = new BrokerAuthenticatorMethodX509Attributes().withAttributes(mapOf("cewiipfpub", "uijfqk"))
                .withSubject("ibwwiftohqkv");
