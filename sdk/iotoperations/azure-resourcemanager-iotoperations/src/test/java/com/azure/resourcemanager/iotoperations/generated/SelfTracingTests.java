...
public final class SelfTracingTests {
    ...
    public void testDeserialize() throws Exception {
        SelfTracing model = BinaryData.fromString("{\"mode\":\"Enabled\",\"intervalSeconds\":1901976575}")
            .toObject(SelfTracing.class);
        Assertions.assertEquals(OperationalMode.ENABLED, model.mode());
        Assertions.assertEquals(1901976575, model.intervalSeconds());
    }

    @org.junit.jupiter.api.Test
    public void testSerialize() throws Exception {
        SelfTracing model = new SelfTracing().withMode(OperationalMode.ENABLED).withIntervalSeconds(1901976575);
