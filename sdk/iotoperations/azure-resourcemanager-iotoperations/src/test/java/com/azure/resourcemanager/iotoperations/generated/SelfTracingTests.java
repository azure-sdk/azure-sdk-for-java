...
public final class SelfTracingTests {
    ...
    public void testDeserialize() throws Exception {
        SelfTracing model = BinaryData.fromString("{\"mode\":\"Disabled\",\"intervalSeconds\":1993000932}")
            .toObject(SelfTracing.class);
        Assertions.assertEquals(OperationalMode.DISABLED, model.mode());
        Assertions.assertEquals(1993000932, model.intervalSeconds());
    }

    @org.junit.jupiter.api.Test
    public void testSerialize() throws Exception {
        SelfTracing model = new SelfTracing().withMode(OperationalMode.DISABLED).withIntervalSeconds(1993000932);
