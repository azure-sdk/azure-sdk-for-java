...
public final class DataManagersImpl implements DataManagers {
    ...
    public DataManagersImpl(DataManagersClient innerClient,
    ...
    public PagedIterable<DataManager> list() {
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new DataManagerImpl(inner1, this.manager()));
    }
    ...
    public Response<DataManager> getByResourceGroupWithResponse(String resourceGroupName, String dataManagerName,
        Context context) {
