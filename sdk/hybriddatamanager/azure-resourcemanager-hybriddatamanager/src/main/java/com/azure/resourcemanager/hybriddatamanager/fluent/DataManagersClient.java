...
public interface DataManagersClient {
    ...
    Response<DataManagerInner> getByResourceGroupWithResponse(String resourceGroupName, String dataManagerName,
        Context context);
    ...
    SyncPoller<PollResult<DataManagerInner>, DataManagerInner> beginCreate(String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<DataManagerInner>, DataManagerInner> beginUpdate(String resourceGroupName,
    ...
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<DataManagerInner>, DataManagerInner> beginUpdate(String resourceGroupName,
        String dataManagerName, DataManagerUpdateParameter dataManagerUpdateParameter, String ifMatch, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    DataManagerInner update(String resourceGroupName, String dataManagerName,
