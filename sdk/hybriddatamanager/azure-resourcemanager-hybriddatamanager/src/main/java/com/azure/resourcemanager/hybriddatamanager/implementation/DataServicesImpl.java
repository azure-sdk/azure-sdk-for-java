...
public final class DataServicesImpl implements DataServices {
    ...
    public DataServicesImpl(DataServicesClient innerClient,
    ...
    public PagedIterable<DataService> listByDataManager(String resourceGroupName, String dataManagerName) {
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new DataServiceImpl(inner1, this.manager()));
    }
    ...
    public Response<DataService> getWithResponse(String dataServiceName, String resourceGroupName,
