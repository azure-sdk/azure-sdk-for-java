...
public interface DataStoresClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<DataStoreInner> listByDataManager(String resourceGroupName, String dataManagerName, String filter,
        Context context);
    ...
    Response<DataStoreInner> getWithResponse(String dataStoreName, String resourceGroupName, String dataManagerName,
        Context context);
    ...
    SyncPoller<PollResult<DataStoreInner>, DataStoreInner> beginCreateOrUpdate(String dataStoreName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    DataStoreInner createOrUpdate(String dataStoreName, String resourceGroupName, String dataManagerName,
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<Void>, Void> beginDelete(String dataStoreName, String resourceGroupName,
