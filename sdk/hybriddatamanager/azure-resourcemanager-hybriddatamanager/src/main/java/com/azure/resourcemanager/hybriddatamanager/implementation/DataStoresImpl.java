...
public final class DataStoresImpl implements DataStores {
    ...
    public PagedIterable<DataStore> listByDataManager(String resourceGroupName, String dataManagerName, String filter,
        Context context) {
        PagedIterable<DataStoreInner> inner
    ...
    public Response<DataStore> getWithResponse(String dataStoreName, String resourceGroupName, String dataManagerName,
        Context context) {
