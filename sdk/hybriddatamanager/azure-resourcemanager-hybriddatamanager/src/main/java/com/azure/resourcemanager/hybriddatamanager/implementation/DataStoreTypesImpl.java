...
public final class DataStoreTypesImpl implements DataStoreTypes {
    ...
    public DataStoreTypesImpl(DataStoreTypesClient innerClient,
    ...
    public PagedIterable<DataStoreType> listByDataManager(String resourceGroupName, String dataManagerName) {
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new DataStoreTypeImpl(inner1, this.manager()));
    }
    ...
    public Response<DataStoreType> getWithResponse(String dataStoreTypeName, String resourceGroupName,
