...
public final class JobDefinitionProperties {
    ...
    /*
     * Schema version of the job definition.
     */
    @JsonProperty(value = "jobDefinitionSchemaVersion")
    private String jobDefinitionSchemaVersion;

    /*
     * State of the job definition.
     */
    @JsonProperty(value = "jobDefinitionState")
    ...
    /**
     * Get the jobDefinitionSchemaVersion property: Schema version of the job definition.
     *
     * @return the jobDefinitionSchemaVersion value.
     */
    public String jobDefinitionSchemaVersion() {
        return this.jobDefinitionSchemaVersion;
    }

    /**
     * Set the jobDefinitionSchemaVersion property: Schema version of the job definition.
     *
     * @param jobDefinitionSchemaVersion the jobDefinitionSchemaVersion value to set.
     * @return the JobDefinitionProperties object itself.
     */
    public JobDefinitionProperties withJobDefinitionSchemaVersion(String jobDefinitionSchemaVersion) {
        this.jobDefinitionSchemaVersion = jobDefinitionSchemaVersion;
        return this;
    }

    /**
     * Get the jobDefinitionState property: State of the job definition.
     *
     * @return the jobDefinitionState value.
     */
    public JobDefinitionState jobDefinitionState() {
        return this.jobDefinitionState;
    }

    /**
     * Set the jobDefinitionState property: State of the job definition.
     *
     * @param jobDefinitionState the jobDefinitionState value to set.
     * @return the JobDefinitionProperties object itself.
     */
    public JobDefinitionProperties withJobDefinitionState(JobDefinitionState jobDefinitionState) {
        this.jobDefinitionState = jobDefinitionState;
        return this;
    }
