...
public final class DataManagersClientImpl implements DataManagersClient {
    ...
    public interface DataManagersService {
        @Headers({ "Content-Type: application/json" })
        @Get("/subscriptions/{subscriptionId}/providers/Microsoft.HybridData/dataManagers")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<DataManagerList>> list(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<DataManagerList>> listByResourceGroup(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<DataManagerInner>> getByResourceGroup(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
        ...
        Mono<Response<Flux<ByteBuffer>>> create(@HostParam("$host") String endpoint,
            ...
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("dataManagerName") String dataManagerName, @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") DataManagerInner dataManager, @HeaderParam("Accept") String accept,
            Context context);
     ...
     * @return dataManager resources Collection along with {@link PagedResponse} on successful completion of
     * {@link Mono}.
     */
    ...
    private Mono<PagedResponse<DataManagerInner>> listSinglePageAsync() {
        ...
        return FluxUtil
            ...
            .<PagedResponse<DataManagerInner>>map(res -> new PagedResponseBase<>(res.getRequest(), res.getStatusCode(),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<DataManagerInner>> getByResourceGroupWithResponseAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(
                context -> service.getByResourceGroup(this.client.getEndpoint(), this.client.getSubscriptionId(),
                    resourceGroupName, dataManagerName, this.client.getApiVersion(), accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<DataManagerInner>> getByResourceGroupWithResponseAsync(String resourceGroupName,
        ...
        return service.getByResourceGroup(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            dataManagerName, this.client.getApiVersion(), accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<DataManagerInner> getByResourceGroupWithResponse(String resourceGroupName, String dataManagerName,
        Context context) {
    ...
    public DataManagerInner getByResourceGroup(String resourceGroupName, String dataManagerName) {
        return getByResourceGroupWithResponse(resourceGroupName, dataManagerName, Context.NONE).getValue();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> createWithResponseAsync(String resourceGroupName, String dataManagerName,
        DataManagerInner dataManager) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return FluxUtil
            .withContext(context -> service.create(this.client.getEndpoint(), this.client.getSubscriptionId(),
                resourceGroupName, dataManagerName, this.client.getApiVersion(), dataManager, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> createWithResponseAsync(String resourceGroupName, String dataManagerName,
        DataManagerInner dataManager, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service.create(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            dataManagerName, this.client.getApiVersion(), dataManager, accept, context);
    }
    ...
    private PollerFlux<PollResult<DataManagerInner>, DataManagerInner> beginCreateAsync(String resourceGroupName,
        String dataManagerName, DataManagerInner dataManager) {
        Mono<Response<Flux<ByteBuffer>>> mono
            = createWithResponseAsync(resourceGroupName, dataManagerName, dataManager);
        return this.client.<DataManagerInner, DataManagerInner>getLroResult(mono, this.client.getHttpPipeline(),
            DataManagerInner.class, DataManagerInner.class, this.client.getContext());
    }
    ...
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<DataManagerInner>, DataManagerInner> beginCreateAsync(String resourceGroupName,
        String dataManagerName, DataManagerInner dataManager, Context context) {
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono
            = createWithResponseAsync(resourceGroupName, dataManagerName, dataManager, context);
        return this.client.<DataManagerInner, DataManagerInner>getLroResult(mono, this.client.getHttpPipeline(),
            DataManagerInner.class, DataManagerInner.class, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<DataManagerInner>, DataManagerInner> beginCreate(String resourceGroupName,
        String dataManagerName, DataManagerInner dataManager) {
        return this.beginCreateAsync(resourceGroupName, dataManagerName, dataManager).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<DataManagerInner>, DataManagerInner> beginCreate(String resourceGroupName,
        String dataManagerName, DataManagerInner dataManager, Context context) {
        return this.beginCreateAsync(resourceGroupName, dataManagerName, dataManager, context).getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DataManagerInner> createAsync(String resourceGroupName, String dataManagerName,
        DataManagerInner dataManager) {
        return beginCreateAsync(resourceGroupName, dataManagerName, dataManager).last()
    ...
    private Mono<DataManagerInner> createAsync(String resourceGroupName, String dataManagerName,
        DataManagerInner dataManager, Context context) {
        return beginCreateAsync(resourceGroupName, dataManagerName, dataManager, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> deleteWithResponseAsync(String resourceGroupName, String dataManagerName) {
        ...
        return FluxUtil
            .withContext(context -> service.delete(this.client.getEndpoint(), this.client.getSubscriptionId(),
                resourceGroupName, dataManagerName, this.client.getApiVersion(), context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> deleteWithResponseAsync(String resourceGroupName, String dataManagerName,
        ...
        return service.delete(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            dataManagerName, this.client.getApiVersion(), context);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String dataManagerName) {
        return this.beginDeleteAsync(resourceGroupName, dataManagerName).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String dataManagerName,
        Context context) {
        return this.beginDeleteAsync(resourceGroupName, dataManagerName, context).getSyncPoller();
    }
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String dataManagerName) {
        return beginDeleteAsync(resourceGroupName, dataManagerName).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String dataManagerName, Context context) {
        return beginDeleteAsync(resourceGroupName, dataManagerName, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> updateWithResponseAsync(String resourceGroupName, String dataManagerName,
        DataManagerUpdateParameter dataManagerUpdateParameter, String ifMatch) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        if (dataManagerUpdateParameter == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter dataManagerUpdateParameter is required and cannot be null."));
        } else {
        ...
        return FluxUtil
            .withContext(
                context -> service.update(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
                    dataManagerName, this.client.getApiVersion(), ifMatch, dataManagerUpdateParameter, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> updateWithResponseAsync(String resourceGroupName, String dataManagerName,
        DataManagerUpdateParameter dataManagerUpdateParameter, String ifMatch, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<DataManagerInner>, DataManagerInner> beginUpdateAsync(String resourceGroupName,
        String dataManagerName, DataManagerUpdateParameter dataManagerUpdateParameter, String ifMatch) {
        Mono<Response<Flux<ByteBuffer>>> mono
    ...
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<DataManagerInner>, DataManagerInner> beginUpdateAsync(String resourceGroupName,
        String dataManagerName, DataManagerUpdateParameter dataManagerUpdateParameter) {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<DataManagerInner>, DataManagerInner> beginUpdate(String resourceGroupName,
        String dataManagerName, DataManagerUpdateParameter dataManagerUpdateParameter) {
        final String ifMatch = null;
        return this.beginUpdateAsync(resourceGroupName, dataManagerName, dataManagerUpdateParameter, ifMatch)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<DataManagerInner>, DataManagerInner> beginUpdate(String resourceGroupName,
        String dataManagerName, DataManagerUpdateParameter dataManagerUpdateParameter, String ifMatch,
        Context context) {
        return this.beginUpdateAsync(resourceGroupName, dataManagerName, dataManagerUpdateParameter, ifMatch, context)
            .getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DataManagerInner> updateAsync(String resourceGroupName, String dataManagerName,
        DataManagerUpdateParameter dataManagerUpdateParameter, String ifMatch) {
        return beginUpdateAsync(resourceGroupName, dataManagerName, dataManagerUpdateParameter, ifMatch).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<DataManagerInner> updateAsync(String resourceGroupName, String dataManagerName,
        DataManagerUpdateParameter dataManagerUpdateParameter, String ifMatch, Context context) {
        return beginUpdateAsync(resourceGroupName, dataManagerName, dataManagerUpdateParameter, ifMatch, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public DataManagerInner update(String resourceGroupName, String dataManagerName,
        DataManagerUpdateParameter dataManagerUpdateParameter) {
        final String ifMatch = null;
