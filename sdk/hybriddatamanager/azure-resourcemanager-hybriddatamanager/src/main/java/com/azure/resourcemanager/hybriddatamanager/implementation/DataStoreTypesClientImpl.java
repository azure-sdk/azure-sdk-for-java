...
public final class DataStoreTypesClientImpl implements DataStoreTypesClient {
    ...
    public interface DataStoreTypesService {
        ...
        Mono<Response<DataStoreTypeList>> listByDataManager(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<DataStoreTypeInner>> get(@HostParam("$host") String endpoint,
    ...
    private Mono<PagedResponse<DataStoreTypeInner>> listByDataManagerSinglePageAsync(String resourceGroupName,
        ...
        return FluxUtil
            ...
            .<PagedResponse<DataStoreTypeInner>>map(res -> new PagedResponseBase<>(res.getRequest(),
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return all the data store/repository types that the resource supports as paginated response with
     * {@link PagedFlux}.
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<DataStoreTypeInner> listByDataManagerAsync(String resourceGroupName, String dataManagerName) {
        return new PagedFlux<>(() -> listByDataManagerSinglePageAsync(resourceGroupName, dataManagerName),
    ...
    private PagedFlux<DataStoreTypeInner> listByDataManagerAsync(String resourceGroupName, String dataManagerName,
        Context context) {
        return new PagedFlux<>(() -> listByDataManagerSinglePageAsync(resourceGroupName, dataManagerName, context),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<DataStoreTypeInner>> getWithResponseAsync(String dataStoreTypeName, String resourceGroupName,
        String dataManagerName) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        return FluxUtil
            .withContext(
                context -> service.get(this.client.getEndpoint(), dataStoreTypeName, this.client.getSubscriptionId(),
                    resourceGroupName, dataManagerName, this.client.getApiVersion(), accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<DataStoreTypeInner>> getWithResponseAsync(String dataStoreTypeName, String resourceGroupName,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.get(this.client.getEndpoint(), dataStoreTypeName, this.client.getSubscriptionId(),
            resourceGroupName, dataManagerName, this.client.getApiVersion(), accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DataStoreTypeInner> getAsync(String dataStoreTypeName, String resourceGroupName,
        String dataManagerName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<DataStoreTypeInner> getWithResponse(String dataStoreTypeName, String resourceGroupName,
        String dataManagerName, Context context) {
    ...
    public DataStoreTypeInner get(String dataStoreTypeName, String resourceGroupName, String dataManagerName) {
        return getWithResponse(dataStoreTypeName, resourceGroupName, dataManagerName, Context.NONE).getValue();
    }
