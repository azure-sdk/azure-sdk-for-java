...
public final class JobDefinitionsImpl implements JobDefinitions {
    ...
    public JobDefinitionsImpl(JobDefinitionsClient innerClient,
        com.azure.resourcemanager.hybriddatamanager.HybridDataManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public PagedIterable<JobDefinition> listByDataService(String dataServiceName, String resourceGroupName,
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new JobDefinitionImpl(inner1, this.manager()));
    }

    public PagedIterable<JobDefinition> listByDataService(String dataServiceName, String resourceGroupName,
        String dataManagerName, String filter, Context context) {
        PagedIterable<JobDefinitionInner> inner = this.serviceClient()
            .listByDataService(dataServiceName, resourceGroupName, dataManagerName, filter, context);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new JobDefinitionImpl(inner1, this.manager()));
    }

    public Response<JobDefinition> getWithResponse(String dataServiceName, String jobDefinitionName,
    ...
    public JobDefinition get(String dataServiceName, String jobDefinitionName, String resourceGroupName,
        String dataManagerName) {
    ...
    public JobDefinition getById(String id) {
        String dataServiceName = ResourceManagerUtils.getValueFromIdByName(id, "dataServices");
        if (dataServiceName == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
                String.format("The resource ID '%s' is not valid. Missing path segment 'dataServices'.", id)));
        }
        String jobDefinitionName = ResourceManagerUtils.getValueFromIdByName(id, "jobDefinitions");
        if (jobDefinitionName == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
                String.format("The resource ID '%s' is not valid. Missing path segment 'jobDefinitions'.", id)));
        }
        ...
        String dataManagerName = ResourceManagerUtils.getValueFromIdByName(id, "dataManagers");
