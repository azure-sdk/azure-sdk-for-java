...
public final class HybridDataManager {
    ...
    private HybridDataManager(HttpPipeline httpPipeline, AzureProfile profile, Duration defaultPollInterval) {
        ...
        this.clientObject = new HybridDataManagementClientBuilder().pipeline(httpPipeline)
    ...
    public static final class Configurable {
        ...
        private static final Map<String, String> PROPERTIES
            = CoreUtils.getProperties("azure-resourcemanager-hybriddatamanager.properties");
    ...
    /**
     * Gets wrapped service client HybridDataManagementClient providing direct access to the underlying auto-generated
     * API implementation, based on Azure REST API.
     * 
     * @return Wrapped service client HybridDataManagementClient.
     */
