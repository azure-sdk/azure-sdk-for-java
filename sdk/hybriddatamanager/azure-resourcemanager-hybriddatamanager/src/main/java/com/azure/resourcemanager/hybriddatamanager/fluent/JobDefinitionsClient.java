...
public interface JobDefinitionsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    void retryJob(String dataServiceName, String jobDefinitionName, String resourceGroupName, String dataManagerName);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    void skipJob(String dataServiceName, String jobDefinitionName, String resourceGroupName, String dataManagerName);
