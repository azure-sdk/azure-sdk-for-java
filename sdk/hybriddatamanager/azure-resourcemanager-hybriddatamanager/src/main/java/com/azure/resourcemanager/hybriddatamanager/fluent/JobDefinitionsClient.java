...
public interface JobDefinitionsClient {
    ...
    PagedIterable<JobDefinitionInner> listByDataService(String dataServiceName, String resourceGroupName,
    ...
    Response<JobDefinitionInner> getWithResponse(String dataServiceName, String jobDefinitionName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    JobDefinitionInner get(String dataServiceName, String jobDefinitionName, String resourceGroupName,
        String dataManagerName);
    ...
    SyncPoller<PollResult<JobDefinitionInner>, JobDefinitionInner> beginCreateOrUpdate(String dataServiceName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    JobDefinitionInner createOrUpdate(String dataServiceName, String jobDefinitionName, String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<Void>, Void> beginDelete(String dataServiceName, String jobDefinitionName,
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<Void>, Void> beginRun(String dataServiceName, String jobDefinitionName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    void run(String dataServiceName, String jobDefinitionName, String resourceGroupName, String dataManagerName,
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<JobDefinitionInner> listByDataManager(String resourceGroupName, String dataManagerName, String filter,
        Context context);
}
