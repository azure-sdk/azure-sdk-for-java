...
public final class JobDefinitionInner extends DmsBaseObject {
    ...
    public String jobDefinitionSchemaVersion() {
        return this.innerProperties() == null ? null : this.innerProperties().jobDefinitionSchemaVersion();
    }
     ...
     * @return the JobDefinitionInner object itself.
     */
    public JobDefinitionInner withJobDefinitionSchemaVersion(String jobDefinitionSchemaVersion) {
        if (this.innerProperties() == null) {
            this.innerProperties = new JobDefinitionProperties();
        }
        this.innerProperties().withJobDefinitionSchemaVersion(jobDefinitionSchemaVersion);
        return this;
    }
    ...
    public JobDefinitionState jobDefinitionState() {
        return this.innerProperties() == null ? null : this.innerProperties().jobDefinitionState();
    }
     ...
     * @return the JobDefinitionInner object itself.
     */
    public JobDefinitionInner withJobDefinitionState(JobDefinitionState jobDefinitionState) {
        if (this.innerProperties() == null) {
            this.innerProperties = new JobDefinitionProperties();
        }
        this.innerProperties().withJobDefinitionState(jobDefinitionState);
        return this;
    }
