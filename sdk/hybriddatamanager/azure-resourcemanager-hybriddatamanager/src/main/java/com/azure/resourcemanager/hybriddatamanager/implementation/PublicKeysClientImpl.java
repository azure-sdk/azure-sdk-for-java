...
public final class PublicKeysClientImpl implements PublicKeysClient {
    ...
    public interface PublicKeysService {
        ...
        Mono<Response<PublicKeyList>> listByDataManager(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<PublicKeyInner>> get(@HostParam("$host") String endpoint,
            @PathParam("publicKeyName") String publicKeyName, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("dataManagerName") String dataManagerName, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, Context context);
    ...
    private Mono<PagedResponse<PublicKeyInner>> listByDataManagerSinglePageAsync(String resourceGroupName,
        ...
        return FluxUtil
            ...
            .<PagedResponse<PublicKeyInner>>map(res -> new PagedResponseBase<>(res.getRequest(), res.getStatusCode(),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<PublicKeyInner>> getWithResponseAsync(String publicKeyName, String resourceGroupName,
        String dataManagerName) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        return FluxUtil
            .withContext(
                context -> service.get(this.client.getEndpoint(), publicKeyName, this.client.getSubscriptionId(),
                    resourceGroupName, dataManagerName, this.client.getApiVersion(), accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<PublicKeyInner>> getWithResponseAsync(String publicKeyName, String resourceGroupName,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.get(this.client.getEndpoint(), publicKeyName, this.client.getSubscriptionId(), resourceGroupName,
            dataManagerName, this.client.getApiVersion(), accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<PublicKeyInner> getWithResponse(String publicKeyName, String resourceGroupName,
        String dataManagerName, Context context) {
    ...
    public PublicKeyInner get(String publicKeyName, String resourceGroupName, String dataManagerName) {
        return getWithResponse(publicKeyName, resourceGroupName, dataManagerName, Context.NONE).getValue();
    }
