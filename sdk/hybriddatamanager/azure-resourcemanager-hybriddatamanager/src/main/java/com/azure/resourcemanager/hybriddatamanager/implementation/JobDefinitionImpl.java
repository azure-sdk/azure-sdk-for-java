...
public final class JobDefinitionImpl implements JobDefinition, JobDefinition.Definition, JobDefinition.Update {
    ...
    public JobDefinitionImpl withExistingDataService(String dataServiceName, String resourceGroupName,
    ...
    public JobDefinition create() {
        this.innerObject = serviceManager.serviceClient()
            .getJobDefinitions()
            .createOrUpdate(dataServiceName, jobDefinitionName, resourceGroupName, dataManagerName, this.innerModel(),
                Context.NONE);
        return this;
    }
    ...
    JobDefinitionImpl(JobDefinitionInner innerObject,
        ...
        this.serviceManager = serviceManager;
        this.dataServiceName = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "dataServices");
        this.jobDefinitionName = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "jobDefinitions");
        this.resourceGroupName = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "resourceGroups");
        this.dataManagerName = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "dataManagers");
    }
