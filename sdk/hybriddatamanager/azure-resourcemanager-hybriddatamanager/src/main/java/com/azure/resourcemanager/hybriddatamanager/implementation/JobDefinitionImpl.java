...
public final class JobDefinitionImpl implements JobDefinition, JobDefinition.Definition, JobDefinition.Update {
    ...
    public void retryJob() {
        serviceManager
            .jobDefinitions()
            .retryJob(dataServiceName, jobDefinitionName, resourceGroupName, dataManagerName);
    }

    public Response<Void> retryJobWithResponse(Context context) {
        return serviceManager
            .jobDefinitions()
            .retryJobWithResponse(dataServiceName, jobDefinitionName, resourceGroupName, dataManagerName, context);
    }
    ...
    public void skipJob() {
        serviceManager.jobDefinitions().skipJob(dataServiceName, jobDefinitionName, resourceGroupName, dataManagerName);
    }

    public Response<Void> skipJobWithResponse(Context context) {
        return serviceManager
            .jobDefinitions()
            .skipJobWithResponse(dataServiceName, jobDefinitionName, resourceGroupName, dataManagerName, context);
    }
