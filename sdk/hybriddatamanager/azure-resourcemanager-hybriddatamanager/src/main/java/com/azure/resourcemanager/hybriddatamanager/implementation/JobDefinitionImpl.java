...
import com.azure.resourcemanager.hybriddatamanager.models.JobDefinitionState;
...
public final class JobDefinitionImpl implements JobDefinition, JobDefinition.Definition, JobDefinition.Update {
    ...
    public String jobDefinitionSchemaVersion() {
        return this.innerModel().jobDefinitionSchemaVersion();
    }

    public JobDefinitionState jobDefinitionState() {
        return this.innerModel().jobDefinitionState();
    }
    ...
    public void cancel() {
        serviceManager.jobDefinitions().cancel(dataServiceName, jobDefinitionName, resourceGroupName, dataManagerName);
    }

    public Response<Void> cancelWithResponse(Context context) {
        return serviceManager
            .jobDefinitions()
            .cancelWithResponse(dataServiceName, jobDefinitionName, resourceGroupName, dataManagerName, context);
    }

    public void retryJob() {
        serviceManager
            .jobDefinitions()
            .retryJob(resourceGroupName, dataManagerName, dataServiceName, jobDefinitionName);
    }

    public Response<Void> retryJobWithResponse(Context context) {
        return serviceManager
            .jobDefinitions()
            .retryJobWithResponse(resourceGroupName, dataManagerName, dataServiceName, jobDefinitionName, context);
    }
    ...
    public void skipJob() {
        serviceManager.jobDefinitions().skipJob(resourceGroupName, dataManagerName, dataServiceName, jobDefinitionName);
    }

    public Response<Void> skipJobWithResponse(Context context) {
        return serviceManager
            .jobDefinitions()
            .skipJobWithResponse(resourceGroupName, dataManagerName, dataServiceName, jobDefinitionName, context);
    }
    ...
    public JobDefinitionImpl withJobDefinitionSchemaVersion(String jobDefinitionSchemaVersion) {
        this.innerModel().withJobDefinitionSchemaVersion(jobDefinitionSchemaVersion);
        return this;
    }

    public JobDefinitionImpl withJobDefinitionState(JobDefinitionState jobDefinitionState) {
        this.innerModel().withJobDefinitionState(jobDefinitionState);
        return this;
    }
