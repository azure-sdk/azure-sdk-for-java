...
public interface DataStores {
     ...
     * @return all the data stores/repositories in the given resource as paginated response with {@link PagedIterable}.
     */
    PagedIterable<DataStore> listByDataManager(String resourceGroupName, String dataManagerName, String filter,
        Context context);
     ...
     */
    Response<DataStore> getWithResponse(String dataStoreName, String resourceGroupName, String dataManagerName,
        Context context);
