...
public final class JobsImpl implements Jobs {
    ...
    public PagedIterable<Job> listByJobDefinition(String dataServiceName, String jobDefinitionName,
    ...
    public PagedIterable<Job> listByJobDefinition(String dataServiceName, String jobDefinitionName,
        ...
        PagedIterable<JobInner> inner = this.serviceClient()
            .listByJobDefinition(dataServiceName, jobDefinitionName, resourceGroupName, dataManagerName, filter,
                context);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new JobImpl(inner1, this.manager()));
    }

    public Response<Job> getWithResponse(String dataServiceName, String jobDefinitionName, String jobId,
        String resourceGroupName, String dataManagerName, String expand, Context context) {
        Response<JobInner> inner = this.serviceClient()
            .getWithResponse(dataServiceName, jobDefinitionName, jobId, resourceGroupName, dataManagerName, expand,
                context);
        if (inner != null) {
    ...
    public Job get(String dataServiceName, String jobDefinitionName, String jobId, String resourceGroupName,
    ...
    public PagedIterable<Job> listByDataService(String dataServiceName, String resourceGroupName,
        String dataManagerName) {
    ...
    public PagedIterable<Job> listByDataManager(String resourceGroupName, String dataManagerName, String filter,
        Context context) {
        PagedIterable<JobInner> inner
