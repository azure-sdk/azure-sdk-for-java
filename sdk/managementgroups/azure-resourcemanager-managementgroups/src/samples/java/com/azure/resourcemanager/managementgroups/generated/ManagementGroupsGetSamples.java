...
public final class ManagementGroupsGetSamples {
    ...
    public static void
        ...
        manager.managementGroups().getWithResponse("20000000-0001-0000-0000-00000000000",
            ManagementGroupExpandType.ANCESTORS, null, null, "no-cache", com.azure.core.util.Context.NONE);
    }
    ...
    public static void
        ...
        manager.managementGroups().getWithResponse("20000000-0001-0000-0000-000000000000",
            ManagementGroupExpandType.CHILDREN, null, null, "no-cache", com.azure.core.util.Context.NONE);
    }
    ...
    public static void getManagementGroup(com.azure.resourcemanager.managementgroups.ManagementGroupsManager manager) {
        manager.managementGroups().getWithResponse("20000000-0001-0000-0000-000000000000", null, null, null, "no-cache",
    ...
    public static void getManagementGroupsWithExpandAndRecurse(
        ...
        manager.managementGroups().getWithResponse("20000000-0001-0000-0000-000000000000",
            ManagementGroupExpandType.CHILDREN, true, null, "no-cache", com.azure.core.util.Context.NONE);
    }
}
