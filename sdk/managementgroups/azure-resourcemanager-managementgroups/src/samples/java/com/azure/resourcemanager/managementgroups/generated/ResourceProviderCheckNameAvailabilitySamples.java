...
public final class ResourceProviderCheckNameAvailabilitySamples {
    ...
    public static void checkManagementGroupNameAvailability(
        ...
        manager.resourceProviders().checkNameAvailabilityWithResponse(new CheckNameAvailabilityRequest()
            .withName("nameTocheck").withType(Type.MICROSOFT_MANAGEMENT_MANAGEMENT_GROUPS),
