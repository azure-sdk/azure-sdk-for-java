...
/**
 * An instance of this class provides access to all the operations defined in EntitiesOperationsClient.
 */
public final class EntitiesOperationsClientImpl implements EntitiesOperationsClient {
    /**
     * The proxy service used to perform REST calls.
     */
    private final EntitiesOperationsService service;
    ...
    /**
     * Initializes an instance of EntitiesOperationsClientImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    EntitiesOperationsClientImpl(ManagementGroupsApiImpl client) {
        this.service = RestProxy.create(EntitiesOperationsService.class, client.getHttpPipeline(),
            client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for ManagementGroupsApiEntitiesOperations to be used by the proxy service
     * to perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "ManagementGroupsApiE")
    public interface EntitiesOperationsService {
