...
import com.azure.resourcemanager.managementgroups.fluent.SubscriptionUnderManagementGroupsClient;
import com.azure.resourcemanager.managementgroups.fluent.models.SubscriptionUnderManagementGroupInner;
import com.azure.resourcemanager.managementgroups.models.SubscriptionUnderManagementGroupListResult;
import reactor.core.publisher.Mono;

/**
 * An instance of this class provides access to all the operations defined in SubscriptionUnderManagementGroupsClient.
 */
public final class SubscriptionUnderManagementGroupsClientImpl implements SubscriptionUnderManagementGroupsClient {
    /**
     * The proxy service used to perform REST calls.
     */
    private final SubscriptionUnderManagementGroupsService service;
    ...
    /**
     * Initializes an instance of SubscriptionUnderManagementGroupsClientImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    SubscriptionUnderManagementGroupsClientImpl(ManagementGroupsApiImpl client) {
        this.service = RestProxy.create(SubscriptionUnderManagementGroupsService.class, client.getHttpPipeline(),
            client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for ManagementGroupsApiSubscriptionUnderManagementGroups to be used by
     * the proxy service to perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "ManagementGroupsApiS")
    public interface SubscriptionUnderManagementGroupsService {
        @Headers({ "Content-Type: application/json" })
        @Get("/providers/Microsoft.Management/managementGroups/{groupId}/subscriptions")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<SubscriptionUnderManagementGroupListResult>> getSubscriptionsUnderManagementGroup(
            @HostParam("$host") String endpoint, @QueryParam("api-version") String apiVersion,
            @QueryParam("$skiptoken") String skiptoken, @PathParam("groupId") String groupId,
        ...
        Mono<Response<SubscriptionUnderManagementGroupInner>> create(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @HeaderParam("cache-control") String cacheControl,
            @PathParam("groupId") String groupId, @PathParam("subscriptionId") String subscriptionId,
            @BodyParam("application/json") SubscriptionUnderManagementGroupInner resource,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<SubscriptionUnderManagementGroupListResult>> getSubscriptionsUnderManagementGroupNext(
     ...
     * @return the response of a SubscriptionUnderManagementGroup list operation along with {@link PagedResponse} on
    ...
    private Mono<PagedResponse<SubscriptionUnderManagementGroupInner>>
        ...
        return FluxUtil
            .withContext(context -> service.getSubscriptionsUnderManagementGroup(this.client.getEndpoint(),
                this.client.getApiVersion(), skiptoken, groupId, accept, context))
    ...
    private Mono<PagedResponse<SubscriptionUnderManagementGroupInner>>
        ...
        return service
            .getSubscriptionsUnderManagementGroup(this.client.getEndpoint(), this.client.getApiVersion(), skiptoken,
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the response of a SubscriptionUnderManagementGroup list operation as paginated response with
     * {@link PagedFlux}.
     */
    ...
    private Mono<Response<SubscriptionUnderManagementGroupInner>> getSubscriptionWithResponseAsync(String groupId,
        ...
        return FluxUtil
            .withContext(context -> service.getSubscription(this.client.getEndpoint(), this.client.getApiVersion(),
                cacheControl, groupId, subscriptionId, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<SubscriptionUnderManagementGroupInner>> getSubscriptionWithResponseAsync(String groupId,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.getSubscription(this.client.getEndpoint(), this.client.getApiVersion(), cacheControl, groupId,
    ...
    private Mono<Response<SubscriptionUnderManagementGroupInner>> createWithResponseAsync(String groupId,
        String subscriptionId, String cacheControl, SubscriptionUnderManagementGroupInner resource) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.create(this.client.getEndpoint(), this.client.getApiVersion(), cacheControl,
                groupId, subscriptionId, resource, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<SubscriptionUnderManagementGroupInner>> createWithResponseAsync(String groupId,
        String subscriptionId, String cacheControl, SubscriptionUnderManagementGroupInner resource, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.create(this.client.getEndpoint(), this.client.getApiVersion(), cacheControl, groupId,
            subscriptionId, resource, accept, context);
    }
    ...
    private Mono<SubscriptionUnderManagementGroupInner> createAsync(String groupId, String subscriptionId) {
        final String cacheControl = null;
        final SubscriptionUnderManagementGroupInner resource = null;
        return createWithResponseAsync(groupId, subscriptionId, cacheControl, resource)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
    ...
    public Response<SubscriptionUnderManagementGroupInner> createWithResponse(String groupId, String subscriptionId,
        String cacheControl, SubscriptionUnderManagementGroupInner resource, Context context) {
        return createWithResponseAsync(groupId, subscriptionId, cacheControl, resource, context).block();
    }
    ...
    public SubscriptionUnderManagementGroupInner create(String groupId, String subscriptionId) {
        final String cacheControl = null;
        final SubscriptionUnderManagementGroupInner resource = null;
        return createWithResponse(groupId, subscriptionId, cacheControl, resource, Context.NONE).getValue();
    }
    ...
    private Mono<Response<Void>> deleteWithResponseAsync(String groupId, String subscriptionId, String cacheControl) {
        ...
        return FluxUtil
            .withContext(context -> service.delete(this.client.getEndpoint(), this.client.getApiVersion(), cacheControl,
                groupId, subscriptionId, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<Void>> deleteWithResponseAsync(String groupId, String subscriptionId, String cacheControl,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.delete(this.client.getEndpoint(), this.client.getApiVersion(), cacheControl, groupId,
            subscriptionId, accept, context);
    }
