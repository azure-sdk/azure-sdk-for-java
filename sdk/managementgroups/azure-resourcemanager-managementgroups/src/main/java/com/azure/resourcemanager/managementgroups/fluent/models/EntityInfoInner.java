...
public final class EntityInfoInner {
     ...
     * @return the EntityInfoInner object itself.
     */
    public EntityInfoInner withPermissions(PermissionsType permissions) {
        if (this.innerProperties() == null) {
            this.innerProperties = new EntityInfoProperties();
        }
     ...
     * @return the EntityInfoInner object itself.
     */
    public EntityInfoInner withInheritedPermissions(PermissionsType inheritedPermissions) {
        if (this.innerProperties() == null) {
            this.innerProperties = new EntityInfoProperties();
        }
