 ...
 */
public interface HierarchySettingsOperationGroupsClient {
    /**
    ...
    PagedIterable<HierarchySettingsInner> list(String groupId);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<HierarchySettingsInner> list(String groupId, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<HierarchySettingsInner> createOrUpdateWithResponse(String groupId, HierarchySettingsInner resource,
        Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    HierarchySettingsInner createOrUpdate(String groupId, HierarchySettingsInner resource);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<HierarchySettingsInner> updateWithResponse(String groupId, CreateOrUpdateSettingsRequest properties,
        Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    HierarchySettingsInner update(String groupId, CreateOrUpdateSettingsRequest properties);
