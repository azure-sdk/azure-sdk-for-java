...
public final class SubscriptionUnderManagementGroupsImpl implements SubscriptionUnderManagementGroups {
    private static final ClientLogger LOGGER = new ClientLogger(SubscriptionUnderManagementGroupsImpl.class);

    private final SubscriptionUnderManagementGroupsClient innerClient;

    private final com.azure.resourcemanager.managementgroups.ManagementGroupsManager serviceManager;

    public SubscriptionUnderManagementGroupsImpl(SubscriptionUnderManagementGroupsClient innerClient,
    ...
    public Response<SubscriptionUnderManagementGroup> createWithResponse(String groupId, String subscriptionId,
        ...
        Response<SubscriptionUnderManagementGroupInner> inner
            = this.serviceClient().createWithResponse(groupId, subscriptionId, cacheControl, resource, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
                new SubscriptionUnderManagementGroupImpl(inner.getValue(), this.manager()));
        } else {
    ...
    private SubscriptionUnderManagementGroupsClient serviceClient() {
