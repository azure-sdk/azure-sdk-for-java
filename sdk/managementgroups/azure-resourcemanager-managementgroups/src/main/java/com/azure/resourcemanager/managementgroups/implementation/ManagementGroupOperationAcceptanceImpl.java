...
public final class ManagementGroupOperationAcceptanceImpl implements ManagementGroupOperationAcceptance {
    private ManagementGroupOperationAcceptanceInner innerObject;

    private final com.azure.resourcemanager.managementgroups.ManagementGroupsManager serviceManager;

    ManagementGroupOperationAcceptanceImpl(ManagementGroupOperationAcceptanceInner innerObject,
    ...
    public ManagementGroupOperationAcceptanceInner innerModel() {
