...
@Fluent
public final class ParentGroupBagInfo {
    /*
    ...
    /** Creates an instance of ParentGroupBagInfo class. */
     ...
     * @return the ParentGroupBagInfo object itself.
     */
    public ParentGroupBagInfo withId(String id) {
        this.id = id;
        return this;
    }

    /**
     * Get the name property: The name of the parent management group. For example,
    ...
    /**
     * Set the name property: The name of the parent management group. For example,
     * 00000000-0000-0000-0000-000000000000.
     *
     * @param name the name value to set.
     * @return the ParentGroupBagInfo object itself.
     */
    public ParentGroupBagInfo withName(String name) {
        this.name = name;
        return this;
    }
     ...
     * @return the ParentGroupBagInfo object itself.
     */
    public ParentGroupBagInfo withDisplayName(String displayName) {
