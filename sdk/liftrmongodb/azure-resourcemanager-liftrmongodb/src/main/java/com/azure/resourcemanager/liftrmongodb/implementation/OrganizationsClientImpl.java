...
import com.azure.resourcemanager.liftrmongodb.fluent.OrganizationsClient;
...
public final class OrganizationsClientImpl implements OrganizationsClient {
     ...
     */
    private final LiftrMongoDBManagementClientImpl client;
     ...
     */
    OrganizationsClientImpl(LiftrMongoDBManagementClientImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for LiftrMongoDBManagementClientOrganizations to be used by the proxy
     * service to perform REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "LiftrMongoDBManageme")
