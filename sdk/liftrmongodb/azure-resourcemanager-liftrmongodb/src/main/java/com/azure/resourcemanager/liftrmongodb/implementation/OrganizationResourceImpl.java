...
public final class OrganizationResourceImpl
    ...
    private final com.azure.resourcemanager.liftrmongodb.LiftrMongoDBManager serviceManager;
    ...
    private com.azure.resourcemanager.liftrmongodb.LiftrMongoDBManager manager() {
    ...
    OrganizationResourceImpl(String name, com.azure.resourcemanager.liftrmongodb.LiftrMongoDBManager serviceManager) {
    ...
    OrganizationResourceImpl(OrganizationResourceInner innerObject,
        com.azure.resourcemanager.liftrmongodb.LiftrMongoDBManager serviceManager) {
