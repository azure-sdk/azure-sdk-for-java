...
public final class WorkspaceCollectionsClientImpl implements WorkspaceCollectionsClient {
    ...
    WorkspaceCollectionsClientImpl(PowerBIEmbeddedManagementClientImpl client) {
        this.service = RestProxy.create(WorkspaceCollectionsService.class, client.getHttpPipeline(),
    ...
    public interface WorkspaceCollectionsService {
        ...
        Mono<Response<WorkspaceCollectionInner>> getByResourceGroup(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<WorkspaceCollectionInner>> create(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("workspaceCollectionName") String workspaceCollectionName,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") CreateWorkspaceCollectionRequest body, @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<WorkspaceCollectionInner>> update(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("workspaceCollectionName") String workspaceCollectionName,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") UpdateWorkspaceCollectionRequest body, @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<CheckNameResponseInner>> checkNameAvailability(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId, @PathParam("location") String location,
            @QueryParam("api-version") String apiVersion, @BodyParam("application/json") CheckNameRequest body,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<WorkspaceCollectionList>> listByResourceGroup(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<WorkspaceCollectionList>> list(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<WorkspaceCollectionAccessKeysInner>> getAccessKeys(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("workspaceCollectionName") String workspaceCollectionName,
            @QueryParam("api-version") String apiVersion, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<WorkspaceCollectionAccessKeysInner>> regenerateKey(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("workspaceCollectionName") String workspaceCollectionName,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") WorkspaceCollectionAccessKey body, @HeaderParam("Accept") String accept,
            Context context);
        ...
        Mono<Response<Void>> migrate(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") MigrateWorkspaceCollectionRequest body, @HeaderParam("Accept") String accept,
            Context context);
    }
    ...
    private Mono<Response<WorkspaceCollectionInner>> getByResourceGroupWithResponseAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(
                context -> service.getByResourceGroup(this.client.getEndpoint(), this.client.getSubscriptionId(),
                    resourceGroupName, workspaceCollectionName, this.client.getApiVersion(), accept, context))
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<WorkspaceCollectionInner>> getByResourceGroupWithResponseAsync(String resourceGroupName,
        String workspaceCollectionName, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service.getByResourceGroup(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            workspaceCollectionName, this.client.getApiVersion(), accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<WorkspaceCollectionInner> getByResourceGroupAsync(String resourceGroupName,
        String workspaceCollectionName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<WorkspaceCollectionInner> getByResourceGroupWithResponse(String resourceGroupName,
        String workspaceCollectionName, Context context) {
    ...
    public WorkspaceCollectionInner getByResourceGroup(String resourceGroupName, String workspaceCollectionName) {
        return getByResourceGroupWithResponse(resourceGroupName, workspaceCollectionName, Context.NONE).getValue();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<WorkspaceCollectionInner>> createWithResponseAsync(String resourceGroupName,
        String workspaceCollectionName, CreateWorkspaceCollectionRequest body) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return FluxUtil
            .withContext(context -> service.create(this.client.getEndpoint(), this.client.getSubscriptionId(),
                resourceGroupName, workspaceCollectionName, this.client.getApiVersion(), body, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<WorkspaceCollectionInner>> createWithResponseAsync(String resourceGroupName,
        String workspaceCollectionName, CreateWorkspaceCollectionRequest body, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service.create(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            workspaceCollectionName, this.client.getApiVersion(), body, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<WorkspaceCollectionInner> createAsync(String resourceGroupName, String workspaceCollectionName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<WorkspaceCollectionInner> createWithResponse(String resourceGroupName,
        String workspaceCollectionName, CreateWorkspaceCollectionRequest body, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public WorkspaceCollectionInner create(String resourceGroupName, String workspaceCollectionName,
        CreateWorkspaceCollectionRequest body) {
        return createWithResponse(resourceGroupName, workspaceCollectionName, body, Context.NONE).getValue();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<WorkspaceCollectionInner>> updateWithResponseAsync(String resourceGroupName,
        String workspaceCollectionName, UpdateWorkspaceCollectionRequest body) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<WorkspaceCollectionInner>> updateWithResponseAsync(String resourceGroupName,
        String workspaceCollectionName, UpdateWorkspaceCollectionRequest body, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<WorkspaceCollectionInner> updateAsync(String resourceGroupName, String workspaceCollectionName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<WorkspaceCollectionInner> updateWithResponse(String resourceGroupName,
        String workspaceCollectionName, UpdateWorkspaceCollectionRequest body, Context context) {
    ...
    public WorkspaceCollectionInner update(String resourceGroupName, String workspaceCollectionName,
        UpdateWorkspaceCollectionRequest body) {
        return updateWithResponse(resourceGroupName, workspaceCollectionName, body, Context.NONE).getValue();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String workspaceCollectionName) {
        return this.beginDeleteAsync(resourceGroupName, workspaceCollectionName).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String workspaceCollectionName,
        Context context) {
        return this.beginDeleteAsync(resourceGroupName, workspaceCollectionName, context).getSyncPoller();
    }
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String workspaceCollectionName) {
        return beginDeleteAsync(resourceGroupName, workspaceCollectionName).last()
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String workspaceCollectionName, Context context) {
        return beginDeleteAsync(resourceGroupName, workspaceCollectionName, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<CheckNameResponseInner>> checkNameAvailabilityWithResponseAsync(String location,
        CheckNameRequest body) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<CheckNameResponseInner>> checkNameAvailabilityWithResponseAsync(String location,
        CheckNameRequest body, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<CheckNameResponseInner> checkNameAvailabilityWithResponse(String location, CheckNameRequest body,
        Context context) {
    ...
    private Mono<PagedResponse<WorkspaceCollectionInner>> listByResourceGroupSinglePageAsync(String resourceGroupName) {
        ...
        return FluxUtil
            ...
            .<PagedResponse<WorkspaceCollectionInner>>map(res -> new PagedResponseBase<>(res.getRequest(),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<WorkspaceCollectionAccessKeysInner>> getAccessKeysWithResponseAsync(String resourceGroupName,
        String workspaceCollectionName) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.getAccessKeys(this.client.getEndpoint(), this.client.getSubscriptionId(),
                resourceGroupName, workspaceCollectionName, this.client.getApiVersion(), accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<WorkspaceCollectionAccessKeysInner>> getAccessKeysWithResponseAsync(String resourceGroupName,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.getAccessKeys(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            workspaceCollectionName, this.client.getApiVersion(), accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<WorkspaceCollectionAccessKeysInner> getAccessKeysAsync(String resourceGroupName,
        String workspaceCollectionName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<WorkspaceCollectionAccessKeysInner> getAccessKeysWithResponse(String resourceGroupName,
        String workspaceCollectionName, Context context) {
    ...
    public WorkspaceCollectionAccessKeysInner getAccessKeys(String resourceGroupName, String workspaceCollectionName) {
        return getAccessKeysWithResponse(resourceGroupName, workspaceCollectionName, Context.NONE).getValue();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<WorkspaceCollectionAccessKeysInner>> regenerateKeyWithResponseAsync(String resourceGroupName,
        String workspaceCollectionName, WorkspaceCollectionAccessKey body) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<WorkspaceCollectionAccessKeysInner>> regenerateKeyWithResponseAsync(String resourceGroupName,
        String workspaceCollectionName, WorkspaceCollectionAccessKey body, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<WorkspaceCollectionAccessKeysInner> regenerateKeyAsync(String resourceGroupName,
        String workspaceCollectionName, WorkspaceCollectionAccessKey body) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<WorkspaceCollectionAccessKeysInner> regenerateKeyWithResponse(String resourceGroupName,
        String workspaceCollectionName, WorkspaceCollectionAccessKey body, Context context) {
    ...
    public WorkspaceCollectionAccessKeysInner regenerateKey(String resourceGroupName, String workspaceCollectionName,
        WorkspaceCollectionAccessKey body) {
        return regenerateKeyWithResponse(resourceGroupName, workspaceCollectionName, body, Context.NONE).getValue();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Void>> migrateWithResponseAsync(String resourceGroupName,
        MigrateWorkspaceCollectionRequest body) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return FluxUtil
            .withContext(context -> service.migrate(this.client.getEndpoint(), this.client.getSubscriptionId(),
                resourceGroupName, this.client.getApiVersion(), body, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Void>> migrateWithResponseAsync(String resourceGroupName,
        MigrateWorkspaceCollectionRequest body, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    private Mono<Void> migrateAsync(String resourceGroupName, MigrateWorkspaceCollectionRequest body) {
        return migrateWithResponseAsync(resourceGroupName, body).flatMap(ignored -> Mono.empty());
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<Void> migrateWithResponse(String resourceGroupName, MigrateWorkspaceCollectionRequest body,
        Context context) {
    ...
    public void migrate(String resourceGroupName, MigrateWorkspaceCollectionRequest body) {
        migrateWithResponse(resourceGroupName, body, Context.NONE);
    }
}
