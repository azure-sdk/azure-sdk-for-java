...
/**
 * Entry point to PowerBIEmbeddedManager.
...
public final class PowerBIEmbeddedManager {
    ...
    private PowerBIEmbeddedManager(HttpPipeline httpPipeline, AzureProfile profile, Duration defaultPollInterval) {
        ...
        this.clientObject = new PowerBIEmbeddedManagementClientBuilder().pipeline(httpPipeline)
     ...
     * @return the PowerBIEmbedded service API instance.
     */
    public static PowerBIEmbeddedManager authenticate(HttpPipeline httpPipeline, AzureProfile profile) {
        Objects.requireNonNull(httpPipeline, "'httpPipeline' cannot be null.");
        Objects.requireNonNull(profile, "'profile' cannot be null.");
        return new PowerBIEmbeddedManager(httpPipeline, profile, null);
    }
    ...
    public static final class Configurable {
        ...
        private static final Map<String, String> PROPERTIES
            = CoreUtils.getProperties("azure-resourcemanager-powerbiembedded.properties");
    ...
    /**
     * Gets the resource collection API of WorkspaceCollections. It manages WorkspaceCollection.
     * 
    ...
    /**
     * Gets wrapped service client PowerBIEmbeddedManagementClient providing direct access to the underlying
     * auto-generated API implementation, based on Azure REST API.
     * 
     * @return Wrapped service client PowerBIEmbeddedManagementClient.
     */
