...
public final class ResourceProvidersImpl implements ResourceProviders {
    ...
    public Response<OperationList> getAvailableOperationsWithResponse(Context context) {
        Response<OperationListInner> inner = this.serviceClient().getAvailableOperationsWithResponse(context);
        if (inner != null) {
    ...
    public OperationList getAvailableOperations() {
        OperationListInner inner = this.serviceClient().getAvailableOperations();
        if (inner != null) {
