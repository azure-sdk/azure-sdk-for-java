...
public final class WorkspaceCollectionImpl
    ...
    WorkspaceCollectionImpl(String name,
    ...
    WorkspaceCollectionImpl(WorkspaceCollectionInner innerObject,
        com.azure.resourcemanager.powerbiembedded.PowerBIEmbeddedManager serviceManager) {
        this.innerObject = innerObject;
        this.serviceManager = serviceManager;
        this.resourceGroupName = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "resourceGroups");
        this.workspaceCollectionName
            = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "workspaceCollections");
    }
    ...
    public Response<WorkspaceCollectionAccessKeys> getAccessKeysWithResponse(Context context) {
        return serviceManager.workspaceCollections()
    ...
    public Response<WorkspaceCollectionAccessKeys> regenerateKeyWithResponse(WorkspaceCollectionAccessKey body,
        Context context) {
        return serviceManager.workspaceCollections()
