...
public final class WorkspaceCollectionsImpl implements WorkspaceCollections {
    private static final ClientLogger LOGGER = new ClientLogger(WorkspaceCollectionsImpl.class);
    ...
    public WorkspaceCollectionsImpl(WorkspaceCollectionsClient innerClient,
        com.azure.resourcemanager.powerbiembedded.PowerBIEmbeddedManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public Response<WorkspaceCollection> getByResourceGroupWithResponse(String resourceGroupName,
    ...
    public Response<CheckNameResponse> checkNameAvailabilityWithResponse(String location, CheckNameRequest body,
        Context context) {
    ...
    public PagedIterable<WorkspaceCollection> listByResourceGroup(String resourceGroupName) {
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new WorkspaceCollectionImpl(inner1, this.manager()));
    }
    ...
    public Response<WorkspaceCollectionAccessKeys> getAccessKeysWithResponse(String resourceGroupName,
        String workspaceCollectionName, Context context) {
    ...
    public Response<WorkspaceCollectionAccessKeys> regenerateKeyWithResponse(String resourceGroupName,
    ...
    public WorkspaceCollectionAccessKeys regenerateKey(String resourceGroupName, String workspaceCollectionName,
    ...
    public WorkspaceCollection getById(String id) {
        ...
        String workspaceCollectionName = ResourceManagerUtils.getValueFromIdByName(id, "workspaceCollections");
        if (workspaceCollectionName == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
                String.format("The resource ID '%s' is not valid. Missing path segment 'workspaceCollections'.", id)));
        }
