...
public final class PowerBIEmbeddedManagementClientImpl implements PowerBIEmbeddedManagementClient {
     ...
     */
    PowerBIEmbeddedManagementClientImpl(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter,
    ...
    private static final ClientLogger LOGGER = new ClientLogger(PowerBIEmbeddedManagementClientImpl.class);
}
