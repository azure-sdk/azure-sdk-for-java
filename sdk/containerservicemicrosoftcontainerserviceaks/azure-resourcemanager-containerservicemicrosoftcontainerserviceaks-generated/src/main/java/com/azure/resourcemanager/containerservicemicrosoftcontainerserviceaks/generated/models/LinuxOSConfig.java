...
public final class LinuxOSConfig {
     ...
     *
     * <p>Valid values are 'always', 'madvise', and 'never'. The default is 'always'. For more information see
     * [Transparent
     * Hugepages](https://www.kernel.org/doc/html/latest/admin-guide/mm/transhuge.html#admin-guide-transhuge).
     *
     ...
     *
     * <p>Valid values are 'always', 'defer', 'defer+madvise', 'madvise' and 'never'. The default is 'madvise'. For more
     * information see [Transparent
     * Hugepages](https://www.kernel.org/doc/html/latest/admin-guide/mm/transhuge.html#admin-guide-transhuge).
     *
    ...
    /**
     * Get the ulimits property: Ulimit settings for Linux agent nodes.
     *
     * @return the ulimits value.
     */
    public UlimitConfig ulimits() {
        return this.ulimits;
    }

    /**
     * Set the ulimits property: Ulimit settings for Linux agent nodes.
     *
     * @param ulimits the ulimits value to set.
     * @return the LinuxOSConfig object itself.
     */
    public LinuxOSConfig withUlimits(UlimitConfig ulimits) {
