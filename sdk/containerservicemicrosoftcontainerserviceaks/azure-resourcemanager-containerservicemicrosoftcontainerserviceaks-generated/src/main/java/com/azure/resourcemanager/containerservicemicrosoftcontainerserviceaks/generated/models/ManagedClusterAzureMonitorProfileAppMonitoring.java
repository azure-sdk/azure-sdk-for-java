...
public final class ManagedClusterAzureMonitorProfileAppMonitoring {
    ...
    /**
     * Get the enabled property: Indicates if Application Monitoring enabled or not.
     * 
    ...
    /**
     * Set the enabled property: Indicates if Application Monitoring enabled or not.
     * 
     * @param enabled the enabled value to set.
     * @return the ManagedClusterAzureMonitorProfileAppMonitoring object itself.
     */
    public ManagedClusterAzureMonitorProfileAppMonitoring withEnabled(Boolean enabled) {
