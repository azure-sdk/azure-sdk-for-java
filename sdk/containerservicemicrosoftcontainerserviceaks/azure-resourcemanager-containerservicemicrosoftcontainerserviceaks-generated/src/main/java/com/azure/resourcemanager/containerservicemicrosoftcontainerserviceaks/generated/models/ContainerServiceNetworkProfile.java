...
public final class ContainerServiceNetworkProfile {
    ...
    private NetworkMonitoring monitoring;
    ...
    /**
     * Get the monitoring property: This addon can be used to configure network monitoring and generate network
     * monitoring data in Prometheus format.
     * 
     * @return the monitoring value.
     */
    public NetworkMonitoring monitoring() {
        return this.monitoring;
    }

    /**
     * Set the monitoring property: This addon can be used to configure network monitoring and generate network
     * monitoring data in Prometheus format.
     * 
     * @param monitoring the monitoring value to set.
     * @return the ContainerServiceNetworkProfile object itself.
     */
    public ContainerServiceNetworkProfile withMonitoring(NetworkMonitoring monitoring) {
