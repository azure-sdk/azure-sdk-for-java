...
public interface ManagedClusters {
     ...
     */
    Response<GuardrailsAvailableVersion> getGuardrailsVersionsWithResponse(
     ...
     * @return holds an array of MeshUpgradeProfiles as paginated response with {@link PagedIterable}.
     */
    PagedIterable<MeshUpgradeProfile> listMeshUpgradeProfiles(
        String resourceGroupName, String resourceName, Context context);
     ...
     */
    Response<MeshUpgradeProfile> getMeshUpgradeProfileWithResponse(
