...
import com.azure.resourcemanager.containerservicemicrosoftcontainerserviceaks.generated.models.MachineListResult;
...
public final class MachinesClientImpl implements MachinesClient {
    ...
    public interface MachinesService {
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<MachineListResult>> listNext(
    ...
    private PagedFlux<MachineInner> listAsync(String resourceGroupName, String resourceName, String agentPoolName) {
        return new PagedFlux<>(
            () -> listSinglePageAsync(resourceGroupName, resourceName, agentPoolName),
    ...
    private PagedFlux<MachineInner> listAsync(
        String resourceGroupName, String resourceName, String agentPoolName, Context context) {
        return new PagedFlux<>(
            () -> listSinglePageAsync(resourceGroupName, resourceName, agentPoolName, context),
