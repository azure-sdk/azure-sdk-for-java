...
public final class ManagedClusterIngressProfileWebAppRouting {
    ...
    /*
     * Resource IDs of the public DNS zones to be associated with the Web App Routing add-on. Used only when Web App
     * Routing is enabled. All public DNS zones must be in the same resource group.
     */
    ...
    /**
     * Get the dnsZoneResourceIds property: Resource IDs of the public DNS zones to be associated with the Web App
     * Routing add-on. Used only when Web App Routing is enabled. All public DNS zones must be in the same resource
     * group.
     *
    ...
    /**
     * Set the dnsZoneResourceIds property: Resource IDs of the public DNS zones to be associated with the Web App
     * Routing add-on. Used only when Web App Routing is enabled. All public DNS zones must be in the same resource
     * group.
     *
