...
public final class ManagedClusterCostAnalysis {
     ...
     *
     * The Managed Cluster sku.tier must be set to 'Standard' to enable this feature. Enabling this will add Kubernetes
     * Namespace and Deployment details to the Cost Analysis views in the Azure portal. If not specified, the default
     * is false. For more information see aka.ms/aks/docs/cost-analysis.
     */
     ...
     *
     * <p>The Managed Cluster sku.tier must be set to 'Standard' to enable this feature. Enabling this will add
