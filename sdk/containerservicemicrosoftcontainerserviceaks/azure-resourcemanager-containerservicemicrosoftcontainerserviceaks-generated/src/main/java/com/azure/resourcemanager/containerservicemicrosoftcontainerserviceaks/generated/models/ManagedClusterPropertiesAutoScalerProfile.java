...
public final class ManagedClusterPropertiesAutoScalerProfile {
     ...
     *
     * Available values are: 'least-waste', 'most-pods', 'priority', 'random'. If multiple expanders are configured,
     * they will be considered in the order in which they are listed, with the first one being considered first.
     */
    @JsonProperty(value = "expanders")
     ...
     * them.
     *
     * <p>Valid values are 'true' and 'false'.
     *
    ...
    /**
     * Get the daemonsetEvictionForEmptyNodes property: DaemonSet pods will be gracefully terminated from empty nodes
     *
     * <p>If set to true, all daemonset pods on empty nodes will be evicted before deletion of the node. If the
     * daemonset pod cannot be evicted another node will be chosen for scaling. If set to false, the node will be
     * deleted without ensuring that daemonset pods are deleted or evicted.
     *
    ...
    /**
     * Set the daemonsetEvictionForEmptyNodes property: DaemonSet pods will be gracefully terminated from empty nodes
     *
     * <p>If set to true, all daemonset pods on empty nodes will be evicted before deletion of the node. If the
     * daemonset pod cannot be evicted another node will be chosen for scaling. If set to false, the node will be
     * deleted without ensuring that daemonset pods are deleted or evicted.
     ...
     * @return the ManagedClusterPropertiesAutoScalerProfile object itself.
     */
    public ManagedClusterPropertiesAutoScalerProfile withDaemonsetEvictionForEmptyNodes(
    ...
    /**
     * Get the daemonsetEvictionForOccupiedNodes property: DaemonSet pods will be gracefully terminated from non-empty
     * nodes
     *
     * <p>If set to true, all daemonset pods on occupied nodes will be evicted before deletion of the node. If the
     * daemonset pod cannot be evicted another node will be chosen for scaling. If set to false, the node will be
     * deleted without ensuring that daemonset pods are deleted or evicted.
     *
    ...
    /**
     * Set the daemonsetEvictionForOccupiedNodes property: DaemonSet pods will be gracefully terminated from non-empty
     * nodes
     *
     * <p>If set to true, all daemonset pods on occupied nodes will be evicted before deletion of the node. If the
     * daemonset pod cannot be evicted another node will be chosen for scaling. If set to false, the node will be
    ...
    /**
     * Get the ignoreDaemonsetsUtilization property: Should CA ignore DaemonSet pods when calculating resource
     * utilization for scaling down
     *
     * <p>If set to true, the resources used by daemonset will be taken into account when making scaling down decisions.
     *
    ...
    /**
     * Set the ignoreDaemonsetsUtilization property: Should CA ignore DaemonSet pods when calculating resource
     * utilization for scaling down
     *
     * <p>If set to true, the resources used by daemonset will be taken into account when making scaling down decisions.
     *
     ...
     * @return the ManagedClusterPropertiesAutoScalerProfile object itself.
     */
    public ManagedClusterPropertiesAutoScalerProfile withIgnoreDaemonsetsUtilization(
     ...
     *
     * <p>Available values are: 'least-waste', 'most-pods', 'priority', 'random'.
     *
    ...
    /**
     * Get the expanders property: Type of node group expander to be used in scale up.
     *
     * <p>Available values are: 'least-waste', 'most-pods', 'priority', 'random'. If multiple expanders are configured,
     * they will be considered in the order in which they are listed, with the first one being considered first.
     *
     * @return the expanders value.
     */
    ...
    /**
     * Set the expanders property: Type of node group expander to be used in scale up.
     *
     * <p>Available values are: 'least-waste', 'most-pods', 'priority', 'random'. If multiple expanders are configured,
     * they will be considered in the order in which they are listed, with the first one being considered first.
     *
     * @param expanders the expanders value to set.
     * @return the ManagedClusterPropertiesAutoScalerProfile object itself.
     */
    public ManagedClusterPropertiesAutoScalerProfile withExpanders(List<Expander> expanders) {
     ...
     *
     * <p>The default is '15m'. Values must be an integer followed by an 'm'. No unit of time other than minutes (m) is
     * supported.
     *
     ...
     *
     * <p>The default is 45. The maximum is 100 and the minimum is 0.
     *
     ...
     *
     * <p>For scenarios like burst/batch scale where you don't want CA to act before the kubernetes scheduler could
     * schedule all the pods, you can tell CA to ignore unscheduled pods before they're a certain age. The default is
     * '0s'. Values must be an integer followed by a unit ('s' for seconds, 'm' for minutes, 'h' for hours, etc).
     *
     ...
     *
     * <p>This must be an integer. The default is 3.
     *
     ...
     *
     * <p>The default is '10'. Values must be an integer number of seconds.
     *
     ...
     *
     * <p>The default is '10m'. Values must be an integer followed by an 'm'. No unit of time other than minutes (m) is
     * supported.
     *
     ...
     *
     * <p>The default is the scan-interval. Values must be an integer followed by an 'm'. No unit of time other than
     * minutes (m) is supported.
     *
     ...
     * resumes.
     *
     * <p>The default is '3m'. Values must be an integer followed by an 'm'. No unit of time other than minutes (m) is
     * supported.
     *
     ...
     * scale down
     *
     * <p>The default is '20m'. Values must be an integer followed by an 'm'. No unit of time other than minutes (m) is
     * supported.
     *
