...
public final class ManagedClusterPropertiesAutoScalerProfile {
    ...
    private List<Expander> expander;
    ...
    /**
     * Get the expander property: Type of node group expander to be used in scale up.
     * 
     * Available values are: 'least-waste', 'most-pods', 'priority', 'random'. If multiple expanders are configured,
     * they will be considered in the order in which they are listed, with the first one being considered first.
     * 
     ...
     */
    public List<Expander> expander() {
        return this.expander;
    }

    /**
     * Set the expander property: Type of node group expander to be used in scale up.
     * 
     * Available values are: 'least-waste', 'most-pods', 'priority', 'random'. If multiple expanders are configured,
     * they will be considered in the order in which they are listed, with the first one being considered first.
     * 
     ...
     * @return the ManagedClusterPropertiesAutoScalerProfile object itself.
     */
    public ManagedClusterPropertiesAutoScalerProfile withExpander(List<Expander> expander) {
