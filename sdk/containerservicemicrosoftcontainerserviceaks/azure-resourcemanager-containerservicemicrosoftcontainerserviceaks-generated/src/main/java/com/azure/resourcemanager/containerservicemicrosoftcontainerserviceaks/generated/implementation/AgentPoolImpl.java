...
public final class AgentPoolImpl implements AgentPool, AgentPool.Definition, AgentPool.Update {
    ...
    public UserAssignedIdentity vmIdentityProfile() {
        return this.innerModel().vmIdentityProfile();
    }
    ...
    public AgentPoolImpl withVmIdentityProfile(UserAssignedIdentity vmIdentityProfile) {
        this.innerModel().withVmIdentityProfile(vmIdentityProfile);
        return this;
    }
}
