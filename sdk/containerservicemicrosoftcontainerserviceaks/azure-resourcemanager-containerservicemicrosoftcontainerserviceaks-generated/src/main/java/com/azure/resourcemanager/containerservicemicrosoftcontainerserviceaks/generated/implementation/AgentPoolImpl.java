...
public final class AgentPoolImpl implements AgentPool, AgentPool.Definition, AgentPool.Update {
    ...
    public Boolean enableCustomCATrust() {
        return this.innerModel().enableCustomCATrust();
    }
    ...
    public List<String> nodeInitializationTaints() {
        List<String> inner = this.innerModel().nodeInitializationTaints();
        if (inner != null) {
            return Collections.unmodifiableList(inner);
        } else {
            return Collections.emptyList();
    ...
    public AgentPoolArtifactStreamingProfile artifactStreamingProfile() {
        return this.innerModel().artifactStreamingProfile();
    }
    ...
    public AgentPool create() {
        this.innerObject = serviceManager.serviceClient().getAgentPools().createOrUpdate(resourceGroupName,
            resourceName, agentPoolName, this.innerModel(), Context.NONE);
        return this;
    }

    public AgentPool create(Context context) {
        this.innerObject = serviceManager.serviceClient().getAgentPools().createOrUpdate(resourceGroupName,
            resourceName, agentPoolName, this.innerModel(), context);
        return this;
    }
    ...
    public AgentPool refresh() {
        this.innerObject = serviceManager.serviceClient().getAgentPools()
            .getWithResponse(resourceGroupName, resourceName, agentPoolName, Context.NONE).getValue();
        return this;
    }

    public AgentPool refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getAgentPools()
            .getWithResponse(resourceGroupName, resourceName, agentPoolName, context).getValue();
        return this;
    }
    ...
    public AgentPoolImpl withEnableCustomCATrust(Boolean enableCustomCATrust) {
        this.innerModel().withEnableCustomCATrust(enableCustomCATrust);
        return this;
    }
    ...
    public AgentPoolImpl withNodeInitializationTaints(List<String> nodeInitializationTaints) {
        this.innerModel().withNodeInitializationTaints(nodeInitializationTaints);
        return this;
    }
    ...
    public AgentPoolImpl withGpuProfile(AgentPoolGpuProfile gpuProfile) {
        this.innerModel().withGpuProfile(gpuProfile);
        return this;
    }

    public AgentPoolImpl withArtifactStreamingProfile(AgentPoolArtifactStreamingProfile artifactStreamingProfile) {
        this.innerModel().withArtifactStreamingProfile(artifactStreamingProfile);
        return this;
    }
