...
public interface AgentPoolsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<Void>, Void> beginDeleteMachines(
        String resourceGroupName, String resourceName, String agentPoolName, AgentPoolDeleteMachinesParameter machines);
