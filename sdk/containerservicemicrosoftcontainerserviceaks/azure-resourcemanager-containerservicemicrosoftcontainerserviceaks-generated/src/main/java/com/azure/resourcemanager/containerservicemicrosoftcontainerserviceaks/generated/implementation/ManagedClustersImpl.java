...
import com.azure.resourcemanager.containerservicemicrosoftcontainerserviceaks.generated.fluent.ManagedClustersClient;
...
import com.azure.resourcemanager.containerservicemicrosoftcontainerserviceaks.generated.models.ManagedClusters;
...
import com.azure.resourcemanager.containerservicemicrosoftcontainerserviceaks.generated.models.MeshRevisionProfile;
import com.azure.resourcemanager.containerservicemicrosoftcontainerserviceaks.generated.models.MeshUpgradeProfile;
import com.azure.resourcemanager.containerservicemicrosoftcontainerserviceaks.generated.models.OSOptionProfile;
import com.azure.resourcemanager.containerservicemicrosoftcontainerserviceaks.generated.models.OutboundEnvironmentEndpoint;
...
public final class ManagedClustersImpl implements ManagedClusters {
    ...
    public void delete(String resourceGroupName, String resourceName, Boolean ignorePodDisruptionBudget,
        Context context) {
        this.serviceClient().delete(resourceGroupName, resourceName, ignorePodDisruptionBudget, context);
    }
    ...
    public PagedIterable<GuardrailsAvailableVersion> listGuardrailsVersions(String location) {
        ...
        return Utils.mapPage(inner, inner1 -> new GuardrailsAvailableVersionImpl(inner1, this.manager()));
    }
    ...
    public PagedIterable<SafeguardsAvailableVersion> listSafeguardsVersions(String location) {
        ...
        return Utils.mapPage(inner, inner1 -> new SafeguardsAvailableVersionImpl(inner1, this.manager()));
    }
    ...
    public PagedIterable<MeshRevisionProfile> listMeshRevisionProfiles(String location) {
        ...
        return Utils.mapPage(inner, inner1 -> new MeshRevisionProfileImpl(inner1, this.manager()));
    }
    ...
    public PagedIterable<MeshUpgradeProfile> listMeshUpgradeProfiles(String resourceGroupName, String resourceName) {
        ...
        return Utils.mapPage(inner, inner1 -> new MeshUpgradeProfileImpl(inner1, this.manager()));
    }
    ...
    public void deleteById(String id) {
        ...
        this.delete(resourceGroupName, resourceName, localIgnorePodDisruptionBudget, Context.NONE);
    }

    public void deleteByIdWithResponse(String id, Boolean ignorePodDisruptionBudget, Context context) {
        String resourceGroupName = Utils.getValueFromIdByName(id, "resourceGroups");
        if (resourceGroupName == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
                String.format("The resource ID '%s' is not valid. Missing path segment 'resourceGroups'.", id)));
        ...
        this.delete(resourceGroupName, resourceName, ignorePodDisruptionBudget, context);
    }
