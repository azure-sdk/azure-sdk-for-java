...
public class ManagedClusterAgentPoolProfileProperties {
    ...
    /*
     * Customers use this identity to grant AKS access permission to the Capacity Reservation Group and the reserved
     * VMs inside.
     */
    @JsonProperty(value = "vmIdentityProfile")
    private UserAssignedIdentity vmIdentityProfile;
     ...
     * @return the ManagedClusterAgentPoolProfileProperties object itself.
     */
    public ManagedClusterAgentPoolProfileProperties withArtifactStreamingProfile(
    ...
    /**
     * Get the vmIdentityProfile property: Customers use this identity to grant AKS access permission to the Capacity
     * Reservation Group and the reserved VMs inside.
     *
     * @return the vmIdentityProfile value.
     */
    public UserAssignedIdentity vmIdentityProfile() {
        return this.vmIdentityProfile;
    }

    /**
     * Set the vmIdentityProfile property: Customers use this identity to grant AKS access permission to the Capacity
     * Reservation Group and the reserved VMs inside.
     *
     * @param vmIdentityProfile the vmIdentityProfile value to set.
     * @return the ManagedClusterAgentPoolProfileProperties object itself.
     */
    public ManagedClusterAgentPoolProfileProperties withVmIdentityProfile(UserAssignedIdentity vmIdentityProfile) {
        this.vmIdentityProfile = vmIdentityProfile;
        return this;
    }
    ...
    public void validate() {
        ...
        if (vmIdentityProfile() != null) {
            vmIdentityProfile().validate();
        }
    }
}
