...
public final class OpenShiftManagedClusterImpl
    ...
    public OpenShiftManagedCluster create() {
        this.innerObject = serviceManager.serviceClient().getOpenShiftManagedClusters()
    ...
    OpenShiftManagedClusterImpl(String name,
    ...
    public OpenShiftManagedCluster apply() {
        this.innerObject = serviceManager.serviceClient().getOpenShiftManagedClusters().updateTags(resourceGroupName,
    ...
    OpenShiftManagedClusterImpl(OpenShiftManagedClusterInner innerObject,
        com.azure.resourcemanager.containerservicemicrosoftcontainerserviceaks.generated.ContainerServiceManager serviceManager) {
