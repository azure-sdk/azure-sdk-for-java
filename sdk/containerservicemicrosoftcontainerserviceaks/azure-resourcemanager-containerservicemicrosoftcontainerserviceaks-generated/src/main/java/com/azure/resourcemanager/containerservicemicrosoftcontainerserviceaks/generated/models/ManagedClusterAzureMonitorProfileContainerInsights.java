...
public final class ManagedClusterAzureMonitorProfileContainerInsights {
    ...
    /**
     * Get the windowsHostLogs property: Windows Host Logs Profile for Kubernetes Windows Nodes Log Collection.
    ...
    /**
     * Set the windowsHostLogs property: Windows Host Logs Profile for Kubernetes Windows Nodes Log Collection.
     * Collects ETW, Event Logs and Text logs etc. See aka.ms/AzureMonitorContainerInsights for an overview.
     * 
     ...
     */
    public ManagedClusterAzureMonitorProfileContainerInsights
        withWindowsHostLogs(ManagedClusterAzureMonitorProfileWindowsHostLogs windowsHostLogs) {
