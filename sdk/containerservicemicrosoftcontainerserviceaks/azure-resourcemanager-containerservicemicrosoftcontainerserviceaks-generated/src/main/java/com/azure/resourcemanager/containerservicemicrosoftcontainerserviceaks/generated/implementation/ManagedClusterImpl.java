...
import com.azure.resourcemanager.containerservicemicrosoftcontainerserviceaks.generated.models.ManagedClusterMetricsProfile;
import com.azure.resourcemanager.containerservicemicrosoftcontainerserviceaks.generated.models.ManagedClusterNodeProvisioningProfile;
import com.azure.resourcemanager.containerservicemicrosoftcontainerserviceaks.generated.models.ManagedClusterNodeResourceGroupProfile;
...
import com.azure.resourcemanager.containerservicemicrosoftcontainerserviceaks.generated.models.SafeguardsProfile;
...
public final class ManagedClusterImpl implements ManagedCluster, ManagedCluster.Definition, ManagedCluster.Update {
    ...
    public ManagedCluster create() {
        this.innerObject = serviceManager.serviceClient().getManagedClusters().createOrUpdate(resourceGroupName,
            resourceName, this.innerModel(), Context.NONE);
        return this;
    }

    public ManagedCluster create(Context context) {
        this.innerObject = serviceManager.serviceClient().getManagedClusters().createOrUpdate(resourceGroupName,
            resourceName, this.innerModel(), context);
        return this;
    }
    ...
    public ManagedCluster apply() {
        this.innerObject = serviceManager.serviceClient().getManagedClusters().updateTags(resourceGroupName,
            resourceName, updateParameters, Context.NONE);
        return this;
    }

    public ManagedCluster apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getManagedClusters().updateTags(resourceGroupName,
            resourceName, updateParameters, context);
        return this;
    }
    ...
    public ManagedCluster refresh() {
        this.innerObject = serviceManager.serviceClient().getManagedClusters()
    ...
    public Response<CredentialResults> listClusterAdminCredentialsWithResponse(String serverFqdn, Context context) {
        return serviceManager.managedClusters().listClusterAdminCredentialsWithResponse(resourceGroupName, resourceName,
            serverFqdn, context);
    }
    ...
    public Response<CredentialResults> listClusterUserCredentialsWithResponse(String serverFqdn, Format format,
        Context context) {
        return serviceManager.managedClusters().listClusterUserCredentialsWithResponse(resourceGroupName, resourceName,
            serverFqdn, format, context);
    }
    ...
    public Response<CredentialResults> listClusterMonitoringUserCredentialsWithResponse(String serverFqdn,
        Context context) {
        return serviceManager.managedClusters().listClusterMonitoringUserCredentialsWithResponse(resourceGroupName,
            resourceName, serverFqdn, context);
    }
