    ...
    interface DefinitionStages {
        ...
        interface WithCreate
            extends DefinitionStages.WithTags,
                ...
                DefinitionStages.WithNodeResourceGroupProfile,
                DefinitionStages.WithEnableRbac,
                DefinitionStages.WithSupportPlan,
                DefinitionStages.WithEnablePodSecurityPolicy,
                DefinitionStages.WithEnableNamespaceResources,
                ...
                DefinitionStages.WithIngressProfile,
                DefinitionStages.WithPublicNetworkAccess,
                DefinitionStages.WithWorkloadAutoScalerProfile,
                DefinitionStages.WithAzureMonitorProfile,
                DefinitionStages.WithGuardrailsProfile,
                DefinitionStages.WithServiceMeshProfile,
                DefinitionStages.WithMetricsProfile,
                DefinitionStages.WithAiToolchainOperatorProfile,
                DefinitionStages.WithNodeProvisioningProfile {
            /**
        ...
        interface WithKubernetesVersion {
             ...
             * run.
             *
             * <p>When you upgrade a supported AKS cluster, Kubernetes minor versions cannot be skipped. All upgrades
             * must be performed sequentially by major version number. For example, upgrades between 1.14.x -&gt; 1.15.x
             ...
             *     <p>When you upgrade a supported AKS cluster, Kubernetes minor versions cannot be skipped. All
             *     upgrades must be performed sequentially by major version number. For example, upgrades between 1.14.x
             *     -&gt; 1.15.x or 1.15.x -&gt; 1.16.x are allowed, however 1.14.x -&gt; 1.16.x is not allowed. See
        ...
        interface WithEnableNamespaceResources {
             ...
             *
             * <p>The default value is false. It can be enabled/disabled on creation and updating of the managed
             * cluster. See [https://aka.ms/NamespaceARMResource](https://aka.ms/NamespaceARMResource) for more details
             * on Namespace as a ARM Resource..
             *
             * @param enableNamespaceResources Enable namespace as Azure resource.
             *     <p>The default value is false. It can be enabled/disabled on creation and updating of the managed
             *     cluster. See [https://aka.ms/NamespaceARMResource](https://aka.ms/NamespaceARMResource) for more
             *     details on Namespace as a ARM Resource.
             * @return the next definition stage.
             */
        ...
        interface WithAiToolchainOperatorProfile {
             ...
             * @return the next definition stage.
             */
            WithCreate withAiToolchainOperatorProfile(
                ManagedClusterAIToolchainOperatorProfile aiToolchainOperatorProfile);
        }
