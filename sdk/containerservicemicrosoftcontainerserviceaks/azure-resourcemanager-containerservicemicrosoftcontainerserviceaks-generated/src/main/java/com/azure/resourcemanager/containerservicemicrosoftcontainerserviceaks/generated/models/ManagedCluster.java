...
public interface ManagedCluster {
    ...
    /**
     * Gets the creationData property: CreationData to be used to specify the source Snapshot ID if the cluster will be
    ...
    /**
     * Gets the kubernetesVersion property: The version of Kubernetes the Managed Cluster is requested to run.
     * 
     * When you upgrade a supported AKS cluster, Kubernetes minor versions cannot be skipped. All upgrades must be
    ...
    /**
     * Gets the nodeResourceGroupProfile property: The node resource group configuration profile.
     * 
    ...
    /**
     * Gets the enableNamespaceResources property: Enable namespace as Azure resource.
     * 
     * The default value is false. It can be enabled/disabled on creation and updating of the managed cluster. See
     ...
     */
    Boolean enableNamespaceResources();
    ...
    /**
     * Gets the azureMonitorProfile property: Prometheus addon profile for the container service cluster.
     * 
    ...
    /**
     * Gets the safeguardsProfile property: The Safeguards profile holds all the safeguards information for a given
     * cluster.
     * 
     * @return the safeguardsProfile value.
     */
    ...
    interface DefinitionStages {
        ...
        interface WithCreate
            ...
            DefinitionStages.WithIdentity, DefinitionStages.WithCreationData, DefinitionStages.WithKubernetesVersion,
            DefinitionStages.WithDnsPrefix, DefinitionStages.WithFqdnSubdomain, DefinitionStages.WithAgentPoolProfiles,
            DefinitionStages.WithLinuxProfile, DefinitionStages.WithWindowsProfile,
            DefinitionStages.WithServicePrincipalProfile, DefinitionStages.WithAddonProfiles,
            DefinitionStages.WithPodIdentityProfile, DefinitionStages.WithOidcIssuerProfile,
            DefinitionStages.WithNodeResourceGroup, DefinitionStages.WithNodeResourceGroupProfile,
            DefinitionStages.WithEnableRbac, DefinitionStages.WithSupportPlan,
            DefinitionStages.WithEnablePodSecurityPolicy, DefinitionStages.WithEnableNamespaceResources,
            DefinitionStages.WithNetworkProfile, DefinitionStages.WithAadProfile,
            ...
            DefinitionStages.WithAzureMonitorProfile, DefinitionStages.WithSafeguardsProfile,
            DefinitionStages.WithServiceMeshProfile, DefinitionStages.WithMetricsProfile,
            DefinitionStages.WithAiToolchainOperatorProfile, DefinitionStages.WithNodeProvisioningProfile {
            /**
        ...
        /**
         * The stage of the ManagedCluster definition allowing to specify creationData.
         */
        interface WithCreationData {
             ...
             * 
             * @param creationData CreationData to be used to specify the source Snapshot ID if the cluster will be
             * created/upgraded using a snapshot.
             * @return the next definition stage.
             */
        ...
        interface WithKubernetesVersion {
            /**
             * Specifies the kubernetesVersion property: The version of Kubernetes the Managed Cluster is requested to
             * run.
             * 
             * When you upgrade a supported AKS cluster, Kubernetes minor versions cannot be skipped. All upgrades must
             * be performed sequentially by major version number. For example, upgrades between 1.14.x -&gt; 1.15.x or
             * 1.15.x -&gt; 1.16.x are allowed, however 1.14.x -&gt; 1.16.x is not allowed. See [upgrading an AKS
             * cluster](https://docs.microsoft.com/azure/aks/upgrade-cluster) for more details..
             * 
             * @param kubernetesVersion The version of Kubernetes the Managed Cluster is requested to run.
             * 
             * When you upgrade a supported AKS cluster, Kubernetes minor versions cannot be skipped. All upgrades must
             * be performed sequentially by major version number. For example, upgrades between 1.14.x -&gt; 1.15.x or
             * 1.15.x -&gt; 1.16.x are allowed, however 1.14.x -&gt; 1.16.x is not allowed. See [upgrading an AKS
        ...
        interface WithPodIdentityProfile {
             ...
             * 
             * See [use AAD pod identity](https://docs.microsoft.com/azure/aks/use-azure-ad-pod-identity) for more
        ...
        interface WithNodeResourceGroupProfile {
            /**
             * Specifies the nodeResourceGroupProfile property: The node resource group configuration profile..
             * 
             * @param nodeResourceGroupProfile The node resource group configuration profile.
             * @return the next definition stage.
             */
        ...
        interface WithEnablePodSecurityPolicy {
             ...
             * PodSecurityPolicy was deprecated in Kubernetes v1.21, and removed from Kubernetes in v1.25. Learn more at
        ...
        /**
         * The stage of the ManagedCluster definition allowing to specify enableNamespaceResources.
         */
        interface WithEnableNamespaceResources {
            /**
             * Specifies the enableNamespaceResources property: Enable namespace as Azure resource.
             * 
             * The default value is false. It can be enabled/disabled on creation and updating of the managed cluster.
             * See [https://aka.ms/NamespaceARMResource](https://aka.ms/NamespaceARMResource) for more details on
             * Namespace as a ARM Resource..
             * 
             * @param enableNamespaceResources Enable namespace as Azure resource.
             * 
             * The default value is false. It can be enabled/disabled on creation and updating of the managed cluster.
             * See [https://aka.ms/NamespaceARMResource](https://aka.ms/NamespaceARMResource) for more details on
             * Namespace as a ARM Resource.
             * @return the next definition stage.
             */
            WithCreate withEnableNamespaceResources(Boolean enableNamespaceResources);
        }
        ...
        interface WithAzureMonitorProfile {
            /**
             * Specifies the azureMonitorProfile property: Prometheus addon profile for the container service cluster.
             * 
             * @param azureMonitorProfile Prometheus addon profile for the container service cluster.
             * @return the next definition stage.
             */
        ...
        /**
         * The stage of the ManagedCluster definition allowing to specify safeguardsProfile.
         */
        interface WithSafeguardsProfile {
            /**
             * Specifies the safeguardsProfile property: The Safeguards profile holds all the safeguards information for
             * a given cluster.
             * 
             * @param safeguardsProfile The Safeguards profile holds all the safeguards information for a given cluster.
             * @return the next definition stage.
             */
            WithCreate withSafeguardsProfile(SafeguardsProfile safeguardsProfile);
        }
