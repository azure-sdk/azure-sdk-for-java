...
public final class AgentPoolsClientImpl implements AgentPoolsClient {
    ...
    public interface AgentPoolsService {
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Flux<ByteBuffer>>> deleteMachines(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
    ...
    public SyncPoller<PollResult<Void>, Void> beginAbortLatestOperation(
        String resourceGroupName, String resourceName, String agentPoolName, Context context) {
        return this
            .beginAbortLatestOperationAsync(resourceGroupName, resourceName, agentPoolName, context)
            .getSyncPoller();
    }
    ...
    private Mono<Void> abortLatestOperationAsync(String resourceGroupName, String resourceName, String agentPoolName) {
        return beginAbortLatestOperationAsync(resourceGroupName, resourceName, agentPoolName)
            .last()
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> abortLatestOperationAsync(
        String resourceGroupName, String resourceName, String agentPoolName, Context context) {
        return beginAbortLatestOperationAsync(resourceGroupName, resourceName, agentPoolName, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<AgentPoolUpgradeProfileInner> getUpgradeProfileAsync(
        String resourceGroupName, String resourceName, String agentPoolName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> deleteMachinesWithResponseAsync(
        String resourceGroupName,
        String resourceName,
        String agentPoolName,
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<Void>, Void> beginDeleteMachinesAsync(
        String resourceGroupName,
        String resourceName,
        String agentPoolName,
        AgentPoolDeleteMachinesParameter machines) {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<Void>, Void> beginDeleteMachines(
        String resourceGroupName,
        String resourceName,
        String agentPoolName,
        AgentPoolDeleteMachinesParameter machines) {
    ...
    public SyncPoller<PollResult<Void>, Void> beginDeleteMachines(
        ...
        Context context) {
        return this
            .beginDeleteMachinesAsync(resourceGroupName, resourceName, agentPoolName, machines, context)
            .getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> deleteMachinesAsync(
        String resourceGroupName,
        String resourceName,
        String agentPoolName,
        AgentPoolDeleteMachinesParameter machines) {
        return beginDeleteMachinesAsync(resourceGroupName, resourceName, agentPoolName, machines)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<Void> deleteMachinesAsync(
        ...
        AgentPoolDeleteMachinesParameter machines,
        Context context) {
        return beginDeleteMachinesAsync(resourceGroupName, resourceName, agentPoolName, machines, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<AgentPoolAvailableVersionsInner> getAvailableAgentPoolVersionsAsync(
        String resourceGroupName, String resourceName) {
