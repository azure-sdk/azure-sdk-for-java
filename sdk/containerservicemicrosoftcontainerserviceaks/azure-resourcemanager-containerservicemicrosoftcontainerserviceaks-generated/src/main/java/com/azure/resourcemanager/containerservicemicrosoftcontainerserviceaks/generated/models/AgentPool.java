...
public interface AgentPool {
     ...
     * by AKS.
     *
     * <p>These taints will not be reconciled by AKS and can be removed with a kubectl call. This field can be modified
    ...
    interface DefinitionStages {
        ...
        interface WithCreate
            extends DefinitionStages.WithTags,
                ...
                DefinitionStages.WithMessageOfTheDay,
                ...
                DefinitionStages.WithEnableCustomCATrust,
                ...
                DefinitionStages.WithNodeInitializationTaints,
                ...
                DefinitionStages.WithCapacityReservationGroupId,
                ...
                DefinitionStages.WithArtifactStreamingProfile {
            /**
        ...
        interface WithMessageOfTheDay {
             ...
             *
             * <p>A base64-encoded string which will be written to /etc/motd after decoding. This allows customization
             * of the message of the day for Linux nodes. It must not be specified for Windows nodes. It must be a
             ...
             *     <p>A base64-encoded string which will be written to /etc/motd after decoding. This allows
        ...
        interface WithOrchestratorVersion {
             ...
             *
             * <p>Both patch version &lt;major.minor.patch&gt; and &lt;major.minor&gt; are supported. When
             ...
             *     <p>Both patch version &lt;major.minor.patch&gt; and &lt;major.minor&gt; are supported. When
             *     &lt;major.minor&gt; is specified, the latest supported patch version is chosen automatically.
             *     Updating the agent pool with the same &lt;major.minor&gt; once it has been created will not trigger
             *     an upgrade, even if a newer patch version is available. As a best practice, you should upgrade all
             *     node pools in an AKS cluster to the same Kubernetes version. The node pool version must have the same
             *     major version as the control plane. The node pool minor version must be within two minor versions of
             *     the control plane version. The node pool version cannot be greater than the control plane version.
             *     For more information see [upgrading a node
             *     pool](https://docs.microsoft.com/azure/aks/use-multiple-node-pools#upgrade-a-node-pool).
             * @return the next definition stage.
             */
        ...
        interface WithEnableCustomCATrust {
             ...
             *
             * <p>When set to true, AKS adds a label to the node indicating that the feature is enabled and deploys a
             ...
             *     <p>When set to true, AKS adds a label to the node indicating that the feature is enabled and deploys
             *     a daemonset along with host services to sync custom certificate authorities from user-provided list
             *     of base64 encoded certificates into node trust stores. Defaults to false.
             * @return the next definition stage.
             */
        ...
        interface WithNodeInitializationTaints {
             ...
             *
             * <p>These taints will not be reconciled by AKS and can be removed with a kubectl call. This field can be
             ...
             *     AKS.
             *     <p>These taints will not be reconciled by AKS and can be removed with a kubectl call. This field can
             *     be modified after node pool is created, but nodes will not be recreated with new taints until another
             *     operation that requires recreation (e.g. node image upgrade) happens. These taints allow for required
             *     configuration to run before the node is ready to accept workloads, for example
    ...
    interface Update
        extends UpdateStages.WithTags,
            ...
            UpdateStages.WithMessageOfTheDay,
            ...
            UpdateStages.WithEnableCustomCATrust,
            ...
            UpdateStages.WithNodeInitializationTaints,
            ...
            UpdateStages.WithCapacityReservationGroupId,
            ...
            UpdateStages.WithGpuProfile,
            UpdateStages.WithArtifactStreamingProfile {
        /**
