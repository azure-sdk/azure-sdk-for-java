...
public interface AgentPool {
    ...
    /**
     * Gets the messageOfTheDay property: Message of the day for Linux nodes, base64-encoded.
     * 
     ...
     * 
     * Both patch version &lt;major.minor.patch&gt; and &lt;major.minor&gt; are supported. When &lt;major.minor&gt; is
    ...
    /**
     * Gets the currentOrchestratorVersion property: The version of Kubernetes running on the Agent Pool.
     * 
     * If orchestratorVersion was a fully specified version &lt;major.minor.patch&gt;, this field will be exactly equal
     * to it. If orchestratorVersion was &lt;major.minor&gt;, this field will contain the full &lt;major.minor.patch&gt;
     * version being used.
     * 
    ...
    /**
     * Gets the nodeInitializationTaints property: Taints added on the nodes during creation that will not be reconciled
     * by AKS.
     * 
     * These taints will not be reconciled by AKS and can be removed with a kubectl call. This field can be modified
     * after node pool is created, but nodes will not be recreated with new taints until another operation that requires
     * recreation (e.g. node image upgrade) happens. These taints allow for required configuration to run before the
     ...
     */
    AgentPoolGpuProfile gpuProfile();
    ...
    interface DefinitionStages {
        ...
        interface WithCreate extends DefinitionStages.WithTags, DefinitionStages.WithCount, DefinitionStages.WithVmSize,
            ...
            DefinitionStages.WithVnetSubnetId, DefinitionStages.WithPodSubnetId, DefinitionStages.WithMaxPods,
            DefinitionStages.WithOsType, DefinitionStages.WithOsSku, DefinitionStages.WithMaxCount,
            DefinitionStages.WithMinCount, DefinitionStages.WithEnableAutoScaling, DefinitionStages.WithScaleDownMode,
            ...
            DefinitionStages.WithVirtualMachineNodesStatus {
            /**
        ...
        interface WithMessageOfTheDay {
            /**
             * Specifies the messageOfTheDay property: Message of the day for Linux nodes, base64-encoded.
             * 
             * A base64-encoded string which will be written to /etc/motd after decoding. This allows customization of
             * the message of the day for Linux nodes. It must not be specified for Windows nodes. It must be a static
             * string (i.e., will be printed raw and not be executed as a script)..
             * 
             * @param messageOfTheDay Message of the day for Linux nodes, base64-encoded.
             * 
             * A base64-encoded string which will be written to /etc/motd after decoding. This allows customization of
             * the message of the day for Linux nodes. It must not be specified for Windows nodes. It must be a static
             * string (i.e., will be printed raw and not be executed as a script).
        ...
        interface WithPodSubnetId {
             ...
             * 
             * If omitted, pod IPs are statically assigned on the node subnet (see vnetSubnetID for more details). This
             * is of the form:
             * /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualNetworks/{virtualNetworkName}/subnets/{subnetName}.
             * 
        ...
        interface WithMode {
             ...
             * 
             * A cluster must have at least one 'System' Agent Pool at all times. For additional information on agent
        ...
        interface WithOrchestratorVersion {
             ...
             * 
             * Both patch version &lt;major.minor.patch&gt; and &lt;major.minor&gt; are supported. When
             * &lt;major.minor&gt; is specified, the latest supported patch version is chosen automatically. Updating
             * the agent pool with the same &lt;major.minor&gt; once it has been created will not trigger an upgrade,
             * even if a newer patch version is available. As a best practice, you should upgrade all node pools in an
        ...
        interface WithEnableNodePublicIp {
             ...
             * 
             * Some scenarios may require nodes in a node pool to receive their own dedicated public IP addresses. A
        ...
        interface WithEnableCustomCATrust {
             ...
             * daemonset along with host services to sync custom certificate authorities from user-provided list of
             * base64 encoded certificates into node trust stores. Defaults to false..
             * 
             * @param enableCustomCATrust Whether to enable Custom CA Trust feature.
             * 
             * When set to true, AKS adds a label to the node indicating that the feature is enabled and deploys a
             * daemonset along with host services to sync custom certificate authorities from user-provided list of
             * base64 encoded certificates into node trust stores. Defaults to false.
        ...
        interface WithScaleSetEvictionPolicy {
             ...
             * 
             * This cannot be specified unless the scaleSetPriority is 'Spot'. If not specified, the default is
             * 'Delete'..
             * 
        ...
        interface WithNodeInitializationTaints {
            /**
             * Specifies the nodeInitializationTaints property: Taints added on the nodes during creation that will not
             * be reconciled by AKS.
             * 
             * These taints will not be reconciled by AKS and can be removed with a kubectl call. This field can be
             * modified after node pool is created, but nodes will not be recreated with new taints until another
             * operation that requires recreation (e.g. node image upgrade) happens. These taints allow for required
             * configuration to run before the node is ready to accept workloads, for example 'key1=value1:NoSchedule'
             * that then can be removed with `kubectl taint nodes node1 key1=value1:NoSchedule-`.
             * 
             * @param nodeInitializationTaints Taints added on the nodes during creation that will not be reconciled by
             * AKS.
             * 
             * These taints will not be reconciled by AKS and can be removed with a kubectl call. This field can be
             * modified after node pool is created, but nodes will not be recreated with new taints until another
        ...
        interface WithCapacityReservationGroupId {
             ...
             * Reservation Group to provide virtual machines from a reserved group of Virtual Machines.
             * 
             * AKS will associate the specified agent pool with the Capacity Reservation Group..
             * 
        ...
        interface WithGpuProfile {
             ...
             * @return the next definition stage.
             */
            WithCreate withGpuProfile(AgentPoolGpuProfile gpuProfile);
        }
    ...
    interface Update extends UpdateStages.WithTags, UpdateStages.WithCount, UpdateStages.WithVmSize,
        ...
        UpdateStages.WithPodSubnetId, UpdateStages.WithMaxPods, UpdateStages.WithOsType, UpdateStages.WithOsSku,
        ...
        UpdateStages.WithAvailabilityZones, UpdateStages.WithEnableNodePublicIp, UpdateStages.WithEnableCustomCATrust,
    ...
    interface UpdateStages {
        ...
        interface WithGpuProfile {
             ...
             * @return the next definition stage.
             */
            Update withGpuProfile(AgentPoolGpuProfile gpuProfile);
        }
