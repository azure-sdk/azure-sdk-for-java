...
public final class AgentPoolInner extends SubResource {
    ...
    public UserAssignedIdentity vmIdentityProfile() {
        return this.innerProperties() == null ? null : this.innerProperties().vmIdentityProfile();
    }
     ...
     * @return the AgentPoolInner object itself.
     */
    public AgentPoolInner withVmIdentityProfile(UserAssignedIdentity vmIdentityProfile) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ManagedClusterAgentPoolProfileProperties();
        }
        this.innerProperties().withVmIdentityProfile(vmIdentityProfile);
        return this;
    }
