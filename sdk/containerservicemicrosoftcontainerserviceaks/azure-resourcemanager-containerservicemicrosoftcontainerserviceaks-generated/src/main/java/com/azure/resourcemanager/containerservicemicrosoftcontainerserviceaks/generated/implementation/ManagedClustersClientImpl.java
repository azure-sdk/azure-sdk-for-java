...
public final class ManagedClustersClientImpl implements ManagedClustersClient {
    ...
    public interface ManagedClustersService {
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<GuardrailsAvailableVersionInner>> getGuardrailsVersions(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("location") String location,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<GuardrailsAvailableVersionsList>> listGuardrailsVersions(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("location") String location,
    ...
    private Mono<Response<OSOptionProfileInner>> getOSOptionsWithResponseAsync(String location, String resourceType) {
        ...
        final String apiVersion = "2023-10-02-preview";
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<RunCommandResultInner> getCommandResultAsync(
        String resourceGroupName, String resourceName, String commandId) {
     ...
     *
     * <p>Contains Guardrails version along with its support info and whether it is a default version.
     *
     * @param location The name of the Azure region.
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<GuardrailsAvailableVersionInner>> getGuardrailsVersionsWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<GuardrailsAvailableVersionInner> getGuardrailsVersionsWithResponse(
        String location, String version, Context context) {
     ...
     *
     * <p>Contains list of Guardrails version along with its support info and whether it is a default version.
     *
     * @param location The name of the Azure region.
     * @throws IllegalArgumentException thrown if parameters fail the validation.
     * @throws ManagementException thrown if the request is rejected by server.
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<GuardrailsAvailableVersionInner>> listGuardrailsVersionsSinglePageAsync(
        String location) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                ...
                context ->
                    service
                        .listGuardrailsVersions(
                            ...
                            accept,
                            context))
            .<PagedResponse<GuardrailsAvailableVersionInner>>map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(),
                        res.getStatusCode(),
    ...
    private PagedFlux<GuardrailsAvailableVersionInner> listGuardrailsVersionsAsync(String location) {
        return new PagedFlux<>(
            () -> listGuardrailsVersionsSinglePageAsync(location),
    ...
    private PagedFlux<GuardrailsAvailableVersionInner> listGuardrailsVersionsAsync(String location, Context context) {
        return new PagedFlux<>(
            () -> listGuardrailsVersionsSinglePageAsync(location, context),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<MeshUpgradeProfileInner> getMeshUpgradeProfileAsync(
        String resourceGroupName, String resourceName, String mode) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<GuardrailsAvailableVersionInner>> listGuardrailsVersionsNextSinglePageAsync(
        String nextLink) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
    ...
    private Mono<PagedResponse<GuardrailsAvailableVersionInner>> listGuardrailsVersionsNextSinglePageAsync(
        ...
        context = this.client.mergeContext(context);
        return service
            .listGuardrailsVersionsNext(nextLink, this.client.getEndpoint(), accept, context)
            .map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(),
