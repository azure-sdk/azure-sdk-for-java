...
import com.azure.resourcemanager.containerservicemicrosoftcontainerserviceaks.generated.models.GuardrailsAvailableVersionsList;
import com.azure.resourcemanager.containerservicemicrosoftcontainerserviceaks.generated.models.ManagedClusterAadProfile;
import com.azure.resourcemanager.containerservicemicrosoftcontainerserviceaks.generated.models.ManagedClusterListResult;
...
import com.azure.resourcemanager.containerservicemicrosoftcontainerserviceaks.generated.models.MeshRevisionProfileList;
import com.azure.resourcemanager.containerservicemicrosoftcontainerserviceaks.generated.models.MeshUpgradeProfileList;
import com.azure.resourcemanager.containerservicemicrosoftcontainerserviceaks.generated.models.OutboundEnvironmentEndpointCollection;
import com.azure.resourcemanager.containerservicemicrosoftcontainerserviceaks.generated.models.RunCommandRequest;
import com.azure.resourcemanager.containerservicemicrosoftcontainerserviceaks.generated.models.SafeguardsAvailableVersionsList;
...
public final class ManagedClustersClientImpl implements ManagedClustersClient {
        ...
        return FluxUtil
            .withContext(
                context -> service.delete(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(),
                    resourceGroupName, resourceName, ignorePodDisruptionBudget, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> deleteWithResponseAsync(String resourceGroupName, String resourceName,
        ...
        return service.delete(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(), resourceGroupName,
            resourceName, ignorePodDisruptionBudget, accept, context);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String resourceName,
        Boolean ignorePodDisruptionBudget, Context context) {
        return this.beginDeleteAsync(resourceGroupName, resourceName, ignorePodDisruptionBudget, context)
            .getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> deleteAsync(String resourceGroupName, String resourceName, Boolean ignorePodDisruptionBudget) {
        return beginDeleteAsync(resourceGroupName, resourceName, ignorePodDisruptionBudget).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String resourceName, Boolean ignorePodDisruptionBudget,
        Context context) {
        return beginDeleteAsync(resourceGroupName, resourceName, ignorePodDisruptionBudget, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
