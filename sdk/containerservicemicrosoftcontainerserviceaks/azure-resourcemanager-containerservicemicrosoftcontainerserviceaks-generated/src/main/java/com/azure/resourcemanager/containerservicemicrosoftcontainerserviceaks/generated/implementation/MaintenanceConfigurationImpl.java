...
public final class MaintenanceConfigurationImpl
    ...
    public MaintenanceConfiguration create() {
        this.innerObject = serviceManager.serviceClient().getMaintenanceConfigurations()
            .createOrUpdateWithResponse(resourceGroupName, resourceName, configName, this.innerModel(), Context.NONE)
            .getValue();
        return this;
    }
    ...
    MaintenanceConfigurationImpl(String name,
    ...
    public MaintenanceConfiguration refresh() {
        this.innerObject = serviceManager.serviceClient().getMaintenanceConfigurations()
            .getWithResponse(resourceGroupName, resourceName, configName, Context.NONE).getValue();
        return this;
    }

    public MaintenanceConfiguration refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getMaintenanceConfigurations()
            .getWithResponse(resourceGroupName, resourceName, configName, context).getValue();
        return this;
    }
    ...
    public MaintenanceConfigurationImpl withMaintenanceWindow(MaintenanceWindow maintenanceWindow) {
