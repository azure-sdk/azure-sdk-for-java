...
public final class OperationStatusResultsClientImpl implements OperationStatusResultsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<OperationStatusResultInner> getAsync(String resourceGroupName, String resourceName,
        String operationId) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<OperationStatusResultInner> getByAgentPoolAsync(String resourceGroupName, String resourceName,
