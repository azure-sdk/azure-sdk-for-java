...
import com.azure.resourcemanager.containerservicemicrosoftcontainerserviceaks.generated.models.ManagedClusterSnapshotListResult;
 ...
 */
public final class ManagedClusterSnapshotsClientImpl implements ManagedClusterSnapshotsClient {
    /**
    ...
    /**
     * The interface defining all the services for ContainerServiceManagementClientManagedClusterSnapshots to be used
    ...
    private PagedFlux<ManagedClusterSnapshotInner> listAsync() {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<ManagedClusterSnapshotInner> listByResourceGroupAsync(String resourceGroupName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ManagedClusterSnapshotInner> getByResourceGroupAsync(String resourceGroupName, String resourceName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ManagedClusterSnapshotInner> createOrUpdateAsync(String resourceGroupName, String resourceName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ManagedClusterSnapshotInner> updateTagsAsync(String resourceGroupName, String resourceName,
