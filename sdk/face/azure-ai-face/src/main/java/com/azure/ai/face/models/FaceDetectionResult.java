...
public final class FaceDetectionResult {
    ...
    @Generated
    @JsonCreator
    private FaceDetectionResult(@JsonProperty(value = "faceId") String faceId) {
        this.faceId = faceId;
    }

    /**
     * Get the faceId property: Unique faceId of the detected face, created by detection API and it will expire 24
    ...
    /**
     * Get the recognitionModel property: The 'recognitionModel' associated with this faceId. This is only returned
     * when 'returnRecognitionModel' is explicitly set as true.
     * 
    ...
    /**
     * Get the faceAttributes property: Face attributes fore detected face.
     * 
