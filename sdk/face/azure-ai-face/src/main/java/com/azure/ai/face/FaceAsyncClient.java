...
public final class FaceAsyncClient {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> detectFromStreamWithResponse(BinaryData imageContent,
        RequestOptions requestOptions) {
        return this.serviceClient.detectFromStreamWithResponseAsync(imageContent, requestOptions);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> verifyWithResponse(BinaryData request, RequestOptions requestOptions) {
        return this.serviceClient.verifyWithResponseAsync(request, requestOptions);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<List<FaceDetectionResult>> detectFromStream(BinaryData imageContent, Boolean returnFaceId,
        ...
        return detectFromStreamWithResponse(imageContent, requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(TYPE_REFERENCE_LIST_FACE_DETECTION_RESULT));
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<List<FaceDetectionResult>> detectFromStream(BinaryData imageContent) {
        // Generated convenience method for detectFromStreamWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return detectFromStreamWithResponse(imageContent, requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(TYPE_REFERENCE_LIST_FACE_DETECTION_RESULT));
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<List<FindSimilarResult>> findSimilar(String faceId, List<String> faceIds,
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<VerifyResult> verify(String faceId1, String faceId2) {
        // Generated convenience method for verifyWithResponse
        RequestOptions requestOptions = new RequestOptions();
        VerifyRequest requestObj = new VerifyRequest(faceId1, faceId2);
        BinaryData request = BinaryData.fromObject(requestObj);
        return verifyWithResponse(request, requestOptions).flatMap(FluxUtil::toMono)
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<GroupResult> group(List<String> faceIds) {
        ...
        return groupWithResponse(request, requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(GroupResult.class));
    }
