...
/**
 * The person in a specified large person group. To add face to this person, please call LargePersonGroup PersonFace -
 * Add.
 */
@Fluent
public final class LargePersonGroupPerson {
    ...
    @Generated
    @JsonCreator
    public LargePersonGroupPerson(@JsonProperty(value = "name") String name) {
        this.name = name;
    }
     ...
     * @return the LargePersonGroupPerson object itself.
     */
    @Generated
    public LargePersonGroupPerson setUserData(String userData) {
