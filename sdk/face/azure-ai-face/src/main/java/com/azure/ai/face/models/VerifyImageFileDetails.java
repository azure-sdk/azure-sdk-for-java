...
/**
 * The file details model for the verifyImage.
 */
@Fluent
public final class VerifyImageFileDetails {
    ...
    /**
     * Creates an instance of VerifyImageFileDetails class.
     * 
     * @param content the content value to set.
     */
    @Generated
    public VerifyImageFileDetails(BinaryData content) {
     ...
     */
    @Generated
    public VerifyImageFileDetails setContentType(String contentType) {
