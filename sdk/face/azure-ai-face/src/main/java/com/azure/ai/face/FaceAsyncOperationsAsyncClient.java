...
public final class FaceAsyncOperationsAsyncClient {
    @Generated
    private final FaceAsyncOperationsImpl serviceClient;

    /**
     * Initializes an instance of FaceAsyncOperationsAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    FaceAsyncOperationsAsyncClient(FaceAsyncOperationsImpl serviceClient) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<AsyncOperationStatus> getStatus(String operationId) {
        // Generated convenience method for getStatusWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getStatusWithResponse(operationId, requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(AsyncOperationStatus.class));
    }
}
