...
public final class Resource {
    ...
    /*
     * Array of PersonDirectory person ids to remove from the DynamicPersonGroup.
     */
    @Generated
    ...
    @Generated
    @JsonCreator
    public Resource(@JsonProperty(value = "name") String name) {
        this.name = name;
    }
    ...
    /**
     * Get the removePersonIds property: Array of PersonDirectory person ids to remove from the DynamicPersonGroup.
     * 
    ...
    /**
     * Set the removePersonIds property: Array of PersonDirectory person ids to remove from the DynamicPersonGroup.
     * 
     * @param removePersonIds the removePersonIds value to set.
     * @return the Resource object itself.
     */
    @Generated
    public Resource setRemovePersonIds(List<String> removePersonIds) {
