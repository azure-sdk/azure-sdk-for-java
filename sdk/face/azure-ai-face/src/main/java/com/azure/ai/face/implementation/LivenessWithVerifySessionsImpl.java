...
/**
 * An instance of this class provides access to all the operations defined in LivenessWithVerifySessions.
 */
public final class LivenessWithVerifySessionsImpl {
    /**
     * The proxy service used to perform REST calls.
     */
    private final LivenessWithVerifySessionsService service;
    ...
    /**
     * Initializes an instance of LivenessWithVerifySessionsImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    LivenessWithVerifySessionsImpl(FaceClientImpl client) {
        this.service = RestProxy.create(LivenessWithVerifySessionsService.class, client.getHttpPipeline(),
    ...
    /**
     * The interface defining all the services for FaceClientLivenessWithVerifySessions to be used by the proxy service
     * to perform REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "FaceClientLivenessWi")
    public interface LivenessWithVerifySessionsService {
        ...
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        @UnexpectedResponseExceptionType(HttpResponseException.class)
        Mono<Response<BinaryData>> createSessionWithVerifyImage(@HostParam("endpoint") String endpoint,
            @PathParam("apiVersion") String apiVersion, @HeaderParam("content-type") String contentType,
            @HeaderParam("accept") String accept,
            @BodyParam("multipart/form-data") BinaryData livenessSessionWithVerifyImageCreationContent,
            RequestOptions requestOptions, Context context);
        ...
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        @UnexpectedResponseExceptionType(HttpResponseException.class)
        Response<BinaryData> createSessionWithVerifyImageSync(@HostParam("endpoint") String endpoint,
            @PathParam("apiVersion") String apiVersion, @HeaderParam("content-type") String contentType,
            @HeaderParam("accept") String accept,
            @BodyParam("multipart/form-data") BinaryData livenessSessionWithVerifyImageCreationContent,
            RequestOptions requestOptions, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> createSessionWithVerifyImageWithResponseAsync(
        BinaryData livenessSessionWithVerifyImageCreationContent, RequestOptions requestOptions) {
        final String contentType = "multipart/form-data";
        final String accept = "application/json";
        return FluxUtil.withContext(context -> service.createSessionWithVerifyImage(this.client.getEndpoint(),
            this.client.getServiceVersion().getVersion(), contentType, accept,
            livenessSessionWithVerifyImageCreationContent, requestOptions, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<BinaryData> createSessionWithVerifyImageWithResponse(
        BinaryData livenessSessionWithVerifyImageCreationContent, RequestOptions requestOptions) {
        final String contentType = "multipart/form-data";
        final String accept = "application/json";
        return service.createSessionWithVerifyImageSync(this.client.getEndpoint(),
            this.client.getServiceVersion().getVersion(), contentType, accept,
            livenessSessionWithVerifyImageCreationContent, requestOptions, Context.NONE);
    }
}
