...
public final class IdentifyFromPersonDirectoryRequest {
    /*
     * Array of query faces faceIds, created by the Face - Detect. Each of the faces are identified independently. The
     * valid number of faceIds is between [1, 10].
     */
    @Generated
    ...
    /*
     * Array of personIds created in PersonDirectory - PersonCreate. The valid number of personIds is between [1,30].
     */
    @Generated
    ...
    /**
     * Get the personIds property: Array of personIds created in PersonDirectory - PersonCreate. The valid number of
