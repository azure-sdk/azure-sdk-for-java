...
/**
 * An instance of this class provides access to all the operations defined in FaceAsyncOperations.
 */
public final class FaceAsyncOperationsImpl {
    /**
     * The proxy service used to perform REST calls.
     */
    private final FaceAsyncOperationsService service;
    ...
    /**
     * Initializes an instance of FaceAsyncOperationsImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    FaceAsyncOperationsImpl(FaceClientImpl client) {
        this.service = RestProxy.create(FaceAsyncOperationsService.class, client.getHttpPipeline(),
    ...
    /**
     * The interface defining all the services for FaceClientFaceAsyncOperations to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "FaceClientFaceAsyncO")
    public interface FaceAsyncOperationsService {
        @Get("/face/{apiVersion}/operations/{operationId}")
        ...
        Mono<Response<BinaryData>> getStatus(@HostParam("endpoint") String endpoint,
            @PathParam("apiVersion") String apiVersion, @PathParam("operationId") String operationId,
