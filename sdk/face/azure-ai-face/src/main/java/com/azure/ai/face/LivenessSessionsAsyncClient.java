...
public final class LivenessSessionsAsyncClient {
    @Generated
    private final LivenessSessionsImpl serviceClient;

    /**
     * Initializes an instance of LivenessSessionsAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    LivenessSessionsAsyncClient(LivenessSessionsImpl serviceClient) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<LivenessSession> getSession(String sessionId) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<List<LivenessSessionAuditEntry>> listSessionAuditEntries(String sessionId, String start, Integer top) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<List<LivenessSessionAuditEntry>> listSessionAuditEntries(String sessionId) {
        // Generated convenience method for listSessionAuditEntriesWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return listSessionAuditEntriesWithResponse(sessionId, requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(TYPE_REFERENCE_LIST_LIVENESS_SESSION_AUDIT_ENTRY));
