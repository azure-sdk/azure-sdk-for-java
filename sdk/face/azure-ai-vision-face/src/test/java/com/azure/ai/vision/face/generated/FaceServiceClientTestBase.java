...
import com.azure.ai.vision.face.PersonDirectoryClient;
...
class FaceServiceClientTestBase extends TestProxyTestBase {
    ...
    protected void beforeTest() {
        FaceServiceClientBuilder faceListClientbuilder = new FaceServiceClientBuilder()
        ...
        if (getTestMode() == TestMode.PLAYBACK) {
            ...
            faceListClientbuilder.credential(new DefaultAzureCredentialBuilder().build());
        }
        faceListClient = faceListClientbuilder.buildFaceListClient();

        FaceServiceClientBuilder largeFaceListClientbuilder = new FaceServiceClientBuilder()
            .endpoint(Configuration.getGlobalConfiguration().get("ENDPOINT", "endpoint"))
            .httpClient(HttpClient.createDefault())
            .httpLogOptions(new HttpLogOptions().setLogLevel(HttpLogDetailLevel.BASIC));
        if (getTestMode() == TestMode.PLAYBACK) {
            ...
            largeFaceListClientbuilder.credential(new DefaultAzureCredentialBuilder().build());
        }
        largeFaceListClient = largeFaceListClientbuilder.buildLargeFaceListClient();

        FaceServiceClientBuilder personGroupClientbuilder = new FaceServiceClientBuilder()
            .endpoint(Configuration.getGlobalConfiguration().get("ENDPOINT", "endpoint"))
            .httpClient(HttpClient.createDefault())
            .httpLogOptions(new HttpLogOptions().setLogLevel(HttpLogDetailLevel.BASIC));
        if (getTestMode() == TestMode.PLAYBACK) {
            ...
            personGroupClientbuilder.credential(new DefaultAzureCredentialBuilder().build());
        }
        personGroupClient = personGroupClientbuilder.buildPersonGroupClient();

        FaceServiceClientBuilder largePersonGroupClientbuilder = new FaceServiceClientBuilder()
            .endpoint(Configuration.getGlobalConfiguration().get("ENDPOINT", "endpoint"))
            .httpClient(HttpClient.createDefault())
            .httpLogOptions(new HttpLogOptions().setLogLevel(HttpLogDetailLevel.BASIC));
        if (getTestMode() == TestMode.PLAYBACK) {
            ...
            largePersonGroupClientbuilder.credential(new DefaultAzureCredentialBuilder().build());
        }
        largePersonGroupClient = largePersonGroupClientbuilder.buildLargePersonGroupClient();

        FaceServiceClientBuilder personDirectoryClientbuilder = new FaceServiceClientBuilder()
            .endpoint(Configuration.getGlobalConfiguration().get("ENDPOINT", "endpoint"))
            .httpClient(HttpClient.createDefault())
            .httpLogOptions(new HttpLogOptions().setLogLevel(HttpLogDetailLevel.BASIC));
        if (getTestMode() == TestMode.PLAYBACK) {
            ...
            personDirectoryClientbuilder.credential(new DefaultAzureCredentialBuilder().build());
        }
        personDirectoryClient = personDirectoryClientbuilder.buildPersonDirectoryClient();
