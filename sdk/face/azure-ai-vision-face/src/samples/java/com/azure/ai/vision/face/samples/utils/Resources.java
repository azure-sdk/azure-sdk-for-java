...
public class Resources {
    ...
    public static final String TEST_IMAGE_PATH_FAMILY1_LADY1 = TEST_IMAGE_BASE_PATH + "Family2-Lady1.jpg";
    public static final String TEST_IMAGE_PATH_FAMILY1_LADY2 = TEST_IMAGE_BASE_PATH + "Family2-Lady2.jpg";
