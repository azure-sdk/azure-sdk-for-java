 ...
 */
@Immutable
public final class LargePersonGroupData {
    /*
    ...
    /**
     * Creates an instance of LargePersonGroupData class.
     * 
     * @param name the name value to set.
     */
    @Generated
    @JsonCreator
    private LargePersonGroupData(@JsonProperty(value = "name") String name) {
        this.name = name;
    }
