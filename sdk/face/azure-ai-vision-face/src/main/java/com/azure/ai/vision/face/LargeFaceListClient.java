...
public final class LargeFaceListClient {
    ...
    public Response<BinaryData> addFaceFromUrlWithResponse(String largeFaceListId, BinaryData addFaceFromUrlRequest2,
        RequestOptions requestOptions) {
        return this.serviceClient.addFaceFromUrlWithResponse(largeFaceListId, addFaceFromUrlRequest2, requestOptions);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public AddFaceResult addFaceFromUrl(String largeFaceListId, String url, List<Integer> targetFace,
        ...
        return addFaceFromUrlWithResponse(largeFaceListId, addFaceFromUrlRequest2, requestOptions).getValue()
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public AddFaceResult addFaceFromUrl(String largeFaceListId, String url) {
        // Generated convenience method for addFaceFromUrlWithResponse
        RequestOptions requestOptions = new RequestOptions();
        AddFaceFromUrlRequest1 addFaceFromUrlRequest2Obj = new AddFaceFromUrlRequest1(url);
        BinaryData addFaceFromUrlRequest2 = BinaryData.fromObject(addFaceFromUrlRequest2Obj);
