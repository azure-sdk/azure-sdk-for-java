...
public final class LivenessSessionItem implements JsonSerializable<LivenessSessionItem> {
     ...
     */
    @Generated
    private LivenessSessionItem(String deviceCorrelationId) {
    ...
    public static LivenessSessionItem fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            LivenessSessionItem deserializedLivenessSessionItem = new LivenessSessionItem(deviceCorrelationId);
            deserializedLivenessSessionItem.id = id;
            deserializedLivenessSessionItem.createdDateTime = createdDateTime;
            deserializedLivenessSessionItem.sessionExpired = sessionExpired;
