...
public final class FaceSessionClientImpl {
    ...
    public interface FaceSessionClientService {
        ...
        Mono<Response<Void>> deleteLivenessSession(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("sessionId") String sessionId,
    ...
    public Mono<Response<BinaryData>> createLivenessSessionWithResponseAsync(BinaryData livenessSessionCreationContent,
        RequestOptions requestOptions) {
        final String accept = "application/json";
        return FluxUtil.withContext(context -> service.createLivenessSession(this.getEndpoint(),
            this.getServiceVersion().getVersion(), accept, livenessSessionCreationContent, requestOptions, context));
    }
    ...
    public Response<BinaryData> createLivenessSessionWithResponse(BinaryData livenessSessionCreationContent,
        ...
        return service.createLivenessSessionSync(this.getEndpoint(), this.getServiceVersion().getVersion(), accept,
            livenessSessionCreationContent, requestOptions, Context.NONE);
    }
    ...
    public Mono<Response<BinaryData>> createLivenessWithVerifySessionWithVerifyImageWithResponseAsync(
        ...
        return FluxUtil
            .withContext(context -> service.createLivenessWithVerifySessionWithVerifyImage(this.getEndpoint(),
                this.getServiceVersion().getVersion(), contentType, accept,
    ...
    public Response<BinaryData> createLivenessWithVerifySessionWithVerifyImageWithResponse(
        ...
        return service.createLivenessWithVerifySessionWithVerifyImageSync(this.getEndpoint(),
            this.getServiceVersion().getVersion(), contentType, accept, livenessSessionWithVerifyImageCreationContent,
            requestOptions, Context.NONE);
    }
