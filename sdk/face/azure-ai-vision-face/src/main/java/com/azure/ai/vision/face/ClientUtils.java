...
class ClientUtils {
    static void addRequireQueryParameters(RequestOptions requestOptions, String parameterName, Object paramterObject) {
    ...
    static void addRequiredQueryParameterForDetection(
    ...
    static void addOptionalQueryParameterForDetection(RequestOptions requestOptions, List<FaceAttributeType> returnFaceAttributes,
