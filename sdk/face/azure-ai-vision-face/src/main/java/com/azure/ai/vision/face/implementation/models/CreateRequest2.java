...
/**
 * The CreateRequest2 model.
 */
@Fluent
public final class CreateRequest2 implements JsonSerializable<CreateRequest2> {
    /*
    ...
    /**
     * Creates an instance of CreateRequest2 class.
     * 
     * @param name the name value to set.
     */
    @Generated
    public CreateRequest2(String name) {
        this.name = name;
    }
     ...
     * @return the CreateRequest2 object itself.
     */
    @Generated
    public CreateRequest2 setUserData(String userData) {
     ...
     */
    @Generated
    public CreateRequest2 setRecognitionModel(FaceRecognitionModel recognitionModel) {
    ...
    /**
     * Reads an instance of CreateRequest2 from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of CreateRequest2 if the JsonReader was pointing to an instance of it, or null if it was
     * pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the CreateRequest2.
     */
    @Generated
    public static CreateRequest2 fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            CreateRequest2 deserializedCreateRequest2 = new CreateRequest2(name);
            deserializedCreateRequest2.userData = userData;
            deserializedCreateRequest2.recognitionModel = recognitionModel;

            return deserializedCreateRequest2;
        });
    }
}
