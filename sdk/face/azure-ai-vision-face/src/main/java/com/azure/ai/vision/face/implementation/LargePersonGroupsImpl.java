...
public final class LargePersonGroupsImpl {
    ...
    public Mono<Response<Void>> createWithResponseAsync(String largePersonGroupId, BinaryData createCollectionOptions,
        RequestOptions requestOptions) {
        final String accept = "application/json";
        return FluxUtil.withContext(
            context -> service.create(this.client.getEndpoint(), this.client.getServiceVersion().getVersion(),
                largePersonGroupId, accept, createCollectionOptions, requestOptions, context));
    }
    ...
    public Response<Void> createWithResponse(String largePersonGroupId, BinaryData createCollectionOptions,
        ...
        return service.createSync(this.client.getEndpoint(), this.client.getServiceVersion().getVersion(),
            largePersonGroupId, accept, createCollectionOptions, requestOptions, Context.NONE);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<Void>> updateWithResponseAsync(String largePersonGroupId,
        ...
        return FluxUtil.withContext(
            context -> service.update(this.client.getEndpoint(), this.client.getServiceVersion().getVersion(),
                largePersonGroupId, accept, userDefinedFieldsForUpdate, requestOptions, context));
    }
    ...
    public Response<Void> updateWithResponse(String largePersonGroupId, BinaryData userDefinedFieldsForUpdate,
        ...
        return service.updateSync(this.client.getEndpoint(), this.client.getServiceVersion().getVersion(),
            largePersonGroupId, accept, userDefinedFieldsForUpdate, requestOptions, Context.NONE);
    }
    ...
    public Mono<Response<BinaryData>> createPersonWithResponseAsync(String largePersonGroupId,
        ...
        return FluxUtil.withContext(
            context -> service.createPerson(this.client.getEndpoint(), this.client.getServiceVersion().getVersion(),
                largePersonGroupId, accept, userDefinedFields, requestOptions, context));
    }
    ...
    public Response<BinaryData> createPersonWithResponse(String largePersonGroupId, BinaryData userDefinedFields,
        ...
        return service.createPersonSync(this.client.getEndpoint(), this.client.getServiceVersion().getVersion(),
            largePersonGroupId, accept, userDefinedFields, requestOptions, Context.NONE);
    }
    ...
    public Mono<Response<Void>> updatePersonWithResponseAsync(String largePersonGroupId, String personId,
        ...
        return FluxUtil.withContext(
            context -> service.updatePerson(this.client.getEndpoint(), this.client.getServiceVersion().getVersion(),
                largePersonGroupId, personId, accept, userDefinedFieldsForUpdate, requestOptions, context));
    }
    ...
    public Response<Void> updatePersonWithResponse(String largePersonGroupId, String personId,
        ...
        return service.updatePersonSync(this.client.getEndpoint(), this.client.getServiceVersion().getVersion(),
            largePersonGroupId, personId, accept, userDefinedFieldsForUpdate, requestOptions, Context.NONE);
    }
    ...
    public Mono<Response<Void>> updateFaceWithResponseAsync(String largePersonGroupId, String personId,
        ...
        return FluxUtil.withContext(
            context -> service.updateFace(this.client.getEndpoint(), this.client.getServiceVersion().getVersion(),
                largePersonGroupId, personId, persistedFaceId, accept, faceUserData, requestOptions, context));
    }
    ...
    public Response<Void> updateFaceWithResponse(String largePersonGroupId, String personId, String persistedFaceId,
        ...
        return service.updateFaceSync(this.client.getEndpoint(), this.client.getServiceVersion().getVersion(),
            largePersonGroupId, personId, persistedFaceId, accept, faceUserData, requestOptions, Context.NONE);
    }
}
