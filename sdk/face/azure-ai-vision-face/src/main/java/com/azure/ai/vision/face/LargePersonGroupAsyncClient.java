...
import com.azure.ai.vision.face.implementation.models.AddFaceFromUrlImplRequest3;
...
public final class LargePersonGroupAsyncClient {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> addFaceFromUrlImplWithResponse(String largePersonGroupId, String personId,
        BinaryData addFaceFromUrlRequest, RequestOptions requestOptions) {
        return this.serviceClient.addFaceFromUrlImplWithResponseAsync(largePersonGroupId, personId,
            addFaceFromUrlRequest, requestOptions);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> addFaceImplWithResponse(String largePersonGroupId, String personId,
        BinaryData imageContent, RequestOptions requestOptions) {
        return this.serviceClient.addFaceImplWithResponseAsync(largePersonGroupId, personId, imageContent,
            requestOptions);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<AddFaceResult> addFaceFromUrlImpl(String largePersonGroupId, String personId, String url,
        ...
        RequestOptions requestOptions = new RequestOptions();
        AddFaceFromUrlImplRequest3 addFaceFromUrlRequestObj = new AddFaceFromUrlImplRequest3(url);
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<AddFaceResult> addFaceImpl(String largePersonGroupId, String personId, BinaryData imageContent,
        List<Integer> targetFace, FaceDetectionModel detectionModel, String userData) {
        ...
        return addFaceImplWithResponse(largePersonGroupId, personId, imageContent, requestOptions)
            .flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(AddFaceResult.class));
    }
