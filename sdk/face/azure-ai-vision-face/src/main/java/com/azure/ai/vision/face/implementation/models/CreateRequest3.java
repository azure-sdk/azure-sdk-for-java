...
/**
 * The CreateRequest3 model.
 */
@Fluent
public final class CreateRequest3 implements JsonSerializable<CreateRequest3> {
    /*
    ...
    /**
     * Creates an instance of CreateRequest3 class.
     * 
     * @param name the name value to set.
     */
    @Generated
    public CreateRequest3(String name) {
        this.name = name;
    }
     ...
     * @return the CreateRequest3 object itself.
     */
    @Generated
    public CreateRequest3 setUserData(String userData) {
     ...
     */
    @Generated
    public CreateRequest3 setRecognitionModel(FaceRecognitionModel recognitionModel) {
    ...
    /**
     * Reads an instance of CreateRequest3 from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of CreateRequest3 if the JsonReader was pointing to an instance of it, or null if it was
     * pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the CreateRequest3.
     */
    @Generated
    public static CreateRequest3 fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            CreateRequest3 deserializedCreateRequest3 = new CreateRequest3(name);
            deserializedCreateRequest3.userData = userData;
            deserializedCreateRequest3.recognitionModel = recognitionModel;

            return deserializedCreateRequest3;
        });
    }
}
