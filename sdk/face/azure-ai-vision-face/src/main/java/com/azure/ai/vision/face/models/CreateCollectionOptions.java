...
/**
 * The CreateCollectionOptions model.
 */
@Fluent
public final class CreateCollectionOptions {
    ...
    /**
     * Creates an instance of CreateCollectionOptions class.
     * 
     * @param name the name value to set.
     */
    @Generated
    @JsonCreator
    public CreateCollectionOptions(@JsonProperty(value = "name") String name) {
        this.name = name;
    }
     ...
     * @return the CreateCollectionOptions object itself.
     */
    @Generated
    public CreateCollectionOptions setUserData(String userData) {
     ...
     */
    @Generated
    public CreateCollectionOptions setRecognitionModel(FaceRecognitionModel recognitionModel) {
