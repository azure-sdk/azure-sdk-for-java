...
public final class FaceClient {
    ...
    public List<FaceDetectionResult> detect(BinaryData imageContent, FaceDetectionModel detectionModel,
                                            ...
                                            List<FaceAttributeType> returnFaceAttributes, Boolean returnFaceLandmarks,
    ...
    public List<FaceDetectionResult> detect(BinaryData imageContent, FaceDetectionModel detectionModel,
                                            FaceRecognitionModel recognitionModel, boolean returnFaceId) {
        return this.detectImpl(imageContent, detectionModel, recognitionModel, returnFaceId, null,
            null, null, null);
    }
    ...
    public List<FaceDetectionResult> detect(String url, DetectOptions options) {
        return this.detect(url, options.getDetectionModel(), options.getRecognitionModel(),
            options.isReturnFaceId(), options.getReturnFaceAttributes(), options.isReturnFaceLandmarks(),
            options.isReturnRecognitionModel(), options.getFaceIdTimeToLive());
    }
    ...
    public List<FaceDetectionResult> detect(String url, FaceDetectionModel detectionModel,
                                                   FaceRecognitionModel recognitionModel, boolean returnFaceId,
                                                   List<FaceAttributeType> returnFaceAttributes,
                                                   Boolean returnFaceLandmarks, Boolean returnRecognitionModel,
    ...
    public List<FaceDetectionResult> detect(String url, FaceDetectionModel detectionModel,
                                                   FaceRecognitionModel recognitionModel, boolean returnFaceId) {
        return this.detect(url, detectionModel, recognitionModel, returnFaceId, null,
            null, null, null);
    }
    ...
    public List<FaceDetectionResult> detect(String url, FaceDetectionModel detectionModel,
                                                   FaceRecognitionModel recognitionModel, boolean returnFaceId,
                                                   List<FaceAttributeType> returnFaceAttributes) {
        return this.detect(url, detectionModel, recognitionModel, returnFaceId, returnFaceAttributes,
            null, null,null);
    }
}
