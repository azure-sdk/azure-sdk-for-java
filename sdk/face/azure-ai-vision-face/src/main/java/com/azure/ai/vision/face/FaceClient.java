...
import com.azure.ai.vision.face.models.DetectFromUrlOptions;
...
public final class FaceClient {
     ...
     * https://azure.microsoft.com/en-us/blog/responsible-ai-investments-and-safeguards-for-facial-recognition/. We will
     * also retire the Snapshot API, which allowed biometric data transfer from one Face subscription to another.
     * Existing customers have until 30 June 2023 to use the emotion, gender, age, smile, facial hair, hair, and makeup
     * attributes and the Snapshot API through Face API before they are retired.
     * 
     * * No image will be stored. Only the extracted face feature(s) will be stored on server. The faceId is an
     * identifier of the face feature and will be used in Face - Identify, Face - Verify, and Face - Find Similar. The
     * stored face features will expire and be deleted at the time specified by faceIdTimeToLive after the original
     * detection call.
     ...
     * * For optimal results when querying Face - Identify, Face - Verify, and Face - Find Similar ('returnFaceId' is
     * true), please use faces that are: frontal, clear, and with a minimum size of 200x200 pixels (100 pixels between
     * eyes).
     ...
     * * 'detection_01': The default detection model for Face - Detect. Recommend for near frontal face detection. For
     * scenarios with exceptionally large angle (head-pose) faces, occluded faces or wrong image orientation, the faces
     ...
     * Face attributes (mask and headPose only) and landmarks are supported if you choose this detection model.
     * * Different 'recognitionModel' values are provided. If follow-up operations like Verify, Identify, Find Similar
     * are needed, please specify the recognition model with 'recognitionModel' parameter. The default value for
     ...
     * * 'recognition_01': The default recognition model for Face - Detect. All those faceIds created before 2019 March
     * are bonded with this recognition model.
     * * 'recognition_02': Recognition model released in 2019 March.
     * * 'recognition_03': Recognition model released in 2020 May.
     * * 'recognition_04': Recognition model released in 2021 February. 'recognition_04' is recommended since its
     * accuracy is improved on faces wearing masks compared with 'recognition_03', and its overall accuracy is improved
    ...
    public Response<BinaryData> detectWithResponse(BinaryData imageContent, RequestOptions requestOptions) {
        return this.serviceClient.detectWithResponse(imageContent, requestOptions);
    }
     ...
     * 
     * The 'recognitionModel' associated with the query face's faceId should be the same as the 'recognitionModel' used
     * by the target faceId array, face list or large face list.
     * <p><strong>Request Body Schema</strong></p>
     * 
     * <pre>{@code
     * {
    ...
    public Response<BinaryData> findSimilarFromFaceListWithResponse(BinaryData request, RequestOptions requestOptions) {
        return this.serviceClient.findSimilarFromFaceListWithResponse(request, requestOptions);
    }
     ...
     * faces in the person group (given by personGroupId) or large person group (given by largePersonGroupId), and
     * return candidate person(s) for that face ranked by similarity confidence. The person group/large person group
     * should be trained to make it ready for identification. See more in PersonGroup - Train and LargePersonGroup -
     * Train.
     * 
     * &gt; [!NOTE]
     ...
     * &gt; * Try Face - Find Similar when you need to find similar faces from a face list/large face list instead of a
    ...
    /**
     * Verify whether one face belongs to a person in person group.
     * 
     * &gt; [!NOTE]
     * &gt; * Higher face image quality means better identification precision. Please consider high-quality faces:
     * frontal, clear, and face size is 200x200 pixels (100 pixels between eyes) or bigger.
    ...
    /**
     * Verify whether one face belongs to a person in large person group.
     * 
     * &gt; [!NOTE]
     * &gt; * Higher face image quality means better identification precision. Please consider high-quality faces:
     * frontal, clear, and face size is 200x200 pixels (100 pixels between eyes) or bigger.
    ...
    /**
     * Verify whether one face belongs to a person directory person.
     * 
     * &gt; [!NOTE]
     * &gt; * Higher face image quality means better identification precision. Please consider high-quality faces:
     * frontal, clear, and face size is 200x200 pixels (100 pixels between eyes) or bigger.
     ...
     * * Group API needs at least 2 candidate faces and 1000 at most. We suggest to try Face - Verify when you only have
     * 2 candidate faces.
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public List<FaceDetectionResult> detect(BinaryData imageContent, Boolean returnFaceId, Boolean returnFaceLandmarks,
        List<FaceAttributeType> returnFaceAttributes, FaceRecognitionModel recognitionModel,
        Boolean returnRecognitionModel, FaceDetectionModel detectionModel, Integer faceIdTimeToLive) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public List<FaceDetectionResult> detect(BinaryData imageContent) {
        // Generated convenience method for detectWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return detectWithResponse(imageContent, requestOptions).getValue()
            .toObject(TYPE_REFERENCE_LIST_FACE_DETECTION_RESULT);
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public List<FaceFindSimilarResult> findSimilarFromFaceList(String faceId, String faceListId,
        Integer maxNumOfCandidatesReturned, FindSimilarMatchMode mode) {
        ...
        FindSimilarFromFaceListRequest requestObj = new FindSimilarFromFaceListRequest(faceId, faceListId)
            ...
            .setMode(mode);
        BinaryData request = BinaryData.fromObject(requestObj);
        return findSimilarFromFaceListWithResponse(request, requestOptions).getValue()
            .toObject(TYPE_REFERENCE_LIST_FACE_FIND_SIMILAR_RESULT);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public List<FaceIdentificationResult> identifyFromPersonGroup(List<String> faceIds, String personGroupId,
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public List<FaceIdentificationResult> identifyFromPersonDirectory(List<String> faceIds, List<String> personIds,
        Integer maxNumOfCandidatesReturned, Double confidenceThreshold) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public List<FaceIdentificationResult> identifyFromDynamicPersonGroup(List<String> faceIds,
     ...
     * is created in PersonGroup - Create.
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public FaceVerificationResult verifyFromPersonGroup(String faceId, String personGroupId, String personId) {
        ...
        BinaryData request = BinaryData.fromObject(requestObj);
        return verifyFromPersonGroupWithResponse(request, requestOptions).getValue()
    ...
    public FaceVerificationResult verifyFromLargePersonGroup(String faceId, String largePersonGroupId,
        ...
        BinaryData request = BinaryData.fromObject(requestObj);
        return verifyFromLargePersonGroupWithResponse(request, requestOptions).getValue()
            .toObject(FaceVerificationResult.class);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public FaceVerificationResult verifyFromPersonDirectory(String faceId, String personId) {
        ...
        BinaryData request = BinaryData.fromObject(requestObj);
        return verifyFromPersonDirectoryWithResponse(request, requestOptions).getValue()
            .toObject(FaceVerificationResult.class);
    }
