...
import static com.azure.ai.vision.face.ClientUtils.addOptionalQueryParameterForDetection;
import static com.azure.ai.vision.face.ClientUtils.addRequiredQueryParameterForDetection;
...
public final class FaceClient {
    ...
    Response<BinaryData> detectFromUrlWithResponse(BinaryData request, RequestOptions requestOptions) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<BinaryData> detectWithResponse(BinaryData imageContent, RequestOptions requestOptions) {
     ...
     * <tr><td>recognitionModel</td><td>String</td><td>No</td><td>The 'recognitionModel' associated with the detected
     * faceIds. Supported 'recognitionModel' values include 'recognition_01', 'recognition_02', 'recognition_03' or
     * 'recognition_04'.'recognition_04' is recommended since its accuracy is improved on faces wearing masks compared
     * with 'recognition_03', and its overall accuracy is improved compared with 'recognition_01' and 'recognition_02'.
     * Allowed values: "recognition_01", "recognition_02", "recognition_03", "recognition_04".</td></tr>
     * <tr><td>returnRecognitionModel</td><td>Boolean</td><td>No</td><td>Return 'recognitionModel' or not. The default
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<BinaryData> detectWithResponse(BinaryData imageContent, FaceDetectionModel detectionModel, FaceRecognitionModel recognitionModel,
        boolean returnFaceId, RequestOptions requestOptions) {
        addRequiredQueryParameterForDetection(requestOptions, detectionModel, recognitionModel, returnFaceId);
        return detectWithResponse(imageContent, requestOptions);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<BinaryData> detectFromUrlWithResponse(BinaryData request, FaceDetectionModel detectionModel, FaceRecognitionModel recognitionModel,
        boolean returnFaceId, RequestOptions requestOptions) {
        addRequiredQueryParameterForDetection(requestOptions, detectionModel, recognitionModel, returnFaceId);
        return detectFromUrlWithResponse(request, requestOptions);
    }
    ...
    public List<FaceDetectionResult> detect(BinaryData imageContent, DetectOptions options) {
        return this.detect(
            imageContent,
            options.getDetectionModel(),
            options.getRecognitionModel(),
            options.isReturnFaceId(),
            options.getReturnFaceAttributes(),
            options.isReturnFaceLandmarks(),
            options.isReturnRecognitionModel(),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public List<FaceDetectionResult> detect(BinaryData imageContent, FaceDetectionModel detectionModel, FaceRecognitionModel recognitionModel,
        ...
        RequestOptions requestOptions = new RequestOptions();
        addRequiredQueryParameterForDetection(requestOptions, detectionModel, recognitionModel, returnFaceId);
        addOptionalQueryParameterForDetection(requestOptions, returnFaceAttributes, returnFaceLandmarks, returnRecognitionModel, faceIdTimeToLive);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public List<FaceDetectionResult> detectFromUrl(String url, DetectOptions options) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public List<FaceDetectionResult> detectFromUrl(String url, FaceDetectionModel detectionModel, FaceRecognitionModel recognitionModel,
        boolean returnFaceId, List<FaceAttributeType> returnFaceAttributes, Boolean returnFaceLandmarks, Boolean returnRecognitionModel,
        Integer faceIdTimeToLive) {
        RequestOptions requestOptions = new RequestOptions();
        addRequiredQueryParameterForDetection(requestOptions, detectionModel, recognitionModel, returnFaceId);
