...
public final class LargeFaceListClient {
    ...
    @Generated
    private final LargeFaceListImpl serviceClient;
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<BinaryData> addFaceFromUrlImplWithResponse(BinaryData addFaceFromUrlRequest,
        RequestOptions requestOptions) {
        return this.serviceClient.addFaceFromUrlImplWithResponse(addFaceFromUrlRequest, requestOptions);
    }
    ...
    public Response<Void> updateFaceWithResponse(String persistedFaceId, BinaryData updateFaceRequest,
        RequestOptions requestOptions) {
        return this.serviceClient.updateFaceWithResponse(persistedFaceId, updateFaceRequest, requestOptions);
    }
    ...
    AddFaceResult addFaceFromUrlImpl(String url, List<Integer> targetFace, FaceDetectionModel detectionModel,
        ...
        return addFaceFromUrlImplWithResponse(addFaceFromUrlRequest, requestOptions).getValue()
    ...
    public void updateFace(String persistedFaceId, String userData) {
        ...
        updateFaceWithResponse(persistedFaceId, updateFaceRequest, requestOptions).getValue();
    }
     ...
     */
    @Generated
    LargeFaceListClient(LargeFaceListImpl serviceClient) {
