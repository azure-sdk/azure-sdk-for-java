...
public final class LargePersonGroupClient {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public AddFaceResult addFaceFromUrlImpl(String largePersonGroupId, String personId, String url,
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public AddFaceResult addFaceImpl(String largePersonGroupId, String personId, BinaryData imageContent,
        List<Integer> targetFace, FaceDetectionModel detectionModel, String userData) {
