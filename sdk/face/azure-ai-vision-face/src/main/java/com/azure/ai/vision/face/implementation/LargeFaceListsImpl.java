...
public final class LargeFaceListsImpl {
    ...
    public interface LargeFaceListsService {
        ...
        Mono<Response<Void>> create(@HostParam("endpoint") String endpoint, @HostParam("apiVersion") String apiVersion,
            ...
            @BodyParam("application/json") BinaryData createRequest2, RequestOptions requestOptions, Context context);
        ...
        Mono<Response<Void>> update(@HostParam("endpoint") String endpoint, @HostParam("apiVersion") String apiVersion,
            @PathParam("largeFaceListId") String largeFaceListId, @HeaderParam("accept") String accept,
            @BodyParam("application/json") BinaryData updateRequest2, RequestOptions requestOptions, Context context);
        ...
        Mono<Response<BinaryData>> addFaceFromUrl(@HostParam("endpoint") String endpoint,
            @HostParam("apiVersion") String apiVersion, @PathParam("largeFaceListId") String largeFaceListId,
            @HeaderParam("accept") String accept, @BodyParam("application/json") BinaryData addFaceFromUrlRequest2,
            RequestOptions requestOptions, Context context);
        ...
        Mono<Response<Void>> updateFace(@HostParam("endpoint") String endpoint,
            @HostParam("apiVersion") String apiVersion, @PathParam("largeFaceListId") String largeFaceListId,
            @PathParam("persistedFaceId") String persistedFaceId, @HeaderParam("accept") String accept,
            @BodyParam("application/json") BinaryData updateFaceRequest2, RequestOptions requestOptions,
            Context context);
    ...
    public Mono<Response<Void>> createWithResponseAsync(String largeFaceListId, BinaryData createRequest2,
        RequestOptions requestOptions) {
        final String accept = "application/json";
        return FluxUtil.withContext(
            context -> service.create(this.client.getEndpoint(), this.client.getServiceVersion().getVersion(),
                largeFaceListId, accept, createRequest2, requestOptions, context));
    }
    ...
    public Response<Void> createWithResponse(String largeFaceListId, BinaryData createRequest2,
        ...
        return service.createSync(this.client.getEndpoint(), this.client.getServiceVersion().getVersion(),
            largeFaceListId, accept, createRequest2, requestOptions, Context.NONE);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<Void>> updateWithResponseAsync(String largeFaceListId, BinaryData updateRequest2,
        RequestOptions requestOptions) {
        final String accept = "application/json";
        return FluxUtil.withContext(
            context -> service.update(this.client.getEndpoint(), this.client.getServiceVersion().getVersion(),
                largeFaceListId, accept, updateRequest2, requestOptions, context));
    }
    ...
    public Response<Void> updateWithResponse(String largeFaceListId, BinaryData updateRequest2,
        ...
        return service.updateSync(this.client.getEndpoint(), this.client.getServiceVersion().getVersion(),
            largeFaceListId, accept, updateRequest2, requestOptions, Context.NONE);
    }
    ...
    public Mono<Response<BinaryData>> addFaceFromUrlWithResponseAsync(String largeFaceListId,
        ...
        return FluxUtil.withContext(
            context -> service.addFaceFromUrl(this.client.getEndpoint(), this.client.getServiceVersion().getVersion(),
                largeFaceListId, accept, addFaceFromUrlRequest2, requestOptions, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<BinaryData> addFaceFromUrlWithResponse(String largeFaceListId, BinaryData addFaceFromUrlRequest2,
        RequestOptions requestOptions) {
        final String accept = "application/json";
        return service.addFaceFromUrlSync(this.client.getEndpoint(), this.client.getServiceVersion().getVersion(),
            largeFaceListId, accept, addFaceFromUrlRequest2, requestOptions, Context.NONE);
    }
    ...
    public Mono<Response<Void>> updateFaceWithResponseAsync(String largeFaceListId, String persistedFaceId,
        ...
        return FluxUtil.withContext(
            context -> service.updateFace(this.client.getEndpoint(), this.client.getServiceVersion().getVersion(),
                largeFaceListId, persistedFaceId, accept, updateFaceRequest2, requestOptions, context));
    }
    ...
    public Response<Void> updateFaceWithResponse(String largeFaceListId, String persistedFaceId,
        ...
        return service.updateFaceSync(this.client.getEndpoint(), this.client.getServiceVersion().getVersion(),
            largeFaceListId, persistedFaceId, accept, updateFaceRequest2, requestOptions, Context.NONE);
    }
