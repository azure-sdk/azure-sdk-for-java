...
public final class PersonGroupAsyncClient {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    Mono<Response<BinaryData>> addFaceFromUrlImplWithResponse(String personGroupId, String personId,
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    Mono<Response<BinaryData>> addFaceImplWithResponse(String personGroupId, String personId, BinaryData imageContent,
        RequestOptions requestOptions) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    Mono<AddFaceResult> addFaceFromUrlImpl(String personGroupId, String personId, String url, List<Integer> targetFace,
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    Mono<AddFaceResult> addFaceFromUrlImpl(String personGroupId, String personId, String url) {
        // Generated convenience method for addFaceFromUrlImplWithResponse
        RequestOptions requestOptions = new RequestOptions();
        AddFaceFromUrlRequest1 addFaceFromUrlRequest1Obj = new AddFaceFromUrlRequest1(url);
        BinaryData addFaceFromUrlRequest1 = BinaryData.fromObject(addFaceFromUrlRequest1Obj);
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    Mono<AddFaceResult> addFaceImpl(String personGroupId, String personId, BinaryData imageContent,
