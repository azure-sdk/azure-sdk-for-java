...
public final class FindSimilarRequest implements JsonSerializable<FindSimilarRequest> {
    ...
    /*
     * An array of candidate faceIds. All of them are created by Face - Detect and the faceIds will expire 24 hours after the detection call. The number of faceIds is limited to 1000.
     */
    @Generated
     ...
     * will expire 24 hours after the detection call. The number of faceIds is limited to 1000.
     * 
