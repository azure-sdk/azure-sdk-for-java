...
public final class PersonGroupsImpl {
    ...
    public interface PersonGroupsService {
        ...
        Mono<Response<Void>> updateFace(@HostParam("endpoint") String endpoint,
            @HostParam("apiVersion") String apiVersion, @PathParam("personGroupId") String personGroupId,
            @PathParam("personId") String personId, @PathParam("persistedFaceId") String persistedFaceId,
            @HeaderParam("accept") String accept, @BodyParam("application/json") BinaryData faceUserData,
            RequestOptions requestOptions, Context context);
    ...
    public Mono<Response<Void>> createWithResponseAsync(String personGroupId, BinaryData createCollectionOptions,
        RequestOptions requestOptions) {
        final String accept = "application/json";
        return FluxUtil.withContext(
            context -> service.create(this.client.getEndpoint(), this.client.getServiceVersion().getVersion(),
                personGroupId, accept, createCollectionOptions, requestOptions, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<Void> createWithResponse(String personGroupId, BinaryData createCollectionOptions,
        RequestOptions requestOptions) {
        final String accept = "application/json";
        return service.createSync(this.client.getEndpoint(), this.client.getServiceVersion().getVersion(),
            personGroupId, accept, createCollectionOptions, requestOptions, Context.NONE);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<Void>> updateWithResponseAsync(String personGroupId, BinaryData userDefinedFieldsForUpdate,
        RequestOptions requestOptions) {
        final String accept = "application/json";
        return FluxUtil.withContext(
            context -> service.update(this.client.getEndpoint(), this.client.getServiceVersion().getVersion(),
                personGroupId, accept, userDefinedFieldsForUpdate, requestOptions, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<Void> updateWithResponse(String personGroupId, BinaryData userDefinedFieldsForUpdate,
        RequestOptions requestOptions) {
        final String accept = "application/json";
        return service.updateSync(this.client.getEndpoint(), this.client.getServiceVersion().getVersion(),
            personGroupId, accept, userDefinedFieldsForUpdate, requestOptions, Context.NONE);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> createPersonWithResponseAsync(String personGroupId, BinaryData userDefinedFields,
        RequestOptions requestOptions) {
        final String accept = "application/json";
        return FluxUtil.withContext(
            context -> service.createPerson(this.client.getEndpoint(), this.client.getServiceVersion().getVersion(),
                personGroupId, accept, userDefinedFields, requestOptions, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<BinaryData> createPersonWithResponse(String personGroupId, BinaryData userDefinedFields,
        RequestOptions requestOptions) {
        final String accept = "application/json";
        return service.createPersonSync(this.client.getEndpoint(), this.client.getServiceVersion().getVersion(),
            personGroupId, accept, userDefinedFields, requestOptions, Context.NONE);
    }
    ...
    public Mono<Response<Void>> updatePersonWithResponseAsync(String personGroupId, String personId,
        ...
        return FluxUtil.withContext(
            context -> service.updatePerson(this.client.getEndpoint(), this.client.getServiceVersion().getVersion(),
                personGroupId, personId, accept, userDefinedFieldsForUpdate, requestOptions, context));
    }
    ...
    public Response<Void> updatePersonWithResponse(String personGroupId, String personId,
        ...
        return service.updatePersonSync(this.client.getEndpoint(), this.client.getServiceVersion().getVersion(),
            personGroupId, personId, accept, userDefinedFieldsForUpdate, requestOptions, Context.NONE);
    }
    ...
    public Mono<Response<Void>> updateFaceWithResponseAsync(String personGroupId, String personId,
        ...
        return FluxUtil.withContext(
            context -> service.updateFace(this.client.getEndpoint(), this.client.getServiceVersion().getVersion(),
                personGroupId, personId, persistedFaceId, accept, faceUserData, requestOptions, context));
    }
    ...
    public Response<Void> updateFaceWithResponse(String personGroupId, String personId, String persistedFaceId,
        ...
        return service.updateFaceSync(this.client.getEndpoint(), this.client.getServiceVersion().getVersion(),
            personGroupId, personId, persistedFaceId, accept, faceUserData, requestOptions, Context.NONE);
    }
}
