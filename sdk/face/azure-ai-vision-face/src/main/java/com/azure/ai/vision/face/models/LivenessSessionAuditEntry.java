...
public final class LivenessSessionAuditEntry implements JsonSerializable<LivenessSessionAuditEntry> {
     ...
     */
    @Generated
    private final SessionAuditEntryRequestInfo request;

    /*
     * The response of this entry.
     */
    @Generated
    private final SessionAuditEntryResponseInfo response;
    ...
    private LivenessSessionAuditEntry(long id, String sessionId, String requestId, String clientRequestId,
        OffsetDateTime receivedDateTime, SessionAuditEntryRequestInfo request, SessionAuditEntryResponseInfo response,
        String digest) {
        this.id = id;
    ...
    public static LivenessSessionAuditEntry fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            SessionAuditEntryRequestInfo request = null;
            SessionAuditEntryResponseInfo response = null;
            String digest = null;
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("id".equals(fieldName)) {
                    ...
                    request = SessionAuditEntryRequestInfo.fromJson(reader);
                } else if ("response".equals(fieldName)) {
                    response = SessionAuditEntryResponseInfo.fromJson(reader);
