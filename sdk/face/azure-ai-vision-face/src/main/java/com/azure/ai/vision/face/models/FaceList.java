 ...
 */
@Immutable
public final class FaceList implements JsonSerializable<FaceList> {
    /*
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeArrayField("persistedFaces", this.persistedFaces,
            (writer, element) -> writer.writeJson(element));
        return jsonWriter.writeEndObject();
    }

    /**
     * Reads an instance of FaceList from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of FaceList if the JsonReader was pointing to an instance of it, or null if it was pointing
     * to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the FaceList.
     */
    @Generated
    public static FaceList fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            String name = null;
            String faceListId = null;
            String userData = null;
            FaceRecognitionModel recognitionModel = null;
            List<FaceListFace> persistedFaces = null;
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                } else if ("persistedFaces".equals(fieldName)) {
                    persistedFaces = reader.readArray(reader1 -> FaceListFace.fromJson(reader1));
                } else {
                    reader.skipChildren();
                }
            }
            FaceList deserializedFaceList = new FaceList(name);
            deserializedFaceList.faceListId = faceListId;
            deserializedFaceList.userData = userData;
            deserializedFaceList.recognitionModel = recognitionModel;
            deserializedFaceList.persistedFaces = persistedFaces;

            return deserializedFaceList;
        });
    }
}
