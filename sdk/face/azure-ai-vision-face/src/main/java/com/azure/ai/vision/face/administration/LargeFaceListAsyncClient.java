...
/**
 * Initializes a new instance of the asynchronous LargeFaceList type.
 */
...
public final class LargeFaceListAsyncClient {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    Mono<Response<BinaryData>> addFaceFromUrlImplWithResponse(BinaryData addFaceFromUrlRequest,
        RequestOptions requestOptions) {
        return this.serviceClient.addFaceFromUrlImplWithResponseAsync(addFaceFromUrlRequest, requestOptions);
    }
    ...
    Mono<AddFaceResult> addFaceFromUrlImpl(String url, List<Integer> targetFace, FaceDetectionModel detectionModel,
        ...
        return addFaceFromUrlImplWithResponse(addFaceFromUrlRequest, requestOptions).flatMap(FluxUtil::toMono)
     ...
     */
    @Generated
    LargeFaceListAsyncClient(LargeFaceListImpl serviceClient) {
