...
public final class FaceListClient {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<BinaryData> addFaceFromUrlImplWithResponse(String faceListId, BinaryData addFaceFromUrlRequest3,
        RequestOptions requestOptions) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<BinaryData> addFaceImplWithResponse(String faceListId, BinaryData imageContent,
        RequestOptions requestOptions) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    AddFaceResult addFaceFromUrlImpl(String faceListId, String url, List<Integer> targetFace,
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    AddFaceResult addFaceFromUrlImpl(String faceListId, String url) {
        // Generated convenience method for addFaceFromUrlImplWithResponse
        RequestOptions requestOptions = new RequestOptions();
        AddFaceFromUrlRequest3 addFaceFromUrlRequest3Obj = new AddFaceFromUrlRequest3(url);
        BinaryData addFaceFromUrlRequest3 = BinaryData.fromObject(addFaceFromUrlRequest3Obj);
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    AddFaceResult addFaceImpl(String faceListId, BinaryData imageContent, List<Integer> targetFace,
        FaceDetectionModel detectionModel, String userData) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    AddFaceResult addFaceImpl(String faceListId, BinaryData imageContent) {
        // Generated convenience method for addFaceImplWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return addFaceImplWithResponse(faceListId, imageContent, requestOptions).getValue()
            .toObject(AddFaceResult.class);
