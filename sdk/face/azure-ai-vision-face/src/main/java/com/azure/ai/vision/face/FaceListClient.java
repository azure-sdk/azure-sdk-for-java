...
public final class FaceListClient {
    ...
    public Response<Void> createWithResponse(String faceListId, BinaryData createRequest3,
        ...
        return this.serviceClient.createWithResponse(faceListId, createRequest3, requestOptions);
    }
    ...
    public Response<Void> updateWithResponse(String faceListId, BinaryData updateRequest3,
        RequestOptions requestOptions) {
        return this.serviceClient.updateWithResponse(faceListId, updateRequest3, requestOptions);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<BinaryData> addFaceFromUrlWithResponse(String faceListId, BinaryData addFaceFromUrlRequest3,
        RequestOptions requestOptions) {
        return this.serviceClient.addFaceFromUrlWithResponse(faceListId, addFaceFromUrlRequest3, requestOptions);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public void create(String faceListId, String name, String userData, FaceRecognitionModel recognitionModel) {
        // Generated convenience method for createWithResponse
        RequestOptions requestOptions = new RequestOptions();
        CreateRequest createRequest3Obj
        ...
        createWithResponse(faceListId, createRequest3, requestOptions).getValue();
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public void create(String faceListId, String name) {
        // Generated convenience method for createWithResponse
        RequestOptions requestOptions = new RequestOptions();
        CreateRequest createRequest3Obj = new CreateRequest(name);
        BinaryData createRequest3 = BinaryData.fromObject(createRequest3Obj);
        createWithResponse(faceListId, createRequest3, requestOptions).getValue();
    }
    ...
    public FaceList get(String faceListId, Boolean returnRecognitionModel) {
        ...
        return getWithResponse(faceListId, requestOptions).getValue().toObject(FaceList.class);
    }
    ...
    public void update(String faceListId, String name, String userData) {
        ...
        RequestOptions requestOptions = new RequestOptions();
        UpdateRequest updateRequest3Obj = new UpdateRequest().setName(name).setUserData(userData);
        BinaryData updateRequest3 = BinaryData.fromObject(updateRequest3Obj);
        updateWithResponse(faceListId, updateRequest3, requestOptions).getValue();
    }
    ...
    public void update(String faceListId) {
        // Generated convenience method for updateWithResponse
        RequestOptions requestOptions = new RequestOptions();
        UpdateRequest updateRequest3Obj = new UpdateRequest();
        BinaryData updateRequest3 = BinaryData.fromObject(updateRequest3Obj);
        updateWithResponse(faceListId, updateRequest3, requestOptions).getValue();
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public AddFaceResult addFaceFromUrl(String faceListId, String url, List<Integer> targetFace,
        FaceDetectionModel detectionModel, String userData) {
        // Generated convenience method for addFaceFromUrlWithResponse
        RequestOptions requestOptions = new RequestOptions();
        AddFaceFromUrlRequest addFaceFromUrlRequest3Obj = new AddFaceFromUrlRequest(url);
        ...
        return addFaceFromUrlWithResponse(faceListId, addFaceFromUrlRequest3, requestOptions).getValue()
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public AddFaceResult addFaceFromUrl(String faceListId, String url) {
        // Generated convenience method for addFaceFromUrlWithResponse
        RequestOptions requestOptions = new RequestOptions();
        AddFaceFromUrlRequest addFaceFromUrlRequest3Obj = new AddFaceFromUrlRequest(url);
        BinaryData addFaceFromUrlRequest3 = BinaryData.fromObject(addFaceFromUrlRequest3Obj);
