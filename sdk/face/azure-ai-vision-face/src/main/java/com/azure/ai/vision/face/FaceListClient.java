...
import com.azure.ai.vision.face.implementation.models.AddFaceFromUrlImplRequest;
...
public final class FaceListClient {
    ...
    public Response<BinaryData> addFaceFromUrlImplWithResponse(String faceListId, BinaryData addFaceFromUrlRequest3,
        RequestOptions requestOptions) {
        return this.serviceClient.addFaceFromUrlImplWithResponse(faceListId, addFaceFromUrlRequest3, requestOptions);
    }
    ...
    public Response<BinaryData> addFaceImplWithResponse(String faceListId, BinaryData imageContent,
        RequestOptions requestOptions) {
        return this.serviceClient.addFaceImplWithResponse(faceListId, imageContent, requestOptions);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public AddFaceResult addFaceFromUrlImpl(String faceListId, String url, List<Integer> targetFace,
        FaceDetectionModel detectionModel, String userData) {
        // Generated convenience method for addFaceFromUrlImplWithResponse
        RequestOptions requestOptions = new RequestOptions();
        AddFaceFromUrlImplRequest addFaceFromUrlRequest3Obj = new AddFaceFromUrlImplRequest(url);
        ...
        return addFaceFromUrlImplWithResponse(faceListId, addFaceFromUrlRequest3, requestOptions).getValue()
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public AddFaceResult addFaceFromUrlImpl(String faceListId, String url) {
        // Generated convenience method for addFaceFromUrlImplWithResponse
        RequestOptions requestOptions = new RequestOptions();
        AddFaceFromUrlImplRequest addFaceFromUrlRequest3Obj = new AddFaceFromUrlImplRequest(url);
        BinaryData addFaceFromUrlRequest3 = BinaryData.fromObject(addFaceFromUrlRequest3Obj);
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public AddFaceResult addFaceImpl(String faceListId, BinaryData imageContent, List<Integer> targetFace,
        FaceDetectionModel detectionModel, String userData) {
        ...
        return addFaceImplWithResponse(faceListId, imageContent, requestOptions).getValue()
            .toObject(AddFaceResult.class);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public AddFaceResult addFaceImpl(String faceListId, BinaryData imageContent) {
        // Generated convenience method for addFaceImplWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return addFaceImplWithResponse(faceListId, imageContent, requestOptions).getValue()
            .toObject(AddFaceResult.class);
