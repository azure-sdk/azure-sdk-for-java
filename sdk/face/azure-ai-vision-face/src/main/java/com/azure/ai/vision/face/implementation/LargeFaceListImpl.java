...
public final class LargeFaceListImpl {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> addFaceFromUrlImplWithResponseAsync(BinaryData addFaceFromUrlRequest,
        RequestOptions requestOptions) {
        final String contentType = "application/json";
        final String accept = "application/json";
        return FluxUtil.withContext(
            context -> service.addFaceFromUrlImpl(this.getEndpoint(), this.getServiceVersion().getVersion(),
                this.getLargeFaceListId(), contentType, accept, addFaceFromUrlRequest, requestOptions, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<BinaryData> addFaceFromUrlImplWithResponse(BinaryData addFaceFromUrlRequest,
        RequestOptions requestOptions) {
        final String contentType = "application/json";
        final String accept = "application/json";
        return service.addFaceFromUrlImplSync(this.getEndpoint(), this.getServiceVersion().getVersion(),
            this.getLargeFaceListId(), contentType, accept, addFaceFromUrlRequest, requestOptions, Context.NONE);
    }
