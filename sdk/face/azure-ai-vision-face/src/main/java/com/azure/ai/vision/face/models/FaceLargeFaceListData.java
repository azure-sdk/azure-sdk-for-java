 ...
 */
@Immutable
public final class FaceLargeFaceListData {
    /*
    ...
    /**
     * Creates an instance of FaceLargeFaceListData class.
     * 
     * @param name the name value to set.
     */
    @Generated
    @JsonCreator
    private FaceLargeFaceListData(@JsonProperty(value = "name") String name) {
        this.name = name;
    }
