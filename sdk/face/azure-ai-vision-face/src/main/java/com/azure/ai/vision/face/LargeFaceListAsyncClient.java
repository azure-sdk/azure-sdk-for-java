...
public final class LargeFaceListAsyncClient {
    ...
    public Mono<Response<BinaryData>> addFaceFromUrlWithResponse(String largeFaceListId,
        BinaryData addFaceFromUrlRequest2, RequestOptions requestOptions) {
        return this.serviceClient.addFaceFromUrlWithResponseAsync(largeFaceListId, addFaceFromUrlRequest2,
            requestOptions);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> create(String largeFaceListId, String name, String userData,
        FaceRecognitionModel recognitionModel) {
        // Generated convenience method for createWithResponse
        RequestOptions requestOptions = new RequestOptions();
        CreateRequest1 createRequest2Obj
    ...
    public Mono<Void> create(String largeFaceListId, String name) {
        // Generated convenience method for createWithResponse
        RequestOptions requestOptions = new RequestOptions();
        CreateRequest1 createRequest2Obj = new CreateRequest1(name);
        BinaryData createRequest2 = BinaryData.fromObject(createRequest2Obj);
        return createWithResponse(largeFaceListId, createRequest2, requestOptions).flatMap(FluxUtil::toMono);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<LargeFaceList> get(String largeFaceListId) {
        // Generated convenience method for getWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getWithResponse(largeFaceListId, requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(LargeFaceList.class));
    ...
    public Mono<Void> update(String largeFaceListId, String name, String userData) {
        ...
        RequestOptions requestOptions = new RequestOptions();
        UpdateRequest1 updateRequest2Obj = new UpdateRequest1().setName(name).setUserData(userData);
    ...
    public Mono<Void> update(String largeFaceListId) {
        // Generated convenience method for updateWithResponse
        RequestOptions requestOptions = new RequestOptions();
        UpdateRequest1 updateRequest2Obj = new UpdateRequest1();
        BinaryData updateRequest2 = BinaryData.fromObject(updateRequest2Obj);
        return updateWithResponse(largeFaceListId, updateRequest2, requestOptions).flatMap(FluxUtil::toMono);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<AddFaceResult> addFaceFromUrl(String largeFaceListId, String url, List<Integer> targetFace,
        FaceDetectionModel detectionModel, String userData) {
        // Generated convenience method for addFaceFromUrlWithResponse
        RequestOptions requestOptions = new RequestOptions();
        AddFaceFromUrlRequest1 addFaceFromUrlRequest2Obj = new AddFaceFromUrlRequest1(url);
        ...
        return addFaceFromUrlWithResponse(largeFaceListId, addFaceFromUrlRequest2, requestOptions)
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<AddFaceResult> addFaceFromUrl(String largeFaceListId, String url) {
        // Generated convenience method for addFaceFromUrlWithResponse
        RequestOptions requestOptions = new RequestOptions();
        AddFaceFromUrlRequest1 addFaceFromUrlRequest2Obj = new AddFaceFromUrlRequest1(url);
        BinaryData addFaceFromUrlRequest2 = BinaryData.fromObject(addFaceFromUrlRequest2Obj);
    ...
    public Mono<Void> updateFace(String largeFaceListId, String persistedFaceId, String userData) {
        ...
        RequestOptions requestOptions = new RequestOptions();
        UpdateFaceRequest updateFaceRequest2Obj = new UpdateFaceRequest().setUserData(userData);
    ...
    public Mono<Void> updateFace(String largeFaceListId, String persistedFaceId) {
        // Generated convenience method for updateFaceWithResponse
        RequestOptions requestOptions = new RequestOptions();
        UpdateFaceRequest updateFaceRequest2Obj = new UpdateFaceRequest();
        BinaryData updateFaceRequest2 = BinaryData.fromObject(updateFaceRequest2Obj);
        return updateFaceWithResponse(largeFaceListId, persistedFaceId, updateFaceRequest2, requestOptions)
            .flatMap(FluxUtil::toMono);
    }
