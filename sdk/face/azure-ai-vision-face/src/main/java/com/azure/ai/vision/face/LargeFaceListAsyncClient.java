...
import com.azure.ai.vision.face.implementation.models.AddFaceFromUrlImplRequest1;
...
public final class LargeFaceListAsyncClient {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> addFaceFromUrlImplWithResponse(String largeFaceListId,
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> addFaceImplWithResponse(String largeFaceListId, BinaryData imageContent,
        RequestOptions requestOptions) {
        return this.serviceClient.addFaceImplWithResponseAsync(largeFaceListId, imageContent, requestOptions);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<AddFaceResult> addFaceFromUrlImpl(String largeFaceListId, String url, List<Integer> targetFace,
        FaceDetectionModel detectionModel, String userData) {
        // Generated convenience method for addFaceFromUrlImplWithResponse
        RequestOptions requestOptions = new RequestOptions();
        AddFaceFromUrlImplRequest1 addFaceFromUrlRequest2Obj = new AddFaceFromUrlImplRequest1(url);
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<AddFaceResult> addFaceFromUrlImpl(String largeFaceListId, String url) {
        // Generated convenience method for addFaceFromUrlImplWithResponse
        RequestOptions requestOptions = new RequestOptions();
        AddFaceFromUrlImplRequest1 addFaceFromUrlRequest2Obj = new AddFaceFromUrlImplRequest1(url);
        BinaryData addFaceFromUrlRequest2 = BinaryData.fromObject(addFaceFromUrlRequest2Obj);
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<AddFaceResult> addFaceImpl(String largeFaceListId, BinaryData imageContent, List<Integer> targetFace,
        FaceDetectionModel detectionModel, String userData) {
        ...
        return addFaceImplWithResponse(largeFaceListId, imageContent, requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(AddFaceResult.class));
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<AddFaceResult> addFaceImpl(String largeFaceListId, BinaryData imageContent) {
        // Generated convenience method for addFaceImplWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return addFaceImplWithResponse(largeFaceListId, imageContent, requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(AddFaceResult.class));
