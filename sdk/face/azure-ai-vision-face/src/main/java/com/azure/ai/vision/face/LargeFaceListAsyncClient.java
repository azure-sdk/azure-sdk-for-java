...
public final class LargeFaceListAsyncClient {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    Mono<Response<BinaryData>> addFaceImplWithResponse(String largeFaceListId, BinaryData imageContent,
        RequestOptions requestOptions) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    Mono<AddFaceResult> addFaceFromUrlImpl(String largeFaceListId, String url, List<Integer> targetFace,
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    Mono<AddFaceResult> addFaceImpl(String largeFaceListId, BinaryData imageContent, List<Integer> targetFace,
        FaceDetectionModel detectionModel, String userData) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    Mono<AddFaceResult> addFaceImpl(String largeFaceListId, BinaryData imageContent) {
        // Generated convenience method for addFaceImplWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return addFaceImplWithResponse(largeFaceListId, imageContent, requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(AddFaceResult.class));
