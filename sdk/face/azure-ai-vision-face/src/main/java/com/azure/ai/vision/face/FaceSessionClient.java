...
public final class FaceSessionClient {
    ...
    public Response<BinaryData> createLivenessSessionWithResponse(BinaryData livenessSessionCreationContent,
        RequestOptions requestOptions) {
        return this.serviceClient.createLivenessSessionWithResponse(livenessSessionCreationContent, requestOptions);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<BinaryData> createLivenessWithVerifySessionWithResponse(BinaryData livenessSessionCreationContent,
        RequestOptions requestOptions) {
        return this.serviceClient.createLivenessWithVerifySessionWithResponse(livenessSessionCreationContent,
            requestOptions);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public LivenessSessionCreationResult
        ...
        return createLivenessSessionWithResponse(BinaryData.fromObject(livenessSessionCreationContent), requestOptions)
            .getValue()
            .toObject(LivenessSessionCreationResult.class);
    }
    ...
    public LivenessSessionCreationResult
        ...
        return createLivenessWithVerifySessionWithResponse(BinaryData.fromObject(livenessSessionCreationContent),
            requestOptions).getValue().toObject(LivenessSessionCreationResult.class);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public LivenessSessionCreationResult createLivenessWithVerifySessionWithVerifyImage(
        ...
        return createLivenessWithVerifySessionWithVerifyImageWithResponse(new MultipartFormDataHelper(requestOptions)
            ...
            .end()
            .getRequestBody(), requestOptions).getValue().toObject(LivenessSessionCreationResult.class);
    }
