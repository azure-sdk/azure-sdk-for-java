...
public final class FaceAsyncClient {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    Mono<List<FaceDetectionResult>> detectFromUrl(DetectFromUrlOptions options) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    Mono<List<FaceDetectionResult>> detect(BinaryData imageContent, Boolean returnFaceId, Boolean returnFaceLandmarks,
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    Mono<List<FaceDetectionResult>> detect(BinaryData imageContent) {
        // Generated convenience method for detectWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return detectWithResponse(imageContent, requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(TYPE_REFERENCE_LIST_FACE_DETECTION_RESULT));
