...
public final class FaceAsyncClient {
    ...
    public Mono<Response<BinaryData>> detectFromUrlWithResponse(BinaryData request, RequestOptions requestOptions) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> detectWithResponse(BinaryData imageContent, RequestOptions requestOptions) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<List<FaceDetectionResult>> detectFromUrl(DetectFromUrlOptions options) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<List<FaceDetectionResult>> detect(BinaryData imageContent, Boolean returnFaceId,
        Boolean returnFaceLandmarks, List<FaceAttributeType> returnFaceAttributes,
        FaceRecognitionModel recognitionModel, Boolean returnRecognitionModel, FaceDetectionModel detectionModel,
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<List<FaceDetectionResult>> detect(BinaryData imageContent) {
        // Generated convenience method for detectWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return detectWithResponse(imageContent, requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(TYPE_REFERENCE_LIST_FACE_DETECTION_RESULT));
