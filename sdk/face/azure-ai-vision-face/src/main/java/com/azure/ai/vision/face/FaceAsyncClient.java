...
public final class FaceAsyncClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Mono<Response<BinaryData>> detectWithResponse(BinaryData imageContent, FaceDetectionModel detectionModel, FaceRecognitionModel recognitionModel,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> detectFromUrlWithResponse(BinaryData request, FaceDetectionModel detectionModel, FaceRecognitionModel recognitionModel,
        boolean returnFaceId, RequestOptions requestOptions) {
        addRequiredQueryParameterForDetection(requestOptions, detectionModel, recognitionModel, returnFaceId);
        return this.serviceClient.detectFromUrlWithResponseAsync(request, requestOptions);
    }
    ...
    public Mono<List<FaceDetectionResult>> detect(BinaryData imageContent, FaceDetectionModel detectionModel, FaceRecognitionModel recognitionModel,
        ...
        return this.detect(imageContent, detectionModel, recognitionModel, returnFaceId, null,  null,
            null, null);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono< List<FaceDetectionResult>> detectFromUrl(String url, FaceDetectionModel detectionModel, FaceRecognitionModel recognitionModel,
        boolean returnFaceId, List<FaceAttributeType> returnFaceAttributes, Boolean returnFaceLandmarks, Boolean returnRecognitionModel,
        Integer faceIdTimeToLive) {
        RequestOptions requestOptions = new RequestOptions();
        addRequiredQueryParameterForDetection(requestOptions, detectionModel, recognitionModel, returnFaceId);
