 ...
 */
@Immutable
public final class TrainingResult implements JsonSerializable<TrainingResult> {
    /*
    ...
    /**
     * Creates an instance of TrainingResult class.
     * 
     ...
     */
    @Generated
    private TrainingResult(OperationStatus status, OffsetDateTime createdDateTime, OffsetDateTime lastActionDateTime,
        OffsetDateTime lastSuccessfulTrainingDateTime) {
        this.status = status;
    ...
    /**
     * Reads an instance of TrainingResult from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of TrainingResult if the JsonReader was pointing to an instance of it, or null if it was
     * pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the TrainingResult.
     */
    @Generated
    public static TrainingResult fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            TrainingResult deserializedTrainingResult
                = new TrainingResult(status, createdDateTime, lastActionDateTime, lastSuccessfulTrainingDateTime);
            deserializedTrainingResult.message = message;

            return deserializedTrainingResult;
        });
    }
}
