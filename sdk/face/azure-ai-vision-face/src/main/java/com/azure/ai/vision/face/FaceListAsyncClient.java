...
public final class FaceListAsyncClient {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> addFaceFromUrlImplWithResponse(String faceListId,
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> addFaceImplWithResponse(String faceListId, BinaryData imageContent,
        RequestOptions requestOptions) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<AddFaceResult> addFaceFromUrlImpl(String faceListId, String url, List<Integer> targetFace,
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<AddFaceResult> addFaceFromUrlImpl(String faceListId, String url) {
        // Generated convenience method for addFaceFromUrlImplWithResponse
        RequestOptions requestOptions = new RequestOptions();
        AddFaceFromUrlImplRequest addFaceFromUrlRequest3Obj = new AddFaceFromUrlImplRequest(url);
        BinaryData addFaceFromUrlRequest3 = BinaryData.fromObject(addFaceFromUrlRequest3Obj);
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<AddFaceResult> addFaceImpl(String faceListId, BinaryData imageContent, List<Integer> targetFace,
        FaceDetectionModel detectionModel, String userData) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<AddFaceResult> addFaceImpl(String faceListId, BinaryData imageContent) {
        // Generated convenience method for addFaceImplWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return addFaceImplWithResponse(faceListId, imageContent, requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(AddFaceResult.class));
