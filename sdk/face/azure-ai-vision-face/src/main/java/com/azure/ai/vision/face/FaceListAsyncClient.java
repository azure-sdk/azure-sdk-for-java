...
public final class FaceListAsyncClient {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> addFaceFromUrlWithResponse(String faceListId, BinaryData addFaceFromUrlRequest3,
        RequestOptions requestOptions) {
        return this.serviceClient.addFaceFromUrlWithResponseAsync(faceListId, addFaceFromUrlRequest3, requestOptions);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<AddFaceResult> addFaceFromUrl(String faceListId, String url, List<Integer> targetFace,
        ...
        return addFaceFromUrlWithResponse(faceListId, addFaceFromUrlRequest3, requestOptions).flatMap(FluxUtil::toMono)
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<AddFaceResult> addFaceFromUrl(String faceListId, String url) {
        // Generated convenience method for addFaceFromUrlWithResponse
        RequestOptions requestOptions = new RequestOptions();
        AddFaceFromUrlRequest addFaceFromUrlRequest3Obj = new AddFaceFromUrlRequest(url);
        BinaryData addFaceFromUrlRequest3 = BinaryData.fromObject(addFaceFromUrlRequest3Obj);
