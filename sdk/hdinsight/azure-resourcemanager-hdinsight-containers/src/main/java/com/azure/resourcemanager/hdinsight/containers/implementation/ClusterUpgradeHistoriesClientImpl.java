...
public final class ClusterUpgradeHistoriesClientImpl implements ClusterUpgradeHistoriesClient {
    ...
    /**
     * The interface defining all the services for HDInsightContainersManagementClientClusterUpgradeHistories to be
    ...
    public interface ClusterUpgradeHistoriesService {
        ...
        Mono<Response<ClusterUpgradeHistoryListResult>> list(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ClusterUpgradeHistoryListResult>> listNext(
    ...
    private Mono<PagedResponse<ClusterUpgradeHistoryInner>> listSinglePageAsync(String resourceGroupName,
        ...
        return FluxUtil
            ...
            .<PagedResponse<ClusterUpgradeHistoryInner>>map(res -> new PagedResponseBase<>(res.getRequest(),
    ...
    private PagedFlux<ClusterUpgradeHistoryInner> listAsync(String resourceGroupName, String clusterPoolName,
        String clusterName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<ClusterUpgradeHistoryInner> list(String resourceGroupName, String clusterPoolName,
        String clusterName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<ClusterUpgradeHistoryInner>> listNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<ClusterUpgradeHistoryInner>> listNextSinglePageAsync(String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        if (this.client.getEndpoint() == null) {
