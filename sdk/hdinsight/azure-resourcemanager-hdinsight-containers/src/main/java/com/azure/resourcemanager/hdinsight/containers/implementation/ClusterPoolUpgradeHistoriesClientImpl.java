...
public final class ClusterPoolUpgradeHistoriesClientImpl implements ClusterPoolUpgradeHistoriesClient {
    ...
    public interface ClusterPoolUpgradeHistoriesService {
        ...
        Mono<Response<ClusterPoolUpgradeHistoryListResult>> list(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ClusterPoolUpgradeHistoryListResult>> listNext(
    ...
    private Mono<PagedResponse<ClusterPoolUpgradeHistoryInner>> listSinglePageAsync(String resourceGroupName,
        ...
        return FluxUtil
            ...
            .<PagedResponse<ClusterPoolUpgradeHistoryInner>>map(res -> new PagedResponseBase<>(res.getRequest(),
    ...
    private PagedFlux<ClusterPoolUpgradeHistoryInner> listAsync(String resourceGroupName, String clusterPoolName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<ClusterPoolUpgradeHistoryInner> list(String resourceGroupName, String clusterPoolName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<ClusterPoolUpgradeHistoryInner>> listNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
