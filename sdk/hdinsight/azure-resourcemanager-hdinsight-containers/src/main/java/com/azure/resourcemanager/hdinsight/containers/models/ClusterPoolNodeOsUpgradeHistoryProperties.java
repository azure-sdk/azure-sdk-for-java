        ...
        if (utcTime() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property utcTime in model ClusterPoolNodeOsUpgradeHistoryProperties"));
        }
        if (upgradeResult() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property upgradeResult in model ClusterPoolNodeOsUpgradeHistoryProperties"));
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(ClusterPoolNodeOsUpgradeHistoryProperties.class);
