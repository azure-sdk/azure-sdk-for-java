        ...
        if (subnetId() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property subnetId in model ClusterPoolResourcePropertiesNetworkProfile"));
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(ClusterPoolResourcePropertiesNetworkProfile.class);
