        ...
        if (utcTime() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property utcTime in model ClusterHotfixUpgradeHistoryProperties"));
        }
        if (upgradeResult() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property upgradeResult in model ClusterHotfixUpgradeHistoryProperties"));
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(ClusterHotfixUpgradeHistoryProperties.class);
