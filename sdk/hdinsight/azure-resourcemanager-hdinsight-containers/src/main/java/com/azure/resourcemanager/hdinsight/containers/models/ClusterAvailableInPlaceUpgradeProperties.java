...
@JsonTypeInfo(
    ...
    defaultImpl = ClusterAvailableInPlaceUpgradeProperties.class)
@JsonTypeName("ClusterAvailableInPlaceUpgradeProperties")
@JsonSubTypes({
    @JsonSubTypes.Type(name = "HotfixUpgrade", value = ClusterAvailableUpgradeHotfixUpgradeProperties.class),
    @JsonSubTypes.Type(
        name = "PatchVersionUpgrade",
        value = ClusterAvailableUpgradePatchVersionUpgradeProperties.class) })
@Fluent
