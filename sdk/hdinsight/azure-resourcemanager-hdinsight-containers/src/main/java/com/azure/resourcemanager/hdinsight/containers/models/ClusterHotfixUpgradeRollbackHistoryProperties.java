        ...
        if (utcTime() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property utcTime in model ClusterHotfixUpgradeRollbackHistoryProperties"));
        }
        if (upgradeResult() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property upgradeResult in model ClusterHotfixUpgradeRollbackHistoryProperties"));
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(ClusterHotfixUpgradeRollbackHistoryProperties.class);
