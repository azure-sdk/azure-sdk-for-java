...
public interface ClusterPool {
    ...
    interface DefinitionStages {
         ...
         */
        interface WithCreate extends DefinitionStages.WithTags, DefinitionStages.WithManagedResourceGroupName,
            DefinitionStages.WithClusterPoolProfile, DefinitionStages.WithComputeProfile,
            DefinitionStages.WithNetworkProfile, DefinitionStages.WithLogAnalyticsProfile {
            /**
     ...
     * @return cluster pool.
     */
    ClusterPool upgrade(ClusterPoolUpgrade clusterPoolUpgradeRequest);
     ...
     * @return cluster pool.
     */
    ClusterPool upgrade(ClusterPoolUpgrade clusterPoolUpgradeRequest, Context context);
}
