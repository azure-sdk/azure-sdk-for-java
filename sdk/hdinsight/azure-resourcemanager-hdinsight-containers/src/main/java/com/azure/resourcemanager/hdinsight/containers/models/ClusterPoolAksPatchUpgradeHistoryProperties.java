        ...
        if (utcTime() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property utcTime in model ClusterPoolAksPatchUpgradeHistoryProperties"));
        }
        if (upgradeResult() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property upgradeResult in model ClusterPoolAksPatchUpgradeHistoryProperties"));
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(ClusterPoolAksPatchUpgradeHistoryProperties.class);
