...
/**
 * Result of the request to list HDInsight operations. It contains a list of operations and a URL link to get the next
 * set of results.
 */
@Fluent
public final class OperationListResult {
    ...
    /**
     * Set the value property: The list of HDInsight operations supported by the HDInsight resource provider.
     *
