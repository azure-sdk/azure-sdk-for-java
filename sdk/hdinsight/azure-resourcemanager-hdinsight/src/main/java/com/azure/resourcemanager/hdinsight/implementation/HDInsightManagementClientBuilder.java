...
public final class HDInsightManagementClientBuilder {
    /*
     * The subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms
     ...
     */
    public HDInsightManagementClientBuilder subscriptionId(String subscriptionId) {
     ...
     * @return the HDInsightManagementClientBuilder.
     */
    public HDInsightManagementClientBuilder endpoint(String endpoint) {
     ...
     * @return the HDInsightManagementClientBuilder.
     */
    public HDInsightManagementClientBuilder serializerAdapter(SerializerAdapter serializerAdapter) {
