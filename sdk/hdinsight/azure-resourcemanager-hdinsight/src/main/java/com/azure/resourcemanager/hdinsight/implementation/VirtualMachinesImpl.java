...
public final class VirtualMachinesImpl implements VirtualMachines {
    ...
    public Response<List<HostInfo>> listHostsWithResponse(String resourceGroupName, String clusterName,
        Context context) {
        ...
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(), inner.getValue()
                .stream().map(inner1 -> new HostInfoImpl(inner1, this.manager())).collect(Collectors.toList()));
        } else {
            return null;
        }
    }
    ...
    public Response<AsyncOperationResult> getAsyncOperationStatusWithResponse(String resourceGroupName,
