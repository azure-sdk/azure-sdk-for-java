...
public final class ClustersUpdateGatewaySettingsSamples {
     ...
     */
    /**
     * Sample code: Enable update Entra User Information in an existing Entra User enabled HDInsight cluster.
     * 
     * @param manager Entry point to HDInsightManager.
     */
    public static void enableUpdateEntraUserInformationInAnExistingEntraUserEnabledHDInsightCluster(
        com.azure.resourcemanager.hdinsight.HDInsightManager manager) {
        manager.clusters()
