...
public interface NetworkSecurityPerimeterConfigurationsClient {
    ...
    Response<NetworkSecurityPerimeterConfigurationListResultInner> listByIotHubWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    NetworkSecurityPerimeterConfigurationListResultInner listByIotHub(String resourceGroupName, String resourceName);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    NetworkSecurityPerimeterConfigurationInner get(String resourceGroupName, String resourceName, String nspConfigName);
