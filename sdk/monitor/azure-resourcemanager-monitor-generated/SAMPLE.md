...
public final class MetricsOperationListAtSubscriptionScopeSamples {
    ...
    public static void getSubscriptionLevelMetricData(com.azure.resourcemanager.monitor.generated.MonitorManager manager) {
        manager.metricsOperations().listAtSubscriptionScopeWithResponse("westus2", "2021-06-08T19:00:00Z/2021-06-12T01:00:00Z", Duration.parse("PT6H"), "Data Disk Max Burst IOPS", "count", 10, "count desc", "LUN eq '0' and Microsoft.ResourceId eq '*'", null, "microsoft.compute/virtualmachines", true, false, com.azure.core.util.Context.NONE);
    }
    ...
    public static void getSubscriptionLevelMetricMetadata(com.azure.resourcemanager.monitor.generated.MonitorManager manager) {
        manager.metricsOperations().listAtSubscriptionScopeWithResponse("westus2", "2021-06-10T02:23:16.129Z/2021-06-12T02:23:16.129Z", null, "Data Disk Max Burst IOPS", null, null, null, "LUN eq '0'", MetricResultType.fromString("metadata"), "microsoft.compute/virtualmachines", null, null, com.azure.core.util.Context.NONE);
    }
}
```
...
public final class MetricsOperationListAtSubscriptionScopePostSamples {
    ...
    public static void postRequestForSubscriptionLevelMetricData(com.azure.resourcemanager.monitor.generated.MonitorManager manager) {
        manager.metricsOperations().listAtSubscriptionScopePostWithResponse("westus2", "2021-06-08T19:00:00Z/2021-06-12T01:00:00Z", Duration.parse("PT6H"), "Data Disk Max Burst IOPS", "count", 10, "count desc", "LUN eq '0' and Microsoft.ResourceId eq '*'", null, "microsoft.compute/virtualmachines", true, false, null, com.azure.core.util.Context.NONE);
    }
    ...
    public static void postRequestForSubscriptionLevelMetricMetadata(com.azure.resourcemanager.monitor.generated.MonitorManager manager) {
        manager.metricsOperations().listAtSubscriptionScopePostWithResponse("westus2", "2021-06-10T02:23:16.129Z/2021-06-12T02:23:16.129Z", null, "Data Disk Max Burst IOPS", null, null, null, "LUN eq '0'", MetricResultType.fromString("metadata"), "microsoft.compute/virtualmachines", null, null, null, com.azure.core.util.Context.NONE);
    }
