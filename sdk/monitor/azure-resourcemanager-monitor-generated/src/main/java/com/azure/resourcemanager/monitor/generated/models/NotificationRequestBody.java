...
public final class NotificationRequestBody {
     ...
     */
    @JsonProperty(value = "incidentReceivers")
    private List<IncidentReceiver> incidentReceivers;
     ...
     */
    public List<IncidentReceiver> incidentReceivers() {
     ...
     * @return the NotificationRequestBody object itself.
     */
    public NotificationRequestBody withIncidentReceivers(List<IncidentReceiver> incidentReceivers) {
