 ...
 */
@Fluent
public final class SubscriptionScopeMetricDefinitionInner
    implements JsonSerializable<SubscriptionScopeMetricDefinitionInner> {
    /*
    ...
    /**
     * Creates an instance of SubscriptionScopeMetricDefinitionInner class.
     */
    public SubscriptionScopeMetricDefinitionInner() {
    }
     ...
     * @return the SubscriptionScopeMetricDefinitionInner object itself.
     */
    public SubscriptionScopeMetricDefinitionInner withIsDimensionRequired(Boolean isDimensionRequired) {
     ...
     * @return the SubscriptionScopeMetricDefinitionInner object itself.
     */
    public SubscriptionScopeMetricDefinitionInner withResourceId(String resourceId) {
     ...
     * @return the SubscriptionScopeMetricDefinitionInner object itself.
     */
    public SubscriptionScopeMetricDefinitionInner withNamespace(String namespace) {
     ...
     * @return the SubscriptionScopeMetricDefinitionInner object itself.
     */
    public SubscriptionScopeMetricDefinitionInner withName(LocalizableString name) {
        this.name = name;
        return this;
    }
     ...
     * @return the SubscriptionScopeMetricDefinitionInner object itself.
     */
    public SubscriptionScopeMetricDefinitionInner withDisplayDescription(String displayDescription) {
     ...
     * @return the SubscriptionScopeMetricDefinitionInner object itself.
     */
    public SubscriptionScopeMetricDefinitionInner withCategory(String category) {
     ...
     * @return the SubscriptionScopeMetricDefinitionInner object itself.
     */
    public SubscriptionScopeMetricDefinitionInner withMetricClass(MetricClass metricClass) {
     ...
     * @return the SubscriptionScopeMetricDefinitionInner object itself.
     */
    public SubscriptionScopeMetricDefinitionInner withUnit(MetricUnit unit) {
        this.unit = unit;
        return this;
    }
     ...
     */
    public SubscriptionScopeMetricDefinitionInner
        withPrimaryAggregationType(MetricAggregationType primaryAggregationType) {
     ...
     * @return the SubscriptionScopeMetricDefinitionInner object itself.
     */
    public SubscriptionScopeMetricDefinitionInner withId(String id) {
        this.id = id;
        return this;
    }
     ...
     * @return the SubscriptionScopeMetricDefinitionInner object itself.
     */
    public SubscriptionScopeMetricDefinitionInner withDimensions(List<LocalizableString> dimensions) {
    ...
    /**
     * Reads an instance of SubscriptionScopeMetricDefinitionInner from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of SubscriptionScopeMetricDefinitionInner if the JsonReader was pointing to an instance of
     * it, or null if it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the SubscriptionScopeMetricDefinitionInner.
     */
    public static SubscriptionScopeMetricDefinitionInner fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            SubscriptionScopeMetricDefinitionInner deserializedSubscriptionScopeMetricDefinitionInner
                = new SubscriptionScopeMetricDefinitionInner();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("isDimensionRequired".equals(fieldName)) {
                    deserializedSubscriptionScopeMetricDefinitionInner.isDimensionRequired
                        = reader.getNullable(JsonReader::getBoolean);
                } else if ("resourceId".equals(fieldName)) {
                    deserializedSubscriptionScopeMetricDefinitionInner.resourceId = reader.getString();
                } else if ("namespace".equals(fieldName)) {
                    deserializedSubscriptionScopeMetricDefinitionInner.namespace = reader.getString();
                } else if ("name".equals(fieldName)) {
                    deserializedSubscriptionScopeMetricDefinitionInner.name = LocalizableString.fromJson(reader);
                } else if ("displayDescription".equals(fieldName)) {
                    deserializedSubscriptionScopeMetricDefinitionInner.displayDescription = reader.getString();
                } else if ("category".equals(fieldName)) {
                    deserializedSubscriptionScopeMetricDefinitionInner.category = reader.getString();
                } else if ("metricClass".equals(fieldName)) {
                    deserializedSubscriptionScopeMetricDefinitionInner.metricClass
                        = MetricClass.fromString(reader.getString());
                } else if ("unit".equals(fieldName)) {
                    deserializedSubscriptionScopeMetricDefinitionInner.unit = MetricUnit.fromString(reader.getString());
                } else if ("primaryAggregationType".equals(fieldName)) {
                    deserializedSubscriptionScopeMetricDefinitionInner.primaryAggregationType
                    ...
                    deserializedSubscriptionScopeMetricDefinitionInner.supportedAggregationTypes
                    ...
                    deserializedSubscriptionScopeMetricDefinitionInner.metricAvailabilities = metricAvailabilities;
                } else if ("id".equals(fieldName)) {
                    deserializedSubscriptionScopeMetricDefinitionInner.id = reader.getString();
                } else if ("dimensions".equals(fieldName)) {
                    List<LocalizableString> dimensions
                        = reader.readArray(reader1 -> LocalizableString.fromJson(reader1));
                    deserializedSubscriptionScopeMetricDefinitionInner.dimensions = dimensions;
                } else {
                    reader.skipChildren();
                }
            }

            return deserializedSubscriptionScopeMetricDefinitionInner;
        });
    }
}
