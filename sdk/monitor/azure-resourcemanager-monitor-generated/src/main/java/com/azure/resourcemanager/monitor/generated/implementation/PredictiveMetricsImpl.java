...
public final class PredictiveMetricsImpl implements PredictiveMetrics {
    ...
    public PredictiveResponse get(String resourceGroupName, String autoscaleSettingName, String aggregation) {
        PredictiveResponseInner inner = this.serviceClient().get(resourceGroupName, autoscaleSettingName, aggregation);
        if (inner != null) {
