...
public final class ActionGroupResourceImpl
    ...
    public List<IncidentReceiver> incidentReceivers() {
        List<IncidentReceiver> inner = this.innerModel().incidentReceivers();
        if (inner != null) {
            return Collections.unmodifiableList(inner);
        } else {
            return Collections.emptyList();
    ...
    public ActionGroupResourceImpl withIncidentReceivers(List<IncidentReceiver> incidentReceivers) {
