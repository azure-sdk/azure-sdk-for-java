...
public final class OperationsClientImpl implements OperationsClient {
    ...
    public interface OperationsService {
        ...
        Mono<Response<OperationListResultAutoGeneratedInner>> list(@HostParam("$host") String endpoint,
    ...
    private Mono<Response<OperationListResultAutoGeneratedInner>> listWithResponseAsync() {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<OperationListResultAutoGeneratedInner>> listWithResponseAsync(Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<OperationListResultAutoGeneratedInner> listAsync() {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<OperationListResultAutoGeneratedInner> listWithResponse(Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public OperationListResultAutoGeneratedInner list() {
