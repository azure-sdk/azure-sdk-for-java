...
public final class OperationsClientImpl implements OperationsClient {
     ...
     * @return a list of REST API operations supported by the Microsoft.Insights Azure Resource Provider along with
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a list of REST API operations supported by the Microsoft.Insights Azure Resource Provider on successful
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a list of REST API operations supported by the Microsoft.Insights Azure Resource Provider.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
