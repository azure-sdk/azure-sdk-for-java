...
public final class TenantActionGroupsClientImpl implements TenantActionGroupsClient {
    ...
    public interface TenantActionGroupsService {
        ...
        Mono<Response<TenantActionGroupResourceInner>> createOrUpdate(@HostParam("$host") String endpoint,
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<TenantActionGroupResourceInner>> get(@HostParam("$host") String endpoint,
            @PathParam("managementGroupId") String managementGroupId,
            @PathParam("tenantActionGroupName") String tenantActionGroupName,
            @HeaderParam("x-ms-client-tenant-id") String xMsClientTenantId,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<TenantActionGroupResourceInner>> update(@HostParam("$host") String endpoint,
            @PathParam("managementGroupId") String managementGroupId,
            @PathParam("tenantActionGroupName") String tenantActionGroupName,
            @HeaderParam("x-ms-client-tenant-id") String xMsClientTenantId,
            @QueryParam("api-version") String apiVersion,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<TenantActionGroupList>> listByManagementGroupId(@HostParam("$host") String endpoint,
            @PathParam("managementGroupId") String managementGroupId,
            @HeaderParam("x-ms-client-tenant-id") String xMsClientTenantId,
            @QueryParam("api-version") String apiVersion, @HeaderParam("Accept") String accept, Context context);
    }
    ...
    private Mono<Response<TenantActionGroupResourceInner>> createOrUpdateWithResponseAsync(String managementGroupId,
        ...
        return FluxUtil
            .withContext(context -> service.createOrUpdate(this.client.getEndpoint(), managementGroupId,
                tenantActionGroupName, xMsClientTenantId, apiVersion, actionGroup, accept, context))
    ...
    private Mono<Response<TenantActionGroupResourceInner>> createOrUpdateWithResponseAsync(String managementGroupId,
        ...
        return service.createOrUpdate(this.client.getEndpoint(), managementGroupId, tenantActionGroupName,
            xMsClientTenantId, apiVersion, actionGroup, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<TenantActionGroupResourceInner> createOrUpdateAsync(String managementGroupId,
        String tenantActionGroupName, String xMsClientTenantId, TenantActionGroupResourceInner actionGroup) {
    ...
    private Mono<Response<TenantActionGroupResourceInner>> getWithResponseAsync(String managementGroupId,
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.get(this.client.getEndpoint(), managementGroupId, tenantActionGroupName,
                xMsClientTenantId, apiVersion, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<TenantActionGroupResourceInner>> getWithResponseAsync(String managementGroupId,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.get(this.client.getEndpoint(), managementGroupId, tenantActionGroupName, xMsClientTenantId,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<TenantActionGroupResourceInner> getAsync(String managementGroupId, String tenantActionGroupName,
    ...
    private Mono<Response<Void>> deleteWithResponseAsync(String managementGroupId, String tenantActionGroupName,
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.delete(this.client.getEndpoint(), managementGroupId, tenantActionGroupName,
                xMsClientTenantId, apiVersion, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<Void>> deleteWithResponseAsync(String managementGroupId, String tenantActionGroupName,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.delete(this.client.getEndpoint(), managementGroupId, tenantActionGroupName, xMsClientTenantId,
            apiVersion, accept, context);
    }
    ...
    private Mono<Response<TenantActionGroupResourceInner>> updateWithResponseAsync(String managementGroupId,
        String tenantActionGroupName, String xMsClientTenantId, ActionGroupPatchBody tenantActionGroupPatch) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.update(this.client.getEndpoint(), managementGroupId, tenantActionGroupName,
                xMsClientTenantId, apiVersion, tenantActionGroupPatch, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<TenantActionGroupResourceInner>> updateWithResponseAsync(String managementGroupId,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.update(this.client.getEndpoint(), managementGroupId, tenantActionGroupName, xMsClientTenantId,
            apiVersion, tenantActionGroupPatch, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<TenantActionGroupResourceInner> updateAsync(String managementGroupId, String tenantActionGroupName,
        String xMsClientTenantId, ActionGroupPatchBody tenantActionGroupPatch) {
    ...
    private Mono<PagedResponse<TenantActionGroupResourceInner>>
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.listByManagementGroupId(this.client.getEndpoint(), managementGroupId,
                xMsClientTenantId, apiVersion, accept, context))
    ...
    private Mono<PagedResponse<TenantActionGroupResourceInner>>
        ...
        context = this.client.mergeContext(context);
        return service
            .listByManagementGroupId(this.client.getEndpoint(), managementGroupId, xMsClientTenantId, apiVersion,
                accept, context)
