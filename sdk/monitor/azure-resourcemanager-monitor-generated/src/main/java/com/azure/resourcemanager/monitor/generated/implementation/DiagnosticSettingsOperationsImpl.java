...
public final class DiagnosticSettingsOperationsImpl implements DiagnosticSettingsOperations {
    ...
    public DiagnosticSettingsOperationsImpl(DiagnosticSettingsOperationsClient innerClient,
    ...
    public PagedIterable<DiagnosticSettingsResource> list(String resourceUri) {
        ...
        return ResourceManagerUtils.mapPage(inner,
            inner1 -> new DiagnosticSettingsResourceImpl(inner1, this.manager()));
    }
    ...
    public DiagnosticSettingsResource getById(String id) {
        ...
        if (name == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
                String.format("The resource ID '%s' is not valid. Missing path segment 'diagnosticSettings'.", id)));
        }
