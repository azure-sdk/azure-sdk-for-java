...
public final class MetricDefinitionsClientImpl implements MetricDefinitionsClient {
    ...
    private Mono<PagedResponse<SubscriptionScopeMetricDefinitionInner>>
        ...
        return FluxUtil
            .withContext(context -> service.listAtSubscriptionScope(this.client.getEndpoint(),
                this.client.getSubscriptionId(), this.client.getApiVersion(), region, metricnamespace, accept, context))
    ...
    private Mono<PagedResponse<SubscriptionScopeMetricDefinitionInner>>
        ...
        return service
            .listAtSubscriptionScope(this.client.getEndpoint(), this.client.getSubscriptionId(),
                this.client.getApiVersion(), region, metricnamespace, accept, context)
    ...
    private Mono<PagedResponse<MetricDefinitionInner>> listSinglePageAsync(String resourceUri, String metricnamespace,
        ...
        context = this.client.mergeContext(context);
        return service
            .list(this.client.getEndpoint(), resourceUri, this.client.getApiVersion(), metricnamespace, accept, context)
            .map(res -> new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(),
                res.getValue().value(), null, null));
    }
