...
import com.azure.resourcemanager.monitor.generated.models.SubscriptionScopeMetricDefinitionCollection;
...
public final class MetricDefinitionsClientImpl implements MetricDefinitionsClient {
    ...
    private Mono<PagedResponse<SubscriptionScopeMetricDefinitionInner>> listAtSubscriptionScopeSinglePageAsync(
        String region, String metricnamespace) {
                ...
                context ->
                    service
                        .listAtSubscriptionScope(
                            ...
                            accept,
                            context))
            .<PagedResponse<SubscriptionScopeMetricDefinitionInner>>map(
                res ->
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<SubscriptionScopeMetricDefinitionInner>> listAtSubscriptionScopeSinglePageAsync(
        String region, String metricnamespace, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    private PagedFlux<SubscriptionScopeMetricDefinitionInner> listAtSubscriptionScopeAsync(
        String region, String metricnamespace) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<SubscriptionScopeMetricDefinitionInner> listAtSubscriptionScope(
        String region, String metricnamespace, Context context) {
