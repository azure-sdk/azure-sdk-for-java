...
public final class DataCollectionRuleAssociationsImpl implements DataCollectionRuleAssociations {
    ...
    public DataCollectionRuleAssociationsImpl(DataCollectionRuleAssociationsClient innerClient,
    ...
    public PagedIterable<DataCollectionRuleAssociationProxyOnlyResource> listByResource(String resourceUri) {
        ...
        return ResourceManagerUtils.mapPage(inner,
            inner1 -> new DataCollectionRuleAssociationProxyOnlyResourceImpl(inner1, this.manager()));
    }
    ...
    public PagedIterable<DataCollectionRuleAssociationProxyOnlyResource> listByRule(String resourceGroupName,
    ...
    public PagedIterable<DataCollectionRuleAssociationProxyOnlyResource>
    ...
    public Response<DataCollectionRuleAssociationProxyOnlyResource> getWithResponse(String resourceUri,
    ...
    public Response<Void> deleteByResourceGroupWithResponse(String resourceUri, String associationName,
        Context context) {
    ...
    public DataCollectionRuleAssociationProxyOnlyResource getById(String id) {
        ...
        String associationName = ResourceManagerUtils.getValueFromIdByParameterName(id,
            "/{resourceUri}/providers/Microsoft.Insights/dataCollectionRuleAssociations/{associationName}",
            "associationName");
        if (associationName == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(String.format(
                "The resource ID '%s' is not valid. Missing path segment 'dataCollectionRuleAssociations'.", id)));
        }
