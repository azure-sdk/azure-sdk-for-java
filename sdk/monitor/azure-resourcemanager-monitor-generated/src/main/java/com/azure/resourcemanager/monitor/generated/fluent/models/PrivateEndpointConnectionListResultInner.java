...
public final class PrivateEndpointConnectionListResultInner
     ...
     */
    public PrivateEndpointConnectionListResultInner withValue(List<PrivateEndpointConnectionAutoGeneratedInner> value) {
        this.value = value;
        return this;
    }
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("value".equals(fieldName)) {
                    List<PrivateEndpointConnectionAutoGeneratedInner> value
