...
public final class DataCollectionRulesImpl implements DataCollectionRules {
    ...
    public DataCollectionRulesImpl(DataCollectionRulesClient innerClient,
    ...
    public PagedIterable<DataCollectionRuleResource> listByResourceGroup(String resourceGroupName) {
        ...
        return ResourceManagerUtils.mapPage(inner,
            inner1 -> new DataCollectionRuleResourceImpl(inner1, this.manager()));
    }
    ...
    public Response<DataCollectionRuleResource> getByResourceGroupWithResponse(String resourceGroupName,
    ...
    public Response<Void> deleteWithResponse(String resourceGroupName, String dataCollectionRuleName,
        ...
        return this.serviceClient().deleteWithResponse(resourceGroupName, dataCollectionRuleName, deleteAssociations,
            context);
    }
    ...
    public DataCollectionRuleResource getById(String id) {
        ...
        String dataCollectionRuleName = ResourceManagerUtils.getValueFromIdByName(id, "dataCollectionRules");
        if (dataCollectionRuleName == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
                String.format("The resource ID '%s' is not valid. Missing path segment 'dataCollectionRules'.", id)));
        }
    ...
    public void deleteById(String id) {
        ...
        Boolean localDeleteAssociations = null;
        this.deleteWithResponse(resourceGroupName, dataCollectionRuleName, localDeleteAssociations, Context.NONE);
    }

    public Response<Void> deleteByIdWithResponse(String id, Boolean deleteAssociations, Context context) {
        String resourceGroupName = ResourceManagerUtils.getValueFromIdByName(id, "resourceGroups");
        if (resourceGroupName == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
                String.format("The resource ID '%s' is not valid. Missing path segment 'resourceGroups'.", id)));
        ...
        return this.deleteWithResponse(resourceGroupName, dataCollectionRuleName, deleteAssociations, context);
    }
