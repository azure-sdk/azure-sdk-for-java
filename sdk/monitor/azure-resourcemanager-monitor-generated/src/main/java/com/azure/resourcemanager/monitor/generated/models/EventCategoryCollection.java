...
public final class EventCategoryCollection implements JsonSerializable<EventCategoryCollection> {
     ...
     */
    private List<LocalizableStringAutoGeneratedInner> value;
     ...
     */
    public List<LocalizableStringAutoGeneratedInner> value() {
        return this.value;
    }
     ...
     */
    public EventCategoryCollection withValue(List<LocalizableStringAutoGeneratedInner> value) {
        this.value = value;
        return this;
    }
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("value".equals(fieldName)) {
                    List<LocalizableStringAutoGeneratedInner> value
                        = reader.readArray(reader1 -> LocalizableStringAutoGeneratedInner.fromJson(reader1));
