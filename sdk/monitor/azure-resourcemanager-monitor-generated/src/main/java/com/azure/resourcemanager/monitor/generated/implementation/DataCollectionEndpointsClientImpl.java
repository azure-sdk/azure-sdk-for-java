...
public final class DataCollectionEndpointsClientImpl implements DataCollectionEndpointsClient {
    ...
    public interface DataCollectionEndpointsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<DataCollectionEndpointResourceListResult>> list(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<DataCollectionEndpointResourceInner>> getByResourceGroup(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("dataCollectionEndpointName") String dataCollectionEndpointName,
            @QueryParam("api-version") String apiVersion, @HeaderParam("Accept") String accept, Context context);
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<DataCollectionEndpointResourceInner>> create(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("dataCollectionEndpointName") String dataCollectionEndpointName,
            @QueryParam("api-version") String apiVersion,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<DataCollectionEndpointResourceInner>> update(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("dataCollectionEndpointName") String dataCollectionEndpointName,
            @QueryParam("api-version") String apiVersion, @BodyParam("application/json") ResourceForUpdate body,
            @HeaderParam("Accept") String accept, Context context);
    ...
    private Mono<PagedResponse<NetworkSecurityPerimeterConfigurationInner>>
        ...
        return FluxUtil
            .withContext(context -> service.listNsp(this.client.getEndpoint(), this.client.getSubscriptionId(),
                resourceGroupName, dataCollectionEndpointName, apiVersion, accept, context))
    ...
    private Mono<PagedResponse<NetworkSecurityPerimeterConfigurationInner>>
        ...
        return service
            .listNsp(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
    ...
    private Mono<Response<NetworkSecurityPerimeterConfigurationInner>> getNspWithResponseAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(
                context -> service.getNsp(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
                    dataCollectionEndpointName, apiVersion, networkSecurityPerimeterConfigurationName, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<NetworkSecurityPerimeterConfigurationInner>> getNspWithResponseAsync(String resourceGroupName,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.getNsp(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            dataCollectionEndpointName, apiVersion, networkSecurityPerimeterConfigurationName, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<NetworkSecurityPerimeterConfigurationInner> getNspAsync(String resourceGroupName,
        String dataCollectionEndpointName, String networkSecurityPerimeterConfigurationName) {
    ...
    private Mono<Response<Flux<ByteBuffer>>> reconcileNspWithResponseAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(context -> service.reconcileNsp(this.client.getEndpoint(), this.client.getSubscriptionId(),
                resourceGroupName, dataCollectionEndpointName, apiVersion, networkSecurityPerimeterConfigurationName,
                accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<DataCollectionEndpointResourceInner>>
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DataCollectionEndpointResourceInner> getByResourceGroupAsync(String resourceGroupName,
        String dataCollectionEndpointName) {
    ...
    private Mono<Response<DataCollectionEndpointResourceInner>> createWithResponseAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(context -> service.create(this.client.getEndpoint(), this.client.getSubscriptionId(),
                resourceGroupName, dataCollectionEndpointName, apiVersion, body, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<DataCollectionEndpointResourceInner>> createWithResponseAsync(String resourceGroupName,
        ...
        return service.create(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            dataCollectionEndpointName, apiVersion, body, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DataCollectionEndpointResourceInner> createAsync(String resourceGroupName,
        String dataCollectionEndpointName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DataCollectionEndpointResourceInner> updateAsync(String resourceGroupName,
        String dataCollectionEndpointName) {
