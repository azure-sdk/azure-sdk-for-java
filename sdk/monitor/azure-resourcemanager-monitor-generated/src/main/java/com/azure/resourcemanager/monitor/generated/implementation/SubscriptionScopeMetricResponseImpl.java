...
public final class SubscriptionScopeMetricResponseImpl implements SubscriptionScopeMetricResponse {
    ...
    SubscriptionScopeMetricResponseImpl(SubscriptionScopeMetricResponseInner innerObject,
    ...
    public List<SubscriptionScopeMetric> value() {
        ...
        if (inner != null) {
            return Collections.unmodifiableList(inner.stream()
                .map(inner1 -> new SubscriptionScopeMetricImpl(inner1, this.manager())).collect(Collectors.toList()));
        } else {
