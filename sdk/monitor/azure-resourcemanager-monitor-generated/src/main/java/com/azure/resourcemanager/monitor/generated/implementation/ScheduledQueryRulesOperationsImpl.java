...
public final class ScheduledQueryRulesOperationsImpl implements ScheduledQueryRulesOperations {
    private static final ClientLogger LOGGER = new ClientLogger(ScheduledQueryRulesOperationsImpl.class);

    private final ScheduledQueryRulesOperationsClient innerClient;

    private final com.azure.resourcemanager.monitor.generated.MonitorManager serviceManager;

    public ScheduledQueryRulesOperationsImpl(ScheduledQueryRulesOperationsClient innerClient,
    ...
    public PagedIterable<ScheduledQueryRuleResource> list() {
        ...
        return ResourceManagerUtils.mapPage(inner,
            inner1 -> new ScheduledQueryRuleResourceImpl(inner1, this.manager()));
    }
    ...
    public Response<ScheduledQueryRuleResource> getByResourceGroupWithResponse(String resourceGroupName,
    ...
    private ScheduledQueryRulesOperationsClient serviceClient() {
