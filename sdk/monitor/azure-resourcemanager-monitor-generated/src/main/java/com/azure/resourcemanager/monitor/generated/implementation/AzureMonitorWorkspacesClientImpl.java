...
public final class AzureMonitorWorkspacesClientImpl implements AzureMonitorWorkspacesClient {
    ...
    public interface AzureMonitorWorkspacesService {
        ...
        Mono<Response<AzureMonitorWorkspaceResourceListResult>> listByResourceGroup(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<AzureMonitorWorkspaceResourceListResult>> list(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<AzureMonitorWorkspaceResourceInner>> getByResourceGroup(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<AzureMonitorWorkspaceResourceInner>> create(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("azureMonitorWorkspaceName") String azureMonitorWorkspaceName,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<AzureMonitorWorkspaceResourceInner>> update(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("azureMonitorWorkspaceName") String azureMonitorWorkspaceName,
            @QueryParam("api-version") String apiVersion,
    ...
    private Mono<Response<AzureMonitorWorkspaceResourceInner>>
        ...
        if (azureMonitorWorkspaceName == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter azureMonitorWorkspaceName is required and cannot be null."));
        }
        final String apiVersion = "2023-04-03";
        final String accept = "application/json";
        return FluxUtil
            .withContext(
                context -> service.getByResourceGroup(this.client.getEndpoint(), this.client.getSubscriptionId(),
                    resourceGroupName, azureMonitorWorkspaceName, apiVersion, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<AzureMonitorWorkspaceResourceInner>> getByResourceGroupWithResponseAsync(
        ...
        return service.getByResourceGroup(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            azureMonitorWorkspaceName, apiVersion, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<AzureMonitorWorkspaceResourceInner>> createWithResponseAsync(String resourceGroupName,
        String azureMonitorWorkspaceName, AzureMonitorWorkspaceResourceInner azureMonitorWorkspaceProperties) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return FluxUtil
            .withContext(
                context -> service.create(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
                    azureMonitorWorkspaceName, apiVersion, azureMonitorWorkspaceProperties, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<AzureMonitorWorkspaceResourceInner> createAsync(String resourceGroupName,
        String azureMonitorWorkspaceName, AzureMonitorWorkspaceResourceInner azureMonitorWorkspaceProperties) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<AzureMonitorWorkspaceResourceInner> createWithResponse(String resourceGroupName,
        String azureMonitorWorkspaceName, AzureMonitorWorkspaceResourceInner azureMonitorWorkspaceProperties,
        Context context) {
        return createWithResponseAsync(resourceGroupName, azureMonitorWorkspaceName, azureMonitorWorkspaceProperties,
            context).block();
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public AzureMonitorWorkspaceResourceInner create(String resourceGroupName, String azureMonitorWorkspaceName,
        AzureMonitorWorkspaceResourceInner azureMonitorWorkspaceProperties) {
        return createWithResponse(resourceGroupName, azureMonitorWorkspaceName, azureMonitorWorkspaceProperties,
    ...
    private Mono<Response<AzureMonitorWorkspaceResourceInner>> updateWithResponseAsync(String resourceGroupName,
        String azureMonitorWorkspaceName, AzureMonitorWorkspaceResourceForUpdate azureMonitorWorkspaceProperties) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    public AzureMonitorWorkspaceResourceInner update(String resourceGroupName, String azureMonitorWorkspaceName) {
        final AzureMonitorWorkspaceResourceForUpdate azureMonitorWorkspaceProperties = null;
        return updateWithResponse(resourceGroupName, azureMonitorWorkspaceName, azureMonitorWorkspaceProperties,
            Context.NONE).getValue();
    }
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String azureMonitorWorkspaceName, Context context) {
        return beginDeleteAsync(resourceGroupName, azureMonitorWorkspaceName, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
