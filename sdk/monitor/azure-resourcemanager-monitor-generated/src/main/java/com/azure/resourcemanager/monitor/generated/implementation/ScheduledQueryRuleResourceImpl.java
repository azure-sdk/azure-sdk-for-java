...
public final class ScheduledQueryRuleResourceImpl
    ...
    public RuleResolveConfiguration resolveConfiguration() {
        return this.innerModel().resolveConfiguration();
    }
    ...
    ScheduledQueryRuleResourceImpl(String name,
    ...
    ScheduledQueryRuleResourceImpl(ScheduledQueryRuleResourceInner innerObject,
        com.azure.resourcemanager.monitor.generated.MonitorManager serviceManager) {
    ...
    public ScheduledQueryRuleResourceImpl
    ...
    public ScheduledQueryRuleResourceImpl withResolveConfiguration(RuleResolveConfiguration resolveConfiguration) {
        if (isInCreateMode()) {
            this.innerModel().withResolveConfiguration(resolveConfiguration);
            return this;
        } else {
            this.updateParameters.withResolveConfiguration(resolveConfiguration);
            return this;
        }
    }
