...
public final class EventCategoriesClientImpl implements EventCategoriesClient {
    ...
    public interface EventCategoriesService {
        ...
        Mono<Response<EventCategoryCollection>> list(@HostParam("$host") String endpoint,
    ...
    private Mono<PagedResponse<LocalizableStringAutoGeneratedInner>> listSinglePageAsync() {
        ...
        return FluxUtil.withContext(context -> service.list(this.client.getEndpoint(), apiVersion, accept, context))
            .<PagedResponse<LocalizableStringAutoGeneratedInner>>map(res -> new PagedResponseBase<>(res.getRequest(),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<LocalizableStringAutoGeneratedInner>> listSinglePageAsync(Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    private PagedFlux<LocalizableStringAutoGeneratedInner> listAsync() {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<LocalizableStringAutoGeneratedInner> listAsync(Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<LocalizableStringAutoGeneratedInner> list() {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<LocalizableStringAutoGeneratedInner> list(Context context) {
