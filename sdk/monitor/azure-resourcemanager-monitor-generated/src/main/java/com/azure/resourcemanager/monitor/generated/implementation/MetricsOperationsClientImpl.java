...
public final class MetricsOperationsClientImpl implements MetricsOperationsClient {
     ...
     * has a comma in it then use %2 to indicate it. Eg: 'Metric,Name1' should be **'Metric%2Name1'**. At most 20 metric
    ...
    private Mono<Response<ResponseInner>> listAtSubscriptionScopePostWithResponseAsync(String region, String timespan,
        ...
        return service.listAtSubscriptionScopePost(this.client.getEndpoint(), this.client.getSubscriptionId(),
            apiVersion, region, timespan, interval, metricnames, aggregation, top, orderBy, filter, resultType,
            metricnamespace, autoAdjustTimegrain, validateDimensions, rollupby, body, accept, context);
    }
