...
public final class MetricsOperationsClientImpl implements MetricsOperationsClient {
    ...
    public interface MetricsOperationsService {
        ...
        Mono<Response<ResponseInner>> listAtSubscriptionScope(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
            @QueryParam("region") String region, @QueryParam("timespan") String timespan,
            @QueryParam("interval") String interval, @QueryParam("metricnames") String metricnames,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ResponseInner>> listAtSubscriptionScopePost(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
        ...
        Mono<Response<ResponseInner>> list(@HostParam("$host") String endpoint,
            ...
            @QueryParam("timespan") String timespan, @QueryParam("interval") String interval,
    ...
    private Mono<Response<ResponseInner>> listAtSubscriptionScopeWithResponseAsync(String region, String timespan,
        String interval, String metricnames, String aggregation, Integer top, String orderBy, String filter,
        ...
        return FluxUtil
            .withContext(
                context -> service.listAtSubscriptionScope(this.client.getEndpoint(), this.client.getSubscriptionId(),
                    apiVersion, region, timespan, interval, metricnames, aggregation, top, orderBy, filter, resultType,
                    metricnamespace, autoAdjustTimegrain, validateDimensions, rollupby, accept, context))
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ResponseInner> listAtSubscriptionScopeAsync(String region) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ResponseInner> listAtSubscriptionScopeWithResponse(String region, String timespan, String interval,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ResponseInner>> listAtSubscriptionScopePostWithResponseAsync(String region,
        ...
        return FluxUtil
            .withContext(context -> service.listAtSubscriptionScopePost(this.client.getEndpoint(),
                this.client.getSubscriptionId(), apiVersion, region, body, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<ResponseInner>> listAtSubscriptionScopePostWithResponseAsync(String region,
        ...
        return service.listAtSubscriptionScopePost(this.client.getEndpoint(), this.client.getSubscriptionId(),
            apiVersion, region, body, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ResponseInner> listAtSubscriptionScopePostAsync(String region) {
        final SubscriptionScopeMetricsRequestBodyParameters body = null;
        return listAtSubscriptionScopePostWithResponseAsync(region, body)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ResponseInner> listAtSubscriptionScopePostWithResponse(String region,
        SubscriptionScopeMetricsRequestBodyParameters body, Context context) {
        return listAtSubscriptionScopePostWithResponseAsync(region, body, context).block();
    }
    ...
    public ResponseInner listAtSubscriptionScopePost(String region) {
        final SubscriptionScopeMetricsRequestBodyParameters body = null;
        return listAtSubscriptionScopePostWithResponse(region, body, Context.NONE).getValue();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ResponseInner>> listWithResponseAsync(String resourceUri, String timespan, String interval,
    ...
    private Mono<Response<ResponseInner>> listWithResponseAsync(String resourceUri, String timespan, String interval,
        ...
        return service.list(this.client.getEndpoint(), resourceUri, timespan, interval, metricnames, aggregation, top,
            orderBy, filter, resultType, apiVersion, metricnamespace, autoAdjustTimegrain, validateDimensions, rollupby,
            accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ResponseInner> listWithResponse(String resourceUri, String timespan, String interval,
        String metricnames, String aggregation, Integer top, String orderBy, String filter, ResultType resultType,
        String metricnamespace, Boolean autoAdjustTimegrain, Boolean validateDimensions, String rollupby,
        Context context) {
        return listWithResponseAsync(resourceUri, timespan, interval, metricnames, aggregation, top, orderBy, filter,
