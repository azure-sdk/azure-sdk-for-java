...
public final class MetricDefinitionsImpl implements MetricDefinitions {
    ...
    public PagedIterable<SubscriptionScopeMetricDefinition> listAtSubscriptionScope(String region) {
        PagedIterable<SubscriptionScopeMetricDefinitionInner> inner
            = this.serviceClient().listAtSubscriptionScope(region);
        return Utils.mapPage(inner, inner1 -> new SubscriptionScopeMetricDefinitionImpl(inner1, this.manager()));
    }

    public PagedIterable<SubscriptionScopeMetricDefinition> listAtSubscriptionScope(String region,
        String metricnamespace, Context context) {
        PagedIterable<SubscriptionScopeMetricDefinitionInner> inner
            = this.serviceClient().listAtSubscriptionScope(region, metricnamespace, context);
        return Utils.mapPage(inner, inner1 -> new SubscriptionScopeMetricDefinitionImpl(inner1, this.manager()));
    }
