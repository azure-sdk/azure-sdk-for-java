...
public interface ScheduledQueryRuleResource {
    ...
    /**
     * Gets the skipQueryValidation property: The flag which indicates whether unidentified table or column names in the
     * query text should be ignored during validation. The default is false. Relevant only for Log Alert rules with an
     * evaluation frequency which is greater than 1 minute.
     *
    ...
    interface DefinitionStages {
        ...
        interface WithSkipQueryValidation {
            /**
             * Specifies the skipQueryValidation property: The flag which indicates whether unidentified table or column
             * names in the query text should be ignored during validation. The default is false. Relevant only for Log
             * Alert rules with an evaluation frequency which is greater than 1 minute..
             *
             * @param skipQueryValidation The flag which indicates whether unidentified table or column names in the
             *     query text should be ignored during validation. The default is false. Relevant only for Log Alert
             *     rules with an evaluation frequency which is greater than 1 minute.
             * @return the next definition stage.
             */
