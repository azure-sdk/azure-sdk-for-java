...
public final class DataCollectionRuleAssociationProxyOnlyResourceImpl implements
    DataCollectionRuleAssociationProxyOnlyResource, DataCollectionRuleAssociationProxyOnlyResource.Definition {
    private DataCollectionRuleAssociationProxyOnlyResourceInner innerObject;

    private final com.azure.resourcemanager.monitor.generated.MonitorManager serviceManager;

    DataCollectionRuleAssociationProxyOnlyResourceImpl(DataCollectionRuleAssociationProxyOnlyResourceInner innerObject,
    ...
    public DataCollectionRuleAssociationProxyOnlyResource create() {
        this.innerObject = serviceManager.serviceClient().getDataCollectionRuleAssociations()
            .createWithResponse(resourceUri, associationName, this.innerModel(), Context.NONE).getValue();
        return this;
    }

    public DataCollectionRuleAssociationProxyOnlyResource create(Context context) {
        this.innerObject = serviceManager.serviceClient().getDataCollectionRuleAssociations()
            .createWithResponse(resourceUri, associationName, this.innerModel(), context).getValue();
        return this;
    }

    DataCollectionRuleAssociationProxyOnlyResourceImpl(String name,
        com.azure.resourcemanager.monitor.generated.MonitorManager serviceManager) {
    ...
    public DataCollectionRuleAssociationProxyOnlyResource refresh() {
        this.innerObject = serviceManager.serviceClient().getDataCollectionRuleAssociations()
            .getWithResponse(resourceUri, associationName, Context.NONE).getValue();
        return this;
    }

    public DataCollectionRuleAssociationProxyOnlyResource refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getDataCollectionRuleAssociations()
            .getWithResponse(resourceUri, associationName, context).getValue();
        return this;
    }
    ...
    public DataCollectionRuleAssociationProxyOnlyResourceImpl
