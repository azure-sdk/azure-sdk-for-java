...
public final class ActionGroupsImpl implements ActionGroups {
    ...
    public TestNotificationDetailsResponse createNotificationsAtActionGroupResourceLevel(String resourceGroupName,
        ...
        TestNotificationDetailsResponseInner inner = this.serviceClient().createNotificationsAtActionGroupResourceLevel(
    ...
    public Response<TestNotificationDetailsResponse> getTestNotificationsAtActionGroupResourceLevelWithResponse(
        ...
        Response<TestNotificationDetailsResponseInner> inner
            = this.serviceClient().getTestNotificationsAtActionGroupResourceLevelWithResponse(resourceGroupName,
                actionGroupName, notificationId, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
