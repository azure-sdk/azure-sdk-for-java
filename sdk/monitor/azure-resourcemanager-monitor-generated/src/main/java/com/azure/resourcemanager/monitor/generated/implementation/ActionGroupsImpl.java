...
public final class ActionGroupsImpl implements ActionGroups {
    ...
    public TestNotificationResponse postTestNotifications(NotificationRequestBody notificationRequest) {
        TestNotificationResponseInner inner = this.serviceClient().postTestNotifications(notificationRequest);
        if (inner != null) {
            return new TestNotificationResponseImpl(inner, this.manager());
        } else {
            return null;
        }
    }

    public TestNotificationResponse postTestNotifications(
        NotificationRequestBody notificationRequest, Context context) {
        TestNotificationResponseInner inner = this.serviceClient().postTestNotifications(notificationRequest, context);
        if (inner != null) {
            return new TestNotificationResponseImpl(inner, this.manager());
        } else {
            return null;
