...
public final class ActionGroupsImpl implements ActionGroups {
    ...
    public PagedIterable<NetworkSecurityPerimeterConfiguration> listNsp(String resourceGroupName,
        ...
        PagedIterable<NetworkSecurityPerimeterConfigurationInner> inner
            = this.serviceClient().listNsp(resourceGroupName, actionGroupName);
    ...
    public PagedIterable<NetworkSecurityPerimeterConfiguration> listNsp(String resourceGroupName,
        ...
        PagedIterable<NetworkSecurityPerimeterConfigurationInner> inner
            = this.serviceClient().listNsp(resourceGroupName, actionGroupName, context);
        return ResourceManagerUtils.mapPage(inner,
            inner1 -> new NetworkSecurityPerimeterConfigurationImpl(inner1, this.manager()));
    }
    ...
    public Response<NetworkSecurityPerimeterConfiguration> getNspWithResponse(String resourceGroupName,
        ...
        Response<NetworkSecurityPerimeterConfigurationInner> inner = this.serviceClient()
            .getNspWithResponse(resourceGroupName, actionGroupName, networkSecurityPerimeterConfigurationName, context);
        if (inner != null) {
    ...
    public NetworkSecurityPerimeterConfiguration getNsp(String resourceGroupName, String actionGroupName,
        String networkSecurityPerimeterConfigurationName) {
        NetworkSecurityPerimeterConfigurationInner inner = this.serviceClient()
            .getNsp(resourceGroupName, actionGroupName, networkSecurityPerimeterConfigurationName);
        if (inner != null) {
    ...
    public void reconcileNsp(String resourceGroupName, String actionGroupName,
        String networkSecurityPerimeterConfigurationName) {
        this.serviceClient()
            .reconcileNsp(resourceGroupName, actionGroupName, networkSecurityPerimeterConfigurationName);
    }

    public void reconcileNsp(String resourceGroupName, String actionGroupName,
        String networkSecurityPerimeterConfigurationName, Context context) {
        this.serviceClient()
            .reconcileNsp(resourceGroupName, actionGroupName, networkSecurityPerimeterConfigurationName, context);
    }

    public Response<ActionGroupResource> getByResourceGroupWithResponse(String resourceGroupName,
        String actionGroupName, Context context) {
    ...
    public Response<Void> deleteByResourceGroupWithResponse(String resourceGroupName, String actionGroupName,
        Context context) {
    ...
    public Response<TestNotificationDetailsResponse> getTestNotificationsAtActionGroupResourceLevelWithResponse(
        ...
        Response<TestNotificationDetailsResponseInner> inner = this.serviceClient()
