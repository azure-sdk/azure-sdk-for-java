...
/**
 * Log and metrics specifications for the operation.
 */
@Fluent
public final class ServiceSpecification {
     ...
     */
    @JsonProperty(value = "legacyMetricSpecifications")
    private Object legacyMetricSpecifications;
    ...
    /**
     * Get the legacyMetricSpecifications property: Legacy Metric specifications for operation. Deprecated, do not use.
     * 
     * @return the legacyMetricSpecifications value.
     */
    public Object legacyMetricSpecifications() {
        return this.legacyMetricSpecifications;
    }

    /**
     * Set the legacyMetricSpecifications property: Legacy Metric specifications for operation. Deprecated, do not use.
     * 
     * @param legacyMetricSpecifications the legacyMetricSpecifications value to set.
     * @return the ServiceSpecification object itself.
     */
    public ServiceSpecification withLegacyMetricSpecifications(Object legacyMetricSpecifications) {
        this.legacyMetricSpecifications = legacyMetricSpecifications;
        return this;
    }
