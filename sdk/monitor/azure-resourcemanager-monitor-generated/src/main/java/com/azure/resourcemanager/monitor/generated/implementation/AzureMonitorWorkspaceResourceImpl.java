...
public final class AzureMonitorWorkspaceResourceImpl implements AzureMonitorWorkspaceResource,
    ...
    public AzureMonitorWorkspaceResource apply() {
        this.innerObject = serviceManager.serviceClient()
            .getAzureMonitorWorkspaces()
            .updateWithResponse(resourceGroupName, azureMonitorWorkspaceName, updateAzureMonitorWorkspaceProperties,
                Context.NONE)
            .getValue();
        return this;
    }
    ...
    public AzureMonitorWorkspaceResourceImpl withPublicNetworkAccess(PublicNetworkAccess publicNetworkAccess) {
