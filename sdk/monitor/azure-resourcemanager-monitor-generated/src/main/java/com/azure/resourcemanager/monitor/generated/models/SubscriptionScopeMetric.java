...
public final class SubscriptionScopeMetric {
     ...
     */
    public SubscriptionScopeMetric withId(String id) {
        this.id = id;
        return this;
    }
     ...
     * @return the SubscriptionScopeMetric object itself.
     */
    public SubscriptionScopeMetric withType(String type) {
        this.type = type;
        return this;
    }
     ...
     * @return the SubscriptionScopeMetric object itself.
     */
    public SubscriptionScopeMetric withName(LocalizableString name) {
        this.name = name;
        return this;
    }
     ...
     * @return the SubscriptionScopeMetric object itself.
     */
    public SubscriptionScopeMetric withDisplayDescription(String displayDescription) {
     ...
     * @return the SubscriptionScopeMetric object itself.
     */
    public SubscriptionScopeMetric withErrorCode(String errorCode) {
     ...
     * @return the SubscriptionScopeMetric object itself.
     */
    public SubscriptionScopeMetric withErrorMessage(String errorMessage) {
     ...
     * @return the SubscriptionScopeMetric object itself.
     */
    public SubscriptionScopeMetric withUnit(MetricUnit unit) {
        this.unit = unit;
        return this;
    }
     ...
     * @return the SubscriptionScopeMetric object itself.
     */
    public SubscriptionScopeMetric withTimeseries(List<TimeSeriesElement> timeseries) {
    ...
    public void validate() {
        if (id() == null) {
            throw LOGGER.logExceptionAsError(
                new IllegalArgumentException("Missing required property id in model SubscriptionScopeMetric"));
        }
        if (type() == null) {
            throw LOGGER.logExceptionAsError(
                new IllegalArgumentException("Missing required property type in model SubscriptionScopeMetric"));
        }
        if (name() == null) {
            throw LOGGER.logExceptionAsError(
                new IllegalArgumentException("Missing required property name in model SubscriptionScopeMetric"));
        } else {
            name().validate();
        }
        if (unit() == null) {
            throw LOGGER.logExceptionAsError(
                new IllegalArgumentException("Missing required property unit in model SubscriptionScopeMetric"));
        }
        if (timeseries() == null) {
            throw LOGGER.logExceptionAsError(
                new IllegalArgumentException("Missing required property timeseries in model SubscriptionScopeMetric"));
        } else {
            timeseries().forEach(e -> e.validate());
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(SubscriptionScopeMetric.class);
}
