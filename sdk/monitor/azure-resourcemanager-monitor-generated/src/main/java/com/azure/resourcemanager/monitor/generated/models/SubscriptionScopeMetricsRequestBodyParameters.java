...
public final class SubscriptionScopeMetricsRequestBodyParameters {
    ...
    /*
     * The names of the metrics (comma separated) to retrieve. Special case: If a metricname itself has a comma in it
     * then use %2 to indicate it. Eg: 'Metric,Name1' should be **'Metric%2Name1'**. At most 20 metric names can be
     * specified.
     */
     ...
     * Defaults to false.
     */
    @JsonProperty(value = "autoAdjustTimegrain")
     ...
     */
    @JsonProperty(value = "validateDimensions")
     ...
     * @return the SubscriptionScopeMetricsRequestBodyParameters object itself.
     */
    public SubscriptionScopeMetricsRequestBodyParameters withInterval(String interval) {
        this.interval = interval;
        return this;
    }

    /**
     * Get the metricNames property: The names of the metrics (comma separated) to retrieve. Special case: If a
     * metricname itself has a comma in it then use %2 to indicate it. Eg: 'Metric,Name1' should be
     * **'Metric%2Name1'**. At most 20 metric names can be specified.
     * 
    ...
    /**
     * Set the metricNames property: The names of the metrics (comma separated) to retrieve. Special case: If a
     * metricname itself has a comma in it then use %2 to indicate it. Eg: 'Metric,Name1' should be
     * **'Metric%2Name1'**. At most 20 metric names can be specified.
     * 
