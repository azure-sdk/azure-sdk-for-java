...
public final class EventDataImpl implements EventData {
    ...
    public LocalizableStringAutoGenerated eventName() {
        LocalizableStringAutoGeneratedInner inner = this.innerModel().eventName();
        if (inner != null) {
            return new LocalizableStringAutoGeneratedImpl(inner, this.manager());
        } else {
            return null;
        }
    }

    public LocalizableStringAutoGenerated category() {
        LocalizableStringAutoGeneratedInner inner = this.innerModel().category();
        if (inner != null) {
            return new LocalizableStringAutoGeneratedImpl(inner, this.manager());
        } else {
            return null;
    ...
    public LocalizableStringAutoGenerated resourceProviderName() {
        LocalizableStringAutoGeneratedInner inner = this.innerModel().resourceProviderName();
        if (inner != null) {
            return new LocalizableStringAutoGeneratedImpl(inner, this.manager());
        } else {
            return null;
    ...
    public LocalizableStringAutoGenerated resourceType() {
        LocalizableStringAutoGeneratedInner inner = this.innerModel().resourceType();
        if (inner != null) {
            return new LocalizableStringAutoGeneratedImpl(inner, this.manager());
        } else {
            return null;
    ...
    public LocalizableStringAutoGenerated operationName() {
        LocalizableStringAutoGeneratedInner inner = this.innerModel().operationName();
        if (inner != null) {
            return new LocalizableStringAutoGeneratedImpl(inner, this.manager());
        } else {
            return null;
    ...
    public LocalizableStringAutoGenerated status() {
        LocalizableStringAutoGeneratedInner inner = this.innerModel().status();
        if (inner != null) {
            return new LocalizableStringAutoGeneratedImpl(inner, this.manager());
        } else {
            return null;
    ...
    public LocalizableStringAutoGenerated subStatus() {
        LocalizableStringAutoGeneratedInner inner = this.innerModel().subStatus();
        if (inner != null) {
            return new LocalizableStringAutoGeneratedImpl(inner, this.manager());
        } else {
            return null;
