...
public interface AzureMonitorWorkspacesClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<AzureMonitorWorkspaceResourceInner> createWithResponse(String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    AzureMonitorWorkspaceResourceInner create(String resourceGroupName, String azureMonitorWorkspaceName,
