...
public interface AzureMonitorWorkspacesClient {
    ...
    Response<AzureMonitorWorkspaceResourceInner> getByResourceGroupWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<AzureMonitorWorkspaceResourceInner> createWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    AzureMonitorWorkspaceResourceInner create(
        String resourceGroupName,
        String azureMonitorWorkspaceName,
        AzureMonitorWorkspaceResourceInner azureMonitorWorkspaceProperties);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<AzureMonitorWorkspaceResourceInner> updateWithResponse(
        String resourceGroupName,
        String azureMonitorWorkspaceName,
