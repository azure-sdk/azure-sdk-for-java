...
public interface ActionGroupsClient {
    ...
    SyncPoller<PollResult<Void>, Void> beginPostTestNotifications(NotificationRequestBody notificationRequest);
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<Void>, Void> beginPostTestNotifications(
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<Void>, Void> beginCreateNotificationsAtResourceGroupLevel(
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<Void>, Void> beginCreateNotificationsAtActionGroupResourceLevel(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    void createNotificationsAtActionGroupResourceLevel(
        String resourceGroupName, String actionGroupName, NotificationRequestBody notificationRequest);
