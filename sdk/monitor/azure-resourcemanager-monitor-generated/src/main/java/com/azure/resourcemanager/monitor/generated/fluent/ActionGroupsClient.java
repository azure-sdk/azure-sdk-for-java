...
public interface ActionGroupsClient {
    ...
    PagedIterable<NetworkSecurityPerimeterConfigurationInner> listNsp(String resourceGroupName, String actionGroupName);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    NetworkSecurityPerimeterConfigurationInner getNsp(String resourceGroupName, String actionGroupName,
    ...
    SyncPoller<PollResult<Void>, Void> beginReconcileNsp(String resourceGroupName, String actionGroupName,
        String networkSecurityPerimeterConfigurationName);
