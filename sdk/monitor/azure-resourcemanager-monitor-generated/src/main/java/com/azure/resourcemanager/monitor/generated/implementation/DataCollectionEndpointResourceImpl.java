...
import com.azure.resourcemanager.monitor.generated.models.ResourceForUpdateProperties;
import java.util.Collections;
import java.util.List;
import java.util.Map;

public final class DataCollectionEndpointResourceImpl implements DataCollectionEndpointResource,
    DataCollectionEndpointResource.Definition, DataCollectionEndpointResource.Update {
    ...
    public DataCollectionEndpointMetricsIngestion metricsIngestion() {
        return this.innerModel().metricsIngestion();
    }
    ...
    public DataCollectionEndpointFailoverConfiguration failoverConfiguration() {
        return this.innerModel().failoverConfiguration();
    }
    ...
    public DataCollectionEndpointResource create() {
        this.innerObject = serviceManager.serviceClient().getDataCollectionEndpoints()
    ...
    public DataCollectionEndpointResource create(Context context) {
        this.innerObject = serviceManager.serviceClient().getDataCollectionEndpoints()
            .createWithResponse(resourceGroupName, dataCollectionEndpointName, this.innerModel(), context).getValue();
        return this;
    }

    DataCollectionEndpointResourceImpl(String name,
    ...
    public DataCollectionEndpointResource apply() {
        this.innerObject = serviceManager.serviceClient().getDataCollectionEndpoints()
            .updateWithResponse(resourceGroupName, dataCollectionEndpointName, updateBody, Context.NONE).getValue();
        return this;
    }

    public DataCollectionEndpointResource apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getDataCollectionEndpoints()
            .updateWithResponse(resourceGroupName, dataCollectionEndpointName, updateBody, context).getValue();
        return this;
    }

    DataCollectionEndpointResourceImpl(DataCollectionEndpointResourceInner innerObject,
        com.azure.resourcemanager.monitor.generated.MonitorManager serviceManager) {
        this.innerObject = innerObject;
        this.serviceManager = serviceManager;
        this.resourceGroupName = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "resourceGroups");
        this.dataCollectionEndpointName
            = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "dataCollectionEndpoints");
    }

    public DataCollectionEndpointResource refresh() {
        this.innerObject = serviceManager.serviceClient().getDataCollectionEndpoints()
            .getByResourceGroupWithResponse(resourceGroupName, dataCollectionEndpointName, Context.NONE).getValue();
        return this;
    }

    public DataCollectionEndpointResource refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getDataCollectionEndpoints()
            .getByResourceGroupWithResponse(resourceGroupName, dataCollectionEndpointName, context).getValue();
        return this;
    }
    ...
    public DataCollectionEndpointResourceImpl withIdentity(DataCollectionEndpointResourceIdentity identity) {
    ...
    public DataCollectionEndpointResourceImpl
    ...
    public DataCollectionEndpointResourceImpl
        ...
        this.innerModel().withMetricsIngestion(metricsIngestion);
        return this;
    }
    ...
    public DataCollectionEndpointResourceImpl
        ...
        this.innerModel().withFailoverConfiguration(failoverConfiguration);
        return this;
    }

    public DataCollectionEndpointResourceImpl withMetadata(DataCollectionEndpointMetadata metadata) {
        this.innerModel().withMetadata(metadata);
        return this;
    }

    public DataCollectionEndpointResourceImpl withIdentity(ResourceForUpdateIdentity identity) {
        this.updateBody.withIdentity(identity);
        return this;
    }

    public DataCollectionEndpointResourceImpl withKind(String kind) {
        this.updateBody.withKind(kind);
        return this;
    }

    public DataCollectionEndpointResourceImpl withProperties(ResourceForUpdateProperties properties) {
