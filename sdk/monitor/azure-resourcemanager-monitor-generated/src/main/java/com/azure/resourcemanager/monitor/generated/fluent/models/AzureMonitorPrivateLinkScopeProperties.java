...
public final class AzureMonitorPrivateLinkScopeProperties
     ...
     */
    private List<PrivateEndpointConnectionAutoGeneratedInner> privateEndpointConnections;
     ...
     */
    public List<PrivateEndpointConnectionAutoGeneratedInner> privateEndpointConnections() {
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("accessModeSettings".equals(fieldName)) {
                    ...
                    List<PrivateEndpointConnectionAutoGeneratedInner> privateEndpointConnections
                        = reader.readArray(reader1 -> PrivateEndpointConnectionAutoGeneratedInner.fromJson(reader1));
