...
public final class MetricAlertResourceCollection {
    ...
    /*
     * URL to fetch the next set of alert rule resources.
     */
    ...
    /**
     * Get the nextLink property: URL to fetch the next set of alert rule resources.
     *
    ...
    /**
     * Set the nextLink property: URL to fetch the next set of alert rule resources.
     *
     * @param nextLink the nextLink value to set.
     * @return the MetricAlertResourceCollection object itself.
     */
    public MetricAlertResourceCollection withNextLink(String nextLink) {
