...
import com.azure.resourcemanager.monitor.generated.models.DataCollectionRuleEndpoints;
...
import com.azure.resourcemanager.monitor.generated.models.DataCollectionRuleResourceIdentity;
...
import com.azure.resourcemanager.monitor.generated.models.ResourceForUpdateAutoGenerated;
import com.azure.resourcemanager.monitor.generated.models.ResourceForUpdateIdentity;
...
public final class DataCollectionRuleResourceImpl
    ...
    public DataCollectionRuleReferences references() {
        return this.innerModel().references();
    }

    public DataCollectionRuleAgentSettings agentSettings() {
        return this.innerModel().agentSettings();
    }
    ...
    private ResourceForUpdateAutoGenerated updateBody;
    ...
    public DataCollectionRuleResource create() {
        this.innerObject = serviceManager.serviceClient().getDataCollectionRules()
            .createWithResponse(resourceGroupName, dataCollectionRuleName, this.innerModel(), Context.NONE).getValue();
        return this;
    }

    public DataCollectionRuleResource create(Context context) {
        this.innerObject = serviceManager.serviceClient().getDataCollectionRules()
            .createWithResponse(resourceGroupName, dataCollectionRuleName, this.innerModel(), context).getValue();
        return this;
    }

    DataCollectionRuleResourceImpl(String name,
    ...
    public DataCollectionRuleResourceImpl update() {
        this.updateBody = new ResourceForUpdateAutoGenerated();
        return this;
    }

    public DataCollectionRuleResource apply() {
        this.innerObject = serviceManager.serviceClient().getDataCollectionRules()
            .updateWithResponse(resourceGroupName, dataCollectionRuleName, updateBody, Context.NONE).getValue();
        return this;
    }

    public DataCollectionRuleResource apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getDataCollectionRules()
            .updateWithResponse(resourceGroupName, dataCollectionRuleName, updateBody, context).getValue();
        return this;
    }

    DataCollectionRuleResourceImpl(DataCollectionRuleResourceInner innerObject,
        com.azure.resourcemanager.monitor.generated.MonitorManager serviceManager) {
        this.innerObject = innerObject;
        this.serviceManager = serviceManager;
        this.resourceGroupName = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "resourceGroups");
        this.dataCollectionRuleName
            = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "dataCollectionRules");
    }

    public DataCollectionRuleResource refresh() {
        this.innerObject = serviceManager.serviceClient().getDataCollectionRules()
            .getByResourceGroupWithResponse(resourceGroupName, dataCollectionRuleName, Context.NONE).getValue();
        return this;
    }

    public DataCollectionRuleResource refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getDataCollectionRules()
            .getByResourceGroupWithResponse(resourceGroupName, dataCollectionRuleName, context).getValue();
        return this;
    }
    ...
    public DataCollectionRuleResourceImpl withIdentity(DataCollectionRuleResourceIdentity identity) {
    ...
    public DataCollectionRuleResourceImpl withReferences(DataCollectionRuleReferences references) {
        this.innerModel().withReferences(references);
        return this;
    }

    public DataCollectionRuleResourceImpl withAgentSettings(DataCollectionRuleAgentSettings agentSettings) {
        this.innerModel().withAgentSettings(agentSettings);
        return this;
    }
    ...
    public DataCollectionRuleResourceImpl withIdentity(ResourceForUpdateIdentity identity) {
