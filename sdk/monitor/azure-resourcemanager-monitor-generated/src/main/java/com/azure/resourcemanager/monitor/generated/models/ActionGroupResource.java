...
public interface ActionGroupResource {
     ...
     */
    void createNotificationsAtActionGroupResourceLevel(NotificationRequestBody notificationRequest);
     ...
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     */
    void createNotificationsAtActionGroupResourceLevel(NotificationRequestBody notificationRequest, Context context);
