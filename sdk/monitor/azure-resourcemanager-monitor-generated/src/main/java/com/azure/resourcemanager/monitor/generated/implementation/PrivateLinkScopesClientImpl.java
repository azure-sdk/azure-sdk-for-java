...
public final class PrivateLinkScopesClientImpl implements PrivateLinkScopesClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<AzureMonitorPrivateLinkScopeInner> getByResourceGroupAsync(String resourceGroupName,
        String scopeName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<AzureMonitorPrivateLinkScopeInner> createOrUpdateAsync(String resourceGroupName, String scopeName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<AzureMonitorPrivateLinkScopeInner> updateTagsAsync(String resourceGroupName, String scopeName,
