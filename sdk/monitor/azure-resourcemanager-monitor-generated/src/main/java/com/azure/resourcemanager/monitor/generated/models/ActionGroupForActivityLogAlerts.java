...
@Fluent
public final class ActionGroupForActivityLogAlerts {
    /*
     ...
     * @return the ActionGroupForActivityLogAlerts object itself.
     */
    public ActionGroupForActivityLogAlerts withActionGroupId(String actionGroupId) {
     ...
     * @return the ActionGroupForActivityLogAlerts object itself.
     */
    public ActionGroupForActivityLogAlerts withWebhookProperties(Map<String, String> webhookProperties) {
            ...
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException(
                        "Missing required property actionGroupId in model ActionGroupForActivityLogAlerts"));
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(ActionGroupForActivityLogAlerts.class);
}
