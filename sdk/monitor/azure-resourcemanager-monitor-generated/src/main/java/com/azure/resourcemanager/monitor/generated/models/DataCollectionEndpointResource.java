...
public interface DataCollectionEndpointResource {
    ...
    /**
     * Gets the identity property: Managed service identity of the resource.
     * 
    ...
    /**
     * Gets the metricsIngestion property: The endpoint used by clients to ingest metrics.
     * 
    ...
    /**
     * Gets the privateLinkScopedResources property: List of Azure Monitor Private Link Scope Resources to which this
    ...
    /**
     * Gets the failoverConfiguration property: Failover configuration on this endpoint. This property can only be
     * updated by Log Analytics Control Plane (LACP) for DCE with Log Analytics Destination.
     * 
     * @return the failoverConfiguration value.
     */
    DataCollectionEndpointFailoverConfiguration failoverConfiguration();

    /**
     * Gets the metadata property: Metadata for the resource. This property can only be updated by Log Analytics Control
     * Plane (LACP) for DCE with Log Analytics Destination.
     * 
     * @return the metadata value.
     */
    DataCollectionEndpointMetadata metadata();
    ...
    interface DefinitionStages {
        ...
        interface WithCreate extends DefinitionStages.WithTags, DefinitionStages.WithKind,
            DefinitionStages.WithIdentity, DefinitionStages.WithDescription, DefinitionStages.WithImmutableId,
            DefinitionStages.WithConfigurationAccess, DefinitionStages.WithLogsIngestion,
            DefinitionStages.WithMetricsIngestion, DefinitionStages.WithNetworkAcls,
            DefinitionStages.WithFailoverConfiguration, DefinitionStages.WithMetadata {
            /**
        ...
        /**
         * The stage of the DataCollectionEndpointResource definition allowing to specify identity.
         */
        interface WithIdentity {
            /**
             * Specifies the identity property: Managed service identity of the resource..
             * 
             * @param identity Managed service identity of the resource.
             * @return the next definition stage.
             */
            WithCreate withIdentity(DataCollectionEndpointResourceIdentity identity);
        }
        ...
        /**
         * The stage of the DataCollectionEndpointResource definition allowing to specify metricsIngestion.
         */
        interface WithMetricsIngestion {
            /**
             * Specifies the metricsIngestion property: The endpoint used by clients to ingest metrics..
             * 
             * @param metricsIngestion The endpoint used by clients to ingest metrics.
             * @return the next definition stage.
             */
            WithCreate withMetricsIngestion(DataCollectionEndpointMetricsIngestion metricsIngestion);
        }
        ...
        /**
         * The stage of the DataCollectionEndpointResource definition allowing to specify failoverConfiguration.
         */
        interface WithFailoverConfiguration {
            /**
             * Specifies the failoverConfiguration property: Failover configuration on this endpoint. This property can
             * only be updated by Log Analytics Control Plane (LACP) for DCE with Log Analytics Destination.
             * 
             * @param failoverConfiguration Failover configuration on this endpoint. This property can only be updated
             * by Log Analytics Control Plane (LACP) for DCE with Log Analytics Destination.
             * @return the next definition stage.
             */
            WithCreate withFailoverConfiguration(DataCollectionEndpointFailoverConfiguration failoverConfiguration);
        }

        /**
         * The stage of the DataCollectionEndpointResource definition allowing to specify metadata.
         */
        interface WithMetadata {
            /**
             * Specifies the metadata property: Metadata for the resource. This property can only be updated by Log
             * Analytics Control Plane (LACP) for DCE with Log Analytics Destination.
             * 
             * @param metadata Metadata for the resource. This property can only be updated by Log Analytics Control
             * Plane (LACP) for DCE with Log Analytics Destination.
             * @return the next definition stage.
             */
            WithCreate withMetadata(DataCollectionEndpointMetadata metadata);
        }
    }
    ...
    interface UpdateStages {
        ...
        /**
         * The stage of the DataCollectionEndpointResource update allowing to specify identity.
         */
        interface WithIdentity {
            /**
             ...
             * @return the next definition stage.
             */
            Update withIdentity(ResourceForUpdateIdentity identity);
        }

        /**
         * The stage of the DataCollectionEndpointResource update allowing to specify kind.
         */
        interface WithKind {
            /**
             * Specifies the kind property: Kind of Data Collection Endpoint.
             * 
             * @param kind Kind of Data Collection Endpoint.
             * @return the next definition stage.
             */
        ...
        /**
         * The stage of the DataCollectionEndpointResource update allowing to specify properties.
         */
        interface WithProperties {
            /**
             * Specifies the properties property: Properties of the Data Collection Endpoint that are being updated..
             * 
             * @param properties Properties of the Data Collection Endpoint that are being updated.
             * @return the next definition stage.
             */
            Update withProperties(ResourceForUpdateProperties properties);
        }
    }
