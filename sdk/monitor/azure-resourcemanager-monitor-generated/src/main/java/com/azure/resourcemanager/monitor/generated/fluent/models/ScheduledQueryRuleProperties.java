...
public final class ScheduledQueryRuleProperties implements JsonSerializable<ScheduledQueryRuleProperties> {
     ...
     */
    public ScheduledQueryRuleProperties
        withRuleResolveConfiguration(RuleResolveConfiguration ruleResolveConfiguration) {
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeNumberField("severity", this.severity == null ? null : this.severity.toLong());
        ...
        jsonWriter.writeJsonField("ruleResolveConfiguration", this.ruleResolveConfiguration);
    ...
    public static ScheduledQueryRuleProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                } else if ("ruleResolveConfiguration".equals(fieldName)) {
                    deserializedScheduledQueryRuleProperties.ruleResolveConfiguration
