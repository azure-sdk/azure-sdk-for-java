...
public interface DataCollectionRuleResource {
     ...
     */
    DataCollectionRuleResourceIdentity identity();
    ...
    /**
     * Gets the endpoints property: Defines the ingestion endpoints to send data to via this rule.
     * 
    ...
    /**
     * Gets the references property: Defines all the references that may be used in other sections of the DCR.
     * 
    ...
    /**
     * Gets the agentSettings property: Agent settings used to modify agent behavior on a given host.
     * 
     * @return the agentSettings value.
     */
    DataCollectionRuleAgentSettings agentSettings();
    ...
    /**
     * Gets the dataSources property: The specification of data sources.
    ...
    interface DefinitionStages {
        ...
        interface WithCreate extends DefinitionStages.WithTags, DefinitionStages.WithKind,
            DefinitionStages.WithIdentity, DefinitionStages.WithDescription,
            DefinitionStages.WithDataCollectionEndpointId, DefinitionStages.WithReferences,
            DefinitionStages.WithAgentSettings, DefinitionStages.WithStreamDeclarations,
            DefinitionStages.WithDataSources, DefinitionStages.WithDestinations, DefinitionStages.WithDataFlows {
            /**
        ...
        /**
         * The stage of the DataCollectionRuleResource definition allowing to specify identity.
         */
        interface WithIdentity {
             ...
             * @return the next definition stage.
             */
            WithCreate withIdentity(DataCollectionRuleResourceIdentity identity);
        }
        ...
        /**
         * The stage of the DataCollectionRuleResource definition allowing to specify references.
         */
        interface WithReferences {
            /**
             * Specifies the references property: Defines all the references that may be used in other sections of the
             * DCR.
             * 
             * @param references Defines all the references that may be used in other sections of the DCR.
             * @return the next definition stage.
             */
            WithCreate withReferences(DataCollectionRuleReferences references);
        }

        /**
         * The stage of the DataCollectionRuleResource definition allowing to specify agentSettings.
         */
        interface WithAgentSettings {
            /**
             * Specifies the agentSettings property: Agent settings used to modify agent behavior on a given host.
             * 
             * @param agentSettings Agent settings used to modify agent behavior on a given host.
             * @return the next definition stage.
             */
            WithCreate withAgentSettings(DataCollectionRuleAgentSettings agentSettings);
        }
        ...
        interface WithDataSources {
            /**
             * Specifies the dataSources property: The specification of data sources.
    ...
    interface UpdateStages {
        ...
        /**
         * The stage of the DataCollectionRuleResource update allowing to specify identity.
         */
        interface WithIdentity {
            /**
