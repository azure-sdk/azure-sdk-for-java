 ...
 */
@Fluent
public final class SubscriptionScopeMetricInner {
    /*
     * the metric Id.
     */
     ...
     * @return the SubscriptionScopeMetricInner object itself.
     */
    public SubscriptionScopeMetricInner withUnit(MetricUnit unit) {
        this.unit = unit;
        return this;
    }
    ...
    public void validate() {
        ...
        if (type() == null) {
            throw LOGGER.logExceptionAsError(
                new IllegalArgumentException("Missing required property type in model SubscriptionScopeMetricInner"));
        }
        if (name() == null) {
            throw LOGGER.logExceptionAsError(
                new IllegalArgumentException("Missing required property name in model SubscriptionScopeMetricInner"));
        } else {
            name().validate();
        }
        if (unit() == null) {
            throw LOGGER.logExceptionAsError(
                new IllegalArgumentException("Missing required property unit in model SubscriptionScopeMetricInner"));
        }
        if (timeseries() == null) {
