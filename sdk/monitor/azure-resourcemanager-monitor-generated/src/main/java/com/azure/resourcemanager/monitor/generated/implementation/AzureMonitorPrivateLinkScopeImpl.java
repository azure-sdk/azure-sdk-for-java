...
public final class AzureMonitorPrivateLinkScopeImpl implements AzureMonitorPrivateLinkScope,
    ...
    public List<PrivateEndpointConnectionAutoGenerated> privateEndpointConnections() {
        List<PrivateEndpointConnectionAutoGeneratedInner> inner = this.innerModel().privateEndpointConnections();
        if (inner != null) {
            return Collections.unmodifiableList(
                inner.stream().map(inner1 -> new PrivateEndpointConnectionAutoGeneratedImpl(inner1, this.manager()))
