...
public final class ResourceProvidersClientImpl implements ResourceProvidersClient {
    ...
    public interface ResourceProvidersService {
        ...
        Mono<Response<TestNotificationDetailsResponseAutoGeneratedInner>>
            getTestNotificationsAtTenantActionGroupResourceLevel(@HostParam("$host") String endpoint,
                @PathParam("managementGroupId") String managementGroupId,
                @PathParam("tenantActionGroupName") String tenantActionGroupName,
                @HeaderParam("x-ms-client-tenant-id") String xMsClientTenantId,
                @QueryParam("api-version") String apiVersion, @PathParam("notificationId") String notificationId,
                @HeaderParam("Accept") String accept, Context context);
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> createNotificationsAtTenantActionGroupResourceLevelWithResponseAsync(
        ...
        return FluxUtil
            .withContext(context -> service.createNotificationsAtTenantActionGroupResourceLevel(
                this.client.getEndpoint(), managementGroupId, tenantActionGroupName, xMsClientTenantId, apiVersion,
    ...
    private Mono<Response<Flux<ByteBuffer>>> createNotificationsAtTenantActionGroupResourceLevelWithResponseAsync(
        ...
        return service.createNotificationsAtTenantActionGroupResourceLevel(this.client.getEndpoint(), managementGroupId,
            tenantActionGroupName, xMsClientTenantId, apiVersion, notificationRequest, accept, context);
    }
    ...
    private
        PollerFlux<PollResult<TestNotificationDetailsResponseAutoGeneratedInner>, TestNotificationDetailsResponseAutoGeneratedInner>
        ...
        return this.client
            .<TestNotificationDetailsResponseAutoGeneratedInner, TestNotificationDetailsResponseAutoGeneratedInner>getLroResult(
                mono, this.client.getHttpPipeline(), TestNotificationDetailsResponseAutoGeneratedInner.class,
                TestNotificationDetailsResponseAutoGeneratedInner.class, this.client.getContext());
    }
    ...
    private
        ...
        return this.client
            .<TestNotificationDetailsResponseAutoGeneratedInner, TestNotificationDetailsResponseAutoGeneratedInner>getLroResult(
                mono, this.client.getHttpPipeline(), TestNotificationDetailsResponseAutoGeneratedInner.class,
                TestNotificationDetailsResponseAutoGeneratedInner.class, context);
    }
    ...
    public
        ...
        return this.beginCreateNotificationsAtTenantActionGroupResourceLevelAsync(managementGroupId,
            tenantActionGroupName, xMsClientTenantId, notificationRequest).getSyncPoller();
    }
    ...
    public
        ...
        return this.beginCreateNotificationsAtTenantActionGroupResourceLevelAsync(managementGroupId,
            tenantActionGroupName, xMsClientTenantId, notificationRequest, context).getSyncPoller();
    }
    ...
    private Mono<TestNotificationDetailsResponseAutoGeneratedInner>
        ...
        return beginCreateNotificationsAtTenantActionGroupResourceLevelAsync(managementGroupId, tenantActionGroupName,
            xMsClientTenantId, notificationRequest).last().flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<TestNotificationDetailsResponseAutoGeneratedInner>
        createNotificationsAtTenantActionGroupResourceLevelAsync(String managementGroupId, String tenantActionGroupName,
            String xMsClientTenantId, TenantNotificationRequestBody notificationRequest, Context context) {
        return beginCreateNotificationsAtTenantActionGroupResourceLevelAsync(managementGroupId, tenantActionGroupName,
            xMsClientTenantId, notificationRequest, context).last().flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<Response<TestNotificationDetailsResponseAutoGeneratedInner>>
        getTestNotificationsAtTenantActionGroupResourceLevelWithResponseAsync(String managementGroupId,
            String tenantActionGroupName, String xMsClientTenantId, String notificationId) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.getTestNotificationsAtTenantActionGroupResourceLevel(
                this.client.getEndpoint(), managementGroupId, tenantActionGroupName, xMsClientTenantId, apiVersion,
                notificationId, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<TestNotificationDetailsResponseAutoGeneratedInner>>
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.getTestNotificationsAtTenantActionGroupResourceLevel(this.client.getEndpoint(),
            managementGroupId, tenantActionGroupName, xMsClientTenantId, apiVersion, notificationId, accept, context);
    }
    ...
    private Mono<TestNotificationDetailsResponseAutoGeneratedInner>
        ...
        return getTestNotificationsAtTenantActionGroupResourceLevelWithResponseAsync(managementGroupId,
            tenantActionGroupName, xMsClientTenantId, notificationId).flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
    ...
    public Response<TestNotificationDetailsResponseAutoGeneratedInner>
        getTestNotificationsAtTenantActionGroupResourceLevelWithResponse(String managementGroupId,
            String tenantActionGroupName, String xMsClientTenantId, String notificationId, Context context) {
        return getTestNotificationsAtTenantActionGroupResourceLevelWithResponseAsync(managementGroupId,
            tenantActionGroupName, xMsClientTenantId, notificationId, context).block();
    }
    ...
    public TestNotificationDetailsResponseAutoGeneratedInner getTestNotificationsAtTenantActionGroupResourceLevel(
        ...
        return getTestNotificationsAtTenantActionGroupResourceLevelWithResponse(managementGroupId,
            tenantActionGroupName, xMsClientTenantId, notificationId, Context.NONE).getValue();
    }
}
