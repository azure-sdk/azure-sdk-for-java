...
public final class MetricsClientImpl implements MetricsClient {
        ...
        return FluxUtil
            .withContext(
                context -> service.listAtSubscriptionScope(this.client.getEndpoint(), this.client.getSubscriptionId(),
                    this.client.getApiVersion(), region, timespan, interval, metricnames, aggregation, top, orderBy,
                    filter, resultType, metricnamespace, autoAdjustTimegrain, validateDimensions, accept, context))
    ...
    private Mono<Response<SubscriptionScopeMetricResponseInner>> listAtSubscriptionScopeWithResponseAsync(String region,
        ...
        return service.listAtSubscriptionScope(this.client.getEndpoint(), this.client.getSubscriptionId(),
            this.client.getApiVersion(), region, timespan, interval, metricnames, aggregation, top, orderBy, filter,
            resultType, metricnamespace, autoAdjustTimegrain, validateDimensions, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<SubscriptionScopeMetricResponseInner> listAtSubscriptionScopeAsync(String region) {
    ...
    private Mono<Response<SubscriptionScopeMetricResponseInner>> listAtSubscriptionScopePostWithResponseAsync(
        ...
        return FluxUtil
            .withContext(context -> service.listAtSubscriptionScopePost(this.client.getEndpoint(),
                this.client.getSubscriptionId(), this.client.getApiVersion(), region, timespan, interval, metricnames,
    ...
    private Mono<Response<SubscriptionScopeMetricResponseInner>> listAtSubscriptionScopePostWithResponseAsync(
        ...
        return service.listAtSubscriptionScopePost(this.client.getEndpoint(), this.client.getSubscriptionId(),
            this.client.getApiVersion(), region, timespan, interval, metricnames, aggregation, top, orderBy, filter,
            resultType, metricnamespace, autoAdjustTimegrain, validateDimensions, body, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<SubscriptionScopeMetricResponseInner> listAtSubscriptionScopePostAsync(String region) {
        final String timespan = null;
        final Duration interval = null;
        final String metricnames = null;
        final String aggregation = null;
    ...
    private Mono<Response<ResponseInner>> listWithResponseAsync(String resourceUri, String timespan, Duration interval,
        ...
        return FluxUtil
            .withContext(context -> service.list(this.client.getEndpoint(), resourceUri, timespan, interval,
                metricnames, aggregation, top, orderBy, filter, resultType, this.client.getApiVersion(),
                metricnamespace, autoAdjustTimegrain, validateDimensions, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<ResponseInner>> listWithResponseAsync(String resourceUri, String timespan, Duration interval,
        ...
        return service.list(this.client.getEndpoint(), resourceUri, timespan, interval, metricnames, aggregation, top,
            ...
            validateDimensions, accept, context);
    }
