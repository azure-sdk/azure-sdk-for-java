...
public final class MetricsOperationsImpl implements MetricsOperations {
    ...
    public Response<ResponseModel> listAtSubscriptionScopeWithResponse(String region, String timespan, String interval,
        ...
        Context context) {
        Response<ResponseInner> inner = this.serviceClient().listAtSubscriptionScopeWithResponse(region, timespan,
            interval, metricnames, aggregation, top, orderBy, filter, resultType, metricnamespace, autoAdjustTimegrain,
    ...
    public ResponseModel listAtSubscriptionScope(String region) {
        ResponseInner inner = this.serviceClient().listAtSubscriptionScope(region);
        if (inner != null) {
    ...
    public Response<ResponseModel> listAtSubscriptionScopePostWithResponse(String region, String timespan,
        ...
        Response<ResponseInner> inner = this.serviceClient().listAtSubscriptionScopePostWithResponse(region, timespan,
            interval, metricnames, aggregation, top, orderBy, filter, resultType, metricnamespace, autoAdjustTimegrain,
    ...
    public ResponseModel listAtSubscriptionScopePost(String region) {
        ResponseInner inner = this.serviceClient().listAtSubscriptionScopePost(region);
        if (inner != null) {
            return new ResponseModelImpl(inner, this.manager());
        } else {
            return null;
