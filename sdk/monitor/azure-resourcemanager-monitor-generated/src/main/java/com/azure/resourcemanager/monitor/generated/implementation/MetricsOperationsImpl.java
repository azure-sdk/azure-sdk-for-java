...
public final class MetricsOperationsImpl implements MetricsOperations {
    ...
    public Response<ResponseModel> listAtSubscriptionScopePostWithResponse(String region,
        SubscriptionScopeMetricsRequestBodyParameters body, Context context) {
        Response<ResponseInner> inner
            = this.serviceClient().listAtSubscriptionScopePostWithResponse(region, body, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
                new ResponseModelImpl(inner.getValue(), this.manager()));
        } else {
