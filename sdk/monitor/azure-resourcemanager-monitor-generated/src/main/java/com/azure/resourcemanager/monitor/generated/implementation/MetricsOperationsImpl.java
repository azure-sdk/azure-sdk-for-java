...
public final class MetricsOperationsImpl implements MetricsOperations {
    ...
    public Response<ResponseModel> listAtSubscriptionScopeWithResponse(String region, String timespan, String interval,
        ...
        Response<ResponseInner> inner = this.serviceClient()
            .listAtSubscriptionScopeWithResponse(region, timespan, interval, metricnames, aggregation, top, orderBy,
    ...
    public Response<ResponseModel> listAtSubscriptionScopePostWithResponse(String region, String timespan,
        ...
        Response<ResponseInner> inner = this.serviceClient()
            .listAtSubscriptionScopePostWithResponse(region, timespan, interval, metricnames, aggregation, top, orderBy,
                filter, resultType, metricnamespace, autoAdjustTimegrain, validateDimensions, rollupby, body, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
                new ResponseModelImpl(inner.getValue(), this.manager()));
        } else {
