...
public final class PrivateEndpointConnectionsClientImpl implements PrivateEndpointConnectionsClient {
    ...
    public interface PrivateEndpointConnectionsService {
        ...
        Mono<Response<PrivateEndpointConnectionAutoGeneratedInner>> get(@HostParam("$host") String endpoint,
        ...
        Mono<Response<Flux<ByteBuffer>>> createOrUpdate(@HostParam("$host") String endpoint,
            ...
            @PathParam("scopeName") String scopeName,
            @PathParam("privateEndpointConnectionName") String privateEndpointConnectionName,
            @BodyParam("application/json") PrivateEndpointConnectionAutoGeneratedInner parameters,
            @HeaderParam("Accept") String accept, Context context);
    ...
    private Mono<Response<PrivateEndpointConnectionAutoGeneratedInner>> getWithResponseAsync(String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PrivateEndpointConnectionAutoGeneratedInner> getAsync(String resourceGroupName, String scopeName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<PrivateEndpointConnectionAutoGeneratedInner> getWithResponse(String resourceGroupName,
        String scopeName, String privateEndpointConnectionName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public PrivateEndpointConnectionAutoGeneratedInner get(String resourceGroupName, String scopeName,
        String privateEndpointConnectionName) {
    ...
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String resourceGroupName, String scopeName,
        String privateEndpointConnectionName, PrivateEndpointConnectionAutoGeneratedInner parameters) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String resourceGroupName, String scopeName,
        String privateEndpointConnectionName, PrivateEndpointConnectionAutoGeneratedInner parameters, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    private
        PollerFlux<PollResult<PrivateEndpointConnectionAutoGeneratedInner>, PrivateEndpointConnectionAutoGeneratedInner>
        ...
        return this.client
            .<PrivateEndpointConnectionAutoGeneratedInner, PrivateEndpointConnectionAutoGeneratedInner>getLroResult(
                mono, this.client.getHttpPipeline(), PrivateEndpointConnectionAutoGeneratedInner.class,
                PrivateEndpointConnectionAutoGeneratedInner.class, this.client.getContext());
    }
    ...
    private
        PollerFlux<PollResult<PrivateEndpointConnectionAutoGeneratedInner>, PrivateEndpointConnectionAutoGeneratedInner>
        beginCreateOrUpdateAsync(String resourceGroupName, String scopeName, String privateEndpointConnectionName,
            PrivateEndpointConnectionAutoGeneratedInner parameters, Context context) {
        context = this.client.mergeContext(context);
        ...
        return this.client
            .<PrivateEndpointConnectionAutoGeneratedInner, PrivateEndpointConnectionAutoGeneratedInner>getLroResult(
                mono, this.client.getHttpPipeline(), PrivateEndpointConnectionAutoGeneratedInner.class,
                PrivateEndpointConnectionAutoGeneratedInner.class, context);
    }
    ...
    public
        ...
        beginCreateOrUpdate(String resourceGroupName, String scopeName, String privateEndpointConnectionName,
            PrivateEndpointConnectionAutoGeneratedInner parameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PrivateEndpointConnectionAutoGeneratedInner> createOrUpdateAsync(String resourceGroupName,
        String scopeName, String privateEndpointConnectionName,
        PrivateEndpointConnectionAutoGeneratedInner parameters) {
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PrivateEndpointConnectionAutoGeneratedInner> createOrUpdateAsync(String resourceGroupName,
        String scopeName, String privateEndpointConnectionName, PrivateEndpointConnectionAutoGeneratedInner parameters,
        Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public PrivateEndpointConnectionAutoGeneratedInner createOrUpdate(String resourceGroupName, String scopeName,
        String privateEndpointConnectionName, PrivateEndpointConnectionAutoGeneratedInner parameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PrivateEndpointConnectionListResultInner> listByPrivateLinkScopeAsync(String resourceGroupName,
        String scopeName) {
