...
public final class PredictiveMetricsClientImpl implements PredictiveMetricsClient {
    ...
    private Mono<PredictiveResponseInner> getAsync(
        ...
        return getWithResponseAsync(
                resourceGroupName, autoscaleSettingName, aggregation, timespan, interval, metricnamespace, metricnames)
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PredictiveResponseInner> getAsync(
        String resourceGroupName, String autoscaleSettingName, String aggregation) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public PredictiveResponseInner get(String resourceGroupName, String autoscaleSettingName, String aggregation) {
        final String timespan = null;
        final Duration interval = null;
        final String metricnamespace = null;
        final String metricnames = null;
