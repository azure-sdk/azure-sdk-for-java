...
public final class ActionGroupsClientImpl implements ActionGroupsClient {
    ...
    private Mono<PagedResponse<NetworkSecurityPerimeterConfigurationInner>>
        ...
        return FluxUtil
            .withContext(context -> service.listNsp(this.client.getEndpoint(), resourceGroupName, actionGroupName,
    ...
    private Mono<PagedResponse<NetworkSecurityPerimeterConfigurationInner>>
        ...
        return service
            .listNsp(this.client.getEndpoint(), resourceGroupName, actionGroupName, this.client.getSubscriptionId(),
        ...
        return FluxUtil
            .withContext(
                context -> service.getNsp(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
                    actionGroupName, networkSecurityPerimeterConfigurationName, apiVersion, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> reconcileNspWithResponseAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(context -> service.reconcileNsp(this.client.getEndpoint(), this.client.getSubscriptionId(),
                resourceGroupName, actionGroupName, networkSecurityPerimeterConfigurationName, apiVersion, accept,
                context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
