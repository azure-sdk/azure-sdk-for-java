...
public final class ActionGroupsClientImpl implements ActionGroupsClient {
    ...
    private Mono<Response<ActionGroupResourceInner>> createOrUpdateWithResponseAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(
                context -> service.createOrUpdate(this.client.getEndpoint(), resourceGroupName, actionGroupName,
                    this.client.getSubscriptionId(), this.client.getApiVersion(), actionGroup, accept, context))
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ActionGroupResourceInner> createOrUpdateAsync(String resourceGroupName, String actionGroupName,
    ...
    private Mono<Response<ActionGroupResourceInner>> getByResourceGroupWithResponseAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(context -> service.getByResourceGroup(this.client.getEndpoint(), resourceGroupName,
                actionGroupName, this.client.getSubscriptionId(), this.client.getApiVersion(), accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<ActionGroupResourceInner>> updateWithResponseAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(context -> service.update(this.client.getEndpoint(), this.client.getSubscriptionId(),
                resourceGroupName, actionGroupName, this.client.getApiVersion(), actionGroupPatch, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<ActionGroupResourceInner>> updateWithResponseAsync(String resourceGroupName,
        ...
        return service.update(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            actionGroupName, this.client.getApiVersion(), actionGroupPatch, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ActionGroupResourceInner> updateAsync(String resourceGroupName, String actionGroupName,
    ...
    private Mono<Response<Flux<ByteBuffer>>> createNotificationsAtActionGroupResourceLevelWithResponseAsync(
        ...
        return FluxUtil
            .withContext(context -> service.createNotificationsAtActionGroupResourceLevel(this.client.getEndpoint(),
                this.client.getSubscriptionId(), resourceGroupName, actionGroupName, this.client.getApiVersion(),
    ...
    private Mono<Response<TestNotificationDetailsResponseInner>>
        ...
        return FluxUtil
            .withContext(context -> service.getTestNotificationsAtActionGroupResourceLevel(this.client.getEndpoint(),
                this.client.getSubscriptionId(), resourceGroupName, actionGroupName, notificationId,
    ...
    private Mono<Response<Void>> enableReceiverWithResponseAsync(String resourceGroupName, String actionGroupName,
        ...
        return FluxUtil
            .withContext(
                context -> service.enableReceiver(this.client.getEndpoint(), resourceGroupName, actionGroupName,
                    this.client.getSubscriptionId(), this.client.getApiVersion(), enableRequest, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> enableReceiverAsync(String resourceGroupName, String actionGroupName,
        EnableRequest enableRequest) {
