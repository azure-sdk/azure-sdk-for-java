...
public final class ActionGroupsClientImpl implements ActionGroupsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<Void>, Void> beginCreateNotificationsAtActionGroupResourceLevelAsync(
        String resourceGroupName, String actionGroupName, NotificationRequestBody notificationRequest) {
        Mono<Response<Flux<ByteBuffer>>> mono =
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<Void>, Void> beginCreateNotificationsAtActionGroupResourceLevel(
        String resourceGroupName, String actionGroupName, NotificationRequestBody notificationRequest) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> createNotificationsAtActionGroupResourceLevelAsync(
        String resourceGroupName, String actionGroupName, NotificationRequestBody notificationRequest) {
        return beginCreateNotificationsAtActionGroupResourceLevelAsync(
                resourceGroupName, actionGroupName, notificationRequest)
            .last()
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public void createNotificationsAtActionGroupResourceLevel(
        String resourceGroupName, String actionGroupName, NotificationRequestBody notificationRequest) {
        createNotificationsAtActionGroupResourceLevelAsync(resourceGroupName, actionGroupName, notificationRequest)
            .block();
    }
