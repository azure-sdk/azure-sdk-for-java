...
public interface MetricsOperationsClient {
    ...
    Response<ResponseInner> listAtSubscriptionScopeWithResponse(String region, String timespan, String interval,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<ResponseInner> listAtSubscriptionScopePostWithResponse(String region, String timespan, String interval,
        String metricnames, String aggregation, Integer top, String orderBy, String filter, MetricResultType resultType,
        String metricnamespace, Boolean autoAdjustTimegrain, Boolean validateDimensions, String rollupby,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<ResponseInner> listWithResponse(String resourceUri, String timespan, String interval, String metricnames,
