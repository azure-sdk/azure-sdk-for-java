...
public interface MetricsOperationsClient {
    ...
    Response<SubscriptionScopeMetricResponseInner> listAtSubscriptionScopeWithResponse(
        String region,
        String timespan,
        String interval,
        String metricnames,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<SubscriptionScopeMetricResponseInner> listAtSubscriptionScopePostWithResponse(
        String region,
        String timespan,
        String interval,
        String metricnames,
