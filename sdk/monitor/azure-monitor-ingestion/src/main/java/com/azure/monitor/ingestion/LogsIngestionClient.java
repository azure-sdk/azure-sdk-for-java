...
public final class LogsIngestionClient {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public void upload(String ruleId, String streamName, List<Map<String, Object>> body, String contentEncoding) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public void upload(String ruleId, String streamName, List<Map<String, Object>> body) {
        // Generated convenience method for uploadWithResponse
        RequestOptions requestOptions = new RequestOptions();
        uploadWithResponse(ruleId, streamName, BinaryData.fromObject(body), requestOptions).getValue();
    }
