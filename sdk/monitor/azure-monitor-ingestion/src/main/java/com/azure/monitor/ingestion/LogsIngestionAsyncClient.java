...
public final class LogsIngestionAsyncClient {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> upload(String ruleId, String streamName, List<Map<String, Object>> body, String contentEncoding) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> upload(String ruleId, String streamName, List<Map<String, Object>> body) {
        // Generated convenience method for uploadWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return uploadWithResponse(ruleId, streamName, BinaryData.fromObject(body), requestOptions)
            .flatMap(FluxUtil::toMono);
