...
import com.azure.resourcemanager.workloadssapvirtualinstance.models.SapCentralServerInstanceListResult;
...
public final class SapCentralServerInstancesClientImpl implements SapCentralServerInstancesClient {
     ...
     */
    SapCentralServerInstancesClientImpl(WorkloadsClientImpl client) {
    ...
    /**
     * The interface defining all the services for WorkloadsClientSapCentralServerInstances to be used by the proxy
    ...
    public interface SapCentralServerInstancesService {
        ...
        Mono<Response<SapCentralServerInstanceListResult>> list(@HostParam("$host") String endpoint,
        ...
        Mono<Response<Flux<ByteBuffer>>> create(@HostParam("$host") String endpoint,
            ...
            @BodyParam("application/json") SapCentralServerInstanceInner resource, @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<SapCentralServerInstanceInner>> update(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("sapVirtualInstanceName") String sapVirtualInstanceName,
            @PathParam("centralInstanceName") String centralInstanceName,
            @BodyParam("application/json") UpdateSapCentralInstanceRequest properties,
    ...
    private Mono<Response<Flux<ByteBuffer>>> createWithResponseAsync(String resourceGroupName,
        ...
        return service.create(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, sapVirtualInstanceName, centralInstanceName, resource, accept, context);
    }
    ...
    private Mono<Response<SapCentralServerInstanceInner>> updateWithResponseAsync(String resourceGroupName,
        ...
        return service.update(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, sapVirtualInstanceName, centralInstanceName, properties, accept, context);
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> startWithResponseAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(context -> service.start(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, sapVirtualInstanceName, centralInstanceName, body,
                accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> startWithResponseAsync(String resourceGroupName,
        ...
        return service.start(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, sapVirtualInstanceName, centralInstanceName, body, accept, context);
    }
