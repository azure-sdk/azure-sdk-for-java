...
public final class SapDatabaseInstancesImpl implements SapDatabaseInstances {
    ...
    public OperationStatusResult start(String resourceGroupName, String sapVirtualInstanceName,
        ...
        OperationStatusResultInner inner
            = this.serviceClient().start(resourceGroupName, sapVirtualInstanceName, databaseInstanceName, body);
        if (inner != null) {
    ...
    public OperationStatusResult stop(String resourceGroupName, String sapVirtualInstanceName,
        ...
        OperationStatusResultInner inner
            = this.serviceClient().stop(resourceGroupName, sapVirtualInstanceName, databaseInstanceName, body);
        if (inner != null) {
            return new OperationStatusResultImpl(inner, this.manager());
        } else {
            return null;
