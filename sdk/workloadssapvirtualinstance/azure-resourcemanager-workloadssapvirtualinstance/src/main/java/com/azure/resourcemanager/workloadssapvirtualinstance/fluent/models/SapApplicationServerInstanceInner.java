        ...
        if (location() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property location in model SapApplicationServerInstanceInner"));
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(SapApplicationServerInstanceInner.class);
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("id".equals(fieldName)) {
                    ...
                    deserializedSapApplicationServerInstanceInner.properties
