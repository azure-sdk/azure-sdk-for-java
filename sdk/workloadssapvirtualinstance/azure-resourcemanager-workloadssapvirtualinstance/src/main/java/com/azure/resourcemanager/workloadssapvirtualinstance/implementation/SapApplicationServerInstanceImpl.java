...
public final class SapApplicationServerInstanceImpl implements SapApplicationServerInstance,
    ...
    public OperationStatusResult start(StartRequest body) {
        return serviceManager.sapApplicationServerInstances()
            .start(resourceGroupName, sapVirtualInstanceName, applicationInstanceName, body);
    }
    ...
    public OperationStatusResult stop(StopRequest body) {
        return serviceManager.sapApplicationServerInstances()
            .stop(resourceGroupName, sapVirtualInstanceName, applicationInstanceName, body);
    }
