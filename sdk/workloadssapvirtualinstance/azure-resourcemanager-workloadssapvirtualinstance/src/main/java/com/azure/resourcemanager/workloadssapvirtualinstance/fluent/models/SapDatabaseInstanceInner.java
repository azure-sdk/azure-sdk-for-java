        ...
        if (location() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property location in model SapDatabaseInstanceInner"));
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(SapDatabaseInstanceInner.class);
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("id".equals(fieldName)) {
                    ...
                    deserializedSapDatabaseInstanceInner.properties = SapDatabaseProperties.fromJson(reader);
