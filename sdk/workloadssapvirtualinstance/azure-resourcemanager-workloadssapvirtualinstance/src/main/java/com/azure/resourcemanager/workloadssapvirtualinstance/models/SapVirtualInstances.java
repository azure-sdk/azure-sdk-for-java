...
public interface SapVirtualInstances {
     ...
     */
    Response<SapAvailabilityZoneDetailsResult> getAvailabilityZoneDetailsWithResponse(String location,
     ...
     */
    SapAvailabilityZoneDetailsResult getAvailabilityZoneDetails(String location,
     ...
     */
    Response<SapDiskConfigurationsResult> getDiskConfigurationsWithResponse(String location,
     ...
     */
    SapDiskConfigurationsResult getDiskConfigurations(String location, SapDiskConfigurationsRequest body);
     ...
     */
    Response<SapSupportedResourceSkusResult> getSapSupportedSkuWithResponse(String location,
     ...
     */
    SapSupportedResourceSkusResult getSapSupportedSku(String location, SapSupportedSkusRequest body);
     ...
     */
    Response<SapSizingRecommendationResult> getSizingRecommendationsWithResponse(String location,
     ...
     */
    SapSizingRecommendationResult getSizingRecommendations(String location, SapSizingRecommendationRequest body);
     ...
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     */
    void deleteByResourceGroup(String resourceGroupName, String sapVirtualInstanceName);
