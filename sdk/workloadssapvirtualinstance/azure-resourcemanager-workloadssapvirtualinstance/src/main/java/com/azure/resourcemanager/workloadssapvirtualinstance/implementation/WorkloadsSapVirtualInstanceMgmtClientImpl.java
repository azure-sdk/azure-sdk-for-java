...
/**
 * Initializes a new instance of the WorkloadsSapVirtualInstanceMgmtClientImpl type.
 */
@ServiceClient(builder = WorkloadsSapVirtualInstanceMgmtClientBuilder.class)
public final class WorkloadsSapVirtualInstanceMgmtClientImpl implements WorkloadsSapVirtualInstanceMgmtClient {
    /**
     * Service host.
     */
     ...
     */
    WorkloadsSapVirtualInstanceMgmtClientImpl(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter,
    ...
    private static final ClientLogger LOGGER = new ClientLogger(WorkloadsSapVirtualInstanceMgmtClientImpl.class);
}
