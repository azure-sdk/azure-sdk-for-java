...
public final class DeletedWorkbooksClientImpl implements DeletedWorkbooksClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<DeletedWorkbookInner> listAsync(CategoryType category, List<String> tags, Boolean canFetchContent,
        Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<DeletedWorkbookInner> list(CategoryType category, List<String> tags, Boolean canFetchContent,
        Context context) {
