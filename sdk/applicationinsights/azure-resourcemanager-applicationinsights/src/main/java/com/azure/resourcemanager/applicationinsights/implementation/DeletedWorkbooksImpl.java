...
public final class DeletedWorkbooksImpl implements DeletedWorkbooks {
    ...
    public PagedIterable<DeletedWorkbook> list(CategoryType category, List<String> tags, Boolean canFetchContent,
        Context context) {
        PagedIterable<DeletedWorkbookInner> inner = this.serviceClient().list(category, tags, canFetchContent, context);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new DeletedWorkbookImpl(inner1, this.manager()));
    }
