...
public final class PrivateLinkScopeOperationStatusClientImpl implements PrivateLinkScopeOperationStatusClient {
     ...
     */
    PrivateLinkScopeOperationStatusClientImpl(ApplicationInsightsManagementClientImpl client) {
        this.service =
            RestProxy
                .create(
    ...
    /**
     * The interface defining all the services for ApplicationInsightsManagementClientPrivateLinkScopeOperationStatus to
