...
import com.azure.resourcemanager.applicationinsights.fluent.models.PrivateEndpointConnectionListResultInner;
...
public final class PrivateEndpointConnectionsClientImpl implements PrivateEndpointConnectionsClient {
     ...
     */
    PrivateEndpointConnectionsClientImpl(ApplicationInsightsManagementClientImpl client) {
        this.service =
            RestProxy
                .create(
    ...
    /**
     * The interface defining all the services for ApplicationInsightsManagementClientPrivateEndpointConnections to be
