...
import com.azure.resourcemanager.applicationinsights.fluent.models.ScopedResourceInner;
import com.azure.resourcemanager.applicationinsights.models.ScopedResourceListResult;
...
public final class PrivateLinkScopedResourcesClientImpl implements PrivateLinkScopedResourcesClient {
     ...
     */
    PrivateLinkScopedResourcesClientImpl(ApplicationInsightsManagementClientImpl client) {
        this.service =
            RestProxy
                .create(
    ...
    /**
     * The interface defining all the services for ApplicationInsightsManagementClientPrivateLinkScopedResources to be
