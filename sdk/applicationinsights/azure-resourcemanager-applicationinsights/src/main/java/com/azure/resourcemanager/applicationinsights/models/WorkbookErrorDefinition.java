...
public final class WorkbookErrorDefinition extends ManagementError {
    ...
    /**
     * Reads an instance of WorkbookErrorDefinition from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of WorkbookErrorDefinition if the JsonReader was pointing to an instance of it, or null if it
     * was pointing to JSON null.
     * @throws IOException If an error occurs while reading the WorkbookErrorDefinition.
     */
    public static WorkbookErrorDefinition fromJson(JsonReader jsonReader) throws IOException {
    ...
    private static WorkbookErrorDefinition readManagementError(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            WorkbookErrorDefinition deserializedWorkbookErrorDefinition = new WorkbookErrorDefinition();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("code".equals(fieldName)) {
                    deserializedWorkbookErrorDefinition.code = reader.getString();
                } else if ("message".equals(fieldName)) {
                    deserializedWorkbookErrorDefinition.message = reader.getString();
                } else if ("target".equals(fieldName)) {
                    deserializedWorkbookErrorDefinition.target = reader.getString();
                } else if ("details".equals(fieldName)) {
                    List<ManagementError> details = reader.readArray(reader1 -> ManagementError.fromJson(reader1));
                    deserializedWorkbookErrorDefinition.details = details;
                    ...
                    deserializedWorkbookErrorDefinition.additionalInfo = additionalInfo;
                } else if ("innererror".equals(fieldName)) {
                    deserializedWorkbookErrorDefinition.innererror = WorkbookInnerErrorTrace.fromJson(reader);
                } else {
                    reader.skipChildren();
                }
            }

            return deserializedWorkbookErrorDefinition;
        });
    }
}
