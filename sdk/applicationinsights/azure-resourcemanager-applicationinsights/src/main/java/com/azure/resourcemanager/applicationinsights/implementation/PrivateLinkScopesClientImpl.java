...
import com.azure.resourcemanager.applicationinsights.models.AzureMonitorPrivateLinkScopeListResult;
...
public final class PrivateLinkScopesClientImpl implements PrivateLinkScopesClient {
     ...
     */
    PrivateLinkScopesClientImpl(ApplicationInsightsManagementClientImpl client) {
        this.service =
    ...
    /**
     * The interface defining all the services for ApplicationInsightsManagementClientPrivateLinkScopes to be used by
    ...
    public interface PrivateLinkScopesService {
        ...
        Mono<Response<AzureMonitorPrivateLinkScopeInner>> updateTags(
            ...
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("scopeName") String scopeName,
            @BodyParam("application/json") TagsResourcePrivateLinkScope privateLinkScopeTags,
            @HeaderParam("Accept") String accept,
            Context context);
    ...
    private Mono<Response<AzureMonitorPrivateLinkScopeInner>> updateTagsWithResponseAsync(
        String resourceGroupName, String scopeName, TagsResourcePrivateLinkScope privateLinkScopeTags) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    private Mono<Response<AzureMonitorPrivateLinkScopeInner>> updateTagsWithResponseAsync(
        String resourceGroupName,
        String scopeName,
        TagsResourcePrivateLinkScope privateLinkScopeTags,
        Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
