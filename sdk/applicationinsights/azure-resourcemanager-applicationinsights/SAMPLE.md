...
public final class AnalyticsItemsDeleteSamples {
    ...
    public static void
        ...
        manager.analyticsItems().deleteWithResponse("my-resource-group", "my-component", ItemScopePath.ANALYTICS_ITEMS,
...
public final class AnalyticsItemsGetSamples {
    ...
    public static void
        ...
        manager.analyticsItems().getWithResponse("my-resource-group", "my-component", ItemScopePath.ANALYTICS_ITEMS,
            "3466c160-4a10-4df8-afdf-0007f3f6dee5", null, com.azure.core.util.Context.NONE);
    }
}
```
...
public final class AnalyticsItemsListSamples {
    ...
    public static void
        ...
        manager.analyticsItems().listWithResponse("my-resource-group", "my-component", ItemScopePath.ANALYTICS_ITEMS,
...
public final class AnnotationsDeleteSamples {
    ...
    public static void
        ...
        manager.annotations().deleteWithResponse("my-resource-group", "my-component",
            "bb820f1b-3110-4a8b-ba2c-8c1129d7eb6a", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class AnnotationsGetSamples {
    ...
    public static void
        ...
        manager.annotations().getWithResponse("my-resource-group", "my-component",
            "444e2c08-274a-4bbb-a89e-d77bb720f44a", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class AnnotationsListSamples {
    ...
    public static void
        ...
        manager.annotations().list("my-resource-group", "my-component", "2018-02-05T00%3A30%3A00.000Z",
            "2018-02-06T00%3A33A00.000Z", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class ApiKeysCreateSamples {
    ...
    public static void aPIKeyCreate(com.azure.resourcemanager.applicationinsights.ApplicationInsightsManager manager) {
        manager.apiKeys().createWithResponse("my-resource-group", "my-component", new ApiKeyRequest().withName("test2")
...
public final class ApiKeysDeleteSamples {
    ...
    public static void aPIKeyDelete(com.azure.resourcemanager.applicationinsights.ApplicationInsightsManager manager) {
        manager.apiKeys().deleteWithResponse("my-resource-group", "my-component",
            "bb820f1b-3110-4a8b-ba2c-8c1129d7eb6a", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class ApiKeysGetSamples {
    ...
    public static void aPIKeysGet(com.azure.resourcemanager.applicationinsights.ApplicationInsightsManager manager) {
        manager.apiKeys().getWithResponse("my-resource-group", "my-component", "bb820f1b-3110-4a8b-ba2c-8c1129d7eb6a",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class ComponentCurrentBillingFeaturesGetSamples {
    ...
    public static void componentCurrentBillingFeaturesGet(
        com.azure.resourcemanager.applicationinsights.ApplicationInsightsManager manager) {
        manager.componentCurrentBillingFeatures().getWithResponse("my-resource-group", "my-component",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class ComponentLinkedStorageAccountsOperationGetSamples {
    ...
    public static void componentLinkedStorageAccountsGet(
        com.azure.resourcemanager.applicationinsights.ApplicationInsightsManager manager) {
        manager.componentLinkedStorageAccountsOperations().getWithResponse("someResourceGroupName", "myComponent",
            StorageType.SERVICE_PROFILER, com.azure.core.util.Context.NONE);
    }
}
```
...
public final class ComponentLinkedStorageAccountsOperationUpdateSamples {
    ...
    public static void componentLinkedStorageAccountsUpdate(
        ...
        ComponentLinkedStorageAccounts resource
            = manager.componentLinkedStorageAccountsOperations().getWithResponse("someResourceGroupName", "myComponent",
                StorageType.SERVICE_PROFILER, com.azure.core.util.Context.NONE).getValue();
        resource.update().withLinkedStorageAccount(
            "/subscriptions/86dc51d3-92ed-4d7e-947a-775ea79b4918/resourceGroups/someResourceGroupName/providers/Microsoft.Storage/storageAccounts/storageaccountname")
            .apply();
    }
}
...
public final class ComponentQuotaStatusGetSamples {
    ...
    public static void componentCurrentBillingFeaturesGet(
        com.azure.resourcemanager.applicationinsights.ApplicationInsightsManager manager) {
        manager.componentQuotaStatus().getWithResponse("my-resource-group", "my-component",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class ComponentsCreateOrUpdateSamples {
    ...
    public static void
        ...
        manager.components().define("my-component").withRegion("South Central US")
            .withExistingResourceGroup("my-resource-group").withKind("web").withApplicationType(ApplicationType.WEB)
            .withFlowType(FlowType.BLUEFIELD).withRequestSource(RequestSource.REST)
    ...
    public static void
        ...
        manager.components().define("my-component").withRegion("South Central US")
            .withExistingResourceGroup("my-resource-group").withKind("web")
            .withTags(mapOf("ApplicationGatewayType", "Internal-Only", "BillingEntity", "Self")).create();
    }
...
public final class ComponentsDeleteSamples {
    ...
    public static void
        ...
        manager.components().deleteByResourceGroupWithResponse("my-resource-group", "my-component",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class ComponentsGetByResourceGroupSamples {
    ...
    public static void componentGet(com.azure.resourcemanager.applicationinsights.ApplicationInsightsManager manager) {
        manager.components().getByResourceGroupWithResponse("my-resource-group", "my-component",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class ComponentsGetPurgeStatusSamples {
    ...
    public static void
        ...
        manager.components().getPurgeStatusWithResponse("OIAutoRest5123", "aztest5048",
...
public final class ComponentsPurgeSamples {
    ...
    public static void
        componentPurge(com.azure.resourcemanager.applicationinsights.ApplicationInsightsManager manager) {
        manager.components().purgeWithResponse("OIAutoRest5123", "aztest5048",
            new ComponentPurgeBody().withTable("Heartbeat").withFilters(Arrays.asList(new ComponentPurgeBodyFilters()
...
public final class ExportConfigurationsDeleteSamples {
    ...
    public static void
        ...
        manager.exportConfigurations().deleteWithResponse("my-resource-group", "my-component",
            "uGOoki0jQsyEs3IdQ83Q4QsNr4=", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class ExportConfigurationsGetSamples {
    ...
    public static void
        ...
        manager.exportConfigurations().getWithResponse("my-resource-group", "my-component",
            "uGOoki0jQsyEs3IdQ83Q4QsNr4=", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class FavoritesAddSamples {
    ...
    public static void favoriteAdd(com.azure.resourcemanager.applicationinsights.ApplicationInsightsManager manager) {
        manager.favorites().addWithResponse("my-resource-group", "my-ai-component",
            "deadb33f-8bee-4d3b-a059-9be8dac93960",
            new ApplicationInsightsComponentFavoriteInner().withName("Blah Blah Blah").withConfig(
                ...
                .withVersion("ME").withFavoriteType(FavoriteType.SHARED)
                .withTags(Arrays.asList("TagSample01", "TagSample02")).withIsGeneratedFromTemplate(false),
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class FavoritesDeleteSamples {
    ...
    public static void favoriteList(com.azure.resourcemanager.applicationinsights.ApplicationInsightsManager manager) {
        manager.favorites().deleteWithResponse("my-resource-group", "my-ai-component",
...
public final class FavoritesGetSamples {
    ...
    public static void favoriteGet(com.azure.resourcemanager.applicationinsights.ApplicationInsightsManager manager) {
        manager.favorites().getWithResponse("my-resource-group", "my-ai-component",
            "deadb33f-5e0d-4064-8ebb-1a4ed0313eb2", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class FavoritesListSamples {
    ...
    public static void favoritesList(com.azure.resourcemanager.applicationinsights.ApplicationInsightsManager manager) {
        manager.favorites().listWithResponse("my-resource-group", "my-ai-component", null, null, null, null,
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class FavoritesUpdateSamples {
     ...
     */
    public static void favoriteList(com.azure.resourcemanager.applicationinsights.ApplicationInsightsManager manager) {
        manager.favorites().updateWithResponse("my-resource-group", "my-ai-component",
            "deadb33f-5e0d-4064-8ebb-1a4ed0313eb2",
            new ApplicationInsightsComponentFavoriteInner().withName("Derek Changed This").withConfig(
...
public final class LiveTokenGetSamples {
    ...
    public static void
        ...
        manager.liveTokens().getWithResponse(
...
public final class ProactiveDetectionConfigurationsListSamples {
    ...
    public static void proactiveDetectionConfigurationsList(
        com.azure.resourcemanager.applicationinsights.ApplicationInsightsManager manager) {
        manager.proactiveDetectionConfigurations().listWithResponse("my-resource-group", "my-component",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class ProactiveDetectionConfigurationsUpdateSamples {
    ...
    public static void proactiveDetectionConfigurationUpdate(
        com.azure.resourcemanager.applicationinsights.ApplicationInsightsManager manager) {
        manager.proactiveDetectionConfigurations().updateWithResponse("my-resource-group", "my-component",
            "slowpageloadtime",
            new ApplicationInsightsComponentProactiveDetectionConfigurationInner().withName("slowpageloadtime")
                .withEnabled(true).withSendEmailsToSubscriptionOwners(true)
                ...
                .withRuleDefinitions(new ApplicationInsightsComponentProactiveDetectionConfigurationRuleDefinitions()
                    .withName("slowpageloadtime").withDisplayName("Slow page load time")
                    ...
                    .withIsHidden(false).withIsEnabledByDefault(true).withIsInPreview(false)
...
public final class WebTestsDeleteSamples {
    ...
    public static void webTestDelete(com.azure.resourcemanager.applicationinsights.ApplicationInsightsManager manager) {
        manager.webTests().deleteByResourceGroupWithResponse("my-resource-group", "my-webtest-01-mywebservice",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class WebTestsGetByResourceGroupSamples {
    ...
    public static void webTestGet(com.azure.resourcemanager.applicationinsights.ApplicationInsightsManager manager) {
        manager.webTests().getByResourceGroupWithResponse("my-resource-group", "my-webtest-01-mywebservice",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class WorkItemConfigurationsCreateSamples {
    ...
    public static void
        ...
        manager.workItemConfigurations().createWithResponse("my-resource-group", "my-component",
            new WorkItemCreateConfiguration().withConnectorId("d334e2a4-6733-488e-8645-a9fdc1694f41")
                ...
                .withValidateOnly(true).withWorkItemProperties(mapOf()),
            com.azure.core.util.Context.NONE);
    }
...
public final class WorkItemConfigurationsDeleteSamples {
    ...
    public static void
        ...
        manager.workItemConfigurations().deleteWithResponse("my-resource-group", "my-component",
            "Visual Studio Team Services", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class WorkItemConfigurationsGetDefaultSamples {
    ...
    public static void workItemConfigurationsGetDefault(
        com.azure.resourcemanager.applicationinsights.ApplicationInsightsManager manager) {
        manager.workItemConfigurations().getDefaultWithResponse("my-resource-group", "my-component",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class WorkItemConfigurationsGetItemSamples {
    ...
    public static void workItemConfigurationsGetDefault(
        com.azure.resourcemanager.applicationinsights.ApplicationInsightsManager manager) {
        manager.workItemConfigurations().getItemWithResponse("my-resource-group", "my-component",
            "Visual Studio Team Services", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class WorkItemConfigurationsUpdateItemSamples {
    ...
    public static void
        workItemConfigurationsCreate(com.azure.resourcemanager.applicationinsights.ApplicationInsightsManager manager) {
        manager.workItemConfigurations().updateItemWithResponse("my-resource-group", "my-component",
...
public final class WorkbookTemplatesCreateOrUpdateSamples {
    ...
    public static void workbookTemplateAdd(
        ...
        manager.workbookTemplates().define("testtemplate2").withRegion("west us")
            .withExistingResourceGroup("my-resource-group").withPriority(1).withAuthor("Contoso")
            .withTemplateData(SerializerFactory.createDefaultManagementSerializerAdapter().deserialize(
            ...
            .withGalleries(
                Arrays.asList(new WorkbookTemplateGallery().withName("Simple Template").withCategory("Failures")
                    .withType("tsg").withOrder(100).withResourceType("microsoft.insights/components")))
            .create();
    }
}
```
...
public final class WorkbookTemplatesGetByResourceGroupSamples {
    ...
    public static void
        ...
        manager.workbookTemplates().getByResourceGroupWithResponse("my-resource-group", "my-resource-name",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class WorkbookTemplatesUpdateSamples {
    ...
    public static void
        ...
        WorkbookTemplate resource = manager.workbookTemplates().getByResourceGroupWithResponse("my-resource-group",
            "my-template-resource", com.azure.core.util.Context.NONE).getValue();
...
public final class WorkbooksListByResourceGroupSamples {
    ...
    public static void
        ...
        manager.workbooks().listByResourceGroup("my-resource-group", CategoryType.WORKBOOK, null,
...
public final class WorkbooksRevisionsListSamples {
    ...
    public static void
        ...
        manager.workbooks().revisionsList("my-resource-group", "deadb33f-5e0d-4064-8ebb-1a4ed0313eb2",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class WorkbooksUpdateSamples {
    ...
    public static void
        ...
        Workbook resource = manager.workbooks().getByResourceGroupWithResponse("my-resource-group",
            "deadb33f-5e0d-4064-8ebb-1a4ed0313eb2", null, com.azure.core.util.Context.NONE).getValue();
        resource.update().withSourceId(
            "/subscriptions/6b643656-33eb-422f-aee8-3ac145d124af/resourceGroups/my-resource-group/providers/Microsoft.Web/sites/MyApp")
            .apply();
    }
