...
/**
 * Resource collection API of ClusterRecoveryPoints.
 */
public interface ClusterRecoveryPoints {
    /**
     ...
     */
    PagedIterable<ClusterRecoveryPoint> listByReplicationProtectionCluster(String resourceName,
