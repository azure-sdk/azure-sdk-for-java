...
public interface ClusterRecoveryPointOperationsClient {
    ...
    Response<ClusterRecoveryPointInner> getWithResponse(String resourceName, String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ClusterRecoveryPointInner get(String resourceName, String resourceGroupName, String fabricName,
