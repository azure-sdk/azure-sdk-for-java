...
public final class ReplicationStorageClassificationsClientImpl implements ReplicationStorageClassificationsClient {
    ...
    private interface ReplicationStorageClassificationsService {
    ...
    private Mono<StorageClassificationInner> getAsync(
        ...
        return getWithResponseAsync(resourceName, resourceGroupName, fabricName, storageClassificationName)
            .flatMap(
                (Response<StorageClassificationInner> res) -> {
    ...
    public StorageClassificationInner get(
        String resourceName, String resourceGroupName, String fabricName, String storageClassificationName) {
        return getAsync(resourceName, resourceGroupName, fabricName, storageClassificationName).block();
    }
