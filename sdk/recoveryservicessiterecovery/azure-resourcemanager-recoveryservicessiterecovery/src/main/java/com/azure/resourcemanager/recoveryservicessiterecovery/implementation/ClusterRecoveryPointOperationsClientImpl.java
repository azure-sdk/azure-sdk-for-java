...
public final class ClusterRecoveryPointOperationsClientImpl implements ClusterRecoveryPointOperationsClient {
    ...
    /**
     * The interface defining all the services for SiteRecoveryManagementClientClusterRecoveryPointOperations to be
    ...
    private Mono<Response<ClusterRecoveryPointInner>> getWithResponseAsync(String resourceName,
        String resourceGroupName, String fabricName, String protectionContainerName,
        String replicationProtectionClusterName, String recoveryPointName) {
    ...
    private Mono<Response<ClusterRecoveryPointInner>> getWithResponseAsync(String resourceName,
        String resourceGroupName, String fabricName, String protectionContainerName,
        String replicationProtectionClusterName, String recoveryPointName, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ClusterRecoveryPointInner> getAsync(String resourceName, String resourceGroupName, String fabricName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ClusterRecoveryPointInner> getWithResponse(String resourceName, String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ClusterRecoveryPointInner get(String resourceName, String resourceGroupName, String fabricName,
        String protectionContainerName, String replicationProtectionClusterName, String recoveryPointName) {
