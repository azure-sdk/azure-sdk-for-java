...
public final class ReplicationAppliancesClientImpl implements ReplicationAppliancesClient {
    ...
    public interface ReplicationAppliancesService {
        ...
        Mono<Response<ApplianceCollection>> list(@HostParam("$host") String endpoint,
            ...
            @QueryParam("$filter") String filter, @PathParam("resourceName") String resourceName,
    ...
    private Mono<PagedResponse<ReplicationApplianceInner>> listSinglePageAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(context -> service.list(this.client.getEndpoint(), this.client.getApiVersion(),
                resourceGroupName, filter, resourceName, this.client.getSubscriptionId(), accept, context))
    ...
    private Mono<PagedResponse<ReplicationApplianceInner>> listSinglePageAsync(String resourceGroupName,
        ...
        return service
            .list(this.client.getEndpoint(), this.client.getApiVersion(), resourceGroupName, filter, resourceName,
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<ReplicationApplianceInner> listAsync(String resourceGroupName, String resourceName, String filter,
        Context context) {
