...
public final class ReplicationAppliancesClientImpl implements ReplicationAppliancesClient {
    ...
    ReplicationAppliancesClientImpl(SiteRecoveryManagementClientImpl client) {
        this.service =
            RestProxy
                .create(ReplicationAppliancesService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }
    ...
    private interface ReplicationAppliancesService {
        ...
        Mono<Response<ApplianceCollection>> list(
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ApplianceCollection>> listNext(
    ...
    private Mono<PagedResponse<ReplicationApplianceInner>> listSinglePageAsync(
                ...
                context ->
                    service
                        .list(
                            ...
                            accept,
                            context))
            .<PagedResponse<ReplicationApplianceInner>>map(
                res ->
    ...
    private PagedFlux<ReplicationApplianceInner> listAsync(
        String resourceName, String resourceGroupName, String filter) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<ReplicationApplianceInner> list(
        String resourceName, String resourceGroupName, String filter, Context context) {
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return collection of appliance details along with {@link PagedResponse} on successful completion of {@link
     *     Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
