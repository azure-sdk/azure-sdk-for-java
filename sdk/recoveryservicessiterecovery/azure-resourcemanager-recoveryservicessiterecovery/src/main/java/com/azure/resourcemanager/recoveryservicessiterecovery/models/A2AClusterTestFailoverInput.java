...
public final class A2AClusterTestFailoverInput extends ClusterTestFailoverProviderSpecificInput {
    ...
    /**
     * Reads an instance of A2AClusterTestFailoverInput from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of A2AClusterTestFailoverInput if the JsonReader was pointing to an instance of it, or null
     * if it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the A2AClusterTestFailoverInput.
     */
    public static A2AClusterTestFailoverInput fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            A2AClusterTestFailoverInput deserializedA2AClusterTestFailoverInput = new A2AClusterTestFailoverInput();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("instanceType".equals(fieldName)) {
                    deserializedA2AClusterTestFailoverInput.instanceType = reader.getString();
                } else if ("clusterRecoveryPointId".equals(fieldName)) {
                    deserializedA2AClusterTestFailoverInput.clusterRecoveryPointId = reader.getString();
                    ...
                    deserializedA2AClusterTestFailoverInput.individualNodeRecoveryPoints = individualNodeRecoveryPoints;
                } else {
                    reader.skipChildren();
                }
            }

            return deserializedA2AClusterTestFailoverInput;
        });
    }
}
