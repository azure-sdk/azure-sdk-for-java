...
public final class ReplicationProtectionClusterProperties {
     ...
     * The status.
     */
    @JsonProperty(value = "protectionClusterStatus")
    private String protectionClusterStatus;
     ...
     * @return the ReplicationProtectionClusterProperties object itself.
     */
    public ReplicationProtectionClusterProperties withPrimaryProtectionContainerFriendlyName(
     ...
     * @return the ReplicationProtectionClusterProperties object itself.
     */
    public ReplicationProtectionClusterProperties withRecoveryProtectionContainerFriendlyName(
     ...
     * @return the ReplicationProtectionClusterProperties object itself.
     */
    public ReplicationProtectionClusterProperties withLastSuccessfulFailoverTime(
     ...
     * @return the ReplicationProtectionClusterProperties object itself.
     */
    public ReplicationProtectionClusterProperties withLastSuccessfulTestFailoverTime(
    ...
    /**
     * Get the protectionClusterStatus property: The status.
     *
     * @return the protectionClusterStatus value.
     */
    public String protectionClusterStatus() {
        return this.protectionClusterStatus;
    }

    /**
     * Set the protectionClusterStatus property: The status.
     *
     * @param protectionClusterStatus the protectionClusterStatus value to set.
     * @return the ReplicationProtectionClusterProperties object itself.
     */
    public ReplicationProtectionClusterProperties withProtectionClusterStatus(String protectionClusterStatus) {
        this.protectionClusterStatus = protectionClusterStatus;
        return this;
    }
     ...
     * @return the ReplicationProtectionClusterProperties object itself.
     */
    public ReplicationProtectionClusterProperties withAreAllClusterNodesRegistered(
        Boolean areAllClusterNodesRegistered) {
     ...
     * @return the ReplicationProtectionClusterProperties object itself.
     */
    public ReplicationProtectionClusterProperties withClusterRegisteredNodes(
     ...
     * @return the ReplicationProtectionClusterProperties object itself.
     */
    public ReplicationProtectionClusterProperties withProviderSpecificDetails(
        ReplicationClusterProviderSpecificSettings providerSpecificDetails) {
     ...
     * @return the ReplicationProtectionClusterProperties object itself.
     */
    public ReplicationProtectionClusterProperties withSharedDiskProperties(
        SharedDiskReplicationItemProperties sharedDiskProperties) {
