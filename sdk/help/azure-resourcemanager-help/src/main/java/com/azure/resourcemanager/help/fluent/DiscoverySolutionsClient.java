...
public interface DiscoverySolutionsClient {
    ...
    PagedIterable<SolutionMetadataInner> list(String scope);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<SolutionMetadataInner> list(String scope, String filter, String skiptoken, Context context);
}
