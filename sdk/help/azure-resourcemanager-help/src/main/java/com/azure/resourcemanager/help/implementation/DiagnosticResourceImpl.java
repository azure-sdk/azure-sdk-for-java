...
public final class DiagnosticResourceImpl implements DiagnosticResource, DiagnosticResource.Definition {
    ...
    private final com.azure.resourcemanager.help.SelfHelpManager serviceManager;

    DiagnosticResourceImpl(
        DiagnosticResourceInner innerObject, com.azure.resourcemanager.help.SelfHelpManager serviceManager) {
    ...
    private com.azure.resourcemanager.help.SelfHelpManager manager() {
    ...
    DiagnosticResourceImpl(String name, com.azure.resourcemanager.help.SelfHelpManager serviceManager) {
