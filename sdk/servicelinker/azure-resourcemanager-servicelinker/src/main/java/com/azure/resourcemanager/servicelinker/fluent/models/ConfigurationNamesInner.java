...
@Fluent
public final class ConfigurationNamesInner {
    /*
    ...
    /** Creates an instance of ConfigurationNamesInner class. */
    public ConfigurationNamesInner() {
    }
     ...
     * @return the ConfigurationNamesInner object itself.
     */
    public ConfigurationNamesInner withTargetService(String targetService) {
     ...
     * @return the ConfigurationNamesInner object itself.
     */
    public ConfigurationNamesInner withClientType(ClientType clientType) {
     ...
     * @return the ConfigurationNamesInner object itself.
     */
    public ConfigurationNamesInner withAuthType(AuthType authType) {
     ...
     * @return the ConfigurationNamesInner object itself.
     */
    public ConfigurationNamesInner withNames(List<ConfigurationName> names) {
        this.names = names;
        return this;
    }
