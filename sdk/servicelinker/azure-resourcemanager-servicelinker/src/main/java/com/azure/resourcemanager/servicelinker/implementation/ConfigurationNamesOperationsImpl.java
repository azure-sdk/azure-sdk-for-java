...
import com.azure.resourcemanager.servicelinker.models.ConfigurationNames;
...
public final class ConfigurationNamesOperationsImpl implements ConfigurationNamesOperations {
    ...
    public PagedIterable<ConfigurationNames> list() {
        PagedIterable<ConfigurationNamesInner> inner = this.serviceClient().list();
        return Utils.mapPage(inner, inner1 -> new ConfigurationNamesImpl(inner1, this.manager()));
    }

    public PagedIterable<ConfigurationNames> list(String filter, String skipToken, Context context) {
        PagedIterable<ConfigurationNamesInner> inner = this.serviceClient().list(filter, skipToken, context);
        return Utils.mapPage(inner, inner1 -> new ConfigurationNamesImpl(inner1, this.manager()));
    }
