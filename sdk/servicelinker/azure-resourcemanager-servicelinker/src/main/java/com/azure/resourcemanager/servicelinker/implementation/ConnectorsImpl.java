...
public final class ConnectorsImpl implements Connectors {
    ...
    public Response<DryrunResource> getDryrunWithResponse(String subscriptionId, String resourceGroupName,
        ...
        Response<DryrunResourceInner> inner = this.serviceClient().getDryrunWithResponse(subscriptionId,
    ...
    public DryrunResource updateDryrun(String subscriptionId, String resourceGroupName, String location,
        String dryrunName, DryrunPatch parameters) {
        DryrunResourceInner inner
            = this.serviceClient().updateDryrun(subscriptionId, resourceGroupName, location, dryrunName, parameters);
        if (inner != null) {
            return new DryrunResourceImpl(inner, this.manager());
        } else {
            return null;
    ...
    public DryrunResource updateDryrun(String subscriptionId, String resourceGroupName, String location,
        ...
        DryrunResourceInner inner = this.serviceClient().updateDryrun(subscriptionId, resourceGroupName, location,
            dryrunName, parameters, context);
        if (inner != null) {
            return new DryrunResourceImpl(inner, this.manager());
        } else {
            return null;
    ...
    public Response<ConfigurationResult> generateConfigurationsWithResponse(String subscriptionId,
        ...
        Context context) {
        Response<ConfigurationResultInner> inner = this.serviceClient().generateConfigurationsWithResponse(
