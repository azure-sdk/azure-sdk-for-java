...
public final class ConfigurationNamesImpl implements ConfigurationNames {
    private ConfigurationNamesInner innerObject;

    private final com.azure.resourcemanager.servicelinker.ServiceLinkerManager serviceManager;

    ConfigurationNamesImpl(
        ConfigurationNamesInner innerObject,
    ...
    public ConfigurationNamesInner innerModel() {
