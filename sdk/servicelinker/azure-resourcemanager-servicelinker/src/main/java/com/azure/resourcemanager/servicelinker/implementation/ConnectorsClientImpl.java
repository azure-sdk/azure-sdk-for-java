...
public final class ConnectorsClientImpl implements ConnectorsClient {
    ...
    public interface ConnectorsService {
        ...
        Mono<Response<DryrunList>> listDryrun(
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<DryrunResourceInner>> getDryrun(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("location") String location,
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Flux<ByteBuffer>>> createDryrun(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("location") String location,
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Flux<ByteBuffer>>> updateDryrun(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("location") String location,
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Void>> deleteDryrun(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("location") String location,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ResourceList>> list(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("location") String location,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ConfigurationResultInner>> generateConfigurations(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("location") String location,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<DryrunList>> listDryrunNext(
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ResourceList>> listNext(
            @PathParam(value = "nextLink", encoded = true) String nextLink,
            @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept,
            Context context);
    ...
    private Mono<PagedResponse<DryrunResourceInner>> listDryrunSinglePageAsync(
                ...
                context ->
                    service
                        .listDryrun(
                            ...
                            accept,
                            context))
            .<PagedResponse<DryrunResourceInner>>map(
                res ->
    ...
    private PagedFlux<DryrunResourceInner> listDryrunAsync(
        String subscriptionId, String resourceGroupName, String location) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<DryrunResourceInner> listDryrun(
        String subscriptionId, String resourceGroupName, String location) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<DryrunResourceInner>> getDryrunWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DryrunResourceInner> getDryrunAsync(
        String subscriptionId, String resourceGroupName, String location, String dryrunName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<DryrunResourceInner> getDryrunWithResponse(
        String subscriptionId, String resourceGroupName, String location, String dryrunName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> createDryrunWithResponseAsync(
    ...
    private PollerFlux<PollResult<DryrunResourceInner>, DryrunResourceInner> beginCreateDryrunAsync(
        ...
        return this
            .client
            .<DryrunResourceInner, DryrunResourceInner>getLroResult(
                mono,
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<DryrunResourceInner>, DryrunResourceInner> beginCreateDryrun(
        String subscriptionId,
        String resourceGroupName,
        String location,
        String dryrunName,
        DryrunResourceInner parameters) {
        return this
            .beginCreateDryrunAsync(subscriptionId, resourceGroupName, location, dryrunName, parameters)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<DryrunResourceInner>, DryrunResourceInner> beginCreateDryrun(
        ...
        Context context) {
        return this
            .beginCreateDryrunAsync(subscriptionId, resourceGroupName, location, dryrunName, parameters, context)
            .getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DryrunResourceInner> createDryrunAsync(
        String subscriptionId,
        String resourceGroupName,
        String location,
        String dryrunName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> updateDryrunWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<DryrunResourceInner>, DryrunResourceInner> beginUpdateDryrun(
        String subscriptionId, String resourceGroupName, String location, String dryrunName, DryrunPatch parameters) {
        return this
            .beginUpdateDryrunAsync(subscriptionId, resourceGroupName, location, dryrunName, parameters)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<DryrunResourceInner>, DryrunResourceInner> beginUpdateDryrun(
        ...
        Context context) {
        return this
            .beginUpdateDryrunAsync(subscriptionId, resourceGroupName, location, dryrunName, parameters, context)
            .getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DryrunResourceInner> updateDryrunAsync(
        String subscriptionId, String resourceGroupName, String location, String dryrunName, DryrunPatch parameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Void>> deleteDryrunWithResponseAsync(
        String subscriptionId, String resourceGroupName, String location, String dryrunName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> deleteDryrunAsync(
        String subscriptionId, String resourceGroupName, String location, String dryrunName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<Void> deleteDryrunWithResponse(
        String subscriptionId, String resourceGroupName, String location, String dryrunName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<LinkerResourceInner>> listSinglePageAsync(
        String subscriptionId, String resourceGroupName, String location) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<LinkerResourceInner> listAsync(
        String subscriptionId, String resourceGroupName, String location, Context context) {
        return new PagedFlux<>(
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<LinkerResourceInner> list(
        String subscriptionId, String resourceGroupName, String location, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<LinkerResourceInner> getAsync(
        String subscriptionId, String resourceGroupName, String location, String connectorName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<LinkerResourceInner> getWithResponse(
        String subscriptionId, String resourceGroupName, String location, String connectorName, Context context) {
    ...
    public SyncPoller<PollResult<LinkerResourceInner>, LinkerResourceInner> beginCreateOrUpdate(
        ...
        LinkerResourceInner parameters) {
        return this
            .beginCreateOrUpdateAsync(subscriptionId, resourceGroupName, location, connectorName, parameters)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(
        String subscriptionId, String resourceGroupName, String location, String connectorName, Context context) {
        return this
            .beginDeleteAsync(subscriptionId, resourceGroupName, location, connectorName, context)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<LinkerResourceInner>, LinkerResourceInner> beginUpdate(
        ...
        LinkerPatch parameters) {
        return this
            .beginUpdateAsync(subscriptionId, resourceGroupName, location, connectorName, parameters)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<LinkerResourceInner>, LinkerResourceInner> beginUpdate(
        ...
        Context context) {
        return this
            .beginUpdateAsync(subscriptionId, resourceGroupName, location, connectorName, parameters, context)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<ValidateOperationResultInner>, ValidateOperationResultInner> beginValidate(
        String subscriptionId, String resourceGroupName, String location, String connectorName, Context context) {
        return this
            .beginValidateAsync(subscriptionId, resourceGroupName, location, connectorName, context)
            .getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ValidateOperationResultInner> validateAsync(
        String subscriptionId, String resourceGroupName, String location, String connectorName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ConfigurationResultInner>> generateConfigurationsWithResponseAsync(
        String subscriptionId,
        String resourceGroupName,
        String location,
        String connectorName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ConfigurationResultInner> generateConfigurationsAsync(
        String subscriptionId, String resourceGroupName, String location, String connectorName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ConfigurationResultInner> generateConfigurationsWithResponse(
        String subscriptionId,
        String resourceGroupName,
        String location,
        String connectorName,
