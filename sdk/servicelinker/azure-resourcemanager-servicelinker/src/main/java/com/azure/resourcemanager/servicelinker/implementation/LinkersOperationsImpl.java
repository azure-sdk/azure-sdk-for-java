...
public final class LinkersOperationsImpl implements LinkersOperations {
    ...
    public LinkersOperationsImpl(
        LinkersOperationsClient innerClient,
    ...
    public DryrunResource createDryrun(
    ...
    public Response<ConfigurationResult> generateConfigurationsWithResponse(
    ...
    public PagedIterable<DaprConfigurationResource> listDaprConfigurations(String resourceUri) {
        ...
        return Utils.mapPage(inner, inner1 -> new DaprConfigurationResourceImpl(inner1, this.manager()));
    }
