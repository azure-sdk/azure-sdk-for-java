...
public final class LinkersOperationsImpl implements LinkersOperations {
    ...
    public DryrunResource getDryrunById(String id) {
        ...
        String dryrunName = ResourceManagerUtils.getValueFromIdByParameterName(id,
        ...
        return this.getDryrunWithResponse(resourceUri, dryrunName, Context.NONE).getValue();
    }
    ...
    public Response<DryrunResource> getDryrunByIdWithResponse(String id, Context context) {
        ...
        return this.getDryrunWithResponse(resourceUri, dryrunName, context);
    }
    ...
    public void deleteDryrunById(String id) {
        ...
        this.deleteDryrunWithResponse(resourceUri, dryrunName, Context.NONE);
    }
    ...
    public Response<Void> deleteDryrunByIdWithResponse(String id, Context context) {
        ...
        return this.deleteDryrunWithResponse(resourceUri, dryrunName, context);
    }
