...
public final class LinkersOperationsClientImpl implements LinkersOperationsClient {
    ...
    public interface LinkersOperationsService {
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<DaprConfigurationList>> listDaprConfigurations(
            @HostParam("$host") String endpoint,
            @PathParam(value = "resourceUri", encoded = true) String resourceUri,
            @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept,
        ...
        return FluxUtil
            .withContext(
                context ->
                    service
                        .listDryrun(
                            this.client.getEndpoint(), resourceUri, this.client.getApiVersion(), accept, context))
    ...
    private Mono<PagedResponse<DryrunResourceInner>> listDryrunSinglePageAsync(String resourceUri, Context context) {
        ...
        return service
            .listDryrun(this.client.getEndpoint(), resourceUri, this.client.getApiVersion(), accept, context)
            .map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(),
    ...
    private PagedFlux<DryrunResourceInner> listDryrunAsync(String resourceUri) {
        return new PagedFlux<>(
            () -> listDryrunSinglePageAsync(resourceUri), nextLink -> listDryrunNextSinglePageAsync(nextLink));
    }
    ...
    private PagedFlux<DryrunResourceInner> listDryrunAsync(String resourceUri, Context context) {
        return new PagedFlux<>(
            () -> listDryrunSinglePageAsync(resourceUri, context),
    ...
    private Mono<Response<DryrunResourceInner>> getDryrunWithResponseAsync(
        String resourceUri, String dryrunName, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
        ...
        return service
            .getDryrun(
                this.client.getEndpoint(), resourceUri, this.client.getApiVersion(), dryrunName, accept, context);
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> createDryrunWithResponseAsync(
        String resourceUri, String dryrunName, DryrunResourceInner parameters) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> createDryrunWithResponseAsync(
        String resourceUri, String dryrunName, DryrunResourceInner parameters, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    private Mono<DryrunResourceInner> createDryrunAsync(
        String resourceUri, String dryrunName, DryrunResourceInner parameters) {
        return beginCreateDryrunAsync(resourceUri, dryrunName, parameters)
            .last()
    ...
    private Mono<DryrunResourceInner> createDryrunAsync(
        String resourceUri, String dryrunName, DryrunResourceInner parameters, Context context) {
        return beginCreateDryrunAsync(resourceUri, dryrunName, parameters, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> updateDryrunWithResponseAsync(
        String resourceUri, String dryrunName, DryrunPatch parameters) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> updateDryrunWithResponseAsync(
        String resourceUri, String dryrunName, DryrunPatch parameters, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    private Mono<DryrunResourceInner> updateDryrunAsync(String resourceUri, String dryrunName, DryrunPatch parameters) {
        return beginUpdateDryrunAsync(resourceUri, dryrunName, parameters)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<DryrunResourceInner> updateDryrunAsync(
        String resourceUri, String dryrunName, DryrunPatch parameters, Context context) {
        return beginUpdateDryrunAsync(resourceUri, dryrunName, parameters, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<Response<ConfigurationResultInner>> generateConfigurationsWithResponseAsync(
        String resourceUri, String linkerName, ConfigurationInfo parameters) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ConfigurationResultInner>> generateConfigurationsWithResponseAsync(
        String resourceUri, String linkerName, ConfigurationInfo parameters, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<DaprConfigurationResourceInner>> listDaprConfigurationsSinglePageAsync(
        String resourceUri) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                ...
                context ->
                    service
                        .listDaprConfigurations(
                            this.client.getEndpoint(), resourceUri, this.client.getApiVersion(), accept, context))
            .<PagedResponse<DaprConfigurationResourceInner>>map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(),
                        res.getStatusCode(),
    ...
    private PagedFlux<DaprConfigurationResourceInner> listDaprConfigurationsAsync(String resourceUri) {
        return new PagedFlux<>(
            () -> listDaprConfigurationsSinglePageAsync(resourceUri),
    ...
    private PagedFlux<DaprConfigurationResourceInner> listDaprConfigurationsAsync(String resourceUri, Context context) {
        return new PagedFlux<>(
            () -> listDaprConfigurationsSinglePageAsync(resourceUri, context),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<DaprConfigurationResourceInner>> listDaprConfigurationsNextSinglePageAsync(
        String nextLink) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
    ...
    private Mono<PagedResponse<DaprConfigurationResourceInner>> listDaprConfigurationsNextSinglePageAsync(
        ...
        context = this.client.mergeContext(context);
        return service
            .listDaprConfigurationsNext(nextLink, this.client.getEndpoint(), accept, context)
            .map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(),
