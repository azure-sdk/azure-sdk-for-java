...
import com.azure.resourcemanager.servicelinker.fluent.models.ConfigurationNamesInner;
...
public final class ConfigurationNamesOperationsClientImpl implements ConfigurationNamesOperationsClient {
    ...
    public interface ConfigurationNamesOperationsService {
        ...
        Mono<Response<ConfigurationNameResult>> list(
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ConfigurationNameResult>> listNext(
    ...
    private Mono<PagedResponse<ConfigurationNamesInner>> listSinglePageAsync(String filter, String skipToken) {
        ...
        return FluxUtil
            ...
            .<PagedResponse<ConfigurationNamesInner>>map(
                res ->
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<ConfigurationNamesInner>> listSinglePageAsync(
    ...
    private PagedFlux<ConfigurationNamesInner> listAsync(String filter, String skipToken) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<ConfigurationNamesInner> listAsync() {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<ConfigurationNamesInner> listAsync(String filter, String skipToken, Context context) {
        return new PagedFlux<>(
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<ConfigurationNamesInner> list() {
        final String filter = null;
        final String skipToken = null;
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<ConfigurationNamesInner> list(String filter, String skipToken, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<ConfigurationNamesInner>> listNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<ConfigurationNamesInner>> listNextSinglePageAsync(String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        if (this.client.getEndpoint() == null) {
