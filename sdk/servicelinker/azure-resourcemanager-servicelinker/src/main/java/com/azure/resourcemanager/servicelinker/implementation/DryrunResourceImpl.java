...
public final class DryrunResourceImpl implements DryrunResource, DryrunResource.Definition, DryrunResource.Update {
    ...
    public DryrunResourceImpl withExistingResourceUri(String resourceUri) {
        this.resourceUri = resourceUri;
        return this;
    }

    public DryrunResource create() {
        this.innerObject = serviceManager.serviceClient().getLinkersOperations().createDryrun(resourceUri, dryrunName,
    ...
    public DryrunResource apply() {
        this.innerObject = serviceManager.serviceClient().getLinkersOperations().updateDryrun(resourceUri, dryrunName,
    ...
    DryrunResourceImpl(DryrunResourceInner innerObject,
        ...
        this.resourceUri = ResourceManagerUtils.getValueFromIdByParameterName(innerObject.id(),
            "/{resourceUri}/providers/Microsoft.ServiceLinker/dryruns/{dryrunName}", "resourceUri");
        this.dryrunName = ResourceManagerUtils.getValueFromIdByParameterName(innerObject.id(),
            "/{resourceUri}/providers/Microsoft.ServiceLinker/dryruns/{dryrunName}", "dryrunName");
    }

    public DryrunResource refresh() {
        this.innerObject = serviceManager.serviceClient().getLinkersOperations()
            .getDryrunWithResponse(resourceUri, dryrunName, Context.NONE).getValue();
        return this;
    }

    public DryrunResource refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getLinkersOperations()
            .getDryrunWithResponse(resourceUri, dryrunName, context).getValue();
        return this;
    }
