...
public interface LinkersOperationsClient {
    ...
    SyncPoller<PollResult<DryrunResourceInner>, DryrunResourceInner> beginCreateDryrun(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    DryrunResourceInner createDryrun(
        String resourceUri, String dryrunName, DryrunResourceInner parameters, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<DryrunResourceInner>, DryrunResourceInner> beginUpdateDryrun(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<ConfigurationResultInner> generateConfigurationsWithResponse(
