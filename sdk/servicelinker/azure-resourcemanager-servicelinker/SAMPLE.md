...
public final class LinkerCreateOrUpdateSamples {
    /*
     * x-ms-original-file:
     * specification/servicelinker/resource-manager/Microsoft.ServiceLinker/stable/2023-05-01/examples/
    ...
    public static void putLinkWithSecretStore(com.azure.resourcemanager.servicelinker.ServiceLinkerManager manager) {
        manager.linkers().define("linkName").withExistingResourceUri(
            ...
            .withSecretStore(new SecretStore().withKeyVaultId("fakeTokenPlaceholder")).create();
    }
    ...
    /*
     * x-ms-original-file:
     * specification/servicelinker/resource-manager/Microsoft.ServiceLinker/stable/2023-05-01/examples/PutLink.json
     */
    /**
     * Sample code: PutLink.
     * 
...
public final class LinkerDeleteSamples {
    /*
     * x-ms-original-file:
     * specification/servicelinker/resource-manager/Microsoft.ServiceLinker/stable/2023-05-01/examples/DeleteLink.json
     */
    /**
...
public final class LinkerGetSamples {
    /*
     * x-ms-original-file:
     * specification/servicelinker/resource-manager/Microsoft.ServiceLinker/stable/2023-05-01/examples/Link.json
     */
    /**
     * Sample code: Link.
     * 
...
public final class LinkerListSamples {
    /*
     * x-ms-original-file:
     * specification/servicelinker/resource-manager/Microsoft.ServiceLinker/stable/2023-05-01/examples/LinkList.json
     */
    /**
...
public final class LinkerListConfigurationsSamples {
    /*
     * x-ms-original-file:
     * specification/servicelinker/resource-manager/Microsoft.ServiceLinker/stable/2023-05-01/examples/GetConfigurations
     * .json
     */
    /**
...
public final class LinkerUpdateSamples {
    /*
     * x-ms-original-file:
     * specification/servicelinker/resource-manager/Microsoft.ServiceLinker/stable/2023-05-01/examples/PatchLink.json
     */
    /**
...
public final class OperationsListSamples {
    /*
     * x-ms-original-file:
     * specification/servicelinker/resource-manager/Microsoft.ServiceLinker/stable/2023-05-01/examples/OperationsList.
     * json
     */
    /**
     * Sample code: GetConfiguration.
