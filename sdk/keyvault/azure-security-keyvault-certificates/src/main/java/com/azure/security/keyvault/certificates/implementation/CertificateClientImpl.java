...
import com.azure.security.keyvault.certificates.KeyVaultServiceVersion;
...
public final class CertificateClientImpl {
     ...
     */
    public CertificateClientImpl(String vaultBaseUrl, KeyVaultServiceVersion serviceVersion) {
