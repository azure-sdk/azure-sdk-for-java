 ...
 */
@ServiceClientBuilder(serviceClients = { KeyClient.class, KeyAsyncClient.class })
public final class KeyClientBuilder implements HttpTrait<KeyClientBuilder>, ConfigurationTrait<KeyClientBuilder>,
    ...
    private static final Map<String, String> PROPERTIES
        = CoreUtils.getProperties("azure-security-keyvault-keys.properties");
    ...
    @Generated
    @Override
    public KeyClientBuilder addPolicy(HttpPipelinePolicy customPolicy) {
     ...
     */
    @Generated
    public KeyClientBuilder serviceVersion(KeyVaultServiceVersion serviceVersion) {
    ...
    private KeyClientImpl buildInnerClient() {
        ...
        KeyClientImpl client = new KeyClientImpl(localPipeline, JacksonAdapter.createDefaultSerializerAdapter(),
    ...
    /**
     * Builds an instance of KeyAsyncClient class.
     * 
     * @return an instance of KeyAsyncClient.
     */
    @Generated
