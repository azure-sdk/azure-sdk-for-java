...
public final class KeyClient {
    ...
    public Response<BinaryData> getKeyAttestationWithResponse(String keyName, String keyVersion,
        RequestOptions requestOptions) {
        return this.serviceClient.getKeyAttestationWithResponse(keyName, keyVersion, requestOptions);
    }
    ...
    public KeyBundle rotateKey(String keyName) {
        ...
        RequestOptions requestOptions = new RequestOptions();
        return rotateKeyWithResponse(keyName, requestOptions).getValue().toObject(KeyBundle.class);
    }
    ...
    public DeletedKeyBundle deleteKey(String keyName) {
        ...
        RequestOptions requestOptions = new RequestOptions();
        return deleteKeyWithResponse(keyName, requestOptions).getValue().toObject(DeletedKeyBundle.class);
    }
    ...
    public KeyBundle getKey(String keyName, String keyVersion) {
        ...
        RequestOptions requestOptions = new RequestOptions();
        return getKeyWithResponse(keyName, keyVersion, requestOptions).getValue().toObject(KeyBundle.class);
    }
    ...
    public PagedIterable<KeyItem> getKeyVersions(String keyName, Integer maxresults) {
        ...
        return serviceClient.getKeyVersions(keyName, requestOptions)
            .mapPage(bodyItemValue -> bodyItemValue.toObject(KeyItem.class));
    }
    ...
    public PagedIterable<KeyItem> getKeys(Integer maxresults) {
        ...
        return serviceClient.getKeys(requestOptions).mapPage(bodyItemValue -> bodyItemValue.toObject(KeyItem.class));
    }
    ...
    public BackupKeyResult backupKey(String keyName) {
        ...
        RequestOptions requestOptions = new RequestOptions();
        return backupKeyWithResponse(keyName, requestOptions).getValue().toObject(BackupKeyResult.class);
    }
    ...
    public ReleaseKeyResult release(String keyName, String keyVersion, KeyReleaseParameters parameters) {
        ...
        return releaseWithResponse(keyName, keyVersion, BinaryData.fromObject(parameters), requestOptions).getValue()
            .toObject(ReleaseKeyResult.class);
    }
    ...
    public PagedIterable<DeletedKeyItem> getDeletedKeys(Integer maxresults) {
        ...
        return serviceClient.getDeletedKeys(requestOptions)
            .mapPage(bodyItemValue -> bodyItemValue.toObject(DeletedKeyItem.class));
    }
    ...
    public DeletedKeyBundle getDeletedKey(String keyName) {
        ...
        RequestOptions requestOptions = new RequestOptions();
        return getDeletedKeyWithResponse(keyName, requestOptions).getValue().toObject(DeletedKeyBundle.class);
    }
    ...
    public KeyBundle recoverDeletedKey(String keyName) {
        ...
        RequestOptions requestOptions = new RequestOptions();
        return recoverDeletedKeyWithResponse(keyName, requestOptions).getValue().toObject(KeyBundle.class);
    }
    ...
    public KeyRotationPolicy getKeyRotationPolicy(String keyName) {
        ...
        RequestOptions requestOptions = new RequestOptions();
        return getKeyRotationPolicyWithResponse(keyName, requestOptions).getValue().toObject(KeyRotationPolicy.class);
    }
    ...
    public KeyRotationPolicy updateKeyRotationPolicy(String keyName, KeyRotationPolicy keyRotationPolicy) {
        ...
        return updateKeyRotationPolicyWithResponse(keyName, BinaryData.fromObject(keyRotationPolicy), requestOptions)
            .getValue()
            .toObject(KeyRotationPolicy.class);
    }
     ...
     * @return the public part of a stored key along with its attestation blob.
     * 
     * The get key attestation operation returns the key along with its attestation blob.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public KeyBundle getKeyAttestation(String keyName, String keyVersion) {
        // Generated convenience method for getKeyAttestationWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getKeyAttestationWithResponse(keyName, keyVersion, requestOptions).getValue().toObject(KeyBundle.class);
    }
}
