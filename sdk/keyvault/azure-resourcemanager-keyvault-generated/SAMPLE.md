...
public final class KeysCreateIfNotExistSamples {
    ...
    public static void createAKey(com.azure.resourcemanager.keyvault.generated.KeyVaultManager manager) {
        manager.keys().define("sample-key-name").withExistingVault("sample-group", "sample-vault-name")
            .withProperties(new KeyProperties().withKty(JsonWebKeyType.RSA)).create();
    }
}
```
...
public final class KeysGetSamples {
    ...
    public static void getAKey(com.azure.resourcemanager.keyvault.generated.KeyVaultManager manager) {
        manager.keys().getWithResponse("sample-group", "sample-vault-name", "sample-key-name",
...
public final class KeysGetVersionSamples {
    ...
    public static void getAKeyVersion(com.azure.resourcemanager.keyvault.generated.KeyVaultManager manager) {
        manager.keys().getVersionWithResponse("sample-group", "sample-vault-name", "sample-key-name",
...
public final class KeysListVersionsSamples {
    ...
    public static void listKeyVersionsInTheVault(com.azure.resourcemanager.keyvault.generated.KeyVaultManager manager) {
        manager.keys().listVersions("sample-group", "sample-vault-name", "sample-key-name",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class ManagedHsmKeysCreateIfNotExistSamples {
     ...
     */
    public static void createAKey(com.azure.resourcemanager.keyvault.generated.KeyVaultManager manager) {
        manager.managedHsmKeys().define("sample-key-name")
            .withExistingManagedHSM("sample-group", "sample-managedhsm-name")
            .withProperties(new ManagedHsmKeyProperties().withKty(JsonWebKeyType.RSA)).create();
    }
}
```
...
public final class ManagedHsmKeysGetSamples {
     ...
     */
    public static void getAKey(com.azure.resourcemanager.keyvault.generated.KeyVaultManager manager) {
        manager.managedHsmKeys().getWithResponse("sample-group", "sample-managedhsm-name", "sample-key-name",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class ManagedHsmKeysGetVersionSamples {
     ...
     */
    public static void getAKeyVersion(com.azure.resourcemanager.keyvault.generated.KeyVaultManager manager) {
        manager.managedHsmKeys().getVersionWithResponse("sample-group", "sample-managedhsm-name", "sample-key-name",
            "fd618d9519b74f9aae94ade66b876acc", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class ManagedHsmKeysListVersionsSamples {
    ...
    public static void
        ...
        manager.managedHsmKeys().listVersions("sample-group", "sample-managedhsm-name", "sample-key-name",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class ManagedHsmsCheckMhsmNameAvailabilitySamples {
    ...
    public static void validateAManagedHsmName(com.azure.resourcemanager.keyvault.generated.KeyVaultManager manager) {
        manager.managedHsms().checkMhsmNameAvailabilityWithResponse(
...
public final class ManagedHsmsCreateOrUpdateSamples {
    ...
    public static void createANewManagedHSMPoolOrUpdateAnExistingManagedHSMPool(
        ...
        manager.managedHsms().define("hsm1").withRegion("westus").withExistingResourceGroup("hsm-group")
            ...
            .withProperties(
                new ManagedHsmProperties().withTenantId(UUID.fromString("00000000-0000-0000-0000-000000000000"))
                    ...
                    .withEnableSoftDelete(true).withSoftDeleteRetentionInDays(90).withEnablePurgeProtection(false))
            .create();
    }
...
public final class MhsmPrivateEndpointConnectionsDeleteSamples {
    ...
    public static void managedHsmDeletePrivateEndpointConnection(
        com.azure.resourcemanager.keyvault.generated.KeyVaultManager manager) {
        manager.mhsmPrivateEndpointConnections().delete("sample-group", "sample-mhsm", "sample-pec",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class MhsmPrivateEndpointConnectionsGetSamples {
    ...
    public static void
        ...
        manager.mhsmPrivateEndpointConnections().getWithResponse("sample-group", "sample-mhsm", "sample-pec",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class MhsmPrivateEndpointConnectionsListByResourceSamples {
    ...
    public static void
        listManagedHSMPoolsInASubscription(com.azure.resourcemanager.keyvault.generated.KeyVaultManager manager) {
        manager.mhsmPrivateEndpointConnections().listByResource("sample-group", "sample-mhsm",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class MhsmPrivateEndpointConnectionsPutSamples {
    ...
    public static void
        ...
        manager.mhsmPrivateEndpointConnections().define("sample-pec").withRegion((String) null)
...
public final class MhsmPrivateLinkResourcesListByMhsmResourceSamples {
    ...
    public static void
        ...
        manager.mhsmPrivateLinkResources().listByMhsmResourceWithResponse("sample-group", "sample-mhsm",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class PrivateEndpointConnectionsDeleteSamples {
    ...
    public static void
        ...
        manager.privateEndpointConnections().delete("sample-group", "sample-vault", "sample-pec",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class PrivateEndpointConnectionsGetSamples {
    ...
    public static void
        ...
        manager.privateEndpointConnections().getWithResponse("sample-group", "sample-vault", "sample-pec",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class PrivateEndpointConnectionsListByResourceSamples {
    ...
    public static void
        ...
        manager.privateEndpointConnections().listByResource("sample-group", "sample-vault",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class PrivateEndpointConnectionsPutSamples {
    ...
    public static void
        ...
        manager.privateEndpointConnections().define("sample-pec").withRegion((String) null)
            .withExistingVault("sample-group", "sample-vault").withEtag("")
            .withPrivateLinkServiceConnectionState(
...
public final class PrivateLinkResourcesListByVaultSamples {
    ...
    public static void
        keyVaultListPrivateLinkResources(com.azure.resourcemanager.keyvault.generated.KeyVaultManager manager) {
        manager.privateLinkResources().listByVaultWithResponse("sample-group", "sample-vault",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class SecretsCreateOrUpdateSamples {
    ...
    public static void createASecret(com.azure.resourcemanager.keyvault.generated.KeyVaultManager manager) {
        manager.secrets().define("secret-name").withExistingVault("sample-group", "sample-vault")
            .withProperties(new SecretProperties().withValue("secret-value")).create();
    }
}
```
...
public final class SecretsGetSamples {
    ...
    public static void getASecret(com.azure.resourcemanager.keyvault.generated.KeyVaultManager manager) {
        manager.secrets().getWithResponse("sample-group", "sample-vault", "secret-name",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class VaultsCheckNameAvailabilitySamples {
    ...
    public static void validateAVaultName(com.azure.resourcemanager.keyvault.generated.KeyVaultManager manager) {
        manager.vaults().checkNameAvailabilityWithResponse(
...
public final class VaultsCreateOrUpdateSamples {
    ...
    public static void
        ...
        manager.vaults().define("sample-vault").withRegion("westus").withExistingResourceGroup("sample-resource-group")
...
public final class VaultsDeleteSamples {
    ...
    public static void deleteAVault(com.azure.resourcemanager.keyvault.generated.KeyVaultManager manager) {
        manager.vaults().deleteByResourceGroupWithResponse("sample-resource-group", "sample-vault",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class VaultsGetByResourceGroupSamples {
    ...
    public static void retrieveAVault(com.azure.resourcemanager.keyvault.generated.KeyVaultManager manager) {
        manager.vaults().getByResourceGroupWithResponse("sample-resource-group", "sample-vault",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class VaultsUpdateAccessPolicySamples {
    /*
     * x-ms-original-file:
     * specification/keyvault/resource-manager/Microsoft.KeyVault/stable/2023-07-01/examples/updateAccessPoliciesAdd.
     * json
     */
    /**
    ...
    public static void addAnAccessPolicyOrUpdateAnAccessPolicyWithNewPermissions(
        com.azure.resourcemanager.keyvault.generated.KeyVaultManager manager) {
        manager.vaults().updateAccessPolicyWithResponse("sample-group", "sample-vault", AccessPolicyUpdateKind.ADD,
