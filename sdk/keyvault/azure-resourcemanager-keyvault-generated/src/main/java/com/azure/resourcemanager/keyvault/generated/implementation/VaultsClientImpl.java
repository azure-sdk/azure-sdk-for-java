...
public final class VaultsClientImpl implements VaultsClient {
    ...
    public interface VaultsService {
        ...
        Mono<Response<ResourceListResult>> list(
            ...
            @QueryParam("$top") Integer top,
            @QueryParam("api-version") ResourceManagerApiVersions apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @HeaderParam("Accept") String accept,
            Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<VaultInner> updateAsync(String resourceGroupName, String vaultName, VaultPatchParameters parameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<VaultAccessPolicyParametersInner> updateAccessPolicyAsync(
        String resourceGroupName,
        String vaultName,
        AccessPolicyUpdateKind operationKind,
        VaultAccessPolicyParametersInner parameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<Resource>> listSinglePageAsync(ResourceManagerApiVersions apiVersion, Integer top) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    private Mono<PagedResponse<Resource>> listSinglePageAsync(
        ResourceManagerApiVersions apiVersion, Integer top, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<Resource> listAsync(ResourceManagerApiVersions apiVersion, Integer top) {
        return new PagedFlux<>(
            () -> listSinglePageAsync(apiVersion, top), nextLink -> listNextSinglePageAsync(nextLink));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<Resource> listAsync(ResourceManagerApiVersions apiVersion) {
        final Integer top = null;
        return new PagedFlux<>(
            () -> listSinglePageAsync(apiVersion, top), nextLink -> listNextSinglePageAsync(nextLink));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<Resource> listAsync(ResourceManagerApiVersions apiVersion, Integer top, Context context) {
        return new PagedFlux<>(
            () -> listSinglePageAsync(apiVersion, top, context),
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<Resource> list(ResourceManagerApiVersions apiVersion) {
        final Integer top = null;
        return new PagedIterable<>(listAsync(apiVersion, top));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<Resource> list(ResourceManagerApiVersions apiVersion, Integer top, Context context) {
        return new PagedIterable<>(listAsync(apiVersion, top, context));
    }
