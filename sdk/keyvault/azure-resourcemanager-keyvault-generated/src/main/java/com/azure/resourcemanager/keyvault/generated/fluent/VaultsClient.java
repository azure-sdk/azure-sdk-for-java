...
public interface VaultsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<Resource> list(ResourceManagerApiVersions apiVersion);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<Resource> list(ResourceManagerApiVersions apiVersion, Integer top, Context context);
