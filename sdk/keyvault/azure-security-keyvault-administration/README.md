# Azure KeyVault client library for Java

Azure KeyVault client library for Java.

This package contains Microsoft Azure KeyVault client library.
...
```java com.azure.security.keyvault.administration.readme
```
