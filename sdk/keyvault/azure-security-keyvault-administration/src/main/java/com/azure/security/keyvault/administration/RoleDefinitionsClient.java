...
public final class RoleDefinitionsClient {
    ...
    public PagedIterable<BinaryData> list(String scope, RequestOptions requestOptions) {
        return this.serviceClient.list(scope, requestOptions);
    }
    ...
    public RoleDefinition delete(String scope, String roleDefinitionName) {
        ...
        return deleteWithResponse(scope, roleDefinitionName, requestOptions).getValue().toObject(RoleDefinition.class);
    }
    ...
    public RoleDefinition get(String scope, String roleDefinitionName) {
        ...
        RequestOptions requestOptions = new RequestOptions();
        return getWithResponse(scope, roleDefinitionName, requestOptions).getValue().toObject(RoleDefinition.class);
    }
    ...
    public PagedIterable<RoleDefinition> list(String scope, String filter) {
        ...
        return serviceClient.list(scope, requestOptions)
            .mapPage(bodyItemValue -> bodyItemValue.toObject(RoleDefinition.class));
    }
