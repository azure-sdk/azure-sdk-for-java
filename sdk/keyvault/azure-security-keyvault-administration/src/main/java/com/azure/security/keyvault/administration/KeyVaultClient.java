...
public final class KeyVaultClient {
    ...
    public SyncPoller<BinaryData, BinaryData> beginFullBackup(BinaryData azureStorageBlobContainerUri,
        ...
        return this.serviceClient.beginFullBackup(azureStorageBlobContainerUri, requestOptions);
    }
    ...
    public SyncPoller<BinaryData, BinaryData> beginPreFullBackup(BinaryData preBackupOperationParameters,
        RequestOptions requestOptions) {
        return this.serviceClient.beginPreFullBackup(preBackupOperationParameters, requestOptions);
    }
    ...
    public SyncPoller<BinaryData, BinaryData> beginPreFullRestoreOperation(BinaryData preRestoreOperationParameters,
        RequestOptions requestOptions) {
        return this.serviceClient.beginPreFullRestoreOperation(preRestoreOperationParameters, requestOptions);
    }
    ...
    public SyncPoller<BinaryData, BinaryData> beginFullRestoreOperation(BinaryData restoreBlobDetails,
        RequestOptions requestOptions) {
        return this.serviceClient.beginFullRestoreOperation(restoreBlobDetails, requestOptions);
    }
    ...
    public SyncPoller<BinaryData, BinaryData> beginSelectiveKeyRestoreOperation(String keyName,
        ...
        return this.serviceClient.beginSelectiveKeyRestoreOperation(keyName, restoreBlobDetails, requestOptions);
    }
    ...
    public FullBackupOperation fullBackupStatus(String jobId) {
        ...
        return fullBackupStatusWithResponse(jobId, requestOptions).getValue().toObject(FullBackupOperation.class);
    }
    ...
    public SyncPoller<FullBackupOperation, FullBackupOperation>
        ...
        RequestOptions requestOptions = new RequestOptions();
        return serviceClient.beginFullBackupWithModel(BinaryData.fromObject(azureStorageBlobContainerUri),
            requestOptions);
    }
    ...
    public SyncPoller<FullBackupOperation, FullBackupOperation>
        ...
        RequestOptions requestOptions = new RequestOptions();
        return serviceClient.beginPreFullBackupWithModel(BinaryData.fromObject(preBackupOperationParameters),
            requestOptions);
    }
    ...
    public RestoreOperation restoreStatus(String jobId) {
        ...
        RequestOptions requestOptions = new RequestOptions();
        return restoreStatusWithResponse(jobId, requestOptions).getValue().toObject(RestoreOperation.class);
    }
    ...
    public SyncPoller<RestoreOperation, RestoreOperation>
        ...
        RequestOptions requestOptions = new RequestOptions();
        return serviceClient.beginPreFullRestoreOperationWithModel(BinaryData.fromObject(preRestoreOperationParameters),
            requestOptions);
    }
    ...
    public SyncPoller<RestoreOperation, RestoreOperation>
        ...
        RequestOptions requestOptions = new RequestOptions();
        return serviceClient.beginFullRestoreOperationWithModel(BinaryData.fromObject(restoreBlobDetails),
            requestOptions);
    }
    ...
    public SelectiveKeyRestoreOperation selectiveKeyRestoreStatus(String jobId) {
        ...
        RequestOptions requestOptions = new RequestOptions();
        return selectiveKeyRestoreStatusWithResponse(jobId, requestOptions).getValue()
            .toObject(SelectiveKeyRestoreOperation.class);
    }
    ...
    public SyncPoller<SelectiveKeyRestoreOperation, SelectiveKeyRestoreOperation>
        ...
        RequestOptions requestOptions = new RequestOptions();
        return serviceClient.beginSelectiveKeyRestoreOperationWithModel(keyName,
    ...
    public Setting updateSetting(String settingName, UpdateSettingRequest parameters) {
        ...
        RequestOptions requestOptions = new RequestOptions();
        return updateSettingWithResponse(settingName, BinaryData.fromObject(parameters), requestOptions).getValue()
    ...
    public Setting getSetting(String settingName) {
        ...
        RequestOptions requestOptions = new RequestOptions();
        return getSettingWithResponse(settingName, requestOptions).getValue().toObject(Setting.class);
    }
    ...
    public SettingsListResult getSettings() {
        ...
        RequestOptions requestOptions = new RequestOptions();
        return getSettingsWithResponse(requestOptions).getValue().toObject(SettingsListResult.class);
    }
}
