...
import com.azure.resourcemanager.storageactions.models.PagedStorageTaskAssignment;
...
public final class StorageTaskAssignmentsClientImpl implements StorageTaskAssignmentsClient {
    ...
    public interface StorageTaskAssignmentsService {
        ...
        Mono<Response<PagedStorageTaskAssignment>> list(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<PagedStorageTaskAssignment>> listNext(
