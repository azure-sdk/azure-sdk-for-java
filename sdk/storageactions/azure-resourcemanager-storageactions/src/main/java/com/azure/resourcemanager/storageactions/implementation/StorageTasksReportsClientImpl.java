...
import com.azure.resourcemanager.storageactions.models.StorageTaskReportInstanceListResult;
...
public final class StorageTasksReportsClientImpl implements StorageTasksReportsClient {
    ...
    public interface StorageTasksReportsService {
        ...
        Mono<Response<StorageTaskReportInstanceListResult>> list(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @QueryParam("$maxpagesize") String maxpagesize,
            @QueryParam("$filter") String filter, @PathParam("storageTaskName") String storageTaskName,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<StorageTaskReportInstanceListResult>> listNext(
     ...
     * @return the response of a StorageTaskReportInstance list operation along with {@link PagedResponse} on successful
    ...
    private Mono<PagedResponse<StorageTaskReportInstanceInner>> listSinglePageAsync(String resourceGroupName,
        ...
        return FluxUtil.withContext(context -> service.list(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, maxpagesize, filter, storageTaskName, accept, context))
    ...
    private Mono<PagedResponse<StorageTaskReportInstanceInner>> listSinglePageAsync(String resourceGroupName,
        ...
        return service
            .list(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
                resourceGroupName, maxpagesize, filter, storageTaskName, accept, context)
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the response of a StorageTaskReportInstance list operation as paginated response with {@link PagedFlux}.
     */
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the response of a StorageTaskReportInstance list operation as paginated response with
     * {@link PagedIterable}.
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
