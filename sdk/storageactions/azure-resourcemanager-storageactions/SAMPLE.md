...
public final class OperationsListSamples {
    /*
     * x-ms-original-file: specification/storageactions/resource-manager/Microsoft.StorageActions/stable/2023-01-01/examples/OperationsList.json
     */
    /**
...
public final class StorageTaskAssignmentListSamples {
    /*
     * x-ms-original-file: specification/storageactions/resource-manager/Microsoft.StorageActions/stable/2023-01-01/examples/StorageTaskAssignment_List.json
     */
    /**
     ...
     * @param manager Entry point to StorageActionsManager.
     */
    public static void listStorageTaskAssignmentsByResourceGroup(com.azure.resourcemanager.storageactions.StorageActionsManager manager) {
...
public final class StorageTasksCreateSamples {
    /*
     * x-ms-original-file: specification/storageactions/resource-manager/Microsoft.StorageActions/stable/2023-01-01/examples/StorageTasks_Create.json
     */
    /**
...
public final class StorageTasksDeleteSamples {
    /*
     * x-ms-original-file: specification/storageactions/resource-manager/Microsoft.StorageActions/stable/2023-01-01/examples/StorageTasks_Delete.json
     */
    /**
...
public final class StorageTasksGetByResourceGroupSamples {
    /*
     * x-ms-original-file: specification/storageactions/resource-manager/Microsoft.StorageActions/stable/2023-01-01/examples/StorageTasks_Get.json
     */
    /**
...
public final class StorageTasksListSamples {
    /*
     * x-ms-original-file: specification/storageactions/resource-manager/Microsoft.StorageActions/stable/2023-01-01/examples/StorageTasks_ListBySubscription.json
     */
    /**
     ...
     * @param manager Entry point to StorageActionsManager.
     */
    public static void listStorageTasksBySubscription(com.azure.resourcemanager.storageactions.StorageActionsManager manager) {
...
public final class StorageTasksListByResourceGroupSamples {
    /*
     * x-ms-original-file: specification/storageactions/resource-manager/Microsoft.StorageActions/stable/2023-01-01/examples/StorageTasks_ListByResourceGroup.json
     */
    /**
     ...
     * @param manager Entry point to StorageActionsManager.
     */
    public static void listStorageTasksByResourceGroup(com.azure.resourcemanager.storageactions.StorageActionsManager manager) {
...
public final class StorageTasksPreviewActionsSamples {
    /*
     * x-ms-original-file: specification/storageactions/resource-manager/Microsoft.StorageActions/stable/2023-01-01/examples/PerformStorageTaskActionsPreview.json
     */
    /**
...
public final class StorageTasksUpdateSamples {
    /*
     * x-ms-original-file: specification/storageactions/resource-manager/Microsoft.StorageActions/stable/2023-01-01/examples/StorageTasks_Update.json
     */
    /**
    ...
    public static void patchStorageTask(com.azure.resourcemanager.storageactions.StorageActionsManager manager) {
        StorageTask resource = manager.storageTasks().getByResourceGroupWithResponse("res4228", "mytask1", com.azure.core.util.Context.NONE).getValue();
        resource.update().withProperties(new StorageTaskProperties().withEnabled(true).withDescription("My Storage task").withAction(new StorageTaskAction().withIfProperty(new IfCondition().withCondition("[[equals(AccessTier, 'Cool')]]").withOperations(Arrays.asList(new StorageTaskOperation().withName(StorageTaskOperationName.SET_BLOB_TIER).withParameters(mapOf("tier", "Hot")).withOnSuccess(OnSuccess.CONTINUE).withOnFailure(OnFailure.BREAK)))).withElseProperty(new ElseCondition().withOperations(Arrays.asList(new StorageTaskOperation().withName(StorageTaskOperationName.DELETE_BLOB).withOnSuccess(OnSuccess.CONTINUE).withOnFailure(OnFailure.BREAK)))))).apply();
    }
...
public final class StorageTasksReportListSamples {
    /*
     * x-ms-original-file: specification/storageactions/resource-manager/Microsoft.StorageActions/stable/2023-01-01/examples/StorageTasksReport_List.json
     */
    /**
     * Sample code: ListStorageTasksByResourceGroup.
     * 
