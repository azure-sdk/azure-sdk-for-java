...
public final class DatabasesGetSamples {
    ...
    public static void getsADatabaseWithAvailabilityZoneSpecified(
        com.azure.resourcemanager.sql.generated.SqlManager manager) {
        manager.databases().getWithResponse("Default-SQL-SouthEastAsia", "testsvr", "testdb", null, null, Context.NONE);
    }
    ...
    public static void getsADatabaseWithDatabaseLevelKeysExpanded(
        ...
        manager
            .databases()
            .getWithResponse("Default-SQL-SouthEastAsia", "testsvr", "testdb", "keys", null, Context.NONE);
    }
...
public final class DatabasesUpdateSamples {
    ...
    public static void assignsMaintenanceWindowToADatabase(com.azure.resourcemanager.sql.generated.SqlManager manager) {
        Database resource =
            manager
                .databases()
                .getWithResponse("Default-SQL-SouthEastAsia", "testsvr", "testdb", null, null, Context.NONE)
                .getValue();
        resource
            .update()
...
public final class RestorableDroppedDatabasesGetSamples {
    ...
    public static void getsARestorableDroppedDatabaseWithExpandEqualsKeys(
        ...
        manager
            .restorableDroppedDatabases()
            .getWithResponse(
                "Default-SQL-SouthEastAsia", "testsvr", "testdb,131403269876900000", "keys", null, Context.NONE);
    }
    ...
    public static void getsARestorableDroppedDatabase(com.azure.resourcemanager.sql.generated.SqlManager manager) {
        manager
            .restorableDroppedDatabases()
            .getWithResponse(
                "Default-SQL-SouthEastAsia", "testsvr", "testdb,131403269876900000", null, null, Context.NONE);
    }
}
```
...
public final class ServersRefreshStatusSamples {
    ...
    public static void refreshExternalGovernanceEnablementStatus(
        com.azure.resourcemanager.sql.generated.SqlManager manager) {
        manager.servers().refreshStatus("sqlcrudtest-7398", "sqlcrudtest-4645", Context.NONE);
    }
}
```
