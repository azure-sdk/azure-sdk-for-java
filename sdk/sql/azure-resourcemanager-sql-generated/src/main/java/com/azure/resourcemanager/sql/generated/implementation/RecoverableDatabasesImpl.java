...
public final class RecoverableDatabasesImpl implements RecoverableDatabases {
    ...
    public RecoverableDatabasesImpl(RecoverableDatabasesClient innerClient,
    ...
    public PagedIterable<RecoverableDatabase> listByServer(String resourceGroupName, String serverName) {
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new RecoverableDatabaseImpl(inner1, this.manager()));
    }
    ...
    public Response<RecoverableDatabase> getWithResponse(String resourceGroupName, String serverName,
        String databaseName, String expand, String filter, Context context) {
        Response<RecoverableDatabaseInner> inner = this.serviceClient().getWithResponse(resourceGroupName, serverName,
