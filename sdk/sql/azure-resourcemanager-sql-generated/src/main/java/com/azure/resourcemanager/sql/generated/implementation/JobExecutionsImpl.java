...
public final class JobExecutionsImpl implements JobExecutions {
    ...
    public PagedIterable<JobExecution> listByAgent(String resourceGroupName, String serverName, String jobAgentName,
        ...
        PagedIterable<JobExecutionInner> inner = this.serviceClient().listByAgent(resourceGroupName, serverName,
            jobAgentName, createTimeMin, createTimeMax, endTimeMin, endTimeMax, isActive, skip, top, context);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new JobExecutionImpl(inner1, this.manager()));
    }
    ...
    public Response<Void> cancelWithResponse(String resourceGroupName, String serverName, String jobAgentName,
        ...
        return this.serviceClient().cancelWithResponse(resourceGroupName, serverName, jobAgentName, jobName,
            jobExecutionId, context);
    }
    ...
    public PagedIterable<JobExecution> listByJob(String resourceGroupName, String serverName, String jobAgentName,
        String jobName) {
        PagedIterable<JobExecutionInner> inner
    ...
    public PagedIterable<JobExecution> listByJob(String resourceGroupName, String serverName, String jobAgentName,
        ...
        OffsetDateTime endTimeMax, Boolean isActive, Integer skip, Integer top, Context context) {
        PagedIterable<JobExecutionInner> inner = this.serviceClient().listByJob(resourceGroupName, serverName,
            jobAgentName, jobName, createTimeMin, createTimeMax, endTimeMin, endTimeMax, isActive, skip, top, context);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new JobExecutionImpl(inner1, this.manager()));
    }
    ...
    public JobExecution createOrUpdate(String resourceGroupName, String serverName, String jobAgentName, String jobName,
        UUID jobExecutionId) {
        JobExecutionInner inner
    ...
    public JobExecution createOrUpdate(String resourceGroupName, String serverName, String jobAgentName, String jobName,
        ...
        JobExecutionInner inner = this.serviceClient().createOrUpdate(resourceGroupName, serverName, jobAgentName,
            jobName, jobExecutionId, context);
        if (inner != null) {
            return new JobExecutionImpl(inner, this.manager());
        } else {
            return null;
