...
public final class RestorableDroppedManagedDatabasesImpl implements RestorableDroppedManagedDatabases {
    ...
    public RestorableDroppedManagedDatabasesImpl(RestorableDroppedManagedDatabasesClient innerClient,
        com.azure.resourcemanager.sql.generated.SqlManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public PagedIterable<RestorableDroppedManagedDatabase> listByInstance(String resourceGroupName,
        ...
        return ResourceManagerUtils.mapPage(inner,
            inner1 -> new RestorableDroppedManagedDatabaseImpl(inner1, this.manager()));
    }
    ...
    public Response<RestorableDroppedManagedDatabase> getWithResponse(String resourceGroupName,
        String managedInstanceName, String restorableDroppedDatabaseId, Context context) {
        Response<RestorableDroppedManagedDatabaseInner> inner = this.serviceClient().getWithResponse(resourceGroupName,
            managedInstanceName, restorableDroppedDatabaseId, context);
        if (inner != null) {
    ...
    public RestorableDroppedManagedDatabase get(String resourceGroupName, String managedInstanceName,
