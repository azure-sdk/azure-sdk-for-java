...
@Fluent
public final class JobExecutionAutoGeneratedInner extends ProxyResource {
    /*
     * Resource properties.
     */
    @JsonProperty(value = "properties")
    private JobExecutionPropertiesAutoGenerated innerProperties;

    /** Creates an instance of JobExecutionAutoGeneratedInner class. */
    public JobExecutionAutoGeneratedInner() {
    }
     ...
     * @return the JobExecutionAutoGeneratedInner object itself.
     */
    public JobExecutionAutoGeneratedInner withCurrentAttempts(Integer currentAttempts) {
        if (this.innerProperties() == null) {
            this.innerProperties = new JobExecutionPropertiesAutoGenerated();
        }
