...
public final class JobImpl implements Job, Job.Definition, Job.Update {
    ...
    public Job create() {
        this.innerObject = serviceManager.serviceClient().getJobs().createOrUpdateWithResponse(resourceGroupName,
            serverName, jobAgentName, jobName, this.innerModel(), Context.NONE).getValue();
        return this;
    }

    public Job create(Context context) {
        this.innerObject = serviceManager.serviceClient().getJobs().createOrUpdateWithResponse(resourceGroupName,
            serverName, jobAgentName, jobName, this.innerModel(), context).getValue();
        return this;
    }
    ...
    public Job refresh() {
        this.innerObject = serviceManager.serviceClient().getJobs()
            .getWithResponse(resourceGroupName, serverName, jobAgentName, jobName, Context.NONE).getValue();
        return this;
    }

    public Job refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getJobs()
            .getWithResponse(resourceGroupName, serverName, jobAgentName, jobName, context).getValue();
        return this;
    }
