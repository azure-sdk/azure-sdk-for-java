...
import com.azure.resourcemanager.sql.generated.models.JobAgentVersionCapability;
...
public final class LocationCapabilitiesImpl implements LocationCapabilities {
    ...
    LocationCapabilitiesImpl(LocationCapabilitiesInner innerObject,
    ...
    public List<JobAgentVersionCapability> supportedJobAgentVersions() {
        List<JobAgentVersionCapability> inner = this.innerModel().supportedJobAgentVersions();
        if (inner != null) {
            return Collections.unmodifiableList(inner);
        } else {
            return Collections.emptyList();
