...
import com.azure.resourcemanager.sql.generated.models.ServerBlobAuditingPolicyListResult;
...
public final class ServerBlobAuditingPoliciesClientImpl implements ServerBlobAuditingPoliciesClient {
    ...
    /**
     * The interface defining all the services for SqlManagementClientServerBlobAuditingPolicies to be used by the
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ServerBlobAuditingPolicyInner> getAsync(String resourceGroupName, String serverName) {
    ...
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String resourceGroupName,
        String serverName, ServerBlobAuditingPolicyInner parameters) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
