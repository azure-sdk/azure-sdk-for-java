...
public final class JobTargetGroupInner extends ProxyResource {
     ...
     * @return An instance of JobTargetGroupInner if the JsonReader was pointing to an instance of it, or null if it was
     * pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the JobTargetGroupInner.
     */
    public static JobTargetGroupInner fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            JobTargetGroupInner deserializedJobTargetGroupInner = new JobTargetGroupInner();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("id".equals(fieldName)) {
                    deserializedJobTargetGroupInner.id = reader.getString();
                } else if ("name".equals(fieldName)) {
                    deserializedJobTargetGroupInner.name = reader.getString();
                } else if ("type".equals(fieldName)) {
                    deserializedJobTargetGroupInner.type = reader.getString();
                } else if ("properties".equals(fieldName)) {
                    deserializedJobTargetGroupInner.innerProperties = JobTargetGroupProperties.fromJson(reader);
                } else {
                    reader.skipChildren();
                }
            }

            return deserializedJobTargetGroupInner;
        });
    }
}
