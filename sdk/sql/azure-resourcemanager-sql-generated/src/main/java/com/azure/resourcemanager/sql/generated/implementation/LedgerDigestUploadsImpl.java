...
public final class LedgerDigestUploadsImpl
    ...
    public LedgerDigestUploadsImpl withExistingDatabase(String resourceGroupName, String serverName,
        String databaseName) {
    ...
    public LedgerDigestUploads create() {
        this.innerObject = serviceManager.serviceClient().getLedgerDigestUploadsOperations().createOrUpdate(
    ...
    LedgerDigestUploadsImpl(LedgerDigestUploadsName name,
    ...
    LedgerDigestUploadsImpl(LedgerDigestUploadsInner innerObject,
        com.azure.resourcemanager.sql.generated.SqlManager serviceManager) {
        ...
        this.ledgerDigestUploads = LedgerDigestUploadsName
            .fromString(ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "ledgerDigestUploads"));
    }

    public LedgerDigestUploads refresh() {
        this.innerObject = serviceManager.serviceClient().getLedgerDigestUploadsOperations()
            .getWithResponse(resourceGroupName, serverName, databaseName, ledgerDigestUploads, Context.NONE).getValue();
        return this;
    }

    public LedgerDigestUploads refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getLedgerDigestUploadsOperations()
            .getWithResponse(resourceGroupName, serverName, databaseName, ledgerDigestUploads, context).getValue();
        return this;
    }

    public LedgerDigestUploads disable() {
        return serviceManager.ledgerDigestUploadsOperations().disable(resourceGroupName, serverName, databaseName,
            ledgerDigestUploads);
    }

    public LedgerDigestUploads disable(Context context) {
        return serviceManager.ledgerDigestUploadsOperations().disable(resourceGroupName, serverName, databaseName,
            ledgerDigestUploads, context);
    }
