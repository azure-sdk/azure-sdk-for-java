...
public final class SyncGroupImpl implements SyncGroup, SyncGroup.Definition, SyncGroup.Update {
    ...
    public SyncGroup create() {
        this.innerObject = serviceManager.serviceClient().getSyncGroups().createOrUpdate(resourceGroupName, serverName,
            databaseName, syncGroupName, this.innerModel(), Context.NONE);
        return this;
    }

    public SyncGroup create(Context context) {
        this.innerObject = serviceManager.serviceClient().getSyncGroups().createOrUpdate(resourceGroupName, serverName,
            databaseName, syncGroupName, this.innerModel(), context);
        return this;
    }
    ...
    public SyncGroup apply() {
        this.innerObject = serviceManager.serviceClient().getSyncGroups().update(resourceGroupName, serverName,
            databaseName, syncGroupName, this.innerModel(), Context.NONE);
        return this;
    }
    ...
    public SyncGroup refresh() {
        this.innerObject = serviceManager.serviceClient().getSyncGroups()
            .getWithResponse(resourceGroupName, serverName, databaseName, syncGroupName, Context.NONE).getValue();
        return this;
    }

    public SyncGroup refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getSyncGroups()
            .getWithResponse(resourceGroupName, serverName, databaseName, syncGroupName, context).getValue();
        return this;
    }
    ...
    public Response<Void> cancelSyncWithResponse(Context context) {
        return serviceManager.syncGroups().cancelSyncWithResponse(resourceGroupName, serverName, databaseName,
            syncGroupName, context);
    }
    ...
    public Response<Void> triggerSyncWithResponse(Context context) {
        return serviceManager.syncGroups().triggerSyncWithResponse(resourceGroupName, serverName, databaseName,
            syncGroupName, context);
    }
