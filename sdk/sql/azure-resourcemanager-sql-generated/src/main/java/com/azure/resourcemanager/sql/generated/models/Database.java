...
public interface Database {
     ...
     * that are used to provide high availability. Not applicable to a Hyperscale database within an elastic pool.
     *
     ...
     * the free database.
     *
     * <p>AutoPause: The database will be auto paused upon exhaustion of free limits for remainder of the month.
     *
     * <p>BillForUsage: The database will continue to be online upon exhaustion of free limits and any overage will be
     * billed.
     *
    ...
    interface DefinitionStages {
        ...
        interface WithCreate
            extends DefinitionStages.WithTags,
                ...
                DefinitionStages.WithRequestedBackupStorageRedundancy,
                DefinitionStages.WithMinCapacity,
                DefinitionStages.WithMaintenanceConfigurationId,
                DefinitionStages.WithIsLedgerOn,
                DefinitionStages.WithFederatedClientId,
                DefinitionStages.WithKeys,
                DefinitionStages.WithEncryptionProtector,
                DefinitionStages.WithPreferredEnclaveType,
                DefinitionStages.WithUseFreeLimit,
                DefinitionStages.WithFreeLimitExhaustionBehavior,
                DefinitionStages.WithSourceResourceId,
                DefinitionStages.WithManualCutover,
                DefinitionStages.WithPerformCutover,
        ...
        interface WithHighAvailabilityReplicaCount {
             ...
             * database that are used to provide high availability. Not applicable to a Hyperscale database within an
             * elastic pool..
             *
             * @param highAvailabilityReplicaCount The number of secondary replicas associated with the database that
             *     are used to provide high availability. Not applicable to a Hyperscale database within an elastic
             *     pool.
             * @return the next definition stage.
             */
        ...
        interface WithFreeLimitExhaustionBehavior {
             ...
             * <p>AutoPause: The database will be auto paused upon exhaustion of free limits for remainder of the month.
             *
             * <p>BillForUsage: The database will continue to be online upon exhaustion of free limits and any overage
             * will be billed..
             *
             * @param freeLimitExhaustionBehavior Specifies the behavior when monthly free limits are exhausted for the
             *     free database.
             *     <p>AutoPause: The database will be auto paused upon exhaustion of free limits for remainder of the
             *     month.
             *     <p>BillForUsage: The database will continue to be online upon exhaustion of free limits and any
        ...
        interface WithSourceResourceId {
             ...
             * <p>This property is only supported for DataWarehouse edition and allows to restore across subscriptions.
             *
             * <p>When sourceResourceId is specified, sourceDatabaseId, recoverableDatabaseId,
             * restorableDroppedDatabaseId and sourceDatabaseDeletionDate must not be specified and CreateMode must be
             * PointInTimeRestore, Restore or Recover.
             *
             * <p>When createMode is PointInTimeRestore, sourceResourceId must be the resource ID of the existing
             * database or existing sql pool, and restorePointInTime must be specified.
             *
             * <p>When createMode is Restore, sourceResourceId must be the resource ID of restorable dropped database or
             * restorable dropped sql pool.
             *
             * <p>When createMode is Recover, sourceResourceId must be the resource ID of recoverable database or
             ...
             *     this database.
             *     <p>This property is only supported for DataWarehouse edition and allows to restore across
             *     subscriptions.
             *     <p>When sourceResourceId is specified, sourceDatabaseId, recoverableDatabaseId,
             *     restorableDroppedDatabaseId and sourceDatabaseDeletionDate must not be specified and CreateMode must
             *     be PointInTimeRestore, Restore or Recover.
             *     <p>When createMode is PointInTimeRestore, sourceResourceId must be the resource ID of the existing
             *     database or existing sql pool, and restorePointInTime must be specified.
             *     <p>When createMode is Restore, sourceResourceId must be the resource ID of restorable dropped
             *     database or restorable dropped sql pool.
             *     <p>When createMode is Recover, sourceResourceId must be the resource ID of recoverable database or
             *     recoverable sql pool.
             *     <p>When source subscription belongs to a different tenant than target subscription,
             *     “x-ms-authorization-auxiliary” header must contain authentication token for the source tenant. For
             *     more details about “x-ms-authorization-auxiliary” header see
             *     https://docs.microsoft.com/en-us/azure/azure-resource-manager/management/authenticate-multi-tenant.
             * @return the next definition stage.
             */
        ...
        interface WithManualCutover {
             ...
             *
             * <p>This property is only applicable when scaling database from Business Critical/General
             * Purpose/Premium/Standard tier to Hyperscale tier.
             *
             * <p>When manualCutover is specified, the scaling operation will wait for user input to trigger cutover to
             * Hyperscale database.
             *
             * <p>To trigger cutover, please provide 'performCutover' parameter when the Scaling operation is in Waiting
             * state..
             *
             ...
             *     <p>This property is only applicable when scaling database from Business Critical/General
             *     Purpose/Premium/Standard tier to Hyperscale tier.
             *     <p>When manualCutover is specified, the scaling operation will wait for user input to trigger cutover
             *     to Hyperscale database.
             *     <p>To trigger cutover, please provide 'performCutover' parameter when the Scaling operation is in
             *     Waiting state.
             * @return the next definition stage.
             */
        ...
        interface WithPerformCutover {
             ...
             *
             * <p>When performCutover is specified, the scaling operation will trigger cutover and perform role-change
             * to Hyperscale database..
             *
             ...
             *     <p>This property is only applicable when scaling database from Business Critical/General
             *     Purpose/Premium/Standard tier to Hyperscale tier is already in progress.
             *     <p>When performCutover is specified, the scaling operation will trigger cutover and perform
    ...
    interface Update
        extends UpdateStages.WithTags,
            ...
            UpdateStages.WithRequestedBackupStorageRedundancy,
            UpdateStages.WithMinCapacity,
            UpdateStages.WithMaintenanceConfigurationId,
            UpdateStages.WithIsLedgerOn,
            UpdateStages.WithFederatedClientId,
            UpdateStages.WithKeys,
            UpdateStages.WithEncryptionProtector,
            UpdateStages.WithPreferredEnclaveType,
            UpdateStages.WithUseFreeLimit,
            UpdateStages.WithFreeLimitExhaustionBehavior,
            UpdateStages.WithManualCutover,
            UpdateStages.WithPerformCutover,
            UpdateStages.WithEncryptionProtectorAutoRotation {
        /**
