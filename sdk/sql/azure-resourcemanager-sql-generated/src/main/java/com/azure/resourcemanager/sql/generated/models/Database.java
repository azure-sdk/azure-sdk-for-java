...
public interface Database {
    ...
    /**
     * Gets the identity property: The Azure Active Directory identity of the database.
     * 
    ...
    /**
     * Gets the hyperscaleBillingVersion property: The pricing model to use when calculating billing for this database.
     * 
     * @return the hyperscaleBillingVersion value.
     */
    HyperscaleBillingVersion hyperscaleBillingVersion();
    ...
    /**
     * Gets the highAvailabilityReplicaCount property: The number of secondary replicas associated with the Business
     * Critical, Premium, or Hyperscale edition database that are used to provide high availability. Not applicable to a
    ...
    /**
     * Gets the isLedgerOn property: Whether or not this database is a ledger database, which means all tables in the
    ...
    /**
     * Gets the isInfraEncryptionEnabled property: Infra encryption is enabled for this database.
     * 
    ...
    /**
     * Gets the federatedClientId property: The Client id used for cross tenant per database CMK scenario.
     * 
    ...
    /**
     * Gets the keys property: The resource ids of the user assigned identities to use.
     * 
     * @return the keys value.
     */
    Map<String, DatabaseKey> keys();

    /**
     * Gets the encryptionProtector property: The azure key vault URI of the database if it's configured with per
    ...
    /**
     * Gets the preferredEnclaveType property: Type of enclave requested on the database i.e. Default or VBS enclaves.
     * 
     * @return the preferredEnclaveType value.
     */
    AlwaysEncryptedEnclaveType preferredEnclaveType();

    /**
     * Gets the useFreeLimit property: Whether or not the database uses free monthly limits. Allowed on one database in
     * a subscription.
     * 
     * @return the useFreeLimit value.
     */
    Boolean useFreeLimit();

    /**
     * Gets the freeLimitExhaustionBehavior property: Specifies the behavior when monthly free limits are exhausted for
     * the free database.
     * 
    ...
    /**
     * Gets the sourceResourceId property: The resource identifier of the source associated with the create operation of
     * this database.
     * 
    ...
    /**
     * Gets the manualCutover property: Whether or not customer controlled manual cutover needs to be done during Update
     ...
     */
    Boolean manualCutover();

    /**
     * Gets the performCutover property: To trigger customer controlled manual cutover during the wait state while
     ...
     */
    Boolean performCutover();

    /**
     * Gets the availabilityZone property: Specifies the availability zone the database is pinned to.
     * 
    ...
    /**
     * Gets the encryptionProtectorAutoRotation property: The flag to enable or disable auto rotation of database
     * encryption protector AKV key.
     * 
     * @return the encryptionProtectorAutoRotation value.
     */
    Boolean encryptionProtectorAutoRotation();
    ...
    interface DefinitionStages {
        ...
        interface WithCreate extends DefinitionStages.WithTags, DefinitionStages.WithSku, DefinitionStages.WithIdentity,
            DefinitionStages.WithCreateMode, DefinitionStages.WithCollation, DefinitionStages.WithMaxSizeBytes,
            DefinitionStages.WithSampleName, DefinitionStages.WithElasticPoolId, DefinitionStages.WithSourceDatabaseId,
            DefinitionStages.WithRestorePointInTime, DefinitionStages.WithSourceDatabaseDeletionDate,
            DefinitionStages.WithRecoveryServicesRecoveryPointId,
            DefinitionStages.WithLongTermRetentionBackupResourceId, DefinitionStages.WithRecoverableDatabaseId,
            DefinitionStages.WithRestorableDroppedDatabaseId, DefinitionStages.WithCatalogCollation,
            DefinitionStages.WithZoneRedundant, DefinitionStages.WithLicenseType,
            DefinitionStages.WithHighAvailabilityReplicaCount, DefinitionStages.WithSecondaryType,
            DefinitionStages.WithAutoPauseDelay, DefinitionStages.WithRequestedBackupStorageRedundancy,
            DefinitionStages.WithMinCapacity, DefinitionStages.WithMaintenanceConfigurationId,
            DefinitionStages.WithIsLedgerOn, DefinitionStages.WithFederatedClientId, DefinitionStages.WithKeys,
            DefinitionStages.WithEncryptionProtector, DefinitionStages.WithPreferredEnclaveType,
            DefinitionStages.WithUseFreeLimit, DefinitionStages.WithFreeLimitExhaustionBehavior,
            DefinitionStages.WithSourceResourceId, DefinitionStages.WithManualCutover,
            DefinitionStages.WithPerformCutover, DefinitionStages.WithAvailabilityZone,
            DefinitionStages.WithEncryptionProtectorAutoRotation {
            /**
        ...
        /**
         * The stage of the Database definition allowing to specify identity.
         */
        interface WithIdentity {
            /**
             * Specifies the identity property: The Azure Active Directory identity of the database..
             * 
             * @param identity The Azure Active Directory identity of the database.
             * @return the next definition stage.
             */
            WithCreate withIdentity(DatabaseIdentity identity);
        }
        ...
        interface WithCreateMode {
             ...
             * Default: regular database creation.
             * 
             * Copy: creates a database as a copy of an existing database. sourceDatabaseId must be specified as the
             * resource ID of the source database.
             * 
             * Secondary: creates a database as a secondary replica of an existing database. sourceDatabaseId must be
             ...
             * must be specified.
             * 
             * Recovery: Creates a database by restoring a geo-replicated backup. sourceDatabaseId must be specified as
             * the recoverable database resource ID to restore.
             * 
             * Restore: Creates a database by restoring a backup of a deleted database. sourceDatabaseId must be
        ...
        interface WithHighAvailabilityReplicaCount {
             ...
             * Business Critical, Premium, or Hyperscale edition database that are used to provide high availability.
             * Not applicable to a Hyperscale database within an elastic pool..
             * 
             * @param highAvailabilityReplicaCount The number of secondary replicas associated with the Business
             * Critical, Premium, or Hyperscale edition database that are used to provide high availability. Not
             * applicable to a Hyperscale database within an elastic pool.
             * @return the next definition stage.
             */
        ...
        interface WithSecondaryType {
             ...
             * 
             * @param secondaryType The secondary type of the database if it is a secondary. Valid values are Geo, Named
             * and Standby.
             * @return the next definition stage.
             */
        ...
        /**
         * The stage of the Database definition allowing to specify requestedBackupStorageRedundancy.
         */
        ...
        /**
         * The stage of the Database definition allowing to specify isLedgerOn.
         */
        interface WithIsLedgerOn {
            /**
             * Specifies the isLedgerOn property: Whether or not this database is a ledger database, which means all
             * tables in the database are ledger tables. Note: the value of this property cannot be changed after the
             * database has been created..
             * 
             * @param isLedgerOn Whether or not this database is a ledger database, which means all tables in the
             * database are ledger tables. Note: the value of this property cannot be changed after the database has
             * been created.
             * @return the next definition stage.
             */
            WithCreate withIsLedgerOn(Boolean isLedgerOn);
        }

        /**
         * The stage of the Database definition allowing to specify federatedClientId.
         */
        interface WithFederatedClientId {
            /**
             * Specifies the federatedClientId property: The Client id used for cross tenant per database CMK scenario.
             * 
        ...
        /**
         * The stage of the Database definition allowing to specify keys.
         */
        interface WithKeys {
            /**
             * Specifies the keys property: The resource ids of the user assigned identities to use.
             * 
             * @param keys The resource ids of the user assigned identities to use.
             * @return the next definition stage.
             */
            WithCreate withKeys(Map<String, DatabaseKey> keys);
        }

        /**
         * The stage of the Database definition allowing to specify encryptionProtector.
         */
        interface WithEncryptionProtector {
            /**
             * Specifies the encryptionProtector property: The azure key vault URI of the database if it's configured
             * with per Database Customer Managed Keys..
             * 
             * @param encryptionProtector The azure key vault URI of the database if it's configured with per Database
             * Customer Managed Keys.
             * @return the next definition stage.
             */
            WithCreate withEncryptionProtector(String encryptionProtector);
        }

        /**
         * The stage of the Database definition allowing to specify preferredEnclaveType.
         */
        interface WithPreferredEnclaveType {
            /**
             * Specifies the preferredEnclaveType property: Type of enclave requested on the database i.e. Default or
             * VBS enclaves..
             * 
             * @param preferredEnclaveType Type of enclave requested on the database i.e. Default or VBS enclaves.
             * @return the next definition stage.
             */
            WithCreate withPreferredEnclaveType(AlwaysEncryptedEnclaveType preferredEnclaveType);
        }

        /**
         * The stage of the Database definition allowing to specify useFreeLimit.
         */
        interface WithUseFreeLimit {
            /**
             * Specifies the useFreeLimit property: Whether or not the database uses free monthly limits. Allowed on one
             * database in a subscription..
             * 
             * @param useFreeLimit Whether or not the database uses free monthly limits. Allowed on one database in a
             * subscription.
             * @return the next definition stage.
             */
            WithCreate withUseFreeLimit(Boolean useFreeLimit);
        }

        /**
         * The stage of the Database definition allowing to specify freeLimitExhaustionBehavior.
         */
        interface WithFreeLimitExhaustionBehavior {
            /**
             * Specifies the freeLimitExhaustionBehavior property: Specifies the behavior when monthly free limits are
             * exhausted for the free database.
             * 
             * AutoPause: The database will be auto paused upon exhaustion of free limits for remainder of the month.
             * 
             * BillForUsage: The database will continue to be online upon exhaustion of free limits and any overage will
             * be billed..
             * 
             * @param freeLimitExhaustionBehavior Specifies the behavior when monthly free limits are exhausted for the
             * free database.
             * 
             * AutoPause: The database will be auto paused upon exhaustion of free limits for remainder of the month.
             * 
             ...
             * @return the next definition stage.
             */
            WithCreate withFreeLimitExhaustionBehavior(FreeLimitExhaustionBehavior freeLimitExhaustionBehavior);
        }

        /**
         * The stage of the Database definition allowing to specify sourceResourceId.
         */
        interface WithSourceResourceId {
            /**
             * Specifies the sourceResourceId property: The resource identifier of the source associated with the create
             * operation of this database.
             * 
             * This property is only supported for DataWarehouse edition and allows to restore across subscriptions.
             * 
             * When sourceResourceId is specified, sourceDatabaseId, recoverableDatabaseId, restorableDroppedDatabaseId
             * and sourceDatabaseDeletionDate must not be specified and CreateMode must be PointInTimeRestore, Restore
             * or Recover.
             * 
             * When createMode is PointInTimeRestore, sourceResourceId must be the resource ID of the existing database
             * or existing sql pool, and restorePointInTime must be specified.
             * 
             ...
             * “x-ms-authorization-auxiliary” header must contain authentication token for the source tenant. For more
             * details about “x-ms-authorization-auxiliary” header see
             * https://docs.microsoft.com/en-us/azure/azure-resource-manager/management/authenticate-multi-tenant .
             * 
             * @param sourceResourceId The resource identifier of the source associated with the create operation of
             * this database.
             * 
             * This property is only supported for DataWarehouse edition and allows to restore across subscriptions.
             * 
        ...
        /**
         * The stage of the Database definition allowing to specify manualCutover.
         */
        interface WithManualCutover {
            /**
             * Specifies the manualCutover property: Whether or not customer controlled manual cutover needs to be done
             ...
             * 
             * When manualCutover is specified, the scaling operation will wait for user input to trigger cutover to
             * Hyperscale database.
             * 
             * To trigger cutover, please provide 'performCutover' parameter when the Scaling operation is in Waiting
             * state..
             * 
             * @param manualCutover Whether or not customer controlled manual cutover needs to be done during Update
             * Database operation to Hyperscale tier.
             * 
             * This property is only applicable when scaling database from Business Critical/General
             * Purpose/Premium/Standard tier to Hyperscale tier.
             ...
             * @return the next definition stage.
             */
            WithCreate withManualCutover(Boolean manualCutover);
        }

        /**
         * The stage of the Database definition allowing to specify performCutover.
         */
        interface WithPerformCutover {
            /**
             * Specifies the performCutover property: To trigger customer controlled manual cutover during the wait
             ...
             * Hyperscale database..
             * 
             * @param performCutover To trigger customer controlled manual cutover during the wait state while Scaling
             ...
             * @return the next definition stage.
             */
            WithCreate withPerformCutover(Boolean performCutover);
        }

        /**
         * The stage of the Database definition allowing to specify availabilityZone.
         */
        interface WithAvailabilityZone {
            /**
             * Specifies the availabilityZone property: Specifies the availability zone the database is pinned to..
             * 
             * @param availabilityZone Specifies the availability zone the database is pinned to.
             * @return the next definition stage.
             */
            WithCreate withAvailabilityZone(AvailabilityZoneType availabilityZone);
        }

        /**
         * The stage of the Database definition allowing to specify encryptionProtectorAutoRotation.
         */
        interface WithEncryptionProtectorAutoRotation {
            /**
             * Specifies the encryptionProtectorAutoRotation property: The flag to enable or disable auto rotation of
             * database encryption protector AKV key..
             * 
             * @param encryptionProtectorAutoRotation The flag to enable or disable auto rotation of database encryption
             * protector AKV key.
             * @return the next definition stage.
             */
            WithCreate withEncryptionProtectorAutoRotation(Boolean encryptionProtectorAutoRotation);
        }
    }
    ...
    interface Update extends UpdateStages.WithTags, UpdateStages.WithSku, UpdateStages.WithIdentity,
        UpdateStages.WithMaxSizeBytes, UpdateStages.WithElasticPoolId, UpdateStages.WithZoneRedundant,
        UpdateStages.WithLicenseType, UpdateStages.WithReadScale, UpdateStages.WithHighAvailabilityReplicaCount,
        UpdateStages.WithSecondaryType, UpdateStages.WithAutoPauseDelay,
        UpdateStages.WithRequestedBackupStorageRedundancy, UpdateStages.WithMinCapacity,
        UpdateStages.WithMaintenanceConfigurationId, UpdateStages.WithIsLedgerOn, UpdateStages.WithFederatedClientId,
        UpdateStages.WithKeys, UpdateStages.WithEncryptionProtector, UpdateStages.WithPreferredEnclaveType,
        UpdateStages.WithUseFreeLimit, UpdateStages.WithFreeLimitExhaustionBehavior, UpdateStages.WithManualCutover,
        UpdateStages.WithPerformCutover, UpdateStages.WithEncryptionProtectorAutoRotation {
        /**
    ...
    interface UpdateStages {
        ...
        /**
         * The stage of the Database update allowing to specify identity.
         */
        interface WithIdentity {
            /**
             * Specifies the identity property: Database identity.
             * 
             * @param identity Database identity.
             * @return the next definition stage.
             */
            Update withIdentity(DatabaseIdentity identity);
        }
        ...
        interface WithReadScale {
             ...
             * replica in the same region. Not applicable to a Hyperscale database within an elastic pool..
             * 
             * @param readScale The state of read-only routing. If enabled, connections that have application intent set
             * to readonly in their connection string may be routed to a readonly secondary replica in the same region.
             * Not applicable to a Hyperscale database within an elastic pool.
             * @return the next definition stage.
             */
        ...
        /**
         * The stage of the Database update allowing to specify requestedBackupStorageRedundancy.
         */
        interface WithRequestedBackupStorageRedundancy {
            /**
             * Specifies the requestedBackupStorageRedundancy property: The storage account type to be used to store
             ...
             * @return the next definition stage.
             */
            Update withRequestedBackupStorageRedundancy(BackupStorageRedundancy requestedBackupStorageRedundancy);
        }
        ...
        /**
         * The stage of the Database update allowing to specify isLedgerOn.
         */
        interface WithIsLedgerOn {
            /**
             * Specifies the isLedgerOn property: Whether or not this database is a ledger database, which means all
             ...
             * @return the next definition stage.
             */
            Update withIsLedgerOn(Boolean isLedgerOn);
        }

        /**
         * The stage of the Database update allowing to specify federatedClientId.
         */
        interface WithFederatedClientId {
            /**
             * Specifies the federatedClientId property: The Client id used for cross tenant per database CMK scenario.
        ...
        /**
         * The stage of the Database update allowing to specify keys.
         */
        interface WithKeys {
            /**
             * Specifies the keys property: The resource ids of the user assigned identities to use.
             ...
             * @return the next definition stage.
             */
            Update withKeys(Map<String, DatabaseKey> keys);
        }

        /**
         * The stage of the Database update allowing to specify encryptionProtector.
         */
        interface WithEncryptionProtector {
            /**
             * Specifies the encryptionProtector property: The azure key vault URI of the database if it's configured
             ...
             * @return the next definition stage.
             */
            Update withEncryptionProtector(String encryptionProtector);
        }

        /**
         * The stage of the Database update allowing to specify preferredEnclaveType.
         */
        interface WithPreferredEnclaveType {
            /**
             * Specifies the preferredEnclaveType property: Type of enclave requested on the database i.e. Default or
             ...
             * @return the next definition stage.
             */
            Update withPreferredEnclaveType(AlwaysEncryptedEnclaveType preferredEnclaveType);
        }

        /**
         * The stage of the Database update allowing to specify useFreeLimit.
         */
        interface WithUseFreeLimit {
            /**
             * Specifies the useFreeLimit property: Whether or not the database uses free monthly limits. Allowed on one
             ...
             * @return the next definition stage.
             */
            Update withUseFreeLimit(Boolean useFreeLimit);
        }

        /**
         * The stage of the Database update allowing to specify freeLimitExhaustionBehavior.
         */
        interface WithFreeLimitExhaustionBehavior {
            /**
             * Specifies the freeLimitExhaustionBehavior property: Specifies the behavior when monthly free limits are
             ...
             * @return the next definition stage.
             */
            Update withFreeLimitExhaustionBehavior(FreeLimitExhaustionBehavior freeLimitExhaustionBehavior);
        }

        /**
         * The stage of the Database update allowing to specify manualCutover.
         */
        interface WithManualCutover {
            /**
             * Specifies the manualCutover property: Whether or not customer controlled manual cutover needs to be done
             ...
             * @return the next definition stage.
             */
            Update withManualCutover(Boolean manualCutover);
        }

        /**
         * The stage of the Database update allowing to specify performCutover.
         */
        interface WithPerformCutover {
            /**
             * Specifies the performCutover property: To trigger customer controlled manual cutover during the wait
             ...
             * @return the next definition stage.
             */
            Update withPerformCutover(Boolean performCutover);
        }

        /**
         * The stage of the Database update allowing to specify encryptionProtectorAutoRotation.
         */
        interface WithEncryptionProtectorAutoRotation {
            /**
             * Specifies the encryptionProtectorAutoRotation property: The flag to enable or disable auto rotation of
             ...
             * @return the next definition stage.
             */
            Update withEncryptionProtectorAutoRotation(Boolean encryptionProtectorAutoRotation);
        }
    }
     ...
     */
    ImportExportOperationResult export(ExportDatabaseDefinition parameters);
     ...
     * @return an ImportExport operation result resource.
     */
    ImportExportOperationResult export(ExportDatabaseDefinition parameters, Context context);
     ...
     * @return an ImportExport operation result resource.
     */
    ImportExportOperationResult importMethod(ImportExistingDatabaseDefinition parameters);
     ...
     * @return an ImportExport operation result resource.
     */
    ImportExportOperationResult importMethod(ImportExistingDatabaseDefinition parameters, Context context);
     ...
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     */
    void upgradeDataWarehouse(Context context);
}
