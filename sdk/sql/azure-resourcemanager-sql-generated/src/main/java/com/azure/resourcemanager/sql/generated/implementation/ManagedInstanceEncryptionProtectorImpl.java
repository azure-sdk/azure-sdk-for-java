...
public final class ManagedInstanceEncryptionProtectorImpl implements ManagedInstanceEncryptionProtector,
    ManagedInstanceEncryptionProtector.Definition, ManagedInstanceEncryptionProtector.Update {
    ...
    public ManagedInstanceEncryptionProtectorImpl withExistingManagedInstance(String resourceGroupName,
    ...
    public ManagedInstanceEncryptionProtector create() {
        this.innerObject = serviceManager.serviceClient().getManagedInstanceEncryptionProtectors().createOrUpdate(
    ...
    ManagedInstanceEncryptionProtectorImpl(EncryptionProtectorName name,
    ...
    ManagedInstanceEncryptionProtectorImpl(ManagedInstanceEncryptionProtectorInner innerObject,
        com.azure.resourcemanager.sql.generated.SqlManager serviceManager) {
    ...
    public ManagedInstanceEncryptionProtector refresh() {
        this.innerObject = serviceManager.serviceClient().getManagedInstanceEncryptionProtectors()
            .getWithResponse(resourceGroupName, managedInstanceName, encryptionProtectorName, Context.NONE).getValue();
        return this;
    }

    public ManagedInstanceEncryptionProtector refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getManagedInstanceEncryptionProtectors()
            .getWithResponse(resourceGroupName, managedInstanceName, encryptionProtectorName, context).getValue();
        return this;
    }

    public void revalidate() {
        serviceManager.managedInstanceEncryptionProtectors().revalidate(resourceGroupName, managedInstanceName,
