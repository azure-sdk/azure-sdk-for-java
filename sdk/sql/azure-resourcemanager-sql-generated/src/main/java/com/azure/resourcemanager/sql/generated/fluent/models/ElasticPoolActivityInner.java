...
public final class ElasticPoolActivityInner extends ProxyResource {
     ...
     * @return An instance of ElasticPoolActivityInner if the JsonReader was pointing to an instance of it, or null if
     * it was pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the ElasticPoolActivityInner.
     */
    public static ElasticPoolActivityInner fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ElasticPoolActivityInner deserializedElasticPoolActivityInner = new ElasticPoolActivityInner();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("id".equals(fieldName)) {
                    deserializedElasticPoolActivityInner.id = reader.getString();
                } else if ("name".equals(fieldName)) {
                    deserializedElasticPoolActivityInner.name = reader.getString();
                } else if ("type".equals(fieldName)) {
                    deserializedElasticPoolActivityInner.type = reader.getString();
                } else if ("location".equals(fieldName)) {
                    deserializedElasticPoolActivityInner.location = reader.getString();
                } else if ("properties".equals(fieldName)) {
                    deserializedElasticPoolActivityInner.innerProperties
                        = ElasticPoolActivityProperties.fromJson(reader);
                } else {
                    reader.skipChildren();
                }
            }

            return deserializedElasticPoolActivityInner;
        });
    }
}
