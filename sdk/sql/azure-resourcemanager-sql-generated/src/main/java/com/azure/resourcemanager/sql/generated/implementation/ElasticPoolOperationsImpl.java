...
public final class ElasticPoolOperationsImpl implements ElasticPoolOperations {
    ...
    public ElasticPoolOperationsImpl(ElasticPoolOperationsClient innerClient,
    ...
    public Response<Void> cancelWithResponse(String resourceGroupName, String serverName, String elasticPoolName,
        ...
        return this.serviceClient().cancelWithResponse(resourceGroupName, serverName, elasticPoolName, operationId,
            context);
    }
    ...
    public PagedIterable<ElasticPoolOperation> listByElasticPool(String resourceGroupName, String serverName,
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new ElasticPoolOperationImpl(inner1, this.manager()));
    }
