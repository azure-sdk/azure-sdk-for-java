...
public final class FailoverGroupsImpl implements FailoverGroups {
    ...
    public PagedIterable<FailoverGroup> listByServer(String resourceGroupName, String serverName) {
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new FailoverGroupImpl(inner1, this.manager()));
    }
    ...
    public Response<FailoverGroup> getWithResponse(String resourceGroupName, String serverName,
    ...
    public FailoverGroup forceFailoverAllowDataLoss(String resourceGroupName, String serverName,
    ...
    public FailoverGroup forceFailoverAllowDataLoss(String resourceGroupName, String serverName,
        String failoverGroupName, Context context) {
        FailoverGroupInner inner = this.serviceClient().forceFailoverAllowDataLoss(resourceGroupName, serverName,
    ...
    public FailoverGroup tryPlannedBeforeForcedFailover(String resourceGroupName, String serverName,
        String failoverGroupName) {
        FailoverGroupInner inner
            = this.serviceClient().tryPlannedBeforeForcedFailover(resourceGroupName, serverName, failoverGroupName);
        if (inner != null) {
            return new FailoverGroupImpl(inner, this.manager());
        } else {
            return null;
    ...
    public FailoverGroup tryPlannedBeforeForcedFailover(String resourceGroupName, String serverName,
        String failoverGroupName, Context context) {
        FailoverGroupInner inner = this.serviceClient().tryPlannedBeforeForcedFailover(resourceGroupName, serverName,
            failoverGroupName, context);
        if (inner != null) {
            return new FailoverGroupImpl(inner, this.manager());
        } else {
