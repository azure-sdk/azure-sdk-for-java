...
public final class ElasticPoolsImpl implements ElasticPools {
    ...
    public ElasticPoolsImpl(ElasticPoolsClient innerClient,
    ...
    public PagedIterable<ElasticPool> listByServer(String resourceGroupName, String serverName) {
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new ElasticPoolImpl(inner1, this.manager()));
    }

    public PagedIterable<ElasticPool> listByServer(String resourceGroupName, String serverName, Long skip,
        Context context) {
    ...
    public Response<ElasticPool> getWithResponse(String resourceGroupName, String serverName, String elasticPoolName,
        Context context) {
    ...
    public ElasticPool getById(String id) {
        ...
        String elasticPoolName = ResourceManagerUtils.getValueFromIdByName(id, "elasticPools");
