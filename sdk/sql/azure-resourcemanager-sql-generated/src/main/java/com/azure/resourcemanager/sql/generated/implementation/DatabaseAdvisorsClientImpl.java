...
public final class DatabaseAdvisorsClientImpl implements DatabaseAdvisorsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<List<AdvisorInner>> listByDatabaseAsync(String resourceGroupName, String serverName,
        String databaseName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<AdvisorInner> getAsync(String resourceGroupName, String serverName, String databaseName,
        String advisorName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<AdvisorInner> updateAsync(String resourceGroupName, String serverName, String databaseName,
