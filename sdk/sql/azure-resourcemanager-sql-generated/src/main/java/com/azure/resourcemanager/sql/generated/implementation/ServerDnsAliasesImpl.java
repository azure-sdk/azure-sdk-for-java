...
public final class ServerDnsAliasesImpl implements ServerDnsAliases {
    ...
    public ServerDnsAliasesImpl(ServerDnsAliasesClient innerClient,
    ...
    public PagedIterable<ServerDnsAlias> listByServer(String resourceGroupName, String serverName) {
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new ServerDnsAliasImpl(inner1, this.manager()));
    }
    ...
    public Response<ServerDnsAlias> getWithResponse(String resourceGroupName, String serverName, String dnsAliasName,
        Context context) {
    ...
    public ServerDnsAlias acquire(String resourceGroupName, String serverName, String dnsAliasName,
