...
public final class ManagedRestorableDroppedDatabaseBackupShortTermRetentionPoliciesImpl
    ...
    public Response<ManagedBackupShortTermRetentionPolicy> getWithResponse(String resourceGroupName,
        String managedInstanceName, String restorableDroppedDatabaseId, ManagedShortTermRetentionPolicyName policyName,
        Context context) {
        Response<ManagedBackupShortTermRetentionPolicyInner> inner = this.serviceClient()
            .getWithResponse(resourceGroupName, managedInstanceName, restorableDroppedDatabaseId, policyName, context);
        if (inner != null) {
    ...
    public ManagedBackupShortTermRetentionPolicy get(String resourceGroupName, String managedInstanceName,
    ...
    public ManagedBackupShortTermRetentionPolicy createOrUpdate(String resourceGroupName, String managedInstanceName,
        String restorableDroppedDatabaseId, ManagedShortTermRetentionPolicyName policyName,
        ManagedBackupShortTermRetentionPolicyInner parameters) {
        ManagedBackupShortTermRetentionPolicyInner inner = this.serviceClient().createOrUpdate(resourceGroupName,
            managedInstanceName, restorableDroppedDatabaseId, policyName, parameters);
        if (inner != null) {
            return new ManagedBackupShortTermRetentionPolicyImpl(inner, this.manager());
        } else {
            return null;
    ...
    public ManagedBackupShortTermRetentionPolicy createOrUpdate(String resourceGroupName, String managedInstanceName,
        ...
        ManagedBackupShortTermRetentionPolicyInner inner = this.serviceClient().createOrUpdate(resourceGroupName,
            managedInstanceName, restorableDroppedDatabaseId, policyName, parameters, context);
        if (inner != null) {
            return new ManagedBackupShortTermRetentionPolicyImpl(inner, this.manager());
        } else {
            return null;
    ...
    public ManagedBackupShortTermRetentionPolicy update(String resourceGroupName, String managedInstanceName,
        String restorableDroppedDatabaseId, ManagedShortTermRetentionPolicyName policyName,
        ManagedBackupShortTermRetentionPolicyInner parameters) {
        ManagedBackupShortTermRetentionPolicyInner inner = this.serviceClient().update(resourceGroupName,
            managedInstanceName, restorableDroppedDatabaseId, policyName, parameters);
        if (inner != null) {
            return new ManagedBackupShortTermRetentionPolicyImpl(inner, this.manager());
        } else {
    ...
    public PagedIterable<ManagedBackupShortTermRetentionPolicy> listByRestorableDroppedDatabase(
        ...
        PagedIterable<ManagedBackupShortTermRetentionPolicyInner> inner = this.serviceClient()
            .listByRestorableDroppedDatabase(resourceGroupName, managedInstanceName, restorableDroppedDatabaseId);
        return ResourceManagerUtils.mapPage(inner,
            inner1 -> new ManagedBackupShortTermRetentionPolicyImpl(inner1, this.manager()));
    }
    ...
    public PagedIterable<ManagedBackupShortTermRetentionPolicy> listByRestorableDroppedDatabase(
        ...
        PagedIterable<ManagedBackupShortTermRetentionPolicyInner> inner
            = this.serviceClient().listByRestorableDroppedDatabase(resourceGroupName, managedInstanceName,
