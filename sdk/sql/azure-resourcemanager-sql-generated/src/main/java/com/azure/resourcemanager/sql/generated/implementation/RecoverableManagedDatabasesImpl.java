...
public final class RecoverableManagedDatabasesImpl implements RecoverableManagedDatabases {
    ...
    public RecoverableManagedDatabasesImpl(RecoverableManagedDatabasesClient innerClient,
        com.azure.resourcemanager.sql.generated.SqlManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public PagedIterable<RecoverableManagedDatabase> listByInstance(String resourceGroupName,
        ...
        return ResourceManagerUtils.mapPage(inner,
            inner1 -> new RecoverableManagedDatabaseImpl(inner1, this.manager()));
    }
    ...
    public Response<RecoverableManagedDatabase> getWithResponse(String resourceGroupName, String managedInstanceName,
        String recoverableDatabaseName, Context context) {
        Response<RecoverableManagedDatabaseInner> inner = this.serviceClient().getWithResponse(resourceGroupName,
            managedInstanceName, recoverableDatabaseName, context);
        if (inner != null) {
    ...
    public RecoverableManagedDatabase get(String resourceGroupName, String managedInstanceName,
