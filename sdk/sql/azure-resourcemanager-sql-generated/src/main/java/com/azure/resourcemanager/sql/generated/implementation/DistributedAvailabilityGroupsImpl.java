...
public final class DistributedAvailabilityGroupsImpl implements DistributedAvailabilityGroups {
    ...
    public DistributedAvailabilityGroupsImpl(DistributedAvailabilityGroupsClient innerClient,
        com.azure.resourcemanager.sql.generated.SqlManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public PagedIterable<DistributedAvailabilityGroup> listByInstance(String resourceGroupName,
        ...
        return ResourceManagerUtils.mapPage(inner,
            inner1 -> new DistributedAvailabilityGroupImpl(inner1, this.manager()));
    }
    ...
    public Response<DistributedAvailabilityGroup> getWithResponse(String resourceGroupName, String managedInstanceName,
        String distributedAvailabilityGroupName, Context context) {
        Response<DistributedAvailabilityGroupInner> inner = this.serviceClient().getWithResponse(resourceGroupName,
            managedInstanceName, distributedAvailabilityGroupName, context);
        if (inner != null) {
    ...
    public DistributedAvailabilityGroup get(String resourceGroupName, String managedInstanceName,
    ...
    public DistributedAvailabilityGroup failover(String resourceGroupName, String managedInstanceName,
        String distributedAvailabilityGroupName, DistributedAvailabilityGroupsFailoverRequest parameters) {
        DistributedAvailabilityGroupInner inner = this.serviceClient().failover(resourceGroupName, managedInstanceName,
    ...
    public DistributedAvailabilityGroup setRole(String resourceGroupName, String managedInstanceName,
        String distributedAvailabilityGroupName, DistributedAvailabilityGroupSetRole parameters) {
        DistributedAvailabilityGroupInner inner = this.serviceClient().setRole(resourceGroupName, managedInstanceName,
            distributedAvailabilityGroupName, parameters);
        if (inner != null) {
            return new DistributedAvailabilityGroupImpl(inner, this.manager());
        } else {
    ...
    public DistributedAvailabilityGroup getById(String id) {
        ...
        String distributedAvailabilityGroupName
            = ResourceManagerUtils.getValueFromIdByName(id, "distributedAvailabilityGroups");
        if (distributedAvailabilityGroupName == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(String.format(
                "The resource ID '%s' is not valid. Missing path segment 'distributedAvailabilityGroups'.", id)));
        }
        return this
