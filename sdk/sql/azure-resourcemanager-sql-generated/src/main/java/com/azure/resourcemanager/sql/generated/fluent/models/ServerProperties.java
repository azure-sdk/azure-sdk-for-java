...
public final class ServerProperties {
    ...
    /*
     * Number of days that a server will stay soft-deleted when dropped.
     */
    ...
    /**
     * Get the retentionDays property: Number of days that a server will stay soft-deleted when dropped.
     *
    ...
    /**
     * Set the retentionDays property: Number of days that a server will stay soft-deleted when dropped.
     *
    ...
    /**
     * Get the createMode property: Create mode for the server. Value is optional but if passed in, must be 'Normal' or
     * 'Restore'.
     *
    ...
    /**
     * Set the createMode property: Create mode for the server. Value is optional but if passed in, must be 'Normal' or
     * 'Restore'.
     *
