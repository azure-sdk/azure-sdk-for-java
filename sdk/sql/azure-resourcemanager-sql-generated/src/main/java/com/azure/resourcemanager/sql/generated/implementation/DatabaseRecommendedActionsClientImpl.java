...
public final class DatabaseRecommendedActionsClientImpl implements DatabaseRecommendedActionsClient {
    ...
    /**
     * The interface defining all the services for SqlManagementClientDatabaseRecommendedActions to be used by the
    ...
    private Mono<Response<List<RecommendedActionInner>>> listByDatabaseAdvisorWithResponseAsync(
        ...
        return FluxUtil
            .withContext(context -> service.listByDatabaseAdvisor(this.client.getEndpoint(), resourceGroupName,
                serverName, databaseName, advisorName, this.client.getSubscriptionId(), this.client.getApiVersion(),
                accept, context))
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<List<RecommendedActionInner>> listByDatabaseAdvisorAsync(String resourceGroupName, String serverName,
    ...
    private Mono<Response<RecommendedActionInner>> getWithResponseAsync(String resourceGroupName, String serverName,
        ...
        return FluxUtil
            .withContext(context -> service.get(this.client.getEndpoint(), resourceGroupName, serverName, databaseName,
                advisorName, recommendedActionName, this.client.getSubscriptionId(), this.client.getApiVersion(),
                accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<RecommendedActionInner>> getWithResponseAsync(String resourceGroupName, String serverName,
        ...
        return service.get(this.client.getEndpoint(), resourceGroupName, serverName, databaseName, advisorName,
            recommendedActionName, this.client.getSubscriptionId(), this.client.getApiVersion(), accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<RecommendedActionInner> getAsync(String resourceGroupName, String serverName, String databaseName,
    ...
    private Mono<Response<RecommendedActionInner>> updateWithResponseAsync(String resourceGroupName, String serverName,
        ...
        return FluxUtil
            .withContext(context -> service.update(this.client.getEndpoint(), resourceGroupName, serverName,
                databaseName, advisorName, recommendedActionName, this.client.getSubscriptionId(),
    ...
    private Mono<Response<RecommendedActionInner>> updateWithResponseAsync(String resourceGroupName, String serverName,
        ...
        return service.update(this.client.getEndpoint(), resourceGroupName, serverName, databaseName, advisorName,
            recommendedActionName, this.client.getSubscriptionId(), this.client.getApiVersion(), parameters, accept,
            context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<RecommendedActionInner> updateAsync(String resourceGroupName, String serverName, String databaseName,
