...
public final class OutboundFirewallRulesImpl implements OutboundFirewallRules {
    ...
    public OutboundFirewallRulesImpl(OutboundFirewallRulesClient innerClient,
    ...
    public PagedIterable<OutboundFirewallRule> listByServer(String resourceGroupName, String serverName) {
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new OutboundFirewallRuleImpl(inner1, this.manager()));
    }
    ...
    public Response<OutboundFirewallRule> getWithResponse(String resourceGroupName, String serverName,
    ...
    public OutboundFirewallRule createOrUpdate(String resourceGroupName, String serverName, String outboundRuleFqdn) {
        OutboundFirewallRuleInner inner
            = this.serviceClient().createOrUpdate(resourceGroupName, serverName, outboundRuleFqdn);
        if (inner != null) {
            return new OutboundFirewallRuleImpl(inner, this.manager());
        } else {
            return null;
    ...
    public OutboundFirewallRule createOrUpdate(String resourceGroupName, String serverName, String outboundRuleFqdn,
        Context context) {
        OutboundFirewallRuleInner inner
            = this.serviceClient().createOrUpdate(resourceGroupName, serverName, outboundRuleFqdn, context);
        if (inner != null) {
            return new OutboundFirewallRuleImpl(inner, this.manager());
        } else {
            return null;
