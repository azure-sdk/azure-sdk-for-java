...
public final class ManagedDatabaseImpl implements ManagedDatabase, ManagedDatabase.Definition, ManagedDatabase.Update {
    ...
    public void cancelMove(ManagedDatabaseMoveDefinition parameters, Context context) {
        serviceManager
            .managedDatabases()
            .cancelMove(resourceGroupName, managedInstanceName, databaseName, parameters, context);
    }

    public void completeMove(ManagedDatabaseMoveDefinition parameters) {
        serviceManager
            .managedDatabases()
            .completeMove(resourceGroupName, managedInstanceName, databaseName, parameters);
    }

    public void completeMove(ManagedDatabaseMoveDefinition parameters, Context context) {
        serviceManager
            .managedDatabases()
            .completeMove(resourceGroupName, managedInstanceName, databaseName, parameters, context);
    }
    ...
    public void startMove(ManagedDatabaseStartMoveDefinition parameters, Context context) {
        serviceManager
            .managedDatabases()
            .startMove(resourceGroupName, managedInstanceName, databaseName, parameters, context);
    }
