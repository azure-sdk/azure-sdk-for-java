...
public final class ManagedInstanceKeyImpl
    ...
    public ManagedInstanceKey create() {
        this.innerObject = serviceManager.serviceClient().getManagedInstanceKeys().createOrUpdate(resourceGroupName,
            managedInstanceName, keyName, this.innerModel(), Context.NONE);
        return this;
    }

    public ManagedInstanceKey create(Context context) {
        this.innerObject = serviceManager.serviceClient().getManagedInstanceKeys().createOrUpdate(resourceGroupName,
            managedInstanceName, keyName, this.innerModel(), context);
        return this;
    }

    ManagedInstanceKeyImpl(String name, com.azure.resourcemanager.sql.generated.SqlManager serviceManager) {
    ...
    ManagedInstanceKeyImpl(ManagedInstanceKeyInner innerObject,
    ...
    public ManagedInstanceKey refresh() {
        this.innerObject = serviceManager.serviceClient().getManagedInstanceKeys()
            .getWithResponse(resourceGroupName, managedInstanceName, keyName, Context.NONE).getValue();
        return this;
    }

    public ManagedInstanceKey refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getManagedInstanceKeys()
            .getWithResponse(resourceGroupName, managedInstanceName, keyName, context).getValue();
        return this;
    }
