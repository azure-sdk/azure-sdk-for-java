...
public final class JobAgentImpl implements JobAgent, JobAgent.Definition, JobAgent.Update {
    ...
    public JobAgent create() {
        this.innerObject = serviceManager.serviceClient().getJobAgents().createOrUpdate(resourceGroupName, serverName,
            jobAgentName, this.innerModel(), Context.NONE);
        return this;
    }

    public JobAgent create(Context context) {
        this.innerObject = serviceManager.serviceClient().getJobAgents().createOrUpdate(resourceGroupName, serverName,
            jobAgentName, this.innerModel(), context);
        return this;
    }
    ...
    public JobAgent apply() {
        this.innerObject = serviceManager.serviceClient().getJobAgents().update(resourceGroupName, serverName,
            jobAgentName, updateParameters, Context.NONE);
        return this;
    }

    public JobAgent apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getJobAgents().update(resourceGroupName, serverName,
            jobAgentName, updateParameters, context);
        return this;
    }
    ...
    JobAgentImpl(JobAgentInner innerObject, com.azure.resourcemanager.sql.generated.SqlManager serviceManager) {
        ...
        this.jobAgentName = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "jobAgents");
    }

    public JobAgent refresh() {
        this.innerObject = serviceManager.serviceClient().getJobAgents()
            .getWithResponse(resourceGroupName, serverName, jobAgentName, Context.NONE).getValue();
        return this;
    }

    public JobAgent refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getJobAgents()
            .getWithResponse(resourceGroupName, serverName, jobAgentName, context).getValue();
        return this;
    }
    ...
    public JobAgentImpl withIdentity(JobAgentIdentity identity) {
        if (isInCreateMode()) {
