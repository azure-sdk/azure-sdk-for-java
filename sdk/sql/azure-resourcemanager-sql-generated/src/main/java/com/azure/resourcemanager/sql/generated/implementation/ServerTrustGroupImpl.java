...
public final class ServerTrustGroupImpl
    ...
    public ServerTrustGroup create() {
        this.innerObject = serviceManager.serviceClient().getServerTrustGroups().createOrUpdate(resourceGroupName,
            locationName, serverTrustGroupName, this.innerModel(), Context.NONE);
        return this;
    }

    public ServerTrustGroup create(Context context) {
        this.innerObject = serviceManager.serviceClient().getServerTrustGroups().createOrUpdate(resourceGroupName,
            locationName, serverTrustGroupName, this.innerModel(), context);
        return this;
    }
    ...
    ServerTrustGroupImpl(ServerTrustGroupInner innerObject,
        com.azure.resourcemanager.sql.generated.SqlManager serviceManager) {
        this.innerObject = innerObject;
        this.serviceManager = serviceManager;
        this.resourceGroupName = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "resourceGroups");
        this.locationName = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "locations");
        this.serverTrustGroupName = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "serverTrustGroups");
    }

    public ServerTrustGroup refresh() {
        this.innerObject = serviceManager.serviceClient().getServerTrustGroups()
            .getWithResponse(resourceGroupName, locationName, serverTrustGroupName, Context.NONE).getValue();
        return this;
    }

    public ServerTrustGroup refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getServerTrustGroups()
            .getWithResponse(resourceGroupName, locationName, serverTrustGroupName, context).getValue();
        return this;
    }
