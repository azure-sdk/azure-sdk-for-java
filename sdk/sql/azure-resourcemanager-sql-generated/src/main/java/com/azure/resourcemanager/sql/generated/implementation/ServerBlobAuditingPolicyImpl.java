...
public final class ServerBlobAuditingPolicyImpl
    ...
    public ServerBlobAuditingPolicy create() {
        this.innerObject = serviceManager.serviceClient().getServerBlobAuditingPolicies()
    ...
    ServerBlobAuditingPolicyImpl(com.azure.resourcemanager.sql.generated.SqlManager serviceManager) {
    ...
    public ServerBlobAuditingPolicyImpl withIsManagedIdentityInUse(Boolean isManagedIdentityInUse) {
