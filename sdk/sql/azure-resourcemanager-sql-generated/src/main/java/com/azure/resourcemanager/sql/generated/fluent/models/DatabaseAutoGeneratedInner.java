...
/** A database resource. */
@Fluent
public final class DatabaseAutoGeneratedInner extends Resource {
    /*
     * The database SKU.
     *
    ...
    private DatabasePropertiesAutoGenerated innerProperties;
     ...
     * @return the DatabaseAutoGeneratedInner object itself.
     */
    public DatabaseAutoGeneratedInner withSku(Sku sku) {
        this.sku = sku;
        return this;
    }
     ...
     * @return the DatabaseAutoGeneratedInner object itself.
     */
    public DatabaseAutoGeneratedInner withIdentity(DatabaseIdentity identity) {
    ...
    /** {@inheritDoc} */
    @Override
    public DatabaseAutoGeneratedInner withLocation(String location) {
    ...
    /** {@inheritDoc} */
    @Override
    public DatabaseAutoGeneratedInner withTags(Map<String, String> tags) {
        super.withTags(tags);
        return this;
    }
     ...
     * @return the DatabaseAutoGeneratedInner object itself.
     */
    public DatabaseAutoGeneratedInner withCreateMode(CreateMode createMode) {
        if (this.innerProperties() == null) {
            this.innerProperties = new DatabasePropertiesAutoGenerated();
        }
     ...
     * @return the DatabaseAutoGeneratedInner object itself.
     */
    public DatabaseAutoGeneratedInner withCollation(String collation) {
        if (this.innerProperties() == null) {
            this.innerProperties = new DatabasePropertiesAutoGenerated();
        }
     ...
     * @return the DatabaseAutoGeneratedInner object itself.
     */
    public DatabaseAutoGeneratedInner withMaxSizeBytes(Long maxSizeBytes) {
        if (this.innerProperties() == null) {
            this.innerProperties = new DatabasePropertiesAutoGenerated();
        }
     ...
     * @return the DatabaseAutoGeneratedInner object itself.
     */
    public DatabaseAutoGeneratedInner withSampleName(SampleName sampleName) {
        if (this.innerProperties() == null) {
            this.innerProperties = new DatabasePropertiesAutoGenerated();
        }
     ...
     * @return the DatabaseAutoGeneratedInner object itself.
     */
    public DatabaseAutoGeneratedInner withElasticPoolId(String elasticPoolId) {
        if (this.innerProperties() == null) {
            this.innerProperties = new DatabasePropertiesAutoGenerated();
        }
     ...
     * @return the DatabaseAutoGeneratedInner object itself.
     */
    public DatabaseAutoGeneratedInner withSourceDatabaseId(String sourceDatabaseId) {
        if (this.innerProperties() == null) {
            this.innerProperties = new DatabasePropertiesAutoGenerated();
        }
     ...
     * @return the DatabaseAutoGeneratedInner object itself.
     */
    public DatabaseAutoGeneratedInner withRestorePointInTime(OffsetDateTime restorePointInTime) {
        if (this.innerProperties() == null) {
            this.innerProperties = new DatabasePropertiesAutoGenerated();
        }
     ...
     * @return the DatabaseAutoGeneratedInner object itself.
     */
    public DatabaseAutoGeneratedInner withSourceDatabaseDeletionDate(OffsetDateTime sourceDatabaseDeletionDate) {
        if (this.innerProperties() == null) {
            this.innerProperties = new DatabasePropertiesAutoGenerated();
        }
     ...
     * @return the DatabaseAutoGeneratedInner object itself.
     */
    public DatabaseAutoGeneratedInner withRecoveryServicesRecoveryPointId(String recoveryServicesRecoveryPointId) {
        if (this.innerProperties() == null) {
            this.innerProperties = new DatabasePropertiesAutoGenerated();
        }
     ...
     * @return the DatabaseAutoGeneratedInner object itself.
     */
    public DatabaseAutoGeneratedInner withLongTermRetentionBackupResourceId(String longTermRetentionBackupResourceId) {
        if (this.innerProperties() == null) {
            this.innerProperties = new DatabasePropertiesAutoGenerated();
        }
     ...
     * @return the DatabaseAutoGeneratedInner object itself.
     */
    public DatabaseAutoGeneratedInner withRecoverableDatabaseId(String recoverableDatabaseId) {
        if (this.innerProperties() == null) {
            this.innerProperties = new DatabasePropertiesAutoGenerated();
        }
     ...
     * @return the DatabaseAutoGeneratedInner object itself.
     */
    public DatabaseAutoGeneratedInner withRestorableDroppedDatabaseId(String restorableDroppedDatabaseId) {
        if (this.innerProperties() == null) {
            this.innerProperties = new DatabasePropertiesAutoGenerated();
        }
     ...
     * @return the DatabaseAutoGeneratedInner object itself.
     */
    public DatabaseAutoGeneratedInner withCatalogCollation(CatalogCollationType catalogCollation) {
        if (this.innerProperties() == null) {
            this.innerProperties = new DatabasePropertiesAutoGenerated();
        }
     ...
     * @return the DatabaseAutoGeneratedInner object itself.
     */
    public DatabaseAutoGeneratedInner withZoneRedundant(Boolean zoneRedundant) {
        if (this.innerProperties() == null) {
            this.innerProperties = new DatabasePropertiesAutoGenerated();
        }
     ...
     * @return the DatabaseAutoGeneratedInner object itself.
     */
    public DatabaseAutoGeneratedInner withLicenseType(DatabaseLicenseType licenseType) {
        if (this.innerProperties() == null) {
            this.innerProperties = new DatabasePropertiesAutoGenerated();
        }
     ...
     * @return the DatabaseAutoGeneratedInner object itself.
     */
    public DatabaseAutoGeneratedInner withReadScale(DatabaseReadScale readScale) {
        if (this.innerProperties() == null) {
            this.innerProperties = new DatabasePropertiesAutoGenerated();
        }
     ...
     * @return the DatabaseAutoGeneratedInner object itself.
     */
    public DatabaseAutoGeneratedInner withHighAvailabilityReplicaCount(Integer highAvailabilityReplicaCount) {
        if (this.innerProperties() == null) {
            this.innerProperties = new DatabasePropertiesAutoGenerated();
        }
     ...
     * @return the DatabaseAutoGeneratedInner object itself.
     */
    public DatabaseAutoGeneratedInner withSecondaryType(SecondaryType secondaryType) {
        if (this.innerProperties() == null) {
            this.innerProperties = new DatabasePropertiesAutoGenerated();
        }
     ...
     * @return the DatabaseAutoGeneratedInner object itself.
     */
    public DatabaseAutoGeneratedInner withAutoPauseDelay(Integer autoPauseDelay) {
        if (this.innerProperties() == null) {
            this.innerProperties = new DatabasePropertiesAutoGenerated();
        }
     ...
     * @return the DatabaseAutoGeneratedInner object itself.
     */
    public DatabaseAutoGeneratedInner withRequestedBackupStorageRedundancy(
     ...
     * @return the DatabaseAutoGeneratedInner object itself.
     */
    public DatabaseAutoGeneratedInner withMinCapacity(Double minCapacity) {
        if (this.innerProperties() == null) {
            this.innerProperties = new DatabasePropertiesAutoGenerated();
        }
     ...
     * @return the DatabaseAutoGeneratedInner object itself.
     */
    public DatabaseAutoGeneratedInner withMaintenanceConfigurationId(String maintenanceConfigurationId) {
        if (this.innerProperties() == null) {
            this.innerProperties = new DatabasePropertiesAutoGenerated();
        }
     ...
     * @return the DatabaseAutoGeneratedInner object itself.
     */
    public DatabaseAutoGeneratedInner withIsLedgerOn(Boolean isLedgerOn) {
        if (this.innerProperties() == null) {
            this.innerProperties = new DatabasePropertiesAutoGenerated();
        }
     ...
     * @return the DatabaseAutoGeneratedInner object itself.
     */
    public DatabaseAutoGeneratedInner withFederatedClientId(UUID federatedClientId) {
        if (this.innerProperties() == null) {
            this.innerProperties = new DatabasePropertiesAutoGenerated();
        }
     ...
     * @return the DatabaseAutoGeneratedInner object itself.
     */
    public DatabaseAutoGeneratedInner withSourceResourceId(String sourceResourceId) {
        if (this.innerProperties() == null) {
            this.innerProperties = new DatabasePropertiesAutoGenerated();
        }
