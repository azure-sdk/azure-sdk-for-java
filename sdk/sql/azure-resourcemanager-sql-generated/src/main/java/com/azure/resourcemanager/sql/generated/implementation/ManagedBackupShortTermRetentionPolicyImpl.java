...
public final class ManagedBackupShortTermRetentionPolicyImpl implements ManagedBackupShortTermRetentionPolicy,
    ManagedBackupShortTermRetentionPolicy.Definition, ManagedBackupShortTermRetentionPolicy.Update {
    ...
    public ManagedBackupShortTermRetentionPolicyImpl withExistingDatabase(String resourceGroupName,
    ...
    public ManagedBackupShortTermRetentionPolicy create() {
        this.innerObject = serviceManager.serviceClient().getManagedBackupShortTermRetentionPolicies().createOrUpdate(
    ...
    ManagedBackupShortTermRetentionPolicyImpl(ManagedShortTermRetentionPolicyName name,
    ...
    public ManagedBackupShortTermRetentionPolicy apply() {
        this.innerObject = serviceManager.serviceClient().getManagedBackupShortTermRetentionPolicies()
            .update(resourceGroupName, managedInstanceName, databaseName, policyName, this.innerModel(), Context.NONE);
        return this;
    }
    ...
    ManagedBackupShortTermRetentionPolicyImpl(ManagedBackupShortTermRetentionPolicyInner innerObject,
        com.azure.resourcemanager.sql.generated.SqlManager serviceManager) {
        ...
        this.policyName = ManagedShortTermRetentionPolicyName.fromString(
            ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "backupShortTermRetentionPolicies"));
    }
