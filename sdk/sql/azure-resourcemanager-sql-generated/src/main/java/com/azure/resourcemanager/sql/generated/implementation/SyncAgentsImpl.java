...
public final class SyncAgentsImpl implements SyncAgents {
    ...
    public SyncAgentsImpl(SyncAgentsClient innerClient,
    ...
    public PagedIterable<SyncAgent> listByServer(String resourceGroupName, String serverName) {
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new SyncAgentImpl(inner1, this.manager()));
    }
    ...
    public Response<SyncAgent> getWithResponse(String resourceGroupName, String serverName, String syncAgentName,
        Context context) {
    ...
    public Response<SyncAgentKeyProperties> generateKeyWithResponse(String resourceGroupName, String serverName,
    ...
    public PagedIterable<SyncAgentLinkedDatabase> listLinkedDatabases(String resourceGroupName, String serverName,
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new SyncAgentLinkedDatabaseImpl(inner1, this.manager()));
    }
    ...
    public SyncAgent getById(String id) {
        ...
        String syncAgentName = ResourceManagerUtils.getValueFromIdByName(id, "syncAgents");
