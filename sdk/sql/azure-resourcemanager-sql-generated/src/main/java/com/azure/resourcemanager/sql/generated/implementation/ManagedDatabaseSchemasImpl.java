...
public final class ManagedDatabaseSchemasImpl implements ManagedDatabaseSchemas {
    ...
    public ManagedDatabaseSchemasImpl(ManagedDatabaseSchemasClient innerClient,
        com.azure.resourcemanager.sql.generated.SqlManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public PagedIterable<DatabaseSchema> listByDatabase(String resourceGroupName, String managedInstanceName,
        String databaseName) {
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new DatabaseSchemaImpl(inner1, this.manager()));
    }

    public PagedIterable<DatabaseSchema> listByDatabase(String resourceGroupName, String managedInstanceName,
        String databaseName, String filter, Context context) {
        PagedIterable<DatabaseSchemaInner> inner = this.serviceClient().listByDatabase(resourceGroupName,
            managedInstanceName, databaseName, filter, context);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new DatabaseSchemaImpl(inner1, this.manager()));
    }

    public Response<DatabaseSchema> getWithResponse(String resourceGroupName, String managedInstanceName,
        String databaseName, String schemaName, Context context) {
        Response<DatabaseSchemaInner> inner = this.serviceClient().getWithResponse(resourceGroupName,
            managedInstanceName, databaseName, schemaName, context);
        if (inner != null) {
    ...
    public DatabaseSchema get(String resourceGroupName, String managedInstanceName, String databaseName,
        String schemaName) {
