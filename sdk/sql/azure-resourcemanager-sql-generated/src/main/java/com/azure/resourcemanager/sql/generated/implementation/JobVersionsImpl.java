...
public final class JobVersionsImpl implements JobVersions {
    ...
    public JobVersionsImpl(JobVersionsClient innerClient,
        com.azure.resourcemanager.sql.generated.SqlManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public PagedIterable<JobVersion> listByJob(String resourceGroupName, String serverName, String jobAgentName,
        String jobName) {
        PagedIterable<JobVersionInner> inner
            = this.serviceClient().listByJob(resourceGroupName, serverName, jobAgentName, jobName);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new JobVersionImpl(inner1, this.manager()));
    }
    ...
    public Response<JobVersion> getWithResponse(String resourceGroupName, String serverName, String jobAgentName,
        String jobName, int jobVersion, Context context) {
        Response<JobVersionInner> inner = this.serviceClient().getWithResponse(resourceGroupName, serverName,
    ...
    public JobVersion get(String resourceGroupName, String serverName, String jobAgentName, String jobName,
        int jobVersion) {
