...
public final class ReplicationLinksImpl implements ReplicationLinks {
    ...
    public ReplicationLinksImpl(ReplicationLinksClient innerClient,
        com.azure.resourcemanager.sql.generated.SqlManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public PagedIterable<ReplicationLink> listByDatabase(String resourceGroupName, String serverName,
        String databaseName) {
    ...
    public Response<ReplicationLink> getWithResponse(String resourceGroupName, String serverName, String databaseName,
    ...
    public void delete(String resourceGroupName, String serverName, String databaseName, String linkId,
        Context context) {
        this.serviceClient().delete(resourceGroupName, serverName, databaseName, linkId, context);
    }
    ...
    public ReplicationLink failoverAllowDataLoss(String resourceGroupName, String serverName, String databaseName,
        String linkId) {
        ReplicationLinkInner inner
    ...
    public ReplicationLink getById(String id) {
        ...
        String linkId = Utils.getValueFromIdByName(id, "replicationLinks");
        if (linkId == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
                String.format("The resource ID '%s' is not valid. Missing path segment 'replicationLinks'.", id)));
        }
        return this.getWithResponse(resourceGroupName, serverName, databaseName, linkId, Context.NONE).getValue();
    }

    public Response<ReplicationLink> getByIdWithResponse(String id, Context context) {
        String resourceGroupName = Utils.getValueFromIdByName(id, "resourceGroups");
        if (resourceGroupName == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
                String.format("The resource ID '%s' is not valid. Missing path segment 'resourceGroups'.", id)));
        ...
        return this.getWithResponse(resourceGroupName, serverName, databaseName, linkId, context);
    }
    ...
    public void deleteById(String id) {
        ...
        this.delete(resourceGroupName, serverName, databaseName, linkId, Context.NONE);
    }
    ...
    public void deleteByIdWithResponse(String id, Context context) {
        ...
        this.delete(resourceGroupName, serverName, databaseName, linkId, context);
    }
    ...
    public ReplicationLinkImpl define(String name) {
        return new ReplicationLinkImpl(name, this.manager());
    }
}
