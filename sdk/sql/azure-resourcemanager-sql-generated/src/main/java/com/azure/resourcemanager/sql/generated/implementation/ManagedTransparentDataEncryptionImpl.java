...
public final class ManagedTransparentDataEncryptionImpl implements ManagedTransparentDataEncryption,
    ManagedTransparentDataEncryption.Definition, ManagedTransparentDataEncryption.Update {
    ...
    public ManagedTransparentDataEncryptionImpl withExistingDatabase(String resourceGroupName,
    ...
    public ManagedTransparentDataEncryption create() {
        this.innerObject = serviceManager.serviceClient().getManagedDatabaseTransparentDataEncryptions()
            .createOrUpdateWithResponse(resourceGroupName, managedInstanceName, databaseName, tdeName,
    ...
    public ManagedTransparentDataEncryption create(Context context) {
        this.innerObject
            = serviceManager.serviceClient().getManagedDatabaseTransparentDataEncryptions().createOrUpdateWithResponse(
                resourceGroupName, managedInstanceName, databaseName, tdeName, this.innerModel(), context).getValue();
        return this;
    }

    ManagedTransparentDataEncryptionImpl(TransparentDataEncryptionName name,
    ...
    ManagedTransparentDataEncryptionImpl(ManagedTransparentDataEncryptionInner innerObject,
        com.azure.resourcemanager.sql.generated.SqlManager serviceManager) {
        ...
        this.tdeName = TransparentDataEncryptionName
    ...
    public ManagedTransparentDataEncryption refresh() {
        this.innerObject = serviceManager.serviceClient().getManagedDatabaseTransparentDataEncryptions()
            .getWithResponse(resourceGroupName, managedInstanceName, databaseName, tdeName, Context.NONE).getValue();
        return this;
    }

    public ManagedTransparentDataEncryption refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getManagedDatabaseTransparentDataEncryptions()
            .getWithResponse(resourceGroupName, managedInstanceName, databaseName, tdeName, context).getValue();
        return this;
    }
