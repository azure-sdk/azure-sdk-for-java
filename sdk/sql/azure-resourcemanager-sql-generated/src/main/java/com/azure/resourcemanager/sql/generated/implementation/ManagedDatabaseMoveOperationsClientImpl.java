...
import com.azure.resourcemanager.sql.generated.models.ManagedDatabaseMoveOperationListResult;
...
public final class ManagedDatabaseMoveOperationsClientImpl implements ManagedDatabaseMoveOperationsClient {
    ...
    ManagedDatabaseMoveOperationsClientImpl(SqlManagementClientImpl client) {
        this.service =
            RestProxy
                .create(
                    ManagedDatabaseMoveOperationsService.class,
    ...
    private interface ManagedDatabaseMoveOperationsService {
        @Headers({"Content-Type: application/json"})
        @Get(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/locations"
                + "/{locationName}/managedDatabaseMoveOperationResults")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ManagedDatabaseMoveOperationListResult>> listByLocation(
        ...
        @Get(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/locations"
                + "/{locationName}/managedDatabaseMoveOperationResults/{operationId}")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ManagedDatabaseMoveOperationResultInner>> get(
            @HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("locationName") String locationName,
    ...
    private PagedFlux<ManagedDatabaseMoveOperationResultInner> listByLocationAsync(
        String resourceGroupName, String locationName, Boolean onlyLatestPerDatabase, String filter) {
    ...
    private PagedFlux<ManagedDatabaseMoveOperationResultInner> listByLocationAsync(
        ...
        return new PagedFlux<>(
            () ->
                listByLocationSinglePageAsync(resourceGroupName, locationName, onlyLatestPerDatabase, filter, context),
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<ManagedDatabaseMoveOperationResultInner> listByLocation(
        String resourceGroupName, String locationName) {
        final Boolean onlyLatestPerDatabase = null;
        final String filter = null;
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ManagedDatabaseMoveOperationResultInner>> getWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ManagedDatabaseMoveOperationResultInner> getAsync(
        String resourceGroupName, String locationName, UUID operationId) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ManagedDatabaseMoveOperationResultInner get(
        String resourceGroupName, String locationName, UUID operationId) {
        return getAsync(resourceGroupName, locationName, operationId).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ManagedDatabaseMoveOperationResultInner> getWithResponse(
        String resourceGroupName, String locationName, UUID operationId, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<ManagedDatabaseMoveOperationResultInner>> listByLocationNextSinglePageAsync(
        String nextLink) {
        if (nextLink == null) {
