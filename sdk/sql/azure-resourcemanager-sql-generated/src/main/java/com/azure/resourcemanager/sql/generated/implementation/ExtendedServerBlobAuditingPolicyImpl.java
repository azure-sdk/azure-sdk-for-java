...
public final class ExtendedServerBlobAuditingPolicyImpl implements ExtendedServerBlobAuditingPolicy,
    ...
    public ExtendedServerBlobAuditingPolicy create() {
        this.innerObject = serviceManager.serviceClient().getExtendedServerBlobAuditingPolicies()
    ...
    public ExtendedServerBlobAuditingPolicy refresh() {
        this.innerObject = serviceManager.serviceClient().getExtendedServerBlobAuditingPolicies()
            .getWithResponse(resourceGroupName, serverName, Context.NONE).getValue();
        return this;
    }

    public ExtendedServerBlobAuditingPolicy refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getExtendedServerBlobAuditingPolicies()
            .getWithResponse(resourceGroupName, serverName, context).getValue();
        return this;
    }
    ...
    public ExtendedServerBlobAuditingPolicyImpl withIsManagedIdentityInUse(Boolean isManagedIdentityInUse) {
