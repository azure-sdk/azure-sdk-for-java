 ...
 */
public interface DatabaseBillingVersionsClient {
    /**
    ...
    Response<DatabaseBillingVersionResponseInner> createWithResponse(String resourceGroupName, String serverName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    DatabaseBillingVersionResponseInner create(String resourceGroupName, String serverName, String databaseName);
}
