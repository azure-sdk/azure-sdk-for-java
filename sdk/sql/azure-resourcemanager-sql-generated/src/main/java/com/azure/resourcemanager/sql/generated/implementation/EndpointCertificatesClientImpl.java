...
import com.azure.resourcemanager.sql.generated.models.EndpointCertificateListResult;
...
public final class EndpointCertificatesClientImpl implements EndpointCertificatesClient {
    ...
    EndpointCertificatesClientImpl(SqlManagementClientImpl client) {
        this.service =
            RestProxy
                .create(EndpointCertificatesService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }
    ...
    private interface EndpointCertificatesService {
        ...
        @Get(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql"
                + "/managedInstances/{managedInstanceName}/endpointCertificates")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<EndpointCertificateListResult>> listByInstance(
        ...
        @Get(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql"
                + "/managedInstances/{managedInstanceName}/endpointCertificates/{endpointType}")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<EndpointCertificateInner>> get(
            @HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("managedInstanceName") String managedInstanceName,
    ...
    private Mono<PagedResponse<EndpointCertificateInner>> listByInstanceSinglePageAsync(
                ...
                context ->
                    service
                        .listByInstance(
                            ...
                            accept,
                            context))
            .<PagedResponse<EndpointCertificateInner>>map(
                res ->
    ...
    private PagedFlux<EndpointCertificateInner> listByInstanceAsync(
        String resourceGroupName, String managedInstanceName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<EndpointCertificateInner> listByInstance(
        String resourceGroupName, String managedInstanceName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<EndpointCertificateInner>> getWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<EndpointCertificateInner> getAsync(
        String resourceGroupName, String managedInstanceName, String endpointType) {
    ...
    public EndpointCertificateInner get(String resourceGroupName, String managedInstanceName, String endpointType) {
        return getAsync(resourceGroupName, managedInstanceName, endpointType).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<EndpointCertificateInner> getWithResponse(
        String resourceGroupName, String managedInstanceName, String endpointType, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<EndpointCertificateInner>> listByInstanceNextSinglePageAsync(
