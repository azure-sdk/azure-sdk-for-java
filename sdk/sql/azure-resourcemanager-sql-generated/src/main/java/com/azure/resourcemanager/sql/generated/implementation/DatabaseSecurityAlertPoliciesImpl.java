...
public final class DatabaseSecurityAlertPoliciesImpl implements DatabaseSecurityAlertPolicies {
    ...
    public DatabaseSecurityAlertPoliciesImpl(DatabaseSecurityAlertPoliciesClient innerClient,
        com.azure.resourcemanager.sql.generated.SqlManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public Response<DatabaseSecurityAlertPolicy> getWithResponse(String resourceGroupName, String serverName,
        String databaseName, SecurityAlertPolicyName securityAlertPolicyName, Context context) {
        Response<DatabaseSecurityAlertPolicyInner> inner = this.serviceClient().getWithResponse(resourceGroupName,
            serverName, databaseName, securityAlertPolicyName, context);
        if (inner != null) {
    ...
    public DatabaseSecurityAlertPolicy get(String resourceGroupName, String serverName, String databaseName,
    ...
    public PagedIterable<DatabaseSecurityAlertPolicy> listByDatabase(String resourceGroupName, String serverName,
        String databaseName) {
        ...
        return ResourceManagerUtils.mapPage(inner,
            inner1 -> new DatabaseSecurityAlertPolicyImpl(inner1, this.manager()));
    }
    ...
    public DatabaseSecurityAlertPolicy getById(String id) {
        ...
        return this.getWithResponse(resourceGroupName, serverName, databaseName, securityAlertPolicyName, Context.NONE)
            .getValue();
    }
