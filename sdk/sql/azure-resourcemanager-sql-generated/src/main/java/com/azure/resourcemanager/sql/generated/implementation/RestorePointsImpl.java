...
public final class RestorePointsImpl implements RestorePoints {
    ...
    public RestorePointsImpl(RestorePointsClient innerClient,
        com.azure.resourcemanager.sql.generated.SqlManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public PagedIterable<RestorePoint> listByDatabase(String resourceGroupName, String serverName,
        String databaseName) {
    ...
    public PagedIterable<RestorePoint> listByDatabase(String resourceGroupName, String serverName, String databaseName,
        Context context) {
        PagedIterable<RestorePointInner> inner
    ...
    public RestorePoint create(String resourceGroupName, String serverName, String databaseName,
    ...
    public Response<RestorePoint> getWithResponse(String resourceGroupName, String serverName, String databaseName,
        String restorePointName, Context context) {
        Response<RestorePointInner> inner = this.serviceClient().getWithResponse(resourceGroupName, serverName,
            databaseName, restorePointName, context);
        if (inner != null) {
    ...
    public Response<Void> deleteWithResponse(String resourceGroupName, String serverName, String databaseName,
        String restorePointName, Context context) {
        return this.serviceClient().deleteWithResponse(resourceGroupName, serverName, databaseName, restorePointName,
            context);
    }
