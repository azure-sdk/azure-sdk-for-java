...
public final class LogicalDatabaseTransparentDataEncryptionImpl implements LogicalDatabaseTransparentDataEncryption,
    LogicalDatabaseTransparentDataEncryption.Definition, LogicalDatabaseTransparentDataEncryption.Update {
    ...
    public LogicalDatabaseTransparentDataEncryptionImpl withExistingDatabase(String resourceGroupName,
    ...
    public LogicalDatabaseTransparentDataEncryption create() {
        this.innerObject = serviceManager.serviceClient().getTransparentDataEncryptions()
            .createOrUpdate(resourceGroupName, serverName, databaseName, tdeName, this.innerModel(), Context.NONE);
        return this;
    }

    public LogicalDatabaseTransparentDataEncryption create(Context context) {
        this.innerObject = serviceManager.serviceClient().getTransparentDataEncryptions()
            .createOrUpdate(resourceGroupName, serverName, databaseName, tdeName, this.innerModel(), context);
        return this;
    }

    LogicalDatabaseTransparentDataEncryptionImpl(TransparentDataEncryptionName name,
    ...
    LogicalDatabaseTransparentDataEncryptionImpl(LogicalDatabaseTransparentDataEncryptionInner innerObject,
        com.azure.resourcemanager.sql.generated.SqlManager serviceManager) {
    ...
    public LogicalDatabaseTransparentDataEncryption refresh() {
        this.innerObject = serviceManager.serviceClient().getTransparentDataEncryptions()
            .getWithResponse(resourceGroupName, serverName, databaseName, tdeName, Context.NONE).getValue();
        return this;
    }

    public LogicalDatabaseTransparentDataEncryption refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getTransparentDataEncryptions()
            .getWithResponse(resourceGroupName, serverName, databaseName, tdeName, context).getValue();
        return this;
    }
