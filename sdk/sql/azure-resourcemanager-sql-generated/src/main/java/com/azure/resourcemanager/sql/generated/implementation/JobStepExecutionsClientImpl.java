...
import com.azure.resourcemanager.sql.generated.fluent.models.JobExecutionAutoGeneratedInner;
import com.azure.resourcemanager.sql.generated.models.JobExecutionListResultAutoGenerated;
...
public final class JobStepExecutionsClientImpl implements JobStepExecutionsClient {
    ...
    public interface JobStepExecutionsService {
        ...
        Mono<Response<JobExecutionListResultAutoGenerated>> listByJobExecution(
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<JobExecutionAutoGeneratedInner>> get(
            @HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("serverName") String serverName,
            @PathParam("jobAgentName") String jobAgentName,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<JobExecutionListResultAutoGenerated>> listByJobExecutionNext(
    ...
    private Mono<PagedResponse<JobExecutionAutoGeneratedInner>> listByJobExecutionSinglePageAsync(
                ...
                context ->
                    service
                        .listByJobExecution(
                            ...
                            accept,
                            context))
            .<PagedResponse<JobExecutionAutoGeneratedInner>>map(
                res ->
    ...
    private PagedFlux<JobExecutionAutoGeneratedInner> listByJobExecutionAsync(
        String resourceGroupName,
        String serverName,
        String jobAgentName,
        String jobName,
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<JobExecutionAutoGeneratedInner> listByJobExecution(
        String resourceGroupName, String serverName, String jobAgentName, String jobName, UUID jobExecutionId) {
        final OffsetDateTime createTimeMin = null;
        final OffsetDateTime createTimeMax = null;
        final OffsetDateTime endTimeMin = null;
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<JobExecutionAutoGeneratedInner>> getWithResponseAsync(
        String resourceGroupName,
        String serverName,
        String jobAgentName,
        String jobName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<JobExecutionAutoGeneratedInner> getAsync(
        String resourceGroupName,
        String serverName,
        String jobAgentName,
        String jobName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<JobExecutionAutoGeneratedInner> getWithResponse(
        String resourceGroupName,
        String serverName,
        String jobAgentName,
        String jobName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public JobExecutionAutoGeneratedInner get(
        String resourceGroupName,
        String serverName,
        String jobAgentName,
        String jobName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<JobExecutionAutoGeneratedInner>> listByJobExecutionNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<JobExecutionAutoGeneratedInner>> listByJobExecutionNextSinglePageAsync(
