...
public interface JobExecutions {
     ...
     * @return a list of job executions as paginated response with {@link PagedIterable}.
     */
    PagedIterable<JobExecution> listByJob(String resourceGroupName, String serverName, String jobAgentName,
        String jobName);
     ...
     */
    JobExecution createOrUpdate(String resourceGroupName, String serverName, String jobAgentName, String jobName,
        UUID jobExecutionId);
