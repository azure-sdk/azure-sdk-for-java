...
public final class SynapseLinkWorkspacesClientImpl implements SynapseLinkWorkspacesClient {
    ...
    SynapseLinkWorkspacesClientImpl(SqlManagementClientImpl client) {
        this.service = RestProxy.create(SynapseLinkWorkspacesService.class, client.getHttpPipeline(),
    ...
    public interface SynapseLinkWorkspacesService {
        ...
        @Get("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/databases/{databaseName}/linkWorkspaces")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<SynapseLinkWorkspaceListResult>> listByDatabase(@HostParam("$host") String endpoint,
    ...
    private Mono<PagedResponse<SynapseLinkWorkspaceInner>> listByDatabaseSinglePageAsync(String resourceGroupName,
        ...
        return FluxUtil
            ...
            .<PagedResponse<SynapseLinkWorkspaceInner>>map(res -> new PagedResponseBase<>(res.getRequest(),
    ...
    private PagedFlux<SynapseLinkWorkspaceInner> listByDatabaseAsync(String resourceGroupName, String serverName,
        String databaseName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<SynapseLinkWorkspaceInner> listByDatabase(String resourceGroupName, String serverName,
        String databaseName) {
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a list of synapselink workspaces along with {@link PagedResponse} on successful completion of
     * {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
