...
public final class ManagedDatabaseAdvancedThreatProtectionInner extends ProxyResource {
     ...
     * @return An instance of ManagedDatabaseAdvancedThreatProtectionInner if the JsonReader was pointing to an instance
     * of it, or null if it was pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the ManagedDatabaseAdvancedThreatProtectionInner.
     */
    public static ManagedDatabaseAdvancedThreatProtectionInner fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ManagedDatabaseAdvancedThreatProtectionInner deserializedManagedDatabaseAdvancedThreatProtectionInner
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("id".equals(fieldName)) {
                    deserializedManagedDatabaseAdvancedThreatProtectionInner.id = reader.getString();
                } else if ("name".equals(fieldName)) {
                    deserializedManagedDatabaseAdvancedThreatProtectionInner.name = reader.getString();
                } else if ("type".equals(fieldName)) {
                    deserializedManagedDatabaseAdvancedThreatProtectionInner.type = reader.getString();
                } else if ("systemData".equals(fieldName)) {
                    deserializedManagedDatabaseAdvancedThreatProtectionInner.systemData = SystemData.fromJson(reader);
                } else if ("properties".equals(fieldName)) {
                    deserializedManagedDatabaseAdvancedThreatProtectionInner.innerProperties
            ...
            return deserializedManagedDatabaseAdvancedThreatProtectionInner;
        });
    }
}
