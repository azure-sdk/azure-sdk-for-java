...
public final class DatabaseAutoGeneratedImpl
    implements DatabaseAutoGenerated, DatabaseAutoGenerated.Definition, DatabaseAutoGenerated.Update {
    private DatabaseAutoGeneratedInner innerObject;
    ...
    public DatabaseAutoGeneratedInner innerModel() {
    ...
    private DatabaseInner createParameters;

    private DatabaseUpdate updateParameters;

    public DatabaseAutoGeneratedImpl withExistingServer(String resourceGroupName, String serverName) {
        this.resourceGroupName = resourceGroupName;
        this.serverName = serverName;
        return this;
    }

    public DatabaseAutoGenerated create() {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getDatabases()
                .createOrUpdate(resourceGroupName, serverName, databaseName, createParameters, Context.NONE);
        return this;
    }

    public DatabaseAutoGenerated create(Context context) {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getDatabases()
                .createOrUpdate(resourceGroupName, serverName, databaseName, createParameters, context);
        return this;
    }

    DatabaseAutoGeneratedImpl(String name, com.azure.resourcemanager.sql.generated.SqlManager serviceManager) {
        this.innerObject = new DatabaseAutoGeneratedInner();
        this.serviceManager = serviceManager;
        this.databaseName = name;
        this.createParameters = new DatabaseInner();
    }

    public DatabaseAutoGeneratedImpl update() {
        this.updateParameters = new DatabaseUpdate();
        return this;
    }

    public DatabaseAutoGenerated apply() {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getDatabases()
    ...
    public DatabaseAutoGenerated apply(Context context) {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getDatabases()
    ...
    DatabaseAutoGeneratedImpl(
        DatabaseAutoGeneratedInner innerObject, com.azure.resourcemanager.sql.generated.SqlManager serviceManager) {
    ...
    public DatabaseAutoGenerated refresh() {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getDatabases()
    ...
    public DatabaseAutoGenerated refresh(Context context) {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getDatabases()
    ...
    public ImportExportOperationResult export(ExportDatabaseDefinitionAutoGenerated parameters) {
        return serviceManager.databases().export(resourceGroupName, serverName, databaseName, parameters);
    }

    public ImportExportOperationResult export(ExportDatabaseDefinitionAutoGenerated parameters, Context context) {
        return serviceManager.databases().export(resourceGroupName, serverName, databaseName, parameters, context);
    }
    ...
    public ImportExportOperationResult importMethod(ImportExistingDatabaseDefinitionAutoGenerated parameters) {
        return serviceManager.databases().importMethod(resourceGroupName, serverName, databaseName, parameters);
    }

    public ImportExportOperationResult importMethod(
        ImportExistingDatabaseDefinitionAutoGenerated parameters, Context context) {
        return serviceManager
            .databases()
            .importMethod(resourceGroupName, serverName, databaseName, parameters, context);
    }
    ...
    public DatabaseAutoGenerated pause() {
        return serviceManager.databases().pause(resourceGroupName, serverName, databaseName);
    }

    public DatabaseAutoGenerated pause(Context context) {
        return serviceManager.databases().pause(resourceGroupName, serverName, databaseName, context);
    }

    public DatabaseAutoGenerated resume() {
        return serviceManager.databases().resume(resourceGroupName, serverName, databaseName);
    }

    public DatabaseAutoGenerated resume(Context context) {
        return serviceManager.databases().resume(resourceGroupName, serverName, databaseName, context);
    }
    ...
    public DatabaseAutoGeneratedImpl withRegion(Region location) {
        this.innerModel().withLocation(location.toString());
        return this;
    }

    public DatabaseAutoGeneratedImpl withRegion(String location) {
        this.innerModel().withLocation(location);
        return this;
    }

    public DatabaseAutoGeneratedImpl withTags(Map<String, String> tags) {
        if (isInCreateMode()) {
    ...
    public DatabaseAutoGeneratedImpl withSku(Sku sku) {
        if (isInCreateMode()) {
    ...
    public DatabaseAutoGeneratedImpl withIdentity(DatabaseIdentity identity) {
        if (isInCreateMode()) {
    ...
    public DatabaseAutoGeneratedImpl withCreateMode(CreateMode createMode) {
        this.innerModel().withCreateMode(createMode);
        return this;
    }

    public DatabaseAutoGeneratedImpl withCollation(String collation) {
        this.innerModel().withCollation(collation);
        return this;
    }

    public DatabaseAutoGeneratedImpl withMaxSizeBytes(Long maxSizeBytes) {
        if (isInCreateMode()) {
    ...
    public DatabaseAutoGeneratedImpl withSampleName(SampleName sampleName) {
        this.innerModel().withSampleName(sampleName);
        return this;
    }

    public DatabaseAutoGeneratedImpl withElasticPoolId(String elasticPoolId) {
        if (isInCreateMode()) {
    ...
    public DatabaseAutoGeneratedImpl withSourceDatabaseId(String sourceDatabaseId) {
        this.innerModel().withSourceDatabaseId(sourceDatabaseId);
        return this;
    }

    public DatabaseAutoGeneratedImpl withRestorePointInTime(OffsetDateTime restorePointInTime) {
        this.innerModel().withRestorePointInTime(restorePointInTime);
        return this;
    }

    public DatabaseAutoGeneratedImpl withSourceDatabaseDeletionDate(OffsetDateTime sourceDatabaseDeletionDate) {
        this.innerModel().withSourceDatabaseDeletionDate(sourceDatabaseDeletionDate);
        return this;
    }

    public DatabaseAutoGeneratedImpl withRecoveryServicesRecoveryPointId(String recoveryServicesRecoveryPointId) {
        this.innerModel().withRecoveryServicesRecoveryPointId(recoveryServicesRecoveryPointId);
        return this;
    }

    public DatabaseAutoGeneratedImpl withLongTermRetentionBackupResourceId(String longTermRetentionBackupResourceId) {
        this.innerModel().withLongTermRetentionBackupResourceId(longTermRetentionBackupResourceId);
        return this;
    }

    public DatabaseAutoGeneratedImpl withRecoverableDatabaseId(String recoverableDatabaseId) {
        this.innerModel().withRecoverableDatabaseId(recoverableDatabaseId);
        return this;
    }

    public DatabaseAutoGeneratedImpl withRestorableDroppedDatabaseId(String restorableDroppedDatabaseId) {
        this.innerModel().withRestorableDroppedDatabaseId(restorableDroppedDatabaseId);
        return this;
    }

    public DatabaseAutoGeneratedImpl withCatalogCollation(CatalogCollationType catalogCollation) {
        this.innerModel().withCatalogCollation(catalogCollation);
        return this;
    }

    public DatabaseAutoGeneratedImpl withZoneRedundant(Boolean zoneRedundant) {
        if (isInCreateMode()) {
    ...
    public DatabaseAutoGeneratedImpl withLicenseType(DatabaseLicenseType licenseType) {
        if (isInCreateMode()) {
    ...
    public DatabaseAutoGeneratedImpl withHighAvailabilityReplicaCount(Integer highAvailabilityReplicaCount) {
        if (isInCreateMode()) {
    ...
    public DatabaseAutoGeneratedImpl withSecondaryType(SecondaryType secondaryType) {
        if (isInCreateMode()) {
    ...
    public DatabaseAutoGeneratedImpl withAutoPauseDelay(Integer autoPauseDelay) {
        if (isInCreateMode()) {
    ...
    public DatabaseAutoGeneratedImpl withRequestedBackupStorageRedundancy(
    ...
    public DatabaseAutoGeneratedImpl withMinCapacity(Double minCapacity) {
        if (isInCreateMode()) {
    ...
    public DatabaseAutoGeneratedImpl withMaintenanceConfigurationId(String maintenanceConfigurationId) {
        if (isInCreateMode()) {
    ...
    public DatabaseAutoGeneratedImpl withIsLedgerOn(Boolean isLedgerOn) {
        if (isInCreateMode()) {
    ...
    public DatabaseAutoGeneratedImpl withFederatedClientId(UUID federatedClientId) {
        if (isInCreateMode()) {
    ...
    public DatabaseAutoGeneratedImpl withSourceResourceId(String sourceResourceId) {
        this.innerModel().withSourceResourceId(sourceResourceId);
        return this;
    }

    public DatabaseAutoGeneratedImpl withReadScale(DatabaseReadScale readScale) {
