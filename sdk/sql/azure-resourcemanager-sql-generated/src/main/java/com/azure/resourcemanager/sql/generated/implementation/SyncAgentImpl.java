...
public final class SyncAgentImpl implements SyncAgent, SyncAgent.Definition, SyncAgent.Update {
    ...
    public SyncAgent create() {
        this.innerObject = serviceManager.serviceClient().getSyncAgents().createOrUpdate(resourceGroupName, serverName,
            syncAgentName, this.innerModel(), Context.NONE);
        return this;
    }

    public SyncAgent create(Context context) {
        this.innerObject = serviceManager.serviceClient().getSyncAgents().createOrUpdate(resourceGroupName, serverName,
            syncAgentName, this.innerModel(), context);
        return this;
    }
    ...
    SyncAgentImpl(SyncAgentInner innerObject, com.azure.resourcemanager.sql.generated.SqlManager serviceManager) {
        ...
        this.syncAgentName = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "syncAgents");
    }

    public SyncAgent refresh() {
        this.innerObject = serviceManager.serviceClient().getSyncAgents()
            .getWithResponse(resourceGroupName, serverName, syncAgentName, Context.NONE).getValue();
        return this;
    }

    public SyncAgent refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getSyncAgents()
            .getWithResponse(resourceGroupName, serverName, syncAgentName, context).getValue();
        return this;
    }

    public Response<SyncAgentKeyProperties> generateKeyWithResponse(Context context) {
        return serviceManager.syncAgents().generateKeyWithResponse(resourceGroupName, serverName, syncAgentName,
            context);
    }
