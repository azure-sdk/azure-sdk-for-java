...
@Fluent
public final class ImportExistingDatabaseDefinitionAutoGenerated {
    /*
     * Storage key type.
     */
     ...
     * @return the ImportExistingDatabaseDefinitionAutoGenerated object itself.
     */
    public ImportExistingDatabaseDefinitionAutoGenerated withStorageKeyType(StorageKeyType storageKeyType) {
     ...
     * @return the ImportExistingDatabaseDefinitionAutoGenerated object itself.
     */
    public ImportExistingDatabaseDefinitionAutoGenerated withStorageKey(String storageKey) {
     ...
     * @return the ImportExistingDatabaseDefinitionAutoGenerated object itself.
     */
    public ImportExistingDatabaseDefinitionAutoGenerated withStorageUri(String storageUri) {
     ...
     * @return the ImportExistingDatabaseDefinitionAutoGenerated object itself.
     */
    public ImportExistingDatabaseDefinitionAutoGenerated withAdministratorLogin(String administratorLogin) {
     ...
     * @return the ImportExistingDatabaseDefinitionAutoGenerated object itself.
     */
    public ImportExistingDatabaseDefinitionAutoGenerated withAdministratorLoginPassword(
     ...
     * @return the ImportExistingDatabaseDefinitionAutoGenerated object itself.
     */
    public ImportExistingDatabaseDefinitionAutoGenerated withAuthenticationType(String authenticationType) {
     ...
     * @return the ImportExistingDatabaseDefinitionAutoGenerated object itself.
     */
    public ImportExistingDatabaseDefinitionAutoGenerated withNetworkIsolation(
            ...
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException(
                        "Missing required property storageKeyType in model"
                            + " ImportExistingDatabaseDefinitionAutoGenerated"));
        }
        if (storageKey() == null) {
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException(
                        "Missing required property storageKey in model ImportExistingDatabaseDefinitionAutoGenerated"));
        }
        if (storageUri() == null) {
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException(
                        "Missing required property storageUri in model ImportExistingDatabaseDefinitionAutoGenerated"));
        }
        if (administratorLogin() == null) {
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException(
                        "Missing required property administratorLogin in model"
                            + " ImportExistingDatabaseDefinitionAutoGenerated"));
        }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(ImportExistingDatabaseDefinitionAutoGenerated.class);
}
