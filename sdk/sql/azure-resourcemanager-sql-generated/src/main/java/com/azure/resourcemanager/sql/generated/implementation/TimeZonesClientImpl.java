...
import com.azure.resourcemanager.sql.generated.models.TimeZoneListResult;
...
public final class TimeZonesClientImpl implements TimeZonesClient {
    ...
    private PagedFlux<TimeZoneInner> listByLocationAsync(String locationName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<TimeZoneInner> getAsync(String locationName, String timeZoneId) {
