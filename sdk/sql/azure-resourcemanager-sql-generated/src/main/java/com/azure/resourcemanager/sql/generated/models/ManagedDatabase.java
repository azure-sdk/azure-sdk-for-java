...
public interface ManagedDatabase {
    ...
    /**
     * Gets the crossSubscriptionSourceDatabaseId property: The resource identifier of the cross-subscription source
    ...
    /**
     * Gets the crossSubscriptionRestorableDroppedDatabaseId property: The restorable cross-subscription dropped
    ...
    /**
     * Gets the storageContainerIdentity property: Conditional. If createMode is RestoreExternalBackup, this value is
    ...
    /**
     * Gets the storageContainerSasToken property: Conditional. If createMode is RestoreExternalBackup and
    ...
    /**
     * Gets the crossSubscriptionTargetManagedInstanceId property: Target managed instance id used in cross-subscription
     * restore.
     *
    ...
    interface DefinitionStages {
        ...
        interface WithCreate
            extends DefinitionStages.WithTags,
                ...
                DefinitionStages.WithCrossSubscriptionTargetManagedInstanceId,
        ...
        /** The stage of the ManagedDatabase definition allowing to specify crossSubscriptionSourceDatabaseId. */
        interface WithCrossSubscriptionSourceDatabaseId {
            /**
             * Specifies the crossSubscriptionSourceDatabaseId property: The resource identifier of the
             * cross-subscription source database associated with create operation of this database..
             *
             * @param crossSubscriptionSourceDatabaseId The resource identifier of the cross-subscription source
             *     database associated with create operation of this database.
             * @return the next definition stage.
             */
            WithCreate withCrossSubscriptionSourceDatabaseId(String crossSubscriptionSourceDatabaseId);
        }
        ...
        /**
         * The stage of the ManagedDatabase definition allowing to specify crossSubscriptionRestorableDroppedDatabaseId.
         */
        interface WithCrossSubscriptionRestorableDroppedDatabaseId {
            /**
             * Specifies the crossSubscriptionRestorableDroppedDatabaseId property: The restorable cross-subscription
             * dropped database resource id to restore when creating this database..
             *
             * @param crossSubscriptionRestorableDroppedDatabaseId The restorable cross-subscription dropped database
             *     resource id to restore when creating this database.
             * @return the next definition stage.
             */
            WithCreate withCrossSubscriptionRestorableDroppedDatabaseId(
                String crossSubscriptionRestorableDroppedDatabaseId);
        }
        /** The stage of the ManagedDatabase definition allowing to specify storageContainerIdentity. */
        interface WithStorageContainerIdentity {
            /**
             * Specifies the storageContainerIdentity property: Conditional. If createMode is RestoreExternalBackup,
             * this value is used. Specifies the identity used for storage container authentication. Can be
             * 'SharedAccessSignature' or 'ManagedIdentity'; if not specified 'SharedAccessSignature' is assumed..
             *
             * @param storageContainerIdentity Conditional. If createMode is RestoreExternalBackup, this value is used.
             *     Specifies the identity used for storage container authentication. Can be 'SharedAccessSignature' or
             *     'ManagedIdentity'; if not specified 'SharedAccessSignature' is assumed.
             * @return the next definition stage.
             */
            WithCreate withStorageContainerIdentity(String storageContainerIdentity);
        }
        ...
        interface WithStorageContainerSasToken {
            /**
             * Specifies the storageContainerSasToken property: Conditional. If createMode is RestoreExternalBackup and
             * storageContainerIdentity is not ManagedIdentity, this value is required. Specifies the storage container
             * sas token..
             *
             * @param storageContainerSasToken Conditional. If createMode is RestoreExternalBackup and
        ...
        /** The stage of the ManagedDatabase definition allowing to specify crossSubscriptionTargetManagedInstanceId. */
        interface WithCrossSubscriptionTargetManagedInstanceId {
            /**
             * Specifies the crossSubscriptionTargetManagedInstanceId property: Target managed instance id used in
             * cross-subscription restore..
             *
             * @param crossSubscriptionTargetManagedInstanceId Target managed instance id used in cross-subscription
             *     restore.
             * @return the next definition stage.
             */
            WithCreate withCrossSubscriptionTargetManagedInstanceId(String crossSubscriptionTargetManagedInstanceId);
        }
        /** The stage of the ManagedDatabase definition allowing to specify isLedgerOn. */
     ...
     */
    void cancelMove(ManagedDatabaseMoveDefinition parameters);
     ...
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     */
    void cancelMove(ManagedDatabaseMoveDefinition parameters, Context context);
     ...
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     */
    void completeMove(ManagedDatabaseMoveDefinition parameters);
     ...
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     */
    void completeMove(ManagedDatabaseMoveDefinition parameters, Context context);
     ...
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     */
    void startMove(ManagedDatabaseStartMoveDefinition parameters);
     ...
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     */
    void startMove(ManagedDatabaseStartMoveDefinition parameters, Context context);
}
