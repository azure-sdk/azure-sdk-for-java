...
public final class WorkloadClassifierImpl
    ...
    public WorkloadClassifierImpl withExistingWorkloadGroup(String resourceGroupName, String serverName,
    ...
    public WorkloadClassifier create() {
        this.innerObject = serviceManager.serviceClient().getWorkloadClassifiers().createOrUpdate(resourceGroupName,
            serverName, databaseName, workloadGroupName, workloadClassifierName, this.innerModel(), Context.NONE);
        return this;
    }

    public WorkloadClassifier create(Context context) {
        this.innerObject = serviceManager.serviceClient().getWorkloadClassifiers().createOrUpdate(resourceGroupName,
            serverName, databaseName, workloadGroupName, workloadClassifierName, this.innerModel(), context);
        return this;
    }
    ...
    WorkloadClassifierImpl(WorkloadClassifierInner innerObject,
        ...
        this.workloadClassifierName
            = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "workloadClassifiers");
    }

    public WorkloadClassifier refresh() {
        this.innerObject = serviceManager.serviceClient().getWorkloadClassifiers().getWithResponse(resourceGroupName,
            serverName, databaseName, workloadGroupName, workloadClassifierName, Context.NONE).getValue();
        return this;
    }

    public WorkloadClassifier refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getWorkloadClassifiers().getWithResponse(resourceGroupName,
            serverName, databaseName, workloadGroupName, workloadClassifierName, context).getValue();
        return this;
    }
