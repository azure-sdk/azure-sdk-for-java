...
public final class ExtendedDatabaseBlobAuditingPolicyImpl implements ExtendedDatabaseBlobAuditingPolicy,
    ExtendedDatabaseBlobAuditingPolicy.Definition, ExtendedDatabaseBlobAuditingPolicy.Update {
    ...
    public ExtendedDatabaseBlobAuditingPolicyImpl withExistingDatabase(String resourceGroupName, String serverName,
        String databaseName) {
    ...
    public ExtendedDatabaseBlobAuditingPolicy create() {
        this.innerObject = serviceManager.serviceClient().getExtendedDatabaseBlobAuditingPolicies()
            .createOrUpdateWithResponse(resourceGroupName, serverName, databaseName, this.innerModel(), Context.NONE)
            .getValue();
        return this;
    }
    ...
    ExtendedDatabaseBlobAuditingPolicyImpl(ExtendedDatabaseBlobAuditingPolicyInner innerObject,
    ...
    public ExtendedDatabaseBlobAuditingPolicyImpl withIsManagedIdentityInUse(Boolean isManagedIdentityInUse) {
