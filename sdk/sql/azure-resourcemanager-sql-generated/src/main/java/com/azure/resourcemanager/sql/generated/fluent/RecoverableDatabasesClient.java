...
public interface RecoverableDatabasesClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<RecoverableDatabaseAutoGeneratedInner> listByServer(String resourceGroupName, String serverName);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<RecoverableDatabaseAutoGeneratedInner> listByServer(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<RecoverableDatabaseAutoGeneratedInner> getWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    RecoverableDatabaseAutoGeneratedInner get(String resourceGroupName, String serverName, String databaseName);
}
