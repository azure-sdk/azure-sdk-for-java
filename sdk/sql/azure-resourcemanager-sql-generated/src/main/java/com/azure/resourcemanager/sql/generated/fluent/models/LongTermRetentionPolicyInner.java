...
public final class LongTermRetentionPolicyInner extends ProxyResource {
     ...
     * @return An instance of LongTermRetentionPolicyInner if the JsonReader was pointing to an instance of it, or null
     * if it was pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the LongTermRetentionPolicyInner.
     */
    public static LongTermRetentionPolicyInner fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            LongTermRetentionPolicyInner deserializedLongTermRetentionPolicyInner = new LongTermRetentionPolicyInner();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("id".equals(fieldName)) {
                    deserializedLongTermRetentionPolicyInner.id = reader.getString();
                } else if ("name".equals(fieldName)) {
                    deserializedLongTermRetentionPolicyInner.name = reader.getString();
            ...
            return deserializedLongTermRetentionPolicyInner;
        });
    }
}
