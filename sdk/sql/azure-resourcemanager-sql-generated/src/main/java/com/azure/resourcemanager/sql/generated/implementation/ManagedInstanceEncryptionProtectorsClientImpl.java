...
import com.azure.resourcemanager.sql.generated.models.ManagedInstanceEncryptionProtectorListResult;
...
public final class ManagedInstanceEncryptionProtectorsClientImpl implements ManagedInstanceEncryptionProtectorsClient {
    ...
    private Mono<Response<Flux<ByteBuffer>>> revalidateWithResponseAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(context -> service.revalidate(this.client.getEndpoint(), resourceGroupName,
                managedInstanceName, encryptionProtectorName, this.client.getSubscriptionId(), apiVersion, context))
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ManagedInstanceEncryptionProtectorInner> getAsync(String resourceGroupName, String managedInstanceName,
        EncryptionProtectorName encryptionProtectorName) {
