...
public final class CapabilitiesClientImpl implements CapabilitiesClient {
    ...
    public interface CapabilitiesService {
        ...
        Mono<Response<LocationCapabilitiesInner>> listByLocation(@HostParam("$host") String endpoint,
            @PathParam("locationName") String locationName, @QueryParam("include") CapabilityGroup include,
    ...
    private Mono<Response<LocationCapabilitiesInner>> listByLocationWithResponseAsync(String locationName,
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<LocationCapabilitiesInner>> listByLocationWithResponseAsync(String locationName,
        CapabilityGroup include, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<LocationCapabilitiesInner> listByLocationAsync(String locationName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<LocationCapabilitiesInner> listByLocationWithResponse(String locationName, CapabilityGroup include,
        Context context) {
