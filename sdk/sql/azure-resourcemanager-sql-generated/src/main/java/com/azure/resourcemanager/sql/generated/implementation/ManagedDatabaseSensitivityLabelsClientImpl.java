...
public final class ManagedDatabaseSensitivityLabelsClientImpl implements ManagedDatabaseSensitivityLabelsClient {
    ...
    private Mono<Response<SensitivityLabelInner>> getWithResponseAsync(String resourceGroupName,
        ...
        return service.get(this.client.getEndpoint(), resourceGroupName, managedInstanceName, databaseName, schemaName,
            tableName, columnName, sensitivityLabelSource, this.client.getSubscriptionId(), apiVersion, accept,
            context);
    }
    ...
    private Mono<Response<SensitivityLabelInner>> createOrUpdateWithResponseAsync(String resourceGroupName,
        ...
        return service.createOrUpdate(this.client.getEndpoint(), resourceGroupName, managedInstanceName, databaseName,
            schemaName, tableName, columnName, sensitivityLabelSource, this.client.getSubscriptionId(), apiVersion,
    ...
    private Mono<PagedResponse<SensitivityLabelInner>> listCurrentByDatabaseSinglePageAsync(String resourceGroupName,
        ...
        return service
            .listCurrentByDatabase(this.client.getEndpoint(), resourceGroupName, managedInstanceName, databaseName,
                skipToken, count, filter, this.client.getSubscriptionId(), apiVersion, accept, context)
    ...
    private Mono<PagedResponse<SensitivityLabelInner>> listRecommendedByDatabaseSinglePageAsync(
        ...
        return service
            .listRecommendedByDatabase(this.client.getEndpoint(), resourceGroupName, managedInstanceName, databaseName,
                skipToken, includeDisabledRecommendations, filter, this.client.getSubscriptionId(), apiVersion, accept,
                context)
            .map(res -> new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(),
                res.getValue().value(), res.getValue().nextLink(), null));
    }
