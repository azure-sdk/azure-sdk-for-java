...
public final class IPv6FirewallRulesClientImpl implements IPv6FirewallRulesClient {
    ...
    private interface IPv6FirewallRulesService {
        ...
        Mono<Response<IPv6FirewallRuleInner>> createOrUpdate(
            ...
            @PathParam("subscriptionId") String subscriptionId,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") IPv6FirewallRuleInner parameters,
            @HeaderParam("Accept") String accept,
            Context context);
    ...
    private Mono<PagedResponse<IPv6FirewallRuleInner>> listByServerSinglePageAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<IPv6FirewallRuleInner> listByServerAsync(
        String resourceGroupName, String serverName, Context context) {
        return new PagedFlux<>(
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<IPv6FirewallRuleInner> listByServer(
        String resourceGroupName, String serverName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<IPv6FirewallRuleInner>> getWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<IPv6FirewallRuleInner>> createOrUpdateWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<IPv6FirewallRuleInner> createOrUpdateAsync(
        String resourceGroupName, String serverName, String firewallRuleName, IPv6FirewallRuleInner parameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<IPv6FirewallRuleInner> createOrUpdateWithResponse(
        String resourceGroupName,
        String serverName,
        String firewallRuleName,
        IPv6FirewallRuleInner parameters,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<IPv6FirewallRuleInner>> listByServerNextSinglePageAsync(
