...
import com.azure.resourcemanager.sql.generated.models.ServerCreateMode;
...
public final class ServerImpl implements Server, Server.Definition, Server.Update {
    ...
    public ServerImpl withRetentionDays(Integer retentionDays) {
        if (isInCreateMode()) {
            this.innerModel().withRetentionDays(retentionDays);
            return this;
        } else {
            this.updateParameters.withRetentionDays(retentionDays);
            return this;
        }
    }

    public ServerImpl withCreateMode(ServerCreateMode createMode) {
        if (isInCreateMode()) {
