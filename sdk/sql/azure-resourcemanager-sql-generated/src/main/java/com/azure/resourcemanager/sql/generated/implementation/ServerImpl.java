...
import com.azure.resourcemanager.sql.generated.models.ServerIPv6EnabledFlag;
...
public final class ServerImpl implements Server, Server.Definition, Server.Update {
    ...
    public ServerIPv6EnabledFlag isIPv6Enabled() {
    ...
    public ServerImpl withIsIPv6Enabled(ServerIPv6EnabledFlag isIPv6Enabled) {
        if (isInCreateMode()) {
