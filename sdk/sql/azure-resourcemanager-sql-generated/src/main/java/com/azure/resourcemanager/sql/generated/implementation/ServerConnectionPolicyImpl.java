...
public final class ServerConnectionPolicyImpl
    ...
    public ServerConnectionPolicy create() {
        this.innerObject = serviceManager.serviceClient().getServerConnectionPolicies()
            .createOrUpdate(resourceGroupName, serverName, connectionPolicyName, this.innerModel(), Context.NONE);
        return this;
    }

    public ServerConnectionPolicy create(Context context) {
        this.innerObject = serviceManager.serviceClient().getServerConnectionPolicies()
            .createOrUpdate(resourceGroupName, serverName, connectionPolicyName, this.innerModel(), context);
        return this;
    }

    ServerConnectionPolicyImpl(ConnectionPolicyName name,
    ...
    ServerConnectionPolicyImpl(ServerConnectionPolicyInner innerObject,
        com.azure.resourcemanager.sql.generated.SqlManager serviceManager) {
        this.innerObject = innerObject;
        this.serviceManager = serviceManager;
        this.resourceGroupName = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "resourceGroups");
        this.serverName = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "servers");
        this.connectionPolicyName = ConnectionPolicyName
            .fromString(ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "connectionPolicies"));
    }

    public ServerConnectionPolicy refresh() {
        this.innerObject = serviceManager.serviceClient().getServerConnectionPolicies()
            .getWithResponse(resourceGroupName, serverName, connectionPolicyName, Context.NONE).getValue();
        return this;
    }

    public ServerConnectionPolicy refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getServerConnectionPolicies()
            .getWithResponse(resourceGroupName, serverName, connectionPolicyName, context).getValue();
        return this;
    }
