...
public final class ReplicationLinksClientImpl implements ReplicationLinksClient {
    ...
    public interface ReplicationLinksService {
        ...
        Mono<Response<Flux<ByteBuffer>>> createOrUpdate(
            ...
            @PathParam("subscriptionId") String subscriptionId,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") ReplicationLinkInner parameters,
            @HeaderParam("Accept") String accept,
            Context context);
        ...
        Mono<Response<Flux<ByteBuffer>>> update(
            ...
            @PathParam("subscriptionId") String subscriptionId,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") ReplicationLinkUpdate parameters,
            @HeaderParam("Accept") String accept,
            Context context);
    ...
    public SyncPoller<PollResult<ReplicationLinkInner>, ReplicationLinkInner> beginCreateOrUpdate(
        ...
        ReplicationLinkInner parameters) {
        return this
            .beginCreateOrUpdateAsync(resourceGroupName, serverName, databaseName, linkId, parameters)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<ReplicationLinkInner>, ReplicationLinkInner> beginCreateOrUpdate(
        ...
        Context context) {
        return this
            .beginCreateOrUpdateAsync(resourceGroupName, serverName, databaseName, linkId, parameters, context)
            .getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ReplicationLinkInner> createOrUpdateAsync(
        String resourceGroupName,
        String serverName,
        String databaseName,
        String linkId,
        ReplicationLinkInner parameters) {
        return beginCreateOrUpdateAsync(resourceGroupName, serverName, databaseName, linkId, parameters)
            .last()
    ...
    private Mono<ReplicationLinkInner> createOrUpdateAsync(
        ...
        ReplicationLinkInner parameters,
        Context context) {
        return beginCreateOrUpdateAsync(resourceGroupName, serverName, databaseName, linkId, parameters, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ReplicationLinkInner createOrUpdate(
        String resourceGroupName,
        String serverName,
        String databaseName,
        String linkId,
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<ReplicationLinkInner>, ReplicationLinkInner> beginUpdate(
        String resourceGroupName,
        String serverName,
        String databaseName,
        String linkId,
    ...
    public SyncPoller<PollResult<ReplicationLinkInner>, ReplicationLinkInner> beginUpdate(
        ...
        Context context) {
        return this
            .beginUpdateAsync(resourceGroupName, serverName, databaseName, linkId, parameters, context)
            .getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ReplicationLinkInner> updateAsync(
        String resourceGroupName,
        String serverName,
        String databaseName,
        String linkId,
        ReplicationLinkUpdate parameters) {
        return beginUpdateAsync(resourceGroupName, serverName, databaseName, linkId, parameters)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<ReplicationLinkInner> updateAsync(
        ...
        ReplicationLinkUpdate parameters,
        Context context) {
        return beginUpdateAsync(resourceGroupName, serverName, databaseName, linkId, parameters, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ReplicationLinkInner update(
        String resourceGroupName,
        String serverName,
        String databaseName,
        String linkId,
