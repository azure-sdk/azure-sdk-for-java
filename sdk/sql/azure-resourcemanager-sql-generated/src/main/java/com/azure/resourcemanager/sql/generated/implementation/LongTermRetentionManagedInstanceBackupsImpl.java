...
public final class LongTermRetentionManagedInstanceBackupsImpl implements LongTermRetentionManagedInstanceBackups {
    ...
    public LongTermRetentionManagedInstanceBackupsImpl(LongTermRetentionManagedInstanceBackupsClient innerClient,
    ...
    public PagedIterable<ManagedInstanceLongTermRetentionBackup> listByLocation(String locationName) {
        ...
        return ResourceManagerUtils.mapPage(inner,
            inner1 -> new ManagedInstanceLongTermRetentionBackupImpl(inner1, this.manager()));
    }

    public PagedIterable<ManagedInstanceLongTermRetentionBackup> listByLocation(String locationName,
        Boolean onlyLatestPerDatabase, DatabaseState databaseState, Long skip, Long top, String filter,
        Context context) {
        PagedIterable<ManagedInstanceLongTermRetentionBackupInner> inner = this.serviceClient()
            .listByLocation(locationName, onlyLatestPerDatabase, databaseState, skip, top, filter, context);
        return ResourceManagerUtils.mapPage(inner,
            inner1 -> new ManagedInstanceLongTermRetentionBackupImpl(inner1, this.manager()));
    }

    public PagedIterable<ManagedInstanceLongTermRetentionBackup> listByDatabase(String locationName,
    ...
    public PagedIterable<ManagedInstanceLongTermRetentionBackup> listByDatabase(String locationName,
        ...
        Context context) {
        PagedIterable<ManagedInstanceLongTermRetentionBackupInner> inner = this.serviceClient().listByDatabase(
            locationName, managedInstanceName, databaseName, onlyLatestPerDatabase, databaseState, context);
        return ResourceManagerUtils.mapPage(inner,
            inner1 -> new ManagedInstanceLongTermRetentionBackupImpl(inner1, this.manager()));
    }

    public Response<ManagedInstanceLongTermRetentionBackup> getWithResponse(String locationName,
        String managedInstanceName, String databaseName, String backupName, Context context) {
        Response<ManagedInstanceLongTermRetentionBackupInner> inner = this.serviceClient().getWithResponse(locationName,
    ...
    public ManagedInstanceLongTermRetentionBackup get(String locationName, String managedInstanceName,
    ...
    public PagedIterable<ManagedInstanceLongTermRetentionBackup> listByInstance(String locationName,
    ...
    public PagedIterable<ManagedInstanceLongTermRetentionBackup> listByResourceGroupLocation(String resourceGroupName,
        String locationName) {
        PagedIterable<ManagedInstanceLongTermRetentionBackupInner> inner
    ...
    public PagedIterable<ManagedInstanceLongTermRetentionBackup> listByResourceGroupLocation(String resourceGroupName,
        String locationName, Boolean onlyLatestPerDatabase, DatabaseState databaseState, Long skip, Long top,
        String filter, Context context) {
        PagedIterable<ManagedInstanceLongTermRetentionBackupInner> inner
            = this.serviceClient().listByResourceGroupLocation(resourceGroupName, locationName, onlyLatestPerDatabase,
                databaseState, skip, top, filter, context);
        return ResourceManagerUtils.mapPage(inner,
            inner1 -> new ManagedInstanceLongTermRetentionBackupImpl(inner1, this.manager()));
    }

    public PagedIterable<ManagedInstanceLongTermRetentionBackup> listByResourceGroupDatabase(String resourceGroupName,
    ...
    public PagedIterable<ManagedInstanceLongTermRetentionBackup> listByResourceGroupDatabase(String resourceGroupName,
        ...
        PagedIterable<ManagedInstanceLongTermRetentionBackupInner> inner
            = this.serviceClient().listByResourceGroupDatabase(resourceGroupName, locationName, managedInstanceName,
                databaseName, onlyLatestPerDatabase, databaseState, context);
        return ResourceManagerUtils.mapPage(inner,
            inner1 -> new ManagedInstanceLongTermRetentionBackupImpl(inner1, this.manager()));
    }

    public Response<ManagedInstanceLongTermRetentionBackup> getByResourceGroupWithResponse(String resourceGroupName,
        ...
        Response<ManagedInstanceLongTermRetentionBackupInner> inner
            = this.serviceClient().getByResourceGroupWithResponse(resourceGroupName, locationName, managedInstanceName,
                databaseName, backupName, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
                new ManagedInstanceLongTermRetentionBackupImpl(inner.getValue(), this.manager()));
        } else {
    ...
    public ManagedInstanceLongTermRetentionBackup getByResourceGroup(String resourceGroupName, String locationName,
        String managedInstanceName, String databaseName, String backupName) {
        ManagedInstanceLongTermRetentionBackupInner inner = this.serviceClient().getByResourceGroup(resourceGroupName,
            locationName, managedInstanceName, databaseName, backupName);
        if (inner != null) {
            return new ManagedInstanceLongTermRetentionBackupImpl(inner, this.manager());
        } else {
            return null;
    ...
    public void deleteByResourceGroup(String resourceGroupName, String locationName, String managedInstanceName,
        String databaseName, String backupName) {
        this.serviceClient().deleteByResourceGroup(resourceGroupName, locationName, managedInstanceName, databaseName,
            backupName);
    }
    ...
    public PagedIterable<ManagedInstanceLongTermRetentionBackup> listByResourceGroupInstance(String resourceGroupName,
