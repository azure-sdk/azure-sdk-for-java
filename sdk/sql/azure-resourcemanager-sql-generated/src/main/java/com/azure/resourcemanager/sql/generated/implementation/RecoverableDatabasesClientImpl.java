...
public final class RecoverableDatabasesClientImpl implements RecoverableDatabasesClient {
    ...
    public interface RecoverableDatabasesService {
        ...
        Mono<Response<RecoverableDatabaseListResult>> listByServer(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<RecoverableDatabaseListResult>> listByServerNext(
     ...
     * @return a list of recoverable databases along with {@link PagedResponse} on successful completion of
     * {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<RecoverableDatabaseInner>> listByServerSinglePageAsync(String resourceGroupName,
        String serverName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<RecoverableDatabaseInner>> listByServerNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
