...
import com.azure.resourcemanager.sql.generated.models.RecoverableDatabaseListResult;
import com.azure.resourcemanager.sql.generated.models.RecoverableDatabaseListResultAutoGenerated;
...
public final class RecoverableDatabasesClientImpl implements RecoverableDatabasesClient {
    ...
    public interface RecoverableDatabasesService {
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<RecoverableDatabaseListResultAutoGenerated>> listByServer(
            @HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("serverName") String serverName,
            @PathParam("subscriptionId") String subscriptionId,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<RecoverableDatabaseAutoGeneratedInner>> get(
            @HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("serverName") String serverName,
            @PathParam("databaseName") String databaseName,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<RecoverableDatabaseListResultAutoGenerated>> listByServerNext(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<RecoverableDatabaseInner> getAsync(String resourceGroupName, String serverName, String databaseName) {
    ...
    private PagedFlux<RecoverableDatabaseInner> listByServerAsync(String resourceGroupName, String serverName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<RecoverableDatabaseAutoGeneratedInner>> listByServerSinglePageAsync(
        String resourceGroupName, String serverName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                ...
                context ->
                    service
                        .listByServer(
                            ...
                            accept,
                            context))
            .<PagedResponse<RecoverableDatabaseAutoGeneratedInner>>map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(),
                        res.getStatusCode(),
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<RecoverableDatabaseAutoGeneratedInner> listByServerAsync(
        String resourceGroupName, String serverName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<RecoverableDatabaseAutoGeneratedInner> listByServer(
        String resourceGroupName, String serverName) {
        return new PagedIterable<>(listByServerAsync(resourceGroupName, serverName));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<RecoverableDatabaseAutoGeneratedInner>> getWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<RecoverableDatabaseAutoGeneratedInner> getAsync(
        String resourceGroupName, String serverName, String databaseName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<RecoverableDatabaseAutoGeneratedInner> getWithResponse(
        String resourceGroupName,
        String serverName,
        String databaseName,
        String expand,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public RecoverableDatabaseAutoGeneratedInner get(String resourceGroupName, String serverName, String databaseName) {
        final String expand = null;
        final String filter = null;
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<RecoverableDatabaseAutoGeneratedInner>> listByServerNextSinglePageAsync(
        String nextLink) {
        if (nextLink == null) {
