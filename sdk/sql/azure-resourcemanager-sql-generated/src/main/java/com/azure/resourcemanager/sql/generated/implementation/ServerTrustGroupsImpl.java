...
public final class ServerTrustGroupsImpl implements ServerTrustGroups {
    ...
    public ServerTrustGroupsImpl(ServerTrustGroupsClient innerClient,
    ...
    public PagedIterable<ServerTrustGroup> listByLocation(String resourceGroupName, String locationName) {
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new ServerTrustGroupImpl(inner1, this.manager()));
    }
    ...
    public Response<ServerTrustGroup> getWithResponse(String resourceGroupName, String locationName,
    ...
    public ServerTrustGroup getById(String id) {
        ...
        String serverTrustGroupName = ResourceManagerUtils.getValueFromIdByName(id, "serverTrustGroups");
        if (serverTrustGroupName == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
                String.format("The resource ID '%s' is not valid. Missing path segment 'serverTrustGroups'.", id)));
        }
