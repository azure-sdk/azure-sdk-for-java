...
public interface ReplicationLinksClient {
    ...
    SyncPoller<PollResult<ReplicationLinkInner>, ReplicationLinkInner> beginCreateOrUpdate(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ReplicationLinkInner createOrUpdate(
        String resourceGroupName,
        String serverName,
        String databaseName,
        String linkId,
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<ReplicationLinkInner>, ReplicationLinkInner> beginUpdate(
        String resourceGroupName,
        String serverName,
        String databaseName,
        String linkId,
