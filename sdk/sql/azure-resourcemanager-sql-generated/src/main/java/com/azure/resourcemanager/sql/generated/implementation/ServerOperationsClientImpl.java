...
public final class ServerOperationsClientImpl implements ServerOperationsClient {
    ...
    public interface ServerOperationsService {
        ...
        Mono<Response<ServerOperationListResult>> listByServer(@HostParam("$host") String endpoint,
    ...
    private Mono<PagedResponse<ServerOperationInner>> listByServerSinglePageAsync(String resourceGroupName,
        String serverName) {
