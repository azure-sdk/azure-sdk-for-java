...
public final class ManagedInstancesImpl implements ManagedInstances {
    ...
    public ManagedInstancesImpl(ManagedInstancesClient innerClient,
    ...
    public PagedIterable<ManagedInstance> list() {
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new ManagedInstanceImpl(inner1, this.manager()));
    }
    ...
    public PagedIterable<ManagedInstance> listByResourceGroup(String resourceGroupName, String expand,
        Context context) {
        PagedIterable<ManagedInstanceInner> inner
    ...
    public Response<ManagedInstance> getByResourceGroupWithResponse(String resourceGroupName,
        String managedInstanceName, String expand, Context context) {
        Response<ManagedInstanceInner> inner = this.serviceClient().getByResourceGroupWithResponse(resourceGroupName,
            managedInstanceName, expand, context);
        if (inner != null) {
    ...
    public PagedIterable<OutboundEnvironmentEndpoint>
    ...
    public RefreshExternalGovernanceStatusOperationResultMI refreshStatus(String resourceGroupName,
    ...
    public PagedIterable<TopQueries> listByManagedInstance(String resourceGroupName, String managedInstanceName) {
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new TopQueriesImpl(inner1, this.manager()));
    }
    ...
    public PagedIterable<TopQueries> listByManagedInstance(String resourceGroupName, String managedInstanceName,
        ...
        PagedIterable<TopQueriesInner> inner
            = this.serviceClient().listByManagedInstance(resourceGroupName, managedInstanceName, numberOfQueries,
    ...
    public ManagedInstance getById(String id) {
        ...
        return this.getByResourceGroupWithResponse(resourceGroupName, managedInstanceName, localExpand, Context.NONE)
            .getValue();
    }
