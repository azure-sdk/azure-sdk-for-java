...
public final class JobStepsImpl implements JobSteps {
    ...
    public PagedIterable<JobStep> listByVersion(String resourceGroupName, String serverName, String jobAgentName,
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new JobStepImpl(inner1, this.manager()));
    }

    public PagedIterable<JobStep> listByVersion(String resourceGroupName, String serverName, String jobAgentName,
        String jobName, int jobVersion, Context context) {
        PagedIterable<JobStepInner> inner = this.serviceClient().listByVersion(resourceGroupName, serverName,
            jobAgentName, jobName, jobVersion, context);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new JobStepImpl(inner1, this.manager()));
    }

    public Response<JobStep> getByVersionWithResponse(String resourceGroupName, String serverName, String jobAgentName,
        String jobName, int jobVersion, String stepName, Context context) {
        Response<JobStepInner> inner = this.serviceClient().getByVersionWithResponse(resourceGroupName, serverName,
            jobAgentName, jobName, jobVersion, stepName, context);
        if (inner != null) {
    ...
    public JobStep getByVersion(String resourceGroupName, String serverName, String jobAgentName, String jobName,
        int jobVersion, String stepName) {
        JobStepInner inner = this.serviceClient().getByVersion(resourceGroupName, serverName, jobAgentName, jobName,
            jobVersion, stepName);
        if (inner != null) {
    ...
    public PagedIterable<JobStep> listByJob(String resourceGroupName, String serverName, String jobAgentName,
        String jobName) {
        PagedIterable<JobStepInner> inner
    ...
    public Response<JobStep> getWithResponse(String resourceGroupName, String serverName, String jobAgentName,
        String jobName, String stepName, Context context) {
        Response<JobStepInner> inner = this.serviceClient().getWithResponse(resourceGroupName, serverName, jobAgentName,
            jobName, stepName, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
                new JobStepImpl(inner.getValue(), this.manager()));
        } else {
    ...
    public JobStep get(String resourceGroupName, String serverName, String jobAgentName, String jobName,
        String stepName) {
    ...
    public Response<Void> deleteWithResponse(String resourceGroupName, String serverName, String jobAgentName,
        String jobName, String stepName, Context context) {
        return this.serviceClient().deleteWithResponse(resourceGroupName, serverName, jobAgentName, jobName, stepName,
            context);
    }
    ...
    public JobStep getById(String id) {
        ...
        String jobAgentName = ResourceManagerUtils.getValueFromIdByName(id, "jobAgents");
        ...
        String stepName = ResourceManagerUtils.getValueFromIdByName(id, "steps");
        if (stepName == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
                String.format("The resource ID '%s' is not valid. Missing path segment 'steps'.", id)));
        }
        return this.getWithResponse(resourceGroupName, serverName, jobAgentName, jobName, stepName, Context.NONE)
            .getValue();
    }
