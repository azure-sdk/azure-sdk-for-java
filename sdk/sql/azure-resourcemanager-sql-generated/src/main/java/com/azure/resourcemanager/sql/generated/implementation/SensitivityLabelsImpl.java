...
public final class SensitivityLabelsImpl implements SensitivityLabels {
    ...
    public PagedIterable<SensitivityLabel> listRecommendedByDatabase(String resourceGroupName, String serverName,
        ...
        PagedIterable<SensitivityLabelInner> inner = this.serviceClient()
            .listRecommendedByDatabase(resourceGroupName, serverName, databaseName, skipToken,
    ...
    public Response<Void> enableRecommendationWithResponse(String resourceGroupName, String serverName,
        ...
        return this.serviceClient()
            .enableRecommendationWithResponse(resourceGroupName, serverName, databaseName, schemaName, tableName,
                columnName, context);
    }
    ...
    public Response<SensitivityLabel> createOrUpdateWithResponse(String resourceGroupName, String serverName,
        ...
        Context context) {
        Response<SensitivityLabelInner> inner = this.serviceClient()
            .createOrUpdateWithResponse(resourceGroupName, serverName, databaseName, schemaName, tableName, columnName,
                parameters, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
                new SensitivityLabelImpl(inner.getValue(), this.manager()));
    ...
    public SensitivityLabel createOrUpdate(String resourceGroupName, String serverName, String databaseName,
        ...
        SensitivityLabelInner inner = this.serviceClient()
            .createOrUpdate(resourceGroupName, serverName, databaseName, schemaName, tableName, columnName, parameters);
        if (inner != null) {
            return new SensitivityLabelImpl(inner, this.manager());
        } else {
            return null;
