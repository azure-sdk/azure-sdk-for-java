...
import com.azure.resourcemanager.sql.generated.models.ExternalGovernanceStatus;
import com.azure.resourcemanager.sql.generated.models.FreemiumType;
import com.azure.resourcemanager.sql.generated.models.HybridSecondaryUsage;
import com.azure.resourcemanager.sql.generated.models.HybridSecondaryUsageDetected;
...
public final class ManagedInstanceImpl implements ManagedInstance, ManagedInstance.Definition, ManagedInstance.Update {
    ...
    public Boolean isGeneralPurposeV2() {
        return this.innerModel().isGeneralPurposeV2();
    }
    ...
    public HybridSecondaryUsage hybridSecondaryUsage() {
        return this.innerModel().hybridSecondaryUsage();
    }

    public HybridSecondaryUsageDetected hybridSecondaryUsageDetected() {
        return this.innerModel().hybridSecondaryUsageDetected();
    }
    ...
    public Integer storageIOps() {
        return this.innerModel().storageIOps();
    }

    public Integer storageThroughputMBps() {
        return this.innerModel().storageThroughputMBps();
    }

    public Integer totalMemoryMB() {
        return this.innerModel().totalMemoryMB();
    }
    ...
    public ExternalGovernanceStatus externalGovernanceStatus() {
        return this.innerModel().externalGovernanceStatus();
    }

    public FreemiumType pricingModel() {
        return this.innerModel().pricingModel();
    }
    ...
    public AuthMetadataLookupModes authenticationMetadata() {
        return this.innerModel().authenticationMetadata();
    }

    public ManagedInstanceDatabaseFormat databaseFormat() {
        return this.innerModel().databaseFormat();
    }
    ...
    public ManagedInstance create() {
        this.innerObject = serviceManager.serviceClient().getManagedInstances().createOrUpdate(resourceGroupName,
            managedInstanceName, this.innerModel(), Context.NONE);
        return this;
    }

    public ManagedInstance create(Context context) {
        this.innerObject = serviceManager.serviceClient().getManagedInstances().createOrUpdate(resourceGroupName,
            managedInstanceName, this.innerModel(), context);
        return this;
    }

    ManagedInstanceImpl(String name, com.azure.resourcemanager.sql.generated.SqlManager serviceManager) {
    ...
    public ManagedInstance apply() {
        this.innerObject = serviceManager.serviceClient().getManagedInstances().update(resourceGroupName,
            managedInstanceName, updateParameters, Context.NONE);
        return this;
    }

    public ManagedInstance apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getManagedInstances().update(resourceGroupName,
            managedInstanceName, updateParameters, context);
        return this;
    }

    ManagedInstanceImpl(ManagedInstanceInner innerObject,
    ...
    public ManagedInstance refresh() {
        ...
        this.innerObject = serviceManager.serviceClient().getManagedInstances()
    ...
    public ManagedInstance refresh(Context context) {
        String localExpand = null;
        this.innerObject = serviceManager.serviceClient().getManagedInstances()
            .getByResourceGroupWithResponse(resourceGroupName, managedInstanceName, localExpand, context).getValue();
        return this;
    }
    ...
    public ManagedInstanceImpl withIsGeneralPurposeV2(Boolean isGeneralPurposeV2) {
        if (isInCreateMode()) {
            this.innerModel().withIsGeneralPurposeV2(isGeneralPurposeV2);
            return this;
        } else {
            this.updateParameters.withIsGeneralPurposeV2(isGeneralPurposeV2);
            return this;
        }
    }
    ...
    public ManagedInstanceImpl withHybridSecondaryUsage(HybridSecondaryUsage hybridSecondaryUsage) {
        if (isInCreateMode()) {
            this.innerModel().withHybridSecondaryUsage(hybridSecondaryUsage);
            return this;
        } else {
            this.updateParameters.withHybridSecondaryUsage(hybridSecondaryUsage);
            return this;
        }
    }
    ...
    public ManagedInstanceImpl withStorageIOps(Integer storageIOps) {
        if (isInCreateMode()) {
            this.innerModel().withStorageIOps(storageIOps);
            return this;
        } else {
            this.updateParameters.withStorageIOps(storageIOps);
            return this;
        }
    }

    public ManagedInstanceImpl withStorageThroughputMBps(Integer storageThroughputMBps) {
        if (isInCreateMode()) {
            this.innerModel().withStorageThroughputMBps(storageThroughputMBps);
            return this;
        } else {
            this.updateParameters.withStorageThroughputMBps(storageThroughputMBps);
            return this;
        }
    }

    public ManagedInstanceImpl withTotalMemoryMB(Integer totalMemoryMB) {
        if (isInCreateMode()) {
            this.innerModel().withTotalMemoryMB(totalMemoryMB);
            return this;
        } else {
            this.updateParameters.withTotalMemoryMB(totalMemoryMB);
            return this;
        }
    }
    ...
    public ManagedInstanceImpl withPrimaryUserAssignedIdentityId(String primaryUserAssignedIdentityId) {
        if (isInCreateMode()) {
    ...
    public ManagedInstanceImpl withKeyId(String keyId) {
        this.innerModel().withKeyId(keyId);
        return this;
    }

    public ManagedInstanceImpl withAdministrators(ManagedInstanceExternalAdministrator administrators) {
        this.innerModel().withAdministrators(administrators);
        return this;
    }

    public ManagedInstanceImpl withServicePrincipal(ServicePrincipal servicePrincipal) {
        if (isInCreateMode()) {
    ...
    public ManagedInstanceImpl withPricingModel(FreemiumType pricingModel) {
        if (isInCreateMode()) {
            this.innerModel().withPricingModel(pricingModel);
            return this;
        } else {
            this.updateParameters.withPricingModel(pricingModel);
            return this;
        }
    }

    public ManagedInstanceImpl withAuthenticationMetadata(AuthMetadataLookupModes authenticationMetadata) {
        if (isInCreateMode()) {
            this.innerModel().withAuthenticationMetadata(authenticationMetadata);
            return this;
        } else {
            this.updateParameters.withAuthenticationMetadata(authenticationMetadata);
            return this;
        }
    }

    public ManagedInstanceImpl withDatabaseFormat(ManagedInstanceDatabaseFormat databaseFormat) {
        if (isInCreateMode()) {
            this.innerModel().withDatabaseFormat(databaseFormat);
            return this;
        } else {
            this.updateParameters.withDatabaseFormat(databaseFormat);
            return this;
        }
    }
