...
import com.azure.resourcemanager.sql.generated.models.MaintenancePolicy;
...
public final class ManagedInstanceImpl implements ManagedInstance, ManagedInstance.Definition, ManagedInstance.Update {
    ...
    ManagedInstanceImpl(
        ManagedInstanceInner innerObject, com.azure.resourcemanager.sql.generated.SqlManager serviceManager) {
    ...
    public ManagedInstance refresh(Context context) {
        ...
        this.innerObject =
            serviceManager
                .serviceClient()
                .getManagedInstances()
                .getByResourceGroupWithResponse(resourceGroupName, managedInstanceName, localExpand, context)
                .getValue();
        return this;
    }
    ...
    public ManagedInstanceImpl withMaintenancePolicy(MaintenancePolicy maintenancePolicy) {
        if (isInCreateMode()) {
    ...
    public ManagedInstanceImpl withRequestedBackupStorageRedundancy(
