...
public final class ManagedInstanceImpl implements ManagedInstance, ManagedInstance.Definition, ManagedInstance.Update {
    ...
    public void start() {
        serviceManager.managedInstances().start(resourceGroupName, managedInstanceName);
    }

    public void start(Context context) {
        serviceManager.managedInstances().start(resourceGroupName, managedInstanceName, context);
    }

    public void stop() {
        serviceManager.managedInstances().stop(resourceGroupName, managedInstanceName);
    }

    public void stop(Context context) {
        serviceManager.managedInstances().stop(resourceGroupName, managedInstanceName, context);
    }
