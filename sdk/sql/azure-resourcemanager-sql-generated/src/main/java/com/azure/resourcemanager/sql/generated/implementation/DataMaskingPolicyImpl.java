        ...
        this.innerObject =
            serviceManager
                ...
                .createOrUpdateWithResponse(
                    resourceGroupName, serverName, databaseName, dataMaskingPolicyName, this.innerModel(), Context.NONE)
                .getValue();
        return this;
    }
    ...
    public DataMaskingPolicy create(Context context) {
        this.innerObject =
            serviceManager
                ...
                .getDataMaskingPolicies()
                .createOrUpdateWithResponse(
                    resourceGroupName, serverName, databaseName, dataMaskingPolicyName, this.innerModel(), context)
                .getValue();
        return this;
    }

    DataMaskingPolicyImpl(
        DataMaskingPolicyName name, com.azure.resourcemanager.sql.generated.SqlManager serviceManager) {
    ...
    public DataMaskingPolicy refresh(Context context) {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getDataMaskingPolicies()
                .getWithResponse(resourceGroupName, serverName, databaseName, dataMaskingPolicyName, context)
                .getValue();
        return this;
    }
