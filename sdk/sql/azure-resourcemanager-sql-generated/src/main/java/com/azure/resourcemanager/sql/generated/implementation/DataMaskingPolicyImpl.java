...
public final class DataMaskingPolicyImpl
    ...
    private DataMaskingPolicyName dataMaskingPolicyName;

    public DataMaskingPolicyImpl withExistingDatabase(String resourceGroupName, String serverName,
        String databaseName) {
    ...
    public DataMaskingPolicy create() {
        this.innerObject
            = serviceManager.serviceClient().getDataMaskingPolicies().createOrUpdateWithResponse(resourceGroupName,
                serverName, databaseName, dataMaskingPolicyName, this.innerModel(), Context.NONE).getValue();
        return this;
    }
    ...
    public DataMaskingPolicy create(Context context) {
        this.innerObject
            = serviceManager.serviceClient().getDataMaskingPolicies().createOrUpdateWithResponse(resourceGroupName,
                serverName, databaseName, dataMaskingPolicyName, this.innerModel(), context).getValue();
        return this;
    }

    DataMaskingPolicyImpl(DataMaskingPolicyName name,
        com.azure.resourcemanager.sql.generated.SqlManager serviceManager) {
        this.innerObject = new DataMaskingPolicyInner();
        this.serviceManager = serviceManager;
        this.dataMaskingPolicyName = name;
    }
    ...
    DataMaskingPolicyImpl(DataMaskingPolicyInner innerObject,
        ...
        this.dataMaskingPolicyName
            = DataMaskingPolicyName.fromString(Utils.getValueFromIdByName(innerObject.id(), "dataMaskingPolicies"));
    }

    public DataMaskingPolicy refresh() {
        this.innerObject = serviceManager.serviceClient().getDataMaskingPolicies()
            .getWithResponse(resourceGroupName, serverName, databaseName, dataMaskingPolicyName, Context.NONE)
            .getValue();
        return this;
    }
    ...
    public DataMaskingPolicy refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getDataMaskingPolicies()
            .getWithResponse(resourceGroupName, serverName, databaseName, dataMaskingPolicyName, context).getValue();
        return this;
    }
