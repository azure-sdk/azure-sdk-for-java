...
public final class ServerCommunicationLinkImpl
    ...
    public ServerCommunicationLink create() {
        this.innerObject = serviceManager.serviceClient().getServerCommunicationLinks()
    ...
    ServerCommunicationLinkImpl(String name, com.azure.resourcemanager.sql.generated.SqlManager serviceManager) {
    ...
    ServerCommunicationLinkImpl(ServerCommunicationLinkInner innerObject,
        com.azure.resourcemanager.sql.generated.SqlManager serviceManager) {
        this.innerObject = innerObject;
        this.serviceManager = serviceManager;
        this.resourceGroupName = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "resourceGroups");
        this.serverName = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "servers");
        this.communicationLinkName = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "communicationLinks");
    }

    public ServerCommunicationLink refresh() {
        this.innerObject = serviceManager.serviceClient().getServerCommunicationLinks()
            .getWithResponse(resourceGroupName, serverName, communicationLinkName, Context.NONE).getValue();
        return this;
    }

    public ServerCommunicationLink refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getServerCommunicationLinks()
            .getWithResponse(resourceGroupName, serverName, communicationLinkName, context).getValue();
        return this;
    }
