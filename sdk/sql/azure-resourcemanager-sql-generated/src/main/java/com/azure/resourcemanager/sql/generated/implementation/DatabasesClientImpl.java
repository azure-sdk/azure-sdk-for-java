...
import com.azure.resourcemanager.sql.generated.models.DatabaseListResultAutoGenerated;
import com.azure.resourcemanager.sql.generated.models.DatabaseUpdate;
import com.azure.resourcemanager.sql.generated.models.DatabaseUpdateAutoGenerated;
...
public final class DatabasesClientImpl implements DatabasesClient {
    ...
    private interface DatabasesService {
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<DatabaseListResultAutoGenerated>> listByServer(
            @HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("serverName") String serverName,
            @QueryParam("$skipToken") String skipToken,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<DatabaseAutoGeneratedInner>> get(
            @HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("serverName") String serverName,
            @PathParam("databaseName") String databaseName,
        ...
        Mono<Response<Flux<ByteBuffer>>> createOrUpdate(
            ...
            @PathParam("subscriptionId") String subscriptionId,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") DatabaseAutoGeneratedInner parameters,
            @HeaderParam("Accept") String accept,
            Context context);
        ...
        Mono<Response<Flux<ByteBuffer>>> update(
            ...
            @PathParam("subscriptionId") String subscriptionId,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") DatabaseUpdateAutoGenerated parameters,
            @HeaderParam("Accept") String accept,
            Context context);
        ...
        Mono<Response<Flux<ByteBuffer>>> export(
            ...
            @PathParam("subscriptionId") String subscriptionId,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") ExportDatabaseDefinitionAutoGenerated parameters,
            @HeaderParam("Accept") String accept,
            Context context);
        ...
        Mono<Response<Flux<ByteBuffer>>> importMethod(
            ...
            @PathParam("subscriptionId") String subscriptionId,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") ImportExistingDatabaseDefinitionAutoGenerated parameters,
            @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<DatabaseListResultAutoGenerated>> listByElasticPool(
            @HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("serverName") String serverName,
            @PathParam("elasticPoolName") String elasticPoolName,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<DatabaseListResultAutoGenerated>> listInaccessibleByServer(
            @HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("serverName") String serverName,
            @PathParam("subscriptionId") String subscriptionId,
    ...
    private Mono<PagedResponse<DatabaseInner>> listByServerSinglePageAsync(
        String resourceGroupName, String serverName, String skipToken) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    private PagedFlux<DatabaseInner> listByServerAsync(String resourceGroupName, String serverName, String skipToken) {
        return new PagedFlux<>(
            () -> listByServerSinglePageAsync(resourceGroupName, serverName, skipToken),
    ...
    private PagedFlux<DatabaseInner> listByServerAsync(
        String resourceGroupName, String serverName, String skipToken, Context context) {
        return new PagedFlux<>(
            () -> listByServerSinglePageAsync(resourceGroupName, serverName, skipToken, context),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<DatabaseAutoGeneratedInner>> listByServerSinglePageAsync(
        String resourceGroupName, String serverName, String skipToken) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                ...
                context ->
                    service
                        .listByServer(
                            ...
                            accept,
                            context))
            .<PagedResponse<DatabaseAutoGeneratedInner>>map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(),
                        res.getStatusCode(),
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<DatabaseAutoGeneratedInner> listByServerAsync(
        String resourceGroupName, String serverName, String skipToken) {
        return new PagedFlux<>(
            () -> listByServerSinglePageAsync(resourceGroupName, serverName, skipToken),
            nextLink -> listByServerNextSinglePageAsync(nextLink));
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<DatabaseAutoGeneratedInner> listByServerAsync(String resourceGroupName, String serverName) {
        final String skipToken = null;
        return new PagedFlux<>(
            () -> listByServerSinglePageAsync(resourceGroupName, serverName, skipToken),
            nextLink -> listByServerNextSinglePageAsync(nextLink));
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<DatabaseAutoGeneratedInner> listByServer(String resourceGroupName, String serverName) {
        final String skipToken = null;
        return new PagedIterable<>(listByServerAsync(resourceGroupName, serverName, skipToken));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<DatabaseAutoGeneratedInner> listByServer(
        String resourceGroupName, String serverName, String skipToken, Context context) {
        return new PagedIterable<>(listByServerAsync(resourceGroupName, serverName, skipToken, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<DatabaseAutoGeneratedInner>> getWithResponseAsync(
        String resourceGroupName, String serverName, String databaseName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DatabaseAutoGeneratedInner> getAsync(
        String resourceGroupName, String serverName, String databaseName) {
        return getWithResponseAsync(resourceGroupName, serverName, databaseName)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public DatabaseAutoGeneratedInner get(String resourceGroupName, String serverName, String databaseName) {
        return getAsync(resourceGroupName, serverName, databaseName).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<DatabaseAutoGeneratedInner> getWithResponse(
        String resourceGroupName, String serverName, String databaseName, Context context) {
        return getWithResponseAsync(resourceGroupName, serverName, databaseName, context).block();
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(
        String resourceGroupName, String serverName, String databaseName, DatabaseAutoGeneratedInner parameters) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(
        ...
        String serverName,
        String databaseName,
        DatabaseAutoGeneratedInner parameters,
        Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<DatabaseAutoGeneratedInner>, DatabaseAutoGeneratedInner> beginCreateOrUpdateAsync(
        String resourceGroupName, String serverName, String databaseName, DatabaseAutoGeneratedInner parameters) {
        Mono<Response<Flux<ByteBuffer>>> mono =
            createOrUpdateWithResponseAsync(resourceGroupName, serverName, databaseName, parameters);
        return this
            .client
            .<DatabaseAutoGeneratedInner, DatabaseAutoGeneratedInner>getLroResult(
                mono,
                this.client.getHttpPipeline(),
                DatabaseAutoGeneratedInner.class,
                DatabaseAutoGeneratedInner.class,
                this.client.getContext());
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<DatabaseAutoGeneratedInner>, DatabaseAutoGeneratedInner> beginCreateOrUpdate(
        String resourceGroupName, String serverName, String databaseName, DatabaseAutoGeneratedInner parameters) {
        return beginCreateOrUpdateAsync(resourceGroupName, serverName, databaseName, parameters).getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DatabaseAutoGeneratedInner> createOrUpdateAsync(
        String resourceGroupName, String serverName, String databaseName, DatabaseAutoGeneratedInner parameters) {
        return beginCreateOrUpdateAsync(resourceGroupName, serverName, databaseName, parameters)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public DatabaseAutoGeneratedInner createOrUpdate(
        String resourceGroupName, String serverName, String databaseName, DatabaseAutoGeneratedInner parameters) {
        return createOrUpdateAsync(resourceGroupName, serverName, databaseName, parameters).block();
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> updateWithResponseAsync(
        String resourceGroupName, String serverName, String databaseName, DatabaseUpdateAutoGenerated parameters) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    private Mono<Response<Flux<ByteBuffer>>> updateWithResponseAsync(
        ...
        String serverName,
        String databaseName,
        DatabaseUpdateAutoGenerated parameters,
        Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<DatabaseAutoGeneratedInner>, DatabaseAutoGeneratedInner> beginUpdateAsync(
        String resourceGroupName, String serverName, String databaseName, DatabaseUpdateAutoGenerated parameters) {
        Mono<Response<Flux<ByteBuffer>>> mono =
            updateWithResponseAsync(resourceGroupName, serverName, databaseName, parameters);
        return this
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<DatabaseAutoGeneratedInner>, DatabaseAutoGeneratedInner> beginUpdate(
        String resourceGroupName, String serverName, String databaseName, DatabaseUpdateAutoGenerated parameters) {
        return beginUpdateAsync(resourceGroupName, serverName, databaseName, parameters).getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DatabaseAutoGeneratedInner> updateAsync(
        String resourceGroupName, String serverName, String databaseName, DatabaseUpdateAutoGenerated parameters) {
        return beginUpdateAsync(resourceGroupName, serverName, databaseName, parameters)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public DatabaseAutoGeneratedInner update(
        String resourceGroupName, String serverName, String databaseName, DatabaseUpdateAutoGenerated parameters) {
        return updateAsync(resourceGroupName, serverName, databaseName, parameters).block();
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> exportWithResponseAsync(
        ...
        String serverName,
        String databaseName,
        ExportDatabaseDefinitionAutoGenerated parameters) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    private Mono<Response<Flux<ByteBuffer>>> importMethodWithResponseAsync(
        ...
        String serverName,
        String databaseName,
        ImportExistingDatabaseDefinitionAutoGenerated parameters) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<DatabaseAutoGeneratedInner>, DatabaseAutoGeneratedInner> beginPauseAsync(
        String resourceGroupName, String serverName, String databaseName) {
        Mono<Response<Flux<ByteBuffer>>> mono = pauseWithResponseAsync(resourceGroupName, serverName, databaseName);
        return this
            .client
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<DatabaseAutoGeneratedInner>, DatabaseAutoGeneratedInner> beginPause(
        String resourceGroupName, String serverName, String databaseName) {
        return beginPauseAsync(resourceGroupName, serverName, databaseName).getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DatabaseAutoGeneratedInner> pauseAsync(
        String resourceGroupName, String serverName, String databaseName) {
        return beginPauseAsync(resourceGroupName, serverName, databaseName)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public DatabaseAutoGeneratedInner pause(String resourceGroupName, String serverName, String databaseName) {
        return pauseAsync(resourceGroupName, serverName, databaseName).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public DatabaseAutoGeneratedInner pause(
        String resourceGroupName, String serverName, String databaseName, Context context) {
        return pauseAsync(resourceGroupName, serverName, databaseName, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<DatabaseAutoGeneratedInner>, DatabaseAutoGeneratedInner> beginResumeAsync(
        String resourceGroupName, String serverName, String databaseName) {
        Mono<Response<Flux<ByteBuffer>>> mono = resumeWithResponseAsync(resourceGroupName, serverName, databaseName);
        return this
            .client
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<DatabaseAutoGeneratedInner>, DatabaseAutoGeneratedInner> beginResume(
        String resourceGroupName, String serverName, String databaseName) {
        return beginResumeAsync(resourceGroupName, serverName, databaseName).getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DatabaseAutoGeneratedInner> resumeAsync(
        String resourceGroupName, String serverName, String databaseName) {
        return beginResumeAsync(resourceGroupName, serverName, databaseName)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public DatabaseAutoGeneratedInner resume(String resourceGroupName, String serverName, String databaseName) {
        return resumeAsync(resourceGroupName, serverName, databaseName).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public DatabaseAutoGeneratedInner resume(
        String resourceGroupName, String serverName, String databaseName, Context context) {
        return resumeAsync(resourceGroupName, serverName, databaseName, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<DatabaseAutoGeneratedInner>> listByElasticPoolSinglePageAsync(
        String resourceGroupName, String serverName, String elasticPoolName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<DatabaseAutoGeneratedInner> listByElasticPoolAsync(
        String resourceGroupName, String serverName, String elasticPoolName) {
        return new PagedFlux<>(
            () -> listByElasticPoolSinglePageAsync(resourceGroupName, serverName, elasticPoolName),
            nextLink -> listByElasticPoolNextSinglePageAsync(nextLink));
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<DatabaseAutoGeneratedInner> listByElasticPool(
        String resourceGroupName, String serverName, String elasticPoolName) {
        return new PagedIterable<>(listByElasticPoolAsync(resourceGroupName, serverName, elasticPoolName));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<DatabaseAutoGeneratedInner>> listInaccessibleByServerSinglePageAsync(
        String resourceGroupName, String serverName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<DatabaseAutoGeneratedInner> listInaccessibleByServerAsync(
        String resourceGroupName, String serverName) {
        return new PagedFlux<>(
            () -> listInaccessibleByServerSinglePageAsync(resourceGroupName, serverName),
            nextLink -> listInaccessibleByServerNextSinglePageAsync(nextLink));
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<DatabaseAutoGeneratedInner> listInaccessibleByServer(
        String resourceGroupName, String serverName) {
        return new PagedIterable<>(listInaccessibleByServerAsync(resourceGroupName, serverName));
    }
