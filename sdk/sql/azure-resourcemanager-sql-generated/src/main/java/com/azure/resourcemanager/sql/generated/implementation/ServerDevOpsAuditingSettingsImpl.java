...
public final class ServerDevOpsAuditingSettingsImpl implements ServerDevOpsAuditingSettings,
    ServerDevOpsAuditingSettings.Definition, ServerDevOpsAuditingSettings.Update {
    ...
    public Boolean isManagedIdentityInUse() {
        return this.innerModel().isManagedIdentityInUse();
    }
    ...
    private DevOpsAuditingSettingsName devOpsAuditingSettingsName;
    ...
    public ServerDevOpsAuditingSettings create() {
        this.innerObject = serviceManager.serviceClient().getServerDevOpsAuditSettings()
            .createOrUpdate(resourceGroupName, serverName, devOpsAuditingSettingsName, this.innerModel(), Context.NONE);
        return this;
    }
    ...
    ServerDevOpsAuditingSettingsImpl(DevOpsAuditingSettingsName name,
    ...
    ServerDevOpsAuditingSettingsImpl(ServerDevOpsAuditingSettingsInner innerObject,
        com.azure.resourcemanager.sql.generated.SqlManager serviceManager) {
        this.innerObject = innerObject;
        this.serviceManager = serviceManager;
        this.resourceGroupName = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "resourceGroups");
        this.serverName = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "servers");
        this.devOpsAuditingSettingsName = DevOpsAuditingSettingsName
            .fromString(ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "devOpsAuditingSettings"));
    }

    public ServerDevOpsAuditingSettings refresh() {
        this.innerObject = serviceManager.serviceClient().getServerDevOpsAuditSettings()
            .getWithResponse(resourceGroupName, serverName, devOpsAuditingSettingsName, Context.NONE).getValue();
        return this;
    }

    public ServerDevOpsAuditingSettings refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getServerDevOpsAuditSettings()
            .getWithResponse(resourceGroupName, serverName, devOpsAuditingSettingsName, context).getValue();
        return this;
    }
    ...
    public ServerDevOpsAuditingSettingsImpl withIsManagedIdentityInUse(Boolean isManagedIdentityInUse) {
        this.innerModel().withIsManagedIdentityInUse(isManagedIdentityInUse);
        return this;
    }
