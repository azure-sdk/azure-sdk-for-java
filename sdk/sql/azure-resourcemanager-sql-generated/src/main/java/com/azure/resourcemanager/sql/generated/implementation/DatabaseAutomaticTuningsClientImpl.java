...
public final class DatabaseAutomaticTuningsClientImpl implements DatabaseAutomaticTuningsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DatabaseAutomaticTuningInner> getAsync(String resourceGroupName, String serverName,
        String databaseName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DatabaseAutomaticTuningInner> updateAsync(String resourceGroupName, String serverName,
