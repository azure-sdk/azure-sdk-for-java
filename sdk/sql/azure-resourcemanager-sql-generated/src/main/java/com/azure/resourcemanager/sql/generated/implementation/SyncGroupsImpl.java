...
public final class SyncGroupsImpl implements SyncGroups {
    ...
    public SyncGroupsImpl(SyncGroupsClient innerClient,
    ...
    public PagedIterable<SyncDatabaseIdProperties> listSyncDatabaseIds(String locationName) {
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new SyncDatabaseIdPropertiesImpl(inner1, this.manager()));
    }
    ...
    public PagedIterable<SyncGroup> listByDatabase(String resourceGroupName, String serverName, String databaseName) {
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new SyncGroupImpl(inner1, this.manager()));
    }
    ...
    public Response<SyncGroup> getWithResponse(String resourceGroupName, String serverName, String databaseName,
    ...
    public Response<Void> cancelSyncWithResponse(String resourceGroupName, String serverName, String databaseName,
        String syncGroupName, Context context) {
        return this.serviceClient().cancelSyncWithResponse(resourceGroupName, serverName, databaseName, syncGroupName,
            context);
    }
    ...
    public PagedIterable<SyncFullSchemaProperties> listHubSchemas(String resourceGroupName, String serverName,
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new SyncFullSchemaPropertiesImpl(inner1, this.manager()));
    }
    ...
    public PagedIterable<SyncGroupLogProperties> listLogs(String resourceGroupName, String serverName,
        String databaseName, String syncGroupName, String startTime, String endTime, SyncGroupsType type) {
        PagedIterable<SyncGroupLogPropertiesInner> inner = this.serviceClient().listLogs(resourceGroupName, serverName,
            databaseName, syncGroupName, startTime, endTime, type);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new SyncGroupLogPropertiesImpl(inner1, this.manager()));
    }
    ...
    public PagedIterable<SyncGroupLogProperties> listLogs(String resourceGroupName, String serverName,
        ...
        PagedIterable<SyncGroupLogPropertiesInner> inner = this.serviceClient().listLogs(resourceGroupName, serverName,
            databaseName, syncGroupName, startTime, endTime, type, continuationToken, context);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new SyncGroupLogPropertiesImpl(inner1, this.manager()));
    }
    ...
    public Response<Void> triggerSyncWithResponse(String resourceGroupName, String serverName, String databaseName,
        String syncGroupName, Context context) {
        return this.serviceClient().triggerSyncWithResponse(resourceGroupName, serverName, databaseName, syncGroupName,
            context);
    }
    ...
    public SyncGroup getById(String id) {
        ...
        String syncGroupName = ResourceManagerUtils.getValueFromIdByName(id, "syncGroups");
        if (syncGroupName == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
                String.format("The resource ID '%s' is not valid. Missing path segment 'syncGroups'.", id)));
        }
        return this.getWithResponse(resourceGroupName, serverName, databaseName, syncGroupName, Context.NONE)
            .getValue();
    }
