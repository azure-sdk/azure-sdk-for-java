...
public final class GeoBackupPoliciesImpl implements GeoBackupPolicies {
    ...
    public PagedIterable<GeoBackupPolicy> list(String resourceGroupName, String serverName, String databaseName) {
        PagedIterable<GeoBackupPolicyInner> inner
            = this.serviceClient().list(resourceGroupName, serverName, databaseName);
    ...
    public PagedIterable<GeoBackupPolicy> list(String resourceGroupName, String serverName, String databaseName,
        Context context) {
        PagedIterable<GeoBackupPolicyInner> inner
            = this.serviceClient().list(resourceGroupName, serverName, databaseName, context);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new GeoBackupPolicyImpl(inner1, this.manager()));
    }
