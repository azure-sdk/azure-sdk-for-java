...
@Fluent
public final class JobExecutionAutoGenerated2Inner extends ProxyResource {
    /*
     * Resource properties.
     */
    @JsonProperty(value = "properties")
    private JobExecutionPropertiesAutoGenerated2 innerProperties;

    /** Creates an instance of JobExecutionAutoGenerated2Inner class. */
    public JobExecutionAutoGenerated2Inner() {
    }
     ...
     * @return the JobExecutionAutoGenerated2Inner object itself.
     */
    public JobExecutionAutoGenerated2Inner withCurrentAttempts(Integer currentAttempts) {
        if (this.innerProperties() == null) {
            this.innerProperties = new JobExecutionPropertiesAutoGenerated2();
        }
