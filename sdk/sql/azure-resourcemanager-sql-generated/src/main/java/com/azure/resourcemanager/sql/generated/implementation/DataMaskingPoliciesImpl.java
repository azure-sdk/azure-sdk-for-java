...
public final class DataMaskingPoliciesImpl implements DataMaskingPolicies {
    ...
    public DataMaskingPolicy getById(String id) {
        ...
        String dataMaskingPolicyNameLocal = Utils.getValueFromIdByName(id, "dataMaskingPolicies");
            ...
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException(
                        String
                            .format(
                                "The resource ID '%s' is not valid. Missing path segment 'dataMaskingPolicies'.", id)));
        }
