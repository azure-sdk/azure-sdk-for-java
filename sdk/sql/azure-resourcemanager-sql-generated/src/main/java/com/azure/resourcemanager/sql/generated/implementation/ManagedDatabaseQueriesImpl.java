...
public final class ManagedDatabaseQueriesImpl implements ManagedDatabaseQueries {
    ...
    public ManagedDatabaseQueriesImpl(ManagedDatabaseQueriesClient innerClient,
        com.azure.resourcemanager.sql.generated.SqlManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public Response<ManagedInstanceQuery> getWithResponse(String resourceGroupName, String managedInstanceName,
        String databaseName, String queryId, Context context) {
        Response<ManagedInstanceQueryInner> inner = this.serviceClient().getWithResponse(resourceGroupName,
            managedInstanceName, databaseName, queryId, context);
        if (inner != null) {
    ...
    public ManagedInstanceQuery get(String resourceGroupName, String managedInstanceName, String databaseName,
        String queryId) {
    ...
    public PagedIterable<QueryStatistics> listByQuery(String resourceGroupName, String managedInstanceName,
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new QueryStatisticsImpl(inner1, this.manager()));
    }

    public PagedIterable<QueryStatistics> listByQuery(String resourceGroupName, String managedInstanceName,
        String databaseName, String queryId, String startTime, String endTime, QueryTimeGrainType interval,
        Context context) {
        PagedIterable<QueryStatisticsInner> inner = this.serviceClient().listByQuery(resourceGroupName,
            managedInstanceName, databaseName, queryId, startTime, endTime, interval, context);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new QueryStatisticsImpl(inner1, this.manager()));
    }
