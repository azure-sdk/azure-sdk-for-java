...
public final class SyncMemberImpl implements SyncMember, SyncMember.Definition, SyncMember.Update {
    ...
    public SyncMemberImpl withExistingSyncGroup(String resourceGroupName, String serverName, String databaseName,
    ...
    public SyncMember create() {
        this.innerObject = serviceManager.serviceClient().getSyncMembers().createOrUpdate(resourceGroupName, serverName,
            databaseName, syncGroupName, syncMemberName, this.innerModel(), Context.NONE);
        return this;
    }

    public SyncMember create(Context context) {
        this.innerObject = serviceManager.serviceClient().getSyncMembers().createOrUpdate(resourceGroupName, serverName,
            databaseName, syncGroupName, syncMemberName, this.innerModel(), context);
        return this;
    }

    SyncMemberImpl(String name, com.azure.resourcemanager.sql.generated.SqlManager serviceManager) {
    ...
    public SyncMember apply() {
        this.innerObject = serviceManager.serviceClient().getSyncMembers().update(resourceGroupName, serverName,
            databaseName, syncGroupName, syncMemberName, this.innerModel(), Context.NONE);
        return this;
    }
    ...
    SyncMemberImpl(SyncMemberInner innerObject, com.azure.resourcemanager.sql.generated.SqlManager serviceManager) {
        ...
        this.syncMemberName = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "syncMembers");
    }

    public SyncMember refresh() {
        this.innerObject = serviceManager.serviceClient().getSyncMembers()
    ...
    public void refreshMemberSchema() {
        serviceManager.syncMembers().refreshMemberSchema(resourceGroupName, serverName, databaseName, syncGroupName,
            syncMemberName);
    }

    public void refreshMemberSchema(Context context) {
        serviceManager.syncMembers().refreshMemberSchema(resourceGroupName, serverName, databaseName, syncGroupName,
