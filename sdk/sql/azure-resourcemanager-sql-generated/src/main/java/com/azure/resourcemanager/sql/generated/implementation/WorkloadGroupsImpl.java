...
public final class WorkloadGroupsImpl implements WorkloadGroups {
    ...
    public WorkloadGroupsImpl(WorkloadGroupsClient innerClient,
        com.azure.resourcemanager.sql.generated.SqlManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public PagedIterable<WorkloadGroup> listByDatabase(String resourceGroupName, String serverName,
        String databaseName) {
        PagedIterable<WorkloadGroupInner> inner
            = this.serviceClient().listByDatabase(resourceGroupName, serverName, databaseName);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new WorkloadGroupImpl(inner1, this.manager()));
    }

    public PagedIterable<WorkloadGroup> listByDatabase(String resourceGroupName, String serverName, String databaseName,
        Context context) {
        PagedIterable<WorkloadGroupInner> inner
    ...
    public Response<WorkloadGroup> getWithResponse(String resourceGroupName, String serverName, String databaseName,
        String workloadGroupName, Context context) {
        Response<WorkloadGroupInner> inner = this.serviceClient().getWithResponse(resourceGroupName, serverName,
            databaseName, workloadGroupName, context);
        if (inner != null) {
    ...
    public WorkloadGroup get(String resourceGroupName, String serverName, String databaseName,
    ...
    public WorkloadGroup getById(String id) {
        ...
        return this.getWithResponse(resourceGroupName, serverName, databaseName, workloadGroupName, Context.NONE)
            .getValue();
    }
