...
public final class ManagedInstanceDtcsClientImpl implements ManagedInstanceDtcsClient {
    ...
    ManagedInstanceDtcsClientImpl(SqlManagementClientImpl client) {
        this.service =
            RestProxy.create(ManagedInstanceDtcsService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }
    ...
    private interface ManagedInstanceDtcsService {
        @Headers({"Content-Type: application/json"})
        @Get(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql"
                + "/managedInstances/{managedInstanceName}/dtc")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ManagedInstanceDtcListResult>> listByManagedInstance(
        ...
        @Get(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql"
                + "/managedInstances/{managedInstanceName}/dtc/{dtcName}")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ManagedInstanceDtcInner>> get(
            @HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("managedInstanceName") String managedInstanceName,
            @PathParam("dtcName") DtcName dtcName,
            @PathParam("subscriptionId") String subscriptionId,
            @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept,
            Context context);
        ...
        Mono<Response<Flux<ByteBuffer>>> createOrUpdate(
            ...
            @PathParam("subscriptionId") String subscriptionId,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") ManagedInstanceDtcInner parameters,
            @HeaderParam("Accept") String accept,
            Context context);
    ...
    private Mono<PagedResponse<ManagedInstanceDtcInner>> listByManagedInstanceSinglePageAsync(
                ...
                context ->
                    service
                        .listByManagedInstance(
                            ...
                            accept,
                            context))
            .<PagedResponse<ManagedInstanceDtcInner>>map(
                res ->
    ...
    private PagedFlux<ManagedInstanceDtcInner> listByManagedInstanceAsync(
        String resourceGroupName, String managedInstanceName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<ManagedInstanceDtcInner> listByManagedInstance(
        String resourceGroupName, String managedInstanceName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ManagedInstanceDtcInner>> getWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ManagedInstanceDtcInner> getAsync(
        String resourceGroupName, String managedInstanceName, DtcName dtcName) {
    ...
    public ManagedInstanceDtcInner get(String resourceGroupName, String managedInstanceName, DtcName dtcName) {
        return getAsync(resourceGroupName, managedInstanceName, dtcName).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ManagedInstanceDtcInner> getWithResponse(
        String resourceGroupName, String managedInstanceName, DtcName dtcName, Context context) {
    ...
    private PollerFlux<PollResult<ManagedInstanceDtcInner>, ManagedInstanceDtcInner> beginCreateOrUpdateAsync(
        ...
        return this
            .client
            .<ManagedInstanceDtcInner, ManagedInstanceDtcInner>getLroResult(
                mono,
    ...
    public SyncPoller<PollResult<ManagedInstanceDtcInner>, ManagedInstanceDtcInner> beginCreateOrUpdate(
        String resourceGroupName, String managedInstanceName, DtcName dtcName, ManagedInstanceDtcInner parameters) {
        return beginCreateOrUpdateAsync(resourceGroupName, managedInstanceName, dtcName, parameters).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<ManagedInstanceDtcInner>, ManagedInstanceDtcInner> beginCreateOrUpdate(
        ...
        ManagedInstanceDtcInner parameters,
        Context context) {
        return beginCreateOrUpdateAsync(resourceGroupName, managedInstanceName, dtcName, parameters, context)
            .getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ManagedInstanceDtcInner> createOrUpdateAsync(
        String resourceGroupName, String managedInstanceName, DtcName dtcName, ManagedInstanceDtcInner parameters) {
        return beginCreateOrUpdateAsync(resourceGroupName, managedInstanceName, dtcName, parameters)
            .last()
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ManagedInstanceDtcInner createOrUpdate(
        String resourceGroupName, String managedInstanceName, DtcName dtcName, ManagedInstanceDtcInner parameters) {
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a list of managed instance's DTCs along with {@link PagedResponse} on successful completion of {@link
     *     Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<ManagedInstanceDtcInner>> listByManagedInstanceNextSinglePageAsync(
