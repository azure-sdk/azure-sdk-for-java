...
public final class DistributedAvailabilityGroupImpl implements DistributedAvailabilityGroup,
    ...
    public DistributedAvailabilityGroup failover(DistributedAvailabilityGroupsFailoverRequest parameters) {
        return serviceManager.distributedAvailabilityGroups().failover(resourceGroupName, managedInstanceName,
    ...
    public DistributedAvailabilityGroup setRole(DistributedAvailabilityGroupSetRole parameters) {
        return serviceManager.distributedAvailabilityGroups().setRole(resourceGroupName, managedInstanceName,
            distributedAvailabilityGroupName, parameters);
    }
