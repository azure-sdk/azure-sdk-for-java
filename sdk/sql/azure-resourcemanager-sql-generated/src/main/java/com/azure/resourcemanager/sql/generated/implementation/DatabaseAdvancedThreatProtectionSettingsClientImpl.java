...
public final class DatabaseAdvancedThreatProtectionSettingsClientImpl
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DatabaseAdvancedThreatProtectionInner> getAsync(String resourceGroupName, String serverName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DatabaseAdvancedThreatProtectionInner> createOrUpdateAsync(String resourceGroupName, String serverName,
        String databaseName, AdvancedThreatProtectionName advancedThreatProtectionName,
