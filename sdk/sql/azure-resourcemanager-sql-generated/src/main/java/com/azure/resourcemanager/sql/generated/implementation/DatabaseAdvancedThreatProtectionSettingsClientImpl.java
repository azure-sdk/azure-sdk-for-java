...
import com.azure.resourcemanager.sql.generated.models.DatabaseAdvancedThreatProtectionListResult;
...
public final class DatabaseAdvancedThreatProtectionSettingsClientImpl
    ...
    DatabaseAdvancedThreatProtectionSettingsClientImpl(SqlManagementClientImpl client) {
        this.service =
            RestProxy
                .create(
                    DatabaseAdvancedThreatProtectionSettingsService.class,
    ...
    private PagedFlux<DatabaseAdvancedThreatProtectionInner> listByDatabaseAsync(
        String resourceGroupName, String serverName, String databaseName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<DatabaseAdvancedThreatProtectionInner> listByDatabase(
        String resourceGroupName, String serverName, String databaseName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<DatabaseAdvancedThreatProtectionInner>> getWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DatabaseAdvancedThreatProtectionInner> getAsync(
        String resourceGroupName,
        String serverName,
        String databaseName,
        AdvancedThreatProtectionName advancedThreatProtectionName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<DatabaseAdvancedThreatProtectionInner> getWithResponse(
        String resourceGroupName,
        String serverName,
        String databaseName,
        AdvancedThreatProtectionName advancedThreatProtectionName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public DatabaseAdvancedThreatProtectionInner get(
        String resourceGroupName,
        String serverName,
        String databaseName,
        AdvancedThreatProtectionName advancedThreatProtectionName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DatabaseAdvancedThreatProtectionInner> createOrUpdateAsync(
        String resourceGroupName,
        String serverName,
        String databaseName,
        AdvancedThreatProtectionName advancedThreatProtectionName,
        ...
        return createOrUpdateWithResponseAsync(
                resourceGroupName, serverName, databaseName, advancedThreatProtectionName, parameters)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<DatabaseAdvancedThreatProtectionInner> createOrUpdateWithResponse(
        String resourceGroupName,
        String serverName,
        String databaseName,
        AdvancedThreatProtectionName advancedThreatProtectionName,
        ...
        Context context) {
        return createOrUpdateWithResponseAsync(
                resourceGroupName, serverName, databaseName, advancedThreatProtectionName, parameters, context)
            .block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public DatabaseAdvancedThreatProtectionInner createOrUpdate(
        String resourceGroupName,
        String serverName,
        String databaseName,
        AdvancedThreatProtectionName advancedThreatProtectionName,
        ...
        return createOrUpdateWithResponse(
                resourceGroupName, serverName, databaseName, advancedThreatProtectionName, parameters, Context.NONE)
            .getValue();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<DatabaseAdvancedThreatProtectionInner>> listByDatabaseNextSinglePageAsync(
        String nextLink) {
        if (nextLink == null) {
