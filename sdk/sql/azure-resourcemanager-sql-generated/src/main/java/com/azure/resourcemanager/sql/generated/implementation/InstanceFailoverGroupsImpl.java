...
public final class InstanceFailoverGroupsImpl implements InstanceFailoverGroups {
    ...
    public InstanceFailoverGroupsImpl(InstanceFailoverGroupsClient innerClient,
    ...
    public PagedIterable<InstanceFailoverGroup> listByLocation(String resourceGroupName, String locationName) {
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new InstanceFailoverGroupImpl(inner1, this.manager()));
    }
    ...
    public Response<InstanceFailoverGroup> getWithResponse(String resourceGroupName, String locationName,
    ...
    public InstanceFailoverGroup forceFailoverAllowDataLoss(String resourceGroupName, String locationName,
    ...
    public InstanceFailoverGroup forceFailoverAllowDataLoss(String resourceGroupName, String locationName,
        String failoverGroupName, Context context) {
        InstanceFailoverGroupInner inner = this.serviceClient().forceFailoverAllowDataLoss(resourceGroupName,
            locationName, failoverGroupName, context);
        if (inner != null) {
            return new InstanceFailoverGroupImpl(inner, this.manager());
        } else {
            return null;
    ...
    public InstanceFailoverGroup getById(String id) {
        ...
        String locationName = ResourceManagerUtils.getValueFromIdByName(id, "locations");
        if (locationName == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
                String.format("The resource ID '%s' is not valid. Missing path segment 'locations'.", id)));
        }
        String failoverGroupName = ResourceManagerUtils.getValueFromIdByName(id, "instanceFailoverGroups");
        if (failoverGroupName == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(String
                .format("The resource ID '%s' is not valid. Missing path segment 'instanceFailoverGroups'.", id)));
        }
