...
public final class ServerKeyImpl implements ServerKey, ServerKey.Definition, ServerKey.Update {
    ...
    public ServerKey create() {
        this.innerObject = serviceManager.serviceClient().getServerKeys().createOrUpdate(resourceGroupName, serverName,
            keyName, this.innerModel(), Context.NONE);
        return this;
    }

    public ServerKey create(Context context) {
        this.innerObject = serviceManager.serviceClient().getServerKeys().createOrUpdate(resourceGroupName, serverName,
            keyName, this.innerModel(), context);
        return this;
    }
