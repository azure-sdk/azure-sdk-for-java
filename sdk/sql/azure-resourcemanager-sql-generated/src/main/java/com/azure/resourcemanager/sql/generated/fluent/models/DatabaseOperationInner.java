...
public final class DatabaseOperationInner extends ProxyResource {
    ...
    /**
     * Get the phaseCode property: The operation phase code.
     *
     * @return the phaseCode value.
     */
    public Integer phaseCode() {
        return this.innerProperties() == null ? null : this.innerProperties().phaseCode();
    }

    /**
     * Get the phaseDescription property: The operation phase description.
     *
     * @return the phaseDescription value.
     */
    public String phaseDescription() {
        return this.innerProperties() == null ? null : this.innerProperties().phaseDescription();
    }
    ...
    public Map<String, String> phaseInformation() {
        return this.innerProperties() == null ? null : this.innerProperties().phaseInformation();
    }
