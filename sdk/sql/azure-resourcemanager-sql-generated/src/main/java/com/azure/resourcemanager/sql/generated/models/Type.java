...
public final class Type extends ExpandableStringEnum<Type> {
    /** Static value SystemDefined for Type. */
    public static final Type SYSTEM_DEFINED = fromString("SystemDefined");

    /** Static value CustomerDefined for Type. */
    public static final Type CUSTOMER_DEFINED = fromString("CustomerDefined");
