...
public final class DatabaseSchemasClientImpl implements DatabaseSchemasClient {
    ...
    /**
     * The interface defining all the services for SqlManagementClientDatabaseSchemas to be used by the proxy service
    ...
    private Mono<Response<DatabaseSchemaInner>> getWithResponseAsync(String resourceGroupName, String serverName,
        ...
        return FluxUtil
            .withContext(context -> service.get(this.client.getEndpoint(), resourceGroupName, serverName, databaseName,
                schemaName, this.client.getSubscriptionId(), this.client.getApiVersion(), accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DatabaseSchemaInner> getAsync(String resourceGroupName, String serverName, String databaseName,
        String schemaName) {
