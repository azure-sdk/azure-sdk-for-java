...
public final class DatabaseSchemasClientImpl implements DatabaseSchemasClient {
    ...
    private interface DatabaseSchemasService {
        ...
        @Get(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers"
                + "/{serverName}/databases/{databaseName}/schemas")
        ...
        @Get(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers"
                + "/{serverName}/databases/{databaseName}/schemas/{schemaName}")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
    ...
    public DatabaseSchemaInner get(
        String resourceGroupName, String serverName, String databaseName, String schemaName) {
        return getAsync(resourceGroupName, serverName, databaseName, schemaName).block();
    }
