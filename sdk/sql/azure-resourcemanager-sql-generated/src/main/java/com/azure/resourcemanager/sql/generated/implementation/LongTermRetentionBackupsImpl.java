...
public final class LongTermRetentionBackupsImpl implements LongTermRetentionBackups {
    ...
    public LongTermRetentionBackupsImpl(LongTermRetentionBackupsClient innerClient,
    ...
    public PagedIterable<LongTermRetentionBackup> listByLocation(String locationName) {
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new LongTermRetentionBackupImpl(inner1, this.manager()));
    }

    public PagedIterable<LongTermRetentionBackup> listByLocation(String locationName, Boolean onlyLatestPerDatabase,
    ...
    public PagedIterable<LongTermRetentionBackup> listByServer(String locationName,
    ...
    public PagedIterable<LongTermRetentionBackup> listByServer(String locationName, String longTermRetentionServerName,
        Boolean onlyLatestPerDatabase, DatabaseState databaseState, Context context) {
        PagedIterable<LongTermRetentionBackupInner> inner = this.serviceClient().listByServer(locationName,
            longTermRetentionServerName, onlyLatestPerDatabase, databaseState, context);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new LongTermRetentionBackupImpl(inner1, this.manager()));
    }

    public PagedIterable<LongTermRetentionBackup> listByDatabase(String locationName,
        String longTermRetentionServerName, String longTermRetentionDatabaseName) {
        PagedIterable<LongTermRetentionBackupInner> inner = this.serviceClient().listByDatabase(locationName,
    ...
    public Response<LongTermRetentionBackup> getWithResponse(String locationName, String longTermRetentionServerName,
        String longTermRetentionDatabaseName, String backupName, Context context) {
        Response<LongTermRetentionBackupInner> inner = this.serviceClient().getWithResponse(locationName,
    ...
    public LongTermRetentionBackup get(String locationName, String longTermRetentionServerName,
        String longTermRetentionDatabaseName, String backupName) {
        LongTermRetentionBackupInner inner = this.serviceClient().get(locationName, longTermRetentionServerName,
    ...
    public void delete(String locationName, String longTermRetentionServerName, String longTermRetentionDatabaseName,
        String backupName) {
        this.serviceClient().delete(locationName, longTermRetentionServerName, longTermRetentionDatabaseName,
            backupName);
    }
    ...
    public LongTermRetentionBackup changeAccessTier(String locationName, String longTermRetentionServerName,
        String longTermRetentionDatabaseName, String backupName,
        ChangeLongTermRetentionBackupAccessTierParameters parameters) {
        LongTermRetentionBackupInner inner = this.serviceClient().changeAccessTier(locationName,
    ...
    public LongTermRetentionBackupOperationResult copy(String locationName, String longTermRetentionServerName,
        String longTermRetentionDatabaseName, String backupName, CopyLongTermRetentionBackupParameters parameters) {
        LongTermRetentionBackupOperationResultInner inner = this.serviceClient().copy(locationName,
            longTermRetentionServerName, longTermRetentionDatabaseName, backupName, parameters);
        if (inner != null) {
    ...
    public LongTermRetentionBackupOperationResult update(String locationName, String longTermRetentionServerName,
        String longTermRetentionDatabaseName, String backupName, UpdateLongTermRetentionBackupParameters parameters) {
        LongTermRetentionBackupOperationResultInner inner = this.serviceClient().update(locationName,
            longTermRetentionServerName, longTermRetentionDatabaseName, backupName, parameters);
        if (inner != null) {
            return new LongTermRetentionBackupOperationResultImpl(inner, this.manager());
        } else {
    ...
    public PagedIterable<LongTermRetentionBackup> listByResourceGroupLocation(String resourceGroupName,
        String locationName) {
        PagedIterable<LongTermRetentionBackupInner> inner
    ...
    public PagedIterable<LongTermRetentionBackup> listByResourceGroupLocation(String resourceGroupName,
        ...
        PagedIterable<LongTermRetentionBackupInner> inner = this.serviceClient().listByResourceGroupLocation(
            resourceGroupName, locationName, onlyLatestPerDatabase, databaseState, context);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new LongTermRetentionBackupImpl(inner1, this.manager()));
    }

    public PagedIterable<LongTermRetentionBackup> listByResourceGroupServer(String resourceGroupName,
        String locationName, String longTermRetentionServerName) {
        PagedIterable<LongTermRetentionBackupInner> inner = this.serviceClient()
    ...
    public PagedIterable<LongTermRetentionBackup> listByResourceGroupServer(String resourceGroupName,
        ...
        DatabaseState databaseState, Context context) {
        PagedIterable<LongTermRetentionBackupInner> inner
            = this.serviceClient().listByResourceGroupServer(resourceGroupName, locationName,
                longTermRetentionServerName, onlyLatestPerDatabase, databaseState, context);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new LongTermRetentionBackupImpl(inner1, this.manager()));
    }

    public PagedIterable<LongTermRetentionBackup> listByResourceGroupDatabase(String resourceGroupName,
        String locationName, String longTermRetentionServerName, String longTermRetentionDatabaseName) {
        PagedIterable<LongTermRetentionBackupInner> inner = this.serviceClient().listByResourceGroupDatabase(
    ...
    public Response<LongTermRetentionBackup> getByResourceGroupWithResponse(String resourceGroupName,
        String locationName, String longTermRetentionServerName, String longTermRetentionDatabaseName,
        String backupName, Context context) {
        Response<LongTermRetentionBackupInner> inner
            = this.serviceClient().getByResourceGroupWithResponse(resourceGroupName, locationName,
                longTermRetentionServerName, longTermRetentionDatabaseName, backupName, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
                new LongTermRetentionBackupImpl(inner.getValue(), this.manager()));
    ...
    public LongTermRetentionBackup getByResourceGroup(String resourceGroupName, String locationName,
        String longTermRetentionServerName, String longTermRetentionDatabaseName, String backupName) {
        LongTermRetentionBackupInner inner = this.serviceClient().getByResourceGroup(resourceGroupName, locationName,
    ...
    public void deleteByResourceGroup(String resourceGroupName, String locationName, String longTermRetentionServerName,
        String longTermRetentionDatabaseName, String backupName) {
        this.serviceClient().deleteByResourceGroup(resourceGroupName, locationName, longTermRetentionServerName,
            longTermRetentionDatabaseName, backupName);
    }
    ...
    public LongTermRetentionBackup changeAccessTierByResourceGroup(String resourceGroupName, String locationName,
        String longTermRetentionServerName, String longTermRetentionDatabaseName, String backupName,
        ChangeLongTermRetentionBackupAccessTierParameters parameters) {
        LongTermRetentionBackupInner inner = this.serviceClient().changeAccessTierByResourceGroup(resourceGroupName,
    ...
    public LongTermRetentionBackupOperationResult copyByResourceGroup(String resourceGroupName, String locationName,
        String longTermRetentionServerName, String longTermRetentionDatabaseName, String backupName,
        CopyLongTermRetentionBackupParameters parameters) {
        LongTermRetentionBackupOperationResultInner inner = this.serviceClient().copyByResourceGroup(resourceGroupName,
            locationName, longTermRetentionServerName, longTermRetentionDatabaseName, backupName, parameters);
        if (inner != null) {
            return new LongTermRetentionBackupOperationResultImpl(inner, this.manager());
        } else {
    ...
    public LongTermRetentionBackupOperationResult updateByResourceGroup(String resourceGroupName, String locationName,
        String longTermRetentionServerName, String longTermRetentionDatabaseName, String backupName,
        UpdateLongTermRetentionBackupParameters parameters) {
        LongTermRetentionBackupOperationResultInner inner
            = this.serviceClient().updateByResourceGroup(resourceGroupName, locationName, longTermRetentionServerName,
