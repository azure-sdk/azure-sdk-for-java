...
public interface ServerBlobAuditingPolicy {
    ...
    /**
     * Gets the inner com.azure.resourcemanager.sql.generated.fluent.models.ServerBlobAuditingPolicyInner object.
     *
    ...
    interface DefinitionStages {
        ...
        /** The stage of the ServerBlobAuditingPolicy definition allowing to specify isDevopsAuditEnabled. */
        ...
        /** The stage of the ServerBlobAuditingPolicy definition allowing to specify isManagedIdentityInUse. */
    ...
    interface UpdateStages {
        /** The stage of the ServerBlobAuditingPolicy update allowing to specify isDevopsAuditEnabled. */
        interface WithIsDevopsAuditEnabled {
            /**
             * Specifies the isDevopsAuditEnabled property: Specifies the state of devops audit. If state is Enabled,
             * devops logs will be sent to Azure Monitor. In order to send the events to Azure Monitor, specify 'State'
        ...
        /** The stage of the ServerBlobAuditingPolicy update allowing to specify isManagedIdentityInUse. */
        interface WithIsManagedIdentityInUse {
            /**
             * Specifies the isManagedIdentityInUse property: Specifies whether Managed Identity is used to access blob
             * storage.
