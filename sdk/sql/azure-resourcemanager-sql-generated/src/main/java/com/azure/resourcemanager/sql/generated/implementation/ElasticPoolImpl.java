...
public final class ElasticPoolImpl implements ElasticPool, ElasticPool.Definition, ElasticPool.Update {
    ...
    public ElasticPool create() {
        this.innerObject = serviceManager.serviceClient().getElasticPools().createOrUpdate(resourceGroupName,
            serverName, elasticPoolName, this.innerModel(), Context.NONE);
        return this;
    }

    public ElasticPool create(Context context) {
        this.innerObject = serviceManager.serviceClient().getElasticPools().createOrUpdate(resourceGroupName,
            serverName, elasticPoolName, this.innerModel(), context);
        return this;
    }

    ElasticPoolImpl(String name, com.azure.resourcemanager.sql.generated.SqlManager serviceManager) {
    ...
    public ElasticPool apply() {
        this.innerObject = serviceManager.serviceClient().getElasticPools().update(resourceGroupName, serverName,
            elasticPoolName, updateParameters, Context.NONE);
        return this;
    }

    public ElasticPool apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getElasticPools().update(resourceGroupName, serverName,
            elasticPoolName, updateParameters, context);
        return this;
    }

    ElasticPoolImpl(ElasticPoolInner innerObject, com.azure.resourcemanager.sql.generated.SqlManager serviceManager) {
        this.innerObject = innerObject;
        this.serviceManager = serviceManager;
        this.resourceGroupName = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "resourceGroups");
        this.serverName = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "servers");
        this.elasticPoolName = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "elasticPools");
    }

    public ElasticPool refresh() {
        this.innerObject = serviceManager.serviceClient().getElasticPools()
            .getWithResponse(resourceGroupName, serverName, elasticPoolName, Context.NONE).getValue();
        return this;
    }

    public ElasticPool refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getElasticPools()
            .getWithResponse(resourceGroupName, serverName, elasticPoolName, context).getValue();
        return this;
    }
    ...
    public ElasticPoolImpl withMinCapacity(Double minCapacity) {
        if (isInCreateMode()) {
    ...
    public ElasticPoolImpl withHighAvailabilityReplicaCount(Integer highAvailabilityReplicaCount) {
        if (isInCreateMode()) {
    ...
    public ElasticPoolImpl withAutoPauseDelay(Integer autoPauseDelay) {
        if (isInCreateMode()) {
    ...
    public ElasticPoolImpl withPreferredEnclaveType(AlwaysEncryptedEnclaveType preferredEnclaveType) {
        if (isInCreateMode()) {
    ...
    public ElasticPoolImpl withAvailabilityZone(AvailabilityZoneType availabilityZone) {
        if (isInCreateMode()) {
