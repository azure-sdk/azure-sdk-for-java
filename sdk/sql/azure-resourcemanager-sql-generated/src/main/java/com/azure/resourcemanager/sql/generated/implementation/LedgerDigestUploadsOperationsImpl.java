...
public final class LedgerDigestUploadsOperationsImpl implements LedgerDigestUploadsOperations {
    ...
    public LedgerDigestUploadsOperationsImpl(LedgerDigestUploadsOperationsClient innerClient,
        com.azure.resourcemanager.sql.generated.SqlManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public PagedIterable<LedgerDigestUploads> listByDatabase(String resourceGroupName, String serverName,
        String databaseName) {
        PagedIterable<LedgerDigestUploadsInner> inner
            = this.serviceClient().listByDatabase(resourceGroupName, serverName, databaseName);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new LedgerDigestUploadsImpl(inner1, this.manager()));
    }
    ...
    public Response<LedgerDigestUploads> getWithResponse(String resourceGroupName, String serverName,
        String databaseName, LedgerDigestUploadsName ledgerDigestUploads, Context context) {
        Response<LedgerDigestUploadsInner> inner = this.serviceClient().getWithResponse(resourceGroupName, serverName,
    ...
    public LedgerDigestUploads get(String resourceGroupName, String serverName, String databaseName,
    ...
    public LedgerDigestUploads disable(String resourceGroupName, String serverName, String databaseName,
        LedgerDigestUploadsName ledgerDigestUploads) {
        LedgerDigestUploadsInner inner
    ...
    public LedgerDigestUploads getById(String id) {
        ...
        String ledgerDigestUploadsLocal = ResourceManagerUtils.getValueFromIdByName(id, "ledgerDigestUploads");
        ...
        return this.getWithResponse(resourceGroupName, serverName, databaseName, ledgerDigestUploads, Context.NONE)
            .getValue();
    }
