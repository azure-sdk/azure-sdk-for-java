...
/** An immutable client-side representation of ExtendedDatabaseBlobAuditingPolicy. */
public interface ExtendedDatabaseBlobAuditingPolicy {
    /**
    ...
    /**
     * Gets the predicateExpression property: Specifies condition of where clause when creating an audit.
     *
    ...
    /**
     * Gets the isManagedIdentityInUse property: Specifies whether Managed Identity is used to access blob storage.
     *
     * @return the isManagedIdentityInUse value.
     */
    Boolean isManagedIdentityInUse();
    ...
    /**
     * Gets the inner com.azure.resourcemanager.sql.generated.fluent.models.ExtendedDatabaseBlobAuditingPolicyInner
     * object.
     *
     * @return the inner object.
     */
    ExtendedDatabaseBlobAuditingPolicyInner innerModel();

    /** The entirety of the ExtendedDatabaseBlobAuditingPolicy definition. */
    interface Definition
        extends DefinitionStages.Blank, DefinitionStages.WithParentResource, DefinitionStages.WithCreate {
    }
    /** The ExtendedDatabaseBlobAuditingPolicy definition stages. */
    interface DefinitionStages {
        /** The first stage of the ExtendedDatabaseBlobAuditingPolicy definition. */
        interface Blank extends WithParentResource {
        }
        /** The stage of the ExtendedDatabaseBlobAuditingPolicy definition allowing to specify parent resource. */
        ...
        /**
         * The stage of the ExtendedDatabaseBlobAuditingPolicy definition which contains all the minimum required
         * properties for the resource to be created, but also allows for any other optional properties to be specified.
         */
        interface WithCreate
            extends DefinitionStages.WithPredicateExpression,
                ...
                DefinitionStages.WithIsManagedIdentityInUse,
             ...
             */
            ExtendedDatabaseBlobAuditingPolicy create();
             ...
             * @return the created resource.
             */
            ExtendedDatabaseBlobAuditingPolicy create(Context context);
        }
        /** The stage of the ExtendedDatabaseBlobAuditingPolicy definition allowing to specify predicateExpression. */
        ...
        /** The stage of the ExtendedDatabaseBlobAuditingPolicy definition allowing to specify auditActionsAndGroups. */
        interface WithAuditActionsAndGroups {
             ...
             * BATCH_COMPLETED_GROUP DBCC_GROUP DATABASE_OWNERSHIP_CHANGE_GROUP DATABASE_CHANGE_GROUP
        ...
        /**
         * The stage of the ExtendedDatabaseBlobAuditingPolicy definition allowing to specify
        ...
        /**
         * The stage of the ExtendedDatabaseBlobAuditingPolicy definition allowing to specify isManagedIdentityInUse.
         */
        interface WithIsManagedIdentityInUse {
            /**
             * Specifies the isManagedIdentityInUse property: Specifies whether Managed Identity is used to access blob
             * storage.
             *
             * @param isManagedIdentityInUse Specifies whether Managed Identity is used to access blob storage.
             * @return the next definition stage.
             */
            WithCreate withIsManagedIdentityInUse(Boolean isManagedIdentityInUse);
        }
        /** The stage of the ExtendedDatabaseBlobAuditingPolicy definition allowing to specify state. */
        interface WithState {
            /**
        ...
        /** The stage of the ExtendedDatabaseBlobAuditingPolicy definition allowing to specify storageEndpoint. */
        ...
        /**
         * The stage of the ExtendedDatabaseBlobAuditingPolicy definition allowing to specify storageAccountAccessKey.
         */
    ...
    /**
     * Begins update for the ExtendedDatabaseBlobAuditingPolicy resource.
     *
     * @return the stage of resource update.
     */
    ExtendedDatabaseBlobAuditingPolicy.Update update();

    /** The template for ExtendedDatabaseBlobAuditingPolicy update. */
    interface Update
        extends UpdateStages.WithPredicateExpression,
            ...
            UpdateStages.WithIsManagedIdentityInUse,
         ...
         */
        ExtendedDatabaseBlobAuditingPolicy apply();
         ...
         * @return the updated resource.
         */
        ExtendedDatabaseBlobAuditingPolicy apply(Context context);
    }
    /** The ExtendedDatabaseBlobAuditingPolicy update stages. */
    interface UpdateStages {
        /** The stage of the ExtendedDatabaseBlobAuditingPolicy update allowing to specify predicateExpression. */
        interface WithPredicateExpression {
            /**
             * Specifies the predicateExpression property: Specifies condition of where clause when creating an audit..
             *
        ...
        /** The stage of the ExtendedDatabaseBlobAuditingPolicy update allowing to specify auditActionsAndGroups. */
        interface WithAuditActionsAndGroups {
            /**
             * Specifies the auditActionsAndGroups property: Specifies the Actions-Groups and Actions to audit.
             *
        ...
        /**
         * The stage of the ExtendedDatabaseBlobAuditingPolicy update allowing to specify isStorageSecondaryKeyInUse.
         */
        interface WithIsStorageSecondaryKeyInUse {
            /**
             * Specifies the isStorageSecondaryKeyInUse property: Specifies whether storageAccountAccessKey value is the
        ...
        /**
         * The stage of the ExtendedDatabaseBlobAuditingPolicy update allowing to specify isAzureMonitorTargetEnabled.
         */
        interface WithIsAzureMonitorTargetEnabled {
            /**
             * Specifies the isAzureMonitorTargetEnabled property: Specifies whether audit events are sent to Azure
        ...
        /** The stage of the ExtendedDatabaseBlobAuditingPolicy update allowing to specify isManagedIdentityInUse. */
        interface WithIsManagedIdentityInUse {
            /**
             * Specifies the isManagedIdentityInUse property: Specifies whether Managed Identity is used to access blob
             * storage.
             ...
             * @return the next definition stage.
             */
            Update withIsManagedIdentityInUse(Boolean isManagedIdentityInUse);
        }
        /** The stage of the ExtendedDatabaseBlobAuditingPolicy update allowing to specify state. */
        interface WithState {
            /**
             * Specifies the state property: Specifies the state of the audit. If state is Enabled, storageEndpoint or
             * isAzureMonitorTargetEnabled are required..
        ...
        /** The stage of the ExtendedDatabaseBlobAuditingPolicy update allowing to specify storageEndpoint. */
        interface WithStorageEndpoint {
            /**
             * Specifies the storageEndpoint property: Specifies the blob storage endpoint (e.g.
             * https://MyAccount.blob.core.windows.net). If state is Enabled, storageEndpoint or
        ...
        /** The stage of the ExtendedDatabaseBlobAuditingPolicy update allowing to specify storageAccountAccessKey. */
        interface WithStorageAccountAccessKey {
            /**
             * Specifies the storageAccountAccessKey property: Specifies the identifier key of the auditing storage
             * account. If state is Enabled and storageEndpoint is specified, not specifying the storageAccountAccessKey
        ...
        /**
         * The stage of the ExtendedDatabaseBlobAuditingPolicy update allowing to specify storageAccountSubscriptionId.
         */
        interface WithStorageAccountSubscriptionId {
            /**
             * Specifies the storageAccountSubscriptionId property: Specifies the blob storage subscription Id..
     ...
     */
    ExtendedDatabaseBlobAuditingPolicy refresh();
     ...
     * @return the refreshed resource.
     */
    ExtendedDatabaseBlobAuditingPolicy refresh(Context context);
}
