...
public interface JobStepExecutionsClient {
    ...
    PagedIterable<JobExecutionAutoGeneratedInner> listByJobExecution(
    ...
    Response<JobExecutionAutoGeneratedInner> getWithResponse(
        String resourceGroupName,
        String serverName,
        String jobAgentName,
        String jobName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    JobExecutionAutoGeneratedInner get(
        String resourceGroupName,
        String serverName,
        String jobAgentName,
        String jobName,
