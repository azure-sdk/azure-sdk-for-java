...
public interface JobTargetExecutions {
     ...
     */
    PagedIterable<JobExecutionAutoGenerated2> listByStep(
     ...
     */
    Response<JobExecutionAutoGenerated2> getWithResponse(
        String resourceGroupName,
        String serverName,
        String jobAgentName,
        String jobName,
     ...
     */
    JobExecutionAutoGenerated2 get(
        String resourceGroupName,
        String serverName,
        String jobAgentName,
        String jobName,
     ...
     * @return a list of job executions as paginated response with {@link PagedIterable}.
     */
    PagedIterable<JobExecutionAutoGenerated2> listByJobExecution(
