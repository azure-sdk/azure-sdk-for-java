...
public final class ServerDevOpsAuditSettingsImpl implements ServerDevOpsAuditSettings {
    ...
    public ServerDevOpsAuditSettingsImpl(ServerDevOpsAuditSettingsClient innerClient,
    ...
    public PagedIterable<ServerDevOpsAuditingSettings> listByServer(String resourceGroupName, String serverName) {
        ...
        return ResourceManagerUtils.mapPage(inner,
            inner1 -> new ServerDevOpsAuditingSettingsImpl(inner1, this.manager()));
    }
    ...
    public Response<ServerDevOpsAuditingSettings> getWithResponse(String resourceGroupName, String serverName,
    ...
    public ServerDevOpsAuditingSettings get(String resourceGroupName, String serverName,
    ...
    public ServerDevOpsAuditingSettings getById(String id) {
        ...
        String devOpsAuditingSettingsNameLocal
            = ResourceManagerUtils.getValueFromIdByName(id, "devOpsAuditingSettings");
        if (devOpsAuditingSettingsNameLocal == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(String
                .format("The resource ID '%s' is not valid. Missing path segment 'devOpsAuditingSettings'.", id)));
        }
        DevOpsAuditingSettingsName devOpsAuditingSettingsName
            = DevOpsAuditingSettingsName.fromString(devOpsAuditingSettingsNameLocal);
    ...
    public ServerDevOpsAuditingSettingsImpl define(DevOpsAuditingSettingsName name) {
