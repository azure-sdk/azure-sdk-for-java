...
import com.azure.resourcemanager.sql.generated.models.ManagedServerDnsAliasListResult;
...
public final class ManagedServerDnsAliasesClientImpl implements ManagedServerDnsAliasesClient {
    ...
    ManagedServerDnsAliasesClientImpl(SqlManagementClientImpl client) {
        this.service = RestProxy.create(ManagedServerDnsAliasesService.class, client.getHttpPipeline(),
    ...
    public interface ManagedServerDnsAliasesService {
        ...
        Mono<Response<ManagedServerDnsAliasListResult>> listByManagedInstance(@HostParam("$host") String endpoint,
        ...
        @Headers({ "Content-Type: application/json" })
        @Get("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/managedInstances/{managedInstanceName}/dnsAliases/{dnsAliasName}")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ManagedServerDnsAliasInner>> get(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("managedInstanceName") String managedInstanceName,
    ...
    private Mono<PagedResponse<ManagedServerDnsAliasInner>>
    ...
    private PagedFlux<ManagedServerDnsAliasInner> listByManagedInstanceAsync(String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<ManagedServerDnsAliasInner> listByManagedInstance(String resourceGroupName,
        String managedInstanceName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ManagedServerDnsAliasInner>> getWithResponseAsync(String resourceGroupName,
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ManagedServerDnsAliasInner>> getWithResponseAsync(String resourceGroupName,
        String managedInstanceName, String dnsAliasName, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ManagedServerDnsAliasInner> getAsync(String resourceGroupName, String managedInstanceName,
        String dnsAliasName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ManagedServerDnsAliasInner> getWithResponse(String resourceGroupName, String managedInstanceName,
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String resourceGroupName,
        String managedInstanceName, String dnsAliasName, ManagedServerDnsAliasCreation parameters, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    private PollerFlux<PollResult<ManagedServerDnsAliasInner>, ManagedServerDnsAliasInner> beginCreateOrUpdateAsync(
        ...
        return this.client.<ManagedServerDnsAliasInner, ManagedServerDnsAliasInner>getLroResult(mono,
            this.client.getHttpPipeline(), ManagedServerDnsAliasInner.class, ManagedServerDnsAliasInner.class,
    ...
    private PollerFlux<PollResult<ManagedServerDnsAliasInner>, ManagedServerDnsAliasInner> beginCreateOrUpdateAsync(
        ...
        Mono<Response<Flux<ByteBuffer>>> mono = createOrUpdateWithResponseAsync(resourceGroupName, managedInstanceName,
            dnsAliasName, parameters, context);
        return this.client.<ManagedServerDnsAliasInner, ManagedServerDnsAliasInner>getLroResult(mono,
            this.client.getHttpPipeline(), ManagedServerDnsAliasInner.class, ManagedServerDnsAliasInner.class, context);
    }
    ...
    public SyncPoller<PollResult<ManagedServerDnsAliasInner>, ManagedServerDnsAliasInner> beginCreateOrUpdate(
        String resourceGroupName, String managedInstanceName, String dnsAliasName,
        ManagedServerDnsAliasCreation parameters) {
        return this.beginCreateOrUpdateAsync(resourceGroupName, managedInstanceName, dnsAliasName, parameters)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<ManagedServerDnsAliasInner>, ManagedServerDnsAliasInner> beginCreateOrUpdate(
        String resourceGroupName, String managedInstanceName, String dnsAliasName,
        ManagedServerDnsAliasCreation parameters, Context context) {
        return this.beginCreateOrUpdateAsync(resourceGroupName, managedInstanceName, dnsAliasName, parameters, context)
            .getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ManagedServerDnsAliasInner> createOrUpdateAsync(String resourceGroupName, String managedInstanceName,
        String dnsAliasName, ManagedServerDnsAliasCreation parameters) {
        return beginCreateOrUpdateAsync(resourceGroupName, managedInstanceName, dnsAliasName, parameters).last()
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ManagedServerDnsAliasInner> createOrUpdateAsync(String resourceGroupName, String managedInstanceName,
        String dnsAliasName, ManagedServerDnsAliasCreation parameters, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ManagedServerDnsAliasInner createOrUpdate(String resourceGroupName, String managedInstanceName,
        String dnsAliasName, ManagedServerDnsAliasCreation parameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> deleteAsync(String resourceGroupName, String managedInstanceName, String dnsAliasName) {
        return beginDeleteAsync(resourceGroupName, managedInstanceName, dnsAliasName).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String managedInstanceName, String dnsAliasName,
        Context context) {
        return beginDeleteAsync(resourceGroupName, managedInstanceName, dnsAliasName, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> acquireWithResponseAsync(String resourceGroupName,
        String managedInstanceName, String dnsAliasName, ManagedServerDnsAliasAcquisition parameters) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> acquireWithResponseAsync(String resourceGroupName,
        String managedInstanceName, String dnsAliasName, ManagedServerDnsAliasAcquisition parameters, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    public SyncPoller<PollResult<ManagedServerDnsAliasInner>, ManagedServerDnsAliasInner> beginAcquire(
        String resourceGroupName, String managedInstanceName, String dnsAliasName,
        ManagedServerDnsAliasAcquisition parameters, Context context) {
        return this.beginAcquireAsync(resourceGroupName, managedInstanceName, dnsAliasName, parameters, context)
            .getSyncPoller();
    }
    ...
    private Mono<ManagedServerDnsAliasInner> acquireAsync(String resourceGroupName, String managedInstanceName,
        ...
        return beginAcquireAsync(resourceGroupName, managedInstanceName, dnsAliasName, parameters).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ManagedServerDnsAliasInner> acquireAsync(String resourceGroupName, String managedInstanceName,
        String dnsAliasName, ManagedServerDnsAliasAcquisition parameters, Context context) {
        return beginAcquireAsync(resourceGroupName, managedInstanceName, dnsAliasName, parameters, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
