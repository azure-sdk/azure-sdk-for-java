...
public interface JobTargetExecutionsClient {
    ...
    PagedIterable<JobExecutionAutoGenerated2Inner> listByStep(
    ...
    Response<JobExecutionAutoGenerated2Inner> getWithResponse(
        String resourceGroupName,
        String serverName,
        String jobAgentName,
        String jobName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    JobExecutionAutoGenerated2Inner get(
        String resourceGroupName,
        String serverName,
        String jobAgentName,
        String jobName,
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<JobExecutionAutoGenerated2Inner> listByJobExecution(
