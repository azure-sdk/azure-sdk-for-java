...
import com.azure.resourcemanager.sql.generated.models.LogicalServerAdvancedThreatProtectionListResult;
...
public final class ServerAdvancedThreatProtectionSettingsClientImpl
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ServerAdvancedThreatProtectionInner> getAsync(
        String resourceGroupName, String serverName, AdvancedThreatProtectionName advancedThreatProtectionName) {
    ...
    public ServerAdvancedThreatProtectionInner get(
        String resourceGroupName, String serverName, AdvancedThreatProtectionName advancedThreatProtectionName) {
        return getAsync(resourceGroupName, serverName, advancedThreatProtectionName).block();
    }
