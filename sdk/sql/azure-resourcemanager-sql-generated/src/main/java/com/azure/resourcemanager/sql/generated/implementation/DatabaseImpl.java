...
import com.azure.resourcemanager.sql.generated.models.FreeLimitExhaustionBehavior;
import com.azure.resourcemanager.sql.generated.models.HyperscaleBillingVersion;
...
public final class DatabaseImpl implements Database, Database.Definition, Database.Update {
    ...
    public HyperscaleBillingVersion hyperscaleBillingVersion() {
        return this.innerModel().hyperscaleBillingVersion();
    }
    ...
    public Map<String, DatabaseKey> keys() {
        Map<String, DatabaseKey> inner = this.innerModel().keys();
        if (inner != null) {
            return Collections.unmodifiableMap(inner);
        } else {
            return Collections.emptyMap();
    ...
    public String encryptionProtector() {
        return this.innerModel().encryptionProtector();
    }

    public AlwaysEncryptedEnclaveType preferredEnclaveType() {
        return this.innerModel().preferredEnclaveType();
    }

    public Boolean useFreeLimit() {
        return this.innerModel().useFreeLimit();
    }

    public FreeLimitExhaustionBehavior freeLimitExhaustionBehavior() {
        return this.innerModel().freeLimitExhaustionBehavior();
    }
    ...
    public Boolean manualCutover() {
        return this.innerModel().manualCutover();
    }

    public Boolean performCutover() {
        return this.innerModel().performCutover();
    }
    ...
    public Boolean encryptionProtectorAutoRotation() {
        return this.innerModel().encryptionProtectorAutoRotation();
    }
    ...
    public Database apply() {
        this.innerObject = serviceManager.serviceClient().getDatabases().update(resourceGroupName, serverName,
    ...
    public Database refresh() {
        ...
        this.innerObject = serviceManager.serviceClient().getDatabases()
            .getWithResponse(resourceGroupName, serverName, databaseName, localExpand, localFilter, Context.NONE)
            .getValue();
        return this;
    }
    ...
    public Database refresh(Context context) {
        ...
        String localFilter = null;
        this.innerObject = serviceManager.serviceClient().getDatabases()
            .getWithResponse(resourceGroupName, serverName, databaseName, localExpand, localFilter, context).getValue();
        return this;
    }
    ...
    public Response<Void> renameWithResponse(ResourceMoveDefinition parameters, Context context) {
        return serviceManager.databases().renameWithResponse(resourceGroupName, serverName, databaseName, parameters,
            context);
    }
    ...
    public DatabaseImpl withKeys(Map<String, DatabaseKey> keys) {
        if (isInCreateMode()) {
            this.innerModel().withKeys(keys);
            return this;
        } else {
            this.updateParameters.withKeys(keys);
            return this;
        }
    }

    public DatabaseImpl withEncryptionProtector(String encryptionProtector) {
        if (isInCreateMode()) {
            this.innerModel().withEncryptionProtector(encryptionProtector);
            return this;
        } else {
            this.updateParameters.withEncryptionProtector(encryptionProtector);
            return this;
        }
    }

    public DatabaseImpl withPreferredEnclaveType(AlwaysEncryptedEnclaveType preferredEnclaveType) {
        if (isInCreateMode()) {
            this.innerModel().withPreferredEnclaveType(preferredEnclaveType);
            return this;
        } else {
            this.updateParameters.withPreferredEnclaveType(preferredEnclaveType);
            return this;
        }
    }

    public DatabaseImpl withUseFreeLimit(Boolean useFreeLimit) {
        if (isInCreateMode()) {
            this.innerModel().withUseFreeLimit(useFreeLimit);
            return this;
        } else {
            this.updateParameters.withUseFreeLimit(useFreeLimit);
            return this;
        }
    }

    public DatabaseImpl withFreeLimitExhaustionBehavior(FreeLimitExhaustionBehavior freeLimitExhaustionBehavior) {
        if (isInCreateMode()) {
            this.innerModel().withFreeLimitExhaustionBehavior(freeLimitExhaustionBehavior);
            return this;
        } else {
            this.updateParameters.withFreeLimitExhaustionBehavior(freeLimitExhaustionBehavior);
            return this;
        }
    }
    ...
    public DatabaseImpl withManualCutover(Boolean manualCutover) {
        if (isInCreateMode()) {
            this.innerModel().withManualCutover(manualCutover);
            return this;
        } else {
            this.updateParameters.withManualCutover(manualCutover);
            return this;
        }
    }

    public DatabaseImpl withPerformCutover(Boolean performCutover) {
        if (isInCreateMode()) {
            this.innerModel().withPerformCutover(performCutover);
            return this;
        } else {
            this.updateParameters.withPerformCutover(performCutover);
            return this;
        }
    }

    public DatabaseImpl withAvailabilityZone(AvailabilityZoneType availabilityZone) {
        this.innerModel().withAvailabilityZone(availabilityZone);
        return this;
    }

    public DatabaseImpl withEncryptionProtectorAutoRotation(Boolean encryptionProtectorAutoRotation) {
        if (isInCreateMode()) {
            this.innerModel().withEncryptionProtectorAutoRotation(encryptionProtectorAutoRotation);
            return this;
        } else {
            this.updateParameters.withEncryptionProtectorAutoRotation(encryptionProtectorAutoRotation);
            return this;
        }
    }
