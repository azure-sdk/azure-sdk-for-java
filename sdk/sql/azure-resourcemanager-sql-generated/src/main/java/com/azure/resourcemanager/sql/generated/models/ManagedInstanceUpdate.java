...
public final class ManagedInstanceUpdate {
    ...
    /**
     * Get the maintenancePolicy property: This managed instance value is used to determine schedule for custom
     * maintenance.
     *
    ...
    /**
     * Set the maintenancePolicy property: This managed instance value is used to determine schedule for custom
     * maintenance.
     *
     * @param maintenancePolicy the maintenancePolicy value to set.
     * @return the ManagedInstanceUpdate object itself.
     */
    public ManagedInstanceUpdate withMaintenancePolicy(MaintenancePolicy maintenancePolicy) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ManagedInstanceProperties();
        }
