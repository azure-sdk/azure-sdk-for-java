...
public final class InstancePoolImpl implements InstancePool, InstancePool.Definition, InstancePool.Update {
    ...
    public InstancePool create() {
        this.innerObject = serviceManager.serviceClient().getInstancePools().createOrUpdate(resourceGroupName,
            instancePoolName, this.innerModel(), Context.NONE);
        return this;
    }

    public InstancePool create(Context context) {
        this.innerObject = serviceManager.serviceClient().getInstancePools().createOrUpdate(resourceGroupName,
            instancePoolName, this.innerModel(), context);
        return this;
    }
    ...
    public InstancePool apply() {
        this.innerObject = serviceManager.serviceClient().getInstancePools().update(resourceGroupName, instancePoolName,
    ...
    InstancePoolImpl(InstancePoolInner innerObject, com.azure.resourcemanager.sql.generated.SqlManager serviceManager) {
        ...
        this.instancePoolName = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "instancePools");
    }

    public InstancePool refresh() {
        this.innerObject = serviceManager.serviceClient().getInstancePools()
            .getByResourceGroupWithResponse(resourceGroupName, instancePoolName, Context.NONE).getValue();
        return this;
    }

    public InstancePool refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getInstancePools()
            .getByResourceGroupWithResponse(resourceGroupName, instancePoolName, context).getValue();
        return this;
    }
    ...
    public InstancePoolImpl withMaintenanceConfigurationId(String maintenanceConfigurationId) {
        if (isInCreateMode()) {
