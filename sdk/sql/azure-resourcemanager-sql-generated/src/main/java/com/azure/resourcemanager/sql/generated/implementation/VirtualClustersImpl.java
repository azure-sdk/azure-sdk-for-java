...
public final class VirtualClustersImpl implements VirtualClusters {
    ...
    public VirtualClustersImpl(VirtualClustersClient innerClient,
    ...
    public PagedIterable<VirtualCluster> list() {
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new VirtualClusterImpl(inner1, this.manager()));
    }
    ...
    public Response<VirtualCluster> getByResourceGroupWithResponse(String resourceGroupName, String virtualClusterName,
        Context context) {
    ...
    public UpdateVirtualClusterDnsServersOperation updateDnsServers(String resourceGroupName,
        String virtualClusterName) {
        UpdateVirtualClusterDnsServersOperationInner inner
            = this.serviceClient().updateDnsServers(resourceGroupName, virtualClusterName);
        if (inner != null) {
            return new UpdateVirtualClusterDnsServersOperationImpl(inner, this.manager());
        } else {
            return null;
        }
    }

    public UpdateVirtualClusterDnsServersOperation updateDnsServers(String resourceGroupName, String virtualClusterName,
        Context context) {
        UpdateVirtualClusterDnsServersOperationInner inner
            = this.serviceClient().updateDnsServers(resourceGroupName, virtualClusterName, context);
        if (inner != null) {
            return new UpdateVirtualClusterDnsServersOperationImpl(inner, this.manager());
        } else {
            return null;
