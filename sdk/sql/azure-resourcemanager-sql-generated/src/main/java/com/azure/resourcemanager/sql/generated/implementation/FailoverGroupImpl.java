...
public final class FailoverGroupImpl implements FailoverGroup, FailoverGroup.Definition, FailoverGroup.Update {
    ...
    public FailoverGroup tryPlannedBeforeForcedFailover() {
        return serviceManager
            .failoverGroups()
            .tryPlannedBeforeForcedFailover(resourceGroupName, serverName, failoverGroupName);
    }

    public FailoverGroup tryPlannedBeforeForcedFailover(Context context) {
        return serviceManager
            .failoverGroups()
            .tryPlannedBeforeForcedFailover(resourceGroupName, serverName, failoverGroupName, context);
    }
