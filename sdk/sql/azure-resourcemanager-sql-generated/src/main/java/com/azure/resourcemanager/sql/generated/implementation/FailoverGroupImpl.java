...
public final class FailoverGroupImpl implements FailoverGroup, FailoverGroup.Definition, FailoverGroup.Update {
    ...
    public FailoverGroup create() {
        this.innerObject = serviceManager.serviceClient().getFailoverGroups().createOrUpdate(resourceGroupName,
            serverName, failoverGroupName, this.innerModel(), Context.NONE);
        return this;
    }

    public FailoverGroup create(Context context) {
        this.innerObject = serviceManager.serviceClient().getFailoverGroups().createOrUpdate(resourceGroupName,
            serverName, failoverGroupName, this.innerModel(), context);
        return this;
    }
    ...
    public FailoverGroup apply() {
        this.innerObject = serviceManager.serviceClient().getFailoverGroups().update(resourceGroupName, serverName,
            failoverGroupName, updateParameters, Context.NONE);
        return this;
    }

    public FailoverGroup apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getFailoverGroups().update(resourceGroupName, serverName,
            failoverGroupName, updateParameters, context);
        return this;
    }

    FailoverGroupImpl(FailoverGroupInner innerObject,
        com.azure.resourcemanager.sql.generated.SqlManager serviceManager) {
        this.innerObject = innerObject;
        this.serviceManager = serviceManager;
        this.resourceGroupName = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "resourceGroups");
        this.serverName = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "servers");
        this.failoverGroupName = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "failoverGroups");
    }

    public FailoverGroup refresh() {
        this.innerObject = serviceManager.serviceClient().getFailoverGroups()
            .getWithResponse(resourceGroupName, serverName, failoverGroupName, Context.NONE).getValue();
        return this;
    }

    public FailoverGroup refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getFailoverGroups()
            .getWithResponse(resourceGroupName, serverName, failoverGroupName, context).getValue();
        return this;
    }
    ...
    public FailoverGroup forceFailoverAllowDataLoss() {
        return serviceManager.failoverGroups().forceFailoverAllowDataLoss(resourceGroupName, serverName,
            failoverGroupName);
    }
    ...
    public FailoverGroup tryPlannedBeforeForcedFailover() {
        return serviceManager.failoverGroups().tryPlannedBeforeForcedFailover(resourceGroupName, serverName,
            failoverGroupName);
    }

    public FailoverGroup tryPlannedBeforeForcedFailover(Context context) {
        return serviceManager.failoverGroups().tryPlannedBeforeForcedFailover(resourceGroupName, serverName,
            failoverGroupName, context);
    }
    ...
    public FailoverGroupImpl withPartnerServers(List<PartnerInfo> partnerServers) {
        if (isInCreateMode()) {
            ...
            this.updateParameters.withPartnerServers(partnerServers);
            return this;
        }
    }
    ...
    public FailoverGroupImpl withSecondaryType(FailoverGroupDatabasesSecondaryType secondaryType) {
        if (isInCreateMode()) {
