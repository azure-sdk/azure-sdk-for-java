...
import com.azure.resourcemanager.sql.generated.models.JobExecutionListResultAutoGenerated2;
...
public final class JobTargetExecutionsClientImpl implements JobTargetExecutionsClient {
    ...
    public interface JobTargetExecutionsService {
        ...
        Mono<Response<JobExecutionListResultAutoGenerated2>> listByStep(
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<JobExecutionAutoGenerated2Inner>> get(
            @HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("serverName") String serverName,
            @PathParam("jobAgentName") String jobAgentName,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<JobExecutionListResultAutoGenerated2>> listByJobExecution(
            @HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("serverName") String serverName,
            @PathParam("jobAgentName") String jobAgentName,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<JobExecutionListResultAutoGenerated2>> listByStepNext(
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<JobExecutionListResultAutoGenerated2>> listByJobExecutionNext(
            @PathParam(value = "nextLink", encoded = true) String nextLink,
            @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept,
            Context context);
    ...
    private Mono<PagedResponse<JobExecutionAutoGenerated2Inner>> listByStepSinglePageAsync(
                ...
                context ->
                    service
                        .listByStep(
                            ...
                            accept,
                            context))
            .<PagedResponse<JobExecutionAutoGenerated2Inner>>map(
                res ->
    ...
    private PagedFlux<JobExecutionAutoGenerated2Inner> listByStepAsync(
        String resourceGroupName,
        String serverName,
        String jobAgentName,
        String jobName,
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<JobExecutionAutoGenerated2Inner> listByStep(
        String resourceGroupName,
        String serverName,
        String jobAgentName,
        String jobName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<JobExecutionAutoGenerated2Inner>> getWithResponseAsync(
        String resourceGroupName,
        String serverName,
        String jobAgentName,
        String jobName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<JobExecutionAutoGenerated2Inner> getAsync(
        String resourceGroupName,
        String serverName,
        String jobAgentName,
        String jobName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<JobExecutionAutoGenerated2Inner> getWithResponse(
        String resourceGroupName,
        String serverName,
        String jobAgentName,
        String jobName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public JobExecutionAutoGenerated2Inner get(
        String resourceGroupName,
        String serverName,
        String jobAgentName,
        String jobName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<JobExecutionAutoGenerated2Inner>> listByJobExecutionSinglePageAsync(
        String resourceGroupName,
        String serverName,
        String jobAgentName,
        String jobName,
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<JobExecutionAutoGenerated2Inner> listByJobExecutionAsync(
        String resourceGroupName,
        String serverName,
        String jobAgentName,
        String jobName,
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<JobExecutionAutoGenerated2Inner> listByJobExecution(
        String resourceGroupName, String serverName, String jobAgentName, String jobName, UUID jobExecutionId) {
        final OffsetDateTime createTimeMin = null;
        final OffsetDateTime createTimeMax = null;
        final OffsetDateTime endTimeMin = null;
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<JobExecutionAutoGenerated2Inner>> listByStepNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<JobExecutionAutoGenerated2Inner>> listByStepNextSinglePageAsync(
        ...
        context = this.client.mergeContext(context);
        return service
            .listByStepNext(nextLink, this.client.getEndpoint(), accept, context)
            .map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<JobExecutionAutoGenerated2Inner>> listByJobExecutionNextSinglePageAsync(
        String nextLink) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
