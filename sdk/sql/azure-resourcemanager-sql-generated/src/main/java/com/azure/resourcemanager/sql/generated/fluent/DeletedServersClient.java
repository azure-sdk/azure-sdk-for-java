...
public interface DeletedServersClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<DeletedServerInner> listByResourceGroup(String resourceGroupName);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<DeletedServerInner> listByResourceGroup(String resourceGroupName, Context context);
    ...
    Response<DeletedServerInner> getByResourceGroupWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    DeletedServerInner getByResourceGroup(String resourceGroupName, String deletedServerName);
}
