...
public final class ManagedInstanceAdvancedThreatProtectionImpl implements ManagedInstanceAdvancedThreatProtection,
    ManagedInstanceAdvancedThreatProtection.Definition, ManagedInstanceAdvancedThreatProtection.Update {
    ...
    public ManagedInstanceAdvancedThreatProtectionImpl withExistingManagedInstance(String resourceGroupName,
    ...
    public ManagedInstanceAdvancedThreatProtection create() {
        this.innerObject
            = serviceManager.serviceClient().getManagedInstanceAdvancedThreatProtectionSettings().createOrUpdate(
                resourceGroupName, managedInstanceName, advancedThreatProtectionName, this.innerModel(), Context.NONE);
        return this;
    }
    ...
    ManagedInstanceAdvancedThreatProtectionImpl(AdvancedThreatProtectionName name,
    ...
    ManagedInstanceAdvancedThreatProtectionImpl(ManagedInstanceAdvancedThreatProtectionInner innerObject,
        com.azure.resourcemanager.sql.generated.SqlManager serviceManager) {
    ...
    public ManagedInstanceAdvancedThreatProtection refresh() {
        this.innerObject = serviceManager.serviceClient().getManagedInstanceAdvancedThreatProtectionSettings()
    ...
    public ManagedInstanceAdvancedThreatProtection refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getManagedInstanceAdvancedThreatProtectionSettings()
            .getWithResponse(resourceGroupName, managedInstanceName, advancedThreatProtectionName, context).getValue();
        return this;
    }
