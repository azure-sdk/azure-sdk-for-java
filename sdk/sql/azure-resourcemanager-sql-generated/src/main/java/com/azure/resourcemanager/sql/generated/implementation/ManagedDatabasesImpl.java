...
public final class ManagedDatabasesImpl implements ManagedDatabases {
    ...
    public ManagedDatabasesImpl(ManagedDatabasesClient innerClient,
    ...
    public PagedIterable<ManagedDatabase> listByInstance(String resourceGroupName, String managedInstanceName) {
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new ManagedDatabaseImpl(inner1, this.manager()));
    }
    ...
    public Response<ManagedDatabase> getWithResponse(String resourceGroupName, String managedInstanceName,
    ...
    public void cancelMove(String resourceGroupName, String managedInstanceName, String databaseName,
        ...
        this.serviceClient().cancelMove(resourceGroupName, managedInstanceName, databaseName, parameters);
    }

    public void cancelMove(String resourceGroupName, String managedInstanceName, String databaseName,
        ManagedDatabaseMoveDefinition parameters, Context context) {
        this.serviceClient().cancelMove(resourceGroupName, managedInstanceName, databaseName, parameters, context);
    }

    public void completeMove(String resourceGroupName, String managedInstanceName, String databaseName,
        ManagedDatabaseMoveDefinition parameters) {
        this.serviceClient().completeMove(resourceGroupName, managedInstanceName, databaseName, parameters);
    }

    public void completeMove(String resourceGroupName, String managedInstanceName, String databaseName,
        ManagedDatabaseMoveDefinition parameters, Context context) {
        this.serviceClient().completeMove(resourceGroupName, managedInstanceName, databaseName, parameters, context);
    }
    ...
    public void startMove(String resourceGroupName, String managedInstanceName, String databaseName,
        ...
        this.serviceClient().startMove(resourceGroupName, managedInstanceName, databaseName, parameters);
    }

    public void startMove(String resourceGroupName, String managedInstanceName, String databaseName,
        ManagedDatabaseStartMoveDefinition parameters, Context context) {
        this.serviceClient().startMove(resourceGroupName, managedInstanceName, databaseName, parameters, context);
    }

    public PagedIterable<ManagedDatabase> listInaccessibleByInstance(String resourceGroupName,
