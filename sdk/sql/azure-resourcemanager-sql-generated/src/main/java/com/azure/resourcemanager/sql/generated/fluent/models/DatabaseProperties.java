...
public final class DatabaseProperties {
     ...
     */
    @JsonProperty(value = "hyperscaleBillingVersion", access = JsonProperty.Access.WRITE_ONLY)
    private HyperscaleBillingVersion hyperscaleBillingVersion;
    ...
    /*
     * The number of secondary replicas associated with the Business Critical, Premium, or Hyperscale edition database
    ...
    /**
     * Get the hyperscaleBillingVersion property: The pricing model to use when calculating billing for this database.
     * 
     * @return the hyperscaleBillingVersion value.
     */
    public HyperscaleBillingVersion hyperscaleBillingVersion() {
        return this.hyperscaleBillingVersion;
    }
    ...
    /**
     * Get the earliestRestoreDate property: This records the earliest start date and time that restore is available
    ...
    /**
     * Get the highAvailabilityReplicaCount property: The number of secondary replicas associated with the Business
     * Critical, Premium, or Hyperscale edition database that are used to provide high availability. Not applicable to
     * a Hyperscale database within an elastic pool.
     * 
    ...
    /**
     * Set the highAvailabilityReplicaCount property: The number of secondary replicas associated with the Business
     * Critical, Premium, or Hyperscale edition database that are used to provide high availability. Not applicable to
     * a Hyperscale database within an elastic pool.
     * 
    ...
    /**
     * Get the useFreeLimit property: Whether or not the database uses free monthly limits. Allowed on one database in
     * a subscription.
     * 
    ...
    /**
     * Set the useFreeLimit property: Whether or not the database uses free monthly limits. Allowed on one database in
     * a subscription.
     * 
