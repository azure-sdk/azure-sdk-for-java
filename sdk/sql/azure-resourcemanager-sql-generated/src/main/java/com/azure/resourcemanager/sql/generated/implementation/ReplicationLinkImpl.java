...
public final class ReplicationLinkImpl implements ReplicationLink, ReplicationLink.Definition, ReplicationLink.Update {
    ...
    public ReplicationLink create() {
        this.innerObject = serviceManager.serviceClient().getReplicationLinks().createOrUpdate(resourceGroupName,
            serverName, databaseName, linkId, this.innerModel(), Context.NONE);
        return this;
    }

    public ReplicationLink create(Context context) {
        this.innerObject = serviceManager.serviceClient().getReplicationLinks().createOrUpdate(resourceGroupName,
            serverName, databaseName, linkId, this.innerModel(), context);
        return this;
    }
    ...
    public ReplicationLink apply() {
        this.innerObject = serviceManager.serviceClient().getReplicationLinks().update(resourceGroupName, serverName,
            databaseName, linkId, updateParameters, Context.NONE);
        return this;
    }

    public ReplicationLink apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getReplicationLinks().update(resourceGroupName, serverName,
            databaseName, linkId, updateParameters, context);
        return this;
    }
    ...
    ReplicationLinkImpl(ReplicationLinkInner innerObject,
        ...
        this.linkId = Utils.getValueFromIdByName(innerObject.id(), "replicationLinks");
    }

    public ReplicationLink refresh() {
        this.innerObject = serviceManager.serviceClient().getReplicationLinks()
            .getWithResponse(resourceGroupName, serverName, databaseName, linkId, Context.NONE).getValue();
        return this;
    }

    public ReplicationLink refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getReplicationLinks()
            .getWithResponse(resourceGroupName, serverName, databaseName, linkId, context).getValue();
        return this;
    }
    ...
    public ReplicationLink failoverAllowDataLoss() {
        return serviceManager.replicationLinks().failoverAllowDataLoss(resourceGroupName, serverName, databaseName,
            linkId);
    }
