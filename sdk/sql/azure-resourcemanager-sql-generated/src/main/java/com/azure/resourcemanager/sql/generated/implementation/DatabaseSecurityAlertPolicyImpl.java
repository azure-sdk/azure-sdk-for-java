...
public final class DatabaseSecurityAlertPolicyImpl
    ...
    public DatabaseSecurityAlertPolicyImpl withExistingDatabase(String resourceGroupName, String serverName,
        String databaseName) {
    ...
    public DatabaseSecurityAlertPolicy create() {
        this.innerObject = serviceManager.serviceClient().getDatabaseSecurityAlertPolicies()
            .createOrUpdateWithResponse(resourceGroupName, serverName, databaseName, securityAlertPolicyName,
    ...
    DatabaseSecurityAlertPolicyImpl(SecurityAlertPolicyName name,
    ...
    DatabaseSecurityAlertPolicyImpl(DatabaseSecurityAlertPolicyInner innerObject,
        com.azure.resourcemanager.sql.generated.SqlManager serviceManager) {
    ...
    public DatabaseSecurityAlertPolicy refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getDatabaseSecurityAlertPolicies()
            .getWithResponse(resourceGroupName, serverName, databaseName, securityAlertPolicyName, context).getValue();
        return this;
    }
