...
public final class JobPrivateEndpointsClientImpl implements JobPrivateEndpointsClient {
    ...
    JobPrivateEndpointsClientImpl(SqlManagementClientImpl client) {
        this.service =
            RestProxy.create(JobPrivateEndpointsService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }
    ...
    public interface JobPrivateEndpointsService {
        ...
        Mono<Response<JobPrivateEndpointListResult>> listByAgent(
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<JobPrivateEndpointInner>> get(
            @HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("serverName") String serverName,
            @PathParam("jobAgentName") String jobAgentName,
        ...
        Mono<Response<Flux<ByteBuffer>>> createOrUpdate(
            ...
            @PathParam("subscriptionId") String subscriptionId,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") JobPrivateEndpointInner parameters,
            @HeaderParam("Accept") String accept,
            Context context);
     ...
     * @return a list of job agent private endpoints along with {@link PagedResponse} on successful completion of {@link
     *     Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<JobPrivateEndpointInner>> listByAgentSinglePageAsync(
                ...
                context ->
                    service
                        .listByAgent(
                            ...
                            accept,
                            context))
            .<PagedResponse<JobPrivateEndpointInner>>map(
                res ->
    ...
    private PagedFlux<JobPrivateEndpointInner> listByAgentAsync(
        String resourceGroupName, String serverName, String jobAgentName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<JobPrivateEndpointInner> listByAgent(
        String resourceGroupName, String serverName, String jobAgentName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<JobPrivateEndpointInner>> getWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<JobPrivateEndpointInner> getAsync(
        String resourceGroupName, String serverName, String jobAgentName, String privateEndpointName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<JobPrivateEndpointInner> getWithResponse(
        String resourceGroupName, String serverName, String jobAgentName, String privateEndpointName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public JobPrivateEndpointInner get(
        String resourceGroupName, String serverName, String jobAgentName, String privateEndpointName) {
    ...
    private PollerFlux<PollResult<JobPrivateEndpointInner>, JobPrivateEndpointInner> beginCreateOrUpdateAsync(
        ...
        Mono<Response<Flux<ByteBuffer>>> mono =
            createOrUpdateWithResponseAsync(
                resourceGroupName, serverName, jobAgentName, privateEndpointName, parameters);
        return this
            .client
            .<JobPrivateEndpointInner, JobPrivateEndpointInner>getLroResult(
                mono,
    ...
    private PollerFlux<PollResult<JobPrivateEndpointInner>, JobPrivateEndpointInner> beginCreateOrUpdateAsync(
        ...
        Mono<Response<Flux<ByteBuffer>>> mono =
            createOrUpdateWithResponseAsync(
                resourceGroupName, serverName, jobAgentName, privateEndpointName, parameters, context);
        return this
            .client
            .<JobPrivateEndpointInner, JobPrivateEndpointInner>getLroResult(
                mono,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<JobPrivateEndpointInner> createOrUpdateAsync(
        String resourceGroupName,
        String serverName,
        String jobAgentName,
        String privateEndpointName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public JobPrivateEndpointInner createOrUpdate(
        String resourceGroupName,
        String serverName,
        String jobAgentName,
        String privateEndpointName,
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(
        String resourceGroupName, String serverName, String jobAgentName, String privateEndpointName, Context context) {
        return this
            .beginDeleteAsync(resourceGroupName, serverName, jobAgentName, privateEndpointName, context)
            .getSyncPoller();
    }
    ...
    private Mono<Void> deleteAsync(
        String resourceGroupName, String serverName, String jobAgentName, String privateEndpointName) {
        return beginDeleteAsync(resourceGroupName, serverName, jobAgentName, privateEndpointName)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<Void> deleteAsync(
        String resourceGroupName, String serverName, String jobAgentName, String privateEndpointName, Context context) {
        return beginDeleteAsync(resourceGroupName, serverName, jobAgentName, privateEndpointName, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<JobPrivateEndpointInner>> listByAgentNextSinglePageAsync(
