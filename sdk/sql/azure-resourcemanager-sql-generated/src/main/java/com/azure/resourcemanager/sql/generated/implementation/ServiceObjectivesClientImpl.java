...
import com.azure.resourcemanager.sql.generated.models.ServiceObjectiveListResult;
...
public final class ServiceObjectivesClientImpl implements ServiceObjectivesClient {
    ...
    /**
     * Initializes an instance of ServiceObjectivesClientImpl.
     *
     * @param client the instance of the service client containing this operation class.
     */
    ServiceObjectivesClientImpl(SqlManagementClientImpl client) {
        this.service =
    ...
    private interface ServiceObjectivesService {
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ServiceObjectiveListResult>> listByServer(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ServiceObjectiveInner> getAsync(
        String resourceGroupName, String serverName, String serviceObjectiveName) {
    ...
    public Response<ServiceObjectiveInner> getWithResponse(
        String resourceGroupName, String serverName, String serviceObjectiveName, Context context) {
        return getWithResponseAsync(resourceGroupName, serverName, serviceObjectiveName, context).block();
    }
    ...
    public ServiceObjectiveInner get(String resourceGroupName, String serverName, String serviceObjectiveName) {
        return getWithResponse(resourceGroupName, serverName, serviceObjectiveName, Context.NONE).getValue();
    }
    ...
    private PagedFlux<ServiceObjectiveInner> listByServerAsync(String resourceGroupName, String serverName) {
