...
public interface ElasticPool {
    ...
    /**
     * Gets the minCapacity property: Minimal capacity that serverless pool will not shrink below, if not paused.
     * 
     ...
     * Critical, Premium, or Hyperscale edition elastic pool that are used to provide high availability. Applicable only
     * to Hyperscale elastic pools.
     * 
    ...
    /**
     * Gets the autoPauseDelay property: Time in minutes after which elastic pool is automatically paused. A value of -1
    ...
    /**
     * Gets the preferredEnclaveType property: Type of enclave requested on the elastic pool.
     * 
    ...
    /**
     * Gets the availabilityZone property: Specifies the availability zone the pool's primary replica is pinned to.
     * 
    ...
    interface DefinitionStages {
        ...
        interface WithCreate extends DefinitionStages.WithTags, DefinitionStages.WithSku,
            DefinitionStages.WithMaxSizeBytes, DefinitionStages.WithMinCapacity,
            DefinitionStages.WithPerDatabaseSettings, DefinitionStages.WithZoneRedundant,
            DefinitionStages.WithLicenseType, DefinitionStages.WithMaintenanceConfigurationId,
            DefinitionStages.WithHighAvailabilityReplicaCount, DefinitionStages.WithAutoPauseDelay,
            DefinitionStages.WithPreferredEnclaveType, DefinitionStages.WithAvailabilityZone {
            /**
        ...
        /**
         * The stage of the ElasticPool definition allowing to specify minCapacity.
         */
        interface WithMinCapacity {
            /**
             * Specifies the minCapacity property: Minimal capacity that serverless pool will not shrink below, if not
             * paused.
             * 
        ...
        /**
         * The stage of the ElasticPool definition allowing to specify highAvailabilityReplicaCount.
         */
        interface WithHighAvailabilityReplicaCount {
             ...
             * Critical, Premium, or Hyperscale edition elastic pool that are used to provide high availability.
        ...
        /**
         * The stage of the ElasticPool definition allowing to specify autoPauseDelay.
         */
        interface WithAutoPauseDelay {
            /**
             * Specifies the autoPauseDelay property: Time in minutes after which elastic pool is automatically paused.
             * A value of -1 means that automatic pause is disabled.
             * 
             * @param autoPauseDelay Time in minutes after which elastic pool is automatically paused. A value of -1
             * means that automatic pause is disabled.
             * @return the next definition stage.
             */
        ...
        /**
         * The stage of the ElasticPool definition allowing to specify preferredEnclaveType.
         */
        interface WithPreferredEnclaveType {
            /**
             * Specifies the preferredEnclaveType property: Type of enclave requested on the elastic pool..
             * 
             * @param preferredEnclaveType Type of enclave requested on the elastic pool.
             * @return the next definition stage.
             */
        ...
        /**
         * The stage of the ElasticPool definition allowing to specify availabilityZone.
         */
        interface WithAvailabilityZone {
            /**
             * Specifies the availabilityZone property: Specifies the availability zone the pool's primary replica is
             * pinned to..
             * 
             * @param availabilityZone Specifies the availability zone the pool's primary replica is pinned to.
             * @return the next definition stage.
             */
    ...
    interface Update extends UpdateStages.WithTags, UpdateStages.WithSku, UpdateStages.WithMaxSizeBytes,
        UpdateStages.WithMinCapacity, UpdateStages.WithPerDatabaseSettings, UpdateStages.WithZoneRedundant,
        UpdateStages.WithLicenseType, UpdateStages.WithMaintenanceConfigurationId,
        UpdateStages.WithHighAvailabilityReplicaCount, UpdateStages.WithAutoPauseDelay,
        UpdateStages.WithPreferredEnclaveType, UpdateStages.WithAvailabilityZone {
        /**
    ...
    interface UpdateStages {
        ...
        /**
         * The stage of the ElasticPool update allowing to specify minCapacity.
         */
        interface WithMinCapacity {
            /**
             * Specifies the minCapacity property: Minimal capacity that serverless pool will not shrink below, if not
        ...
        /**
         * The stage of the ElasticPool update allowing to specify highAvailabilityReplicaCount.
         */
        interface WithHighAvailabilityReplicaCount {
            /**
             * Specifies the highAvailabilityReplicaCount property: The number of secondary replicas associated with the
        ...
        /**
         * The stage of the ElasticPool update allowing to specify autoPauseDelay.
         */
        interface WithAutoPauseDelay {
            /**
             * Specifies the autoPauseDelay property: Time in minutes after which elastic pool is automatically paused.
        ...
        /**
         * The stage of the ElasticPool update allowing to specify preferredEnclaveType.
         */
        interface WithPreferredEnclaveType {
            /**
             * Specifies the preferredEnclaveType property: Type of enclave requested on the elastic pool..
        ...
        /**
         * The stage of the ElasticPool update allowing to specify availabilityZone.
         */
        interface WithAvailabilityZone {
            /**
             * Specifies the availabilityZone property: Specifies the availability zone the pool's primary replica is
             ...
             * @return the next definition stage.
             */
            Update withAvailabilityZone(AvailabilityZoneType availabilityZone);
        }
    }
