...
public final class ServerAzureADAdministratorImpl
    ...
    public ServerAzureADAdministrator create() {
        this.innerObject = serviceManager.serviceClient().getServerAzureADAdministrators()
    ...
    ServerAzureADAdministratorImpl(AdministratorName name,
    ...
    ServerAzureADAdministratorImpl(ServerAzureADAdministratorInner innerObject,
        com.azure.resourcemanager.sql.generated.SqlManager serviceManager) {
