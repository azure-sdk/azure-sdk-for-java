...
import com.azure.resourcemanager.sql.generated.models.StartStopManagedInstanceScheduleListResult;
...
public final class StartStopManagedInstanceSchedulesClientImpl implements StartStopManagedInstanceSchedulesClient {
    ...
    StartStopManagedInstanceSchedulesClientImpl(SqlManagementClientImpl client) {
        this.service =
            RestProxy
                .create(
                    StartStopManagedInstanceSchedulesService.class,
    ...
    public interface StartStopManagedInstanceSchedulesService {
        ...
        @Get(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql"
                + "/managedInstances/{managedInstanceName}/startStopSchedules")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<StartStopManagedInstanceScheduleListResult>> listByInstance(
        ...
        @Get(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql"
                + "/managedInstances/{managedInstanceName}/startStopSchedules/{startStopScheduleName}")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<StartStopManagedInstanceScheduleInner>> get(
            @HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("managedInstanceName") String managedInstanceName,
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<StartStopManagedInstanceScheduleInner>> createOrUpdate(
            @HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("managedInstanceName") String managedInstanceName,
            @PathParam("startStopScheduleName") StartStopScheduleName startStopScheduleName,
    ...
    private Mono<PagedResponse<StartStopManagedInstanceScheduleInner>> listByInstanceSinglePageAsync(
                ...
                context ->
                    service
                        .listByInstance(
                            ...
                            accept,
                            context))
            .<PagedResponse<StartStopManagedInstanceScheduleInner>>map(
                res ->
    ...
    private PagedFlux<StartStopManagedInstanceScheduleInner> listByInstanceAsync(
        String resourceGroupName, String managedInstanceName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<StartStopManagedInstanceScheduleInner> listByInstance(
        String resourceGroupName, String managedInstanceName) {
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the managed instance's Start/Stop schedule along with {@link Response} on successful completion of {@link
     *     Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<StartStopManagedInstanceScheduleInner>> getWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<StartStopManagedInstanceScheduleInner> getAsync(
        String resourceGroupName, String managedInstanceName, StartStopScheduleName startStopScheduleName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<StartStopManagedInstanceScheduleInner> getWithResponse(
        String resourceGroupName,
        String managedInstanceName,
        StartStopScheduleName startStopScheduleName,
        Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public StartStopManagedInstanceScheduleInner get(
        String resourceGroupName, String managedInstanceName, StartStopScheduleName startStopScheduleName) {
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return managed instance's Start/Stop schedule along with {@link Response} on successful completion of {@link
     *     Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<StartStopManagedInstanceScheduleInner> createOrUpdateAsync(
        String resourceGroupName,
        String managedInstanceName,
        StartStopScheduleName startStopScheduleName,
        StartStopManagedInstanceScheduleInner parameters) {
        return createOrUpdateWithResponseAsync(
                resourceGroupName, managedInstanceName, startStopScheduleName, parameters)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<StartStopManagedInstanceScheduleInner> createOrUpdateWithResponse(
        String resourceGroupName,
        String managedInstanceName,
        StartStopScheduleName startStopScheduleName,
        StartStopManagedInstanceScheduleInner parameters,
        Context context) {
        return createOrUpdateWithResponseAsync(
                resourceGroupName, managedInstanceName, startStopScheduleName, parameters, context)
            .block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public StartStopManagedInstanceScheduleInner createOrUpdate(
        String resourceGroupName,
        String managedInstanceName,
        StartStopScheduleName startStopScheduleName,
        StartStopManagedInstanceScheduleInner parameters) {
        return createOrUpdateWithResponse(
                resourceGroupName, managedInstanceName, startStopScheduleName, parameters, Context.NONE)
            .getValue();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<StartStopManagedInstanceScheduleInner>> listByInstanceNextSinglePageAsync(
        String nextLink) {
        if (nextLink == null) {
