...
public final class ManagedServerSecurityAlertPolicyImpl implements ManagedServerSecurityAlertPolicy,
    ManagedServerSecurityAlertPolicy.Definition, ManagedServerSecurityAlertPolicy.Update {
    ...
    public ManagedServerSecurityAlertPolicyImpl withExistingManagedInstance(String resourceGroupName,
    ...
    public ManagedServerSecurityAlertPolicy create() {
        this.innerObject = serviceManager.serviceClient().getManagedServerSecurityAlertPolicies().createOrUpdate(
    ...
    ManagedServerSecurityAlertPolicyImpl(SecurityAlertPolicyNameAutoGenerated name,
    ...
    ManagedServerSecurityAlertPolicyImpl(ManagedServerSecurityAlertPolicyInner innerObject,
        com.azure.resourcemanager.sql.generated.SqlManager serviceManager) {
        this.innerObject = innerObject;
        this.serviceManager = serviceManager;
        this.resourceGroupName = Utils.getValueFromIdByName(innerObject.id(), "resourceGroups");
        this.managedInstanceName = Utils.getValueFromIdByName(innerObject.id(), "managedInstances");
        this.securityAlertPolicyName = SecurityAlertPolicyNameAutoGenerated
    ...
    public ManagedServerSecurityAlertPolicy refresh() {
        this.innerObject = serviceManager.serviceClient().getManagedServerSecurityAlertPolicies()
            .getWithResponse(resourceGroupName, managedInstanceName, securityAlertPolicyName, Context.NONE).getValue();
        return this;
    }

    public ManagedServerSecurityAlertPolicy refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getManagedServerSecurityAlertPolicies()
            .getWithResponse(resourceGroupName, managedInstanceName, securityAlertPolicyName, context).getValue();
        return this;
    }
