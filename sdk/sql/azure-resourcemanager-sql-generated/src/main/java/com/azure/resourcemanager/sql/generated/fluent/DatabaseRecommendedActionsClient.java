...
public interface DatabaseRecommendedActionsClient {
    ...
    Response<List<RecommendedActionAutoGeneratedInner>> listByDatabaseAdvisorWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    List<RecommendedActionAutoGeneratedInner> listByDatabaseAdvisor(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<RecommendedActionAutoGeneratedInner> getWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    RecommendedActionAutoGeneratedInner get(
        String resourceGroupName,
        String serverName,
        String databaseName,
        String advisorName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<RecommendedActionAutoGeneratedInner> updateWithResponse(
        String resourceGroupName,
        String serverName,
        String databaseName,
        String advisorName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    RecommendedActionAutoGeneratedInner update(
        String resourceGroupName,
        String serverName,
        String databaseName,
        String advisorName,
