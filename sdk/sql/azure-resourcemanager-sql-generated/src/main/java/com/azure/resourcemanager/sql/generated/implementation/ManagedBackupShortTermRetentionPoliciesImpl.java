...
public final class ManagedBackupShortTermRetentionPoliciesImpl implements ManagedBackupShortTermRetentionPolicies {
    ...
    public ManagedBackupShortTermRetentionPoliciesImpl(ManagedBackupShortTermRetentionPoliciesClient innerClient,
        com.azure.resourcemanager.sql.generated.SqlManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public PagedIterable<ManagedBackupShortTermRetentionPolicy> listByDatabase(String resourceGroupName,
    ...
    public ManagedBackupShortTermRetentionPolicy getById(String id) {
        ...
        String policyNameLocal = ResourceManagerUtils.getValueFromIdByName(id, "backupShortTermRetentionPolicies");
        if (policyNameLocal == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(String.format(
                "The resource ID '%s' is not valid. Missing path segment 'backupShortTermRetentionPolicies'.", id)));
        }
        ManagedShortTermRetentionPolicyName policyName
            = ManagedShortTermRetentionPolicyName.fromString(policyNameLocal);
