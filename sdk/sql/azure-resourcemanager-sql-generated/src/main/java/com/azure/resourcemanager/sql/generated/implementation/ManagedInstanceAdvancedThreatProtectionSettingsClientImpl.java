...
public final class ManagedInstanceAdvancedThreatProtectionSettingsClientImpl
    ...
    private interface ManagedInstanceAdvancedThreatProtectionSettingsService {
        @Headers({"Content-Type: application/json"})
        @Get(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql"
                + "/managedInstances/{managedInstanceName}/advancedThreatProtectionSettings")
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ManagedInstanceAdvancedThreatProtectionInner> getAsync(
        String resourceGroupName,
        String managedInstanceName,
        AdvancedThreatProtectionName advancedThreatProtectionName) {
    ...
    public ManagedInstanceAdvancedThreatProtectionInner get(
        ...
        String managedInstanceName,
        AdvancedThreatProtectionName advancedThreatProtectionName) {
        return getAsync(resourceGroupName, managedInstanceName, advancedThreatProtectionName).block();
    }
