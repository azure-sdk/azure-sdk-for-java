...
public final class ServerConfigurationOptionsClientImpl implements ServerConfigurationOptionsClient {
    ...
    /**
     * The interface defining all the services for SqlManagementClientServerConfigurationOptions to be used by the
    ...
    private Mono<Response<ServerConfigurationOptionInner>> getWithResponseAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(context -> service.get(this.client.getEndpoint(), resourceGroupName, managedInstanceName,
                serverConfigurationOptionName, this.client.getSubscriptionId(), this.client.getApiVersion(), accept,
                context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ServerConfigurationOptionInner> getAsync(String resourceGroupName, String managedInstanceName,
    ...
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(context -> service.createOrUpdate(this.client.getEndpoint(), resourceGroupName,
                managedInstanceName, serverConfigurationOptionName, this.client.getSubscriptionId(),
    ...
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String resourceGroupName,
        ...
        return service.createOrUpdate(this.client.getEndpoint(), resourceGroupName, managedInstanceName,
            serverConfigurationOptionName, this.client.getSubscriptionId(), this.client.getApiVersion(), parameters,
            accept, context);
    }
    ...
    public SyncPoller<PollResult<ServerConfigurationOptionInner>, ServerConfigurationOptionInner> beginCreateOrUpdate(
        ...
        ServerConfigurationOptionName serverConfigurationOptionName, ServerConfigurationOptionInner parameters,
        Context context) {
        return this.beginCreateOrUpdateAsync(resourceGroupName, managedInstanceName, serverConfigurationOptionName,
