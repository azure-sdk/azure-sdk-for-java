...
import com.azure.resourcemanager.sql.generated.models.ServerConfigurationOptionListResult;
...
public final class ServerConfigurationOptionsClientImpl implements ServerConfigurationOptionsClient {
    ...
    ServerConfigurationOptionsClientImpl(SqlManagementClientImpl client) {
        this.service =
            RestProxy
                .create(
                    ServerConfigurationOptionsService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }
    ...
    public interface ServerConfigurationOptionsService {
        ...
        @Get(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql"
                + "/managedInstances/{managedInstanceName}/serverConfigurationOptions")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ServerConfigurationOptionListResult>> listByManagedInstance(
        ...
        @Get(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql"
                + "/managedInstances/{managedInstanceName}/serverConfigurationOptions/{serverConfigurationOptionName}")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ServerConfigurationOptionInner>> get(
            @HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("managedInstanceName") String managedInstanceName,
    ...
    private Mono<PagedResponse<ServerConfigurationOptionInner>> listByManagedInstanceSinglePageAsync(
                ...
                context ->
                    service
                        .listByManagedInstance(
                            ...
                            accept,
                            context))
            .<PagedResponse<ServerConfigurationOptionInner>>map(
                res ->
    ...
    private PagedFlux<ServerConfigurationOptionInner> listByManagedInstanceAsync(
        String resourceGroupName, String managedInstanceName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<ServerConfigurationOptionInner> listByManagedInstance(
        String resourceGroupName, String managedInstanceName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ServerConfigurationOptionInner>> getWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ServerConfigurationOptionInner> getAsync(
        String resourceGroupName,
        String managedInstanceName,
        ServerConfigurationOptionName serverConfigurationOptionName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ServerConfigurationOptionInner> getWithResponse(
        String resourceGroupName,
        String managedInstanceName,
        ServerConfigurationOptionName serverConfigurationOptionName,
        Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ServerConfigurationOptionInner get(
        String resourceGroupName,
        String managedInstanceName,
        ServerConfigurationOptionName serverConfigurationOptionName) {
    ...
    private PollerFlux<PollResult<ServerConfigurationOptionInner>, ServerConfigurationOptionInner>
        ...
        Mono<Response<Flux<ByteBuffer>>> mono =
            createOrUpdateWithResponseAsync(
                resourceGroupName, managedInstanceName, serverConfigurationOptionName, parameters);
        return this
            .client
            .<ServerConfigurationOptionInner, ServerConfigurationOptionInner>getLroResult(
                mono,
    ...
    private PollerFlux<PollResult<ServerConfigurationOptionInner>, ServerConfigurationOptionInner>
        ...
        Mono<Response<Flux<ByteBuffer>>> mono =
            createOrUpdateWithResponseAsync(
                resourceGroupName, managedInstanceName, serverConfigurationOptionName, parameters, context);
        return this
            .client
            .<ServerConfigurationOptionInner, ServerConfigurationOptionInner>getLroResult(
                mono,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ServerConfigurationOptionInner> createOrUpdateAsync(
        String resourceGroupName,
        String managedInstanceName,
        ServerConfigurationOptionName serverConfigurationOptionName,
        ServerConfigurationOptionInner parameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ServerConfigurationOptionInner createOrUpdate(
        String resourceGroupName,
        String managedInstanceName,
        ServerConfigurationOptionName serverConfigurationOptionName,
        ServerConfigurationOptionInner parameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<ServerConfigurationOptionInner>> listByManagedInstanceNextSinglePageAsync(
        String nextLink) {
        if (nextLink == null) {
