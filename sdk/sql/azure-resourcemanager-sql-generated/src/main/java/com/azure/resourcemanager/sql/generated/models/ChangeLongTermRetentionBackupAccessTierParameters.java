...
public final class ChangeLongTermRetentionBackupAccessTierParameters {
     ...
     */
    public ChangeLongTermRetentionBackupAccessTierParameters withBackupStorageAccessTier(
    ...
    public void validate() {
            ...
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException(
                        "Missing required property backupStorageAccessTier in model"
        ...
        if (operationMode() == null) {
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException(
                        "Missing required property operationMode in model"
                            + " ChangeLongTermRetentionBackupAccessTierParameters"));
        }
    }
