...
public final class ServerConnectionPoliciesImpl implements ServerConnectionPolicies {
    ...
    public ServerConnectionPoliciesImpl(ServerConnectionPoliciesClient innerClient,
    ...
    public PagedIterable<ServerConnectionPolicy> listByServer(String resourceGroupName, String serverName) {
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new ServerConnectionPolicyImpl(inner1, this.manager()));
    }
    ...
    public Response<ServerConnectionPolicy> getWithResponse(String resourceGroupName, String serverName,
    ...
    public ServerConnectionPolicy get(String resourceGroupName, String serverName,
    ...
    public ServerConnectionPolicy getById(String id) {
        ...
        String connectionPolicyNameLocal = ResourceManagerUtils.getValueFromIdByName(id, "connectionPolicies");
        if (connectionPolicyNameLocal == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
                String.format("The resource ID '%s' is not valid. Missing path segment 'connectionPolicies'.", id)));
        }
