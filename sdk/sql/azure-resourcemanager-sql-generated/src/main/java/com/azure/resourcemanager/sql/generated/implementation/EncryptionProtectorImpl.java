...
public final class EncryptionProtectorImpl
    ...
    public EncryptionProtector create() {
        this.innerObject = serviceManager.serviceClient().getEncryptionProtectors().createOrUpdate(resourceGroupName,
            serverName, encryptionProtectorName, this.innerModel(), Context.NONE);
        return this;
    }

    public EncryptionProtector create(Context context) {
        this.innerObject = serviceManager.serviceClient().getEncryptionProtectors().createOrUpdate(resourceGroupName,
            serverName, encryptionProtectorName, this.innerModel(), context);
        return this;
    }
    ...
    public EncryptionProtector refresh() {
        this.innerObject = serviceManager.serviceClient().getEncryptionProtectors()
            .getWithResponse(resourceGroupName, serverName, encryptionProtectorName, Context.NONE).getValue();
        return this;
    }

    public EncryptionProtector refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getEncryptionProtectors()
            .getWithResponse(resourceGroupName, serverName, encryptionProtectorName, context).getValue();
        return this;
    }

    public void revalidate() {
        serviceManager.encryptionProtectors().revalidate(resourceGroupName, serverName, encryptionProtectorName);
    }
    ...
    public EncryptionProtectorImpl withAutoRotationEnabled(Boolean autoRotationEnabled) {
