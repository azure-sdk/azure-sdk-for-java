...
public final class DatabaseEncryptionProtectorsClientImpl implements DatabaseEncryptionProtectorsClient {
    ...
    DatabaseEncryptionProtectorsClientImpl(SqlManagementClientImpl client) {
        this.service =
            RestProxy
                .create(
                    DatabaseEncryptionProtectorsService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }
    ...
    public interface DatabaseEncryptionProtectorsService {
        ...
        @Post(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers"
                + "/{serverName}/databases/{databaseName}/encryptionProtector/{encryptionProtectorName}/revalidate")
        ...
        @Post(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers"
                + "/{serverName}/databases/{databaseName}/encryptionProtector/{encryptionProtectorName}/revert")
        @ExpectedResponses({200, 202})
        @UnexpectedResponseExceptionType(ManagementException.class)
    ...
    private PollerFlux<PollResult<Void>, Void> beginRevalidateAsync(
        ...
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono =
            revalidateWithResponseAsync(resourceGroupName, serverName, databaseName, encryptionProtectorName, context);
        return this
            .client
    ...
    public SyncPoller<PollResult<Void>, Void> beginRevalidate(
        ...
        EncryptionProtectorName encryptionProtectorName) {
        return this
            .beginRevalidateAsync(resourceGroupName, serverName, databaseName, encryptionProtectorName)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginRevalidate(
        ...
        Context context) {
        return this
            .beginRevalidateAsync(resourceGroupName, serverName, databaseName, encryptionProtectorName, context)
            .getSyncPoller();
    }
    ...
    private Mono<Void> revalidateAsync(
        ...
        String databaseName,
        EncryptionProtectorName encryptionProtectorName) {
        return beginRevalidateAsync(resourceGroupName, serverName, databaseName, encryptionProtectorName)
            .last()
    ...
    public SyncPoller<PollResult<Void>, Void> beginRevert(
        ...
        EncryptionProtectorName encryptionProtectorName) {
        return this
            .beginRevertAsync(resourceGroupName, serverName, databaseName, encryptionProtectorName)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginRevert(
        ...
        Context context) {
        return this
            .beginRevertAsync(resourceGroupName, serverName, databaseName, encryptionProtectorName, context)
            .getSyncPoller();
    }
    ...
    private Mono<Void> revertAsync(
        ...
        String databaseName,
        EncryptionProtectorName encryptionProtectorName) {
        return beginRevertAsync(resourceGroupName, serverName, databaseName, encryptionProtectorName)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<Void> revertAsync(
        ...
        EncryptionProtectorName encryptionProtectorName,
        Context context) {
        return beginRevertAsync(resourceGroupName, serverName, databaseName, encryptionProtectorName, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
