...
public final class DatabaseEncryptionProtectorsClientImpl implements DatabaseEncryptionProtectorsClient {
    ...
    private Mono<Response<Flux<ByteBuffer>>> revalidateWithResponseAsync(String resourceGroupName, String serverName,
        ...
        return FluxUtil
            .withContext(
                context -> service.revalidate(this.client.getEndpoint(), resourceGroupName, serverName, databaseName,
    ...
    private Mono<Response<Flux<ByteBuffer>>> revertWithResponseAsync(String resourceGroupName, String serverName,
        ...
        return FluxUtil
            .withContext(
                context -> service.revert(this.client.getEndpoint(), resourceGroupName, serverName, databaseName,
                    encryptionProtectorName, this.client.getSubscriptionId(), this.client.getApiVersion(), context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
