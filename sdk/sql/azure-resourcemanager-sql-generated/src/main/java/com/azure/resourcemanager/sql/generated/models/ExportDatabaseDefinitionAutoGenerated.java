...
@Fluent
public final class ExportDatabaseDefinitionAutoGenerated {
    /*
     * Storage key type.
     */
     ...
     * @return the ExportDatabaseDefinitionAutoGenerated object itself.
     */
    public ExportDatabaseDefinitionAutoGenerated withStorageKeyType(StorageKeyType storageKeyType) {
     ...
     * @return the ExportDatabaseDefinitionAutoGenerated object itself.
     */
    public ExportDatabaseDefinitionAutoGenerated withStorageKey(String storageKey) {
     ...
     * @return the ExportDatabaseDefinitionAutoGenerated object itself.
     */
    public ExportDatabaseDefinitionAutoGenerated withStorageUri(String storageUri) {
     ...
     * @return the ExportDatabaseDefinitionAutoGenerated object itself.
     */
    public ExportDatabaseDefinitionAutoGenerated withAdministratorLogin(String administratorLogin) {
     ...
     * @return the ExportDatabaseDefinitionAutoGenerated object itself.
     */
    public ExportDatabaseDefinitionAutoGenerated withAdministratorLoginPassword(String administratorLoginPassword) {
     ...
     * @return the ExportDatabaseDefinitionAutoGenerated object itself.
     */
    public ExportDatabaseDefinitionAutoGenerated withAuthenticationType(String authenticationType) {
     ...
     * @return the ExportDatabaseDefinitionAutoGenerated object itself.
     */
    public ExportDatabaseDefinitionAutoGenerated withNetworkIsolation(NetworkIsolationSettings networkIsolation) {
            ...
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException(
                        "Missing required property storageKeyType in model ExportDatabaseDefinitionAutoGenerated"));
        }
        if (storageKey() == null) {
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException(
                        "Missing required property storageKey in model ExportDatabaseDefinitionAutoGenerated"));
        }
        if (storageUri() == null) {
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException(
                        "Missing required property storageUri in model ExportDatabaseDefinitionAutoGenerated"));
        }
        if (administratorLogin() == null) {
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException(
                        "Missing required property administratorLogin in model ExportDatabaseDefinitionAutoGenerated"));
        }
                ...
                .logExceptionAsError(
                    new IllegalArgumentException(
                        "Missing required property administratorLoginPassword in model"
                            + " ExportDatabaseDefinitionAutoGenerated"));
        }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(ExportDatabaseDefinitionAutoGenerated.class);
}
