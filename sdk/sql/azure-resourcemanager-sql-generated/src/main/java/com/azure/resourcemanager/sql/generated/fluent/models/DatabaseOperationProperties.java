...
public final class DatabaseOperationProperties {
    ...
    /*
     * The operation phase code.
     */
    @JsonProperty(value = "phaseCode", access = JsonProperty.Access.WRITE_ONLY)
    private Integer phaseCode;

    /*
     * The operation phase description.
     */
    @JsonProperty(value = "phaseDescription", access = JsonProperty.Access.WRITE_ONLY)
