...
public final class DeletedServerProperties {
    ...
    /*
     * The fully qualified domain name of the server before deletion.
     */
    @JsonProperty(value = "fullyQualifiedDomainName", access = JsonProperty.Access.WRITE_ONLY)
    private String fullyQualifiedDomainName;

    /*
     * Time at which the server data will be purged, after which server restore will no longer be possible. If this is
     * `null`, then default behavior will be used.
     */
    ...
    /**
     * Get the fullyQualifiedDomainName property: The fully qualified domain name of the server before deletion.
     *
    ...
    /**
     * Get the scheduledPurgeDate property: Time at which the server data will be purged, after which server restore
     * will no longer be possible. If this is `null`, then default behavior will be used.
     *
