...
public final class JobCredentialImpl implements JobCredential, JobCredential.Definition, JobCredential.Update {
    ...
    public JobCredential create() {
        this.innerObject
            = serviceManager.serviceClient().getJobCredentials().createOrUpdateWithResponse(resourceGroupName,
                serverName, jobAgentName, credentialName, this.innerModel(), Context.NONE).getValue();
        return this;
    }
    ...
    public JobCredential create(Context context) {
        this.innerObject
            = serviceManager.serviceClient().getJobCredentials().createOrUpdateWithResponse(resourceGroupName,
                serverName, jobAgentName, credentialName, this.innerModel(), context).getValue();
        return this;
    }
    ...
    JobCredentialImpl(JobCredentialInner innerObject,
    ...
    public JobCredential refresh() {
        this.innerObject = serviceManager.serviceClient().getJobCredentials()
            .getWithResponse(resourceGroupName, serverName, jobAgentName, credentialName, Context.NONE).getValue();
        return this;
    }

    public JobCredential refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getJobCredentials()
            .getWithResponse(resourceGroupName, serverName, jobAgentName, credentialName, context).getValue();
        return this;
    }
