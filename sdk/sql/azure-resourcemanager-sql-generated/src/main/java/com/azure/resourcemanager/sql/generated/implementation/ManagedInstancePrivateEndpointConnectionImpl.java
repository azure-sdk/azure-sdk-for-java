...
public final class ManagedInstancePrivateEndpointConnectionImpl implements ManagedInstancePrivateEndpointConnection,
    ManagedInstancePrivateEndpointConnection.Definition, ManagedInstancePrivateEndpointConnection.Update {
    ...
    public ManagedInstancePrivateEndpointConnectionImpl withExistingManagedInstance(String resourceGroupName,
    ...
    public ManagedInstancePrivateEndpointConnection create() {
        this.innerObject = serviceManager.serviceClient().getManagedInstancePrivateEndpointConnections().createOrUpdate(
            resourceGroupName, managedInstanceName, privateEndpointConnectionName, this.innerModel(), Context.NONE);
        return this;
    }
    ...
    ManagedInstancePrivateEndpointConnectionImpl(String name,
    ...
    ManagedInstancePrivateEndpointConnectionImpl(ManagedInstancePrivateEndpointConnectionInner innerObject,
        com.azure.resourcemanager.sql.generated.SqlManager serviceManager) {
    ...
    public ManagedInstancePrivateEndpointConnection refresh() {
        this.innerObject = serviceManager.serviceClient().getManagedInstancePrivateEndpointConnections()
    ...
    public ManagedInstancePrivateEndpointConnection refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getManagedInstancePrivateEndpointConnections()
            .getWithResponse(resourceGroupName, managedInstanceName, privateEndpointConnectionName, context).getValue();
        return this;
    }

    public ManagedInstancePrivateEndpointConnectionImpl
