...
public interface Databases {
     ...
     * @return a list of databases as paginated response with {@link PagedIterable}.
     */
    PagedIterable<DatabaseAutoGenerated> listByServer(String resourceGroupName, String serverName);
     ...
     * @return a list of databases as paginated response with {@link PagedIterable}.
     */
    PagedIterable<DatabaseAutoGenerated> listByServer(
        String resourceGroupName, String serverName, String skipToken, Context context);
     ...
     * @return a database.
     */
    DatabaseAutoGenerated get(String resourceGroupName, String serverName, String databaseName);
     ...
     * @return a database along with {@link Response}.
     */
    Response<DatabaseAutoGenerated> getWithResponse(
        String resourceGroupName, String serverName, String databaseName, Context context);
     ...
     * @return a database resource.
     */
    DatabaseAutoGenerated pause(String resourceGroupName, String serverName, String databaseName);
     ...
     * @return a database resource.
     */
    DatabaseAutoGenerated pause(String resourceGroupName, String serverName, String databaseName, Context context);
     ...
     * @return a database resource.
     */
    DatabaseAutoGenerated resume(String resourceGroupName, String serverName, String databaseName);
     ...
     * @return a database resource.
     */
    DatabaseAutoGenerated resume(String resourceGroupName, String serverName, String databaseName, Context context);
     ...
     * @return a list of databases in an elastic pool as paginated response with {@link PagedIterable}.
     */
    PagedIterable<DatabaseAutoGenerated> listByElasticPool(
     ...
     * @return a list of inaccessible databases in a logical server as paginated response with {@link PagedIterable}.
     */
    PagedIterable<DatabaseAutoGenerated> listInaccessibleByServer(String resourceGroupName, String serverName);
     ...
     * @return a list of inaccessible databases in a logical server as paginated response with {@link PagedIterable}.
     */
    PagedIterable<DatabaseAutoGenerated> listInaccessibleByServer(
    ...
    /**
     * Begins definition for a new DatabaseAutoGenerated resource.
     *
     * @param name resource name.
     * @return the first stage of the new DatabaseAutoGenerated definition.
     */
    DatabaseAutoGenerated.DefinitionStages.Blank define(String name);
}
