...
public final class ManagedInstanceLongTermRetentionPolicyImpl implements ManagedInstanceLongTermRetentionPolicy,
    ManagedInstanceLongTermRetentionPolicy.Definition, ManagedInstanceLongTermRetentionPolicy.Update {
    ...
    public BackupStorageAccessTier backupStorageAccessTier() {
        return this.innerModel().backupStorageAccessTier();
    }
    ...
    public ManagedInstanceLongTermRetentionPolicyImpl withExistingDatabase(String resourceGroupName,
    ...
    public ManagedInstanceLongTermRetentionPolicy create() {
        this.innerObject = serviceManager.serviceClient().getManagedInstanceLongTermRetentionPolicies().createOrUpdate(
    ...
    ManagedInstanceLongTermRetentionPolicyImpl(ManagedInstanceLongTermRetentionPolicyName name,
    ...
    ManagedInstanceLongTermRetentionPolicyImpl(ManagedInstanceLongTermRetentionPolicyInner innerObject,
        com.azure.resourcemanager.sql.generated.SqlManager serviceManager) {
        ...
        this.policyName = ManagedInstanceLongTermRetentionPolicyName
            .fromString(ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "backupLongTermRetentionPolicies"));
    }

    public ManagedInstanceLongTermRetentionPolicy refresh() {
        this.innerObject = serviceManager.serviceClient().getManagedInstanceLongTermRetentionPolicies()
            .getWithResponse(resourceGroupName, managedInstanceName, databaseName, policyName, Context.NONE).getValue();
        return this;
    }

    public ManagedInstanceLongTermRetentionPolicy refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getManagedInstanceLongTermRetentionPolicies()
            .getWithResponse(resourceGroupName, managedInstanceName, databaseName, policyName, context).getValue();
        return this;
    }
    ...
    public ManagedInstanceLongTermRetentionPolicyImpl
        ...
        this.innerModel().withBackupStorageAccessTier(backupStorageAccessTier);
        return this;
    }
