...
public final class ManagedDatabaseSecurityEventsImpl implements ManagedDatabaseSecurityEvents {
    ...
    public ManagedDatabaseSecurityEventsImpl(ManagedDatabaseSecurityEventsClient innerClient,
        com.azure.resourcemanager.sql.generated.SqlManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public PagedIterable<SecurityEvent> listByDatabase(String resourceGroupName, String managedInstanceName,
        String databaseName) {
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new SecurityEventImpl(inner1, this.manager()));
    }

    public PagedIterable<SecurityEvent> listByDatabase(String resourceGroupName, String managedInstanceName,
        String databaseName, String filter, Integer skip, Integer top, String skiptoken, Context context) {
        PagedIterable<SecurityEventInner> inner = this.serviceClient().listByDatabase(resourceGroupName,
            managedInstanceName, databaseName, filter, skip, top, skiptoken, context);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new SecurityEventImpl(inner1, this.manager()));
    }
