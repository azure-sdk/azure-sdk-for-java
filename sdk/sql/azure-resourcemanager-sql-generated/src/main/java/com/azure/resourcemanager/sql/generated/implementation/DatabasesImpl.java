...
public final class DatabasesImpl implements Databases {
    ...
    public PagedIterable<Metric> listMetrics(String resourceGroupName, String serverName, String databaseName,
        String filter) {
        PagedIterable<MetricInner> inner
            = this.serviceClient().listMetrics(resourceGroupName, serverName, databaseName, filter);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new MetricImpl(inner1, this.manager()));
    }
    ...
    public PagedIterable<MetricDefinition> listMetricDefinitions(String resourceGroupName, String serverName,
        String databaseName) {
    ...
    public PagedIterable<Database> listByServer(String resourceGroupName, String serverName, String skipToken,
        Context context) {
    ...
    public Response<Database> getWithResponse(String resourceGroupName, String serverName, String databaseName,
        String expand, String filter, Context context) {
        Response<DatabaseInner> inner = this.serviceClient().getWithResponse(resourceGroupName, serverName,
            databaseName, expand, filter, context);
        if (inner != null) {
    ...
    public ImportExportOperationResult export(String resourceGroupName, String serverName, String databaseName,
    ...
    public ImportExportOperationResult importMethod(String resourceGroupName, String serverName, String databaseName,
    ...
    public Response<Void> renameWithResponse(String resourceGroupName, String serverName, String databaseName,
        ...
        return this.serviceClient().renameWithResponse(resourceGroupName, serverName, databaseName, parameters,
            context);
    }
    ...
    public PagedIterable<Database> listByElasticPool(String resourceGroupName, String serverName,
    ...
    public Database getById(String id) {
        ...
        return this.getWithResponse(resourceGroupName, serverName, databaseName, localExpand, localFilter, Context.NONE)
            .getValue();
    }

    public Response<Database> getByIdWithResponse(String id, String expand, String filter, Context context) {
        String resourceGroupName = ResourceManagerUtils.getValueFromIdByName(id, "resourceGroups");
        if (resourceGroupName == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
                String.format("The resource ID '%s' is not valid. Missing path segment 'resourceGroups'.", id)));
        ...
        return this.getWithResponse(resourceGroupName, serverName, databaseName, expand, filter, context);
    }
