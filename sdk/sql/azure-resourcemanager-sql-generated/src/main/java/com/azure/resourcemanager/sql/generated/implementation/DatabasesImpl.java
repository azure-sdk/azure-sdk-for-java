...
public final class DatabasesImpl implements Databases {
    ...
    public PagedIterable<DatabaseAutoGenerated> listByServer(String resourceGroupName, String serverName) {
        PagedIterable<DatabaseAutoGeneratedInner> inner =
            this.serviceClient().listByServer(resourceGroupName, serverName);
        return Utils.mapPage(inner, inner1 -> new DatabaseAutoGeneratedImpl(inner1, this.manager()));
    }

    public PagedIterable<DatabaseAutoGenerated> listByServer(
        String resourceGroupName, String serverName, String skipToken, Context context) {
        PagedIterable<DatabaseAutoGeneratedInner> inner =
            this.serviceClient().listByServer(resourceGroupName, serverName, skipToken, context);
        return Utils.mapPage(inner, inner1 -> new DatabaseAutoGeneratedImpl(inner1, this.manager()));
    ...
    public DatabaseAutoGenerated get(String resourceGroupName, String serverName, String databaseName) {
        DatabaseAutoGeneratedInner inner = this.serviceClient().get(resourceGroupName, serverName, databaseName);
        if (inner != null) {
            return new DatabaseAutoGeneratedImpl(inner, this.manager());
        } else {
            return null;
        }
    }

    public Response<DatabaseAutoGenerated> getWithResponse(
        String resourceGroupName, String serverName, String databaseName, Context context) {
        Response<DatabaseAutoGeneratedInner> inner =
            this.serviceClient().getWithResponse(resourceGroupName, serverName, databaseName, context);
        if (inner != null) {
            return new SimpleResponse<>(
                inner.getRequest(),
                inner.getStatusCode(),
                inner.getHeaders(),
                new DatabaseAutoGeneratedImpl(inner.getValue(), this.manager()));
        } else {
            return null;
        }
    }
    ...
    public DatabaseAutoGenerated pause(String resourceGroupName, String serverName, String databaseName) {
        DatabaseAutoGeneratedInner inner = this.serviceClient().pause(resourceGroupName, serverName, databaseName);
        if (inner != null) {
            return new DatabaseAutoGeneratedImpl(inner, this.manager());
        } else {
            return null;
    ...
    public DatabaseAutoGenerated pause(
        String resourceGroupName, String serverName, String databaseName, Context context) {
        DatabaseAutoGeneratedInner inner =
    ...
    public DatabaseAutoGenerated resume(String resourceGroupName, String serverName, String databaseName) {
        DatabaseAutoGeneratedInner inner = this.serviceClient().resume(resourceGroupName, serverName, databaseName);
        if (inner != null) {
            return new DatabaseAutoGeneratedImpl(inner, this.manager());
        } else {
            return null;
    ...
    public PagedIterable<DatabaseAutoGenerated> listByElasticPool(
        String resourceGroupName, String serverName, String elasticPoolName) {
        PagedIterable<DatabaseAutoGeneratedInner> inner =
            this.serviceClient().listByElasticPool(resourceGroupName, serverName, elasticPoolName);
        return Utils.mapPage(inner, inner1 -> new DatabaseAutoGeneratedImpl(inner1, this.manager()));
    ...
    public PagedIterable<DatabaseAutoGenerated> listInaccessibleByServer(String resourceGroupName, String serverName) {
        PagedIterable<DatabaseAutoGeneratedInner> inner =
            this.serviceClient().listInaccessibleByServer(resourceGroupName, serverName);
        return Utils.mapPage(inner, inner1 -> new DatabaseAutoGeneratedImpl(inner1, this.manager()));
    }

    public PagedIterable<DatabaseAutoGenerated> listInaccessibleByServer(
        String resourceGroupName, String serverName, Context context) {
        PagedIterable<DatabaseAutoGeneratedInner> inner =
            this.serviceClient().listInaccessibleByServer(resourceGroupName, serverName, context);
        return Utils.mapPage(inner, inner1 -> new DatabaseAutoGeneratedImpl(inner1, this.manager()));
    ...
    public DatabaseAutoGeneratedImpl define(String name) {
        return new DatabaseAutoGeneratedImpl(name, this.manager());
    }
}
