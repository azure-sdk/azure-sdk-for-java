...
public final class DatabaseBlobAuditingPolicyImpl
    ...
    public DatabaseBlobAuditingPolicyImpl withExistingDatabase(String resourceGroupName, String serverName,
        String databaseName) {
    ...
    public DatabaseBlobAuditingPolicy create() {
        this.innerObject = serviceManager.serviceClient().getDatabaseBlobAuditingPolicies()
    ...
    DatabaseBlobAuditingPolicyImpl(com.azure.resourcemanager.sql.generated.SqlManager serviceManager) {
    ...
    DatabaseBlobAuditingPolicyImpl(DatabaseBlobAuditingPolicyInner innerObject,
    ...
    public DatabaseBlobAuditingPolicyImpl withIsManagedIdentityInUse(Boolean isManagedIdentityInUse) {
