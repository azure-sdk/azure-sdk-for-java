...
public interface ManagedInstanceLongTermRetentionPolicy {
    ...
    /**
     * Gets the weeklyRetention property: The weekly retention policy for an LTR backup.
     * 
    ...
    /**
     * Gets the monthlyRetention property: The monthly retention policy for an LTR backup.
     * 
    ...
    /**
     * Gets the yearlyRetention property: The yearly retention policy for an LTR backup.
     * 
    ...
    /**
     * Gets the weekOfYear property: The week of year to take the yearly backup.
     * 
    ...
    interface DefinitionStages {
         ...
         */
        interface WithCreate extends DefinitionStages.WithBackupStorageAccessTier, DefinitionStages.WithWeeklyRetention,
            DefinitionStages.WithMonthlyRetention, DefinitionStages.WithYearlyRetention,
        ...
        /**
         * The stage of the ManagedInstanceLongTermRetentionPolicy definition allowing to specify
        ...
        interface WithWeeklyRetention {
            /**
             * Specifies the weeklyRetention property: The weekly retention policy for an LTR backup..
             * 
             * @param weeklyRetention The weekly retention policy for an LTR backup.
             * @return the next definition stage.
             */
        ...
        interface WithMonthlyRetention {
            /**
             * Specifies the monthlyRetention property: The monthly retention policy for an LTR backup..
             * 
             * @param monthlyRetention The monthly retention policy for an LTR backup.
             * @return the next definition stage.
             */
        ...
        interface WithYearlyRetention {
            /**
             * Specifies the yearlyRetention property: The yearly retention policy for an LTR backup..
             * 
             * @param yearlyRetention The yearly retention policy for an LTR backup.
             * @return the next definition stage.
             */
        ...
        interface WithWeekOfYear {
            /**
             * Specifies the weekOfYear property: The week of year to take the yearly backup..
             * 
             * @param weekOfYear The week of year to take the yearly backup.
             * @return the next definition stage.
             */
     ...
     */
    interface Update extends UpdateStages.WithBackupStorageAccessTier, UpdateStages.WithWeeklyRetention,
        UpdateStages.WithMonthlyRetention, UpdateStages.WithYearlyRetention, UpdateStages.WithWeekOfYear {
        /**
    ...
    interface UpdateStages {
        /**
         * The stage of the ManagedInstanceLongTermRetentionPolicy update allowing to specify backupStorageAccessTier.
         */
        interface WithBackupStorageAccessTier {
            /**
             * Specifies the backupStorageAccessTier property: The BackupStorageAccessTier for the LTR backups.
