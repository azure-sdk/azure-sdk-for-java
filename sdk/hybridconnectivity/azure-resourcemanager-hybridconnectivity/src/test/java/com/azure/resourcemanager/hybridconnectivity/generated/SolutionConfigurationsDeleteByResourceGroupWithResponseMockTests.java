...
public final class SolutionConfigurationsDeleteByResourceGroupWithResponseMockTests {
    @Test
    public void testDeleteWithResponse() throws Exception {
        ...
        manager.solutionConfigurations()
            .deleteByResourceGroupWithResponse("elpcirelsfeaenwa", "fatkld", com.azure.core.util.Context.NONE);
