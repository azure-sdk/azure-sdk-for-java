...
public final class EndpointsDeleteByResourceGroupWithResponseMockTests {
    @Test
    public void testDeleteWithResponse() throws Exception {
        ...
        manager.endpoints().deleteByResourceGroupWithResponse("bxwyjsflhhcaa", "n", com.azure.core.util.Context.NONE);
