...
public final class GenerateAwsTemplateRequestTests {
    ...
    public void testDeserialize() throws Exception {
        GenerateAwsTemplateRequest model = BinaryData.fromString(
            "{\"connectorId\":\"biksq\",\"solutionTypes\":[{\"solutionType\":\"ssainqpjwnzll\",\"solutionSettings\":{\"\":{\"vmgxsab\":\"pee\",\"jczdzevndh\":\"yqduujit\",\"feusnhut\":\"rwpdappdsbdkvwrw\"}}},{\"solutionType\":\"eltmrldhugjzzdat\",\"solutionSettings\":{\"\":{\"lgphu\":\"cdgea\"}}}]}")
            .toObject(GenerateAwsTemplateRequest.class);
        Assertions.assertEquals("biksq", model.connectorId());
        Assertions.assertEquals("ssainqpjwnzll", model.solutionTypes().get(0).solutionType());
    }

    @org.junit.jupiter.api.Test
    public void testSerialize() throws Exception {
        GenerateAwsTemplateRequest model = new GenerateAwsTemplateRequest().withConnectorId("biksq")
            .withSolutionTypes(Arrays.asList(
                new SolutionTypeSettings().withSolutionType("ssainqpjwnzll")
                    .withSolutionSettings(new SolutionSettings().withAdditionalProperties(mapOf())),
                new SolutionTypeSettings().withSolutionType("eltmrldhugjzzdat")
                    .withSolutionSettings(new SolutionSettings().withAdditionalProperties(mapOf()))));
