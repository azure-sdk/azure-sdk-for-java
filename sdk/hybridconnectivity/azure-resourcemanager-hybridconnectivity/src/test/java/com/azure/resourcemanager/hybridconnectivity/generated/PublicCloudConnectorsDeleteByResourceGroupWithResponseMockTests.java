...
public final class PublicCloudConnectorsDeleteByResourceGroupWithResponseMockTests {
    @Test
    public void testDeleteWithResponse() throws Exception {
        ...
        manager.publicCloudConnectors()
            .deleteByResourceGroupWithResponse("swacffgdkzz", "wkfvhqcrailvp", com.azure.core.util.Context.NONE);
