...
public final class SolutionConfigurationsGetWithResponseMockTests {
    ...
    public void testGetWithResponse() throws Exception {
        String responseStr
            = "{\"properties\":{\"provisioningState\":\"Canceled\",\"solutionType\":\"iohgwxrtfud\",\"solutionSettings\":{\"\":{\"himdbl\":\"gyqagvrvmnpkuk\"}},\"status\":\"New\",\"statusDetails\":\"mfnjh\",\"lastSyncTime\":\"2021-04-05T14:46:39Z\"},\"id\":\"mszkkfo\",\"name\":\"rey\",\"type\":\"kzikfjawneaivxwc\"}";
        ...
        SolutionConfiguration response = manager.solutionConfigurations()
            .getWithResponse("mtdaa", "gdv", com.azure.core.util.Context.NONE)
            .getValue();

        Assertions.assertEquals("iohgwxrtfud", response.properties().solutionType());
    }
}
