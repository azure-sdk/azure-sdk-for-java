...
public final class InventoryPropertiesTests {
    ...
    public void testDeserialize() throws Exception {
        InventoryProperties model = BinaryData.fromString(
            "{\"cloudNativeType\":\"ec2\",\"cloudNativeResourceId\":\"yqjpkcatt\",\"azureResourceId\":\"gjcrcczsqpjhvm\",\"status\":\"Completed\",\"statusDetails\":\"nysounqe\",\"provisioningState\":\"Canceled\"}")
            .toObject(InventoryProperties.class);
        Assertions.assertEquals(CloudNativeType.EC2, model.cloudNativeType());
        Assertions.assertEquals("yqjpkcatt", model.cloudNativeResourceId());
        Assertions.assertEquals("gjcrcczsqpjhvm", model.azureResourceId());
        Assertions.assertEquals(SolutionConfigurationStatus.COMPLETED, model.status());
        Assertions.assertEquals("nysounqe", model.statusDetails());
    }
}
