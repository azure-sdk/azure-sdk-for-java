...
public final class SolutionConfigurationsCreateOrUpdateWithResponseMockTests {
    ...
    public void testCreateOrUpdateWithResponse() throws Exception {
        String responseStr
            = "{\"properties\":{\"provisioningState\":\"Failed\",\"solutionType\":\"lhbnxkna\",\"solutionSettings\":{\"\":{\"dtpnapnyiropuhp\":\"ppg\"}},\"status\":\"Failed\",\"statusDetails\":\"gylgqgitxmedjvcs\",\"lastSyncTime\":\"2021-02-26T17:22:44Z\"},\"id\":\"wwncwzzhxgk\",\"name\":\"rmgucnap\",\"type\":\"t\"}";
        ...
        SolutionConfiguration response = manager.solutionConfigurations()
            .define("eilpjzuaejxdu")
            .withExistingResourceUri("vzunluthnnprnxi")
            .withProperties(new SolutionConfigurationProperties().withSolutionType("zbbtdzumveek")
                .withSolutionSettings(new SolutionSettings().withAdditionalProperties(mapOf())))
            .create();

        Assertions.assertEquals("lhbnxkna", response.properties().solutionType());
    }
