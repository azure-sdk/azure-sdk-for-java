...
public final class SolutionTypeSettingsTests {
    ...
    public void testDeserialize() throws Exception {
        SolutionTypeSettings model = BinaryData.fromString(
            "{\"solutionType\":\"sx\",\"solutionSettings\":{\"\":{\"zehtbmu\":\"dxbmtqioq\",\"wnoi\":\"p\",\"bqsoqijg\":\"hwlrx\"}}}")
            .toObject(SolutionTypeSettings.class);
        Assertions.assertEquals("sx", model.solutionType());
    }

    @org.junit.jupiter.api.Test
    public void testSerialize() throws Exception {
        SolutionTypeSettings model = new SolutionTypeSettings().withSolutionType("sx")
