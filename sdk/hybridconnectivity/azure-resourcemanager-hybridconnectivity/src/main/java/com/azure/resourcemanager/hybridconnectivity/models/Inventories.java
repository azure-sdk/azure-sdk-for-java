...
public interface Inventories {
     ...
     */
    PagedIterable<InventoryResource> listByWidget(String resourceUri, String solutionConfiguration);
     ...
     * @return the response of a InventoryResource list operation as paginated response with {@link PagedIterable}.
     */
    PagedIterable<InventoryResource> listByWidget(String resourceUri, String solutionConfiguration, Context context);
