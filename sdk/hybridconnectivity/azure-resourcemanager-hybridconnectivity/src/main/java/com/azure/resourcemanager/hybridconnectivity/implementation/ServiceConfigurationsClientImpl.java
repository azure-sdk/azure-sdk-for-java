...
public final class ServiceConfigurationsClientImpl implements ServiceConfigurationsClient {
    ...
    public interface ServiceConfigurationsService {
        ...
        Mono<Response<HybridConnectivityServiceConfigurationInner>> get(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam(value = "resourceUri", encoded = true) String resourceUri,
            @PathParam("endpointName") String endpointName,
            @PathParam("serviceConfigurationName") String serviceConfigurationName,
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<HybridConnectivityServiceConfigurationInner>> createOrupdate(
            @HostParam("endpoint") String endpoint, @QueryParam("api-version") String apiVersion,
            @PathParam(value = "resourceUri", encoded = true) String resourceUri,
            @PathParam("endpointName") String endpointName,
            @PathParam("serviceConfigurationName") String serviceConfigurationName,
            @HeaderParam("Content-Type") String contentType, @HeaderParam("Accept") String accept,
            @BodyParam("application/json") HybridConnectivityServiceConfigurationInner serviceConfigurationResource,
            Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<HybridConnectivityServiceConfigurationInner>> update(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam(value = "resourceUri", encoded = true) String resourceUri,
            @PathParam("endpointName") String endpointName,
            @PathParam("serviceConfigurationName") String serviceConfigurationName,
    ...
    private Mono<Response<HybridConnectivityServiceConfigurationInner>> getWithResponseAsync(String resourceUri,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<HybridConnectivityServiceConfigurationInner> getAsync(String resourceUri, String endpointName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<HybridConnectivityServiceConfigurationInner> getWithResponse(String resourceUri,
        String endpointName, String serviceConfigurationName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public HybridConnectivityServiceConfigurationInner get(String resourceUri, String endpointName,
        String serviceConfigurationName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<HybridConnectivityServiceConfigurationInner>> createOrupdateWithResponseAsync(
        String resourceUri, String endpointName, String serviceConfigurationName,
        HybridConnectivityServiceConfigurationInner serviceConfigurationResource) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    private Mono<Response<HybridConnectivityServiceConfigurationInner>> createOrupdateWithResponseAsync(
        String resourceUri, String endpointName, String serviceConfigurationName,
        HybridConnectivityServiceConfigurationInner serviceConfigurationResource, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<HybridConnectivityServiceConfigurationInner> createOrupdateAsync(String resourceUri,
        String endpointName, String serviceConfigurationName,
        HybridConnectivityServiceConfigurationInner serviceConfigurationResource) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<HybridConnectivityServiceConfigurationInner> createOrupdateWithResponse(String resourceUri,
        String endpointName, String serviceConfigurationName,
        HybridConnectivityServiceConfigurationInner serviceConfigurationResource, Context context) {
        return createOrupdateWithResponseAsync(resourceUri, endpointName, serviceConfigurationName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public HybridConnectivityServiceConfigurationInner createOrupdate(String resourceUri, String endpointName,
        String serviceConfigurationName, HybridConnectivityServiceConfigurationInner serviceConfigurationResource) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<HybridConnectivityServiceConfigurationInner>> updateWithResponseAsync(String resourceUri,
        String endpointName, String serviceConfigurationName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<HybridConnectivityServiceConfigurationInner> updateAsync(String resourceUri, String endpointName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<HybridConnectivityServiceConfigurationInner> updateWithResponse(String resourceUri,
        String endpointName, String serviceConfigurationName,
        ServiceConfigurationResourcePatch serviceConfigurationResource, Context context) {
        return updateWithResponseAsync(resourceUri, endpointName, serviceConfigurationName,
            serviceConfigurationResource, context).block();
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public HybridConnectivityServiceConfigurationInner update(String resourceUri, String endpointName,
        String serviceConfigurationName, ServiceConfigurationResourcePatch serviceConfigurationResource) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<HybridConnectivityServiceConfigurationInner>>
        ...
        return FluxUtil
            ...
            .<PagedResponse<HybridConnectivityServiceConfigurationInner>>map(
    ...
    private PagedFlux<HybridConnectivityServiceConfigurationInner> listByEndpointResourceAsync(String resourceUri,
        String endpointName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<HybridConnectivityServiceConfigurationInner> listByEndpointResource(String resourceUri,
        String endpointName) {
