...
public final class PublicCloudConnectorsImpl implements PublicCloudConnectors {
    ...
    public TestPermissionResult testPermissions(String resourceGroupName, String publicCloudConnector) {
        TestPermissionResultInner inner = this.serviceClient().testPermissions(resourceGroupName, publicCloudConnector);
        if (inner != null) {
            return new TestPermissionResultImpl(inner, this.manager());
        } else {
            return null;
        }
    }
    ...
    public TestPermissionResult testPermissions(String resourceGroupName, String publicCloudConnector,
        Context context) {
        TestPermissionResultInner inner
