...
public final class ServiceConfigurationProperties implements JsonSerializable<ServiceConfigurationProperties> {
     ...
     * Name of the service.
     */
    private HybridConnectivityServiceName serviceName;
     ...
     */
    private HybridConnectivityProvisioningState provisioningState;
     ...
     */
    public ServiceConfigurationProperties withServiceName(HybridConnectivityServiceName serviceName) {
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("serviceName".equals(fieldName)) {
                    deserializedServiceConfigurationProperties.serviceName
                        = HybridConnectivityServiceName.fromString(reader.getString());
                    ...
                    deserializedServiceConfigurationProperties.provisioningState
                        = HybridConnectivityProvisioningState.fromString(reader.getString());
                } else {
                    reader.skipChildren();
                }
            }
