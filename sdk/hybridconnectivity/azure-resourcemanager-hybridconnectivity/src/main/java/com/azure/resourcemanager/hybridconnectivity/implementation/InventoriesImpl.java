...
public final class InventoriesImpl implements Inventories {
    ...
    public PagedIterable<InventoryResource> listByWidget(String resourceUri, String solutionConfiguration) {
        PagedIterable<InventoryResourceInner> inner
            = this.serviceClient().listByWidget(resourceUri, solutionConfiguration);
    ...
    public PagedIterable<InventoryResource> listByWidget(String resourceUri, String solutionConfiguration,
        Context context) {
        PagedIterable<InventoryResourceInner> inner
            = this.serviceClient().listByWidget(resourceUri, solutionConfiguration, context);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new InventoryResourceImpl(inner1, this.manager()));
    }
