...
public final class EndpointProperties {
    ...
    /*
     * The enabled service configurations.
     */
    @JsonProperty(value = "serviceConfigurations")
     ...
     * @return the EndpointProperties object itself.
     */
    public EndpointProperties withServiceConfigurations(List<ServiceConfiguration> serviceConfigurations) {
    ...
    public void validate() {
        ...
        if (serviceConfigurations() != null) {
            serviceConfigurations().forEach(e -> e.validate());
        }
    }
