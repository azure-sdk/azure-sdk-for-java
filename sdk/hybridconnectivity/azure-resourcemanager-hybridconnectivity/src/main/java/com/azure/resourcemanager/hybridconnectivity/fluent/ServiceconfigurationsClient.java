...
public interface ServiceconfigurationsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<ServiceConfigurationResourceInner> createWithResponse(String resourceUri, String endpointName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ServiceConfigurationResourceInner create(String resourceUri, String endpointName, String serviceConfigurationName,
