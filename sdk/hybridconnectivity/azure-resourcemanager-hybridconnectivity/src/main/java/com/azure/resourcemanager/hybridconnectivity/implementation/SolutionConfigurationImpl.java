...
public final class SolutionConfigurationImpl
    ...
    public void syncNow() {
        serviceManager.solutionConfigurations().syncNow(resourceUri, solutionConfiguration);
    }

    public void syncNow(Context context) {
        serviceManager.solutionConfigurations().syncNow(resourceUri, solutionConfiguration, context);
    }
