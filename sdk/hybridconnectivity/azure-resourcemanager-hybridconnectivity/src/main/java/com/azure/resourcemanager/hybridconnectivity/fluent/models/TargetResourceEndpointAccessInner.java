 ...
 */
@Immutable
public final class TargetResourceEndpointAccessInner implements JsonSerializable<TargetResourceEndpointAccessInner> {
    /*
    ...
    /**
     * Creates an instance of TargetResourceEndpointAccessInner class.
     */
    private TargetResourceEndpointAccessInner() {
    }
    ...
    /**
     * Reads an instance of TargetResourceEndpointAccessInner from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of TargetResourceEndpointAccessInner if the JsonReader was pointing to an instance of it, or
     * null if it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the TargetResourceEndpointAccessInner.
     */
    public static TargetResourceEndpointAccessInner fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            TargetResourceEndpointAccessInner deserializedTargetResourceEndpointAccessInner
                = new TargetResourceEndpointAccessInner();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("relay".equals(fieldName)) {
                    deserializedTargetResourceEndpointAccessInner.innerRelay
            ...
            return deserializedTargetResourceEndpointAccessInner;
        });
    }
}
