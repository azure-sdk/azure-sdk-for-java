 ...
 */
@Immutable
public final class IngressGatewayAssetInner implements JsonSerializable<IngressGatewayAssetInner> {
    /*
    ...
    /**
     * Creates an instance of IngressGatewayAssetInner class.
     */
    private IngressGatewayAssetInner() {
    }
    ...
    /**
     * Reads an instance of IngressGatewayAssetInner from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of IngressGatewayAssetInner if the JsonReader was pointing to an instance of it, or null if
     * it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the IngressGatewayAssetInner.
     */
    public static IngressGatewayAssetInner fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            IngressGatewayAssetInner deserializedIngressGatewayAssetInner = new IngressGatewayAssetInner();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("relay".equals(fieldName)) {
                    deserializedIngressGatewayAssetInner.innerRelay = RelayNamespaceAccessProperties.fromJson(reader);
                } else if ("ingress".equals(fieldName)) {
                    deserializedIngressGatewayAssetInner.innerIngress = IngressProfileProperties.fromJson(reader);
                } else {
                    reader.skipChildren();
                }
            }

            return deserializedIngressGatewayAssetInner;
        });
    }
}
