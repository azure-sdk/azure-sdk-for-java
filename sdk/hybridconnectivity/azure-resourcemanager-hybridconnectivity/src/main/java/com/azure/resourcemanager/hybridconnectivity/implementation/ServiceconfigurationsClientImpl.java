...
public final class ServiceconfigurationsClientImpl implements ServiceconfigurationsClient {
    ...
    public interface ServiceconfigurationsService {
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ServiceConfigurationResourceInner>> create(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam(value = "resourceUri", encoded = true) String resourceUri,
            @PathParam(value = "endpointName", encoded = true) String endpointName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ServiceConfigurationResourceInner>> createWithResponseAsync(
        String resourceUri,
        String endpointName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ServiceConfigurationResourceInner> createAsync(
        String resourceUri,
        String endpointName,
        String serviceConfigurationName,
        ServiceConfigurationResourceInner serviceConfigurationResource) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ServiceConfigurationResourceInner> createWithResponse(
        String resourceUri,
        String endpointName,
        String serviceConfigurationName,
        ServiceConfigurationResourceInner serviceConfigurationResource,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ServiceConfigurationResourceInner create(
        String resourceUri,
        String endpointName,
        String serviceConfigurationName,
        ServiceConfigurationResourceInner serviceConfigurationResource) {
