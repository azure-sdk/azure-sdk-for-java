...
public final class ServiceconfigurationsClientImpl implements ServiceconfigurationsClient {
    ...
    public interface ServiceconfigurationsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ServiceConfigurationResourceInner>> create(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam(value = "resourceUri", encoded = true) String resourceUri,
            @PathParam(value = "endpointName", encoded = true) String endpointName,
            @PathParam(value = "serviceConfigurationName", encoded = true) String serviceConfigurationName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ServiceConfigurationResourceInner>> createWithResponseAsync(String resourceUri,
        String endpointName, String serviceConfigurationName,
    ...
    private Mono<Response<ServiceConfigurationResourceInner>> createWithResponseAsync(String resourceUri,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.create(this.client.getEndpoint(), this.client.getApiVersion(), resourceUri, endpointName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ServiceConfigurationResourceInner> createAsync(String resourceUri, String endpointName,
        String serviceConfigurationName, ServiceConfigurationResourceInner serviceConfigurationResource) {
        return createWithResponseAsync(resourceUri, endpointName, serviceConfigurationName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ServiceConfigurationResourceInner> createWithResponse(String resourceUri, String endpointName,
        String serviceConfigurationName, ServiceConfigurationResourceInner serviceConfigurationResource,
        Context context) {
        return createWithResponseAsync(resourceUri, endpointName, serviceConfigurationName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ServiceConfigurationResourceInner create(String resourceUri, String endpointName,
        String serviceConfigurationName, ServiceConfigurationResourceInner serviceConfigurationResource) {
        return createWithResponse(resourceUri, endpointName, serviceConfigurationName, serviceConfigurationResource,
