...
public final class EndpointsList implements JsonSerializable<EndpointsList> {
     ...
     */
    private List<HybridConnectivityEndpointInner> value;
     ...
     */
    public List<HybridConnectivityEndpointInner> value() {
        return this.value;
    }
    ...
    public void validate() {
        if (value() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Missing required property value in model EndpointsList"));
        } else {
            value().forEach(e -> e.validate());
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(EndpointsList.class);
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("value".equals(fieldName)) {
                    List<HybridConnectivityEndpointInner> value
                        = reader.readArray(reader1 -> HybridConnectivityEndpointInner.fromJson(reader1));
