...
public final class EndpointResourceImpl
    ...
    public List<ServiceConfiguration> serviceConfigurations() {
        List<ServiceConfiguration> inner = this.innerModel().serviceConfigurations();
        if (inner != null) {
    ...
    public EndpointResourceImpl withServiceConfigurations(List<ServiceConfiguration> serviceConfigurations) {
        this.innerModel().withServiceConfigurations(serviceConfigurations);
        return this;
    }
}
