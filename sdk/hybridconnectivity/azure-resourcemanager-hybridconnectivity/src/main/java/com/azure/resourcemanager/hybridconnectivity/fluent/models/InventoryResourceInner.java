...
public final class InventoryResourceInner extends ProxyResource {
     ...
     */
    public InventoryResourceInner withProperties(InventoryProperties properties) {
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("id".equals(fieldName)) {
                    ...
                    deserializedInventoryResourceInner.properties = InventoryProperties.fromJson(reader);
