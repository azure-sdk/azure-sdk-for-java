...
public interface PublicCloudConnectorsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<TestPermissionResultInner>, TestPermissionResultInner>
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    TestPermissionResultInner testPermissions(String resourceGroupName, String publicCloudConnector);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    TestPermissionResultInner testPermissions(String resourceGroupName, String publicCloudConnector, Context context);
}
