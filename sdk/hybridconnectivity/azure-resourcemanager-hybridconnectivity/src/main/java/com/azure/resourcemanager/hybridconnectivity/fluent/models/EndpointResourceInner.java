...
public final class EndpointResourceInner extends ProxyResource {
    ...
    /**
     * Get the serviceConfigurations property: The enabled service configurations.
     *
     * @return the serviceConfigurations value.
     */
    public List<ServiceConfiguration> serviceConfigurations() {
        return this.innerProperties() == null ? null : this.innerProperties().serviceConfigurations();
    }

    /**
     * Set the serviceConfigurations property: The enabled service configurations.
     *
     * @param serviceConfigurations the serviceConfigurations value to set.
     * @return the EndpointResourceInner object itself.
     */
    public EndpointResourceInner withServiceConfigurations(List<ServiceConfiguration> serviceConfigurations) {
        if (this.innerProperties() == null) {
            this.innerProperties = new EndpointProperties();
        }
        this.innerProperties().withServiceConfigurations(serviceConfigurations);
        return this;
    }
