...
public final class InventoriesClientImpl implements InventoriesClient {
    ...
    public interface InventoriesService {
        ...
        Mono<Response<InventoryResourceListResult>> listByWidget(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<InventoryResourceListResult>> listByWidgetNext(
    ...
    private Mono<PagedResponse<InventoryResourceInner>> listByWidgetSinglePageAsync(String resourceUri,
        ...
        return FluxUtil
            .withContext(context -> service.listByWidget(this.client.getEndpoint(), this.client.getApiVersion(),
                resourceUri, solutionConfiguration, accept, context))
    ...
    private Mono<PagedResponse<InventoryResourceInner>> listByWidgetSinglePageAsync(String resourceUri,
        ...
        return service
            .listByWidget(this.client.getEndpoint(), this.client.getApiVersion(), resourceUri, solutionConfiguration,
                accept, context)
    ...
    private PagedFlux<InventoryResourceInner> listByWidgetAsync(String resourceUri, String solutionConfiguration) {
        return new PagedFlux<>(() -> listByWidgetSinglePageAsync(resourceUri, solutionConfiguration),
            nextLink -> listByWidgetNextSinglePageAsync(nextLink));
    }
    ...
    private PagedFlux<InventoryResourceInner> listByWidgetAsync(String resourceUri, String solutionConfiguration,
        Context context) {
        return new PagedFlux<>(() -> listByWidgetSinglePageAsync(resourceUri, solutionConfiguration, context),
            nextLink -> listByWidgetNextSinglePageAsync(nextLink, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<InventoryResourceInner> listByWidget(String resourceUri, String solutionConfiguration) {
        return new PagedIterable<>(listByWidgetAsync(resourceUri, solutionConfiguration));
    }
    ...
    public PagedIterable<InventoryResourceInner> listByWidget(String resourceUri, String solutionConfiguration,
        Context context) {
        return new PagedIterable<>(listByWidgetAsync(resourceUri, solutionConfiguration, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<InventoryResourceInner>> listByWidgetNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.listByWidgetNext(nextLink, this.client.getEndpoint(), accept, context))
            .<PagedResponse<InventoryResourceInner>>map(res -> new PagedResponseBase<>(res.getRequest(),
                res.getStatusCode(), res.getHeaders(), res.getValue().value(), res.getValue().nextLink(), null))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<PagedResponse<InventoryResourceInner>> listByWidgetNextSinglePageAsync(String nextLink,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.listByWidgetNext(nextLink, this.client.getEndpoint(), accept, context)
            .map(res -> new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(),
                res.getValue().value(), res.getValue().nextLink(), null));
    }
}
