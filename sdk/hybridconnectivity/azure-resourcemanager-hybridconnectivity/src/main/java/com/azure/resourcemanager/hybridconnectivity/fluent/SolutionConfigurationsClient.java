...
public interface SolutionConfigurationsClient {
    ...
    SyncPoller<PollResult<Void>, Void> beginSyncNow(String resourceUri, String solutionConfiguration);
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<Void>, Void> beginSyncNow(String resourceUri, String solutionConfiguration, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    void syncNow(String resourceUri, String solutionConfiguration);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    void syncNow(String resourceUri, String solutionConfiguration, Context context);
}
