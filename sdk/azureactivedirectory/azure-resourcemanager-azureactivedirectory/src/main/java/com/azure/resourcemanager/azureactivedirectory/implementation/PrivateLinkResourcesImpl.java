...
public final class PrivateLinkResourcesImpl implements PrivateLinkResources {
    ...
    public PagedIterable<PrivateLinkResource> listByPrivateLinkPolicy(String resourceGroupName, String policyName) {
    ...
    public Response<PrivateLinkResource> getWithResponse(String resourceGroupName, String policyName, String groupName,
        Context context) {
