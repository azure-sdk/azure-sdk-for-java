...
public final class PrivateLinkForAzureAdsClientImpl implements PrivateLinkForAzureAdsClient {
    ...
    PrivateLinkForAzureAdsClientImpl(AzureactivedirectoryImpl client) {
        this.service = RestProxy.create(PrivateLinkForAzureAdsService.class, client.getHttpPipeline(),
    ...
    public interface PrivateLinkForAzureAdsService {
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<PrivateLinkPolicyInner>> update(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("policyName") String policyName,
            @QueryParam("api-version") String apiVersion,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<PrivateLinkPolicyInner>> getByResourceGroup(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("policyName") String policyName,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<PrivateLinkPolicyListResult>> list(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<PrivateLinkPolicyListResult>> listByResourceGroup(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
     ...
     * @return privateLink Policy configuration object along with {@link Response} on successful completion of
     * {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> createWithResponseAsync(String resourceGroupName, String policyName,
        PrivateLinkPolicyInner privateLinkPolicy) {
        ...
        return FluxUtil
            .withContext(context -> service.create(this.client.getEndpoint(), this.client.getSubscriptionId(),
                resourceGroupName, policyName, this.client.getApiVersion(), privateLinkPolicy, accept, context))
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> createWithResponseAsync(String resourceGroupName, String policyName,
        PrivateLinkPolicyInner privateLinkPolicy, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service.create(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName, policyName,
            this.client.getApiVersion(), privateLinkPolicy, accept, context);
    }
    ...
    private PollerFlux<PollResult<PrivateLinkPolicyInner>, PrivateLinkPolicyInner>
        beginCreateAsync(String resourceGroupName, String policyName, PrivateLinkPolicyInner privateLinkPolicy) {
        Mono<Response<Flux<ByteBuffer>>> mono
            = createWithResponseAsync(resourceGroupName, policyName, privateLinkPolicy);
        return this.client.<PrivateLinkPolicyInner, PrivateLinkPolicyInner>getLroResult(mono,
            this.client.getHttpPipeline(), PrivateLinkPolicyInner.class, PrivateLinkPolicyInner.class,
    ...
    private PollerFlux<PollResult<PrivateLinkPolicyInner>, PrivateLinkPolicyInner> beginCreateAsync(
        ...
        return this.client.<PrivateLinkPolicyInner, PrivateLinkPolicyInner>getLroResult(mono,
            this.client.getHttpPipeline(), PrivateLinkPolicyInner.class, PrivateLinkPolicyInner.class, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<PrivateLinkPolicyInner>, PrivateLinkPolicyInner> beginCreate(String resourceGroupName,
        String policyName, PrivateLinkPolicyInner privateLinkPolicy) {
        return this.beginCreateAsync(resourceGroupName, policyName, privateLinkPolicy).getSyncPoller();
    }
    ...
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<PrivateLinkPolicyInner>, PrivateLinkPolicyInner> beginCreate(String resourceGroupName,
        String policyName, PrivateLinkPolicyInner privateLinkPolicy, Context context) {
        return this.beginCreateAsync(resourceGroupName, policyName, privateLinkPolicy, context).getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PrivateLinkPolicyInner> createAsync(String resourceGroupName, String policyName,
        PrivateLinkPolicyInner privateLinkPolicy) {
        return beginCreateAsync(resourceGroupName, policyName, privateLinkPolicy).last()
    ...
    private Mono<PrivateLinkPolicyInner> createAsync(String resourceGroupName, String policyName,
        PrivateLinkPolicyInner privateLinkPolicy, Context context) {
        return beginCreateAsync(resourceGroupName, policyName, privateLinkPolicy, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public PrivateLinkPolicyInner create(String resourceGroupName, String policyName,
        PrivateLinkPolicyInner privateLinkPolicy) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<PrivateLinkPolicyInner>> updateWithResponseAsync(String resourceGroupName, String policyName,
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<PrivateLinkPolicyInner>> updateWithResponseAsync(String resourceGroupName, String policyName,
        PrivateLinkPolicyUpdateParameter privateLinkPolicy, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.update(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName, policyName,
            this.client.getApiVersion(), privateLinkPolicy, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<PrivateLinkPolicyInner> updateWithResponse(String resourceGroupName, String policyName,
        PrivateLinkPolicyUpdateParameter privateLinkPolicy, Context context) {
    ...
    public PrivateLinkPolicyInner update(String resourceGroupName, String policyName) {
        final PrivateLinkPolicyUpdateParameter privateLinkPolicy = null;
        return updateWithResponse(resourceGroupName, policyName, privateLinkPolicy, Context.NONE).getValue();
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a private link policy with a given name along with {@link Response} on successful completion of
     * {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<PrivateLinkPolicyInner>> getByResourceGroupWithResponseAsync(String resourceGroupName,
        String policyName) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        return FluxUtil
            .withContext(
                context -> service.getByResourceGroup(this.client.getEndpoint(), this.client.getSubscriptionId(),
                    resourceGroupName, policyName, this.client.getApiVersion(), accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<PrivateLinkPolicyInner> getByResourceGroupWithResponse(String resourceGroupName, String policyName,
        Context context) {
    ...
    private Mono<Response<Void>> deleteWithResponseAsync(String resourceGroupName, String policyName, Context context) {
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.delete(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName, policyName,
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a list of private link policies along with {@link PagedResponse} on successful completion of
     * {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<PrivateLinkPolicyInner>> listSinglePageAsync() {
        ...
        return FluxUtil
            .withContext(context -> service.list(this.client.getEndpoint(), this.client.getSubscriptionId(),
                this.client.getApiVersion(), accept, context))
            .<PagedResponse<PrivateLinkPolicyInner>>map(res -> new PagedResponseBase<>(res.getRequest(),
