...
public final class DiagnosticSettingsOperationsClientImpl implements DiagnosticSettingsOperationsClient {
     ...
     */
    DiagnosticSettingsOperationsClientImpl(AzureactivedirectoryImpl client) {
        this.service =
            RestProxy
                .create(
    ...
    /**
     * The interface defining all the services for AzureactivedirectoryDiagnosticSettingsOperations to be used by the
     ...
     * @return the active diagnostic settings list for AadIam along with {@link Response} on successful completion of
     *     {@link Mono}.
     */
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the active diagnostic settings list for AadIam on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the active diagnostic setting for AadIam along with {@link Response} on successful completion of {@link
     *     Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the active diagnostic setting for AadIam on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ...
    private Mono<DiagnosticSettingsResourceInner> createOrUpdateAsync(
        String name, DiagnosticSettingsResourceInner parameters) {
        return createOrUpdateWithResponseAsync(name, parameters).flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
