...
public final class PrivateLinkResourcesClientImpl implements PrivateLinkResourcesClient {
    ...
    public interface PrivateLinkResourcesService {
        ...
        Mono<Response<PrivateLinkResourceListResult>> listByPrivateLinkPolicy(@HostParam("$host") String endpoint,
     ...
     * @return the private link resources that need to be created for a policy of AzureAD along with
     * {@link PagedResponse} on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<PrivateLinkResourceInner>>
        listByPrivateLinkPolicySinglePageAsync(String resourceGroupName, String policyName) {
        ...
        return FluxUtil
            .withContext(
                context -> service.listByPrivateLinkPolicy(this.client.getEndpoint(), this.client.getSubscriptionId(),
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<PrivateLinkResourceInner>>
        listByPrivateLinkPolicySinglePageAsync(String resourceGroupName, String policyName, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service
            .listByPrivateLinkPolicy(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
    ...
    private PagedFlux<PrivateLinkResourceInner> listByPrivateLinkPolicyAsync(String resourceGroupName,
        String policyName) {
        return new PagedFlux<>(() -> listByPrivateLinkPolicySinglePageAsync(resourceGroupName, policyName),
    ...
    private PagedFlux<PrivateLinkResourceInner> listByPrivateLinkPolicyAsync(String resourceGroupName,
        ...
        return new PagedFlux<>(() -> listByPrivateLinkPolicySinglePageAsync(resourceGroupName, policyName, context),
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<PrivateLinkResourceInner> listByPrivateLinkPolicy(String resourceGroupName,
        String policyName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<PrivateLinkResourceInner> listByPrivateLinkPolicy(String resourceGroupName, String policyName,
        Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<PrivateLinkResourceInner>> getWithResponseAsync(String resourceGroupName, String policyName,
        String groupName) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        return FluxUtil
            .withContext(context -> service.get(this.client.getEndpoint(), this.client.getSubscriptionId(),
                resourceGroupName, policyName, groupName, this.client.getApiVersion(), accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<PrivateLinkResourceInner>> getWithResponseAsync(String resourceGroupName, String policyName,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.get(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName, policyName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<PrivateLinkResourceInner> getWithResponse(String resourceGroupName, String policyName,
        String groupName, Context context) {
    ...
    public PrivateLinkResourceInner get(String resourceGroupName, String policyName, String groupName) {
        return getWithResponse(resourceGroupName, policyName, groupName, Context.NONE).getValue();
    }
    ...
    private Mono<PagedResponse<PrivateLinkResourceInner>> listByPrivateLinkPolicyNextSinglePageAsync(String nextLink,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.listByPrivateLinkPolicyNext(nextLink, this.client.getEndpoint(), accept, context)
            .map(res -> new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(),
                res.getValue().value(), res.getValue().nextLink(), null));
    }
}
