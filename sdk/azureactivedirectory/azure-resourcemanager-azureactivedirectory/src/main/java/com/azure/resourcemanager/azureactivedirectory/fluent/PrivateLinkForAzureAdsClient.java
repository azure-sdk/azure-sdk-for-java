...
public interface PrivateLinkForAzureAdsClient {
    ...
    SyncPoller<PollResult<PrivateLinkPolicyInner>, PrivateLinkPolicyInner> beginCreate(String resourceGroupName,
    ...
    PrivateLinkPolicyInner create(String resourceGroupName, String policyName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    PrivateLinkPolicyInner create(String resourceGroupName, String policyName, PrivateLinkPolicyInner privateLinkPolicy,
        Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<PrivateLinkPolicyInner> updateWithResponse(String resourceGroupName, String policyName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<PrivateLinkPolicyInner> getByResourceGroupWithResponse(String resourceGroupName, String policyName,
        Context context);
