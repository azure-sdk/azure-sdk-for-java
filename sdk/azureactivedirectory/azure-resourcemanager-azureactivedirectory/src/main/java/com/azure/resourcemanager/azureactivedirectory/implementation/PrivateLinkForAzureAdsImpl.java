...
public final class PrivateLinkForAzureAdsImpl implements PrivateLinkForAzureAds {
    ...
    public PrivateLinkForAzureAdsImpl(PrivateLinkForAzureAdsClient innerClient,
        com.azure.resourcemanager.azureactivedirectory.AzureactivedirectoryManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public Response<PrivateLinkPolicy> getByResourceGroupWithResponse(String resourceGroupName, String policyName,
        Context context) {
    ...
    public Response<Void> deleteByResourceGroupWithResponse(String resourceGroupName, String policyName,
        Context context) {
    ...
    public PagedIterable<PrivateLinkPolicy> list() {
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new PrivateLinkPolicyImpl(inner1, this.manager()));
    }
    ...
    public PrivateLinkPolicy getById(String id) {
        ...
        String policyName = ResourceManagerUtils.getValueFromIdByName(id, "privateLinkForAzureAd");
        if (policyName == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
                String.format("The resource ID '%s' is not valid. Missing path segment 'privateLinkForAzureAd'.", id)));
        }
    ...
    public void deleteById(String id) {
        ...
        this.deleteByResourceGroupWithResponse(resourceGroupName, policyName, Context.NONE);
    }
    ...
    public Response<Void> deleteByIdWithResponse(String id, Context context) {
        ...
        return this.deleteByResourceGroupWithResponse(resourceGroupName, policyName, context);
    }
