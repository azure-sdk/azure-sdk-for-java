...
public final class PrivateLinkPolicyImpl
    ...
    public PrivateLinkPolicy create() {
        this.innerObject = serviceManager.serviceClient().getPrivateLinkForAzureAds().create(resourceGroupName,
            policyName, this.innerModel(), Context.NONE);
        return this;
    }

    public PrivateLinkPolicy create(Context context) {
        this.innerObject = serviceManager.serviceClient().getPrivateLinkForAzureAds().create(resourceGroupName,
            policyName, this.innerModel(), context);
        return this;
    }

    PrivateLinkPolicyImpl(String name,
    ...
    public PrivateLinkPolicy apply() {
        this.innerObject = serviceManager.serviceClient().getPrivateLinkForAzureAds()
            .updateWithResponse(resourceGroupName, policyName, updatePrivateLinkPolicy, Context.NONE).getValue();
        return this;
    }

    public PrivateLinkPolicy apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getPrivateLinkForAzureAds()
            .updateWithResponse(resourceGroupName, policyName, updatePrivateLinkPolicy, context).getValue();
        return this;
    }

    PrivateLinkPolicyImpl(PrivateLinkPolicyInner innerObject,
        com.azure.resourcemanager.azureactivedirectory.AzureactivedirectoryManager serviceManager) {
        this.innerObject = innerObject;
        this.serviceManager = serviceManager;
        this.resourceGroupName = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "resourcegroups");
        this.policyName = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "privateLinkForAzureAd");
    }
