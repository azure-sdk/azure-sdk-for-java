...
public final class GetGatewayResourceTests extends ServiceFabricClientAPIsClientTestBase {
    @Test
    @Disabled
    public void testGetGatewayResourceTests() {
        RequestOptions requestOptions = new RequestOptions();
        Response<BinaryData> response = meshGatewayClient.getWithResponse("sampleGateway", requestOptions);
