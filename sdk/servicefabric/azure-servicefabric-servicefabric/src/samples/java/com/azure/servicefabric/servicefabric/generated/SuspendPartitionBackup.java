...
public class SuspendPartitionBackup {
    public static void main(String[] args) {
        ...
        // BEGIN:com.azure.servicefabric.servicefabric.generated.suspendpartitionbackup.suspendpartitionbackup
        RequestOptions requestOptions = new RequestOptions();
        requestOptions.addQueryParam("api-version", "6.4");
        Response<Void> response =
                serviceFabricClientAPIsClient.suspendPartitionBackupWithResponse(
                        "1daae3f5-7fd6-42e9-b1ba-8c05f873994d", requestOptions);
        // END:com.azure.servicefabric.servicefabric.generated.suspendpartitionbackup.suspendpartitionbackup
    }
}
