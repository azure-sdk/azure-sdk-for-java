...
public class CreateNewName {
    public static void main(String[] args) {
        ...
        // BEGIN:com.azure.servicefabric.servicefabric.generated.createname.createnewname
        BinaryData NameDescription =
                BinaryData.fromString("{\"Name\":\"fabric:/samples/CalculatorApp/CalculatorService/Name-1\"}");
        RequestOptions requestOptions = new RequestOptions();
        requestOptions.addQueryParam("api-version", "6.0");
        Response<Void> response = serviceFabricClientAPIsClient.createNameWithResponse(NameDescription, requestOptions);
        // END:com.azure.servicefabric.servicefabric.generated.createname.createnewname
    }
}
