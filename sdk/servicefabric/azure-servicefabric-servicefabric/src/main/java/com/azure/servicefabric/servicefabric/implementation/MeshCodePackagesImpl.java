...
public final class MeshCodePackagesImpl {
    ...
    /**
     * Initializes an instance of MeshCodePackagesImpl.
     *
     * @param client the instance of the service client containing this operation class.
     */
    MeshCodePackagesImpl(ServiceFabricClientAPIsClientImpl client) {
        this.service =
                RestProxy.create(
    ...
    private interface MeshCodePackagesService {
        ...
        Mono<Response<BinaryData>> getContainerLogs(
    ...
    public Mono<Response<BinaryData>> getContainerLogsWithResponseAsync(
