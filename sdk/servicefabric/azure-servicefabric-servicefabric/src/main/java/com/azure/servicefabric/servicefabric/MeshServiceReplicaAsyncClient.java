...
import com.azure.servicefabric.servicefabric.implementation.MeshServiceReplicasImpl;
import reactor.core.publisher.Mono;

/** Initializes a new instance of the asynchronous ServiceFabricClientAPIsClient type. */
@ServiceClient(builder = MeshServiceReplicaClientBuilder.class, isAsync = true)
public final class MeshServiceReplicaAsyncClient {
    @Generated private final MeshServiceReplicasImpl serviceClient;

    /**
     * Initializes an instance of MeshServiceReplicaAsyncClient class.
     *
     * @param serviceClient the service client implementation.
     */
    @Generated
    MeshServiceReplicaAsyncClient(MeshServiceReplicasImpl serviceClient) {
    ...
    public Mono<Response<BinaryData>> getWithResponse(
        ...
        return this.serviceClient.getWithResponseAsync(
                applicationResourceName, serviceResourceName, replicaName, requestOptions);
    }
    ...
    public Mono<Response<BinaryData>> listWithResponse(
        ...
        return this.serviceClient.listWithResponseAsync(applicationResourceName, serviceResourceName, requestOptions);
    }
}
