...
public final class CopilotSettingsClientImpl implements CopilotSettingsClient {
     ...
     */
    private final PortalServicesManagementClientImpl client;
     ...
     */
    CopilotSettingsClientImpl(PortalServicesManagementClientImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for PortalServicesManagementClientCopilotSettings to be used by the proxy
     * service to perform REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "PortalServicesManage")
