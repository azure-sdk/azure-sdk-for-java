...
import com.azure.resourcemanager.portalservicescopilot.implementation.CopilotSettingsImpl;
import com.azure.resourcemanager.portalservicescopilot.implementation.OperationsImpl;
import com.azure.resourcemanager.portalservicescopilot.implementation.PortalServicesClientBuilder;
...
/**
 * Entry point to PortalservicescopilotManager.
 * Azure Portal Services API Reference.
 */
public final class PortalservicescopilotManager {
    private Operations operations;

    private CopilotSettings copilotSettings;

    private final PortalServicesClient clientObject;

    private PortalservicescopilotManager(HttpPipeline httpPipeline, AzureProfile profile,
        Duration defaultPollInterval) {
        Objects.requireNonNull(httpPipeline, "'httpPipeline' cannot be null.");
        Objects.requireNonNull(profile, "'profile' cannot be null.");
        this.clientObject = new PortalServicesClientBuilder().pipeline(httpPipeline)
     ...
     */
    public static PortalservicescopilotManager authenticate(TokenCredential credential, AzureProfile profile) {
     ...
     * @return the portalservicescopilot service API instance.
     */
    public static PortalservicescopilotManager authenticate(HttpPipeline httpPipeline, AzureProfile profile) {
        Objects.requireNonNull(httpPipeline, "'httpPipeline' cannot be null.");
        Objects.requireNonNull(profile, "'profile' cannot be null.");
        return new PortalservicescopilotManager(httpPipeline, profile, null);
    }

    /**
     * Gets a Configurable instance that can be used to create PortalservicescopilotManager with optional configuration.
     * 
     * @return the Configurable instance allowing configurations.
     */
    public static Configurable configure() {
        return new PortalservicescopilotManager.Configurable();
    }
    ...
    public static final class Configurable {
        ...
        private static final Map<String, String> PROPERTIES
            = CoreUtils.getProperties("azure-resourcemanager-portalservicescopilot.properties");
