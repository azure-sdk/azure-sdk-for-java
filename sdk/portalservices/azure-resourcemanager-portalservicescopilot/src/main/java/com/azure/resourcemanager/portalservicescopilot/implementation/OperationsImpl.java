...
public final class OperationsImpl implements Operations {
    ...
    public PagedIterable<Operation> list(String apiVersion) {
        PagedIterable<OperationInner> inner = this.serviceClient().list(apiVersion);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new OperationImpl(inner1, this.manager()));
    }

    public PagedIterable<Operation> list(String apiVersion, Context context) {
        PagedIterable<OperationInner> inner = this.serviceClient().list(apiVersion, context);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new OperationImpl(inner1, this.manager()));
    }
