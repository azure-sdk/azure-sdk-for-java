...
import com.azure.resourcemanager.cts.fluent.OperationsClient;
...
/** Initializes a new instance of the CtsrpClientImpl type. */
@ServiceClient(builder = CtsrpClientBuilder.class)
public final class CtsrpClientImpl implements CtsrpClient {
    ...
    /**
     * Initializes an instance of CtsrpClient client.
     *
    ...
    CtsrpClientImpl(
        ...
        this.apiVersion = "2022-03-09-preview";
    ...
    private static final ClientLogger LOGGER = new ClientLogger(CtsrpClientImpl.class);
}
