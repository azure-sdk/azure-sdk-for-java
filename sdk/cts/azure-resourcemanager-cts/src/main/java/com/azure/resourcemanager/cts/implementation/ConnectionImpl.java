...
public final class ConnectionImpl implements Connection, Connection.Definition, Connection.Update {
    ...
    ConnectionImpl(String name, com.azure.resourcemanager.cts.CtsManager serviceManager) {
    ...
    ConnectionImpl(ConnectionInner innerObject, com.azure.resourcemanager.cts.CtsManager serviceManager) {
