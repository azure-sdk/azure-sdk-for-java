...
import com.azure.resourcemanager.cts.fluent.models.OperationInner;
import com.azure.resourcemanager.cts.models.OperationListResult;
...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    OperationsClientImpl(CtsrpClientImpl client) {
        this.service =
    ...
    /**
     * The interface defining all the services for CtsrpClientOperations to be used by the proxy service to perform REST
     * calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "CtsrpClientOperation")
    private interface OperationsService {
        @Headers({"Content-Type: application/json"})
        @Get("/providers/Microsoft.Cts/operations")
    ...
    /**
     * Lists all of the available Microsoft.Cts REST API operations.
     *
