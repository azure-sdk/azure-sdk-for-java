...
public final class PipelinesImpl implements Pipelines {
    ...
    public PipelinesImpl(PipelinesClient innerClient, com.azure.resourcemanager.cts.CtsManager serviceManager) {
    ...
    public Pipeline approveConnection(String resourceGroupName, String pipelineName, ConnectionBody connection) {
        PipelineInner inner = this.serviceClient().approveConnection(resourceGroupName, pipelineName, connection);
        if (inner != null) {
            return new PipelineImpl(inner, this.manager());
        } else {
            return null;
    ...
    public Pipeline approveConnection(
    ...
    public Pipeline rejectConnection(String resourceGroupName, String pipelineName, ConnectionBody connection) {
        PipelineInner inner = this.serviceClient().rejectConnection(resourceGroupName, pipelineName, connection);
        if (inner != null) {
            return new PipelineImpl(inner, this.manager());
        } else {
            return null;
    ...
    public Pipeline rejectConnection(
        String resourceGroupName, String pipelineName, ConnectionBody connection, Context context) {
        PipelineInner inner =
