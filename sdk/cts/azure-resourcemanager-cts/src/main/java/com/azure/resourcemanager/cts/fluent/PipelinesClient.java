...
public interface PipelinesClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<PipelineInner>, PipelineInner> beginUpdate(
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<PipelineInner>, PipelineInner> beginApproveConnection(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    PipelineInner approveConnection(String resourceGroupName, String pipelineName, ConnectionBody connection);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    PipelineInner approveConnection(
        String resourceGroupName, String pipelineName, ConnectionBody connection, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<PipelineInner>, PipelineInner> beginRejectConnection(
        String resourceGroupName, String pipelineName, ConnectionBody connection);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    PipelineInner rejectConnection(String resourceGroupName, String pipelineName, ConnectionBody connection);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    PipelineInner rejectConnection(
        String resourceGroupName, String pipelineName, ConnectionBody connection, Context context);
