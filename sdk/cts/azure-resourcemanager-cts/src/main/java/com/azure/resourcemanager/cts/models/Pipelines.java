...
public interface Pipelines {
     ...
     */
    Pipeline approveConnection(String resourceGroupName, String pipelineName, ConnectionBody connection);
     ...
     * @return the pipeline resource definition.
     */
    Pipeline rejectConnection(String resourceGroupName, String pipelineName, ConnectionBody connection);
