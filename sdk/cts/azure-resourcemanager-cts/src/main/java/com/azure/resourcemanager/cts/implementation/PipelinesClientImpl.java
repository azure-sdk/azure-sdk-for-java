...
import com.azure.resourcemanager.cts.fluent.PipelinesClient;
...
import com.azure.resourcemanager.cts.models.PipelinesListResult;
...
public final class PipelinesClientImpl implements PipelinesClient {
     ...
     */
    PipelinesClientImpl(CtsrpClientImpl client) {
        this.service =
    ...
    /**
     * The interface defining all the services for CtsrpClientPipelines to be used by the proxy service to perform REST
     * calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "CtsrpClientPipelines")
    private interface PipelinesService {
        ...
        @Post(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Cts/pipelines"
                + "/{pipelineName}/approveConnection")
        @ExpectedResponses({200, 202})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Flux<ByteBuffer>>> approveConnection(
            ...
            @PathParam("pipelineName") String pipelineName,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") ConnectionBody connection,
            @HeaderParam("Accept") String accept,
            Context context);
        ...
        @Headers({"Content-Type: application/json"})
        @Get("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Cts/pipelines")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        ...
        @Headers({"Content-Type: application/json"})
        @Get("/subscriptions/{subscriptionId}/providers/Microsoft.Cts/pipelines")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
    ...
    public SyncPoller<PollResult<PipelineInner>, PipelineInner> beginCreateOrUpdate(
        String resourceGroupName, String pipelineName, PipelineInner pipeline) {
        return beginCreateOrUpdateAsync(resourceGroupName, pipelineName, pipeline).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<PipelineInner>, PipelineInner> beginCreateOrUpdate(
        String resourceGroupName, String pipelineName, PipelineInner pipeline, Context context) {
        return beginCreateOrUpdateAsync(resourceGroupName, pipelineName, pipeline, context).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String pipelineName) {
        return beginDeleteAsync(resourceGroupName, pipelineName).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(
        String resourceGroupName, String pipelineName, Context context) {
        return beginDeleteAsync(resourceGroupName, pipelineName, context).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<PipelineInner>, PipelineInner> beginUpdate(
        String resourceGroupName, String pipelineName, PipelinesPatch pipeline) {
        return beginUpdateAsync(resourceGroupName, pipelineName, pipeline).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<PipelineInner>, PipelineInner> beginUpdate(
        String resourceGroupName, String pipelineName, PipelinesPatch pipeline, Context context) {
        return beginUpdateAsync(resourceGroupName, pipelineName, pipeline, context).getSyncPoller();
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> approveConnectionWithResponseAsync(
        String resourceGroupName, String pipelineName, ConnectionBody connection) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> approveConnectionWithResponseAsync(
        String resourceGroupName, String pipelineName, ConnectionBody connection, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<PipelineInner>, PipelineInner> beginApproveConnectionAsync(
        String resourceGroupName, String pipelineName, ConnectionBody connection) {
        Mono<Response<Flux<ByteBuffer>>> mono =
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<PipelineInner>, PipelineInner> beginApproveConnection(
        String resourceGroupName, String pipelineName, ConnectionBody connection) {
        return beginApproveConnectionAsync(resourceGroupName, pipelineName, connection).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<PipelineInner>, PipelineInner> beginApproveConnection(
        String resourceGroupName, String pipelineName, ConnectionBody connection, Context context) {
        return beginApproveConnectionAsync(resourceGroupName, pipelineName, connection, context).getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PipelineInner> approveConnectionAsync(
        String resourceGroupName, String pipelineName, ConnectionBody connection) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public PipelineInner approveConnection(String resourceGroupName, String pipelineName, ConnectionBody connection) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public PipelineInner approveConnection(
        String resourceGroupName, String pipelineName, ConnectionBody connection, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<PipelineInner>, PipelineInner> beginRejectConnectionAsync(
        String resourceGroupName, String pipelineName, ConnectionBody connection) {
        Mono<Response<Flux<ByteBuffer>>> mono =
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<PipelineInner>, PipelineInner> beginRejectConnection(
        String resourceGroupName, String pipelineName, ConnectionBody connection) {
        return beginRejectConnectionAsync(resourceGroupName, pipelineName, connection).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<PipelineInner>, PipelineInner> beginRejectConnection(
        String resourceGroupName, String pipelineName, ConnectionBody connection, Context context) {
        return beginRejectConnectionAsync(resourceGroupName, pipelineName, connection, context).getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PipelineInner> rejectConnectionAsync(
        String resourceGroupName, String pipelineName, ConnectionBody connection) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public PipelineInner rejectConnection(String resourceGroupName, String pipelineName, ConnectionBody connection) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public PipelineInner rejectConnection(
        String resourceGroupName, String pipelineName, ConnectionBody connection, Context context) {
