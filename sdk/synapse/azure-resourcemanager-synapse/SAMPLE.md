...
public final class BigDataPoolsGetSamples {
    ...
    public static void getABigDataPool(com.azure.resourcemanager.synapse.SynapseManager manager) {
        manager.bigDataPools()
            .getWithResponse("ExampleResourceGroup", "ExampleWorkspace", "ExamplePool",
                com.azure.core.util.Context.NONE);
    }
}
```
...
public final class BigDataPoolsUpdateSamples {
    ...
    public static void updateABigDataPool(com.azure.resourcemanager.synapse.SynapseManager manager) {
        BigDataPoolResourceInfo resource = manager.bigDataPools()
            .getWithResponse("ExampleResourceGroup", "ExampleWorkspace", "ExamplePool",
                com.azure.core.util.Context.NONE)
            .getValue();
...
public final class DataMaskingRulesGetSamples {
    ...
    public static void getDataMaskingRule(com.azure.resourcemanager.synapse.SynapseManager manager) {
        manager.dataMaskingRules()
            .getWithResponse("sqlcrudtest-6852", "sqlcrudtest-2080", "sqlcrudtest-331", "rule1",
                com.azure.core.util.Context.NONE);
    }
}
```
...
public final class ExtendedSqlPoolBlobAuditingPoliciesListBySqlPoolSamples {
    ...
    public static void
        ...
        manager.extendedSqlPoolBlobAuditingPolicies()
            .listBySqlPool("blobauditingtest-6852", "blobauditingtest-2080", "testdb",
                com.azure.core.util.Context.NONE);
    }
}
```
...
public final class IntegrationRuntimeAuthKeysOperationRegenerateSamples {
    ...
    public static void regenerateAuthKey(com.azure.resourcemanager.synapse.SynapseManager manager) {
        manager.integrationRuntimeAuthKeysOperations()
            .regenerateWithResponse("exampleResourceGroup", "exampleWorkspace", "exampleIntegrationRuntime",
...
public final class IntegrationRuntimeConnectionInfosGetSamples {
    ...
    public static void getConnectionInfo(com.azure.resourcemanager.synapse.SynapseManager manager) {
        manager.integrationRuntimeConnectionInfos()
...
public final class IntegrationRuntimeNodesDeleteSamples {
    ...
    public static void deleteIntegrationRuntimeNode(com.azure.resourcemanager.synapse.SynapseManager manager) {
        manager.integrationRuntimeNodes()
            .deleteWithResponse("exampleResourceGroup", "exampleWorkspace", "exampleIntegrationRuntime", "Node_1",
                com.azure.core.util.Context.NONE);
    }
}
```
...
public final class IntegrationRuntimeNodesUpdateSamples {
    ...
    public static void updateIntegrationRuntimeNode(com.azure.resourcemanager.synapse.SynapseManager manager) {
        manager.integrationRuntimeNodes()
            .updateWithResponse("exampleResourceGroup", "exampleWorkspace", "exampleIntegrationRuntime", "Node_1",
...
public final class IntegrationRuntimeObjectMetadataListSamples {
    ...
    public static void getIntegrationRuntimeObjectMetadata(com.azure.resourcemanager.synapse.SynapseManager manager) {
        manager.integrationRuntimeObjectMetadatas()
            .listWithResponse("exampleResourceGroup", "exampleWorkspace", "testactivityv2",
...
public final class IntegrationRuntimesDeleteSamples {
    ...
    public static void deleteIntegrationRuntime(com.azure.resourcemanager.synapse.SynapseManager manager) {
        manager.integrationRuntimes()
            .delete("exampleResourceGroup", "exampleWorkspace", "exampleIntegrationRuntime",
                com.azure.core.util.Context.NONE);
    }
}
```
...
public final class IntegrationRuntimesEnableInteractiveQuerySamples {
    ...
    public static void stopIntegrationRuntime(com.azure.resourcemanager.synapse.SynapseManager manager) {
        manager.integrationRuntimes()
            .enableInteractiveQuery("exampleResourceGroup", "exampleWorkspace", "exampleManagedIntegrationRuntime",
                com.azure.core.util.Context.NONE);
    }
}
```
...
public final class OperationsGetAzureAsyncHeaderResultSamples {
    ...
    public static void getAzureAsyncOperationHeaderResult(com.azure.resourcemanager.synapse.SynapseManager manager) {
        manager.operations()
            .getAzureAsyncHeaderResultWithResponse("resourceGroup1", "workspace1",
...
public final class PrivateEndpointConnectionsDeleteSamples {
    ...
    public static void deletePrivateEndpointConnection(com.azure.resourcemanager.synapse.SynapseManager manager) {
        manager.privateEndpointConnections()
            .delete("ExampleResourceGroup", "ExampleWorkspace", "ExamplePrivateEndpointConnection",
                com.azure.core.util.Context.NONE);
    }
}
```
...
public final class RestorableDroppedSqlPoolsListByWorkspaceSamples {
    ...
    public static void getListOfRestorableDroppedSqlPools(com.azure.resourcemanager.synapse.SynapseManager manager) {
        manager.restorableDroppedSqlPools()
            .listByWorkspace("restorabledroppeddatabasetest-1349", "restorabledroppeddatabasetest-1840",
                com.azure.core.util.Context.NONE);
    }
}
```
...
public final class SqlPoolBlobAuditingPoliciesCreateOrUpdateSamples {
    ...
    public static void createOrUpdateADatabaseSBlobAuditingPolicyWithAllParameters(
        com.azure.resourcemanager.synapse.SynapseManager manager) {
        manager.sqlPoolBlobAuditingPolicies()
            .define()
            .withExistingSqlPool("blobauditingtest-4799", "blobauditingtest-6440", "testdb")
            .withState(BlobAuditingPolicyState.ENABLED)
            .withStorageEndpoint("https://mystorage.blob.core.windows.net")
...
public final class SqlPoolConnectionPoliciesGetSamples {
    ...
    public static void
        ...
        manager.sqlPoolConnectionPolicies()
            .getWithResponse("blobauditingtest-6852", "blobauditingtest-2080", "testdb", ConnectionPolicyName.DEFAULT,
                com.azure.core.util.Context.NONE);
    }
}
```
...
public final class SqlPoolDataWarehouseUserActivitiesGetSamples {
    ...
    public static void getASQLAnalyticsPoolUserActivity(com.azure.resourcemanager.synapse.SynapseManager manager) {
        manager.sqlPoolDataWarehouseUserActivities()
...
public final class SqlPoolMaintenanceWindowOptionsGetSamples {
    ...
    public static void getListOfTransparentDataEncryptionConfigurationsOfASQLAnalyticsPool(
        com.azure.resourcemanager.synapse.SynapseManager manager) {
        manager.sqlPoolMaintenanceWindowOptions()
...
public final class SqlPoolMaintenanceWindowsCreateOrUpdateSamples {
    ...
    public static void setsMaintenanceWindowSettingsForASelectedSQLAnalyticsPool(
        ...
        manager.sqlPoolMaintenanceWindows()
            .createOrUpdateWithResponse("samplerg", "testworkspace", "testsp", "current",
...
public final class SqlPoolMetadataSyncConfigsCreateSamples {
    ...
    public static void
        ...
        manager.sqlPoolMetadataSyncConfigs()
            .createWithResponse("ExampleResourceGroup", "ExampleWorkspace", "ExampleSqlPool",
                new MetadataSyncConfigInner().withEnabled(true), com.azure.core.util.Context.NONE);
    }
}
```
...
public final class SqlPoolSecurityAlertPoliciesGetSamples {
    ...
    public static void getASecurityAlertOfASQLAnalyticsPool(com.azure.resourcemanager.synapse.SynapseManager manager) {
        manager.sqlPoolSecurityAlertPolicies()
...
public final class SqlPoolTableColumnsListByTableNameSamples {
    ...
    public static void listTheColumnsInATableOfAGivenSchemaInASQLAnalyticsPool(
        com.azure.resourcemanager.synapse.SynapseManager manager) {
        manager.sqlPoolTableColumns()
            .listByTableName("myRG", "serverName", "myDatabase", "dbo", "table1", null,
                com.azure.core.util.Context.NONE);
    }
}
```
...
public final class SqlPoolTransparentDataEncryptionsGetSamples {
    ...
    public static void getTransparentDataEncryptionConfigurationOfASQLAnalyticsPool(
        com.azure.resourcemanager.synapse.SynapseManager manager) {
        manager.sqlPoolTransparentDataEncryptions()
            .getWithResponse("sqlcrudtest-6852", "sqlcrudtest-2080", "sqlcrudtest-9187",
...
public final class SqlPoolVulnerabilityAssessmentScansListSamples {
    ...
    public static void
        ...
        manager.sqlPoolVulnerabilityAssessmentScans()
            .list("vulnerabilityassessmenttest-4711", "vulnerabilityassessmenttest-6411", "testdb",
...
public final class SqlPoolVulnerabilityAssessmentsListSamples {
    ...
    public static void
        ...
        manager.sqlPoolVulnerabilityAssessments()
            .list("vulnerabilityaseessmenttest-4799", "vulnerabilityaseessmenttest-6440", "testdb",
                com.azure.core.util.Context.NONE);
    }
}
```
...
public final class SqlPoolWorkloadClassifierGetSamples {
    ...
    public static void getAWorkloadClassifierForSQLAnalyticsPoolSWorkloadGroup(
        com.azure.resourcemanager.synapse.SynapseManager manager) {
        manager.sqlPoolWorkloadClassifiers()
            .getWithResponse("sqlcrudtest-6852", "sqlcrudtest-2080", "sqlcrudtest-9187", "wlm_workloadgroup",
                "wlm_classifier", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class SqlPoolWorkloadClassifierListSamples {
    ...
    public static void getTheListOfWorkloadClassifiersOfASQLAnalyticsPoolSWorkloadGroup(
        com.azure.resourcemanager.synapse.SynapseManager manager) {
        manager.sqlPoolWorkloadClassifiers()
            .list("sqlcrudtest-6852", "sqlcrudtest-2080", "sqlcrudtest-9187", "wlm_workloadgroup",
                com.azure.core.util.Context.NONE);
    }
}
```
...
public final class SqlPoolWorkloadGroupGetSamples {
    ...
    public static void getAAWorkloadGroupOfASQLAnalyticsPool(com.azure.resourcemanager.synapse.SynapseManager manager) {
        manager.sqlPoolWorkloadGroups()
            .getWithResponse("sqlcrudtest-6852", "sqlcrudtest-2080", "sqlcrudtest-9187", "smallrc",
                com.azure.core.util.Context.NONE);
    }
}
```
...
public final class WorkspaceManagedIdentitySqlControlSettingsCreateOrUpdateSamples {
    ...
    public static void
        ...
        manager.workspaceManagedIdentitySqlControlSettings()
            .createOrUpdate("resourceGroup1", "workspace1",
...
public final class WorkspaceManagedSqlServerBlobAuditingPoliciesGetSamples {
    ...
    public static void
        ...
        manager.workspaceManagedSqlServerBlobAuditingPolicies()
            .getWithResponse("wsg-7398", "testWorkspace", BlobAuditingPolicyName.DEFAULT,
                com.azure.core.util.Context.NONE);
    }
}
```
...
public final class WorkspaceManagedSqlServerEncryptionProtectorCreateOrUpdateSamples {
    ...
    public static void
        ...
        EncryptionProtector resource = manager.workspaceManagedSqlServerEncryptionProtectors()
            .getWithResponse("wsg-7398", "testWorkspace", EncryptionProtectorName.CURRENT,
                com.azure.core.util.Context.NONE)
            .getValue();
        resource.update()
...
public final class WorkspaceManagedSqlServerSecurityAlertPolicyCreateOrUpdateSamples {
    ...
    public static void updateAWorkspaceManagedSqlServerSThreatDetectionPolicyWithAllParameters(
        com.azure.resourcemanager.synapse.SynapseManager manager) {
        ServerSecurityAlertPolicy resource = manager.workspaceManagedSqlServerSecurityAlertPolicies()
            .getWithResponse("wsg-7398", "testWorkspace", SecurityAlertPolicyNameAutoGenerated.DEFAULT,
                com.azure.core.util.Context.NONE)
            .getValue();
        resource.update()
            .withState(SecurityAlertPolicyState.ENABLED)
...
public final class WorkspaceManagedSqlServerSecurityAlertPolicyGetSamples {
    ...
    public static void
        ...
        manager.workspaceManagedSqlServerSecurityAlertPolicies()
            .getWithResponse("wsg-7398", "testWorkspace", SecurityAlertPolicyNameAutoGenerated.DEFAULT,
                com.azure.core.util.Context.NONE);
    }
}
...
public final class WorkspaceManagedSqlServerVulnerabilityAssessmentsDeleteSamples {
    ...
    public static void removeWorkspaceManagedSqlServerSVulnerabilityAssessment(
        com.azure.resourcemanager.synapse.SynapseManager manager) {
        manager.workspaceManagedSqlServerVulnerabilityAssessments()
            .deleteWithResponse("wsg-7398", "testWorkspace", VulnerabilityAssessmentName.DEFAULT,
                com.azure.core.util.Context.NONE);
    }
}
```
...
public final class WorkspaceManagedSqlServerVulnerabilityAssessmentsGetSamples {
    ...
    public static void
        ...
        manager.workspaceManagedSqlServerVulnerabilityAssessments()
            .getWithResponse("wsg-7398", "testWorkspace", VulnerabilityAssessmentName.DEFAULT,
                com.azure.core.util.Context.NONE);
    }
}
```
