...
public final class KustoPoolPrincipalAssignmentsImpl implements KustoPoolPrincipalAssignments {
    ...
    public Response<CheckNameResult> checkNameAvailabilityWithResponse(String workspaceName, String kustoPoolName,
        ...
        Response<CheckNameResultInner> inner = this.serviceClient().checkNameAvailabilityWithResponse(workspaceName,
            kustoPoolName, resourceGroupName, principalAssignmentName, context);
        if (inner != null) {
    ...
    public CheckNameResult checkNameAvailability(String workspaceName, String kustoPoolName, String resourceGroupName,
        ...
        CheckNameResultInner inner = this.serviceClient().checkNameAvailability(workspaceName, kustoPoolName,
            resourceGroupName, principalAssignmentName);
        if (inner != null) {
    ...
    public Response<ClusterPrincipalAssignment> getWithResponse(String workspaceName, String kustoPoolName,
        ...
        Response<ClusterPrincipalAssignmentInner> inner = this.serviceClient().getWithResponse(workspaceName,
            kustoPoolName, principalAssignmentName, resourceGroupName, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
