...
public interface ResourceProvidersClient {
    ...
    Response<IntegrationRuntimeOperationStatusInner> integrationRuntimeStartOperationStatusWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    IntegrationRuntimeOperationStatusInner integrationRuntimeStartOperationStatus(
        String resourceGroupName,
        String workspaceName,
        String integrationRuntimeName,
        String integrationRuntimeAction,
