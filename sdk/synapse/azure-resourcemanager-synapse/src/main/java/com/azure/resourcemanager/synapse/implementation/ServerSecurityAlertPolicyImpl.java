...
public final class ServerSecurityAlertPolicyImpl
    ...
    public ServerSecurityAlertPolicy create() {
        this.innerObject = serviceManager.serviceClient().getWorkspaceManagedSqlServerSecurityAlertPolicies()
            .createOrUpdate(resourceGroupName, workspaceName, securityAlertPolicyName, this.innerModel(), Context.NONE);
        return this;
    }
    ...
    ServerSecurityAlertPolicyImpl(SecurityAlertPolicyNameAutoGenerated name,
    ...
    public ServerSecurityAlertPolicy refresh() {
        this.innerObject = serviceManager.serviceClient().getWorkspaceManagedSqlServerSecurityAlertPolicies()
            .getWithResponse(resourceGroupName, workspaceName, securityAlertPolicyName, Context.NONE).getValue();
        return this;
    }

    public ServerSecurityAlertPolicy refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getWorkspaceManagedSqlServerSecurityAlertPolicies()
            .getWithResponse(resourceGroupName, workspaceName, securityAlertPolicyName, context).getValue();
        return this;
    }
