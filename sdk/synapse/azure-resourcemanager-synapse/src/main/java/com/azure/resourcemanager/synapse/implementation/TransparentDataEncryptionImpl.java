...
public final class TransparentDataEncryptionImpl
    ...
    public TransparentDataEncryption create() {
        this.innerObject
            = serviceManager
                .serviceClient().getSqlPoolTransparentDataEncryptions().createOrUpdateWithResponse(resourceGroupName,
                    workspaceName, sqlPoolName, transparentDataEncryptionName, this.innerModel(), Context.NONE)
                .getValue();
        return this;
    }

    public TransparentDataEncryption create(Context context) {
        this.innerObject = serviceManager.serviceClient().getSqlPoolTransparentDataEncryptions()
