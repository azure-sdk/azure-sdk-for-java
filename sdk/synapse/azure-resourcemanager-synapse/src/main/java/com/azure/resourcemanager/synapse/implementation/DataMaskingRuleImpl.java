...
public final class DataMaskingRuleImpl implements DataMaskingRule, DataMaskingRule.Definition, DataMaskingRule.Update {
    ...
    public DataMaskingRule create() {
        this.innerObject
            = serviceManager.serviceClient().getDataMaskingRules().createOrUpdateWithResponse(resourceGroupName,
                workspaceName, sqlPoolName, dataMaskingRuleName, this.innerModel(), Context.NONE).getValue();
        return this;
    }
    ...
    public DataMaskingRule create(Context context) {
        this.innerObject
            = serviceManager.serviceClient().getDataMaskingRules().createOrUpdateWithResponse(resourceGroupName,
                workspaceName, sqlPoolName, dataMaskingRuleName, this.innerModel(), context).getValue();
        return this;
    }
    ...
    public DataMaskingRule refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getDataMaskingRules()
            .getWithResponse(resourceGroupName, workspaceName, sqlPoolName, dataMaskingRuleName, context).getValue();
        return this;
    }
