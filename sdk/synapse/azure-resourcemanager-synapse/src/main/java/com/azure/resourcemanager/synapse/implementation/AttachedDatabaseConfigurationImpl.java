...
public final class AttachedDatabaseConfigurationImpl implements AttachedDatabaseConfiguration,
    ...
    public AttachedDatabaseConfiguration create() {
        this.innerObject
            = serviceManager.serviceClient().getKustoPoolAttachedDatabaseConfigurations().createOrUpdate(workspaceName,
                kustoPoolName, attachedDatabaseConfigurationName, resourceGroupName, this.innerModel(), Context.NONE);
        return this;
    }
    ...
    public AttachedDatabaseConfiguration create(Context context) {
        this.innerObject
            = serviceManager.serviceClient().getKustoPoolAttachedDatabaseConfigurations().createOrUpdate(workspaceName,
                kustoPoolName, attachedDatabaseConfigurationName, resourceGroupName, this.innerModel(), context);
        return this;
    }
    ...
    public AttachedDatabaseConfiguration refresh() {
        this.innerObject
            = serviceManager.serviceClient().getKustoPoolAttachedDatabaseConfigurations().getWithResponse(workspaceName,
                kustoPoolName, attachedDatabaseConfigurationName, resourceGroupName, Context.NONE).getValue();
        return this;
    }
    ...
    public AttachedDatabaseConfiguration refresh(Context context) {
        this.innerObject
            = serviceManager.serviceClient().getKustoPoolAttachedDatabaseConfigurations().getWithResponse(workspaceName,
                kustoPoolName, attachedDatabaseConfigurationName, resourceGroupName, context).getValue();
        return this;
    }
