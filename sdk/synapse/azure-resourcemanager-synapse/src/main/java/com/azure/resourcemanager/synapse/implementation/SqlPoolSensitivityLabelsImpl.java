...
public final class SqlPoolSensitivityLabelsImpl implements SqlPoolSensitivityLabels {
    ...
    public Response<Void> updateWithResponse(String resourceGroupName, String workspaceName, String sqlPoolName,
        ...
        return this.serviceClient().updateWithResponse(resourceGroupName, workspaceName, sqlPoolName, parameters,
            context);
    }
    ...
    public PagedIterable<SensitivityLabel> listRecommended(String resourceGroupName, String workspaceName,
        ...
        PagedIterable<SensitivityLabelInner> inner = this.serviceClient().listRecommended(resourceGroupName,
            workspaceName, sqlPoolName, includeDisabledRecommendations, skipToken, filter, context);
        return Utils.mapPage(inner, inner1 -> new SensitivityLabelImpl(inner1, this.manager()));
    }
    ...
    public Response<Void> deleteWithResponse(String resourceGroupName, String workspaceName, String sqlPoolName,
        ...
        return this.serviceClient().deleteWithResponse(resourceGroupName, workspaceName, sqlPoolName, schemaName,
    ...
    public Response<SensitivityLabel> getWithResponse(String resourceGroupName, String workspaceName,
        ...
        Response<SensitivityLabelInner> inner = this.serviceClient().getWithResponse(resourceGroupName, workspaceName,
            sqlPoolName, schemaName, tableName, columnName, sensitivityLabelSource, context);
        if (inner != null) {
    ...
    public SensitivityLabel get(String resourceGroupName, String workspaceName, String sqlPoolName, String schemaName,
        ...
        SensitivityLabelInner inner = this.serviceClient().get(resourceGroupName, workspaceName, sqlPoolName,
    ...
    public Response<Void> enableRecommendationWithResponse(String resourceGroupName, String workspaceName,
        ...
        return this.serviceClient().enableRecommendationWithResponse(resourceGroupName, workspaceName, sqlPoolName,
    ...
    public void enableRecommendation(String resourceGroupName, String workspaceName, String sqlPoolName,
        ...
        this.serviceClient().enableRecommendation(resourceGroupName, workspaceName, sqlPoolName, schemaName, tableName,
            columnName);
    }

    public Response<Void> disableRecommendationWithResponse(String resourceGroupName, String workspaceName,
        String sqlPoolName, String schemaName, String tableName, String columnName, Context context) {
        return this.serviceClient().disableRecommendationWithResponse(resourceGroupName, workspaceName, sqlPoolName,
            schemaName, tableName, columnName, context);
    }

    public void disableRecommendation(String resourceGroupName, String workspaceName, String sqlPoolName,
        String schemaName, String tableName, String columnName) {
        this.serviceClient().disableRecommendation(resourceGroupName, workspaceName, sqlPoolName, schemaName, tableName,
            columnName);
    }
