...
public final class WorkloadClassifierImpl
    ...
    public WorkloadClassifier create() {
        this.innerObject
            = serviceManager.serviceClient().getSqlPoolWorkloadClassifiers().createOrUpdate(resourceGroupName,
                workspaceName, sqlPoolName, workloadGroupName, workloadClassifierName, this.innerModel(), Context.NONE);
        return this;
    }
    ...
    public WorkloadClassifier create(Context context) {
        this.innerObject
            = serviceManager.serviceClient().getSqlPoolWorkloadClassifiers().createOrUpdate(resourceGroupName,
                workspaceName, sqlPoolName, workloadGroupName, workloadClassifierName, this.innerModel(), context);
        return this;
    }
    ...
    public WorkloadClassifier refresh() {
        this.innerObject
            = serviceManager.serviceClient().getSqlPoolWorkloadClassifiers().getWithResponse(resourceGroupName,
                workspaceName, sqlPoolName, workloadGroupName, workloadClassifierName, Context.NONE).getValue();
        return this;
    }
    ...
    public WorkloadClassifier refresh(Context context) {
        this.innerObject
            = serviceManager.serviceClient().getSqlPoolWorkloadClassifiers().getWithResponse(resourceGroupName,
                workspaceName, sqlPoolName, workloadGroupName, workloadClassifierName, context).getValue();
        return this;
    }
