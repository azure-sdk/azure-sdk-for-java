...
public final class SqlPoolMaintenanceWindowsImpl implements SqlPoolMaintenanceWindows {
    ...
    public Response<MaintenanceWindows> getWithResponse(String resourceGroupName, String workspaceName,
        ...
        Response<MaintenanceWindowsInner> inner = this.serviceClient().getWithResponse(resourceGroupName, workspaceName,
            sqlPoolName, maintenanceWindowName, context);
        if (inner != null) {
    ...
    public Response<Void> createOrUpdateWithResponse(String resourceGroupName, String workspaceName, String sqlPoolName,
        ...
        return this.serviceClient().createOrUpdateWithResponse(resourceGroupName, workspaceName, sqlPoolName,
            maintenanceWindowName, parameters, context);
    }
    ...
    public void createOrUpdate(String resourceGroupName, String workspaceName, String sqlPoolName,
        ...
        this.serviceClient().createOrUpdate(resourceGroupName, workspaceName, sqlPoolName, maintenanceWindowName,
            parameters);
    }
