...
public final class PrivateLinkHubImpl implements PrivateLinkHub, PrivateLinkHub.Definition, PrivateLinkHub.Update {
    ...
    public PrivateLinkHub create() {
        this.innerObject = serviceManager.serviceClient().getPrivateLinkHubs()
    ...
    public PrivateLinkHub create(Context context) {
        this.innerObject = serviceManager.serviceClient().getPrivateLinkHubs()
            .createOrUpdateWithResponse(resourceGroupName, privateLinkHubName, this.innerModel(), context).getValue();
        return this;
    }
    ...
    public PrivateLinkHub refresh() {
        this.innerObject = serviceManager.serviceClient().getPrivateLinkHubs()
            .getByResourceGroupWithResponse(resourceGroupName, privateLinkHubName, Context.NONE).getValue();
        return this;
    }

    public PrivateLinkHub refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getPrivateLinkHubs()
            .getByResourceGroupWithResponse(resourceGroupName, privateLinkHubName, context).getValue();
        return this;
    }
