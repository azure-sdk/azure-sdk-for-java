...
public final class BigDataPoolResourceInfoImpl
    ...
    public BigDataPoolResourceInfo create() {
        this.innerObject = serviceManager.serviceClient().getBigDataPools().createOrUpdate(resourceGroupName,
            workspaceName, bigDataPoolName, this.innerModel(), createForce, Context.NONE);
        return this;
    }

    public BigDataPoolResourceInfo create(Context context) {
        this.innerObject = serviceManager.serviceClient().getBigDataPools().createOrUpdate(resourceGroupName,
            workspaceName, bigDataPoolName, this.innerModel(), createForce, context);
        return this;
    }
    ...
    public BigDataPoolResourceInfo apply() {
        this.innerObject = serviceManager.serviceClient().getBigDataPools().updateWithResponse(resourceGroupName,
            workspaceName, bigDataPoolName, updateBigDataPoolPatchInfo, Context.NONE).getValue();
        return this;
    }

    public BigDataPoolResourceInfo apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getBigDataPools()
    ...
    public BigDataPoolResourceInfo refresh() {
        this.innerObject = serviceManager.serviceClient().getBigDataPools()
            .getWithResponse(resourceGroupName, workspaceName, bigDataPoolName, Context.NONE).getValue();
        return this;
    }

    public BigDataPoolResourceInfo refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getBigDataPools()
            .getWithResponse(resourceGroupName, workspaceName, bigDataPoolName, context).getValue();
        return this;
    }
