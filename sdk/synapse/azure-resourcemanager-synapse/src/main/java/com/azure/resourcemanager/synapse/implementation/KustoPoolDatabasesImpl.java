...
public final class KustoPoolDatabasesImpl implements KustoPoolDatabases {
    ...
    public KustoPoolDatabasesImpl(KustoPoolDatabasesClient innerClient,
        com.azure.resourcemanager.synapse.SynapseManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public PagedIterable<Database> listByKustoPool(String resourceGroupName, String workspaceName,
    ...
    public Response<Database> getWithResponse(String resourceGroupName, String workspaceName, String kustoPoolName,
        ...
        Response<DatabaseInner> inner = this.serviceClient().getWithResponse(resourceGroupName, workspaceName,
    ...
    public Database createOrUpdate(String resourceGroupName, String workspaceName, String kustoPoolName,
        String databaseName, DatabaseInner parameters) {
        DatabaseInner inner = this.serviceClient().createOrUpdate(resourceGroupName, workspaceName, kustoPoolName,
    ...
    public Database update(String resourceGroupName, String workspaceName, String kustoPoolName, String databaseName,
    ...
    public Database update(String resourceGroupName, String workspaceName, String kustoPoolName, String databaseName,
        ...
        DatabaseInner inner = this.serviceClient().update(resourceGroupName, workspaceName, kustoPoolName, databaseName,
            parameters, context);
        if (inner != null) {
            return new DatabaseImpl(inner, this.manager());
        } else {
