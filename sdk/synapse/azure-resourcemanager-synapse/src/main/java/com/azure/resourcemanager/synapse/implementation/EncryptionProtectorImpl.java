...
public final class EncryptionProtectorImpl
    ...
    public EncryptionProtector create() {
        this.innerObject = serviceManager.serviceClient().getWorkspaceManagedSqlServerEncryptionProtectors()
    ...
    public EncryptionProtector refresh() {
        this.innerObject = serviceManager.serviceClient().getWorkspaceManagedSqlServerEncryptionProtectors()
            .getWithResponse(resourceGroupName, workspaceName, encryptionProtectorName, Context.NONE).getValue();
        return this;
    }

    public EncryptionProtector refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getWorkspaceManagedSqlServerEncryptionProtectors()
            .getWithResponse(resourceGroupName, workspaceName, encryptionProtectorName, context).getValue();
        return this;
    }

    public void revalidate() {
        serviceManager.workspaceManagedSqlServerEncryptionProtectors().revalidate(resourceGroupName, workspaceName,
