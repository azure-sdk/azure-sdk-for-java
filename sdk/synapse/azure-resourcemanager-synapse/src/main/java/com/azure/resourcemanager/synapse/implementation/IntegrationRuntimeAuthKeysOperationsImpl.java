...
public final class IntegrationRuntimeAuthKeysOperationsImpl implements IntegrationRuntimeAuthKeysOperations {
    ...
    public Response<IntegrationRuntimeAuthKeys> regenerateWithResponse(String resourceGroupName, String workspaceName,
        ...
        Context context) {
        Response<IntegrationRuntimeAuthKeysInner> inner = this.serviceClient().regenerateWithResponse(resourceGroupName,
            workspaceName, integrationRuntimeName, regenerateKeyParameters, context);
        if (inner != null) {
    ...
    public IntegrationRuntimeAuthKeys regenerate(String resourceGroupName, String workspaceName,
        String integrationRuntimeName, IntegrationRuntimeRegenerateKeyParameters regenerateKeyParameters) {
        IntegrationRuntimeAuthKeysInner inner = this.serviceClient().regenerate(resourceGroupName, workspaceName,
