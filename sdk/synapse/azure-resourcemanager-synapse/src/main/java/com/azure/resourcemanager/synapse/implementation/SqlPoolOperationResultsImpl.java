...
public final class SqlPoolOperationResultsImpl implements SqlPoolOperationResults {
    ...
    public Response<SqlPool> getLocationHeaderResultWithResponse(String resourceGroupName, String workspaceName,
        String sqlPoolName, String operationId, Context context) {
        Response<SqlPoolInner> inner = this.serviceClient()
