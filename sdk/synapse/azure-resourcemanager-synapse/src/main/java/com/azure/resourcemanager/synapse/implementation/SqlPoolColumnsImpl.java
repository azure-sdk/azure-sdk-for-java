...
public final class SqlPoolColumnsImpl implements SqlPoolColumns {
    ...
    public Response<SqlPoolColumn> getWithResponse(String resourceGroupName, String workspaceName, String sqlPoolName,
        ...
        Response<SqlPoolColumnInner> inner = this.serviceClient().getWithResponse(resourceGroupName, workspaceName,
            sqlPoolName, schemaName, tableName, columnName, context);
        if (inner != null) {
    ...
    public SqlPoolColumn get(String resourceGroupName, String workspaceName, String sqlPoolName, String schemaName,
        ...
        SqlPoolColumnInner inner = this.serviceClient().get(resourceGroupName, workspaceName, sqlPoolName, schemaName,
