...
public final class PrivateEndpointConnectionsPrivateLinkHubsClientImpl
    ...
    PrivateEndpointConnectionsPrivateLinkHubsClientImpl(SynapseManagementClientImpl client) {
        this.service = RestProxy.create(PrivateEndpointConnectionsPrivateLinkHubsService.class,
    ...
    private Mono<PagedResponse<PrivateEndpointConnectionForPrivateLinkHubInner>>
        listSinglePageAsync(String resourceGroupName, String privateLinkHubName) {
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<PrivateEndpointConnectionForPrivateLinkHubInner>>
        listSinglePageAsync(String resourceGroupName, String privateLinkHubName, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    private PagedFlux<PrivateEndpointConnectionForPrivateLinkHubInner> listAsync(String resourceGroupName,
