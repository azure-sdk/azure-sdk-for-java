...
public final class DatabasePrincipalAssignmentImpl
    ...
    public DatabasePrincipalAssignment create() {
        this.innerObject = serviceManager.serviceClient().getKustoPoolDatabasePrincipalAssignments().createOrUpdate(
            workspaceName, kustoPoolName, databaseName, principalAssignmentName, resourceGroupName, this.innerModel(),
            Context.NONE);
        return this;
    }
    ...
    public DatabasePrincipalAssignment create(Context context) {
        this.innerObject
            = serviceManager.serviceClient().getKustoPoolDatabasePrincipalAssignments().createOrUpdate(workspaceName,
                kustoPoolName, databaseName, principalAssignmentName, resourceGroupName, this.innerModel(), context);
        return this;
    }
    ...
    public DatabasePrincipalAssignment refresh() {
        this.innerObject
            = serviceManager.serviceClient().getKustoPoolDatabasePrincipalAssignments().getWithResponse(workspaceName,
                kustoPoolName, databaseName, principalAssignmentName, resourceGroupName, Context.NONE).getValue();
        return this;
    }
    ...
    public DatabasePrincipalAssignment refresh(Context context) {
        this.innerObject
            = serviceManager.serviceClient().getKustoPoolDatabasePrincipalAssignments().getWithResponse(workspaceName,
                kustoPoolName, databaseName, principalAssignmentName, resourceGroupName, context).getValue();
        return this;
    }
