...
public final class IntegrationRuntimeResourceImpl
    ...
    public IntegrationRuntimeResource create() {
        this.innerObject = serviceManager.serviceClient().getIntegrationRuntimes().create(resourceGroupName,
            workspaceName, integrationRuntimeName, this.innerModel(), createIfMatch, Context.NONE);
        return this;
    }

    public IntegrationRuntimeResource create(Context context) {
        this.innerObject = serviceManager.serviceClient().getIntegrationRuntimes().create(resourceGroupName,
            workspaceName, integrationRuntimeName, this.innerModel(), createIfMatch, context);
        return this;
    }
    ...
    public IntegrationRuntimeResource apply() {
        this.innerObject = serviceManager.serviceClient().getIntegrationRuntimes().updateWithResponse(resourceGroupName,
            workspaceName, integrationRuntimeName, updateUpdateIntegrationRuntimeRequest, Context.NONE).getValue();
        return this;
    }

    public IntegrationRuntimeResource apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getIntegrationRuntimes().updateWithResponse(resourceGroupName,
            workspaceName, integrationRuntimeName, updateUpdateIntegrationRuntimeRequest, context).getValue();
        return this;
    }
    ...
    public Response<Void> upgradeWithResponse(Context context) {
        return serviceManager.integrationRuntimes().upgradeWithResponse(resourceGroupName, workspaceName,
    ...
    public void enableInteractiveQuery() {
        serviceManager.integrationRuntimes().enableInteractiveQuery(resourceGroupName, workspaceName,
    ...
    public void disableInteractiveQuery() {
        serviceManager.integrationRuntimes().disableInteractiveQuery(resourceGroupName, workspaceName,
            integrationRuntimeName);
    }
