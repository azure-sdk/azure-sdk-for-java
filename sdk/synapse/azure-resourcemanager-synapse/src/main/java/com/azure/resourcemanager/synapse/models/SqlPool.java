...
public interface SqlPool {
    ...
    interface DefinitionStages {
        ...
        interface WithCreateMode {
             ...
             * recoverableDatabaseId to restore.
             * 
             * Restore: Creates a sql pool by restoring a backup of a deleted sql pool. SourceDatabaseId should be the
             * sql pool's original resource ID. SourceDatabaseId and sourceDatabaseDeletionDate must be specified..
             * 
