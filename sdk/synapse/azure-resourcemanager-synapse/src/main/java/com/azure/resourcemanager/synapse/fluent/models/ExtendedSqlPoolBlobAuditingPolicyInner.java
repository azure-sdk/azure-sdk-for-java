 ...
 */
@Fluent
public final class ExtendedSqlPoolBlobAuditingPolicyInner extends ProxyResource {
    /*
     * Resource properties.
     */
    @JsonProperty(value = "properties")
    private ExtendedSqlPoolBlobAuditingPolicyProperties innerProperties;

    /**
     * Creates an instance of ExtendedSqlPoolBlobAuditingPolicyInner class.
     */
    ...
    public ExtendedSqlPoolBlobAuditingPolicyInner withPredicateExpression(String predicateExpression) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ExtendedSqlPoolBlobAuditingPolicyProperties();
        }
