...
public final class IpFirewallRuleInfoImpl
    ...
    public IpFirewallRuleInfo create() {
        this.innerObject = serviceManager.serviceClient().getIpFirewallRules().createOrUpdate(resourceGroupName,
            workspaceName, ruleName, this.innerModel(), Context.NONE);
        return this;
    }

    public IpFirewallRuleInfo create(Context context) {
        this.innerObject = serviceManager.serviceClient().getIpFirewallRules().createOrUpdate(resourceGroupName,
            workspaceName, ruleName, this.innerModel(), context);
        return this;
    }
    ...
    public IpFirewallRuleInfo refresh() {
        this.innerObject = serviceManager.serviceClient().getIpFirewallRules()
            .getWithResponse(resourceGroupName, workspaceName, ruleName, Context.NONE).getValue();
        return this;
    }

    public IpFirewallRuleInfo refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getIpFirewallRules()
            .getWithResponse(resourceGroupName, workspaceName, ruleName, context).getValue();
        return this;
    }
