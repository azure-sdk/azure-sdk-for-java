...
import com.azure.resourcemanager.synapse.models.ErrorDetailAutoGenerated2Exception;
...
public final class WorkspacesClientImpl implements WorkspacesClient {
    ...
    public interface WorkspacesService {
        ...
        @Get(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Synapse/workspaces"
                + "/{workspaceName}")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ErrorDetailAutoGenerated2Exception.class)
     ...
     * @throws IllegalArgumentException thrown if parameters fail the validation.
     * @throws ErrorDetailAutoGenerated2Exception thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<WorkspaceInner>, WorkspaceInner> beginDeleteAsync(
        String resourceGroupName, String workspaceName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<WorkspaceInner>, WorkspaceInner> beginDelete(
        String resourceGroupName, String workspaceName) {
