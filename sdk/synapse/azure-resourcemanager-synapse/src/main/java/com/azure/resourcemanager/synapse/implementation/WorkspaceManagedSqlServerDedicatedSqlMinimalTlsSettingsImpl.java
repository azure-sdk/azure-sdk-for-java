...
public final class WorkspaceManagedSqlServerDedicatedSqlMinimalTlsSettingsImpl
    ...
    public DedicatedSQLminimalTlsSettings update(String resourceGroupName, String workspaceName,
        ...
        DedicatedSQLminimalTlsSettingsInner inner = this.serviceClient().update(resourceGroupName, workspaceName,
            dedicatedSQLminimalTlsSettingsName, parameters);
        if (inner != null) {
    ...
    public Response<DedicatedSQLminimalTlsSettings> getWithResponse(String resourceGroupName, String workspaceName,
        ...
        Response<DedicatedSQLminimalTlsSettingsInner> inner = this.serviceClient().getWithResponse(resourceGroupName,
            workspaceName, dedicatedSQLminimalTlsSettingsName, context);
        if (inner != null) {
