...
import com.azure.resourcemanager.synapse.models.ErrorDetailAutoGeneratedException;
...
public final class SqlPoolTransparentDataEncryptionsClientImpl implements SqlPoolTransparentDataEncryptionsClient {
    ...
    public interface SqlPoolTransparentDataEncryptionsService {
        ...
        @UnexpectedResponseExceptionType(ErrorDetailAutoGeneratedException.class)
     ...
     * @throws IllegalArgumentException thrown if parameters fail the validation.
     * @throws ErrorDetailAutoGeneratedException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
