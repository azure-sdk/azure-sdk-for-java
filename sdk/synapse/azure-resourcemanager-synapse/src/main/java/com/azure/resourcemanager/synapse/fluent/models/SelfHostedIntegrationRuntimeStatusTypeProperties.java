...
public final class SelfHostedIntegrationRuntimeStatusTypeProperties {
     ...
     */
    @JsonProperty(value = "autoUpdateETA")
    ...
    /*
     * OS Type, 1- Windows; 2- Linux
     */
    @JsonProperty(value = "osType", access = JsonProperty.Access.WRITE_ONLY)
    private Integer osType;

    /*
     * Target framework type, 0 - DotNetFramework ; 1 - DotNetCore
     */
     ...
     * @return the SelfHostedIntegrationRuntimeStatusTypeProperties object itself.
     */
    public SelfHostedIntegrationRuntimeStatusTypeProperties withAutoUpdateEta(OffsetDateTime autoUpdateEta) {
