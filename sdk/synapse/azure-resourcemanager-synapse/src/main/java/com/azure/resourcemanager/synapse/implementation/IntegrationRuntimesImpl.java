...
public final class IntegrationRuntimesImpl implements IntegrationRuntimes {
    ...
    public Response<IntegrationRuntimeResource> getWithResponse(String resourceGroupName, String workspaceName,
        ...
        Response<IntegrationRuntimeResourceInner> inner = this.serviceClient().getWithResponse(resourceGroupName,
            workspaceName, integrationRuntimeName, ifNoneMatch, context);
        if (inner != null) {
    ...
    public Response<Void> upgradeWithResponse(String resourceGroupName, String workspaceName,
        ...
        return this.serviceClient().upgradeWithResponse(resourceGroupName, workspaceName, integrationRuntimeName,
            context);
    }
    ...
    public Response<IntegrationRuntimeOutboundNetworkDependenciesEndpointsResponse>
        ...
        Response<IntegrationRuntimeOutboundNetworkDependenciesEndpointsResponseInner> inner
            = this.serviceClient().listOutboundNetworkDependenciesEndpointsWithResponse(resourceGroupName,
