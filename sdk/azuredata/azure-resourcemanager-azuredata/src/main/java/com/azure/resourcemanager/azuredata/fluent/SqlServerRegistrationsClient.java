...
public interface SqlServerRegistrationsClient {
    ...
    Response<SqlServerRegistrationInner> getByResourceGroupWithResponse(String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<SqlServerRegistrationInner> createOrUpdateWithResponse(String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<SqlServerRegistrationInner> updateWithResponse(String resourceGroupName, String sqlServerRegistrationName,
        SqlServerRegistrationUpdate parameters, Context context);
