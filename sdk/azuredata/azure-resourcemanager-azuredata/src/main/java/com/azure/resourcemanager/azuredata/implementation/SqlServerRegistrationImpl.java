...
public final class SqlServerRegistrationImpl
    ...
    public SqlServerRegistration create() {
        this.innerObject = serviceManager.serviceClient().getSqlServerRegistrations()
            .createOrUpdateWithResponse(resourceGroupName, sqlServerRegistrationName, this.innerModel(), Context.NONE)
            .getValue();
        return this;
    }
    ...
    public SqlServerRegistration apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getSqlServerRegistrations()
            .updateWithResponse(resourceGroupName, sqlServerRegistrationName, updateParameters, context).getValue();
        return this;
    }

    SqlServerRegistrationImpl(SqlServerRegistrationInner innerObject,
        com.azure.resourcemanager.azuredata.AzureDataManager serviceManager) {
        this.innerObject = innerObject;
        this.serviceManager = serviceManager;
        this.resourceGroupName = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "resourceGroups");
        this.sqlServerRegistrationName
            = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "sqlServerRegistrations");
    }

    public SqlServerRegistration refresh() {
        this.innerObject = serviceManager.serviceClient().getSqlServerRegistrations()
            .getByResourceGroupWithResponse(resourceGroupName, sqlServerRegistrationName, Context.NONE).getValue();
        return this;
    }

    public SqlServerRegistration refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getSqlServerRegistrations()
            .getByResourceGroupWithResponse(resourceGroupName, sqlServerRegistrationName, context).getValue();
        return this;
    }
