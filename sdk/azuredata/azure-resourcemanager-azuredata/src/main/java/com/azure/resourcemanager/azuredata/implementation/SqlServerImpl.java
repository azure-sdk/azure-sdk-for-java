...
public final class SqlServerImpl implements SqlServer, SqlServer.Definition, SqlServer.Update {
    ...
    public SqlServer create() {
        this.innerObject = serviceManager.serviceClient().getSqlServers().createOrUpdateWithResponse(resourceGroupName,
            sqlServerRegistrationName, sqlServerName, this.innerModel(), Context.NONE).getValue();
        return this;
    }

    public SqlServer create(Context context) {
        this.innerObject = serviceManager.serviceClient().getSqlServers().createOrUpdateWithResponse(resourceGroupName,
            sqlServerRegistrationName, sqlServerName, this.innerModel(), context).getValue();
        return this;
    }
    ...
    SqlServerImpl(SqlServerInner innerObject, com.azure.resourcemanager.azuredata.AzureDataManager serviceManager) {
        ...
        this.sqlServerName = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "sqlServers");
    }

    public SqlServer refresh() {
        String localExpand = null;
        this.innerObject = serviceManager.serviceClient().getSqlServers()
