...
import com.azure.resourcemanager.azuredata.models.OperationListResult;
...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    OperationsClientImpl(AzureDataManagementClientImpl client) {
        this.service =
    ...
    /**
     * The interface defining all the services for AzureDataManagementClientOperations to be used by the proxy service
