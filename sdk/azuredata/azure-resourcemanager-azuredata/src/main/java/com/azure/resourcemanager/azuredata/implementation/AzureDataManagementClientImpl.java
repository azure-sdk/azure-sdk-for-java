...
public final class AzureDataManagementClientImpl implements AzureDataManagementClient {
     ...
     */
    AzureDataManagementClientImpl(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter,
    ...
    private static final ClientLogger LOGGER = new ClientLogger(AzureDataManagementClientImpl.class);
}
