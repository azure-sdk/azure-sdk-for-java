...
public final class SqlServersImpl implements SqlServers {
    ...
    public SqlServersImpl(SqlServersClient innerClient,
        com.azure.resourcemanager.azuredata.AzureDataManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public Response<SqlServer> getWithResponse(String resourceGroupName, String sqlServerRegistrationName,
        String sqlServerName, String expand, Context context) {
        Response<SqlServerInner> inner = this.serviceClient().getWithResponse(resourceGroupName,
            sqlServerRegistrationName, sqlServerName, expand, context);
        if (inner != null) {
    ...
    public Response<Void> deleteWithResponse(String resourceGroupName, String sqlServerRegistrationName,
        ...
        return this.serviceClient().deleteWithResponse(resourceGroupName, sqlServerRegistrationName, sqlServerName,
            context);
    }
    ...
    public PagedIterable<SqlServer> listByResourceGroup(String resourceGroupName, String sqlServerRegistrationName) {
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new SqlServerImpl(inner1, this.manager()));
    }
    ...
    public SqlServer getById(String id) {
        ...
        String sqlServerName = ResourceManagerUtils.getValueFromIdByName(id, "sqlServers");
