...
public final class OperationsListSamples {
    /*
     * x-ms-original-file:
     * specification/azuredata/resource-manager/Microsoft.AzureData/preview/2019-07-24-preview/examples/ListOperation.
     * json
     */
    /**
...
public final class SqlServerRegistrationsCreateOrUpdateSamples {
    /*
     * x-ms-original-file:
     * specification/azuredata/resource-manager/Microsoft.AzureData/preview/2019-07-24-preview/examples/
     * CreateOrUpdateSqlServerRegistration.json
     */
    /**
     ...
     */
    public static void
        createsOrUpdatesASQLServerRegistration(com.azure.resourcemanager.azuredata.AzureDataManager manager) {
        manager.sqlServerRegistrations().define("testsqlregistration").withRegion("northeurope")
            .withExistingResourceGroup("testrg").withTags(mapOf("mytag", "myval")).create();
    }
...
public final class SqlServerRegistrationsDeleteSamples {
     ...
     * x-ms-original-file:
     * specification/azuredata/resource-manager/Microsoft.AzureData/preview/2019-07-24-preview/examples/
     * DeleteSqlServerRegistration.json
     */
    /**
    ...
    public static void deletesASQLServerRegistration(com.azure.resourcemanager.azuredata.AzureDataManager manager) {
        manager.sqlServerRegistrations().deleteByResourceGroupWithResponse("testrg", "testsqlregistration",
...
public final class SqlServerRegistrationsGetByResourceGroupSamples {
    ...
    public static void getsASQLServerRegistration(com.azure.resourcemanager.azuredata.AzureDataManager manager) {
        manager.sqlServerRegistrations().getByResourceGroupWithResponse("testrg", "testsqlregistration",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class SqlServerRegistrationsListSamples {
     ...
     * x-ms-original-file:
     * specification/azuredata/resource-manager/Microsoft.AzureData/preview/2019-07-24-preview/examples/
     * ListSubscriptionSqlServerRegistration.json
     */
    /**
     ...
     */
    public static void
        getsAllSQLServerRegistrationsInASubscription(com.azure.resourcemanager.azuredata.AzureDataManager manager) {
        manager.sqlServerRegistrations().list(com.azure.core.util.Context.NONE);
    }
}
```
...
public final class SqlServerRegistrationsListByResourceGroupSamples {
     ...
     * x-ms-original-file:
     * specification/azuredata/resource-manager/Microsoft.AzureData/preview/2019-07-24-preview/examples/
     * ListByResourceGroupSqlServerRegistration.json
     */
    /**
     ...
     */
    public static void
        getsAllSQLServerRegistrationsInAResourceGroup(com.azure.resourcemanager.azuredata.AzureDataManager manager) {
        manager.sqlServerRegistrations().listByResourceGroup("testrg", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class SqlServerRegistrationsUpdateSamples {
     ...
     * x-ms-original-file:
     * specification/azuredata/resource-manager/Microsoft.AzureData/preview/2019-07-24-preview/examples/
     * UpdateSqlServerRegistration.json
     */
    /**
    ...
    public static void updatesASQLServerRegistrationTags(com.azure.resourcemanager.azuredata.AzureDataManager manager) {
        SqlServerRegistration resource = manager.sqlServerRegistrations()
            .getByResourceGroupWithResponse("testrg", "testsqlregistration", com.azure.core.util.Context.NONE)
            .getValue();
...
public final class SqlServersCreateOrUpdateSamples {
     ...
     * x-ms-original-file:
     * specification/azuredata/resource-manager/Microsoft.AzureData/preview/2019-07-24-preview/examples/
     * CreateOrUpdateSqlServerWithRegistrationGroup.json
     */
    /**
     ...
     */
    public static void
        createsOrUpdatesASQLServerInARegistrationGroup(com.azure.resourcemanager.azuredata.AzureDataManager manager) {
        manager.sqlServers().define("testsqlserver").withExistingSqlServerRegistration("testrg", "testsqlregistration")
            .withVersion("2008").withEdition("Latin")
            .withRegistrationId(
...
public final class SqlServersDeleteSamples {
    /*
     * x-ms-original-file:
     * specification/azuredata/resource-manager/Microsoft.AzureData/preview/2019-07-24-preview/examples/DeleteSqlServer.
     * json
     */
    /**
    ...
    public static void deletesASQLServer(com.azure.resourcemanager.azuredata.AzureDataManager manager) {
        manager.sqlServers().deleteWithResponse("testrg", "testsqlregistration", "testsqlserver",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class SqlServersListByResourceGroupSamples {
     ...
     * x-ms-original-file:
     * specification/azuredata/resource-manager/Microsoft.AzureData/preview/2019-07-24-preview/examples/
     * ListByResourceGroupSqlServer.json
     */
    /**
     ...
     */
    public static void
        getsAllSQLServersInASQLServerRegistration(com.azure.resourcemanager.azuredata.AzureDataManager manager) {
        manager.sqlServers().listByResourceGroup("testrg", "testsqlregistration", null,
            com.azure.core.util.Context.NONE);
    }
}
```
