...
import com.azure.resourcemanager.postgresqlmicrosoftdbforpostgresqlpostgresqlserver.models.VirtualNetworkRuleListResult;
...
public final class VirtualNetworkRulesClientImpl implements VirtualNetworkRulesClient {
     ...
     */
    VirtualNetworkRulesClientImpl(PostgreSqlManagementClientImpl client) {
        this.service =
    ...
    /**
     * The interface defining all the services for PostgreSqlManagementClientVirtualNetworkRules to be used by the proxy
