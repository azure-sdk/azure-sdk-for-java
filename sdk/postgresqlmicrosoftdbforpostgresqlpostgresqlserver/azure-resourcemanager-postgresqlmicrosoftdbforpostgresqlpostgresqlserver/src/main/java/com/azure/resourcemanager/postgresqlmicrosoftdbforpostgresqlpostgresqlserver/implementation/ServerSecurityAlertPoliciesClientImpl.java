...
import com.azure.resourcemanager.postgresqlmicrosoftdbforpostgresqlpostgresqlserver.models.ServerSecurityAlertPolicyListResult;
...
public final class ServerSecurityAlertPoliciesClientImpl implements ServerSecurityAlertPoliciesClient {
    ...
    public interface ServerSecurityAlertPoliciesService {
        ...
        @Headers({"Content-Type: application/json"})
        @Get(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforPostgreSQL/servers/{serverName}/securityAlertPolicies")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
