...
/**
 * Initializes a new instance of the NotificationHubsRPClientImpl type.
 */
@ServiceClient(builder = NotificationHubsRPClientBuilder.class)
public final class NotificationHubsRPClientImpl implements NotificationHubsRPClient {
    /**
    ...
    /**
     * The NotificationHubsClient object to access its operations.
     */
    private final NotificationHubsClient notificationHubs;
     ...
     */
    public NotificationHubsClient getNotificationHubs() {
    ...
    /**
     * Initializes an instance of NotificationHubsRPClient client.
     * 
     ...
     */
    NotificationHubsRPClientImpl(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter,
        ...
        this.notificationHubs = new NotificationHubsClientImpl(this);
    ...
    private static final ClientLogger LOGGER = new ClientLogger(NotificationHubsRPClientImpl.class);
}
