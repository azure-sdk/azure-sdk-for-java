...
public final class NamespaceProperties {
    ...
    private List<PrivateEndpointConnectionResource> privateEndpointConnections;
    ...
    /**
     * Get the name property: Name of the Notification Hubs namespace. This is immutable property, set automatically by
     * the service when the namespace is created.
     *
