...
public final class SharedAccessAuthorizationRuleProperties {
    ...
    /**
     * Get the primaryKey property: Gets a base64-encoded 256-bit primary key for signing and validating the SAS token.
     *
    ...
    /**
     * Set the primaryKey property: Gets a base64-encoded 256-bit primary key for signing and validating the SAS token.
     *
    ...
    /**
     * Get the secondaryKey property: Gets a base64-encoded 256-bit primary key for signing and validating the SAS
     * token.
     *
    ...
    /**
     * Set the secondaryKey property: Gets a base64-encoded 256-bit primary key for signing and validating the SAS
     * token.
     *
