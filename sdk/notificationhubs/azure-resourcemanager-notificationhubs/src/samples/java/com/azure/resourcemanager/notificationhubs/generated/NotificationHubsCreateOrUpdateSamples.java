...
public final class NotificationHubsCreateOrUpdateSamples {
    /*
     * x-ms-original-file:
     * specification/notificationhubs/resource-manager/Microsoft.NotificationHubs/stable/2023-09-01/examples/
    ...
    public static void
        ...
        manager.notificationHubs().define("nh-sdk-hub").withRegion("eastus")
            .withExistingNamespace("5ktrial", "nh-sdk-ns").withProperties(new NotificationHubProperties()).create();
    }
}
