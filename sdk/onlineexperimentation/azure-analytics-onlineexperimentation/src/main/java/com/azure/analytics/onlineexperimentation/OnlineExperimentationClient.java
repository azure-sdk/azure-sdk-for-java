...
public final class OnlineExperimentationClient {
    ...
    public Response<BinaryData> validateMetricWithResponse(String experimentMetricId, BinaryData body,
        RequestOptions requestOptions) {
        return this.serviceClient.validateMetricWithResponse(experimentMetricId, body, requestOptions);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ExperimentMetricValidationResult validateMetric(String experimentMetricId, ExperimentMetric body) {
        // Generated convenience method for validateMetricWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return validateMetricWithResponse(experimentMetricId, BinaryData.fromObject(body), requestOptions).getValue()
