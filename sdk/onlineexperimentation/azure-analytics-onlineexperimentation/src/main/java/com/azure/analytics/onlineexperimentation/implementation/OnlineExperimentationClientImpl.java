...
public final class OnlineExperimentationClientImpl {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> validateMetricWithResponseAsync(String experimentMetricId, BinaryData body,
        RequestOptions requestOptions) {
        final String contentType = "application/json";
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.validateMetric(this.getEndpoint(), this.getServiceVersion().getVersion(),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<BinaryData> validateMetricWithResponse(String experimentMetricId, BinaryData body,
        RequestOptions requestOptions) {
        final String contentType = "application/json";
        final String accept = "application/json";
        return service.validateMetricSync(this.getEndpoint(), this.getServiceVersion().getVersion(), experimentMetricId,
