...
public final class OnlineExperimentationAsyncClient {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> validateMetricWithResponse(String experimentMetricId, BinaryData body,
        RequestOptions requestOptions) {
        return this.serviceClient.validateMetricWithResponseAsync(experimentMetricId, body, requestOptions);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<ExperimentMetricValidationResult> validateMetric(String experimentMetricId, ExperimentMetric body) {
        // Generated convenience method for validateMetricWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return validateMetricWithResponse(experimentMetricId, BinaryData.fromObject(body), requestOptions)
            .flatMap(FluxUtil::toMono)
