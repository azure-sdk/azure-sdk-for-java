...
public class ExperimentMetricDefinition implements JsonSerializable<ExperimentMetricDefinition> {
     ...
     */
    @Generated
    private MetricType type = MetricType.fromString("ExperimentMetricDefinition");
        ...
        return jsonReader.readObject(reader -> {
            ...
            try (JsonReader readerToUse = reader.bufferObject()) {
                ...
                if ("EventCount".equals(discriminatorValue)) {
                    return EventCountDefinition.fromJson(readerToUse.reset());
                } else if ("UserCount".equals(discriminatorValue)) {
                    return UserCountDefinition.fromJson(readerToUse.reset());
                } else if ("EventRate".equals(discriminatorValue)) {
                    return EventRateDefinition.fromJson(readerToUse.reset());
                } else if ("UserRate".equals(discriminatorValue)) {
                    return UserRateDefinition.fromJson(readerToUse.reset());
                } else if ("Sum".equals(discriminatorValue)) {
                    return SumDefinition.fromJson(readerToUse.reset());
                } else if ("Average".equals(discriminatorValue)) {
                    return AverageDefinition.fromJson(readerToUse.reset());
                } else if ("Percentile".equals(discriminatorValue)) {
                    return PercentileDefinition.fromJson(readerToUse.reset());
                } else {
    ...
    static ExperimentMetricDefinition fromJsonKnownDiscriminator(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("type".equals(fieldName)) {
                    deserializedExperimentMetricDefinition.type = MetricType.fromString(reader.getString());
                } else {
                    reader.skipChildren();
                }
            }
