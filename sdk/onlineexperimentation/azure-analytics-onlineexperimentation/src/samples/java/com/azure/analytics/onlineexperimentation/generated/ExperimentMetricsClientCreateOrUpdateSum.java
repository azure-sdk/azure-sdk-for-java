...
import com.azure.analytics.onlineexperimentation.models.SumDefinition;
...
public class ExperimentMetricsClientCreateOrUpdateSum {
    public static void main(String[] args) {
        OnlineExperimentationClient onlineExperimentationClient
            = new OnlineExperimentationClientBuilder().credential(new DefaultAzureCredentialBuilder().build())
                ...
                .buildClient();
        // BEGIN:com.azure.analytics.onlineexperimentation.generated.experimentmetricsclientcreateorupdate.experimentmetricsclientcreateorupdatesum
        ExperimentMetric response = onlineExperimentationClient.createOrUpdate("sum_revenue",
            new ExperimentMetric().setLifecycle(LifecycleStage.ACTIVE)
                ...
                .setDefinition(new SumDefinition()
        ...
        // END:com.azure.analytics.onlineexperimentation.generated.experimentmetricsclientcreateorupdate.experimentmetricsclientcreateorupdatesum
    }
}
