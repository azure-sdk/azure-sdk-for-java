...
import com.azure.analytics.onlineexperimentation.models.EventCountDefinition;
...
public class ExperimentMetricsClientCreateOrUpdateEventCount {
    public static void main(String[] args) {
        OnlineExperimentationClient onlineExperimentationClient
            = new OnlineExperimentationClientBuilder().credential(new DefaultAzureCredentialBuilder().build())
                ...
                .buildClient();
        // BEGIN:com.azure.analytics.onlineexperimentation.generated.experimentmetricsclientcreateorupdate.experimentmetricsclientcreateorupdateeventcount
        ExperimentMetric response = onlineExperimentationClient.createOrUpdate("events_purchase_creditcard",
            new ExperimentMetric().setLifecycle(LifecycleStage.ACTIVE)
                ...
                .setDefinition(new EventCountDefinition().setEvent(new ObservedEvent().setEventName("Transaction")
        ...
        // END:com.azure.analytics.onlineexperimentation.generated.experimentmetricsclientcreateorupdate.experimentmetricsclientcreateorupdateeventcount
    }
}
