...
public class DeleteMetricByMetricNameUsingLongRunningOperation {
    public static void main(String[] args) {
        OnlineExperimentationClient onlineExperimentationClient
            = new OnlineExperimentationClientBuilder().credential(new DefaultAzureCredentialBuilder().build())
                ...
                .buildClient();
        // BEGIN:com.azure.analytics.onlineexperimentation.generated.experimentmetricsclientdelete.deletemetricbymetricnameusinglongrunningoperation
        ...
        // END:com.azure.analytics.onlineexperimentation.generated.experimentmetricsclientdelete.deletemetricbymetricnameusinglongrunningoperation
    }
}
