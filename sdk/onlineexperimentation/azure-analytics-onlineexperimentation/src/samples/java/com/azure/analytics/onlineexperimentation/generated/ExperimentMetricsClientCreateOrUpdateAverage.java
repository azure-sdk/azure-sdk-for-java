...
public class ExperimentMetricsClientCreateOrUpdateAverage {
    public static void main(String[] args) {
        OnlineExperimentationClient onlineExperimentationClient
            = new OnlineExperimentationClientBuilder().credential(new DefaultAzureCredentialBuilder().build())
                ...
                .buildClient();
        // BEGIN:com.azure.analytics.onlineexperimentation.generated.experimentmetricsclientcreateorupdate.experimentmetricsclientcreateorupdateaverage
        ExperimentMetric response = onlineExperimentationClient.createOrUpdate("avg_purchase_revenue",
        ...
        // END:com.azure.analytics.onlineexperimentation.generated.experimentmetricsclientcreateorupdate.experimentmetricsclientcreateorupdateaverage
    }
}
