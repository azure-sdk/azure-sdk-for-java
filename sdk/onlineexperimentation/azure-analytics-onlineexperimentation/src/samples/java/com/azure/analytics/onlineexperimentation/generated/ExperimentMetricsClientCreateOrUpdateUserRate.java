...
import com.azure.analytics.onlineexperimentation.models.UserRateDefinition;
...
public class ExperimentMetricsClientCreateOrUpdateUserRate {
    public static void main(String[] args) {
        OnlineExperimentationClient onlineExperimentationClient
            = new OnlineExperimentationClientBuilder().credential(new DefaultAzureCredentialBuilder().build())
                ...
                .buildClient();
        // BEGIN:com.azure.analytics.onlineexperimentation.generated.experimentmetricsclientcreateorupdate.experimentmetricsclientcreateorupdateuserrate
        ExperimentMetric response = onlineExperimentationClient.createOrUpdate("rate_subscription_ad",
            new ExperimentMetric().setLifecycle(LifecycleStage.ACTIVE)
                ...
                .setDefinition(new UserRateDefinition()
                    .setStartEvent(
        ...
        // END:com.azure.analytics.onlineexperimentation.generated.experimentmetricsclientcreateorupdate.experimentmetricsclientcreateorupdateuserrate
    }
}
