...
public class ExperimentMetricsClientValidate {
    public static void main(String[] args) {
        OnlineExperimentationClient onlineExperimentationClient
            = new OnlineExperimentationClientBuilder().credential(new DefaultAzureCredentialBuilder().build())
                ...
                .buildClient();
        // BEGIN:com.azure.analytics.onlineexperimentation.generated.experimentmetricsclientvalidate.experimentmetricsclientvalidate
        ...
        // END:com.azure.analytics.onlineexperimentation.generated.experimentmetricsclientvalidate.experimentmetricsclientvalidate
    }
}
