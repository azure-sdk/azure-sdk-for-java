...
public class GetMetricByMetricName {
    public static void main(String[] args) {
        OnlineExperimentationClient onlineExperimentationClient
            = new OnlineExperimentationClientBuilder().credential(new DefaultAzureCredentialBuilder().build())
                ...
                .buildClient();
        // BEGIN:com.azure.analytics.onlineexperimentation.generated.experimentmetricsclientget.getmetricbymetricname
        ...
        // END:com.azure.analytics.onlineexperimentation.generated.experimentmetricsclientget.getmetricbymetricname
    }
}
