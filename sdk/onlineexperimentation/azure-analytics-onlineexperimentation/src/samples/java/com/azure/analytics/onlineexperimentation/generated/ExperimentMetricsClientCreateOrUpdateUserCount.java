...
import com.azure.analytics.onlineexperimentation.models.UserCountDefinition;
...
public class ExperimentMetricsClientCreateOrUpdateUserCount {
    public static void main(String[] args) {
        OnlineExperimentationClient onlineExperimentationClient
            = new OnlineExperimentationClientBuilder().credential(new DefaultAzureCredentialBuilder().build())
                ...
                .buildClient();
        // BEGIN:com.azure.analytics.onlineexperimentation.generated.experimentmetricsclientcreateorupdate.experimentmetricsclientcreateorupdateusercount
        ExperimentMetric response = onlineExperimentationClient.createOrUpdate("users_purchase", new ExperimentMetric()
            ...
            .setDefinition(new UserCountDefinition()
        ...
        // END:com.azure.analytics.onlineexperimentation.generated.experimentmetricsclientcreateorupdate.experimentmetricsclientcreateorupdateusercount
    }
}
