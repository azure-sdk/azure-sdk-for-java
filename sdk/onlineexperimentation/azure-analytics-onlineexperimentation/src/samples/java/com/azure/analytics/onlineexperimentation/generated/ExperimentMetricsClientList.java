...
public class ExperimentMetricsClientList {
    public static void main(String[] args) {
        OnlineExperimentationClient onlineExperimentationClient
            = new OnlineExperimentationClientBuilder().credential(new DefaultAzureCredentialBuilder().build())
                ...
                .buildClient();
        // BEGIN:com.azure.analytics.onlineexperimentation.generated.experimentmetricsclientlist.experimentmetricsclientlist
        PagedIterable<ExperimentMetric> response = onlineExperimentationClient.list();
        // END:com.azure.analytics.onlineexperimentation.generated.experimentmetricsclientlist.experimentmetricsclientlist
    }
}
