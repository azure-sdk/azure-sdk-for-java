...
import com.azure.analytics.onlineexperimentation.models.PercentileDefinition;
...
public class ExperimentMetricsClientCreateOrUpdatePercentile {
    public static void main(String[] args) {
        OnlineExperimentationClient onlineExperimentationClient
            = new OnlineExperimentationClientBuilder().credential(new DefaultAzureCredentialBuilder().build())
                ...
                .buildClient();
        // BEGIN:com.azure.analytics.onlineexperimentation.generated.experimentmetricsclientcreateorupdate.experimentmetricsclientcreateorupdatepercentile
        ExperimentMetric response = onlineExperimentationClient.createOrUpdate("p95_page_load_time",
            new ExperimentMetric().setLifecycle(LifecycleStage.ACTIVE)
                ...
                .setDefinition(new PercentileDefinition()
        ...
        // END:com.azure.analytics.onlineexperimentation.generated.experimentmetricsclientcreateorupdate.experimentmetricsclientcreateorupdatepercentile
    }
}
