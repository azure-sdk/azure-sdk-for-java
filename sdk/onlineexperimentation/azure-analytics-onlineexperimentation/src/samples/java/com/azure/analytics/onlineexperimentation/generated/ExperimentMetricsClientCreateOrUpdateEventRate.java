...
public class ExperimentMetricsClientCreateOrUpdateEventRate {
    public static void main(String[] args) {
        OnlineExperimentationClient onlineExperimentationClient
            = new OnlineExperimentationClientBuilder().credential(new DefaultAzureCredentialBuilder().build())
                ...
                .buildClient();
        // BEGIN:com.azure.analytics.onlineexperimentation.generated.experimentmetricsclientcreateorupdate.experimentmetricsclientcreateorupdateeventrate
        ...
        // END:com.azure.analytics.onlineexperimentation.generated.experimentmetricsclientcreateorupdate.experimentmetricsclientcreateorupdateeventrate
    }
}
