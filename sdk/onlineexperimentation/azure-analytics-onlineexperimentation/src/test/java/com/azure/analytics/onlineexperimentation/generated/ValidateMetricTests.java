...
import com.azure.analytics.onlineexperimentation.models.ValidationResult;
...
public final class ValidateMetricTests extends OnlineExperimentationClientTestBase {
    ...
    public void testValidateMetricTests() {
        // method invocation
        ExperimentMetricValidationResult response = onlineExperimentationClient.validateMetric(
            "events_purchase_creditcard",
        ...
        Assertions.assertEquals(ValidationResult.INVALID, response.getResult());
    }
}
