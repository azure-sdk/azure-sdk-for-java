...
@Disabled
public final class ExperimentMetricsClientCreateOrUpdatePercentileTests extends OnlineExperimentationClientTestBase {
    @Test
    @Disabled
    public void testExperimentMetricsClientCreateOrUpdatePercentileTests() {
        // method invocation
        ...
        Assertions.assertEquals(MetricType.PERCENTILE, responseDefinition.getType());
