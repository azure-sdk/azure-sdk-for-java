...
@Disabled
public final class ExperimentMetricsClientCreateOrUpdateSumTests extends OnlineExperimentationClientTestBase {
    @Test
    @Disabled
    public void testExperimentMetricsClientCreateOrUpdateSumTests() {
        // method invocation
        ...
        Assertions.assertEquals(MetricType.SUM, responseDefinition.getType());
