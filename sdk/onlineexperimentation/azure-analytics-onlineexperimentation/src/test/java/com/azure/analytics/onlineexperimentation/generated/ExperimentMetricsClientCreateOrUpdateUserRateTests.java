...
@Disabled
public final class ExperimentMetricsClientCreateOrUpdateUserRateTests extends OnlineExperimentationClientTestBase {
    @Test
    @Disabled
    public void testExperimentMetricsClientCreateOrUpdateUserRateTests() {
        // method invocation
        ...
        Assertions.assertEquals(MetricType.USER_RATE, responseDefinition.getType());
