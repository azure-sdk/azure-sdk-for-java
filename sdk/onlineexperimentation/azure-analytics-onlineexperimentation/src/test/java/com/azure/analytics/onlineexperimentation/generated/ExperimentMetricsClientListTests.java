...
@Disabled
public final class ExperimentMetricsClientListTests extends OnlineExperimentationClientTestBase {
    @Test
    @Disabled
    public void testExperimentMetricsClientListTests() {
        // method invocation
        PagedIterable<ExperimentMetric> response = onlineExperimentationClient.list();
        ...
        Assertions.assertEquals(MetricType.EVENT_COUNT, firstItemDefinition.getType());
