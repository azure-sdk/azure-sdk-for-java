...
@Disabled
public final class ExperimentMetricsClientCreateOrUpdateUserCountTests extends OnlineExperimentationClientTestBase {
    @Test
    @Disabled
    public void testExperimentMetricsClientCreateOrUpdateUserCountTests() {
        // method invocation
        ...
        Assertions.assertEquals(MetricType.USER_COUNT, responseDefinition.getType());
