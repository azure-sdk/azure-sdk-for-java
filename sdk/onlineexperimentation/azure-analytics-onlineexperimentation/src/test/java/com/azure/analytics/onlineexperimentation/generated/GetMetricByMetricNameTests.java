...
@Disabled
public final class GetMetricByMetricNameTests extends OnlineExperimentationClientTestBase {
    @Test
    @Disabled
    public void testGetMetricByMetricNameTests() {
        // method invocation
        ExperimentMetric response = onlineExperimentationClient.get("events_purchase_creditcard",
