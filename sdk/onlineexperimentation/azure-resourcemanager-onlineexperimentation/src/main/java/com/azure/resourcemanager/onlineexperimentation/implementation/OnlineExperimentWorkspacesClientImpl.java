...
public final class OnlineExperimentWorkspacesClientImpl implements OnlineExperimentWorkspacesClient {
     ...
     */
    OnlineExperimentWorkspacesClientImpl(OnlineExperimentationClientImpl client) {
    ...
    /**
     * The interface defining all the services for OnlineExperimentationClientOnlineExperimentWorkspaces to be used by
