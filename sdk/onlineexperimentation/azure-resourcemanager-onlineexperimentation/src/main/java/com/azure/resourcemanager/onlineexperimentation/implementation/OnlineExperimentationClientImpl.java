...
/**
 * Initializes a new instance of the OnlineExperimentationClientImpl type.
 */
@ServiceClient(builder = OnlineExperimentationClientBuilder.class)
public final class OnlineExperimentationClientImpl implements OnlineExperimentationClient {
    /**
     * Service host.
     */
     ...
     */
    OnlineExperimentationClientImpl(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter,
    ...
    private static final ClientLogger LOGGER = new ClientLogger(OnlineExperimentationClientImpl.class);
}
