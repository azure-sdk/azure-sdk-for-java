...
import com.azure.resourcemanager.relationships.fluent.MicrosoftRelationshipsManagementService;
import com.azure.resourcemanager.relationships.implementation.DependencyOfRelationshipsImpl;
import com.azure.resourcemanager.relationships.implementation.MicrosoftRelationshipsManagementServiceBuilder;
...
/**
 * Entry point to RelationshipsManager.
...
public final class RelationshipsManager {
    ...
    private final MicrosoftRelationshipsManagementService clientObject;
    ...
    private RelationshipsManager(HttpPipeline httpPipeline, AzureProfile profile, Duration defaultPollInterval) {
        ...
        this.clientObject = new MicrosoftRelationshipsManagementServiceBuilder().pipeline(httpPipeline)
     ...
     */
    public static RelationshipsManager authenticate(TokenCredential credential, AzureProfile profile) {
     ...
     * @return the relationships service API instance.
     */
    public static RelationshipsManager authenticate(HttpPipeline httpPipeline, AzureProfile profile) {
        Objects.requireNonNull(httpPipeline, "'httpPipeline' cannot be null.");
        Objects.requireNonNull(profile, "'profile' cannot be null.");
        return new RelationshipsManager(httpPipeline, profile, null);
    }

    /**
     * Gets a Configurable instance that can be used to create RelationshipsManager with optional configuration.
     * 
     * @return the Configurable instance allowing configurations.
     */
    public static Configurable configure() {
        return new RelationshipsManager.Configurable();
    }
    ...
    public static final class Configurable {
        ...
        private static final Map<String, String> PROPERTIES
            = CoreUtils.getProperties("azure-resourcemanager-relationships.properties");
    ...
    /**
     * Gets wrapped service client MicrosoftRelationshipsManagementService providing direct access to the underlying
     * auto-generated API implementation, based on Azure REST API.
     * 
     * @return Wrapped service client MicrosoftRelationshipsManagementService.
     */
    public MicrosoftRelationshipsManagementService serviceClient() {
