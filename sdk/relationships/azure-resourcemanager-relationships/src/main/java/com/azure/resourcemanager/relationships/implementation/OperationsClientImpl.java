...
import com.azure.resourcemanager.relationships.models.OperationListResult;
...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    OperationsClientImpl(MicrosoftRelationshipsManagementServiceImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for MicrosoftRelationshipsManagementServiceOperations to be used by the
