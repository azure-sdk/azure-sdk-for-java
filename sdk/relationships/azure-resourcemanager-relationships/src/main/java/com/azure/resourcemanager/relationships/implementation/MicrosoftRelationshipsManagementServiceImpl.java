...
/**
 * Initializes a new instance of the MicrosoftRelationshipsManagementServiceImpl type.
 */
@ServiceClient(builder = MicrosoftRelationshipsManagementServiceBuilder.class)
public final class MicrosoftRelationshipsManagementServiceImpl implements MicrosoftRelationshipsManagementService {
    /**
     * server parameter.
     */
    ...
    /**
     * Initializes an instance of MicrosoftRelationshipsManagementService client.
     * 
     ...
     */
    MicrosoftRelationshipsManagementServiceImpl(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter,
    ...
    private static final ClientLogger LOGGER = new ClientLogger(MicrosoftRelationshipsManagementServiceImpl.class);
}
