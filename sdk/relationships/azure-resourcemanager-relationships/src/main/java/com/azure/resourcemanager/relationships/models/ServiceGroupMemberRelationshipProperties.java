...
public final class ServiceGroupMemberRelationshipProperties
        ...
        if (targetId() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property targetId in model ServiceGroupMemberRelationshipProperties"));
        }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(ServiceGroupMemberRelationshipProperties.class);
