...
/**
 * An instance of this class provides access to all the operations defined in Motorcycles.
 */
public final class MotorcyclesImpl {
    /**
     * The proxy service used to perform REST calls.
     */
    private final MotorcyclesService service;
    ...
    /**
     * Initializes an instance of MotorcyclesImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    MotorcyclesImpl(ServiceClientClientImpl client) {
        this.service
            = RestProxy.create(MotorcyclesService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }
    ...
    /**
     * The interface defining all the services for ServiceClientClientMotorcycles to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "ServiceClientClientM")
    public interface MotorcyclesService {
        @Get("/workspaces/{workspaceName}/motorcycles/{motorcycleId}")
        ...
        Mono<Response<BinaryData>> get(@HostParam("endpoint") String endpoint,
            ...
            @PathParam("motorcycleId") String motorcycleId, @HeaderParam("accept") String accept,
        ...
        Mono<Response<BinaryData>> createOrUpdate(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("workspaceName") String workspaceName,
            @PathParam("motorcycleId") String motorcycleId, @HeaderParam("Content-Type") String contentType,
        ...
        @Get("/workspaces/{workspaceName}/motorcycles")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(value = ClientAuthenticationException.class, code = { 401 })
        @UnexpectedResponseExceptionType(value = ResourceNotFoundException.class, code = { 404 })
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
    ...
    public Mono<Response<BinaryData>> getWithResponseAsync(String workspaceName, String motorcycleId,
        RequestOptions requestOptions) {
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.get(this.client.getEndpoint(), this.client.getServiceVersion().getVersion(),
                workspaceName, motorcycleId, accept, requestOptions, context));
    }
    ...
    public Response<BinaryData> getWithResponse(String workspaceName, String motorcycleId,
        ...
        return service.getSync(this.client.getEndpoint(), this.client.getServiceVersion().getVersion(), workspaceName,
            motorcycleId, accept, requestOptions, Context.NONE);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> createOrUpdateWithResponseAsync(String workspaceName, String motorcycleId,
        ...
        return FluxUtil.withContext(
            context -> service.createOrUpdate(this.client.getEndpoint(), this.client.getServiceVersion().getVersion(),
                workspaceName, motorcycleId, contentType, accept, resource, requestOptions, context));
    }
    ...
    public Response<BinaryData> createOrUpdateWithResponse(String workspaceName, String motorcycleId,
        ...
        return service.createOrUpdateSync(this.client.getEndpoint(), this.client.getServiceVersion().getVersion(),
            workspaceName, motorcycleId, contentType, accept, resource, requestOptions, Context.NONE);
    }
     ...
     * @throws ResourceNotFoundException thrown if the request is rejected by server on status code 404.
     * @throws ResourceModifiedException thrown if the request is rejected by server on status code 409.
     * @return paged collection of Motorcycle items along with {@link PagedResponse} on successful completion of
     * {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
     ...
     * @throws ResourceNotFoundException thrown if the request is rejected by server on status code 404.
     * @throws ResourceModifiedException thrown if the request is rejected by server on status code 409.
     * @return paged collection of Motorcycle items along with {@link PagedResponse}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
