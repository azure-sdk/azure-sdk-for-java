...
public final class MarkdownPartMetadata extends DashboardPartMetadata {
     ...
     */
    private String type = "Extension/HubsExtension/PartType/MarkdownPart";
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("type".equals(fieldName)) {
                    deserializedMarkdownPartMetadata.type = reader.getString();
            ...
            deserializedMarkdownPartMetadata.withAdditionalProperties(additionalProperties);
