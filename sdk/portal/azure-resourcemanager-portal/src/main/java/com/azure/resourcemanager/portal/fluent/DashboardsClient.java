...
public interface DashboardsClient {
    ...
    Response<DashboardInner> createOrUpdateWithResponse(String resourceGroupName, String dashboardName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<DashboardInner> getByResourceGroupWithResponse(String resourceGroupName, String dashboardName,
        Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<DashboardInner> updateWithResponse(String resourceGroupName, String dashboardName,
