...
import com.azure.resourcemanager.portal.fluent.models.OperationInner;
import com.azure.resourcemanager.portal.models.OperationListResult;
...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    OperationsClientImpl(PortalForTestingImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for PortalForTestingOperations to be used by the proxy service to perform
     * REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "PortalForTestingOper")
