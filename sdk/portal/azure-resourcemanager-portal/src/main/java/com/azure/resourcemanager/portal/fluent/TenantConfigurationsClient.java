...
public interface TenantConfigurationsClient {
    ...
    PagedIterable<TenantConfigurationInner> listByTenant();
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<TenantConfigurationInner> listByTenant(Context context);
    ...
    Response<TenantConfigurationInner> getWithResponse(String configurationName, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    TenantConfigurationInner get(String configurationName);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<TenantConfigurationInner> createWithResponse(String configurationName, TenantConfigurationInner resource,
        Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    TenantConfigurationInner create(String configurationName, TenantConfigurationInner resource);
