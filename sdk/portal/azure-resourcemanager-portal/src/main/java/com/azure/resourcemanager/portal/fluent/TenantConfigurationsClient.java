...
public interface TenantConfigurationsClient {
    ...
    Response<ConfigurationInner> getWithResponse(ConfigurationName configurationName, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<ConfigurationInner> createWithResponse(ConfigurationName configurationName,
