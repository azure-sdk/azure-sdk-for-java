...
/**
 * Initializes a new instance of the PortalForTestingImpl type.
 */
@ServiceClient(builder = PortalForTestingBuilder.class)
public final class PortalForTestingImpl implements PortalForTesting {
    /**
    ...
    /**
     * Initializes an instance of PortalForTesting client.
     * 
     ...
     */
    PortalForTestingImpl(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter, Duration defaultPollInterval,
    ...
    private static final ClientLogger LOGGER = new ClientLogger(PortalForTestingImpl.class);
}
