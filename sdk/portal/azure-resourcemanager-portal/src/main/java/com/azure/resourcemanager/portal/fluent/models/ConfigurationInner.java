...
public final class ConfigurationInner extends ProxyResource {
     ...
     */
    public ConfigurationInner withProperties(ConfigurationProperties properties) {
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("id".equals(fieldName)) {
                    ...
                    deserializedConfigurationInner.properties = ConfigurationProperties.fromJson(reader);
