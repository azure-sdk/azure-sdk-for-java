...
public final class DashboardsClientImpl implements DashboardsClient {
    ...
    public interface DashboardsService {
        ...
        Mono<Response<DashboardInner>> createOrUpdate(@HostParam("$host") String endpoint,
            ...
            @QueryParam("api-version") String apiVersion, @BodyParam("application/json") DashboardInner dashboard,
        ...
        Mono<Response<DashboardInner>> update(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("dashboardName") String dashboardName,
            @QueryParam("api-version") String apiVersion, @BodyParam("application/json") PatchableDashboard dashboard,
            @HeaderParam("Accept") String accept, Context context);
    ...
    private Mono<Response<DashboardInner>> createOrUpdateWithResponseAsync(String resourceGroupName,
        String dashboardName, DashboardInner dashboard) {
        ...
        return FluxUtil
            .withContext(context -> service.createOrUpdate(this.client.getEndpoint(), this.client.getSubscriptionId(),
                resourceGroupName, dashboardName, this.client.getApiVersion(), dashboard, accept, context))
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<DashboardInner>> createOrUpdateWithResponseAsync(String resourceGroupName,
        String dashboardName, DashboardInner dashboard, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service.createOrUpdate(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            dashboardName, this.client.getApiVersion(), dashboard, accept, context);
    }
    ...
    public Response<DashboardInner> createOrUpdateWithResponse(String resourceGroupName, String dashboardName,
        DashboardInner dashboard, Context context) {
    ...
    public DashboardInner createOrUpdate(String resourceGroupName, String dashboardName, DashboardInner dashboard) {
        return createOrUpdateWithResponse(resourceGroupName, dashboardName, dashboard, Context.NONE).getValue();
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<DashboardInner>> updateWithResponseAsync(String resourceGroupName, String dashboardName,
        PatchableDashboard dashboard, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    public DashboardInner update(String resourceGroupName, String dashboardName, PatchableDashboard dashboard) {
        return updateWithResponse(resourceGroupName, dashboardName, dashboard, Context.NONE).getValue();
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return list of dashboards along with {@link PagedResponse} on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
