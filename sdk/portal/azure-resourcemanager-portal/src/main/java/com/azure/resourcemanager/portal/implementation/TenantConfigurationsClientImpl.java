...
public final class TenantConfigurationsClientImpl implements TenantConfigurationsClient {
    ...
    public interface TenantConfigurationsService {
        ...
        Mono<Response<ConfigurationList>> list(@HostParam("$host") String endpoint,
        ...
        Mono<Response<ConfigurationInner>> create(@HostParam("$host") String endpoint,
            ...
            @BodyParam("application/json") ConfigurationInner tenantConfiguration, @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ConfigurationList>> listNext(@PathParam(value = "nextLink", encoded = true) String nextLink,
    ...
    private Mono<Response<ConfigurationInner>> getWithResponseAsync(ConfigurationName configurationName) {
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.get(this.client.getEndpoint(), configurationName,
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return tenant configuration along with {@link Response} on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ConfigurationInner>> createWithResponseAsync(ConfigurationName configurationName,
        ConfigurationInner tenantConfiguration) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.create(this.client.getEndpoint(), configurationName,
                this.client.getApiVersion(), tenantConfiguration, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ConfigurationInner>> createWithResponseAsync(ConfigurationName configurationName,
        ConfigurationInner tenantConfiguration, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.create(this.client.getEndpoint(), configurationName, this.client.getApiVersion(),
            tenantConfiguration, accept, context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return tenant configuration on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ConfigurationInner> createAsync(ConfigurationName configurationName,
        ConfigurationInner tenantConfiguration) {
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return tenant configuration along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ConfigurationInner> createWithResponse(ConfigurationName configurationName,
        ConfigurationInner tenantConfiguration, Context context) {
    ...
    public ConfigurationInner create(ConfigurationName configurationName, ConfigurationInner tenantConfiguration) {
        return createWithResponse(configurationName, tenantConfiguration, Context.NONE).getValue();
    }
    ...
    private Mono<Response<Void>> deleteWithResponseAsync(ConfigurationName configurationName) {
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.delete(this.client.getEndpoint(), configurationName,
                this.client.getApiVersion(), accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<Void>> deleteWithResponseAsync(ConfigurationName configurationName, Context context) {
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.delete(this.client.getEndpoint(), configurationName, this.client.getApiVersion(), accept,
            context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return list of tenant configurations along with {@link PagedResponse} on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
