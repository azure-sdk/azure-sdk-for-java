...
public final class TenantConfigurationsClientImpl implements TenantConfigurationsClient {
     ...
     */
    TenantConfigurationsClientImpl(PortalForTestingImpl client) {
    ...
    /**
     * The interface defining all the services for PortalForTestingTenantConfigurations to be used by the proxy service
     * to perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "PortalForTestingTena")
