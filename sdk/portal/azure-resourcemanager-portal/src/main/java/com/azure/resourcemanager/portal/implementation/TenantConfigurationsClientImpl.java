...
import com.azure.resourcemanager.portal.models.TenantConfigurationListResult;
...
public final class TenantConfigurationsClientImpl implements TenantConfigurationsClient {
    ...
    public interface TenantConfigurationsService {
        ...
        Mono<Response<TenantConfigurationListResult>> listByTenant(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<TenantConfigurationInner>> get(@HostParam("$host") String endpoint,
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<TenantConfigurationInner>> create(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("configurationName") String configurationName,
            @BodyParam("application/json") TenantConfigurationInner resource, @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<TenantConfigurationListResult>> listByTenantNext(
    ...
    private Mono<PagedResponse<TenantConfigurationInner>> listByTenantSinglePageAsync() {
        ...
        return FluxUtil.withContext(
            ...
            .<PagedResponse<TenantConfigurationInner>>map(res -> new PagedResponseBase<>(res.getRequest(),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<TenantConfigurationInner>> listByTenantSinglePageAsync(Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    private PagedFlux<TenantConfigurationInner> listByTenantAsync() {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<TenantConfigurationInner> listByTenantAsync(Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<TenantConfigurationInner> listByTenant() {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<TenantConfigurationInner> listByTenant(Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<TenantConfigurationInner>> getWithResponseAsync(String configurationName) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<TenantConfigurationInner>> getWithResponseAsync(String configurationName, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<TenantConfigurationInner> getAsync(String configurationName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<TenantConfigurationInner> getWithResponse(String configurationName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public TenantConfigurationInner get(String configurationName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<TenantConfigurationInner>> createWithResponseAsync(String configurationName,
        TenantConfigurationInner resource) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<TenantConfigurationInner>> createWithResponseAsync(String configurationName,
        TenantConfigurationInner resource, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<TenantConfigurationInner> createAsync(String configurationName, TenantConfigurationInner resource) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<TenantConfigurationInner> createWithResponse(String configurationName,
        TenantConfigurationInner resource, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public TenantConfigurationInner create(String configurationName, TenantConfigurationInner resource) {
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the response of a TenantConfiguration list operation along with {@link PagedResponse} on successful
     * completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<TenantConfigurationInner>> listByTenantNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
