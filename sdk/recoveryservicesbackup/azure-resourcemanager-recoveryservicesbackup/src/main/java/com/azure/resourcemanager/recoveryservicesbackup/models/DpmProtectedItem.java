        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("backupManagementType".equals(fieldName)) {
                    deserializedDpmProtectedItem.backupManagementType
                        = BackupManagementType.fromString(reader.getString());
                } else if ("workloadType".equals(fieldName)) {
                    deserializedDpmProtectedItem.workloadType = DataSourceType.fromString(reader.getString());
                    ...
                    deserializedDpmProtectedItem.vaultId = reader.getString();
