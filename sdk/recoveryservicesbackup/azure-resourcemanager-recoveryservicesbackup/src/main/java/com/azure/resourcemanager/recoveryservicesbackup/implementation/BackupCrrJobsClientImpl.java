...
public final class BackupCrrJobsClientImpl implements BackupCrrJobsClient {
    ...
    public interface BackupCrrJobsService {
        ...
        Mono<Response<JobResourceList>> list(@HostParam("$host") String endpoint,
            ...
            @QueryParam("$skipToken") String skipToken, @BodyParam("application/json") CrrJobRequest parameters,
     ...
     * @return the list of CRR jobs from the target region along with {@link PagedResponse} on successful completion of
     * {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<JobResourceInner>> listSinglePageAsync(String azureRegion, CrrJobRequest parameters,
        ...
        return FluxUtil
            .withContext(context -> service.list(this.client.getEndpoint(), this.client.getApiVersion(), azureRegion,
                this.client.getSubscriptionId(), filter, skipToken, parameters, accept, context))
    ...
    private Mono<PagedResponse<JobResourceInner>> listSinglePageAsync(String azureRegion, CrrJobRequest parameters,
        ...
        return service
            .list(this.client.getEndpoint(), this.client.getApiVersion(), azureRegion, this.client.getSubscriptionId(),
                filter, skipToken, parameters, accept, context)
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the list of CRR jobs from the target region as paginated response with {@link PagedFlux}.
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<JobResourceInner> listAsync(String azureRegion, CrrJobRequest parameters, String filter,
        String skipToken) {
        return new PagedFlux<>(() -> listSinglePageAsync(azureRegion, parameters, filter, skipToken),
    ...
    private PagedFlux<JobResourceInner> listAsync(String azureRegion, CrrJobRequest parameters, String filter,
        ...
        return new PagedFlux<>(() -> listSinglePageAsync(azureRegion, parameters, filter, skipToken, context),
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the list of CRR jobs from the target region as paginated response with {@link PagedIterable}.
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<JobResourceInner> list(String azureRegion, CrrJobRequest parameters, String filter,
        String skipToken, Context context) {
