...
public final class CrossRegionRestoresClientImpl implements CrossRegionRestoresClient {
    ...
    public interface CrossRegionRestoresService {
        ...
        Mono<Response<Flux<ByteBuffer>>> trigger(@HostParam("$host") String endpoint,
            ...
            @BodyParam("application/json") CrossRegionRestoreRequest parameters, @HeaderParam("Accept") String accept,
            Context context);
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> triggerWithResponseAsync(String azureRegion,
        CrossRegionRestoreRequest parameters) {
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> triggerWithResponseAsync(String azureRegion,
        CrossRegionRestoreRequest parameters, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service.trigger(this.client.getEndpoint(), this.client.getApiVersion(), azureRegion,
            this.client.getSubscriptionId(), parameters, accept, context);
    }
    ...
    private PollerFlux<PollResult<Void>, Void> beginTriggerAsync(String azureRegion,
        CrossRegionRestoreRequest parameters) {
    ...
    public SyncPoller<PollResult<Void>, Void> beginTrigger(String azureRegion, CrossRegionRestoreRequest parameters) {
        return this.beginTriggerAsync(azureRegion, parameters).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginTrigger(String azureRegion, CrossRegionRestoreRequest parameters,
        Context context) {
        return this.beginTriggerAsync(azureRegion, parameters, context).getSyncPoller();
    }
    ...
    private Mono<Void> triggerAsync(String azureRegion, CrossRegionRestoreRequest parameters, Context context) {
        return beginTriggerAsync(azureRegion, parameters, context).last()
