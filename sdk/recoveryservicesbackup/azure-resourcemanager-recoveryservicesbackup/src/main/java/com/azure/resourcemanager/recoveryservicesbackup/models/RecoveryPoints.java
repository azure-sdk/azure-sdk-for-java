...
public interface RecoveryPoints {
     ...
     */
    Response<CrrAccessTokenResource> getAccessTokenWithResponse(String vaultName, String resourceGroupName,
     ...
     * @return the response.
     */
    CrrAccessTokenResource getAccessToken(String vaultName, String resourceGroupName, String fabricName,
