...
public final class BackupProtectedItemsCrrsClientImpl implements BackupProtectedItemsCrrsClient {
     ...
     */
    BackupProtectedItemsCrrsClientImpl(RecoveryServicesBackupClientImpl client) {
    ...
    /**
     * The interface defining all the services for RecoveryServicesBackupClientBackupProtectedItemsCrrs to be used by
    ...
    public interface BackupProtectedItemsCrrsService {
        ...
        Mono<Response<ProtectedItemResourceList>> list(@HostParam("$host") String endpoint,
