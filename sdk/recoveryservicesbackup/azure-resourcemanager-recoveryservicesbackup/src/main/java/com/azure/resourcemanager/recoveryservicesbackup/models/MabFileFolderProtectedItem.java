        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("backupManagementType".equals(fieldName)) {
                    deserializedMabFileFolderProtectedItem.backupManagementType
                        = BackupManagementType.fromString(reader.getString());
                } else if ("workloadType".equals(fieldName)) {
                    deserializedMabFileFolderProtectedItem.workloadType = DataSourceType.fromString(reader.getString());
                    ...
                    deserializedMabFileFolderProtectedItem.vaultId = reader.getString();
