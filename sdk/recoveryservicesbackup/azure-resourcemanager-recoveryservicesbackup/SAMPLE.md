...
public final class ProtectionPoliciesCreateOrUpdateSamples {
     ...
     * x-ms-original-file:
     * specification/recoveryservicesbackup/resource-manager/Microsoft.RecoveryServices/preview/2024-11-01-preview/
     * examples/AzureWorkload/ProtectionPolicies_CreateOrUpdate_SapHanaDBInstance.json
     */
    /**
...
public final class ProtectionPoliciesGetSamples {
     ...
     * x-ms-original-file:
     * specification/recoveryservicesbackup/resource-manager/Microsoft.RecoveryServices/preview/2024-11-01-preview/
     * examples/AzureWorkload/ProtectionPolicies_Get_SapHanaDBInstance.json
     */
    /**
...
public final class RestoresTriggerSamples {
     ...
     */
    /**
     * Sample code: Restore to IaaS VM with Resource Guard enabled.
     * 
     * @param manager Entry point to RecoveryServicesBackupManager.
     */
    public static void restoreToIaaSVMWithResourceGuardEnabled(
        com.azure.resourcemanager.recoveryservicesbackup.RecoveryServicesBackupManager manager) {
        manager.restores()
            .trigger("testVault", "netsdktestrg", "Azure",
                "IaasVMContainer;iaasvmcontainerv2;netsdktestrg;netvmtestv2vm1",
