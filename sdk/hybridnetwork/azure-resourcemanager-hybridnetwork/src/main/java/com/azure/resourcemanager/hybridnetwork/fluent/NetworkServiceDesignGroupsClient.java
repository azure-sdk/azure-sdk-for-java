...
public interface NetworkServiceDesignGroupsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<NetworkServiceDesignGroupInner> listByPublisher(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    NetworkServiceDesignGroupInner createOrUpdate(
        String resourceGroupName,
        String publisherName,
        String networkServiceDesignGroupName,
        NetworkServiceDesignGroupInner parameters);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<NetworkServiceDesignGroupInner> getWithResponse(
        String resourceGroupName, String publisherName, String networkServiceDesignGroupName, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    NetworkServiceDesignGroupInner get(
        String resourceGroupName, String publisherName, String networkServiceDesignGroupName);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<NetworkServiceDesignGroupInner> updateWithResponse(
        String resourceGroupName,
        String publisherName,
        String networkServiceDesignGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    NetworkServiceDesignGroupInner update(
