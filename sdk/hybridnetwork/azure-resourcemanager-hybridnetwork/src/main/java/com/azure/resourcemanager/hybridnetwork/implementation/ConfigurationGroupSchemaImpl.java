    ...
    public ConfigurationGroupSchema create(Context context) {
        this.innerObject =
            serviceManager
                ...
                .getConfigurationGroupSchemas()
                .createOrUpdate(
                    resourceGroupName, publisherName, configurationGroupSchemaName, this.innerModel(), context);
        return this;
    }

    ConfigurationGroupSchemaImpl(
    ...
    public ConfigurationGroupSchema apply() {
        this.innerObject =
            serviceManager
                ...
                .getConfigurationGroupSchemas()
                .updateWithResponse(
                    resourceGroupName, publisherName, configurationGroupSchemaName, updateParameters, Context.NONE)
                .getValue();
        return this;
    }
    ...
    public ConfigurationGroupSchema apply(Context context) {
        this.innerObject =
            serviceManager
                ...
                .getConfigurationGroupSchemas()
                .updateWithResponse(
                    resourceGroupName, publisherName, configurationGroupSchemaName, updateParameters, context)
                .getValue();
        return this;
    }

    ConfigurationGroupSchemaImpl(
        ConfigurationGroupSchemaInner innerObject,
