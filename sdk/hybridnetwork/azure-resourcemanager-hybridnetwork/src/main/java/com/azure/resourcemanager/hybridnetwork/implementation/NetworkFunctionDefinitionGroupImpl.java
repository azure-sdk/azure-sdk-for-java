...
public final class NetworkFunctionDefinitionGroupImpl
    implements NetworkFunctionDefinitionGroup,
        NetworkFunctionDefinitionGroup.Definition,
        NetworkFunctionDefinitionGroup.Update {
    ...
    NetworkFunctionDefinitionGroupImpl(
    ...
    public NetworkFunctionDefinitionGroup apply(Context context) {
        this.innerObject =
            serviceManager
                ...
                .getNetworkFunctionDefinitionGroups()
                .updateWithResponse(
                    resourceGroupName, publisherName, networkFunctionDefinitionGroupName, updateParameters, context)
                .getValue();
        return this;
    }

    NetworkFunctionDefinitionGroupImpl(
        NetworkFunctionDefinitionGroupInner innerObject,
    ...
    public NetworkFunctionDefinitionGroupImpl withProperties(
