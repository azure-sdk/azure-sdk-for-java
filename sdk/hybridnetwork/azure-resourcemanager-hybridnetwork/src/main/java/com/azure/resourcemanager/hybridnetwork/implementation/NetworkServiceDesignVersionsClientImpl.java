...
public final class NetworkServiceDesignVersionsClientImpl implements NetworkServiceDesignVersionsClient {
    ...
    NetworkServiceDesignVersionsClientImpl(HybridNetworkManagementClientImpl client) {
        this.service =
            RestProxy
                .create(
                    NetworkServiceDesignVersionsService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }
    ...
    public interface NetworkServiceDesignVersionsService {
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<NetworkServiceDesignVersionInner>> get(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("publisherName") String publisherName,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<NetworkServiceDesignVersionInner>> update(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("publisherName") String publisherName,
    ...
    private PollerFlux<PollResult<NetworkServiceDesignVersionInner>, NetworkServiceDesignVersionInner>
        ...
        return this
            .client
            .<NetworkServiceDesignVersionInner, NetworkServiceDesignVersionInner>getLroResult(
                mono,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<NetworkServiceDesignVersionInner> createOrUpdateAsync(
        String resourceGroupName,
        String publisherName,
        String networkServiceDesignGroupName,
        String networkServiceDesignVersionName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public NetworkServiceDesignVersionInner createOrUpdate(
        String resourceGroupName,
        String publisherName,
        String networkServiceDesignGroupName,
        String networkServiceDesignVersionName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<NetworkServiceDesignVersionInner>> getWithResponseAsync(
        String resourceGroupName,
        String publisherName,
        String networkServiceDesignGroupName,
        String networkServiceDesignVersionName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<NetworkServiceDesignVersionInner> getAsync(
        String resourceGroupName,
        String publisherName,
        String networkServiceDesignGroupName,
        String networkServiceDesignVersionName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<NetworkServiceDesignVersionInner> getWithResponse(
        String resourceGroupName,
        String publisherName,
        String networkServiceDesignGroupName,
        String networkServiceDesignVersionName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public NetworkServiceDesignVersionInner get(
        String resourceGroupName,
        String publisherName,
        String networkServiceDesignGroupName,
        String networkServiceDesignVersionName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<NetworkServiceDesignVersionInner>> updateWithResponseAsync(
        String resourceGroupName,
        String publisherName,
        String networkServiceDesignGroupName,
        String networkServiceDesignVersionName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<NetworkServiceDesignVersionInner> updateAsync(
        String resourceGroupName,
        String publisherName,
        String networkServiceDesignGroupName,
        String networkServiceDesignVersionName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<NetworkServiceDesignVersionInner> updateWithResponse(
        String resourceGroupName,
        String publisherName,
        String networkServiceDesignGroupName,
        String networkServiceDesignVersionName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public NetworkServiceDesignVersionInner update(
        String resourceGroupName,
        String publisherName,
        String networkServiceDesignGroupName,
        String networkServiceDesignVersionName,
                ...
                context ->
                    service
                        .listByNetworkServiceDesignGroup(
                            ...
                            accept,
                            context))
            .<PagedResponse<NetworkServiceDesignVersionInner>>map(
                res ->
    ...
    private PagedFlux<NetworkServiceDesignVersionInner> listByNetworkServiceDesignGroupAsync(
        String resourceGroupName, String publisherName, String networkServiceDesignGroupName) {
        return new PagedFlux<>(
            () ->
                listByNetworkServiceDesignGroupSinglePageAsync(
                    resourceGroupName, publisherName, networkServiceDesignGroupName),
    ...
    private PagedFlux<NetworkServiceDesignVersionInner> listByNetworkServiceDesignGroupAsync(
        ...
        return new PagedFlux<>(
            () ->
                listByNetworkServiceDesignGroupSinglePageAsync(
                    resourceGroupName, publisherName, networkServiceDesignGroupName, context),
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<NetworkServiceDesignVersionInner> listByNetworkServiceDesignGroup(
        String resourceGroupName, String publisherName, String networkServiceDesignGroupName) {
    ...
    public PagedIterable<NetworkServiceDesignVersionInner> listByNetworkServiceDesignGroup(
        String resourceGroupName, String publisherName, String networkServiceDesignGroupName, Context context) {
        return new PagedIterable<>(
            listByNetworkServiceDesignGroupAsync(
                resourceGroupName, publisherName, networkServiceDesignGroupName, context));
    }
    ...
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<
            PollResult<NetworkServiceDesignVersionUpdateStateInner>, NetworkServiceDesignVersionUpdateStateInner>
        ...
        return this
            ...
            .<NetworkServiceDesignVersionUpdateStateInner, NetworkServiceDesignVersionUpdateStateInner>getLroResult(
                mono,
                this.client.getHttpPipeline(),
                NetworkServiceDesignVersionUpdateStateInner.class,
                NetworkServiceDesignVersionUpdateStateInner.class,
                this.client.getContext());
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return publisher network service design version update request definition on successful completion of {@link
     *     Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<NetworkServiceDesignVersionUpdateStateInner> updateStateAsync(
        String resourceGroupName,
        String publisherName,
        String networkServiceDesignGroupName,
        String networkServiceDesignVersionName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public NetworkServiceDesignVersionUpdateStateInner updateState(
        String resourceGroupName,
        String publisherName,
        String networkServiceDesignGroupName,
        String networkServiceDesignVersionName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<NetworkServiceDesignVersionInner>> listByNetworkServiceDesignGroupNextSinglePageAsync(
        String nextLink) {
        if (nextLink == null) {
        ...
        return FluxUtil
            .withContext(
                context ->
                    service.listByNetworkServiceDesignGroupNext(nextLink, this.client.getEndpoint(), accept, context))
            .<PagedResponse<NetworkServiceDesignVersionInner>>map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(),
    ...
    private Mono<PagedResponse<NetworkServiceDesignVersionInner>> listByNetworkServiceDesignGroupNextSinglePageAsync(
        ...
        context = this.client.mergeContext(context);
        return service
            .listByNetworkServiceDesignGroupNext(nextLink, this.client.getEndpoint(), accept, context)
            .map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(),
