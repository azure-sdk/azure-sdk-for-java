...
public interface NetworkFunctionDefinitionVersionsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<NetworkFunctionDefinitionVersionInner> getWithResponse(
        String resourceGroupName,
        String publisherName,
        String networkFunctionDefinitionGroupName,
        String networkFunctionDefinitionVersionName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    NetworkFunctionDefinitionVersionInner get(
        String resourceGroupName,
        String publisherName,
        String networkFunctionDefinitionGroupName,
        String networkFunctionDefinitionVersionName);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<NetworkFunctionDefinitionVersionInner> updateWithResponse(
        String resourceGroupName,
        String publisherName,
        String networkFunctionDefinitionGroupName,
        String networkFunctionDefinitionVersionName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    NetworkFunctionDefinitionVersionInner update(
        String resourceGroupName,
        String publisherName,
        String networkFunctionDefinitionGroupName,
        String networkFunctionDefinitionVersionName,
    ...
    PagedIterable<NetworkFunctionDefinitionVersionInner> listByNetworkFunctionDefinitionGroup(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    NetworkFunctionDefinitionVersionUpdateStateInner updateState(
        String resourceGroupName,
        String publisherName,
        String networkFunctionDefinitionGroupName,
        String networkFunctionDefinitionVersionName,
