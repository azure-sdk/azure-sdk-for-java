...
public final class ArtifactManifestsImpl implements ArtifactManifests {
    ...
    public ArtifactManifestsImpl(
        ArtifactManifestsClient innerClient,
        com.azure.resourcemanager.hybridnetwork.HybridNetworkManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public PagedIterable<ArtifactManifest> listByArtifactStore(
    ...
    public Response<ArtifactManifest> getWithResponse(
        String resourceGroupName,
        String publisherName,
        String artifactStoreName,
        String artifactManifestName,
        Context context) {
        Response<ArtifactManifestInner> inner =
            this
                .serviceClient()
    ...
    public Response<ArtifactAccessCredential> listCredentialWithResponse(
        String resourceGroupName,
        String publisherName,
        String artifactStoreName,
        String artifactManifestName,
        Context context) {
        Response<ArtifactAccessCredentialInner> inner =
            this
                .serviceClient()
    ...
    public ArtifactAccessCredential listCredential(
        String resourceGroupName, String publisherName, String artifactStoreName, String artifactManifestName) {
        ArtifactAccessCredentialInner inner =
            this
                .serviceClient()
    ...
    public ArtifactManifestUpdateState updateState(
        String resourceGroupName,
        String publisherName,
        String artifactStoreName,
        String artifactManifestName,
        ArtifactManifestUpdateStateInner parameters) {
        ArtifactManifestUpdateStateInner inner =
            this
                .serviceClient()
        ...
        if (artifactStoreName == null) {
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException(
                        String
                            .format("The resource ID '%s' is not valid. Missing path segment 'artifactStores'.", id)));
        }
            ...
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException(
                        String
                            .format(
                                "The resource ID '%s' is not valid. Missing path segment 'artifactManifests'.", id)));
        }
        return this
