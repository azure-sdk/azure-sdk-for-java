...
public final class SiteNetworkServicesImpl implements SiteNetworkServices {
    ...
    public SiteNetworkServicesImpl(
        SiteNetworkServicesClient innerClient,
    ...
    public Response<SiteNetworkService> getByResourceGroupWithResponse(
            ...
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException(
                        String
                            .format(
                                "The resource ID '%s' is not valid. Missing path segment 'siteNetworkServices'.", id)));
        }
