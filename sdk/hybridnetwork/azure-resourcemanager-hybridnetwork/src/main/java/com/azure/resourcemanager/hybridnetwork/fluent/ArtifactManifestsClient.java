...
public interface ArtifactManifestsClient {
    ...
    PagedIterable<ArtifactManifestInner> listByArtifactStore(
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<ArtifactManifestInner>, ArtifactManifestInner> beginCreateOrUpdate(
        String resourceGroupName,
        String publisherName,
        String artifactStoreName,
        String artifactManifestName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ArtifactManifestInner createOrUpdate(
        String resourceGroupName,
        String publisherName,
        String artifactStoreName,
        String artifactManifestName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<ArtifactManifestInner> getWithResponse(
        String resourceGroupName,
        String publisherName,
        String artifactStoreName,
        String artifactManifestName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<ArtifactManifestInner> updateWithResponse(
        String resourceGroupName,
        String publisherName,
        String artifactStoreName,
        String artifactManifestName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<ArtifactAccessCredentialInner> listCredentialWithResponse(
        String resourceGroupName,
        String publisherName,
        String artifactStoreName,
        String artifactManifestName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ArtifactAccessCredentialInner listCredential(
        String resourceGroupName, String publisherName, String artifactStoreName, String artifactManifestName);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ArtifactManifestUpdateStateInner updateState(
        String resourceGroupName,
        String publisherName,
        String artifactStoreName,
        String artifactManifestName,
