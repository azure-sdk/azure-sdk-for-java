...
public final class ComponentsImpl implements Components {
    ...
    public ComponentsImpl(
        ComponentsClient innerClient, com.azure.resourcemanager.hybridnetwork.HybridNetworkManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public Response<Component> getWithResponse(
    ...
    public PagedIterable<Component> listByNetworkFunction(
