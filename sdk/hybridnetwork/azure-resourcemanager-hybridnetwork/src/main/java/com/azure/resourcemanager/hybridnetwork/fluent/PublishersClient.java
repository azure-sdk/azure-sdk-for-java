...
public interface PublishersClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<PublisherInner> getByResourceGroupWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<PublisherInner>, PublisherInner> beginCreateOrUpdate(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<PublisherInner> updateWithResponse(
