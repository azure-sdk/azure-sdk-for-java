...
public final class ArtifactStoresImpl implements ArtifactStores {
    ...
    public ArtifactStoresImpl(
        ArtifactStoresClient innerClient, com.azure.resourcemanager.hybridnetwork.HybridNetworkManager serviceManager) {
    ...
    public PagedIterable<ArtifactStore> listByPublisher(
    ...
    public Response<ArtifactStore> getWithResponse(
