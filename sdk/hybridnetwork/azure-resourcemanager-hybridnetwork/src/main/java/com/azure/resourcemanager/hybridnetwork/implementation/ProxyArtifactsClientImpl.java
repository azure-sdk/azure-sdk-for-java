...
public final class ProxyArtifactsClientImpl implements ProxyArtifactsClient {
    ...
    public interface ProxyArtifactsService {
        ...
        Mono<Response<ProxyArtifactOverviewListResult>> list(
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ProxyArtifactVersionsOverviewListResult>> get(
            @HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("publisherName") String publisherName,
            @PathParam("artifactStoreName") String artifactStoreName,
        ...
        Mono<Response<Flux<ByteBuffer>>> updateState(
            ...
            @PathParam("artifactStoreName") String artifactStoreName,
            @QueryParam("artifactName") String artifactName,
            @PathParam("artifactVersionName") String artifactVersionName,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @BodyParam("application/json") ArtifactChangeState parameters,
            @HeaderParam("Accept") String accept,
            Context context);
    ...
    private Mono<PagedResponse<ProxyArtifactListOverviewInner>> listSinglePageAsync(
                ...
                context ->
                    service
                        .list(
                            ...
                            accept,
                            context))
            .<PagedResponse<ProxyArtifactListOverviewInner>>map(
                res ->
    ...
    private PagedFlux<ProxyArtifactListOverviewInner> listAsync(
        String resourceGroupName, String publisherName, String artifactStoreName) {
        return new PagedFlux<>(
            () -> listSinglePageAsync(resourceGroupName, publisherName, artifactStoreName),
    ...
    private PagedFlux<ProxyArtifactListOverviewInner> listAsync(
        String resourceGroupName, String publisherName, String artifactStoreName, Context context) {
        return new PagedFlux<>(
            () -> listSinglePageAsync(resourceGroupName, publisherName, artifactStoreName, context),
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<ProxyArtifactListOverviewInner> list(
        String resourceGroupName, String publisherName, String artifactStoreName) {
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a Artifact overview information along with {@link PagedResponse} on successful completion of {@link
     *     Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<ProxyArtifactVersionsListOverviewInner>> getSinglePageAsync(
        String resourceGroupName, String publisherName, String artifactStoreName, String artifactName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
                ...
                context ->
                    service
                        .get(
                            ...
                            accept,
                            context))
            .<PagedResponse<ProxyArtifactVersionsListOverviewInner>>map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(),
                        res.getStatusCode(),
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<ProxyArtifactVersionsListOverviewInner> getAsync(
        String resourceGroupName, String publisherName, String artifactStoreName, String artifactName) {
        return new PagedFlux<>(
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<ProxyArtifactVersionsListOverviewInner> get(
        String resourceGroupName, String publisherName, String artifactStoreName, String artifactName) {
    ...
    private PollerFlux<PollResult<ProxyArtifactVersionsListOverviewInner>, ProxyArtifactVersionsListOverviewInner>
        ...
        Mono<Response<Flux<ByteBuffer>>> mono =
            updateStateWithResponseAsync(
                resourceGroupName, publisherName, artifactStoreName, artifactName, artifactVersionName, parameters);
        return this
            .client
            .<ProxyArtifactVersionsListOverviewInner, ProxyArtifactVersionsListOverviewInner>getLroResult(
                mono,
                this.client.getHttpPipeline(),
                ProxyArtifactVersionsListOverviewInner.class,
                ProxyArtifactVersionsListOverviewInner.class,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ProxyArtifactVersionsListOverviewInner> updateStateAsync(
        String resourceGroupName,
        String publisherName,
        String artifactStoreName,
        String artifactName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ProxyArtifactVersionsListOverviewInner updateState(
        String resourceGroupName,
        String publisherName,
        String artifactStoreName,
        String artifactName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<ProxyArtifactListOverviewInner>> listNextSinglePageAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<ProxyArtifactVersionsListOverviewInner>> getNextSinglePageAsync(
        String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
