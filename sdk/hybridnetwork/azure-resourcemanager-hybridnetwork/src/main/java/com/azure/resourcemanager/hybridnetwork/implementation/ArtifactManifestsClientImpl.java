...
public final class ArtifactManifestsClientImpl implements ArtifactManifestsClient {
    ...
    public interface ArtifactManifestsService {
        ...
        Mono<Response<ArtifactManifestListResult>> listByArtifactStore(
        ...
        Mono<Response<Flux<ByteBuffer>>> createOrUpdate(
            ...
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @BodyParam("application/json") ArtifactManifestInner parameters,
            @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ArtifactManifestInner>> get(
            @HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("publisherName") String publisherName,
            @PathParam("artifactStoreName") String artifactStoreName,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ArtifactManifestInner>> update(
            @HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("publisherName") String publisherName,
            @PathParam("artifactStoreName") String artifactStoreName,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ArtifactAccessCredentialInner>> listCredential(
            @HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("publisherName") String publisherName,
            @PathParam("artifactStoreName") String artifactStoreName,
    ...
    private Mono<PagedResponse<ArtifactManifestInner>> listByArtifactStoreSinglePageAsync(
                ...
                context ->
                    service
                        .listByArtifactStore(
                            ...
                            accept,
                            context))
            .<PagedResponse<ArtifactManifestInner>>map(
                res ->
    ...
    private PagedFlux<ArtifactManifestInner> listByArtifactStoreAsync(
        String resourceGroupName, String publisherName, String artifactStoreName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<ArtifactManifestInner> listByArtifactStore(
        String resourceGroupName, String publisherName, String artifactStoreName) {
    ...
    private PollerFlux<PollResult<Void>, Void> beginDeleteAsync(
        ...
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono =
            deleteWithResponseAsync(resourceGroupName, publisherName, artifactStoreName, artifactManifestName, context);
        return this
            .client
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(
        String resourceGroupName, String publisherName, String artifactStoreName, String artifactManifestName) {
        return this
            .beginDeleteAsync(resourceGroupName, publisherName, artifactStoreName, artifactManifestName)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(
        ...
        Context context) {
        return this
            .beginDeleteAsync(resourceGroupName, publisherName, artifactStoreName, artifactManifestName, context)
            .getSyncPoller();
    }
    ...
    private Mono<Void> deleteAsync(
        String resourceGroupName, String publisherName, String artifactStoreName, String artifactManifestName) {
        return beginDeleteAsync(resourceGroupName, publisherName, artifactStoreName, artifactManifestName)
            .last()
    ...
    private PollerFlux<PollResult<ArtifactManifestInner>, ArtifactManifestInner> beginCreateOrUpdateAsync(
        ...
        Mono<Response<Flux<ByteBuffer>>> mono =
            createOrUpdateWithResponseAsync(
                resourceGroupName, publisherName, artifactStoreName, artifactManifestName, parameters);
        return this
            .client
            .<ArtifactManifestInner, ArtifactManifestInner>getLroResult(
                mono,
                this.client.getHttpPipeline(),
                ArtifactManifestInner.class,
                ArtifactManifestInner.class,
    ...
    private PollerFlux<PollResult<ArtifactManifestInner>, ArtifactManifestInner> beginCreateOrUpdateAsync(
        ...
        Mono<Response<Flux<ByteBuffer>>> mono =
            createOrUpdateWithResponseAsync(
                resourceGroupName, publisherName, artifactStoreName, artifactManifestName, parameters, context);
        return this
            .client
            .<ArtifactManifestInner, ArtifactManifestInner>getLroResult(
                mono, this.client.getHttpPipeline(), ArtifactManifestInner.class, ArtifactManifestInner.class, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ArtifactManifestInner> createOrUpdateAsync(
        String resourceGroupName,
        String publisherName,
        String artifactStoreName,
        String artifactManifestName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ArtifactManifestInner createOrUpdate(
        String resourceGroupName,
        String publisherName,
        String artifactStoreName,
        String artifactManifestName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ArtifactManifestInner>> getWithResponseAsync(
        String resourceGroupName, String publisherName, String artifactStoreName, String artifactManifestName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ArtifactManifestInner> getAsync(
        String resourceGroupName, String publisherName, String artifactStoreName, String artifactManifestName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ArtifactManifestInner> getWithResponse(
        String resourceGroupName,
        String publisherName,
        String artifactStoreName,
        String artifactManifestName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ArtifactManifestInner get(
        String resourceGroupName, String publisherName, String artifactStoreName, String artifactManifestName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ArtifactManifestInner>> updateWithResponseAsync(
        String resourceGroupName,
        String publisherName,
        String artifactStoreName,
        String artifactManifestName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ArtifactManifestInner> updateAsync(
        String resourceGroupName,
        String publisherName,
        String artifactStoreName,
        String artifactManifestName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ArtifactManifestInner> updateWithResponse(
        String resourceGroupName,
        String publisherName,
        String artifactStoreName,
        String artifactManifestName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ArtifactManifestInner update(
        String resourceGroupName,
        String publisherName,
        String artifactStoreName,
        String artifactManifestName,
        ...
        return updateWithResponse(
                resourceGroupName, publisherName, artifactStoreName, artifactManifestName, parameters, Context.NONE)
            .getValue();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ArtifactAccessCredentialInner>> listCredentialWithResponseAsync(
        String resourceGroupName, String publisherName, String artifactStoreName, String artifactManifestName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ArtifactAccessCredentialInner> listCredentialAsync(
        String resourceGroupName, String publisherName, String artifactStoreName, String artifactManifestName) {
        return listCredentialWithResponseAsync(
                resourceGroupName, publisherName, artifactStoreName, artifactManifestName)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ArtifactAccessCredentialInner> listCredentialWithResponse(
        String resourceGroupName,
        String publisherName,
        String artifactStoreName,
        String artifactManifestName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ArtifactAccessCredentialInner listCredential(
        String resourceGroupName, String publisherName, String artifactStoreName, String artifactManifestName) {
        return listCredentialWithResponse(
                resourceGroupName, publisherName, artifactStoreName, artifactManifestName, Context.NONE)
            .getValue();
    }
    ...
    private PollerFlux<PollResult<ArtifactManifestUpdateStateInner>, ArtifactManifestUpdateStateInner>
        ...
        return this
            .client
            .<ArtifactManifestUpdateStateInner, ArtifactManifestUpdateStateInner>getLroResult(
                mono,
                this.client.getHttpPipeline(),
                ArtifactManifestUpdateStateInner.class,
                ArtifactManifestUpdateStateInner.class,
                this.client.getContext());
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ArtifactManifestUpdateStateInner> updateStateAsync(
        String resourceGroupName,
        String publisherName,
        String artifactStoreName,
        String artifactManifestName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ArtifactManifestUpdateStateInner updateState(
        String resourceGroupName,
        String publisherName,
        String artifactStoreName,
        String artifactManifestName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<ArtifactManifestInner>> listByArtifactStoreNextSinglePageAsync(
        ...
        context = this.client.mergeContext(context);
        return service
            .listByArtifactStoreNext(nextLink, this.client.getEndpoint(), accept, context)
            .map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(),
