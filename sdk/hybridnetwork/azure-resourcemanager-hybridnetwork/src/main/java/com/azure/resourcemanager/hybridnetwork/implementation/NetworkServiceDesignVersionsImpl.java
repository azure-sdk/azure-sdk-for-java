...
public final class NetworkServiceDesignVersionsImpl implements NetworkServiceDesignVersions {
    ...
    public NetworkServiceDesignVersionsImpl(
        NetworkServiceDesignVersionsClient innerClient,
    ...
    public Response<NetworkServiceDesignVersion> getWithResponse(
        String resourceGroupName,
        String publisherName,
        String networkServiceDesignGroupName,
        String networkServiceDesignVersionName,
        Context context) {
        Response<NetworkServiceDesignVersionInner> inner =
            this
                .serviceClient()
                .getWithResponse(
                    resourceGroupName,
    ...
    public NetworkServiceDesignVersion get(
        String resourceGroupName,
        String publisherName,
        String networkServiceDesignGroupName,
        String networkServiceDesignVersionName) {
        NetworkServiceDesignVersionInner inner =
            this
                .serviceClient()
    ...
    public PagedIterable<NetworkServiceDesignVersion> listByNetworkServiceDesignGroup(
        String resourceGroupName, String publisherName, String networkServiceDesignGroupName) {
        PagedIterable<NetworkServiceDesignVersionInner> inner =
            this
                .serviceClient()
    ...
    public NetworkServiceDesignVersionUpdateState updateState(
        String resourceGroupName,
        String publisherName,
        String networkServiceDesignGroupName,
        String networkServiceDesignVersionName,
        NetworkServiceDesignVersionUpdateStateInner parameters) {
        NetworkServiceDesignVersionUpdateStateInner inner =
            this
                .serviceClient()
                .updateState(
                    resourceGroupName,
            ...
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException(
                        String
                            .format(
                                "The resource ID '%s' is not valid. Missing path segment 'networkServiceDesignGroups'.",
                                id)));
        }
