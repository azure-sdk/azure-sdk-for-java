...
public final class ProxyArtifactsImpl implements ProxyArtifacts {
    ...
    public ProxyArtifactsImpl(
        ProxyArtifactsClient innerClient, com.azure.resourcemanager.hybridnetwork.HybridNetworkManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public PagedIterable<ProxyArtifactListOverview> list(
    ...
    public PagedIterable<ProxyArtifactVersionsListOverview> get(
    ...
    public ProxyArtifactVersionsListOverview updateState(
        String resourceGroupName,
        String publisherName,
        String artifactStoreName,
        String artifactName,
        ...
        ProxyArtifactVersionsListOverviewInner inner =
            this
                .serviceClient()
                .updateState(
