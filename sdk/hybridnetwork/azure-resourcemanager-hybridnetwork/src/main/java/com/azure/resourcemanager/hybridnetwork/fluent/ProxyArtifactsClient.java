...
public interface ProxyArtifactsClient {
    ...
    PagedIterable<ProxyArtifactListOverviewInner> list(
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<ProxyArtifactVersionsListOverviewInner> get(
    ...
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<ProxyArtifactVersionsListOverviewInner> get(
        String resourceGroupName, String publisherName, String artifactStoreName, String artifactName, Context context);
    ...
    ProxyArtifactVersionsListOverviewInner updateState(
        String resourceGroupName,
        String publisherName,
        String artifactStoreName,
        String artifactName,
