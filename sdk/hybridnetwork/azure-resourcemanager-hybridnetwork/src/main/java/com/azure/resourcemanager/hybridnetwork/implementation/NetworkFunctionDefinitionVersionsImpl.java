...
public final class NetworkFunctionDefinitionVersionsImpl implements NetworkFunctionDefinitionVersions {
    ...
    public NetworkFunctionDefinitionVersionsImpl(
        NetworkFunctionDefinitionVersionsClient innerClient,
    ...
    public Response<NetworkFunctionDefinitionVersion> getWithResponse(
        String resourceGroupName,
        String publisherName,
        String networkFunctionDefinitionGroupName,
        String networkFunctionDefinitionVersionName,
        Context context) {
        Response<NetworkFunctionDefinitionVersionInner> inner =
            this
                .serviceClient()
                .getWithResponse(
                    resourceGroupName,
    ...
    public NetworkFunctionDefinitionVersion get(
        String resourceGroupName,
        String publisherName,
        String networkFunctionDefinitionGroupName,
        String networkFunctionDefinitionVersionName) {
        NetworkFunctionDefinitionVersionInner inner =
            this
                .serviceClient()
                .get(
                    resourceGroupName,
    ...
    public NetworkFunctionDefinitionVersionUpdateState updateState(
        String resourceGroupName,
        String publisherName,
        String networkFunctionDefinitionGroupName,
        String networkFunctionDefinitionVersionName,
