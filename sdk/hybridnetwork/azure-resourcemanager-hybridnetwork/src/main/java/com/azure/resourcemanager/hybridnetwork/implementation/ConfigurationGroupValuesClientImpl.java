...
public final class ConfigurationGroupValuesClientImpl implements ConfigurationGroupValuesClient {
    ...
    ConfigurationGroupValuesClientImpl(HybridNetworkManagementClientImpl client) {
        this.service =
            RestProxy
                .create(ConfigurationGroupValuesService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }
    ...
    public interface ConfigurationGroupValuesService {
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ConfigurationGroupValueInner>> getByResourceGroup(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @QueryParam("api-version") String apiVersion,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ConfigurationGroupValueInner>> updateTags(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @QueryParam("api-version") String apiVersion,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ConfigurationGroupValueListResult>> list(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ConfigurationGroupValueListResult>> listByResourceGroup(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @QueryParam("api-version") String apiVersion,
    ...
    private Mono<Response<Flux<ByteBuffer>>> deleteWithResponseAsync(
        ...
        if (configurationGroupValueName == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
                        "Parameter configurationGroupValueName is required and cannot be null."));
        }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> deleteWithResponseAsync(
        String resourceGroupName, String configurationGroupValueName, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String configurationGroupValueName) {
        return beginDeleteAsync(resourceGroupName, configurationGroupValueName)
            .last()
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String configurationGroupValueName, Context context) {
        return beginDeleteAsync(resourceGroupName, configurationGroupValueName, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ConfigurationGroupValueInner>> getByResourceGroupWithResponseAsync(
        String resourceGroupName, String configurationGroupValueName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return information about the specified hybrid configuration group values on successful completion of {@link
     *     Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ConfigurationGroupValueInner> getByResourceGroupAsync(
        String resourceGroupName, String configurationGroupValueName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ConfigurationGroupValueInner> getByResourceGroupWithResponse(
        String resourceGroupName, String configurationGroupValueName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ConfigurationGroupValueInner getByResourceGroup(
        String resourceGroupName, String configurationGroupValueName) {
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return hybrid configuration group value resource along with {@link Response} on successful completion of {@link
     *     Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ...
    private PollerFlux<PollResult<ConfigurationGroupValueInner>, ConfigurationGroupValueInner> beginCreateOrUpdateAsync(
        ...
        return this
            .client
            .<ConfigurationGroupValueInner, ConfigurationGroupValueInner>getLroResult(
                mono,
                this.client.getHttpPipeline(),
                ConfigurationGroupValueInner.class,
                ConfigurationGroupValueInner.class,
    ...
    public SyncPoller<PollResult<ConfigurationGroupValueInner>, ConfigurationGroupValueInner> beginCreateOrUpdate(
        String resourceGroupName, String configurationGroupValueName, ConfigurationGroupValueInner parameters) {
        return this
            .beginCreateOrUpdateAsync(resourceGroupName, configurationGroupValueName, parameters)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<ConfigurationGroupValueInner>, ConfigurationGroupValueInner> beginCreateOrUpdate(
        ...
        Context context) {
        return this
            .beginCreateOrUpdateAsync(resourceGroupName, configurationGroupValueName, parameters, context)
            .getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ConfigurationGroupValueInner> createOrUpdateAsync(
        String resourceGroupName, String configurationGroupValueName, ConfigurationGroupValueInner parameters) {
        return beginCreateOrUpdateAsync(resourceGroupName, configurationGroupValueName, parameters)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<ConfigurationGroupValueInner> createOrUpdateAsync(
        ...
        ConfigurationGroupValueInner parameters,
        Context context) {
        return beginCreateOrUpdateAsync(resourceGroupName, configurationGroupValueName, parameters, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ConfigurationGroupValueInner createOrUpdate(
        String resourceGroupName, String configurationGroupValueName, ConfigurationGroupValueInner parameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ConfigurationGroupValueInner>> updateTagsWithResponseAsync(
        String resourceGroupName, String configurationGroupValueName, TagsObject parameters) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ConfigurationGroupValueInner>> updateTagsWithResponseAsync(
        String resourceGroupName, String configurationGroupValueName, TagsObject parameters, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ConfigurationGroupValueInner> updateTagsAsync(
        String resourceGroupName, String configurationGroupValueName, TagsObject parameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ConfigurationGroupValueInner> updateTagsWithResponse(
        String resourceGroupName, String configurationGroupValueName, TagsObject parameters, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ConfigurationGroupValueInner updateTags(
        String resourceGroupName, String configurationGroupValueName, TagsObject parameters) {
                ...
                context ->
                    service
                        .list(
                            ...
                            accept,
                            context))
            .<PagedResponse<ConfigurationGroupValueInner>>map(
                res ->
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return response for hybrid configurationGroups API service call as paginated response with {@link
     *     PagedIterable}.
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<ConfigurationGroupValueInner>> listByResourceGroupSinglePageAsync(
        String resourceGroupName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<ConfigurationGroupValueInner> listByResourceGroupAsync(
        String resourceGroupName, Context context) {
        return new PagedFlux<>(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<ConfigurationGroupValueInner>> listBySubscriptionNextSinglePageAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<ConfigurationGroupValueInner>> listByResourceGroupNextSinglePageAsync(
        String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
