...
public interface ArtifactManifests {
     ...
     */
    PagedIterable<ArtifactManifest> listByArtifactStore(
     ...
     */
    Response<ArtifactManifest> getWithResponse(
        String resourceGroupName,
        String publisherName,
        String artifactStoreName,
        String artifactManifestName,
     ...
     */
    Response<ArtifactAccessCredential> listCredentialWithResponse(
        String resourceGroupName,
        String publisherName,
        String artifactStoreName,
        String artifactManifestName,
