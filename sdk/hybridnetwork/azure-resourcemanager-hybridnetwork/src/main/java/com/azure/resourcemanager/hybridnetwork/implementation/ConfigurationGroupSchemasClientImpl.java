...
public final class ConfigurationGroupSchemasClientImpl implements ConfigurationGroupSchemasClient {
    ...
    ConfigurationGroupSchemasClientImpl(HybridNetworkManagementClientImpl client) {
        this.service =
            RestProxy
                .create(
                    ConfigurationGroupSchemasService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }
    ...
    public interface ConfigurationGroupSchemasService {
        ...
        Mono<Response<ConfigurationGroupSchemaListResult>> listByPublisher(
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ConfigurationGroupSchemaInner>> get(
            @HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("publisherName") String publisherName,
            @PathParam("configurationGroupSchemaName") String configurationGroupSchemaName,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ConfigurationGroupSchemaInner>> update(
            @HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("publisherName") String publisherName,
            @PathParam("configurationGroupSchemaName") String configurationGroupSchemaName,
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Flux<ByteBuffer>>> updateState(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("publisherName") String publisherName,
    ...
    private Mono<PagedResponse<ConfigurationGroupSchemaInner>> listByPublisherSinglePageAsync(
        String resourceGroupName, String publisherName) {
                ...
                context ->
                    service
                        .listByPublisher(
                            ...
                            accept,
                            context))
            .<PagedResponse<ConfigurationGroupSchemaInner>>map(
                res ->
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<ConfigurationGroupSchemaInner>> listByPublisherSinglePageAsync(
        String resourceGroupName, String publisherName, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return information of the configuration group schemas under a publisher as paginated response with {@link
     *     PagedFlux}.
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<ConfigurationGroupSchemaInner> listByPublisherAsync(
        String resourceGroupName, String publisherName) {
        return new PagedFlux<>(
            () -> listByPublisherSinglePageAsync(resourceGroupName, publisherName),
    ...
    private PagedFlux<ConfigurationGroupSchemaInner> listByPublisherAsync(
        String resourceGroupName, String publisherName, Context context) {
        return new PagedFlux<>(
            () -> listByPublisherSinglePageAsync(resourceGroupName, publisherName, context),
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<ConfigurationGroupSchemaInner> listByPublisher(
        String resourceGroupName, String publisherName) {
    ...
    private Mono<Response<Flux<ByteBuffer>>> deleteWithResponseAsync(
        ...
        if (configurationGroupSchemaName == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
                        "Parameter configurationGroupSchemaName is required and cannot be null."));
        }
        if (this.client.getSubscriptionId() == null) {
            return Mono
                .error(
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> deleteWithResponseAsync(
        String resourceGroupName, String publisherName, String configurationGroupSchemaName, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(
        String resourceGroupName, String publisherName, String configurationGroupSchemaName, Context context) {
        return this
            .beginDeleteAsync(resourceGroupName, publisherName, configurationGroupSchemaName, context)
            .getSyncPoller();
    }
    ...
    private Mono<Void> deleteAsync(
        String resourceGroupName, String publisherName, String configurationGroupSchemaName) {
        return beginDeleteAsync(resourceGroupName, publisherName, configurationGroupSchemaName)
            .last()
    ...
    private Mono<Void> deleteAsync(
        String resourceGroupName, String publisherName, String configurationGroupSchemaName, Context context) {
        return beginDeleteAsync(resourceGroupName, publisherName, configurationGroupSchemaName, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private PollerFlux<PollResult<ConfigurationGroupSchemaInner>, ConfigurationGroupSchemaInner>
        beginCreateOrUpdateAsync(
            ...
            ConfigurationGroupSchemaInner parameters) {
        Mono<Response<Flux<ByteBuffer>>> mono =
            createOrUpdateWithResponseAsync(resourceGroupName, publisherName, configurationGroupSchemaName, parameters);
        return this
            .client
            .<ConfigurationGroupSchemaInner, ConfigurationGroupSchemaInner>getLroResult(
                mono,
                this.client.getHttpPipeline(),
                ConfigurationGroupSchemaInner.class,
                ConfigurationGroupSchemaInner.class,
    ...
    private PollerFlux<PollResult<ConfigurationGroupSchemaInner>, ConfigurationGroupSchemaInner>
        ...
        Mono<Response<Flux<ByteBuffer>>> mono =
            createOrUpdateWithResponseAsync(
                resourceGroupName, publisherName, configurationGroupSchemaName, parameters, context);
        return this
            .client
            .<ConfigurationGroupSchemaInner, ConfigurationGroupSchemaInner>getLroResult(
                mono,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ConfigurationGroupSchemaInner> createOrUpdateAsync(
        String resourceGroupName,
        String publisherName,
        String configurationGroupSchemaName,
        ConfigurationGroupSchemaInner parameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ConfigurationGroupSchemaInner createOrUpdate(
        String resourceGroupName,
        String publisherName,
        String configurationGroupSchemaName,
        ConfigurationGroupSchemaInner parameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ConfigurationGroupSchemaInner>> getWithResponseAsync(
        String resourceGroupName, String publisherName, String configurationGroupSchemaName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ConfigurationGroupSchemaInner> getAsync(
        String resourceGroupName, String publisherName, String configurationGroupSchemaName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ConfigurationGroupSchemaInner> getWithResponse(
        String resourceGroupName, String publisherName, String configurationGroupSchemaName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ConfigurationGroupSchemaInner get(
        String resourceGroupName, String publisherName, String configurationGroupSchemaName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ConfigurationGroupSchemaInner>> updateWithResponseAsync(
        String resourceGroupName, String publisherName, String configurationGroupSchemaName, TagsObject parameters) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ConfigurationGroupSchemaInner> updateAsync(
        String resourceGroupName, String publisherName, String configurationGroupSchemaName, TagsObject parameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ConfigurationGroupSchemaInner> updateWithResponse(
        String resourceGroupName,
        String publisherName,
        String configurationGroupSchemaName,
        TagsObject parameters,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ConfigurationGroupSchemaInner update(
        String resourceGroupName, String publisherName, String configurationGroupSchemaName, TagsObject parameters) {
        return updateWithResponse(
                resourceGroupName, publisherName, configurationGroupSchemaName, parameters, Context.NONE)
            .getValue();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> updateStateWithResponseAsync(
        String resourceGroupName,
        String publisherName,
        String configurationGroupSchemaName,
    ...
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<
            PollResult<ConfigurationGroupSchemaVersionUpdateStateInner>,
            ConfigurationGroupSchemaVersionUpdateStateInner>
        beginUpdateStateAsync(
            String resourceGroupName,
            String publisherName,
            String configurationGroupSchemaName,
            ConfigurationGroupSchemaVersionUpdateStateInner parameters) {
        ...
        return this
            .client
            .<ConfigurationGroupSchemaVersionUpdateStateInner, ConfigurationGroupSchemaVersionUpdateStateInner>
                getLroResult(
                    mono,
                    this.client.getHttpPipeline(),
                    ConfigurationGroupSchemaVersionUpdateStateInner.class,
                    ConfigurationGroupSchemaVersionUpdateStateInner.class,
                    this.client.getContext());
    }
    ...
    public SyncPoller<
        ...
        beginUpdateState(
            ...
            ConfigurationGroupSchemaVersionUpdateStateInner parameters) {
        return this
            .beginUpdateStateAsync(resourceGroupName, publisherName, configurationGroupSchemaName, parameters)
            .getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ConfigurationGroupSchemaVersionUpdateStateInner> updateStateAsync(
        String resourceGroupName,
        String publisherName,
        String configurationGroupSchemaName,
        ConfigurationGroupSchemaVersionUpdateStateInner parameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ConfigurationGroupSchemaVersionUpdateStateInner updateState(
        String resourceGroupName,
        String publisherName,
        String configurationGroupSchemaName,
        ConfigurationGroupSchemaVersionUpdateStateInner parameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<ConfigurationGroupSchemaInner>> listByPublisherNextSinglePageAsync(
