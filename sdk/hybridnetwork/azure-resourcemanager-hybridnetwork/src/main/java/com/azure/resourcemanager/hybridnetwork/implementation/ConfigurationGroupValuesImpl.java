...
public final class ConfigurationGroupValuesImpl implements ConfigurationGroupValues {
    ...
    public ConfigurationGroupValuesImpl(
        ConfigurationGroupValuesClient innerClient,
    ...
    public Response<ConfigurationGroupValue> getByResourceGroupWithResponse(
        String resourceGroupName, String configurationGroupValueName, Context context) {
        Response<ConfigurationGroupValueInner> inner =
            this
                .serviceClient()
            ...
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException(
                        String
                            .format(
                                "The resource ID '%s' is not valid. Missing path segment 'configurationGroupValues'.",
                                id)));
        }
        return this
