...
public interface ArtifactStoresClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<ArtifactStoreInner>, ArtifactStoreInner> beginCreateOrUpdate(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ArtifactStoreInner createOrUpdate(
        String resourceGroupName, String publisherName, String artifactStoreName, ArtifactStoreInner parameters);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<ArtifactStoreInner> getWithResponse(
        String resourceGroupName, String publisherName, String artifactStoreName, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<ArtifactStoreInner> updateWithResponse(
        String resourceGroupName,
        String publisherName,
        String artifactStoreName,
