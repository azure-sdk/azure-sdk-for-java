...
public final class ManagedServiceIdentityTests {
    ...
    public void testDeserialize() throws Exception {
        ManagedServiceIdentity model = BinaryData.fromString(
            "{\"principalId\":\"dd\",\"tenantId\":\"cbcuejrjxgciqi\",\"type\":\"None\",\"userAssignedIdentities\":{\"ofyyvoqacpi\":{\"principalId\":\"xsdqrhzoymibmrqy\",\"clientId\":\"ahwfluszdtmhrk\"}}}")
    ...
    public void testSerialize() throws Exception {
        ManagedServiceIdentity model = new ManagedServiceIdentity().withType(ManagedServiceIdentityType.NONE)
            .withUserAssignedIdentities(mapOf("ofyyvoqacpi", new UserAssignedIdentity()));
