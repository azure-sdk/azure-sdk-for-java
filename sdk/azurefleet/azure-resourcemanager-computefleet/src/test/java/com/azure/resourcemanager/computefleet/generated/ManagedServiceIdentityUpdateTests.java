...
public final class ManagedServiceIdentityUpdateTests {
    ...
    public void testDeserialize() throws Exception {
        ManagedServiceIdentityUpdate model = BinaryData.fromString(
            "{\"type\":\"SystemAssigned,UserAssigned\",\"userAssignedIdentities\":{\"yzrpzbchckqqzq\":{\"principalId\":\"lqiyntorzihl\",\"clientId\":\"sjswsrms\"},\"mibzyhwitsmypyyn\":{\"principalId\":\"xiy\",\"clientId\":\"iizynkedyatrwyh\"},\"dtlwwrlkd\":{\"principalId\":\"dpumnzgmw\",\"clientId\":\"mabiknsorgjhxb\"}}}")
    ...
    public void testSerialize() throws Exception {
        ManagedServiceIdentityUpdate model
            = new ManagedServiceIdentityUpdate().withType(ManagedServiceIdentityType.SYSTEM_ASSIGNED_USER_ASSIGNED)
                .withUserAssignedIdentities(mapOf("yzrpzbchckqqzq", new UserAssignedIdentity(), "mibzyhwitsmypyyn",
                    new UserAssignedIdentity(), "dtlwwrlkd", new UserAssignedIdentity()));
