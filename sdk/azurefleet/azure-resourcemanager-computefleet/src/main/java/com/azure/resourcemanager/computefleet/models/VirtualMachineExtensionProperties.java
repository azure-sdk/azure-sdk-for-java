...
public final class VirtualMachineExtensionProperties implements JsonSerializable<VirtualMachineExtensionProperties> {
     ...
     * @return the VirtualMachineExtensionProperties object itself.
     */
    public VirtualMachineExtensionProperties withSettings(Map<String, Object> settings) {
     ...
     * @return the VirtualMachineExtensionProperties object itself.
     */
    public VirtualMachineExtensionProperties withProtectedSettings(Map<String, Object> protectedSettings) {
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("forceUpdateTag".equals(fieldName)) {
                    ...
                    deserializedVirtualMachineExtensionProperties.settings = settings;
                } else if ("protectedSettings".equals(fieldName)) {
                    Map<String, Object> protectedSettings = reader.readMap(reader1 -> reader1.readUntyped());
                    deserializedVirtualMachineExtensionProperties.protectedSettings = protectedSettings;
