...
public final class SecurityPostureReference implements JsonSerializable<SecurityPostureReference> {
     ...
     */
    private List<VirtualMachineExtension> excludeExtensions;
     ...
     */
    public List<VirtualMachineExtension> excludeExtensions() {
     ...
     * @return the SecurityPostureReference object itself.
     */
    public SecurityPostureReference withExcludeExtensions(List<VirtualMachineExtension> excludeExtensions) {
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("id".equals(fieldName)) {
                    ...
                    List<VirtualMachineExtension> excludeExtensions
