...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    private final MicrosoftAzureFleetTestingImpl client;
     ...
     */
    OperationsClientImpl(MicrosoftAzureFleetTestingImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for MicrosoftAzureFleetTestingOperations to be used by the proxy service
     * to perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "MicrosoftAzureFleetT")
