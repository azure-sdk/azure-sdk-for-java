...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    private final MicrosoftAzureFleetTestImpl client;
     ...
     */
    OperationsClientImpl(MicrosoftAzureFleetTestImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for MicrosoftAzureFleetTestOperations to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{$host}")
