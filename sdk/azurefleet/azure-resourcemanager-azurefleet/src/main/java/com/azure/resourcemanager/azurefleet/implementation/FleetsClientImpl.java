...
public final class FleetsClientImpl implements FleetsClient {
     ...
     */
    private final MicrosoftAzureFleetForTestingImpl client;
     ...
     */
    FleetsClientImpl(MicrosoftAzureFleetForTestingImpl client) {
        this.service = RestProxy.create(FleetsService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for MicrosoftAzureFleetForTestingFleets to be used by the proxy service
