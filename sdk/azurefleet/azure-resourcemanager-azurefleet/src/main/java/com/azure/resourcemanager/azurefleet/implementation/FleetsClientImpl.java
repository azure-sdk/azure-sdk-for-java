...
public final class FleetsClientImpl implements FleetsClient {
     ...
     */
    FleetsClientImpl(MicrosoftAzureFleetTestImpl client) {
        this.service = RestProxy.create(FleetsService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for MicrosoftAzureFleetTestFleets to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{$host}")
