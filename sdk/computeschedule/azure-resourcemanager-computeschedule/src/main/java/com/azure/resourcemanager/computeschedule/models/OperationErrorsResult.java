...
/**
 * This is the first level of operation errors from the request to get errors per vm operation.
 */
@Fluent
public final class OperationErrorsResult implements JsonSerializable<OperationErrorsResult> {
        ...
        if (operationId() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property operationId in model OperationErrorsResult"));
        }
        if (creationTime() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property creationTime in model OperationErrorsResult"));
        }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(OperationErrorsResult.class);
