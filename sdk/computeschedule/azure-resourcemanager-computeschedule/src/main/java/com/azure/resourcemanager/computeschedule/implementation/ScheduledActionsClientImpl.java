...
public final class ScheduledActionsClientImpl implements ScheduledActionsClient {
     ...
     */
    private final MicrosoftComputeScheduleTestImpl client;
     ...
     */
    ScheduledActionsClientImpl(MicrosoftComputeScheduleTestImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for MicrosoftComputeScheduleTestScheduledActions to be used by the proxy
