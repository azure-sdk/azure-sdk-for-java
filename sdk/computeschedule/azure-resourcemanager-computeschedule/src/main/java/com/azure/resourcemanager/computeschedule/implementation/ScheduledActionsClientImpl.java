...
public final class ScheduledActionsClientImpl implements ScheduledActionsClient {
     ...
     */
    private final MicrosoftComputeScheduleManagementServiceImpl client;
     ...
     */
    ScheduledActionsClientImpl(MicrosoftComputeScheduleManagementServiceImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for MicrosoftComputeScheduleManagementServiceScheduledActions to be used
