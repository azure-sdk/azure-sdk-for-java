...
public final class ScheduledActionsClientImpl implements ScheduledActionsClient {
     ...
     */
    private final MicrosoftComputeScheduleForTestingImpl client;
     ...
     */
    ScheduledActionsClientImpl(MicrosoftComputeScheduleForTestingImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for MicrosoftComputeScheduleForTestingScheduledActions to be used by the
