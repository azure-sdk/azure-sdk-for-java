...
public final class ResourceOperation implements JsonSerializable<ResourceOperation> {
    ...
    public void validate() {
        if (resourceId() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Missing required property resourceId in model ResourceOperation"));
        }
        if (operation() != null) {
            operation().validate();
        }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(ResourceOperation.class);
