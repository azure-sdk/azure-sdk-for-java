...
public final class ResourceOperationDetails implements JsonSerializable<ResourceOperationDetails> {
    ...
    /*
     * Number of minutes to retry retriable errors
     */
    private Float retryWindowInMinutes;
    ...
    /**
     * Get the retryWindowInMinutes property: Number of minutes to retry retriable errors.
     * 
     * @return the retryWindowInMinutes value.
     */
    public Float retryWindowInMinutes() {
        return this.retryWindowInMinutes;
    }

    /**
     * Set the retryWindowInMinutes property: Number of minutes to retry retriable errors.
     * 
     * @param retryWindowInMinutes the retryWindowInMinutes value to set.
     * @return the ResourceOperationDetails object itself.
     */
    public ResourceOperationDetails withRetryWindowInMinutes(Float retryWindowInMinutes) {
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("operationId".equals(fieldName)) {
                    ...
                    deserializedResourceOperationDetails.retryWindowInMinutes
