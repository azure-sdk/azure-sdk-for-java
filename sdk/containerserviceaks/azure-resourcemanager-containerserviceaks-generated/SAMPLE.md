...
- [Get](#namespaces_get)
- [ListByManagedCluster](#namespaces_listbymanagedcluster)
- [ListCredential](#namespaces_listcredential)
...
public final class NamespacesCreateOrUpdateSamples {
     ...
     * x-ms-original-file:
     * specification/containerservice/resource-manager/Microsoft.ContainerService/aks/preview/2025-03-02-preview/
     * examples/NamespacesCreate_Update.json
     */
    /**
     * Sample code: Create/Update Namespace.
     * 
     * @param manager Entry point to ContainerServiceManager.
     */
    public static void
        createUpdateNamespace(com.azure.resourcemanager.containerserviceaks.generated.ContainerServiceManager manager) {
        manager.namespaces()
            .define("namespace1")
            .withExistingManagedCluster("rg1", "clustername1")
...
### Namespaces_ListByManagedCluster
...
public final class NamespacesUpdateSamples {
     ...
     * x-ms-original-file:
     * specification/containerservice/resource-manager/Microsoft.ContainerService/aks/preview/2025-03-02-preview/
     * examples/NamespacesUpdateTags.json
     */
    /**
     * Sample code: Update Namespace Tags.
     * 
     * @param manager Entry point to ContainerServiceManager.
     */
    public static void
        updateNamespaceTags(com.azure.resourcemanager.containerserviceaks.generated.ContainerServiceManager manager) {
...
```java
/**
 * Samples for Namespaces ListByManagedCluster.
 */
public final class NamespacesListByManagedClusterSamples {
    /*
     * x-ms-original-file:
     * specification/containerservice/resource-manager/Microsoft.ContainerService/aks/preview/2025-03-02-preview/
     * examples/NamespacesList.json
     */
    /**
    ...
    public static void listNamespacesByManagedCluster(
        com.azure.resourcemanager.containerserviceaks.generated.ContainerServiceManager manager) {
        manager.namespaces().listByManagedCluster("rg1", "clustername1", com.azure.core.util.Context.NONE);
    }
}
```
