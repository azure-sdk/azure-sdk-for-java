...
public final class ScaleProfile implements JsonSerializable<ScaleProfile> {
     ...
     * @return the ScaleProfile object itself.
     */
    public ScaleProfile withAutoscale(Object autoscale) {
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeUntypedField("autoscale", this.autoscale);
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("manual".equals(fieldName)) {
                    ...
                    deserializedScaleProfile.autoscale = reader.readUntyped();
                } else {
                    reader.skipChildren();
                }
            }
