...
public interface AgentPools {
     ...
     */
    Response<AgentPool> getWithResponse(String resourceGroupName, String resourceName, String agentPoolName,
        Context context);
     ...
     */
    Response<AgentPoolUpgradeProfile> getUpgradeProfileWithResponse(String resourceGroupName, String resourceName,
     ...
     */
    Response<AgentPoolAvailableVersions> getAvailableAgentPoolVersionsWithResponse(String resourceGroupName,
     ...
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     */
    void deleteByIdWithResponse(String id, Boolean ignorePodDisruptionBudget, String ifMatch, Context context);
