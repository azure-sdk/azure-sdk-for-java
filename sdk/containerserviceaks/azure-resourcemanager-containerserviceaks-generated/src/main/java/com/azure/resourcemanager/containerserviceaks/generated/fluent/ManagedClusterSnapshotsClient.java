...
public interface ManagedClusterSnapshotsClient {
    ...
    Response<ManagedClusterSnapshotInner> getByResourceGroupWithResponse(String resourceGroupName, String resourceName,
        Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<ManagedClusterSnapshotInner> createOrUpdateWithResponse(String resourceGroupName, String resourceName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<ManagedClusterSnapshotInner> updateTagsWithResponse(String resourceGroupName, String resourceName,
