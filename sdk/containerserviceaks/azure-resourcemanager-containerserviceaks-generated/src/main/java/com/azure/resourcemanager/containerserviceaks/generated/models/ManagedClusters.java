...
public interface ManagedClusters {
     ...
     */
    Response<KubernetesVersionListResult> listKubernetesVersionsWithResponse(String location, Context context);
     ...
     */
    KubernetesVersionListResult listKubernetesVersions(String location);
     ...
     */
    Response<ManagedClusterUpgradeProfile> getUpgradeProfileWithResponse(String resourceGroupName, String resourceName,
        Context context);
     ...
     */
    Response<ManagedClusterAccessProfile> getAccessProfileWithResponse(String resourceGroupName, String resourceName,
     ...
     */
    Response<CredentialResults> listClusterAdminCredentialsWithResponse(String resourceGroupName, String resourceName,
        String serverFqdn, Context context);
     ...
     * @return the list credential result response along with {@link Response}.
     */
    Response<CredentialResults> listClusterUserCredentialsWithResponse(String resourceGroupName, String resourceName,
     ...
     * @return the list credential result response along with {@link Response}.
     */
    Response<CredentialResults> listClusterMonitoringUserCredentialsWithResponse(String resourceGroupName,
     ...
     */
    Response<ManagedCluster> getByResourceGroupWithResponse(String resourceGroupName, String resourceName,
        Context context);
     ...
     */
    Response<RunCommandResult> getCommandResultWithResponse(String resourceGroupName, String resourceName,
     ...
     */
    Response<GuardrailsAvailableVersion> getGuardrailsVersionsWithResponse(String location, String version,
        Context context);
     ...
     */
    GuardrailsAvailableVersion getGuardrailsVersions(String location, String version);
     ...
     * {@link PagedIterable}.
     */
    PagedIterable<GuardrailsAvailableVersion> listGuardrailsVersions(String location);
     ...
     * {@link PagedIterable}.
     */
    PagedIterable<GuardrailsAvailableVersion> listGuardrailsVersions(String location, Context context);
     ...
     */
    Response<SafeguardsAvailableVersion> getSafeguardsVersionsWithResponse(String location, String version,
        Context context);
     ...
     */
    SafeguardsAvailableVersion getSafeguardsVersions(String location, String version);
     ...
     * {@link PagedIterable}.
     */
    PagedIterable<SafeguardsAvailableVersion> listSafeguardsVersions(String location);
     ...
     * {@link PagedIterable}.
     */
    PagedIterable<SafeguardsAvailableVersion> listSafeguardsVersions(String location, Context context);
     ...
     */
    PagedIterable<MeshRevisionProfile> listMeshRevisionProfiles(String location);
     ...
     * @return holds an array of MeshRevisionsProfiles as paginated response with {@link PagedIterable}.
     */
    PagedIterable<MeshRevisionProfile> listMeshRevisionProfiles(String location, Context context);
     ...
     */
    Response<MeshRevisionProfile> getMeshRevisionProfileWithResponse(String location, String mode, Context context);
     ...
     */
    MeshRevisionProfile getMeshRevisionProfile(String location, String mode);
     ...
     */
    PagedIterable<MeshUpgradeProfile> listMeshUpgradeProfiles(String resourceGroupName, String resourceName);
     ...
     */
    Response<MeshUpgradeProfile> getMeshUpgradeProfileWithResponse(String resourceGroupName, String resourceName,
     ...
     */
    MeshUpgradeProfile getMeshUpgradeProfile(String resourceGroupName, String resourceName, String mode);
     ...
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     */
    void deleteByIdWithResponse(String id, String ifMatch, Boolean ignorePodDisruptionBudget, Context context);
