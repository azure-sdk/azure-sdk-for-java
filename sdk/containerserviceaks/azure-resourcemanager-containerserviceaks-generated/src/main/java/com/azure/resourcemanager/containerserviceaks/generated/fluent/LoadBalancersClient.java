...
public interface LoadBalancersClient {
    ...
    PagedIterable<LoadBalancerInner> listByManagedCluster(String resourceGroupName, String resourceName);
    ...
    Response<LoadBalancerInner> getWithResponse(String resourceGroupName, String resourceName, String loadBalancerName,
        Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<LoadBalancerInner> createOrUpdateWithResponse(String resourceGroupName, String resourceName,
