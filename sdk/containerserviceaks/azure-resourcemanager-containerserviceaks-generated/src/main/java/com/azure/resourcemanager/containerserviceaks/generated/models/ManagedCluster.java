...
public interface ManagedCluster {
    ...
    /**
     * Gets the enableNamespaceResources property: The default value is false. It can be enabled/disabled on creation
     * and updating of the managed cluster. See
    ...
    /**
     * Gets the publicNetworkAccess property: Allow or deny public network access for AKS.
     * 
    ...
    /**
     * Gets the schedulerProfile property: Profile of the pod scheduler configuration.
     * 
    ...
    /**
     * Gets the inner com.azure.resourcemanager.containerserviceaks.generated.fluent.models.ManagedClusterInner object.
     * 
    ...
    interface DefinitionStages {
        ...
        interface WithCreate
            ...
            DefinitionStages.WithIdentity, DefinitionStages.WithKind, DefinitionStages.WithCreationData,
            ...
            DefinitionStages.WithSupportPlan, DefinitionStages.WithEnableNamespaceResources,
            ...
            DefinitionStages.WithBootstrapProfile, DefinitionStages.WithSchedulerProfile, DefinitionStages.WithStatus,
        ...
        interface WithKubernetesVersion {
             ...
             * allowed. See [upgrading an AKS cluster](https://docs.microsoft.com/azure/aks/upgrade-cluster) for more
             * details.
             * @return the next definition stage.
             */
        ...
        interface WithEnableNamespaceResources {
            /**
             * Specifies the enableNamespaceResources property: The default value is false. It can be enabled/disabled
             * on creation and updating of the managed cluster. See
             * [https://aka.ms/NamespaceARMResource](https://aka.ms/NamespaceARMResource) for more details on Namespace
             * as a ARM Resource..
             * 
             * @param enableNamespaceResources The default value is false. It can be enabled/disabled on creation and
             * updating of the managed cluster. See
             * [https://aka.ms/NamespaceARMResource](https://aka.ms/NamespaceARMResource) for more details on Namespace
             * as a ARM Resource.
             * @return the next definition stage.
             */
        ...
        interface WithPublicNetworkAccess {
            /**
             * Specifies the publicNetworkAccess property: Allow or deny public network access for AKS.
             * 
             * @param publicNetworkAccess Allow or deny public network access for AKS.
             * @return the next definition stage.
             */
        ...
        /**
         * The stage of the ManagedCluster definition allowing to specify schedulerProfile.
         */
        interface WithSchedulerProfile {
            /**
             * Specifies the schedulerProfile property: Profile of the pod scheduler configuration..
             * 
             * @param schedulerProfile Profile of the pod scheduler configuration.
             * @return the next definition stage.
             */
            WithCreate withSchedulerProfile(SchedulerProfile schedulerProfile);
        }
     ...
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     */
    void rebalanceLoadBalancers(RebalanceLoadBalancersRequestBody parameters);
     ...
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     */
    void rebalanceLoadBalancers(RebalanceLoadBalancersRequestBody parameters, Context context);
}
