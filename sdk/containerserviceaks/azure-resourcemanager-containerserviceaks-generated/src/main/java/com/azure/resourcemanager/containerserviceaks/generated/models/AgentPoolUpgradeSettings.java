...
public final class AgentPoolUpgradeSettings implements JsonSerializable<AgentPoolUpgradeSettings> {
     ...
     * This can either be set to an integer (e.g. '5') or a percentage (e.g. '50%'). If a percentage is specified, it is
     * the percentage of the total agent pool size at the time of the upgrade. For percentages, fractional nodes are
     * rounded up. If not specified, the default is maxSurge. This must always be greater than or equal to maxSurge. For
    ...
    /**
     * Get the maxBlockedNodes property: This can either be set to an integer (e.g. '5') or a percentage (e.g. '50%').
     * If a percentage is specified, it is the percentage of the total agent pool size at the time of the upgrade. For
     * percentages, fractional nodes are rounded up. If not specified, the default is maxSurge. This must always be
     * greater than or equal to maxSurge. For more information, including best practices, see:
     * https://learn.microsoft.com/en-us/azure/aks/upgrade-cluster.
     * 
    ...
    /**
     * Set the maxBlockedNodes property: This can either be set to an integer (e.g. '5') or a percentage (e.g. '50%').
     * If a percentage is specified, it is the percentage of the total agent pool size at the time of the upgrade. For
     * percentages, fractional nodes are rounded up. If not specified, the default is maxSurge. This must always be
     * greater than or equal to maxSurge. For more information, including best practices, see:
     * https://learn.microsoft.com/en-us/azure/aks/upgrade-cluster.
