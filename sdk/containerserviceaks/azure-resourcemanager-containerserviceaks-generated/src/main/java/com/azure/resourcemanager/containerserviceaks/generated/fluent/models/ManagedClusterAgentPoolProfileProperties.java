...
import com.azure.resourcemanager.containerserviceaks.generated.models.AgentPoolArtifactStreamingProfile;
import com.azure.resourcemanager.containerserviceaks.generated.models.AgentPoolGatewayProfile;
...
import com.azure.resourcemanager.containerserviceaks.generated.models.AgentPoolStatus;
...
import com.azure.resourcemanager.containerserviceaks.generated.models.LocalDnsProfile;
...
import com.azure.resourcemanager.containerserviceaks.generated.models.PodIpAllocationMode;
...
import com.azure.resourcemanager.containerserviceaks.generated.models.VirtualMachineNodes;
...
public class ManagedClusterAgentPoolProfileProperties
    ...
    /*
     * Both patch version <major.minor.patch> and <major.minor> are supported. When <major.minor> is specified, the
     * latest supported patch version is chosen automatically. Updating the agent pool with the same <major.minor> once
    ...
    /*
     * If orchestratorVersion was a fully specified version <major.minor.patch>, this field will be exactly equal to it.
     * If orchestratorVersion was <major.minor>, this field will contain the full <major.minor.patch> version being
     * used.
     */
    ...
    /**
     * Get the orchestratorVersion property: Both patch version &lt;major.minor.patch&gt; and &lt;major.minor&gt; are
    ...
    /**
     * Set the orchestratorVersion property: Both patch version &lt;major.minor.patch&gt; and &lt;major.minor&gt; are
     * supported. When &lt;major.minor&gt; is specified, the latest supported patch version is chosen automatically.
     * Updating the agent pool with the same &lt;major.minor&gt; once it has been created will not trigger an upgrade,
     * even if a newer patch version is available. As a best practice, you should upgrade all node pools in an AKS
     * cluster to the same Kubernetes version. The node pool version must have the same major version as the control
    ...
    /**
     * Get the currentOrchestratorVersion property: If orchestratorVersion was a fully specified version
    ...
    /**
     * Set the currentOrchestratorVersion property: If orchestratorVersion was a fully specified version
     * &lt;major.minor.patch&gt;, this field will be exactly equal to it. If orchestratorVersion was
     * &lt;major.minor&gt;, this field will contain the full &lt;major.minor.patch&gt; version being used.
     * 
    ...
    /**
     * Get the enableCustomCATrust property: When set to true, AKS adds a label to the node indicating that the feature
    ...
    /**
     * Set the enableCustomCATrust property: When set to true, AKS adds a label to the node indicating that the feature
     * is enabled and deploys a daemonset along with host services to sync custom certificate authorities from
     * user-provided list of base64 encoded certificates into node trust stores. Defaults to false.
     * 
    ...
    /**
     * Get the nodeInitializationTaints property: These taints will not be reconciled by AKS and can be removed with a
    ...
    /**
     * Set the nodeInitializationTaints property: These taints will not be reconciled by AKS and can be removed with a
     * kubectl call. This field can be modified after node pool is created, but nodes will not be recreated with new
     * taints until another operation that requires recreation (e.g. node image upgrade) happens. These taints allow for
     * required configuration to run before the node is ready to accept workloads, for example 'key1=value1:NoSchedule'
     * that then can be removed with `kubectl taint nodes node1 key1=value1:NoSchedule-`.
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeBooleanField("enableCustomCATrust", this.enableCustomCATrust);
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("eTag".equals(fieldName)) {
                    ...
                    deserializedManagedClusterAgentPoolProfileProperties.enableNodePublicIp
                        = reader.getNullable(JsonReader::getBoolean);
                } else if ("enableCustomCATrust".equals(fieldName)) {
                    deserializedManagedClusterAgentPoolProfileProperties.enableCustomCATrust
                        = reader.getNullable(JsonReader::getBoolean);
