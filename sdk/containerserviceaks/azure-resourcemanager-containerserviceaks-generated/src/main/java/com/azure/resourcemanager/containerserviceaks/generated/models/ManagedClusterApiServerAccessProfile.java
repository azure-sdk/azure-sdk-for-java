...
public final class ManagedClusterApiServerAccessProfile
    ...
    /*
     * It is required when: 1. creating a new cluster with BYO Vnet; 2. updating an existing cluster to enable apiserver
     * vnet integration.
     */
    ...
    /**
     * Get the subnetId property: It is required when: 1. creating a new cluster with BYO Vnet; 2. updating an existing
    ...
    /**
     * Set the subnetId property: It is required when: 1. creating a new cluster with BYO Vnet; 2. updating an existing
     * cluster to enable apiserver vnet integration.
     * 
