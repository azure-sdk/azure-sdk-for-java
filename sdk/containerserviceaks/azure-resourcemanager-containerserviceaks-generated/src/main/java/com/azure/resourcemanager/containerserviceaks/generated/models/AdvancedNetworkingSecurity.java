...
import com.azure.resourcemanager.containerserviceaks.generated.fluent.models.AdvancedNetworkingSecurityTransitEncryption;
...
public final class AdvancedNetworkingSecurity implements JsonSerializable<AdvancedNetworkingSecurity> {
    ...
    /*
     * This allows users to configure Layer 7 network policies (FQDN, HTTP, Kafka). Policies themselves must be
     ...
     */
    private AdvancedNetworkingSecurityTransitEncryption innerTransitEncryption;
    ...
    /**
     * Get the advancedNetworkPolicies property: This allows users to configure Layer 7 network policies (FQDN, HTTP,
     * Kafka). Policies themselves must be configured via the Cilium Network Policy resources, see
     * https://docs.cilium.io/en/latest/security/policy/index.html. This can be enabled only on cilium-based clusters.
     * If not specified, the default value is FQDN if security.enabled is set to true.
     * 
    ...
    /**
     * Set the advancedNetworkPolicies property: This allows users to configure Layer 7 network policies (FQDN, HTTP,
     * Kafka). Policies themselves must be configured via the Cilium Network Policy resources, see
     * https://docs.cilium.io/en/latest/security/policy/index.html. This can be enabled only on cilium-based clusters.
     * If not specified, the default value is FQDN if security.enabled is set to true.
     * 
    ...
    /**
     * Get the innerTransitEncryption property: Encryption configuration for Cilium-based clusters. Once enabled all
     * traffic between Cilium managed pods will be encrypted when it leaves the node boundary.
     * 
     * @return the innerTransitEncryption value.
     */
    private AdvancedNetworkingSecurityTransitEncryption innerTransitEncryption() {
        return this.innerTransitEncryption;
    }

    /**
     * Get the type property: This can be enabled only on Cilium-based clusters. If not specified, the default value is
     * None.
     * 
     * @return the type value.
     */
    public TransitEncryptionType type() {
        return this.innerTransitEncryption() == null ? null : this.innerTransitEncryption().type();
    }

    /**
     * Set the type property: This can be enabled only on Cilium-based clusters. If not specified, the default value is
     * None.
     * 
     * @param type the type value to set.
     * @return the AdvancedNetworkingSecurity object itself.
     */
    public AdvancedNetworkingSecurity withType(TransitEncryptionType type) {
        if (this.innerTransitEncryption() == null) {
            this.innerTransitEncryption = new AdvancedNetworkingSecurityTransitEncryption();
        }
        this.innerTransitEncryption().withType(type);
        return this;
    }
    ...
    public void validate() {
        if (innerTransitEncryption() != null) {
            innerTransitEncryption().validate();
        }
    }
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeJsonField("transitEncryption", this.innerTransitEncryption);
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("enabled".equals(fieldName)) {
                    ...
                    deserializedAdvancedNetworkingSecurity.innerTransitEncryption
