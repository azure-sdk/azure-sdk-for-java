...
public final class PrivateEndpointConnectionImpl
    ...
    public PrivateEndpointConnectionImpl withExistingConfigurationStore(String resourceGroupName,
    ...
    public PrivateEndpointConnection refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getPrivateEndpointConnections()
            .getWithResponse(resourceGroupName, configStoreName, privateEndpointConnectionName, context).getValue();
        return this;
    }
