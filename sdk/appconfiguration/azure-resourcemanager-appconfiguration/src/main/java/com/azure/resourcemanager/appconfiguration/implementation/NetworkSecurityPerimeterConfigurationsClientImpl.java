...
public final class NetworkSecurityPerimeterConfigurationsClientImpl
     ...
     * AppConfigurationManagementClientNetworkSecurityPerimeterConfigurations to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{$host}")
    ...
    public interface NetworkSecurityPerimeterConfigurationsService {
        ...
        @Headers({ "Content-Type: application/json" })
        @Get("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AppConfiguration/configurationStores/{configStoreName}/networkSecurityPerimeterConfigurations/{nspConfigurationName}")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        ...
        @Headers({ "Content-Type: application/json" })
        @Post("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AppConfiguration/configurationStores/{configStoreName}/networkSecurityPerimeterConfigurations/{nspConfigurationName}/reconcile")
    ...
    private Mono<Response<NetworkSecurityPerimeterConfigurationInner>> getWithResponseAsync(String resourceGroupName,
        String configStoreName, String nspConfigurationName) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return FluxUtil
            .withContext(context -> service.get(this.client.getEndpoint(), this.client.getSubscriptionId(),
                resourceGroupName, configStoreName, nspConfigurationName, this.client.getApiVersion(), accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<NetworkSecurityPerimeterConfigurationInner>> getWithResponseAsync(String resourceGroupName,
        ...
        return service.get(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            configStoreName, nspConfigurationName, this.client.getApiVersion(), accept, context);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginReconcile(String resourceGroupName, String configStoreName,
        String nspConfigurationName, Context context) {
        return this.beginReconcileAsync(resourceGroupName, configStoreName, nspConfigurationName, context)
            .getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> reconcileAsync(String resourceGroupName, String configStoreName, String nspConfigurationName) {
        return beginReconcileAsync(resourceGroupName, configStoreName, nspConfigurationName).last()
    ...
    private Mono<Void> reconcileAsync(String resourceGroupName, String configStoreName, String nspConfigurationName,
        Context context) {
        return beginReconcileAsync(resourceGroupName, configStoreName, nspConfigurationName, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public void reconcile(String resourceGroupName, String configStoreName, String nspConfigurationName) {
        reconcileAsync(resourceGroupName, configStoreName, nspConfigurationName).block();
    }
    ...
    public void reconcile(String resourceGroupName, String configStoreName, String nspConfigurationName,
        Context context) {
        reconcileAsync(resourceGroupName, configStoreName, nspConfigurationName, context).block();
    }
