...
public final class ConfigurationStorePropertiesUpdateParameters
    ...
    /**
     * Get the sasAuth property: This property manages if SAS token authentication is enabled or disabled.
     * 
    ...
    /**
     * Set the sasAuth property: This property manages if SAS token authentication is enabled or disabled.
     * 
     * @param sasAuth the sasAuth value to set.
     * @return the ConfigurationStorePropertiesUpdateParameters object itself.
     */
    public ConfigurationStorePropertiesUpdateParameters withSasAuth(SasAuth sasAuth) {
        this.sasAuth = sasAuth;
        return this;
    }
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeStringField("sasAuth", this.sasAuth == null ? null : this.sasAuth.toString());
    ...
    public static ConfigurationStorePropertiesUpdateParameters fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                } else if ("sasAuth".equals(fieldName)) {
                    deserializedConfigurationStorePropertiesUpdateParameters.sasAuth
                        = SasAuth.fromString(reader.getString());
