...
import com.azure.resourcemanager.appconfiguration.models.ResourceParameters;
...
public final class SasTokenGenerationResultInner implements JsonSerializable<SasTokenGenerationResultInner> {
    /*
     * The parameters to define the data plane resource scope.
     */
    ...
    /**
     * Get the resourceParameters property: The parameters to define the data plane resource scope.
     * 
    ...
    public static SasTokenGenerationResultInner fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("resourceParameters".equals(fieldName)) {
                    deserializedSasTokenGenerationResultInner.resourceParameters = ResourceParameters.fromJson(reader);
                    ...
                    deserializedSasTokenGenerationResultInner.kind = SasTokenKind.fromString(reader.getString());
