...
public final class OperationsClientImpl implements OperationsClient {
    ...
    private Mono<PagedResponse<OperationDefinitionInner>> listSinglePageAsync(String skipToken) {
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.list(this.client.getEndpoint(), apiVersion, skipToken, accept, context))
    ...
    private Mono<PagedResponse<OperationDefinitionInner>> listSinglePageAsync(String skipToken, Context context) {
        ...
        context = this.client.mergeContext(context);
        return service
            .list(this.client.getEndpoint(), apiVersion, skipToken, accept, context)
            .map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(),
