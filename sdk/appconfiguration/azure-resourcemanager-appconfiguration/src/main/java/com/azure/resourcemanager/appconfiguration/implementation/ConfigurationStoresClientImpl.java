...
public final class ConfigurationStoresClientImpl implements ConfigurationStoresClient {
    ...
    public interface ConfigurationStoresService {
        ...
        @Headers({ "Content-Type: application/json" })
        @Post("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AppConfiguration/configurationStores/{configStoreName}/resetSasTokens")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Void>> resetSasTokens(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("configStoreName") String configStoreName, @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") ResetSasTokensParameters resetSasTokensParameters,
            @HeaderParam("Accept") String accept, Context context);
    ...
    public SyncPoller<PollResult<ConfigurationStoreInner>, ConfigurationStoreInner> beginCreate(
        String resourceGroupName, String configStoreName, ConfigurationStoreInner configStoreCreationParameters) {
        return this.beginCreateAsync(resourceGroupName, configStoreName, configStoreCreationParameters).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String configStoreName) {
        return this.beginDeleteAsync(resourceGroupName, configStoreName).getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Void>> resetSasTokensWithResponseAsync(String resourceGroupName, String configStoreName,
        ...
        if (resetSasTokensParameters == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter resetSasTokensParameters is required and cannot be null."));
        } else {
            resetSasTokensParameters.validate();
        }
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.resetSasTokens(this.client.getEndpoint(), this.client.getSubscriptionId(),
                resourceGroupName, configStoreName, this.client.getApiVersion(), resetSasTokensParameters, accept,
                context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Void>> resetSasTokensWithResponseAsync(String resourceGroupName, String configStoreName,
        ResetSasTokensParameters resetSasTokensParameters, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.resetSasTokens(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            configStoreName, this.client.getApiVersion(), resetSasTokensParameters, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> resetSasTokensAsync(String resourceGroupName, String configStoreName,
        ResetSasTokensParameters resetSasTokensParameters) {
        return resetSasTokensWithResponseAsync(resourceGroupName, configStoreName, resetSasTokensParameters)
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<Void> resetSasTokensWithResponse(String resourceGroupName, String configStoreName,
        ResetSasTokensParameters resetSasTokensParameters, Context context) {
        return resetSasTokensWithResponseAsync(resourceGroupName, configStoreName, resetSasTokensParameters, context)
            .block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public void resetSasTokens(String resourceGroupName, String configStoreName,
        ResetSasTokensParameters resetSasTokensParameters) {
        resetSasTokensWithResponse(resourceGroupName, configStoreName, resetSasTokensParameters, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginPurgeDeleted(String location, String configStoreName) {
        return this.beginPurgeDeletedAsync(location, configStoreName).getSyncPoller();
    }
