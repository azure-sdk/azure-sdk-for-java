...
import com.azure.resourcemanager.appconfiguration.models.ConfigurationStoreUpdateParametersAutoGenerated;
...
public final class ConfigurationStoresClientImpl implements ConfigurationStoresClient {
    ...
    private interface ConfigurationStoresService {
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ConfigurationStoreInner>> get(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
        ...
        Mono<Response<Flux<ByteBuffer>>> update(
            ...
            @PathParam("configStoreName") String configStoreName,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") ConfigurationStoreUpdateParametersAutoGenerated configStoreUpdateParameters,
            @HeaderParam("Accept") String accept,
            Context context);
    ...
    private Mono<PagedResponse<ConfigurationStoreInner>> listSinglePageAsync(String skipToken, Context context) {
        ...
        return service
            .list(this.client.getEndpoint(), this.client.getSubscriptionId(), apiVersion, skipToken, accept, context)
            .map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ConfigurationStoreInner>> getWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ConfigurationStoreInner> getAsync(String resourceGroupName, String configStoreName) {
        return getWithResponseAsync(resourceGroupName, configStoreName)
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ConfigurationStoreInner> getWithResponse(
        String resourceGroupName, String configStoreName, Context context) {
        return getWithResponseAsync(resourceGroupName, configStoreName, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ConfigurationStoreInner get(String resourceGroupName, String configStoreName) {
        return getWithResponse(resourceGroupName, configStoreName, Context.NONE).getValue();
    }
    ...
    private Mono<PagedResponse<DeletedConfigurationStoreInner>> listDeletedSinglePageAsync(Context context) {
        ...
        context = this.client.mergeContext(context);
        return service
            .listDeleted(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(), accept, context)
            .map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(),
    ...
    private Mono<Response<Flux<ByteBuffer>>> updateWithResponseAsync(
        String resourceGroupName,
        String configStoreName,
        ConfigurationStoreUpdateParametersAutoGenerated configStoreUpdateParameters) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
