...
public final class NetworkSecurityPerimeterConfigurationsImpl implements NetworkSecurityPerimeterConfigurations {
    ...
    public Response<NetworkSecurityPerimeterConfiguration> getWithResponse(String resourceGroupName,
        ...
        Response<NetworkSecurityPerimeterConfigurationInner> inner
            = this.serviceClient().getWithResponse(resourceGroupName, configStoreName, nspConfigurationName, context);
        if (inner != null) {
    ...
    public NetworkSecurityPerimeterConfiguration get(String resourceGroupName, String configStoreName,
        ...
        NetworkSecurityPerimeterConfigurationInner inner
            = this.serviceClient().get(resourceGroupName, configStoreName, nspConfigurationName);
        if (inner != null) {
    ...
    public void reconcile(String resourceGroupName, String configStoreName, String nspConfigurationName) {
        this.serviceClient().reconcile(resourceGroupName, configStoreName, nspConfigurationName);
    }

    public void reconcile(String resourceGroupName, String configStoreName, String nspConfigurationName,
        Context context) {
        this.serviceClient().reconcile(resourceGroupName, configStoreName, nspConfigurationName, context);
    }
