...
public final class NetworkSecurityPerimeterConfigurationsImpl implements NetworkSecurityPerimeterConfigurations {
    ...
    public NetworkSecurityPerimeterConfiguration reconcile(String resourceGroupName, String configStoreName,
        String networkSecurityPerimeterConfigurationName) {
        NetworkSecurityPerimeterConfigurationInner inner = this.serviceClient()
            .reconcile(resourceGroupName, configStoreName, networkSecurityPerimeterConfigurationName);
        if (inner != null) {
            return new NetworkSecurityPerimeterConfigurationImpl(inner, this.manager());
        } else {
            return null;
