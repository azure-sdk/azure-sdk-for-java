...
public final class ConfigurationStoreInner extends Resource {
    ...
    public SasAuth sasAuth() {
        return this.innerProperties() == null ? null : this.innerProperties().sasAuth();
    }
     ...
     * @return the ConfigurationStoreInner object itself.
     */
    public ConfigurationStoreInner withSasAuth(SasAuth sasAuth) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ConfigurationStoreProperties();
        }
        this.innerProperties().withSasAuth(sasAuth);
        return this;
    }
