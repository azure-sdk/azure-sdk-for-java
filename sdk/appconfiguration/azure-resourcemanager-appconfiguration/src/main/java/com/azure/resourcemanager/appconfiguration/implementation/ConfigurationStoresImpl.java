...
public final class ConfigurationStoresImpl implements ConfigurationStores {
    ...
    public ConfigurationStoresImpl(ConfigurationStoresClient innerClient,
    ...
    public void resetSasTokens(String resourceGroupName, String configStoreName,
        ...
        this.serviceClient().resetSasTokens(resourceGroupName, configStoreName, resetSasTokensParameters);
    }
