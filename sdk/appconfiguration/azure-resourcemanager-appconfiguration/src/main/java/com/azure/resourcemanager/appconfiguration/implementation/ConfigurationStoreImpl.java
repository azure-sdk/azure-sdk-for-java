...
public final class ConfigurationStoreImpl
    ...
    public SasAuth sasAuth() {
        return this.innerModel().sasAuth();
    }
    ...
    public Response<Void> resetSasTokensWithResponse(ResetSasTokensParameters resetSasTokensParameters,
        Context context) {
        return serviceManager.configurationStores()
            .resetSasTokensWithResponse(resourceGroupName, configStoreName, resetSasTokensParameters, context);
    }

    public void resetSasTokens(ResetSasTokensParameters resetSasTokensParameters) {
        serviceManager.configurationStores()
            .resetSasTokens(resourceGroupName, configStoreName, resetSasTokensParameters);
    }
    ...
    public ConfigurationStoreImpl withSasAuth(SasAuth sasAuth) {
        if (isInCreateMode()) {
            this.innerModel().withSasAuth(sasAuth);
            return this;
        } else {
            this.updateConfigStoreUpdateParameters.withSasAuth(sasAuth);
            return this;
        }
    }
