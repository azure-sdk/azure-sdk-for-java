...
public final class ReplicasClientImpl implements ReplicasClient {
    ...
    private interface ReplicasService {
        ...
        @Get(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AppConfiguration"
                + "/configurationStores/{configStoreName}/replicas")
        ...
        @Get(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AppConfiguration"
                + "/configurationStores/{configStoreName}/replicas/{replicaName}")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(
        String resourceGroupName, String configStoreName, String replicaName) {
        return beginDeleteAsync(resourceGroupName, configStoreName, replicaName).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(
        String resourceGroupName, String configStoreName, String replicaName, Context context) {
        return beginDeleteAsync(resourceGroupName, configStoreName, replicaName, context).getSyncPoller();
    }
