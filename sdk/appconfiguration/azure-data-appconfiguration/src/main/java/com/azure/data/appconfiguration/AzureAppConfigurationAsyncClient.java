...
public final class AzureAppConfigurationAsyncClient {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> putKeyValueWithResponse(String contentTypeHeader, String key,
    ...
    public PagedFlux<KeyValue> getKeyValues(String key, String label, String syncToken, String after,
        ...
        PagedFlux<BinaryData> pagedFluxResponse = getKeyValues(requestOptions);
        return PagedFlux.create(() -> (continuationTokenParam, pageSizeParam) -> {
            Flux<PagedResponse<BinaryData>> flux = (continuationTokenParam == null)
                ? pagedFluxResponse.byPage().take(1)
                : pagedFluxResponse.byPage(continuationTokenParam).take(1);
    ...
    public PagedFlux<Snapshot> getSnapshots(String name, String after, List<SnapshotFields> select,
        ...
        PagedFlux<BinaryData> pagedFluxResponse = getSnapshots(requestOptions);
        return PagedFlux.create(() -> (continuationTokenParam, pageSizeParam) -> {
            Flux<PagedResponse<BinaryData>> flux = (continuationTokenParam == null)
                ? pagedFluxResponse.byPage().take(1)
                : pagedFluxResponse.byPage(continuationTokenParam).take(1);
    ...
    public PagedFlux<Label> getLabels(String name, String syncToken, String after, String acceptDatetime,
        ...
        PagedFlux<BinaryData> pagedFluxResponse = getLabels(requestOptions);
        return PagedFlux.create(() -> (continuationTokenParam, pageSizeParam) -> {
            Flux<PagedResponse<BinaryData>> flux = (continuationTokenParam == null)
                ? pagedFluxResponse.byPage().take(1)
                : pagedFluxResponse.byPage(continuationTokenParam).take(1);
    ...
    public PagedFlux<KeyValue> getRevisions(String key, String label, String syncToken, String after,
        ...
        PagedFlux<BinaryData> pagedFluxResponse = getRevisions(requestOptions);
        return PagedFlux.create(() -> (continuationTokenParam, pageSizeParam) -> {
            Flux<PagedResponse<BinaryData>> flux = (continuationTokenParam == null)
                ? pagedFluxResponse.byPage().take(1)
                : pagedFluxResponse.byPage(continuationTokenParam).take(1);
