...
public final class KeyValue implements JsonSerializable<KeyValue> {
    ...
    public static KeyValue fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            deserializedKeyValue.label = label;
            deserializedKeyValue.contentType = contentType;
            deserializedKeyValue.value = value;
            deserializedKeyValue.lastModified = lastModified;
            deserializedKeyValue.tags = tags;
            deserializedKeyValue.locked = locked;
            deserializedKeyValue.etag = etag;
