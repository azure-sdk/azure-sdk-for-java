...
public final class AzureAppConfigurationClientImpl {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> putKeyValueWithResponseAsync(String contentType, String key,
        RequestOptions requestOptions) {
        final String accept = "application/vnd.microsoft.appconfig.kv+json, application/problem+json, application/json";
        return FluxUtil.withContext(context -> service.putKeyValue(this.getEndpoint(),
            this.getServiceVersion().getVersion(), contentType, key, accept, requestOptions, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<BinaryData> putKeyValueWithResponse(String contentType, String key, RequestOptions requestOptions) {
        final String accept = "application/vnd.microsoft.appconfig.kv+json, application/problem+json, application/json";
        return service.putKeyValueSync(this.getEndpoint(), this.getServiceVersion().getVersion(), contentType, key,
            accept, requestOptions, Context.NONE);
    }
    ...
    public PollerFlux<BinaryData, BinaryData> beginCreateSnapshotAsync(String contentType, String name,
        BinaryData entity, RequestOptions requestOptions) {
        return PollerFlux.create(Duration.ofSeconds(1),
            () -> this.createSnapshotWithResponseAsync(contentType, name, entity, requestOptions),
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<BinaryData, BinaryData> beginCreateSnapshot(String contentType, String name, BinaryData entity,
        RequestOptions requestOptions) {
        return SyncPoller.createPoller(Duration.ofSeconds(1),
            () -> this.createSnapshotWithResponse(contentType, name, entity, requestOptions),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> updateSnapshotWithResponseAsync(String contentType, String name,
        BinaryData entity, RequestOptions requestOptions) {
        final String accept
            = "application/vnd.microsoft.appconfig.snapshot+json, application/problem+json, application/json";
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<BinaryData> updateSnapshotWithResponse(String contentType, String name, BinaryData entity,
        RequestOptions requestOptions) {
        final String accept
            = "application/vnd.microsoft.appconfig.snapshot+json, application/problem+json, application/json";
