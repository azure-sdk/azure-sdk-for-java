...
public final class AzureAppConfigurationClientImpl {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> putKeyValueWithResponseAsync(ContentTypeHeader contentTypeHeader, String key,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<BinaryData> putKeyValueWithResponse(ContentTypeHeader contentTypeHeader, String key,
        RequestOptions requestOptions) {
        final String accept = "application/vnd.microsoft.appconfig.kv+json, application/problem+json, application/json";
