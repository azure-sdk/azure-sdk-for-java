# Azure AzureAppConfiguration client library for Java

Azure AzureAppConfiguration client library for Java.

This package contains Microsoft Azure AzureAppConfiguration client library.
...
```java com.azure.data.appconfiguration.readme
```
