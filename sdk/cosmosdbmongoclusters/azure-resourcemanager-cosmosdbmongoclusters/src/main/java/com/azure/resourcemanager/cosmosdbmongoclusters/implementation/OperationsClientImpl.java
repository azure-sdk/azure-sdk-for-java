...
import com.azure.resourcemanager.cosmosdbmongoclusters.models.OperationListResult;
...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    OperationsClientImpl(CosmosDBMongoClusterManagementClientImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for CosmosDBMongoClusterManagementClientOperations to be used by the
