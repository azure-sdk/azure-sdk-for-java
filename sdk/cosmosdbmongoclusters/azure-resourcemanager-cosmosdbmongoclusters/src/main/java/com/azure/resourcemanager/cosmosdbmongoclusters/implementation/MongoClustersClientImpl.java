...
import com.azure.resourcemanager.cosmosdbmongoclusters.fluent.MongoClustersClient;
import com.azure.resourcemanager.cosmosdbmongoclusters.fluent.models.CheckNameAvailabilityResponseInner;
...
import com.azure.resourcemanager.cosmosdbmongoclusters.models.MongoClusterListResult;
import com.azure.resourcemanager.cosmosdbmongoclusters.models.MongoClusterUpdate;
...
public final class MongoClustersClientImpl implements MongoClustersClient {
     ...
     */
    private final CosmosDBMongoClusterManagementClientImpl client;
     ...
     */
    MongoClustersClientImpl(CosmosDBMongoClusterManagementClientImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for CosmosDBMongoClusterManagementClientMongoClusters to be used by the
     * proxy service to perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "CosmosDBMongoCluster")
