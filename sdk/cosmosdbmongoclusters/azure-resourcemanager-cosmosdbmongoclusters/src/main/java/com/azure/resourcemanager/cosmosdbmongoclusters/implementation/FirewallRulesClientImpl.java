...
import com.azure.resourcemanager.cosmosdbmongoclusters.models.FirewallRuleListResult;
...
public final class FirewallRulesClientImpl implements FirewallRulesClient {
     ...
     */
    FirewallRulesClientImpl(CosmosDBMongoClusterManagementClientImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for CosmosDBMongoClusterManagementClientFirewallRules to be used by the
    ...
    public interface FirewallRulesService {
        ...
        Mono<Response<FirewallRuleListResult>> listByMongoCluster(@HostParam("$host") String endpoint,
