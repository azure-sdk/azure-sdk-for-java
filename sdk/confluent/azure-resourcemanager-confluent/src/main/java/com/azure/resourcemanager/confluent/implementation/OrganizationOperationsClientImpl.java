...
public final class OrganizationOperationsClientImpl implements OrganizationOperationsClient {
    ...
    /**
     * Initializes an instance of OrganizationOperationsClientImpl.
     *
     * @param client the instance of the service client containing this operation class.
     */
    OrganizationOperationsClientImpl(ConfluentManagementClientImpl client) {
        this.service =
            RestProxy
                .create(OrganizationOperationsService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for ConfluentManagementClientOrganizationOperations to be used by the
     * proxy service to perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "ConfluentManagementC")
    private interface OrganizationOperationsService {
