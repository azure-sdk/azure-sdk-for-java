...
public final class AccessClientImpl implements AccessClient {
    ...
    public interface AccessService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<RoleBindingRecordInner>> createRoleBinding(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("organizationName") String organizationName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<RoleBindingRecordInner>> createRoleBindingWithResponseAsync(String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<RoleBindingRecordInner> createRoleBindingAsync(String resourceGroupName, String organizationName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<RoleBindingRecordInner> createRoleBindingWithResponse(String resourceGroupName,
        String organizationName, AccessCreateRoleBindingRequestModel body, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public RoleBindingRecordInner createRoleBinding(String resourceGroupName, String organizationName,
        AccessCreateRoleBindingRequestModel body) {
