 ...
 */
@Fluent
public final class KafkaAzureCosmosDBSinkConnectorInfo extends PartnerInfoBase {
    /*
     * The partner connector type.
     */
    private PartnerConnectorType partnerConnectorType = PartnerConnectorType.KAFKA_AZURE_COSMOS_DBSINK;
    ...
    /**
     * Creates an instance of KafkaAzureCosmosDBSinkConnectorInfo class.
     */
     ...
     * @return the KafkaAzureCosmosDBSinkConnectorInfo object itself.
     */
    public KafkaAzureCosmosDBSinkConnectorInfo withAuthType(AuthType authType) {
     ...
     * @return the KafkaAzureCosmosDBSinkConnectorInfo object itself.
     */
    public KafkaAzureCosmosDBSinkConnectorInfo withInputFormat(DataFormatType inputFormat) {
     ...
     * @return the KafkaAzureCosmosDBSinkConnectorInfo object itself.
     */
    public KafkaAzureCosmosDBSinkConnectorInfo withOutputFormat(DataFormatType outputFormat) {
     ...
     * @return the KafkaAzureCosmosDBSinkConnectorInfo object itself.
     */
    public KafkaAzureCosmosDBSinkConnectorInfo withApiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }
     ...
     * @return the KafkaAzureCosmosDBSinkConnectorInfo object itself.
     */
    public KafkaAzureCosmosDBSinkConnectorInfo withApiSecret(String apiSecret) {
     ...
     * @return the KafkaAzureCosmosDBSinkConnectorInfo object itself.
     */
    public KafkaAzureCosmosDBSinkConnectorInfo withServiceAccountId(String serviceAccountId) {
     ...
     * @return the KafkaAzureCosmosDBSinkConnectorInfo object itself.
     */
    public KafkaAzureCosmosDBSinkConnectorInfo withTopics(List<String> topics) {
        this.topics = topics;
        return this;
    }
     ...
     * @return the KafkaAzureCosmosDBSinkConnectorInfo object itself.
     */
    public KafkaAzureCosmosDBSinkConnectorInfo withTopicsDir(String topicsDir) {
     ...
     * @return the KafkaAzureCosmosDBSinkConnectorInfo object itself.
     */
    public KafkaAzureCosmosDBSinkConnectorInfo withFlushSize(String flushSize) {
     ...
     * @return the KafkaAzureCosmosDBSinkConnectorInfo object itself.
     */
    public KafkaAzureCosmosDBSinkConnectorInfo withMaxTasks(String maxTasks) {
     ...
     * @return the KafkaAzureCosmosDBSinkConnectorInfo object itself.
     */
    public KafkaAzureCosmosDBSinkConnectorInfo withTimeInterval(String timeInterval) {
    ...
    /**
     * Reads an instance of KafkaAzureCosmosDBSinkConnectorInfo from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of KafkaAzureCosmosDBSinkConnectorInfo if the JsonReader was pointing to an instance of it,
     * or null if it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the KafkaAzureCosmosDBSinkConnectorInfo.
     */
    public static KafkaAzureCosmosDBSinkConnectorInfo fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            KafkaAzureCosmosDBSinkConnectorInfo deserializedKafkaAzureCosmosDBSinkConnectorInfo
                = new KafkaAzureCosmosDBSinkConnectorInfo();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("partnerConnectorType".equals(fieldName)) {
                    deserializedKafkaAzureCosmosDBSinkConnectorInfo.partnerConnectorType
                        = PartnerConnectorType.fromString(reader.getString());
                } else if ("authType".equals(fieldName)) {
                    deserializedKafkaAzureCosmosDBSinkConnectorInfo.authType = AuthType.fromString(reader.getString());
                } else if ("inputFormat".equals(fieldName)) {
                    deserializedKafkaAzureCosmosDBSinkConnectorInfo.inputFormat
                        = DataFormatType.fromString(reader.getString());
                } else if ("outputFormat".equals(fieldName)) {
                    deserializedKafkaAzureCosmosDBSinkConnectorInfo.outputFormat
                        = DataFormatType.fromString(reader.getString());
                } else if ("apiKey".equals(fieldName)) {
                    deserializedKafkaAzureCosmosDBSinkConnectorInfo.apiKey = reader.getString();
                } else if ("apiSecret".equals(fieldName)) {
                    deserializedKafkaAzureCosmosDBSinkConnectorInfo.apiSecret = reader.getString();
                } else if ("serviceAccountId".equals(fieldName)) {
                    deserializedKafkaAzureCosmosDBSinkConnectorInfo.serviceAccountId = reader.getString();
                } else if ("topics".equals(fieldName)) {
                    List<String> topics = reader.readArray(reader1 -> reader1.getString());
                    deserializedKafkaAzureCosmosDBSinkConnectorInfo.topics = topics;
                } else if ("topicsDir".equals(fieldName)) {
                    deserializedKafkaAzureCosmosDBSinkConnectorInfo.topicsDir = reader.getString();
                } else if ("flushSize".equals(fieldName)) {
                    deserializedKafkaAzureCosmosDBSinkConnectorInfo.flushSize = reader.getString();
                } else if ("maxTasks".equals(fieldName)) {
                    deserializedKafkaAzureCosmosDBSinkConnectorInfo.maxTasks = reader.getString();
                } else if ("timeInterval".equals(fieldName)) {
                    deserializedKafkaAzureCosmosDBSinkConnectorInfo.timeInterval = reader.getString();
                } else {
                    reader.skipChildren();
                }
            }

            return deserializedKafkaAzureCosmosDBSinkConnectorInfo;
        });
    }
}
