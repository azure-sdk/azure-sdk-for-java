...
public interface ClustersClient {
    ...
    Response<SCClusterRecordInner> createOrUpdateWithResponse(String resourceGroupName, String organizationName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    SCClusterRecordInner createOrUpdate(String resourceGroupName, String organizationName, String environmentId,
        String clusterId);
