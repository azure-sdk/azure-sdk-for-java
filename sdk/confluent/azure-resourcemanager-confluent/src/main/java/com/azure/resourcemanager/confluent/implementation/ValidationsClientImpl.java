...
public final class ValidationsClientImpl implements ValidationsClient {
    ...
    public interface ValidationsService {
        ...
        @Post(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Confluent"
                + "/validations/{organizationName}/orgvalidateV2")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ValidationResponseInner>> validateOrganizationV2(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ValidationResponseInner>> validateOrganizationV2WithResponseAsync(
        String resourceGroupName, String organizationName, OrganizationResourceInner body) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ValidationResponseInner> validateOrganizationV2Async(
        String resourceGroupName, String organizationName, OrganizationResourceInner body) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ValidationResponseInner> validateOrganizationV2WithResponse(
        String resourceGroupName, String organizationName, OrganizationResourceInner body, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ValidationResponseInner validateOrganizationV2(
        String resourceGroupName, String organizationName, OrganizationResourceInner body) {
