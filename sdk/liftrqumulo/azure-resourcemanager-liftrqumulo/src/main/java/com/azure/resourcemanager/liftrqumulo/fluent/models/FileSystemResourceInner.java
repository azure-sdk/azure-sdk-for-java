...
public final class FileSystemResourceInner extends Resource {
     ...
     * @return the FileSystemResourceInner object itself.
     */
    public FileSystemResourceInner withSubscriptionId(String subscriptionId) {
     ...
     * @return the FileSystemResourceInner object itself.
     */
    public FileSystemResourceInner withProvisioningState(ProvisioningState provisioningState) {
        if (this.innerProperties() == null) {
            this.innerProperties = new FileSystemResourceProperties();
        }
     ...
     * @return the FileSystemResourceInner object itself.
     */
    public FileSystemResourceInner withCompanyDetails(CompanyDetails companyDetails) {
        if (this.innerProperties() == null) {
            this.innerProperties = new FileSystemResourceProperties();
        }
    ...
    public Integer initialCapacity() {
        return this.innerProperties() == null ? null : this.innerProperties().initialCapacity();
    }
     ...
     * @return the FileSystemResourceInner object itself.
     */
    public FileSystemResourceInner withInitialCapacity(Integer initialCapacity) {
        if (this.innerProperties() == null) {
            this.innerProperties = new FileSystemResourceProperties();
        }
