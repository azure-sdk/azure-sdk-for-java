...
public final class FileSystemResourceImpl
    ...
    public FileSystemResourceImpl withSubscriptionId(String subscriptionId) {
    ...
    public FileSystemResourceImpl withProvisioningState(ProvisioningState provisioningState) {
    ...
    public FileSystemResourceImpl withCompanyDetails(CompanyDetails companyDetails) {
