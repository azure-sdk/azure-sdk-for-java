...
/**
 * Resource collection API of PaloAltoNetworksCloudngfws.
 */
public interface PaloAltoNetworksCloudngfws {
    /**
     ...
     */
    Response<List<CloudManagerTenant>> listCloudManagerTenantsWithResponse(Context context);
     ...
     */
    List<CloudManagerTenant> listCloudManagerTenants();
