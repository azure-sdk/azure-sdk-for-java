...
public final class PaloAltoNetworksCloudngfwsClientImpl implements PaloAltoNetworksCloudngfwsClient {
    ...
    /**
     * The interface defining all the services for PaloAltoNetworksCloudngfwPaloAltoNetworksCloudngfws to be used by the
    ...
    public interface PaloAltoNetworksCloudngfwsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<CloudManagerTenantListInner>> listCloudManagerTenants(@HostParam("$host") String endpoint,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<CloudManagerTenantListInner>> listCloudManagerTenantsWithResponseAsync(Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
