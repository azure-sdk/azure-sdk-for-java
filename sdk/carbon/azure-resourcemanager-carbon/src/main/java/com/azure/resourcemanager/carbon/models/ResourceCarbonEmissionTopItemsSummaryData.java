...
@JsonTypeName("ResourceTopItemsSummaryData")
@Fluent
public final class ResourceCarbonEmissionTopItemsSummaryData extends CarbonEmissionDataInner {
     ...
     */
    @Override
    public ResourceCarbonEmissionTopItemsSummaryData withTotalCarbonEmission(double totalCarbonEmission) {
     ...
     */
    @Override
    public ResourceCarbonEmissionTopItemsSummaryData withChangeRatioForLastMonth(double changeRatioForLastMonth) {
     ...
     */
    @Override
    public ResourceCarbonEmissionTopItemsSummaryData withChangeRatioFor12Months(double changeRatioFor12Months) {
     ...
     */
    @Override
    public ResourceCarbonEmissionTopItemsSummaryData withChangeValueMonthOverMonth(Double changeValueMonthOverMonth) {
