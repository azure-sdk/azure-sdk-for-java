...
public interface CarbonServices {
     ...
     */
    PagedIterable<CarbonEmissionData> listCarbonEmissionReports(QueryFilter queryParameters);
     ...
     * @return list of carbon emission results as paginated response with {@link PagedIterable}.
     */
    PagedIterable<CarbonEmissionData> listCarbonEmissionReports(QueryFilter queryParameters, Context context);
