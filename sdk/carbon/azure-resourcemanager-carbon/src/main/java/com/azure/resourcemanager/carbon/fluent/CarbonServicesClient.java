...
public interface CarbonServicesClient {
    ...
    PagedIterable<CarbonEmissionDataInner> listCarbonEmissionReports(QueryFilter queryParameters);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<CarbonEmissionDataInner> listCarbonEmissionReports(QueryFilter queryParameters, Context context);
