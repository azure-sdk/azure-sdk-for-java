...
import com.azure.resourcemanager.iotfirmwaredefense.models.CryptoKeyResourceListResult;
...
public final class CryptoKeysClientImpl implements CryptoKeysClient {
     ...
     */
    CryptoKeysClientImpl(IotFirmwareDefenseImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for IotFirmwareDefenseCryptoKeys to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{$host}")
    ...
    public interface CryptoKeysService {
        ...
        Mono<Response<CryptoKeyResourceListResult>> listByFirmware(@HostParam("$host") String endpoint,
