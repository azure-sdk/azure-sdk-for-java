...
public final class CryptoKey implements JsonSerializable<CryptoKey> {
     ...
     * @return the CryptoKey object itself.
     */
    public CryptoKey withKeyType(CryptoKeyType keyType) {
    ...
    /**
     * Set the cryptoKeySize property: Size of the key in bits.
     * 
     * @param cryptoKeySize the cryptoKeySize value to set.
     * @return the CryptoKey object itself.
     */
    public CryptoKey withCryptoKeySize(Long cryptoKeySize) {
