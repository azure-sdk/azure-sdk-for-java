...
public final class PasswordHash implements JsonSerializable<PasswordHash> {
     ...
     * @return the PasswordHash object itself.
     */
    public PasswordHash withPasswordHashId(String passwordHashId) {
     ...
     * @return the PasswordHash object itself.
     */
    public PasswordHash withFilePath(String filePath) {
     ...
     * @return the PasswordHash object itself.
     */
    public PasswordHash withSalt(String salt) {
        this.salt = salt;
        return this;
    }
     ...
     * @return the PasswordHash object itself.
     */
    public PasswordHash withHash(String hash) {
        this.hash = hash;
        return this;
    }
     ...
     * @return the PasswordHash object itself.
     */
    public PasswordHash withContext(String context) {
     ...
     * @return the PasswordHash object itself.
     */
    public PasswordHash withUsername(String username) {
     ...
     * @return the PasswordHash object itself.
     */
    public PasswordHash withAlgorithm(String algorithm) {
