...
public final class PasswordHashResourceInner extends ProxyResource {
     ...
     */
    private PasswordHash properties;
     ...
     */
    public PasswordHashResourceInner withProperties(PasswordHash properties) {
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("id".equals(fieldName)) {
                    ...
                    deserializedPasswordHashResourceInner.properties = PasswordHash.fromJson(reader);
