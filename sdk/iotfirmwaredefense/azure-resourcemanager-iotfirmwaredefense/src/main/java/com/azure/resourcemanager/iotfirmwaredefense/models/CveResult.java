...
public final class CveResult implements JsonSerializable<CveResult> {
     ...
     */
    private Float effectiveCvssScore;
    ...
    /**
     * Set the componentId property: ID of the affected SBOM component.
     * 
     * @param componentId the componentId value to set.
     * @return the CveResult object itself.
     */
    public CveResult withComponentId(String componentId) {
    ...
    /**
     * Set the componentName property: Name of the affected SBOM component.
     * 
     * @param componentName the componentName value to set.
     * @return the CveResult object itself.
     */
    public CveResult withComponentName(String componentName) {
    ...
    /**
     * Set the componentVersion property: Version of the affected SBOM component.
     * 
     * @param componentVersion the componentVersion value to set.
     * @return the CveResult object itself.
     */
    public CveResult withComponentVersion(String componentVersion) {
    ...
    /**
     * Set the cveName property: Name of the CVE.
     * 
     * @param cveName the cveName value to set.
     * @return the CveResult object itself.
     */
    public CveResult withCveName(String cveName) {
    ...
    /**
     * Set the effectiveCvssScore property: The most recent CVSS score of the CVE.
     * 
     * @param effectiveCvssScore the effectiveCvssScore value to set.
     * @return the CveResult object itself.
     */
    public CveResult withEffectiveCvssScore(Float effectiveCvssScore) {
        this.effectiveCvssScore = effectiveCvssScore;
        return this;
    }
    ...
    /**
     * Set the effectiveCvssVersion property: The version of the effectiveCvssScore property.
     * 
     * @param effectiveCvssVersion the effectiveCvssVersion value to set.
     * @return the CveResult object itself.
     */
    public CveResult withEffectiveCvssVersion(Integer effectiveCvssVersion) {
        this.effectiveCvssVersion = effectiveCvssVersion;
        return this;
    }
    ...
    /**
     * Set the cvssScores property: All known CVSS scores for the CVE.
     * 
     * @param cvssScores the cvssScores value to set.
     * @return the CveResult object itself.
     */
    public CveResult withCvssScores(List<CvssScore> cvssScores) {
        this.cvssScores = cvssScores;
        return this;
    }
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("cveId".equals(fieldName)) {
                    ...
                    deserializedCveResult.effectiveCvssScore = reader.getNullable(JsonReader::getFloat);
