...
import com.azure.resourcemanager.iotfirmwaredefense.models.CveResourceListResult;
import reactor.core.publisher.Mono;

/**
 * An instance of this class provides access to all the operations defined in CvesClient.
 */
public final class CvesClientImpl implements CvesClient {
    /**
     * The proxy service used to perform REST calls.
     */
    private final CvesService service;
    ...
    /**
     * Initializes an instance of CvesClientImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    CvesClientImpl(IotFirmwareDefenseImpl client) {
        this.service = RestProxy.create(CvesService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for IotFirmwareDefenseCves to be used by the proxy service to perform
     * REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "IotFirmwareDefenseCv")
    public interface CvesService {
        ...
        Mono<Response<CveResourceListResult>> listByFirmware(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<CveResourceListResult>> listByFirmwareNext(
     ...
     * @return the response of a CveResource list operation along with {@link PagedResponse} on successful completion of
     * {@link Mono}.
     */
    ...
    private Mono<PagedResponse<CveResourceInner>> listByFirmwareSinglePageAsync(String resourceGroupName,
        ...
        return FluxUtil
            ...
            .<PagedResponse<CveResourceInner>>map(res -> new PagedResponseBase<>(res.getRequest(), res.getStatusCode(),
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the response of a CveResource list operation as paginated response with {@link PagedFlux}.
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<CveResourceInner> listByFirmwareAsync(String resourceGroupName, String workspaceName,
        String firmwareId) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<CveResourceInner> listByFirmware(String resourceGroupName, String workspaceName,
        String firmwareId) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<CveResourceInner>> listByFirmwareNextSinglePageAsync(String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        if (this.client.getEndpoint() == null) {
