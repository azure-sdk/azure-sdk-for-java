...
public final class WorkspaceUpdate implements JsonSerializable<WorkspaceUpdate> {
     ...
     */
    public WorkspaceUpdate withSku(AzureResourceManagerCommonTypesSkuUpdate sku) {
        this.sku = sku;
        return this;
    }
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("sku".equals(fieldName)) {
                    deserializedWorkspaceUpdate.sku = AzureResourceManagerCommonTypesSkuUpdate.fromJson(reader);
