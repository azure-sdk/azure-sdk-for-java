...
public final class UsageMetricInner extends ProxyResource {
     ...
     */
    private UsageMetricProperties properties;
     ...
     */
    public UsageMetricInner withProperties(UsageMetricProperties properties) {
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("id".equals(fieldName)) {
                    ...
                    deserializedUsageMetricInner.properties = UsageMetricProperties.fromJson(reader);
