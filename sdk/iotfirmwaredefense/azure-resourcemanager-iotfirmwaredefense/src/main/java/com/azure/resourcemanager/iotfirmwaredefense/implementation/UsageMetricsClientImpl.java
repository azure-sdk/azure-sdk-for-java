...
import com.azure.resourcemanager.iotfirmwaredefense.models.UsageMetricListResult;
...
public final class UsageMetricsClientImpl implements UsageMetricsClient {
     ...
     */
    UsageMetricsClientImpl(IotFirmwareDefenseImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for IotFirmwareDefenseUsageMetrics to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "IotFirmwareDefenseUs")
    public interface UsageMetricsService {
        ...
        Mono<Response<UsageMetricListResult>> listByWorkspace(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<UsageMetricInner>> get(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("workspaceName") String workspaceName,
