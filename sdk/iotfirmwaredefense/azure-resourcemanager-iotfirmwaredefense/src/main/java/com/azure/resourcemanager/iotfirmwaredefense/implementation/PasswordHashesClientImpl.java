...
import com.azure.resourcemanager.iotfirmwaredefense.models.PasswordHashResourceListResult;
import reactor.core.publisher.Mono;

/**
 * An instance of this class provides access to all the operations defined in PasswordHashesClient.
 */
public final class PasswordHashesClientImpl implements PasswordHashesClient {
    /**
    ...
    /**
     * Initializes an instance of PasswordHashesClientImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    PasswordHashesClientImpl(IotFirmwareDefenseImpl client) {
        this.service
            = RestProxy.create(PasswordHashesService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for IotFirmwareDefensePasswordHashes to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "IotFirmwareDefensePa")
    public interface PasswordHashesService {
        ...
        Mono<Response<PasswordHashResourceListResult>> listByFirmware(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<PasswordHashResourceListResult>> listByFirmwareNext(
     ...
     * @return the response of a PasswordHashResource list operation along with {@link PagedResponse} on successful
     * completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<PasswordHashResourceInner>> listByFirmwareSinglePageAsync(String resourceGroupName,
        ...
        return FluxUtil
            ...
            .<PagedResponse<PasswordHashResourceInner>>map(res -> new PagedResponseBase<>(res.getRequest(),
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the response of a PasswordHashResource list operation as paginated response with {@link PagedFlux}.
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<PasswordHashResourceInner> listByFirmwareAsync(String resourceGroupName, String workspaceName,
        String firmwareId) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<PasswordHashResourceInner> listByFirmware(String resourceGroupName, String workspaceName,
        String firmwareId) {
