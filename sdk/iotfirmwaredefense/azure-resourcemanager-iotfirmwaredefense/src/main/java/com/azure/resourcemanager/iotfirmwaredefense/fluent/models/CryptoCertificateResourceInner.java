...
public final class CryptoCertificateResourceInner extends ProxyResource {
     ...
     */
    private CryptoCertificate properties;
     ...
     */
    public CryptoCertificate properties() {
     ...
     */
    public CryptoCertificateResourceInner withProperties(CryptoCertificate properties) {
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("id".equals(fieldName)) {
                    ...
                    deserializedCryptoCertificateResourceInner.properties = CryptoCertificate.fromJson(reader);
