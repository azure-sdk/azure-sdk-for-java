...
/**
 * Resource collection API of SbomComponents.
 */
public interface SbomComponents {
    /**
     ...
     */
    PagedIterable<SbomComponentResource> listByFirmware(String resourceGroupName, String workspaceName,
        String firmwareId);
