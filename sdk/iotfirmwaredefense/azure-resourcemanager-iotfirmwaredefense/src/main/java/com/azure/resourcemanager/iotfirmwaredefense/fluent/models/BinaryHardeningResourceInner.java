...
public final class BinaryHardeningResourceInner extends ProxyResource {
     ...
     */
    private BinaryHardeningResult properties;
     ...
     */
    public BinaryHardeningResourceInner withProperties(BinaryHardeningResult properties) {
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("id".equals(fieldName)) {
                    ...
                    deserializedBinaryHardeningResourceInner.properties = BinaryHardeningResult.fromJson(reader);
