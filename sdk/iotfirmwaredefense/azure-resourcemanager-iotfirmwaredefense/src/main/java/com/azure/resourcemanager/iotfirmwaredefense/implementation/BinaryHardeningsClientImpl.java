...
import com.azure.resourcemanager.iotfirmwaredefense.models.BinaryHardeningResourceListResult;
import reactor.core.publisher.Mono;

/**
 * An instance of this class provides access to all the operations defined in BinaryHardeningsClient.
 */
public final class BinaryHardeningsClientImpl implements BinaryHardeningsClient {
    /**
     * The proxy service used to perform REST calls.
     */
    private final BinaryHardeningsService service;
    ...
    /**
     * Initializes an instance of BinaryHardeningsClientImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    BinaryHardeningsClientImpl(IotFirmwareDefenseImpl client) {
        this.service
            = RestProxy.create(BinaryHardeningsService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for IotFirmwareDefenseBinaryHardenings to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "IotFirmwareDefenseBi")
    public interface BinaryHardeningsService {
        ...
        Mono<Response<BinaryHardeningResourceListResult>> listByFirmware(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<BinaryHardeningResourceListResult>> listByFirmwareNext(
     ...
     * @return the response of a BinaryHardeningResource list operation along with {@link PagedResponse} on successful
     * completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<BinaryHardeningResourceInner>> listByFirmwareSinglePageAsync(String resourceGroupName,
        ...
        return FluxUtil
            ...
            .<PagedResponse<BinaryHardeningResourceInner>>map(res -> new PagedResponseBase<>(res.getRequest(),
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the response of a BinaryHardeningResource list operation as paginated response with {@link PagedFlux}.
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<BinaryHardeningResourceInner> listByFirmwareAsync(String resourceGroupName, String workspaceName,
        String firmwareId) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<BinaryHardeningResourceInner> listByFirmware(String resourceGroupName, String workspaceName,
        String firmwareId) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<BinaryHardeningResourceInner>> listByFirmwareNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
