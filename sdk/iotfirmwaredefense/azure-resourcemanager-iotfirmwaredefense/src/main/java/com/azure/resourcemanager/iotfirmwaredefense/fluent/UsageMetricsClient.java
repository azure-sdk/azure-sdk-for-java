 ...
 */
public interface UsageMetricsClient {
    /**
    ...
    PagedIterable<UsageMetricInner> listByWorkspace(String resourceGroupName, String workspaceName);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<UsageMetricInner> listByWorkspace(String resourceGroupName, String workspaceName, Context context);
    ...
    Response<UsageMetricInner> getWithResponse(String resourceGroupName, String workspaceName, String name,
        Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    UsageMetricInner get(String resourceGroupName, String workspaceName, String name);
}
