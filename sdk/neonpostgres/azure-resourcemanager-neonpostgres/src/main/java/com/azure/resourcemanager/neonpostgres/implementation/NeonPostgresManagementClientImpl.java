...
/**
 * Initializes a new instance of the NeonPostgresManagementClientImpl type.
 */
@ServiceClient(builder = NeonPostgresManagementClientBuilder.class)
public final class NeonPostgresManagementClientImpl implements NeonPostgresManagementClient {
    /**
     * Service host.
     */
     ...
     */
    NeonPostgresManagementClientImpl(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter,
