...
public final class OrganizationPropertiesTests {
    ...
    public void testDeserialize() throws Exception {
        ...
        Assertions.assertEquals(false, model.projectProperties().branch().roles().get(0).isSuperUser());
        ...
        Assertions.assertEquals(true, model.projectProperties().roles().get(0).isSuperUser());
