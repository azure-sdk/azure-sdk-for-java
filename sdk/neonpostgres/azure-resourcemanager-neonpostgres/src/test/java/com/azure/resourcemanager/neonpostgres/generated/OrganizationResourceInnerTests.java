...
public final class OrganizationResourceInnerTests {
    ...
    public void testDeserialize() throws Exception {
        ...
        Assertions.assertEquals(true, model.properties().projectProperties().branch().roles().get(0).isSuperUser());
        ...
        Assertions.assertEquals(false, model.properties().projectProperties().roles().get(0).isSuperUser());
