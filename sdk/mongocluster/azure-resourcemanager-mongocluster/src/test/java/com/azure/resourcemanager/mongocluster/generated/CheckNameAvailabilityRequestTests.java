...
public final class CheckNameAvailabilityRequestTests {
    ...
    public void testDeserialize() throws Exception {
        CheckNameAvailabilityRequest model = BinaryData.fromString("{\"name\":\"jfkgiawxk\",\"type\":\"ypl\"}")
            .toObject(CheckNameAvailabilityRequest.class);
        Assertions.assertEquals("jfkgiawxk", model.name());
        Assertions.assertEquals("ypl", model.type());
    }

    @org.junit.jupiter.api.Test
    public void testSerialize() throws Exception {
        CheckNameAvailabilityRequest model = new CheckNameAvailabilityRequest().withName("jfkgiawxk").withType("ypl");
