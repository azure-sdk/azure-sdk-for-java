...
public final class PrivateEndpointConnectionsListByMongoClusterMockTests {
    ...
    public void testListByMongoCluster() throws Exception {
        String responseStr
            = "{\"value\":[{\"properties\":{\"groupIds\":[\"yaxuconuqszfkb\",\"ypewrmjmwvvjekt\"],\"privateEndpoint\":{\"id\":\"enhwlrs\"},\"privateLinkServiceConnectionState\":{\"status\":\"Pending\",\"description\":\"pwvlqdq\",\"actionsRequired\":\"iqylihkaetck\"},\"provisioningState\":\"Deleting\"},\"id\":\"ivfsnk\",\"name\":\"m\",\"type\":\"ctq\"}]}";
        ...
        PagedIterable<PrivateEndpointConnectionResource> response = manager.privateEndpointConnections()
            .listByMongoCluster("hheunmmqhgyx", "konocu", com.azure.core.util.Context.NONE);
        ...
        Assertions.assertEquals("iqylihkaetck",
