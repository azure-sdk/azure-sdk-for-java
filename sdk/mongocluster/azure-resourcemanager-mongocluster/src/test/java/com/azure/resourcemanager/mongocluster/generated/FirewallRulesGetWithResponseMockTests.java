...
public final class FirewallRulesGetWithResponseMockTests {
    ...
    public void testGetWithResponse() throws Exception {
        String responseStr
            = "{\"properties\":{\"provisioningState\":\"Succeeded\",\"startIpAddress\":\"onpc\",\"endIpAddress\":\"hocohslkev\"},\"id\":\"ggzfbu\",\"name\":\"fmvfaxkffeiit\",\"type\":\"lvmezyvshxmzsbbz\"}";
        ...
        FirewallRule response = manager.firewallRules()
            .getWithResponse("ugidyjrr", "byao", "v", com.azure.core.util.Context.NONE)
            .getValue();

        Assertions.assertEquals("onpc", response.properties().startIpAddress());
        Assertions.assertEquals("hocohslkev", response.properties().endIpAddress());
    }
}
