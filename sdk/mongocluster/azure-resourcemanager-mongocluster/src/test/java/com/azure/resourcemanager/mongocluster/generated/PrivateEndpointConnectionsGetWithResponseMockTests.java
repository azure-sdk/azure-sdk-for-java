...
public final class PrivateEndpointConnectionsGetWithResponseMockTests {
    ...
    public void testGetWithResponse() throws Exception {
        String responseStr
            = "{\"properties\":{\"groupIds\":[\"i\",\"phxepcyvahf\",\"ljkyqxjvuuj\"],\"privateEndpoint\":{\"id\":\"dokgjl\"},\"privateLinkServiceConnectionState\":{\"status\":\"Approved\",\"description\":\"gvcl\",\"actionsRequired\":\"gsncghkjeszz\"},\"provisioningState\":\"Creating\"},\"id\":\"htxfvgxbfsmxnehm\",\"name\":\"vecxgodebfqkk\",\"type\":\"bmpukgriwflz\"}";
        ...
        PrivateEndpointConnectionResource response = manager.privateEndpointConnections()
            .getWithResponse("jf", "ebrjcxe", "fuwutttxf", com.azure.core.util.Context.NONE)
            .getValue();

        Assertions.assertEquals(PrivateEndpointServiceConnectionStatus.APPROVED,
            response.properties().privateLinkServiceConnectionState().status());
        Assertions.assertEquals("gvcl", response.properties().privateLinkServiceConnectionState().description());
        Assertions.assertEquals("gsncghkjeszz",
