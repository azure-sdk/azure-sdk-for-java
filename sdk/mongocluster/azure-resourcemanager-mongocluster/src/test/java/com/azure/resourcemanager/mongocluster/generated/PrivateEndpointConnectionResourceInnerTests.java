...
public final class PrivateEndpointConnectionResourceInnerTests {
    ...
    public void testDeserialize() throws Exception {
        PrivateEndpointConnectionResourceInner model = BinaryData.fromString(
            "{\"properties\":{\"groupIds\":[\"fthwxmnteiwa\",\"pvkmijcmmxdcuf\",\"fsrpymzidnse\"],\"privateEndpoint\":{\"id\":\"tbzsgfyccs\"},\"privateLinkServiceConnectionState\":{\"status\":\"Pending\",\"description\":\"dwzjeiach\",\"actionsRequired\":\"osfln\"},\"provisioningState\":\"Canceled\"},\"id\":\"qpteeh\",\"name\":\"zvypyqrimzinp\",\"type\":\"swjdkirso\"}")
            .toObject(PrivateEndpointConnectionResourceInner.class);
        Assertions.assertEquals("tbzsgfyccs", model.properties().privateEndpoint().id());
        ...
        Assertions.assertEquals(PrivateEndpointConnectionProvisioningState.CANCELED,
            model.properties().provisioningState());
    }

    @org.junit.jupiter.api.Test
    public void testSerialize() throws Exception {
        PrivateEndpointConnectionResourceInner model = new PrivateEndpointConnectionResourceInner().withProperties(
            new PrivateEndpointConnectionProperties().withPrivateEndpoint(new PrivateEndpoint().withId("tbzsgfyccs"))
                ...
                .withProvisioningState(PrivateEndpointConnectionProvisioningState.CANCELED));
