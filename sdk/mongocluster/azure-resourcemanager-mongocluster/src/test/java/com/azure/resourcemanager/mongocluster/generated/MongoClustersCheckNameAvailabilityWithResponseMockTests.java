...
public final class MongoClustersCheckNameAvailabilityWithResponseMockTests {
    ...
    public void testCheckNameAvailabilityWithResponse() throws Exception {
        String responseStr = "{\"nameAvailable\":true,\"reason\":\"Invalid\",\"message\":\"atkpnp\"}";
        ...
        CheckNameAvailabilityResponse response = manager.mongoClusters()
            .checkNameAvailabilityWithResponse("oczvy",
                new CheckNameAvailabilityRequest().withName("qrvkdv").withType("llr"), com.azure.core.util.Context.NONE)
            .getValue();
        ...
        Assertions.assertEquals("atkpnp", response.message());
    }
}
