...
public final class FirewallRulesCreateOrUpdateMockTests {
    ...
    public void testCreateOrUpdate() throws Exception {
        String responseStr
            = "{\"properties\":{\"provisioningState\":\"Succeeded\",\"startIpAddress\":\"ttmrywnuzoqf\",\"endIpAddress\":\"iyqzrnk\"},\"id\":\"vyxlwhzlsicohoqq\",\"name\":\"wvl\",\"type\":\"yav\"}";
        ...
        FirewallRule response = manager.firewallRules()
            .define("sjttgzfbish")
            .withExistingMongoCluster("dpydn", "yhxdeoejzicwi")
            .withProperties(
                new FirewallRuleProperties().withStartIpAddress("ajdeyeamdphaga").withEndIpAddress("pbuxwgipwhon"))
            .create();

        Assertions.assertEquals("ttmrywnuzoqf", response.properties().startIpAddress());
        Assertions.assertEquals("iyqzrnk", response.properties().endIpAddress());
    }
}
