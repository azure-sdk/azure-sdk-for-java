...
public final class PrivateEndpointConnectionPropertiesTests {
    ...
    public void testDeserialize() throws Exception {
        PrivateEndpointConnectionProperties model = BinaryData.fromString(
            "{\"groupIds\":[\"xaolth\",\"trg\",\"jbp\",\"zfsinzgvf\"],\"privateEndpoint\":{\"id\":\"wzo\"},\"privateLinkServiceConnectionState\":{\"status\":\"Approved\",\"description\":\"felluwfzitonpe\",\"actionsRequired\":\"pjkjlxofpdv\"},\"provisioningState\":\"Failed\"}")
        ...
        Assertions.assertEquals("pjkjlxofpdv", model.privateLinkServiceConnectionState().actionsRequired());
    }
            ...
            = new PrivateEndpointConnectionProperties().withPrivateEndpoint(new PrivateEndpoint())
                .withPrivateLinkServiceConnectionState(
                    new PrivateLinkServiceConnectionState().withStatus(PrivateEndpointServiceConnectionStatus.APPROVED)
                        ...
                        .withActionsRequired("pjkjlxofpdv"));
