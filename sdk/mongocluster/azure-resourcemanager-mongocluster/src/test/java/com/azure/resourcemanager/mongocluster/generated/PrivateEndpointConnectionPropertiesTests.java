...
public final class PrivateEndpointConnectionPropertiesTests {
    ...
    public void testDeserialize() throws Exception {
        PrivateEndpointConnectionProperties model = BinaryData.fromString(
            "{\"groupIds\":[\"xj\",\"prozvcputegjvwmf\",\"atscmd\",\"pjhulsuuvmkj\"],\"privateEndpoint\":{\"id\":\"rwfndiod\"},\"privateLinkServiceConnectionState\":{\"status\":\"Rejected\",\"description\":\"w\",\"actionsRequired\":\"dpvwryoqpsoaccta\"},\"provisioningState\":\"Succeeded\"}")
            .toObject(PrivateEndpointConnectionProperties.class);
        Assertions.assertEquals("rwfndiod", model.privateEndpoint().id());
        ...
        Assertions.assertEquals(PrivateEndpointConnectionProvisioningState.SUCCEEDED, model.provisioningState());
    }

    @org.junit.jupiter.api.Test
    public void testSerialize() throws Exception {
        PrivateEndpointConnectionProperties model
            = new PrivateEndpointConnectionProperties().withPrivateEndpoint(new PrivateEndpoint().withId("rwfndiod"))
