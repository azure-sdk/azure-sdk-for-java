...
public final class PrivateEndpointConnectionsCreateMockTests {
    ...
    public void testCreate() throws Exception {
        ...
        PrivateEndpointConnectionResource response = manager.privateEndpointConnections()
            ...
            .withProperties(
                new PrivateEndpointConnectionProperties().withPrivateEndpoint(new PrivateEndpoint().withId("heun"))
        ...
        Assertions.assertEquals("ymuctqhjfbebrj", response.properties().privateEndpoint().id());
