...
public final class ReplicasClientImpl implements ReplicasClient {
    ...
    public interface ReplicasService {
        ...
        Mono<Response<ReplicaListResult>> listByMongoCluster(@HostParam("endpoint") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ReplicaListResult>> listByMongoClusterNext(
    ...
    private Mono<PagedResponse<ReplicaInner>> listByMongoClusterSinglePageAsync(String resourceGroupName,
    ...
    private PagedFlux<ReplicaInner> listByMongoClusterAsync(String resourceGroupName, String mongoClusterName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<ReplicaInner> listByMongoCluster(String resourceGroupName, String mongoClusterName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<ReplicaInner>> listByMongoClusterNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<ReplicaInner>> listByMongoClusterNextSinglePageAsync(String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        if (this.client.getEndpoint() == null) {
