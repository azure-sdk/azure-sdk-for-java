...
public interface ReplicasClient {
    ...
    PagedIterable<ReplicaInner> listByMongoCluster(String resourceGroupName, String mongoClusterName);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<ReplicaInner> listByMongoCluster(String resourceGroupName, String mongoClusterName, Context context);
}
