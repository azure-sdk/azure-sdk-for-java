...
public final class HighAvailabilityProperties implements JsonSerializable<HighAvailabilityProperties> {
    ...
    /*
     * The current high availability mode the cluster is deployed with.
     */
    private HighAvailabilityMode mode;

    /*
     * The state of the high availability configuration for the cluster.
     */
    ...
    /**
     * Get the mode property: The current high availability mode the cluster is deployed with.
     * 
    ...
    /**
     * Get the state property: The state of the high availability configuration for the cluster.
     * 
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("targetMode".equals(fieldName)) {
                    ...
                    deserializedHighAvailabilityProperties.mode = HighAvailabilityMode.fromString(reader.getString());
                } else if ("state".equals(fieldName)) {
                    deserializedHighAvailabilityProperties.state = reader.getString();
                } else {
                    reader.skipChildren();
                }
            }
