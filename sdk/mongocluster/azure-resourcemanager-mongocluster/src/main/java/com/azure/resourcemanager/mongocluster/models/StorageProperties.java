...
public final class StorageProperties implements JsonSerializable<StorageProperties> {
    ...
    /*
     * The througput of the storage assigned to each server. Only applicable if the type is 'PremiumSSDv2'.
     */
    ...
    /**
     * Get the throughput property: The througput of the storage assigned to each server. Only applicable if the type is
     * 'PremiumSSDv2'.
     * 
    ...
    /**
     * Set the throughput property: The througput of the storage assigned to each server. Only applicable if the type is
     * 'PremiumSSDv2'.
     * 
