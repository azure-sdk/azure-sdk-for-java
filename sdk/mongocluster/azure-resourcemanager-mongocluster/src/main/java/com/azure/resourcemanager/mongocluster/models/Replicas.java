...
public interface Replicas {
     ...
     */
    PagedIterable<Replica> listByMongoCluster(String resourceGroupName, String mongoClusterName);
     ...
     * @return the response of a Replica list operation as paginated response with {@link PagedIterable}.
     */
    PagedIterable<Replica> listByMongoCluster(String resourceGroupName, String mongoClusterName, Context context);
}
