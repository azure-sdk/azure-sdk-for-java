...
public final class FederatedIdentityCredentialsCreateOrUpdateSamples {
     ...
     */
    public static void federatedIdentityCredentialCreate(com.azure.resourcemanager.msi.generated.ManagedServiceIdentityManager manager) {
        manager.federatedIdentityCredentials().define("ficResourceName").withExistingUserAssignedIdentity("rgName", "resourceName").withIssuer("https://oidc.prod-aks.azure.com/TenantGUID/IssuerGUID").withSubject("system:serviceaccount:ns:svcaccount").withAudiences(Arrays.asList("api://AzureADTokenExchange")).create();
    }
}
```
...
public final class FederatedIdentityCredentialsDeleteSamples {
     ...
     * @param manager Entry point to ManagedServiceIdentityManager.
     */
    public static void federatedIdentityCredentialDelete(com.azure.resourcemanager.msi.generated.ManagedServiceIdentityManager manager) {
        manager.federatedIdentityCredentials().deleteWithResponse("rgName", "resourceName", "ficResourceName", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class FederatedIdentityCredentialsGetSamples {
     ...
     * @param manager Entry point to ManagedServiceIdentityManager.
     */
    public static void federatedIdentityCredentialGet(com.azure.resourcemanager.msi.generated.ManagedServiceIdentityManager manager) {
        manager.federatedIdentityCredentials().getWithResponse("rgName", "resourceName", "ficResourceName", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class FederatedIdentityCredentialsListSamples {
     ...
     * @param manager Entry point to ManagedServiceIdentityManager.
     */
    public static void federatedIdentityCredentialList(com.azure.resourcemanager.msi.generated.ManagedServiceIdentityManager manager) {
        manager.federatedIdentityCredentials().list("rgName", "resourceName", null, null, com.azure.core.util.Context.NONE);
    }
}
```
...
public final class OperationsListSamples {
     ...
     * @param manager Entry point to ManagedServiceIdentityManager.
     */
    public static void msiOperationsList(com.azure.resourcemanager.msi.generated.ManagedServiceIdentityManager manager) {
...
public final class SystemAssignedIdentitiesGetByScopeSamples {
     ...
     */
    public static void msiOperationsList(com.azure.resourcemanager.msi.generated.ManagedServiceIdentityManager manager) {
        manager.systemAssignedIdentities().getByScopeWithResponse("scope", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class UserAssignedIdentitiesCreateOrUpdateSamples {
    ...
    public static void identityCreate(com.azure.resourcemanager.msi.generated.ManagedServiceIdentityManager manager) {
        manager.userAssignedIdentities().define("resourceName").withRegion("eastus").withExistingResourceGroup("rgName").withTags(mapOf("key1", "fakeTokenPlaceholder", "key2", "fakeTokenPlaceholder")).create();
    }
...
public final class UserAssignedIdentitiesDeleteSamples {
    ...
    public static void identityDelete(com.azure.resourcemanager.msi.generated.ManagedServiceIdentityManager manager) {
        manager.userAssignedIdentities().deleteByResourceGroupWithResponse("rgName", "resourceName", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class UserAssignedIdentitiesGetByResourceGroupSamples {
    ...
    public static void identityGet(com.azure.resourcemanager.msi.generated.ManagedServiceIdentityManager manager) {
        manager.userAssignedIdentities().getByResourceGroupWithResponse("rgName", "resourceName", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class UserAssignedIdentitiesListSamples {
     ...
     * @param manager Entry point to ManagedServiceIdentityManager.
     */
    public static void identityListBySubscription(com.azure.resourcemanager.msi.generated.ManagedServiceIdentityManager manager) {
...
public final class UserAssignedIdentitiesListByResourceGroupSamples {
     ...
     * @param manager Entry point to ManagedServiceIdentityManager.
     */
    public static void identityListByResourceGroup(com.azure.resourcemanager.msi.generated.ManagedServiceIdentityManager manager) {
...
public final class UserAssignedIdentitiesUpdateSamples {
    ...
    public static void identityUpdate(com.azure.resourcemanager.msi.generated.ManagedServiceIdentityManager manager) {
        Identity resource = manager.userAssignedIdentities().getByResourceGroupWithResponse("rgName", "resourceName", com.azure.core.util.Context.NONE).getValue();
