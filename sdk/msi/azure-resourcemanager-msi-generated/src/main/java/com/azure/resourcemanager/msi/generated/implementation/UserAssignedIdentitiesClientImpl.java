...
import com.azure.resourcemanager.msi.generated.models.AssociatedResourcesListResult;
...
public final class UserAssignedIdentitiesClientImpl implements UserAssignedIdentitiesClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<AzureResourceInner> listAssociatedResourcesAsync(String resourceGroupName, String resourceName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<IdentityInner> createOrUpdateAsync(
        String resourceGroupName, String resourceName, IdentityInner parameters) {
