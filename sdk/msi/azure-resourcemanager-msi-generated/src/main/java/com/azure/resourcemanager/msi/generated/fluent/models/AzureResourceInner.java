 ...
 *
 * <p>Describes an Azure resource that is attached to an identity.
 */
@Immutable
public final class AzureResourceInner {
     ...
     */
    @JsonProperty(value = "typeDisplayName", access = JsonProperty.Access.WRITE_ONLY)
    ...
    /** Creates an instance of AzureResourceInner class. */
    public AzureResourceInner() {
    }
    ...
    /**
     * Get the typeDisplayName property: The name of the type of this resource.
     *
     * @return the typeDisplayName value.
     */
