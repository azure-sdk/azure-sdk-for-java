...
public final class IdentityImpl implements Identity, Identity.Definition, Identity.Update {
    ...
    public Identity create() {
        this.innerObject = serviceManager.serviceClient().getUserAssignedIdentities()
    ...
    public Identity apply() {
        this.innerObject = serviceManager.serviceClient().getUserAssignedIdentities()
            .updateWithResponse(resourceGroupName, resourceName, updateParameters, Context.NONE).getValue();
        return this;
    }

    public Identity apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getUserAssignedIdentities()
            .updateWithResponse(resourceGroupName, resourceName, updateParameters, context).getValue();
        return this;
    }

    IdentityImpl(IdentityInner innerObject,
