...
public final class FederatedIdentityCredentialsImpl implements FederatedIdentityCredentials {
    ...
    public Response<FederatedIdentityCredential> getWithResponse(String resourceGroupName, String resourceName,
        ...
        Response<FederatedIdentityCredentialInner> inner = this.serviceClient().getWithResponse(resourceGroupName,
            resourceName, federatedIdentityCredentialResourceName, context);
        if (inner != null) {
    ...
    public Response<Void> deleteWithResponse(String resourceGroupName, String resourceName,
        String federatedIdentityCredentialResourceName, Context context) {
        return this.serviceClient().deleteWithResponse(resourceGroupName, resourceName,
            federatedIdentityCredentialResourceName, context);
    }
