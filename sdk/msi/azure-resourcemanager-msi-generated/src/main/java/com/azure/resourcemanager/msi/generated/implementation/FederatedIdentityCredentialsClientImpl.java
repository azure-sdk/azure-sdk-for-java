...
public final class FederatedIdentityCredentialsClientImpl implements FederatedIdentityCredentialsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<FederatedIdentityCredentialInner> createOrUpdateAsync(String resourceGroupName, String resourceName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<FederatedIdentityCredentialInner> getAsync(String resourceGroupName, String resourceName,
