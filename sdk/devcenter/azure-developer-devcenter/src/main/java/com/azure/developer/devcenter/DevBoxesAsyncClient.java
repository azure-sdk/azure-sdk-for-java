...
public final class DevBoxesAsyncClient {
    ...
    public PollerFlux<BinaryData, BinaryData> beginCreateDevBox(String projectName, String userId, String devBoxName,
        ...
        return this.serviceClient.beginCreateDevBoxAsync(projectName, userId, devBoxName, devBox, requestOptions);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<DevBoxPool> listPools(String projectName, String filter, Integer top) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<DevBoxSchedule> listSchedules(String projectName, String poolName, String filter, Integer top) {
