...
/**
 * Properties of an curation profile. These properties can be updated after the resource has been created.
 */
@Fluent
public class CurationProfileUpdateProperties implements JsonSerializable<CurationProfileUpdateProperties> {
    /*
    ...
    /**
     * Creates an instance of CurationProfileUpdateProperties class.
     */
    public CurationProfileUpdateProperties() {
    }
     ...
     * @return the CurationProfileUpdateProperties object itself.
     */
    public CurationProfileUpdateProperties withResourcePolicies(List<ResourcePolicy> resourcePolicies) {
     ...
     * @return the CurationProfileUpdateProperties object itself.
     */
    public CurationProfileUpdateProperties withScopes(List<String> scopes) {
        this.scopes = scopes;
        return this;
    }
    ...
    /**
     * Reads an instance of CurationProfileUpdateProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of CurationProfileUpdateProperties if the JsonReader was pointing to an instance of it, or
     * null if it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the CurationProfileUpdateProperties.
     */
    public static CurationProfileUpdateProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            CurationProfileUpdateProperties deserializedCurationProfileUpdateProperties
                = new CurationProfileUpdateProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("resourcePolicies".equals(fieldName)) {
                    ...
                    deserializedCurationProfileUpdateProperties.resourcePolicies = resourcePolicies;
                } else if ("scopes".equals(fieldName)) {
                    List<String> scopes = reader.readArray(reader1 -> reader1.getString());
                    deserializedCurationProfileUpdateProperties.scopes = scopes;
                } else {
                    reader.skipChildren();
                }
            }

            return deserializedCurationProfileUpdateProperties;
        });
    }
}
