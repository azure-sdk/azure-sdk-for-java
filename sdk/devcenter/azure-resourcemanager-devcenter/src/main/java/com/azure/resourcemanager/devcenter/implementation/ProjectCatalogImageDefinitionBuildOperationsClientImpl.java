 ...
 */
public final class ProjectCatalogImageDefinitionBuildOperationsClientImpl
    implements ProjectCatalogImageDefinitionBuildOperationsClient {
    /**
     * The proxy service used to perform REST calls.
     */
    private final ProjectCatalogImageDefinitionBuildOperationsService service;
    ...
    /**
     * Initializes an instance of ProjectCatalogImageDefinitionBuildOperationsClientImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    ProjectCatalogImageDefinitionBuildOperationsClientImpl(DevCenterManagementClientImpl client) {
        this.service = RestProxy.create(ProjectCatalogImageDefinitionBuildOperationsService.class,
            client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for DevCenterManagementClientProjectCatalogImageDefinitionBuildOperations
     * to be used by the proxy service to perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "DevCenterManagementC")
    public interface ProjectCatalogImageDefinitionBuildOperationsService {
    ...
    private Mono<Response<ImageDefinitionBuildInner>> getWithResponseAsync(String resourceGroupName, String projectName,
    ...
    private Mono<Response<ImageDefinitionBuildInner>> getWithResponseAsync(String resourceGroupName, String projectName,
        ...
        return service.get(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, projectName, catalogName, imageDefinitionName, buildName, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ImageDefinitionBuildInner> getAsync(String resourceGroupName, String projectName, String catalogName,
        String imageDefinitionName, String buildName) {
        return getWithResponseAsync(resourceGroupName, projectName, catalogName, imageDefinitionName, buildName)
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ImageDefinitionBuildInner> getWithResponse(String resourceGroupName, String projectName,
        String catalogName, String imageDefinitionName, String buildName, Context context) {
        return getWithResponseAsync(resourceGroupName, projectName, catalogName, imageDefinitionName, buildName,
            context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ImageDefinitionBuildInner get(String resourceGroupName, String projectName, String catalogName,
        String imageDefinitionName, String buildName) {
        return getWithResponse(resourceGroupName, projectName, catalogName, imageDefinitionName, buildName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> cancelWithResponseAsync(String resourceGroupName, String projectName,
        String catalogName, String imageDefinitionName, String buildName) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
    ...
    private PollerFlux<PollResult<Void>, Void> beginCancelAsync(String resourceGroupName, String projectName,
        String catalogName, String imageDefinitionName, String buildName) {
        Mono<Response<Flux<ByteBuffer>>> mono
            = cancelWithResponseAsync(resourceGroupName, projectName, catalogName, imageDefinitionName, buildName);
    ...
    private PollerFlux<PollResult<Void>, Void> beginCancelAsync(String resourceGroupName, String projectName,
        String catalogName, String imageDefinitionName, String buildName, Context context) {
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono = cancelWithResponseAsync(resourceGroupName, projectName, catalogName,
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<Void>, Void> beginCancel(String resourceGroupName, String projectName,
        String catalogName, String imageDefinitionName, String buildName) {
        return this.beginCancelAsync(resourceGroupName, projectName, catalogName, imageDefinitionName, buildName)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginCancel(String resourceGroupName, String projectName,
        String catalogName, String imageDefinitionName, String buildName, Context context) {
        return this
            .beginCancelAsync(resourceGroupName, projectName, catalogName, imageDefinitionName, buildName, context)
            .getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> cancelAsync(String resourceGroupName, String projectName, String catalogName,
        String imageDefinitionName, String buildName) {
        return beginCancelAsync(resourceGroupName, projectName, catalogName, imageDefinitionName, buildName).last()
    ...
    private Mono<Void> cancelAsync(String resourceGroupName, String projectName, String catalogName,
        ...
        return beginCancelAsync(resourceGroupName, projectName, catalogName, imageDefinitionName, buildName, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    public void cancel(String resourceGroupName, String projectName, String catalogName, String imageDefinitionName,
        String buildName) {
        cancelAsync(resourceGroupName, projectName, catalogName, imageDefinitionName, buildName).block();
    }
    ...
    public void cancel(String resourceGroupName, String projectName, String catalogName, String imageDefinitionName,
        ...
        cancelAsync(resourceGroupName, projectName, catalogName, imageDefinitionName, buildName, context).block();
    }
    ...
    private Mono<Response<ImageDefinitionBuildDetailsInner>> getBuildDetailsWithResponseAsync(String resourceGroupName,
        String projectName, String catalogName, String imageDefinitionName, String buildName) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ImageDefinitionBuildDetailsInner> getBuildDetailsAsync(String resourceGroupName, String projectName,
        String catalogName, String imageDefinitionName, String buildName) {
        return getBuildDetailsWithResponseAsync(resourceGroupName, projectName, catalogName, imageDefinitionName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ImageDefinitionBuildDetailsInner getBuildDetails(String resourceGroupName, String projectName,
        String catalogName, String imageDefinitionName, String buildName) {
        return getBuildDetailsWithResponse(resourceGroupName, projectName, catalogName, imageDefinitionName, buildName,
            Context.NONE).getValue();
    }
}
