...
public final class DevCenterCatalogImageDefinitionsImpl implements DevCenterCatalogImageDefinitions {
    ...
    public Response<DevCenterCatalogImageDefinition> getByDevCenterCatalogWithResponse(String resourceGroupName,
        String devCenterName, String catalogName, String imageDefinitionName, Context context) {
        Response<DevCenterCatalogImageDefinitionInner> inner = this.serviceClient()
            .getByDevCenterCatalogWithResponse(resourceGroupName, devCenterName, catalogName, imageDefinitionName,
                context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
                new DevCenterCatalogImageDefinitionImpl(inner.getValue(), this.manager()));
        } else {
            return null;
        }
    }

    public DevCenterCatalogImageDefinition getByDevCenterCatalog(String resourceGroupName, String devCenterName,
        String catalogName, String imageDefinitionName) {
        DevCenterCatalogImageDefinitionInner inner = this.serviceClient()
            .getByDevCenterCatalog(resourceGroupName, devCenterName, catalogName, imageDefinitionName);
        if (inner != null) {
            return new DevCenterCatalogImageDefinitionImpl(inner, this.manager());
        } else {
            return null;
        }
    }
