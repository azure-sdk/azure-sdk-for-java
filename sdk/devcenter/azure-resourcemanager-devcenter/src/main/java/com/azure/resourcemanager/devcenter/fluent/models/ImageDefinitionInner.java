...
public final class ImageDefinitionInner extends ProxyResource {
     ...
     */
    private CatalogImageDefinitionMetadataProperties innerProperties;
    ...
    public ImageDefinitionInner withImageReference(ImageReference imageReference) {
        if (this.innerProperties() == null) {
            this.innerProperties = new CatalogImageDefinitionMetadataProperties();
        }
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("id".equals(fieldName)) {
                    ...
                    deserializedImageDefinitionInner.innerProperties
                        = CatalogImageDefinitionMetadataProperties.fromJson(reader);
