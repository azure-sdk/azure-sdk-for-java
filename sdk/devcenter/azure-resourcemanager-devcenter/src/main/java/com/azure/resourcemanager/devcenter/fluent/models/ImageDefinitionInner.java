...
public final class ImageDefinitionInner extends ProxyResource {
     ...
     * @return the ImageDefinitionInner object itself.
     */
    public ImageDefinitionInner withTasks(List<CustomizationTaskInstance> tasks) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ImageDefinitionProperties();
        }
     ...
     * @return the ImageDefinitionInner object itself.
     */
    public ImageDefinitionInner withUserTasks(List<CustomizationTaskInstance> userTasks) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ImageDefinitionProperties();
        }
     ...
     * @return the ImageDefinitionInner object itself.
     */
    public ImageDefinitionInner withExtendsProperty(ImageDefinitionReference extendsProperty) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ImageDefinitionProperties();
        }
