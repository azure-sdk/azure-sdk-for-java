...
public final class DevBoxAutoDeleteSettings implements JsonSerializable<DevBoxAutoDeleteSettings> {
     ...
     */
    public DevBoxAutoDeleteSettings withDeleteMode(DevBoxDeleteMode deleteMode) {
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("deleteMode".equals(fieldName)) {
                    deserializedDevBoxAutoDeleteSettings.deleteMode = DevBoxDeleteMode.fromString(reader.getString());
