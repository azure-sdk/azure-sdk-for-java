...
public final class PoolInner extends Resource {
     ...
     * @return the PoolInner object itself.
     */
    public PoolInner withActiveHoursConfiguration(ActiveHoursConfiguration activeHoursConfiguration) {
        if (this.innerProperties() == null) {
            this.innerProperties = new PoolProperties();
        }
     ...
     * @return the PoolInner object itself.
     */
    public PoolInner withDevBoxTunnelEnableStatus(DevBoxTunnelEnableStatus devBoxTunnelEnableStatus) {
        if (this.innerProperties() == null) {
            this.innerProperties = new PoolProperties();
        }
