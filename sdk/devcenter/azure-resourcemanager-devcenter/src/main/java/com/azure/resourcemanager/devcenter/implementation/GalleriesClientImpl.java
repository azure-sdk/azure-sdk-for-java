...
public final class GalleriesClientImpl implements GalleriesClient {
    ...
    /**
     * The interface defining all the services for DevCenterManagementClientGalleries to be used by the proxy service
    ...
    public interface GalleriesService {
        ...
        Mono<Response<GalleryListResult>> listByDevCenter(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<GalleryInner>> get(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("devCenterName") String devCenterName,
        ...
        Mono<Response<Flux<ByteBuffer>>> createOrUpdate(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("devCenterName") String devCenterName,
            @PathParam("galleryName") String galleryName, @BodyParam("application/json") GalleryInner body,
     ...
     * @return results of the gallery list operation along with {@link PagedResponse} on successful completion of
     * {@link Mono}.
     */
    ...
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(context -> service.createOrUpdate(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, devCenterName, galleryName, body, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    public SyncPoller<PollResult<GalleryInner>, GalleryInner> beginCreateOrUpdate(String resourceGroupName,
        String devCenterName, String galleryName, GalleryInner body, Context context) {
        return this.beginCreateOrUpdateAsync(resourceGroupName, devCenterName, galleryName, body, context)
            .getSyncPoller();
    }
    ...
    private Mono<GalleryInner> createOrUpdateAsync(String resourceGroupName, String devCenterName, String galleryName,
        ...
        return beginCreateOrUpdateAsync(resourceGroupName, devCenterName, galleryName, body, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String devCenterName, String galleryName,
        Context context) {
        return beginDeleteAsync(resourceGroupName, devCenterName, galleryName, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
