...
public final class ImagesClientImpl implements ImagesClient {
    ...
    public interface ImagesService {
        ...
        Mono<Response<ImageListResult>> listByDevCenter(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ImageListResult>> listByGallery(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("devCenterName") String devCenterName,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ImageListResult>> listByProject(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ImageInner>> getByProject(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("projectName") String projectName,
     ...
     * @return results of the image list operation along with {@link PagedResponse} on successful completion of
     * {@link Mono}.
     */
    ...
    private Mono<PagedResponse<ImageInner>> listByGallerySinglePageAsync(String resourceGroupName, String devCenterName,
        ...
        context = this.client.mergeContext(context);
        return service
            .listByGallery(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
                resourceGroupName, devCenterName, galleryName, top, accept, context)
            .map(res -> new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(),
                res.getValue().value(), res.getValue().nextLink(), null));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<ImageInner> listByProjectAsync(String resourceGroupName, String projectName, Context context) {
        return new PagedFlux<>(() -> listByProjectSinglePageAsync(resourceGroupName, projectName, context),
    ...
    public PagedIterable<ImageInner> listByProject(String resourceGroupName, String projectName) {
        return new PagedIterable<>(listByProjectAsync(resourceGroupName, projectName));
    }
    ...
    public PagedIterable<ImageInner> listByProject(String resourceGroupName, String projectName, Context context) {
        return new PagedIterable<>(listByProjectAsync(resourceGroupName, projectName, context));
    }
    ...
    public Response<ImageInner> getByProjectWithResponse(String resourceGroupName, String projectName, String imageName,
        Context context) {
        return getByProjectWithResponseAsync(resourceGroupName, projectName, imageName, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<ImageInner>> listByProjectNextSinglePageAsync(String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        if (this.client.getEndpoint() == null) {
