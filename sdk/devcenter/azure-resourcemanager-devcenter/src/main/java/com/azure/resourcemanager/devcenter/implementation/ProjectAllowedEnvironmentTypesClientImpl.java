...
public final class ProjectAllowedEnvironmentTypesClientImpl implements ProjectAllowedEnvironmentTypesClient {
    ...
    /**
     * The interface defining all the services for DevCenterManagementClientProjectAllowedEnvironmentTypes to be used
    ...
    public interface ProjectAllowedEnvironmentTypesService {
        ...
        Mono<Response<AllowedEnvironmentTypeListResult>> list(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<AllowedEnvironmentTypeInner>> get(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("projectName") String projectName,
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<AllowedEnvironmentTypeInner> listAsync(String resourceGroupName, String projectName, Integer top,
        Context context) {
