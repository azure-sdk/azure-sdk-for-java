...
public final class DevCenterCatalogImageDefinitionBuildOperationsImpl
    implements DevCenterCatalogImageDefinitionBuildOperations {
    private static final ClientLogger LOGGER
        = new ClientLogger(DevCenterCatalogImageDefinitionBuildOperationsImpl.class);

    private final DevCenterCatalogImageDefinitionBuildOperationsClient innerClient;

    private final com.azure.resourcemanager.devcenter.DevCenterManager serviceManager;

    public DevCenterCatalogImageDefinitionBuildOperationsImpl(
        DevCenterCatalogImageDefinitionBuildOperationsClient innerClient,
    ...
    private DevCenterCatalogImageDefinitionBuildOperationsClient serviceClient() {
