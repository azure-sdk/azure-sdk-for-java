 ...
 */
@Fluent
public final class ManagedServiceIdentityAutoGenerated
    implements JsonSerializable<ManagedServiceIdentityAutoGenerated> {
    /*
    ...
    /**
     * Creates an instance of ManagedServiceIdentityAutoGenerated class.
     */
     ...
     * @return the ManagedServiceIdentityAutoGenerated object itself.
     */
    public ManagedServiceIdentityAutoGenerated withType(ManagedServiceIdentityType type) {
        this.type = type;
        return this;
    }
        ...
        if (type() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property type in model ManagedServiceIdentityAutoGenerated"));
        }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(ManagedServiceIdentityAutoGenerated.class);
    ...
    /**
     * Reads an instance of ManagedServiceIdentityAutoGenerated from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of ManagedServiceIdentityAutoGenerated if the JsonReader was pointing to an instance of it,
     * or null if it was pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the ManagedServiceIdentityAutoGenerated.
     */
    public static ManagedServiceIdentityAutoGenerated fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ManagedServiceIdentityAutoGenerated deserializedManagedServiceIdentityAutoGenerated
                = new ManagedServiceIdentityAutoGenerated();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("type".equals(fieldName)) {
                    deserializedManagedServiceIdentityAutoGenerated.type
                        = ManagedServiceIdentityType.fromString(reader.getString());
                } else if ("principalId".equals(fieldName)) {
                    deserializedManagedServiceIdentityAutoGenerated.principalId
                        = reader.getNullable(nonNullReader -> UUID.fromString(nonNullReader.getString()));
                } else if ("tenantId".equals(fieldName)) {
                    deserializedManagedServiceIdentityAutoGenerated.tenantId
                        = reader.getNullable(nonNullReader -> UUID.fromString(nonNullReader.getString()));
                    ...
                    deserializedManagedServiceIdentityAutoGenerated.userAssignedIdentities = userAssignedIdentities;
                } else {
                    reader.skipChildren();
                }
            }

            return deserializedManagedServiceIdentityAutoGenerated;
        });
    }
}
