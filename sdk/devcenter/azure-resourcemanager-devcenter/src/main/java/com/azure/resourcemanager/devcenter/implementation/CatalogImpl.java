...
public final class CatalogImpl implements Catalog, Catalog.Definition, Catalog.Update {
    ...
    public Catalog create() {
        this.innerObject = serviceManager.serviceClient().getProjectCatalogs().createOrUpdate(resourceGroupName,
            projectName, catalogName, this.innerModel(), Context.NONE);
        return this;
    }

    public Catalog create(Context context) {
        this.innerObject = serviceManager.serviceClient().getProjectCatalogs().createOrUpdate(resourceGroupName,
            projectName, catalogName, this.innerModel(), context);
        return this;
    }
    ...
    public Catalog apply() {
        this.innerObject = serviceManager.serviceClient().getProjectCatalogs().patch(resourceGroupName, projectName,
    ...
    public Catalog refresh() {
        this.innerObject = serviceManager.serviceClient().getProjectCatalogs()
            .getWithResponse(resourceGroupName, projectName, catalogName, Context.NONE).getValue();
        return this;
    }

    public Catalog refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getProjectCatalogs()
            .getWithResponse(resourceGroupName, projectName, catalogName, context).getValue();
        return this;
    }

    public Response<SyncErrorDetails> getSyncErrorDetailsWithResponse(Context context) {
        return serviceManager.projectCatalogs().getSyncErrorDetailsWithResponse(resourceGroupName, projectName,
            catalogName, context);
    }
