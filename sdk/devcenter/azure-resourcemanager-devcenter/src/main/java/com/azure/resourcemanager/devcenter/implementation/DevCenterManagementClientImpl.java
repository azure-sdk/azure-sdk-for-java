...
public final class DevCenterManagementClientImpl implements DevCenterManagementClient {
    ...
    /**
     * The CurationProfilesClient object to access its operations.
     */
    private final CurationProfilesClient curationProfiles;

    /**
     * Gets the CurationProfilesClient object to access its operations.
     * 
     * @return the CurationProfilesClient object.
     */
    public CurationProfilesClient getCurationProfiles() {
        return this.curationProfiles;
    }
    ...
    DevCenterManagementClientImpl(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter,
        ...
        this.curationProfiles = new CurationProfilesClientImpl(this);
