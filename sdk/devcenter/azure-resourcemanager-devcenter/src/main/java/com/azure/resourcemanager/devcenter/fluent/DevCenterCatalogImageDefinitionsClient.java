...
public interface DevCenterCatalogImageDefinitionsClient {
    ...
    Response<ImageDefinitionInner> getByDevCenterCatalogWithResponse(String resourceGroupName, String devCenterName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ImageDefinitionInner getByDevCenterCatalog(String resourceGroupName, String devCenterName, String catalogName,
