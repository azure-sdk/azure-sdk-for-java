 ...
 */
public interface DevCenterCatalogImageDefinitionsClient {
    /**
    ...
    PagedIterable<ImageDefinitionInner> listByDevCenterCatalog(String resourceGroupName, String devCenterName,
        String catalogName);
    ...
    Response<DevCenterCatalogImageDefinitionInner> getByDevCenterCatalogWithResponse(String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    DevCenterCatalogImageDefinitionInner getByDevCenterCatalog(String resourceGroupName, String devCenterName,
    ...
    SyncPoller<PollResult<Void>, Void> beginBuildImage(String resourceGroupName, String devCenterName,
        String catalogName, String imageDefinitionName);
