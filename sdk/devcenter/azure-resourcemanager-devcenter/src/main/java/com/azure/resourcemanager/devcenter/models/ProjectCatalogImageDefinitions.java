...
/**
 * Resource collection API of ProjectCatalogImageDefinitions.
 */
public interface ProjectCatalogImageDefinitions {
    /**
     ...
     */
    PagedIterable<ImageDefinition> listByProjectCatalog(String resourceGroupName, String projectName,
        String catalogName);
     ...
     */
    Response<ImageDefinition> getByProjectCatalogWithResponse(String resourceGroupName, String projectName,
     ...
     */
    ImageDefinition getByProjectCatalog(String resourceGroupName, String projectName, String catalogName,
