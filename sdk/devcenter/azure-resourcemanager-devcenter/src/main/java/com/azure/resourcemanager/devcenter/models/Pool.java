...
public interface Pool {
    ...
    /**
     * Gets the stopOnNoConnect property: Stop on no connect configuration settings for Dev Boxes created in this pool.
     * 
     * @return the stopOnNoConnect value.
     */
    StopOnNoConnectConfiguration stopOnNoConnect();
    ...
    /**
     * Gets the activeHoursConfiguration property: Active hours configuration settings for Dev Boxes created in this
     * pool.
     * 
    ...
    /**
     * Gets the devBoxTunnelEnableStatus property: Indicates whether Dev Box Tunnel is enabled for a the pool.
     * 
    ...
    interface DefinitionStages {
        ...
        interface WithCreate extends DefinitionStages.WithTags, DefinitionStages.WithDevBoxDefinitionType,
            ...
            DefinitionStages.WithStopOnNoConnect, DefinitionStages.WithSingleSignOnStatus,
            DefinitionStages.WithDisplayName, DefinitionStages.WithVirtualNetworkType,
            DefinitionStages.WithManagedVirtualNetworkRegions, DefinitionStages.WithActiveHoursConfiguration,
            DefinitionStages.WithDevBoxTunnelEnableStatus {
            /**
        ...
        /**
         * The stage of the Pool definition allowing to specify stopOnNoConnect.
         */
        interface WithStopOnNoConnect {
            /**
             * Specifies the stopOnNoConnect property: Stop on no connect configuration settings for Dev Boxes created
             * in this pool..
             * 
             * @param stopOnNoConnect Stop on no connect configuration settings for Dev Boxes created in this pool.
             * @return the next definition stage.
             */
            WithCreate withStopOnNoConnect(StopOnNoConnectConfiguration stopOnNoConnect);
        }
        ...
        /**
         * The stage of the Pool definition allowing to specify activeHoursConfiguration.
         */
        interface WithActiveHoursConfiguration {
            /**
             * Specifies the activeHoursConfiguration property: Active hours configuration settings for Dev Boxes
             * created in this pool..
             * 
             * @param activeHoursConfiguration Active hours configuration settings for Dev Boxes created in this pool.
             * @return the next definition stage.
             */
            WithCreate withActiveHoursConfiguration(ActiveHoursConfiguration activeHoursConfiguration);
        }

        /**
         * The stage of the Pool definition allowing to specify devBoxTunnelEnableStatus.
         */
        interface WithDevBoxTunnelEnableStatus {
            /**
             * Specifies the devBoxTunnelEnableStatus property: Indicates whether Dev Box Tunnel is enabled for a the
             * pool..
             * 
             * @param devBoxTunnelEnableStatus Indicates whether Dev Box Tunnel is enabled for a the pool.
             * @return the next definition stage.
             */
            WithCreate withDevBoxTunnelEnableStatus(DevBoxTunnelEnableStatus devBoxTunnelEnableStatus);
        }
    }
     ...
     */
    interface Update
        extends UpdateStages.WithTags, UpdateStages.WithDevBoxDefinitionType, UpdateStages.WithDevBoxDefinitionName,
        UpdateStages.WithDevBoxDefinition, UpdateStages.WithNetworkConnectionName, UpdateStages.WithLicenseType,
        UpdateStages.WithLocalAdministrator, UpdateStages.WithStopOnDisconnect, UpdateStages.WithStopOnNoConnect,
        UpdateStages.WithSingleSignOnStatus, UpdateStages.WithDisplayName, UpdateStages.WithVirtualNetworkType,
        UpdateStages.WithManagedVirtualNetworkRegions, UpdateStages.WithActiveHoursConfiguration,
        UpdateStages.WithDevBoxTunnelEnableStatus {
        /**
    ...
    interface UpdateStages {
        ...
        /**
         * The stage of the Pool update allowing to specify stopOnNoConnect.
         */
        interface WithStopOnNoConnect {
            /**
             * Specifies the stopOnNoConnect property: Stop on no connect configuration settings for Dev Boxes created
             ...
             * @return the next definition stage.
             */
            Update withStopOnNoConnect(StopOnNoConnectConfiguration stopOnNoConnect);
        }
        ...
        /**
         * The stage of the Pool update allowing to specify activeHoursConfiguration.
         */
        interface WithActiveHoursConfiguration {
            /**
             * Specifies the activeHoursConfiguration property: Active hours configuration settings for Dev Boxes
             ...
             * @return the next definition stage.
             */
            Update withActiveHoursConfiguration(ActiveHoursConfiguration activeHoursConfiguration);
        }

        /**
         * The stage of the Pool update allowing to specify devBoxTunnelEnableStatus.
         */
        interface WithDevBoxTunnelEnableStatus {
            /**
             * Specifies the devBoxTunnelEnableStatus property: Indicates whether Dev Box Tunnel is enabled for a the
             ...
             * @return the next definition stage.
             */
            Update withDevBoxTunnelEnableStatus(DevBoxTunnelEnableStatus devBoxTunnelEnableStatus);
        }
    }
