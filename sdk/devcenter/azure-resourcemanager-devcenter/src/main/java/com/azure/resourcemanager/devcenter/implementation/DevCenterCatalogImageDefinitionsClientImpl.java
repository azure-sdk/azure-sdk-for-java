...
public final class DevCenterCatalogImageDefinitionsClientImpl implements DevCenterCatalogImageDefinitionsClient {
    ...
    public interface DevCenterCatalogImageDefinitionsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<DevCenterCatalogImageDefinitionInner>> getByDevCenterCatalog(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("devCenterName") String devCenterName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<DevCenterCatalogImageDefinitionInner>> getByDevCenterCatalogWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DevCenterCatalogImageDefinitionInner> getByDevCenterCatalogAsync(String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<DevCenterCatalogImageDefinitionInner> getByDevCenterCatalogWithResponse(String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public DevCenterCatalogImageDefinitionInner getByDevCenterCatalog(String resourceGroupName, String devCenterName,
