...
public final class PoolProperties extends PoolUpdateProperties {
     ...
     */
    @Override
    public PoolProperties withActiveHoursConfiguration(ActiveHoursConfiguration activeHoursConfiguration) {
        super.withActiveHoursConfiguration(activeHoursConfiguration);
        return this;
    }
     ...
     */
    @Override
    public PoolProperties withDevBoxTunnelEnableStatus(DevBoxTunnelEnableStatus devBoxTunnelEnableStatus) {
        super.withDevBoxTunnelEnableStatus(devBoxTunnelEnableStatus);
        return this;
    }
    ...
    public void validate() {
        ...
        if (activeHoursConfiguration() != null) {
            activeHoursConfiguration().validate();
        }
    }
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeJsonField("activeHoursConfiguration", activeHoursConfiguration());
        jsonWriter.writeStringField("devBoxTunnelEnableStatus",
            devBoxTunnelEnableStatus() == null ? null : devBoxTunnelEnableStatus().toString());
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("devBoxDefinitionType".equals(fieldName)) {
                    ...
                    deserializedPoolProperties.withActiveHoursConfiguration(ActiveHoursConfiguration.fromJson(reader));
                } else if ("devBoxTunnelEnableStatus".equals(fieldName)) {
                    deserializedPoolProperties
                        .withDevBoxTunnelEnableStatus(DevBoxTunnelEnableStatus.fromString(reader.getString()));
