 ...
 */
public interface ProjectCatalogImageDefinitionsClient {
    /**
    ...
    PagedIterable<ImageDefinitionInner> listByProjectCatalog(String resourceGroupName, String projectName,
        String catalogName);
    ...
    Response<ImageDefinitionInner> getByProjectCatalogWithResponse(String resourceGroupName, String projectName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ImageDefinitionInner getByProjectCatalog(String resourceGroupName, String projectName, String catalogName,
    ...
    SyncPoller<PollResult<Void>, Void> beginBuildImage(String resourceGroupName, String projectName, String catalogName,
        String imageDefinitionName);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    void buildImage(String resourceGroupName, String projectName, String catalogName, String imageDefinitionName);
