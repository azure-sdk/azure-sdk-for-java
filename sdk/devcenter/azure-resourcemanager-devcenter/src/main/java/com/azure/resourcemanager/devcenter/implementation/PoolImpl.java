...
public final class PoolImpl implements Pool, Pool.Definition, Pool.Update {
    ...
    public ActiveHoursConfiguration activeHoursConfiguration() {
        return this.innerModel().activeHoursConfiguration();
    }

    public DevBoxTunnelEnableStatus devBoxTunnelEnableStatus() {
        return this.innerModel().devBoxTunnelEnableStatus();
    }
    ...
    public PoolImpl withActiveHoursConfiguration(ActiveHoursConfiguration activeHoursConfiguration) {
        if (isInCreateMode()) {
            this.innerModel().withActiveHoursConfiguration(activeHoursConfiguration);
            return this;
        } else {
            this.updateBody.withActiveHoursConfiguration(activeHoursConfiguration);
            return this;
        }
    }

    public PoolImpl withDevBoxTunnelEnableStatus(DevBoxTunnelEnableStatus devBoxTunnelEnableStatus) {
        if (isInCreateMode()) {
            this.innerModel().withDevBoxTunnelEnableStatus(devBoxTunnelEnableStatus);
            return this;
        } else {
            this.updateBody.withDevBoxTunnelEnableStatus(devBoxTunnelEnableStatus);
            return this;
        }
    }
