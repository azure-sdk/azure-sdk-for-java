...
public final class EnvironmentTypeImpl implements EnvironmentType, EnvironmentType.Definition, EnvironmentType.Update {
    ...
    public EnvironmentType create() {
        this.innerObject
            = serviceManager.serviceClient().getEnvironmentTypes().createOrUpdateWithResponse(resourceGroupName,
                devCenterName, environmentTypeName, this.innerModel(), Context.NONE).getValue();
        return this;
    }
    ...
    public EnvironmentType create(Context context) {
        this.innerObject
            = serviceManager.serviceClient().getEnvironmentTypes().createOrUpdateWithResponse(resourceGroupName,
                devCenterName, environmentTypeName, this.innerModel(), context).getValue();
        return this;
    }
    ...
    public EnvironmentType apply() {
        this.innerObject = serviceManager.serviceClient().getEnvironmentTypes()
    ...
    public EnvironmentType apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getEnvironmentTypes()
            .updateWithResponse(resourceGroupName, devCenterName, environmentTypeName, updateBody, context).getValue();
        return this;
    }
    ...
    public EnvironmentType refresh() {
        this.innerObject = serviceManager.serviceClient().getEnvironmentTypes()
            .getWithResponse(resourceGroupName, devCenterName, environmentTypeName, Context.NONE).getValue();
        return this;
    }

    public EnvironmentType refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getEnvironmentTypes()
            .getWithResponse(resourceGroupName, devCenterName, environmentTypeName, context).getValue();
        return this;
    }
