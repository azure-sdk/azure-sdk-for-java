...
public final class CatalogDevBoxDefinitionsGetErrorDetailsSamples {
     ...
     * CatalogDevBoxDefinitions_GetErrorDetails.json
     */
    /**
     ...
     */
    public static void
        catalogDevBoxDefinitionsGetErrorDetails(com.azure.resourcemanager.devcenter.DevCenterManager manager) {
        manager.catalogDevBoxDefinitions().getErrorDetailsWithResponse("rg1", "Contoso", "CentralCatalog", "WebDevBox",
