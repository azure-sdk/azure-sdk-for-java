...
* `models.DevCenterCatalogImageDefinition` was added
...
* `models.ImageDefinitionMetadataProperties` was added
...
* `models.DevBoxAutoDeleteConfiguration` was added
...
* `models.AzureAiServicesConfiguration` was added
...
* `models.ImageDefinitionUserContentProperties` was added
