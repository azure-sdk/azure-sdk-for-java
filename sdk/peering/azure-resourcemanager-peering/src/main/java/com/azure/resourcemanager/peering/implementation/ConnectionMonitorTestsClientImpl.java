...
public final class ConnectionMonitorTestsClientImpl implements ConnectionMonitorTestsClient {
    ...
    public interface ConnectionMonitorTestsService {
        ...
        Mono<Response<ConnectionMonitorTestInner>> get(@HostParam("$host") String endpoint,
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ConnectionMonitorTestInner>> createOrUpdate(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("peeringServiceName") String peeringServiceName,
            @PathParam("connectionMonitorTestName") String connectionMonitorTestName,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ConnectionMonitorTestListResult>> listByPeeringService(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("peeringServiceName") String peeringServiceName,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, Context context);
    ...
    private Mono<Response<ConnectionMonitorTestInner>> getWithResponseAsync(String resourceGroupName,
        ...
        if (connectionMonitorTestName == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter connectionMonitorTestName is required and cannot be null."));
        }
        ...
        return FluxUtil
            .withContext(context -> service.get(this.client.getEndpoint(), resourceGroupName, peeringServiceName,
                connectionMonitorTestName, this.client.getSubscriptionId(), this.client.getApiVersion(), accept,
                context))
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ConnectionMonitorTestInner>> getWithResponseAsync(String resourceGroupName,
        String peeringServiceName, String connectionMonitorTestName, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service.get(this.client.getEndpoint(), resourceGroupName, peeringServiceName, connectionMonitorTestName,
    ...
    private Mono<Response<ConnectionMonitorTestInner>> createOrUpdateWithResponseAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(context -> service.createOrUpdate(this.client.getEndpoint(), resourceGroupName,
                peeringServiceName, connectionMonitorTestName, this.client.getSubscriptionId(),
                this.client.getApiVersion(), connectionMonitorTest, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<ConnectionMonitorTestInner>> createOrUpdateWithResponseAsync(String resourceGroupName,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.createOrUpdate(this.client.getEndpoint(), resourceGroupName, peeringServiceName,
            connectionMonitorTestName, this.client.getSubscriptionId(), this.client.getApiVersion(),
            connectionMonitorTest, accept, context);
    }
    ...
    public Response<ConnectionMonitorTestInner> createOrUpdateWithResponse(String resourceGroupName,
        ...
        Context context) {
        return createOrUpdateWithResponseAsync(resourceGroupName, peeringServiceName, connectionMonitorTestName,
            connectionMonitorTest, context).block();
    }
    ...
    private Mono<Response<Void>> deleteWithResponseAsync(String resourceGroupName, String peeringServiceName,
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.delete(this.client.getEndpoint(), resourceGroupName, peeringServiceName,
                connectionMonitorTestName, this.client.getSubscriptionId(), this.client.getApiVersion(), accept,
                context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<Void>> deleteWithResponseAsync(String resourceGroupName, String peeringServiceName,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.delete(this.client.getEndpoint(), resourceGroupName, peeringServiceName,
            connectionMonitorTestName, this.client.getSubscriptionId(), this.client.getApiVersion(), accept, context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the paginated list of Connection Monitor Tests along with {@link PagedResponse} on successful completion
     * of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<ConnectionMonitorTestInner>>
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.listByPeeringService(this.client.getEndpoint(), resourceGroupName,
                peeringServiceName, this.client.getSubscriptionId(), this.client.getApiVersion(), accept, context))
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<ConnectionMonitorTestInner>>
        listByPeeringServiceSinglePageAsync(String resourceGroupName, String peeringServiceName, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        context = this.client.mergeContext(context);
        return service
            .listByPeeringService(this.client.getEndpoint(), resourceGroupName, peeringServiceName,
                this.client.getSubscriptionId(), this.client.getApiVersion(), accept, context)
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the paginated list of Connection Monitor Tests as paginated response with {@link PagedFlux}.
     */
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the paginated list of Connection Monitor Tests as paginated response with {@link PagedIterable}.
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    ...
    private Mono<PagedResponse<ConnectionMonitorTestInner>> listByPeeringServiceNextSinglePageAsync(String nextLink,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.listByPeeringServiceNext(nextLink, this.client.getEndpoint(), accept, context)
            .map(res -> new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(),
                res.getValue().value(), res.getValue().nextLink(), null));
    }
}
