...
public final class LookingGlassClientImpl implements LookingGlassClient {
    ...
    public interface LookingGlassService {
        ...
        Mono<Response<LookingGlassOutputInner>> invoke(@HostParam("$host") String endpoint,
            @QueryParam("command") LookingGlassCommand command,
            @QueryParam("sourceType") LookingGlassSourceType sourceType,
            @QueryParam("sourceLocation") String sourceLocation, @QueryParam("destinationIP") String destinationIp,
    ...
    private Mono<Response<LookingGlassOutputInner>> invokeWithResponseAsync(LookingGlassCommand command,
        LookingGlassSourceType sourceType, String sourceLocation, String destinationIp) {
        ...
        return FluxUtil
            .withContext(context -> service.invoke(this.client.getEndpoint(), command, sourceType, sourceLocation,
                destinationIp, this.client.getSubscriptionId(), this.client.getApiVersion(), accept, context))
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<LookingGlassOutputInner>> invokeWithResponseAsync(LookingGlassCommand command,
        LookingGlassSourceType sourceType, String sourceLocation, String destinationIp, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service.invoke(this.client.getEndpoint(), command, sourceType, sourceLocation, destinationIp,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<LookingGlassOutputInner> invokeAsync(LookingGlassCommand command, LookingGlassSourceType sourceType,
        String sourceLocation, String destinationIp) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<LookingGlassOutputInner> invokeWithResponse(LookingGlassCommand command,
        LookingGlassSourceType sourceType, String sourceLocation, String destinationIp, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public LookingGlassOutputInner invoke(LookingGlassCommand command, LookingGlassSourceType sourceType,
        String sourceLocation, String destinationIp) {
        return invokeWithResponse(command, sourceType, sourceLocation, destinationIp, Context.NONE).getValue();
    }
}
