...
public final class RpUnbilledPrefixesImpl implements RpUnbilledPrefixes {
    ...
    public RpUnbilledPrefixesImpl(
        RpUnbilledPrefixesClient innerClient, com.azure.resourcemanager.peering.PeeringManager serviceManager) {
    ...
    public PagedIterable<RpUnbilledPrefix> list(String resourceGroupName, String peeringName) {
        ...
        return Utils.mapPage(inner, inner1 -> new RpUnbilledPrefixImpl(inner1, this.manager()));
    }

    public PagedIterable<RpUnbilledPrefix> list(
