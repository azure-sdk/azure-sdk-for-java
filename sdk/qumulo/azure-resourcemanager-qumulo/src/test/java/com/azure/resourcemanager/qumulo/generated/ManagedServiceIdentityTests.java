...
public final class ManagedServiceIdentityTests {
    ...
    public void testDeserialize() throws Exception {
        ManagedServiceIdentity model = BinaryData.fromString(
            "{\"principalId\":\"pini\",\"tenantId\":\"ayhuy\",\"type\":\"SystemAssigned,UserAssigned\",\"userAssignedIdentities\":{\"eotusivyevc\":{\"principalId\":\"depoog\",\"clientId\":\"uvamiheognarxzxt\"},\"gxg\":{\"principalId\":\"qi\",\"clientId\":\"hungbwjzrnf\"}}}")
        ...
        ManagedServiceIdentity model
            = new ManagedServiceIdentity().withType(ManagedServiceIdentityType.SYSTEM_ASSIGNED_USER_ASSIGNED)
                .withUserAssignedIdentities(
                    mapOf("eotusivyevc", new UserAssignedIdentity(), "gxg", new UserAssignedIdentity()));
