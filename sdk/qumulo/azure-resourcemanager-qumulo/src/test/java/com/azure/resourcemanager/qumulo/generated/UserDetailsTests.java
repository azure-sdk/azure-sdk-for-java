...
public final class UserDetailsTests {
    ...
    public void testDeserialize() throws Exception {
        UserDetails model = BinaryData.fromString("{\"email\":\"jkjlxofpdvhpfx\"}").toObject(UserDetails.class);
        Assertions.assertEquals("jkjlxofpdvhpfx", model.email());
    }

    @org.junit.jupiter.api.Test
    public void testSerialize() throws Exception {
        UserDetails model = new UserDetails().withEmail("jkjlxofpdvhpfx");
