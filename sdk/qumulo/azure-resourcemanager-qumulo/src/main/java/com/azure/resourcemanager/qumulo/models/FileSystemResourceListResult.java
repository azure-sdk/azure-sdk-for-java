...
public final class FileSystemResourceListResult implements JsonSerializable<FileSystemResourceListResult> {
     ...
     */
    private List<LiftrBaseStorageFileSystemResourceInner> value;
     ...
     */
    public List<LiftrBaseStorageFileSystemResourceInner> value() {
        return this.value;
    }
     ...
     */
    public FileSystemResourceListResult withValue(List<LiftrBaseStorageFileSystemResourceInner> value) {
        this.value = value;
        return this;
    }
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("value".equals(fieldName)) {
                    List<LiftrBaseStorageFileSystemResourceInner> value
                        = reader.readArray(reader1 -> LiftrBaseStorageFileSystemResourceInner.fromJson(reader1));
