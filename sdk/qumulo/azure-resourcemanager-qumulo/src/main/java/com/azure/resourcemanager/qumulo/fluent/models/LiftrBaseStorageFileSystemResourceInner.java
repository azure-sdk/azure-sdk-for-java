 ...
 */
@Fluent
public final class LiftrBaseStorageFileSystemResourceInner extends Resource {
    /*
     * The resource-specific properties for this resource.
     */
    private LiftrBaseStorageFileSystemResourceProperties innerProperties;
    ...
    /**
     * Creates an instance of LiftrBaseStorageFileSystemResourceInner class.
     */
    public LiftrBaseStorageFileSystemResourceInner() {
    }
     ...
     * @return the LiftrBaseStorageFileSystemResourceInner object itself.
     */
    public LiftrBaseStorageFileSystemResourceInner withIdentity(ManagedServiceIdentity identity) {
     ...
     */
    @Override
    public LiftrBaseStorageFileSystemResourceInner withLocation(String location) {
     ...
     */
    @Override
    public LiftrBaseStorageFileSystemResourceInner withTags(Map<String, String> tags) {
        super.withTags(tags);
        return this;
    }
    ...
    public LiftrBaseStorageFileSystemResourceInner
        ...
        if (this.innerProperties() == null) {
            this.innerProperties = new LiftrBaseStorageFileSystemResourceProperties();
        }
     ...
     * @return the LiftrBaseStorageFileSystemResourceInner object itself.
     */
    public LiftrBaseStorageFileSystemResourceInner withStorageSku(String storageSku) {
        if (this.innerProperties() == null) {
            this.innerProperties = new LiftrBaseStorageFileSystemResourceProperties();
        }
     ...
     * @return the LiftrBaseStorageFileSystemResourceInner object itself.
     */
    public LiftrBaseStorageFileSystemResourceInner withUserDetails(LiftrBaseUserDetails userDetails) {
        if (this.innerProperties() == null) {
            this.innerProperties = new LiftrBaseStorageFileSystemResourceProperties();
        }
     ...
     * @return the LiftrBaseStorageFileSystemResourceInner object itself.
     */
    public LiftrBaseStorageFileSystemResourceInner withDelegatedSubnetId(String delegatedSubnetId) {
        if (this.innerProperties() == null) {
            this.innerProperties = new LiftrBaseStorageFileSystemResourceProperties();
        }
     ...
     * @return the LiftrBaseStorageFileSystemResourceInner object itself.
     */
    public LiftrBaseStorageFileSystemResourceInner withClusterLoginUrl(String clusterLoginUrl) {
        if (this.innerProperties() == null) {
            this.innerProperties = new LiftrBaseStorageFileSystemResourceProperties();
        }
     ...
     * @return the LiftrBaseStorageFileSystemResourceInner object itself.
     */
    public LiftrBaseStorageFileSystemResourceInner withPrivateIPs(List<String> privateIPs) {
        if (this.innerProperties() == null) {
            this.innerProperties = new LiftrBaseStorageFileSystemResourceProperties();
        }
     ...
     * @return the LiftrBaseStorageFileSystemResourceInner object itself.
     */
    public LiftrBaseStorageFileSystemResourceInner withAdminPassword(String adminPassword) {
        if (this.innerProperties() == null) {
            this.innerProperties = new LiftrBaseStorageFileSystemResourceProperties();
        }
     ...
     * @return the LiftrBaseStorageFileSystemResourceInner object itself.
     */
    public LiftrBaseStorageFileSystemResourceInner withAvailabilityZone(String availabilityZone) {
        if (this.innerProperties() == null) {
            this.innerProperties = new LiftrBaseStorageFileSystemResourceProperties();
        }
    ...
    /**
     * Reads an instance of LiftrBaseStorageFileSystemResourceInner from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of LiftrBaseStorageFileSystemResourceInner if the JsonReader was pointing to an instance of
     * it, or null if it was pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the LiftrBaseStorageFileSystemResourceInner.
     */
    public static LiftrBaseStorageFileSystemResourceInner fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            LiftrBaseStorageFileSystemResourceInner deserializedLiftrBaseStorageFileSystemResourceInner
                = new LiftrBaseStorageFileSystemResourceInner();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("id".equals(fieldName)) {
                    deserializedLiftrBaseStorageFileSystemResourceInner.id = reader.getString();
                } else if ("name".equals(fieldName)) {
                    deserializedLiftrBaseStorageFileSystemResourceInner.name = reader.getString();
                } else if ("type".equals(fieldName)) {
                    deserializedLiftrBaseStorageFileSystemResourceInner.type = reader.getString();
                } else if ("location".equals(fieldName)) {
                    deserializedLiftrBaseStorageFileSystemResourceInner.withLocation(reader.getString());
                } else if ("tags".equals(fieldName)) {
                    Map<String, String> tags = reader.readMap(reader1 -> reader1.getString());
                    deserializedLiftrBaseStorageFileSystemResourceInner.withTags(tags);
                } else if ("properties".equals(fieldName)) {
                    deserializedLiftrBaseStorageFileSystemResourceInner.innerProperties
                        = LiftrBaseStorageFileSystemResourceProperties.fromJson(reader);
                } else if ("identity".equals(fieldName)) {
                    deserializedLiftrBaseStorageFileSystemResourceInner.identity
                        = ManagedServiceIdentity.fromJson(reader);
                } else if ("systemData".equals(fieldName)) {
                    deserializedLiftrBaseStorageFileSystemResourceInner.systemData = SystemData.fromJson(reader);
                } else {
                    reader.skipChildren();
                }
            }

            return deserializedLiftrBaseStorageFileSystemResourceInner;
        });
    }
}
