...
public final class LiftrBaseMarketplaceDetails implements JsonSerializable<LiftrBaseMarketplaceDetails> {
     ...
     */
    public LiftrBaseMarketplaceDetails withMarketplaceSubscriptionId(String marketplaceSubscriptionId) {
     ...
     * @return the LiftrBaseMarketplaceDetails object itself.
     */
    public LiftrBaseMarketplaceDetails withPlanId(String planId) {
        this.planId = planId;
        return this;
    }
     ...
     * @return the LiftrBaseMarketplaceDetails object itself.
     */
    public LiftrBaseMarketplaceDetails withOfferId(String offerId) {
     ...
     * @return the LiftrBaseMarketplaceDetails object itself.
     */
    public LiftrBaseMarketplaceDetails withPublisherId(String publisherId) {
     ...
     * @return the LiftrBaseMarketplaceDetails object itself.
     */
    public LiftrBaseMarketplaceDetails withTermUnit(String termUnit) {
        ...
        if (planId() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property planId in model LiftrBaseMarketplaceDetails"));
        }
        if (offerId() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property offerId in model LiftrBaseMarketplaceDetails"));
        }
    }
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("planId".equals(fieldName)) {
                    deserializedLiftrBaseMarketplaceDetails.planId = reader.getString();
                } else if ("offerId".equals(fieldName)) {
                    deserializedLiftrBaseMarketplaceDetails.offerId = reader.getString();
                } else if ("marketplaceSubscriptionId".equals(fieldName)) {
                    deserializedLiftrBaseMarketplaceDetails.marketplaceSubscriptionId = reader.getString();
                } else if ("publisherId".equals(fieldName)) {
                    deserializedLiftrBaseMarketplaceDetails.publisherId = reader.getString();
                } else if ("termUnit".equals(fieldName)) {
                    deserializedLiftrBaseMarketplaceDetails.termUnit = reader.getString();
                } else if ("marketplaceSubscriptionStatus".equals(fieldName)) {
                    deserializedLiftrBaseMarketplaceDetails.marketplaceSubscriptionStatus
