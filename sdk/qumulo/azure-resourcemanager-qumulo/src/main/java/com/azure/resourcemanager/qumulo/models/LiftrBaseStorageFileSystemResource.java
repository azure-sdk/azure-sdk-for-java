...
/**
 * An immutable client-side representation of LiftrBaseStorageFileSystemResource.
 */
public interface LiftrBaseStorageFileSystemResource {
    /**
     ...
     */
    LiftrBaseMarketplaceDetails marketplaceDetails();
     ...
     */
    LiftrBaseUserDetails userDetails();
    ...
    /**
     * Gets the inner com.azure.resourcemanager.qumulo.fluent.models.LiftrBaseStorageFileSystemResourceInner object.
     * 
     * @return the inner object.
     */
    LiftrBaseStorageFileSystemResourceInner innerModel();

    /**
     * The entirety of the LiftrBaseStorageFileSystemResource definition.
     */
    ...
    /**
     * The LiftrBaseStorageFileSystemResource definition stages.
     */
    interface DefinitionStages {
        /**
         * The first stage of the LiftrBaseStorageFileSystemResource definition.
         */
        interface Blank extends WithLocation {
        }

        /**
         * The stage of the LiftrBaseStorageFileSystemResource definition allowing to specify location.
         */
        ...
        /**
         * The stage of the LiftrBaseStorageFileSystemResource definition allowing to specify parent resource.
         */
        ...
        /**
         * The stage of the LiftrBaseStorageFileSystemResource definition which contains all the minimum required
        ...
        interface WithCreate extends DefinitionStages.WithTags, DefinitionStages.WithIdentity,
             ...
             */
            LiftrBaseStorageFileSystemResource create();
             ...
             * @return the created resource.
             */
            LiftrBaseStorageFileSystemResource create(Context context);
        }

        /**
         * The stage of the LiftrBaseStorageFileSystemResource definition allowing to specify tags.
         */
        interface WithTags {
            /**
        ...
        /**
         * The stage of the LiftrBaseStorageFileSystemResource definition allowing to specify identity.
         */
        ...
        /**
         * The stage of the LiftrBaseStorageFileSystemResource definition allowing to specify marketplaceDetails.
         */
        interface WithMarketplaceDetails {
             ...
             * @return the next definition stage.
             */
            WithCreate withMarketplaceDetails(LiftrBaseMarketplaceDetails marketplaceDetails);
        }

        /**
         * The stage of the LiftrBaseStorageFileSystemResource definition allowing to specify storageSku.
         */
        ...
        /**
         * The stage of the LiftrBaseStorageFileSystemResource definition allowing to specify userDetails.
         */
        interface WithUserDetails {
             ...
             * @return the next definition stage.
             */
            WithCreate withUserDetails(LiftrBaseUserDetails userDetails);
        }

        /**
         * The stage of the LiftrBaseStorageFileSystemResource definition allowing to specify delegatedSubnetId.
         */
        ...
        /**
         * The stage of the LiftrBaseStorageFileSystemResource definition allowing to specify clusterLoginUrl.
         */
        ...
        /**
         * The stage of the LiftrBaseStorageFileSystemResource definition allowing to specify privateIPs.
         */
        ...
        /**
         * The stage of the LiftrBaseStorageFileSystemResource definition allowing to specify adminPassword.
         */
        ...
        /**
         * The stage of the LiftrBaseStorageFileSystemResource definition allowing to specify availabilityZone.
         */
    ...
    /**
     * Begins update for the LiftrBaseStorageFileSystemResource resource.
     * 
     * @return the stage of resource update.
     */
    LiftrBaseStorageFileSystemResource.Update update();

    /**
     * The template for LiftrBaseStorageFileSystemResource update.
     */
    interface Update extends UpdateStages.WithTags, UpdateStages.WithIdentity, UpdateStages.WithProperties {
         ...
         */
        LiftrBaseStorageFileSystemResource apply();
         ...
         * @return the updated resource.
         */
        LiftrBaseStorageFileSystemResource apply(Context context);
    }

    /**
     * The LiftrBaseStorageFileSystemResource update stages.
     */
    interface UpdateStages {
        /**
         * The stage of the LiftrBaseStorageFileSystemResource update allowing to specify tags.
         */
        interface WithTags {
            /**
             * Specifies the tags property: Resource tags..
        ...
        /**
         * The stage of the LiftrBaseStorageFileSystemResource update allowing to specify identity.
         */
        interface WithIdentity {
            /**
             * Specifies the identity property: The managed service identities assigned to this resource..
        ...
        /**
         * The stage of the LiftrBaseStorageFileSystemResource update allowing to specify properties.
         */
        interface WithProperties {
             ...
             * @return the next definition stage.
             */
            Update withProperties(LiftrBaseStorageFileSystemResourceUpdateProperties properties);
        }
    }
     ...
     */
    LiftrBaseStorageFileSystemResource refresh();
     ...
     * @return the refreshed resource.
     */
    LiftrBaseStorageFileSystemResource refresh(Context context);
}
