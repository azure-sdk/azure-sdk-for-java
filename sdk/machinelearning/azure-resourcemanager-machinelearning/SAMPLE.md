...
public final class ConnectionCreateOrUpdateDeploymentSamples {
     ...
     * x-ms-original-file:
     * specification/machinelearningservices/resource-manager/Microsoft.MachineLearningServices/stable/2024-04-01/
     * examples/WorkspaceConnection/createDeployment.json
     */
    /**
...
public final class ConnectionDeleteDeploymentSamples {
     ...
     * x-ms-original-file:
     * specification/machinelearningservices/resource-manager/Microsoft.MachineLearningServices/stable/2024-04-01/
     * examples/WorkspaceConnection/deleteDeployment.json
     */
    /**
...
public final class ConnectionGetDeploymentSamples {
     ...
     * x-ms-original-file:
     * specification/machinelearningservices/resource-manager/Microsoft.MachineLearningServices/stable/2024-04-01/
     * examples/WorkspaceConnection/getDeployment.json
     */
    /**
...
public final class ConnectionGetModelsSamples {
     ...
     * x-ms-original-file:
     * specification/machinelearningservices/resource-manager/Microsoft.MachineLearningServices/stable/2024-04-01/
     * examples/WorkspaceConnection/getModels.json
     */
    /**
...
public final class ConnectionListDeploymentsSamples {
     ...
     * x-ms-original-file:
     * specification/machinelearningservices/resource-manager/Microsoft.MachineLearningServices/stable/2024-04-01/
     * examples/WorkspaceConnection/listDeployments.json
     */
    /**
...
public final class ConnectionRaiBlocklistItemCreateSamples {
     ...
     * x-ms-original-file:
     * specification/machinelearningservices/resource-manager/Microsoft.MachineLearningServices/stable/2024-04-01/
     * examples/WorkspaceConnection/RaiBlocklistItem/create.json
     */
    /**
    ...
    public static void
        ...
        manager.connectionRaiBlocklistItems().define("raiBlocklistItemName")
...
public final class ConnectionRaiBlocklistItemDeleteSamples {
     ...
     * x-ms-original-file:
     * specification/machinelearningservices/resource-manager/Microsoft.MachineLearningServices/stable/2024-04-01/
     * examples/WorkspaceConnection/RaiBlocklistItem/delete.json
     */
    /**
    ...
    public static void
        ...
        manager.connectionRaiBlocklistItems().delete("test-rg", "aml-workspace-name", "testConnection",
...
public final class ConnectionRaiBlocklistItemsOperationListSamples {
     ...
     * x-ms-original-file:
     * specification/machinelearningservices/resource-manager/Microsoft.MachineLearningServices/stable/2024-04-01/
     * examples/WorkspaceConnection/RaiBlocklistItem/list.json
     */
    /**
    ...
    public static void listRaiBlocklistItems(com.azure.resourcemanager.machinelearning.MachineLearningManager manager) {
        manager.connectionRaiBlocklistItemsOperations().list("test-rg", "aml-workspace-name", "testConnection",
            "raiBlocklistName", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class ConnectionRaiBlocklistOperationCreateSamples {
     ...
     * x-ms-original-file:
     * specification/machinelearningservices/resource-manager/Microsoft.MachineLearningServices/stable/2024-04-01/
     * examples/WorkspaceConnection/RaiBlocklist/create.json
     */
    /**
    ...
    public static void createRaiBlocklist(com.azure.resourcemanager.machinelearning.MachineLearningManager manager) {
        manager.connectionRaiBlocklistOperations().define("raiBlocklistName")
...
public final class ConnectionRaiBlocklistsListSamples {
     ...
     * x-ms-original-file:
     * specification/machinelearningservices/resource-manager/Microsoft.MachineLearningServices/stable/2024-04-01/
     * examples/WorkspaceConnection/RaiBlocklist/list.json
     */
    /**
    ...
    public static void listRaiBlocklist(com.azure.resourcemanager.machinelearning.MachineLearningManager manager) {
        manager.connectionRaiBlocklists().list("test-rg", "aml-workspace-name", "testConnection",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class ConnectionRaiPoliciesListSamples {
     ...
     * x-ms-original-file:
     * specification/machinelearningservices/resource-manager/Microsoft.MachineLearningServices/stable/2024-04-01/
     * examples/WorkspaceConnection/RaiPolicy/list.json
     */
    /**
...
public final class ConnectionRaiPolicyOperationCreateSamples {
     ...
     * x-ms-original-file:
     * specification/machinelearningservices/resource-manager/Microsoft.MachineLearningServices/stable/2024-04-01/
     * examples/WorkspaceConnection/RaiPolicy/create.json
     */
    /**
...
public final class ConnectionRaiPolicyOperationGetSamples {
     ...
     * x-ms-original-file:
     * specification/machinelearningservices/resource-manager/Microsoft.MachineLearningServices/stable/2024-04-01/
     * examples/WorkspaceConnection/RaiPolicy/get.json
     */
    /**
...
public final class JobsCreateOrUpdateSamples {
    ...
    public static void createOrUpdateAutoMLJob(com.azure.resourcemanager.machinelearning.MachineLearningManager manager)
        ...
        manager.jobs().define("string").withExistingWorkspace("test-rg", "my-aml-workspace")
            .withProperties(new AutoMLJob().withDescription("string").withProperties(mapOf("string", "string"))
                .withTags(mapOf("string", "string")).withComputeId("string").withDisplayName("string")
                .withExperimentName("string").withIdentity(new AmlToken()).withIsArchived(false)
                ...
                .withOutputs(mapOf("string",
                    new UriFileJobOutput().withDescription("string").withMode(OutputDeliveryMode.READ_WRITE_MOUNT)
                        .withUri("string")))
    ...
    public static void createOrUpdateSweepJob(com.azure.resourcemanager.machinelearning.MachineLearningManager manager)
        throws IOException {
        manager.jobs().define("string").withExistingWorkspace("test-rg", "my-aml-workspace")
            .withProperties(new SweepJob().withDescription("string").withProperties(mapOf("string", "string"))
                .withTags(mapOf("string", "string")).withComputeId("string").withDisplayName("string")
                ...
                .withLimits(new SweepJobLimits().withMaxConcurrentTrials(1).withMaxTotalTrials(1)
                ...
                .withTrial(new TrialComponent().withCodeId("fakeTokenPlaceholder").withCommand("string")
                    .withDistribution(new Mpi().withProcessCountPerInstance(1)).withEnvironmentId("string")
    ...
    public static void createOrUpdateCommandJob(
        ...
        manager.jobs().define("string").withExistingWorkspace("test-rg", "my-aml-workspace")
            .withProperties(new CommandJob().withDescription("string").withProperties(mapOf("string", "string"))
                .withTags(mapOf("string", "string")).withComputeId("string").withDisplayName("string")
                .withExperimentName("string").withIdentity(new AmlToken())
                .withServices(mapOf("string",
                    new JobService().withEndpoint("string").withJobServiceType("string").withPort(1)
                        .withProperties(mapOf("string", "string"))))
...
public final class MarketplaceSubscriptionsListSamples {
    ...
    public static void
        ...
        manager.marketplaceSubscriptions().list(null, null, null, com.azure.core.util.Context.NONE);
    }
}
```
...
public final class ServerlessEndpointsListSamples {
    ...
    public static void
        ...
        manager.serverlessEndpoints().list(null, null, null, com.azure.core.util.Context.NONE);
    }
}
```
    ...
    public static void diagnoseWorkspace(com.azure.resourcemanager.machinelearning.MachineLearningManager manager) {
        manager.workspaces().diagnose("workspace-1234", "testworkspace",
            new DiagnoseWorkspaceParameters()
                .withValue(new DiagnoseRequestProperties().withUdr(mapOf()).withNsg(mapOf()).withResourceLock(mapOf())
                    .withDnsResolution(mapOf()).withStorageAccount(mapOf()).withKeyVault(mapOf())
                    .withContainerRegistry(mapOf()).withApplicationInsights(mapOf()).withOthers(mapOf())),
            com.azure.core.util.Context.NONE);
    }
