...
public final class JobsListSamples {
    ...
    public static void listCommandJob(com.azure.resourcemanager.machinelearning.MachineLearningManager manager) {
        manager.jobs().list("test-rg", "my-aml-workspace", null, "string", "string", ListViewType.ACTIVE_ONLY, "string",
            false, "string", null, com.azure.core.util.Context.NONE);
    }
    ...
    public static void listAutoMLJob(com.azure.resourcemanager.machinelearning.MachineLearningManager manager) {
        manager.jobs().list("test-rg", "my-aml-workspace", null, "string", "string", ListViewType.ALL, "string", false,
            "string", null, com.azure.core.util.Context.NONE);
    }
}
