...
public final class ManagedNetworkSettingsRuleCreateOrUpdateSamples {
    ...
    public static void createOrUpdateManagedNetworkSettingsRule(
        ...
        manager.managedNetworkSettingsRules().define("some_string")
            .withExistingWorkspace("test-rg", "aml-workspace-name").withProperties(new FqdnOutboundRule()
                .withCategory(RuleCategory.USER_DEFINED).withStatus(RuleStatus.ACTIVE).withDestination("some_string"))
            .create();
    }
}
