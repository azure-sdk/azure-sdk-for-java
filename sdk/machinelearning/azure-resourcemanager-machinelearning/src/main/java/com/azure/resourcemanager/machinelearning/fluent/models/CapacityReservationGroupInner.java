...
/**
 * The CapacityReservationGroup model.
 */
@Fluent
public final class CapacityReservationGroupInner extends Resource {
    ...
    private CapacityReservationGroupProperties properties;
     ...
     */
    public CapacityReservationGroupInner withIdentity(ManagedServiceIdentity identity) {
     ...
     * @return the CapacityReservationGroupInner object itself.
     */
    public CapacityReservationGroupInner withKind(String kind) {
        this.kind = kind;
        return this;
    }
     ...
     * @return the CapacityReservationGroupInner object itself.
     */
    public CapacityReservationGroupInner withProperties(CapacityReservationGroupProperties properties) {
     ...
     * @return the CapacityReservationGroupInner object itself.
     */
    public CapacityReservationGroupInner withSku(Sku sku) {
        this.sku = sku;
        return this;
    }
    ...
    public void validate() {
        ...
        if (properties() == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
                "Missing required property properties in model CapacityReservationGroupInner"));
        } else {
            properties().validate();
        }
        if (sku() != null) {
    ...
    private static final ClientLogger LOGGER = new ClientLogger(CapacityReservationGroupInner.class);
}
