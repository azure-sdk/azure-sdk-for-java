...
public final class RegistryDataReferencesClientImpl implements RegistryDataReferencesClient {
    ...
    RegistryDataReferencesClientImpl(AzureMachineLearningServicesImpl client) {
        this.service =
            RestProxy
                .create(RegistryDataReferencesService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }
    ...
    public interface RegistryDataReferencesService {
        ...
        Mono<Response<GetBlobReferenceSasResponseDtoInner>> getBlobReferenceSas(
            ...
            @BodyParam("application/json") GetBlobReferenceSasRequestDto body,
     ...
     * @return blob reference SAS Uri value along with {@link Response} on successful completion of {@link Mono}.
     */
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return blob reference SAS Uri value on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<GetBlobReferenceSasResponseDtoInner> getBlobReferenceSasAsync(
        String resourceGroupName,
        String registryName,
        String name,
        String version,
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return blob reference SAS Uri value along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<GetBlobReferenceSasResponseDtoInner> getBlobReferenceSasWithResponse(
        String resourceGroupName,
        String registryName,
        String name,
        String version,
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return blob reference SAS Uri value.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public GetBlobReferenceSasResponseDtoInner getBlobReferenceSas(
        String resourceGroupName,
        String registryName,
        String name,
        String version,
