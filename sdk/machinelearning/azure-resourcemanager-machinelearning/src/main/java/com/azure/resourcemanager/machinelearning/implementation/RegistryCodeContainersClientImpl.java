...
public final class RegistryCodeContainersClientImpl implements RegistryCodeContainersClient {
    ...
    RegistryCodeContainersClientImpl(AzureMachineLearningServicesImpl client) {
        this.service =
            RestProxy
                .create(RegistryCodeContainersService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }
    ...
    private interface RegistryCodeContainersService {
        @Headers({"Content-Type: application/json"})
        @Get(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers"
                + "/Microsoft.MachineLearningServices/registries/{registryName}/codes")
        ...
        @Delete(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers"
                + "/Microsoft.MachineLearningServices/registries/{registryName}/codes/{codeName}")
    ...
    private Mono<Response<Flux<ByteBuffer>>> deleteWithResponseAsync(
        String resourceGroupName, String registryName, String codeName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(
        String resourceGroupName, String registryName, String codeName) {
        return beginDeleteAsync(resourceGroupName, registryName, codeName).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(
        String resourceGroupName, String registryName, String codeName, Context context) {
        return beginDeleteAsync(resourceGroupName, registryName, codeName, context).getSyncPoller();
    }
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String registryName, String codeName) {
        return beginDeleteAsync(resourceGroupName, registryName, codeName)
            .last()
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String registryName, String codeName, Context context) {
        return beginDeleteAsync(resourceGroupName, registryName, codeName, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    public CodeContainerInner get(String resourceGroupName, String registryName, String codeName) {
        return getAsync(resourceGroupName, registryName, codeName).block();
    }
    ...
    private PollerFlux<PollResult<CodeContainerInner>, CodeContainerInner> beginCreateOrUpdateAsync(
        ...
        return this
            .client
            .<CodeContainerInner, CodeContainerInner>getLroResult(
                mono,
                this.client.getHttpPipeline(),
                CodeContainerInner.class,
                CodeContainerInner.class,
    ...
    private PollerFlux<PollResult<CodeContainerInner>, CodeContainerInner> beginCreateOrUpdateAsync(
        ...
        return this
            .client
            .<CodeContainerInner, CodeContainerInner>getLroResult(
                mono, this.client.getHttpPipeline(), CodeContainerInner.class, CodeContainerInner.class, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<CodeContainerInner>, CodeContainerInner> beginCreateOrUpdate(
        String resourceGroupName, String registryName, String codeName, CodeContainerInner body) {
        return beginCreateOrUpdateAsync(resourceGroupName, registryName, codeName, body).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<CodeContainerInner>, CodeContainerInner> beginCreateOrUpdate(
        String resourceGroupName, String registryName, String codeName, CodeContainerInner body, Context context) {
        return beginCreateOrUpdateAsync(resourceGroupName, registryName, codeName, body, context).getSyncPoller();
    }
    ...
    private Mono<CodeContainerInner> createOrUpdateAsync(
        String resourceGroupName, String registryName, String codeName, CodeContainerInner body) {
        return beginCreateOrUpdateAsync(resourceGroupName, registryName, codeName, body)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<CodeContainerInner> createOrUpdateAsync(
        String resourceGroupName, String registryName, String codeName, CodeContainerInner body, Context context) {
        return beginCreateOrUpdateAsync(resourceGroupName, registryName, codeName, body, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
