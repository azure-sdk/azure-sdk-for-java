...
public final class RegistryDataVersionsImpl implements RegistryDataVersions {
    ...
    public Response<PendingUploadResponseDto> createOrGetPendingUploadWithResponse(
        ...
        Response<PendingUploadResponseDtoInner> inner =
            this
                .serviceClient()
                .createOrGetPendingUploadWithResponse(resourceGroupName, registryName, name, version, body, context);
        if (inner != null) {
            return new SimpleResponse<>(
                inner.getRequest(),
                inner.getStatusCode(),
    ...
    public PendingUploadResponseDto createOrGetPendingUpload(
        ...
        PendingUploadResponseDtoInner inner =
            this.serviceClient().createOrGetPendingUpload(resourceGroupName, registryName, name, version, body);
        if (inner != null) {
