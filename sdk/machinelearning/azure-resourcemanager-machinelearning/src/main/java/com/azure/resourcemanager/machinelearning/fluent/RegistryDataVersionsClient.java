...
public interface RegistryDataVersionsClient {
    ...
    PagedIterable<DataVersionBaseInner> list(String resourceGroupName, String registryName, String name);
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<DataVersionBaseInner>, DataVersionBaseInner> beginCreateOrUpdate(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<BlobReferenceSasResponseDtoInner> getBlobReferenceSasWithResponse(
        String resourceGroupName,
        String registryName,
        String name,
        String version,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    BlobReferenceSasResponseDtoInner getBlobReferenceSas(
