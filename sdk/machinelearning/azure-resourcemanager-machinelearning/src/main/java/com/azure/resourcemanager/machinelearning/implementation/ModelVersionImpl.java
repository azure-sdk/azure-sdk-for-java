...
public final class ModelVersionImpl implements ModelVersion, ModelVersion.Definition, ModelVersion.Update {
    ...
    public ModelVersion create() {
        this.innerObject = serviceManager.serviceClient().getRegistryModelVersions().createOrUpdate(resourceGroupName,
            registryName, modelName, version, this.innerModel(), Context.NONE);
        return this;
    }

    public ModelVersion create(Context context) {
        this.innerObject = serviceManager.serviceClient().getRegistryModelVersions().createOrUpdate(resourceGroupName,
            registryName, modelName, version, this.innerModel(), context);
        return this;
    }
    ...
    public ModelVersion refresh() {
        this.innerObject = serviceManager.serviceClient().getRegistryModelVersions()
            .getWithResponse(resourceGroupName, registryName, modelName, version, Context.NONE).getValue();
        return this;
    }

    public ModelVersion refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getRegistryModelVersions()
            .getWithResponse(resourceGroupName, registryName, modelName, version, context).getValue();
        return this;
    }

    public PackageResponse packageMethod(PackageRequest body) {
        return serviceManager.registryModelVersions().packageMethod(resourceGroupName, registryName, modelName, version,
            body);
    }
    ...
    public Response<PendingUploadResponseDto> createOrGetStartPendingUploadWithResponse(PendingUploadRequestDto body,
        Context context) {
        return serviceManager.registryModelVersions().createOrGetStartPendingUploadWithResponse(resourceGroupName,
            registryName, modelName, version, body, context);
    }

    public PendingUploadResponseDto createOrGetStartPendingUpload(PendingUploadRequestDto body) {
        return serviceManager.registryModelVersions().createOrGetStartPendingUpload(resourceGroupName, registryName,
            modelName, version, body);
    }
