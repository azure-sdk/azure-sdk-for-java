...
public final class LabelingJobProperties extends JobBaseProperties {
    ...
    /** {@inheritDoc} */
    @Override
    public LabelingJobProperties withNotificationSetting(NotificationSetting notificationSetting) {
    ...
    /** {@inheritDoc} */
    @Override
    public LabelingJobProperties withSecretsConfiguration(Map<String, SecretConfiguration> secretsConfiguration) {
