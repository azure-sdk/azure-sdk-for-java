...
public final class WorkspaceUpdateParametersInner {
    ...
    /**
     * Get the enableSoftwareBillOfMaterials property: Flag to tell if SoftwareBillOfMaterial should be enabled for this
     * workspace.
     * 
    ...
    /**
     * Set the enableSoftwareBillOfMaterials property: Flag to tell if SoftwareBillOfMaterial should be enabled for this
     * workspace.
     * 
