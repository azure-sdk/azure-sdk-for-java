...
public final class WorkspaceUpdateParametersInner {
     ...
     * @return the WorkspaceUpdateParametersInner object itself.
     */
    public WorkspaceUpdateParametersInner withServerlessComputeCustomSubnet(String serverlessComputeCustomSubnet) {
        if (this.innerProperties() == null) {
            this.innerProperties = new WorkspacePropertiesUpdateParametersInner();
        }
     ...
     * @return the WorkspaceUpdateParametersInner object itself.
     */
    public WorkspaceUpdateParametersInner withServerlessComputeNoPublicIp(Boolean serverlessComputeNoPublicIp) {
        if (this.innerProperties() == null) {
            this.innerProperties = new WorkspacePropertiesUpdateParametersInner();
        }
     ...
     * @return the WorkspaceUpdateParametersInner object itself.
     */
    public WorkspaceUpdateParametersInner withServiceManagedResourcesSettings(
