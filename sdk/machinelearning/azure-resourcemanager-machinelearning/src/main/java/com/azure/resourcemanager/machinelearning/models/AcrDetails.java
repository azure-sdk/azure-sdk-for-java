...
public final class AcrDetails {
    ...
    /*
     * Details of user created ACR account to be used for the Registry. Not supported in most cases and will throw 400
     * error if provided.
     */
    ...
    /**
     * Get the userCreatedAcrAccount property: Details of user created ACR account to be used for the Registry. Not
     * supported in most cases and will throw 400 error if provided.
     *
    ...
    /**
     * Set the userCreatedAcrAccount property: Details of user created ACR account to be used for the Registry. Not
     * supported in most cases and will throw 400 error if provided.
     *
