...
public interface FeaturesetVersionsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<FeaturesetVersionInner> list(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<FeaturesetVersionInner> getWithResponse(
        String resourceGroupName, String workspaceName, String name, String version, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<FeaturesetVersionInner>, FeaturesetVersionInner> beginCreateOrUpdate(
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<FeaturesetJobInner>, FeaturesetJobInner> beginBackfill(
        String resourceGroupName,
        String workspaceName,
        String name,
        String version,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<FeatureInner> getFeatureWithResponse(
        String resourceGroupName,
        String workspaceName,
        String name,
        String version,
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<FeatureInner> listFeatures(
        String resourceGroupName, String workspaceName, String name, String version);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<FeaturesetJobInner> listMaterializationJobs(
        String resourceGroupName, String workspaceName, String name, String version);
