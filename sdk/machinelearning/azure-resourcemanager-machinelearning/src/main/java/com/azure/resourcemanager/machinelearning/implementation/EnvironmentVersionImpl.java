...
public final class EnvironmentVersionImpl
    ...
    public EnvironmentVersion create() {
        this.innerObject = serviceManager.serviceClient().getRegistryEnvironmentVersions()
    ...
    public EnvironmentVersion refresh() {
        this.innerObject = serviceManager.serviceClient().getRegistryEnvironmentVersions()
            .getWithResponse(resourceGroupName, registryName, environmentName, version, Context.NONE).getValue();
        return this;
    }

    public EnvironmentVersion refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getRegistryEnvironmentVersions()
            .getWithResponse(resourceGroupName, registryName, environmentName, version, context).getValue();
        return this;
    }
