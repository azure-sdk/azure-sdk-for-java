...
public final class PoolStatusInner {
    ...
    /*
     * Gets or sets event log for inference pool.
     */
    ...
    /**
     * Get the eventLog property: Gets or sets event log for inference pool.
     *
    ...
    /**
     * Set the eventLog property: Gets or sets event log for inference pool.
     *
     * @param eventLog the eventLog value to set.
     * @return the PoolStatusInner object itself.
     */
    public PoolStatusInner withEventLog(List<Object> eventLog) {
