...
public final class RegistryEnvironmentVersionsClientImpl implements RegistryEnvironmentVersionsClient {
    ...
    private interface RegistryEnvironmentVersionsService {
        ...
        @Delete(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers"
                + "/Microsoft.MachineLearningServices/registries/{registryName}/environments/{environmentName}/versions"
                + "/{version}")
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(
        String resourceGroupName, String registryName, String environmentName, String version) {
        return beginDeleteAsync(resourceGroupName, registryName, environmentName, version).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(
        String resourceGroupName, String registryName, String environmentName, String version, Context context) {
        return beginDeleteAsync(resourceGroupName, registryName, environmentName, version, context).getSyncPoller();
    }
    ...
    public EnvironmentVersionInner get(
        String resourceGroupName, String registryName, String environmentName, String version) {
        return getAsync(resourceGroupName, registryName, environmentName, version).block();
    }
