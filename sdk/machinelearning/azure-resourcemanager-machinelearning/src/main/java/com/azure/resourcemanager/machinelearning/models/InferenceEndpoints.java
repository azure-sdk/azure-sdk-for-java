...
public interface InferenceEndpoints {
     ...
     */
    PagedIterable<InferenceEndpointMinimalTrackedResource> list(
     ...
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     */
    void delete(String resourceGroupName, String workspaceName, String poolName, String groupName, String name);
     ...
     */
    Response<InferenceEndpointMinimalTrackedResource> getWithResponse(
        String resourceGroupName,
        String workspaceName,
        String poolName,
        String groupName,
     ...
     */
    InferenceEndpointMinimalTrackedResource get(
     ...
     * @return inferenceEndpoint along with {@link Response}.
     */
    InferenceEndpointMinimalTrackedResource getById(String id);
     ...
     * @return inferenceEndpoint along with {@link Response}.
     */
    Response<InferenceEndpointMinimalTrackedResource> getByIdWithResponse(String id, Context context);
    ...
    /**
     * Begins definition for a new InferenceEndpointMinimalTrackedResource resource.
     *
     * @param name resource name.
     * @return the first stage of the new InferenceEndpointMinimalTrackedResource definition.
     */
    InferenceEndpointMinimalTrackedResource.DefinitionStages.Blank define(String name);
}
