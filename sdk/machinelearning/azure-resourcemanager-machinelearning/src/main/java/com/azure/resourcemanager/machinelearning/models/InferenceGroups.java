...
public interface InferenceGroups {
     ...
     */
    PagedIterable<InferenceGroupMinimalTrackedResourceWithSku> list(
     ...
     */
    Response<InferenceGroupMinimalTrackedResourceWithSku> getWithResponse(
     ...
     */
    InferenceGroupMinimalTrackedResourceWithSku get(
     ...
     */
    PagedIterable<SkuResource> listSkus(String resourceGroupName, String workspaceName, String poolName, String name);
     ...
     */
    Response<GroupStatus> getStatusWithResponse(
        String resourceGroupName, String workspaceName, String poolName, String name, Context context);
     ...
     * @return the response.
     */
    GroupStatus getStatus(String resourceGroupName, String workspaceName, String poolName, String name);
     ...
     * @return inferenceGroup along with {@link Response}.
     */
    InferenceGroupMinimalTrackedResourceWithSku getById(String id);
     ...
     * @return inferenceGroup along with {@link Response}.
     */
    Response<InferenceGroupMinimalTrackedResourceWithSku> getByIdWithResponse(String id, Context context);
    ...
    /**
     * Begins definition for a new InferenceGroupMinimalTrackedResourceWithSku resource.
     *
     * @param name resource name.
     * @return the first stage of the new InferenceGroupMinimalTrackedResourceWithSku definition.
     */
    InferenceGroupMinimalTrackedResourceWithSku.DefinitionStages.Blank define(String name);
}
