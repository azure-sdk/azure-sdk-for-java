...
public final class DataContainerImpl implements DataContainer, DataContainer.Definition, DataContainer.Update {
    ...
    public DataContainer create() {
        this.innerObject = serviceManager.serviceClient().getRegistryDataContainers().createOrUpdate(resourceGroupName,
            registryName, name, this.innerModel(), Context.NONE);
        return this;
    }

    public DataContainer create(Context context) {
        this.innerObject = serviceManager.serviceClient().getRegistryDataContainers().createOrUpdate(resourceGroupName,
            registryName, name, this.innerModel(), context);
        return this;
    }
    ...
    public DataContainer refresh() {
        this.innerObject = serviceManager.serviceClient().getRegistryDataContainers()
            .getWithResponse(resourceGroupName, registryName, name, Context.NONE).getValue();
        return this;
    }

    public DataContainer refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getRegistryDataContainers()
            .getWithResponse(resourceGroupName, registryName, name, context).getValue();
        return this;
    }
