...
public final class SchedulesClientImpl implements SchedulesClient {
    ...
    /**
     * The interface defining all the services for AzureMachineLearningServicesSchedules to be used by the proxy
    ...
    public interface SchedulesService {
        ...
        @Headers({ "Content-Type: application/json" })
        @Post("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/schedules/{name}/trigger")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<TriggerRunSubmissionDtoInner>> trigger(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("workspaceName") String workspaceName,
            @PathParam("name") String name, @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") TriggerOnceRequest body, @HeaderParam("Accept") String accept,
            Context context);
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<ScheduleInner>> listSinglePageAsync(String resourceGroupName, String workspaceName,
        String skip, ScheduleListViewType listViewType, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    private PagedFlux<ScheduleInner> listAsync(String resourceGroupName, String workspaceName, String skip,
        ...
        return new PagedFlux<>(() -> listSinglePageAsync(resourceGroupName, workspaceName, skip, listViewType, context),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<TriggerRunSubmissionDtoInner>> triggerWithResponseAsync(String resourceGroupName,
        String workspaceName, String name, TriggerOnceRequest body) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.trigger(this.client.getEndpoint(), this.client.getSubscriptionId(),
                resourceGroupName, workspaceName, name, this.client.getApiVersion(), body, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<TriggerRunSubmissionDtoInner>> triggerWithResponseAsync(String resourceGroupName,
        String workspaceName, String name, TriggerOnceRequest body, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.trigger(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            workspaceName, name, this.client.getApiVersion(), body, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<TriggerRunSubmissionDtoInner> triggerAsync(String resourceGroupName, String workspaceName, String name,
        TriggerOnceRequest body) {
        return triggerWithResponseAsync(resourceGroupName, workspaceName, name, body)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<TriggerRunSubmissionDtoInner> triggerWithResponse(String resourceGroupName, String workspaceName,
        String name, TriggerOnceRequest body, Context context) {
        return triggerWithResponseAsync(resourceGroupName, workspaceName, name, body, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public TriggerRunSubmissionDtoInner trigger(String resourceGroupName, String workspaceName, String name,
        TriggerOnceRequest body) {
        return triggerWithResponse(resourceGroupName, workspaceName, name, body, Context.NONE).getValue();
    }
