 ...
 */
@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, property = "format", defaultImpl = CsvExportSummary.class, visible = true)
@JsonTypeName("CSV")
@Immutable
public final class CsvExportSummary extends ExportSummaryInner {
    ...
    private ExportFormatType format = ExportFormatType.CSV;
