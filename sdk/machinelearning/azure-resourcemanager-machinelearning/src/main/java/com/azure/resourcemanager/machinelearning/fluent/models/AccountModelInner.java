...
public final class AccountModelInner extends DeploymentModel {
     ...
     */
    @JsonProperty(value = "connectionIds")
    ...
    /**
     * Get the connectionIds property: The list of connection ids.
     * 
    ...
    /**
     * Set the connectionIds property: The list of connection ids.
     * 
     * @param connectionIds the connectionIds value to set.
     * @return the AccountModelInner object itself.
     */
    public AccountModelInner withConnectionIds(List<String> connectionIds) {
