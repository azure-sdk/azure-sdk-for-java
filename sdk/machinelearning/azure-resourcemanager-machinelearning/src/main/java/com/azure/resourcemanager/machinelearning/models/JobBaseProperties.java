...
public class JobBaseProperties extends ResourceBase {
    ...
    /**
     * Get the parentJobName property: Parent job name.
     * 
     * @return the parentJobName value.
     */
    ...
    /**
     * Set the parentJobName property: Parent job name.
     * 
     * @param parentJobName the parentJobName value to set.
     * @return the JobBaseProperties object itself.
     */
    public JobBaseProperties withParentJobName(String parentJobName) {
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeStringField("parentJobName", this.parentJobName);
    ...
    public static JobBaseProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            try (JsonReader readerToUse = reader.bufferObject()) {
                ...
                } else if ("FineTuning".equals(discriminatorValue)) {
                    return FineTuningJob.fromJson(readerToUse.reset());
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("description".equals(fieldName)) {
                    ...
                    deserializedJobBaseProperties.parentJobName = reader.getString();
