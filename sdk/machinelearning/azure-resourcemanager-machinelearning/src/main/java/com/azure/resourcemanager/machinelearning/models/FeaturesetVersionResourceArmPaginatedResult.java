...
public final class FeaturesetVersionResourceArmPaginatedResult {
    ...
    /**
     * Get the nextLink property: The link to the next page of FeaturesetVersion objects. If null, there are no
     * additional pages.
     * 
    ...
    /**
     * Set the nextLink property: The link to the next page of FeaturesetVersion objects. If null, there are no
     * additional pages.
     * 
     * @param nextLink the nextLink value to set.
     * @return the FeaturesetVersionResourceArmPaginatedResult object itself.
     */
    public FeaturesetVersionResourceArmPaginatedResult withNextLink(String nextLink) {
