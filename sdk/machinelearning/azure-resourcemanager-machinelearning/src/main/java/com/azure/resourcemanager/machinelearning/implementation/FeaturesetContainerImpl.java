...
public final class FeaturesetContainerImpl
    ...
    public FeaturesetContainer create() {
        this.innerObject = serviceManager.serviceClient().getFeaturesetContainers().createOrUpdate(resourceGroupName,
    ...
    public FeaturesetContainer refresh() {
        this.innerObject = serviceManager.serviceClient().getFeaturesetContainers()
            .getEntityWithResponse(resourceGroupName, workspaceName, name, Context.NONE).getValue();
        return this;
    }

    public FeaturesetContainer refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getFeaturesetContainers()
            .getEntityWithResponse(resourceGroupName, workspaceName, name, context).getValue();
        return this;
    }
