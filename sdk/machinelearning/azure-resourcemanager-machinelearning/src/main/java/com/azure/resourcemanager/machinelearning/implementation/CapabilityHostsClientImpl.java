...
public final class CapabilityHostsClientImpl implements CapabilityHostsClient {
     ...
     */
    CapabilityHostsClientImpl(AzureMachineLearningServicesImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for AzureMachineLearningServicesCapabilityHosts to be used by the proxy
