...
public final class RegistryDataVersionsClientImpl implements RegistryDataVersionsClient {
    ...
    RegistryDataVersionsClientImpl(AzureMachineLearningServicesImpl client) {
        this.service =
            RestProxy
                .create(RegistryDataVersionsService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }
    ...
    public interface RegistryDataVersionsService {
        ...
        @Headers({"Content-Type: application/json"})
        @Post(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/registries/{registryName}/data/{name}/versions/{version}/getBlobReferenceSAS")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
    ...
    private PagedFlux<DataVersionBaseInner> listAsync(
        ...
        return new PagedFlux<>(
            () ->
                listSinglePageAsync(
                    resourceGroupName, registryName, name, orderBy, top, skip, tags, listViewType, context),
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String registryName, String name, String version) {
        return beginDeleteAsync(resourceGroupName, registryName, name, version)
            .last()
    ...
    private Mono<Void> deleteAsync(
        String resourceGroupName, String registryName, String name, String version, Context context) {
        return beginDeleteAsync(resourceGroupName, registryName, name, version, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private PollerFlux<PollResult<DataVersionBaseInner>, DataVersionBaseInner> beginCreateOrUpdateAsync(
        ...
        return this
            .client
            .<DataVersionBaseInner, DataVersionBaseInner>getLroResult(
                mono,
                this.client.getHttpPipeline(),
                DataVersionBaseInner.class,
                DataVersionBaseInner.class,
    ...
    private PollerFlux<PollResult<DataVersionBaseInner>, DataVersionBaseInner> beginCreateOrUpdateAsync(
        ...
        return this
            .client
            .<DataVersionBaseInner, DataVersionBaseInner>getLroResult(
                mono, this.client.getHttpPipeline(), DataVersionBaseInner.class, DataVersionBaseInner.class, context);
    }
    ...
    public SyncPoller<PollResult<DataVersionBaseInner>, DataVersionBaseInner> beginCreateOrUpdate(
        ...
        Context context) {
        return this
            .beginCreateOrUpdateAsync(resourceGroupName, registryName, name, version, body, context)
            .getSyncPoller();
    }
    ...
    private Mono<DataVersionBaseInner> createOrUpdateAsync(
        String resourceGroupName, String registryName, String name, String version, DataVersionBaseInner body) {
        return beginCreateOrUpdateAsync(resourceGroupName, registryName, name, version, body)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<DataVersionBaseInner> createOrUpdateAsync(
        ...
        DataVersionBaseInner body,
        Context context) {
        return beginCreateOrUpdateAsync(resourceGroupName, registryName, name, version, body, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    /**
     * Get a SAS for a blob reference associated with the data asset.
     *
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
     * @param registryName Name of Azure Machine Learning registry. This is case-insensitive.
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a SAS for a blob reference associated with the data asset along with {@link Response} on successful
     *     completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<BlobReferenceSasResponseDtoInner>> getBlobReferenceSasWithResponseAsync(
        String resourceGroupName, String registryName, String name, String version, BlobReferenceSasRequestDto body) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a SAS for a blob reference associated with the data asset on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a SAS for a blob reference associated with the data asset along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a SAS for a blob reference associated with the data asset.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ...
    public Response<PendingUploadResponseDtoInner> createOrGetStartPendingUploadWithResponse(
        ...
        return createOrGetStartPendingUploadWithResponseAsync(
                resourceGroupName, registryName, name, version, body, context)
            .block();
    }
    ...
    public PendingUploadResponseDtoInner createOrGetStartPendingUpload(
        ...
        return createOrGetStartPendingUploadWithResponse(
                resourceGroupName, registryName, name, version, body, Context.NONE)
            .getValue();
    }
