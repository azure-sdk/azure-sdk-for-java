...
public final class RegistryDataVersionsClientImpl implements RegistryDataVersionsClient {
    ...
    public interface RegistryDataVersionsService {
        ...
        @Headers({"Content-Type: application/json"})
        @Post(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/registries/{registryName}/data/{name}/versions/pendingUpload/{version}")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
    ...
    private Mono<PendingUploadResponseDtoInner> createOrGetPendingUploadAsync(
        String resourceGroupName, String registryName, String name, String version, PendingUploadRequestDto body) {
        return createOrGetPendingUploadWithResponseAsync(resourceGroupName, registryName, name, version, body)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
    ...
    public Response<PendingUploadResponseDtoInner> createOrGetPendingUploadWithResponse(
        ...
        PendingUploadRequestDto body,
        Context context) {
        return createOrGetPendingUploadWithResponseAsync(resourceGroupName, registryName, name, version, body, context)
            .block();
    }
    ...
    public PendingUploadResponseDtoInner createOrGetPendingUpload(
        String resourceGroupName, String registryName, String name, String version, PendingUploadRequestDto body) {
        return createOrGetPendingUploadWithResponse(resourceGroupName, registryName, name, version, body, Context.NONE)
            .getValue();
    }
