...
/**
 * An immutable client-side representation of ServerlessEndpoint.
 */
public interface ServerlessEndpoint {
    ...
    /**
     * Gets the inner com.azure.resourcemanager.machinelearning.fluent.models.ServerlessEndpointInner object.
     * 
     * @return the inner object.
     */
    ServerlessEndpointInner innerModel();
    ...
    /**
     * The ServerlessEndpoint definition stages.
     */
    interface DefinitionStages {
        /**
         * The first stage of the ServerlessEndpoint definition.
         */
        interface Blank extends WithLocation {
        }

        /**
         * The stage of the ServerlessEndpoint definition allowing to specify location.
         */
        ...
        /**
         * The stage of the ServerlessEndpoint definition allowing to specify parent resource.
         */
        ...
        /**
         * The stage of the ServerlessEndpoint definition allowing to specify properties.
         */
        interface WithProperties {
             ...
             * @return the next definition stage.
             */
            WithCreate withProperties(ServerlessEndpointProperties properties);
        }
        ...
        interface WithCreate extends DefinitionStages.WithTags, DefinitionStages.WithIdentity,
             ...
             * @return the created resource.
             */
            ServerlessEndpoint create(Context context);
        }

        /**
         * The stage of the ServerlessEndpoint definition allowing to specify tags.
         */
        interface WithTags {
            /**
        ...
        /**
         * The stage of the ServerlessEndpoint definition allowing to specify sku.
         */
        interface WithSku {
            /**
    ...
    /**
     * Begins update for the ServerlessEndpoint resource.
     * 
     * @return the stage of resource update.
     */
    ServerlessEndpoint.Update update();
    ...
    interface Update extends UpdateStages.WithTags, UpdateStages.WithIdentity, UpdateStages.WithSku {
         ...
         * @return the updated resource.
         */
        ServerlessEndpoint apply(Context context);
    }

    /**
     * The ServerlessEndpoint update stages.
     */
    interface UpdateStages {
        /**
         * The stage of the ServerlessEndpoint update allowing to specify tags.
         */
        interface WithTags {
            /**
             * Specifies the tags property: Resource tags..
     ...
     * @return the refreshed resource.
     */
    ServerlessEndpoint refresh(Context context);
     ...
     */
    Response<ServerlessEndpointStatus> getStatusWithResponse(Context context);
     ...
     * @return the response.
     */
    ServerlessEndpointStatus getStatus();
     ...
     * @return keys for endpoint authentication.
     */
    EndpointAuthKeys regenerateKeys(RegenerateEndpointKeysRequest body);
     ...
     * @return keys for endpoint authentication.
     */
    EndpointAuthKeys regenerateKeys(RegenerateEndpointKeysRequest body, Context context);
}
