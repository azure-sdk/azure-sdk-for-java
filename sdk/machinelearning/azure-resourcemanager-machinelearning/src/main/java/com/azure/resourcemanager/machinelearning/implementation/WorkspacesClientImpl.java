...
public final class WorkspacesClientImpl implements WorkspacesClient {
    ...
    public interface WorkspacesService {
        ...
        Mono<Response<WorkspaceListResult>> list(@HostParam("$host") String endpoint,
            ...
            @QueryParam("kind") String kind, @QueryParam("$skip") String skip, @HeaderParam("Accept") String accept,
            Context context);
    ...
    private Mono<PagedResponse<WorkspaceInner>> listSinglePageAsync(String kind, String skip) {
        ...
        return FluxUtil
            .withContext(context -> service.list(this.client.getEndpoint(), this.client.getSubscriptionId(),
                this.client.getApiVersion(), kind, skip, accept, context))
    ...
    private PagedFlux<WorkspaceInner> listAsync(String kind, String skip) {
        return new PagedFlux<>(() -> listSinglePageAsync(kind, skip),
    ...
    private PagedFlux<WorkspaceInner> listAsync(String kind, String skip, Context context) {
        return new PagedFlux<>(() -> listSinglePageAsync(kind, skip, context),
        ...
        return FluxUtil
            .withContext(
                context -> service.listByResourceGroup(this.client.getEndpoint(), this.client.getSubscriptionId(),
                    resourceGroupName, this.client.getApiVersion(), kind, skip, accept, context))
            .<PagedResponse<WorkspaceInner>>map(res -> new PagedResponseBase<>(res.getRequest(), res.getStatusCode(),
                res.getHeaders(), res.getValue().value(), res.getValue().nextLink(), null))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<WorkspaceInner>> listByResourceGroupSinglePageAsync(String resourceGroupName,
        String kind, String skip, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    private PagedFlux<WorkspaceInner> listByResourceGroupAsync(String resourceGroupName, String kind, String skip) {
        return new PagedFlux<>(() -> listByResourceGroupSinglePageAsync(resourceGroupName, kind, skip),
    ...
    private PagedFlux<WorkspaceInner> listByResourceGroupAsync(String resourceGroupName, String kind, String skip,
        Context context) {
        return new PagedFlux<>(() -> listByResourceGroupSinglePageAsync(resourceGroupName, kind, skip, context),
