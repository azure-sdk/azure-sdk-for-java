...
public final class UriFolderJobOutput extends JobOutput {
     ...
     */
    public UriFolderJobOutput withAssetName(String assetName) {
     ...
     * @return the UriFolderJobOutput object itself.
     */
    public UriFolderJobOutput withAssetVersion(String assetVersion) {
     ...
     * @return the UriFolderJobOutput object itself.
     */
    public UriFolderJobOutput withAutoDeleteSetting(AutoDeleteSetting autoDeleteSetting) {
     ...
     * @return the UriFolderJobOutput object itself.
     */
    public UriFolderJobOutput withPathOnCompute(String pathOnCompute) {
