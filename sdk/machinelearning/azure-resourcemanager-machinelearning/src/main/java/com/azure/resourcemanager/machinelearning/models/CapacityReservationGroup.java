...
public interface CapacityReservationGroup {
     ...
     */
    CapacityReservationGroupProperties properties();
    ...
    /**
     * Gets the inner com.azure.resourcemanager.machinelearning.fluent.models.CapacityReservationGroupInner object.
     *
    ...
    interface DefinitionStages {
        ...
        /** The stage of the CapacityReservationGroup definition allowing to specify properties. */
        interface WithProperties {
             ...
             * @return the next definition stage.
             */
            WithCreate withProperties(CapacityReservationGroupProperties properties);
        }
        ...
        /** The stage of the CapacityReservationGroup definition allowing to specify identity. */
        ...
        /** The stage of the CapacityReservationGroup definition allowing to specify kind. */
        interface WithKind {
            /**
        ...
        /** The stage of the CapacityReservationGroup definition allowing to specify sku. */
        interface WithSku {
            /**
    ...
    interface UpdateStages {
        ...
        /** The stage of the CapacityReservationGroup update allowing to specify identity. */
        interface WithIdentity {
            /**
             * Specifies the identity property: Managed service identity (system assigned and/or user assigned
             * identities).
        ...
        /** The stage of the CapacityReservationGroup update allowing to specify kind. */
        interface WithKind {
            /**
             * Specifies the kind property: Metadata used by portal/tooling/etc to render different UX experiences for
             * resources of the same type..
        ...
        /** The stage of the CapacityReservationGroup update allowing to specify properties. */
        interface WithProperties {
            /**
             * Specifies the properties property: [Required] Additional attributes of the entity..
             *
             ...
             * @return the next definition stage.
             */
            Update withProperties(CapacityReservationGroupProperties properties);
        }

        /** The stage of the CapacityReservationGroup update allowing to specify sku. */
        interface WithSku {
            /**
             * Specifies the sku property: Sku details required for ARM contract for Autoscaling..
             *
