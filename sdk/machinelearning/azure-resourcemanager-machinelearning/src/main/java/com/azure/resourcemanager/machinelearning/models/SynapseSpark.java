        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("computeLocation".equals(fieldName)) {
                    ...
                    deserializedSynapseSpark.provisioningState = ProvisioningState.fromString(reader.getString());
                } else if ("description".equals(fieldName)) {
                    deserializedSynapseSpark.withDescription(reader.getString());
                } else if ("createdOn".equals(fieldName)) {
                    deserializedSynapseSpark.createdOn = reader
                        .getNullable(nonNullReader -> CoreUtils.parseBestOffsetDateTime(nonNullReader.getString()));
                } else if ("modifiedOn".equals(fieldName)) {
                    deserializedSynapseSpark.modifiedOn = reader
                        .getNullable(nonNullReader -> CoreUtils.parseBestOffsetDateTime(nonNullReader.getString()));
                    ...
                    deserializedSynapseSpark.provisioningErrors = provisioningErrors;
                } else if ("isAttachedCompute".equals(fieldName)) {
                    deserializedSynapseSpark.isAttachedCompute = reader.getNullable(JsonReader::getBoolean);
