...
public final class InferenceEndpointImpl
    ...
    public InferenceEndpoint create() {
        this.innerObject = serviceManager.serviceClient().getInferenceEndpoints().createOrUpdate(resourceGroupName,
            workspaceName, poolName, endpointName, this.innerModel(), Context.NONE);
        return this;
    }

    public InferenceEndpoint create(Context context) {
        this.innerObject = serviceManager.serviceClient().getInferenceEndpoints().createOrUpdate(resourceGroupName,
            workspaceName, poolName, endpointName, this.innerModel(), context);
        return this;
    }
    ...
    public InferenceEndpoint refresh() {
        this.innerObject = serviceManager.serviceClient().getInferenceEndpoints()
            .getWithResponse(resourceGroupName, workspaceName, poolName, endpointName, Context.NONE).getValue();
        return this;
    }

    public InferenceEndpoint refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getInferenceEndpoints()
            .getWithResponse(resourceGroupName, workspaceName, poolName, endpointName, context).getValue();
        return this;
    }
