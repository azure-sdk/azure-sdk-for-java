...
public final class FeaturesetContainersClientImpl implements FeaturesetContainersClient {
    ...
    FeaturesetContainersClientImpl(AzureMachineLearningServicesImpl client) {
        this.service =
            RestProxy
                .create(FeaturesetContainersService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }
    ...
    public interface FeaturesetContainersService {
        ...
        @Get(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers"
                + "/Microsoft.MachineLearningServices/workspaces/{workspaceName}/featuresets")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<FeaturesetContainerResourceArmPaginatedResult>> list(
        ...
        @Delete(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers"
                + "/Microsoft.MachineLearningServices/workspaces/{workspaceName}/featuresets/{name}")
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<FeaturesetContainerInner>> getEntity(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("workspaceName") String workspaceName,
        ...
        Mono<Response<Flux<ByteBuffer>>> createOrUpdate(
            ...
            @PathParam("name") String name,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") FeaturesetContainerInner body,
            @HeaderParam("Accept") String accept,
            Context context);
    ...
    private Mono<PagedResponse<FeaturesetContainerInner>> listSinglePageAsync(
                ...
                context ->
                    service
                        .list(
                            ...
                            accept,
                            context))
            .<PagedResponse<FeaturesetContainerInner>>map(
                res ->
    ...
    private PagedFlux<FeaturesetContainerInner> listAsync(
        String resourceGroupName, String workspaceName, String skip, String tags, ListViewType listViewType) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<FeaturesetContainerInner> list(
        String resourceGroupName,
        String workspaceName,
        String skip,
        String tags,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<FeaturesetContainerInner>> getEntityWithResponseAsync(
        String resourceGroupName, String workspaceName, String name) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<FeaturesetContainerInner> getEntityWithResponse(
        String resourceGroupName, String workspaceName, String name, Context context) {
    ...
    private PollerFlux<PollResult<FeaturesetContainerInner>, FeaturesetContainerInner> beginCreateOrUpdateAsync(
        ...
        return this
            .client
            .<FeaturesetContainerInner, FeaturesetContainerInner>getLroResult(
                mono,
                this.client.getHttpPipeline(),
                FeaturesetContainerInner.class,
                FeaturesetContainerInner.class,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<FeaturesetContainerInner> createOrUpdateAsync(
        String resourceGroupName, String workspaceName, String name, FeaturesetContainerInner body) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public FeaturesetContainerInner createOrUpdate(
        String resourceGroupName, String workspaceName, String name, FeaturesetContainerInner body) {
