...
public interface FeaturesetContainers {
     ...
     */
    PagedIterable<FeaturesetContainer> list(String resourceGroupName, String workspaceName);
     ...
     * @return a paginated list of FeaturesetContainer entities as paginated response with {@link PagedIterable}.
     */
    PagedIterable<FeaturesetContainer> list(
     ...
     */
    Response<FeaturesetContainer> getEntityWithResponse(
     ...
     * @return container.
     */
    FeaturesetContainer getEntity(String resourceGroupName, String workspaceName, String name);
     ...
     * @return container along with {@link Response}.
     */
    FeaturesetContainer getEntityById(String id);
     ...
     * @return container along with {@link Response}.
     */
    Response<FeaturesetContainer> getEntityByIdWithResponse(String id, Context context);
     ...
     * @return the first stage of the new FeaturesetContainer definition.
     */
    FeaturesetContainer.DefinitionStages.Blank define(String name);
}
