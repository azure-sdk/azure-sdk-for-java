...
public final class EnvironmentContainerImpl
    ...
    public EnvironmentContainer create() {
        this.innerObject = serviceManager.serviceClient().getRegistryEnvironmentContainers()
    ...
    public EnvironmentContainer refresh() {
        this.innerObject = serviceManager.serviceClient().getRegistryEnvironmentContainers()
            .getWithResponse(resourceGroupName, registryName, environmentName, Context.NONE).getValue();
        return this;
    }

    public EnvironmentContainer refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getRegistryEnvironmentContainers()
            .getWithResponse(resourceGroupName, registryName, environmentName, context).getValue();
        return this;
    }
