...
public final class RegistryCodeVersionsClientImpl implements RegistryCodeVersionsClient {
    ...
    RegistryCodeVersionsClientImpl(AzureMachineLearningServicesImpl client) {
        this.service =
            RestProxy
                .create(RegistryCodeVersionsService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }
    ...
    public interface RegistryCodeVersionsService {
        ...
        @Headers({"Content-Type: application/json"})
        @Post(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/registries/{registryName}/codes/{codeName}/versions/{version}/getBlobReferenceSAS")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
    ...
    private Mono<PagedResponse<CodeVersionInner>> listSinglePageAsync(
        String resourceGroupName, String registryName, String codeName, String orderBy, Integer top, String skip) {
    ...
    private PagedFlux<CodeVersionInner> listAsync(
        ...
        return new PagedFlux<>(
            () -> listSinglePageAsync(resourceGroupName, registryName, codeName, orderBy, top, skip),
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String registryName, String codeName, String version) {
        return beginDeleteAsync(resourceGroupName, registryName, codeName, version)
            .last()
    ...
    private Mono<Void> deleteAsync(
        String resourceGroupName, String registryName, String codeName, String version, Context context) {
        return beginDeleteAsync(resourceGroupName, registryName, codeName, version, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private PollerFlux<PollResult<CodeVersionInner>, CodeVersionInner> beginCreateOrUpdateAsync(
        ...
        return this
            .client
            .<CodeVersionInner, CodeVersionInner>getLroResult(
                mono,
                this.client.getHttpPipeline(),
                CodeVersionInner.class,
                CodeVersionInner.class,
    ...
    private PollerFlux<PollResult<CodeVersionInner>, CodeVersionInner> beginCreateOrUpdateAsync(
        ...
        return this
            .client
            .<CodeVersionInner, CodeVersionInner>getLroResult(
                mono, this.client.getHttpPipeline(), CodeVersionInner.class, CodeVersionInner.class, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<CodeVersionInner>, CodeVersionInner> beginCreateOrUpdate(
        String resourceGroupName, String registryName, String codeName, String version, CodeVersionInner body) {
    ...
    public SyncPoller<PollResult<CodeVersionInner>, CodeVersionInner> beginCreateOrUpdate(
        ...
        Context context) {
        return this
            .beginCreateOrUpdateAsync(resourceGroupName, registryName, codeName, version, body, context)
            .getSyncPoller();
    }
    ...
    private Mono<CodeVersionInner> createOrUpdateAsync(
        String resourceGroupName, String registryName, String codeName, String version, CodeVersionInner body) {
        return beginCreateOrUpdateAsync(resourceGroupName, registryName, codeName, version, body)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<CodeVersionInner> createOrUpdateAsync(
        ...
        CodeVersionInner body,
        Context context) {
        return beginCreateOrUpdateAsync(resourceGroupName, registryName, codeName, version, body, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
     * @param registryName Name of Azure Machine Learning registry. This is case-insensitive.
     * @param codeName Code name. This is case-sensitive.
     * @param version Version identifier. This is case-sensitive.
     * @param body blob reference request object.
     * @throws IllegalArgumentException thrown if parameters fail the validation.
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a SAS for a blob reference associated with the code along with {@link Response} on successful completion
     *     of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a SAS for a blob reference associated with the code on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<BlobReferenceSasResponseDtoInner> getBlobReferenceSasAsync(
        ...
        String version,
        BlobReferenceSasRequestDto body) {
        return getBlobReferenceSasWithResponseAsync(resourceGroupName, registryName, codeName, version, body)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a SAS for a blob reference associated with the code along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<BlobReferenceSasResponseDtoInner> getBlobReferenceSasWithResponse(
        ...
        BlobReferenceSasRequestDto body,
        Context context) {
        return getBlobReferenceSasWithResponseAsync(resourceGroupName, registryName, codeName, version, body, context)
            .block();
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a SAS for a blob reference associated with the code.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public BlobReferenceSasResponseDtoInner getBlobReferenceSas(
        ...
        String version,
        BlobReferenceSasRequestDto body) {
        return getBlobReferenceSasWithResponse(resourceGroupName, registryName, codeName, version, body, Context.NONE)
            .getValue();
    }
    ...
    public PendingUploadResponseDtoInner createOrGetStartPendingUpload(
        ...
        return createOrGetStartPendingUploadWithResponse(
                resourceGroupName, registryName, codeName, version, body, Context.NONE)
            .getValue();
    }
