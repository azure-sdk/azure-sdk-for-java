...
public final class RegistryProperties extends ResourceBase {
     ...
     */
    @JsonProperty(value = "managedResourceGroupTags")
    @JsonInclude(value = JsonInclude.Include.NON_NULL, content = JsonInclude.Include.ALWAYS)
    private Map<String, String> managedResourceGroupTags;
    ...
    /**
     * Get the managedResourceGroupTags property: Tags to be applied to the managed resource group associated with this
     * registry.
     *
     * @return the managedResourceGroupTags value.
     */
    public Map<String, String> managedResourceGroupTags() {
        return this.managedResourceGroupTags;
    }

    /**
     * Set the managedResourceGroupTags property: Tags to be applied to the managed resource group associated with this
     * registry.
     *
     * @param managedResourceGroupTags the managedResourceGroupTags value to set.
     * @return the RegistryProperties object itself.
     */
    public RegistryProperties withManagedResourceGroupTags(Map<String, String> managedResourceGroupTags) {
        this.managedResourceGroupTags = managedResourceGroupTags;
        return this;
    }
