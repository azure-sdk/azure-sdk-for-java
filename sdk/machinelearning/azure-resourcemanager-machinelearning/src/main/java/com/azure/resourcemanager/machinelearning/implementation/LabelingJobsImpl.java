...
public final class LabelingJobsImpl implements LabelingJobs {
    ...
    public Response<Void> pauseWithResponse(
        String resourceGroupName, String workspaceName, String id, Context context) {
        return this.serviceClient().pauseWithResponse(resourceGroupName, workspaceName, id, context);
    }

    public void pause(String resourceGroupName, String workspaceName, String id) {
        this.serviceClient().pause(resourceGroupName, workspaceName, id);
    }

    public void resume(String resourceGroupName, String workspaceName, String id) {
        this.serviceClient().resume(resourceGroupName, workspaceName, id);
    }

    public void resume(String resourceGroupName, String workspaceName, String id, Context context) {
        this.serviceClient().resume(resourceGroupName, workspaceName, id, context);
    }
    ...
    public Response<LabelingJob> getByIdWithResponse(
        ...
        return this
            .getWithResponse(
                resourceGroupName, workspaceName, varId, includeJobInstructions, includeLabelCategories, context);
    }
