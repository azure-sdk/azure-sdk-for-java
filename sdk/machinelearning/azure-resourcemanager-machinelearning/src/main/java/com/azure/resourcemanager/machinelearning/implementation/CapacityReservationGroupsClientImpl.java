...
public final class CapacityReservationGroupsClientImpl implements CapacityReservationGroupsClient {
    ...
    public interface CapacityReservationGroupsService {
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<CapacityReservationGroupTrackedResourceArmPaginatedResult>>
    ...
    private PagedFlux<CapacityReservationGroupInner> listAsync(String skip) {
        return new PagedFlux<>(
            () -> listSinglePageAsync(skip),
            nextLink -> capacityReservationGroupsListBySubscriptionNextSinglePageAsync(nextLink));
    }
    ...
    private PagedFlux<CapacityReservationGroupInner> listAsync(String skip, Context context) {
        return new PagedFlux<>(
            ...
            nextLink -> capacityReservationGroupsListBySubscriptionNextSinglePageAsync(nextLink, context));
    }
    ...
    private Mono<Void> updateAsync(
        String resourceGroupName, String groupId, PartialMinimalTrackedResourceWithSkuAndIdentity body) {
        return updateWithResponseAsync(resourceGroupName, groupId, body).flatMap(ignored -> Mono.empty());
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public void update(String resourceGroupName, String groupId, PartialMinimalTrackedResourceWithSkuAndIdentity body) {
        updateWithResponse(resourceGroupName, groupId, body, Context.NONE);
    }
    ...
    private Mono<PagedResponse<CapacityReservationGroupInner>>
        capacityReservationGroupsListBySubscriptionNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<CapacityReservationGroupInner>>
        capacityReservationGroupsListBySubscriptionNextSinglePageAsync(String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        if (this.client.getEndpoint() == null) {
        ...
        context = this.client.mergeContext(context);
        return service
            .capacityReservationGroupsListBySubscriptionNext(nextLink, this.client.getEndpoint(), accept, context)
            .map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(),
