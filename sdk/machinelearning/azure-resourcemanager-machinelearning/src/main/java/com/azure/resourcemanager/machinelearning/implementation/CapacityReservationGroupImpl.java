...
public final class CapacityReservationGroupImpl
    ...
    public CapacityReservationGroup create() {
        this.innerObject = serviceManager.serviceClient().getCapacityReservationGroups()
            .createOrUpdateWithResponse(resourceGroupName, groupId, this.innerModel(), Context.NONE).getValue();
        return this;
    }

    public CapacityReservationGroup create(Context context) {
        this.innerObject = serviceManager.serviceClient().getCapacityReservationGroups()
            .createOrUpdateWithResponse(resourceGroupName, groupId, this.innerModel(), context).getValue();
        return this;
    }

    CapacityReservationGroupImpl(String name,
    ...
    public CapacityReservationGroup apply() {
        this.innerObject = serviceManager.serviceClient().getCapacityReservationGroups()
            .updateWithResponse(resourceGroupName, groupId, updateBody, Context.NONE).getValue();
        return this;
    }

    public CapacityReservationGroup apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getCapacityReservationGroups()
            .updateWithResponse(resourceGroupName, groupId, updateBody, context).getValue();
        return this;
    }

    CapacityReservationGroupImpl(CapacityReservationGroupInner innerObject,
        com.azure.resourcemanager.machinelearning.MachineLearningManager serviceManager) {
        this.innerObject = innerObject;
        this.serviceManager = serviceManager;
        this.resourceGroupName = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "resourceGroups");
        this.groupId = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "capacityReserverationGroups");
    }

    public CapacityReservationGroup refresh() {
        this.innerObject = serviceManager.serviceClient().getCapacityReservationGroups()
            .getByResourceGroupWithResponse(resourceGroupName, groupId, Context.NONE).getValue();
        return this;
    }

    public CapacityReservationGroup refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getCapacityReservationGroups()
            .getByResourceGroupWithResponse(resourceGroupName, groupId, context).getValue();
        return this;
    }
