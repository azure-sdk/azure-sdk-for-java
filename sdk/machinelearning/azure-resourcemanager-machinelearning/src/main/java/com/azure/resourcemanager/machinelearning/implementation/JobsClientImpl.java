...
public final class JobsClientImpl implements JobsClient {
    ...
    public interface JobsService {
        ...
        Mono<Response<JobBaseResourceArmPaginatedResult>> list(@HostParam("$host") String endpoint,
            ...
            @QueryParam("assetName") String assetName, @QueryParam("scheduled") Boolean scheduled,
            @QueryParam("scheduleId") String scheduleId, @HeaderParam("Accept") String accept, Context context);
    ...
    private Mono<PagedResponse<JobBaseInner>> listSinglePageAsync(String resourceGroupName, String workspaceName,
        String skip, String jobType, String tag, ListViewType listViewType, String properties, String assetName,
        Boolean scheduled, String scheduleId) {
        ...
        return FluxUtil
            .withContext(context -> service.list(this.client.getEndpoint(), this.client.getSubscriptionId(),
                ...
                properties, assetName, scheduled, scheduleId, accept, context))
    ...
    private Mono<PagedResponse<JobBaseInner>> listSinglePageAsync(String resourceGroupName, String workspaceName,
        String skip, String jobType, String tag, ListViewType listViewType, String properties, String assetName,
        Boolean scheduled, String scheduleId, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service
            .list(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName, workspaceName,
                this.client.getApiVersion(), skip, jobType, tag, listViewType, properties, assetName, scheduled,
                scheduleId, accept, context)
    ...
    private PagedFlux<JobBaseInner> listAsync(String resourceGroupName, String workspaceName, String skip,
        String jobType, String tag, ListViewType listViewType, String properties, String assetName, Boolean scheduled,
        String scheduleId) {
        return new PagedFlux<>(() -> listSinglePageAsync(resourceGroupName, workspaceName, skip, jobType, tag,
            listViewType, properties, assetName, scheduled, scheduleId), nextLink -> listNextSinglePageAsync(nextLink));
    }
    ...
    private PagedFlux<JobBaseInner> listAsync(String resourceGroupName, String workspaceName, String skip,
        String jobType, String tag, ListViewType listViewType, String properties, String assetName, Boolean scheduled,
        String scheduleId, Context context) {
        return new PagedFlux<>(() -> listSinglePageAsync(resourceGroupName, workspaceName, skip, jobType, tag,
            listViewType, properties, assetName, scheduled, scheduleId, context),
    ...
    public PagedIterable<JobBaseInner> list(String resourceGroupName, String workspaceName) {
        ...
        return new PagedIterable<>(listAsync(resourceGroupName, workspaceName, skip, jobType, tag, listViewType,
            properties, assetName, scheduled, scheduleId));
    }
    ...
    public PagedIterable<JobBaseInner> list(String resourceGroupName, String workspaceName, String skip, String jobType,
        String tag, ListViewType listViewType, String properties, String assetName, Boolean scheduled,
        String scheduleId, Context context) {
        return new PagedIterable<>(listAsync(resourceGroupName, workspaceName, skip, jobType, tag, listViewType,
            properties, assetName, scheduled, scheduleId, context));
    }
