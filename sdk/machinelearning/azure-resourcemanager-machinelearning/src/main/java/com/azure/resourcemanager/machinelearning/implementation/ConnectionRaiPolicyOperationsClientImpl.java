...
public final class ConnectionRaiPolicyOperationsClientImpl implements ConnectionRaiPolicyOperationsClient {
    ...
    private Mono<Response<Flux<ByteBuffer>>> deleteWithResponseAsync(String resourceGroupName, String workspaceName,
        String connectionName, String raiPolicyName, String proxyApiVersion) {
        ...
        return FluxUtil
            .withContext(context -> service.delete(this.client.getEndpoint(), this.client.getSubscriptionId(),
                resourceGroupName, workspaceName, connectionName, raiPolicyName, this.client.getApiVersion(),
    ...
    private Mono<Response<Flux<ByteBuffer>>> deleteWithResponseAsync(String resourceGroupName, String workspaceName,
        ...
        return service.delete(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            workspaceName, connectionName, raiPolicyName, this.client.getApiVersion(), proxyApiVersion, accept,
            context);
    }
    ...
    private PollerFlux<PollResult<Void>, Void> beginDeleteAsync(String resourceGroupName, String workspaceName,
        ...
        Mono<Response<Flux<ByteBuffer>>> mono
            = deleteWithResponseAsync(resourceGroupName, workspaceName, connectionName, raiPolicyName, proxyApiVersion);
    ...
    private PollerFlux<PollResult<Void>, Void> beginDeleteAsync(String resourceGroupName, String workspaceName,
        ...
        Mono<Response<Flux<ByteBuffer>>> mono = deleteWithResponseAsync(resourceGroupName, workspaceName,
            connectionName, raiPolicyName, proxyApiVersion, context);
        return this.client.<Void, Void>getLroResult(mono, this.client.getHttpPipeline(), Void.class, Void.class,
            context);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String workspaceName,
        String connectionName, String raiPolicyName) {
        final String proxyApiVersion = null;
        return this.beginDeleteAsync(resourceGroupName, workspaceName, connectionName, raiPolicyName, proxyApiVersion)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String workspaceName,
        String connectionName, String raiPolicyName, String proxyApiVersion, Context context) {
        return this
            .beginDeleteAsync(resourceGroupName, workspaceName, connectionName, raiPolicyName, proxyApiVersion, context)
            .getSyncPoller();
    }
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String workspaceName, String connectionName,
        ...
        return beginDeleteAsync(resourceGroupName, workspaceName, connectionName, raiPolicyName, proxyApiVersion).last()
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String workspaceName, String connectionName,
        ...
        return beginDeleteAsync(resourceGroupName, workspaceName, connectionName, raiPolicyName, proxyApiVersion,
    ...
    public void delete(String resourceGroupName, String workspaceName, String connectionName, String raiPolicyName) {
        final String proxyApiVersion = null;
        deleteAsync(resourceGroupName, workspaceName, connectionName, raiPolicyName, proxyApiVersion).block();
    }
    ...
    public void delete(String resourceGroupName, String workspaceName, String connectionName, String raiPolicyName,
        ...
        deleteAsync(resourceGroupName, workspaceName, connectionName, raiPolicyName, proxyApiVersion, context).block();
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> createWithResponseAsync(String resourceGroupName, String workspaceName,
        String connectionName, String raiPolicyName, RaiPolicyPropertiesBasicResourceInner body, String proxyApiVersion,
        Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        return service.create(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            workspaceName, connectionName, raiPolicyName, this.client.getApiVersion(), proxyApiVersion, body, accept,
            context);
    }
    ...
    private PollerFlux<PollResult<RaiPolicyPropertiesBasicResourceInner>, RaiPolicyPropertiesBasicResourceInner>
        ...
        Mono<Response<Flux<ByteBuffer>>> mono = createWithResponseAsync(resourceGroupName, workspaceName,
            connectionName, raiPolicyName, body, proxyApiVersion);
    ...
    private PollerFlux<PollResult<RaiPolicyPropertiesBasicResourceInner>, RaiPolicyPropertiesBasicResourceInner>
        ...
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono = createWithResponseAsync(resourceGroupName, workspaceName,
            connectionName, raiPolicyName, body, proxyApiVersion, context);
        return this.client.<RaiPolicyPropertiesBasicResourceInner, RaiPolicyPropertiesBasicResourceInner>getLroResult(
            mono, this.client.getHttpPipeline(), RaiPolicyPropertiesBasicResourceInner.class,
    ...
    public SyncPoller<PollResult<RaiPolicyPropertiesBasicResourceInner>, RaiPolicyPropertiesBasicResourceInner>
        ...
        final String proxyApiVersion = null;
        return this
            .beginCreateAsync(resourceGroupName, workspaceName, connectionName, raiPolicyName, body, proxyApiVersion)
            .getSyncPoller();
    }
    ...
    private Mono<RaiPolicyPropertiesBasicResourceInner> createAsync(String resourceGroupName, String workspaceName,
        String connectionName, String raiPolicyName, RaiPolicyPropertiesBasicResourceInner body,
        String proxyApiVersion) {
        return beginCreateAsync(resourceGroupName, workspaceName, connectionName, raiPolicyName, body, proxyApiVersion)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    public RaiPolicyPropertiesBasicResourceInner create(String resourceGroupName, String workspaceName,
        String connectionName, String raiPolicyName, RaiPolicyPropertiesBasicResourceInner body) {
        final String proxyApiVersion = null;
        return createAsync(resourceGroupName, workspaceName, connectionName, raiPolicyName, body, proxyApiVersion)
            .block();
    }
