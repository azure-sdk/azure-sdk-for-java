...
public final class ConnectionRaiPolicyOperationsClientImpl implements ConnectionRaiPolicyOperationsClient {
     ...
     */
    ConnectionRaiPolicyOperationsClientImpl(AzureMachineLearningWorkspacesImpl client) {
    ...
    /**
     * The interface defining all the services for AzureMachineLearningWorkspacesConnectionRaiPolicyOperations to be
