...
public final class CodeContainerImpl implements CodeContainer, CodeContainer.Definition, CodeContainer.Update {
    ...
    public CodeContainer create() {
        this.innerObject = serviceManager.serviceClient().getRegistryCodeContainers().createOrUpdate(resourceGroupName,
            registryName, codeName, this.innerModel(), Context.NONE);
        return this;
    }

    public CodeContainer create(Context context) {
        this.innerObject = serviceManager.serviceClient().getRegistryCodeContainers().createOrUpdate(resourceGroupName,
            registryName, codeName, this.innerModel(), context);
        return this;
    }
    ...
    public CodeContainer refresh() {
        this.innerObject = serviceManager.serviceClient().getRegistryCodeContainers()
            .getWithResponse(resourceGroupName, registryName, codeName, Context.NONE).getValue();
        return this;
    }

    public CodeContainer refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getRegistryCodeContainers()
            .getWithResponse(resourceGroupName, registryName, codeName, context).getValue();
        return this;
    }
