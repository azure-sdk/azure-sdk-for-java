...
public final class ConnectionsImpl implements Connections {
    ...
    public Response<EndpointModels> listModelsWithResponse(String resourceGroupName, String workspaceName,
        Context context) {
        Response<EndpointModelsInner> inner
            = this.serviceClient().listModelsWithResponse(resourceGroupName, workspaceName, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
    ...
    public EndpointModels listModels(String resourceGroupName, String workspaceName) {
        EndpointModelsInner inner = this.serviceClient().listModels(resourceGroupName, workspaceName);
        if (inner != null) {
