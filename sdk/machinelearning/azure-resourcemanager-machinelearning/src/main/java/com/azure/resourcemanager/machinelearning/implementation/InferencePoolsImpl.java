...
public final class InferencePoolsImpl implements InferencePools {
    ...
    public PagedIterable<InferencePool> list(String resourceGroupName, String workspaceName, Integer count, String skip,
        ...
        PagedIterable<InferencePoolInner> inner = this.serviceClient().list(resourceGroupName, workspaceName, count,
            skip, tags, properties, orderBy, context);
        return Utils.mapPage(inner, inner1 -> new InferencePoolImpl(inner1, this.manager()));
    }
    ...
    public Response<PoolStatus> getStatusWithResponse(String resourceGroupName, String workspaceName,
        String inferencePoolName, Context context) {
    ...
    public PagedIterable<SkuResource> listSkus(String resourceGroupName, String workspaceName,
    ...
    public PagedIterable<SkuResource> listSkus(String resourceGroupName, String workspaceName, String inferencePoolName,
