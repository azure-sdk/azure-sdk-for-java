...
public final class InferencePoolsImpl implements InferencePools {
    ...
    public InferencePool get(String resourceGroupName, String workspaceName, String name) {
        InferencePoolInner inner = this.serviceClient().get(resourceGroupName, workspaceName, name);
        if (inner != null) {
    ...
    public PagedIterable<SkuResource> listSkus(String resourceGroupName, String workspaceName, String name) {
        PagedIterable<SkuResourceInner> inner = this.serviceClient().listSkus(resourceGroupName, workspaceName, name);
    ...
    public PagedIterable<SkuResource> listSkus(
        ...
        PagedIterable<SkuResourceInner> inner =
            this.serviceClient().listSkus(resourceGroupName, workspaceName, name, count, skip, context);
        return Utils.mapPage(inner, inner1 -> new SkuResourceImpl(inner1, this.manager()));
    }
    ...
    public Response<PoolStatus> getStatusWithResponse(
        ...
        Response<PoolStatusInner> inner =
            this.serviceClient().getStatusWithResponse(resourceGroupName, workspaceName, name, context);
        if (inner != null) {
            return new SimpleResponse<>(
                inner.getRequest(),
                inner.getStatusCode(),
    ...
    public PoolStatus getStatus(String resourceGroupName, String workspaceName, String name) {
        PoolStatusInner inner = this.serviceClient().getStatus(resourceGroupName, workspaceName, name);
        if (inner != null) {
    ...
    public InferencePool getById(String id) {
        ...
        String name = Utils.getValueFromIdByName(id, "inferencePools");
        if (name == null) {
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException(
