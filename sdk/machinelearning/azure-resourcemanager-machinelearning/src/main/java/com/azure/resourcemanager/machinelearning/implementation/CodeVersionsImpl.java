...
public final class CodeVersionsImpl implements CodeVersions {
    ...
    public Response<PendingUploadResponseDto> createOrGetPendingUploadWithResponse(
        ...
        Response<PendingUploadResponseDtoInner> inner =
            this
                .serviceClient()
                .createOrGetPendingUploadWithResponse(resourceGroupName, workspaceName, name, version, body, context);
        if (inner != null) {
            return new SimpleResponse<>(
                inner.getRequest(),
                inner.getStatusCode(),
    ...
    public PendingUploadResponseDto createOrGetPendingUpload(
        ...
        PendingUploadResponseDtoInner inner =
            this.serviceClient().createOrGetPendingUpload(resourceGroupName, workspaceName, name, version, body);
        if (inner != null) {
