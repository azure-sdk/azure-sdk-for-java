...
public final class RegistriesImpl implements Registries {
    ...
    public RegistriesImpl(
        RegistriesClient innerClient, com.azure.resourcemanager.machinelearning.MachineLearningManager serviceManager) {
    ...
    public PagedIterable<Registry> list(String skip, Context context) {
        PagedIterable<RegistryInner> inner = this.serviceClient().list(skip, context);
        return Utils.mapPage(inner, inner1 -> new RegistryImpl(inner1, this.manager()));
    }
    ...
    public PagedIterable<Registry> listByResourceGroup(String resourceGroupName, String skip, Context context) {
        PagedIterable<RegistryInner> inner = this.serviceClient().listByResourceGroup(resourceGroupName, skip, context);
        return Utils.mapPage(inner, inner1 -> new RegistryImpl(inner1, this.manager()));
    }
    ...
    public Response<Void> deleteWithResponse(String resourceGroupName, String registryName, Context context) {
        return this.serviceClient().deleteWithResponse(resourceGroupName, registryName, context);
    }
    ...
    public void deleteById(String id) {
        ...
        this.deleteWithResponse(resourceGroupName, registryName, Context.NONE);
    }
    ...
    public Response<Void> deleteByIdWithResponse(String id, Context context) {
        ...
        return this.deleteWithResponse(resourceGroupName, registryName, context);
    }
