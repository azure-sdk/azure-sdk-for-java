...
public final class ComputeResourceImpl implements ComputeResource, ComputeResource.Definition, ComputeResource.Update {
    ...
    public ComputeResource resize(ResizeSchema parameters) {
        return serviceManager.computes().resize(resourceGroupName, workspaceName, computeName, parameters);
    }

    public ComputeResource resize(ResizeSchema parameters, Context context) {
        return serviceManager.computes().resize(resourceGroupName, workspaceName, computeName, parameters, context);
    }
