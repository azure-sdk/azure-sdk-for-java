...
public final class ServerlessEndpointsClientImpl implements ServerlessEndpointsClient {
    ...
    ServerlessEndpointsClientImpl(AzureMachineLearningServicesImpl client) {
        this.service =
            RestProxy.create(ServerlessEndpointsService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }
    ...
    public interface ServerlessEndpointsService {
        ...
        Mono<Response<ServerlessEndpointTrackedResourceArmPaginatedResult>> list(
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ServerlessEndpointInner>> get(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("workspaceName") String workspaceName,
        ...
        Mono<Response<Flux<ByteBuffer>>> createOrUpdate(
            ...
            @PathParam("name") String name,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") ServerlessEndpointInner body,
            @HeaderParam("Accept") String accept,
            Context context);
    ...
    private Mono<PagedResponse<ServerlessEndpointInner>> listSinglePageAsync(
                ...
                context ->
                    service
                        .list(
                            ...
                            accept,
                            context))
            .<PagedResponse<ServerlessEndpointInner>>map(
                res ->
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<ServerlessEndpointInner> listAsync(
        String resourceGroupName, String workspaceName, String skip, Context context) {
        return new PagedFlux<>(
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<ServerlessEndpointInner> list(
        String resourceGroupName, String workspaceName, String skip, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ServerlessEndpointInner>> getWithResponseAsync(
        String resourceGroupName, String workspaceName, String name) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ServerlessEndpointInner> getWithResponse(
        String resourceGroupName, String workspaceName, String name, Context context) {
    ...
    private PollerFlux<PollResult<ServerlessEndpointInner>, ServerlessEndpointInner> beginUpdateAsync(
        ...
        return this
            .client
            .<ServerlessEndpointInner, ServerlessEndpointInner>getLroResult(
                mono,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ServerlessEndpointInner> updateAsync(
        String resourceGroupName,
        String workspaceName,
        String name,
        PartialMinimalTrackedResourceWithSkuAndIdentity body) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ServerlessEndpointInner update(
        String resourceGroupName,
        String workspaceName,
        String name,
        PartialMinimalTrackedResourceWithSkuAndIdentity body) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ServerlessEndpointInner> createOrUpdateAsync(
        String resourceGroupName, String workspaceName, String name, ServerlessEndpointInner body) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ServerlessEndpointInner createOrUpdate(
        String resourceGroupName, String workspaceName, String name, ServerlessEndpointInner body) {
    ...
    private PollerFlux<PollResult<EndpointAuthKeysInner>, EndpointAuthKeysInner> beginRegenerateKeysAsync(
        ...
        return this
            .client
            .<EndpointAuthKeysInner, EndpointAuthKeysInner>getLroResult(
                mono,
                this.client.getHttpPipeline(),
                EndpointAuthKeysInner.class,
                EndpointAuthKeysInner.class,
                this.client.getContext());
    }
    ...
    private PollerFlux<PollResult<EndpointAuthKeysInner>, EndpointAuthKeysInner> beginRegenerateKeysAsync(
        ...
        return this
            .client
            .<EndpointAuthKeysInner, EndpointAuthKeysInner>getLroResult(
                mono, this.client.getHttpPipeline(), EndpointAuthKeysInner.class, EndpointAuthKeysInner.class, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<EndpointAuthKeysInner> regenerateKeysAsync(
        String resourceGroupName, String workspaceName, String name, RegenerateEndpointKeysRequest body) {
        return beginRegenerateKeysAsync(resourceGroupName, workspaceName, name, body)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<EndpointAuthKeysInner> regenerateKeysAsync(
        ...
        RegenerateEndpointKeysRequest body,
        Context context) {
        return beginRegenerateKeysAsync(resourceGroupName, workspaceName, name, body, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public EndpointAuthKeysInner regenerateKeys(
        String resourceGroupName, String workspaceName, String name, RegenerateEndpointKeysRequest body) {
