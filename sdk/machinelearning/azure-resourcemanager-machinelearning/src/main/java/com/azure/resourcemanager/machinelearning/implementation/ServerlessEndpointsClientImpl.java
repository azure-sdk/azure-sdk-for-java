...
public final class ServerlessEndpointsClientImpl implements ServerlessEndpointsClient {
    ...
    public interface ServerlessEndpointsService {
        ...
        @Headers({ "Content-Type: application/json" })
        @Post("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/serverlessEndpoints/{name}/getStatus")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ServerlessEndpointStatusInner>> getStatus(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("workspaceName") String workspaceName,
            @PathParam("name") String name, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ServerlessEndpointStatusInner>> getStatusWithResponseAsync(String resourceGroupName,
        String workspaceName, String name) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ServerlessEndpointStatusInner> getStatusAsync(String resourceGroupName, String workspaceName,
        String name) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ServerlessEndpointStatusInner> getStatusWithResponse(String resourceGroupName, String workspaceName,
        String name, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ServerlessEndpointStatusInner getStatus(String resourceGroupName, String workspaceName, String name) {
