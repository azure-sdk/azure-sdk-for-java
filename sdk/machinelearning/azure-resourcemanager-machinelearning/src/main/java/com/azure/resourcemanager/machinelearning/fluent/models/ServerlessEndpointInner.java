...
public final class ServerlessEndpointInner extends Resource {
    ...
    public void validate() {
        ...
        if (properties() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property properties in model ServerlessEndpointInner"));
        } else {
            properties().validate();
        }
        if (sku() != null) {
        ...
        if (location() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property location in model ServerlessEndpointInner"));
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(ServerlessEndpointInner.class);
     ...
     * @return An instance of ServerlessEndpointInner if the JsonReader was pointing to an instance of it, or null if it
     * was pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the ServerlessEndpointInner.
     */
    public static ServerlessEndpointInner fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ServerlessEndpointInner deserializedServerlessEndpointInner = new ServerlessEndpointInner();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("id".equals(fieldName)) {
                    deserializedServerlessEndpointInner.id = reader.getString();
                } else if ("name".equals(fieldName)) {
                    deserializedServerlessEndpointInner.name = reader.getString();
                } else if ("type".equals(fieldName)) {
                    deserializedServerlessEndpointInner.type = reader.getString();
                } else if ("location".equals(fieldName)) {
                    deserializedServerlessEndpointInner.withLocation(reader.getString());
                    ...
                    deserializedServerlessEndpointInner.systemData = SystemData.fromJson(reader);
                } else {
                    reader.skipChildren();
                }
            }

            return deserializedServerlessEndpointInner;
        });
    }
}
