...
public final class RegistryEnvironmentVersionsImpl implements RegistryEnvironmentVersions {
    ...
    public PagedIterable<EnvironmentVersion> list(String resourceGroupName, String registryName, String environmentName,
        ...
        PagedIterable<EnvironmentVersionInner> inner = this.serviceClient().list(resourceGroupName, registryName,
            environmentName, orderBy, top, skip, listViewType, stage, context);
        return Utils.mapPage(inner, inner1 -> new EnvironmentVersionImpl(inner1, this.manager()));
    }
