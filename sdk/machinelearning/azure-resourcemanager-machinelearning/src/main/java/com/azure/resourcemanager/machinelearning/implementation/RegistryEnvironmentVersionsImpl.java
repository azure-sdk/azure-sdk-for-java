...
public final class RegistryEnvironmentVersionsImpl implements RegistryEnvironmentVersions {
    ...
    public RegistryEnvironmentVersionsImpl(
        RegistryEnvironmentVersionsClient innerClient,
    ...
    public BlobReferenceSasResponseDto getBlobReferenceSas(
        ...
        BlobReferenceSasResponseDtoInner inner =
            this.serviceClient().getBlobReferenceSas(resourceGroupName, registryName, environmentName, version, body);
        if (inner != null) {
