...
public final class InferencePoolsClientImpl implements InferencePoolsClient {
    ...
    public interface InferencePoolsService {
        ...
        @Headers({"Content-Type: application/json"})
        @Delete(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/inferencePools/{name}")
        ...
        @Headers({"Content-Type: application/json"})
        @Get(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/inferencePools/{name}/skus")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        ...
        @Headers({"Content-Type: application/json"})
        @Post(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/inferencePools/{name}/status")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<InferencePoolInner> getAsync(String resourceGroupName, String workspaceName, String name) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public InferencePoolInner get(String resourceGroupName, String workspaceName, String name) {
    ...
    private Mono<InferencePoolInner> updateAsync(
        ...
        String name,
        PartialMinimalTrackedResourceWithSkuAndIdentity body) {
        return beginUpdateAsync(resourceGroupName, workspaceName, name, body)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<InferencePoolInner> updateAsync(
        ...
        PartialMinimalTrackedResourceWithSkuAndIdentity body,
        Context context) {
        return beginUpdateAsync(resourceGroupName, workspaceName, name, body, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(
        String resourceGroupName, String workspaceName, String name, InferencePoolInner body) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(
        String resourceGroupName, String workspaceName, String name, InferencePoolInner body, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    private Mono<PagedResponse<SkuResourceInner>> listSkusSinglePageAsync(
        String resourceGroupName, String workspaceName, String name, Integer count, String skip) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    private PagedFlux<SkuResourceInner> listSkusAsync(
        String resourceGroupName, String workspaceName, String name, Integer count, String skip) {
        return new PagedFlux<>(
            () -> listSkusSinglePageAsync(resourceGroupName, workspaceName, name, count, skip),
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<SkuResourceInner> listSkusAsync(String resourceGroupName, String workspaceName, String name) {
        final Integer count = null;
        final String skip = null;
        return new PagedFlux<>(
            () -> listSkusSinglePageAsync(resourceGroupName, workspaceName, name, count, skip),
    ...
    private PagedFlux<SkuResourceInner> listSkusAsync(
        String resourceGroupName, String workspaceName, String name, Integer count, String skip, Context context) {
        return new PagedFlux<>(
            () -> listSkusSinglePageAsync(resourceGroupName, workspaceName, name, count, skip, context),
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<SkuResourceInner> listSkus(String resourceGroupName, String workspaceName, String name) {
        final Integer count = null;
        final String skip = null;
        return new PagedIterable<>(listSkusAsync(resourceGroupName, workspaceName, name, count, skip));
    }
    ...
    public PagedIterable<SkuResourceInner> listSkus(
        String resourceGroupName, String workspaceName, String name, Integer count, String skip, Context context) {
        return new PagedIterable<>(listSkusAsync(resourceGroupName, workspaceName, name, count, skip, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PoolStatusInner> getStatusAsync(String resourceGroupName, String workspaceName, String name) {
        return getStatusWithResponseAsync(resourceGroupName, workspaceName, name)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
    ...
    public Response<PoolStatusInner> getStatusWithResponse(
        String resourceGroupName, String workspaceName, String name, Context context) {
        return getStatusWithResponseAsync(resourceGroupName, workspaceName, name, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public PoolStatusInner getStatus(String resourceGroupName, String workspaceName, String name) {
        return getStatusWithResponse(resourceGroupName, workspaceName, name, Context.NONE).getValue();
    }
