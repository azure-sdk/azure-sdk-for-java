...
public final class SchedulesImpl implements Schedules {
    ...
    public PagedIterable<Schedule> list(String resourceGroupName, String workspaceName, String skip,
    ...
    public Response<Schedule> getWithResponse(String resourceGroupName, String workspaceName, String name,
        Context context) {
    ...
    public Response<TriggerRunSubmissionDto> triggerWithResponse(String resourceGroupName, String workspaceName,
        String name, TriggerOnceRequest body, Context context) {
        Response<TriggerRunSubmissionDtoInner> inner
            = this.serviceClient().triggerWithResponse(resourceGroupName, workspaceName, name, body, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
                new TriggerRunSubmissionDtoImpl(inner.getValue(), this.manager()));
        } else {
            return null;
        }
    }

    public TriggerRunSubmissionDto trigger(String resourceGroupName, String workspaceName, String name,
        TriggerOnceRequest body) {
        TriggerRunSubmissionDtoInner inner = this.serviceClient().trigger(resourceGroupName, workspaceName, name, body);
        if (inner != null) {
            return new TriggerRunSubmissionDtoImpl(inner, this.manager());
        } else {
            return null;
        }
    }
