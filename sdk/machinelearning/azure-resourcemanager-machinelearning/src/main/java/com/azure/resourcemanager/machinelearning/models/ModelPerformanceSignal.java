...
public final class ModelPerformanceSignal extends MonitoringSignalBase {
    ...
    /**
     * Get the productionData property: [Required] The data produced by the production service which performance will
     * be calculated for.
     * 
    ...
    /**
     * Set the productionData property: [Required] The data produced by the production service which performance will
     * be calculated for.
     * 
