...
public final class RegistryComponentContainersClientImpl implements RegistryComponentContainersClient {
    ...
    RegistryComponentContainersClientImpl(AzureMachineLearningServicesImpl client) {
        this.service =
            RestProxy
                .create(
                    RegistryComponentContainersService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }
    ...
    private interface RegistryComponentContainersService {
        @Headers({"Content-Type: application/json"})
        @Get(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers"
                + "/Microsoft.MachineLearningServices/registries/{registryName}/components")
        ...
        @Delete(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers"
                + "/Microsoft.MachineLearningServices/registries/{registryName}/components/{componentName}")
        ...
        Mono<Response<Flux<ByteBuffer>>> createOrUpdate(
            ...
            @PathParam("componentName") String componentName,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") ComponentContainerInner body,
            @HeaderParam("Accept") String accept,
            Context context);
    ...
    private Mono<PagedResponse<ComponentContainerInner>> listSinglePageAsync(
        String resourceGroupName, String registryName, String skip) {
                ...
                context ->
                    service
                        .list(
                            ...
                            accept,
                            context))
            .<PagedResponse<ComponentContainerInner>>map(
                res ->
    ...
    private PagedFlux<ComponentContainerInner> listAsync(String resourceGroupName, String registryName, String skip) {
        return new PagedFlux<>(
            () -> listSinglePageAsync(resourceGroupName, registryName, skip),
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<ComponentContainerInner> listAsync(
        String resourceGroupName, String registryName, String skip, Context context) {
        return new PagedFlux<>(
            () -> listSinglePageAsync(resourceGroupName, registryName, skip, context),
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<ComponentContainerInner> list(
        String resourceGroupName, String registryName, String skip, Context context) {
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(
        String resourceGroupName, String registryName, String componentName) {
        return beginDeleteAsync(resourceGroupName, registryName, componentName).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(
        String resourceGroupName, String registryName, String componentName, Context context) {
        return beginDeleteAsync(resourceGroupName, registryName, componentName, context).getSyncPoller();
    }
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String registryName, String componentName) {
        return beginDeleteAsync(resourceGroupName, registryName, componentName)
            .last()
    ...
    private Mono<Void> deleteAsync(
        String resourceGroupName, String registryName, String componentName, Context context) {
        return beginDeleteAsync(resourceGroupName, registryName, componentName, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ComponentContainerInner>> getWithResponseAsync(
        String resourceGroupName, String registryName, String componentName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ComponentContainerInner> getAsync(
        String resourceGroupName, String registryName, String componentName) {
    ...
    public ComponentContainerInner get(String resourceGroupName, String registryName, String componentName) {
        return getAsync(resourceGroupName, registryName, componentName).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ComponentContainerInner> getWithResponse(
        String resourceGroupName, String registryName, String componentName, Context context) {
    ...
    private PollerFlux<PollResult<ComponentContainerInner>, ComponentContainerInner> beginCreateOrUpdateAsync(
        ...
        return this
            .client
            .<ComponentContainerInner, ComponentContainerInner>getLroResult(
                mono,
                this.client.getHttpPipeline(),
                ComponentContainerInner.class,
                ComponentContainerInner.class,
    ...
    public SyncPoller<PollResult<ComponentContainerInner>, ComponentContainerInner> beginCreateOrUpdate(
        String resourceGroupName, String registryName, String componentName, ComponentContainerInner body) {
        return beginCreateOrUpdateAsync(resourceGroupName, registryName, componentName, body).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<ComponentContainerInner>, ComponentContainerInner> beginCreateOrUpdate(
        ...
        ComponentContainerInner body,
        Context context) {
        return beginCreateOrUpdateAsync(resourceGroupName, registryName, componentName, body, context).getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ComponentContainerInner> createOrUpdateAsync(
        String resourceGroupName, String registryName, String componentName, ComponentContainerInner body) {
        return beginCreateOrUpdateAsync(resourceGroupName, registryName, componentName, body)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<ComponentContainerInner> createOrUpdateAsync(
        ...
        ComponentContainerInner body,
        Context context) {
        return beginCreateOrUpdateAsync(resourceGroupName, registryName, componentName, body, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ComponentContainerInner createOrUpdate(
        String resourceGroupName, String registryName, String componentName, ComponentContainerInner body) {
