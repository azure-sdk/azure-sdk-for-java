...
public final class ManagedNetworkSettingsRulesImpl implements ManagedNetworkSettingsRules {
    ...
    public ManagedNetworkSettingsRulesImpl(
        ManagedNetworkSettingsRulesClient innerClient,
    ...
    public PagedIterable<OutboundRuleBasicResource> list(String resourceGroupName, String workspaceName) {
        ...
        return Utils.mapPage(inner, inner1 -> new OutboundRuleBasicResourceImpl(inner1, this.manager()));
    }

    public PagedIterable<OutboundRuleBasicResource> list(
    ...
    public Response<OutboundRuleBasicResource> getWithResponse(
    ...
    public OutboundRuleBasicResource getById(String id) {
        ...
        String ruleName = Utils.getValueFromIdByName(id, "outboundRules");
        if (ruleName == null) {
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException(
