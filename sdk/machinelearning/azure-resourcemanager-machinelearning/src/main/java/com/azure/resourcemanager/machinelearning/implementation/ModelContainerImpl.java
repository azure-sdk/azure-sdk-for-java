...
public final class ModelContainerImpl implements ModelContainer, ModelContainer.Definition, ModelContainer.Update {
    ...
    public ModelContainer create() {
        this.innerObject = serviceManager.serviceClient().getRegistryModelContainers().createOrUpdate(resourceGroupName,
            registryName, modelName, this.innerModel(), Context.NONE);
        return this;
    }

    public ModelContainer create(Context context) {
        this.innerObject = serviceManager.serviceClient().getRegistryModelContainers().createOrUpdate(resourceGroupName,
            registryName, modelName, this.innerModel(), context);
        return this;
    }
    ...
    public ModelContainer refresh() {
        this.innerObject = serviceManager.serviceClient().getRegistryModelContainers()
            .getWithResponse(resourceGroupName, registryName, modelName, Context.NONE).getValue();
        return this;
    }

    public ModelContainer refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getRegistryModelContainers()
            .getWithResponse(resourceGroupName, registryName, modelName, context).getValue();
        return this;
    }
