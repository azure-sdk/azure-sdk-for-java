...
public final class InferenceGroupsClientImpl implements InferenceGroupsClient {
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String workspaceName, String poolName, String groupName,
        Context context) {
        return beginDeleteAsync(resourceGroupName, workspaceName, poolName, groupName, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<Response<InferenceGroupInner>> getWithResponseAsync(String resourceGroupName, String workspaceName,
        ...
        return service.get(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName, workspaceName,
            poolName, groupName, this.client.getApiVersion(), accept, context);
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> updateWithResponseAsync(String resourceGroupName, String workspaceName,
        String poolName, String groupName, PartialMinimalTrackedResourceWithSku body, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    private PollerFlux<PollResult<InferenceGroupInner>, InferenceGroupInner> beginUpdateAsync(String resourceGroupName,
        ...
        return this.client.<InferenceGroupInner, InferenceGroupInner>getLroResult(mono, this.client.getHttpPipeline(),
            InferenceGroupInner.class, InferenceGroupInner.class, context);
    }
    ...
    public SyncPoller<PollResult<InferenceGroupInner>, InferenceGroupInner> beginUpdate(String resourceGroupName,
        String workspaceName, String poolName, String groupName, PartialMinimalTrackedResourceWithSku body,
        Context context) {
        return this.beginUpdateAsync(resourceGroupName, workspaceName, poolName, groupName, body, context)
            .getSyncPoller();
    }
    ...
    private Mono<InferenceGroupInner> updateAsync(String resourceGroupName, String workspaceName, String poolName,
        ...
        return beginUpdateAsync(resourceGroupName, workspaceName, poolName, groupName, body, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    public SyncPoller<PollResult<InferenceGroupInner>, InferenceGroupInner> beginCreateOrUpdate(
        String resourceGroupName, String workspaceName, String poolName, String groupName, InferenceGroupInner body) {
        return this.beginCreateOrUpdateAsync(resourceGroupName, workspaceName, poolName, groupName, body)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<InferenceGroupInner>, InferenceGroupInner> beginCreateOrUpdate(
        String resourceGroupName, String workspaceName, String poolName, String groupName, InferenceGroupInner body,
        Context context) {
        return this.beginCreateOrUpdateAsync(resourceGroupName, workspaceName, poolName, groupName, body, context)
            .getSyncPoller();
    }
    ...
    private Mono<InferenceGroupInner> createOrUpdateAsync(String resourceGroupName, String workspaceName,
        ...
        return beginCreateOrUpdateAsync(resourceGroupName, workspaceName, poolName, groupName, body, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<DeltaModelStatusResponseInner>> getDeltaModelsStatusAsyncWithResponseAsync(
        String resourceGroupName, String workspaceName, String poolName, String groupName, DeltaModelStatusRequest body,
        Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.getDeltaModelsStatusAsync(this.client.getEndpoint(), this.client.getSubscriptionId(),
    ...
    private Mono<PagedResponse<String>> listDeltaModelsAsyncSinglePageAsync(String resourceGroupName,
        ...
        context = this.client.mergeContext(context);
        return service
            .listDeltaModelsAsync(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
                workspaceName, poolName, groupName, this.client.getApiVersion(), body, accept, context)
            .map(res -> new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(),
                res.getValue().value(), res.getValue().nextLink(), null));
    }
    ...
    private PagedFlux<String> listDeltaModelsAsyncAsync(String resourceGroupName, String workspaceName, String poolName,
        ...
        return new PagedFlux<>(() -> listDeltaModelsAsyncSinglePageAsync(resourceGroupName, workspaceName, poolName,
            groupName, body, context), nextLink -> listDeltaModelsAsyncNextSinglePageAsync(nextLink, context));
    }
    ...
    public PagedIterable<String> listDeltaModelsAsync(String resourceGroupName, String workspaceName, String poolName,
        String groupName, DeltaModelListRequest body) {
        return new PagedIterable<>(
            listDeltaModelsAsyncAsync(resourceGroupName, workspaceName, poolName, groupName, body));
    }
    ...
    public PagedIterable<String> listDeltaModelsAsync(String resourceGroupName, String workspaceName, String poolName,
        String groupName, DeltaModelListRequest body, Context context) {
        return new PagedIterable<>(
            listDeltaModelsAsyncAsync(resourceGroupName, workspaceName, poolName, groupName, body, context));
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> modifyDeltaModelsAsyncWithResponseAsync(String resourceGroupName,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.modifyDeltaModelsAsync(this.client.getEndpoint(), this.client.getSubscriptionId(),
            resourceGroupName, workspaceName, poolName, groupName, this.client.getApiVersion(), body, accept, context);
    }
    ...
    private PollerFlux<PollResult<Void>, Void> beginModifyDeltaModelsAsyncAsync(String resourceGroupName,
        String workspaceName, String poolName, String groupName, DeltaModelModifyRequest body, Context context) {
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono = modifyDeltaModelsAsyncWithResponseAsync(resourceGroupName,
            workspaceName, poolName, groupName, body, context);
        return this.client.<Void, Void>getLroResult(mono, this.client.getHttpPipeline(), Void.class, Void.class,
            context);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginModifyDeltaModelsAsync(String resourceGroupName,
        String workspaceName, String poolName, String groupName, DeltaModelModifyRequest body) {
        return this.beginModifyDeltaModelsAsyncAsync(resourceGroupName, workspaceName, poolName, groupName, body)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginModifyDeltaModelsAsync(String resourceGroupName,
        String workspaceName, String poolName, String groupName, DeltaModelModifyRequest body, Context context) {
        return this
            .beginModifyDeltaModelsAsyncAsync(resourceGroupName, workspaceName, poolName, groupName, body, context)
            .getSyncPoller();
    }
    ...
    private Mono<Void> modifyDeltaModelsAsyncAsync(String resourceGroupName, String workspaceName, String poolName,
        ...
        return beginModifyDeltaModelsAsyncAsync(resourceGroupName, workspaceName, poolName, groupName, body, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    public void modifyDeltaModelsAsync(String resourceGroupName, String workspaceName, String poolName,
        String groupName, DeltaModelModifyRequest body) {
        modifyDeltaModelsAsyncAsync(resourceGroupName, workspaceName, poolName, groupName, body).block();
    }
    ...
    public void modifyDeltaModelsAsync(String resourceGroupName, String workspaceName, String poolName,
        String groupName, DeltaModelModifyRequest body, Context context) {
        modifyDeltaModelsAsyncAsync(resourceGroupName, workspaceName, poolName, groupName, body, context).block();
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<SkuResourceInner>> listSkusSinglePageAsync(String resourceGroupName,
        String workspaceName, String poolName, String groupName, Integer count, String skip, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service
            .listSkus(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName, workspaceName,
                poolName, groupName, this.client.getApiVersion(), count, skip, accept, context)
            .map(res -> new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(),
                res.getValue().value(), res.getValue().nextLink(), null));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<String>> listDeltaModelsAsyncNextSinglePageAsync(String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        if (this.client.getEndpoint() == null) {
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.listDeltaModelsAsyncNext(nextLink, this.client.getEndpoint(), accept, context)
            .map(res -> new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(),
                res.getValue().value(), res.getValue().nextLink(), null));
    }
