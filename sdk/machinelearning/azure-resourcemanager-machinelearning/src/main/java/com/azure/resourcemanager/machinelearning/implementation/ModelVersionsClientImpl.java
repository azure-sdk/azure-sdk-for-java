...
public final class ModelVersionsClientImpl implements ModelVersionsClient {
    ...
    public interface ModelVersionsService {
        ...
        Mono<Response<ModelVersionResourceArmPaginatedResult>> list(@HostParam("$host") String endpoint,
            ...
            @QueryParam("offset") Integer offset, @QueryParam("tags") String tags,
            @QueryParam("properties") String properties, @QueryParam("feed") String feed,
            @QueryParam("listViewType") ListViewType listViewType, @QueryParam("stage") String stage,
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ModelVersionInner>> createOrUpdate(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("workspaceName") String workspaceName,
            @PathParam("name") String name, @PathParam("version") String version,
        ...
        @Headers({ "Content-Type: application/json" })
        @Post("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/models/{name}/versions/{version}/package")
        @ExpectedResponses({ 200, 202 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Flux<ByteBuffer>>> packageMethod(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("workspaceName") String workspaceName,
            @PathParam("name") String name, @PathParam("version") String version,
            @QueryParam("api-version") String apiVersion, @BodyParam("application/json") PackageRequest body,
            @HeaderParam("Accept") String accept, Context context);
    ...
    private Mono<PagedResponse<ModelVersionInner>> listSinglePageAsync(String resourceGroupName, String workspaceName,
        ...
        String tags, String properties, String feed, ListViewType listViewType, String stage) {
        ...
        return FluxUtil
            .withContext(context -> service.list(this.client.getEndpoint(), this.client.getSubscriptionId(),
                resourceGroupName, workspaceName, name, this.client.getApiVersion(), skip, orderBy, top, version,
                description, offset, tags, properties, feed, listViewType, stage, accept, context))
    ...
    private Mono<PagedResponse<ModelVersionInner>> listSinglePageAsync(String resourceGroupName, String workspaceName,
        String name, String skip, String orderBy, Integer top, String version, String description, Integer offset,
        String tags, String properties, String feed, ListViewType listViewType, String stage, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service
            .list(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName, workspaceName, name,
                this.client.getApiVersion(), skip, orderBy, top, version, description, offset, tags, properties, feed,
                listViewType, stage, accept, context)
    ...
    private PagedFlux<ModelVersionInner> listAsync(String resourceGroupName, String workspaceName, String name,
        ...
        String properties, String feed, ListViewType listViewType, String stage) {
        return new PagedFlux<>(() -> listSinglePageAsync(resourceGroupName, workspaceName, name, skip, orderBy, top,
            version, description, offset, tags, properties, feed, listViewType, stage),
    ...
    private PagedFlux<ModelVersionInner> listAsync(String resourceGroupName, String workspaceName, String name,
        String skip, String orderBy, Integer top, String version, String description, Integer offset, String tags,
        String properties, String feed, ListViewType listViewType, String stage, Context context) {
        return new PagedFlux<>(
            () -> listSinglePageAsync(resourceGroupName, workspaceName, name, skip, orderBy, top, version, description,
                offset, tags, properties, feed, listViewType, stage, context),
    ...
    public PagedIterable<ModelVersionInner> list(String resourceGroupName, String workspaceName, String name) {
        ...
        final ListViewType listViewType = null;
        final String stage = null;
        return new PagedIterable<>(listAsync(resourceGroupName, workspaceName, name, skip, orderBy, top, version,
            description, offset, tags, properties, feed, listViewType, stage));
    }
    ...
    public PagedIterable<ModelVersionInner> list(String resourceGroupName, String workspaceName, String name,
        ...
        String properties, String feed, ListViewType listViewType, String stage, Context context) {
        return new PagedIterable<>(listAsync(resourceGroupName, workspaceName, name, skip, orderBy, top, version,
            description, offset, tags, properties, feed, listViewType, stage, context));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ModelVersionInner>> createOrUpdateWithResponseAsync(String resourceGroupName,
        String workspaceName, String name, String version, ModelVersionInner body, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return package response returned after async package operation completes successfully along with
     * {@link Response} on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> packageMethodWithResponseAsync(String resourceGroupName,
        String workspaceName, String name, String version, PackageRequest body) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.packageMethod(this.client.getEndpoint(), this.client.getSubscriptionId(),
                resourceGroupName, workspaceName, name, version, this.client.getApiVersion(), body, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> packageMethodWithResponseAsync(String resourceGroupName,
        String workspaceName, String name, String version, PackageRequest body, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.packageMethod(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            workspaceName, name, version, this.client.getApiVersion(), body, accept, context);
    }
    ...
    private PollerFlux<PollResult<PackageResponseInner>, PackageResponseInner> beginPackageMethodAsync(
        ...
        return this.client.<PackageResponseInner, PackageResponseInner>getLroResult(mono, this.client.getHttpPipeline(),
            PackageResponseInner.class, PackageResponseInner.class, this.client.getContext());
    }
    ...
    private PollerFlux<PollResult<PackageResponseInner>, PackageResponseInner> beginPackageMethodAsync(
        ...
        return this.client.<PackageResponseInner, PackageResponseInner>getLroResult(mono, this.client.getHttpPipeline(),
            PackageResponseInner.class, PackageResponseInner.class, context);
    }
    ...
    public SyncPoller<PollResult<PackageResponseInner>, PackageResponseInner> beginPackageMethod(
        String resourceGroupName, String workspaceName, String name, String version, PackageRequest body,
        Context context) {
        return this.beginPackageMethodAsync(resourceGroupName, workspaceName, name, version, body, context)
            .getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PackageResponseInner> packageMethodAsync(String resourceGroupName, String workspaceName, String name,
        String version, PackageRequest body) {
        return beginPackageMethodAsync(resourceGroupName, workspaceName, name, version, body).last()
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PackageResponseInner> packageMethodAsync(String resourceGroupName, String workspaceName, String name,
        String version, PackageRequest body, Context context) {
        return beginPackageMethodAsync(resourceGroupName, workspaceName, name, version, body, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public PackageResponseInner packageMethod(String resourceGroupName, String workspaceName, String name,
        String version, PackageRequest body) {
