...
public final class ModelVersionsClientImpl implements ModelVersionsClient {
    ...
    private Mono<PagedResponse<ModelVersionInner>> listSinglePageAsync(String resourceGroupName, String workspaceName,
        String name, String skip, String orderBy, Integer top, String version, String description, Integer offset,
        String tags, String properties, String feed, ListViewType listViewType, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    public PagedIterable<ModelVersionInner> list(String resourceGroupName, String workspaceName, String name) {
        ...
        return new PagedIterable<>(listAsync(resourceGroupName, workspaceName, name, skip, orderBy, top, version,
            description, offset, tags, properties, feed, listViewType));
    }
    ...
    public PagedIterable<ModelVersionInner> list(String resourceGroupName, String workspaceName, String name,
        ...
        String properties, String feed, ListViewType listViewType, Context context) {
        return new PagedIterable<>(listAsync(resourceGroupName, workspaceName, name, skip, orderBy, top, version,
            description, offset, tags, properties, feed, listViewType, context));
    }
