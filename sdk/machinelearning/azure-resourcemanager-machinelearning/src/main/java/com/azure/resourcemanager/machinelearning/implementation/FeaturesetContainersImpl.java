...
public final class FeaturesetContainersImpl implements FeaturesetContainers {
    ...
    public FeaturesetContainersImpl(
        FeaturesetContainersClient innerClient,
    ...
    public PagedIterable<FeaturesetContainer> list(String resourceGroupName, String workspaceName) {
        ...
        return Utils.mapPage(inner, inner1 -> new FeaturesetContainerImpl(inner1, this.manager()));
    }

    public PagedIterable<FeaturesetContainer> list(
        ...
        Context context) {
        PagedIterable<FeaturesetContainerInner> inner =
    ...
    public Response<FeaturesetContainer> getEntityWithResponse(
