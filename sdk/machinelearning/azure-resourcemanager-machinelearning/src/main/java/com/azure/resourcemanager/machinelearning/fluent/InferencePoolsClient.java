...
public interface InferencePoolsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<InferencePoolInner> list(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<InferencePoolInner> getWithResponse(
        String resourceGroupName, String workspaceName, String name, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    InferencePoolInner get(String resourceGroupName, String workspaceName, String name);
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<InferencePoolInner>, InferencePoolInner> beginUpdate(
        String resourceGroupName,
        String workspaceName,
        String name,
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<InferencePoolInner>, InferencePoolInner> beginCreateOrUpdate(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    InferencePoolInner createOrUpdate(
        String resourceGroupName, String workspaceName, String name, InferencePoolInner body);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<SkuResourceInner> listSkus(String resourceGroupName, String workspaceName, String name);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<PoolStatusInner> getStatusWithResponse(
        String resourceGroupName, String workspaceName, String name, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    PoolStatusInner getStatus(String resourceGroupName, String workspaceName, String name);
}
