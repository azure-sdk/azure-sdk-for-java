...
public interface ComponentVersionsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<ComponentVersionInner> getWithResponse(String resourceGroupName, String workspaceName, String name,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<ComponentVersionInner> createOrUpdateWithResponse(String resourceGroupName, String workspaceName,
