...
public final class CapabilityHostProperties extends ResourceBase {
    ...
    /*
     * List of Memory connections.
     */
    private List<String> memoryConnections;
    ...
    /**
     * Get the memoryConnections property: List of Memory connections.
     * 
     * @return the memoryConnections value.
     */
    public List<String> memoryConnections() {
        return this.memoryConnections;
    }

    /**
     * Set the memoryConnections property: List of Memory connections.
     * 
     * @param memoryConnections the memoryConnections value to set.
     * @return the CapabilityHostProperties object itself.
     */
    public CapabilityHostProperties withMemoryConnections(List<String> memoryConnections) {
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeArrayField("memoryConnections", this.memoryConnections,
            (writer, element) -> writer.writeString(element));
    ...
    public static CapabilityHostProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                } else if ("memoryConnections".equals(fieldName)) {
                    List<String> memoryConnections = reader.readArray(reader1 -> reader1.getString());
                    deserializedCapabilityHostProperties.memoryConnections = memoryConnections;
