...
public final class CapabilityHostProperties extends ResourceBase {
    ...
    /**
     * Get the connectionName property: connection name.
     * 
    ...
    /**
     * Set the connectionName property: connection name.
     * 
     * @param connectionName the connectionName value to set.
     * @return the CapabilityHostProperties object itself.
     */
    public CapabilityHostProperties withConnectionName(String connectionName) {
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("description".equals(fieldName)) {
                    ...
                    deserializedCapabilityHostProperties.connectionName = reader.getString();
