...
public final class ManagedNetworkProvisionsImpl implements ManagedNetworkProvisions {
    ...
    public ManagedNetworkProvisionStatus provisionManagedNetwork(
        String resourceGroupName, String workspaceName, ManagedNetworkProvisionOptions parameters, Context context) {
        ManagedNetworkProvisionStatusInner inner =
            this.serviceClient().provisionManagedNetwork(resourceGroupName, workspaceName, parameters, context);
        if (inner != null) {
            return new ManagedNetworkProvisionStatusImpl(inner, this.manager());
        } else {
            return null;
