...
public interface FeaturesetVersions {
     ...
     * @return a paginated list of FeaturesetVersion entities as paginated response with {@link PagedIterable}.
     */
    PagedIterable<FeaturesetVersion> list(
     ...
     */
    Response<FeaturesetVersion> getWithResponse(
     ...
     */
    FeaturesetVersionBackfillResponse backfill(
        String resourceGroupName,
        String workspaceName,
        String name,
        String version,
     ...
     */
    Response<Feature> getFeatureWithResponse(
        String resourceGroupName,
        String workspaceName,
        String name,
        String version,
     ...
     */
    PagedIterable<Feature> listFeatures(String resourceGroupName, String workspaceName, String name, String version);
