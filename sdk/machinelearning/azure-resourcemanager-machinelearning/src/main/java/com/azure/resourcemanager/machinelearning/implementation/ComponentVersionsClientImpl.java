...
public final class ComponentVersionsClientImpl implements ComponentVersionsClient {
    ...
    /**
     * The interface defining all the services for AzureMachineLearningServicesComponentVersions to be used by the
    ...
    public interface ComponentVersionsService {
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ComponentVersionInner>> createOrUpdate(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("workspaceName") String workspaceName,
            @PathParam("name") String name, @PathParam("version") String version,
    ...
    private Mono<PagedResponse<ComponentVersionInner>> listSinglePageAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(context -> service.list(this.client.getEndpoint(), this.client.getSubscriptionId(),
                resourceGroupName, workspaceName, name, this.client.getApiVersion(), orderBy, top, skip, listViewType,
    ...
    private Mono<PagedResponse<ComponentVersionInner>> listSinglePageAsync(String resourceGroupName,
        ...
        return service
            .list(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName, workspaceName, name,
                this.client.getApiVersion(), orderBy, top, skip, listViewType, stage, accept, context)
    ...
    private PagedFlux<ComponentVersionInner> listAsync(String resourceGroupName, String workspaceName, String name,
        String orderBy, Integer top, String skip, ListViewType listViewType, String stage) {
    ...
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<ComponentVersionInner> listAsync(String resourceGroupName, String workspaceName, String name,
        String orderBy, Integer top, String skip, ListViewType listViewType, String stage, Context context) {
        return new PagedFlux<>(() -> listSinglePageAsync(resourceGroupName, workspaceName, name, orderBy, top, skip,
            listViewType, stage, context), nextLink -> listNextSinglePageAsync(nextLink, context));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ComponentVersionInner>> createOrUpdateWithResponseAsync(String resourceGroupName,
        String workspaceName, String name, String version, ComponentVersionInner body, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
