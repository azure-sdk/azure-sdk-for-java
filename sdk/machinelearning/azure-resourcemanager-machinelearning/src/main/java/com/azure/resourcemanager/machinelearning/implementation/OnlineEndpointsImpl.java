...
public final class OnlineEndpointsImpl implements OnlineEndpoints {
    ...
    public PagedIterable<OnlineEndpoint> list(String resourceGroupName, String workspaceName, String name,
        ...
        PagedIterable<OnlineEndpointInner> inner = this.serviceClient().list(resourceGroupName, workspaceName, name,
            count, computeType, skip, tags, properties, orderBy, context);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new OnlineEndpointImpl(inner1, this.manager()));
    }
