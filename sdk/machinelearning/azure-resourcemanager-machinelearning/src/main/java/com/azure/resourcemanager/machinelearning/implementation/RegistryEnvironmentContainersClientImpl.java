...
public final class RegistryEnvironmentContainersClientImpl implements RegistryEnvironmentContainersClient {
    ...
    RegistryEnvironmentContainersClientImpl(AzureMachineLearningServicesImpl client) {
        this.service =
            RestProxy
                .create(
                    RegistryEnvironmentContainersService.class,
    ...
    private interface RegistryEnvironmentContainersService {
        @Headers({"Content-Type: application/json"})
        @Get(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers"
                + "/Microsoft.MachineLearningServices/registries/{registryName}/environments")
        ...
        @Delete(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers"
                + "/Microsoft.MachineLearningServices/registries/{registryName}/environments/{environmentName}")
    ...
    private Mono<PagedResponse<EnvironmentContainerInner>> listSinglePageAsync(
        String resourceGroupName, String registryName, String skip, ListViewType listViewType) {
    ...
    private PagedFlux<EnvironmentContainerInner> listAsync(
        ...
        return new PagedFlux<>(
            () -> listSinglePageAsync(resourceGroupName, registryName, skip, listViewType),
    ...
    private PagedFlux<EnvironmentContainerInner> listAsync(
        String resourceGroupName, String registryName, String skip, ListViewType listViewType, Context context) {
        return new PagedFlux<>(
            () -> listSinglePageAsync(resourceGroupName, registryName, skip, listViewType, context),
    ...
    private PollerFlux<PollResult<Void>, Void> beginDeleteAsync(
        ...
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono =
            deleteWithResponseAsync(resourceGroupName, registryName, environmentName, context);
        return this
            .client
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(
        String resourceGroupName, String registryName, String environmentName) {
        return beginDeleteAsync(resourceGroupName, registryName, environmentName).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(
        String resourceGroupName, String registryName, String environmentName, Context context) {
        return beginDeleteAsync(resourceGroupName, registryName, environmentName, context).getSyncPoller();
    }
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String registryName, String environmentName) {
        return beginDeleteAsync(resourceGroupName, registryName, environmentName)
            .last()
    ...
    private Mono<Void> deleteAsync(
        String resourceGroupName, String registryName, String environmentName, Context context) {
        return beginDeleteAsync(resourceGroupName, registryName, environmentName, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    public void delete(String resourceGroupName, String registryName, String environmentName) {
        deleteAsync(resourceGroupName, registryName, environmentName).block();
    }
    ...
    public void delete(String resourceGroupName, String registryName, String environmentName, Context context) {
        deleteAsync(resourceGroupName, registryName, environmentName, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<EnvironmentContainerInner> getAsync(
        String resourceGroupName, String registryName, String environmentName) {
    ...
    public EnvironmentContainerInner get(String resourceGroupName, String registryName, String environmentName) {
        return getAsync(resourceGroupName, registryName, environmentName).block();
    }
    ...
    public Response<EnvironmentContainerInner> getWithResponse(
        String resourceGroupName, String registryName, String environmentName, Context context) {
        return getWithResponseAsync(resourceGroupName, registryName, environmentName, context).block();
    }
    ...
    private PollerFlux<PollResult<EnvironmentContainerInner>, EnvironmentContainerInner> beginCreateOrUpdateAsync(
        ...
        return this
            .client
            .<EnvironmentContainerInner, EnvironmentContainerInner>getLroResult(
                mono,
    ...
    private PollerFlux<PollResult<EnvironmentContainerInner>, EnvironmentContainerInner> beginCreateOrUpdateAsync(
        ...
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono =
            createOrUpdateWithResponseAsync(resourceGroupName, registryName, environmentName, body, context);
        return this
            .client
            .<EnvironmentContainerInner, EnvironmentContainerInner>getLroResult(
                mono,
    ...
    public SyncPoller<PollResult<EnvironmentContainerInner>, EnvironmentContainerInner> beginCreateOrUpdate(
        String resourceGroupName, String registryName, String environmentName, EnvironmentContainerInner body) {
        return beginCreateOrUpdateAsync(resourceGroupName, registryName, environmentName, body).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<EnvironmentContainerInner>, EnvironmentContainerInner> beginCreateOrUpdate(
        ...
        EnvironmentContainerInner body,
        Context context) {
        return beginCreateOrUpdateAsync(resourceGroupName, registryName, environmentName, body, context)
            .getSyncPoller();
    }
    ...
    private Mono<EnvironmentContainerInner> createOrUpdateAsync(
        String resourceGroupName, String registryName, String environmentName, EnvironmentContainerInner body) {
        return beginCreateOrUpdateAsync(resourceGroupName, registryName, environmentName, body)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    public EnvironmentContainerInner createOrUpdate(
        String resourceGroupName, String registryName, String environmentName, EnvironmentContainerInner body) {
        return createOrUpdateAsync(resourceGroupName, registryName, environmentName, body).block();
    }
    ...
    public EnvironmentContainerInner createOrUpdate(
        ...
        EnvironmentContainerInner body,
        Context context) {
        return createOrUpdateAsync(resourceGroupName, registryName, environmentName, body, context).block();
    }
