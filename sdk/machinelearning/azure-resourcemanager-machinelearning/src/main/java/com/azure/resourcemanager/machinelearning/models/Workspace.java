...
public interface Workspace {
    ...
    interface DefinitionStages {
        ...
        interface WithEnableSoftwareBillOfMaterials {
            /**
             * Specifies the enableSoftwareBillOfMaterials property: Flag to tell if SoftwareBillOfMaterial should be
             * enabled for this workspace.
             * 
             * @param enableSoftwareBillOfMaterials Flag to tell if SoftwareBillOfMaterial should be enabled for this
             * workspace.
             * @return the next definition stage.
             */
