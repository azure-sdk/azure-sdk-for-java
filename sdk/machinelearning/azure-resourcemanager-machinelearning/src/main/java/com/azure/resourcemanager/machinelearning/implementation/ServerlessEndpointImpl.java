...
public final class ServerlessEndpointImpl
    ...
    public ServerlessEndpoint create() {
        this.innerObject = serviceManager.serviceClient().getServerlessEndpoints().createOrUpdate(resourceGroupName,
    ...
    public ServerlessEndpoint apply() {
        this.innerObject = serviceManager.serviceClient().getServerlessEndpoints().update(resourceGroupName,
            workspaceName, name, updateBody, Context.NONE);
        return this;
    }

    public ServerlessEndpoint apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getServerlessEndpoints().update(resourceGroupName,
            workspaceName, name, updateBody, context);
        return this;
    }
    ...
    ServerlessEndpointImpl(ServerlessEndpointInner innerObject,
        ...
        this.name = Utils.getValueFromIdByName(innerObject.id(), "serverlessEndpoints");
    }

    public ServerlessEndpoint refresh() {
        this.innerObject = serviceManager.serviceClient().getServerlessEndpoints()
    ...
    public Response<ServerlessEndpointStatus> getStatusWithResponse(Context context) {
        return serviceManager.serverlessEndpoints().getStatusWithResponse(resourceGroupName, workspaceName, name,
            context);
    }

    public ServerlessEndpointStatus getStatus() {
        return serviceManager.serverlessEndpoints().getStatus(resourceGroupName, workspaceName, name);
    }

    public Response<EndpointAuthKeys> listKeysWithResponse(Context context) {
        return serviceManager.serverlessEndpoints().listKeysWithResponse(resourceGroupName, workspaceName, name,
            context);
    }
