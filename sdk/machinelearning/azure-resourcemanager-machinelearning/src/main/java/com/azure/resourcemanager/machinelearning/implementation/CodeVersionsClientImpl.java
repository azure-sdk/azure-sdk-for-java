...
public final class CodeVersionsClientImpl implements CodeVersionsClient {
    ...
    public interface CodeVersionsService {
        ...
        @Headers({"Content-Type: application/json"})
        @Post(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/codes/{name}/versions/pendingUpload/{version}")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
    ...
    private Mono<PendingUploadResponseDtoInner> createOrGetPendingUploadAsync(
        String resourceGroupName, String workspaceName, String name, String version, PendingUploadRequestDto body) {
        return createOrGetPendingUploadWithResponseAsync(resourceGroupName, workspaceName, name, version, body)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
    ...
    public Response<PendingUploadResponseDtoInner> createOrGetPendingUploadWithResponse(
        ...
        PendingUploadRequestDto body,
        Context context) {
        return createOrGetPendingUploadWithResponseAsync(resourceGroupName, workspaceName, name, version, body, context)
            .block();
    }
    ...
    public PendingUploadResponseDtoInner createOrGetPendingUpload(
        String resourceGroupName, String workspaceName, String name, String version, PendingUploadRequestDto body) {
        return createOrGetPendingUploadWithResponse(resourceGroupName, workspaceName, name, version, body, Context.NONE)
            .getValue();
    }
