...
public final class LabelingJobImpl implements LabelingJob, LabelingJob.Definition, LabelingJob.Update {
    ...
    public LabelingJob create() {
        this.innerObject = serviceManager.serviceClient().getLabelingJobs().createOrUpdate(resourceGroupName,
            workspaceName, id, this.innerModel(), Context.NONE);
        return this;
    }

    public LabelingJob create(Context context) {
        this.innerObject = serviceManager.serviceClient().getLabelingJobs().createOrUpdate(resourceGroupName,
            workspaceName, id, this.innerModel(), context);
        return this;
    }
    ...
    LabelingJobImpl(LabelingJobInner innerObject,
        com.azure.resourcemanager.machinelearning.MachineLearningManager serviceManager) {
        this.innerObject = innerObject;
        this.serviceManager = serviceManager;
        this.resourceGroupName = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "resourceGroups");
        this.workspaceName = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "workspaces");
        this.id = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "labelingJobs");
    }

    public LabelingJob refresh() {
        this.innerObject = serviceManager.serviceClient().getLabelingJobs()
