...
public interface FeaturesetContainersClient {
    ...
    PagedIterable<FeaturesetContainerInner> list(String resourceGroupName, String workspaceName);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<FeaturesetContainerInner> list(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<FeaturesetContainerInner> getEntityWithResponse(
        String resourceGroupName, String workspaceName, String name, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<FeaturesetContainerInner>, FeaturesetContainerInner> beginCreateOrUpdate(
