...
public final class WorkspacePropertiesUpdateParametersInner
     ...
     * @return the WorkspacePropertiesUpdateParametersInner object itself.
     */
    public WorkspacePropertiesUpdateParametersInner withSystemDatastoresAuthMode(String systemDatastoresAuthMode) {
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("allowRoleAssignmentOnRG".equals(fieldName)) {
                    ...
                    deserializedWorkspacePropertiesUpdateParametersInner.systemDatastoresAuthMode = reader.getString();
