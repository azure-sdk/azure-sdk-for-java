...
public final class ModelVersionInner extends ProxyResource {
    ...
    private ModelVersionProperties properties;
     ...
     */
    public ModelVersionInner withProperties(ModelVersionProperties properties) {
    ...
    public void validate() {
        if (properties() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Missing required property properties in model ModelVersionInner"));
        } else {
            properties().validate();
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(ModelVersionInner.class);
}
