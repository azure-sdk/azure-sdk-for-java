...
@Fluent
public final class OsPatchingStatusAutoGenerated {
    /*
     * The os patching status.
     */
    @JsonProperty(value = "patchStatus")
    private OsPatchingStatus patchStatus;
    ...
    /** Creates an instance of OsPatchingStatusAutoGenerated class. */
    public OsPatchingStatusAutoGenerated() {
    }
     ...
     */
    public OsPatchingStatus patchStatus() {
     ...
     * @return the OsPatchingStatusAutoGenerated object itself.
     */
    public OsPatchingStatusAutoGenerated withPatchStatus(OsPatchingStatus patchStatus) {
     ...
     * @return the OsPatchingStatusAutoGenerated object itself.
     */
    public OsPatchingStatusAutoGenerated withLatestPatchTime(String latestPatchTime) {
     ...
     * @return the OsPatchingStatusAutoGenerated object itself.
     */
    public OsPatchingStatusAutoGenerated withRebootPending(Boolean rebootPending) {
     ...
     * @return the OsPatchingStatusAutoGenerated object itself.
     */
    public OsPatchingStatusAutoGenerated withScheduledRebootTime(String scheduledRebootTime) {
