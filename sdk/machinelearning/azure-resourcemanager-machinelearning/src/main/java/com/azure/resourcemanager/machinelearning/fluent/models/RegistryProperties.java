...
public final class RegistryProperties {
     ...
     */
    @JsonProperty(value = "managedResourceGroupSettings")
    ...
    /*
     * One of the values in Creating/Updating/Deleting/Completed.
     */
    ...
    /**
     * Get the managedResourceGroup property: ResourceId of the managed RG if the registry has system created
     * resources.
     * 
    ...
    /**
     * Set the managedResourceGroup property: ResourceId of the managed RG if the registry has system created
     * resources.
     * 
    ...
    /**
     * Get the provisioningState property: One of the values in Creating/Updating/Deleting/Completed.
     * 
