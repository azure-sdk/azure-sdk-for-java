...
public final class LabelingJobInner extends ProxyResource {
    ...
    private LabelingJobPropertiesInner properties;
     ...
     */
    public LabelingJobPropertiesInner properties() {
     ...
     */
    public LabelingJobInner withProperties(LabelingJobPropertiesInner properties) {
    ...
    public void validate() {
        if (properties() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Missing required property properties in model LabelingJobInner"));
        } else {
            properties().validate();
        }
    }
