...
public final class ConnectionsClientImpl implements ConnectionsClient {
     ...
     */
    ConnectionsClientImpl(AzureMachineLearningServicesImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for AzureMachineLearningServicesConnections to be used by the proxy
    ...
    public interface ConnectionsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<EndpointModelsInner>> listModels(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("workspaceName") String workspaceName,
            @QueryParam("api-version") String apiVersion, @HeaderParam("Accept") String accept, Context context);
    ...
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<EndpointDeploymentResourcePropertiesBasicResourceInner>
        listDeploymentsAsync(String resourceGroupName, String workspaceName, String connectionName, Context context) {
        return new PagedFlux<>(
            () -> listDeploymentsSinglePageAsync(resourceGroupName, workspaceName, connectionName, context),
    ...
    public PagedIterable<EndpointDeploymentResourcePropertiesBasicResourceInner>
        ...
        return new PagedIterable<>(listDeploymentsAsync(resourceGroupName, workspaceName, connectionName));
    }
    ...
    public PagedIterable<EndpointDeploymentResourcePropertiesBasicResourceInner>
        ...
        return new PagedIterable<>(listDeploymentsAsync(resourceGroupName, workspaceName, connectionName, context));
    }
    ...
    private PollerFlux<PollResult<Void>, Void> beginDeleteDeploymentAsync(String resourceGroupName,
        ...
        Mono<Response<Flux<ByteBuffer>>> mono = deleteDeploymentWithResponseAsync(resourceGroupName, workspaceName,
            connectionName, deploymentName, context);
        return this.client.<Void, Void>getLroResult(mono, this.client.getHttpPipeline(), Void.class, Void.class,
            context);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDeleteDeployment(String resourceGroupName, String workspaceName,
        ...
        return this.beginDeleteDeploymentAsync(resourceGroupName, workspaceName, connectionName, deploymentName)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDeleteDeployment(String resourceGroupName, String workspaceName,
        ...
        return this
            .beginDeleteDeploymentAsync(resourceGroupName, workspaceName, connectionName, deploymentName, context)
            .getSyncPoller();
    }
    ...
    private Mono<Void> deleteDeploymentAsync(String resourceGroupName, String workspaceName, String connectionName,
        ...
        return beginDeleteDeploymentAsync(resourceGroupName, workspaceName, connectionName, deploymentName, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    public void deleteDeployment(String resourceGroupName, String workspaceName, String connectionName,
        String deploymentName) {
        deleteDeploymentAsync(resourceGroupName, workspaceName, connectionName, deploymentName).block();
    }
    ...
    public void deleteDeployment(String resourceGroupName, String workspaceName, String connectionName,
        String deploymentName, Context context) {
        deleteDeploymentAsync(resourceGroupName, workspaceName, connectionName, deploymentName, context).block();
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateDeploymentWithResponseAsync(String resourceGroupName,
        ...
        return service.createOrUpdateDeployment(this.client.getEndpoint(), this.client.getSubscriptionId(),
            resourceGroupName, workspaceName, connectionName, deploymentName, this.client.getApiVersion(), body, accept,
            context);
    }
    ...
    private
        ...
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono = createOrUpdateDeploymentWithResponseAsync(resourceGroupName,
            workspaceName, connectionName, deploymentName, body, context);
        return this.client
            .<EndpointDeploymentResourcePropertiesBasicResourceInner, EndpointDeploymentResourcePropertiesBasicResourceInner>getLroResult(
                mono, this.client.getHttpPipeline(), EndpointDeploymentResourcePropertiesBasicResourceInner.class,
    ...
    private PagedFlux<EndpointModelPropertiesInner> getModelsAsync(String resourceGroupName, String workspaceName,
        ...
        return new PagedFlux<>(
            () -> getModelsSinglePageAsync(resourceGroupName, workspaceName, connectionName, context),
    ...
    public PagedIterable<EndpointModelPropertiesInner> getModels(String resourceGroupName, String workspaceName,
        String connectionName) {
        return new PagedIterable<>(getModelsAsync(resourceGroupName, workspaceName, connectionName));
    }
    ...
    public PagedIterable<EndpointModelPropertiesInner> getModels(String resourceGroupName, String workspaceName,
        String connectionName, Context context) {
        return new PagedIterable<>(getModelsAsync(resourceGroupName, workspaceName, connectionName, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<EndpointModelsInner>> listModelsWithResponseAsync(String resourceGroupName,
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.listModels(this.client.getEndpoint(), this.client.getSubscriptionId(),
    ...
    private Mono<Response<EndpointModelsInner>> listModelsWithResponseAsync(String resourceGroupName,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.listModels(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<EndpointModelsInner> listModelsAsync(String resourceGroupName, String workspaceName) {
        return listModelsWithResponseAsync(resourceGroupName, workspaceName)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<EndpointModelsInner> listModelsWithResponse(String resourceGroupName, String workspaceName,
        Context context) {
        return listModelsWithResponseAsync(resourceGroupName, workspaceName, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public EndpointModelsInner listModels(String resourceGroupName, String workspaceName) {
        return listModelsWithResponse(resourceGroupName, workspaceName, Context.NONE).getValue();
    }
