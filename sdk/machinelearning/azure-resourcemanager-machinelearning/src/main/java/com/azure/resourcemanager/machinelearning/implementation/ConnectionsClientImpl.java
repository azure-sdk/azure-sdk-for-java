...
public final class ConnectionsClientImpl implements ConnectionsClient {
    ...
    public interface ConnectionsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<EndpointModels>> getModels(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("workspaceName") String workspaceName,
            @PathParam("connectionName") String connectionName, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<EndpointModels>> getModelsNext(@PathParam(value = "nextLink", encoded = true) String nextLink,
    ...
    public
        ...
        beginCreateOrUpdateDeployment(String resourceGroupName, String workspaceName, String connectionName,
            String deploymentName, EndpointDeploymentResourcePropertiesBasicResourceInner body, Context context) {
        return this.beginCreateOrUpdateDeploymentAsync(resourceGroupName, workspaceName, connectionName, deploymentName,
            body, context).getSyncPoller();
    }
