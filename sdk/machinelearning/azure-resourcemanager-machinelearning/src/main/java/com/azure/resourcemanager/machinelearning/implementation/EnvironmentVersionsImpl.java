...
public final class EnvironmentVersionsImpl implements EnvironmentVersions {
    ...
    public PagedIterable<EnvironmentVersion> list(String resourceGroupName, String workspaceName, String name,
        ...
        PagedIterable<EnvironmentVersionInner> inner = this.serviceClient().list(resourceGroupName, workspaceName, name,
            orderBy, top, skip, listViewType, stage, context);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new EnvironmentVersionImpl(inner1, this.manager()));
    }
    ...
    public Response<EnvironmentVersion> createOrUpdateWithResponse(String resourceGroupName, String workspaceName,
        ...
        Response<EnvironmentVersionInner> inner = this.serviceClient().createOrUpdateWithResponse(resourceGroupName,
