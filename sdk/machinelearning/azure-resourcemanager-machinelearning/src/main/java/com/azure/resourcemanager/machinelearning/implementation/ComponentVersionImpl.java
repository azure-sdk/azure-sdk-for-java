...
public final class ComponentVersionImpl
    ...
    public ComponentVersion create() {
        this.innerObject = serviceManager.serviceClient().getRegistryComponentVersions()
    ...
    public ComponentVersion refresh() {
        this.innerObject = serviceManager.serviceClient().getRegistryComponentVersions()
            .getWithResponse(resourceGroupName, registryName, componentName, version, Context.NONE).getValue();
        return this;
    }

    public ComponentVersion refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getRegistryComponentVersions()
            .getWithResponse(resourceGroupName, registryName, componentName, version, context).getValue();
        return this;
    }
