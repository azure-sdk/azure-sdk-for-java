...
public final class CustomMonitoringSignal extends MonitoringSignalBase {
    ...
    private Map<String, MonitoringInputData> inputAssets;
     ...
     */
    public Map<String, MonitoringInputData> inputAssets() {
     ...
     * @return the CustomMonitoringSignal object itself.
     */
    public CustomMonitoringSignal withInputAssets(Map<String, MonitoringInputData> inputAssets) {
    ...
    /** {@inheritDoc} */
    @Override
    public CustomMonitoringSignal withLookbackPeriod(Duration lookbackPeriod) {
    ...
    /** {@inheritDoc} */
    @Override
    public CustomMonitoringSignal withMode(MonitoringNotificationMode mode) {
        super.withMode(mode);
        return this;
    }
