...
public final class CustomMonitoringSignal extends MonitoringSignalBase {
     ...
     */
    @JsonProperty(value = "workspaceConnection")
    ...
    /**
     * Get the workspaceConnection property: A list of metrics to calculate and their associated thresholds.
     * 
    ...
    /**
     * Set the workspaceConnection property: A list of metrics to calculate and their associated thresholds.
     * 
    ...
    public void validate() {
        ...
        if (componentId() == null) {
            throw LOGGER.logExceptionAsError(
                new IllegalArgumentException("Missing required property componentId in model CustomMonitoringSignal"));
        }
        if (inputAssets() != null) {
