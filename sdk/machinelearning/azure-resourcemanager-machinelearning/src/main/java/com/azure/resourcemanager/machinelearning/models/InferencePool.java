...
/**
 * An immutable client-side representation of InferencePool.
 */
public interface InferencePool {
    /**
     ...
     */
    InferencePoolProperties properties();
    ...
    /**
     * Gets the inner com.azure.resourcemanager.machinelearning.fluent.models.InferencePoolInner object.
     * 
     * @return the inner object.
     */
    InferencePoolInner innerModel();

    /**
     * The entirety of the InferencePool definition.
     */
    ...
    /**
     * The InferencePool definition stages.
     */
    interface DefinitionStages {
        /**
         * The first stage of the InferencePool definition.
         */
        interface Blank extends WithLocation {
        }

        /**
         * The stage of the InferencePool definition allowing to specify location.
         */
        ...
        /**
         * The stage of the InferencePool definition allowing to specify parent resource.
         */
        ...
        /**
         * The stage of the InferencePool definition allowing to specify properties.
         */
        interface WithProperties {
             ...
             * @return the next definition stage.
             */
            WithCreate withProperties(InferencePoolProperties properties);
        }

        /**
         * The stage of the InferencePool definition which contains all the minimum required properties for the resource
        ...
        interface WithCreate extends DefinitionStages.WithTags, DefinitionStages.WithIdentity,
             ...
             * @return the created resource.
             */
            InferencePool create(Context context);
        }

        /**
         * The stage of the InferencePool definition allowing to specify tags.
         */
        interface WithTags {
            /**
        ...
        /**
         * The stage of the InferencePool definition allowing to specify identity.
         */
        ...
        /**
         * The stage of the InferencePool definition allowing to specify kind.
         */
        interface WithKind {
            /**
        ...
        /**
         * The stage of the InferencePool definition allowing to specify sku.
         */
        interface WithSku {
            /**
    ...
    /**
     * Begins update for the InferencePool resource.
     * 
     * @return the stage of resource update.
     */
    InferencePool.Update update();

    /**
     * The template for InferencePool update.
     */
    interface Update extends UpdateStages.WithTags, UpdateStages.WithIdentity, UpdateStages.WithSku {
         ...
         * @return the updated resource.
         */
        InferencePool apply(Context context);
    }

    /**
     * The InferencePool update stages.
     */
    interface UpdateStages {
        /**
         * The stage of the InferencePool update allowing to specify tags.
         */
        interface WithTags {
            /**
             * Specifies the tags property: Resource tags..
        ...
        /**
         * The stage of the InferencePool update allowing to specify identity.
         */
        interface WithIdentity {
            /**
             * Specifies the identity property: Managed service identity (system assigned and/or user assigned
        ...
        /**
         * The stage of the InferencePool update allowing to specify sku.
         */
        interface WithSku {
            /**
             * Specifies the sku property: Sku details required for ARM contract for Autoscaling..
     ...
     * @return the refreshed resource.
     */
    InferencePool refresh(Context context);
     ...
     */
    Response<PoolStatus> getStatusWithResponse(Context context);
