 ...
 */
@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, property = "datastoreType", defaultImpl = HdfsDatastore.class, visible = true)
@JsonTypeName("Hdfs")
@Fluent
public final class HdfsDatastore extends DatastoreProperties {
    ...
    private DatastoreType datastoreType = DatastoreType.HDFS;
    ...
    /**
     * Creates an instance of HdfsDatastore class.
     */
     ...
     */
    @Override
    public HdfsDatastore withIntellectualProperty(IntellectualProperty intellectualProperty) {
    ...
    public void validate() {
        ...
        if (nameNodeAddress() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Missing required property nameNodeAddress in model HdfsDatastore"));
        }
    }
