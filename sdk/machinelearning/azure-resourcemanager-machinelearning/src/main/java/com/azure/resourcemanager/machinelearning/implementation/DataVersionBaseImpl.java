...
public final class DataVersionBaseImpl implements DataVersionBase, DataVersionBase.Definition, DataVersionBase.Update {
    ...
    public DataVersionBase create() {
        this.innerObject = serviceManager.serviceClient().getRegistryDataVersions().createOrUpdate(resourceGroupName,
            registryName, name, version, this.innerModel(), Context.NONE);
        return this;
    }

    public DataVersionBase create(Context context) {
        this.innerObject = serviceManager.serviceClient().getRegistryDataVersions().createOrUpdate(resourceGroupName,
            registryName, name, version, this.innerModel(), context);
        return this;
    }
    ...
    public DataVersionBase refresh() {
        this.innerObject = serviceManager.serviceClient().getRegistryDataVersions()
            .getWithResponse(resourceGroupName, registryName, name, version, Context.NONE).getValue();
        return this;
    }

    public DataVersionBase refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getRegistryDataVersions()
            .getWithResponse(resourceGroupName, registryName, name, version, context).getValue();
        return this;
    }

    public Response<PendingUploadResponseDto> createOrGetStartPendingUploadWithResponse(PendingUploadRequestDto body,
        Context context) {
        return serviceManager.registryDataVersions().createOrGetStartPendingUploadWithResponse(resourceGroupName,
            registryName, name, version, body, context);
    }

    public PendingUploadResponseDto createOrGetStartPendingUpload(PendingUploadRequestDto body) {
        return serviceManager.registryDataVersions().createOrGetStartPendingUpload(resourceGroupName, registryName,
            name, version, body);
    }
