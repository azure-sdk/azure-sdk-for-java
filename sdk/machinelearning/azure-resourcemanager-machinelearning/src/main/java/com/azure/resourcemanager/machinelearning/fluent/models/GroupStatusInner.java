...
public final class GroupStatusInner {
    ...
    /*
     * Gets or sets event log for inference group.
     */
    @JsonProperty(value = "eventLog")
    private List<Object> eventLog;
    ...
    /**
     * Get the eventLog property: Gets or sets event log for inference group.
     *
     * @return the eventLog value.
     */
    ...
    /**
     * Set the eventLog property: Gets or sets event log for inference group.
     *
     * @param eventLog the eventLog value to set.
     * @return the GroupStatusInner object itself.
     */
    public GroupStatusInner withEventLog(List<Object> eventLog) {
