...
public interface ServerlessEndpointsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<ServerlessEndpointStatusInner> getStatusWithResponse(String resourceGroupName, String workspaceName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ServerlessEndpointStatusInner getStatus(String resourceGroupName, String workspaceName, String name);
}
