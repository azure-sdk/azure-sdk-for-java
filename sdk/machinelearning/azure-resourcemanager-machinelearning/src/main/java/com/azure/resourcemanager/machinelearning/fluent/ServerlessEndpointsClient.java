...
public interface ServerlessEndpointsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<ServerlessEndpointInner> list(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<ServerlessEndpointInner> getWithResponse(
        String resourceGroupName, String workspaceName, String name, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<ServerlessEndpointInner>, ServerlessEndpointInner> beginUpdate(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ServerlessEndpointInner update(
        String resourceGroupName,
        String workspaceName,
        String name,
        PartialMinimalTrackedResourceWithSkuAndIdentity body);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ServerlessEndpointInner createOrUpdate(
        String resourceGroupName, String workspaceName, String name, ServerlessEndpointInner body);
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<EndpointAuthKeysInner>, EndpointAuthKeysInner> beginRegenerateKeys(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    EndpointAuthKeysInner regenerateKeys(
        String resourceGroupName, String workspaceName, String name, RegenerateEndpointKeysRequest body);
