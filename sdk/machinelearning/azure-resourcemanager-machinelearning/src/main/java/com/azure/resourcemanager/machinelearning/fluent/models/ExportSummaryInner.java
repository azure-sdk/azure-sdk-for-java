...
import com.azure.resourcemanager.machinelearning.models.ExportFormatType;
 ...
 */
@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, property = "format", defaultImpl = ExportSummaryInner.class, visible = true)
...
public class ExportSummaryInner {
    ...
    public ExportSummaryInner() {
        this.format = ExportFormatType.fromString("ExportSummary");
    }
