...
public final class FeatureStoreSettings {
    ...
    /*
     * The allowRoleAssignmentsOnResourceGroupLevel property.
     */
    @JsonProperty(value = "allowRoleAssignmentsOnResourceGroupLevel")
    private Boolean allowRoleAssignmentsOnResourceGroupLevel;
    ...
    /**
     * Get the allowRoleAssignmentsOnResourceGroupLevel property: The allowRoleAssignmentsOnResourceGroupLevel property.
     *
     * @return the allowRoleAssignmentsOnResourceGroupLevel value.
     */
    public Boolean allowRoleAssignmentsOnResourceGroupLevel() {
        return this.allowRoleAssignmentsOnResourceGroupLevel;
    }

    /**
     * Set the allowRoleAssignmentsOnResourceGroupLevel property: The allowRoleAssignmentsOnResourceGroupLevel property.
     *
     * @param allowRoleAssignmentsOnResourceGroupLevel the allowRoleAssignmentsOnResourceGroupLevel value to set.
     * @return the FeatureStoreSettings object itself.
     */
    public FeatureStoreSettings withAllowRoleAssignmentsOnResourceGroupLevel(
        Boolean allowRoleAssignmentsOnResourceGroupLevel) {
        this.allowRoleAssignmentsOnResourceGroupLevel = allowRoleAssignmentsOnResourceGroupLevel;
        return this;
    }
