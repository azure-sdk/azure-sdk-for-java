...
import com.azure.resourcemanager.machinelearning.models.JobType;
...
@JsonTypeInfo(
    ...
    property = "jobType",
    defaultImpl = LabelingJobPropertiesInner.class,
    visible = true)
...
public final class LabelingJobPropertiesInner extends JobBaseProperties {
    ...
    private JobType jobType = JobType.LABELING;
     ...
     */
    public LabelingJobPropertiesInner
        withLabelingJobMediaProperties(LabelingJobMediaProperties labelingJobMediaProperties) {
    ...
    public void validate() {
        ...
        if (labelCategories() != null) {
            labelCategories().values().forEach(e -> {
                if (e != null) {
                    e.validate();
                }
            });
