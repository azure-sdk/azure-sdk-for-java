...
public final class RegistryImpl implements Registry, Registry.Definition, Registry.Update {
    ...
    public Registry create() {
        this.innerObject = serviceManager.serviceClient().getRegistries().createOrUpdate(resourceGroupName,
            registryName, this.innerModel(), Context.NONE);
        return this;
    }

    public Registry create(Context context) {
        this.innerObject = serviceManager.serviceClient().getRegistries().createOrUpdate(resourceGroupName,
            registryName, this.innerModel(), context);
        return this;
    }
    ...
    public Registry apply() {
        this.innerObject = serviceManager.serviceClient().getRegistries()
            .updateWithResponse(resourceGroupName, registryName, updateBody, Context.NONE).getValue();
        return this;
    }

    public Registry apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getRegistries()
            .updateWithResponse(resourceGroupName, registryName, updateBody, context).getValue();
        return this;
    }
