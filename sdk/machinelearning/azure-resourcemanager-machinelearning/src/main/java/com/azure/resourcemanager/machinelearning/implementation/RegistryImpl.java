...
public final class RegistryImpl implements Registry, Registry.Definition, Registry.Update {
    ...
    public List<PrivateEndpointConnectionAutoGenerated> privateEndpointConnections() {
        List<PrivateEndpointConnectionAutoGenerated> inner = this.innerModel().privateEndpointConnections();
        if (inner != null) {
    ...
    public RegistryImpl withPrivateEndpointConnections(
    ...
    public RegistryImpl withIdentity(PartialManagedServiceIdentityAutoGenerated identity) {
