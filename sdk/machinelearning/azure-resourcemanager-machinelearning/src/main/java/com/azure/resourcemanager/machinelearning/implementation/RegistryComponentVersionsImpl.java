...
public final class RegistryComponentVersionsImpl implements RegistryComponentVersions {
    ...
    public RegistryComponentVersionsImpl(
        RegistryComponentVersionsClient innerClient,
    ...
    public BlobReferenceSasResponseDto getBlobReferenceSas(
        ...
        BlobReferenceSasResponseDtoInner inner =
            this.serviceClient().getBlobReferenceSas(resourceGroupName, registryName, componentName, version, body);
        if (inner != null) {
    ...
    public ComponentVersion getById(String id) {
        ...
        String componentName = Utils.getValueFromIdByName(id, "components");
