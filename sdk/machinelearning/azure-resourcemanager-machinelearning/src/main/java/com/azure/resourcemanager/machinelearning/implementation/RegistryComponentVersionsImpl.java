...
public final class RegistryComponentVersionsImpl implements RegistryComponentVersions {
    ...
    public PagedIterable<ComponentVersion> list(String resourceGroupName, String registryName, String componentName,
        String orderBy, Integer top, String skip, String stage, Context context) {
        PagedIterable<ComponentVersionInner> inner = this.serviceClient().list(resourceGroupName, registryName,
            componentName, orderBy, top, skip, stage, context);
        return Utils.mapPage(inner, inner1 -> new ComponentVersionImpl(inner1, this.manager()));
    }
