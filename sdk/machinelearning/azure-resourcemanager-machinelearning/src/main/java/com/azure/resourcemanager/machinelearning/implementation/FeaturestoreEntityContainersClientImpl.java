...
public final class FeaturestoreEntityContainersClientImpl implements FeaturestoreEntityContainersClient {
    ...
    FeaturestoreEntityContainersClientImpl(AzureMachineLearningServicesImpl client) {
        this.service =
            RestProxy
                .create(
                    FeaturestoreEntityContainersService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }
    ...
    public interface FeaturestoreEntityContainersService {
        ...
        @Get(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers"
                + "/Microsoft.MachineLearningServices/workspaces/{workspaceName}/featurestoreEntities")
        ...
        @Delete(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers"
                + "/Microsoft.MachineLearningServices/workspaces/{workspaceName}/featurestoreEntities/{name}")
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<FeaturestoreEntityContainerInner>> getEntity(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("workspaceName") String workspaceName,
        ...
        Mono<Response<Flux<ByteBuffer>>> createOrUpdate(
            ...
            @PathParam("name") String name,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") FeaturestoreEntityContainerInner body,
            @HeaderParam("Accept") String accept,
            Context context);
    ...
    private Mono<PagedResponse<FeaturestoreEntityContainerInner>> listSinglePageAsync(
        String resourceGroupName, String workspaceName, String skip, String tags, ListViewType listViewType) {
                ...
                context ->
                    service
                        .list(
                            ...
                            accept,
                            context))
            .<PagedResponse<FeaturestoreEntityContainerInner>>map(
                res ->
    ...
    private PagedFlux<FeaturestoreEntityContainerInner> listAsync(
        String resourceGroupName, String workspaceName, String skip, String tags, ListViewType listViewType) {
        return new PagedFlux<>(
            () -> listSinglePageAsync(resourceGroupName, workspaceName, skip, tags, listViewType),
    ...
    private PagedFlux<FeaturestoreEntityContainerInner> listAsync(
        ...
        Context context) {
        return new PagedFlux<>(
            () -> listSinglePageAsync(resourceGroupName, workspaceName, skip, tags, listViewType, context),
    ...
    public PagedIterable<FeaturestoreEntityContainerInner> list(String resourceGroupName, String workspaceName) {
        ...
        final String tags = null;
        final ListViewType listViewType = null;
        return new PagedIterable<>(listAsync(resourceGroupName, workspaceName, skip, tags, listViewType));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<FeaturestoreEntityContainerInner> list(
        String resourceGroupName,
        String workspaceName,
        String skip,
        String tags,
        ListViewType listViewType,
        Context context) {
        return new PagedIterable<>(listAsync(resourceGroupName, workspaceName, skip, tags, listViewType, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<FeaturestoreEntityContainerInner>> getEntityWithResponseAsync(
        String resourceGroupName, String workspaceName, String name) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<FeaturestoreEntityContainerInner> getEntityAsync(
        String resourceGroupName, String workspaceName, String name) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<FeaturestoreEntityContainerInner> getEntityWithResponse(
        String resourceGroupName, String workspaceName, String name, Context context) {
    ...
    private PollerFlux<PollResult<FeaturestoreEntityContainerInner>, FeaturestoreEntityContainerInner>
        ...
        return this
            .client
            .<FeaturestoreEntityContainerInner, FeaturestoreEntityContainerInner>getLroResult(
                mono,
                this.client.getHttpPipeline(),
                FeaturestoreEntityContainerInner.class,
                FeaturestoreEntityContainerInner.class,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<FeaturestoreEntityContainerInner> createOrUpdateAsync(
        String resourceGroupName, String workspaceName, String name, FeaturestoreEntityContainerInner body) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public FeaturestoreEntityContainerInner createOrUpdate(
        String resourceGroupName, String workspaceName, String name, FeaturestoreEntityContainerInner body) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<FeaturestoreEntityContainerInner>> listNextSinglePageAsync(
