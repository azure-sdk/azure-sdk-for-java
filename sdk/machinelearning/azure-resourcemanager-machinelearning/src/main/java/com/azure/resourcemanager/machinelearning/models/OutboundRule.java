...
public class OutboundRule {
    ...
    /**
     * Get the status property: Status of a managed network Outbound Rule of a machine learning workspace.
     *
    ...
    /**
     * Set the status property: Status of a managed network Outbound Rule of a machine learning workspace.
     *
