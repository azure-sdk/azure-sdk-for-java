...
public final class FeaturesetVersionImpl
    ...
    public FeaturesetVersion create() {
        this.innerObject = serviceManager.serviceClient().getFeaturesetVersions().createOrUpdate(resourceGroupName,
            workspaceName, name, version, this.innerModel(), Context.NONE);
        return this;
    }

    public FeaturesetVersion create(Context context) {
        this.innerObject = serviceManager.serviceClient().getFeaturesetVersions().createOrUpdate(resourceGroupName,
            workspaceName, name, version, this.innerModel(), context);
        return this;
    }
    ...
    public FeaturesetVersion refresh() {
        this.innerObject = serviceManager.serviceClient().getFeaturesetVersions()
            .getWithResponse(resourceGroupName, workspaceName, name, version, Context.NONE).getValue();
        return this;
    }

    public FeaturesetVersion refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getFeaturesetVersions()
            .getWithResponse(resourceGroupName, workspaceName, name, version, context).getValue();
        return this;
    }
