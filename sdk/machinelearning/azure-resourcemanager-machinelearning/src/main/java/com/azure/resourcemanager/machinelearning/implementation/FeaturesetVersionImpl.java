...
public final class FeaturesetVersionImpl
    ...
    public PagedIterable<Feature> listFeatures(String skip, String tags, Context context) {
        return serviceManager
            .featuresetVersions()
            .listFeatures(resourceGroupName, workspaceName, name, version, skip, tags, context);
    }
