...
public final class FeaturesetVersionImpl
    ...
    public Response<Feature> getFeatureWithResponse(GetFeatureRequest body, Context context) {
        return serviceManager
            .featuresetVersions()
            .getFeatureWithResponse(resourceGroupName, workspaceName, name, version, body, context);
    }

    public Feature getFeature(GetFeatureRequest body) {
        return serviceManager.featuresetVersions().getFeature(resourceGroupName, workspaceName, name, version, body);
    }

    public PagedIterable<Feature> listFeatures() {
        return serviceManager.featuresetVersions().listFeatures(resourceGroupName, workspaceName, name, version);
    }

    public PagedIterable<Feature> listFeatures(
        String skip, String tags, String featureName, String description, Context context) {
        return serviceManager
            .featuresetVersions()
            .listFeatures(
