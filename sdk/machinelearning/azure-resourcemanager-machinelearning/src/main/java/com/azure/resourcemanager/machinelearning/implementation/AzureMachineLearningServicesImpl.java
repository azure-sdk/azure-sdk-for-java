...
public final class AzureMachineLearningServicesImpl implements AzureMachineLearningServices {
    ...
    /**
     * The InferencePoolsClient object to access its operations.
     */
    private final InferencePoolsClient inferencePools;
     ...
     */
    public InferencePoolsClient getInferencePools() {
        return this.inferencePools;
    }

    /**
     * The InferenceEndpointsClient object to access its operations.
     */
    private final InferenceEndpointsClient inferenceEndpoints;
     ...
     */
    public InferenceEndpointsClient getInferenceEndpoints() {
        return this.inferenceEndpoints;
    }

    /**
     * The InferenceGroupsClient object to access its operations.
     */
    private final InferenceGroupsClient inferenceGroups;
     ...
     */
    public InferenceGroupsClient getInferenceGroups() {
        return this.inferenceGroups;
    }
    ...
    /**
     * The IndexesClient object to access its operations.
     */
    private final IndexesClient indexes;

    /**
     * Gets the IndexesClient object to access its operations.
     * 
     * @return the IndexesClient object.
     */
    public IndexesClient getIndexes() {
        return this.indexes;
    }

    /**
     * The IndexesVersionsClient object to access its operations.
     */
    private final IndexesVersionsClient indexesVersions;

    /**
     * Gets the IndexesVersionsClient object to access its operations.
     * 
     * @return the IndexesVersionsClient object.
     */
    public IndexesVersionsClient getIndexesVersions() {
        return this.indexesVersions;
    }
    ...
    AzureMachineLearningServicesImpl(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter,
        ...
        this.inferencePools = new InferencePoolsClientImpl(this);
        this.inferenceEndpoints = new InferenceEndpointsClientImpl(this);
        this.inferenceGroups = new InferenceGroupsClientImpl(this);
        ...
        this.indexes = new IndexesClientImpl(this);
        this.indexesVersions = new IndexesVersionsClientImpl(this);
    }
