...
public final class AzureMachineLearningServicesImpl implements AzureMachineLearningServices {
    ...
    /**
     * The IndexesOperationsClient object to access its operations.
     */
    private final IndexesOperationsClient indexesOperations;

    /**
     * Gets the IndexesOperationsClient object to access its operations.
     * 
     * @return the IndexesOperationsClient object.
     */
    public IndexesOperationsClient getIndexesOperations() {
    ...
    AzureMachineLearningServicesImpl(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter,
        ...
        this.indexesOperations = new IndexesOperationsClientImpl(this);
