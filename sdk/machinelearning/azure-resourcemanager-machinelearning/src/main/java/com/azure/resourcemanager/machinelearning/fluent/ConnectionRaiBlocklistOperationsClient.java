...
public interface ConnectionRaiBlocklistOperationsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<RaiBlocklistPropertiesBasicResourceInner> getWithResponse(String resourceGroupName, String workspaceName,
        String connectionName, String raiBlocklistName, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<RaiBlocklistPropertiesBasicResourceInner>, RaiBlocklistPropertiesBasicResourceInner>
