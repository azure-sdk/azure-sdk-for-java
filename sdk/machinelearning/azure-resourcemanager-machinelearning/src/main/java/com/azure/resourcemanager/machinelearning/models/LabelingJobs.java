...
public interface LabelingJobs {
     ...
     * @return a paginated list of LabelingJob entities as paginated response with {@link PagedIterable}.
     */
    PagedIterable<LabelingJob> list(String resourceGroupName, String workspaceName, String skip, Integer top,
        Context context);
     ...
     */
    Response<LabelingJobProperties> pauseWithResponse(String resourceGroupName, String workspaceName, String id,
        Context context);
