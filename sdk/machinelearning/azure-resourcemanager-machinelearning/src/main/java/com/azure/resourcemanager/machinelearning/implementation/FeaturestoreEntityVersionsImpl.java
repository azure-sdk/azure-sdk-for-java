...
public final class FeaturestoreEntityVersionsImpl implements FeaturestoreEntityVersions {
    ...
    public FeaturestoreEntityVersionsImpl(
        FeaturestoreEntityVersionsClient innerClient,
    ...
    public PagedIterable<FeaturestoreEntityVersion> list(String resourceGroupName, String workspaceName, String name) {
        ...
        return Utils.mapPage(inner, inner1 -> new FeaturestoreEntityVersionImpl(inner1, this.manager()));
    }

    public PagedIterable<FeaturestoreEntityVersion> list(
    ...
    public Response<FeaturestoreEntityVersion> getWithResponse(
