...
public interface Workspaces {
     ...
     * @return the response body along with {@link Response}.
     */
    Response<EndpointModels> listConnectionModelsWithResponse(String resourceGroupName, String workspaceName,
        Context context);
     ...
     * @return the response.
     */
    EndpointModels listConnectionModels(String resourceGroupName, String workspaceName);
