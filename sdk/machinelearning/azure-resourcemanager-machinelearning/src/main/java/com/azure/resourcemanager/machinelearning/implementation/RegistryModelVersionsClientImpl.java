...
public final class RegistryModelVersionsClientImpl implements RegistryModelVersionsClient {
    ...
    public interface RegistryModelVersionsService {
        ...
        @Get(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers"
                + "/Microsoft.MachineLearningServices/registries/{registryName}/models/{modelName}/versions")
        ...
        @Delete(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers"
                + "/Microsoft.MachineLearningServices/registries/{registryName}/models/{modelName}/versions/{version}")
    ...
    private Mono<PendingUploadResponseDtoInner> createOrGetPendingUploadAsync(
        String resourceGroupName, String registryName, String modelName, String version, PendingUploadRequestDto body) {
        return createOrGetPendingUploadWithResponseAsync(resourceGroupName, registryName, modelName, version, body)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
