...
public final class RegistryModelVersionsClientImpl implements RegistryModelVersionsClient {
    ...
    RegistryModelVersionsClientImpl(AzureMachineLearningServicesImpl client) {
        this.service =
            RestProxy
                .create(RegistryModelVersionsService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }
    ...
    public interface RegistryModelVersionsService {
        ...
        @Headers({"Content-Type: application/json"})
        @Post(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/registries/{registryName}/models/{modelName}/versions/{version}/getBlobReferenceSAS")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String registryName, String modelName, String version) {
        return beginDeleteAsync(resourceGroupName, registryName, modelName, version)
            .last()
    ...
    private Mono<Void> deleteAsync(
        String resourceGroupName, String registryName, String modelName, String version, Context context) {
        return beginDeleteAsync(resourceGroupName, registryName, modelName, version, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private PollerFlux<PollResult<ModelVersionInner>, ModelVersionInner> beginCreateOrUpdateAsync(
        ...
        return this
            .client
            .<ModelVersionInner, ModelVersionInner>getLroResult(
                mono,
                this.client.getHttpPipeline(),
                ModelVersionInner.class,
                ModelVersionInner.class,
    ...
    private PollerFlux<PollResult<ModelVersionInner>, ModelVersionInner> beginCreateOrUpdateAsync(
        ...
        return this
            .client
            .<ModelVersionInner, ModelVersionInner>getLroResult(
                mono, this.client.getHttpPipeline(), ModelVersionInner.class, ModelVersionInner.class, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<ModelVersionInner>, ModelVersionInner> beginCreateOrUpdate(
        String resourceGroupName, String registryName, String modelName, String version, ModelVersionInner body) {
    ...
    public SyncPoller<PollResult<ModelVersionInner>, ModelVersionInner> beginCreateOrUpdate(
        ...
        Context context) {
        return this
            .beginCreateOrUpdateAsync(resourceGroupName, registryName, modelName, version, body, context)
            .getSyncPoller();
    }
    ...
    private Mono<ModelVersionInner> createOrUpdateAsync(
        String resourceGroupName, String registryName, String modelName, String version, ModelVersionInner body) {
        return beginCreateOrUpdateAsync(resourceGroupName, registryName, modelName, version, body)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<ModelVersionInner> createOrUpdateAsync(
        ...
        ModelVersionInner body,
        Context context) {
        return beginCreateOrUpdateAsync(resourceGroupName, registryName, modelName, version, body, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    /**
     * Get a SAS for a blob reference associated with the model.
     *
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
     * @param registryName Name of Azure Machine Learning registry. This is case-insensitive.
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a SAS for a blob reference associated with the model along with {@link Response} on successful completion
     *     of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a SAS for a blob reference associated with the model on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<BlobReferenceSasResponseDtoInner> getBlobReferenceSasAsync(
        ...
        String version,
        BlobReferenceSasRequestDto body) {
        return getBlobReferenceSasWithResponseAsync(resourceGroupName, registryName, modelName, version, body)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a SAS for a blob reference associated with the model along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<BlobReferenceSasResponseDtoInner> getBlobReferenceSasWithResponse(
        ...
        BlobReferenceSasRequestDto body,
        Context context) {
        return getBlobReferenceSasWithResponseAsync(resourceGroupName, registryName, modelName, version, body, context)
            .block();
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a SAS for a blob reference associated with the model.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public BlobReferenceSasResponseDtoInner getBlobReferenceSas(
        ...
        String version,
        BlobReferenceSasRequestDto body) {
        return getBlobReferenceSasWithResponse(resourceGroupName, registryName, modelName, version, body, Context.NONE)
            .getValue();
    }
    ...
    public PendingUploadResponseDtoInner createOrGetStartPendingUpload(
        ...
        return createOrGetStartPendingUploadWithResponse(
                resourceGroupName, registryName, modelName, version, body, Context.NONE)
            .getValue();
    }
