 ...
 */
@Fluent
public final class TableFixedParameters {
    /*
    ...
    private Integer minDataInLeaf;

    /*
     * Minimum loss reduction required to make a further partition on a leaf node of the tree.
     */
    @JsonProperty(value = "minSplitGain")
    private Double minSplitGain;
    ...
    /**
     * Creates an instance of TableFixedParameters class.
     */
     ...
     * @return the TableFixedParameters object itself.
     */
    public TableFixedParameters withBooster(String booster) {
     ...
     * @return the TableFixedParameters object itself.
     */
    public TableFixedParameters withBoostingType(String boostingType) {
     ...
     * @return the TableFixedParameters object itself.
     */
    public TableFixedParameters withGrowPolicy(String growPolicy) {
     ...
     * @return the TableFixedParameters object itself.
     */
    public TableFixedParameters withLearningRate(Double learningRate) {
     ...
     * @return the TableFixedParameters object itself.
     */
    public TableFixedParameters withMaxBin(Integer maxBin) {
        this.maxBin = maxBin;
        return this;
    }
     ...
     * @return the TableFixedParameters object itself.
     */
    public TableFixedParameters withMaxDepth(Integer maxDepth) {
     ...
     * @return the TableFixedParameters object itself.
     */
    public TableFixedParameters withMaxLeaves(Integer maxLeaves) {
     ...
     * @return the TableFixedParameters object itself.
     */
    public TableFixedParameters withMinDataInLeaf(Integer minDataInLeaf) {
     ...
     * @return the TableFixedParameters object itself.
     */
    public TableFixedParameters withMinSplitGain(Double minSplitGain) {
     ...
     * @return the TableFixedParameters object itself.
     */
    public TableFixedParameters withModelName(String modelName) {
     ...
     * @return the TableFixedParameters object itself.
     */
    public TableFixedParameters withNEstimators(Integer nEstimators) {
     ...
     * @return the TableFixedParameters object itself.
     */
    public TableFixedParameters withNumLeaves(Integer numLeaves) {
     ...
     * @return the TableFixedParameters object itself.
     */
    public TableFixedParameters withPreprocessorName(String preprocessorName) {
     ...
     * @return the TableFixedParameters object itself.
     */
    public TableFixedParameters withRegAlpha(Double regAlpha) {
     ...
     * @return the TableFixedParameters object itself.
     */
    public TableFixedParameters withRegLambda(Double regLambda) {
     ...
     * @return the TableFixedParameters object itself.
     */
    public TableFixedParameters withSubsample(Double subsample) {
     ...
     * @return the TableFixedParameters object itself.
     */
    public TableFixedParameters withSubsampleFreq(Double subsampleFreq) {
     ...
     * @return the TableFixedParameters object itself.
     */
    public TableFixedParameters withTreeMethod(String treeMethod) {
     ...
     * @return the TableFixedParameters object itself.
     */
    public TableFixedParameters withWithMean(Boolean withMean) {
     ...
     * @return the TableFixedParameters object itself.
     */
    public TableFixedParameters withWithStd(Boolean withStd) {
