...
public final class EndpointDeploymentsClientImpl implements EndpointDeploymentsClient {
     ...
     */
    EndpointDeploymentsClientImpl(AzureMachineLearningServicesImpl client) {
    ...
    /**
     * The interface defining all the services for AzureMachineLearningServicesEndpointDeployments to be used by the
    ...
    private Mono<PagedResponse<EndpointDeploymentResourcePropertiesBasicResourceInner>> getInWorkspaceSinglePageAsync(
        ...
        return service
            .getInWorkspace(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<EndpointDeploymentResourcePropertiesBasicResourceInner> getInWorkspaceAsync(
        String resourceGroupName, String workspaceName, EndpointType endpointType, String skip, Context context) {
        return new PagedFlux<>(
            () -> getInWorkspaceSinglePageAsync(resourceGroupName, workspaceName, endpointType, skip, context),
            nextLink -> getInWorkspaceNextSinglePageAsync(nextLink, context));
    }
    ...
    public PagedIterable<EndpointDeploymentResourcePropertiesBasicResourceInner>
        ...
        final EndpointType endpointType = null;
        final String skip = null;
        return new PagedIterable<>(getInWorkspaceAsync(resourceGroupName, workspaceName, endpointType, skip));
    }
    ...
    public PagedIterable<EndpointDeploymentResourcePropertiesBasicResourceInner> getInWorkspace(
        String resourceGroupName, String workspaceName, EndpointType endpointType, String skip, Context context) {
        return new PagedIterable<>(getInWorkspaceAsync(resourceGroupName, workspaceName, endpointType, skip, context));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<EndpointDeploymentResourcePropertiesBasicResourceInner>>
        listSinglePageAsync(String resourceGroupName, String workspaceName, String endpointName, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    private PagedFlux<EndpointDeploymentResourcePropertiesBasicResourceInner> listAsync(String resourceGroupName,
        ...
        return new PagedFlux<>(() -> listSinglePageAsync(resourceGroupName, workspaceName, endpointName, context),
    ...
    public PagedIterable<EndpointDeploymentResourcePropertiesBasicResourceInner> list(String resourceGroupName,
        String workspaceName, String endpointName) {
        return new PagedIterable<>(listAsync(resourceGroupName, workspaceName, endpointName));
    }
    ...
    public PagedIterable<EndpointDeploymentResourcePropertiesBasicResourceInner> list(String resourceGroupName,
        String workspaceName, String endpointName, Context context) {
        return new PagedIterable<>(listAsync(resourceGroupName, workspaceName, endpointName, context));
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String workspaceName,
        String endpointName, String deploymentName) {
        final String proxyApiVersion = null;
        return this.beginDeleteAsync(resourceGroupName, workspaceName, endpointName, deploymentName, proxyApiVersion)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String workspaceName,
        String endpointName, String deploymentName, String proxyApiVersion, Context context) {
        return this
            .beginDeleteAsync(resourceGroupName, workspaceName, endpointName, deploymentName, proxyApiVersion, context)
            .getSyncPoller();
    }
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String workspaceName, String endpointName,
        ...
        return beginDeleteAsync(resourceGroupName, workspaceName, endpointName, deploymentName, proxyApiVersion,
    ...
    public void delete(String resourceGroupName, String workspaceName, String endpointName, String deploymentName) {
        final String proxyApiVersion = null;
        deleteAsync(resourceGroupName, workspaceName, endpointName, deploymentName, proxyApiVersion).block();
    }
    ...
    public void delete(String resourceGroupName, String workspaceName, String endpointName, String deploymentName,
        ...
        deleteAsync(resourceGroupName, workspaceName, endpointName, deploymentName, proxyApiVersion, context).block();
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<EndpointDeploymentResourcePropertiesBasicResourceInner>>
        getInWorkspaceNextSinglePageAsync(String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        if (this.client.getEndpoint() == null) {
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.getInWorkspaceNext(nextLink, this.client.getEndpoint(), accept, context)
            .map(res -> new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(),
                res.getValue().value(), res.getValue().nextLink(), null));
    }
