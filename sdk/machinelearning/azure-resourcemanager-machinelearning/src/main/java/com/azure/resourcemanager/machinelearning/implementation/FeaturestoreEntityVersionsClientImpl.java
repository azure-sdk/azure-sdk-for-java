...
public final class FeaturestoreEntityVersionsClientImpl implements FeaturestoreEntityVersionsClient {
    ...
    FeaturestoreEntityVersionsClientImpl(AzureMachineLearningServicesImpl client) {
        this.service =
            RestProxy
                .create(
                    FeaturestoreEntityVersionsService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }
    ...
    public interface FeaturestoreEntityVersionsService {
        ...
        @Get(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers"
                + "/Microsoft.MachineLearningServices/workspaces/{workspaceName}/featurestoreEntities/{name}/versions")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<FeaturestoreEntityVersionResourceArmPaginatedResult>> list(
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<FeaturestoreEntityVersionInner>> get(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("workspaceName") String workspaceName,
        ...
        Mono<Response<Flux<ByteBuffer>>> createOrUpdate(
            ...
            @PathParam("version") String version,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") FeaturestoreEntityVersionInner body,
            @HeaderParam("Accept") String accept,
            Context context);
    ...
    private Mono<PagedResponse<FeaturestoreEntityVersionInner>> listSinglePageAsync(
                ...
                context ->
                    service
                        .list(
                            ...
                            accept,
                            context))
            .<PagedResponse<FeaturestoreEntityVersionInner>>map(
                res ->
    ...
    private PagedFlux<FeaturestoreEntityVersionInner> listAsync(
        String resourceGroupName,
        String workspaceName,
        String name,
        String skip,
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<FeaturestoreEntityVersionInner> list(
        String resourceGroupName, String workspaceName, String name) {
        final String skip = null;
        final String tags = null;
        final ListViewType listViewType = null;
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<FeaturestoreEntityVersionInner>> getWithResponseAsync(
        String resourceGroupName, String workspaceName, String name, String version) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<FeaturestoreEntityVersionInner> getAsync(
        String resourceGroupName, String workspaceName, String name, String version) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<FeaturestoreEntityVersionInner> getWithResponse(
        String resourceGroupName, String workspaceName, String name, String version, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public FeaturestoreEntityVersionInner get(
        String resourceGroupName, String workspaceName, String name, String version) {
    ...
    private PollerFlux<PollResult<FeaturestoreEntityVersionInner>, FeaturestoreEntityVersionInner>
        ...
        return this
            .client
            .<FeaturestoreEntityVersionInner, FeaturestoreEntityVersionInner>getLroResult(
                mono,
                this.client.getHttpPipeline(),
                FeaturestoreEntityVersionInner.class,
                FeaturestoreEntityVersionInner.class,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<FeaturestoreEntityVersionInner> createOrUpdateAsync(
        String resourceGroupName,
        String workspaceName,
        String name,
        String version,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public FeaturestoreEntityVersionInner createOrUpdate(
        String resourceGroupName,
        String workspaceName,
        String name,
        String version,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<FeaturestoreEntityVersionInner>> listNextSinglePageAsync(
