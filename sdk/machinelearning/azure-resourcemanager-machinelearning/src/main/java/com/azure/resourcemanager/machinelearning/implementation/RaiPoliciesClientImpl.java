...
public final class RaiPoliciesClientImpl implements RaiPoliciesClient {
     ...
     */
    RaiPoliciesClientImpl(AzureMachineLearningWorkspacesImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for AzureMachineLearningWorkspacesRaiPolicies to be used by the proxy
