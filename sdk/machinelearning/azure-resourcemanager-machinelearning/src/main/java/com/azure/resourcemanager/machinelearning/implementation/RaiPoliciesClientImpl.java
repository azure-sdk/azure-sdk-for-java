...
public final class RaiPoliciesClientImpl implements RaiPoliciesClient {
     ...
     */
    RaiPoliciesClientImpl(AzureMachineLearningServicesImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for AzureMachineLearningServicesRaiPolicies to be used by the proxy
    ...
    private Mono<PagedResponse<RaiPolicyPropertiesBasicResourceInner>> listSinglePageAsync(String resourceGroupName,
        String workspaceName, String endpointName, String proxyApiVersion) {
        ...
        return FluxUtil
            .withContext(
                context -> service.list(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
                    workspaceName, endpointName, this.client.getApiVersion(), proxyApiVersion, accept, context))
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<RaiPolicyPropertiesBasicResourceInner>> listSinglePageAsync(String resourceGroupName,
        String workspaceName, String endpointName, String proxyApiVersion, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service
            .list(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName, workspaceName,
                endpointName, this.client.getApiVersion(), proxyApiVersion, accept, context)
    ...
    private PagedFlux<RaiPolicyPropertiesBasicResourceInner> listAsync(String resourceGroupName, String workspaceName,
        String endpointName, String proxyApiVersion) {
        return new PagedFlux<>(
            () -> listSinglePageAsync(resourceGroupName, workspaceName, endpointName, proxyApiVersion),
    ...
    private PagedFlux<RaiPolicyPropertiesBasicResourceInner> listAsync(String resourceGroupName, String workspaceName,
        ...
        return new PagedFlux<>(
            () -> listSinglePageAsync(resourceGroupName, workspaceName, endpointName, proxyApiVersion, context),
    ...
    public PagedIterable<RaiPolicyPropertiesBasicResourceInner> list(String resourceGroupName, String workspaceName,
        String endpointName) {
        final String proxyApiVersion = null;
        return new PagedIterable<>(listAsync(resourceGroupName, workspaceName, endpointName, proxyApiVersion));
    }
    ...
    public PagedIterable<RaiPolicyPropertiesBasicResourceInner> list(String resourceGroupName, String workspaceName,
        String endpointName, String proxyApiVersion, Context context) {
        return new PagedIterable<>(listAsync(resourceGroupName, workspaceName, endpointName, proxyApiVersion, context));
    }
