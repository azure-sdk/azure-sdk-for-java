...
public final class FeaturesImpl implements Features {
    ...
    public PagedIterable<Feature> list(String resourceGroupName, String workspaceName, String featuresetName,
        ...
        PagedIterable<FeatureInner> inner = this.serviceClient().list(resourceGroupName, workspaceName, featuresetName,
            featuresetVersion, skip, tags, featureName, description, listViewType, pageSize, context);
        return Utils.mapPage(inner, inner1 -> new FeatureImpl(inner1, this.manager()));
    }
    ...
    public Response<Feature> getWithResponse(String resourceGroupName, String workspaceName, String featuresetName,
        ...
        Response<FeatureInner> inner = this.serviceClient().getWithResponse(resourceGroupName, workspaceName,
            featuresetName, featuresetVersion, featureName, context);
        if (inner != null) {
    ...
    public Feature get(String resourceGroupName, String workspaceName, String featuresetName, String featuresetVersion,
        String featureName) {
        FeatureInner inner = this.serviceClient().get(resourceGroupName, workspaceName, featuresetName,
            featuresetVersion, featureName);
        if (inner != null) {
