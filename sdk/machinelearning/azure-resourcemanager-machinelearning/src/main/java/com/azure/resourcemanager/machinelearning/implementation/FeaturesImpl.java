...
public final class FeaturesImpl implements Features {
    ...
    public FeaturesImpl(
        FeaturesClient innerClient, com.azure.resourcemanager.machinelearning.MachineLearningManager serviceManager) {
    ...
    public Response<Feature> getWithResponse(
        String resourceGroupName,
        String workspaceName,
        String featuresetName,
        String featuresetVersion,
    ...
    public Feature get(
        ...
        String featureName) {
        FeatureInner inner =
            this.serviceClient().get(resourceGroupName, workspaceName, featuresetName, featuresetVersion, featureName);
        if (inner != null) {
