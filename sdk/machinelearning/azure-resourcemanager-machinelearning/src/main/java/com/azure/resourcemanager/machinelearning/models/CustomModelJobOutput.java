...
@JsonTypeInfo(
    ...
    defaultImpl = CustomModelJobOutput.class,
    visible = true)
...
public final class CustomModelJobOutput extends JobOutput {
     ...
     * @return the CustomModelJobOutput object itself.
     */
    public CustomModelJobOutput withAutoDeleteSetting(AutoDeleteSetting autoDeleteSetting) {
     ...
     * @return the CustomModelJobOutput object itself.
     */
    public CustomModelJobOutput withPathOnCompute(String pathOnCompute) {
