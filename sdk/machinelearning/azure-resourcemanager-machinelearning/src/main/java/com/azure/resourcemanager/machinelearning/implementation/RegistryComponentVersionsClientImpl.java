...
public final class RegistryComponentVersionsClientImpl implements RegistryComponentVersionsClient {
    ...
    private interface RegistryComponentVersionsService {
        @Headers({"Content-Type: application/json"})
        @Get(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers"
                + "/Microsoft.MachineLearningServices/registries/{registryName}/components/{componentName}/versions")
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(
        String resourceGroupName, String registryName, String componentName, String version) {
        return beginDeleteAsync(resourceGroupName, registryName, componentName, version).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(
        String resourceGroupName, String registryName, String componentName, String version, Context context) {
        return beginDeleteAsync(resourceGroupName, registryName, componentName, version, context).getSyncPoller();
    }
    ...
    public ComponentVersionInner get(
        String resourceGroupName, String registryName, String componentName, String version) {
        return getAsync(resourceGroupName, registryName, componentName, version).block();
    }
    ...
    public SyncPoller<PollResult<ComponentVersionInner>, ComponentVersionInner> beginCreateOrUpdate(
        ...
        String version,
        ComponentVersionInner body) {
        return beginCreateOrUpdateAsync(resourceGroupName, registryName, componentName, version, body).getSyncPoller();
    }
