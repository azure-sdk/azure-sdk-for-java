...
public final class RegistryComponentVersionsClientImpl implements RegistryComponentVersionsClient {
    ...
    private Mono<PagedResponse<ComponentVersionInner>> listSinglePageAsync(String resourceGroupName,
        String registryName, String componentName, String orderBy, Integer top, String skip, String stage) {
        ...
        return FluxUtil
            .withContext(context -> service.list(this.client.getEndpoint(), this.client.getSubscriptionId(),
                resourceGroupName, registryName, componentName, this.client.getApiVersion(), orderBy, top, skip, stage,
                accept, context))
    ...
    private Mono<PagedResponse<ComponentVersionInner>> listSinglePageAsync(String resourceGroupName,
        ...
        return service
            .list(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName, registryName,
                componentName, this.client.getApiVersion(), orderBy, top, skip, stage, accept, context)
    ...
    private PagedFlux<ComponentVersionInner> listAsync(String resourceGroupName, String registryName,
        String componentName, String orderBy, Integer top, String skip, String stage) {
    ...
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<ComponentVersionInner> listAsync(String resourceGroupName, String registryName,
        String componentName, String orderBy, Integer top, String skip, String stage, Context context) {
        return new PagedFlux<>(() -> listSinglePageAsync(resourceGroupName, registryName, componentName, orderBy, top,
            skip, stage, context), nextLink -> listNextSinglePageAsync(nextLink, context));
    }
