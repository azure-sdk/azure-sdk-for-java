...
public final class RegistryComponentVersionsClientImpl implements RegistryComponentVersionsClient {
    ...
    RegistryComponentVersionsClientImpl(AzureMachineLearningServicesImpl client) {
        this.service =
            RestProxy
                .create(
                    RegistryComponentVersionsService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }
    ...
    public interface RegistryComponentVersionsService {
        ...
        @Headers({"Content-Type: application/json"})
        @Post(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/registries/{registryName}/components/{componentName}/versions/{version}/getBlobReferenceSAS")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<BlobReferenceSasResponseDtoInner>> getBlobReferenceSas(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("registryName") String registryName,
            ...
            @PathParam("version") String version,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") BlobReferenceSasRequestDto body,
            @HeaderParam("Accept") String accept,
            Context context);
    ...
    private Mono<PagedResponse<ComponentVersionInner>> listSinglePageAsync(
        String resourceGroupName, String registryName, String componentName, String orderBy, Integer top, String skip) {
    ...
    private Mono<Void> deleteAsync(
        String resourceGroupName, String registryName, String componentName, String version) {
        return beginDeleteAsync(resourceGroupName, registryName, componentName, version)
            .last()
    ...
    private Mono<Void> deleteAsync(
        String resourceGroupName, String registryName, String componentName, String version, Context context) {
        return beginDeleteAsync(resourceGroupName, registryName, componentName, version, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ComponentVersionInner get(
        String resourceGroupName, String registryName, String componentName, String version) {
    ...
    private PollerFlux<PollResult<ComponentVersionInner>, ComponentVersionInner> beginCreateOrUpdateAsync(
        ...
        return this
            .client
            .<ComponentVersionInner, ComponentVersionInner>getLroResult(
                mono,
                this.client.getHttpPipeline(),
                ComponentVersionInner.class,
                ComponentVersionInner.class,
    ...
    private PollerFlux<PollResult<ComponentVersionInner>, ComponentVersionInner> beginCreateOrUpdateAsync(
        ...
        return this
            .client
            .<ComponentVersionInner, ComponentVersionInner>getLroResult(
                mono, this.client.getHttpPipeline(), ComponentVersionInner.class, ComponentVersionInner.class, context);
    }
    ...
    public SyncPoller<PollResult<ComponentVersionInner>, ComponentVersionInner> beginCreateOrUpdate(
        ...
        ComponentVersionInner body) {
        return this
            .beginCreateOrUpdateAsync(resourceGroupName, registryName, componentName, version, body)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<ComponentVersionInner>, ComponentVersionInner> beginCreateOrUpdate(
        ...
        Context context) {
        return this
            .beginCreateOrUpdateAsync(resourceGroupName, registryName, componentName, version, body, context)
            .getSyncPoller();
    }
    ...
    private Mono<ComponentVersionInner> createOrUpdateAsync(
        ...
        String version,
        ComponentVersionInner body) {
        return beginCreateOrUpdateAsync(resourceGroupName, registryName, componentName, version, body)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<ComponentVersionInner> createOrUpdateAsync(
        ...
        ComponentVersionInner body,
        Context context) {
        return beginCreateOrUpdateAsync(resourceGroupName, registryName, componentName, version, body, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    /**
     * Get a SAS for a blob reference associated with the component.
     *
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
     * @param registryName Name of Azure Machine Learning registry. This is case-insensitive.
     * @param componentName Component name. This is case-sensitive.
     * @param version Version identifier. This is case-sensitive.
     * @param body blob reference request object.
     * @throws IllegalArgumentException thrown if parameters fail the validation.
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a SAS for a blob reference associated with the component along with {@link Response} on successful
     *     completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<BlobReferenceSasResponseDtoInner>> getBlobReferenceSasWithResponseAsync(
        String resourceGroupName,
        String registryName,
        String componentName,
        String version,
        BlobReferenceSasRequestDto body) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a SAS for a blob reference associated with the component on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<BlobReferenceSasResponseDtoInner> getBlobReferenceSasAsync(
        String resourceGroupName,
        String registryName,
        String componentName,
        String version,
        BlobReferenceSasRequestDto body) {
        return getBlobReferenceSasWithResponseAsync(resourceGroupName, registryName, componentName, version, body)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a SAS for a blob reference associated with the component along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<BlobReferenceSasResponseDtoInner> getBlobReferenceSasWithResponse(
        String resourceGroupName,
        String registryName,
        String componentName,
        String version,
        BlobReferenceSasRequestDto body,
        Context context) {
        return getBlobReferenceSasWithResponseAsync(
                resourceGroupName, registryName, componentName, version, body, context)
            .block();
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a SAS for a blob reference associated with the component.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public BlobReferenceSasResponseDtoInner getBlobReferenceSas(
        String resourceGroupName,
        String registryName,
        String componentName,
        String version,
        BlobReferenceSasRequestDto body) {
        return getBlobReferenceSasWithResponse(
                resourceGroupName, registryName, componentName, version, body, Context.NONE)
            .getValue();
    }
