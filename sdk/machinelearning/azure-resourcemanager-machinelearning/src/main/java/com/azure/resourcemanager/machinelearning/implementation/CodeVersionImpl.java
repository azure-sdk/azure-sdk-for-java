...
public final class CodeVersionImpl implements CodeVersion, CodeVersion.Definition, CodeVersion.Update {
    ...
    public CodeVersion create() {
        this.innerObject = serviceManager.serviceClient().getRegistryCodeVersions().createOrUpdate(resourceGroupName,
            registryName, codeName, version, this.innerModel(), Context.NONE);
        return this;
    }

    public CodeVersion create(Context context) {
        this.innerObject = serviceManager.serviceClient().getRegistryCodeVersions().createOrUpdate(resourceGroupName,
            registryName, codeName, version, this.innerModel(), context);
        return this;
    }
    ...
    public CodeVersion refresh() {
        this.innerObject = serviceManager.serviceClient().getRegistryCodeVersions()
            .getWithResponse(resourceGroupName, registryName, codeName, version, Context.NONE).getValue();
        return this;
    }

    public CodeVersion refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getRegistryCodeVersions()
            .getWithResponse(resourceGroupName, registryName, codeName, version, context).getValue();
        return this;
    }

    public Response<PendingUploadResponseDto> createOrGetStartPendingUploadWithResponse(PendingUploadRequestDto body,
        Context context) {
        return serviceManager.registryCodeVersions().createOrGetStartPendingUploadWithResponse(resourceGroupName,
            registryName, codeName, version, body, context);
    }

    public PendingUploadResponseDto createOrGetStartPendingUpload(PendingUploadRequestDto body) {
        return serviceManager.registryCodeVersions().createOrGetStartPendingUpload(resourceGroupName, registryName,
            codeName, version, body);
    }
