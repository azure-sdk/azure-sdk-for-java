...
public final class WorkspaceInner extends ProxyResource {
    ...
    public String agentsEndpointUri() {
        return this.innerProperties() == null ? null : this.innerProperties().agentsEndpointUri();
    }
    ...
    public Boolean allowRoleAssignmentOnRG() {
        return this.innerProperties() == null ? null : this.innerProperties().allowRoleAssignmentOnRG();
    }
     ...
     * @return the WorkspaceInner object itself.
     */
    public WorkspaceInner withAllowRoleAssignmentOnRG(Boolean allowRoleAssignmentOnRG) {
        if (this.innerProperties() == null) {
            this.innerProperties = new WorkspacePropertiesInner();
        }
        this.innerProperties().withAllowRoleAssignmentOnRG(allowRoleAssignmentOnRG);
        return this;
    }
    ...
    public Boolean enableSimplifiedCmk() {
        return this.innerProperties() == null ? null : this.innerProperties().enableSimplifiedCmk();
    }
     ...
     * @return the WorkspaceInner object itself.
     */
    public WorkspaceInner withEnableSimplifiedCmk(Boolean enableSimplifiedCmk) {
        if (this.innerProperties() == null) {
            this.innerProperties = new WorkspacePropertiesInner();
        }
        this.innerProperties().withEnableSimplifiedCmk(enableSimplifiedCmk);
        return this;
    }
    ...
    public Boolean enableSoftwareBillOfMaterials() {
        return this.innerProperties() == null ? null : this.innerProperties().enableSoftwareBillOfMaterials();
    }
     ...
     * @return the WorkspaceInner object itself.
     */
    public WorkspaceInner withEnableSoftwareBillOfMaterials(Boolean enableSoftwareBillOfMaterials) {
        if (this.innerProperties() == null) {
            this.innerProperties = new WorkspacePropertiesInner();
        }
        this.innerProperties().withEnableSoftwareBillOfMaterials(enableSoftwareBillOfMaterials);
        return this;
    }
    ...
    public List<String> ipAllowlist() {
        return this.innerProperties() == null ? null : this.innerProperties().ipAllowlist();
    }
     ...
     * @return the WorkspaceInner object itself.
     */
    public WorkspaceInner withIpAllowlist(List<String> ipAllowlist) {
        if (this.innerProperties() == null) {
            this.innerProperties = new WorkspacePropertiesInner();
        }
        this.innerProperties().withIpAllowlist(ipAllowlist);
        return this;
    }
     ...
     * @return the WorkspaceInner object itself.
     */
    public WorkspaceInner withNetworkAcls(NetworkAcls networkAcls) {
        if (this.innerProperties() == null) {
            this.innerProperties = new WorkspacePropertiesInner();
        }
     ...
     * @return the WorkspaceInner object itself.
     */
    public WorkspaceInner withPublicNetworkAccess(PublicNetworkAccessType publicNetworkAccess) {
        if (this.innerProperties() == null) {
            this.innerProperties = new WorkspacePropertiesInner();
        }
    ...
    public void validate() {
        ...
        if (innerProperties() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Missing required property innerProperties in model WorkspaceInner"));
        } else {
