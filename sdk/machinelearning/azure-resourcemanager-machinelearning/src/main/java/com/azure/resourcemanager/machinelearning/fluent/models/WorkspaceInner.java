...
public final class WorkspaceInner extends ProxyResource {
     ...
     * @return the WorkspaceInner object itself.
     */
    public WorkspaceInner withManagedNetwork(Object managedNetwork) {
        if (this.innerProperties() == null) {
            this.innerProperties = new WorkspacePropertiesInner();
        }
    ...
    /**
     * Get the workspaceHubConfig property: The workspaceHubConfig property.
     *
    ...
    /**
     * Set the workspaceHubConfig property: The workspaceHubConfig property.
     *
