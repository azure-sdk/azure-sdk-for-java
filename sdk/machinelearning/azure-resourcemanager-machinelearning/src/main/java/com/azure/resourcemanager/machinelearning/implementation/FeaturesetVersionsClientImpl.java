...
import com.azure.resourcemanager.machinelearning.models.FeatureArmPaginatedResult;
...
public final class FeaturesetVersionsClientImpl implements FeaturesetVersionsClient {
    ...
    public interface FeaturesetVersionsService {
        ...
        @Get(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers"
                + "/Microsoft.MachineLearningServices/workspaces/{workspaceName}/featuresets/{name}/versions")
        ...
        @Delete(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers"
                + "/Microsoft.MachineLearningServices/workspaces/{workspaceName}/featuresets/{name}/versions/{version}")
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<FeatureInner>> getFeature(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("workspaceName") String workspaceName,
            ...
            @PathParam("version") String version,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") GetFeatureRequest body,
            @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<FeatureArmPaginatedResult>> listFeatures(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("workspaceName") String workspaceName,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<FeatureArmPaginatedResult>> listFeaturesNext(
            @PathParam(value = "nextLink", encoded = true) String nextLink,
            @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept,
            Context context);
    ...
    private PagedFlux<FeaturesetVersionInner> listAsync(
        ...
        return new PagedFlux<>(
            () -> listSinglePageAsync(resourceGroupName, workspaceName, name, skip, tags, listViewType),
    ...
    private PagedFlux<FeaturesetVersionInner> listAsync(
        ...
        Context context) {
        return new PagedFlux<>(
            () -> listSinglePageAsync(resourceGroupName, workspaceName, name, skip, tags, listViewType, context),
    ...
    public PagedIterable<FeaturesetVersionInner> list(String resourceGroupName, String workspaceName, String name) {
        ...
        final String tags = null;
        final ListViewType listViewType = null;
        return new PagedIterable<>(listAsync(resourceGroupName, workspaceName, name, skip, tags, listViewType));
    }
    ...
    public PagedIterable<FeaturesetVersionInner> list(
        ...
        return new PagedIterable<>(
            listAsync(resourceGroupName, workspaceName, name, skip, tags, listViewType, context));
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return response payload for creating a backfill request for a given feature set version along with {@link
    ...
    private PollerFlux<PollResult<FeaturesetVersionBackfillResponseInner>, FeaturesetVersionBackfillResponseInner>
        ...
        return this
            .client
            .<FeaturesetVersionBackfillResponseInner, FeaturesetVersionBackfillResponseInner>getLroResult(
                mono,
                this.client.getHttpPipeline(),
                FeaturesetVersionBackfillResponseInner.class,
                FeaturesetVersionBackfillResponseInner.class,
                this.client.getContext());
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<FeaturesetVersionBackfillResponseInner> backfillAsync(
        String resourceGroupName,
        String workspaceName,
        String name,
        String version,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public FeaturesetVersionBackfillResponseInner backfill(
        String resourceGroupName,
        String workspaceName,
        String name,
        String version,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<FeatureInner>> getFeatureWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<FeatureInner> getFeatureAsync(
        String resourceGroupName, String workspaceName, String name, String version, GetFeatureRequest body) {
        return getFeatureWithResponseAsync(resourceGroupName, workspaceName, name, version, body)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<FeatureInner> getFeatureWithResponse(
        String resourceGroupName,
        String workspaceName,
        String name,
        String version,
        GetFeatureRequest body,
        Context context) {
        return getFeatureWithResponseAsync(resourceGroupName, workspaceName, name, version, body, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public FeatureInner getFeature(
        String resourceGroupName, String workspaceName, String name, String version, GetFeatureRequest body) {
        return getFeatureWithResponse(resourceGroupName, workspaceName, name, version, body, Context.NONE).getValue();
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a paginated list of Feature entities along with {@link PagedResponse} on successful completion of {@link
     *     Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<FeatureInner>> listFeaturesSinglePageAsync(
        String resourceGroupName, String workspaceName, String name, String version, String skip, String tags) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
                ...
                context ->
                    service
                        .listFeatures(
                            ...
                            accept,
                            context))
            .<PagedResponse<FeatureInner>>map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(),
                        res.getStatusCode(),
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<FeatureInner> listFeaturesAsync(
        String resourceGroupName, String workspaceName, String name, String version, String skip, String tags) {
        return new PagedFlux<>(
            () -> listFeaturesSinglePageAsync(resourceGroupName, workspaceName, name, version, skip, tags),
            nextLink -> listFeaturesNextSinglePageAsync(nextLink));
    }
    ...
    private PagedFlux<FeatureInner> listFeaturesAsync(
        ...
        Context context) {
        return new PagedFlux<>(
            () -> listFeaturesSinglePageAsync(resourceGroupName, workspaceName, name, version, skip, tags, context),
            nextLink -> listFeaturesNextSinglePageAsync(nextLink, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<FeatureInner> listFeatures(
        String resourceGroupName, String workspaceName, String name, String version) {
        final String skip = null;
        final String tags = null;
        return new PagedIterable<>(listFeaturesAsync(resourceGroupName, workspaceName, name, version, skip, tags));
    }
    ...
    public PagedIterable<FeatureInner> listFeatures(
        ...
        Context context) {
        return new PagedIterable<>(
            listFeaturesAsync(resourceGroupName, workspaceName, name, version, skip, tags, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<FeatureInner>> listFeaturesNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        if (this.client.getEndpoint() == null) {
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.listFeaturesNext(nextLink, this.client.getEndpoint(), accept, context))
            .<PagedResponse<FeatureInner>>map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<FeatureInner>> listFeaturesNextSinglePageAsync(String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        if (this.client.getEndpoint() == null) {
        ...
        context = this.client.mergeContext(context);
        return service
            .listFeaturesNext(nextLink, this.client.getEndpoint(), accept, context)
            .map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(),
