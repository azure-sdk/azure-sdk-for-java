...
public final class FeaturesetVersionsClientImpl implements FeaturesetVersionsClient {
    ...
    private PagedFlux<FeatureInner> listFeaturesAsync(
        ...
        return new PagedFlux<>(
            () ->
                listFeaturesSinglePageAsync(
                    resourceGroupName, workspaceName, name, version, skip, tags, featureName, description),
    ...
    private PagedFlux<FeatureInner> listFeaturesAsync(
        ...
        return new PagedFlux<>(
            () ->
                listFeaturesSinglePageAsync(
                    resourceGroupName, workspaceName, name, version, skip, tags, featureName, description, context),
    ...
    public PagedIterable<FeatureInner> listFeatures(
        ...
        final String description = null;
        return new PagedIterable<>(
            listFeaturesAsync(resourceGroupName, workspaceName, name, version, skip, tags, featureName, description));
    }
