...
public final class EndpointsClientImpl implements EndpointsClient {
    ...
    /**
     * The interface defining all the services for AzureMachineLearningServicesEndpoints to be used by the proxy
    ...
    private Mono<PagedResponse<EndpointResourcePropertiesBasicResourceInner>>
        listSinglePageAsync(String resourceGroupName, String workspaceName, EndpointType endpointType, String skip) {
    ...
    private Mono<PagedResponse<EndpointResourcePropertiesBasicResourceInner>> listSinglePageAsync(
        ...
        return service
            .list(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName, workspaceName,
                this.client.getApiVersion(), endpointType, skip, accept, context)
    ...
    private PagedFlux<EndpointResourcePropertiesBasicResourceInner> listAsync(String resourceGroupName,
        String workspaceName, EndpointType endpointType, String skip) {
        return new PagedFlux<>(() -> listSinglePageAsync(resourceGroupName, workspaceName, endpointType, skip),
    ...
    private PagedFlux<EndpointResourcePropertiesBasicResourceInner> listAsync(String resourceGroupName,
        ...
        return new PagedFlux<>(() -> listSinglePageAsync(resourceGroupName, workspaceName, endpointType, skip, context),
    ...
    public PagedIterable<EndpointResourcePropertiesBasicResourceInner> list(String resourceGroupName,
        ...
        final EndpointType endpointType = null;
        final String skip = null;
        return new PagedIterable<>(listAsync(resourceGroupName, workspaceName, endpointType, skip));
    }
    ...
    public PagedIterable<EndpointResourcePropertiesBasicResourceInner> list(String resourceGroupName,
        String workspaceName, EndpointType endpointType, String skip, Context context) {
        return new PagedIterable<>(listAsync(resourceGroupName, workspaceName, endpointType, skip, context));
    }
