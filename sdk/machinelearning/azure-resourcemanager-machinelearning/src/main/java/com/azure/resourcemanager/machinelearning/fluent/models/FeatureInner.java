 ...
 */
@Fluent
public final class FeatureInner extends ProxyResource {
    /*
     ...
     */
    public FeatureInner withProperties(FeatureProperties properties) {
    ...
    public void validate() {
        if (properties() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Missing required property properties in model FeatureInner"));
        } else {
            properties().validate();
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(FeatureInner.class);
}
