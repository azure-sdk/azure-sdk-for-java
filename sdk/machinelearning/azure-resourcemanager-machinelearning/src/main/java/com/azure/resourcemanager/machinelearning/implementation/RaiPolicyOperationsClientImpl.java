...
public final class RaiPolicyOperationsClientImpl implements RaiPolicyOperationsClient {
     ...
     */
    RaiPolicyOperationsClientImpl(AzureMachineLearningServicesImpl client) {
    ...
    /**
     * The interface defining all the services for AzureMachineLearningServicesRaiPolicyOperations to be used by the
    ...
    private PollerFlux<PollResult<Void>, Void> beginDeleteAsync(String resourceGroupName, String workspaceName,
        ...
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono
            = deleteWithResponseAsync(resourceGroupName, workspaceName, endpointName, raiPolicyName, context);
        return this.client.<Void, Void>getLroResult(mono, this.client.getHttpPipeline(), Void.class, Void.class,
            context);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String workspaceName,
        String endpointName, String raiPolicyName) {
        return this.beginDeleteAsync(resourceGroupName, workspaceName, endpointName, raiPolicyName).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String workspaceName,
        String endpointName, String raiPolicyName, Context context) {
        return this.beginDeleteAsync(resourceGroupName, workspaceName, endpointName, raiPolicyName, context)
            .getSyncPoller();
    }
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String workspaceName, String endpointName,
        ...
        return beginDeleteAsync(resourceGroupName, workspaceName, endpointName, raiPolicyName, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    public void delete(String resourceGroupName, String workspaceName, String endpointName, String raiPolicyName) {
        deleteAsync(resourceGroupName, workspaceName, endpointName, raiPolicyName).block();
    }
    ...
    public void delete(String resourceGroupName, String workspaceName, String endpointName, String raiPolicyName,
        Context context) {
        deleteAsync(resourceGroupName, workspaceName, endpointName, raiPolicyName, context).block();
    }
        ...
        return FluxUtil
            .withContext(
                context -> service.create(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
                    workspaceName, endpointName, raiPolicyName, this.client.getApiVersion(), body, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private PollerFlux<PollResult<RaiPolicyPropertiesBasicResourceInner>, RaiPolicyPropertiesBasicResourceInner>
        ...
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono
            = createWithResponseAsync(resourceGroupName, workspaceName, endpointName, raiPolicyName, body, context);
        return this.client.<RaiPolicyPropertiesBasicResourceInner, RaiPolicyPropertiesBasicResourceInner>getLroResult(
            mono, this.client.getHttpPipeline(), RaiPolicyPropertiesBasicResourceInner.class,
    ...
    public SyncPoller<PollResult<RaiPolicyPropertiesBasicResourceInner>, RaiPolicyPropertiesBasicResourceInner>
        beginCreate(String resourceGroupName, String workspaceName, String endpointName, String raiPolicyName,
            RaiPolicyPropertiesBasicResourceInner body) {
        return this.beginCreateAsync(resourceGroupName, workspaceName, endpointName, raiPolicyName, body)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<RaiPolicyPropertiesBasicResourceInner>, RaiPolicyPropertiesBasicResourceInner>
        beginCreate(String resourceGroupName, String workspaceName, String endpointName, String raiPolicyName,
            RaiPolicyPropertiesBasicResourceInner body, Context context) {
        return this.beginCreateAsync(resourceGroupName, workspaceName, endpointName, raiPolicyName, body, context)
            .getSyncPoller();
    }
    ...
    private Mono<RaiPolicyPropertiesBasicResourceInner> createAsync(String resourceGroupName, String workspaceName,
        String endpointName, String raiPolicyName, RaiPolicyPropertiesBasicResourceInner body, Context context) {
        return beginCreateAsync(resourceGroupName, workspaceName, endpointName, raiPolicyName, body, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    public RaiPolicyPropertiesBasicResourceInner create(String resourceGroupName, String workspaceName,
        String endpointName, String raiPolicyName, RaiPolicyPropertiesBasicResourceInner body) {
        return createAsync(resourceGroupName, workspaceName, endpointName, raiPolicyName, body).block();
    }
    ...
    public RaiPolicyPropertiesBasicResourceInner create(String resourceGroupName, String workspaceName,
        String endpointName, String raiPolicyName, RaiPolicyPropertiesBasicResourceInner body, Context context) {
        return createAsync(resourceGroupName, workspaceName, endpointName, raiPolicyName, body, context).block();
    }
}
