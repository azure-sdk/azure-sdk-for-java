...
public final class MonitorDefinition {
    ...
    /**
     * Get the notificationSetting property: The monitor's notification settings.
     *
    ...
    /**
     * Set the notificationSetting property: The monitor's notification settings.
     *
     * @param notificationSetting the notificationSetting value to set.
     * @return the MonitorDefinition object itself.
     */
    public MonitorDefinition withNotificationSetting(NotificationSetting notificationSetting) {
