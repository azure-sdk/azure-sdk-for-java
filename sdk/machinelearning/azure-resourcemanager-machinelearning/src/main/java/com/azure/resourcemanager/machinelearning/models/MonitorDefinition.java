...
public final class MonitorDefinition {
     ...
     */
    @JsonProperty(value = "alertNotificationSetting")
    private MonitoringAlertNotificationSettingsBase alertNotificationSetting;
    ...
    /**
     * Get the alertNotificationSetting property: The monitor's notification settings.
     *
     * @return the alertNotificationSetting value.
     */
    public MonitoringAlertNotificationSettingsBase alertNotificationSetting() {
        return this.alertNotificationSetting;
    }

    /**
     * Set the alertNotificationSetting property: The monitor's notification settings.
     *
     * @param alertNotificationSetting the alertNotificationSetting value to set.
     * @return the MonitorDefinition object itself.
     */
    public MonitorDefinition withAlertNotificationSetting(
        MonitoringAlertNotificationSettingsBase alertNotificationSetting) {
        this.alertNotificationSetting = alertNotificationSetting;
        return this;
    }

    /**
     * Get the computeId property: [Required] The ARM resource ID of the compute resource to run the monitoring job on.
     *
    ...
    /**
     * Set the computeId property: [Required] The ARM resource ID of the compute resource to run the monitoring job on.
     *
     * @param computeId the computeId value to set.
     * @return the MonitorDefinition object itself.
     */
    public MonitorDefinition withComputeId(String computeId) {
     ...
     * @return the MonitorDefinition object itself.
     */
    public MonitorDefinition withMonitoringTarget(String monitoringTarget) {
    ...
    public void validate() {
        if (alertNotificationSetting() != null) {
            alertNotificationSetting().validate();
        }
        if (computeId() == null) {
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException("Missing required property computeId in model MonitorDefinition"));
        }
        if (signals() == null) {
            throw LOGGER
                .logExceptionAsError(
