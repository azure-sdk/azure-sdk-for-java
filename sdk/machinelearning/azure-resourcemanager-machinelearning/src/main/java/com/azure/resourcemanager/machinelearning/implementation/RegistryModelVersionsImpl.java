...
public final class RegistryModelVersionsImpl implements RegistryModelVersions {
    ...
    public PagedIterable<ModelVersion> list(String resourceGroupName, String registryName, String modelName,
        ...
        PagedIterable<ModelVersionInner> inner = this.serviceClient().list(resourceGroupName, registryName, modelName,
            skip, orderBy, top, version, description, tags, properties, listViewType, context);
        return Utils.mapPage(inner, inner1 -> new ModelVersionImpl(inner1, this.manager()));
    }
    ...
    public PackageResponse packageMethod(String resourceGroupName, String registryName, String modelName,
        String version, PackageRequest body) {
        PackageResponseInner inner
            = this.serviceClient().packageMethod(resourceGroupName, registryName, modelName, version, body);
        if (inner != null) {
    ...
    public PackageResponse packageMethod(String resourceGroupName, String registryName, String modelName,
        ...
        PackageResponseInner inner
            = this.serviceClient().packageMethod(resourceGroupName, registryName, modelName, version, body, context);
        if (inner != null) {
            return new PackageResponseImpl(inner, this.manager());
        } else {
            return null;
    ...
    public Response<PendingUploadResponseDto> createOrGetStartPendingUploadWithResponse(String resourceGroupName,
        ...
        Response<PendingUploadResponseDtoInner> inner = this.serviceClient().createOrGetStartPendingUploadWithResponse(
    ...
    public PendingUploadResponseDto createOrGetStartPendingUpload(String resourceGroupName, String registryName,
        ...
        PendingUploadResponseDtoInner inner = this.serviceClient().createOrGetStartPendingUpload(resourceGroupName,
            registryName, modelName, version, body);
        if (inner != null) {
