...
public final class RegistryModelVersionsImpl implements RegistryModelVersions {
    ...
    public RegistryModelVersionsImpl(
        RegistryModelVersionsClient innerClient,
    ...
    public Response<BlobReferenceSasResponseDto> getBlobReferenceSasWithResponse(
        ...
        Response<BlobReferenceSasResponseDtoInner> inner =
            this
                .serviceClient()
                .getBlobReferenceSasWithResponse(resourceGroupName, registryName, modelName, version, body, context);
        if (inner != null) {
            return new SimpleResponse<>(
                inner.getRequest(),
                inner.getStatusCode(),
    ...
    public BlobReferenceSasResponseDto getBlobReferenceSas(
        ...
        BlobReferenceSasResponseDtoInner inner =
            this.serviceClient().getBlobReferenceSas(resourceGroupName, registryName, modelName, version, body);
        if (inner != null) {
