...
public final class WorkspacesImpl implements Workspaces {
    ...
    public Response<EndpointModels> listConnectionModelsWithResponse(String resourceGroupName, String workspaceName,
        Context context) {
        Response<EndpointModelsInner> inner
            = this.serviceClient().listConnectionModelsWithResponse(resourceGroupName, workspaceName, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
    ...
    public EndpointModels listConnectionModels(String resourceGroupName, String workspaceName) {
        EndpointModelsInner inner = this.serviceClient().listConnectionModels(resourceGroupName, workspaceName);
        if (inner != null) {
