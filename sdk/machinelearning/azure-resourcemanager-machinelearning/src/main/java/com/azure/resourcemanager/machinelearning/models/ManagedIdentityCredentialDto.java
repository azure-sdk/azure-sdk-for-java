...
/** The ManagedIdentityCredentialDto model. */
...
@Fluent
public final class ManagedIdentityCredentialDto extends DataReferenceCredentialDto {
    /*
    ...
    /** Creates an instance of ManagedIdentityCredentialDto class. */
    public ManagedIdentityCredentialDto() {
    }

    /**
     * Get the managedIdentityType property: Type of managed identity.
     *
    ...
    /**
     * Set the managedIdentityType property: Type of managed identity.
     *
     * @param managedIdentityType the managedIdentityType value to set.
     * @return the ManagedIdentityCredentialDto object itself.
     */
    public ManagedIdentityCredentialDto withManagedIdentityType(String managedIdentityType) {
     ...
     * @return the ManagedIdentityCredentialDto object itself.
     */
    public ManagedIdentityCredentialDto withUserManagedIdentityClientId(String userManagedIdentityClientId) {
     ...
     * @return the ManagedIdentityCredentialDto object itself.
     */
    public ManagedIdentityCredentialDto withUserManagedIdentityPrincipalId(String userManagedIdentityPrincipalId) {
     ...
     * @return the ManagedIdentityCredentialDto object itself.
     */
    public ManagedIdentityCredentialDto withUserManagedIdentityResourceId(String userManagedIdentityResourceId) {
     ...
     * @return the ManagedIdentityCredentialDto object itself.
     */
    public ManagedIdentityCredentialDto withUserManagedIdentityTenantId(String userManagedIdentityTenantId) {
