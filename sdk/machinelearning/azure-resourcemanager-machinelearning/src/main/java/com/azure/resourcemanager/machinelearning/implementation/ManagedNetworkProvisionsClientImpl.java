...
public final class ManagedNetworkProvisionsClientImpl implements ManagedNetworkProvisionsClient {
    ...
    ManagedNetworkProvisionsClientImpl(AzureMachineLearningServicesImpl client) {
        this.service =
            RestProxy
                .create(ManagedNetworkProvisionsService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }
    ...
    public interface ManagedNetworkProvisionsService {
        ...
        Mono<Response<Flux<ByteBuffer>>> provisionManagedNetwork(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("workspaceName") String workspaceName,
            @BodyParam("application/json") ManagedNetworkProvisionOptions parameters,
     ...
     * @param parameters Managed Network Provisioning Options for a machine learning workspace.
     * @throws IllegalArgumentException thrown if parameters fail the validation.
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return status of the Provisioning for the managed network of a machine learning workspace along with {@link
     *     Response} on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> provisionManagedNetworkWithResponseAsync(
        String resourceGroupName, String workspaceName, ManagedNetworkProvisionOptions parameters) {
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> provisionManagedNetworkWithResponseAsync(
        String resourceGroupName, String workspaceName, ManagedNetworkProvisionOptions parameters, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    private PollerFlux<PollResult<ManagedNetworkProvisionStatusInner>, ManagedNetworkProvisionStatusInner>
        beginProvisionManagedNetworkAsync(
            String resourceGroupName, String workspaceName, ManagedNetworkProvisionOptions parameters) {
        Mono<Response<Flux<ByteBuffer>>> mono =
            provisionManagedNetworkWithResponseAsync(resourceGroupName, workspaceName, parameters);
        return this
            .client
            .<ManagedNetworkProvisionStatusInner, ManagedNetworkProvisionStatusInner>getLroResult(
                mono,
                this.client.getHttpPipeline(),
                ManagedNetworkProvisionStatusInner.class,
                ManagedNetworkProvisionStatusInner.class,
    ...
    private PollerFlux<PollResult<ManagedNetworkProvisionStatusInner>, ManagedNetworkProvisionStatusInner>
        ...
        final ManagedNetworkProvisionOptions parameters = null;
        Mono<Response<Flux<ByteBuffer>>> mono =
            provisionManagedNetworkWithResponseAsync(resourceGroupName, workspaceName, parameters);
        return this
            .client
    ...
    private PollerFlux<PollResult<ManagedNetworkProvisionStatusInner>, ManagedNetworkProvisionStatusInner>
        beginProvisionManagedNetworkAsync(
            ...
            ManagedNetworkProvisionOptions parameters,
            Context context) {
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono =
            provisionManagedNetworkWithResponseAsync(resourceGroupName, workspaceName, parameters, context);
        return this
            .client
            .<ManagedNetworkProvisionStatusInner, ManagedNetworkProvisionStatusInner>getLroResult(
                mono,
    ...
    public SyncPoller<PollResult<ManagedNetworkProvisionStatusInner>, ManagedNetworkProvisionStatusInner>
        ...
        final ManagedNetworkProvisionOptions parameters = null;
        return this.beginProvisionManagedNetworkAsync(resourceGroupName, workspaceName, parameters).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<ManagedNetworkProvisionStatusInner>, ManagedNetworkProvisionStatusInner>
        beginProvisionManagedNetwork(
            ...
            Context context) {
        return this
            .beginProvisionManagedNetworkAsync(resourceGroupName, workspaceName, parameters, context)
            .getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ManagedNetworkProvisionStatusInner> provisionManagedNetworkAsync(
        String resourceGroupName, String workspaceName, ManagedNetworkProvisionOptions parameters) {
        return beginProvisionManagedNetworkAsync(resourceGroupName, workspaceName, parameters)
            .last()
    ...
    private Mono<ManagedNetworkProvisionStatusInner> provisionManagedNetworkAsync(
        String resourceGroupName, String workspaceName, ManagedNetworkProvisionOptions parameters, Context context) {
        return beginProvisionManagedNetworkAsync(resourceGroupName, workspaceName, parameters, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    public ManagedNetworkProvisionStatusInner provisionManagedNetwork(String resourceGroupName, String workspaceName) {
        final ManagedNetworkProvisionOptions parameters = null;
        return provisionManagedNetworkAsync(resourceGroupName, workspaceName, parameters).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ManagedNetworkProvisionStatusInner provisionManagedNetwork(
        String resourceGroupName, String workspaceName, ManagedNetworkProvisionOptions parameters, Context context) {
        return provisionManagedNetworkAsync(resourceGroupName, workspaceName, parameters, context).block();
    }
}
