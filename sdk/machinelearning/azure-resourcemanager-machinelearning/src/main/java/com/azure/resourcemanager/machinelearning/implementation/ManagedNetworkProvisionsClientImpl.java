...
public final class ManagedNetworkProvisionsClientImpl implements ManagedNetworkProvisionsClient {
    ...
    private Mono<ManagedNetworkProvisionStatusInner> provisionManagedNetworkAsync(
        String resourceGroupName, String workspaceName, ManagedNetworkProvisionOptions body) {
        return beginProvisionManagedNetworkAsync(resourceGroupName, workspaceName, body)
            .last()
    ...
    private Mono<ManagedNetworkProvisionStatusInner> provisionManagedNetworkAsync(
        String resourceGroupName, String workspaceName, ManagedNetworkProvisionOptions body, Context context) {
        return beginProvisionManagedNetworkAsync(resourceGroupName, workspaceName, body, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
