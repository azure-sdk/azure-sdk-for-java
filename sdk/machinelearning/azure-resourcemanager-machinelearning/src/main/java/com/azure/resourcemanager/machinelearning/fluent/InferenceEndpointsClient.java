...
public interface InferenceEndpointsClient {
    ...
    PagedIterable<InferenceEndpointMinimalTrackedResourceInner> list(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<InferenceEndpointMinimalTrackedResourceInner> getWithResponse(
        String resourceGroupName,
        String workspaceName,
        String poolName,
        String groupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    InferenceEndpointMinimalTrackedResourceInner get(
        String resourceGroupName, String workspaceName, String poolName, String groupName, String name);
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<InferenceEndpointMinimalTrackedResourceInner>, InferenceEndpointMinimalTrackedResourceInner>
        beginUpdate(
            String resourceGroupName,
            String workspaceName,
            String poolName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    InferenceEndpointMinimalTrackedResourceInner update(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    InferenceEndpointMinimalTrackedResourceInner createOrUpdate(
        String resourceGroupName,
        String workspaceName,
        String poolName,
        String groupName,
