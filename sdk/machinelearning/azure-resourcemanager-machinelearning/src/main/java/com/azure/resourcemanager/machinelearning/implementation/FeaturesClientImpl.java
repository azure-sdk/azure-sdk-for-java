...
public final class FeaturesClientImpl implements FeaturesClient {
    ...
    public interface FeaturesService {
        ...
        Mono<Response<FeatureResourceArmPaginatedResult>> list(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<FeatureInner>> get(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("workspaceName") String workspaceName,
            @PathParam("featuresetName") String featuresetName,
    ...
    private Mono<PagedResponse<FeatureInner>> listSinglePageAsync(String resourceGroupName, String workspaceName,
        ...
        return FluxUtil
            .withContext(context -> service.list(this.client.getEndpoint(), this.client.getSubscriptionId(),
                resourceGroupName, workspaceName, featuresetName, featuresetVersion, this.client.getApiVersion(), skip,
                tags, featureName, description, listViewType, pageSize, accept, context))
    ...
    private Mono<Response<FeatureInner>> getWithResponseAsync(String resourceGroupName, String workspaceName,
        ...
        return FluxUtil
            .withContext(context -> service.get(this.client.getEndpoint(), this.client.getSubscriptionId(),
                resourceGroupName, workspaceName, featuresetName, featuresetVersion, featureName,
