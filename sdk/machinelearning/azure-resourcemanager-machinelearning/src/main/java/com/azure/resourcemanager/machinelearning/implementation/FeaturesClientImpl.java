...
public final class FeaturesClientImpl implements FeaturesClient {
    ...
    public interface FeaturesService {
        ...
        Mono<Response<FeatureResourceArmPaginatedResult>> list(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("workspaceName") String workspaceName,
            @PathParam("featuresetName") String featuresetName,
            @PathParam("featuresetVersion") String featuresetVersion,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<FeatureInner>> get(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("workspaceName") String workspaceName,
    ...
    private Mono<PagedResponse<FeatureInner>> listSinglePageAsync(
    ...
    private PagedFlux<FeatureInner> listAsync(
        String resourceGroupName,
        String workspaceName,
        String featuresetName,
        String featuresetVersion,
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<FeatureInner> list(
        String resourceGroupName, String workspaceName, String featuresetName, String featuresetVersion) {
        final String skip = null;
        final String tags = null;
        final String featureName = null;
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<FeatureInner>> getWithResponseAsync(
        String resourceGroupName,
        String workspaceName,
        String featuresetName,
        String featuresetVersion,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<FeatureInner> getAsync(
        String resourceGroupName,
        String workspaceName,
        String featuresetName,
        String featuresetVersion,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<FeatureInner> getWithResponse(
        String resourceGroupName,
        String workspaceName,
        String featuresetName,
        String featuresetVersion,
        ...
        return getWithResponseAsync(
                resourceGroupName, workspaceName, featuresetName, featuresetVersion, featureName, context)
            .block();
    }
    ...
    public FeatureInner get(
        ...
        return getWithResponse(
                resourceGroupName, workspaceName, featuresetName, featuresetVersion, featureName, Context.NONE)
            .getValue();
    }
