...
public final class ManagedNetworkSettingsRulesClientImpl implements ManagedNetworkSettingsRulesClient {
    ...
    public interface ManagedNetworkSettingsRulesService {
        ...
        Mono<Response<Flux<ByteBuffer>>> createOrUpdate(
            ...
            @PathParam("ruleName") String ruleName,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") OutboundRuleBasicResourceInner parameters,
            @HeaderParam("Accept") String accept,
            Context context);
     ...
     * @return list of outbound rules for the managed network of a machine learning workspace along with {@link
     ...
     * @param workspaceName Name of Azure Machine Learning workspace.
     * @param ruleName Name of the workspace managed network outbound rule.
     * @param parameters Outbound Rule to be created or updated in the managed network of a machine learning workspace.
     * @throws IllegalArgumentException thrown if parameters fail the validation.
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return outbound Rule Basic Resource for the managed network of a machine learning workspace along with {@link
     *     Response} on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(
        String resourceGroupName, String workspaceName, String ruleName, OutboundRuleBasicResourceInner parameters) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(
        ...
        String ruleName,
        OutboundRuleBasicResourceInner parameters,
        Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
    ...
    private PollerFlux<PollResult<OutboundRuleBasicResourceInner>, OutboundRuleBasicResourceInner>
        beginCreateOrUpdateAsync(
            ...
            OutboundRuleBasicResourceInner parameters) {
        Mono<Response<Flux<ByteBuffer>>> mono =
            createOrUpdateWithResponseAsync(resourceGroupName, workspaceName, ruleName, parameters);
        return this
            .client
    ...
    private PollerFlux<PollResult<OutboundRuleBasicResourceInner>, OutboundRuleBasicResourceInner>
        ...
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono =
            createOrUpdateWithResponseAsync(resourceGroupName, workspaceName, ruleName, parameters, context);
        return this
            .client
            .<OutboundRuleBasicResourceInner, OutboundRuleBasicResourceInner>getLroResult(
                mono,
    ...
    public SyncPoller<PollResult<OutboundRuleBasicResourceInner>, OutboundRuleBasicResourceInner> beginCreateOrUpdate(
        String resourceGroupName, String workspaceName, String ruleName, OutboundRuleBasicResourceInner parameters) {
        return this.beginCreateOrUpdateAsync(resourceGroupName, workspaceName, ruleName, parameters).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<OutboundRuleBasicResourceInner>, OutboundRuleBasicResourceInner> beginCreateOrUpdate(
        ...
        Context context) {
        return this
            .beginCreateOrUpdateAsync(resourceGroupName, workspaceName, ruleName, parameters, context)
            .getSyncPoller();
    }
    ...
    private Mono<OutboundRuleBasicResourceInner> createOrUpdateAsync(
        String resourceGroupName, String workspaceName, String ruleName, OutboundRuleBasicResourceInner parameters) {
        return beginCreateOrUpdateAsync(resourceGroupName, workspaceName, ruleName, parameters)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<OutboundRuleBasicResourceInner> createOrUpdateAsync(
        ...
        OutboundRuleBasicResourceInner parameters,
        Context context) {
        return beginCreateOrUpdateAsync(resourceGroupName, workspaceName, ruleName, parameters, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    public OutboundRuleBasicResourceInner createOrUpdate(
        String resourceGroupName, String workspaceName, String ruleName, OutboundRuleBasicResourceInner parameters) {
        return createOrUpdateAsync(resourceGroupName, workspaceName, ruleName, parameters).block();
    }
    ...
    public OutboundRuleBasicResourceInner createOrUpdate(
        ...
        OutboundRuleBasicResourceInner parameters,
        Context context) {
        return createOrUpdateAsync(resourceGroupName, workspaceName, ruleName, parameters, context).block();
    }
