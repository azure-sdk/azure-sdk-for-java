...
public interface RegistriesClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<RegistryInner> list(String skip, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<RegistryInner> listByResourceGroup(String resourceGroupName, String skip, Context context);
    ...
    Response<Void> deleteWithResponse(String resourceGroupName, String registryName, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<RegistryInner> updateWithResponse(
    ...
    SyncPoller<PollResult<RegistryInner>, RegistryInner> beginCreateOrUpdate(
