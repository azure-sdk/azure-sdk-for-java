...
import com.azure.resourcemanager.machinelearning.models.RegistriesUpdateResponse;
...
public final class RegistriesClientImpl implements RegistriesClient {
    ...
    public interface RegistriesService {
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<RegistriesUpdateResponse> update(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("registryName") String registryName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<RegistriesUpdateResponse> updateWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public RegistriesUpdateResponse updateWithResponse(
        String resourceGroupName, String registryName, PartialRegistryPartialTrackedResource body, Context context) {
