...
public final class RegistriesClientImpl implements RegistriesClient {
    ...
    private PollerFlux<PollResult<RegistryInner>, RegistryInner> beginUpdateAsync(
        String resourceGroupName, String registryName, PartialRegistryPartialTrackedResource body) {
        Mono<Response<Flux<ByteBuffer>>> mono = updateWithResponseAsync(resourceGroupName, registryName, body);
        return this
            .client
    ...
    private PollerFlux<PollResult<RegistryInner>, RegistryInner> beginUpdateAsync(
        String resourceGroupName, String registryName, PartialRegistryPartialTrackedResource body, Context context) {
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono = updateWithResponseAsync(resourceGroupName, registryName, body, context);
        return this
            .client
            .<RegistryInner, RegistryInner>getLroResult(
    ...
    public SyncPoller<PollResult<RegistryInner>, RegistryInner> beginUpdate(
        String resourceGroupName, String registryName, PartialRegistryPartialTrackedResource body) {
        return this.beginUpdateAsync(resourceGroupName, registryName, body).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<RegistryInner>, RegistryInner> beginUpdate(
        String resourceGroupName, String registryName, PartialRegistryPartialTrackedResource body, Context context) {
        return this.beginUpdateAsync(resourceGroupName, registryName, body, context).getSyncPoller();
    }
    ...
    private Mono<RegistryInner> updateAsync(
        String resourceGroupName, String registryName, PartialRegistryPartialTrackedResource body) {
        return beginUpdateAsync(resourceGroupName, registryName, body)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<RegistryInner> updateAsync(
        String resourceGroupName, String registryName, PartialRegistryPartialTrackedResource body, Context context) {
        return beginUpdateAsync(resourceGroupName, registryName, body, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    public RegistryInner update(
        String resourceGroupName, String registryName, PartialRegistryPartialTrackedResource body, Context context) {
        return updateAsync(resourceGroupName, registryName, body, context).block();
    }
