...
public final class RegistriesClientImpl implements RegistriesClient {
    ...
    public interface RegistriesService {
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Flux<ByteBuffer>>> removeRegions(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("registryName") String registryName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> removeRegionsWithResponseAsync(
        String resourceGroupName, String registryName, RegistryInner body) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<RegistryInner>, RegistryInner> beginRemoveRegionsAsync(
        String resourceGroupName, String registryName, RegistryInner body) {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<RegistryInner>, RegistryInner> beginRemoveRegions(
        String resourceGroupName, String registryName, RegistryInner body) {
    ...
    private Mono<RegistryInner> removeRegionsAsync(String resourceGroupName, String registryName, RegistryInner body) {
        return beginRemoveRegionsAsync(resourceGroupName, registryName, body)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<RegistryInner> removeRegionsAsync(
        String resourceGroupName, String registryName, RegistryInner body, Context context) {
        return beginRemoveRegionsAsync(resourceGroupName, registryName, body, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public RegistryInner removeRegions(
        String resourceGroupName, String registryName, RegistryInner body, Context context) {
