...
public final class WorkspaceImpl implements Workspace, Workspace.Definition, Workspace.Update {
    ...
    public Response<EndpointModels> listConnectionModelsWithResponse(Context context) {
        return serviceManager.workspaces().listConnectionModelsWithResponse(resourceGroupName, workspaceName, context);
    }

    public EndpointModels listConnectionModels() {
        return serviceManager.workspaces().listConnectionModels(resourceGroupName, workspaceName);
    }
    ...
    public WorkspaceImpl withV1LegacyMode(Boolean v1LegacyMode) {
        if (isInCreateMode()) {
            ...
            this.updateParameters.withV1LegacyMode(v1LegacyMode);
            return this;
        }
    }
    ...
    public WorkspaceImpl withEnableDataIsolation(Boolean enableDataIsolation) {
        if (isInCreateMode()) {
            ...
            this.updateParameters.withEnableDataIsolation(enableDataIsolation);
            return this;
        }
    }
