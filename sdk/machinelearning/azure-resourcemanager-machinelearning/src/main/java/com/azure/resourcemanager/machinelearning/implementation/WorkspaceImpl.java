...
public final class WorkspaceImpl implements Workspace, Workspace.Definition, Workspace.Update {
    ...
    public WorkspaceImpl withServerlessComputeCustomSubnet(String serverlessComputeCustomSubnet) {
        if (isInCreateMode()) {
            ...
            this.updateBody.withServerlessComputeCustomSubnet(serverlessComputeCustomSubnet);
            return this;
        }
    }
    ...
    public WorkspaceImpl withServerlessComputeNoPublicIp(Boolean serverlessComputeNoPublicIp) {
        if (isInCreateMode()) {
            ...
            this.updateBody.withServerlessComputeNoPublicIp(serverlessComputeNoPublicIp);
            return this;
        }
    }
