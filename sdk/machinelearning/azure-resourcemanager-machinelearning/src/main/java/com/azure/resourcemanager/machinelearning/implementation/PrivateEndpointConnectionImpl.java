...
public final class PrivateEndpointConnectionImpl
    ...
    public PrivateEndpointConnectionImpl withIdentity(ManagedServiceIdentity identity) {
    ...
    public PrivateEndpointConnectionImpl withProvisioningState(EndpointServiceConnectionStatus provisioningState) {
