...
public interface RegistryDataContainers {
     ...
     */
    PagedIterable<DataContainer> list(String resourceGroupName, String registryName);
     ...
     * @return container.
     */
    DataContainer get(String resourceGroupName, String registryName, String name);
