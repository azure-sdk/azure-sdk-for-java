...
public final class RegistryCodeVersionsImpl implements RegistryCodeVersions {
    ...
    public RegistryCodeVersionsImpl(
        RegistryCodeVersionsClient innerClient,
    ...
    public Response<BlobReferenceSasResponseDto> getBlobReferenceSasWithResponse(
        ...
        Context context) {
        Response<BlobReferenceSasResponseDtoInner> inner =
            this
                .serviceClient()
                .getBlobReferenceSasWithResponse(resourceGroupName, registryName, codeName, version, body, context);
        if (inner != null) {
            return new SimpleResponse<>(
                inner.getRequest(),
                inner.getStatusCode(),
                inner.getHeaders(),
                new BlobReferenceSasResponseDtoImpl(inner.getValue(), this.manager()));
        } else {
            return null;
        }
    }

    public BlobReferenceSasResponseDto getBlobReferenceSas(
        String resourceGroupName,
        String registryName,
        String codeName,
        String version,
        BlobReferenceSasRequestDto body) {
        BlobReferenceSasResponseDtoInner inner =
            this.serviceClient().getBlobReferenceSas(resourceGroupName, registryName, codeName, version, body);
        if (inner != null) {
            return new BlobReferenceSasResponseDtoImpl(inner, this.manager());
        } else {
            return null;
        }
    }
    ...
    public Response<PendingUploadResponseDto> createOrGetStartPendingUploadWithResponse(
        ...
        Context context) {
        Response<PendingUploadResponseDtoInner> inner =
            this
                .serviceClient()
    ...
    public CodeVersion getById(String id) {
        ...
        String codeName = Utils.getValueFromIdByName(id, "codes");
        if (codeName == null) {
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException(
