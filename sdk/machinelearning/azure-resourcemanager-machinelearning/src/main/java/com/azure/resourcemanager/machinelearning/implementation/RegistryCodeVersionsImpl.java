...
public final class RegistryCodeVersionsImpl implements RegistryCodeVersions {
    ...
    public Response<PendingUploadResponseDto> createOrGetPendingUploadWithResponse(
        String resourceGroupName,
        String registryName,
        String codeName,
        String version,
    ...
    public PendingUploadResponseDto createOrGetPendingUpload(
        ...
        PendingUploadResponseDtoInner inner =
            this.serviceClient().createOrGetPendingUpload(resourceGroupName, registryName, codeName, version, body);
        if (inner != null) {
