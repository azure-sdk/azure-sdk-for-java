...
@JsonTypeInfo(
    ...
    property = "type",
    defaultImpl = SpeechEndpointDeploymentResourceProperties.class,
    visible = true)
...
public final class SpeechEndpointDeploymentResourceProperties extends EndpointDeploymentResourceProperties {
        ...
        if (model() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property model in model SpeechEndpointDeploymentResourceProperties"));
        } else {
            model().validate();
        }
        if (sku() != null) {
    ...
    private static final ClientLogger LOGGER = new ClientLogger(SpeechEndpointDeploymentResourceProperties.class);
}
