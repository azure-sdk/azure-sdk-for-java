...
public final class OnlineDeploymentsImpl implements OnlineDeployments {
    ...
    public Response<OnlineDeployment> getWithResponse(String resourceGroupName, String workspaceName,
        String endpointName, String deploymentName, Context context) {
        Response<OnlineDeploymentInner> inner = this.serviceClient().getWithResponse(resourceGroupName, workspaceName,
            endpointName, deploymentName, context);
        if (inner != null) {
    ...
    public Response<DeploymentLogs> getLogsWithResponse(String resourceGroupName, String workspaceName,
        String endpointName, String deploymentName, DeploymentLogsRequest body, Context context) {
        Response<DeploymentLogsInner> inner = this.serviceClient().getLogsWithResponse(resourceGroupName, workspaceName,
    ...
    public PagedIterable<SkuResource> listSkus(String resourceGroupName, String workspaceName, String endpointName,
        String deploymentName) {
    ...
    public PagedIterable<SkuResource> listSkus(String resourceGroupName, String workspaceName, String endpointName,
        ...
        PagedIterable<SkuResourceInner> inner = this.serviceClient().listSkus(resourceGroupName, workspaceName,
            endpointName, deploymentName, count, skip, context);
        return Utils.mapPage(inner, inner1 -> new SkuResourceImpl(inner1, this.manager()));
    }
