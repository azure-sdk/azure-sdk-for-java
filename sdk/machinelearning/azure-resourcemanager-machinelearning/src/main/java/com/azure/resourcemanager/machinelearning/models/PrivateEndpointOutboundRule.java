...
public final class PrivateEndpointOutboundRule extends OutboundRule {
    ...
    /**
     * Get the parentRuleName property: The dependency rule name.
     * 
     * @return the parentRuleName value.
     */
     ...
     * @return the PrivateEndpointOutboundRule object itself.
     */
    public PrivateEndpointOutboundRule withParentRuleNames(List<String> parentRuleNames) {
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeArrayField("parentRuleNames", this.parentRuleNames,
    ...
    public static PrivateEndpointOutboundRule fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                } else if ("parentRuleName".equals(fieldName)) {
                    deserializedPrivateEndpointOutboundRule.parentRuleName = reader.getString();
                } else if ("parentRuleNames".equals(fieldName)) {
                    List<String> parentRuleNames = reader.readArray(reader1 -> reader1.getString());
                    deserializedPrivateEndpointOutboundRule.parentRuleNames = parentRuleNames;
                } else {
                    reader.skipChildren();
                }
            }
