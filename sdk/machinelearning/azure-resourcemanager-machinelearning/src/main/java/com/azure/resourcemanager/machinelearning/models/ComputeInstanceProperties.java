...
public final class ComputeInstanceProperties {
     ...
     */
    @JsonProperty(value = "osPatchingResult", access = JsonProperty.Access.WRITE_ONLY)
    private ComputeInstanceOsPatchingResult osPatchingResult;
    ...
    /**
     * Get the osPatchingResult property: The result of os patching operation on this ComputeInstance.
     * 
     * @return the osPatchingResult value.
     */
    public ComputeInstanceOsPatchingResult osPatchingResult() {
        return this.osPatchingResult;
    }
    ...
    public void validate() {
        ...
        if (osPatchingResult() != null) {
            osPatchingResult().validate();
        }
