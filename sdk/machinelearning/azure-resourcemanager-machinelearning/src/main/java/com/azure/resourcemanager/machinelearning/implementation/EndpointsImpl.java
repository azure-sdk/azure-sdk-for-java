...
public final class EndpointsImpl implements Endpoints {
    ...
    public PagedIterable<EndpointResourcePropertiesBasicResource> list(String resourceGroupName, String workspaceName,
        ...
        PagedIterable<EndpointResourcePropertiesBasicResourceInner> inner = this.serviceClient().list(resourceGroupName,
            workspaceName, endpointType, includeInferenceEndpoints, skip, expand, context);
        return ResourceManagerUtils.mapPage(inner,
            inner1 -> new EndpointResourcePropertiesBasicResourceImpl(inner1, this.manager()));
    }
    ...
    public PagedIterable<AccountModel> getModels(String resourceGroupName, String workspaceName, String endpointName) {
    ...
    public Response<AccountApiKeys> regenerateKeysWithResponse(String resourceGroupName, String workspaceName,
        ...
        Response<AccountApiKeysInner> inner = this.serviceClient().regenerateKeysWithResponse(resourceGroupName,
            workspaceName, endpointName, body, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
