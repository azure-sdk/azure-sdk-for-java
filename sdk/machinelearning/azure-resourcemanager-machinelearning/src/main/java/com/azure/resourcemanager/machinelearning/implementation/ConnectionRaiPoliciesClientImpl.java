...
public final class ConnectionRaiPoliciesClientImpl implements ConnectionRaiPoliciesClient {
     ...
     */
    ConnectionRaiPoliciesClientImpl(AzureMachineLearningServicesImpl client) {
    ...
    /**
     * The interface defining all the services for AzureMachineLearningServicesConnectionRaiPolicies to be used by the
