...
public final class OnlineDeploymentInner extends Resource {
     ...
     * @return the OnlineDeploymentInner object itself.
     */
    public OnlineDeploymentInner withKind(String kind) {
        this.kind = kind;
        return this;
    }
     ...
     * @return the OnlineDeploymentInner object itself.
     */
    public OnlineDeploymentInner withSku(Sku sku) {
        this.sku = sku;
        return this;
    }
    ...
    public void validate() {
        ...
        if (location() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Missing required property location in model OnlineDeploymentInner"));
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(OnlineDeploymentInner.class);
    ...
    /**
     * Reads an instance of OnlineDeploymentInner from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of OnlineDeploymentInner if the JsonReader was pointing to an instance of it, or null if it
     * was pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the OnlineDeploymentInner.
     */
    public static OnlineDeploymentInner fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            OnlineDeploymentInner deserializedOnlineDeploymentInner = new OnlineDeploymentInner();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("id".equals(fieldName)) {
                    deserializedOnlineDeploymentInner.id = reader.getString();
                } else if ("name".equals(fieldName)) {
                    deserializedOnlineDeploymentInner.name = reader.getString();
                } else if ("type".equals(fieldName)) {
                    deserializedOnlineDeploymentInner.type = reader.getString();
                } else if ("location".equals(fieldName)) {
                    deserializedOnlineDeploymentInner.withLocation(reader.getString());
                    ...
                    deserializedOnlineDeploymentInner.systemData = SystemData.fromJson(reader);
                } else {
                    reader.skipChildren();
                }
            }

            return deserializedOnlineDeploymentInner;
        });
    }
}
