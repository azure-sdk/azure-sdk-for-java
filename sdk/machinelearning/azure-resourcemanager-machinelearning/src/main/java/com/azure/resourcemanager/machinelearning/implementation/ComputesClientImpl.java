...
public final class ComputesClientImpl implements ComputesClient {
    ...
    public interface ComputesService {
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Void>> updateCustomServices(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("workspaceName") String workspaceName,
            @PathParam("computeName") String computeName,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") List<CustomService> customServices,
            @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Void>> updateDataMounts(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("workspaceName") String workspaceName,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Void>> updateIdleShutdownSetting(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("workspaceName") String workspaceName,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<VirtualMachineSizeListResultInner>> getAllowedResizeSizes(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("workspaceName") String workspaceName,
        ...
        Mono<Response<Flux<ByteBuffer>>> resize(
            ...
            @PathParam("computeName") String computeName,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") ResizeSchema parameters,
            @HeaderParam("Accept") String accept,
            Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Void>> updateCustomServicesWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> updateCustomServicesAsync(
        String resourceGroupName, String workspaceName, String computeName, List<CustomService> customServices) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Void>> updateDataMountsWithResponseAsync(
        String resourceGroupName, String workspaceName, String computeName, List<ComputeInstanceDataMount> dataMounts) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> updateDataMountsAsync(
        String resourceGroupName, String workspaceName, String computeName, List<ComputeInstanceDataMount> dataMounts) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<Void> updateDataMountsWithResponse(
        String resourceGroupName,
        String workspaceName,
        String computeName,
        List<ComputeInstanceDataMount> dataMounts,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Void>> updateIdleShutdownSettingWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> updateIdleShutdownSettingAsync(
        String resourceGroupName, String workspaceName, String computeName, IdleShutdownSetting parameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<VirtualMachineSizeListResultInner> getAllowedResizeSizesAsync(
        String resourceGroupName, String workspaceName, String computeName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<VirtualMachineSizeListResultInner> getAllowedResizeSizesWithResponse(
        String resourceGroupName, String workspaceName, String computeName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public VirtualMachineSizeListResultInner getAllowedResizeSizes(
        String resourceGroupName, String workspaceName, String computeName) {
    ...
    public SyncPoller<PollResult<Void>, Void> beginResize(
        String resourceGroupName, String workspaceName, String computeName, ResizeSchema parameters, Context context) {
        return this
            .beginResizeAsync(resourceGroupName, workspaceName, computeName, parameters, context)
            .getSyncPoller();
    }
    ...
    private Mono<Void> resizeAsync(
        String resourceGroupName, String workspaceName, String computeName, ResizeSchema parameters) {
        return beginResizeAsync(resourceGroupName, workspaceName, computeName, parameters)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<Void> resizeAsync(
        String resourceGroupName, String workspaceName, String computeName, ResizeSchema parameters, Context context) {
        return beginResizeAsync(resourceGroupName, workspaceName, computeName, parameters, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
