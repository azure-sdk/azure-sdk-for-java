...
public final class ComputesClientImpl implements ComputesClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<ComputeResourceInner>, ComputeResourceInner> beginResizeAsync(
        String resourceGroupName, String workspaceName, String computeName, ResizeSchema parameters) {
        Mono<Response<Flux<ByteBuffer>>> mono =
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<ComputeResourceInner>, ComputeResourceInner> beginResize(
        String resourceGroupName, String workspaceName, String computeName, ResizeSchema parameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ComputeResourceInner> resizeAsync(
        String resourceGroupName, String workspaceName, String computeName, ResizeSchema parameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ComputeResourceInner resize(
        String resourceGroupName, String workspaceName, String computeName, ResizeSchema parameters) {
        return resizeAsync(resourceGroupName, workspaceName, computeName, parameters).block();
    }
    ...
    public ComputeResourceInner resize(
        String resourceGroupName, String workspaceName, String computeName, ResizeSchema parameters, Context context) {
        return resizeAsync(resourceGroupName, workspaceName, computeName, parameters, context).block();
    }
