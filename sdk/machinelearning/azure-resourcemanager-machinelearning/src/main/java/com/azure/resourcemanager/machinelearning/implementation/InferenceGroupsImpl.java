...
public final class InferenceGroupsImpl implements InferenceGroups {
    ...
    public PagedIterable<InferenceGroup> list(String resourceGroupName, String workspaceName, String poolName) {
        ...
        return Utils.mapPage(inner, inner1 -> new InferenceGroupImpl(inner1, this.manager()));
    }

    public PagedIterable<InferenceGroup> list(String resourceGroupName, String workspaceName, String poolName,
        Integer count, String skip, String tags, String properties, OrderString orderBy, Context context) {
        PagedIterable<InferenceGroupInner> inner = this.serviceClient().list(resourceGroupName, workspaceName, poolName,
            count, skip, tags, properties, orderBy, context);
        return Utils.mapPage(inner, inner1 -> new InferenceGroupImpl(inner1, this.manager()));
    }
    ...
    public Response<GroupStatus> getStatusWithResponse(String resourceGroupName, String workspaceName, String poolName,
        String groupName, Context context) {
        Response<GroupStatusInner> inner = this.serviceClient().getStatusWithResponse(resourceGroupName, workspaceName,
            poolName, groupName, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
    ...
    public PagedIterable<SkuResource> listSkus(String resourceGroupName, String workspaceName, String poolName,
        ...
        PagedIterable<SkuResourceInner> inner = this.serviceClient().listSkus(resourceGroupName, workspaceName,
            poolName, groupName, count, skip, context);
        return Utils.mapPage(inner, inner1 -> new SkuResourceImpl(inner1, this.manager()));
    }
