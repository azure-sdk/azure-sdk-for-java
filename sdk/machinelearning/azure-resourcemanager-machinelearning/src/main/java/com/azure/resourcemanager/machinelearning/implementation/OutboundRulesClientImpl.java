...
public final class OutboundRulesClientImpl implements OutboundRulesClient {
    ...
    private PollerFlux<PollResult<Void>, Void> beginDeleteAsync(String resourceGroupName, String workspaceName,
        ...
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono
            = deleteWithResponseAsync(resourceGroupName, workspaceName, managedNetworkName, ruleName, context);
        return this.client.<Void, Void>getLroResult(mono, this.client.getHttpPipeline(), Void.class, Void.class,
            context);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String workspaceName,
        String managedNetworkName, String ruleName) {
        return this.beginDeleteAsync(resourceGroupName, workspaceName, managedNetworkName, ruleName).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String workspaceName,
        String managedNetworkName, String ruleName, Context context) {
        return this.beginDeleteAsync(resourceGroupName, workspaceName, managedNetworkName, ruleName, context)
            .getSyncPoller();
    }
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String workspaceName, String managedNetworkName,
        ...
        return beginDeleteAsync(resourceGroupName, workspaceName, managedNetworkName, ruleName, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    public void delete(String resourceGroupName, String workspaceName, String managedNetworkName, String ruleName) {
        deleteAsync(resourceGroupName, workspaceName, managedNetworkName, ruleName).block();
    }
    ...
    public void delete(String resourceGroupName, String workspaceName, String managedNetworkName, String ruleName,
        Context context) {
        deleteAsync(resourceGroupName, workspaceName, managedNetworkName, ruleName, context).block();
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<OutboundRuleBasicResourceInner>> getWithResponseAsync(String resourceGroupName,
        String workspaceName, String managedNetworkName, String ruleName, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service.get(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName, workspaceName,
            managedNetworkName, ruleName, this.client.getApiVersion(), accept, context);
    }
    ...
    public Response<OutboundRuleBasicResourceInner> getWithResponse(String resourceGroupName, String workspaceName,
        String managedNetworkName, String ruleName, Context context) {
        return getWithResponseAsync(resourceGroupName, workspaceName, managedNetworkName, ruleName, context).block();
    }
    ...
    private PollerFlux<PollResult<OutboundRuleBasicResourceInner>, OutboundRuleBasicResourceInner>
        ...
        Mono<Response<Flux<ByteBuffer>>> mono = createOrUpdateWithResponseAsync(resourceGroupName, workspaceName,
            managedNetworkName, ruleName, body, context);
        return this.client.<OutboundRuleBasicResourceInner, OutboundRuleBasicResourceInner>getLroResult(mono,
            this.client.getHttpPipeline(), OutboundRuleBasicResourceInner.class, OutboundRuleBasicResourceInner.class,
            context);
    }
    ...
    public SyncPoller<PollResult<OutboundRuleBasicResourceInner>, OutboundRuleBasicResourceInner> beginCreateOrUpdate(
        ...
        return this.beginCreateOrUpdateAsync(resourceGroupName, workspaceName, managedNetworkName, ruleName, body)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<OutboundRuleBasicResourceInner>, OutboundRuleBasicResourceInner> beginCreateOrUpdate(
        ...
        return this
            .beginCreateOrUpdateAsync(resourceGroupName, workspaceName, managedNetworkName, ruleName, body, context)
            .getSyncPoller();
    }
    ...
    private Mono<OutboundRuleBasicResourceInner> createOrUpdateAsync(String resourceGroupName, String workspaceName,
        ...
        return beginCreateOrUpdateAsync(resourceGroupName, workspaceName, managedNetworkName, ruleName, body, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    public OutboundRuleBasicResourceInner createOrUpdate(String resourceGroupName, String workspaceName,
        String managedNetworkName, String ruleName, OutboundRuleBasicResourceInner body) {
        return createOrUpdateAsync(resourceGroupName, workspaceName, managedNetworkName, ruleName, body).block();
    }
    ...
    public OutboundRuleBasicResourceInner createOrUpdate(String resourceGroupName, String workspaceName,
        String managedNetworkName, String ruleName, OutboundRuleBasicResourceInner body, Context context) {
        return createOrUpdateAsync(resourceGroupName, workspaceName, managedNetworkName, ruleName, body, context)
            .block();
    }
    ...
    private PagedFlux<OutboundRuleBasicResourceInner> listAsync(String resourceGroupName, String workspaceName,
        ...
        return new PagedFlux<>(() -> listSinglePageAsync(resourceGroupName, workspaceName, managedNetworkName, context),
    ...
    public PagedIterable<OutboundRuleBasicResourceInner> list(String resourceGroupName, String workspaceName,
        String managedNetworkName) {
        return new PagedIterable<>(listAsync(resourceGroupName, workspaceName, managedNetworkName));
    }
    ...
    public PagedIterable<OutboundRuleBasicResourceInner> list(String resourceGroupName, String workspaceName,
        String managedNetworkName, Context context) {
        return new PagedIterable<>(listAsync(resourceGroupName, workspaceName, managedNetworkName, context));
    }
