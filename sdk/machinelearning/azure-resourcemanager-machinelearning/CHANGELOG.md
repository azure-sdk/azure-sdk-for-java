...
* `models.ManagedNetworkSettingsDtoBasicResource` was added

* `models.ManagedNetworkSettingsDtoBasicResource$UpdateStages` was added

* `models.ManagedNetworkSettingsOperations` was added

* `models.WorkspaceConnectionUpdateParameter` was added

* `models.ManagedNetworkSettingsDtoBasicResource$Update` was added

* `models.FirewallSku` was added

* `models.ManagedNetworkSettingsDto` was added

* `models.ManagedNetworkSettingsDtoBasicResource$DefinitionStages` was added

* `models.ManagedNetworkSettingsDtoBasicResource$Definition` was added
