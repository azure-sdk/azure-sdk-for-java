...
public final class CreatesAChatCompletionForTheProvidedPromptUsingStreamingTests extends ChatProtocolClientTestBase {
    @Test
    @Disabled
    public void testCreatesAChatCompletionForTheProvidedPromptUsingStreamingTests() throws IOException {
        // method invocation
        ChatCompletionChunk response = chatProtocolClient.createStreaming("chat",
            Arrays.asList(new TextChatMessage(ChatRole.USER, "Tell me a joke")),
            JacksonAdapter.createDefaultSerializerAdapter().deserialize("null", Object.class, SerializerEncoding.JSON),
            mapOf());
