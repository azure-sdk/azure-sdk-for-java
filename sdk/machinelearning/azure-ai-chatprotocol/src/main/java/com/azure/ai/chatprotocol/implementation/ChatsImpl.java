...
public final class ChatsImpl {
    ...
    public interface ChatsService {
        ...
        Mono<Response<BinaryData>> createStreaming(@HostParam("endpoint") String endpoint,
            ...
            @BodyParam("application/json") BinaryData createStreamingRequest, RequestOptions requestOptions,
            Context context);
    ...
    public Mono<Response<BinaryData>> createStreamingWithResponseAsync(String operationRoute,
        ...
        return FluxUtil.withContext(context -> service.createStreaming(this.client.getEndpoint(), operationRoute,
            accept, createStreamingRequest, requestOptions, context));
    }
    ...
    public Response<BinaryData> createStreamingWithResponse(String operationRoute, BinaryData createStreamingRequest,
        ...
        final String accept = "application/json";
        return service.createStreamingSync(this.client.getEndpoint(), operationRoute, accept, createStreamingRequest,
    ...
    public Mono<Response<BinaryData>> createWithResponseAsync(String operationRoute, BinaryData createRequest,
        ...
        return FluxUtil.withContext(context -> service.create(this.client.getEndpoint(), operationRoute, accept,
            createRequest, requestOptions, context));
    }
    ...
    public Response<BinaryData> createWithResponse(String operationRoute, BinaryData createRequest,
        RequestOptions requestOptions) {
        final String accept = "application/json";
        return service.createSync(this.client.getEndpoint(), operationRoute, accept, createRequest, requestOptions,
            Context.NONE);
    }
}
