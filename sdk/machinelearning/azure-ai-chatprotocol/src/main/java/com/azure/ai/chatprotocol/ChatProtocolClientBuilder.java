...
public final class ChatProtocolClientBuilder implements HttpTrait<ChatProtocolClientBuilder>,
    ConfigurationTrait<ChatProtocolClientBuilder>, TokenCredentialTrait<ChatProtocolClientBuilder>,
    KeyCredentialTrait<ChatProtocolClientBuilder>, EndpointTrait<ChatProtocolClientBuilder> {
    @Generated
    ...
    @Generated
    private static final Map<String, String> PROPERTIES = CoreUtils.getProperties("azure-ai-chatprotocol.properties");
    ...
    private ChatProtocolClientImpl buildInnerClient() {
        ...
        ChatProtocolClientImpl client
            = new ChatProtocolClientImpl(localPipeline, JacksonAdapter.createDefaultSerializerAdapter(), this.endpoint);
        return client;
    }
    ...
    public ChatProtocolAsyncClient buildAsyncClient() {
        return new ChatProtocolAsyncClient(buildInnerClient());
    }
    ...
    public ChatProtocolClient buildClient() {
        return new ChatProtocolClient(buildInnerClient());
    }
