...
@Fluent
public final class StreamingChatCompletionOptionsRecord {
    /*
    ...
    /**
     * Creates an instance of StreamingChatCompletionOptionsRecord class.
     *
     * @param messages the messages value to set.
     */
    @Generated
    @JsonCreator
    public StreamingChatCompletionOptionsRecord(@JsonProperty(value = "messages") List<ChatMessage> messages) {
        stream = true;
     ...
     * @return the StreamingChatCompletionOptionsRecord object itself.
     */
    @Generated
    public StreamingChatCompletionOptionsRecord setSessionState(Object sessionState) {
     ...
     */
    @Generated
    public StreamingChatCompletionOptionsRecord setContext(Map<String, Object> context) {
