 ...
 */
@Fluent
public final class ChatCompletionOptions implements JsonSerializable<ChatCompletionOptions> {
    /*
     ...
     */
    @Generated
    public ChatCompletionOptions(List<ChatMessage> messages) {
    ...
    /**
     * Reads an instance of ChatCompletionOptions from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of ChatCompletionOptions if the JsonReader was pointing to an instance of it, or null if it
     * was pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the ChatCompletionOptions.
     */
    @Generated
    public static ChatCompletionOptions fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            ChatCompletionOptions deserializedChatCompletionOptions = new ChatCompletionOptions(messages);
            deserializedChatCompletionOptions.sessionState = sessionState;
            deserializedChatCompletionOptions.context = context;

            return deserializedChatCompletionOptions;
        });
    }
}
