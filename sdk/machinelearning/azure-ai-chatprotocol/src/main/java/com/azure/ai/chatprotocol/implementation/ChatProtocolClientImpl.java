...
public final class ChatProtocolClientImpl {
    ...
    public Mono<Response<BinaryData>> createStreamingWithResponseAsync(String operationRoute,
        ...
        return FluxUtil.withContext(context -> service.createStreaming(this.getEndpoint(), operationRoute, accept,
            streamingChatCompletionOptions, requestOptions, context));
    }
    ...
    public Response<BinaryData> createStreamingWithResponse(String operationRoute,
        BinaryData streamingChatCompletionOptions, RequestOptions requestOptions) {
        final String accept = "application/json";
        return service.createStreamingSync(this.getEndpoint(), operationRoute, accept, streamingChatCompletionOptions,
    ...
    public Mono<Response<BinaryData>> createWithResponseAsync(String operationRoute, BinaryData chatCompletionOptions,
        ...
        final String accept = "application/json";
        return FluxUtil.withContext(context -> service.create(this.getEndpoint(), operationRoute, accept,
    ...
    public Response<BinaryData> createWithResponse(String operationRoute, BinaryData chatCompletionOptions,
        RequestOptions requestOptions) {
        final String accept = "application/json";
        return service.createSync(this.getEndpoint(), operationRoute, accept, chatCompletionOptions, requestOptions,
            Context.NONE);
    }
}
