 ...
 */
@Fluent
public final class StreamingChatCompletionOptions implements JsonSerializable<StreamingChatCompletionOptions> {
    /*
     ...
     */
    @Generated
    public StreamingChatCompletionOptions(List<ChatMessage> messages) {
    ...
    /**
     * Reads an instance of StreamingChatCompletionOptions from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of StreamingChatCompletionOptions if the JsonReader was pointing to an instance of it, or
     * null if it was pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the StreamingChatCompletionOptions.
     */
    @Generated
    public static StreamingChatCompletionOptions fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            StreamingChatCompletionOptions deserializedStreamingChatCompletionOptions
                = new StreamingChatCompletionOptions(messages);
            deserializedStreamingChatCompletionOptions.sessionState = sessionState;
            deserializedStreamingChatCompletionOptions.context = context;

            return deserializedStreamingChatCompletionOptions;
        });
    }
}
