...
public final class ChatProtocolClient {
    ...
    public Response<BinaryData> createStreamingWithResponse(
        ...
        return this.serviceClient.createStreamingWithResponse(streamingChatCompletionOptions, requestOptions);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<BinaryData> createWithResponse(BinaryData chatCompletionOptions, RequestOptions requestOptions) {
        return this.serviceClient.createWithResponse(chatCompletionOptions, requestOptions);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ChatCompletionChunkRecord createStreaming(
        ...
        return createStreamingWithResponse(BinaryData.fromObject(streamingChatCompletionOptions), requestOptions)
                .getValue()
                .toObject(ChatCompletionChunkRecord.class);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ChatCompletionRecord create(ChatCompletionOptionsRecord chatCompletionOptions) {
        // Generated convenience method for createWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return createWithResponse(BinaryData.fromObject(chatCompletionOptions), requestOptions)
                .getValue()
                .toObject(ChatCompletionRecord.class);
    }
}
