...
public final class ChatProtocolClient {
    ...
    public Response<BinaryData> createStreamingWithResponse(String operationRoute,
        ...
        return this.serviceClient.createStreamingWithResponse(operationRoute, streamingChatCompletionOptions,
            requestOptions);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ChatCompletionDelta createStreaming(String operationRoute,
        ...
        return createStreamingWithResponse(operationRoute, BinaryData.fromObject(streamingChatCompletionOptions),
            requestOptions).getValue().toObject(ChatCompletionDelta.class);
    }
    ...
    public ChatCompletion create(String operationRoute, ChatCompletionOptions chatCompletionOptions) {
        ...
        return createWithResponse(operationRoute, BinaryData.fromObject(chatCompletionOptions), requestOptions)
            .getValue().toObject(ChatCompletion.class);
    }
}
