...
public final class ChatProtocolClient {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ChatCompletionChunk createStreaming(String operationRoute, List<ChatMessage> messages, Object sessionState,
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ChatCompletion create(String operationRoute, List<ChatMessage> messages, Object sessionState,
        Map<String, Object> context) {
