...
@Immutable
public final class ChatChoiceRecord {
    /*
    ...
    /**
     * Creates an instance of ChatChoiceRecord class.
     *
    ...
    @Generated
    @JsonCreator
    private ChatChoiceRecord(
            @JsonProperty(value = "index") long index,
            @JsonProperty(value = "message") ChatMessage message,
            @JsonProperty(value = "finish_reason") FinishReason finishReason) {
        this.index = index;
