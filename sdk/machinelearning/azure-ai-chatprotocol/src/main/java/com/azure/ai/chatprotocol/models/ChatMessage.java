...
public final class ChatMessage {
    ...
    @Generated
    @JsonCreator
    public ChatMessage(@JsonProperty(value = "content") String content, @JsonProperty(value = "role") ChatRole role) {
     ...
     */
    @Generated
    public ChatMessage setSessionState(Object sessionState) {
