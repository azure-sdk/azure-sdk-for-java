...
public final class ChatProtocolAsyncClient {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> createWithResponse(String operationRoute, BinaryData createRequest,
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<ChatCompletionChunk> createStreaming(String operationRoute, List<ChatMessage> messages,
        Object sessionState, Map<String, Object> context) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<ChatCompletion> create(String operationRoute, List<ChatMessage> messages, Object sessionState,
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<ChatCompletion> create(String operationRoute, List<ChatMessage> messages) {
        // Generated convenience method for createWithResponse
        RequestOptions requestOptions = new RequestOptions();
