...
import com.azure.ai.chatprotocol.models.ChatCompletionDelta;
...
public final class ChatProtocolAsyncClient {
    @Generated
    private final ChatProtocolClientImpl serviceClient;
    ...
    public Mono<Response<BinaryData>> createStreamingWithResponse(String operationRoute,
        BinaryData streamingChatCompletionOptions, RequestOptions requestOptions) {
        return this.serviceClient.createStreamingWithResponseAsync(operationRoute, streamingChatCompletionOptions,
            requestOptions);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> createWithResponse(String operationRoute, BinaryData chatCompletionOptions,
        RequestOptions requestOptions) {
        return this.serviceClient.createWithResponseAsync(operationRoute, chatCompletionOptions, requestOptions);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<ChatCompletionDelta> createStreaming(String operationRoute,
        StreamingChatCompletionOptions streamingChatCompletionOptions) {
        // Generated convenience method for createStreamingWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return createStreamingWithResponse(operationRoute, BinaryData.fromObject(streamingChatCompletionOptions),
            requestOptions).flatMap(FluxUtil::toMono)
                .map(protocolMethodData -> protocolMethodData.toObject(ChatCompletionDelta.class));
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<ChatCompletion> create(String operationRoute, ChatCompletionOptions chatCompletionOptions) {
        // Generated convenience method for createWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return createWithResponse(operationRoute, BinaryData.fromObject(chatCompletionOptions), requestOptions)
            .flatMap(FluxUtil::toMono).map(protocolMethodData -> protocolMethodData.toObject(ChatCompletion.class));
    }
}
