...
public final class ChatProtocolAsyncClient {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<ChatCompletionChunk> createStreaming(List<ChatMessage> messages, String operationRoute,
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<ChatCompletion> create(List<ChatMessage> messages, String operationRoute, Object sessionState,
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<ChatCompletion> create(List<ChatMessage> messages, String operationRoute) {
        // Generated convenience method for createWithResponse
        RequestOptions requestOptions = new RequestOptions();
