        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("latestMonthEmissions".equals(fieldName)) {
                    deserializedResourceCarbonEmissionItemDetailData.latestMonthEmissions = reader.getDouble();
                } else if ("previousMonthEmissions".equals(fieldName)) {
                    deserializedResourceCarbonEmissionItemDetailData.previousMonthEmissions = reader.getDouble();
                } else if ("monthOverMonthEmissionsChangeRatio".equals(fieldName)) {
                    deserializedResourceCarbonEmissionItemDetailData.monthOverMonthEmissionsChangeRatio
                        = reader.getNullable(JsonReader::getDouble);
                } else if ("monthlyEmissionsChangeValue".equals(fieldName)) {
                    deserializedResourceCarbonEmissionItemDetailData.monthlyEmissionsChangeValue
                        = reader.getNullable(JsonReader::getDouble);
