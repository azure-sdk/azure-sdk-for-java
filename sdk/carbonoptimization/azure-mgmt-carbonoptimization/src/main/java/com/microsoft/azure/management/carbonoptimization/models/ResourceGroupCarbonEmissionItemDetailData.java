        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("latestMonthEmissions".equals(fieldName)) {
                    deserializedResourceGroupCarbonEmissionItemDetailData.latestMonthEmissions = reader.getDouble();
                } else if ("previousMonthEmissions".equals(fieldName)) {
                    deserializedResourceGroupCarbonEmissionItemDetailData.previousMonthEmissions = reader.getDouble();
                } else if ("monthOverMonthEmissionsChangeRatio".equals(fieldName)) {
                    deserializedResourceGroupCarbonEmissionItemDetailData.monthOverMonthEmissionsChangeRatio
                        = reader.getNullable(JsonReader::getDouble);
                } else if ("monthlyEmissionsChangeValue".equals(fieldName)) {
                    deserializedResourceGroupCarbonEmissionItemDetailData.monthlyEmissionsChangeValue
                        = reader.getNullable(JsonReader::getDouble);
