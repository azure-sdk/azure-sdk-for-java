 ...
 */
@Immutable
public final class ResourceCarbonEmissionTopItemsSummaryData extends CarbonEmissionDataInner {
    /*
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("latestMonthEmissions".equals(fieldName)) {
                    deserializedResourceCarbonEmissionTopItemsSummaryData.latestMonthEmissions = reader.getDouble();
                } else if ("previousMonthEmissions".equals(fieldName)) {
                    deserializedResourceCarbonEmissionTopItemsSummaryData.previousMonthEmissions = reader.getDouble();
                } else if ("monthOverMonthEmissionsChangeRatio".equals(fieldName)) {
                    deserializedResourceCarbonEmissionTopItemsSummaryData.monthOverMonthEmissionsChangeRatio
                        = reader.getNullable(JsonReader::getDouble);
                } else if ("monthlyEmissionsChangeValue".equals(fieldName)) {
                    deserializedResourceCarbonEmissionTopItemsSummaryData.monthlyEmissionsChangeValue
                        = reader.getNullable(JsonReader::getDouble);
