...
import com.microsoft.azure.management.carbonoptimization.implementation.models.CarbonEmissionDataListResult;
...
public final class CarbonServicesClientImpl implements CarbonServicesClient {
     ...
     */
    private final CarbonClientImpl client;
     ...
     */
    CarbonServicesClientImpl(CarbonClientImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for CarbonClientCarbonServices to be used by the proxy service to perform
     * REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "CarbonClientCarbonSe")
