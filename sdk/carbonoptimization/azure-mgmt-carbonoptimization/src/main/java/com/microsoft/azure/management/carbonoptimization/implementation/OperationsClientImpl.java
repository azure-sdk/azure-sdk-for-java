...
import com.microsoft.azure.management.carbonoptimization.implementation.models.OperationListResult;
...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    OperationsClientImpl(CarbonClientImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for CarbonClientOperations to be used by the proxy service to perform
     * REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "CarbonClientOperatio")
