...
public interface Skus {
     ...
     */
    PagedIterable<Sku> listByOffer(String resourceGroupName, String clusterName, String publisherName,
        String offerName);
     ...
     * @return list of SKU proxy resources for the HCI cluster as paginated response with {@link PagedIterable}.
     */
    PagedIterable<Sku> listByOffer(String resourceGroupName, String clusterName, String publisherName, String offerName,
     ...
     */
    Response<Sku> getWithResponse(String resourceGroupName, String clusterName, String publisherName, String offerName,
        String skuName, String expand, Context context);
