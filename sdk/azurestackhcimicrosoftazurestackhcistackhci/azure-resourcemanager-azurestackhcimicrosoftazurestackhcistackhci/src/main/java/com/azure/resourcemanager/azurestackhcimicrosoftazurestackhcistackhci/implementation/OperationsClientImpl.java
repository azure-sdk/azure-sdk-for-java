...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    OperationsClientImpl(AzureStackHciClientImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for AzureStackHciClientOperations to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{$host}")
    ...
    public interface OperationsService {
        ...
        Mono<Response<OperationListResultInner>> list(@HostParam("$host") String endpoint,
