...
public interface UpdateRunsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<UpdateRunInner> putWithResponse(String resourceGroupName, String clusterName, String updateName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<UpdateRunInner> getWithResponse(String resourceGroupName, String clusterName, String updateName,
        String updateRunName, Context context);
