...
public interface SkusClient {
    ...
    PagedIterable<SkuInner> listByOffer(String resourceGroupName, String clusterName, String publisherName,
        String offerName);
    ...
    Response<SkuInner> getWithResponse(String resourceGroupName, String clusterName, String publisherName,
