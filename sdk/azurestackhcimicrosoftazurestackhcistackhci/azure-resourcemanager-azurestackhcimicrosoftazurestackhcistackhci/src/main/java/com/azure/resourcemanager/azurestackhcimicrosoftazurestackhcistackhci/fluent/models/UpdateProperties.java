...
public final class UpdateProperties {
     ...
     */
    @JsonProperty(value = "minSbeVersionRequired")
     ...
     */
    @JsonProperty(value = "packageSizeInMb")
     ...
     */
    @JsonProperty(value = "releaseLink")
    private String releaseLink;

    /*
     * Indicates the way the update content can be downloaded.
     */
    @JsonProperty(value = "availabilityType")
     ...
     */
    @JsonProperty(value = "updateStateProperties")
