...
public final class UpdateInner extends ProxyResource {
     ...
     */
    public UpdateInner withLocation(String location) {
     ...
     * @return the UpdateInner object itself.
     */
    public UpdateInner withInstalledDate(OffsetDateTime installedDate) {
     ...
     * @return the UpdateInner object itself.
     */
    public UpdateInner withDescription(String description) {
        if (this.innerProperties() == null) {
            this.innerProperties = new UpdateProperties();
        }
     ...
     * @return the UpdateInner object itself.
     */
    public UpdateInner withMinSbeVersionRequired(String minSbeVersionRequired) {
        if (this.innerProperties() == null) {
            this.innerProperties = new UpdateProperties();
        }
     ...
     * @return the UpdateInner object itself.
     */
    public UpdateInner withState(State state) {
        if (this.innerProperties() == null) {
            this.innerProperties = new UpdateProperties();
        }
     ...
     * @return the UpdateInner object itself.
     */
    public UpdateInner withPrerequisites(List<UpdatePrerequisite> prerequisites) {
        if (this.innerProperties() == null) {
            this.innerProperties = new UpdateProperties();
        }
     ...
     * @return the UpdateInner object itself.
     */
    public UpdateInner withComponentVersions(List<PackageVersionInfo> componentVersions) {
        if (this.innerProperties() == null) {
            this.innerProperties = new UpdateProperties();
        }
     ...
     * @return the UpdateInner object itself.
     */
    public UpdateInner withRebootRequired(RebootRequirement rebootRequired) {
        if (this.innerProperties() == null) {
            this.innerProperties = new UpdateProperties();
        }
     ...
     * @return the UpdateInner object itself.
     */
    public UpdateInner withHealthState(HealthState healthState) {
        if (this.innerProperties() == null) {
            this.innerProperties = new UpdateProperties();
        }
     ...
     * @return the UpdateInner object itself.
     */
    public UpdateInner withHealthCheckResult(List<PrecheckResult> healthCheckResult) {
        if (this.innerProperties() == null) {
            this.innerProperties = new UpdateProperties();
        }
     ...
     * @return the UpdateInner object itself.
     */
    public UpdateInner withHealthCheckDate(OffsetDateTime healthCheckDate) {
        if (this.innerProperties() == null) {
            this.innerProperties = new UpdateProperties();
        }
     ...
     * @return the UpdateInner object itself.
     */
    public UpdateInner withPackagePath(String packagePath) {
        if (this.innerProperties() == null) {
            this.innerProperties = new UpdateProperties();
        }
     ...
     * @return the UpdateInner object itself.
     */
    public UpdateInner withPackageSizeInMb(Float packageSizeInMb) {
        if (this.innerProperties() == null) {
            this.innerProperties = new UpdateProperties();
        }
     ...
     * @return the UpdateInner object itself.
     */
    public UpdateInner withDisplayName(String displayName) {
        if (this.innerProperties() == null) {
            this.innerProperties = new UpdateProperties();
        }
     ...
     * @return the UpdateInner object itself.
     */
    public UpdateInner withVersion(String version) {
        if (this.innerProperties() == null) {
            this.innerProperties = new UpdateProperties();
        }
     ...
     * @return the UpdateInner object itself.
     */
    public UpdateInner withPublisher(String publisher) {
        if (this.innerProperties() == null) {
            this.innerProperties = new UpdateProperties();
        }
     ...
     * @return the UpdateInner object itself.
     */
    public UpdateInner withReleaseLink(String releaseLink) {
        if (this.innerProperties() == null) {
            this.innerProperties = new UpdateProperties();
        }
     ...
     * @return the UpdateInner object itself.
     */
    public UpdateInner withAvailabilityType(AvailabilityType availabilityType) {
        if (this.innerProperties() == null) {
            this.innerProperties = new UpdateProperties();
        }
     ...
     * @return the UpdateInner object itself.
     */
    public UpdateInner withPackageType(String packageType) {
        if (this.innerProperties() == null) {
            this.innerProperties = new UpdateProperties();
        }
     ...
     * @return the UpdateInner object itself.
     */
    public UpdateInner withAdditionalProperties(String additionalProperties) {
        if (this.innerProperties() == null) {
            this.innerProperties = new UpdateProperties();
        }
     ...
     * @return the UpdateInner object itself.
     */
    public UpdateInner withProgressPercentage(Float progressPercentage) {
        if (this.innerProperties() == null) {
            this.innerProperties = new UpdateProperties();
        }
     ...
     * @return the UpdateInner object itself.
     */
    public UpdateInner withNotifyMessage(String notifyMessage) {
        if (this.innerProperties() == null) {
            this.innerProperties = new UpdateProperties();
        }
