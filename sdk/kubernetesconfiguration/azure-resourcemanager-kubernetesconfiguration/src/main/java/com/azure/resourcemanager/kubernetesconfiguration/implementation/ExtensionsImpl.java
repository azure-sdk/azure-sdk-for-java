...
public final class ExtensionsImpl implements Extensions {
    ...
    public Extension create(String resourceGroupName, String clusterRp, String clusterResourceName, String clusterName,
        ...
        ExtensionInner inner = this.serviceClient().create(resourceGroupName, clusterRp, clusterResourceName,
    ...
    public Response<Extension> getWithResponse(String resourceGroupName, String clusterRp, String clusterResourceName,
        String clusterName, String extensionName, Context context) {
        Response<ExtensionInner> inner = this.serviceClient().getWithResponse(resourceGroupName, clusterRp,
            clusterResourceName, clusterName, extensionName, context);
        if (inner != null) {
    ...
    public Extension update(String resourceGroupName, String clusterRp, String clusterResourceName, String clusterName,
        ...
        ExtensionInner inner = this.serviceClient().update(resourceGroupName, clusterRp, clusterResourceName,
