...
public final class FluxConfigurationsClientImpl implements FluxConfigurationsClient {
    ...
    public SyncPoller<PollResult<FluxConfigurationInner>, FluxConfigurationInner> beginCreateOrUpdate(
        String resourceGroupName, String clusterRp, String clusterResourceName, String clusterName,
        String fluxConfigurationName, FluxConfigurationInner fluxConfiguration) {
        return this.beginCreateOrUpdateAsync(resourceGroupName, clusterRp, clusterResourceName, clusterName,
            fluxConfigurationName, fluxConfiguration).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<FluxConfigurationInner>, FluxConfigurationInner> beginCreateOrUpdate(
        ...
        String fluxConfigurationName, FluxConfigurationInner fluxConfiguration, Context context) {
        return this.beginCreateOrUpdateAsync(resourceGroupName, clusterRp, clusterResourceName, clusterName,
            fluxConfigurationName, fluxConfiguration, context).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<FluxConfigurationInner>, FluxConfigurationInner> beginUpdate(String resourceGroupName,
        ...
        FluxConfigurationPatch fluxConfigurationPatch) {
        return this.beginUpdateAsync(resourceGroupName, clusterRp, clusterResourceName, clusterName,
            fluxConfigurationName, fluxConfigurationPatch).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<FluxConfigurationInner>, FluxConfigurationInner> beginUpdate(String resourceGroupName,
        ...
        FluxConfigurationPatch fluxConfigurationPatch, Context context) {
        return this.beginUpdateAsync(resourceGroupName, clusterRp, clusterResourceName, clusterName,
            fluxConfigurationName, fluxConfigurationPatch, context).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String clusterRp,
        ...
        return this.beginDeleteAsync(resourceGroupName, clusterRp, clusterResourceName, clusterName,
            fluxConfigurationName, forceDelete).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String clusterRp,
        ...
        Context context) {
        return this.beginDeleteAsync(resourceGroupName, clusterRp, clusterResourceName, clusterName,
            fluxConfigurationName, forceDelete, context).getSyncPoller();
    }
