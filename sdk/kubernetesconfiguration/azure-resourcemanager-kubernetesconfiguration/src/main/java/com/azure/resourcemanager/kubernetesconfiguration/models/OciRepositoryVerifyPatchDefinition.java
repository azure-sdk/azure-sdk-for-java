 ...
 */
@Fluent
public final class OciRepositoryVerifyPatchDefinition {
    /*
    ...
    /**
     * Creates an instance of OciRepositoryVerifyPatchDefinition class.
     */
     ...
     * @return the OciRepositoryVerifyPatchDefinition object itself.
     */
    public OciRepositoryVerifyPatchDefinition withProvider(String provider) {
     ...
     * @return the OciRepositoryVerifyPatchDefinition object itself.
     */
    public OciRepositoryVerifyPatchDefinition withSecretRef(String secretRef) {
     ...
     */
    public OciRepositoryVerifyPatchDefinition
        withMatchOidcIdentity(List<MatchOidcIdentityPatchDefinition> matchOidcIdentity) {
