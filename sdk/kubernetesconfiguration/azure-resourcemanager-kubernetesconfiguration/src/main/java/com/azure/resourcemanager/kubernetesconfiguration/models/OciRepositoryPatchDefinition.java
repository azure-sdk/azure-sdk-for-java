...
public final class OciRepositoryPatchDefinition {
    ...
    private OciRepositoryLayerSelectorPatchDefinition layerSelector;

    /*
     * Verification of the authenticity of an OCI Artifact.
     */
    @JsonProperty(value = "verify")
    private OciRepositoryVerifyPatchDefinition verify;
     ...
     */
    public OciRepositoryLayerSelectorPatchDefinition layerSelector() {
     ...
     * @return the OciRepositoryPatchDefinition object itself.
     */
    public OciRepositoryPatchDefinition withLayerSelector(OciRepositoryLayerSelectorPatchDefinition layerSelector) {
     ...
     */
    public OciRepositoryVerifyPatchDefinition verify() {
        return this.verify;
    }
     ...
     * @return the OciRepositoryPatchDefinition object itself.
     */
    public OciRepositoryPatchDefinition withVerify(OciRepositoryVerifyPatchDefinition verify) {
        this.verify = verify;
        return this;
    }
     ...
     * @return the OciRepositoryPatchDefinition object itself.
     */
    public OciRepositoryPatchDefinition withCertSecretRef(String certSecretRef) {
