...
public final class FluxConfigurationsImpl implements FluxConfigurations {
    ...
    public Response<FluxConfiguration> getWithResponse(String resourceGroupName, String clusterRp,
        ...
        Response<FluxConfigurationInner> inner = this.serviceClient().getWithResponse(resourceGroupName, clusterRp,
            clusterResourceName, clusterName, fluxConfigurationName, context);
        if (inner != null) {
    ...
    public FluxConfiguration get(String resourceGroupName, String clusterRp, String clusterResourceName,
        ...
        FluxConfigurationInner inner = this.serviceClient().get(resourceGroupName, clusterRp, clusterResourceName,
            clusterName, fluxConfigurationName);
        if (inner != null) {
    ...
    public FluxConfiguration createOrUpdate(String resourceGroupName, String clusterRp, String clusterResourceName,
        ...
        FluxConfigurationInner inner = this.serviceClient().createOrUpdate(resourceGroupName, clusterRp,
    ...
    public FluxConfiguration update(String resourceGroupName, String clusterRp, String clusterResourceName,
        ...
        FluxConfigurationInner inner = this.serviceClient().update(resourceGroupName, clusterRp, clusterResourceName,
    ...
    public void delete(String resourceGroupName, String clusterRp, String clusterResourceName, String clusterName,
        ...
        this.serviceClient().delete(resourceGroupName, clusterRp, clusterResourceName, clusterName,
            fluxConfigurationName, forceDelete, context);
    }
