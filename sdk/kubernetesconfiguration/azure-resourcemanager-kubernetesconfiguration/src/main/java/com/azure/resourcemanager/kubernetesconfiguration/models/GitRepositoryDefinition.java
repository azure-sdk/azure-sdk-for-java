 ...
 */
@Fluent
public final class GitRepositoryDefinition implements JsonSerializable<GitRepositoryDefinition> {
    /*
     ...
     * @return the GitRepositoryDefinition object itself.
     */
    public GitRepositoryDefinition withProvider(String provider) {
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("url".equals(fieldName)) {
                    ...
                    deserializedGitRepositoryDefinition.provider = reader.getString();
                } else {
                    reader.skipChildren();
                }
            }
