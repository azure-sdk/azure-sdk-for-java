...
public final class FluxConfigOperationStatusImpl implements FluxConfigOperationStatus {
    ...
    public Response<OperationStatusResult> getWithResponse(String resourceGroupName, String clusterRp,
        ...
        Context context) {
        Response<OperationStatusResultInner> inner = this.serviceClient().getWithResponse(resourceGroupName, clusterRp,
            clusterResourceName, clusterName, fluxConfigurationName, operationId, context);
        if (inner != null) {
    ...
    public OperationStatusResult get(String resourceGroupName, String clusterRp, String clusterResourceName,
        ...
        OperationStatusResultInner inner = this.serviceClient().get(resourceGroupName, clusterRp, clusterResourceName,
            clusterName, fluxConfigurationName, operationId);
        if (inner != null) {
