...
public final class DatabaseMigrationsMongoToCosmosDbvCoreMongoCreateSamples {
    ...
    public static void createMongoToCosmosDbMongoVCoreDatabaseMigrationResourceWithMinimumParameters(
        ...
        manager.databaseMigrationsMongoToCosmosDbvCoreMongoes().create("testrg", "targetCosmosDbClusterName",
            "migrationRequest",
            new DatabaseMigrationCosmosDbMongoInner().withProperties(new DatabaseMigrationPropertiesCosmosDbMongo()
                .withScope(
                ...
                .withSourceMongoConnection(new MongoConnectionInformation().withHost("abc.mongodb.com").withPort(88)
                    .withUsername("abc").withPassword("fakeTokenPlaceholder").withUseSsl(true))
                ...
                .withCollectionList(Arrays.asList(
                    new MongoMigrationCollection().withSourceDatabase("sourceDb1").withSourceCollection("sourceCol1")
                        .withTargetDatabase("targetDb1").withTargetCollection("targetCol1"),
        ...
        manager.databaseMigrationsMongoToCosmosDbvCoreMongoes().create("testrg", "targetCosmosDbClusterName",
            ...
            new DatabaseMigrationCosmosDbMongoInner().withProperties(new DatabaseMigrationPropertiesCosmosDbMongo()
                ...
                .withTargetMongoConnection(
                    new MongoConnectionInformation().withHost("xyz.mongocluster.cosmos.azure.com").withPort(10255)
                        .withUsername("def").withPassword("fakeTokenPlaceholder").withUseSsl(true))
                .withCollectionList(Arrays.asList(
                    new MongoMigrationCollection().withSourceDatabase("sourceDb1").withSourceCollection("sourceCol1")
                        .withTargetDatabase("targetDb1").withTargetCollection("targetCol1"),
                    new MongoMigrationCollection().withSourceDatabase("sourceDb2").withSourceCollection("sourceCol2")
                        .withTargetDatabase("sourceDb2").withTargetCollection("sourceCol2")))),
            com.azure.core.util.Context.NONE);
    }
}
