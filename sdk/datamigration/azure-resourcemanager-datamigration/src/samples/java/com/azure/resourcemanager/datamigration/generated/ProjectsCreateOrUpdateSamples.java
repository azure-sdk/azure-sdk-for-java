...
public final class ProjectsCreateOrUpdateSamples {
    ...
    public static void projectsCreateOrUpdate(com.azure.resourcemanager.datamigration.DataMigrationManager manager) {
        manager.projects().define("DmsSdkProject").withRegion("southcentralus")
            .withExistingService("DmsSdkRg", "DmsSdkService").withSourcePlatform(ProjectSourcePlatform.SQL)
            .withTargetPlatform(ProjectTargetPlatform.SQLDB).create();
    }
}
