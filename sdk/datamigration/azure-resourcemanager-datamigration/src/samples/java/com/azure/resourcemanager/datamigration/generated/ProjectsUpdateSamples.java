...
public final class ProjectsUpdateSamples {
    ...
    public static void projectsUpdate(com.azure.resourcemanager.datamigration.DataMigrationManager manager) {
        Project resource = manager.projects()
            .getWithResponse("DmsSdkRg", "DmsSdkService", "DmsSdkProject", com.azure.core.util.Context.NONE).getValue();
        resource.update().withSourcePlatform(ProjectSourcePlatform.SQL).withTargetPlatform(ProjectTargetPlatform.SQLDB)
            .apply();
    }
}
