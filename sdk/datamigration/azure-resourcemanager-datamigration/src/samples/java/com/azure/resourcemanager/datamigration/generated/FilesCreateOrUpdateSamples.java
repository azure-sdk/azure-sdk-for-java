...
public final class FilesCreateOrUpdateSamples {
    ...
    public static void filesCreateOrUpdate(com.azure.resourcemanager.datamigration.DataMigrationManager manager) {
        manager.files().define("x114d023d8").withExistingProject("DmsSdkRg", "DmsSdkService", "DmsSdkProject")
            .withProperties(new ProjectFileProperties().withFilePath("DmsSdkFilePath/DmsSdkFile.sql")).create();
    }
}
