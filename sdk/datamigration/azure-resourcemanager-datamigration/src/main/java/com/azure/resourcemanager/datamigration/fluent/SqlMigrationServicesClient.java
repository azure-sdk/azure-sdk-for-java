...
public interface SqlMigrationServicesClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<IntegrationRuntimeMonitoringDataInner> monitoringDataWithResponse(
        String resourceGroupName, String sqlMigrationServiceName, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    IntegrationRuntimeMonitoringDataInner monitoringData(String resourceGroupName, String sqlMigrationServiceName);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<ValidateIRInner> validateIRWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ValidateIRInner validateIR(String resourceGroupName, String sqlMigrationServiceName, ValidateIRInner parameters);
