...
public interface DatabaseMigrationsSqlVmsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<DatabaseMigrationSqlVmListResultInner> listByScopeWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    DatabaseMigrationSqlVmListResultInner listByScope(String resourceGroupName, String sqlVirtualMachineName);
