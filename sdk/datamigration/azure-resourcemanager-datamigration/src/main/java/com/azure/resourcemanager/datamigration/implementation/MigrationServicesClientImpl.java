...
import com.azure.resourcemanager.datamigration.models.MigrationListResult;
...
public final class MigrationServicesClientImpl implements MigrationServicesClient {
    ...
    public interface MigrationServicesService {
        ...
        Mono<Response<MigrationServiceInner>> getByResourceGroup(
        ...
        Mono<Response<Flux<ByteBuffer>>> createOrUpdate(
            ...
            @PathParam("subscriptionId") String subscriptionId,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") MigrationServiceInner parameters,
            @HeaderParam("Accept") String accept,
            Context context);
        ...
        Mono<Response<Flux<ByteBuffer>>> update(
            ...
            @PathParam("subscriptionId") String subscriptionId,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") MigrationServiceUpdate parameters,
            @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<MigrationListResult>> listByResourceGroup(
            @HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("subscriptionId") String subscriptionId,
            @QueryParam("api-version") String apiVersion,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<MigrationListResult>> list(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<MigrationListResult>> listByResourceGroupNext(
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<MigrationListResult>> listBySubscriptionNext(
            @PathParam(value = "nextLink", encoded = true) String nextLink,
            @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept,
            Context context);
    ...
    private Mono<Response<MigrationServiceInner>> getByResourceGroupWithResponseAsync(
        String resourceGroupName, String migrationServiceName) {
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<MigrationServiceInner>> getByResourceGroupWithResponseAsync(
        String resourceGroupName, String migrationServiceName, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<MigrationServiceInner> getByResourceGroupWithResponse(
        String resourceGroupName, String migrationServiceName, Context context) {
    ...
    private PollerFlux<PollResult<MigrationServiceInner>, MigrationServiceInner> beginCreateOrUpdateAsync(
        ...
        return this
            .client
            .<MigrationServiceInner, MigrationServiceInner>getLroResult(
                mono,
    ...
    private PollerFlux<PollResult<MigrationServiceInner>, MigrationServiceInner> beginCreateOrUpdateAsync(
        ...
        return this
            .client
            .<MigrationServiceInner, MigrationServiceInner>getLroResult(
                mono, this.client.getHttpPipeline(), MigrationServiceInner.class, MigrationServiceInner.class, context);
    }
    ...
    public SyncPoller<PollResult<MigrationServiceInner>, MigrationServiceInner> beginCreateOrUpdate(
        String resourceGroupName, String migrationServiceName, MigrationServiceInner parameters, Context context) {
        return this
            .beginCreateOrUpdateAsync(resourceGroupName, migrationServiceName, parameters, context)
            .getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<MigrationServiceInner> createOrUpdateAsync(
        String resourceGroupName, String migrationServiceName, MigrationServiceInner parameters) {
        return beginCreateOrUpdateAsync(resourceGroupName, migrationServiceName, parameters)
            .last()
    ...
    private Mono<MigrationServiceInner> createOrUpdateAsync(
        String resourceGroupName, String migrationServiceName, MigrationServiceInner parameters, Context context) {
        return beginCreateOrUpdateAsync(resourceGroupName, migrationServiceName, parameters, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public MigrationServiceInner createOrUpdate(
        String resourceGroupName, String migrationServiceName, MigrationServiceInner parameters) {
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String migrationServiceName) {
        return beginDeleteAsync(resourceGroupName, migrationServiceName)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String migrationServiceName, Context context) {
        return beginDeleteAsync(resourceGroupName, migrationServiceName, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> updateWithResponseAsync(
        String resourceGroupName, String migrationServiceName, MigrationServiceUpdate parameters) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<MigrationServiceInner>, MigrationServiceInner> beginUpdate(
        String resourceGroupName, String migrationServiceName, MigrationServiceUpdate parameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<MigrationServiceInner> updateAsync(
        String resourceGroupName, String migrationServiceName, MigrationServiceUpdate parameters) {
        return beginUpdateAsync(resourceGroupName, migrationServiceName, parameters)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<MigrationServiceInner> updateAsync(
        String resourceGroupName, String migrationServiceName, MigrationServiceUpdate parameters, Context context) {
        return beginUpdateAsync(resourceGroupName, migrationServiceName, parameters, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public MigrationServiceInner update(
        String resourceGroupName, String migrationServiceName, MigrationServiceUpdate parameters) {
                ...
                context ->
                    service
                        .listByResourceGroup(
                            ...
                            accept,
                            context))
            .<PagedResponse<MigrationServiceInner>>map(
                res ->
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<MigrationServiceInner>> listByResourceGroupSinglePageAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<MigrationServiceInner>> listByResourceGroupNextSinglePageAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<MigrationServiceInner>> listBySubscriptionNextSinglePageAsync(
        String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
