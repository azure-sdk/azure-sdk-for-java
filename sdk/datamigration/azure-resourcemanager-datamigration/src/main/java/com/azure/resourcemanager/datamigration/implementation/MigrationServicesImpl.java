...
public final class MigrationServicesImpl implements MigrationServices {
    ...
    public MigrationServicesImpl(
        MigrationServicesClient innerClient,
        com.azure.resourcemanager.datamigration.DataMigrationManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public Response<MigrationService> getByResourceGroupWithResponse(
    ...
    public PagedIterable<MigrationService> listByResourceGroup(String resourceGroupName) {
        ...
        return Utils.mapPage(inner, inner1 -> new MigrationServiceImpl(inner1, this.manager()));
    }
    ...
    public MigrationService getById(String id) {
        ...
        String migrationServiceName = Utils.getValueFromIdByName(id, "migrationServices");
            ...
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException(
                        String
                            .format(
                                "The resource ID '%s' is not valid. Missing path segment 'migrationServices'.", id)));
        }
