...
public final class DataMigrationServiceImpl
    ...
    public DataMigrationService create() {
        this.innerObject = serviceManager.serviceClient().getServices().createOrUpdate(groupName, serviceName,
    ...
    public DataMigrationService apply() {
        this.innerObject = serviceManager.serviceClient().getServices().update(groupName, serviceName,
            this.innerModel(), Context.NONE);
        return this;
    }
    ...
    public DataMigrationService refresh() {
        this.innerObject = serviceManager.serviceClient().getServices()
            .getByResourceGroupWithResponse(groupName, serviceName, Context.NONE).getValue();
        return this;
    }

    public DataMigrationService refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getServices()
            .getByResourceGroupWithResponse(groupName, serviceName, context).getValue();
        return this;
    }
    ...
    public Response<NameAvailabilityResponse>
        ...
        return serviceManager.services().checkChildrenNameAvailabilityWithResponse(groupName, serviceName, parameters,
            context);
    }
