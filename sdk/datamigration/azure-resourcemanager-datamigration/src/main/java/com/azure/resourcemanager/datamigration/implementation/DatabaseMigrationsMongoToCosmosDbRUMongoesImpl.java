...
public final class DatabaseMigrationsMongoToCosmosDbRUMongoesImpl
    ...
    public PagedIterable<DatabaseMigrationCosmosDbMongo> getForScope(String resourceGroupName,
        ...
        return Utils.mapPage(inner, inner1 -> new DatabaseMigrationCosmosDbMongoImpl(inner1, this.manager()));
    }
    ...
    public DatabaseMigrationCosmosDbMongo getById(String id) {
        ...
        String targetResourceName = Utils.getValueFromIdByName(id, "databaseAccounts");
        if (targetResourceName == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
                String.format("The resource ID '%s' is not valid. Missing path segment 'databaseAccounts'.", id)));
        }
        String migrationName = Utils.getValueFromIdByName(id, "databaseMigrations");
