...
public final class MongoDbMigrationSettings {
    /*
     * The RU limit on a CosmosDB target that collections will be temporarily increased to (if lower) during the
     * initial copy of a migration, from 10,000 to 1,000,000, or 0 to use the default boost (which is generally the
     * maximum), or null to not boost the RUs. This setting has no effect on non-CosmosDB targets.
     */
     ...
     * (if lower) during the initial copy of a migration, from 10,000 to 1,000,000, or 0 to use the default boost
     * (which is generally the maximum), or null to not boost the RUs. This setting has no effect on non-CosmosDB
     * targets.
     * 
    ...
    /**
     * Get the replication property: Describes how changes will be replicated from the source to the target. The
     * default is OneTime.
     * 
    ...
    /**
     * Set the replication property: Describes how changes will be replicated from the source to the target. The
     * default is OneTime.
     * 
    ...
    public void validate() {
        if (databases() == null) {
            throw LOGGER.logExceptionAsError(
                new IllegalArgumentException("Missing required property databases in model MongoDbMigrationSettings"));
        } else {
