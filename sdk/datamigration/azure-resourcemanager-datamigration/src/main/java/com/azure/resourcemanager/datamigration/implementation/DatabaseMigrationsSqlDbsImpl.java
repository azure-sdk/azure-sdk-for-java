...
public final class DatabaseMigrationsSqlDbsImpl implements DatabaseMigrationsSqlDbs {
    ...
    public Response<DatabaseMigrationSqlDb> getWithResponse(String resourceGroupName, String sqlDbInstanceName,
        ...
        Response<DatabaseMigrationSqlDbInner> inner = this.serviceClient().getWithResponse(resourceGroupName,
            sqlDbInstanceName, targetDbName, migrationOperationId, expand, context);
        if (inner != null) {
    ...
    public DatabaseMigrationSqlDb getById(String id) {
        ...
        return this.getWithResponse(resourceGroupName, sqlDbInstanceName, targetDbName, localMigrationOperationId,
            localExpand, Context.NONE).getValue();
    }

    public Response<DatabaseMigrationSqlDb> getByIdWithResponse(String id, UUID migrationOperationId, String expand,
        Context context) {
        String resourceGroupName = Utils.getValueFromIdByName(id, "resourceGroups");
        if (resourceGroupName == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
