...
public final class DatabaseMigrationsSqlMisImpl implements DatabaseMigrationsSqlMis {
    ...
    public Response<DatabaseMigrationSqlMiListResult> listByScopeWithResponse(
        String resourceGroupName, String managedInstanceName, Context context) {
        Response<DatabaseMigrationSqlMiListResultInner> inner =
            this.serviceClient().listByScopeWithResponse(resourceGroupName, managedInstanceName, context);
        if (inner != null) {
            return new SimpleResponse<>(
                inner.getRequest(),
                inner.getStatusCode(),
                inner.getHeaders(),
                new DatabaseMigrationSqlMiListResultImpl(inner.getValue(), this.manager()));
        } else {
            return null;
        }
    }

    public DatabaseMigrationSqlMiListResult listByScope(String resourceGroupName, String managedInstanceName) {
        DatabaseMigrationSqlMiListResultInner inner =
            this.serviceClient().listByScope(resourceGroupName, managedInstanceName);
        if (inner != null) {
            return new DatabaseMigrationSqlMiListResultImpl(inner, this.manager());
        } else {
            return null;
        }
    }
