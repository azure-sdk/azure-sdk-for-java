...
public final class DatabaseMigrationsSqlMisImpl implements DatabaseMigrationsSqlMis {
    ...
    public Response<DatabaseMigrationSqlMi> getWithResponse(String resourceGroupName, String managedInstanceName,
        ...
        Response<DatabaseMigrationSqlMiInner> inner = this.serviceClient().getWithResponse(resourceGroupName,
            managedInstanceName, targetDbName, migrationOperationId, expand, context);
        if (inner != null) {
    ...
    public DatabaseMigrationSqlMi getById(String id) {
        ...
        return this.getWithResponse(resourceGroupName, managedInstanceName, targetDbName, localMigrationOperationId,
