...
public final class DatabaseMigrationSqlVmImpl
    ...
    public DatabaseMigrationSqlVm create() {
        this.innerObject = serviceManager.serviceClient().getDatabaseMigrationsSqlVms()
    ...
    public DatabaseMigrationSqlVm refresh() {
        ...
        this.innerObject
            = serviceManager.serviceClient().getDatabaseMigrationsSqlVms().getWithResponse(resourceGroupName,
                sqlVirtualMachineName, targetDbName, localMigrationOperationId, localExpand, Context.NONE).getValue();
        return this;
    }
    ...
    public DatabaseMigrationSqlVm refresh(Context context) {
        ...
        this.innerObject
            = serviceManager.serviceClient().getDatabaseMigrationsSqlVms().getWithResponse(resourceGroupName,
                sqlVirtualMachineName, targetDbName, localMigrationOperationId, localExpand, context).getValue();
        return this;
    }

    public void cancel(MigrationOperationInput parameters) {
        serviceManager.databaseMigrationsSqlVms().cancel(resourceGroupName, sqlVirtualMachineName, targetDbName,
            parameters);
    }
    ...
    public void cutover(MigrationOperationInput parameters) {
        serviceManager.databaseMigrationsSqlVms().cutover(resourceGroupName, sqlVirtualMachineName, targetDbName,
            parameters);
    }
