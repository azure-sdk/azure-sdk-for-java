    ...
    public void validate() {
        if (selectedDatabases() == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
                "Missing required property selectedDatabases in model MigrateOracleAzureDbPostgreSqlSyncTaskInput"));
        } else {
            selectedDatabases().forEach(e -> e.validate());
        }
        if (targetConnectionInfo() == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
                "Missing required property targetConnectionInfo in model MigrateOracleAzureDbPostgreSqlSyncTaskInput"));
        } else {
            targetConnectionInfo().validate();
        }
        if (sourceConnectionInfo() == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
                "Missing required property sourceConnectionInfo in model MigrateOracleAzureDbPostgreSqlSyncTaskInput"));
        } else {
