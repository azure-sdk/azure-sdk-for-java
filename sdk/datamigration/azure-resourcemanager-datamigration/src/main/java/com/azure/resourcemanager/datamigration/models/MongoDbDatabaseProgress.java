...
public final class MongoDbDatabaseProgress extends MongoDbProgress {
    ...
    /**
     * Get the collections property: The progress of the collections in the database. The keys are the unqualified
    ...
    /**
     * Set the collections property: The progress of the collections in the database. The keys are the unqualified
     * names of the collections.
     * 
