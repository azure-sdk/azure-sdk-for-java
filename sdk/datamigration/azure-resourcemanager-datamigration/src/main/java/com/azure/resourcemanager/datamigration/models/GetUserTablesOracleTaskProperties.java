        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("errors".equals(fieldName)) {
                    ...
                    deserializedGetUserTablesOracleTaskProperties.errors = errors;
                } else if ("state".equals(fieldName)) {
                    deserializedGetUserTablesOracleTaskProperties.state = TaskState.fromString(reader.getString());
                    ...
                    deserializedGetUserTablesOracleTaskProperties.commands = commands;
