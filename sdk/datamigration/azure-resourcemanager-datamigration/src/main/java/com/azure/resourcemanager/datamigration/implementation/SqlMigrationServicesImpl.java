...
public final class SqlMigrationServicesImpl implements SqlMigrationServices {
    ...
    public Response<IntegrationRuntimeMonitoringData> monitoringDataWithResponse(
        String resourceGroupName, String sqlMigrationServiceName, Context context) {
        Response<IntegrationRuntimeMonitoringDataInner> inner =
            this.serviceClient().monitoringDataWithResponse(resourceGroupName, sqlMigrationServiceName, context);
        if (inner != null) {
            return new SimpleResponse<>(
                inner.getRequest(),
                inner.getStatusCode(),
    ...
    public IntegrationRuntimeMonitoringData monitoringData(String resourceGroupName, String sqlMigrationServiceName) {
        IntegrationRuntimeMonitoringDataInner inner =
            this.serviceClient().monitoringData(resourceGroupName, sqlMigrationServiceName);
        if (inner != null) {
            return new IntegrationRuntimeMonitoringDataImpl(inner, this.manager());
        } else {
            return null;
    ...
    public Response<ValidateIR> validateIRWithResponse(
        String resourceGroupName, String sqlMigrationServiceName, ValidateIRInner parameters, Context context) {
        Response<ValidateIRInner> inner =
            this
                .serviceClient()
                .validateIRWithResponse(resourceGroupName, sqlMigrationServiceName, parameters, context);
        if (inner != null) {
            return new SimpleResponse<>(
                inner.getRequest(),
                inner.getStatusCode(),
                inner.getHeaders(),
                new ValidateIRImpl(inner.getValue(), this.manager()));
        } else {
            return null;
        }
    }

    public ValidateIR validateIR(String resourceGroupName, String sqlMigrationServiceName, ValidateIRInner parameters) {
        ValidateIRInner inner = this.serviceClient().validateIR(resourceGroupName, sqlMigrationServiceName, parameters);
        if (inner != null) {
            return new ValidateIRImpl(inner, this.manager());
        } else {
            return null;
        }
    }
