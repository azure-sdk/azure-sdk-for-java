...
public final class SqlMigrationServiceImpl
    ...
    SqlMigrationServiceImpl(
        SqlMigrationServiceInner innerObject,
    ...
    public Response<ValidateIR> validateIRWithResponse(ValidateIRInner parameters, Context context) {
        return serviceManager
            .sqlMigrationServices()
            .validateIRWithResponse(resourceGroupName, sqlMigrationServiceName, parameters, context);
    }

    public ValidateIR validateIR(ValidateIRInner parameters) {
        return serviceManager.sqlMigrationServices().validateIR(resourceGroupName, sqlMigrationServiceName, parameters);
    }
