...
public final class ServiceTasksImpl implements ServiceTasks {
    ...
    public Response<ProjectTask> createOrUpdateWithResponse(String groupName, String serviceName, String taskName,
    ...
    public ProjectTask createOrUpdate(String groupName, String serviceName, String taskName,
    ...
    public Response<ProjectTask> updateWithResponse(String groupName, String serviceName, String taskName,
        ProjectTaskInner parameters, Context context) {
        Response<ProjectTaskInner> inner
