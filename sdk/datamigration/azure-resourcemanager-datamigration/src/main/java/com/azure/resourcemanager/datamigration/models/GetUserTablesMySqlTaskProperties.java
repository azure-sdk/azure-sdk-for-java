        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("errors".equals(fieldName)) {
                    ...
                    deserializedGetUserTablesMySqlTaskProperties.errors = errors;
                } else if ("state".equals(fieldName)) {
                    deserializedGetUserTablesMySqlTaskProperties.state = TaskState.fromString(reader.getString());
                    ...
                    deserializedGetUserTablesMySqlTaskProperties.commands = commands;
