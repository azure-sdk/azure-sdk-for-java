...
public final class ServiceTasksClientImpl implements ServiceTasksClient {
    ...
    private Mono<PagedResponse<ProjectTaskInner>> listSinglePageAsync(String groupName, String serviceName,
        ...
        return service
            .list(this.client.getEndpoint(), this.client.getSubscriptionId(), groupName, serviceName,
    ...
    private PagedFlux<ProjectTaskInner> listAsync(String groupName, String serviceName, String taskType,
        Context context) {
        return new PagedFlux<>(() -> listSinglePageAsync(groupName, serviceName, taskType, context),
    ...
    private Mono<Response<ProjectTaskInner>> getWithResponseAsync(String groupName, String serviceName, String taskName,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.get(this.client.getEndpoint(), this.client.getSubscriptionId(), groupName, serviceName, taskName,
