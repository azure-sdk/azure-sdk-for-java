...
public final class ProjectImpl implements Project, Project.Definition, Project.Update {
    ...
    public Project create(Context context) {
        this.innerObject = serviceManager.serviceClient().getProjects()
            .createOrUpdateWithResponse(groupName, serviceName, projectName, this.innerModel(), context).getValue();
        return this;
    }
    ...
    public Project apply() {
        this.innerObject = serviceManager.serviceClient().getProjects()
            .updateWithResponse(groupName, serviceName, projectName, this.innerModel(), Context.NONE).getValue();
        return this;
    }

    public Project apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getProjects()
            .updateWithResponse(groupName, serviceName, projectName, this.innerModel(), context).getValue();
        return this;
    }
    ...
    public Project refresh() {
        this.innerObject = serviceManager.serviceClient().getProjects()
            .getWithResponse(groupName, serviceName, projectName, Context.NONE).getValue();
        return this;
    }

    public Project refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getProjects()
            .getWithResponse(groupName, serviceName, projectName, context).getValue();
        return this;
    }
