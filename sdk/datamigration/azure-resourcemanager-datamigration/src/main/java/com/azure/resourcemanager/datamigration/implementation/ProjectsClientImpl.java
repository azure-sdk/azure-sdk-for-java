...
public final class ProjectsClientImpl implements ProjectsClient {
    ...
    /**
     * The interface defining all the services for DataMigrationManagementClientProjects to be used by the proxy
    ...
    private PagedFlux<ProjectInner> listAsync(String groupName, String serviceName, Context context) {
        return new PagedFlux<>(() -> listSinglePageAsync(groupName, serviceName, context),
