...
public final class DatabaseMigrationSqlDbImpl
    ...
    public DatabaseMigrationSqlDb create() {
        this.innerObject = serviceManager.serviceClient().getDatabaseMigrationsSqlDbs()
    ...
    public DatabaseMigrationSqlDb refresh() {
        ...
        this.innerObject
            = serviceManager.serviceClient().getDatabaseMigrationsSqlDbs().getWithResponse(resourceGroupName,
                sqlDbInstanceName, targetDbName, localMigrationOperationId, localExpand, Context.NONE).getValue();
        return this;
    }
    ...
    public DatabaseMigrationSqlDb refresh(Context context) {
        ...
        this.innerObject
            = serviceManager.serviceClient().getDatabaseMigrationsSqlDbs().getWithResponse(resourceGroupName,
                sqlDbInstanceName, targetDbName, localMigrationOperationId, localExpand, context).getValue();
        return this;
    }

    public void cancel(MigrationOperationInput parameters) {
        serviceManager.databaseMigrationsSqlDbs().cancel(resourceGroupName, sqlDbInstanceName, targetDbName,
            parameters);
    }

    public void cancel(MigrationOperationInput parameters, Context context) {
        serviceManager.databaseMigrationsSqlDbs().cancel(resourceGroupName, sqlDbInstanceName, targetDbName, parameters,
            context);
    }
