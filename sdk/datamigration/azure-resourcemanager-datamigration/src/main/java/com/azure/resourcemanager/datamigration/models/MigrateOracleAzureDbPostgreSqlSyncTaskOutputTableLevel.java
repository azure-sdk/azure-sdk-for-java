 ...
 */
@Immutable
public final class MigrateOracleAzureDbPostgreSqlSyncTaskOutputTableLevel
    ...
    /**
     * Creates an instance of MigrateOracleAzureDbPostgreSqlSyncTaskOutputTableLevel class.
     */
    ...
    /**
     * Reads an instance of MigrateOracleAzureDbPostgreSqlSyncTaskOutputTableLevel from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of MigrateOracleAzureDbPostgreSqlSyncTaskOutputTableLevel if the JsonReader was pointing to
     * an instance of it, or null if it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the MigrateOracleAzureDbPostgreSqlSyncTaskOutputTableLevel.
     */
    public static MigrateOracleAzureDbPostgreSqlSyncTaskOutputTableLevel fromJson(JsonReader jsonReader)
        throws IOException {
        return jsonReader.readObject(reader -> {
            MigrateOracleAzureDbPostgreSqlSyncTaskOutputTableLevel deserializedMigrateOracleAzureDbPostgreSqlSyncTaskOutputTableLevel
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("id".equals(fieldName)) {
                    deserializedMigrateOracleAzureDbPostgreSqlSyncTaskOutputTableLevel.id = reader.getString();
                } else if ("resultType".equals(fieldName)) {
                    deserializedMigrateOracleAzureDbPostgreSqlSyncTaskOutputTableLevel.resultType = reader.getString();
                } else if ("tableName".equals(fieldName)) {
                    deserializedMigrateOracleAzureDbPostgreSqlSyncTaskOutputTableLevel.tableName = reader.getString();
                } else if ("databaseName".equals(fieldName)) {
                    deserializedMigrateOracleAzureDbPostgreSqlSyncTaskOutputTableLevel.databaseName
                        = reader.getString();
                } else if ("cdcInsertCounter".equals(fieldName)) {
                    deserializedMigrateOracleAzureDbPostgreSqlSyncTaskOutputTableLevel.cdcInsertCounter
                        = reader.getNullable(JsonReader::getLong);
                } else if ("cdcUpdateCounter".equals(fieldName)) {
                    deserializedMigrateOracleAzureDbPostgreSqlSyncTaskOutputTableLevel.cdcUpdateCounter
                        = reader.getNullable(JsonReader::getLong);
                } else if ("cdcDeleteCounter".equals(fieldName)) {
                    deserializedMigrateOracleAzureDbPostgreSqlSyncTaskOutputTableLevel.cdcDeleteCounter
                        = reader.getNullable(JsonReader::getLong);
                } else if ("fullLoadEstFinishTime".equals(fieldName)) {
                    deserializedMigrateOracleAzureDbPostgreSqlSyncTaskOutputTableLevel.fullLoadEstFinishTime = reader
                        .getNullable(nonNullReader -> CoreUtils.parseBestOffsetDateTime(nonNullReader.getString()));
                } else if ("fullLoadStartedOn".equals(fieldName)) {
                    deserializedMigrateOracleAzureDbPostgreSqlSyncTaskOutputTableLevel.fullLoadStartedOn = reader
                        .getNullable(nonNullReader -> CoreUtils.parseBestOffsetDateTime(nonNullReader.getString()));
                } else if ("fullLoadEndedOn".equals(fieldName)) {
                    deserializedMigrateOracleAzureDbPostgreSqlSyncTaskOutputTableLevel.fullLoadEndedOn = reader
                        .getNullable(nonNullReader -> CoreUtils.parseBestOffsetDateTime(nonNullReader.getString()));
                } else if ("fullLoadTotalRows".equals(fieldName)) {
                    deserializedMigrateOracleAzureDbPostgreSqlSyncTaskOutputTableLevel.fullLoadTotalRows
                        = reader.getNullable(JsonReader::getLong);
                } else if ("state".equals(fieldName)) {
                    deserializedMigrateOracleAzureDbPostgreSqlSyncTaskOutputTableLevel.state
                        = SyncTableMigrationState.fromString(reader.getString());
                } else if ("totalChangesApplied".equals(fieldName)) {
                    deserializedMigrateOracleAzureDbPostgreSqlSyncTaskOutputTableLevel.totalChangesApplied
                        = reader.getNullable(JsonReader::getLong);
                } else if ("dataErrorsCounter".equals(fieldName)) {
                    deserializedMigrateOracleAzureDbPostgreSqlSyncTaskOutputTableLevel.dataErrorsCounter
                        = reader.getNullable(JsonReader::getLong);
                } else if ("lastModifiedTime".equals(fieldName)) {
                    deserializedMigrateOracleAzureDbPostgreSqlSyncTaskOutputTableLevel.lastModifiedTime = reader
                        .getNullable(nonNullReader -> CoreUtils.parseBestOffsetDateTime(nonNullReader.getString()));
                } else {
                    reader.skipChildren();
                }
            ...
            return deserializedMigrateOracleAzureDbPostgreSqlSyncTaskOutputTableLevel;
        });
    }
}
