...
public final class ProjectFileImpl implements ProjectFile, ProjectFile.Definition, ProjectFile.Update {
    ...
    public ProjectFile apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getFiles()
            .updateWithResponse(groupName, serviceName, projectName, fileName, this.innerModel(), context).getValue();
        return this;
    }
    ...
    public ProjectFile refresh() {
        this.innerObject = serviceManager.serviceClient().getFiles()
            .getWithResponse(groupName, serviceName, projectName, fileName, Context.NONE).getValue();
        return this;
    }

    public ProjectFile refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getFiles()
            .getWithResponse(groupName, serviceName, projectName, fileName, context).getValue();
        return this;
    }
