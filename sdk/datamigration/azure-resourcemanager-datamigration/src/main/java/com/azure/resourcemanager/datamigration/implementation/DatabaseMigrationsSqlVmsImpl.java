...
public final class DatabaseMigrationsSqlVmsImpl implements DatabaseMigrationsSqlVms {
    ...
    public Response<DatabaseMigrationSqlVmListResult> listByScopeWithResponse(
        String resourceGroupName, String sqlVirtualMachineName, Context context) {
        Response<DatabaseMigrationSqlVmListResultInner> inner =
            this.serviceClient().listByScopeWithResponse(resourceGroupName, sqlVirtualMachineName, context);
        if (inner != null) {
            return new SimpleResponse<>(
                inner.getRequest(),
                inner.getStatusCode(),
                inner.getHeaders(),
                new DatabaseMigrationSqlVmListResultImpl(inner.getValue(), this.manager()));
        } else {
            return null;
        }
    }

    public DatabaseMigrationSqlVmListResult listByScope(String resourceGroupName, String sqlVirtualMachineName) {
        DatabaseMigrationSqlVmListResultInner inner =
            this.serviceClient().listByScope(resourceGroupName, sqlVirtualMachineName);
        if (inner != null) {
            return new DatabaseMigrationSqlVmListResultImpl(inner, this.manager());
        } else {
            return null;
        }
    }
