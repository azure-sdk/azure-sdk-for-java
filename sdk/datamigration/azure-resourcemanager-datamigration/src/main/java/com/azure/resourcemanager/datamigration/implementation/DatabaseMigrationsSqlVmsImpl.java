...
public final class DatabaseMigrationsSqlVmsImpl implements DatabaseMigrationsSqlVms {
    ...
    public Response<DatabaseMigrationSqlVm> getWithResponse(String resourceGroupName, String sqlVirtualMachineName,
        ...
        Response<DatabaseMigrationSqlVmInner> inner = this.serviceClient().getWithResponse(resourceGroupName,
            sqlVirtualMachineName, targetDbName, migrationOperationId, expand, context);
        if (inner != null) {
    ...
    public DatabaseMigrationSqlVm getById(String id) {
        ...
        return this.getWithResponse(resourceGroupName, sqlVirtualMachineName, targetDbName, localMigrationOperationId,
