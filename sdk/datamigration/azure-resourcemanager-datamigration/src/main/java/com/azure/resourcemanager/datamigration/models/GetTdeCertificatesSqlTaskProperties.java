...
public final class GetTdeCertificatesSqlTaskProperties extends ProjectTaskProperties {
    ...
    /**
     * Reads an instance of GetTdeCertificatesSqlTaskProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of GetTdeCertificatesSqlTaskProperties if the JsonReader was pointing to an instance of it,
     * or null if it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the GetTdeCertificatesSqlTaskProperties.
     */
    public static GetTdeCertificatesSqlTaskProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            GetTdeCertificatesSqlTaskProperties deserializedGetTdeCertificatesSqlTaskProperties
                = new GetTdeCertificatesSqlTaskProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("errors".equals(fieldName)) {
                    ...
                    deserializedGetTdeCertificatesSqlTaskProperties.errors = errors;
                } else if ("state".equals(fieldName)) {
                    deserializedGetTdeCertificatesSqlTaskProperties.state = TaskState.fromString(reader.getString());
                    ...
                    deserializedGetTdeCertificatesSqlTaskProperties.commands = commands;
                    ...
                    deserializedGetTdeCertificatesSqlTaskProperties.input
                        = GetTdeCertificatesSqlTaskInput.fromJson(reader);
                } else if ("output".equals(fieldName)) {
                    List<GetTdeCertificatesSqlTaskOutput> output
                        = reader.readArray(reader1 -> GetTdeCertificatesSqlTaskOutput.fromJson(reader1));
                    deserializedGetTdeCertificatesSqlTaskProperties.output = output;
                } else {
                    reader.skipChildren();
                }
            }
