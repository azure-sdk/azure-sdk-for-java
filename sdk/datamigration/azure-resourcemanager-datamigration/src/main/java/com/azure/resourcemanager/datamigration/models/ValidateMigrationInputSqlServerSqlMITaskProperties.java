        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("errors".equals(fieldName)) {
                    ...
                    deserializedValidateMigrationInputSqlServerSqlMITaskProperties.errors = errors;
                } else if ("state".equals(fieldName)) {
                    deserializedValidateMigrationInputSqlServerSqlMITaskProperties.state
                    ...
                    deserializedValidateMigrationInputSqlServerSqlMITaskProperties.commands = commands;
