...
public final class MigrateMySqlAzureDbForMySqlOfflineTaskOutputMigrationLevel
    ...
    private MigrateMySqlAzureDbForMySqlOfflineTaskOutputMigrationLevelMigrationType migrationType;
    ...
    /*
     * The binlog position when the consistent snapshot was taken. Only returned when consistent backup is enabled in
     * the migration inputs.
     */
    @JsonProperty(value = "sourceBinlogPosition", access = JsonProperty.Access.WRITE_ONLY)
    private MySqlBinlogPositionOutput sourceBinlogPosition;
     ...
     */
    public MigrateMySqlAzureDbForMySqlOfflineTaskOutputMigrationLevelMigrationType migrationType() {
    ...
    /**
     * Get the sourceBinlogPosition property: The binlog position when the consistent snapshot was taken. Only returned
     * when consistent backup is enabled in the migration inputs.
     *
     * @return the sourceBinlogPosition value.
     */
    public MySqlBinlogPositionOutput sourceBinlogPosition() {
        return this.sourceBinlogPosition;
    }
    ...
    public void validate() {
        ...
        if (sourceBinlogPosition() != null) {
            sourceBinlogPosition().validate();
        }
    }
}
