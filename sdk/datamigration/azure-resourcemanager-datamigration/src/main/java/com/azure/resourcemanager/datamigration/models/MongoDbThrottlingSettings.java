...
public final class MongoDbThrottlingSettings {
    ...
    /**
     * Get the minFreeCpu property: The percentage of CPU time that the migrator will try to avoid using, from 0 to
     * 100.
     * 
    ...
    /**
     * Set the minFreeCpu property: The percentage of CPU time that the migrator will try to avoid using, from 0 to
     * 100.
     * 
    ...
    /**
     * Get the maxParallelism property: The maximum number of work items (e.g. collection copies) that will be
    ...
    /**
     * Set the maxParallelism property: The maximum number of work items (e.g. collection copies) that will be
     * processed in parallel.
     * 
