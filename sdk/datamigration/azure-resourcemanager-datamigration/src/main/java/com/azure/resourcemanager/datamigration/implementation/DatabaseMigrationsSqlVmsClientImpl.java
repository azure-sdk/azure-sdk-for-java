...
public final class DatabaseMigrationsSqlVmsClientImpl implements DatabaseMigrationsSqlVmsClient {
    ...
    private interface DatabaseMigrationsSqlVmsService {
        ...
        Mono<Response<DatabaseMigrationSqlVmInner>> get(
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<DatabaseMigrationSqlVmListResultInner>> listByScope(
            @HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("sqlVirtualMachineName") String sqlVirtualMachineName,
            @PathParam("subscriptionId") String subscriptionId,
        ...
        @ExpectedResponses({200, 202})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Flux<ByteBuffer>>> cutover(
            @HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("sqlVirtualMachineName") String sqlVirtualMachineName,
            @PathParam("targetDbName") String targetDbName,
    ...
    private Mono<Response<DatabaseMigrationSqlVmInner>> getWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DatabaseMigrationSqlVmInner> getAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<DatabaseMigrationSqlVmInner> getWithResponse(
        String resourceGroupName,
        String sqlVirtualMachineName,
        String targetDbName,
        UUID migrationOperationId,
    ...
    public DatabaseMigrationSqlVmInner get(
        ...
        return getWithResponse(
                resourceGroupName, sqlVirtualMachineName, targetDbName, migrationOperationId, expand, Context.NONE)
            .getValue();
    }
    ...
    private PollerFlux<PollResult<DatabaseMigrationSqlVmInner>, DatabaseMigrationSqlVmInner> beginCreateOrUpdateAsync(
        ...
        return this
            .client
            .<DatabaseMigrationSqlVmInner, DatabaseMigrationSqlVmInner>getLroResult(
                mono,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DatabaseMigrationSqlVmInner> createOrUpdateAsync(
        String resourceGroupName,
        String sqlVirtualMachineName,
        String targetDbName,
        DatabaseMigrationSqlVmInner parameters) {
    ...
    private Mono<Response<Flux<ByteBuffer>>> deleteWithResponseAsync(
        String resourceGroupName, String sqlVirtualMachineName, String targetDbName, Boolean force) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    private PollerFlux<PollResult<Void>, Void> beginDeleteAsync(
        ...
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono =
            deleteWithResponseAsync(resourceGroupName, sqlVirtualMachineName, targetDbName, force, context);
        return this
            .client
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(
        String resourceGroupName, String sqlVirtualMachineName, String targetDbName) {
        final Boolean force = null;
        return beginDeleteAsync(resourceGroupName, sqlVirtualMachineName, targetDbName, force).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(
        String resourceGroupName, String sqlVirtualMachineName, String targetDbName, Boolean force, Context context) {
        return beginDeleteAsync(resourceGroupName, sqlVirtualMachineName, targetDbName, force, context).getSyncPoller();
    }
    ...
    private Mono<Void> deleteAsync(
        String resourceGroupName, String sqlVirtualMachineName, String targetDbName, Boolean force) {
        return beginDeleteAsync(resourceGroupName, sqlVirtualMachineName, targetDbName, force)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<Void> deleteAsync(
        String resourceGroupName, String sqlVirtualMachineName, String targetDbName, Boolean force, Context context) {
        return beginDeleteAsync(resourceGroupName, sqlVirtualMachineName, targetDbName, force, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    public void delete(String resourceGroupName, String sqlVirtualMachineName, String targetDbName) {
        final Boolean force = null;
        deleteAsync(resourceGroupName, sqlVirtualMachineName, targetDbName, force).block();
    }
    ...
    public void delete(
        String resourceGroupName, String sqlVirtualMachineName, String targetDbName, Boolean force, Context context) {
        deleteAsync(resourceGroupName, sqlVirtualMachineName, targetDbName, force, context).block();
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a list of Database Migrations for SQL Virtual Machine along with {@link Response} on successful
     *     completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<DatabaseMigrationSqlVmListResultInner>> listByScopeWithResponseAsync(
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a list of Database Migrations for SQL Virtual Machine on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DatabaseMigrationSqlVmListResultInner> listByScopeAsync(
        String resourceGroupName, String sqlVirtualMachineName) {
        return listByScopeWithResponseAsync(resourceGroupName, sqlVirtualMachineName)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a list of Database Migrations for SQL Virtual Machine along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<DatabaseMigrationSqlVmListResultInner> listByScopeWithResponse(
        String resourceGroupName, String sqlVirtualMachineName, Context context) {
        return listByScopeWithResponseAsync(resourceGroupName, sqlVirtualMachineName, context).block();
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a list of Database Migrations for SQL Virtual Machine.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public DatabaseMigrationSqlVmListResultInner listByScope(String resourceGroupName, String sqlVirtualMachineName) {
        return listByScopeWithResponse(resourceGroupName, sqlVirtualMachineName, Context.NONE).getValue();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> cutoverWithResponseAsync(
        String resourceGroupName,
        String sqlVirtualMachineName,
        String targetDbName,
        MigrationOperationInput parameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<Void>, Void> beginCutoverAsync(
        String resourceGroupName,
        String sqlVirtualMachineName,
        String targetDbName,
        MigrationOperationInput parameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<Void>, Void> beginCutover(
        String resourceGroupName,
        String sqlVirtualMachineName,
        String targetDbName,
        MigrationOperationInput parameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> cutoverAsync(
        String resourceGroupName,
        String sqlVirtualMachineName,
        String targetDbName,
        MigrationOperationInput parameters) {
