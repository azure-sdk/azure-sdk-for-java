...
public final class DatabaseMigrationsSqlVmsClientImpl implements DatabaseMigrationsSqlVmsClient {
    ...
    public SyncPoller<PollResult<DatabaseMigrationSqlVmInner>, DatabaseMigrationSqlVmInner> beginCreateOrUpdate(
        ...
        DatabaseMigrationSqlVmInner parameters) {
        return this
            .beginCreateOrUpdateAsync(resourceGroupName, sqlVirtualMachineName, targetDbName, parameters)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginCancel(
        ...
        MigrationOperationInput parameters) {
        return this
            .beginCancelAsync(resourceGroupName, sqlVirtualMachineName, targetDbName, parameters)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginCancel(
        ...
        Context context) {
        return this
            .beginCancelAsync(resourceGroupName, sqlVirtualMachineName, targetDbName, parameters, context)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginCutover(
        ...
        MigrationOperationInput parameters) {
        return this
            .beginCutoverAsync(resourceGroupName, sqlVirtualMachineName, targetDbName, parameters)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginCutover(
        ...
        Context context) {
        return this
            .beginCutoverAsync(resourceGroupName, sqlVirtualMachineName, targetDbName, parameters, context)
            .getSyncPoller();
    }
