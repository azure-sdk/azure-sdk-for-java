...
public final class DatabaseMigrationsSqlVmsClientImpl implements DatabaseMigrationsSqlVmsClient {
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<DatabaseMigrationSqlVmInner>> getWithResponseAsync(String resourceGroupName,
        String sqlVirtualMachineName, String targetDbName, UUID migrationOperationId, String expand, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service.get(this.client.getEndpoint(), resourceGroupName, sqlVirtualMachineName, targetDbName,
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String resourceGroupName,
        String sqlVirtualMachineName, String targetDbName, DatabaseMigrationSqlVmInner parameters, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.createOrUpdate(this.client.getEndpoint(), resourceGroupName, sqlVirtualMachineName, targetDbName,
    ...
    private PollerFlux<PollResult<DatabaseMigrationSqlVmInner>, DatabaseMigrationSqlVmInner> beginCreateOrUpdateAsync(
        ...
        Mono<Response<Flux<ByteBuffer>>> mono = createOrUpdateWithResponseAsync(resourceGroupName,
            sqlVirtualMachineName, targetDbName, parameters, context);
        return this.client.<DatabaseMigrationSqlVmInner, DatabaseMigrationSqlVmInner>getLroResult(mono,
            this.client.getHttpPipeline(), DatabaseMigrationSqlVmInner.class, DatabaseMigrationSqlVmInner.class,
            context);
    }
    ...
    public SyncPoller<PollResult<DatabaseMigrationSqlVmInner>, DatabaseMigrationSqlVmInner> beginCreateOrUpdate(
        String resourceGroupName, String sqlVirtualMachineName, String targetDbName,
        DatabaseMigrationSqlVmInner parameters) {
        return this.beginCreateOrUpdateAsync(resourceGroupName, sqlVirtualMachineName, targetDbName, parameters)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<DatabaseMigrationSqlVmInner>, DatabaseMigrationSqlVmInner> beginCreateOrUpdate(
        ...
        DatabaseMigrationSqlVmInner parameters, Context context) {
        return this
            .beginCreateOrUpdateAsync(resourceGroupName, sqlVirtualMachineName, targetDbName, parameters, context)
            .getSyncPoller();
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> cancelWithResponseAsync(String resourceGroupName,
        String sqlVirtualMachineName, String targetDbName, MigrationOperationInput parameters, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        context = this.client.mergeContext(context);
        return service.cancel(this.client.getEndpoint(), resourceGroupName, sqlVirtualMachineName, targetDbName,
    ...
    public SyncPoller<PollResult<Void>, Void> beginCancel(String resourceGroupName, String sqlVirtualMachineName,
        String targetDbName, MigrationOperationInput parameters) {
        return this.beginCancelAsync(resourceGroupName, sqlVirtualMachineName, targetDbName, parameters)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginCancel(String resourceGroupName, String sqlVirtualMachineName,
        String targetDbName, MigrationOperationInput parameters, Context context) {
        return this.beginCancelAsync(resourceGroupName, sqlVirtualMachineName, targetDbName, parameters, context)
            .getSyncPoller();
    }
    ...
    private Mono<Void> cancelAsync(String resourceGroupName, String sqlVirtualMachineName, String targetDbName,
        ...
        return beginCancelAsync(resourceGroupName, sqlVirtualMachineName, targetDbName, parameters, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> cutoverWithResponseAsync(String resourceGroupName,
        ...
        context = this.client.mergeContext(context);
        return service.cutover(this.client.getEndpoint(), resourceGroupName, sqlVirtualMachineName, targetDbName,
            this.client.getSubscriptionId(), this.client.getApiVersion(), parameters, context);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginCutover(String resourceGroupName, String sqlVirtualMachineName,
        String targetDbName, MigrationOperationInput parameters) {
        return this.beginCutoverAsync(resourceGroupName, sqlVirtualMachineName, targetDbName, parameters)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginCutover(String resourceGroupName, String sqlVirtualMachineName,
        String targetDbName, MigrationOperationInput parameters, Context context) {
        return this.beginCutoverAsync(resourceGroupName, sqlVirtualMachineName, targetDbName, parameters, context)
            .getSyncPoller();
    }
    ...
    private Mono<Void> cutoverAsync(String resourceGroupName, String sqlVirtualMachineName, String targetDbName,
        MigrationOperationInput parameters, Context context) {
        return beginCutoverAsync(resourceGroupName, sqlVirtualMachineName, targetDbName, parameters, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
