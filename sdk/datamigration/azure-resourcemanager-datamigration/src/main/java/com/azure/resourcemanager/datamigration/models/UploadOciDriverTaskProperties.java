        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("errors".equals(fieldName)) {
                    ...
                    deserializedUploadOciDriverTaskProperties.errors = errors;
                } else if ("state".equals(fieldName)) {
                    deserializedUploadOciDriverTaskProperties.state = TaskState.fromString(reader.getString());
                    ...
                    deserializedUploadOciDriverTaskProperties.commands = commands;
