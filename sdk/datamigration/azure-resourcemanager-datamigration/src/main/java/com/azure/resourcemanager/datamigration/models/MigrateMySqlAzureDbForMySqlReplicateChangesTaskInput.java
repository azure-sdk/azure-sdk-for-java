 ...
 */
@Fluent
public final class MigrateMySqlAzureDbForMySqlReplicateChangesTaskInput {
    /*
    ...
    private List<MigrateMySqlAzureDbForMySqlReplicateChangesDatabaseInput> selectedDatabases;
    ...
    /*
     * The binlog position to start replicating changes at
     */
    @JsonProperty(value = "binLogInfo")
    private MySqlBinlogPositionInput binLogInfo;
    ...
    /** Creates an instance of MigrateMySqlAzureDbForMySqlReplicateChangesTaskInput class. */
     ...
     * @return the MigrateMySqlAzureDbForMySqlReplicateChangesTaskInput object itself.
     */
    public MigrateMySqlAzureDbForMySqlReplicateChangesTaskInput withSourceConnectionInfo(
     ...
     * @return the MigrateMySqlAzureDbForMySqlReplicateChangesTaskInput object itself.
     */
    public MigrateMySqlAzureDbForMySqlReplicateChangesTaskInput withTargetConnectionInfo(
     ...
     */
    public List<MigrateMySqlAzureDbForMySqlReplicateChangesDatabaseInput> selectedDatabases() {
     ...
     * @return the MigrateMySqlAzureDbForMySqlReplicateChangesTaskInput object itself.
     */
    public MigrateMySqlAzureDbForMySqlReplicateChangesTaskInput withSelectedDatabases(
        List<MigrateMySqlAzureDbForMySqlReplicateChangesDatabaseInput> selectedDatabases) {
     ...
     * @return the MigrateMySqlAzureDbForMySqlReplicateChangesTaskInput object itself.
     */
    public MigrateMySqlAzureDbForMySqlReplicateChangesTaskInput withMakeSourceServerReadOnly(
        Boolean makeSourceServerReadOnly) {
     ...
     * @return the MigrateMySqlAzureDbForMySqlReplicateChangesTaskInput object itself.
     */
    public MigrateMySqlAzureDbForMySqlReplicateChangesTaskInput withStartedOn(OffsetDateTime startedOn) {
     ...
     * @return the MigrateMySqlAzureDbForMySqlReplicateChangesTaskInput object itself.
     */
    public MigrateMySqlAzureDbForMySqlReplicateChangesTaskInput withSourceServerResourceId(
     ...
     * @return the MigrateMySqlAzureDbForMySqlReplicateChangesTaskInput object itself.
     */
    public MigrateMySqlAzureDbForMySqlReplicateChangesTaskInput withTargetServerResourceId(
     ...
     * @return the MigrateMySqlAzureDbForMySqlReplicateChangesTaskInput object itself.
     */
    public MigrateMySqlAzureDbForMySqlReplicateChangesTaskInput withOptionalAgentSettings(
    ...
    /**
     * Get the binLogInfo property: The binlog position to start replicating changes at.
     *
     * @return the binLogInfo value.
     */
    public MySqlBinlogPositionInput binLogInfo() {
        return this.binLogInfo;
    }

    /**
     * Set the binLogInfo property: The binlog position to start replicating changes at.
     *
     * @param binLogInfo the binLogInfo value to set.
     * @return the MigrateMySqlAzureDbForMySqlReplicateChangesTaskInput object itself.
     */
    public MigrateMySqlAzureDbForMySqlReplicateChangesTaskInput withBinLogInfo(MySqlBinlogPositionInput binLogInfo) {
     ...
     * @return the MigrateMySqlAzureDbForMySqlReplicateChangesTaskInput object itself.
     */
    public MigrateMySqlAzureDbForMySqlReplicateChangesTaskInput withEncryptedKeyForSecureFields(
    ...
    private static final ClientLogger LOGGER =
        new ClientLogger(MigrateMySqlAzureDbForMySqlReplicateChangesTaskInput.class);
}
