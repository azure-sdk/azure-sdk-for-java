...
public final class MigrateMySqlAzureDbForMySqlReplicateChangesTaskInput {
     ...
     */
    @JsonProperty(value = "binLogInfo", required = true)
    ...
    /**
     * Get the binLogInfo property: The binlog position to start replicating the changes at.
     *
    ...
    /**
     * Set the binLogInfo property: The binlog position to start replicating the changes at.
     *
    ...
    public void validate() {
        ...
        if (binLogInfo() == null) {
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException(
                        "Missing required property binLogInfo in model"
                            + " MigrateMySqlAzureDbForMySqlReplicateChangesTaskInput"));
        } else {
            binLogInfo().validate();
        }
