...
public final class ProjectTaskImpl implements ProjectTask, ProjectTask.Definition, ProjectTask.Update {
    ...
    public ProjectTask apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getTasks()
            .updateWithResponse(groupName, serviceName, projectName, taskName, this.innerModel(), context).getValue();
        return this;
    }
    ...
    public ProjectTask refresh() {
        ...
        this.innerObject = serviceManager.serviceClient().getTasks()
            .getWithResponse(groupName, serviceName, projectName, taskName, localExpand, Context.NONE).getValue();
        return this;
    }
    ...
    public ProjectTask refresh(Context context) {
        String localExpand = null;
        this.innerObject = serviceManager.serviceClient().getTasks()
            .getWithResponse(groupName, serviceName, projectName, taskName, localExpand, context).getValue();
        return this;
    }
    ...
    public Response<CommandProperties> commandWithResponse(CommandPropertiesInner parameters, Context context) {
        return serviceManager.tasks().commandWithResponse(groupName, serviceName, projectName, taskName, parameters,
            context);
    }
