...
public interface MigrationServicesClient {
    ...
    Response<MigrationServiceInner> getByResourceGroupWithResponse(
    ...
    SyncPoller<PollResult<MigrationServiceInner>, MigrationServiceInner> beginCreateOrUpdate(
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<MigrationServiceInner>, MigrationServiceInner> beginUpdate(
