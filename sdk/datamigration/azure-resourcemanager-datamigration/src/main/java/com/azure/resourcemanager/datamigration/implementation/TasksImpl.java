...
public final class TasksImpl implements Tasks {
    ...
    public Response<Void> deleteWithResponse(String groupName, String serviceName, String projectName, String taskName,
        ...
        return this.serviceClient().deleteWithResponse(groupName, serviceName, projectName, taskName,
            deleteRunningTasks, context);
    }
    ...
    public Response<CommandProperties> commandWithResponse(String groupName, String serviceName, String projectName,
        ...
        Response<CommandPropertiesInner> inner = this.serviceClient().commandWithResponse(groupName, serviceName,
            projectName, taskName, parameters, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
