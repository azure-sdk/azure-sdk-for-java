...
public interface DatabaseMigrationsSqlVms {
     ...
     */
    Response<DatabaseMigrationSqlVm> getWithResponse(String resourceGroupName, String sqlVirtualMachineName,
     ...
     * @return database Migration Resource for SQL Virtual Machine along with {@link Response}.
     */
    Response<DatabaseMigrationSqlVm> getByIdWithResponse(String id, UUID migrationOperationId, String expand,
        Context context);
