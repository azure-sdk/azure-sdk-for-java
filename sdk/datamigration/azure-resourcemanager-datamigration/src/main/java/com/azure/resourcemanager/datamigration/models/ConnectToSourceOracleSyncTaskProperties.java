        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("errors".equals(fieldName)) {
                    ...
                    deserializedConnectToSourceOracleSyncTaskProperties.errors = errors;
                } else if ("state".equals(fieldName)) {
                    deserializedConnectToSourceOracleSyncTaskProperties.state
                    ...
                    deserializedConnectToSourceOracleSyncTaskProperties.commands = commands;
