...
public final class SqlMigrationServicesClientImpl implements SqlMigrationServicesClient {
    ...
    private interface SqlMigrationServicesService {
        ...
        @Get(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataMigration"
                + "/sqlMigrationServices/{sqlMigrationServiceName}/MonitoringData")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<IntegrationRuntimeMonitoringDataInner>> monitoringData(
            @HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("sqlMigrationServiceName") String sqlMigrationServiceName,
            @PathParam("subscriptionId") String subscriptionId,
        ...
        @Post(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataMigration"
                + "/sqlMigrationServices/{sqlMigrationServiceName}/validateIR")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ValidateIRInner>> validateIR(
            @HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("sqlMigrationServiceName") String sqlMigrationServiceName,
            @PathParam("subscriptionId") String subscriptionId,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") ValidateIRInner parameters,
            @HeaderParam("Accept") String accept,
            Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<IntegrationRuntimeMonitoringDataInner>> monitoringDataWithResponseAsync(
        String resourceGroupName, String sqlMigrationServiceName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<IntegrationRuntimeMonitoringDataInner> monitoringDataAsync(
        String resourceGroupName, String sqlMigrationServiceName) {
        return monitoringDataWithResponseAsync(resourceGroupName, sqlMigrationServiceName)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<IntegrationRuntimeMonitoringDataInner> monitoringDataWithResponse(
        String resourceGroupName, String sqlMigrationServiceName, Context context) {
        return monitoringDataWithResponseAsync(resourceGroupName, sqlMigrationServiceName, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public IntegrationRuntimeMonitoringDataInner monitoringData(
        String resourceGroupName, String sqlMigrationServiceName) {
        return monitoringDataWithResponse(resourceGroupName, sqlMigrationServiceName, Context.NONE).getValue();
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return iR validations for MI / VM along with {@link Response} on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ValidateIRInner>> validateIRWithResponseAsync(
        String resourceGroupName, String sqlMigrationServiceName, ValidateIRInner parameters) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ValidateIRInner>> validateIRWithResponseAsync(
        String resourceGroupName, String sqlMigrationServiceName, ValidateIRInner parameters, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return iR validations for MI / VM on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ValidateIRInner> validateIRAsync(
        String resourceGroupName, String sqlMigrationServiceName, ValidateIRInner parameters) {
        return validateIRWithResponseAsync(resourceGroupName, sqlMigrationServiceName, parameters)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return iR validations for MI / VM along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ValidateIRInner> validateIRWithResponse(
        String resourceGroupName, String sqlMigrationServiceName, ValidateIRInner parameters, Context context) {
        return validateIRWithResponseAsync(resourceGroupName, sqlMigrationServiceName, parameters, context).block();
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return iR validations for MI / VM.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ValidateIRInner validateIR(
        String resourceGroupName, String sqlMigrationServiceName, ValidateIRInner parameters) {
        return validateIRWithResponse(resourceGroupName, sqlMigrationServiceName, parameters, Context.NONE).getValue();
    }
