...
public final class SqlMigrationServicesClientImpl implements SqlMigrationServicesClient {
    ...
    private Mono<Response<SqlMigrationServiceInner>> getByResourceGroupWithResponseAsync(String resourceGroupName,
        ...
        return service.getByResourceGroup(this.client.getEndpoint(), resourceGroupName, sqlMigrationServiceName,
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String resourceGroupName,
        String sqlMigrationServiceName, SqlMigrationServiceInner parameters, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.createOrUpdate(this.client.getEndpoint(), resourceGroupName, sqlMigrationServiceName,
            this.client.getSubscriptionId(), this.client.getApiVersion(), parameters, accept, context);
    }
    ...
    private PollerFlux<PollResult<SqlMigrationServiceInner>, SqlMigrationServiceInner> beginCreateOrUpdateAsync(
        ...
        return this.client.<SqlMigrationServiceInner, SqlMigrationServiceInner>getLroResult(mono,
            this.client.getHttpPipeline(), SqlMigrationServiceInner.class, SqlMigrationServiceInner.class, context);
    }
    ...
    public SyncPoller<PollResult<SqlMigrationServiceInner>, SqlMigrationServiceInner> beginCreateOrUpdate(
        String resourceGroupName, String sqlMigrationServiceName, SqlMigrationServiceInner parameters) {
        return this.beginCreateOrUpdateAsync(resourceGroupName, sqlMigrationServiceName, parameters).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<SqlMigrationServiceInner>, SqlMigrationServiceInner> beginCreateOrUpdate(
        String resourceGroupName, String sqlMigrationServiceName, SqlMigrationServiceInner parameters,
        Context context) {
        return this.beginCreateOrUpdateAsync(resourceGroupName, sqlMigrationServiceName, parameters, context)
            .getSyncPoller();
    }
    ...
    private Mono<SqlMigrationServiceInner> createOrUpdateAsync(String resourceGroupName, String sqlMigrationServiceName,
        ...
        return beginCreateOrUpdateAsync(resourceGroupName, sqlMigrationServiceName, parameters, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> deleteWithResponseAsync(String resourceGroupName,
        ...
        context = this.client.mergeContext(context);
        return service.delete(this.client.getEndpoint(), resourceGroupName, sqlMigrationServiceName,
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String sqlMigrationServiceName) {
        return this.beginDeleteAsync(resourceGroupName, sqlMigrationServiceName).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String sqlMigrationServiceName,
        Context context) {
        return this.beginDeleteAsync(resourceGroupName, sqlMigrationServiceName, context).getSyncPoller();
    }
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String sqlMigrationServiceName, Context context) {
        return beginDeleteAsync(resourceGroupName, sqlMigrationServiceName, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> updateWithResponseAsync(String resourceGroupName,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.update(this.client.getEndpoint(), resourceGroupName, sqlMigrationServiceName,
            this.client.getSubscriptionId(), this.client.getApiVersion(), parameters, accept, context);
    }
    ...
    public SyncPoller<PollResult<SqlMigrationServiceInner>, SqlMigrationServiceInner>
        ...
        return this.beginUpdateAsync(resourceGroupName, sqlMigrationServiceName, parameters).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<SqlMigrationServiceInner>, SqlMigrationServiceInner> beginUpdate(
        String resourceGroupName, String sqlMigrationServiceName, SqlMigrationServiceUpdate parameters,
        Context context) {
        return this.beginUpdateAsync(resourceGroupName, sqlMigrationServiceName, parameters, context).getSyncPoller();
    }
    ...
    private Mono<SqlMigrationServiceInner> updateAsync(String resourceGroupName, String sqlMigrationServiceName,
        ...
        return beginUpdateAsync(resourceGroupName, sqlMigrationServiceName, parameters, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<Response<AuthenticationKeysInner>> listAuthKeysWithResponseAsync(String resourceGroupName,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.listAuthKeys(this.client.getEndpoint(), resourceGroupName, sqlMigrationServiceName,
            this.client.getSubscriptionId(), this.client.getApiVersion(), accept, context);
    }
    ...
    private Mono<Response<RegenAuthKeysInner>> regenerateAuthKeysWithResponseAsync(String resourceGroupName,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.regenerateAuthKeys(this.client.getEndpoint(), resourceGroupName, sqlMigrationServiceName,
            this.client.getSubscriptionId(), this.client.getApiVersion(), parameters, accept, context);
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<DeleteNodeInner>> deleteNodeWithResponseAsync(String resourceGroupName,
        String sqlMigrationServiceName, DeleteNodeInner parameters, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.deleteNode(this.client.getEndpoint(), resourceGroupName, sqlMigrationServiceName,
            this.client.getSubscriptionId(), this.client.getApiVersion(), parameters, accept, context);
    }
    ...
    private Mono<PagedResponse<DatabaseMigrationInner>> listMigrationsSinglePageAsync(String resourceGroupName,
        ...
        context = this.client.mergeContext(context);
        return service
            .listMigrations(this.client.getEndpoint(), resourceGroupName, sqlMigrationServiceName,
                this.client.getSubscriptionId(), this.client.getApiVersion(), accept, context)
            .map(res -> new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(),
                res.getValue().value(), res.getValue().nextLink(), null));
    }
    ...
    private PagedFlux<DatabaseMigrationInner> listMigrationsAsync(String resourceGroupName,
        String sqlMigrationServiceName, Context context) {
        return new PagedFlux<>(() -> listMigrationsSinglePageAsync(resourceGroupName, sqlMigrationServiceName, context),
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<IntegrationRuntimeMonitoringDataInner>>
        listMonitoringDataWithResponseAsync(String resourceGroupName, String sqlMigrationServiceName, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.listMonitoringData(this.client.getEndpoint(), resourceGroupName, sqlMigrationServiceName,
            this.client.getSubscriptionId(), this.client.getApiVersion(), accept, context);
    }
