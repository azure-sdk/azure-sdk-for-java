...
public interface DatabaseMigrationsSqlMisClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<DatabaseMigrationSqlMiListResultInner> listByScopeWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    DatabaseMigrationSqlMiListResultInner listByScope(String resourceGroupName, String managedInstanceName);
