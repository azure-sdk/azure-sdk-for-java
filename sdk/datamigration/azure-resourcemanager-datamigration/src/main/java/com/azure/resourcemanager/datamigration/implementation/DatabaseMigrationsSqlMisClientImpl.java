...
public final class DatabaseMigrationsSqlMisClientImpl implements DatabaseMigrationsSqlMisClient {
    ...
    public SyncPoller<PollResult<DatabaseMigrationSqlMiInner>, DatabaseMigrationSqlMiInner> beginCreateOrUpdate(
        ...
        DatabaseMigrationSqlMiInner parameters) {
        return this
            .beginCreateOrUpdateAsync(resourceGroupName, managedInstanceName, targetDbName, parameters)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<DatabaseMigrationSqlMiInner>, DatabaseMigrationSqlMiInner> beginCreateOrUpdate(
        ...
        Context context) {
        return this
            .beginCreateOrUpdateAsync(resourceGroupName, managedInstanceName, targetDbName, parameters, context)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginCancel(
        ...
        Context context) {
        return this
            .beginCancelAsync(resourceGroupName, managedInstanceName, targetDbName, parameters, context)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginCutover(
        ...
        Context context) {
        return this
            .beginCutoverAsync(resourceGroupName, managedInstanceName, targetDbName, parameters, context)
            .getSyncPoller();
    }
