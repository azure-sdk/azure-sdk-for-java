...
public final class DatabaseMigrationsSqlMisClientImpl implements DatabaseMigrationsSqlMisClient {
    ...
    private interface DatabaseMigrationsSqlMisService {
        ...
        Mono<Response<DatabaseMigrationSqlMiInner>> get(
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<DatabaseMigrationSqlMiListResultInner>> listByScope(
            @HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("managedInstanceName") String managedInstanceName,
            @PathParam("subscriptionId") String subscriptionId,
    ...
    private Mono<Response<DatabaseMigrationSqlMiInner>> getWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DatabaseMigrationSqlMiInner> getAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<DatabaseMigrationSqlMiInner> getWithResponse(
        String resourceGroupName,
        String managedInstanceName,
        String targetDbName,
        UUID migrationOperationId,
    ...
    public DatabaseMigrationSqlMiInner get(String resourceGroupName, String managedInstanceName, String targetDbName) {
        ...
        return getWithResponse(
                resourceGroupName, managedInstanceName, targetDbName, migrationOperationId, expand, Context.NONE)
            .getValue();
    }
    ...
    private PollerFlux<PollResult<DatabaseMigrationSqlMiInner>, DatabaseMigrationSqlMiInner> beginCreateOrUpdateAsync(
        ...
        return this
            .client
            .<DatabaseMigrationSqlMiInner, DatabaseMigrationSqlMiInner>getLroResult(
                mono,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DatabaseMigrationSqlMiInner> createOrUpdateAsync(
        String resourceGroupName,
        String managedInstanceName,
        String targetDbName,
        DatabaseMigrationSqlMiInner parameters) {
    ...
    private Mono<Response<Flux<ByteBuffer>>> deleteWithResponseAsync(
        String resourceGroupName, String managedInstanceName, String targetDbName, Boolean force) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    private PollerFlux<PollResult<Void>, Void> beginDeleteAsync(
        ...
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono =
            deleteWithResponseAsync(resourceGroupName, managedInstanceName, targetDbName, force, context);
        return this
            .client
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(
        String resourceGroupName, String managedInstanceName, String targetDbName) {
        final Boolean force = null;
        return beginDeleteAsync(resourceGroupName, managedInstanceName, targetDbName, force).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(
        String resourceGroupName, String managedInstanceName, String targetDbName, Boolean force, Context context) {
        return beginDeleteAsync(resourceGroupName, managedInstanceName, targetDbName, force, context).getSyncPoller();
    }
    ...
    private Mono<Void> deleteAsync(
        String resourceGroupName, String managedInstanceName, String targetDbName, Boolean force) {
        return beginDeleteAsync(resourceGroupName, managedInstanceName, targetDbName, force)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<Void> deleteAsync(
        String resourceGroupName, String managedInstanceName, String targetDbName, Boolean force, Context context) {
        return beginDeleteAsync(resourceGroupName, managedInstanceName, targetDbName, force, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    public void delete(String resourceGroupName, String managedInstanceName, String targetDbName) {
        final Boolean force = null;
        deleteAsync(resourceGroupName, managedInstanceName, targetDbName, force).block();
    }
    ...
    public void delete(
        String resourceGroupName, String managedInstanceName, String targetDbName, Boolean force, Context context) {
        deleteAsync(resourceGroupName, managedInstanceName, targetDbName, force, context).block();
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a list of Database Migrations for SQL Managed Instance along with {@link Response} on successful
     *     completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<DatabaseMigrationSqlMiListResultInner>> listByScopeWithResponseAsync(
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a list of Database Migrations for SQL Managed Instance on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DatabaseMigrationSqlMiListResultInner> listByScopeAsync(
        String resourceGroupName, String managedInstanceName) {
        return listByScopeWithResponseAsync(resourceGroupName, managedInstanceName)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a list of Database Migrations for SQL Managed Instance along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<DatabaseMigrationSqlMiListResultInner> listByScopeWithResponse(
        String resourceGroupName, String managedInstanceName, Context context) {
        return listByScopeWithResponseAsync(resourceGroupName, managedInstanceName, context).block();
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a list of Database Migrations for SQL Managed Instance.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public DatabaseMigrationSqlMiListResultInner listByScope(String resourceGroupName, String managedInstanceName) {
        return listByScopeWithResponse(resourceGroupName, managedInstanceName, Context.NONE).getValue();
    }
