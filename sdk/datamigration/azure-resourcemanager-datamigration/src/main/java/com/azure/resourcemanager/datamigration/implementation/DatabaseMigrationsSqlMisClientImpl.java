...
public final class DatabaseMigrationsSqlMisClientImpl implements DatabaseMigrationsSqlMisClient {
    ...
    public interface DatabaseMigrationsSqlMisService {
        ...
        Mono<Response<DatabaseMigrationSqlMiInner>> get(@HostParam("$host") String endpoint,
    ...
    private Mono<Response<DatabaseMigrationSqlMiInner>> getWithResponseAsync(String resourceGroupName,
        String managedInstanceName, String targetDbName, UUID migrationOperationId, String expand) {
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<DatabaseMigrationSqlMiInner>> getWithResponseAsync(String resourceGroupName,
        String managedInstanceName, String targetDbName, UUID migrationOperationId, String expand, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service.get(this.client.getEndpoint(), resourceGroupName, managedInstanceName, targetDbName,
    ...
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(context -> service.createOrUpdate(this.client.getEndpoint(), resourceGroupName,
                managedInstanceName, targetDbName, this.client.getSubscriptionId(), this.client.getApiVersion(),
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String resourceGroupName,
        String managedInstanceName, String targetDbName, DatabaseMigrationSqlMiInner parameters, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.createOrUpdate(this.client.getEndpoint(), resourceGroupName, managedInstanceName, targetDbName,
    ...
    private PollerFlux<PollResult<DatabaseMigrationSqlMiInner>, DatabaseMigrationSqlMiInner> beginCreateOrUpdateAsync(
        ...
        Mono<Response<Flux<ByteBuffer>>> mono = createOrUpdateWithResponseAsync(resourceGroupName, managedInstanceName,
            targetDbName, parameters, context);
        return this.client.<DatabaseMigrationSqlMiInner, DatabaseMigrationSqlMiInner>getLroResult(mono,
            this.client.getHttpPipeline(), DatabaseMigrationSqlMiInner.class, DatabaseMigrationSqlMiInner.class,
            context);
    }
    ...
    public SyncPoller<PollResult<DatabaseMigrationSqlMiInner>, DatabaseMigrationSqlMiInner> beginCreateOrUpdate(
        String resourceGroupName, String managedInstanceName, String targetDbName,
        DatabaseMigrationSqlMiInner parameters) {
        return this.beginCreateOrUpdateAsync(resourceGroupName, managedInstanceName, targetDbName, parameters)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<DatabaseMigrationSqlMiInner>, DatabaseMigrationSqlMiInner> beginCreateOrUpdate(
        String resourceGroupName, String managedInstanceName, String targetDbName,
        DatabaseMigrationSqlMiInner parameters, Context context) {
        return this.beginCreateOrUpdateAsync(resourceGroupName, managedInstanceName, targetDbName, parameters, context)
            .getSyncPoller();
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> cancelWithResponseAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(context -> service.cancel(this.client.getEndpoint(), resourceGroupName, managedInstanceName,
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> cancelWithResponseAsync(String resourceGroupName,
        String managedInstanceName, String targetDbName, MigrationOperationInput parameters, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        context = this.client.mergeContext(context);
        return service.cancel(this.client.getEndpoint(), resourceGroupName, managedInstanceName, targetDbName,
    ...
    public SyncPoller<PollResult<Void>, Void> beginCancel(String resourceGroupName, String managedInstanceName,
        String targetDbName, MigrationOperationInput parameters) {
        return this.beginCancelAsync(resourceGroupName, managedInstanceName, targetDbName, parameters).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginCancel(String resourceGroupName, String managedInstanceName,
        String targetDbName, MigrationOperationInput parameters, Context context) {
        return this.beginCancelAsync(resourceGroupName, managedInstanceName, targetDbName, parameters, context)
            .getSyncPoller();
    }
    ...
    private Mono<Void> cancelAsync(String resourceGroupName, String managedInstanceName, String targetDbName,
        ...
        return beginCancelAsync(resourceGroupName, managedInstanceName, targetDbName, parameters, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> cutoverWithResponseAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(context -> service.cutover(this.client.getEndpoint(), resourceGroupName, managedInstanceName,
                targetDbName, this.client.getSubscriptionId(), this.client.getApiVersion(), parameters, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> cutoverWithResponseAsync(String resourceGroupName,
        ...
        context = this.client.mergeContext(context);
        return service.cutover(this.client.getEndpoint(), resourceGroupName, managedInstanceName, targetDbName,
            this.client.getSubscriptionId(), this.client.getApiVersion(), parameters, context);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginCutover(String resourceGroupName, String managedInstanceName,
        String targetDbName, MigrationOperationInput parameters) {
        return this.beginCutoverAsync(resourceGroupName, managedInstanceName, targetDbName, parameters).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginCutover(String resourceGroupName, String managedInstanceName,
        String targetDbName, MigrationOperationInput parameters, Context context) {
        return this.beginCutoverAsync(resourceGroupName, managedInstanceName, targetDbName, parameters, context)
            .getSyncPoller();
    }
    ...
    private Mono<Void> cutoverAsync(String resourceGroupName, String managedInstanceName, String targetDbName,
        MigrationOperationInput parameters, Context context) {
        return beginCutoverAsync(resourceGroupName, managedInstanceName, targetDbName, parameters, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
