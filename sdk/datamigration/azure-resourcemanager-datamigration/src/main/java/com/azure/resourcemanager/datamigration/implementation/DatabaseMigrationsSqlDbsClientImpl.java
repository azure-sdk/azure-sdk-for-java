...
public final class DatabaseMigrationsSqlDbsClientImpl implements DatabaseMigrationsSqlDbsClient {
    ...
    public interface DatabaseMigrationsSqlDbsService {
        ...
        @Post(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers"
                + "/{sqlDbInstanceName}/providers/Microsoft.DataMigration/databaseMigrations/{targetDbName}/retry")
        @ExpectedResponses({202})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<DatabaseMigrationSqlDbInner>> retry(
            @HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("sqlDbInstanceName") String sqlDbInstanceName,
            @PathParam("targetDbName") String targetDbName,
    ...
    public DatabaseMigrationSqlDbInner get(String resourceGroupName, String sqlDbInstanceName, String targetDbName) {
        ...
        return getWithResponse(
                resourceGroupName, sqlDbInstanceName, targetDbName, migrationOperationId, expand, Context.NONE)
            .getValue();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<DatabaseMigrationSqlDbInner>> retryWithResponseAsync(
        String resourceGroupName,
        String sqlDbInstanceName,
        String targetDbName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DatabaseMigrationSqlDbInner> retryAsync(
        String resourceGroupName,
        String sqlDbInstanceName,
        String targetDbName,
        MigrationOperationInput migrationOperationInput) {
        return retryWithResponseAsync(resourceGroupName, sqlDbInstanceName, targetDbName, migrationOperationInput)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<DatabaseMigrationSqlDbInner> retryWithResponse(
        String resourceGroupName,
        String sqlDbInstanceName,
        String targetDbName,
        MigrationOperationInput migrationOperationInput,
        Context context) {
        return retryWithResponseAsync(
                resourceGroupName, sqlDbInstanceName, targetDbName, migrationOperationInput, context)
            .block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public DatabaseMigrationSqlDbInner retry(
        String resourceGroupName,
        String sqlDbInstanceName,
        String targetDbName,
        MigrationOperationInput migrationOperationInput) {
        return retryWithResponse(
                resourceGroupName, sqlDbInstanceName, targetDbName, migrationOperationInput, Context.NONE)
            .getValue();
    }
}
