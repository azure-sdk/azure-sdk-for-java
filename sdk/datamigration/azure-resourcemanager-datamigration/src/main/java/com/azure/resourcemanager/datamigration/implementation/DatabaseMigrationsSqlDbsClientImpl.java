...
public final class DatabaseMigrationsSqlDbsClientImpl implements DatabaseMigrationsSqlDbsClient {
    ...
    public SyncPoller<PollResult<DatabaseMigrationSqlDbInner>, DatabaseMigrationSqlDbInner> beginCreateOrUpdate(
        ...
        DatabaseMigrationSqlDbInner parameters) {
        return this
            .beginCreateOrUpdateAsync(resourceGroupName, sqlDbInstanceName, targetDbName, parameters)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<DatabaseMigrationSqlDbInner>, DatabaseMigrationSqlDbInner> beginCreateOrUpdate(
        ...
        Context context) {
        return this
            .beginCreateOrUpdateAsync(resourceGroupName, sqlDbInstanceName, targetDbName, parameters, context)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(
        String resourceGroupName, String sqlDbInstanceName, String targetDbName, Boolean force, Context context) {
        return this
            .beginDeleteAsync(resourceGroupName, sqlDbInstanceName, targetDbName, force, context)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginCancel(
        ...
        Context context) {
        return this
            .beginCancelAsync(resourceGroupName, sqlDbInstanceName, targetDbName, parameters, context)
            .getSyncPoller();
    }
