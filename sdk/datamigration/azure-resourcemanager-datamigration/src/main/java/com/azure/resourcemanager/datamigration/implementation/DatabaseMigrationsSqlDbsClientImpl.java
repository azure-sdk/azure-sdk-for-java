...
public final class DatabaseMigrationsSqlDbsClientImpl implements DatabaseMigrationsSqlDbsClient {
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<DatabaseMigrationSqlDbInner>> getWithResponseAsync(String resourceGroupName,
        String sqlDbInstanceName, String targetDbName, UUID migrationOperationId, String expand, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service.get(this.client.getEndpoint(), resourceGroupName, sqlDbInstanceName, targetDbName,
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String resourceGroupName,
        String sqlDbInstanceName, String targetDbName, DatabaseMigrationSqlDbInner parameters, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.createOrUpdate(this.client.getEndpoint(), resourceGroupName, sqlDbInstanceName, targetDbName,
    ...
    public SyncPoller<PollResult<DatabaseMigrationSqlDbInner>, DatabaseMigrationSqlDbInner> beginCreateOrUpdate(
        String resourceGroupName, String sqlDbInstanceName, String targetDbName,
        DatabaseMigrationSqlDbInner parameters) {
        return this.beginCreateOrUpdateAsync(resourceGroupName, sqlDbInstanceName, targetDbName, parameters)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<DatabaseMigrationSqlDbInner>, DatabaseMigrationSqlDbInner> beginCreateOrUpdate(
        String resourceGroupName, String sqlDbInstanceName, String targetDbName, DatabaseMigrationSqlDbInner parameters,
        Context context) {
        return this.beginCreateOrUpdateAsync(resourceGroupName, sqlDbInstanceName, targetDbName, parameters, context)
            .getSyncPoller();
    }
    ...
    private Mono<DatabaseMigrationSqlDbInner> createOrUpdateAsync(String resourceGroupName, String sqlDbInstanceName,
        ...
        return beginCreateOrUpdateAsync(resourceGroupName, sqlDbInstanceName, targetDbName, parameters, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> deleteWithResponseAsync(String resourceGroupName, String sqlDbInstanceName,
        ...
        context = this.client.mergeContext(context);
        return service.delete(this.client.getEndpoint(), resourceGroupName, sqlDbInstanceName, targetDbName, force,
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String sqlDbInstanceName,
        String targetDbName) {
        final Boolean force = null;
        return this.beginDeleteAsync(resourceGroupName, sqlDbInstanceName, targetDbName, force).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String sqlDbInstanceName,
        String targetDbName, Boolean force, Context context) {
        return this.beginDeleteAsync(resourceGroupName, sqlDbInstanceName, targetDbName, force, context)
            .getSyncPoller();
    }
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String sqlDbInstanceName, String targetDbName,
        ...
        return beginDeleteAsync(resourceGroupName, sqlDbInstanceName, targetDbName, force, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> cancelWithResponseAsync(String resourceGroupName, String sqlDbInstanceName,
        ...
        context = this.client.mergeContext(context);
        return service.cancel(this.client.getEndpoint(), resourceGroupName, sqlDbInstanceName, targetDbName,
    ...
    public SyncPoller<PollResult<Void>, Void> beginCancel(String resourceGroupName, String sqlDbInstanceName,
        String targetDbName, MigrationOperationInput parameters) {
        return this.beginCancelAsync(resourceGroupName, sqlDbInstanceName, targetDbName, parameters).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginCancel(String resourceGroupName, String sqlDbInstanceName,
        String targetDbName, MigrationOperationInput parameters, Context context) {
        return this.beginCancelAsync(resourceGroupName, sqlDbInstanceName, targetDbName, parameters, context)
            .getSyncPoller();
    }
    ...
    private Mono<Void> cancelAsync(String resourceGroupName, String sqlDbInstanceName, String targetDbName,
        ...
        return beginCancelAsync(resourceGroupName, sqlDbInstanceName, targetDbName, parameters, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
