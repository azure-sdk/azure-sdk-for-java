...
public final class DatabaseMigrationSqlMiImpl
    ...
    public DatabaseMigrationSqlMi create() {
        this.innerObject = serviceManager.serviceClient().getDatabaseMigrationsSqlMis()
    ...
    public DatabaseMigrationSqlMi refresh() {
        ...
        this.innerObject
            = serviceManager.serviceClient().getDatabaseMigrationsSqlMis().getWithResponse(resourceGroupName,
                managedInstanceName, targetDbName, localMigrationOperationId, localExpand, Context.NONE).getValue();
        return this;
    }
    ...
    public DatabaseMigrationSqlMi refresh(Context context) {
        ...
        this.innerObject
            = serviceManager.serviceClient().getDatabaseMigrationsSqlMis().getWithResponse(resourceGroupName,
                managedInstanceName, targetDbName, localMigrationOperationId, localExpand, context).getValue();
        return this;
    }

    public void cancel(MigrationOperationInput parameters) {
        serviceManager.databaseMigrationsSqlMis().cancel(resourceGroupName, managedInstanceName, targetDbName,
            parameters);
    }
    ...
    public void cutover(MigrationOperationInput parameters) {
        serviceManager.databaseMigrationsSqlMis().cutover(resourceGroupName, managedInstanceName, targetDbName,
            parameters);
    }
