...
```java
import com.azure.resourcemanager.communitytraining.models.AzureResourceManagerCommonTypesSkuUpdate;
...
public final class CommunityTrainingsUpdateSamples {
    ...
    public static void
        ...
        resource.update()
            .withTags(mapOf())
            .withSku(new AzureResourceManagerCommonTypesSkuUpdate().withName("Commercial").withTier(SkuTier.STANDARD))
