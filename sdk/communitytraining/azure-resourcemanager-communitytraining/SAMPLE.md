...
```java
import com.azure.resourcemanager.communitytraining.models.AzureResourceManagerCommonTypesSku;
...
public final class CommunityTrainingsUpdateSamples {
    ...
    public static void
        ...
        resource.update()
            .withTags(mapOf())
            .withSku(new AzureResourceManagerCommonTypesSku().withName("Commercial").withTier(SkuTier.STANDARD))
