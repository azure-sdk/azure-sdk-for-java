...
public final class CommunityTrainingImpl
    ...
    CommunityTrainingImpl(CommunityTrainingInner innerObject,
        ...
        this.communityTrainingName = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "communityTrainings");
    }
    ...
    public CommunityTrainingImpl withSku(AzureResourceManagerCommonTypesSkuUpdate sku) {
