...
public final class CommunityTrainingsImpl implements CommunityTrainings {
    ...
    public PagedIterable<CommunityTraining> list() {
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new CommunityTrainingImpl(inner1, this.manager()));
    }
    ...
    public Response<CommunityTraining> getByResourceGroupWithResponse(String resourceGroupName,
    ...
    public CommunityTraining getById(String id) {
        ...
        String communityTrainingName = ResourceManagerUtils.getValueFromIdByName(id, "communityTrainings");
