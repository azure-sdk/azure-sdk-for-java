...
/**
 * Initializes a new instance of the MicrosoftCommunityForTestingImpl type.
 */
@ServiceClient(builder = MicrosoftCommunityForTestingBuilder.class)
public final class MicrosoftCommunityForTestingImpl implements MicrosoftCommunityForTesting {
    /**
    ...
    /**
     * Initializes an instance of MicrosoftCommunityForTesting client.
     * 
     ...
     */
    MicrosoftCommunityForTestingImpl(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter,
    ...
    private static final ClientLogger LOGGER = new ClientLogger(MicrosoftCommunityForTestingImpl.class);
}
