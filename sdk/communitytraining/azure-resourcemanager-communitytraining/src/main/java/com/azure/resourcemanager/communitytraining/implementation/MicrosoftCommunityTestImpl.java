...
/**
 * Initializes a new instance of the MicrosoftCommunityTestImpl type.
 */
@ServiceClient(builder = MicrosoftCommunityTestBuilder.class)
public final class MicrosoftCommunityTestImpl implements MicrosoftCommunityTest {
    /**
    ...
    /**
     * Initializes an instance of MicrosoftCommunityTest client.
     * 
     ...
     */
    MicrosoftCommunityTestImpl(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter,
    ...
    private static final ClientLogger LOGGER = new ClientLogger(MicrosoftCommunityTestImpl.class);
}
