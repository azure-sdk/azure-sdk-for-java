 ...
 */
@Fluent
public final class IdentityConfigurationProperties implements JsonSerializable<IdentityConfigurationProperties> {
    /*
    ...
    /**
     * Reads an instance of IdentityConfigurationProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of IdentityConfigurationProperties if the JsonReader was pointing to an instance of it, or
     * null if it was pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the IdentityConfigurationProperties.
     */
    public static IdentityConfigurationProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            IdentityConfigurationProperties deserializedIdentityConfigurationProperties
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("identityType".equals(fieldName)) {
                    deserializedIdentityConfigurationProperties.identityType = reader.getString();
                } else if ("tenantId".equals(fieldName)) {
                    deserializedIdentityConfigurationProperties.tenantId = reader.getString();
                } else if ("domainName".equals(fieldName)) {
                    deserializedIdentityConfigurationProperties.domainName = reader.getString();
                } else if ("clientId".equals(fieldName)) {
                    deserializedIdentityConfigurationProperties.clientId = reader.getString();
                } else if ("clientSecret".equals(fieldName)) {
                    deserializedIdentityConfigurationProperties.clientSecret = reader.getString();
                } else if ("teamsEnabled".equals(fieldName)) {
                    deserializedIdentityConfigurationProperties.teamsEnabled
                        = reader.getNullable(JsonReader::getBoolean);
                } else if ("b2cAuthenticationPolicy".equals(fieldName)) {
                    deserializedIdentityConfigurationProperties.b2CAuthenticationPolicy = reader.getString();
                } else if ("b2cPasswordResetPolicy".equals(fieldName)) {
                    deserializedIdentityConfigurationProperties.b2CPasswordResetPolicy = reader.getString();
                } else if ("customLoginParameters".equals(fieldName)) {
                    deserializedIdentityConfigurationProperties.customLoginParameters = reader.getString();
                } else {
                    reader.skipChildren();
                }
            }

            return deserializedIdentityConfigurationProperties;
        });
    }
}
