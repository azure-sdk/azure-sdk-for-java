...
public interface CommunityTrainingsClient {
    ...
    Response<CommunityTrainingInner> getByResourceGroupWithResponse(String resourceGroupName,
    ...
    SyncPoller<PollResult<CommunityTrainingInner>, CommunityTrainingInner> beginCreate(String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<CommunityTrainingInner>, CommunityTrainingInner> beginUpdate(String resourceGroupName,
