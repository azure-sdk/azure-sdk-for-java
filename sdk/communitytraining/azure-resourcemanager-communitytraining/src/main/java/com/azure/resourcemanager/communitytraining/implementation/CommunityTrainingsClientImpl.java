...
public final class CommunityTrainingsClientImpl implements CommunityTrainingsClient {
     ...
     */
    private final MicrosoftCommunityTestImpl client;
     ...
     */
    CommunityTrainingsClientImpl(MicrosoftCommunityTestImpl client) {
    ...
    /**
     * The interface defining all the services for MicrosoftCommunityTestCommunityTrainings to be used by the proxy
     * service to perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "MicrosoftCommunityTe")
