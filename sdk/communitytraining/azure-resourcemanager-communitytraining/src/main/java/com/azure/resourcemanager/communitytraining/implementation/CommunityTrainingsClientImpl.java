...
public final class CommunityTrainingsClientImpl implements CommunityTrainingsClient {
     ...
     */
    private final MicrosoftCommunityForTestingImpl client;
     ...
     */
    CommunityTrainingsClientImpl(MicrosoftCommunityForTestingImpl client) {
    ...
    /**
     * The interface defining all the services for MicrosoftCommunityForTestingCommunityTrainings to be used by the
     * proxy service to perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "MicrosoftCommunityFo")
    public interface CommunityTrainingsService {
        ...
        Mono<Response<CommunityTrainingListResult>> list(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<CommunityTrainingListResult>> listByResourceGroup(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<CommunityTrainingInner>> getByResourceGroup(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
    ...
    private Mono<PagedResponse<CommunityTrainingInner>> listSinglePageAsync() {
        ...
        return FluxUtil
            ...
            .<PagedResponse<CommunityTrainingInner>>map(res -> new PagedResponseBase<>(res.getRequest(),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<CommunityTrainingInner>> getByResourceGroupWithResponseAsync(String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<CommunityTrainingInner> getByResourceGroupAsync(String resourceGroupName,
        String communityTrainingName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<CommunityTrainingInner> getByResourceGroupWithResponse(String resourceGroupName,
        String communityTrainingName, Context context) {
    ...
    private PollerFlux<PollResult<CommunityTrainingInner>, CommunityTrainingInner>
        ...
        return this.client.<CommunityTrainingInner, CommunityTrainingInner>getLroResult(mono,
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<CommunityTrainingInner>, CommunityTrainingInner> beginCreate(String resourceGroupName,
        String communityTrainingName, CommunityTrainingInner resource) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<CommunityTrainingInner> createAsync(String resourceGroupName, String communityTrainingName,
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<CommunityTrainingInner>, CommunityTrainingInner> beginUpdate(String resourceGroupName,
        String communityTrainingName, CommunityTrainingUpdate properties) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<CommunityTrainingInner> updateAsync(String resourceGroupName, String communityTrainingName,
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<Void>, Void> beginDeleteAsync(String resourceGroupName, String communityTrainingName,
        Context context) {
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono
