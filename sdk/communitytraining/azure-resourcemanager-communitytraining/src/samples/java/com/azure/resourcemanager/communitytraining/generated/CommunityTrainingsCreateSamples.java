...
public final class CommunityTrainingsCreateSamples {
    ...
    public static void
        ...
        manager.communityTrainings().define("ctApplication").withRegion("southeastasia")
            ...
            .withSku(new Sku().withName("Commercial").withTier(SkuTier.STANDARD)).withPortalName("ctwebsite")
            ...
            .withIdentityConfiguration(new IdentityConfigurationProperties().withIdentityType("ADB2C")
                .withTeamsEnabled(false).withTenantId("c1ffbb60-88cf-4b83-b54f-c47ae6220c19").withDomainName("cttenant")
                .withClientId("8c92390f-2f30-493d-bd13-d3c3eba3709d").withClientSecret("fakeTokenPlaceholder")
                .withB2CAuthenticationPolicy("B2C_1_signup_signin").withB2CPasswordResetPolicy("fakeTokenPlaceholder")
                .withCustomLoginParameters("custom_hint"))
            .withZoneRedundancyEnabled(true).withDisasterRecoveryEnabled(true).create();
    }
}
