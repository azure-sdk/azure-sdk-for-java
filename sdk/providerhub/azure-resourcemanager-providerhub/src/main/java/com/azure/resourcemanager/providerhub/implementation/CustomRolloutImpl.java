...
public final class CustomRolloutImpl implements CustomRollout, CustomRollout.Definition, CustomRollout.Update {
    ...
    public CustomRollout create() {
        this.innerObject = serviceManager.serviceClient().getCustomRollouts()
            .createOrUpdateWithResponse(providerNamespace, rolloutName, this.innerModel(), Context.NONE).getValue();
        return this;
    }

    public CustomRollout create(Context context) {
        this.innerObject = serviceManager.serviceClient().getCustomRollouts()
            .createOrUpdateWithResponse(providerNamespace, rolloutName, this.innerModel(), context).getValue();
        return this;
    }
    ...
    public CustomRollout refresh() {
        this.innerObject = serviceManager.serviceClient().getCustomRollouts()
            .getWithResponse(providerNamespace, rolloutName, Context.NONE).getValue();
        return this;
    }

    public CustomRollout refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getCustomRollouts()
            .getWithResponse(providerNamespace, rolloutName, context).getValue();
        return this;
    }
