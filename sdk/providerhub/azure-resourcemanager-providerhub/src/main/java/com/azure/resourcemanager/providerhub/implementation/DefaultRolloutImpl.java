...
public final class DefaultRolloutImpl implements DefaultRollout, DefaultRollout.Definition, DefaultRollout.Update {
    ...
    public DefaultRollout create() {
        this.innerObject = serviceManager.serviceClient().getDefaultRollouts().createOrUpdate(providerNamespace,
            rolloutName, this.innerModel(), Context.NONE);
        return this;
    }

    public DefaultRollout create(Context context) {
        this.innerObject = serviceManager.serviceClient().getDefaultRollouts().createOrUpdate(providerNamespace,
            rolloutName, this.innerModel(), context);
        return this;
    }
    ...
    public DefaultRollout refresh() {
        this.innerObject = serviceManager.serviceClient().getDefaultRollouts()
