...
public final class ResourceTypeRegistrationImpl
    ...
    public ResourceTypeRegistration create() {
        this.innerObject = serviceManager.serviceClient().getResourceTypeRegistrations()
    ...
    public ResourceTypeRegistration refresh() {
        this.innerObject = serviceManager.serviceClient().getResourceTypeRegistrations()
            .getWithResponse(providerNamespace, resourceType, Context.NONE).getValue();
        return this;
    }

    public ResourceTypeRegistration refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getResourceTypeRegistrations()
            .getWithResponse(providerNamespace, resourceType, context).getValue();
        return this;
    }
