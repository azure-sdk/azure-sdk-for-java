...
public final class OperationsClientImpl implements OperationsClient {
    ...
    /**
     * The interface defining all the services for ProviderHubOperations to be used by the proxy service to perform
     * REST calls.
     */
    @Host("{$host}")
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<List<OperationsDefinitionInner>>>
        listByProviderRegistrationWithResponseAsync(String providerNamespace, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.listByProviderRegistration(this.client.getEndpoint(), this.client.getSubscriptionId(),
