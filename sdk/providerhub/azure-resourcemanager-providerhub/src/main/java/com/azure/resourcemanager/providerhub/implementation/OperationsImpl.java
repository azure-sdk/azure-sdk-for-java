    ...
    public Response<List<OperationsDefinition>> listByProviderRegistrationWithResponse(String providerNamespace,
        ...
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
                inner.getValue().stream().map(inner1 -> new OperationsDefinitionImpl(inner1, this.manager()))
    ...
    public List<OperationsDefinition> listByProviderRegistration(String providerNamespace) {
        ...
        if (inner != null) {
            return Collections.unmodifiableList(inner.stream()
                .map(inner1 -> new OperationsDefinitionImpl(inner1, this.manager())).collect(Collectors.toList()));
        } else {
