...
public interface DetachTrafficFiltersClient {
    ...
    SyncPoller<PollResult<Void>, Void> beginUpdate(String resourceGroupName, String monitorName, String rulesetId);
    ...
    void update(String resourceGroupName, String monitorName, String rulesetId);
