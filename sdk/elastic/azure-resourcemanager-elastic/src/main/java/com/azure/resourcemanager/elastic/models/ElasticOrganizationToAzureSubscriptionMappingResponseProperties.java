...
public final class ElasticOrganizationToAzureSubscriptionMappingResponseProperties {
    /*
     * The Azure Subscription ID to which the Organization belongs and gets billed into. This is empty for a new user
     * OR a user without an Elastic Organization.
     */
     ...
     */
    @JsonProperty(value = "elasticOrganizationId")
    private String elasticOrganizationId;

    /*
     * The Elastic Organization Name.
     */
    @JsonProperty(value = "elasticOrganizationName")
     ...
     */
    public ElasticOrganizationToAzureSubscriptionMappingResponseProperties withBilledAzureSubscriptionId(
     ...
     * @return the ElasticOrganizationToAzureSubscriptionMappingResponseProperties object itself.
     */
    public ElasticOrganizationToAzureSubscriptionMappingResponseProperties withElasticOrganizationId(
     ...
     * @return the ElasticOrganizationToAzureSubscriptionMappingResponseProperties object itself.
     */
    public ElasticOrganizationToAzureSubscriptionMappingResponseProperties withElasticOrganizationName(
