...
public final class MonitoredResourcesClientImpl implements MonitoredResourcesClient {
    ...
    /**
     * The interface defining all the services for MicrosoftElasticMonitoredResources to be used by the proxy service
    ...
    public interface MonitoredResourcesService {
        ...
        Mono<Response<MonitoredResourceListResponse>> list(@HostParam("$host") String endpoint,
