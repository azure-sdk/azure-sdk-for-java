...
public final class BillingInfoesClientImpl implements BillingInfoesClient {
     ...
     */
    BillingInfoesClientImpl(MicrosoftElasticImpl client) {
        this.service =
    ...
    /**
     * The interface defining all the services for MicrosoftElasticBillingInfoes to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "MicrosoftElasticBill")
    public interface BillingInfoesService {
        ...
        Mono<Response<BillingInfoResponseInner>> get(
    ...
    private Mono<Response<BillingInfoResponseInner>> getWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<BillingInfoResponseInner> getWithResponse(
        String resourceGroupName, String monitorName, Context context) {
