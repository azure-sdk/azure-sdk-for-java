...
public final class ConnectedPartnerResourcesClientImpl implements ConnectedPartnerResourcesClient {
     ...
     */
    ConnectedPartnerResourcesClientImpl(MicrosoftElasticImpl client) {
        this.service =
            RestProxy
                .create(
                    ConnectedPartnerResourcesService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for MicrosoftElasticConnectedPartnerResources to be used by the proxy
     * service to perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "MicrosoftElasticConn")
    public interface ConnectedPartnerResourcesService {
        ...
        Mono<Response<ConnectedPartnerResourcesListResponse>> list(
    ...
    private Mono<PagedResponse<ConnectedPartnerResourcesListFormatInner>> listSinglePageAsync(
    ...
    private PagedFlux<ConnectedPartnerResourcesListFormatInner> listAsync(
        String resourceGroupName, String monitorName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<ConnectedPartnerResourcesListFormatInner> list(
        String resourceGroupName, String monitorName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<ConnectedPartnerResourcesListFormatInner>> listNextSinglePageAsync(
