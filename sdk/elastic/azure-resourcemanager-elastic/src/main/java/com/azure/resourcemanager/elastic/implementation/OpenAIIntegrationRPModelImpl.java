...
public final class OpenAIIntegrationRPModelImpl
    ...
    public OpenAIIntegrationRPModel create() {
        this.innerObject = serviceManager.serviceClient().getOpenAIs().createOrUpdateWithResponse(resourceGroupName,
            monitorName, integrationName, this.innerModel(), Context.NONE).getValue();
        return this;
    }

    public OpenAIIntegrationRPModel create(Context context) {
        this.innerObject = serviceManager.serviceClient().getOpenAIs()
    ...
    public OpenAIIntegrationRPModel refresh() {
        this.innerObject = serviceManager.serviceClient().getOpenAIs()
            .getWithResponse(resourceGroupName, monitorName, integrationName, Context.NONE).getValue();
        return this;
    }

    public OpenAIIntegrationRPModel refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getOpenAIs()
            .getWithResponse(resourceGroupName, monitorName, integrationName, context).getValue();
        return this;
    }
