...
public interface DetachAndDeleteTrafficFiltersClient {
    ...
    SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String monitorName, String rulesetId);
    ...
    void delete(String resourceGroupName, String monitorName, String rulesetId);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    void delete(String resourceGroupName, String monitorName, String rulesetId, Context context);
}
