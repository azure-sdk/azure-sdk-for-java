...
public final class OpenAIIntegrationProperties {
     ...
     */
    @JsonProperty(value = "openAIResourceId", access = JsonProperty.Access.WRITE_ONLY)
    private String openAIResourceId;

    /*
     * The API endpoint for Open AI resource
     */
    @JsonProperty(value = "openAIResourceEndpoint", access = JsonProperty.Access.WRITE_ONLY)
