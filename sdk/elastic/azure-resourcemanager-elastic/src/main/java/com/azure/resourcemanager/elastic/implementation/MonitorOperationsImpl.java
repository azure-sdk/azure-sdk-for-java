...
public final class MonitorOperationsImpl implements MonitorOperations {
    ...
    public void upgrade(String resourceGroupName, String monitorName, ElasticMonitorUpgrade body) {
        this.serviceClient().upgrade(resourceGroupName, monitorName, body);
    }
