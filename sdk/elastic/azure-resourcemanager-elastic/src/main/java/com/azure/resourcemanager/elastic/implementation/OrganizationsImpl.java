...
public final class OrganizationsImpl implements Organizations {
    ...
    public ResubscribeResponse resubscribe(String resourceGroupName, String monitorName) {
        ResubscribeResponseInner inner = this.serviceClient().resubscribe(resourceGroupName, monitorName);
        if (inner != null) {
            return new ResubscribeResponseImpl(inner, this.manager());
        } else {
            return null;
        }
    }

    public ResubscribeResponse resubscribe(String resourceGroupName, String monitorName, ResubscribeProperties body,
        Context context) {
        ResubscribeResponseInner inner
