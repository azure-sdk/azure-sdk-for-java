...
public final class OrganizationsClientImpl implements OrganizationsClient {
    ...
    private PollerFlux<PollResult<Void>, Void> beginResubscribeAsync(String resourceGroupName, String monitorName,
        ResubscribeProperties body) {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<Void>, Void> beginResubscribe(String resourceGroupName, String monitorName) {
        final ResubscribeProperties body = null;
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> resubscribeAsync(String resourceGroupName, String monitorName, ResubscribeProperties body) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> resubscribeAsync(String resourceGroupName, String monitorName) {
        final ResubscribeProperties body = null;
        return beginResubscribeAsync(resourceGroupName, monitorName, body).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    public void resubscribe(String resourceGroupName, String monitorName) {
        final ResubscribeProperties body = null;
        resubscribeAsync(resourceGroupName, monitorName, body).block();
    }
    ...
    public void resubscribe(String resourceGroupName, String monitorName, ResubscribeProperties body, Context context) {
        resubscribeAsync(resourceGroupName, monitorName, body, context).block();
    }
}
