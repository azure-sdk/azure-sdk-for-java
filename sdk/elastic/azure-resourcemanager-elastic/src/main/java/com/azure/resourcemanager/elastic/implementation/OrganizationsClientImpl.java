...
public final class OrganizationsClientImpl implements OrganizationsClient {
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the properties of Resubscribe response object along with {@link Response} on successful completion of
     * {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the {@link PollerFlux} for polling of the properties of Resubscribe response object.
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<ResubscribeResponseInner>, ResubscribeResponseInner>
        ...
        return this.client.<ResubscribeResponseInner, ResubscribeResponseInner>getLroResult(mono,
            this.client.getHttpPipeline(), ResubscribeResponseInner.class, ResubscribeResponseInner.class,
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<ResubscribeResponseInner>, ResubscribeResponseInner> beginResubscribeAsync(
        ...
        return this.client.<ResubscribeResponseInner, ResubscribeResponseInner>getLroResult(mono,
            this.client.getHttpPipeline(), ResubscribeResponseInner.class, ResubscribeResponseInner.class, context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the {@link SyncPoller} for polling of the properties of Resubscribe response object.
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<ResubscribeResponseInner>, ResubscribeResponseInner>
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the properties of Resubscribe response object on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ResubscribeResponseInner> resubscribeAsync(String resourceGroupName, String monitorName,
        ResubscribeProperties body) {
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the properties of Resubscribe response object.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ResubscribeResponseInner resubscribe(String resourceGroupName, String monitorName) {
        final ResubscribeProperties body = null;
