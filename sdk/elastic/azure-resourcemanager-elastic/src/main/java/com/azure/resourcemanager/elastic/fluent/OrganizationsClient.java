...
public interface OrganizationsClient {
    ...
    SyncPoller<PollResult<ResubscribeResponseInner>, ResubscribeResponseInner>
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ResubscribeResponseInner resubscribe(String resourceGroupName, String monitorName);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ResubscribeResponseInner resubscribe(String resourceGroupName, String monitorName, ResubscribeProperties body,
        Context context);
}
