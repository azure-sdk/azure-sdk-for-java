...
public final class BillingInfoesImpl implements BillingInfoes {
    ...
    public BillingInfoesImpl(
        BillingInfoesClient innerClient, com.azure.resourcemanager.elastic.ElasticManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public Response<BillingInfoResponse> getWithResponse(
