...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    OperationsClientImpl(ElasticManagementClientImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for ElasticManagementClientOperations to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{$host}")
    ...
    private Mono<PagedResponse<OperationAutoGeneratedInner>> listSinglePageAsync() {
        ...
        return FluxUtil
            ...
            .<PagedResponse<OperationAutoGeneratedInner>>map(res -> new PagedResponseBase<>(res.getRequest(),
