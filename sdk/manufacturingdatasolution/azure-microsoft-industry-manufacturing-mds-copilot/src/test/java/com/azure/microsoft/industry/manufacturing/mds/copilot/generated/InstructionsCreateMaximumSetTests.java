...
@Disabled
public final class InstructionsCreateMaximumSetTests extends CopilotServiceClientTestBase {
    @Test
    @Disabled
    public void testInstructionsCreateMaximumSetTests() {
        // method invocation
        SyncPoller<OperationResultQuery, Instruction> response
            = setPlaybackSyncPollerPollInterval(instructionsInstructionsClient
