...
@Disabled
public final class InstructionsCreateOrReplaceMaximumSetGeneratedByMaximumSetRuleGeneratedByMinimumSetRuleTests
    extends CopilotServiceClientTestBase {
    @Test
    @Disabled
    public void testInstructionsCreateOrReplaceMaximumSetGeneratedByMaximumSetRuleGeneratedByMinimumSetRuleTests() {
        // method invocation
        SyncPoller<OperationResponse, Instruction> response
            = setPlaybackSyncPollerPollInterval(
                instructionsInstructionsClient
                    .beginCreateOrReplace("rikqzdlzbu",
