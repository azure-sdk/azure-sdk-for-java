...
@Disabled
public final class InstructionsCreateOrReplaceMaximumSetTests extends CopilotServiceClientTestBase {
    @Test
    @Disabled
    public void testInstructionsCreateOrReplaceMaximumSetTests() {
        // method invocation
        SyncPoller<OperationResultQuery, Instruction> response
            = setPlaybackSyncPollerPollInterval(instructionsInstructionsClient.beginCreateOrReplace("gvkwsyskqknrjpqs",
