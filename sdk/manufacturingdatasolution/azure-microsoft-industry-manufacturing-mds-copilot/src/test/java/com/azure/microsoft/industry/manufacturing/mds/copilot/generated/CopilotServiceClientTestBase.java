...
class CopilotServiceClientTestBase extends TestProxyTestBase {
    protected QueryServiceQueryApiClient queryServiceQueryApiClient;
    ...
    protected void beforeTest() {
        CopilotServiceClientBuilder queryServiceQueryApiClientbuilder = new CopilotServiceClientBuilder()
        ...
        if (getTestMode() == TestMode.PLAYBACK) {
            queryServiceQueryApiClientbuilder.credential(new MockTokenCredential());
        } else if (getTestMode() == TestMode.RECORD) {
            queryServiceQueryApiClientbuilder.addPolicy(interceptorManager.getRecordPolicy())
                .credential(new DefaultAzureCredentialBuilder().build());
        } else if (getTestMode() == TestMode.LIVE) {
            queryServiceQueryApiClientbuilder.credential(new DefaultAzureCredentialBuilder().build());
        }
        queryServiceQueryApiClient = queryServiceQueryApiClientbuilder.buildQueryServiceQueryApiClient();
