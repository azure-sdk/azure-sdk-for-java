...
@Disabled
public final class InstructionsCreateOrReplaceMaximumSetGeneratedByMaximumSetRuleGeneratedByMaximumSetRuleTests
    extends CopilotServiceClientTestBase {
    @Test
    @Disabled
    public void testInstructionsCreateOrReplaceMaximumSetGeneratedByMaximumSetRuleGeneratedByMaximumSetRuleTests() {
        // method invocation
        SyncPoller<OperationResponse, Instruction> response
            = setPlaybackSyncPollerPollInterval(
                instructionsInstructionsClient
                    .beginCreateOrReplace("jxxviglirnyjyuqdjvhgdnpqsmvc",
