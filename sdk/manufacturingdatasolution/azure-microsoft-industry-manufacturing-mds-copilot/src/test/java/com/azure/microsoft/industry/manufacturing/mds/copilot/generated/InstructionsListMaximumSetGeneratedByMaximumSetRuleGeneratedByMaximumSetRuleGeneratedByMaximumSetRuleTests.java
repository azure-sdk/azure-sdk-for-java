...
@Disabled
public final class InstructionsListMaximumSetGeneratedByMaximumSetRuleGeneratedByMaximumSetRuleGeneratedByMaximumSetRuleTests
    extends CopilotServiceClientTestBase {
    @Test
    @Disabled
    public void
        testInstructionsListMaximumSetGeneratedByMaximumSetRuleGeneratedByMaximumSetRuleGeneratedByMaximumSetRuleTests() {
        // method invocation
        PagedIterable<Instruction> response = instructionsInstructionsClient.list(InstructionStatusEnum.ACTIVE);
        ...
        Assertions.assertEquals("qeuspigqkmmsbyolpvvbf", firstItem.getInstructionId());
        // verify property "instructionVersion"
        Assertions.assertEquals("ggsazazuaspjazqphyyiwxphqipk", firstItem.getInstructionVersion());
        ...
        Assertions.assertEquals("ncjziatzbkn", firstItemRetrievalSubTopics.iterator().next());
        List<String> firstItemRetrievalKeywords = firstItemRetrieval.getKeywords();
        Assertions.assertEquals("xwbkjrwd", firstItemRetrievalKeywords.iterator().next());
        List<String> firstItemRetrievalSampleQuestions = firstItemRetrieval.getSampleQuestions();
        Assertions.assertEquals("qmrgzdtouhonzzqjhlunvcmamwyqin", firstItemRetrievalSampleQuestions.iterator().next());
        ...
        Assertions.assertEquals("eazzaethdegqcpgalsjw", firstItemContentSemanticContent.getContext());
        Assertions.assertEquals("bognszjgfpssrwvcwm", firstItemContentSemanticContent.getSteps());
        ...
        Assertions.assertEquals("wkcw", firstItemRelationshipsDependencies.iterator().next());
        List<String> firstItemRelationshipsExclusions = firstItemRelationships.getExclusions();
        Assertions.assertEquals("wlur", firstItemRelationshipsExclusions.iterator().next());
        ...
        Assertions.assertEquals("iaaswzkdcf", firstItemAdministrativeDetails.getSource());
        Assertions.assertEquals("jdsosxpobdbsnvjybsignzvqwx", firstItemAdministrativeDetails.getCreatedBy());
        Assertions.assertEquals("mmgenazkjomsdsxwurs", firstItemAdministrativeDetails.getLastModifiedBy());
        Assertions.assertNotNull(firstItemAdministrativeDetails.getCreatedAt());
        Assertions.assertEquals("cwq", firstItemAdministrativeDetails.getComment());
        // verify property "status"
        Assertions.assertEquals(InstructionStatusEnum.ACTIVE, firstItem.getStatus());
    }
}
