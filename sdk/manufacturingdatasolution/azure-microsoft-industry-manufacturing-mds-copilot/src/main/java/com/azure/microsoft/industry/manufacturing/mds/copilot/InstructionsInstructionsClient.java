...
public final class InstructionsInstructionsClient {
    ...
    public PagedIterable<BinaryData> list(String status, RequestOptions requestOptions) {
        return this.serviceClient.list(status, requestOptions);
    }
    ...
    public Instruction get(String id) {
        ...
        return getWithResponse(id, requestOptions).getValue().toObject(Instruction.class);
    }

    /**
     * List Instruction resources.
     * 
     * @param status Get all active instructions by status.
     * @throws IllegalArgumentException thrown if parameters fail the validation.
     * @throws HttpResponseException thrown if the request is rejected by server.
     * @throws ClientAuthenticationException thrown if the request is rejected by server on status code 401.
     * @throws ResourceNotFoundException thrown if the request is rejected by server on status code 404.
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<Instruction> list(InstructionStatusEnum status) {
        // Generated convenience method for list
        RequestOptions requestOptions = new RequestOptions();
        return serviceClient.list(status.toString(), requestOptions)
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<OperationResponse, Instruction> beginCreateOrReplace(String id, Instruction resource) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<OperationResponse, Void> beginDelete(String id) {
