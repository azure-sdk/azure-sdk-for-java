...
public final class QueryValidationTestCase implements JsonSerializable<QueryValidationTestCase> {
     ...
     */
    @Generated
    public QueryValidationTestCase(Choice skip) {
        this.skip = skip;
    }
    ...
    /**
     * Get the expectedKqlQuery property: The expected kql query for the test case.
     * 
    ...
    /**
     * Set the expectedKqlQuery property: The expected kql query for the test case.
     * 
    ...
    /**
     * Get the skip property: skip the test run.
     * 
     * @return the skip value.
     */
    @Generated
    public Choice getSkip() {
        return this.skip;
    }
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeStringField("skip", this.skip == null ? null : this.skip.toString());
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("skip".equals(fieldName)) {
                    skip = Choice.fromString(reader.getString());
            ...
            QueryValidationTestCase deserializedQueryValidationTestCase = new QueryValidationTestCase(skip);
