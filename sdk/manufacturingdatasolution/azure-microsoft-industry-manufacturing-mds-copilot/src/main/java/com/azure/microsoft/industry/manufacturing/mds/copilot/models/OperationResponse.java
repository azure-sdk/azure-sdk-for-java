...
public final class OperationResponse implements JsonSerializable<OperationResponse> {
     ...
     */
    @Generated
    private OperationResponse(OperationStatusValue status, List<String> errorMessage) {
        this.status = status;
    ...
    public static OperationResponse fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            OperationResponse deserializedOperationResponse = new OperationResponse(status, errorMessage);
            deserializedOperationResponse.operationId = operationId;
