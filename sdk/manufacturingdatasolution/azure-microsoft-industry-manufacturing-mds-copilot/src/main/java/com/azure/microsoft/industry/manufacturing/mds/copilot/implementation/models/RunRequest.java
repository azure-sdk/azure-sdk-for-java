...
public final class RunRequest implements JsonSerializable<RunRequest> {
     ...
     */
    @Generated
    private final Choice runInConversationContext;
     ...
     */
    @Generated
    public RunRequest(List<QueryValidationTestCase> testCases, Choice runInConversationContext) {
     ...
     */
    @Generated
    public Choice getRunInConversationContext() {
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeStringField("runInConversationContext",
            this.runInConversationContext == null ? null : this.runInConversationContext.toString());
    ...
    public static RunRequest fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            Choice runInConversationContext = null;
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("testCases".equals(fieldName)) {
                    ...
                    runInConversationContext = Choice.fromString(reader.getString());
                } else {
                    reader.skipChildren();
                }
            }
