...
public final class GetResponse implements JsonSerializable<GetResponse> {
     ...
     */
    @Generated
    private GetResponse(InstructionLanguageEnum language, RetrievalProperties retrieval, Relationships relationships,
        String comment) {
    ...
    /**
     * Get the comment property: The comment for the instruction.
     * 
    ...
    public static GetResponse fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            GetResponse deserializedGetResponse = new GetResponse(language, retrieval, relationships, comment);
            deserializedGetResponse.id = id;
            deserializedGetResponse.status = status;
            deserializedGetResponse.domain = domain;
            deserializedGetResponse.subDomain = subDomain;
            deserializedGetResponse.category = category;
