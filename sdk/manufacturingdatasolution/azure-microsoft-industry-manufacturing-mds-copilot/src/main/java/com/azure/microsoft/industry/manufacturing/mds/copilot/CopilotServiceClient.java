...
public final class CopilotServiceClient {
    @Generated
    private final CopilotServiceClientImpl serviceClient;

    /**
     * Initializes an instance of CopilotServiceClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    CopilotServiceClient(CopilotServiceClientImpl serviceClient) {
    ...
    public Response<BinaryData> submitFeedbackWithResponse(BinaryData submitFeedbackRequest,
        ...
        return this.serviceClient.submitFeedbackWithResponse(submitFeedbackRequest, requestOptions);
    }
    ...
    public QueryResponse queryExecute(QueryRequest request, String conversationId, String acceptLanguage,
        Integer maxRetry, Choice includeSummary) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public SubmitFeedbackResponse submitFeedback(FeedbackCategory feedback, QueryEndpoint queryEndpoint,
        ...
        return submitFeedbackWithResponse(submitFeedbackRequest, requestOptions).getValue()
            .toObject(SubmitFeedbackResponse.class);
    }
