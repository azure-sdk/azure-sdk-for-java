...
/**
 * An instance of this class provides access to all the operations defined in ValidateQueryApis.
 */
public final class ValidateQueryApisImpl {
    /**
     * The proxy service used to perform REST calls.
     */
    private final ValidateQueryApisService service;
    ...
    /**
     * Initializes an instance of ValidateQueryApisImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    ValidateQueryApisImpl(CopilotServiceClientImpl client) {
        this.service
            = RestProxy.create(ValidateQueryApisService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }
    ...
    /**
     * The interface defining all the services for CopilotServiceClientValidateQueryApis to be used by the proxy service
     * to perform REST calls.
     */
    @Host("https://mds-{mdsUniqueId}.{location}.cloudapp.azure.com/")
    @ServiceInterface(name = "CopilotServiceClient")
    public interface ValidateQueryApisService {
     ...
     *             skip: String(Yes/No) (Required)
     *         }
     *     ]
     *     runInConversationContext: String(Yes/No) (Required)
     * }
     * }
     * </pre>
     * 
