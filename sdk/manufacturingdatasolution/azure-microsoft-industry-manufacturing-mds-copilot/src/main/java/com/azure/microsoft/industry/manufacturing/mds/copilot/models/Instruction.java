...
public final class Instruction implements JsonSerializable<Instruction> {
     ...
     */
    @Generated
    private final InstrustionDomainEnum domain;

    /*
     * Sub-domain for the instruction
     */
    @Generated
    private final InstructionSubDomainEnum subDomain;

    /*
     * Category for the instruction
     */
    @Generated
    private final InstructionCategoryEnum category;
     ...
     */
    @Generated
    public Instruction(String instructionVersion, InstrustionDomainEnum domain, InstructionSubDomainEnum subDomain,
        InstructionCategoryEnum category, InstructionLanguageEnum language, RetrievalProperties retrieval,
        ContentProperties content, Relationships relationships, AdministrativeDetails administrativeDetails,
        InstructionStatusEnum status) {
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeStringField("subDomain", this.subDomain == null ? null : this.subDomain.toString());
    ...
    public static Instruction fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("instructionId".equals(fieldName)) {
            ...
            Instruction deserializedInstruction = new Instruction(instructionVersion, domain, subDomain, category,
                language, retrieval, content, relationships, administrativeDetails, status);
            deserializedInstruction.instructionId = instructionId;
