...
public final class AliasDictionaryAliasesClient {
    ...
    public Response<BinaryData> activateWithResponse(String id, BinaryData activateRequest,
        RequestOptions requestOptions) {
        return this.serviceClient.activateWithResponse(id, activateRequest, requestOptions);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ActivateAlias activate(String id, boolean enabled) {
        ...
        return activateWithResponse(id, activateRequest, requestOptions).getValue().toObject(ActivateAlias.class);
    }
}
