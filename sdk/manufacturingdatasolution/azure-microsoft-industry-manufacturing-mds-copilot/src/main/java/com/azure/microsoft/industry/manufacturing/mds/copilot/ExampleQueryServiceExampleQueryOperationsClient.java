...
public final class ExampleQueryServiceExampleQueryOperationsClient {
    ...
    public Response<BinaryData> updateExampleWithResponse(String exampleId, BinaryData resource,
        ...
        return this.serviceClient.updateExampleWithResponse(exampleId, resource, requestOptions);
    }
    ...
    public Response<Void> createExampleWithResponse(BinaryData resource, RequestOptions requestOptions) {
        return this.serviceClient.createExampleWithResponse(resource, requestOptions);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ExampleQueryRequest updateExample(String exampleId, ExampleQueryRequest resource) {
        ...
        return updateExampleWithResponse(exampleId, resourceInBinaryData, requestOptions).getValue()
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public void createExample(ExampleQueryRequest resource) {
        // Generated convenience method for createExampleWithResponse
        RequestOptions requestOptions = new RequestOptions();
        createExampleWithResponse(BinaryData.fromObject(resource), requestOptions).getValue();
    }
