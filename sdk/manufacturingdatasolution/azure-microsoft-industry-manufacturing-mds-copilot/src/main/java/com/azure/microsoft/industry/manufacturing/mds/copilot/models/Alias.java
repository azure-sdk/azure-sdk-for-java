...
public final class Alias implements JsonSerializable<Alias> {
     ...
     */
    @Generated
    public Alias(String name, List<String> aliases, Choice enabled) {
        this.name = name;
    ...
    /**
     * Get the enabled property: Indicates if the alias is enabled.
     * 
     * @return the enabled value.
     */
    @Generated
    public Choice getEnabled() {
        return this.enabled;
    }
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("id".equals(fieldName)) {
                    ...
                    enabled = Choice.fromString(reader.getString());
                } else {
                    reader.skipChildren();
                }
            }
            Alias deserializedAlias = new Alias(name, aliases, enabled);
