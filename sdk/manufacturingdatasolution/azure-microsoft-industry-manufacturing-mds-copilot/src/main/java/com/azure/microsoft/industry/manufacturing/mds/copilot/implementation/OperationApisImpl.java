...
/**
 * An instance of this class provides access to all the operations defined in OperationApis.
 */
public final class OperationApisImpl {
    /**
     * The proxy service used to perform REST calls.
     */
    private final OperationApisService service;
    ...
    /**
     * Initializes an instance of OperationApisImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    OperationApisImpl(CopilotServiceClientImpl client) {
        this.service
            = RestProxy.create(OperationApisService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }
    ...
    /**
     * The interface defining all the services for CopilotServiceClientOperationApis to be used by the proxy service to
     * perform REST calls.
     */
    @Host("https://mds-{mdsUniqueId}.{location}.cloudapp.azure.com/")
    @ServiceInterface(name = "CopilotServiceClient")
    public interface OperationApisService {
    ...
    public Mono<Response<BinaryData>> getWithResponseAsync(String operationId, RequestOptions requestOptions) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<BinaryData> getWithResponse(String operationId, RequestOptions requestOptions) {
        final String accept = "application/json";
