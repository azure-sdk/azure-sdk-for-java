...
import com.azure.microsoft.industry.manufacturing.mds.copilot.implementation.ValidateQueryApisImpl;
...
public final class ValidateQueryApiAsyncClient {
    @Generated
    private final ValidateQueryApisImpl serviceClient;

    /**
     * Initializes an instance of ValidateQueryApiAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    ValidateQueryApiAsyncClient(ValidateQueryApisImpl serviceClient) {
    ...
    public Mono<QueryValidationJobScheduleConfirmation> run(List<QueryValidationTestCase> testCases,
        Choice runInConversationContext) {
