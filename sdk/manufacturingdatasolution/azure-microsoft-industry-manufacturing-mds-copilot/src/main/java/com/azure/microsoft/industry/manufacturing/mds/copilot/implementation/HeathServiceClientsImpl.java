...
public final class HeathServiceClientsImpl {
    ...
    public interface HeathServiceClientsService {
        ...
        Mono<Response<BinaryData>> getHealthStatus(@HostParam("mdsUniqueId") String mdsUniqueId,
        ...
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        @UnexpectedResponseExceptionType(HttpResponseException.class)
        Response<BinaryData> getHealthStatusSync(@HostParam("mdsUniqueId") String mdsUniqueId,
            @HostParam("location") String location, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, RequestOptions requestOptions, Context context);
    }
    ...
    public Mono<Response<BinaryData>> getHealthStatusWithResponseAsync(RequestOptions requestOptions) {
        final String accept = "application/json";
        return FluxUtil.withContext(context -> service.getHealthStatus(this.client.getMdsUniqueId(),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<BinaryData> getHealthStatusWithResponse(RequestOptions requestOptions) {
        final String accept = "application/json";
        return service.getHealthStatusSync(this.client.getMdsUniqueId(), this.client.getLocation(),
