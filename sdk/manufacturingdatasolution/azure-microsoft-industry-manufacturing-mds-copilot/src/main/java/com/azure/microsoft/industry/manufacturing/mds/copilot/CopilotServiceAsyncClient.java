...
public final class CopilotServiceAsyncClient {
    @Generated
    private final CopilotServiceClientImpl serviceClient;

    /**
     * Initializes an instance of CopilotServiceAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    CopilotServiceAsyncClient(CopilotServiceClientImpl serviceClient) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<QueryResponse> queryExecute(QueryRequest request, String conversationId, String acceptLanguage,
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<QueryResponse> queryExecute(QueryRequest request) {
        // Generated convenience method for queryExecuteWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return queryExecuteWithResponse(BinaryData.fromObject(request), requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(QueryResponse.class));
