...
public class ExampleQueryOperationsUpdateExampleMaximumSet {
    public static void main(String[] args) {
        ...
        ExampleQueryRequest response = exampleQueryServiceExampleQueryOperationsClient.updateExample("rsedkhrqvgiqz",
            new ExampleQueryRequest().setUserQuestion("nj")
                .setLinkedInstructions(Arrays.asList("qvjmxhbnhjjuxunapx"))
                .setSampleQuery(
                    new SampleQuery().setLanguage("hnurkqeqfmfmjfnc").setQuery("amwxibfyjlzcrekrrcgfzohg")));
