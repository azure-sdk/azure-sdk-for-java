...
public final class EmployeesCreateOrUpdateSamples {
    ...
    public static void employeesCreateOrUpdate(com.azure.resourcemanager.contoso.ContosoManager manager) {
        manager.employees()
            ...
            .withProperties(
                new EmployeeProperties().withCity("gydhnntudughbmxlkyzrskcdkotrxn").withProfile("ms".getBytes()))
            .create();
    }
...
public final class EmployeesListSamples {
    /*
     * x-ms-original-file: 2021-10-01-preview/Employees_ListBySubscription.json
     */
    /**
...
public final class EmployeesUpdateSamples {
    ...
    public static void employeesUpdate(com.azure.resourcemanager.contoso.ContosoManager manager) {
        ...
        resource.update()
            ...
            .withProperties(new EmployeeProperties().withCity("uyfg").withProfile("oapgijcswfkruiuuzbwco".getBytes()))
            .apply();
    }
...
public final class OperationsListSamples {
    /*
     * x-ms-original-file: 2021-10-01-preview/Operations_List.json
     */
    /**
