...
public interface EmployeesClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<EmployeeInner> updateWithResponse(String resourceGroupName, String employeeName, EmployeeUpdate properties,
        Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    EmployeeInner update(String resourceGroupName, String employeeName, EmployeeUpdate properties);
