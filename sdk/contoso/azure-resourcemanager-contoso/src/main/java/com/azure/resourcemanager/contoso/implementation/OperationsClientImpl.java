...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    OperationsClientImpl(ContosoClientImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for ContosoClientOperations to be used by the proxy service to perform
     * REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "ContosoClientOperati")
