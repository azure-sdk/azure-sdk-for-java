...
public final class EmployeeImpl implements Employee, Employee.Definition, Employee.Update {
    ...
    private EmployeeUpdate updateProperties;
    ...
    public EmployeeImpl update() {
        this.updateProperties = new EmployeeUpdate();
        return this;
    }
    ...
    public Employee apply() {
        this.innerObject = serviceManager.serviceClient()
            .getEmployees()
            .updateWithResponse(resourceGroupName, employeeName, updateProperties, Context.NONE)
            .getValue();
        return this;
    }
    ...
    public Employee apply(Context context) {
        this.innerObject = serviceManager.serviceClient()
            .getEmployees()
            .updateWithResponse(resourceGroupName, employeeName, updateProperties, context)
            .getValue();
        return this;
    }
    ...
    public EmployeeImpl withProperties(EmployeeUpdateProperties properties) {
