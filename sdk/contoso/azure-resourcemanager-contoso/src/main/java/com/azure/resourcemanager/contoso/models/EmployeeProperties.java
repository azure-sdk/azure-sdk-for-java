...
public final class EmployeeProperties implements JsonSerializable<EmployeeProperties> {
    ...
    /*
     * Age of employee along with test that should show up in documentation.
     */
    private Integer age;
    ...
    /**
     * Get the age property: Age of employee along with test that should show up in documentation.
     * 
    ...
    /**
     * Set the age property: Age of employee along with test that should show up in documentation.
     * 
