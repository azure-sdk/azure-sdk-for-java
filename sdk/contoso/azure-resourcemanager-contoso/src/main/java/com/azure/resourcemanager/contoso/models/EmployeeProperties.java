...
public final class EmployeeProperties implements JsonSerializable<EmployeeProperties> {
    ...
    /**
     * Get the state property: State or province of employee.
     * 
    ...
    /**
     * Set the state property: State or province of employee.
     * 
     * @param state the state value to set.
     * @return the EmployeeProperties object itself.
     */
    public EmployeeProperties withState(String state) {
        this.state = state;
        return this;
    }
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("age".equals(fieldName)) {
                    ...
                    deserializedEmployeeProperties.state = reader.getString();
