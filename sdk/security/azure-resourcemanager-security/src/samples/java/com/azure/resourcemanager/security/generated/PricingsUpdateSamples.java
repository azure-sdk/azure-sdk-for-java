...
public final class PricingsUpdateSamples {
     ...
     */
    public static void
        updatePricingOnSubscriptionPartialSuccess(com.azure.resourcemanager.security.SecurityManager manager) {
        manager.pricings().updateWithResponse("CloudPosture", new PricingInner().withPricingTier(PricingTier.STANDARD),
    ...
    public static void updatePricingOnSubscriptionExampleForCloudPosturePlan(
        ...
        manager.pricings().updateWithResponse("subscriptions/20ff7fc3-e762-44dd-bd96-b71116dcdc23", "CloudPosture",
            new PricingAutoGeneratedInner().withPricingTier(PricingTier.STANDARD), com.azure.core.util.Context.NONE);
    }
    ...
    public static void updatePricingOnSubscriptionExampleForVirtualMachinesPlan(
        ...
        manager.pricings().updateWithResponse(
            "subscriptions/20ff7fc3-e762-44dd-bd96-b71116dcdc23", "VirtualMachines", new PricingAutoGeneratedInner()
                .withPricingTier(PricingTier.STANDARD).withSubPlan("P2").withEnforce(Enforce.TRUE),
            com.azure.core.util.Context.NONE);
    }
    ...
    public static void updatePricingOnResourceExampleForVirtualMachinesPlan(
        ...
        manager.pricings().updateWithResponse(
            ...
            "virtualMachines", new PricingAutoGeneratedInner().withPricingTier(PricingTier.STANDARD).withSubPlan("P1"),
            com.azure.core.util.Context.NONE);
    }
}
