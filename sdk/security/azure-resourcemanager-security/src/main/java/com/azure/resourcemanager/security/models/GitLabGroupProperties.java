...
public final class GitLabGroupProperties {
    ...
    /** Creates an instance of GitLabGroupProperties class. */
     ...
     *
     * <p>Pending - Provisioning pending. Failed - Provisioning failed. Succeeded - Successful provisioning. Canceled -
     * Provisioning canceled. PendingDeletion - Deletion pending. DeletionSuccess - Deletion successful. DeletionFailure
     * - Deletion failure.
     *
    ...
    /**
     * Get the fullyQualifiedName property: Gets or sets the fully-qualified name of the Group object.
     *
     * <p>This contains the entire namespace hierarchy where namespaces are separated by the '$' character.
     *
    ...
    /**
     * Get the fullyQualifiedFriendlyName property: Gets or sets the human readable fully-qualified name of the Group
     * object.
     *
     * <p>This contains the entire namespace hierarchy as seen on GitLab UI where namespaces are separated by the '/'
     * character.
     *
    ...
    /**
     * Get the url property: Gets or sets the url of the GitLab Group.
     *
     ...
     *
     * <p>OnboardedByOtherConnector - this resource has already been onboarded to another connector. This is only
     * applicable to top-level resources. Onboarded - this resource has already been onboarded by the specified
     * connector. NotOnboarded - this resource has not been onboarded to any connector. NotApplicable - the onboarding
     ...
     * @return the GitLabGroupProperties object itself.
     */
    public GitLabGroupProperties withOnboardingState(OnboardingState onboardingState) {
