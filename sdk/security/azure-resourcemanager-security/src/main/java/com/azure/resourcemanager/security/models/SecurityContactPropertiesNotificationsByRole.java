...
public final class SecurityContactPropertiesNotificationsByRole {
    ...
    private StateForNotificationsByRole state;
     ...
     */
    public StateForNotificationsByRole state() {
        return this.state;
    }
     ...
     */
    public SecurityContactPropertiesNotificationsByRole withState(StateForNotificationsByRole state) {
        this.state = state;
        return this;
    }
