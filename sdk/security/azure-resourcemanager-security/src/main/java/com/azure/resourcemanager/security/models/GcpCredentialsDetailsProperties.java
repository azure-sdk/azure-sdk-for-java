        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("authenticationProvisioningState".equals(fieldName)) {
                    deserializedGcpCredentialsDetailsProperties.authenticationProvisioningState
                    ...
                    deserializedGcpCredentialsDetailsProperties.grantedPermissions = grantedPermissions;
