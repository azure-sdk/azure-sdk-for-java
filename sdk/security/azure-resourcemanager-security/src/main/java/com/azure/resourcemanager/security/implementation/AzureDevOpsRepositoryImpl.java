...
public final class AzureDevOpsRepositoryImpl
    ...
    public AzureDevOpsRepositoryImpl withExistingProject(
    ...
    AzureDevOpsRepositoryImpl(
        AzureDevOpsRepositoryInner innerObject, com.azure.resourcemanager.security.SecurityManager serviceManager) {
        ...
        this.repoName = Utils.getValueFromIdByName(innerObject.id(), "repos");
    }
