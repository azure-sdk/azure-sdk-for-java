...
public interface SecurityConnectorGovernanceRulesClient {
    ...
    PagedIterable<GovernanceRuleInner> list(String resourceGroupName, String securityConnectorName);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<GovernanceRuleInner> list(String resourceGroupName, String securityConnectorName, Context context);
}
