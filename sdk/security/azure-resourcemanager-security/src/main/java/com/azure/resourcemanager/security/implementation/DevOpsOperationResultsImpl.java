...
public final class DevOpsOperationResultsImpl implements DevOpsOperationResults {
    ...
    public DevOpsOperationResultsImpl(
        DevOpsOperationResultsClient innerClient, com.azure.resourcemanager.security.SecurityManager serviceManager) {
    ...
    public Response<OperationStatusResult> getWithResponse(
        ...
        Response<OperationStatusResultInner> inner =
            this.serviceClient().getWithResponse(resourceGroupName, securityConnectorName, operationResultId, context);
        if (inner != null) {
