...
public interface GitHubReposClient {
    ...
    PagedIterable<GitHubRepositoryInner> list(String resourceGroupName, String securityConnectorName, String ownerName);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<GitHubRepositoryInner> list(
    ...
    Response<GitHubRepositoryInner> getWithResponse(
