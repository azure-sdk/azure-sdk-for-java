        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("isEnabled".equals(fieldName)) {
                    ...
                    deserializedAmqpC2DRejectedMessagesNotInAllowedRange.displayName = reader.getString();
                } else if ("description".equals(fieldName)) {
                    deserializedAmqpC2DRejectedMessagesNotInAllowedRange.description = reader.getString();
