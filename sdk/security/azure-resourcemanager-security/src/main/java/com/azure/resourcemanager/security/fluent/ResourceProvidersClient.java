...
public interface ResourceProvidersClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<AggregationResponseInner> aggregationsWithResponse(AggregationRequest aggregations, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    AggregationResponseInner aggregations(AggregationRequest aggregations);
}
