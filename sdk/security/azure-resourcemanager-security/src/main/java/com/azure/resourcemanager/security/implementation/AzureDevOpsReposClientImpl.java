...
public final class AzureDevOpsReposClientImpl implements AzureDevOpsReposClient {
    ...
    public interface AzureDevOpsReposService {
        ...
        Mono<Response<AzureDevOpsRepositoryListResponse>> list(
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<AzureDevOpsRepositoryInner>> get(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("securityConnectorName") String securityConnectorName,
    ...
    private Mono<PagedResponse<AzureDevOpsRepositoryInner>> listSinglePageAsync(
                ...
                context ->
                    service
                        .list(
                            ...
                            accept,
                            context))
            .<PagedResponse<AzureDevOpsRepositoryInner>>map(
                res ->
    ...
    private PagedFlux<AzureDevOpsRepositoryInner> listAsync(
        String resourceGroupName, String securityConnectorName, String orgName, String projectName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<AzureDevOpsRepositoryInner> list(
        String resourceGroupName, String securityConnectorName, String orgName, String projectName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<AzureDevOpsRepositoryInner>> getWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<AzureDevOpsRepositoryInner> getAsync(
        String resourceGroupName, String securityConnectorName, String orgName, String projectName, String repoName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<AzureDevOpsRepositoryInner> getWithResponse(
        String resourceGroupName,
        String securityConnectorName,
        String orgName,
        String projectName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public AzureDevOpsRepositoryInner get(
        String resourceGroupName, String securityConnectorName, String orgName, String projectName, String repoName) {
    ...
    private PollerFlux<PollResult<AzureDevOpsRepositoryInner>, AzureDevOpsRepositoryInner> beginCreateOrUpdateAsync(
        ...
        Mono<Response<Flux<ByteBuffer>>> mono =
            createOrUpdateWithResponseAsync(
                resourceGroupName, securityConnectorName, orgName, projectName, repoName, azureDevOpsRepository);
        return this
            .client
            .<AzureDevOpsRepositoryInner, AzureDevOpsRepositoryInner>getLroResult(
                mono,
                this.client.getHttpPipeline(),
                AzureDevOpsRepositoryInner.class,
                AzureDevOpsRepositoryInner.class,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<AzureDevOpsRepositoryInner> createOrUpdateAsync(
        String resourceGroupName,
        String securityConnectorName,
        String orgName,
        String projectName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public AzureDevOpsRepositoryInner createOrUpdate(
        String resourceGroupName,
        String securityConnectorName,
        String orgName,
        String projectName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<AzureDevOpsRepositoryInner> updateAsync(
        String resourceGroupName,
        String securityConnectorName,
        String orgName,
        String projectName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public AzureDevOpsRepositoryInner update(
        String resourceGroupName,
        String securityConnectorName,
        String orgName,
        String projectName,
