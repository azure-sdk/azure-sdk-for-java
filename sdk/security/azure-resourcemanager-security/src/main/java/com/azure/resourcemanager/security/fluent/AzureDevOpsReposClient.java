...
public interface AzureDevOpsReposClient {
    ...
    PagedIterable<AzureDevOpsRepositoryInner> list(
    ...
    Response<AzureDevOpsRepositoryInner> getWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<AzureDevOpsRepositoryInner>, AzureDevOpsRepositoryInner> beginUpdate(
        String resourceGroupName,
        String securityConnectorName,
        String orgName,
        String projectName,
