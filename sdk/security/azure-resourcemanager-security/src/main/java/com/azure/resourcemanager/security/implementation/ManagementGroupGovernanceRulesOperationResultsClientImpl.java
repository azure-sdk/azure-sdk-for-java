 ...
 * ManagementGroupGovernanceRulesOperationResultsClient.
 */
public final class ManagementGroupGovernanceRulesOperationResultsClientImpl
    implements ManagementGroupGovernanceRulesOperationResultsClient {
    /** The proxy service used to perform REST calls. */
    private final ManagementGroupGovernanceRulesOperationResultsService service;

    /** The service client containing this operation class. */
    private final SecurityCenterImpl client;

    /**
     * Initializes an instance of ManagementGroupGovernanceRulesOperationResultsClientImpl.
     *
     * @param client the instance of the service client containing this operation class.
     */
    ManagementGroupGovernanceRulesOperationResultsClientImpl(SecurityCenterImpl client) {
        this.service =
            RestProxy
                .create(
                    ManagementGroupGovernanceRulesOperationResultsService.class,
    ...
    /**
     * The interface defining all the services for SecurityCenterManagementGroupGovernanceRulesOperationResults to be
     * used by the proxy service to perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "SecurityCenterManage")
    public interface ManagementGroupGovernanceRulesOperationResultsService {
        @Headers({"Content-Type: application/json"})
        @Get(
            "/providers/Microsoft.Management/managementGroups/{managementGroupId}/providers/Microsoft.Security"
                + "/governanceRules/{ruleId}/operationResults/{operationId}")
        @ExpectedResponses({200, 202})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<ManagementGroupGovernanceRulesOperationResultsGetResponse> get(
    ...
    private Mono<ManagementGroupGovernanceRulesOperationResultsGetResponse> getWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ManagementGroupGovernanceRulesOperationResultsGetResponse getWithResponse(
        String managementGroupId, String ruleId, String operationId, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public OperationResultAutoGeneratedInner get(String managementGroupId, String ruleId, String operationId) {
