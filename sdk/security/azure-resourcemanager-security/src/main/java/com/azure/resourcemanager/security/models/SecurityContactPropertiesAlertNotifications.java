...
public final class SecurityContactPropertiesAlertNotifications {
    ...
    private StateForAlertNotifications state;
     ...
     */
    public StateForAlertNotifications state() {
        return this.state;
    }
     ...
     */
    public SecurityContactPropertiesAlertNotifications withState(StateForAlertNotifications state) {
        this.state = state;
        return this;
    }
