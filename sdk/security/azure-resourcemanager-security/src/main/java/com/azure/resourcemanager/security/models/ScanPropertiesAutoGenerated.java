...
@Fluent
public final class ScanPropertiesAutoGenerated {
    /*
    ...
    /** Creates an instance of ScanPropertiesAutoGenerated class. */
    public ScanPropertiesAutoGenerated() {
    }
     ...
     * @return the ScanPropertiesAutoGenerated object itself.
     */
    public ScanPropertiesAutoGenerated withTriggerType(ScanTriggerType triggerType) {
     ...
     * @return the ScanPropertiesAutoGenerated object itself.
     */
    public ScanPropertiesAutoGenerated withState(ScanState state) {
        this.state = state;
        return this;
    }
     ...
     * @return the ScanPropertiesAutoGenerated object itself.
     */
    public ScanPropertiesAutoGenerated withServer(String server) {
        this.server = server;
        return this;
    }
     ...
     * @return the ScanPropertiesAutoGenerated object itself.
     */
    public ScanPropertiesAutoGenerated withDatabase(String database) {
     ...
     * @return the ScanPropertiesAutoGenerated object itself.
     */
    public ScanPropertiesAutoGenerated withSqlVersion(String sqlVersion) {
     ...
     * @return the ScanPropertiesAutoGenerated object itself.
     */
    public ScanPropertiesAutoGenerated withStartTime(OffsetDateTime startTime) {
     ...
     * @return the ScanPropertiesAutoGenerated object itself.
     */
    public ScanPropertiesAutoGenerated withEndTime(OffsetDateTime endTime) {
     ...
     * @return the ScanPropertiesAutoGenerated object itself.
     */
    public ScanPropertiesAutoGenerated withHighSeverityFailedRulesCount(Integer highSeverityFailedRulesCount) {
     ...
     * @return the ScanPropertiesAutoGenerated object itself.
     */
    public ScanPropertiesAutoGenerated withMediumSeverityFailedRulesCount(Integer mediumSeverityFailedRulesCount) {
     ...
     * @return the ScanPropertiesAutoGenerated object itself.
     */
    public ScanPropertiesAutoGenerated withLowSeverityFailedRulesCount(Integer lowSeverityFailedRulesCount) {
     ...
     * @return the ScanPropertiesAutoGenerated object itself.
     */
    public ScanPropertiesAutoGenerated withTotalPassedRulesCount(Integer totalPassedRulesCount) {
     ...
     * @return the ScanPropertiesAutoGenerated object itself.
     */
    public ScanPropertiesAutoGenerated withTotalFailedRulesCount(Integer totalFailedRulesCount) {
     ...
     * @return the ScanPropertiesAutoGenerated object itself.
     */
    public ScanPropertiesAutoGenerated withTotalRulesCount(Integer totalRulesCount) {
     ...
     * @return the ScanPropertiesAutoGenerated object itself.
     */
    public ScanPropertiesAutoGenerated withIsBaselineApplied(Boolean isBaselineApplied) {
     ...
     * @return the ScanPropertiesAutoGenerated object itself.
     */
    public ScanPropertiesAutoGenerated withLastScanTime(OffsetDateTime lastScanTime) {
