...
public final class SensitivitySettingsImpl implements SensitivitySettings {
    ...
    public Response<GetSensitivitySettingsResponse>
        ...
        Response<GetSensitivitySettingsResponseInner> inner
            = this.serviceClient().updateWithResponse(sensitivitySettings, context);
        if (inner != null) {
    ...
    public GetSensitivitySettingsResponse update(UpdateSensitivitySettingsRequest sensitivitySettings) {
        GetSensitivitySettingsResponseInner inner = this.serviceClient().update(sensitivitySettings);
        if (inner != null) {
