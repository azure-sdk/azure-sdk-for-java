...
public final class SensitivitySettingsImpl implements SensitivitySettings {
    ...
    public Response<GetSensitivitySettingsListResponse> listSensitivitySettingsWithResponse(Context context) {
        Response<GetSensitivitySettingsListResponseInner> inner =
            this.serviceClient().listSensitivitySettingsWithResponse(context);
        if (inner != null) {
            return new SimpleResponse<>(
                inner.getRequest(),
                inner.getStatusCode(),
    ...
    public GetSensitivitySettingsListResponse listSensitivitySettings() {
        GetSensitivitySettingsListResponseInner inner = this.serviceClient().listSensitivitySettings();
        if (inner != null) {
