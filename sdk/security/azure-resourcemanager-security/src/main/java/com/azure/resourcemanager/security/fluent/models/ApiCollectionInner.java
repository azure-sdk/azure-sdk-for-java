...
public final class ApiCollectionInner extends ProxyResource {
     ...
     * @return the ApiCollectionInner object itself.
     */
    public ApiCollectionInner withDisplayName(String displayName) {
     ...
     * @return the ApiCollectionInner object itself.
     */
    public ApiCollectionInner withAdditionalData(Map<String, String> additionalData) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ApiCollectionProperties();
        }
