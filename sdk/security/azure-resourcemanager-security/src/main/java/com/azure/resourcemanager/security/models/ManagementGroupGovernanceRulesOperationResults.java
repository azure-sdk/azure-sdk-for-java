...
/** Resource collection API of ManagementGroupGovernanceRulesOperationResults. */
public interface ManagementGroupGovernanceRulesOperationResults {
    /**
     ...
     * @return governance rules long run operation result for the requested scope by ruleId and operationId.
     */
    OperationResultAutoGenerated get(String managementGroupId, String ruleId, String operationId);
}
