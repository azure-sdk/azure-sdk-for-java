...
public interface Pricings {
     ...
     */
    Response<PricingAutoGenerated> getWithResponse(String scopeId, String pricingName, Context context);
     ...
     * subscription id).
     */
    PricingAutoGenerated get(String scopeId, String pricingName);
     ...
     * {@link Response}.
     */
    Response<PricingAutoGenerated> updateWithResponse(String scopeId, String pricingName,
     ...
     * @return microsoft Defender for Cloud is provided in two pricing tiers: free and standard.
     */
    PricingAutoGenerated update(String scopeId, String pricingName, PricingAutoGeneratedInner pricing);
     ...
     */
    Response<Void> deleteByResourceGroupWithResponse(String scopeId, String pricingName, Context context);
     ...
     * @return list of pricing configurations response along with {@link Response}.
     */
    Response<PricingListAutoGenerated> listWithResponse(String scopeId, String filter, Context context);
     ...
     * @return list of pricing configurations response.
     */
    PricingListAutoGenerated list(String scopeId);
}
