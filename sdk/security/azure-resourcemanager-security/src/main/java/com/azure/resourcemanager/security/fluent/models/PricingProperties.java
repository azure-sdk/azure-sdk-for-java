...
public final class PricingProperties {
    ...
    /*
     * (optional) will return true if the pricing bundle is deprecated
     */
    @JsonProperty(value = "deprecated", access = JsonProperty.Access.WRITE_ONLY)
    private Boolean deprecated;

    /*
     * (optional) List of pricing bundles which replace the deprecated bundle,
    ...
    /**
     * Get the deprecated property: (optional) will return true if the pricing bundle is deprecated.
     *
    ...
    /**
     * Get the replacedBy property: (optional) List of pricing bundles which replace the deprecated bundle, if
     * deprecated is true.
     *
