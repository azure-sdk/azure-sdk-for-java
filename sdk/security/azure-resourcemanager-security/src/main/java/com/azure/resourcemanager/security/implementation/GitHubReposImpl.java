...
public final class GitHubReposImpl implements GitHubRepos {
    ...
    public GitHubReposImpl(
        GitHubReposClient innerClient, com.azure.resourcemanager.security.SecurityManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public PagedIterable<GitHubRepository> list(
        ...
        return Utils.mapPage(inner, inner1 -> new GitHubRepositoryImpl(inner1, this.manager()));
    }
