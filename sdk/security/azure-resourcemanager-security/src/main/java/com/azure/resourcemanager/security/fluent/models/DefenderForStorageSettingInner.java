...
public final class DefenderForStorageSettingInner extends ProxyResource {
    ...
    /**
     * Get the innerProperties property: A Defender for Storage resource properties.
     *
    ...
    /**
     * Get the operationStatusSensitiveDataDiscoveryOperationStatus property: Optional. A status describing the
