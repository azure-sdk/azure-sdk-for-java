 ...
 */
public final class SecurityConnectorGovernanceRulesClientImpl implements SecurityConnectorGovernanceRulesClient {
    /** The proxy service used to perform REST calls. */
    private final SecurityConnectorGovernanceRulesService service;

    /** The service client containing this operation class. */
    private final SecurityCenterImpl client;

    /**
     * Initializes an instance of SecurityConnectorGovernanceRulesClientImpl.
     *
     * @param client the instance of the service client containing this operation class.
     */
    SecurityConnectorGovernanceRulesClientImpl(SecurityCenterImpl client) {
        this.service =
            RestProxy
                .create(
                    SecurityConnectorGovernanceRulesService.class,
    ...
    /**
     * The interface defining all the services for SecurityCenterSecurityConnectorGovernanceRules to be used by the
    ...
    public interface SecurityConnectorGovernanceRulesService {
        ...
        @Get(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Security"
                + "/securityConnectors/{securityConnectorName}/providers/Microsoft.Security/governanceRules")
    ...
    private PagedFlux<GovernanceRuleInner> listAsync(String resourceGroupName, String securityConnectorName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<GovernanceRuleInner> listAsync(
        String resourceGroupName, String securityConnectorName, Context context) {
        return new PagedFlux<>(
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<GovernanceRuleInner> list(String resourceGroupName, String securityConnectorName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<GovernanceRuleInner> list(
        String resourceGroupName, String securityConnectorName, Context context) {
