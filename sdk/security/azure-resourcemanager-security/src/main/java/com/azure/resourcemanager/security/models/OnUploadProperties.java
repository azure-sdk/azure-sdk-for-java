...
public final class OnUploadProperties implements JsonSerializable<OnUploadProperties> {
    ...
    /*
     * Optional. Determine which blobs get scanned by On Upload malware scanning. An Or operation is performed between
     * each filter type.
     */
    ...
    /**
     * Get the filters property: Optional. Determine which blobs get scanned by On Upload malware scanning. An Or
    ...
    /**
     * Set the filters property: Optional. Determine which blobs get scanned by On Upload malware scanning. An Or
     * operation is performed between each filter type.
     * 
