...
public final class OnUploadProperties implements JsonSerializable<OnUploadProperties> {
    ...
    /*
     * Determine which blobs get scanned by On Upload malware scanning. An Or operation is performed between each filter
     * type.
     */
    private OnUploadFilters filters;
    ...
    /**
     * Get the filters property: Determine which blobs get scanned by On Upload malware scanning. An Or operation is
    ...
    /**
     * Set the filters property: Determine which blobs get scanned by On Upload malware scanning. An Or operation is
     * performed between each filter type.
     * 
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("isEnabled".equals(fieldName)) {
                    ...
                    deserializedOnUploadProperties.filters = OnUploadFilters.fromJson(reader);
                } else {
                    reader.skipChildren();
                }
            }
