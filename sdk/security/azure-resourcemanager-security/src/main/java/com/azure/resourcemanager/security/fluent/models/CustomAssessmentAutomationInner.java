...
public final class CustomAssessmentAutomationInner extends ProxyResource {
    ...
    /**
     * Reads an instance of CustomAssessmentAutomationInner from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of CustomAssessmentAutomationInner if the JsonReader was pointing to an instance of it, or
     * null if it was pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the CustomAssessmentAutomationInner.
     */
    public static CustomAssessmentAutomationInner fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            CustomAssessmentAutomationInner deserializedCustomAssessmentAutomationInner
                = new CustomAssessmentAutomationInner();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("id".equals(fieldName)) {
                    deserializedCustomAssessmentAutomationInner.id = reader.getString();
                } else if ("name".equals(fieldName)) {
                    deserializedCustomAssessmentAutomationInner.name = reader.getString();
                } else if ("type".equals(fieldName)) {
                    deserializedCustomAssessmentAutomationInner.type = reader.getString();
                } else if ("systemData".equals(fieldName)) {
                    deserializedCustomAssessmentAutomationInner.systemData = SystemData.fromJson(reader);
                } else if ("properties".equals(fieldName)) {
                    deserializedCustomAssessmentAutomationInner.innerProperties
                        = CustomAssessmentAutomationProperties.fromJson(reader);
                } else {
                    reader.skipChildren();
                }
            }

            return deserializedCustomAssessmentAutomationInner;
        });
    }
}
