...
public final class DevOpsConfigurationProperties implements JsonSerializable<DevOpsConfigurationProperties> {
     ...
     */
    private AgentlessScanning agentlessScanning;
    ...
    /**
     * Get the agentlessScanning property: Agentless Scanning states.
     * 
     * @return the agentlessScanning value.
     */
    public AgentlessScanning agentlessScanning() {
        return this.agentlessScanning;
    }

    /**
     * Set the agentlessScanning property: Agentless Scanning states.
     * 
     * @param agentlessScanning the agentlessScanning value to set.
     * @return the DevOpsConfigurationProperties object itself.
     */
    public DevOpsConfigurationProperties withAgentlessScanning(AgentlessScanning agentlessScanning) {
        this.agentlessScanning = agentlessScanning;
        return this;
    }
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeStringField("agentlessScanning",
            this.agentlessScanning == null ? null : this.agentlessScanning.toString());
    ...
    public static DevOpsConfigurationProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                } else if ("agentlessScanning".equals(fieldName)) {
                    deserializedDevOpsConfigurationProperties.agentlessScanning
                        = AgentlessScanning.fromString(reader.getString());
                } else {
                    reader.skipChildren();
                }
            }
