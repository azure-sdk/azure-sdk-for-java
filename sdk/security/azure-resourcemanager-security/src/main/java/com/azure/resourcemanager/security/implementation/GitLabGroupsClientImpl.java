...
public final class GitLabGroupsClientImpl implements GitLabGroupsClient {
    ...
    /**
     * The interface defining all the services for SecurityCenterGitLabGroups to be used by the proxy service to perform
     * REST calls.
     */
    @Host("{$host}")
    ...
    public interface GitLabGroupsService {
        ...
        Mono<Response<GitLabGroupListResponseInner>> listAvailable(
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<GitLabGroupInner>> get(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("securityConnectorName") String securityConnectorName,
    ...
    private Mono<Response<GitLabGroupListResponseInner>> listAvailableWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<GitLabGroupListResponseInner> listAvailableAsync(
        String resourceGroupName, String securityConnectorName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<GitLabGroupListResponseInner> listAvailableWithResponse(
        String resourceGroupName, String securityConnectorName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<GitLabGroupInner>> listSinglePageAsync(
        String resourceGroupName, String securityConnectorName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                ...
                context ->
                    service
                        .list(
                            ...
                            accept,
                            context))
            .<PagedResponse<GitLabGroupInner>>map(
                res ->
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<GitLabGroupInner> listAsync(
        String resourceGroupName, String securityConnectorName, Context context) {
        return new PagedFlux<>(
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<GitLabGroupInner> list(
        String resourceGroupName, String securityConnectorName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<GitLabGroupInner>> getWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<GitLabGroupInner> getAsync(
        String resourceGroupName, String securityConnectorName, String groupFQName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<GitLabGroupInner> getWithResponse(
        String resourceGroupName, String securityConnectorName, String groupFQName, Context context) {
