...
public final class SettingsClientImpl implements SettingsClient {
    ...
    public interface SettingsService {
        ...
        Mono<Response<SettingsList>> list(
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<SettingInner>> update(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("settingName") SettingNameAutoGenerated settingName,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<SettingsList>> listNext(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<SettingInner>> getWithResponseAsync(SettingNameAutoGenerated settingName, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    private Mono<Response<SettingInner>> updateWithResponseAsync(
        SettingNameAutoGenerated settingName, SettingInner setting) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<SettingInner>> updateWithResponseAsync(
        SettingNameAutoGenerated settingName, SettingInner setting, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
