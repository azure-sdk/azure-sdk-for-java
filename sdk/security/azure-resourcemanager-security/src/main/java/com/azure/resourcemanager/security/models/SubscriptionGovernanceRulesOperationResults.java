...
/** Resource collection API of SubscriptionGovernanceRulesOperationResults. */
public interface SubscriptionGovernanceRulesOperationResults {
    /**
     ...
     */
    Response<OperationResultAutoGenerated> getWithResponse(String ruleId, String operationId, Context context);
     ...
     * @return governance rules long run operation result for the requested scope by ruleId and operationId.
     */
    OperationResultAutoGenerated get(String ruleId, String operationId);
}
