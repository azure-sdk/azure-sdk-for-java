...
public interface GitLabGroups {
     ...
     */
    Response<GitLabGroupListResponse> listAvailableWithResponse(
     ...
     */
    GitLabGroupListResponse listAvailable(String resourceGroupName, String securityConnectorName);
     ...
     */
    PagedIterable<GitLabGroup> list(String resourceGroupName, String securityConnectorName);
     ...
     * @return list of RP resources which supports pagination as paginated response with {@link PagedIterable}.
     */
    PagedIterable<GitLabGroup> list(String resourceGroupName, String securityConnectorName, Context context);
     ...
     */
    Response<GitLabGroup> getWithResponse(
     ...
     */
    GitLabGroup get(String resourceGroupName, String securityConnectorName, String groupFQName);
}
