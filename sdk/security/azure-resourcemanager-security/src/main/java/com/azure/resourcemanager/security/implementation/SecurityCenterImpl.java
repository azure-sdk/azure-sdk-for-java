...
public final class SecurityCenterImpl implements SecurityCenter {
    ...
    /** The VmScannersClient object to access its operations. */
    private final VmScannersClient vmScanners;

    /**
     * Gets the VmScannersClient object to access its operations.
     *
     * @return the VmScannersClient object.
     */
    public VmScannersClient getVmScanners() {
    ...
    SecurityCenterImpl(
        ...
        this.vmScanners = new VmScannersClientImpl(this);
