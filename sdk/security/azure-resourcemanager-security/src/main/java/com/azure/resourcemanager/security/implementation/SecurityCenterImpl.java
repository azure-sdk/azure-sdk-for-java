...
public final class SecurityCenterImpl implements SecurityCenter {
    ...
    /** The ApplicationMappingRulesClient object to access its operations. */
    private final ApplicationMappingRulesClient applicationMappingRules;

    /**
     * Gets the ApplicationMappingRulesClient object to access its operations.
     *
     * @return the ApplicationMappingRulesClient object.
     */
    public ApplicationMappingRulesClient getApplicationMappingRules() {
        return this.applicationMappingRules;
    }
    ...
    SecurityCenterImpl(
        ...
        this.applicationMappingRules = new ApplicationMappingRulesClientImpl(this);
    }
