        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("isEnabled".equals(fieldName)) {
                    ...
                    deserializedActiveConnectionsNotInAllowedRange.displayName = reader.getString();
                } else if ("description".equals(fieldName)) {
                    deserializedActiveConnectionsNotInAllowedRange.description = reader.getString();
