...
public final class SecurityAssessmentMetadataResponseInner extends ProxyResource {
     ...
     * @return the SecurityAssessmentMetadataResponseInner object itself.
     */
    public SecurityAssessmentMetadataResponseInner withCloudProviders(List<CloudProviders> cloudProviders) {
        if (this.innerProperties() == null) {
            this.innerProperties = new SecurityAssessmentMetadataPropertiesResponse();
        }
    ...
    public String remediationPolicy() {
        return this.innerProperties() == null ? null : this.innerProperties().remediationPolicy();
    }
     ...
     * @return the SecurityAssessmentMetadataResponseInner object itself.
     */
    public SecurityAssessmentMetadataResponseInner withRemediationPolicy(String remediationPolicy) {
        if (this.innerProperties() == null) {
            this.innerProperties = new SecurityAssessmentMetadataPropertiesResponse();
        }
        this.innerProperties().withRemediationPolicy(remediationPolicy);
        return this;
    }
    ...
    public ManagementProvider managementProvider() {
        return this.innerProperties() == null ? null : this.innerProperties().managementProvider();
    }
     ...
     * @return the SecurityAssessmentMetadataResponseInner object itself.
     */
    public SecurityAssessmentMetadataResponseInner withManagementProvider(ManagementProvider managementProvider) {
        if (this.innerProperties() == null) {
            this.innerProperties = new SecurityAssessmentMetadataPropertiesResponse();
        }
        this.innerProperties().withManagementProvider(managementProvider);
        return this;
    }
