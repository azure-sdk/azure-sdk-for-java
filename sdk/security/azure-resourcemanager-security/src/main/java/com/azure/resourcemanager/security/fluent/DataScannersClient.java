 ...
 */
public interface DataScannersClient {
    /**
    ...
    PagedIterable<DataScannerInner> list();
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<DataScannerInner> list(Context context);
    ...
    Response<DataScannerInner> getWithResponse(String dataScannerName, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    DataScannerInner get(String dataScannerName);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<DataScannerInner> createOrUpdateWithResponse(String dataScannerName, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    DataScannerInner createOrUpdate(String dataScannerName);
