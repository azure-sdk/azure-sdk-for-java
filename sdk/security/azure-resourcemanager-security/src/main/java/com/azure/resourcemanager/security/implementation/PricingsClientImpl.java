...
import com.azure.resourcemanager.security.fluent.models.PricingListAutoGeneratedInner;
...
public final class PricingsClientImpl implements PricingsClient {
    ...
    public interface PricingsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<PricingAutoGeneratedInner>> get(@HostParam("$host") String endpoint,
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<PricingAutoGeneratedInner>> update(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam(value = "scopeId", encoded = true) String scopeId,
            @PathParam("pricingName") String pricingName,
            @BodyParam("application/json") PricingAutoGeneratedInner pricing, @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<PricingListAutoGeneratedInner>> list(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam(value = "scopeId", encoded = true) String scopeId,
    ...
    private Mono<PricingInner> getAsync(String pricingName) {
        return getWithResponseAsync(pricingName).flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
    ...
    private Mono<PricingInner> updateAsync(String pricingName, PricingInner pricing) {
        return updateWithResponseAsync(pricingName, pricing).flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<PricingAutoGeneratedInner>> getWithResponseAsync(String scopeId, String pricingName) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PricingAutoGeneratedInner> getAsync(String scopeId, String pricingName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<PricingAutoGeneratedInner> getWithResponse(String scopeId, String pricingName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public PricingAutoGeneratedInner get(String scopeId, String pricingName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<PricingAutoGeneratedInner>> updateWithResponseAsync(String scopeId, String pricingName,
        PricingAutoGeneratedInner pricing) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<PricingAutoGeneratedInner>> updateWithResponseAsync(String scopeId, String pricingName,
        PricingAutoGeneratedInner pricing, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PricingAutoGeneratedInner> updateAsync(String scopeId, String pricingName,
        PricingAutoGeneratedInner pricing) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<PricingAutoGeneratedInner> updateWithResponse(String scopeId, String pricingName,
        PricingAutoGeneratedInner pricing, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public PricingAutoGeneratedInner update(String scopeId, String pricingName, PricingAutoGeneratedInner pricing) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<PricingListAutoGeneratedInner>> listWithResponseAsync(String scopeId, String filter) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PricingListAutoGeneratedInner> listAsync(String scopeId) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<PricingListAutoGeneratedInner> listWithResponse(String scopeId, String filter, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public PricingListAutoGeneratedInner list(String scopeId) {
        final String filter = null;
