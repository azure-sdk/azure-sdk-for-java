...
public final class AzureDevOpsReposImpl implements AzureDevOpsRepos {
    ...
    public AzureDevOpsReposImpl(
        AzureDevOpsReposClient innerClient, com.azure.resourcemanager.security.SecurityManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public PagedIterable<AzureDevOpsRepository> list(
        ...
        return Utils.mapPage(inner, inner1 -> new AzureDevOpsRepositoryImpl(inner1, this.manager()));
    }
    ...
    public Response<AzureDevOpsRepository> getWithResponse(
        ...
        String repoName,
        Context context) {
        Response<AzureDevOpsRepositoryInner> inner =
            this
                .serviceClient()
    ...
    public AzureDevOpsRepository get(
    ...
    public AzureDevOpsRepository getById(String id) {
        ...
        String orgName = Utils.getValueFromIdByName(id, "azureDevOpsOrgs");
        if (orgName == null) {
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException(
                        String
                            .format("The resource ID '%s' is not valid. Missing path segment 'azureDevOpsOrgs'.", id)));
        }
        ...
        String repoName = Utils.getValueFromIdByName(id, "repos");
        if (repoName == null) {
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException(
