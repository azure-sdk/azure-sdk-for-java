...
public interface SensitivitySettingsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<GetSensitivitySettingsListResponseInner> listSensitivitySettingsWithResponse(Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    GetSensitivitySettingsListResponseInner listSensitivitySettings();
}
