...
public interface SensitivitySettings {
     ...
     */
    Response<GetSensitivitySettingsResponse> updateWithResponse(UpdateSensitivitySettingsRequest sensitivitySettings,
        Context context);
     ...
     */
    GetSensitivitySettingsResponse update(UpdateSensitivitySettingsRequest sensitivitySettings);
