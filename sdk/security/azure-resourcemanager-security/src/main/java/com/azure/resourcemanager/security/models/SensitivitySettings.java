...
public interface SensitivitySettings {
     ...
     */
    Response<GetSensitivitySettingsListResponse> listSensitivitySettingsWithResponse(Context context);
     ...
     */
    GetSensitivitySettingsListResponse listSensitivitySettings();
}
