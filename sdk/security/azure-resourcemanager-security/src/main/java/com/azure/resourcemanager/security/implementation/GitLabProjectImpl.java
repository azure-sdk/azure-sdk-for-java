...
public final class GitLabProjectImpl implements GitLabProject {
    private GitLabProjectInner innerObject;

    private final com.azure.resourcemanager.security.SecurityManager serviceManager;

    GitLabProjectImpl(
        GitLabProjectInner innerObject, com.azure.resourcemanager.security.SecurityManager serviceManager) {
    ...
    public GitLabProjectInner innerModel() {
