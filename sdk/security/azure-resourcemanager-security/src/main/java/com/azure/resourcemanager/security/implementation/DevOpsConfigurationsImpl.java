...
public final class DevOpsConfigurationsImpl implements DevOpsConfigurations {
    ...
    public DevOpsConfigurationsImpl(
        DevOpsConfigurationsClient innerClient, com.azure.resourcemanager.security.SecurityManager serviceManager) {
    ...
    public PagedIterable<DevOpsConfiguration> list(String resourceGroupName, String securityConnectorName) {
        ...
        return Utils.mapPage(inner, inner1 -> new DevOpsConfigurationImpl(inner1, this.manager()));
    }

    public PagedIterable<DevOpsConfiguration> list(
    ...
    public Response<DevOpsConfiguration> getWithResponse(
        String resourceGroupName, String securityConnectorName, Context context) {
    ...
    public DevOpsConfiguration createOrUpdate(
    ...
    public DevOpsConfiguration createOrUpdate(
        ...
        Context context) {
        DevOpsConfigurationInner inner =
            this.serviceClient().createOrUpdate(resourceGroupName, securityConnectorName, devOpsConfiguration, context);
        if (inner != null) {
            return new DevOpsConfigurationImpl(inner, this.manager());
        } else {
            return null;
    ...
    public DevOpsConfiguration update(
        String resourceGroupName, String securityConnectorName, DevOpsConfigurationInner devOpsConfiguration) {
        DevOpsConfigurationInner inner =
