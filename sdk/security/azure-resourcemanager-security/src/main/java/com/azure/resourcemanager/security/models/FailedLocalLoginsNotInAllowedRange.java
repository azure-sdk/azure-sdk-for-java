        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("isEnabled".equals(fieldName)) {
                    ...
                    deserializedFailedLocalLoginsNotInAllowedRange.displayName = reader.getString();
                } else if ("description".equals(fieldName)) {
                    deserializedFailedLocalLoginsNotInAllowedRange.description = reader.getString();
