...
public final class GitLabProjectsImpl implements GitLabProjects {
    ...
    public GitLabProjectsImpl(
        GitLabProjectsClient innerClient, com.azure.resourcemanager.security.SecurityManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public PagedIterable<GitLabProject> list(
        ...
        return Utils.mapPage(inner, inner1 -> new GitLabProjectImpl(inner1, this.manager()));
    }
    ...
    public Response<GitLabProject> getWithResponse(
        String resourceGroupName,
        String securityConnectorName,
        String groupFQName,
        String projectName,
        Context context) {
        Response<GitLabProjectInner> inner =
            this
                .serviceClient()
