...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    OperationsClientImpl(SecurityCenterImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for SecurityCenterOperations to be used by the proxy service to perform
     * REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "SecurityCenterOperat")
     ...
     * @return list of possible operations for Microsoft.Security resource provider along with {@link PagedResponse} on
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return list of possible operations for Microsoft.Security resource provider as paginated response with
     * {@link PagedFlux}.
     */
