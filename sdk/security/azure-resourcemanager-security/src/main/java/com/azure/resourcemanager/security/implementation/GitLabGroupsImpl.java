...
public final class GitLabGroupsImpl implements GitLabGroups {
    ...
    public GitLabGroupsImpl(
        GitLabGroupsClient innerClient, com.azure.resourcemanager.security.SecurityManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public Response<GitLabGroupListResponse> listAvailableWithResponse(
    ...
    public PagedIterable<GitLabGroup> list(String resourceGroupName, String securityConnectorName) {
        ...
        return Utils.mapPage(inner, inner1 -> new GitLabGroupImpl(inner1, this.manager()));
    }
    ...
    public Response<GitLabGroup> getWithResponse(
