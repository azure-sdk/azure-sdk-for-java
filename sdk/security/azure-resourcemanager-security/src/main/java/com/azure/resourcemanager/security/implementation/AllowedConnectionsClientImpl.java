...
public final class AllowedConnectionsClientImpl implements AllowedConnectionsClient {
    ...
    AllowedConnectionsClientImpl(SecurityCenterImpl client) {
        this.service = RestProxy.create(AllowedConnectionsService.class, client.getHttpPipeline(),
    ...
    public interface AllowedConnectionsService {
        ...
        Mono<Response<AllowedConnectionsList>> list(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<AllowedConnectionsList>> listByHomeRegion(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<AllowedConnectionsResourceInner>> get(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("ascLocation") String ascLocation,
            @PathParam("connectionType") ConnectionType connectionType, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<AllowedConnectionsList>> listNext(@PathParam(value = "nextLink", encoded = true) String nextLink,
    ...
    private Mono<PagedResponse<AllowedConnectionsResourceInner>> listSinglePageAsync() {
        ...
        return FluxUtil
            ...
            .<PagedResponse<AllowedConnectionsResourceInner>>map(res -> new PagedResponseBase<>(res.getRequest(),
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the list of all possible traffic between resources for the subscription and location along with
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<AllowedConnectionsResourceInner>> getWithResponseAsync(String resourceGroupName,
        String ascLocation, ConnectionType connectionType) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return FluxUtil
            .withContext(context -> service.get(this.client.getEndpoint(), this.client.getSubscriptionId(),
                resourceGroupName, ascLocation, connectionType, this.client.getApiVersion(), accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<AllowedConnectionsResourceInner>> getWithResponseAsync(String resourceGroupName,
        String ascLocation, ConnectionType connectionType, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service.get(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName, ascLocation,
            connectionType, this.client.getApiVersion(), accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<AllowedConnectionsResourceInner> getAsync(String resourceGroupName, String ascLocation,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<AllowedConnectionsResourceInner> getWithResponse(String resourceGroupName, String ascLocation,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public AllowedConnectionsResourceInner get(String resourceGroupName, String ascLocation,
        ConnectionType connectionType) {
