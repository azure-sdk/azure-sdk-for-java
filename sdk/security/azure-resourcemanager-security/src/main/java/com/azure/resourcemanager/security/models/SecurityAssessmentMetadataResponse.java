...
public interface SecurityAssessmentMetadataResponse {
    ...
    /**
     * Gets the cloudProviders property: The cloudProviders property.
     * 
     * @return the cloudProviders value.
     */
    List<CloudProviders> cloudProviders();

    /**
     * Gets the remediationPolicy property: The Azure Policy definition ID that is used for remediating the assessment.
     * 
     * @return the remediationPolicy value.
     */
    String remediationPolicy();

    /**
     * Gets the managementProvider property: The management provider of the assessment.
     * 
    ...
    interface DefinitionStages {
         ...
         */
        interface WithCreate extends DefinitionStages.WithPublishDates, DefinitionStages.WithPlannedDeprecationDate,
            DefinitionStages.WithTactics, DefinitionStages.WithTechniques, DefinitionStages.WithCloudProviders,
            DefinitionStages.WithRemediationPolicy, DefinitionStages.WithManagementProvider,
            DefinitionStages.WithDisplayName, DefinitionStages.WithDescription,
            DefinitionStages.WithRemediationDescription, DefinitionStages.WithCategories, DefinitionStages.WithSeverity,
            DefinitionStages.WithUserImpact, DefinitionStages.WithImplementationEffort, DefinitionStages.WithThreats,
            DefinitionStages.WithPreview, DefinitionStages.WithAssessmentType, DefinitionStages.WithPartnerData {
            /**
        ...
        /**
         * The stage of the SecurityAssessmentMetadataResponse definition allowing to specify cloudProviders.
         */
        interface WithCloudProviders {
            /**
             * Specifies the cloudProviders property: The cloudProviders property..
             * 
             * @param cloudProviders The cloudProviders property.
             * @return the next definition stage.
             */
            WithCreate withCloudProviders(List<CloudProviders> cloudProviders);
        }

        /**
         * The stage of the SecurityAssessmentMetadataResponse definition allowing to specify remediationPolicy.
         */
        interface WithRemediationPolicy {
            /**
             * Specifies the remediationPolicy property: The Azure Policy definition ID that is used for remediating the
             * assessment.
             * 
             * @param remediationPolicy The Azure Policy definition ID that is used for remediating the assessment.
             * @return the next definition stage.
             */
            WithCreate withRemediationPolicy(String remediationPolicy);
        }

        /**
         * The stage of the SecurityAssessmentMetadataResponse definition allowing to specify managementProvider.
         */
        interface WithManagementProvider {
            /**
             * Specifies the managementProvider property: The management provider of the assessment.
             * 
             * @param managementProvider The management provider of the assessment.
             * @return the next definition stage.
             */
            WithCreate withManagementProvider(ManagementProvider managementProvider);
        }
