...
public final class ExtensionAutoGenerated {
    ...
    private OperationStatusAutoGenerated2 operationStatus;
     ...
     * @return the ExtensionAutoGenerated object itself.
     */
    public ExtensionAutoGenerated withName(String name) {
        this.name = name;
        return this;
    }
     ...
     * @return the ExtensionAutoGenerated object itself.
     */
    public ExtensionAutoGenerated withIsEnabled(IsEnabled isEnabled) {
     ...
     * @return the ExtensionAutoGenerated object itself.
     */
    public ExtensionAutoGenerated withAdditionalExtensionProperties(Map<String, Object> additionalExtensionProperties) {
     ...
     */
    public OperationStatusAutoGenerated2 operationStatus() {
    ...
    public void validate() {
        if (name() == null) {
            throw LOGGER.logExceptionAsError(
                new IllegalArgumentException("Missing required property name in model ExtensionAutoGenerated"));
        }
        if (isEnabled() == null) {
            throw LOGGER.logExceptionAsError(
                new IllegalArgumentException("Missing required property isEnabled in model ExtensionAutoGenerated"));
        }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(ExtensionAutoGenerated.class);
}
