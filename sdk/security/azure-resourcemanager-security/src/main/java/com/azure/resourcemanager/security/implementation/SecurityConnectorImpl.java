...
public final class SecurityConnectorImpl
    ...
    public SecurityConnectorPropertiesOrganizationalData organizationalData() {
        return this.innerModel().organizationalData();
    }
    ...
    public SecurityConnectorImpl withCloudName(CloudName cloudName) {
        this.innerModel().withCloudName(cloudName);
        return this;
    }
    ...
    public SecurityConnectorImpl withOrganizationalData(
        SecurityConnectorPropertiesOrganizationalData organizationalData) {
        this.innerModel().withOrganizationalData(organizationalData);
        return this;
    }
}
