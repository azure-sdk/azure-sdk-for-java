 ...
 */
@Fluent
public final class PricingAutoGeneratedInner extends ProxyResource {
    /*
     * Pricing data
     */
    @JsonProperty(value = "properties")
    private PricingPropertiesAutoGenerated innerProperties;

    /**
     * Creates an instance of PricingAutoGeneratedInner class.
     */
    public PricingAutoGeneratedInner() {
    }
     ...
     * @return the PricingAutoGeneratedInner object itself.
     */
    public PricingAutoGeneratedInner withPricingTier(PricingTier pricingTier) {
        if (this.innerProperties() == null) {
            this.innerProperties = new PricingPropertiesAutoGenerated();
        }
     ...
     * @return the PricingAutoGeneratedInner object itself.
     */
    public PricingAutoGeneratedInner withSubPlan(String subPlan) {
        if (this.innerProperties() == null) {
            this.innerProperties = new PricingPropertiesAutoGenerated();
        }
     ...
     * @return the PricingAutoGeneratedInner object itself.
     */
    public PricingAutoGeneratedInner withEnforce(Enforce enforce) {
        if (this.innerProperties() == null) {
            this.innerProperties = new PricingPropertiesAutoGenerated();
        }
     ...
     * @return the PricingAutoGeneratedInner object itself.
     */
    public PricingAutoGeneratedInner withExtensions(List<ExtensionAutoGenerated> extensions) {
        if (this.innerProperties() == null) {
            this.innerProperties = new PricingPropertiesAutoGenerated();
        }
