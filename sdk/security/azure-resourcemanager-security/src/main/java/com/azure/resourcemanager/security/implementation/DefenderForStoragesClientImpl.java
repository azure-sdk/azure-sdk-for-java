...
public final class DefenderForStoragesClientImpl implements DefenderForStoragesClient {
    ...
    public interface DefenderForStoragesService {
        ...
        Mono<Response<DefenderForStorageSettingInner>> get(
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<DefenderForStorageSettingInner>> create(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam(value = "resourceId", encoded = true) String resourceId,
            @PathParam("settingName") SettingNameAutoGenerated settingName,
     ...
     * @return the Defender for Storage settings for the specified resource along with {@link Response} on successful
     *     completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<DefenderForStorageSettingInner>> getWithResponseAsync(
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the Defender for Storage settings for the specified resource on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DefenderForStorageSettingInner> getAsync(String resourceId, SettingNameAutoGenerated settingName) {
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the Defender for Storage settings for the specified resource along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<DefenderForStorageSettingInner> getWithResponse(
        String resourceId, SettingNameAutoGenerated settingName, Context context) {
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the Defender for Storage settings for the specified resource.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<DefenderForStorageSettingInner>> createWithResponseAsync(
        String resourceId,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DefenderForStorageSettingInner> createAsync(
        String resourceId,
        SettingNameAutoGenerated settingName,
        DefenderForStorageSettingInner defenderForStorageSetting) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<DefenderForStorageSettingInner> createWithResponse(
        String resourceId,
        SettingNameAutoGenerated settingName,
        DefenderForStorageSettingInner defenderForStorageSetting,
        Context context) {
