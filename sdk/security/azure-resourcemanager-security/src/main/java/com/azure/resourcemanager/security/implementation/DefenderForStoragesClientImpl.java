...
public final class DefenderForStoragesClientImpl implements DefenderForStoragesClient {
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<DefenderForStorageSettingInner>> getWithResponseAsync(String resourceId,
        SettingNameAutoGenerated settingName, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<DefenderForStorageSettingInner> getWithResponse(String resourceId,
        SettingNameAutoGenerated settingName, Context context) {
    ...
    private Mono<Response<DefenderForStorageSettingInner>> createWithResponseAsync(String resourceId,
        SettingNameAutoGenerated settingName, DefenderForStorageSettingInner defenderForStorageSetting) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DefenderForStorageSettingInner> createAsync(String resourceId, SettingNameAutoGenerated settingName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<DefenderForStorageSettingInner> createWithResponse(String resourceId,
        SettingNameAutoGenerated settingName, DefenderForStorageSettingInner defenderForStorageSetting,
        Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public DefenderForStorageSettingInner create(String resourceId, SettingNameAutoGenerated settingName,
        DefenderForStorageSettingInner defenderForStorageSetting) {
