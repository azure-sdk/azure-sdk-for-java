...
public final class DefenderForStoragesClientImpl implements DefenderForStoragesClient {
    ...
    private Mono<Response<MalwareScanInner>> startMalwareScanWithResponseAsync(String resourceId,
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.startMalwareScan(this.client.getEndpoint(), this.client.getApiVersion(),
                resourceId, settingName, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<MalwareScanInner>> startMalwareScanWithResponseAsync(String resourceId,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.startMalwareScan(this.client.getEndpoint(), this.client.getApiVersion(), resourceId, settingName,
            accept, context);
    }
    ...
    private Mono<Response<MalwareScanInner>> cancelMalwareScanWithResponseAsync(String resourceId,
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.cancelMalwareScan(this.client.getEndpoint(), this.client.getApiVersion(),
                resourceId, settingName, scanId, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<MalwareScanInner>> cancelMalwareScanWithResponseAsync(String resourceId,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.cancelMalwareScan(this.client.getEndpoint(), this.client.getApiVersion(), resourceId,
    ...
    private Mono<Response<MalwareScanInner>> getMalwareScanWithResponseAsync(String resourceId, SettingName settingName,
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.getMalwareScan(this.client.getEndpoint(), this.client.getApiVersion(),
                resourceId, settingName, scanId, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<MalwareScanInner>> getMalwareScanWithResponseAsync(String resourceId, SettingName settingName,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.getMalwareScan(this.client.getEndpoint(), this.client.getApiVersion(), resourceId, settingName,
            scanId, accept, context);
    }
