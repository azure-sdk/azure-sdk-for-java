...
public final class SensitivitySettingsClientImpl implements SensitivitySettingsClient {
    ...
    public interface SensitivitySettingsService {
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<GetSensitivitySettingsListResponseInner>> listSensitivitySettings(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept,
            Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<GetSensitivitySettingsListResponseInner>> listSensitivitySettingsWithResponseAsync() {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
        ...
        return FluxUtil
            .withContext(
                context -> service.listSensitivitySettings(this.client.getEndpoint(), apiVersion, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<GetSensitivitySettingsListResponseInner>> listSensitivitySettingsWithResponseAsync(
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.listSensitivitySettings(this.client.getEndpoint(), apiVersion, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<GetSensitivitySettingsListResponseInner> listSensitivitySettingsAsync() {
        return listSensitivitySettingsWithResponseAsync().flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<GetSensitivitySettingsListResponseInner> listSensitivitySettingsWithResponse(Context context) {
        return listSensitivitySettingsWithResponseAsync(context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public GetSensitivitySettingsListResponseInner listSensitivitySettings() {
        return listSensitivitySettingsWithResponse(Context.NONE).getValue();
    }
}
