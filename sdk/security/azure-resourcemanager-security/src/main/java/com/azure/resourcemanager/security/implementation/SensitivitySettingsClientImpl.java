...
public final class SensitivitySettingsClientImpl implements SensitivitySettingsClient {
    ...
    public interface SensitivitySettingsService {
        ...
        Mono<Response<GetSensitivitySettingsResponseInner>> update(@HostParam("$host") String endpoint,
    ...
    private Mono<Response<GetSensitivitySettingsResponseInner>>
        updateWithResponseAsync(UpdateSensitivitySettingsRequest sensitivitySettings) {
        ...
        return FluxUtil
            .withContext(
                context -> service.update(this.client.getEndpoint(), apiVersion, sensitivitySettings, accept, context))
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<GetSensitivitySettingsResponseInner>>
        updateWithResponseAsync(UpdateSensitivitySettingsRequest sensitivitySettings, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service.update(this.client.getEndpoint(), apiVersion, sensitivitySettings, accept, context);
    }
    ...
    private Mono<GetSensitivitySettingsResponseInner>
        updateAsync(UpdateSensitivitySettingsRequest sensitivitySettings) {
        return updateWithResponseAsync(sensitivitySettings).flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
    ...
    public Response<GetSensitivitySettingsResponseInner>
        updateWithResponse(UpdateSensitivitySettingsRequest sensitivitySettings, Context context) {
        return updateWithResponseAsync(sensitivitySettings, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public GetSensitivitySettingsResponseInner update(UpdateSensitivitySettingsRequest sensitivitySettings) {
        return updateWithResponse(sensitivitySettings, Context.NONE).getValue();
    }
