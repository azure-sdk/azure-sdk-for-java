...
public final class SensitivitySettingsClientImpl implements SensitivitySettingsClient {
    ...
    public interface SensitivitySettingsService {
        ...
        Mono<Response<GetSensitivitySettingsResponseInner>> createOrUpdate(
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<GetSensitivitySettingsResponseInner>> get(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<GetSensitivitySettingsListResponseInner>> list(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept,
            Context context);
    ...
    private Mono<Response<GetSensitivitySettingsResponseInner>> createOrUpdateWithResponseAsync(
        ...
        return FluxUtil
            .withContext(
                context ->
                    service.createOrUpdate(this.client.getEndpoint(), apiVersion, sensitivitySettings, accept, context))
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<GetSensitivitySettingsResponseInner> createOrUpdateAsync(
        UpdateSensitivitySettingsRequest sensitivitySettings) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<GetSensitivitySettingsResponseInner> createOrUpdateWithResponse(
        UpdateSensitivitySettingsRequest sensitivitySettings, Context context) {
    ...
    private Mono<Response<GetSensitivitySettingsResponseInner>> getWithResponseAsync() {
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.get(this.client.getEndpoint(), apiVersion, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
