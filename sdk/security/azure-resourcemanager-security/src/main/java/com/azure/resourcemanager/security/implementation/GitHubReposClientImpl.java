...
public final class GitHubReposClientImpl implements GitHubReposClient {
    ...
    public interface GitHubReposService {
        ...
        Mono<Response<GitHubRepositoryListResponse>> list(
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<GitHubRepositoryInner>> get(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("securityConnectorName") String securityConnectorName,
    ...
    private Mono<PagedResponse<GitHubRepositoryInner>> listSinglePageAsync(
        String resourceGroupName, String securityConnectorName, String ownerName) {
                ...
                context ->
                    service
                        .list(
                            ...
                            accept,
                            context))
            .<PagedResponse<GitHubRepositoryInner>>map(
                res ->
    ...
    private PagedFlux<GitHubRepositoryInner> listAsync(
        String resourceGroupName, String securityConnectorName, String ownerName) {
        return new PagedFlux<>(
            () -> listSinglePageAsync(resourceGroupName, securityConnectorName, ownerName),
    ...
    private PagedFlux<GitHubRepositoryInner> listAsync(
        String resourceGroupName, String securityConnectorName, String ownerName, Context context) {
        return new PagedFlux<>(
            () -> listSinglePageAsync(resourceGroupName, securityConnectorName, ownerName, context),
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<GitHubRepositoryInner> list(
        String resourceGroupName, String securityConnectorName, String ownerName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<GitHubRepositoryInner>> getWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<GitHubRepositoryInner> getAsync(
        String resourceGroupName, String securityConnectorName, String ownerName, String repoName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<GitHubRepositoryInner> getWithResponse(
        String resourceGroupName, String securityConnectorName, String ownerName, String repoName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public GitHubRepositoryInner get(
        String resourceGroupName, String securityConnectorName, String ownerName, String repoName) {
