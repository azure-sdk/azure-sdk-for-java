...
/** Resource collection API of ManagementGroupGovernanceRulesExecuteStatus. */
public interface ManagementGroupGovernanceRulesExecuteStatus {
    /**
     ...
     */
    Response<ExecuteRuleStatus> getWithResponse(
     ...
     * @return a specific governance rule execution status for the requested scope by ruleId and operationId.
     */
    ExecuteRuleStatus get(String managementGroupId, String ruleId, String operationId);
}
