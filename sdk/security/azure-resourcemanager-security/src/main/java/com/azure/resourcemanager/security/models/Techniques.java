...
public final class Techniques extends ExpandableStringEnum<Techniques> {
    ...
    /**
     * Static value Cloud Storage Object Discovery for Techniques.
     */
    public static final Techniques CLOUD_STORAGE_OBJECT_DISCOVERY = fromString("Cloud Storage Object Discovery");

    /**
     * Static value Weaken Encryption for Techniques.
     */
    public static final Techniques WEAKEN_ENCRYPTION = fromString("Weaken Encryption");

    /**
     * Static value Network Service Discovery for Techniques.
     */
    public static final Techniques NETWORK_SERVICE_DISCOVERY = fromString("Network Service Discovery");

    /**
     * Static value Exfiltration over C2 Channel for Techniques.
     */
    public static final Techniques EXFILTRATION_OVER_C2_CHANNEL = fromString("Exfiltration over C2 Channel");

    /**
     * Static value Steal Application Access Token for Techniques.
     */
    public static final Techniques STEAL_APPLICATION_ACCESS_TOKEN = fromString("Steal Application Access Token");

    /**
     * Static value Gather Victim Host Information for Techniques.
     */
    public static final Techniques GATHER_VICTIM_HOST_INFORMATION = fromString("Gather Victim Host Information");
