        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("isEnabled".equals(fieldName)) {
                    ...
                    deserializedDenylistCustomAlertRule.displayName = reader.getString();
                } else if ("description".equals(fieldName)) {
                    deserializedDenylistCustomAlertRule.description = reader.getString();
                } else if ("valueType".equals(fieldName)) {
                    deserializedDenylistCustomAlertRule.valueType = ValueType.fromString(reader.getString());
