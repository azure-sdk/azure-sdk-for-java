...
public final class DevOpsConfigurationsClientImpl implements DevOpsConfigurationsClient {
    ...
    DevOpsConfigurationsClientImpl(SecurityCenterImpl client) {
        this.service =
            RestProxy
                .create(DevOpsConfigurationsService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }
    ...
    public interface DevOpsConfigurationsService {
        ...
        Mono<Response<DevOpsConfigurationListResponse>> list(
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<DevOpsConfigurationInner>> get(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("securityConnectorName") String securityConnectorName,
    ...
    private Mono<PagedResponse<DevOpsConfigurationInner>> listSinglePageAsync(
                ...
                context ->
                    service
                        .list(
                            ...
                            accept,
                            context))
            .<PagedResponse<DevOpsConfigurationInner>>map(
                res ->
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<DevOpsConfigurationInner> listAsync(
        String resourceGroupName, String securityConnectorName, Context context) {
        return new PagedFlux<>(
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<DevOpsConfigurationInner> list(
        String resourceGroupName, String securityConnectorName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<DevOpsConfigurationInner>> getWithResponseAsync(
        String resourceGroupName, String securityConnectorName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<DevOpsConfigurationInner> getWithResponse(
        String resourceGroupName, String securityConnectorName, Context context) {
    ...
    private PollerFlux<PollResult<DevOpsConfigurationInner>, DevOpsConfigurationInner> beginCreateOrUpdateAsync(
        ...
        return this
            .client
            .<DevOpsConfigurationInner, DevOpsConfigurationInner>getLroResult(
                mono,
                this.client.getHttpPipeline(),
                DevOpsConfigurationInner.class,
                DevOpsConfigurationInner.class,
    ...
    public SyncPoller<PollResult<DevOpsConfigurationInner>, DevOpsConfigurationInner> beginCreateOrUpdate(
        String resourceGroupName, String securityConnectorName, DevOpsConfigurationInner devOpsConfiguration) {
        return this
            .beginCreateOrUpdateAsync(resourceGroupName, securityConnectorName, devOpsConfiguration)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<DevOpsConfigurationInner>, DevOpsConfigurationInner> beginCreateOrUpdate(
        ...
        Context context) {
        return this
            .beginCreateOrUpdateAsync(resourceGroupName, securityConnectorName, devOpsConfiguration, context)
            .getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DevOpsConfigurationInner> createOrUpdateAsync(
        String resourceGroupName, String securityConnectorName, DevOpsConfigurationInner devOpsConfiguration) {
        return beginCreateOrUpdateAsync(resourceGroupName, securityConnectorName, devOpsConfiguration)
            .last()
    ...
    private Mono<DevOpsConfigurationInner> createOrUpdateAsync(
        ...
        DevOpsConfigurationInner devOpsConfiguration,
        Context context) {
        return beginCreateOrUpdateAsync(resourceGroupName, securityConnectorName, devOpsConfiguration, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public DevOpsConfigurationInner createOrUpdate(
        String resourceGroupName, String securityConnectorName, DevOpsConfigurationInner devOpsConfiguration) {
    ...
    public SyncPoller<PollResult<DevOpsConfigurationInner>, DevOpsConfigurationInner> beginUpdate(
        ...
        Context context) {
        return this
            .beginUpdateAsync(resourceGroupName, securityConnectorName, devOpsConfiguration, context)
            .getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DevOpsConfigurationInner> updateAsync(
        String resourceGroupName, String securityConnectorName, DevOpsConfigurationInner devOpsConfiguration) {
        return beginUpdateAsync(resourceGroupName, securityConnectorName, devOpsConfiguration)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<DevOpsConfigurationInner> updateAsync(
        ...
        DevOpsConfigurationInner devOpsConfiguration,
        Context context) {
        return beginUpdateAsync(resourceGroupName, securityConnectorName, devOpsConfiguration, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public DevOpsConfigurationInner update(
        String resourceGroupName, String securityConnectorName, DevOpsConfigurationInner devOpsConfiguration) {
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String securityConnectorName) {
        return beginDeleteAsync(resourceGroupName, securityConnectorName)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String securityConnectorName, Context context) {
        return beginDeleteAsync(resourceGroupName, securityConnectorName, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
