        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("isEnabled".equals(fieldName)) {
                    ...
                    deserializedProcessNotAllowed.displayName = reader.getString();
                } else if ("description".equals(fieldName)) {
                    deserializedProcessNotAllowed.description = reader.getString();
                } else if ("valueType".equals(fieldName)) {
                    deserializedProcessNotAllowed.valueType = ValueType.fromString(reader.getString());
