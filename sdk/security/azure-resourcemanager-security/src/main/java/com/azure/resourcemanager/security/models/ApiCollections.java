...
public interface ApiCollections {
     ...
     *     response with {@link PagedIterable}.
     */
    PagedIterable<ApiCollection> listByAzureApiManagementService(
     ...
     *     Response}.
     */
    Response<ApiCollection> getByAzureApiManagementServiceWithResponse(
     ...
     * @return an API collection as represented by Microsoft Defender for APIs.
     */
    ApiCollection onboardAzureApiManagementApi(
        String resourceGroupName, String serviceName, String apiId, Context context);
