...
public final class AzureDevOpsOrgsImpl implements AzureDevOpsOrgs {
    ...
    public AzureDevOpsOrgsImpl(
        AzureDevOpsOrgsClient innerClient, com.azure.resourcemanager.security.SecurityManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public Response<AzureDevOpsOrgListResponse> listAvailableWithResponse(
