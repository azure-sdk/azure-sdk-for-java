...
public final class RegulatoryComplianceControlsClientImpl implements RegulatoryComplianceControlsClient {
    ...
    RegulatoryComplianceControlsClientImpl(SecurityCenterImpl client) {
        this.service = RestProxy.create(RegulatoryComplianceControlsService.class, client.getHttpPipeline(),
    ...
    public interface RegulatoryComplianceControlsService {
        ...
        Mono<Response<RegulatoryComplianceControlList>> list(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<RegulatoryComplianceControlInner>> get(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("regulatoryComplianceStandardName") String regulatoryComplianceStandardName,
    ...
    private Mono<PagedResponse<RegulatoryComplianceControlInner>>
        listSinglePageAsync(String regulatoryComplianceStandardName, String filter) {
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<RegulatoryComplianceControlInner>>
        listSinglePageAsync(String regulatoryComplianceStandardName, String filter, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    private PagedFlux<RegulatoryComplianceControlInner> listAsync(String regulatoryComplianceStandardName,
        String filter) {
        return new PagedFlux<>(() -> listSinglePageAsync(regulatoryComplianceStandardName, filter),
    ...
    private PagedFlux<RegulatoryComplianceControlInner> listAsync(String regulatoryComplianceStandardName,
        ...
        return new PagedFlux<>(() -> listSinglePageAsync(regulatoryComplianceStandardName, filter, context),
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<RegulatoryComplianceControlInner> list(String regulatoryComplianceStandardName, String filter,
        Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<RegulatoryComplianceControlInner>>
        getWithResponseAsync(String regulatoryComplianceStandardName, String regulatoryComplianceControlName) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<RegulatoryComplianceControlInner> getAsync(String regulatoryComplianceStandardName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<RegulatoryComplianceControlInner> getWithResponse(String regulatoryComplianceStandardName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public RegulatoryComplianceControlInner get(String regulatoryComplianceStandardName,
        String regulatoryComplianceControlName) {
