...
public final class SecuritySolutionsReferenceDatasClientImpl implements SecuritySolutionsReferenceDatasClient {
    ...
    SecuritySolutionsReferenceDatasClientImpl(SecurityCenterImpl client) {
        this.service = RestProxy.create(SecuritySolutionsReferenceDatasService.class, client.getHttpPipeline(),
    ...
    public interface SecuritySolutionsReferenceDatasService {
        ...
        Mono<Response<SecuritySolutionsReferenceDataListInner>> list(@HostParam("$host") String endpoint,
    ...
    private Mono<Response<SecuritySolutionsReferenceDataListInner>>
        listByHomeRegionWithResponseAsync(String ascLocation) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return list of all supported Security Solutions for subscription and location on successful completion of
     * {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
