...
public final class AzureDevOpsProjectsClientImpl implements AzureDevOpsProjectsClient {
    ...
    private PagedFlux<AzureDevOpsProjectInner> listAsync(
        ...
        return new PagedFlux<>(
            () -> listSinglePageAsync(resourceGroupName, securityConnectorName, orgName),
    ...
    private PagedFlux<AzureDevOpsProjectInner> listAsync(
        String resourceGroupName, String securityConnectorName, String orgName, Context context) {
        return new PagedFlux<>(
            () -> listSinglePageAsync(resourceGroupName, securityConnectorName, orgName, context),
    ...
    private PollerFlux<PollResult<AzureDevOpsProjectInner>, AzureDevOpsProjectInner> beginCreateOrUpdateAsync(
        ...
        Mono<Response<Flux<ByteBuffer>>> mono =
            createOrUpdateWithResponseAsync(
                resourceGroupName, securityConnectorName, orgName, projectName, azureDevOpsProject);
        return this
            .client
    ...
    private PollerFlux<PollResult<AzureDevOpsProjectInner>, AzureDevOpsProjectInner> beginCreateOrUpdateAsync(
        ...
        Mono<Response<Flux<ByteBuffer>>> mono =
            createOrUpdateWithResponseAsync(
                resourceGroupName, securityConnectorName, orgName, projectName, azureDevOpsProject, context);
        return this
            .client
            .<AzureDevOpsProjectInner, AzureDevOpsProjectInner>getLroResult(
                mono,
    ...
    private PollerFlux<PollResult<AzureDevOpsProjectInner>, AzureDevOpsProjectInner> beginUpdateAsync(
        ...
        AzureDevOpsProjectInner azureDevOpsProject) {
        Mono<Response<Flux<ByteBuffer>>> mono =
            updateWithResponseAsync(resourceGroupName, securityConnectorName, orgName, projectName, azureDevOpsProject);
        return this
            .client
            .<AzureDevOpsProjectInner, AzureDevOpsProjectInner>getLroResult(
                mono,
