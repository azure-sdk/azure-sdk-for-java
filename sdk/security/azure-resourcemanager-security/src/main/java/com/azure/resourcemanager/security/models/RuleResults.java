...
public interface RuleResults {
    ...
    interface DefinitionStages {
        ...
        interface WithResults {
            /**
             * Specifies the results property: Expected results to be inserted into the baseline. Leave this field empty
             * it LatestScan == true..
             *
             * @param results Expected results to be inserted into the baseline. Leave this field empty it LatestScan ==
             *     true.
             * @return the next definition stage.
             */
