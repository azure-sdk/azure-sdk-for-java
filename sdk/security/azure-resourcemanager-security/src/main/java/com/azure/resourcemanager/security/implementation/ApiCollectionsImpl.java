...
public final class ApiCollectionsImpl implements ApiCollections {
    ...
    public PagedIterable<ApiCollection> listByAzureApiManagementService(
    ...
    public Response<ApiCollection> getByAzureApiManagementServiceWithResponse(
    ...
    public ApiCollection onboardAzureApiManagementApi(
        String resourceGroupName, String serviceName, String apiId, Context context) {
        ApiCollectionInner inner =
