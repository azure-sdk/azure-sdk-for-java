...
public final class GitLabProjectsClientImpl implements GitLabProjectsClient {
    ...
    public interface GitLabProjectsService {
        ...
        Mono<Response<GitLabProjectListResponse>> list(
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<GitLabProjectInner>> get(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("securityConnectorName") String securityConnectorName,
    ...
    private Mono<PagedResponse<GitLabProjectInner>> listSinglePageAsync(
                ...
                context ->
                    service
                        .list(
                            ...
                            accept,
                            context))
            .<PagedResponse<GitLabProjectInner>>map(
                res ->
    ...
    private PagedFlux<GitLabProjectInner> listAsync(
        String resourceGroupName, String securityConnectorName, String groupFQName) {
        return new PagedFlux<>(
            () -> listSinglePageAsync(resourceGroupName, securityConnectorName, groupFQName),
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<GitLabProjectInner> list(
        String resourceGroupName, String securityConnectorName, String groupFQName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<GitLabProjectInner>> getWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<GitLabProjectInner> getAsync(
        String resourceGroupName, String securityConnectorName, String groupFQName, String projectName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<GitLabProjectInner> getWithResponse(
        String resourceGroupName,
        String securityConnectorName,
        String groupFQName,
        String projectName,
