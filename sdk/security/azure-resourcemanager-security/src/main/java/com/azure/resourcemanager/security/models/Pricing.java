...
public interface Pricing {
    ...
    /**
     * Gets the deprecated property: (optional) will return true if the pricing bundle is deprecated.
     *
    ...
    /**
     * Gets the replacedBy property: (optional) List of pricing bundles which replace the deprecated bundle, if
     * deprecated is true.
     *
