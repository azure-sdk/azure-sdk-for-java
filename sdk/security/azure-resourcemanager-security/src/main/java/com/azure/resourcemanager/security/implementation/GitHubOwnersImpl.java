...
public final class GitHubOwnersImpl implements GitHubOwners {
    ...
    public GitHubOwnersImpl(
        GitHubOwnersClient innerClient, com.azure.resourcemanager.security.SecurityManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public Response<GitHubOwnerListResponse> listAvailableWithResponse(
