...
public final class AzureDevOpsOrgsClientImpl implements AzureDevOpsOrgsClient {
    ...
    private Mono<Response<AzureDevOpsOrgInner>> getWithResponseAsync(String resourceGroupName,
        ...
        return service.get(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            securityConnectorName, orgName, this.client.getApiVersion(), accept, context);
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(context -> service.createOrUpdate(this.client.getEndpoint(), this.client.getSubscriptionId(),
                resourceGroupName, securityConnectorName, orgName, this.client.getApiVersion(), azureDevOpsOrg, accept,
                context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String resourceGroupName,
        ...
        return service.createOrUpdate(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            securityConnectorName, orgName, this.client.getApiVersion(), azureDevOpsOrg, accept, context);
    }
    ...
    private PollerFlux<PollResult<AzureDevOpsOrgInner>, AzureDevOpsOrgInner> beginCreateOrUpdateAsync(
        ...
        Mono<Response<Flux<ByteBuffer>>> mono = createOrUpdateWithResponseAsync(resourceGroupName,
            securityConnectorName, orgName, azureDevOpsOrg, context);
        return this.client.<AzureDevOpsOrgInner, AzureDevOpsOrgInner>getLroResult(mono, this.client.getHttpPipeline(),
            AzureDevOpsOrgInner.class, AzureDevOpsOrgInner.class, context);
    }
    ...
    public SyncPoller<PollResult<AzureDevOpsOrgInner>, AzureDevOpsOrgInner> beginCreateOrUpdate(
        String resourceGroupName, String securityConnectorName, String orgName, AzureDevOpsOrgInner azureDevOpsOrg) {
        return this.beginCreateOrUpdateAsync(resourceGroupName, securityConnectorName, orgName, azureDevOpsOrg)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<AzureDevOpsOrgInner>, AzureDevOpsOrgInner> beginCreateOrUpdate(
        String resourceGroupName, String securityConnectorName, String orgName, AzureDevOpsOrgInner azureDevOpsOrg,
        Context context) {
        return this.beginCreateOrUpdateAsync(resourceGroupName, securityConnectorName, orgName, azureDevOpsOrg, context)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<AzureDevOpsOrgInner>, AzureDevOpsOrgInner> beginUpdate(String resourceGroupName,
        String securityConnectorName, String orgName, AzureDevOpsOrgInner azureDevOpsOrg, Context context) {
        return this.beginUpdateAsync(resourceGroupName, securityConnectorName, orgName, azureDevOpsOrg, context)
            .getSyncPoller();
    }
    ...
    private Mono<AzureDevOpsOrgInner> updateAsync(String resourceGroupName, String securityConnectorName,
        String orgName, AzureDevOpsOrgInner azureDevOpsOrg, Context context) {
        return beginUpdateAsync(resourceGroupName, securityConnectorName, orgName, azureDevOpsOrg, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
