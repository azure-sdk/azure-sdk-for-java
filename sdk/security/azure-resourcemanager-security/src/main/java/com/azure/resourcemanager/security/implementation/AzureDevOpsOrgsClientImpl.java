...
public final class AzureDevOpsOrgsClientImpl implements AzureDevOpsOrgsClient {
    ...
    public interface AzureDevOpsOrgsService {
        ...
        Mono<Response<AzureDevOpsOrgListResponseInner>> listAvailable(
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<AzureDevOpsOrgListResponseInner>> list(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("securityConnectorName") String securityConnectorName,
    ...
    private Mono<Response<AzureDevOpsOrgListResponseInner>> listAvailableWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<AzureDevOpsOrgListResponseInner> listAvailableAsync(
        String resourceGroupName, String securityConnectorName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<AzureDevOpsOrgListResponseInner> listAvailableWithResponse(
        String resourceGroupName, String securityConnectorName, Context context) {
    ...
    private PagedFlux<AzureDevOpsOrgInner> listAsync(String resourceGroupName, String securityConnectorName) {
        return new PagedFlux<>(
            () -> listSinglePageAsync(resourceGroupName, securityConnectorName),
    ...
    private PagedFlux<AzureDevOpsOrgInner> listAsync(
        String resourceGroupName, String securityConnectorName, Context context) {
        return new PagedFlux<>(
            () -> listSinglePageAsync(resourceGroupName, securityConnectorName, context),
    ...
    private Mono<Response<AzureDevOpsOrgInner>> getWithResponseAsync(
        String resourceGroupName, String securityConnectorName, String orgName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    public Response<AzureDevOpsOrgInner> getWithResponse(
        String resourceGroupName, String securityConnectorName, String orgName, Context context) {
        return getWithResponseAsync(resourceGroupName, securityConnectorName, orgName, context).block();
    }
    ...
    private PollerFlux<PollResult<AzureDevOpsOrgInner>, AzureDevOpsOrgInner> beginCreateOrUpdateAsync(
        ...
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono =
            createOrUpdateWithResponseAsync(resourceGroupName, securityConnectorName, orgName, azureDevOpsOrg, context);
        return this
            .client
            .<AzureDevOpsOrgInner, AzureDevOpsOrgInner>getLroResult(
    ...
    public SyncPoller<PollResult<AzureDevOpsOrgInner>, AzureDevOpsOrgInner> beginCreateOrUpdate(
        String resourceGroupName, String securityConnectorName, String orgName, AzureDevOpsOrgInner azureDevOpsOrg) {
        return this
            .beginCreateOrUpdateAsync(resourceGroupName, securityConnectorName, orgName, azureDevOpsOrg)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<AzureDevOpsOrgInner>, AzureDevOpsOrgInner> beginCreateOrUpdate(
        ...
        Context context) {
        return this
            .beginCreateOrUpdateAsync(resourceGroupName, securityConnectorName, orgName, azureDevOpsOrg, context)
            .getSyncPoller();
    }
    ...
    private Mono<AzureDevOpsOrgInner> createOrUpdateAsync(
        String resourceGroupName, String securityConnectorName, String orgName, AzureDevOpsOrgInner azureDevOpsOrg) {
        return beginCreateOrUpdateAsync(resourceGroupName, securityConnectorName, orgName, azureDevOpsOrg)
            .last()
    ...
    private Mono<AzureDevOpsOrgInner> createOrUpdateAsync(
        ...
        AzureDevOpsOrgInner azureDevOpsOrg,
        Context context) {
        return beginCreateOrUpdateAsync(resourceGroupName, securityConnectorName, orgName, azureDevOpsOrg, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    public AzureDevOpsOrgInner createOrUpdate(
        String resourceGroupName, String securityConnectorName, String orgName, AzureDevOpsOrgInner azureDevOpsOrg) {
        return createOrUpdateAsync(resourceGroupName, securityConnectorName, orgName, azureDevOpsOrg).block();
    }
    ...
    public AzureDevOpsOrgInner createOrUpdate(
        ...
        AzureDevOpsOrgInner azureDevOpsOrg,
        Context context) {
        return createOrUpdateAsync(resourceGroupName, securityConnectorName, orgName, azureDevOpsOrg, context).block();
    }
    ...
    private PollerFlux<PollResult<AzureDevOpsOrgInner>, AzureDevOpsOrgInner> beginUpdateAsync(
        ...
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono =
            updateWithResponseAsync(resourceGroupName, securityConnectorName, orgName, azureDevOpsOrg, context);
        return this
            .client
            .<AzureDevOpsOrgInner, AzureDevOpsOrgInner>getLroResult(
                mono, this.client.getHttpPipeline(), AzureDevOpsOrgInner.class, AzureDevOpsOrgInner.class, context);
    ...
    public SyncPoller<PollResult<AzureDevOpsOrgInner>, AzureDevOpsOrgInner> beginUpdate(
        ...
        Context context) {
        return this
            .beginUpdateAsync(resourceGroupName, securityConnectorName, orgName, azureDevOpsOrg, context)
            .getSyncPoller();
    }
    ...
    private Mono<AzureDevOpsOrgInner> updateAsync(
        String resourceGroupName, String securityConnectorName, String orgName, AzureDevOpsOrgInner azureDevOpsOrg) {
        return beginUpdateAsync(resourceGroupName, securityConnectorName, orgName, azureDevOpsOrg)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<AzureDevOpsOrgInner> updateAsync(
        ...
        AzureDevOpsOrgInner azureDevOpsOrg,
        Context context) {
        return beginUpdateAsync(resourceGroupName, securityConnectorName, orgName, azureDevOpsOrg, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    public AzureDevOpsOrgInner update(
        String resourceGroupName, String securityConnectorName, String orgName, AzureDevOpsOrgInner azureDevOpsOrg) {
        return updateAsync(resourceGroupName, securityConnectorName, orgName, azureDevOpsOrg).block();
    }
    ...
    public AzureDevOpsOrgInner update(
        ...
        AzureDevOpsOrgInner azureDevOpsOrg,
        Context context) {
        return updateAsync(resourceGroupName, securityConnectorName, orgName, azureDevOpsOrg, context).block();
    }
