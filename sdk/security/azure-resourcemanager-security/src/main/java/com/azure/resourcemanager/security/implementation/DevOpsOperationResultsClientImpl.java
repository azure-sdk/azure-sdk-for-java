...
public final class DevOpsOperationResultsClientImpl implements DevOpsOperationResultsClient {
    ...
    DevOpsOperationResultsClientImpl(SecurityCenterImpl client) {
        this.service =
            RestProxy
                .create(DevOpsOperationResultsService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }
     ...
     * @return devops long running operation result along with {@link Response} on successful completion of {@link
     *     Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<OperationStatusResultInner>> getWithResponseAsync(
        String resourceGroupName, String securityConnectorName, String operationResultId) {
