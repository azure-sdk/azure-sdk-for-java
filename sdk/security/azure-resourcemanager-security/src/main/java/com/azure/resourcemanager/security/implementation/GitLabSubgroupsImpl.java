...
public final class GitLabSubgroupsImpl implements GitLabSubgroups {
    ...
    public GitLabSubgroupsImpl(
        GitLabSubgroupsClient innerClient, com.azure.resourcemanager.security.SecurityManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public Response<GitLabGroupListResponse> listWithResponse(
