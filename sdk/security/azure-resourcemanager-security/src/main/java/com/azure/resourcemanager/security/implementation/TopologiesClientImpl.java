...
public final class TopologiesClientImpl implements TopologiesClient {
    ...
    public interface TopologiesService {
        ...
        Mono<Response<TopologyList>> list(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<TopologyList>> listByHomeRegion(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<TopologyResourceInner>> get(@HostParam("$host") String endpoint,
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a list that allows to build a topology view of a subscription and location along with
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<TopologyResourceInner>> getWithResponseAsync(String resourceGroupName, String ascLocation,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<TopologyResourceInner> getAsync(String resourceGroupName, String ascLocation,
        String topologyResourceName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<TopologyResourceInner> getWithResponse(String resourceGroupName, String ascLocation,
        String topologyResourceName, Context context) {
