...
- [CreateOrUpdate](#vmscanners_createorupdate)
- [Delete](#vmscanners_delete)
- [Get](#vmscanners_get)
- [ListBySubscription](#vmscanners_listbysubscription)
...
public final class SecurityConnectorsCreateOrUpdateSamples {
    /*
     * x-ms-original-file: specification/security/resource-manager/Microsoft.Security/preview/2022-05-01-preview/examples/SecurityConnectors/PutSecurityConnector_example.json
     */
    /**
...
public final class SecurityConnectorsListSamples {
    /*
     * x-ms-original-file: specification/security/resource-manager/Microsoft.Security/preview/2022-05-01-preview/examples/SecurityConnectors/GetSecurityConnectorsSubscription_example.json
     */
    /**
...
### VmScanners_CreateOrUpdate

```java
import com.azure.core.util.Context;

/** Samples for VmScanners CreateOrUpdate. */
public final class VmScannersCreateOrUpdateSamples {
    /*
     * x-ms-original-file: specification/security/resource-manager/Microsoft.Security/preview/2022-03-01-preview/examples/VmScanners/CreateVmScanner_example.json
     */
    /**
     * Sample code: Create or update a VM scanner configuration.
     *
     * @param manager Entry point to SecurityManager.
     */
    public static void createOrUpdateAVMScannerConfiguration(
        com.azure.resourcemanager.security.SecurityManager manager) {
        manager.vmScanners().createOrUpdateWithResponse("default", Context.NONE);
    }
}
```
...
### VmScanners_ListBySubscription

```java
import com.azure.core.util.Context;

/** Samples for VmScanners ListBySubscription. */
public final class VmScannersListBySubscriptionSamples {
    /*
     * x-ms-original-file: specification/security/resource-manager/Microsoft.Security/preview/2022-03-01-preview/examples/VmScanners/ListBySubscriptionVmScanners_example.json
     */
    /**
     * Sample code: Gets the subscription's VM scanner configurations.
     *
     * @param manager Entry point to SecurityManager.
     */
    public static void getsTheSubscriptionSVMScannerConfigurations(
        com.azure.resourcemanager.security.SecurityManager manager) {
        manager.vmScanners().listBySubscriptionWithResponse(Context.NONE);
    }
}
```
