...
- [Create](#apicollections_create)
- [Delete](#apicollections_delete)
- [Get](#apicollections_get)
...
### ApiCollections_Create

```java
/** Samples for ApiCollections Create. */
public final class ApiCollectionsCreateSamples {
    /*
     * x-ms-original-file: specification/security/resource-manager/Microsoft.Security/preview/2022-11-20-preview/examples/ApiCollections/CreateAPICollection_example.json
     */
    /**
...
### ApiCollections_Delete

```java
/** Samples for ApiCollections Delete. */
public final class ApiCollectionsDeleteSamples {
    /*
     * x-ms-original-file: specification/security/resource-manager/Microsoft.Security/preview/2022-11-20-preview/examples/ApiCollections/DeleteAPICollection_example.json
     */
    /**
...
```java
/** Samples for ApiCollections Get. */
public final class ApiCollectionsGetSamples {
    /*
     * x-ms-original-file: specification/security/resource-manager/Microsoft.Security/preview/2022-11-20-preview/examples/ApiCollections/GetAPICollection_example.json
     */
    /**
...
public final class ApiCollectionsListSamples {
    /*
     * x-ms-original-file: specification/security/resource-manager/Microsoft.Security/preview/2022-11-20-preview/examples/ApiCollections/GetAPICollectionsResourceGroup_example.json
     */
    /**
...
public final class SettingsUpdateSamples {
    ...
    public static void updateASettingForSubscription(com.azure.resourcemanager.security.SecurityManager manager) {
        manager
            .settings()
            .updateWithResponse(
                SettingNameAutoGenerated.WDATP,
                new DataExportSettings().withEnabled(true),
                com.azure.core.util.Context.NONE);
    }
}
```
