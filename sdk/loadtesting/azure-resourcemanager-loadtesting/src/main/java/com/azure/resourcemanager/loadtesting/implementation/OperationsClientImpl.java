...
import com.azure.resourcemanager.loadtesting.models.OperationListResult;
...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    OperationsClientImpl(LoadTestClientForTestingImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for LoadTestClientForTestingOperations to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{$host}")
