...
public final class LoadTestResourceUpdate implements JsonSerializable<LoadTestResourceUpdate> {
     ...
     */
    public LoadTestResourceUpdate withIdentity(AzureResourceManagerCommonTypesManagedServiceIdentityUpdate identity) {
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("identity".equals(fieldName)) {
                    deserializedLoadTestResourceUpdate.identity
                    ...
                    deserializedLoadTestResourceUpdate.innerProperties
