...
public final class QuotasClientImpl implements QuotasClient {
     ...
     */
    QuotasClientImpl(LoadTestClientForTestingImpl client) {
        this.service = RestProxy.create(QuotasService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for LoadTestClientForTestingQuotas to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{$host}")
