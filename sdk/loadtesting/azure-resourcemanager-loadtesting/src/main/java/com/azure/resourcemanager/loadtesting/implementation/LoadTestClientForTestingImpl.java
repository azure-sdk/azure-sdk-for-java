...
import com.azure.resourcemanager.loadtesting.fluent.OperationsClient;
...
/**
 * Initializes a new instance of the LoadTestClientForTestingImpl type.
 */
@ServiceClient(builder = LoadTestClientForTestingBuilder.class)
public final class LoadTestClientForTestingImpl implements LoadTestClientForTesting {
    /**
    ...
    /**
     * Initializes an instance of LoadTestClientForTesting client.
     * 
     ...
     */
    LoadTestClientForTestingImpl(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter,
    ...
    private static final ClientLogger LOGGER = new ClientLogger(LoadTestClientForTestingImpl.class);
}
