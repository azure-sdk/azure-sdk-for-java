...
public final class LoadTestResourceImpl
    ...
    public LoadTestResource create() {
        this.innerObject = serviceManager.serviceClient().getLoadTests().createOrUpdate(resourceGroupName, loadTestName,
    ...
    public LoadTestResource apply() {
        this.innerObject = serviceManager.serviceClient().getLoadTests().update(resourceGroupName, loadTestName,
    ...
    public LoadTestResource refresh() {
        this.innerObject = serviceManager.serviceClient().getLoadTests()
            .getByResourceGroupWithResponse(resourceGroupName, loadTestName, Context.NONE).getValue();
        return this;
    }

    public LoadTestResource refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getLoadTests()
            .getByResourceGroupWithResponse(resourceGroupName, loadTestName, context).getValue();
        return this;
    }
