...
public final class LoadTestResourceListResult {
     ...
     * @return the LoadTestResourceListResult object itself.
     */
    ...
    public void validate() {
        if (value() == null) {
            throw LOGGER.logExceptionAsError(
                new IllegalArgumentException("Missing required property value in model LoadTestResourceListResult"));
        } else {
            value().forEach(e -> e.validate());
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(LoadTestResourceListResult.class);
}
