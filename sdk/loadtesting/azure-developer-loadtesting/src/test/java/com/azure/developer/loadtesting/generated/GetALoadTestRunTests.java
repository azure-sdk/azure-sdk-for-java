...
@Disabled
public final class GetALoadTestRunTests extends LoadTestAdministrationClientTestBase {
    @Test
    @Disabled
    public void testGetALoadTestRunTests() {
        // method invocation
        LoadTestRun response = loadTestRunClient.getTestRun("12316678-1234-1234-1234-122451189012");
        ...
        Assertions.assertNotNull(response.getTestRunStatistics());
        ...
        TestRunFileInfo responseTestArtifactsOutputArtifactsResultFileInfo
            = responseTestArtifactsOutputArtifacts.getResultFileInfo();
        Assertions.assertNotNull(responseTestArtifactsOutputArtifactsResultFileInfo);
        Assertions.assertEquals("sample.jmx", responseTestArtifactsOutputArtifactsResultFileInfo.getFileName());
        Assertions.assertEquals(
            "https://somestorageaccount.blob.core.windows.net/00000000-0000-0000-0000-000000000000/00000000-0000-0000-0000-000000000000.zip?sv=2019-12-12&st=2021-01-26T18%3A30%3A20Z&se=2021-02-05T18%3A30%3A00Z&sr=c&sp=rl&sig=d7PZKyQsIeE6xb%2B1M4Yb56I%2FEEKoNIF65D%2Fs0IFsYcE%3D",
            responseTestArtifactsOutputArtifactsResultFileInfo.getUrl());
        Assertions.assertEquals(LoadTestingFileType.ADDITIONAL_ARTIFACTS,
            responseTestArtifactsOutputArtifactsResultFileInfo.getFileType());
        Assertions.assertNotNull(responseTestArtifactsOutputArtifactsResultFileInfo.getExpiresOn());
        Assertions.assertEquals(FileValidationStatus.VALIDATION_SUCCESS,
            responseTestArtifactsOutputArtifactsResultFileInfo.getValidationStatus());
        TestRunFileInfo responseTestArtifactsOutputArtifactsLogsFileInfo
            = responseTestArtifactsOutputArtifacts.getLogsFileInfo();
        Assertions.assertNotNull(responseTestArtifactsOutputArtifactsLogsFileInfo);
        Assertions.assertEquals("worker.log", responseTestArtifactsOutputArtifactsLogsFileInfo.getFileName());
        Assertions.assertEquals(
            "https://somestorageaccount.blob.core.windows.net/00000000-0000-0000-0000-000000000000/00000000-0000-0000-0000-000000000000.zip?sv=2019-12-12&st=2021-01-26T18%3A30%3A20Z&se=2021-02-05T18%3A30%3A00Z&sr=c&sp=rl&sig=d7PZKyQsIeE6xb%2B1M4Yb56I%2FEEKoNIF65D%2Fs0IFsYcE%3D",
            responseTestArtifactsOutputArtifactsLogsFileInfo.getUrl());
        Assertions.assertEquals(LoadTestingFileType.ADDITIONAL_ARTIFACTS,
            responseTestArtifactsOutputArtifactsLogsFileInfo.getFileType());
        Assertions.assertNotNull(responseTestArtifactsOutputArtifactsLogsFileInfo.getExpiresOn());
        Assertions.assertEquals(FileValidationStatus.fromString(""),
            responseTestArtifactsOutputArtifactsLogsFileInfo.getValidationStatus());
        TestRunFileInfo responseTestArtifactsOutputArtifactsReportFileInfo
            = responseTestArtifactsOutputArtifacts.getReportFileInfo();
        Assertions.assertNotNull(responseTestArtifactsOutputArtifactsReportFileInfo);
        Assertions.assertEquals("worker.log", responseTestArtifactsOutputArtifactsReportFileInfo.getFileName());
        Assertions.assertEquals(
            "https://somestorageaccount.blob.core.windows.net/00000000-0000-0000-0000-000000000000/00000000-0000-0000-0000-000000000000.zip?sv=2019-12-12&st=2021-01-26T18%3A30%3A20Z&se=2021-02-05T18%3A30%3A00Z&sr=c&sp=rl&sig=d7PZKyQsIeE6xb%2B1M4Yb56I%2FEEKoNIF65D%2Fs0IFsYcE%3D",
            responseTestArtifactsOutputArtifactsReportFileInfo.getUrl());
        Assertions.assertEquals(LoadTestingFileType.ADDITIONAL_ARTIFACTS,
            responseTestArtifactsOutputArtifactsReportFileInfo.getFileType());
        Assertions.assertNotNull(responseTestArtifactsOutputArtifactsReportFileInfo.getExpiresOn());
        Assertions.assertEquals(FileValidationStatus.fromString(""),
            responseTestArtifactsOutputArtifactsReportFileInfo.getValidationStatus());
        // verify property "testResult"
        Assertions.assertEquals(PassFailTestResult.PASSED, response.getTestResult());
        // verify property "virtualUsers"
        Assertions.assertEquals(4, response.getVirtualUsers());
        ...
        Assertions.assertEquals(TestRunStatus.DONE, response.getStatus());
        ...
        Assertions.assertEquals(18L, response.getDuration());
        // verify property "virtualUserHours"
        Assertions.assertEquals(20.5D, response.getVirtualUserHours());
        ...
        // verify property "requestDataLevel"
        Assertions.assertEquals(RequestDataLevel.NONE, response.getRequestDataLevel());
        // verify property "debugLogsEnabled"
        Assertions.assertEquals(true, response.isDebugLogsEnabled());
