...
@Disabled
public final class StopATestProfileRunTests extends LoadTestAdministrationClientTestBase {
    @Test
    @Disabled
    public void testStopATestProfileRunTests() {
        // method invocation
        TestProfileRun response = loadTestRunClient.stopTestProfileRun("12316678-1234-1234-1234-122451189012");
        ...
        Assertions.assertEquals(TestProfileRunStatus.CANCELLING, response.getStatus());
