    ...
    public static void main(String[] args) {
        ...
        Test response = loadTestAdministrationClient.createOrUpdateTest("12345678-1234-1234-1234-123456789012",
            new Test()
                ...
                .setLoadTestConfiguration(new LoadTestConfiguration().setEngineInstances(6)
                    .setSplitAllCSVs(true)
                    .setRegionalLoadTestConfig(
                        Arrays.asList(new RegionalConfiguration().setEngineInstances(4).setRegion("northeurope"),
                            new RegionalConfiguration().setEngineInstances(2).setRegion("westeurope"))))
