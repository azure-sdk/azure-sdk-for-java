...
import com.azure.developer.loadtesting.models.TestKind;
import com.azure.identity.DefaultAzureCredentialBuilder;
import java.util.Arrays;
import java.util.HashMap;
import java.util.Map;

public class CreateOrUpdateALocustLoadTest {
    public static void main(String[] args) {
        LoadTestAdministrationClient loadTestAdministrationClient
            = new LoadTestAdministrationClientBuilder().credential(new DefaultAzureCredentialBuilder().build())
                ...
                .buildClient();
        // BEGIN:com.azure.developer.loadtesting.generated.createorupdatetest.createorupdatealocustloadtest
        Test response = loadTestAdministrationClient.createOrUpdateTest("12345678-1234-1234-1234-123456789012",
            new Test()
                ...
                .setLoadTestConfiguration(new LoadTestConfiguration().setSplitAllCSVs(false)
                    .setRegionalLoadTestConfig(
                        Arrays.asList(new RegionalConfiguration().setLoadPercentage(40).setRegion("northeurope"),
                            new RegionalConfiguration().setLoadPercentage(60).setRegion("westeurope"))))
                ...
                .setEngineBuiltInIdentityIds(Arrays.asList(
                    "/subscriptions/10000000-0000-0000-0000-000000000000/resourceGroups/samplerg1/providers/Microsoft.ManagedIdentity/userAssignedIdentities/sampleresourcename")));
        // END:com.azure.developer.loadtesting.generated.createorupdatetest.createorupdatealocustloadtest
    }
