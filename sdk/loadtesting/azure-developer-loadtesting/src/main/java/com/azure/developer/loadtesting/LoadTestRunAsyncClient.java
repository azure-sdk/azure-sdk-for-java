...
import com.azure.developer.loadtesting.models.GetTestRunFileResponse;
...
public final class LoadTestRunAsyncClient {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<GetTestRunFileResponse> getTestRunFile(String testRunId, String fileName) {
        ...
        return getTestRunFileWithResponse(testRunId, fileName, requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(GetTestRunFileResponse.class));
    }
