...
public final class TestRunArtifacts implements JsonSerializable<TestRunArtifacts> {
    ...
    static {
        JsonMergePatchHelper.setTestRunArtifactsAccessor((model, jsonMergePatchEnabled) -> {
    ...
    private JsonWriter toJsonMergePatch(JsonWriter jsonWriter) throws IOException {
        jsonWriter.writeStartObject();
        if (updatedProperties.contains("outputArtifacts")) {
            if (this.outputArtifacts == null) {
                jsonWriter.writeNullField("outputArtifacts");
            } else {
                JsonMergePatchHelper.getTestRunOutputArtifactsAccessor()
                    .prepareModelForJsonMergePatch(this.outputArtifacts, true);
                jsonWriter.writeJsonField("outputArtifacts", this.outputArtifacts);
                JsonMergePatchHelper.getTestRunOutputArtifactsAccessor()
                    .prepareModelForJsonMergePatch(this.outputArtifacts, false);
            }
        }
        return jsonWriter.writeEndObject();
    }
