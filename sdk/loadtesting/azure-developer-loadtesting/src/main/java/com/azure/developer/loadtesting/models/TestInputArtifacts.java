...
public final class TestInputArtifacts implements JsonSerializable<TestInputArtifacts> {
    ...
    static {
        JsonMergePatchHelper.setTestInputArtifactsAccessor((model, jsonMergePatchEnabled) -> {
    ...
    private JsonWriter toJsonMergePatch(JsonWriter jsonWriter) throws IOException {
        ...
        if (updatedProperties.contains("configFileInfo")) {
            if (this.configFileInfo == null) {
                ...
                JsonMergePatchHelper.getTestFileInfoAccessor().prepareModelForJsonMergePatch(this.configFileInfo, true);
                jsonWriter.writeJsonField("configFileInfo", this.configFileInfo);
                JsonMergePatchHelper.getTestFileInfoAccessor()
