...
public final class LoadTestRunClient {
    ...
    public PagedIterable<BinaryData> listMetricDimensionValues(
            ...
            String timespan,
            RequestOptions requestOptions) {
        return this.serviceClient.listMetricDimensionValues(
     ...
     * @throws ResourceModifiedException thrown if the request is rejected by server on status code 409.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return associated app component (collection of azure resources) for the given test run.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public FileInfo getTestRunFile(String testRunId, String fileName) {
    ...
    public PagedIterable<DimensionValueList> listMetricDimensionValues(
        ...
        return serviceClient
                ...
                .mapPage(bodyItemValue -> bodyItemValue.toObject(DimensionValueList.class));
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<TimeSeriesElement> listMetrics(
            String testRunId,
            String metricName,
            String metricNamespace,
            String timespan,
        ...
        return serviceClient
                ...
                .mapPage(bodyItemValue -> bodyItemValue.toObject(TimeSeriesElement.class));
    }
