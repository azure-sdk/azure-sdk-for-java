...
import com.azure.developer.loadtesting.models.GetTestFileResponse;
...
import com.azure.developer.loadtesting.models.UploadTestFileResponse;
...
public final class LoadTestAdministrationClient {
     ...
     *     url: String (Optional)
     *     fileType: String(JMX_FILE/USER_PROPERTIES/ADDITIONAL_ARTIFACTS/ZIPPED_ARTIFACTS/URL_TEST_CONFIG_JSON/TEST_SCRIPT) (Optional)
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public TestServerMetricConfig createOrUpdateServerMetricsConfig(String testId, TestServerMetricConfig body) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public GetTestFileResponse getTestFile(String testId, String fileName) {
        // Generated convenience method for getTestFileWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getTestFileWithResponse(testId, fileName, requestOptions).getValue().toObject(GetTestFileResponse.class);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public UploadTestFileResponse uploadTestFile(String testId, String fileName, BinaryData body, FileType fileType) {
        ...
        return uploadTestFileWithResponse(testId, fileName, body, requestOptions).getValue()
            .toObject(UploadTestFileResponse.class);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public UploadTestFileResponse uploadTestFile(String testId, String fileName, BinaryData body) {
        // Generated convenience method for uploadTestFileWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return uploadTestFileWithResponse(testId, fileName, body, requestOptions).getValue()
            .toObject(UploadTestFileResponse.class);
