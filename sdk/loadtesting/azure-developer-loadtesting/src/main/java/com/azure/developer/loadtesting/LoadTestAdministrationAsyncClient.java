...
public final class LoadTestAdministrationAsyncClient {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<GetTestFileResponse> getTestFile(String testId, String fileName) {
        ...
        return getTestFileWithResponse(testId, fileName, requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(GetTestFileResponse.class));
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<UploadTestFileResponse> uploadTestFile(String testId, String fileName, BinaryData body,
        FileType fileType) {
        ...
        return uploadTestFileWithResponse(testId, fileName, body, requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(UploadTestFileResponse.class));
    }
