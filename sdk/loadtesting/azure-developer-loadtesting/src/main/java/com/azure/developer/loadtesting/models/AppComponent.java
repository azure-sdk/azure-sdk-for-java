...
public final class AppComponent implements JsonSerializable<AppComponent> {
    ...
    static {
        JsonMergePatchHelper.setAppComponentAccessor((model, jsonMergePatchEnabled) -> {
    ...
    public static AppComponent fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            deserializedAppComponent.resourceName = resourceName;
            deserializedAppComponent.resourceType = resourceType;
