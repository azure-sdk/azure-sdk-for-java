...
public final class TestsImpl {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<BinaryData> listFilesSinglePage(String testId, RequestOptions requestOptions) {
        final String accept = "application/json";
        Response<BinaryData> res =
    ...
    public PagedIterable<BinaryData> listFiles(String testId, RequestOptions requestOptions) {
        ...
        requestOptionsForNextPage.setContext(
                requestOptions != null && requestOptions.getContext() != null
                        ...
                        : Context.NONE);
        return new PagedIterable<>(
                () -> listFilesSinglePage(testId, requestOptions),
