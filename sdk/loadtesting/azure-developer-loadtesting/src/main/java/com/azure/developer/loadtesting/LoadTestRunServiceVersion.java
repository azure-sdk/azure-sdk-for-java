...
/**
 * Service version of LoadTestRunClient.
 */
public enum LoadTestRunServiceVersion implements ServiceVersion {
    /**
    ...
    LoadTestRunServiceVersion(String version) {
     ...
     * 
     * @return The latest {@link LoadTestRunServiceVersion}.
     */
    public static LoadTestRunServiceVersion getLatest() {
