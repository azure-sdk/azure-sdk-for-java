...
public final class TestRun {
    ...
    /*
     * Region configuration applied of load test run
     */
    @Generated
    @JsonProperty(value = "regionConfiguration", access = JsonProperty.Access.WRITE_ONLY)
     ...
     */
    @Generated
    @JsonProperty(value = "publicIPDisabled", access = JsonProperty.Access.WRITE_ONLY)
    ...
    /**
     * Get the regionConfiguration property: Region configuration applied of load test run.
     * 
