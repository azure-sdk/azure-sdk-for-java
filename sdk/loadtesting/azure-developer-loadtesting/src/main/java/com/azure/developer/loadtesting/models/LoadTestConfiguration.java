...
public final class LoadTestConfiguration {
    ...
    /*
     * Configure engine instances to be split into multiple regions
     */
    @Generated
    @JsonProperty(value = "regionConfiguration")
    private List<RegionConfig> regionConfiguration;
    ...
    /**
     * Get the regionConfiguration property: Configure engine instances to be split into multiple regions.
     * 
     * @return the regionConfiguration value.
     */
    @Generated
    public List<RegionConfig> getRegionConfiguration() {
        return this.regionConfiguration;
    }

    /**
     * Set the regionConfiguration property: Configure engine instances to be split into multiple regions.
     * 
     * @param regionConfiguration the regionConfiguration value to set.
     * @return the LoadTestConfiguration object itself.
     */
    @Generated
    public LoadTestConfiguration setRegionConfiguration(List<RegionConfig> regionConfiguration) {
