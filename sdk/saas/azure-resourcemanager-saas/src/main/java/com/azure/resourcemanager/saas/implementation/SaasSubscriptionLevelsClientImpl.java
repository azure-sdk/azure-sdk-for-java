...
public final class SaasSubscriptionLevelsClientImpl implements SaasSubscriptionLevelsClient {
    ...
    public SyncPoller<PollResult<Void>, Void> beginUpdateToUnsubscribed(
        String resourceGroupName, String resourceName, DeleteOptions parameters) {
        return this.beginUpdateToUnsubscribedAsync(resourceGroupName, resourceName, parameters).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginUpdateToUnsubscribed(
        String resourceGroupName, String resourceName, DeleteOptions parameters, Context context) {
        return this
            .beginUpdateToUnsubscribedAsync(resourceGroupName, resourceName, parameters, context)
            .getSyncPoller();
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the ISV access token for a specified Subscription Level SaaS along with {@link Response} on successful
     *     completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the ISV access token for a specified Subscription Level SaaS on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ...
    public AccessTokenResultInner listAccessToken(String resourceGroupName, String resourceName) {
        return listAccessTokenWithResponse(resourceGroupName, resourceName, Context.NONE).getValue();
    }
    ...
    public void validateMoveResources(String resourceGroupName, MoveResource moveResourceParameter) {
        validateMoveResourcesWithResponse(resourceGroupName, moveResourceParameter, Context.NONE);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginMoveResources(
        String resourceGroupName, MoveResource moveResourceParameter) {
        return this.beginMoveResourcesAsync(resourceGroupName, moveResourceParameter).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginMoveResources(
        String resourceGroupName, MoveResource moveResourceParameter, Context context) {
        return this.beginMoveResourcesAsync(resourceGroupName, moveResourceParameter, context).getSyncPoller();
    }
