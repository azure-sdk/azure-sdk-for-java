...
public final class FluidRelayServersClientImpl implements FluidRelayServersClient {
    ...
    private interface FluidRelayServersService {
        ...
        @Post(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroup}/providers/Microsoft.FluidRelay"
                + "/fluidRelayServers/{fluidRelayServerName}/getKeys")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<FluidRelayServerKeysInner>> getKeys(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroup") String resourceGroup,
            @PathParam("fluidRelayServerName") String fluidRelayServerName,
    ...
    private Mono<Void> deleteAsync(String resourceGroup, String fluidRelayServerName) {
        return deleteWithResponseAsync(resourceGroup, fluidRelayServerName)
    ...
    private Mono<FluidRelayServerKeysInner> regenerateKeyAsync(
        ...
        return regenerateKeyWithResponseAsync(resourceGroup, fluidRelayServerName, parameters)
            .flatMap(
                (Response<FluidRelayServerKeysInner> res) -> {
                    if (res.getValue() != null) {
                        return Mono.just(res.getValue());
                    } else {
                        return Mono.empty();
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<FluidRelayServerKeysInner>> getKeysWithResponseAsync(
        String resourceGroup, String fluidRelayServerName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<FluidRelayServerKeysInner> getKeysAsync(String resourceGroup, String fluidRelayServerName) {
        return getKeysWithResponseAsync(resourceGroup, fluidRelayServerName)
            .flatMap(
                (Response<FluidRelayServerKeysInner> res) -> {
                    if (res.getValue() != null) {
                        return Mono.just(res.getValue());
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public FluidRelayServerKeysInner getKeys(String resourceGroup, String fluidRelayServerName) {
        return getKeysAsync(resourceGroup, fluidRelayServerName).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<FluidRelayServerKeysInner> getKeysWithResponse(
        String resourceGroup, String fluidRelayServerName, Context context) {
        return getKeysWithResponseAsync(resourceGroup, fluidRelayServerName, context).block();
    }
