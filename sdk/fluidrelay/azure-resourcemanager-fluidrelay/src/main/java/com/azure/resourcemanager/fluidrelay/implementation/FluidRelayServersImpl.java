...
public final class FluidRelayServersImpl implements FluidRelayServers {
    ...
    public FluidRelayServerKeys getKeys(String resourceGroup, String fluidRelayServerName) {
        FluidRelayServerKeysInner inner = this.serviceClient().getKeys(resourceGroup, fluidRelayServerName);
        if (inner != null) {
            return new FluidRelayServerKeysImpl(inner, this.manager());
        } else {
            return null;
    ...
    public Response<FluidRelayServerKeys> getKeysWithResponse(
        String resourceGroup, String fluidRelayServerName, Context context) {
        Response<FluidRelayServerKeysInner> inner =
            this.serviceClient().getKeysWithResponse(resourceGroup, fluidRelayServerName, context);
        if (inner != null) {
            return new SimpleResponse<>(
                inner.getRequest(),
                inner.getStatusCode(),
