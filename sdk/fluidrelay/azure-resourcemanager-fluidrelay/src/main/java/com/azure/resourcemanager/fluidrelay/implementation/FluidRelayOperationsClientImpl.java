...
public final class FluidRelayOperationsClientImpl implements FluidRelayOperationsClient {
    ...
    public interface FluidRelayOperationsService {
     ...
     * @return result of GET request to list FluidRelay operations along with {@link PagedResponse} on successful
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return result of GET request to list FluidRelay operations as paginated response with {@link PagedFlux}.
     */
