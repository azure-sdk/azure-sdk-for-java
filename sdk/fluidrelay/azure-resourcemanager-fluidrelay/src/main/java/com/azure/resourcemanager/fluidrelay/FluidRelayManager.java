...
public final class FluidRelayManager {
    ...
    private FluidRelayManager(HttpPipeline httpPipeline, AzureProfile profile, Duration defaultPollInterval) {
        ...
        this.clientObject = new FluidRelayManagementClientBuilder().pipeline(httpPipeline)
     ...
     * @return the FluidRelay service API instance.
     */
    public static FluidRelayManager authenticate(HttpPipeline httpPipeline, AzureProfile profile) {
        Objects.requireNonNull(httpPipeline, "'httpPipeline' cannot be null.");
        Objects.requireNonNull(profile, "'profile' cannot be null.");
        return new FluidRelayManager(httpPipeline, profile, null);
    }
    ...
    public static final class Configurable {
        ...
        private static final Map<String, String> PROPERTIES
            = CoreUtils.getProperties("azure-resourcemanager-fluidrelay.properties");
    ...
    /**
     * Gets the resource collection API of FluidRelayOperations.
     * 
    ...
    /**
     * Gets the resource collection API of FluidRelayServers. It manages FluidRelayServer.
     * 
