...
public final class FluidRelayServerImpl
    ...
    public FluidRelayServerKeys getKeys() {
        return serviceManager.fluidRelayServers().getKeys(resourceGroup, fluidRelayServerName);
    }

    public Response<FluidRelayServerKeys> getKeysWithResponse(Context context) {
        return serviceManager.fluidRelayServers().getKeysWithResponse(resourceGroup, fluidRelayServerName, context);
    }
