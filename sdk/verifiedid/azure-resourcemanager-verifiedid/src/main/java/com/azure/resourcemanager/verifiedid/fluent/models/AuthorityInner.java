...
public final class AuthorityInner extends Resource {
     ...
     */
    @Override
    public AuthorityInner withTags(Map<String, String> tags) {
        super.withTags(tags);
        return this;
    }
    ...
    public void validate() {
        ...
        if (location() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Missing required property location in model AuthorityInner"));
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(AuthorityInner.class);
