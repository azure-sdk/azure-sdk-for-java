...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    private final VerifiedIdMgmtClientTestImpl client;
     ...
     */
    OperationsClientImpl(VerifiedIdMgmtClientTestImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for VerifiedIdMgmtClientTestOperations to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{$host}")
