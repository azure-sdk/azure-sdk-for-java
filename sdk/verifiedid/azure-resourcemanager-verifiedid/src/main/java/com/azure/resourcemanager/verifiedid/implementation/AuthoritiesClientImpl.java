...
public final class AuthoritiesClientImpl implements AuthoritiesClient {
     ...
     */
    AuthoritiesClientImpl(VerifiedIdMgmtClientTestImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for VerifiedIdMgmtClientTestAuthorities to be used by the proxy service
