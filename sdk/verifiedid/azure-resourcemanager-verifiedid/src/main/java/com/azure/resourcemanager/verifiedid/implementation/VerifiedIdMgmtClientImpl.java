...
/**
 * Initializes a new instance of the VerifiedIdMgmtClientImpl type.
 */
@ServiceClient(builder = VerifiedIdMgmtClientBuilder.class)
public final class VerifiedIdMgmtClientImpl implements VerifiedIdMgmtClient {
    /**
    ...
    /**
     * Initializes an instance of VerifiedIdMgmtClient client.
     * 
     ...
     */
    VerifiedIdMgmtClientImpl(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter,
    ...
    private static final ClientLogger LOGGER = new ClientLogger(VerifiedIdMgmtClientImpl.class);
}
