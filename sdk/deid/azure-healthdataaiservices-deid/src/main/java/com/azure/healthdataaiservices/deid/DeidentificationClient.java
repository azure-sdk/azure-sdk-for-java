...
public final class DeidentificationClient {
     ...
     */
    @Generated
    DeidentificationClient(DeidentificationsImpl serviceClient) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollOperationDetails, DeidentifyJob> beginCreateJob(String name, DeidentifyJob resource) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public DeidentifyJob getJob(String name) {
        // Generated convenience method for getJobWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getJobWithResponse(name, requestOptions).getValue().toObject(DeidentifyJob.class);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<DeidentifyJob> listJobs(String continuationToken) {
        ...
        return serviceClient.listJobs(requestOptions)
            .mapPage(bodyItemValue -> bodyItemValue.toObject(DeidentifyJob.class));
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<DeidentifyJob> listJobs() {
        // Generated convenience method for listJobs
        RequestOptions requestOptions = new RequestOptions();
        return serviceClient.listJobs(requestOptions)
            .mapPage(bodyItemValue -> bodyItemValue.toObject(DeidentifyJob.class));
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public DeidentifyJob cancelJob(String name) {
        // Generated convenience method for cancelJobWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return cancelJobWithResponse(name, requestOptions).getValue().toObject(DeidentifyJob.class);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public DeidentifyResult deidentify(DeidentifyOptions body) {
        ...
        return deidentifyWithResponse(BinaryData.fromObject(body), requestOptions).getValue()
            .toObject(DeidentifyResult.class);
    }
}
