...
import com.azure.healthdataaiservices.deid.implementation.DeidentificationsImpl;
import com.azure.healthdataaiservices.deid.models.DeidentifyJob;
import com.azure.healthdataaiservices.deid.models.DeidentifyOptions;
import com.azure.healthdataaiservices.deid.models.DeidentifyResult;
import com.azure.healthdataaiservices.deid.models.HealthFileDetails;
...
public final class DeidentificationAsyncClient {
    @Generated
    private final DeidentificationsImpl serviceClient;
     ...
     */
    @Generated
    DeidentificationAsyncClient(DeidentificationsImpl serviceClient) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<BinaryData> listJobFiles(String name, RequestOptions requestOptions) {
        return this.serviceClient.listJobFilesAsync(name, requestOptions);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public PollerFlux<PollOperationDetails, DeidentifyJob> beginCreateJob(String name, DeidentifyJob resource) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<DeidentifyJob> listJobs(String continuationToken) {
        ...
        return PagedFlux.create(() -> (continuationToken, pageSize) -> {
            ...
            return flux.map(pagedResponse -> new PagedResponseBase<Void, DeidentifyJob>(pagedResponse.getRequest(),
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<DeidentifyJob> listJobs() {
        // Generated convenience method for listJobs
        RequestOptions requestOptions = new RequestOptions();
        PagedFlux<BinaryData> pagedFluxResponse = listJobs(requestOptions);
        return PagedFlux.create(() -> (continuationToken, pageSize) -> {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<HealthFileDetails> listJobFiles(String name, String continuationToken) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<HealthFileDetails> listJobFiles(String name) {
        // Generated convenience method for listJobFiles
        RequestOptions requestOptions = new RequestOptions();
        PagedFlux<BinaryData> pagedFluxResponse = listJobFiles(name, requestOptions);
        return PagedFlux.create(() -> (continuationToken, pageSize) -> {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<DeidentifyJob> cancelJob(String name) {
     ...
     * @throws ResourceModifiedException thrown if the request is rejected by server on status code 409.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return response for synchronous De-Identify operation on successful completion of {@link Mono}.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<DeidentifyResult> deidentify(DeidentifyOptions body) {
        ...
        return deidentifyWithResponse(BinaryData.fromObject(body), requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(DeidentifyResult.class));
    }
}
