 ...
 */
@Fluent
public final class Job implements JsonSerializable<Job> {
    /*
     ...
     */
    @Generated
    public Job(SourceStorageLocation sourceLocation, TargetStorageLocation targetLocation, DocumentDataType dataType,
    ...
    public static Job fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            Job deserializedJob = new Job(sourceLocation, targetLocation, dataType, operation);
            deserializedJob.status = status;
            deserializedJob.createdAt = createdAt;
            deserializedJob.redactionFormat = redactionFormat;
            deserializedJob.error = error;
            deserializedJob.startedAt = startedAt;
            deserializedJob.lastUpdatedAt = lastUpdatedAt;
            deserializedJob.summary = summary;
