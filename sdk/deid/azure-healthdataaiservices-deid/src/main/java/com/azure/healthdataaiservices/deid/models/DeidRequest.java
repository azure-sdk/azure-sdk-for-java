 ...
 */
@Fluent
public final class DeidRequest implements JsonSerializable<DeidRequest> {
    /*
     ...
     */
    @Generated
    public DeidRequest(String inputText, DocumentDataType dataType, OperationType operation,
    ...
    /**
     * Reads an instance of DeidRequest from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of DeidRequest if the JsonReader was pointing to an instance of it, or null if it was
     * pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the DeidRequest.
     */
    @Generated
    public static DeidRequest fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            DeidRequest deserializedDeidRequest = new DeidRequest(inputText, dataType, operation, stringIndexType);
            deserializedDeidRequest.redactionFormat = redactionFormat;

            return deserializedDeidRequest;
        });
    }
}
