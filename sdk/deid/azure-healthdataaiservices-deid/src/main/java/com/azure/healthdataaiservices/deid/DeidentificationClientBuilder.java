...
import com.azure.healthdataaiservices.deid.implementation.DeidentificationClientImpl;
...
@ServiceClientBuilder(
    serviceClients = {
        JobsClient.class,
        RealtimeOperationsClient.class,
        JobsAsyncClient.class,
        RealtimeOperationsAsyncClient.class })
public final class DeidentificationClientBuilder implements HttpTrait<DeidentificationClientBuilder>,
    ConfigurationTrait<DeidentificationClientBuilder>, TokenCredentialTrait<DeidentificationClientBuilder> {
    @Generated
    ...
    private static final Map<String, String> PROPERTIES
        = CoreUtils.getProperties("azure-healthdataaiservices-deid.properties");
     ...
     */
    @Generated
    private String deidServiceUri;

    /**
     * Sets Uri of your Deid Service.
     * 
     * @param deidServiceUri the deidServiceUri value.
     * @return the DeidentificationClientBuilder.
     */
    @Generated
    public DeidentificationClientBuilder deidServiceUri(String deidServiceUri) {
    ...
    private DeidentificationClientImpl buildInnerClient() {
        ...
        DeidentificationClientImpl client = new DeidentificationClientImpl(localPipeline,
            JacksonAdapter.createDefaultSerializerAdapter(), this.deidServiceUri, localServiceVersion);
        return client;
    }
    ...
    /**
     * Builds an instance of RealtimeOperationsAsyncClient class.
     * 
     * @return an instance of RealtimeOperationsAsyncClient.
     */
    @Generated
    public RealtimeOperationsAsyncClient buildRealtimeOperationsAsyncClient() {
        return new RealtimeOperationsAsyncClient(buildInnerClient().getRealtimeOperations());
    }
    ...
    /**
     * Builds an instance of RealtimeOperationsClient class.
     * 
     * @return an instance of RealtimeOperationsClient.
     */
    @Generated
    public RealtimeOperationsClient buildRealtimeOperationsClient() {
        return new RealtimeOperationsClient(buildInnerClient().getRealtimeOperations());
    }
