...
public final class PolicyOperationStatusClientImpl implements PolicyOperationStatusClient {
    ...
    private Mono<OperationStatusInner> getAsync(
        String subscriptionId, String resourceGroupName, String vaultName, String policyName, String operationId) {
        return getWithResponseAsync(subscriptionId, resourceGroupName, vaultName, policyName, operationId)
    ...
    public Response<OperationStatusInner> getWithResponse(
        ...
        String operationId,
        Context context) {
        return getWithResponseAsync(subscriptionId, resourceGroupName, vaultName, policyName, operationId, context)
            .block();
    }
    ...
    public OperationStatusInner get(
        String subscriptionId, String resourceGroupName, String vaultName, String policyName, String operationId) {
        return getWithResponse(subscriptionId, resourceGroupName, vaultName, policyName, operationId, Context.NONE)
            .getValue();
    }
}
