...
import com.azure.resourcemanager.azuresiterecovery.models.FabricModelSystemData;
...
public final class FabricModelImpl implements FabricModel, FabricModel.Definition, FabricModel.Update {
    ...
    public FabricModelImpl withExistingResourceGroup(String subscriptionId, String resourceGroupName) {
    ...
    public FabricModel create() {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getFabrics()
                .create(subscriptionId, resourceGroupName, fabricName, this.innerModel(), Context.NONE);
        return this;
    }
    ...
    public FabricModel create(Context context) {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getFabrics()
                .create(subscriptionId, resourceGroupName, fabricName, this.innerModel(), context);
        return this;
    }

    FabricModelImpl(String name, com.azure.resourcemanager.azuresiterecovery.AzureSiteRecoveryManager serviceManager) {
    ...
    public FabricModel apply() {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getFabrics()
                .update(subscriptionId, resourceGroupName, fabricName, updateBody, Context.NONE);
        return this;
    }
    ...
    public FabricModel apply(Context context) {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getFabrics()
                .update(subscriptionId, resourceGroupName, fabricName, updateBody, context);
        return this;
    }
    ...
    public FabricModel refresh(Context context) {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getFabrics()
                .getByResourceGroupWithResponse(subscriptionId, resourceGroupName, fabricName, context)
                .getValue();
        return this;
    }
