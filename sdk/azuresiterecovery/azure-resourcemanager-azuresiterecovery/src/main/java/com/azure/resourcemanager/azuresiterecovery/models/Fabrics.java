...
public interface Fabrics {
     ...
     */
    Response<FabricModel> getByResourceGroupWithResponse(
     ...
     */
    FabricModel getByResourceGroup(String subscriptionId, String resourceGroupName, String fabricName);
     ...
     */
    PagedIterable<FabricModel> list(String subscriptionId);
     ...
     * @return the list of fabrics in the given subscription as paginated response with {@link PagedIterable}.
     */
    PagedIterable<FabricModel> list(String subscriptionId, String continuationToken, Context context);
     ...
     *     PagedIterable}.
     */
    PagedIterable<FabricModel> listByResourceGroup(String subscriptionId, String resourceGroupName);
     ...
     *     PagedIterable}.
     */
    PagedIterable<FabricModel> listByResourceGroup(
