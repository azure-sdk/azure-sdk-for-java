...
public interface ProtectedItems {
     ...
     */
    ProtectedItemModel get(String subscriptionId, String resourceGroupName, String vaultName, String protectedItemName);
     ...
     */
    PagedIterable<ProtectedItemModel> list(String subscriptionId, String resourceGroupName, String vaultName);
     ...
     * @return the list of protected items in the given vault as paginated response with {@link PagedIterable}.
     */
    PagedIterable<ProtectedItemModel> list(
