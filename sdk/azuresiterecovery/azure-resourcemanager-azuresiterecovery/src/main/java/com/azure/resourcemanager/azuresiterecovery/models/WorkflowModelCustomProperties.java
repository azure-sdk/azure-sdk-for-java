...
@JsonSubTypes({
    @JsonSubTypes.Type(
        name = "FailoverWorkflowModelCustomProperties",
        value = FailoverWorkflowModelCustomProperties.class),
    @JsonSubTypes.Type(
        name = "TestFailoverCleanupWorkflowModelCustomProperties",
        value = TestFailoverCleanupWorkflowModelCustomProperties.class),
    @JsonSubTypes.Type(
        name = "TestFailoverWorkflowModelCustomProperties",
        value = TestFailoverWorkflowModelCustomProperties.class)
})
@Immutable
