...
public interface Workflows {
     ...
     */
    WorkflowModel get(String subscriptionId, String resourceGroupName, String vaultName, String workflowName);
     ...
     */
    PagedIterable<WorkflowModel> list(String subscriptionId, String resourceGroupName, String vaultName);
