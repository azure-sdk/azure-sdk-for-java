...
public interface EventsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    EventModelInner get(String subscriptionId, String resourceGroupName, String vaultName, String eventName);
    ...
    PagedIterable<EventModelInner> list(String subscriptionId, String resourceGroupName, String vaultName);
