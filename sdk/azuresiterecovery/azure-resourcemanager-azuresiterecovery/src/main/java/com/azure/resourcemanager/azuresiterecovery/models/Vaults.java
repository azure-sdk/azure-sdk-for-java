...
public interface Vaults {
     ...
     */
    Response<VaultModel> getByResourceGroupWithResponse(
     ...
     */
    VaultModel getByResourceGroup(String subscriptionId, String resourceGroupName, String vaultName);
     ...
     */
    PagedIterable<VaultModel> list(String subscriptionId);
     ...
     * @return the list of vaults in the given subscription as paginated response with {@link PagedIterable}.
     */
    PagedIterable<VaultModel> list(String subscriptionId, String continuationToken, Context context);
     ...
     *     PagedIterable}.
     */
    PagedIterable<VaultModel> listByResourceGroup(String subscriptionId, String resourceGroupName);
     ...
     *     PagedIterable}.
     */
    PagedIterable<VaultModel> listByResourceGroup(
