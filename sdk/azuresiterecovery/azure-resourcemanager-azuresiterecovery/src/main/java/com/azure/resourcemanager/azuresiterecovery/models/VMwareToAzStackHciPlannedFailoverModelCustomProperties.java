...
@JsonTypeName("VMwareToAzStackHCIPlannedFailoverModelCustomProperties")
@Fluent
public final class VMwareToAzStackHciPlannedFailoverModelCustomProperties extends PlannedFailoverModelCustomProperties {
    /*
    ...
    /** Creates an instance of VMwareToAzStackHciPlannedFailoverModelCustomProperties class. */
    public VMwareToAzStackHciPlannedFailoverModelCustomProperties() {
    }
     ...
     * @return the VMwareToAzStackHciPlannedFailoverModelCustomProperties object itself.
     */
    public VMwareToAzStackHciPlannedFailoverModelCustomProperties withShutdownSourceVM(boolean shutdownSourceVM) {
