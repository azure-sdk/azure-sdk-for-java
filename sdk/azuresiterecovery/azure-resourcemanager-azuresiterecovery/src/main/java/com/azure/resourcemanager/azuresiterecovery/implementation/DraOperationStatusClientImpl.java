...
public final class DraOperationStatusClientImpl implements DraOperationStatusClient {
    ...
    private Mono<OperationStatusInner> getAsync(
        String subscriptionId, String resourceGroupName, String fabricName, String draName, String operationId) {
        return getWithResponseAsync(subscriptionId, resourceGroupName, fabricName, draName, operationId)
    ...
    public Response<OperationStatusInner> getWithResponse(
        ...
        String operationId,
        Context context) {
        return getWithResponseAsync(subscriptionId, resourceGroupName, fabricName, draName, operationId, context)
            .block();
    }
    ...
    public OperationStatusInner get(
        String subscriptionId, String resourceGroupName, String fabricName, String draName, String operationId) {
        return getWithResponse(subscriptionId, resourceGroupName, fabricName, draName, operationId, Context.NONE)
            .getValue();
    }
}
