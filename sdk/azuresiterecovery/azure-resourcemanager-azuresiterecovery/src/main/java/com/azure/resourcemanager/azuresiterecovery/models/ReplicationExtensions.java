...
public interface ReplicationExtensions {
     ...
     */
    PagedIterable<ReplicationExtensionModel> list(String subscriptionId, String resourceGroupName, String vaultName);
     ...
     * @return the list of replication extensions in the given vault as paginated response with {@link PagedIterable}.
     */
    PagedIterable<ReplicationExtensionModel> list(
