...
public final class WorkflowOperationStatusClientImpl implements WorkflowOperationStatusClient {
     ...
     */
    WorkflowOperationStatusClientImpl(AzureSiteRecoveryManagementServiceApiImpl client) {
        this.service =
            RestProxy
    ...
    /**
     * The interface defining all the services for AzureSiteRecoveryManagementServiceApiWorkflowOperationStatus to be
    ...
    /**
     * Gets the workflow operation status.
     *
    ...
    private Mono<OperationStatusInner> getAsync(
        String subscriptionId, String resourceGroupName, String vaultName, String workflowName, String operationId) {
        return getWithResponseAsync(subscriptionId, resourceGroupName, vaultName, workflowName, operationId)
    ...
    public Response<OperationStatusInner> getWithResponse(
        ...
        String operationId,
        Context context) {
        return getWithResponseAsync(subscriptionId, resourceGroupName, vaultName, workflowName, operationId, context)
            .block();
    }
    ...
    public OperationStatusInner get(
        String subscriptionId, String resourceGroupName, String vaultName, String workflowName, String operationId) {
        return getWithResponse(subscriptionId, resourceGroupName, vaultName, workflowName, operationId, Context.NONE)
            .getValue();
    }
}
