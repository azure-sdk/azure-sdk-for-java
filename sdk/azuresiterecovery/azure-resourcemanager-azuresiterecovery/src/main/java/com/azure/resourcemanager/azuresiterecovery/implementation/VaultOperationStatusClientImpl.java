...
public final class VaultOperationStatusClientImpl implements VaultOperationStatusClient {
     ...
     */
    VaultOperationStatusClientImpl(AzureSiteRecoveryManagementServiceApiImpl client) {
        this.service =
            RestProxy
    ...
    /**
     * The interface defining all the services for AzureSiteRecoveryManagementServiceApiVaultOperationStatus to be used
    ...
    private Mono<Response<OperationStatusInner>> getWithResponseAsync(
        String subscriptionId, String resourceGroupName, String vaultName, String operationId) {
    ...
    private Mono<OperationStatusInner> getAsync(
        String subscriptionId, String resourceGroupName, String vaultName, String operationId) {
        return getWithResponseAsync(subscriptionId, resourceGroupName, vaultName, operationId)
    ...
    public Response<OperationStatusInner> getWithResponse(
        String subscriptionId, String resourceGroupName, String vaultName, String operationId, Context context) {
        return getWithResponseAsync(subscriptionId, resourceGroupName, vaultName, operationId, context).block();
    }
    ...
    public OperationStatusInner get(
        String subscriptionId, String resourceGroupName, String vaultName, String operationId) {
        return getWithResponse(subscriptionId, resourceGroupName, vaultName, operationId, Context.NONE).getValue();
    }
}
