...
public final class FabricOperationsStatusClientImpl implements FabricOperationsStatusClient {
     ...
     */
    FabricOperationsStatusClientImpl(AzureSiteRecoveryManagementServiceApiImpl client) {
        this.service =
            RestProxy
    ...
    /**
     * The interface defining all the services for AzureSiteRecoveryManagementServiceApiFabricOperationsStatus to be
    ...
    private Mono<Response<OperationStatusInner>> getWithResponseAsync(
        String subscriptionId, String resourceGroupName, String fabricName, String operationId) {
    ...
    private Mono<OperationStatusInner> getAsync(
        String subscriptionId, String resourceGroupName, String fabricName, String operationId) {
        return getWithResponseAsync(subscriptionId, resourceGroupName, fabricName, operationId)
    ...
    public Response<OperationStatusInner> getWithResponse(
        String subscriptionId, String resourceGroupName, String fabricName, String operationId, Context context) {
        return getWithResponseAsync(subscriptionId, resourceGroupName, fabricName, operationId, context).block();
    }
    ...
    public OperationStatusInner get(
        String subscriptionId, String resourceGroupName, String fabricName, String operationId) {
        return getWithResponse(subscriptionId, resourceGroupName, fabricName, operationId, Context.NONE).getValue();
    }
}
