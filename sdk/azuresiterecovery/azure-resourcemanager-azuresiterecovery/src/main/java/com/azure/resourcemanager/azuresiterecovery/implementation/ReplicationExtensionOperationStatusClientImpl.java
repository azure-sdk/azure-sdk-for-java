...
/**
 * An instance of this class provides access to all the operations defined in ReplicationExtensionOperationStatusClient.
 */
public final class ReplicationExtensionOperationStatusClientImpl implements ReplicationExtensionOperationStatusClient {
    ...
    ReplicationExtensionOperationStatusClientImpl(AzureSiteRecoveryManagementServiceApiImpl client) {
        this.service =
            RestProxy
                .create(
                    ReplicationExtensionOperationStatusService.class,
     ...
     *
     * <p>Tracks the results of an asynchronous operation on the replication extension.
     *
    ...
    private Mono<OperationStatusInner> getAsync(
        ...
        String replicationExtensionName,
        String operationId) {
        return getWithResponseAsync(subscriptionId, resourceGroupName, vaultName, replicationExtensionName, operationId)
    ...
    public OperationStatusInner get(
        ...
        return getWithResponse(
                subscriptionId, resourceGroupName, vaultName, replicationExtensionName, operationId, Context.NONE)
            .getValue();
    }
}
