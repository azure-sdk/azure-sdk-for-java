...
import com.azure.resourcemanager.azuresiterecovery.models.EmailConfigurationModelCollection;
...
public final class EmailConfigurationsClientImpl implements EmailConfigurationsClient {
     ...
     */
    EmailConfigurationsClientImpl(AzureSiteRecoveryManagementServiceApiImpl client) {
        this.service =
    ...
    /**
     * The interface defining all the services for AzureSiteRecoveryManagementServiceApiEmailConfigurations to be used
    ...
    private Mono<EmailConfigurationModelInner> getAsync(
        String subscriptionId, String resourceGroupName, String vaultName, String emailConfigurationName) {
        return getWithResponseAsync(subscriptionId, resourceGroupName, vaultName, emailConfigurationName)
    ...
    public Response<EmailConfigurationModelInner> getWithResponse(
        ...
        String emailConfigurationName,
        Context context) {
        return getWithResponseAsync(subscriptionId, resourceGroupName, vaultName, emailConfigurationName, context)
            .block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public EmailConfigurationModelInner get(
        String subscriptionId, String resourceGroupName, String vaultName, String emailConfigurationName) {
        return getWithResponse(subscriptionId, resourceGroupName, vaultName, emailConfigurationName, Context.NONE)
            .getValue();
    }
    ...
    private Mono<EmailConfigurationModelInner> createAsync(
        ...
        return createWithResponseAsync(subscriptionId, resourceGroupName, vaultName, emailConfigurationName, body)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
    ...
    public Response<EmailConfigurationModelInner> createWithResponse(
        ...
        return createWithResponseAsync(
                subscriptionId, resourceGroupName, vaultName, emailConfigurationName, body, context)
            .block();
    }
    ...
    public EmailConfigurationModelInner create(
        ...
        return createWithResponse(
                subscriptionId, resourceGroupName, vaultName, emailConfigurationName, body, Context.NONE)
            .getValue();
    }
