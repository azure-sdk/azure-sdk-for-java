...
public interface EmailConfigurationsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    EmailConfigurationModelInner get(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    EmailConfigurationModelInner create(
        String subscriptionId, String resourceGroupName, String vaultName, String emailConfigurationName);
    ...
    PagedIterable<EmailConfigurationModelInner> list(String subscriptionId, String resourceGroupName, String vaultName);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<EmailConfigurationModelInner> list(
