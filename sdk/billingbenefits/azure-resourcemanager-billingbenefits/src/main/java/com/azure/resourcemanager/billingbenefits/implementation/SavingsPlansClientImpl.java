...
public final class SavingsPlansClientImpl implements SavingsPlansClient {
    ...
    public interface SavingsPlansService {
        ...
        Mono<Response<SavingsPlanModelList>> list(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<SavingsPlanModelListResult>> listAll(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<SavingsPlanModelInner>> get(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<SavingsPlanValidateResponseInner>> validateUpdate(@HostParam("$host") String endpoint,
            @PathParam("savingsPlanOrderId") String savingsPlanOrderId,
            @PathParam("savingsPlanId") String savingsPlanId, @QueryParam("api-version") String apiVersion,
    ...
    private Mono<PagedResponse<SavingsPlanModelInner>> listSinglePageAsync(String savingsPlanOrderId) {
        ...
        return FluxUtil
            .withContext(context -> service.list(this.client.getEndpoint(), savingsPlanOrderId,
    ...
    private Mono<PagedResponse<SavingsPlanModelInner>> listSinglePageAsync(String savingsPlanOrderId, Context context) {
        ...
        return service.list(this.client.getEndpoint(), savingsPlanOrderId, this.client.getApiVersion(), accept, context)
    ...
    private PagedFlux<SavingsPlanModelInner> listAsync(String savingsPlanOrderId, Context context) {
        return new PagedFlux<>(() -> listSinglePageAsync(savingsPlanOrderId, context),
    ...
    private Mono<PagedResponse<SavingsPlanModelInner>> listAllSinglePageAsync(String filter, String orderby,
        ...
        context = this.client.mergeContext(context);
        return service
            .listAll(this.client.getEndpoint(), this.client.getApiVersion(), filter, orderby, refreshSummary, skiptoken,
                selectedState, take, accept, context)
            .map(res -> new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(),
                res.getValue().value(), res.getValue().nextLink(), null));
    }
    ...
    private Mono<Response<SavingsPlanModelInner>> getWithResponseAsync(String savingsPlanOrderId, String savingsPlanId,
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.get(this.client.getEndpoint(), savingsPlanOrderId, savingsPlanId,
    ...
    private Mono<Response<SavingsPlanModelInner>> getWithResponseAsync(String savingsPlanOrderId, String savingsPlanId,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.get(this.client.getEndpoint(), savingsPlanOrderId, savingsPlanId, this.client.getApiVersion(),
    ...
    private Mono<SavingsPlansUpdateResponse> updateWithResponseAsync(String savingsPlanOrderId, String savingsPlanId,
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.update(this.client.getEndpoint(), savingsPlanOrderId, savingsPlanId,
    ...
    private Mono<SavingsPlansUpdateResponse> updateWithResponseAsync(String savingsPlanOrderId, String savingsPlanId,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.update(this.client.getEndpoint(), savingsPlanOrderId, savingsPlanId, this.client.getApiVersion(),
            body, accept, context);
    }
    ...
    private Mono<Response<SavingsPlanValidateResponseInner>> validateUpdateWithResponseAsync(String savingsPlanOrderId,
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.validateUpdate(this.client.getEndpoint(), savingsPlanOrderId, savingsPlanId,
                this.client.getApiVersion(), body, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<SavingsPlanValidateResponseInner>> validateUpdateWithResponseAsync(String savingsPlanOrderId,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.validateUpdate(this.client.getEndpoint(), savingsPlanOrderId, savingsPlanId,
            this.client.getApiVersion(), body, accept, context);
    }
