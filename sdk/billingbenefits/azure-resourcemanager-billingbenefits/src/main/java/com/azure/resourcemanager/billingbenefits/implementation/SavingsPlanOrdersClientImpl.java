...
public final class SavingsPlanOrdersClientImpl implements SavingsPlanOrdersClient {
     ...
     */
    SavingsPlanOrdersClientImpl(BenefitsRPImpl client) {
        this.service =
    ...
    /**
     * The interface defining all the services for BenefitsRPSavingsPlanOrders to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "BenefitsRPSavingsPla")
    private interface SavingsPlanOrdersService {
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<SavingsPlanOrderModelInner>> elevate(
            @HostParam("$host") String endpoint,
            @PathParam("savingsPlanOrderId") String savingsPlanOrderId,
            @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept,
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return savings plan order along with {@link Response} on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<SavingsPlanOrderModelInner>> elevateWithResponseAsync(String savingsPlanOrderId) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<SavingsPlanOrderModelInner>> elevateWithResponseAsync(
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return savings plan order on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<SavingsPlanOrderModelInner> elevateAsync(String savingsPlanOrderId) {
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return savings plan order along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<SavingsPlanOrderModelInner> elevateWithResponse(String savingsPlanOrderId, Context context) {
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return savings plan order.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public SavingsPlanOrderModelInner elevate(String savingsPlanOrderId) {
