...
public interface SavingsPlanOrdersClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<SavingsPlanOrderModelInner> elevateWithResponse(String savingsPlanOrderId, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    SavingsPlanOrderModelInner elevate(String savingsPlanOrderId);
