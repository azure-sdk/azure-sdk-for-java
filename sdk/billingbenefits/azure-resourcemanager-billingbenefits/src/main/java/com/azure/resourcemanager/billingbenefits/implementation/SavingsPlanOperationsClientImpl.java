...
public final class SavingsPlanOperationsClientImpl implements SavingsPlanOperationsClient {
     ...
     */
    SavingsPlanOperationsClientImpl(BenefitsRPImpl client) {
        this.service =
            RestProxy
    ...
    /**
     * The interface defining all the services for BenefitsRPSavingsPlanOperations to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "BenefitsRPSavingsPla")
    private interface SavingsPlanOperationsService {
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<SavingsPlanModelInner>> update(
            @HostParam("$host") String endpoint,
            @PathParam("savingsPlanOrderId") String savingsPlanOrderId,
            @PathParam("savingsPlanId") String savingsPlanId,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") SavingsPlanUpdateRequestInner body,
            @HeaderParam("Accept") String accept,
            Context context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<SavingsPlanModelInner>> updateWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<SavingsPlanModelInner> updateWithResponse(
        String savingsPlanOrderId, String savingsPlanId, SavingsPlanUpdateRequestInner body, Context context) {
