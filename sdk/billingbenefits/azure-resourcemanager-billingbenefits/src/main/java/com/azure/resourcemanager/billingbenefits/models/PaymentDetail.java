...
public final class PaymentDetail {
    ...
    /*
     * The internalProperties property.
     */
    @JsonProperty(value = "internalProperties")
    private PaymentDetailInternalProperties internalProperties;
    ...
    /**
     * Get the internalProperties property: The internalProperties property.
     *
     * @return the internalProperties value.
     */
    public PaymentDetailInternalProperties internalProperties() {
        return this.internalProperties;
    }

    /**
     * Set the internalProperties property: The internalProperties property.
     *
     * @param internalProperties the internalProperties value to set.
     * @return the PaymentDetail object itself.
     */
    public PaymentDetail withInternalProperties(PaymentDetailInternalProperties internalProperties) {
