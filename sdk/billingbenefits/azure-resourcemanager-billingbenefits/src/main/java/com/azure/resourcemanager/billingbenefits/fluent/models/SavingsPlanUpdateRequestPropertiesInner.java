...
@Fluent
public final class SavingsPlanUpdateRequestPropertiesInner {
    /*
     * Display name
     */
    ...
    private RenewPropertiesInner renewProperties;

    /** Creates an instance of SavingsPlanUpdateRequestPropertiesInner class. */
    public SavingsPlanUpdateRequestPropertiesInner() {
    }
     ...
     * @return the SavingsPlanUpdateRequestPropertiesInner object itself.
     */
    public SavingsPlanUpdateRequestPropertiesInner withDisplayName(String displayName) {
     ...
     * @return the SavingsPlanUpdateRequestPropertiesInner object itself.
     */
    public SavingsPlanUpdateRequestPropertiesInner withAppliedScopeType(AppliedScopeType appliedScopeType) {
     ...
     * @return the SavingsPlanUpdateRequestPropertiesInner object itself.
     */
    public SavingsPlanUpdateRequestPropertiesInner withAppliedScopeProperties(
    ...
    /**
     * Get the renew property: Setting this to true will automatically purchase a new savings plan on the expiration
     * date time.
     *
    ...
    /**
     * Set the renew property: Setting this to true will automatically purchase a new savings plan on the expiration
     * date time.
     *
     * @param renew the renew value to set.
     * @return the SavingsPlanUpdateRequestPropertiesInner object itself.
     */
    public SavingsPlanUpdateRequestPropertiesInner withRenew(Boolean renew) {
        this.renew = renew;
        return this;
    }
     ...
     */
    public RenewPropertiesInner renewProperties() {
     ...
     * @return the SavingsPlanUpdateRequestPropertiesInner object itself.
     */
    public SavingsPlanUpdateRequestPropertiesInner withRenewProperties(RenewPropertiesInner renewProperties) {
