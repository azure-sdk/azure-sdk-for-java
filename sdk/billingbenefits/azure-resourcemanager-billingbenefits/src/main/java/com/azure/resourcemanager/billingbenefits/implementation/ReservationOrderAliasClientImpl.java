...
public final class ReservationOrderAliasClientImpl implements ReservationOrderAliasClient {
     ...
     */
    ReservationOrderAliasClientImpl(BenefitsRPImpl client) {
        this.service =
            RestProxy
    ...
    /**
     * The interface defining all the services for BenefitsRPReservationOrderAlias to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "BenefitsRPReservatio")
    private interface ReservationOrderAliasService {
