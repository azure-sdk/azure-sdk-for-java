...
import com.azure.resourcemanager.billingbenefits.models.OperationListResult;
...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    OperationsClientImpl(BillingBenefitsRPImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for BillingBenefitsRPOperations to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "BillingBenefitsRPOpe")
