...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    OperationsClientImpl(BenefitsRPImpl client) {
        this.service =
    ...
    /**
     * The interface defining all the services for BenefitsRPOperations to be used by the proxy service to perform REST
     * calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "BenefitsRPOperations")
