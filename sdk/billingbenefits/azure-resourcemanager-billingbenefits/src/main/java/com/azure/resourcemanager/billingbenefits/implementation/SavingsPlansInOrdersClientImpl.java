...
/** An instance of this class provides access to all the operations defined in SavingsPlansInOrdersClient. */
public final class SavingsPlansInOrdersClientImpl implements SavingsPlansInOrdersClient {
    /** The proxy service used to perform REST calls. */
    private final SavingsPlansInOrdersService service;

    /** The service client containing this operation class. */
    private final BillingBenefitsRPImpl client;

    /**
     * Initializes an instance of SavingsPlansInOrdersClientImpl.
     *
     * @param client the instance of the service client containing this operation class.
     */
    SavingsPlansInOrdersClientImpl(BillingBenefitsRPImpl client) {
        this.service =
            RestProxy
                .create(SavingsPlansInOrdersService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for BillingBenefitsRPSavingsPlansInOrders to be used by the proxy service
     * to perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "BillingBenefitsRPSav")
    public interface SavingsPlansInOrdersService {
