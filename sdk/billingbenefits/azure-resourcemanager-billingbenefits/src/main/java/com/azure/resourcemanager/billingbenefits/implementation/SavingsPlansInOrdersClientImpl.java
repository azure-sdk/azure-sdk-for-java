...
public final class SavingsPlansInOrdersClientImpl implements SavingsPlansInOrdersClient {
     ...
     */
    SavingsPlansInOrdersClientImpl(BenefitsRPImpl client) {
        this.service =
            RestProxy
    ...
    /**
     * The interface defining all the services for BenefitsRPSavingsPlansInOrders to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "BenefitsRPSavingsPla")
    private interface SavingsPlansInOrdersService {
