...
public final class SavingsPlanOrderAliasClientImpl implements SavingsPlanOrderAliasClient {
     ...
     */
    SavingsPlanOrderAliasClientImpl(BenefitsRPImpl client) {
        this.service =
            RestProxy
    ...
    /**
     * The interface defining all the services for BenefitsRPSavingsPlanOrderAlias to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "BenefitsRPSavingsPla")
    private interface SavingsPlanOrderAliasService {
