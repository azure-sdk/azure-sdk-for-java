...
public final class MembershipsClientImpl implements MembershipsClient {
    ...
    /**
     * Initializes an instance of MembershipsClientImpl.
     *
     * @param client the instance of the service client containing this operation class.
     */
    MembershipsClientImpl(McppClientImpl client) {
        this.service =
            RestProxy.create(MembershipsService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for McppClientMemberships to be used by the proxy service to perform REST
     * calls.
     */
    @Host("{$host}")
    ...
    public interface MembershipsService {
        ...
        @Get(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.CloudPartnerProgram"
                + "/membership/{resourceName}")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<MembershipDetailsResponseInner>> getByResourceGroup(
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<MembershipDetailsResponseInner>> createPurchase(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("resourceName") String resourceName,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") ProductCode body,
            @HeaderParam("Accept") String accept,
            Context context);
     ...
     * @return mCPP Purchase details response along with {@link Response} on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<MembershipDetailsResponseInner>> getByResourceGroupWithResponseAsync(
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return mCPP Purchase details response on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<MembershipDetailsResponseInner> getByResourceGroupAsync(
        String subscriptionId, String resourceGroupName, String resourceName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<MembershipDetailsResponseInner> getByResourceGroupWithResponse(
        String subscriptionId, String resourceGroupName, String resourceName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public MembershipDetailsResponseInner getByResourceGroup(
        String subscriptionId, String resourceGroupName, String resourceName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<MembershipDetailsResponseInner>> createPurchaseWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<MembershipDetailsResponseInner> createPurchaseAsync(
        String subscriptionId, String resourceGroupName, String resourceName, ProductCode body) {
        return createPurchaseWithResponseAsync(subscriptionId, resourceGroupName, resourceName, body)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<MembershipDetailsResponseInner> createPurchaseWithResponse(
        String subscriptionId, String resourceGroupName, String resourceName, ProductCode body, Context context) {
        return createPurchaseWithResponseAsync(subscriptionId, resourceGroupName, resourceName, body, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public MembershipDetailsResponseInner createPurchase(
        String subscriptionId, String resourceGroupName, String resourceName, ProductCode body) {
        return createPurchaseWithResponse(subscriptionId, resourceGroupName, resourceName, body, Context.NONE)
            .getValue();
    }
