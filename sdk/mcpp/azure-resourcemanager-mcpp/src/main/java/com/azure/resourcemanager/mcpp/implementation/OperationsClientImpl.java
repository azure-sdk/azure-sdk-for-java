...
import com.azure.resourcemanager.mcpp.models.OperationListResult;
...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    OperationsClientImpl(McppClientImpl client) {
        this.service =
    ...
    /**
     * The interface defining all the services for McppClientOperations to be used by the proxy service to perform REST
     * calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "McppClientOperations")
    public interface OperationsService {
        @Headers({"Content-Type: application/json"})
        @Get("/providers/Microsoft.CloudPartnerProgram/operations")
