...
public final class VirtualMachinesImpl implements VirtualMachines {
    ...
    public void delete(
        ...
        this.serviceClient().delete(resourceGroupName, virtualMachineName, deleteFromHost, force, context);
    }
    ...
    public void deleteById(String id) {
        ...
        this.delete(resourceGroupName, virtualMachineName, localDeleteFromHost, localForce, Context.NONE);
    }

    public void deleteByIdWithResponse(String id, Boolean deleteFromHost, Boolean force, Context context) {
        String resourceGroupName = Utils.getValueFromIdByName(id, "resourceGroups");
        if (resourceGroupName == null) {
            throw LOGGER
                .logExceptionAsError(
        ...
        this.delete(resourceGroupName, virtualMachineName, deleteFromHost, force, context);
    }
