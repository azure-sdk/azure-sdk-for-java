...
public interface HybridIdentityMetadatas {
     ...
     */
    PagedIterable<HybridIdentityMetadata> list(String resourceGroupName, String virtualMachineName);
     ...
     * @return list of HybridIdentityMetadata as paginated response with {@link PagedIterable}.
     */
    PagedIterable<HybridIdentityMetadata> list(String resourceGroupName, String virtualMachineName, Context context);
