...
public final class VCenterImpl implements VCenter, VCenter.Definition, VCenter.Update {
    ...
    public VCenter create() {
        this.innerObject = serviceManager.serviceClient().getVCenters().create(resourceGroupName, vcenterName,
    ...
    public VCenter apply() {
        this.innerObject = serviceManager.serviceClient().getVCenters()
            .updateWithResponse(resourceGroupName, vcenterName, updateBody, Context.NONE).getValue();
        return this;
    }

    public VCenter apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getVCenters()
            .updateWithResponse(resourceGroupName, vcenterName, updateBody, context).getValue();
        return this;
    }
    ...
    public VCenter refresh() {
        this.innerObject = serviceManager.serviceClient().getVCenters()
            .getByResourceGroupWithResponse(resourceGroupName, vcenterName, Context.NONE).getValue();
        return this;
    }

    public VCenter refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getVCenters()
            .getByResourceGroupWithResponse(resourceGroupName, vcenterName, context).getValue();
        return this;
    }
