...
public final class VCentersClientImpl implements VCentersClient {
    ...
    public interface VCentersService {
        ...
        @Put("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ConnectedVMwarevSphere/vcenters/{vcenterName}")
        ...
        Mono<Response<Flux<ByteBuffer>>> create(@HostParam("$host") String endpoint,
            ...
            @QueryParam("api-version") String apiVersion, @BodyParam("application/json") VCenterInner body,
            @HeaderParam("Accept") String accept, Context context);

        @Headers({ "Content-Type: application/json" })
        @Get("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ConnectedVMwarevSphere/vcenters/{vcenterName}")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<VCenterInner>> getByResourceGroup(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("vcenterName") String vcenterName,
            @QueryParam("api-version") String apiVersion, @HeaderParam("Accept") String accept, Context context);

        @Headers({ "Content-Type: application/json" })
        @Patch("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ConnectedVMwarevSphere/vcenters/{vcenterName}")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<VCenterInner>> update(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("vcenterName") String vcenterName,
        ...
        @Headers({ "Content-Type: application/json" })
        @Delete("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ConnectedVMwarevSphere/vcenters/{vcenterName}")
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<VCentersList>> list(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<VCentersList>> listByResourceGroup(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<VCentersList>> listNext(@PathParam(value = "nextLink", encoded = true) String nextLink,
    ...
    private Mono<Response<Flux<ByteBuffer>>> createWithResponseAsync(String resourceGroupName, String vcenterName,
        VCenterInner body) {
        ...
        return FluxUtil
            .withContext(context -> service.create(this.client.getEndpoint(), this.client.getSubscriptionId(),
                resourceGroupName, vcenterName, this.client.getApiVersion(), body, accept, context))
    ...
    private Mono<Response<Flux<ByteBuffer>>> createWithResponseAsync(String resourceGroupName, String vcenterName,
        ...
        return service.create(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            vcenterName, this.client.getApiVersion(), body, accept, context);
    }
    ...
    private PollerFlux<PollResult<VCenterInner>, VCenterInner> beginCreateAsync(String resourceGroupName,
        String vcenterName, VCenterInner body) {
    ...
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<VCenterInner>, VCenterInner> beginCreateAsync(String resourceGroupName,
        String vcenterName, VCenterInner body, Context context) {
        context = this.client.mergeContext(context);
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<VCenterInner>, VCenterInner> beginCreate(String resourceGroupName,
        String vcenterName) {
        final VCenterInner body = null;
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<VCenterInner>, VCenterInner> beginCreate(String resourceGroupName, String vcenterName,
        VCenterInner body, Context context) {
    ...
    private Mono<VCenterInner> createAsync(String resourceGroupName, String vcenterName, VCenterInner body) {
        return beginCreateAsync(resourceGroupName, vcenterName, body).last()
    ...
    private Mono<VCenterInner> createAsync(String resourceGroupName, String vcenterName, VCenterInner body,
        Context context) {
        return beginCreateAsync(resourceGroupName, vcenterName, body, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<VCenterInner>> getByResourceGroupWithResponseAsync(String resourceGroupName,
        String vcenterName) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
    ...
    private Mono<Response<VCenterInner>> getByResourceGroupWithResponseAsync(String resourceGroupName,
        ...
        return service.getByResourceGroup(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            vcenterName, this.client.getApiVersion(), accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<VCenterInner> getByResourceGroupWithResponse(String resourceGroupName, String vcenterName,
        Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<VCenterInner>> updateWithResponseAsync(String resourceGroupName, String vcenterName,
        ResourcePatch body) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<VCenterInner> updateWithResponse(String resourceGroupName, String vcenterName, ResourcePatch body,
        Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> deleteWithResponseAsync(String resourceGroupName, String vcenterName,
        Boolean force) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        return FluxUtil
            .withContext(context -> service.delete(this.client.getEndpoint(), this.client.getSubscriptionId(),
                resourceGroupName, vcenterName, this.client.getApiVersion(), force, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> deleteWithResponseAsync(String resourceGroupName, String vcenterName,
        ...
        return service.delete(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            vcenterName, this.client.getApiVersion(), force, accept, context);
    }
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String vcenterName, Boolean force) {
        return beginDeleteAsync(resourceGroupName, vcenterName, force).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String vcenterName, Boolean force, Context context) {
        return beginDeleteAsync(resourceGroupName, vcenterName, force, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
