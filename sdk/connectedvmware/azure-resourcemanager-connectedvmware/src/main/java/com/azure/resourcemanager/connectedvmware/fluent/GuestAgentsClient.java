...
public interface GuestAgentsClient {
    ...
    PagedIterable<GuestAgentInner> list(String resourceGroupName, String virtualMachineName);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<GuestAgentInner> list(String resourceGroupName, String virtualMachineName, Context context);
}
