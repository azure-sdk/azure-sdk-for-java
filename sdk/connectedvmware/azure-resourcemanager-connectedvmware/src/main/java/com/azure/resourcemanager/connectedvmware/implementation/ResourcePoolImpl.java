...
public final class ResourcePoolImpl implements ResourcePool, ResourcePool.Definition, ResourcePool.Update {
    ...
    public ResourcePool create() {
        this.innerObject = serviceManager.serviceClient().getResourcePools().create(resourceGroupName, resourcePoolName,
    ...
    public ResourcePool apply() {
        this.innerObject = serviceManager.serviceClient().getResourcePools()
            .updateWithResponse(resourceGroupName, resourcePoolName, updateBody, Context.NONE).getValue();
        return this;
    }

    public ResourcePool apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getResourcePools()
            .updateWithResponse(resourceGroupName, resourcePoolName, updateBody, context).getValue();
        return this;
    }
    ...
    public ResourcePool refresh() {
        this.innerObject = serviceManager.serviceClient().getResourcePools()
            .getByResourceGroupWithResponse(resourceGroupName, resourcePoolName, Context.NONE).getValue();
        return this;
    }

    public ResourcePool refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getResourcePools()
            .getByResourceGroupWithResponse(resourceGroupName, resourcePoolName, context).getValue();
        return this;
    }
