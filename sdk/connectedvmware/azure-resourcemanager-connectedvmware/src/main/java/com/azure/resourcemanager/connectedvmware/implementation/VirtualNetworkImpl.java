...
public final class VirtualNetworkImpl implements VirtualNetwork, VirtualNetwork.Definition, VirtualNetwork.Update {
    ...
    public VirtualNetwork create() {
        this.innerObject = serviceManager.serviceClient().getVirtualNetworks().create(resourceGroupName,
    ...
    public VirtualNetwork apply() {
        this.innerObject = serviceManager.serviceClient().getVirtualNetworks()
            .updateWithResponse(resourceGroupName, virtualNetworkName, updateBody, Context.NONE).getValue();
        return this;
    }

    public VirtualNetwork apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getVirtualNetworks()
            .updateWithResponse(resourceGroupName, virtualNetworkName, updateBody, context).getValue();
        return this;
    }
