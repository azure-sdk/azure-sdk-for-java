...
public final class ResourceProvidersClientImpl implements ResourceProvidersClient {
     ...
     */
    ResourceProvidersClientImpl(ConnectedVMwareClientImpl client) {
        this.service =
    ...
    /**
     * The interface defining all the services for ConnectedVMwareClientResourceProviders to be used by the proxy
    ...
    public interface ResourceProvidersService {
        ...
        @Post(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers"
                + "/Microsoft.ConnectedVMwarevSphere/virtualMachines/{virtualMachineName}/upgradeExtensions")
    ...
    private PollerFlux<PollResult<Void>, Void> beginUpgradeExtensionsAsync(
        ...
        Mono<Response<Flux<ByteBuffer>>> mono =
            upgradeExtensionsWithResponseAsync(resourceGroupName, virtualMachineName, extensionUpgradeParameters);
        return this
            .client
    ...
    private PollerFlux<PollResult<Void>, Void> beginUpgradeExtensionsAsync(
        ...
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono =
            upgradeExtensionsWithResponseAsync(
                resourceGroupName, virtualMachineName, extensionUpgradeParameters, context);
        return this
            .client
    ...
    public SyncPoller<PollResult<Void>, Void> beginUpgradeExtensions(
        String resourceGroupName, String virtualMachineName, MachineExtensionUpgrade extensionUpgradeParameters) {
        return this
            .beginUpgradeExtensionsAsync(resourceGroupName, virtualMachineName, extensionUpgradeParameters)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginUpgradeExtensions(
        ...
        Context context) {
        return this
            .beginUpgradeExtensionsAsync(resourceGroupName, virtualMachineName, extensionUpgradeParameters, context)
            .getSyncPoller();
    }
    ...
    private Mono<Void> upgradeExtensionsAsync(
        String resourceGroupName, String virtualMachineName, MachineExtensionUpgrade extensionUpgradeParameters) {
        return beginUpgradeExtensionsAsync(resourceGroupName, virtualMachineName, extensionUpgradeParameters)
            .last()
    ...
    private Mono<Void> upgradeExtensionsAsync(
        ...
        MachineExtensionUpgrade extensionUpgradeParameters,
        Context context) {
        return beginUpgradeExtensionsAsync(resourceGroupName, virtualMachineName, extensionUpgradeParameters, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    public void upgradeExtensions(
        String resourceGroupName, String virtualMachineName, MachineExtensionUpgrade extensionUpgradeParameters) {
        upgradeExtensionsAsync(resourceGroupName, virtualMachineName, extensionUpgradeParameters).block();
    }
    ...
    public void upgradeExtensions(
        ...
        MachineExtensionUpgrade extensionUpgradeParameters,
        Context context) {
        upgradeExtensionsAsync(resourceGroupName, virtualMachineName, extensionUpgradeParameters, context).block();
    }
}
