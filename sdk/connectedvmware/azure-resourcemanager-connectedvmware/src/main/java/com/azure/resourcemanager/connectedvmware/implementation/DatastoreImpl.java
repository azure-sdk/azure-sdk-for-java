...
public final class DatastoreImpl implements Datastore, Datastore.Definition, Datastore.Update {
    ...
    public Datastore create() {
        this.innerObject = serviceManager.serviceClient().getDatastores().create(resourceGroupName, datastoreName,
    ...
    public Datastore apply() {
        this.innerObject = serviceManager.serviceClient().getDatastores()
            .updateWithResponse(resourceGroupName, datastoreName, updateBody, Context.NONE).getValue();
        return this;
    }

    public Datastore apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getDatastores()
            .updateWithResponse(resourceGroupName, datastoreName, updateBody, context).getValue();
        return this;
    }
    ...
    public Datastore refresh() {
        this.innerObject = serviceManager.serviceClient().getDatastores()
            .getByResourceGroupWithResponse(resourceGroupName, datastoreName, Context.NONE).getValue();
        return this;
    }

    public Datastore refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getDatastores()
            .getByResourceGroupWithResponse(resourceGroupName, datastoreName, context).getValue();
        return this;
    }
