...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    OperationsClientImpl(ConnectedVMwareClientImpl client) {
        this.service =
    ...
    /**
     * The interface defining all the services for ConnectedVMwareClientOperations to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{$host}")
    ...
    private interface OperationsService {
        ...
        @Get("/providers/Microsoft.ConnectedVMwarevSphere/operations")
