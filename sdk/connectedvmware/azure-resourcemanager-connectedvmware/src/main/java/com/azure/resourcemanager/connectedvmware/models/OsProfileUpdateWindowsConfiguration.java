...
public final class OsProfileUpdateWindowsConfiguration {
     ...
     */
    public OsProfileUpdateWindowsConfiguration withAssessmentMode(String assessmentMode) {
     ...
     * @return the OsProfileUpdateWindowsConfiguration object itself.
     */
    public OsProfileUpdateWindowsConfiguration withPatchMode(String patchMode) {
        if (this.innerPatchSettings() == null) {
            this.innerPatchSettings = new PatchSettings();
        }
