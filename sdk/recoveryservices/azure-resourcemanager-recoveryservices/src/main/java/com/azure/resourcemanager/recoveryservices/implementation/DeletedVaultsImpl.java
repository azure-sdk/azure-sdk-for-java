...
public final class DeletedVaultsImpl implements DeletedVaults {
    ...
    public DeletedVault undelete(String location, String deletedVaultName, DeletedVaultUndeleteInput undeleteInput) {
        DeletedVaultInner inner = this.serviceClient().undelete(location, deletedVaultName, undeleteInput);
        if (inner != null) {
            return new DeletedVaultImpl(inner, this.manager());
        } else {
            return null;
    ...
    public DeletedVault undelete(String location, String deletedVaultName, DeletedVaultUndeleteInput undeleteInput,
        Context context) {
        DeletedVaultInner inner = this.serviceClient().undelete(location, deletedVaultName, undeleteInput, context);
        if (inner != null) {
            return new DeletedVaultImpl(inner, this.manager());
        } else {
            return null;
