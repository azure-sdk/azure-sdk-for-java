...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    OperationsClientImpl(DataLakeAnalyticsAccountManagementClientImpl client) {
        this.service =
    ...
    /**
     * The interface defining all the services for DataLakeAnalyticsAccountManagementClientOperations to be used by the
     ...
     * @return the list of available operations for Data Lake Analytics along with {@link Response} on successful
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the list of available operations for Data Lake Analytics on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
