...
#### `models.OperationMetaMetricAvailabilitiesSpecification` was modified
...
#### `models.AddDataLakeStoreParameters` was modified
...
#### `models.DataLakeStoreAccountInformationListResult` was modified

* `toJson(com.azure.json.JsonWriter)` was added
* `fromJson(com.azure.json.JsonReader)` was added

#### `models.UpdateComputePolicyParameters` was modified
...
#### `models.UpdateComputePolicyWithAccountParameters` was modified
...
#### `models.UpdateStorageAccountParameters` was modified
...
#### `models.UpdateDataLakeStoreWithAccountParameters` was modified

* `fromJson(com.azure.json.JsonReader)` was added
* `toJson(com.azure.json.JsonWriter)` was added

#### `models.SasTokenInformationListResult` was modified
...
#### `models.AddStorageAccountParameters` was modified

* `toJson(com.azure.json.JsonWriter)` was added
* `fromJson(com.azure.json.JsonReader)` was added

#### `models.CreateComputePolicyWithAccountParameters` was modified

* `toJson(com.azure.json.JsonWriter)` was added
* `fromJson(com.azure.json.JsonReader)` was added

#### `models.AddDataLakeStoreWithAccountParameters` was modified

* `fromJson(com.azure.json.JsonReader)` was added
* `toJson(com.azure.json.JsonWriter)` was added

#### `models.CreateOrUpdateComputePolicyParameters` was modified

* `fromJson(com.azure.json.JsonReader)` was added
* `toJson(com.azure.json.JsonWriter)` was added

#### `models.StorageAccountInformationListResult` was modified
...
#### `models.UpdateStorageAccountWithAccountParameters` was modified

* `fromJson(com.azure.json.JsonReader)` was added
* `toJson(com.azure.json.JsonWriter)` was added

#### `models.HiveMetastore` was modified
...
#### `models.OperationMetaPropertyInfo` was modified

* `fromJson(com.azure.json.JsonReader)` was added
* `toJson(com.azure.json.JsonWriter)` was added

#### `models.StorageContainerListResult` was modified
...
#### `models.AddStorageAccountWithAccountParameters` was modified

* `fromJson(com.azure.json.JsonReader)` was added
* `toJson(com.azure.json.JsonWriter)` was added

#### `models.ComputePolicyListResult` was modified
