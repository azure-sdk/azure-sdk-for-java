...
public final class ConfigurationsClientImpl implements ConfigurationsClient {
    ...
    public interface ConfigurationsService {
        ...
        @Headers({ "Content-Type: application/json" })
        @Get("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Nginx.NginxPlus/nginxDeployments/{deploymentName}/configurations/default")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        ...
        @Headers({ "Content-Type: application/json" })
        @Put("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Nginx.NginxPlus/nginxDeployments/{deploymentName}/configurations/default")
        ...
        @Headers({ "Content-Type: application/json" })
        @Delete("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Nginx.NginxPlus/nginxDeployments/{deploymentName}/configurations/default")
    ...
    private Mono<NginxConfigurationInner> getAsync(String resourceGroupName, String deploymentName) {
        return getWithResponseAsync(resourceGroupName, deploymentName).flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
    ...
    public Response<NginxConfigurationInner> getWithResponse(String resourceGroupName, String deploymentName,
        Context context) {
        return getWithResponseAsync(resourceGroupName, deploymentName, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public NginxConfigurationInner get(String resourceGroupName, String deploymentName) {
        return getWithResponse(resourceGroupName, deploymentName, Context.NONE).getValue();
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String resourceGroupName,
        String deploymentName, NginxConfigurationInner body) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String resourceGroupName,
        String deploymentName, NginxConfigurationInner body, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    private PollerFlux<PollResult<NginxConfigurationInner>, NginxConfigurationInner>
        beginCreateOrUpdateAsync(String resourceGroupName, String deploymentName, NginxConfigurationInner body) {
    ...
    private Mono<NginxConfigurationInner> createOrUpdateAsync(String resourceGroupName, String deploymentName,
        ...
        return beginCreateOrUpdateAsync(resourceGroupName, deploymentName, body, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
