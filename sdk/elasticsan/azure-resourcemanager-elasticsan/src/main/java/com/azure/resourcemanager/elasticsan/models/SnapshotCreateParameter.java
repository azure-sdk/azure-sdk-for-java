...
@Fluent
public final class SnapshotCreateParameter extends ProxyResource {
    /*
     ...
     * @return the SnapshotCreateParameter object itself.
     */
            ...
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException(
                        "Missing required property innerProperties in model SnapshotCreateParameter"));
        } else {
            innerProperties().validate();
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(SnapshotCreateParameter.class);
}
