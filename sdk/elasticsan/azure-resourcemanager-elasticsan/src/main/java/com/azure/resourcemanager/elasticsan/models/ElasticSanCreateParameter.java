...
@Fluent
public final class ElasticSanCreateParameter extends Resource {
    /*
     ...
     * @return the ElasticSanCreateParameter object itself.
     */
            ...
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException(
                        "Missing required property innerProperties in model ElasticSanCreateParameter"));
        } else {
            innerProperties().validate();
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(ElasticSanCreateParameter.class);
}
