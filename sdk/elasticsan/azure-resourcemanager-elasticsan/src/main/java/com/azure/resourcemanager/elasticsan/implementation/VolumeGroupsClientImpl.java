...
public final class VolumeGroupsClientImpl implements VolumeGroupsClient {
    ...
    public interface VolumeGroupsService {
        ...
        Mono<Response<Flux<ByteBuffer>>> delete(@HostParam("$host") String endpoint,
            ...
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("elasticSanName") String elasticSanName, @PathParam("volumeGroupName") String volumeGroupName,
            @QueryParam("api-version") String apiVersion, @QueryParam("purge") Purge purge,
            @HeaderParam("Accept") String accept, Context context);
    ...
    private Mono<Response<Flux<ByteBuffer>>> deleteWithResponseAsync(String resourceGroupName, String elasticSanName,
        String volumeGroupName, Purge purge) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return FluxUtil
            .withContext(
                context -> service.delete(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
                    elasticSanName, volumeGroupName, this.client.getApiVersion(), purge, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> deleteWithResponseAsync(String resourceGroupName, String elasticSanName,
        String volumeGroupName, Purge purge, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    private PollerFlux<PollResult<Void>, Void> beginDeleteAsync(String resourceGroupName, String elasticSanName,
        String volumeGroupName, Purge purge) {
        Mono<Response<Flux<ByteBuffer>>> mono
            = deleteWithResponseAsync(resourceGroupName, elasticSanName, volumeGroupName, purge);
    ...
    private PollerFlux<PollResult<Void>, Void> beginDeleteAsync(String resourceGroupName, String elasticSanName,
        ...
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono
            = deleteWithResponseAsync(resourceGroupName, elasticSanName, volumeGroupName, purge, context);
        return this.client.<Void, Void>getLroResult(mono, this.client.getHttpPipeline(), Void.class, Void.class,
            context);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String elasticSanName,
        String volumeGroupName) {
        final Purge purge = null;
        return this.beginDeleteAsync(resourceGroupName, elasticSanName, volumeGroupName, purge).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String elasticSanName,
        String volumeGroupName, Purge purge, Context context) {
        return this.beginDeleteAsync(resourceGroupName, elasticSanName, volumeGroupName, purge, context)
            .getSyncPoller();
    }
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String elasticSanName, String volumeGroupName,
        Purge purge) {
        return beginDeleteAsync(resourceGroupName, elasticSanName, volumeGroupName, purge).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> deleteAsync(String resourceGroupName, String elasticSanName, String volumeGroupName, Purge purge,
        Context context) {
        return beginDeleteAsync(resourceGroupName, elasticSanName, volumeGroupName, purge, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    public void delete(String resourceGroupName, String elasticSanName, String volumeGroupName) {
        final Purge purge = null;
        deleteAsync(resourceGroupName, elasticSanName, volumeGroupName, purge).block();
    }
    ...
    public void delete(String resourceGroupName, String elasticSanName, String volumeGroupName, Purge purge,
        Context context) {
        deleteAsync(resourceGroupName, elasticSanName, volumeGroupName, purge, context).block();
    }
    ...
    private Mono<Response<VolumeGroupInner>> getWithResponseAsync(String resourceGroupName, String elasticSanName,
        ...
        return FluxUtil
            .withContext(context -> service.get(this.client.getEndpoint(), this.client.getSubscriptionId(),
                resourceGroupName, elasticSanName, volumeGroupName, this.client.getApiVersion(),
    ...
    private Mono<VolumeGroupInner> getAsync(String resourceGroupName, String elasticSanName, String volumeGroupName) {
        final XMsAccessSoftDeletedResources xMsAccessSoftDeletedResources = null;
        return getWithResponseAsync(resourceGroupName, elasticSanName, volumeGroupName, xMsAccessSoftDeletedResources)
    ...
    public VolumeGroupInner get(String resourceGroupName, String elasticSanName, String volumeGroupName) {
        final XMsAccessSoftDeletedResources xMsAccessSoftDeletedResources = null;
        return getWithResponse(resourceGroupName, elasticSanName, volumeGroupName, xMsAccessSoftDeletedResources,
