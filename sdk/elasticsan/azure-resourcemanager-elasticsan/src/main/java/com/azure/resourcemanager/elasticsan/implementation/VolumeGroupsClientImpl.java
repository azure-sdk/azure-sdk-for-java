...
public final class VolumeGroupsClientImpl implements VolumeGroupsClient {
    ...
    private interface VolumeGroupsService {
        ...
        Mono<Response<Flux<ByteBuffer>>> delete(
            ...
            @PathParam("elasticSanName") String elasticSanName,
            @PathParam("volumeGroupName") String volumeGroupName,
            @HeaderParam("x-ms-delete-volumes") Boolean forceDeleteVolumes,
            @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept,
            Context context);
    ...
    private PollerFlux<PollResult<Void>, Void> beginDeleteAsync(
        String resourceGroupName, String elasticSanName, String volumeGroupName, Boolean forceDeleteVolumes) {
        Mono<Response<Flux<ByteBuffer>>> mono =
            deleteWithResponseAsync(resourceGroupName, elasticSanName, volumeGroupName, forceDeleteVolumes);
        return this
            .client
    ...
    private PollerFlux<PollResult<Void>, Void> beginDeleteAsync(
        ...
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono =
            deleteWithResponseAsync(resourceGroupName, elasticSanName, volumeGroupName, forceDeleteVolumes, context);
        return this
            .client
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(
        String resourceGroupName, String elasticSanName, String volumeGroupName, Boolean forceDeleteVolumes) {
        return beginDeleteAsync(resourceGroupName, elasticSanName, volumeGroupName, forceDeleteVolumes).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(
        ...
        Boolean forceDeleteVolumes,
        Context context) {
        return beginDeleteAsync(resourceGroupName, elasticSanName, volumeGroupName, forceDeleteVolumes, context)
            .getSyncPoller();
    }
    ...
    private Mono<Void> deleteAsync(
        String resourceGroupName, String elasticSanName, String volumeGroupName, Boolean forceDeleteVolumes) {
        return beginDeleteAsync(resourceGroupName, elasticSanName, volumeGroupName, forceDeleteVolumes)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String elasticSanName, String volumeGroupName) {
        final Boolean forceDeleteVolumes = null;
        return beginDeleteAsync(resourceGroupName, elasticSanName, volumeGroupName, forceDeleteVolumes)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    public void delete(
        String resourceGroupName, String elasticSanName, String volumeGroupName, Boolean forceDeleteVolumes) {
        deleteAsync(resourceGroupName, elasticSanName, volumeGroupName, forceDeleteVolumes).block();
    }
    ...
    public void delete(
        ...
        Boolean forceDeleteVolumes,
        Context context) {
        deleteAsync(resourceGroupName, elasticSanName, volumeGroupName, forceDeleteVolumes, context).block();
    }
    ...
    public VolumeGroupInner get(String resourceGroupName, String elasticSanName, String volumeGroupName) {
        return getAsync(resourceGroupName, elasticSanName, volumeGroupName).block();
    }
