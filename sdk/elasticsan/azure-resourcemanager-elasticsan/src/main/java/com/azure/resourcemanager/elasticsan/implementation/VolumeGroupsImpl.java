...
public final class VolumeGroupsImpl implements VolumeGroups {
    ...
    public void delete(String resourceGroupName, String elasticSanName, String volumeGroupName, DeleteType deleteType,
        Context context) {
        this.serviceClient().delete(resourceGroupName, elasticSanName, volumeGroupName, deleteType, context);
    }
    ...
    public void deleteById(String id) {
        ...
        this.delete(resourceGroupName, elasticSanName, volumeGroupName, localDeleteType, Context.NONE);
    }

    public void deleteByIdWithResponse(String id, DeleteType deleteType, Context context) {
        String resourceGroupName = ResourceManagerUtils.getValueFromIdByName(id, "resourceGroups");
        if (resourceGroupName == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
                String.format("The resource ID '%s' is not valid. Missing path segment 'resourceGroups'.", id)));
        ...
        this.delete(resourceGroupName, elasticSanName, volumeGroupName, deleteType, context);
    }
