...
public final class PrivateEndpointConnectionsGetSamples {
    ...
    public static void
        ...
        manager.privateEndpointConnections()
            .getWithResponse("rgelasticsan", "elasticsanname", "ds", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class SkusListSamples {
    ...
    public static void skusListMaximumSetGen(com.azure.resourcemanager.elasticsan.ElasticSanManager manager) {
        manager.skus().list("qxjnbqhcp", com.azure.core.util.Context.NONE);
    }
}
```
    ...
    public static void volumeGroupsCreateMaximumSetGen(com.azure.resourcemanager.elasticsan.ElasticSanManager manager) {
        manager.volumeGroups()
            ...
            .withIdentity(new Identity().withType(IdentityType.NONE)
                .withUserAssignedIdentities(mapOf("key5", new UserAssignedIdentity())))
            ...
            .withEncryptionProperties(new EncryptionProperties()
                ...
                .withEncryptionIdentity(
                    new EncryptionIdentity().withEncryptionUserAssignedIdentity("iugvrhjvdicpvezicozf")))
            .withNetworkAcls(new NetworkRuleSet().withVirtualNetworkRules(Arrays
                .asList(new VirtualNetworkRule().withVirtualNetworkResourceId("hjiouaiusd").withAction(Action.ALLOW))))
            .create();
    }
...
public final class VolumeSnapshotsCreateSamples {
    ...
    public static void
        ...
        manager.volumeSnapshots()
            ...
            .withCreationData(new SnapshotCreationData().withSourceId("vxmsvj"))
            .create();
    }
...
public final class VolumeSnapshotsListByVolumeGroupSamples {
    ...
    public static void
        ...
        manager.volumeSnapshots()
            .listByVolumeGroup("rgelasticsan", "elasticsanname", "volumegroupname", "z",
                com.azure.core.util.Context.NONE);
    }
}
```
...
public final class VolumesCreateSamples {
    ...
    public static void volumesCreateMaximumSetGen(com.azure.resourcemanager.elasticsan.ElasticSanManager manager) {
        manager.volumes()
            ...
            .withExistingVolumegroup("rgelasticsan", "elasticsanname", "volumegroupname")
            .withSizeGiB(28L)
            .withCreationData(new SourceCreationData().withCreateSource(VolumeCreateOption.NONE).withSourceId("kn"))
            .withManagedBy(new ManagedByInfo().withResourceId("tlr"))
            .create();
    }
    ...
    public static void volumesUpdateMaximumSetGen(com.azure.resourcemanager.elasticsan.ElasticSanManager manager) {
        Volume resource = manager.volumes()
            .getWithResponse("rgelasticsan", "elasticsanname", "volumegroupname", "volumename",
                com.azure.core.util.Context.NONE)
            .getValue();
        resource.update().withSizeGiB(17L).withManagedBy(new ManagedByInfo().withResourceId("tlr")).apply();
    }
}
```
