...
public interface ConnectorsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<ConnectorInner> getByResourceGroupWithResponse(String resourceGroupName, String connectorName,
        Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<ConnectorInner> updateWithResponse(String resourceGroupName, String connectorName,
