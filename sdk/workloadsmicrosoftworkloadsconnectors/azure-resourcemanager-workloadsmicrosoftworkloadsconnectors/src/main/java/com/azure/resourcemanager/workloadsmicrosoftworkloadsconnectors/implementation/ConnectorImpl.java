...
public final class ConnectorImpl implements Connector, Connector.Definition, Connector.Update {
    ...
    public Connector create() {
        this.innerObject = serviceManager.serviceClient().getConnectors().create(resourceGroupName, connectorName,
    ...
    public Connector apply() {
        this.innerObject = serviceManager.serviceClient().getConnectors()
            .updateWithResponse(resourceGroupName, connectorName, updateBody, Context.NONE).getValue();
        return this;
    }

    public Connector apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getConnectors()
            .updateWithResponse(resourceGroupName, connectorName, updateBody, context).getValue();
        return this;
    }
    ...
    public Connector refresh() {
        this.innerObject = serviceManager.serviceClient().getConnectors()
            .getByResourceGroupWithResponse(resourceGroupName, connectorName, Context.NONE).getValue();
        return this;
    }

    public Connector refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getConnectors()
            .getByResourceGroupWithResponse(resourceGroupName, connectorName, context).getValue();
        return this;
    }
