...
public final class AcssBackupConnectionsClientImpl implements AcssBackupConnectionsClient {
    ...
    AcssBackupConnectionsClientImpl(WorkloadsClientImpl client) {
        this.service = RestProxy.create(AcssBackupConnectionsService.class, client.getHttpPipeline(),
    ...
    public interface AcssBackupConnectionsService {
        ...
        @Get("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Workloads/connectors/{connectorName}/acssBackups/{backupName}")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<AcssBackupConnectionInner>> get(@HostParam("$host") String endpoint,
        ...
        @Headers({ "Content-Type: application/json" })
        @Put("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Workloads/connectors/{connectorName}/acssBackups/{backupName}")
        ...
        Mono<Response<Flux<ByteBuffer>>> create(@HostParam("$host") String endpoint,
            ...
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("connectorName") String connectorName,
            @PathParam("backupName") String backupName, @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") AcssBackupConnectionInner body, @HeaderParam("Accept") String accept,
            Context context);

        @Headers({ "Content-Type: application/json" })
        @Patch("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Workloads/connectors/{connectorName}/acssBackups/{backupName}")
        ...
        Mono<Response<Flux<ByteBuffer>>> update(@HostParam("$host") String endpoint,
            ...
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("connectorName") String connectorName,
            @PathParam("backupName") String backupName, @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") UpdateAcssBackupConnectionRequest body, @HeaderParam("Accept") String accept,
            Context context);

        @Headers({ "Content-Type: application/json" })
        @Delete("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Workloads/connectors/{connectorName}/acssBackups/{backupName}")
        ...
        @Headers({ "Content-Type: application/json" })
        @Get("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Workloads/connectors/{connectorName}/acssBackups")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<AcssBackupConnectionList>> list(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("connectorName") String connectorName,
    ...
    private Mono<Response<AcssBackupConnectionInner>> getWithResponseAsync(String resourceGroupName,
        String connectorName, String backupName) {
        ...
        return FluxUtil
            .withContext(context -> service.get(this.client.getEndpoint(), this.client.getSubscriptionId(),
                resourceGroupName, connectorName, backupName, this.client.getApiVersion(), accept, context))
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<AcssBackupConnectionInner>> getWithResponseAsync(String resourceGroupName,
        String connectorName, String backupName, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service.get(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName, connectorName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<AcssBackupConnectionInner> getAsync(String resourceGroupName, String connectorName,
        String backupName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<AcssBackupConnectionInner> getWithResponse(String resourceGroupName, String connectorName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> createWithResponseAsync(String resourceGroupName, String connectorName,
        String backupName, AcssBackupConnectionInner body) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return FluxUtil
            .withContext(context -> service.create(this.client.getEndpoint(), this.client.getSubscriptionId(),
                resourceGroupName, connectorName, backupName, this.client.getApiVersion(), body, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> createWithResponseAsync(String resourceGroupName, String connectorName,
        String backupName, AcssBackupConnectionInner body, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service.create(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            connectorName, backupName, this.client.getApiVersion(), body, accept, context);
    }
    ...
    private PollerFlux<PollResult<AcssBackupConnectionInner>, AcssBackupConnectionInner> beginCreateAsync(
        ...
        return this.client.<AcssBackupConnectionInner, AcssBackupConnectionInner>getLroResult(mono,
            this.client.getHttpPipeline(), AcssBackupConnectionInner.class, AcssBackupConnectionInner.class,
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<AcssBackupConnectionInner>, AcssBackupConnectionInner>
        beginCreateAsync(String resourceGroupName, String connectorName, String backupName) {
    ...
    private PollerFlux<PollResult<AcssBackupConnectionInner>, AcssBackupConnectionInner> beginCreateAsync(
        ...
        return this.client.<AcssBackupConnectionInner, AcssBackupConnectionInner>getLroResult(mono,
            this.client.getHttpPipeline(), AcssBackupConnectionInner.class, AcssBackupConnectionInner.class, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<AcssBackupConnectionInner>, AcssBackupConnectionInner>
        beginCreate(String resourceGroupName, String connectorName, String backupName) {
        final AcssBackupConnectionInner body = null;
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return define the backup connection resource of virtual instance for SAP. on successful completion of
     * {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<AcssBackupConnectionInner> createAsync(String resourceGroupName, String connectorName,
        String backupName, AcssBackupConnectionInner body) {
        return beginCreateAsync(resourceGroupName, connectorName, backupName, body).last()
    ...
    private Mono<AcssBackupConnectionInner> createAsync(String resourceGroupName, String connectorName,
        String backupName, AcssBackupConnectionInner body, Context context) {
        return beginCreateAsync(resourceGroupName, connectorName, backupName, body, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    public AcssBackupConnectionInner create(String resourceGroupName, String connectorName, String backupName,
        AcssBackupConnectionInner body, Context context) {
    ...
    private Mono<Response<Flux<ByteBuffer>>> updateWithResponseAsync(String resourceGroupName, String connectorName,
        String backupName, UpdateAcssBackupConnectionRequest body) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> updateWithResponseAsync(String resourceGroupName, String connectorName,
        String backupName, UpdateAcssBackupConnectionRequest body, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<AcssBackupConnectionInner>, AcssBackupConnectionInner>
        beginUpdateAsync(String resourceGroupName, String connectorName, String backupName) {
    ...
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<AcssBackupConnectionInner>, AcssBackupConnectionInner>
        beginUpdate(String resourceGroupName, String connectorName, String backupName) {
        final UpdateAcssBackupConnectionRequest body = null;
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<AcssBackupConnectionInner> updateAsync(String resourceGroupName, String connectorName,
        String backupName, UpdateAcssBackupConnectionRequest body) {
        return beginUpdateAsync(resourceGroupName, connectorName, backupName, body).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<AcssBackupConnectionInner> updateAsync(String resourceGroupName, String connectorName,
        String backupName, UpdateAcssBackupConnectionRequest body, Context context) {
        return beginUpdateAsync(resourceGroupName, connectorName, backupName, body, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    public AcssBackupConnectionInner update(String resourceGroupName, String connectorName, String backupName,
        UpdateAcssBackupConnectionRequest body, Context context) {
    ...
    private Mono<Response<Flux<ByteBuffer>>> deleteWithResponseAsync(String resourceGroupName, String connectorName,
        ...
        return service.delete(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            connectorName, backupName, this.client.getApiVersion(), accept, context);
    }
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String connectorName, String backupName) {
        return beginDeleteAsync(resourceGroupName, connectorName, backupName).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String connectorName, String backupName, Context context) {
        return beginDeleteAsync(resourceGroupName, connectorName, backupName, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return defines the collection of backup connection resources of virtual instances for SAP along with
     * {@link PagedResponse} on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<AcssBackupConnectionInner>> listSinglePageAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(context -> service.list(this.client.getEndpoint(), this.client.getSubscriptionId(),
                resourceGroupName, connectorName, this.client.getApiVersion(), accept, context))
            .<PagedResponse<AcssBackupConnectionInner>>map(res -> new PagedResponseBase<>(res.getRequest(),
    ...
    private Mono<PagedResponse<AcssBackupConnectionInner>> listSinglePageAsync(String resourceGroupName,
        ...
        context = this.client.mergeContext(context);
        return service
            .list(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName, connectorName,
    ...
    private PagedFlux<AcssBackupConnectionInner> listAsync(String resourceGroupName, String connectorName) {
        return new PagedFlux<>(() -> listSinglePageAsync(resourceGroupName, connectorName),
    ...
    private PagedFlux<AcssBackupConnectionInner> listAsync(String resourceGroupName, String connectorName,
        Context context) {
        return new PagedFlux<>(() -> listSinglePageAsync(resourceGroupName, connectorName, context),
