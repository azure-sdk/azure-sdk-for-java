...
/**
 * Specify the HANA database TLS/SSL properties which will be used for enabling Azure Backup for this database. You
 * need to specify these details if you have enabled secure communication for your HANA database.
 */
@Fluent
