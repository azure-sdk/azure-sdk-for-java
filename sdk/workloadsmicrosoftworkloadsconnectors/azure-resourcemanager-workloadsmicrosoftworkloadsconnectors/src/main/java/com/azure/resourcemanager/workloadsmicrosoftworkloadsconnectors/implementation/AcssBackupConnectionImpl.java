...
public final class AcssBackupConnectionImpl
    ...
    public AcssBackupConnection create() {
        this.innerObject = serviceManager.serviceClient().getAcssBackupConnections().create(resourceGroupName,
            connectorName, backupName, this.innerModel(), Context.NONE);
        return this;
    }

    public AcssBackupConnection create(Context context) {
        this.innerObject = serviceManager.serviceClient().getAcssBackupConnections().create(resourceGroupName,
            connectorName, backupName, this.innerModel(), context);
        return this;
    }

    AcssBackupConnectionImpl(String name,
    ...
    public AcssBackupConnection apply() {
        this.innerObject = serviceManager.serviceClient().getAcssBackupConnections().update(resourceGroupName,
            connectorName, backupName, updateBody, Context.NONE);
        return this;
    }

    public AcssBackupConnection apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getAcssBackupConnections().update(resourceGroupName,
            connectorName, backupName, updateBody, context);
        return this;
    }

    AcssBackupConnectionImpl(AcssBackupConnectionInner innerObject,
        com.azure.resourcemanager.workloadsmicrosoftworkloadsconnectors.WorkloadsManager serviceManager) {
    ...
    public AcssBackupConnection refresh() {
        this.innerObject = serviceManager.serviceClient().getAcssBackupConnections()
            .getWithResponse(resourceGroupName, connectorName, backupName, Context.NONE).getValue();
        return this;
    }

    public AcssBackupConnection refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getAcssBackupConnections()
            .getWithResponse(resourceGroupName, connectorName, backupName, context).getValue();
        return this;
    }
