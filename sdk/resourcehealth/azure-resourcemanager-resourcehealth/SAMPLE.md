...
public final class AvailabilityStatusesGetByResourceSamples {
    /*
     * x-ms-original-file:
     * specification/resourcehealth/resource-manager/Microsoft.ResourceHealth/stable/2024-02-01/examples/
    ...
    public static void
        ...
        manager.availabilityStatuses().getByResourceWithResponse("resourceUri", null, "recommendedactions",
...
public final class AvailabilityStatusesListBySubscriptionIdSamples {
    ...
    public static void
        ...
        manager.availabilityStatuses().listBySubscriptionId(null, "recommendedactions",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class ChildAvailabilityStatusesGetByResourceSamples {
    ...
    public static void
        ...
        manager.childAvailabilityStatuses().getByResourceWithResponse(
...
public final class ChildAvailabilityStatusesListSamples {
    ...
    public static void
        ...
        manager.childAvailabilityStatuses().list(
            "subscriptions/227b734f-e14f-4de6-b7fc-3190c21e69f6/resourceGroups/JUHACKETRHCTEST/providers/Microsoft.Compute/virtualMachineScaleSets/rhctest/virtualMachines/4",
...
public final class EventOperationFetchDetailsByTenantIdAndTrackingIdSamples {
    ...
    public static void
        ...
        manager.eventOperations().fetchDetailsByTenantIdAndTrackingIdWithResponse("eventTrackingId",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class EventOperationGetBySubscriptionIdAndTrackingIdSamples {
    ...
    public static void securityAdvisoriesEventBySubscriptionIdAndTrackingId(
        com.azure.resourcemanager.resourcehealth.ResourceHealthManager manager) {
        manager.eventOperations().getBySubscriptionIdAndTrackingIdWithResponse("eventTrackingId",
            "properties/status eq 'Active'", "7/10/2022", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class EventOperationGetByTenantIdAndTrackingIdSamples {
    ...
    public static void
        ...
        manager.eventOperations().getByTenantIdAndTrackingIdWithResponse("eventTrackingId",
            "properties/status eq 'Active'", "7/10/2022", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class EventsOperationListSamples {
    ...
    public static void
        ...
        manager.eventsOperations().list("service eq 'Virtual Machines' or region eq 'West US'", "7/24/2020",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class EventsOperationListBySingleResourceSamples {
    ...
    public static void
        ...
        manager.eventsOperations().listBySingleResource(
...
public final class EventsOperationListByTenantIdSamples {
    ...
    public static void listEventsByTenantId(com.azure.resourcemanager.resourcehealth.ResourceHealthManager manager) {
        manager.eventsOperations().listByTenantId("service eq 'Virtual Machines' or region eq 'West US'", "7/24/2020",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class ImpactedResourcesGetByTenantIdSamples {
     ...
     */
    public static void impactedResourcesGet(com.azure.resourcemanager.resourcehealth.ResourceHealthManager manager) {
        manager.impactedResources().getByTenantIdWithResponse("BC_1-FXZ", "abc-123-ghj-456",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class ImpactedResourcesListBySubscriptionIdAndEventIdSamples {
    ...
    public static void
        ...
        manager.impactedResources().listBySubscriptionIdAndEventId("BC_1-FXZ", "targetRegion eq 'westus'",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class ImpactedResourcesListByTenantIdAndEventIdSamples {
     ...
     */
    public static void listEventsByTenantId(com.azure.resourcemanager.resourcehealth.ResourceHealthManager manager) {
        manager.impactedResources().listByTenantIdAndEventId("BC_1-FXZ", "targetRegion eq 'westus'",
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class MetadataListSamples {
    /*
     * x-ms-original-file:
     * specification/resourcehealth/resource-manager/Microsoft.ResourceHealth/stable/2024-02-01/examples/Metadata_List.
     * json
     */
    /**
     * Sample code: GetMetadata.
...
public final class OperationsListSamples {
    /*
     * x-ms-original-file:
     * specification/resourcehealth/resource-manager/Microsoft.ResourceHealth/stable/2024-02-01/examples/Operations_List
     * .json
     */
    /**
...
public final class SecurityAdvisoryImpactedResourcesListByTenantIdAndEventIdSamples {
    ...
    public static void listSecurityAdvisoryImpactedResourcesByTenantId(
        com.azure.resourcemanager.resourcehealth.ResourceHealthManager manager) {
        manager.securityAdvisoryImpactedResources().listByTenantIdAndEventId("BC_1-FXZ", null,
            com.azure.core.util.Context.NONE);
    }
}
```
