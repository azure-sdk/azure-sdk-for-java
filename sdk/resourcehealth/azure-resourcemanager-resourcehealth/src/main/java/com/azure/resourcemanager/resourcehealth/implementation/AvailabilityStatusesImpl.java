...
public final class AvailabilityStatusesImpl implements AvailabilityStatuses {
    ...
    public PagedIterable<AvailabilityStatusAutoGenerated> listBySubscriptionId() {
        PagedIterable<AvailabilityStatusAutoGeneratedInner> inner = this.serviceClient().listBySubscriptionId();
        return Utils.mapPage(inner, inner1 -> new AvailabilityStatusAutoGeneratedImpl(inner1, this.manager()));
    }

    public PagedIterable<AvailabilityStatusAutoGenerated> listBySubscriptionId(
        String filter, String expand, Context context) {
        PagedIterable<AvailabilityStatusAutoGeneratedInner> inner =
            this.serviceClient().listBySubscriptionId(filter, expand, context);
        return Utils.mapPage(inner, inner1 -> new AvailabilityStatusAutoGeneratedImpl(inner1, this.manager()));
    }

    public PagedIterable<AvailabilityStatusAutoGenerated> listByResourceGroup(String resourceGroupName) {
        PagedIterable<AvailabilityStatusAutoGeneratedInner> inner =
            this.serviceClient().listByResourceGroup(resourceGroupName);
        return Utils.mapPage(inner, inner1 -> new AvailabilityStatusAutoGeneratedImpl(inner1, this.manager()));
    }

    public PagedIterable<AvailabilityStatusAutoGenerated> listByResourceGroup(
        String resourceGroupName, String filter, String expand, Context context) {
        PagedIterable<AvailabilityStatusAutoGeneratedInner> inner =
            this.serviceClient().listByResourceGroup(resourceGroupName, filter, expand, context);
        return Utils.mapPage(inner, inner1 -> new AvailabilityStatusAutoGeneratedImpl(inner1, this.manager()));
    ...
    public Response<AvailabilityStatusAutoGenerated> getByResourceWithResponse(
        String resourceUri, String filter, String expand, Context context) {
        Response<AvailabilityStatusAutoGeneratedInner> inner =
            this.serviceClient().getByResourceWithResponse(resourceUri, filter, expand, context);
        if (inner != null) {
            return new SimpleResponse<>(
                inner.getRequest(),
                inner.getStatusCode(),
                inner.getHeaders(),
                new AvailabilityStatusAutoGeneratedImpl(inner.getValue(), this.manager()));
        } else {
            return null;
        }
    }

    public AvailabilityStatusAutoGenerated getByResource(String resourceUri) {
        AvailabilityStatusAutoGeneratedInner inner = this.serviceClient().getByResource(resourceUri);
        if (inner != null) {
            return new AvailabilityStatusAutoGeneratedImpl(inner, this.manager());
        } else {
            return null;
        }
    }

    public PagedIterable<AvailabilityStatusAutoGenerated> list(String resourceUri) {
        PagedIterable<AvailabilityStatusAutoGeneratedInner> inner = this.serviceClient().list(resourceUri);
        return Utils.mapPage(inner, inner1 -> new AvailabilityStatusAutoGeneratedImpl(inner1, this.manager()));
    }

    public PagedIterable<AvailabilityStatusAutoGenerated> list(
        String resourceUri, String filter, String expand, Context context) {
        PagedIterable<AvailabilityStatusAutoGeneratedInner> inner =
            this.serviceClient().list(resourceUri, filter, expand, context);
        return Utils.mapPage(inner, inner1 -> new AvailabilityStatusAutoGeneratedImpl(inner1, this.manager()));
    }
