...
public final class EventAutoGeneratedImpl implements EventAutoGenerated {
    private EventAutoGeneratedInner innerObject;

    private final com.azure.resourcemanager.resourcehealth.ResourceHealthManager serviceManager;

    EventAutoGeneratedImpl(
        EventAutoGeneratedInner innerObject,
    ...
    public List<ImpactAutoGenerated> impact() {
        List<ImpactAutoGenerated> inner = this.innerModel().impact();
        if (inner != null) {
            return Collections.unmodifiableList(inner);
        } else {
            return Collections.emptyList();
    ...
    public EventAutoGeneratedInner innerModel() {
