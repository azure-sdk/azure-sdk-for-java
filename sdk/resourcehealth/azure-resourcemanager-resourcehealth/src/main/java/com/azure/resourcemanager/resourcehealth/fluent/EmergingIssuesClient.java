...
public interface EmergingIssuesClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<EmergingIssuesGetResultAutoGeneratedInner> getWithResponse(Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    EmergingIssuesGetResultAutoGeneratedInner get();
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<EmergingIssuesGetResultAutoGeneratedInner> list();
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<EmergingIssuesGetResultAutoGeneratedInner> list(Context context);
}
