...
@Fluent
public final class ImpactedServiceRegionAutoGenerated {
    /*
    ...
    /** Creates an instance of ImpactedServiceRegionAutoGenerated class. */
    public ImpactedServiceRegionAutoGenerated() {
    }
     ...
     * @return the ImpactedServiceRegionAutoGenerated object itself.
     */
    public ImpactedServiceRegionAutoGenerated withImpactedRegion(String impactedRegion) {
     ...
     * @return the ImpactedServiceRegionAutoGenerated object itself.
     */
    public ImpactedServiceRegionAutoGenerated withStatus(EventStatusValues status) {
        this.status = status;
        return this;
    }
     ...
     * @return the ImpactedServiceRegionAutoGenerated object itself.
     */
    public ImpactedServiceRegionAutoGenerated withImpactedSubscriptions(List<String> impactedSubscriptions) {
     ...
     * @return the ImpactedServiceRegionAutoGenerated object itself.
     */
    public ImpactedServiceRegionAutoGenerated withLastUpdateTime(OffsetDateTime lastUpdateTime) {
     ...
     * @return the ImpactedServiceRegionAutoGenerated object itself.
     */
    public ImpactedServiceRegionAutoGenerated withUpdates(List<Update> updates) {
