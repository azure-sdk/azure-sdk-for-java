...
import com.azure.resourcemanager.resourcehealth.models.AvailabilityStatusListResultAutoGenerated;
...
public final class AvailabilityStatusesClientImpl implements AvailabilityStatusesClient {
    ...
    public interface AvailabilityStatusesService {
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<AvailabilityStatusListResultAutoGenerated>> listBySubscriptionId(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @QueryParam("$filter") String filter,
            @PathParam("subscriptionId") String subscriptionId,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<AvailabilityStatusListResultAutoGenerated>> listByResourceGroup(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @QueryParam("api-version") String apiVersion,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<AvailabilityStatusAutoGeneratedInner>> getByResource(
            @HostParam("$host") String endpoint,
            @PathParam(value = "resourceUri", encoded = true) String resourceUri,
            @QueryParam("api-version") String apiVersion,
            @QueryParam("$filter") String filter,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<AvailabilityStatusListResultAutoGenerated>> list(
            @HostParam("$host") String endpoint,
            @PathParam(value = "resourceUri", encoded = true) String resourceUri,
            @QueryParam("api-version") String apiVersion,
            @QueryParam("$filter") String filter,
    ...
    private Mono<PagedResponse<AvailabilityStatusInner>> listBySubscriptionIdSinglePageAsync(
        ...
        return service
            .listBySubscriptionId(
                this.client.getEndpoint(), apiVersion, filter, this.client.getSubscriptionId(), expand, accept, context)
            .map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<AvailabilityStatusAutoGeneratedInner>> listBySubscriptionIdSinglePageAsync(
        String filter, String expand) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                ...
                context ->
                    service
                        .listBySubscriptionId(
                            ...
                            accept,
                            context))
            .<PagedResponse<AvailabilityStatusAutoGeneratedInner>>map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(),
                        res.getStatusCode(),
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<AvailabilityStatusAutoGeneratedInner> listBySubscriptionIdAsync(String filter, String expand) {
        return new PagedFlux<>(
            () -> listBySubscriptionIdSinglePageAsync(filter, expand),
            nextLink -> listBySubscriptionIdNextSinglePageAsync(nextLink));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<AvailabilityStatusAutoGeneratedInner> listBySubscriptionIdAsync() {
        final String filter = null;
        final String expand = null;
        return new PagedFlux<>(
            () -> listBySubscriptionIdSinglePageAsync(filter, expand),
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<AvailabilityStatusAutoGeneratedInner> listBySubscriptionId() {
        final String filter = null;
        final String expand = null;
        return new PagedIterable<>(listBySubscriptionIdAsync(filter, expand));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<AvailabilityStatusAutoGeneratedInner>> listByResourceGroupSinglePageAsync(
        String resourceGroupName, String filter, String expand) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<AvailabilityStatusAutoGeneratedInner> listByResourceGroupAsync(
        String resourceGroupName, String filter, String expand) {
        return new PagedFlux<>(
            () -> listByResourceGroupSinglePageAsync(resourceGroupName, filter, expand),
            nextLink -> listByResourceGroupNextSinglePageAsync(nextLink));
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<AvailabilityStatusAutoGeneratedInner> listByResourceGroupAsync(String resourceGroupName) {
        final String filter = null;
        final String expand = null;
        return new PagedFlux<>(
            () -> listByResourceGroupSinglePageAsync(resourceGroupName, filter, expand),
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<AvailabilityStatusAutoGeneratedInner> listByResourceGroup(String resourceGroupName) {
        final String filter = null;
        final String expand = null;
        return new PagedIterable<>(listByResourceGroupAsync(resourceGroupName, filter, expand));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<AvailabilityStatusAutoGeneratedInner> listByResourceGroup(
        String resourceGroupName, String filter, String expand, Context context) {
        return new PagedIterable<>(listByResourceGroupAsync(resourceGroupName, filter, expand, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<AvailabilityStatusAutoGeneratedInner>> getByResourceWithResponseAsync(
        String resourceUri, String filter, String expand) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<AvailabilityStatusAutoGeneratedInner> getByResourceAsync(String resourceUri) {
        final String filter = null;
        final String expand = null;
        return getByResourceWithResponseAsync(resourceUri, filter, expand)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<AvailabilityStatusAutoGeneratedInner> getByResourceWithResponse(
        String resourceUri, String filter, String expand, Context context) {
        return getByResourceWithResponseAsync(resourceUri, filter, expand, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public AvailabilityStatusAutoGeneratedInner getByResource(String resourceUri) {
        final String filter = null;
        final String expand = null;
        return getByResourceWithResponse(resourceUri, filter, expand, Context.NONE).getValue();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<AvailabilityStatusAutoGeneratedInner>> listSinglePageAsync(
        String resourceUri, String filter, String expand) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<AvailabilityStatusAutoGeneratedInner> listAsync(
        String resourceUri, String filter, String expand) {
        return new PagedFlux<>(
            () -> listSinglePageAsync(resourceUri, filter, expand), nextLink -> listNextSinglePageAsync(nextLink));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<AvailabilityStatusAutoGeneratedInner> listAsync(String resourceUri) {
        final String filter = null;
        final String expand = null;
        return new PagedFlux<>(
            () -> listSinglePageAsync(resourceUri, filter, expand), nextLink -> listNextSinglePageAsync(nextLink));
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<AvailabilityStatusAutoGeneratedInner> list(String resourceUri) {
        final String filter = null;
        final String expand = null;
        return new PagedIterable<>(listAsync(resourceUri, filter, expand));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<AvailabilityStatusAutoGeneratedInner> list(
        String resourceUri, String filter, String expand, Context context) {
        return new PagedIterable<>(listAsync(resourceUri, filter, expand, context));
    }
