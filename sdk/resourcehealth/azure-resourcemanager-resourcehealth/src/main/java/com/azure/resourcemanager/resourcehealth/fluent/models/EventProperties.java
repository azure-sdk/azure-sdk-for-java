...
public final class EventProperties implements JsonSerializable<EventProperties> {
    ...
    /*
     * If true the event may contains Sensitive data. Use the /fetchEventDetails endpoint to fetch sensitive data
     */
    private Boolean eventSensitive;
    ...
    /**
     * Get the eventSensitive property: If true the event may contains Sensitive data. Use the /fetchEventDetails
     * endpoint to fetch sensitive data.
     * 
     * @return the eventSensitive value.
     */
    public Boolean eventSensitive() {
        return this.eventSensitive;
    }

    /**
     * Set the eventSensitive property: If true the event may contains Sensitive data. Use the /fetchEventDetails
     * endpoint to fetch sensitive data.
     * 
     * @param eventSensitive the eventSensitive value to set.
     * @return the EventProperties object itself.
     */
    public EventProperties withEventSensitive(Boolean eventSensitive) {
        this.eventSensitive = eventSensitive;
        return this;
    }
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeBooleanField("eventSensitive", this.eventSensitive);
    ...
    public static EventProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                } else if ("eventSensitive".equals(fieldName)) {
                    deserializedEventProperties.eventSensitive = reader.getNullable(JsonReader::getBoolean);
