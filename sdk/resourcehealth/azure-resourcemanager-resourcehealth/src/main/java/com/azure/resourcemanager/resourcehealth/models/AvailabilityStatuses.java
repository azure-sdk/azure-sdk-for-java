...
public interface AvailabilityStatuses {
     ...
     * @return the List availabilityStatus operation response as paginated response with {@link PagedIterable}.
     */
    PagedIterable<AvailabilityStatusAutoGenerated> listBySubscriptionId();
     ...
     * @return the List availabilityStatus operation response as paginated response with {@link PagedIterable}.
     */
    PagedIterable<AvailabilityStatusAutoGenerated> listBySubscriptionId(String filter, String expand, Context context);
     ...
     * @return the List availabilityStatus operation response as paginated response with {@link PagedIterable}.
     */
    PagedIterable<AvailabilityStatusAutoGenerated> listByResourceGroup(String resourceGroupName);
     ...
     * @return the List availabilityStatus operation response as paginated response with {@link PagedIterable}.
     */
    PagedIterable<AvailabilityStatusAutoGenerated> listByResourceGroup(
        String resourceGroupName, String filter, String expand, Context context);
     ...
     * @return current availability status for a single resource along with {@link Response}.
     */
    Response<AvailabilityStatusAutoGenerated> getByResourceWithResponse(
        String resourceUri, String filter, String expand, Context context);
     ...
     * @return current availability status for a single resource.
     */
    AvailabilityStatusAutoGenerated getByResource(String resourceUri);
     ...
     * @return the List availabilityStatus operation response as paginated response with {@link PagedIterable}.
     */
    PagedIterable<AvailabilityStatusAutoGenerated> list(String resourceUri);
     ...
     * @return the List availabilityStatus operation response as paginated response with {@link PagedIterable}.
     */
    PagedIterable<AvailabilityStatusAutoGenerated> list(
        String resourceUri, String filter, String expand, Context context);
}
