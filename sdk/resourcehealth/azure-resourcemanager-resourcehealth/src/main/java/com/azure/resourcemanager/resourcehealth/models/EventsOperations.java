...
public interface EventsOperations {
     ...
     */
    PagedIterable<Event> listBySubscriptionId();
     ...
     * @return the List events operation response as paginated response with {@link PagedIterable}.
     */
    PagedIterable<Event> listBySubscriptionId(String filter, String queryStartTime, Context context);
     ...
     * @return the List events operation response as paginated response with {@link PagedIterable}.
     */
    PagedIterable<EventAutoGenerated> listBySubscriptionId();
     ...
     * @return the List events operation response as paginated response with {@link PagedIterable}.
     */
    PagedIterable<EventAutoGenerated> listBySingleResource(String resourceUri);
     ...
     * @return the List events operation response as paginated response with {@link PagedIterable}.
     */
    PagedIterable<EventAutoGenerated> listBySingleResource(
