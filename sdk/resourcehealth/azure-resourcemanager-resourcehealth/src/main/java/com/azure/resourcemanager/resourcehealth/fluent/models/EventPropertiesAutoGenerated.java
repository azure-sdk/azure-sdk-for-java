...
/** Properties of event. */
@Fluent
public final class EventPropertiesAutoGenerated {
    /*
     * Type of event.
     */
    ...
    private List<ImpactAutoGenerated> impact;

    /*
     * Recommended actions of event.
     */
    @JsonProperty(value = "recommendedActions")
    private EventPropertiesRecommendedActionsAutoGenerated recommendedActions;
    ...
    /** Creates an instance of EventPropertiesAutoGenerated class. */
    public EventPropertiesAutoGenerated() {
    }
     ...
     * @return the EventPropertiesAutoGenerated object itself.
     */
    public EventPropertiesAutoGenerated withEventType(EventTypeValues eventType) {
     ...
     * @return the EventPropertiesAutoGenerated object itself.
     */
    public EventPropertiesAutoGenerated withEventSource(EventSourceValues eventSource) {
     ...
     * @return the EventPropertiesAutoGenerated object itself.
     */
    public EventPropertiesAutoGenerated withStatus(EventStatusValues status) {
        this.status = status;
        return this;
    }
     ...
     * @return the EventPropertiesAutoGenerated object itself.
     */
    public EventPropertiesAutoGenerated withTitle(String title) {
        this.title = title;
        return this;
    }
     ...
     * @return the EventPropertiesAutoGenerated object itself.
     */
    public EventPropertiesAutoGenerated withSummary(String summary) {
     ...
     * @return the EventPropertiesAutoGenerated object itself.
     */
    public EventPropertiesAutoGenerated withHeaderProperty(String headerProperty) {
     ...
     * @return the EventPropertiesAutoGenerated object itself.
     */
    public EventPropertiesAutoGenerated withLevel(LevelValues level) {
        this.level = level;
        return this;
    }
     ...
     * @return the EventPropertiesAutoGenerated object itself.
     */
    public EventPropertiesAutoGenerated withEventLevel(EventLevelValues eventLevel) {
     ...
     * @return the EventPropertiesAutoGenerated object itself.
     */
    public EventPropertiesAutoGenerated withReason(String reason) {
        this.reason = reason;
        return this;
    }
     ...
     * @return the EventPropertiesAutoGenerated object itself.
     */
    public EventPropertiesAutoGenerated withArticle(EventPropertiesArticle article) {
     ...
     * @return the EventPropertiesAutoGenerated object itself.
     */
    public EventPropertiesAutoGenerated withLinks(List<Link> links) {
        this.links = links;
        return this;
    }
     ...
     * @return the EventPropertiesAutoGenerated object itself.
     */
    public EventPropertiesAutoGenerated withImpactStartTime(OffsetDateTime impactStartTime) {
     ...
     * @return the EventPropertiesAutoGenerated object itself.
     */
    public EventPropertiesAutoGenerated withImpactMitigationTime(OffsetDateTime impactMitigationTime) {
     ...
     * @return the EventPropertiesAutoGenerated object itself.
     */
    public EventPropertiesAutoGenerated withImpact(List<ImpactAutoGenerated> impact) {
        this.impact = impact;
        return this;
    }
     ...
     * @return the EventPropertiesAutoGenerated object itself.
     */
    public EventPropertiesAutoGenerated withRecommendedActions(
     ...
     * @return the EventPropertiesAutoGenerated object itself.
     */
    public EventPropertiesAutoGenerated withFaqs(List<Faq> faqs) {
        this.faqs = faqs;
        return this;
    }
     ...
     * @return the EventPropertiesAutoGenerated object itself.
     */
    public EventPropertiesAutoGenerated withIsHir(Boolean isHir) {
        this.isHir = isHir;
        return this;
    }
     ...
     * @return the EventPropertiesAutoGenerated object itself.
     */
    public EventPropertiesAutoGenerated withEnableMicrosoftSupport(Boolean enableMicrosoftSupport) {
     ...
     * @return the EventPropertiesAutoGenerated object itself.
     */
    public EventPropertiesAutoGenerated withDescription(String description) {
     ...
     * @return the EventPropertiesAutoGenerated object itself.
     */
    public EventPropertiesAutoGenerated withPlatformInitiated(Boolean platformInitiated) {
     ...
     * @return the EventPropertiesAutoGenerated object itself.
     */
    public EventPropertiesAutoGenerated withEnableChatWithUs(Boolean enableChatWithUs) {
     ...
     * @return the EventPropertiesAutoGenerated object itself.
     */
    public EventPropertiesAutoGenerated withPriority(Integer priority) {
     ...
     * @return the EventPropertiesAutoGenerated object itself.
     */
    public EventPropertiesAutoGenerated withLastUpdateTime(OffsetDateTime lastUpdateTime) {
     ...
     * @return the EventPropertiesAutoGenerated object itself.
     */
    public EventPropertiesAutoGenerated withHirStage(String hirStage) {
