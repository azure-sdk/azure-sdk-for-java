...
public interface EventsOperationsClient {
    ...
    PagedIterable<EventInner> listBySubscriptionId();
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<EventInner> listBySubscriptionId(String filter, String queryStartTime, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<EventAutoGeneratedInner> listBySubscriptionId();
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<EventAutoGeneratedInner> listBySingleResource(String resourceUri);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<EventAutoGeneratedInner> listBySingleResource(
