...
import com.azure.resourcemanager.resourcehealth.models.EventsAutoGenerated;
...
public final class EventsOperationsClientImpl implements EventsOperationsClient {
    ...
    public interface EventsOperationsService {
        ...
        Mono<Response<Events>> listBySubscriptionId(
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<EventsAutoGenerated>> listBySubscriptionId(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @QueryParam("$filter") String filter,
            @QueryParam("queryStartTime") String queryStartTime,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<EventsAutoGenerated>> listBySingleResource(
            @HostParam("$host") String endpoint,
            @PathParam(value = "resourceUri", encoded = true) String resourceUri,
            @QueryParam("api-version") String apiVersion,
            @QueryParam("$filter") String filter,
    ...
    private Mono<PagedResponse<EventInner>> listBySubscriptionIdSinglePageAsync(String filter, String queryStartTime) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<EventInner>> listBySubscriptionIdSinglePageAsync(
    ...
    private PagedFlux<EventInner> listBySubscriptionIdAsync(String filter, String queryStartTime) {
        return new PagedFlux<>(
            () -> listBySubscriptionIdSinglePageAsync(filter, queryStartTime),
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<EventInner> listBySubscriptionIdAsync() {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<EventInner> listBySubscriptionIdAsync(String filter, String queryStartTime, Context context) {
        return new PagedFlux<>(
            () -> listBySubscriptionIdSinglePageAsync(filter, queryStartTime, context),
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<EventInner> listBySubscriptionId() {
        final String filter = null;
        final String queryStartTime = null;
        return new PagedIterable<>(listBySubscriptionIdAsync(filter, queryStartTime));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<EventInner> listBySubscriptionId(String filter, String queryStartTime, Context context) {
        return new PagedIterable<>(listBySubscriptionIdAsync(filter, queryStartTime, context));
    }
    ...
    private Mono<PagedResponse<EventInner>> listByTenantIdSinglePageAsync(String filter, String queryStartTime) {
        ...
        return FluxUtil
            .withContext(
                context ->
                    service
                        .listByTenantId(this.client.getEndpoint(), apiVersion, filter, queryStartTime, accept, context))
            .<PagedResponse<EventInner>>map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(),
                ...
                context ->
                    service
                        .listBySingleResource(
                            this.client.getEndpoint(), resourceUri, apiVersion, filter, accept, context))
            .<PagedResponse<EventInner>>map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(),
    ...
    private Mono<PagedResponse<EventInner>> listBySingleResourceSinglePageAsync(
        ...
        context = this.client.mergeContext(context);
        return service
            .listBySingleResource(this.client.getEndpoint(), resourceUri, apiVersion, filter, accept, context)
            .map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<EventAutoGeneratedInner>> listBySubscriptionIdSinglePageAsync(
        String filter, String queryStartTime, String view) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
                ...
                context ->
                    service
                        .listBySubscriptionId(
                            ...
                            accept,
                            context))
            .<PagedResponse<EventAutoGeneratedInner>>map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(),
                        res.getStatusCode(),
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<EventAutoGeneratedInner> listBySubscriptionIdAsync(
        String filter, String queryStartTime, String view) {
        return new PagedFlux<>(
            () -> listBySubscriptionIdSinglePageAsync(filter, queryStartTime, view),
            nextLink -> listBySubscriptionIdNextSinglePageAsync(nextLink));
    }
    ...
    private PagedFlux<EventAutoGeneratedInner> listBySubscriptionIdAsync(
        String filter, String queryStartTime, String view, Context context) {
        return new PagedFlux<>(
            () -> listBySubscriptionIdSinglePageAsync(filter, queryStartTime, view, context),
            nextLink -> listBySubscriptionIdNextSinglePageAsync(nextLink, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<EventAutoGeneratedInner> listBySubscriptionId() {
        final String filter = null;
        final String queryStartTime = null;
        final String view = null;
        return new PagedIterable<>(listBySubscriptionIdAsync(filter, queryStartTime, view));
    }
    ...
    public PagedIterable<EventAutoGeneratedInner> listBySubscriptionId(
        String filter, String queryStartTime, String view, Context context) {
        return new PagedIterable<>(listBySubscriptionIdAsync(filter, queryStartTime, view, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<EventAutoGeneratedInner>> listBySingleResourceSinglePageAsync(
        ...
        return FluxUtil
            .withContext(
                context ->
                    service
                        .listBySingleResource(
                            this.client.getEndpoint(), resourceUri, apiVersion, filter, view, accept, context))
            .<PagedResponse<EventAutoGeneratedInner>>map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(),
    ...
    private Mono<PagedResponse<EventAutoGeneratedInner>> listBySingleResourceSinglePageAsync(
        ...
        context = this.client.mergeContext(context);
        return service
            .listBySingleResource(this.client.getEndpoint(), resourceUri, apiVersion, filter, view, accept, context)
            .map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(),
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<EventAutoGeneratedInner> listBySingleResourceAsync(
        String resourceUri, String filter, String view) {
        return new PagedFlux<>(
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<EventAutoGeneratedInner> listBySingleResourceAsync(String resourceUri) {
        final String filter = null;
        final String view = null;
        return new PagedFlux<>(
            () -> listBySingleResourceSinglePageAsync(resourceUri, filter, view),
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<EventAutoGeneratedInner> listBySingleResource(String resourceUri) {
        final String filter = null;
        final String view = null;
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<EventAutoGeneratedInner> listBySingleResource(
        String resourceUri, String filter, String view, Context context) {
