...
public final class EventInner extends ProxyResource {
    ...
    public Boolean eventSensitive() {
        return this.innerProperties() == null ? null : this.innerProperties().eventSensitive();
    }
     ...
     * @return the EventInner object itself.
     */
    public EventInner withEventSensitive(Boolean eventSensitive) {
        if (this.innerProperties() == null) {
            this.innerProperties = new EventProperties();
        }
        this.innerProperties().withEventSensitive(eventSensitive);
        return this;
    }
