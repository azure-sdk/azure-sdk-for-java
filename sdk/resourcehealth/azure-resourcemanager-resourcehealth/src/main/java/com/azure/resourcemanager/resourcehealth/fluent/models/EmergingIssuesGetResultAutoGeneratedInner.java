...
@Fluent
public final class EmergingIssuesGetResultAutoGeneratedInner extends ProxyResource {
    /*
     * The emerging issue entity properties.
     */
    @JsonProperty(value = "properties")
    private EmergingIssueAutoGenerated innerProperties;

    /** Creates an instance of EmergingIssuesGetResultAutoGeneratedInner class. */
    public EmergingIssuesGetResultAutoGeneratedInner() {
    }
     ...
     * @return the EmergingIssuesGetResultAutoGeneratedInner object itself.
     */
    public EmergingIssuesGetResultAutoGeneratedInner withRefreshTimestamp(OffsetDateTime refreshTimestamp) {
        if (this.innerProperties() == null) {
            this.innerProperties = new EmergingIssueAutoGenerated();
        }
     ...
     * @return the EmergingIssuesGetResultAutoGeneratedInner object itself.
     */
    public EmergingIssuesGetResultAutoGeneratedInner withStatusBanners(List<StatusBanner> statusBanners) {
        if (this.innerProperties() == null) {
            this.innerProperties = new EmergingIssueAutoGenerated();
        }
     ...
     * @return the EmergingIssuesGetResultAutoGeneratedInner object itself.
     */
    public EmergingIssuesGetResultAutoGeneratedInner withStatusActiveEvents(
