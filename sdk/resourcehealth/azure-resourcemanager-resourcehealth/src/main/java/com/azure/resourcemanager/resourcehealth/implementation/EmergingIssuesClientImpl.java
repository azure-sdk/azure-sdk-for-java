...
import com.azure.resourcemanager.resourcehealth.models.EmergingIssueListResultAutoGenerated;
...
public final class EmergingIssuesClientImpl implements EmergingIssuesClient {
    ...
    public interface EmergingIssuesService {
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<EmergingIssuesGetResultAutoGeneratedInner>> get(
            @HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<EmergingIssueListResultAutoGenerated>> list(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept,
            Context context);
    ...
    private Mono<Response<EmergingIssuesGetResultInner>> getWithResponseAsync(IssueNameParameter issueName) {
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.get(this.client.getEndpoint(), issueName, apiVersion, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<EmergingIssuesGetResultInner>> getWithResponseAsync(
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.get(this.client.getEndpoint(), issueName, apiVersion, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<EmergingIssuesGetResultAutoGeneratedInner>> getWithResponseAsync() {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<EmergingIssuesGetResultAutoGeneratedInner>> getWithResponseAsync(Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<EmergingIssuesGetResultAutoGeneratedInner> getAsync() {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<EmergingIssuesGetResultAutoGeneratedInner> getWithResponse(Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public EmergingIssuesGetResultAutoGeneratedInner get() {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<EmergingIssuesGetResultAutoGeneratedInner>> listSinglePageAsync() {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
        ...
        return FluxUtil
            .withContext(context -> service.list(this.client.getEndpoint(), apiVersion, accept, context))
            .<PagedResponse<EmergingIssuesGetResultAutoGeneratedInner>>map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(),
                        res.getStatusCode(),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<EmergingIssuesGetResultAutoGeneratedInner>> listSinglePageAsync(Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<EmergingIssuesGetResultAutoGeneratedInner> listAsync() {
        return new PagedFlux<>(() -> listSinglePageAsync(), nextLink -> listNextSinglePageAsync(nextLink));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<EmergingIssuesGetResultAutoGeneratedInner> listAsync(Context context) {
        return new PagedFlux<>(
            () -> listSinglePageAsync(context), nextLink -> listNextSinglePageAsync(nextLink, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<EmergingIssuesGetResultAutoGeneratedInner> list() {
        return new PagedIterable<>(listAsync());
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<EmergingIssuesGetResultAutoGeneratedInner> list(Context context) {
        return new PagedIterable<>(listAsync(context));
    }
