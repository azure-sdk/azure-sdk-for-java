...
/**
 * <p>
 * <a href="https://learn.microsoft.com/azure/event-hubs/schema-registry-overview">Azure Schema Registry</a> is a
 ...
 *
 * <p>
 * In addition, Azure Schema Registry can integrate with other Azure services, such as Azure Event Hubs and
 ...
 * accelerate the development of data-driven applications.
 * </p>
 *
 * <p>
 * The Azure Schema Registry client library allows Java developers to interact with Azure Schema Registry. It
 * provides a set of APIs that enable Java developers to perform operations such as registering, updating, and
 * retrieving schemas from the Azure Schema Registry.
 * </p>
 *
 * <h2>Key Concepts</h2>
 *
 ...
 *
 * <p>
 * Service clients are the point of interaction for developers to use Azure Schema Registry.
 ...
 *
 * <p>
 * <strong>Sample: Construct a service client</strong>
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The samples below use the synchronous client, {@link com.azure.data.schemaregistry.SchemaRegistryClient}.
 * More samples can be found in the class's Javadoc. In addition, samples using the asynchronous
 * {@link com.azure.data.schemaregistry.SchemaRegistryAsyncClient} can be found in the class's JavaDocs.
 * </p>
 *
 * <p>
 * <strong>Sample: Register a schema</strong>
 * </p>
 *
 * <p>
 * The following code sample demonstrates registering an Avro schema. The
 * {@link com.azure.data.schemaregistry.models.SchemaProperties} returned contains the schema's id. This id uniquely
 * identifies the schema and can be used to quickly associate payloads with that schema.
 * </p>
 *
 ...
 *
 * <p>
 * <strong>Sample: Getting the schema using a schema id</strong>
 * </p>
 *
 * <p>
 * The following code sample demonstrates how to fetch a schema using its schema id. The schema id can be found in
