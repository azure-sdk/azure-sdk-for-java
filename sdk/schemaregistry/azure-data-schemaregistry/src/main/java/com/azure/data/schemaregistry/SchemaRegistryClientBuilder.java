...
public final class SchemaRegistryClientBuilder implements HttpTrait<SchemaRegistryClientBuilder>,
    ...
    private AzureSchemaRegistryImpl getAzureSchemaRegistryImplService() {
        ...
        if (buildPipeline == null) {
            ...
            buildPipeline = new HttpPipelineBuilder().policies(policies.toArray(new HttpPipelinePolicy[0]))
                .httpClient(httpClient).clientOptions(clientOptions).build();
        }
     ...
     * @throws NullPointerException if {@link #fullyQualifiedNamespace(String) endpoint} and
     * {@link #credential(TokenCredential)
