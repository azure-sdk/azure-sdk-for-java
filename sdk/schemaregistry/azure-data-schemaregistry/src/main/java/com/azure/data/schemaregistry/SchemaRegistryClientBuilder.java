...
/**
 * A builder for creating a new instance of the SchemaRegistryClient type.
 */
@ServiceClientBuilder(serviceClients = { SchemaRegistryClient.class, SchemaRegistryAsyncClient.class })
public final class SchemaRegistryClientBuilder implements HttpTrait<SchemaRegistryClientBuilder>,
    ConfigurationTrait<SchemaRegistryClientBuilder>, TokenCredentialTrait<SchemaRegistryClientBuilder> {
    @Generated
    ...
    /**
     * Create an instance of the SchemaRegistryClientBuilder.
     */
    @Generated
    ...
    @Generated
    @Override
    public SchemaRegistryClientBuilder pipeline(HttpPipeline pipeline) {
    ...
    @Generated
    @Override
    public SchemaRegistryClientBuilder httpLogOptions(HttpLogOptions httpLogOptions) {
    ...
    @Generated
    @Override
    public SchemaRegistryClientBuilder credential(TokenCredential tokenCredential) {
     ...
     * 
     * @param fullyQualifiedNamespace the fullyQualifiedNamespace value.
     * @return the SchemaRegistryClientBuilder.
     */
    @Generated
     ...
     */
    @Generated
    public SchemaRegistryClientBuilder serviceVersion(SchemaRegistryServiceVersion serviceVersion) {
    ...
    /**
     * Builds an instance of SchemaRegistryAsyncClient class.
     * 
     * @return an instance of SchemaRegistryAsyncClient.
     */
    @Generated
    public SchemaRegistryAsyncClient buildAsyncClient() {
        return new SchemaRegistryAsyncClient(buildInnerClient());
    }

    /**
     * Builds an instance of SchemaRegistryClient class.
     * 
     * @return an instance of SchemaRegistryClient.
     */
    @Generated
    public SchemaRegistryClient buildClient() {
        return new SchemaRegistryClient(buildInnerClient());
    }

    private static final ClientLogger LOGGER = new ClientLogger(SchemaRegistryClientBuilder.class);
}
