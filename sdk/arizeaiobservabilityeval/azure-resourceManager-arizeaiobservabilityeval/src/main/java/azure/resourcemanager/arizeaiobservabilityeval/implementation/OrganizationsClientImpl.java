...
import azure.resourceManager.arizeaiobservabilityeval.implementation.models.OrganizationResourceListResult;
...
public final class OrganizationsClientImpl implements OrganizationsClient {
     ...
     */
    private final ArizeAIObservabilityEvalMgmtClientImpl client;
     ...
     */
    OrganizationsClientImpl(ArizeAIObservabilityEvalMgmtClientImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for ArizeAIObservabilityEvalMgmtClientOrganizations to be used by the
    ...
    public interface OrganizationsService {
        ...
        @Patch("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/ArizeAi.ObservabilityEval/organizations/{organizationname}")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        ...
        @Headers({ "Content-Type: application/json" })
        @Get("/subscriptions/{subscriptionId}/providers/ArizeAi.ObservabilityEval/organizations")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
