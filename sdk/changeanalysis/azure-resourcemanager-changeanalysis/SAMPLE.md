...
public final class ChangesListSamples {
    ...
    public static void
        ...
        manager.changes().list(OffsetDateTime.parse("2021-04-25T12:09:03.141Z"),
...
public final class ChangesListByResourceGroupSamples {
    ...
    public static void
        ...
        manager.changes().listByResourceGroup("MyResourceGroup", OffsetDateTime.parse("2021-04-25T12:09:03.141Z"),
            OffsetDateTime.parse("2021-04-26T12:09:03.141Z"), null, com.azure.core.util.Context.NONE);
    }
}
```
...
public final class ResourceChangesListSamples {
    ...
    public static void
        ...
        manager.resourceChanges().list(
            "subscriptions/4d962866-1e3f-47f2-bd18-450c08f914c1/resourceGroups/MyResourceGroup/providers/Microsoft.Web/sites/mysite",
            OffsetDateTime.parse("2021-04-25T12:09:03.141Z"), OffsetDateTime.parse("2021-04-26T12:09:03.141Z"), null,
