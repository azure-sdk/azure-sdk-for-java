 ...
 */
@Fluent
public final class MultivariateBatchDetectionSettings {
    /*
    ...
    /**
     * Creates an instance of MultivariateBatchDetectionSettings class.
     *
    ...
    @Generated
    @JsonCreator
    public MultivariateBatchDetectionSettings(
            @JsonProperty(value = "dataSource") String dataSource,
     ...
     * @return the MultivariateBatchDetectionSettings object itself.
     */
    @Generated
    public MultivariateBatchDetectionSettings setTopContributorCount(Integer topContributorCount) {
