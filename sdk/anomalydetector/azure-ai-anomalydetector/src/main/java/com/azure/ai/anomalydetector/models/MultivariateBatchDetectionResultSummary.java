...
public final class MultivariateBatchDetectionResultSummary {
     ...
     */
    @Generated
    @JsonProperty(value = "setupInfo")
    private MultivariateBatchDetectionSettings batchDetectionSettings;

    /**
     * Get the batchDetectionSettings property: Detection request for batch inference. This is an asynchronous inference
     * that will need another API to get detection results.
     *
     * @return the batchDetectionSettings value.
     */
    @Generated
    public MultivariateBatchDetectionSettings getBatchDetectionSettings() {
        return this.batchDetectionSettings;
    }
}
