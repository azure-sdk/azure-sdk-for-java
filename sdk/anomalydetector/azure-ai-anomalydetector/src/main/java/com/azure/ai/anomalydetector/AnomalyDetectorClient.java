...
public final class AnomalyDetectorClient {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<MultivariateModel> listMultivariateModels() {
        // Generated convenience method for listMultivariateModels
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public MultivariateModel getMultivariateModel(String modelId) {
        // Generated convenience method for getMultivariateModelWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getMultivariateModelWithResponse(modelId, requestOptions).getValue().toObject(MultivariateModel.class);
    }
    ...
    public Response<BinaryData> detectUnivariateLastAnomalyWithResponse(
            BinaryData options, RequestOptions requestOptions) {
        return this.client.detectUnivariateLastAnomalyWithResponse(options, requestOptions).block();
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public UnivariateLastDetectionResult detectUnivariateLastAnomaly(UnivariateDetectionOptions options) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public MultivariateModel trainMultivariateModel(MultivariateModelDetails modelInfo) {
        ...
        return trainMultivariateModelWithResponse(BinaryData.fromObject(modelInfo), requestOptions)
                .getValue()
                .toObject(MultivariateModel.class);
    }
