...
import com.azure.resourcemanager.mysqldiscovery.models.ErrorSummaryList;
...
public final class ErrorSummariesClientImpl implements ErrorSummariesClient {
     ...
     */
    ErrorSummariesClientImpl(AzureApiForMySqlDiscoveryImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for AzureApiForMySqlDiscoveryErrorSummaries to be used by the proxy
     ...
     * @return list of ErrorSummaries along with {@link PagedResponse} on successful completion of {@link Mono}.
     */
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return list of ErrorSummaries as paginated response with {@link PagedFlux}.
     */
