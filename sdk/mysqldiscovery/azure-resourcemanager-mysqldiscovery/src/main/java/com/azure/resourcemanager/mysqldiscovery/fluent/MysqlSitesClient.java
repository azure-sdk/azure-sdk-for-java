...
public interface MysqlSitesClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    MysqlSiteInner createOrUpdate(String resourceGroupName, String siteName, MysqlSiteInner resource);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    MysqlSiteInner createOrUpdate(String resourceGroupName, String siteName, MysqlSiteInner resource, Context context);
