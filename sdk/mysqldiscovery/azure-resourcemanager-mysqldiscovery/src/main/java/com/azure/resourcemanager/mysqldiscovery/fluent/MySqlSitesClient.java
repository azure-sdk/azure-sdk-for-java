...
public interface MySqlSitesClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    MySqlSiteInner update(String resourceGroupName, String siteName, MySqlSitesResourcePatch body);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    MySqlSiteInner update(String resourceGroupName, String siteName, MySqlSitesResourcePatch body, Context context);
