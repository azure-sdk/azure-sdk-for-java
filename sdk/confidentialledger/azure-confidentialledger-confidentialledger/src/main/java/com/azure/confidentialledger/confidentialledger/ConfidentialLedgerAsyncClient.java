...
public final class ConfidentialLedgerAsyncClient {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> getSubLedgerIdsWithResponse(RequestOptions requestOptions) {
        return this.serviceClient.getSubLedgerIdsWithResponseAsync(requestOptions);
    }
