...
public final class ConfidentialLedgersImpl {
    ...
    private interface ConfidentialLedgersService {
        ...
        @UnexpectedResponseExceptionType(
                ...
                code = {409})
        @UnexpectedResponseExceptionType(HttpResponseException.class)
        Mono<Response<BinaryData>> getSubLedgerIds(
                @HostParam("ledgerUri") String ledgerUri,
                @QueryParam("api-version") String apiVersion,
                RequestOptions requestOptions,
                Context context);
     ...
     * @throws ResourceNotFoundException thrown if the request is rejected by server on status code 404.
     * @throws ResourceModifiedException thrown if the request is rejected by server on status code 409.
     * @return a list of identifiers for sub-ledgers along with {@link Response} on successful completion of {@link
     *     Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> getSubLedgerIdsWithResponseAsync(RequestOptions requestOptions) {
        return FluxUtil.withContext(
                context ->
                        service.getSubLedgerIds(
                                this.client.getLedgerUri(),
                                this.client.getServiceVersion().getVersion(),
                                requestOptions,
                                context));
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> getSubLedgerIdsWithResponseAsync(RequestOptions requestOptions, Context context) {
        return service.getSubLedgerIds(
                this.client.getLedgerUri(), this.client.getServiceVersion().getVersion(), requestOptions, context);
    }
    ...
    public Response<BinaryData> getSubLedgerIdsWithResponse(RequestOptions requestOptions) {
        return getSubLedgerIdsWithResponseAsync(requestOptions).block();
    }
