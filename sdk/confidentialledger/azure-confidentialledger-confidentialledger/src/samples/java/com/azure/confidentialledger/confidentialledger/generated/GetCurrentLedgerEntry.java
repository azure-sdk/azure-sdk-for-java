...
public class GetCurrentLedgerEntry {
    public static void main(String[] args) {
        ...
        // BEGIN:com.azure.confidentialledger.confidentialledger.generated.confidentialledgergetcurrentledgerentry.getcurrentledgerentry
        RequestOptions requestOptions = new RequestOptions();
        Response<BinaryData> response = confidentialLedgerClient.getCurrentLedgerEntryWithResponse(requestOptions);
        // END:com.azure.confidentialledger.confidentialledger.generated.confidentialledgergetcurrentledgerentry.getcurrentledgerentry
    }
}
