...
public class PostLedgerEntry {
    public static void main(String[] args) {
        ...
        // BEGIN:com.azure.confidentialledger.confidentialledger.generated.confidentialledgerpostledgerentry.postledgerentry
        RequestOptions requestOptions = new RequestOptions();
        Response<BinaryData> response = confidentialLedgerClient.postLedgerEntryWithResponse(requestOptions);
        // END:com.azure.confidentialledger.confidentialledger.generated.confidentialledgerpostledgerentry.postledgerentry
    }
}
