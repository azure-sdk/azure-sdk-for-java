...
public class DeleteUser {
    public static void main(String[] args) {
        ...
        // BEGIN:com.azure.confidentialledger.confidentialledger.generated.confidentialledgerdeleteuser.deleteuser
        RequestOptions requestOptions = new RequestOptions();
        Response<Void> response = confidentialLedgerClient.deleteUserWithResponse("AAD object id", requestOptions);
        // END:com.azure.confidentialledger.confidentialledger.generated.confidentialledgerdeleteuser.deleteuser
    }
}
