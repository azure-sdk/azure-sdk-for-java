...
public final class ConfidentialLedgerClientBuilder implements HttpTrait<ConfidentialLedgerClientBuilder>, ConfigurationTrait<ConfidentialLedgerClientBuilder>, TokenCredentialTrait<ConfidentialLedgerClientBuilder> {
    @Generated
    ...
    @Generated
    private static final Map<String, String> PROPERTIES = CoreUtils.getProperties("azure-azure-confidentialledger-bugbash.properties");
    ...
    private ConfidentialLedgerClientImpl buildInnerClient() {
        ...
        ConfidentialLedgerServiceVersion localServiceVersion = (serviceVersion != null) ? serviceVersion : ConfidentialLedgerServiceVersion.getLatest();
        ConfidentialLedgerClientImpl client = new ConfidentialLedgerClientImpl(localPipeline, JacksonAdapter.createDefaultSerializerAdapter(), ledgerUri, localServiceVersion);
        return client;
    }
