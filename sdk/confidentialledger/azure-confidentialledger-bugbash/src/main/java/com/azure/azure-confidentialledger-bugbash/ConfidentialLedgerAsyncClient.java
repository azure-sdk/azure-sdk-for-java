...
import com.azure.azure-confidentialledger-bugbash.implementation.ConfidentialLedgerClientImpl;
...
public final class ConfidentialLedgerAsyncClient {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<Void>> createLedgerEntryWithResponse(BinaryData resourceCreateOrReplaceModel, RequestOptions requestOptions) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> createOrUpdateUserWithResponse(String userId, BinaryData ledgerUser, RequestOptions requestOptions) {
