...
public final class CodeTransparencyClientImpl {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> getEntryStatusWithResponseAsync(String operationId, BinaryData body,
        RequestOptions requestOptions) {
        final String accept = "application/json";
        return FluxUtil.withContext(context -> service.getEntryStatus(this.getEndpoint(),
            this.getServiceVersion().getVersion(), operationId, accept, body, requestOptions, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> getEntryWithResponseAsync(String entryId, BinaryData body,
        RequestOptions requestOptions) {
        ...
        return FluxUtil.withContext(context -> service.getEntry(this.getEndpoint(),
            this.getServiceVersion().getVersion(), entryId, accept, body, requestOptions, context));
    }
    ...
    public Response<BinaryData> getEntryWithResponse(String entryId, BinaryData body, RequestOptions requestOptions) {
        final String accept = "application/cose, application/json";
        return service.getEntrySync(this.getEndpoint(), this.getServiceVersion().getVersion(), entryId, accept, body,
            requestOptions, Context.NONE);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> getEntryReceiptWithResponseAsync(String entryId, BinaryData body,
        RequestOptions requestOptions) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<BinaryData>> listEntryIdsSinglePageAsync(BinaryData body,
        RequestOptions requestOptions) {
        final String accept = "application/json";
        return FluxUtil
    ...
    public PagedFlux<BinaryData> listEntryIdsAsync(BinaryData body, RequestOptions requestOptions) {
        RequestOptions requestOptionsForNextPage = new RequestOptions();
        requestOptionsForNextPage.setContext(
            requestOptions != null && requestOptions.getContext() != null ? requestOptions.getContext() : Context.NONE);
        return new PagedFlux<>(() -> listEntryIdsSinglePageAsync(body, requestOptions),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<BinaryData> listEntryIdsSinglePage(BinaryData body, RequestOptions requestOptions) {
        final String accept = "application/json";
    ...
    public PagedIterable<BinaryData> listEntryIds(BinaryData body, RequestOptions requestOptions) {
        ...
        requestOptionsForNextPage.setContext(
            requestOptions != null && requestOptions.getContext() != null ? requestOptions.getContext() : Context.NONE);
        return new PagedIterable<>(() -> listEntryIdsSinglePage(body, requestOptions),
