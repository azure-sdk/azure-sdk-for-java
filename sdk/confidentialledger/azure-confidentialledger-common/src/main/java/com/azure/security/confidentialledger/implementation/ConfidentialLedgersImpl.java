...
public final class ConfidentialLedgersImpl {
    ...
    private interface ConfidentialLedgersService {
        ...
        @UnexpectedResponseExceptionType(
                ...
                code = {409})
        @UnexpectedResponseExceptionType(HttpResponseException.class)
        Mono<Response<BinaryData>> getCollections(
                @HostParam("ledgerUri") String ledgerUri,
                @QueryParam("api-version") String apiVersion,
                RequestOptions requestOptions,
                Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> getCollectionsWithResponseAsync(RequestOptions requestOptions, Context context) {
    ...
    public Response<BinaryData> getCollectionsWithResponse(RequestOptions requestOptions) {
        return getCollectionsWithResponseAsync(requestOptions).block();
    }
    ...
    public PagedFlux<BinaryData> getLedgerEntriesAsync(RequestOptions requestOptions) {
        ...
        return new PagedFlux<>(
                ...
                nextLink -> getLedgerEntriesNextSinglePageAsync(nextLink, requestOptionsForNextPage));
    }
    ...
    public PagedFlux<BinaryData> getLedgerEntriesAsync(RequestOptions requestOptions, Context context) {
        ...
        return new PagedFlux<>(
                ...
                nextLink -> getLedgerEntriesNextSinglePageAsync(nextLink, requestOptionsForNextPage, context));
    }
