...
public final class ConfidentialLedgerClient {
    ...
    public Response<BinaryData> getCollectionsWithResponse(RequestOptions requestOptions) {
        return this.client.getCollectionsWithResponse(requestOptions).block();
    }
    ...
    public PagedIterable<BinaryData> getLedgerEntries(RequestOptions requestOptions) {
        return new PagedIterable<>(this.client.getLedgerEntries(requestOptions));
    }
    ...
    public Response<BinaryData> postLedgerEntryWithResponse(RequestOptions requestOptions) {
        return this.client.postLedgerEntryWithResponse(requestOptions).block();
    }
