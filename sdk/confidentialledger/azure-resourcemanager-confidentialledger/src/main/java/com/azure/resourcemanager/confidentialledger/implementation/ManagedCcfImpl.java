...
public final class ManagedCcfImpl implements ManagedCcf, ManagedCcf.Definition, ManagedCcf.Update {
    ...
    public ManagedCcf create() {
        this.innerObject = serviceManager.serviceClient().getManagedCcfs().create(resourceGroupName, appName,
    ...
    public ManagedCcf apply() {
        this.innerObject = serviceManager.serviceClient().getManagedCcfs().update(resourceGroupName, appName,
            this.innerModel(), Context.NONE);
        return this;
    }
    ...
    public ManagedCcf refresh() {
        this.innerObject = serviceManager.serviceClient().getManagedCcfs()
            .getByResourceGroupWithResponse(resourceGroupName, appName, Context.NONE).getValue();
        return this;
    }

    public ManagedCcf refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getManagedCcfs()
            .getByResourceGroupWithResponse(resourceGroupName, appName, context).getValue();
        return this;
    }
