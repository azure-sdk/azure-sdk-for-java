...
public final class ConfidentialLedgerImpl
    ...
    public ConfidentialLedger create() {
        this.innerObject = serviceManager.serviceClient().getLedgers().create(resourceGroupName, ledgerName,
    ...
    public ConfidentialLedger apply() {
        this.innerObject = serviceManager.serviceClient().getLedgers().update(resourceGroupName, ledgerName,
            this.innerModel(), Context.NONE);
        return this;
    }
    ...
    public ConfidentialLedger refresh() {
        this.innerObject = serviceManager.serviceClient().getLedgers()
            .getByResourceGroupWithResponse(resourceGroupName, ledgerName, Context.NONE).getValue();
        return this;
    }

    public ConfidentialLedger refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getLedgers()
            .getByResourceGroupWithResponse(resourceGroupName, ledgerName, context).getValue();
        return this;
    }
