...
public final class LedgerProperties {
    /*
     * Enclave Platform on which Ledger Application is deployed, defaults to IntelSgx
     */
    @JsonProperty(value = "enclavePlatform", access = JsonProperty.Access.WRITE_ONLY)
    ...
    /**
     * Get the enclavePlatform property: Enclave Platform on which Ledger Application is deployed, defaults to
     * IntelSgx.
     * 
