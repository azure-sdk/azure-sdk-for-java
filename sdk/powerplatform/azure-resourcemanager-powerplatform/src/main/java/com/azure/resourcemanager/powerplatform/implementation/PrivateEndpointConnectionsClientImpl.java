...
public final class PrivateEndpointConnectionsClientImpl implements PrivateEndpointConnectionsClient {
    ...
    public interface PrivateEndpointConnectionsService {
        ...
        Mono<Response<PrivateEndpointConnectionListResult>> listByEnterprisePolicy(@HostParam("$host") String endpoint,
    ...
    private PagedFlux<PrivateEndpointConnectionInner> listByEnterprisePolicyAsync(String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<PrivateEndpointConnectionInner> listByEnterprisePolicy(String resourceGroupName,
        String enterprisePolicyName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PrivateEndpointConnectionInner> getAsync(String resourceGroupName, String enterprisePolicyName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<Void> deleteWithResponse(String resourceGroupName, String enterprisePolicyName,
        String privateEndpointConnectionName, Context context) {
