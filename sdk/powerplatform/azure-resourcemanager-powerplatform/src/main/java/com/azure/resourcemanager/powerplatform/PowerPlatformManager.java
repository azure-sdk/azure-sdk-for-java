...
public final class PowerPlatformManager {
    ...
    private PowerPlatformManager(HttpPipeline httpPipeline, AzureProfile profile, Duration defaultPollInterval) {
        ...
        this.clientObject = new PowerPlatformBuilder().pipeline(httpPipeline)
     ...
     * @return the PowerPlatform service API instance.
     */
    public static PowerPlatformManager authenticate(HttpPipeline httpPipeline, AzureProfile profile) {
        Objects.requireNonNull(httpPipeline, "'httpPipeline' cannot be null.");
        Objects.requireNonNull(profile, "'profile' cannot be null.");
        return new PowerPlatformManager(httpPipeline, profile, null);
    }
    ...
    public static final class Configurable {
        ...
        private static final Map<String, String> PROPERTIES
            = CoreUtils.getProperties("azure-resourcemanager-powerplatform.properties");
