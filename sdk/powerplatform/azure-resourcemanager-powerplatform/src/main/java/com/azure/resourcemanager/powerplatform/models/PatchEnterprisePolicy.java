...
import com.azure.resourcemanager.powerplatform.fluent.models.Properties;
 ...
 */
@Fluent
public final class PatchEnterprisePolicy extends PatchTrackedResource {
    /*
    ...
    /**
     * Creates an instance of PatchEnterprisePolicy class.
     */
     ...
     * @return the PatchEnterprisePolicy object itself.
     */
    public PatchEnterprisePolicy withKind(EnterprisePolicyKind kind) {
        this.kind = kind;
        return this;
    }
     ...
     * @return the PatchEnterprisePolicy object itself.
     */
    public PatchEnterprisePolicy withHealthStatus(HealthStatus healthStatus) {
        if (this.innerProperties() == null) {
            this.innerProperties = new Properties();
        }
    ...
    /**
     * Reads an instance of PatchEnterprisePolicy from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of PatchEnterprisePolicy if the JsonReader was pointing to an instance of it, or null if it
     * was pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the PatchEnterprisePolicy.
     */
    public static PatchEnterprisePolicy fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            PatchEnterprisePolicy deserializedPatchEnterprisePolicy = new PatchEnterprisePolicy();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("id".equals(fieldName)) {
                    deserializedPatchEnterprisePolicy.id = reader.getString();
                } else if ("name".equals(fieldName)) {
                    deserializedPatchEnterprisePolicy.name = reader.getString();
                } else if ("type".equals(fieldName)) {
                    deserializedPatchEnterprisePolicy.type = reader.getString();
                } else if ("tags".equals(fieldName)) {
                    Map<String, String> tags = reader.readMap(reader1 -> reader1.getString());
                    deserializedPatchEnterprisePolicy.withTags(tags);
                } else if ("location".equals(fieldName)) {
                    deserializedPatchEnterprisePolicy.withLocation(reader.getString());
                } else if ("identity".equals(fieldName)) {
                    deserializedPatchEnterprisePolicy.identity = EnterprisePolicyIdentity.fromJson(reader);
                } else if ("kind".equals(fieldName)) {
                    deserializedPatchEnterprisePolicy.kind = EnterprisePolicyKind.fromString(reader.getString());
                } else if ("properties".equals(fieldName)) {
                    deserializedPatchEnterprisePolicy.innerProperties = Properties.fromJson(reader);
                } else if ("systemData".equals(fieldName)) {
                    deserializedPatchEnterprisePolicy.systemData = SystemData.fromJson(reader);
                } else {
                    reader.skipChildren();
                }
            }

            return deserializedPatchEnterprisePolicy;
        });
    }
}
