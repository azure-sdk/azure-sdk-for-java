...
public final class AccountsClientImpl implements AccountsClient {
    ...
    private Mono<Response<AccountInner>> createOrUpdateWithResponseAsync(String accountName, String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<AccountInner> createOrUpdateAsync(String accountName, String resourceGroupName,
        AccountInner parameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<AccountInner> createOrUpdateWithResponse(String accountName, String resourceGroupName,
        AccountInner parameters, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<AccountInner>> updateWithResponseAsync(String accountName, String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<AccountInner> updateWithResponse(String accountName, String resourceGroupName,
        PatchAccount parameters, Context context) {
