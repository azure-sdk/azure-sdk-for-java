...
public interface EnterprisePoliciesClient {
    ...
    Response<EnterprisePolicyInner> createOrUpdateWithResponse(String enterprisePolicyName, String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<EnterprisePolicyInner> getByResourceGroupWithResponse(String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<EnterprisePolicyInner> updateWithResponse(String enterprisePolicyName, String resourceGroupName,
