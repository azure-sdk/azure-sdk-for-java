...
public final class EnterprisePoliciesClientImpl implements EnterprisePoliciesClient {
    ...
    public interface EnterprisePoliciesService {
        ...
        Mono<Response<EnterprisePolicyInner>> createOrUpdate(@HostParam("$host") String endpoint,
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<EnterprisePolicyInner>> getByResourceGroup(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<EnterprisePolicyInner>> update(@HostParam("$host") String endpoint,
            @PathParam("enterprisePolicyName") String enterprisePolicyName,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @QueryParam("api-version") String apiVersion,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<EnterprisePolicyList>> listByResourceGroup(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<EnterprisePolicyList>> list(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, Context context);
    ...
    private Mono<Response<EnterprisePolicyInner>> createOrUpdateWithResponseAsync(String enterprisePolicyName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<EnterprisePolicyInner> createOrUpdateAsync(String enterprisePolicyName, String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<EnterprisePolicyInner> createOrUpdateWithResponse(String enterprisePolicyName,
        String resourceGroupName, EnterprisePolicyInner parameters, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<EnterprisePolicyInner>> getByResourceGroupWithResponseAsync(String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<EnterprisePolicyInner> getByResourceGroupWithResponse(String resourceGroupName,
        String enterprisePolicyName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<EnterprisePolicyInner>> updateWithResponseAsync(String enterprisePolicyName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<EnterprisePolicyInner> updateAsync(String enterprisePolicyName, String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<EnterprisePolicyInner> updateWithResponse(String enterprisePolicyName, String resourceGroupName,
    ...
    private Mono<PagedResponse<EnterprisePolicyInner>> listByResourceGroupSinglePageAsync(String resourceGroupName) {
        ...
        return FluxUtil
            ...
            .<PagedResponse<EnterprisePolicyInner>>map(res -> new PagedResponseBase<>(res.getRequest(),
