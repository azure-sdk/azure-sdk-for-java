...
public interface AccountsClient {
    ...
    Response<AccountInner> createOrUpdateWithResponse(String accountName, String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<AccountInner> updateWithResponse(String accountName, String resourceGroupName, PatchAccount parameters,
        Context context);
