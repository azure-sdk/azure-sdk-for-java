...
public final class EnterprisePoliciesImpl implements EnterprisePolicies {
    ...
    public Response<EnterprisePolicy> getByResourceGroupWithResponse(String resourceGroupName,
    ...
    public Response<Void> deleteByResourceGroupWithResponse(String resourceGroupName, String enterprisePolicyName,
        Context context) {
