...
public final class IndexRecommendationDetails implements JsonSerializable<IndexRecommendationDetails> {
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeStringField("indexColumns", this.indexColumns);
        jsonWriter.writeStringField("includedColumns", this.includedColumns);
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("databaseName".equals(fieldName)) {
                    ...
                    deserializedIndexRecommendationDetails.indexColumns = reader.getString();
                } else if ("includedColumns".equals(fieldName)) {
                    deserializedIndexRecommendationDetails.includedColumns = reader.getString();
                } else {
                    reader.skipChildren();
                }
            }
