...
public final class Storage {
     ...
     */
    @JsonProperty(value = "iopsTier")
    private AzureManagedDiskPerformanceTiers iopsTier;
    ...
    /**
     * Get the iopsTier property: Name of storage tier for IOPS.
     *
     * @return the iopsTier value.
     */
    public AzureManagedDiskPerformanceTiers iopsTier() {
        return this.iopsTier;
    }

    /**
     * Set the iopsTier property: Name of storage tier for IOPS.
     *
     * @param iopsTier the iopsTier value to set.
     * @return the Storage object itself.
     */
    public Storage withIopsTier(AzureManagedDiskPerformanceTiers iopsTier) {
        this.iopsTier = iopsTier;
        return this;
    }
