...
public interface IndexRecommendationResource {
    ...
    /**
     * Gets the kind property: Kind of index recommendation.
     * 
    ...
    /**
     * Gets the id property: The id of index recommendation.
     * 
     * @return the id value.
     */
    String id();
    ...
    /**
     * Gets the name property: The name of index recommendation.
     * 
