...
import com.azure.resourcemanager.postgresqlflexibleserver.models.ReplicationPromoteMode;
...
public final class ServersUpdateSamples {
    ...
    /*
     * x-ms-original-file: specification/postgresql/resource-manager/Microsoft.DBforPostgreSQL/preview/2023-06-01-preview/examples/PromoteReplicaAsPlannedSiteswap.json
     */
    /**
     * Sample code: Siteswap a replica server as planned, i.e. it will wait for replication to complete before promoting
     * replica as Primary and original primary as replica.
     *
     * @param manager Entry point to PostgreSqlManager.
     */
    public static void
        siteswapAReplicaServerAsPlannedIEItWillWaitForReplicationToCompleteBeforePromotingReplicaAsPrimaryAndOriginalPrimaryAsReplica(
            com.azure.resourcemanager.postgresqlflexibleserver.PostgreSqlManager manager) {
        Server resource =
            manager
                .servers()
        ...
        resource
            ...
            .withReplica(
                new Replica()
                    .withPromoteMode(ReplicationPromoteMode.SITESWAP)
                    .withPromoteOption(ReplicationPromoteOption.PLANNED))
            .apply();
    }

    /*
     * x-ms-original-file: specification/postgresql/resource-manager/Microsoft.DBforPostgreSQL/preview/2023-06-01-preview/examples/PromoteReplicaAsForcedSiteswap.json
     */
    /**
     * Sample code: Siteswap a replica server as forced, i.e. it will replica as Primary and original primary as replica
     * immediately without waiting for primary and replica to be in sync.
     *
     * @param manager Entry point to PostgreSqlManager.
     */
    public static void
        siteswapAReplicaServerAsForcedIEItWillReplicaAsPrimaryAndOriginalPrimaryAsReplicaImmediatelyWithoutWaitingForPrimaryAndReplicaToBeInSync(
            com.azure.resourcemanager.postgresqlflexibleserver.PostgreSqlManager manager) {
        Server resource =
            manager
                .servers()
        ...
        resource
            ...
            .withReplica(
                new Replica()
                    .withPromoteMode(ReplicationPromoteMode.STANDALONE)
                    .withPromoteOption(ReplicationPromoteOption.PLANNED))
            .apply();
    }
