...
import com.azure.resourcemanager.edgemicrosoftedgesites.fluent.models.OperationInner;
import com.azure.resourcemanager.edgemicrosoftedgesites.models.OperationListResult;
...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    OperationsClientImpl(EdgeSitesImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for EdgeSitesOperations to be used by the proxy service to perform REST
     * calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "EdgeSitesOperations")
