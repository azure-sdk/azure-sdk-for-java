...
/**
 * Resource collection API of SitesDeletes.
 */
public interface SitesDeletes {
    /**
     ...
     */
    Response<Void> atSubscriptionWithResponse(String siteName, Context context);
     ...
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     */
    void atSubscription(String siteName);
