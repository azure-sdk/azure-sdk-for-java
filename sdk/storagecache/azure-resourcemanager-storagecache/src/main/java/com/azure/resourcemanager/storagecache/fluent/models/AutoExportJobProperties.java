...
public final class AutoExportJobProperties implements JsonSerializable<AutoExportJobProperties> {
     ...
     * @return the AutoExportJobProperties object itself.
     */
    public AutoExportJobProperties withState(AutoExportStatusType state) {
        if (this.innerStatus() == null) {
            this.innerStatus = new AutoExportJobPropertiesStatus();
        }
        this.innerStatus().withState(state);
        return this;
    }
    ...
    /**
     * Get the currentIterationFilesExported property: Number of files that have been exported in current iteration.
     * 
    ...
    /**
     * Get the currentIterationFilesFailed property: Number of files failed to export in current iteration.
     * 
