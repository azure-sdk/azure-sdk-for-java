...
public interface AutoImportJob {
     ...
     */
    Integer preexistingDirectories();
    ...
    /**
     * Gets the importedFilesBlobSyncEventsImportedFiles property: Number of files imported during auto import.
     * 
     * @return the importedFilesBlobSyncEventsImportedFiles value.
     */
    Integer importedFilesBlobSyncEventsImportedFiles();

    /**
     * Gets the importedDirectoriesBlobSyncEventsImportedDirectories property: Number of directories imported during
     * auto import.
     * 
     * @return the importedDirectoriesBlobSyncEventsImportedDirectories value.
     */
    Integer importedDirectoriesBlobSyncEventsImportedDirectories();

    /**
     * Gets the importedSymlinksBlobSyncEventsImportedSymlinks property: Number of symlinks imported during auto import.
     * 
     * @return the importedSymlinksBlobSyncEventsImportedSymlinks value.
     */
    Integer importedSymlinksBlobSyncEventsImportedSymlinks();

    /**
     * Gets the preexistingFilesBlobSyncEventsPreexistingFiles property: Number of preexisting files during auto import.
     * 
     * @return the preexistingFilesBlobSyncEventsPreexistingFiles value.
     */
    Integer preexistingFilesBlobSyncEventsPreexistingFiles();

    /**
     * Gets the preexistingDirectoriesBlobSyncEventsPreexistingDirectories property: Number of preexisting directories
     * during auto import.
     * 
     * @return the preexistingDirectoriesBlobSyncEventsPreexistingDirectories value.
     */
    Integer preexistingDirectoriesBlobSyncEventsPreexistingDirectories();

    /**
     * Gets the preexistingSymlinksBlobSyncEventsPreexistingSymlinks property: Number of preexisting symlinks during
     * auto import.
     * 
     * @return the preexistingSymlinksBlobSyncEventsPreexistingSymlinks value.
     */
    Integer preexistingSymlinksBlobSyncEventsPreexistingSymlinks();

    /**
     * Gets the totalBlobsImportedBlobSyncEventsTotalBlobsImported property: Total number of blobs imported during auto
     * import.
     * 
     * @return the totalBlobsImportedBlobSyncEventsTotalBlobsImported value.
     */
    Integer totalBlobsImportedBlobSyncEventsTotalBlobsImported();

    /**
     * Gets the rateOfBlobImportBlobSyncEventsRateOfBlobImport property: Rate of blob import during auto import.
     * 
     * @return the rateOfBlobImportBlobSyncEventsRateOfBlobImport value.
     */
    Integer rateOfBlobImportBlobSyncEventsRateOfBlobImport();

    /**
     * Gets the totalErrorsBlobSyncEventsTotalErrors property: Total errors encountered during auto import.
     * 
     * @return the totalErrorsBlobSyncEventsTotalErrors value.
     */
    Integer totalErrorsBlobSyncEventsTotalErrors();

    /**
     * Gets the totalConflictsBlobSyncEventsTotalConflicts property: Total conflicts encountered during auto import.
     * 
     * @return the totalConflictsBlobSyncEventsTotalConflicts value.
     */
    Integer totalConflictsBlobSyncEventsTotalConflicts();

    /**
     * Gets the deletions property: Number of deletions during auto import.
     * 
    ...
    /**
     * Gets the lastChangeFeedEventConsumedTime property: Date and time of the last Change Feed event consumed.
     * 
     * @return the lastChangeFeedEventConsumedTime value.
     */
    OffsetDateTime lastChangeFeedEventConsumedTime();

    /**
     * Gets the lastTimeFullySynchronized property: Date and time when last fully synchronized.
     * 
     * @return the lastTimeFullySynchronized value.
     */
    OffsetDateTime lastTimeFullySynchronized();
    ...
    interface DefinitionStages {
        ...
        interface WithConflictResolutionMode {
             ...
             * were not dirty. Please reference https://learn.microsoft.com/en-us/azure/azure-managed-lustre/ for a
