...
public interface AutoExportJob {
    ...
    /**
     * Gets the currentIterationFilesExported property: Number of files that have been exported in current iteration.
     * 
    ...
    /**
     * Gets the currentIterationFilesFailed property: Number of files failed to export in current iteration.
     * 
