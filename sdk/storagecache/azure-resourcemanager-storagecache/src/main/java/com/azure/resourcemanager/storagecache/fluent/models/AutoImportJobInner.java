...
public final class AutoImportJobInner extends Resource {
     ...
     * @return the AutoImportJobInner object itself.
     */
    public AutoImportJobInner withMaximumErrors(Integer maximumErrors) {
        if (this.innerProperties() == null) {
            this.innerProperties = new AutoImportJobProperties();
        }
    ...
    public Integer importedFilesBlobSyncEventsImportedFiles() {
        return this.innerProperties() == null
            ? null
            : this.innerProperties().importedFilesBlobSyncEventsImportedFiles();
    }
    ...
    public Integer importedDirectoriesBlobSyncEventsImportedDirectories() {
        return this.innerProperties() == null
            ? null
            : this.innerProperties().importedDirectoriesBlobSyncEventsImportedDirectories();
    }
    ...
    public Integer importedSymlinksBlobSyncEventsImportedSymlinks() {
        return this.innerProperties() == null
            ? null
            : this.innerProperties().importedSymlinksBlobSyncEventsImportedSymlinks();
    }
    ...
    public Integer preexistingFilesBlobSyncEventsPreexistingFiles() {
        return this.innerProperties() == null
            ? null
            : this.innerProperties().preexistingFilesBlobSyncEventsPreexistingFiles();
    }
    ...
    public Integer preexistingDirectoriesBlobSyncEventsPreexistingDirectories() {
        return this.innerProperties() == null
            ? null
            : this.innerProperties().preexistingDirectoriesBlobSyncEventsPreexistingDirectories();
    }
    ...
    public Integer preexistingSymlinksBlobSyncEventsPreexistingSymlinks() {
        return this.innerProperties() == null
            ? null
            : this.innerProperties().preexistingSymlinksBlobSyncEventsPreexistingSymlinks();
    }
    ...
    public Integer totalBlobsImportedBlobSyncEventsTotalBlobsImported() {
        return this.innerProperties() == null
            ? null
            : this.innerProperties().totalBlobsImportedBlobSyncEventsTotalBlobsImported();
    }
    ...
    public Integer rateOfBlobImportBlobSyncEventsRateOfBlobImport() {
        return this.innerProperties() == null
            ? null
            : this.innerProperties().rateOfBlobImportBlobSyncEventsRateOfBlobImport();
    }
    ...
    public Integer totalErrorsBlobSyncEventsTotalErrors() {
        return this.innerProperties() == null ? null : this.innerProperties().totalErrorsBlobSyncEventsTotalErrors();
    }
    ...
    public Integer totalConflictsBlobSyncEventsTotalConflicts() {
        return this.innerProperties() == null
            ? null
            : this.innerProperties().totalConflictsBlobSyncEventsTotalConflicts();
    }
    ...
    public Integer deletions() {
        return this.innerProperties() == null ? null : this.innerProperties().deletions();
    }
    ...
    public OffsetDateTime lastChangeFeedEventConsumedTime() {
        return this.innerProperties() == null ? null : this.innerProperties().lastChangeFeedEventConsumedTime();
    }
    ...
    public OffsetDateTime lastTimeFullySynchronized() {
        return this.innerProperties() == null ? null : this.innerProperties().lastTimeFullySynchronized();
    }
