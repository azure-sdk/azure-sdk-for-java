...
public final class ImportJobImpl implements ImportJob, ImportJob.Definition, ImportJob.Update {
    ...
    public ImportJob create() {
        this.innerObject = serviceManager.serviceClient().getImportJobs().createOrUpdate(resourceGroupName,
            amlFilesystemName, importJobName, this.innerModel(), Context.NONE);
        return this;
    }

    public ImportJob create(Context context) {
        this.innerObject = serviceManager.serviceClient().getImportJobs().createOrUpdate(resourceGroupName,
            amlFilesystemName, importJobName, this.innerModel(), context);
        return this;
    }
    ...
    public ImportJob apply() {
        this.innerObject = serviceManager.serviceClient().getImportJobs().update(resourceGroupName, amlFilesystemName,
            importJobName, updateImportJob, Context.NONE);
        return this;
    }

    public ImportJob apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getImportJobs().update(resourceGroupName, amlFilesystemName,
            importJobName, updateImportJob, context);
        return this;
    }
    ...
    public ImportJob refresh() {
        this.innerObject = serviceManager.serviceClient().getImportJobs()
            .getWithResponse(resourceGroupName, amlFilesystemName, importJobName, Context.NONE).getValue();
        return this;
    }

    public ImportJob refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getImportJobs()
            .getWithResponse(resourceGroupName, amlFilesystemName, importJobName, context).getValue();
        return this;
    }
