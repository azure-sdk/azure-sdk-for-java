...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    OperationsClientImpl(StorageCacheManagementClientImpl client) {
        this.service =
    ...
    /**
     * The interface defining all the services for StorageCacheManagementClientOperations to be used by the proxy
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<ApiOperationInner>> listSinglePageAsync(Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<ApiOperationInner> listAsync(Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<ApiOperationInner> list(Context context) {
