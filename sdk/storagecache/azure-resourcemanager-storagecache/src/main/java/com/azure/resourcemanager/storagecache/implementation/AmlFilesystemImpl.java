...
public final class AmlFilesystemImpl implements AmlFilesystem, AmlFilesystem.Definition, AmlFilesystem.Update {
    ...
    public Response<Void> importMethodWithResponse(AmlFilesystemImportInfo importInfo, Context context) {
        return serviceManager.amlFilesystems().importMethodWithResponse(resourceGroupName, amlFilesystemName,
            importInfo, context);
    }

    public void importMethod() {
        serviceManager.amlFilesystems().importMethod(resourceGroupName, amlFilesystemName);
    }

    public Response<Void> cancelImportWithResponse(Context context) {
        return serviceManager.amlFilesystems().cancelImportWithResponse(resourceGroupName, amlFilesystemName, context);
    }

    public void cancelImport() {
        serviceManager.amlFilesystems().cancelImport(resourceGroupName, amlFilesystemName);
    }
