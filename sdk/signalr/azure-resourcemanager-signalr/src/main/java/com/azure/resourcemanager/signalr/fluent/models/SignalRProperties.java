...
public final class SignalRProperties implements JsonSerializable<SignalRProperties> {
    ...
    /**
     * Get the routeSettings property: Route settings for the resource.
     * 
    ...
    /**
     * Set the routeSettings property: Route settings for the resource.
     * 
     * @param routeSettings the routeSettings value to set.
     * @return the SignalRProperties object itself.
     */
    public SignalRProperties withRouteSettings(RouteSettings routeSettings) {
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeJsonField("routeSettings", this.routeSettings);
    ...
    public static SignalRProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                } else if ("routeSettings".equals(fieldName)) {
                    deserializedSignalRProperties.routeSettings = RouteSettings.fromJson(reader);
                } else {
                    reader.skipChildren();
                }
            }
