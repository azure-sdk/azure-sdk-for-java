 ...
 */
public final class SignalRReplicaSharedPrivateLinkResourcesClientImpl
    implements SignalRReplicaSharedPrivateLinkResourcesClient {
    /**
     * The proxy service used to perform REST calls.
     */
    private final SignalRReplicaSharedPrivateLinkResourcesService service;
    ...
    /**
     * Initializes an instance of SignalRReplicaSharedPrivateLinkResourcesClientImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    SignalRReplicaSharedPrivateLinkResourcesClientImpl(SignalRManagementClientImpl client) {
        this.service = RestProxy.create(SignalRReplicaSharedPrivateLinkResourcesService.class, client.getHttpPipeline(),
            client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for SignalRManagementClientSignalRReplicaSharedPrivateLinkResources to
     * be used by the proxy service to perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "SignalRManagementCli")
    public interface SignalRReplicaSharedPrivateLinkResourcesService {
    ...
    public SyncPoller<PollResult<SharedPrivateLinkResourceInner>, SharedPrivateLinkResourceInner> beginCreateOrUpdate(
        ...
        SharedPrivateLinkResourceInner parameters) {
        return this.beginCreateOrUpdateAsync(resourceGroupName, resourceName, replicaName,
