...
public final class SignalRManagementClientImpl implements SignalRManagementClient {
    ...
    /**
     * The SignalRReplicaOperationsClient object to access its operations.
     */
    private final SignalRReplicaOperationsClient signalRReplicaOperations;

    /**
     * Gets the SignalRReplicaOperationsClient object to access its operations.
     * 
     * @return the SignalRReplicaOperationsClient object.
     */
    public SignalRReplicaOperationsClient getSignalRReplicaOperations() {
        return this.signalRReplicaOperations;
    }
    ...
    public SignalRSharedPrivateLinkResourcesClient getSignalRSharedPrivateLinkResources() {
        return this.signalRSharedPrivateLinkResources;
    }
    ...
    SignalRManagementClientImpl(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter,
        ...
        this.signalRReplicaOperations = new SignalRReplicaOperationsClientImpl(this);
