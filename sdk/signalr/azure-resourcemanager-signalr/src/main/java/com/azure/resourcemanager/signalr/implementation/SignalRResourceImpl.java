...
public final class SignalRResourceImpl implements SignalRResource, SignalRResource.Definition, SignalRResource.Update {
    ...
    public SignalRResource create() {
        this.innerObject = serviceManager.serviceClient().getSignalRs().createOrUpdate(resourceGroupName, resourceName,
    ...
    public SignalRResource apply() {
        this.innerObject = serviceManager.serviceClient().getSignalRs().update(resourceGroupName, resourceName,
            this.innerModel(), Context.NONE);
        return this;
    }
    ...
    public SignalRResource refresh() {
        this.innerObject = serviceManager.serviceClient().getSignalRs()
