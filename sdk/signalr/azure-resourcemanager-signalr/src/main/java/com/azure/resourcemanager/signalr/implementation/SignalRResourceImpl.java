...
public final class SignalRResourceImpl implements SignalRResource, SignalRResource.Definition, SignalRResource.Update {
    ...
    public RouteSettings routeSettings() {
        return this.innerModel().routeSettings();
    }
    ...
    public SignalRResourceImpl withRouteSettings(RouteSettings routeSettings) {
        this.innerModel().withRouteSettings(routeSettings);
        return this;
    }
}
