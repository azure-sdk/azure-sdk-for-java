...
public final class CustomDomainImpl implements CustomDomain, CustomDomain.Definition, CustomDomain.Update {
    ...
    public CustomDomain create() {
        this.innerObject = serviceManager.serviceClient().getSignalRCustomDomains().createOrUpdate(resourceGroupName,
    ...
    public CustomDomain refresh() {
        this.innerObject = serviceManager.serviceClient().getSignalRCustomDomains()
