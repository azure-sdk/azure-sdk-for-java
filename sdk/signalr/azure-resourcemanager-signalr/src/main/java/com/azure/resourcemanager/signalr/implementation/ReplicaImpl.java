...
public final class ReplicaImpl implements Replica, Replica.Definition, Replica.Update {
    ...
    public Replica create() {
        this.innerObject = serviceManager.serviceClient().getSignalRReplicas().createOrUpdate(resourceGroupName,
    ...
    public Replica apply() {
        this.innerObject = serviceManager.serviceClient().getSignalRReplicas().update(resourceGroupName, resourceName,
    ...
    public Replica refresh() {
        this.innerObject = serviceManager.serviceClient().getSignalRReplicas()
