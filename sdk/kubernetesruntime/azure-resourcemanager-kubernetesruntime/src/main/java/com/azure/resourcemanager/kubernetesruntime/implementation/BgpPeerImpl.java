...
public final class BgpPeerImpl implements BgpPeer, BgpPeer.Definition, BgpPeer.Update {
    ...
    public BgpPeer create() {
        this.innerObject = serviceManager.serviceClient().getBgpPeers().createOrUpdate(resourceUri, bgpPeerName,
    ...
    public BgpPeer refresh() {
        this.innerObject = serviceManager.serviceClient().getBgpPeers()
            .getWithResponse(resourceUri, bgpPeerName, Context.NONE).getValue();
        return this;
    }

    public BgpPeer refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getBgpPeers()
            .getWithResponse(resourceUri, bgpPeerName, context).getValue();
        return this;
    }
