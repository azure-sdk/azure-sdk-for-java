...
public final class ServiceResourceImpl implements ServiceResource, ServiceResource.Definition, ServiceResource.Update {
    ...
    public ServiceResource create() {
        this.innerObject = serviceManager.serviceClient().getServices()
            .createOrUpdateWithResponse(resourceUri, serviceName, this.innerModel(), Context.NONE).getValue();
        return this;
    }

    public ServiceResource create(Context context) {
        this.innerObject = serviceManager.serviceClient().getServices()
            .createOrUpdateWithResponse(resourceUri, serviceName, this.innerModel(), context).getValue();
        return this;
    }
    ...
    public ServiceResource refresh() {
        this.innerObject = serviceManager.serviceClient().getServices()
            .getWithResponse(resourceUri, serviceName, Context.NONE).getValue();
        return this;
    }

    public ServiceResource refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getServices()
            .getWithResponse(resourceUri, serviceName, context).getValue();
        return this;
    }
}
