...
public interface BgpPeersClient {
    ...
    PagedIterable<BgpPeerInner> listByParent(String resourceUri);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<BgpPeerInner> listByParent(String resourceUri, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<Void>, Void> beginDelete(String resourceUri, String bgpPeerName);
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<Void>, Void> beginDelete(String resourceUri, String bgpPeerName, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    void delete(String resourceUri, String bgpPeerName, Context context);
}
