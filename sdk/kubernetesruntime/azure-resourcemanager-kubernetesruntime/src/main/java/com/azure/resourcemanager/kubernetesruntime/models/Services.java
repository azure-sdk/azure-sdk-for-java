...
public interface Services {
     ...
     */
    PagedIterable<ServiceResource> listByParent(String resourceUri);
     ...
     * @return the response of a ServiceResource list operation as paginated response with {@link PagedIterable}.
     */
    PagedIterable<ServiceResource> listByParent(String resourceUri, Context context);
     ...
     */
    Response<ServiceResource> getWithResponse(String resourceUri, String serviceName, Context context);
     ...
     */
    ServiceResource get(String resourceUri, String serviceName);
     ...
     */
    Response<Void> deleteByResourceGroupWithResponse(String resourceUri, String serviceName, Context context);
     ...
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     */
    void deleteByResourceGroup(String resourceUri, String serviceName);
