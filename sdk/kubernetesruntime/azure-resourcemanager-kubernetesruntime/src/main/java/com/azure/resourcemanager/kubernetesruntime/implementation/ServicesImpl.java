...
public final class ServicesImpl implements Services {
    ...
    public PagedIterable<ServiceResource> listByParent(String resourceUri) {
        PagedIterable<ServiceResourceInner> inner = this.serviceClient().listByParent(resourceUri);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new ServiceResourceImpl(inner1, this.manager()));
    }

    public PagedIterable<ServiceResource> listByParent(String resourceUri, Context context) {
        PagedIterable<ServiceResourceInner> inner = this.serviceClient().listByParent(resourceUri, context);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new ServiceResourceImpl(inner1, this.manager()));
    }
