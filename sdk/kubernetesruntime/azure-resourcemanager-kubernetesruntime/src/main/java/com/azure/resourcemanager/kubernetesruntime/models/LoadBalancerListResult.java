...
public final class LoadBalancerListResult {
     ...
     * @return the LoadBalancerListResult object itself.
     */
    public LoadBalancerListResult withNextLink(String nextLink) {
    ...
    public void validate() {
        if (value() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Missing required property value in model LoadBalancerListResult"));
        } else {
