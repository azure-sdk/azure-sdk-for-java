...
public final class StorageClassResourceImpl
    ...
    public StorageClassResource create() {
        this.innerObject = serviceManager.serviceClient().getStorageClass().createOrUpdate(resourceUri,
            storageClassName, this.innerModel(), Context.NONE);
        return this;
    }

    public StorageClassResource create(Context context) {
        this.innerObject = serviceManager.serviceClient().getStorageClass().createOrUpdate(resourceUri,
            storageClassName, this.innerModel(), context);
        return this;
    }
    ...
    public StorageClassResource apply() {
        this.innerObject = serviceManager.serviceClient().getStorageClass().update(resourceUri, storageClassName,
    ...
    public StorageClassResource refresh() {
        this.innerObject = serviceManager.serviceClient().getStorageClass()
            .getWithResponse(resourceUri, storageClassName, Context.NONE).getValue();
        return this;
    }

    public StorageClassResource refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getStorageClass()
            .getWithResponse(resourceUri, storageClassName, context).getValue();
        return this;
    }
