...
public interface LoadBalancersClient {
    ...
    PagedIterable<LoadBalancerInner> listByParent(String resourceUri);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<LoadBalancerInner> listByParent(String resourceUri, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<Void>, Void> beginDelete(String resourceUri, String loadBalancerName);
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<Void>, Void> beginDelete(String resourceUri, String loadBalancerName, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    void delete(String resourceUri, String loadBalancerName, Context context);
}
