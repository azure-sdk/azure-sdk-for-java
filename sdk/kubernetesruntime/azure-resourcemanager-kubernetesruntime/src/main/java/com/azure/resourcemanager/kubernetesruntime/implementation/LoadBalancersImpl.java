...
public final class LoadBalancersImpl implements LoadBalancers {
    ...
    public PagedIterable<LoadBalancer> listByParent(String resourceUri) {
        PagedIterable<LoadBalancerInner> inner = this.serviceClient().listByParent(resourceUri);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new LoadBalancerImpl(inner1, this.manager()));
    }

    public PagedIterable<LoadBalancer> listByParent(String resourceUri, Context context) {
        PagedIterable<LoadBalancerInner> inner = this.serviceClient().listByParent(resourceUri, context);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new LoadBalancerImpl(inner1, this.manager()));
    }
    ...
    public void delete(String resourceUri, String loadBalancerName, Context context) {
        this.serviceClient().delete(resourceUri, loadBalancerName, context);
    }
    ...
    public void deleteById(String id) {
        ...
        this.delete(resourceUri, loadBalancerName, Context.NONE);
    }
    ...
    public void deleteByIdWithResponse(String id, Context context) {
        ...
        this.delete(resourceUri, loadBalancerName, context);
    }
