...
public final class BgpPeersClientImpl implements BgpPeersClient {
    ...
    /**
     * The interface defining all the services for MicrosoftKubernetesRuntimeBgpPeers to be used by the proxy service
    ...
    public interface BgpPeersService {
        ...
        Mono<Response<BgpPeerListResult>> list(@HostParam("$host") String endpoint,
