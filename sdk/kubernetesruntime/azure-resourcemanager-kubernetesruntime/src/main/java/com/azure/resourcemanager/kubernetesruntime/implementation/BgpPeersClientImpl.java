...
public final class BgpPeersClientImpl implements BgpPeersClient {
    ...
    public interface BgpPeersService {
        ...
        Mono<Response<BgpPeerListResult>> listByParent(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<BgpPeerInner>> get(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<BgpPeerListResult>> listByParentNext(
    ...
    private Mono<PagedResponse<BgpPeerInner>> listByParentSinglePageAsync(String resourceUri) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<BgpPeerInner>> listByParentSinglePageAsync(String resourceUri, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    private PagedFlux<BgpPeerInner> listByParentAsync(String resourceUri) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<BgpPeerInner> listByParentAsync(String resourceUri, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<BgpPeerInner> listByParent(String resourceUri) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<BgpPeerInner> listByParent(String resourceUri, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> deleteWithResponseAsync(String resourceUri, String bgpPeerName) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<Void>, Void> beginDeleteAsync(String resourceUri, String bgpPeerName) {
        Mono<Response<Flux<ByteBuffer>>> mono = deleteWithResponseAsync(resourceUri, bgpPeerName);
    ...
    private PollerFlux<PollResult<Void>, Void> beginDeleteAsync(String resourceUri, String bgpPeerName,
        Context context) {
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono = deleteWithResponseAsync(resourceUri, bgpPeerName, context);
        return this.client.<Void, Void>getLroResult(mono, this.client.getHttpPipeline(), Void.class, Void.class,
            context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceUri, String bgpPeerName) {
        return this.beginDeleteAsync(resourceUri, bgpPeerName).getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceUri, String bgpPeerName, Context context) {
        return this.beginDeleteAsync(resourceUri, bgpPeerName, context).getSyncPoller();
    }
    ...
    private Mono<Void> deleteAsync(String resourceUri, String bgpPeerName) {
        return beginDeleteAsync(resourceUri, bgpPeerName).last().flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> deleteAsync(String resourceUri, String bgpPeerName, Context context) {
        return beginDeleteAsync(resourceUri, bgpPeerName, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    public void delete(String resourceUri, String bgpPeerName) {
        deleteAsync(resourceUri, bgpPeerName).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public void delete(String resourceUri, String bgpPeerName, Context context) {
        deleteAsync(resourceUri, bgpPeerName, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<BgpPeerInner>> listByParentNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<BgpPeerInner>> listByParentNextSinglePageAsync(String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        if (this.client.getEndpoint() == null) {
