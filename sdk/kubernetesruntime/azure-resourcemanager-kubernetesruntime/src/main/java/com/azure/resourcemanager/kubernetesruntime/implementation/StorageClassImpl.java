...
public final class StorageClassImpl implements StorageClass {
    ...
    public PagedIterable<StorageClassResource> listByParent(String resourceUri) {
        PagedIterable<StorageClassResourceInner> inner = this.serviceClient().listByParent(resourceUri);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new StorageClassResourceImpl(inner1, this.manager()));
    }

    public PagedIterable<StorageClassResource> listByParent(String resourceUri, Context context) {
        PagedIterable<StorageClassResourceInner> inner = this.serviceClient().listByParent(resourceUri, context);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new StorageClassResourceImpl(inner1, this.manager()));
    }
