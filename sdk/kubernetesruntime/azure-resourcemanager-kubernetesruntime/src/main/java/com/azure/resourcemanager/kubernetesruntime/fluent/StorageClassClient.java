...
public interface StorageClassClient {
    ...
    PagedIterable<StorageClassResourceInner> listByParent(String resourceUri);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<StorageClassResourceInner> listByParent(String resourceUri, Context context);
