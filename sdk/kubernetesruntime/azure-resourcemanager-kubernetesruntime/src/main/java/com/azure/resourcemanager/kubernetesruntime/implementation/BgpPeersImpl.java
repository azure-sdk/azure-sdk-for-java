...
public final class BgpPeersImpl implements BgpPeers {
    ...
    public PagedIterable<BgpPeer> listByParent(String resourceUri) {
        PagedIterable<BgpPeerInner> inner = this.serviceClient().listByParent(resourceUri);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new BgpPeerImpl(inner1, this.manager()));
    }

    public PagedIterable<BgpPeer> listByParent(String resourceUri, Context context) {
        PagedIterable<BgpPeerInner> inner = this.serviceClient().listByParent(resourceUri, context);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new BgpPeerImpl(inner1, this.manager()));
    }
    ...
    public void delete(String resourceUri, String bgpPeerName, Context context) {
        this.serviceClient().delete(resourceUri, bgpPeerName, context);
    }
    ...
    public void deleteById(String id) {
        ...
        this.delete(resourceUri, bgpPeerName, Context.NONE);
    }
    ...
    public void deleteByIdWithResponse(String id, Context context) {
        ...
        this.delete(resourceUri, bgpPeerName, context);
    }
