...
public final class StorageClassClientImpl implements StorageClassClient {
     ...
     */
    StorageClassClientImpl(MicrosoftKubernetesRuntimeImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for MicrosoftKubernetesRuntimeStorageClass to be used by the proxy
    ...
    public interface StorageClassService {
        ...
        Mono<Response<StorageClassResourceListResult>> listByParent(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<StorageClassResourceInner>> get(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
        ...
        Mono<Response<Flux<ByteBuffer>>> createOrUpdate(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam(value = "resourceUri", encoded = true) String resourceUri,
            @PathParam("storageClassName") String storageClassName,
            @BodyParam("application/json") StorageClassResourceInner resource, @HeaderParam("Accept") String accept,
            Context context);
        ...
        Mono<Response<Flux<ByteBuffer>>> update(@HostParam("$host") String endpoint,
            ...
            @PathParam(value = "resourceUri", encoded = true) String resourceUri,
            @PathParam("storageClassName") String storageClassName,
            @BodyParam("application/json") StorageClassResourceUpdate properties, @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<StorageClassResourceListResult>> listByParentNext(
    ...
    private Mono<PagedResponse<StorageClassResourceInner>> listByParentSinglePageAsync(String resourceUri) {
    ...
    private PagedFlux<StorageClassResourceInner> listByParentAsync(String resourceUri) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<StorageClassResourceInner> listByParentAsync(String resourceUri, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<StorageClassResourceInner> listByParent(String resourceUri) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<StorageClassResourceInner> listByParent(String resourceUri, Context context) {
    ...
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String resourceUri,
        ...
        return FluxUtil
            .withContext(context -> service.createOrUpdate(this.client.getEndpoint(), this.client.getApiVersion(),
                resourceUri, storageClassName, resource, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String resourceUri,
        ...
        return service.createOrUpdate(this.client.getEndpoint(), this.client.getApiVersion(), resourceUri,
            storageClassName, resource, accept, context);
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> updateWithResponseAsync(String resourceUri, String storageClassName,
        ...
        return FluxUtil
            .withContext(context -> service.update(this.client.getEndpoint(), this.client.getApiVersion(), resourceUri,
                storageClassName, properties, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<StorageClassResourceInner>> listByParentNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
