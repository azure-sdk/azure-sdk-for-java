 ...
 */
@Fluent
public final class MacieAllowListProperties implements JsonSerializable<MacieAllowListProperties> {
    /*
     * AWS Properties
     */
    private AwsMacieAllowListProperties awsProperties;
    ...
    /**
     * Creates an instance of MacieAllowListProperties class.
     */
     ...
     */
    public AwsMacieAllowListProperties awsProperties() {
     ...
     * @return the MacieAllowListProperties object itself.
     */
    public MacieAllowListProperties withAwsProperties(AwsMacieAllowListProperties awsProperties) {
     ...
     * @return the MacieAllowListProperties object itself.
     */
    public MacieAllowListProperties withPublicCloudConnectorsResourceId(String publicCloudConnectorsResourceId) {
     ...
     * @return the MacieAllowListProperties object itself.
     */
    public MacieAllowListProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the MacieAllowListProperties object itself.
     */
    public MacieAllowListProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the MacieAllowListProperties object itself.
     */
    public MacieAllowListProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the MacieAllowListProperties object itself.
     */
    public MacieAllowListProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the MacieAllowListProperties object itself.
     */
    public MacieAllowListProperties withAwsRegion(String awsRegion) {
     ...
     * @return the MacieAllowListProperties object itself.
     */
    public MacieAllowListProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of MacieAllowListProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of MacieAllowListProperties if the JsonReader was pointing to an instance of it, or null if
     * it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the MacieAllowListProperties.
     */
    public static MacieAllowListProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            MacieAllowListProperties deserializedMacieAllowListProperties = new MacieAllowListProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedMacieAllowListProperties.awsProperties = AwsMacieAllowListProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedMacieAllowListProperties.publicCloudConnectorsResourceId = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedMacieAllowListProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedMacieAllowListProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedMacieAllowListProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedMacieAllowListProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedMacieAllowListProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedMacieAllowListProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedMacieAllowListProperties.provisioningState
            ...
            return deserializedMacieAllowListProperties;
        });
    }
}
