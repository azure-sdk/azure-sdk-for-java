 ...
 */
@Fluent
public final class SsmInstanceInformationProperties implements JsonSerializable<SsmInstanceInformationProperties> {
    /*
     * AWS Properties
     */
    private AwsSsmInstanceInformationProperties awsProperties;
    ...
    /**
     * Creates an instance of SsmInstanceInformationProperties class.
     */
    public SsmInstanceInformationProperties() {
    }
     ...
     */
    public AwsSsmInstanceInformationProperties awsProperties() {
     ...
     * @return the SsmInstanceInformationProperties object itself.
     */
    public SsmInstanceInformationProperties withAwsProperties(AwsSsmInstanceInformationProperties awsProperties) {
     ...
     * @return the SsmInstanceInformationProperties object itself.
     */
    public SsmInstanceInformationProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the SsmInstanceInformationProperties object itself.
     */
    public SsmInstanceInformationProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the SsmInstanceInformationProperties object itself.
     */
    public SsmInstanceInformationProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the SsmInstanceInformationProperties object itself.
     */
    public SsmInstanceInformationProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the SsmInstanceInformationProperties object itself.
     */
    public SsmInstanceInformationProperties withAwsRegion(String awsRegion) {
     ...
     * @return the SsmInstanceInformationProperties object itself.
     */
    public SsmInstanceInformationProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of SsmInstanceInformationProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of SsmInstanceInformationProperties if the JsonReader was pointing to an instance of it, or
     * null if it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the SsmInstanceInformationProperties.
     */
    public static SsmInstanceInformationProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            SsmInstanceInformationProperties deserializedSsmInstanceInformationProperties
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("awsProperties".equals(fieldName)) {
                    deserializedSsmInstanceInformationProperties.awsProperties
                        = AwsSsmInstanceInformationProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedSsmInstanceInformationProperties.publicCloudConnectorsResourceId = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedSsmInstanceInformationProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedSsmInstanceInformationProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedSsmInstanceInformationProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedSsmInstanceInformationProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedSsmInstanceInformationProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedSsmInstanceInformationProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedSsmInstanceInformationProperties.provisioningState
            ...
            return deserializedSsmInstanceInformationProperties;
        });
    }
}
