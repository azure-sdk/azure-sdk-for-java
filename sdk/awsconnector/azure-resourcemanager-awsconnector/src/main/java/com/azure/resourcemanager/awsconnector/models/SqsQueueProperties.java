 ...
 */
@Fluent
public final class SqsQueueProperties implements JsonSerializable<SqsQueueProperties> {
    /*
     * AWS Properties
     */
    private AwsSqsQueueProperties awsProperties;
    ...
    /**
     * Creates an instance of SqsQueueProperties class.
     */
     ...
     */
    public AwsSqsQueueProperties awsProperties() {
     ...
     * @return the SqsQueueProperties object itself.
     */
    public SqsQueueProperties withAwsProperties(AwsSqsQueueProperties awsProperties) {
     ...
     * @return the SqsQueueProperties object itself.
     */
    public SqsQueueProperties withPublicCloudConnectorsResourceId(String publicCloudConnectorsResourceId) {
     ...
     * @return the SqsQueueProperties object itself.
     */
    public SqsQueueProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the SqsQueueProperties object itself.
     */
    public SqsQueueProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the SqsQueueProperties object itself.
     */
    public SqsQueueProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the SqsQueueProperties object itself.
     */
    public SqsQueueProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the SqsQueueProperties object itself.
     */
    public SqsQueueProperties withAwsRegion(String awsRegion) {
     ...
     * @return the SqsQueueProperties object itself.
     */
    public SqsQueueProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of SqsQueueProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of SqsQueueProperties if the JsonReader was pointing to an instance of it, or null if it was
     * pointing to JSON null.
     * @throws IOException If an error occurs while reading the SqsQueueProperties.
     */
    public static SqsQueueProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            SqsQueueProperties deserializedSqsQueueProperties = new SqsQueueProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedSqsQueueProperties.awsProperties = AwsSqsQueueProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedSqsQueueProperties.publicCloudConnectorsResourceId = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedSqsQueueProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedSqsQueueProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedSqsQueueProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedSqsQueueProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedSqsQueueProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedSqsQueueProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedSqsQueueProperties.provisioningState = ProvisioningState.fromString(reader.getString());
                } else {
                    reader.skipChildren();
                }
            }

            return deserializedSqsQueueProperties;
        });
    }
}
