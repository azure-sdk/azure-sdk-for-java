 ...
 */
@Fluent
public final class IamInstanceProfileProperties implements JsonSerializable<IamInstanceProfileProperties> {
    /*
     * AWS Properties
     */
    private AwsIamInstanceProfileProperties awsProperties;
    ...
    /**
     * Creates an instance of IamInstanceProfileProperties class.
     */
     ...
     */
    public AwsIamInstanceProfileProperties awsProperties() {
     ...
     * @return the IamInstanceProfileProperties object itself.
     */
    public IamInstanceProfileProperties withAwsProperties(AwsIamInstanceProfileProperties awsProperties) {
     ...
     * @return the IamInstanceProfileProperties object itself.
     */
    public IamInstanceProfileProperties withPublicCloudConnectorsResourceId(String publicCloudConnectorsResourceId) {
     ...
     * @return the IamInstanceProfileProperties object itself.
     */
    public IamInstanceProfileProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the IamInstanceProfileProperties object itself.
     */
    public IamInstanceProfileProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the IamInstanceProfileProperties object itself.
     */
    public IamInstanceProfileProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the IamInstanceProfileProperties object itself.
     */
    public IamInstanceProfileProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the IamInstanceProfileProperties object itself.
     */
    public IamInstanceProfileProperties withAwsRegion(String awsRegion) {
     ...
     * @return the IamInstanceProfileProperties object itself.
     */
    public IamInstanceProfileProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of IamInstanceProfileProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of IamInstanceProfileProperties if the JsonReader was pointing to an instance of it, or null
     * if it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the IamInstanceProfileProperties.
     */
    public static IamInstanceProfileProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            IamInstanceProfileProperties deserializedIamInstanceProfileProperties = new IamInstanceProfileProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedIamInstanceProfileProperties.awsProperties
                        = AwsIamInstanceProfileProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedIamInstanceProfileProperties.publicCloudConnectorsResourceId = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedIamInstanceProfileProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedIamInstanceProfileProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedIamInstanceProfileProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedIamInstanceProfileProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedIamInstanceProfileProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedIamInstanceProfileProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedIamInstanceProfileProperties.provisioningState
            ...
            return deserializedIamInstanceProfileProperties;
        });
    }
}
