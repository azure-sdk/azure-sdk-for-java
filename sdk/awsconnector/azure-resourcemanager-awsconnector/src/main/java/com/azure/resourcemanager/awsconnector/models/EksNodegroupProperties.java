 ...
 */
@Fluent
public final class EksNodegroupProperties implements JsonSerializable<EksNodegroupProperties> {
    /*
     * AWS Properties
     */
    private AwsEksNodegroupProperties awsProperties;
    ...
    /**
     * Creates an instance of EksNodegroupProperties class.
     */
    public EksNodegroupProperties() {
    }
     ...
     */
    public AwsEksNodegroupProperties awsProperties() {
     ...
     * @return the EksNodegroupProperties object itself.
     */
    public EksNodegroupProperties withAwsProperties(AwsEksNodegroupProperties awsProperties) {
     ...
     * @return the EksNodegroupProperties object itself.
     */
    public EksNodegroupProperties withPublicCloudConnectorsResourceId(String publicCloudConnectorsResourceId) {
     ...
     * @return the EksNodegroupProperties object itself.
     */
    public EksNodegroupProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the EksNodegroupProperties object itself.
     */
    public EksNodegroupProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the EksNodegroupProperties object itself.
     */
    public EksNodegroupProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the EksNodegroupProperties object itself.
     */
    public EksNodegroupProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the EksNodegroupProperties object itself.
     */
    public EksNodegroupProperties withAwsRegion(String awsRegion) {
     ...
     * @return the EksNodegroupProperties object itself.
     */
    public EksNodegroupProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of EksNodegroupProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of EksNodegroupProperties if the JsonReader was pointing to an instance of it, or null if it
     * was pointing to JSON null.
     * @throws IOException If an error occurs while reading the EksNodegroupProperties.
     */
    public static EksNodegroupProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            EksNodegroupProperties deserializedEksNodegroupProperties = new EksNodegroupProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedEksNodegroupProperties.awsProperties = AwsEksNodegroupProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedEksNodegroupProperties.publicCloudConnectorsResourceId = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedEksNodegroupProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedEksNodegroupProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedEksNodegroupProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedEksNodegroupProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedEksNodegroupProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedEksNodegroupProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedEksNodegroupProperties.provisioningState
            ...
            return deserializedEksNodegroupProperties;
        });
    }
}
