 ...
 */
@Fluent
public final class Ec2KeyPairProperties implements JsonSerializable<Ec2KeyPairProperties> {
    /*
     * AWS Properties
     */
    private AwsEc2KeyPairProperties awsProperties;
    ...
    /**
     * Creates an instance of Ec2KeyPairProperties class.
     */
     ...
     */
    public AwsEc2KeyPairProperties awsProperties() {
     ...
     * @return the Ec2KeyPairProperties object itself.
     */
    public Ec2KeyPairProperties withAwsProperties(AwsEc2KeyPairProperties awsProperties) {
     ...
     * @return the Ec2KeyPairProperties object itself.
     */
    public Ec2KeyPairProperties withPublicCloudConnectorsResourceId(String publicCloudConnectorsResourceId) {
     ...
     * @return the Ec2KeyPairProperties object itself.
     */
    public Ec2KeyPairProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the Ec2KeyPairProperties object itself.
     */
    public Ec2KeyPairProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the Ec2KeyPairProperties object itself.
     */
    public Ec2KeyPairProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the Ec2KeyPairProperties object itself.
     */
    public Ec2KeyPairProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the Ec2KeyPairProperties object itself.
     */
    public Ec2KeyPairProperties withAwsRegion(String awsRegion) {
     ...
     * @return the Ec2KeyPairProperties object itself.
     */
    public Ec2KeyPairProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of Ec2KeyPairProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of Ec2KeyPairProperties if the JsonReader was pointing to an instance of it, or null if it
     * was pointing to JSON null.
     * @throws IOException If an error occurs while reading the Ec2KeyPairProperties.
     */
    public static Ec2KeyPairProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            Ec2KeyPairProperties deserializedEc2KeyPairProperties = new Ec2KeyPairProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedEc2KeyPairProperties.awsProperties = AwsEc2KeyPairProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedEc2KeyPairProperties.publicCloudConnectorsResourceId = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedEc2KeyPairProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedEc2KeyPairProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedEc2KeyPairProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedEc2KeyPairProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedEc2KeyPairProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedEc2KeyPairProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedEc2KeyPairProperties.provisioningState
            ...
            return deserializedEc2KeyPairProperties;
        });
    }
}
