...
public final class JobType extends ExpandableStringEnum<JobType> {
    /**
     * Static value ONE_TIME for JobType.
     */
    public static final JobType ONE_TIME = fromString("ONE_TIME");

    /**
     * Static value SCHEDULED for JobType.
     */
    public static final JobType SCHEDULED = fromString("SCHEDULED");
