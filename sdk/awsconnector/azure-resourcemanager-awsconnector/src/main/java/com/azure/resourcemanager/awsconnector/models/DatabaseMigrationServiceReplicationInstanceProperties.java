 ...
 */
@Fluent
public final class DatabaseMigrationServiceReplicationInstanceProperties
    implements JsonSerializable<DatabaseMigrationServiceReplicationInstanceProperties> {
    /*
     * AWS Properties
     */
    private AwsDatabaseMigrationServiceReplicationInstanceProperties awsProperties;
    ...
    /**
     * Creates an instance of DatabaseMigrationServiceReplicationInstanceProperties class.
     */
    public DatabaseMigrationServiceReplicationInstanceProperties() {
    }
     ...
     */
    public AwsDatabaseMigrationServiceReplicationInstanceProperties awsProperties() {
     ...
     * @return the DatabaseMigrationServiceReplicationInstanceProperties object itself.
     */
    public DatabaseMigrationServiceReplicationInstanceProperties
        withAwsProperties(AwsDatabaseMigrationServiceReplicationInstanceProperties awsProperties) {
     ...
     * @return the DatabaseMigrationServiceReplicationInstanceProperties object itself.
     */
    public DatabaseMigrationServiceReplicationInstanceProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the DatabaseMigrationServiceReplicationInstanceProperties object itself.
     */
    public DatabaseMigrationServiceReplicationInstanceProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the DatabaseMigrationServiceReplicationInstanceProperties object itself.
     */
    public DatabaseMigrationServiceReplicationInstanceProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the DatabaseMigrationServiceReplicationInstanceProperties object itself.
     */
    public DatabaseMigrationServiceReplicationInstanceProperties withAwsRegion(String awsRegion) {
     ...
     * @return the DatabaseMigrationServiceReplicationInstanceProperties object itself.
     */
    public DatabaseMigrationServiceReplicationInstanceProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of DatabaseMigrationServiceReplicationInstanceProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of DatabaseMigrationServiceReplicationInstanceProperties if the JsonReader was pointing to an
     * instance of it, or null if it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the DatabaseMigrationServiceReplicationInstanceProperties.
     */
    public static DatabaseMigrationServiceReplicationInstanceProperties fromJson(JsonReader jsonReader)
        throws IOException {
        return jsonReader.readObject(reader -> {
            DatabaseMigrationServiceReplicationInstanceProperties deserializedDatabaseMigrationServiceReplicationInstanceProperties
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("awsProperties".equals(fieldName)) {
                    deserializedDatabaseMigrationServiceReplicationInstanceProperties.awsProperties
                        = AwsDatabaseMigrationServiceReplicationInstanceProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedDatabaseMigrationServiceReplicationInstanceProperties.publicCloudConnectorsResourceId
                        = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedDatabaseMigrationServiceReplicationInstanceProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedDatabaseMigrationServiceReplicationInstanceProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedDatabaseMigrationServiceReplicationInstanceProperties.publicCloudResourceName
                        = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedDatabaseMigrationServiceReplicationInstanceProperties.awsSourceSchema
                        = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedDatabaseMigrationServiceReplicationInstanceProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedDatabaseMigrationServiceReplicationInstanceProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedDatabaseMigrationServiceReplicationInstanceProperties.provisioningState
            ...
            return deserializedDatabaseMigrationServiceReplicationInstanceProperties;
        });
    }
}
