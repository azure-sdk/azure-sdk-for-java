 ...
 */
@Fluent
public final class AutoScalingGroupProperties implements JsonSerializable<AutoScalingGroupProperties> {
    /*
     * AWS Properties
     */
    private AwsAutoScalingGroupProperties awsProperties;
    ...
    /**
     * Creates an instance of AutoScalingGroupProperties class.
     */
    public AutoScalingGroupProperties() {
    }
     ...
     */
    public AwsAutoScalingGroupProperties awsProperties() {
     ...
     * @return the AutoScalingGroupProperties object itself.
     */
    public AutoScalingGroupProperties withAwsProperties(AwsAutoScalingGroupProperties awsProperties) {
     ...
     * @return the AutoScalingGroupProperties object itself.
     */
    public AutoScalingGroupProperties withPublicCloudConnectorsResourceId(String publicCloudConnectorsResourceId) {
     ...
     * @return the AutoScalingGroupProperties object itself.
     */
    public AutoScalingGroupProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the AutoScalingGroupProperties object itself.
     */
    public AutoScalingGroupProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the AutoScalingGroupProperties object itself.
     */
    public AutoScalingGroupProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the AutoScalingGroupProperties object itself.
     */
    public AutoScalingGroupProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the AutoScalingGroupProperties object itself.
     */
    public AutoScalingGroupProperties withAwsRegion(String awsRegion) {
     ...
     * @return the AutoScalingGroupProperties object itself.
     */
    public AutoScalingGroupProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of AutoScalingGroupProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of AutoScalingGroupProperties if the JsonReader was pointing to an instance of it, or null if
     * it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the AutoScalingGroupProperties.
     */
    public static AutoScalingGroupProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            AutoScalingGroupProperties deserializedAutoScalingGroupProperties = new AutoScalingGroupProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedAutoScalingGroupProperties.awsProperties
                        = AwsAutoScalingGroupProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedAutoScalingGroupProperties.publicCloudConnectorsResourceId = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedAutoScalingGroupProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedAutoScalingGroupProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedAutoScalingGroupProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedAutoScalingGroupProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedAutoScalingGroupProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedAutoScalingGroupProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedAutoScalingGroupProperties.provisioningState
            ...
            return deserializedAutoScalingGroupProperties;
        });
    }
}
