 ...
 */
@Fluent
public final class IamVirtualMfaDeviceProperties implements JsonSerializable<IamVirtualMfaDeviceProperties> {
    /*
     * AWS Properties
     */
    private AwsIamVirtualMfaDeviceProperties awsProperties;
    ...
    /**
     * Creates an instance of IamVirtualMfaDeviceProperties class.
     */
     ...
     */
    public AwsIamVirtualMfaDeviceProperties awsProperties() {
     ...
     * @return the IamVirtualMfaDeviceProperties object itself.
     */
    public IamVirtualMfaDeviceProperties withAwsProperties(AwsIamVirtualMfaDeviceProperties awsProperties) {
     ...
     * @return the IamVirtualMfaDeviceProperties object itself.
     */
    public IamVirtualMfaDeviceProperties withPublicCloudConnectorsResourceId(String publicCloudConnectorsResourceId) {
     ...
     * @return the IamVirtualMfaDeviceProperties object itself.
     */
    public IamVirtualMfaDeviceProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the IamVirtualMfaDeviceProperties object itself.
     */
    public IamVirtualMfaDeviceProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the IamVirtualMfaDeviceProperties object itself.
     */
    public IamVirtualMfaDeviceProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the IamVirtualMfaDeviceProperties object itself.
     */
    public IamVirtualMfaDeviceProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the IamVirtualMfaDeviceProperties object itself.
     */
    public IamVirtualMfaDeviceProperties withAwsRegion(String awsRegion) {
     ...
     * @return the IamVirtualMfaDeviceProperties object itself.
     */
    public IamVirtualMfaDeviceProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of IamVirtualMfaDeviceProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of IamVirtualMfaDeviceProperties if the JsonReader was pointing to an instance of it, or null
     * if it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the IamVirtualMfaDeviceProperties.
     */
    public static IamVirtualMfaDeviceProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            IamVirtualMfaDeviceProperties deserializedIamVirtualMfaDeviceProperties
                = new IamVirtualMfaDeviceProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedIamVirtualMfaDeviceProperties.awsProperties
                        = AwsIamVirtualMfaDeviceProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedIamVirtualMfaDeviceProperties.publicCloudConnectorsResourceId = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedIamVirtualMfaDeviceProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedIamVirtualMfaDeviceProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedIamVirtualMfaDeviceProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedIamVirtualMfaDeviceProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedIamVirtualMfaDeviceProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedIamVirtualMfaDeviceProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedIamVirtualMfaDeviceProperties.provisioningState
            ...
            return deserializedIamVirtualMfaDeviceProperties;
        });
    }
}
