...
public final class Type extends ExpandableStringEnum<Type> {
    /**
     * Static value STATEFUL for Type.
     */
    public static final Type STATEFUL = fromString("STATEFUL");

    /**
     * Static value STATELESS for Type.
     */
    public static final Type STATELESS = fromString("STATELESS");
