 ...
 */
@Fluent
public final class SageMakerNotebookInstanceSummaryProperties
    implements JsonSerializable<SageMakerNotebookInstanceSummaryProperties> {
    /*
     * AWS Properties
     */
    private AwsSageMakerNotebookInstanceSummaryProperties awsProperties;
    ...
    /**
     * Creates an instance of SageMakerNotebookInstanceSummaryProperties class.
     */
     ...
     */
    public AwsSageMakerNotebookInstanceSummaryProperties awsProperties() {
     ...
     * @return the SageMakerNotebookInstanceSummaryProperties object itself.
     */
    public SageMakerNotebookInstanceSummaryProperties
        withAwsProperties(AwsSageMakerNotebookInstanceSummaryProperties awsProperties) {
     ...
     * @return the SageMakerNotebookInstanceSummaryProperties object itself.
     */
    public SageMakerNotebookInstanceSummaryProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the SageMakerNotebookInstanceSummaryProperties object itself.
     */
    public SageMakerNotebookInstanceSummaryProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the SageMakerNotebookInstanceSummaryProperties object itself.
     */
    public SageMakerNotebookInstanceSummaryProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the SageMakerNotebookInstanceSummaryProperties object itself.
     */
    public SageMakerNotebookInstanceSummaryProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the SageMakerNotebookInstanceSummaryProperties object itself.
     */
    public SageMakerNotebookInstanceSummaryProperties withAwsRegion(String awsRegion) {
     ...
     * @return the SageMakerNotebookInstanceSummaryProperties object itself.
     */
    public SageMakerNotebookInstanceSummaryProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of SageMakerNotebookInstanceSummaryProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of SageMakerNotebookInstanceSummaryProperties if the JsonReader was pointing to an instance
     * of it, or null if it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the SageMakerNotebookInstanceSummaryProperties.
     */
    public static SageMakerNotebookInstanceSummaryProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            SageMakerNotebookInstanceSummaryProperties deserializedSageMakerNotebookInstanceSummaryProperties
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("awsProperties".equals(fieldName)) {
                    deserializedSageMakerNotebookInstanceSummaryProperties.awsProperties
                        = AwsSageMakerNotebookInstanceSummaryProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedSageMakerNotebookInstanceSummaryProperties.publicCloudConnectorsResourceId
                        = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedSageMakerNotebookInstanceSummaryProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedSageMakerNotebookInstanceSummaryProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedSageMakerNotebookInstanceSummaryProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedSageMakerNotebookInstanceSummaryProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedSageMakerNotebookInstanceSummaryProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedSageMakerNotebookInstanceSummaryProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedSageMakerNotebookInstanceSummaryProperties.provisioningState
            ...
            return deserializedSageMakerNotebookInstanceSummaryProperties;
        });
    }
}
