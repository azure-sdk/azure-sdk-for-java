 ...
 */
@Fluent
public final class Ec2VpcProperties implements JsonSerializable<Ec2VpcProperties> {
    /*
     * AWS Properties
     */
    private AwsEc2VpcProperties awsProperties;
    ...
    /**
     * Creates an instance of Ec2VpcProperties class.
     */
     ...
     */
    public AwsEc2VpcProperties awsProperties() {
     ...
     * @return the Ec2VpcProperties object itself.
     */
    public Ec2VpcProperties withAwsProperties(AwsEc2VpcProperties awsProperties) {
     ...
     * @return the Ec2VpcProperties object itself.
     */
    public Ec2VpcProperties withPublicCloudConnectorsResourceId(String publicCloudConnectorsResourceId) {
     ...
     * @return the Ec2VpcProperties object itself.
     */
    public Ec2VpcProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the Ec2VpcProperties object itself.
     */
    public Ec2VpcProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the Ec2VpcProperties object itself.
     */
    public Ec2VpcProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the Ec2VpcProperties object itself.
     */
    public Ec2VpcProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the Ec2VpcProperties object itself.
     */
    public Ec2VpcProperties withAwsRegion(String awsRegion) {
     ...
     * @return the Ec2VpcProperties object itself.
     */
    public Ec2VpcProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of Ec2VpcProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of Ec2VpcProperties if the JsonReader was pointing to an instance of it, or null if it was
     * pointing to JSON null.
     * @throws IOException If an error occurs while reading the Ec2VpcProperties.
     */
    public static Ec2VpcProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            Ec2VpcProperties deserializedEc2VpcProperties = new Ec2VpcProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedEc2VpcProperties.awsProperties = AwsEc2VpcProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedEc2VpcProperties.publicCloudConnectorsResourceId = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedEc2VpcProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedEc2VpcProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedEc2VpcProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedEc2VpcProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedEc2VpcProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedEc2VpcProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedEc2VpcProperties.provisioningState = ProvisioningState.fromString(reader.getString());
                } else {
                    reader.skipChildren();
                }
            }

            return deserializedEc2VpcProperties;
        });
    }
}
