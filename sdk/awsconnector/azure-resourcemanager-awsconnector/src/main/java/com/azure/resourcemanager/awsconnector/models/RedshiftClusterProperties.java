 ...
 */
@Fluent
public final class RedshiftClusterProperties implements JsonSerializable<RedshiftClusterProperties> {
    /*
     * AWS Properties
     */
    private AwsRedshiftClusterProperties awsProperties;
    ...
    /**
     * Creates an instance of RedshiftClusterProperties class.
     */
    public RedshiftClusterProperties() {
    }
     ...
     */
    public AwsRedshiftClusterProperties awsProperties() {
     ...
     * @return the RedshiftClusterProperties object itself.
     */
    public RedshiftClusterProperties withAwsProperties(AwsRedshiftClusterProperties awsProperties) {
     ...
     * @return the RedshiftClusterProperties object itself.
     */
    public RedshiftClusterProperties withPublicCloudConnectorsResourceId(String publicCloudConnectorsResourceId) {
     ...
     * @return the RedshiftClusterProperties object itself.
     */
    public RedshiftClusterProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the RedshiftClusterProperties object itself.
     */
    public RedshiftClusterProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the RedshiftClusterProperties object itself.
     */
    public RedshiftClusterProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the RedshiftClusterProperties object itself.
     */
    public RedshiftClusterProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the RedshiftClusterProperties object itself.
     */
    public RedshiftClusterProperties withAwsRegion(String awsRegion) {
     ...
     * @return the RedshiftClusterProperties object itself.
     */
    public RedshiftClusterProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of RedshiftClusterProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of RedshiftClusterProperties if the JsonReader was pointing to an instance of it, or null if
     * it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the RedshiftClusterProperties.
     */
    public static RedshiftClusterProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            RedshiftClusterProperties deserializedRedshiftClusterProperties = new RedshiftClusterProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedRedshiftClusterProperties.awsProperties = AwsRedshiftClusterProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedRedshiftClusterProperties.publicCloudConnectorsResourceId = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedRedshiftClusterProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedRedshiftClusterProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedRedshiftClusterProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedRedshiftClusterProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedRedshiftClusterProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedRedshiftClusterProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedRedshiftClusterProperties.provisioningState
            ...
            return deserializedRedshiftClusterProperties;
        });
    }
}
