 ...
 */
@Fluent
public final class LambdaFunctionProperties implements JsonSerializable<LambdaFunctionProperties> {
    /*
     * AWS Properties
     */
    private AwsLambdaFunctionProperties awsProperties;
    ...
    /**
     * Creates an instance of LambdaFunctionProperties class.
     */
    public LambdaFunctionProperties() {
    }
     ...
     */
    public AwsLambdaFunctionProperties awsProperties() {
     ...
     * @return the LambdaFunctionProperties object itself.
     */
    public LambdaFunctionProperties withAwsProperties(AwsLambdaFunctionProperties awsProperties) {
     ...
     * @return the LambdaFunctionProperties object itself.
     */
    public LambdaFunctionProperties withPublicCloudConnectorsResourceId(String publicCloudConnectorsResourceId) {
     ...
     * @return the LambdaFunctionProperties object itself.
     */
    public LambdaFunctionProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the LambdaFunctionProperties object itself.
     */
    public LambdaFunctionProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the LambdaFunctionProperties object itself.
     */
    public LambdaFunctionProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the LambdaFunctionProperties object itself.
     */
    public LambdaFunctionProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the LambdaFunctionProperties object itself.
     */
    public LambdaFunctionProperties withAwsRegion(String awsRegion) {
     ...
     * @return the LambdaFunctionProperties object itself.
     */
    public LambdaFunctionProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of LambdaFunctionProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of LambdaFunctionProperties if the JsonReader was pointing to an instance of it, or null if
     * it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the LambdaFunctionProperties.
     */
    public static LambdaFunctionProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            LambdaFunctionProperties deserializedLambdaFunctionProperties = new LambdaFunctionProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedLambdaFunctionProperties.awsProperties = AwsLambdaFunctionProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedLambdaFunctionProperties.publicCloudConnectorsResourceId = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedLambdaFunctionProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedLambdaFunctionProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedLambdaFunctionProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedLambdaFunctionProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedLambdaFunctionProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedLambdaFunctionProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedLambdaFunctionProperties.provisioningState
            ...
            return deserializedLambdaFunctionProperties;
        });
    }
}
