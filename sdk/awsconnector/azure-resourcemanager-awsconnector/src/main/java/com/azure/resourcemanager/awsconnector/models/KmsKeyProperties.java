 ...
 */
@Fluent
public final class KmsKeyProperties implements JsonSerializable<KmsKeyProperties> {
    /*
     * AWS Properties
     */
    private AwsKmsKeyProperties awsProperties;
    ...
    /**
     * Creates an instance of KmsKeyProperties class.
     */
     ...
     */
    public AwsKmsKeyProperties awsProperties() {
     ...
     * @return the KmsKeyProperties object itself.
     */
    public KmsKeyProperties withAwsProperties(AwsKmsKeyProperties awsProperties) {
     ...
     * @return the KmsKeyProperties object itself.
     */
    public KmsKeyProperties withPublicCloudConnectorsResourceId(String publicCloudConnectorsResourceId) {
     ...
     * @return the KmsKeyProperties object itself.
     */
    public KmsKeyProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the KmsKeyProperties object itself.
     */
    public KmsKeyProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the KmsKeyProperties object itself.
     */
    public KmsKeyProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the KmsKeyProperties object itself.
     */
    public KmsKeyProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the KmsKeyProperties object itself.
     */
    public KmsKeyProperties withAwsRegion(String awsRegion) {
     ...
     * @return the KmsKeyProperties object itself.
     */
    public KmsKeyProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of KmsKeyProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of KmsKeyProperties if the JsonReader was pointing to an instance of it, or null if it was
     * pointing to JSON null.
     * @throws IOException If an error occurs while reading the KmsKeyProperties.
     */
    public static KmsKeyProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            KmsKeyProperties deserializedKmsKeyProperties = new KmsKeyProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedKmsKeyProperties.awsProperties = AwsKmsKeyProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedKmsKeyProperties.publicCloudConnectorsResourceId = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedKmsKeyProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedKmsKeyProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedKmsKeyProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedKmsKeyProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedKmsKeyProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedKmsKeyProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedKmsKeyProperties.provisioningState = ProvisioningState.fromString(reader.getString());
                } else {
                    reader.skipChildren();
                }
            }

            return deserializedKmsKeyProperties;
        });
    }
}
