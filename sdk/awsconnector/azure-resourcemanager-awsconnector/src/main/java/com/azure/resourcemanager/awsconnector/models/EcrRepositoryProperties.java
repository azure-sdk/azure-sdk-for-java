 ...
 */
@Fluent
public final class EcrRepositoryProperties implements JsonSerializable<EcrRepositoryProperties> {
    /*
     * AWS Properties
     */
    private AwsEcrRepositoryProperties awsProperties;
    ...
    /**
     * Creates an instance of EcrRepositoryProperties class.
     */
     ...
     */
    public AwsEcrRepositoryProperties awsProperties() {
     ...
     * @return the EcrRepositoryProperties object itself.
     */
    public EcrRepositoryProperties withAwsProperties(AwsEcrRepositoryProperties awsProperties) {
     ...
     * @return the EcrRepositoryProperties object itself.
     */
    public EcrRepositoryProperties withPublicCloudConnectorsResourceId(String publicCloudConnectorsResourceId) {
     ...
     * @return the EcrRepositoryProperties object itself.
     */
    public EcrRepositoryProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the EcrRepositoryProperties object itself.
     */
    public EcrRepositoryProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the EcrRepositoryProperties object itself.
     */
    public EcrRepositoryProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the EcrRepositoryProperties object itself.
     */
    public EcrRepositoryProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the EcrRepositoryProperties object itself.
     */
    public EcrRepositoryProperties withAwsRegion(String awsRegion) {
     ...
     * @return the EcrRepositoryProperties object itself.
     */
    public EcrRepositoryProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of EcrRepositoryProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of EcrRepositoryProperties if the JsonReader was pointing to an instance of it, or null if it
     * was pointing to JSON null.
     * @throws IOException If an error occurs while reading the EcrRepositoryProperties.
     */
    public static EcrRepositoryProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            EcrRepositoryProperties deserializedEcrRepositoryProperties = new EcrRepositoryProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedEcrRepositoryProperties.awsProperties = AwsEcrRepositoryProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedEcrRepositoryProperties.publicCloudConnectorsResourceId = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedEcrRepositoryProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedEcrRepositoryProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedEcrRepositoryProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedEcrRepositoryProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedEcrRepositoryProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedEcrRepositoryProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedEcrRepositoryProperties.provisioningState
            ...
            return deserializedEcrRepositoryProperties;
        });
    }
}
