 ...
 */
@Fluent
public final class RdsDBClusterProperties implements JsonSerializable<RdsDBClusterProperties> {
    /*
     * AWS Properties
     */
    private AwsRdsDBClusterProperties awsProperties;
    ...
    /**
     * Creates an instance of RdsDBClusterProperties class.
     */
    public RdsDBClusterProperties() {
    }
     ...
     */
    public AwsRdsDBClusterProperties awsProperties() {
     ...
     * @return the RdsDBClusterProperties object itself.
     */
    public RdsDBClusterProperties withAwsProperties(AwsRdsDBClusterProperties awsProperties) {
     ...
     * @return the RdsDBClusterProperties object itself.
     */
    public RdsDBClusterProperties withPublicCloudConnectorsResourceId(String publicCloudConnectorsResourceId) {
     ...
     * @return the RdsDBClusterProperties object itself.
     */
    public RdsDBClusterProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the RdsDBClusterProperties object itself.
     */
    public RdsDBClusterProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the RdsDBClusterProperties object itself.
     */
    public RdsDBClusterProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the RdsDBClusterProperties object itself.
     */
    public RdsDBClusterProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the RdsDBClusterProperties object itself.
     */
    public RdsDBClusterProperties withAwsRegion(String awsRegion) {
     ...
     * @return the RdsDBClusterProperties object itself.
     */
    public RdsDBClusterProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of RdsDBClusterProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of RdsDBClusterProperties if the JsonReader was pointing to an instance of it, or null if it
     * was pointing to JSON null.
     * @throws IOException If an error occurs while reading the RdsDBClusterProperties.
     */
    public static RdsDBClusterProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            RdsDBClusterProperties deserializedRdsDBClusterProperties = new RdsDBClusterProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedRdsDBClusterProperties.awsProperties = AwsRdsDBClusterProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedRdsDBClusterProperties.publicCloudConnectorsResourceId = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedRdsDBClusterProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedRdsDBClusterProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedRdsDBClusterProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedRdsDBClusterProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedRdsDBClusterProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedRdsDBClusterProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedRdsDBClusterProperties.provisioningState
            ...
            return deserializedRdsDBClusterProperties;
        });
    }
}
