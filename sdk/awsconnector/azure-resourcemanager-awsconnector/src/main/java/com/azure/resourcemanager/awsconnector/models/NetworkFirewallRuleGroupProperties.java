 ...
 */
@Fluent
public final class NetworkFirewallRuleGroupProperties implements JsonSerializable<NetworkFirewallRuleGroupProperties> {
    /*
     * AWS Properties
     */
    private AwsNetworkFirewallRuleGroupProperties awsProperties;
    ...
    /**
     * Creates an instance of NetworkFirewallRuleGroupProperties class.
     */
     ...
     */
    public AwsNetworkFirewallRuleGroupProperties awsProperties() {
     ...
     * @return the NetworkFirewallRuleGroupProperties object itself.
     */
    public NetworkFirewallRuleGroupProperties withAwsProperties(AwsNetworkFirewallRuleGroupProperties awsProperties) {
     ...
     * @return the NetworkFirewallRuleGroupProperties object itself.
     */
    public NetworkFirewallRuleGroupProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the NetworkFirewallRuleGroupProperties object itself.
     */
    public NetworkFirewallRuleGroupProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the NetworkFirewallRuleGroupProperties object itself.
     */
    public NetworkFirewallRuleGroupProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the NetworkFirewallRuleGroupProperties object itself.
     */
    public NetworkFirewallRuleGroupProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the NetworkFirewallRuleGroupProperties object itself.
     */
    public NetworkFirewallRuleGroupProperties withAwsRegion(String awsRegion) {
     ...
     * @return the NetworkFirewallRuleGroupProperties object itself.
     */
    public NetworkFirewallRuleGroupProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of NetworkFirewallRuleGroupProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of NetworkFirewallRuleGroupProperties if the JsonReader was pointing to an instance of it, or
     * null if it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the NetworkFirewallRuleGroupProperties.
     */
    public static NetworkFirewallRuleGroupProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            NetworkFirewallRuleGroupProperties deserializedNetworkFirewallRuleGroupProperties
                = new NetworkFirewallRuleGroupProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedNetworkFirewallRuleGroupProperties.awsProperties
                        = AwsNetworkFirewallRuleGroupProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedNetworkFirewallRuleGroupProperties.publicCloudConnectorsResourceId = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedNetworkFirewallRuleGroupProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedNetworkFirewallRuleGroupProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedNetworkFirewallRuleGroupProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedNetworkFirewallRuleGroupProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedNetworkFirewallRuleGroupProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedNetworkFirewallRuleGroupProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedNetworkFirewallRuleGroupProperties.provisioningState
            ...
            return deserializedNetworkFirewallRuleGroupProperties;
        });
    }
}
