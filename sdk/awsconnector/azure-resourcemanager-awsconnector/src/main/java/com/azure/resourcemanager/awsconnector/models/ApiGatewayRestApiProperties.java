 ...
 */
@Fluent
public final class ApiGatewayRestApiProperties implements JsonSerializable<ApiGatewayRestApiProperties> {
    /*
     * AWS Properties
     */
    private AwsApiGatewayRestApiProperties awsProperties;
    ...
    /**
     * Creates an instance of ApiGatewayRestApiProperties class.
     */
     ...
     */
    public AwsApiGatewayRestApiProperties awsProperties() {
     ...
     * @return the ApiGatewayRestApiProperties object itself.
     */
    public ApiGatewayRestApiProperties withAwsProperties(AwsApiGatewayRestApiProperties awsProperties) {
     ...
     * @return the ApiGatewayRestApiProperties object itself.
     */
    public ApiGatewayRestApiProperties withPublicCloudConnectorsResourceId(String publicCloudConnectorsResourceId) {
     ...
     * @return the ApiGatewayRestApiProperties object itself.
     */
    public ApiGatewayRestApiProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the ApiGatewayRestApiProperties object itself.
     */
    public ApiGatewayRestApiProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the ApiGatewayRestApiProperties object itself.
     */
    public ApiGatewayRestApiProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the ApiGatewayRestApiProperties object itself.
     */
    public ApiGatewayRestApiProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the ApiGatewayRestApiProperties object itself.
     */
    public ApiGatewayRestApiProperties withAwsRegion(String awsRegion) {
     ...
     * @return the ApiGatewayRestApiProperties object itself.
     */
    public ApiGatewayRestApiProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of ApiGatewayRestApiProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of ApiGatewayRestApiProperties if the JsonReader was pointing to an instance of it, or null
     * if it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the ApiGatewayRestApiProperties.
     */
    public static ApiGatewayRestApiProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ApiGatewayRestApiProperties deserializedApiGatewayRestApiProperties = new ApiGatewayRestApiProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedApiGatewayRestApiProperties.awsProperties
                        = AwsApiGatewayRestApiProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedApiGatewayRestApiProperties.publicCloudConnectorsResourceId = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedApiGatewayRestApiProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedApiGatewayRestApiProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedApiGatewayRestApiProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedApiGatewayRestApiProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedApiGatewayRestApiProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedApiGatewayRestApiProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedApiGatewayRestApiProperties.provisioningState
            ...
            return deserializedApiGatewayRestApiProperties;
        });
    }
}
