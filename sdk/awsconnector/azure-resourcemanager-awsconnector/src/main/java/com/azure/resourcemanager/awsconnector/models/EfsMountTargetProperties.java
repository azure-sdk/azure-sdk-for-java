 ...
 */
@Fluent
public final class EfsMountTargetProperties implements JsonSerializable<EfsMountTargetProperties> {
    /*
     * AWS Properties
     */
    private AwsEfsMountTargetProperties awsProperties;
    ...
    /**
     * Creates an instance of EfsMountTargetProperties class.
     */
    public EfsMountTargetProperties() {
    }
     ...
     */
    public AwsEfsMountTargetProperties awsProperties() {
     ...
     * @return the EfsMountTargetProperties object itself.
     */
    public EfsMountTargetProperties withAwsProperties(AwsEfsMountTargetProperties awsProperties) {
     ...
     * @return the EfsMountTargetProperties object itself.
     */
    public EfsMountTargetProperties withPublicCloudConnectorsResourceId(String publicCloudConnectorsResourceId) {
     ...
     * @return the EfsMountTargetProperties object itself.
     */
    public EfsMountTargetProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the EfsMountTargetProperties object itself.
     */
    public EfsMountTargetProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the EfsMountTargetProperties object itself.
     */
    public EfsMountTargetProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the EfsMountTargetProperties object itself.
     */
    public EfsMountTargetProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the EfsMountTargetProperties object itself.
     */
    public EfsMountTargetProperties withAwsRegion(String awsRegion) {
     ...
     * @return the EfsMountTargetProperties object itself.
     */
    public EfsMountTargetProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of EfsMountTargetProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of EfsMountTargetProperties if the JsonReader was pointing to an instance of it, or null if
     * it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the EfsMountTargetProperties.
     */
    public static EfsMountTargetProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            EfsMountTargetProperties deserializedEfsMountTargetProperties = new EfsMountTargetProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedEfsMountTargetProperties.awsProperties = AwsEfsMountTargetProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedEfsMountTargetProperties.publicCloudConnectorsResourceId = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedEfsMountTargetProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedEfsMountTargetProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedEfsMountTargetProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedEfsMountTargetProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedEfsMountTargetProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedEfsMountTargetProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedEfsMountTargetProperties.provisioningState
            ...
            return deserializedEfsMountTargetProperties;
        });
    }
}
