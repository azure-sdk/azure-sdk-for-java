 ...
 */
@Fluent
public final class EcrImageDetailProperties implements JsonSerializable<EcrImageDetailProperties> {
    /*
     * AWS Properties
     */
    private AwsEcrImageDetailProperties awsProperties;
    ...
    /**
     * Creates an instance of EcrImageDetailProperties class.
     */
     ...
     */
    public AwsEcrImageDetailProperties awsProperties() {
     ...
     * @return the EcrImageDetailProperties object itself.
     */
    public EcrImageDetailProperties withAwsProperties(AwsEcrImageDetailProperties awsProperties) {
     ...
     * @return the EcrImageDetailProperties object itself.
     */
    public EcrImageDetailProperties withPublicCloudConnectorsResourceId(String publicCloudConnectorsResourceId) {
     ...
     * @return the EcrImageDetailProperties object itself.
     */
    public EcrImageDetailProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the EcrImageDetailProperties object itself.
     */
    public EcrImageDetailProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the EcrImageDetailProperties object itself.
     */
    public EcrImageDetailProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the EcrImageDetailProperties object itself.
     */
    public EcrImageDetailProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the EcrImageDetailProperties object itself.
     */
    public EcrImageDetailProperties withAwsRegion(String awsRegion) {
     ...
     * @return the EcrImageDetailProperties object itself.
     */
    public EcrImageDetailProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of EcrImageDetailProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of EcrImageDetailProperties if the JsonReader was pointing to an instance of it, or null if
     * it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the EcrImageDetailProperties.
     */
    public static EcrImageDetailProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            EcrImageDetailProperties deserializedEcrImageDetailProperties = new EcrImageDetailProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedEcrImageDetailProperties.awsProperties = AwsEcrImageDetailProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedEcrImageDetailProperties.publicCloudConnectorsResourceId = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedEcrImageDetailProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedEcrImageDetailProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedEcrImageDetailProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedEcrImageDetailProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedEcrImageDetailProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedEcrImageDetailProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedEcrImageDetailProperties.provisioningState
            ...
            return deserializedEcrImageDetailProperties;
        });
    }
}
