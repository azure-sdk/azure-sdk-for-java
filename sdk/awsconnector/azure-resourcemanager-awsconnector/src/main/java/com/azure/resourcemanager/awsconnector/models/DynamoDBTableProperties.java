 ...
 */
@Fluent
public final class DynamoDBTableProperties implements JsonSerializable<DynamoDBTableProperties> {
    /*
     * AWS Properties
     */
    private AwsDynamoDBTableProperties awsProperties;
    ...
    /**
     * Creates an instance of DynamoDBTableProperties class.
     */
     ...
     */
    public AwsDynamoDBTableProperties awsProperties() {
     ...
     * @return the DynamoDBTableProperties object itself.
     */
    public DynamoDBTableProperties withAwsProperties(AwsDynamoDBTableProperties awsProperties) {
     ...
     * @return the DynamoDBTableProperties object itself.
     */
    public DynamoDBTableProperties withPublicCloudConnectorsResourceId(String publicCloudConnectorsResourceId) {
     ...
     * @return the DynamoDBTableProperties object itself.
     */
    public DynamoDBTableProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the DynamoDBTableProperties object itself.
     */
    public DynamoDBTableProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the DynamoDBTableProperties object itself.
     */
    public DynamoDBTableProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the DynamoDBTableProperties object itself.
     */
    public DynamoDBTableProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the DynamoDBTableProperties object itself.
     */
    public DynamoDBTableProperties withAwsRegion(String awsRegion) {
     ...
     * @return the DynamoDBTableProperties object itself.
     */
    public DynamoDBTableProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of DynamoDBTableProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of DynamoDBTableProperties if the JsonReader was pointing to an instance of it, or null if it
     * was pointing to JSON null.
     * @throws IOException If an error occurs while reading the DynamoDBTableProperties.
     */
    public static DynamoDBTableProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            DynamoDBTableProperties deserializedDynamoDBTableProperties = new DynamoDBTableProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedDynamoDBTableProperties.awsProperties = AwsDynamoDBTableProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedDynamoDBTableProperties.publicCloudConnectorsResourceId = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedDynamoDBTableProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedDynamoDBTableProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedDynamoDBTableProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedDynamoDBTableProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedDynamoDBTableProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedDynamoDBTableProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedDynamoDBTableProperties.provisioningState
            ...
            return deserializedDynamoDBTableProperties;
        });
    }
}
