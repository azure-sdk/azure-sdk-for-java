 ...
 */
@Fluent
public final class Ec2VolumeProperties implements JsonSerializable<Ec2VolumeProperties> {
    /*
     * AWS Properties
     */
    private AwsEc2VolumeProperties awsProperties;
    ...
    /**
     * Creates an instance of Ec2VolumeProperties class.
     */
     ...
     */
    public AwsEc2VolumeProperties awsProperties() {
     ...
     * @return the Ec2VolumeProperties object itself.
     */
    public Ec2VolumeProperties withAwsProperties(AwsEc2VolumeProperties awsProperties) {
     ...
     * @return the Ec2VolumeProperties object itself.
     */
    public Ec2VolumeProperties withPublicCloudConnectorsResourceId(String publicCloudConnectorsResourceId) {
     ...
     * @return the Ec2VolumeProperties object itself.
     */
    public Ec2VolumeProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the Ec2VolumeProperties object itself.
     */
    public Ec2VolumeProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the Ec2VolumeProperties object itself.
     */
    public Ec2VolumeProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the Ec2VolumeProperties object itself.
     */
    public Ec2VolumeProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the Ec2VolumeProperties object itself.
     */
    public Ec2VolumeProperties withAwsRegion(String awsRegion) {
     ...
     * @return the Ec2VolumeProperties object itself.
     */
    public Ec2VolumeProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of Ec2VolumeProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of Ec2VolumeProperties if the JsonReader was pointing to an instance of it, or null if it was
     * pointing to JSON null.
     * @throws IOException If an error occurs while reading the Ec2VolumeProperties.
     */
    public static Ec2VolumeProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            Ec2VolumeProperties deserializedEc2VolumeProperties = new Ec2VolumeProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedEc2VolumeProperties.awsProperties = AwsEc2VolumeProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedEc2VolumeProperties.publicCloudConnectorsResourceId = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedEc2VolumeProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedEc2VolumeProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedEc2VolumeProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedEc2VolumeProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedEc2VolumeProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedEc2VolumeProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedEc2VolumeProperties.provisioningState
            ...
            return deserializedEc2VolumeProperties;
        });
    }
}
