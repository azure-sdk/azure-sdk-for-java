 ...
 */
@Fluent
public final class SnsTopicProperties implements JsonSerializable<SnsTopicProperties> {
    /*
     * AWS Properties
     */
    private AwsSnsTopicProperties awsProperties;
    ...
    /**
     * Creates an instance of SnsTopicProperties class.
     */
     ...
     */
    public AwsSnsTopicProperties awsProperties() {
     ...
     * @return the SnsTopicProperties object itself.
     */
    public SnsTopicProperties withAwsProperties(AwsSnsTopicProperties awsProperties) {
     ...
     * @return the SnsTopicProperties object itself.
     */
    public SnsTopicProperties withPublicCloudConnectorsResourceId(String publicCloudConnectorsResourceId) {
     ...
     * @return the SnsTopicProperties object itself.
     */
    public SnsTopicProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the SnsTopicProperties object itself.
     */
    public SnsTopicProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the SnsTopicProperties object itself.
     */
    public SnsTopicProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the SnsTopicProperties object itself.
     */
    public SnsTopicProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the SnsTopicProperties object itself.
     */
    public SnsTopicProperties withAwsRegion(String awsRegion) {
     ...
     * @return the SnsTopicProperties object itself.
     */
    public SnsTopicProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of SnsTopicProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of SnsTopicProperties if the JsonReader was pointing to an instance of it, or null if it was
     * pointing to JSON null.
     * @throws IOException If an error occurs while reading the SnsTopicProperties.
     */
    public static SnsTopicProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            SnsTopicProperties deserializedSnsTopicProperties = new SnsTopicProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedSnsTopicProperties.awsProperties = AwsSnsTopicProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedSnsTopicProperties.publicCloudConnectorsResourceId = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedSnsTopicProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedSnsTopicProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedSnsTopicProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedSnsTopicProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedSnsTopicProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedSnsTopicProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedSnsTopicProperties.provisioningState = ProvisioningState.fromString(reader.getString());
                } else {
                    reader.skipChildren();
                }
            }

            return deserializedSnsTopicProperties;
        });
    }
}
