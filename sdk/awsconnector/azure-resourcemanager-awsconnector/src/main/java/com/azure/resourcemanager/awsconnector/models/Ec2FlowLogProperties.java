 ...
 */
@Fluent
public final class Ec2FlowLogProperties implements JsonSerializable<Ec2FlowLogProperties> {
    /*
     * AWS Properties
     */
    private AwsEc2FlowLogProperties awsProperties;
    ...
    /**
     * Creates an instance of Ec2FlowLogProperties class.
     */
     ...
     */
    public AwsEc2FlowLogProperties awsProperties() {
     ...
     * @return the Ec2FlowLogProperties object itself.
     */
    public Ec2FlowLogProperties withAwsProperties(AwsEc2FlowLogProperties awsProperties) {
     ...
     * @return the Ec2FlowLogProperties object itself.
     */
    public Ec2FlowLogProperties withPublicCloudConnectorsResourceId(String publicCloudConnectorsResourceId) {
     ...
     * @return the Ec2FlowLogProperties object itself.
     */
    public Ec2FlowLogProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the Ec2FlowLogProperties object itself.
     */
    public Ec2FlowLogProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the Ec2FlowLogProperties object itself.
     */
    public Ec2FlowLogProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the Ec2FlowLogProperties object itself.
     */
    public Ec2FlowLogProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the Ec2FlowLogProperties object itself.
     */
    public Ec2FlowLogProperties withAwsRegion(String awsRegion) {
     ...
     * @return the Ec2FlowLogProperties object itself.
     */
    public Ec2FlowLogProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of Ec2FlowLogProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of Ec2FlowLogProperties if the JsonReader was pointing to an instance of it, or null if it
     * was pointing to JSON null.
     * @throws IOException If an error occurs while reading the Ec2FlowLogProperties.
     */
    public static Ec2FlowLogProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            Ec2FlowLogProperties deserializedEc2FlowLogProperties = new Ec2FlowLogProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedEc2FlowLogProperties.awsProperties = AwsEc2FlowLogProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedEc2FlowLogProperties.publicCloudConnectorsResourceId = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedEc2FlowLogProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedEc2FlowLogProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedEc2FlowLogProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedEc2FlowLogProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedEc2FlowLogProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedEc2FlowLogProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedEc2FlowLogProperties.provisioningState
            ...
            return deserializedEc2FlowLogProperties;
        });
    }
}
