 ...
 */
@Fluent
public final class NetworkFirewallPolicyProperties implements JsonSerializable<NetworkFirewallPolicyProperties> {
    /*
     * AWS Properties
     */
    private AwsNetworkFirewallPolicyProperties awsProperties;
    ...
    /**
     * Creates an instance of NetworkFirewallPolicyProperties class.
     */
     ...
     */
    public AwsNetworkFirewallPolicyProperties awsProperties() {
     ...
     * @return the NetworkFirewallPolicyProperties object itself.
     */
    public NetworkFirewallPolicyProperties withAwsProperties(AwsNetworkFirewallPolicyProperties awsProperties) {
     ...
     * @return the NetworkFirewallPolicyProperties object itself.
     */
    public NetworkFirewallPolicyProperties withPublicCloudConnectorsResourceId(String publicCloudConnectorsResourceId) {
     ...
     * @return the NetworkFirewallPolicyProperties object itself.
     */
    public NetworkFirewallPolicyProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the NetworkFirewallPolicyProperties object itself.
     */
    public NetworkFirewallPolicyProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the NetworkFirewallPolicyProperties object itself.
     */
    public NetworkFirewallPolicyProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the NetworkFirewallPolicyProperties object itself.
     */
    public NetworkFirewallPolicyProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the NetworkFirewallPolicyProperties object itself.
     */
    public NetworkFirewallPolicyProperties withAwsRegion(String awsRegion) {
     ...
     * @return the NetworkFirewallPolicyProperties object itself.
     */
    public NetworkFirewallPolicyProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of NetworkFirewallPolicyProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of NetworkFirewallPolicyProperties if the JsonReader was pointing to an instance of it, or
     * null if it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the NetworkFirewallPolicyProperties.
     */
    public static NetworkFirewallPolicyProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            NetworkFirewallPolicyProperties deserializedNetworkFirewallPolicyProperties
                = new NetworkFirewallPolicyProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedNetworkFirewallPolicyProperties.awsProperties
                        = AwsNetworkFirewallPolicyProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedNetworkFirewallPolicyProperties.publicCloudConnectorsResourceId = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedNetworkFirewallPolicyProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedNetworkFirewallPolicyProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedNetworkFirewallPolicyProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedNetworkFirewallPolicyProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedNetworkFirewallPolicyProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedNetworkFirewallPolicyProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedNetworkFirewallPolicyProperties.provisioningState
            ...
            return deserializedNetworkFirewallPolicyProperties;
        });
    }
}
