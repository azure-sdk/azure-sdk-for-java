 ...
 */
@Fluent
public final class CognitoUserPoolConfig implements JsonSerializable<CognitoUserPoolConfig> {
    /*
    ...
    /**
     * Creates an instance of CognitoUserPoolConfig class.
     */
     ...
     * @return the CognitoUserPoolConfig object itself.
     */
    ...
    /**
     * Reads an instance of CognitoUserPoolConfig from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of CognitoUserPoolConfig if the JsonReader was pointing to an instance of it, or null if it
     * was pointing to JSON null.
     * @throws IOException If an error occurs while reading the CognitoUserPoolConfig.
     */
    public static CognitoUserPoolConfig fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            CognitoUserPoolConfig deserializedCognitoUserPoolConfig = new CognitoUserPoolConfig();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("appIdClientRegex".equals(fieldName)) {
                    deserializedCognitoUserPoolConfig.appIdClientRegex = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedCognitoUserPoolConfig.awsRegion = reader.getString();
                } else if ("userPoolId".equals(fieldName)) {
                    deserializedCognitoUserPoolConfig.userPoolId = reader.getString();
                } else {
                    reader.skipChildren();
                }
            }

            return deserializedCognitoUserPoolConfig;
        });
    }
}
