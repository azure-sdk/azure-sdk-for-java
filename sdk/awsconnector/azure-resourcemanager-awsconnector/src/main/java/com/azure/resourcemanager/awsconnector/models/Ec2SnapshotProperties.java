 ...
 */
@Fluent
public final class Ec2SnapshotProperties implements JsonSerializable<Ec2SnapshotProperties> {
    /*
     * AWS Properties
     */
    private AwsEc2SnapshotProperties awsProperties;
    ...
    /**
     * Creates an instance of Ec2SnapshotProperties class.
     */
     ...
     */
    public AwsEc2SnapshotProperties awsProperties() {
     ...
     * @return the Ec2SnapshotProperties object itself.
     */
    public Ec2SnapshotProperties withAwsProperties(AwsEc2SnapshotProperties awsProperties) {
     ...
     * @return the Ec2SnapshotProperties object itself.
     */
    public Ec2SnapshotProperties withPublicCloudConnectorsResourceId(String publicCloudConnectorsResourceId) {
     ...
     * @return the Ec2SnapshotProperties object itself.
     */
    public Ec2SnapshotProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the Ec2SnapshotProperties object itself.
     */
    public Ec2SnapshotProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the Ec2SnapshotProperties object itself.
     */
    public Ec2SnapshotProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the Ec2SnapshotProperties object itself.
     */
    public Ec2SnapshotProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the Ec2SnapshotProperties object itself.
     */
    public Ec2SnapshotProperties withAwsRegion(String awsRegion) {
     ...
     * @return the Ec2SnapshotProperties object itself.
     */
    public Ec2SnapshotProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of Ec2SnapshotProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of Ec2SnapshotProperties if the JsonReader was pointing to an instance of it, or null if it
     * was pointing to JSON null.
     * @throws IOException If an error occurs while reading the Ec2SnapshotProperties.
     */
    public static Ec2SnapshotProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            Ec2SnapshotProperties deserializedEc2SnapshotProperties = new Ec2SnapshotProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedEc2SnapshotProperties.awsProperties = AwsEc2SnapshotProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedEc2SnapshotProperties.publicCloudConnectorsResourceId = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedEc2SnapshotProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedEc2SnapshotProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedEc2SnapshotProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedEc2SnapshotProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedEc2SnapshotProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedEc2SnapshotProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedEc2SnapshotProperties.provisioningState
            ...
            return deserializedEc2SnapshotProperties;
        });
    }
}
