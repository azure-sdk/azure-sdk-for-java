 ...
 */
@Fluent
public final class ConfigServiceDeliveryChannelProperties
    implements JsonSerializable<ConfigServiceDeliveryChannelProperties> {
    /*
     * AWS Properties
     */
    private AwsConfigServiceDeliveryChannelProperties awsProperties;
    ...
    /**
     * Creates an instance of ConfigServiceDeliveryChannelProperties class.
     */
     ...
     */
    public AwsConfigServiceDeliveryChannelProperties awsProperties() {
     ...
     * @return the ConfigServiceDeliveryChannelProperties object itself.
     */
    public ConfigServiceDeliveryChannelProperties
        withAwsProperties(AwsConfigServiceDeliveryChannelProperties awsProperties) {
     ...
     * @return the ConfigServiceDeliveryChannelProperties object itself.
     */
    public ConfigServiceDeliveryChannelProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the ConfigServiceDeliveryChannelProperties object itself.
     */
    public ConfigServiceDeliveryChannelProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the ConfigServiceDeliveryChannelProperties object itself.
     */
    public ConfigServiceDeliveryChannelProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the ConfigServiceDeliveryChannelProperties object itself.
     */
    public ConfigServiceDeliveryChannelProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the ConfigServiceDeliveryChannelProperties object itself.
     */
    public ConfigServiceDeliveryChannelProperties withAwsRegion(String awsRegion) {
     ...
     * @return the ConfigServiceDeliveryChannelProperties object itself.
     */
    public ConfigServiceDeliveryChannelProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of ConfigServiceDeliveryChannelProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of ConfigServiceDeliveryChannelProperties if the JsonReader was pointing to an instance of
     * it, or null if it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the ConfigServiceDeliveryChannelProperties.
     */
    public static ConfigServiceDeliveryChannelProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ConfigServiceDeliveryChannelProperties deserializedConfigServiceDeliveryChannelProperties
                = new ConfigServiceDeliveryChannelProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedConfigServiceDeliveryChannelProperties.awsProperties
                        = AwsConfigServiceDeliveryChannelProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedConfigServiceDeliveryChannelProperties.publicCloudConnectorsResourceId
                        = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedConfigServiceDeliveryChannelProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedConfigServiceDeliveryChannelProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedConfigServiceDeliveryChannelProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedConfigServiceDeliveryChannelProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedConfigServiceDeliveryChannelProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedConfigServiceDeliveryChannelProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedConfigServiceDeliveryChannelProperties.provisioningState
            ...
            return deserializedConfigServiceDeliveryChannelProperties;
        });
    }
}
