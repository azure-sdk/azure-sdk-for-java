 ...
 */
@Fluent
public final class LogsSubscriptionFilterProperties implements JsonSerializable<LogsSubscriptionFilterProperties> {
    /*
     * AWS Properties
     */
    private AwsLogsSubscriptionFilterProperties awsProperties;
    ...
    /**
     * Creates an instance of LogsSubscriptionFilterProperties class.
     */
     ...
     */
    public AwsLogsSubscriptionFilterProperties awsProperties() {
     ...
     * @return the LogsSubscriptionFilterProperties object itself.
     */
    public LogsSubscriptionFilterProperties withAwsProperties(AwsLogsSubscriptionFilterProperties awsProperties) {
     ...
     * @return the LogsSubscriptionFilterProperties object itself.
     */
    public LogsSubscriptionFilterProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the LogsSubscriptionFilterProperties object itself.
     */
    public LogsSubscriptionFilterProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the LogsSubscriptionFilterProperties object itself.
     */
    public LogsSubscriptionFilterProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the LogsSubscriptionFilterProperties object itself.
     */
    public LogsSubscriptionFilterProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the LogsSubscriptionFilterProperties object itself.
     */
    public LogsSubscriptionFilterProperties withAwsRegion(String awsRegion) {
     ...
     * @return the LogsSubscriptionFilterProperties object itself.
     */
    public LogsSubscriptionFilterProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of LogsSubscriptionFilterProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of LogsSubscriptionFilterProperties if the JsonReader was pointing to an instance of it, or
     * null if it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the LogsSubscriptionFilterProperties.
     */
    public static LogsSubscriptionFilterProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            LogsSubscriptionFilterProperties deserializedLogsSubscriptionFilterProperties
                = new LogsSubscriptionFilterProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedLogsSubscriptionFilterProperties.awsProperties
                        = AwsLogsSubscriptionFilterProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedLogsSubscriptionFilterProperties.publicCloudConnectorsResourceId = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedLogsSubscriptionFilterProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedLogsSubscriptionFilterProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedLogsSubscriptionFilterProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedLogsSubscriptionFilterProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedLogsSubscriptionFilterProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedLogsSubscriptionFilterProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedLogsSubscriptionFilterProperties.provisioningState
            ...
            return deserializedLogsSubscriptionFilterProperties;
        });
    }
}
