 ...
 */
@Fluent
public final class EfsFileSystemProperties implements JsonSerializable<EfsFileSystemProperties> {
    /*
     * AWS Properties
     */
    private AwsEfsFileSystemProperties awsProperties;
    ...
    /**
     * Creates an instance of EfsFileSystemProperties class.
     */
     ...
     */
    public AwsEfsFileSystemProperties awsProperties() {
     ...
     * @return the EfsFileSystemProperties object itself.
     */
    public EfsFileSystemProperties withAwsProperties(AwsEfsFileSystemProperties awsProperties) {
     ...
     * @return the EfsFileSystemProperties object itself.
     */
    public EfsFileSystemProperties withPublicCloudConnectorsResourceId(String publicCloudConnectorsResourceId) {
     ...
     * @return the EfsFileSystemProperties object itself.
     */
    public EfsFileSystemProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the EfsFileSystemProperties object itself.
     */
    public EfsFileSystemProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the EfsFileSystemProperties object itself.
     */
    public EfsFileSystemProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the EfsFileSystemProperties object itself.
     */
    public EfsFileSystemProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the EfsFileSystemProperties object itself.
     */
    public EfsFileSystemProperties withAwsRegion(String awsRegion) {
     ...
     * @return the EfsFileSystemProperties object itself.
     */
    public EfsFileSystemProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of EfsFileSystemProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of EfsFileSystemProperties if the JsonReader was pointing to an instance of it, or null if it
     * was pointing to JSON null.
     * @throws IOException If an error occurs while reading the EfsFileSystemProperties.
     */
    public static EfsFileSystemProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            EfsFileSystemProperties deserializedEfsFileSystemProperties = new EfsFileSystemProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedEfsFileSystemProperties.awsProperties = AwsEfsFileSystemProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedEfsFileSystemProperties.publicCloudConnectorsResourceId = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedEfsFileSystemProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedEfsFileSystemProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedEfsFileSystemProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedEfsFileSystemProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedEfsFileSystemProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedEfsFileSystemProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedEfsFileSystemProperties.provisioningState
            ...
            return deserializedEfsFileSystemProperties;
        });
    }
}
