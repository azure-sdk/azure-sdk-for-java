 ...
 */
@Fluent
public final class RdsDBSnapshotProperties implements JsonSerializable<RdsDBSnapshotProperties> {
    /*
     * AWS Properties
     */
    private AwsRdsDBSnapshotProperties awsProperties;
    ...
    /**
     * Creates an instance of RdsDBSnapshotProperties class.
     */
    public RdsDBSnapshotProperties() {
    }
     ...
     */
    public AwsRdsDBSnapshotProperties awsProperties() {
     ...
     * @return the RdsDBSnapshotProperties object itself.
     */
    public RdsDBSnapshotProperties withAwsProperties(AwsRdsDBSnapshotProperties awsProperties) {
     ...
     * @return the RdsDBSnapshotProperties object itself.
     */
    public RdsDBSnapshotProperties withPublicCloudConnectorsResourceId(String publicCloudConnectorsResourceId) {
     ...
     * @return the RdsDBSnapshotProperties object itself.
     */
    public RdsDBSnapshotProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the RdsDBSnapshotProperties object itself.
     */
    public RdsDBSnapshotProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the RdsDBSnapshotProperties object itself.
     */
    public RdsDBSnapshotProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the RdsDBSnapshotProperties object itself.
     */
    public RdsDBSnapshotProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the RdsDBSnapshotProperties object itself.
     */
    public RdsDBSnapshotProperties withAwsRegion(String awsRegion) {
     ...
     * @return the RdsDBSnapshotProperties object itself.
     */
    public RdsDBSnapshotProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of RdsDBSnapshotProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of RdsDBSnapshotProperties if the JsonReader was pointing to an instance of it, or null if it
     * was pointing to JSON null.
     * @throws IOException If an error occurs while reading the RdsDBSnapshotProperties.
     */
    public static RdsDBSnapshotProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            RdsDBSnapshotProperties deserializedRdsDBSnapshotProperties = new RdsDBSnapshotProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedRdsDBSnapshotProperties.awsProperties = AwsRdsDBSnapshotProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedRdsDBSnapshotProperties.publicCloudConnectorsResourceId = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedRdsDBSnapshotProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedRdsDBSnapshotProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedRdsDBSnapshotProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedRdsDBSnapshotProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedRdsDBSnapshotProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedRdsDBSnapshotProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedRdsDBSnapshotProperties.provisioningState
            ...
            return deserializedRdsDBSnapshotProperties;
        });
    }
}
