 ...
 */
@Fluent
public final class ElasticBeanstalkEnvironmentProperties
    implements JsonSerializable<ElasticBeanstalkEnvironmentProperties> {
    /*
     * AWS Properties
     */
    private AwsElasticBeanstalkEnvironmentProperties awsProperties;
    ...
    /**
     * Creates an instance of ElasticBeanstalkEnvironmentProperties class.
     */
     ...
     */
    public AwsElasticBeanstalkEnvironmentProperties awsProperties() {
     ...
     * @return the ElasticBeanstalkEnvironmentProperties object itself.
     */
    public ElasticBeanstalkEnvironmentProperties
        withAwsProperties(AwsElasticBeanstalkEnvironmentProperties awsProperties) {
     ...
     * @return the ElasticBeanstalkEnvironmentProperties object itself.
     */
    public ElasticBeanstalkEnvironmentProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the ElasticBeanstalkEnvironmentProperties object itself.
     */
    public ElasticBeanstalkEnvironmentProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the ElasticBeanstalkEnvironmentProperties object itself.
     */
    public ElasticBeanstalkEnvironmentProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the ElasticBeanstalkEnvironmentProperties object itself.
     */
    public ElasticBeanstalkEnvironmentProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the ElasticBeanstalkEnvironmentProperties object itself.
     */
    public ElasticBeanstalkEnvironmentProperties withAwsRegion(String awsRegion) {
     ...
     * @return the ElasticBeanstalkEnvironmentProperties object itself.
     */
    public ElasticBeanstalkEnvironmentProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of ElasticBeanstalkEnvironmentProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of ElasticBeanstalkEnvironmentProperties if the JsonReader was pointing to an instance of it,
     * or null if it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the ElasticBeanstalkEnvironmentProperties.
     */
    public static ElasticBeanstalkEnvironmentProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ElasticBeanstalkEnvironmentProperties deserializedElasticBeanstalkEnvironmentProperties
                = new ElasticBeanstalkEnvironmentProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedElasticBeanstalkEnvironmentProperties.awsProperties
                        = AwsElasticBeanstalkEnvironmentProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedElasticBeanstalkEnvironmentProperties.publicCloudConnectorsResourceId
                        = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedElasticBeanstalkEnvironmentProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedElasticBeanstalkEnvironmentProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedElasticBeanstalkEnvironmentProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedElasticBeanstalkEnvironmentProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedElasticBeanstalkEnvironmentProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedElasticBeanstalkEnvironmentProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedElasticBeanstalkEnvironmentProperties.provisioningState
            ...
            return deserializedElasticBeanstalkEnvironmentProperties;
        });
    }
}
