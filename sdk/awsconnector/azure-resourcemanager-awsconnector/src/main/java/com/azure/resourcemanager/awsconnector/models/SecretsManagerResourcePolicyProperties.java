 ...
 */
@Fluent
public final class SecretsManagerResourcePolicyProperties
    implements JsonSerializable<SecretsManagerResourcePolicyProperties> {
    /*
     * AWS Properties
     */
    private AwsSecretsManagerResourcePolicyProperties awsProperties;
    ...
    /**
     * Creates an instance of SecretsManagerResourcePolicyProperties class.
     */
     ...
     */
    public AwsSecretsManagerResourcePolicyProperties awsProperties() {
     ...
     * @return the SecretsManagerResourcePolicyProperties object itself.
     */
    public SecretsManagerResourcePolicyProperties
        withAwsProperties(AwsSecretsManagerResourcePolicyProperties awsProperties) {
     ...
     * @return the SecretsManagerResourcePolicyProperties object itself.
     */
    public SecretsManagerResourcePolicyProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the SecretsManagerResourcePolicyProperties object itself.
     */
    public SecretsManagerResourcePolicyProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the SecretsManagerResourcePolicyProperties object itself.
     */
    public SecretsManagerResourcePolicyProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the SecretsManagerResourcePolicyProperties object itself.
     */
    public SecretsManagerResourcePolicyProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the SecretsManagerResourcePolicyProperties object itself.
     */
    public SecretsManagerResourcePolicyProperties withAwsRegion(String awsRegion) {
     ...
     * @return the SecretsManagerResourcePolicyProperties object itself.
     */
    public SecretsManagerResourcePolicyProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of SecretsManagerResourcePolicyProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of SecretsManagerResourcePolicyProperties if the JsonReader was pointing to an instance of
     * it, or null if it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the SecretsManagerResourcePolicyProperties.
     */
    public static SecretsManagerResourcePolicyProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            SecretsManagerResourcePolicyProperties deserializedSecretsManagerResourcePolicyProperties
                = new SecretsManagerResourcePolicyProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedSecretsManagerResourcePolicyProperties.awsProperties
                        = AwsSecretsManagerResourcePolicyProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedSecretsManagerResourcePolicyProperties.publicCloudConnectorsResourceId
                        = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedSecretsManagerResourcePolicyProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedSecretsManagerResourcePolicyProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedSecretsManagerResourcePolicyProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedSecretsManagerResourcePolicyProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedSecretsManagerResourcePolicyProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedSecretsManagerResourcePolicyProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedSecretsManagerResourcePolicyProperties.provisioningState
            ...
            return deserializedSecretsManagerResourcePolicyProperties;
        });
    }
}
