 ...
 */
@Fluent
public final class RdsExportTaskProperties implements JsonSerializable<RdsExportTaskProperties> {
    /*
     * AWS Properties
     */
    private AwsRdsExportTaskProperties awsProperties;
    ...
    /**
     * Creates an instance of RdsExportTaskProperties class.
     */
     ...
     */
    public AwsRdsExportTaskProperties awsProperties() {
     ...
     * @return the RdsExportTaskProperties object itself.
     */
    public RdsExportTaskProperties withAwsProperties(AwsRdsExportTaskProperties awsProperties) {
     ...
     * @return the RdsExportTaskProperties object itself.
     */
    public RdsExportTaskProperties withPublicCloudConnectorsResourceId(String publicCloudConnectorsResourceId) {
     ...
     * @return the RdsExportTaskProperties object itself.
     */
    public RdsExportTaskProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the RdsExportTaskProperties object itself.
     */
    public RdsExportTaskProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the RdsExportTaskProperties object itself.
     */
    public RdsExportTaskProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the RdsExportTaskProperties object itself.
     */
    public RdsExportTaskProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the RdsExportTaskProperties object itself.
     */
    public RdsExportTaskProperties withAwsRegion(String awsRegion) {
     ...
     * @return the RdsExportTaskProperties object itself.
     */
    public RdsExportTaskProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of RdsExportTaskProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of RdsExportTaskProperties if the JsonReader was pointing to an instance of it, or null if it
     * was pointing to JSON null.
     * @throws IOException If an error occurs while reading the RdsExportTaskProperties.
     */
    public static RdsExportTaskProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            RdsExportTaskProperties deserializedRdsExportTaskProperties = new RdsExportTaskProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedRdsExportTaskProperties.awsProperties = AwsRdsExportTaskProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedRdsExportTaskProperties.publicCloudConnectorsResourceId = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedRdsExportTaskProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedRdsExportTaskProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedRdsExportTaskProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedRdsExportTaskProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedRdsExportTaskProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedRdsExportTaskProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedRdsExportTaskProperties.provisioningState
            ...
            return deserializedRdsExportTaskProperties;
        });
    }
}
