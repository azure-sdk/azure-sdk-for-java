 ...
 */
@Fluent
public final class IamPolicyVersionProperties implements JsonSerializable<IamPolicyVersionProperties> {
    /*
     * AWS Properties
     */
    private AwsIamPolicyVersionProperties awsProperties;
    ...
    /**
     * Creates an instance of IamPolicyVersionProperties class.
     */
     ...
     */
    public AwsIamPolicyVersionProperties awsProperties() {
     ...
     * @return the IamPolicyVersionProperties object itself.
     */
    public IamPolicyVersionProperties withAwsProperties(AwsIamPolicyVersionProperties awsProperties) {
     ...
     * @return the IamPolicyVersionProperties object itself.
     */
    public IamPolicyVersionProperties withPublicCloudConnectorsResourceId(String publicCloudConnectorsResourceId) {
     ...
     * @return the IamPolicyVersionProperties object itself.
     */
    public IamPolicyVersionProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the IamPolicyVersionProperties object itself.
     */
    public IamPolicyVersionProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the IamPolicyVersionProperties object itself.
     */
    public IamPolicyVersionProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the IamPolicyVersionProperties object itself.
     */
    public IamPolicyVersionProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the IamPolicyVersionProperties object itself.
     */
    public IamPolicyVersionProperties withAwsRegion(String awsRegion) {
     ...
     * @return the IamPolicyVersionProperties object itself.
     */
    public IamPolicyVersionProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of IamPolicyVersionProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of IamPolicyVersionProperties if the JsonReader was pointing to an instance of it, or null if
     * it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the IamPolicyVersionProperties.
     */
    public static IamPolicyVersionProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            IamPolicyVersionProperties deserializedIamPolicyVersionProperties = new IamPolicyVersionProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedIamPolicyVersionProperties.awsProperties
                        = AwsIamPolicyVersionProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedIamPolicyVersionProperties.publicCloudConnectorsResourceId = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedIamPolicyVersionProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedIamPolicyVersionProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedIamPolicyVersionProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedIamPolicyVersionProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedIamPolicyVersionProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedIamPolicyVersionProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedIamPolicyVersionProperties.provisioningState
            ...
            return deserializedIamPolicyVersionProperties;
        });
    }
}
