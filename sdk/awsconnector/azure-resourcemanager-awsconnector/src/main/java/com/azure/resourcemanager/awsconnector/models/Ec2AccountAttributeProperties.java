 ...
 */
@Fluent
public final class Ec2AccountAttributeProperties implements JsonSerializable<Ec2AccountAttributeProperties> {
    /*
     * AWS Properties
     */
    private AwsEc2AccountAttributeProperties awsProperties;
    ...
    /**
     * Creates an instance of Ec2AccountAttributeProperties class.
     */
     ...
     */
    public AwsEc2AccountAttributeProperties awsProperties() {
     ...
     * @return the Ec2AccountAttributeProperties object itself.
     */
    public Ec2AccountAttributeProperties withAwsProperties(AwsEc2AccountAttributeProperties awsProperties) {
     ...
     * @return the Ec2AccountAttributeProperties object itself.
     */
    public Ec2AccountAttributeProperties withPublicCloudConnectorsResourceId(String publicCloudConnectorsResourceId) {
     ...
     * @return the Ec2AccountAttributeProperties object itself.
     */
    public Ec2AccountAttributeProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the Ec2AccountAttributeProperties object itself.
     */
    public Ec2AccountAttributeProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the Ec2AccountAttributeProperties object itself.
     */
    public Ec2AccountAttributeProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the Ec2AccountAttributeProperties object itself.
     */
    public Ec2AccountAttributeProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the Ec2AccountAttributeProperties object itself.
     */
    public Ec2AccountAttributeProperties withAwsRegion(String awsRegion) {
     ...
     * @return the Ec2AccountAttributeProperties object itself.
     */
    public Ec2AccountAttributeProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of Ec2AccountAttributeProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of Ec2AccountAttributeProperties if the JsonReader was pointing to an instance of it, or null
     * if it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the Ec2AccountAttributeProperties.
     */
    public static Ec2AccountAttributeProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            Ec2AccountAttributeProperties deserializedEc2AccountAttributeProperties
                = new Ec2AccountAttributeProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedEc2AccountAttributeProperties.awsProperties
                        = AwsEc2AccountAttributeProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedEc2AccountAttributeProperties.publicCloudConnectorsResourceId = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedEc2AccountAttributeProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedEc2AccountAttributeProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedEc2AccountAttributeProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedEc2AccountAttributeProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedEc2AccountAttributeProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedEc2AccountAttributeProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedEc2AccountAttributeProperties.provisioningState
            ...
            return deserializedEc2AccountAttributeProperties;
        });
    }
}
