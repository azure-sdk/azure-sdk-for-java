 ...
 */
@Fluent
public final class RdsDBSnapshotAttributesResultProperties
    implements JsonSerializable<RdsDBSnapshotAttributesResultProperties> {
    /*
     * AWS Properties
     */
    private AwsRdsDBSnapshotAttributesResultProperties awsProperties;
    ...
    /**
     * Creates an instance of RdsDBSnapshotAttributesResultProperties class.
     */
     ...
     */
    public AwsRdsDBSnapshotAttributesResultProperties awsProperties() {
     ...
     * @return the RdsDBSnapshotAttributesResultProperties object itself.
     */
    public RdsDBSnapshotAttributesResultProperties
        withAwsProperties(AwsRdsDBSnapshotAttributesResultProperties awsProperties) {
     ...
     * @return the RdsDBSnapshotAttributesResultProperties object itself.
     */
    public RdsDBSnapshotAttributesResultProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the RdsDBSnapshotAttributesResultProperties object itself.
     */
    public RdsDBSnapshotAttributesResultProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the RdsDBSnapshotAttributesResultProperties object itself.
     */
    public RdsDBSnapshotAttributesResultProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the RdsDBSnapshotAttributesResultProperties object itself.
     */
    public RdsDBSnapshotAttributesResultProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the RdsDBSnapshotAttributesResultProperties object itself.
     */
    public RdsDBSnapshotAttributesResultProperties withAwsRegion(String awsRegion) {
     ...
     * @return the RdsDBSnapshotAttributesResultProperties object itself.
     */
    public RdsDBSnapshotAttributesResultProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of RdsDBSnapshotAttributesResultProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of RdsDBSnapshotAttributesResultProperties if the JsonReader was pointing to an instance of
     * it, or null if it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the RdsDBSnapshotAttributesResultProperties.
     */
    public static RdsDBSnapshotAttributesResultProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            RdsDBSnapshotAttributesResultProperties deserializedRdsDBSnapshotAttributesResultProperties
                = new RdsDBSnapshotAttributesResultProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedRdsDBSnapshotAttributesResultProperties.awsProperties
                        = AwsRdsDBSnapshotAttributesResultProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedRdsDBSnapshotAttributesResultProperties.publicCloudConnectorsResourceId
                        = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedRdsDBSnapshotAttributesResultProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedRdsDBSnapshotAttributesResultProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedRdsDBSnapshotAttributesResultProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedRdsDBSnapshotAttributesResultProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedRdsDBSnapshotAttributesResultProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedRdsDBSnapshotAttributesResultProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedRdsDBSnapshotAttributesResultProperties.provisioningState
            ...
            return deserializedRdsDBSnapshotAttributesResultProperties;
        });
    }
}
