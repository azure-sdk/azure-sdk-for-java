 ...
 */
@Fluent
public final class SsmParameterProperties implements JsonSerializable<SsmParameterProperties> {
    /*
     * AWS Properties
     */
    private AwsSsmParameterProperties awsProperties;
    ...
    /**
     * Creates an instance of SsmParameterProperties class.
     */
     ...
     */
    public AwsSsmParameterProperties awsProperties() {
     ...
     * @return the SsmParameterProperties object itself.
     */
    public SsmParameterProperties withAwsProperties(AwsSsmParameterProperties awsProperties) {
     ...
     * @return the SsmParameterProperties object itself.
     */
    public SsmParameterProperties withPublicCloudConnectorsResourceId(String publicCloudConnectorsResourceId) {
     ...
     * @return the SsmParameterProperties object itself.
     */
    public SsmParameterProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the SsmParameterProperties object itself.
     */
    public SsmParameterProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the SsmParameterProperties object itself.
     */
    public SsmParameterProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the SsmParameterProperties object itself.
     */
    public SsmParameterProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the SsmParameterProperties object itself.
     */
    public SsmParameterProperties withAwsRegion(String awsRegion) {
     ...
     * @return the SsmParameterProperties object itself.
     */
    public SsmParameterProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of SsmParameterProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of SsmParameterProperties if the JsonReader was pointing to an instance of it, or null if it
     * was pointing to JSON null.
     * @throws IOException If an error occurs while reading the SsmParameterProperties.
     */
    public static SsmParameterProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            SsmParameterProperties deserializedSsmParameterProperties = new SsmParameterProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedSsmParameterProperties.awsProperties = AwsSsmParameterProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedSsmParameterProperties.publicCloudConnectorsResourceId = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedSsmParameterProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedSsmParameterProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedSsmParameterProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedSsmParameterProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedSsmParameterProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedSsmParameterProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedSsmParameterProperties.provisioningState
            ...
            return deserializedSsmParameterProperties;
        });
    }
}
