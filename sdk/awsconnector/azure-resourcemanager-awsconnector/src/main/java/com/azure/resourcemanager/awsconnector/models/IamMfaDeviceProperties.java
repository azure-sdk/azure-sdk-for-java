 ...
 */
@Fluent
public final class IamMfaDeviceProperties implements JsonSerializable<IamMfaDeviceProperties> {
    /*
     * AWS Properties
     */
    private AwsIamMfaDeviceProperties awsProperties;
    ...
    /**
     * Creates an instance of IamMfaDeviceProperties class.
     */
    public IamMfaDeviceProperties() {
    }
     ...
     */
    public AwsIamMfaDeviceProperties awsProperties() {
     ...
     * @return the IamMfaDeviceProperties object itself.
     */
    public IamMfaDeviceProperties withAwsProperties(AwsIamMfaDeviceProperties awsProperties) {
     ...
     * @return the IamMfaDeviceProperties object itself.
     */
    public IamMfaDeviceProperties withPublicCloudConnectorsResourceId(String publicCloudConnectorsResourceId) {
     ...
     * @return the IamMfaDeviceProperties object itself.
     */
    public IamMfaDeviceProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the IamMfaDeviceProperties object itself.
     */
    public IamMfaDeviceProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the IamMfaDeviceProperties object itself.
     */
    public IamMfaDeviceProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the IamMfaDeviceProperties object itself.
     */
    public IamMfaDeviceProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the IamMfaDeviceProperties object itself.
     */
    public IamMfaDeviceProperties withAwsRegion(String awsRegion) {
     ...
     * @return the IamMfaDeviceProperties object itself.
     */
    public IamMfaDeviceProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of IamMfaDeviceProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of IamMfaDeviceProperties if the JsonReader was pointing to an instance of it, or null if it
     * was pointing to JSON null.
     * @throws IOException If an error occurs while reading the IamMfaDeviceProperties.
     */
    public static IamMfaDeviceProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            IamMfaDeviceProperties deserializedIamMfaDeviceProperties = new IamMfaDeviceProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedIamMfaDeviceProperties.awsProperties = AwsIamMfaDeviceProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedIamMfaDeviceProperties.publicCloudConnectorsResourceId = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedIamMfaDeviceProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedIamMfaDeviceProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedIamMfaDeviceProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedIamMfaDeviceProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedIamMfaDeviceProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedIamMfaDeviceProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedIamMfaDeviceProperties.provisioningState
            ...
            return deserializedIamMfaDeviceProperties;
        });
    }
}
