 ...
 */
@Fluent
public final class OpenSearchDomainStatusProperties implements JsonSerializable<OpenSearchDomainStatusProperties> {
    /*
     * AWS Properties
     */
    private AwsOpenSearchDomainStatusProperties awsProperties;
    ...
    /**
     * Creates an instance of OpenSearchDomainStatusProperties class.
     */
    public OpenSearchDomainStatusProperties() {
    }
     ...
     */
    public AwsOpenSearchDomainStatusProperties awsProperties() {
     ...
     * @return the OpenSearchDomainStatusProperties object itself.
     */
    public OpenSearchDomainStatusProperties withAwsProperties(AwsOpenSearchDomainStatusProperties awsProperties) {
     ...
     * @return the OpenSearchDomainStatusProperties object itself.
     */
    public OpenSearchDomainStatusProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the OpenSearchDomainStatusProperties object itself.
     */
    public OpenSearchDomainStatusProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the OpenSearchDomainStatusProperties object itself.
     */
    public OpenSearchDomainStatusProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the OpenSearchDomainStatusProperties object itself.
     */
    public OpenSearchDomainStatusProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the OpenSearchDomainStatusProperties object itself.
     */
    public OpenSearchDomainStatusProperties withAwsRegion(String awsRegion) {
     ...
     * @return the OpenSearchDomainStatusProperties object itself.
     */
    public OpenSearchDomainStatusProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of OpenSearchDomainStatusProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of OpenSearchDomainStatusProperties if the JsonReader was pointing to an instance of it, or
     * null if it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the OpenSearchDomainStatusProperties.
     */
    public static OpenSearchDomainStatusProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            OpenSearchDomainStatusProperties deserializedOpenSearchDomainStatusProperties
                = new OpenSearchDomainStatusProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedOpenSearchDomainStatusProperties.awsProperties
                        = AwsOpenSearchDomainStatusProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedOpenSearchDomainStatusProperties.publicCloudConnectorsResourceId = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedOpenSearchDomainStatusProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedOpenSearchDomainStatusProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedOpenSearchDomainStatusProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedOpenSearchDomainStatusProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedOpenSearchDomainStatusProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedOpenSearchDomainStatusProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedOpenSearchDomainStatusProperties.provisioningState
            ...
            return deserializedOpenSearchDomainStatusProperties;
        });
    }
}
