 ...
 */
@Fluent
public final class LightsailInstanceProperties implements JsonSerializable<LightsailInstanceProperties> {
    /*
     * AWS Properties
     */
    private AwsLightsailInstanceProperties awsProperties;
    ...
    /**
     * Creates an instance of LightsailInstanceProperties class.
     */
    public LightsailInstanceProperties() {
    }
     ...
     */
    public AwsLightsailInstanceProperties awsProperties() {
     ...
     * @return the LightsailInstanceProperties object itself.
     */
    public LightsailInstanceProperties withAwsProperties(AwsLightsailInstanceProperties awsProperties) {
     ...
     * @return the LightsailInstanceProperties object itself.
     */
    public LightsailInstanceProperties withPublicCloudConnectorsResourceId(String publicCloudConnectorsResourceId) {
     ...
     * @return the LightsailInstanceProperties object itself.
     */
    public LightsailInstanceProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the LightsailInstanceProperties object itself.
     */
    public LightsailInstanceProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the LightsailInstanceProperties object itself.
     */
    public LightsailInstanceProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the LightsailInstanceProperties object itself.
     */
    public LightsailInstanceProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the LightsailInstanceProperties object itself.
     */
    public LightsailInstanceProperties withAwsRegion(String awsRegion) {
     ...
     * @return the LightsailInstanceProperties object itself.
     */
    public LightsailInstanceProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of LightsailInstanceProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of LightsailInstanceProperties if the JsonReader was pointing to an instance of it, or null
     * if it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the LightsailInstanceProperties.
     */
    public static LightsailInstanceProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            LightsailInstanceProperties deserializedLightsailInstanceProperties = new LightsailInstanceProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedLightsailInstanceProperties.awsProperties
                        = AwsLightsailInstanceProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedLightsailInstanceProperties.publicCloudConnectorsResourceId = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedLightsailInstanceProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedLightsailInstanceProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedLightsailInstanceProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedLightsailInstanceProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedLightsailInstanceProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedLightsailInstanceProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedLightsailInstanceProperties.provisioningState
            ...
            return deserializedLightsailInstanceProperties;
        });
    }
}
