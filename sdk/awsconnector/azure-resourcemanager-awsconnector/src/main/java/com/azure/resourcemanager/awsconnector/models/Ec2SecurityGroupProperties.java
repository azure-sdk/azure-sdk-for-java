 ...
 */
@Fluent
public final class Ec2SecurityGroupProperties implements JsonSerializable<Ec2SecurityGroupProperties> {
    /*
     * AWS Properties
     */
    private AwsEc2SecurityGroupProperties awsProperties;
    ...
    /**
     * Creates an instance of Ec2SecurityGroupProperties class.
     */
     ...
     */
    public AwsEc2SecurityGroupProperties awsProperties() {
     ...
     * @return the Ec2SecurityGroupProperties object itself.
     */
    public Ec2SecurityGroupProperties withAwsProperties(AwsEc2SecurityGroupProperties awsProperties) {
     ...
     * @return the Ec2SecurityGroupProperties object itself.
     */
    public Ec2SecurityGroupProperties withPublicCloudConnectorsResourceId(String publicCloudConnectorsResourceId) {
     ...
     * @return the Ec2SecurityGroupProperties object itself.
     */
    public Ec2SecurityGroupProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the Ec2SecurityGroupProperties object itself.
     */
    public Ec2SecurityGroupProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the Ec2SecurityGroupProperties object itself.
     */
    public Ec2SecurityGroupProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the Ec2SecurityGroupProperties object itself.
     */
    public Ec2SecurityGroupProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the Ec2SecurityGroupProperties object itself.
     */
    public Ec2SecurityGroupProperties withAwsRegion(String awsRegion) {
     ...
     * @return the Ec2SecurityGroupProperties object itself.
     */
    public Ec2SecurityGroupProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of Ec2SecurityGroupProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of Ec2SecurityGroupProperties if the JsonReader was pointing to an instance of it, or null if
     * it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the Ec2SecurityGroupProperties.
     */
    public static Ec2SecurityGroupProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            Ec2SecurityGroupProperties deserializedEc2SecurityGroupProperties = new Ec2SecurityGroupProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedEc2SecurityGroupProperties.awsProperties
                        = AwsEc2SecurityGroupProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedEc2SecurityGroupProperties.publicCloudConnectorsResourceId = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedEc2SecurityGroupProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedEc2SecurityGroupProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedEc2SecurityGroupProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedEc2SecurityGroupProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedEc2SecurityGroupProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedEc2SecurityGroupProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedEc2SecurityGroupProperties.provisioningState
            ...
            return deserializedEc2SecurityGroupProperties;
        });
    }
}
