 ...
 */
@Fluent
public final class IamAccessKeyLastUsedProperties implements JsonSerializable<IamAccessKeyLastUsedProperties> {
    /*
     * AWS Properties
     */
    private AwsIamAccessKeyLastUsedProperties awsProperties;
    ...
    /**
     * Creates an instance of IamAccessKeyLastUsedProperties class.
     */
     ...
     */
    public AwsIamAccessKeyLastUsedProperties awsProperties() {
     ...
     * @return the IamAccessKeyLastUsedProperties object itself.
     */
    public IamAccessKeyLastUsedProperties withAwsProperties(AwsIamAccessKeyLastUsedProperties awsProperties) {
     ...
     * @return the IamAccessKeyLastUsedProperties object itself.
     */
    public IamAccessKeyLastUsedProperties withPublicCloudConnectorsResourceId(String publicCloudConnectorsResourceId) {
     ...
     * @return the IamAccessKeyLastUsedProperties object itself.
     */
    public IamAccessKeyLastUsedProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the IamAccessKeyLastUsedProperties object itself.
     */
    public IamAccessKeyLastUsedProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the IamAccessKeyLastUsedProperties object itself.
     */
    public IamAccessKeyLastUsedProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the IamAccessKeyLastUsedProperties object itself.
     */
    public IamAccessKeyLastUsedProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the IamAccessKeyLastUsedProperties object itself.
     */
    public IamAccessKeyLastUsedProperties withAwsRegion(String awsRegion) {
     ...
     * @return the IamAccessKeyLastUsedProperties object itself.
     */
    public IamAccessKeyLastUsedProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of IamAccessKeyLastUsedProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of IamAccessKeyLastUsedProperties if the JsonReader was pointing to an instance of it, or
     * null if it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the IamAccessKeyLastUsedProperties.
     */
    public static IamAccessKeyLastUsedProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            IamAccessKeyLastUsedProperties deserializedIamAccessKeyLastUsedProperties
                = new IamAccessKeyLastUsedProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedIamAccessKeyLastUsedProperties.awsProperties
                        = AwsIamAccessKeyLastUsedProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedIamAccessKeyLastUsedProperties.publicCloudConnectorsResourceId = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedIamAccessKeyLastUsedProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedIamAccessKeyLastUsedProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedIamAccessKeyLastUsedProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedIamAccessKeyLastUsedProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedIamAccessKeyLastUsedProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedIamAccessKeyLastUsedProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedIamAccessKeyLastUsedProperties.provisioningState
            ...
            return deserializedIamAccessKeyLastUsedProperties;
        });
    }
}
