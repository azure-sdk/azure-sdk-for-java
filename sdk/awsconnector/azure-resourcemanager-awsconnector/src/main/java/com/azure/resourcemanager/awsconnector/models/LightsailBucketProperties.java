 ...
 */
@Fluent
public final class LightsailBucketProperties implements JsonSerializable<LightsailBucketProperties> {
    /*
     * AWS Properties
     */
    private AwsLightsailBucketProperties awsProperties;
    ...
    /**
     * Creates an instance of LightsailBucketProperties class.
     */
     ...
     */
    public AwsLightsailBucketProperties awsProperties() {
     ...
     * @return the LightsailBucketProperties object itself.
     */
    public LightsailBucketProperties withAwsProperties(AwsLightsailBucketProperties awsProperties) {
     ...
     * @return the LightsailBucketProperties object itself.
     */
    public LightsailBucketProperties withPublicCloudConnectorsResourceId(String publicCloudConnectorsResourceId) {
     ...
     * @return the LightsailBucketProperties object itself.
     */
    public LightsailBucketProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the LightsailBucketProperties object itself.
     */
    public LightsailBucketProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the LightsailBucketProperties object itself.
     */
    public LightsailBucketProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the LightsailBucketProperties object itself.
     */
    public LightsailBucketProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the LightsailBucketProperties object itself.
     */
    public LightsailBucketProperties withAwsRegion(String awsRegion) {
     ...
     * @return the LightsailBucketProperties object itself.
     */
    public LightsailBucketProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of LightsailBucketProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of LightsailBucketProperties if the JsonReader was pointing to an instance of it, or null if
     * it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the LightsailBucketProperties.
     */
    public static LightsailBucketProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            LightsailBucketProperties deserializedLightsailBucketProperties = new LightsailBucketProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedLightsailBucketProperties.awsProperties = AwsLightsailBucketProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedLightsailBucketProperties.publicCloudConnectorsResourceId = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedLightsailBucketProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedLightsailBucketProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedLightsailBucketProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedLightsailBucketProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedLightsailBucketProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedLightsailBucketProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedLightsailBucketProperties.provisioningState
            ...
            return deserializedLightsailBucketProperties;
        });
    }
}
