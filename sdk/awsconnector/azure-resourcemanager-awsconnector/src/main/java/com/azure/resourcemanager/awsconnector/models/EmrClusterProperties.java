 ...
 */
@Fluent
public final class EmrClusterProperties implements JsonSerializable<EmrClusterProperties> {
    /*
     * AWS Properties
     */
    private AwsEmrClusterProperties awsProperties;
    ...
    /**
     * Creates an instance of EmrClusterProperties class.
     */
    public EmrClusterProperties() {
    }
     ...
     */
    public AwsEmrClusterProperties awsProperties() {
     ...
     * @return the EmrClusterProperties object itself.
     */
    public EmrClusterProperties withAwsProperties(AwsEmrClusterProperties awsProperties) {
     ...
     * @return the EmrClusterProperties object itself.
     */
    public EmrClusterProperties withPublicCloudConnectorsResourceId(String publicCloudConnectorsResourceId) {
     ...
     * @return the EmrClusterProperties object itself.
     */
    public EmrClusterProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the EmrClusterProperties object itself.
     */
    public EmrClusterProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the EmrClusterProperties object itself.
     */
    public EmrClusterProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the EmrClusterProperties object itself.
     */
    public EmrClusterProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the EmrClusterProperties object itself.
     */
    public EmrClusterProperties withAwsRegion(String awsRegion) {
     ...
     * @return the EmrClusterProperties object itself.
     */
    public EmrClusterProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of EmrClusterProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of EmrClusterProperties if the JsonReader was pointing to an instance of it, or null if it
     * was pointing to JSON null.
     * @throws IOException If an error occurs while reading the EmrClusterProperties.
     */
    public static EmrClusterProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            EmrClusterProperties deserializedEmrClusterProperties = new EmrClusterProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedEmrClusterProperties.awsProperties = AwsEmrClusterProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedEmrClusterProperties.publicCloudConnectorsResourceId = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedEmrClusterProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedEmrClusterProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedEmrClusterProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedEmrClusterProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedEmrClusterProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedEmrClusterProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedEmrClusterProperties.provisioningState
            ...
            return deserializedEmrClusterProperties;
        });
    }
}
