 ...
 */
@Fluent
public final class ConfigServiceConfigurationRecorderProperties
    implements JsonSerializable<ConfigServiceConfigurationRecorderProperties> {
    /*
     * AWS Properties
     */
    private AwsConfigServiceConfigurationRecorderProperties awsProperties;
    ...
    /**
     * Creates an instance of ConfigServiceConfigurationRecorderProperties class.
     */
    public ConfigServiceConfigurationRecorderProperties() {
    }
     ...
     */
    public AwsConfigServiceConfigurationRecorderProperties awsProperties() {
     ...
     * @return the ConfigServiceConfigurationRecorderProperties object itself.
     */
    public ConfigServiceConfigurationRecorderProperties
        withAwsProperties(AwsConfigServiceConfigurationRecorderProperties awsProperties) {
     ...
     * @return the ConfigServiceConfigurationRecorderProperties object itself.
     */
    public ConfigServiceConfigurationRecorderProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the ConfigServiceConfigurationRecorderProperties object itself.
     */
    public ConfigServiceConfigurationRecorderProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the ConfigServiceConfigurationRecorderProperties object itself.
     */
    public ConfigServiceConfigurationRecorderProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the ConfigServiceConfigurationRecorderProperties object itself.
     */
    public ConfigServiceConfigurationRecorderProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the ConfigServiceConfigurationRecorderProperties object itself.
     */
    public ConfigServiceConfigurationRecorderProperties withAwsRegion(String awsRegion) {
     ...
     * @return the ConfigServiceConfigurationRecorderProperties object itself.
     */
    public ConfigServiceConfigurationRecorderProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of ConfigServiceConfigurationRecorderProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of ConfigServiceConfigurationRecorderProperties if the JsonReader was pointing to an instance
     * of it, or null if it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the ConfigServiceConfigurationRecorderProperties.
     */
    public static ConfigServiceConfigurationRecorderProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ConfigServiceConfigurationRecorderProperties deserializedConfigServiceConfigurationRecorderProperties
                = new ConfigServiceConfigurationRecorderProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedConfigServiceConfigurationRecorderProperties.awsProperties
                        = AwsConfigServiceConfigurationRecorderProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedConfigServiceConfigurationRecorderProperties.publicCloudConnectorsResourceId
                        = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedConfigServiceConfigurationRecorderProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedConfigServiceConfigurationRecorderProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedConfigServiceConfigurationRecorderProperties.publicCloudResourceName
                        = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedConfigServiceConfigurationRecorderProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedConfigServiceConfigurationRecorderProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedConfigServiceConfigurationRecorderProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedConfigServiceConfigurationRecorderProperties.provisioningState
            ...
            return deserializedConfigServiceConfigurationRecorderProperties;
        });
    }
}
