 ...
 */
@Fluent
public final class IamPasswordPolicyProperties implements JsonSerializable<IamPasswordPolicyProperties> {
    /*
     * AWS Properties
     */
    private AwsIamPasswordPolicyProperties awsProperties;
    ...
    /**
     * Creates an instance of IamPasswordPolicyProperties class.
     */
     ...
     */
    public AwsIamPasswordPolicyProperties awsProperties() {
     ...
     * @return the IamPasswordPolicyProperties object itself.
     */
    public IamPasswordPolicyProperties withAwsProperties(AwsIamPasswordPolicyProperties awsProperties) {
     ...
     * @return the IamPasswordPolicyProperties object itself.
     */
    public IamPasswordPolicyProperties withPublicCloudConnectorsResourceId(String publicCloudConnectorsResourceId) {
     ...
     * @return the IamPasswordPolicyProperties object itself.
     */
    public IamPasswordPolicyProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the IamPasswordPolicyProperties object itself.
     */
    public IamPasswordPolicyProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the IamPasswordPolicyProperties object itself.
     */
    public IamPasswordPolicyProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the IamPasswordPolicyProperties object itself.
     */
    public IamPasswordPolicyProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the IamPasswordPolicyProperties object itself.
     */
    public IamPasswordPolicyProperties withAwsRegion(String awsRegion) {
     ...
     * @return the IamPasswordPolicyProperties object itself.
     */
    public IamPasswordPolicyProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of IamPasswordPolicyProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of IamPasswordPolicyProperties if the JsonReader was pointing to an instance of it, or null
     * if it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the IamPasswordPolicyProperties.
     */
    public static IamPasswordPolicyProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            IamPasswordPolicyProperties deserializedIamPasswordPolicyProperties = new IamPasswordPolicyProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedIamPasswordPolicyProperties.awsProperties
                        = AwsIamPasswordPolicyProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedIamPasswordPolicyProperties.publicCloudConnectorsResourceId = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedIamPasswordPolicyProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedIamPasswordPolicyProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedIamPasswordPolicyProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedIamPasswordPolicyProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedIamPasswordPolicyProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedIamPasswordPolicyProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedIamPasswordPolicyProperties.provisioningState
            ...
            return deserializedIamPasswordPolicyProperties;
        });
    }
}
