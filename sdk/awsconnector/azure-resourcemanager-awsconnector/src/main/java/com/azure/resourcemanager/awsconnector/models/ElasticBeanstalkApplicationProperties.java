 ...
 */
@Fluent
public final class ElasticBeanstalkApplicationProperties
    implements JsonSerializable<ElasticBeanstalkApplicationProperties> {
    /*
     * AWS Properties
     */
    private AwsElasticBeanstalkApplicationProperties awsProperties;
    ...
    /**
     * Creates an instance of ElasticBeanstalkApplicationProperties class.
     */
     ...
     */
    public AwsElasticBeanstalkApplicationProperties awsProperties() {
     ...
     * @return the ElasticBeanstalkApplicationProperties object itself.
     */
    public ElasticBeanstalkApplicationProperties
        withAwsProperties(AwsElasticBeanstalkApplicationProperties awsProperties) {
     ...
     * @return the ElasticBeanstalkApplicationProperties object itself.
     */
    public ElasticBeanstalkApplicationProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the ElasticBeanstalkApplicationProperties object itself.
     */
    public ElasticBeanstalkApplicationProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the ElasticBeanstalkApplicationProperties object itself.
     */
    public ElasticBeanstalkApplicationProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the ElasticBeanstalkApplicationProperties object itself.
     */
    public ElasticBeanstalkApplicationProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the ElasticBeanstalkApplicationProperties object itself.
     */
    public ElasticBeanstalkApplicationProperties withAwsRegion(String awsRegion) {
     ...
     * @return the ElasticBeanstalkApplicationProperties object itself.
     */
    public ElasticBeanstalkApplicationProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of ElasticBeanstalkApplicationProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of ElasticBeanstalkApplicationProperties if the JsonReader was pointing to an instance of it,
     * or null if it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the ElasticBeanstalkApplicationProperties.
     */
    public static ElasticBeanstalkApplicationProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ElasticBeanstalkApplicationProperties deserializedElasticBeanstalkApplicationProperties
                = new ElasticBeanstalkApplicationProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedElasticBeanstalkApplicationProperties.awsProperties
                        = AwsElasticBeanstalkApplicationProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedElasticBeanstalkApplicationProperties.publicCloudConnectorsResourceId
                        = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedElasticBeanstalkApplicationProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedElasticBeanstalkApplicationProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedElasticBeanstalkApplicationProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedElasticBeanstalkApplicationProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedElasticBeanstalkApplicationProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedElasticBeanstalkApplicationProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedElasticBeanstalkApplicationProperties.provisioningState
            ...
            return deserializedElasticBeanstalkApplicationProperties;
        });
    }
}
