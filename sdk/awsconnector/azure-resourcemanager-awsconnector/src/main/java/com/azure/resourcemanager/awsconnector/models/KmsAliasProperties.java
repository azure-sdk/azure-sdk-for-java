 ...
 */
@Fluent
public final class KmsAliasProperties implements JsonSerializable<KmsAliasProperties> {
    /*
     * AWS Properties
     */
    private AwsKmsAliasProperties awsProperties;
    ...
    /**
     * Creates an instance of KmsAliasProperties class.
     */
     ...
     */
    public AwsKmsAliasProperties awsProperties() {
     ...
     * @return the KmsAliasProperties object itself.
     */
    public KmsAliasProperties withAwsProperties(AwsKmsAliasProperties awsProperties) {
     ...
     * @return the KmsAliasProperties object itself.
     */
    public KmsAliasProperties withPublicCloudConnectorsResourceId(String publicCloudConnectorsResourceId) {
     ...
     * @return the KmsAliasProperties object itself.
     */
    public KmsAliasProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the KmsAliasProperties object itself.
     */
    public KmsAliasProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the KmsAliasProperties object itself.
     */
    public KmsAliasProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the KmsAliasProperties object itself.
     */
    public KmsAliasProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the KmsAliasProperties object itself.
     */
    public KmsAliasProperties withAwsRegion(String awsRegion) {
     ...
     * @return the KmsAliasProperties object itself.
     */
    public KmsAliasProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of KmsAliasProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of KmsAliasProperties if the JsonReader was pointing to an instance of it, or null if it was
     * pointing to JSON null.
     * @throws IOException If an error occurs while reading the KmsAliasProperties.
     */
    public static KmsAliasProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            KmsAliasProperties deserializedKmsAliasProperties = new KmsAliasProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedKmsAliasProperties.awsProperties = AwsKmsAliasProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedKmsAliasProperties.publicCloudConnectorsResourceId = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedKmsAliasProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedKmsAliasProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedKmsAliasProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedKmsAliasProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedKmsAliasProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedKmsAliasProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedKmsAliasProperties.provisioningState = ProvisioningState.fromString(reader.getString());
                } else {
                    reader.skipChildren();
                }
            }

            return deserializedKmsAliasProperties;
        });
    }
}
