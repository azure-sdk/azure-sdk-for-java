 ...
 */
@Fluent
public final class AcmCertificateSummaryProperties implements JsonSerializable<AcmCertificateSummaryProperties> {
    /*
     * AWS Properties
     */
    private AwsAcmCertificateSummaryProperties awsProperties;
    ...
    /**
     * Creates an instance of AcmCertificateSummaryProperties class.
     */
     ...
     */
    public AwsAcmCertificateSummaryProperties awsProperties() {
     ...
     * @return the AcmCertificateSummaryProperties object itself.
     */
    public AcmCertificateSummaryProperties withAwsProperties(AwsAcmCertificateSummaryProperties awsProperties) {
     ...
     * @return the AcmCertificateSummaryProperties object itself.
     */
    public AcmCertificateSummaryProperties withPublicCloudConnectorsResourceId(String publicCloudConnectorsResourceId) {
     ...
     * @return the AcmCertificateSummaryProperties object itself.
     */
    public AcmCertificateSummaryProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the AcmCertificateSummaryProperties object itself.
     */
    public AcmCertificateSummaryProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the AcmCertificateSummaryProperties object itself.
     */
    public AcmCertificateSummaryProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the AcmCertificateSummaryProperties object itself.
     */
    public AcmCertificateSummaryProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the AcmCertificateSummaryProperties object itself.
     */
    public AcmCertificateSummaryProperties withAwsRegion(String awsRegion) {
     ...
     * @return the AcmCertificateSummaryProperties object itself.
     */
    public AcmCertificateSummaryProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of AcmCertificateSummaryProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of AcmCertificateSummaryProperties if the JsonReader was pointing to an instance of it, or
     * null if it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the AcmCertificateSummaryProperties.
     */
    public static AcmCertificateSummaryProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            AcmCertificateSummaryProperties deserializedAcmCertificateSummaryProperties
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("awsProperties".equals(fieldName)) {
                    deserializedAcmCertificateSummaryProperties.awsProperties
                        = AwsAcmCertificateSummaryProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedAcmCertificateSummaryProperties.publicCloudConnectorsResourceId = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedAcmCertificateSummaryProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedAcmCertificateSummaryProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedAcmCertificateSummaryProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedAcmCertificateSummaryProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedAcmCertificateSummaryProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedAcmCertificateSummaryProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedAcmCertificateSummaryProperties.provisioningState
            ...
            return deserializedAcmCertificateSummaryProperties;
        });
    }
}
