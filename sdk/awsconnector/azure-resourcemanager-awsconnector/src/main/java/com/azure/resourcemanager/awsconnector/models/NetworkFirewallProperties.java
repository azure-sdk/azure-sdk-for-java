 ...
 */
@Fluent
public final class NetworkFirewallProperties implements JsonSerializable<NetworkFirewallProperties> {
    /*
     * AWS Properties
     */
    private AwsNetworkFirewallProperties awsProperties;
    ...
    /**
     * Creates an instance of NetworkFirewallProperties class.
     */
     ...
     */
    public AwsNetworkFirewallProperties awsProperties() {
     ...
     * @return the NetworkFirewallProperties object itself.
     */
    public NetworkFirewallProperties withAwsProperties(AwsNetworkFirewallProperties awsProperties) {
     ...
     * @return the NetworkFirewallProperties object itself.
     */
    public NetworkFirewallProperties withPublicCloudConnectorsResourceId(String publicCloudConnectorsResourceId) {
     ...
     * @return the NetworkFirewallProperties object itself.
     */
    public NetworkFirewallProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the NetworkFirewallProperties object itself.
     */
    public NetworkFirewallProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the NetworkFirewallProperties object itself.
     */
    public NetworkFirewallProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the NetworkFirewallProperties object itself.
     */
    public NetworkFirewallProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the NetworkFirewallProperties object itself.
     */
    public NetworkFirewallProperties withAwsRegion(String awsRegion) {
     ...
     * @return the NetworkFirewallProperties object itself.
     */
    public NetworkFirewallProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of NetworkFirewallProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of NetworkFirewallProperties if the JsonReader was pointing to an instance of it, or null if
     * it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the NetworkFirewallProperties.
     */
    public static NetworkFirewallProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            NetworkFirewallProperties deserializedNetworkFirewallProperties = new NetworkFirewallProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedNetworkFirewallProperties.awsProperties = AwsNetworkFirewallProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedNetworkFirewallProperties.publicCloudConnectorsResourceId = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedNetworkFirewallProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedNetworkFirewallProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedNetworkFirewallProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedNetworkFirewallProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedNetworkFirewallProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedNetworkFirewallProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedNetworkFirewallProperties.provisioningState
            ...
            return deserializedNetworkFirewallProperties;
        });
    }
}
