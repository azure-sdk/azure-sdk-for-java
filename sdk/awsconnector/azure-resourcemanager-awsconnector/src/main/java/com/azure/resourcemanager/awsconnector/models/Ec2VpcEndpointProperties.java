 ...
 */
@Fluent
public final class Ec2VpcEndpointProperties implements JsonSerializable<Ec2VpcEndpointProperties> {
    /*
     * AWS Properties
     */
    private AwsEc2VpcEndpointProperties awsProperties;
    ...
    /**
     * Creates an instance of Ec2VpcEndpointProperties class.
     */
     ...
     */
    public AwsEc2VpcEndpointProperties awsProperties() {
     ...
     * @return the Ec2VpcEndpointProperties object itself.
     */
    public Ec2VpcEndpointProperties withAwsProperties(AwsEc2VpcEndpointProperties awsProperties) {
     ...
     * @return the Ec2VpcEndpointProperties object itself.
     */
    public Ec2VpcEndpointProperties withPublicCloudConnectorsResourceId(String publicCloudConnectorsResourceId) {
     ...
     * @return the Ec2VpcEndpointProperties object itself.
     */
    public Ec2VpcEndpointProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the Ec2VpcEndpointProperties object itself.
     */
    public Ec2VpcEndpointProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the Ec2VpcEndpointProperties object itself.
     */
    public Ec2VpcEndpointProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the Ec2VpcEndpointProperties object itself.
     */
    public Ec2VpcEndpointProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the Ec2VpcEndpointProperties object itself.
     */
    public Ec2VpcEndpointProperties withAwsRegion(String awsRegion) {
     ...
     * @return the Ec2VpcEndpointProperties object itself.
     */
    public Ec2VpcEndpointProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of Ec2VpcEndpointProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of Ec2VpcEndpointProperties if the JsonReader was pointing to an instance of it, or null if
     * it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the Ec2VpcEndpointProperties.
     */
    public static Ec2VpcEndpointProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            Ec2VpcEndpointProperties deserializedEc2VpcEndpointProperties = new Ec2VpcEndpointProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedEc2VpcEndpointProperties.awsProperties = AwsEc2VpcEndpointProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedEc2VpcEndpointProperties.publicCloudConnectorsResourceId = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedEc2VpcEndpointProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedEc2VpcEndpointProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedEc2VpcEndpointProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedEc2VpcEndpointProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedEc2VpcEndpointProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedEc2VpcEndpointProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedEc2VpcEndpointProperties.provisioningState
            ...
            return deserializedEc2VpcEndpointProperties;
        });
    }
}
