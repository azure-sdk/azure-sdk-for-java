 ...
 */
@Fluent
public final class AccessAnalyzerProperties implements JsonSerializable<AccessAnalyzerProperties> {
    /*
     * AWS Properties
     */
    private AwsAccessAnalyzerProperties awsProperties;
    ...
    /**
     * Creates an instance of AccessAnalyzerProperties class.
     */
     ...
     */
    public AwsAccessAnalyzerProperties awsProperties() {
     ...
     * @return the AccessAnalyzerProperties object itself.
     */
    public AccessAnalyzerProperties withAwsProperties(AwsAccessAnalyzerProperties awsProperties) {
     ...
     * @return the AccessAnalyzerProperties object itself.
     */
    public AccessAnalyzerProperties withPublicCloudConnectorsResourceId(String publicCloudConnectorsResourceId) {
     ...
     * @return the AccessAnalyzerProperties object itself.
     */
    public AccessAnalyzerProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the AccessAnalyzerProperties object itself.
     */
    public AccessAnalyzerProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the AccessAnalyzerProperties object itself.
     */
    public AccessAnalyzerProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the AccessAnalyzerProperties object itself.
     */
    public AccessAnalyzerProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the AccessAnalyzerProperties object itself.
     */
    public AccessAnalyzerProperties withAwsRegion(String awsRegion) {
     ...
     * @return the AccessAnalyzerProperties object itself.
     */
    public AccessAnalyzerProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of AccessAnalyzerProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of AccessAnalyzerProperties if the JsonReader was pointing to an instance of it, or null if
     * it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the AccessAnalyzerProperties.
     */
    public static AccessAnalyzerProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            AccessAnalyzerProperties deserializedAccessAnalyzerProperties = new AccessAnalyzerProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedAccessAnalyzerProperties.awsProperties = AwsAccessAnalyzerProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedAccessAnalyzerProperties.publicCloudConnectorsResourceId = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedAccessAnalyzerProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedAccessAnalyzerProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedAccessAnalyzerProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedAccessAnalyzerProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedAccessAnalyzerProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedAccessAnalyzerProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedAccessAnalyzerProperties.provisioningState
            ...
            return deserializedAccessAnalyzerProperties;
        });
    }
}
