 ...
 */
@Fluent
public final class CloudFormationStackProperties implements JsonSerializable<CloudFormationStackProperties> {
    /*
     * AWS Properties
     */
    private AwsCloudFormationStackProperties awsProperties;
    ...
    /**
     * Creates an instance of CloudFormationStackProperties class.
     */
     ...
     */
    public AwsCloudFormationStackProperties awsProperties() {
     ...
     * @return the CloudFormationStackProperties object itself.
     */
    public CloudFormationStackProperties withAwsProperties(AwsCloudFormationStackProperties awsProperties) {
     ...
     * @return the CloudFormationStackProperties object itself.
     */
    public CloudFormationStackProperties withPublicCloudConnectorsResourceId(String publicCloudConnectorsResourceId) {
     ...
     * @return the CloudFormationStackProperties object itself.
     */
    public CloudFormationStackProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the CloudFormationStackProperties object itself.
     */
    public CloudFormationStackProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the CloudFormationStackProperties object itself.
     */
    public CloudFormationStackProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the CloudFormationStackProperties object itself.
     */
    public CloudFormationStackProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the CloudFormationStackProperties object itself.
     */
    public CloudFormationStackProperties withAwsRegion(String awsRegion) {
     ...
     * @return the CloudFormationStackProperties object itself.
     */
    public CloudFormationStackProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of CloudFormationStackProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of CloudFormationStackProperties if the JsonReader was pointing to an instance of it, or null
     * if it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the CloudFormationStackProperties.
     */
    public static CloudFormationStackProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            CloudFormationStackProperties deserializedCloudFormationStackProperties
                = new CloudFormationStackProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedCloudFormationStackProperties.awsProperties
                        = AwsCloudFormationStackProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedCloudFormationStackProperties.publicCloudConnectorsResourceId = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedCloudFormationStackProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedCloudFormationStackProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedCloudFormationStackProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedCloudFormationStackProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedCloudFormationStackProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedCloudFormationStackProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedCloudFormationStackProperties.provisioningState
            ...
            return deserializedCloudFormationStackProperties;
        });
    }
}
