 ...
 */
@Fluent
public final class DynamoDBContinuousBackupsDescriptionProperties
    implements JsonSerializable<DynamoDBContinuousBackupsDescriptionProperties> {
    /*
     * AWS Properties
     */
    private AwsDynamoDBContinuousBackupsDescriptionProperties awsProperties;
    ...
    /**
     * Creates an instance of DynamoDBContinuousBackupsDescriptionProperties class.
     */
     ...
     */
    public AwsDynamoDBContinuousBackupsDescriptionProperties awsProperties() {
     ...
     * @return the DynamoDBContinuousBackupsDescriptionProperties object itself.
     */
    public DynamoDBContinuousBackupsDescriptionProperties
        withAwsProperties(AwsDynamoDBContinuousBackupsDescriptionProperties awsProperties) {
     ...
     * @return the DynamoDBContinuousBackupsDescriptionProperties object itself.
     */
    public DynamoDBContinuousBackupsDescriptionProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the DynamoDBContinuousBackupsDescriptionProperties object itself.
     */
    public DynamoDBContinuousBackupsDescriptionProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the DynamoDBContinuousBackupsDescriptionProperties object itself.
     */
    public DynamoDBContinuousBackupsDescriptionProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the DynamoDBContinuousBackupsDescriptionProperties object itself.
     */
    public DynamoDBContinuousBackupsDescriptionProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the DynamoDBContinuousBackupsDescriptionProperties object itself.
     */
    public DynamoDBContinuousBackupsDescriptionProperties withAwsRegion(String awsRegion) {
     ...
     * @return the DynamoDBContinuousBackupsDescriptionProperties object itself.
     */
    public DynamoDBContinuousBackupsDescriptionProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of DynamoDBContinuousBackupsDescriptionProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of DynamoDBContinuousBackupsDescriptionProperties if the JsonReader was pointing to an
     * instance of it, or null if it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the DynamoDBContinuousBackupsDescriptionProperties.
     */
    public static DynamoDBContinuousBackupsDescriptionProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            DynamoDBContinuousBackupsDescriptionProperties deserializedDynamoDBContinuousBackupsDescriptionProperties
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("awsProperties".equals(fieldName)) {
                    deserializedDynamoDBContinuousBackupsDescriptionProperties.awsProperties
                        = AwsDynamoDBContinuousBackupsDescriptionProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedDynamoDBContinuousBackupsDescriptionProperties.publicCloudConnectorsResourceId
                        = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedDynamoDBContinuousBackupsDescriptionProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedDynamoDBContinuousBackupsDescriptionProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedDynamoDBContinuousBackupsDescriptionProperties.publicCloudResourceName
                        = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedDynamoDBContinuousBackupsDescriptionProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedDynamoDBContinuousBackupsDescriptionProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedDynamoDBContinuousBackupsDescriptionProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedDynamoDBContinuousBackupsDescriptionProperties.provisioningState
            ...
            return deserializedDynamoDBContinuousBackupsDescriptionProperties;
        });
    }
}
