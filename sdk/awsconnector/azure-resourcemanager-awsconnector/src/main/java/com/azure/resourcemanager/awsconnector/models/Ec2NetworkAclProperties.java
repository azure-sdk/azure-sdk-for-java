 ...
 */
@Fluent
public final class Ec2NetworkAclProperties implements JsonSerializable<Ec2NetworkAclProperties> {
    /*
     * AWS Properties
     */
    private AwsEc2NetworkAclProperties awsProperties;
    ...
    /**
     * Creates an instance of Ec2NetworkAclProperties class.
     */
     ...
     */
    public AwsEc2NetworkAclProperties awsProperties() {
     ...
     * @return the Ec2NetworkAclProperties object itself.
     */
    public Ec2NetworkAclProperties withAwsProperties(AwsEc2NetworkAclProperties awsProperties) {
     ...
     * @return the Ec2NetworkAclProperties object itself.
     */
    public Ec2NetworkAclProperties withPublicCloudConnectorsResourceId(String publicCloudConnectorsResourceId) {
     ...
     * @return the Ec2NetworkAclProperties object itself.
     */
    public Ec2NetworkAclProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the Ec2NetworkAclProperties object itself.
     */
    public Ec2NetworkAclProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the Ec2NetworkAclProperties object itself.
     */
    public Ec2NetworkAclProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the Ec2NetworkAclProperties object itself.
     */
    public Ec2NetworkAclProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the Ec2NetworkAclProperties object itself.
     */
    public Ec2NetworkAclProperties withAwsRegion(String awsRegion) {
     ...
     * @return the Ec2NetworkAclProperties object itself.
     */
    public Ec2NetworkAclProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of Ec2NetworkAclProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of Ec2NetworkAclProperties if the JsonReader was pointing to an instance of it, or null if it
     * was pointing to JSON null.
     * @throws IOException If an error occurs while reading the Ec2NetworkAclProperties.
     */
    public static Ec2NetworkAclProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            Ec2NetworkAclProperties deserializedEc2NetworkAclProperties = new Ec2NetworkAclProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedEc2NetworkAclProperties.awsProperties = AwsEc2NetworkAclProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedEc2NetworkAclProperties.publicCloudConnectorsResourceId = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedEc2NetworkAclProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedEc2NetworkAclProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedEc2NetworkAclProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedEc2NetworkAclProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedEc2NetworkAclProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedEc2NetworkAclProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedEc2NetworkAclProperties.provisioningState
            ...
            return deserializedEc2NetworkAclProperties;
        });
    }
}
