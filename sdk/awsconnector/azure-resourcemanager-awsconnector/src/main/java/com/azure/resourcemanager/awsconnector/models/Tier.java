...
public final class Tier extends ExpandableStringEnum<Tier> {
    /**
     * Static value Advanced for Tier.
     */
    public static final Tier ADVANCED = fromString("Advanced");

    /**
     * Static value Intelligent-Tiering for Tier.
     */
    public static final Tier INTELLIGENT_TIERING = fromString("Intelligent-Tiering");
