 ...
 */
@Fluent
public final class EksClusterProperties implements JsonSerializable<EksClusterProperties> {
    /*
     * AWS Properties
     */
    private AwsEksClusterProperties awsProperties;
    ...
    /**
     * Creates an instance of EksClusterProperties class.
     */
    public EksClusterProperties() {
    }
     ...
     */
    public AwsEksClusterProperties awsProperties() {
     ...
     * @return the EksClusterProperties object itself.
     */
    public EksClusterProperties withAwsProperties(AwsEksClusterProperties awsProperties) {
     ...
     * @return the EksClusterProperties object itself.
     */
    public EksClusterProperties withPublicCloudConnectorsResourceId(String publicCloudConnectorsResourceId) {
     ...
     * @return the EksClusterProperties object itself.
     */
    public EksClusterProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the EksClusterProperties object itself.
     */
    public EksClusterProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the EksClusterProperties object itself.
     */
    public EksClusterProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the EksClusterProperties object itself.
     */
    public EksClusterProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the EksClusterProperties object itself.
     */
    public EksClusterProperties withAwsRegion(String awsRegion) {
     ...
     * @return the EksClusterProperties object itself.
     */
    public EksClusterProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of EksClusterProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of EksClusterProperties if the JsonReader was pointing to an instance of it, or null if it
     * was pointing to JSON null.
     * @throws IOException If an error occurs while reading the EksClusterProperties.
     */
    public static EksClusterProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            EksClusterProperties deserializedEksClusterProperties = new EksClusterProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedEksClusterProperties.awsProperties = AwsEksClusterProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedEksClusterProperties.publicCloudConnectorsResourceId = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedEksClusterProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedEksClusterProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedEksClusterProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedEksClusterProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedEksClusterProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedEksClusterProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedEksClusterProperties.provisioningState
            ...
            return deserializedEksClusterProperties;
        });
    }
}
