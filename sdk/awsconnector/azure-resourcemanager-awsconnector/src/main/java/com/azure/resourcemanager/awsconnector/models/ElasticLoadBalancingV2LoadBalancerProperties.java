 ...
 */
@Fluent
public final class ElasticLoadBalancingV2LoadBalancerProperties
    implements JsonSerializable<ElasticLoadBalancingV2LoadBalancerProperties> {
    /*
     * AWS Properties
     */
    private AwsElasticLoadBalancingV2LoadBalancerProperties awsProperties;
    ...
    /**
     * Creates an instance of ElasticLoadBalancingV2LoadBalancerProperties class.
     */
     ...
     */
    public AwsElasticLoadBalancingV2LoadBalancerProperties awsProperties() {
     ...
     * @return the ElasticLoadBalancingV2LoadBalancerProperties object itself.
     */
    public ElasticLoadBalancingV2LoadBalancerProperties
        withAwsProperties(AwsElasticLoadBalancingV2LoadBalancerProperties awsProperties) {
     ...
     * @return the ElasticLoadBalancingV2LoadBalancerProperties object itself.
     */
    public ElasticLoadBalancingV2LoadBalancerProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the ElasticLoadBalancingV2LoadBalancerProperties object itself.
     */
    public ElasticLoadBalancingV2LoadBalancerProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the ElasticLoadBalancingV2LoadBalancerProperties object itself.
     */
    public ElasticLoadBalancingV2LoadBalancerProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the ElasticLoadBalancingV2LoadBalancerProperties object itself.
     */
    public ElasticLoadBalancingV2LoadBalancerProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the ElasticLoadBalancingV2LoadBalancerProperties object itself.
     */
    public ElasticLoadBalancingV2LoadBalancerProperties withAwsRegion(String awsRegion) {
     ...
     * @return the ElasticLoadBalancingV2LoadBalancerProperties object itself.
     */
    public ElasticLoadBalancingV2LoadBalancerProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of ElasticLoadBalancingV2LoadBalancerProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of ElasticLoadBalancingV2LoadBalancerProperties if the JsonReader was pointing to an instance
     * of it, or null if it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the ElasticLoadBalancingV2LoadBalancerProperties.
     */
    public static ElasticLoadBalancingV2LoadBalancerProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ElasticLoadBalancingV2LoadBalancerProperties deserializedElasticLoadBalancingV2LoadBalancerProperties
                = new ElasticLoadBalancingV2LoadBalancerProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedElasticLoadBalancingV2LoadBalancerProperties.awsProperties
                        = AwsElasticLoadBalancingV2LoadBalancerProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedElasticLoadBalancingV2LoadBalancerProperties.publicCloudConnectorsResourceId
                        = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedElasticLoadBalancingV2LoadBalancerProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedElasticLoadBalancingV2LoadBalancerProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedElasticLoadBalancingV2LoadBalancerProperties.publicCloudResourceName
                        = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedElasticLoadBalancingV2LoadBalancerProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedElasticLoadBalancingV2LoadBalancerProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedElasticLoadBalancingV2LoadBalancerProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedElasticLoadBalancingV2LoadBalancerProperties.provisioningState
            ...
            return deserializedElasticLoadBalancingV2LoadBalancerProperties;
        });
    }
}
