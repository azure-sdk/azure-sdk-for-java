 ...
 */
@Fluent
public final class CloudFormationStackSetProperties implements JsonSerializable<CloudFormationStackSetProperties> {
    /*
     * AWS Properties
     */
    private AwsCloudFormationStackSetProperties awsProperties;
    ...
    /**
     * Creates an instance of CloudFormationStackSetProperties class.
     */
    public CloudFormationStackSetProperties() {
    }
     ...
     */
    public AwsCloudFormationStackSetProperties awsProperties() {
     ...
     * @return the CloudFormationStackSetProperties object itself.
     */
    public CloudFormationStackSetProperties withAwsProperties(AwsCloudFormationStackSetProperties awsProperties) {
     ...
     * @return the CloudFormationStackSetProperties object itself.
     */
    public CloudFormationStackSetProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the CloudFormationStackSetProperties object itself.
     */
    public CloudFormationStackSetProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the CloudFormationStackSetProperties object itself.
     */
    public CloudFormationStackSetProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the CloudFormationStackSetProperties object itself.
     */
    public CloudFormationStackSetProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the CloudFormationStackSetProperties object itself.
     */
    public CloudFormationStackSetProperties withAwsRegion(String awsRegion) {
     ...
     * @return the CloudFormationStackSetProperties object itself.
     */
    public CloudFormationStackSetProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of CloudFormationStackSetProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of CloudFormationStackSetProperties if the JsonReader was pointing to an instance of it, or
     * null if it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the CloudFormationStackSetProperties.
     */
    public static CloudFormationStackSetProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            CloudFormationStackSetProperties deserializedCloudFormationStackSetProperties
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("awsProperties".equals(fieldName)) {
                    deserializedCloudFormationStackSetProperties.awsProperties
                        = AwsCloudFormationStackSetProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedCloudFormationStackSetProperties.publicCloudConnectorsResourceId = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedCloudFormationStackSetProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedCloudFormationStackSetProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedCloudFormationStackSetProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedCloudFormationStackSetProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedCloudFormationStackSetProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedCloudFormationStackSetProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedCloudFormationStackSetProperties.provisioningState
            ...
            return deserializedCloudFormationStackSetProperties;
        });
    }
}
