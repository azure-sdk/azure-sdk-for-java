 ...
 */
@Fluent
public final class DaxClusterProperties implements JsonSerializable<DaxClusterProperties> {
    /*
     * AWS Properties
     */
    private AwsDaxClusterProperties awsProperties;
    ...
    /**
     * Creates an instance of DaxClusterProperties class.
     */
    public DaxClusterProperties() {
    }
     ...
     */
    public AwsDaxClusterProperties awsProperties() {
     ...
     * @return the DaxClusterProperties object itself.
     */
    public DaxClusterProperties withAwsProperties(AwsDaxClusterProperties awsProperties) {
     ...
     * @return the DaxClusterProperties object itself.
     */
    public DaxClusterProperties withPublicCloudConnectorsResourceId(String publicCloudConnectorsResourceId) {
     ...
     * @return the DaxClusterProperties object itself.
     */
    public DaxClusterProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the DaxClusterProperties object itself.
     */
    public DaxClusterProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the DaxClusterProperties object itself.
     */
    public DaxClusterProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the DaxClusterProperties object itself.
     */
    public DaxClusterProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the DaxClusterProperties object itself.
     */
    public DaxClusterProperties withAwsRegion(String awsRegion) {
     ...
     * @return the DaxClusterProperties object itself.
     */
    public DaxClusterProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of DaxClusterProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of DaxClusterProperties if the JsonReader was pointing to an instance of it, or null if it
     * was pointing to JSON null.
     * @throws IOException If an error occurs while reading the DaxClusterProperties.
     */
    public static DaxClusterProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            DaxClusterProperties deserializedDaxClusterProperties = new DaxClusterProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedDaxClusterProperties.awsProperties = AwsDaxClusterProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedDaxClusterProperties.publicCloudConnectorsResourceId = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedDaxClusterProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedDaxClusterProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedDaxClusterProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedDaxClusterProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedDaxClusterProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedDaxClusterProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedDaxClusterProperties.provisioningState
            ...
            return deserializedDaxClusterProperties;
        });
    }
}
