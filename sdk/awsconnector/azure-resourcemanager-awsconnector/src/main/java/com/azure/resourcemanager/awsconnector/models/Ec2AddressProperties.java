 ...
 */
@Fluent
public final class Ec2AddressProperties implements JsonSerializable<Ec2AddressProperties> {
    /*
     * AWS Properties
     */
    private AwsEc2AddressProperties awsProperties;
    ...
    /**
     * Creates an instance of Ec2AddressProperties class.
     */
     ...
     */
    public AwsEc2AddressProperties awsProperties() {
     ...
     * @return the Ec2AddressProperties object itself.
     */
    public Ec2AddressProperties withAwsProperties(AwsEc2AddressProperties awsProperties) {
     ...
     * @return the Ec2AddressProperties object itself.
     */
    public Ec2AddressProperties withPublicCloudConnectorsResourceId(String publicCloudConnectorsResourceId) {
     ...
     * @return the Ec2AddressProperties object itself.
     */
    public Ec2AddressProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the Ec2AddressProperties object itself.
     */
    public Ec2AddressProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the Ec2AddressProperties object itself.
     */
    public Ec2AddressProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the Ec2AddressProperties object itself.
     */
    public Ec2AddressProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the Ec2AddressProperties object itself.
     */
    public Ec2AddressProperties withAwsRegion(String awsRegion) {
     ...
     * @return the Ec2AddressProperties object itself.
     */
    public Ec2AddressProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of Ec2AddressProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of Ec2AddressProperties if the JsonReader was pointing to an instance of it, or null if it
     * was pointing to JSON null.
     * @throws IOException If an error occurs while reading the Ec2AddressProperties.
     */
    public static Ec2AddressProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            Ec2AddressProperties deserializedEc2AddressProperties = new Ec2AddressProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedEc2AddressProperties.awsProperties = AwsEc2AddressProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedEc2AddressProperties.publicCloudConnectorsResourceId = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedEc2AddressProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedEc2AddressProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedEc2AddressProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedEc2AddressProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedEc2AddressProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedEc2AddressProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedEc2AddressProperties.provisioningState
            ...
            return deserializedEc2AddressProperties;
        });
    }
}
