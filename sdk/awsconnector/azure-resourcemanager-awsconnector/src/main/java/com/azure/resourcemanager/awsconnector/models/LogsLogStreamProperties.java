 ...
 */
@Fluent
public final class LogsLogStreamProperties implements JsonSerializable<LogsLogStreamProperties> {
    /*
     * AWS Properties
     */
    private AwsLogsLogStreamProperties awsProperties;
    ...
    /**
     * Creates an instance of LogsLogStreamProperties class.
     */
    public LogsLogStreamProperties() {
    }
     ...
     */
    public AwsLogsLogStreamProperties awsProperties() {
     ...
     * @return the LogsLogStreamProperties object itself.
     */
    public LogsLogStreamProperties withAwsProperties(AwsLogsLogStreamProperties awsProperties) {
     ...
     * @return the LogsLogStreamProperties object itself.
     */
    public LogsLogStreamProperties withPublicCloudConnectorsResourceId(String publicCloudConnectorsResourceId) {
     ...
     * @return the LogsLogStreamProperties object itself.
     */
    public LogsLogStreamProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the LogsLogStreamProperties object itself.
     */
    public LogsLogStreamProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the LogsLogStreamProperties object itself.
     */
    public LogsLogStreamProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the LogsLogStreamProperties object itself.
     */
    public LogsLogStreamProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the LogsLogStreamProperties object itself.
     */
    public LogsLogStreamProperties withAwsRegion(String awsRegion) {
     ...
     * @return the LogsLogStreamProperties object itself.
     */
    public LogsLogStreamProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of LogsLogStreamProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of LogsLogStreamProperties if the JsonReader was pointing to an instance of it, or null if it
     * was pointing to JSON null.
     * @throws IOException If an error occurs while reading the LogsLogStreamProperties.
     */
    public static LogsLogStreamProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            LogsLogStreamProperties deserializedLogsLogStreamProperties = new LogsLogStreamProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedLogsLogStreamProperties.awsProperties = AwsLogsLogStreamProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedLogsLogStreamProperties.publicCloudConnectorsResourceId = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedLogsLogStreamProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedLogsLogStreamProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedLogsLogStreamProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedLogsLogStreamProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedLogsLogStreamProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedLogsLogStreamProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedLogsLogStreamProperties.provisioningState
            ...
            return deserializedLogsLogStreamProperties;
        });
    }
}
