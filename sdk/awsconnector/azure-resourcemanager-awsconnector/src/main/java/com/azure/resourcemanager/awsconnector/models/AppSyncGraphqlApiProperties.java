 ...
 */
@Fluent
public final class AppSyncGraphqlApiProperties implements JsonSerializable<AppSyncGraphqlApiProperties> {
    /*
     * AWS Properties
     */
    private AwsAppSyncGraphqlApiProperties awsProperties;
    ...
    /**
     * Creates an instance of AppSyncGraphqlApiProperties class.
     */
    public AppSyncGraphqlApiProperties() {
    }
     ...
     */
    public AwsAppSyncGraphqlApiProperties awsProperties() {
     ...
     * @return the AppSyncGraphqlApiProperties object itself.
     */
    public AppSyncGraphqlApiProperties withAwsProperties(AwsAppSyncGraphqlApiProperties awsProperties) {
     ...
     * @return the AppSyncGraphqlApiProperties object itself.
     */
    public AppSyncGraphqlApiProperties withPublicCloudConnectorsResourceId(String publicCloudConnectorsResourceId) {
     ...
     * @return the AppSyncGraphqlApiProperties object itself.
     */
    public AppSyncGraphqlApiProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the AppSyncGraphqlApiProperties object itself.
     */
    public AppSyncGraphqlApiProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the AppSyncGraphqlApiProperties object itself.
     */
    public AppSyncGraphqlApiProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the AppSyncGraphqlApiProperties object itself.
     */
    public AppSyncGraphqlApiProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the AppSyncGraphqlApiProperties object itself.
     */
    public AppSyncGraphqlApiProperties withAwsRegion(String awsRegion) {
     ...
     * @return the AppSyncGraphqlApiProperties object itself.
     */
    public AppSyncGraphqlApiProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of AppSyncGraphqlApiProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of AppSyncGraphqlApiProperties if the JsonReader was pointing to an instance of it, or null
     * if it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the AppSyncGraphqlApiProperties.
     */
    public static AppSyncGraphqlApiProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            AppSyncGraphqlApiProperties deserializedAppSyncGraphqlApiProperties = new AppSyncGraphqlApiProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedAppSyncGraphqlApiProperties.awsProperties
                        = AwsAppSyncGraphqlApiProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedAppSyncGraphqlApiProperties.publicCloudConnectorsResourceId = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedAppSyncGraphqlApiProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedAppSyncGraphqlApiProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedAppSyncGraphqlApiProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedAppSyncGraphqlApiProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedAppSyncGraphqlApiProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedAppSyncGraphqlApiProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedAppSyncGraphqlApiProperties.provisioningState
            ...
            return deserializedAppSyncGraphqlApiProperties;
        });
    }
}
