 ...
 */
@Fluent
public final class Ec2InstanceProperties implements JsonSerializable<Ec2InstanceProperties> {
    /*
     * AWS Properties
     */
    private AwsEc2InstanceProperties awsProperties;
    ...
    /**
     * Creates an instance of Ec2InstanceProperties class.
     */
    public Ec2InstanceProperties() {
    }
     ...
     */
    public AwsEc2InstanceProperties awsProperties() {
     ...
     * @return the Ec2InstanceProperties object itself.
     */
    public Ec2InstanceProperties withAwsProperties(AwsEc2InstanceProperties awsProperties) {
     ...
     * @return the Ec2InstanceProperties object itself.
     */
    public Ec2InstanceProperties withPublicCloudConnectorsResourceId(String publicCloudConnectorsResourceId) {
     ...
     * @return the Ec2InstanceProperties object itself.
     */
    public Ec2InstanceProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the Ec2InstanceProperties object itself.
     */
    public Ec2InstanceProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the Ec2InstanceProperties object itself.
     */
    public Ec2InstanceProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the Ec2InstanceProperties object itself.
     */
    public Ec2InstanceProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the Ec2InstanceProperties object itself.
     */
    public Ec2InstanceProperties withAwsRegion(String awsRegion) {
     ...
     * @return the Ec2InstanceProperties object itself.
     */
    public Ec2InstanceProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of Ec2InstanceProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of Ec2InstanceProperties if the JsonReader was pointing to an instance of it, or null if it
     * was pointing to JSON null.
     * @throws IOException If an error occurs while reading the Ec2InstanceProperties.
     */
    public static Ec2InstanceProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            Ec2InstanceProperties deserializedEc2InstanceProperties = new Ec2InstanceProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedEc2InstanceProperties.awsProperties = AwsEc2InstanceProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedEc2InstanceProperties.publicCloudConnectorsResourceId = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedEc2InstanceProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedEc2InstanceProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedEc2InstanceProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedEc2InstanceProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedEc2InstanceProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedEc2InstanceProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedEc2InstanceProperties.provisioningState
            ...
            return deserializedEc2InstanceProperties;
        });
    }
}
