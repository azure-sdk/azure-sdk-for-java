 ...
 */
@Fluent
public final class S3BucketProperties implements JsonSerializable<S3BucketProperties> {
    /*
     * AWS Properties
     */
    private AwsS3BucketProperties awsProperties;
    ...
    /**
     * Creates an instance of S3BucketProperties class.
     */
     ...
     */
    public AwsS3BucketProperties awsProperties() {
     ...
     * @return the S3BucketProperties object itself.
     */
    public S3BucketProperties withAwsProperties(AwsS3BucketProperties awsProperties) {
     ...
     * @return the S3BucketProperties object itself.
     */
    public S3BucketProperties withPublicCloudConnectorsResourceId(String publicCloudConnectorsResourceId) {
     ...
     * @return the S3BucketProperties object itself.
     */
    public S3BucketProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the S3BucketProperties object itself.
     */
    public S3BucketProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the S3BucketProperties object itself.
     */
    public S3BucketProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the S3BucketProperties object itself.
     */
    public S3BucketProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the S3BucketProperties object itself.
     */
    public S3BucketProperties withAwsRegion(String awsRegion) {
     ...
     * @return the S3BucketProperties object itself.
     */
    public S3BucketProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of S3BucketProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of S3BucketProperties if the JsonReader was pointing to an instance of it, or null if it was
     * pointing to JSON null.
     * @throws IOException If an error occurs while reading the S3BucketProperties.
     */
    public static S3BucketProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            S3BucketProperties deserializedS3BucketProperties = new S3BucketProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedS3BucketProperties.awsProperties = AwsS3BucketProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedS3BucketProperties.publicCloudConnectorsResourceId = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedS3BucketProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedS3BucketProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedS3BucketProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedS3BucketProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedS3BucketProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedS3BucketProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedS3BucketProperties.provisioningState = ProvisioningState.fromString(reader.getString());
                } else {
                    reader.skipChildren();
                }
            }

            return deserializedS3BucketProperties;
        });
    }
}
