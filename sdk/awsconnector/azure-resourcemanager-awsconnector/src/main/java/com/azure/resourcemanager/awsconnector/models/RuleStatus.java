...
public final class RuleStatus extends ExpandableStringEnum<RuleStatus> {
    /**
     * Static value Disabled for RuleStatus.
     */
    public static final RuleStatus DISABLED = fromString("Disabled");

    /**
     * Static value Enabled for RuleStatus.
     */
    public static final RuleStatus ENABLED = fromString("Enabled");
