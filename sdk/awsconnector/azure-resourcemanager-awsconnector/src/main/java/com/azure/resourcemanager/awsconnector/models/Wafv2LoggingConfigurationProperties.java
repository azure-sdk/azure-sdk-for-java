 ...
 */
@Fluent
public final class Wafv2LoggingConfigurationProperties
    implements JsonSerializable<Wafv2LoggingConfigurationProperties> {
    /*
     * AWS Properties
     */
    private AwsWafv2LoggingConfigurationProperties awsProperties;
    ...
    /**
     * Creates an instance of Wafv2LoggingConfigurationProperties class.
     */
     ...
     */
    public AwsWafv2LoggingConfigurationProperties awsProperties() {
     ...
     * @return the Wafv2LoggingConfigurationProperties object itself.
     */
    public Wafv2LoggingConfigurationProperties withAwsProperties(AwsWafv2LoggingConfigurationProperties awsProperties) {
     ...
     * @return the Wafv2LoggingConfigurationProperties object itself.
     */
    public Wafv2LoggingConfigurationProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the Wafv2LoggingConfigurationProperties object itself.
     */
    public Wafv2LoggingConfigurationProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the Wafv2LoggingConfigurationProperties object itself.
     */
    public Wafv2LoggingConfigurationProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the Wafv2LoggingConfigurationProperties object itself.
     */
    public Wafv2LoggingConfigurationProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the Wafv2LoggingConfigurationProperties object itself.
     */
    public Wafv2LoggingConfigurationProperties withAwsRegion(String awsRegion) {
     ...
     * @return the Wafv2LoggingConfigurationProperties object itself.
     */
    public Wafv2LoggingConfigurationProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of Wafv2LoggingConfigurationProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of Wafv2LoggingConfigurationProperties if the JsonReader was pointing to an instance of it,
     * or null if it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the Wafv2LoggingConfigurationProperties.
     */
    public static Wafv2LoggingConfigurationProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            Wafv2LoggingConfigurationProperties deserializedWafv2LoggingConfigurationProperties
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("awsProperties".equals(fieldName)) {
                    deserializedWafv2LoggingConfigurationProperties.awsProperties
                        = AwsWafv2LoggingConfigurationProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedWafv2LoggingConfigurationProperties.publicCloudConnectorsResourceId
                        = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedWafv2LoggingConfigurationProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedWafv2LoggingConfigurationProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedWafv2LoggingConfigurationProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedWafv2LoggingConfigurationProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedWafv2LoggingConfigurationProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedWafv2LoggingConfigurationProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedWafv2LoggingConfigurationProperties.provisioningState
            ...
            return deserializedWafv2LoggingConfigurationProperties;
        });
    }
}
