 ...
 */
@Fluent
public final class EmrClusterSummaryProperties implements JsonSerializable<EmrClusterSummaryProperties> {
    /*
     * AWS Properties
     */
    private AwsEmrClusterSummaryProperties awsProperties;
    ...
    /**
     * Creates an instance of EmrClusterSummaryProperties class.
     */
    public EmrClusterSummaryProperties() {
    }
     ...
     */
    public AwsEmrClusterSummaryProperties awsProperties() {
     ...
     * @return the EmrClusterSummaryProperties object itself.
     */
    public EmrClusterSummaryProperties withAwsProperties(AwsEmrClusterSummaryProperties awsProperties) {
     ...
     * @return the EmrClusterSummaryProperties object itself.
     */
    public EmrClusterSummaryProperties withPublicCloudConnectorsResourceId(String publicCloudConnectorsResourceId) {
     ...
     * @return the EmrClusterSummaryProperties object itself.
     */
    public EmrClusterSummaryProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the EmrClusterSummaryProperties object itself.
     */
    public EmrClusterSummaryProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the EmrClusterSummaryProperties object itself.
     */
    public EmrClusterSummaryProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the EmrClusterSummaryProperties object itself.
     */
    public EmrClusterSummaryProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the EmrClusterSummaryProperties object itself.
     */
    public EmrClusterSummaryProperties withAwsRegion(String awsRegion) {
     ...
     * @return the EmrClusterSummaryProperties object itself.
     */
    public EmrClusterSummaryProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of EmrClusterSummaryProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of EmrClusterSummaryProperties if the JsonReader was pointing to an instance of it, or null
     * if it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the EmrClusterSummaryProperties.
     */
    public static EmrClusterSummaryProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            EmrClusterSummaryProperties deserializedEmrClusterSummaryProperties = new EmrClusterSummaryProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedEmrClusterSummaryProperties.awsProperties
                        = AwsEmrClusterSummaryProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedEmrClusterSummaryProperties.publicCloudConnectorsResourceId = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedEmrClusterSummaryProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedEmrClusterSummaryProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedEmrClusterSummaryProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedEmrClusterSummaryProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedEmrClusterSummaryProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedEmrClusterSummaryProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedEmrClusterSummaryProperties.provisioningState
            ...
            return deserializedEmrClusterSummaryProperties;
        });
    }
}
