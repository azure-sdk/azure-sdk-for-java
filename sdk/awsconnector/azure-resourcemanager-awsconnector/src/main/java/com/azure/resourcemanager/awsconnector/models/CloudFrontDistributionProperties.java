 ...
 */
@Fluent
public final class CloudFrontDistributionProperties implements JsonSerializable<CloudFrontDistributionProperties> {
    /*
     * AWS Properties
     */
    private AwsCloudFrontDistributionProperties awsProperties;
    ...
    /**
     * Creates an instance of CloudFrontDistributionProperties class.
     */
     ...
     */
    public AwsCloudFrontDistributionProperties awsProperties() {
     ...
     * @return the CloudFrontDistributionProperties object itself.
     */
    public CloudFrontDistributionProperties withAwsProperties(AwsCloudFrontDistributionProperties awsProperties) {
     ...
     * @return the CloudFrontDistributionProperties object itself.
     */
    public CloudFrontDistributionProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the CloudFrontDistributionProperties object itself.
     */
    public CloudFrontDistributionProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the CloudFrontDistributionProperties object itself.
     */
    public CloudFrontDistributionProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the CloudFrontDistributionProperties object itself.
     */
    public CloudFrontDistributionProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the CloudFrontDistributionProperties object itself.
     */
    public CloudFrontDistributionProperties withAwsRegion(String awsRegion) {
     ...
     * @return the CloudFrontDistributionProperties object itself.
     */
    public CloudFrontDistributionProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of CloudFrontDistributionProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of CloudFrontDistributionProperties if the JsonReader was pointing to an instance of it, or
     * null if it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the CloudFrontDistributionProperties.
     */
    public static CloudFrontDistributionProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            CloudFrontDistributionProperties deserializedCloudFrontDistributionProperties
                = new CloudFrontDistributionProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedCloudFrontDistributionProperties.awsProperties
                        = AwsCloudFrontDistributionProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedCloudFrontDistributionProperties.publicCloudConnectorsResourceId = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedCloudFrontDistributionProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedCloudFrontDistributionProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedCloudFrontDistributionProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedCloudFrontDistributionProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedCloudFrontDistributionProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedCloudFrontDistributionProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedCloudFrontDistributionProperties.provisioningState
            ...
            return deserializedCloudFrontDistributionProperties;
        });
    }
}
