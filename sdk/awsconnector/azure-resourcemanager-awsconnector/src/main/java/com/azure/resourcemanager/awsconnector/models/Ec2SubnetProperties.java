 ...
 */
@Fluent
public final class Ec2SubnetProperties implements JsonSerializable<Ec2SubnetProperties> {
    /*
     * AWS Properties
     */
    private AwsEc2SubnetProperties awsProperties;
    ...
    /**
     * Creates an instance of Ec2SubnetProperties class.
     */
     ...
     */
    public AwsEc2SubnetProperties awsProperties() {
     ...
     * @return the Ec2SubnetProperties object itself.
     */
    public Ec2SubnetProperties withAwsProperties(AwsEc2SubnetProperties awsProperties) {
     ...
     * @return the Ec2SubnetProperties object itself.
     */
    public Ec2SubnetProperties withPublicCloudConnectorsResourceId(String publicCloudConnectorsResourceId) {
     ...
     * @return the Ec2SubnetProperties object itself.
     */
    public Ec2SubnetProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the Ec2SubnetProperties object itself.
     */
    public Ec2SubnetProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the Ec2SubnetProperties object itself.
     */
    public Ec2SubnetProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the Ec2SubnetProperties object itself.
     */
    public Ec2SubnetProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the Ec2SubnetProperties object itself.
     */
    public Ec2SubnetProperties withAwsRegion(String awsRegion) {
     ...
     * @return the Ec2SubnetProperties object itself.
     */
    public Ec2SubnetProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of Ec2SubnetProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of Ec2SubnetProperties if the JsonReader was pointing to an instance of it, or null if it was
     * pointing to JSON null.
     * @throws IOException If an error occurs while reading the Ec2SubnetProperties.
     */
    public static Ec2SubnetProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            Ec2SubnetProperties deserializedEc2SubnetProperties = new Ec2SubnetProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedEc2SubnetProperties.awsProperties = AwsEc2SubnetProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedEc2SubnetProperties.publicCloudConnectorsResourceId = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedEc2SubnetProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedEc2SubnetProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedEc2SubnetProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedEc2SubnetProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedEc2SubnetProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedEc2SubnetProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedEc2SubnetProperties.provisioningState
            ...
            return deserializedEc2SubnetProperties;
        });
    }
}
