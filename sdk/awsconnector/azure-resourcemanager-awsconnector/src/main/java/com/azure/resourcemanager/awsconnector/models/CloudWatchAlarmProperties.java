 ...
 */
@Fluent
public final class CloudWatchAlarmProperties implements JsonSerializable<CloudWatchAlarmProperties> {
    /*
     * AWS Properties
     */
    private AwsCloudWatchAlarmProperties awsProperties;
    ...
    /**
     * Creates an instance of CloudWatchAlarmProperties class.
     */
     ...
     */
    public AwsCloudWatchAlarmProperties awsProperties() {
     ...
     * @return the CloudWatchAlarmProperties object itself.
     */
    public CloudWatchAlarmProperties withAwsProperties(AwsCloudWatchAlarmProperties awsProperties) {
     ...
     * @return the CloudWatchAlarmProperties object itself.
     */
    public CloudWatchAlarmProperties withPublicCloudConnectorsResourceId(String publicCloudConnectorsResourceId) {
     ...
     * @return the CloudWatchAlarmProperties object itself.
     */
    public CloudWatchAlarmProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the CloudWatchAlarmProperties object itself.
     */
    public CloudWatchAlarmProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the CloudWatchAlarmProperties object itself.
     */
    public CloudWatchAlarmProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the CloudWatchAlarmProperties object itself.
     */
    public CloudWatchAlarmProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the CloudWatchAlarmProperties object itself.
     */
    public CloudWatchAlarmProperties withAwsRegion(String awsRegion) {
     ...
     * @return the CloudWatchAlarmProperties object itself.
     */
    public CloudWatchAlarmProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of CloudWatchAlarmProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of CloudWatchAlarmProperties if the JsonReader was pointing to an instance of it, or null if
     * it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the CloudWatchAlarmProperties.
     */
    public static CloudWatchAlarmProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            CloudWatchAlarmProperties deserializedCloudWatchAlarmProperties = new CloudWatchAlarmProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedCloudWatchAlarmProperties.awsProperties = AwsCloudWatchAlarmProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedCloudWatchAlarmProperties.publicCloudConnectorsResourceId = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedCloudWatchAlarmProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedCloudWatchAlarmProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedCloudWatchAlarmProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedCloudWatchAlarmProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedCloudWatchAlarmProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedCloudWatchAlarmProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedCloudWatchAlarmProperties.provisioningState
            ...
            return deserializedCloudWatchAlarmProperties;
        });
    }
}
