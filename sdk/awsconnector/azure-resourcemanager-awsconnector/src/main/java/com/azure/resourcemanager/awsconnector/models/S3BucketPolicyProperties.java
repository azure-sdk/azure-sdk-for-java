 ...
 */
@Fluent
public final class S3BucketPolicyProperties implements JsonSerializable<S3BucketPolicyProperties> {
    /*
     * AWS Properties
     */
    private AwsS3BucketPolicyProperties awsProperties;
    ...
    /**
     * Creates an instance of S3BucketPolicyProperties class.
     */
     ...
     */
    public AwsS3BucketPolicyProperties awsProperties() {
     ...
     * @return the S3BucketPolicyProperties object itself.
     */
    public S3BucketPolicyProperties withAwsProperties(AwsS3BucketPolicyProperties awsProperties) {
     ...
     * @return the S3BucketPolicyProperties object itself.
     */
    public S3BucketPolicyProperties withPublicCloudConnectorsResourceId(String publicCloudConnectorsResourceId) {
     ...
     * @return the S3BucketPolicyProperties object itself.
     */
    public S3BucketPolicyProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the S3BucketPolicyProperties object itself.
     */
    public S3BucketPolicyProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the S3BucketPolicyProperties object itself.
     */
    public S3BucketPolicyProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the S3BucketPolicyProperties object itself.
     */
    public S3BucketPolicyProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the S3BucketPolicyProperties object itself.
     */
    public S3BucketPolicyProperties withAwsRegion(String awsRegion) {
     ...
     * @return the S3BucketPolicyProperties object itself.
     */
    public S3BucketPolicyProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of S3BucketPolicyProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of S3BucketPolicyProperties if the JsonReader was pointing to an instance of it, or null if
     * it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the S3BucketPolicyProperties.
     */
    public static S3BucketPolicyProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            S3BucketPolicyProperties deserializedS3BucketPolicyProperties = new S3BucketPolicyProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedS3BucketPolicyProperties.awsProperties = AwsS3BucketPolicyProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedS3BucketPolicyProperties.publicCloudConnectorsResourceId = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedS3BucketPolicyProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedS3BucketPolicyProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedS3BucketPolicyProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedS3BucketPolicyProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedS3BucketPolicyProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedS3BucketPolicyProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedS3BucketPolicyProperties.provisioningState
            ...
            return deserializedS3BucketPolicyProperties;
        });
    }
}
