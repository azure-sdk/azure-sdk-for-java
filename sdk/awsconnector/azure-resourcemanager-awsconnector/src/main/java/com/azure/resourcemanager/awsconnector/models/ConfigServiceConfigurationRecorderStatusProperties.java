 ...
 */
@Fluent
public final class ConfigServiceConfigurationRecorderStatusProperties
    implements JsonSerializable<ConfigServiceConfigurationRecorderStatusProperties> {
    /*
     * AWS Properties
     */
    private AwsConfigServiceConfigurationRecorderStatusProperties awsProperties;
    ...
    /**
     * Creates an instance of ConfigServiceConfigurationRecorderStatusProperties class.
     */
     ...
     */
    public AwsConfigServiceConfigurationRecorderStatusProperties awsProperties() {
     ...
     * @return the ConfigServiceConfigurationRecorderStatusProperties object itself.
     */
    public ConfigServiceConfigurationRecorderStatusProperties
        withAwsProperties(AwsConfigServiceConfigurationRecorderStatusProperties awsProperties) {
     ...
     * @return the ConfigServiceConfigurationRecorderStatusProperties object itself.
     */
    public ConfigServiceConfigurationRecorderStatusProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the ConfigServiceConfigurationRecorderStatusProperties object itself.
     */
    public ConfigServiceConfigurationRecorderStatusProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the ConfigServiceConfigurationRecorderStatusProperties object itself.
     */
    public ConfigServiceConfigurationRecorderStatusProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the ConfigServiceConfigurationRecorderStatusProperties object itself.
     */
    public ConfigServiceConfigurationRecorderStatusProperties withAwsRegion(String awsRegion) {
     ...
     * @return the ConfigServiceConfigurationRecorderStatusProperties object itself.
     */
    public ConfigServiceConfigurationRecorderStatusProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of ConfigServiceConfigurationRecorderStatusProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of ConfigServiceConfigurationRecorderStatusProperties if the JsonReader was pointing to an
     * instance of it, or null if it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the ConfigServiceConfigurationRecorderStatusProperties.
     */
    public static ConfigServiceConfigurationRecorderStatusProperties fromJson(JsonReader jsonReader)
        throws IOException {
        return jsonReader.readObject(reader -> {
            ConfigServiceConfigurationRecorderStatusProperties deserializedConfigServiceConfigurationRecorderStatusProperties
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("awsProperties".equals(fieldName)) {
                    deserializedConfigServiceConfigurationRecorderStatusProperties.awsProperties
                        = AwsConfigServiceConfigurationRecorderStatusProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedConfigServiceConfigurationRecorderStatusProperties.publicCloudConnectorsResourceId
                        = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedConfigServiceConfigurationRecorderStatusProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedConfigServiceConfigurationRecorderStatusProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedConfigServiceConfigurationRecorderStatusProperties.publicCloudResourceName
                        = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedConfigServiceConfigurationRecorderStatusProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedConfigServiceConfigurationRecorderStatusProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedConfigServiceConfigurationRecorderStatusProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedConfigServiceConfigurationRecorderStatusProperties.provisioningState
            ...
            return deserializedConfigServiceConfigurationRecorderStatusProperties;
        });
    }
}
