 ...
 */
@Fluent
public final class LogsMetricFilterProperties implements JsonSerializable<LogsMetricFilterProperties> {
    /*
     * AWS Properties
     */
    private AwsLogsMetricFilterProperties awsProperties;
    ...
    /**
     * Creates an instance of LogsMetricFilterProperties class.
     */
     ...
     */
    public AwsLogsMetricFilterProperties awsProperties() {
     ...
     * @return the LogsMetricFilterProperties object itself.
     */
    public LogsMetricFilterProperties withAwsProperties(AwsLogsMetricFilterProperties awsProperties) {
     ...
     * @return the LogsMetricFilterProperties object itself.
     */
    public LogsMetricFilterProperties withPublicCloudConnectorsResourceId(String publicCloudConnectorsResourceId) {
     ...
     * @return the LogsMetricFilterProperties object itself.
     */
    public LogsMetricFilterProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the LogsMetricFilterProperties object itself.
     */
    public LogsMetricFilterProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the LogsMetricFilterProperties object itself.
     */
    public LogsMetricFilterProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the LogsMetricFilterProperties object itself.
     */
    public LogsMetricFilterProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the LogsMetricFilterProperties object itself.
     */
    public LogsMetricFilterProperties withAwsRegion(String awsRegion) {
     ...
     * @return the LogsMetricFilterProperties object itself.
     */
    public LogsMetricFilterProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of LogsMetricFilterProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of LogsMetricFilterProperties if the JsonReader was pointing to an instance of it, or null if
     * it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the LogsMetricFilterProperties.
     */
    public static LogsMetricFilterProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            LogsMetricFilterProperties deserializedLogsMetricFilterProperties = new LogsMetricFilterProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedLogsMetricFilterProperties.awsProperties
                        = AwsLogsMetricFilterProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedLogsMetricFilterProperties.publicCloudConnectorsResourceId = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedLogsMetricFilterProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedLogsMetricFilterProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedLogsMetricFilterProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedLogsMetricFilterProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedLogsMetricFilterProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedLogsMetricFilterProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedLogsMetricFilterProperties.provisioningState
            ...
            return deserializedLogsMetricFilterProperties;
        });
    }
}
