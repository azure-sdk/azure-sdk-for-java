 ...
 */
@Fluent
public final class LogsLogGroupProperties implements JsonSerializable<LogsLogGroupProperties> {
    /*
     * AWS Properties
     */
    private AwsLogsLogGroupProperties awsProperties;
    ...
    /**
     * Creates an instance of LogsLogGroupProperties class.
     */
     ...
     */
    public AwsLogsLogGroupProperties awsProperties() {
     ...
     * @return the LogsLogGroupProperties object itself.
     */
    public LogsLogGroupProperties withAwsProperties(AwsLogsLogGroupProperties awsProperties) {
     ...
     * @return the LogsLogGroupProperties object itself.
     */
    public LogsLogGroupProperties withPublicCloudConnectorsResourceId(String publicCloudConnectorsResourceId) {
     ...
     * @return the LogsLogGroupProperties object itself.
     */
    public LogsLogGroupProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the LogsLogGroupProperties object itself.
     */
    public LogsLogGroupProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the LogsLogGroupProperties object itself.
     */
    public LogsLogGroupProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the LogsLogGroupProperties object itself.
     */
    public LogsLogGroupProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the LogsLogGroupProperties object itself.
     */
    public LogsLogGroupProperties withAwsRegion(String awsRegion) {
     ...
     * @return the LogsLogGroupProperties object itself.
     */
    public LogsLogGroupProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of LogsLogGroupProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of LogsLogGroupProperties if the JsonReader was pointing to an instance of it, or null if it
     * was pointing to JSON null.
     * @throws IOException If an error occurs while reading the LogsLogGroupProperties.
     */
    public static LogsLogGroupProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            LogsLogGroupProperties deserializedLogsLogGroupProperties = new LogsLogGroupProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedLogsLogGroupProperties.awsProperties = AwsLogsLogGroupProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedLogsLogGroupProperties.publicCloudConnectorsResourceId = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedLogsLogGroupProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedLogsLogGroupProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedLogsLogGroupProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedLogsLogGroupProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedLogsLogGroupProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedLogsLogGroupProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedLogsLogGroupProperties.provisioningState
            ...
            return deserializedLogsLogGroupProperties;
        });
    }
}
