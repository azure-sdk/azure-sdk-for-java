...
public final class Origin extends ExpandableStringEnum<Origin> {
    ...
    /**
     * Static value AWS_KMS for Origin.
     */
    public static final Origin AWS_KMS = fromString("AWS_KMS");

    /**
     * Static value EXTERNAL for Origin.
     */
    public static final Origin EXTERNAL = fromString("EXTERNAL");
