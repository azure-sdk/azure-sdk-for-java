 ...
 */
@Fluent
public final class Route53HostedZoneProperties implements JsonSerializable<Route53HostedZoneProperties> {
    /*
     * AWS Properties
     */
    private AwsRoute53HostedZoneProperties awsProperties;
    ...
    /**
     * Creates an instance of Route53HostedZoneProperties class.
     */
    public Route53HostedZoneProperties() {
    }
     ...
     */
    public AwsRoute53HostedZoneProperties awsProperties() {
     ...
     * @return the Route53HostedZoneProperties object itself.
     */
    public Route53HostedZoneProperties withAwsProperties(AwsRoute53HostedZoneProperties awsProperties) {
     ...
     * @return the Route53HostedZoneProperties object itself.
     */
    public Route53HostedZoneProperties withPublicCloudConnectorsResourceId(String publicCloudConnectorsResourceId) {
     ...
     * @return the Route53HostedZoneProperties object itself.
     */
    public Route53HostedZoneProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the Route53HostedZoneProperties object itself.
     */
    public Route53HostedZoneProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the Route53HostedZoneProperties object itself.
     */
    public Route53HostedZoneProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the Route53HostedZoneProperties object itself.
     */
    public Route53HostedZoneProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the Route53HostedZoneProperties object itself.
     */
    public Route53HostedZoneProperties withAwsRegion(String awsRegion) {
     ...
     * @return the Route53HostedZoneProperties object itself.
     */
    public Route53HostedZoneProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of Route53HostedZoneProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of Route53HostedZoneProperties if the JsonReader was pointing to an instance of it, or null
     * if it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the Route53HostedZoneProperties.
     */
    public static Route53HostedZoneProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            Route53HostedZoneProperties deserializedRoute53HostedZoneProperties = new Route53HostedZoneProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedRoute53HostedZoneProperties.awsProperties
                        = AwsRoute53HostedZoneProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedRoute53HostedZoneProperties.publicCloudConnectorsResourceId = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedRoute53HostedZoneProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedRoute53HostedZoneProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedRoute53HostedZoneProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedRoute53HostedZoneProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedRoute53HostedZoneProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedRoute53HostedZoneProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedRoute53HostedZoneProperties.provisioningState
            ...
            return deserializedRoute53HostedZoneProperties;
        });
    }
}
