 ...
 */
@Fluent
public final class CodeBuildProjectProperties implements JsonSerializable<CodeBuildProjectProperties> {
    /*
     * AWS Properties
     */
    private AwsCodeBuildProjectProperties awsProperties;
    ...
    /**
     * Creates an instance of CodeBuildProjectProperties class.
     */
    public CodeBuildProjectProperties() {
    }
     ...
     */
    public AwsCodeBuildProjectProperties awsProperties() {
     ...
     * @return the CodeBuildProjectProperties object itself.
     */
    public CodeBuildProjectProperties withAwsProperties(AwsCodeBuildProjectProperties awsProperties) {
     ...
     * @return the CodeBuildProjectProperties object itself.
     */
    public CodeBuildProjectProperties withPublicCloudConnectorsResourceId(String publicCloudConnectorsResourceId) {
     ...
     * @return the CodeBuildProjectProperties object itself.
     */
    public CodeBuildProjectProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the CodeBuildProjectProperties object itself.
     */
    public CodeBuildProjectProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the CodeBuildProjectProperties object itself.
     */
    public CodeBuildProjectProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the CodeBuildProjectProperties object itself.
     */
    public CodeBuildProjectProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the CodeBuildProjectProperties object itself.
     */
    public CodeBuildProjectProperties withAwsRegion(String awsRegion) {
     ...
     * @return the CodeBuildProjectProperties object itself.
     */
    public CodeBuildProjectProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of CodeBuildProjectProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of CodeBuildProjectProperties if the JsonReader was pointing to an instance of it, or null if
     * it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the CodeBuildProjectProperties.
     */
    public static CodeBuildProjectProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            CodeBuildProjectProperties deserializedCodeBuildProjectProperties = new CodeBuildProjectProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedCodeBuildProjectProperties.awsProperties
                        = AwsCodeBuildProjectProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedCodeBuildProjectProperties.publicCloudConnectorsResourceId = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedCodeBuildProjectProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedCodeBuildProjectProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedCodeBuildProjectProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedCodeBuildProjectProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedCodeBuildProjectProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedCodeBuildProjectProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedCodeBuildProjectProperties.provisioningState
            ...
            return deserializedCodeBuildProjectProperties;
        });
    }
}
