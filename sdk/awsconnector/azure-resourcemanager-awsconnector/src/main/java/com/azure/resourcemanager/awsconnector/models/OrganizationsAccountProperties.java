 ...
 */
@Fluent
public final class OrganizationsAccountProperties implements JsonSerializable<OrganizationsAccountProperties> {
    /*
     * AWS Properties
     */
    private AwsOrganizationsAccountProperties awsProperties;
    ...
    /**
     * Creates an instance of OrganizationsAccountProperties class.
     */
     ...
     */
    public AwsOrganizationsAccountProperties awsProperties() {
     ...
     * @return the OrganizationsAccountProperties object itself.
     */
    public OrganizationsAccountProperties withAwsProperties(AwsOrganizationsAccountProperties awsProperties) {
     ...
     * @return the OrganizationsAccountProperties object itself.
     */
    public OrganizationsAccountProperties withPublicCloudConnectorsResourceId(String publicCloudConnectorsResourceId) {
     ...
     * @return the OrganizationsAccountProperties object itself.
     */
    public OrganizationsAccountProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the OrganizationsAccountProperties object itself.
     */
    public OrganizationsAccountProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the OrganizationsAccountProperties object itself.
     */
    public OrganizationsAccountProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the OrganizationsAccountProperties object itself.
     */
    public OrganizationsAccountProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the OrganizationsAccountProperties object itself.
     */
    public OrganizationsAccountProperties withAwsRegion(String awsRegion) {
     ...
     * @return the OrganizationsAccountProperties object itself.
     */
    public OrganizationsAccountProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of OrganizationsAccountProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of OrganizationsAccountProperties if the JsonReader was pointing to an instance of it, or
     * null if it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the OrganizationsAccountProperties.
     */
    public static OrganizationsAccountProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            OrganizationsAccountProperties deserializedOrganizationsAccountProperties
                = new OrganizationsAccountProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedOrganizationsAccountProperties.awsProperties
                        = AwsOrganizationsAccountProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedOrganizationsAccountProperties.publicCloudConnectorsResourceId = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedOrganizationsAccountProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedOrganizationsAccountProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedOrganizationsAccountProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedOrganizationsAccountProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedOrganizationsAccountProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedOrganizationsAccountProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedOrganizationsAccountProperties.provisioningState
            ...
            return deserializedOrganizationsAccountProperties;
        });
    }
}
