 ...
 */
@Fluent
public final class SnsSubscriptionProperties implements JsonSerializable<SnsSubscriptionProperties> {
    /*
     * AWS Properties
     */
    private AwsSnsSubscriptionProperties awsProperties;
    ...
    /**
     * Creates an instance of SnsSubscriptionProperties class.
     */
     ...
     */
    public AwsSnsSubscriptionProperties awsProperties() {
     ...
     * @return the SnsSubscriptionProperties object itself.
     */
    public SnsSubscriptionProperties withAwsProperties(AwsSnsSubscriptionProperties awsProperties) {
     ...
     * @return the SnsSubscriptionProperties object itself.
     */
    public SnsSubscriptionProperties withPublicCloudConnectorsResourceId(String publicCloudConnectorsResourceId) {
     ...
     * @return the SnsSubscriptionProperties object itself.
     */
    public SnsSubscriptionProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the SnsSubscriptionProperties object itself.
     */
    public SnsSubscriptionProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the SnsSubscriptionProperties object itself.
     */
    public SnsSubscriptionProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the SnsSubscriptionProperties object itself.
     */
    public SnsSubscriptionProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the SnsSubscriptionProperties object itself.
     */
    public SnsSubscriptionProperties withAwsRegion(String awsRegion) {
     ...
     * @return the SnsSubscriptionProperties object itself.
     */
    public SnsSubscriptionProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of SnsSubscriptionProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of SnsSubscriptionProperties if the JsonReader was pointing to an instance of it, or null if
     * it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the SnsSubscriptionProperties.
     */
    public static SnsSubscriptionProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            SnsSubscriptionProperties deserializedSnsSubscriptionProperties = new SnsSubscriptionProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedSnsSubscriptionProperties.awsProperties = AwsSnsSubscriptionProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedSnsSubscriptionProperties.publicCloudConnectorsResourceId = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedSnsSubscriptionProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedSnsSubscriptionProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedSnsSubscriptionProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedSnsSubscriptionProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedSnsSubscriptionProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedSnsSubscriptionProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedSnsSubscriptionProperties.provisioningState
            ...
            return deserializedSnsSubscriptionProperties;
        });
    }
}
