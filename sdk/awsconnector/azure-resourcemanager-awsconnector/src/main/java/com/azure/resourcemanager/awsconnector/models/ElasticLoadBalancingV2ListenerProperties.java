 ...
 */
@Fluent
public final class ElasticLoadBalancingV2ListenerProperties
    implements JsonSerializable<ElasticLoadBalancingV2ListenerProperties> {
    /*
     * AWS Properties
     */
    private AwsElasticLoadBalancingV2ListenerProperties awsProperties;
    ...
    /**
     * Creates an instance of ElasticLoadBalancingV2ListenerProperties class.
     */
     ...
     */
    public AwsElasticLoadBalancingV2ListenerProperties awsProperties() {
     ...
     * @return the ElasticLoadBalancingV2ListenerProperties object itself.
     */
    public ElasticLoadBalancingV2ListenerProperties
        withAwsProperties(AwsElasticLoadBalancingV2ListenerProperties awsProperties) {
     ...
     * @return the ElasticLoadBalancingV2ListenerProperties object itself.
     */
    public ElasticLoadBalancingV2ListenerProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the ElasticLoadBalancingV2ListenerProperties object itself.
     */
    public ElasticLoadBalancingV2ListenerProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the ElasticLoadBalancingV2ListenerProperties object itself.
     */
    public ElasticLoadBalancingV2ListenerProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the ElasticLoadBalancingV2ListenerProperties object itself.
     */
    public ElasticLoadBalancingV2ListenerProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the ElasticLoadBalancingV2ListenerProperties object itself.
     */
    public ElasticLoadBalancingV2ListenerProperties withAwsRegion(String awsRegion) {
     ...
     * @return the ElasticLoadBalancingV2ListenerProperties object itself.
     */
    public ElasticLoadBalancingV2ListenerProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of ElasticLoadBalancingV2ListenerProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of ElasticLoadBalancingV2ListenerProperties if the JsonReader was pointing to an instance of
     * it, or null if it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the ElasticLoadBalancingV2ListenerProperties.
     */
    public static ElasticLoadBalancingV2ListenerProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ElasticLoadBalancingV2ListenerProperties deserializedElasticLoadBalancingV2ListenerProperties
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("awsProperties".equals(fieldName)) {
                    deserializedElasticLoadBalancingV2ListenerProperties.awsProperties
                        = AwsElasticLoadBalancingV2ListenerProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedElasticLoadBalancingV2ListenerProperties.publicCloudConnectorsResourceId
                        = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedElasticLoadBalancingV2ListenerProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedElasticLoadBalancingV2ListenerProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedElasticLoadBalancingV2ListenerProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedElasticLoadBalancingV2ListenerProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedElasticLoadBalancingV2ListenerProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedElasticLoadBalancingV2ListenerProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedElasticLoadBalancingV2ListenerProperties.provisioningState
            ...
            return deserializedElasticLoadBalancingV2ListenerProperties;
        });
    }
}
