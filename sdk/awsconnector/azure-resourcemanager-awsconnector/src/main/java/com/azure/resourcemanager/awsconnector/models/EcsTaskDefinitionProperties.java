 ...
 */
@Fluent
public final class EcsTaskDefinitionProperties implements JsonSerializable<EcsTaskDefinitionProperties> {
    /*
     * AWS Properties
     */
    private AwsEcsTaskDefinitionProperties awsProperties;
    ...
    /**
     * Creates an instance of EcsTaskDefinitionProperties class.
     */
    public EcsTaskDefinitionProperties() {
    }
     ...
     */
    public AwsEcsTaskDefinitionProperties awsProperties() {
     ...
     * @return the EcsTaskDefinitionProperties object itself.
     */
    public EcsTaskDefinitionProperties withAwsProperties(AwsEcsTaskDefinitionProperties awsProperties) {
     ...
     * @return the EcsTaskDefinitionProperties object itself.
     */
    public EcsTaskDefinitionProperties withPublicCloudConnectorsResourceId(String publicCloudConnectorsResourceId) {
     ...
     * @return the EcsTaskDefinitionProperties object itself.
     */
    public EcsTaskDefinitionProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the EcsTaskDefinitionProperties object itself.
     */
    public EcsTaskDefinitionProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the EcsTaskDefinitionProperties object itself.
     */
    public EcsTaskDefinitionProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the EcsTaskDefinitionProperties object itself.
     */
    public EcsTaskDefinitionProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the EcsTaskDefinitionProperties object itself.
     */
    public EcsTaskDefinitionProperties withAwsRegion(String awsRegion) {
     ...
     * @return the EcsTaskDefinitionProperties object itself.
     */
    public EcsTaskDefinitionProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of EcsTaskDefinitionProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of EcsTaskDefinitionProperties if the JsonReader was pointing to an instance of it, or null
     * if it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the EcsTaskDefinitionProperties.
     */
    public static EcsTaskDefinitionProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            EcsTaskDefinitionProperties deserializedEcsTaskDefinitionProperties = new EcsTaskDefinitionProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedEcsTaskDefinitionProperties.awsProperties
                        = AwsEcsTaskDefinitionProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedEcsTaskDefinitionProperties.publicCloudConnectorsResourceId = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedEcsTaskDefinitionProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedEcsTaskDefinitionProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedEcsTaskDefinitionProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedEcsTaskDefinitionProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedEcsTaskDefinitionProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedEcsTaskDefinitionProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedEcsTaskDefinitionProperties.provisioningState
            ...
            return deserializedEcsTaskDefinitionProperties;
        });
    }
}
