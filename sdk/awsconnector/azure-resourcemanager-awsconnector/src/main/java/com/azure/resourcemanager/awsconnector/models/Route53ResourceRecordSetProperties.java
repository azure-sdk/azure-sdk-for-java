 ...
 */
@Fluent
public final class Route53ResourceRecordSetProperties implements JsonSerializable<Route53ResourceRecordSetProperties> {
    /*
     * AWS Properties
     */
    private AwsRoute53ResourceRecordSetProperties awsProperties;
    ...
    /**
     * Creates an instance of Route53ResourceRecordSetProperties class.
     */
    public Route53ResourceRecordSetProperties() {
    }
     ...
     */
    public AwsRoute53ResourceRecordSetProperties awsProperties() {
     ...
     * @return the Route53ResourceRecordSetProperties object itself.
     */
    public Route53ResourceRecordSetProperties withAwsProperties(AwsRoute53ResourceRecordSetProperties awsProperties) {
     ...
     * @return the Route53ResourceRecordSetProperties object itself.
     */
    public Route53ResourceRecordSetProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the Route53ResourceRecordSetProperties object itself.
     */
    public Route53ResourceRecordSetProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the Route53ResourceRecordSetProperties object itself.
     */
    public Route53ResourceRecordSetProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the Route53ResourceRecordSetProperties object itself.
     */
    public Route53ResourceRecordSetProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the Route53ResourceRecordSetProperties object itself.
     */
    public Route53ResourceRecordSetProperties withAwsRegion(String awsRegion) {
     ...
     * @return the Route53ResourceRecordSetProperties object itself.
     */
    public Route53ResourceRecordSetProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of Route53ResourceRecordSetProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of Route53ResourceRecordSetProperties if the JsonReader was pointing to an instance of it, or
     * null if it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the Route53ResourceRecordSetProperties.
     */
    public static Route53ResourceRecordSetProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            Route53ResourceRecordSetProperties deserializedRoute53ResourceRecordSetProperties
                = new Route53ResourceRecordSetProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedRoute53ResourceRecordSetProperties.awsProperties
                        = AwsRoute53ResourceRecordSetProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedRoute53ResourceRecordSetProperties.publicCloudConnectorsResourceId = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedRoute53ResourceRecordSetProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedRoute53ResourceRecordSetProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedRoute53ResourceRecordSetProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedRoute53ResourceRecordSetProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedRoute53ResourceRecordSetProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedRoute53ResourceRecordSetProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedRoute53ResourceRecordSetProperties.provisioningState
            ...
            return deserializedRoute53ResourceRecordSetProperties;
        });
    }
}
