...
import com.azure.resourcemanager.awsconnector.models.OperationListResult;
...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    OperationsClientImpl(MicrosoftAwsConnectorImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for MicrosoftAwsConnectorOperations to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{$host}")
    ...
    public interface OperationsService {
        ...
        @Get("/providers/Microsoft.AwsConnector/operations")
