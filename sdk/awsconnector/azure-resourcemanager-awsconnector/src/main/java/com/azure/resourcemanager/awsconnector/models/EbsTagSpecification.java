...
public final class EbsTagSpecification implements JsonSerializable<EbsTagSpecification> {
    ...
    /**
     * Get the propagateTags property: Determines whether to propagate the tags from the task definition to
     * the Amazon EBS volume. Tags can only propagate to a ``SERVICE`` specified in
     * ``ServiceVolumeConfiguration``. If no value is specified, the tags aren't
     * propagated.
     * 
    ...
    /**
     * Set the propagateTags property: Determines whether to propagate the tags from the task definition to
     * the Amazon EBS volume. Tags can only propagate to a ``SERVICE`` specified in
     * ``ServiceVolumeConfiguration``. If no value is specified, the tags aren't
     * propagated.
     * 
