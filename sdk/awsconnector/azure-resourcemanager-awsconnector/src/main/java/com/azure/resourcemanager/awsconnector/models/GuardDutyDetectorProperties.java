 ...
 */
@Fluent
public final class GuardDutyDetectorProperties implements JsonSerializable<GuardDutyDetectorProperties> {
    /*
     * AWS Properties
     */
    private AwsGuardDutyDetectorProperties awsProperties;
    ...
    /**
     * Creates an instance of GuardDutyDetectorProperties class.
     */
     ...
     */
    public AwsGuardDutyDetectorProperties awsProperties() {
     ...
     * @return the GuardDutyDetectorProperties object itself.
     */
    public GuardDutyDetectorProperties withAwsProperties(AwsGuardDutyDetectorProperties awsProperties) {
     ...
     * @return the GuardDutyDetectorProperties object itself.
     */
    public GuardDutyDetectorProperties withPublicCloudConnectorsResourceId(String publicCloudConnectorsResourceId) {
     ...
     * @return the GuardDutyDetectorProperties object itself.
     */
    public GuardDutyDetectorProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the GuardDutyDetectorProperties object itself.
     */
    public GuardDutyDetectorProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the GuardDutyDetectorProperties object itself.
     */
    public GuardDutyDetectorProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the GuardDutyDetectorProperties object itself.
     */
    public GuardDutyDetectorProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the GuardDutyDetectorProperties object itself.
     */
    public GuardDutyDetectorProperties withAwsRegion(String awsRegion) {
     ...
     * @return the GuardDutyDetectorProperties object itself.
     */
    public GuardDutyDetectorProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of GuardDutyDetectorProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of GuardDutyDetectorProperties if the JsonReader was pointing to an instance of it, or null
     * if it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the GuardDutyDetectorProperties.
     */
    public static GuardDutyDetectorProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            GuardDutyDetectorProperties deserializedGuardDutyDetectorProperties = new GuardDutyDetectorProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedGuardDutyDetectorProperties.awsProperties
                        = AwsGuardDutyDetectorProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedGuardDutyDetectorProperties.publicCloudConnectorsResourceId = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedGuardDutyDetectorProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedGuardDutyDetectorProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedGuardDutyDetectorProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedGuardDutyDetectorProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedGuardDutyDetectorProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedGuardDutyDetectorProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedGuardDutyDetectorProperties.provisioningState
            ...
            return deserializedGuardDutyDetectorProperties;
        });
    }
}
