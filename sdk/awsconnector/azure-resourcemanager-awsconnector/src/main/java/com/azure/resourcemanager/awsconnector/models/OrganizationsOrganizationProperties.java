 ...
 */
@Fluent
public final class OrganizationsOrganizationProperties
    implements JsonSerializable<OrganizationsOrganizationProperties> {
    /*
     * AWS Properties
     */
    private AwsOrganizationsOrganizationProperties awsProperties;
    ...
    /**
     * Creates an instance of OrganizationsOrganizationProperties class.
     */
     ...
     */
    public AwsOrganizationsOrganizationProperties awsProperties() {
     ...
     * @return the OrganizationsOrganizationProperties object itself.
     */
    public OrganizationsOrganizationProperties withAwsProperties(AwsOrganizationsOrganizationProperties awsProperties) {
     ...
     * @return the OrganizationsOrganizationProperties object itself.
     */
    public OrganizationsOrganizationProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the OrganizationsOrganizationProperties object itself.
     */
    public OrganizationsOrganizationProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the OrganizationsOrganizationProperties object itself.
     */
    public OrganizationsOrganizationProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the OrganizationsOrganizationProperties object itself.
     */
    public OrganizationsOrganizationProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the OrganizationsOrganizationProperties object itself.
     */
    public OrganizationsOrganizationProperties withAwsRegion(String awsRegion) {
     ...
     * @return the OrganizationsOrganizationProperties object itself.
     */
    public OrganizationsOrganizationProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of OrganizationsOrganizationProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of OrganizationsOrganizationProperties if the JsonReader was pointing to an instance of it,
     * or null if it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the OrganizationsOrganizationProperties.
     */
    public static OrganizationsOrganizationProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            OrganizationsOrganizationProperties deserializedOrganizationsOrganizationProperties
                = new OrganizationsOrganizationProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedOrganizationsOrganizationProperties.awsProperties
                        = AwsOrganizationsOrganizationProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedOrganizationsOrganizationProperties.publicCloudConnectorsResourceId
                        = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedOrganizationsOrganizationProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedOrganizationsOrganizationProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedOrganizationsOrganizationProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedOrganizationsOrganizationProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedOrganizationsOrganizationProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedOrganizationsOrganizationProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedOrganizationsOrganizationProperties.provisioningState
            ...
            return deserializedOrganizationsOrganizationProperties;
        });
    }
}
