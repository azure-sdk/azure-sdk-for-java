 ...
 */
@Fluent
public final class S3AccessControlPolicyProperties implements JsonSerializable<S3AccessControlPolicyProperties> {
    /*
     * AWS Properties
     */
    private AwsS3AccessControlPolicyProperties awsProperties;
    ...
    /**
     * Creates an instance of S3AccessControlPolicyProperties class.
     */
     ...
     */
    public AwsS3AccessControlPolicyProperties awsProperties() {
     ...
     * @return the S3AccessControlPolicyProperties object itself.
     */
    public S3AccessControlPolicyProperties withAwsProperties(AwsS3AccessControlPolicyProperties awsProperties) {
     ...
     * @return the S3AccessControlPolicyProperties object itself.
     */
    public S3AccessControlPolicyProperties withPublicCloudConnectorsResourceId(String publicCloudConnectorsResourceId) {
     ...
     * @return the S3AccessControlPolicyProperties object itself.
     */
    public S3AccessControlPolicyProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the S3AccessControlPolicyProperties object itself.
     */
    public S3AccessControlPolicyProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the S3AccessControlPolicyProperties object itself.
     */
    public S3AccessControlPolicyProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the S3AccessControlPolicyProperties object itself.
     */
    public S3AccessControlPolicyProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the S3AccessControlPolicyProperties object itself.
     */
    public S3AccessControlPolicyProperties withAwsRegion(String awsRegion) {
     ...
     * @return the S3AccessControlPolicyProperties object itself.
     */
    public S3AccessControlPolicyProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of S3AccessControlPolicyProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of S3AccessControlPolicyProperties if the JsonReader was pointing to an instance of it, or
     * null if it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the S3AccessControlPolicyProperties.
     */
    public static S3AccessControlPolicyProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            S3AccessControlPolicyProperties deserializedS3AccessControlPolicyProperties
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("awsProperties".equals(fieldName)) {
                    deserializedS3AccessControlPolicyProperties.awsProperties
                        = AwsS3AccessControlPolicyProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedS3AccessControlPolicyProperties.publicCloudConnectorsResourceId = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedS3AccessControlPolicyProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedS3AccessControlPolicyProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedS3AccessControlPolicyProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedS3AccessControlPolicyProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedS3AccessControlPolicyProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedS3AccessControlPolicyProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedS3AccessControlPolicyProperties.provisioningState
            ...
            return deserializedS3AccessControlPolicyProperties;
        });
    }
}
