 ...
 */
@Fluent
public final class CacheBehavior implements JsonSerializable<CacheBehavior> {
    /*
     ...
     * in the *Amazon CloudFront Developer Guide*. A ``CacheBehavior`` must include either a ``CachePolicyId`` or
     ...
     * specific fields of data for this cache behavior.
     */
     ...
     * policies.html) in the *Amazon CloudFront Developer Guide*. A ``CacheBehavior`` must include either a
     ...
     * cache behaviors are listed in the distribution. You can optionally include a slash (``/``) at the beginning of
     * the path pattern. For example, ``/images/*.jpg``. CloudFront behavior is the same with or without the leading
     ...
     * cache behavior. For more information, see [Path
     * Pattern](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/distribution-web-values-specify.html#
     * DownloadDistValuesPathPattern) in the *Amazon CloudFront Developer Guide*.
     */
    ...
    /*
     * The value of ``ID`` for the origin that you want CloudFront to route requests to when they match this cache
     * behavior.
     */
     ...
     * URLs or cookies must be signed with the private key of a CloudFront key pair in the trusted signer's AWS-account.
    ...
    /**
     * Creates an instance of CacheBehavior class.
     */
     ...
     * @return the CacheBehavior object itself.
     */
    ...
    /**
     * Get the cachePolicyId property: The unique identifier of the cache policy that is attached to this cache
    ...
    /**
     * Set the cachePolicyId property: The unique identifier of the cache policy that is attached to this cache
     * behavior. For more information, see [Creating cache
     * policies](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/controlling-the-cache-key.html#cache-key-create-cache-policy)
     * or [Using the managed cache
     * policies](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/using-managed-cache-policies.html)
     ...
     * @return the CacheBehavior object itself.
     */
    public CacheBehavior withDefaultTtl(Integer defaultTtl) {
     ...
     * you want CloudFront to use for encrypting specific fields of data for this cache behavior.
     * 
     ...
     * @return the CacheBehavior object itself.
     */
    public CacheBehavior withFunctionAssociations(List<FunctionAssociation> functionAssociations) {
     ...
     * @return the CacheBehavior object itself.
     */
    public CacheBehavior withMaxTtl(Integer maxTtl) {
        this.maxTtl = maxTtl;
        return this;
    }
     ...
     * @return the CacheBehavior object itself.
     */
    public CacheBehavior withMinTtl(Integer minTtl) {
        this.minTtl = minTtl;
        return this;
    }
    ...
    /**
     * Get the pathPattern property: The pattern (for example, ``images/*.jpg``) that specifies which requests to apply
     * the behavior to. When CloudFront receives a viewer request, the requested path is compared with path patterns in
     * the order in which cache behaviors are listed in the distribution. You can optionally include a slash (``/``) at
     * the beginning of the path pattern. For example, ``/images/*.jpg``. CloudFront behavior is the same with or
     * without the leading ``/``. The path pattern for the default cache behavior is ``*`` and cannot be changed. If the
     * request for an object does not match the path pattern for any cache behaviors, CloudFront applies the behavior in
    ...
    /**
     * Set the pathPattern property: The pattern (for example, ``images/*.jpg``) that specifies which requests to apply
     * the behavior to. When CloudFront receives a viewer request, the requested path is compared with path patterns in
     * the order in which cache behaviors are listed in the distribution. You can optionally include a slash (``/``) at
     * the beginning of the path pattern. For example, ``/images/*.jpg``. CloudFront behavior is the same with or
     * without the leading ``/``. The path pattern for the default cache behavior is ``*`` and cannot be changed. If the
     ...
     * @return the CacheBehavior object itself.
     */
    public CacheBehavior withTrustedKeyGroups(List<String> trustedKeyGroups) {
     ...
     * the cache behavior. The URLs or cookies must be signed with the private key of a CloudFront key pair in the
     * trusted signer's AWS-account. The signed URL or cookie contains information about which public key CloudFront
    ...
    /**
     * Reads an instance of CacheBehavior from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of CacheBehavior if the JsonReader was pointing to an instance of it, or null if it was
     * pointing to JSON null.
     * @throws IOException If an error occurs while reading the CacheBehavior.
     */
    public static CacheBehavior fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            CacheBehavior deserializedCacheBehavior = new CacheBehavior();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("allowedMethods".equals(fieldName)) {
                    ...
                    deserializedCacheBehavior.allowedMethods = allowedMethods;
                } else if ("cachePolicyId".equals(fieldName)) {
                    deserializedCacheBehavior.cachePolicyId = reader.getString();
                } else if ("cachedMethods".equals(fieldName)) {
                    List<String> cachedMethods = reader.readArray(reader1 -> reader1.getString());
                    deserializedCacheBehavior.cachedMethods = cachedMethods;
                } else if ("compress".equals(fieldName)) {
                    deserializedCacheBehavior.compress = reader.getNullable(JsonReader::getBoolean);
                } else if ("defaultTTL".equals(fieldName)) {
                    deserializedCacheBehavior.defaultTtl = reader.getNullable(JsonReader::getInt);
                } else if ("fieldLevelEncryptionId".equals(fieldName)) {
                    deserializedCacheBehavior.fieldLevelEncryptionId = reader.getString();
                } else if ("forwardedValues".equals(fieldName)) {
                    deserializedCacheBehavior.forwardedValues = ForwardedValues.fromJson(reader);
                    ...
                    deserializedCacheBehavior.functionAssociations = functionAssociations;
                    ...
                    deserializedCacheBehavior.lambdaFunctionAssociations = lambdaFunctionAssociations;
                } else if ("maxTTL".equals(fieldName)) {
                    deserializedCacheBehavior.maxTtl = reader.getNullable(JsonReader::getInt);
                } else if ("minTTL".equals(fieldName)) {
                    deserializedCacheBehavior.minTtl = reader.getNullable(JsonReader::getInt);
                } else if ("originRequestPolicyId".equals(fieldName)) {
                    deserializedCacheBehavior.originRequestPolicyId = reader.getString();
                } else if ("pathPattern".equals(fieldName)) {
                    deserializedCacheBehavior.pathPattern = reader.getString();
                } else if ("realtimeLogConfigArn".equals(fieldName)) {
                    deserializedCacheBehavior.realtimeLogConfigArn = reader.getString();
                } else if ("responseHeadersPolicyId".equals(fieldName)) {
                    deserializedCacheBehavior.responseHeadersPolicyId = reader.getString();
                } else if ("smoothStreaming".equals(fieldName)) {
                    deserializedCacheBehavior.smoothStreaming = reader.getNullable(JsonReader::getBoolean);
                } else if ("targetOriginId".equals(fieldName)) {
                    deserializedCacheBehavior.targetOriginId = reader.getString();
                } else if ("trustedKeyGroups".equals(fieldName)) {
                    List<String> trustedKeyGroups = reader.readArray(reader1 -> reader1.getString());
                    deserializedCacheBehavior.trustedKeyGroups = trustedKeyGroups;
                } else if ("trustedSigners".equals(fieldName)) {
                    List<String> trustedSigners = reader.readArray(reader1 -> reader1.getString());
                    deserializedCacheBehavior.trustedSigners = trustedSigners;
                } else if ("viewerProtocolPolicy".equals(fieldName)) {
                    deserializedCacheBehavior.viewerProtocolPolicy = reader.getString();
                } else {
                    reader.skipChildren();
                }
            }

            return deserializedCacheBehavior;
        });
    }
}
