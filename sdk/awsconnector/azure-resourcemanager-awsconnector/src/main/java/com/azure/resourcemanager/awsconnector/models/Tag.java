...
public final class Tag implements JsonSerializable<Tag> {
    ...
    /**
     * Get the key property: The key name of the tag. You can specify a value that is 1 to 127 Unicode characters in
    ...
    /**
     * Set the key property: The key name of the tag. You can specify a value that is 1 to 127 Unicode characters in
     * length and cannot be prefixed with aws:. You can use any of the following characters: the set of Unicode letters,
     * digits, whitespace, _, ., /, =, +, and -.
     * 
    ...
    /**
     * Get the value property: The value for the tag. You can specify a value that is 1 to 255 Unicode characters in
     * length and cannot be prefixed with aws:. You can use any of the following characters: the set of Unicode letters,
     * digits, whitespace, _, ., /, =, +, and -.
     * 
    ...
    /**
     * Set the value property: The value for the tag. You can specify a value that is 1 to 255 Unicode characters in
     * length and cannot be prefixed with aws:. You can use any of the following characters: the set of Unicode letters,
     * digits, whitespace, _, ., /, =, +, and -.
     * 
