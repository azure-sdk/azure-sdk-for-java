 ...
 */
@Fluent
public final class ApiGatewayStageProperties implements JsonSerializable<ApiGatewayStageProperties> {
    /*
     * AWS Properties
     */
    private AwsApiGatewayStageProperties awsProperties;
    ...
    /**
     * Creates an instance of ApiGatewayStageProperties class.
     */
     ...
     */
    public AwsApiGatewayStageProperties awsProperties() {
     ...
     * @return the ApiGatewayStageProperties object itself.
     */
    public ApiGatewayStageProperties withAwsProperties(AwsApiGatewayStageProperties awsProperties) {
     ...
     * @return the ApiGatewayStageProperties object itself.
     */
    public ApiGatewayStageProperties withPublicCloudConnectorsResourceId(String publicCloudConnectorsResourceId) {
     ...
     * @return the ApiGatewayStageProperties object itself.
     */
    public ApiGatewayStageProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the ApiGatewayStageProperties object itself.
     */
    public ApiGatewayStageProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the ApiGatewayStageProperties object itself.
     */
    public ApiGatewayStageProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the ApiGatewayStageProperties object itself.
     */
    public ApiGatewayStageProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the ApiGatewayStageProperties object itself.
     */
    public ApiGatewayStageProperties withAwsRegion(String awsRegion) {
     ...
     * @return the ApiGatewayStageProperties object itself.
     */
    public ApiGatewayStageProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of ApiGatewayStageProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of ApiGatewayStageProperties if the JsonReader was pointing to an instance of it, or null if
     * it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the ApiGatewayStageProperties.
     */
    public static ApiGatewayStageProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ApiGatewayStageProperties deserializedApiGatewayStageProperties = new ApiGatewayStageProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedApiGatewayStageProperties.awsProperties = AwsApiGatewayStageProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedApiGatewayStageProperties.publicCloudConnectorsResourceId = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedApiGatewayStageProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedApiGatewayStageProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedApiGatewayStageProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedApiGatewayStageProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedApiGatewayStageProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedApiGatewayStageProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedApiGatewayStageProperties.provisioningState
            ...
            return deserializedApiGatewayStageProperties;
        });
    }
}
