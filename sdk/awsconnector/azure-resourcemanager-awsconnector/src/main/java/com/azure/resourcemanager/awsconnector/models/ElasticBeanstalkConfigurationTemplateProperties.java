 ...
 */
@Fluent
public final class ElasticBeanstalkConfigurationTemplateProperties
    implements JsonSerializable<ElasticBeanstalkConfigurationTemplateProperties> {
    /*
     * AWS Properties
     */
    private AwsElasticBeanstalkConfigurationTemplateProperties awsProperties;
    ...
    /**
     * Creates an instance of ElasticBeanstalkConfigurationTemplateProperties class.
     */
     ...
     */
    public AwsElasticBeanstalkConfigurationTemplateProperties awsProperties() {
     ...
     * @return the ElasticBeanstalkConfigurationTemplateProperties object itself.
     */
    public ElasticBeanstalkConfigurationTemplateProperties
        withAwsProperties(AwsElasticBeanstalkConfigurationTemplateProperties awsProperties) {
     ...
     * @return the ElasticBeanstalkConfigurationTemplateProperties object itself.
     */
    public ElasticBeanstalkConfigurationTemplateProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the ElasticBeanstalkConfigurationTemplateProperties object itself.
     */
    public ElasticBeanstalkConfigurationTemplateProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the ElasticBeanstalkConfigurationTemplateProperties object itself.
     */
    public ElasticBeanstalkConfigurationTemplateProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the ElasticBeanstalkConfigurationTemplateProperties object itself.
     */
    public ElasticBeanstalkConfigurationTemplateProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the ElasticBeanstalkConfigurationTemplateProperties object itself.
     */
    public ElasticBeanstalkConfigurationTemplateProperties withAwsRegion(String awsRegion) {
     ...
     * @return the ElasticBeanstalkConfigurationTemplateProperties object itself.
     */
    public ElasticBeanstalkConfigurationTemplateProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of ElasticBeanstalkConfigurationTemplateProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of ElasticBeanstalkConfigurationTemplateProperties if the JsonReader was pointing to an
     * instance of it, or null if it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the ElasticBeanstalkConfigurationTemplateProperties.
     */
    public static ElasticBeanstalkConfigurationTemplateProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ElasticBeanstalkConfigurationTemplateProperties deserializedElasticBeanstalkConfigurationTemplateProperties
                = new ElasticBeanstalkConfigurationTemplateProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedElasticBeanstalkConfigurationTemplateProperties.awsProperties
                        = AwsElasticBeanstalkConfigurationTemplateProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedElasticBeanstalkConfigurationTemplateProperties.publicCloudConnectorsResourceId
                        = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedElasticBeanstalkConfigurationTemplateProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedElasticBeanstalkConfigurationTemplateProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedElasticBeanstalkConfigurationTemplateProperties.publicCloudResourceName
                        = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedElasticBeanstalkConfigurationTemplateProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedElasticBeanstalkConfigurationTemplateProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedElasticBeanstalkConfigurationTemplateProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedElasticBeanstalkConfigurationTemplateProperties.provisioningState
            ...
            return deserializedElasticBeanstalkConfigurationTemplateProperties;
        });
    }
}
