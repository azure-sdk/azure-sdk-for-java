 ...
 */
@Fluent
public final class RdsDBInstanceProperties implements JsonSerializable<RdsDBInstanceProperties> {
    /*
     * AWS Properties
     */
    private AwsRdsDBInstanceProperties awsProperties;
    ...
    /**
     * Creates an instance of RdsDBInstanceProperties class.
     */
    public RdsDBInstanceProperties() {
    }
     ...
     */
    public AwsRdsDBInstanceProperties awsProperties() {
     ...
     * @return the RdsDBInstanceProperties object itself.
     */
    public RdsDBInstanceProperties withAwsProperties(AwsRdsDBInstanceProperties awsProperties) {
     ...
     * @return the RdsDBInstanceProperties object itself.
     */
    public RdsDBInstanceProperties withPublicCloudConnectorsResourceId(String publicCloudConnectorsResourceId) {
     ...
     * @return the RdsDBInstanceProperties object itself.
     */
    public RdsDBInstanceProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the RdsDBInstanceProperties object itself.
     */
    public RdsDBInstanceProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the RdsDBInstanceProperties object itself.
     */
    public RdsDBInstanceProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the RdsDBInstanceProperties object itself.
     */
    public RdsDBInstanceProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the RdsDBInstanceProperties object itself.
     */
    public RdsDBInstanceProperties withAwsRegion(String awsRegion) {
     ...
     * @return the RdsDBInstanceProperties object itself.
     */
    public RdsDBInstanceProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of RdsDBInstanceProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of RdsDBInstanceProperties if the JsonReader was pointing to an instance of it, or null if it
     * was pointing to JSON null.
     * @throws IOException If an error occurs while reading the RdsDBInstanceProperties.
     */
    public static RdsDBInstanceProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            RdsDBInstanceProperties deserializedRdsDBInstanceProperties = new RdsDBInstanceProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedRdsDBInstanceProperties.awsProperties = AwsRdsDBInstanceProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedRdsDBInstanceProperties.publicCloudConnectorsResourceId = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedRdsDBInstanceProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedRdsDBInstanceProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedRdsDBInstanceProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedRdsDBInstanceProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedRdsDBInstanceProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedRdsDBInstanceProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedRdsDBInstanceProperties.provisioningState
            ...
            return deserializedRdsDBInstanceProperties;
        });
    }
}
