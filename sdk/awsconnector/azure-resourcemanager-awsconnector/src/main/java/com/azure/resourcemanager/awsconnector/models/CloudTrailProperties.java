 ...
 */
@Fluent
public final class CloudTrailProperties implements JsonSerializable<CloudTrailProperties> {
    /*
     * AWS Properties
     */
    private AwsCloudTrailProperties awsProperties;
    ...
    /**
     * Creates an instance of CloudTrailProperties class.
     */
     ...
     */
    public AwsCloudTrailProperties awsProperties() {
     ...
     * @return the CloudTrailProperties object itself.
     */
    public CloudTrailProperties withAwsProperties(AwsCloudTrailProperties awsProperties) {
     ...
     * @return the CloudTrailProperties object itself.
     */
    public CloudTrailProperties withPublicCloudConnectorsResourceId(String publicCloudConnectorsResourceId) {
     ...
     * @return the CloudTrailProperties object itself.
     */
    public CloudTrailProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the CloudTrailProperties object itself.
     */
    public CloudTrailProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the CloudTrailProperties object itself.
     */
    public CloudTrailProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the CloudTrailProperties object itself.
     */
    public CloudTrailProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the CloudTrailProperties object itself.
     */
    public CloudTrailProperties withAwsRegion(String awsRegion) {
     ...
     * @return the CloudTrailProperties object itself.
     */
    public CloudTrailProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of CloudTrailProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of CloudTrailProperties if the JsonReader was pointing to an instance of it, or null if it
     * was pointing to JSON null.
     * @throws IOException If an error occurs while reading the CloudTrailProperties.
     */
    public static CloudTrailProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            CloudTrailProperties deserializedCloudTrailProperties = new CloudTrailProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedCloudTrailProperties.awsProperties = AwsCloudTrailProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedCloudTrailProperties.publicCloudConnectorsResourceId = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedCloudTrailProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedCloudTrailProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedCloudTrailProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedCloudTrailProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedCloudTrailProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedCloudTrailProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedCloudTrailProperties.provisioningState
            ...
            return deserializedCloudTrailProperties;
        });
    }
}
