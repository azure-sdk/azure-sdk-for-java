 ...
 */
@Fluent
public final class IamGroupProperties implements JsonSerializable<IamGroupProperties> {
    /*
     * AWS Properties
     */
    private AwsIamGroupProperties awsProperties;
    ...
    /**
     * Creates an instance of IamGroupProperties class.
     */
     ...
     */
    public AwsIamGroupProperties awsProperties() {
     ...
     * @return the IamGroupProperties object itself.
     */
    public IamGroupProperties withAwsProperties(AwsIamGroupProperties awsProperties) {
     ...
     * @return the IamGroupProperties object itself.
     */
    public IamGroupProperties withPublicCloudConnectorsResourceId(String publicCloudConnectorsResourceId) {
     ...
     * @return the IamGroupProperties object itself.
     */
    public IamGroupProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the IamGroupProperties object itself.
     */
    public IamGroupProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the IamGroupProperties object itself.
     */
    public IamGroupProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the IamGroupProperties object itself.
     */
    public IamGroupProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the IamGroupProperties object itself.
     */
    public IamGroupProperties withAwsRegion(String awsRegion) {
     ...
     * @return the IamGroupProperties object itself.
     */
    public IamGroupProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of IamGroupProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of IamGroupProperties if the JsonReader was pointing to an instance of it, or null if it was
     * pointing to JSON null.
     * @throws IOException If an error occurs while reading the IamGroupProperties.
     */
    public static IamGroupProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            IamGroupProperties deserializedIamGroupProperties = new IamGroupProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedIamGroupProperties.awsProperties = AwsIamGroupProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedIamGroupProperties.publicCloudConnectorsResourceId = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedIamGroupProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedIamGroupProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedIamGroupProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedIamGroupProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedIamGroupProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedIamGroupProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedIamGroupProperties.provisioningState = ProvisioningState.fromString(reader.getString());
                } else {
                    reader.skipChildren();
                }
            }

            return deserializedIamGroupProperties;
        });
    }
}
