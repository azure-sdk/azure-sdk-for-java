 ...
 */
@Fluent
public final class S3AccessPointProperties implements JsonSerializable<S3AccessPointProperties> {
    /*
     * AWS Properties
     */
    private AwsS3AccessPointProperties awsProperties;
    ...
    /**
     * Creates an instance of S3AccessPointProperties class.
     */
     ...
     */
    public AwsS3AccessPointProperties awsProperties() {
     ...
     * @return the S3AccessPointProperties object itself.
     */
    public S3AccessPointProperties withAwsProperties(AwsS3AccessPointProperties awsProperties) {
     ...
     * @return the S3AccessPointProperties object itself.
     */
    public S3AccessPointProperties withPublicCloudConnectorsResourceId(String publicCloudConnectorsResourceId) {
     ...
     * @return the S3AccessPointProperties object itself.
     */
    public S3AccessPointProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the S3AccessPointProperties object itself.
     */
    public S3AccessPointProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the S3AccessPointProperties object itself.
     */
    public S3AccessPointProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the S3AccessPointProperties object itself.
     */
    public S3AccessPointProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the S3AccessPointProperties object itself.
     */
    public S3AccessPointProperties withAwsRegion(String awsRegion) {
     ...
     * @return the S3AccessPointProperties object itself.
     */
    public S3AccessPointProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of S3AccessPointProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of S3AccessPointProperties if the JsonReader was pointing to an instance of it, or null if it
     * was pointing to JSON null.
     * @throws IOException If an error occurs while reading the S3AccessPointProperties.
     */
    public static S3AccessPointProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            S3AccessPointProperties deserializedS3AccessPointProperties = new S3AccessPointProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedS3AccessPointProperties.awsProperties = AwsS3AccessPointProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedS3AccessPointProperties.publicCloudConnectorsResourceId = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedS3AccessPointProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedS3AccessPointProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedS3AccessPointProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedS3AccessPointProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedS3AccessPointProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedS3AccessPointProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedS3AccessPointProperties.provisioningState
            ...
            return deserializedS3AccessPointProperties;
        });
    }
}
