 ...
 */
@Fluent
public final class IamAccessKeyMetadataProperties implements JsonSerializable<IamAccessKeyMetadataProperties> {
    /*
     * AWS Properties
     */
    private AwsIamAccessKeyMetadataProperties awsProperties;
    ...
    /**
     * Creates an instance of IamAccessKeyMetadataProperties class.
     */
     ...
     */
    public AwsIamAccessKeyMetadataProperties awsProperties() {
     ...
     * @return the IamAccessKeyMetadataProperties object itself.
     */
    public IamAccessKeyMetadataProperties withAwsProperties(AwsIamAccessKeyMetadataProperties awsProperties) {
     ...
     * @return the IamAccessKeyMetadataProperties object itself.
     */
    public IamAccessKeyMetadataProperties withPublicCloudConnectorsResourceId(String publicCloudConnectorsResourceId) {
     ...
     * @return the IamAccessKeyMetadataProperties object itself.
     */
    public IamAccessKeyMetadataProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the IamAccessKeyMetadataProperties object itself.
     */
    public IamAccessKeyMetadataProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the IamAccessKeyMetadataProperties object itself.
     */
    public IamAccessKeyMetadataProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the IamAccessKeyMetadataProperties object itself.
     */
    public IamAccessKeyMetadataProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the IamAccessKeyMetadataProperties object itself.
     */
    public IamAccessKeyMetadataProperties withAwsRegion(String awsRegion) {
     ...
     * @return the IamAccessKeyMetadataProperties object itself.
     */
    public IamAccessKeyMetadataProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of IamAccessKeyMetadataProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of IamAccessKeyMetadataProperties if the JsonReader was pointing to an instance of it, or
     * null if it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the IamAccessKeyMetadataProperties.
     */
    public static IamAccessKeyMetadataProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            IamAccessKeyMetadataProperties deserializedIamAccessKeyMetadataProperties
                = new IamAccessKeyMetadataProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedIamAccessKeyMetadataProperties.awsProperties
                        = AwsIamAccessKeyMetadataProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedIamAccessKeyMetadataProperties.publicCloudConnectorsResourceId = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedIamAccessKeyMetadataProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedIamAccessKeyMetadataProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedIamAccessKeyMetadataProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedIamAccessKeyMetadataProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedIamAccessKeyMetadataProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedIamAccessKeyMetadataProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedIamAccessKeyMetadataProperties.provisioningState
            ...
            return deserializedIamAccessKeyMetadataProperties;
        });
    }
}
