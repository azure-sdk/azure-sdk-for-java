 ...
 */
@Fluent
public final class LambdaFunctionCodeLocationProperties
    implements JsonSerializable<LambdaFunctionCodeLocationProperties> {
    /*
     * AWS Properties
     */
    private AwsLambdaFunctionCodeLocationProperties awsProperties;
    ...
    /**
     * Creates an instance of LambdaFunctionCodeLocationProperties class.
     */
     ...
     */
    public AwsLambdaFunctionCodeLocationProperties awsProperties() {
     ...
     * @return the LambdaFunctionCodeLocationProperties object itself.
     */
    public LambdaFunctionCodeLocationProperties
        withAwsProperties(AwsLambdaFunctionCodeLocationProperties awsProperties) {
     ...
     * @return the LambdaFunctionCodeLocationProperties object itself.
     */
    public LambdaFunctionCodeLocationProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the LambdaFunctionCodeLocationProperties object itself.
     */
    public LambdaFunctionCodeLocationProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the LambdaFunctionCodeLocationProperties object itself.
     */
    public LambdaFunctionCodeLocationProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the LambdaFunctionCodeLocationProperties object itself.
     */
    public LambdaFunctionCodeLocationProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the LambdaFunctionCodeLocationProperties object itself.
     */
    public LambdaFunctionCodeLocationProperties withAwsRegion(String awsRegion) {
     ...
     * @return the LambdaFunctionCodeLocationProperties object itself.
     */
    public LambdaFunctionCodeLocationProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of LambdaFunctionCodeLocationProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of LambdaFunctionCodeLocationProperties if the JsonReader was pointing to an instance of it,
     * or null if it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the LambdaFunctionCodeLocationProperties.
     */
    public static LambdaFunctionCodeLocationProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            LambdaFunctionCodeLocationProperties deserializedLambdaFunctionCodeLocationProperties
                = new LambdaFunctionCodeLocationProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedLambdaFunctionCodeLocationProperties.awsProperties
                        = AwsLambdaFunctionCodeLocationProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedLambdaFunctionCodeLocationProperties.publicCloudConnectorsResourceId
                        = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedLambdaFunctionCodeLocationProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedLambdaFunctionCodeLocationProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedLambdaFunctionCodeLocationProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedLambdaFunctionCodeLocationProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedLambdaFunctionCodeLocationProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedLambdaFunctionCodeLocationProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedLambdaFunctionCodeLocationProperties.provisioningState
            ...
            return deserializedLambdaFunctionCodeLocationProperties;
        });
    }
}
