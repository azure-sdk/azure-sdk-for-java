 ...
 */
@Fluent
public final class SsmResourceComplianceSummaryItemProperties
    implements JsonSerializable<SsmResourceComplianceSummaryItemProperties> {
    /*
     * AWS Properties
     */
    private AwsSsmResourceComplianceSummaryItemProperties awsProperties;
    ...
    /**
     * Creates an instance of SsmResourceComplianceSummaryItemProperties class.
     */
    public SsmResourceComplianceSummaryItemProperties() {
    }
     ...
     */
    public AwsSsmResourceComplianceSummaryItemProperties awsProperties() {
     ...
     * @return the SsmResourceComplianceSummaryItemProperties object itself.
     */
    public SsmResourceComplianceSummaryItemProperties
        withAwsProperties(AwsSsmResourceComplianceSummaryItemProperties awsProperties) {
     ...
     * @return the SsmResourceComplianceSummaryItemProperties object itself.
     */
    public SsmResourceComplianceSummaryItemProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the SsmResourceComplianceSummaryItemProperties object itself.
     */
    public SsmResourceComplianceSummaryItemProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the SsmResourceComplianceSummaryItemProperties object itself.
     */
    public SsmResourceComplianceSummaryItemProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the SsmResourceComplianceSummaryItemProperties object itself.
     */
    public SsmResourceComplianceSummaryItemProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the SsmResourceComplianceSummaryItemProperties object itself.
     */
    public SsmResourceComplianceSummaryItemProperties withAwsRegion(String awsRegion) {
     ...
     * @return the SsmResourceComplianceSummaryItemProperties object itself.
     */
    public SsmResourceComplianceSummaryItemProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of SsmResourceComplianceSummaryItemProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of SsmResourceComplianceSummaryItemProperties if the JsonReader was pointing to an instance
     * of it, or null if it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the SsmResourceComplianceSummaryItemProperties.
     */
    public static SsmResourceComplianceSummaryItemProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            SsmResourceComplianceSummaryItemProperties deserializedSsmResourceComplianceSummaryItemProperties
                = new SsmResourceComplianceSummaryItemProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedSsmResourceComplianceSummaryItemProperties.awsProperties
                        = AwsSsmResourceComplianceSummaryItemProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedSsmResourceComplianceSummaryItemProperties.publicCloudConnectorsResourceId
                        = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedSsmResourceComplianceSummaryItemProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedSsmResourceComplianceSummaryItemProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedSsmResourceComplianceSummaryItemProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedSsmResourceComplianceSummaryItemProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedSsmResourceComplianceSummaryItemProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedSsmResourceComplianceSummaryItemProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedSsmResourceComplianceSummaryItemProperties.provisioningState
            ...
            return deserializedSsmResourceComplianceSummaryItemProperties;
        });
    }
}
