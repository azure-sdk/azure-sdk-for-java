 ...
 */
@Fluent
public final class CodeBuildSourceCredentialsInfoProperties
    implements JsonSerializable<CodeBuildSourceCredentialsInfoProperties> {
    /*
     * AWS Properties
     */
    private AwsCodeBuildSourceCredentialsInfoProperties awsProperties;
    ...
    /**
     * Creates an instance of CodeBuildSourceCredentialsInfoProperties class.
     */
     ...
     */
    public AwsCodeBuildSourceCredentialsInfoProperties awsProperties() {
     ...
     * @return the CodeBuildSourceCredentialsInfoProperties object itself.
     */
    public CodeBuildSourceCredentialsInfoProperties
        withAwsProperties(AwsCodeBuildSourceCredentialsInfoProperties awsProperties) {
     ...
     * @return the CodeBuildSourceCredentialsInfoProperties object itself.
     */
    public CodeBuildSourceCredentialsInfoProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the CodeBuildSourceCredentialsInfoProperties object itself.
     */
    public CodeBuildSourceCredentialsInfoProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the CodeBuildSourceCredentialsInfoProperties object itself.
     */
    public CodeBuildSourceCredentialsInfoProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the CodeBuildSourceCredentialsInfoProperties object itself.
     */
    public CodeBuildSourceCredentialsInfoProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the CodeBuildSourceCredentialsInfoProperties object itself.
     */
    public CodeBuildSourceCredentialsInfoProperties withAwsRegion(String awsRegion) {
     ...
     * @return the CodeBuildSourceCredentialsInfoProperties object itself.
     */
    public CodeBuildSourceCredentialsInfoProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of CodeBuildSourceCredentialsInfoProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of CodeBuildSourceCredentialsInfoProperties if the JsonReader was pointing to an instance of
     * it, or null if it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the CodeBuildSourceCredentialsInfoProperties.
     */
    public static CodeBuildSourceCredentialsInfoProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            CodeBuildSourceCredentialsInfoProperties deserializedCodeBuildSourceCredentialsInfoProperties
                = new CodeBuildSourceCredentialsInfoProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedCodeBuildSourceCredentialsInfoProperties.awsProperties
                        = AwsCodeBuildSourceCredentialsInfoProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedCodeBuildSourceCredentialsInfoProperties.publicCloudConnectorsResourceId
                        = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedCodeBuildSourceCredentialsInfoProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedCodeBuildSourceCredentialsInfoProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedCodeBuildSourceCredentialsInfoProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedCodeBuildSourceCredentialsInfoProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedCodeBuildSourceCredentialsInfoProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedCodeBuildSourceCredentialsInfoProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedCodeBuildSourceCredentialsInfoProperties.provisioningState
            ...
            return deserializedCodeBuildSourceCredentialsInfoProperties;
        });
    }
}
