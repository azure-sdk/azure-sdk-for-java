 ...
 */
@Fluent
public final class EcsClusterProperties implements JsonSerializable<EcsClusterProperties> {
    /*
     * AWS Properties
     */
    private AwsEcsClusterProperties awsProperties;
    ...
    /**
     * Creates an instance of EcsClusterProperties class.
     */
     ...
     */
    public AwsEcsClusterProperties awsProperties() {
     ...
     * @return the EcsClusterProperties object itself.
     */
    public EcsClusterProperties withAwsProperties(AwsEcsClusterProperties awsProperties) {
     ...
     * @return the EcsClusterProperties object itself.
     */
    public EcsClusterProperties withPublicCloudConnectorsResourceId(String publicCloudConnectorsResourceId) {
     ...
     * @return the EcsClusterProperties object itself.
     */
    public EcsClusterProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the EcsClusterProperties object itself.
     */
    public EcsClusterProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the EcsClusterProperties object itself.
     */
    public EcsClusterProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the EcsClusterProperties object itself.
     */
    public EcsClusterProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the EcsClusterProperties object itself.
     */
    public EcsClusterProperties withAwsRegion(String awsRegion) {
     ...
     * @return the EcsClusterProperties object itself.
     */
    public EcsClusterProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of EcsClusterProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of EcsClusterProperties if the JsonReader was pointing to an instance of it, or null if it
     * was pointing to JSON null.
     * @throws IOException If an error occurs while reading the EcsClusterProperties.
     */
    public static EcsClusterProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            EcsClusterProperties deserializedEcsClusterProperties = new EcsClusterProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedEcsClusterProperties.awsProperties = AwsEcsClusterProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedEcsClusterProperties.publicCloudConnectorsResourceId = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedEcsClusterProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedEcsClusterProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedEcsClusterProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedEcsClusterProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedEcsClusterProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedEcsClusterProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedEcsClusterProperties.provisioningState
            ...
            return deserializedEcsClusterProperties;
        });
    }
}
