 ...
 */
@Fluent
public final class Macie2JobSummaryProperties implements JsonSerializable<Macie2JobSummaryProperties> {
    /*
     * AWS Properties
     */
    private AwsMacie2JobSummaryProperties awsProperties;
    ...
    /**
     * Creates an instance of Macie2JobSummaryProperties class.
     */
     ...
     */
    public AwsMacie2JobSummaryProperties awsProperties() {
     ...
     * @return the Macie2JobSummaryProperties object itself.
     */
    public Macie2JobSummaryProperties withAwsProperties(AwsMacie2JobSummaryProperties awsProperties) {
     ...
     * @return the Macie2JobSummaryProperties object itself.
     */
    public Macie2JobSummaryProperties withPublicCloudConnectorsResourceId(String publicCloudConnectorsResourceId) {
     ...
     * @return the Macie2JobSummaryProperties object itself.
     */
    public Macie2JobSummaryProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the Macie2JobSummaryProperties object itself.
     */
    public Macie2JobSummaryProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the Macie2JobSummaryProperties object itself.
     */
    public Macie2JobSummaryProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the Macie2JobSummaryProperties object itself.
     */
    public Macie2JobSummaryProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the Macie2JobSummaryProperties object itself.
     */
    public Macie2JobSummaryProperties withAwsRegion(String awsRegion) {
     ...
     * @return the Macie2JobSummaryProperties object itself.
     */
    public Macie2JobSummaryProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of Macie2JobSummaryProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of Macie2JobSummaryProperties if the JsonReader was pointing to an instance of it, or null if
     * it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the Macie2JobSummaryProperties.
     */
    public static Macie2JobSummaryProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            Macie2JobSummaryProperties deserializedMacie2JobSummaryProperties = new Macie2JobSummaryProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedMacie2JobSummaryProperties.awsProperties
                        = AwsMacie2JobSummaryProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedMacie2JobSummaryProperties.publicCloudConnectorsResourceId = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedMacie2JobSummaryProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedMacie2JobSummaryProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedMacie2JobSummaryProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedMacie2JobSummaryProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedMacie2JobSummaryProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedMacie2JobSummaryProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedMacie2JobSummaryProperties.provisioningState
            ...
            return deserializedMacie2JobSummaryProperties;
        });
    }
}
