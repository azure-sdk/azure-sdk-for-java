 ...
 */
@Fluent
public final class Ec2RouteTableProperties implements JsonSerializable<Ec2RouteTableProperties> {
    /*
     * AWS Properties
     */
    private AwsEc2RouteTableProperties awsProperties;
    ...
    /**
     * Creates an instance of Ec2RouteTableProperties class.
     */
     ...
     */
    public AwsEc2RouteTableProperties awsProperties() {
     ...
     * @return the Ec2RouteTableProperties object itself.
     */
    public Ec2RouteTableProperties withAwsProperties(AwsEc2RouteTableProperties awsProperties) {
     ...
     * @return the Ec2RouteTableProperties object itself.
     */
    public Ec2RouteTableProperties withPublicCloudConnectorsResourceId(String publicCloudConnectorsResourceId) {
     ...
     * @return the Ec2RouteTableProperties object itself.
     */
    public Ec2RouteTableProperties withAwsAccountId(String awsAccountId) {
     ...
     * @return the Ec2RouteTableProperties object itself.
     */
    public Ec2RouteTableProperties withArn(String arn) {
        this.arn = arn;
        return this;
    }
     ...
     * @return the Ec2RouteTableProperties object itself.
     */
    public Ec2RouteTableProperties withPublicCloudResourceName(String publicCloudResourceName) {
     ...
     * @return the Ec2RouteTableProperties object itself.
     */
    public Ec2RouteTableProperties withAwsSourceSchema(String awsSourceSchema) {
     ...
     * @return the Ec2RouteTableProperties object itself.
     */
    public Ec2RouteTableProperties withAwsRegion(String awsRegion) {
     ...
     * @return the Ec2RouteTableProperties object itself.
     */
    public Ec2RouteTableProperties withAwsTags(Map<String, String> awsTags) {
    ...
    /**
     * Reads an instance of Ec2RouteTableProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of Ec2RouteTableProperties if the JsonReader was pointing to an instance of it, or null if it
     * was pointing to JSON null.
     * @throws IOException If an error occurs while reading the Ec2RouteTableProperties.
     */
    public static Ec2RouteTableProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            Ec2RouteTableProperties deserializedEc2RouteTableProperties = new Ec2RouteTableProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("awsProperties".equals(fieldName)) {
                    deserializedEc2RouteTableProperties.awsProperties = AwsEc2RouteTableProperties.fromJson(reader);
                } else if ("publicCloudConnectorsResourceId".equals(fieldName)) {
                    deserializedEc2RouteTableProperties.publicCloudConnectorsResourceId = reader.getString();
                } else if ("awsAccountId".equals(fieldName)) {
                    deserializedEc2RouteTableProperties.awsAccountId = reader.getString();
                } else if ("arn".equals(fieldName)) {
                    deserializedEc2RouteTableProperties.arn = reader.getString();
                } else if ("publicCloudResourceName".equals(fieldName)) {
                    deserializedEc2RouteTableProperties.publicCloudResourceName = reader.getString();
                } else if ("awsSourceSchema".equals(fieldName)) {
                    deserializedEc2RouteTableProperties.awsSourceSchema = reader.getString();
                } else if ("awsRegion".equals(fieldName)) {
                    deserializedEc2RouteTableProperties.awsRegion = reader.getString();
                } else if ("awsTags".equals(fieldName)) {
                    Map<String, String> awsTags = reader.readMap(reader1 -> reader1.getString());
                    deserializedEc2RouteTableProperties.awsTags = awsTags;
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedEc2RouteTableProperties.provisioningState
            ...
            return deserializedEc2RouteTableProperties;
        });
    }
}
