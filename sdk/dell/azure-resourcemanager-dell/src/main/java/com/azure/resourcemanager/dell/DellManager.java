...
import com.azure.resourcemanager.dell.implementation.FileSystemsImpl;
import com.azure.resourcemanager.dell.implementation.OperationsImpl;
import com.azure.resourcemanager.dell.implementation.StorageClientBuilder;
...
/**
 * Entry point to DellManager.
 * Dell Storage service.
 */
public final class DellManager {
    ...
    private DellManager(HttpPipeline httpPipeline, AzureProfile profile, Duration defaultPollInterval) {
     ...
     */
    public static DellManager authenticate(TokenCredential credential, AzureProfile profile) {
     ...
     * @return the Dell service API instance.
     */
    public static DellManager authenticate(HttpPipeline httpPipeline, AzureProfile profile) {
        Objects.requireNonNull(httpPipeline, "'httpPipeline' cannot be null.");
        Objects.requireNonNull(profile, "'profile' cannot be null.");
        return new DellManager(httpPipeline, profile, null);
    }

    /**
     * Gets a Configurable instance that can be used to create DellManager with optional configuration.
     * 
     * @return the Configurable instance allowing configurations.
     */
    public static Configurable configure() {
        return new DellManager.Configurable();
    }
    ...
    public static final class Configurable {
        ...
        private static final Map<String, String> PROPERTIES
            = CoreUtils.getProperties("azure-resourcemanager-dell.properties");
