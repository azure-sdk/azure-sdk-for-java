...
public final class JoinRequestOperationsClientImpl implements JoinRequestOperationsClient {
    /** The proxy service used to perform REST calls. */
    private final JoinRequestOperationsService service;

    /** The service client containing this operation class. */
    private final EducationManagementClientImpl client;

    /**
     * Initializes an instance of JoinRequestOperationsClientImpl.
     *
     * @param client the instance of the service client containing this operation class.
     */
    JoinRequestOperationsClientImpl(EducationManagementClientImpl client) {
        this.service =
            RestProxy
                .create(JoinRequestOperationsService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for EducationManagementClientJoinRequestOperations to be used by the
     * proxy service to perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "EducationManagementC")
    private interface JoinRequestOperationsService {
