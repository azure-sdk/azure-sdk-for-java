...
/** Grant details. */
@Immutable
public final class GrantDetailsV2Inner extends ProxyResource {
    /*
     * Grant detail properties.
     */
    @JsonProperty(value = "properties")
    private GrantDetailPropertiesV2 innerProperties;
    ...
    /** Creates an instance of GrantDetailsV2Inner class. */
    public GrantDetailsV2Inner() {
    }
    ...
    /**
     * Get the displayName property: Grant display name.
     *
