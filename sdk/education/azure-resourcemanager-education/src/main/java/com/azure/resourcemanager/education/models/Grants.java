...
public interface Grants {
     ...
     * @return a list of grants that Microsoft has provided as paginated response with {@link PagedIterable}.
     */
    PagedIterable<GrantDetailsV2> listAllV2();
     ...
     * @return a list of grants that Microsoft has provided as paginated response with {@link PagedIterable}.
     */
    PagedIterable<GrantDetailsV2> listAllV2(Boolean includeAllocatedBudget, Context context);
     ...
     *     response with {@link PagedIterable}.
     */
    PagedIterable<GrantDetailsV2> listV2(String billingAccountName, String billingProfileName);
     ...
     *     response with {@link PagedIterable}.
     */
    PagedIterable<GrantDetailsV2> listV2(
        String billingAccountName, String billingProfileName, Boolean includeAllocatedBudget, Context context);
     ...
     *     Response}.
     */
    Response<GrantDetailsV2> getV2WithResponse(
        String billingAccountName, String billingProfileName, Boolean includeAllocatedBudget, Context context);
     ...
     * @return details for a specific grant linked to the provided billing account and billing profile.
     */
    GrantDetailsV2 getV2(String billingAccountName, String billingProfileName);
}
