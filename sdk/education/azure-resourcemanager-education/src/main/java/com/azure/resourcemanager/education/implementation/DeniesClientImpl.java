...
public final class DeniesClientImpl implements DeniesClient {
    /** The proxy service used to perform REST calls. */
    private final DeniesService service;

    /** The service client containing this operation class. */
    private final EducationManagementClientImpl client;

    /**
     * Initializes an instance of DeniesClientImpl.
     *
     * @param client the instance of the service client containing this operation class.
     */
    DeniesClientImpl(EducationManagementClientImpl client) {
        this.service = RestProxy.create(DeniesService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for EducationManagementClientDenies to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "EducationManagementC")
    private interface DeniesService {
