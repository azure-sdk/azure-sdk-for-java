...
public final class InformaticaServerlessRuntimeResourceListResult {
    ...
    /**
     * Set the value property: The InformaticaServerlessRuntimeResource items on this page.
     * 
     * @param value the value value to set.
     * @return the InformaticaServerlessRuntimeResourceListResult object itself.
     */
    public InformaticaServerlessRuntimeResourceListResult
        withValue(List<InformaticaServerlessRuntimeResourceInner> value) {
        this.value = value;
        return this;
    }
     ...
     * @return the InformaticaServerlessRuntimeResourceListResult object itself.
     */
    public InformaticaServerlessRuntimeResourceListResult withNextLink(String nextLink) {
