...
@Fluent
public final class DiagnosticSetting {
    /*
    ...
    /*
     * The workspace ID (resource ID of a Log Analytics workspace) for a Log Analytics workspace to which you would
    ...
    /** Creates an instance of DiagnosticSetting class. */
     ...
     * @return the DiagnosticSetting object itself.
     */
    public DiagnosticSetting withStorageAccountId(String storageAccountId) {
     ...
     * @return the DiagnosticSetting object itself.
     */
    public DiagnosticSetting withServiceBusRuleId(String serviceBusRuleId) {
     ...
     * @return the DiagnosticSetting object itself.
     */
    public DiagnosticSetting withWorkspaceId(String workspaceId) {
     ...
     * @return the DiagnosticSetting object itself.
     */
    public DiagnosticSetting withEventHubAuthorizationRuleId(String eventHubAuthorizationRuleId) {
     ...
     * @return the DiagnosticSetting object itself.
     */
    public DiagnosticSetting withEventHubName(String eventHubName) {
     ...
     * @return the DiagnosticSetting object itself.
     */
    public DiagnosticSetting withLogs(List<LogSettings> logs) {
        this.logs = logs;
        return this;
    }
