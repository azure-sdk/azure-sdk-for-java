...
public final class DiagnosticSettingsCategoriesClientImpl implements DiagnosticSettingsCategoriesClient {
     ...
     */
    DiagnosticSettingsCategoriesClientImpl(AadcustomsecurityattributesdiagnosticsettingsImpl client) {
        this.service =
            RestProxy
                .create(
     ...
     * AadcustomsecurityattributesdiagnosticsettingsDiagnosticSettingsCategories to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{$host}")
    ...
    public interface DiagnosticSettingsCategoriesService {
        ...
        @Get("/providers/Microsoft.AadCustomSecurityAttributesDiagnosticSettings/diagnosticSettingsCategories")
