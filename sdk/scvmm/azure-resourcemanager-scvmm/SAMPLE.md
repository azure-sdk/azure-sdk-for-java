...
public final class AvailabilitySetsCreateOrUpdateSamples {
    ...
    public static void availabilitySetsCreateOrUpdateMinimumSet(com.azure.resourcemanager.scvmm.ScvmmManager manager) {
        manager.availabilitySets().define("_").withRegion("jelevilan").withExistingResourceGroup("rgscvmm")
    ...
    public static void availabilitySetsCreateOrUpdateMaximumSet(com.azure.resourcemanager.scvmm.ScvmmManager manager) {
        manager.availabilitySets().define("-").withRegion("jelevilan").withExistingResourceGroup("rgscvmm")
            .withExtendedLocation(new ExtendedLocation().withType("bsmcn").withName("s"))
...
public final class AvailabilitySetsDeleteSamples {
    ...
    public static void availabilitySetsDeleteMaximumSet(com.azure.resourcemanager.scvmm.ScvmmManager manager) {
        manager.availabilitySets().delete("rgscvmm", "_", true, com.azure.core.util.Context.NONE);
    }
...
public final class AvailabilitySetsUpdateSamples {
    ...
    public static void availabilitySetsUpdateMinimumSet(com.azure.resourcemanager.scvmm.ScvmmManager manager) {
        AvailabilitySet resource = manager.availabilitySets()
            .getByResourceGroupWithResponse("rgscvmm", "1", com.azure.core.util.Context.NONE).getValue();
...
public final class CloudsCreateOrUpdateSamples {
    ...
    public static void cloudsCreateOrUpdateMaximumSet(com.azure.resourcemanager.scvmm.ScvmmManager manager) {
        manager.clouds().define("2").withRegion("khwsdmaxfhmbu").withExistingResourceGroup("rgscvmm")
            ...
            .withProperties(new CloudProperties().withInventoryItemId("qjd").withUuid("fpjfqldhdkxgdxejzmvwusmojufr")
                .withVmmServerId(
                    "/subscriptions/12345678-1234-1234-1234-12345678abc/resourceGroups/exampleResourceGroup/providers/Microsoft.ScVmm/vmmServers/vmmServerName"))
            .create();
    }
...
public final class CloudsDeleteSamples {
    ...
    public static void cloudsDeleteMaximumSet(com.azure.resourcemanager.scvmm.ScvmmManager manager) {
        manager.clouds().delete("rgscvmm", "-", true, com.azure.core.util.Context.NONE);
    }
...
public final class VirtualMachineInstancesCreateCheckpointSamples {
    ...
    public static void
        ...
        manager.virtualMachineInstances().createCheckpoint("gtgclehcbsyave",
            new VirtualMachineCreateCheckpoint().withName("ilvltf").withDescription("zoozhfbepldrgpjqsbhpqebtodrhvy"),
            com.azure.core.util.Context.NONE);
    }
    ...
    public static void
        ...
        manager.virtualMachineInstances().createCheckpoint("gtgclehcbsyave", new VirtualMachineCreateCheckpoint(),
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class VirtualMachineInstancesCreateOrUpdateSamples {
    ...
    public static void
        ...
        manager.virtualMachineInstances().createOrUpdate("gtgclehcbsyave",
    ...
    public static void
        ...
        manager.virtualMachineInstances().createOrUpdate("gtgclehcbsyave", new VirtualMachineInstanceInner(),
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class VirtualMachineInstancesDeleteSamples {
    ...
    public static void virtualMachineInstancesDeleteMaximumSet(com.azure.resourcemanager.scvmm.ScvmmManager manager) {
        manager.virtualMachineInstances().delete("gtgclehcbsyave", true, true, com.azure.core.util.Context.NONE);
    }
...
public final class VirtualMachineInstancesDeleteCheckpointSamples {
    ...
    public static void
        ...
        manager.virtualMachineInstances().deleteCheckpoint("gtgclehcbsyave",
    ...
    public static void
        ...
        manager.virtualMachineInstances().deleteCheckpoint("gtgclehcbsyave", new VirtualMachineDeleteCheckpoint(),
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class VirtualMachineInstancesRestoreCheckpointSamples {
    ...
    public static void
        ...
        manager.virtualMachineInstances().restoreCheckpoint("gtgclehcbsyave", new VirtualMachineRestoreCheckpoint(),
            com.azure.core.util.Context.NONE);
    }
    ...
    public static void
        ...
        manager.virtualMachineInstances().restoreCheckpoint("gtgclehcbsyave",
            new VirtualMachineRestoreCheckpoint().withId("rweqduwzsn"), com.azure.core.util.Context.NONE);
    }
}
```
...
public final class VirtualMachineTemplatesCreateOrUpdateSamples {
    ...
    public static void
        ...
        manager.virtualMachineTemplates().define("P").withRegion("ayxsyduviotylbojh")
            .withExistingResourceGroup("rgscvmm").withExtendedLocation(new ExtendedLocation()).create();
    }
    ...
    public static void
        ...
        manager.virtualMachineTemplates().define("6").withRegion("ayxsyduviotylbojh")
...
public final class VirtualMachineTemplatesDeleteSamples {
    ...
    public static void virtualMachineTemplatesDeleteMaximumSet(com.azure.resourcemanager.scvmm.ScvmmManager manager) {
        manager.virtualMachineTemplates().delete("rgscvmm", "6", true, com.azure.core.util.Context.NONE);
    }
}
```
    ...
    public static void virtualNetworksCreateOrUpdateMaximumSet(com.azure.resourcemanager.scvmm.ScvmmManager manager) {
        manager.virtualNetworks().define("_").withRegion("fky").withExistingResourceGroup("rgscvmm")
            ...
            .withProperties(new VirtualNetworkProperties().withInventoryItemId("bxn")
                .withUuid("frgopsbqsutlipgfuokvsjpgdwrk").withVmmServerId(
                    "/subscriptions/12345678-1234-1234-1234-12345678abc/resourceGroups/exampleResourceGroup/providers/Microsoft.ScVmm/vmmServers/vmmServerName"))
            .create();
    }
...
public final class VirtualNetworksDeleteSamples {
    ...
    public static void virtualNetworksDeleteMaximumSet(com.azure.resourcemanager.scvmm.ScvmmManager manager) {
        manager.virtualNetworks().delete("rgscvmm", ".", true, com.azure.core.util.Context.NONE);
    }
...
public final class VirtualNetworksUpdateSamples {
    ...
    public static void virtualNetworksUpdateMaximumSet(com.azure.resourcemanager.scvmm.ScvmmManager manager) {
        VirtualNetwork resource = manager.virtualNetworks()
            .getByResourceGroupWithResponse("rgscvmm", "S", com.azure.core.util.Context.NONE).getValue();
...
public final class VmmServersCreateOrUpdateSamples {
    ...
    public static void vmmServersCreateOrUpdateMinimumSet(com.azure.resourcemanager.scvmm.ScvmmManager manager) {
        manager.vmmServers().define("w").withRegion("hslxkyzktvwpqbypvs").withExistingResourceGroup("rgscvmm")
            .withExtendedLocation(new ExtendedLocation()).create();
    }
...
public final class VmmServersDeleteSamples {
    ...
    public static void vmmServersDeleteMaximumSet(com.azure.resourcemanager.scvmm.ScvmmManager manager) {
        manager.vmmServers().delete("rgscvmm", ".", true, com.azure.core.util.Context.NONE);
    }
