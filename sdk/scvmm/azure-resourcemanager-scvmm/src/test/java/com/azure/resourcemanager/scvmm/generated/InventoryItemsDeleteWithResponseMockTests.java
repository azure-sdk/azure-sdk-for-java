...
public final class InventoryItemsDeleteWithResponseMockTests {
    @Test
    public void testDeleteWithResponse() throws Exception {
        ...
        manager.inventoryItems()
            .deleteWithResponse("gfggcvkyylizrzbj", "sfxsf", "ztlvtmvagbwidqlv", com.azure.core.util.Context.NONE);
