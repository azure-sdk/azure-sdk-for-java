...
public final class AvailabilitySetsClientImpl implements AvailabilitySetsClient {
    ...
    public interface AvailabilitySetsService {
        ...
        Mono<Response<Flux<ByteBuffer>>> createOrUpdate(@HostParam("$host") String endpoint,
            ...
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("availabilitySetResourceName") String availabilitySetResourceName,
            @QueryParam("api-version") String apiVersion, @BodyParam("application/json") AvailabilitySetInner body,
        ...
        return FluxUtil
            .withContext(
                context -> service.getByResourceGroup(this.client.getEndpoint(), this.client.getSubscriptionId(),
                    resourceGroupName, availabilitySetResourceName, this.client.getApiVersion(), accept, context))
    ...
    private Mono<Response<AvailabilitySetInner>> getByResourceGroupWithResponseAsync(String resourceGroupName,
        ...
        return service.getByResourceGroup(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            availabilitySetResourceName, this.client.getApiVersion(), accept, context);
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String resourceGroupName,
        String availabilitySetResourceName, AvailabilitySetInner body) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return FluxUtil
            .withContext(context -> service.createOrUpdate(this.client.getEndpoint(), this.client.getSubscriptionId(),
                resourceGroupName, availabilitySetResourceName, this.client.getApiVersion(), body, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String resourceGroupName,
        String availabilitySetResourceName, AvailabilitySetInner body, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service.createOrUpdate(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            availabilitySetResourceName, this.client.getApiVersion(), body, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<AvailabilitySetInner>, AvailabilitySetInner>
        beginCreateOrUpdate(String resourceGroupName, String availabilitySetResourceName, AvailabilitySetInner body) {
    ...
    public SyncPoller<PollResult<AvailabilitySetInner>, AvailabilitySetInner> beginCreateOrUpdate(
        String resourceGroupName, String availabilitySetResourceName, AvailabilitySetInner body, Context context) {
        return this.beginCreateOrUpdateAsync(resourceGroupName, availabilitySetResourceName, body, context)
            .getSyncPoller();
    }
    ...
    private Mono<AvailabilitySetInner> createOrUpdateAsync(String resourceGroupName, String availabilitySetResourceName,
        ...
        return beginCreateOrUpdateAsync(resourceGroupName, availabilitySetResourceName, body).last()
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<AvailabilitySetInner> createOrUpdateAsync(String resourceGroupName, String availabilitySetResourceName,
        AvailabilitySetInner body, Context context) {
        return beginCreateOrUpdateAsync(resourceGroupName, availabilitySetResourceName, body, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> deleteWithResponseAsync(String resourceGroupName,
        String availabilitySetResourceName, Force force) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return FluxUtil
            .withContext(context -> service.delete(this.client.getEndpoint(), this.client.getSubscriptionId(),
                resourceGroupName, availabilitySetResourceName, this.client.getApiVersion(), force, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> deleteWithResponseAsync(String resourceGroupName,
        String availabilitySetResourceName, Force force, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service.delete(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            availabilitySetResourceName, this.client.getApiVersion(), force, accept, context);
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> updateWithResponseAsync(String resourceGroupName,
        String availabilitySetResourceName, ResourcePatch body) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return FluxUtil
            .withContext(
                context -> service.update(this.client.getEndpoint(), resourceGroupName, this.client.getApiVersion(),
                    this.client.getSubscriptionId(), availabilitySetResourceName, body, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> updateWithResponseAsync(String resourceGroupName,
        String availabilitySetResourceName, ResourcePatch body, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<AvailabilitySetInner>, AvailabilitySetInner>
        beginUpdateAsync(String resourceGroupName, String availabilitySetResourceName, ResourcePatch body) {
        Mono<Response<Flux<ByteBuffer>>> mono
    ...
    private Mono<AvailabilitySetInner> updateAsync(String resourceGroupName, String availabilitySetResourceName,
        ResourcePatch body) {
        return beginUpdateAsync(resourceGroupName, availabilitySetResourceName, body).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<AvailabilitySetInner> updateAsync(String resourceGroupName, String availabilitySetResourceName,
        ...
        return beginUpdateAsync(resourceGroupName, availabilitySetResourceName, body, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public AvailabilitySetInner update(String resourceGroupName, String availabilitySetResourceName, ResourcePatch body,
        Context context) {
