...
import com.azure.resourcemanager.scvmm.fluent.models.MachineExtensionInner;
import com.azure.resourcemanager.scvmm.models.MachineExtensionUpdate;
import com.azure.resourcemanager.scvmm.models.MachineExtensionsListResult;
...
public final class MachineExtensionsClientImpl implements MachineExtensionsClient {
     ...
     */
    MachineExtensionsClientImpl(ScvmmClientImpl client) {
        this.service =
    ...
    /**
     * The interface defining all the services for ScvmmClientMachineExtensions to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "ScvmmClientMachineEx")
