        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("id".equals(fieldName)) {
                    deserializedVirtualMachineTemplateInner.withId(reader.getString());
                } else if ("name".equals(fieldName)) {
                    deserializedVirtualMachineTemplateInner.withName(reader.getString());
                } else if ("type".equals(fieldName)) {
                    deserializedVirtualMachineTemplateInner.withType(reader.getString());
