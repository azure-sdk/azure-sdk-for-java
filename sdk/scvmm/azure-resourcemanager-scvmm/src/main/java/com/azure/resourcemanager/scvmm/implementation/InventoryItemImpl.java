...
public final class InventoryItemImpl implements InventoryItem, InventoryItem.Definition {
    ...
    public InventoryItem create() {
        this.innerObject = serviceManager.serviceClient().getInventoryItems().createWithResponse(resourceGroupName,
            vmmServerName, inventoryItemResourceName, this.innerModel(), Context.NONE).getValue();
        return this;
    }

    public InventoryItem create(Context context) {
        this.innerObject = serviceManager.serviceClient().getInventoryItems()
    ...
    public InventoryItem refresh() {
        this.innerObject = serviceManager.serviceClient().getInventoryItems()
            .getWithResponse(resourceGroupName, vmmServerName, inventoryItemResourceName, Context.NONE).getValue();
        return this;
    }

    public InventoryItem refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getInventoryItems()
            .getWithResponse(resourceGroupName, vmmServerName, inventoryItemResourceName, context).getValue();
        return this;
    }
