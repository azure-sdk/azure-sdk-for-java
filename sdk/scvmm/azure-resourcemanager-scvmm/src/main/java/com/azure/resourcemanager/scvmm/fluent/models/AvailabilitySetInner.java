        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("id".equals(fieldName)) {
                    deserializedAvailabilitySetInner.withId(reader.getString());
                } else if ("name".equals(fieldName)) {
                    deserializedAvailabilitySetInner.withName(reader.getString());
                } else if ("type".equals(fieldName)) {
                    deserializedAvailabilitySetInner.withType(reader.getString());
