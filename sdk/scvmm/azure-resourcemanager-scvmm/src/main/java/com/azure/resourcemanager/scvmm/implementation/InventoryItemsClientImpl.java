...
public final class InventoryItemsClientImpl implements InventoryItemsClient {
    ...
    public interface InventoryItemsService {
        ...
        Mono<Response<InventoryItemInner>> get(@HostParam("endpoint") String endpoint,
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<InventoryItemInner>> create(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("vmmServerName") String vmmServerName,
            @PathParam("inventoryItemResourceName") String inventoryItemResourceName,
            @HeaderParam("Content-Type") String contentType, @HeaderParam("Accept") String accept,
            @BodyParam("application/json") InventoryItemInner resource, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<InventoryItemListResult>> listByVmmServer(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("vmmServerName") String vmmServerName,
            @HeaderParam("Accept") String accept, Context context);
    ...
    private Mono<Response<InventoryItemInner>> createWithResponseAsync(String resourceGroupName, String vmmServerName,
        ...
        return FluxUtil
            .withContext(context -> service.create(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, vmmServerName, inventoryItemResourceName,
    ...
    private Mono<Response<InventoryItemInner>> createWithResponseAsync(String resourceGroupName, String vmmServerName,
        ...
        return service.create(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, vmmServerName, inventoryItemResourceName, contentType, accept, resource, context);
    }
