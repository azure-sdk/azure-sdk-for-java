        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("id".equals(fieldName)) {
                    deserializedVirtualNetworkInner.withId(reader.getString());
                } else if ("name".equals(fieldName)) {
                    deserializedVirtualNetworkInner.withName(reader.getString());
                } else if ("type".equals(fieldName)) {
                    deserializedVirtualNetworkInner.withType(reader.getString());
