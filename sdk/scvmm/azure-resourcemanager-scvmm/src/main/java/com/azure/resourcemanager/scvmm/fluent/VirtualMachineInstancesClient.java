...
public interface VirtualMachineInstancesClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<VirtualMachineInstanceListResultInner> listWithResponse(String resourceUri, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    VirtualMachineInstanceListResultInner list(String resourceUri);
