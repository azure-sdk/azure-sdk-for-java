...
public final class VirtualMachineInstancesClientImpl implements VirtualMachineInstancesClient {
    ...
    public interface VirtualMachineInstancesService {
        ...
        Mono<Response<Flux<ByteBuffer>>> delete(@HostParam("$host") String endpoint,
            ...
            @QueryParam("deleteFromHost") DeleteFromHost deleteFromHost, @HeaderParam("Accept") String accept,
            Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> deleteWithResponseAsync(String resourceUri, Force force,
    ...
    private Mono<Response<Flux<ByteBuffer>>> deleteWithResponseAsync(String resourceUri, Force force,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.delete(this.client.getEndpoint(), resourceUri, this.client.getApiVersion(), force,
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<Void>, Void> beginDeleteAsync(String resourceUri, Force force,
        DeleteFromHost deleteFromHost) {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceUri, Force force,
        DeleteFromHost deleteFromHost, Context context) {
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return list of VirtualMachineInstances along with {@link PagedResponse} on successful completion of
     * {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ...
    private Mono<Response<Flux<ByteBuffer>>> createCheckpointWithResponseAsync(String resourceUri,
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.createCheckpoint(this.client.getEndpoint(), resourceUri,
                this.client.getApiVersion(), body, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> createCheckpointWithResponseAsync(String resourceUri,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.createCheckpoint(this.client.getEndpoint(), resourceUri, this.client.getApiVersion(), body,
            accept, context);
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> deleteCheckpointWithResponseAsync(String resourceUri,
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.deleteCheckpoint(this.client.getEndpoint(), resourceUri,
                this.client.getApiVersion(), body, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> deleteCheckpointWithResponseAsync(String resourceUri,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.deleteCheckpoint(this.client.getEndpoint(), resourceUri, this.client.getApiVersion(), body,
            accept, context);
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> restoreCheckpointWithResponseAsync(String resourceUri,
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.restoreCheckpoint(this.client.getEndpoint(), resourceUri,
                this.client.getApiVersion(), body, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> restoreCheckpointWithResponseAsync(String resourceUri,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.restoreCheckpoint(this.client.getEndpoint(), resourceUri, this.client.getApiVersion(), body,
            accept, context);
    }
