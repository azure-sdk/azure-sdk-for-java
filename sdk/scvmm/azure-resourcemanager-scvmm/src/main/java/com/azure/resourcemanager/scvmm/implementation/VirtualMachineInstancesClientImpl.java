...
public final class VirtualMachineInstancesClientImpl implements VirtualMachineInstancesClient {
    ...
    public interface VirtualMachineInstancesService {
        ...
        Mono<Response<Flux<ByteBuffer>>> stop(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam(value = "resourceUri", encoded = true) String resourceUri, @HeaderParam("Accept") String accept,
            @BodyParam("application/json") StopVirtualMachineOptions body, Context context);
        ...
        Mono<Response<Flux<ByteBuffer>>> createCheckpoint(@HostParam("endpoint") String endpoint,
            ...
            @PathParam(value = "resourceUri", encoded = true) String resourceUri,
            @HeaderParam("Content-Type") String contentType, @HeaderParam("Accept") String accept,
            @BodyParam("application/json") VirtualMachineCreateCheckpoint body, Context context);
        ...
        Mono<Response<Flux<ByteBuffer>>> deleteCheckpoint(@HostParam("endpoint") String endpoint,
            ...
            @PathParam(value = "resourceUri", encoded = true) String resourceUri,
            @HeaderParam("Content-Type") String contentType, @HeaderParam("Accept") String accept,
            @BodyParam("application/json") VirtualMachineDeleteCheckpoint body, Context context);
        ...
        Mono<Response<Flux<ByteBuffer>>> restoreCheckpoint(@HostParam("endpoint") String endpoint,
            ...
            @PathParam(value = "resourceUri", encoded = true) String resourceUri,
            @HeaderParam("Content-Type") String contentType, @HeaderParam("Accept") String accept,
            @BodyParam("application/json") VirtualMachineRestoreCheckpoint body, Context context);
     ...
     * 
     * Retrieves information about a virtual machine instance along with {@link Response} on successful completion of
     * {@link Mono}.
     */
     ...
     * @return a virtual machine.
     * 
     * Retrieves information about a virtual machine instance on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ...
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String resourceUri,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.createOrUpdate(this.client.getEndpoint(), this.client.getApiVersion(), resourceUri, contentType,
    ...
    private Mono<Response<Flux<ByteBuffer>>> updateWithResponseAsync(String resourceUri,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.update(this.client.getEndpoint(), this.client.getApiVersion(), resourceUri, contentType, accept,
            properties, context);
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> createCheckpointWithResponseAsync(String resourceUri,
        ...
        return FluxUtil
            .withContext(context -> service.createCheckpoint(this.client.getEndpoint(), this.client.getApiVersion(),
                resourceUri, contentType, accept, body, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> createCheckpointWithResponseAsync(String resourceUri,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.createCheckpoint(this.client.getEndpoint(), this.client.getApiVersion(), resourceUri,
    ...
    private Mono<Response<Flux<ByteBuffer>>> deleteCheckpointWithResponseAsync(String resourceUri,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.deleteCheckpoint(this.client.getEndpoint(), this.client.getApiVersion(), resourceUri,
            contentType, accept, body, context);
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> restoreCheckpointWithResponseAsync(String resourceUri,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.restoreCheckpoint(this.client.getEndpoint(), this.client.getApiVersion(), resourceUri,
            contentType, accept, body, context);
    }
