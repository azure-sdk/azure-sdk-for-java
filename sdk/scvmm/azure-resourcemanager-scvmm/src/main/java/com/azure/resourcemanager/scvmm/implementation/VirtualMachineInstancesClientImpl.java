...
import com.azure.resourcemanager.scvmm.implementation.models.VirtualMachineInstanceListResult;
...
public final class VirtualMachineInstancesClientImpl implements VirtualMachineInstancesClient {
    ...
    public interface VirtualMachineInstancesService {
        ...
        Mono<Response<Flux<ByteBuffer>>> createOrUpdate(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("resourceUri") String resourceUri,
            @HeaderParam("accept") String accept, @BodyParam("application/json") VirtualMachineInstanceInner resource,
            Context context);
        ...
        Mono<Response<Flux<ByteBuffer>>> update(@HostParam("endpoint") String endpoint,
            ...
            @BodyParam("application/json") VirtualMachineInstanceUpdate properties, Context context);
        ...
        Mono<Response<Flux<ByteBuffer>>> stop(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("resourceUri") String resourceUri,
            @HeaderParam("accept") String accept, @BodyParam("application/json") StopVirtualMachineOptions body,
            Context context);
        ...
        @ExpectedResponses({ 202 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Flux<ByteBuffer>>> createCheckpoint(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("resourceUri") String resourceUri,
            @HeaderParam("accept") String accept, @BodyParam("application/json") VirtualMachineCreateCheckpoint body,
            Context context);
        ...
        @ExpectedResponses({ 202 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Flux<ByteBuffer>>> deleteCheckpoint(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("resourceUri") String resourceUri,
            @HeaderParam("accept") String accept, @BodyParam("application/json") VirtualMachineDeleteCheckpoint body,
            Context context);
        ...
        @ExpectedResponses({ 202 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Flux<ByteBuffer>>> restoreCheckpoint(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("resourceUri") String resourceUri,
            @HeaderParam("accept") String accept, @BodyParam("application/json") VirtualMachineRestoreCheckpoint body,
            Context context);
    ...
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String resourceUri,
        ...
        return FluxUtil
            .withContext(context -> service.createOrUpdate(this.client.getEndpoint(), this.client.getApiVersion(),
                resourceUri, accept, resource, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String resourceUri,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.createOrUpdate(this.client.getEndpoint(), this.client.getApiVersion(), resourceUri, accept,
            resource, context);
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> updateWithResponseAsync(String resourceUri,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.update(this.client.getEndpoint(), this.client.getApiVersion(), resourceUri, accept, properties,
            context);
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> stopWithResponseAsync(String resourceUri, StopVirtualMachineOptions body,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.stop(this.client.getEndpoint(), this.client.getApiVersion(), resourceUri, accept, body, context);
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> createCheckpointWithResponseAsync(String resourceUri,
        ...
        return FluxUtil
            .withContext(context -> service.createCheckpoint(this.client.getEndpoint(), this.client.getApiVersion(),
                resourceUri, accept, body, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> createCheckpointWithResponseAsync(String resourceUri,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.createCheckpoint(this.client.getEndpoint(), this.client.getApiVersion(), resourceUri, accept,
            body, context);
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> deleteCheckpointWithResponseAsync(String resourceUri,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.deleteCheckpoint(this.client.getEndpoint(), this.client.getApiVersion(), resourceUri, accept,
            body, context);
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> restoreCheckpointWithResponseAsync(String resourceUri,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.restoreCheckpoint(this.client.getEndpoint(), this.client.getApiVersion(), resourceUri, accept,
            body, context);
    }
