...
public final class VmInstanceHybridIdentityMetadataInner extends ProxyResource {
     ...
     */
    public VmInstanceHybridIdentityMetadataProperties properties() {
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("id".equals(fieldName)) {
                    deserializedVmInstanceHybridIdentityMetadataInner.withId(reader.getString());
                } else if ("name".equals(fieldName)) {
                    deserializedVmInstanceHybridIdentityMetadataInner.withName(reader.getString());
                } else if ("type".equals(fieldName)) {
                    deserializedVmInstanceHybridIdentityMetadataInner.withType(reader.getString());
