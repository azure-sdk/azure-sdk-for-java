...
public final class VirtualMachineInstancesImpl implements VirtualMachineInstances {
    ...
    public void restart(String resourceUri, Object body) {
        this.serviceClient().restart(resourceUri, body);
    }

    public void restart(String resourceUri, Object body, Context context) {
        this.serviceClient().restart(resourceUri, body, context);
    }
    ...
    public void start(String resourceUri, Object body) {
        this.serviceClient().start(resourceUri, body);
    }

    public void start(String resourceUri, Object body, Context context) {
        this.serviceClient().start(resourceUri, body, context);
    }
