...
import com.azure.resourcemanager.scvmm.fluent.models.HybridIdentityMetadataInner;
import com.azure.resourcemanager.scvmm.models.HybridIdentityMetadataList;
...
public final class HybridIdentityMetadatasClientImpl implements HybridIdentityMetadatasClient {
     ...
     */
    HybridIdentityMetadatasClientImpl(ScvmmClientImpl client) {
        this.service =
            RestProxy
    ...
    /**
     * The interface defining all the services for ScvmmClientHybridIdentityMetadatas to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "ScvmmClientHybridIde")
