        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("id".equals(fieldName)) {
                    deserializedVirtualMachineInstanceInner.withId(reader.getString());
                } else if ("name".equals(fieldName)) {
                    deserializedVirtualMachineInstanceInner.withName(reader.getString());
                } else if ("type".equals(fieldName)) {
                    deserializedVirtualMachineInstanceInner.withType(reader.getString());
