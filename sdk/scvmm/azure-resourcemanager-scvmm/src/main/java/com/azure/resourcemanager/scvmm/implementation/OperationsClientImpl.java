...
import com.azure.resourcemanager.scvmm.models.ResourceProviderOperationList;
...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    OperationsClientImpl(ScvmmClientImpl client) {
        this.service =
    ...
    /**
     * The interface defining all the services for ScvmmClientOperations to be used by the proxy service to perform REST
     * calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "ScvmmClientOperation")
