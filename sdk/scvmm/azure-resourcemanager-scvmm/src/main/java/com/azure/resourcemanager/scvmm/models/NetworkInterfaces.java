...
public final class NetworkInterfaces {
     ...
     * @return the NetworkInterfaces object itself.
     */
    ...
    /**
     * Get the networkName property: Gets or sets the name of the virtual network in vmmServer that the nic is connected
     * to.
     *
