...
import com.azure.resourcemanager.scvmm.models.VmInstanceHybridIdentityMetadataList;
import reactor.core.publisher.Mono;

/**
 * An instance of this class provides access to all the operations defined in
 * VirtualMachineInstanceHybridIdentityMetadatasClient.
 */
public final class VirtualMachineInstanceHybridIdentityMetadatasClientImpl
    implements VirtualMachineInstanceHybridIdentityMetadatasClient {
    /**
     * The proxy service used to perform REST calls.
     */
    private final VirtualMachineInstanceHybridIdentityMetadatasService service;
    ...
    /**
     * Initializes an instance of VirtualMachineInstanceHybridIdentityMetadatasClientImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    VirtualMachineInstanceHybridIdentityMetadatasClientImpl(ScvmmClientImpl client) {
        this.service = RestProxy.create(VirtualMachineInstanceHybridIdentityMetadatasService.class,
            client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for ScvmmClientVirtualMachineInstanceHybridIdentityMetadatas to be used
     * by the proxy service to perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "ScvmmClientVirtualMa")
    public interface VirtualMachineInstanceHybridIdentityMetadatasService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<VmInstanceHybridIdentityMetadataList>> list(@HostParam("$host") String endpoint,
            @PathParam(value = "resourceUri", encoded = true) String resourceUri,
            @QueryParam("api-version") String apiVersion, @HeaderParam("Accept") String accept, Context context);
