...
import com.azure.resourcemanager.scvmm.implementation.models.GuestAgentListResult;
...
public final class GuestAgentsClientImpl implements GuestAgentsClient {
     ...
     * @return guestAgent.
     * 
     * Implements GuestAgent GET method along with {@link Response} on successful completion of {@link Mono}.
     */
     ...
     * @return guestAgent.
     * 
     * Implements GuestAgent GET method on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ...
    private Mono<Response<Flux<ByteBuffer>>> createWithResponseAsync(String resourceUri, GuestAgentInner resource,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.create(this.client.getEndpoint(), this.client.getApiVersion(), resourceUri, contentType, accept,
            resource, context);
    }
