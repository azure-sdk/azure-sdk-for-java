...
public final class GuestAgentsClientImpl implements GuestAgentsClient {
    ...
    public interface GuestAgentsService {
        ...
        Mono<Response<Flux<ByteBuffer>>> create(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("resourceUri") String resourceUri,
            @HeaderParam("accept") String accept, @BodyParam("application/json") GuestAgentInner resource,
            Context context);
    ...
    private Mono<Response<Flux<ByteBuffer>>> createWithResponseAsync(String resourceUri, GuestAgentInner resource,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.create(this.client.getEndpoint(), this.client.getApiVersion(), resourceUri, accept, resource,
            context);
    }
