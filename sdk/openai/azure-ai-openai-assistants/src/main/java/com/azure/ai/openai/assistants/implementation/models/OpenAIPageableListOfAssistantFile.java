...
public final class OpenAIPageableListOfAssistantFile {
    ...
    private final List<AssistantFile> data;
    ...
    @Generated
    @JsonCreator
    private OpenAIPageableListOfAssistantFile(@JsonProperty(value = "data") List<AssistantFile> data,
     ...
     */
    @Generated
    public List<AssistantFile> getData() {
        return this.data;
    }
