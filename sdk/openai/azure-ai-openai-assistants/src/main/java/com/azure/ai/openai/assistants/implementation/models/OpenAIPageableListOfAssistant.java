 ...
 */
@Immutable
public final class OpenAIPageableListOfAssistant implements JsonSerializable<OpenAIPageableListOfAssistant> {
     ...
     * @return An instance of OpenAIPageableListOfAssistant if the JsonReader was pointing to an instance of it, or null
    ...
    public static OpenAIPageableListOfAssistant fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            OpenAIPageableListOfAssistant deserializedOpenAIPageableListOfAssistant
                = new OpenAIPageableListOfAssistant(data, firstId, lastId);
            deserializedOpenAIPageableListOfAssistant.hasMore = hasMore;
            return deserializedOpenAIPageableListOfAssistant;
        });
    }
     ...
     */
    @Generated
    private OpenAIPageableListOfAssistant(List<Assistant> data, String firstId, String lastId) {
        this.data = data;
