...
public final class OpenAIPageableListOfMessageFile {
    ...
    private final List<MessageFile> data;
    ...
    @Generated
    @JsonCreator
    private OpenAIPageableListOfMessageFile(@JsonProperty(value = "data") List<MessageFile> data,
     ...
     */
    @Generated
    public List<MessageFile> getData() {
        return this.data;
    }
