...
public final class OpenAIPageableListOfBatch implements JsonSerializable<OpenAIPageableListOfBatch> {
    ...
    /**
     * Reads an instance of OpenAIPageableListOfBatch from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of OpenAIPageableListOfBatch if the JsonReader was pointing to an instance of it, or null if
     * it was pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the OpenAIPageableListOfBatch.
     */
    @Generated
