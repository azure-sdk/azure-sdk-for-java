...
public final class ImageGenerationOptions {
    ...
    /**
     * Get the n property: The number of images to generate. Dall-e-2 models support values between 1 and 10. Dall-e-3
     * models only support a value of 1.
     *
     * @return the n value.
     */
    @Generated
    ...
    /**
     * Set the n property: The number of images to generate. Dall-e-2 models support values between 1 and 10. Dall-e-3
     * models only support a value of 1.
     *
    ...
    /**
     * Get the size property: The desired dimensions for generated images. Dall-e-2 models support 256x256, 512x512, or
     * 1024x1024. Dall-e-3 models support 1024x1024, 1792x1024, or 1024x1792.
     *
    ...
    /**
     * Set the size property: The desired dimensions for generated images. Dall-e-2 models support 256x256, 512x512, or
     * 1024x1024. Dall-e-3 models support 1024x1024, 1792x1024, or 1024x1792.
     *
    ...
    /**
     * Get the quality property: The desired image generation quality level to use. Only configurable with dall-e-3
     * models.
     *
    ...
    /**
     * Set the quality property: The desired image generation quality level to use. Only configurable with dall-e-3
     * models.
     *
