 ...
 */
@Immutable
public final class ChatCompletionsStream {
    /*
    ...
    /**
     * Creates an instance of ChatCompletionsStream class.
     *
     ...
     */
    @Generated
    private ChatCompletionsStream(
            String id, OffsetDateTime createdAt, List<ChatChoiceStream> choices, CompletionsUsage usage) {
        this.id = id;
    ...
    private ChatCompletionsStream(
            ...
            @JsonProperty(value = "choices") List<ChatChoiceStream> choices,
     ...
     */
    @Generated
    public List<ChatChoiceStream> getChoices() {
        return this.choices;
    }
