...
public final class OpenAIClient {
    ...
    SyncPoller<BinaryData, BinaryData> beginBeginImageGenerations(BinaryData imageGenerationOptions,
        RequestOptions requestOptions) {
        return this.serviceClient.beginBeginImageGenerations(imageGenerationOptions, requestOptions);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<BinaryData> getAzureBatchImageGenerationOperationStatusWithResponse(String operationId,
        RequestOptions requestOptions) {
    ...
    SyncPoller<BatchImageGenerationOperationResponse, BatchImageGenerationOperationResponse>
        ...
        RequestOptions requestOptions = new RequestOptions();
        return serviceClient.beginBeginImageGenerationsWithModel(BinaryData.fromObject(imageGenerationOptions),
            requestOptions);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    BatchImageGenerationOperationResponse getAzureBatchImageGenerationOperationStatus(String operationId) {
        // Generated convenience method for getAzureBatchImageGenerationOperationStatusWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getAzureBatchImageGenerationOperationStatusWithResponse(operationId, requestOptions).getValue()
            .toObject(BatchImageGenerationOperationResponse.class);
    }
