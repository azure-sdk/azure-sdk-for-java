...
public final class ImageGenerationData {
    ...
    /**
     * Get the revisedPrompt property: The final prompt used by the model to generate the image. Only provided with
     * dall-3-models and only when revisions were made to the prompt.
     *
