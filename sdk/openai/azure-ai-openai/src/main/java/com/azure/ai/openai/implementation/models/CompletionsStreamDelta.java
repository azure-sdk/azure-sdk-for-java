 ...
 */
@Immutable
public final class CompletionsStreamDelta {
    /*
    ...
    private List<ChoiceStreamDelta> choices;
    ...
    /**
     * Creates an instance of CompletionsStreamDelta class.
     *
     ...
     */
    @Generated
    private CompletionsStreamDelta(
            String id, OffsetDateTime createdAt, List<ChoiceStreamDelta> choices, CompletionsUsage usage) {
        this.id = id;
    ...
    private CompletionsStreamDelta(
            ...
            @JsonProperty(value = "choices") List<ChoiceStreamDelta> choices,
     ...
     */
    @Generated
    public List<ChoiceStreamDelta> getChoices() {
        return this.choices;
    }
