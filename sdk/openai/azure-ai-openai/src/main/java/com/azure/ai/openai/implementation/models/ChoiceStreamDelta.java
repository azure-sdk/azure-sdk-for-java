 ...
 */
@Immutable
public final class ChoiceStreamDelta {
    /*
    ...
    private CompletionsLogProbabilityModelStreamDelta logprobs;
    ...
    /**
     * Creates an instance of ChoiceStreamDelta class.
     *
    ...
    @Generated
    @JsonCreator
    private ChoiceStreamDelta(
            @JsonProperty(value = "text") String text,
            @JsonProperty(value = "index") int index,
            @JsonProperty(value = "logprobs") CompletionsLogProbabilityModelStreamDelta logprobs,
     ...
     */
    @Generated
    public CompletionsLogProbabilityModelStreamDelta getLogprobs() {
