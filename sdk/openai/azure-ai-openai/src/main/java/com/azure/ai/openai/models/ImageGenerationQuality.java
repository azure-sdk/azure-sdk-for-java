...
/**
 * An image generation configuration that specifies how the model should prioritize quality, cost, and speed. Only
 * configurable with dall-e-3 models.
 */
public final class ImageGenerationQuality extends ExpandableStringEnum<ImageGenerationQuality> {
    ...
    @Generated public static final ImageGenerationQuality STANDARD = fromString("standard");

    /** Requests image generation with higher quality, higher cost and lower speed relative to standard. */
    @Generated public static final ImageGenerationQuality HD = fromString("hd");
