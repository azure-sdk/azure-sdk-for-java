...
public final class QuotaOperationsClientImpl implements QuotaOperationsClient {
    ...
    private Mono<PagedResponse<OperationResponseInner>> listSinglePageAsync() {
        ...
        return FluxUtil
            ...
            .<PagedResponse<OperationResponseInner>>map(
                res ->
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<OperationResponseInner>> listSinglePageAsync(Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<OperationResponseInner> listAsync(Context context) {
