...
public final class GroupQuotasClientImpl implements GroupQuotasClient {
    ...
    private Mono<Response<Flux<ByteBuffer>>> updateWithResponseAsync(String managementGroupId, String groupQuotaName,
        GroupQuotasEntityInner groupQuotasPatchRequestBody) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> updateWithResponseAsync(String managementGroupId, String groupQuotaName,
        GroupQuotasEntityInner groupQuotasPatchRequestBody, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    private PollerFlux<PollResult<GroupQuotasEntityInner>, GroupQuotasEntityInner> beginUpdateAsync(
        String managementGroupId, String groupQuotaName, GroupQuotasEntityInner groupQuotasPatchRequestBody) {
        Mono<Response<Flux<ByteBuffer>>> mono
    ...
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<GroupQuotasEntityInner>, GroupQuotasEntityInner> beginUpdate(String managementGroupId,
        String groupQuotaName, GroupQuotasEntityInner groupQuotasPatchRequestBody, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Void>> deleteWithResponseAsync(String managementGroupId, String groupQuotaName) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    private Mono<Void> deleteAsync(String managementGroupId, String groupQuotaName) {
        return deleteWithResponseAsync(managementGroupId, groupQuotaName).flatMap(ignored -> Mono.empty());
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<Void> deleteWithResponse(String managementGroupId, String groupQuotaName, Context context) {
        return deleteWithResponseAsync(managementGroupId, groupQuotaName, context).block();
    }
    ...
    public void delete(String managementGroupId, String groupQuotaName) {
        deleteWithResponse(managementGroupId, groupQuotaName, Context.NONE);
    }
