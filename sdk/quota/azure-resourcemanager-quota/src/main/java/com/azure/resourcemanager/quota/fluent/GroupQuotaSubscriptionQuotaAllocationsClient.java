...
public interface GroupQuotaSubscriptionQuotaAllocationsClient {
    ...
    PagedIterable<SubscriptionQuotaAllocationsInner> list(
    ...
    SyncPoller<PollResult<SubscriptionQuotaAllocationsInner>, SubscriptionQuotaAllocationsInner> beginCreateOrUpdate(
        String mgId,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<SubscriptionQuotaAllocationsInner> getWithResponse(
