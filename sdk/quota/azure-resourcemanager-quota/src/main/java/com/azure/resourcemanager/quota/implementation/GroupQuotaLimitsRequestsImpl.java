...
public final class GroupQuotaLimitsRequestsImpl implements GroupQuotaLimitsRequests {
    ...
    public ProxyResource createOrUpdate(String managementGroupId, String groupQuotaName, String resourceProviderName,
        String resourceName) {
        return this.serviceClient().createOrUpdate(managementGroupId, groupQuotaName, resourceProviderName,
            resourceName);
    }
    ...
    public ProxyResource createOrUpdate(String managementGroupId, String groupQuotaName, String resourceProviderName,
        ...
        return this.serviceClient().createOrUpdate(managementGroupId, groupQuotaName, resourceProviderName,
            resourceName, groupQuotaRequest, context);
    }
    ...
    public SubmittedResourceRequestStatus update(String managementGroupId, String groupQuotaName,
        ...
        Context context) {
        SubmittedResourceRequestStatusInner inner = this.serviceClient().update(managementGroupId, groupQuotaName,
