...
public final class GroupQuotaLimitsRequestsImpl implements GroupQuotaLimitsRequests {
    ...
    public Response<SubmittedResourceRequestStatus> getWithResponse(String managementGroupId, String groupQuotaName,
        ...
        Response<SubmittedResourceRequestStatusInner> inner
            = this.serviceClient().getWithResponse(managementGroupId, groupQuotaName, requestId, filter, context);
        if (inner != null) {
    ...
    public SubmittedResourceRequestStatus get(String managementGroupId, String groupQuotaName, String requestId,
        ...
        SubmittedResourceRequestStatusInner inner
            = this.serviceClient().get(managementGroupId, groupQuotaName, requestId, filter);
        if (inner != null) {
