...
public final class GroupQuotaLimitsImpl implements GroupQuotaLimits {
    ...
    public Response<GroupQuotaLimit> getWithResponse(String managementGroupId, String groupQuotaName,
        ...
        Response<GroupQuotaLimitInner> inner = this.serviceClient().getWithResponse(managementGroupId, groupQuotaName,
            resourceProviderName, resourceName, filter, context);
        if (inner != null) {
