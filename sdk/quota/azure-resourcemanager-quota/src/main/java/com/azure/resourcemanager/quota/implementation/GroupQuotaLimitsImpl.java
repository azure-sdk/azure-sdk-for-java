...
public final class GroupQuotaLimitsImpl implements GroupQuotaLimits {
    ...
    public ProxyResource createOrUpdate(String managementGroupId, String groupQuotaName, String resourceName,
        ...
        return this.serviceClient().createOrUpdate(managementGroupId, groupQuotaName, resourceName,
            groupQuotaLimitRequest, context);
    }

    public GroupQuotaLimit update(String managementGroupId, String groupQuotaName, String resourceName) {
        GroupQuotaLimitInner inner = this.serviceClient().update(managementGroupId, groupQuotaName, resourceName);
        if (inner != null) {
    ...
    public GroupQuotaLimit get(String managementGroupId, String groupQuotaName, String resourceName, String filter) {
        GroupQuotaLimitInner inner = this.serviceClient().get(managementGroupId, groupQuotaName, resourceName, filter);
        if (inner != null) {
            return new GroupQuotaLimitImpl(inner, this.manager());
        } else {
            return null;
    ...
    public PagedIterable<GroupQuotaLimit> list(String managementGroupId, String groupQuotaName, String filter) {
