...
public interface GroupQuotasClient {
    ...
    SyncPoller<PollResult<GroupQuotasEntityInner>, GroupQuotasEntityInner> beginCreateOrUpdate(
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<GroupQuotasEntityInner>, GroupQuotasEntityInner> beginUpdate(
        String mgId, String groupQuotaName);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<GroupQuotasEntityInner> getWithResponse(String mgId, String groupQuotaName, Context context);
    ...
    PagedIterable<GroupQuotasEntityInner> list(String mgId);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<GroupQuotasEntityInner> list(String mgId, Context context);
}
