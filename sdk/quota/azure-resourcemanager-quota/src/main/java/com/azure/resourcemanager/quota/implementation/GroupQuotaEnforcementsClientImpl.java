...
/**
 * An instance of this class provides access to all the operations defined in GroupQuotaEnforcementsClient.
 */
public final class GroupQuotaEnforcementsClientImpl implements GroupQuotaEnforcementsClient {
    /**
     * The proxy service used to perform REST calls.
     */
    private final GroupQuotaEnforcementsService service;
    ...
    /**
     * Initializes an instance of GroupQuotaEnforcementsClientImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    GroupQuotaEnforcementsClientImpl(AzureQuotaExtensionApiImpl client) {
        this.service = RestProxy.create(GroupQuotaEnforcementsService.class, client.getHttpPipeline(),
            client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for AzureQuotaExtensionApiGroupQuotaEnforcements to be used by the proxy
     * service to perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "AzureQuotaExtensionA")
    public interface GroupQuotaEnforcementsService {
        @Headers({ "Content-Type: application/json" })
        @Put("/providers/Microsoft.Management/managementGroups/{managementGroupId}/providers/Microsoft.Quota/groupQuotas/{groupQuotaName}/resourceProviders/{resourceProviderName}/groupQuotaEnforcements/{location}")
        ...
        @Headers({ "Content-Type: application/json" })
        @Patch("/providers/Microsoft.Management/managementGroups/{managementGroupId}/providers/Microsoft.Quota/groupQuotas/{groupQuotaName}/resourceProviders/{resourceProviderName}/groupQuotaEnforcements/{location}")
        ...
        @Headers({ "Content-Type: application/json" })
        @Get("/providers/Microsoft.Management/managementGroups/{managementGroupId}/providers/Microsoft.Quota/groupQuotas/{groupQuotaName}/resourceProviders/{resourceProviderName}/groupQuotaEnforcements/{location}")
        ...
        @Headers({ "Content-Type: application/json" })
        @Get("/providers/Microsoft.Management/managementGroups/{managementGroupId}/providers/Microsoft.Quota/groupQuotas/{groupQuotaName}/resourceProviders/{resourceProviderName}/groupQuotaEnforcements")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
    ...
    private PollerFlux<PollResult<ProxyResource>, ProxyResource> beginCreateOrUpdateAsync(String managementGroupId,
        ...
        Mono<Response<Flux<ByteBuffer>>> mono
            = createOrUpdateWithResponseAsync(managementGroupId, groupQuotaName, resourceProviderName, location);
    ...
    private PollerFlux<PollResult<ProxyResource>, ProxyResource> beginCreateOrUpdateAsync(String managementGroupId,
        ...
        Mono<Response<Flux<ByteBuffer>>> mono = createOrUpdateWithResponseAsync(managementGroupId, groupQuotaName,
            resourceProviderName, location, context);
        return this.client.<ProxyResource, ProxyResource>getLroResult(mono, this.client.getHttpPipeline(),
    ...
    public SyncPoller<PollResult<ProxyResource>, ProxyResource> beginCreateOrUpdate(String managementGroupId,
        String groupQuotaName, String resourceProviderName, String location) {
        return this.beginCreateOrUpdateAsync(managementGroupId, groupQuotaName, resourceProviderName, location)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<ProxyResource>, ProxyResource> beginCreateOrUpdate(String managementGroupId,
        String groupQuotaName, String resourceProviderName, String location, Context context) {
        return this.beginCreateOrUpdateAsync(managementGroupId, groupQuotaName, resourceProviderName, location, context)
            .getSyncPoller();
    }
    ...
    private Mono<ProxyResource> createOrUpdateAsync(String managementGroupId, String groupQuotaName,
        ...
        return beginCreateOrUpdateAsync(managementGroupId, groupQuotaName, resourceProviderName, location).last()
    ...
    private Mono<ProxyResource> createOrUpdateAsync(String managementGroupId, String groupQuotaName,
        ...
        return beginCreateOrUpdateAsync(managementGroupId, groupQuotaName, resourceProviderName, location, context)
    ...
    public ProxyResource createOrUpdate(String managementGroupId, String groupQuotaName, String resourceProviderName,
        String location) {
        return createOrUpdateAsync(managementGroupId, groupQuotaName, resourceProviderName, location).block();
    }
    ...
    public ProxyResource createOrUpdate(String managementGroupId, String groupQuotaName, String resourceProviderName,
        ...
        return createOrUpdateAsync(managementGroupId, groupQuotaName, resourceProviderName, location, context).block();
    }
    ...
    private PollerFlux<PollResult<GroupQuotasEnforcementResponseInner>, GroupQuotasEnforcementResponseInner>
        beginUpdateAsync(String managementGroupId, String groupQuotaName, String resourceProviderName,
            String location) {
        Mono<Response<Flux<ByteBuffer>>> mono
            = updateWithResponseAsync(managementGroupId, groupQuotaName, resourceProviderName, location);
    ...
    private PollerFlux<PollResult<GroupQuotasEnforcementResponseInner>, GroupQuotasEnforcementResponseInner>
        ...
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono
            = updateWithResponseAsync(managementGroupId, groupQuotaName, resourceProviderName, location, context);
        return this.client.<GroupQuotasEnforcementResponseInner, GroupQuotasEnforcementResponseInner>getLroResult(mono,
            this.client.getHttpPipeline(), GroupQuotasEnforcementResponseInner.class,
    ...
    public SyncPoller<PollResult<GroupQuotasEnforcementResponseInner>, GroupQuotasEnforcementResponseInner>
        ...
        return this.beginUpdateAsync(managementGroupId, groupQuotaName, resourceProviderName, location).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<GroupQuotasEnforcementResponseInner>, GroupQuotasEnforcementResponseInner> beginUpdate(
        ...
        Context context) {
        return this.beginUpdateAsync(managementGroupId, groupQuotaName, resourceProviderName, location, context)
            .getSyncPoller();
    }
    ...
    private Mono<GroupQuotasEnforcementResponseInner> updateAsync(String managementGroupId, String groupQuotaName,
        String resourceProviderName, String location) {
        return beginUpdateAsync(managementGroupId, groupQuotaName, resourceProviderName, location).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<GroupQuotasEnforcementResponseInner> updateAsync(String managementGroupId, String groupQuotaName,
        String resourceProviderName, String location, Context context) {
        return beginUpdateAsync(managementGroupId, groupQuotaName, resourceProviderName, location, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    public GroupQuotasEnforcementResponseInner update(String managementGroupId, String groupQuotaName,
        String resourceProviderName, String location) {
        return updateAsync(managementGroupId, groupQuotaName, resourceProviderName, location).block();
    }
    ...
    public GroupQuotasEnforcementResponseInner update(String managementGroupId, String groupQuotaName,
        String resourceProviderName, String location, Context context) {
        return updateAsync(managementGroupId, groupQuotaName, resourceProviderName, location, context).block();
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the GroupQuotas enforcement status for the ResourceProvider/location along with {@link Response} on
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the GroupQuotas enforcement status for the ResourceProvider/location on successful completion of
     * {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
