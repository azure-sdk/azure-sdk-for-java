 ...
 */
public interface GroupQuotaEnforcementsClient {
    /**
    ...
    SyncPoller<PollResult<GroupQuotasEnforcementResponseInner>, GroupQuotasEnforcementResponseInner> beginUpdate(
        String managementGroupId, String groupQuotaName, String resourceProviderName, String location, Context context);
