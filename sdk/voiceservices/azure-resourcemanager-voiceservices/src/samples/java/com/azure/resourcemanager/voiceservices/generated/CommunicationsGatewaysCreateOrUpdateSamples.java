...
public final class CommunicationsGatewaysCreateOrUpdateSamples {
    ...
    public static void
        ...
        manager.communicationsGateways().define("myname").withRegion("useast").withExistingResourceGroup("testrg")
            .withSku(new Sku().withName("standard"))
            .withServiceLocations(Arrays.asList(
                new ServiceRegionProperties().withName("useast").withPrimaryRegionProperties(
                ...
                new ServiceRegionProperties().withName("useast2").withPrimaryRegionProperties(
            ...
            .withConnectivity(Connectivity.PUBLIC_ADDRESS).withCodecs(Arrays.asList(TeamsCodecs.PCMA))
