...
public final class NameAvailabilityCheckLocalSamples {
    ...
    public static void
        ...
        manager.nameAvailabilities().checkLocalWithResponse("useast", new CheckNameAvailabilityRequest()
            .withName("myname").withType("Microsoft.VoiceServices/CommunicationsGateways"),
