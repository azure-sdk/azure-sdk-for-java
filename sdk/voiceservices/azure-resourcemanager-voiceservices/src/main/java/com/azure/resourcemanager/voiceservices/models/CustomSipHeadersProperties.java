...
public final class CustomSipHeadersProperties {
    ...
    /**
     * Get the headers property: The Custom SIP Headers to apply to the calls which traverse the Communications
     * Gateway.
     * 
    ...
    /**
     * Set the headers property: The Custom SIP Headers to apply to the calls which traverse the Communications
     * Gateway.
     * 
