...
public final class TestLineImpl implements TestLine, TestLine.Definition, TestLine.Update {
    ...
    public TestLine create() {
        this.innerObject = serviceManager.serviceClient().getTestLines().createOrUpdate(resourceGroupName,
            communicationsGatewayName, testLineName, this.innerModel(), Context.NONE);
        return this;
    }

    public TestLine create(Context context) {
        this.innerObject = serviceManager.serviceClient().getTestLines().createOrUpdate(resourceGroupName,
            communicationsGatewayName, testLineName, this.innerModel(), context);
        return this;
    }
    ...
    public TestLine apply() {
        this.innerObject = serviceManager.serviceClient().getTestLines().updateWithResponse(resourceGroupName,
            communicationsGatewayName, testLineName, updateProperties, Context.NONE).getValue();
        return this;
    }

    public TestLine apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getTestLines()
    ...
    public TestLine refresh() {
        this.innerObject = serviceManager.serviceClient().getTestLines()
            .getWithResponse(resourceGroupName, communicationsGatewayName, testLineName, Context.NONE).getValue();
        return this;
    }

    public TestLine refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getTestLines()
            .getWithResponse(resourceGroupName, communicationsGatewayName, testLineName, context).getValue();
        return this;
    }
