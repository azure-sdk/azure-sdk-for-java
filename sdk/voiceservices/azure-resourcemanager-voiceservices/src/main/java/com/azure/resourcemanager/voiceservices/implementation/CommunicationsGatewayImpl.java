...
public final class CommunicationsGatewayImpl
    ...
    public DnsDelegationsProperties dnsDelegations() {
        return this.innerModel().dnsDelegations();
    }

    public CustomSipHeadersProperties customSipHeaders() {
        return this.innerModel().customSipHeaders();
    }

    public List<String> allocatedSignalingAddressPrefixes() {
        List<String> inner = this.innerModel().allocatedSignalingAddressPrefixes();
        if (inner != null) {
            return Collections.unmodifiableList(inner);
        } else {
            return Collections.emptyList();
    ...
    public List<String> allocatedMediaAddressPrefixes() {
        List<String> inner = this.innerModel().allocatedMediaAddressPrefixes();
        if (inner != null) {
            return Collections.unmodifiableList(inner);
        } else {
            return Collections.emptyList();
    ...
    public CommunicationsGateway create() {
        this.innerObject = serviceManager.serviceClient().getCommunicationsGateways().createOrUpdate(resourceGroupName,
            communicationsGatewayName, this.innerModel(), Context.NONE);
        return this;
    }

    public CommunicationsGateway create(Context context) {
        this.innerObject = serviceManager.serviceClient().getCommunicationsGateways().createOrUpdate(resourceGroupName,
            communicationsGatewayName, this.innerModel(), context);
        return this;
    }
    ...
    public CommunicationsGateway apply() {
        this.innerObject = serviceManager.serviceClient().getCommunicationsGateways()
    ...
    public CommunicationsGateway apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getCommunicationsGateways()
            .updateWithResponse(resourceGroupName, communicationsGatewayName, updateProperties, context).getValue();
        return this;
    }
    ...
    public CommunicationsGateway refresh() {
        this.innerObject = serviceManager.serviceClient().getCommunicationsGateways()
            .getByResourceGroupWithResponse(resourceGroupName, communicationsGatewayName, Context.NONE).getValue();
        return this;
    }

    public CommunicationsGateway refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getCommunicationsGateways()
            .getByResourceGroupWithResponse(resourceGroupName, communicationsGatewayName, context).getValue();
        return this;
    }
    ...
    public CommunicationsGatewayImpl withSku(Sku sku) {
        if (isInCreateMode()) {
    ...
    public CommunicationsGatewayImpl withApiBridge(ApiBridgeProperties apiBridge) {
    ...
    public CommunicationsGatewayImpl withDnsDelegations(DnsDelegationsProperties dnsDelegations) {
        this.innerModel().withDnsDelegations(dnsDelegations);
        return this;
    }

    public CommunicationsGatewayImpl withCustomSipHeaders(CustomSipHeadersProperties customSipHeaders) {
        this.innerModel().withCustomSipHeaders(customSipHeaders);
        return this;
    }
