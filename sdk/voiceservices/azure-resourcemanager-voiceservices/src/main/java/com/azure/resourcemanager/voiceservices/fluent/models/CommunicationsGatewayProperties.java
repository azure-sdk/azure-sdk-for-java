...
public final class CommunicationsGatewayProperties {
     ...
     */
    @JsonProperty(value = "dnsDelegations")
     ...
     */
    @JsonProperty(value = "customSipHeaders")
     ...
     */
    @JsonProperty(value = "allocatedSignalingAddressPrefixes", access = JsonProperty.Access.WRITE_ONLY)
     ...
     */
    @JsonProperty(value = "allocatedMediaAddressPrefixes", access = JsonProperty.Access.WRITE_ONLY)
    ...
    /**
     * Get the teamsVoicemailPilotNumber property: This number is used in Teams Phone Mobile scenarios for access to
    ...
    /**
     * Set the teamsVoicemailPilotNumber property: This number is used in Teams Phone Mobile scenarios for access to
     * the voicemail IVR from the native dialer.
     * 
