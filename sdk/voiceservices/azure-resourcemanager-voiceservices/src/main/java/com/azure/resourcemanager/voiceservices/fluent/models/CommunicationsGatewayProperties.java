...
public final class CommunicationsGatewayProperties implements JsonSerializable<CommunicationsGatewayProperties> {
     ...
     */
    private ApiBridgeProperties apiBridge;
     ...
     */
    public ApiBridgeProperties apiBridge() {
     ...
     * @return the CommunicationsGatewayProperties object itself.
     */
    public CommunicationsGatewayProperties withApiBridge(ApiBridgeProperties apiBridge) {
    ...
    /**
     * Get the dnsDelegations property: Details of DNS Domains to delegate to the Communications Gateway.
     * 
     * @return the dnsDelegations value.
     */
    public DnsDelegationsProperties dnsDelegations() {
        return this.dnsDelegations;
    }

    /**
     * Set the dnsDelegations property: Details of DNS Domains to delegate to the Communications Gateway.
     * 
     * @param dnsDelegations the dnsDelegations value to set.
     * @return the CommunicationsGatewayProperties object itself.
     */
    public CommunicationsGatewayProperties withDnsDelegations(DnsDelegationsProperties dnsDelegations) {
        this.dnsDelegations = dnsDelegations;
        return this;
    }

    /**
     * Get the customSipHeaders property: Custom SIP Header to add to any subscriber with a custom_header value, if
     * required.
     * 
     * @return the customSipHeaders value.
     */
    public CustomSipHeadersProperties customSipHeaders() {
        return this.customSipHeaders;
    }

    /**
     * Set the customSipHeaders property: Custom SIP Header to add to any subscriber with a custom_header value, if
     * required.
     * 
     * @param customSipHeaders the customSipHeaders value to set.
     * @return the CommunicationsGatewayProperties object itself.
     */
    public CommunicationsGatewayProperties withCustomSipHeaders(CustomSipHeadersProperties customSipHeaders) {
        this.customSipHeaders = customSipHeaders;
        return this;
    }

    /**
     * Get the allocatedSignalingAddressPrefixes property: A list of IP allocated prefixes which may be used to receive
     * signaling data from this Communications Gateway.
     * 
     * @return the allocatedSignalingAddressPrefixes value.
     */
    public List<String> allocatedSignalingAddressPrefixes() {
        return this.allocatedSignalingAddressPrefixes;
    }

    /**
     * Get the allocatedMediaAddressPrefixes property: A list of allocated IP prefixes which may be used to receive
     * media data from this Communications Gateway.
     * 
     * @return the allocatedMediaAddressPrefixes value.
     */
    public List<String> allocatedMediaAddressPrefixes() {
        return this.allocatedMediaAddressPrefixes;
    }
    ...
    public void validate() {
        ...
        if (dnsDelegations() != null) {
            dnsDelegations().validate();
        }
        if (customSipHeaders() != null) {
            customSipHeaders().validate();
        }
    }
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeArrayField("platforms", this.platforms,
            (writer, element) -> writer.writeString(element == null ? null : element.toString()));
        jsonWriter.writeJsonField("apiBridge", this.apiBridge);
        ...
        jsonWriter.writeBooleanField("integratedMcpEnabled", this.integratedMcpEnabled);
        jsonWriter.writeArrayField("emergencyDialStrings", this.emergencyDialStrings,
            (writer, element) -> writer.writeString(element));
        jsonWriter.writeJsonField("dnsDelegations", this.dnsDelegations);
        jsonWriter.writeJsonField("customSipHeaders", this.customSipHeaders);
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("serviceLocations".equals(fieldName)) {
                    ...
                    deserializedCommunicationsGatewayProperties.apiBridge = ApiBridgeProperties.fromJson(reader);
                ...
                } else if ("integratedMcpEnabled".equals(fieldName)) {
                    deserializedCommunicationsGatewayProperties.integratedMcpEnabled
                        = reader.getNullable(JsonReader::getBoolean);
                ...
                } else if ("dnsDelegations".equals(fieldName)) {
                    deserializedCommunicationsGatewayProperties.dnsDelegations
                        = DnsDelegationsProperties.fromJson(reader);
                } else if ("customSipHeaders".equals(fieldName)) {
                    deserializedCommunicationsGatewayProperties.customSipHeaders
                        = CustomSipHeadersProperties.fromJson(reader);
                } else if ("allocatedSignalingAddressPrefixes".equals(fieldName)) {
                    List<String> allocatedSignalingAddressPrefixes = reader.readArray(reader1 -> reader1.getString());
                    deserializedCommunicationsGatewayProperties.allocatedSignalingAddressPrefixes
                        = allocatedSignalingAddressPrefixes;
                } else if ("allocatedMediaAddressPrefixes".equals(fieldName)) {
                    List<String> allocatedMediaAddressPrefixes = reader.readArray(reader1 -> reader1.getString());
                    deserializedCommunicationsGatewayProperties.allocatedMediaAddressPrefixes
