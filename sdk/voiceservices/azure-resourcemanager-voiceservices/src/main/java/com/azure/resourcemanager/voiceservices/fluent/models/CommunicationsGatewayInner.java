...
public final class CommunicationsGatewayInner extends Resource {
     ...
     * @return the CommunicationsGatewayInner object itself.
     */
    public CommunicationsGatewayInner withSku(Sku sku) {
        this.sku = sku;
        return this;
    }
     ...
     * @return the CommunicationsGatewayInner object itself.
     */
    public CommunicationsGatewayInner withApiBridge(ApiBridgeProperties apiBridge) {
        if (this.innerProperties() == null) {
            this.innerProperties = new CommunicationsGatewayProperties();
        }
    ...
    public DnsDelegationsProperties dnsDelegations() {
        return this.innerProperties() == null ? null : this.innerProperties().dnsDelegations();
    }
     ...
     * @return the CommunicationsGatewayInner object itself.
     */
    public CommunicationsGatewayInner withDnsDelegations(DnsDelegationsProperties dnsDelegations) {
        if (this.innerProperties() == null) {
            this.innerProperties = new CommunicationsGatewayProperties();
        }
        this.innerProperties().withDnsDelegations(dnsDelegations);
        return this;
    }
    ...
    public CustomSipHeadersProperties customSipHeaders() {
        return this.innerProperties() == null ? null : this.innerProperties().customSipHeaders();
    }
     ...
     * @return the CommunicationsGatewayInner object itself.
     */
    public CommunicationsGatewayInner withCustomSipHeaders(CustomSipHeadersProperties customSipHeaders) {
        if (this.innerProperties() == null) {
            this.innerProperties = new CommunicationsGatewayProperties();
        }
        this.innerProperties().withCustomSipHeaders(customSipHeaders);
        return this;
    }
    ...
    public List<String> allocatedSignalingAddressPrefixes() {
        return this.innerProperties() == null ? null : this.innerProperties().allocatedSignalingAddressPrefixes();
    }
    ...
    public List<String> allocatedMediaAddressPrefixes() {
        return this.innerProperties() == null ? null : this.innerProperties().allocatedMediaAddressPrefixes();
    }
