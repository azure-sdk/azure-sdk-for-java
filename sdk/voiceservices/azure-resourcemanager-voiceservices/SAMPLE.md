...
public final class CommunicationsGatewaysCreateOrUpdateSamples {
    ...
    public static void
        ...
        manager.communicationsGateways()
            ...
            .withPlatforms(
                Arrays.asList(CommunicationsPlatform.OPERATOR_CONNECT, CommunicationsPlatform.TEAMS_DIRECT_ROUTING))
            .withApiBridge(new ApiBridgeProperties().withConfigureApiBridge(ApiBridgeActivationState.ENABLED)
                .withAllowedAddressPrefixes(Arrays.asList("198.51.100.192/26")))
            .withAutoGeneratedDomainNameLabelScope(AutoGeneratedDomainNameLabelScope.NO_REUSE)
            .withTeamsVoicemailPilotNumber("1234567890")
            .withDnsDelegations(new DnsDelegationsProperties()
                .withDelegations(Arrays.asList(new DnsDelegationProperties().withDomain("commsgw.contoso.com"))))
            .withCustomSipHeaders(new CustomSipHeadersProperties()
...
public final class OperationsListSamples {
    /*
     * x-ms-original-file:
     * specification/voiceservices/resource-manager/Microsoft.VoiceServices/stable/2023-09-01/examples/Operations_List.
     * json
     */
    /**
...
public final class TestLinesDeleteSamples {
    /*
     * x-ms-original-file:
     * specification/voiceservices/resource-manager/Microsoft.VoiceServices/stable/2023-09-01/examples/TestLines_Delete.
     * json
     */
    /**
...
public final class TestLinesGetSamples {
    /*
     * x-ms-original-file:
     * specification/voiceservices/resource-manager/Microsoft.VoiceServices/stable/2023-09-01/examples/TestLines_Get.
     * json
     */
    /**
