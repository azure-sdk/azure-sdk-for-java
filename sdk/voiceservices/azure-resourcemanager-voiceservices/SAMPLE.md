...
```java
import com.azure.resourcemanager.voiceservices.models.ApiBridgeActivationState;
import com.azure.resourcemanager.voiceservices.models.ApiBridgeProperties;
...
import com.azure.resourcemanager.voiceservices.models.CustomSipHeader;
import com.azure.resourcemanager.voiceservices.models.CustomSipHeadersProperties;
import com.azure.resourcemanager.voiceservices.models.DnsDelegationProperties;
import com.azure.resourcemanager.voiceservices.models.DnsDelegationsProperties;
...
import com.azure.resourcemanager.voiceservices.models.Sku;
...
public final class CommunicationsGatewaysCreateOrUpdateSamples {
    /*
     * x-ms-original-file: specification/voiceservices/resource-manager/Microsoft.VoiceServices/stable/2023-09-01/examples/CommunicationsGateways_CreateOrUpdate.json
     */
    /**
     ...
     */
    public static void createCommunicationsGatewayResource(com.azure.resourcemanager.voiceservices.VoiceServicesManager manager) {
        manager.communicationsGateways().define("myname").withRegion("useast").withExistingResourceGroup("testrg").withSku(new Sku().withName("standard")).withServiceLocations(Arrays.asList(new ServiceRegionProperties().withName("useast").withPrimaryRegionProperties(new PrimaryRegionProperties().withOperatorAddresses(Arrays.asList("198.51.100.1")).withAllowedSignalingSourceAddressPrefixes(Arrays.asList("10.1.1.0/24")).withAllowedMediaSourceAddressPrefixes(Arrays.asList("10.1.2.0/24"))), new ServiceRegionProperties().withName("useast2").withPrimaryRegionProperties(new PrimaryRegionProperties().withOperatorAddresses(Arrays.asList("198.51.100.2")).withAllowedSignalingSourceAddressPrefixes(Arrays.asList("10.2.1.0/24")).withAllowedMediaSourceAddressPrefixes(Arrays.asList("10.2.2.0/24"))))).withConnectivity(Connectivity.PUBLIC_ADDRESS).withCodecs(Arrays.asList(TeamsCodecs.PCMA)).withE911Type(E911Type.STANDARD).withPlatforms(Arrays.asList(CommunicationsPlatform.OPERATOR_CONNECT, CommunicationsPlatform.TEAMS_DIRECT_ROUTING)).withApiBridge(new ApiBridgeProperties().withConfigureApiBridge(ApiBridgeActivationState.ENABLED).withAllowedAddressPrefixes(Arrays.asList("198.51.100.192/26"))).withAutoGeneratedDomainNameLabelScope(AutoGeneratedDomainNameLabelScope.NO_REUSE).withTeamsVoicemailPilotNumber("1234567890").withDnsDelegations(new DnsDelegationsProperties().withDelegations(Arrays.asList(new DnsDelegationProperties().withDomain("commsgw.contoso.com")))).withCustomSipHeaders(new CustomSipHeadersProperties().withHeaders(Arrays.asList(new CustomSipHeader().withName("x-contoso-commsgw-identifier")))).create();
    }
}
```
...
public final class CommunicationsGatewaysDeleteSamples {
    /*
     * x-ms-original-file: specification/voiceservices/resource-manager/Microsoft.VoiceServices/stable/2023-09-01/examples/CommunicationsGateways_Delete.json
     */
    /**
     ...
     * @param manager Entry point to VoiceServicesManager.
     */
    public static void deleteCommunicationsGatewayResource(com.azure.resourcemanager.voiceservices.VoiceServicesManager manager) {
...
public final class CommunicationsGatewaysGetByResourceGroupSamples {
    /*
     * x-ms-original-file: specification/voiceservices/resource-manager/Microsoft.VoiceServices/stable/2023-09-01/examples/CommunicationsGateways_Get.json
     */
    /**
     ...
     * @param manager Entry point to VoiceServicesManager.
     */
    public static void getCommunicationsGatewayResource(com.azure.resourcemanager.voiceservices.VoiceServicesManager manager) {
        manager.communicationsGateways().getByResourceGroupWithResponse("testrg", "myname", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class CommunicationsGatewaysListSamples {
    /*
     * x-ms-original-file: specification/voiceservices/resource-manager/Microsoft.VoiceServices/stable/2023-09-01/examples/CommunicationsGateways_ListBySubscription.json
     */
    /**
     ...
     * @param manager Entry point to VoiceServicesManager.
     */
    public static void listCommunicationsGatewayResourceSub(com.azure.resourcemanager.voiceservices.VoiceServicesManager manager) {
...
public final class CommunicationsGatewaysListByResourceGroupSamples {
    /*
     * x-ms-original-file: specification/voiceservices/resource-manager/Microsoft.VoiceServices/stable/2023-09-01/examples/CommunicationsGateways_ListByResourceGroup.json
     */
    /**
     ...
     * @param manager Entry point to VoiceServicesManager.
     */
    public static void listCommunicationsGatewayResource(com.azure.resourcemanager.voiceservices.VoiceServicesManager manager) {
...
public final class CommunicationsGatewaysUpdateSamples {
     ...
     * @param manager Entry point to VoiceServicesManager.
     */
    public static void updateCommunicationsGatewayResource(com.azure.resourcemanager.voiceservices.VoiceServicesManager manager) {
        CommunicationsGateway resource = manager.communicationsGateways().getByResourceGroupWithResponse("testrg", "myname", com.azure.core.util.Context.NONE).getValue();
...
public final class NameAvailabilityCheckLocalSamples {
    /*
     * x-ms-original-file: specification/voiceservices/resource-manager/Microsoft.VoiceServices/stable/2023-09-01/examples/NameAvailability_CheckLocal.json
     */
    /**
     ...
     * @param manager Entry point to VoiceServicesManager.
     */
    public static void checkLocalNameAvailability(com.azure.resourcemanager.voiceservices.VoiceServicesManager manager) {
        manager.nameAvailabilities().checkLocalWithResponse("useast", new CheckNameAvailabilityRequest().withName("myname").withType("Microsoft.VoiceServices/CommunicationsGateways"), com.azure.core.util.Context.NONE);
    }
}
```
...
public final class TestLinesCreateOrUpdateSamples {
    ...
    public static void createTestLineResource(com.azure.resourcemanager.voiceservices.VoiceServicesManager manager) {
        manager.testLines().define("myline").withRegion("useast").withExistingCommunicationsGateway("testrg", "myname").withPhoneNumber("+1-555-1234").withPurpose(TestLinePurpose.AUTOMATED).create();
    }
}
```
...
public final class TestLinesGetSamples {
    /*
     * x-ms-original-file: specification/voiceservices/resource-manager/Microsoft.VoiceServices/stable/2023-09-01/examples/TestLines_Get.json
     */
    /**
...
public final class TestLinesListByCommunicationsGatewaySamples {
    /*
     * x-ms-original-file: specification/voiceservices/resource-manager/Microsoft.VoiceServices/stable/2023-09-01/examples/TestLines_ListByCommunicationsGateway.json
     */
    /**
...
public final class TestLinesUpdateSamples {
    /*
     * x-ms-original-file: specification/voiceservices/resource-manager/Microsoft.VoiceServices/stable/2023-09-01/examples/TestLines_Update.json
     */
    /**
    ...
    public static void updateTestLineResource(com.azure.resourcemanager.voiceservices.VoiceServicesManager manager) {
        TestLine resource = manager.testLines().getWithResponse("testrg", "myname", "myline", com.azure.core.util.Context.NONE).getValue();
        resource.update().apply();
    }
}
```
