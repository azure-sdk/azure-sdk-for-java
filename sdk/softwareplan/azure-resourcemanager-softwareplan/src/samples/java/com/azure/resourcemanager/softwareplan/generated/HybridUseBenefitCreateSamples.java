...
public final class HybridUseBenefitCreateSamples {
    /*
     * x-ms-original-file:
     * specification/softwareplan/resource-manager/Microsoft.SoftwarePlan/stable/2019-12-01/examples/PutHybridUseBenefit
     * .json
     */
    /**
    ...
    public static void hybridUseBenefit(com.azure.resourcemanager.softwareplan.SoftwarePlanManager manager) {
        manager.hybridUseBenefits().define("94f46eda-45f8-493a-8425-251921463a89").withExistingScope(
            "subscriptions/{sub-id}/resourceGroups/{rg-name}/providers/Microsoft.Compute/HostGroups/{host-group-name}/hosts/{host-name}")
            .withSku(new Sku().withName("SQL_Server_Perpetual")).create();
    }
}
