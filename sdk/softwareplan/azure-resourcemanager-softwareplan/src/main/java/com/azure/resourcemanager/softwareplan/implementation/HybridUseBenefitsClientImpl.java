...
public final class HybridUseBenefitsClientImpl implements HybridUseBenefitsClient {
    ...
    public interface HybridUseBenefitsService {
        @Headers({ "Content-Type: application/json" })
        @Get("/{scope}/providers/Microsoft.SoftwarePlan/hybridUseBenefits")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<HybridUseBenefitListResult>> list(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<HybridUseBenefitModelInner>> create(@HostParam("$host") String endpoint,
            @PathParam(value = "scope", encoded = true) String scope, @PathParam("planId") String planId,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") HybridUseBenefitModelInner body, @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<HybridUseBenefitModelInner>> update(@HostParam("$host") String endpoint,
            @PathParam(value = "scope", encoded = true) String scope, @PathParam("planId") String planId,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") HybridUseBenefitModelInner body, @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<HybridUseBenefitModelInner>> get(@HostParam("$host") String endpoint,
            @PathParam(value = "scope", encoded = true) String scope, @PathParam("planId") String planId,
    ...
    private Mono<PagedResponse<HybridUseBenefitModelInner>> listSinglePageAsync(String scope, String filter) {
        ...
        return FluxUtil
            .withContext(context -> service.list(this.client.getEndpoint(), scope, this.client.getApiVersion(), filter,
                accept, context))
            .<PagedResponse<HybridUseBenefitModelInner>>map(res -> new PagedResponseBase<>(res.getRequest(),
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return response on GET of a hybrid use benefit along with {@link Response} on successful completion of
     * {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<HybridUseBenefitModelInner>> createWithResponseAsync(String scope, String planId,
        HybridUseBenefitModelInner body) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.create(this.client.getEndpoint(), scope, planId,
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<HybridUseBenefitModelInner>> createWithResponseAsync(String scope, String planId,
        HybridUseBenefitModelInner body, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.create(this.client.getEndpoint(), scope, planId, this.client.getApiVersion(), body, accept,
            context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<HybridUseBenefitModelInner> createWithResponse(String scope, String planId,
        HybridUseBenefitModelInner body, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<HybridUseBenefitModelInner>> updateWithResponseAsync(String scope, String planId,
        HybridUseBenefitModelInner body) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.update(this.client.getEndpoint(), scope, planId,
                this.client.getApiVersion(), body, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<HybridUseBenefitModelInner>> updateWithResponseAsync(String scope, String planId,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.update(this.client.getEndpoint(), scope, planId, this.client.getApiVersion(), body, accept,
            context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<HybridUseBenefitModelInner> updateWithResponse(String scope, String planId,
        HybridUseBenefitModelInner body, Context context) {
    ...
    private Mono<Response<HybridUseBenefitModelInner>> getWithResponseAsync(String scope, String planId) {
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.get(this.client.getEndpoint(), scope, planId, this.client.getApiVersion(),
                accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<Void>> deleteWithResponseAsync(String scope, String planId) {
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.delete(this.client.getEndpoint(), scope, planId,
