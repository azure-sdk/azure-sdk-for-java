...
public interface HybridUseBenefitsClient {
    ...
    Response<HybridUseBenefitModelInner> createWithResponse(String scope, String planId,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<HybridUseBenefitModelInner> updateWithResponse(String scope, String planId,
        HybridUseBenefitModelInner body, Context context);
