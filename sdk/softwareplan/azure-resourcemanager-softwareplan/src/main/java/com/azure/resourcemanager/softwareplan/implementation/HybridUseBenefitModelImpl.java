...
public final class HybridUseBenefitModelImpl
    ...
    public HybridUseBenefitModel create() {
        this.innerObject = serviceManager.serviceClient().getHybridUseBenefits()
            .createWithResponse(scope, planId, this.innerModel(), Context.NONE).getValue();
        return this;
    }

    public HybridUseBenefitModel create(Context context) {
        this.innerObject = serviceManager.serviceClient().getHybridUseBenefits()
            .createWithResponse(scope, planId, this.innerModel(), context).getValue();
        return this;
    }
    ...
    public HybridUseBenefitModel apply() {
        this.innerObject = serviceManager.serviceClient().getHybridUseBenefits()
            .updateWithResponse(scope, planId, this.innerModel(), Context.NONE).getValue();
        return this;
    }

    public HybridUseBenefitModel apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getHybridUseBenefits()
            .updateWithResponse(scope, planId, this.innerModel(), context).getValue();
        return this;
    }

    HybridUseBenefitModelImpl(HybridUseBenefitModelInner innerObject,
        ...
        this.scope = Utils.getValueFromIdByParameterName(innerObject.id(),
            "/{scope}/providers/Microsoft.SoftwarePlan/hybridUseBenefits/{planId}", "scope");
        this.planId = Utils.getValueFromIdByParameterName(innerObject.id(),
            "/{scope}/providers/Microsoft.SoftwarePlan/hybridUseBenefits/{planId}", "planId");
    }

    public HybridUseBenefitModel refresh() {
        this.innerObject = serviceManager.serviceClient().getHybridUseBenefits()
            .getWithResponse(scope, planId, Context.NONE).getValue();
        return this;
    }
