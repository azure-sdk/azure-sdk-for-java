...
public final class HybridUseBenefitsImpl implements HybridUseBenefits {
    ...
    public HybridUseBenefitsImpl(HybridUseBenefitsClient innerClient,
    ...
    public HybridUseBenefitModel getById(String id) {
        ...
        String planId = Utils.getValueFromIdByParameterName(id,
            "/{scope}/providers/Microsoft.SoftwarePlan/hybridUseBenefits/{planId}", "planId");
        if (planId == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
                String.format("The resource ID '%s' is not valid. Missing path segment 'hybridUseBenefits'.", id)));
        }
