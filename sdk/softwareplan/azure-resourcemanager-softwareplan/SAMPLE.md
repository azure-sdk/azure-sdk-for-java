...
public final class HybridUseBenefitCreateSamples {
    ...
    public static void hybridUseBenefit(com.azure.resourcemanager.softwareplan.SoftwarePlanManager manager) {
        manager.hybridUseBenefits().define("94f46eda-45f8-493a-8425-251921463a89").withExistingScope("subscriptions/{sub-id}/resourceGroups/{rg-name}/providers/Microsoft.Compute/HostGroups/{host-group-name}/hosts/{host-name}").withSku(new Sku().withName("SQL_Server_Perpetual")).create();
    }
}
```
...
public final class HybridUseBenefitDeleteSamples {
     ...
     */
    public static void hybridUseBenefit(com.azure.resourcemanager.softwareplan.SoftwarePlanManager manager) {
        manager.hybridUseBenefits().deleteByResourceGroupWithResponse("subscriptions/{sub-id}/resourceGroups/{rg-name}/providers/Microsoft.Compute/HostGroups/{host-group-name}/hosts/{host-name}", "94f46eda-45f8-493a-8425-251921463a89", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class HybridUseBenefitGetSamples {
     ...
     */
    public static void hybridUseBenefit(com.azure.resourcemanager.softwareplan.SoftwarePlanManager manager) {
        manager.hybridUseBenefits().getWithResponse("subscriptions/{sub-id}/resourceGroups/{rg-name}/providers/Microsoft.Compute/HostGroups/{host-group-name}/hosts/{host-name}", "94f46eda-45f8-493a-8425-251921463a89", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class HybridUseBenefitListSamples {
    ...
    public static void hybridUseBenefitListResult(com.azure.resourcemanager.softwareplan.SoftwarePlanManager manager) {
        manager.hybridUseBenefits().list("subscriptions/{sub-id}/resourceGroups/{rg-name}/providers/Microsoft.Compute/HostGroups/{host-group-name}/hosts/{host-name}", "SQL_Server_EE_AHB", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class HybridUseBenefitUpdateSamples {
     ...
     */
    public static void hybridUseBenefit(com.azure.resourcemanager.softwareplan.SoftwarePlanManager manager) {
        HybridUseBenefitModel resource = manager.hybridUseBenefits().getWithResponse("subscriptions/{sub-id}/resourceGroups/{rg-name}/providers/Microsoft.Compute/HostGroups/{host-group-name}/hosts/{host-name}", "94f46eda-45f8-493a-8425-251921463a89", com.azure.core.util.Context.NONE).getValue();
...
public final class HybridUseBenefitRevisionListSamples {
     ...
     * @param manager Entry point to SoftwarePlanManager.
     */
    public static void hybridUseBenefitRevisionsResponse(com.azure.resourcemanager.softwareplan.SoftwarePlanManager manager) {
        manager.hybridUseBenefitRevisions().list("subscriptions/{sub-id}/resourceGroups/{rg-name}/providers/Microsoft.Compute/HostGroups/{host-group-name}/hosts/{host-name}", "94f46eda-45f8-493a-8425-251921463a89", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class OperationsListSamples {
    ...
    public static void getOperations(com.azure.resourcemanager.softwareplan.SoftwarePlanManager manager) {
        manager.operations().list("subscriptions/{sub-id}/resourceGroups/{rg-name}/providers/Microsoft.Compute/HostGroups/{host-group-name}/hosts/{host-name}", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class SoftwarePlanRegisterSamples {
     ...
     */
    public static void hybridUseBenefitListResult(com.azure.resourcemanager.softwareplan.SoftwarePlanManager manager) {
        manager.softwarePlans().registerWithResponse(com.azure.core.util.Context.NONE);
    }
}
```
