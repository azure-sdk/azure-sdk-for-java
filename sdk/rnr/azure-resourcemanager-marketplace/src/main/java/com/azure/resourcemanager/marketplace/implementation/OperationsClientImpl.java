...
import com.azure.resourcemanager.marketplace.fluent.models.OperationInner;
...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    OperationsClientImpl(MarketplaceClientImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for MarketplaceClientOperations to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "MarketplaceClientOpe")
