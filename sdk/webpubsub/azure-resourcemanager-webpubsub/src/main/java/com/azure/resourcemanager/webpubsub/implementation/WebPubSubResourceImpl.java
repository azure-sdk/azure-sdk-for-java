...
public final class WebPubSubResourceImpl
    ...
    public WebPubSubResource create() {
        this.innerObject = serviceManager.serviceClient().getWebPubSubs().createOrUpdate(resourceGroupName,
    ...
    public WebPubSubResource apply() {
        this.innerObject = serviceManager.serviceClient().getWebPubSubs().update(resourceGroupName, resourceName,
    ...
    public WebPubSubResource refresh() {
        this.innerObject = serviceManager.serviceClient().getWebPubSubs()
