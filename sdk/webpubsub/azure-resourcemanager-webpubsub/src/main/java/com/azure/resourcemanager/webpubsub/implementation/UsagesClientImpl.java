...
public final class UsagesClientImpl implements UsagesClient {
    ...
    public interface UsagesService {
        ...
        Mono<Response<SignalRServiceUsageList>> list(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<SignalRServiceUsageList>> listNext(@PathParam(value = "nextLink", encoded = true) String nextLink,
    ...
    private Mono<PagedResponse<SignalRServiceUsageInner>> listSinglePageAsync(String location) {
        ...
        return FluxUtil
            ...
            .<PagedResponse<SignalRServiceUsageInner>>map(res -> new PagedResponseBase<>(res.getRequest(),
