...
public final class ReplicaImpl implements Replica, Replica.Definition, Replica.Update {
    ...
    public Replica create() {
        this.innerObject = serviceManager.serviceClient().getWebPubSubReplicas().createOrUpdate(resourceGroupName,
            resourceName, replicaName, this.innerModel(), Context.NONE);
        return this;
    }

    public Replica create(Context context) {
        this.innerObject = serviceManager.serviceClient().getWebPubSubReplicas().createOrUpdate(resourceGroupName,
            resourceName, replicaName, this.innerModel(), context);
        return this;
    }
    ...
    public Replica apply() {
        this.innerObject = serviceManager.serviceClient().getWebPubSubReplicas().update(resourceGroupName, resourceName,
            replicaName, this.innerModel(), Context.NONE);
        return this;
    }

    public Replica apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getWebPubSubReplicas().update(resourceGroupName, resourceName,
            replicaName, this.innerModel(), context);
        return this;
    }
    ...
    public Replica refresh() {
        this.innerObject = serviceManager.serviceClient().getWebPubSubReplicas()
            .getWithResponse(resourceGroupName, resourceName, replicaName, Context.NONE).getValue();
        return this;
    }

    public Replica refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getWebPubSubReplicas()
            .getWithResponse(resourceGroupName, resourceName, replicaName, context).getValue();
        return this;
    }
