...
public final class WebPubSubManagementClientImpl implements WebPubSubManagementClient {
    ...
    /**
     * The WebPubSubReplicaOperationsClient object to access its operations.
     */
    private final WebPubSubReplicaOperationsClient webPubSubReplicaOperations;

    /**
     * Gets the WebPubSubReplicaOperationsClient object to access its operations.
     * 
     * @return the WebPubSubReplicaOperationsClient object.
     */
    public WebPubSubReplicaOperationsClient getWebPubSubReplicaOperations() {
        return this.webPubSubReplicaOperations;
    }
    ...
    public WebPubSubSharedPrivateLinkResourcesClient getWebPubSubSharedPrivateLinkResources() {
        return this.webPubSubSharedPrivateLinkResources;
    }
    ...
    WebPubSubManagementClientImpl(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter,
        ...
        this.webPubSubReplicaOperations = new WebPubSubReplicaOperationsClientImpl(this);
