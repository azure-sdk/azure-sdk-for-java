...
public final class CustomDomainImpl implements CustomDomain, CustomDomain.Definition, CustomDomain.Update {
    ...
    public CustomDomain create() {
        this.innerObject = serviceManager.serviceClient().getWebPubSubCustomDomains().createOrUpdate(resourceGroupName,
            resourceName, name, this.innerModel(), Context.NONE);
        return this;
    }

    public CustomDomain create(Context context) {
        this.innerObject = serviceManager.serviceClient().getWebPubSubCustomDomains().createOrUpdate(resourceGroupName,
            resourceName, name, this.innerModel(), context);
        return this;
    }
    ...
    public CustomDomain refresh() {
        this.innerObject = serviceManager.serviceClient().getWebPubSubCustomDomains()
            .getWithResponse(resourceGroupName, resourceName, name, Context.NONE).getValue();
        return this;
    }

    public CustomDomain refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getWebPubSubCustomDomains()
            .getWithResponse(resourceGroupName, resourceName, name, context).getValue();
        return this;
    }
