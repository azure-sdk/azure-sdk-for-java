...
public final class CustomCertificateImpl
    ...
    public CustomCertificate create() {
        this.innerObject = serviceManager.serviceClient().getWebPubSubCustomCertificates()
    ...
    public CustomCertificate refresh() {
        this.innerObject = serviceManager.serviceClient().getWebPubSubCustomCertificates()
            .getWithResponse(resourceGroupName, resourceName, certificateName, Context.NONE).getValue();
        return this;
    }

    public CustomCertificate refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getWebPubSubCustomCertificates()
            .getWithResponse(resourceGroupName, resourceName, certificateName, context).getValue();
        return this;
    }
