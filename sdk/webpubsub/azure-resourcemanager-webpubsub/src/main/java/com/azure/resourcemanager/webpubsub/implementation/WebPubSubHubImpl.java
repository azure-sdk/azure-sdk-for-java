...
public final class WebPubSubHubImpl implements WebPubSubHub, WebPubSubHub.Definition, WebPubSubHub.Update {
    ...
    public WebPubSubHub create() {
        this.innerObject = serviceManager.serviceClient().getWebPubSubHubs().createOrUpdate(hubName, resourceGroupName,
    ...
    public WebPubSubHub refresh() {
        this.innerObject = serviceManager.serviceClient().getWebPubSubHubs()
            .getWithResponse(hubName, resourceGroupName, resourceName, Context.NONE).getValue();
        return this;
    }

    public WebPubSubHub refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getWebPubSubHubs()
            .getWithResponse(hubName, resourceGroupName, resourceName, context).getValue();
        return this;
    }
