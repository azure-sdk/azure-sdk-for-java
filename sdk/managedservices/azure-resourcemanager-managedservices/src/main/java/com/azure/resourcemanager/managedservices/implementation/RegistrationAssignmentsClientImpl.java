...
public final class RegistrationAssignmentsClientImpl implements RegistrationAssignmentsClient {
    ...
    RegistrationAssignmentsClientImpl(ManagedServicesClientImpl client) {
        this.service = RestProxy.create(RegistrationAssignmentsService.class, client.getHttpPipeline(),
    ...
    public interface RegistrationAssignmentsService {
        @Headers({ "Content-Type: application/json" })
        @Get("/{scope}/providers/Microsoft.ManagedServices/registrationAssignments/{registrationAssignmentId}")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<RegistrationAssignmentInner>> get(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<RegistrationAssignmentList>> list(@HostParam("$host") String endpoint,
            @PathParam(value = "scope", encoded = true) String scope,
            @QueryParam("$expandRegistrationDefinition") Boolean expandRegistrationDefinition,
    ...
    private Mono<Response<RegistrationAssignmentInner>> getWithResponseAsync(String scope,
        String registrationAssignmentId, Boolean expandRegistrationDefinition) {
        ...
        return FluxUtil
            .withContext(context -> service.get(this.client.getEndpoint(), scope, registrationAssignmentId,
                expandRegistrationDefinition, this.client.getApiVersion(), accept, context))
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<RegistrationAssignmentInner>> getWithResponseAsync(String scope,
        String registrationAssignmentId, Boolean expandRegistrationDefinition, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service.get(this.client.getEndpoint(), scope, registrationAssignmentId, expandRegistrationDefinition,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<RegistrationAssignmentInner> getWithResponse(String scope, String registrationAssignmentId,
        Boolean expandRegistrationDefinition, Context context) {
    ...
    private Mono<Response<Flux<ByteBuffer>>> deleteWithResponseAsync(String scope, String registrationAssignmentId) {
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.delete(this.client.getEndpoint(), scope, registrationAssignmentId,
                this.client.getApiVersion(), accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> deleteWithResponseAsync(String scope, String registrationAssignmentId,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.delete(this.client.getEndpoint(), scope, registrationAssignmentId, this.client.getApiVersion(),
            accept, context);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String scope, String registrationAssignmentId) {
        return this.beginDeleteAsync(scope, registrationAssignmentId).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String scope, String registrationAssignmentId,
        Context context) {
        return this.beginDeleteAsync(scope, registrationAssignmentId, context).getSyncPoller();
    }
    ...
    private Mono<Void> deleteAsync(String scope, String registrationAssignmentId, Context context) {
        return beginDeleteAsync(scope, registrationAssignmentId, context).last()
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String scope,
        String registrationAssignmentId, RegistrationAssignmentInner requestBody) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.createOrUpdate(this.client.getEndpoint(), scope, registrationAssignmentId,
                this.client.getApiVersion(), requestBody, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String scope,
        String registrationAssignmentId, RegistrationAssignmentInner requestBody, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.createOrUpdate(this.client.getEndpoint(), scope, registrationAssignmentId,
            this.client.getApiVersion(), requestBody, accept, context);
    }
    ...
    private PollerFlux<PollResult<RegistrationAssignmentInner>, RegistrationAssignmentInner> beginCreateOrUpdateAsync(
        ...
        return this.client.<RegistrationAssignmentInner, RegistrationAssignmentInner>getLroResult(mono,
            this.client.getHttpPipeline(), RegistrationAssignmentInner.class, RegistrationAssignmentInner.class,
            this.client.getContext());
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<RegistrationAssignmentInner>, RegistrationAssignmentInner>
        beginCreateOrUpdate(String scope, String registrationAssignmentId, RegistrationAssignmentInner requestBody) {
        return this.beginCreateOrUpdateAsync(scope, registrationAssignmentId, requestBody).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<RegistrationAssignmentInner>, RegistrationAssignmentInner> beginCreateOrUpdate(
        String scope, String registrationAssignmentId, RegistrationAssignmentInner requestBody, Context context) {
        return this.beginCreateOrUpdateAsync(scope, registrationAssignmentId, requestBody, context).getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<RegistrationAssignmentInner> createOrUpdateAsync(String scope, String registrationAssignmentId,
        RegistrationAssignmentInner requestBody) {
        return beginCreateOrUpdateAsync(scope, registrationAssignmentId, requestBody).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<RegistrationAssignmentInner> createOrUpdateAsync(String scope, String registrationAssignmentId,
        RegistrationAssignmentInner requestBody, Context context) {
        return beginCreateOrUpdateAsync(scope, registrationAssignmentId, requestBody, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public RegistrationAssignmentInner createOrUpdate(String scope, String registrationAssignmentId,
        RegistrationAssignmentInner requestBody) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<RegistrationAssignmentInner>> listSinglePageAsync(String scope,
        Boolean expandRegistrationDefinition, String filter) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.list(this.client.getEndpoint(), scope, expandRegistrationDefinition,
                this.client.getApiVersion(), filter, accept, context))
            .<PagedResponse<RegistrationAssignmentInner>>map(res -> new PagedResponseBase<>(res.getRequest(),
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<RegistrationAssignmentInner>> listSinglePageAsync(String scope,
        Boolean expandRegistrationDefinition, String filter, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        context = this.client.mergeContext(context);
        return service
            .list(this.client.getEndpoint(), scope, expandRegistrationDefinition, this.client.getApiVersion(), filter,
                accept, context)
    ...
    private PagedFlux<RegistrationAssignmentInner> listAsync(String scope, Boolean expandRegistrationDefinition,
        String filter) {
        return new PagedFlux<>(() -> listSinglePageAsync(scope, expandRegistrationDefinition, filter),
    ...
    private PagedFlux<RegistrationAssignmentInner> listAsync(String scope, Boolean expandRegistrationDefinition,
        ...
        return new PagedFlux<>(() -> listSinglePageAsync(scope, expandRegistrationDefinition, filter, context),
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<RegistrationAssignmentInner> list(String scope, Boolean expandRegistrationDefinition,
        String filter, Context context) {
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the list of registration assignments along with {@link PagedResponse} on successful completion of
     * {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
