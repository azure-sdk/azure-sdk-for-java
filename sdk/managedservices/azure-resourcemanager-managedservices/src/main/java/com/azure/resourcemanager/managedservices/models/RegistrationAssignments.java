...
public interface RegistrationAssignments {
     ...
     */
    Response<RegistrationAssignment> getWithResponse(String scope, String registrationAssignmentId,
     ...
     * @return a list of the registration assignments as paginated response with {@link PagedIterable}.
     */
    PagedIterable<RegistrationAssignment> list(String scope, Boolean expandRegistrationDefinition, String filter,
        Context context);
     ...
     * @return the details of the specified registration assignment along with {@link Response}.
     */
    Response<RegistrationAssignment> getByIdWithResponse(String id, Boolean expandRegistrationDefinition,
        Context context);
