...
public interface RegistrationDefinitionsClient {
    ...
    Response<RegistrationDefinitionInner> getWithResponse(String scope, String registrationDefinitionId,
        Context context);
    ...
    SyncPoller<PollResult<RegistrationDefinitionInner>, RegistrationDefinitionInner>
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    RegistrationDefinitionInner createOrUpdate(String registrationDefinitionId, String scope,
