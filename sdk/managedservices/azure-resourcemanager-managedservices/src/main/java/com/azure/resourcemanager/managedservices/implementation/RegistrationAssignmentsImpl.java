...
public final class RegistrationAssignmentsImpl implements RegistrationAssignments {
    ...
    public RegistrationAssignmentsImpl(RegistrationAssignmentsClient innerClient,
        com.azure.resourcemanager.managedservices.ManagedServicesManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public Response<RegistrationAssignment> getWithResponse(String scope, String registrationAssignmentId,
        Boolean expandRegistrationDefinition, Context context) {
        Response<RegistrationAssignmentInner> inner = this.serviceClient()
    ...
    public PagedIterable<RegistrationAssignment> list(String scope) {
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new RegistrationAssignmentImpl(inner1, this.manager()));
    }

    public PagedIterable<RegistrationAssignment> list(String scope, Boolean expandRegistrationDefinition, String filter,
        Context context) {
    ...
    public RegistrationAssignment getById(String id) {
        String scope = ResourceManagerUtils.getValueFromIdByParameterName(id,
            "/{scope}/providers/Microsoft.ManagedServices/registrationAssignments/{registrationAssignmentId}", "scope");
        if (scope == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
                String.format("The resource ID '%s' is not valid. Missing path segment 'scope'.", id)));
        }
        String registrationAssignmentId = ResourceManagerUtils.getValueFromIdByParameterName(id,
        ...
        if (registrationAssignmentId == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(String
                .format("The resource ID '%s' is not valid. Missing path segment 'registrationAssignments'.", id)));
        }
        Boolean localExpandRegistrationDefinition = null;
        return this.getWithResponse(scope, registrationAssignmentId, localExpandRegistrationDefinition, Context.NONE)
            .getValue();
    }

    public Response<RegistrationAssignment> getByIdWithResponse(String id, Boolean expandRegistrationDefinition,
        Context context) {
        String scope = ResourceManagerUtils.getValueFromIdByParameterName(id,
            "/{scope}/providers/Microsoft.ManagedServices/registrationAssignments/{registrationAssignmentId}", "scope");
        if (scope == null) {
