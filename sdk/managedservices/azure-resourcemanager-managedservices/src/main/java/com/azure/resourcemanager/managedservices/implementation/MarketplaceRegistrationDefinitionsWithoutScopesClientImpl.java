...
public final class MarketplaceRegistrationDefinitionsWithoutScopesClientImpl
    ...
    MarketplaceRegistrationDefinitionsWithoutScopesClientImpl(ManagedServicesClientImpl client) {
        this.service = RestProxy.create(MarketplaceRegistrationDefinitionsWithoutScopesService.class,
    ...
    public interface MarketplaceRegistrationDefinitionsWithoutScopesService {
        @Headers({ "Content-Type: application/json" })
        @Get("/providers/Microsoft.ManagedServices/marketplaceRegistrationDefinitions")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<MarketplaceRegistrationDefinitionList>> list(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<MarketplaceRegistrationDefinitionInner>> get(@HostParam("$host") String endpoint,
     ...
     * @return a list of the marketplace registration definitions for the marketplace identifier along with
     * {@link PagedResponse} on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<MarketplaceRegistrationDefinitionInner>> listSinglePageAsync(String filter) {
        ...
        return FluxUtil.withContext(
            context -> service.list(this.client.getEndpoint(), filter, this.client.getApiVersion(), accept, context))
            .<PagedResponse<MarketplaceRegistrationDefinitionInner>>map(res -> new PagedResponseBase<>(res.getRequest(),
    ...
    private Mono<PagedResponse<MarketplaceRegistrationDefinitionInner>> listSinglePageAsync(String filter,
        ...
        return service.list(this.client.getEndpoint(), filter, this.client.getApiVersion(), accept, context)
    ...
    private PagedFlux<MarketplaceRegistrationDefinitionInner> listAsync(String filter) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<MarketplaceRegistrationDefinitionInner> listAsync() {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<MarketplaceRegistrationDefinitionInner> listAsync(String filter, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<MarketplaceRegistrationDefinitionInner> list() {
        final String filter = null;
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<MarketplaceRegistrationDefinitionInner> list(String filter, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<MarketplaceRegistrationDefinitionInner>> getWithResponseAsync(String marketplaceIdentifier) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.get(this.client.getEndpoint(), marketplaceIdentifier,
    ...
    private Mono<Response<MarketplaceRegistrationDefinitionInner>> getWithResponseAsync(String marketplaceIdentifier,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.get(this.client.getEndpoint(), marketplaceIdentifier, this.client.getApiVersion(), accept,
            context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the marketplace registration definition for the marketplace identifier on successful completion of
     * {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<MarketplaceRegistrationDefinitionInner> getAsync(String marketplaceIdentifier) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<MarketplaceRegistrationDefinitionInner> getWithResponse(String marketplaceIdentifier,
        Context context) {
