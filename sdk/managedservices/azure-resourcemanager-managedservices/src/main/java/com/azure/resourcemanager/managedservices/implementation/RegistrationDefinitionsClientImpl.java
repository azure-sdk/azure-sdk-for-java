...
public final class RegistrationDefinitionsClientImpl implements RegistrationDefinitionsClient {
    ...
    RegistrationDefinitionsClientImpl(ManagedServicesClientImpl client) {
        this.service = RestProxy.create(RegistrationDefinitionsService.class, client.getHttpPipeline(),
    ...
    public interface RegistrationDefinitionsService {
        @Headers({ "Content-Type: application/json" })
        @Get("/{scope}/providers/Microsoft.ManagedServices/registrationDefinitions/{registrationDefinitionId}")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<RegistrationDefinitionInner>> get(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<RegistrationDefinitionList>> list(@HostParam("$host") String endpoint,
    ...
    private Mono<Response<RegistrationDefinitionInner>> getWithResponseAsync(String scope,
        ...
        return FluxUtil
            .withContext(context -> service.get(this.client.getEndpoint(), scope, registrationDefinitionId,
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<RegistrationDefinitionInner>> getWithResponseAsync(String scope,
        String registrationDefinitionId, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service.get(this.client.getEndpoint(), scope, registrationDefinitionId, this.client.getApiVersion(),
            accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<RegistrationDefinitionInner> getWithResponse(String scope, String registrationDefinitionId,
        Context context) {
    ...
    private Mono<Response<Void>> deleteWithResponseAsync(String registrationDefinitionId, String scope) {
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.delete(this.client.getEndpoint(), registrationDefinitionId,
                this.client.getApiVersion(), scope, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<Void>> deleteWithResponseAsync(String registrationDefinitionId, String scope,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.delete(this.client.getEndpoint(), registrationDefinitionId, this.client.getApiVersion(), scope,
            accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String registrationDefinitionId,
        String scope, RegistrationDefinitionInner requestBody) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.createOrUpdate(this.client.getEndpoint(), registrationDefinitionId,
                this.client.getApiVersion(), scope, requestBody, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String registrationDefinitionId,
        String scope, RegistrationDefinitionInner requestBody, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.createOrUpdate(this.client.getEndpoint(), registrationDefinitionId, this.client.getApiVersion(),
            scope, requestBody, accept, context);
    }
    ...
    private PollerFlux<PollResult<RegistrationDefinitionInner>, RegistrationDefinitionInner> beginCreateOrUpdateAsync(
        ...
        return this.client.<RegistrationDefinitionInner, RegistrationDefinitionInner>getLroResult(mono,
            this.client.getHttpPipeline(), RegistrationDefinitionInner.class, RegistrationDefinitionInner.class,
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<RegistrationDefinitionInner>, RegistrationDefinitionInner>
        beginCreateOrUpdate(String registrationDefinitionId, String scope, RegistrationDefinitionInner requestBody) {
        return this.beginCreateOrUpdateAsync(registrationDefinitionId, scope, requestBody).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<RegistrationDefinitionInner>, RegistrationDefinitionInner> beginCreateOrUpdate(
        String registrationDefinitionId, String scope, RegistrationDefinitionInner requestBody, Context context) {
        return this.beginCreateOrUpdateAsync(registrationDefinitionId, scope, requestBody, context).getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<RegistrationDefinitionInner> createOrUpdateAsync(String registrationDefinitionId, String scope,
        RegistrationDefinitionInner requestBody) {
        return beginCreateOrUpdateAsync(registrationDefinitionId, scope, requestBody).last()
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<RegistrationDefinitionInner> createOrUpdateAsync(String registrationDefinitionId, String scope,
        RegistrationDefinitionInner requestBody, Context context) {
        return beginCreateOrUpdateAsync(registrationDefinitionId, scope, requestBody, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public RegistrationDefinitionInner createOrUpdate(String registrationDefinitionId, String scope,
        RegistrationDefinitionInner requestBody) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<RegistrationDefinitionInner>> listSinglePageAsync(String scope, String filter) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return FluxUtil
            .withContext(context -> service.list(this.client.getEndpoint(), scope, this.client.getApiVersion(), filter,
                accept, context))
            .<PagedResponse<RegistrationDefinitionInner>>map(res -> new PagedResponseBase<>(res.getRequest(),
    ...
    private Mono<PagedResponse<RegistrationDefinitionInner>> listSinglePageAsync(String scope, String filter,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.list(this.client.getEndpoint(), scope, this.client.getApiVersion(), filter, accept, context)
    ...
    private PagedFlux<RegistrationDefinitionInner> listAsync(String scope, String filter) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<RegistrationDefinitionInner> listAsync(String scope, String filter, Context context) {
        return new PagedFlux<>(() -> listSinglePageAsync(scope, filter, context),
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<RegistrationDefinitionInner> list(String scope, String filter, Context context) {
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the list of registration definitions along with {@link PagedResponse} on successful completion of
     * {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
