 ...
 */
@Fluent
public final class RegistrationDefinitionProperties implements JsonSerializable<RegistrationDefinitionProperties> {
    /*
    ...
    /**
     * Creates an instance of RegistrationDefinitionProperties class.
     */
    ...
    /**
     * Reads an instance of RegistrationDefinitionProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of RegistrationDefinitionProperties if the JsonReader was pointing to an instance of it, or
     * null if it was pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the RegistrationDefinitionProperties.
     */
    public static RegistrationDefinitionProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            RegistrationDefinitionProperties deserializedRegistrationDefinitionProperties
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("authorizations".equals(fieldName)) {
                    ...
                    deserializedRegistrationDefinitionProperties.authorizations = authorizations;
                } else if ("managedByTenantId".equals(fieldName)) {
                    deserializedRegistrationDefinitionProperties.managedByTenantId = reader.getString();
                } else if ("description".equals(fieldName)) {
                    deserializedRegistrationDefinitionProperties.description = reader.getString();
                    ...
                    deserializedRegistrationDefinitionProperties.eligibleAuthorizations = eligibleAuthorizations;
                } else if ("registrationDefinitionName".equals(fieldName)) {
                    deserializedRegistrationDefinitionProperties.registrationDefinitionName = reader.getString();
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedRegistrationDefinitionProperties.provisioningState
                        = ProvisioningState.fromString(reader.getString());
                } else if ("manageeTenantId".equals(fieldName)) {
                    deserializedRegistrationDefinitionProperties.manageeTenantId = reader.getString();
                } else if ("manageeTenantName".equals(fieldName)) {
                    deserializedRegistrationDefinitionProperties.manageeTenantName = reader.getString();
                } else if ("managedByTenantName".equals(fieldName)) {
                    deserializedRegistrationDefinitionProperties.managedByTenantName = reader.getString();
                } else {
                    reader.skipChildren();
                }
            }

            return deserializedRegistrationDefinitionProperties;
        });
    }
}
