...
public final class MarketplaceRegistrationDefinitionsImpl implements MarketplaceRegistrationDefinitions {
    ...
    public MarketplaceRegistrationDefinitionsImpl(MarketplaceRegistrationDefinitionsClient innerClient,
    ...
    public PagedIterable<MarketplaceRegistrationDefinition> list(String scope) {
        ...
        return ResourceManagerUtils.mapPage(inner,
            inner1 -> new MarketplaceRegistrationDefinitionImpl(inner1, this.manager()));
    }
    ...
    public Response<MarketplaceRegistrationDefinition> getWithResponse(String scope, String marketplaceIdentifier,
        Context context) {
