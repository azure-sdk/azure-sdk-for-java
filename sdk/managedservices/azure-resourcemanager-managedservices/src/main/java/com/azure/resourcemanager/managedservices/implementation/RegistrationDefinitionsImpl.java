...
public final class RegistrationDefinitionsImpl implements RegistrationDefinitions {
    ...
    public RegistrationDefinitionsImpl(RegistrationDefinitionsClient innerClient,
        com.azure.resourcemanager.managedservices.ManagedServicesManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public Response<RegistrationDefinition> getWithResponse(String scope, String registrationDefinitionId,
        Context context) {
    ...
    public Response<Void> deleteByResourceGroupWithResponse(String registrationDefinitionId, String scope,
        Context context) {
    ...
    public PagedIterable<RegistrationDefinition> list(String scope) {
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new RegistrationDefinitionImpl(inner1, this.manager()));
    }
    ...
    public RegistrationDefinition getById(String id) {
        String scope = ResourceManagerUtils.getValueFromIdByParameterName(id,
            "/{scope}/providers/Microsoft.ManagedServices/registrationDefinitions/{registrationDefinitionId}", "scope");
        if (scope == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
                String.format("The resource ID '%s' is not valid. Missing path segment 'scope'.", id)));
        }
        String registrationDefinitionId = ResourceManagerUtils.getValueFromIdByParameterName(id,
        ...
        if (registrationDefinitionId == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(String
                .format("The resource ID '%s' is not valid. Missing path segment 'registrationDefinitions'.", id)));
        }
