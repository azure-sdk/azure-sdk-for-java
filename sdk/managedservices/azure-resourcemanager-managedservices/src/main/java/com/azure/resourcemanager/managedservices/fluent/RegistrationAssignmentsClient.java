...
public interface RegistrationAssignmentsClient {
    ...
    Response<RegistrationAssignmentInner> getWithResponse(String scope, String registrationAssignmentId,
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<RegistrationAssignmentInner>, RegistrationAssignmentInner> beginCreateOrUpdate(String scope,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    RegistrationAssignmentInner createOrUpdate(String scope, String registrationAssignmentId,
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<RegistrationAssignmentInner> list(String scope, Boolean expandRegistrationDefinition, String filter,
        Context context);
}
