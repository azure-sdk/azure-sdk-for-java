...
public final class RegistrationDefinitionImpl
    ...
    RegistrationDefinitionImpl(String name,
    ...
    RegistrationDefinitionImpl(RegistrationDefinitionInner innerObject,
        com.azure.resourcemanager.managedservices.ManagedServicesManager serviceManager) {
        this.innerObject = innerObject;
        this.serviceManager = serviceManager;
        this.registrationDefinitionId = ResourceManagerUtils.getValueFromIdByParameterName(innerObject.id(),
