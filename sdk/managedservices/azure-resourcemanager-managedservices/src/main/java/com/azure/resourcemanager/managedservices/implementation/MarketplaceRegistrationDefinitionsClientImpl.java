...
public final class MarketplaceRegistrationDefinitionsClientImpl implements MarketplaceRegistrationDefinitionsClient {
    ...
    MarketplaceRegistrationDefinitionsClientImpl(ManagedServicesClientImpl client) {
        this.service = RestProxy.create(MarketplaceRegistrationDefinitionsService.class, client.getHttpPipeline(),
    ...
    public interface MarketplaceRegistrationDefinitionsService {
    ...
    private Mono<PagedResponse<MarketplaceRegistrationDefinitionInner>> listSinglePageAsync(String scope,
        String filter) {
        ...
        return FluxUtil
            .withContext(context -> service.list(this.client.getEndpoint(), scope, filter, this.client.getApiVersion(),
                accept, context))
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<MarketplaceRegistrationDefinitionInner>> listSinglePageAsync(String scope, String filter,
        Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<MarketplaceRegistrationDefinitionInner>> getWithResponseAsync(String scope,
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.get(this.client.getEndpoint(), scope, marketplaceIdentifier,
    ...
    private Mono<Response<MarketplaceRegistrationDefinitionInner>> getWithResponseAsync(String scope,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.get(this.client.getEndpoint(), scope, marketplaceIdentifier, this.client.getApiVersion(), accept,
            context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<MarketplaceRegistrationDefinitionInner> getWithResponse(String scope, String marketplaceIdentifier,
        Context context) {
