...
public final class RegistrationAssignmentImpl
    ...
    RegistrationAssignmentImpl(String name,
    ...
    RegistrationAssignmentImpl(RegistrationAssignmentInner innerObject,
        com.azure.resourcemanager.managedservices.ManagedServicesManager serviceManager) {
        ...
        this.registrationAssignmentId = ResourceManagerUtils.getValueFromIdByParameterName(innerObject.id(),
