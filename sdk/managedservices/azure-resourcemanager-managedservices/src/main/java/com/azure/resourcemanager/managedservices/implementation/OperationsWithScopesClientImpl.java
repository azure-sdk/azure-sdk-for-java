...
public final class OperationsWithScopesClientImpl implements OperationsWithScopesClient {
    ...
    OperationsWithScopesClientImpl(ManagedServicesClientImpl client) {
        this.service = RestProxy.create(OperationsWithScopesService.class, client.getHttpPipeline(),
    ...
    public interface OperationsWithScopesService {
        @Headers({ "Content-Type: application/json" })
        @Get("/{scope}/providers/Microsoft.ManagedServices/operations")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<OperationListInner>> list(@HostParam("$host") String endpoint,
     ...
     * @return a list of the operations with the scope along with {@link Response} on successful completion of
     * {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<OperationListInner>> listWithResponseAsync(String scope) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<OperationListInner>> listWithResponseAsync(String scope, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<OperationListInner> listAsync(String scope) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<OperationListInner> listWithResponse(String scope, Context context) {
