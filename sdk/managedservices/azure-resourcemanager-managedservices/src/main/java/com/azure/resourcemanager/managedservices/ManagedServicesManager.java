...
/**
 * Entry point to ManagedServicesManager.
...
public final class ManagedServicesManager {
    ...
    private ManagedServicesManager(HttpPipeline httpPipeline, AzureProfile profile, Duration defaultPollInterval) {
        ...
        this.clientObject = new ManagedServicesClientBuilder().pipeline(httpPipeline)
    ...
    public static final class Configurable {
        ...
        private static final Map<String, String> PROPERTIES
            = CoreUtils.getProperties("azure-resourcemanager-managedservices.properties");
    ...
    public MarketplaceRegistrationDefinitions marketplaceRegistrationDefinitions() {
        if (this.marketplaceRegistrationDefinitions == null) {
            this.marketplaceRegistrationDefinitions = new MarketplaceRegistrationDefinitionsImpl(
                clientObject.getMarketplaceRegistrationDefinitions(), this);
        }
    ...
    /**
     * Gets wrapped service client ManagedServicesClient providing direct access to the underlying auto-generated API
     * implementation, based on Azure REST API.
     * 
     * @return Wrapped service client ManagedServicesClient.
     */
