...
public final class IndexesAsyncClient {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<Index> listVersions(String name, Integer top, String skip, String tags,
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<Index> list(Integer top, String skip, String tags, ListViewType listViewType) {
