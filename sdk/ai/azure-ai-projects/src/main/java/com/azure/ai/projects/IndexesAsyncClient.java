...
public final class IndexesAsyncClient {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<Index> listVersions(String name, String continuationToken) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<Index> listLatest(String continuationToken) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Index> createOrUpdateVersion(String name, String version, Index body) {
