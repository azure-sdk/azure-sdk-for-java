...
public final class DatasetsImpl {
    ...
    public interface DatasetsService {
        ...
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        @UnexpectedResponseExceptionType(HttpResponseException.class)
        Mono<Response<BinaryData>> startPendingUploadVersion(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("name") String name,
            @PathParam("version") String version, @HeaderParam("Content-Type") String contentType,
            @HeaderParam("Accept") String accept, @BodyParam("application/json") BinaryData body,
            RequestOptions requestOptions, Context context);
        ...
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        @UnexpectedResponseExceptionType(HttpResponseException.class)
        Response<BinaryData> startPendingUploadVersionSync(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("name") String name,
            @PathParam("version") String version, @HeaderParam("Content-Type") String contentType,
            @HeaderParam("Accept") String accept, @BodyParam("application/json") BinaryData body,
            RequestOptions requestOptions, Context context);
    ...
    public Mono<Response<BinaryData>> createOrUpdateVersionWithResponseAsync(String name, String version,
        ...
        return FluxUtil.withContext(context -> service.createOrUpdateVersion(this.client.getEndpoint(),
            this.client.getServiceVersion().getVersion(), name, version, contentType, accept, body, requestOptions,
            context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> startPendingUploadVersionWithResponseAsync(String name, String version,
        BinaryData body, RequestOptions requestOptions) {
        final String contentType = "application/json";
        final String accept = "application/json";
        return FluxUtil.withContext(context -> service.startPendingUploadVersion(this.client.getEndpoint(),
            this.client.getServiceVersion().getVersion(), name, version, contentType, accept, body, requestOptions,
            context));
    }
    ...
    public Response<BinaryData> startPendingUploadVersionWithResponse(String name, String version, BinaryData body,
        ...
        final String contentType = "application/json";
        final String accept = "application/json";
        return service.startPendingUploadVersionSync(this.client.getEndpoint(),
            this.client.getServiceVersion().getVersion(), name, version, contentType, accept, body, requestOptions,
            Context.NONE);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> getCredentialsWithResponseAsync(String name, String version, BinaryData body,
        RequestOptions requestOptions) {
        final String contentType = "application/json";
        final String accept = "application/json";
        return FluxUtil.withContext(
            context -> service.getCredentials(this.client.getEndpoint(), this.client.getServiceVersion().getVersion(),
