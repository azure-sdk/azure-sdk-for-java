...
public final class DatasetsAsyncClient {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<DatasetVersion> listVersions(String name, Integer top, String skip, String tags,
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<DatasetVersion> list(Integer top, String skip, String tags, ListViewType listViewType) {
