            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("name".equals(fieldName)) {
                    JsonMergePatchHelper.getDatasetVersionAccessor()
                        .setName(deserializedFolderDatasetVersion, reader.getString());
                    ...
                    JsonMergePatchHelper.getDatasetVersionAccessor()
                        .setId(deserializedFolderDatasetVersion, reader.getString());
                } else if ("description".equals(fieldName)) {
                    JsonMergePatchHelper.getDatasetVersionAccessor()
                        .setDescription(deserializedFolderDatasetVersion, reader.getString());
