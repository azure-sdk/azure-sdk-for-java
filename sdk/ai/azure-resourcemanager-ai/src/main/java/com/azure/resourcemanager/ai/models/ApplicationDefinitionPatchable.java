...
import com.azure.resourcemanager.ai.fluent.models.ApplicationDefinitionProperties;
import com.fasterxml.jackson.annotation.JsonProperty;
import java.util.List;

/** Information about managed application definition. */
@Fluent
public final class ApplicationDefinitionPatchable extends GenericResource {
    /*
    ...
    /** {@inheritDoc} */
    @Override
    public ApplicationDefinitionPatchable withManagedBy(String managedBy) {
    ...
    /** {@inheritDoc} */
    @Override
    public ApplicationDefinitionPatchable withSku(Sku sku) {
        super.withSku(sku);
        return this;
    }
     ...
     * @return the ApplicationDefinitionPatchable object itself.
     */
    public ApplicationDefinitionPatchable withLockLevel(ApplicationLockLevel lockLevel) {
     ...
     * @return the ApplicationDefinitionPatchable object itself.
     */
    public ApplicationDefinitionPatchable withDisplayName(String displayName) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ApplicationDefinitionProperties();
        }
     ...
     * @return the ApplicationDefinitionPatchable object itself.
     */
    public ApplicationDefinitionPatchable withIsEnabled(IsEnabled isEnabled) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ApplicationDefinitionProperties();
        }
     ...
     * @return the ApplicationDefinitionPatchable object itself.
     */
    public ApplicationDefinitionPatchable withAuthorizations(List<ApplicationAuthorization> authorizations) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ApplicationDefinitionProperties();
        }
     ...
     * @return the ApplicationDefinitionPatchable object itself.
     */
    public ApplicationDefinitionPatchable withArtifacts(List<ApplicationDefinitionArtifact> artifacts) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ApplicationDefinitionProperties();
        }
     ...
     * @return the ApplicationDefinitionPatchable object itself.
     */
    public ApplicationDefinitionPatchable withDescription(String description) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ApplicationDefinitionProperties();
        }
     ...
     * @return the ApplicationDefinitionPatchable object itself.
     */
    public ApplicationDefinitionPatchable withPackageFileUri(String packageFileUri) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ApplicationDefinitionProperties();
        }
     ...
     * @return the ApplicationDefinitionPatchable object itself.
     */
    public ApplicationDefinitionPatchable withMainTemplate(Object mainTemplate) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ApplicationDefinitionProperties();
        }
     ...
     * @return the ApplicationDefinitionPatchable object itself.
     */
    public ApplicationDefinitionPatchable withCreateUiDefinition(Object createUiDefinition) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ApplicationDefinitionProperties();
        }
     ...
     * @return the ApplicationDefinitionPatchable object itself.
     */
    public ApplicationDefinitionPatchable withNotificationPolicy(ApplicationNotificationPolicy notificationPolicy) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ApplicationDefinitionProperties();
        }
     ...
     * @return the ApplicationDefinitionPatchable object itself.
     */
    public ApplicationDefinitionPatchable withLockingPolicy(ApplicationPackageLockingPolicyDefinition lockingPolicy) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ApplicationDefinitionProperties();
        }
     ...
     * @return the ApplicationDefinitionPatchable object itself.
     */
    public ApplicationDefinitionPatchable withDeploymentPolicy(ApplicationDeploymentPolicy deploymentPolicy) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ApplicationDefinitionProperties();
        }
     ...
     * @return the ApplicationDefinitionPatchable object itself.
     */
    public ApplicationDefinitionPatchable withManagementPolicy(ApplicationManagementPolicy managementPolicy) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ApplicationDefinitionProperties();
        }
     ...
     * @return the ApplicationDefinitionPatchable object itself.
     */
    public ApplicationDefinitionPatchable withPolicies(List<ApplicationPolicy> policies) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ApplicationDefinitionProperties();
        }
