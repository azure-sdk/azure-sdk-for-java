...
import com.azure.resourcemanager.ai.fluent.OperationsClient;
...
/** Initializes a new instance of the AiImpl type. */
@ServiceClient(builder = AiBuilder.class)
public final class AiImpl implements Ai {
    ...
    /** The ApplicationsDefinitionsClient object to access its operations. */
    private final ApplicationsDefinitionsClient applicationsDefinitions;

    /**
     * Gets the ApplicationsDefinitionsClient object to access its operations.
     *
     * @return the ApplicationsDefinitionsClient object.
     */
    public ApplicationsDefinitionsClient getApplicationsDefinitions() {
        return this.applicationsDefinitions;
    }
    ...
    /**
     * Initializes an instance of Ai client.
     *
    ...
    AiImpl(
        ...
        this.applicationsDefinitions = new ApplicationsDefinitionsClientImpl(this);
    ...
    private static final ClientLogger LOGGER = new ClientLogger(AiImpl.class);
}
