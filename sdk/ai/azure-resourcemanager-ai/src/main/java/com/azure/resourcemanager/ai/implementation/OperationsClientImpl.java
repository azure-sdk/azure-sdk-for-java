...
import com.azure.resourcemanager.ai.fluent.models.OperationInner;
import com.azure.resourcemanager.ai.models.OperationListResult;
...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    OperationsClientImpl(AiImpl client) {
        this.service =
    ...
    /**
     * The interface defining all the services for AiOperations to be used by the proxy service to perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "AiOperations")
    private interface OperationsService {
        @Headers({"Content-Type: application/json"})
        @Get("/providers/Microsoft.Ai/operations")
    ...
    /**
     * Lists all of the available Microsoft.Ai REST API operations.
     *
