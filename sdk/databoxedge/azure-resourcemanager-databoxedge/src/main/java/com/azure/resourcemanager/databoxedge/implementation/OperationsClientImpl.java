...
public final class OperationsClientImpl implements OperationsClient {
    ...
    /**
     * The interface defining all the services for DataBoxEdgeManagementClientOperations to be used by the proxy
     ...
     * @return the list of operations used for the discovery of available provider operations along with
