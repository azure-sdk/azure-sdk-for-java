...
public final class RolesClientImpl implements RolesClient {
    ...
    public interface RolesService {
        ...
        Mono<Response<RoleList>> listByDataBoxEdgeDevice(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<RoleInner>> get(@HostParam("$host") String endpoint, @PathParam("deviceName") String deviceName,
        ...
        Mono<Response<Flux<ByteBuffer>>> createOrUpdate(@HostParam("$host") String endpoint,
            ...
            @PathParam("resourceGroupName") String resourceGroupName, @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") RoleInner role, @HeaderParam("Accept") String accept, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<RoleInner> getWithResponse(String deviceName, String name, String resourceGroupName,
        Context context) {
    ...
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String deviceName, String name,
        ...
        return FluxUtil
            .withContext(context -> service.createOrUpdate(this.client.getEndpoint(), deviceName, name,
                this.client.getSubscriptionId(), resourceGroupName, this.client.getApiVersion(), role, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String deviceName, String name,
        ...
        return service.createOrUpdate(this.client.getEndpoint(), deviceName, name, this.client.getSubscriptionId(),
            resourceGroupName, this.client.getApiVersion(), role, accept, context);
    }
    ...
    private PollerFlux<PollResult<RoleInner>, RoleInner> beginCreateOrUpdateAsync(String deviceName, String name,
        String resourceGroupName, RoleInner role) {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<RoleInner>, RoleInner> beginCreateOrUpdate(String deviceName, String name,
        String resourceGroupName, RoleInner role) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<RoleInner> createOrUpdateAsync(String deviceName, String name, String resourceGroupName,
        RoleInner role) {
        return beginCreateOrUpdateAsync(deviceName, name, resourceGroupName, role).last()
    ...
    private Mono<RoleInner> createOrUpdateAsync(String deviceName, String name, String resourceGroupName,
        ...
        return beginCreateOrUpdateAsync(deviceName, name, resourceGroupName, role, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
