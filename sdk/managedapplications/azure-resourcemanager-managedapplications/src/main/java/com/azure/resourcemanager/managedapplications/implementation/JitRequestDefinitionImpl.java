...
public final class JitRequestDefinitionImpl
    ...
    public JitRequestDefinition create() {
        this.innerObject = serviceManager.serviceClient().getJitRequests().createOrUpdate(resourceGroupName,
            jitRequestName, this.innerModel(), Context.NONE);
        return this;
    }

    public JitRequestDefinition create(Context context) {
        this.innerObject = serviceManager.serviceClient().getJitRequests().createOrUpdate(resourceGroupName,
            jitRequestName, this.innerModel(), context);
        return this;
    }
    ...
    public JitRequestDefinition apply() {
        this.innerObject = serviceManager.serviceClient().getJitRequests()
            .updateWithResponse(resourceGroupName, jitRequestName, updateParameters, Context.NONE).getValue();
        return this;
    }

    public JitRequestDefinition apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getJitRequests()
            .updateWithResponse(resourceGroupName, jitRequestName, updateParameters, context).getValue();
        return this;
    }
    ...
    public JitRequestDefinition refresh() {
        this.innerObject = serviceManager.serviceClient().getJitRequests()
            .getByResourceGroupWithResponse(resourceGroupName, jitRequestName, Context.NONE).getValue();
        return this;
    }

    public JitRequestDefinition refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getJitRequests()
            .getByResourceGroupWithResponse(resourceGroupName, jitRequestName, context).getValue();
        return this;
    }
