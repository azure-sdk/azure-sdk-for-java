...
public final class ApplicationDefinitionImpl
    ...
    public ApplicationDefinition create() {
        this.innerObject = serviceManager.serviceClient().getApplicationDefinitions()
    ...
    public ApplicationDefinition apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getApplicationDefinitions()
            .updateWithResponse(resourceGroupName, applicationDefinitionName, updateParameters, context).getValue();
        return this;
    }
    ...
    public ApplicationDefinition refresh() {
        this.innerObject = serviceManager.serviceClient().getApplicationDefinitions()
            .getByResourceGroupWithResponse(resourceGroupName, applicationDefinitionName, Context.NONE).getValue();
        return this;
    }

    public ApplicationDefinition refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getApplicationDefinitions()
            .getByResourceGroupWithResponse(resourceGroupName, applicationDefinitionName, context).getValue();
        return this;
    }
