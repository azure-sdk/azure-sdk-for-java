...
public final class ApplicationImpl implements Application, Application.Definition, Application.Update {
    ...
    public Application refresh() {
        this.innerObject = serviceManager.serviceClient().getApplications()
            .getByResourceGroupWithResponse(resourceGroupName, applicationName, Context.NONE).getValue();
        return this;
    }

    public Application refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getApplications()
            .getByResourceGroupWithResponse(resourceGroupName, applicationName, context).getValue();
        return this;
    }
    ...
    public Response<AllowedUpgradePlansResult> listAllowedUpgradePlansWithResponse(Context context) {
        return serviceManager.applications().listAllowedUpgradePlansWithResponse(resourceGroupName, applicationName,
            context);
    }
    ...
    public Response<ManagedIdentityTokenResult> listTokensWithResponse(ListTokenRequest parameters, Context context) {
        return serviceManager.applications().listTokensWithResponse(resourceGroupName, applicationName, parameters,
            context);
    }
