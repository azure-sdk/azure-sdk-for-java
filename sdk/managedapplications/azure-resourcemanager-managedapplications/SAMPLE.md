...
public final class ApplicationDefinitionsUpdateByIdSamples {
    ...
    public static void
        updateManagedApplicationDefinition(com.azure.resourcemanager.managedapplications.ApplicationManager manager) {
        manager.applicationDefinitions()
            .updateByIdWithResponse("rg", "myManagedApplicationDef",
...
public final class ApplicationsListTokensSamples {
    ...
    public static void
        ...
        manager.applications()
            .listTokensWithResponse("rg", "myManagedApplication",
                new ListTokenRequest().withAuthorizationAudience("fakeTokenPlaceholder")
...
public final class ApplicationsUpdateSamples {
    ...
    public static void
        ...
        manager.applications()
            .update("rg", "myManagedApplication", new ApplicationPatchableInner().withKind("ServiceCatalog")
                .withManagedResourceGroupId("/subscriptions/subid/resourceGroups/myManagedRG")
                .withApplicationDefinitionId(
                    "/subscriptions/subid/resourceGroups/rg/providers/Microsoft.Solutions/applicationDefinitions/myAppDef"),
                com.azure.core.util.Context.NONE);
...
public final class ApplicationsUpdateAccessSamples {
    ...
    public static void
        ...
        manager.applications()
            .updateAccess("rg", "myManagedApplication",
                new UpdateAccessDefinitionInner().withApprover("amauser")
                    .withMetadata(new JitRequestMetadata().withOriginRequestId("originRequestId")
...
public final class JitRequestsCreateOrUpdateSamples {
    ...
    public static void
        ...
        manager.jitRequests()
            ...
            .withJitSchedulingPolicy(new JitSchedulingPolicy().withType(JitSchedulingType.ONCE)
