...
public interface SapVirtualInstance {
    ...
    interface Update
        extends UpdateStages.WithTags, UpdateStages.WithIdentity, UpdateStages.WithManagedResourcesNetworkAccessType {
        /**
    ...
    interface UpdateStages {
        ...
        /** The stage of the SapVirtualInstance update allowing to specify managedResourcesNetworkAccessType. */
        interface WithManagedResourcesNetworkAccessType {
            /**
             * Specifies the managedResourcesNetworkAccessType property: Specifies the network access configuration for
             * the resources that will be deployed in the Managed Resource Group. The options to choose from are Public
             ...
             * @return the next definition stage.
             */
            Update withManagedResourcesNetworkAccessType(
                ManagedResourcesNetworkAccessType managedResourcesNetworkAccessType);
        }
    }
