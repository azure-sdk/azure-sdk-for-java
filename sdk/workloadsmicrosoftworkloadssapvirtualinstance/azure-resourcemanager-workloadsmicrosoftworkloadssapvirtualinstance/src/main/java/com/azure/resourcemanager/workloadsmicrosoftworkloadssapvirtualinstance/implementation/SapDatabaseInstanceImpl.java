...
public final class SapDatabaseInstanceImpl
    ...
    private final com.azure.resourcemanager.workloadsmicrosoftworkloadssapvirtualinstance.WorkloadsSapVirtualInstanceManager serviceManager;
    ...
    private com.azure.resourcemanager.workloadsmicrosoftworkloadssapvirtualinstance.WorkloadsSapVirtualInstanceManager
        manager() {
    ...
    public SapDatabaseInstance create() {
        this.innerObject = serviceManager.serviceClient().getSapDatabaseInstances().create(resourceGroupName,
            sapVirtualInstanceName, databaseInstanceName, this.innerModel(), Context.NONE);
        return this;
    }

    public SapDatabaseInstance create(Context context) {
        this.innerObject = serviceManager.serviceClient().getSapDatabaseInstances().create(resourceGroupName,
            sapVirtualInstanceName, databaseInstanceName, this.innerModel(), context);
        return this;
    }

    SapDatabaseInstanceImpl(String name,
        com.azure.resourcemanager.workloadsmicrosoftworkloadssapvirtualinstance.WorkloadsSapVirtualInstanceManager serviceManager) {
    ...
    public SapDatabaseInstance apply() {
        this.innerObject
            = serviceManager.serviceClient().getSapDatabaseInstances().updateWithResponse(resourceGroupName,
                sapVirtualInstanceName, databaseInstanceName, updateBody, Context.NONE).getValue();
        return this;
    }

    public SapDatabaseInstance apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getSapDatabaseInstances()
            .updateWithResponse(resourceGroupName, sapVirtualInstanceName, databaseInstanceName, updateBody, context)
            .getValue();
        return this;
    }
    ...
    public SapDatabaseInstance refresh() {
        this.innerObject = serviceManager.serviceClient().getSapDatabaseInstances()
            .getWithResponse(resourceGroupName, sapVirtualInstanceName, databaseInstanceName, Context.NONE).getValue();
        return this;
    }

    public SapDatabaseInstance refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getSapDatabaseInstances()
            .getWithResponse(resourceGroupName, sapVirtualInstanceName, databaseInstanceName, context).getValue();
        return this;
    }

    public OperationStatusResult startInstance() {
        return serviceManager.sapDatabaseInstances().startInstance(resourceGroupName, sapVirtualInstanceName,
    ...
    public OperationStatusResult stopInstance() {
        return serviceManager.sapDatabaseInstances().stopInstance(resourceGroupName, sapVirtualInstanceName,
            databaseInstanceName);
    }
