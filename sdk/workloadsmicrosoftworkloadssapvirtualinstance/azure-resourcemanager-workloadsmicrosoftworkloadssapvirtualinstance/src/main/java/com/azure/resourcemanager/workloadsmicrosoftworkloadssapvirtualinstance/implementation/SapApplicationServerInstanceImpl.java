...
public final class SapApplicationServerInstanceImpl implements SapApplicationServerInstance,
    ...
    public SapApplicationServerInstance create() {
        this.innerObject = serviceManager.serviceClient().getSapApplicationServerInstances().create(resourceGroupName,
            sapVirtualInstanceName, applicationInstanceName, this.innerModel(), Context.NONE);
        return this;
    }

    public SapApplicationServerInstance create(Context context) {
        this.innerObject = serviceManager.serviceClient().getSapApplicationServerInstances().create(resourceGroupName,
            sapVirtualInstanceName, applicationInstanceName, this.innerModel(), context);
        return this;
    }
    ...
    public SapApplicationServerInstance apply() {
        this.innerObject
            = serviceManager.serviceClient().getSapApplicationServerInstances().updateWithResponse(resourceGroupName,
                sapVirtualInstanceName, applicationInstanceName, updateBody, Context.NONE).getValue();
        return this;
    }

    public SapApplicationServerInstance apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getSapApplicationServerInstances()
            .updateWithResponse(resourceGroupName, sapVirtualInstanceName, applicationInstanceName, updateBody, context)
            .getValue();
        return this;
    }
    ...
    public SapApplicationServerInstance refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getSapApplicationServerInstances()
            .getWithResponse(resourceGroupName, sapVirtualInstanceName, applicationInstanceName, context).getValue();
        return this;
    }

    public OperationStatusResult startInstance() {
        return serviceManager.sapApplicationServerInstances().startInstance(resourceGroupName, sapVirtualInstanceName,
    ...
    public OperationStatusResult stopInstance() {
        return serviceManager.sapApplicationServerInstances().stopInstance(resourceGroupName, sapVirtualInstanceName,
            applicationInstanceName);
    }
