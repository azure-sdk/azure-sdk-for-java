...
@Fluent
public class AadProfileResponse {
    /*
    ...
    /** Creates an instance of AadProfileResponse class. */
     ...
     * @return the AadProfileResponse object itself.
     */
    public AadProfileResponse withAdminGroupObjectIDs(List<String> adminGroupObjectIDs) {
     ...
     * @return the AadProfileResponse object itself.
     */
    public AadProfileResponse withClientAppId(String clientAppId) {
     ...
     * @return the AadProfileResponse object itself.
     */
    public AadProfileResponse withEnableAzureRbac(Boolean enableAzureRbac) {
     ...
     * @return the AadProfileResponse object itself.
     */
    public AadProfileResponse withManaged(Boolean managed) {
     ...
     * @return the AadProfileResponse object itself.
     */
    public AadProfileResponse withServerAppId(String serverAppId) {
     ...
     * @return the AadProfileResponse object itself.
     */
    public AadProfileResponse withTenantId(String tenantId) {
