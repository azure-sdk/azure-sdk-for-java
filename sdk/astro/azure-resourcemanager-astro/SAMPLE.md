    ...
    public static void
        ...
        resource.update()
            ...
            .withProperties(new OrganizationResourceUpdateProperties()
                .withUser(new LiftrBaseUserDetailsUpdate().withFirstName("ggdybximgouyreops")
                    .withLastName("jjnvjvtgvgldtaasy")
                    .withEmailAddress(".K_@e7N-g1.xjqnbPs")
                    .withUpn("otbhjplmt")
                    .withPhoneNumber("jzkkmmqmjyfyqgidhqwrokwnba"))
                .withPartnerOrganizationProperties(
                    new LiftrBaseDataPartnerOrganizationPropertiesUpdate().withOrganizationId("lowsj")
                        .withWorkspaceId("pckyzpgztaal")
                        .withOrganizationName("U.1-:7")
                        .withWorkspaceName("9.:06")
                        .withSingleSignOnProperties(
                            new LiftrBaseSingleSignOnProperties().withSingleSignOnState(SingleSignOnStates.INITIAL)
