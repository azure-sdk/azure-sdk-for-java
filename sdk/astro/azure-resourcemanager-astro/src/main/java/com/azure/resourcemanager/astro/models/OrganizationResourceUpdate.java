...
public final class OrganizationResourceUpdate implements JsonSerializable<OrganizationResourceUpdate> {
     ...
     */
    public OrganizationResourceUpdate withIdentity(AzureResourceManagerLegacyManagedServiceIdentityV4Update identity) {
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("identity".equals(fieldName)) {
                    deserializedOrganizationResourceUpdate.identity
