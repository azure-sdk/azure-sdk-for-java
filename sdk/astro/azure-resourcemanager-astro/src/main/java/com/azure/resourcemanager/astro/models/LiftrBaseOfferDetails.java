...
public final class LiftrBaseOfferDetails implements JsonSerializable<LiftrBaseOfferDetails> {
    ...
    /**
     * Get the autoRenew property: Subscription auto renewal flag.
     * 
    ...
    /**
     * Set the autoRenew property: Subscription auto renewal flag.
     * 
     * @param autoRenew the autoRenew value to set.
     * @return the LiftrBaseOfferDetails object itself.
     */
    public LiftrBaseOfferDetails withAutoRenew(Boolean autoRenew) {
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("publisherId".equals(fieldName)) {
                    ...
                    deserializedLiftrBaseOfferDetails.autoRenew = reader.getNullable(JsonReader::getBoolean);
                } else {
                    reader.skipChildren();
                }
            }
