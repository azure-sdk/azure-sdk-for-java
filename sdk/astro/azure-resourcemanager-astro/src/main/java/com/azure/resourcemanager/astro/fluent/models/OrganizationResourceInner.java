...
public final class OrganizationResourceInner extends Resource {
     ...
     */
    private LiftrBaseDataOrganizationProperties properties;
     ...
     */
    public OrganizationResourceInner withProperties(LiftrBaseDataOrganizationProperties properties) {
        ...
        if (location() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property location in model OrganizationResourceInner"));
        }
    }
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("id".equals(fieldName)) {
                    ...
                    deserializedOrganizationResourceInner.properties
                        = LiftrBaseDataOrganizationProperties.fromJson(reader);
