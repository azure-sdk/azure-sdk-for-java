 ...
 */
@Fluent
public final class GetRolesRequest implements JsonSerializable<GetRolesRequest> {
    /*
    ...
    /**
     * Creates an instance of GetRolesRequest class.
     */
     ...
     * @return the GetRolesRequest object itself.
     */
    public GetRolesRequest withSearchParamsDictionary(Map<String, String> searchParamsDictionary) {
     ...
     * @return the GetRolesRequest object itself.
     */
    public GetRolesRequest withPageInfo(PageInfo pageInfo) {
    ...
    /**
     * Reads an instance of GetRolesRequest from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of GetRolesRequest if the JsonReader was pointing to an instance of it, or null if it was
     * pointing to JSON null.
     * @throws IOException If an error occurs while reading the GetRolesRequest.
     */
    public static GetRolesRequest fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            GetRolesRequest deserializedGetRolesRequest = new GetRolesRequest();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("searchParamsDictionary".equals(fieldName)) {
                    ...
                    deserializedGetRolesRequest.searchParamsDictionary = searchParamsDictionary;
                } else if ("pageInfo".equals(fieldName)) {
                    deserializedGetRolesRequest.pageInfo = PageInfo.fromJson(reader);
                } else {
                    reader.skipChildren();
                }
            }

            return deserializedGetRolesRequest;
        });
    }
}
