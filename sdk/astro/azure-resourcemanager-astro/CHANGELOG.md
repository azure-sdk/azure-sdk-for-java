...
* `models.LiftrBaseOfferDetailsUpdate` was added

* `models.LiftrBaseMarketplaceDetailsUpdate` was added

#### `models.OrganizationResourceUpdateProperties` was modified

* `withMarketplace(models.LiftrBaseMarketplaceDetailsUpdate)` was added
