...
public final class ReturnsClientImpl implements ReturnsClient {
    ...
    private interface ReturnsService {
        ...
        @Post("/providers/Microsoft.Capacity/return")
    ...
    private Mono<ReturnsPostResponse> postWithResponseAsync(RefundRequest body) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ReturnsPostResponse> postWithResponseAsync(RefundRequest body, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<RefundResponseInner> postAsync(RefundRequest body) {
        return postWithResponseAsync(body).flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public RefundResponseInner post(RefundRequest body) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ReturnsPostResponse postWithResponse(RefundRequest body, Context context) {
        return postWithResponseAsync(body, context).block();
    }
}
