...
public interface CalculateRefundsClient {
    ...
    CalculateRefundResponseInner post(CalculateRefundRequest body);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<CalculateRefundResponseInner> postWithResponse(CalculateRefundRequest body, Context context);
}
