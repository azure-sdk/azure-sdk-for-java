...
public interface Reservations {
     ...
     */
    ReservationResponse get(String reservationId, String reservationOrderId);
     ...
     *
     * <p>Unarchiving a `Reservation` moves it to the state it was before archiving.
     *
     * @param reservationOrderId Order Id of the reservation.
     * @param reservationId Id of the Reservation Item.
     * @throws IllegalArgumentException thrown if parameters fail the validation.
     ...
     * @return the paginated response with {@link PagedIterable}.
     */
    PagedIterable<ReservationResponse> listRevisions(String reservationId, String reservationOrderId);
     ...
     * @return the paginated response with {@link PagedIterable}.
     */
    PagedIterable<ReservationResponse> listRevisions(String reservationId, String reservationOrderId, Context context);
