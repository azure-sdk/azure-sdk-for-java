...
public final class ReturnsImpl implements Returns {
    ...
    public RefundResponse post(RefundRequest body) {
        RefundResponseInner inner = this.serviceClient().post(body);
        if (inner != null) {
    ...
    public Response<RefundResponse> postWithResponse(RefundRequest body, Context context) {
        ReturnsPostResponse inner = this.serviceClient().postWithResponse(body, context);
        if (inner != null) {
