...
This package contains Microsoft Azure SDK for MobileNetwork Management SDK. Mobile Network Management API. Package tag package-2024-06. For documentation on how to use this package, please see [Azure Management Libraries for Java](https://aka.ms/azsdk/java/mgmt).
