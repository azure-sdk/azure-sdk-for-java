...
public interface AttachedDataNetwork {
    ...
    /**
     * Gets the naptConfiguration property: The network address and port translation (NAPT) configuration.
    ...
    interface DefinitionStages {
        ...
        interface WithUserEquipmentAddressPoolPrefix {
             ...
             * network from which the packet core instance will dynamically assign IP addresses to UEs.
             * The packet core instance assigns an IP address to a UE when the UE sets up a PDU session.
             * You must define at least one of userEquipmentAddressPoolPrefix and userEquipmentStaticAddressPoolPrefix.
             * If you define both, they must be of the same size.
             * @return the next definition stage.
        ...
        interface WithUserEquipmentStaticAddressPoolPrefix {
             ...
             * addresses to UEs.
             * The packet core instance assigns an IP address to a UE when the UE sets up a PDU session. The static IP
             * address for a specific UE is set in StaticIPConfiguration on the corresponding SIM resource.
             * At least one of userEquipmentAddressPoolPrefix and userEquipmentStaticAddressPoolPrefix must be defined.
