...
public interface SimsClient {
    ...
    SyncPoller<PollResult<AsyncOperationStatusInner>, AsyncOperationStatusInner> beginClone(String resourceGroupName,
        String simGroupName, SimClone body);
    ...
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<AsyncOperationStatusInner>, AsyncOperationStatusInner> beginClone(String resourceGroupName,
        String simGroupName, SimClone body, Context context);
    ...
    AsyncOperationStatusInner clone(String resourceGroupName, String simGroupName, SimClone body);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    AsyncOperationStatusInner clone(String resourceGroupName, String simGroupName, SimClone body, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    AsyncOperationStatusInner bulkDelete(String resourceGroupName, String simGroupName, SimDeleteList body);
    ...
    SyncPoller<PollResult<AsyncOperationStatusInner>, AsyncOperationStatusInner> beginMove(String resourceGroupName,
        String simGroupName, SimMove body);
    ...
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<AsyncOperationStatusInner>, AsyncOperationStatusInner> beginMove(String resourceGroupName,
        String simGroupName, SimMove body, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    AsyncOperationStatusInner move(String resourceGroupName, String simGroupName, SimMove body);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    AsyncOperationStatusInner move(String resourceGroupName, String simGroupName, SimMove body, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    SimInner createOrUpdate(String resourceGroupName, String simGroupName, String simName, SimInner resource);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    AsyncOperationStatusInner bulkUpload(String resourceGroupName, String simGroupName, SimUploadList body);
