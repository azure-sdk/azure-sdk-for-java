...
public final class RoutingInfoModelInner extends ProxyResource {
    ...
    /**
     * Get the controlPlaneAccessRoutes property: A list of IPv4 control plane access routes.
     * 
    ...
    /**
     * Set the controlPlaneAccessRoutes property: A list of IPv4 control plane access routes.
     * 
    ...
    /**
     * Get the userPlaneAccessRoutes property: A list of IPv4 user plane access routes.
     * 
    ...
    /**
     * Set the userPlaneAccessRoutes property: A list of IPv4 user plane access routes.
     * 
