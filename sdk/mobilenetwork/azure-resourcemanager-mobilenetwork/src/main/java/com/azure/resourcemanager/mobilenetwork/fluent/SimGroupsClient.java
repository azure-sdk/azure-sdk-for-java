...
public interface SimGroupsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    SimGroupInner createOrUpdate(String resourceGroupName, String simGroupName, SimGroupInner resource);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    SimGroupInner updateTags(String resourceGroupName, String simGroupName, IdentityAndTagsObject properties);
