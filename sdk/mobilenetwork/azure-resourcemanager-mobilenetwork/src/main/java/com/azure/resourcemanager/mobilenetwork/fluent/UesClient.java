...
public interface UesClient {
    ...
    PagedIterable<UeInfoInner> listByPacketCoreControlPlane(String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<UeInfoInner> listByPacketCoreControlPlane(String resourceGroupName, String packetCoreControlPlaneName,
        Context context);
}
