...
public final class AttachedDataNetworkListResult {
    ...
    /**
     * Get the value property: The AttachedDataNetwork items on this page.
     * 
    ...
    /**
     * Set the value property: The AttachedDataNetwork items on this page.
     * 
     ...
     * @return the AttachedDataNetworkListResult object itself.
     */
    public AttachedDataNetworkListResult withNextLink(String nextLink) {
        ...
        if (value() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property value in model AttachedDataNetworkListResult"));
        } else {
            value().forEach(e -> e.validate());
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(AttachedDataNetworkListResult.class);
}
