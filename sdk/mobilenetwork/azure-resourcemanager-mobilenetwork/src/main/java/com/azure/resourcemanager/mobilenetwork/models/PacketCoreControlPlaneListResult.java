...
public final class PacketCoreControlPlaneListResult {
    ...
    /**
     * Get the value property: The PacketCoreControlPlane items on this page.
     * 
    ...
    /**
     * Set the value property: The PacketCoreControlPlane items on this page.
     * 
     ...
     * @return the PacketCoreControlPlaneListResult object itself.
     */
    public PacketCoreControlPlaneListResult withNextLink(String nextLink) {
        ...
        if (value() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property value in model PacketCoreControlPlaneListResult"));
        } else {
            value().forEach(e -> e.validate());
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(PacketCoreControlPlaneListResult.class);
}
