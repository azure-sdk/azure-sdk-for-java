...
public final class UeInfo4GProperties {
     ...
     */
    public PlmnId plmn() {
        return this.innerGuti() == null ? null : this.innerGuti().plmn();
    }
     ...
     * @return the UeInfo4GProperties object itself.
     */
    public UeInfo4GProperties withPlmn(PlmnId plmn) {
        if (this.innerGuti() == null) {
            this.innerGuti = new Guti4G();
        }
        this.innerGuti().withPlmn(plmn);
        return this;
    }
     ...
     * @return the UeInfo4GProperties object itself.
     */
    public UeInfo4GProperties withPlmnConnectionInfoPlmn(PlmnId plmn) {
        if (this.innerConnectionInfo() == null) {
            this.innerConnectionInfo = new UeConnectionInfo4G();
        }
