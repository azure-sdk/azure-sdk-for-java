...
public final class ServiceListResult {
     ...
     * @return the ServiceListResult object itself.
     */
    public ServiceListResult withNextLink(String nextLink) {
    ...
    public void validate() {
        if (value() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Missing required property value in model ServiceListResult"));
        } else {
            value().forEach(e -> e.validate());
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(ServiceListResult.class);
}
