...
/**
 * An instance of this class provides access to all the operations defined in ExtendedUeInfosClient.
 */
public final class ExtendedUeInfosClientImpl implements ExtendedUeInfosClient {
    /**
     * The proxy service used to perform REST calls.
     */
    private final ExtendedUeInfosService service;
    ...
    /**
     * Initializes an instance of ExtendedUeInfosClientImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    ExtendedUeInfosClientImpl(MobileNetworkManagementClientImpl client) {
        this.service
            = RestProxy.create(ExtendedUeInfosService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for MobileNetworkManagementClientExtendedUeInfos to be used by the proxy
     * service to perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "MobileNetworkManagem")
    public interface ExtendedUeInfosService {
    ...
    private Mono<Response<ExtendedUeInfoInner>> getWithResponseAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(context -> service.get(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, packetCoreControlPlaneName, ueId, accept, context))
    ...
    private Mono<Response<ExtendedUeInfoInner>> getWithResponseAsync(String resourceGroupName,
        ...
        return service.get(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, packetCoreControlPlaneName, ueId, accept, context);
    }
