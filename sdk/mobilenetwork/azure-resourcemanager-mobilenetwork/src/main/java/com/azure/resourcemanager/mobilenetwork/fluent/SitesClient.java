...
public interface SitesClient {
    ...
    PagedIterable<SiteInner> listByMobileNetwork(String resourceGroupName, String mobileNetworkName);
    ...
    Response<SiteInner> getWithResponse(String resourceGroupName, String mobileNetworkName, String siteName,
        Context context);
    ...
    SyncPoller<PollResult<SiteInner>, SiteInner> beginCreateOrUpdate(String resourceGroupName, String mobileNetworkName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    SiteInner createOrUpdate(String resourceGroupName, String mobileNetworkName, String siteName, SiteInner resource);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<SiteInner> updateTagsWithResponse(String resourceGroupName, String mobileNetworkName, String siteName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    SiteInner updateTags(String resourceGroupName, String mobileNetworkName, String siteName, TagsObject properties);
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<AsyncOperationStatusInner>, AsyncOperationStatusInner> beginDeletePacketCore(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    AsyncOperationStatusInner deletePacketCore(String resourceGroupName, String mobileNetworkName, String siteName,
