 ...
 */
public interface PacketCoreControlPlaneVersionsTenantResourcesClient {
    /**
    ...
    PagedIterable<PacketCoreControlPlaneVersionInner> listByTenant();
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<PacketCoreControlPlaneVersionInner> listByTenant(Context context);
