...
import com.azure.resourcemanager.standbypool.models.OperationListResult;
...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    OperationsClientImpl(MicrosoftStandbyPoolImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for MicrosoftStandbyPoolOperations to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{$host}")
