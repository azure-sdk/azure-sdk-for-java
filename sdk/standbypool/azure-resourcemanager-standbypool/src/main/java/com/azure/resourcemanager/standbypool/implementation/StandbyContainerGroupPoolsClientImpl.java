...
public final class StandbyContainerGroupPoolsClientImpl implements StandbyContainerGroupPoolsClient {
     ...
     */
    private final MicrosoftStandbyPoolImpl client;
     ...
     */
    StandbyContainerGroupPoolsClientImpl(MicrosoftStandbyPoolImpl client) {
    ...
    /**
     * The interface defining all the services for MicrosoftStandbyPoolStandbyContainerGroupPools to be used by the
     * proxy service to perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "MicrosoftStandbyPool")
    public interface StandbyContainerGroupPoolsService {
        ...
        Mono<Response<StandbyContainerGroupPoolResourceListResult>> list(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<StandbyContainerGroupPoolResourceInner>> getByResourceGroup(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
        ...
        Mono<Response<Flux<ByteBuffer>>> createOrUpdate(@HostParam("$host") String endpoint,
            ...
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("standbyContainerGroupPoolName") String standbyContainerGroupPoolName,
            @BodyParam("application/json") StandbyContainerGroupPoolResourceInner resource,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<StandbyContainerGroupPoolResourceInner>> update(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("standbyContainerGroupPoolName") String standbyContainerGroupPoolName,
            @BodyParam("application/json") StandbyContainerGroupPoolResourceUpdate properties,
            @HeaderParam("Accept") String accept, Context context);
    ...
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(context -> service.createOrUpdate(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, standbyContainerGroupPoolName, resource, accept,
                context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<StandbyContainerGroupPoolResourceInner>> updateWithResponseAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(context -> service.update(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, standbyContainerGroupPoolName, properties, accept,
                context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<StandbyContainerGroupPoolResourceInner>> updateWithResponseAsync(String resourceGroupName,
        ...
        return service.update(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, standbyContainerGroupPoolName, properties, accept, context);
    }
