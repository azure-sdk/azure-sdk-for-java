...
public final class StandbyVirtualMachinePoolResourceImpl implements StandbyVirtualMachinePoolResource,
    ...
    public StandbyVirtualMachinePoolElasticityProfile elasticityProfile() {
        return this.innerModel().elasticityProfile();
    }

    public VirtualMachineState virtualMachineState() {
        return this.innerModel().virtualMachineState();
    }

    public String attachedVirtualMachineScaleSetId() {
        return this.innerModel().attachedVirtualMachineScaleSetId();
    }
    ...
    public StandbyVirtualMachinePoolResource create() {
        this.innerObject = serviceManager.serviceClient().getStandbyVirtualMachinePools()
    ...
    public StandbyVirtualMachinePoolResource apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getStandbyVirtualMachinePools()
            .updateWithResponse(resourceGroupName, standbyVirtualMachinePoolName, updateProperties, context).getValue();
        return this;
    }
    ...
    public StandbyVirtualMachinePoolResource refresh() {
        this.innerObject = serviceManager.serviceClient().getStandbyVirtualMachinePools()
            .getByResourceGroupWithResponse(resourceGroupName, standbyVirtualMachinePoolName, Context.NONE).getValue();
        return this;
    }

    public StandbyVirtualMachinePoolResource refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getStandbyVirtualMachinePools()
            .getByResourceGroupWithResponse(resourceGroupName, standbyVirtualMachinePoolName, context).getValue();
        return this;
    }
    ...
    public StandbyVirtualMachinePoolResourceImpl
        ...
        this.innerModel().withElasticityProfile(elasticityProfile);
        return this;
    }

    public StandbyVirtualMachinePoolResourceImpl withVirtualMachineState(VirtualMachineState virtualMachineState) {
        if (isInCreateMode()) {
            this.innerModel().withVirtualMachineState(virtualMachineState);
            return this;
        } else {
            this.updateProperties.withVirtualMachineState(virtualMachineState);
            return this;
        }
    }
    ...
    public StandbyVirtualMachinePoolResourceImpl
        ...
        if (isInCreateMode()) {
            this.innerModel().withAttachedVirtualMachineScaleSetId(attachedVirtualMachineScaleSetId);
            return this;
        } else {
            this.updateProperties.withAttachedVirtualMachineScaleSetId(attachedVirtualMachineScaleSetId);
            return this;
        }
    }
    ...
    public StandbyVirtualMachinePoolResourceImpl
        ...
        this.updateProperties.withElasticityProfile(elasticityProfile);
        return this;
    }
