...
public final class StandbyVirtualMachinesClientImpl implements StandbyVirtualMachinesClient {
     ...
     */
    StandbyVirtualMachinesClientImpl(MicrosoftStandbyPoolImpl client) {
    ...
    /**
     * The interface defining all the services for MicrosoftStandbyPoolStandbyVirtualMachines to be used by the proxy
