...
public final class StandbyContainerGroupPoolResourceImpl implements StandbyContainerGroupPoolResource,
    ...
    public ContainerGroupProperties containerGroupProperties() {
        return this.innerModel().containerGroupProperties();
    }
    ...
    public StandbyContainerGroupPoolResource create() {
        this.innerObject = serviceManager.serviceClient().getStandbyContainerGroupPools()
    ...
    public StandbyContainerGroupPoolResource apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getStandbyContainerGroupPools()
            .updateWithResponse(resourceGroupName, standbyContainerGroupPoolName, updateProperties, context).getValue();
        return this;
    }
    ...
    public StandbyContainerGroupPoolResource refresh() {
        this.innerObject = serviceManager.serviceClient().getStandbyContainerGroupPools()
            .getByResourceGroupWithResponse(resourceGroupName, standbyContainerGroupPoolName, Context.NONE).getValue();
        return this;
    }

    public StandbyContainerGroupPoolResource refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getStandbyContainerGroupPools()
            .getByResourceGroupWithResponse(resourceGroupName, standbyContainerGroupPoolName, context).getValue();
        return this;
    }
    ...
    public StandbyContainerGroupPoolResourceImpl
        ...
        this.innerModel().withContainerGroupProperties(containerGroupProperties);
        return this;
    }
    ...
    public StandbyContainerGroupPoolResourceImpl
        ...
        this.updateProperties.withContainerGroupProperties(containerGroupProperties);
        return this;
    }
