...
import com.azure.resourcemanager.standbypool.fluent.MicrosoftStandbyPool;
...
/**
 * Initializes a new instance of the MicrosoftStandbyPoolImpl type.
 */
@ServiceClient(builder = MicrosoftStandbyPoolBuilder.class)
public final class MicrosoftStandbyPoolImpl implements MicrosoftStandbyPool {
    /**
    ...
    /**
     * The StandbyVirtualMachinePoolsClient object to access its operations.
     */
    private final StandbyVirtualMachinePoolsClient standbyVirtualMachinePools;
     ...
     */
    public StandbyVirtualMachinePoolsClient getStandbyVirtualMachinePools() {
        return this.standbyVirtualMachinePools;
    }

    /**
     * The StandbyVirtualMachinesClient object to access its operations.
     */
    private final StandbyVirtualMachinesClient standbyVirtualMachines;
     ...
     */
    public StandbyVirtualMachinesClient getStandbyVirtualMachines() {
        return this.standbyVirtualMachines;
    }

    /**
     * Initializes an instance of MicrosoftStandbyPool client.
     * 
     ...
     */
    MicrosoftStandbyPoolImpl(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter,
    ...
    private static final ClientLogger LOGGER = new ClientLogger(MicrosoftStandbyPoolImpl.class);
}
