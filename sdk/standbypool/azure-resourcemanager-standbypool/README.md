# Azure Resource Manager standbypool client library for Java

Azure Resource Manager standbypool client library for Java.

This package contains Microsoft Azure SDK for standbypool Management SDK.  Package tag package-2023-12-01-preview. For documentation on how to use this package, please see [Azure Management Libraries for Java](https://aka.ms/azsdk/java/mgmt).
