...
public final class RelationshipsImpl {
     ...
     * }</pre>
     * 
     * @param body The AtlasRelationship object containing the information for the relationship to
     * be created.
    ...
    public Response<BinaryData> updateWithResponse(BinaryData body, RequestOptions requestOptions) {
        final String accept = "application/json";
        return service.updateSync(this.client.getEndpoint(), this.client.getServiceVersion().getVersion(), accept, body,
            requestOptions, Context.NONE);
    }
