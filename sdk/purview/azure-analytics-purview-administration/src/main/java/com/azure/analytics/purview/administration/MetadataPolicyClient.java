...
public final class MetadataPolicyClient {
    @Generated private final MetadataPolicyAsyncClient asyncClient;
     ...
     */
    @Generated
    MetadataPolicyClient(MetadataPolicyAsyncClient asyncClient) {
    ...
    public Response<BinaryData> updateWithResponse(String policyId, RequestOptions requestOptions) {
        return this.asyncClient.updateWithResponse(policyId, requestOptions).block();
    }
    ...
    public Response<BinaryData> getWithResponse(String policyId, RequestOptions requestOptions) {
        return this.asyncClient.getWithResponse(policyId, requestOptions).block();
    }
}
