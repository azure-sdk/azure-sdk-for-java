...
public final class ScanResultsImpl {
     ...
     */
    ScanResultsImpl(PurviewMetadataClientImpl client) {
        this.service =
    ...
    /**
     * The interface defining all the services for PurviewMetadataClientScanResults to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{Endpoint}")
    ...
    public PagedFlux<BinaryData> listScanHistoryAsync(
        ...
        return new PagedFlux<>(
                ...
                nextLink -> listScanHistoryNextSinglePageAsync(nextLink, requestOptionsForNextPage, context));
    }
