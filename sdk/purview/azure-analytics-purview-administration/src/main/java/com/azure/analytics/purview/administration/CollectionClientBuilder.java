...
@ServiceClientBuilder(serviceClients = {CollectionClient.class, CollectionAsyncClient.class})
public final class CollectionClientBuilder
        implements HttpTrait<CollectionClientBuilder>,
                ConfigurationTrait<CollectionClientBuilder>,
                TokenCredentialTrait<CollectionClientBuilder>,
                EndpointTrait<CollectionClientBuilder> {
    ...
    @Generated
    public CollectionClientBuilder() {
    ...
    @Generated
    @Override
    public CollectionClientBuilder pipeline(HttpPipeline pipeline) {
    ...
    @Generated
    @Override
    public CollectionClientBuilder httpClient(HttpClient httpClient) {
    ...
    @Generated
    @Override
    public CollectionClientBuilder httpLogOptions(HttpLogOptions httpLogOptions) {
    ...
    @Generated
    @Override
    public CollectionClientBuilder clientOptions(ClientOptions clientOptions) {
    ...
    @Generated
    @Override
    public CollectionClientBuilder retryOptions(RetryOptions retryOptions) {
    ...
    @Generated
    @Override
    public CollectionClientBuilder addPolicy(HttpPipelinePolicy customPolicy) {
    ...
    @Generated
    @Override
    public CollectionClientBuilder configuration(Configuration configuration) {
    ...
    @Generated
    @Override
    public CollectionClientBuilder credential(TokenCredential tokenCredential) {
     ...
     * @return the CollectionClientBuilder.
     */
    @Generated
    public CollectionClientBuilder retryPolicy(RetryPolicy retryPolicy) {
