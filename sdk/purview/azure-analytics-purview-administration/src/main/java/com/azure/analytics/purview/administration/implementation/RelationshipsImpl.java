...
public final class RelationshipsImpl {
     ...
     */
    RelationshipsImpl(PurviewMetadataClientImpl client) {
        this.service =
    ...
    /**
     * The interface defining all the services for PurviewMetadataClientRelationships to be used by the proxy service to
     * perform REST calls.
     */
