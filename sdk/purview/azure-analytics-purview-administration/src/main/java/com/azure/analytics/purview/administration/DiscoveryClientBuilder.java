...
@ServiceClientBuilder(serviceClients = {DiscoveryClient.class, DiscoveryAsyncClient.class})
public final class DiscoveryClientBuilder
        implements HttpTrait<DiscoveryClientBuilder>,
                ConfigurationTrait<DiscoveryClientBuilder>,
                TokenCredentialTrait<DiscoveryClientBuilder>,
                EndpointTrait<DiscoveryClientBuilder> {
    ...
    @Generated
    @Override
    public DiscoveryClientBuilder pipeline(HttpPipeline pipeline) {
    ...
    @Generated
    @Override
    public DiscoveryClientBuilder httpClient(HttpClient httpClient) {
    ...
    @Generated
    @Override
    public DiscoveryClientBuilder httpLogOptions(HttpLogOptions httpLogOptions) {
    ...
    @Generated
    @Override
    public DiscoveryClientBuilder clientOptions(ClientOptions clientOptions) {
    ...
    @Generated
    @Override
    public DiscoveryClientBuilder retryOptions(RetryOptions retryOptions) {
    ...
    @Generated
    @Override
    public DiscoveryClientBuilder addPolicy(HttpPipelinePolicy customPolicy) {
    ...
    @Generated
    @Override
    public DiscoveryClientBuilder configuration(Configuration configuration) {
    ...
    @Generated
    @Override
    public DiscoveryClientBuilder credential(TokenCredential tokenCredential) {
     ...
     * @return the DiscoveryClientBuilder.
     */
    @Generated
    public DiscoveryClientBuilder retryPolicy(RetryPolicy retryPolicy) {
