...
import com.azure.analytics.purview.administration.implementation.SystemScanRulesetsImpl;
...
@ServiceClient(builder = SystemScanRulesetsClientBuilder.class, isAsync = true)
