...
@ServiceClient(builder = ScansClientBuilder.class)
public final class ScansClient {
    @Generated private final ScansAsyncClient asyncClient;

    /**
     * Initializes an instance of ScansClient class.
     *
     * @param asyncClient the async client.
     */
    @Generated
    ScansClient(ScansAsyncClient asyncClient) {
    ...
    public Response<BinaryData> createOrUpdateWithResponse(
        ...
        return this.asyncClient.createOrUpdateWithResponse(dataSourceName, scanName, body, requestOptions).block();
    }
    ...
    public Response<BinaryData> deleteWithResponse(
        ...
        return this.asyncClient.deleteWithResponse(dataSourceName, scanName, requestOptions).block();
    }
    ...
    public PagedIterable<BinaryData> listByDataSource(String dataSourceName, RequestOptions requestOptions) {
        return new PagedIterable<>(this.asyncClient.listByDataSource(dataSourceName, requestOptions));
    }
}
