...
public final class DiscoveriesImpl {
     ...
     */
    DiscoveriesImpl(PurviewMetadataClientImpl client) {
        this.service =
    ...
    /**
     * The interface defining all the services for PurviewMetadataClientDiscoveries to be used by the proxy service to
     * perform REST calls.
     */
    ...
    public Mono<Response<BinaryData>> queryWithResponseAsync(BinaryData searchRequest, RequestOptions requestOptions) {
        ...
        return FluxUtil.withContext(
                context ->
                        service.query(this.client.getEndpoint(), apiVersion, searchRequest, requestOptions, context));
    }
    ...
    public Mono<Response<BinaryData>> queryWithResponseAsync(
        ...
        final String apiVersion = "2022-03-01-preview";
        return service.query(this.client.getEndpoint(), apiVersion, searchRequest, requestOptions, context);
    }
    ...
    public Mono<Response<BinaryData>> suggestWithResponseAsync(
        ...
        return FluxUtil.withContext(
                context ->
                        service.suggest(
                                this.client.getEndpoint(), apiVersion, suggestRequest, requestOptions, context));
    }
    ...
    public Mono<Response<BinaryData>> suggestWithResponseAsync(
        ...
        final String apiVersion = "2022-03-01-preview";
        return service.suggest(this.client.getEndpoint(), apiVersion, suggestRequest, requestOptions, context);
    }
    ...
    public Mono<Response<BinaryData>> browseWithResponseAsync(BinaryData browseRequest, RequestOptions requestOptions) {
        ...
        return FluxUtil.withContext(
                context ->
                        service.browse(this.client.getEndpoint(), apiVersion, browseRequest, requestOptions, context));
    }
    ...
    public Mono<Response<BinaryData>> browseWithResponseAsync(
        ...
        final String apiVersion = "2022-03-01-preview";
        return service.browse(this.client.getEndpoint(), apiVersion, browseRequest, requestOptions, context);
    }
        ...
        return FluxUtil.withContext(
                context ->
                        service.autoComplete(
                                this.client.getEndpoint(), apiVersion, autoCompleteRequest, requestOptions, context));
    }
