...
@ServiceClientBuilder(serviceClients = {EntityClient.class, EntityAsyncClient.class})
public final class EntityClientBuilder
        implements HttpTrait<EntityClientBuilder>,
                ConfigurationTrait<EntityClientBuilder>,
                TokenCredentialTrait<EntityClientBuilder>,
                EndpointTrait<EntityClientBuilder> {
    ...
    @Generated
    @Override
    public EntityClientBuilder pipeline(HttpPipeline pipeline) {
    ...
    @Generated
    @Override
    public EntityClientBuilder httpClient(HttpClient httpClient) {
    ...
    @Generated
    @Override
    public EntityClientBuilder httpLogOptions(HttpLogOptions httpLogOptions) {
    ...
    @Generated
    @Override
    public EntityClientBuilder clientOptions(ClientOptions clientOptions) {
    ...
    @Generated
    @Override
    public EntityClientBuilder retryOptions(RetryOptions retryOptions) {
    ...
    @Generated
    @Override
    public EntityClientBuilder addPolicy(HttpPipelinePolicy customPolicy) {
    ...
    @Generated
    @Override
    public EntityClientBuilder configuration(Configuration configuration) {
    ...
    @Generated
    @Override
    public EntityClientBuilder credential(TokenCredential tokenCredential) {
     ...
     * @return the EntityClientBuilder.
     */
    @Generated
    public EntityClientBuilder retryPolicy(RetryPolicy retryPolicy) {
