...
public final class LineagesImpl {
     ...
     */
    LineagesImpl(PurviewMetadataClientImpl client) {
        this.service = RestProxy.create(LineagesService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for PurviewMetadataClientLineages to be used by the proxy service to
     * perform REST calls.
     */
    ...
    public Mono<Response<BinaryData>> nextPageLineageWithResponseAsync(String guid, RequestOptions requestOptions) {
        ...
        return FluxUtil.withContext(
                context ->
                        service.nextPageLineage(this.client.getEndpoint(), guid, apiVersion, requestOptions, context));
    }
    ...
    public Mono<Response<BinaryData>> nextPageLineageWithResponseAsync(
            String guid, RequestOptions requestOptions, Context context) {
        final String apiVersion = "2022-03-01-preview";
        return service.nextPageLineage(this.client.getEndpoint(), guid, apiVersion, requestOptions, context);
    }
    ...
    public Mono<Response<BinaryData>> getLineageByUniqueAttributeWithResponseAsync(
        ...
        return service.getLineageByUniqueAttribute(this.client.getEndpoint(), typeName, requestOptions, context);
    }
    ...
    public Response<BinaryData> getLineageByUniqueAttributeWithResponse(
            String typeName, RequestOptions requestOptions) {
        return getLineageByUniqueAttributeWithResponseAsync(typeName, requestOptions).block();
    }
}
