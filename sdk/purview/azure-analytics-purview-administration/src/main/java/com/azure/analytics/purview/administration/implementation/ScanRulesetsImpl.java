...
public final class ScanRulesetsImpl {
     ...
     */
    ScanRulesetsImpl(PurviewMetadataClientImpl client) {
        this.service =
    ...
    /**
     * The interface defining all the services for PurviewMetadataClientScanRulesets to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{Endpoint}")
    ...
    public Mono<Response<BinaryData>> getWithResponseAsync(String scanRulesetName, RequestOptions requestOptions) {
        ...
        return FluxUtil.withContext(
                context ->
                        service.get(this.client.getEndpoint(), scanRulesetName, apiVersion, requestOptions, context));
    }
    ...
    public Mono<Response<BinaryData>> getWithResponseAsync(
        ...
        final String apiVersion = "2018-12-01-preview";
        return service.get(this.client.getEndpoint(), scanRulesetName, apiVersion, requestOptions, context);
    }
        ...
        return FluxUtil.withContext(
                context ->
                        service.createOrUpdate(
                                this.client.getEndpoint(), scanRulesetName, apiVersion, requestOptions, context));
    }
    ...
    public Mono<Response<BinaryData>> createOrUpdateWithResponseAsync(
            String scanRulesetName, RequestOptions requestOptions, Context context) {
        final String apiVersion = "2018-12-01-preview";
        return service.createOrUpdate(this.client.getEndpoint(), scanRulesetName, apiVersion, requestOptions, context);
    }
    ...
    public Mono<Response<BinaryData>> deleteWithResponseAsync(
            String scanRulesetName, RequestOptions requestOptions, Context context) {
        final String apiVersion = "2018-12-01-preview";
        return service.delete(this.client.getEndpoint(), scanRulesetName, apiVersion, requestOptions, context);
    }
