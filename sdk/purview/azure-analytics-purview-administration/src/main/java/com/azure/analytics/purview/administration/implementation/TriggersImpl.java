...
public final class TriggersImpl {
     ...
     */
    TriggersImpl(PurviewMetadataClientImpl client) {
        this.service = RestProxy.create(TriggersService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for PurviewMetadataClientTriggers to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{Endpoint}")
