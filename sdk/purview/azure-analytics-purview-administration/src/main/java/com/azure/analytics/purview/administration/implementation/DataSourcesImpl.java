...
public final class DataSourcesImpl {
     ...
     */
    DataSourcesImpl(PurviewMetadataClientImpl client) {
        this.service =
    ...
    /**
     * The interface defining all the services for PurviewMetadataClientDataSources to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{Endpoint}")
        ...
        return FluxUtil.withContext(
                context ->
                        service.createOrUpdate(
                                this.client.getEndpoint(), dataSourceName, apiVersion, requestOptions, context));
    }
    ...
    public Mono<Response<BinaryData>> createOrUpdateWithResponseAsync(
        ...
        final String apiVersion = "2018-12-01-preview";
        return service.createOrUpdate(this.client.getEndpoint(), dataSourceName, apiVersion, requestOptions, context);
    }
    ...
    public Mono<Response<BinaryData>> getWithResponseAsync(String dataSourceName, RequestOptions requestOptions) {
        final String apiVersion = "2018-12-01-preview";
        return FluxUtil.withContext(
                context -> service.get(this.client.getEndpoint(), dataSourceName, apiVersion, requestOptions, context));
    }
    ...
    public Mono<Response<BinaryData>> getWithResponseAsync(
            String dataSourceName, RequestOptions requestOptions, Context context) {
        final String apiVersion = "2018-12-01-preview";
        return service.get(this.client.getEndpoint(), dataSourceName, apiVersion, requestOptions, context);
    }
    ...
    public Mono<Response<BinaryData>> deleteWithResponseAsync(String dataSourceName, RequestOptions requestOptions) {
        ...
        return FluxUtil.withContext(
                context ->
                        service.delete(this.client.getEndpoint(), dataSourceName, apiVersion, requestOptions, context));
    }
    ...
    public Mono<Response<BinaryData>> deleteWithResponseAsync(
            String dataSourceName, RequestOptions requestOptions, Context context) {
        final String apiVersion = "2018-12-01-preview";
        return service.delete(this.client.getEndpoint(), dataSourceName, apiVersion, requestOptions, context);
    }
