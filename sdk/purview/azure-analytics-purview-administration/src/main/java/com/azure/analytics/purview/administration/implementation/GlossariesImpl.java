...
public final class GlossariesImpl {
     ...
     */
    GlossariesImpl(PurviewMetadataClientImpl client) {
        this.service =
    ...
    /**
     * The interface defining all the services for PurviewMetadataClientGlossaries to be used by the proxy service to
     * perform REST calls.
     */
        ...
        return FluxUtil.withContext(
                context ->
                        service.importGlossaryTermsViaCsv(
                                this.client.getEndpoint(), glossaryGuid, apiVersion, file, requestOptions, context));
    }
        ...
        return FluxUtil.withContext(
                context ->
                        service.importGlossaryTermsViaCsvByGlossaryName(
                                this.client.getEndpoint(), glossaryName, apiVersion, file, requestOptions, context));
    }
        ...
        return FluxUtil.withContext(
                context ->
                        service.getImportCsvOperationStatus(
                                this.client.getEndpoint(), operationGuid, apiVersion, requestOptions, context));
    }
    ...
    public Mono<Response<Flux<ByteBuffer>>> exportGlossaryTermsAsCsvWithResponseAsync(
        ...
        return service.exportGlossaryTermsAsCsv(
                this.client.getEndpoint(), glossaryGuid, apiVersion, termGuids, requestOptions, context);
    }
        ...
        return FluxUtil.withContext(
                context ->
                        service.listTermsByGlossaryName(
                                this.client.getEndpoint(), glossaryName, apiVersion, requestOptions, context));
    }
