...
import com.azure.analytics.purview.administration.implementation.LineagesImpl;
...
public final class LineageAsyncClient {
    ...
    public Mono<Response<BinaryData>> getLineageByUniqueAttributeWithResponse(
        ...
        return this.serviceClient.getLineageByUniqueAttributeWithResponseAsync(typeName, requestOptions);
    }
}
