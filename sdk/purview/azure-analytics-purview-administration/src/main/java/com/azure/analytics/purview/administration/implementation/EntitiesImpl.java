...
public final class EntitiesImpl {
     ...
     */
    EntitiesImpl(PurviewMetadataClientImpl client) {
        this.service = RestProxy.create(EntitiesService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for PurviewMetadataClientEntities to be used by the proxy service to
     * perform REST calls.
     */
    ...
    private interface EntitiesService {
        ...
        @UnexpectedResponseExceptionType(
                ...
                code = {409})
        @UnexpectedResponseExceptionType(HttpResponseException.class)
        Mono<Response<Void>> deleteBusinessAttributes(
                @HostParam("Endpoint") String endpoint,
        ...
        @UnexpectedResponseExceptionType(
                ...
                code = {409})
        @UnexpectedResponseExceptionType(HttpResponseException.class)
        Mono<Response<Void>> addOrUpdateBusinessAttributes(
                @HostParam("Endpoint") String endpoint,
                @PathParam("bmName") String bmName,
                @PathParam("guid") String guid,
                RequestOptions requestOptions,
        ...
        @UnexpectedResponseExceptionType(
                ...
                code = {404})
        @UnexpectedResponseExceptionType(HttpResponseException.class)
        Mono<Response<BinaryData>> importBusinessAttributes(
                @HostParam("Endpoint") String endpoint, RequestOptions requestOptions, Context context);
     ...
     *     <caption>Query Parameters</caption>
     *     <tr><th>Name</th><th>Type</th><th>Required</th><th>Description</th></tr>
     *     <tr><td>isOverwrite</td><td>String</td><td>No</td><td>Whether to overwrite the existing business metadata on the entity or not, default is false.</td></tr>
     * </table>
     *
     * <p><strong>Request Body Schema</strong>
     *
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<Void>> deleteBusinessAttributesWithResponseAsync(
            String bmName, String guid, RequestOptions requestOptions) {
        return FluxUtil.withContext(
                context ->
                        service.deleteBusinessAttributes(
    ...
    public Mono<Response<Void>> deleteBusinessAttributesWithResponseAsync(
        ...
        return service.deleteBusinessAttributes(this.client.getEndpoint(), bmName, guid, requestOptions, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<Void> deleteBusinessAttributesWithResponse(
            String bmName, String guid, RequestOptions requestOptions) {
        return deleteBusinessAttributesWithResponseAsync(bmName, guid, requestOptions).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<Void>> addOrUpdateBusinessAttributesWithResponseAsync(
            String bmName, String guid, RequestOptions requestOptions) {
        return FluxUtil.withContext(
                context ->
                        service.addOrUpdateBusinessAttributes(
                                this.client.getEndpoint(), bmName, guid, requestOptions, context));
    }
    ...
    public Mono<Response<Void>> addOrUpdateBusinessAttributesWithResponseAsync(
            String bmName, String guid, RequestOptions requestOptions, Context context) {
        return service.addOrUpdateBusinessAttributes(this.client.getEndpoint(), bmName, guid, requestOptions, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<Void> addOrUpdateBusinessAttributesWithResponse(
            String bmName, String guid, RequestOptions requestOptions) {
        return addOrUpdateBusinessAttributesWithResponseAsync(bmName, guid, requestOptions).block();
    }
    ...
    public Mono<Response<Void>> getSampleBusinessMetadataTemplateWithResponseAsync(RequestOptions requestOptions) {
        return FluxUtil.withContext(
                context ->
                        service.getSampleBusinessMetadataTemplate(this.client.getEndpoint(), requestOptions, context));
    }
    ...
    public Mono<Response<Void>> getSampleBusinessMetadataTemplateWithResponseAsync(
        ...
        return service.getSampleBusinessMetadataTemplate(this.client.getEndpoint(), requestOptions, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> importBusinessAttributesWithResponseAsync(RequestOptions requestOptions) {
        return FluxUtil.withContext(
                context -> service.importBusinessAttributes(this.client.getEndpoint(), requestOptions, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> importBusinessAttributesWithResponseAsync(
            RequestOptions requestOptions, Context context) {
        return service.importBusinessAttributes(this.client.getEndpoint(), requestOptions, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<BinaryData> importBusinessAttributesWithResponse(RequestOptions requestOptions) {
        return importBusinessAttributesWithResponseAsync(requestOptions).block();
    }
