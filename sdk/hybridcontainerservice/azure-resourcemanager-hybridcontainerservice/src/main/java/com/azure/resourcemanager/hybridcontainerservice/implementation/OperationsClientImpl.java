...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    OperationsClientImpl(HybridContainerServiceImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for HybridContainerServiceOperations to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{$host}")
