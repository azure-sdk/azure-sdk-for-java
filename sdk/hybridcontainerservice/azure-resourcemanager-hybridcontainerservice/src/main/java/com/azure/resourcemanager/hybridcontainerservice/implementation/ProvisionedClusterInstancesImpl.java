...
public final class ProvisionedClusterInstancesImpl implements ProvisionedClusterInstances {
    ...
    public Response<ProvisionedClusterUpgradeProfileList>
        listUpgradeProfileWithResponse(String connectedClusterResourceUri, Context context) {
        Response<ProvisionedClusterUpgradeProfileListInner> inner
            = this.serviceClient().listUpgradeProfileWithResponse(connectedClusterResourceUri, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
                new ProvisionedClusterUpgradeProfileListImpl(inner.getValue(), this.manager()));
        } else {
            return null;
        }
    }

    public ProvisionedClusterUpgradeProfileList listUpgradeProfile(String connectedClusterResourceUri) {
        ProvisionedClusterUpgradeProfileListInner inner
            = this.serviceClient().listUpgradeProfile(connectedClusterResourceUri);
        if (inner != null) {
            return new ProvisionedClusterUpgradeProfileListImpl(inner, this.manager());
        } else {
            return null;
        }
    }
