...
public final class ProvisionedClusterInstancesClientImpl implements ProvisionedClusterInstancesClient {
    ...
    public interface ProvisionedClusterInstancesService {
        ...
        Mono<Response<ProvisionedClustersInner>> get(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ProvisionedClustersListResult>> list(@HostParam("$host") String endpoint,
            @PathParam(value = "connectedClusterResourceUri", encoded = true) String connectedClusterResourceUri,
            @QueryParam("api-version") String apiVersion, @HeaderParam("Accept") String accept, Context context);
        ...
        @Headers({ "Content-Type: application/json" })
        @Get("/{connectedClusterResourceUri}/providers/Microsoft.HybridContainerService/provisionedClusterInstances/default/upgradeProfiles")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ProvisionedClusterUpgradeProfileListInner>> listUpgradeProfile(
    ...
    private PollerFlux<PollResult<ProvisionedClustersInner>, ProvisionedClustersInner> beginCreateOrUpdateAsync(
        ...
        return this.client.<ProvisionedClustersInner, ProvisionedClustersInner>getLroResult(mono,
            this.client.getHttpPipeline(), ProvisionedClustersInner.class, ProvisionedClustersInner.class,
    ...
    private PollerFlux<PollResult<ProvisionedClustersInner>, ProvisionedClustersInner> beginCreateOrUpdateAsync(
        ...
        return this.client.<ProvisionedClustersInner, ProvisionedClustersInner>getLroResult(mono,
            this.client.getHttpPipeline(), ProvisionedClustersInner.class, ProvisionedClustersInner.class, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<ProvisionedClustersInner>, ProvisionedClustersInner>
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ProvisionedClustersInner> createOrUpdateAsync(String connectedClusterResourceUri,
        ProvisionedClustersInner provisionedClusterInstance) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ProvisionedClustersInner createOrUpdate(String connectedClusterResourceUri,
        ProvisionedClustersInner provisionedClusterInstance) {
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the Hybrid AKS provisioned cluster instances associated with the connected cluster along with
    ...
    private Mono<PagedResponse<ProvisionedClustersInner>> listSinglePageAsync(String connectedClusterResourceUri) {
        ...
        return FluxUtil
            .withContext(context -> service.list(this.client.getEndpoint(), connectedClusterResourceUri,
                this.client.getApiVersion(), accept, context))
            .<PagedResponse<ProvisionedClustersInner>>map(res -> new PagedResponseBase<>(res.getRequest(),
    ...
    /**
     * Lists the upgrade profiles of a provisioned cluster instance.
     * 
     * @param connectedClusterResourceUri The fully qualified Azure Resource manager identifier of the connected cluster
     * resource.
     * @throws IllegalArgumentException thrown if parameters fail the validation.
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return list of upgradeProfiles for the provisioned cluster along with {@link Response} on successful completion
     * of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ProvisionedClusterUpgradeProfileListInner>>
        listUpgradeProfileWithResponseAsync(String connectedClusterResourceUri) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.listUpgradeProfile(this.client.getEndpoint(), connectedClusterResourceUri,
                this.client.getApiVersion(), accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ProvisionedClusterUpgradeProfileListInner>>
        listUpgradeProfileWithResponseAsync(String connectedClusterResourceUri, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.listUpgradeProfile(this.client.getEndpoint(), connectedClusterResourceUri,
            this.client.getApiVersion(), accept, context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return list of upgradeProfiles for the provisioned cluster on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ProvisionedClusterUpgradeProfileListInner>
        listUpgradeProfileAsync(String connectedClusterResourceUri) {
        return listUpgradeProfileWithResponseAsync(connectedClusterResourceUri)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return list of upgradeProfiles for the provisioned cluster along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ProvisionedClusterUpgradeProfileListInner>
        listUpgradeProfileWithResponse(String connectedClusterResourceUri, Context context) {
        return listUpgradeProfileWithResponseAsync(connectedClusterResourceUri, context).block();
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return list of upgradeProfiles for the provisioned cluster.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ProvisionedClusterUpgradeProfileListInner listUpgradeProfile(String connectedClusterResourceUri) {
        return listUpgradeProfileWithResponse(connectedClusterResourceUri, Context.NONE).getValue();
    }
