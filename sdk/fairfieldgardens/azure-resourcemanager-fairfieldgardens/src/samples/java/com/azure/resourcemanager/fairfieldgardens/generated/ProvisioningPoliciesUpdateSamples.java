...
public final class ProvisioningPoliciesUpdateSamples {
     ...
     * ProvisioningPolicies_Update.json
     */
    /**
     ...
     */
    public static void
        provisioningPoliciesUpdate(com.azure.resourcemanager.fairfieldgardens.FairfieldgardensManager manager) {
        ProvisioningPolicy resource = manager.provisioningPolicies()
            .getWithResponse("rgopenapi", "Jack", "QDnuX5r6684GtJ62", com.azure.core.util.Context.NONE).getValue();
        resource.update().withTags(mapOf("key5221", "fakeTokenPlaceholder"))
            ...
            .withJit(new JitRuleUpdate().withPriority(10).withSubscriptionId("vzbhvmvyczrhnuzwd")
                .withResourceGroupName("K_-"))
