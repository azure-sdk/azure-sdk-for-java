...
public final class FirewallRulesImpl implements FirewallRules {
    ...
    public PagedIterable<RedisFirewallRule> list(String resourceGroupName, String cacheName) {
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new RedisFirewallRuleImpl(inner1, this.manager()));
    }
    ...
    public Response<RedisFirewallRule> createOrUpdateWithResponse(String resourceGroupName, String cacheName,
        String ruleName, RedisFirewallRuleInner parameters, Context context) {
        Response<RedisFirewallRuleInner> inner = this.serviceClient().createOrUpdateWithResponse(resourceGroupName,
            cacheName, ruleName, parameters, context);
        if (inner != null) {
    ...
    public RedisFirewallRule createOrUpdate(String resourceGroupName, String cacheName, String ruleName,
    ...
    public Response<RedisFirewallRule> getWithResponse(String resourceGroupName, String cacheName, String ruleName,
        Context context) {
