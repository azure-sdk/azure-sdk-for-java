...
public class RedisCommonProperties {
     ...
     * rdb-backup-enabled,rdb-storage-connection-string,rdb-backup-frequency,maxmemory-delta,maxmemory-policy,notify-
     * keyspace-events,maxmemory-samples,slowlog-log-slower-than,slowlog-max-len,list-max-ziplist-entries,list-max-
     * ziplist-value,hash-max-ziplist-entries,hash-max-ziplist-value,set-max-intset-entries,zset-max-ziplist-entries,
    ...
    /*
     * Optional: Specifies the method in which zones are allocated to the Redis cache. 'Automatic' refers to allocation
     * of zones automatically by the Azure based on the availability zones support in the region and number of
     * instances. 'UserDefined' refers to usage of zones passed in by you for allocation. 'NoZones' refers to the
     * non-zonal cache. If 'zonalAllocation' is not passed, it will be set to 'UserDefined' when zones are passed in,
     * otherwise, will be set to 'NoZones'
     */
    @JsonProperty(value = "zonalAllocation")
    private ZonalAllocation zonalAllocation;
    ...
    /**
     * Get the zonalAllocation property: Optional: Specifies the method in which zones are allocated to the Redis
     ...
     */
    public ZonalAllocation zonalAllocation() {
        return this.zonalAllocation;
    }

    /**
     * Set the zonalAllocation property: Optional: Specifies the method in which zones are allocated to the Redis
     * cache. 'Automatic' refers to allocation of zones automatically by the Azure based on the availability zones
     * support in the region and number of instances. 'UserDefined' refers to usage of zones passed in by you for
     * allocation. 'NoZones' refers to the non-zonal cache. If 'zonalAllocation' is not passed, it will be set to
     * 'UserDefined' when zones are passed in, otherwise, will be set to 'NoZones'.
     * 
     * @param zonalAllocation the zonalAllocation value to set.
     * @return the RedisCommonProperties object itself.
     */
    public RedisCommonProperties withZonalAllocation(ZonalAllocation zonalAllocation) {
        this.zonalAllocation = zonalAllocation;
        return this;
    }
