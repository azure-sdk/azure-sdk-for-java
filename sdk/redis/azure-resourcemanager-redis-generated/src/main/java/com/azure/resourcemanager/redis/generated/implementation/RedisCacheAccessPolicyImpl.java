...
public final class RedisCacheAccessPolicyImpl
    ...
    public RedisCacheAccessPolicy create() {
        this.innerObject = serviceManager.serviceClient().getAccessPolicies().createUpdate(resourceGroupName, cacheName,
            accessPolicyName, this.innerModel(), Context.NONE);
        return this;
    }

    public RedisCacheAccessPolicy create(Context context) {
        this.innerObject = serviceManager.serviceClient().getAccessPolicies().createUpdate(resourceGroupName, cacheName,
            accessPolicyName, this.innerModel(), context);
        return this;
    }
    ...
    RedisCacheAccessPolicyImpl(RedisCacheAccessPolicyInner innerObject,
    ...
    public RedisCacheAccessPolicy refresh() {
        this.innerObject = serviceManager.serviceClient().getAccessPolicies()
            .getWithResponse(resourceGroupName, cacheName, accessPolicyName, Context.NONE).getValue();
        return this;
    }

    public RedisCacheAccessPolicy refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getAccessPolicies()
            .getWithResponse(resourceGroupName, cacheName, accessPolicyName, context).getValue();
        return this;
    }
