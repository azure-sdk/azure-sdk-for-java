...
import com.azure.resourcemanager.redis.generated.fluent.models.RedisCreateProperties;
...
public final class RedisCreateParameters {
     ...
     * @return the RedisCreateParameters object itself.
     */
    public RedisCreateParameters withRedisConfiguration(RedisCommonPropertiesRedisConfiguration redisConfiguration) {
        if (this.innerProperties() == null) {
            this.innerProperties = new RedisCreateProperties();
        }
    ...
    public ZonalAllocation zonalAllocation() {
        return this.innerProperties() == null ? null : this.innerProperties().zonalAllocation();
    }
     ...
     * @return the RedisCreateParameters object itself.
     */
    public RedisCreateParameters withZonalAllocation(ZonalAllocation zonalAllocation) {
        if (this.innerProperties() == null) {
            this.innerProperties = new RedisCreateProperties();
        }
        this.innerProperties().withZonalAllocation(zonalAllocation);
        return this;
    }
