...
public final class RedisResourceInner extends Resource {
     ...
     * @return the RedisResourceInner object itself.
     */
    public RedisResourceInner withZonalAllocation(ZonalAllocation zonalAllocation) {
        if (this.innerProperties() == null) {
            this.innerProperties = new RedisPropertiesInner();
        }
    ...
    public void validate() {
        if (innerProperties() == null) {
            throw LOGGER.logExceptionAsError(
                new IllegalArgumentException("Missing required property innerProperties in model RedisResourceInner"));
        } else {
