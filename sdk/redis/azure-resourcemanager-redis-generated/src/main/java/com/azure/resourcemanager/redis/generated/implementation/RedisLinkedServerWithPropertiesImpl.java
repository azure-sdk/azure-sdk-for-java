...
public final class RedisLinkedServerWithPropertiesImpl
    ...
    RedisLinkedServerWithPropertiesImpl(RedisLinkedServerWithPropertiesInner innerObject,
    ...
    public String geoReplicatedPrimaryHostname() {
        return this.innerModel().geoReplicatedPrimaryHostname();
    }

    public String primaryHostname() {
        return this.innerModel().primaryHostname();
    }
    ...
    public RedisLinkedServerWithProperties create() {
        this.innerObject = serviceManager.serviceClient().getLinkedServers().create(resourceGroupName, name,
            linkedServerName, createParameters, Context.NONE);
        return this;
    }

    public RedisLinkedServerWithProperties create(Context context) {
        this.innerObject = serviceManager.serviceClient().getLinkedServers().create(resourceGroupName, name,
            linkedServerName, createParameters, context);
        return this;
    }

    RedisLinkedServerWithPropertiesImpl(String name,
        com.azure.resourcemanager.redis.generated.RedisManager serviceManager) {
    ...
    public RedisLinkedServerWithProperties refresh() {
        this.innerObject = serviceManager.serviceClient().getLinkedServers()
            .getWithResponse(resourceGroupName, name, linkedServerName, Context.NONE).getValue();
        return this;
    }

    public RedisLinkedServerWithProperties refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getLinkedServers()
            .getWithResponse(resourceGroupName, name, linkedServerName, context).getValue();
        return this;
    }
