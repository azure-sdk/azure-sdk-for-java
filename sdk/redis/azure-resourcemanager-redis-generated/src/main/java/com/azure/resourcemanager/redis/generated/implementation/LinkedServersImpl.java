...
public final class LinkedServersImpl implements LinkedServers {
    ...
    public LinkedServersImpl(LinkedServersClient innerClient,
    ...
    public Response<RedisLinkedServerWithProperties> getWithResponse(String resourceGroupName, String name,
    ...
    public PagedIterable<RedisLinkedServerWithProperties> list(String resourceGroupName, String name) {
        ...
        return ResourceManagerUtils.mapPage(inner,
            inner1 -> new RedisLinkedServerWithPropertiesImpl(inner1, this.manager()));
    }
    ...
    public RedisLinkedServerWithProperties getById(String id) {
        ...
        String linkedServerName = ResourceManagerUtils.getValueFromIdByName(id, "linkedServers");
