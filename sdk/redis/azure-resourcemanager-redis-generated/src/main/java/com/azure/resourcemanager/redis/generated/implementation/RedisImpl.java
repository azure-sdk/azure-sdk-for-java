...
public final class RedisImpl implements Redis {
    ...
    public PagedIterable<UpgradeNotification> listUpgradeNotifications(String resourceGroupName, String name,
        double history) {
        PagedIterable<UpgradeNotificationInner> inner
            = this.serviceClient().listUpgradeNotifications(resourceGroupName, name, history);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new UpgradeNotificationImpl(inner1, this.manager()));
    }
    ...
    public Response<RedisResource> getByResourceGroupWithResponse(String resourceGroupName, String name,
        Context context) {
    ...
    public PagedIterable<RedisResource> listByResourceGroup(String resourceGroupName) {
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new RedisResourceImpl(inner1, this.manager()));
    }
    ...
    public Response<RedisAccessKeys> regenerateKeyWithResponse(String resourceGroupName, String name,
    ...
    public RedisAccessKeys regenerateKey(String resourceGroupName, String name,
    ...
    public Response<RedisForceRebootResponse> forceRebootWithResponse(String resourceGroupName, String name,
    ...
    public RedisForceRebootResponse forceReboot(String resourceGroupName, String name,
    ...
    public OperationStatusResult flushCache(String resourceGroupName, String cacheName) {
        OperationStatusResultInner inner = this.serviceClient().flushCache(resourceGroupName, cacheName);
        if (inner != null) {
    ...
    public OperationStatusResult flushCache(String resourceGroupName, String cacheName, Context context) {
        OperationStatusResultInner inner = this.serviceClient().flushCache(resourceGroupName, cacheName, context);
        if (inner != null) {
            return new OperationStatusResultImpl(inner, this.manager());
        } else {
            return null;
    ...
    public RedisResource getById(String id) {
        ...
        String name = ResourceManagerUtils.getValueFromIdByName(id, "redis");
        if (name == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
