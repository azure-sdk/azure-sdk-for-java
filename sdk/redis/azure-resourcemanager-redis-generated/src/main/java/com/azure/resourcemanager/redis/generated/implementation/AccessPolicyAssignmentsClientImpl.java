...
public final class AccessPolicyAssignmentsClientImpl implements AccessPolicyAssignmentsClient {
    ...
    public interface AccessPolicyAssignmentsService {
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<RedisCacheAccessPolicyAssignmentInner>> get(
            @HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("cacheName") String cacheName,
            @PathParam("accessPolicyAssignmentName") String accessPolicyAssignmentName,
    ...
    private PollerFlux<PollResult<RedisCacheAccessPolicyAssignmentInner>, RedisCacheAccessPolicyAssignmentInner>
        ...
        return this
            .client
            .<RedisCacheAccessPolicyAssignmentInner, RedisCacheAccessPolicyAssignmentInner>getLroResult(
                mono,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<RedisCacheAccessPolicyAssignmentInner> createUpdateAsync(
        String resourceGroupName,
        String cacheName,
        String accessPolicyAssignmentName,
        RedisCacheAccessPolicyAssignmentInner parameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<RedisCacheAccessPolicyAssignmentInner>> getWithResponseAsync(
        String resourceGroupName, String cacheName, String accessPolicyAssignmentName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<RedisCacheAccessPolicyAssignmentInner> getAsync(
        String resourceGroupName, String cacheName, String accessPolicyAssignmentName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<RedisCacheAccessPolicyAssignmentInner> getWithResponse(
        String resourceGroupName, String cacheName, String accessPolicyAssignmentName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<RedisCacheAccessPolicyAssignmentInner>> listSinglePageAsync(
                ...
                context ->
                    service
                        .list(
                            ...
                            accept,
                            context))
            .<PagedResponse<RedisCacheAccessPolicyAssignmentInner>>map(
                res ->
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<RedisCacheAccessPolicyAssignmentInner> listAsync(
        String resourceGroupName, String cacheName, Context context) {
        return new PagedFlux<>(
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<RedisCacheAccessPolicyAssignmentInner> list(
        String resourceGroupName, String cacheName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<RedisCacheAccessPolicyAssignmentInner>> listNextSinglePageAsync(
