...
public final class PatchSchedulesImpl implements PatchSchedules {
    ...
    public PatchSchedulesImpl(PatchSchedulesClient innerClient,
    ...
    public PagedIterable<RedisPatchSchedule> listByRedisResource(String resourceGroupName, String cacheName) {
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new RedisPatchScheduleImpl(inner1, this.manager()));
    }
    ...
    public Response<RedisPatchSchedule> getWithResponse(String resourceGroupName, String name,
    ...
    public RedisPatchSchedule getById(String id) {
        ...
        String defaultParameterLocal = ResourceManagerUtils.getValueFromIdByName(id, "patchSchedules");
        if (defaultParameterLocal == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
                String.format("The resource ID '%s' is not valid. Missing path segment 'patchSchedules'.", id)));
        }
