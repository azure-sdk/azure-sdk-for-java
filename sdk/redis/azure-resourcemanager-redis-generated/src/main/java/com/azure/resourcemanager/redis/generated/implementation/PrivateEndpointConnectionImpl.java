...
public final class PrivateEndpointConnectionImpl
    ...
    public PrivateEndpointConnection create() {
        this.innerObject = serviceManager.serviceClient().getPrivateEndpointConnections().put(resourceGroupName,
            cacheName, privateEndpointConnectionName, this.innerModel(), Context.NONE);
        return this;
    }

    public PrivateEndpointConnection create(Context context) {
        this.innerObject = serviceManager.serviceClient().getPrivateEndpointConnections().put(resourceGroupName,
            cacheName, privateEndpointConnectionName, this.innerModel(), context);
        return this;
    }
    ...
    public PrivateEndpointConnection refresh() {
        this.innerObject = serviceManager.serviceClient().getPrivateEndpointConnections()
            .getWithResponse(resourceGroupName, cacheName, privateEndpointConnectionName, Context.NONE).getValue();
        return this;
    }

    public PrivateEndpointConnection refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getPrivateEndpointConnections()
            .getWithResponse(resourceGroupName, cacheName, privateEndpointConnectionName, context).getValue();
        return this;
    }
