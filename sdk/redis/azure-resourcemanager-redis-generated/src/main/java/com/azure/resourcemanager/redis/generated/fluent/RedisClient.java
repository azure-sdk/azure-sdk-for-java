...
public interface RedisClient {
    ...
    PagedIterable<UpgradeNotificationInner> listUpgradeNotifications(String resourceGroupName, String name,
        double history);
    ...
    SyncPoller<PollResult<RedisResourceInner>, RedisResourceInner> beginCreate(String resourceGroupName, String name,
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<RedisResourceInner>, RedisResourceInner> beginUpdate(String resourceGroupName, String name,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<RedisAccessKeysInner> regenerateKeyWithResponse(String resourceGroupName, String name,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<RedisForceRebootResponseInner> forceRebootWithResponse(String resourceGroupName, String name,
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<Void>, Void> beginImportData(String resourceGroupName, String name,
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<Void>, Void> beginExportData(String resourceGroupName, String name,
