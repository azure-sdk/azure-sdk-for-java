...
public interface AccessPoliciesClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<RedisCacheAccessPolicyInner>, RedisCacheAccessPolicyInner> beginDelete(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    RedisCacheAccessPolicyInner delete(String resourceGroupName, String cacheName, String accessPolicyName);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    RedisCacheAccessPolicyInner delete(
        String resourceGroupName, String cacheName, String accessPolicyName, Context context);
