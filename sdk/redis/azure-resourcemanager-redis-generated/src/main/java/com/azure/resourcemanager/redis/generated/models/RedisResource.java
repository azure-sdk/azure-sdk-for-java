...
public interface RedisResource {
    ...
    /**
     * Gets the zonalAllocation property: Optional: Specifies the method in which zones are allocated to the Redis
     * cache. 'Automatic' refers to allocation of zones automatically by the Azure based on the availability zones
     * support in the region and number of instances. 'UserDefined' refers to usage of zones passed in by you for
     * allocation. 'NoZones' refers to the non-zonal cache. If 'zonalAllocation' is not passed, it will be set to
     * 'UserDefined' when zones are passed in, otherwise, will be set to 'NoZones'.
     * 
     * @return the zonalAllocation value.
     */
    ...
    interface DefinitionStages {
        ...
        interface WithCreate
            ...
            DefinitionStages.WithSubnetId, DefinitionStages.WithStaticIp, DefinitionStages.WithRedisConfiguration,
            DefinitionStages.WithRedisVersion, DefinitionStages.WithEnableNonSslPort,
            DefinitionStages.WithReplicasPerMaster, DefinitionStages.WithReplicasPerPrimary,
            DefinitionStages.WithTenantSettings, DefinitionStages.WithShardCount,
            DefinitionStages.WithMinimumTlsVersion, DefinitionStages.WithPublicNetworkAccess,
            DefinitionStages.WithUpdateChannel, DefinitionStages.WithZonalAllocation {
            /**
        ...
        /**
         * The stage of the RedisResource definition allowing to specify zonalAllocation.
         */
        interface WithZonalAllocation {
            /**
             * Specifies the zonalAllocation property: Optional: Specifies the method in which zones are allocated to
             * the Redis cache. 'Automatic' refers to allocation of zones automatically by the Azure based on the
             * availability zones support in the region and number of instances. 'UserDefined' refers to usage of zones
             * passed in by you for allocation. 'NoZones' refers to the non-zonal cache. If 'zonalAllocation' is not
             * passed, it will be set to 'UserDefined' when zones are passed in, otherwise, will be set to 'NoZones'.
             * 
             * @param zonalAllocation Optional: Specifies the method in which zones are allocated to the Redis cache.
             * 'Automatic' refers to allocation of zones automatically by the Azure based on the availability zones
             * support in the region and number of instances. 'UserDefined' refers to usage of zones passed in by you
             * for allocation. 'NoZones' refers to the non-zonal cache. If 'zonalAllocation' is not passed, it will be
             * set to 'UserDefined' when zones are passed in, otherwise, will be set to 'NoZones'.
             * @return the next definition stage.
             */
            WithCreate withZonalAllocation(ZonalAllocation zonalAllocation);
        }
    }
    ...
    interface Update extends UpdateStages.WithTags, UpdateStages.WithIdentity, UpdateStages.WithSku,
        ...
        UpdateStages.WithUpdateChannel, UpdateStages.WithZonalAllocation {
        /**
    ...
    interface UpdateStages {
        ...
        /**
         * The stage of the RedisResource update allowing to specify zonalAllocation.
         */
        interface WithZonalAllocation {
            /**
             * Specifies the zonalAllocation property: Optional: Specifies the method in which zones are allocated to
             ...
             * @return the next definition stage.
             */
            Update withZonalAllocation(ZonalAllocation zonalAllocation);
        }
    }
