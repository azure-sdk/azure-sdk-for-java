...
public interface RedisResource {
    ...
    interface DefinitionStages {
        ...
        interface WithZonalAllocationPolicy {
             ...
             * the Redis cache. 'Automatic' enables zone redundancy and Azure will select zones based on regional
             * availability and capacity. 'UserDefined' will select availability zones passed in by you using the
             * 'zones' parameter. 'NoZones' will produce a non-zonal cache. If 'zonalAllocation' is not passed, it will
             ...
             * 'Automatic' enables zone redundancy and Azure will select zones based on regional availability and
             * capacity. 'UserDefined' will select availability zones passed in by you using the 'zones' parameter.
             * 'NoZones' will produce a non-zonal cache. If 'zonalAllocation' is not passed, it will be set to
