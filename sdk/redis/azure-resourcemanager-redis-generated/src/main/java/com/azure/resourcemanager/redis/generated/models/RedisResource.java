...
public interface RedisResource {
    ...
    interface DefinitionStages {
        ...
        interface WithCreate extends DefinitionStages.WithTags, DefinitionStages.WithZones,
            DefinitionStages.WithIdentity, DefinitionStages.WithSubnetId, DefinitionStages.WithStaticIp,
            DefinitionStages.WithRedisConfiguration, DefinitionStages.WithRedisVersion,
            DefinitionStages.WithEnableNonSslPort, DefinitionStages.WithReplicasPerMaster,
            DefinitionStages.WithReplicasPerPrimary, DefinitionStages.WithTenantSettings,
            DefinitionStages.WithShardCount, DefinitionStages.WithMinimumTlsVersion,
            DefinitionStages.WithPublicNetworkAccess, DefinitionStages.WithUpdateChannel,
            DefinitionStages.WithDisableAccessKeyAuthentication, DefinitionStages.WithZonalAllocationPolicy {
            /**
        ...
        interface WithRedisVersion {
            /**
             * Specifies the redisVersion property: Redis version. This should be in the form 'major[.minor]' (only
             * 'major' is required) or the value 'latest' which refers to the latest stable Redis version that is
             * available. Supported versions: 4.0, 6.0 (latest). Default value is 'latest'..
             * 
             * @param redisVersion Redis version. This should be in the form 'major[.minor]' (only 'major' is required)
             * or the value 'latest' which refers to the latest stable Redis version that is available. Supported
             * versions: 4.0, 6.0 (latest). Default value is 'latest'.
             * @return the next definition stage.
             */
        ...
        /**
         * The stage of the RedisResource definition allowing to specify updateChannel.
         */
        interface WithUpdateChannel {
            /**
             * Specifies the updateChannel property: Optional: Specifies the update channel for the monthly Redis
             * updates your Redis Cache will receive. Caches using 'Preview' update channel get latest Redis updates at
             * least 4 weeks ahead of 'Stable' channel caches. Default value is 'Stable'..
             * 
             * @param updateChannel Optional: Specifies the update channel for the monthly Redis updates your Redis
             * Cache will receive. Caches using 'Preview' update channel get latest Redis updates at least 4 weeks ahead
             * of 'Stable' channel caches. Default value is 'Stable'.
             * @return the next definition stage.
             */
            WithCreate withUpdateChannel(UpdateChannel updateChannel);
        }

        /**
         * The stage of the RedisResource definition allowing to specify disableAccessKeyAuthentication.
         */
        interface WithDisableAccessKeyAuthentication {
            /**
             * Specifies the disableAccessKeyAuthentication property: Authentication to Redis through access keys is
             * disabled when set as true. Default value is false..
             * 
             * @param disableAccessKeyAuthentication Authentication to Redis through access keys is disabled when set as
             * true. Default value is false.
             * @return the next definition stage.
             */
            WithCreate withDisableAccessKeyAuthentication(Boolean disableAccessKeyAuthentication);
        }

        /**
         * The stage of the RedisResource definition allowing to specify zonalAllocationPolicy.
         */
        interface WithZonalAllocationPolicy {
            /**
             * Specifies the zonalAllocationPolicy property: Optional: Specifies how availability zones are allocated to
             * the Redis cache. 'Automatic' enables zone redundancy and Azure will automatically select zones based on
             * regional availability and capacity. 'UserDefined' will select availability zones passed in by you using
             * the 'zones' parameter. 'NoZones' will produce a non-zonal cache. If 'zonalAllocationPolicy' is not
             * passed, it will be set to 'UserDefined' when zones are passed in, otherwise, it will be set to
             * 'Automatic' in regions where zones are supported and 'NoZones' in regions where zones are not supported..
             * 
             * @param zonalAllocationPolicy Optional: Specifies how availability zones are allocated to the Redis cache.
             * 'Automatic' enables zone redundancy and Azure will automatically select zones based on regional
             * availability and capacity. 'UserDefined' will select availability zones passed in by you using the
             * 'zones' parameter. 'NoZones' will produce a non-zonal cache. If 'zonalAllocationPolicy' is not passed, it
             * will be set to 'UserDefined' when zones are passed in, otherwise, it will be set to 'Automatic' in
             * regions where zones are supported and 'NoZones' in regions where zones are not supported.
             * @return the next definition stage.
             */
            WithCreate withZonalAllocationPolicy(ZonalAllocationPolicy zonalAllocationPolicy);
        }
    }
    ...
    interface Update extends UpdateStages.WithTags, UpdateStages.WithIdentity, UpdateStages.WithSku,
        UpdateStages.WithRedisConfiguration, UpdateStages.WithRedisVersion, UpdateStages.WithEnableNonSslPort,
        UpdateStages.WithReplicasPerMaster, UpdateStages.WithReplicasPerPrimary, UpdateStages.WithTenantSettings,
        UpdateStages.WithShardCount, UpdateStages.WithMinimumTlsVersion, UpdateStages.WithPublicNetworkAccess,
        UpdateStages.WithUpdateChannel, UpdateStages.WithDisableAccessKeyAuthentication,
        UpdateStages.WithZonalAllocationPolicy {
        /**
    ...
    interface UpdateStages {
        ...
        /**
         * The stage of the RedisResource update allowing to specify updateChannel.
         */
        interface WithUpdateChannel {
            /**
             * Specifies the updateChannel property: Optional: Specifies the update channel for the monthly Redis
             ...
             * @return the next definition stage.
             */
            Update withUpdateChannel(UpdateChannel updateChannel);
        }

        /**
         * The stage of the RedisResource update allowing to specify disableAccessKeyAuthentication.
         */
        interface WithDisableAccessKeyAuthentication {
            /**
             * Specifies the disableAccessKeyAuthentication property: Authentication to Redis through access keys is
             ...
             * @return the next definition stage.
             */
            Update withDisableAccessKeyAuthentication(Boolean disableAccessKeyAuthentication);
        }

        /**
         * The stage of the RedisResource update allowing to specify zonalAllocationPolicy.
         */
        interface WithZonalAllocationPolicy {
            /**
             * Specifies the zonalAllocationPolicy property: Optional: Specifies how availability zones are allocated to
             ...
             * @return the next definition stage.
             */
            Update withZonalAllocationPolicy(ZonalAllocationPolicy zonalAllocationPolicy);
        }
    }
