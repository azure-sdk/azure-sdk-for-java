...
public interface RedisResource {
     ...
     * access method. Default value is 'Enabled'. Note: This setting is important for caches with private endpoints. It
     * has *no effect* on caches that are joined to, or injected into, a virtual network subnet.
     *
    ...
    interface DefinitionStages {
        ...
        interface WithPublicNetworkAccess {
             ...
             * endpoints are the exclusive access method. Default value is 'Enabled'. Note: This setting is important
             * for caches with private endpoints. It has *no effect* on caches that are joined to, or injected into, a
             ...
             *     exclusive access method. Default value is 'Enabled'. Note: This setting is important for caches with
