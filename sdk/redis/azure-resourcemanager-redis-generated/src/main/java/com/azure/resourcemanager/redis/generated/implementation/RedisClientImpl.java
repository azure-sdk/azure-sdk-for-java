...
public final class RedisClientImpl implements RedisClient {
    ...
    public interface RedisService {
        ...
        @ExpectedResponses({200, 202})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Flux<ByteBuffer>>> flushCache(
            @HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> flushCacheWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<OperationStatusResultInner>, OperationStatusResultInner> beginFlushCacheAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<OperationStatusResultInner>, OperationStatusResultInner> beginFlushCache(
        String resourceGroupName, String cacheName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<OperationStatusResultInner> flushCacheAsync(
        String resourceGroupName, String cacheName, Context context) {
        return beginFlushCacheAsync(resourceGroupName, cacheName, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
