...
public final class RedisCacheAccessPolicyAssignmentImpl
    implements RedisCacheAccessPolicyAssignment,
        RedisCacheAccessPolicyAssignment.Definition,
        RedisCacheAccessPolicyAssignment.Update {
    ...
    public RedisCacheAccessPolicyAssignment create() {
        this.innerObject =
            serviceManager
                ...
                .createUpdate(
                    resourceGroupName, cacheName, accessPolicyAssignmentName, this.innerModel(), Context.NONE);
        return this;
    }
    ...
    public RedisCacheAccessPolicyAssignment create(Context context) {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getAccessPolicyAssignments()
                .createUpdate(resourceGroupName, cacheName, accessPolicyAssignmentName, this.innerModel(), context);
        return this;
    }

    RedisCacheAccessPolicyAssignmentImpl(
    ...
    RedisCacheAccessPolicyAssignmentImpl(
        RedisCacheAccessPolicyAssignmentInner innerObject,
        ...
        this.accessPolicyAssignmentName = Utils.getValueFromIdByName(innerObject.id(), "accessPolicyAssignments");
    }
    ...
    public RedisCacheAccessPolicyAssignment refresh() {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getAccessPolicyAssignments()
                .getWithResponse(resourceGroupName, cacheName, accessPolicyAssignmentName, Context.NONE)
                .getValue();
        return this;
    }
    ...
    public RedisCacheAccessPolicyAssignment refresh(Context context) {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getAccessPolicyAssignments()
                .getWithResponse(resourceGroupName, cacheName, accessPolicyAssignmentName, context)
                .getValue();
        return this;
    }
