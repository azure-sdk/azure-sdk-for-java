...
public final class AccessPoliciesClientImpl implements AccessPoliciesClient {
     ...
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
     * @param cacheName The name of the Redis cache.
     * @param accessPolicyName The name of the access policy that is being deleted from the Redis cache.
     * @throws IllegalArgumentException thrown if parameters fail the validation.
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<RedisCacheAccessPolicyInner>, RedisCacheAccessPolicyInner> beginDeleteAsync(
        String resourceGroupName, String cacheName, String accessPolicyName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<RedisCacheAccessPolicyInner>, RedisCacheAccessPolicyInner> beginDelete(
        String resourceGroupName, String cacheName, String accessPolicyName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<RedisCacheAccessPolicyInner> deleteAsync(
        String resourceGroupName, String cacheName, String accessPolicyName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public RedisCacheAccessPolicyInner delete(String resourceGroupName, String cacheName, String accessPolicyName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public RedisCacheAccessPolicyInner delete(
        String resourceGroupName, String cacheName, String accessPolicyName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<RedisCacheAccessPolicyInner> getAsync(
        String resourceGroupName, String cacheName, String accessPolicyName) {
