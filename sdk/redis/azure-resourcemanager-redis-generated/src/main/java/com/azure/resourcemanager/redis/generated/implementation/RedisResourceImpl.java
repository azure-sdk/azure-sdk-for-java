...
public final class RedisResourceImpl implements RedisResource, RedisResource.Definition, RedisResource.Update {
    ...
    public UpdateChannel updateChannel() {
        return this.innerModel().updateChannel();
    }

    public Boolean disableAccessKeyAuthentication() {
        return this.innerModel().disableAccessKeyAuthentication();
    }

    public ZonalAllocationPolicy zonalAllocationPolicy() {
        return this.innerModel().zonalAllocationPolicy();
    }
    ...
    public RedisResource apply() {
        this.innerObject
            = serviceManager.serviceClient().getRedis().update(resourceGroupName, name, updateParameters, Context.NONE);
        return this;
    }

    public RedisResource apply(Context context) {
        this.innerObject
            = serviceManager.serviceClient().getRedis().update(resourceGroupName, name, updateParameters, context);
        return this;
    }

    RedisResourceImpl(RedisResourceInner innerObject,
        com.azure.resourcemanager.redis.generated.RedisManager serviceManager) {
        this.innerObject = innerObject;
        this.serviceManager = serviceManager;
        this.resourceGroupName = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "resourceGroups");
        this.name = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "redis");
    }
    ...
    public Response<RedisAccessKeys> regenerateKeyWithResponse(RedisRegenerateKeyParameters parameters,
        Context context) {
    ...
    public Response<RedisForceRebootResponse> forceRebootWithResponse(RedisRebootParameters parameters,
        Context context) {
    ...
    public RedisResourceImpl withUpdateChannel(UpdateChannel updateChannel) {
        if (isInCreateMode()) {
            this.createParameters.withUpdateChannel(updateChannel);
            return this;
        } else {
            this.updateParameters.withUpdateChannel(updateChannel);
            return this;
        }
    }

    public RedisResourceImpl withDisableAccessKeyAuthentication(Boolean disableAccessKeyAuthentication) {
        if (isInCreateMode()) {
            this.createParameters.withDisableAccessKeyAuthentication(disableAccessKeyAuthentication);
            return this;
        } else {
            this.updateParameters.withDisableAccessKeyAuthentication(disableAccessKeyAuthentication);
            return this;
        }
    }

    public RedisResourceImpl withZonalAllocationPolicy(ZonalAllocationPolicy zonalAllocationPolicy) {
        if (isInCreateMode()) {
            this.createParameters.withZonalAllocationPolicy(zonalAllocationPolicy);
            return this;
        } else {
            this.updateParameters.withZonalAllocationPolicy(zonalAllocationPolicy);
            return this;
        }
    }
