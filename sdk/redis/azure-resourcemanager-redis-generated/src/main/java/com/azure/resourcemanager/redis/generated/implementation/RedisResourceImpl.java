...
import com.azure.resourcemanager.redis.generated.models.ZonalAllocation;
...
public final class RedisResourceImpl implements RedisResource, RedisResource.Definition, RedisResource.Update {
    ...
    public ZonalAllocation zonalAllocation() {
        return this.innerModel().zonalAllocation();
    }
    ...
    public RedisResource refresh() {
        this.innerObject = serviceManager.serviceClient().getRedis()
    ...
    public RedisResourceImpl withZonalAllocation(ZonalAllocation zonalAllocation) {
        if (isInCreateMode()) {
            this.createParameters.withZonalAllocation(zonalAllocation);
            return this;
        } else {
            this.updateParameters.withZonalAllocation(zonalAllocation);
            return this;
        }
    }
