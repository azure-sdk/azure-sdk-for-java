...
public final class Sku {
    ...
    /*
     * The SKU family to use. Valid values: (C, P). (C = Basic/Standard, P = Premium, G = General Purpose, M = Memory
     * Optimized).
     */
    ...
    /**
     * Get the name property: The type of Redis cache to deploy. Valid values: (Basic, Standard, Premium, General
    ...
    /**
     * Set the name property: The type of Redis cache to deploy. Valid values: (Basic, Standard, Premium, General
     * Purpose, Memory Optimized).
     *
    ...
    /**
     * Get the family property: The SKU family to use. Valid values: (C, P). (C = Basic/Standard, P = Premium, G =
     * General Purpose, M = Memory Optimized).
     *
    ...
    /**
     * Set the family property: The SKU family to use. Valid values: (C, P). (C = Basic/Standard, P = Premium, G =
     * General Purpose, M = Memory Optimized).
     *
