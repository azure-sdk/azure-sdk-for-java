...
public interface AccessPolicyAssignmentsClient {
    ...
    SyncPoller<PollResult<RedisCacheAccessPolicyAssignmentSetInner>, RedisCacheAccessPolicyAssignmentSetInner>
        beginCreateUpdate(
    ...
    RedisCacheAccessPolicyAssignmentSetInner createUpdate(
        String resourceGroupName,
        String cacheName,
        String accessPolicyName,
        RedisCacheAccessPolicyAssignmentSetInner parameters);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    RedisCacheAccessPolicyAssignmentSetInner delete(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<RedisCacheAccessPolicyAssignmentSetInner> getWithResponse(
        String resourceGroupName, String cacheName, String accessPolicyName, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    RedisCacheAccessPolicyAssignmentSetInner get(String resourceGroupName, String cacheName, String accessPolicyName);
    ...
    PagedIterable<RedisCacheAccessPolicyAssignmentSetInner> list(String resourceGroupName, String cacheName);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<RedisCacheAccessPolicyAssignmentSetInner> list(
