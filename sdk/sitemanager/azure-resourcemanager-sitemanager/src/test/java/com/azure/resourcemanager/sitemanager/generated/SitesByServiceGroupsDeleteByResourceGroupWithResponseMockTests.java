...
public final class SitesByServiceGroupsDeleteByResourceGroupWithResponseMockTests {
    @Test
    public void testDeleteWithResponse() throws Exception {
        ...
        manager.sitesByServiceGroups()
            .deleteByResourceGroupWithResponse("j", "odxobnbdxkqpxok", com.azure.core.util.Context.NONE);
