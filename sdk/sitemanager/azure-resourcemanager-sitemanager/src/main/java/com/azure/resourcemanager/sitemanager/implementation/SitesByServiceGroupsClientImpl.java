...
public final class SitesByServiceGroupsClientImpl implements SitesByServiceGroupsClient {
     ...
     */
    SitesByServiceGroupsClientImpl(EdgeClientImpl client) {
    ...
    /**
     * The interface defining all the services for EdgeClientSitesByServiceGroups to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "EdgeClientSitesBySer")
