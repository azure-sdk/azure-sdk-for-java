...
import com.azure.resourcemanager.cosmosdbmicrosoftdocumentdbcore.fluent.SqlResourcesClient;
import com.azure.resourcemanager.cosmosdbmicrosoftdocumentdbcore.fluent.models.BackupInformationInner;
import com.azure.resourcemanager.cosmosdbmicrosoftdocumentdbcore.fluent.models.ClientEncryptionKeyGetResultsInner;
...
import com.azure.resourcemanager.cosmosdbmicrosoftdocumentdbcore.fluent.models.PhysicalPartitionThroughputInfoResultInner;
import com.azure.resourcemanager.cosmosdbmicrosoftdocumentdbcore.fluent.models.SqlContainerGetResultsInner;
import com.azure.resourcemanager.cosmosdbmicrosoftdocumentdbcore.fluent.models.SqlDatabaseGetResultsInner;
import com.azure.resourcemanager.cosmosdbmicrosoftdocumentdbcore.fluent.models.SqlRoleAssignmentGetResultsInner;
import com.azure.resourcemanager.cosmosdbmicrosoftdocumentdbcore.fluent.models.SqlRoleDefinitionGetResultsInner;
import com.azure.resourcemanager.cosmosdbmicrosoftdocumentdbcore.fluent.models.SqlStoredProcedureGetResultsInner;
import com.azure.resourcemanager.cosmosdbmicrosoftdocumentdbcore.fluent.models.SqlTriggerGetResultsInner;
import com.azure.resourcemanager.cosmosdbmicrosoftdocumentdbcore.fluent.models.SqlUserDefinedFunctionGetResultsInner;
import com.azure.resourcemanager.cosmosdbmicrosoftdocumentdbcore.fluent.models.ThroughputSettingsGetResultsInner;
import com.azure.resourcemanager.cosmosdbmicrosoftdocumentdbcore.models.ClientEncryptionKeyCreateUpdateParameters;
import com.azure.resourcemanager.cosmosdbmicrosoftdocumentdbcore.models.ClientEncryptionKeysListResult;
...
import com.azure.resourcemanager.cosmosdbmicrosoftdocumentdbcore.models.SqlContainerCreateUpdateParameters;
import com.azure.resourcemanager.cosmosdbmicrosoftdocumentdbcore.models.SqlContainerListResult;
import com.azure.resourcemanager.cosmosdbmicrosoftdocumentdbcore.models.SqlDatabaseCreateUpdateParameters;
import com.azure.resourcemanager.cosmosdbmicrosoftdocumentdbcore.models.SqlDatabaseListResult;
import com.azure.resourcemanager.cosmosdbmicrosoftdocumentdbcore.models.SqlRoleAssignmentCreateUpdateParameters;
import com.azure.resourcemanager.cosmosdbmicrosoftdocumentdbcore.models.SqlRoleAssignmentListResult;
import com.azure.resourcemanager.cosmosdbmicrosoftdocumentdbcore.models.SqlRoleDefinitionCreateUpdateParameters;
import com.azure.resourcemanager.cosmosdbmicrosoftdocumentdbcore.models.SqlRoleDefinitionListResult;
import com.azure.resourcemanager.cosmosdbmicrosoftdocumentdbcore.models.SqlStoredProcedureCreateUpdateParameters;
import com.azure.resourcemanager.cosmosdbmicrosoftdocumentdbcore.models.SqlStoredProcedureListResult;
import com.azure.resourcemanager.cosmosdbmicrosoftdocumentdbcore.models.SqlTriggerCreateUpdateParameters;
import com.azure.resourcemanager.cosmosdbmicrosoftdocumentdbcore.models.SqlTriggerListResult;
import com.azure.resourcemanager.cosmosdbmicrosoftdocumentdbcore.models.SqlUserDefinedFunctionCreateUpdateParameters;
import com.azure.resourcemanager.cosmosdbmicrosoftdocumentdbcore.models.SqlUserDefinedFunctionListResult;
...
public final class SqlResourcesClientImpl implements SqlResourcesClient {
    ...
    public interface SqlResourcesService {
        ...
        @ExpectedResponses({200, 202})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Flux<ByteBuffer>>> sqlDatabasePartitionMerge(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("accountName") String accountName,
        ...
        @ExpectedResponses({200, 202})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Flux<ByteBuffer>>> listSqlContainerPartitionMerge(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("accountName") String accountName,
        ...
        @ExpectedResponses({200, 202})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Flux<ByteBuffer>>> sqlDatabaseRetrieveThroughputDistribution(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("accountName") String accountName,
        ...
        @ExpectedResponses({200, 202})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Flux<ByteBuffer>>> sqlDatabaseRedistributeThroughput(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("accountName") String accountName,
        ...
        @ExpectedResponses({200, 202})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Flux<ByteBuffer>>> sqlContainerRetrieveThroughputDistribution(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("accountName") String accountName,
        ...
        @ExpectedResponses({200, 202})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Flux<ByteBuffer>>> sqlContainerRedistributeThroughput(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("accountName") String accountName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ClientEncryptionKeyGetResultsInner> getClientEncryptionKeyAsync(
        String resourceGroupName, String accountName, String databaseName, String clientEncryptionKeyName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> sqlDatabasePartitionMergeWithResponseAsync(
    ...
    private PollerFlux<
        ...
        beginSqlDatabasePartitionMergeAsync(
            String resourceGroupName, String accountName, String databaseName, MergeParameters mergeParameters) {
        Mono<Response<Flux<ByteBuffer>>> mono =
    ...
    private PollerFlux<
        ...
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono =
            sqlDatabasePartitionMergeWithResponseAsync(
    ...
    public SyncPoller<
        ...
        beginSqlDatabasePartitionMerge(
            String resourceGroupName, String accountName, String databaseName, MergeParameters mergeParameters) {
        return this
            .beginSqlDatabasePartitionMergeAsync(resourceGroupName, accountName, databaseName, mergeParameters)
            .getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PhysicalPartitionStorageInfoCollectionInner> sqlDatabasePartitionMergeAsync(
        String resourceGroupName, String accountName, String databaseName, MergeParameters mergeParameters) {
    ...
    private Mono<PhysicalPartitionStorageInfoCollectionInner> sqlDatabasePartitionMergeAsync(
        ...
        MergeParameters mergeParameters,
        Context context) {
        return beginSqlDatabasePartitionMergeAsync(
                resourceGroupName, accountName, databaseName, mergeParameters, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public PhysicalPartitionStorageInfoCollectionInner sqlDatabasePartitionMerge(
        String resourceGroupName, String accountName, String databaseName, MergeParameters mergeParameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> listSqlContainerPartitionMergeWithResponseAsync(
        String resourceGroupName,
        String accountName,
        String databaseName,
        String containerName,
    ...
    private PollerFlux<
            PollResult<PhysicalPartitionStorageInfoCollectionInner>, PhysicalPartitionStorageInfoCollectionInner>
        beginListSqlContainerPartitionMergeAsync(
            String resourceGroupName,
            String accountName,
            String databaseName,
            String containerName,
            MergeParameters mergeParameters) {
        Mono<Response<Flux<ByteBuffer>>> mono =
            listSqlContainerPartitionMergeWithResponseAsync(
    ...
    private Mono<PhysicalPartitionStorageInfoCollectionInner> listSqlContainerPartitionMergeAsync(
        ...
        String containerName,
        MergeParameters mergeParameters) {
        return beginListSqlContainerPartitionMergeAsync(
                resourceGroupName, accountName, databaseName, containerName, mergeParameters)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public PhysicalPartitionStorageInfoCollectionInner listSqlContainerPartitionMerge(
        String resourceGroupName,
        String accountName,
        String databaseName,
        String containerName,
        MergeParameters mergeParameters) {
        return listSqlContainerPartitionMergeAsync(
                resourceGroupName, accountName, databaseName, containerName, mergeParameters)
            .block();
    }
    ...
    private PollerFlux<
        ...
        beginSqlDatabaseRetrieveThroughputDistributionAsync(
            String resourceGroupName,
            String accountName,
            String databaseName,
            RetrieveThroughputParameters retrieveThroughputParameters) {
        Mono<Response<Flux<ByteBuffer>>> mono =
            sqlDatabaseRetrieveThroughputDistributionWithResponseAsync(
    ...
    private Mono<PhysicalPartitionThroughputInfoResultInner> sqlDatabaseRetrieveThroughputDistributionAsync(
        ...
        String databaseName,
        RetrieveThroughputParameters retrieveThroughputParameters) {
        return beginSqlDatabaseRetrieveThroughputDistributionAsync(
                resourceGroupName, accountName, databaseName, retrieveThroughputParameters)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    public PhysicalPartitionThroughputInfoResultInner sqlDatabaseRetrieveThroughputDistribution(
        ...
        String databaseName,
        RetrieveThroughputParameters retrieveThroughputParameters) {
        return sqlDatabaseRetrieveThroughputDistributionAsync(
                resourceGroupName, accountName, databaseName, retrieveThroughputParameters)
            .block();
    }
    ...
    private PollerFlux<
            PollResult<PhysicalPartitionThroughputInfoResultInner>, PhysicalPartitionThroughputInfoResultInner>
        beginSqlDatabaseRedistributeThroughputAsync(
            String resourceGroupName,
            String accountName,
            String databaseName,
            RedistributeThroughputParameters redistributeThroughputParameters) {
        Mono<Response<Flux<ByteBuffer>>> mono =
            sqlDatabaseRedistributeThroughputWithResponseAsync(
    ...
    private Mono<PhysicalPartitionThroughputInfoResultInner> sqlDatabaseRedistributeThroughputAsync(
        ...
        String databaseName,
        RedistributeThroughputParameters redistributeThroughputParameters) {
        return beginSqlDatabaseRedistributeThroughputAsync(
                resourceGroupName, accountName, databaseName, redistributeThroughputParameters)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public PhysicalPartitionThroughputInfoResultInner sqlDatabaseRedistributeThroughput(
        String resourceGroupName,
        String accountName,
        String databaseName,
        RedistributeThroughputParameters redistributeThroughputParameters) {
        return sqlDatabaseRedistributeThroughputAsync(
                resourceGroupName, accountName, databaseName, redistributeThroughputParameters)
            .block();
    }
    ...
    private PollerFlux<
            PollResult<PhysicalPartitionThroughputInfoResultInner>, PhysicalPartitionThroughputInfoResultInner>
        beginSqlContainerRetrieveThroughputDistributionAsync(
            String resourceGroupName,
            String accountName,
            String databaseName,
            String containerName,
            RetrieveThroughputParameters retrieveThroughputParameters) {
        Mono<Response<Flux<ByteBuffer>>> mono =
            sqlContainerRetrieveThroughputDistributionWithResponseAsync(
    ...
    private Mono<PhysicalPartitionThroughputInfoResultInner> sqlContainerRetrieveThroughputDistributionAsync(
        ...
        String containerName,
        RetrieveThroughputParameters retrieveThroughputParameters) {
        return beginSqlContainerRetrieveThroughputDistributionAsync(
                resourceGroupName, accountName, databaseName, containerName, retrieveThroughputParameters)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    public PhysicalPartitionThroughputInfoResultInner sqlContainerRetrieveThroughputDistribution(
        ...
        String containerName,
        RetrieveThroughputParameters retrieveThroughputParameters) {
        return sqlContainerRetrieveThroughputDistributionAsync(
                resourceGroupName, accountName, databaseName, containerName, retrieveThroughputParameters)
            .block();
    }
    ...
    private PollerFlux<
            PollResult<PhysicalPartitionThroughputInfoResultInner>, PhysicalPartitionThroughputInfoResultInner>
        beginSqlContainerRedistributeThroughputAsync(
            String resourceGroupName,
            String accountName,
            String databaseName,
            String containerName,
            RedistributeThroughputParameters redistributeThroughputParameters) {
        Mono<Response<Flux<ByteBuffer>>> mono =
            sqlContainerRedistributeThroughputWithResponseAsync(
    ...
    private Mono<PhysicalPartitionThroughputInfoResultInner> sqlContainerRedistributeThroughputAsync(
        ...
        String containerName,
        RedistributeThroughputParameters redistributeThroughputParameters) {
        return beginSqlContainerRedistributeThroughputAsync(
                resourceGroupName, accountName, databaseName, containerName, redistributeThroughputParameters)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public PhysicalPartitionThroughputInfoResultInner sqlContainerRedistributeThroughput(
        String resourceGroupName,
        String accountName,
        String databaseName,
        String containerName,
        RedistributeThroughputParameters redistributeThroughputParameters) {
        return sqlContainerRedistributeThroughputAsync(
                resourceGroupName, accountName, databaseName, containerName, redistributeThroughputParameters)
            .block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<SqlRoleDefinitionGetResultsInner> getSqlRoleDefinitionAsync(
        String roleDefinitionId, String resourceGroupName, String accountName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<SqlRoleAssignmentGetResultsInner> getSqlRoleAssignmentAsync(
        String roleAssignmentId, String resourceGroupName, String accountName) {
