...
/** Resource collection API of RestorableGremlinDatabases. */
public interface RestorableGremlinDatabases {
    /**
     ...
     */
    PagedIterable<RestorableGremlinDatabaseGetResult> list(String location, String instanceId);
     ...
     *     response with {@link PagedIterable}.
     */
    PagedIterable<RestorableGremlinDatabaseGetResult> list(String location, String instanceId, Context context);
}
