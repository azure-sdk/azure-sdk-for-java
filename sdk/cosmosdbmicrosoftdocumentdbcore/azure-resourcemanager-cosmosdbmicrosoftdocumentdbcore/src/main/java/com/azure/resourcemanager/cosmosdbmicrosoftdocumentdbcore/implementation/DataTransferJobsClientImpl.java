...
import com.azure.resourcemanager.cosmosdbmicrosoftdocumentdbcore.models.CreateJobRequest;
import com.azure.resourcemanager.cosmosdbmicrosoftdocumentdbcore.models.DataTransferJobFeedResults;
...
public final class DataTransferJobsClientImpl implements DataTransferJobsClient {
    ...
    public interface DataTransferJobsService {
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<DataTransferJobGetResultsInner>> pause(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("accountName") String accountName,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<DataTransferJobGetResultsInner>> resume(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("accountName") String accountName,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<DataTransferJobGetResultsInner>> cancel(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("accountName") String accountName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<DataTransferJobGetResultsInner>> pauseWithResponseAsync(
        String resourceGroupName, String accountName, String jobName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DataTransferJobGetResultsInner> pauseAsync(
        String resourceGroupName, String accountName, String jobName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<DataTransferJobGetResultsInner> pauseWithResponse(
        String resourceGroupName, String accountName, String jobName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<DataTransferJobGetResultsInner>> resumeWithResponseAsync(
        String resourceGroupName, String accountName, String jobName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DataTransferJobGetResultsInner> resumeAsync(
        String resourceGroupName, String accountName, String jobName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<DataTransferJobGetResultsInner> resumeWithResponse(
        String resourceGroupName, String accountName, String jobName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<DataTransferJobGetResultsInner>> cancelWithResponseAsync(
        String resourceGroupName, String accountName, String jobName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DataTransferJobGetResultsInner> cancelAsync(
        String resourceGroupName, String accountName, String jobName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<DataTransferJobGetResultsInner> cancelWithResponse(
        String resourceGroupName, String accountName, String jobName, Context context) {
