...
import com.azure.resourcemanager.cosmosdbmicrosoftdocumentdbcore.models.TableListResult;
...
public final class TableResourcesClientImpl implements TableResourcesClient {
     ...
     * @return the List operation response, that contains the Table and their properties along with {@link
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<TableGetResultsInner> getTableAsync(String resourceGroupName, String accountName, String tableName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ThroughputSettingsGetResultsInner> getTableThroughputAsync(
        String resourceGroupName, String accountName, String tableName) {
