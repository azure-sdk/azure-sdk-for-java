...
/** Resource collection API of DatabaseAccountRegions. */
public interface DatabaseAccountRegions {
    /**
     ...
     */
    PagedIterable<Metric> listMetrics(String resourceGroupName, String accountName, String region, String filter);
