...
import com.azure.resourcemanager.cosmosdbmicrosoftdocumentdbcore.fluent.models.DatabaseAccountGetResultsInner;
import com.azure.resourcemanager.cosmosdbmicrosoftdocumentdbcore.fluent.models.PrivateEndpointConnectionInner;
...
import com.azure.resourcemanager.cosmosdbmicrosoftdocumentdbcore.models.BackupPolicy;
import com.azure.resourcemanager.cosmosdbmicrosoftdocumentdbcore.models.Capability;
import com.azure.resourcemanager.cosmosdbmicrosoftdocumentdbcore.models.Capacity;
import com.azure.resourcemanager.cosmosdbmicrosoftdocumentdbcore.models.ConnectorOffer;
...
import com.azure.resourcemanager.cosmosdbmicrosoftdocumentdbcore.models.DatabaseAccountCreateUpdateParameters;
import com.azure.resourcemanager.cosmosdbmicrosoftdocumentdbcore.models.DatabaseAccountGetResults;
import com.azure.resourcemanager.cosmosdbmicrosoftdocumentdbcore.models.DatabaseAccountKeysMetadata;
...
import com.azure.resourcemanager.cosmosdbmicrosoftdocumentdbcore.models.DatabaseAccountOfferType;
import com.azure.resourcemanager.cosmosdbmicrosoftdocumentdbcore.models.DatabaseAccountRegenerateKeyParameters;
import com.azure.resourcemanager.cosmosdbmicrosoftdocumentdbcore.models.DatabaseAccountUpdateParameters;
...
import com.azure.resourcemanager.cosmosdbmicrosoftdocumentdbcore.models.PrivateEndpointConnection;
...
public final class DatabaseAccountGetResultsImpl
    ...
    public DatabaseAccountKeysMetadata keysMetadata() {
        return this.innerModel().keysMetadata();
    }

    public Boolean enablePartitionMerge() {
        return this.innerModel().enablePartitionMerge();
    }

    public Boolean enableBurstCapacity() {
        return this.innerModel().enableBurstCapacity();
    }
    ...
    DatabaseAccountGetResultsImpl(
        String name, com.azure.resourcemanager.cosmosdbmicrosoftdocumentdbcore.CosmosDBManager serviceManager) {
    ...
    public DatabaseAccountGetResultsImpl withEnablePartitionMerge(Boolean enablePartitionMerge) {
        if (isInCreateMode()) {
            this.createCreateUpdateParameters.withEnablePartitionMerge(enablePartitionMerge);
            return this;
        } else {
            this.updateUpdateParameters.withEnablePartitionMerge(enablePartitionMerge);
            return this;
        }
    }

    public DatabaseAccountGetResultsImpl withEnableBurstCapacity(Boolean enableBurstCapacity) {
        if (isInCreateMode()) {
            this.createCreateUpdateParameters.withEnableBurstCapacity(enableBurstCapacity);
            return this;
        } else {
            this.updateUpdateParameters.withEnableBurstCapacity(enableBurstCapacity);
            return this;
        }
    }

    public DatabaseAccountGetResultsImpl withMinimalTlsVersion(MinimalTlsVersion minimalTlsVersion) {
        if (isInCreateMode()) {
            this.createCreateUpdateParameters.withMinimalTlsVersion(minimalTlsVersion);
            return this;
        } else {
            this.updateUpdateParameters.withMinimalTlsVersion(minimalTlsVersion);
            return this;
        }
    }
