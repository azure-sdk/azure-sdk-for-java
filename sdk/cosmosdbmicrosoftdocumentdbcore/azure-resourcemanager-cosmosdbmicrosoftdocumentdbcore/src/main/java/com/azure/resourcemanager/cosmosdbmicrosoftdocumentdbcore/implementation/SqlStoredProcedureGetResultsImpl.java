...
import com.azure.resourcemanager.cosmosdbmicrosoftdocumentdbcore.models.SqlStoredProcedureGetPropertiesResource;
...
public final class SqlStoredProcedureGetResultsImpl
    ...
    SqlStoredProcedureGetResultsImpl(
    ...
    SqlStoredProcedureGetResultsImpl(
        SqlStoredProcedureGetResultsInner innerObject,
    ...
    public SqlStoredProcedureGetResultsImpl withIdentity(ManagedServiceIdentity identity) {
        if (isInCreateMode()) {
            this.createCreateUpdateSqlStoredProcedureParameters.withIdentity(identity);
            return this;
        } else {
            this.updateCreateUpdateSqlStoredProcedureParameters.withIdentity(identity);
            return this;
        }
    }
