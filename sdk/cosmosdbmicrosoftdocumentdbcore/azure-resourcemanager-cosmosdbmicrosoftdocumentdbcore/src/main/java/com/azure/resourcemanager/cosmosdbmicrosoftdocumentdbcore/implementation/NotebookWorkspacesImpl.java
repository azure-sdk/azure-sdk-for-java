...
import com.azure.resourcemanager.cosmosdbmicrosoftdocumentdbcore.fluent.models.NotebookWorkspaceInner;
import com.azure.resourcemanager.cosmosdbmicrosoftdocumentdbcore.models.NotebookWorkspace;
...
public final class NotebookWorkspacesImpl implements NotebookWorkspaces {
    ...
    public NotebookWorkspace getById(String id) {
        ...
        String notebookWorkspaceNameLocal = Utils.getValueFromIdByName(id, "notebookWorkspaces");
        if (notebookWorkspaceNameLocal == null) {
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException(
                        String
        ...
        NotebookWorkspaceName notebookWorkspaceName = NotebookWorkspaceName.fromString(notebookWorkspaceNameLocal);
