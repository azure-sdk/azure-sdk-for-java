...
public interface SqlDatabaseGetResults {
    ...
    /**
     * Gets the inner com.azure.resourcemanager.cosmosdbmicrosoftdocumentdbcore.fluent.models.SqlDatabaseGetResultsInner
     * object.
     *
     ...
     */
    PhysicalPartitionStorageInfoCollection sqlDatabasePartitionMerge(MergeParameters mergeParameters);
     ...
     * @return list of physical partitions and their properties returned by a merge operation.
     */
    PhysicalPartitionStorageInfoCollection sqlDatabasePartitionMerge(MergeParameters mergeParameters, Context context);
}
