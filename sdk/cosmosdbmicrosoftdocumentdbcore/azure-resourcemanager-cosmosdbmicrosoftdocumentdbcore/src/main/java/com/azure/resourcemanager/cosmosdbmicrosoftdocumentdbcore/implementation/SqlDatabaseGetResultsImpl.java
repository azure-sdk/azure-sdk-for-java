...
import com.azure.resourcemanager.cosmosdbmicrosoftdocumentdbcore.models.SqlDatabaseGetPropertiesOptions;
import com.azure.resourcemanager.cosmosdbmicrosoftdocumentdbcore.models.SqlDatabaseGetPropertiesResource;
...
public final class SqlDatabaseGetResultsImpl
    ...
    SqlDatabaseGetResultsImpl(
        SqlDatabaseGetResultsInner innerObject,
    ...
    public PhysicalPartitionStorageInfoCollection sqlDatabasePartitionMerge(MergeParameters mergeParameters) {
    ...
    public SqlDatabaseGetResultsImpl withIdentity(ManagedServiceIdentity identity) {
        if (isInCreateMode()) {
            this.createCreateUpdateSqlDatabaseParameters.withIdentity(identity);
            return this;
        } else {
            this.updateCreateUpdateSqlDatabaseParameters.withIdentity(identity);
            return this;
        }
    }
