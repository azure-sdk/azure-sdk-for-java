...
public interface MongoDBResourcesClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    PhysicalPartitionThroughputInfoResultInner mongoDBDatabaseRedistributeThroughput(
        String resourceGroupName,
        String accountName,
        String databaseName,
        RedistributeThroughputParameters redistributeThroughputParameters);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    PhysicalPartitionThroughputInfoResultInner mongoDBContainerRetrieveThroughputDistribution(
        String resourceGroupName,
        String accountName,
        String databaseName,
        String collectionName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    PhysicalPartitionThroughputInfoResultInner mongoDBContainerRedistributeThroughput(
        String resourceGroupName,
        String accountName,
        String databaseName,
        String collectionName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    PhysicalPartitionStorageInfoCollectionInner mongoDBDatabasePartitionMerge(
        String resourceGroupName, String accountName, String databaseName, MergeParameters mergeParameters);
