...
import com.azure.resourcemanager.cosmosdbmicrosoftdocumentdbcore.models.GremlinDatabaseCreateUpdateParameters;
import com.azure.resourcemanager.cosmosdbmicrosoftdocumentdbcore.models.GremlinDatabaseGetPropertiesOptions;
import com.azure.resourcemanager.cosmosdbmicrosoftdocumentdbcore.models.GremlinDatabaseGetPropertiesResource;
...
public final class GremlinDatabaseGetResultsImpl
    ...
    public GremlinDatabaseGetResultsImpl withIdentity(ManagedServiceIdentity identity) {
        if (isInCreateMode()) {
            this.createCreateUpdateGremlinDatabaseParameters.withIdentity(identity);
            return this;
        } else {
            this.updateCreateUpdateGremlinDatabaseParameters.withIdentity(identity);
            return this;
        }
    }
