...
import com.azure.resourcemanager.cosmosdbmicrosoftdocumentdbcore.models.FirewallRuleListResult;
import com.azure.resourcemanager.cosmosdbmicrosoftdocumentdbcore.models.MongoClusterListResult;
...
public final class MongoClustersClientImpl implements MongoClustersClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<FirewallRuleInner> getFirewallRuleAsync(
        String resourceGroupName, String mongoClusterName, String firewallRuleName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ListConnectionStringsResultInner> listConnectionStringsAsync(
        String resourceGroupName, String mongoClusterName) {
