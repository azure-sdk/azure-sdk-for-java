...
import com.azure.resourcemanager.cosmosdbmicrosoftdocumentdbcore.models.RestorableDatabaseAccountsListResult;
...
public final class RestorableDatabaseAccountsClientImpl implements RestorableDatabaseAccountsClient {
    ...
    private PagedFlux<RestorableDatabaseAccountGetResultInner> listByLocationAsync(String location) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<RestorableDatabaseAccountGetResultInner> listAsync() {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<RestorableDatabaseAccountGetResultInner> getByLocationAsync(String location, String instanceId) {
