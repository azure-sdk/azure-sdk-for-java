...
import com.azure.resourcemanager.cosmosdbmicrosoftdocumentdbcore.models.LocationListResult;
...
public final class LocationsClientImpl implements LocationsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<LocationGetResultInner>> getWithResponseAsync(String location) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<LocationGetResultInner> getAsync(String location) {
