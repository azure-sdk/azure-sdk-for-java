...
import com.azure.resourcemanager.cosmosdbmicrosoftdocumentdbcore.models.MongoClusterStatus;
import com.azure.resourcemanager.cosmosdbmicrosoftdocumentdbcore.models.MongoClusterUpdate;
import com.azure.resourcemanager.cosmosdbmicrosoftdocumentdbcore.models.NodeGroupSpec;
import com.azure.resourcemanager.cosmosdbmicrosoftdocumentdbcore.models.ProvisioningState;
    ...
    public MongoCluster apply() {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getMongoClusters()
                .update(resourceGroupName, mongoClusterName, updateParameters, Context.NONE);
        return this;
    }
    ...
    public MongoCluster apply(Context context) {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getMongoClusters()
                .update(resourceGroupName, mongoClusterName, updateParameters, context);
        return this;
    }

    MongoClusterImpl(
        MongoClusterInner innerObject,
