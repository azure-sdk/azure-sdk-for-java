...
import com.azure.resourcemanager.cosmosdbmicrosoftdocumentdbcore.fluent.models.RestorableGremlinResourcesGetResultInner;
import com.azure.resourcemanager.cosmosdbmicrosoftdocumentdbcore.models.RestorableGremlinResourcesListResult;
...
public final class RestorableGremlinResourcesClientImpl implements RestorableGremlinResourcesClient {
    ...
    public interface RestorableGremlinResourcesService {
    ...
    private Mono<PagedResponse<RestorableGremlinResourcesGetResultInner>> listSinglePageAsync(
                ...
                context ->
                    service
                        .list(
                            ...
                            accept,
                            context))
            .<PagedResponse<RestorableGremlinResourcesGetResultInner>>map(
                res ->
    ...
    private PagedFlux<RestorableGremlinResourcesGetResultInner> listAsync(
        String location, String instanceId, String restoreLocation, String restoreTimestampInUtc) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<RestorableGremlinResourcesGetResultInner> listAsync(String location, String instanceId) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<RestorableGremlinResourcesGetResultInner> list(
        String location, String instanceId, String restoreLocation, String restoreTimestampInUtc, Context context) {
