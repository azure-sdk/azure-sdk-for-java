...
import com.azure.resourcemanager.cosmosdbmicrosoftdocumentdbcore.fluent.models.DataTransferJobGetResultsInner;
import com.azure.resourcemanager.cosmosdbmicrosoftdocumentdbcore.models.DataTransferJobGetResults;
...
public final class DataTransferJobsImpl implements DataTransferJobs {
    ...
    public DataTransferJobsImpl(
        DataTransferJobsClient innerClient,
    ...
    public Response<DataTransferJobGetResults> pauseWithResponse(
        String resourceGroupName, String accountName, String jobName, Context context) {
        Response<DataTransferJobGetResultsInner> inner =
    ...
    public DataTransferJobGetResults pause(String resourceGroupName, String accountName, String jobName) {
        DataTransferJobGetResultsInner inner = this.serviceClient().pause(resourceGroupName, accountName, jobName);
        if (inner != null) {
            return new DataTransferJobGetResultsImpl(inner, this.manager());
        } else {
            return null;
    ...
    public Response<DataTransferJobGetResults> resumeWithResponse(
        String resourceGroupName, String accountName, String jobName, Context context) {
        Response<DataTransferJobGetResultsInner> inner =
    ...
    public DataTransferJobGetResults resume(String resourceGroupName, String accountName, String jobName) {
        DataTransferJobGetResultsInner inner = this.serviceClient().resume(resourceGroupName, accountName, jobName);
        if (inner != null) {
            return new DataTransferJobGetResultsImpl(inner, this.manager());
        } else {
            return null;
    ...
    public Response<DataTransferJobGetResults> cancelWithResponse(
        String resourceGroupName, String accountName, String jobName, Context context) {
        Response<DataTransferJobGetResultsInner> inner =
    ...
    public DataTransferJobGetResults cancel(String resourceGroupName, String accountName, String jobName) {
        DataTransferJobGetResultsInner inner = this.serviceClient().cancel(resourceGroupName, accountName, jobName);
        if (inner != null) {
            return new DataTransferJobGetResultsImpl(inner, this.manager());
        } else {
            return null;
