...
import com.azure.resourcemanager.cosmosdbmicrosoftdocumentdbcore.fluent.CassandraResourcesClient;
import com.azure.resourcemanager.cosmosdbmicrosoftdocumentdbcore.fluent.models.CassandraKeyspaceGetResultsInner;
import com.azure.resourcemanager.cosmosdbmicrosoftdocumentdbcore.fluent.models.CassandraTableGetResultsInner;
import com.azure.resourcemanager.cosmosdbmicrosoftdocumentdbcore.fluent.models.CassandraViewGetResultsInner;
import com.azure.resourcemanager.cosmosdbmicrosoftdocumentdbcore.fluent.models.ThroughputSettingsGetResultsInner;
import com.azure.resourcemanager.cosmosdbmicrosoftdocumentdbcore.models.CassandraKeyspaceCreateUpdateParameters;
import com.azure.resourcemanager.cosmosdbmicrosoftdocumentdbcore.models.CassandraKeyspaceListResult;
import com.azure.resourcemanager.cosmosdbmicrosoftdocumentdbcore.models.CassandraTableCreateUpdateParameters;
import com.azure.resourcemanager.cosmosdbmicrosoftdocumentdbcore.models.CassandraTableListResult;
import com.azure.resourcemanager.cosmosdbmicrosoftdocumentdbcore.models.CassandraViewCreateUpdateParameters;
import com.azure.resourcemanager.cosmosdbmicrosoftdocumentdbcore.models.CassandraViewListResult;
...
public final class CassandraResourcesClientImpl implements CassandraResourcesClient {
    ...
    public interface CassandraResourcesService {
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<CassandraViewListResult>> listCassandraViews(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("accountName") String accountName,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<CassandraViewGetResultsInner>> getCassandraView(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("accountName") String accountName,
        ...
        @ExpectedResponses({200, 202})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Flux<ByteBuffer>>> createUpdateCassandraView(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("accountName") String accountName,
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Flux<ByteBuffer>>> deleteCassandraView(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("accountName") String accountName,
        ...
        @ExpectedResponses({200, 202})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Flux<ByteBuffer>>> updateCassandraViewThroughput(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("accountName") String accountName,
        ...
        @ExpectedResponses({200, 202})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Flux<ByteBuffer>>> migrateCassandraViewToAutoscale(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("accountName") String accountName,
        ...
        @ExpectedResponses({200, 202})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Flux<ByteBuffer>>> migrateCassandraViewToManualThroughput(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("accountName") String accountName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<CassandraKeyspaceGetResultsInner> getCassandraKeyspaceAsync(
        String resourceGroupName, String accountName, String keyspaceName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ThroughputSettingsGetResultsInner> getCassandraKeyspaceThroughputAsync(
        String resourceGroupName, String accountName, String keyspaceName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<CassandraTableGetResultsInner> getCassandraTableAsync(
        String resourceGroupName, String accountName, String keyspaceName, String tableName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ThroughputSettingsGetResultsInner> getCassandraTableThroughputAsync(
        String resourceGroupName, String accountName, String keyspaceName, String tableName) {
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the List operation response, that contains the Cassandra views and their properties along with {@link
     *     PagedResponse} on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
                ...
                context ->
                    service
                        .listCassandraViews(
                            ...
                            accept,
                            context))
            .<PagedResponse<CassandraViewGetResultsInner>>map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(), res.getStatusCode(), res.getHeaders(), res.getValue().value(), null, null))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<CassandraViewGetResultsInner> listCassandraViewsAsync(
        String resourceGroupName, String accountName, String keyspaceName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<CassandraViewGetResultsInner> listCassandraViews(
        String resourceGroupName, String accountName, String keyspaceName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<CassandraViewGetResultsInner>> getCassandraViewWithResponseAsync(
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the Cassandra view under an existing Azure Cosmos DB database account on successful completion of {@link
     *     Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<CassandraViewGetResultsInner> getCassandraViewAsync(
        String resourceGroupName, String accountName, String keyspaceName, String viewName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<CassandraViewGetResultsInner> getCassandraViewWithResponse(
        String resourceGroupName, String accountName, String keyspaceName, String viewName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public CassandraViewGetResultsInner getCassandraView(
        String resourceGroupName, String accountName, String keyspaceName, String viewName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> createUpdateCassandraViewWithResponseAsync(
        String resourceGroupName,
        String accountName,
        String keyspaceName,
        String viewName,
    ...
    private PollerFlux<PollResult<CassandraViewGetResultsInner>, CassandraViewGetResultsInner>
        beginCreateUpdateCassandraViewAsync(
            ...
            CassandraViewCreateUpdateParameters createUpdateCassandraViewParameters) {
        Mono<Response<Flux<ByteBuffer>>> mono =
            createUpdateCassandraViewWithResponseAsync(
                resourceGroupName, accountName, keyspaceName, viewName, createUpdateCassandraViewParameters);
        return this
            .client
            .<CassandraViewGetResultsInner, CassandraViewGetResultsInner>getLroResult(
                mono,
                this.client.getHttpPipeline(),
                CassandraViewGetResultsInner.class,
                CassandraViewGetResultsInner.class,
                this.client.getContext());
    }
    ...
    private PollerFlux<PollResult<CassandraViewGetResultsInner>, CassandraViewGetResultsInner>
        ...
        Mono<Response<Flux<ByteBuffer>>> mono =
            createUpdateCassandraViewWithResponseAsync(
                resourceGroupName, accountName, keyspaceName, viewName, createUpdateCassandraViewParameters, context);
        return this
            .client
            .<CassandraViewGetResultsInner, CassandraViewGetResultsInner>getLroResult(
                mono,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<CassandraViewGetResultsInner> createUpdateCassandraViewAsync(
        String resourceGroupName,
        String accountName,
        String keyspaceName,
        String viewName,
        CassandraViewCreateUpdateParameters createUpdateCassandraViewParameters) {
        return beginCreateUpdateCassandraViewAsync(
                resourceGroupName, accountName, keyspaceName, viewName, createUpdateCassandraViewParameters)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public CassandraViewGetResultsInner createUpdateCassandraView(
        String resourceGroupName,
        String accountName,
        String keyspaceName,
        String viewName,
        CassandraViewCreateUpdateParameters createUpdateCassandraViewParameters) {
        return createUpdateCassandraViewAsync(
                resourceGroupName, accountName, keyspaceName, viewName, createUpdateCassandraViewParameters)
            .block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> deleteCassandraViewWithResponseAsync(
        String resourceGroupName, String accountName, String keyspaceName, String viewName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<Void>, Void> beginDeleteCassandraViewAsync(
        String resourceGroupName, String accountName, String keyspaceName, String viewName) {
        Mono<Response<Flux<ByteBuffer>>> mono =
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<Void>, Void> beginDeleteCassandraView(
        String resourceGroupName, String accountName, String keyspaceName, String viewName) {
        return this
            .beginDeleteCassandraViewAsync(resourceGroupName, accountName, keyspaceName, viewName)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDeleteCassandraView(
        String resourceGroupName, String accountName, String keyspaceName, String viewName, Context context) {
        return this
            .beginDeleteCassandraViewAsync(resourceGroupName, accountName, keyspaceName, viewName, context)
            .getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> deleteCassandraViewAsync(
        String resourceGroupName, String accountName, String keyspaceName, String viewName) {
        return beginDeleteCassandraViewAsync(resourceGroupName, accountName, keyspaceName, viewName)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<Void> deleteCassandraViewAsync(
        String resourceGroupName, String accountName, String keyspaceName, String viewName, Context context) {
        return beginDeleteCassandraViewAsync(resourceGroupName, accountName, keyspaceName, viewName, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ThroughputSettingsGetResultsInner> getCassandraViewThroughputAsync(
        String resourceGroupName, String accountName, String keyspaceName, String viewName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ThroughputSettingsGetResultsInner> getCassandraViewThroughputWithResponse(
        String resourceGroupName, String accountName, String keyspaceName, String viewName, Context context) {
        return getCassandraViewThroughputWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ThroughputSettingsGetResultsInner getCassandraViewThroughput(
        String resourceGroupName, String accountName, String keyspaceName, String viewName) {
        return getCassandraViewThroughputWithResponse(
                resourceGroupName, accountName, keyspaceName, viewName, Context.NONE)
            .getValue();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> updateCassandraViewThroughputWithResponseAsync(
        String resourceGroupName,
        String accountName,
        String keyspaceName,
        String viewName,
    ...
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<ThroughputSettingsGetResultsInner>, ThroughputSettingsGetResultsInner>
        beginUpdateCassandraViewThroughputAsync(
            String resourceGroupName,
            String accountName,
            String keyspaceName,
            String viewName,
            ThroughputSettingsUpdateParameters updateThroughputParameters) {
        Mono<Response<Flux<ByteBuffer>>> mono =
            updateCassandraViewThroughputWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ThroughputSettingsGetResultsInner> updateCassandraViewThroughputAsync(
        String resourceGroupName,
        String accountName,
        String keyspaceName,
        String viewName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ThroughputSettingsGetResultsInner updateCassandraViewThroughput(
        String resourceGroupName,
        String accountName,
        String keyspaceName,
        String viewName,
        ThroughputSettingsUpdateParameters updateThroughputParameters) {
        return updateCassandraViewThroughputAsync(
                resourceGroupName, accountName, keyspaceName, viewName, updateThroughputParameters)
            .block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> migrateCassandraViewToAutoscaleWithResponseAsync(
        String resourceGroupName, String accountName, String keyspaceName, String viewName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
    ...
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<ThroughputSettingsGetResultsInner>, ThroughputSettingsGetResultsInner>
        beginMigrateCassandraViewToAutoscaleAsync(
            String resourceGroupName, String accountName, String keyspaceName, String viewName) {
        Mono<Response<Flux<ByteBuffer>>> mono =
    ...
    private PollerFlux<PollResult<ThroughputSettingsGetResultsInner>, ThroughputSettingsGetResultsInner>
        ...
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono =
            migrateCassandraViewToAutoscaleWithResponseAsync(
                resourceGroupName, accountName, keyspaceName, viewName, context);
        return this
            .client
            .<ThroughputSettingsGetResultsInner, ThroughputSettingsGetResultsInner>getLroResult(
    ...
    public SyncPoller<PollResult<ThroughputSettingsGetResultsInner>, ThroughputSettingsGetResultsInner>
        beginMigrateCassandraViewToAutoscale(
            String resourceGroupName, String accountName, String keyspaceName, String viewName) {
        return this
            .beginMigrateCassandraViewToAutoscaleAsync(resourceGroupName, accountName, keyspaceName, viewName)
            .getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ThroughputSettingsGetResultsInner> migrateCassandraViewToAutoscaleAsync(
        String resourceGroupName, String accountName, String keyspaceName, String viewName) {
    ...
    private Mono<ThroughputSettingsGetResultsInner> migrateCassandraViewToAutoscaleAsync(
        String resourceGroupName, String accountName, String keyspaceName, String viewName, Context context) {
        return beginMigrateCassandraViewToAutoscaleAsync(
                resourceGroupName, accountName, keyspaceName, viewName, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ThroughputSettingsGetResultsInner migrateCassandraViewToAutoscale(
        String resourceGroupName, String accountName, String keyspaceName, String viewName) {
    ...
    private PollerFlux<PollResult<ThroughputSettingsGetResultsInner>, ThroughputSettingsGetResultsInner>
        beginMigrateCassandraViewToManualThroughputAsync(
            String resourceGroupName, String accountName, String keyspaceName, String viewName) {
        Mono<Response<Flux<ByteBuffer>>> mono =
            migrateCassandraViewToManualThroughputWithResponseAsync(
    ...
    private Mono<ThroughputSettingsGetResultsInner> migrateCassandraViewToManualThroughputAsync(
        String resourceGroupName, String accountName, String keyspaceName, String viewName, Context context) {
        return beginMigrateCassandraViewToManualThroughputAsync(
                resourceGroupName, accountName, keyspaceName, viewName, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ThroughputSettingsGetResultsInner migrateCassandraViewToManualThroughput(
        String resourceGroupName, String accountName, String keyspaceName, String viewName) {
    ...
    public ThroughputSettingsGetResultsInner migrateCassandraViewToManualThroughput(
        String resourceGroupName, String accountName, String keyspaceName, String viewName, Context context) {
        return migrateCassandraViewToManualThroughputAsync(
                resourceGroupName, accountName, keyspaceName, viewName, context)
            .block();
    }
}
