...
public final class ManagedServiceIdentityTests {
    ...
    public void testDeserialize() throws Exception {
        ManagedServiceIdentity model = BinaryData.fromString(
            "{\"principalId\":\"aoyfhrtxilnerkuj\",\"tenantId\":\"vlejuvfqa\",\"type\":\"SystemAssigned,UserAssigned\",\"userAssignedIdentities\":{\"nruj\":{\"clientId\":\"wjkcp\",\"principalId\":\"nwbxgjvtbvpyssz\"},\"uckyf\":{\"clientId\":\"uhmuouqfprwzwbn\",\"principalId\":\"itnwuizgazxufi\"}}}")
    ...
    public void testSerialize() throws Exception {
        ManagedServiceIdentity model = new ManagedServiceIdentity()
            ...
            .withUserAssignedIdentities(mapOf("nruj", new UserAssignedIdentity(), "uckyf", new UserAssignedIdentity()));
