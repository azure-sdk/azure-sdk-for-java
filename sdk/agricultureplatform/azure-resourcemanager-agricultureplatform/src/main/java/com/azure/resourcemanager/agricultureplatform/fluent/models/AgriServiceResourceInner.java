...
public final class AgriServiceResourceInner extends Resource {
     ...
     */
    private AgriServiceResourceProperties innerProperties;
     ...
     */
    @Override
    public AgriServiceResourceInner withTags(Map<String, String> tags) {
        super.withTags(tags);
        return this;
    }
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("id".equals(fieldName)) {
                    ...
                    deserializedAgriServiceResourceInner.innerProperties
                        = AgriServiceResourceProperties.fromJson(reader);
