...
- [GetByAccountIdByDepartmentId](#enrollmentaccounts_getbyaccountidbydepartmentid)
- [ListByBillingAccount](#enrollmentaccounts_listbybillingaccount)
- [ListByDepartmentName](#enrollmentaccounts_listbydepartmentname)
...
public final class EnrollmentAccountsGetSamples {
    /*
     * x-ms-original-file: specification/billing/resource-manager/Microsoft.Billing/stable/2023-04-01/examples/enrollmentAccountGet.json
     */
    /**
...
### EnrollmentAccounts_GetByAccountIdByDepartmentId
...
public final class EnrollmentAccountsListByBillingAccountSamples {
    /*
     * x-ms-original-file: specification/billing/resource-manager/Microsoft.Billing/stable/2023-04-01/examples/enrollmentAccountsListByBillingAccount.json
     */
    /**
     ...
     * @param manager Entry point to BillingManager.
     */
    public static void enrollmentAccountsListByBillingAccount(
        com.azure.resourcemanager.billing.BillingManager manager) {
        manager
            .enrollmentAccounts()
...
```java
/** Samples for EnrollmentAccounts ListByDepartmentName. */
public final class EnrollmentAccountsListByDepartmentNameSamples {
    /*
     * x-ms-original-file: specification/billing/resource-manager/Microsoft.Billing/stable/2023-04-01/examples/enrollmentAccountsListByDepartment.json
     */
    /**
    ...
    public static void enrollmentAccountsListByDepartment(com.azure.resourcemanager.billing.BillingManager manager) {
        manager
            ...
            .listByDepartmentName(
                "6564892", "164821", null, null, null, null, null, null, com.azure.core.util.Context.NONE);
    }
}
```
...
public final class RecipientTransfersAcceptSamples {
    /*
     * x-ms-original-file: specification/billing/resource-manager/Microsoft.Billing/stable/2023-04-01/examples/AcceptTransfer.json
     */
    /**
                ...
                new AcceptTransferRequest()
                    .withProductDetails(
                        Arrays
                            .asList(
                                new ProductDetails()
                                    .withProductType(ProductType.AZURE_SUBSCRIPTION)
                                    .withProductId("subscriptionId"),
                                new ProductDetails()
                                    .withProductType(ProductType.AZURE_RESERVATION)
...
public final class RecipientTransfersListSamples {
    /*
     * x-ms-original-file: specification/billing/resource-manager/Microsoft.Billing/stable/2023-04-01/examples/ListRecipientTransfers.json
     */
    /**
...
public final class RecipientTransfersValidateSamples {
    /*
     * x-ms-original-file: specification/billing/resource-manager/Microsoft.Billing/stable/2023-04-01/examples/ValidateTransfer.json
     */
    /**
...
public final class TransfersListSamples {
    /*
     * x-ms-original-file: specification/billing/resource-manager/Microsoft.Billing/stable/2023-04-01/examples/ListTransfers.json
     */
    /**
     * Sample code: TransfersList.
     *
