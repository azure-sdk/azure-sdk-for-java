...
public final class BillingRoleDefinitionGetByDepartmentSamples {
    /*
     * x-ms-original-file: specification/billing/resource-manager/Microsoft.Billing/stable/2023-04-01/examples/billingRoleDefinitionGetByDepartment.json
     */
    /**
    ...
    public static void billingRoleDefinitionGetByDepartment(com.azure.resourcemanager.billing.BillingManager manager) {
        manager
            ...
            .getByDepartmentWithResponse(
                "123456", "7368531", "50000000-aaaa-bbbb-cccc-100000000000", com.azure.core.util.Context.NONE);
    }
}
