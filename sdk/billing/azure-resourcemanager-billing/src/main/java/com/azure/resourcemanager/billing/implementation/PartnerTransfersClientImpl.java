...
public final class PartnerTransfersClientImpl implements PartnerTransfersClient {
    ...
    public interface PartnerTransfersService {
        ...
        Mono<Response<PartnerTransferDetailsInner>> get(
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<PartnerTransferDetailsInner>> initiate(
            @HostParam("$host") String endpoint,
            @PathParam("billingAccountName") String billingAccountName,
            @PathParam("billingProfileName") String billingProfileName,
            @PathParam("customerName") String customerName,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<PartnerTransferDetailsInner>> cancel(
            @HostParam("$host") String endpoint,
            @PathParam("billingAccountName") String billingAccountName,
            @PathParam("billingProfileName") String billingProfileName,
            @PathParam("customerName") String customerName,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<PartnerTransferDetailsListResult>> list(
            @HostParam("$host") String endpoint,
            @PathParam("billingAccountName") String billingAccountName,
            @PathParam("billingProfileName") String billingProfileName,
            @PathParam("customerName") String customerName,
    ...
    private Mono<Response<PartnerTransferDetailsInner>> getWithResponseAsync(
        String billingAccountName, String billingProfileName, String customerName, String transferName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PartnerTransferDetailsInner> getAsync(
        String billingAccountName, String billingProfileName, String customerName, String transferName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<PartnerTransferDetailsInner> getWithResponse(
        String billingAccountName,
        String billingProfileName,
        String customerName,
        String transferName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public PartnerTransferDetailsInner get(
        String billingAccountName, String billingProfileName, String customerName, String transferName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<PartnerTransferDetailsInner>> initiateWithResponseAsync(
        String billingAccountName,
        String billingProfileName,
        String customerName,
        String transferName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PartnerTransferDetailsInner> initiateAsync(
        String billingAccountName,
        String billingProfileName,
        String customerName,
        String transferName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<PartnerTransferDetailsInner> initiateWithResponse(
        String billingAccountName,
        String billingProfileName,
        String customerName,
        String transferName,
        ...
        return initiateWithResponseAsync(
                billingAccountName, billingProfileName, customerName, transferName, parameters, context)
            .block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public PartnerTransferDetailsInner initiate(
        String billingAccountName,
        String billingProfileName,
        String customerName,
        String transferName,
        ...
        return initiateWithResponse(
                billingAccountName, billingProfileName, customerName, transferName, parameters, Context.NONE)
            .getValue();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<PartnerTransferDetailsInner>> cancelWithResponseAsync(
        String billingAccountName, String billingProfileName, String customerName, String transferName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PartnerTransferDetailsInner> cancelAsync(
        String billingAccountName, String billingProfileName, String customerName, String transferName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<PartnerTransferDetailsInner> cancelWithResponse(
        String billingAccountName,
        String billingProfileName,
        String customerName,
        String transferName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public PartnerTransferDetailsInner cancel(
        String billingAccountName, String billingProfileName, String customerName, String transferName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<PartnerTransferDetailsInner>> listSinglePageAsync(
                ...
                context ->
                    service
                        .list(
                            ...
                            accept,
                            context))
            .<PagedResponse<PartnerTransferDetailsInner>>map(
                res ->
    ...
    private PagedFlux<PartnerTransferDetailsInner> listAsync(
        String billingAccountName, String billingProfileName, String customerName) {
    ...
    private PagedFlux<PartnerTransferDetailsInner> listAsync(
        String billingAccountName, String billingProfileName, String customerName, Context context) {
        return new PagedFlux<>(
            () -> listSinglePageAsync(billingAccountName, billingProfileName, customerName, context),
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<PartnerTransferDetailsInner> list(
        String billingAccountName, String billingProfileName, String customerName) {
