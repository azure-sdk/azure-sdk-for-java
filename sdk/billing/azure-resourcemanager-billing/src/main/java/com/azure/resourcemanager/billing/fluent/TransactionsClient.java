...
public interface TransactionsClient {
    ...
    PagedIterable<TransactionInner> listByCustomer(
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<TransactionInner> listByInvoiceSection(
        String billingAccountName,
        String billingProfileName,
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<TransactionInner> listByBillingProfile(
        String billingAccountName,
        String billingProfileName,
        LocalDate periodStartDate,
        LocalDate periodEndDate,
    ...
    SyncPoller<PollResult<DocumentDownloadResultInner>, DocumentDownloadResultInner> beginDownloadByInvoice(
    ...
    DocumentDownloadResultInner downloadByInvoice(String billingAccountName, String invoiceName);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    DocumentDownloadResultInner downloadByInvoice(String billingAccountName, String invoiceName, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<TransactionInner> listByInvoice(
        String billingAccountName,
        String invoiceName,
        String filter,
        String orderBy,
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<TransactionInner> listByBillingAccount(
