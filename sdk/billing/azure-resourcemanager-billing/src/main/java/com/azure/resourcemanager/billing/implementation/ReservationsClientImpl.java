...
public final class ReservationsClientImpl implements ReservationsClient {
    ...
    public interface ReservationsService {
        ...
        Mono<Response<ReservationsListResult>> listByBillingProfile(@HostParam("$host") String endpoint,
            ...
            @QueryParam("selectedState") String selectedState, @HeaderParam("Accept") String accept, Context context);
    ...
    private Mono<PagedResponse<ReservationInner>> listByBillingAccountSinglePageAsync(String billingAccountName,
        String filter, String orderby, String refreshSummary, String selectedState) {
        ...
        return FluxUtil
            .withContext(context -> service.listByBillingAccount(this.client.getEndpoint(), apiVersion,
                billingAccountName, filter, orderby, refreshSummary, selectedState, accept, context))
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<ReservationInner>> listByBillingAccountSinglePageAsync(String billingAccountName,
        String filter, String orderby, String refreshSummary, String selectedState, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service
            .listByBillingAccount(this.client.getEndpoint(), apiVersion, billingAccountName, filter, orderby,
                refreshSummary, selectedState, accept, context)
    ...
    private PagedFlux<ReservationInner> listByBillingAccountAsync(String billingAccountName, String filter,
        String orderby, String refreshSummary, String selectedState) {
        return new PagedFlux<>(() -> listByBillingAccountSinglePageAsync(billingAccountName, filter, orderby,
            refreshSummary, selectedState), nextLink -> listByBillingAccountNextSinglePageAsync(nextLink));
    }
    ...
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<ReservationInner> listByBillingAccountAsync(String billingAccountName, String filter,
        String orderby, String refreshSummary, String selectedState, Context context) {
        return new PagedFlux<>(() -> listByBillingAccountSinglePageAsync(billingAccountName, filter, orderby,
            refreshSummary, selectedState, context),
    ...
    private Mono<PagedResponse<ReservationInner>> listByBillingProfileSinglePageAsync(String billingAccountName,
        String billingProfileName, String filter, String orderby, String refreshSummary, String selectedState) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return FluxUtil
            .withContext(
                context -> service.listByBillingProfile(this.client.getEndpoint(), apiVersion, billingAccountName,
                    billingProfileName, filter, orderby, refreshSummary, selectedState, accept, context))
            .<PagedResponse<ReservationInner>>map(res -> new PagedResponseBase<>(res.getRequest(), res.getStatusCode(),
                res.getHeaders(), res.getValue().value(), res.getValue().nextLink(), null))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<PagedResponse<ReservationInner>> listByBillingProfileSinglePageAsync(String billingAccountName,
        ...
        context = this.client.mergeContext(context);
        return service
            .listByBillingProfile(this.client.getEndpoint(), apiVersion, billingAccountName, billingProfileName, filter,
                orderby, refreshSummary, selectedState, accept, context)
            .map(res -> new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(),
                res.getValue().value(), res.getValue().nextLink(), null));
    }
    ...
    private PagedFlux<ReservationInner> listByBillingProfileAsync(String billingAccountName, String billingProfileName,
        ...
        return new PagedFlux<>(() -> listByBillingProfileSinglePageAsync(billingAccountName, billingProfileName, filter,
            orderby, refreshSummary, selectedState), nextLink -> listByBillingProfileNextSinglePageAsync(nextLink));
    }
