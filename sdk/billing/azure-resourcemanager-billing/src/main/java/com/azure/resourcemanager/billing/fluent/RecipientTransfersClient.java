...
public interface RecipientTransfersClient {
    ...
    Response<RecipientTransferDetailsInner> acceptWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<ValidateTransferListResponseInner> validateWithResponse(
        String transferName, AcceptTransferRequest parameters, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<RecipientTransferDetailsInner> list(String filter, Context context);
}
