...
public interface RecipientTransfers {
     ...
     */
    Response<RecipientTransferDetails> acceptWithResponse(
     ...
     */
    Response<ValidateTransferListResponse> validateWithResponse(
        String transferName, AcceptTransferRequest parameters, Context context);
     ...
     * @return the list of transfers received by caller as paginated response with {@link PagedIterable}.
     */
    PagedIterable<RecipientTransferDetails> list(String filter, Context context);
}
