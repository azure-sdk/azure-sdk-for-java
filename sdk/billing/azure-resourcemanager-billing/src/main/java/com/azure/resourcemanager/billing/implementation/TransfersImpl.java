...
public final class TransfersImpl implements Transfers {
    ...
    public Response<TransferDetails> getWithResponse(
        String billingAccountName,
        String billingProfileName,
        String invoiceSectionName,
        String transferName,
        Context context) {
        Response<TransferDetailsInner> inner =
            this
                .serviceClient()
    ...
    public Response<TransferDetails> initiateWithResponse(
        String billingAccountName,
        String billingProfileName,
        String invoiceSectionName,
        String transferName,
    ...
    public TransferDetails initiate(
        String billingAccountName,
        String billingProfileName,
        String invoiceSectionName,
        String transferName,
    ...
    public Response<TransferDetails> cancelWithResponse(
        String billingAccountName,
        String billingProfileName,
        String invoiceSectionName,
        String transferName,
    ...
    public PagedIterable<TransferDetails> list(
        ...
        return Utils.mapPage(inner, inner1 -> new TransferDetailsImpl(inner1, this.manager()));
    }
