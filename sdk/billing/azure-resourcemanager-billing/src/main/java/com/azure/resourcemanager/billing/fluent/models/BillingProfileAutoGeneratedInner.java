...
/** A billing profile. */
@Fluent
public final class BillingProfileAutoGeneratedInner extends ArmResource {
    /*
     * The properties of the billing profile.
     */
    @JsonProperty(value = "properties")
    private BillingProfilePropertiesAutoGenerated innerProperties;

    /** Creates an instance of BillingProfileAutoGeneratedInner class. */
    public BillingProfileAutoGeneratedInner() {
    }
     ...
     * @return the BillingProfileAutoGeneratedInner object itself.
     */
    public BillingProfileAutoGeneratedInner withBillTo(AddressDetails billTo) {
        if (this.innerProperties() == null) {
            this.innerProperties = new BillingProfilePropertiesAutoGenerated();
        }
     ...
     * @return the BillingProfileAutoGeneratedInner object itself.
     */
    public BillingProfileAutoGeneratedInner withDisplayName(String displayName) {
        if (this.innerProperties() == null) {
            this.innerProperties = new BillingProfilePropertiesAutoGenerated();
        }
     ...
     * @return the BillingProfileAutoGeneratedInner object itself.
     */
    public BillingProfileAutoGeneratedInner withEnabledAzurePlans(List<AzurePlan> enabledAzurePlans) {
        if (this.innerProperties() == null) {
            this.innerProperties = new BillingProfilePropertiesAutoGenerated();
        }
     ...
     * @return the BillingProfileAutoGeneratedInner object itself.
     */
    public BillingProfileAutoGeneratedInner withInvoiceEmailOptIn(Boolean invoiceEmailOptIn) {
        if (this.innerProperties() == null) {
            this.innerProperties = new BillingProfilePropertiesAutoGenerated();
        }
     ...
     * @return the BillingProfileAutoGeneratedInner object itself.
     */
    public BillingProfileAutoGeneratedInner withInvoiceSections(InvoiceSectionsOnExpandAutoGenerated invoiceSections) {
        if (this.innerProperties() == null) {
            this.innerProperties = new BillingProfilePropertiesAutoGenerated();
        }
     ...
     * @return the BillingProfileAutoGeneratedInner object itself.
     */
    public BillingProfileAutoGeneratedInner withPoNumber(String poNumber) {
        if (this.innerProperties() == null) {
            this.innerProperties = new BillingProfilePropertiesAutoGenerated();
        }
     ...
     * @return the BillingProfileAutoGeneratedInner object itself.
     */
    public BillingProfileAutoGeneratedInner withTags(Map<String, String> tags) {
        if (this.innerProperties() == null) {
            this.innerProperties = new BillingProfilePropertiesAutoGenerated();
        }
