...
public final class BillingProfilesClientImpl implements BillingProfilesClient {
    ...
    public interface BillingProfilesService {
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<BillingProfileAutoGeneratedInner>> get(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam("billingAccountName") String billingAccountName,
        ...
        Mono<Response<Flux<ByteBuffer>>> createOrUpdate(
            ...
            @PathParam("billingAccountName") String billingAccountName,
            @PathParam("billingProfileName") String billingProfileName,
            @BodyParam("application/json") BillingProfileAutoGeneratedInner parameters,
            @HeaderParam("Accept") String accept,
            Context context);
    ...
    private Mono<PagedResponse<BillingProfileAutoGeneratedInner>> listByBillingAccountSinglePageAsync(
                ...
                context ->
                    service
                        .listByBillingAccount(
                            ...
                            accept,
                            context))
            .<PagedResponse<BillingProfileAutoGeneratedInner>>map(
                res ->
    ...
    private PagedFlux<BillingProfileAutoGeneratedInner> listByBillingAccountAsync(
        String billingAccountName, String expand) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<BillingProfileAutoGeneratedInner> listByBillingAccountAsync(String billingAccountName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<BillingProfileAutoGeneratedInner> listByBillingAccount(String billingAccountName) {
        final String expand = null;
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<BillingProfileAutoGeneratedInner> listByBillingAccount(
        String billingAccountName, String expand, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<BillingProfileAutoGeneratedInner>> getWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<BillingProfileAutoGeneratedInner> getAsync(String billingAccountName, String billingProfileName) {
        final String expand = null;
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<BillingProfileAutoGeneratedInner> getWithResponse(
        String billingAccountName, String billingProfileName, String expand, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public BillingProfileAutoGeneratedInner get(String billingAccountName, String billingProfileName) {
        final String expand = null;
        return getWithResponse(billingAccountName, billingProfileName, expand, Context.NONE).getValue();
    }
    ...
    private PollerFlux<PollResult<BillingProfileAutoGeneratedInner>, BillingProfileAutoGeneratedInner>
        ...
        return this
            .client
            .<BillingProfileAutoGeneratedInner, BillingProfileAutoGeneratedInner>getLroResult(
                mono,
                this.client.getHttpPipeline(),
                BillingProfileAutoGeneratedInner.class,
                BillingProfileAutoGeneratedInner.class,
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<BillingProfileAutoGeneratedInner>, BillingProfileAutoGeneratedInner>
        beginCreateOrUpdate(
            String billingAccountName, String billingProfileName, BillingProfileAutoGeneratedInner parameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<BillingProfileAutoGeneratedInner> createOrUpdateAsync(
        String billingAccountName, String billingProfileName, BillingProfileAutoGeneratedInner parameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public BillingProfileAutoGeneratedInner createOrUpdate(
        String billingAccountName, String billingProfileName, BillingProfileAutoGeneratedInner parameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<BillingProfileAutoGeneratedInner>> listByBillingAccountNextSinglePageAsync(
        String nextLink) {
        if (nextLink == null) {
