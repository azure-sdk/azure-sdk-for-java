...
public interface Transactions {
     ...
     */
    PagedIterable<Transaction> listByCustomer(
     ...
     * @return a container for a list of resources as paginated response with {@link PagedIterable}.
     */
    PagedIterable<Transaction> listByInvoiceSection(
        String billingAccountName,
        String billingProfileName,
     ...
     * @return a container for a list of resources as paginated response with {@link PagedIterable}.
     */
    PagedIterable<Transaction> listByBillingProfile(
        String billingAccountName,
        String billingProfileName,
        LocalDate periodStartDate,
        LocalDate periodEndDate,
     ...
     */
    DocumentDownloadResult downloadByInvoice(String billingAccountName, String invoiceName);
     ...
     * @return a URL to download the transactions document for an invoice.
     */
    DocumentDownloadResult downloadByInvoice(String billingAccountName, String invoiceName, Context context);
     ...
     * @return a container for a list of resources as paginated response with {@link PagedIterable}.
     */
    PagedIterable<Transaction> listByInvoice(
        String billingAccountName,
        String invoiceName,
        String filter,
        String orderBy,
     ...
     * @return a container for a list of resources as paginated response with {@link PagedIterable}.
     */
    PagedIterable<Transaction> listByBillingAccount(
