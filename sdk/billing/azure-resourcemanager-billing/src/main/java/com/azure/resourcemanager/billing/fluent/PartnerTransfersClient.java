...
public interface PartnerTransfersClient {
    ...
    Response<PartnerTransferDetailsInner> getWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    PartnerTransferDetailsInner get(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<PartnerTransferDetailsInner> initiateWithResponse(
        String billingAccountName,
        String billingProfileName,
        String customerName,
        String transferName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    PartnerTransferDetailsInner initiate(
        String billingAccountName,
        String billingProfileName,
        String customerName,
        String transferName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<PartnerTransferDetailsInner> cancelWithResponse(
        String billingAccountName,
        String billingProfileName,
        String customerName,
        String transferName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    PartnerTransferDetailsInner cancel(
        String billingAccountName, String billingProfileName, String customerName, String transferName);
    ...
    PagedIterable<PartnerTransferDetailsInner> list(
