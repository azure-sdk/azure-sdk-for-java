...
public final class TransfersClientImpl implements TransfersClient {
    ...
    public interface TransfersService {
        ...
        Mono<Response<TransferDetailsInner>> get(
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<TransferDetailsInner>> initiate(
            @HostParam("$host") String endpoint,
            @PathParam("billingAccountName") String billingAccountName,
            @PathParam("billingProfileName") String billingProfileName,
            @PathParam("invoiceSectionName") String invoiceSectionName,
            @PathParam("transferName") String transferName,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") InitiateTransferRequest parameters,
            @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<TransferDetailsInner>> cancel(
            @HostParam("$host") String endpoint,
            @PathParam("billingAccountName") String billingAccountName,
            @PathParam("billingProfileName") String billingProfileName,
            @PathParam("invoiceSectionName") String invoiceSectionName,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<TransferDetailsListResult>> list(
            @HostParam("$host") String endpoint,
            @PathParam("billingAccountName") String billingAccountName,
            @PathParam("billingProfileName") String billingProfileName,
            @PathParam("invoiceSectionName") String invoiceSectionName,
    ...
    private Mono<Response<TransferDetailsInner>> getWithResponseAsync(
        String billingAccountName, String billingProfileName, String invoiceSectionName, String transferName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<TransferDetailsInner> getAsync(
        String billingAccountName, String billingProfileName, String invoiceSectionName, String transferName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<TransferDetailsInner> getWithResponse(
        String billingAccountName,
        String billingProfileName,
        String invoiceSectionName,
        String transferName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public TransferDetailsInner get(
        String billingAccountName, String billingProfileName, String invoiceSectionName, String transferName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<TransferDetailsInner>> initiateWithResponseAsync(
        String billingAccountName,
        String billingProfileName,
        String invoiceSectionName,
        String transferName,
        InitiateTransferRequest parameters) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<TransferDetailsInner> initiateAsync(
        String billingAccountName,
        String billingProfileName,
        String invoiceSectionName,
        String transferName,
        InitiateTransferRequest parameters) {
        return initiateWithResponseAsync(
                billingAccountName, billingProfileName, invoiceSectionName, transferName, parameters)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<TransferDetailsInner> initiateWithResponse(
        String billingAccountName,
        String billingProfileName,
        String invoiceSectionName,
        String transferName,
        ...
        Context context) {
        return initiateWithResponseAsync(
                billingAccountName, billingProfileName, invoiceSectionName, transferName, parameters, context)
            .block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public TransferDetailsInner initiate(
        String billingAccountName,
        String billingProfileName,
        String invoiceSectionName,
        String transferName,
        InitiateTransferRequest parameters) {
        return initiateWithResponse(
                billingAccountName, billingProfileName, invoiceSectionName, transferName, parameters, Context.NONE)
            .getValue();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<TransferDetailsInner>> cancelWithResponseAsync(
        String billingAccountName, String billingProfileName, String invoiceSectionName, String transferName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<TransferDetailsInner> cancelAsync(
        String billingAccountName, String billingProfileName, String invoiceSectionName, String transferName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<TransferDetailsInner> cancelWithResponse(
        String billingAccountName,
        String billingProfileName,
        String invoiceSectionName,
        String transferName,
        Context context) {
        return cancelWithResponseAsync(
                billingAccountName, billingProfileName, invoiceSectionName, transferName, context)
            .block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public TransferDetailsInner cancel(
        String billingAccountName, String billingProfileName, String invoiceSectionName, String transferName) {
        return cancelWithResponse(
                billingAccountName, billingProfileName, invoiceSectionName, transferName, Context.NONE)
            .getValue();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<TransferDetailsInner>> listSinglePageAsync(
                ...
                context ->
                    service
                        .list(
                            ...
                            accept,
                            context))
            .<PagedResponse<TransferDetailsInner>>map(
                res ->
    ...
    private PagedFlux<TransferDetailsInner> listAsync(
        String billingAccountName, String billingProfileName, String invoiceSectionName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<TransferDetailsInner> list(
        String billingAccountName, String billingProfileName, String invoiceSectionName) {
