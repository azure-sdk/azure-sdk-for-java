...
public interface Products {
     ...
     * @return the list of products as paginated response with {@link PagedIterable}.
     */
    PagedIterable<Product> listByBillingProfile(String billingAccountName, String billingProfileName, String filter,
        Context context);
     ...
     * @return the list of products as paginated response with {@link PagedIterable}.
     */
    PagedIterable<Product> listByInvoiceSection(String billingAccountName, String billingProfileName,
     ...
     */
    Response<Product> updateWithResponse(String billingAccountName, String productName, ProductInner parameters,
        Context context);
     ...
     * @return a product.
     */
    Response<Product> moveWithResponse(String billingAccountName, String productName,
     ...
     */
    Response<ValidateProductTransferEligibilityResult> validateMoveWithResponse(String billingAccountName,
     ...
     */
    ValidateProductTransferEligibilityResult validateMove(String billingAccountName, String productName,
