...
public final class BillingRoleAssignmentsImpl implements BillingRoleAssignments {
    ...
    public Response<BillingRoleAssignment> deleteByBillingAccountWithResponse(String billingAccountName,
        String billingRoleAssignmentName, Context context) {
        Response<BillingRoleAssignmentInner> inner = this.serviceClient()
    ...
    public Response<BillingRoleAssignment> getByInvoiceSectionWithResponse(String billingAccountName,
        ...
        Response<BillingRoleAssignmentInner> inner = this.serviceClient().getByInvoiceSectionWithResponse(
    ...
    public BillingRoleAssignment getByInvoiceSection(String billingAccountName, String billingProfileName,
        ...
        BillingRoleAssignmentInner inner = this.serviceClient().getByInvoiceSection(billingAccountName,
    ...
    public Response<BillingRoleAssignment> deleteByInvoiceSectionWithResponse(String billingAccountName,
        String billingProfileName, String invoiceSectionName, String billingRoleAssignmentName, Context context) {
        Response<BillingRoleAssignmentInner> inner = this.serviceClient().deleteByInvoiceSectionWithResponse(
            billingAccountName, billingProfileName, invoiceSectionName, billingRoleAssignmentName, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
                new BillingRoleAssignmentImpl(inner.getValue(), this.manager()));
    ...
    public BillingRoleAssignment deleteByInvoiceSection(String billingAccountName, String billingProfileName,
        String invoiceSectionName, String billingRoleAssignmentName) {
        BillingRoleAssignmentInner inner = this.serviceClient().deleteByInvoiceSection(billingAccountName,
            billingProfileName, invoiceSectionName, billingRoleAssignmentName);
        if (inner != null) {
            return new BillingRoleAssignmentImpl(inner, this.manager());
        } else {
    ...
    public Response<BillingRoleAssignment> getByBillingProfileWithResponse(String billingAccountName,
        ...
        Response<BillingRoleAssignmentInner> inner = this.serviceClient().getByBillingProfileWithResponse(
    ...
    public BillingRoleAssignment getByBillingProfile(String billingAccountName, String billingProfileName,
        ...
        BillingRoleAssignmentInner inner = this.serviceClient().getByBillingProfile(billingAccountName,
            billingProfileName, billingRoleAssignmentName);
        if (inner != null) {
            return new BillingRoleAssignmentImpl(inner, this.manager());
        } else {
            return null;
    ...
    public Response<BillingRoleAssignment> deleteByBillingProfileWithResponse(String billingAccountName,
        String billingProfileName, String billingRoleAssignmentName, Context context) {
        Response<BillingRoleAssignmentInner> inner = this.serviceClient().deleteByBillingProfileWithResponse(
            billingAccountName, billingProfileName, billingRoleAssignmentName, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
                new BillingRoleAssignmentImpl(inner.getValue(), this.manager()));
    ...
    public BillingRoleAssignment deleteByBillingProfile(String billingAccountName, String billingProfileName,
        String billingRoleAssignmentName) {
        BillingRoleAssignmentInner inner = this.serviceClient().deleteByBillingProfile(billingAccountName,
            billingProfileName, billingRoleAssignmentName);
        if (inner != null) {
            return new BillingRoleAssignmentImpl(inner, this.manager());
        } else {
    ...
    public PagedIterable<BillingRoleAssignment> listByInvoiceSection(String billingAccountName,
        ...
        PagedIterable<BillingRoleAssignmentInner> inner = this.serviceClient().listByInvoiceSection(billingAccountName,
