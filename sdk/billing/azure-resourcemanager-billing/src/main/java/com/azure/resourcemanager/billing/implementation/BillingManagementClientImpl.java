...
public final class BillingManagementClientImpl implements BillingManagementClient {
    ...
    /** The CheckAccessClient object to access its operations. */
    private final CheckAccessClient checkAccess;

    /**
     * Gets the CheckAccessClient object to access its operations.
     *
     * @return the CheckAccessClient object.
     */
    public CheckAccessClient getCheckAccess() {
    ...
    BillingManagementClientImpl(
        ...
        this.checkAccess = new CheckAccessClientImpl(this);
