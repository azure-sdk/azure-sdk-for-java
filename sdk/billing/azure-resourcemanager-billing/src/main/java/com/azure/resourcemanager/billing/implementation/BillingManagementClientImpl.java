...
public final class BillingManagementClientImpl implements BillingManagementClient {
    ...
    /** The TransactionSummariesClient object to access its operations. */
    private final TransactionSummariesClient transactionSummaries;
     ...
     */
    public TransactionSummariesClient getTransactionSummaries() {
    ...
    BillingManagementClientImpl(
        ...
        this.transactionSummaries = new TransactionSummariesClientImpl(this);
