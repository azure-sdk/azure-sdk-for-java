...
public final class PartnerTransfersImpl implements PartnerTransfers {
    ...
    public PartnerTransfersImpl(
        PartnerTransfersClient innerClient, com.azure.resourcemanager.billing.BillingManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public Response<PartnerTransferDetails> getWithResponse(
        String billingAccountName,
        String billingProfileName,
        String customerName,
        String transferName,
        Context context) {
        Response<PartnerTransferDetailsInner> inner =
            this
                .serviceClient()
    ...
    public PartnerTransferDetails get(
    ...
    public Response<PartnerTransferDetails> initiateWithResponse(
        String billingAccountName,
        String billingProfileName,
        String customerName,
        String transferName,
    ...
    public PartnerTransferDetails initiate(
        String billingAccountName,
        String billingProfileName,
        String customerName,
        String transferName,
    ...
    public Response<PartnerTransferDetails> cancelWithResponse(
        String billingAccountName,
        String billingProfileName,
        String customerName,
        String transferName,
    ...
    public PartnerTransferDetails cancel(
        String billingAccountName, String billingProfileName, String customerName, String transferName) {
        PartnerTransferDetailsInner inner =
    ...
    public PagedIterable<PartnerTransferDetails> list(
        ...
        return Utils.mapPage(inner, inner1 -> new PartnerTransferDetailsImpl(inner1, this.manager()));
    }
