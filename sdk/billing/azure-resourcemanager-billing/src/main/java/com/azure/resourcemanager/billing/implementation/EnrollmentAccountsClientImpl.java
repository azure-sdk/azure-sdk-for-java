...
public final class EnrollmentAccountsClientImpl implements EnrollmentAccountsClient {
    ...
    public interface EnrollmentAccountsService {
        ...
        Mono<Response<EnrollmentAccountListResult>> listByDepartmentName(
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<EnrollmentAccountAutoGeneratedInner>> getByAccountIdByDepartmentId(
            @HostParam("$host") String endpoint,
            @PathParam("billingAccountName") String billingAccountName,
            @PathParam("departmentName") String departmentName,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<EnrollmentAccountListResult>> listByBillingAccount(
            @HostParam("$host") String endpoint,
            @PathParam("billingAccountName") String billingAccountName,
            @QueryParam("api-version") String apiVersion,
            @QueryParam("filter") String filter,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<EnrollmentAccountAutoGeneratedInner>> get(
            @HostParam("$host") String endpoint,
            @PathParam("billingAccountName") String billingAccountName,
            @PathParam("enrollmentAccountName") String enrollmentAccountName,
            @QueryParam("api-version") String apiVersion,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<EnrollmentAccountListResult>> listByDepartmentNameNext(
    ...
    private Mono<PagedResponse<EnrollmentAccountAutoGeneratedInner>> listByDepartmentNameSinglePageAsync(
                ...
                context ->
                    service
                        .listByDepartmentName(
                            ...
                            accept,
                            context))
            .<PagedResponse<EnrollmentAccountAutoGeneratedInner>>map(
                res ->
    ...
    private PagedFlux<EnrollmentAccountAutoGeneratedInner> listByDepartmentNameAsync(
        String billingAccountName,
        String departmentName,
        String filter,
        String orderBy,
        ...
        return new PagedFlux<>(
            () ->
                listByDepartmentNameSinglePageAsync(
                    billingAccountName, departmentName, filter, orderBy, top, skip, count, search),
            nextLink -> listByDepartmentNameNextSinglePageAsync(nextLink));
    }
    ...
    private PagedFlux<EnrollmentAccountAutoGeneratedInner> listByDepartmentNameAsync(
        ...
        return new PagedFlux<>(
            ...
            nextLink -> listByDepartmentNameNextSinglePageAsync(nextLink, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<EnrollmentAccountAutoGeneratedInner> listByDepartmentName(
        String billingAccountName, String departmentName) {
        final String filter = null;
        final String orderBy = null;
        final Long top = null;
        ...
        return new PagedIterable<>(
            listByDepartmentNameAsync(billingAccountName, departmentName, filter, orderBy, top, skip, count, search));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<EnrollmentAccountAutoGeneratedInner>> getByAccountIdByDepartmentIdWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<EnrollmentAccountAutoGeneratedInner> getByAccountIdByDepartmentIdAsync(
        String billingAccountName, String departmentName, String enrollmentAccountName) {
        return getByAccountIdByDepartmentIdWithResponseAsync(billingAccountName, departmentName, enrollmentAccountName)
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<EnrollmentAccountAutoGeneratedInner> getByAccountIdByDepartmentIdWithResponse(
        String billingAccountName, String departmentName, String enrollmentAccountName, Context context) {
        return getByAccountIdByDepartmentIdWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public EnrollmentAccountAutoGeneratedInner getByAccountIdByDepartmentId(
        String billingAccountName, String departmentName, String enrollmentAccountName) {
        return getByAccountIdByDepartmentIdWithResponse(
                billingAccountName, departmentName, enrollmentAccountName, Context.NONE)
            .getValue();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<EnrollmentAccountAutoGeneratedInner>> listByBillingAccountSinglePageAsync(
        String billingAccountName, String filter, String orderBy, Long top, Long skip, Boolean count, String search) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<EnrollmentAccountAutoGeneratedInner> listByBillingAccountAsync(
        String billingAccountName, String filter, String orderBy, Long top, Long skip, Boolean count, String search) {
        return new PagedFlux<>(
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<EnrollmentAccountAutoGeneratedInner> listByBillingAccountAsync(String billingAccountName) {
        final String filter = null;
        final String orderBy = null;
        final Long top = null;
        final Long skip = null;
        ...
        return new PagedFlux<>(
            () ->
                listByBillingAccountSinglePageAsync(
                    billingAccountName, filter, orderBy, top, skip, count, search, context),
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<EnrollmentAccountAutoGeneratedInner> listByBillingAccount(String billingAccountName) {
        final String filter = null;
        final String orderBy = null;
        final Long top = null;
        final Long skip = null;
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<EnrollmentAccountAutoGeneratedInner> listByBillingAccount(
        String billingAccountName,
        String filter,
        String orderBy,
        Long top,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<EnrollmentAccountAutoGeneratedInner>> getWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<EnrollmentAccountAutoGeneratedInner> getAsync(
        String billingAccountName, String enrollmentAccountName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<EnrollmentAccountAutoGeneratedInner> getWithResponse(
        String billingAccountName, String enrollmentAccountName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public EnrollmentAccountAutoGeneratedInner get(String billingAccountName, String enrollmentAccountName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<EnrollmentAccountAutoGeneratedInner>> listByDepartmentNameNextSinglePageAsync(
        String nextLink) {
        if (nextLink == null) {
        ...
        return FluxUtil
            .withContext(
                context -> service.listByDepartmentNameNext(nextLink, this.client.getEndpoint(), accept, context))
            .<PagedResponse<EnrollmentAccountAutoGeneratedInner>>map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(),
    ...
    private Mono<PagedResponse<EnrollmentAccountAutoGeneratedInner>> listByDepartmentNameNextSinglePageAsync(
        ...
        context = this.client.mergeContext(context);
        return service
            .listByDepartmentNameNext(nextLink, this.client.getEndpoint(), accept, context)
            .map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<EnrollmentAccountAutoGeneratedInner>> listByBillingAccountNextSinglePageAsync(
        String nextLink) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
