...
public final class PaymentMethodsClientImpl implements PaymentMethodsClient {
    ...
    public interface PaymentMethodsService {
        ...
        Mono<Response<PaymentMethodLinksListResult>> listByBillingProfile(
        ...
        @Get(
            "/providers/Microsoft.Billing/billingAccounts/{billingAccountName}/billingProfiles/{billingProfileName}"
                + "/paymentMethodLinks/{paymentMethodName}")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<PaymentMethodLinkInner>> getByBillingProfile(
            @HostParam("$host") String endpoint,
            @PathParam("billingAccountName") String billingAccountName,
            @PathParam("billingProfileName") String billingProfileName,
            @PathParam("paymentMethodName") String paymentMethodName,
            @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<PaymentMethodsListResult>> listByBillingAccount(
            @HostParam("$host") String endpoint,
            @PathParam("billingAccountName") String billingAccountName,
            @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<PaymentMethodInner>> getByBillingAccount(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam("billingAccountName") String billingAccountName,
            @PathParam("paymentMethodName") String paymentMethodName,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<PaymentMethodsListResult>> listByUser(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept,
            Context context);
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Void>> deleteByUser(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam("paymentMethodName") String paymentMethodName,
            @HeaderParam("Accept") String accept,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<PaymentMethodInner>> getByUser(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam("paymentMethodName") String paymentMethodName,
            @HeaderParam("Accept") String accept,
     ...
     * @return the list of payment method links along with {@link PagedResponse} on successful completion of {@link
     *     Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<PaymentMethodLinkInner>> listByBillingProfileSinglePageAsync(
                ...
                context ->
                    service
                        .listByBillingProfile(
                            ...
                            accept,
                            context))
            .<PagedResponse<PaymentMethodLinkInner>>map(
                res ->
    ...
    private PagedFlux<PaymentMethodLinkInner> listByBillingProfileAsync(
        String billingAccountName, String billingProfileName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<PaymentMethodLinkInner> listByBillingProfile(
        String billingAccountName, String billingProfileName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<PaymentMethodLinkInner>> getByBillingProfileWithResponseAsync(
        String billingAccountName, String billingProfileName, String paymentMethodName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<PaymentMethodLinkInner>> getByBillingProfileWithResponseAsync(
        String billingAccountName, String billingProfileName, String paymentMethodName, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PaymentMethodLinkInner> getByBillingProfileAsync(
        String billingAccountName, String billingProfileName, String paymentMethodName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<PaymentMethodLinkInner> getByBillingProfileWithResponse(
        String billingAccountName, String billingProfileName, String paymentMethodName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public PaymentMethodLinkInner getByBillingProfile(
        String billingAccountName, String billingProfileName, String paymentMethodName) {
                ...
                context ->
                    service
                        .listByBillingAccount(
                            ...
                            accept,
                            context))
            .<PagedResponse<PaymentMethodInner>>map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(),
                        res.getStatusCode(),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<PaymentMethodInner>> listByBillingAccountSinglePageAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<PaymentMethodInner>> getByBillingAccountWithResponseAsync(
        String billingAccountName, String paymentMethodName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<PaymentMethodInner>> getByBillingAccountWithResponseAsync(
        String billingAccountName, String paymentMethodName, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<PaymentMethodInner> getByBillingAccountWithResponse(
        String billingAccountName, String paymentMethodName, Context context) {
    ...
    private Mono<PagedResponse<PaymentMethodInner>> listByUserSinglePageAsync(Context context) {
        ...
        context = this.client.mergeContext(context);
        return service
            .listByUser(this.client.getEndpoint(), this.client.getApiVersion(), accept, context)
            .map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(),
    ...
    private PagedFlux<PaymentMethodInner> listByUserAsync(Context context) {
        return new PagedFlux<>(
            () -> listByUserSinglePageAsync(context), nextLink -> listByUserNextSinglePageAsync(nextLink, context));
    }
        ...
        return FluxUtil
            .withContext(
                context ->
                    service
                        .deleteByUser(
                            this.client.getEndpoint(), this.client.getApiVersion(), paymentMethodName, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<Void>> deleteByUserWithResponseAsync(String paymentMethodName, Context context) {
        ...
        context = this.client.mergeContext(context);
        return service
            .deleteByUser(this.client.getEndpoint(), this.client.getApiVersion(), paymentMethodName, accept, context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a payment method owned by the caller along with {@link Response} on successful completion of {@link
     *     Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ...
    private Mono<Response<PaymentMethodInner>> getByUserWithResponseAsync(String paymentMethodName, Context context) {
        ...
        context = this.client.mergeContext(context);
        return service
            .getByUser(this.client.getEndpoint(), this.client.getApiVersion(), paymentMethodName, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<PaymentMethodLinkInner>> listByBillingProfileNextSinglePageAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<PaymentMethodInner>> listByBillingAccountNextSinglePageAsync(
        String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
