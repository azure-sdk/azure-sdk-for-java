...
public final class PaymentMethodsImpl implements PaymentMethods {
    ...
    public PaymentMethodsImpl(
        PaymentMethodsClient innerClient, com.azure.resourcemanager.billing.BillingManager serviceManager) {
    ...
    public PagedIterable<PaymentMethodLink> listByBillingProfile(String billingAccountName, String billingProfileName) {
        ...
        return Utils.mapPage(inner, inner1 -> new PaymentMethodLinkImpl(inner1, this.manager()));
    }

    public PagedIterable<PaymentMethodLink> listByBillingProfile(
    ...
    public Response<PaymentMethodLink> getByBillingProfileWithResponse(
        String billingAccountName, String billingProfileName, String paymentMethodName, Context context) {
        Response<PaymentMethodLinkInner> inner =
            this
                .serviceClient()
    ...
    public PaymentMethodLink getByBillingProfile(
    ...
    public PagedIterable<PaymentMethod> listByBillingAccount(String billingAccountName) {
        ...
        return Utils.mapPage(inner, inner1 -> new PaymentMethodImpl(inner1, this.manager()));
    }
    ...
    public Response<PaymentMethod> getByBillingAccountWithResponse(
