...
public final class RecipientTransfersImpl implements RecipientTransfers {
    ...
    public RecipientTransfersImpl(
        RecipientTransfersClient innerClient, com.azure.resourcemanager.billing.BillingManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public Response<RecipientTransferDetails> acceptWithResponse(
    ...
    public Response<ValidateTransferListResponse> validateWithResponse(
        String transferName, AcceptTransferRequest parameters, Context context) {
    ...
    public PagedIterable<RecipientTransferDetails> list() {
        ...
        return Utils.mapPage(inner, inner1 -> new RecipientTransferDetailsImpl(inner1, this.manager()));
    }

    public PagedIterable<RecipientTransferDetails> list(String filter, Context context) {
        PagedIterable<RecipientTransferDetailsInner> inner = this.serviceClient().list(filter, context);
        return Utils.mapPage(inner, inner1 -> new RecipientTransferDetailsImpl(inner1, this.manager()));
    }
