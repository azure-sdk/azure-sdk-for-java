...
/** Resource collection API of TransactionSummaries. */
public interface TransactionSummaries {
    /**
     ...
     */
    Response<TransactionSummary> getByInvoiceWithResponse(
     ...
     */
    TransactionSummary getByInvoice(String billingAccountName, String invoiceName);
}
