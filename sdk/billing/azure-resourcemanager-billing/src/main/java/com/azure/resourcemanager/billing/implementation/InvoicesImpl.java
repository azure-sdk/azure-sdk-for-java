...
public final class InvoicesImpl implements Invoices {
    ...
    public DownloadUrl downloadMultipleBillingSubscriptionInvoices(String subscriptionId, List<String> downloadUrls) {
        DownloadUrlInner inner =
            this.serviceClient().downloadMultipleBillingSubscriptionInvoices(subscriptionId, downloadUrls);
        if (inner != null) {
            return new DownloadUrlImpl(inner, this.manager());
        } else {
            return null;
    ...
    public DownloadUrl downloadMultipleBillingSubscriptionInvoices(
        String subscriptionId, List<String> downloadUrls, Context context) {
        DownloadUrlInner inner =
            this.serviceClient().downloadMultipleBillingSubscriptionInvoices(subscriptionId, downloadUrls, context);
        if (inner != null) {
            return new DownloadUrlImpl(inner, this.manager());
        } else {
            return null;
    ...
    public PagedIterable<Invoice> listByBillingSubscription(
        ...
        PagedIterable<InvoiceInner> inner =
            this.serviceClient().listByBillingSubscription(subscriptionId, periodStartDate, periodEndDate);
        return Utils.mapPage(inner, inner1 -> new InvoiceImpl(inner1, this.manager()));
    }
    ...
    public PagedIterable<Invoice> listByBillingSubscription(
        ...
        PagedIterable<InvoiceInner> inner =
            this.serviceClient().listByBillingSubscription(subscriptionId, periodStartDate, periodEndDate, context);
        return Utils.mapPage(inner, inner1 -> new InvoiceImpl(inner1, this.manager()));
    }

    public Response<Invoice> getBySubscriptionAndInvoiceIdWithResponse(
        String subscriptionId, String invoiceName, Context context) {
        Response<InvoiceInner> inner =
            this.serviceClient().getBySubscriptionAndInvoiceIdWithResponse(subscriptionId, invoiceName, context);
        if (inner != null) {
            return new SimpleResponse<>(
                inner.getRequest(),
                inner.getStatusCode(),
    ...
    public Invoice getBySubscriptionAndInvoiceId(String subscriptionId, String invoiceName) {
        InvoiceInner inner = this.serviceClient().getBySubscriptionAndInvoiceId(subscriptionId, invoiceName);
        if (inner != null) {
            return new InvoiceImpl(inner, this.manager());
        } else {
            return null;
    ...
    public DownloadUrl downloadBillingSubscriptionInvoice(
        String subscriptionId, String invoiceName, String downloadToken) {
        DownloadUrlInner inner =
            this.serviceClient().downloadBillingSubscriptionInvoice(subscriptionId, invoiceName, downloadToken);
        if (inner != null) {
            return new DownloadUrlImpl(inner, this.manager());
        } else {
            return null;
    ...
    public DownloadUrl downloadBillingSubscriptionInvoice(
        ...
        DownloadUrlInner inner =
            this
                .serviceClient()
                .downloadBillingSubscriptionInvoice(subscriptionId, invoiceName, downloadToken, context);
        if (inner != null) {
            return new DownloadUrlImpl(inner, this.manager());
        } else {
            return null;
