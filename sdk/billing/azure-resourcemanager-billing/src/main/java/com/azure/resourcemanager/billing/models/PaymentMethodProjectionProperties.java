...
@Fluent
public final class PaymentMethodProjectionProperties {
    /*
    ...
    /** Creates an instance of PaymentMethodProjectionProperties class. */
     ...
     * @return the PaymentMethodProjectionProperties object itself.
     */
    public PaymentMethodProjectionProperties withFamily(PaymentMethodFamily family) {
        this.family = family;
        return this;
    }
     ...
     * @return the PaymentMethodProjectionProperties object itself.
     */
    public PaymentMethodProjectionProperties withLogos(List<PaymentMethodLogo> logos) {
        this.logos = logos;
        return this;
    }
     ...
     * @return the PaymentMethodProjectionProperties object itself.
     */
    public PaymentMethodProjectionProperties withStatus(PaymentMethodStatus status) {
        this.status = status;
        return this;
    }

    /**
     * Get the type property: The type of payment method.
     *
