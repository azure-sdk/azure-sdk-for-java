...
public interface EnrollmentAccounts {
     ...
     */
    PagedIterable<EnrollmentAccountAutoGenerated> listByDepartmentName(
     ...
     */
    Response<EnrollmentAccountAutoGenerated> getByAccountIdByDepartmentIdWithResponse(
     ...
     */
    EnrollmentAccountAutoGenerated getByAccountIdByDepartmentId(
     ...
     * @return a container for a list of resources as paginated response with {@link PagedIterable}.
     */
    PagedIterable<EnrollmentAccountAutoGenerated> listByBillingAccount(String billingAccountName);
     ...
     * @return a container for a list of resources as paginated response with {@link PagedIterable}.
     */
    PagedIterable<EnrollmentAccountAutoGenerated> listByBillingAccount(
        String billingAccountName,
        String filter,
        String orderBy,
        Long top,
     ...
     */
    Response<EnrollmentAccountAutoGenerated> getWithResponse(
     ...
     */
    EnrollmentAccountAutoGenerated get(String billingAccountName, String enrollmentAccountName);
}
