...
public interface TransfersClient {
    ...
    Response<TransferDetailsInner> getWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<TransferDetailsInner> initiateWithResponse(
        String billingAccountName,
        String billingProfileName,
        String invoiceSectionName,
        String transferName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<TransferDetailsInner> cancelWithResponse(
        String billingAccountName,
        String billingProfileName,
        String invoiceSectionName,
        String transferName,
    ...
    PagedIterable<TransferDetailsInner> list(
