...
public final class DepartmentsClientImpl implements DepartmentsClient {
    ...
    public interface DepartmentsService {
        ...
        Mono<Response<DepartmentListResult>> listByBillingAccount(
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<DepartmentAutoGeneratedInner>> get(
            @HostParam("$host") String endpoint,
            @PathParam("billingAccountName") String billingAccountName,
    ...
    private Mono<PagedResponse<DepartmentAutoGeneratedInner>> listByBillingAccountSinglePageAsync(
        String billingAccountName, String filter, String orderBy, Long top, Long skip, String search) {
                ...
                context ->
                    service
                        .listByBillingAccount(
                            ...
                            accept,
                            context))
            .<PagedResponse<DepartmentAutoGeneratedInner>>map(
                res ->
    ...
    private PagedFlux<DepartmentAutoGeneratedInner> listByBillingAccountAsync(
        String billingAccountName, String filter, String orderBy, Long top, Long skip, String search) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<DepartmentAutoGeneratedInner> listByBillingAccountAsync(String billingAccountName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<DepartmentAutoGeneratedInner> listByBillingAccount(String billingAccountName) {
        final String filter = null;
        final String orderBy = null;
        final Long top = null;
        final Long skip = null;
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<DepartmentAutoGeneratedInner> listByBillingAccount(
        String billingAccountName, String filter, String orderBy, Long top, Long skip, String search, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<DepartmentAutoGeneratedInner>> getWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DepartmentAutoGeneratedInner> getAsync(String billingAccountName, String departmentName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<DepartmentAutoGeneratedInner> getWithResponse(
        String billingAccountName, String departmentName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public DepartmentAutoGeneratedInner get(String billingAccountName, String departmentName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<DepartmentAutoGeneratedInner>> listByBillingAccountNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<DepartmentAutoGeneratedInner>> listByBillingAccountNextSinglePageAsync(
