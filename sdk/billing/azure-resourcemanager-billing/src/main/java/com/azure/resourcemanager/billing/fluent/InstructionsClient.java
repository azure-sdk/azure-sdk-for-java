...
public interface InstructionsClient {
    ...
    Response<InstructionInner> getWithResponse(String billingAccountName, String billingProfileName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<InstructionInner> putWithResponse(String billingAccountName, String billingProfileName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    InstructionInner put(String billingAccountName, String billingProfileName, String instructionName,
