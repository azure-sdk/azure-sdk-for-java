...
public final class BillingPeriodsClientImpl implements BillingPeriodsClient {
    ...
    /**
     * The interface defining all the services for BillingManagementClientBillingPeriods to be used by the proxy
    ...
    public interface BillingPeriodsService {
        ...
        Mono<Response<BillingPeriodsListResult>> list(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<BillingPeriodInner>> get(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
     ...
     * @return result of listing billing periods along with {@link PagedResponse} on successful completion of
     * {@link Mono}.
     */
    ...
    private Mono<PagedResponse<BillingPeriodInner>> listSinglePageAsync(String filter, String skiptoken, Integer top) {
        ...
        return FluxUtil
            .withContext(context -> service.list(this.client.getEndpoint(), this.client.getSubscriptionId(), apiVersion,
                filter, skiptoken, top, accept, context))
            .<PagedResponse<BillingPeriodInner>>map(res -> new PagedResponseBase<>(res.getRequest(),
    ...
    private Mono<PagedResponse<BillingPeriodInner>> listSinglePageAsync(String filter, String skiptoken, Integer top,
        ...
        return service
            .list(this.client.getEndpoint(), this.client.getSubscriptionId(), apiVersion, filter, skiptoken, top,
                accept, context)
    ...
    private PagedFlux<BillingPeriodInner> listAsync(String filter, String skiptoken, Integer top, Context context) {
        return new PagedFlux<>(() -> listSinglePageAsync(filter, skiptoken, top, context),
    ...
    private Mono<Response<BillingPeriodInner>> getWithResponseAsync(String billingPeriodName) {
        ...
        return FluxUtil
            .withContext(context -> service.get(this.client.getEndpoint(), this.client.getSubscriptionId(), apiVersion,
                billingPeriodName, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<BillingPeriodInner>> getWithResponseAsync(String billingPeriodName, Context context) {
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.get(this.client.getEndpoint(), this.client.getSubscriptionId(), apiVersion, billingPeriodName,
            accept, context);
    }
