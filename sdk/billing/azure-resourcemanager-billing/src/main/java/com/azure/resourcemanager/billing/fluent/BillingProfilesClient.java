...
public interface BillingProfilesClient {
    ...
    PagedIterable<BillingProfileAutoGeneratedInner> listByBillingAccount(String billingAccountName);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<BillingProfileAutoGeneratedInner> listByBillingAccount(
    ...
    Response<BillingProfileAutoGeneratedInner> getWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    BillingProfileAutoGeneratedInner get(String billingAccountName, String billingProfileName);
    ...
    SyncPoller<PollResult<BillingProfileAutoGeneratedInner>, BillingProfileAutoGeneratedInner> beginCreateOrUpdate(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    BillingProfileAutoGeneratedInner createOrUpdate(
        String billingAccountName, String billingProfileName, BillingProfileAutoGeneratedInner parameters);
