...
public interface BillingProperties {
     ...
     */
    Response<BillingProperty> getWithResponse(String subscriptionId, Context context);
     ...
     */
    BillingProperty get(String subscriptionId);
     ...
     */
    Response<BillingProperty> updateWithResponse(
     ...
     */
    BillingProperty update(String subscriptionId, BillingPropertyInner parameters);
}
