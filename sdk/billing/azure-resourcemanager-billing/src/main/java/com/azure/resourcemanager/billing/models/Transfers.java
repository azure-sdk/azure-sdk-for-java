...
public interface Transfers {
     ...
     */
    Response<TransferDetails> getWithResponse(
     ...
     */
    Response<TransferDetails> initiateWithResponse(
        String billingAccountName,
        String billingProfileName,
        String invoiceSectionName,
        String transferName,
     ...
     * @return details of the transfer along with {@link Response}.
     */
    Response<TransferDetails> cancelWithResponse(
        String billingAccountName,
        String billingProfileName,
        String invoiceSectionName,
        String transferName,
     ...
     */
    PagedIterable<TransferDetails> list(
