...
public final class RecipientTransfersClientImpl implements RecipientTransfersClient {
    ...
    RecipientTransfersClientImpl(BillingManagementClientImpl client) {
        this.service =
            RestProxy.create(RecipientTransfersService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }
    ...
    public interface RecipientTransfersService {
        ...
        Mono<Response<RecipientTransferDetailsInner>> accept(
            @HostParam("$host") String endpoint,
            @PathParam("transferName") String transferName,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") AcceptTransferRequest parameters,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ValidateTransferListResponseInner>> validate(
            @HostParam("$host") String endpoint,
            @PathParam("transferName") String transferName,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") AcceptTransferRequest parameters,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<RecipientTransferDetailsInner>> decline(
            @HostParam("$host") String endpoint,
            @PathParam("transferName") String transferName,
            @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<RecipientTransferDetailsInner>> get(
            @HostParam("$host") String endpoint,
            @PathParam("transferName") String transferName,
            @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<RecipientTransferDetailsListResult>> list(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
    ...
    private Mono<Response<RecipientTransferDetailsInner>> acceptWithResponseAsync(
        String transferName, AcceptTransferRequest parameters) {
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<RecipientTransferDetailsInner>> acceptWithResponseAsync(
        String transferName, AcceptTransferRequest parameters, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
        ...
        return service
            .accept(this.client.getEndpoint(), transferName, this.client.getApiVersion(), parameters, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<RecipientTransferDetailsInner> acceptWithResponse(
        String transferName, AcceptTransferRequest parameters, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ValidateTransferListResponseInner>> validateWithResponseAsync(
        String transferName, AcceptTransferRequest parameters) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
    ...
    private Mono<Response<ValidateTransferListResponseInner>> validateWithResponseAsync(
        ...
        return service
            .validate(
                this.client.getEndpoint(), transferName, this.client.getApiVersion(), parameters, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ValidateTransferListResponseInner> validateAsync(
        String transferName, AcceptTransferRequest parameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ValidateTransferListResponseInner> validateWithResponse(
        String transferName, AcceptTransferRequest parameters, Context context) {
    ...
    private Mono<Response<RecipientTransferDetailsInner>> declineWithResponseAsync(String transferName) {
        ...
        return FluxUtil
            .withContext(
                context ->
                    service
                        .decline(this.client.getEndpoint(), transferName, this.client.getApiVersion(), accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<RecipientTransferDetailsInner>> declineWithResponseAsync(
        String transferName, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    private Mono<Response<RecipientTransferDetailsInner>> getWithResponseAsync(String transferName) {
        ...
        return FluxUtil
            .withContext(
                context ->
                    service.get(this.client.getEndpoint(), transferName, this.client.getApiVersion(), accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<RecipientTransferDetailsInner>> listSinglePageAsync(String filter) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
        ...
        return FluxUtil
            ...
            .<PagedResponse<RecipientTransferDetailsInner>>map(
                res ->
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<RecipientTransferDetailsInner>> listSinglePageAsync(String filter, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    private PagedFlux<RecipientTransferDetailsInner> listAsync(String filter) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<RecipientTransferDetailsInner> listAsync(String filter, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<RecipientTransferDetailsInner> list(String filter, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<RecipientTransferDetailsInner>> listNextSinglePageAsync(
