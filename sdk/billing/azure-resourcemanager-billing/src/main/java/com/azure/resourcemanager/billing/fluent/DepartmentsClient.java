...
public interface DepartmentsClient {
    ...
    PagedIterable<DepartmentAutoGeneratedInner> listByBillingAccount(String billingAccountName);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<DepartmentAutoGeneratedInner> listByBillingAccount(
    ...
    Response<DepartmentAutoGeneratedInner> getWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    DepartmentAutoGeneratedInner get(String billingAccountName, String departmentName);
}
