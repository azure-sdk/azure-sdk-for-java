...
public final class BillingSubscriptionsImpl implements BillingSubscriptions {
    ...
    public PagedIterable<BillingSubscription> listByInvoiceSection(String billingAccountName, String billingProfileName,
        ...
        PagedIterable<BillingSubscriptionInner> inner = this.serviceClient().listByInvoiceSection(billingAccountName,
    ...
    public Response<BillingSubscription> updateWithResponse(String billingAccountName,
    ...
    public BillingSubscription move(String billingAccountName,
    ...
    public BillingSubscription move(String billingAccountName, TransferBillingSubscriptionRequestProperties parameters,
        Context context) {
    ...
    public Response<ValidateSubscriptionTransferEligibilityResult> validateMoveWithResponse(String billingAccountName,
    ...
    public ValidateSubscriptionTransferEligibilityResult validateMove(String billingAccountName,
        TransferBillingSubscriptionRequestProperties parameters) {
