...
public final class TransactionsClientImpl implements TransactionsClient {
    ...
    private PagedFlux<TransactionInner> listByInvoiceAsync(String billingAccountName, String invoiceName) {
        return new PagedFlux<>(() -> listByInvoiceSinglePageAsync(billingAccountName, invoiceName),
    ...
    private PagedFlux<TransactionInner> listByInvoiceAsync(String billingAccountName, String invoiceName,
        Context context) {
        return new PagedFlux<>(() -> listByInvoiceSinglePageAsync(billingAccountName, invoiceName, context),
