...
public interface PaymentMethodsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<PaymentMethodLinkInner> listByBillingProfile(
    ...
    Response<PaymentMethodLinkInner> getByBillingProfileWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    PaymentMethodLinkInner getByBillingProfile(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<PaymentMethodInner> getByBillingAccountWithResponse(
