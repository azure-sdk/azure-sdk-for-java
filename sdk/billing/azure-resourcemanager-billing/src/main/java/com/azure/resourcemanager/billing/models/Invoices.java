...
public interface Invoices {
     ...
     */
    DocumentDownloadResult downloadMultipleByBillingAccount(String billingAccountName);
     ...
     * @return a URL to download multiple invoice documents (invoice pdf, tax receipts, credit notes) as a zip file.
     */
    DocumentDownloadResult downloadMultipleByBillingAccount(
     ...
     * @return a URL to download an invoice document.
     */
    DocumentDownloadResult downloadByBillingAccount(
     ...
     * @return a URL to download the summary document for an invoice.
     */
    DocumentDownloadResult downloadSummaryByBillingAccount(
     ...
     * @return a URL to download multiple invoice documents (invoice pdf, tax receipts, credit notes) as a zip file.
     */
    DocumentDownloadResult downloadMultipleByBillingSubscription(String subscriptionId);
     ...
     * @return a URL to download multiple invoice documents (invoice pdf, tax receipts, credit notes) as a zip file.
     */
    DocumentDownloadResult downloadMultipleByBillingSubscription(
     ...
     */
    DocumentDownloadResult downloadByBillingSubscription(String subscriptionId, String invoiceName);
     ...
     * @return a secure URL that can be used to download a an entity until the URL expires.
     */
    DocumentDownloadResult downloadByBillingSubscription(
     ...
     */
    Response<Invoice> getByBillingSubscriptionWithResponse(String subscriptionId, String invoiceName, Context context);
     ...
     */
    Invoice getByBillingSubscription(String subscriptionId, String invoiceName);
     ...
     * @return a container for a list of resources as paginated response with {@link PagedIterable}.
     */
    PagedIterable<Invoice> listByBillingSubscription(String subscriptionId);
