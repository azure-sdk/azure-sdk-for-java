...
public final class PrivateIpAddressesFilter {
    ...
    /**
     * Get the subnetId property: The [OCID](/Content/General/Concepts/identifiers.htm) of the resource.
     * 
    ...
    /**
     * Set the subnetId property: The [OCID](/Content/General/Concepts/identifiers.htm) of the resource.
     * 
    ...
    /**
     * Get the vnicId property: The [OCID](/Content/General/Concepts/identifiers.htm) of the resource.
     * 
    ...
    /**
     * Set the vnicId property: The [OCID](/Content/General/Concepts/identifiers.htm) of the resource.
     * 
    ...
    public void validate() {
        if (subnetId() == null) {
            throw LOGGER.logExceptionAsError(
                new IllegalArgumentException("Missing required property subnetId in model PrivateIpAddressesFilter"));
        }
        if (vnicId() == null) {
            throw LOGGER.logExceptionAsError(
