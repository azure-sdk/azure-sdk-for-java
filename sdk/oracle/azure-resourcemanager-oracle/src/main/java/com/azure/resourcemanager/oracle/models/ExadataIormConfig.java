...
public final class ExadataIormConfig {
    ...
    private IormLifecycleState provisioningState;
    ...
    /**
     * Get the provisioningState property: The current state of IORM configuration for the Exadata DB system.
     * 
     * @return the provisioningState value.
     */
    public IormLifecycleState provisioningState() {
        return this.provisioningState;
    }

    /**
     * Set the provisioningState property: The current state of IORM configuration for the Exadata DB system.
     * 
     * @param provisioningState the provisioningState value to set.
     * @return the ExadataIormConfig object itself.
     */
    public ExadataIormConfig withProvisioningState(IormLifecycleState provisioningState) {
