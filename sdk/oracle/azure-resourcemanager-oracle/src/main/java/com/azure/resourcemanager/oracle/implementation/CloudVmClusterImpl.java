...
public final class CloudVmClusterImpl implements CloudVmCluster, CloudVmCluster.Definition, CloudVmCluster.Update {
    ...
    public List<NsgCidr> nsgCidrs() {
        List<NsgCidr> inner = this.innerModel().nsgCidrs();
        if (inner != null) {
            return Collections.unmodifiableList(inner);
        } else {
            return Collections.emptyList();
    ...
    public CloudVmClusterImpl withNsgCidrs(List<NsgCidr> nsgCidrs) {
        this.innerModel().withNsgCidrs(nsgCidrs);
        return this;
    }
