...
public final class VirtualNetworkAddressesImpl implements VirtualNetworkAddresses {
    ...
    public PagedIterable<VirtualNetworkAddress> listByCloudVmCluster(String resourceGroupName,
        ...
        return Utils.mapPage(inner, inner1 -> new VirtualNetworkAddressImpl(inner1, this.manager()));
    }
    ...
    public Response<VirtualNetworkAddress> getWithResponse(String resourceGroupName, String cloudvmclustername,
        ...
        Response<VirtualNetworkAddressInner> inner = this.serviceClient().getWithResponse(resourceGroupName,
            cloudvmclustername, virtualnetworkaddressname, context);
        if (inner != null) {
    ...
    public VirtualNetworkAddress getById(String id) {
        ...
        String virtualnetworkaddressname = Utils.getValueFromIdByName(id, "virtualNetworkAddresses");
