...
public final class MaintenanceWindow {
     ...
     * values are - 0 - represents time slot 0:00 - 3:59 UTC - 4 - represents time slot 4:00 - 7:59 UTC - 8 -
     * represents time slot 8:00 - 11:59 UTC - 12 - represents time slot 12:00 - 15:59 UTC - 16 - represents time slot
     ...
     * dates, not days of the week. For example, to allow maintenance during the 2nd week of the month (from the 8th
     * day to the 14th day of the month), use the value 2. Maintenance cannot be scheduled for the fifth week of months
     * that contain more than 28 days. Note that this parameter works in conjunction with the daysOfWeek and
     * hoursOfDay parameters to allow you to specify specific days of the week and hours that maintenance will be
     * performed.
     * 
    ...
    /**
     * Get the leadTimeInWeeks property: Lead time window allows user to set a lead time to prepare for a down time.
    ...
    /**
     * Set the leadTimeInWeeks property: Lead time window allows user to set a lead time to prepare for a down time.
     * The lead time is in weeks and valid value is between 1 to 4.
     * 
