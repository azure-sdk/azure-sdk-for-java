...
@Fluent
public final class OrchestratorVersionProfileAutoGenerated {
    /*
     * Orchestrator type.
     */
     ...
     * @return the OrchestratorVersionProfileAutoGenerated object itself.
     */
    public OrchestratorVersionProfileAutoGenerated withOrchestratorType(String orchestratorType) {
     ...
     * @return the OrchestratorVersionProfileAutoGenerated object itself.
     */
    public OrchestratorVersionProfileAutoGenerated withOrchestratorVersion(String orchestratorVersion) {
     ...
     * @return the OrchestratorVersionProfileAutoGenerated object itself.
     */
    public OrchestratorVersionProfileAutoGenerated withDefaultProperty(Boolean defaultProperty) {
     ...
     * @return the OrchestratorVersionProfileAutoGenerated object itself.
     */
    public OrchestratorVersionProfileAutoGenerated withIsPreview(Boolean isPreview) {
     ...
     * @return the OrchestratorVersionProfileAutoGenerated object itself.
     */
    public OrchestratorVersionProfileAutoGenerated withUpgrades(List<OrchestratorProfile> upgrades) {
            ...
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException(
                        "Missing required property orchestratorType in model OrchestratorVersionProfileAutoGenerated"));
        }
        if (orchestratorVersion() == null) {
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException(
                        "Missing required property orchestratorVersion in model"
                            + " OrchestratorVersionProfileAutoGenerated"));
        }
        if (upgrades() != null) {
    ...
    private static final ClientLogger LOGGER = new ClientLogger(OrchestratorVersionProfileAutoGenerated.class);
}
