...
public final class AgentPoolInner extends SubResource {
     ...
     * @return the AgentPoolInner object itself.
     */
    public AgentPoolInner withCurrentOrchestratorVersion(String currentOrchestratorVersion) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ManagedClusterAgentPoolProfileProperties();
        }
        this.innerProperties().withCurrentOrchestratorVersion(currentOrchestratorVersion);
        return this;
    }
