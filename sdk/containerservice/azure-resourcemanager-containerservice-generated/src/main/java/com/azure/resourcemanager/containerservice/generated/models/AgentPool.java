...
public interface AgentPool {
    ...
    /**
     * Gets the currentOrchestratorVersion property: The version of Kubernetes running on the Agent Pool. If
    ...
    /**
     * Gets the enableCustomCATrust property: Whether to enable Custom CA Trust feature. When set to true, AKS deploys a
     * daemonset and host services to sync custom certificate authorities from a user-provided config map into node
    ...
    /**
     * Gets the scaleSetEvictionPolicy property: The Virtual Machine Scale Set eviction policy. This cannot be specified
    ...
    /**
     * Gets the kubeletConfig property: Kubelet configurations of agent nodes. The Kubelet configuration on the agent
     * pool nodes.
     *
    ...
    /**
     * Gets the linuxOSConfig property: OS configurations of Linux agent nodes. The OS configuration of Linux agent
     * nodes.
     *
    ...
    interface DefinitionStages {
        ...
        interface WithCreate
            extends DefinitionStages.WithTags,
                ...
                DefinitionStages.WithCurrentOrchestratorVersion,
        ...
        interface WithVmSize {
             ...
             *     insufficient compute resources (memory, cpu, etc) pods might fail to run correctly. For more details
             *     on restricted VM sizes, see: https://docs.microsoft.com/azure/aks/quotas-skus-regions.
             * @return the next definition stage.
             */
        ...
        interface WithOsDiskType {
             ...
             *     if the VM supports it and has a cache disk larger than the requested OSDiskSizeGB. Otherwise,
             *     defaults to 'Managed'. May not be changed after creation. For more information see [Ephemeral
             *     OS](https://docs.microsoft.com/azure/aks/cluster-configuration#ephemeral-os).
             * @return the next definition stage.
             */
        ...
        interface WithOrchestratorVersion {
             ...
             * version &lt;major.minor.patch&gt; and &lt;major.minor&gt; are supported. When &lt;major.minor&gt; is
             * specified, the latest supported patch version is chosen automatically. Updating the agent pool with the
             * same &lt;major.minor&gt; once it has been created will not trigger an upgrade, even if a newer patch
             * version is available. As a best practice, you should upgrade all node pools in an AKS cluster to the same
             * Kubernetes version. The node pool version must have the same major version as the control plane. The node
             * pool minor version must be within two minor versions of the control plane version. The node pool version
             ...
             *     specified, the latest supported patch version is chosen automatically. Updating the agent pool with
             *     the same &lt;major.minor&gt; once it has been created will not trigger an upgrade, even if a newer
             *     patch version is available. As a best practice, you should upgrade all node pools in an AKS cluster
             *     to the same Kubernetes version. The node pool version must have the same major version as the control
             *     plane. The node pool minor version must be within two minor versions of the control plane version.
             *     The node pool version cannot be greater than the control plane version. For more information see
             *     [upgrading a node
             *     pool](https://docs.microsoft.com/azure/aks/use-multiple-node-pools#upgrade-a-node-pool).
             * @return the next definition stage.
             */
        ...
        /** The stage of the AgentPool definition allowing to specify currentOrchestratorVersion. */
        interface WithCurrentOrchestratorVersion {
            /**
             * Specifies the currentOrchestratorVersion property: The version of Kubernetes running on the Agent Pool.
             * If orchestratorVersion was a fully specified version &lt;major.minor.patch&gt;, this field will be
             ...
             *
             * @param currentOrchestratorVersion The version of Kubernetes running on the Agent Pool. If
             *     orchestratorVersion was a fully specified version &lt;major.minor.patch&gt;, this field will be
             *     exactly equal to it. If orchestratorVersion was &lt;major.minor&gt;, this field will contain the full
             *     &lt;major.minor.patch&gt; version being used.
             * @return the next definition stage.
             */
            WithCreate withCurrentOrchestratorVersion(String currentOrchestratorVersion);
        }
        ...
        interface WithEnableNodePublicIp {
             ...
             *     nodes in a node pool to receive their own dedicated public IP addresses. A common scenario is for
             *     gaming workloads, where a console needs to make a direct connection to a cloud virtual machine to
        ...
        interface WithEnableCustomCATrust {
            /**
             * Specifies the enableCustomCATrust property: Whether to enable Custom CA Trust feature. When set to true,
             * AKS deploys a daemonset and host services to sync custom certificate authorities from a user-provided
             * config map into node trust stores. Defaults to false..
             *
             * @param enableCustomCATrust Whether to enable Custom CA Trust feature. When set to true, AKS deploys a
             *     daemonset and host services to sync custom certificate authorities from a user-provided config map
             *     into node trust stores. Defaults to false.
             * @return the next definition stage.
             */
        ...
        interface WithScaleSetEvictionPolicy {
            /**
             * Specifies the scaleSetEvictionPolicy property: The Virtual Machine Scale Set eviction policy. This cannot
             * be specified unless the scaleSetPriority is 'Spot'. If not specified, the default is 'Delete'..
             *
             * @param scaleSetEvictionPolicy The Virtual Machine Scale Set eviction policy. This cannot be specified
             *     unless the scaleSetPriority is 'Spot'. If not specified, the default is 'Delete'.
             * @return the next definition stage.
             */
        ...
        interface WithSpotMaxPrice {
             ...
             *     on-demand. Possible values are any decimal value greater than zero or -1 which indicates the
             *     willingness to pay any on-demand price. For more details on spot pricing, see [spot VMs
             *     pricing](https://docs.microsoft.com/azure/virtual-machines/spot-vms#pricing).
             * @return the next definition stage.
             */
        ...
        interface WithKubeletConfig {
            /**
             * Specifies the kubeletConfig property: Kubelet configurations of agent nodes. The Kubelet configuration on
             * the agent pool nodes..
             *
             * @param kubeletConfig Kubelet configurations of agent nodes. The Kubelet configuration on the agent pool
             *     nodes.
             * @return the next definition stage.
             */
        ...
        interface WithLinuxOSConfig {
            /**
             * Specifies the linuxOSConfig property: OS configurations of Linux agent nodes. The OS configuration of
             * Linux agent nodes..
             *
             * @param linuxOSConfig OS configurations of Linux agent nodes. The OS configuration of Linux agent nodes.
             * @return the next definition stage.
             */
        ...
        interface WithHostGroupId {
             ...
             *     machines from, used only in creation scenario and not allowed to changed once set. This is of the
             *     form:
             *     /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/hostGroups/{hostGroupName}.
             *     For more information see [Azure dedicated
             *     hosts](https://docs.microsoft.com/azure/virtual-machines/dedicated-hosts).
    ...
    interface Update
        extends UpdateStages.WithTags,
            ...
            UpdateStages.WithCurrentOrchestratorVersion,
    ...
    interface UpdateStages {
        ...
        /** The stage of the AgentPool update allowing to specify currentOrchestratorVersion. */
        interface WithCurrentOrchestratorVersion {
            /**
             * Specifies the currentOrchestratorVersion property: The version of Kubernetes running on the Agent Pool.
             * If orchestratorVersion was a fully specified version &lt;major.minor.patch&gt;, this field will be
             ...
             * @return the next definition stage.
             */
            Update withCurrentOrchestratorVersion(String currentOrchestratorVersion);
        }
