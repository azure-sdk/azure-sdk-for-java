...
public final class NetworkProfileForSnapshot {
    ...
    /*
     * The network mode Azure CNI is configured with. networkMode for managed
     * cluster snapshot.
     */
    ...
    /*
     * The load balancer sku for the managed cluster. loadBalancerSku for
    ...
    /**
     * Get the networkMode property: The network mode Azure CNI is configured with. networkMode for managed cluster
     * snapshot.
     *
    ...
    /**
     * Set the networkMode property: The network mode Azure CNI is configured with. networkMode for managed cluster
     * snapshot.
     *
    ...
    /**
     * Get the loadBalancerSku property: The load balancer sku for the managed cluster. loadBalancerSku for managed
     * cluster snapshot.
     *
    ...
    /**
     * Set the loadBalancerSku property: The load balancer sku for the managed cluster. loadBalancerSku for managed
     * cluster snapshot.
     *
