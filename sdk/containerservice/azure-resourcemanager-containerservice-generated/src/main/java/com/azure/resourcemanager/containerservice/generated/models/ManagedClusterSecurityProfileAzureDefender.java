...
public final class ManagedClusterSecurityProfileAzureDefender {
    ...
    /*
     * Resource ID of the Log Analytics workspace to be associated with Azure Defender.  When Azure Defender is
     * enabled, this field is required and must be a valid workspace resource ID. When Azure Defender is disabled,
