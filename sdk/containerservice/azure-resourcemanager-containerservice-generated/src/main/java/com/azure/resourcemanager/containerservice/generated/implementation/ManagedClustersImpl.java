...
public final class ManagedClustersImpl implements ManagedClusters {
    ...
    public ManagedCluster abortLatestOperation(String resourceGroupName, String resourceName) {
        ManagedClusterInner inner = this.serviceClient().abortLatestOperation(resourceGroupName, resourceName);
        if (inner != null) {
            return new ManagedClusterImpl(inner, this.manager());
        } else {
            return null;
    ...
    public ManagedCluster abortLatestOperation(String resourceGroupName, String resourceName, Context context) {
        ManagedClusterInner inner = this.serviceClient().abortLatestOperation(resourceGroupName, resourceName, context);
        if (inner != null) {
            return new ManagedClusterImpl(inner, this.manager());
        } else {
            return null;
