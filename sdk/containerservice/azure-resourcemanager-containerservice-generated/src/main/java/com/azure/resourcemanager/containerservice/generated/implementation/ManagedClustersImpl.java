...
public final class ManagedClustersImpl implements ManagedClusters {
    ...
    public void delete(String resourceGroupName, String resourceName, Boolean noPoddisruptionbudget) {
        this.serviceClient().delete(resourceGroupName, resourceName, noPoddisruptionbudget);
    }
    ...
    public void delete(String resourceGroupName, String resourceName, Boolean noPoddisruptionbudget, Context context) {
        this.serviceClient().delete(resourceGroupName, resourceName, noPoddisruptionbudget, context);
    }
    ...
    public void deleteById(String id) {
        ...
        Boolean localNoPoddisruptionbudget = null;
        this.delete(resourceGroupName, resourceName, localNoPoddisruptionbudget, Context.NONE);
    }

    public void deleteByIdWithResponse(String id, Boolean noPoddisruptionbudget, Context context) {
        String resourceGroupName = Utils.getValueFromIdByName(id, "resourceGroups");
        if (resourceGroupName == null) {
            throw LOGGER
                .logExceptionAsError(
        ...
        this.delete(resourceGroupName, resourceName, noPoddisruptionbudget, context);
    }
