...
public interface TrustedAccessRoleBindingsClient {
    ...
    TrustedAccessRoleBindingListResultInner list(String resourceGroupName, String resourceName);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<TrustedAccessRoleBindingListResultInner> listWithResponse(
