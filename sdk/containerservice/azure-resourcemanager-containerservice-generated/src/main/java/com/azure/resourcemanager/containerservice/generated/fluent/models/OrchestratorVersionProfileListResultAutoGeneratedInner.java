...
@Fluent
public final class OrchestratorVersionProfileListResultAutoGeneratedInner {
    /*
    ...
    private OrchestratorVersionProfilePropertiesAutoGenerated innerProperties =
        new OrchestratorVersionProfilePropertiesAutoGenerated();
     ...
     * @return the OrchestratorVersionProfileListResultAutoGeneratedInner object itself.
     */
    public OrchestratorVersionProfileListResultAutoGeneratedInner withOrchestrators(
        List<OrchestratorVersionProfileAutoGenerated> orchestrators) {
        if (this.innerProperties() == null) {
            this.innerProperties = new OrchestratorVersionProfilePropertiesAutoGenerated();
        }
                ...
                .logExceptionAsError(
                    new IllegalArgumentException(
                        "Missing required property innerProperties in model"
                            + " OrchestratorVersionProfileListResultAutoGeneratedInner"));
        } else {
    ...
    private static final ClientLogger LOGGER =
        new ClientLogger(OrchestratorVersionProfileListResultAutoGeneratedInner.class);
}
