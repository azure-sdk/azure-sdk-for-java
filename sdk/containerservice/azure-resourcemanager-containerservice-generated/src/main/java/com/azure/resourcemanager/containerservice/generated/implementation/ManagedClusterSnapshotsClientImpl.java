...
import com.azure.resourcemanager.containerservice.generated.models.ManagedClusterSnapshotListResult;
...
public final class ManagedClusterSnapshotsClientImpl implements ManagedClusterSnapshotsClient {
    ...
    private interface ManagedClusterSnapshotsService {
    ...
    private Mono<ManagedClusterSnapshotInner> getByResourceGroupAsync(String resourceGroupName, String resourceName) {
        return getByResourceGroupWithResponseAsync(resourceGroupName, resourceName)
            .flatMap(
                (Response<ManagedClusterSnapshotInner> res) -> {
