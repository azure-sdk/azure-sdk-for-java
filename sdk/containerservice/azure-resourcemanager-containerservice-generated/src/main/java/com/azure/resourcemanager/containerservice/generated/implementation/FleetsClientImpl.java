...
import com.azure.resourcemanager.containerservice.generated.fluent.FleetsClient;
...
import com.azure.resourcemanager.containerservice.generated.models.FleetListResult;
...
public final class FleetsClientImpl implements FleetsClient {
    ...
    private interface FleetsService {
    ...
    public SyncPoller<PollResult<FleetInner>, FleetInner> beginCreateOrUpdate(
        String resourceGroupName, String fleetName, FleetInner parameters, String ifMatch, String ifNoneMatch) {
        return beginCreateOrUpdateAsync(resourceGroupName, fleetName, parameters, ifMatch, ifNoneMatch).getSyncPoller();
    }
    ...
    public FleetInner update(String resourceGroupName, String fleetName) {
        final String ifMatch = null;
        final FleetPatch parameters = null;
        return updateAsync(resourceGroupName, fleetName, ifMatch, parameters).block();
    }
    ...
    public FleetInner getByResourceGroup(String resourceGroupName, String fleetName) {
        return getByResourceGroupAsync(resourceGroupName, fleetName).block();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String fleetName, String ifMatch) {
        return beginDeleteAsync(resourceGroupName, fleetName, ifMatch).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(
        String resourceGroupName, String fleetName, String ifMatch, Context context) {
        return beginDeleteAsync(resourceGroupName, fleetName, ifMatch, context).getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public void delete(String resourceGroupName, String fleetName, String ifMatch) {
    ...
    public FleetCredentialResultsInner listCredentials(String resourceGroupName, String fleetName) {
        return listCredentialsAsync(resourceGroupName, fleetName).block();
    }
