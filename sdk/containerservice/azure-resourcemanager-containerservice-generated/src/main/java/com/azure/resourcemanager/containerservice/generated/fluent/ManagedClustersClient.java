...
public interface ManagedClustersClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    void delete(String resourceGroupName, String resourceName, Boolean noPoddisruptionbudget);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    void delete(String resourceGroupName, String resourceName, Boolean noPoddisruptionbudget, Context context);
