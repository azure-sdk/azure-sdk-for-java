...
public interface ManagedClustersClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<ManagedClusterInner>, ManagedClusterInner> beginAbortLatestOperation(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ManagedClusterInner abortLatestOperation(String resourceGroupName, String resourceName);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ManagedClusterInner abortLatestOperation(String resourceGroupName, String resourceName, Context context);
