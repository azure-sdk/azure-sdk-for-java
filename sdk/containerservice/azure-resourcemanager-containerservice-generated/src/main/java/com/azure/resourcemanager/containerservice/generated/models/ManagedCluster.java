...
public interface ManagedCluster {
    ...
    /**
     * Gets the kubernetesVersion property: The version of Kubernetes the Managed Cluster is running. When you upgrade a
    ...
    /**
     * Gets the publicNetworkAccess property: Whether the cluster can be accessed through public network or not Default
    ...
    interface DefinitionStages {
        ...
        interface WithKubernetesVersion {
            /**
             * Specifies the kubernetesVersion property: The version of Kubernetes the Managed Cluster is running. When
             * you upgrade a supported AKS cluster, Kubernetes minor versions cannot be skipped. All upgrades must be
             ...
             * cluster](https://docs.microsoft.com/azure/aks/upgrade-cluster) for more details..
             *
             * @param kubernetesVersion The version of Kubernetes the Managed Cluster is running. When you upgrade a
             *     supported AKS cluster, Kubernetes minor versions cannot be skipped. All upgrades must be performed
        ...
        interface WithPublicNetworkAccess {
            /**
             * Specifies the publicNetworkAccess property: Whether the cluster can be accessed through public network or
             * not Default value is 'Enabled' (case insensitive). Could be set to 'Disabled' to enable private cluster.
             *
             * @param publicNetworkAccess Whether the cluster can be accessed through public network or not Default
             *     value is 'Enabled' (case insensitive). Could be set to 'Disabled' to enable private cluster.
             * @return the next definition stage.
             */
