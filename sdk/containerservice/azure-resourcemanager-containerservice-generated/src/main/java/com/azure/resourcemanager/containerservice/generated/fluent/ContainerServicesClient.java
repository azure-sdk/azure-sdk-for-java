...
public interface ContainerServicesClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    OrchestratorVersionProfileListResultAutoGeneratedInner listOrchestrators(String location);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<OrchestratorVersionProfileListResultAutoGeneratedInner> listOrchestratorsWithResponse(
        String location, String resourceType, Context context);
}
