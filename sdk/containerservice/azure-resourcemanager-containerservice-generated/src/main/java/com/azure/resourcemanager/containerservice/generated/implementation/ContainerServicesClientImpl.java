...
public final class ContainerServicesClientImpl implements ContainerServicesClient {
    ...
    private interface ContainerServicesService {
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<OrchestratorVersionProfileListResultAutoGeneratedInner>> listOrchestrators(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("location") String location,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<OrchestratorVersionProfileListResultInner> listOrchestratorsAsync(
        String location, String resourceType) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<OrchestratorVersionProfileListResultInner> listOrchestratorsAsync(String location) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<OrchestratorVersionProfileListResultAutoGeneratedInner>> listOrchestratorsWithResponseAsync(
        String location, String resourceType) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<OrchestratorVersionProfileListResultAutoGeneratedInner> listOrchestratorsAsync(
        String location, String resourceType) {
        return listOrchestratorsWithResponseAsync(location, resourceType)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<OrchestratorVersionProfileListResultAutoGeneratedInner> listOrchestratorsAsync(String location) {
        final String resourceType = null;
        return listOrchestratorsWithResponseAsync(location, resourceType)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public OrchestratorVersionProfileListResultAutoGeneratedInner listOrchestrators(String location) {
        final String resourceType = null;
        return listOrchestratorsAsync(location, resourceType).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<OrchestratorVersionProfileListResultAutoGeneratedInner> listOrchestratorsWithResponse(
        String location, String resourceType, Context context) {
        return listOrchestratorsWithResponseAsync(location, resourceType, context).block();
    }
}
