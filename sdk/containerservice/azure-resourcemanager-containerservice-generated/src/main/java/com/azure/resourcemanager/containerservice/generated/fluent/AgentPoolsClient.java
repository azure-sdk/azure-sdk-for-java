...
public interface AgentPoolsClient {
    ...
    SyncPoller<PollResult<AgentPoolInner>, AgentPoolInner> beginAbortLatestOperation(
    ...
    AgentPoolInner abortLatestOperation(String resourceGroupName, String resourceName, String agentPoolName);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    AgentPoolInner abortLatestOperation(
        String resourceGroupName, String resourceName, String agentPoolName, Context context);
