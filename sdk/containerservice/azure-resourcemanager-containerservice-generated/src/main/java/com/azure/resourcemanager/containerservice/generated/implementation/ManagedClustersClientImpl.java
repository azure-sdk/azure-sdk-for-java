...
public final class ManagedClustersClientImpl implements ManagedClustersClient {
    ...
    private interface ManagedClustersService {
        ...
        Mono<Response<Flux<ByteBuffer>>> delete(
            ...
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("resourceName") String resourceName,
            @QueryParam("no-poddisruptionbudget") Boolean noPoddisruptionbudget,
            @HeaderParam("Accept") String accept,
            Context context);
    ...
    private Mono<Response<OSOptionProfileInner>> getOSOptionsWithResponseAsync(String location, String resourceType) {
        ...
        final String apiVersion = "2022-03-02-preview";
     ...
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
     * @param resourceName The name of the managed cluster resource.
     * @param noPoddisruptionbudget no-poddisruptionbudget=true to delete those pods on a node without considering Pod
     *     Disruption Budget.
     * @throws IllegalArgumentException thrown if parameters fail the validation.
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
    ...
    private Mono<Response<Flux<ByteBuffer>>> deleteWithResponseAsync(
        String resourceGroupName, String resourceName, Boolean noPoddisruptionbudget) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> deleteWithResponseAsync(
        String resourceGroupName, String resourceName, Boolean noPoddisruptionbudget, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    private PollerFlux<PollResult<Void>, Void> beginDeleteAsync(
        String resourceGroupName, String resourceName, Boolean noPoddisruptionbudget) {
        Mono<Response<Flux<ByteBuffer>>> mono =
            deleteWithResponseAsync(resourceGroupName, resourceName, noPoddisruptionbudget);
        return this
            .client
    ...
    private PollerFlux<PollResult<Void>, Void> beginDeleteAsync(
        ...
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono =
            deleteWithResponseAsync(resourceGroupName, resourceName, noPoddisruptionbudget, context);
        return this
            .client
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(
        String resourceGroupName, String resourceName, Boolean noPoddisruptionbudget) {
        return beginDeleteAsync(resourceGroupName, resourceName, noPoddisruptionbudget).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(
        String resourceGroupName, String resourceName, Boolean noPoddisruptionbudget, Context context) {
        return beginDeleteAsync(resourceGroupName, resourceName, noPoddisruptionbudget, context).getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> deleteAsync(String resourceGroupName, String resourceName, Boolean noPoddisruptionbudget) {
        return beginDeleteAsync(resourceGroupName, resourceName, noPoddisruptionbudget)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String resourceName) {
        final Boolean noPoddisruptionbudget = null;
        return beginDeleteAsync(resourceGroupName, resourceName, noPoddisruptionbudget)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<Void> deleteAsync(
        String resourceGroupName, String resourceName, Boolean noPoddisruptionbudget, Context context) {
        return beginDeleteAsync(resourceGroupName, resourceName, noPoddisruptionbudget, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public void delete(String resourceGroupName, String resourceName, Boolean noPoddisruptionbudget) {
        deleteAsync(resourceGroupName, resourceName, noPoddisruptionbudget).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public void delete(String resourceGroupName, String resourceName, Boolean noPoddisruptionbudget, Context context) {
        deleteAsync(resourceGroupName, resourceName, noPoddisruptionbudget, context).block();
    }
