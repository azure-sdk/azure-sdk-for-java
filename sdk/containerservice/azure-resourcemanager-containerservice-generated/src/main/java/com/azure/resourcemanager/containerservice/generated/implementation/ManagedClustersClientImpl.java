...
import com.azure.resourcemanager.containerservice.generated.models.OutboundEnvironmentEndpointCollection;
...
public final class ManagedClustersClientImpl implements ManagedClustersClient {
    ...
    private interface ManagedClustersService {
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Void>> abortLatestOperation(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
        ...
        @Post(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerService"
                + "/managedClusters/{resourceName}/rotateServiceAccountSigningKeys")
        @ExpectedResponses({202, 204})
        @UnexpectedResponseExceptionType(ManagementException.class)
     ...
     * @param resourceType The resource type for which the OS options or list of orchestrators needs to be returned.
    ...
    private Mono<Response<OSOptionProfileInner>> getOSOptionsWithResponseAsync(String location, String resourceType) {
        ...
        final String apiVersion = "2022-08-03-preview";
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(
        String resourceGroupName, String resourceName, Boolean ignorePodDisruptionBudget) {
        return beginDeleteAsync(resourceGroupName, resourceName, ignorePodDisruptionBudget).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(
        String resourceGroupName, String resourceName, Boolean ignorePodDisruptionBudget, Context context) {
        return beginDeleteAsync(resourceGroupName, resourceName, ignorePodDisruptionBudget, context).getSyncPoller();
    }
     ...
     *
     * <p>Aborting last running operation on managed cluster. We return a 204 no content code here to indicate that the
     * operation has been accepted and an abort will be attempted but is not guaranteed to complete successfully. Please
     * look up the provisioning state of the managed cluster to keep track of whether it changes to Canceled. A canceled
     * provisioning state indicates that the abort was successful.
     *
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
     * @param resourceName The name of the managed cluster resource.
     * @throws IllegalArgumentException thrown if parameters fail the validation.
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Void>> abortLatestOperationWithResponseAsync(String resourceGroupName, String resourceName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Void>> abortLatestOperationWithResponseAsync(
        String resourceGroupName, String resourceName, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
    ...
    private Mono<Void> abortLatestOperationAsync(String resourceGroupName, String resourceName) {
        return abortLatestOperationWithResponseAsync(resourceGroupName, resourceName).flatMap(ignored -> Mono.empty());
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<Void> abortLatestOperationWithResponse(
        String resourceGroupName, String resourceName, Context context) {
        return abortLatestOperationWithResponseAsync(resourceGroupName, resourceName, context).block();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginRotateServiceAccountSigningKeys(
        String resourceGroupName, String resourceName) {
        return beginRotateServiceAccountSigningKeysAsync(resourceGroupName, resourceName).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginRotateServiceAccountSigningKeys(
        String resourceGroupName, String resourceName, Context context) {
        return beginRotateServiceAccountSigningKeysAsync(resourceGroupName, resourceName, context).getSyncPoller();
    }
