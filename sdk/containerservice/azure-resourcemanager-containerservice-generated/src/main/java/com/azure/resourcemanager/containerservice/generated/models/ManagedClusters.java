...
public interface ManagedClusters {
     ...
     * @return the response.
     */
    ManagedCluster abortLatestOperation(String resourceGroupName, String resourceName);
     ...
     * @return the response.
     */
    ManagedCluster abortLatestOperation(String resourceGroupName, String resourceName, Context context);
