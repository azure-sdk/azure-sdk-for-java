...
public interface ManagedClusters {
     ...
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     */
    void delete(String resourceGroupName, String resourceName, Boolean ignorePodDisruptionBudget);
     ...
     */
    Response<Void> abortLatestOperationWithResponse(String resourceGroupName, String resourceName, Context context);
