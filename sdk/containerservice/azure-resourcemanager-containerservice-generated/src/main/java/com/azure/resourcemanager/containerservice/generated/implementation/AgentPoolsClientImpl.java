...
public final class AgentPoolsClientImpl implements AgentPoolsClient {
     ...
     *
     * <p>Aborting last running operation on agent pool. We return a 204 no content code here to indicate that the
     * operation has been accepted and an abort will be attempted but is not guaranteed to complete successfully. Please
     * look up the provisioning state of the agent pool to keep track of whether it changes to Canceled. A canceled
    ...
    private Mono<Void> abortLatestOperationAsync(String resourceGroupName, String resourceName, String agentPoolName) {
        return abortLatestOperationWithResponseAsync(resourceGroupName, resourceName, agentPoolName)
    ...
    public Response<Void> abortLatestOperationWithResponse(
        String resourceGroupName, String resourceName, String agentPoolName, Context context) {
        return abortLatestOperationWithResponseAsync(resourceGroupName, resourceName, agentPoolName, context).block();
    }
    ...
    public void abortLatestOperation(String resourceGroupName, String resourceName, String agentPoolName) {
        abortLatestOperationWithResponse(resourceGroupName, resourceName, agentPoolName, Context.NONE);
    }
