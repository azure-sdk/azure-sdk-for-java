...
public final class AgentPoolsClientImpl implements AgentPoolsClient {
    ...
    private interface AgentPoolsService {
        ...
        @Post(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerService"
                + "/managedclusters/{resourceName}/agentPools/{agentPoolName}/abort")
     ...
     * and eventually to a Canceled state when cancellation finishes. If the operation completes before cancelation can
    ...
    private PollerFlux<PollResult<AgentPoolInner>, AgentPoolInner> beginAbortLatestOperationAsync(
        String resourceGroupName, String resourceName, String agentPoolName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<AgentPoolInner>, AgentPoolInner> beginAbortLatestOperation(
        String resourceGroupName, String resourceName, String agentPoolName) {
        return beginAbortLatestOperationAsync(resourceGroupName, resourceName, agentPoolName).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<AgentPoolInner>, AgentPoolInner> beginAbortLatestOperation(
        String resourceGroupName, String resourceName, String agentPoolName, Context context) {
        return beginAbortLatestOperationAsync(resourceGroupName, resourceName, agentPoolName, context).getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<AgentPoolInner> abortLatestOperationAsync(
        String resourceGroupName, String resourceName, String agentPoolName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public AgentPoolInner abortLatestOperation(String resourceGroupName, String resourceName, String agentPoolName) {
        return abortLatestOperationAsync(resourceGroupName, resourceName, agentPoolName).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public AgentPoolInner abortLatestOperation(
        String resourceGroupName, String resourceName, String agentPoolName, Context context) {
        return abortLatestOperationAsync(resourceGroupName, resourceName, agentPoolName, context).block();
    }
