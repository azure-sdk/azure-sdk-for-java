...
public final class AgentPoolsClientImpl implements AgentPoolsClient {
    ...
    private Mono<Response<Flux<ByteBuffer>>> deleteWithResponseAsync(
        String resourceGroupName, String resourceName, String agentPoolName, Boolean noPoddisruptionbudget) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    private PollerFlux<PollResult<Void>, Void> beginDeleteAsync(
        String resourceGroupName, String resourceName, String agentPoolName, Boolean noPoddisruptionbudget) {
        Mono<Response<Flux<ByteBuffer>>> mono =
            deleteWithResponseAsync(resourceGroupName, resourceName, agentPoolName, noPoddisruptionbudget);
        return this
            .client
    ...
    private PollerFlux<PollResult<Void>, Void> beginDeleteAsync(
        ...
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono =
            deleteWithResponseAsync(resourceGroupName, resourceName, agentPoolName, noPoddisruptionbudget, context);
        return this
            .client
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(
        String resourceGroupName, String resourceName, String agentPoolName, Boolean noPoddisruptionbudget) {
        return beginDeleteAsync(resourceGroupName, resourceName, agentPoolName, noPoddisruptionbudget).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(
        ...
        Boolean noPoddisruptionbudget,
        Context context) {
        return beginDeleteAsync(resourceGroupName, resourceName, agentPoolName, noPoddisruptionbudget, context)
            .getSyncPoller();
    }
    ...
    private Mono<Void> deleteAsync(
        String resourceGroupName, String resourceName, String agentPoolName, Boolean noPoddisruptionbudget) {
        return beginDeleteAsync(resourceGroupName, resourceName, agentPoolName, noPoddisruptionbudget)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    public void delete(
        String resourceGroupName, String resourceName, String agentPoolName, Boolean noPoddisruptionbudget) {
        deleteAsync(resourceGroupName, resourceName, agentPoolName, noPoddisruptionbudget).block();
    }
    ...
    public void delete(
        ...
        Boolean noPoddisruptionbudget,
        Context context) {
        deleteAsync(resourceGroupName, resourceName, agentPoolName, noPoddisruptionbudget, context).block();
    }
