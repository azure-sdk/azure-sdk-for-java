...
public class ManagedClusterAgentPoolProfileProperties {
     ...
     * Allowed values must be in the range of 0 to 1000 (inclusive) for user
     * pools and in the range of 1 to 1000 (inclusive) for system pools. The
     * default value is 1.
     */
    ...
    /**
     * Get the count property: Desired Number of agents (VMs) specified to host docker containers. Allowed values must
    ...
    /**
     * Set the count property: Desired Number of agents (VMs) specified to host docker containers. Allowed values must
     * be in the range of 0 to 1000 (inclusive) for user pools and in the range of 1 to 1000 (inclusive) for system
     * pools. The default value is 1.
     *
