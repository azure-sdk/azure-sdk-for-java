...
public final class TrustedAccessRoleBindingsClientImpl implements TrustedAccessRoleBindingsClient {
    ...
    private interface TrustedAccessRoleBindingsService {
        ...
        Mono<Response<TrustedAccessRoleBindingListResultInner>> list(
     ...
     * @return list of trusted access role bindings along with {@link Response} on successful completion of {@link
     *     Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<TrustedAccessRoleBindingListResultInner>> listWithResponseAsync(
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return list of trusted access role bindings on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<TrustedAccessRoleBindingListResultInner> listAsync(String resourceGroupName, String resourceName) {
        return listWithResponseAsync(resourceGroupName, resourceName)
            .flatMap(
                (Response<TrustedAccessRoleBindingListResultInner> res) -> {
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return list of trusted access role bindings.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public TrustedAccessRoleBindingListResultInner list(String resourceGroupName, String resourceName) {
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return list of trusted access role bindings along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<TrustedAccessRoleBindingListResultInner> listWithResponse(
        String resourceGroupName, String resourceName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<TrustedAccessRoleBindingInner> getAsync(
        String resourceGroupName, String resourceName, String trustedAccessRoleBindingName) {
        return getWithResponseAsync(resourceGroupName, resourceName, trustedAccessRoleBindingName)
            .flatMap(
                (Response<TrustedAccessRoleBindingInner> res) -> {
                    if (res.getValue() != null) {
                        return Mono.just(res.getValue());
                    } else {
                        return Mono.empty();
    ...
    public TrustedAccessRoleBindingInner get(
        String resourceGroupName, String resourceName, String trustedAccessRoleBindingName) {
        return getAsync(resourceGroupName, resourceName, trustedAccessRoleBindingName).block();
    }
