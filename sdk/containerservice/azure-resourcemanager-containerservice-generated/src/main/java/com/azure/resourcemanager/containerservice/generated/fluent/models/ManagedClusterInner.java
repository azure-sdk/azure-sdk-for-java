...
public final class ManagedClusterInner extends Resource {
    ...
    public ManagedClusterAutoReconcileProfile autoReconcileProfile() {
        return this.innerProperties() == null ? null : this.innerProperties().autoReconcileProfile();
    }
     ...
     * @return the ManagedClusterInner object itself.
     */
    public ManagedClusterInner withAutoReconcileProfile(ManagedClusterAutoReconcileProfile autoReconcileProfile) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ManagedClusterProperties();
        }
        this.innerProperties().withAutoReconcileProfile(autoReconcileProfile);
        return this;
    }
