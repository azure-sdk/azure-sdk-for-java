...
public final class ApplicationDefinitionImpl
    ...
    ApplicationDefinitionImpl(String name, com.azure.resourcemanager.solutions.ApplicationManager serviceManager) {
    ...
    ApplicationDefinitionImpl(
        ApplicationDefinitionInner innerObject, com.azure.resourcemanager.solutions.ApplicationManager serviceManager) {
