...
/** Initializes a new instance of the ManagedApplicationManagementClientImpl type. */
@ServiceClient(builder = ManagedApplicationManagementClientBuilder.class)
public final class ManagedApplicationManagementClientImpl implements ManagedApplicationManagementClient {
    ...
    /**
     * Initializes an instance of ManagedApplicationManagementClient client.
     *
     ...
     */
    ManagedApplicationManagementClientImpl(
    ...
    private static final ClientLogger LOGGER = new ClientLogger(ManagedApplicationManagementClientImpl.class);
}
