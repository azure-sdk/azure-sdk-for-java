...
public final class ApplicationsClientImpl implements ApplicationsClient {
    ...
    private interface ApplicationsService {
        ...
        @Post(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Solutions"
                + "/applications/{applicationName}/updateAccess")
        @ExpectedResponses({200, 202})
        @UnexpectedResponseExceptionType(ManagementException.class)
        ...
        @Post(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Solutions"
                + "/applications/{applicationName}/listTokens")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<ApplicationInner>, ApplicationInner> beginUpdateAsync(
        String resourceGroupName, String applicationName, ApplicationPatchable parameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<ApplicationInner>, ApplicationInner> beginUpdate(
        String resourceGroupName, String applicationName, ApplicationPatchable parameters) {
        return beginUpdateAsync(resourceGroupName, applicationName, parameters).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<ApplicationInner>, ApplicationInner> beginUpdate(
        String resourceGroupName, String applicationName, ApplicationPatchable parameters, Context context) {
        return beginUpdateAsync(resourceGroupName, applicationName, parameters, context).getSyncPoller();
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> updateByIdWithResponseAsync(
        String applicationId, ApplicationPatchable parameters) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> updateByIdWithResponseAsync(
        String applicationId, ApplicationPatchable parameters, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<ApplicationInner>, ApplicationInner> beginUpdateByIdAsync(
        String applicationId, ApplicationPatchable parameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<ApplicationInner>, ApplicationInner> beginUpdateById(
        String applicationId, ApplicationPatchable parameters) {
        return beginUpdateByIdAsync(applicationId, parameters).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<ApplicationInner>, ApplicationInner> beginUpdateById(
        String applicationId, ApplicationPatchable parameters, Context context) {
        return beginUpdateByIdAsync(applicationId, parameters, context).getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ApplicationInner> updateByIdAsync(String applicationId, ApplicationPatchable parameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ApplicationInner> updateByIdAsync(
        String applicationId, ApplicationPatchable parameters, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ApplicationInner updateById(String applicationId, ApplicationPatchable parameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ApplicationInner updateById(String applicationId, ApplicationPatchable parameters, Context context) {
    ...
    public AllowedUpgradePlansResultInner listAllowedUpgradePlans(String resourceGroupName, String applicationName) {
        return listAllowedUpgradePlansAsync(resourceGroupName, applicationName).block();
    }
    ...
    public SyncPoller<PollResult<UpdateAccessDefinitionInner>, UpdateAccessDefinitionInner> beginUpdateAccess(
        String resourceGroupName, String applicationName, UpdateAccessDefinitionInner parameters) {
        return beginUpdateAccessAsync(resourceGroupName, applicationName, parameters).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<UpdateAccessDefinitionInner>, UpdateAccessDefinitionInner> beginUpdateAccess(
        String resourceGroupName, String applicationName, UpdateAccessDefinitionInner parameters, Context context) {
        return beginUpdateAccessAsync(resourceGroupName, applicationName, parameters, context).getSyncPoller();
    }
    ...
    public ManagedIdentityTokenResultInner listTokens(
        String resourceGroupName, String applicationName, ListTokenRequest parameters) {
        return listTokensAsync(resourceGroupName, applicationName, parameters).block();
    }
