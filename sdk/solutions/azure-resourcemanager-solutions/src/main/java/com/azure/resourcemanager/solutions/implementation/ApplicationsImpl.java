...
public final class ApplicationsImpl implements Applications {
    ...
    public Application updateById(String applicationId, ApplicationPatchable parameters) {
        ApplicationInner inner = this.serviceClient().updateById(applicationId, parameters);
        if (inner != null) {
            return new ApplicationImpl(inner, this.manager());
        } else {
            return null;
    ...
    public Application updateById(String applicationId, ApplicationPatchable parameters, Context context) {
        ApplicationInner inner = this.serviceClient().updateById(applicationId, parameters, context);
        if (inner != null) {
            return new ApplicationImpl(inner, this.manager());
        } else {
            return null;
