...
public final class JitRequestDefinitionImpl
    ...
    JitRequestDefinitionImpl(String name, com.azure.resourcemanager.solutions.ApplicationManager serviceManager) {
    ...
    JitRequestDefinitionImpl(
        JitRequestDefinitionInner innerObject, com.azure.resourcemanager.solutions.ApplicationManager serviceManager) {
