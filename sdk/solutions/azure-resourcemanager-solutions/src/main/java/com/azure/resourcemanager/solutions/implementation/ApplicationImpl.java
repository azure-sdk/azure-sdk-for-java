...
public final class ApplicationImpl implements Application, Application.Definition, Application.Update {
    ...
    ApplicationImpl(String name, com.azure.resourcemanager.solutions.ApplicationManager serviceManager) {
    ...
    ApplicationImpl(
        ApplicationInner innerObject, com.azure.resourcemanager.solutions.ApplicationManager serviceManager) {
