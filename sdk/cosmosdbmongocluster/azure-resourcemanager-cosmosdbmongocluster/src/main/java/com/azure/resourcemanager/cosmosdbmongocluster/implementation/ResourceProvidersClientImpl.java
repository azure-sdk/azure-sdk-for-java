...
import com.azure.resourcemanager.cosmosdbmongocluster.models.OperationListResult;
...
public final class ResourceProvidersClientImpl implements ResourceProvidersClient {
     ...
     */
    ResourceProvidersClientImpl(CosmosDBMongoClusterImpl client) {
        this.service =
    ...
    /**
     * The interface defining all the services for CosmosDBMongoClusterResourceProviders to be used by the proxy service
