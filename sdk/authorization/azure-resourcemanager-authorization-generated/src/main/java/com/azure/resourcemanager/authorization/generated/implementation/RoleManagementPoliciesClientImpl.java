...
import com.azure.resourcemanager.authorization.generated.models.RoleManagementPolicyListResult;
import reactor.core.publisher.Mono;

/**
 * An instance of this class provides access to all the operations defined in RoleManagementPoliciesClient.
 */
public final class RoleManagementPoliciesClientImpl implements RoleManagementPoliciesClient {
    /**
    ...
    /**
     * The interface defining all the services for AuthorizationManagementClientRoleManagementPolicies to be used by
    ...
    private Mono<Response<RoleManagementPolicyInner>> getWithResponseAsync(String scope,
        ...
        return FluxUtil
            .withContext(context -> service.get(this.client.getEndpoint(), scope, roleManagementPolicyName,
    ...
    private Mono<Response<RoleManagementPolicyInner>> getWithResponseAsync(String scope,
        ...
        return service.get(this.client.getEndpoint(), scope, roleManagementPolicyName, this.client.getApiVersion(),
            accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<RoleManagementPolicyInner> getAsync(String scope, String roleManagementPolicyName) {
    ...
    private Mono<Response<RoleManagementPolicyInner>> updateWithResponseAsync(String scope,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.update(this.client.getEndpoint(), scope, roleManagementPolicyName, this.client.getApiVersion(),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<RoleManagementPolicyInner> updateAsync(String scope, String roleManagementPolicyName,
    ...
    private Mono<Response<Void>> deleteWithResponseAsync(String scope, String roleManagementPolicyName,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.delete(this.client.getEndpoint(), scope, roleManagementPolicyName, this.client.getApiVersion(),
            accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> deleteAsync(String scope, String roleManagementPolicyName) {
    ...
    private PagedFlux<RoleManagementPolicyInner> listForScopeAsync(String scope) {
