...
public interface AlertsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    AlertInner update(String scope, String alertId, AlertInner parameters);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<AlertInner> updateWithResponse(String scope, String alertId, AlertInner parameters, Context context);
