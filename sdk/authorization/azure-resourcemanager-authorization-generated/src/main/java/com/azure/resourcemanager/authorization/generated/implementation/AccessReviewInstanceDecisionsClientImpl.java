...
public final class AccessReviewInstanceDecisionsClientImpl implements AccessReviewInstanceDecisionsClient {
    ...
    AccessReviewInstanceDecisionsClientImpl(AuthorizationManagementClientImpl client) {
        this.service = RestProxy.create(AccessReviewInstanceDecisionsService.class, client.getHttpPipeline(),
            client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for AuthorizationManagementClientAccessReviewInstanceDecisions to be
     * used by the proxy service to perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "AuthorizationManagem")
    public interface AccessReviewInstanceDecisionsService {
        @Headers({ "Content-Type: application/json" })
        @Get("/subscriptions/{subscriptionId}/providers/Microsoft.Authorization/accessReviewScheduleDefinitions/{scheduleDefinitionId}/instances/{id}/decisions")
     ...
     * @return access review instance decisions along with {@link PagedResponse} on successful completion of
     * {@link Mono}.
     */
    ...
    private Mono<PagedResponse<AccessReviewDecisionInner>> listSinglePageAsync(String scheduleDefinitionId, String id,
        ...
        return FluxUtil
            .withContext(context -> service.list(this.client.getEndpoint(), this.client.getSubscriptionId(),
                scheduleDefinitionId, id, apiVersion, filter, accept, context))
    ...
    private Mono<PagedResponse<AccessReviewDecisionInner>> listSinglePageAsync(String scheduleDefinitionId, String id,
        ...
        return service
            .list(this.client.getEndpoint(), this.client.getSubscriptionId(), scheduleDefinitionId, id, apiVersion,
