...
public interface AccessReviewInstanceMyDecisions {
     ...
     */
    PagedIterable<AccessReviewDecision> list(String scheduleDefinitionId, String acid);
     ...
     * @return my access review instance decisions as paginated response with {@link PagedIterable}.
     */
    PagedIterable<AccessReviewDecision> list(String scheduleDefinitionId, String acid, String filter, Context context);
