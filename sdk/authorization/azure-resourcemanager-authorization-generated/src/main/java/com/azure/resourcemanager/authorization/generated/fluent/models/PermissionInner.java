 ...
 */
@Fluent
public final class PermissionInner implements JsonSerializable<PermissionInner> {
    /*
     * Allowed actions.
     */
    ...
    /*
     * The conditions on the role definition. This limits the resources it can be assigned to.
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("actions".equals(fieldName)) {
                    ...
                    deserializedPermissionInner.condition = reader.getString();
                } else if ("conditionVersion".equals(fieldName)) {
                    deserializedPermissionInner.conditionVersion = reader.getString();
                } else {
                    reader.skipChildren();
                }
            }
