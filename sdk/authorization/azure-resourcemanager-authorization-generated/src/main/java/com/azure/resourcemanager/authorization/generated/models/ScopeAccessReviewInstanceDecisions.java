...
/**
 * Resource collection API of ScopeAccessReviewInstanceDecisions.
 */
public interface ScopeAccessReviewInstanceDecisions {
    /**
     ...
     */
    PagedIterable<AccessReviewDecision> list(String scope, String scheduleDefinitionId, String id);
     ...
     * @return access review instance decisions as paginated response with {@link PagedIterable}.
     */
    PagedIterable<AccessReviewDecision> list(String scope, String scheduleDefinitionId, String id, String filter,
        Context context);
}
