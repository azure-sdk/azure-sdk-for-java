...
public interface RoleAssignmentsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<ValidationResponseInner> validateWithResponse(String scope, String roleAssignmentName,
        RoleAssignmentCreateParameters parameters, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ValidationResponseInner validate(String scope, String roleAssignmentName,
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<RoleAssignmentInner> listForScope(String scope, String filter, String tenantId, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<ValidationResponseInner> validateByIdWithResponse(String roleAssignmentId,
        RoleAssignmentCreateParameters parameters, Context context);
