...
public final class RoleManagementPolicyNotificationRule extends RoleManagementPolicyRule {
    ...
    /*
     * Its value determine if the notification need to be sent to the recipient
     * type specified in policy rule.
     */
    ...
    /**
     * Get the notificationRecipients property: The list notification recipients.
     *
    ...
    /**
     * Set the notificationRecipients property: The list notification recipients.
     *
    ...
    /**
     * Get the isDefaultRecipientsEnabled property: Its value determine if the notification need to be sent to the
     * recipient type specified in policy rule.
     *
    ...
    /**
     * Set the isDefaultRecipientsEnabled property: Its value determine if the notification need to be sent to the
     * recipient type specified in policy rule.
     *
