...
import com.azure.resourcemanager.authorization.generated.fluent.RoleAssignmentScheduleInstancesClient;
import com.azure.resourcemanager.authorization.generated.fluent.models.RoleAssignmentScheduleInstanceInner;
import com.azure.resourcemanager.authorization.generated.models.RoleAssignmentScheduleInstanceListResult;
...
public final class RoleAssignmentScheduleInstancesClientImpl implements RoleAssignmentScheduleInstancesClient {
    ...
    public interface RoleAssignmentScheduleInstancesService {
        ...
        Mono<Response<RoleAssignmentScheduleInstanceListResult>> listForScope(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<RoleAssignmentScheduleInstanceInner>> get(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<RoleAssignmentScheduleInstanceListResult>> listForScopeNext(
    ...
    private Mono<PagedResponse<RoleAssignmentScheduleInstanceInner>> listForScopeSinglePageAsync(String scope,
        String filter) {
        ...
        return FluxUtil
            ...
            .<PagedResponse<RoleAssignmentScheduleInstanceInner>>map(res -> new PagedResponseBase<>(res.getRequest(),
    ...
    private PagedFlux<RoleAssignmentScheduleInstanceInner> listForScopeAsync(String scope, String filter) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<RoleAssignmentScheduleInstanceInner> listForScopeAsync(String scope) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<RoleAssignmentScheduleInstanceInner> listForScope(String scope, String filter,
        Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<RoleAssignmentScheduleInstanceInner>> getWithResponseAsync(String scope,
    ...
    private Mono<Response<RoleAssignmentScheduleInstanceInner>> getWithResponseAsync(String scope,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.get(this.client.getEndpoint(), scope, roleAssignmentScheduleInstanceName,
            this.client.getApiVersion(), accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<RoleAssignmentScheduleInstanceInner> getAsync(String scope,
        String roleAssignmentScheduleInstanceName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<RoleAssignmentScheduleInstanceInner> getWithResponse(String scope,
        String roleAssignmentScheduleInstanceName, Context context) {
