...
public interface ScopeAccessReviewInstancesClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<AccessReviewInstanceInner> list(String scope, String scheduleDefinitionId, String filter,
        Context context);
    ...
    Response<AccessReviewInstanceInner> getByIdWithResponse(String scope, String scheduleDefinitionId, String id,
        Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<AccessReviewInstanceInner> createWithResponse(String scope, String scheduleDefinitionId, String id,
