 ...
 */
public final class TenantLevelAccessReviewInstanceContactedReviewersClientImpl
    implements TenantLevelAccessReviewInstanceContactedReviewersClient {
    /**
     * The proxy service used to perform REST calls.
     */
    private final TenantLevelAccessReviewInstanceContactedReviewersService service;
    ...
    /**
     * Initializes an instance of TenantLevelAccessReviewInstanceContactedReviewersClientImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    TenantLevelAccessReviewInstanceContactedReviewersClientImpl(AuthorizationManagementClientImpl client) {
        this.service = RestProxy.create(TenantLevelAccessReviewInstanceContactedReviewersService.class,
     ...
     * AuthorizationManagementClientTenantLevelAccessReviewInstanceContactedReviewers to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{$host}")
    ...
    private Mono<PagedResponse<AccessReviewContactedReviewerInner>> listSinglePageAsync(String scheduleDefinitionId,
        String id) {
        ...
        return FluxUtil.withContext(
            context -> service.list(this.client.getEndpoint(), scheduleDefinitionId, id, apiVersion, accept, context))
    ...
    private Mono<PagedResponse<AccessReviewContactedReviewerInner>> listSinglePageAsync(String scheduleDefinitionId,
        ...
        return service.list(this.client.getEndpoint(), scheduleDefinitionId, id, apiVersion, accept, context)
    ...
    private PagedFlux<AccessReviewContactedReviewerInner> listAsync(String scheduleDefinitionId, String id) {
        return new PagedFlux<>(() -> listSinglePageAsync(scheduleDefinitionId, id),
    ...
    private PagedFlux<AccessReviewContactedReviewerInner> listAsync(String scheduleDefinitionId, String id,
        Context context) {
        return new PagedFlux<>(() -> listSinglePageAsync(scheduleDefinitionId, id, context),
