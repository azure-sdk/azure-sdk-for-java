...
public interface AccessReviewInstanceMyDecisionsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<AccessReviewDecisionInner> list(String scheduleDefinitionId, String id, String filter,
        Context context);
    ...
    Response<AccessReviewDecisionInner> getByIdWithResponse(String scheduleDefinitionId, String id, String decisionId,
        Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<AccessReviewDecisionInner> patchWithResponse(String scheduleDefinitionId, String id, String decisionId,
