...
import com.azure.resourcemanager.authorization.generated.fluent.ScopeAccessReviewHistoryDefinitionsClient;
...
public final class ScopeAccessReviewHistoryDefinitionsClientImpl implements ScopeAccessReviewHistoryDefinitionsClient {
    ...
    ScopeAccessReviewHistoryDefinitionsClientImpl(AuthorizationManagementClientImpl client) {
        this.service = RestProxy.create(ScopeAccessReviewHistoryDefinitionsService.class, client.getHttpPipeline(),
    ...
    public interface ScopeAccessReviewHistoryDefinitionsService {
        ...
        Mono<Response<AccessReviewHistoryDefinitionListResult>> list(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<AccessReviewHistoryDefinitionInner>> getById(@HostParam("$host") String endpoint,
    ...
    private Mono<PagedResponse<AccessReviewHistoryDefinitionInner>> listSinglePageAsync(String scope, String filter) {
        ...
        return FluxUtil
            ...
            .<PagedResponse<AccessReviewHistoryDefinitionInner>>map(res -> new PagedResponseBase<>(res.getRequest(),
    ...
    private PagedFlux<AccessReviewHistoryDefinitionInner> listAsync(String scope, String filter) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<AccessReviewHistoryDefinitionInner> listAsync(String scope) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<AccessReviewHistoryDefinitionInner>> getByIdWithResponseAsync(String scope,
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.getById(this.client.getEndpoint(), scope, historyDefinitionId, apiVersion,
                accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<AccessReviewHistoryDefinitionInner> getByIdAsync(String scope, String historyDefinitionId) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<AccessReviewHistoryDefinitionInner> getByIdWithResponse(String scope, String historyDefinitionId,
        Context context) {
