...
public final class AccessReviewInstanceImpl implements AccessReviewInstance, AccessReviewInstance.Definition {
    ...
    AccessReviewInstanceImpl(AccessReviewInstanceInner innerObject,
    ...
    public AccessReviewInstance create() {
        this.innerObject = serviceManager.serviceClient().getAccessReviewInstances()
            .createWithResponse(scheduleDefinitionId, id, createProperties, Context.NONE).getValue();
        return this;
    }

    public AccessReviewInstance create(Context context) {
        this.innerObject = serviceManager.serviceClient().getAccessReviewInstances()
            .createWithResponse(scheduleDefinitionId, id, createProperties, context).getValue();
        return this;
    }

    AccessReviewInstanceImpl(String name,
        com.azure.resourcemanager.authorization.generated.AuthorizationManager serviceManager) {
    ...
    public AccessReviewInstance refresh() {
        this.innerObject = serviceManager.serviceClient().getAccessReviewInstances()
            .getByIdWithResponse(scheduleDefinitionId, id, Context.NONE).getValue();
        return this;
    }

    public AccessReviewInstance refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getAccessReviewInstances()
            .getByIdWithResponse(scheduleDefinitionId, id, context).getValue();
        return this;
    }
