...
public final class ScopeAccessReviewScheduleDefinitionsClientImpl
    ...
    ScopeAccessReviewScheduleDefinitionsClientImpl(AuthorizationManagementClientImpl client) {
        this.service = RestProxy.create(ScopeAccessReviewScheduleDefinitionsService.class, client.getHttpPipeline(),
    ...
    public interface ScopeAccessReviewScheduleDefinitionsService {
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Void>> deleteById(@HostParam("$host") String endpoint, @PathParam("scope") String scope,
    ...
    private Mono<PagedResponse<AccessReviewScheduleDefinitionInner>> listSinglePageAsync(String scope, String filter,
        ...
        return service.list(this.client.getEndpoint(), scope, apiVersion, filter, accept, context)
    ...
    private PagedFlux<AccessReviewScheduleDefinitionInner> listAsync(String scope, String filter) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<AccessReviewScheduleDefinitionInner> listAsync(String scope) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<AccessReviewScheduleDefinitionInner>> getByIdWithResponseAsync(String scope,
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.getById(this.client.getEndpoint(), scope, scheduleDefinitionId, apiVersion,
                accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<AccessReviewScheduleDefinitionInner> getByIdAsync(String scope, String scheduleDefinitionId) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<AccessReviewScheduleDefinitionInner> getByIdWithResponse(String scope, String scheduleDefinitionId,
        Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Void>> deleteByIdWithResponseAsync(String scope, String scheduleDefinitionId) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.deleteById(this.client.getEndpoint(), scope, scheduleDefinitionId,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> deleteByIdAsync(String scope, String scheduleDefinitionId) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<AccessReviewScheduleDefinitionInner>> createOrUpdateByIdWithResponseAsync(String scope,
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.createOrUpdateById(this.client.getEndpoint(), scope, scheduleDefinitionId,
    ...
    private Mono<Response<AccessReviewScheduleDefinitionInner>> createOrUpdateByIdWithResponseAsync(String scope,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.createOrUpdateById(this.client.getEndpoint(), scope, scheduleDefinitionId, apiVersion,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<AccessReviewScheduleDefinitionInner> createOrUpdateByIdAsync(String scope, String scheduleDefinitionId,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<AccessReviewScheduleDefinitionInner> createOrUpdateByIdWithResponse(String scope,
        String scheduleDefinitionId, AccessReviewScheduleDefinitionProperties properties, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public AccessReviewScheduleDefinitionInner createOrUpdateById(String scope, String scheduleDefinitionId,
        AccessReviewScheduleDefinitionProperties properties) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Void>> stopWithResponseAsync(String scope, String scheduleDefinitionId) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.stop(this.client.getEndpoint(), scope, scheduleDefinitionId, apiVersion,
                accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> stopAsync(String scope, String scheduleDefinitionId) {
