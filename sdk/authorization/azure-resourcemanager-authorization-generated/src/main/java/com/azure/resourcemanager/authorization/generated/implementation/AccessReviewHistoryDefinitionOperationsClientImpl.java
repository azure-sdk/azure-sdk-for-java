...
public final class AccessReviewHistoryDefinitionOperationsClientImpl
    ...
    AccessReviewHistoryDefinitionOperationsClientImpl(AuthorizationManagementClientImpl client) {
        this.service = RestProxy.create(AccessReviewHistoryDefinitionOperationsService.class, client.getHttpPipeline(),
    ...
    public interface AccessReviewHistoryDefinitionOperationsService {
        ...
        @Put("/subscriptions/{subscriptionId}/providers/Microsoft.Authorization/accessReviewHistoryDefinitions/{historyDefinitionId}")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<AccessReviewHistoryDefinitionInner>> create(@HostParam("$host") String endpoint,
        ...
        @Headers({ "Content-Type: application/json" })
        @Delete("/subscriptions/{subscriptionId}/providers/Microsoft.Authorization/accessReviewHistoryDefinitions/{historyDefinitionId}")
    ...
    private Mono<Response<AccessReviewHistoryDefinitionInner>> createWithResponseAsync(String historyDefinitionId,
        ...
        return FluxUtil
            .withContext(context -> service.create(this.client.getEndpoint(), this.client.getSubscriptionId(),
                historyDefinitionId, apiVersion, properties, accept, context))
    ...
    private Mono<Response<AccessReviewHistoryDefinitionInner>> createWithResponseAsync(String historyDefinitionId,
        ...
        return service.create(this.client.getEndpoint(), this.client.getSubscriptionId(), historyDefinitionId,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<AccessReviewHistoryDefinitionInner> createAsync(String historyDefinitionId,
        AccessReviewHistoryDefinitionProperties properties) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<AccessReviewHistoryDefinitionInner> createWithResponse(String historyDefinitionId,
        AccessReviewHistoryDefinitionProperties properties, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public AccessReviewHistoryDefinitionInner create(String historyDefinitionId,
        AccessReviewHistoryDefinitionProperties properties) {
    ...
    private Mono<Response<Void>> deleteByIdWithResponseAsync(String historyDefinitionId) {
        ...
        return FluxUtil
            .withContext(context -> service.deleteById(this.client.getEndpoint(), this.client.getSubscriptionId(),
                historyDefinitionId, apiVersion, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<Void>> deleteByIdWithResponseAsync(String historyDefinitionId, Context context) {
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.deleteById(this.client.getEndpoint(), this.client.getSubscriptionId(), historyDefinitionId,
