...
public final class AlertConfigurationsImpl implements AlertConfigurations {
    ...
    public Response<AlertConfiguration> updateWithResponse(
        String scope, String alertId, AlertConfigurationInner parameters, Context context) {
        Response<AlertConfigurationInner> inner =
            this.serviceClient().updateWithResponse(scope, alertId, parameters, context);
        if (inner != null) {
            return new SimpleResponse<>(
                inner.getRequest(),
                inner.getStatusCode(),
    ...
    public AlertConfiguration update(String scope, String alertId, AlertConfigurationInner parameters) {
        AlertConfigurationInner inner = this.serviceClient().update(scope, alertId, parameters);
        if (inner != null) {
            return new AlertConfigurationImpl(inner, this.manager());
        } else {
            return null;
