...
import com.azure.resourcemanager.authorization.generated.models.ClassicAdministratorListResult;
...
public final class ClassicAdministratorsClientImpl implements ClassicAdministratorsClient {
    ...
    ClassicAdministratorsClientImpl(AuthorizationManagementClientImpl client) {
        this.service = RestProxy.create(ClassicAdministratorsService.class, client.getHttpPipeline(),
    ...
    public interface ClassicAdministratorsService {
        ...
        Mono<Response<ClassicAdministratorListResult>> list(@HostParam("$host") String endpoint,
    ...
    private Mono<PagedResponse<ClassicAdministratorInner>> listSinglePageAsync() {
        ...
        return FluxUtil
            .withContext(context -> service.list(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(),
                accept, context))
            .<PagedResponse<ClassicAdministratorInner>>map(res -> new PagedResponseBase<>(res.getRequest(),
