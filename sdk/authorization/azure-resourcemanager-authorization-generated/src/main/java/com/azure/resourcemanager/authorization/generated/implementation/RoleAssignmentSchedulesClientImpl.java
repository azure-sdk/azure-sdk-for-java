...
import com.azure.resourcemanager.authorization.generated.models.RoleAssignmentScheduleListResult;
...
public final class RoleAssignmentSchedulesClientImpl implements RoleAssignmentSchedulesClient {
    ...
    RoleAssignmentSchedulesClientImpl(AuthorizationManagementClientImpl client) {
        this.service = RestProxy.create(RoleAssignmentSchedulesService.class, client.getHttpPipeline(),
    ...
    public interface RoleAssignmentSchedulesService {
        ...
        Mono<Response<RoleAssignmentScheduleInner>> get(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<RoleAssignmentScheduleListResult>> listForScope(@HostParam("$host") String endpoint,
    ...
    private Mono<Response<RoleAssignmentScheduleInner>> getWithResponseAsync(String scope,
        String roleAssignmentScheduleName) {
        ...
        return FluxUtil
            .withContext(context -> service.get(this.client.getEndpoint(), scope, roleAssignmentScheduleName,
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<RoleAssignmentScheduleInner>> getWithResponseAsync(String scope,
        String roleAssignmentScheduleName, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service.get(this.client.getEndpoint(), scope, roleAssignmentScheduleName, this.client.getApiVersion(),
            accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<RoleAssignmentScheduleInner> getAsync(String scope, String roleAssignmentScheduleName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<RoleAssignmentScheduleInner> getWithResponse(String scope, String roleAssignmentScheduleName,
        Context context) {
    ...
    private Mono<PagedResponse<RoleAssignmentScheduleInner>> listForScopeSinglePageAsync(String scope, String filter) {
        ...
        return FluxUtil
            .withContext(context -> service.listForScope(this.client.getEndpoint(), scope, filter,
                this.client.getApiVersion(), accept, context))
            .<PagedResponse<RoleAssignmentScheduleInner>>map(res -> new PagedResponseBase<>(res.getRequest(),
    ...
    private PagedFlux<RoleAssignmentScheduleInner> listForScopeAsync(String scope, String filter) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<RoleAssignmentScheduleInner> listForScopeAsync(String scope) {
