...
public final class AccessReviewInstanceMyDecisionsClientImpl implements AccessReviewInstanceMyDecisionsClient {
    ...
    private interface AccessReviewInstanceMyDecisionsService {
        ...
        @Get(
            "/providers/Microsoft.Authorization/accessReviewScheduleDefinitions/{scheduleDefinitionId}/instances/{acid}"
                + "/decisions")
     ...
     * @param acid The id of the access review instance.
    ...
    private Mono<PagedResponse<AccessReviewDecisionInner>> listSinglePageAsync(
        String scheduleDefinitionId, String acid, String filter) {
        ...
        if (acid == null) {
            return Mono.error(new IllegalArgumentException("Parameter acid is required and cannot be null."));
        }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<AccessReviewDecisionInner>> listSinglePageAsync(
        String scheduleDefinitionId, String acid, String filter, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    private PagedFlux<AccessReviewDecisionInner> listAsync(String scheduleDefinitionId, String acid, String filter) {
        return new PagedFlux<>(
            () -> listSinglePageAsync(scheduleDefinitionId, acid, filter),
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<AccessReviewDecisionInner> listAsync(String scheduleDefinitionId, String acid) {
    ...
    private PagedFlux<AccessReviewDecisionInner> listAsync(
        String scheduleDefinitionId, String acid, String filter, Context context) {
        return new PagedFlux<>(
            () -> listSinglePageAsync(scheduleDefinitionId, acid, filter, context),
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<AccessReviewDecisionInner> list(String scheduleDefinitionId, String acid) {
        final String filter = null;
        return new PagedIterable<>(listAsync(scheduleDefinitionId, acid, filter));
    }
    ...
    public PagedIterable<AccessReviewDecisionInner> list(
        String scheduleDefinitionId, String acid, String filter, Context context) {
        return new PagedIterable<>(listAsync(scheduleDefinitionId, acid, filter, context));
    }
