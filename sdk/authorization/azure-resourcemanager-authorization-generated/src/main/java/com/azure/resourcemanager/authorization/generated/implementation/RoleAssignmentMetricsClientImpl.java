...
public final class RoleAssignmentMetricsClientImpl implements RoleAssignmentMetricsClient {
     ...
     * @return role assignment usage metrics for a subscription along with {@link Response} on successful completion of
     *     {@link Mono}.
     */
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return role assignment usage metrics for a subscription on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<RoleAssignmentMetricsResultInner> getMetricsForSubscriptionAsync() {
        return getMetricsForSubscriptionWithResponseAsync().flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return role assignment usage metrics for a subscription along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
