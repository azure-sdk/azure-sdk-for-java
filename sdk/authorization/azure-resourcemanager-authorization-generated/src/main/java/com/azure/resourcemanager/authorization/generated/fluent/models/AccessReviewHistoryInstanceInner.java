...
public final class AccessReviewHistoryInstanceInner extends ProxyResource {
     ...
     * generateDownloadUri() must be called for a specific accessReviewHistoryDefinitionInstance. The link expires
     * after a 24 hour period. Callers can see the expiration date time by looking at the 'se' parameter in the
     * generated uri.
     * 
