...
/**
 * Resource collection API of RoleEligibilitySchedules.
 */
public interface RoleEligibilitySchedules {
    /**
     ...
     */
    Response<RoleEligibilitySchedule> getWithResponse(String scope, String roleEligibilityScheduleName,
        Context context);
     ...
     */
    RoleEligibilitySchedule get(String scope, String roleEligibilityScheduleName);
     ...
     */
    PagedIterable<RoleEligibilitySchedule> listForScope(String scope);
     ...
     * @return role eligibility schedules for a resource scope as paginated response with {@link PagedIterable}.
     */
    PagedIterable<RoleEligibilitySchedule> listForScope(String scope, String filter, Context context);
}
