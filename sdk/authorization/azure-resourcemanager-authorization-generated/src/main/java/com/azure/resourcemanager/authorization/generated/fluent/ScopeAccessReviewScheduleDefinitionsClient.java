...
public interface ScopeAccessReviewScheduleDefinitionsClient {
    ...
    Response<AccessReviewScheduleDefinitionInner> getByIdWithResponse(String scope, String scheduleDefinitionId,
        Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<AccessReviewScheduleDefinitionInner> createOrUpdateByIdWithResponse(String scope,
