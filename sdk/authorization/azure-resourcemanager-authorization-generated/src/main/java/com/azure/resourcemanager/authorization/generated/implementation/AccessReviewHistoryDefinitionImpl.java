...
public final class AccessReviewHistoryDefinitionImpl
    ...
    AccessReviewHistoryDefinitionImpl(AccessReviewHistoryDefinitionInner innerObject,
    ...
    public List<AccessReviewHistoryInstance> instances() {
        ...
        if (inner != null) {
            return Collections.unmodifiableList(
                inner.stream().map(inner1 -> new AccessReviewHistoryInstanceImpl(inner1, this.manager()))
    ...
    public AccessReviewHistoryDefinition create() {
        this.innerObject = serviceManager.serviceClient().getAccessReviewHistoryDefinitionOperations()
            .createWithResponse(historyDefinitionId, createProperties, Context.NONE).getValue();
        return this;
    }

    public AccessReviewHistoryDefinition create(Context context) {
        this.innerObject = serviceManager.serviceClient().getAccessReviewHistoryDefinitionOperations()
            .createWithResponse(historyDefinitionId, createProperties, context).getValue();
        return this;
    }

    AccessReviewHistoryDefinitionImpl(String name,
        com.azure.resourcemanager.authorization.generated.AuthorizationManager serviceManager) {
