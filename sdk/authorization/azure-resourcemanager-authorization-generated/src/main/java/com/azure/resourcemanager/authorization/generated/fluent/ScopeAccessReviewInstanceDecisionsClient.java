...
public interface ScopeAccessReviewInstanceDecisionsClient {
    ...
    PagedIterable<AccessReviewDecisionInner> list(String scope, String scheduleDefinitionId, String id);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<AccessReviewDecisionInner> list(String scope, String scheduleDefinitionId, String id, String filter,
        Context context);
}
