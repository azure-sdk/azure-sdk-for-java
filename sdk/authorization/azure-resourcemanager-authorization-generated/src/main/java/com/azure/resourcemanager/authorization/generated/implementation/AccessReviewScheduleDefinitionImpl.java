...
public final class AccessReviewScheduleDefinitionImpl implements AccessReviewScheduleDefinition,
    AccessReviewScheduleDefinition.Definition, AccessReviewScheduleDefinition.Update {
    ...
    public List<AccessReviewInstance> instances() {
        ...
        if (inner != null) {
            return Collections.unmodifiableList(inner.stream()
                .map(inner1 -> new AccessReviewInstanceImpl(inner1, this.manager())).collect(Collectors.toList()));
        } else {
            return Collections.emptyList();
        }
    }
    ...
    public Boolean includeInheritedAccess() {
        return this.innerModel().includeInheritedAccess();
    }
    ...
    public String excludeResourceId() {
        return this.innerModel().excludeResourceId();
    }

    public String excludeRoleDefinitionId() {
        return this.innerModel().excludeRoleDefinitionId();
    }
    ...
    public AccessReviewScheduleDefinition create() {
        this.innerObject = serviceManager.serviceClient().getAccessReviewScheduleDefinitions()
            .createOrUpdateByIdWithResponse(scheduleDefinitionId, createProperties, Context.NONE).getValue();
        return this;
    }

    public AccessReviewScheduleDefinition create(Context context) {
        this.innerObject = serviceManager.serviceClient().getAccessReviewScheduleDefinitions()
            .createOrUpdateByIdWithResponse(scheduleDefinitionId, createProperties, context).getValue();
        return this;
    }

    AccessReviewScheduleDefinitionImpl(String name,
    ...
    public AccessReviewScheduleDefinition apply() {
        this.innerObject = serviceManager.serviceClient().getAccessReviewScheduleDefinitions()
            .createOrUpdateByIdWithResponse(scheduleDefinitionId, updateProperties, Context.NONE).getValue();
        return this;
    }

    public AccessReviewScheduleDefinition apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getAccessReviewScheduleDefinitions()
            .createOrUpdateByIdWithResponse(scheduleDefinitionId, updateProperties, context).getValue();
        return this;
    }

    AccessReviewScheduleDefinitionImpl(AccessReviewScheduleDefinitionInner innerObject,
        com.azure.resourcemanager.authorization.generated.AuthorizationManager serviceManager) {
        this.innerObject = innerObject;
        this.serviceManager = serviceManager;
        this.scheduleDefinitionId
            = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "accessReviewScheduleDefinitions");
    }

    public AccessReviewScheduleDefinition refresh() {
        this.innerObject = serviceManager.serviceClient().getAccessReviewScheduleDefinitions()
            .getByIdWithResponse(scheduleDefinitionId, Context.NONE).getValue();
        return this;
    }

    public AccessReviewScheduleDefinition refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getAccessReviewScheduleDefinitions()
            .getByIdWithResponse(scheduleDefinitionId, context).getValue();
        return this;
    }
    ...
    public AccessReviewScheduleDefinitionImpl
