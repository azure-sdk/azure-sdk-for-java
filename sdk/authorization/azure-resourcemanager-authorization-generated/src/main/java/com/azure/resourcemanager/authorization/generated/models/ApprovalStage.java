...
public final class ApprovalStage {
    ...
    /**
     * Get the escalationTimeInMinutes property: The time in minutes when the approval request would be escalated if
     * the primary approver does not approve.
     * 
    ...
    /**
     * Set the escalationTimeInMinutes property: The time in minutes when the approval request would be escalated if
     * the primary approver does not approve.
     * 
