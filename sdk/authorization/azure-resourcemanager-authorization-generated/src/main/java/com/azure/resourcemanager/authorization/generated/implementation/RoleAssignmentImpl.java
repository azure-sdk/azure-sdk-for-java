...
public final class RoleAssignmentImpl implements RoleAssignment, RoleAssignment.Definition {
    ...
    public Response<ValidationResponse> validateWithResponse(RoleAssignmentCreateParameters parameters,
        Context context) {
        return serviceManager.roleAssignments().validateWithResponse(scope, roleAssignmentName, parameters, context);
    }

    public ValidationResponse validate(RoleAssignmentCreateParameters parameters) {
        return serviceManager.roleAssignments().validate(scope, roleAssignmentName, parameters);
    }
