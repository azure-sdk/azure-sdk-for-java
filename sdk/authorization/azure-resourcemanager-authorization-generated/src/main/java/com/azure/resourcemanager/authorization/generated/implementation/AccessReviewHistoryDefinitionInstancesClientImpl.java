...
public final class AccessReviewHistoryDefinitionInstancesClientImpl
    ...
    AccessReviewHistoryDefinitionInstancesClientImpl(AuthorizationManagementClientImpl client) {
        this.service = RestProxy.create(AccessReviewHistoryDefinitionInstancesService.class, client.getHttpPipeline(),
    ...
    public interface AccessReviewHistoryDefinitionInstancesService {
        ...
        @Post("/subscriptions/{subscriptionId}/providers/Microsoft.Authorization/accessReviewHistoryDefinitions/{historyDefinitionId}/instances/{instanceId}/generateDownloadUri")
    ...
    private Mono<Response<AccessReviewHistoryInstanceInner>>
        generateDownloadUriWithResponseAsync(String historyDefinitionId, String instanceId) {
        ...
        return FluxUtil
            .withContext(context -> service.generateDownloadUri(this.client.getEndpoint(),
                this.client.getSubscriptionId(), historyDefinitionId, instanceId, apiVersion, accept, context))
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<AccessReviewHistoryInstanceInner>>
        generateDownloadUriWithResponseAsync(String historyDefinitionId, String instanceId, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service.generateDownloadUri(this.client.getEndpoint(), this.client.getSubscriptionId(),
            historyDefinitionId, instanceId, apiVersion, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<AccessReviewHistoryInstanceInner> generateDownloadUriAsync(String historyDefinitionId,
        String instanceId) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<AccessReviewHistoryInstanceInner> generateDownloadUriWithResponse(String historyDefinitionId,
