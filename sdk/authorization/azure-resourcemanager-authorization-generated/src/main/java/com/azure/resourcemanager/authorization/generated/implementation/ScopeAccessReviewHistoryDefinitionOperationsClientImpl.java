...
public final class ScopeAccessReviewHistoryDefinitionOperationsClientImpl
    ...
    ScopeAccessReviewHistoryDefinitionOperationsClientImpl(AuthorizationManagementClientImpl client) {
        this.service = RestProxy.create(ScopeAccessReviewHistoryDefinitionOperationsService.class,
    ...
    private Mono<Response<AccessReviewHistoryDefinitionInner>> createWithResponseAsync(String scope,
        ...
        return FluxUtil
            .withContext(context -> service.create(this.client.getEndpoint(), scope, historyDefinitionId, apiVersion,
    ...
    private Mono<Response<AccessReviewHistoryDefinitionInner>> createWithResponseAsync(String scope,
        ...
        return service.create(this.client.getEndpoint(), scope, historyDefinitionId, apiVersion, properties, accept,
            context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<AccessReviewHistoryDefinitionInner> createAsync(String scope, String historyDefinitionId,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<AccessReviewHistoryDefinitionInner> createWithResponse(String scope, String historyDefinitionId,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public AccessReviewHistoryDefinitionInner create(String scope, String historyDefinitionId,
        AccessReviewHistoryDefinitionProperties properties) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Void>> deleteByIdWithResponseAsync(String scope, String historyDefinitionId) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.deleteById(this.client.getEndpoint(), scope, historyDefinitionId,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> deleteByIdAsync(String scope, String historyDefinitionId) {
