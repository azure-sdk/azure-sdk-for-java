...
public final class AccessReviewHistoryDefinitionsClientImpl implements AccessReviewHistoryDefinitionsClient {
    ...
    AccessReviewHistoryDefinitionsClientImpl(AuthorizationManagementClientImpl client) {
        this.service = RestProxy.create(AccessReviewHistoryDefinitionsService.class, client.getHttpPipeline(),
    ...
    public interface AccessReviewHistoryDefinitionsService {
        ...
        @Headers({ "Content-Type: application/json" })
        @Get("/subscriptions/{subscriptionId}/providers/Microsoft.Authorization/accessReviewHistoryDefinitions/{historyDefinitionId}")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
    ...
    private Mono<Response<AccessReviewHistoryDefinitionInner>> getByIdWithResponseAsync(String historyDefinitionId,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.getById(this.client.getEndpoint(), this.client.getSubscriptionId(), historyDefinitionId,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<AccessReviewHistoryDefinitionInner> getByIdWithResponse(String historyDefinitionId,
        Context context) {
