...
import com.azure.resourcemanager.authorization.generated.fluent.ScopeAccessReviewHistoryDefinitionInstancesClient;
...
public final class ScopeAccessReviewHistoryDefinitionInstancesClientImpl
    ...
    ScopeAccessReviewHistoryDefinitionInstancesClientImpl(AuthorizationManagementClientImpl client) {
        this.service = RestProxy.create(ScopeAccessReviewHistoryDefinitionInstancesService.class,
    ...
    public interface ScopeAccessReviewHistoryDefinitionInstancesService {
        ...
        @Post("/{scope}/providers/Microsoft.Authorization/accessReviewHistoryDefinitions/{historyDefinitionId}/instances/{instanceId}/generateDownloadUri")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<AccessReviewHistoryInstanceInner>> generateDownloadUri(@HostParam("$host") String endpoint,
            @PathParam("scope") String scope, @PathParam("historyDefinitionId") String historyDefinitionId,
            @PathParam("instanceId") String instanceId, @QueryParam("api-version") String apiVersion,
    ...
    private Mono<Response<AccessReviewHistoryInstanceInner>> generateDownloadUriWithResponseAsync(String scope,
        ...
        return FluxUtil
            .withContext(context -> service.generateDownloadUri(this.client.getEndpoint(), scope, historyDefinitionId,
                instanceId, apiVersion, accept, context))
    ...
    private Mono<Response<AccessReviewHistoryInstanceInner>> generateDownloadUriWithResponseAsync(String scope,
        ...
        return service.generateDownloadUri(this.client.getEndpoint(), scope, historyDefinitionId, instanceId,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<AccessReviewHistoryInstanceInner> generateDownloadUriAsync(String scope, String historyDefinitionId,
        String instanceId) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<AccessReviewHistoryInstanceInner> generateDownloadUriWithResponse(String scope,
        String historyDefinitionId, String instanceId, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public AccessReviewHistoryInstanceInner generateDownloadUri(String scope, String historyDefinitionId,
        String instanceId) {
