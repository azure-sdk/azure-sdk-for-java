...
public final class RoleAssignmentScheduleImpl implements RoleAssignmentSchedule {
    private RoleAssignmentScheduleInner innerObject;

    private final com.azure.resourcemanager.authorization.generated.AuthorizationManager serviceManager;

    RoleAssignmentScheduleImpl(RoleAssignmentScheduleInner innerObject,
    ...
    public String roleAssignmentScheduleRequestId() {
        return this.innerModel().roleAssignmentScheduleRequestId();
    }
    ...
    public RoleAssignmentScheduleInner innerModel() {
