...
public final class AccessReviewInstancesAssignedForMyApprovalsClientImpl
    ...
    AccessReviewInstancesAssignedForMyApprovalsClientImpl(AuthorizationManagementClientImpl client) {
        this.service =
            RestProxy
                .create(
                    AccessReviewInstancesAssignedForMyApprovalsService.class,
    ...
    private interface AccessReviewInstancesAssignedForMyApprovalsService {
    ...
    private Mono<PagedResponse<AccessReviewInstanceInner>> listSinglePageAsync(String scheduleDefinitionId) {
        ...
        return FluxUtil
            .withContext(
                context -> service.list(this.client.getEndpoint(), scheduleDefinitionId, apiVersion, accept, context))
    ...
    private Mono<PagedResponse<AccessReviewInstanceInner>> listSinglePageAsync(
        ...
        return service
            .list(this.client.getEndpoint(), scheduleDefinitionId, apiVersion, accept, context)
            .map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(),
    ...
    private PagedFlux<AccessReviewInstanceInner> listAsync(String scheduleDefinitionId) {
        return new PagedFlux<>(
            () -> listSinglePageAsync(scheduleDefinitionId), nextLink -> listNextSinglePageAsync(nextLink));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<AccessReviewInstanceInner> listAsync(String scheduleDefinitionId, Context context) {
        return new PagedFlux<>(
            () -> listSinglePageAsync(scheduleDefinitionId, context),
    ...
    public PagedIterable<AccessReviewInstanceInner> list(String scheduleDefinitionId) {
        return new PagedIterable<>(listAsync(scheduleDefinitionId));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<AccessReviewInstanceInner> list(String scheduleDefinitionId, Context context) {
        return new PagedIterable<>(listAsync(scheduleDefinitionId, context));
    }
    ...
    private Mono<Response<AccessReviewInstanceInner>> getByIdWithResponseAsync(String scheduleDefinitionId, String id) {
        ...
        return FluxUtil
            .withContext(
                context ->
                    service.getById(this.client.getEndpoint(), scheduleDefinitionId, id, apiVersion, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
