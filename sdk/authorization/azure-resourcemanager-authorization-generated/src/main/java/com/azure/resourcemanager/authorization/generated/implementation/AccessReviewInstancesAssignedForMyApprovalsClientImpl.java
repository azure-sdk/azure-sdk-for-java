 ...
 */
public final class AccessReviewInstancesAssignedForMyApprovalsClientImpl
    implements AccessReviewInstancesAssignedForMyApprovalsClient {
    /**
     * The proxy service used to perform REST calls.
     */
    private final AccessReviewInstancesAssignedForMyApprovalsService service;
    ...
    /**
     * Initializes an instance of AccessReviewInstancesAssignedForMyApprovalsClientImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    AccessReviewInstancesAssignedForMyApprovalsClientImpl(AuthorizationManagementClientImpl client) {
        this.service = RestProxy.create(AccessReviewInstancesAssignedForMyApprovalsService.class,
     ...
     * AuthorizationManagementClientAccessReviewInstancesAssignedForMyApprovals to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "AuthorizationManagem")
    public interface AccessReviewInstancesAssignedForMyApprovalsService {
        @Headers({ "Content-Type: application/json" })
        @Get("/providers/Microsoft.Authorization/accessReviewScheduleDefinitions/{scheduleDefinitionId}/instances")
        ...
        @Headers({ "Content-Type: application/json" })
        @Get("/providers/Microsoft.Authorization/accessReviewScheduleDefinitions/{scheduleDefinitionId}/instances/{id}")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
    ...
    private Mono<PagedResponse<AccessReviewInstanceInner>> listSinglePageAsync(String scheduleDefinitionId,
        ...
        return FluxUtil
            .withContext(context -> service.list(this.client.getEndpoint(), scheduleDefinitionId, apiVersion, filter,
                accept, context))
    ...
    private Mono<PagedResponse<AccessReviewInstanceInner>> listSinglePageAsync(String scheduleDefinitionId,
        ...
        return service.list(this.client.getEndpoint(), scheduleDefinitionId, apiVersion, filter, accept, context)
    ...
    private Mono<Response<AccessReviewInstanceInner>> getByIdWithResponseAsync(String scheduleDefinitionId, String id) {
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.getById(this.client.getEndpoint(), scheduleDefinitionId, id, apiVersion,
                accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<AccessReviewInstanceInner>> getByIdWithResponseAsync(String scheduleDefinitionId, String id,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.getById(this.client.getEndpoint(), scheduleDefinitionId, id, apiVersion, accept, context);
    }
