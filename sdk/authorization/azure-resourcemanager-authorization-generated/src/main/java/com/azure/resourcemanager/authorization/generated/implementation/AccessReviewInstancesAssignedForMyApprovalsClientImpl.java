...
public final class AccessReviewInstancesAssignedForMyApprovalsClientImpl
    ...
    private Mono<PagedResponse<AccessReviewInstanceInner>> listSinglePageAsync(
        ...
        final String apiVersion = "2021-11-16-preview";
        final String accept = "application/json";
        return FluxUtil
            .withContext(
                context ->
                    service.list(this.client.getEndpoint(), scheduleDefinitionId, apiVersion, filter, accept, context))
    ...
    private Mono<PagedResponse<AccessReviewInstanceInner>> listSinglePageAsync(
        ...
        return service
            .list(this.client.getEndpoint(), scheduleDefinitionId, apiVersion, filter, accept, context)
            .map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(),
    ...
    private Mono<AccessReviewInstanceInner> getByIdAsync(String scheduleDefinitionId, String id) {
        return getByIdWithResponseAsync(scheduleDefinitionId, id)
            .flatMap(
                (Response<AccessReviewInstanceInner> res) -> {
