...
public final class AccessReviewInstancesAssignedForMyApprovalsClientImpl
    ...
    private Mono<PagedResponse<AccessReviewInstanceInner>> listSinglePageAsync(
        ...
        return service
            .list(this.client.getEndpoint(), scheduleDefinitionId, this.client.getApiVersion(), filter, accept, context)
            .map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(),
    ...
    private Mono<Response<AccessReviewInstanceInner>> getByIdWithResponseAsync(
        ...
        context = this.client.mergeContext(context);
        return service
            .getById(this.client.getEndpoint(), scheduleDefinitionId, id, this.client.getApiVersion(), accept, context);
    }
