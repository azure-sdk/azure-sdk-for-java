...
public class AlertConfigurationPropertiesInner {
    ...
    /**
     * Get the isEnabled property: True if the alert is enabled, false will disable the scanning for the specific
     * alert.
     * 
    ...
    /**
     * Set the isEnabled property: True if the alert is enabled, false will disable the scanning for the specific
     * alert.
     * 
