...
public final class RoleAssignmentScheduleRequestImpl
    ...
    public RoleAssignmentScheduleRequest create() {
        this.innerObject = serviceManager.serviceClient().getRoleAssignmentScheduleRequests()
            .createWithResponse(scope, roleAssignmentScheduleRequestName, this.innerModel(), Context.NONE).getValue();
        return this;
    }

    public RoleAssignmentScheduleRequest create(Context context) {
        this.innerObject = serviceManager.serviceClient().getRoleAssignmentScheduleRequests()
            .createWithResponse(scope, roleAssignmentScheduleRequestName, this.innerModel(), context).getValue();
        return this;
    }
    ...
    public RoleAssignmentScheduleRequest refresh() {
        this.innerObject = serviceManager.serviceClient().getRoleAssignmentScheduleRequests()
            .getWithResponse(scope, roleAssignmentScheduleRequestName, Context.NONE).getValue();
        return this;
    }

    public RoleAssignmentScheduleRequest refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getRoleAssignmentScheduleRequests()
            .getWithResponse(scope, roleAssignmentScheduleRequestName, context).getValue();
        return this;
    }

    public Response<Void> cancelWithResponse(Context context) {
        return serviceManager.roleAssignmentScheduleRequests().cancelWithResponse(scope,
    ...
    public Response<RoleAssignmentScheduleRequest> validateWithResponse(RoleAssignmentScheduleRequestInner parameters,
        Context context) {
        return serviceManager.roleAssignmentScheduleRequests().validateWithResponse(scope,
            roleAssignmentScheduleRequestName, parameters, context);
    }

    public RoleAssignmentScheduleRequest validate(RoleAssignmentScheduleRequestInner parameters) {
        return serviceManager.roleAssignmentScheduleRequests().validate(scope, roleAssignmentScheduleRequestName,
            parameters);
    }
