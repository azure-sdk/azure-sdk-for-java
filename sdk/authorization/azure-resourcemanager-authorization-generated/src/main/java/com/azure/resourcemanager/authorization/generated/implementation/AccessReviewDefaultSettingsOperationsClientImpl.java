...
public final class AccessReviewDefaultSettingsOperationsClientImpl
    ...
    AccessReviewDefaultSettingsOperationsClientImpl(AuthorizationManagementClientImpl client) {
        this.service = RestProxy.create(AccessReviewDefaultSettingsOperationsService.class, client.getHttpPipeline(),
            client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for AuthorizationManagementClientAccessReviewDefaultSettingsOperations
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<AccessReviewDefaultSettingsInner>>
        putWithResponseAsync(AccessReviewScheduleSettings properties) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.put(this.client.getEndpoint(), this.client.getSubscriptionId(), apiVersion,
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<AccessReviewDefaultSettingsInner>>
        putWithResponseAsync(AccessReviewScheduleSettings properties, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.put(this.client.getEndpoint(), this.client.getSubscriptionId(), apiVersion, properties, accept,
            context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<AccessReviewDefaultSettingsInner> putWithResponse(AccessReviewScheduleSettings properties,
        Context context) {
