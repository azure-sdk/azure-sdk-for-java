...
public final class AccessReviewScheduleDefinitionsClientImpl implements AccessReviewScheduleDefinitionsClient {
    ...
    AccessReviewScheduleDefinitionsClientImpl(AuthorizationManagementClientImpl client) {
        this.service = RestProxy.create(AccessReviewScheduleDefinitionsService.class, client.getHttpPipeline(),
    ...
    public interface AccessReviewScheduleDefinitionsService {
        @Headers({ "Content-Type: application/json" })
        @Get("/subscriptions/{subscriptionId}/providers/Microsoft.Authorization/accessReviewScheduleDefinitions")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<AccessReviewScheduleDefinitionListResult>> list(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
            @QueryParam(value = "$filter", encoded = true) String filter, @HeaderParam("Accept") String accept,
            Context context);

        @Headers({ "Content-Type: application/json" })
        @Get("/subscriptions/{subscriptionId}/providers/Microsoft.Authorization/accessReviewScheduleDefinitions/{scheduleDefinitionId}")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<AccessReviewScheduleDefinitionInner>> getById(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("scheduleDefinitionId") String scheduleDefinitionId,
            @QueryParam("api-version") String apiVersion, @HeaderParam("Accept") String accept, Context context);

        @Headers({ "Content-Type: application/json" })
        @Delete("/subscriptions/{subscriptionId}/providers/Microsoft.Authorization/accessReviewScheduleDefinitions/{scheduleDefinitionId}")
        ...
        @Headers({ "Content-Type: application/json" })
        @Put("/subscriptions/{subscriptionId}/providers/Microsoft.Authorization/accessReviewScheduleDefinitions/{scheduleDefinitionId}")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<AccessReviewScheduleDefinitionInner>> createOrUpdateById(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("scheduleDefinitionId") String scheduleDefinitionId,
        ...
        @Headers({ "Content-Type: application/json" })
        @Post("/subscriptions/{subscriptionId}/providers/Microsoft.Authorization/accessReviewScheduleDefinitions/{scheduleDefinitionId}/stop")
     ...
     * @return access review schedule definitions along with {@link PagedResponse} on successful completion of
     * {@link Mono}.
     */
    ...
    private Mono<PagedResponse<AccessReviewScheduleDefinitionInner>> listSinglePageAsync(String filter) {
        ...
        return FluxUtil
            ...
            .<PagedResponse<AccessReviewScheduleDefinitionInner>>map(res -> new PagedResponseBase<>(res.getRequest(),
    ...
    private Mono<Response<AccessReviewScheduleDefinitionInner>> getByIdWithResponseAsync(String scheduleDefinitionId) {
        ...
        return FluxUtil
            .withContext(context -> service.getById(this.client.getEndpoint(), this.client.getSubscriptionId(),
                scheduleDefinitionId, apiVersion, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<AccessReviewScheduleDefinitionInner>> getByIdWithResponseAsync(String scheduleDefinitionId,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.getById(this.client.getEndpoint(), this.client.getSubscriptionId(), scheduleDefinitionId,
    ...
    private Mono<AccessReviewScheduleDefinitionInner> getByIdAsync(String scheduleDefinitionId) {
        return getByIdWithResponseAsync(scheduleDefinitionId).flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<AccessReviewScheduleDefinitionInner> getByIdWithResponse(String scheduleDefinitionId,
        Context context) {
    ...
    public AccessReviewScheduleDefinitionInner getById(String scheduleDefinitionId) {
        return getByIdWithResponse(scheduleDefinitionId, Context.NONE).getValue();
    }
    ...
    private Mono<Response<Void>> deleteByIdWithResponseAsync(String scheduleDefinitionId) {
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.deleteById(this.client.getEndpoint(), this.client.getSubscriptionId(),
                scheduleDefinitionId, apiVersion, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<Void>> deleteByIdWithResponseAsync(String scheduleDefinitionId, Context context) {
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.deleteById(this.client.getEndpoint(), this.client.getSubscriptionId(), scheduleDefinitionId,
            apiVersion, accept, context);
    }
    ...
    private Mono<Void> deleteByIdAsync(String scheduleDefinitionId) {
        return deleteByIdWithResponseAsync(scheduleDefinitionId).flatMap(ignored -> Mono.empty());
    }
    ...
    public void deleteById(String scheduleDefinitionId) {
        deleteByIdWithResponse(scheduleDefinitionId, Context.NONE);
    }
    ...
    private Mono<Response<AccessReviewScheduleDefinitionInner>> createOrUpdateByIdWithResponseAsync(
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.createOrUpdateById(this.client.getEndpoint(),
                this.client.getSubscriptionId(), scheduleDefinitionId, apiVersion, properties, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<AccessReviewScheduleDefinitionInner>> createOrUpdateByIdWithResponseAsync(
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.createOrUpdateById(this.client.getEndpoint(), this.client.getSubscriptionId(),
            scheduleDefinitionId, apiVersion, properties, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<AccessReviewScheduleDefinitionInner> createOrUpdateByIdAsync(String scheduleDefinitionId,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<AccessReviewScheduleDefinitionInner> createOrUpdateByIdWithResponse(String scheduleDefinitionId,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public AccessReviewScheduleDefinitionInner createOrUpdateById(String scheduleDefinitionId,
        AccessReviewScheduleDefinitionProperties properties) {
        return createOrUpdateByIdWithResponse(scheduleDefinitionId, properties, Context.NONE).getValue();
    }
    ...
    private Mono<Response<Void>> stopWithResponseAsync(String scheduleDefinitionId, Context context) {
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.stop(this.client.getEndpoint(), this.client.getSubscriptionId(), scheduleDefinitionId,
            apiVersion, accept, context);
    }
    ...
    public void stop(String scheduleDefinitionId) {
        stopWithResponse(scheduleDefinitionId, Context.NONE);
    }
