...
public final class ScopeAccessReviewInstanceContactedReviewersClientImpl
    ...
    ScopeAccessReviewInstanceContactedReviewersClientImpl(AuthorizationManagementClientImpl client) {
        this.service =
            RestProxy
                .create(
                    ScopeAccessReviewInstanceContactedReviewersService.class,
    ...
    private interface ScopeAccessReviewInstanceContactedReviewersService {
        @Headers({"Content-Type: application/json"})
        @Get(
            "/{scope}/providers/Microsoft.Authorization/accessReviewScheduleDefinitions/{scheduleDefinitionId}"
                + "/instances/{id}/contactedReviewers")
    ...
    private Mono<PagedResponse<AccessReviewContactedReviewerInner>> listSinglePageAsync(
        ...
        return FluxUtil
            .withContext(
                context ->
                    service
                        .list(this.client.getEndpoint(), scope, scheduleDefinitionId, id, apiVersion, accept, context))
    ...
    private PagedFlux<AccessReviewContactedReviewerInner> listAsync(
        ...
        return new PagedFlux<>(
            () -> listSinglePageAsync(scope, scheduleDefinitionId, id), nextLink -> listNextSinglePageAsync(nextLink));
    }
    ...
    private PagedFlux<AccessReviewContactedReviewerInner> listAsync(
        String scope, String scheduleDefinitionId, String id, Context context) {
        return new PagedFlux<>(
            () -> listSinglePageAsync(scope, scheduleDefinitionId, id, context),
