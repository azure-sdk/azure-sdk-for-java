...
public final class ScopeAccessReviewInstanceDecisionsClientImpl implements ScopeAccessReviewInstanceDecisionsClient {
    ...
    ScopeAccessReviewInstanceDecisionsClientImpl(AuthorizationManagementClientImpl client) {
        this.service = RestProxy.create(ScopeAccessReviewInstanceDecisionsService.class, client.getHttpPipeline(),
            client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for AuthorizationManagementClientScopeAccessReviewInstanceDecisions to
    ...
    public interface ScopeAccessReviewInstanceDecisionsService {
        ...
        @Get("/{scope}/providers/Microsoft.Authorization/accessReviewScheduleDefinitions/{scheduleDefinitionId}/instances/{id}/decisions")
    ...
    private Mono<PagedResponse<AccessReviewDecisionInner>> listSinglePageAsync(String scope,
    ...
    private PagedFlux<AccessReviewDecisionInner> listAsync(String scope, String scheduleDefinitionId, String id,
        String filter) {
        return new PagedFlux<>(() -> listSinglePageAsync(scope, scheduleDefinitionId, id, filter),
    ...
    private PagedFlux<AccessReviewDecisionInner> listAsync(String scope, String scheduleDefinitionId, String id,
        ...
        return new PagedFlux<>(() -> listSinglePageAsync(scope, scheduleDefinitionId, id, filter, context),
