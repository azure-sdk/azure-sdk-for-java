...
import com.azure.resourcemanager.authorization.generated.models.RoleEligibilityScheduleRequestListResult;
...
public final class RoleEligibilityScheduleRequestsClientImpl implements RoleEligibilityScheduleRequestsClient {
    ...
    private Mono<Response<RoleEligibilityScheduleRequestInner>> createWithResponseAsync(String scope,
        ...
        return service.create(this.client.getEndpoint(), scope, roleEligibilityScheduleRequestName,
            this.client.getApiVersion(), parameters, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<RoleEligibilityScheduleRequestInner> createAsync(String scope,
        String roleEligibilityScheduleRequestName, RoleEligibilityScheduleRequestInner parameters) {
    ...
    private Mono<Response<RoleEligibilityScheduleRequestInner>> getWithResponseAsync(String scope,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.get(this.client.getEndpoint(), scope, roleEligibilityScheduleRequestName,
            this.client.getApiVersion(), accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<RoleEligibilityScheduleRequestInner> getAsync(String scope,
        String roleEligibilityScheduleRequestName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<RoleEligibilityScheduleRequestInner> listForScopeAsync(String scope) {
    ...
    private Mono<Response<Void>> cancelWithResponseAsync(String scope, String roleEligibilityScheduleRequestName,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.cancel(this.client.getEndpoint(), scope, roleEligibilityScheduleRequestName,
            this.client.getApiVersion(), accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> cancelAsync(String scope, String roleEligibilityScheduleRequestName) {
