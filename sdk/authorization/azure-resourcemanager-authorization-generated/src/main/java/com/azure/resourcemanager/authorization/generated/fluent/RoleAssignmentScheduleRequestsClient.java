...
public interface RoleAssignmentScheduleRequestsClient {
    ...
    Response<RoleAssignmentScheduleRequestInner> createWithResponse(String scope,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<RoleAssignmentScheduleRequestInner> getWithResponse(String scope, String roleAssignmentScheduleRequestName,
        Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<RoleAssignmentScheduleRequestInner> validateWithResponse(String scope,
        String roleAssignmentScheduleRequestName, RoleAssignmentScheduleRequestInner parameters, Context context);
