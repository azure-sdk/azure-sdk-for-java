...
public final class AccessReviewInstancesClientImpl implements AccessReviewInstancesClient {
    ...
    AccessReviewInstancesClientImpl(AuthorizationManagementClientImpl client) {
        this.service = RestProxy.create(AccessReviewInstancesService.class, client.getHttpPipeline(),
    ...
    public interface AccessReviewInstancesService {
        ...
        @Get("/subscriptions/{subscriptionId}/providers/Microsoft.Authorization/accessReviewScheduleDefinitions/{scheduleDefinitionId}/instances")
        ...
        @Headers({ "Content-Type: application/json" })
        @Get("/subscriptions/{subscriptionId}/providers/Microsoft.Authorization/accessReviewScheduleDefinitions/{scheduleDefinitionId}/instances/{id}")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        ...
        @Headers({ "Content-Type: application/json" })
        @Put("/subscriptions/{subscriptionId}/providers/Microsoft.Authorization/accessReviewScheduleDefinitions/{scheduleDefinitionId}/instances/{id}")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
    ...
    private Mono<PagedResponse<AccessReviewInstanceInner>> listSinglePageAsync(String scheduleDefinitionId,
        String filter) {
        ...
        return FluxUtil
            .withContext(context -> service.list(this.client.getEndpoint(), this.client.getSubscriptionId(),
                scheduleDefinitionId, apiVersion, filter, accept, context))
    ...
    private Mono<PagedResponse<AccessReviewInstanceInner>> listSinglePageAsync(String scheduleDefinitionId,
        ...
        return service
            .list(this.client.getEndpoint(), this.client.getSubscriptionId(), scheduleDefinitionId, apiVersion, filter,
                accept, context)
    ...
    private PagedFlux<AccessReviewInstanceInner> listAsync(String scheduleDefinitionId, String filter) {
        return new PagedFlux<>(() -> listSinglePageAsync(scheduleDefinitionId, filter),
    ...
    private PagedFlux<AccessReviewInstanceInner> listAsync(String scheduleDefinitionId, String filter,
        Context context) {
        return new PagedFlux<>(() -> listSinglePageAsync(scheduleDefinitionId, filter, context),
    ...
    private Mono<Response<AccessReviewInstanceInner>> getByIdWithResponseAsync(String scheduleDefinitionId, String id,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.getById(this.client.getEndpoint(), this.client.getSubscriptionId(), scheduleDefinitionId, id,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<AccessReviewInstanceInner> getByIdWithResponse(String scheduleDefinitionId, String id,
        Context context) {
    ...
    public AccessReviewInstanceInner getById(String scheduleDefinitionId, String id) {
        return getByIdWithResponse(scheduleDefinitionId, id, Context.NONE).getValue();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<AccessReviewInstanceInner>> createWithResponseAsync(String scheduleDefinitionId, String id,
        ...
        return FluxUtil
            .withContext(context -> service.create(this.client.getEndpoint(), this.client.getSubscriptionId(),
                scheduleDefinitionId, id, apiVersion, properties, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<AccessReviewInstanceInner>> createWithResponseAsync(String scheduleDefinitionId, String id,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.create(this.client.getEndpoint(), this.client.getSubscriptionId(), scheduleDefinitionId, id,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<AccessReviewInstanceInner> createAsync(String scheduleDefinitionId, String id,
        AccessReviewInstanceProperties properties) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<AccessReviewInstanceInner> createWithResponse(String scheduleDefinitionId, String id,
        AccessReviewInstanceProperties properties, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public AccessReviewInstanceInner create(String scheduleDefinitionId, String id,
        AccessReviewInstanceProperties properties) {
        return createWithResponse(scheduleDefinitionId, id, properties, Context.NONE).getValue();
    }
