...
public final class ScopeAccessReviewInstancesClientImpl implements ScopeAccessReviewInstancesClient {
    ...
    ScopeAccessReviewInstancesClientImpl(AuthorizationManagementClientImpl client) {
        this.service =
            RestProxy
                .create(
                    ScopeAccessReviewInstancesService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }
    ...
    private interface ScopeAccessReviewInstancesService {
    ...
    private Mono<PagedResponse<AccessReviewInstanceInner>> listSinglePageAsync(
        String scope, String scheduleDefinitionId, String filter) {
    ...
    private Mono<PagedResponse<AccessReviewInstanceInner>> listSinglePageAsync(
        ...
        return service
            .list(this.client.getEndpoint(), scope, scheduleDefinitionId, apiVersion, filter, accept, context)
            .map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(),
    ...
    private PagedFlux<AccessReviewInstanceInner> listAsync(String scope, String scheduleDefinitionId, String filter) {
        return new PagedFlux<>(
            () -> listSinglePageAsync(scope, scheduleDefinitionId, filter),
    ...
    private PagedFlux<AccessReviewInstanceInner> listAsync(
        String scope, String scheduleDefinitionId, String filter, Context context) {
        return new PagedFlux<>(
            () -> listSinglePageAsync(scope, scheduleDefinitionId, filter, context),
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<AccessReviewInstanceInner> list(
        String scope, String scheduleDefinitionId, String filter, Context context) {
