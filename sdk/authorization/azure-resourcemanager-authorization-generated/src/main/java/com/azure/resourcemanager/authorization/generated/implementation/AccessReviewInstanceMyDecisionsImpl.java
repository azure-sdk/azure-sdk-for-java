...
public final class AccessReviewInstanceMyDecisionsImpl implements AccessReviewInstanceMyDecisions {
    ...
    public PagedIterable<AccessReviewDecision> list(String scheduleDefinitionId, String acid) {
        PagedIterable<AccessReviewDecisionInner> inner = this.serviceClient().list(scheduleDefinitionId, acid);
    ...
    public PagedIterable<AccessReviewDecision> list(
        ...
        PagedIterable<AccessReviewDecisionInner> inner =
            this.serviceClient().list(scheduleDefinitionId, acid, filter, context);
        return Utils.mapPage(inner, inner1 -> new AccessReviewDecisionImpl(inner1, this.manager()));
    }
