...
public final class AccessReviewInstanceMyDecisionsImpl implements AccessReviewInstanceMyDecisions {
    ...
    public AccessReviewInstanceMyDecisionsImpl(AccessReviewInstanceMyDecisionsClient innerClient,
    ...
    public Response<AccessReviewDecision> getByIdWithResponse(String scheduleDefinitionId, String id, String decisionId,
        Context context) {
    ...
    public Response<AccessReviewDecision> patchWithResponse(String scheduleDefinitionId, String id, String decisionId,
    ...
    public AccessReviewDecision patch(String scheduleDefinitionId, String id, String decisionId,
