...
public interface ScopeAccessReviewHistoryDefinitionInstancesOperationsClient {
    ...
    PagedIterable<AccessReviewHistoryInstanceInner> list(String scope, String historyDefinitionId);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<AccessReviewHistoryInstanceInner> list(String scope, String historyDefinitionId, Context context);
}
