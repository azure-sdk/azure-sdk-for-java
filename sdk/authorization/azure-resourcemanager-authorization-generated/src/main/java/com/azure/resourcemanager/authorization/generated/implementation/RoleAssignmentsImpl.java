...
public final class RoleAssignmentsImpl implements RoleAssignments {
    ...
    public Response<ValidationResponse> validateWithResponse(String scope, String roleAssignmentName,
        RoleAssignmentCreateParameters parameters, Context context) {
        Response<ValidationResponseInner> inner
            = this.serviceClient().validateWithResponse(scope, roleAssignmentName, parameters, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
    ...
    public ValidationResponse validate(String scope, String roleAssignmentName,
        RoleAssignmentCreateParameters parameters) {
        ValidationResponseInner inner = this.serviceClient().validate(scope, roleAssignmentName, parameters);
        if (inner != null) {
    ...
    public Response<ValidationResponse> validateByIdWithResponse(String roleAssignmentId,
        RoleAssignmentCreateParameters parameters, Context context) {
        Response<ValidationResponseInner> inner
            = this.serviceClient().validateByIdWithResponse(roleAssignmentId, parameters, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
                new ValidationResponseImpl(inner.getValue(), this.manager()));
        } else {
    ...
    public ValidationResponse validateById(String roleAssignmentId, RoleAssignmentCreateParameters parameters) {
        ValidationResponseInner inner = this.serviceClient().validateById(roleAssignmentId, parameters);
        if (inner != null) {
            return new ValidationResponseImpl(inner, this.manager());
        } else {
            return null;
