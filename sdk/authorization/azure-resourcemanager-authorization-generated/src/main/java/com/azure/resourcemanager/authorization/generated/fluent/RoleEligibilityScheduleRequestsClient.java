...
public interface RoleEligibilityScheduleRequestsClient {
    ...
    Response<RoleEligibilityScheduleRequestInner> createWithResponse(String scope,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<RoleEligibilityScheduleRequestInner> getWithResponse(String scope,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<RoleEligibilityScheduleRequestInner> validateWithResponse(String scope,
        String roleEligibilityScheduleRequestName, RoleEligibilityScheduleRequestInner parameters, Context context);
