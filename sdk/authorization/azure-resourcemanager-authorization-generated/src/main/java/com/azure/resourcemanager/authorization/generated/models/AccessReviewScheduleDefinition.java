...
public interface AccessReviewScheduleDefinition {
    ...
    /**
     * Gets the includeInheritedAccess property: Flag to indicate whether to expand nested memberships or not.
     * 
    ...
    /**
     * Gets the includeAccessBelowResource property: Flag to indicate whether to expand nested memberships or not.
     * 
    ...
    /**
     * Gets the excludeResourceId property: This is used to indicate the resource id(s) to exclude.
     * 
    ...
    /**
     * Gets the excludeRoleDefinitionId property: This is used to indicate the role definition id(s) to exclude.
     * 
    ...
    interface DefinitionStages {
         ...
         */
        interface WithCreate extends DefinitionStages.WithDisplayName, DefinitionStages.WithDescriptionForAdmins,
            DefinitionStages.WithDescriptionForReviewers, DefinitionStages.WithReviewers,
            DefinitionStages.WithBackupReviewers, DefinitionStages.WithInstances,
            DefinitionStages.WithMailNotificationsEnabled, DefinitionStages.WithReminderNotificationsEnabled,
            DefinitionStages.WithDefaultDecisionEnabled, DefinitionStages.WithJustificationRequiredOnApproval,
            DefinitionStages.WithDefaultDecision, DefinitionStages.WithAutoApplyDecisionsEnabled,
            DefinitionStages.WithRecommendationsEnabled, DefinitionStages.WithRecommendationLookBackDuration,
            DefinitionStages.WithInstanceDurationInDays, DefinitionStages.WithType, DefinitionStages.WithInterval,
            DefinitionStages.WithTypeRangeType, DefinitionStages.WithNumberOfOccurrences,
            DefinitionStages.WithStartDate, DefinitionStages.WithEndDate {
            /**
        ...
        interface WithAutoApplyDecisionsEnabled {
             ...
             * the target object access resource, is enabled. If not enabled, a user must, after the review completes,
             * apply the access review.
             * @return the next definition stage.
             */
        ...
        interface WithRecommendationLookBackDuration {
             ...
             * at 30 days of data(w.r.t the start date of the review) by default. However, in some scenarios, customers
             * want to change how far back to look at and want to configure 60 days, 90 days, etc. instead. This setting
             * allows customers to configure this duration. The value should be in ISO 8601 format
             * (http://en.wikipedia.org/wiki/ISO_8601#Durations).This code can be used to convert TimeSpan to a valid
             * interval string: XmlConvert.ToString(new TimeSpan(hours, minutes, seconds)).
             * @return the next definition stage.
             */
     ...
     */
    interface Update extends UpdateStages.WithDisplayName, UpdateStages.WithDescriptionForAdmins,
        UpdateStages.WithDescriptionForReviewers, UpdateStages.WithReviewers, UpdateStages.WithBackupReviewers,
        UpdateStages.WithInstances, UpdateStages.WithMailNotificationsEnabled,
        UpdateStages.WithReminderNotificationsEnabled, UpdateStages.WithDefaultDecisionEnabled,
        UpdateStages.WithJustificationRequiredOnApproval, UpdateStages.WithDefaultDecision,
        UpdateStages.WithAutoApplyDecisionsEnabled, UpdateStages.WithRecommendationsEnabled,
        UpdateStages.WithRecommendationLookBackDuration, UpdateStages.WithInstanceDurationInDays, UpdateStages.WithType,
        UpdateStages.WithInterval, UpdateStages.WithTypeRangeType, UpdateStages.WithNumberOfOccurrences,
        UpdateStages.WithStartDate, UpdateStages.WithEndDate {
        /**
