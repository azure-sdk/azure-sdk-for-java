...
public final class AccessReviewHistoryDefinitionInstancesOperationsClientImpl
    ...
    AccessReviewHistoryDefinitionInstancesOperationsClientImpl(AuthorizationManagementClientImpl client) {
        this.service = RestProxy.create(AccessReviewHistoryDefinitionInstancesOperationsService.class,
    ...
    public interface AccessReviewHistoryDefinitionInstancesOperationsService {
        ...
        @Get("/subscriptions/{subscriptionId}/providers/Microsoft.Authorization/accessReviewHistoryDefinitions/{historyDefinitionId}/instances")
    ...
    private Mono<PagedResponse<AccessReviewHistoryInstanceInner>> listSinglePageAsync(String historyDefinitionId,
        ...
        return service
            .list(this.client.getEndpoint(), this.client.getSubscriptionId(), historyDefinitionId, apiVersion, accept,
                context)
    ...
    private PagedFlux<AccessReviewHistoryInstanceInner> listAsync(String historyDefinitionId) {
        return new PagedFlux<>(() -> listSinglePageAsync(historyDefinitionId),
    ...
    private PagedFlux<AccessReviewHistoryInstanceInner> listAsync(String historyDefinitionId, Context context) {
        return new PagedFlux<>(() -> listSinglePageAsync(historyDefinitionId, context),
