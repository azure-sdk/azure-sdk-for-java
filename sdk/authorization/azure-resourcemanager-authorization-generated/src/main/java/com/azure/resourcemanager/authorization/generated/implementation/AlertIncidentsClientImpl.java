...
public final class AlertIncidentsClientImpl implements AlertIncidentsClient {
    ...
    private interface AlertIncidentsService {
        ...
        @Headers({"Content-Type: application/json"})
        @Get("/{scope}/providers/Microsoft.Authorization/roleManagementAlerts/alerts/{alertId}/alertIncidents")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
    ...
    private Mono<PagedResponse<AlertIncidentInner>> listForScopeSinglePageAsync(
        ...
        context = this.client.mergeContext(context);
        return service
            .listForScope(this.client.getEndpoint(), scope, alertId, this.client.getApiVersion(), accept, context)
            .map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(),
