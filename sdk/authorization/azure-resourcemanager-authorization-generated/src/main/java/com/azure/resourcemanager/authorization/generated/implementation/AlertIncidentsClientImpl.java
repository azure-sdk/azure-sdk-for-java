...
import com.azure.resourcemanager.authorization.generated.models.AlertIncidentListResult;
...
public final class AlertIncidentsClientImpl implements AlertIncidentsClient {
    ...
    public interface AlertIncidentsService {
        ...
        Mono<Response<AlertIncidentInner>> get(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<AlertIncidentListResult>> listForScope(@HostParam("$host") String endpoint,
            @PathParam(value = "scope", encoded = true) String scope,
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Void>> remediate(@HostParam("$host") String endpoint,
            @PathParam(value = "scope", encoded = true) String scope,
            @PathParam(value = "alertId", encoded = true) String alertId,
            @PathParam(value = "alertIncidentId", encoded = true) String alertIncidentId,
            @QueryParam("api-version") String apiVersion, @HeaderParam("Accept") String accept, Context context);
    ...
    private Mono<Response<AlertIncidentInner>> getWithResponseAsync(String scope, String alertId,
        ...
        return FluxUtil
            .withContext(context -> service.get(this.client.getEndpoint(), scope, alertId, alertIncidentId, apiVersion,
                accept, context))
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<AlertIncidentInner> getAsync(String scope, String alertId, String alertIncidentId) {
    ...
    private Mono<PagedResponse<AlertIncidentInner>> listForScopeSinglePageAsync(String scope, String alertId,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.listForScope(this.client.getEndpoint(), scope, alertId, apiVersion, accept, context)
    ...
    private PagedFlux<AlertIncidentInner> listForScopeAsync(String scope, String alertId) {
    ...
    private Mono<Response<Void>> remediateWithResponseAsync(String scope, String alertId, String alertIncidentId) {
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.remediate(this.client.getEndpoint(), scope, alertId, alertIncidentId,
    ...
    private Mono<Response<Void>> remediateWithResponseAsync(String scope, String alertId, String alertIncidentId,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.remediate(this.client.getEndpoint(), scope, alertId, alertIncidentId, apiVersion, accept,
            context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> remediateAsync(String scope, String alertId, String alertIncidentId) {
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return alert incident list operation result along with {@link PagedResponse} on successful completion of
     * {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
