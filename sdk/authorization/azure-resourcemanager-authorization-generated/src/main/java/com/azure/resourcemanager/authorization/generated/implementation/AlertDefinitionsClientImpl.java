...
import com.azure.resourcemanager.authorization.generated.models.AlertDefinitionListResult;
...
public final class AlertDefinitionsClientImpl implements AlertDefinitionsClient {
    ...
    /**
     * The interface defining all the services for AuthorizationManagementClientAlertDefinitions to be used by the
    ...
    public interface AlertDefinitionsService {
        ...
        Mono<Response<AlertDefinitionInner>> get(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<AlertDefinitionListResult>> listForScope(@HostParam("$host") String endpoint,
    ...
    private Mono<Response<AlertDefinitionInner>> getWithResponseAsync(String scope, String alertDefinitionId) {
        ...
        return FluxUtil.withContext(
            context -> service.get(this.client.getEndpoint(), scope, alertDefinitionId, apiVersion, accept, context))
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<AlertDefinitionInner> getAsync(String scope, String alertDefinitionId) {
    ...
    private Mono<PagedResponse<AlertDefinitionInner>> listForScopeSinglePageAsync(String scope) {
        ...
        return FluxUtil
            ...
            .<PagedResponse<AlertDefinitionInner>>map(res -> new PagedResponseBase<>(res.getRequest(),
    ...
    private PagedFlux<AlertDefinitionInner> listForScopeAsync(String scope) {
