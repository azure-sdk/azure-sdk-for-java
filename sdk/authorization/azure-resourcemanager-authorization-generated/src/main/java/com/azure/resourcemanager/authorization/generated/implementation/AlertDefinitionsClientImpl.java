...
public final class AlertDefinitionsClientImpl implements AlertDefinitionsClient {
    ...
    private interface AlertDefinitionsService {
        @Headers({"Content-Type: application/json"})
        @Get("/{scope}/providers/Microsoft.Authorization/roleManagementAlerts/alertDefinitions/{alertDefinitionId}")
        ...
        @Headers({"Content-Type: application/json"})
        @Get("/{scope}/providers/Microsoft.Authorization/roleManagementAlerts/alertDefinitions")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
    ...
    private Mono<Response<AlertDefinitionInner>> getWithResponseAsync(
        ...
        return service
            .get(this.client.getEndpoint(), scope, alertDefinitionId, this.client.getApiVersion(), accept, context);
    }
