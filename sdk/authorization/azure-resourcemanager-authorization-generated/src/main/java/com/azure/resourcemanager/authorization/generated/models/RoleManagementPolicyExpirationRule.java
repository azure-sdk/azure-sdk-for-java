...
public final class RoleManagementPolicyExpirationRule extends RoleManagementPolicyRule {
     ...
     */
    private List<UserSet> exceptionMembers;
    ...
    /**
     * Get the exceptionMembers property: The members not restricted by expiration rule.
     * 
     * @return the exceptionMembers value.
     */
    public List<UserSet> exceptionMembers() {
        return this.exceptionMembers;
    }

    /**
     * Set the exceptionMembers property: The members not restricted by expiration rule.
     * 
     * @param exceptionMembers the exceptionMembers value to set.
     * @return the RoleManagementPolicyExpirationRule object itself.
     */
    public RoleManagementPolicyExpirationRule withExceptionMembers(List<UserSet> exceptionMembers) {
    ...
    public void validate() {
        if (exceptionMembers() != null) {
            exceptionMembers().forEach(e -> e.validate());
        }
        if (target() != null) {
            target().validate();
        }
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeArrayField("exceptionMembers", this.exceptionMembers,
    ...
    public static RoleManagementPolicyExpirationRule fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                } else if ("exceptionMembers".equals(fieldName)) {
                    List<UserSet> exceptionMembers = reader.readArray(reader1 -> UserSet.fromJson(reader1));
                    deserializedRoleManagementPolicyExpirationRule.exceptionMembers = exceptionMembers;
                } else {
                    reader.skipChildren();
                }
            }
