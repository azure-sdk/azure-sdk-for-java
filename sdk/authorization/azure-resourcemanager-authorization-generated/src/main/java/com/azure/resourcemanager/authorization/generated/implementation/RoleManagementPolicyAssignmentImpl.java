...
public final class RoleManagementPolicyAssignmentImpl
    ...
    public RoleManagementPolicyAssignment create() {
        this.innerObject = serviceManager.serviceClient().getRoleManagementPolicyAssignments()
            .createWithResponse(scope, roleManagementPolicyAssignmentName, this.innerModel(), Context.NONE).getValue();
        return this;
    }

    public RoleManagementPolicyAssignment create(Context context) {
        this.innerObject = serviceManager.serviceClient().getRoleManagementPolicyAssignments()
            .createWithResponse(scope, roleManagementPolicyAssignmentName, this.innerModel(), context).getValue();
        return this;
    }
    ...
    public RoleManagementPolicyAssignment refresh() {
        this.innerObject = serviceManager.serviceClient().getRoleManagementPolicyAssignments()
            .getWithResponse(scope, roleManagementPolicyAssignmentName, Context.NONE).getValue();
        return this;
    }

    public RoleManagementPolicyAssignment refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getRoleManagementPolicyAssignments()
            .getWithResponse(scope, roleManagementPolicyAssignmentName, context).getValue();
        return this;
    }
