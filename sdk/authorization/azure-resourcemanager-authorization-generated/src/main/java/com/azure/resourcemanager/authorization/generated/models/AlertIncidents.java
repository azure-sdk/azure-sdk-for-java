...
/** Resource collection API of AlertIncidents. */
public interface AlertIncidents {
    /**
     ...
     */
    AlertIncident get(String scope, String alertId, String alertIncidentId);
     ...
     */
    Response<AlertIncident> getWithResponse(String scope, String alertId, String alertIncidentId, Context context);
     ...
     */
    PagedIterable<AlertIncident> listForScope(String scope, String alertId);
     ...
     * @return alert incidents for a resource scope as paginated response with {@link PagedIterable}.
     */
    PagedIterable<AlertIncident> listForScope(String scope, String alertId, Context context);
