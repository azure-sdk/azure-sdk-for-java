...
public final class AlertConfigurationsClientImpl implements AlertConfigurationsClient {
    ...
    public interface AlertConfigurationsService {
        ...
        Mono<Response<AlertConfigurationInner>> get(@HostParam("$host") String endpoint,
        ...
        Mono<Response<Void>> update(@HostParam("$host") String endpoint,
            @PathParam(value = "scope", encoded = true) String scope,
            @PathParam(value = "alertId", encoded = true) String alertId, @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") AlertConfigurationInner parameters, @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<AlertConfigurationListResult>> listForScope(@HostParam("$host") String endpoint,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Void>> updateWithResponseAsync(String scope, String alertId,
        AlertConfigurationInner parameters) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Void>> updateWithResponseAsync(String scope, String alertId,
        AlertConfigurationInner parameters, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> updateAsync(String scope, String alertId, AlertConfigurationInner parameters) {
