...
import com.azure.resourcemanager.authorization.generated.models.AlertConfigurationListResult;
...
public final class AlertConfigurationsClientImpl implements AlertConfigurationsClient {
    ...
    private interface AlertConfigurationsService {
        @Headers({"Content-Type: application/json"})
        @Get("/{scope}/providers/Microsoft.Authorization/roleManagementAlerts/alertConfigurations/{alertId}")
        ...
        @Headers({"Content-Type: application/json"})
        @Patch("/{scope}/providers/Microsoft.Authorization/roleManagementAlerts/alertConfigurations/{alertId}")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<AlertConfigurationInner>> update(
            @HostParam("$host") String endpoint,
            @PathParam(value = "scope", encoded = true) String scope,
            @PathParam(value = "alertId", encoded = true) String alertId,
            @QueryParam("api-version") String apiVersion,
        ...
        @Headers({"Content-Type: application/json"})
        @Get("/{scope}/providers/Microsoft.Authorization/roleManagementAlerts/alertConfigurations")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
    ...
    private Mono<Response<AlertConfigurationInner>> getWithResponseAsync(String scope, String alertId) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<AlertConfigurationInner> getAsync(String scope, String alertId) {
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return alert configuration along with {@link Response} on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<AlertConfigurationInner>> updateWithResponseAsync(
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return alert configuration on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<AlertConfigurationInner> updateAsync(
        String scope, String alertId, AlertConfigurationInner parameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<AlertConfigurationInner> updateWithResponse(
        String scope, String alertId, AlertConfigurationInner parameters, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public AlertConfigurationInner update(String scope, String alertId, AlertConfigurationInner parameters) {
    ...
    private PagedFlux<AlertConfigurationInner> listForScopeAsync(String scope) {
