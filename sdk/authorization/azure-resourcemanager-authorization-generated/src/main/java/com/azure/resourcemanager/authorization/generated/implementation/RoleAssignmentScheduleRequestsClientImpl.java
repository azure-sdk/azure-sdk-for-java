...
public final class RoleAssignmentScheduleRequestsClientImpl implements RoleAssignmentScheduleRequestsClient {
    ...
    private Mono<Response<RoleAssignmentScheduleRequestInner>> createWithResponseAsync(String scope,
        ...
        return service.create(this.client.getEndpoint(), scope, roleAssignmentScheduleRequestName,
            this.client.getApiVersion(), parameters, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<RoleAssignmentScheduleRequestInner> createAsync(String scope, String roleAssignmentScheduleRequestName,
    ...
    private Mono<Response<RoleAssignmentScheduleRequestInner>> getWithResponseAsync(String scope,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.get(this.client.getEndpoint(), scope, roleAssignmentScheduleRequestName,
            this.client.getApiVersion(), accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<RoleAssignmentScheduleRequestInner> getAsync(String scope, String roleAssignmentScheduleRequestName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<RoleAssignmentScheduleRequestInner> listForScopeAsync(String scope) {
    ...
    private Mono<Response<Void>> cancelWithResponseAsync(String scope, String roleAssignmentScheduleRequestName,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.cancel(this.client.getEndpoint(), scope, roleAssignmentScheduleRequestName,
            this.client.getApiVersion(), accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> cancelAsync(String scope, String roleAssignmentScheduleRequestName) {
    ...
    private Mono<Response<RoleAssignmentScheduleRequestInner>> validateWithResponseAsync(String scope,
        ...
        return FluxUtil
            .withContext(context -> service.validate(this.client.getEndpoint(), scope,
                roleAssignmentScheduleRequestName, this.client.getApiVersion(), parameters, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<RoleAssignmentScheduleRequestInner>> validateWithResponseAsync(String scope,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.validate(this.client.getEndpoint(), scope, roleAssignmentScheduleRequestName,
            this.client.getApiVersion(), parameters, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<RoleAssignmentScheduleRequestInner> validateAsync(String scope,
        String roleAssignmentScheduleRequestName, RoleAssignmentScheduleRequestInner parameters) {
