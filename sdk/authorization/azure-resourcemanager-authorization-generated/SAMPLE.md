...
public final class RoleAssignmentsListForScopeSamples {
    ...
    public static void
        ...
        manager.roleAssignments()
            .listForScope("subscriptions/a925f2f7-5c63-4b7b-8799-25a5f97bc3b2", null, null,
                com.azure.core.util.Context.NONE);
    }
}
```
...
public final class RoleAssignmentsValidateSamples {
     ...
     * x-ms-original-file:
     * specification/authorization/resource-manager/Microsoft.Authorization/preview/2024-02-01-preview/examples/
     * RoleAssignments_ValidateInvalid.json
     */
    /**
    ...
    public static void validateARoleAssignmentCreateOrUpdateOperationWithFailedValidation(
        com.azure.resourcemanager.authorization.generated.AuthorizationManager manager) {
        manager.roleAssignments()
            .validateWithResponse("subscriptions/a925f2f7-5c63-4b7b-8799-25a5f97bc3b2",
     ...
     * x-ms-original-file:
     * specification/authorization/resource-manager/Microsoft.Authorization/preview/2024-02-01-preview/examples/
     * RoleAssignments_ValidateValid.json
     */
    /**
...
public final class RoleAssignmentsValidateByIdSamples {
     ...
     * x-ms-original-file:
     * specification/authorization/resource-manager/Microsoft.Authorization/preview/2024-02-01-preview/examples/
     * RoleAssignments_ValidateByIdInvalid.json
     */
    /**
     ...
     * x-ms-original-file:
     * specification/authorization/resource-manager/Microsoft.Authorization/preview/2024-02-01-preview/examples/
     * RoleAssignments_ValidateByIdValid.json
     */
    /**
                        ...
                        Arrays
                            .asList(
                                ...
                                new RoleManagementPolicyAuthenticationContextRule()
                                    ...
                                    .withTarget(
                                        new RoleManagementPolicyRuleTarget().withCaller("EndUser")
                                            .withOperations(Arrays.asList("All"))
                                            .withLevel("Assignment"))
                                    .withIsEnabled(false)
                                    .withClaimValue(""),
                                ...
                                new RoleManagementPolicyPimOnlyModeRule().withId("PIMOnlyMode_Admin_Assignment")
                                    ...
                                    .withPimOnlyModeSettings(new PimOnlyModeSettings().withMode(PimOnlyMode.ENABLED)
                                        ...
                                        .withExcludeAllServicePrincipals(false)
                                        .withExludeServicePrincipalsAsTarget(true)))),
                com.azure.core.util.Context.NONE);
    }
}
```
