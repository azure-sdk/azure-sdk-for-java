...
- [CreateOrUpdateCoordinator](#configurations_createorupdatecoordinator)
- [CreateOrUpdateNode](#configurations_createorupdatenode)
...
public final class ClustersUpdateSamples {
    /*
     * x-ms-original-file: specification/postgresqlhsc/resource-manager/Microsoft.DBforPostgreSQL/stable/2022-11-08/examples/ClusterUpgradePostgreSQL.json
     */
    /**
     * Sample code: Upgrade PostgreSQL major version.
     *
     * @param manager Entry point to PostgresqlhscManager.
     */
    public static void upgradePostgreSQLMajorVersion(
        com.azure.resourcemanager.postgresqlhsc.PostgresqlhscManager manager) {
        Cluster resource =
            manager
                .clusters()
                ...
                .getValue();
        resource.update().withPostgresqlVersion("15").apply();
    }
...
### Configurations_CreateOrUpdateCoordinator
...
### Configurations_CreateOrUpdateNode
...
public final class RolesGetSamples {
     ...
     * @param manager Entry point to PostgresqlhscManager.
     */
    public static void getTheRoleOfTheCluster(com.azure.resourcemanager.postgresqlhsc.PostgresqlhscManager manager) {
