...
public final class ClusterInner extends Resource {
     ...
     * @return the ClusterInner object itself.
     */
    public ClusterInner withCoordinatorStorageQuotaInMb(Long coordinatorStorageQuotaInMb) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ClusterProperties();
        }
     ...
     * @return the ClusterInner object itself.
     */
    public ClusterInner withCoordinatorVCores(Long coordinatorVCores) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ClusterProperties();
        }
     ...
     * @return the ClusterInner object itself.
     */
    public ClusterInner withNodeCount(Long nodeCount) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ClusterProperties();
        }
     ...
     * @return the ClusterInner object itself.
     */
    public ClusterInner withNodeStorageQuotaInMb(Long nodeStorageQuotaInMb) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ClusterProperties();
        }
     ...
     * @return the ClusterInner object itself.
     */
    public ClusterInner withNodeVCores(Long nodeVCores) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ClusterProperties();
        }
