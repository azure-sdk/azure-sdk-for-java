...
public interface ServerGroupsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<Void>, Void> beginPromote(String resourceGroupName, String serverGroupName);
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<Void>, Void> beginPromote(String resourceGroupName, String serverGroupName, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    void promote(String resourceGroupName, String serverGroupName);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    void promote(String resourceGroupName, String serverGroupName, Context context);
