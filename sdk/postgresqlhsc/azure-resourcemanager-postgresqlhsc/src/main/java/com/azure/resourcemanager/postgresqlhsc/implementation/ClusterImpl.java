...
public final class ClusterImpl implements Cluster, Cluster.Definition, Cluster.Update {
    ...
    public ClusterImpl withCoordinatorStorageQuotaInMb(Long coordinatorStorageQuotaInMb) {
        if (isInCreateMode()) {
    ...
    public ClusterImpl withCoordinatorVCores(Long coordinatorVCores) {
        if (isInCreateMode()) {
    ...
    public ClusterImpl withNodeCount(Long nodeCount) {
        if (isInCreateMode()) {
    ...
    public ClusterImpl withNodeStorageQuotaInMb(Long nodeStorageQuotaInMb) {
        if (isInCreateMode()) {
    ...
    public ClusterImpl withNodeVCores(Long nodeVCores) {
        if (isInCreateMode()) {
