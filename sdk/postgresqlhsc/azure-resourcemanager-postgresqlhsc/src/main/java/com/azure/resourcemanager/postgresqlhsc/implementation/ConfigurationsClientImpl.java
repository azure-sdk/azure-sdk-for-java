...
public final class ConfigurationsClientImpl implements ConfigurationsClient {
    ...
    public interface ConfigurationsService {
        ...
        @Put(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforPostgreSQL"
                + "/serverGroupsv2/{clusterName}/configurations/{configurationName}/coordinator")
        @ExpectedResponses({202})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Flux<ByteBuffer>>> updateCoordinator(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") UUID subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
        ...
        @Put(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforPostgreSQL"
                + "/serverGroupsv2/{clusterName}/configurations/{configurationName}/node")
        @ExpectedResponses({202})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Flux<ByteBuffer>>> updateNode(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") UUID subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> updateCoordinatorWithResponseAsync(
    ...
    private PollerFlux<PollResult<ServerConfigurationInner>, ServerConfigurationInner> beginUpdateCoordinatorAsync(
        String resourceGroupName, String clusterName, String configurationName, ServerConfigurationRequest parameters) {
        Mono<Response<Flux<ByteBuffer>>> mono =
            updateCoordinatorWithResponseAsync(resourceGroupName, clusterName, configurationName, parameters);
        return this
            .client
    ...
    private PollerFlux<PollResult<ServerConfigurationInner>, ServerConfigurationInner> beginUpdateCoordinatorAsync(
        ...
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono =
            updateCoordinatorWithResponseAsync(resourceGroupName, clusterName, configurationName, parameters, context);
        return this
            .client
            .<ServerConfigurationInner, ServerConfigurationInner>getLroResult(
                mono,
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<ServerConfigurationInner>, ServerConfigurationInner> beginUpdateCoordinator(
        String resourceGroupName, String clusterName, String configurationName, ServerConfigurationRequest parameters) {
        return this
            .beginUpdateCoordinatorAsync(resourceGroupName, clusterName, configurationName, parameters)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<ServerConfigurationInner>, ServerConfigurationInner> beginUpdateCoordinator(
        ...
        Context context) {
        return this
            .beginUpdateCoordinatorAsync(resourceGroupName, clusterName, configurationName, parameters, context)
            .getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ServerConfigurationInner> updateCoordinatorAsync(
        String resourceGroupName, String clusterName, String configurationName, ServerConfigurationRequest parameters) {
        return beginUpdateCoordinatorAsync(resourceGroupName, clusterName, configurationName, parameters)
            .last()
    ...
    private Mono<ServerConfigurationInner> updateCoordinatorAsync(
        ...
        ServerConfigurationRequest parameters,
        Context context) {
        return beginUpdateCoordinatorAsync(resourceGroupName, clusterName, configurationName, parameters, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ServerConfigurationInner updateCoordinator(
        String resourceGroupName, String clusterName, String configurationName, ServerConfigurationRequest parameters) {
        return updateCoordinatorAsync(resourceGroupName, clusterName, configurationName, parameters).block();
    }
    ...
    public ServerConfigurationInner updateCoordinator(
        ...
        ServerConfigurationRequest parameters,
        Context context) {
        return updateCoordinatorAsync(resourceGroupName, clusterName, configurationName, parameters, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> updateNodeWithResponseAsync(
        String resourceGroupName, String clusterName, String configurationName, ServerConfigurationRequest parameters) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<ServerConfigurationInner>, ServerConfigurationInner> beginUpdateNodeAsync(
        String resourceGroupName, String clusterName, String configurationName, ServerConfigurationRequest parameters) {
        Mono<Response<Flux<ByteBuffer>>> mono =
            updateNodeWithResponseAsync(resourceGroupName, clusterName, configurationName, parameters);
        return this
            .client
            .<ServerConfigurationInner, ServerConfigurationInner>getLroResult(
                mono,
    ...
    private PollerFlux<PollResult<ServerConfigurationInner>, ServerConfigurationInner> beginUpdateNodeAsync(
        ...
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono =
            updateNodeWithResponseAsync(resourceGroupName, clusterName, configurationName, parameters, context);
        return this
            .client
            .<ServerConfigurationInner, ServerConfigurationInner>getLroResult(
                mono,
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<ServerConfigurationInner>, ServerConfigurationInner> beginUpdateNode(
        String resourceGroupName, String clusterName, String configurationName, ServerConfigurationRequest parameters) {
        return this.beginUpdateNodeAsync(resourceGroupName, clusterName, configurationName, parameters).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<ServerConfigurationInner>, ServerConfigurationInner> beginUpdateNode(
        ...
        Context context) {
        return this
            .beginUpdateNodeAsync(resourceGroupName, clusterName, configurationName, parameters, context)
            .getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ServerConfigurationInner> updateNodeAsync(
        String resourceGroupName, String clusterName, String configurationName, ServerConfigurationRequest parameters) {
        return beginUpdateNodeAsync(resourceGroupName, clusterName, configurationName, parameters)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<ServerConfigurationInner> updateNodeAsync(
        ...
        ServerConfigurationRequest parameters,
        Context context) {
        return beginUpdateNodeAsync(resourceGroupName, clusterName, configurationName, parameters, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ServerConfigurationInner updateNode(
        String resourceGroupName, String clusterName, String configurationName, ServerConfigurationRequest parameters) {
        return updateNodeAsync(resourceGroupName, clusterName, configurationName, parameters).block();
    }
    ...
    public ServerConfigurationInner updateNode(
        ...
        ServerConfigurationRequest parameters,
        Context context) {
        return updateNodeAsync(resourceGroupName, clusterName, configurationName, parameters, context).block();
    }
