...
/** Initializes a new instance of the CosmosDBForPostgreSqlImpl type. */
@ServiceClient(builder = CosmosDBForPostgreSqlBuilder.class)
public final class CosmosDBForPostgreSqlImpl implements CosmosDBForPostgreSql {
    ...
    /**
     * Initializes an instance of CosmosDBForPostgreSql client.
     *
    ...
    private static final ClientLogger LOGGER = new ClientLogger(CosmosDBForPostgreSqlImpl.class);
}
