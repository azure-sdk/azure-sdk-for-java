...
public final class MicrosoftPostgreSqlHyperscaleImpl implements MicrosoftPostgreSqlHyperscale {
    ...
    /** The ServerGroupOperationsClient object to access its operations. */
    private final ServerGroupOperationsClient serverGroupOperations;

    /**
     * Gets the ServerGroupOperationsClient object to access its operations.
     *
     * @return the ServerGroupOperationsClient object.
     */
    public ServerGroupOperationsClient getServerGroupOperations() {
        return this.serverGroupOperations;
    }
    ...
    MicrosoftPostgreSqlHyperscaleImpl(
        ...
        this.serverGroupOperations = new ServerGroupOperationsClientImpl(this);
    ...
    private static final ClientLogger LOGGER = new ClientLogger(MicrosoftPostgreSqlHyperscaleImpl.class);
}
