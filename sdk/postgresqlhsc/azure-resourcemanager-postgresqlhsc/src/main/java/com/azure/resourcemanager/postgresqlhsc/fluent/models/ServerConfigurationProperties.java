...
import com.azure.resourcemanager.postgresqlhsc.models.RequiresRestartEnum;
...
public final class ServerConfigurationProperties {
    ...
    private RequiresRestartEnum requiresRestart;
     ...
     */
    public RequiresRestartEnum requiresRestart() {
     ...
     * @return the ServerConfigurationProperties object itself.
     */
    public ServerConfigurationProperties withRequiresRestart(RequiresRestartEnum requiresRestart) {
