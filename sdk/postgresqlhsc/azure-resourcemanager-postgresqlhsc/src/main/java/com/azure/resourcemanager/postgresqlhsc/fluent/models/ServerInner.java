...
@Fluent
public final class ServerInner extends ProxyResource {
    /*
     ...
     */
    public ServerInner withServerEdition(String serverEdition) {
     ...
     * @return the ServerInner object itself.
     */
    public ServerInner withStorageQuotaInMb(Long storageQuotaInMb) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ServerProperties();
        }
     ...
     * @return the ServerInner object itself.
     */
    public ServerInner withVCores(Long vCores) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ServerProperties();
        }
     ...
     * @return the ServerInner object itself.
     */
    public ServerInner withEnableHa(Boolean enableHa) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ServerProperties();
        }
     ...
     * @return the ServerInner object itself.
     */
    public ServerInner withRole(ServerRole role) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ServerProperties();
        }
     ...
     * @return the ServerInner object itself.
     */
    public ServerInner withPostgresqlVersion(String postgresqlVersion) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ServerProperties();
        }
     ...
     * @return the ServerInner object itself.
     */
    public ServerInner withCitusVersion(String citusVersion) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ServerProperties();
        }
     ...
     * @return the ServerInner object itself.
     */
    public ServerInner withIsReadOnly(Boolean isReadOnly) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ServerProperties();
        }
        this.innerProperties().withIsReadOnly(isReadOnly);
        return this;
    }
