...
import com.azure.resourcemanager.postgresqlhsc.fluent.models.PrivateEndpointConnectionSimpleProperties;
...
public final class PrivateEndpointConnection extends ProxyResource {
     ...
     * @return the PrivateEndpointConnection object itself.
     */
    public PrivateEndpointConnection withGroupIds(List<String> groupIds) {
        if (this.innerProperties() == null) {
            this.innerProperties = new PrivateEndpointConnectionSimpleProperties();
        }
