...
import com.azure.resourcemanager.postgresqlhsc.models.OperationListResult;
...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    OperationsClientImpl(CosmosDBForPostgreSqlImpl client) {
        this.service =
    ...
    /**
     * The interface defining all the services for CosmosDBForPostgreSqlOperations to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{$host}")
     ...
     * @return a list of resource provider operations along with {@link PagedResponse} on successful completion of
     *     {@link Mono}.
     */
