...
public interface Server {
    ...
    /**
     * Gets the enablePublicIpAccess property: If public IP is requested or not for a server.
     *
    ...
    /**
     * Gets the isReadOnly property: If server is set to read-only.
     *
    ...
    /**
     * Gets the inner com.azure.resourcemanager.postgresqlhsc.fluent.models.ServerInner object.
     *
