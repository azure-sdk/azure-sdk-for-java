...
public final class ConfigurationsImpl implements Configurations {
    ...
    public ServerConfiguration getCoordinatorById(String id) {
        ...
        String configurationName = Utils.getValueFromIdByName(id, "coordinatorConfigurations");
            ...
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException(
                        String
                            .format(
                                "The resource ID '%s' is not valid. Missing path segment 'coordinatorConfigurations'.",
                                id)));
        }
        return this
    ...
    public Response<ServerConfiguration> getCoordinatorByIdWithResponse(String id, Context context) {
        String resourceGroupName = Utils.getValueFromIdByName(id, "resourceGroups");
        if (resourceGroupName == null) {
            throw LOGGER
                .logExceptionAsError(
        ...
        return this.getCoordinatorWithResponse(resourceGroupName, clusterName, configurationName, context);
    }
