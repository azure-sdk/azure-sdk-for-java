...
public final class ConfigurationsImpl implements Configurations {
    ...
    public ServerConfiguration updateCoordinator(
        ...
        ServerConfigurationInner inner =
            this.serviceClient().updateCoordinator(resourceGroupName, clusterName, configurationName, parameters);
        if (inner != null) {
    ...
    public ServerConfiguration updateCoordinator(
        ...
        ServerConfigurationInner inner =
            this
                .serviceClient()
                .updateCoordinator(resourceGroupName, clusterName, configurationName, parameters, context);
        if (inner != null) {
            return new ServerConfigurationImpl(inner, this.manager());
        } else {
            return null;
    ...
    public ServerConfiguration updateNode(
        String resourceGroupName, String clusterName, String configurationName, ServerConfigurationRequest parameters) {
        ServerConfigurationInner inner =
            this.serviceClient().updateNode(resourceGroupName, clusterName, configurationName, parameters);
        if (inner != null) {
            return new ServerConfigurationImpl(inner, this.manager());
        } else {
            return null;
    ...
    public ServerConfiguration updateNode(
        ...
        Context context) {
        ServerConfigurationInner inner =
            this.serviceClient().updateNode(resourceGroupName, clusterName, configurationName, parameters, context);
        if (inner != null) {
            return new ServerConfigurationImpl(inner, this.manager());
        } else {
            return null;
