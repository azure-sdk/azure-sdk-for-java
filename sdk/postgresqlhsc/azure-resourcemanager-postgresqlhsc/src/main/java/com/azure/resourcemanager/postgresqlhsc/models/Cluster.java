...
@Fluent
public final class Cluster extends Resource {
    /*
    ...
    /**
     * Get the sourceResourceId property: The source resource id to restore from. It's required to create 'ReadReplica'.
     *
    ...
    /**
     * Set the sourceResourceId property: The source resource id to restore from. It's required to create 'ReadReplica'.
     *
    ...
    /**
     * Get the sourceLocation property: The source cluster location to restore from. It's required for creating
    ...
    /**
     * Set the sourceLocation property: The source cluster location to restore from. It's required for creating
     * 'PointInTimeRestore' or 'ReadReplica' operations.
     *
     ...
     * from. It's required to create 'PointInTimeRestore'.
     *
     ...
     * @return the Cluster object itself.
     */
    public Cluster withPointInTimeUtc(OffsetDateTime pointInTimeUtc) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ClusterProperties();
        }
