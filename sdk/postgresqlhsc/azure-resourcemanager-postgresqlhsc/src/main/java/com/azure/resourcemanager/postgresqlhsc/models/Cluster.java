...
public final class Cluster extends Resource {
     ...
     * @return the Cluster object itself.
     */
    public Cluster withEnableShardsOnCoordinator(EnableShardsOnCoordinatorEnum enableShardsOnCoordinator) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ClusterProperties();
        }
     ...
     * @return the Cluster object itself.
     */
    public Cluster withEnableHa(EnableHaEnum enableHa) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ClusterProperties();
        }
     ...
     * @return the Cluster object itself.
     */
    public Cluster withCoordinatorEnablePublicIpAccess(CoordinatorEnablePublicIpEnum coordinatorEnablePublicIpAccess) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ClusterProperties();
        }
     ...
     * @return the Cluster object itself.
     */
    public Cluster withNodeEnablePublicIpAccess(NodeEnablePublicIpEnum nodeEnablePublicIpAccess) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ClusterProperties();
        }
