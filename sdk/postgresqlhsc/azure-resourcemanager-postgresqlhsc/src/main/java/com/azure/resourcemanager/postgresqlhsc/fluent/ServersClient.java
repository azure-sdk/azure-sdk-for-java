...
public interface ServersClient {
    ...
    PagedIterable<ServerInner> listByCluster(String resourceGroupName, String clusterName);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<ServerInner> listByCluster(String resourceGroupName, String clusterName, Context context);
    ...
    Response<ServerInner> getWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ServerInner get(String resourceGroupName, String clusterName, String serverName);
}
