...
public final class ClusterResponseImpl implements ClusterResponse, ClusterResponse.Definition, ClusterResponse.Update {
    ...
    public ClusterResponseImpl withEnableShardsOnCoordinator(EnableShardsOnCoordinatorEnum enableShardsOnCoordinator) {
        if (isInCreateMode()) {
    ...
    public ClusterResponseImpl withEnableHa(EnableHaEnum enableHa) {
        if (isInCreateMode()) {
    ...
    public ClusterResponseImpl withCoordinatorEnablePublicIpAccess(
    ...
    public ClusterResponseImpl withNodeEnablePublicIpAccess(NodeEnablePublicIpEnum nodeEnablePublicIpAccess) {
