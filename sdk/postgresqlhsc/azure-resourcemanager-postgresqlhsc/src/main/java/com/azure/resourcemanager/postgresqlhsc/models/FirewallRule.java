...
public interface FirewallRule {
    ...
    /**
     * Gets the startIpAddress property: The start IP address of the server group firewall rule. Must be IPv4 format.
     *
    ...
    /**
     * Gets the endIpAddress property: The end IP address of the server group firewall rule. Must be IPv4 format.
     *
    ...
    interface DefinitionStages {
        ...
        interface WithParentResource {
             ...
             */
            WithStartIpAddress withExistingServerGroupsv2(String resourceGroupName, String serverGroupName);
        }
        /** The stage of the FirewallRule definition allowing to specify startIpAddress. */
        interface WithStartIpAddress {
            /**
             * Specifies the startIpAddress property: The start IP address of the server group firewall rule. Must be
             * IPv4 format..
             *
        ...
        interface WithEndIpAddress {
            /**
             * Specifies the endIpAddress property: The end IP address of the server group firewall rule. Must be IPv4
             * format..
             *
