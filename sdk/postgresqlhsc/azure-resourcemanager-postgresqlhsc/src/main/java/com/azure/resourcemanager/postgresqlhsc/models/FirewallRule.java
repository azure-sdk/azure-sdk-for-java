...
public interface FirewallRule {
    ...
    /**
     * Gets the startIpAddress property: The start IP address of the cluster firewall rule. Must be IPv4 format.
     *
    ...
    /**
     * Gets the endIpAddress property: The end IP address of the cluster firewall rule. Must be IPv4 format.
     *
    ...
    /**
     * Gets the provisioningState property: Provisioning state of the firewall rule.
     *
    ...
    /**
     * Gets the inner com.azure.resourcemanager.postgresqlhsc.fluent.models.FirewallRuleInner object.
     *
    ...
    interface DefinitionStages {
        ...
        interface WithStartIpAddress {
            /**
             * Specifies the startIpAddress property: The start IP address of the cluster firewall rule. Must be IPv4
             * format..
             *
             * @param startIpAddress The start IP address of the cluster firewall rule. Must be IPv4 format.
             * @return the next definition stage.
             */
        ...
        interface WithEndIpAddress {
            /**
             * Specifies the endIpAddress property: The end IP address of the cluster firewall rule. Must be IPv4
             * format..
             *
             * @param endIpAddress The end IP address of the cluster firewall rule. Must be IPv4 format.
             * @return the next definition stage.
             */
