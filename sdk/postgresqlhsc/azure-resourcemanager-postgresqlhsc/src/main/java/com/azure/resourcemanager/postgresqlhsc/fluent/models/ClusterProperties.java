...
public final class ClusterProperties {
    ...
    /*
     * The source resource id to restore from. It's required to create 'ReadReplica'
     */
    @JsonProperty(value = "sourceResourceId")
    private String sourceResourceId;

    /*
     * The source cluster location to restore from. It's required for creating 'PointInTimeRestore' or 'ReadReplica'
     * operations
     */
    ...
    /*
     * Restore point creation time (ISO8601 format), specifying the time to restore from. It's required to create
     * 'PointInTimeRestore'
     */
