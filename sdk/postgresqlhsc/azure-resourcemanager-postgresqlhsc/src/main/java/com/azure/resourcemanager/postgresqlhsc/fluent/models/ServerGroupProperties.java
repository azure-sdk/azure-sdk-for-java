...
public final class ServerGroupProperties {
    ...
    /*
     * The administrator's login name of servers in server group. Can only be specified when the server is being
    ...
    /*
     * The source subscription id to restore from. It's required when 'createMode' is 'PointInTimeRestore' or
     * 'ReadReplica'
     */
    ...
    /*
     * The source resource group name to restore from. It's required when 'createMode' is 'PointInTimeRestore' or
     * 'ReadReplica'
     */
    ...
    /*
     * The source server group name to restore from. It's required when 'createMode' is 'PointInTimeRestore' or
     * 'ReadReplica'
     */
    ...
    /*
     * The source server group location to restore from. It's required when 'createMode' is 'PointInTimeRestore' or
     * 'ReadReplica'
     */
    ...
    /** Creates an instance of ServerGroupProperties class. */
