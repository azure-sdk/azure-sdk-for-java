...
import com.azure.resourcemanager.postgresqlhsc.models.PrivateLinkResourceListResult;
    ...
    public interface PrivateLinkResourcesService {
        ...
        @Get(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforPostgreSQL"
                + "/serverGroupsv2/{clusterName}/privateLinkResources")
        ...
        @Get(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforPostgreSQL"
                + "/serverGroupsv2/{clusterName}/privateLinkResources/{privateLinkResourceName}")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
