...
public final class ApiDefinitionsAsyncClient {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<GetDefinitionResponse> getDefinition(String workspaceName, String apiName, String versionName,
        ...
        return getDefinitionWithResponse(workspaceName, apiName, versionName, definitionName, requestOptions)
            ...
            .map(protocolMethodData -> protocolMethodData.toObject(GetDefinitionResponse.class));
    }
