...
public final class GetResponse1 implements JsonSerializable<GetResponse1> {
     ...
     */
    @Generated
    private GetResponse1(String title, ApiKind kind) {
        this.title = title;
        this.kind = kind;
    }
    ...
    public static GetResponse1 fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            GetResponse1 deserializedGetResponse1 = new GetResponse1(title, kind);
            deserializedGetResponse1.summary = summary;
            deserializedGetResponse1.description = description;
            deserializedGetResponse1.lifecycleStage = lifecycleStage;
            deserializedGetResponse1.termsOfService = termsOfService;
            deserializedGetResponse1.license = license;
            deserializedGetResponse1.externalDocumentation = externalDocumentation;
            deserializedGetResponse1.contacts = contacts;
            deserializedGetResponse1.customProperties = customProperties;
            deserializedGetResponse1.lastUpdated = lastUpdated;

            return deserializedGetResponse1;
        });
    }
}
