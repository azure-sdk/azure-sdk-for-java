...
public final class EnvironmentsImpl {
    ...
    public Mono<Response<BinaryData>> getWithResponseAsync(String workspaceName, String environmentName,
        ...
        return FluxUtil.withContext(
            context -> service.get(this.client.getServiceName(), this.client.getServiceVersion().getVersion(),
                workspaceName, environmentName, accept, requestOptions, context));
    }
    ...
    public Response<BinaryData> getWithResponse(String workspaceName, String environmentName,
        ...
        return service.getSync(this.client.getServiceName(), this.client.getServiceVersion().getVersion(),
            workspaceName, environmentName, accept, requestOptions, Context.NONE);
    }
