...
public final class ApiSpecExportResult implements JsonSerializable<ApiSpecExportResult> {
    ...
    /*
     * The rasdasdesult of the specification export.
     */
    @Generated
    private final String value;

    /*
     * The forasdasdmat of the specification export result.
     */
    @Generated
    ...
    /**
     * Get the value property: The rasdasdesult of the specification export.
     * 
    ...
    /**
     * Get the format property: The forasdasdmat of the specification export result.
     * 
