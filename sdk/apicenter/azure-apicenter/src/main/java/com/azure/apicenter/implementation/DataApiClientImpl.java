...
public final class DataApiClientImpl {
     ...
     */
    public DataApiClientImpl(String serviceName, DataApiServiceVersion serviceVersion) {
        this(new HttpPipelineBuilder().policies(new UserAgentPolicy(), new RetryPolicy()).build(),
            JacksonAdapter.createDefaultSerializerAdapter(), serviceName, serviceVersion);
    }
     ...
     * @param serviceVersion Service version.
     */
    public DataApiClientImpl(HttpPipeline httpPipeline, String serviceName, DataApiServiceVersion serviceVersion) {
        this(httpPipeline, JacksonAdapter.createDefaultSerializerAdapter(), serviceName, serviceVersion);
    }
