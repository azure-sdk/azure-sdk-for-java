...
public final class ApiDeploymentsAsyncClient {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<GetDeploymentResponse> getDeployment(String workspaceName, String apiName, String deploymentName) {
        ...
        return getDeploymentWithResponse(workspaceName, apiName, deploymentName, requestOptions)
            ...
            .map(protocolMethodData -> protocolMethodData.toObject(GetDeploymentResponse.class));
    }
}
