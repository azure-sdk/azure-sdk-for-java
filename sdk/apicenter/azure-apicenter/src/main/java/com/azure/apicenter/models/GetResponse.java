...
public final class GetResponse implements JsonSerializable<GetResponse> {
     ...
     */
    @Generated
    private GetResponse(String title, EnvironmentKind kind) {
        this.title = title;
        this.kind = kind;
    }
    ...
    public static GetResponse fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            GetResponse deserializedGetResponse = new GetResponse(title, kind);
            deserializedGetResponse.description = description;
            deserializedGetResponse.server = server;
            deserializedGetResponse.onboarding = onboarding;
            deserializedGetResponse.customProperties = customProperties;
