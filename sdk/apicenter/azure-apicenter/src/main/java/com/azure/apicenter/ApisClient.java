...
import com.azure.apicenter.models.GetResponse1;
...
public final class ApisClient {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<Api> list(String workspaceName, Integer top, Integer skip) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<Api> list(String workspaceName) {
        // Generated convenience method for list
        RequestOptions requestOptions = new RequestOptions();
        return serviceClient.list(workspaceName, requestOptions)
            .mapPage(bodyItemValue -> bodyItemValue.toObject(Api.class));
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public GetResponse1 get(String workspaceName, String apiName) {
        // Generated convenience method for getWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getWithResponse(workspaceName, apiName, requestOptions).getValue().toObject(GetResponse1.class);
    }
}
