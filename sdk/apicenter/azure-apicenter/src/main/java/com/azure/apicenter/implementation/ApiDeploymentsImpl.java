...
public final class ApiDeploymentsImpl {
    ...
    private PagedResponse<BinaryData> listDeploymentsSinglePage(String workspaceName, String apiName,
        RequestOptions requestOptions) {
        final String accept = "application/json";
        Response<BinaryData> res = service.listDeploymentsSync(this.client.getServiceName(), this.client.getRegion(),
    ...
    private PagedResponse<BinaryData> listDeploymentsNextSinglePage(String nextLink, RequestOptions requestOptions) {
        final String accept = "application/json";
        Response<BinaryData> res = service.listDeploymentsNextSync(nextLink, this.client.getServiceName(),
