...
public final class ApiDeploymentsImpl {
    ...
    public interface ApiDeploymentsService {
        ...
        Mono<Response<BinaryData>> listDeployments(@HostParam("serviceName") String serviceName,
        ...
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        @UnexpectedResponseExceptionType(HttpResponseException.class)
        Response<BinaryData> listDeploymentsSync(@HostParam("serviceName") String serviceName,
            @QueryParam("api-version") String apiVersion, @PathParam("workspaceName") String workspaceName,
            @PathParam("apiName") String apiName, @HeaderParam("Accept") String accept, RequestOptions requestOptions,
            Context context);
        ...
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        @UnexpectedResponseExceptionType(HttpResponseException.class)
        Mono<Response<BinaryData>> getDeployment(@HostParam("serviceName") String serviceName,
            @QueryParam("api-version") String apiVersion, @PathParam("workspaceName") String workspaceName,
            @PathParam("apiName") String apiName, @PathParam("deploymentName") String deploymentName,
        ...
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        @UnexpectedResponseExceptionType(HttpResponseException.class)
        Response<BinaryData> getDeploymentSync(@HostParam("serviceName") String serviceName,
            @QueryParam("api-version") String apiVersion, @PathParam("workspaceName") String workspaceName,
            @PathParam("apiName") String apiName, @PathParam("deploymentName") String deploymentName,
            @HeaderParam("Accept") String accept, RequestOptions requestOptions, Context context);
    ...
    private Mono<PagedResponse<BinaryData>> listDeploymentsSinglePageAsync(String workspaceName, String apiName,
        RequestOptions requestOptions) {
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.listDeployments(this.client.getServiceName(),
    ...
    public PagedFlux<BinaryData> listDeploymentsAsync(String workspaceName, String apiName,
        RequestOptions requestOptions) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PagedResponse<BinaryData> listDeploymentsSinglePage(String workspaceName, String apiName,
        RequestOptions requestOptions) {
        final String accept = "application/json";
        Response<BinaryData> res = service.listDeploymentsSync(this.client.getServiceName(),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> getDeploymentWithResponseAsync(String workspaceName, String apiName,
        String deploymentName, RequestOptions requestOptions) {
        final String accept = "application/json";
        return FluxUtil.withContext(
            context -> service.getDeployment(this.client.getServiceName(), this.client.getServiceVersion().getVersion(),
                workspaceName, apiName, deploymentName, accept, requestOptions, context));
    }
    ...
    public Response<BinaryData> getDeploymentWithResponse(String workspaceName, String apiName, String deploymentName,
        RequestOptions requestOptions) {
        final String accept = "application/json";
        return service.getDeploymentSync(this.client.getServiceName(), this.client.getServiceVersion().getVersion(),
            workspaceName, apiName, deploymentName, accept, requestOptions, Context.NONE);
    }
    ...
    private Mono<PagedResponse<BinaryData>> listDeploymentsNextSinglePageAsync(String nextLink,
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.listDeploymentsNext(nextLink, this.client.getServiceName(), accept,
    ...
    private PagedResponse<BinaryData> listDeploymentsNextSinglePage(String nextLink, RequestOptions requestOptions) {
        final String accept = "application/json";
        Response<BinaryData> res = service.listDeploymentsNextSync(nextLink, this.client.getServiceName(), accept,
