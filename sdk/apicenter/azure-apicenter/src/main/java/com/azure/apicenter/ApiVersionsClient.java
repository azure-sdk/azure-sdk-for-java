...
import com.azure.apicenter.models.GetVersionResponse;
...
public final class ApiVersionsClient {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<ApiVersion> listVersions(String workspaceName, String apiName, Integer top, Integer skip) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<ApiVersion> listVersions(String workspaceName, String apiName) {
        // Generated convenience method for listVersions
        RequestOptions requestOptions = new RequestOptions();
        return serviceClient.listVersions(workspaceName, apiName, requestOptions)
            .mapPage(bodyItemValue -> bodyItemValue.toObject(ApiVersion.class));
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public GetVersionResponse getVersion(String workspaceName, String apiName, String versionName) {
        ...
        return getVersionWithResponse(workspaceName, apiName, versionName, requestOptions).getValue()
            .toObject(GetVersionResponse.class);
    }
}
