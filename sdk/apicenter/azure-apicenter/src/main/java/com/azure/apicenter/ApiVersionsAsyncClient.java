...
public final class ApiVersionsAsyncClient {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<GetVersionResponse> getVersion(String workspaceName, String apiName, String versionName) {
        ...
        return getVersionWithResponse(workspaceName, apiName, versionName, requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(GetVersionResponse.class));
    }
}
