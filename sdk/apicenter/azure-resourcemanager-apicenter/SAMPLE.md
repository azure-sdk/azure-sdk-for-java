...
- [ImportFromApim](#resourceprovider_importfromapim)
...
public final class ApiDefinitionsExportSpecificationSamples {
    ...
    public static void apiDefinitionsExportSpecification(com.azure.resourcemanager.apicenter.ApiCenterManager manager) {
        manager.apiDefinitions().exportSpecification("contoso-resources", "contoso", "default", "echo-api", "2023-01-01", "openapi", com.azure.core.util.Context.NONE);
    }
}
```
...
### ResourceProvider_ImportFromApim
...
public final class ResourceProviderImportFromApimSamples {
    /*
     * x-ms-original-file: specification/apicenter/resource-manager/Microsoft.ApiCenter/preview/2024-03-15-preview/examples/ImportFromApim.json
     */
    /**
    ...
    public static void importFromAPIM(com.azure.resourcemanager.apicenter.ApiCenterManager manager) {
        manager.resourceProviders().importFromApim("contoso-resources", "contoso", new ImportFromApimRequest().withSourceResourceIds(Arrays.asList("/subscriptions/a200340d-6b82-494d-9dbf-687ba6e33f9e/resourceGroups/Api-Default-Central-US-EUAP/providers/Microsoft.ApiManagement/service/alzasloneuap06/apis/swagger-petstore")), com.azure.core.util.Context.NONE);
    }
}
```
...
public final class ServicesExportMetadataSchemaSamples {
    ...
    public static void servicesExportMetadataSchema(com.azure.resourcemanager.apicenter.ApiCenterManager manager) {
        manager.services().exportMetadataSchema("contoso-resources", "contoso", new MetadataSchemaExportRequest().withAssignedTo(MetadataAssignmentEntity.API), com.azure.core.util.Context.NONE);
    }
}
```
