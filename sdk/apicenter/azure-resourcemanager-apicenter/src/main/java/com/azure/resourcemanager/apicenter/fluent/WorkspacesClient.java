...
public interface WorkspacesClient {
    ...
    PagedIterable<WorkspaceInner> listByService(String resourceGroupName, String serviceName);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<WorkspaceInner> listByService(String resourceGroupName, String serviceName, String filter,
        Context context);
    ...
    Response<WorkspaceInner> getWithResponse(String resourceGroupName, String serviceName, String workspaceName,
        Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<WorkspaceInner> createOrUpdateWithResponse(String resourceGroupName, String serviceName,
