...
public final class WorkspacesImpl implements Workspaces {
    ...
    public PagedIterable<Workspace> listByService(String resourceGroupName, String serviceName) {
        PagedIterable<WorkspaceInner> inner = this.serviceClient().listByService(resourceGroupName, serviceName);
        return Utils.mapPage(inner, inner1 -> new WorkspaceImpl(inner1, this.manager()));
    }

    public PagedIterable<Workspace> listByService(String resourceGroupName, String serviceName, String filter,
        Context context) {
