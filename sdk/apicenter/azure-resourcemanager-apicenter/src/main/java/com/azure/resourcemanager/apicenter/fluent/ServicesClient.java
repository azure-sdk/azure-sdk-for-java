...
public interface ServicesClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ServiceInner createOrUpdate(String resourceGroupName, String serviceName, ServiceInner payload);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ServiceInner update(String resourceGroupName, String serviceName, ServiceUpdate payload);
