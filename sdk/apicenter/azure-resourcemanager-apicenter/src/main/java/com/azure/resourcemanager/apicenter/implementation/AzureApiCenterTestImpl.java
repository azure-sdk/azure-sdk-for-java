...
import com.azure.resourcemanager.apicenter.fluent.AzureApiCenterTest;
...
/**
 * Initializes a new instance of the AzureApiCenterTestImpl type.
 */
@ServiceClient(builder = AzureApiCenterTestBuilder.class)
public final class AzureApiCenterTestImpl implements AzureApiCenterTest {
    /**
    ...
    /**
     * Initializes an instance of AzureApiCenterTest client.
     * 
     ...
     */
    AzureApiCenterTestImpl(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter, Duration defaultPollInterval,
    ...
    private static final ClientLogger LOGGER = new ClientLogger(AzureApiCenterTestImpl.class);
}
