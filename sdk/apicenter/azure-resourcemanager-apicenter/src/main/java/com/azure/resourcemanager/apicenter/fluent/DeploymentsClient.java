...
public interface DeploymentsClient {
    ...
    PagedIterable<DeploymentInner> listByApi(String resourceGroupName, String serviceName, String workspaceName,
        String apiName);
    ...
    Response<DeploymentInner> getWithResponse(String resourceGroupName, String serviceName, String workspaceName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<DeploymentInner> createOrUpdateWithResponse(String resourceGroupName, String serviceName,
