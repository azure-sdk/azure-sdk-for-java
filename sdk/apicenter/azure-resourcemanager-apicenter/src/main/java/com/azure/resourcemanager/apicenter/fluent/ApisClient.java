...
public interface ApisClient {
    ...
    PagedIterable<ApiInner> listByWorkspace(String resourceGroupName, String serviceName, String workspaceName);
    ...
    Response<ApiInner> getWithResponse(String resourceGroupName, String serviceName, String workspaceName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<ApiInner> createOrUpdateWithResponse(String resourceGroupName, String serviceName, String workspaceName,
        String apiName, ApiInner resource, Context context);
