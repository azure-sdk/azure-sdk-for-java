...
public interface MetadataSchemasClient {
    ...
    PagedIterable<MetadataSchemaInner> listByService(String resourceGroupName, String serviceName);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<MetadataSchemaInner> listByService(String resourceGroupName, String serviceName, String filter,
        Context context);
    ...
    Response<MetadataSchemaInner> getWithResponse(String resourceGroupName, String serviceName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<MetadataSchemaInner> createOrUpdateWithResponse(String resourceGroupName, String serviceName,
