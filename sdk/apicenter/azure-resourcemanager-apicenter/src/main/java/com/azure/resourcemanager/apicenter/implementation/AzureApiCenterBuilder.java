...
public final class AzureApiCenterBuilder {
     ...
     */
    public AzureApiCenterBuilder subscriptionId(String subscriptionId) {
     ...
     * @return the AzureApiCenterBuilder.
     */
    public AzureApiCenterBuilder endpoint(String endpoint) {
     ...
     * @return the AzureApiCenterBuilder.
     */
    public AzureApiCenterBuilder environment(AzureEnvironment environment) {
     ...
     * @return the AzureApiCenterBuilder.
     */
    public AzureApiCenterBuilder pipeline(HttpPipeline pipeline) {
     ...
     * @return the AzureApiCenterBuilder.
     */
    public AzureApiCenterBuilder defaultPollInterval(Duration defaultPollInterval) {
     ...
     * @return the AzureApiCenterBuilder.
     */
    public AzureApiCenterBuilder serializerAdapter(SerializerAdapter serializerAdapter) {
