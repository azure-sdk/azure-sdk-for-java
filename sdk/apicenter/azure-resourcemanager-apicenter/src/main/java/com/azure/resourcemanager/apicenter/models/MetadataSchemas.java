...
public interface MetadataSchemas {
     ...
     */
    PagedIterable<MetadataSchema> listByService(String resourceGroupName, String serviceName);
     ...
     * @return the response of a MetadataSchema list operation as paginated response with {@link PagedIterable}.
     */
    PagedIterable<MetadataSchema> listByService(String resourceGroupName, String serviceName, String filter,
        Context context);
