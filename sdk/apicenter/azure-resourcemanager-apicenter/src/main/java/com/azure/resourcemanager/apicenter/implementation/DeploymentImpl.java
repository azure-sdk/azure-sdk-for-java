...
public final class DeploymentImpl implements Deployment, Deployment.Definition, Deployment.Update {
    ...
    public DeploymentImpl withExistingApi(
    ...
    public Deployment create(Context context) {
        this.innerObject =
            serviceManager
                ...
                .getDeployments()
                .createOrUpdateWithResponse(
                    resourceGroupName, serviceName, workspaceName, apiName, deploymentName, this.innerModel(), context)
                .getValue();
        return this;
    }
    ...
    public DeploymentImpl withDescription(Object description) {
