...
public final class EnvironmentImpl implements Environment, Environment.Definition, Environment.Update {
        ...
        this.innerObject =
            serviceManager
                ...
                .createOrUpdateWithResponse(
                    resourceGroupName, serviceName, workspaceName, environmentName, this.innerModel(), Context.NONE)
                .getValue();
        return this;
    }
    ...
    public Environment create(Context context) {
        this.innerObject =
            serviceManager
                ...
                .getEnvironments()
                .createOrUpdateWithResponse(
                    resourceGroupName, serviceName, workspaceName, environmentName, this.innerModel(), context)
                .getValue();
        return this;
    }
    ...
    public EnvironmentImpl withTypePropertiesType(EnvironmentType typePropertiesType) {
