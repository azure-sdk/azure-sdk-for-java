...
public interface EnvironmentsClient {
    ...
    PagedIterable<EnvironmentInner> listByWorkspace(String resourceGroupName, String serviceName, String workspaceName);
    ...
    Response<EnvironmentInner> getWithResponse(String resourceGroupName, String serviceName, String workspaceName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<EnvironmentInner> createOrUpdateWithResponse(String resourceGroupName, String serviceName,
