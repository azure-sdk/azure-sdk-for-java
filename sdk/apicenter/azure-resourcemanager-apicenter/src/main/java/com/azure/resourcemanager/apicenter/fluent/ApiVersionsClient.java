...
public interface ApiVersionsClient {
    ...
    PagedIterable<ApiVersionInner> listByApi(String resourceGroupName, String serviceName, String workspaceName,
        String apiName);
    ...
    Response<ApiVersionInner> getWithResponse(String resourceGroupName, String serviceName, String workspaceName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<ApiVersionInner> createOrUpdateWithResponse(String resourceGroupName, String serviceName,
