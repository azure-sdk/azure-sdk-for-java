...
import com.azure.resourcemanager.apicenter.fluent.AzureApiCenterTesttest;
...
/**
 * Initializes a new instance of the AzureApiCenterTesttestImpl type.
 */
@ServiceClient(builder = AzureApiCenterTesttestBuilder.class)
public final class AzureApiCenterTesttestImpl implements AzureApiCenterTesttest {
    /**
    ...
    /**
     * Initializes an instance of AzureApiCenterTesttest client.
     * 
     ...
     */
    AzureApiCenterTesttestImpl(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter,
    ...
    private static final ClientLogger LOGGER = new ClientLogger(AzureApiCenterTesttestImpl.class);
}
