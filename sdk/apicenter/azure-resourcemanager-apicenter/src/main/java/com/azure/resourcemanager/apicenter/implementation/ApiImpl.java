...
public final class ApiImpl implements Api, Api.Definition, Api.Update {
        ...
        this.innerObject =
            serviceManager
                ...
                .createOrUpdateWithResponse(
                    resourceGroupName, serviceName, workspaceName, apiName, this.innerModel(), Context.NONE)
                .getValue();
        return this;
    }
    ...
    public Api create(Context context) {
        this.innerObject =
            serviceManager
                ...
                .getApis()
                .createOrUpdateWithResponse(
                    resourceGroupName, serviceName, workspaceName, apiName, this.innerModel(), context)
                .getValue();
        return this;
    }
    ...
    public ApiImpl withTypePropertiesType(ApiType typePropertiesType) {
