...
public final class ApisClientImpl implements ApisClient {
     ...
     */
    ApisClientImpl(AzureApiCenterForTestingImpl client) {
        this.service = RestProxy.create(ApisService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for AzureApiCenterForTestingApis to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{$host}")
