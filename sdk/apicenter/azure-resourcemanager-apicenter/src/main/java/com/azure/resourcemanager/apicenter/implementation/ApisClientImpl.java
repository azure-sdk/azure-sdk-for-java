...
public final class ApisClientImpl implements ApisClient {
    ...
    public interface ApisService {
        ...
        Mono<Response<ApiCollection>> list(
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<ApisCreateOrUpdateResponse> createOrUpdate(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("serviceName") String serviceName,
            ...
            @PathParam("apiName") String apiName,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") ApiInner payload,
            @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ApiCollection>> listNext(
     ...
     * List APIs
     *
     * <p>Returns a collection of APIs.
     *
    ...
    private Mono<PagedResponse<ApiInner>> listSinglePageAsync(
    ...
    private PagedFlux<ApiInner> listAsync(
        String resourceGroupName, String serviceName, String workspaceName, String filter) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<ApiInner> list(
        String resourceGroupName, String serviceName, String workspaceName, String filter, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ApiInner> getAsync(
        String resourceGroupName, String serviceName, String workspaceName, String apiName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ApisCreateOrUpdateResponse> createOrUpdateWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ApiInner> createOrUpdateAsync(
        String resourceGroupName, String serviceName, String workspaceName, String apiName, ApiInner payload) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ApisCreateOrUpdateResponse createOrUpdateWithResponse(
        String resourceGroupName,
        String serviceName,
        String workspaceName,
        String apiName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ApiInner createOrUpdate(
        String resourceGroupName, String serviceName, String workspaceName, String apiName, ApiInner payload) {
     ...
     * Check if API exists
     *
     * <p>Checks if specified API exists.
     *
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
     * @param serviceName Service name.
     * @param workspaceName The name of the workspace.
