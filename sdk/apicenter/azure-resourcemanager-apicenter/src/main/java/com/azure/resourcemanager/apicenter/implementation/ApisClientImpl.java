...
public final class ApisClientImpl implements ApisClient {
    ...
    public interface ApisService {
        ...
        Mono<ApisCreateOrUpdateResponse> createOrUpdate(@HostParam("$host") String endpoint,
            ...
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("serviceName") String serviceName,
            @PathParam("workspaceName") String workspaceName, @PathParam("apiName") String apiName,
            @BodyParam("application/json") ApiInner payload, @HeaderParam("Accept") String accept, Context context);
    ...
    private Mono<ApisCreateOrUpdateResponse> createOrUpdateWithResponseAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(context -> service.createOrUpdate(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, serviceName, workspaceName, apiName, payload,
                accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<ApisCreateOrUpdateResponse> createOrUpdateWithResponseAsync(String resourceGroupName,
        ...
        return service.createOrUpdate(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, serviceName, workspaceName, apiName, payload, accept,
            context);
    }
