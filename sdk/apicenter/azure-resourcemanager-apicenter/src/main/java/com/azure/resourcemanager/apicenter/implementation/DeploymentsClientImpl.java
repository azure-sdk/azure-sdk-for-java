...
public final class DeploymentsClientImpl implements DeploymentsClient {
     ...
     */
    DeploymentsClientImpl(AzureApiCenterTestImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for AzureApiCenterTestDeployments to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{$host}")
