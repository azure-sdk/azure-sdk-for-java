...
public final class DeploymentsClientImpl implements DeploymentsClient {
     ...
     */
    DeploymentsClientImpl(AzureApiCenterForTestingImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for AzureApiCenterForTestingDeployments to be used by the proxy service
