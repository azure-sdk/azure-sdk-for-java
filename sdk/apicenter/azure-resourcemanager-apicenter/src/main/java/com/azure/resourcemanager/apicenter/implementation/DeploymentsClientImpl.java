...
public final class DeploymentsClientImpl implements DeploymentsClient {
    ...
    public interface DeploymentsService {
        ...
        Mono<Response<DeploymentCollection>> list(
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<DeploymentsGetResponse> get(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("serviceName") String serviceName,
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<DeploymentsCreateOrUpdateResponse> createOrUpdate(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("serviceName") String serviceName,
            ...
            @PathParam("deploymentName") String deploymentName,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") DeploymentInner payload,
            @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<DeploymentCollection>> listNext(
     ...
     * List deployments
     *
     * <p>Returns a collection of API deployments.
     *
    ...
    private Mono<PagedResponse<DeploymentInner>> listSinglePageAsync(
        String resourceGroupName, String serviceName, String workspaceName, String apiName, String filter) {
    ...
    private PagedFlux<DeploymentInner> listAsync(
        String resourceGroupName, String serviceName, String workspaceName, String apiName, String filter) {
    ...
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<DeploymentInner> listAsync(
        String resourceGroupName, String serviceName, String workspaceName, String apiName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<DeploymentInner> list(
        String resourceGroupName, String serviceName, String workspaceName, String apiName) {
        final String filter = null;
     ...
     * Get API deployment
     *
     * <p>Returns details of the API deployment.
     *
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
     * @param serviceName Service name.
     * @param workspaceName The name of the workspace.
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DeploymentsGetResponse> getWithResponseAsync(
        String resourceGroupName, String serviceName, String workspaceName, String apiName, String deploymentName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public DeploymentsGetResponse getWithResponse(
        String resourceGroupName,
        String serviceName,
        String workspaceName,
        String apiName,
     ...
     *
     * <p>Creates new or updates existing API deployment.
     *
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
     * @param serviceName Service name.
     * @param workspaceName The name of the workspace.
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DeploymentsCreateOrUpdateResponse> createOrUpdateWithResponseAsync(
        String resourceGroupName,
        String serviceName,
        String workspaceName,
        String apiName,
    ...
    private Mono<DeploymentInner> createOrUpdateAsync(
        ...
        return createOrUpdateWithResponseAsync(
                resourceGroupName, serviceName, workspaceName, apiName, deploymentName, payload)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public DeploymentsCreateOrUpdateResponse createOrUpdateWithResponse(
        String resourceGroupName,
        String serviceName,
        String workspaceName,
        String apiName,
        ...
        Context context) {
        return createOrUpdateWithResponseAsync(
                resourceGroupName, serviceName, workspaceName, apiName, deploymentName, payload, context)
            .block();
    }
    ...
    public DeploymentInner createOrUpdate(
        ...
        return createOrUpdateWithResponse(
                resourceGroupName, serviceName, workspaceName, apiName, deploymentName, payload, Context.NONE)
            .getValue();
    }
     ...
     *
     * <p>Checks if specified API deployment exists.
     *
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
     * @param serviceName Service name.
     * @param workspaceName The name of the workspace.
