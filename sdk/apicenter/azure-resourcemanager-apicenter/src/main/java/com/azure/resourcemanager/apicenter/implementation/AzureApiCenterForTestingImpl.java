...
import com.azure.resourcemanager.apicenter.fluent.AzureApiCenterForTesting;
...
/**
 * Initializes a new instance of the AzureApiCenterForTestingImpl type.
 */
@ServiceClient(builder = AzureApiCenterForTestingBuilder.class)
public final class AzureApiCenterForTestingImpl implements AzureApiCenterForTesting {
    /**
    ...
    /**
     * Initializes an instance of AzureApiCenterForTesting client.
     * 
     ...
     */
    AzureApiCenterForTestingImpl(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter,
    ...
    private static final ClientLogger LOGGER = new ClientLogger(AzureApiCenterForTestingImpl.class);
}
