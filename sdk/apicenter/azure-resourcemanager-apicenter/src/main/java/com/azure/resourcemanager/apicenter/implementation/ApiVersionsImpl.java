...
public final class ApiVersionsImpl implements ApiVersions {
    ...
    public ApiVersionsImpl(
        ApiVersionsClient innerClient, com.azure.resourcemanager.apicenter.ApiCenterManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public PagedIterable<ApiVersion> list(
    ...
    public Response<ApiVersion> getWithResponse(
        String resourceGroupName,
        String serviceName,
        String workspaceName,
        String apiName,
