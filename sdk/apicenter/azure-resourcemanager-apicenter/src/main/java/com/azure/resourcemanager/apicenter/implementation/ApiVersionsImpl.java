...
public final class ApiVersionsImpl implements ApiVersions {
    ...
    public PagedIterable<ApiVersion> listByApi(String resourceGroupName, String serviceName, String workspaceName,
        String apiName) {
        PagedIterable<ApiVersionInner> inner
            = this.serviceClient().listByApi(resourceGroupName, serviceName, workspaceName, apiName);
        return Utils.mapPage(inner, inner1 -> new ApiVersionImpl(inner1, this.manager()));
    }

    public PagedIterable<ApiVersion> listByApi(String resourceGroupName, String serviceName, String workspaceName,
        String apiName, String filter, Context context) {
        PagedIterable<ApiVersionInner> inner
            = this.serviceClient().listByApi(resourceGroupName, serviceName, workspaceName, apiName, filter, context);
        return Utils.mapPage(inner, inner1 -> new ApiVersionImpl(inner1, this.manager()));
    }
    ...
    public Response<ApiVersion> getWithResponse(String resourceGroupName, String serviceName, String workspaceName,
        ...
        Response<ApiVersionInner> inner = this.serviceClient().getWithResponse(resourceGroupName, serviceName,
