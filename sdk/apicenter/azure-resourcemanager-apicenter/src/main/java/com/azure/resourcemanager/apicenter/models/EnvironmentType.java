...
public final class EnvironmentType extends ExpandableStringEnum<EnvironmentType> {
    /** Static value development for EnvironmentType. */
    public static final EnvironmentType DEVELOPMENT = fromString("development");

    /** Static value testing for EnvironmentType. */
    public static final EnvironmentType TESTING = fromString("testing");

    /** Static value staging for EnvironmentType. */
    public static final EnvironmentType STAGING = fromString("staging");
