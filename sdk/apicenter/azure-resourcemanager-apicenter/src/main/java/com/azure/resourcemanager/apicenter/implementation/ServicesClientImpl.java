...
public final class ServicesClientImpl implements ServicesClient {
     ...
     */
    ServicesClientImpl(AzureApiCenterTestImpl client) {
        this.service = RestProxy.create(ServicesService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for AzureApiCenterTestServices to be used by the proxy service to perform
     * REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "AzureApiCenterTestSe")
