...
public final class ServicesClientImpl implements ServicesClient {
    ...
    public interface ServicesService {
        ...
        Mono<Response<ServiceInner>> createOrUpdate(
            ...
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("serviceName") String serviceName,
            @BodyParam("application/json") ServiceInner payload,
            @HeaderParam("Accept") String accept,
            Context context);
        ...
        Mono<Response<ServiceInner>> update(
            ...
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("serviceName") String serviceName,
            @BodyParam("application/json") ServiceUpdate payload,
            @HeaderParam("Accept") String accept,
            Context context);
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<MetadataSchemaExportResultInner>> exportMetadataSchema(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("serviceName") String serviceName,
            @QueryParam("api-version") String apiVersion,
            @QueryParam("assignedTo") MetadataAssignmentEntity assignedTo,
            @HeaderParam("Accept") String accept,
            Context context);
    ...
    private Mono<Response<ServiceInner>> createOrUpdateWithResponseAsync(
        String resourceGroupName, String serviceName, ServiceInner payload) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    private Mono<Response<ServiceInner>> updateWithResponseAsync(
        String resourceGroupName, String serviceName, ServiceUpdate payload) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    private Mono<Response<MetadataSchemaExportResultInner>> exportMetadataSchemaWithResponseAsync(
        ...
        if (assignedTo == null) {
            return Mono.error(new IllegalArgumentException("Parameter assignedTo is required and cannot be null."));
        }
        final String accept = "application/json";
        return FluxUtil
            .withContext(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<MetadataSchemaExportResultInner> exportMetadataSchemaAsync(
        String resourceGroupName, String serviceName, MetadataAssignmentEntity assignedTo) {
        return exportMetadataSchemaWithResponseAsync(resourceGroupName, serviceName, assignedTo)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<MetadataSchemaExportResultInner> exportMetadataSchemaWithResponse(
        String resourceGroupName, String serviceName, MetadataAssignmentEntity assignedTo, Context context) {
        return exportMetadataSchemaWithResponseAsync(resourceGroupName, serviceName, assignedTo, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public MetadataSchemaExportResultInner exportMetadataSchema(
        String resourceGroupName, String serviceName, MetadataAssignmentEntity assignedTo) {
        return exportMetadataSchemaWithResponse(resourceGroupName, serviceName, assignedTo, Context.NONE).getValue();
    }
