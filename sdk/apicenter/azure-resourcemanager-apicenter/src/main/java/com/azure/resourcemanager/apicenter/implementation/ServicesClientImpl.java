...
public final class ServicesClientImpl implements ServicesClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ServiceInner> createOrUpdateAsync(String resourceGroupName, String serviceName, ServiceInner payload) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ServiceInner createOrUpdate(String resourceGroupName, String serviceName, ServiceInner payload) {
    ...
    private PollerFlux<PollResult<MetadataSchemaExportResultInner>, MetadataSchemaExportResultInner>
        ...
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono
            = exportMetadataSchemaWithResponseAsync(resourceGroupName, serviceName, payload, context);
        return this.client.<MetadataSchemaExportResultInner, MetadataSchemaExportResultInner>getLroResult(mono,
            this.client.getHttpPipeline(), MetadataSchemaExportResultInner.class, MetadataSchemaExportResultInner.class,
            context);
    }
    ...
    public SyncPoller<PollResult<MetadataSchemaExportResultInner>, MetadataSchemaExportResultInner>
        ...
        return this.beginExportMetadataSchemaAsync(resourceGroupName, serviceName, payload).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<MetadataSchemaExportResultInner>, MetadataSchemaExportResultInner>
        beginExportMetadataSchema(String resourceGroupName, String serviceName, MetadataSchemaExportRequest payload,
            Context context) {
        return this.beginExportMetadataSchemaAsync(resourceGroupName, serviceName, payload, context).getSyncPoller();
    }
    ...
    private Mono<MetadataSchemaExportResultInner> exportMetadataSchemaAsync(String resourceGroupName,
        String serviceName, MetadataSchemaExportRequest payload, Context context) {
        return beginExportMetadataSchemaAsync(resourceGroupName, serviceName, payload, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    public MetadataSchemaExportResultInner exportMetadataSchema(String resourceGroupName, String serviceName,
        MetadataSchemaExportRequest payload) {
        return exportMetadataSchemaAsync(resourceGroupName, serviceName, payload).block();
    }
    ...
    public MetadataSchemaExportResultInner exportMetadataSchema(String resourceGroupName, String serviceName,
        MetadataSchemaExportRequest payload, Context context) {
        return exportMetadataSchemaAsync(resourceGroupName, serviceName, payload, context).block();
    }
