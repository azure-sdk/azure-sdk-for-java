...
public final class WorkspacesClientImpl implements WorkspacesClient {
     ...
     */
    WorkspacesClientImpl(AzureApiCenterForTestingImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for AzureApiCenterForTestingWorkspaces to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{$host}")
