...
public final class WorkspacesClientImpl implements WorkspacesClient {
     ...
     */
    WorkspacesClientImpl(AzureApiCenterTesttestImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for AzureApiCenterTesttestWorkspaces to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{$host}")
