...
public final class ApiDefinitionsClientImpl implements ApiDefinitionsClient {
     ...
     */
    ApiDefinitionsClientImpl(AzureApiCenterForTestingImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for AzureApiCenterForTestingApiDefinitions to be used by the proxy
