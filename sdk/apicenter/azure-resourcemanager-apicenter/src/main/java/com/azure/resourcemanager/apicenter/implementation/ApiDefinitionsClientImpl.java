...
public final class ApiDefinitionsClientImpl implements ApiDefinitionsClient {
    ...
    public interface ApiDefinitionsService {
        ...
        Mono<Response<ApiDefinitionCollection>> list(
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<ApiDefinitionsGetResponse> get(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("serviceName") String serviceName,
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<ApiDefinitionsCreateOrUpdateResponse> createOrUpdate(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("serviceName") String serviceName,
            ...
            @PathParam("definitionName") String definitionName,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") ApiDefinitionInner payload,
            @HeaderParam("Accept") String accept,
            Context context);
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Void>> importSpecification(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("serviceName") String serviceName,
            ...
            @PathParam("definitionName") String definitionName,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") ApiSpecImportSource payload,
            @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({200, 202})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ApiSpecExportResultInner>> exportSpecification(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("serviceName") String serviceName,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ApiDefinitionCollection>> listNext(
     ...
     *
     * <p>Returns a collection of API definitions.
     *
    ...
    private Mono<PagedResponse<ApiDefinitionInner>> listSinglePageAsync(
                ...
                context ->
                    service
                        .list(
                            ...
                            accept,
                            context))
            .<PagedResponse<ApiDefinitionInner>>map(
                res ->
    ...
    private PagedFlux<ApiDefinitionInner> listAsync(
        String resourceGroupName,
        String serviceName,
        String workspaceName,
        String apiName,
    ...
    private PagedFlux<ApiDefinitionInner> listAsync(
        ...
        return new PagedFlux<>(
            () ->
                listSinglePageAsync(
                    resourceGroupName, serviceName, workspaceName, apiName, versionName, filter, context),
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<ApiDefinitionInner> list(
        String resourceGroupName, String serviceName, String workspaceName, String apiName, String versionName) {
        final String filter = null;
     ...
     * Get API definition
     *
     * <p>Returns details of the API definition.
     *
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
     * @param serviceName Service name.
     * @param workspaceName The name of the workspace.
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ApiDefinitionsGetResponse> getWithResponseAsync(
        String resourceGroupName,
        String serviceName,
        String workspaceName,
        String apiName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ApiDefinitionInner> getAsync(
        String resourceGroupName,
        String serviceName,
        String workspaceName,
        String apiName,
     ...
     *
     * <p>Creates new or updates existing API definition.
     *
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
     * @param serviceName Service name.
     * @param workspaceName The name of the workspace.
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ApiDefinitionsCreateOrUpdateResponse> createOrUpdateWithResponseAsync(
        String resourceGroupName,
        String serviceName,
        String workspaceName,
        String apiName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ApiDefinitionInner> createOrUpdateAsync(
        String resourceGroupName,
        String serviceName,
        String workspaceName,
        String apiName,
        ...
        return createOrUpdateWithResponseAsync(
                resourceGroupName, serviceName, workspaceName, apiName, versionName, definitionName, payload)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     *
     * <p>Deletes specified API definition.
     *
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
     * @param serviceName Service name.
     * @param workspaceName The name of the workspace.
     ...
     *
     * <p>Checks if specified API definition exists.
     *
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
     * @param serviceName Service name.
     * @param workspaceName The name of the workspace.
     ...
     *
     * <p>Imports the API specification.
     *
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
     * @param serviceName Service name.
     * @param workspaceName The name of the workspace.
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Void>> importSpecificationWithResponseAsync(
        String resourceGroupName,
        String serviceName,
        String workspaceName,
        String apiName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> importSpecificationAsync(
        String resourceGroupName,
        String serviceName,
        String workspaceName,
        String apiName,
        ...
        String definitionName,
        ApiSpecImportSource payload) {
        return importSpecificationWithResponseAsync(
                resourceGroupName, serviceName, workspaceName, apiName, versionName, definitionName, payload)
            .flatMap(ignored -> Mono.empty());
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<Void> importSpecificationWithResponse(
        String resourceGroupName,
        String serviceName,
        String workspaceName,
        String apiName,
     ...
     *
     * <p>Exports the API specification.
     *
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
     * @param serviceName Service name.
     * @param workspaceName The name of the workspace.
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ApiSpecExportResultInner>> exportSpecificationWithResponseAsync(
        String resourceGroupName,
        String serviceName,
        String workspaceName,
        String apiName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ApiSpecExportResultInner> exportSpecificationAsync(
        String resourceGroupName,
        String serviceName,
        String workspaceName,
        String apiName,
        String versionName,
        String definitionName) {
        return exportSpecificationWithResponseAsync(
                resourceGroupName, serviceName, workspaceName, apiName, versionName, definitionName)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ApiSpecExportResultInner> exportSpecificationWithResponse(
        String resourceGroupName,
        String serviceName,
        String workspaceName,
        String apiName,
