...
public final class ApiDefinitionsClientImpl implements ApiDefinitionsClient {
     ...
     */
    ApiDefinitionsClientImpl(AzureApiCenterTesttestImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for AzureApiCenterTesttestApiDefinitions to be used by the proxy service
