...
public final class ApiDefinitionsClientImpl implements ApiDefinitionsClient {
     ...
     */
    ApiDefinitionsClientImpl(AzureApiCenterTestImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for AzureApiCenterTestApiDefinitions to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{$host}")
