...
public final class ApiDefinitionImpl implements ApiDefinition, ApiDefinition.Definition, ApiDefinition.Update {
    ...
    public Response<Void> importSpecificationWithResponse(ApiSpecImportSource payload, Context context) {
    ...
    public void importSpecification(ApiSpecImportSource payload) {
        serviceManager
            .apiDefinitions()
            .importSpecification(
