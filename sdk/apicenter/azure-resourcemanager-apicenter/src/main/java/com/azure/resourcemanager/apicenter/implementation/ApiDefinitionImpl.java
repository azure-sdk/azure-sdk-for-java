...
public final class ApiDefinitionImpl implements ApiDefinition, ApiDefinition.Definition, ApiDefinition.Update {
    ...
    public Response<ApiSpecExportResult> exportSpecificationWithResponse(Object body, Context context) {
    ...
    public ApiSpecExportResult exportSpecification(Object body) {
    ...
    public Response<Object> importSpecificationWithResponse(ApiSpecImportRequest body, Context context) {
        return serviceManager.apiDefinitions().importSpecificationWithResponse(resourceGroupName, serviceName,
            workspaceName, apiName, versionName, definitionName, body, context);
    }

    public Object importSpecification(ApiSpecImportRequest body) {
        return serviceManager.apiDefinitions().importSpecification(resourceGroupName, serviceName, workspaceName,
            apiName, versionName, definitionName, body);
    }
