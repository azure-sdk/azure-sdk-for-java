...
public final class ServiceImpl implements Service, Service.Definition, Service.Update {
    ...
    public MetadataSchemaExportResult exportMetadataSchema(MetadataSchemaExportRequest payload, Context context) {
        return serviceManager.services().exportMetadataSchema(resourceGroupName, serviceName, payload, context);
    }
    ...
    public ServiceImpl withTags(Map<String, String> tags) {
        if (isInCreateMode()) {
            ...
            this.updatePayload.withTags(tags);
            return this;
        }
    }
    ...
    public ServiceImpl withIdentity(ManagedServiceIdentity identity) {
        if (isInCreateMode()) {
            ...
            this.updatePayload.withIdentity(identity);
            return this;
        }
    }
