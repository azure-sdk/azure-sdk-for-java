...
public final class MetadataSchemasClientImpl implements MetadataSchemasClient {
    ...
    public interface MetadataSchemasService {
        ...
        Mono<Response<MetadataSchemaCollection>> list(
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<MetadataSchemasGetResponse> get(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("serviceName") String serviceName,
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<MetadataSchemasCreateOrUpdateResponse> createOrUpdate(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("serviceName") String serviceName,
            @PathParam("metadataSchemaName") String metadataSchemaName,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") MetadataSchemaInner payload,
            @HeaderParam("Accept") String accept,
            Context context);
     ...
     *
     * <p>Returns a collection of metadata schemas.
     *
    ...
    private Mono<PagedResponse<MetadataSchemaInner>> listSinglePageAsync(
                ...
                context ->
                    service
                        .list(
                            ...
                            accept,
                            context))
            .<PagedResponse<MetadataSchemaInner>>map(
                res ->
    ...
    private PagedFlux<MetadataSchemaInner> listAsync(String resourceGroupName, String serviceName, String filter) {
        return new PagedFlux<>(
            () -> listSinglePageAsync(resourceGroupName, serviceName, filter),
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<MetadataSchemaInner> listAsync(
        String resourceGroupName, String serviceName, String filter, Context context) {
        return new PagedFlux<>(
            () -> listSinglePageAsync(resourceGroupName, serviceName, filter, context),
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<MetadataSchemaInner> list(
        String resourceGroupName, String serviceName, String filter, Context context) {
     ...
     * Get metadata schema
     *
     * <p>Returns details of the metadata schema.
     *
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
     * @param serviceName The name of Azure API Center service.
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<MetadataSchemasGetResponse> getWithResponseAsync(
        String resourceGroupName, String serviceName, String metadataSchemaName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<MetadataSchemaInner> getAsync(
        String resourceGroupName, String serviceName, String metadataSchemaName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public MetadataSchemasGetResponse getWithResponse(
        String resourceGroupName, String serviceName, String metadataSchemaName, Context context) {
     ...
     *
     * <p>Creates new or updates existing metadata schema.
     *
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
     * @param serviceName The name of Azure API Center service.
     * @param metadataSchemaName The name of the metadata schema.
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<MetadataSchemasCreateOrUpdateResponse> createOrUpdateWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<MetadataSchemaInner> createOrUpdateAsync(
        String resourceGroupName, String serviceName, String metadataSchemaName, MetadataSchemaInner payload) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public MetadataSchemasCreateOrUpdateResponse createOrUpdateWithResponse(
        String resourceGroupName,
        String serviceName,
        String metadataSchemaName,
        MetadataSchemaInner payload,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public MetadataSchemaInner createOrUpdate(
        String resourceGroupName, String serviceName, String metadataSchemaName, MetadataSchemaInner payload) {
     ...
     *
     * <p>Deletes specified metadata schema.
     *
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
     * @param serviceName The name of Azure API Center service.
     * @param metadataSchemaName The name of the metadata schema.
     ...
     *
     * <p>Checks if specified metadata schema exists.
     *
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
     * @param serviceName The name of Azure API Center service.
     * @param metadataSchemaName The name of the metadata schema.
