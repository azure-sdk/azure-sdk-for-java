...
public final class MetadataSchemasClientImpl implements MetadataSchemasClient {
     ...
     */
    MetadataSchemasClientImpl(AzureApiCenterTesttestImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for AzureApiCenterTesttestMetadataSchemas to be used by the proxy service
