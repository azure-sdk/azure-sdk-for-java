...
public final class MetadataSchemasClientImpl implements MetadataSchemasClient {
     ...
     */
    MetadataSchemasClientImpl(AzureApiCenterForTestingImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for AzureApiCenterForTestingMetadataSchemas to be used by the proxy
