...
public final class MetadataSchemasClientImpl implements MetadataSchemasClient {
    ...
    public interface MetadataSchemasService {
        ...
        Mono<Response<MetadataSchemaListResult>> listByService(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<MetadataSchemaInner>> get(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<MetadataSchemaInner>> createOrUpdate(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("serviceName") String serviceName,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<MetadataSchemaListResult>> listByServiceNext(
    ...
    private Mono<PagedResponse<MetadataSchemaInner>> listByServiceSinglePageAsync(String resourceGroupName,
    ...
    private PagedFlux<MetadataSchemaInner> listByServiceAsync(String resourceGroupName, String serviceName,
        String filter) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<MetadataSchemaInner> listByService(String resourceGroupName, String serviceName) {
        final String filter = null;
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<MetadataSchemaInner> listByService(String resourceGroupName, String serviceName, String filter,
        Context context) {
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return metadata schema entity along with {@link Response} on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<MetadataSchemaInner>> getWithResponseAsync(String resourceGroupName, String serviceName,
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return metadata schema entity along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<MetadataSchemaInner> getWithResponse(String resourceGroupName, String serviceName,
        String metadataSchemaName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<MetadataSchemaInner>> createOrUpdateWithResponseAsync(String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<MetadataSchemaInner> createOrUpdateWithResponse(String resourceGroupName, String serviceName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<MetadataSchemaInner>> listByServiceNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
