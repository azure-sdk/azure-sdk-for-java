...
public final class ApiDefinitionsImpl implements ApiDefinitions {
    ...
    public PagedIterable<ApiDefinition> listByApiVersion(String resourceGroupName, String serviceName,
        String workspaceName, String apiName, String versionName) {
        PagedIterable<ApiDefinitionInner> inner = this.serviceClient().listByApiVersion(resourceGroupName, serviceName,
            workspaceName, apiName, versionName);
        return Utils.mapPage(inner, inner1 -> new ApiDefinitionImpl(inner1, this.manager()));
    }
    ...
    public Response<ApiDefinition> getWithResponse(String resourceGroupName, String serviceName, String workspaceName,
        ...
        Response<ApiDefinitionInner> inner = this.serviceClient().getWithResponse(resourceGroupName, serviceName,
    ...
    public Response<ApiSpecExportResult> exportSpecificationWithResponse(String resourceGroupName, String serviceName,
        String workspaceName, String apiName, String versionName, String definitionName, Object body, Context context) {
        Response<ApiSpecExportResultInner> inner = this.serviceClient().exportSpecificationWithResponse(
            resourceGroupName, serviceName, workspaceName, apiName, versionName, definitionName, body, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
    ...
    public ApiSpecExportResult exportSpecification(String resourceGroupName, String serviceName, String workspaceName,
        String apiName, String versionName, String definitionName, Object body) {
    ...
    public Object importSpecification(String resourceGroupName, String serviceName, String workspaceName,
        ...
        return this.serviceClient().importSpecification(resourceGroupName, serviceName, workspaceName, apiName,
    ...
    public ApiDefinition getById(String id) {
        ...
        String apiName = Utils.getValueFromIdByName(id, "apis");
        if (apiName == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
        ...
        String definitionName = Utils.getValueFromIdByName(id, "definitions");
