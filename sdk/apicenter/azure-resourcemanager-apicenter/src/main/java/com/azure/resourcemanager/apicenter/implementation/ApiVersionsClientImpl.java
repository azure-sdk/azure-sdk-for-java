...
public final class ApiVersionsClientImpl implements ApiVersionsClient {
     ...
     */
    ApiVersionsClientImpl(AzureApiCenterTesttestImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for AzureApiCenterTesttestApiVersions to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{$host}")
