...
public final class ApiVersionsClientImpl implements ApiVersionsClient {
     ...
     */
    ApiVersionsClientImpl(AzureApiCenterForTestingImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for AzureApiCenterForTestingApiVersions to be used by the proxy service
