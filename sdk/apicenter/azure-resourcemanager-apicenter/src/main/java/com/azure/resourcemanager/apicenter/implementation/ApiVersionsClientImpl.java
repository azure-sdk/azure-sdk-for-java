...
public final class ApiVersionsClientImpl implements ApiVersionsClient {
    ...
    public interface ApiVersionsService {
        ...
        Mono<Response<ApiVersionCollection>> list(
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<ApiVersionsGetResponse> get(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("serviceName") String serviceName,
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<ApiVersionsCreateOrUpdateResponse> createOrUpdate(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("serviceName") String serviceName,
            ...
            @PathParam("versionName") String versionName,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") ApiVersionInner payload,
            @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ApiVersionCollection>> listNext(
     ...
     * List API versions
     *
     * <p>Returns a collection of API versions.
     *
    ...
    private Mono<PagedResponse<ApiVersionInner>> listSinglePageAsync(
                ...
                context ->
                    service
                        .list(
                            ...
                            accept,
                            context))
            .<PagedResponse<ApiVersionInner>>map(
                res ->
    ...
    private PagedFlux<ApiVersionInner> listAsync(
        String resourceGroupName, String serviceName, String workspaceName, String apiName, String filter) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<ApiVersionInner> list(
        String resourceGroupName, String serviceName, String workspaceName, String apiName) {
        final String filter = null;
     ...
     * Get API version
     *
     * <p>Returns details of the API version.
     *
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
     * @param serviceName Service name.
     * @param workspaceName The name of the workspace.
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ApiVersionsGetResponse> getWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ApiVersionInner> getAsync(
        String resourceGroupName, String serviceName, String workspaceName, String apiName, String versionName) {
     ...
     *
     * <p>Creates new or updates existing API version.
     *
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
     * @param serviceName Service name.
     * @param workspaceName The name of the workspace.
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ApiVersionsCreateOrUpdateResponse> createOrUpdateWithResponseAsync(
        String resourceGroupName,
        String serviceName,
        String workspaceName,
        String apiName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ApiVersionInner> createOrUpdateAsync(
        String resourceGroupName,
        String serviceName,
        String workspaceName,
        String apiName,
        ...
        return createOrUpdateWithResponseAsync(
                resourceGroupName, serviceName, workspaceName, apiName, versionName, payload)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     * Delete API version
     *
     * <p>Deletes specified API version.
     *
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
     * @param serviceName Service name.
     * @param workspaceName The name of the workspace.
     ...
     *
     * <p>Checks if specified API version exists.
     *
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
     * @param serviceName Service name.
     * @param workspaceName The name of the workspace.
