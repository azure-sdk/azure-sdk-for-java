...
public final class MetadataSchemasImpl implements MetadataSchemas {
    ...
    public PagedIterable<MetadataSchema> listByService(String resourceGroupName, String serviceName) {
        PagedIterable<MetadataSchemaInner> inner = this.serviceClient().listByService(resourceGroupName, serviceName);
        return Utils.mapPage(inner, inner1 -> new MetadataSchemaImpl(inner1, this.manager()));
    }

    public PagedIterable<MetadataSchema> listByService(String resourceGroupName, String serviceName, String filter,
        Context context) {
    ...
    public Response<MetadataSchema> getWithResponse(String resourceGroupName, String serviceName,
        ...
        Response<MetadataSchemaInner> inner
