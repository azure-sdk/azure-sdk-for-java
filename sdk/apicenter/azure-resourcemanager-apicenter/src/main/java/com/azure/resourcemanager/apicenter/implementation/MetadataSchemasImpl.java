...
public final class MetadataSchemasImpl implements MetadataSchemas {
    ...
    public MetadataSchemasImpl(
        MetadataSchemasClient innerClient, com.azure.resourcemanager.apicenter.ApiCenterManager serviceManager) {
    ...
    public PagedIterable<MetadataSchema> list(
    ...
    public Response<MetadataSchema> getWithResponse(
        ...
        if (metadataSchemaName == null) {
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException(
                        String
                            .format("The resource ID '%s' is not valid. Missing path segment 'metadataSchemas'.", id)));
        }
