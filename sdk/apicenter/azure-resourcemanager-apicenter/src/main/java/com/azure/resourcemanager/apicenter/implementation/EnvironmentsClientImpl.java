...
public final class EnvironmentsClientImpl implements EnvironmentsClient {
    ...
    public interface EnvironmentsService {
        ...
        Mono<Response<EnvironmentCollection>> list(
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<EnvironmentsCreateOrUpdateResponse> createOrUpdate(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("serviceName") String serviceName,
            ...
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") EnvironmentInner payload,
            @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<EnvironmentsGetResponse> get(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("serviceName") String serviceName,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<EnvironmentCollection>> listNext(
     ...
     * List environments
     *
     * <p>Returns a collection of environments.
     *
    ...
    private Mono<PagedResponse<EnvironmentInner>> listSinglePageAsync(
        String resourceGroupName, String serviceName, String workspaceName, String filter) {
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<EnvironmentInner>> listSinglePageAsync(
        String resourceGroupName, String serviceName, String workspaceName, String filter, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    private PagedFlux<EnvironmentInner> listAsync(
        ...
        return new PagedFlux<>(
            () -> listSinglePageAsync(resourceGroupName, serviceName, workspaceName, filter),
     ...
     *
     * <p>Creates new or updates existing environment.
     *
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
     * @param serviceName Service name.
     * @param workspaceName The name of the workspace.
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<EnvironmentsCreateOrUpdateResponse> createOrUpdateWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public EnvironmentsCreateOrUpdateResponse createOrUpdateWithResponse(
        String resourceGroupName,
        String serviceName,
        String workspaceName,
        String environmentName,
        ...
        return createOrUpdateWithResponseAsync(
                resourceGroupName, serviceName, workspaceName, environmentName, payload, context)
            .block();
    }
    ...
    public EnvironmentInner createOrUpdate(
        ...
        return createOrUpdateWithResponse(
                resourceGroupName, serviceName, workspaceName, environmentName, payload, Context.NONE)
            .getValue();
    }
    ...
    private Mono<Response<Void>> deleteWithResponseAsync(
        String resourceGroupName, String serviceName, String workspaceName, String environmentName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     *
     * <p>Checks if specified environment exists.
     *
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
     * @param serviceName Service name.
     * @param workspaceName The name of the workspace.
     ...
     * Get environment
     *
     * <p>Returns details of the environment.
     *
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
     * @param serviceName Service name.
     * @param workspaceName The name of the workspace.
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<EnvironmentsGetResponse> getWithResponseAsync(
        String resourceGroupName, String serviceName, String workspaceName, String environmentName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public EnvironmentsGetResponse getWithResponse(
        String resourceGroupName, String serviceName, String workspaceName, String environmentName, Context context) {
