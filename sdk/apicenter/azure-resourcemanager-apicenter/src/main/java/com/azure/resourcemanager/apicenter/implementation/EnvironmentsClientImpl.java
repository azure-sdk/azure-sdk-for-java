...
public final class EnvironmentsClientImpl implements EnvironmentsClient {
     ...
     */
    EnvironmentsClientImpl(AzureApiCenterTesttestImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for AzureApiCenterTesttestEnvironments to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{$host}")
