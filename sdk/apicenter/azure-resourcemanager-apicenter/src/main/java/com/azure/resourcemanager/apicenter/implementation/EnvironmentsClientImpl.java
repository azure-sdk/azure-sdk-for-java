...
public final class EnvironmentsClientImpl implements EnvironmentsClient {
     ...
     */
    EnvironmentsClientImpl(AzureApiCenterForTestingImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for AzureApiCenterForTestingEnvironments to be used by the proxy service
