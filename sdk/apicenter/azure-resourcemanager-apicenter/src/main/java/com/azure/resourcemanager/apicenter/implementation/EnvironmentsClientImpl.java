...
public final class EnvironmentsClientImpl implements EnvironmentsClient {
    ...
    public interface EnvironmentsService {
        ...
        Mono<EnvironmentsCreateOrUpdateResponse> createOrUpdate(@HostParam("$host") String endpoint,
            ...
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("serviceName") String serviceName,
            @PathParam("workspaceName") String workspaceName, @PathParam("environmentName") String environmentName,
            @BodyParam("application/json") EnvironmentInner payload, @HeaderParam("Accept") String accept,
            Context context);
    ...
    private Mono<EnvironmentsCreateOrUpdateResponse> createOrUpdateWithResponseAsync(String resourceGroupName,
        ...
        return service.createOrUpdate(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, serviceName, workspaceName, environmentName, payload,
            accept, context);
    }
