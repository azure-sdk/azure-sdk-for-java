...
public final class EnvironmentsClientImpl implements EnvironmentsClient {
     ...
     */
    EnvironmentsClientImpl(AzureApiCenterTestImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for AzureApiCenterTestEnvironments to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "AzureApiCenterTestEn")
