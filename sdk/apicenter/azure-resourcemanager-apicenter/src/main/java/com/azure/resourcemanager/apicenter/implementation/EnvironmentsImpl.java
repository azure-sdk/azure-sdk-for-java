...
public final class EnvironmentsImpl implements Environments {
    ...
    public PagedIterable<Environment> listByWorkspace(String resourceGroupName, String serviceName,
    ...
    public Response<Environment> getWithResponse(String resourceGroupName, String serviceName, String workspaceName,
        ...
        Response<EnvironmentInner> inner = this.serviceClient().getWithResponse(resourceGroupName, serviceName,
