...
public final class ApisImpl implements Apis {
    ...
    public PagedIterable<Api> listByWorkspace(String resourceGroupName, String serviceName, String workspaceName) {
        PagedIterable<ApiInner> inner
            = this.serviceClient().listByWorkspace(resourceGroupName, serviceName, workspaceName);
        return Utils.mapPage(inner, inner1 -> new ApiImpl(inner1, this.manager()));
    }

    public PagedIterable<Api> listByWorkspace(String resourceGroupName, String serviceName, String workspaceName,
        String filter, Context context) {
        PagedIterable<ApiInner> inner
            = this.serviceClient().listByWorkspace(resourceGroupName, serviceName, workspaceName, filter, context);
        return Utils.mapPage(inner, inner1 -> new ApiImpl(inner1, this.manager()));
    }
