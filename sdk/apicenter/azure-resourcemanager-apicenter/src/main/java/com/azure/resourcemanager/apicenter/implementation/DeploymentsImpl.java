...
public final class DeploymentsImpl implements Deployments {
    ...
    public PagedIterable<Deployment> listByApi(String resourceGroupName, String serviceName, String workspaceName,
        String apiName) {
    ...
    public Response<Deployment> getWithResponse(String resourceGroupName, String serviceName, String workspaceName,
        ...
        Response<DeploymentInner> inner = this.serviceClient().getWithResponse(resourceGroupName, serviceName,
