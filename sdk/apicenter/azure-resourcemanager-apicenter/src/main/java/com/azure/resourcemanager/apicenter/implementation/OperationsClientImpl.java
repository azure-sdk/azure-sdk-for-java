...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    OperationsClientImpl(AzureApiCenterTestImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for AzureApiCenterTestOperations to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "AzureApiCenterTestOp")
