...
public final class WebhookAuthenticationSettings implements JsonSerializable<WebhookAuthenticationSettings> {
    ...
    /*
     * Azure Active Directory Application ID or URI to get the access token that will be included as the bearer token in
     * delivery requests.
     */
    private String azureActiveDirectoryApplicationIdOrUri;

    /*
     * Azure Active Directory Tenant ID to get the access token that will be included as the bearer token in delivery
     * requests.
     */
    ...
    /**
     * Get the azureActiveDirectoryApplicationIdOrUri property: Azure Active Directory Application ID or URI to get the
    ...
    /**
     * Set the azureActiveDirectoryApplicationIdOrUri property: Azure Active Directory Application ID or URI to get the
     * access token that will be included as the bearer token in delivery requests.
     * 
    ...
    /**
     * Get the azureActiveDirectoryTenantId property: Azure Active Directory Tenant ID to get the access token that will
    ...
    /**
     * Set the azureActiveDirectoryTenantId property: Azure Active Directory Tenant ID to get the access token that will
     * be included as the bearer token in delivery requests.
     * 
