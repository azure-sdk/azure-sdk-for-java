...
public final class FederatedIdentityCredentialInfo implements JsonSerializable<FederatedIdentityCredentialInfo> {
    ...
    /**
     * Get the federatedClientId property: The Multi-Tenant AAD Application where the Federated Identity Credential
     * (FIC) is associated with.
     * 
    ...
    /**
     * Set the federatedClientId property: The Multi-Tenant AAD Application where the Federated Identity Credential
     * (FIC) is associated with.
     * 
