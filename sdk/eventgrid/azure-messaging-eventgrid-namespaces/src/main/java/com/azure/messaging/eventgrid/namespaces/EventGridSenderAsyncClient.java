...
public final class EventGridSenderAsyncClient {
    ...
    public Mono<Response<BinaryData>> sendWithResponse(String topicName, BinaryData event,
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> sendEventsWithResponse(String topicName, BinaryData events,
        RequestOptions requestOptions) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PublishResult> send(String topicName, CloudEvent event) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PublishResult> sendEvents(String topicName, List<CloudEvent> events) {
