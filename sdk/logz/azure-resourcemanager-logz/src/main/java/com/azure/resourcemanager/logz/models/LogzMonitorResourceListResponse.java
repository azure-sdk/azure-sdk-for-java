...
public final class LogzMonitorResourceListResponse {
     ...
     */
    public LogzMonitorResourceListResponse withValue(List<LogzMonitorResourceInner> value) {
        this.value = value;
        return this;
    }
     ...
     * @return the LogzMonitorResourceListResponse object itself.
     */
    public LogzMonitorResourceListResponse withNextLink(String nextLink) {
