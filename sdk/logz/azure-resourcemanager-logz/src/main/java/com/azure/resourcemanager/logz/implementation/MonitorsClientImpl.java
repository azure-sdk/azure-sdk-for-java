...
public final class MonitorsClientImpl implements MonitorsClient {
    ...
    public interface MonitorsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<LogzMonitorResourceListResponse>> listByResourceGroup(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<LogzMonitorResourceInner>> getByResourceGroup(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("monitorName") String monitorName,
            @QueryParam("api-version") String apiVersion, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<UserRoleListResponse>> listUserRoles(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("monitorName") String monitorName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<LogzMonitorResourceInner>> getByResourceGroupWithResponseAsync(String resourceGroupName,
        String monitorName) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<LogzMonitorResourceInner> getByResourceGroupWithResponse(String resourceGroupName,
        String monitorName, Context context) {
    ...
    private PollerFlux<PollResult<LogzMonitorResourceInner>, LogzMonitorResourceInner>
        beginCreateAsync(String resourceGroupName, String monitorName, LogzMonitorResourceInner body) {
    ...
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<LogzMonitorResourceInner>, LogzMonitorResourceInner>
        beginCreateAsync(String resourceGroupName, String monitorName, LogzMonitorResourceInner body, Context context) {
        context = this.client.mergeContext(context);
    ...
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<LogzMonitorResourceInner>, LogzMonitorResourceInner>
        beginCreate(String resourceGroupName, String monitorName, LogzMonitorResourceInner body, Context context) {
    ...
    private Mono<LogzMonitorResourceInner> createAsync(String resourceGroupName, String monitorName,
        LogzMonitorResourceInner body, Context context) {
        return beginCreateAsync(resourceGroupName, monitorName, body, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public LogzMonitorResourceInner create(String resourceGroupName, String monitorName, LogzMonitorResourceInner body,
        Context context) {
    ...
    private Mono<Response<LogzMonitorResourceInner>> updateWithResponseAsync(String resourceGroupName,
        String monitorName, LogzMonitorResourceUpdateParameters body) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<LogzMonitorResourceInner>> updateWithResponseAsync(String resourceGroupName,
        String monitorName, LogzMonitorResourceUpdateParameters body, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return response for list of user's role for Logz.io account along with {@link PagedResponse} on successful
     * completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<UserRoleResponseInner>> listUserRolesSinglePageAsync(String resourceGroupName,
        String monitorName, UserRoleRequest body) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.listUserRoles(this.client.getEndpoint(), this.client.getSubscriptionId(),
                resourceGroupName, monitorName, this.client.getApiVersion(), body, accept, context))
            .<PagedResponse<UserRoleResponseInner>>map(res -> new PagedResponseBase<>(res.getRequest(),
                res.getStatusCode(), res.getHeaders(), res.getValue().value(), res.getValue().nextLink(), null))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<UserRoleResponseInner>> listUserRolesSinglePageAsync(String resourceGroupName,
        String monitorName, UserRoleRequest body, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        context = this.client.mergeContext(context);
        return service
            .listUserRoles(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName, monitorName,
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return response for list of user's role for Logz.io account as paginated response with {@link PagedFlux}.
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<UserRoleResponseInner> listUserRolesAsync(String resourceGroupName, String monitorName,
        UserRoleRequest body) {
        return new PagedFlux<>(() -> listUserRolesSinglePageAsync(resourceGroupName, monitorName, body),
    ...
    private PagedFlux<UserRoleResponseInner> listUserRolesAsync(String resourceGroupName, String monitorName,
        ...
        return new PagedFlux<>(() -> listUserRolesSinglePageAsync(resourceGroupName, monitorName, body, context),
    ...
    private Mono<PagedResponse<UserRoleResponseInner>> listUserRolesNextSinglePageAsync(String nextLink,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.listUserRolesNext(nextLink, this.client.getEndpoint(), accept, context)
            .map(res -> new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(),
                res.getValue().value(), res.getValue().nextLink(), null));
    }
}
