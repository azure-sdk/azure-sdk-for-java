...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    OperationsClientImpl(MicrosoftLogzImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for MicrosoftLogzOperations to be used by the proxy service to perform
     * REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "MicrosoftLogzOperati")
     ...
     * @return result of GET request to list the Microsoft.Logz operations along with {@link PagedResponse} on
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return result of GET request to list the Microsoft.Logz operations as paginated response with {@link PagedFlux}.
     */
