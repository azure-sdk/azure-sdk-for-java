...
public final class TagRulesClientImpl implements TagRulesClient {
    ...
    /**
     * The interface defining all the services for MicrosoftLogzTagRules to be used by the proxy service to perform REST
     * calls.
     */
    @Host("{$host}")
    ...
    public interface TagRulesService {
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<TagRulesDeleteResponse> delete(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("monitorName") String monitorName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<TagRulesDeleteResponse> deleteWithResponseAsync(
        String resourceGroupName, String monitorName, String ruleSetName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public TagRulesDeleteResponse deleteWithResponse(
        String resourceGroupName, String monitorName, String ruleSetName, Context context) {
