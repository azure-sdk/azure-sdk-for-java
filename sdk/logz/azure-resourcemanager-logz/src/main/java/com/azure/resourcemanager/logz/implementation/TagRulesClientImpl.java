...
public final class TagRulesClientImpl implements TagRulesClient {
     ...
     */
    TagRulesClientImpl(MicrosoftLogzImpl client) {
        this.service = RestProxy.create(TagRulesService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for MicrosoftLogzTagRules to be used by the proxy service to perform
     * REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "MicrosoftLogzTagRule")
    public interface TagRulesService {
        ...
        Mono<Response<MonitoringTagRulesInner>> createOrUpdate(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("monitorName") String monitorName,
            @PathParam("ruleSetName") String ruleSetName, @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") MonitoringTagRulesInner body, @HeaderParam("Accept") String accept,
            Context context);
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<TagRulesDeleteResponse> delete(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("monitorName") String monitorName,
            @PathParam("ruleSetName") String ruleSetName, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, Context context);
    ...
    private Mono<Response<MonitoringTagRulesInner>> createOrUpdateWithResponseAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(context -> service.createOrUpdate(this.client.getEndpoint(), this.client.getSubscriptionId(),
                resourceGroupName, monitorName, ruleSetName, this.client.getApiVersion(), body, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<MonitoringTagRulesInner>> createOrUpdateWithResponseAsync(String resourceGroupName,
        String monitorName, String ruleSetName, MonitoringTagRulesInner body, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service.createOrUpdate(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            monitorName, ruleSetName, this.client.getApiVersion(), body, accept, context);
    }
    ...
    private Mono<Response<MonitoringTagRulesInner>> getWithResponseAsync(String resourceGroupName, String monitorName,
        ...
        return FluxUtil
            .withContext(context -> service.get(this.client.getEndpoint(), this.client.getSubscriptionId(),
                resourceGroupName, monitorName, ruleSetName, this.client.getApiVersion(), accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<MonitoringTagRulesInner>> getWithResponseAsync(String resourceGroupName, String monitorName,
        ...
        return service.get(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName, monitorName,
            ruleSetName, this.client.getApiVersion(), accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<TagRulesDeleteResponse> deleteWithResponseAsync(String resourceGroupName, String monitorName,
        String ruleSetName) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
    ...
    private Mono<TagRulesDeleteResponse> deleteWithResponseAsync(String resourceGroupName, String monitorName,
        ...
        return service.delete(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            monitorName, ruleSetName, this.client.getApiVersion(), accept, context);
    }
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String monitorName, String ruleSetName) {
        return deleteWithResponseAsync(resourceGroupName, monitorName, ruleSetName).flatMap(ignored -> Mono.empty());
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public TagRulesDeleteResponse deleteWithResponse(String resourceGroupName, String monitorName, String ruleSetName,
        Context context) {
        return deleteWithResponseAsync(resourceGroupName, monitorName, ruleSetName, context).block();
    }
    ...
    public void delete(String resourceGroupName, String monitorName, String ruleSetName) {
        deleteWithResponse(resourceGroupName, monitorName, ruleSetName, Context.NONE);
    }
