...
public final class SubAccountTagRulesImpl implements SubAccountTagRules {
    ...
    public Response<MonitoringTagRules> createOrUpdateWithResponse(String resourceGroupName, String monitorName,
        ...
        Response<MonitoringTagRulesInner> inner = this.serviceClient().createOrUpdateWithResponse(resourceGroupName,
            monitorName, subAccountName, ruleSetName, body, context);
        if (inner != null) {
    ...
    public Response<MonitoringTagRules> getWithResponse(String resourceGroupName, String monitorName,
        ...
        Response<MonitoringTagRulesInner> inner = this.serviceClient().getWithResponse(resourceGroupName, monitorName,
            subAccountName, ruleSetName, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
                new MonitoringTagRulesImpl(inner.getValue(), this.manager()));
        } else {
    ...
    public SubAccountTagRulesDeleteResponse deleteWithResponse(String resourceGroupName, String monitorName,
        String subAccountName, String ruleSetName, Context context) {
        return this.serviceClient().deleteWithResponse(resourceGroupName, monitorName, subAccountName, ruleSetName,
            context);
    }
