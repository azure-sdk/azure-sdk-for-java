...
public final class ImmutabilityPolicyImpl
    ...
    public ImmutabilityPolicy create() {
        this.innerObject = serviceManager.serviceClient()
            .getBlobContainers()
            .createOrUpdateImmutabilityPolicyWithResponse(resourceGroupName, accountName, containerName,
                immutabilityPolicyName, this.innerModel(), createIfMatch, Context.NONE)
            .getValue();
        return this;
    }
    ...
    public ImmutabilityPolicy create(Context context) {
        this.innerObject = serviceManager.serviceClient()
            .getBlobContainers()
            .createOrUpdateImmutabilityPolicyWithResponse(resourceGroupName, accountName, containerName,
                immutabilityPolicyName, this.innerModel(), createIfMatch, context)
            .getValue();
        return this;
    }
    ...
    public ImmutabilityPolicy apply() {
        this.innerObject = serviceManager.serviceClient()
            .getBlobContainers()
            .createOrUpdateImmutabilityPolicyWithResponse(resourceGroupName, accountName, containerName,
                immutabilityPolicyName, this.innerModel(), updateIfMatch, Context.NONE)
            .getValue();
        return this;
    }
    ...
    public ImmutabilityPolicy apply(Context context) {
        this.innerObject = serviceManager.serviceClient()
            .getBlobContainers()
            .createOrUpdateImmutabilityPolicyWithResponse(resourceGroupName, accountName, containerName,
                immutabilityPolicyName, this.innerModel(), updateIfMatch, context)
            .getValue();
        return this;
    }
