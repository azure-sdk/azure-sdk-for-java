...
public final class ImmutabilityPolicyImpl
    ...
    public ImmutabilityPolicy create() {
        this.innerObject = serviceManager.serviceClient()
            .getBlobContainers()
            .createOrUpdateImmutabilityPolicyWithResponse(resourceGroupName, accountName, blobServicesName,
                containerName, immutabilityPolicyName, this.innerModel(), createIfMatch, Context.NONE)
            .getValue();
        return this;
    }
    ...
    public ImmutabilityPolicy create(Context context) {
        this.innerObject = serviceManager.serviceClient()
            .getBlobContainers()
            .createOrUpdateImmutabilityPolicyWithResponse(resourceGroupName, accountName, blobServicesName,
                containerName, immutabilityPolicyName, this.innerModel(), createIfMatch, context)
            .getValue();
        return this;
    }

    ImmutabilityPolicyImpl(String name, com.azure.resourcemanager.storage.generated.StorageManager serviceManager) {
        this.innerObject = new ImmutabilityPolicyInner();
        this.serviceManager = serviceManager;
        this.immutabilityPolicyName = name;
    ...
    public ImmutabilityPolicy apply() {
        this.innerObject = serviceManager.serviceClient()
            .getBlobContainers()
            .createOrUpdateImmutabilityPolicyWithResponse(resourceGroupName, accountName, blobServicesName,
                containerName, immutabilityPolicyName, this.innerModel(), updateIfMatch, Context.NONE)
            .getValue();
        return this;
    }
    ...
    public ImmutabilityPolicy apply(Context context) {
        this.innerObject = serviceManager.serviceClient()
            .getBlobContainers()
            .createOrUpdateImmutabilityPolicyWithResponse(resourceGroupName, accountName, blobServicesName,
                containerName, immutabilityPolicyName, this.innerModel(), updateIfMatch, context)
            .getValue();
        return this;
    }
    ...
    ImmutabilityPolicyImpl(ImmutabilityPolicyInner innerObject,
        ...
        this.immutabilityPolicyName
            = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "immutabilityPolicies");
    }
    ...
    public ImmutabilityPolicy refresh(Context context) {
        ...
        this.innerObject = serviceManager.serviceClient()
            .getBlobContainers()
            .getImmutabilityPolicyWithResponse(resourceGroupName, accountName, blobServicesName, containerName,
                immutabilityPolicyName, localIfMatch, context)
            .getValue();
        return this;
    }
