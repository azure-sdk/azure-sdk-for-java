...
public final class StorageAccountPropertiesCreateParameters {
    ...
    /*
     * Allows https traffic only to storage service if set to true. The default value is true since API version
     * 2019-04-01.
     */
     ...
     * Directory (Azure AD). The default value is null, which is equivalent to false.
     */
    ...
    /**
     * Get the enableHttpsTrafficOnly property: Allows https traffic only to storage service if set to true. The default
    ...
    /**
     * Set the enableHttpsTrafficOnly property: Allows https traffic only to storage service if set to true. The default
     * value is true since API version 2019-04-01.
     *
    ...
    /**
     * Get the isHnsEnabled property: Account HierarchicalNamespace enabled if set to true.
     *
    ...
    /**
     * Set the isHnsEnabled property: Account HierarchicalNamespace enabled if set to true.
     *
    ...
    /**
     * Get the largeFileSharesState property: Allow large file shares if set to Enabled. It cannot be disabled once it
     * is enabled.
     *
    ...
    /**
     * Set the largeFileSharesState property: Allow large file shares if set to Enabled. It cannot be disabled once it
     * is enabled.
     *
