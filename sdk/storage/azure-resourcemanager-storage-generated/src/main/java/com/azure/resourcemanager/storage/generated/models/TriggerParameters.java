...
public final class TriggerParameters implements JsonSerializable<TriggerParameters> {
     ...
     */
    private TriggerParametersIntervalUnit intervalUnit;
     ...
     */
    public TriggerParametersIntervalUnit intervalUnit() {
     ...
     * @return the TriggerParameters object itself.
     */
    public TriggerParameters withIntervalUnit(TriggerParametersIntervalUnit intervalUnit) {
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("startFrom".equals(fieldName)) {
                    ...
                    deserializedTriggerParameters.intervalUnit
                        = TriggerParametersIntervalUnit.fromString(reader.getString());
