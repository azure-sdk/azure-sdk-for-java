...
public final class AccountImmutabilityPolicyProperties {
    /*
     * The immutability period for the blobs in the container since the policy creation in days. 0 is returned when
     * state is disabled.
     */
     ...
     * since the policy creation in days. 0 is returned when state is disabled.
     *
