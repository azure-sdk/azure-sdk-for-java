 ...
 */
@Fluent
public final class TriggerParametersUpdate implements JsonSerializable<TriggerParametersUpdate> {
    /*
     ...
     */
    private TriggerParametersUpdateIntervalUnit intervalUnit;
     ...
     */
    public TriggerParametersUpdateIntervalUnit intervalUnit() {
     ...
     * @return the TriggerParametersUpdate object itself.
     */
    public TriggerParametersUpdate withIntervalUnit(TriggerParametersUpdateIntervalUnit intervalUnit) {
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("startFrom".equals(fieldName)) {
                    ...
                    deserializedTriggerParametersUpdate.intervalUnit
                        = TriggerParametersUpdateIntervalUnit.fromString(reader.getString());
