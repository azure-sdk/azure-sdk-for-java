...
public interface BlobServicesClient {
    ...
    Response<BlobServicePropertiesInner> getServicePropertiesWithResponse(String resourceGroupName, String accountName,
        String blobServicesName, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<BlobServicePropertiesInner> setServicePropertiesWithResponse(String resourceGroupName, String accountName,
        String blobServicesName, BlobServicePropertiesInner parameters, Context context);
