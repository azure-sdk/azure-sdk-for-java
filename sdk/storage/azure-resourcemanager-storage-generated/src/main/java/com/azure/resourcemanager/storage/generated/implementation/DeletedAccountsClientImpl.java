...
import com.azure.resourcemanager.storage.generated.models.DeletedAccountListResult;
...
public final class DeletedAccountsClientImpl implements DeletedAccountsClient {
    ...
    public interface DeletedAccountsService {
        ...
        Mono<Response<DeletedAccountListResult>> list(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<DeletedAccountInner>> get(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("location") String location, @PathParam("deletedAccountName") String deletedAccountName,
            @HeaderParam("Accept") String accept, Context context);
     ...
     * @return the response of a DeletedAccount list operation along with {@link PagedResponse} on successful completion
     * of {@link Mono}.
     */
    ...
    private Mono<PagedResponse<DeletedAccountInner>> listSinglePageAsync() {
        ...
        return FluxUtil
            ...
            .<PagedResponse<DeletedAccountInner>>map(res -> new PagedResponseBase<>(res.getRequest(),
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the response of a DeletedAccount list operation as paginated response with {@link PagedFlux}.
     */
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the response of a DeletedAccount list operation as paginated response with {@link PagedIterable}.
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<DeletedAccountInner>> getWithResponseAsync(String location, String deletedAccountName) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return FluxUtil
            .withContext(context -> service.get(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), location, deletedAccountName, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<DeletedAccountInner>> getWithResponseAsync(String location, String deletedAccountName,
        ...
        return service.get(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            location, deletedAccountName, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DeletedAccountInner> getAsync(String location, String deletedAccountName) {
        return getWithResponseAsync(location, deletedAccountName).flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<DeletedAccountInner> getWithResponse(String location, String deletedAccountName, Context context) {
        return getWithResponseAsync(location, deletedAccountName, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public DeletedAccountInner get(String location, String deletedAccountName) {
        return getWithResponse(location, deletedAccountName, Context.NONE).getValue();
    }
