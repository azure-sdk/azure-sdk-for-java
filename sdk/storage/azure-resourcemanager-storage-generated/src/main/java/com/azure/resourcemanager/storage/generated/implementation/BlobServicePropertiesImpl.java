...
public final class BlobServicePropertiesImpl
    ...
    public BlobServiceProperties create() {
        this.innerObject = serviceManager.serviceClient()
            .getBlobServices()
            .setServicePropertiesWithResponse(resourceGroupName, accountName, blobServicesName, this.innerModel(),
                Context.NONE)
            .getValue();
        return this;
    }
    ...
    BlobServicePropertiesImpl(String name, com.azure.resourcemanager.storage.generated.StorageManager serviceManager) {
        this.innerObject = new BlobServicePropertiesInner();
        this.serviceManager = serviceManager;
        this.blobServicesName = name;
    }
    ...
    public BlobServiceProperties refresh() {
        this.innerObject = serviceManager.serviceClient()
            .getBlobServices()
            .getServicePropertiesWithResponse(resourceGroupName, accountName, blobServicesName, Context.NONE)
            .getValue();
        return this;
    }
