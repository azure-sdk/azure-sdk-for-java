...
public final class ListQueueResource implements JsonSerializable<ListQueueResource> {
    ...
    /**
     * Set the value property: The ListQueue items on this page.
     * 
     * @param value the value value to set.
     * @return the ListQueueResource object itself.
     */
    public ListQueueResource withValue(List<ListQueueInner> value) {
        this.value = value;
        return this;
    }
     ...
     * @return the ListQueueResource object itself.
     */
    public ListQueueResource withNextLink(String nextLink) {
    ...
    public void validate() {
        if (value() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Missing required property value in model ListQueueResource"));
        } else {
            value().forEach(e -> e.validate());
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(ListQueueResource.class);
