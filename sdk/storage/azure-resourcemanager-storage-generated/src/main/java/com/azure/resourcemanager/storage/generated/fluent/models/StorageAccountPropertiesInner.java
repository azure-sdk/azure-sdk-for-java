...
public final class StorageAccountPropertiesInner {
    ...
    /**
     * Get the enableHttpsTrafficOnly property: Allows https traffic only to storage service if set to true.
     *
    ...
    /**
     * Set the enableHttpsTrafficOnly property: Allows https traffic only to storage service if set to true.
     *
