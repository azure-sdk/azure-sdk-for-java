...
public interface StorageAccount {
     ...
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     */
    void abortHierarchicalNamespaceMigration(Context context);
     ...
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     */
    void failover(Constant85 failoverType, Context context);
     ...
     */
    Response<StorageAccountListKeysResult> listKeysWithResponse(Constant86 expand, Context context);
     ...
     * @return the response from the ListKeys operation along with {@link Response}.
     */
    Response<StorageAccountListKeysResult>
