...
public final class DeleteRetentionPolicy {
     ...
     * the maximum value can be 365. 0 will be returned when policy is disabled.
     */
     ...
     * specified value can be 1 and the maximum value can be 365. 0 will be returned when policy is disabled.
     *
