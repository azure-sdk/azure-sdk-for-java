 ...
 */
@Fluent
public final class FileShareInner extends ProxyResource {
    /*
    ...
    /**
     * Get the innerProperties property: Properties of the file share.
     * 
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("id".equals(fieldName)) {
                    ...
                    deserializedFileShareInner.innerProperties = FileShareProperties.fromJson(reader);
