...
public final class BlobContainerImpl implements BlobContainer, BlobContainer.Definition, BlobContainer.Update {
    ...
    public BlobContainer create() {
        this.innerObject = serviceManager.serviceClient()
            .getBlobContainers()
            .createWithResponse(resourceGroupName, accountName, blobServicesName, containerName, this.innerModel(),
                Context.NONE)
            .getValue();
        return this;
    }
    ...
    public BlobContainer apply() {
        this.innerObject = serviceManager.serviceClient()
            .getBlobContainers()
            .updateWithResponse(resourceGroupName, accountName, blobServicesName, containerName, this.innerModel(),
                Context.NONE)
            .getValue();
        return this;
    }
    ...
    BlobContainerImpl(BlobContainerInner innerObject,
        ...
        this.blobServicesName = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "blobServices");
    ...
    public BlobContainer refresh() {
        this.innerObject = serviceManager.serviceClient()
            .getBlobContainers()
            .getWithResponse(resourceGroupName, accountName, blobServicesName, containerName, Context.NONE)
            .getValue();
        return this;
    }
    ...
    public LeaseContainerResponse lease() {
        return serviceManager.blobContainers().lease(resourceGroupName, accountName, blobServicesName, containerName);
    }

    public void objectLevelWorm() {
        serviceManager.blobContainers()
            .objectLevelWorm(resourceGroupName, accountName, blobServicesName, containerName);
    }

    public void objectLevelWorm(Context context) {
        serviceManager.blobContainers()
            .objectLevelWorm(resourceGroupName, accountName, blobServicesName, containerName, context);
    }
