...
public final class FileShareItems implements JsonSerializable<FileShareItems> {
    ...
    /**
     * Set the value property: The FileShareItem items on this page.
     * 
     * @param value the value value to set.
     * @return the FileShareItems object itself.
     */
    public FileShareItems withValue(List<FileShareItemInner> value) {
        this.value = value;
        return this;
    }
     ...
     * @return the FileShareItems object itself.
     */
    public FileShareItems withNextLink(String nextLink) {
    ...
    public void validate() {
        if (value() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Missing required property value in model FileShareItems"));
        } else {
            value().forEach(e -> e.validate());
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(FileShareItems.class);
