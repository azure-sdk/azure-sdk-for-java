...
import com.azure.resourcemanager.storage.generated.models.FileServiceUsages;
...
public final class FileServicesClientImpl implements FileServicesClient {
    ...
    private Mono<Response<FileServicePropertiesInner>> getServicePropertiesWithResponseAsync(String resourceGroupName,
        String accountName, String fileServicesName) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return FluxUtil
            .withContext(context -> service.getServiceProperties(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, accountName, fileServicesName, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<FileServicePropertiesInner>> getServicePropertiesWithResponseAsync(String resourceGroupName,
        String accountName, String fileServicesName, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    private Mono<FileServicePropertiesInner> getServicePropertiesAsync(String resourceGroupName, String accountName,
        ...
        return getServicePropertiesWithResponseAsync(resourceGroupName, accountName, fileServicesName)
    ...
    public Response<FileServicePropertiesInner> getServicePropertiesWithResponse(String resourceGroupName,
        String accountName, String fileServicesName, Context context) {
        return getServicePropertiesWithResponseAsync(resourceGroupName, accountName, fileServicesName, context).block();
    }
    ...
    public FileServicePropertiesInner getServiceProperties(String resourceGroupName, String accountName,
        String fileServicesName) {
        return getServicePropertiesWithResponse(resourceGroupName, accountName, fileServicesName, Context.NONE)
            .getValue();
    }
    ...
    private Mono<Response<FileServicePropertiesInner>> setServicePropertiesWithResponseAsync(String resourceGroupName,
        String accountName, String fileServicesName, FileServicePropertiesInner parameters) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return FluxUtil
            .withContext(context -> service.setServiceProperties(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, accountName, fileServicesName, parameters, accept,
                context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<FileServicePropertiesInner>> setServicePropertiesWithResponseAsync(String resourceGroupName,
        String accountName, String fileServicesName, FileServicePropertiesInner parameters, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<FileServicePropertiesInner> setServicePropertiesAsync(String resourceGroupName, String accountName,
        String fileServicesName, FileServicePropertiesInner parameters) {
        return setServicePropertiesWithResponseAsync(resourceGroupName, accountName, fileServicesName, parameters)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
    ...
    public FileServicePropertiesInner setServiceProperties(String resourceGroupName, String accountName,
        String fileServicesName, FileServicePropertiesInner parameters) {
        return setServicePropertiesWithResponse(resourceGroupName, accountName, fileServicesName, parameters,
     ...
     * @param accountName The name of the storage account within the specified resource group. Storage account names
     * must be between 3 and 24 characters in length and use numbers and lower-case letters only.
     * @param fileServicesName The name of the FileServiceProperties.
    ...
    private Mono<PagedResponse<FileServiceUsageInner>> listServiceUsagesSinglePageAsync(String resourceGroupName,
        String accountName, String fileServicesName, Integer maxpagesize) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.listServiceUsages(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, accountName, fileServicesName, maxpagesize, accept,
                context))
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<FileServiceUsageInner>> listServiceUsagesSinglePageAsync(String resourceGroupName,
        String accountName, String fileServicesName, Integer maxpagesize, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        context = this.client.mergeContext(context);
        return service
            .listServiceUsages(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
                resourceGroupName, accountName, fileServicesName, maxpagesize, accept, context)
    ...
    private PagedFlux<FileServiceUsageInner> listServiceUsagesAsync(String resourceGroupName, String accountName,
        String fileServicesName, Integer maxpagesize) {
        return new PagedFlux<>(
            () -> listServiceUsagesSinglePageAsync(resourceGroupName, accountName, fileServicesName, maxpagesize),
    ...
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<FileServiceUsageInner> listServiceUsagesAsync(String resourceGroupName, String accountName,
        String fileServicesName, Integer maxpagesize, Context context) {
        return new PagedFlux<>(() -> listServiceUsagesSinglePageAsync(resourceGroupName, accountName, fileServicesName,
            maxpagesize, context), nextLink -> listServiceUsagesNextSinglePageAsync(nextLink, context));
    }
    ...
    public PagedIterable<FileServiceUsageInner> listServiceUsages(String resourceGroupName, String accountName,
        ...
        return new PagedIterable<>(
            listServiceUsagesAsync(resourceGroupName, accountName, fileServicesName, maxpagesize));
    }
    ...
    public PagedIterable<FileServiceUsageInner> listServiceUsages(String resourceGroupName, String accountName,
        String fileServicesName, Integer maxpagesize, Context context) {
        return new PagedIterable<>(
            listServiceUsagesAsync(resourceGroupName, accountName, fileServicesName, maxpagesize, context));
    }
     ...
     * must be between 3 and 24 characters in length and use numbers and lower-case letters only.
     * @param fileServicesName The name of the FileServiceProperties.
     * @param fileServiceUsagesName The fileServiceUsagesName parameter.
     * @throws IllegalArgumentException thrown if parameters fail the validation.
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
    ...
    private Mono<Response<FileServiceUsageInner>> getServiceUsageWithResponseAsync(String resourceGroupName,
        String accountName, String fileServicesName, String fileServiceUsagesName) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        if (fileServiceUsagesName == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter fileServiceUsagesName is required and cannot be null."));
        }
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.getServiceUsage(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, accountName, fileServicesName,
                fileServiceUsagesName, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<FileServiceUsageInner>> getServiceUsageWithResponseAsync(String resourceGroupName,
        String accountName, String fileServicesName, String fileServiceUsagesName, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.getServiceUsage(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, accountName, fileServicesName, fileServiceUsagesName,
            accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<FileServiceUsageInner> getServiceUsageAsync(String resourceGroupName, String accountName,
        String fileServicesName, String fileServiceUsagesName) {
        return getServiceUsageWithResponseAsync(resourceGroupName, accountName, fileServicesName, fileServiceUsagesName)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
    ...
    public Response<FileServiceUsageInner> getServiceUsageWithResponse(String resourceGroupName, String accountName,
        String fileServicesName, String fileServiceUsagesName, Context context) {
        return getServiceUsageWithResponseAsync(resourceGroupName, accountName, fileServicesName, fileServiceUsagesName,
            context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public FileServiceUsageInner getServiceUsage(String resourceGroupName, String accountName, String fileServicesName,
        String fileServiceUsagesName) {
        return getServiceUsageWithResponse(resourceGroupName, accountName, fileServicesName, fileServiceUsagesName,
            Context.NONE).getValue();
    }
