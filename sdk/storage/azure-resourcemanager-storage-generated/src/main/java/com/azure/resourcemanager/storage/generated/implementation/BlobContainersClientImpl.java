...
public final class BlobContainersClientImpl implements BlobContainersClient {
    ...
    public interface BlobContainersService {
        ...
        Mono<Response<LegalHoldInner>> clearLegalHold(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("accountName") String accountName,
            @PathParam("containerName") String containerName, @BodyParam("application/json") LegalHoldInner legalHold,
        ...
        @Headers({ "Content-Type: application/json" })
        @Post("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Storage/storageAccounts/{accountName}/blobServices/default/containers/{containerName}/immutabilityPolicies/{ImmutabilityPolicyName}/extend")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        ...
        @Headers({ "Content-Type: application/json" })
        @Post("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Storage/storageAccounts/{accountName}/blobServices/default/containers/{containerName}/immutabilityPolicies/{ImmutabilityPolicyName}/lock")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
    ...
    private Mono<PagedResponse<ListContainerItemInner>> listSinglePageAsync(String resourceGroupName,
        String accountName, Integer maxpagesize, String filter, ListContainersInclude include) {
        ...
        return FluxUtil
            .withContext(context -> service.list(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, accountName, maxpagesize, filter, include, accept,
                context))
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<ListContainerItemInner>> listSinglePageAsync(String resourceGroupName,
        String accountName, Integer maxpagesize, String filter, ListContainersInclude include, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service
            .list(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
                resourceGroupName, accountName, maxpagesize, filter, include, accept, context)
    ...
    private PagedFlux<ListContainerItemInner> listAsync(String resourceGroupName, String accountName,
        Integer maxpagesize, String filter, ListContainersInclude include) {
    ...
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<ListContainerItemInner> listAsync(String resourceGroupName, String accountName,
        Integer maxpagesize, String filter, ListContainersInclude include, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<ListContainerItemInner> list(String resourceGroupName, String accountName, Integer maxpagesize,
    ...
    private Mono<Response<BlobContainerInner>> getWithResponseAsync(String resourceGroupName, String accountName,
        ...
        return FluxUtil
            .withContext(context -> service.get(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, accountName, containerName, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<BlobContainerInner>> getWithResponseAsync(String resourceGroupName, String accountName,
        ...
        return service.get(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, accountName, containerName, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<BlobContainerInner> getAsync(String resourceGroupName, String accountName, String containerName) {
    ...
    private Mono<Response<BlobContainerInner>> createWithResponseAsync(String resourceGroupName, String accountName,
        ...
        return FluxUtil
            .withContext(context -> service.create(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, accountName, containerName, blobContainer, accept,
                context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<BlobContainerInner>> createWithResponseAsync(String resourceGroupName, String accountName,
        ...
        return service.create(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, accountName, containerName, blobContainer, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<BlobContainerInner> createAsync(String resourceGroupName, String accountName, String containerName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<BlobContainerInner> updateAsync(String resourceGroupName, String accountName, String containerName,
        BlobContainerInner blobContainer) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> deleteAsync(String resourceGroupName, String accountName, String containerName) {
    ...
    private Mono<Response<LegalHoldInner>> clearLegalHoldWithResponseAsync(String resourceGroupName, String accountName,
        ...
        return FluxUtil
            .withContext(context -> service.clearLegalHold(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, accountName, containerName, legalHold, accept,
                context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<LegalHoldInner>> clearLegalHoldWithResponseAsync(String resourceGroupName, String accountName,
        ...
        return service.clearLegalHold(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, accountName, containerName, legalHold, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<LegalHoldInner> clearLegalHoldAsync(String resourceGroupName, String accountName, String containerName,
    ...
    private Mono<BlobContainersGetImmutabilityPolicyResponse> getImmutabilityPolicyWithResponseAsync(
        String resourceGroupName, String accountName, String containerName, String immutabilityPolicyName,
        String ifMatch) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        return FluxUtil
            .withContext(context -> service.getImmutabilityPolicy(this.client.getEndpoint(),
                ...
                containerName, immutabilityPolicyName, ifMatch, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<BlobContainersGetImmutabilityPolicyResponse> getImmutabilityPolicyWithResponseAsync(
        ...
        return service.getImmutabilityPolicy(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, accountName, containerName, immutabilityPolicyName,
    ...
    private Mono<ImmutabilityPolicyInner> getImmutabilityPolicyAsync(String resourceGroupName, String accountName,
        String containerName, String immutabilityPolicyName) {
        final String ifMatch = null;
        return getImmutabilityPolicyWithResponseAsync(resourceGroupName, accountName, containerName,
    ...
    public BlobContainersGetImmutabilityPolicyResponse getImmutabilityPolicyWithResponse(String resourceGroupName,
        String accountName, String containerName, String immutabilityPolicyName, String ifMatch, Context context) {
        return getImmutabilityPolicyWithResponseAsync(resourceGroupName, accountName, containerName,
    ...
    public ImmutabilityPolicyInner getImmutabilityPolicy(String resourceGroupName, String accountName,
        String containerName, String immutabilityPolicyName) {
        final String ifMatch = null;
        return getImmutabilityPolicyWithResponse(resourceGroupName, accountName, containerName, immutabilityPolicyName,
    ...
    private Mono<BlobContainersCreateOrUpdateImmutabilityPolicyResponse>
        createOrUpdateImmutabilityPolicyWithResponseAsync(String resourceGroupName, String accountName,
            String containerName, String immutabilityPolicyName, ImmutabilityPolicyInner parameters, String ifMatch) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return FluxUtil
            .withContext(context -> service.createOrUpdateImmutabilityPolicy(this.client.getEndpoint(),
                this.client.getApiVersion(), this.client.getSubscriptionId(), resourceGroupName, accountName,
                containerName, immutabilityPolicyName, ifMatch, parameters, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<ImmutabilityPolicyInner> createOrUpdateImmutabilityPolicyAsync(String resourceGroupName,
        String accountName, String containerName, String immutabilityPolicyName, ImmutabilityPolicyInner parameters) {
        final String ifMatch = null;
        return createOrUpdateImmutabilityPolicyWithResponseAsync(resourceGroupName, accountName, containerName,
            immutabilityPolicyName, parameters, ifMatch).flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
    ...
    public BlobContainersCreateOrUpdateImmutabilityPolicyResponse createOrUpdateImmutabilityPolicyWithResponse(
        ...
        return createOrUpdateImmutabilityPolicyWithResponseAsync(resourceGroupName, accountName, containerName,
            immutabilityPolicyName, parameters, ifMatch, context).block();
    }
    ...
    public ImmutabilityPolicyInner createOrUpdateImmutabilityPolicy(String resourceGroupName, String accountName,
        String containerName, String immutabilityPolicyName, ImmutabilityPolicyInner parameters) {
        final String ifMatch = null;
        return createOrUpdateImmutabilityPolicyWithResponse(resourceGroupName, accountName, containerName,
            immutabilityPolicyName, parameters, ifMatch, Context.NONE).getValue();
    }
    ...
    private Mono<ImmutabilityPolicyInner> deleteImmutabilityPolicyAsync(String resourceGroupName, String accountName,
        String containerName, String immutabilityPolicyName, String ifMatch) {
        return deleteImmutabilityPolicyWithResponseAsync(resourceGroupName, accountName, containerName,
            immutabilityPolicyName, ifMatch).flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
    ...
    public ImmutabilityPolicyInner deleteImmutabilityPolicy(String resourceGroupName, String accountName,
        String containerName, String immutabilityPolicyName, String ifMatch) {
        return deleteImmutabilityPolicyWithResponse(resourceGroupName, accountName, containerName,
    ...
    private Mono<BlobContainersExtendImmutabilityPolicyResponse> extendImmutabilityPolicyWithResponseAsync(
        String resourceGroupName, String accountName, String containerName, String immutabilityPolicyName,
        String ifMatch, ImmutabilityPolicyInner parameters) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    private Mono<ImmutabilityPolicyInner> extendImmutabilityPolicyAsync(String resourceGroupName, String accountName,
        ...
        return extendImmutabilityPolicyWithResponseAsync(resourceGroupName, accountName, containerName,
            immutabilityPolicyName, ifMatch, parameters).flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
    ...
    public BlobContainersExtendImmutabilityPolicyResponse extendImmutabilityPolicyWithResponse(String resourceGroupName,
        String accountName, String containerName, String immutabilityPolicyName, String ifMatch,
        ImmutabilityPolicyInner parameters, Context context) {
        return extendImmutabilityPolicyWithResponseAsync(resourceGroupName, accountName, containerName,
            immutabilityPolicyName, ifMatch, parameters, context).block();
    }
    ...
    public ImmutabilityPolicyInner extendImmutabilityPolicy(String resourceGroupName, String accountName,
        String containerName, String immutabilityPolicyName, String ifMatch) {
        final ImmutabilityPolicyInner parameters = null;
        return extendImmutabilityPolicyWithResponse(resourceGroupName, accountName, containerName,
    ...
    private Mono<ImmutabilityPolicyInner> lockImmutabilityPolicyAsync(String resourceGroupName, String accountName,
        String containerName, String immutabilityPolicyName, String ifMatch) {
        return lockImmutabilityPolicyWithResponseAsync(resourceGroupName, accountName, containerName,
            immutabilityPolicyName, ifMatch).flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
    ...
    public ImmutabilityPolicyInner lockImmutabilityPolicy(String resourceGroupName, String accountName,
        String containerName, String immutabilityPolicyName, String ifMatch) {
        return lockImmutabilityPolicyWithResponse(resourceGroupName, accountName, containerName, immutabilityPolicyName,
            ifMatch, Context.NONE).getValue();
    }
    ...
    private Mono<Response<LeaseContainerResponseInner>> leaseWithResponseAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(context -> service.lease(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, accountName, containerName, parameters, accept,
                context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<LeaseContainerResponseInner>> leaseWithResponseAsync(String resourceGroupName,
        ...
        return service.lease(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, accountName, containerName, parameters, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> objectLevelWormAsync(String resourceGroupName, String accountName, String containerName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<LegalHoldInner> setLegalHoldAsync(String resourceGroupName, String accountName, String containerName,
        LegalHoldInner legalHold) {
