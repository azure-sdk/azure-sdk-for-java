...
public interface QueuesClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<ListQueueInner> list(String resourceGroupName, String accountName, String maxpagesize, String filter,
        Context context);
    ...
    Response<StorageQueueInner> getWithResponse(String resourceGroupName, String accountName, String queueName,
        Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<StorageQueueInner> createWithResponse(String resourceGroupName, String accountName, String queueName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<StorageQueueInner> updateWithResponse(String resourceGroupName, String accountName, String queueName,
        StorageQueueInner queue, Context context);
