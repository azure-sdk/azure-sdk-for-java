...
public final class StorageAccountsImpl implements StorageAccounts {
    ...
    public Response<StorageAccount> getPropertiesWithResponse(
        ...
        Response<StorageAccountInner> inner =
            this.serviceClient().getPropertiesWithResponse(resourceGroupName, accountName, expand, context);
        if (inner != null) {
            return new SimpleResponse<>(
                inner.getRequest(),
                inner.getStatusCode(),
    ...
    public StorageAccount getProperties(String resourceGroupName, String accountName) {
        StorageAccountInner inner = this.serviceClient().getProperties(resourceGroupName, accountName);
        if (inner != null) {
    ...
    public StorageAccount getPropertiesById(String id) {
        ...
        return this.getPropertiesWithResponse(resourceGroupName, accountName, localExpand, Context.NONE).getValue();
    }

    public Response<StorageAccount> getPropertiesByIdWithResponse(
        String id, StorageAccountExpand expand, Context context) {
        String resourceGroupName = Utils.getValueFromIdByName(id, "resourceGroups");
        if (resourceGroupName == null) {
            throw LOGGER
                .logExceptionAsError(
        ...
        return this.getPropertiesWithResponse(resourceGroupName, accountName, expand, context);
    }
