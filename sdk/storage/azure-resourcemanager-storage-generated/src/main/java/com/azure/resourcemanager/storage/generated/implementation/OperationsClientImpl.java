...
import com.azure.resourcemanager.storage.generated.models.OperationListResult;
...
public final class OperationsClientImpl implements OperationsClient {
     ...
     * @return result of the request to list Storage operations along with {@link PagedResponse} on successful
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return result of the request to list Storage operations as paginated response with {@link PagedFlux}.
     */
