...
public final class Endpoints {
     ...
     */
    @JsonProperty(value = "ipv4Endpoints")
    private StorageAccountIpv4Endpoints ipv4Endpoints;

    /*
     * Gets the ipv6 storage endpoints.
     */
    @JsonProperty(value = "ipv6Endpoints")
    ...
    /**
     * Get the ipv4Endpoints property: Gets the ipv4 storage endpoints.
     *
     * @return the ipv4Endpoints value.
     */
    public StorageAccountIpv4Endpoints ipv4Endpoints() {
        return this.ipv4Endpoints;
    }

    /**
     * Set the ipv4Endpoints property: Gets the ipv4 storage endpoints.
     *
     * @param ipv4Endpoints the ipv4Endpoints value to set.
     * @return the Endpoints object itself.
     */
    public Endpoints withIpv4Endpoints(StorageAccountIpv4Endpoints ipv4Endpoints) {
        this.ipv4Endpoints = ipv4Endpoints;
        return this;
    }
    ...
    public void validate() {
        ...
        if (ipv4Endpoints() != null) {
            ipv4Endpoints().validate();
        }
