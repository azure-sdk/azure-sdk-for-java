...
public final class VirtualNetworkRule implements JsonSerializable<VirtualNetworkRule> {
     ...
     */
    private VirtualNetworkRuleAction action;
     ...
     */
    public VirtualNetworkRuleAction action() {
        return this.action;
    }
     ...
     * @return the VirtualNetworkRule object itself.
     */
    public VirtualNetworkRule withAction(VirtualNetworkRuleAction action) {
        this.action = action;
        return this;
    }
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("id".equals(fieldName)) {
                    ...
                    deserializedVirtualNetworkRule.action = VirtualNetworkRuleAction.fromString(reader.getString());
