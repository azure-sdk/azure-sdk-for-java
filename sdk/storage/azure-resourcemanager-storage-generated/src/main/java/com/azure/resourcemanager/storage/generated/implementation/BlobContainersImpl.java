...
public final class BlobContainersImpl implements BlobContainers {
    ...
    public PagedIterable<ListContainerItem> list(String resourceGroupName, String accountName,
        ...
        PagedIterable<ListContainerItemInner> inner
            = this.serviceClient().list(resourceGroupName, accountName, blobServicesName);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new ListContainerItemImpl(inner1, this.manager()));
    }

    public PagedIterable<ListContainerItem> list(String resourceGroupName, String accountName, String blobServicesName,
        String maxpagesize, String filter, ListContainersInclude include, Context context) {
        PagedIterable<ListContainerItemInner> inner = this.serviceClient()
            .list(resourceGroupName, accountName, blobServicesName, maxpagesize, filter, include, context);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new ListContainerItemImpl(inner1, this.manager()));
    }

    public Response<BlobContainer> getWithResponse(String resourceGroupName, String accountName,
        String blobServicesName, String containerName, Context context) {
        Response<BlobContainerInner> inner = this.serviceClient()
            .getWithResponse(resourceGroupName, accountName, blobServicesName, containerName, context);
        if (inner != null) {
    ...
    public BlobContainer get(String resourceGroupName, String accountName, String blobServicesName,
        String containerName) {
        BlobContainerInner inner
            = this.serviceClient().get(resourceGroupName, accountName, blobServicesName, containerName);
        if (inner != null) {
    ...
    public Response<Void> deleteWithResponse(String resourceGroupName, String accountName, String blobServicesName,
        ...
        return this.serviceClient()
            .deleteWithResponse(resourceGroupName, accountName, blobServicesName, containerName, context);
    }

    public void delete(String resourceGroupName, String accountName, String blobServicesName, String containerName) {
        this.serviceClient().delete(resourceGroupName, accountName, blobServicesName, containerName);
    }
    ...
    public Response<LegalHold> clearLegalHoldWithResponse(String resourceGroupName, String accountName,
        ...
        Response<LegalHoldInner> inner = this.serviceClient()
            .clearLegalHoldWithResponse(resourceGroupName, accountName, blobServicesName, containerName, legalHold,
                context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
    ...
    public LegalHold clearLegalHold(String resourceGroupName, String accountName, String blobServicesName,
        String containerName, LegalHoldInner legalHold) {
        LegalHoldInner inner = this.serviceClient()
            .clearLegalHold(resourceGroupName, accountName, blobServicesName, containerName, legalHold);
        if (inner != null) {
    ...
    public Response<ImmutabilityPolicy> getImmutabilityPolicyWithResponse(String resourceGroupName, String accountName,
        String blobServicesName, String containerName, String immutabilityPolicyName, String ifMatch, Context context) {
        BlobContainersGetImmutabilityPolicyResponse inner = this.serviceClient()
            .getImmutabilityPolicyWithResponse(resourceGroupName, accountName, blobServicesName, containerName,
                immutabilityPolicyName, ifMatch, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
    ...
    public ImmutabilityPolicy getImmutabilityPolicy(String resourceGroupName, String accountName,
        ...
        ImmutabilityPolicyInner inner = this.serviceClient()
            .getImmutabilityPolicy(resourceGroupName, accountName, blobServicesName, containerName,
    ...
    public Response<ImmutabilityPolicy> deleteImmutabilityPolicyWithResponse(String resourceGroupName,
        ...
        BlobContainersDeleteImmutabilityPolicyResponse inner = this.serviceClient()
            .deleteImmutabilityPolicyWithResponse(resourceGroupName, accountName, blobServicesName, containerName,
                immutabilityPolicyName, ifMatch, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
                new ImmutabilityPolicyImpl(inner.getValue(), this.manager()));
    ...
    public ImmutabilityPolicy deleteImmutabilityPolicy(String resourceGroupName, String accountName,
        ...
        ImmutabilityPolicyInner inner = this.serviceClient()
            .deleteImmutabilityPolicy(resourceGroupName, accountName, blobServicesName, containerName,
                immutabilityPolicyName, ifMatch);
        if (inner != null) {
            return new ImmutabilityPolicyImpl(inner, this.manager());
        } else {
            return null;
    ...
    public Response<ImmutabilityPolicy> extendImmutabilityPolicyWithResponse(String resourceGroupName,
        ...
        BlobContainersExtendImmutabilityPolicyResponse inner = this.serviceClient()
            .extendImmutabilityPolicyWithResponse(resourceGroupName, accountName, blobServicesName, containerName,
                immutabilityPolicyName, ifMatch, parameters, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
                new ImmutabilityPolicyImpl(inner.getValue(), this.manager()));
        } else {
    ...
    public ImmutabilityPolicy extendImmutabilityPolicy(String resourceGroupName, String accountName,
        String blobServicesName, String containerName, String immutabilityPolicyName, String ifMatch) {
        ImmutabilityPolicyInner inner = this.serviceClient()
            .extendImmutabilityPolicy(resourceGroupName, accountName, blobServicesName, containerName,
                immutabilityPolicyName, ifMatch);
        if (inner != null) {
            return new ImmutabilityPolicyImpl(inner, this.manager());
        } else {
    ...
    public Response<ImmutabilityPolicy> lockImmutabilityPolicyWithResponse(String resourceGroupName, String accountName,
        ...
        BlobContainersLockImmutabilityPolicyResponse inner = this.serviceClient()
            .lockImmutabilityPolicyWithResponse(resourceGroupName, accountName, blobServicesName, containerName,
                immutabilityPolicyName, ifMatch, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
                new ImmutabilityPolicyImpl(inner.getValue(), this.manager()));
    ...
    public ImmutabilityPolicy lockImmutabilityPolicy(String resourceGroupName, String accountName,
        String blobServicesName, String containerName, String immutabilityPolicyName, String ifMatch) {
        ImmutabilityPolicyInner inner = this.serviceClient()
            .lockImmutabilityPolicy(resourceGroupName, accountName, blobServicesName, containerName,
                immutabilityPolicyName, ifMatch);
        if (inner != null) {
            return new ImmutabilityPolicyImpl(inner, this.manager());
        } else {
    ...
    public Response<LeaseContainerResponse> leaseWithResponse(String resourceGroupName, String accountName,
        ...
        Response<LeaseContainerResponseInner> inner = this.serviceClient()
            .leaseWithResponse(resourceGroupName, accountName, blobServicesName, containerName, parameters, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
    ...
    public LeaseContainerResponse lease(String resourceGroupName, String accountName, String blobServicesName,
        String containerName) {
        LeaseContainerResponseInner inner
            = this.serviceClient().lease(resourceGroupName, accountName, blobServicesName, containerName);
        if (inner != null) {
    ...
    public void objectLevelWorm(String resourceGroupName, String accountName, String blobServicesName,
        String containerName) {
        this.serviceClient().objectLevelWorm(resourceGroupName, accountName, blobServicesName, containerName);
    }

    public void objectLevelWorm(String resourceGroupName, String accountName, String blobServicesName,
        String containerName, Context context) {
        this.serviceClient().objectLevelWorm(resourceGroupName, accountName, blobServicesName, containerName, context);
    }

    public Response<LegalHold> setLegalHoldWithResponse(String resourceGroupName, String accountName,
        String blobServicesName, String containerName, LegalHoldInner legalHold, Context context) {
        Response<LegalHoldInner> inner = this.serviceClient()
            .setLegalHoldWithResponse(resourceGroupName, accountName, blobServicesName, containerName, legalHold,
                context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
                new LegalHoldImpl(inner.getValue(), this.manager()));
    ...
    public LegalHold setLegalHold(String resourceGroupName, String accountName, String blobServicesName,
        String containerName, LegalHoldInner legalHold) {
        LegalHoldInner inner = this.serviceClient()
            .setLegalHold(resourceGroupName, accountName, blobServicesName, containerName, legalHold);
        if (inner != null) {
            return new LegalHoldImpl(inner, this.manager());
        } else {
            return null;
    ...
    public BlobContainer getById(String id) {
        ...
        String blobServicesName = ResourceManagerUtils.getValueFromIdByName(id, "blobServices");
        if (blobServicesName == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
                String.format("The resource ID '%s' is not valid. Missing path segment 'blobServices'.", id)));
        }
        ...
        return this.getWithResponse(resourceGroupName, accountName, blobServicesName, containerName, Context.NONE)
            .getValue();
    }
    ...
    public Response<BlobContainer> getByIdWithResponse(String id, Context context) {
        ...
        return this.getWithResponse(resourceGroupName, accountName, blobServicesName, containerName, context);
    }
    ...
    public ImmutabilityPolicy getImmutabilityPolicyById(String id) {
        ...
        String immutabilityPolicyName = ResourceManagerUtils.getValueFromIdByName(id, "immutabilityPolicies");
        if (immutabilityPolicyName == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
                String.format("The resource ID '%s' is not valid. Missing path segment 'immutabilityPolicies'.", id)));
        }
        String localIfMatch = null;
        return this
            .getImmutabilityPolicyWithResponse(resourceGroupName, accountName, blobServicesName, containerName,
                immutabilityPolicyName, localIfMatch, Context.NONE)
            .getValue();
    }
    ...
    public Response<ImmutabilityPolicy> getImmutabilityPolicyByIdWithResponse(String id, String ifMatch,
        ...
        return this.getImmutabilityPolicyWithResponse(resourceGroupName, accountName, blobServicesName, containerName,
            immutabilityPolicyName, ifMatch, context);
    }
    ...
    public void deleteById(String id) {
        ...
        this.deleteWithResponse(resourceGroupName, accountName, blobServicesName, containerName, Context.NONE);
    }
    ...
    public Response<Void> deleteByIdWithResponse(String id, Context context) {
        ...
        return this.deleteWithResponse(resourceGroupName, accountName, blobServicesName, containerName, context);
    }
    ...
    public Response<ImmutabilityPolicy> deleteImmutabilityPolicyByIdWithResponse(String id, String ifMatch,
        ...
        return this.deleteImmutabilityPolicyWithResponse(resourceGroupName, accountName, blobServicesName,
            containerName, immutabilityPolicyName, ifMatch, context);
    }
