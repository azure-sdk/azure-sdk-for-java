...
public final class BlobContainersImpl implements BlobContainers {
    ...
    public PagedIterable<ListContainerItem> list(String resourceGroupName, String accountName, Integer maxpagesize,
    ...
    public Response<ImmutabilityPolicy> getImmutabilityPolicyWithResponse(String resourceGroupName, String accountName,
        String containerName, String immutabilityPolicyName, String ifMatch, Context context) {
        BlobContainersGetImmutabilityPolicyResponse inner = this.serviceClient()
            .getImmutabilityPolicyWithResponse(resourceGroupName, accountName, containerName, immutabilityPolicyName,
                ifMatch, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
    ...
    public ImmutabilityPolicy getImmutabilityPolicy(String resourceGroupName, String accountName, String containerName,
        String immutabilityPolicyName) {
        ImmutabilityPolicyInner inner = this.serviceClient()
            .getImmutabilityPolicy(resourceGroupName, accountName, containerName, immutabilityPolicyName);
        if (inner != null) {
    ...
    public Response<ImmutabilityPolicy> deleteImmutabilityPolicyWithResponse(String resourceGroupName,
        ...
        BlobContainersDeleteImmutabilityPolicyResponse inner = this.serviceClient()
            .deleteImmutabilityPolicyWithResponse(resourceGroupName, accountName, containerName, immutabilityPolicyName,
                ifMatch, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
                new ImmutabilityPolicyImpl(inner.getValue(), this.manager()));
    ...
    public ImmutabilityPolicy deleteImmutabilityPolicy(String resourceGroupName, String accountName,
        ...
        ImmutabilityPolicyInner inner = this.serviceClient()
            .deleteImmutabilityPolicy(resourceGroupName, accountName, containerName, immutabilityPolicyName, ifMatch);
        if (inner != null) {
            return new ImmutabilityPolicyImpl(inner, this.manager());
        } else {
            return null;
    ...
    public Response<ImmutabilityPolicy> extendImmutabilityPolicyWithResponse(String resourceGroupName,
        ...
        BlobContainersExtendImmutabilityPolicyResponse inner = this.serviceClient()
            .extendImmutabilityPolicyWithResponse(resourceGroupName, accountName, containerName, immutabilityPolicyName,
    ...
    public ImmutabilityPolicy extendImmutabilityPolicy(String resourceGroupName, String accountName,
        String containerName, String immutabilityPolicyName, String ifMatch) {
        ImmutabilityPolicyInner inner = this.serviceClient()
            .extendImmutabilityPolicy(resourceGroupName, accountName, containerName, immutabilityPolicyName, ifMatch);
        if (inner != null) {
            return new ImmutabilityPolicyImpl(inner, this.manager());
        } else {
            return null;
    ...
    public Response<ImmutabilityPolicy> lockImmutabilityPolicyWithResponse(String resourceGroupName, String accountName,
        ...
        BlobContainersLockImmutabilityPolicyResponse inner = this.serviceClient()
            .lockImmutabilityPolicyWithResponse(resourceGroupName, accountName, containerName, immutabilityPolicyName,
                ifMatch, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
                new ImmutabilityPolicyImpl(inner.getValue(), this.manager()));
    ...
    public ImmutabilityPolicy lockImmutabilityPolicy(String resourceGroupName, String accountName, String containerName,
        ...
        ImmutabilityPolicyInner inner = this.serviceClient()
            .lockImmutabilityPolicy(resourceGroupName, accountName, containerName, immutabilityPolicyName, ifMatch);
        if (inner != null) {
            return new ImmutabilityPolicyImpl(inner, this.manager());
        } else {
            return null;
    ...
    public Response<ImmutabilityPolicy> getImmutabilityPolicyByIdWithResponse(String id, String ifMatch,
        ...
        return this.getImmutabilityPolicyWithResponse(resourceGroupName, accountName, containerName,
    ...
    public Response<ImmutabilityPolicy> deleteImmutabilityPolicyByIdWithResponse(String id, String ifMatch,
        ...
        return this.deleteImmutabilityPolicyWithResponse(resourceGroupName, accountName, containerName,
            immutabilityPolicyName, ifMatch, context);
    }
