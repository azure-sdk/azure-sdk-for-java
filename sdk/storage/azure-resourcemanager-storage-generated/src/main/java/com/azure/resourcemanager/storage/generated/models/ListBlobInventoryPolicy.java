...
public final class ListBlobInventoryPolicy implements JsonSerializable<ListBlobInventoryPolicy> {
     ...
     * @return the ListBlobInventoryPolicy object itself.
     */
    public ListBlobInventoryPolicy withNextlink(String nextlink) {
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("value".equals(fieldName)) {
                    ...
                    deserializedListBlobInventoryPolicy.nextlink = reader.getString();
                } else {
                    reader.skipChildren();
                }
            }
