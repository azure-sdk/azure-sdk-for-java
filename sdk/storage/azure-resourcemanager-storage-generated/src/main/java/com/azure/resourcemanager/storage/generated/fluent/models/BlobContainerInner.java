 ...
 */
@Fluent
public final class BlobContainerInner extends ProxyResource {
    /*
    ...
    /**
     * Get the innerProperties property: Properties of the blob container.
     * 
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("id".equals(fieldName)) {
                    ...
                    deserializedBlobContainerInner.innerProperties = ContainerProperties.fromJson(reader);
                } else if ("etag".equals(fieldName)) {
                    deserializedBlobContainerInner.etag = reader.getString();
                } else if ("systemData".equals(fieldName)) {
                    deserializedBlobContainerInner.systemData = SystemData.fromJson(reader);
                } else {
                    reader.skipChildren();
                }
            }
