    ...
    public StorageAccount refresh() {
        ...
        this.innerObject =
            serviceManager
                .serviceClient()
                .getStorageAccounts()
                .getPropertiesWithResponse(resourceGroupName, accountName, localExpand, Context.NONE)
                .getValue();
        return this;
    }
    ...
    public StorageAccount refresh(Context context) {
        ...
        this.innerObject =
            serviceManager
                .serviceClient()
                .getStorageAccounts()
                .getPropertiesWithResponse(resourceGroupName, accountName, localExpand, context)
                .getValue();
        return this;
    }
