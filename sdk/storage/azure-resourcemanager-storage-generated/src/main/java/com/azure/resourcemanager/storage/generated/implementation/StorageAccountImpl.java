...
import com.azure.resourcemanager.storage.generated.models.DualStackEndpointPreference;
...
public final class StorageAccountImpl implements StorageAccount, StorageAccount.Definition, StorageAccount.Update {
    ...
    public StorageAccountImpl withDualStackEndpointPreference(DualStackEndpointPreference dualStackEndpointPreference) {
        if (isInCreateMode()) {
            ...
            this.updateParameters.withDualStackEndpointPreference(dualStackEndpointPreference);
            return this;
        }
    }
