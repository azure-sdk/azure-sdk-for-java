...
public final class StorageAccountImpl implements StorageAccount, StorageAccount.Definition, StorageAccount.Update {
    ...
    public void abortHierarchicalNamespaceMigration() {
        serviceManager.storageAccounts().abortHierarchicalNamespaceMigration(resourceGroupName, accountName);
    }

    public void abortHierarchicalNamespaceMigration(Context context) {
        serviceManager.storageAccounts().abortHierarchicalNamespaceMigration(resourceGroupName, accountName, context);
    }
    ...
    public void failover(Constant85 failoverType, Context context) {
    ...
    public Response<ListAccountSasResponse> listAccountSasWithResponse(AccountSasParameters parameters,
        Context context) {
        return serviceManager.storageAccounts()
    ...
    public Response<StorageAccountListKeysResult> listKeysWithResponse(Constant86 expand, Context context) {
    ...
    public void customerInitiatedMigration(StorageAccountMigrationInner parameters, Context context) {
        serviceManager.storageAccounts()
    ...
    public StorageAccountImpl withDefaultToOAuthAuthentication(Boolean defaultToOAuthAuthentication) {
        if (isInCreateMode()) {
            ...
            this.updateParameters.withDefaultToOAuthAuthentication(defaultToOAuthAuthentication);
            return this;
        }
    }
