...
public final class QueueDeleteSamples {
    /*
     * x-ms-original-file: specification/storage/resource-manager/Microsoft.Storage/stable/2023-05-01/examples/QueueOperationDelete.json
     */
    /**
...
public final class StorageTaskAssignmentsListSamples {
    ...
    public static void
        ...
        manager.storageTaskAssignments().list("res4228", "sto4445", null, null, com.azure.core.util.Context.NONE);
    }
}
```
...
```java
import com.azure.resourcemanager.storage.generated.models.ExecutionTargetUpdate;
        ...
        resource.update()
            .withProperties(new StorageTaskAssignmentUpdateProperties().withEnabled(true)
                ...
                .withExecutionContext(new StorageTaskAssignmentUpdateExecutionContext()
                    .withTarget(new ExecutionTargetUpdate().withPrefix(Arrays.asList("prefix1", "prefix2"))
                        .withExcludePrefix(Arrays.asList()))
