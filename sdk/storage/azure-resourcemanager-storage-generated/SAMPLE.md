...
public final class BlobContainersDeleteImmutabilityPolicySamples {
    ...
    public static void deleteImmutabilityPolicy(com.azure.resourcemanager.storage.generated.StorageManager manager) {
        manager.blobContainers()
            .deleteImmutabilityPolicyWithResponse("res1581", "sto9621", "container4910", "default", "8d59f81a7fa7be0",
...
public final class BlobContainersExtendImmutabilityPolicySamples {
    ...
    public static void extendImmutabilityPolicy(com.azure.resourcemanager.storage.generated.StorageManager manager) {
        manager.blobContainers()
            .extendImmutabilityPolicyWithResponse("res6238", "sto232", "container5023", null, "8d59f830d0c3bf9",
...
public final class BlobContainersGetImmutabilityPolicySamples {
    ...
    public static void getImmutabilityPolicy(com.azure.resourcemanager.storage.generated.StorageManager manager) {
        manager.blobContainers()
            .getImmutabilityPolicyWithResponse("res5221", "sto9177", "container3489", "default", null,
                com.azure.core.util.Context.NONE);
    }
}
```
...
public final class BlobContainersLockImmutabilityPolicySamples {
    ...
    public static void lockImmutabilityPolicy(com.azure.resourcemanager.storage.generated.StorageManager manager) {
        manager.blobContainers()
            .lockImmutabilityPolicyWithResponse("res2702", "sto5009", "container1631", null, "8d59f825b721dd3",
                com.azure.core.util.Context.NONE);
    }
}
```
...
public final class BlobInventoryPoliciesListSamples {
    ...
    public static void
        storageAccountGetBlobInventoryPolicy(com.azure.resourcemanager.storage.generated.StorageManager manager) {
        manager.blobInventoryPolicies().listWithResponse("res7687", "sto9699", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class BlobServicesListSamples {
    ...
    public static void listBlobServices(com.azure.resourcemanager.storage.generated.StorageManager manager) {
        manager.blobServices().listWithResponse("res4410", "sto8607", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class FileServicesGetServiceUsageSamples {
    ...
    public static void getFileServiceUsage(com.azure.resourcemanager.storage.generated.StorageManager manager) {
        manager.fileServices()
            .getServiceUsageWithResponse("res4410", "sto8607", "default", "default", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class FileServicesListServiceUsagesSamples {
    ...
    public static void listFileServiceUsages(com.azure.resourcemanager.storage.generated.StorageManager manager) {
        manager.fileServices()
            .listServiceUsages("res4410", "sto8607", "default", null, com.azure.core.util.Context.NONE);
    }
}
```
...
public final class FileSharesCreateSamples {
    ...
    public static void putSharesProvisionedV2(com.azure.resourcemanager.storage.generated.StorageManager manager) {
        manager.fileShares()
            .define("share1235")
            .withExistingFileService("res346", "sto666", null)
            .withShareQuota(100)
    ...
    public static void putShares(com.azure.resourcemanager.storage.generated.StorageManager manager) {
        manager.fileShares().define("share6185").withExistingFileService("res3376", "sto328", null).create();
    }
}
```
...
public final class FileSharesDeleteSamples {
    ...
    public static void deleteShares(com.azure.resourcemanager.storage.generated.StorageManager manager) {
        manager.fileShares()
            .deleteWithResponse("res4079", "sto4506", null, "share9689", null, null, com.azure.core.util.Context.NONE);
    }
}
```
...
public final class FileSharesGetSamples {
    ...
    public static void getShareStats(com.azure.resourcemanager.storage.generated.StorageManager manager) {
        manager.fileShares()
            .getWithResponse("res9871", "sto6217", null, "share1634", "stats", null, com.azure.core.util.Context.NONE);
    }
    ...
    public static void getSharePaidBursting(com.azure.resourcemanager.storage.generated.StorageManager manager) {
        manager.fileShares()
            .getWithResponse("res9871", "sto6217", null, "share1634", null, null, com.azure.core.util.Context.NONE);
    }
...
public final class FileSharesLeaseSamples {
    ...
    public static void breakALeaseOnAShare(com.azure.resourcemanager.storage.generated.StorageManager manager) {
        manager.fileShares()
            .leaseWithResponse("res3376", "sto328", null, "share12", null,
    ...
    public static void acquireALeaseOnAShare(com.azure.resourcemanager.storage.generated.StorageManager manager) {
        manager.fileShares()
            .leaseWithResponse("res3376", "sto328", null, "share124", null,
...
public final class FileSharesListSamples {
    ...
    public static void listShares(com.azure.resourcemanager.storage.generated.StorageManager manager) {
        manager.fileShares().list("res9290", "sto1590", null, null, null, null, com.azure.core.util.Context.NONE);
    }
    ...
    public static void listDeletedShares(com.azure.resourcemanager.storage.generated.StorageManager manager) {
        manager.fileShares().list("res9290", "sto1590", null, null, null, "deleted", com.azure.core.util.Context.NONE);
    }
    ...
    public static void listShareSnapshots(com.azure.resourcemanager.storage.generated.StorageManager manager) {
        manager.fileShares()
            .list("res9290", "sto1590", null, null, null, "snapshots", com.azure.core.util.Context.NONE);
    }
...
public final class FileSharesRestoreSamples {
    ...
    public static void restoreShares(com.azure.resourcemanager.storage.generated.StorageManager manager) {
        manager.fileShares()
            .restoreWithResponse("res3376", "sto328", null, "share1249",
...
public final class FileSharesUpdateSamples {
    ...
    public static void updateShares(com.azure.resourcemanager.storage.generated.StorageManager manager) {
        FileShare resource = manager.fileShares()
            .getWithResponse("res3376", "sto328", null, "share6185", null, null, com.azure.core.util.Context.NONE)
            .getValue();
