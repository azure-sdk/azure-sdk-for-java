...
import com.azure.resourcemanager.storage.generated.models.BlobInventoryPolicyFilterTime;
                                        ...
                                        new BlobInventoryPolicyDefinition()
                                            .withFilters(
                                                new BlobInventoryPolicyFilter()
                                                    ...
                                                    .withCreationTime(
                                                        new BlobInventoryPolicyFilterTime().withLastNDays(3))
                                                    .withLastModified(
                                                        new BlobInventoryPolicyFilterTime().withLastNDays(5)))
...
public final class StorageAccountsDeleteSamples {
    ...
    public static void storageAccountDelete(com.azure.resourcemanager.storage.generated.StorageManager manager) {
        manager.storageAccounts().deleteByResourceGroupWithResponse("res4228", "sto2434", Context.NONE);
    }
}
```
