...
- [GetProperties](#storageaccounts_getproperties)
    ...
    public static void storageAccountUpdateObjectReplicationPolicyOnDestination(
        ...
        ObjectReplicationPolicy resource =
            manager
                .objectReplicationPoliciesOperations()
                .getWithResponse(
                    "res7687", "dst112", "2a20bb73-5717-4635-985a-5d4cf777438f", com.azure.core.util.Context.NONE)
                .getValue();
        resource
            .update()
            .withSourceAccount("src1122")
    ...
    public static void storageAccountUpdateObjectReplicationPolicyOnSource(
        ...
        ObjectReplicationPolicy resource =
            manager
                .objectReplicationPoliciesOperations()
                .getWithResponse(
                    "res7687", "src1122", "2a20bb73-5717-4635-985a-5d4cf777438f", com.azure.core.util.Context.NONE)
                .getValue();
        resource
            .update()
            .withSourceAccount("src1122")
...
public final class StorageAccountsDeleteSamples {
     ...
     */
    public static void storageAccountDelete(com.azure.resourcemanager.storage.generated.StorageManager manager) {
        manager.storageAccounts().deleteWithResponse("res4228", "sto2434", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class StorageAccountsFailoverSamples {
     ...
     * @param manager Entry point to StorageManager.
     */
    public static void storageAccountFailoverPlanned(
        com.azure.resourcemanager.storage.generated.StorageManager manager) {
        manager
            .storageAccounts()
...
public final class StorageAccountsGetCustomerInitiatedMigrationSamples {
     ...
     * @param manager Entry point to StorageManager.
     */
    public static void storageAccountGetMigrationInProgress(
        com.azure.resourcemanager.storage.generated.StorageManager manager) {
        manager
            .storageAccounts()
     ...
     * @param manager Entry point to StorageManager.
     */
    public static void storageAccountGetMigrationFailed(
        com.azure.resourcemanager.storage.generated.StorageManager manager) {
        manager
            .storageAccounts()
            .getCustomerInitiatedMigrationWithResponse(
...
/** Samples for StorageAccounts GetProperties. */
public final class StorageAccountsGetPropertiesSamples {
    /*
    ...
    public static void storageAccountGetProperties(com.azure.resourcemanager.storage.generated.StorageManager manager) {
        manager
            .storageAccounts()
            .getPropertiesWithResponse("res9407", "sto8596", null, com.azure.core.util.Context.NONE);
    }
...
public final class StorageAccountsUpdateSamples {
    ...
    public static void storageAccountUpdateUserAssignedIdentityWithFederatedIdentityClientId(
        ...
        StorageAccount resource =
            manager
                .storageAccounts()
                .getPropertiesWithResponse("res131918", "sto131918", null, com.azure.core.util.Context.NONE)
                .getValue();
        resource
            .update()
            .withSku(new Sku().withName(SkuName.STANDARD_LRS))
    ...
    public static void storageAccountUpdateUserAssignedEncryptionIdentityWithCMK(
        ...
        StorageAccount resource =
            manager
                .storageAccounts()
                .getPropertiesWithResponse("res9101", "sto4445", null, com.azure.core.util.Context.NONE)
                .getValue();
        resource
            .update()
            .withSku(new Sku().withName(SkuName.STANDARD_LRS))
