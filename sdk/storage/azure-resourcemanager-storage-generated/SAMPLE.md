...
- [GetServiceUsage](#fileservices_getserviceusage)
- [List](#fileservices_list)
- [ListServiceUsages](#fileservices_listserviceusages)
...
- [List](#storagetaskassignmentinstancesreport_list)

## StorageTaskAssignments

- [Create](#storagetaskassignments_create)
- [Delete](#storagetaskassignments_delete)
- [Get](#storagetaskassignments_get)
- [List](#storagetaskassignments_list)
- [Update](#storagetaskassignments_update)

## StorageTaskAssignmentsInstancesReport

- [List](#storagetaskassignmentsinstancesreport_list)
...
public final class BlobContainersClearLegalHoldSamples {
    ...
    public static void clearLegalHoldContainers(com.azure.resourcemanager.storage.generated.StorageManager manager) {
        manager.blobContainers()
            .clearLegalHoldWithResponse("res4303", "sto7280", null, "container8723",
...
public final class BlobContainersCreateSamples {
    ...
    public static void
        ...
        manager.blobContainers()
            ...
            .withExistingBlobService("res3376", "sto328", null)
    ...
    public static void putContainers(com.azure.resourcemanager.storage.generated.StorageManager manager) {
        manager.blobContainers().define("container6185").withExistingBlobService("res3376", "sto328", null).create();
    }
}
```
...
public final class BlobContainersCreateOrUpdateImmutabilityPolicySamples {
    ...
    public static void
        ...
        manager.blobContainers()
            .defineImmutabilityPolicy("default")
            .withExistingContainer("res1782", "sto7069", null, "container6397")
...
public final class BlobContainersDeleteSamples {
    ...
    public static void deleteContainers(com.azure.resourcemanager.storage.generated.StorageManager manager) {
        manager.blobContainers()
            .deleteWithResponse("res4079", "sto4506", null, "container9689", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class BlobContainersDeleteImmutabilityPolicySamples {
    ...
    public static void deleteImmutabilityPolicy(com.azure.resourcemanager.storage.generated.StorageManager manager) {
        manager.blobContainers()
            .deleteImmutabilityPolicyWithResponse("res1581", "sto9621", null, "container4910", "default",
...
public final class BlobContainersExtendImmutabilityPolicySamples {
    ...
    public static void extendImmutabilityPolicy(com.azure.resourcemanager.storage.generated.StorageManager manager) {
        manager.blobContainers()
            .extendImmutabilityPolicyWithResponse("res6238", "sto232", null, "container5023", null, "8d59f830d0c3bf9",
...
public final class BlobContainersGetSamples {
    ...
    public static void getContainers(com.azure.resourcemanager.storage.generated.StorageManager manager) {
        manager.blobContainers()
            .getWithResponse("res9871", "sto6217", null, "container1634", com.azure.core.util.Context.NONE);
    }
...
public final class BlobContainersGetImmutabilityPolicySamples {
    ...
    public static void getImmutabilityPolicy(com.azure.resourcemanager.storage.generated.StorageManager manager) {
        manager.blobContainers()
            .getImmutabilityPolicyWithResponse("res5221", "sto9177", null, "container3489", "default", null,
                com.azure.core.util.Context.NONE);
    }
}
```
...
public final class BlobContainersLeaseSamples {
    ...
    public static void breakALeaseOnAContainer(com.azure.resourcemanager.storage.generated.StorageManager manager) {
        manager.blobContainers()
            .leaseWithResponse("res3376", "sto328", null, "container6185",
...
public final class BlobContainersListSamples {
    ...
    public static void listContainers(com.azure.resourcemanager.storage.generated.StorageManager manager) {
        manager.blobContainers().list("res9290", "sto1590", null, null, null, null, com.azure.core.util.Context.NONE);
    }
    ...
    public static void listDeletedContainers(com.azure.resourcemanager.storage.generated.StorageManager manager) {
        manager.blobContainers()
            .list("res9290", "sto1590", null, null, null, ListContainersInclude.DELETED,
                com.azure.core.util.Context.NONE);
    }
}
```
...
public final class BlobContainersLockImmutabilityPolicySamples {
    ...
    public static void lockImmutabilityPolicy(com.azure.resourcemanager.storage.generated.StorageManager manager) {
        manager.blobContainers()
            .lockImmutabilityPolicyWithResponse("res2702", "sto5009", null, "container1631", null, "8d59f825b721dd3",
                com.azure.core.util.Context.NONE);
    }
}
```
...
public final class BlobContainersObjectLevelWormSamples {
    ...
    public static void
        ...
        manager.blobContainers()
            .objectLevelWorm("res1782", "sto7069", null, "container6397", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class BlobContainersSetLegalHoldSamples {
    ...
    public static void setLegalHoldContainers(com.azure.resourcemanager.storage.generated.StorageManager manager) {
        manager.blobContainers()
            .setLegalHoldWithResponse("res4303", "sto7280", null, "container8723",
                new LegalHoldInner().withTags(Arrays.asList("tag1", "tag2", "tag3")), com.azure.core.util.Context.NONE);
    }
...
public final class BlobContainersUpdateSamples {
    ...
    public static void updateContainers(com.azure.resourcemanager.storage.generated.StorageManager manager) {
        BlobContainer resource = manager.blobContainers()
            .getWithResponse("res3376", "sto328", null, "container6185", com.azure.core.util.Context.NONE)
            .getValue();
...
public final class BlobServicesGetServicePropertiesSamples {
    ...
    public static void getBlobServices(com.azure.resourcemanager.storage.generated.StorageManager manager) {
        manager.blobServices()
            .getServicePropertiesWithResponse("res4410", "sto8607", "default", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class DeletedAccountsGetSamples {
    ...
    public static void deletedAccountGet(com.azure.resourcemanager.storage.generated.StorageManager manager) {
        manager.deletedAccounts().getWithResponse("eastus", "sto1125", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class FileServicesListServiceUsagesSamples {
     ...
     * @param manager Entry point to StorageManager.
     */
    public static void listFileServiceUsages(com.azure.resourcemanager.storage.generated.StorageManager manager) {
        manager.fileServices().listServiceUsages("res4410", "sto8607", null, com.azure.core.util.Context.NONE);
    }
}
```
...
public final class FileSharesListSamples {
     ...
     * @param manager Entry point to StorageManager.
     */
    public static void listSharesProvisionedV2(com.azure.resourcemanager.storage.generated.StorageManager manager) {
        manager.fileShares().list("res9290", "sto1590", null, null, null, com.azure.core.util.Context.NONE);
    }
     ...
     * @param manager Entry point to StorageManager.
     */
    public static void listSharesPaidBursting(com.azure.resourcemanager.storage.generated.StorageManager manager) {
        manager.fileShares().list("res9290", "sto1590", null, null, null, com.azure.core.util.Context.NONE);
    }
}
```
...
public final class FileSharesUpdateSamples {
     ...
     * @param manager Entry point to StorageManager.
     */
    public static void updateSharePaidBursting(com.azure.resourcemanager.storage.generated.StorageManager manager) {
        FileShare resource = manager.fileShares()
            .getWithResponse("res3376", "sto328", "share6185", null, null, com.azure.core.util.Context.NONE)
            .getValue();
        resource.update()
     ...
     * @param manager Entry point to StorageManager.
     */
    public static void updateShareProvisionedV2(com.azure.resourcemanager.storage.generated.StorageManager manager) {
        FileShare resource = manager.fileShares()
            .getWithResponse("res3376", "sto328", "share6185", null, null, com.azure.core.util.Context.NONE)
            .getValue();
        resource.update().withShareQuota(100).withProvisionedIops(5000).withProvisionedBandwidthMibps(200).apply();
    }
...
public final class LocalUsersOperationCreateOrUpdateSamples {
     ...
     * @param manager Entry point to StorageManager.
     */
    public static void createNFSv3EnabledLocalUser(com.azure.resourcemanager.storage.generated.StorageManager manager) {
        manager.localUsersOperations()
            .define("user1")
            .withExistingStorageAccount("res6977", "sto2527")
...
public final class ObjectReplicationPoliciesOperationListSamples {
    ...
    public static void storageAccountListObjectReplicationPolicies(
        com.azure.resourcemanager.storage.generated.StorageManager manager) {
        manager.objectReplicationPoliciesOperations()
            .listWithResponse("res6977", "sto2527", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class QueueServicesSetServicePropertiesSamples {
    ...
    public static void queueServicesPut(com.azure.resourcemanager.storage.generated.StorageManager manager) {
        manager.queueServices()
            .setServicePropertiesWithResponse("res4410", "sto8607",
                new QueueServicePropertiesInner().withCors(new CorsRules().withCorsRules(Arrays.asList(
                    new CorsRule()
                        .withAllowedOrigins(Arrays.asList("http://www.contoso.com", "http://www.fabrikam.com"))
                        .withAllowedMethods(Arrays.asList(AllowedMethods.GET, AllowedMethods.HEAD, AllowedMethods.POST,
                            AllowedMethods.OPTIONS, AllowedMethods.MERGE, AllowedMethods.PUT))
...
```java
import com.azure.resourcemanager.storage.generated.models.Constant85;
...
public final class StorageAccountsFailoverSamples {
    ...
    public static void
        ...
        manager.storageAccounts().failover("res4228", "sto2434", Constant85.PLANNED, com.azure.core.util.Context.NONE);
    }
}
```
...
public final class StorageTaskAssignmentInstancesReportListSamples {
     ...
     * @param manager Entry point to StorageManager.
     */
    public static void listStorageTaskAssignmentInstancesReportSummary(
        com.azure.resourcemanager.storage.generated.StorageManager manager) {
        manager.storageTaskAssignmentInstancesReports()
        ...
        manager.storageTaskAssignments()
            ...
            .withExecutionContext(
                new StorageTaskAssignmentExecutionContext()
                    ...
                    .withTrigger(
                        new ExecutionTrigger().withType(TriggerType.RUN_ONCE)
...
public final class StorageTaskAssignmentsListSamples {
     ...
     */
    public static void
        listStorageTaskAssignmentsForAccount(com.azure.resourcemanager.storage.generated.StorageManager manager) {
        manager.storageTaskAssignments().list("res4228", "sto4445", null, com.azure.core.util.Context.NONE);
    }
}
```
...
public final class UsagesListByLocationSamples {
    ...
    public static void usageList(com.azure.resourcemanager.storage.generated.StorageManager manager) {
        manager.usages().listByLocationWithResponse("eastus2(stage)", com.azure.core.util.Context.NONE);
    }
}
```
