...
public final class PageBlobsImpl {
    ...
    public interface PageBlobsService {
        ...
        Mono<Response<Void>> uploadPagesFromUrl(@HostParam("url") String url,
            ...
            @HeaderParam("x-ms-source-url") String sourceUrl, @HeaderParam("x-ms-source-range") String sourceRange,
    ...
    public Mono<Response<Void>> uploadPagesFromUrlWithResponseAsync(String version, String containerName, String blob,
        String sourceUrl, String sourceRange, long contentLength, String range, RequestOptions requestOptions) {
        final String contentType = "application/octet-stream";
        final String accept = "application/json";
        return FluxUtil.withContext(context -> service.uploadPagesFromUrl(this.client.getUrl(), contentType, version,
            containerName, blob, sourceUrl, sourceRange, contentLength, range, accept, requestOptions, context));
    }
