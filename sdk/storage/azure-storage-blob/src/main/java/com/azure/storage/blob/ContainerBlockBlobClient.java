...
import com.azure.storage.blob.implementation.ContainerBlockBlobsImpl;
...
public final class ContainerBlockBlobClient {
    ...
    public Response<BinaryData> queryWithResponse(BinaryData queryRequest, RequestOptions requestOptions) {
        return this.serviceClient.queryWithResponse(queryRequest, requestOptions);
    }
    ...
    public void upload(long contentLength, BinaryData body, Map<String, String> metadata, Integer timeout,
        ...
        String transactionalContentCrc64, String structuredBodyType, Long structuredContentLength,
    ...
    public BlockList getBlockList(BlockListType listType, String snapshot, Integer timeout, String leaseId,
        ...
        return getBlockListWithResponse(listType.toString(), requestOptions).getValue().toObject(BlockList.class);
    }
    ...
    public BinaryData query(QueryRequest queryRequest, String snapshot, Integer timeout, String leaseId,
        ...
        return queryWithResponse(BinaryData.fromObject(queryRequest), requestOptions).getValue();
    }
