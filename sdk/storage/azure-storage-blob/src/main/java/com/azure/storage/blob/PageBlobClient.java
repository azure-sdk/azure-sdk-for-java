...
public final class PageBlobClient {
    ...
    public Response<Void> createWithResponse(long contentLength, long blobContentLength,
        ...
        return this.serviceClient.createWithResponse(contentLength, blobContentLength, requestOptions);
    }
    ...
    public Response<Void> uploadPagesWithResponse(long contentLength, BinaryData body, RequestOptions requestOptions) {
        return this.serviceClient.uploadPagesWithResponse(contentLength, body, requestOptions);
    }
    ...
    public Response<Void> clearPagesWithResponse(long contentLength, RequestOptions requestOptions) {
        return this.serviceClient.clearPagesWithResponse(contentLength, requestOptions);
    }
    ...
    public Response<Void> uploadPagesFromUrlWithResponse(String sourceUrl, String sourceRange, long contentLength,
        ...
        return this.serviceClient.uploadPagesFromUrlWithResponse(sourceUrl, sourceRange, contentLength, range,
            requestOptions);
    }
    ...
    public Response<BinaryData> getPageRangesWithResponse(RequestOptions requestOptions) {
        return this.serviceClient.getPageRangesWithResponse(requestOptions);
    }
    ...
    public Response<BinaryData> getPageRangesDiffWithResponse(RequestOptions requestOptions) {
        return this.serviceClient.getPageRangesDiffWithResponse(requestOptions);
    }
    ...
    public Response<Void> resizeWithResponse(long blobContentLength, RequestOptions requestOptions) {
        return this.serviceClient.resizeWithResponse(blobContentLength, requestOptions);
    }
    ...
    public Response<Void> updateSequenceNumberWithResponse(String sequenceNumberAction, RequestOptions requestOptions) {
        return this.serviceClient.updateSequenceNumberWithResponse(sequenceNumberAction, requestOptions);
    }
    ...
    public Response<Void> copyIncrementalWithResponse(String copySource, RequestOptions requestOptions) {
        return this.serviceClient.copyIncrementalWithResponse(copySource, requestOptions);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public void create(long contentLength, long blobContentLength, Map<String, String> metadata, Integer timeout,
        ...
        createWithResponse(contentLength, blobContentLength, requestOptions).getValue();
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public void create(long contentLength, long blobContentLength) {
        // Generated convenience method for createWithResponse
        RequestOptions requestOptions = new RequestOptions();
        createWithResponse(contentLength, blobContentLength, requestOptions).getValue();
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public void uploadPages(long contentLength, BinaryData body, String transactionalContentMD5,
        ...
        uploadPagesWithResponse(contentLength, body, requestOptions).getValue();
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public void uploadPages(long contentLength, BinaryData body) {
        // Generated convenience method for uploadPagesWithResponse
        RequestOptions requestOptions = new RequestOptions();
        uploadPagesWithResponse(contentLength, body, requestOptions).getValue();
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public void clearPages(long contentLength, Integer timeout, String range, String leaseId, String encryptionKey,
        String encryptionKeySha256, EncryptionAlgorithmType encryptionAlgorithm, String encryptionScope,
        Long ifSequenceNumberLessThanOrEqualTo, Long ifSequenceNumberLessThan, Long ifSequenceNumberEqualTo,
        ...
        clearPagesWithResponse(contentLength, requestOptions).getValue();
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public void clearPages(long contentLength) {
        // Generated convenience method for clearPagesWithResponse
        RequestOptions requestOptions = new RequestOptions();
        clearPagesWithResponse(contentLength, requestOptions).getValue();
    }
    ...
    public void uploadPagesFromUrl(String sourceUrl, String sourceRange, long contentLength, String range,
        ...
        Long ifSequenceNumberLessThanOrEqualTo, Long ifSequenceNumberLessThan, Long ifSequenceNumberEqualTo,
        String ifTags, String sourceIfModifiedSince, String sourceIfUnmodifiedSince, String sourceIfMatch,
        ...
        uploadPagesFromUrlWithResponse(sourceUrl, sourceRange, contentLength, range, requestOptions).getValue();
    }
    ...
    public PageList getPageRanges(String snapshot, Integer timeout, String range, String leaseId, String ifTags,
        ...
        return getPageRangesWithResponse(requestOptions).getValue().toObject(PageList.class);
    }
    ...
    public PageList getPageRangesDiff(String snapshot, Integer timeout, String prevsnapshot, String prevSnapshotUrl,
        ...
        return getPageRangesDiffWithResponse(requestOptions).getValue().toObject(PageList.class);
    }
    ...
    public void resize(long blobContentLength, Integer timeout, String leaseId, String encryptionKey,
        ...
        resizeWithResponse(blobContentLength, requestOptions).getValue();
    }
    ...
    public void updateSequenceNumber(SequenceNumberActionType sequenceNumberAction, Integer timeout, String leaseId,
        ...
        updateSequenceNumberWithResponse(sequenceNumberAction.toString(), requestOptions).getValue();
    }
    ...
    public void copyIncremental(String copySource, Integer timeout, String ifTags,
        ...
        copyIncrementalWithResponse(copySource, requestOptions).getValue();
    }
