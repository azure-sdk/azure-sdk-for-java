...
public final class BlobPropertiesInternal implements JsonSerializable<BlobPropertiesInternal> {
    ...
    /**
     * Get the destinationSnapshot property: The name of the desination snapshot.
     * 
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeStringField("contentMd5", this.contentMd5);
        ...
        jsonWriter.writeStringField("copyCompletionTime",
            this.copyCompletionTime == null
                ? null
                : DateTimeFormatter.ISO_OFFSET_DATE_TIME.format(this.copyCompletionTime));
        ...
        jsonWriter.writeStringField("accessTierChangeTime",
            this.accessTierChangeTime == null
                ? null
                : DateTimeFormatter.ISO_OFFSET_DATE_TIME.format(this.accessTierChangeTime));
        ...
        jsonWriter.writeStringField("lastAccessTime",
        ...
        jsonWriter.writeStringField("immutabilityPolicyUntilDate",
            this.immutabilityPolicyExpiresOn == null
                ? null
                : DateTimeFormatter.ISO_OFFSET_DATE_TIME.format(this.immutabilityPolicyExpiresOn));
    ...
    public static BlobPropertiesInternal fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            OffsetDateTime accessTierChangeTime = null;
            ...
            OffsetDateTime immutabilityPolicyExpiresOn = null;
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("lastModified".equals(fieldName)) {
                    ...
                    lastAccessTime = reader
                        .getNullable(nonNullReader -> CoreUtils.parseBestOffsetDateTime(nonNullReader.getString()));
                } else if ("immutabilityPolicyUntilDate".equals(fieldName)) {
                    immutabilityPolicyExpiresOn = reader
                        .getNullable(nonNullReader -> CoreUtils.parseBestOffsetDateTime(nonNullReader.getString()));
