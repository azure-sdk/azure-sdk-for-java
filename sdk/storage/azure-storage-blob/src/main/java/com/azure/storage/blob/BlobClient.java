...
public final class BlobClient {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public void setExpiry(BlobExpiryOptions expiryOptions, Integer timeout, String expiresOn) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public void setImmutabilityPolicy(Integer timeout, String ifUnmodifiedSince, String immutabilityPolicyExpiry,
    ...
    public void startCopyFromUrl(String copySource, Integer timeout, Map<String, String> metadata, AccessTier tier,
        RehydratePriority rehydratePriority, String sourceIfModifiedSince, String sourceIfUnmodifiedSince,
        String sourceIfMatch, String sourceIfNoneMatch, String sourceIfTags, String ifTags, String leaseId,
        String blobTagsString, Boolean sealBlob, String immutabilityPolicyExpiry,
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public byte[] query(QueryRequest queryRequest, String snapshot, Integer timeout, String leaseId,
        ...
        return queryWithResponse(BinaryData.fromObject(queryRequest), requestOptions).getValue().toObject(byte[].class);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public byte[] query(QueryRequest queryRequest) {
        // Generated convenience method for queryWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return queryWithResponse(BinaryData.fromObject(queryRequest), requestOptions).getValue().toObject(byte[].class);
    }
