...
public final class ContainerBlobsImpl {
     ...
     */
    ContainerBlobsImpl(ServiceClientClientImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for ServiceClientClientContainerBlobs to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{url}")
