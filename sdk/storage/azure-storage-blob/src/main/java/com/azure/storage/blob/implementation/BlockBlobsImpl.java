...
public final class BlockBlobsImpl {
    ...
    public interface BlockBlobsService {
        ...
        Mono<Response<Void>> upload(@HostParam("url") String url, @HeaderParam("Content-Type") String contentType,
            ...
            @BodyParam("application/xml") BinaryData body, RequestOptions requestOptions, Context context);
        ...
        @Put("/?comp=block&fromURL/{containerName}/{blob}")
        @ExpectedResponses({ 201 })
        @UnexpectedResponseExceptionType(value = ClientAuthenticationException.class, code = { 401 })
        @UnexpectedResponseExceptionType(value = ResourceNotFoundException.class, code = { 404 })
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        ...
        @Put("/?comp=blocklist/{containerName}/{blob}")
        @ExpectedResponses({ 201 })
        @UnexpectedResponseExceptionType(value = ClientAuthenticationException.class, code = { 401 })
        @UnexpectedResponseExceptionType(value = ResourceNotFoundException.class, code = { 404 })
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        ...
        @Get("/?comp=blocklist/{containerName}/{blob}")
    ...
    public Mono<Response<Void>> uploadWithResponseAsync(String version, String containerName, String blob,
        BinaryData body, RequestOptions requestOptions) {
        final String contentType = "application/xml";
        final String accept = "application/json";
        return FluxUtil.withContext(context -> service.upload(this.client.getUrl(), contentType, version, containerName,
            blob, accept, body, requestOptions, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<Void> uploadWithResponse(String version, String containerName, String blob, BinaryData body,
        RequestOptions requestOptions) {
        final String contentType = "application/xml";
        final String accept = "application/json";
        return service.uploadSync(this.client.getUrl(), contentType, version, containerName, blob, accept, body,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<Void>> putBlobFromUrlWithResponseAsync(String version, String containerName, String blob,
        long contentLength, String copySource, RequestOptions requestOptions) {
        final String contentType = "application/xml";
        final String accept = "application/json";
        return FluxUtil.withContext(context -> service.putBlobFromUrl(this.client.getUrl(), contentType, version,
            containerName, blob, contentLength, copySource, accept, requestOptions, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<Void> putBlobFromUrlWithResponse(String version, String containerName, String blob,
        long contentLength, String copySource, RequestOptions requestOptions) {
        final String contentType = "application/xml";
        final String accept = "application/json";
        return service.putBlobFromUrlSync(this.client.getUrl(), contentType, version, containerName, blob,
            contentLength, copySource, accept, requestOptions, Context.NONE);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<Void>> stageBlockWithResponseAsync(String version, String containerName, String blob,
        String blockId, long contentLength, BinaryData body, RequestOptions requestOptions) {
        final String contentType = "application/xml";
        final String accept = "application/json";
        return FluxUtil.withContext(context -> service.stageBlock(this.client.getUrl(), contentType, version,
            containerName, blob, blockId, contentLength, accept, body, requestOptions, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<Void> stageBlockWithResponse(String version, String containerName, String blob, String blockId,
        long contentLength, BinaryData body, RequestOptions requestOptions) {
        final String contentType = "application/xml";
        final String accept = "application/json";
        return service.stageBlockSync(this.client.getUrl(), contentType, version, containerName, blob, blockId,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<Void>> stageBlockFromUrlWithResponseAsync(String version, String containerName, String blob,
        String blockId, long contentLength, String sourceUrl, String sourceRange, RequestOptions requestOptions) {
        final String contentType = "application/xml";
        final String accept = "application/json";
        return FluxUtil.withContext(context -> service.stageBlockFromUrl(this.client.getUrl(), contentType, version,
            containerName, blob, blockId, contentLength, sourceUrl, sourceRange, accept, requestOptions, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<Void> stageBlockFromUrlWithResponse(String version, String containerName, String blob,
        String blockId, long contentLength, String sourceUrl, String sourceRange, RequestOptions requestOptions) {
        final String contentType = "application/xml";
        final String accept = "application/json";
        return service.stageBlockFromUrlSync(this.client.getUrl(), contentType, version, containerName, blob, blockId,
            contentLength, sourceUrl, sourceRange, accept, requestOptions, Context.NONE);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<Void>> commitBlockListWithResponseAsync(String version, String containerName, String blob,
        BinaryData blocks, RequestOptions requestOptions) {
        final String contentType = "application/xml";
        final String accept = "application/json";
        return FluxUtil.withContext(context -> service.commitBlockList(this.client.getUrl(), contentType, version,
            containerName, blob, accept, blocks, requestOptions, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<Void> commitBlockListWithResponse(String version, String containerName, String blob,
        BinaryData blocks, RequestOptions requestOptions) {
        final String contentType = "application/xml";
        final String accept = "application/json";
        return service.commitBlockListSync(this.client.getUrl(), contentType, version, containerName, blob, accept,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> getBlockListWithResponseAsync(String version, String containerName, String blob,
        String listType, RequestOptions requestOptions) {
        final String contentType = "application/xml";
        final String accept = "application/xml";
        return FluxUtil.withContext(context -> service.getBlockList(this.client.getUrl(), contentType, version,
            containerName, blob, listType, accept, requestOptions, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<BinaryData> getBlockListWithResponse(String version, String containerName, String blob,
        String listType, RequestOptions requestOptions) {
        final String contentType = "application/xml";
        final String accept = "application/xml";
        return service.getBlockListSync(this.client.getUrl(), contentType, version, containerName, blob, listType,
