...
public final class BlockBlobsImpl {
    ...
    public Response<Void> uploadWithResponse(long contentLength, BinaryData body, RequestOptions requestOptions) {
        final String contentType = "application/octet-stream";
        final String accept = "application/json";
        return service.uploadSync(this.client.getUrl(), contentType, this.client.getVersion(),
    ...
    public Mono<Response<Void>> putBlobFromUrlWithResponseAsync(long contentLength, String copySource,
        ...
        return FluxUtil.withContext(context -> service.putBlobFromUrl(this.client.getUrl(), contentType,
            this.client.getVersion(), this.client.getContainerName(), this.client.getBlob(), contentLength, copySource,
    ...
    public Response<Void> putBlobFromUrlWithResponse(long contentLength, String copySource,
        ...
        final String contentType = "application/octet-stream";
        final String accept = "application/json";
        return service.putBlobFromUrlSync(this.client.getUrl(), contentType, this.client.getVersion(),
            this.client.getContainerName(), this.client.getBlob(), contentLength, copySource, accept, requestOptions,
            Context.NONE);
    }
    ...
    public Mono<Response<Void>> stageBlockWithResponseAsync(String blockId, long contentLength, BinaryData body,
        ...
        return FluxUtil.withContext(context -> service.stageBlock(this.client.getUrl(), contentType,
            this.client.getVersion(), this.client.getContainerName(), this.client.getBlob(), blockId, contentLength,
    ...
    public Response<Void> stageBlockWithResponse(String blockId, long contentLength, BinaryData body,
        ...
        final String contentType = "application/octet-stream";
        final String accept = "application/json";
        return service.stageBlockSync(this.client.getUrl(), contentType, this.client.getVersion(),
    ...
    public Mono<Response<Void>> stageBlockFromUrlWithResponseAsync(String blockId, long contentLength, String sourceUrl,
        ...
        return FluxUtil.withContext(context -> service.stageBlockFromUrl(this.client.getUrl(), contentType,
            this.client.getVersion(), this.client.getContainerName(), this.client.getBlob(), blockId, contentLength,
            sourceUrl, accept, requestOptions, context));
    }
    ...
    public Response<Void> stageBlockFromUrlWithResponse(String blockId, long contentLength, String sourceUrl,
        ...
        final String contentType = "application/xml";
        final String accept = "application/json";
        return service.stageBlockFromUrlSync(this.client.getUrl(), contentType, this.client.getVersion(),
            this.client.getContainerName(), this.client.getBlob(), blockId, contentLength, sourceUrl, accept,
    ...
    public Mono<Response<Void>> commitBlockListWithResponseAsync(BinaryData blocks, RequestOptions requestOptions) {
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.commitBlockList(this.client.getUrl(), contentType, this.client.getVersion(),
                this.client.getContainerName(), this.client.getBlob(), accept, blocks, requestOptions, context));
    }
    ...
    public Response<Void> commitBlockListWithResponse(BinaryData blocks, RequestOptions requestOptions) {
        final String contentType = "application/xml";
        final String accept = "application/json";
        return service.commitBlockListSync(this.client.getUrl(), contentType, this.client.getVersion(),
            this.client.getContainerName(), this.client.getBlob(), accept, blocks, requestOptions, Context.NONE);
    }
    ...
    public Mono<Response<BinaryData>> getBlockListWithResponseAsync(String listType, RequestOptions requestOptions) {
        ...
        return FluxUtil
            .withContext(context -> service.getBlockList(this.client.getUrl(), contentType, this.client.getVersion(),
                this.client.getContainerName(), this.client.getBlob(), listType, accept, requestOptions, context));
    }
    ...
    public Response<BinaryData> getBlockListWithResponse(String listType, RequestOptions requestOptions) {
        final String contentType = "application/xml";
        final String accept = "application/xml";
        return service.getBlockListSync(this.client.getUrl(), contentType, this.client.getVersion(),
