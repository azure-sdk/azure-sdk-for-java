...
public final class PageBlobAsyncClient {
    ...
    public Mono<Response<Void>> uploadPagesFromUrlWithResponse(String version, String containerName, String blob,
        ...
        return this.serviceClient.uploadPagesFromUrlWithResponseAsync(version, containerName, blob, sourceUrl,
            sourceRange, contentLength, range, requestOptions);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> uploadPages(String version, String containerName, String blob, long contentLength,
        BinaryData body, String transactionalContentMD5, String transactionalContentCrc64, Integer timeout,
        String range, String leaseId, String encryptionKey, String encryptionKeySha256, String encryptionAlgorithm,
        ...
        return uploadPagesWithResponse(version, containerName, blob, contentLength, body, requestOptions)
            .flatMap(FluxUtil::toMono);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> uploadPagesFromUrl(String version, String containerName, String blob, String sourceUrl,
        String sourceRange, long contentLength, String range, String sourceContentMd5, String sourceContentCrc64,
        ...
        return uploadPagesFromUrlWithResponse(version, containerName, blob, sourceUrl, sourceRange, contentLength,
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> uploadPagesFromUrl(String version, String containerName, String blob, String sourceUrl,
        String sourceRange, long contentLength, String range) {
        // Generated convenience method for uploadPagesFromUrlWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return uploadPagesFromUrlWithResponse(version, containerName, blob, sourceUrl, sourceRange, contentLength,
            range, requestOptions).flatMap(FluxUtil::toMono);
    ...
    public Mono<Void> copyIncremental(String version, String containerName, String blob, String copySource,
        Integer timeout, String ifTags, RequestConditions requestConditions) {
