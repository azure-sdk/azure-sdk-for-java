...
public final class ContainerAppendBlobsImpl {
     ...
     */
    ContainerAppendBlobsImpl(ServiceClientClientImpl client) {
    ...
    /**
     * The interface defining all the services for ServiceClientClientContainerAppendBlobs to be used by the proxy
     * service to perform REST calls.
     */
    @Host("{url}")
    @ServiceInterface(name = "ServiceClientClientC")
    public interface ContainerAppendBlobsService {
        @Put("/{containerName}/{containerName}/{blob}?AppendBlob")
        ...
        @Put("/{containerName}/{containerName}/{blob}?comp=appendblock")
        @ExpectedResponses({ 201 })
        @UnexpectedResponseExceptionType(value = ClientAuthenticationException.class, code = { 401 })
        @UnexpectedResponseExceptionType(value = ResourceNotFoundException.class, code = { 404 })
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        ...
        @Put("/{containerName}/{containerName}/{blob}?comp=appendblock&fromUrl")
        @ExpectedResponses({ 201 })
        @UnexpectedResponseExceptionType(value = ClientAuthenticationException.class, code = { 401 })
        @UnexpectedResponseExceptionType(value = ResourceNotFoundException.class, code = { 404 })
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        ...
        @Put("/{containerName}/{containerName}/{blob}?comp=seal")
