...
public final class BlobClientBuilder implements HttpTrait<BlobClientBuilder>, ConfigurationTrait<BlobClientBuilder>,
     ...
     */
    @Generated
    public BlobClientBuilder version(String version) {
    ...
    private BlobClientImpl buildInnerClient() {
        ...
        BlobClientImpl client = new BlobClientImpl(localPipeline, JacksonAdapter.createDefaultSerializerAdapter(),
            this.url, this.version, this.containerName, this.blob, localServiceVersion);
        return client;
    }
     ...
     */
    @Generated
    public ServiceAsyncClient buildServiceAsyncClient() {
        return new ServiceAsyncClient(buildInnerClient().getServices());
    }
    ...
    /**
     * Builds an instance of PageBlobAsyncClient class.
     * 
     * @return an instance of PageBlobAsyncClient.
     */
    @Generated
    public PageBlobAsyncClient buildPageBlobAsyncClient() {
        return new PageBlobAsyncClient(buildInnerClient().getPageBlobs());
    }

    /**
     * Builds an instance of AppendBlobAsyncClient class.
     * 
     * @return an instance of AppendBlobAsyncClient.
     */
    @Generated
    public AppendBlobAsyncClient buildAppendBlobAsyncClient() {
        return new AppendBlobAsyncClient(buildInnerClient().getAppendBlobs());
    }

    /**
     * Builds an instance of BlockBlobAsyncClient class.
     * 
     * @return an instance of BlockBlobAsyncClient.
     */
    @Generated
    public BlockBlobAsyncClient buildBlockBlobAsyncClient() {
        return new BlockBlobAsyncClient(buildInnerClient().getBlockBlobs());
    }
    ...
    public ServiceClient buildServiceClient() {
        return new ServiceClient(buildInnerClient().getServices());
    }
