...
public final class QueryFormat implements JsonSerializable<QueryFormat> {
    ...
    /**
     * Get the parquetConfiguration property: The Parquet configuration.
     * 
     * @return the parquetConfiguration value.
     */
    @Generated
    ...
    /**
     * Set the parquetConfiguration property: The Parquet configuration.
     * 
     * @param parquetConfiguration the parquetConfiguration value to set.
     * @return the QueryFormat object itself.
     */
    @Generated
    public QueryFormat setParquetConfiguration(ParquetConfiguration parquetConfiguration) {
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeJsonField("parquetConfiguration", this.parquetConfiguration);
    ...
    public static QueryFormat fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                } else if ("parquetConfiguration".equals(fieldName)) {
                    parquetConfiguration = ParquetConfiguration.fromJson(reader);
                } else {
                    reader.skipChildren();
                }
            }
            ...
            deserializedQueryFormat.parquetConfiguration = parquetConfiguration;
