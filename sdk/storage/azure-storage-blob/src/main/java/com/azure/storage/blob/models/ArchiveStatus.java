...
public final class ArchiveStatus extends ExpandableStringEnum<ArchiveStatus> {
     ...
     */
    @Generated
    public static final ArchiveStatus REHYDRATE_PENDING_TO_ARCHIVE = fromString("rehydrate-pending-to-archive");

    /**
     * The archive status is rehydrating pending to expired.
     */
    @Generated
    public static final ArchiveStatus REHYDRATE_PENDING_TO_EXPIRED = fromString("rehydrate-pending-to-expired");
