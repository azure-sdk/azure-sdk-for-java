...
public final class BlobClientImpl {
     ...
     */
    public BlobClientImpl(String url, String containerName, String blobName, BlobServiceVersion serviceVersion) {
        this(new HttpPipelineBuilder().policies(new UserAgentPolicy(), new RetryPolicy()).build(),
            JacksonAdapter.createDefaultSerializerAdapter(), url, containerName, blobName, serviceVersion);
    }
     ...
     * @param serviceVersion Service version.
     */
    public BlobClientImpl(HttpPipeline httpPipeline, String url, String containerName, String blobName,
        BlobServiceVersion serviceVersion) {
        this(httpPipeline, JacksonAdapter.createDefaultSerializerAdapter(), url, containerName, blobName,
            serviceVersion);
    }
    ...
    public BlobClientImpl(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter, String url,
        String containerName, String blobName, BlobServiceVersion serviceVersion) {
        ...
        this.service = RestProxy.create(BlobClientService.class, this.httpPipeline, this.getSerializerAdapter());
    }
     ...
     */
    @Host("{url}")
    @ServiceInterface(name = "BlobClient")
    ...
    public Mono<Response<Void>> setPropertiesWithResponseAsync(BinaryData setPropertiesRequest,
        ...
        return FluxUtil.withContext(context -> service.setProperties(this.getUrl(), contentType,
            this.getServiceVersion().getVersion(), accept, setPropertiesRequest, requestOptions, context));
    }
    ...
    public Response<Void> setPropertiesWithResponse(BinaryData setPropertiesRequest, RequestOptions requestOptions) {
        final String contentType = "application/xml";
        final String accept = "application/json";
        return service.setPropertiesSync(this.getUrl(), contentType, this.getServiceVersion().getVersion(), accept,
            setPropertiesRequest, requestOptions, Context.NONE);
    }
    ...
    public Mono<Response<BinaryData>> getPropertiesWithResponseAsync(RequestOptions requestOptions) {
        ...
        return FluxUtil.withContext(context -> service.getProperties(this.getUrl(), contentType,
    ...
    public Response<BinaryData> getPropertiesWithResponse(RequestOptions requestOptions) {
        final String contentType = "application/xml";
        final String accept = "application/xml";
        return service.getPropertiesSync(this.getUrl(), contentType, this.getServiceVersion().getVersion(), accept,
    ...
    public Mono<Response<BinaryData>> getStatisticsWithResponseAsync(RequestOptions requestOptions) {
        final String contentType = "application/xml";
        final String accept = "application/xml";
        return FluxUtil.withContext(context -> service.getStatistics(this.getUrl(), contentType,
            this.getServiceVersion().getVersion(), accept, requestOptions, context));
    }
    ...
    public Response<BinaryData> getStatisticsWithResponse(RequestOptions requestOptions) {
        final String contentType = "application/xml";
        final String accept = "application/xml";
        return service.getStatisticsSync(this.getUrl(), contentType, this.getServiceVersion().getVersion(), accept,
            requestOptions, Context.NONE);
    }
    ...
    public Mono<Response<BinaryData>> listContainersSegmentWithResponseAsync(RequestOptions requestOptions) {
        final String contentType = "application/xml";
        final String accept = "application/xml";
        return FluxUtil.withContext(context -> service.listContainersSegment(this.getUrl(), contentType,
            this.getServiceVersion().getVersion(), accept, requestOptions, context));
    }
    ...
    public Response<BinaryData> listContainersSegmentWithResponse(RequestOptions requestOptions) {
        final String contentType = "application/xml";
        final String accept = "application/xml";
        return service.listContainersSegmentSync(this.getUrl(), contentType, this.getServiceVersion().getVersion(),
    ...
    public Mono<Response<BinaryData>> getUserDelegationKeyWithResponseAsync(BinaryData getUserDelegationKeyRequest,
        ...
        final String contentType = "application/xml";
        final String accept = "application/xml";
        return FluxUtil.withContext(context -> service.getUserDelegationKey(this.getUrl(), contentType,
            this.getServiceVersion().getVersion(), accept, getUserDelegationKeyRequest, requestOptions, context));
    }
    ...
    public Response<BinaryData> getUserDelegationKeyWithResponse(BinaryData getUserDelegationKeyRequest,
        ...
        final String contentType = "application/xml";
        final String accept = "application/xml";
        return service.getUserDelegationKeySync(this.getUrl(), contentType, this.getServiceVersion().getVersion(),
            accept, getUserDelegationKeyRequest, requestOptions, Context.NONE);
    }
    ...
    public Mono<Response<Void>> getAccountInfoWithResponseAsync(RequestOptions requestOptions) {
        final String contentType = "application/xml";
        final String accept = "application/json";
        return FluxUtil.withContext(context -> service.getAccountInfo(this.getUrl(), contentType,
            this.getServiceVersion().getVersion(), accept, requestOptions, context));
    }
    ...
    public Response<Void> getAccountInfoWithResponse(RequestOptions requestOptions) {
        final String contentType = "application/xml";
        final String accept = "application/json";
        return service.getAccountInfoSync(this.getUrl(), contentType, this.getServiceVersion().getVersion(), accept,
            requestOptions, Context.NONE);
    }
    ...
    public Mono<Response<BinaryData>> submitBatchWithResponseAsync(long contentLength, BinaryData body,
        ...
        return FluxUtil.withContext(context -> service.submitBatch(this.getUrl(), multipartContentType,
            this.getServiceVersion().getVersion(), contentLength, accept, body, requestOptions, context));
    }
    ...
    public Response<BinaryData> submitBatchWithResponse(long contentLength, BinaryData body,
        ...
        final String multipartContentType = "multipart/mixed";
        final String accept = "multipart/mixed";
        return service.submitBatchSync(this.getUrl(), multipartContentType, this.getServiceVersion().getVersion(),
    ...
    public Mono<Response<BinaryData>> filterBlobsWithResponseAsync(RequestOptions requestOptions) {
        final String contentType = "application/xml";
        final String accept = "application/xml";
        return FluxUtil.withContext(context -> service.filterBlobs(this.getUrl(), contentType,
            this.getServiceVersion().getVersion(), accept, requestOptions, context));
    }
    ...
    public Response<BinaryData> filterBlobsWithResponse(RequestOptions requestOptions) {
        final String contentType = "application/xml";
        final String accept = "application/xml";
        return service.filterBlobsSync(this.getUrl(), contentType, this.getServiceVersion().getVersion(), accept,
            requestOptions, Context.NONE);
    }
}
