...
public final class BlobClientImpl {
     ...
     */
    public BlobClientImpl(String url, String version, String containerName, String blob,
        BlobServiceVersion serviceVersion) {
        this(new HttpPipelineBuilder().policies(new UserAgentPolicy(), new RetryPolicy()).build(),
            JacksonAdapter.createDefaultSerializerAdapter(), url, version, containerName, blob, serviceVersion);
    }
     ...
     * @param serviceVersion Service version.
     */
    public BlobClientImpl(HttpPipeline httpPipeline, String url, String version, String containerName, String blob,
        BlobServiceVersion serviceVersion) {
        this(httpPipeline, JacksonAdapter.createDefaultSerializerAdapter(), url, version, containerName, blob,
            serviceVersion);
    }
     ...
     * @param serviceVersion Service version.
     */
    public BlobClientImpl(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter, String url, String version,
