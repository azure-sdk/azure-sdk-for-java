...
public final class ContainerBlobAsyncClient {
    @Generated
    private final ContainerBlobsImpl serviceClient;

    /**
     * Initializes an instance of ContainerBlobAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    ContainerBlobAsyncClient(ContainerBlobsImpl serviceClient) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> setExpiry(BlobExpiryOptions expiryOptions, Integer timeout, OffsetDateTime expiresOn) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> setImmutabilityPolicy(Integer timeout, OffsetDateTime ifUnmodifiedSince,
