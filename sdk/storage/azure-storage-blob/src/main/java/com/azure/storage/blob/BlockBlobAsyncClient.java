...
public final class BlockBlobAsyncClient {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<Void>> stageBlockWithResponse(String blockId, long contentLength, BinaryData body,
        RequestOptions requestOptions) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<Void>> stageBlockFromUrlWithResponse(String blockId, long contentLength, String sourceUrl,
        RequestOptions requestOptions) {
    ...
    public Mono<Void> putBlobFromUrl(long contentLength, String copySource, Map<String, String> metadata,
        ...
        String sourceIfTags, String sourceContentMd5, String blobTagsString, Boolean copySourceBlobProperties,
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> stageBlock(String blockId, long contentLength, BinaryData body, String transactionalContentMD5,
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<BlockLookupList> getBlockList(BlockListType listType, String snapshot, Integer timeout, String leaseId,
        String ifTags) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<BlockLookupList> getBlockList(BlockListType listType) {
        // Generated convenience method for getBlockListWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getBlockListWithResponse(listType.toString(), requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(BlockLookupList.class));
