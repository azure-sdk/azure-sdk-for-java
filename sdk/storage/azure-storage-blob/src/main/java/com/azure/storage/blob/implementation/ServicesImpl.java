...
public final class ServicesImpl {
    ...
    public interface ServicesService {
        ...
        Mono<Response<BinaryData>> submitBatch(@HostParam("url") String url,
            ...
            @BodyParam("*/*") BinaryData body, RequestOptions requestOptions, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> submitBatchWithResponseAsync(String multipartContentType, String version,
        long contentLength, BinaryData body, RequestOptions requestOptions) {
        final String accept = "*/*";
        return FluxUtil.withContext(context -> service.submitBatch(this.client.getUrl(), multipartContentType, version,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<BinaryData> submitBatchWithResponse(String multipartContentType, String version, long contentLength,
        BinaryData body, RequestOptions requestOptions) {
        final String accept = "*/*";
        return service.submitBatchSync(this.client.getUrl(), multipartContentType, version, contentLength, accept, body,
            requestOptions, Context.NONE);
    }
