...
public final class ServicesImpl {
    ...
    public interface ServicesService {
        ...
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        @UnexpectedResponseExceptionType(HttpResponseException.class)
        Mono<Response<Void>> submitBatch(@HostParam("url") String url, @HeaderParam("Content-Type") String contentType,
            @HeaderParam("x-ms-version") String version, @HeaderParam("Content-Length") long contentLength,
            @HeaderParam("Accept") String accept, RequestOptions requestOptions, Context context);
        ...
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        @UnexpectedResponseExceptionType(HttpResponseException.class)
        Response<Void> submitBatchSync(@HostParam("url") String url, @HeaderParam("Content-Type") String contentType,
            @HeaderParam("x-ms-version") String version, @HeaderParam("Content-Length") long contentLength,
            @HeaderParam("Accept") String accept, RequestOptions requestOptions, Context context);
    ...
    public Mono<Response<Void>> setPropertiesWithResponseAsync(String version, BinaryData setPropertiesRequest,
        RequestOptions requestOptions) {
        final String contentType = "application/xml";
        final String accept = "application/json";
        return FluxUtil.withContext(context -> service.setProperties(this.client.getUrl(), contentType, version, accept,
            setPropertiesRequest, requestOptions, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<Void> setPropertiesWithResponse(String version, BinaryData setPropertiesRequest,
        RequestOptions requestOptions) {
        final String contentType = "application/xml";
        final String accept = "application/json";
        return service.setPropertiesSync(this.client.getUrl(), contentType, version, accept, setPropertiesRequest,
    ...
    public Mono<Response<BinaryData>> getPropertiesWithResponseAsync(String version, RequestOptions requestOptions) {
        ...
        return FluxUtil.withContext(context -> service.getProperties(this.client.getUrl(), contentType, version, accept,
    ...
    public Response<BinaryData> getPropertiesWithResponse(String version, RequestOptions requestOptions) {
        final String contentType = "application/xml";
        final String accept = "application/xml";
        return service.getPropertiesSync(this.client.getUrl(), contentType, version, accept, requestOptions,
            Context.NONE);
    }
    ...
    public Mono<Response<BinaryData>> getStatisticsWithResponseAsync(String version, RequestOptions requestOptions) {
        final String contentType = "application/xml";
        final String accept = "application/xml";
        return FluxUtil.withContext(context -> service.getStatistics(this.client.getUrl(), contentType, version, accept,
            requestOptions, context));
    }
    ...
    public Response<BinaryData> getStatisticsWithResponse(String version, RequestOptions requestOptions) {
        final String contentType = "application/xml";
        final String accept = "application/xml";
        return service.getStatisticsSync(this.client.getUrl(), contentType, version, accept, requestOptions,
            Context.NONE);
    }
    ...
    public Mono<Response<BinaryData>> listContainersSegmentWithResponseAsync(String version,
        ...
        final String contentType = "application/xml";
        final String accept = "application/xml";
        return FluxUtil.withContext(context -> service.listContainersSegment(this.client.getUrl(), contentType, version,
    ...
    public Response<BinaryData> listContainersSegmentWithResponse(String version, RequestOptions requestOptions) {
        final String contentType = "application/xml";
        final String accept = "application/xml";
        return service.listContainersSegmentSync(this.client.getUrl(), contentType, version, accept, requestOptions,
            Context.NONE);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> getUserDelegationKeyWithResponseAsync(String version,
        BinaryData getUserDelegationKeyRequest, RequestOptions requestOptions) {
        final String contentType = "application/xml";
        final String accept = "application/xml";
        return FluxUtil.withContext(context -> service.getUserDelegationKey(this.client.getUrl(), contentType, version,
            accept, getUserDelegationKeyRequest, requestOptions, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<BinaryData> getUserDelegationKeyWithResponse(String version, BinaryData getUserDelegationKeyRequest,
        RequestOptions requestOptions) {
        final String contentType = "application/xml";
        final String accept = "application/xml";
        return service.getUserDelegationKeySync(this.client.getUrl(), contentType, version, accept,
            getUserDelegationKeyRequest, requestOptions, Context.NONE);
    }
    ...
    public Response<Void> getAccountInfoWithResponse(String version, RequestOptions requestOptions) {
        final String contentType = "application/xml";
        final String accept = "application/json";
        return service.getAccountInfoSync(this.client.getUrl(), contentType, version, accept, requestOptions,
            Context.NONE);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<Void>> submitBatchWithResponseAsync(String version, long contentLength,
        RequestOptions requestOptions) {
        final String contentType = "application/xml";
        final String accept = "application/json";
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<Void> submitBatchWithResponse(String version, long contentLength, RequestOptions requestOptions) {
        final String contentType = "application/xml";
        final String accept = "application/json";
        return service.submitBatchSync(this.client.getUrl(), contentType, version, contentLength, accept,
            requestOptions, Context.NONE);
    }
    ...
    public Mono<Response<BinaryData>> filterBlobsWithResponseAsync(String version, RequestOptions requestOptions) {
        final String contentType = "application/xml";
        final String accept = "application/xml";
        return FluxUtil.withContext(context -> service.filterBlobs(this.client.getUrl(), contentType, version, accept,
            requestOptions, context));
    }
    ...
    public Response<BinaryData> filterBlobsWithResponse(String version, RequestOptions requestOptions) {
        final String contentType = "application/xml";
        final String accept = "application/xml";
        return service.filterBlobsSync(this.client.getUrl(), contentType, version, accept, requestOptions,
            Context.NONE);
    }
}
