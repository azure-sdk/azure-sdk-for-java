...
public final class ContainersImpl {
     ...
     */
    ContainersImpl(ServiceClientClientImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for ServiceClientClientContainers to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{url}")
