...
public final class ContainersImpl {
    ...
    public interface ContainersService {
        ...
        Mono<Response<BinaryData>> submitBatch(@HostParam("url") String url,
            ...
            @HeaderParam("Accept") String accept, @BodyParam("*/*") BinaryData body, RequestOptions requestOptions,
            Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<Void>> setAccessPolicyWithResponseAsync(String version, String containerName,
        ...
        return FluxUtil.withContext(context -> service.setAccessPolicy(this.client.getUrl(), contentType, version,
            containerName, accept, containerAcl, requestOptions, context));
    }
    ...
    public Response<Void> setAccessPolicyWithResponse(String version, String containerName, BinaryData containerAcl,
        ...
        final String contentType = "application/xml";
        final String accept = "application/json";
        return service.setAccessPolicySync(this.client.getUrl(), contentType, version, containerName, accept,
            containerAcl, requestOptions, Context.NONE);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<Void>> restoreWithResponseAsync(String version, String containerName,
        RequestOptions requestOptions) {
        final String contentType = "application/xml";
        final String accept = "application/json";
        return FluxUtil.withContext(context -> service.restore(this.client.getUrl(), contentType, version,
            containerName, accept, requestOptions, context));
    }
    ...
    public Response<Void> restoreWithResponse(String version, String containerName, RequestOptions requestOptions) {
        final String contentType = "application/xml";
        final String accept = "application/json";
        return service.restoreSync(this.client.getUrl(), contentType, version, containerName, accept, requestOptions,
            Context.NONE);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> submitBatchWithResponseAsync(String containerName, String multipartContentType,
        long contentLength, String version, BinaryData body, RequestOptions requestOptions) {
        final String accept = "*/*";
        return FluxUtil.withContext(context -> service.submitBatch(this.client.getUrl(), containerName,
            multipartContentType, contentLength, version, accept, body, requestOptions, context));
    }
    ...
    public Response<BinaryData> submitBatchWithResponse(String containerName, String multipartContentType,
        long contentLength, String version, BinaryData body, RequestOptions requestOptions) {
        final String accept = "*/*";
        return service.submitBatchSync(this.client.getUrl(), containerName, multipartContentType, contentLength,
            version, accept, body, requestOptions, Context.NONE);
    }
