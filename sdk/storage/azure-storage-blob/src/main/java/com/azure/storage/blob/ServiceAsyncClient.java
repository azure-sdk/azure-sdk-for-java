...
public final class ServiceAsyncClient {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<Void>> submitBatchWithResponse(String version, long contentLength,
        RequestOptions requestOptions) {
        return this.serviceClient.submitBatchWithResponseAsync(version, contentLength, requestOptions);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> submitBatch(String version, long contentLength, Integer timeout) {
        // Generated convenience method for submitBatchWithResponse
        RequestOptions requestOptions = new RequestOptions();
        if (timeout != null) {
            requestOptions.addQueryParam("timeout", String.valueOf(timeout), false);
        }
        return submitBatchWithResponse(version, contentLength, requestOptions).flatMap(FluxUtil::toMono);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> submitBatch(String version, long contentLength) {
        // Generated convenience method for submitBatchWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return submitBatchWithResponse(version, contentLength, requestOptions).flatMap(FluxUtil::toMono);
    }
