...
/**
 * An instance of this class provides access to all the operations defined in ContainerBlockBlobs.
 */
public final class ContainerBlockBlobsImpl {
    /**
     * The proxy service used to perform REST calls.
     */
    private final ContainerBlockBlobsService service;
    ...
    /**
     * Initializes an instance of ContainerBlockBlobsImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    ContainerBlockBlobsImpl(ServiceClientClientImpl client) {
        this.service = RestProxy.create(ContainerBlockBlobsService.class, client.getHttpPipeline(),
    ...
    /**
     * The interface defining all the services for ServiceClientClientContainerBlockBlobs to be used by the proxy
     * service to perform REST calls.
     */
    @Host("{url}")
    @ServiceInterface(name = "ServiceClientClientC")
    public interface ContainerBlockBlobsService {
        @Put("/{containerName}/{containerName}/{blob}?BlockBlob")
        ...
        @Put("/{containerName}/{containerName}/{blob}?BlockBlob&fromUrl")
        @ExpectedResponses({ 201 })
        @UnexpectedResponseExceptionType(value = ClientAuthenticationException.class, code = { 401 })
        @UnexpectedResponseExceptionType(value = ResourceNotFoundException.class, code = { 404 })
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        ...
        @Put("/{containerName}/{containerName}/{blob}?comp=block")
        @ExpectedResponses({ 201 })
        @UnexpectedResponseExceptionType(value = ClientAuthenticationException.class, code = { 401 })
        @UnexpectedResponseExceptionType(value = ResourceNotFoundException.class, code = { 404 })
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        ...
        @Put("/{containerName}/{containerName}/{blob}?comp=block&fromURL")
        @ExpectedResponses({ 201 })
        @UnexpectedResponseExceptionType(value = ClientAuthenticationException.class, code = { 401 })
        @UnexpectedResponseExceptionType(value = ResourceNotFoundException.class, code = { 404 })
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        ...
        @Put("/{containerName}/{containerName}/{blob}?comp=blocklist")
        @ExpectedResponses({ 201 })
        @UnexpectedResponseExceptionType(value = ClientAuthenticationException.class, code = { 401 })
        @UnexpectedResponseExceptionType(value = ResourceNotFoundException.class, code = { 404 })
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        ...
        @Get("/{containerName}/{containerName}/{blob}?comp=blocklist")
        ...
        @Post("/{containerName}/{containerName}/{blob}?comp=query")
    ...
    public Mono<Response<BinaryData>> queryWithResponseAsync(BinaryData queryRequest, RequestOptions requestOptions) {
        ...
        return FluxUtil.withContext(
            context -> service.query(this.client.getUrl(), contentType, this.client.getServiceVersion().getVersion(),
