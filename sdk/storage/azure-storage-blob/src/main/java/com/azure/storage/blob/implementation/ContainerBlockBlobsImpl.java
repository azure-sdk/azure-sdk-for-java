...
public final class ContainerBlockBlobsImpl {
     ...
     */
    ContainerBlockBlobsImpl(BlobClientImpl client) {
    ...
    /**
     * The interface defining all the services for BlobClientContainerBlockBlobs to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{url}")
    @ServiceInterface(name = "BlobClientContainerB")
    public interface ContainerBlockBlobsService {
        @Put("/{containerName}/{blobName}?BlockBlob")
        ...
        @Put("/{containerName}/{blobName}?BlockBlob&fromUrl")
        @ExpectedResponses({ 201 })
        @UnexpectedResponseExceptionType(value = ClientAuthenticationException.class, code = { 401 })
        @UnexpectedResponseExceptionType(value = ResourceNotFoundException.class, code = { 404 })
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        ...
        @Put("/{containerName}/{blobName}?comp=block")
        @ExpectedResponses({ 201 })
        @UnexpectedResponseExceptionType(value = ClientAuthenticationException.class, code = { 401 })
        @UnexpectedResponseExceptionType(value = ResourceNotFoundException.class, code = { 404 })
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        ...
        Mono<Response<Void>> stageBlock(@HostParam("url") String url, @HeaderParam("Content-Type") String contentType,
            @HeaderParam("x-ms-version") String xMsVersion, @PathParam("containerName") String containerName,
            @PathParam("blobName") String blobName, @QueryParam("blockid") Base64Url blockId,
        ...
        @Put("/{containerName}/{blobName}?comp=block&fromURL")
        @ExpectedResponses({ 201 })
        @UnexpectedResponseExceptionType(value = ClientAuthenticationException.class, code = { 401 })
        @UnexpectedResponseExceptionType(value = ResourceNotFoundException.class, code = { 404 })
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        ...
        Mono<Response<Void>> stageBlockFromUrl(@HostParam("url") String url,
            @HeaderParam("Content-Type") String contentType, @HeaderParam("x-ms-version") String xMsVersion,
            @PathParam("containerName") String containerName, @PathParam("blobName") String blobName,
            @QueryParam("blockid") Base64Url blockId, @HeaderParam("Content-Length") long contentLength,
        ...
        @Put("/{containerName}/{blobName}?comp=blocklist")
        @ExpectedResponses({ 201 })
        @UnexpectedResponseExceptionType(value = ClientAuthenticationException.class, code = { 401 })
        @UnexpectedResponseExceptionType(value = ResourceNotFoundException.class, code = { 404 })
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        ...
        @Get("/{containerName}/{blobName}?comp=blocklist")
        ...
        @Post("/{containerName}/{blobName}?comp=query")
    ...
    public Response<Void> uploadWithResponse(long contentLength, BinaryData body, RequestOptions requestOptions) {
        ...
        return service.uploadSync(this.client.getUrl(), contentType, this.client.getServiceVersion().getVersion(),
            this.client.getContainerName(), this.client.getBlobName(), contentLength, blobType, accept, body,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<Void>> stageBlockWithResponseAsync(byte[] blockId, long contentLength, BinaryData body,
        RequestOptions requestOptions) {
        final String contentType = "application/octet-stream";
        final String accept = "application/json";
        Base64Url blockIdConverted = Base64Url.encode(blockId);
        return FluxUtil.withContext(context -> service.stageBlock(this.client.getUrl(), contentType,
            this.client.getServiceVersion().getVersion(), this.client.getContainerName(), this.client.getBlobName(),
            blockIdConverted, contentLength, accept, body, requestOptions, context));
    }
    ...
    public Response<Void> stageBlockWithResponse(byte[] blockId, long contentLength, BinaryData body,
        ...
        return service.stageBlockSync(this.client.getUrl(), contentType, this.client.getServiceVersion().getVersion(),
            this.client.getContainerName(), this.client.getBlobName(), blockIdConverted, contentLength, accept, body,
            requestOptions, Context.NONE);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<Void>> stageBlockFromUrlWithResponseAsync(byte[] blockId, long contentLength, String sourceUrl,
        RequestOptions requestOptions) {
        ...
        return FluxUtil.withContext(context -> service.stageBlockFromUrl(this.client.getUrl(), contentType,
            this.client.getServiceVersion().getVersion(), this.client.getContainerName(), this.client.getBlobName(),
            blockIdConverted, contentLength, sourceUrl, accept, requestOptions, context));
    }
    ...
    public Response<Void> stageBlockFromUrlWithResponse(byte[] blockId, long contentLength, String sourceUrl,
        ...
        return service.stageBlockFromUrlSync(this.client.getUrl(), contentType,
            this.client.getServiceVersion().getVersion(), this.client.getContainerName(), this.client.getBlobName(),
            blockIdConverted, contentLength, sourceUrl, accept, requestOptions, Context.NONE);
    }
    ...
    public Mono<Response<Void>> commitBlockListWithResponseAsync(BinaryData blocks, RequestOptions requestOptions) {
        ...
        return FluxUtil.withContext(context -> service.commitBlockList(this.client.getUrl(), contentType,
            this.client.getServiceVersion().getVersion(), this.client.getContainerName(), this.client.getBlobName(),
            accept, blocks, requestOptions, context));
    }
    ...
    public Response<Void> commitBlockListWithResponse(BinaryData blocks, RequestOptions requestOptions) {
        ...
        return service.commitBlockListSync(this.client.getUrl(), contentType,
            this.client.getServiceVersion().getVersion(), this.client.getContainerName(), this.client.getBlobName(),
            accept, blocks, requestOptions, Context.NONE);
    }
    ...
    public Response<BinaryData> getBlockListWithResponse(String listType, RequestOptions requestOptions) {
        ...
        return service.getBlockListSync(this.client.getUrl(), contentType, this.client.getServiceVersion().getVersion(),
            this.client.getContainerName(), this.client.getBlobName(), listType, accept, requestOptions, Context.NONE);
    }
    ...
    public Mono<Response<BinaryData>> queryWithResponseAsync(BinaryData queryRequest, RequestOptions requestOptions) {
        ...
        return FluxUtil.withContext(context -> service.query(this.client.getUrl(), contentType,
            this.client.getServiceVersion().getVersion(), this.client.getContainerName(), this.client.getBlobName(),
            accept, queryRequest, requestOptions, context));
    }
    ...
    public Response<BinaryData> queryWithResponse(BinaryData queryRequest, RequestOptions requestOptions) {
        ...
        return service.querySync(this.client.getUrl(), contentType, this.client.getServiceVersion().getVersion(),
            this.client.getContainerName(), this.client.getBlobName(), accept, queryRequest, requestOptions,
            Context.NONE);
    }
}
