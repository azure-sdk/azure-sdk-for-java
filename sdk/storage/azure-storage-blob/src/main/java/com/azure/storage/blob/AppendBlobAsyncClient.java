...
public final class AppendBlobAsyncClient {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> appendBlock(long contentLength, byte[] body, Integer timeout, String transactionalContentMD5,
        ...
        return appendBlockWithResponse(contentLength, BinaryData.fromObject(body), requestOptions)
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> appendBlock(long contentLength, byte[] body) {
        // Generated convenience method for appendBlockWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return appendBlockWithResponse(contentLength, BinaryData.fromObject(body), requestOptions)
            .flatMap(FluxUtil::toMono);
