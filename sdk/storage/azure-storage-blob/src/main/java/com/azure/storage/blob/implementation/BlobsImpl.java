...
public final class BlobsImpl {
    ...
    public interface BlobsService {
        ...
        Mono<Response<BinaryData>> download(@HostParam("url") String url, @HeaderParam("x-ms-version") String version,
        ...
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        @UnexpectedResponseExceptionType(HttpResponseException.class)
        Response<BinaryData> downloadSync(@HostParam("url") String url, @HeaderParam("x-ms-version") String version,
            @PathParam("containerName") String containerName, @PathParam("blob") String blob,
            @HeaderParam("Accept") String accept, RequestOptions requestOptions, Context context);
        ...
        Mono<Response<BinaryData>> query(@HostParam("url") String url, @HeaderParam("Content-Type") String contentType,
            ...
            @BodyParam("application/octet-stream") BinaryData queryRequest, RequestOptions requestOptions,
            Context context);
    ...
    public Mono<Response<BinaryData>> downloadWithResponseAsync(String version, String containerName, String blob,
        ...
        return FluxUtil.withContext(context -> service.download(this.client.getUrl(), version, containerName, blob,
    ...
    public Response<BinaryData> downloadWithResponse(String version, String containerName, String blob,
        RequestOptions requestOptions) {
        final String accept = "application/octet-stream";
        return service.downloadSync(this.client.getUrl(), version, containerName, blob, accept, requestOptions,
            Context.NONE);
    }
