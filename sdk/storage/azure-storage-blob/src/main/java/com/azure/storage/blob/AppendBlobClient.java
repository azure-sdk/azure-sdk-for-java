...
public final class AppendBlobClient {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public void appendBlock(long contentLength, byte[] body, Integer timeout, String transactionalContentMD5,
        ...
        appendBlockWithResponse(contentLength, BinaryData.fromObject(body), requestOptions).getValue();
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public void appendBlock(long contentLength, byte[] body) {
        // Generated convenience method for appendBlockWithResponse
        RequestOptions requestOptions = new RequestOptions();
        appendBlockWithResponse(contentLength, BinaryData.fromObject(body), requestOptions).getValue();
    }
    ...
    public void appendBlockFromUrl(String sourceUrl, long contentLength, String sourceRange, String sourceContentMd5,
        ...
        Long maxSize, Long appendPosition, String ifTags, String sourceIfModifiedSince, String sourceIfUnmodifiedSince,
