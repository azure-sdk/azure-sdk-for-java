...
public final class AppendBlobClient {
    ...
    public Response<Void> createWithResponse(String containerName, String blob, long contentLength, String version,
        ...
        return this.serviceClient.createWithResponse(containerName, blob, contentLength, version, requestOptions);
    }
    ...
    public Response<Void> appendBlockWithResponse(String containerName, String blob, long contentLength, long maxSize,
        ...
        return this.serviceClient.appendBlockWithResponse(containerName, blob, contentLength, maxSize, appendPosition,
    ...
    public Response<Void> appendBlockFromUrlWithResponse(String containerName, String blob, long contentLength,
        ...
        RequestOptions requestOptions) {
        return this.serviceClient.appendBlockFromUrlWithResponse(containerName, blob, contentLength, sourceUrl,
    ...
    public Response<Void> sealWithResponse(String containerName, String blob, long appendPosition, String version,
        RequestOptions requestOptions) {
        return this.serviceClient.sealWithResponse(containerName, blob, appendPosition, version, requestOptions);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public void create(String containerName, String blob, long contentLength, String version, Integer timeout,
        ...
        createWithResponse(containerName, blob, contentLength, version, requestOptions).getValue();
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public void create(String containerName, String blob, long contentLength, String version) {
        // Generated convenience method for createWithResponse
        RequestOptions requestOptions = new RequestOptions();
        createWithResponse(containerName, blob, contentLength, version, requestOptions).getValue();
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public void appendBlock(String containerName, String blob, long contentLength, long maxSize, long appendPosition,
        String version, byte[] body, Integer timeout, String transactionalContentMD5, String transactionalContentCrc64,
        ...
        appendBlockWithResponse(containerName, blob, contentLength, maxSize, appendPosition, version,
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public void appendBlockFromUrl(String containerName, String blob, long contentLength, String sourceUrl,
        ...
        appendBlockFromUrlWithResponse(containerName, blob, contentLength, sourceUrl, sourceRange, maxSize,
            appendPosition, version, requestOptions).getValue();
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public void seal(String containerName, String blob, long appendPosition, String version, Integer timeout,
        ...
        sealWithResponse(containerName, blob, appendPosition, version, requestOptions).getValue();
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public void seal(String containerName, String blob, long appendPosition, String version) {
        // Generated convenience method for sealWithResponse
        RequestOptions requestOptions = new RequestOptions();
        sealWithResponse(containerName, blob, appendPosition, version, requestOptions).getValue();
    }
