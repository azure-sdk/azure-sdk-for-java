...
public final class ContainerBlobAppendBlobsImpl {
    ...
    ContainerBlobAppendBlobsImpl(BlobClientImpl client) {
        this.service = RestProxy.create(ContainerBlobAppendBlobsService.class, client.getHttpPipeline(),
    ...
    public interface ContainerBlobAppendBlobsService {
        @Put("/{containerName}/{blobName}?AppendBlob")
        ...
        @Put("/{containerName}/{blobName}?comp=appendblock")
        @ExpectedResponses({ 201 })
        @UnexpectedResponseExceptionType(value = ClientAuthenticationException.class, code = { 401 })
        @UnexpectedResponseExceptionType(value = ResourceNotFoundException.class, code = { 404 })
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        ...
        @Put("/{containerName}/{blobName}?comp=appendblock&fromUrl")
        @ExpectedResponses({ 201 })
        @UnexpectedResponseExceptionType(value = ClientAuthenticationException.class, code = { 401 })
        @UnexpectedResponseExceptionType(value = ResourceNotFoundException.class, code = { 404 })
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        ...
        @Put("/{containerName}/{blobName}?comp=seal")
    ...
    public Response<Void> createWithResponse(long contentLength, RequestOptions requestOptions) {
        ...
        return service.createSync(this.client.getUrl(), contentType, this.client.getServiceVersion().getVersion(),
            this.client.getContainerName(), this.client.getBlobName(), contentLength, blobType, accept, requestOptions,
            Context.NONE);
    }
