...
public final class BlobItemInternal implements JsonSerializable<BlobItemInternal> {
     ...
     */
    @Generated
    public List<BlobTag> getBlobTags() {
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeArrayField("blobTags", this.blobTags, (writer, element) -> writer.writeJson(element));
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("name".equals(fieldName)) {
                    ...
                    blobTags = reader.readArray(reader1 -> BlobTag.fromJson(reader1));
