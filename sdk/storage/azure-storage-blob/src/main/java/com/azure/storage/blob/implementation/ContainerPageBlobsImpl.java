...
public final class ContainerPageBlobsImpl {
     ...
     */
    ContainerPageBlobsImpl(ServiceClientClientImpl client) {
    ...
    /**
     * The interface defining all the services for ServiceClientClientContainerPageBlobs to be used by the proxy service
     * to perform REST calls.
     */
    @Host("{url}")
    @ServiceInterface(name = "ServiceClientClientC")
    public interface ContainerPageBlobsService {
        @Put("/{containerName}/{containerName}/{blob}?PageBlob")
        ...
        @Put("/{containerName}/{containerName}/{blob}?comp=page&update")
        @ExpectedResponses({ 201 })
        @UnexpectedResponseExceptionType(value = ClientAuthenticationException.class, code = { 401 })
        @UnexpectedResponseExceptionType(value = ResourceNotFoundException.class, code = { 404 })
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        ...
        @Put("/{containerName}/{containerName}/{blob}?comp=page&clear")
        @ExpectedResponses({ 201 })
        @UnexpectedResponseExceptionType(value = ClientAuthenticationException.class, code = { 401 })
        @UnexpectedResponseExceptionType(value = ResourceNotFoundException.class, code = { 404 })
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        ...
        @Put("/{containerName}/{containerName}/{blob}?comp=page&update&fromUrl")
        @ExpectedResponses({ 201 })
        @UnexpectedResponseExceptionType(value = ClientAuthenticationException.class, code = { 401 })
        @UnexpectedResponseExceptionType(value = ResourceNotFoundException.class, code = { 404 })
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        ...
        @Get("/{containerName}/{containerName}/{blob}?comp=pagelist")
        ...
        @Get("/{containerName}/{containerName}/{blob}?comp=pagelist&diff")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(value = ClientAuthenticationException.class, code = { 401 })
        @UnexpectedResponseExceptionType(value = ResourceNotFoundException.class, code = { 404 })
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        ...
        @Put("/{containerName}/{containerName}/{blob}?comp=properties&Resize")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(value = ClientAuthenticationException.class, code = { 401 })
        @UnexpectedResponseExceptionType(value = ResourceNotFoundException.class, code = { 404 })
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        ...
        @Put("/{containerName}/{containerName}/{blob}?comp=properties&UpdateSequenceNumber")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(value = ClientAuthenticationException.class, code = { 401 })
        @UnexpectedResponseExceptionType(value = ResourceNotFoundException.class, code = { 404 })
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        ...
        @Put("/{containerName}/{containerName}/{blob}?comp=incrementalcopy")
    ...
    public Response<Void> createWithResponse(long contentLength, long blobContentLength,
        ...
        return service.createSync(this.client.getUrl(), contentType, this.client.getServiceVersion().getVersion(),
            this.client.getContainerName(), this.client.getBlob(), contentLength, blobContentLength, blobType, accept,
