...
public final class BlockBlobClient {
    ...
    public Response<Void> uploadWithResponse(long contentLength, BinaryData body, RequestOptions requestOptions) {
        return this.serviceClient.uploadWithResponse(contentLength, body, requestOptions);
    }
    ...
    public Response<Void> putBlobFromUrlWithResponse(long contentLength, String copySource,
        ...
        return this.serviceClient.putBlobFromUrlWithResponse(contentLength, copySource, requestOptions);
    }
    ...
    public Response<Void> stageBlockWithResponse(String blockId, long contentLength, BinaryData body,
        RequestOptions requestOptions) {
        return this.serviceClient.stageBlockWithResponse(blockId, contentLength, body, requestOptions);
    }
    ...
    public Response<Void> stageBlockFromUrlWithResponse(String blockId, long contentLength, String sourceUrl,
        RequestOptions requestOptions) {
        return this.serviceClient.stageBlockFromUrlWithResponse(blockId, contentLength, sourceUrl, requestOptions);
    }
    ...
    public Response<Void> commitBlockListWithResponse(BinaryData blocks, RequestOptions requestOptions) {
        return this.serviceClient.commitBlockListWithResponse(blocks, requestOptions);
    }
    ...
    public Response<BinaryData> getBlockListWithResponse(String listType, RequestOptions requestOptions) {
        return this.serviceClient.getBlockListWithResponse(listType, requestOptions);
    }
    ...
    public void upload(long contentLength, BinaryData body, Map<String, String> metadata, Integer timeout,
        ...
        String encryptionScope, AccessTier tier, String ifTags, String blobTagsString, String immutabilityPolicyExpiry,
        ...
        uploadWithResponse(contentLength, body, requestOptions).getValue();
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public void putBlobFromUrl(long contentLength, String copySource, Map<String, String> metadata, Integer timeout,
        String transactionalContentMD5, String blobContentType, String blobContentEncoding, String blobContentLanguage,
        byte[] blobContentMd5, String blobCacheControl, String leaseId, String blobContentDisposition,
        String encryptionKey, String encryptionKeySha256, EncryptionAlgorithmType encryptionAlgorithm,
        String encryptionScope, AccessTier tier, String ifTags, String sourceIfModifiedSince,
        ...
        putBlobFromUrlWithResponse(contentLength, copySource, requestOptions).getValue();
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public void stageBlock(String blockId, long contentLength, BinaryData body, String transactionalContentMD5,
        ...
        stageBlockWithResponse(blockId, contentLength, body, requestOptions).getValue();
    }
    ...
    public void stageBlockFromUrl(String blockId, long contentLength, String sourceUrl, String sourceRange,
        ...
        stageBlockFromUrlWithResponse(blockId, contentLength, sourceUrl, requestOptions).getValue();
    }
    ...
    public void commitBlockList(BlockLookupList blocks, Integer timeout, String blobCacheControl,
        ...
        commitBlockListWithResponse(BinaryData.fromObject(blocks), requestOptions).getValue();
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public BlockLookupList getBlockList(BlockListType listType, String snapshot, Integer timeout, String leaseId,
        String ifTags) {
        ...
        return getBlockListWithResponse(listType.toString(), requestOptions).getValue().toObject(BlockLookupList.class);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public BlockLookupList getBlockList(BlockListType listType) {
        // Generated convenience method for getBlockListWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getBlockListWithResponse(listType.toString(), requestOptions).getValue().toObject(BlockLookupList.class);
    }
