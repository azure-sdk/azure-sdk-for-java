...
public final class AppendBlobsImpl {
    ...
    public Mono<Response<Void>> createWithResponseAsync(long contentLength, RequestOptions requestOptions) {
        ...
        return FluxUtil.withContext(context -> service.create(this.client.getUrl(), contentType,
            ...
            contentLength, blobType, accept, requestOptions, context));
    }
    ...
    public Response<Void> createWithResponse(long contentLength, RequestOptions requestOptions) {
        ...
        return service.createSync(this.client.getUrl(), contentType, this.client.getServiceVersion().getVersion(),
            this.client.getContainerName(), this.client.getBlob(), contentLength, blobType, accept, requestOptions,
            Context.NONE);
    }
    ...
    public Response<Void> appendBlockWithResponse(long contentLength, BinaryData body, RequestOptions requestOptions) {
        final String contentType = "application/octet-stream";
        final String accept = "application/json";
        return service.appendBlockSync(this.client.getUrl(), contentType, this.client.getServiceVersion().getVersion(),
    ...
    public Mono<Response<Void>> appendBlockFromUrlWithResponseAsync(String sourceUrl, long contentLength,
        ...
        return FluxUtil.withContext(context -> service.appendBlockFromUrl(this.client.getUrl(), contentType,
            this.client.getServiceVersion().getVersion(), this.client.getContainerName(), this.client.getBlob(),
            sourceUrl, contentLength, accept, requestOptions, context));
    }
    ...
    public Response<Void> appendBlockFromUrlWithResponse(String sourceUrl, long contentLength,
        ...
        final String contentType = "application/xml";
        final String accept = "application/json";
        return service.appendBlockFromUrlSync(this.client.getUrl(), contentType,
            this.client.getServiceVersion().getVersion(), this.client.getContainerName(), this.client.getBlob(),
            sourceUrl, contentLength, accept, requestOptions, Context.NONE);
    }
    ...
    public Mono<Response<Void>> sealWithResponseAsync(RequestOptions requestOptions) {
        ...
        return FluxUtil.withContext(
            context -> service.seal(this.client.getUrl(), contentType, this.client.getServiceVersion().getVersion(),
    ...
    public Response<Void> sealWithResponse(RequestOptions requestOptions) {
        final String contentType = "application/xml";
        final String accept = "application/json";
        return service.sealSync(this.client.getUrl(), contentType, this.client.getServiceVersion().getVersion(),
