...
public final class AppendBlobsImpl {
    ...
    public interface AppendBlobsService {
        ...
        Mono<Response<Void>> seal(@HostParam("url") String url, @HeaderParam("Content-Type") String contentType,
            @HeaderParam("x-ms-version") String version, @PathParam("containerName") String containerName,
            @PathParam("blob") String blob, @HeaderParam("x-ms-blob-condition-appendpos") long appendPosition,
            @HeaderParam("Accept") String accept, RequestOptions requestOptions, Context context);
    ...
    public Mono<Response<Void>> createWithResponseAsync(String version, String containerName, String blob,
        ...
        return FluxUtil.withContext(context -> service.create(this.client.getUrl(), contentType, version, containerName,
            blob, contentLength, accept, requestOptions, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<Void>> appendBlockWithResponseAsync(String version, String containerName, String blob,
        long contentLength, long maxSize, long appendPosition, BinaryData body, RequestOptions requestOptions) {
        final String contentType = "application/xml";
        final String accept = "application/json";
        return FluxUtil.withContext(context -> service.appendBlock(this.client.getUrl(), contentType, version,
            containerName, blob, contentLength, maxSize, appendPosition, accept, body, requestOptions, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<Void> appendBlockWithResponse(String version, String containerName, String blob, long contentLength,
        long maxSize, long appendPosition, BinaryData body, RequestOptions requestOptions) {
        final String contentType = "application/xml";
        final String accept = "application/json";
        return service.appendBlockSync(this.client.getUrl(), contentType, version, containerName, blob, contentLength,
            maxSize, appendPosition, accept, body, requestOptions, Context.NONE);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<Void>> appendBlockFromUrlWithResponseAsync(String version, String containerName, String blob,
        long contentLength, String sourceUrl, String sourceRange, long maxSize, long appendPosition,
        RequestOptions requestOptions) {
        final String contentType = "application/xml";
        final String accept = "application/json";
        return FluxUtil.withContext(
            context -> service.appendBlockFromUrl(this.client.getUrl(), contentType, version, containerName, blob,
                contentLength, sourceUrl, sourceRange, maxSize, appendPosition, accept, requestOptions, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<Void> appendBlockFromUrlWithResponse(String version, String containerName, String blob,
        long contentLength, String sourceUrl, String sourceRange, long maxSize, long appendPosition,
        RequestOptions requestOptions) {
        final String contentType = "application/xml";
        final String accept = "application/json";
        return service.appendBlockFromUrlSync(this.client.getUrl(), contentType, version, containerName, blob,
            contentLength, sourceUrl, sourceRange, maxSize, appendPosition, accept, requestOptions, Context.NONE);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<Void>> sealWithResponseAsync(String version, String containerName, String blob,
        long appendPosition, RequestOptions requestOptions) {
        final String contentType = "application/xml";
        final String accept = "application/json";
        return FluxUtil.withContext(context -> service.seal(this.client.getUrl(), contentType, version, containerName,
            blob, appendPosition, accept, requestOptions, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<Void> sealWithResponse(String version, String containerName, String blob, long appendPosition,
        RequestOptions requestOptions) {
        final String contentType = "application/xml";
        final String accept = "application/json";
        return service.sealSync(this.client.getUrl(), contentType, version, containerName, blob, appendPosition, accept,
