...
import com.azure.resourcemanager.mongoclusters.fluent.models.FirewallRuleInner;
import com.azure.resourcemanager.mongoclusters.models.FirewallRule;
...
public final class FirewallRuleImpl implements FirewallRule, FirewallRule.Definition, FirewallRule.Update {
    ...
    public FirewallRule create() {
        this.innerObject = serviceManager.serviceClient().getFirewallRules().createOrUpdate(resourceGroupName,
            mongoClusterName, firewallRuleName, this.innerModel(), Context.NONE);
        return this;
    }

    public FirewallRule create(Context context) {
        this.innerObject = serviceManager.serviceClient().getFirewallRules().createOrUpdate(resourceGroupName,
            mongoClusterName, firewallRuleName, this.innerModel(), context);
        return this;
    }

    FirewallRuleImpl(String name, com.azure.resourcemanager.mongoclusters.MongoClusterManager serviceManager) {
    ...
    public FirewallRule refresh() {
        this.innerObject = serviceManager.serviceClient().getFirewallRules()
            .getWithResponse(resourceGroupName, mongoClusterName, firewallRuleName, Context.NONE).getValue();
        return this;
    }

    public FirewallRule refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getFirewallRules()
            .getWithResponse(resourceGroupName, mongoClusterName, firewallRuleName, context).getValue();
        return this;
    }
