...
public final class RegistrationImpl implements Registration, Registration.Definition, Registration.Update {
    ...
    public Registration create() {
        this.innerObject = serviceManager.serviceClient().getRegistrations()
            .createOrUpdateWithResponse(resourceGroup, registrationName, createToken, Context.NONE).getValue();
        return this;
    }

    public Registration create(Context context) {
        this.innerObject = serviceManager.serviceClient().getRegistrations()
            .createOrUpdateWithResponse(resourceGroup, registrationName, createToken, context).getValue();
        return this;
    }
    ...
    public Registration apply() {
        this.innerObject = serviceManager.serviceClient().getRegistrations()
            .updateWithResponse(resourceGroup, registrationName, updateToken, Context.NONE).getValue();
        return this;
    }

    public Registration apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getRegistrations()
            .updateWithResponse(resourceGroup, registrationName, updateToken, context).getValue();
        return this;
    }
    ...
    public Registration refresh() {
        this.innerObject = serviceManager.serviceClient().getRegistrations()
            .getByResourceGroupWithResponse(resourceGroup, registrationName, Context.NONE).getValue();
        return this;
    }

    public Registration refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getRegistrations()
            .getByResourceGroupWithResponse(resourceGroup, registrationName, context).getValue();
        return this;
    }
    ...
    public Response<Void> enableRemoteManagementWithResponse(Context context) {
        return serviceManager.registrations().enableRemoteManagementWithResponse(resourceGroup, registrationName,
            context);
    }
