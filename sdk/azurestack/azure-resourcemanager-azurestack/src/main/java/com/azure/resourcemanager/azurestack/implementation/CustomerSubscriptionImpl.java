...
public final class CustomerSubscriptionImpl implements CustomerSubscription, CustomerSubscription.Definition {
    ...
    public CustomerSubscription create() {
        this.innerObject = serviceManager.serviceClient().getCustomerSubscriptions().createWithResponse(resourceGroup,
            registrationName, customerSubscriptionName, this.innerModel(), Context.NONE).getValue();
        return this;
    }

    public CustomerSubscription create(Context context) {
        this.innerObject = serviceManager.serviceClient().getCustomerSubscriptions()
    ...
    public CustomerSubscription refresh() {
        this.innerObject = serviceManager.serviceClient().getCustomerSubscriptions()
            .getWithResponse(resourceGroup, registrationName, customerSubscriptionName, Context.NONE).getValue();
        return this;
    }

    public CustomerSubscription refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getCustomerSubscriptions()
            .getWithResponse(resourceGroup, registrationName, customerSubscriptionName, context).getValue();
        return this;
    }
