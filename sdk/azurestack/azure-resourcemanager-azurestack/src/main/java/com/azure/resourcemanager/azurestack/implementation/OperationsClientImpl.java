...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    OperationsClientImpl(AzureStackManagementClientImpl client) {
        this.service =
    ...
    /**
     * The interface defining all the services for AzureStackManagementClientOperations to be used by the proxy service
