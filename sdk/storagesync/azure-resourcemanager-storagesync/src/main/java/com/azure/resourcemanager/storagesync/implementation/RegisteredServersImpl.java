...
public final class RegisteredServersImpl implements RegisteredServers {
    ...
    public RegisteredServersImpl(RegisteredServersClient innerClient,
        com.azure.resourcemanager.storagesync.StoragesyncManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public PagedIterable<RegisteredServer> listByStorageSyncService(String resourceGroupName,
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new RegisteredServerImpl(inner1, this.manager()));
    }
    ...
    public Response<RegisteredServer> getWithResponse(String resourceGroupName, String storageSyncServiceName,
    ...
    public RegisteredServer getById(String id) {
        ...
        String serverId = ResourceManagerUtils.getValueFromIdByName(id, "registeredServers");
        if (serverId == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
                String.format("The resource ID '%s' is not valid. Missing path segment 'registeredServers'.", id)));
        }
