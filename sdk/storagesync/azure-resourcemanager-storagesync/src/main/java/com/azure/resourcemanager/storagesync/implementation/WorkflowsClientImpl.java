...
public final class WorkflowsClientImpl implements WorkflowsClient {
    ...
    public interface WorkflowsService {
        ...
        Mono<WorkflowsListByStorageSyncServiceResponse> listByStorageSyncService(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(StorageSyncApiErrorException.class)
        Mono<WorkflowsGetResponse> get(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @QueryParam("api-version") String apiVersion,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(StorageSyncApiErrorException.class)
        Mono<WorkflowsAbortResponse> abort(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @QueryParam("api-version") String apiVersion,
            @PathParam("storageSyncServiceName") String storageSyncServiceName,
            @PathParam("workflowId") String workflowId, @HeaderParam("Accept") String accept, Context context);
    ...
    private Mono<WorkflowsGetResponse> getWithResponseAsync(String resourceGroupName, String storageSyncServiceName,
        ...
        return FluxUtil
            .withContext(context -> service.get(this.client.getEndpoint(), this.client.getSubscriptionId(),
                resourceGroupName, this.client.getApiVersion(), storageSyncServiceName, workflowId, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<WorkflowsGetResponse> getWithResponseAsync(String resourceGroupName, String storageSyncServiceName,
        ...
        return service.get(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            this.client.getApiVersion(), storageSyncServiceName, workflowId, accept, context);
    }
    ...
    private Mono<WorkflowsAbortResponse> abortWithResponseAsync(String resourceGroupName, String storageSyncServiceName,
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.abort(this.client.getEndpoint(), this.client.getSubscriptionId(),
                resourceGroupName, this.client.getApiVersion(), storageSyncServiceName, workflowId, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<WorkflowsAbortResponse> abortWithResponseAsync(String resourceGroupName, String storageSyncServiceName,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.abort(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            this.client.getApiVersion(), storageSyncServiceName, workflowId, accept, context);
    }
