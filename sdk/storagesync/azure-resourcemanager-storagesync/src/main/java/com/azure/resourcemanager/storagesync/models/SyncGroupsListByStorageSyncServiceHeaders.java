...
/** The SyncGroupsListByStorageSyncServiceHeaders model. */
@Fluent
public final class SyncGroupsListByStorageSyncServiceHeaders {
    /*
    ...
    /**
     * Creates an instance of SyncGroupsListByStorageSyncServiceHeaders class.
     *
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public SyncGroupsListByStorageSyncServiceHeaders(HttpHeaders rawHeaders) {
