...
public final class PrivateEndpointConnectionImpl
    ...
    public PrivateEndpointConnectionImpl withExistingStorageSyncService(String resourceGroupName,
    ...
    public PrivateEndpointConnection create() {
        this.innerObject = serviceManager.serviceClient()
            ...
            .create(resourceGroupName, storageSyncServiceName, privateEndpointConnectionName, this.innerModel(),
                Context.NONE);
        return this;
    }
