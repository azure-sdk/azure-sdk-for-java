...
/** The RegisteredServersGetHeaders model. */
@Fluent
public final class RegisteredServersGetHeaders {
    /*
    ...
    /**
     * Creates an instance of RegisteredServersGetHeaders class.
     *
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public RegisteredServersGetHeaders(HttpHeaders rawHeaders) {
