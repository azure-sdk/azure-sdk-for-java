...
public final class ServerEndpointInner extends ProxyResource {
     ...
     * @return the ServerEndpointInner object itself.
     */
    public ServerEndpointInner withServerEndpointProvisioningStatus(
        ServerEndpointProvisioningStatus serverEndpointProvisioningStatus) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ServerEndpointProperties();
        }
        this.innerProperties().withServerEndpointProvisioningStatus(serverEndpointProvisioningStatus);
        return this;
    }
