...
public interface StorageSyncServicesClient {
    ...
    SyncPoller<PollResult<StorageSyncServiceInner>, StorageSyncServiceInner> beginCreate(String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    StorageSyncServicesGetByResourceGroupResponse getByResourceGroupWithResponse(String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<StorageSyncServiceInner>, StorageSyncServiceInner> beginUpdate(String resourceGroupName,
