...
public final class ServerEndpointsImpl implements ServerEndpoints {
    ...
    public ServerEndpointsImpl(ServerEndpointsClient innerClient,
        com.azure.resourcemanager.storagesync.StoragesyncManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public Response<ServerEndpoint> getWithResponse(String resourceGroupName, String storageSyncServiceName,
        String syncGroupName, String serverEndpointName, Context context) {
        ServerEndpointsGetResponse inner = this.serviceClient()
    ...
    public ServerEndpoint get(String resourceGroupName, String storageSyncServiceName, String syncGroupName,
    ...
    public PagedIterable<ServerEndpoint> listBySyncGroup(String resourceGroupName, String storageSyncServiceName,
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new ServerEndpointImpl(inner1, this.manager()));
    }
    ...
    public ServerEndpoint getById(String id) {
        ...
        String serverEndpointName = ResourceManagerUtils.getValueFromIdByName(id, "serverEndpoints");
        if (serverEndpointName == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
                String.format("The resource ID '%s' is not valid. Missing path segment 'serverEndpoints'.", id)));
        }
        return this
    ...
    public Response<ServerEndpoint> getByIdWithResponse(String id, Context context) {
        ...
        return this.getWithResponse(resourceGroupName, storageSyncServiceName, syncGroupName, serverEndpointName,
            context);
    }
