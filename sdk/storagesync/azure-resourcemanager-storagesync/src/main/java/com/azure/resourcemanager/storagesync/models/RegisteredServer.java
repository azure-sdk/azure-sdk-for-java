...
public interface RegisteredServer {
    ...
    /**
     * Gets the latestApplicationId property: Latest Server Application Id discovered from the server. It is not yet
     * applied.
     * 
    ...
    interface DefinitionStages {
         ...
         */
        interface WithCreate extends DefinitionStages.WithServerCertificate, DefinitionStages.WithAgentVersion,
            DefinitionStages.WithServerOSVersion, DefinitionStages.WithLastHeartBeat, DefinitionStages.WithServerRole,
            DefinitionStages.WithClusterId, DefinitionStages.WithClusterName, DefinitionStages.WithServerId,
            DefinitionStages.WithFriendlyName, DefinitionStages.WithApplicationId, DefinitionStages.WithIdentity {
            /**
        ...
        /**
         * The stage of the RegisteredServer definition allowing to specify applicationId.
         */
        interface WithApplicationId {
            /**
             * Specifies the applicationId property: Server ServicePrincipal Id.
             * 
             * @param applicationId Server ServicePrincipal Id.
             * @return the next definition stage.
             */
        ...
        /**
         * The stage of the RegisteredServer definition allowing to specify identity.
         */
        interface WithIdentity {
            /**
             * Specifies the identity property: Apply server with newly discovered ApplicationId if available..
             * 
             * @param identity Apply server with newly discovered ApplicationId if available.
             * @return the next definition stage.
             */
            WithCreate withIdentity(Boolean identity);
        }
    }
     ...
     */
    RegisteredServer.Update update();

    /**
     * The template for RegisteredServer update.
     */
    interface Update extends UpdateStages.WithIdentity, UpdateStages.WithApplicationId {
        /**
         * Executes the update request.
         * 
         * @return the updated resource.
         */
        RegisteredServer apply();
         ...
         * @return the updated resource.
         */
        RegisteredServer apply(Context context);
    }

    /**
     * The RegisteredServer update stages.
     */
    interface UpdateStages {
        /**
         * The stage of the RegisteredServer update allowing to specify identity.
         */
        interface WithIdentity {
            /**
             * Specifies the identity property: Apply server with newly discovered ApplicationId if available..
             ...
             * @return the next definition stage.
             */
            Update withIdentity(Boolean identity);
        }

        /**
         * The stage of the RegisteredServer update allowing to specify applicationId.
         */
        interface WithApplicationId {
            /**
             * Specifies the applicationId property: Apply server with new ServicePrincipal Id.
             * 
             * @param applicationId Apply server with new ServicePrincipal Id.
             * @return the next definition stage.
             */
            Update withApplicationId(String applicationId);
        }
    }
