...
public interface StorageSyncService {
    ...
    /**
     * Gets the identityType property: Identity Type.
     *
    ...
    /**
     * Gets the identityId property: Comma separated list of user assigned identities.
     *
    ...
    interface DefinitionStages {
        ...
        interface WithCreate
            extends DefinitionStages.WithTags,
                ...
                DefinitionStages.WithIdentityType,
                DefinitionStages.WithIdentityId {
            /**
        ...
        /** The stage of the StorageSyncService definition allowing to specify identityType. */
        interface WithIdentityType {
            /**
             * Specifies the identityType property: Identity Type.
             *
             * @param identityType Identity Type.
             * @return the next definition stage.
             */
            WithCreate withIdentityType(ManagedServiceIdentityType identityType);
        }
        /** The stage of the StorageSyncService definition allowing to specify identityId. */
        interface WithIdentityId {
            /**
             * Specifies the identityId property: Comma separated list of user assigned identities.
             *
             * @param identityId Comma separated list of user assigned identities.
             * @return the next definition stage.
             */
            WithCreate withIdentityId(String identityId);
        }
    }
    /**
    ...
    interface Update
        extends UpdateStages.WithTags,
            ...
            UpdateStages.WithIdentityType,
            UpdateStages.WithIdentityId {
        /**
    ...
    interface UpdateStages {
        ...
        /** The stage of the StorageSyncService update allowing to specify identityType. */
        interface WithIdentityType {
            /**
             * Specifies the identityType property: Identity Type.
             *
             ...
             * @return the next definition stage.
             */
            Update withIdentityType(ManagedServiceIdentityType identityType);
        }
        /** The stage of the StorageSyncService update allowing to specify identityId. */
        interface WithIdentityId {
            /**
             * Specifies the identityId property: Comma separated list of user assigned identities.
             *
             ...
             * @return the next definition stage.
             */
            Update withIdentityId(String identityId);
        }
    }
    /**
