...
public final class StorageSyncServicesImpl implements StorageSyncServices {
    ...
    public StorageSyncServicesImpl(StorageSyncServicesClient innerClient,
    ...
    public Response<StorageSyncService> getByResourceGroupWithResponse(String resourceGroupName,
    ...
    public PagedIterable<StorageSyncService> listByResourceGroup(String resourceGroupName) {
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new StorageSyncServiceImpl(inner1, this.manager()));
    }
