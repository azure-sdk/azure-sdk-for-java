...
/** The WorkflowsListByStorageSyncServiceHeaders model. */
@Fluent
public final class WorkflowsListByStorageSyncServiceHeaders {
    ...
    /**
     * Creates an instance of WorkflowsListByStorageSyncServiceHeaders class.
     *
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public WorkflowsListByStorageSyncServiceHeaders(HttpHeaders rawHeaders) {
