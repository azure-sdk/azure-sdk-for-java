...
public final class StorageSyncServicesClientImpl implements StorageSyncServicesClient {
    ...
    public interface StorageSyncServicesService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(StorageSyncApiErrorException.class)
        Mono<StorageSyncServicesGetByResourceGroupResponse> getByResourceGroup(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(StorageSyncApiErrorException.class)
        Mono<StorageSyncServicesListByResourceGroupResponse> listByResourceGroup(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(StorageSyncApiErrorException.class)
        Mono<StorageSyncServicesListResponse> list(@HostParam("$host") String endpoint,
    ...
    private Mono<Response<Flux<ByteBuffer>>> createWithResponseAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(context -> service.create(this.client.getEndpoint(), this.client.getSubscriptionId(),
                resourceGroupName, this.client.getApiVersion(), storageSyncServiceName, parameters, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> createWithResponseAsync(String resourceGroupName,
        String storageSyncServiceName, StorageSyncServiceCreateParameters parameters, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service.create(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            this.client.getApiVersion(), storageSyncServiceName, parameters, accept, context);
    }
    ...
    private PollerFlux<PollResult<StorageSyncServiceInner>, StorageSyncServiceInner> beginCreateAsync(
        ...
        return this.client.<StorageSyncServiceInner, StorageSyncServiceInner>getLroResult(mono,
            this.client.getHttpPipeline(), StorageSyncServiceInner.class, StorageSyncServiceInner.class, context);
    }
    ...
    public SyncPoller<PollResult<StorageSyncServiceInner>, StorageSyncServiceInner> beginCreate(
        String resourceGroupName, String storageSyncServiceName, StorageSyncServiceCreateParameters parameters) {
        return this.beginCreateAsync(resourceGroupName, storageSyncServiceName, parameters).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<StorageSyncServiceInner>, StorageSyncServiceInner> beginCreate(
        String resourceGroupName, String storageSyncServiceName, StorageSyncServiceCreateParameters parameters,
        Context context) {
        return this.beginCreateAsync(resourceGroupName, storageSyncServiceName, parameters, context).getSyncPoller();
    }
    ...
    private Mono<StorageSyncServiceInner> createAsync(String resourceGroupName, String storageSyncServiceName,
        ...
        return beginCreateAsync(resourceGroupName, storageSyncServiceName, parameters, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
        ...
        return FluxUtil
            .withContext(
                context -> service.getByResourceGroup(this.client.getEndpoint(), this.client.getSubscriptionId(),
                    resourceGroupName, storageSyncServiceName, this.client.getApiVersion(), accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<StorageSyncServicesGetByResourceGroupResponse>
        getByResourceGroupWithResponseAsync(String resourceGroupName, String storageSyncServiceName, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service.getByResourceGroup(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            storageSyncServiceName, this.client.getApiVersion(), accept, context);
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> updateWithResponseAsync(String resourceGroupName,
        String storageSyncServiceName, StorageSyncServiceUpdateParameters parameters, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    public SyncPoller<PollResult<StorageSyncServiceInner>, StorageSyncServiceInner>
        ...
        final StorageSyncServiceUpdateParameters parameters = null;
        return this.beginUpdateAsync(resourceGroupName, storageSyncServiceName, parameters).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<StorageSyncServiceInner>, StorageSyncServiceInner> beginUpdate(
        String resourceGroupName, String storageSyncServiceName, StorageSyncServiceUpdateParameters parameters,
        Context context) {
        return this.beginUpdateAsync(resourceGroupName, storageSyncServiceName, parameters, context).getSyncPoller();
    }
    ...
    private Mono<StorageSyncServiceInner> updateAsync(String resourceGroupName, String storageSyncServiceName,
        ...
        return beginUpdateAsync(resourceGroupName, storageSyncServiceName, parameters, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String storageSyncServiceName) {
        return this.beginDeleteAsync(resourceGroupName, storageSyncServiceName).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String storageSyncServiceName,
        Context context) {
        return this.beginDeleteAsync(resourceGroupName, storageSyncServiceName, context).getSyncPoller();
    }
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String storageSyncServiceName, Context context) {
        return beginDeleteAsync(resourceGroupName, storageSyncServiceName, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
