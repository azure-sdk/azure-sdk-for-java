...
public interface PrivateEndpointConnectionsClient {
    ...
    Response<PrivateEndpointConnectionInner> getWithResponse(String resourceGroupName, String storageSyncServiceName,
    ...
    PagedIterable<PrivateEndpointConnectionInner> listByStorageSyncService(String resourceGroupName,
