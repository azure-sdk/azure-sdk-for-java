...
public final class StorageSyncServicesListResponse
     ...
     */
    public StorageSyncServicesListResponse(HttpRequest request, int statusCode, HttpHeaders rawHeaders,
        StorageSyncServiceArray value, StorageSyncServicesListHeaders headers) {
