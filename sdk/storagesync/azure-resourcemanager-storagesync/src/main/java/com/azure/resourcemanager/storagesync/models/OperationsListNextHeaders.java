...
/** The OperationsListNextHeaders model. */
@Fluent
public final class OperationsListNextHeaders {
    /*
    ...
    /**
     * Creates an instance of OperationsListNextHeaders class.
     *
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public OperationsListNextHeaders(HttpHeaders rawHeaders) {
     ...
     * @return the OperationsListNextHeaders object itself.
     */
    public OperationsListNextHeaders withXMsRequestId(String xMsRequestId) {
     ...
     * @return the OperationsListNextHeaders object itself.
     */
    public OperationsListNextHeaders withXMsCorrelationRequestId(String xMsCorrelationRequestId) {
