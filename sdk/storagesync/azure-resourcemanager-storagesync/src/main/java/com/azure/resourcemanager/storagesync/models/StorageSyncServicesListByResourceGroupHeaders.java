...
/** The StorageSyncServicesListByResourceGroupHeaders model. */
@Fluent
public final class StorageSyncServicesListByResourceGroupHeaders {
    /*
    ...
    /**
     * Creates an instance of StorageSyncServicesListByResourceGroupHeaders class.
     *
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public StorageSyncServicesListByResourceGroupHeaders(HttpHeaders rawHeaders) {
