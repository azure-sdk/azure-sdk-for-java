...
public final class ServerEndpointImpl implements ServerEndpoint, ServerEndpoint.Definition, ServerEndpoint.Update {
    ...
    public ServerEndpointProvisioningStatus serverEndpointProvisioningStatus() {
        return this.innerModel().serverEndpointProvisioningStatus();
    }
    ...
    public ServerEndpointImpl withExistingSyncGroup(String resourceGroupName, String storageSyncServiceName,
    ...
    public ServerEndpoint create() {
        this.innerObject = serviceManager.serviceClient()
            .getServerEndpoints()
            .create(resourceGroupName, storageSyncServiceName, syncGroupName, serverEndpointName, createParameters,
                Context.NONE);
        return this;
    }
    ...
    public ServerEndpoint apply() {
        this.innerObject = serviceManager.serviceClient()
            .getServerEndpoints()
            .update(resourceGroupName, storageSyncServiceName, syncGroupName, serverEndpointName, updateParameters,
                Context.NONE);
        return this;
    }
    ...
    ServerEndpointImpl(ServerEndpointInner innerObject,
        ...
        this.serverEndpointName = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "serverEndpoints");
    }
    ...
    public void recallAction(RecallActionParameters parameters) {
        serviceManager.serverEndpoints()
