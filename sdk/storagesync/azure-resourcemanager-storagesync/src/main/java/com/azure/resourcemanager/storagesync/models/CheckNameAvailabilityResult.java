...
public interface CheckNameAvailabilityResult {
     ...
     * use. If true, the name is available. If false, the name has already been taken or invalid and cannot be used.
     * 
    ...
    /**
     * Gets the reason property: Gets the reason that a Storage Sync Service name could not be used. The Reason element
    ...
    /**
     * Gets the inner com.azure.resourcemanager.storagesync.fluent.models.CheckNameAvailabilityResultInner object.
     * 
