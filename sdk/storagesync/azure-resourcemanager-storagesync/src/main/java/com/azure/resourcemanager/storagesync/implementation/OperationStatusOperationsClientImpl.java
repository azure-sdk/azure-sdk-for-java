...
public final class OperationStatusOperationsClientImpl implements OperationStatusOperationsClient {
    ...
    OperationStatusOperationsClientImpl(MicrosoftStorageSyncImpl client) {
        this.service = RestProxy.create(OperationStatusOperationsService.class, client.getHttpPipeline(),
    ...
    public interface OperationStatusOperationsService {
        ...
        Mono<OperationStatusOperationsGetResponse> get(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @QueryParam("api-version") String apiVersion,
            @PathParam("locationName") String locationName, @PathParam("workflowId") String workflowId,
    ...
    private Mono<OperationStatusOperationsGetResponse> getWithResponseAsync(String resourceGroupName,
        String locationName, String workflowId, String operationId) {
        ...
        return FluxUtil
            .withContext(context -> service.get(this.client.getEndpoint(), this.client.getSubscriptionId(),
                resourceGroupName, this.client.getApiVersion(), locationName, workflowId, operationId, accept, context))
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<OperationStatusOperationsGetResponse> getWithResponseAsync(String resourceGroupName,
        String locationName, String workflowId, String operationId, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service.get(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            this.client.getApiVersion(), locationName, workflowId, operationId, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<OperationStatusInner> getAsync(String resourceGroupName, String locationName, String workflowId,
        String operationId) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public OperationStatusOperationsGetResponse getWithResponse(String resourceGroupName, String locationName,
        String workflowId, String operationId, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public OperationStatusInner get(String resourceGroupName, String locationName, String workflowId,
        String operationId) {
        return getWithResponse(resourceGroupName, locationName, workflowId, operationId, Context.NONE).getValue();
    }
}
