...
/** The SyncGroupsCreateHeaders model. */
@Fluent
public final class SyncGroupsCreateHeaders {
    /*
    ...
    /**
     * Creates an instance of SyncGroupsCreateHeaders class.
     *
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public SyncGroupsCreateHeaders(HttpHeaders rawHeaders) {
