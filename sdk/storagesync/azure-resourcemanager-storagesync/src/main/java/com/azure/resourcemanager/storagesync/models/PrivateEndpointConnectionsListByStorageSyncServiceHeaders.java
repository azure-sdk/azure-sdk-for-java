...
/** The PrivateEndpointConnectionsListByStorageSyncServiceHeaders model. */
@Fluent
public final class PrivateEndpointConnectionsListByStorageSyncServiceHeaders {
    ...
    /**
     * Creates an instance of PrivateEndpointConnectionsListByStorageSyncServiceHeaders class.
     *
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public PrivateEndpointConnectionsListByStorageSyncServiceHeaders(HttpHeaders rawHeaders) {
     ...
     * @return the PrivateEndpointConnectionsListByStorageSyncServiceHeaders object itself.
     */
    public PrivateEndpointConnectionsListByStorageSyncServiceHeaders withXMsRequestId(String xMsRequestId) {
     ...
     * @return the PrivateEndpointConnectionsListByStorageSyncServiceHeaders object itself.
     */
    public PrivateEndpointConnectionsListByStorageSyncServiceHeaders withXMsCorrelationRequestId(
