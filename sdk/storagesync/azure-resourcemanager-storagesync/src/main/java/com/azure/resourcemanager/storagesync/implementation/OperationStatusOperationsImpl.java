...
public final class OperationStatusOperationsImpl implements OperationStatusOperations {
    ...
    public OperationStatusOperationsImpl(OperationStatusOperationsClient innerClient,
        com.azure.resourcemanager.storagesync.StoragesyncManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public Response<OperationStatus> getWithResponse(String resourceGroupName, String locationName, String workflowId,
