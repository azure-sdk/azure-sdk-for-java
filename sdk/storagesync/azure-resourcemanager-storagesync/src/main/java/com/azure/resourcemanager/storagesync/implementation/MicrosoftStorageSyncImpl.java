...
public final class MicrosoftStorageSyncImpl implements MicrosoftStorageSync {
     ...
     */
    MicrosoftStorageSyncImpl(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter,
    ...
    private static final ClientLogger LOGGER = new ClientLogger(MicrosoftStorageSyncImpl.class);
}
