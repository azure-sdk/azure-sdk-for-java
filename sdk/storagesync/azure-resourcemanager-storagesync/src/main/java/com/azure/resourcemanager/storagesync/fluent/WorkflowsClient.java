...
public interface WorkflowsClient {
    ...
    WorkflowsGetResponse getWithResponse(String resourceGroupName, String storageSyncServiceName, String workflowId,
        Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    WorkflowsAbortResponse abortWithResponse(String resourceGroupName, String storageSyncServiceName, String workflowId,
        Context context);
