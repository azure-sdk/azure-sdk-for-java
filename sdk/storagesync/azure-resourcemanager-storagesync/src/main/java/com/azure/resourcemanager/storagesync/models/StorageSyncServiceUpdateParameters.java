...
public final class StorageSyncServiceUpdateParameters {
     ...
     * @return the StorageSyncServiceUpdateParameters object itself.
     */
    public StorageSyncServiceUpdateParameters withIdentityType(ManagedServiceIdentityType identityType) {
        if (this.innerProperties() == null) {
            this.innerProperties = new StorageSyncServiceUpdateProperties();
        }
     ...
     * @return the StorageSyncServiceUpdateParameters object itself.
     */
    public StorageSyncServiceUpdateParameters withIdentityId(String identityId) {
        if (this.innerProperties() == null) {
            this.innerProperties = new StorageSyncServiceUpdateProperties();
        }
