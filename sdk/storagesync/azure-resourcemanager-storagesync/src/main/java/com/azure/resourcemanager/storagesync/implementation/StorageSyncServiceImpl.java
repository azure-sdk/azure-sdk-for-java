...
public final class StorageSyncServiceImpl
    ...
    public String identityId() {
        return this.innerModel().identityId();
    }
    ...
    public StorageSyncServiceImpl withIdentityType(ManagedServiceIdentityType identityType) {
        if (isInCreateMode()) {
            this.createParameters.withIdentityType(identityType);
            return this;
        } else {
            this.updateParameters.withIdentityType(identityType);
            return this;
        }
    }

    public StorageSyncServiceImpl withIdentityId(String identityId) {
        if (isInCreateMode()) {
            this.createParameters.withIdentityId(identityId);
            return this;
        } else {
            this.updateParameters.withIdentityId(identityId);
            return this;
        }
    }
