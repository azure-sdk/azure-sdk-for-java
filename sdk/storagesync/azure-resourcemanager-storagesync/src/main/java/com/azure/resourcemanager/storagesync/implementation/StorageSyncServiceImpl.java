...
public final class StorageSyncServiceImpl
    ...
    public Boolean useIdentity() {
        return this.innerModel().useIdentity();
    }
    ...
    StorageSyncServiceImpl(StorageSyncServiceInner innerObject,
    ...
    public StorageSyncServiceImpl withIdentity(ManagedServiceIdentity identity) {
        if (isInCreateMode()) {
    ...
    public StorageSyncServiceImpl withUseIdentity(Boolean useIdentity) {
        if (isInCreateMode()) {
            this.createParameters.withUseIdentity(useIdentity);
            return this;
        } else {
            this.updateParameters.withUseIdentity(useIdentity);
            return this;
        }
    }
