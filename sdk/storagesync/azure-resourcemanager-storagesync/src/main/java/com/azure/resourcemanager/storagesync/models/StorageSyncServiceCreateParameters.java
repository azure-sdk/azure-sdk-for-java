...
public final class StorageSyncServiceCreateParameters {
     ...
     * @return the StorageSyncServiceCreateParameters object itself.
     */
    public StorageSyncServiceCreateParameters withIdentityType(ManagedServiceIdentityType identityType) {
        if (this.innerProperties() == null) {
            this.innerProperties = new StorageSyncServiceCreateParametersProperties();
        }
     ...
     * @return the StorageSyncServiceCreateParameters object itself.
     */
    public StorageSyncServiceCreateParameters withIdentityId(String identityId) {
        if (this.innerProperties() == null) {
            this.innerProperties = new StorageSyncServiceCreateParametersProperties();
        }
        this.innerProperties().withIdentityId(identityId);
        return this;
    }
