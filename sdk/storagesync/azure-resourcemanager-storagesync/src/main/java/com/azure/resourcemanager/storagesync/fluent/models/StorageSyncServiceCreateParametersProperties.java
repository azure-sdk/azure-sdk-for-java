...
public final class StorageSyncServiceCreateParametersProperties {
     ...
     * @return the StorageSyncServiceCreateParametersProperties object itself.
     */
    public StorageSyncServiceCreateParametersProperties withIdentityType(ManagedServiceIdentityType identityType) {
     ...
     * @return the StorageSyncServiceCreateParametersProperties object itself.
     */
    public StorageSyncServiceCreateParametersProperties withIdentityId(String identityId) {
