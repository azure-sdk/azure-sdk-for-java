...
public interface SyncGroupsClient {
    ...
    SyncGroupsCreateResponse createWithResponse(String resourceGroupName, String storageSyncServiceName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    SyncGroupInner create(String resourceGroupName, String storageSyncServiceName, String syncGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    SyncGroupsGetResponse getWithResponse(String resourceGroupName, String storageSyncServiceName, String syncGroupName,
        Context context);
