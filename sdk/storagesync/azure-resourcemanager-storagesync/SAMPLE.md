...
public final class RegisteredServersUpdateSamples {
    /*
     * x-ms-original-file: specification/storagesync/resource-manager/Microsoft.StorageSync/stable/2022-06-01/examples/RegisteredServers_Update.json
     */
    /**
...
public final class StorageSyncServicesCreateSamples {
    ...
    public static void storageSyncServicesCreate(com.azure.resourcemanager.storagesync.StoragesyncManager manager) {
        manager
            ...
            .withIdentityType(ManagedServiceIdentityType.SYSTEM_ASSIGNED_USER_ASSIGNED)
            .create();
    }
