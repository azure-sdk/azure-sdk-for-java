...
public final class ConnectedClusterCreateSamples {
    /*
     * x-ms-original-file:
     * specification/hybridkubernetes/resource-manager/Microsoft.Kubernetes/preview/2024-02-01-preview/examples/
    ...
    public static void
        ...
        manager.connectedClusters().listClusterUserCredentialWithResponse(
            "k8sc-rg", "testCluster", new ListClusterUserCredentialProperties()
                .withAuthenticationMethod(AuthenticationMethod.AAD).withClientProxy(true),
            com.azure.core.util.Context.NONE);
    }
