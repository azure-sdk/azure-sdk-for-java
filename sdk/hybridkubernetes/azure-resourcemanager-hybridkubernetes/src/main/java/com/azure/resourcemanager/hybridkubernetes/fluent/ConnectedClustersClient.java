...
public interface ConnectedClustersClient {
    ...
    SyncPoller<PollResult<ConnectedClusterInner>, ConnectedClusterInner> beginCreateOrUpdate(String resourceGroupName,
    ...
    ConnectedClusterInner createOrUpdate(String resourceGroupName, String clusterName,
