...
public final class ConnectedClustersClientImpl implements ConnectedClustersClient {
    ...
    private PollerFlux<PollResult<ConnectedClusterInner>, ConnectedClusterInner>
        beginCreateOrUpdateAsync(String resourceGroupName, String clusterName, ConnectedClusterInner connectedCluster) {
        Mono<Response<Flux<ByteBuffer>>> mono
            = createOrUpdateWithResponseAsync(resourceGroupName, clusterName, connectedCluster);
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<ConnectedClusterInner>, ConnectedClusterInner> beginCreateOrUpdateAsync(
        String resourceGroupName, String clusterName, ConnectedClusterInner connectedCluster, Context context) {
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono
            = createOrUpdateWithResponseAsync(resourceGroupName, clusterName, connectedCluster, context);
        return this.client.<ConnectedClusterInner, ConnectedClusterInner>getLroResult(mono,
    ...
    public SyncPoller<PollResult<ConnectedClusterInner>, ConnectedClusterInner>
        beginCreateOrUpdate(String resourceGroupName, String clusterName, ConnectedClusterInner connectedCluster) {
        return this.beginCreateOrUpdateAsync(resourceGroupName, clusterName, connectedCluster).getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<ConnectedClusterInner>, ConnectedClusterInner> beginCreateOrUpdate(
        String resourceGroupName, String clusterName, ConnectedClusterInner connectedCluster, Context context) {
        return this.beginCreateOrUpdateAsync(resourceGroupName, clusterName, connectedCluster, context).getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ConnectedClusterInner> createOrUpdateAsync(String resourceGroupName, String clusterName,
        ConnectedClusterInner connectedCluster) {
        return beginCreateOrUpdateAsync(resourceGroupName, clusterName, connectedCluster).last()
    ...
    private Mono<ConnectedClusterInner> createOrUpdateAsync(String resourceGroupName, String clusterName,
        ...
        return beginCreateOrUpdateAsync(resourceGroupName, clusterName, connectedCluster, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ConnectedClusterInner createOrUpdate(String resourceGroupName, String clusterName,
        ConnectedClusterInner connectedCluster) {
        return createOrUpdateAsync(resourceGroupName, clusterName, connectedCluster).block();
    }
    ...
    public ConnectedClusterInner createOrUpdate(String resourceGroupName, String clusterName,
        ConnectedClusterInner connectedCluster, Context context) {
        return createOrUpdateAsync(resourceGroupName, clusterName, connectedCluster, context).block();
    }
