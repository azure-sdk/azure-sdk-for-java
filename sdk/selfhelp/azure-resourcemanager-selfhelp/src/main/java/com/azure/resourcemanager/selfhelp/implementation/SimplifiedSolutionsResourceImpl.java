...
public final class SimplifiedSolutionsResourceImpl
    ...
    public SimplifiedSolutionsResource create() {
        this.innerObject = serviceManager.serviceClient().getSimplifiedSolutions().create(scope,
            simplifiedSolutionsResourceName, this.innerModel(), Context.NONE);
        return this;
    }

    public SimplifiedSolutionsResource create(Context context) {
        this.innerObject = serviceManager.serviceClient().getSimplifiedSolutions().create(scope,
            simplifiedSolutionsResourceName, this.innerModel(), context);
        return this;
    }
    ...
    public SimplifiedSolutionsResource refresh() {
        this.innerObject = serviceManager.serviceClient().getSimplifiedSolutions()
            .getWithResponse(scope, simplifiedSolutionsResourceName, Context.NONE).getValue();
        return this;
    }

    public SimplifiedSolutionsResource refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getSimplifiedSolutions()
            .getWithResponse(scope, simplifiedSolutionsResourceName, context).getValue();
        return this;
    }
