...
public final class DiscoveryNlpRequest {
    ...
    /*
     * ARM resource Id of the resource that is having the issue. Only applicable for Discovery Solution NLP
     * Subscription Scope.
     */
    ...
    public void validate() {
        if (issueSummary() == null) {
            throw LOGGER.logExceptionAsError(
                new IllegalArgumentException("Missing required property issueSummary in model DiscoveryNlpRequest"));
        }
    }
