...
public final class SapVirtualInstanceImpl
    ...
    public SapVirtualInstance apply() {
        this.innerObject = serviceManager.serviceClient().getSapVirtualInstances()
            .updateWithResponse(resourceGroupName, sapVirtualInstanceName, updateBody, Context.NONE).getValue();
        return this;
    }

    public SapVirtualInstance apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getSapVirtualInstances()
            .updateWithResponse(resourceGroupName, sapVirtualInstanceName, updateBody, context).getValue();
        return this;
    }
