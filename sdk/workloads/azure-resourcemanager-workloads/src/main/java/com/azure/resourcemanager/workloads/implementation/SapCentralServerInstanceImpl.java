...
public final class SapCentralServerInstanceImpl
    ...
    public SapCentralServerInstance apply() {
        this.innerObject = serviceManager.serviceClient().getSapCentralInstances().update(resourceGroupName,
            sapVirtualInstanceName, centralInstanceName, updateBody, Context.NONE);
        return this;
    }

    public SapCentralServerInstance apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getSapCentralInstances().update(resourceGroupName,
            sapVirtualInstanceName, centralInstanceName, updateBody, context);
        return this;
    }
