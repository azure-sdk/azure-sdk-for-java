...
public final class SapDatabaseInstanceImpl
    ...
    public SapDatabaseInstance apply() {
        this.innerObject = serviceManager.serviceClient().getSapDatabaseInstances().update(resourceGroupName,
            sapVirtualInstanceName, databaseInstanceName, updateBody, Context.NONE);
        return this;
    }

    public SapDatabaseInstance apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getSapDatabaseInstances().update(resourceGroupName,
            sapVirtualInstanceName, databaseInstanceName, updateBody, context);
        return this;
    }
