...
public interface WordpressInstancesClient {
    ...
    PagedIterable<WordpressInstanceResourceInner> list(String resourceGroupName, String phpWorkloadName);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<WordpressInstanceResourceInner> list(
    ...
    Response<WordpressInstanceResourceInner> getWithResponse(
        String resourceGroupName, String phpWorkloadName, Context context);
    ...
    SyncPoller<PollResult<WordpressInstanceResourceInner>, WordpressInstanceResourceInner> beginCreateOrUpdate(
