        ...
        if (location() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property location in model SapCentralServerInstanceInner"));
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(SapCentralServerInstanceInner.class);
