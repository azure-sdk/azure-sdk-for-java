...
public final class SapApplicationServerInstanceImpl implements SapApplicationServerInstance,
    ...
    public SapApplicationServerInstance apply() {
        this.innerObject = serviceManager.serviceClient().getSapApplicationServerInstances().update(resourceGroupName,
            sapVirtualInstanceName, applicationInstanceName, updateBody, Context.NONE);
        return this;
    }

    public SapApplicationServerInstance apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getSapApplicationServerInstances().update(resourceGroupName,
            sapVirtualInstanceName, applicationInstanceName, updateBody, context);
        return this;
    }
    ...
    public OperationStatusResult startInstance(Context context) {
        return serviceManager.sapApplicationServerInstances().startInstance(resourceGroupName, sapVirtualInstanceName,
            applicationInstanceName, context);
    }
