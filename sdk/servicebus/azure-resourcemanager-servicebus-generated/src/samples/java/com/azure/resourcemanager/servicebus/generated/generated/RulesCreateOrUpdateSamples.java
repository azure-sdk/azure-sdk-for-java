...
public final class RulesCreateOrUpdateSamples {
    /*
     * x-ms-original-file:
     * specification/servicebus/resource-manager/Microsoft.ServiceBus/preview/2022-10-01-preview/examples/Rules/
    ...
    public static void
        ...
        manager.rules().define("sdk-Rules-6571")
            ...
            .withCorrelationFilter(new CorrelationFilter().withProperties(mapOf("topicHint", "Crop"))).create();
    }
    ...
    public static void rulesCreateOrUpdate(com.azure.resourcemanager.servicebus.generated.ServiceBusManager manager) {
        manager.rules().define("sdk-Rules-6571").withExistingResourceGroup("resourceGroupName", "sdk-Namespace-1319",
            "sdk-Topics-2081", "sdk-Subscriptions-8691").create();
    }
    ...
    public static void rulesCreateSqlFilter(com.azure.resourcemanager.servicebus.generated.ServiceBusManager manager) {
        manager.rules().define("sdk-Rules-6571")
            .withExistingResourceGroup("resourceGroupName", "sdk-Namespace-1319", "sdk-Topics-2081",
                "sdk-Subscriptions-8691")
            .withFilterType(FilterType.SQL_FILTER).withSqlFilter(new SqlFilter().withSqlExpression("myproperty=test"))
            .create();
    }
