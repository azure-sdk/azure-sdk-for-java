...
public final class QueuesRegenerateKeysSamples {
    ...
    public static void
        ...
        manager.queues().regenerateKeysWithResponse("ArunMonocle", "sdk-namespace-7982", "sdk-Queues-2317",
            "sdk-AuthRules-5800", new RegenerateAccessKeyParameters().withKeyType(KeyType.PRIMARY_KEY),
