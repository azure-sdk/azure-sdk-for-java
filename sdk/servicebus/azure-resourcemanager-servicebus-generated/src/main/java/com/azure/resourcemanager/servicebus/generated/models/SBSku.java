...
public final class SBSku {
    ...
    /**
     * Get the capacity property: Messaging units for your service bus premium namespace. Valid capacities are {1, 2,
     * 4, 8, 16} multiples of your properties.premiumMessagingPartitions setting. For example, If
    ...
    /**
     * Set the capacity property: Messaging units for your service bus premium namespace. Valid capacities are {1, 2,
     * 4, 8, 16} multiples of your properties.premiumMessagingPartitions setting. For example, If
     * properties.premiumMessagingPartitions is 1 then possible capacity values are 1, 2, 4, 8, and 16. If
     * properties.premiumMessagingPartitions is 4 then possible capacity values are 4, 8, 16, 32 and 64.
     * 
