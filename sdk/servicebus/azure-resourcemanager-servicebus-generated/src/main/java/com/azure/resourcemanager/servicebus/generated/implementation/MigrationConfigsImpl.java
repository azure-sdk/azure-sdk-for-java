...
public final class MigrationConfigsImpl implements MigrationConfigs {
    ...
    public MigrationConfigsImpl(MigrationConfigsClient innerClient,
    ...
    public PagedIterable<MigrationConfigProperties> list(String resourceGroupName, String namespaceName) {
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new MigrationConfigPropertiesImpl(inner1, this.manager()));
    }
    ...
    public Response<MigrationConfigProperties> getWithResponse(String resourceGroupName, String namespaceName,
        MigrationConfigurationName configName, Context context) {
    ...
    public MigrationConfigProperties get(String resourceGroupName, String namespaceName,
    ...
    public Response<Void> completeMigrationWithResponse(String resourceGroupName, String namespaceName,
        MigrationConfigurationName configName, Context context) {
        return this.serviceClient().completeMigrationWithResponse(resourceGroupName, namespaceName, configName,
            context);
    }
    ...
    public MigrationConfigProperties getById(String id) {
        ...
        String configNameLocal = ResourceManagerUtils.getValueFromIdByName(id, "migrationConfigurations");
