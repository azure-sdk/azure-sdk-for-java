...
import com.azure.resourcemanager.servicebus.generated.models.Type;
...
public final class ArmDisasterRecoveryInner extends ProxyResource {
    ...
    /**
     * Get the type property: replication type.
     *
    ...
    /**
     * Set the type property: replication type.
     *
     * @param type the type value to set.
     * @return the ArmDisasterRecoveryInner object itself.
     */
    public ArmDisasterRecoveryInner withTypePropertiesType(Type type) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ArmDisasterRecoveryProperties();
        }
