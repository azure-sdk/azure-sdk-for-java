...
public final class MigrationConfigPropertiesImpl
    ...
    MigrationConfigPropertiesImpl(MigrationConfigPropertiesInner innerObject,
    ...
    public MigrationConfigProperties create() {
        this.innerObject = serviceManager.serviceClient().getMigrationConfigs()
    ...
    MigrationConfigPropertiesImpl(MigrationConfigurationName name,
        com.azure.resourcemanager.servicebus.generated.ServiceBusManager serviceManager) {
    ...
    public MigrationConfigProperties refresh() {
        this.innerObject = serviceManager.serviceClient().getMigrationConfigs()
            .getWithResponse(resourceGroupName, namespaceName, configName, Context.NONE).getValue();
        return this;
    }

    public MigrationConfigProperties refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getMigrationConfigs()
            .getWithResponse(resourceGroupName, namespaceName, configName, context).getValue();
        return this;
    }

    public Response<Void> completeMigrationWithResponse(Context context) {
        return serviceManager.migrationConfigs().completeMigrationWithResponse(resourceGroupName, namespaceName,
            configName, context);
    }
    ...
    public Response<Void> revertWithResponse(Context context) {
        return serviceManager.migrationConfigs().revertWithResponse(resourceGroupName, namespaceName, configName,
            context);
    }
