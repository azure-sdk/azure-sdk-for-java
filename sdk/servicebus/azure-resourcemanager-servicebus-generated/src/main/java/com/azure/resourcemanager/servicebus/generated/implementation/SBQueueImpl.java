...
public final class SBQueueImpl implements SBQueue, SBQueue.Definition, SBQueue.Update {
    ...
    public Long maxMessageSizeInKilobytes() {
        return this.innerModel().maxMessageSizeInKilobytes();
    }
    ...
    public SBQueue create() {
        this.innerObject = serviceManager.serviceClient().getQueues()
            .createOrUpdateWithResponse(resourceGroupName, namespaceName, queueName, this.innerModel(), Context.NONE)
            .getValue();
        return this;
    }
    ...
    SBQueueImpl(String name, com.azure.resourcemanager.servicebus.generated.ServiceBusManager serviceManager) {
    ...
    SBQueueImpl(SBQueueInner innerObject,
        ...
        this.queueName = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "queues");
    }

    public SBQueue refresh() {
        this.innerObject = serviceManager.serviceClient().getQueues()
            .getWithResponse(resourceGroupName, namespaceName, queueName, Context.NONE).getValue();
        return this;
    }

    public SBQueue refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getQueues()
            .getWithResponse(resourceGroupName, namespaceName, queueName, context).getValue();
        return this;
    }
    ...
    public SBQueueImpl withMaxMessageSizeInKilobytes(Long maxMessageSizeInKilobytes) {
        this.innerModel().withMaxMessageSizeInKilobytes(maxMessageSizeInKilobytes);
        return this;
    }
