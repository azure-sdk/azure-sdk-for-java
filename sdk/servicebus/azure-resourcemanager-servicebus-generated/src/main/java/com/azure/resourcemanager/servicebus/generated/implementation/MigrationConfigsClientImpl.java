...
public final class MigrationConfigsClientImpl implements MigrationConfigsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<MigrationConfigPropertiesInner> getAsync(String resourceGroupName, String namespaceName,
        MigrationConfigurationName configName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> completeMigrationAsync(String resourceGroupName, String namespaceName,
        MigrationConfigurationName configName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> revertAsync(String resourceGroupName, String namespaceName,
        MigrationConfigurationName configName) {
