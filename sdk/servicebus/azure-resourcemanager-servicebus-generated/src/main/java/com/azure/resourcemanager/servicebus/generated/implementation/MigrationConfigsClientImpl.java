...
public final class MigrationConfigsClientImpl implements MigrationConfigsClient {
    ...
    public SyncPoller<PollResult<MigrationConfigPropertiesInner>, MigrationConfigPropertiesInner>
        beginCreateAndStartMigration(
            ...
            MigrationConfigPropertiesInner parameters) {
        return this
            .beginCreateAndStartMigrationAsync(resourceGroupName, namespaceName, configName, parameters)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<MigrationConfigPropertiesInner>, MigrationConfigPropertiesInner>
        beginCreateAndStartMigration(
            ...
            Context context) {
        return this
            .beginCreateAndStartMigrationAsync(resourceGroupName, namespaceName, configName, parameters, context)
            .getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<MigrationConfigPropertiesInner> getAsync(
        String resourceGroupName, String namespaceName, MigrationConfigurationName configName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> completeMigrationAsync(
        String resourceGroupName, String namespaceName, MigrationConfigurationName configName) {
