...
public final class RuleImpl implements Rule, Rule.Definition, Rule.Update {
    ...
    public RuleImpl withExistingResourceGroup(String resourceGroupName, String namespaceName, String topicName,
    ...
    public Rule create() {
        this.innerObject = serviceManager.serviceClient().getRules().createOrUpdateWithResponse(resourceGroupName,
            namespaceName, topicName, subscriptionName, ruleName, this.innerModel(), Context.NONE).getValue();
        return this;
    }

    public Rule create(Context context) {
        this.innerObject = serviceManager.serviceClient().getRules().createOrUpdateWithResponse(resourceGroupName,
            namespaceName, topicName, subscriptionName, ruleName, this.innerModel(), context).getValue();
        return this;
    }

    RuleImpl(String name, com.azure.resourcemanager.servicebus.generated.ServiceBusManager serviceManager) {
    ...
    RuleImpl(RuleInner innerObject, com.azure.resourcemanager.servicebus.generated.ServiceBusManager serviceManager) {
        ...
        this.subscriptionName = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "subscriptions");
        this.ruleName = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "rules");
    }

    public Rule refresh() {
        this.innerObject = serviceManager.serviceClient().getRules()
