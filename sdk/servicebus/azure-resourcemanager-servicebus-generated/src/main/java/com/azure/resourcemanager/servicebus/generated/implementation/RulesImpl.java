...
public final class RulesImpl implements Rules {
    ...
    public PagedIterable<Rule> listBySubscriptions(String resourceGroupName, String namespaceName, String topicName,
    ...
    public PagedIterable<Rule> listBySubscriptions(String resourceGroupName, String namespaceName, String topicName,
        ...
        PagedIterable<RuleInner> inner = this.serviceClient().listBySubscriptions(resourceGroupName, namespaceName,
            topicName, subscriptionName, skip, top, context);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new RuleImpl(inner1, this.manager()));
    }
    ...
    public Response<Rule> getWithResponse(String resourceGroupName, String namespaceName, String topicName,
        String subscriptionName, String ruleName, Context context) {
        Response<RuleInner> inner = this.serviceClient().getWithResponse(resourceGroupName, namespaceName, topicName,
            subscriptionName, ruleName, context);
        if (inner != null) {
    ...
    public Rule get(String resourceGroupName, String namespaceName, String topicName, String subscriptionName,
        String ruleName) {
        RuleInner inner
    ...
    public Rule getById(String id) {
        ...
        String subscriptionName = ResourceManagerUtils.getValueFromIdByName(id, "subscriptions");
    ...
    public Response<Void> deleteByIdWithResponse(String id, Context context) {
        ...
        return this.deleteWithResponse(resourceGroupName, namespaceName, topicName, subscriptionName, ruleName,
            context);
    }
