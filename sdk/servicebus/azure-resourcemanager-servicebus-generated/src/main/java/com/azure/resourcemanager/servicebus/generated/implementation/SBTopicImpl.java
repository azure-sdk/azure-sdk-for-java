...
public final class SBTopicImpl implements SBTopic, SBTopic.Definition, SBTopic.Update {
    ...
    public SBTopic create() {
        this.innerObject = serviceManager.serviceClient().getTopics()
            .createOrUpdateWithResponse(resourceGroupName, namespaceName, topicName, this.innerModel(), Context.NONE)
            .getValue();
        return this;
    }
    ...
    SBTopicImpl(SBTopicInner innerObject,
    ...
    public SBTopicImpl withMaxMessageSizeInKilobytes(Long maxMessageSizeInKilobytes) {
