...
public final class SubscriptionsImpl implements Subscriptions {
    ...
    public PagedIterable<SBSubscription> listByTopic(String resourceGroupName, String namespaceName, String topicName) {
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new SBSubscriptionImpl(inner1, this.manager()));
    }
    ...
    public Response<SBSubscription> createOrUpdateWithResponse(String resourceGroupName, String namespaceName,
        String topicName, String subscriptionName, SBSubscriptionInner parameters, Context context) {
        Response<SBSubscriptionInner> inner = this.serviceClient().createOrUpdateWithResponse(resourceGroupName,
            namespaceName, topicName, subscriptionName, parameters, context);
        if (inner != null) {
    ...
    public SBSubscription createOrUpdate(String resourceGroupName, String namespaceName, String topicName,
        String subscriptionName, SBSubscriptionInner parameters) {
        SBSubscriptionInner inner = this.serviceClient().createOrUpdate(resourceGroupName, namespaceName, topicName,
            subscriptionName, parameters);
        if (inner != null) {
    ...
    public Response<Void> deleteWithResponse(String resourceGroupName, String namespaceName, String topicName,
        ...
        return this.serviceClient().deleteWithResponse(resourceGroupName, namespaceName, topicName, subscriptionName,
            context);
    }
    ...
    public Response<SBSubscription> getWithResponse(String resourceGroupName, String namespaceName, String topicName,
        String subscriptionName, Context context) {
        Response<SBSubscriptionInner> inner = this.serviceClient().getWithResponse(resourceGroupName, namespaceName,
            topicName, subscriptionName, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
                new SBSubscriptionImpl(inner.getValue(), this.manager()));
        } else {
    ...
    public SBSubscription get(String resourceGroupName, String namespaceName, String topicName,
