...
public final class ServiceBusManagementClientBuilder {
     ...
     */
    public ServiceBusManagementClientBuilder subscriptionId(String subscriptionId) {
     ...
     * @return the ServiceBusManagementClientBuilder.
     */
    public ServiceBusManagementClientBuilder environment(AzureEnvironment environment) {
     ...
     * @return the ServiceBusManagementClientBuilder.
     */
    public ServiceBusManagementClientBuilder defaultPollInterval(Duration defaultPollInterval) {
     ...
     * @return the ServiceBusManagementClientBuilder.
     */
    public ServiceBusManagementClientBuilder serializerAdapter(SerializerAdapter serializerAdapter) {
