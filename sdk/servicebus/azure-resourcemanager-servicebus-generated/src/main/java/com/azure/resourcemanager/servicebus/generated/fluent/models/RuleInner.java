...
public final class RuleInner extends ProxyResource {
    ...
    /**
     * Get the action property: Represents the filter actions which are allowed for the transformation of a message
    ...
    /**
     * Set the action property: Represents the filter actions which are allowed for the transformation of a message
     * that have been matched by a filter expression.
     * 
