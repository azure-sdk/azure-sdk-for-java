...
public final class NamespacesImpl implements Namespaces {
    ...
    public PagedIterable<SBNamespace> list() {
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new SBNamespaceImpl(inner1, this.manager()));
    }
    ...
    public Response<SBNamespace> getByResourceGroupWithResponse(String resourceGroupName, String namespaceName,
        Context context) {
    ...
    public PagedIterable<NetworkRuleSet> listNetworkRuleSets(String resourceGroupName, String namespaceName) {
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new NetworkRuleSetImpl(inner1, this.manager()));
    }
    ...
    public Response<SBAuthorizationRule> getAuthorizationRuleWithResponse(String resourceGroupName,
        ...
        Response<SBAuthorizationRuleInner> inner = this.serviceClient()
    ...
    public SBAuthorizationRule getAuthorizationRule(String resourceGroupName, String namespaceName,
    ...
    public Response<CheckNameAvailabilityResult> checkNameAvailabilityWithResponse(CheckNameAvailability parameters,
        Context context) {
