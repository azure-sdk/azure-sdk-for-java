...
public final class SupportTicketDetailsInner extends ProxyResource {
    ...
    /**
     * Reads an instance of SupportTicketDetailsInner from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of SupportTicketDetailsInner if the JsonReader was pointing to an instance of it, or null if
     * it was pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the SupportTicketDetailsInner.
     */
    public static SupportTicketDetailsInner fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            SupportTicketDetailsInner deserializedSupportTicketDetailsInner = new SupportTicketDetailsInner();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("id".equals(fieldName)) {
                    deserializedSupportTicketDetailsInner.id = reader.getString();
                } else if ("name".equals(fieldName)) {
                    deserializedSupportTicketDetailsInner.name = reader.getString();
                } else if ("type".equals(fieldName)) {
                    deserializedSupportTicketDetailsInner.type = reader.getString();
                } else if ("properties".equals(fieldName)) {
                    deserializedSupportTicketDetailsInner.innerProperties
                        = SupportTicketDetailsProperties.fromJson(reader);
                } else {
                    reader.skipChildren();
                }
            }

            return deserializedSupportTicketDetailsInner;
        });
    }
}
