 ...
 */
@Fluent
public class ClassificationService implements JsonSerializable<ClassificationService> {
    /*
    ...
    /**
     * Set the serviceId property: Azure resource Id of the service.
     * 
     * @param serviceId the serviceId value to set.
     * @return the ClassificationService object itself.
     */
    ClassificationService withServiceId(String serviceId) {
     ...
     * @return the ClassificationService object itself.
     */
    ClassificationService withDisplayName(String displayName) {
