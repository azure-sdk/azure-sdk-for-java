...
public final class NetworkFunctionsImpl implements NetworkFunctions {
    ...
    public PagedIterable<NetworkFunctionResource> list() {
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new NetworkFunctionResourceImpl(inner1, this.manager()));
    }
    ...
    public Response<NetworkFunctionResource> getByResourceGroupWithResponse(String resourceGroupName,
    ...
    public Response<Void> deleteByResourceGroupWithResponse(String resourceGroupName, String networkFunctionName,
        Context context) {
