...
public interface NetworkFunctionsClient {
    ...
    Response<NetworkFunctionResourceInner> getByResourceGroupWithResponse(String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<NetworkFunctionResourceInner> updateTagsWithResponse(String resourceGroupName, String networkFunctionName,
