...
public final class NetworkFunctionsClientImpl implements NetworkFunctionsClient {
     ...
     */
    private final MicrosoftMobilePacketCoreNetworkFunctionResourceForTestingImpl client;
     ...
     */
    NetworkFunctionsClientImpl(MicrosoftMobilePacketCoreNetworkFunctionResourceForTestingImpl client) {
        this.service
     ...
     * MicrosoftMobilePacketCoreNetworkFunctionResourceForTestingNetworkFunctions to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{$host}")
    ...
    public interface NetworkFunctionsService {
        ...
        Mono<Response<NetworkFunctionResourceListResult>> list(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<NetworkFunctionResourceListResult>> listByResourceGroup(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<NetworkFunctionResourceInner>> getByResourceGroup(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<NetworkFunctionResourceInner>> updateTags(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("networkFunctionName") String networkFunctionName,
    ...
    private Mono<PagedResponse<NetworkFunctionResourceInner>> listSinglePageAsync() {
        ...
        return FluxUtil
            ...
            .<PagedResponse<NetworkFunctionResourceInner>>map(res -> new PagedResponseBase<>(res.getRequest(),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<NetworkFunctionResourceInner>>
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<NetworkFunctionResourceInner>> getByResourceGroupWithResponseAsync(String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<NetworkFunctionResourceInner> getByResourceGroupAsync(String resourceGroupName,
        String networkFunctionName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<NetworkFunctionResourceInner> getByResourceGroupWithResponse(String resourceGroupName,
        String networkFunctionName, Context context) {
    ...
    private PollerFlux<PollResult<NetworkFunctionResourceInner>, NetworkFunctionResourceInner> beginCreateOrUpdateAsync(
        ...
        return this.client.<NetworkFunctionResourceInner, NetworkFunctionResourceInner>getLroResult(mono,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<NetworkFunctionResourceInner> createOrUpdateAsync(String resourceGroupName, String networkFunctionName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<NetworkFunctionResourceInner>> updateTagsWithResponseAsync(String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<NetworkFunctionResourceInner> updateTagsAsync(String resourceGroupName, String networkFunctionName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<NetworkFunctionResourceInner> updateTagsWithResponse(String resourceGroupName,
        String networkFunctionName, NetworkFunctionResourceTagsUpdate properties, Context context) {
