...
/**
 * The interface for MicrosoftMobilePacketCoreNetworkFunctionResourceForTesting class.
 */
public interface MicrosoftMobilePacketCoreNetworkFunctionResourceForTesting {
    /**
