...
public interface NetworkFunctions {
     ...
     */
    Response<NetworkFunctionResource> getByResourceGroupWithResponse(String resourceGroupName,
     ...
     */
    Response<Void> deleteByResourceGroupWithResponse(String resourceGroupName, String networkFunctionName,
        Context context);
