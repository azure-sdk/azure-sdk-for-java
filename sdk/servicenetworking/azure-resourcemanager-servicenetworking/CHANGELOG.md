...
#### `models.AssociationSubnetUpdate` was removed
...
* `models.AssociationSubnetUpdate subnet()` -> `models.AssociationSubnet subnet()`
...
* `withSubnet(models.AssociationSubnet)` was added
* `toJson(com.azure.json.JsonWriter)` was added
* `fromJson(com.azure.json.JsonReader)` was added
