...
public final class TrafficControllerUpdateTests {
    ...
    public void testDeserialize() throws Exception {
        TrafficControllerUpdate model = BinaryData.fromString(
            "{\"tags\":{\"abhjybi\":\"hzrvqd\"},\"properties\":{\"securityPolicyConfigurations\":{\"wafSecurityPolicy\":{\"id\":\"qfbow\"}}}}")
            .toObject(TrafficControllerUpdate.class);
        Assertions.assertEquals("hzrvqd", model.tags().get("abhjybi"));
        Assertions.assertEquals("qfbow", model.properties().securityPolicyConfigurations().wafSecurityPolicy().id());
    }

    @org.junit.jupiter.api.Test
    public void testSerialize() throws Exception {
        TrafficControllerUpdate model = new TrafficControllerUpdate().withTags(mapOf("abhjybi", "hzrvqd"))
            .withProperties(new TrafficControllerUpdateProperties().withSecurityPolicyConfigurations(
                new SecurityPolicyConfigurations().withWafSecurityPolicy(new WafSecurityPolicy().withId("qfbow"))));
