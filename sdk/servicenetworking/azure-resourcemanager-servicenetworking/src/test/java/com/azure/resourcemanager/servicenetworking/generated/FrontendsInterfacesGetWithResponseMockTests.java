...
public final class FrontendsInterfacesGetWithResponseMockTests {
    ...
    public void testGetWithResponse() throws Exception {
        String responseStr
            = "{\"properties\":{\"fqdn\":\"i\",\"provisioningState\":\"Succeeded\"},\"location\":\"ceoveilovno\",\"tags\":{\"bkc\":\"jfcn\"},\"id\":\"x\",\"name\":\"hbttkphyw\",\"type\":\"nv\"}";
        ...
        Frontend response = manager.frontendsInterfaces()
            .getWithResponse("tkncwsc", "svlxotogtwrup", "sx", com.azure.core.util.Context.NONE)
            .getValue();

        Assertions.assertEquals("ceoveilovno", response.location());
        Assertions.assertEquals("jfcn", response.tags().get("bkc"));
    }
}
