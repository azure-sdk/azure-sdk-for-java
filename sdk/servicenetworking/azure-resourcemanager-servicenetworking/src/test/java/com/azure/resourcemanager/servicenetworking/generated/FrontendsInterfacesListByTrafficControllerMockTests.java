...
public final class FrontendsInterfacesListByTrafficControllerMockTests {
    ...
    public void testListByTrafficController() throws Exception {
        String responseStr
            = "{\"value\":[{\"properties\":{\"fqdn\":\"pabgyeps\",\"provisioningState\":\"Accepted\"},\"location\":\"zq\",\"tags\":{\"jidsuyonobglaoc\":\"ywpmueefjzwfqkq\",\"udxytlmoyrx\":\"xtccmg\",\"qj\":\"wfudwpzntxhdzhl\",\"bkyvp\":\"hckfrlhrx\"},\"id\":\"ca\",\"name\":\"uzbpzkafku\",\"type\":\"b\"}]}";
        ...
        PagedIterable<Frontend> response = manager.frontendsInterfaces()
            .listByTrafficController("t", "qnermclfplphoxu", com.azure.core.util.Context.NONE);

        Assertions.assertEquals("zq", response.iterator().next().location());
        Assertions.assertEquals("ywpmueefjzwfqkq", response.iterator().next().tags().get("jidsuyonobglaoc"));
    }
}
