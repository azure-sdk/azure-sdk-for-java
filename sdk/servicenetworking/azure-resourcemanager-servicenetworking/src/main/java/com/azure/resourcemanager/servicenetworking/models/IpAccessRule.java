...
public final class IpAccessRule implements JsonSerializable<IpAccessRule> {
    ...
    /*
     * The priority of the rule. The value can be between 1 and 400. The priority number must be unique for each rule in
    ...
    /**
     * Get the priority property: The priority of the rule. The value can be between 1 and 400. The priority number must
    ...
    /**
     * Set the priority property: The priority of the rule. The value can be between 1 and 400. The priority number must
     * be unique for each rule in the collection. The lower the priority number, the higher the priority of the rule.
     * 
