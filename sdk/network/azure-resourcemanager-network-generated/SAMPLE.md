                    ...
                    .withExclusions(
                        Arrays
                            .asList(
                                ...
                                new OwaspCrsExclusionEntry()
                                    .withMatchVariable(OwaspCrsExclusionEntryMatchVariable.REQUEST_HEADER_NAMES)
                                    .withSelectorMatchOperator(OwaspCrsExclusionEntrySelectorMatchOperator.EQUALS_ANY)
                                    .withExclusionManagedRuleSets(
                                        Arrays
                                            .asList(
                                                new ExclusionManagedRuleSet()
                                ...
                                new OwaspCrsExclusionEntry()
                                    .withMatchVariable(
                                        OwaspCrsExclusionEntryMatchVariable.fromString("RequestHeadersKeys"))
                                    .withSelectorMatchOperator(OwaspCrsExclusionEntrySelectorMatchOperator.EQUALS_ANY)))
                    .withManagedRuleSets(
                        Arrays
                            .asList(
