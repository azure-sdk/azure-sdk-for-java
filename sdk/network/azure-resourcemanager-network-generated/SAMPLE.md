        ...
        manager
            ...
            .withIntrusionDetection(
                new FirewallPolicyIntrusionDetection()
                    .withProfile(FirewallPolicyIntrusionDetectionProfileType.BALANCED)
        ...
        manager
            ...
            .patchWithResponse(
                ...
                new SignaturesOverridesInner()
                    ...
                    .withType("Microsoft.Network/firewallPolicies/intrusionDetectionSignaturesOverrides")
                    .withProperties(
...
public final class FirewallPolicyRuleCollectionGroupsCreateOrUpdateSamples {
     ...
     */
    /**
     * Sample code: Create Firewall Policy Rule Collection Group With custom HTTP headers.
     *
     * @param manager Entry point to NetworkManager.
     */
    public static void createFirewallPolicyRuleCollectionGroupWithCustomHTTPHeaders(
        com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager
            .firewallPolicyRuleCollectionGroups()
            .define("ruleCollectionGroup1")
