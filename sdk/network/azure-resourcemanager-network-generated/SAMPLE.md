...
import com.azure.resourcemanager.network.generated.models.PacketCaptureStorageSettings;
import com.azure.resourcemanager.network.generated.models.PcProtocol;
import com.azure.resourcemanager.network.generated.models.StorageAuthentication;
import java.util.Arrays;
...
public final class PacketCapturesCreateSamples {
    ...
    /*
     * x-ms-original-file: specification/network/resource-manager/Microsoft.Network/stable/2024-05-01/examples/
     * NetworkWatcherPacketCaptureCreateWithManagedIdentityInfo.json
     */
    /**
     * Sample code: Create packet capture with managed identity info.
     * 
     * @param manager Entry point to NetworkManager.
     */
    public static void
        createPacketCaptureWithManagedIdentityInfo(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.packetCaptures()
            .create("rg1", "nw1", "pc1", new PacketCapture()
                .withTarget("/subscriptions/subid/resourceGroups/rg2/providers/Microsoft.Compute/virtualMachines/vm1")
                .withBytesToCapturePerPacket(10000L)
                ...
                .withStorageLocation(new PacketCaptureStorageLocation()
                    ...
                    .withFilePath("D:\\capture\\pc1.cap"))
                .withStorageSettings(
                    new PacketCaptureStorageSettings().withStorageAuthentication(new StorageAuthentication()))
                .withFilters(Arrays.asList()), com.azure.core.util.Context.NONE);
    }
}
```
