...
- [Restart](#networkvirtualappliances_restart)
...
public final class NetworkVirtualAppliancesRestartSamples {
     ...
     * @param manager Entry point to NetworkManager.
     */
    public static void restartSpecificNetworkVirtualApplianceVMsInVMScaleSet(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.networkVirtualAppliances().restartWithResponse("rg1", "nva", null, com.azure.core.util.Context.NONE);
    }
     ...
     * @param manager Entry point to NetworkManager.
     */
    public static void restartAllNetworkVirtualApplianceVMsInVMScaleSet(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.networkVirtualAppliances().restartWithResponse("rg1", "nva", null, com.azure.core.util.Context.NONE);
    }
}
```
