...
public final class SubnetsCreateOrUpdateSamples {
    ...
    /*
     * x-ms-original-file: specification/network/resource-manager/Microsoft.Network/stable/2024-01-01/examples/SubnetCreateServiceEndpointNetworkIdentifier.json
     */
    /**
    ...
    public static void createSubnetWithServiceEndpointsWithNetworkIdentifier(
        ...
        manager.subnets()
            ...
            .withExistingVirtualNetwork("subnet-test", "vnetname")
            .withAddressPrefix("10.0.0.0/16")
            .withServiceEndpoints(Arrays.asList(new ServiceEndpointPropertiesFormatInner()
                .withService("Microsoft.Storage")
                .withNetworkIdentifier(new PublicIpAddressInner().withId(
    ...
    public static void
        ...
        manager.subnets()
            ...
            .withServiceEndpoints(
                Arrays.asList(new ServiceEndpointPropertiesFormatInner().withService("Microsoft.Storage")))
            .create();
    }
...
import com.azure.resourcemanager.network.generated.models.CertificateAuthentication;
import com.azure.resourcemanager.network.generated.models.ConnectionAuthenticationType;
...
import com.azure.resourcemanager.network.generated.models.BgpSettings;
import com.azure.resourcemanager.network.generated.models.IpAllocationMethod;
import com.azure.resourcemanager.network.generated.models.ManagedServiceIdentityAutoGenerated;
import com.azure.resourcemanager.network.generated.models.ManagedServiceIdentityType;
import com.azure.resourcemanager.network.generated.models.RadiusServer;
import com.azure.resourcemanager.network.generated.models.UserAssignedIdentity;
import com.azure.resourcemanager.network.generated.models.VirtualNetworkGatewayIpConfiguration;
import com.azure.resourcemanager.network.generated.models.VirtualNetworkGatewaySku;
import com.azure.resourcemanager.network.generated.models.VirtualNetworkGatewaySkuName;
import com.azure.resourcemanager.network.generated.models.VirtualNetworkGatewaySkuTier;
...
public final class VirtualNetworkGatewaysCreateOrUpdateSamples {
    ...
    public static void updateVirtualNetworkGateway(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.virtualNetworkGateways()
            ...
            .withRegion("centralus")
            .withExistingResourceGroup("rg1")
            .withIdentity(new ManagedServiceIdentityAutoGenerated().withType(ManagedServiceIdentityType.USER_ASSIGNED)
                .withUserAssignedIdentities(mapOf(
                    "/subscriptions/subid/resourceGroups/rg1/providers/Microsoft.ManagedIdentity/userAssignedIdentities/identity1",
...
public final class VirtualNetworkPeeringsGetSamples {
     ...
     * @param manager Entry point to NetworkManager.
     */
    public static void getSubnetPeering(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.virtualNetworkPeerings().getWithResponse("peerTest", "vnet1", "peer", com.azure.core.util.Context.NONE);
    }
     ...
     * @param manager Entry point to NetworkManager.
     */
    public static void getV6SubnetPeering(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.virtualNetworkPeerings().getWithResponse("peerTest", "vnet1", "peer", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class VirtualNetworksCreateOrUpdateSamples {
    ...
    public static void
        ...
        manager.virtualNetworks()
            ...
            .withSubnets(
                Arrays
                    .asList(new SubnetInner().withName("test-1")
                        .withAddressPrefix("10.0.0.0/16")
                        .withServiceEndpoints(Arrays
                            .asList(new ServiceEndpointPropertiesFormatInner().withService("Microsoft.Storage")))))
            .create();
    }
}
```
