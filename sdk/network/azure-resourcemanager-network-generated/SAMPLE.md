...
- [AllocateAzureResource](#ipampool_allocateazureresource)
- [AllocateNonAzureResource](#ipampool_allocatenonazureresource)
- [AssociateResources](#ipampool_associateresources)
- [Create](#ipampool_create)
- [Delete](#ipampool_delete)
- [DisassociateResources](#ipampool_disassociateresources)
- [Get](#ipampool_get)
- [List](#ipampool_list)
- [ListAssociation](#ipampool_listassociation)
- [Update](#ipampool_update)
- [Usage](#ipampool_usage)
...
public final class ApplicationGatewayWafDynamicManifestsDefaultGetSamples {
    ...
    public static void getsWAFDefaultManifest(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager
            .applicationGatewayWafDynamicManifestsDefaults()
    ...
    public static void updateFirewallPolicyTags(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        FirewallPolicy resource =
            manager
                .firewallPolicies()
                .getByResourceGroupWithResponse(
                    "myResourceGroup", "firewallPolicy", null, com.azure.core.util.Context.NONE)
                .getValue();
...
### IpamPool_AllocateAzureResource
...
### IpamPool_AllocateNonAzureResource
...
### IpamPool_DisassociateResources
    ...
    public static void getVMSSPublicIP(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager
            ...
            .getVirtualMachineScaleSetPublicIpAddressWithResponse(
                "vmss-tester", "vmss1", "1", "nic1", "ip1", "pub1", null, com.azure.core.util.Context.NONE);
    }
}
```
    ...
    public static void updateServiceEndpointPolicyTags(
        ...
        ServiceEndpointPolicy resource =
            manager
                .serviceEndpointPolicies()
                .getByResourceGroupWithResponse(
                    "rg1", "testServiceEndpointPolicy", null, com.azure.core.util.Context.NONE)
                .getValue();
        resource.update().withTags(mapOf("tag1", "value1", "tag2", "value2")).apply();
    }
    ...
    public static void setVirtualNetworkGatewayConnectionSharedKey(
        ...
        manager
            ...
            .setSharedKey(
                "rg1",
                "connS2S",
                new ConnectionSharedKeyInner().withValue("AzureAbc123"),
                com.azure.core.util.Context.NONE);
    }
}
```
...
public final class VirtualNetworkGatewaysCreateOrUpdateSamples {
     ...
     * @param manager Entry point to NetworkManager.
     */
    public static void updateVirtualNetworkScalableGateway(
        com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager
            .virtualNetworkGateways()
            .define("ergw")
