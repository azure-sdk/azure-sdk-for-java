...
public final class ApplicationGatewaysStopSamples {
    /*
     * x-ms-original-file: specification/network/resource-manager/Microsoft.Network/stable/2022-05-01/examples/ApplicationGatewayStop.json
     */
    /**
...
public final class AzureFirewallsPacketCaptureSamples {
    /*
     * x-ms-original-file: specification/network/resource-manager/Microsoft.Network/stable/2022-05-01/examples/AzureFirewallPacketCapture.json
     */
    /**
     * Sample code: Run Azure Firewall Packet Capture.
     *
     * @param manager Entry point to NetworkManager.
     */
    public static void runAzureFirewallPacketCapture(
        com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager
            .azureFirewalls()
            .packetCapture(
                ...
                new FirewallPacketCaptureParameters()
                    ...
                    .withFlags(
                        Arrays.asList(new AzureFirewallPacketCaptureFlags(), new AzureFirewallPacketCaptureFlags()))
                    .withFilters(
                        Arrays
                            .asList(
...
public final class FirewallPoliciesListByResourceGroupSamples {
    /*
     * x-ms-original-file: specification/network/resource-manager/Microsoft.Network/stable/2022-05-01/examples/FirewallPolicyListByResourceGroup.json
     */
    /**
...
public final class PublicIpAddressesListByResourceGroupSamples {
    /*
     * x-ms-original-file: specification/network/resource-manager/Microsoft.Network/stable/2022-05-01/examples/PublicIpAddressList.json
     */
    /**
...
public final class ServiceEndpointPoliciesListByResourceGroupSamples {
    /*
     * x-ms-original-file: specification/network/resource-manager/Microsoft.Network/stable/2022-05-01/examples/ServiceEndpointPolicyList.json
     */
    /**
