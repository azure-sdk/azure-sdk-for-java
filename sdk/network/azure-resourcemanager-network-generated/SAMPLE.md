...
public final class BastionHostsCreateOrUpdateSamples {
    ...
    /*
     * x-ms-original-file: specification/network/resource-manager/Microsoft.Network/stable/2022-07-01/examples/BastionHostQuickConnectPut.json
     */
    /**
     * Sample code: Create QuickConnect Bastion Host.
     *
     * @param manager Entry point to NetworkManager.
     */
    public static void createQuickConnectBastionHost(
        com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager
            .bastionHosts()
            .define("bastionhosttenant")
...
public final class BastionHostsDeleteSamples {
    /*
     * x-ms-original-file: specification/network/resource-manager/Microsoft.Network/stable/2022-07-01/examples/BastionHostQuickConnectDelete.json
     */
    /**
     * Sample code: Delete QuickConnect Bastion Host.
     *
     * @param manager Entry point to NetworkManager.
     */
    public static void deleteQuickConnectBastionHost(
        com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.bastionHosts().delete("rg2", "bastionhosttenant", Context.NONE);
    }
