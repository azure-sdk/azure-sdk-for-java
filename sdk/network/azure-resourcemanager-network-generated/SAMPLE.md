...
- [GetSessionRecordingSasUrl](#resourceprovider_getsessionrecordingsasurl)
...
- [SetSessionRecordingSasUrl](#resourceprovider_setsessionrecordingsasurl)
...
public final class AdminRuleCollectionsCreateOrUpdateSamples {
     ...
     */
    public static void
        createOrUpdateAnAdminRuleCollection(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.adminRuleCollections()
...
public final class AdminRuleCollectionsDeleteSamples {
     ...
     */
    public static void
        deletesAnAdminRuleCollection(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.adminRuleCollections()
...
public final class AdminRuleCollectionsListSamples {
     ...
     */
    public static void
        listSecurityAdminRuleCollections(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.adminRuleCollections()
...
public final class ApplicationGatewayPrivateEndpointConnectionsDeleteSamples {
    ...
    public static void deleteApplicationGatewayPrivateEndpointConnection(
        ...
        manager.applicationGatewayPrivateEndpointConnections()
...
public final class ApplicationGatewayWafDynamicManifestsDefaultGetSamples {
    ...
    public static void getsWAFDefaultManifest(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.applicationGatewayWafDynamicManifestsDefaults()
    ...
    public static void createApplicationGateway(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.applicationGateways()
            ...
            .withSku(new ApplicationGatewaySku().withName(ApplicationGatewaySkuName.STANDARD_V2)
                ...
                .withCapacity(3))
            .withGatewayIpConfigurations(Arrays.asList(new ApplicationGatewayIpConfiguration().withName("appgwipc")
            ...
            .withSslCertificates(Arrays.asList(
                new ApplicationGatewaySslCertificate().withName("sslcert")
                    .withData("****")
                    .withPassword("fakeTokenPlaceholder"),
                new ApplicationGatewaySslCertificate().withName("sslcert2")
                    .withKeyVaultSecretId("fakeTokenPlaceholder")))
            ...
            .withBackendAddressPools(Arrays.asList(new ApplicationGatewayBackendAddressPool().withName("appgwpool")
                .withBackendAddresses(Arrays.asList(new ApplicationGatewayBackendAddress().withIpAddress("10.0.1.1"),
            ...
            .withSslProfiles(Arrays.asList(new ApplicationGatewaySslProfile().withName("sslProfile1")
                ...
                .withSslPolicy(new ApplicationGatewaySslPolicy().withPolicyType(ApplicationGatewaySslPolicyType.CUSTOM)
                    .withCipherSuites(
            ...
            .withRequestRoutingRules(Arrays.asList(new ApplicationGatewayRequestRoutingRule().withName("appgwrule")
            ...
            .withRewriteRuleSets(
                Arrays
                    .asList(
                        new ApplicationGatewayRewriteRuleSet().withName("rewriteRuleSet1")
...
public final class ApplicationGatewaysGetSslPredefinedPolicySamples {
     ...
     */
    public static void
        getAvailableSslPredefinedPolicyByName(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.applicationGateways()
...
public final class ApplicationGatewaysListSamples {
     ...
     */
    public static void
        listsAllApplicationGatewaysInASubscription(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class ApplicationGatewaysListAvailableSslPredefinedPoliciesSamples {
     ...
     */
    public static void
        getAvailableSslPredefinedPolicies(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class ApplicationGatewaysUpdateTagsSamples {
     ...
     */
    public static void
        updateApplicationGatewayTags(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        ApplicationGateway resource = manager.applicationGateways()
...
public final class ApplicationSecurityGroupsCreateOrUpdateSamples {
     ...
     */
    public static void
        createApplicationSecurityGroup(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.applicationSecurityGroups()
            .define("test-asg")
            .withRegion("westus")
            .withExistingResourceGroup("rg1")
            .create();
...
public final class ApplicationSecurityGroupsDeleteSamples {
     ...
     */
    public static void
        deleteApplicationSecurityGroup(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class ApplicationSecurityGroupsListSamples {
     ...
     */
    public static void
        listAllApplicationSecurityGroups(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class ApplicationSecurityGroupsListByResourceGroupSamples {
     ...
     */
    public static void
        listLoadBalancersInResourceGroup(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class ApplicationSecurityGroupsUpdateTagsSamples {
     ...
     */
    public static void
        updateApplicationSecurityGroupTags(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        ApplicationSecurityGroup resource = manager.applicationSecurityGroups()
            .getByResourceGroupWithResponse("rg1", "test-asg", com.azure.core.util.Context.NONE)
            .getValue();
        resource.update().withTags(mapOf("tag1", "value1", "tag2", "value2")).apply();
    }
...
public final class AvailablePrivateEndpointTypesListSamples {
     ...
     */
    public static void
        getAvailablePrivateEndpointTypes(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class AvailablePrivateEndpointTypesListByResourceGroupSamples {
    ...
    public static void getAvailablePrivateEndpointTypesInTheResourceGroup(
        com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.availablePrivateEndpointTypes()
...
public final class AvailableResourceGroupDelegationsListSamples {
     ...
     */
    public static void
        getAvailableDelegationsInTheResourceGroup(com.azure.resourcemanager.network.generated.NetworkManager manager) {
    ...
    public static void
        ...
        manager.azureFirewalls()
            ...
            .withApplicationRuleCollections(
                Arrays.asList(new AzureFirewallApplicationRuleCollection().withName("apprulecoll")
                    .withPriority(110)
            ...
            .withNatRuleCollections(Arrays.asList(new AzureFirewallNatRuleCollection().withName("natrulecoll")
                .withPriority(112)
            ...
            .withNetworkRuleCollections(
                Arrays
                    .asList(
                        new AzureFirewallNetworkRuleCollection().withName("netrulecoll")
                            .withPriority(112)
                            .withAction(new AzureFirewallRCAction().withType(AzureFirewallRCActionType.DENY))
                            .withRules(Arrays.asList(
...
public final class AzureFirewallsGetByResourceGroupSamples {
     ...
     */
    public static void
        getAzureFirewallWithAdditionalProperties(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.azureFirewalls()
     ...
     */
    public static void
        getAzureFirewallWithIpGroups(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.azureFirewalls()
            .getByResourceGroupWithResponse("rg1", "azurefirewall", com.azure.core.util.Context.NONE);
    }
     ...
     */
    public static void
        getAzureFirewallWithManagementSubnet(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.azureFirewalls()
            .getByResourceGroupWithResponse("rg1", "azurefirewall", com.azure.core.util.Context.NONE);
    }
...
public final class AzureFirewallsListSamples {
     ...
     */
    public static void
        listAllAzureFirewallsForAGivenSubscription(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class AzureFirewallsUpdateTagsSamples {
    ...
    public static void updateAzureFirewallTags(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        AzureFirewall resource = manager.azureFirewalls()
            .getByResourceGroupWithResponse("azfwtest", "fw1", com.azure.core.util.Context.NONE)
            .getValue();
        resource.update().withTags(mapOf("tag1", "value1", "tag2", "value2")).apply();
    }
...
public final class BastionHostsCreateOrUpdateSamples {
    ...
    public static void createDeveloperBastionHost(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.bastionHosts()
            .define("bastionhostdeveloper")
            .withRegion((String) null)
            .withExistingResourceGroup("rg2")
            .withIpConfigurations(Arrays.asList())
            .withVirtualNetwork(new SubResource()
                .withId("/subscriptions/subid/resourceGroups/rg2/providers/Microsoft.Network/virtualNetworks/vnet2"))
...
public final class BastionHostsListSamples {
     ...
     */
    public static void
        listAllBastionHostsForAGivenSubscription(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class BastionHostsListByResourceGroupSamples {
     ...
     */
    public static void
        listAllBastionHostsForAGivenResourceGroup(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class BastionHostsUpdateTagsSamples {
    ...
    public static void patchBastionHost(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        BastionHost resource = manager.bastionHosts()
            .getByResourceGroupWithResponse("rg1", "bastionhosttenant", com.azure.core.util.Context.NONE)
            .getValue();
        resource.update().withTags(mapOf("tag1", "value1", "tag2", "value2")).apply();
    }
...
public final class ConfigurationPolicyGroupsCreateOrUpdateSamples {
    ...
    public static void configurationPolicyGroupPut(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.configurationPolicyGroups()
            .define("policyGroup1")
...
public final class ConfigurationPolicyGroupsDeleteSamples {
     ...
     */
    public static void
        configurationPolicyGroupDelete(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.configurationPolicyGroups()
...
public final class ConnectionMonitorsUpdateTagsSamples {
    ...
    public static void updateConnectionMonitorTags(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        ConnectionMonitorResult resource = manager.connectionMonitors()
...
public final class ConnectivityConfigurationsDeleteSamples {
     ...
     */
    public static void
        connectivityConfigurationsDelete(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.connectivityConfigurations()
...
public final class ConnectivityConfigurationsGetSamples {
     ...
     */
    public static void
        connectivityConfigurationsGet(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.connectivityConfigurations()
...
public final class ConnectivityConfigurationsListSamples {
     ...
     */
    public static void
        connectivityConfigurationsList(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.connectivityConfigurations()
...
public final class CustomIpPrefixesCreateOrUpdateSamples {
     ...
     */
    public static void
        createCustomIPPrefixAllocationMethod(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.customIpPrefixes()
...
public final class CustomIpPrefixesListByResourceGroupSamples {
     ...
     */
    public static void
        listResourceGroupCustomIPPrefixes(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class CustomIpPrefixesUpdateTagsSamples {
    ...
    public static void updatePublicIPAddressTags(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        CustomIpPrefix resource = manager.customIpPrefixes()
            .getByResourceGroupWithResponse("rg1", "test-customipprefix", null, com.azure.core.util.Context.NONE)
            .getValue();
        resource.update().withTags(mapOf("tag1", "value1", "tag2", "value2")).apply();
    }
...
public final class DdosCustomPoliciesUpdateTagsSamples {
    ...
    public static void dDoSCustomPolicyUpdateTags(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        DdosCustomPolicy resource = manager.ddosCustomPolicies()
            .getByResourceGroupWithResponse("rg1", "test-ddos-custom-policy", com.azure.core.util.Context.NONE)
            .getValue();
        resource.update().withTags(mapOf("tag1", "value1", "tag2", "value2")).apply();
    }
...
public final class DdosProtectionPlansListByResourceGroupSamples {
     ...
     */
    public static void
        listDDoSProtectionPlansInResourceGroup(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class DdosProtectionPlansUpdateTagsSamples {
     ...
     */
    public static void
        dDoSProtectionPlanUpdateTags(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        DdosProtectionPlan resource = manager.ddosProtectionPlans()
            .getByResourceGroupWithResponse("rg1", "test-plan", com.azure.core.util.Context.NONE)
            .getValue();
        resource.update().withTags(mapOf("tag1", "value1", "tag2", "value2")).apply();
    }
...
public final class DscpConfigurationCreateOrUpdateSamples {
    ...
    public static void createDSCPConfiguration(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.dscpConfigurations()
            .define("mydscpconfig")
            .withRegion("eastus")
            .withExistingResourceGroup("rg1")
            .withQosDefinitionCollection(Arrays.asList(
                new QosDefinition().withMarkings(Arrays.asList(1))
                    .withSourceIpRanges(Arrays.asList(new QosIpRange().withStartIp("127.0.0.1").withEndIp("127.0.0.2")))
                ...
                new QosDefinition().withMarkings(Arrays.asList(2))
                    .withSourceIpRanges(Arrays.asList(new QosIpRange().withStartIp("12.0.0.1").withEndIp("12.0.0.2")))
                    .withDestinationIpRanges(
...
public final class ExpressRouteCircuitAuthorizationsCreateOrUpdateSamples {
     ...
     */
    public static void
        createExpressRouteCircuitAuthorization(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.expressRouteCircuitAuthorizations()
...
public final class ExpressRouteCircuitAuthorizationsDeleteSamples {
     ...
     */
    public static void
        deleteExpressRouteCircuitAuthorization(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.expressRouteCircuitAuthorizations()
...
public final class ExpressRouteCircuitConnectionsCreateOrUpdateSamples {
     ...
     */
    public static void
        expressRouteCircuitConnectionCreate(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.expressRouteCircuitConnections()
            ...
            .withExpressRouteCircuitPeering(new SubResource().withId(
...
public final class ExpressRouteCircuitConnectionsListSamples {
     ...
     */
    public static void
        listExpressRouteCircuitConnection(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.expressRouteCircuitConnections()
...
public final class ExpressRouteCircuitPeeringsCreateOrUpdateSamples {
     ...
     */
    public static void
        createExpressRouteCircuitPeerings(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.expressRouteCircuitPeerings()
...
public final class ExpressRouteCircuitPeeringsGetSamples {
     ...
     */
    public static void
        getExpressRouteCircuitPeering(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.expressRouteCircuitPeerings()
...
public final class ExpressRouteCircuitPeeringsListSamples {
     ...
     */
    public static void
        listExpressRouteCircuitPeerings(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class ExpressRouteCircuitsCreateOrUpdateSamples {
    ...
    public static void createExpressRouteCircuitOnExpressRoutePort(
        ...
        manager.expressRouteCircuits()
            ...
            .withEnableDirectPortRateLimit(false)
            .create();
    }
}
```
...
public final class ExpressRouteCircuitsGetPeeringStatsSamples {
     ...
     */
    public static void
        getExpressRouteCircuitPeeringTrafficStats(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.expressRouteCircuits()
...
public final class ExpressRouteCircuitsGetStatsSamples {
     ...
     */
    public static void
        getExpressRouteCircuitTrafficStats(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class ExpressRouteCircuitsListSamples {
     ...
     */
    public static void
        listExpressRouteCircuitsInASubscription(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class ExpressRouteCircuitsListByResourceGroupSamples {
     ...
     */
    public static void
        listExpressRouteCircuitsInAResourceGroup(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class ExpressRouteCircuitsUpdateTagsSamples {
     ...
     */
    public static void
        updateExpressRouteCircuitTags(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        ExpressRouteCircuit resource = manager.expressRouteCircuits()
            .getByResourceGroupWithResponse("ertest", "er1", com.azure.core.util.Context.NONE)
            .getValue();
        resource.update().withTags(mapOf("tag1", "value1", "tag2", "value2")).apply();
    }
...
public final class ExpressRouteConnectionsCreateOrUpdateSamples {
     ...
     */
    public static void
        expressRouteConnectionCreate(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class ExpressRouteConnectionsDeleteSamples {
     ...
     */
    public static void
        expressRouteConnectionDelete(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.expressRouteConnections()
...
public final class ExpressRouteCrossConnectionPeeringsCreateOrUpdateSamples {
    ...
    public static void expressRouteCrossConnectionBgpPeeringCreate(
        com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.expressRouteCrossConnectionPeerings()
...
public final class ExpressRouteCrossConnectionPeeringsGetSamples {
     ...
     */
    public static void
        getExpressRouteCrossConnectionBgpPeering(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.expressRouteCrossConnectionPeerings()
...
public final class ExpressRouteCrossConnectionPeeringsListSamples {
     ...
     */
    public static void
        expressRouteCrossConnectionBgpPeeringList(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.expressRouteCrossConnectionPeerings()
...
public final class ExpressRouteCrossConnectionsCreateOrUpdateSamples {
     ...
     */
    public static void
        updateExpressRouteCrossConnection(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.expressRouteCrossConnections()
...
public final class ExpressRouteCrossConnectionsListSamples {
     ...
     */
    public static void
        expressRouteCrossConnectionList(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class ExpressRouteCrossConnectionsListRoutesTableSamples {
     ...
     */
    public static void
        getExpressRouteCrossConnectionsRouteTable(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.expressRouteCrossConnections()
...
public final class ExpressRouteCrossConnectionsUpdateTagsSamples {
     ...
     */
    public static void
        updateExpressRouteCrossConnectionTags(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        ExpressRouteCrossConnection resource = manager.expressRouteCrossConnections()
            .getByResourceGroupWithResponse("CrossConnection-SiliconValley", "<circuitServiceKey>",
                com.azure.core.util.Context.NONE)
            .getValue();
        resource.update().withTags(mapOf("tag1", "value1", "tag2", "value2")).apply();
...
public final class ExpressRouteGatewaysListBySubscriptionSamples {
     ...
     */
    public static void
        expressRouteGatewayListBySubscription(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class ExpressRouteGatewaysUpdateTagsSamples {
    ...
    public static void expressRouteGatewayUpdate(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        ExpressRouteGateway resource = manager.expressRouteGateways()
            .getByResourceGroupWithResponse("resourceGroupName", "expressRouteGatewayName",
                com.azure.core.util.Context.NONE)
            .getValue();
        resource.update().withTags(mapOf("tag1", "value1", "tag2", "value2")).apply();
...
public final class ExpressRoutePortAuthorizationsCreateOrUpdateSamples {
     ...
     */
    public static void
        createExpressRoutePortAuthorization(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.expressRoutePortAuthorizations()
            .define("authorizatinName")
...
public final class ExpressRoutePortAuthorizationsDeleteSamples {
     ...
     */
    public static void
        deleteExpressRoutePortAuthorization(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.expressRoutePortAuthorizations()
...
public final class ExpressRoutePortAuthorizationsGetSamples {
     ...
     */
    public static void
        getExpressRoutePortAuthorization(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.expressRoutePortAuthorizations()
...
public final class ExpressRoutePortAuthorizationsListSamples {
     ...
     */
    public static void
        listExpressRoutePortAuthorization(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class ExpressRoutePortsListByResourceGroupSamples {
     ...
     */
    public static void
        expressRoutePortListByResourceGroup(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class ExpressRoutePortsUpdateTagsSamples {
    ...
    public static void expressRoutePortUpdateTags(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        ExpressRoutePort resource = manager.expressRoutePorts()
...
public final class ExpressRoutePortsLocationsGetSamples {
     ...
     */
    public static void
        expressRoutePortsLocationGet(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class ExpressRoutePortsLocationsListSamples {
     ...
     */
    public static void
        expressRoutePortsLocationList(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class ExpressRouteProviderPortsLocationListSamples {
     ...
     */
    public static void
        expressRouteProviderPortList(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class FirewallPoliciesUpdateTagsSamples {
    ...
    public static void updateFirewallPolicyTags(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        FirewallPolicy resource = manager.firewallPolicies()
            .getByResourceGroupWithResponse("myResourceGroup", "firewallPolicy", null, com.azure.core.util.Context.NONE)
            .getValue();
...
public final class FirewallPolicyDraftsCreateOrUpdateSamples {
    /*
     * x-ms-original-file: specification/network/resource-manager/Microsoft.Network/stable/2024-01-01/examples/FirewallPolicyDraftPut.json
     */
    /**
...
public final class FirewallPolicyDraftsGetSamples {
    /*
     * x-ms-original-file: specification/network/resource-manager/Microsoft.Network/stable/2024-01-01/examples/FirewallPolicyDraftGet.json
     */
    /**
...
public final class FirewallPolicyIdpsSignaturesFilterValuesListSamples {
     ...
     */
    public static void querySignatureOverrides(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.firewallPolicyIdpsSignaturesFilterValues()
...
public final class FirewallPolicyRuleCollectionGroupDraftsCreateOrUpdateSamples {
    /*
     * x-ms-original-file: specification/network/resource-manager/Microsoft.Network/stable/2024-01-01/examples/FirewallPolicyRuleCollectionGroupDraftPut.json
     */
    /**
...
public final class FirewallPolicyRuleCollectionGroupsCreateOrUpdateSamples {
     ...
     */
    public static void
        createFirewallPolicyRuleCollectionGroup(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.firewallPolicyRuleCollectionGroups()
            .define("ruleCollectionGroup1")
            .withExistingFirewallPolicy("rg1", "firewallPolicy")
            .withPriority(100)
            .withRuleCollections(
                Arrays.asList(new FirewallPolicyFilterRuleCollection().withName("Example-Filter-Rule-Collection")
                    .withPriority(100)
                    .withAction(new FirewallPolicyFilterRuleCollectionAction()
                        .withType(FirewallPolicyFilterRuleCollectionActionType.DENY))
                    .withRules(Arrays.asList(new NetworkRule().withName("network-rule1")
     ...
     */
    public static void
        createFirewallPolicyNatRuleCollectionGroup(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.firewallPolicyRuleCollectionGroups()
            .define("ruleCollectionGroup1")
            .withExistingFirewallPolicy("rg1", "firewallPolicy")
            .withPriority(100)
    ...
    public static void createFirewallPolicyRuleCollectionGroupWithHttpHeaderToInsert(
        ...
        manager.firewallPolicyRuleCollectionGroups()
            ...
            .withRuleCollections(
                Arrays
                    .asList(
                        new FirewallPolicyFilterRuleCollection().withName("Example-Filter-Rule-Collection")
                            .withAction(new FirewallPolicyFilterRuleCollectionAction()
                                .withType(FirewallPolicyFilterRuleCollectionActionType.ALLOW))
                            .withRules(
                                Arrays.asList(new ApplicationRule().withName("rule1")
...
public final class FirewallPolicyRuleCollectionGroupsDeleteSamples {
     ...
     */
    public static void
        deleteFirewallPolicyRuleCollectionGroup(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.firewallPolicyRuleCollectionGroups()
...
public final class FirewallPolicyRuleCollectionGroupsGetSamples {
     ...
     */
    public static void
        getFirewallPolicyNatRuleCollectionGroup(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.firewallPolicyRuleCollectionGroups()
            .getWithResponse("rg1", "firewallPolicy", "ruleCollectionGroup1", com.azure.core.util.Context.NONE);
    }
     ...
     */
    public static void
        getFirewallPolicyRuleCollectionGroup(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.firewallPolicyRuleCollectionGroups()
            .getWithResponse("rg1", "firewallPolicy", "ruleCollectionGroup1", com.azure.core.util.Context.NONE);
    }
...
public final class FlowLogsUpdateTagsSamples {
    ...
    public static void updateFlowLogTags(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        FlowLog resource
            = manager.flowLogs().getWithResponse("rg1", "nw", "fl", com.azure.core.util.Context.NONE).getValue();
        resource.update().withTags(mapOf("tag1", "value1", "tag2", "value2")).apply();
    }
...
public final class HubVirtualNetworkConnectionsCreateOrUpdateSamples {
     ...
     */
    public static void
        hubVirtualNetworkConnectionPut(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.hubVirtualNetworkConnections()
...
public final class HubVirtualNetworkConnectionsDeleteSamples {
     ...
     */
    public static void
        hubVirtualNetworkConnectionDelete(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.hubVirtualNetworkConnections()
...
public final class HubVirtualNetworkConnectionsGetSamples {
     ...
     */
    public static void
        hubVirtualNetworkConnectionGet(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.hubVirtualNetworkConnections()
...
public final class HubVirtualNetworkConnectionsListSamples {
     ...
     */
    public static void
        hubVirtualNetworkConnectionList(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class InboundSecurityRuleOperationCreateOrUpdateSamples {
    ...
    public static void createNetworkVirtualApplianceInboundSecurityRules(
        ...
        manager.inboundSecurityRuleOperations()
            ...
            .withRuleType(InboundSecurityRuleType.PERMANENT)
...
public final class IpAllocationsListByResourceGroupSamples {
     ...
     */
    public static void
        listIpAllocationsInResourceGroup(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class IpAllocationsUpdateTagsSamples {
    ...
    public static void updateVirtualNetworkTags(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        IpAllocation resource = manager.ipAllocations()
            .getByResourceGroupWithResponse("rg1", "test-ipallocation", null, com.azure.core.util.Context.NONE)
            .getValue();
        resource.update().withTags(mapOf("tag1", "value1", "tag2", "value2")).apply();
    }
...
public final class IpGroupsUpdateGroupsSamples {
    ...
    public static void updateIpGroups(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        IpGroup resource = manager.ipGroups()
            .getByResourceGroupWithResponse("myResourceGroup", "ipGroups1", null, com.azure.core.util.Context.NONE)
            .getValue();
        resource.update().withTags(mapOf("key1", "fakeTokenPlaceholder", "key2", "fakeTokenPlaceholder")).apply();
    }
...
public final class LoadBalancerBackendAddressPoolsCreateOrUpdateSamples {
    ...
    public static void updateLoadBalancerBackendPoolWithBackendAddressesContainingVirtualNetworkAndIPAddress(
        com.azure.resourcemanager.network.generated.NetworkManager manager) {
        BackendAddressPool resource = manager.loadBalancerBackendAddressPools()
            .getWithResponse("testrg", "lb", "backend", com.azure.core.util.Context.NONE)
            .getValue();
        resource.update()
            .withLoadBalancerBackendAddresses(Arrays.asList(
...
public final class LoadBalancerBackendAddressPoolsGetSamples {
     ...
     */
    public static void
        loadBalancerBackendAddressPoolGet(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.loadBalancerBackendAddressPools()
            .getWithResponse("testrg", "lb", "backend", com.azure.core.util.Context.NONE);
    }
...
public final class LoadBalancerBackendAddressPoolsListSamples {
     ...
     */
    public static void
        loadBalancerBackendAddressPoolList(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.loadBalancerBackendAddressPools().list("testrg", "lb", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class LoadBalancerFrontendIpConfigurationsGetSamples {
     ...
     */
    public static void
        loadBalancerFrontendIPConfigurationGet(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.loadBalancerFrontendIpConfigurations()
...
public final class LoadBalancerFrontendIpConfigurationsListSamples {
     ...
     */
    public static void
        loadBalancerFrontendIPConfigurationList(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class LoadBalancerLoadBalancingRulesGetSamples {
     ...
     */
    public static void
        loadBalancerLoadBalancingRuleGet(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.loadBalancerLoadBalancingRules()
...
public final class LoadBalancerLoadBalancingRulesListSamples {
     ...
     */
    public static void
        loadBalancerLoadBalancingRuleList(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class LoadBalancerNetworkInterfacesListSamples {
     ...
     */
    public static void
        loadBalancerNetworkInterfaceListVmss(com.azure.resourcemanager.network.generated.NetworkManager manager) {
     ...
     */
    public static void
        loadBalancerNetworkInterfaceListSimple(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.loadBalancerNetworkInterfaces().list("testrg", "lb", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class LoadBalancerOutboundRulesListSamples {
     ...
     */
    public static void
        loadBalancerOutboundRuleList(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class LoadBalancersCreateOrUpdateSamples {
     ...
     */
    public static void
        createLoadBalancerWithInboundNatPool(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.loadBalancers()
            .define("lb")
            .withRegion("eastus")
            .withExistingResourceGroup("rg1")
     ...
     */
    public static void
        createLoadBalancerWithFrontendIPInZone1(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.loadBalancers()
            .define("lb")
            .withRegion("eastus")
            .withExistingResourceGroup("rg1")
     ...
     */
    public static void
        createLoadBalancerWithOutboundRules(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.loadBalancers()
            .define("lb")
            .withRegion("eastus")
            .withExistingResourceGroup("rg1")
     ...
     */
    public static void
        createLoadBalancerWithStandardSKU(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.loadBalancers()
            .define("lb")
            .withRegion("eastus")
            .withExistingResourceGroup("rg1")
...
public final class LoadBalancersListInboundNatRulePortMappingsSamples {
     ...
     */
    public static void
        queryInboundNATRulePortMapping(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.loadBalancers()
...
public final class LoadBalancersMigrateToIpBasedSamples {
     ...
     */
    public static void
        migrateLoadBalancerToIPBased(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.loadBalancers()
...
public final class LoadBalancersSwapPublicIpAddressesSamples {
     ...
     */
    public static void
        swapVIPsBetweenTwoLoadBalancers(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.loadBalancers()
...
public final class LoadBalancersUpdateTagsSamples {
    ...
    public static void updateLoadBalancerTags(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        LoadBalancer resource = manager.loadBalancers()
...
public final class LocalNetworkGatewaysUpdateTagsSamples {
     ...
     */
    public static void
        updateLocalNetworkGatewayTags(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        LocalNetworkGateway resource = manager.localNetworkGateways()
            .getByResourceGroupWithResponse("rg1", "lgw", com.azure.core.util.Context.NONE)
            .getValue();
        resource.update().withTags(mapOf("tag1", "value1", "tag2", "value2")).apply();
    }
...
public final class ManagementGroupNetworkManagerConnectionsCreateOrUpdateSamples {
    ...
    public static void createOrUpdateManagementGroupNetworkManagerConnection(
        com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.managementGroupNetworkManagerConnections()
...
public final class ManagementGroupNetworkManagerConnectionsDeleteSamples {
    ...
    public static void deleteManagementGroupNetworkManagerConnection(
        com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.managementGroupNetworkManagerConnections()
            .deleteByResourceGroupWithResponse("managementGroupA", "TestNMConnection",
                com.azure.core.util.Context.NONE);
    }
}
```
...
public final class ManagementGroupNetworkManagerConnectionsGetSamples {
     ...
     */
    public static void
        getManagementGroupNetworkManagerConnection(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.managementGroupNetworkManagerConnections()
...
public final class NatGatewaysListByResourceGroupSamples {
     ...
     */
    public static void
        listNatGatewaysInResourceGroup(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class NatGatewaysUpdateTagsSamples {
    ...
    public static void updateNatGatewayTags(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        NatGateway resource = manager.natGateways()
            .getByResourceGroupWithResponse("rg1", "test-natGateway", null, com.azure.core.util.Context.NONE)
            .getValue();
        resource.update().withTags(mapOf("tag1", "value1", "tag2", "value2")).apply();
    }
...
public final class NetworkInterfaceIpConfigurationsGetSamples {
     ...
     */
    public static void
        networkInterfaceIPConfigurationGet(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.networkInterfaceIpConfigurations()
...
public final class NetworkInterfaceIpConfigurationsListSamples {
     ...
     */
    public static void
        networkInterfaceIPConfigurationList(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class NetworkInterfaceLoadBalancersListSamples {
     ...
     */
    public static void
        networkInterfaceLoadBalancerList(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class NetworkInterfaceTapConfigurationsCreateOrUpdateSamples {
     ...
     */
    public static void
        createNetworkInterfaceTapConfigurations(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.networkInterfaceTapConfigurations()
            .define("tapconfiguration1")
            .withExistingNetworkInterface("testrg", "mynic")
            .withVirtualNetworkTap(new VirtualNetworkTapInner().withId(
...
public final class NetworkInterfaceTapConfigurationsGetSamples {
     ...
     */
    public static void
        getNetworkInterfaceTapConfigurations(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.networkInterfaceTapConfigurations()
...
public final class NetworkInterfaceTapConfigurationsListSamples {
     ...
     */
    public static void
        listVirtualNetworkTapConfigurations(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class NetworkInterfacesGetCloudServiceNetworkInterfaceSamples {
     ...
     */
    public static void
        getCloudServiceNetworkInterface(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.networkInterfaces()
...
public final class NetworkInterfacesGetEffectiveRouteTableSamples {
     ...
     */
    public static void
        showNetworkInterfaceEffectiveRouteTables(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class NetworkInterfacesGetVirtualMachineScaleSetIpConfigurationSamples {
     ...
     */
    public static void
        getVirtualMachineScaleSetNetworkInterface(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.networkInterfaces()
...
public final class NetworkInterfacesListByResourceGroupSamples {
     ...
     */
    public static void
        listNetworkInterfacesInResourceGroup(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class NetworkInterfacesListCloudServiceNetworkInterfacesSamples {
     ...
     */
    public static void
        listCloudServiceNetworkInterfaces(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class NetworkManagerDeploymentStatusOperationListSamples {
     ...
     */
    public static void
        networkManagerDeploymentStatusList(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.networkManagerDeploymentStatusOperations()
...
public final class NetworkManagersPatchSamples {
    ...
    public static void networkManagesPatch(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        NetworkManager resource = manager.networkManagers()
            .getByResourceGroupWithResponse("rg1", "testNetworkManager", com.azure.core.util.Context.NONE)
            .getValue();
        resource.update().withTags(mapOf("tag1", "value1", "tag2", "value2")).apply();
    }
...
public final class NetworkProfilesCreateOrUpdateSamples {
     ...
     */
    public static void
        createNetworkProfileDefaults(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class NetworkProfilesListByResourceGroupSamples {
     ...
     */
    public static void
        listResourceGroupNetworkProfiles(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class NetworkProfilesUpdateTagsSamples {
    ...
    public static void updateNetworkProfileTags(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        NetworkProfile resource = manager.networkProfiles()
            .getByResourceGroupWithResponse("rg1", "test-np", null, com.azure.core.util.Context.NONE)
            .getValue();
        resource.update().withTags(mapOf("tag1", "value1", "tag2", "value2")).apply();
    }
...
public final class NetworkSecurityGroupsCreateOrUpdateSamples {
     ...
     */
    public static void
        createNetworkSecurityGroupWithRule(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class NetworkSecurityGroupsListSamples {
     ...
     */
    public static void
        listAllNetworkSecurityGroups(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class NetworkSecurityGroupsListByResourceGroupSamples {
     ...
     */
    public static void
        listNetworkSecurityGroupsInResourceGroup(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class NetworkSecurityGroupsUpdateTagsSamples {
     ...
     */
    public static void
        updateNetworkSecurityGroupTags(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class NetworkVirtualApplianceConnectionsCreateOrUpdateSamples {
     ...
     */
    public static void
        networkVirtualApplianceConnectionPut(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class NetworkVirtualApplianceConnectionsGetSamples {
     ...
     */
    public static void
        networkVirtualApplianceConnectionGet(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.networkVirtualApplianceConnections()
...
public final class NetworkVirtualApplianceConnectionsListSamples {
     ...
     */
    public static void
        networkVirtualApplianceConnectionList(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
import com.azure.resourcemanager.network.generated.models.NicTypeInRequest;
import com.azure.resourcemanager.network.generated.models.ResourceIdentityType;
import com.azure.resourcemanager.network.generated.models.VirtualApplianceAdditionalNicProperties;
import com.azure.resourcemanager.network.generated.models.VirtualApplianceIpConfiguration;
import com.azure.resourcemanager.network.generated.models.VirtualApplianceIpConfigurationProperties;
import com.azure.resourcemanager.network.generated.models.VirtualApplianceNetworkInterfaceConfiguration;
import com.azure.resourcemanager.network.generated.models.VirtualApplianceNetworkInterfaceConfigurationProperties;
...
public final class NetworkVirtualAppliancesDeleteSamples {
     ...
     */
    public static void
        deleteNetworkVirtualAppliance(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class NetworkVirtualAppliancesUpdateTagsSamples {
     ...
     */
    public static void
        updateNetworkVirtualAppliance(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        NetworkVirtualAppliance resource = manager.networkVirtualAppliances()
            .getByResourceGroupWithResponse("rg1", "nva", null, com.azure.core.util.Context.NONE)
            .getValue();
        resource.update().withTags(mapOf("key1", "fakeTokenPlaceholder", "key2", "fakeTokenPlaceholder")).apply();
    }
...
public final class NetworkWatchersUpdateTagsSamples {
    ...
    public static void updateNetworkWatcherTags(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        NetworkWatcher resource = manager.networkWatchers()
...
public final class P2SVpnGatewaysCreateOrUpdateSamples {
    ...
    public static void p2SVpnGatewayPut(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.p2SVpnGateways()
            .define("p2sVpnGateway1")
            .withRegion("West US")
            .withExistingResourceGroup("rg1")
            .withTags(mapOf("key1", "fakeTokenPlaceholder"))
            .withVirtualHub(new SubResource()
                .withId("/subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/virtualHubs/virtualHub1"))
...
public final class P2SVpnGatewaysDisconnectP2SVpnConnectionsSamples {
     ...
     */
    public static void
        disconnectVpnConnectionsFromP2sVpnGateway(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.p2SVpnGateways()
...
public final class P2SVpnGatewaysGenerateVpnProfileSamples {
     ...
     */
    public static void
        generateP2SVpnGatewayVPNProfile(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.p2SVpnGateways()
...
public final class P2SVpnGatewaysGetP2SVpnConnectionHealthSamples {
     ...
     */
    public static void
        p2SVpnGatewayGetConnectionHealth(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class P2SVpnGatewaysGetP2SVpnConnectionHealthDetailedSamples {
     ...
     */
    public static void
        p2SVpnGatewayGetConnectionHealthDetailed(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.p2SVpnGateways()
...
public final class P2SVpnGatewaysListSamples {
     ...
     */
    public static void
        p2SVpnGatewayListBySubscription(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class P2SVpnGatewaysListByResourceGroupSamples {
     ...
     */
    public static void
        p2SVpnGatewayListByResourceGroup(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class P2SVpnGatewaysUpdateTagsSamples {
    ...
    public static void p2SVpnGatewayUpdate(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        P2SVpnGateway resource = manager.p2SVpnGateways()
            .getByResourceGroupWithResponse("rg1", "p2sVpnGateway1", com.azure.core.util.Context.NONE)
            .getValue();
        resource.update().withTags(mapOf("tag1", "value1", "tag2", "value2")).apply();
    }
...
public final class PacketCapturesCreateSamples {
    ...
    public static void createPacketCapture(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.packetCaptures()
            .create("rg1", "nw1", "pc1", new PacketCapture()
...
public final class PeerExpressRouteCircuitConnectionsGetSamples {
    ...
    public static void
        ...
        manager.peerExpressRouteCircuitConnections()
...
public final class PrivateLinkServicesCheckPrivateLinkServiceVisibilitySamples {
     ...
     */
    public static void
        checkPrivateLinkServiceVisibility(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.privateLinkServices()
...
public final class PrivateLinkServicesGetPrivateEndpointConnectionSamples {
     ...
     */
    public static void
        getPrivateEndPointConnection(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.privateLinkServices()
...
public final class PrivateLinkServicesListByResourceGroupSamples {
     ...
     */
    public static void
        listPrivateLinkServiceInResourceGroup(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class PublicIpAddressesCreateOrUpdateSamples {
     ...
     */
    public static void
        createPublicIPAddressAllocationMethod(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.publicIpAddresses()
            .define("test-ip")
            .withRegion("eastus")
            .withExistingResourceGroup("rg1")
     ...
     */
    public static void
        createPublicIPAddressDefaults(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class PublicIpAddressesDdosProtectionStatusSamples {
     ...
     */
    public static void
        getDdosProtectionStatusOfAPublicIPAddress(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class PublicIpAddressesListByResourceGroupSamples {
     ...
     */
    public static void
        listResourceGroupPublicIPAddresses(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class PublicIpAddressesUpdateTagsSamples {
     ...
     */
    public static void updatePublicIPAddressTags(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        PublicIpAddress resource = manager.publicIpAddresses()
            .getByResourceGroupWithResponse("rg1", "test-ip", null, com.azure.core.util.Context.NONE)
            .getValue();
        resource.update().withTags(mapOf("tag1", "value1", "tag2", "value2")).apply();
    }
...
public final class PublicIpPrefixesCreateOrUpdateSamples {
     ...
     */
    public static void
        createPublicIPPrefixDefaults(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.publicIpPrefixes()
     ...
     */
    public static void
        createPublicIPPrefixAllocationMethod(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.publicIpPrefixes()
            .define("test-ipprefix")
            .withRegion("westus")
            .withExistingResourceGroup("rg1")
...
public final class PublicIpPrefixesListByResourceGroupSamples {
     ...
     */
    public static void
        listResourceGroupPublicIPPrefixes(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class PublicIpPrefixesUpdateTagsSamples {
    ...
    public static void updatePublicIPPrefixTags(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        PublicIpPrefix resource = manager.publicIpPrefixes()
            .getByResourceGroupWithResponse("rg1", "test-ipprefix", null, com.azure.core.util.Context.NONE)
            .getValue();
        resource.update().withTags(mapOf("tag1", "value1", "tag2", "value2")).apply();
    }
...
public final class ResourceProviderDeleteBastionShareableLinkSamples {
    ...
    public static void deleteBastionShareableLinksForTheRequestVMs(
        com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.resourceProviders()
            .deleteBastionShareableLink("rg1", "bastionhosttenant",
                new BastionShareableLinkListRequest().withVms(Arrays.asList(
...
public final class ResourceProviderDisconnectActiveSessionsSamples {
     ...
     */
    public static void
        deletesTheSpecifiedActiveSession(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.resourceProviders()
            .disconnectActiveSessions("rg1", "bastionhosttenant", new SessionIds(), com.azure.core.util.Context.NONE);
    }
}
```
...
public final class ResourceProviderGetBastionShareableLinkSamples {
    ...
    public static void returnsTheBastionShareableLinksForTheRequestVMs(
        com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.resourceProviders()
            .getBastionShareableLink("rg1", "bastionhosttenant",
                new BastionShareableLinkListRequest().withVms(Arrays.asList(
                    new BastionShareableLinkInner().withVm(new VM().withId(
                        "/subscriptions/subid/resourceGroups/rgx/providers/Microsoft.Compute/virtualMachines/vm1")),
                    new BastionShareableLinkInner().withVm(new VM().withId(
...
### ResourceProvider_GetSessionRecordingSasUrl
...
public final class ResourceProviderListActiveConnectivityConfigurationsSamples {
     ...
     */
    public static void
        listActiveConnectivityConfigurations(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.resourceProviders()
...
public final class ResourceProviderListNetworkManagerEffectiveConnectivityConfigurationsSamples {
     ...
     */
    public static void
        listEffectiveConnectivityConfiguration(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.resourceProviders()
...
public final class ResourceProviderListNetworkManagerEffectiveSecurityAdminRulesSamples {
     ...
     */
    public static void
        listEffectiveSecurityAdminRules(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.resourceProviders()
...
public final class ResourceProviderPutBastionShareableLinkSamples {
    ...
    public static void createBastionShareableLinksForTheRequestVMs(
        com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.resourceProviders()
            .putBastionShareableLink("rg1", "bastionhosttenant",
                new BastionShareableLinkListRequest().withVms(Arrays.asList(
                    new BastionShareableLinkInner().withVm(new VM().withId(
                        "/subscriptions/subid/resourceGroups/rgx/providers/Microsoft.Compute/virtualMachines/vm1")),
                    new BastionShareableLinkInner().withVm(new VM().withId(
...
### ResourceProvider_SetSessionRecordingSasUrl
...
public final class RouteFiltersListByResourceGroupSamples {
     ...
     */
    public static void
        routeFilterListByResourceGroup(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class RouteFiltersUpdateTagsSamples {
    ...
    public static void updateRouteFilterTags(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        RouteFilter resource = manager.routeFilters()
            .getByResourceGroupWithResponse("rg1", "filterName", null, com.azure.core.util.Context.NONE)
            .getValue();
...
public final class RouteMapsCreateOrUpdateSamples {
    ...
    public static void routeMapPut(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.routeMaps()
            .define("routeMap1")
            .withExistingVirtualHub("rg1", "virtualHub1")
            .withAssociatedInboundConnections(Arrays.asList(
...
public final class RouteTablesListByResourceGroupSamples {
     ...
     */
    public static void
        listRouteTablesInResourceGroup(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class RouteTablesUpdateTagsSamples {
    ...
    public static void updateRouteTableTags(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        RouteTable resource = manager.routeTables()
...
public final class RoutingIntentCreateOrUpdateSamples {
    ...
    public static void routeTablePut(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.routingIntents()
            .define("Intent1")
            .withExistingVirtualHub("rg1", "virtualHub1")
            .withRoutingPolicies(Arrays.asList(
...
public final class ScopeConnectionsDeleteSamples {
     ...
     */
    public static void
        deleteNetworkManagerScopeConnection(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.scopeConnections()
...
public final class ScopeConnectionsGetSamples {
     ...
     */
    public static void
        getNetworkManagerScopeConnection(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.scopeConnections()
...
public final class ScopeConnectionsListSamples {
     ...
     */
    public static void
        listNetworkManagerScopeConnection(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class SecurityPartnerProvidersCreateOrUpdateSamples {
    ...
    public static void
        ...
        manager.securityPartnerProviders()
...
public final class SecurityPartnerProvidersDeleteSamples {
     ...
     */
    public static void
        deleteSecurityPartnerProvider(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class ServiceEndpointPoliciesCreateOrUpdateSamples {
    ...
    public static void createServiceEndpointPolicy(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.serviceEndpointPolicies()
            .define("testPolicy")
            .withRegion("westus")
            .withExistingResourceGroup("rg1")
            .create();
     ...
     */
    public static void
        createServiceEndpointPolicyWithDefinition(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.serviceEndpointPolicies()
            .define("testPolicy")
            .withRegion("westus")
            .withExistingResourceGroup("rg1")
...
public final class ServiceEndpointPoliciesListByResourceGroupSamples {
     ...
     */
    public static void
        listResourceGroupServiceEndpointPolicies(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class ServiceEndpointPoliciesUpdateTagsSamples {
     ...
     */
    public static void
        updateServiceEndpointPolicyTags(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        ServiceEndpointPolicy resource = manager.serviceEndpointPolicies()
            .getByResourceGroupWithResponse("rg1", "testServiceEndpointPolicy", null, com.azure.core.util.Context.NONE)
            .getValue();
        resource.update().withTags(mapOf("tag1", "value1", "tag2", "value2")).apply();
    }
...
public final class ServiceEndpointPolicyDefinitionsCreateOrUpdateSamples {
     ...
     */
    public static void
        createServiceEndpointPolicyDefinition(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class ServiceTagInformationListSamples {
     ...
     */
    public static void
        getListOfServiceTagsWithNoAddressPrefixes(com.azure.resourcemanager.network.generated.NetworkManager manager) {
     ...
     */
    public static void
        getListOfServiceTagsWithTagName(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class SubnetsCreateOrUpdateSamples {
     ...
     */
    public static void
        createSubnetWithServiceEndpoints(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.subnets()
            .define("subnet1")
            .withExistingVirtualNetwork("subnet-test", "vnetname")
            .withAddressPrefix("10.0.0.0/16")
    ...
    /*
     * x-ms-original-file: specification/network/resource-manager/Microsoft.Network/stable/2024-01-01/examples/SubnetCreateWithSharingScope.json
     */
    /**
     ...
     */
    public static void
        createSubnetWithSharingScope(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.subnets()
            .define("subnet1")
            .withExistingVirtualNetwork("subnet-test", "vnetname")
            .withAddressPrefix("10.0.0.0/16")
...
public final class SubnetsGetSamples {
     ...
     * @param manager Entry point to NetworkManager.
     */
    public static void getSubnetWithSharingScope(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class SubscriptionNetworkManagerConnectionsCreateOrUpdateSamples {
    ...
    public static void createOrUpdateSubscriptionNetworkManagerConnection(
        com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.subscriptionNetworkManagerConnections()
...
public final class SubscriptionNetworkManagerConnectionsDeleteSamples {
     ...
     */
    public static void
        deleteSubscriptionNetworkManagerConnection(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.subscriptionNetworkManagerConnections()
...
public final class SubscriptionNetworkManagerConnectionsGetSamples {
     ...
     */
    public static void
        getSubscriptionNetworkManagerConnection(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.subscriptionNetworkManagerConnections()
...
public final class SubscriptionNetworkManagerConnectionsListSamples {
     ...
     */
    public static void
        listSubscriptionNetworkManagerConnection(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class VirtualApplianceSitesCreateOrUpdateSamples {
     ...
     */
    public static void
        createNetworkVirtualApplianceSite(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.virtualApplianceSites()
            .define("site1")
            .withExistingNetworkVirtualAppliance("rg1", "nva")
...
public final class VirtualApplianceSitesDeleteSamples {
     ...
     */
    public static void
        deleteNetworkVirtualApplianceSite(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class VirtualApplianceSitesGetSamples {
     ...
     */
    public static void
        getNetworkVirtualApplianceSite(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class VirtualApplianceSkusGetSamples {
     ...
     */
    public static void
        networkVirtualApplianceSkuGet(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class VirtualApplianceSkusListSamples {
     ...
     */
    public static void
        networkVirtualApplianceSkuListResult(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class VirtualHubBgpConnectionsCreateOrUpdateSamples {
    ...
    public static void virtualHubRouteTableV2Put(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.virtualHubBgpConnections()
            .define("conn1")
...
public final class VirtualHubBgpConnectionsDeleteSamples {
     ...
     */
    public static void
        virtualHubRouteTableV2Delete(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class VirtualHubBgpConnectionsGetSamples {
     ...
     */
    public static void
        virtualHubVirtualHubRouteTableV2Get(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class VirtualHubBgpConnectionsListAdvertisedRoutesSamples {
     ...
     */
    public static void
        virtualRouterPeerListAdvertisedRoutes(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.virtualHubBgpConnections()
...
public final class VirtualHubBgpConnectionsListLearnedRoutesSamples {
     ...
     */
    public static void
        virtualRouterPeerListLearnedRoutes(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.virtualHubBgpConnections()
...
public final class VirtualHubIpConfigurationCreateOrUpdateSamples {
     ...
     */
    public static void
        virtualHubIpConfigurationPut(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.virtualHubIpConfigurations()
            .define("ipconfig1")
            .withExistingVirtualHub("rg1", "hub1")
            .withSubnet(new SubnetInner().withId(
...
public final class VirtualHubIpConfigurationDeleteSamples {
     ...
     */
    public static void
        virtualHubIpConfigurationDelete(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class VirtualHubRouteTableV2SCreateOrUpdateSamples {
     ...
     */
    public static void virtualHubRouteTableV2Put(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.virtualHubRouteTableV2S()
    ...
    public static void virtualHubPut(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.virtualHubs()
            ...
            .withVirtualWan(new SubResource()
                .withId("/subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/virtualWans/virtualWan1"))
...
public final class VirtualHubsGetEffectiveVirtualHubRoutesSamples {
     ...
     */
    public static void
        effectiveRoutesForARouteTableResource(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.virtualHubs()
     ...
     */
    public static void
        effectiveRoutesForAConnectionResource(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.virtualHubs()
            .getEffectiveVirtualHubRoutes("rg1", "virtualHub1", new EffectiveRoutesParameters().withResourceId(
     ...
     */
    public static void
        effectiveRoutesForTheVirtualHub(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.virtualHubs()
...
public final class VirtualHubsListByResourceGroupSamples {
     ...
     */
    public static void
        virtualHubListByResourceGroup(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class VirtualHubsUpdateTagsSamples {
    ...
    public static void virtualHubUpdate(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        VirtualHub resource = manager.virtualHubs()
...
public final class VirtualNetworkGatewayConnectionsCreateOrUpdateSamples {
     ...
     */
    public static void
        createVirtualNetworkGatewayConnectionS2S(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.virtualNetworkGatewayConnections()
            .define("connS2S")
            ...
            .withVirtualNetworkGateway1(new VirtualNetworkGatewayInner().withLocation("centralus")
                ...
                .withIpConfigurations(Arrays.asList(new VirtualNetworkGatewayIpConfiguration().withId(
            ...
            .withIngressNatRules(Arrays.asList(new SubResource().withId(
...
public final class VirtualNetworkGatewayConnectionsDeleteSamples {
     ...
     */
    public static void
        deleteVirtualNetworkGatewayConnection(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class VirtualNetworkGatewayConnectionsGetByResourceGroupSamples {
     ...
     */
    public static void
        getVirtualNetworkGatewayConnection(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.virtualNetworkGatewayConnections()
...
public final class VirtualNetworkGatewayConnectionsGetIkeSasSamples {
     ...
     */
    public static void
        getVirtualNetworkGatewayConnectionIkeSa(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class VirtualNetworkGatewayConnectionsResetConnectionSamples {
     ...
     */
    public static void
        resetVirtualNetworkGatewayConnection(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class VirtualNetworkGatewayNatRulesCreateOrUpdateSamples {
     ...
     */
    public static void
        virtualNetworkGatewayNatRulePut(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.virtualNetworkGatewayNatRules()
            .define("natRule1")
...
public final class VirtualNetworkGatewayNatRulesDeleteSamples {
     ...
     */
    public static void
        virtualNetworkGatewayNatRuleDelete(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class VirtualNetworkGatewayNatRulesGetSamples {
     ...
     */
    public static void
        virtualNetworkGatewayNatRuleGet(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.virtualNetworkGatewayNatRules()
...
public final class VirtualNetworkGatewayNatRulesListByVirtualNetworkGatewaySamples {
     ...
     */
    public static void
        virtualNetworkGatewayNatRuleList(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.virtualNetworkGatewayNatRules()
...
public final class VirtualNetworkGatewaysCreateOrUpdateSamples {
    ...
    public static void updateVirtualNetworkGateway(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.virtualNetworkGateways()
            ...
            .withRegion("centralus")
            .withExistingResourceGroup("rg1")
            .withIpConfigurations(Arrays.asList(new VirtualNetworkGatewayIpConfiguration().withName("gwipconfig1")
                .withPrivateIpAllocationMethod(IpAllocationMethod.DYNAMIC)
                .withSubnet(new SubResource().withId(
                    "/subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/virtualNetworks/vnet1/subnets/GatewaySubnet"))
                .withPublicIpAddress(new SubResource().withId(
     ...
     */
    public static void
        updateVirtualNetworkScalableGateway(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.virtualNetworkGateways()
            .define("ergw")
            .withRegion("centralus")
            .withExistingResourceGroup("rg1")
...
public final class VirtualNetworkGatewaysGenerateVpnProfileSamples {
     ...
     */
    public static void
        generateVirtualNetworkGatewayVPNProfile(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.virtualNetworkGateways()
...
public final class VirtualNetworkGatewaysGetAdvertisedRoutesSamples {
     ...
     */
    public static void
        getVirtualNetworkGatewayAdvertisedRoutes(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class VirtualNetworkGatewaysGetBgpPeerStatusSamples {
     ...
     */
    public static void
        getVirtualNetworkGatewayBGPPeerStatus(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class VirtualNetworkGatewaysGetByResourceGroupSamples {
     ...
     */
    public static void
        getVirtualNetworkScalableGateway(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.virtualNetworkGateways()
...
public final class VirtualNetworkGatewaysGetLearnedRoutesSamples {
     ...
     */
    public static void
        getVirtualNetworkGatewayLearnedRoutes(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class VirtualNetworkGatewaysListByResourceGroupSamples {
     ...
     */
    public static void
        listVirtualNetworkGatewaysinResourceGroup(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class VirtualNetworkGatewaysListConnectionsSamples {
     ...
     */
    public static void
        virtualNetworkGatewaysListConnections(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.virtualNetworkGateways()
...
public final class VirtualNetworkGatewaysStopPacketCaptureSamples {
     ...
     */
    public static void
        stopPacketCaptureOnVirtualNetworkGateway(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.virtualNetworkGateways()
            .stopPacketCapture("rg1", "vpngw", new VpnPacketCaptureStopParameters().withSasUrl(
                "https://teststorage.blob.core.windows.net/?sv=2018-03-28&ss=bfqt&srt=sco&sp=rwdlacup&se=2019-09-13T07:44:05Z&st=2019-09-06T23:44:05Z&spr=https&sig=V1h9D1riltvZMI69d6ihENnFo%2FrCvTqGgjO2lf%2FVBhE%3D"),
                com.azure.core.util.Context.NONE);
    }
}
...
public final class VirtualNetworkGatewaysUpdateTagsSamples {
     ...
     */
    public static void
        updateVirtualNetworkGatewayTags(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        VirtualNetworkGateway resource = manager.virtualNetworkGateways()
            .getByResourceGroupWithResponse("rg1", "vpngw", com.azure.core.util.Context.NONE)
            .getValue();
        resource.update().withTags(mapOf("tag1", "value1", "tag2", "value2")).apply();
    }
...
public final class VirtualNetworkGatewaysVpnDeviceConfigurationScriptSamples {
     ...
     */
    public static void
        getVPNDeviceConfigurationScript(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.virtualNetworkGateways()
...
public final class VirtualNetworkTapsDeleteSamples {
     ...
     */
    public static void
        deleteVirtualNetworkTapResource(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class VirtualNetworkTapsListByResourceGroupSamples {
     ...
     */
    public static void
        listVirtualNetworkTapsInResourceGroup(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class VirtualNetworkTapsUpdateTagsSamples {
    ...
    public static void updateVirtualNetworkTapTags(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        VirtualNetworkTap resource = manager.virtualNetworkTaps()
            .getByResourceGroupWithResponse("rg1", "test-vtap", com.azure.core.util.Context.NONE)
            .getValue();
        resource.update().withTags(mapOf("tag1", "value1", "tag2", "value2")).apply();
    }
...
public final class VirtualNetworksCreateOrUpdateSamples {
     ...
     */
    public static void
        createVirtualNetworkWithSubnet(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.virtualNetworks()
            .define("test-vnet")
            .withRegion("eastus")
            .withExistingResourceGroup("rg1")
     ...
     */
    public static void
        createVirtualNetworkWithBgpCommunities(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.virtualNetworks()
            .define("test-vnet")
            .withRegion("eastus")
            .withExistingResourceGroup("rg1")
    ...
    public static void createVirtualNetworkWithSubnetContainingAddressPrefixes(
        ...
        manager.virtualNetworks()
            ...
            .withSubnets(Arrays.asList(
                new SubnetInner().withName("test-2").withAddressPrefixes(Arrays.asList("10.0.0.0/28", "10.0.1.0/28"))))
            .create();
    }
     ...
     */
    public static void
        createVirtualNetworkWithDelegatedSubnets(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.virtualNetworks()
            .define("test-vnet")
     ...
     */
    public static void
        createVirtualNetworkWithEncryption(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.virtualNetworks()
            .define("test-vnet")
            .withRegion("eastus")
            .withExistingResourceGroup("rg1")
     ...
     */
    public static void
        createVirtualNetworkWithServiceEndpoints(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.virtualNetworks()
            .define("vnet1")
            .withRegion("eastus")
            .withExistingResourceGroup("vnetTest")
...
public final class VirtualNetworksGetByResourceGroupSamples {
     ...
     */
    public static void
        getVirtualNetworkWithADelegatedSubnet(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.virtualNetworks()
...
public final class VirtualNetworksListByResourceGroupSamples {
     ...
     */
    public static void
        listVirtualNetworksInResourceGroup(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class VirtualNetworksListDdosProtectionStatusSamples {
     ...
     */
    public static void
        getDdosProtectionStatusOfAVirtualNetwork(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.virtualNetworks()
...
public final class VirtualRoutersListByResourceGroupSamples {
     ...
     */
    public static void
        listAllVirtualRouterForAGivenResourceGroup(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class VirtualWansListByResourceGroupSamples {
     ...
     */
    public static void
        virtualWANListByResourceGroup(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class VirtualWansUpdateTagsSamples {
    ...
    public static void virtualWANUpdate(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        VirtualWan resource = manager.virtualWans()
...
public final class VpnGatewaysListSamples {
     ...
     */
    public static void
        vpnGatewayListBySubscription(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class VpnGatewaysStartPacketCaptureSamples {
     ...
     */
    public static void
        startPacketCaptureOnVpnGatewayWithFilter(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.vpnGateways()
...
public final class VpnGatewaysStopPacketCaptureSamples {
     ...
     */
    public static void
        stopPacketCaptureOnVpnGateway(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.vpnGateways()
...
public final class VpnGatewaysUpdateTagsSamples {
    ...
    public static void vpnGatewayUpdate(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        VpnGateway resource = manager.vpnGateways()
...
public final class VpnServerConfigurationsCreateOrUpdateSamples {
     ...
     */
    public static void
        vpnServerConfigurationCreate(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.vpnServerConfigurations()
            ...
            .withConfigurationPolicyGroups(Arrays.asList(new VpnServerConfigurationPolicyGroupInner().withId(
                ...
                new VpnServerConfigurationPolicyGroupInner().withId(
                    ...
                    .withIsDefault(true)
                    .withPriority(0)
                    .withPolicyMembers(Arrays.asList(new VpnServerConfigurationPolicyGroupMember().withName("policy2")
                        .withAttributeType(VpnPolicyMemberAttributeType.CERTIFICATE_GROUP_ID)
                        .withAttributeValue("red.com")))))
            .create();
    }
...
public final class VpnServerConfigurationsDeleteSamples {
     ...
     */
    public static void
        vpnServerConfigurationDelete(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class VpnServerConfigurationsListByResourceGroupSamples {
     ...
     */
    public static void
        vpnServerConfigurationListByResourceGroup(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class VpnServerConfigurationsUpdateTagsSamples {
     ...
     */
    public static void
        vpnServerConfigurationUpdate(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        VpnServerConfiguration resource = manager.vpnServerConfigurations()
            .getByResourceGroupWithResponse("rg1", "vpnServerConfiguration1", com.azure.core.util.Context.NONE)
            .getValue();
        resource.update().withTags(mapOf("key1", "fakeTokenPlaceholder", "key2", "fakeTokenPlaceholder")).apply();
    }
...
public final class VpnServerConfigurationsAssociatedWithVirtualWanListSamples {
    ...
    public static void
        ...
        manager.vpnServerConfigurationsAssociatedWithVirtualWans()
...
public final class VpnSiteLinkConnectionsGetSamples {
    ...
    public static void vpnSiteLinkConnectionGet(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.vpnSiteLinkConnections()
...
public final class VpnSitesUpdateTagsSamples {
    ...
    public static void vpnSiteUpdate(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        VpnSite resource = manager.vpnSites()
...
public final class VpnSitesConfigurationDownloadSamples {
     ...
     */
    public static void
        vpnSitesConfigurationDownload(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class WebApplicationFirewallPoliciesCreateOrUpdateSamples {
    ...
    public static void createsOrUpdatesAWAFPolicyWithinAResourceGroup(
        ...
        manager.webApplicationFirewallPolicies()
            ...
            .withRegion("WestUs")
            .withExistingResourceGroup("rg1")
            .withPolicySettings(new PolicySettings()
                .withLogScrubbing(
                    new PolicySettingsLogScrubbing().withState(WebApplicationFirewallScrubbingState.ENABLED)
                        .withScrubbingRules(Arrays.asList(
                            new WebApplicationFirewallScrubbingRules()
                                .withMatchVariable(ScrubbingRuleEntryMatchVariable.REQUEST_ARG_NAMES)
                            ...
                            .asList(
                                new OwaspCrsExclusionEntry()
                                    ...
                                    .withExclusionManagedRuleSets(
                                        Arrays
                                            .asList(
                                                new ExclusionManagedRuleSet().withRuleSetType("OWASP")
...
public final class WebApplicationFirewallPoliciesGetByResourceGroupSamples {
     ...
     */
    public static void
        getsAWAFPolicyWithinAResourceGroup(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.webApplicationFirewallPolicies()
...
public final class WebApplicationFirewallPoliciesListSamples {
     ...
     */
    public static void
        listsAllWAFPoliciesInASubscription(com.azure.resourcemanager.network.generated.NetworkManager manager) {
...
public final class WebApplicationFirewallPoliciesListByResourceGroupSamples {
     ...
     */
    public static void
        listsAllWAFPoliciesInAResourceGroup(com.azure.resourcemanager.network.generated.NetworkManager manager) {
