...
public final class VirtualNetworkGatewaysCreateOrUpdateSamples {
    /*
     * x-ms-original-file:
     * specification/network/resource-manager/Microsoft.Network/stable/2023-05-01/examples/VirtualNetworkGatewayUpdate.
     * json
     */
    /**
    ...
    public static void
        ...
        manager.virtualNetworkGateways().define("ergw").withRegion("centralus").withExistingResourceGroup("rg1")
            ...
            .withSku(new VirtualNetworkGatewaySku().withName(VirtualNetworkGatewaySkuName.fromString("ErGwScale"))
