...
public final class WebApplicationFirewallPoliciesCreateOrUpdateSamples {
    /*
     * x-ms-original-file:
     * specification/network/resource-manager/Microsoft.Network/stable/2023-05-01/examples/WafPolicyCreateOrUpdate.json
     */
    /**
                    ...
                    Arrays
                        .asList(
                            ...
                            new OwaspCrsExclusionEntry()
                                ...
                                .withSelectorMatchOperator(OwaspCrsExclusionEntrySelectorMatchOperator.STARTS_WITH)
                                .withSelector("test")))
                .withManagedRuleSets(Arrays.asList(new ManagedRuleSet().withRuleSetType("OWASP")
                    .withRuleSetVersion("3.2")
                    .withRuleGroupOverrides(Arrays.asList(new ManagedRuleGroupOverride()
                        ...
                        .withRules(Arrays.asList(
                            new ManagedRuleOverride().withRuleId("931120").withState(ManagedRuleEnabledState.ENABLED)
                                .withAction(ActionType.LOG),
                            new ManagedRuleOverride().withRuleId("931130").withState(ManagedRuleEnabledState.DISABLED)
