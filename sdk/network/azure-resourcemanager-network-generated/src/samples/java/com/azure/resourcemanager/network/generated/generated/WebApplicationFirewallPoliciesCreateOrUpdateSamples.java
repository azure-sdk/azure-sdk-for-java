...
public final class WebApplicationFirewallPoliciesCreateOrUpdateSamples {
    /*
     * x-ms-original-file:
     * specification/network/resource-manager/Microsoft.Network/stable/2022-07-01/examples/WafPolicyCreateOrUpdate.json
     */
    /**
                ...
                Arrays
                    .asList(
                        new WebApplicationFirewallCustomRule().withName("Rule1").withPriority(1)
                            ...
                            .withMatchConditions(Arrays.asList(new MatchCondition().withMatchVariables(Arrays.asList(
                                new MatchVariable().withVariableName(WebApplicationFirewallMatchVariable.REMOTE_ADDR)))
                        ...
                        new WebApplicationFirewallCustomRule()
                            ...
                            .withMatchConditions(Arrays.asList(
                                ...
                                new MatchCondition()
                                    .withMatchVariables(Arrays.asList(
                                        new MatchVariable()
