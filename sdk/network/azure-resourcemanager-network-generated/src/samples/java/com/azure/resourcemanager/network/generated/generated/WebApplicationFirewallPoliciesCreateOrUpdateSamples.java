                        ...
                        Arrays
                            .asList(
                                ...
                                new OwaspCrsExclusionEntry()
                                    ...
                                    .withSelectorMatchOperator(OwaspCrsExclusionEntrySelectorMatchOperator.STARTS_WITH)
                                    .withSelector("test"),
                                new OwaspCrsExclusionEntry().withExclude(OwaspCrsExclusionEntryExclude.MATCH_VARIABLE)
                                    .withMatchVariable(OwaspCrsExclusionEntryMatchVariable.REQUEST_ARG_VALUES)
                                    .withSelectorMatchOperator(OwaspCrsExclusionEntrySelectorMatchOperator.STARTS_WITH)
                                    .withSelector("test"),
                                new OwaspCrsExclusionEntry().withExclude(OwaspCrsExclusionEntryExclude.REQUEST)
                                    .withMatchVariable(OwaspCrsExclusionEntryMatchVariable.REQUEST_URI)
                                    .withValues(Arrays.asList("path1", "path2", "path3"))
                                    .withExclusionManagedRuleSets(Arrays.asList(new ExclusionManagedRuleSet()
                                        .withRuleSetType("OWASP").withRuleSetVersion("3.2"))),
                                new OwaspCrsExclusionEntry()
                                    .withExclude(OwaspCrsExclusionEntryExclude.REQUEST)
                                    .withMatchVariable(OwaspCrsExclusionEntryMatchVariable.REQUEST_HEADER)
                                    .withSelectorMatchOperator(OwaspCrsExclusionEntrySelectorMatchOperator.STARTS_WITH)
                                    .withSelector("test").withValues(
                                ...
                                new OwaspCrsExclusionEntry().withExclude(OwaspCrsExclusionEntryExclude.REQUEST)
                                    .withMatchVariable(OwaspCrsExclusionEntryMatchVariable.REMOTE_ADDR)
                                    .withValues(Arrays.asList("1.2.3.4", "10.0.0.1/6")).withExclusionManagedRuleSets(
