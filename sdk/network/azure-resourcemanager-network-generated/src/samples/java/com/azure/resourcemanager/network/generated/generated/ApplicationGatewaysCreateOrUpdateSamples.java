...
public final class ApplicationGatewaysCreateOrUpdateSamples {
    /*
     * x-ms-original-file:
     * specification/network/resource-manager/Microsoft.Network/stable/2022-07-01/examples/ApplicationGatewayCreate.json
     */
    /**
    ...
    public static void createApplicationGateway(com.azure.resourcemanager.network.generated.NetworkManager manager) {
        manager.applicationGateways().define("appgw").withRegion("eastus").withExistingResourceGroup("rg1")
            ...
            .withBackendAddressPools(Arrays.asList(new ApplicationGatewayBackendAddressPool().withName("appgwpool")
                ...
                new ApplicationGatewayBackendAddressPool().withId(
                    ...
                    .withName("appgwpool1").withBackendAddresses(
                        Arrays.asList(new ApplicationGatewayBackendAddress(), new ApplicationGatewayBackendAddress()))))
            ...
            .withUrlPathMaps(Arrays.asList(new ApplicationGatewayUrlPathMap().withName("pathMap1")
                ...
                .withDefaultRewriteRuleSet(new SubResource().withId(
                ...
                .withDefaultLoadDistributionPolicy(new SubResource().withId(
                ...
                .withPathRules(Arrays.asList(new ApplicationGatewayPathRule().withName("apiPaths")
                    ...
                    .withRewriteRuleSet(new SubResource().withId(
                        "/subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/applicationGateways/appgw/rewriteRuleSets/rewriteRuleSet1"))
                    .withLoadDistributionPolicy(new SubResource().withId(
                        "/subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/applicationGateways/appgw/loadDistributionPolicies/ldp1"))))))
            .withRequestRoutingRules(Arrays.asList(new ApplicationGatewayRequestRoutingRule().withName("appgwrule")
                ...
                .withLoadDistributionPolicy(new SubResource().withId(
                    "/subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/applicationGateways/appgw/loadDistributionPolicies/ldp1")),
                new ApplicationGatewayRequestRoutingRule().withName("appgwPathBasedRule")
                    .withRuleType(ApplicationGatewayRequestRoutingRuleType.PATH_BASED_ROUTING).withPriority(20)
                    .withHttpListener(new SubResource().withId(
                    ...
                    .withUrlPathMap(new SubResource().withId(
            ...
            .withLoadDistributionPolicies(Arrays.asList(new ApplicationGatewayLoadDistributionPolicy().withName("ldp1")
                .withLoadDistributionTargets(Arrays.asList(new ApplicationGatewayLoadDistributionTarget()
                    .withName("ld11").withWeightPerServer(40)
                    .withBackendAddressPool(new SubResource().withId(
                        "/subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/applicationGateways/appgw/backendAddressPools/appgwpool")),
                    new ApplicationGatewayLoadDistributionTarget().withName("ld11").withWeightPerServer(60)
                        .withBackendAddressPool(new SubResource().withId(
                            "/subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/applicationGateways/appgw/backendAddressPools/appgwpool1"))))
