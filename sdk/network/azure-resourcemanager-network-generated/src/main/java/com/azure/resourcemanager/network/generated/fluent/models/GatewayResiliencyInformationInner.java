...
public final class GatewayResiliencyInformationInner implements JsonSerializable<GatewayResiliencyInformationInner> {
     ...
     */
    public String lastComputedTime() {
     ...
     * @return the GatewayResiliencyInformationInner object itself.
     */
    public GatewayResiliencyInformationInner withLastComputedTime(String lastComputedTime) {
     ...
     */
    public String nextEligibleComputeTime() {
     ...
     * @return the GatewayResiliencyInformationInner object itself.
     */
    public GatewayResiliencyInformationInner withNextEligibleComputeTime(String nextEligibleComputeTime) {
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeStringField("lastComputedTime", this.lastComputedTime);
        jsonWriter.writeStringField("nextEligibleComputeTime", this.nextEligibleComputeTime);
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("overallScore".equals(fieldName)) {
                    ...
                    deserializedGatewayResiliencyInformationInner.lastComputedTime = reader.getString();
                } else if ("nextEligibleComputeTime".equals(fieldName)) {
                    deserializedGatewayResiliencyInformationInner.nextEligibleComputeTime = reader.getString();
