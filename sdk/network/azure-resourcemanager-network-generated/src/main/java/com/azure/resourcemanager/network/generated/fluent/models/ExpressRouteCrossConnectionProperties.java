...
public final class ExpressRouteCrossConnectionProperties
    ...
    /**
     * Set the primaryAzurePort property: The name of the primary port.
     * 
     * @param primaryAzurePort the primaryAzurePort value to set.
     * @return the ExpressRouteCrossConnectionProperties object itself.
     */
    public ExpressRouteCrossConnectionProperties withPrimaryAzurePort(String primaryAzurePort) {
    ...
    /**
     * Set the secondaryAzurePort property: The name of the secondary port.
     * 
     * @param secondaryAzurePort the secondaryAzurePort value to set.
     * @return the ExpressRouteCrossConnectionProperties object itself.
     */
    public ExpressRouteCrossConnectionProperties withSecondaryAzurePort(String secondaryAzurePort) {
