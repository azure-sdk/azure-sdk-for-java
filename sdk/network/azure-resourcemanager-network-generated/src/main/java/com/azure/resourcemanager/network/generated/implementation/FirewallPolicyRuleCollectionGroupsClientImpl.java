...
public final class FirewallPolicyRuleCollectionGroupsClientImpl implements FirewallPolicyRuleCollectionGroupsClient {
    ...
    public interface FirewallPolicyRuleCollectionGroupsService {
        ...
        @Post(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network"
                + "/firewallPolicies/{firewallPolicyName}/ruleCollectionGroups/{ruleCollectionGroupName}/putDraft")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<FirewallPolicyDraftRuleCollectionGroupInner>> createOrUpdateDraft(
            @HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("firewallPolicyName") String firewallPolicyName,
            @PathParam("ruleCollectionGroupName") String ruleCollectionGroupName,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @BodyParam("application/json") FirewallPolicyDraftRuleCollectionGroupInner parameters,
            @HeaderParam("Accept") String accept,
            Context context);
        ...
        @Post(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network"
                + "/firewallPolicies/{firewallPolicyName}/ruleCollectionGroups/{ruleCollectionGroupName}/getDraft")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<FirewallPolicyDraftRuleCollectionGroupInner>> getDraft(
            @HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("firewallPolicyName") String firewallPolicyName,
            @PathParam("ruleCollectionGroupName") String ruleCollectionGroupName,
        ...
        @Post(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network"
                + "/firewallPolicies/{firewallPolicyName}/ruleCollectionGroups/{ruleCollectionGroupName}/deleteDraft")
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<FirewallPolicyDraftRuleCollectionGroupInner>> createOrUpdateDraftWithResponseAsync(
        String resourceGroupName,
        String firewallPolicyName,
        String ruleCollectionGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<FirewallPolicyDraftRuleCollectionGroupInner> createOrUpdateDraftAsync(
        String resourceGroupName,
        String firewallPolicyName,
        String ruleCollectionGroupName,
        FirewallPolicyDraftRuleCollectionGroupInner parameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<FirewallPolicyDraftRuleCollectionGroupInner> createOrUpdateDraftWithResponse(
        String resourceGroupName,
        String firewallPolicyName,
        String ruleCollectionGroupName,
        FirewallPolicyDraftRuleCollectionGroupInner parameters,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public FirewallPolicyDraftRuleCollectionGroupInner createOrUpdateDraft(
        String resourceGroupName,
        String firewallPolicyName,
        String ruleCollectionGroupName,
        FirewallPolicyDraftRuleCollectionGroupInner parameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<FirewallPolicyDraftRuleCollectionGroupInner>> getDraftWithResponseAsync(
        String resourceGroupName,
        String firewallPolicyName,
        String ruleCollectionGroupName,
        FirewallPolicyRuleCollectionGroupInner parameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<FirewallPolicyDraftRuleCollectionGroupInner> getDraftAsync(
        String resourceGroupName,
        String firewallPolicyName,
        String ruleCollectionGroupName,
        FirewallPolicyRuleCollectionGroupInner parameters) {
        return getDraftWithResponseAsync(resourceGroupName, firewallPolicyName, ruleCollectionGroupName, parameters)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<FirewallPolicyDraftRuleCollectionGroupInner> getDraftWithResponse(
        String resourceGroupName,
        String firewallPolicyName,
        String ruleCollectionGroupName,
        FirewallPolicyRuleCollectionGroupInner parameters,
        Context context) {
        return getDraftWithResponseAsync(
                resourceGroupName, firewallPolicyName, ruleCollectionGroupName, parameters, context)
            .block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public FirewallPolicyDraftRuleCollectionGroupInner getDraft(
        String resourceGroupName,
        String firewallPolicyName,
        String ruleCollectionGroupName,
        FirewallPolicyRuleCollectionGroupInner parameters) {
        return getDraftWithResponse(
                resourceGroupName, firewallPolicyName, ruleCollectionGroupName, parameters, Context.NONE)
            .getValue();
    }
    ...
    private Mono<FirewallPolicyRuleCollectionGroupInner> deleteDraftAsync(
        ...
        String ruleCollectionGroupName,
        FirewallPolicyRuleCollectionGroupInner parameters) {
        return deleteDraftWithResponseAsync(resourceGroupName, firewallPolicyName, ruleCollectionGroupName, parameters)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
    ...
    public Response<FirewallPolicyRuleCollectionGroupInner> deleteDraftWithResponse(
        ...
        FirewallPolicyRuleCollectionGroupInner parameters,
        Context context) {
        return deleteDraftWithResponseAsync(
                resourceGroupName, firewallPolicyName, ruleCollectionGroupName, parameters, context)
            .block();
    }
    ...
    public FirewallPolicyRuleCollectionGroupInner deleteDraft(
        ...
        String ruleCollectionGroupName,
        FirewallPolicyRuleCollectionGroupInner parameters) {
        return deleteDraftWithResponse(
                resourceGroupName, firewallPolicyName, ruleCollectionGroupName, parameters, Context.NONE)
            .getValue();
    }
