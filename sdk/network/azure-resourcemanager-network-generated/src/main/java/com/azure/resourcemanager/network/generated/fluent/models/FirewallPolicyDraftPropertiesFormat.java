...
/** The FirewallPolicyDraftPropertiesFormat model. */
@Fluent
public final class FirewallPolicyDraftPropertiesFormat {
    /*
    ...
    /** Creates an instance of FirewallPolicyDraftPropertiesFormat class. */
    public FirewallPolicyDraftPropertiesFormat() {
    }
     ...
     * @return the FirewallPolicyDraftPropertiesFormat object itself.
     */
    public FirewallPolicyDraftPropertiesFormat withThreatIntelMode(AzureFirewallThreatIntelMode threatIntelMode) {
     ...
     * @return the FirewallPolicyDraftPropertiesFormat object itself.
     */
    public FirewallPolicyDraftPropertiesFormat withThreatIntelWhitelist(
     ...
     * @return the FirewallPolicyDraftPropertiesFormat object itself.
     */
    public FirewallPolicyDraftPropertiesFormat withInsights(FirewallPolicyInsights insights) {
     ...
     * @return the FirewallPolicyDraftPropertiesFormat object itself.
     */
    public FirewallPolicyDraftPropertiesFormat withSnat(FirewallPolicySnat snat) {
        this.snat = snat;
        return this;
    }
     ...
     * @return the FirewallPolicyDraftPropertiesFormat object itself.
     */
    public FirewallPolicyDraftPropertiesFormat withSql(FirewallPolicySql sql) {
        this.sql = sql;
        return this;
    }
     ...
     * @return the FirewallPolicyDraftPropertiesFormat object itself.
     */
    public FirewallPolicyDraftPropertiesFormat withDnsSettings(DnsSettings dnsSettings) {
     ...
     * @return the FirewallPolicyDraftPropertiesFormat object itself.
     */
    public FirewallPolicyDraftPropertiesFormat withExplicitProxy(ExplicitProxy explicitProxy) {
     ...
     * @return the FirewallPolicyDraftPropertiesFormat object itself.
     */
    public FirewallPolicyDraftPropertiesFormat withIntrusionDetection(
