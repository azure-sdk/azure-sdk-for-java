...
public final class VirtualNetworkPropertiesFormat {
    ...
    /*
     * Indicates if VM protection is enabled for all the subnets in the virtual network. The enableVmProtection
     * property is deprecated. You can leverage the enableDdoSProtection property.
     */
