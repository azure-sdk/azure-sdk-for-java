...
public interface VpnLinkConnections {
     ...
     */
    Response<SharedKey> sharedKeyGetWithResponse(String resourceGroupName, String gatewayName, String connectionName,
        String linkConnectionName, String sharedKeyName, Context context);
     ...
     */
    SharedKey sharedKeyGet(String resourceGroupName, String gatewayName, String connectionName,
     ...
     * @return the shared key of VpnLink connection specified along with {@link Response}.
     */
    SharedKey sharedKeyGetById(String id);
     ...
     * @return the shared key of VpnLink connection specified along with {@link Response}.
     */
    Response<SharedKey> sharedKeyGetByIdWithResponse(String id, Context context);

    /**
     * Begins definition for a new SharedKey resource.
     * 
     * @param name resource name.
     * @return the first stage of the new SharedKey definition.
     */
    SharedKey.DefinitionStages.Blank define(String name);
}
