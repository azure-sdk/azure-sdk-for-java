 ...
 */
@Fluent
public final class NspAssociationInner extends Resource {
    /*
    ...
    /**
     * Get the id property: NSP resource association identifier.
     * 
     * @return the id value.
     */
    @Override
     ...
     */
    @Override
    public NspAssociationInner withLocation(String location) {
     ...
     */
    @Override
    public NspAssociationInner withTags(Map<String, String> tags) {
        super.withTags(tags);
        return this;
    }
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("name".equals(fieldName)) {
                    ...
                    deserializedNspAssociationInner.withLocation(reader.getString());
                } else if ("tags".equals(fieldName)) {
                    Map<String, String> tags = reader.readMap(reader1 -> reader1.getString());
                    deserializedNspAssociationInner.withTags(tags);
