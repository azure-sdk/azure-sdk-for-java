...
public final class NetworkManagerRoutingConfigurationInner extends ChildResource {
     ...
     */
    public NetworkManagerRoutingConfigurationInner() {
    }

    /**
     * Get the innerProperties property: Indicates the properties for the network manager routing configuration.
     * 
    ...
    /**
     * Reads an instance of NetworkManagerRoutingConfigurationInner from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of NetworkManagerRoutingConfigurationInner if the JsonReader was pointing to an instance of
     * it, or null if it was pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the NetworkManagerRoutingConfigurationInner.
     */
    public static NetworkManagerRoutingConfigurationInner fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            NetworkManagerRoutingConfigurationInner deserializedNetworkManagerRoutingConfigurationInner
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("id".equals(fieldName)) {
                    ...
                    deserializedNetworkManagerRoutingConfigurationInner.systemData = SystemData.fromJson(reader);
                } else {
                    reader.skipChildren();
                }
            }
