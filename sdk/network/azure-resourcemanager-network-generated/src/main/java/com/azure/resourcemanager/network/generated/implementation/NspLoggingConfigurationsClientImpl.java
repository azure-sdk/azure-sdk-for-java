...
/**
 * An instance of this class provides access to all the operations defined in NspLoggingConfigurationsClient.
 */
public final class NspLoggingConfigurationsClientImpl implements NspLoggingConfigurationsClient {
    /**
     * The proxy service used to perform REST calls.
     */
    private final NspLoggingConfigurationsService service;
    ...
    /**
     * Initializes an instance of NspLoggingConfigurationsClientImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    NspLoggingConfigurationsClientImpl(NetworkManagementClientImpl client) {
        this.service = RestProxy.create(NspLoggingConfigurationsService.class, client.getHttpPipeline(),
            client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for NetworkManagementClientNspLoggingConfigurations to be used by the
     * proxy service to perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "NetworkManagementCli")
    public interface NspLoggingConfigurationsService {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<NspLoggingConfigurationInner> getAsync(String resourceGroupName, String networkSecurityPerimeterName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<NspLoggingConfigurationInner> createOrUpdateAsync(String resourceGroupName,
        String networkSecurityPerimeterName, String loggingConfigurationName, NspLoggingConfigurationInner parameters) {
