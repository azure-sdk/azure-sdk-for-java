...
public final class NatGatewayImpl implements NatGateway, NatGateway.Definition, NatGateway.Update {
    ...
    public SubResource sourceVirtualNetwork() {
        return this.innerModel().sourceVirtualNetwork();
    }
    ...
    public NatGatewayImpl withSourceVirtualNetwork(SubResource sourceVirtualNetwork) {
        this.innerModel().withSourceVirtualNetwork(sourceVirtualNetwork);
        return this;
    }
