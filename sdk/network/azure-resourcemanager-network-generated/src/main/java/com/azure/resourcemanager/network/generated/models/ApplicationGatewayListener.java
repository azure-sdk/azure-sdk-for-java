...
public final class ApplicationGatewayListener extends SubResource {
     ...
     */
    public ApplicationGatewayListener withName(String name) {
        this.name = name;
        return this;
    }
     ...
     * @return the ApplicationGatewayListener object itself.
     */
    public ApplicationGatewayListener withFrontendIpConfiguration(SubResource frontendIpConfiguration) {
     ...
     * @return the ApplicationGatewayListener object itself.
     */
    public ApplicationGatewayListener withFrontendPort(SubResource frontendPort) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ApplicationGatewayListenerPropertiesFormat();
        }
     ...
     * @return the ApplicationGatewayListener object itself.
     */
    public ApplicationGatewayListener withProtocol(ApplicationGatewayProtocol protocol) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ApplicationGatewayListenerPropertiesFormat();
        }
     ...
     * @return the ApplicationGatewayListener object itself.
     */
    public ApplicationGatewayListener withSslCertificate(SubResource sslCertificate) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ApplicationGatewayListenerPropertiesFormat();
        }
     ...
     * @return the ApplicationGatewayListener object itself.
     */
    public ApplicationGatewayListener withSslProfile(SubResource sslProfile) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ApplicationGatewayListenerPropertiesFormat();
        }
