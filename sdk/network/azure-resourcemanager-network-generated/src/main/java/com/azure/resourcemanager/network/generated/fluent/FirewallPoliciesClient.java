...
public interface FirewallPoliciesClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<FirewallPolicyDraftInner>, FirewallPolicyDraftInner> beginDeployDraft(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    FirewallPolicyDraftInner deployDraft(String resourceGroupName, String firewallPolicyName);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    FirewallPolicyDraftInner deployDraft(String resourceGroupName, String firewallPolicyName, Context context);
