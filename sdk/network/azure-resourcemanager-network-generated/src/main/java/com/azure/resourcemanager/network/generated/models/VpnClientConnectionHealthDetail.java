...
public final class VpnClientConnectionHealthDetail implements JsonSerializable<VpnClientConnectionHealthDetail> {
    ...
    /**
     * Get the privateIpv6Address property: The assigned private Ipv6 of a connected vpn client.
     * 
     * @return the privateIpv6Address value.
     */
    ...
    public static VpnClientConnectionHealthDetail fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                } else if ("privateIpv6Address".equals(fieldName)) {
                    deserializedVpnClientConnectionHealthDetail.privateIpv6Address = reader.getString();
