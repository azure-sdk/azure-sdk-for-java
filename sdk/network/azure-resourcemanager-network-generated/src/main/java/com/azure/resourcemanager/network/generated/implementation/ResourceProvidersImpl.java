...
public final class ResourceProvidersImpl implements ResourceProviders {
    ...
    public SetSessionRecordingSasUrlResponse setSessionRecordingSasUrl(String resourceGroupName, String bastionHostname,
        String sasurl) {
        SetSessionRecordingSasUrlResponseInner inner
            = this.serviceClient().setSessionRecordingSasUrl(resourceGroupName, bastionHostname, sasurl);
        if (inner != null) {
            return new SetSessionRecordingSasUrlResponseImpl(inner, this.manager());
        } else {
            return null;
        }
    }
    ...
    public SetSessionRecordingSasUrlResponse setSessionRecordingSasUrl(String resourceGroupName, String bastionHostname,
        ...
        SetSessionRecordingSasUrlResponseInner inner
            = this.serviceClient().setSessionRecordingSasUrl(resourceGroupName, bastionHostname, sasurl, context);
        if (inner != null) {
            return new SetSessionRecordingSasUrlResponseImpl(inner, this.manager());
        } else {
            return null;
    ...
    public String getSessionRecordingSasUrl(String resourceGroupName, String bastionHostname) {
        return this.serviceClient().getSessionRecordingSasUrl(resourceGroupName, bastionHostname);
    }

    public String getSessionRecordingSasUrl(String resourceGroupName, String bastionHostname, Context context) {
        return this.serviceClient().getSessionRecordingSasUrl(resourceGroupName, bastionHostname, context);
    }
