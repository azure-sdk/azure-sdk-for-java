...
public final class GatewayRouteSetsInformationInner implements JsonSerializable<GatewayRouteSetsInformationInner> {
     ...
     */
    public GatewayRouteSetsInformationInner withLastComputedTime(String lastComputedTime) {
     ...
     * @return the GatewayRouteSetsInformationInner object itself.
     */
    public GatewayRouteSetsInformationInner withNextEligibleComputeTime(String nextEligibleComputeTime) {
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("lastComputedTime".equals(fieldName)) {
                    deserializedGatewayRouteSetsInformationInner.lastComputedTime = reader.getString();
                } else if ("nextEligibleComputeTime".equals(fieldName)) {
                    deserializedGatewayRouteSetsInformationInner.nextEligibleComputeTime = reader.getString();
