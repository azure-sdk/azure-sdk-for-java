...
import com.azure.resourcemanager.network.generated.fluent.models.ApplicationSecurityGroupPropertiesFormat;
 ...
 */
@Fluent
public final class ApplicationSecurityGroup extends Resource {
    /*
    ...
    /**
     * Creates an instance of ApplicationSecurityGroup class.
     */
     ...
     * @return the ApplicationSecurityGroup object itself.
     */
    public ApplicationSecurityGroup withId(String id) {
        this.id = id;
        return this;
    }
     ...
     */
    @Override
    public ApplicationSecurityGroup withLocation(String location) {
     ...
     */
    @Override
    public ApplicationSecurityGroup withTags(Map<String, String> tags) {
        super.withTags(tags);
        return this;
    }
