 ...
 */
public final class ExpressRouteGatewaysClientImpl implements ExpressRouteGatewaysClient {
    /**
    ...
    private Mono<Response<ExpressRouteGatewayListInner>> listBySubscriptionWithResponseAsync() {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ExpressRouteGatewayListInner> listBySubscriptionAsync() {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ExpressRouteGatewayListInner>>
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ExpressRouteGatewayInner> getByResourceGroupAsync(String resourceGroupName,
        String expressRouteGatewayName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> deleteAsync(String resourceGroupName, String expressRouteGatewayName) {
