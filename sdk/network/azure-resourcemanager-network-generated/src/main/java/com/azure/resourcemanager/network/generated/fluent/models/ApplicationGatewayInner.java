...
public final class ApplicationGatewayInner extends Resource {
    ...
    public Boolean networkIsolationEnabled() {
        return this.innerProperties() == null ? null : this.innerProperties().networkIsolationEnabled();
    }
     ...
     * @return the ApplicationGatewayInner object itself.
     */
    public ApplicationGatewayInner withNetworkIsolationEnabled(Boolean networkIsolationEnabled) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ApplicationGatewayPropertiesFormat();
        }
        this.innerProperties().withNetworkIsolationEnabled(networkIsolationEnabled);
        return this;
    }
