...
import com.azure.resourcemanager.network.generated.models.RoutingRuleListResult;
...
public final class RoutingRulesClientImpl implements RoutingRulesClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<RoutingRuleInner> getAsync(String resourceGroupName, String networkManagerName,
        String configurationName, String ruleCollectionName, String ruleName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<RoutingRuleInner> createOrUpdateAsync(String resourceGroupName, String networkManagerName,
