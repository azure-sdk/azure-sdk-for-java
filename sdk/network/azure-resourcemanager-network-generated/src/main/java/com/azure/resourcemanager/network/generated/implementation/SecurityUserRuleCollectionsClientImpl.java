...
import com.azure.resourcemanager.network.generated.models.SecurityUserRuleCollectionListResult;
 ...
 */
public final class SecurityUserRuleCollectionsClientImpl implements SecurityUserRuleCollectionsClient {
    /**
     * The proxy service used to perform REST calls.
     */
    private final SecurityUserRuleCollectionsService service;
    ...
    /**
     * Initializes an instance of SecurityUserRuleCollectionsClientImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    SecurityUserRuleCollectionsClientImpl(NetworkManagementClientImpl client) {
        this.service = RestProxy.create(SecurityUserRuleCollectionsService.class, client.getHttpPipeline(),
            client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for NetworkManagementClientSecurityUserRuleCollections to be used by the
     * proxy service to perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "NetworkManagementCli")
    public interface SecurityUserRuleCollectionsService {
        @Headers({ "Content-Type: application/json" })
        @Get("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/networkManagers/{networkManagerName}/securityUserConfigurations/{configurationName}/ruleCollections")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<SecurityUserRuleCollectionListResult>> list(@HostParam("$host") String endpoint,
        ...
        @Headers({ "Content-Type: application/json" })
        @Get("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/networkManagers/{networkManagerName}/securityUserConfigurations/{configurationName}/ruleCollections/{ruleCollectionName}")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<SecurityUserRuleCollectionInner>> get(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("networkManagerName") String networkManagerName,
        ...
        @Headers({ "Content-Type: application/json" })
        @Put("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/networkManagers/{networkManagerName}/securityUserConfigurations/{configurationName}/ruleCollections/{ruleCollectionName}")
        @ExpectedResponses({ 200, 201 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<SecurityUserRuleCollectionInner>> createOrUpdate(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("networkManagerName") String networkManagerName,
            @PathParam("configurationName") String configurationName,
            @PathParam("ruleCollectionName") String ruleCollectionName,
            @BodyParam("application/json") SecurityUserRuleCollectionInner securityUserRuleCollection,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<SecurityUserRuleCollectionListResult>> listNext(
     ...
     * @return security user configuration rule collection list result along with {@link PagedResponse} on successful
     * completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<SecurityUserRuleCollectionInner>> listSinglePageAsync(String resourceGroupName,
        ...
        return FluxUtil
            ...
            .<PagedResponse<SecurityUserRuleCollectionInner>>map(res -> new PagedResponseBase<>(res.getRequest(),
    ...
    private PagedFlux<SecurityUserRuleCollectionInner> listAsync(String resourceGroupName, String networkManagerName,
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<SecurityUserRuleCollectionInner> list(String resourceGroupName, String networkManagerName,
        String configurationName) {
        final Integer top = null;
        final String skipToken = null;
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<SecurityUserRuleCollectionInner>> getWithResponseAsync(String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<SecurityUserRuleCollectionInner> getAsync(String resourceGroupName, String networkManagerName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<SecurityUserRuleCollectionInner> getWithResponse(String resourceGroupName,
        String networkManagerName, String configurationName, String ruleCollectionName, Context context) {
        return getWithResponseAsync(resourceGroupName, networkManagerName, configurationName, ruleCollectionName,
            context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public SecurityUserRuleCollectionInner get(String resourceGroupName, String networkManagerName,
        String configurationName, String ruleCollectionName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<SecurityUserRuleCollectionInner>> createOrUpdateWithResponseAsync(String resourceGroupName,
        String networkManagerName, String configurationName, String ruleCollectionName,
        ...
        if (securityUserRuleCollection == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter securityUserRuleCollection is required and cannot be null."));
        } else {
            securityUserRuleCollection.validate();
        }
        final String apiVersion = "2024-03-01";
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.createOrUpdate(this.client.getEndpoint(), apiVersion,
                ...
                ruleCollectionName, securityUserRuleCollection, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<SecurityUserRuleCollectionInner>> createOrUpdateWithResponseAsync(String resourceGroupName,
        ...
        return service.createOrUpdate(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(),
            resourceGroupName, networkManagerName, configurationName, ruleCollectionName, securityUserRuleCollection,
            accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<SecurityUserRuleCollectionInner> createOrUpdateAsync(String resourceGroupName,
        String networkManagerName, String configurationName, String ruleCollectionName,
        SecurityUserRuleCollectionInner securityUserRuleCollection) {
        return createOrUpdateWithResponseAsync(resourceGroupName, networkManagerName, configurationName,
            ruleCollectionName, securityUserRuleCollection).flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<SecurityUserRuleCollectionInner> createOrUpdateWithResponse(String resourceGroupName,
        String networkManagerName, String configurationName, String ruleCollectionName,
        SecurityUserRuleCollectionInner securityUserRuleCollection, Context context) {
        return createOrUpdateWithResponseAsync(resourceGroupName, networkManagerName, configurationName,
            ruleCollectionName, securityUserRuleCollection, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public SecurityUserRuleCollectionInner createOrUpdate(String resourceGroupName, String networkManagerName,
        String configurationName, String ruleCollectionName,
        SecurityUserRuleCollectionInner securityUserRuleCollection) {
        return createOrUpdateWithResponse(resourceGroupName, networkManagerName, configurationName, ruleCollectionName,
            securityUserRuleCollection, Context.NONE).getValue();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<SecurityUserRuleCollectionInner>> listNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
