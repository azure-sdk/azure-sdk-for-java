...
import com.azure.resourcemanager.network.generated.models.NspAccessRuleListResult;
import reactor.core.publisher.Mono;

/**
 * An instance of this class provides access to all the operations defined in NspAccessRulesClient.
 */
public final class NspAccessRulesClientImpl implements NspAccessRulesClient {
    /**
     * The proxy service used to perform REST calls.
     */
    private final NspAccessRulesService service;
    ...
    /**
     * Initializes an instance of NspAccessRulesClientImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    NspAccessRulesClientImpl(NetworkManagementClientImpl client) {
        this.service
            = RestProxy.create(NspAccessRulesService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for NetworkManagementClientNspAccessRules to be used by the proxy service
     * to perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "NetworkManagementCli")
    public interface NspAccessRulesService {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<NspAccessRuleInner> getAsync(String resourceGroupName, String networkSecurityPerimeterName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<NspAccessRuleInner> createOrUpdateAsync(String resourceGroupName, String networkSecurityPerimeterName,
