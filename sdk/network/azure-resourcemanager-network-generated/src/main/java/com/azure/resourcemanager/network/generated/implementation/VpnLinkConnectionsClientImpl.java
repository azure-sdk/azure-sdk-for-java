...
public final class VpnLinkConnectionsClientImpl implements VpnLinkConnectionsClient {
    ...
    public interface VpnLinkConnectionsService {
        ...
        @Headers({ "Content-Type: application/json" })
        @Get("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/vpnGateways/{gatewayName}/vpnConnections/{connectionName}/vpnLinkConnections/{linkConnectionName}/sharedKey/{sharedKeyName}")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<SharedKeyInner>> sharedKeyGet(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("gatewayName") String gatewayName,
            @PathParam("connectionName") String connectionName,
            @PathParam("linkConnectionName") String linkConnectionName,
            @PathParam("sharedKeyName") String sharedKeyName, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, Context context);

        @Headers({ "Content-Type: application/json" })
        @Put("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/vpnGateways/{gatewayName}/vpnConnections/{connectionName}/vpnLinkConnections/{linkConnectionName}/sharedKey/{sharedKeyName}")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Flux<ByteBuffer>>> putSharedKey(@HostParam("$host") String endpoint,
            ...
            @PathParam("linkConnectionName") String linkConnectionName,
            @PathParam("sharedKeyName") String sharedKeyName, @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") SharedKeyProperties parameters, @HeaderParam("Accept") String accept,
            Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<SharedKeyInner>> sharedKeyGetWithResponseAsync(String resourceGroupName, String gatewayName,
        String connectionName, String linkConnectionName, String sharedKeyName) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        if (sharedKeyName == null) {
            return Mono.error(new IllegalArgumentException("Parameter sharedKeyName is required and cannot be null."));
        }
        final String apiVersion = "2023-11-01";
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.sharedKeyGet(this.client.getEndpoint(), this.client.getSubscriptionId(),
                resourceGroupName, gatewayName, connectionName, linkConnectionName, sharedKeyName, apiVersion, accept,
                context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<SharedKeyInner>> sharedKeyGetWithResponseAsync(String resourceGroupName, String gatewayName,
        ...
        return service.sharedKeyGet(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            gatewayName, connectionName, linkConnectionName, sharedKeyName, apiVersion, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<SharedKeyInner> sharedKeyGetAsync(String resourceGroupName, String gatewayName, String connectionName,
        ...
        return sharedKeyGetWithResponseAsync(resourceGroupName, gatewayName, connectionName, linkConnectionName,
            sharedKeyName).flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<SharedKeyInner> sharedKeyGetWithResponse(String resourceGroupName, String gatewayName,
        String connectionName, String linkConnectionName, String sharedKeyName, Context context) {
        return sharedKeyGetWithResponseAsync(resourceGroupName, gatewayName, connectionName, linkConnectionName,
            sharedKeyName, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public SharedKeyInner sharedKeyGet(String resourceGroupName, String gatewayName, String connectionName,
        String linkConnectionName, String sharedKeyName) {
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return vpnLink connection shared key Resource along with {@link Response} on successful completion of
     * {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> putSharedKeyWithResponseAsync(String resourceGroupName, String gatewayName,
        String connectionName, String linkConnectionName, String sharedKeyName, SharedKeyProperties parameters) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return FluxUtil
            .withContext(context -> service.putSharedKey(this.client.getEndpoint(), this.client.getSubscriptionId(),
                resourceGroupName, gatewayName, connectionName, linkConnectionName, sharedKeyName, apiVersion,
    ...
    private Mono<Response<Flux<ByteBuffer>>> putSharedKeyWithResponseAsync(String resourceGroupName, String gatewayName,
        ...
        return service.putSharedKey(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            gatewayName, connectionName, linkConnectionName, sharedKeyName, apiVersion, parameters, accept, context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the {@link PollerFlux} for polling of vpnLink connection shared key Resource.
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<SharedKeyInner>, SharedKeyInner> beginPutSharedKeyAsync(String resourceGroupName,
        String gatewayName, String connectionName, String linkConnectionName, String sharedKeyName,
        SharedKeyProperties parameters) {
        Mono<Response<Flux<ByteBuffer>>> mono = putSharedKeyWithResponseAsync(resourceGroupName, gatewayName,
            connectionName, linkConnectionName, sharedKeyName, parameters);
        return this.client.<SharedKeyInner, SharedKeyInner>getLroResult(mono, this.client.getHttpPipeline(),
            SharedKeyInner.class, SharedKeyInner.class, this.client.getContext());
    }
    ...
    private PollerFlux<PollResult<SharedKeyInner>, SharedKeyInner> beginPutSharedKeyAsync(String resourceGroupName,
        String gatewayName, String connectionName, String linkConnectionName, String sharedKeyName,
        SharedKeyProperties parameters, Context context) {
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono = putSharedKeyWithResponseAsync(resourceGroupName, gatewayName,
            connectionName, linkConnectionName, sharedKeyName, parameters, context);
        return this.client.<SharedKeyInner, SharedKeyInner>getLroResult(mono, this.client.getHttpPipeline(),
            SharedKeyInner.class, SharedKeyInner.class, context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the {@link SyncPoller} for polling of vpnLink connection shared key Resource.
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<SharedKeyInner>, SharedKeyInner> beginPutSharedKey(String resourceGroupName,
        String gatewayName, String connectionName, String linkConnectionName, String sharedKeyName,
        SharedKeyProperties parameters) {
        return this.beginPutSharedKeyAsync(resourceGroupName, gatewayName, connectionName, linkConnectionName,
            sharedKeyName, parameters).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<SharedKeyInner>, SharedKeyInner> beginPutSharedKey(String resourceGroupName,
        ...
        SharedKeyProperties parameters, Context context) {
        return this.beginPutSharedKeyAsync(resourceGroupName, gatewayName, connectionName, linkConnectionName,
            sharedKeyName, parameters, context).getSyncPoller();
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return vpnLink connection shared key Resource on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<SharedKeyInner> putSharedKeyAsync(String resourceGroupName, String gatewayName, String connectionName,
        String linkConnectionName, String sharedKeyName, SharedKeyProperties parameters) {
        return beginPutSharedKeyAsync(resourceGroupName, gatewayName, connectionName, linkConnectionName, sharedKeyName,
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<SharedKeyInner> putSharedKeyAsync(String resourceGroupName, String gatewayName, String connectionName,
        String linkConnectionName, String sharedKeyName, SharedKeyProperties parameters, Context context) {
        return beginPutSharedKeyAsync(resourceGroupName, gatewayName, connectionName, linkConnectionName, sharedKeyName,
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return vpnLink connection shared key Resource.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public SharedKeyInner putSharedKey(String resourceGroupName, String gatewayName, String connectionName,
        String linkConnectionName, String sharedKeyName, SharedKeyProperties parameters) {
        return putSharedKeyAsync(resourceGroupName, gatewayName, connectionName, linkConnectionName, sharedKeyName,
            parameters).block();
    }
