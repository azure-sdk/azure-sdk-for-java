...
public final class VpnLinkConnectionsClientImpl implements VpnLinkConnectionsClient {
    ...
    public interface VpnLinkConnectionsService {
        ...
        @Headers({ "Content-Type: application/json" })
        @Get("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/vpnGateways/{gatewayName}/vpnConnections/{connectionName}/vpnLinkConnections/{linkConnectionName}/sharedKey")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ConnectionSharedKeyAutoGeneratedInner>> sharedKeyGet(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("gatewayName") String gatewayName,
            @PathParam("connectionName") String connectionName,
            @PathParam("linkConnectionName") String linkConnectionName, @QueryParam("api-version") String apiVersion,
        ...
        @Headers({ "Content-Type: application/json" })
        @Post("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/vpnGateways/{gatewayName}/vpnConnections/{connectionName}/vpnLinkConnections/{linkConnectionName}/sharedKey")
        @ExpectedResponses({ 200, 202 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Flux<ByteBuffer>>> putSharedKey(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("gatewayName") String gatewayName,
            @PathParam("connectionName") String connectionName,
            @PathParam("linkConnectionName") String linkConnectionName, @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") ConnectionSharedKeyAutoGeneratedInner parameters,
            @HeaderParam("Accept") String accept, Context context);

        @Headers({ "Content-Type: application/json" })
        @Post("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/vpnGateways/{gatewayName}/vpnConnections/{connectionName}/vpnLinkConnections/{linkConnectionName}/sharedKey/reset")
        @ExpectedResponses({ 200, 202 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Flux<ByteBuffer>>> resetSharedKey(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("gatewayName") String gatewayName,
            @PathParam("connectionName") String connectionName,
            @PathParam("linkConnectionName") String linkConnectionName, @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") ConnectionResetSharedKeyAutoGeneratedInner parameters,
            @HeaderParam("Accept") String accept, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ConnectionSharedKeyAutoGeneratedInner>> sharedKeyGetWithResponseAsync(
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.sharedKeyGet(this.client.getEndpoint(), this.client.getSubscriptionId(),
                resourceGroupName, gatewayName, connectionName, linkConnectionName, apiVersion, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<ConnectionSharedKeyAutoGeneratedInner>> sharedKeyGetWithResponseAsync(
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.sharedKeyGet(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            gatewayName, connectionName, linkConnectionName, apiVersion, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ConnectionSharedKeyAutoGeneratedInner> sharedKeyGetAsync(String resourceGroupName, String gatewayName,
        String connectionName, String linkConnectionName) {
        return sharedKeyGetWithResponseAsync(resourceGroupName, gatewayName, connectionName, linkConnectionName)
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ConnectionSharedKeyAutoGeneratedInner> sharedKeyGetWithResponse(String resourceGroupName,
        String gatewayName, String connectionName, String linkConnectionName, Context context) {
        return sharedKeyGetWithResponseAsync(resourceGroupName, gatewayName, connectionName, linkConnectionName,
            context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ConnectionSharedKeyAutoGeneratedInner sharedKeyGet(String resourceGroupName, String gatewayName,
        String connectionName, String linkConnectionName) {
        return sharedKeyGetWithResponse(resourceGroupName, gatewayName, connectionName, linkConnectionName,
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return response for get VpnLink connection shared key value service call along with {@link Response} on
     * successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> putSharedKeyWithResponseAsync(String resourceGroupName, String gatewayName,
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.putSharedKey(this.client.getEndpoint(), this.client.getSubscriptionId(),
                resourceGroupName, gatewayName, connectionName, linkConnectionName, apiVersion, parameters, accept,
                context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> putSharedKeyWithResponseAsync(String resourceGroupName, String gatewayName,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.putSharedKey(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            gatewayName, connectionName, linkConnectionName, apiVersion, parameters, accept, context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the {@link PollerFlux} for polling of response for get VpnLink connection shared key value service call.
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<ConnectionSharedKeyAutoGeneratedInner>, ConnectionSharedKeyAutoGeneratedInner>
        beginPutSharedKeyAsync(String resourceGroupName, String gatewayName, String connectionName,
            String linkConnectionName, ConnectionSharedKeyAutoGeneratedInner parameters) {
        Mono<Response<Flux<ByteBuffer>>> mono = putSharedKeyWithResponseAsync(resourceGroupName, gatewayName,
            connectionName, linkConnectionName, parameters);
        return this.client.<ConnectionSharedKeyAutoGeneratedInner, ConnectionSharedKeyAutoGeneratedInner>getLroResult(
            mono, this.client.getHttpPipeline(), ConnectionSharedKeyAutoGeneratedInner.class,
            ConnectionSharedKeyAutoGeneratedInner.class, this.client.getContext());
    }
    ...
    private PollerFlux<PollResult<ConnectionSharedKeyAutoGeneratedInner>, ConnectionSharedKeyAutoGeneratedInner>
        ...
        return this.client.<ConnectionSharedKeyAutoGeneratedInner, ConnectionSharedKeyAutoGeneratedInner>getLroResult(
            mono, this.client.getHttpPipeline(), ConnectionSharedKeyAutoGeneratedInner.class,
            ConnectionSharedKeyAutoGeneratedInner.class, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<ConnectionSharedKeyAutoGeneratedInner>, ConnectionSharedKeyAutoGeneratedInner>
        beginPutSharedKey(String resourceGroupName, String gatewayName, String connectionName,
            String linkConnectionName, ConnectionSharedKeyAutoGeneratedInner parameters) {
        return this
            .beginPutSharedKeyAsync(resourceGroupName, gatewayName, connectionName, linkConnectionName, parameters)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<ConnectionSharedKeyAutoGeneratedInner>, ConnectionSharedKeyAutoGeneratedInner>
        beginPutSharedKey(String resourceGroupName, String gatewayName, String connectionName,
            String linkConnectionName, ConnectionSharedKeyAutoGeneratedInner parameters, Context context) {
        return this.beginPutSharedKeyAsync(resourceGroupName, gatewayName, connectionName, linkConnectionName,
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return response for get VpnLink connection shared key value service call on successful completion of
     * {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ConnectionSharedKeyAutoGeneratedInner> putSharedKeyAsync(String resourceGroupName, String gatewayName,
        String connectionName, String linkConnectionName, ConnectionSharedKeyAutoGeneratedInner parameters) {
        return beginPutSharedKeyAsync(resourceGroupName, gatewayName, connectionName, linkConnectionName, parameters)
            .last().flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ConnectionSharedKeyAutoGeneratedInner putSharedKey(String resourceGroupName, String gatewayName,
        String connectionName, String linkConnectionName, ConnectionSharedKeyAutoGeneratedInner parameters) {
        return putSharedKeyAsync(resourceGroupName, gatewayName, connectionName, linkConnectionName, parameters)
            .block();
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the VpnLink connection reset shared key along with {@link Response} on successful completion of
     * {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> resetSharedKeyWithResponseAsync(String resourceGroupName,
        String gatewayName, String connectionName, String linkConnectionName,
        ConnectionResetSharedKeyAutoGeneratedInner parameters) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.resetSharedKey(this.client.getEndpoint(), this.client.getSubscriptionId(),
                resourceGroupName, gatewayName, connectionName, linkConnectionName, apiVersion, parameters, accept,
                context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> resetSharedKeyWithResponseAsync(String resourceGroupName,
        String gatewayName, String connectionName, String linkConnectionName,
        ConnectionResetSharedKeyAutoGeneratedInner parameters, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.resetSharedKey(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            gatewayName, connectionName, linkConnectionName, apiVersion, parameters, accept, context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the {@link PollerFlux} for polling of the VpnLink connection reset shared key.
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private
        PollerFlux<PollResult<ConnectionResetSharedKeyAutoGeneratedInner>, ConnectionResetSharedKeyAutoGeneratedInner>
        beginResetSharedKeyAsync(String resourceGroupName, String gatewayName, String connectionName,
            String linkConnectionName, ConnectionResetSharedKeyAutoGeneratedInner parameters) {
        Mono<Response<Flux<ByteBuffer>>> mono = resetSharedKeyWithResponseAsync(resourceGroupName, gatewayName,
            connectionName, linkConnectionName, parameters);
        return this.client
            .<ConnectionResetSharedKeyAutoGeneratedInner, ConnectionResetSharedKeyAutoGeneratedInner>getLroResult(mono,
                this.client.getHttpPipeline(), ConnectionResetSharedKeyAutoGeneratedInner.class,
                ConnectionResetSharedKeyAutoGeneratedInner.class, this.client.getContext());
    }
    ...
    private
        ...
        return this.client
            .<ConnectionResetSharedKeyAutoGeneratedInner, ConnectionResetSharedKeyAutoGeneratedInner>getLroResult(mono,
                this.client.getHttpPipeline(), ConnectionResetSharedKeyAutoGeneratedInner.class,
                ConnectionResetSharedKeyAutoGeneratedInner.class, context);
    }
    ...
    public
        ...
        beginResetSharedKey(String resourceGroupName, String gatewayName, String connectionName,
            String linkConnectionName, ConnectionResetSharedKeyAutoGeneratedInner parameters) {
        return this
            .beginResetSharedKeyAsync(resourceGroupName, gatewayName, connectionName, linkConnectionName, parameters)
            .getSyncPoller();
    }
    ...
    public
        ...
        beginResetSharedKey(String resourceGroupName, String gatewayName, String connectionName,
            String linkConnectionName, ConnectionResetSharedKeyAutoGeneratedInner parameters, Context context) {
        return this.beginResetSharedKeyAsync(resourceGroupName, gatewayName, connectionName, linkConnectionName,
            parameters, context).getSyncPoller();
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the VpnLink connection reset shared key on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ConnectionResetSharedKeyAutoGeneratedInner> resetSharedKeyAsync(String resourceGroupName,
        String gatewayName, String connectionName, String linkConnectionName,
        ConnectionResetSharedKeyAutoGeneratedInner parameters) {
        return beginResetSharedKeyAsync(resourceGroupName, gatewayName, connectionName, linkConnectionName, parameters)
            .last().flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ConnectionResetSharedKeyAutoGeneratedInner resetSharedKey(String resourceGroupName, String gatewayName,
        String connectionName, String linkConnectionName, ConnectionResetSharedKeyAutoGeneratedInner parameters) {
        return resetSharedKeyAsync(resourceGroupName, gatewayName, connectionName, linkConnectionName, parameters)
            .block();
    }
