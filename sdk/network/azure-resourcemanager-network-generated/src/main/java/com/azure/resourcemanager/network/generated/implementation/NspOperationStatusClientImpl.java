 ...
 */
public final class NspOperationStatusClientImpl implements NspOperationStatusClient {
    /**
     * The proxy service used to perform REST calls.
     */
    private final NspOperationStatusService service;
    ...
    /**
     * Initializes an instance of NspOperationStatusClientImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    NspOperationStatusClientImpl(NetworkManagementClientImpl client) {
        this.service = RestProxy.create(NspOperationStatusService.class, client.getHttpPipeline(),
            client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for NetworkManagementClientNspOperationStatus to be used by the proxy
     * service to perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "NetworkManagementCli")
    public interface NspOperationStatusService {
