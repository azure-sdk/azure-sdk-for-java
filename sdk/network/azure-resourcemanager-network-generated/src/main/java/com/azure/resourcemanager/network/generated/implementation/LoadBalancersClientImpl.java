...
public final class LoadBalancersClientImpl implements LoadBalancersClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<LoadBalancerInner>, LoadBalancerInner>
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<LoadBalancerInner> updateTagsAsync(String resourceGroupName, String loadBalancerName,
