...
public final class PublicIpAddressesClientImpl implements PublicIpAddressesClient {
    ...
    public interface PublicIpAddressesService {
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<PublicIpAddressListResult>> listCloudServicePublicIpAddress(
            @HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("cloudServiceName") String cloudServiceName,
            @QueryParam("api-version") String apiVersion,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<PublicIpAddressListResult>> listCloudServiceRoleInstancePublicIpAddress(
            @HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("cloudServiceName") String cloudServiceName,
            @PathParam("roleInstanceName") String roleInstanceName,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<PublicIpAddressInner>> getCloudServiceRoleInstancePublicIpAddress(
            @HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("cloudServiceName") String cloudServiceName,
            @PathParam("roleInstanceName") String roleInstanceName,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<PublicIpAddressListResult>> listCloudServicePublicIpAddressNext(
            @PathParam(value = "nextLink", encoded = true) String nextLink,
            @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<PublicIpAddressListResult>> listCloudServiceRoleInstancePublicIpAddressNext(
            @PathParam(value = "nextLink", encoded = true) String nextLink,
            @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept,
            Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<PublicIpAddressInner>> listCloudServicePublicIpAddressSinglePageAsync(
        String resourceGroupName, String cloudServiceName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<PublicIpAddressInner> listCloudServicePublicIpAddressAsync(
        String resourceGroupName, String cloudServiceName) {
        return new PagedFlux<>(
            () -> listCloudServicePublicIpAddressSinglePageAsync(resourceGroupName, cloudServiceName),
            nextLink -> listCloudServicePublicIpAddressNextSinglePageAsync(nextLink));
    }
    ...
    private PagedFlux<PublicIpAddressInner> listCloudServicePublicIpAddressAsync(
        String resourceGroupName, String cloudServiceName, Context context) {
        return new PagedFlux<>(
            () -> listCloudServicePublicIpAddressSinglePageAsync(resourceGroupName, cloudServiceName, context),
            nextLink -> listCloudServicePublicIpAddressNextSinglePageAsync(nextLink, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<PublicIpAddressInner> listCloudServicePublicIpAddress(
        String resourceGroupName, String cloudServiceName) {
        return new PagedIterable<>(listCloudServicePublicIpAddressAsync(resourceGroupName, cloudServiceName));
    }
    ...
    public PagedIterable<PublicIpAddressInner> listCloudServicePublicIpAddress(
        String resourceGroupName, String cloudServiceName, Context context) {
        return new PagedIterable<>(listCloudServicePublicIpAddressAsync(resourceGroupName, cloudServiceName, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<PublicIpAddressInner>> listCloudServiceRoleInstancePublicIpAddressSinglePageAsync(
        String resourceGroupName,
        String cloudServiceName,
        String roleInstanceName,
        String networkInterfaceName,
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<PublicIpAddressInner> listCloudServiceRoleInstancePublicIpAddressAsync(
        String resourceGroupName,
        String cloudServiceName,
        String roleInstanceName,
        String networkInterfaceName,
        ...
        return new PagedFlux<>(
            () ->
                listCloudServiceRoleInstancePublicIpAddressSinglePageAsync(
                    resourceGroupName, cloudServiceName, roleInstanceName, networkInterfaceName, ipConfigurationName),
            nextLink -> listCloudServiceRoleInstancePublicIpAddressNextSinglePageAsync(nextLink));
    }
        ...
        return new PagedFlux<>(
            () ->
                listCloudServiceRoleInstancePublicIpAddressSinglePageAsync(
                    ...
                    ipConfigurationName,
                    context),
            nextLink -> listCloudServiceRoleInstancePublicIpAddressNextSinglePageAsync(nextLink, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<PublicIpAddressInner> listCloudServiceRoleInstancePublicIpAddress(
        String resourceGroupName,
        String cloudServiceName,
        String roleInstanceName,
        String networkInterfaceName,
        String ipConfigurationName) {
        return new PagedIterable<>(
            listCloudServiceRoleInstancePublicIpAddressAsync(
                resourceGroupName, cloudServiceName, roleInstanceName, networkInterfaceName, ipConfigurationName));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<PublicIpAddressInner>> getCloudServiceRoleInstancePublicIpAddressWithResponseAsync(
        String resourceGroupName,
        String cloudServiceName,
        String roleInstanceName,
        String networkInterfaceName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PublicIpAddressInner> getCloudServiceRoleInstancePublicIpAddressAsync(
        String resourceGroupName,
        String cloudServiceName,
        String roleInstanceName,
        String networkInterfaceName,
        String ipConfigurationName,
        String publicIpAddressName) {
        return getCloudServiceRoleInstancePublicIpAddressWithResponseAsync(
                resourceGroupName,
                cloudServiceName,
                roleInstanceName,
                networkInterfaceName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<PublicIpAddressInner> getCloudServiceRoleInstancePublicIpAddressWithResponse(
        String resourceGroupName,
        String cloudServiceName,
        String roleInstanceName,
        String networkInterfaceName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public PublicIpAddressInner getCloudServiceRoleInstancePublicIpAddress(
        String resourceGroupName,
        String cloudServiceName,
        String roleInstanceName,
        String networkInterfaceName,
        String ipConfigurationName,
        String publicIpAddressName) {
        return getCloudServiceRoleInstancePublicIpAddressWithResponse(
                resourceGroupName,
                cloudServiceName,
                roleInstanceName,
                networkInterfaceName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<PublicIpAddressInner>> listCloudServicePublicIpAddressNextSinglePageAsync(
        String nextLink) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        ...
        return FluxUtil
            .withContext(
                context ->
                    service.listCloudServicePublicIpAddressNext(nextLink, this.client.getEndpoint(), accept, context))
            .<PagedResponse<PublicIpAddressInner>>map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(),
    ...
    private Mono<PagedResponse<PublicIpAddressInner>> listCloudServicePublicIpAddressNextSinglePageAsync(
        ...
        context = this.client.mergeContext(context);
        return service
            .listCloudServicePublicIpAddressNext(nextLink, this.client.getEndpoint(), accept, context)
            .map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<PublicIpAddressInner>> listCloudServiceRoleInstancePublicIpAddressNextSinglePageAsync(
        String nextLink) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
    ...
    private Mono<PagedResponse<PublicIpAddressInner>> listCloudServiceRoleInstancePublicIpAddressNextSinglePageAsync(
        ...
        context = this.client.mergeContext(context);
        return service
            .listCloudServiceRoleInstancePublicIpAddressNext(nextLink, this.client.getEndpoint(), accept, context)
            .map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(),
