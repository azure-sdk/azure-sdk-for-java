...
@Fluent
public final class FlowLogInformationResponseInner {
    /*
    ...
    private ResultIdentityObjectForUserAssigned identity;

    /** Creates an instance of FlowLogInformationResponseInner class. */
    public FlowLogInformationResponseInner() {
    }
     ...
     * @return the FlowLogInformationResponseInner object itself.
     */
    public FlowLogInformationResponseInner withTargetResourceId(String targetResourceId) {
     ...
     * @return the FlowLogInformationResponseInner object itself.
     */
    public FlowLogInformationResponseInner withFlowAnalyticsConfiguration(
     ...
     * @return the FlowLogInformationResponseInner object itself.
     */
    public FlowLogInformationResponseInner withIdentity(ResultIdentityObjectForUserAssigned identity) {
     ...
     * @return the FlowLogInformationResponseInner object itself.
     */
    public FlowLogInformationResponseInner withStorageId(String storageId) {
     ...
     * @return the FlowLogInformationResponseInner object itself.
     */
    public FlowLogInformationResponseInner withEnabled(boolean enabled) {
        if (this.innerProperties() == null) {
            this.innerProperties = new FlowLogProperties();
        }
     ...
     * @return the FlowLogInformationResponseInner object itself.
     */
    public FlowLogInformationResponseInner withRetentionPolicy(RetentionPolicyParameters retentionPolicy) {
        if (this.innerProperties() == null) {
            this.innerProperties = new FlowLogProperties();
        }
     ...
     * @return the FlowLogInformationResponseInner object itself.
     */
    public FlowLogInformationResponseInner withFormat(FlowLogFormatParameters format) {
        if (this.innerProperties() == null) {
            this.innerProperties = new FlowLogProperties();
        }
            ...
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException(
                        "Missing required property targetResourceId in model FlowLogInformationResponseInner"));
        }
        if (innerProperties() == null) {
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException(
                        "Missing required property innerProperties in model FlowLogInformationResponseInner"));
        } else {
    ...
    private static final ClientLogger LOGGER = new ClientLogger(FlowLogInformationResponseInner.class);
}
