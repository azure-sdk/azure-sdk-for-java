...
import com.azure.resourcemanager.network.generated.models.ListRouteMapsResult;
...
public final class RouteMapsClientImpl implements RouteMapsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<RouteMapInner> getAsync(String resourceGroupName, String virtualHubName, String routeMapName) {
