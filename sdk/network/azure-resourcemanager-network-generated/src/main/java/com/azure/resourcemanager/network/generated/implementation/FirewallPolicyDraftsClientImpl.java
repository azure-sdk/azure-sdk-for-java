 ...
 */
public final class FirewallPolicyDraftsClientImpl implements FirewallPolicyDraftsClient {
    /**
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<FirewallPolicyDraftInner> createOrUpdateAsync(String resourceGroupName, String firewallPolicyName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<FirewallPolicyDraftInner> getAsync(String resourceGroupName, String firewallPolicyName) {
