...
import com.azure.resourcemanager.network.generated.models.AvailableServiceAliasesResult;
...
public final class AvailableServiceAliasesClientImpl implements AvailableServiceAliasesClient {
    ...
    AvailableServiceAliasesClientImpl(NetworkManagementClientImpl client) {
        this.service = RestProxy.create(AvailableServiceAliasesService.class, client.getHttpPipeline(),
    ...
    public interface AvailableServiceAliasesService {
        ...
        Mono<Response<AvailableServiceAliasesResult>> list(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<AvailableServiceAliasesResult>> listByResourceGroup(@HostParam("$host") String endpoint,
    ...
    private Mono<PagedResponse<AvailableServiceAliasInner>> listSinglePageAsync(String location) {
        ...
        return FluxUtil
            ...
            .<PagedResponse<AvailableServiceAliasInner>>map(res -> new PagedResponseBase<>(res.getRequest(),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<AvailableServiceAliasInner>> listByResourceGroupSinglePageAsync(String resourceGroupName,
        String location) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
    ...
    private Mono<PagedResponse<AvailableServiceAliasInner>> listByResourceGroupSinglePageAsync(String resourceGroupName,
        ...
        context = this.client.mergeContext(context);
        return service
            .listByResourceGroup(this.client.getEndpoint(), resourceGroupName, location,
                this.client.getSubscriptionId(), apiVersion, accept, context)
            .map(res -> new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(),
                res.getValue().value(), res.getValue().nextLink(), null));
    }
