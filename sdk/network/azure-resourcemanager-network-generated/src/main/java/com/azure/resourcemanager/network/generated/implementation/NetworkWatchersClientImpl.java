...
public final class NetworkWatchersClientImpl implements NetworkWatchersClient {
    ...
    public interface NetworkWatchersService {
        ...
        Mono<Response<Flux<ByteBuffer>>> setFlowLogConfiguration(
            ...
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @BodyParam("application/json") FlowLogInformationRequest parameters,
            @HeaderParam("Accept") String accept,
            Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<NetworkWatcherInner> createOrUpdateAsync(
        String resourceGroupName, String networkWatcherName, NetworkWatcherInner parameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<NetworkWatcherInner> updateTagsAsync(
        String resourceGroupName, String networkWatcherName, TagsObject parameters) {
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return all network watchers by subscription along with {@link PagedResponse} on successful completion of {@link
     *     Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<TopologyInner> getTopologyAsync(
        String resourceGroupName, String networkWatcherName, TopologyParameters parameters) {
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the configured and effective security group rules on the specified VM on successful completion of {@link
     *     Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the last completed troubleshooting result on a specified resource on successful completion of {@link
     *     Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ...
    private Mono<Response<Flux<ByteBuffer>>> setFlowLogConfigurationWithResponseAsync(
        String resourceGroupName, String networkWatcherName, FlowLogInformationRequest parameters) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> setFlowLogConfigurationWithResponseAsync(
        String resourceGroupName, String networkWatcherName, FlowLogInformationRequest parameters, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<FlowLogInformationResponseInner>, FlowLogInformationResponseInner>
        ...
        return this
            .client
            .<FlowLogInformationResponseInner, FlowLogInformationResponseInner>getLroResult(
                mono,
                this.client.getHttpPipeline(),
                FlowLogInformationResponseInner.class,
                FlowLogInformationResponseInner.class,
                this.client.getContext());
    }
    ...
    private PollerFlux<PollResult<FlowLogInformationResponseInner>, FlowLogInformationResponseInner>
        beginSetFlowLogConfigurationAsync(
            String resourceGroupName,
            String networkWatcherName,
            FlowLogInformationRequest parameters,
            Context context) {
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono =
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<FlowLogInformationResponseInner>, FlowLogInformationResponseInner>
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<FlowLogInformationResponseInner> setFlowLogConfigurationAsync(
        String resourceGroupName, String networkWatcherName, FlowLogInformationRequest parameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public FlowLogInformationResponseInner setFlowLogConfiguration(
        String resourceGroupName, String networkWatcherName, FlowLogInformationRequest parameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<FlowLogInformationResponseInner> getFlowLogStatusAsync(
        String resourceGroupName, String networkWatcherName, FlowLogStatusParameters parameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public FlowLogInformationResponseInner getFlowLogStatus(
        String resourceGroupName, String networkWatcherName, FlowLogStatusParameters parameters) {
