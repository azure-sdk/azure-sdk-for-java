...
public final class FirewallPoliciesClientImpl implements FirewallPoliciesClient {
    ...
    public interface FirewallPoliciesService {
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Object>> deleteDraft(
            @HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("firewallPolicyName") String firewallPolicyName,
            @QueryParam("api-version") String apiVersion,
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return firewallPolicy Draft Object along with {@link Response} on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return firewallPolicy Draft Object on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ...
    private Mono<FirewallPolicyDraftInner> getDraftAsync(String resourceGroupName, String firewallPolicyName) {
        return getDraftWithResponseAsync(resourceGroupName, firewallPolicyName)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
    ...
    public Response<FirewallPolicyDraftInner> getDraftWithResponse(
        String resourceGroupName, String firewallPolicyName, Context context) {
        return getDraftWithResponseAsync(resourceGroupName, firewallPolicyName, context).block();
    }
    ...
    public FirewallPolicyDraftInner getDraft(String resourceGroupName, String firewallPolicyName) {
        return getDraftWithResponse(resourceGroupName, firewallPolicyName, Context.NONE).getValue();
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the {@link PollerFlux} for polling of firewallPolicy Draft Object.
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<FirewallPolicyDraftInner>, FirewallPolicyDraftInner> beginDeployDraftAsync(
        String resourceGroupName, String firewallPolicyName) {
        Mono<Response<Flux<ByteBuffer>>> mono = deployDraftWithResponseAsync(resourceGroupName, firewallPolicyName);
        return this
            .client
            .<FirewallPolicyDraftInner, FirewallPolicyDraftInner>getLroResult(
                mono,
                this.client.getHttpPipeline(),
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<FirewallPolicyDraftInner>, FirewallPolicyDraftInner> beginDeployDraft(
        String resourceGroupName, String firewallPolicyName) {
        return this.beginDeployDraftAsync(resourceGroupName, firewallPolicyName).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<FirewallPolicyDraftInner>, FirewallPolicyDraftInner> beginDeployDraft(
        String resourceGroupName, String firewallPolicyName, Context context) {
        return this.beginDeployDraftAsync(resourceGroupName, firewallPolicyName, context).getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<FirewallPolicyDraftInner> deployDraftAsync(String resourceGroupName, String firewallPolicyName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<FirewallPolicyDraftInner> deployDraftAsync(
        String resourceGroupName, String firewallPolicyName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public FirewallPolicyDraftInner deployDraft(String resourceGroupName, String firewallPolicyName) {
        return deployDraftAsync(resourceGroupName, firewallPolicyName).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public FirewallPolicyDraftInner deployDraft(String resourceGroupName, String firewallPolicyName, Context context) {
        return deployDraftAsync(resourceGroupName, firewallPolicyName, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Object>> deleteDraftWithResponseAsync(String resourceGroupName, String firewallPolicyName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Object>> deleteDraftWithResponseAsync(
        String resourceGroupName, String firewallPolicyName, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Object> deleteDraftAsync(String resourceGroupName, String firewallPolicyName) {
        return deleteDraftWithResponseAsync(resourceGroupName, firewallPolicyName)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<Object> deleteDraftWithResponse(
        String resourceGroupName, String firewallPolicyName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Object deleteDraft(String resourceGroupName, String firewallPolicyName) {
        return deleteDraftWithResponse(resourceGroupName, firewallPolicyName, Context.NONE).getValue();
    }
