...
import com.azure.resourcemanager.network.generated.models.ListRoutingIntentResult;
...
public final class RoutingIntentsClientImpl implements RoutingIntentsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<RoutingIntentInner> getAsync(String resourceGroupName, String virtualHubName,
        String routingIntentName) {
    ...
    private PagedFlux<RoutingIntentInner> listAsync(String resourceGroupName, String virtualHubName) {
