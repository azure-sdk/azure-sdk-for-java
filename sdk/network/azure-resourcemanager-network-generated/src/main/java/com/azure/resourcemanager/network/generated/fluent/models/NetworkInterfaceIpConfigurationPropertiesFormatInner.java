...
public final class NetworkInterfaceIpConfigurationPropertiesFormatInner {
    ...
    /*
     * The prefix address in CIDR format.
     */
    @JsonProperty(value = "privateIPAddressPrefix")
    private String privateIpAddressPrefix;

    /*
     * The /n prefix length of the address prefix. Must be /28 or /32 for IPv4, and /80 or /128 for IPv6.
     */
    ...
    /**
     * Get the privateIpAddressPrefix property: The prefix address in CIDR format.
     * 
     * @return the privateIpAddressPrefix value.
     */
    public String privateIpAddressPrefix() {
        return this.privateIpAddressPrefix;
    }

    /**
     * Set the privateIpAddressPrefix property: The prefix address in CIDR format.
     * 
     * @param privateIpAddressPrefix the privateIpAddressPrefix value to set.
     * @return the NetworkInterfaceIpConfigurationPropertiesFormatInner object itself.
     */
    public NetworkInterfaceIpConfigurationPropertiesFormatInner
        withPrivateIpAddressPrefix(String privateIpAddressPrefix) {
        this.privateIpAddressPrefix = privateIpAddressPrefix;
        return this;
    }

    /**
     * Get the privateIpAddressPrefixLength property: The /n prefix length of the address prefix. Must be /28 or /32
     * for IPv4, and /80 or /128 for IPv6.
     * 
    ...
    /**
     * Set the privateIpAddressPrefixLength property: The /n prefix length of the address prefix. Must be /28 or /32
     * for IPv4, and /80 or /128 for IPv6.
     * 
