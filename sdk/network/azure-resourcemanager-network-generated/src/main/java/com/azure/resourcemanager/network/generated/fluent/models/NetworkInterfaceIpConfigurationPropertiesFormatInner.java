...
public final class NetworkInterfaceIpConfigurationPropertiesFormatInner {
    ...
    /**
     * Get the privateIpAddress property: Private IP address of the IP configuration. It can be a single IP address or
    ...
    /**
     * Set the privateIpAddress property: Private IP address of the IP configuration. It can be a single IP address or
     * a CIDR block in the format &lt;address&gt;/&lt;prefix-length&gt;.
     * 
