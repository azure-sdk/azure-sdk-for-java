...
public final class AzureFirewallImpl implements AzureFirewall, AzureFirewall.Definition, AzureFirewall.Update {
    ...
    public AzureFirewallAutoScaleSettings autoscaleSettings() {
        return this.innerModel().autoscaleSettings();
    }
    ...
    public AzureFirewallImpl withAutoscaleSettings(AzureFirewallAutoScaleSettings autoscaleSettings) {
        this.innerModel().withAutoscaleSettings(autoscaleSettings);
        return this;
    }
