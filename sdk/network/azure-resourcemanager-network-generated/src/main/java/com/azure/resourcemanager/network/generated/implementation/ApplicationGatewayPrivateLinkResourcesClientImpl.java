...
public final class ApplicationGatewayPrivateLinkResourcesClientImpl
    ...
    ApplicationGatewayPrivateLinkResourcesClientImpl(NetworkManagementClientImpl client) {
        this.service = RestProxy.create(ApplicationGatewayPrivateLinkResourcesService.class, client.getHttpPipeline(),
    ...
    public interface ApplicationGatewayPrivateLinkResourcesService {
        ...
        Mono<Response<ApplicationGatewayPrivateLinkResourceListResult>> list(@HostParam("$host") String endpoint,
