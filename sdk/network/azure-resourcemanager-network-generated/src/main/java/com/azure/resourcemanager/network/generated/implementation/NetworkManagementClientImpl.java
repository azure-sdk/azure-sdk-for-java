...
public final class NetworkManagementClientImpl implements NetworkManagementClient {
    ...
    /** The AnalysisIntentsClient object to access its operations. */
    private final AnalysisIntentsClient analysisIntents;

    /**
     * Gets the AnalysisIntentsClient object to access its operations.
     *
     * @return the AnalysisIntentsClient object.
     */
    public AnalysisIntentsClient getAnalysisIntents() {
        return this.analysisIntents;
    }

    /** The AnalysisRunsClient object to access its operations. */
    private final AnalysisRunsClient analysisRuns;

    /**
     * Gets the AnalysisRunsClient object to access its operations.
     *
     * @return the AnalysisRunsClient object.
     */
    public AnalysisRunsClient getAnalysisRuns() {
        return this.analysisRuns;
    }

    /** The ConfigurationSnapshotsClient object to access its operations. */
    private final ConfigurationSnapshotsClient configurationSnapshots;

    /**
     * Gets the ConfigurationSnapshotsClient object to access its operations.
     *
     * @return the ConfigurationSnapshotsClient object.
     */
    public ConfigurationSnapshotsClient getConfigurationSnapshots() {
        return this.configurationSnapshots;
    }

    /** The NetworkVerifiersClient object to access its operations. */
    private final NetworkVerifiersClient networkVerifiers;

    /**
     * Gets the NetworkVerifiersClient object to access its operations.
     *
     * @return the NetworkVerifiersClient object.
     */
    public NetworkVerifiersClient getNetworkVerifiers() {
        return this.networkVerifiers;
    }
    ...
    NetworkManagementClientImpl(
        ...
        this.endpoint = endpoint;
        this.analysisIntents = new AnalysisIntentsClientImpl(this);
        this.analysisRuns = new AnalysisRunsClientImpl(this);
        this.configurationSnapshots = new ConfigurationSnapshotsClientImpl(this);
        this.networkVerifiers = new NetworkVerifiersClientImpl(this);
