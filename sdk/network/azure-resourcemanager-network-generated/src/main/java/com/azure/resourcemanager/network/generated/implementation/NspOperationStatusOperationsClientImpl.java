...
/**
 * An instance of this class provides access to all the operations defined in NspOperationStatusOperationsClient.
 */
public final class NspOperationStatusOperationsClientImpl implements NspOperationStatusOperationsClient {
    /**
     * The proxy service used to perform REST calls.
     */
    private final NspOperationStatusOperationsService service;
    ...
    /**
     * Initializes an instance of NspOperationStatusOperationsClientImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    NspOperationStatusOperationsClientImpl(NetworkManagementClientImpl client) {
        this.service = RestProxy.create(NspOperationStatusOperationsService.class, client.getHttpPipeline(),
            client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for NetworkManagementClientNspOperationStatusOperations to be used by the
     * proxy service to perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "NetworkManagementCli")
    public interface NspOperationStatusOperationsService {
        ...
        Mono<Response<NspOperationStatusInner>> get(@HostParam("$host") String endpoint,
    ...
    private Mono<Response<NspOperationStatusInner>> getWithResponseAsync(String location, String operationId) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<NspOperationStatusInner> getAsync(String location, String operationId) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<NspOperationStatusInner> getWithResponse(String location, String operationId, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public NspOperationStatusInner get(String location, String operationId) {
