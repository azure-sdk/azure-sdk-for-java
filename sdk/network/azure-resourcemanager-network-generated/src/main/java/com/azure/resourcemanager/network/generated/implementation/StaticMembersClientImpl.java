...
import com.azure.resourcemanager.network.generated.models.StaticMemberListResult;
...
public final class StaticMembersClientImpl implements StaticMembersClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<StaticMemberInner> getAsync(String resourceGroupName, String networkManagerName,
        String networkGroupName, String staticMemberName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<StaticMemberInner> createOrUpdateAsync(String resourceGroupName, String networkManagerName,
