...
import com.azure.resourcemanager.network.generated.models.NspAssociationsListResult;
 ...
 */
public final class NspAssociationsClientImpl implements NspAssociationsClient {
    /**
     * The proxy service used to perform REST calls.
     */
    private final NspAssociationsService service;
    ...
    /**
     * Initializes an instance of NspAssociationsClientImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    NspAssociationsClientImpl(NetworkManagementClientImpl client) {
        this.service
            = RestProxy.create(NspAssociationsService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for NetworkManagementClientNspAssociations to be used by the proxy
     * service to perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "NetworkManagementCli")
    public interface NspAssociationsService {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<NspAssociationInner> getAsync(String resourceGroupName, String networkSecurityPerimeterName,
