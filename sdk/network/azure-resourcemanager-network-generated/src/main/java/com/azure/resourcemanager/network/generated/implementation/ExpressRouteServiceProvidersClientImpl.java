...
public final class ExpressRouteServiceProvidersClientImpl implements ExpressRouteServiceProvidersClient {
    ...
    /**
     * The interface defining all the services for NetworkManagementClientExpressRouteServiceProviders to be used by
    ...
    public interface ExpressRouteServiceProvidersService {
        ...
        Mono<Response<ExpressRouteServiceProviderListResult>> list(@HostParam("$host") String endpoint,
    ...
    private Mono<PagedResponse<ExpressRouteServiceProviderInner>> listSinglePageAsync() {
        ...
        return FluxUtil
            .withContext(context -> service.list(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(),
                accept, context))
            .<PagedResponse<ExpressRouteServiceProviderInner>>map(res -> new PagedResponseBase<>(res.getRequest(),
