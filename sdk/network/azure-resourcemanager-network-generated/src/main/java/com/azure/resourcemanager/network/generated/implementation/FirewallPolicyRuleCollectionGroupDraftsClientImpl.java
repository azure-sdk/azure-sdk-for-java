...
public final class FirewallPolicyRuleCollectionGroupDraftsClientImpl
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<FirewallPolicyRuleCollectionGroupDraftInner> createOrUpdateAsync(String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<FirewallPolicyRuleCollectionGroupDraftInner> getAsync(String resourceGroupName,
        String firewallPolicyName, String ruleCollectionGroupName) {
