...
public final class PacketCaptureResultProperties extends PacketCaptureParameters {
     ...
     */
    @Override
    public PacketCaptureResultProperties withStorageSettings(PacketCaptureStorageSettings storageSettings) {
        super.withStorageSettings(storageSettings);
        return this;
    }
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeJsonField("storageSettings", storageSettings());
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("target".equals(fieldName)) {
                    ...
                    deserializedPacketCaptureResultProperties
                        .withStorageSettings(PacketCaptureStorageSettings.fromJson(reader));
