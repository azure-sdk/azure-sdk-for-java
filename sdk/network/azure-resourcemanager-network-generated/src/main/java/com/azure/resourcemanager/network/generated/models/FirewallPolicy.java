...
public interface FirewallPolicy {
     ...
     */
    Response<FirewallPolicyDraft> createOrUpdateDraftWithResponse(FirewallPolicyDraftInner parameters, Context context);
     ...
     */
    FirewallPolicyDraft createOrUpdateDraft(FirewallPolicyDraftInner parameters);
     ...
     */
    Response<FirewallPolicyDraft> getDraftWithResponse(String expand, Context context);
     ...
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     */
    void deployDraft(Context context);
     ...
     */
    Response<Void> deleteDraftWithResponse(Context context);
