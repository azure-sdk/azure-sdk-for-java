...
public final class ExpressRouteCrossConnectionsImpl implements ExpressRouteCrossConnections {
    ...
    public PagedIterable<ExpressRouteCrossConnection> list(String name, Context context) {
        PagedIterable<ExpressRouteCrossConnectionInner> inner = this.serviceClient().list(name, context);
        return ResourceManagerUtils.mapPage(inner,
            inner1 -> new ExpressRouteCrossConnectionImpl(inner1, this.manager()));
    }
