...
import com.azure.resourcemanager.network.generated.models.PerimeterAssociableResourcesListResult;
import reactor.core.publisher.Mono;

/**
 * An instance of this class provides access to all the operations defined in PerimeterAssociableResourceTypesClient.
 */
public final class PerimeterAssociableResourceTypesClientImpl implements PerimeterAssociableResourceTypesClient {
    /**
     * The proxy service used to perform REST calls.
     */
    private final PerimeterAssociableResourceTypesService service;
    ...
    /**
     * Initializes an instance of PerimeterAssociableResourceTypesClientImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    PerimeterAssociableResourceTypesClientImpl(NetworkManagementClientImpl client) {
        this.service = RestProxy.create(PerimeterAssociableResourceTypesService.class, client.getHttpPipeline(),
            client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for NetworkManagementClientPerimeterAssociableResourceTypes to be used by
     * the proxy service to perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "NetworkManagementCli")
    public interface PerimeterAssociableResourceTypesService {
    ...
    private PagedFlux<PerimeterAssociableResourceInner> listAsync(String location) {
