...
public final class PublicIpAddressesImpl implements PublicIpAddresses {
    ...
    public PagedIterable<PublicIpAddress> listCloudServicePublicIpAddress(
        String resourceGroupName, String cloudServiceName) {
        PagedIterable<PublicIpAddressInner> inner =
            this.serviceClient().listCloudServicePublicIpAddress(resourceGroupName, cloudServiceName);
        return Utils.mapPage(inner, inner1 -> new PublicIpAddressImpl(inner1, this.manager()));
    }
    ...
    public PagedIterable<PublicIpAddress> listCloudServicePublicIpAddress(
        String resourceGroupName, String cloudServiceName, Context context) {
        PagedIterable<PublicIpAddressInner> inner =
            this.serviceClient().listCloudServicePublicIpAddress(resourceGroupName, cloudServiceName, context);
        return Utils.mapPage(inner, inner1 -> new PublicIpAddressImpl(inner1, this.manager()));
    }

    public PagedIterable<PublicIpAddress> listCloudServiceRoleInstancePublicIpAddress(
        String resourceGroupName,
        String cloudServiceName,
        String roleInstanceName,
        String networkInterfaceName,
    ...
    public Response<PublicIpAddress> getCloudServiceRoleInstancePublicIpAddressWithResponse(
        String resourceGroupName,
        String cloudServiceName,
        String roleInstanceName,
        String networkInterfaceName,
    ...
    public PublicIpAddress getCloudServiceRoleInstancePublicIpAddress(
        String resourceGroupName,
        String cloudServiceName,
        String roleInstanceName,
        String networkInterfaceName,
