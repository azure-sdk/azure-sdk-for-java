...
public final class ConnectionMonitorEndpoint {
    ...
    /**
     * Get the resourceId property: Resource ID of the connection monitor endpoint are supported for AzureVM,
     * AzureVMSS, AzureVNet, AzureSubnet, MMAWorkspaceMachine, MMAWorkspaceNetwork, AzureArcVM endpoint type.
     * 
    ...
    /**
     * Set the resourceId property: Resource ID of the connection monitor endpoint are supported for AzureVM,
     * AzureVMSS, AzureVNet, AzureSubnet, MMAWorkspaceMachine, MMAWorkspaceNetwork, AzureArcVM endpoint type.
     * 
