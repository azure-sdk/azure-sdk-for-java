...
import com.azure.resourcemanager.network.generated.models.AvailablePrivateEndpointTypesResult;
...
public final class AvailablePrivateEndpointTypesClientImpl implements AvailablePrivateEndpointTypesClient {
    ...
    public interface AvailablePrivateEndpointTypesService {
        ...
        Mono<Response<AvailablePrivateEndpointTypesResult>> list(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<AvailablePrivateEndpointTypesResult>> listByResourceGroup(@HostParam("$host") String endpoint,
    ...
    private Mono<PagedResponse<AvailablePrivateEndpointTypeInner>> listSinglePageAsync(String location) {
        ...
        return FluxUtil
            ...
            .<PagedResponse<AvailablePrivateEndpointTypeInner>>map(res -> new PagedResponseBase<>(res.getRequest(),
    ...
    private Mono<PagedResponse<AvailablePrivateEndpointTypeInner>> listByResourceGroupSinglePageAsync(String location,
        ...
        context = this.client.mergeContext(context);
        return service
            .listByResourceGroup(this.client.getEndpoint(), location, resourceGroupName,
                this.client.getSubscriptionId(), apiVersion, accept, context)
            .map(res -> new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(),
                res.getValue().value(), res.getValue().nextLink(), null));
    }
