...
public final class ApplicationGatewayImpl
    ...
    public List<ApplicationGatewayLoadDistributionPolicy> loadDistributionPolicies() {
        List<ApplicationGatewayLoadDistributionPolicy> inner = this.innerModel().loadDistributionPolicies();
        if (inner != null) {
            return Collections.unmodifiableList(inner);
        } else {
            return Collections.emptyList();
    ...
    public void prepareMigration(ApplicationGatewayMigrationRequest migrationRequest) {
        serviceManager.applicationGateways().prepareMigration(resourceGroupName, applicationGatewayName,
            migrationRequest);
    }

    public void prepareMigration(ApplicationGatewayMigrationRequest migrationRequest, Context context) {
        serviceManager.applicationGateways().prepareMigration(resourceGroupName, applicationGatewayName,
            migrationRequest, context);
    }

    public void executeMigration(ApplicationGatewayMigrationRequest migrationRequest) {
        serviceManager.applicationGateways().executeMigration(resourceGroupName, applicationGatewayName,
            migrationRequest);
    }

    public void executeMigration(ApplicationGatewayMigrationRequest migrationRequest, Context context) {
        serviceManager.applicationGateways().executeMigration(resourceGroupName, applicationGatewayName,
            migrationRequest, context);
    }

    public void commitMigration(ApplicationGatewayMigrationRequest migrationRequest) {
        serviceManager.applicationGateways().commitMigration(resourceGroupName, applicationGatewayName,
            migrationRequest);
    }

    public void commitMigration(ApplicationGatewayMigrationRequest migrationRequest, Context context) {
        serviceManager.applicationGateways().commitMigration(resourceGroupName, applicationGatewayName,
            migrationRequest, context);
    }
    ...
    public ApplicationGatewayImpl withGlobalConfiguration(ApplicationGatewayGlobalConfiguration globalConfiguration) {
        this.innerModel().withGlobalConfiguration(globalConfiguration);
        return this;
    }
