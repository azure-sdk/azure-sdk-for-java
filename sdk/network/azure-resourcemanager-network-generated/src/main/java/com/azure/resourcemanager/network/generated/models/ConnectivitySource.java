...
public final class ConnectivitySource {
     ...
     */
    @JsonProperty(value = "vmssIndex")
    private String vmssIndex;
    ...
    /**
     * Get the address property: The IP address of the NIC chosen.
     *
    ...
    /**
     * Set the address property: The IP address of the NIC chosen.
     *
     * @param address the address value to set.
     * @return the ConnectivitySource object itself.
     */
    public ConnectivitySource withAddress(String address) {
        this.address = address;
        return this;
    }

    /**
     * Get the vmssIndex property: The vmss index from which a connectivity check will be performed.
     *
     * @return the vmssIndex value.
     */
    public String vmssIndex() {
        return this.vmssIndex;
    }

    /**
     * Set the vmssIndex property: The vmss index from which a connectivity check will be performed.
     *
     * @param vmssIndex the vmssIndex value to set.
     * @return the ConnectivitySource object itself.
     */
    public ConnectivitySource withVmssIndex(String vmssIndex) {
        this.vmssIndex = vmssIndex;
        return this;
    }
