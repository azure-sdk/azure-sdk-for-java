...
import com.azure.resourcemanager.network.generated.models.NetworkGroupListResult;
...
public final class NetworkGroupsClientImpl implements NetworkGroupsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<NetworkGroupInner> getAsync(String resourceGroupName, String networkManagerName,
        String networkGroupName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<NetworkGroupInner> createOrUpdateAsync(String resourceGroupName, String networkManagerName,
    ...
    private Mono<Response<Flux<ByteBuffer>>> deleteWithResponseAsync(String resourceGroupName,
        String networkManagerName, String networkGroupName, Boolean force) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<NetworkGroupInner> listAsync(String resourceGroupName, String networkManagerName) {
