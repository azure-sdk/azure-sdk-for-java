...
import com.azure.resourcemanager.network.generated.models.VerifierWorkspaceListResult;
...
public final class VerifierWorkspacesClientImpl implements VerifierWorkspacesClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<VerifierWorkspaceInner> getAsync(String resourceGroupName, String networkManagerName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<VerifierWorkspaceInner> createAsync(String resourceGroupName, String networkManagerName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<VerifierWorkspaceInner> updateAsync(String resourceGroupName, String networkManagerName,
        String workspaceName) {
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a list of Verifier Workspace along with {@link PagedResponse} on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
