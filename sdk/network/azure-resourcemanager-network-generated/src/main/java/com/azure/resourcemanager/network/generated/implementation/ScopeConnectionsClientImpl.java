...
import com.azure.resourcemanager.network.generated.models.ScopeConnectionListResult;
...
public final class ScopeConnectionsClientImpl implements ScopeConnectionsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ScopeConnectionInner> createOrUpdateAsync(String resourceGroupName, String networkManagerName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ScopeConnectionInner> getAsync(String resourceGroupName, String networkManagerName,
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<ScopeConnectionInner> listAsync(String resourceGroupName, String networkManagerName) {
