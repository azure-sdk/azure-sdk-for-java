...
import com.azure.resourcemanager.network.generated.fluent.models.SecurityRulePropertiesFormat;
 ...
 */
@Fluent
public final class SecurityRule extends SubResource {
    /*
    ...
    /**
     * Creates an instance of SecurityRule class.
     */
    public SecurityRule() {
    }
     ...
     * @return the SecurityRule object itself.
     */
    public SecurityRule withName(String name) {
        this.name = name;
        return this;
    }
     ...
     * @return the SecurityRule object itself.
     */
    public SecurityRule withType(String type) {
        this.type = type;
        return this;
    }
     ...
     */
    @Override
    public SecurityRule withId(String id) {
        super.withId(id);
        return this;
    }
     ...
     * @return the SecurityRule object itself.
     */
    public SecurityRule withDescription(String description) {
     ...
     * @return the SecurityRule object itself.
     */
    public SecurityRule withProtocol(SecurityRuleProtocol protocol) {
        if (this.innerProperties() == null) {
            this.innerProperties = new SecurityRulePropertiesFormat();
        }
     ...
     * @return the SecurityRule object itself.
     */
    public SecurityRule withSourcePortRange(String sourcePortRange) {
        if (this.innerProperties() == null) {
            this.innerProperties = new SecurityRulePropertiesFormat();
        }
     ...
     * @return the SecurityRule object itself.
     */
    public SecurityRule withDestinationPortRange(String destinationPortRange) {
        if (this.innerProperties() == null) {
            this.innerProperties = new SecurityRulePropertiesFormat();
        }
     ...
     * @return the SecurityRule object itself.
     */
    public SecurityRule withSourceAddressPrefix(String sourceAddressPrefix) {
        if (this.innerProperties() == null) {
            this.innerProperties = new SecurityRulePropertiesFormat();
        }
     ...
     * @return the SecurityRule object itself.
     */
    public SecurityRule withSourceAddressPrefixes(List<String> sourceAddressPrefixes) {
        if (this.innerProperties() == null) {
            this.innerProperties = new SecurityRulePropertiesFormat();
        }
     ...
     */
    public SecurityRule
        withSourceApplicationSecurityGroups(List<ApplicationSecurityGroup> sourceApplicationSecurityGroups) {
        if (this.innerProperties() == null) {
            this.innerProperties = new SecurityRulePropertiesFormat();
        }
     ...
     * @return the SecurityRule object itself.
     */
    public SecurityRule withDestinationAddressPrefix(String destinationAddressPrefix) {
        if (this.innerProperties() == null) {
            this.innerProperties = new SecurityRulePropertiesFormat();
        }
     ...
     * @return the SecurityRule object itself.
     */
    public SecurityRule withDestinationAddressPrefixes(List<String> destinationAddressPrefixes) {
        if (this.innerProperties() == null) {
            this.innerProperties = new SecurityRulePropertiesFormat();
        }
     ...
     */
    public SecurityRule
        withDestinationApplicationSecurityGroups(List<ApplicationSecurityGroup> destinationApplicationSecurityGroups) {
        if (this.innerProperties() == null) {
            this.innerProperties = new SecurityRulePropertiesFormat();
        }
     ...
     * @return the SecurityRule object itself.
     */
    public SecurityRule withSourcePortRanges(List<String> sourcePortRanges) {
        if (this.innerProperties() == null) {
            this.innerProperties = new SecurityRulePropertiesFormat();
        }
     ...
     * @return the SecurityRule object itself.
     */
    public SecurityRule withDestinationPortRanges(List<String> destinationPortRanges) {
        if (this.innerProperties() == null) {
            this.innerProperties = new SecurityRulePropertiesFormat();
        }
     ...
     * @return the SecurityRule object itself.
     */
    public SecurityRule withAccess(SecurityRuleAccess access) {
        if (this.innerProperties() == null) {
            this.innerProperties = new SecurityRulePropertiesFormat();
        }
     ...
     * @return the SecurityRule object itself.
     */
    public SecurityRule withPriority(Integer priority) {
        if (this.innerProperties() == null) {
            this.innerProperties = new SecurityRulePropertiesFormat();
        }
     ...
     * @return the SecurityRule object itself.
     */
    public SecurityRule withDirection(SecurityRuleDirection direction) {
        if (this.innerProperties() == null) {
            this.innerProperties = new SecurityRulePropertiesFormat();
        }
