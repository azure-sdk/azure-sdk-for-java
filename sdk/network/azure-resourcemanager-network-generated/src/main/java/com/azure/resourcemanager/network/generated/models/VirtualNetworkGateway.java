...
public interface VirtualNetworkGateway {
    ...
    /**
     * Gets the virtualNetworkGatewayMigrationStatus property: The reference to the VirtualNetworkGatewayMigrationStatus
    ...
    /**
     * Gets the enableHighBandwidthVpnGateway property: Flag for enabling creation of high bandwidth VPN gateway.
     * 
     * @return the enableHighBandwidthVpnGateway value.
     */
    Boolean enableHighBandwidthVpnGateway();
    ...
    /**
     * Gets the resiliencyModel property: Property to indicate if the Express Route Gateway has resiliency model of
    ...
    interface DefinitionStages {
        ...
        interface WithCreate
            ...
            DefinitionStages.WithEnableBgp, DefinitionStages.WithEnablePrivateIpAddress,
            DefinitionStages.WithVirtualNetworkGatewayMigrationStatus, DefinitionStages.WithActive,
            DefinitionStages.WithEnableHighBandwidthVpnGateway, DefinitionStages.WithDisableIpSecReplayProtection,
            DefinitionStages.WithGatewayDefaultSite, DefinitionStages.WithSku,
            DefinitionStages.WithVpnClientConfiguration, DefinitionStages.WithVirtualNetworkGatewayPolicyGroups,
            DefinitionStages.WithBgpSettings, DefinitionStages.WithCustomRoutes,
            DefinitionStages.WithEnableDnsForwarding, DefinitionStages.WithVNetExtendedLocationResourceId,
            DefinitionStages.WithNatRules, DefinitionStages.WithEnableBgpRouteTranslationForNat,
            DefinitionStages.WithAllowVirtualWanTraffic, DefinitionStages.WithAllowRemoteVnetTraffic,
            DefinitionStages.WithAdminState, DefinitionStages.WithResiliencyModel {
            /**
        ...
        /**
         * The stage of the VirtualNetworkGateway definition allowing to specify virtualNetworkGatewayMigrationStatus.
         */
        interface WithVirtualNetworkGatewayMigrationStatus {
            /**
             * Specifies the virtualNetworkGatewayMigrationStatus property: The reference to the
             * VirtualNetworkGatewayMigrationStatus which represents the status of migration..
             * 
             * @param virtualNetworkGatewayMigrationStatus The reference to the VirtualNetworkGatewayMigrationStatus
             * which represents the status of migration.
             * @return the next definition stage.
             */
            WithCreate withVirtualNetworkGatewayMigrationStatus(
                VirtualNetworkGatewayMigrationStatus virtualNetworkGatewayMigrationStatus);
        }
        ...
        /**
         * The stage of the VirtualNetworkGateway definition allowing to specify enableHighBandwidthVpnGateway.
         */
        interface WithEnableHighBandwidthVpnGateway {
            /**
             * Specifies the enableHighBandwidthVpnGateway property: Flag for enabling creation of high bandwidth VPN
             * gateway.
             * 
             * @param enableHighBandwidthVpnGateway Flag for enabling creation of high bandwidth VPN gateway.
             * @return the next definition stage.
             */
            WithCreate withEnableHighBandwidthVpnGateway(Boolean enableHighBandwidthVpnGateway);
        }
        ...
        /**
         * The stage of the VirtualNetworkGateway definition allowing to specify resiliencyModel.
         */
        interface WithResiliencyModel {
            /**
             * Specifies the resiliencyModel property: Property to indicate if the Express Route Gateway has resiliency
             * model of MultiHomed or SingleHomed.
             * 
             * @param resiliencyModel Property to indicate if the Express Route Gateway has resiliency model of
             * MultiHomed or SingleHomed.
             * @return the next definition stage.
             */
            WithCreate withResiliencyModel(ResiliencyModel resiliencyModel);
        }
    }
     ...
     */
    GatewayResiliencyInformation getResiliencyInformation();
     ...
     * @return gateway Resiliency Information.
     */
    GatewayResiliencyInformation getResiliencyInformation(Boolean attemptRefresh, Context context);
     ...
     */
    GatewayRouteSetsInformation getRoutesInformation();
     ...
     * @return gateway Route Sets Information.
     */
    GatewayRouteSetsInformation getRoutesInformation(Boolean attemptRefresh, Context context);
     ...
     * @return the response.
     */
    String stopExpressRouteSiteFailoverSimulation(ExpressRouteFailoverStopApiParameters stopParameters);
    ...
    /**
     * Trigger prepare migration for the basic virtual network gateway.
     * 
     ...
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     */
    void invokePrepareMigration(VirtualNetworkGatewayMigrationParameters migrationParams);
     ...
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     */
    void invokePrepareMigration(VirtualNetworkGatewayMigrationParameters migrationParams, Context context);

    /**
     * Trigger execute migration for the basic virtual network gateway.
     * 
     * @throws com.azure.core.management.exception.ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     */
    void invokeExecuteMigration();
     ...
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     */
    void invokeExecuteMigration(Context context);

    /**
     * Trigger commit migration for the basic virtual network gateway.
     * 
     * @throws com.azure.core.management.exception.ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     */
    void invokeCommitMigration();
     ...
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     */
    void invokeCommitMigration(Context context);

    /**
     * Trigger abort migration for the basic virtual network gateway.
     * 
     * @throws com.azure.core.management.exception.ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     */
    void invokeAbortMigration();
     ...
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     */
    void invokeAbortMigration(Context context);
}
