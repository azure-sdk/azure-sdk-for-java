...
public final class ResourceProvidersClientImpl implements ResourceProvidersClient {
    ...
    public interface ResourceProvidersService {
        ...
        @ExpectedResponses({ 200, 202 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Flux<ByteBuffer>>> disconnectActiveSessions(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("bastionHostName") String bastionHostname, @QueryParam("api-version") String apiVersion,
    ...
    private Mono<PagedResponse<BastionSessionStateInner>> disconnectActiveSessionsSinglePageAsync(
        ...
        return FluxUtil.withContext(context -> {
            ...
            return Mono.zip(mono,
                this.client
                    .<BastionSessionDeleteResult, BastionSessionDeleteResult>getLroResult(mono,
                        this.client.getHttpPipeline(), BastionSessionDeleteResult.class,
                        BastionSessionDeleteResult.class, this.client.getContext())
                    .last()
                    .flatMap(this.client::getLroFinalResultOrError));
        })
        ...
        return Mono
            .zip(mono,
                this.client
                    .<BastionSessionDeleteResult, BastionSessionDeleteResult>getLroResult(mono,
                        this.client.getHttpPipeline(), BastionSessionDeleteResult.class,
                        BastionSessionDeleteResult.class, context)
                    .last()
                    .flatMap(this.client::getLroFinalResultOrError))
            .map(res -> new PagedResponseBase<>(res.getT1().getRequest(), res.getT1().getStatusCode(),
                res.getT1().getHeaders(), res.getT2().value(), res.getT2().nextLink(), null));
