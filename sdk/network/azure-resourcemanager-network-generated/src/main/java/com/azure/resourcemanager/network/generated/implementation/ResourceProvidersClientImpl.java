...
public final class ResourceProvidersClientImpl implements ResourceProvidersClient {
    ...
    public interface ResourceProvidersService {
        ...
        Mono<Response<Flux<ByteBuffer>>> putBastionShareableLink(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200, 202 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Flux<ByteBuffer>>> deleteBastionShareableLink(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("bastionHostName") String bastionHostname, @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @BodyParam("application/json") BastionShareableLinkListRequest bslRequest,
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Flux<ByteBuffer>>> deleteBastionShareableLinkByToken(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("bastionHostName") String bastionHostname, @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<BastionShareableLinkListResult>> getBastionShareableLink(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("bastionHostName") String bastionHostname, @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @BodyParam("application/json") BastionShareableLinkListRequest bslRequest,
        ...
        @ExpectedResponses({ 200, 202 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Flux<ByteBuffer>>> getActiveSessions(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("bastionHostName") String bastionHostname, @QueryParam("api-version") String apiVersion,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<BastionSessionDeleteResult>> disconnectActiveSessions(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("bastionHostName") String bastionHostname, @QueryParam("api-version") String apiVersion,
        ...
        @Headers({ "Content-Type: application/json" })
        @Post("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/bastionHosts/{bastionHostName}/setSessionRecordingSasUrl")
        @ExpectedResponses({ 200, 202 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Flux<ByteBuffer>>> setSessionRecordingSasUrl(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("bastionHostName") String bastionHostname, @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") String sasurl, @HeaderParam("Accept") String accept, Context context);

        @Headers({ "Content-Type: application/json" })
        @Post("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/bastionHosts/{bastionHostName}/getSessionRecordingSasUrl")
        @ExpectedResponses({ 200, 202 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Flux<ByteBuffer>>> getSessionRecordingSasUrl(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("bastionHostName") String bastionHostname, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<DnsNameAvailabilityResultInner>> checkDnsNameAvailability(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ExpressRouteProviderPortInner>> expressRouteProviderPort(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<VirtualWanSecurityProvidersInner>> supportedSecurityProviders(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
    ...
    private Mono<Response<Flux<ByteBuffer>>> deleteBastionShareableLinkWithResponseAsync(String resourceGroupName,
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.deleteBastionShareableLink(this.client.getEndpoint(), resourceGroupName,
                bastionHostname, apiVersion, this.client.getSubscriptionId(), bslRequest, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> deleteBastionShareableLinkWithResponseAsync(String resourceGroupName,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.deleteBastionShareableLink(this.client.getEndpoint(), resourceGroupName, bastionHostname,
            apiVersion, this.client.getSubscriptionId(), bslRequest, accept, context);
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> deleteBastionShareableLinkByTokenWithResponseAsync(
        ...
        return FluxUtil
            .withContext(
                context -> service.deleteBastionShareableLinkByToken(this.client.getEndpoint(), resourceGroupName,
                    bastionHostname, apiVersion, this.client.getSubscriptionId(), bslTokenRequest, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> deleteBastionShareableLinkByTokenWithResponseAsync(
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.deleteBastionShareableLinkByToken(this.client.getEndpoint(), resourceGroupName, bastionHostname,
            apiVersion, this.client.getSubscriptionId(), bslTokenRequest, accept, context);
    }
    ...
    private Mono<PagedResponse<BastionShareableLinkInner>> getBastionShareableLinkSinglePageAsync(
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.getBastionShareableLink(this.client.getEndpoint(), resourceGroupName,
                bastionHostname, apiVersion, this.client.getSubscriptionId(), bslRequest, accept, context))
    ...
    private Mono<PagedResponse<BastionShareableLinkInner>> getBastionShareableLinkSinglePageAsync(
        ...
        context = this.client.mergeContext(context);
        return service
            .getBastionShareableLink(this.client.getEndpoint(), resourceGroupName, bastionHostname, apiVersion,
                this.client.getSubscriptionId(), bslRequest, accept, context)
    ...
    private Mono<PagedResponse<BastionSessionStateInner>> disconnectActiveSessionsSinglePageAsync(
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.disconnectActiveSessions(this.client.getEndpoint(), resourceGroupName,
                bastionHostname, apiVersion, this.client.getSubscriptionId(), sessionIds, accept, context))
    ...
    private Mono<PagedResponse<BastionSessionStateInner>> disconnectActiveSessionsSinglePageAsync(
        ...
        context = this.client.mergeContext(context);
        return service
            .disconnectActiveSessions(this.client.getEndpoint(), resourceGroupName, bastionHostname, apiVersion,
                this.client.getSubscriptionId(), sessionIds, accept, context)
            .map(res -> new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(),
                res.getValue().value(), res.getValue().nextLink(), null));
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return response for SetSessionRecordingSasUrl along with {@link Response} on successful completion of
     * {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> setSessionRecordingSasUrlWithResponseAsync(String resourceGroupName,
        String bastionHostname, String sasurl) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        if (sasurl == null) {
            return Mono.error(new IllegalArgumentException("Parameter sasurl is required and cannot be null."));
        }
        final String apiVersion = "2024-01-01";
        final String accept = "application/json";
        return FluxUtil
            .withContext(
                context -> service.setSessionRecordingSasUrl(this.client.getEndpoint(), this.client.getSubscriptionId(),
                    resourceGroupName, bastionHostname, apiVersion, sasurl, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> setSessionRecordingSasUrlWithResponseAsync(String resourceGroupName,
        String bastionHostname, String sasurl, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.setSessionRecordingSasUrl(this.client.getEndpoint(), this.client.getSubscriptionId(),
            resourceGroupName, bastionHostname, apiVersion, sasurl, accept, context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the {@link PollerFlux} for polling of response for SetSessionRecordingSasUrl.
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<SetSessionRecordingSasUrlResponseInner>, SetSessionRecordingSasUrlResponseInner>
        beginSetSessionRecordingSasUrlAsync(String resourceGroupName, String bastionHostname, String sasurl) {
        Mono<Response<Flux<ByteBuffer>>> mono
            = setSessionRecordingSasUrlWithResponseAsync(resourceGroupName, bastionHostname, sasurl);
        return this.client.<SetSessionRecordingSasUrlResponseInner, SetSessionRecordingSasUrlResponseInner>getLroResult(
            mono, this.client.getHttpPipeline(), SetSessionRecordingSasUrlResponseInner.class,
            SetSessionRecordingSasUrlResponseInner.class, this.client.getContext());
    }
    ...
    private PollerFlux<PollResult<SetSessionRecordingSasUrlResponseInner>, SetSessionRecordingSasUrlResponseInner>
        ...
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono
            = setSessionRecordingSasUrlWithResponseAsync(resourceGroupName, bastionHostname, sasurl, context);
        return this.client.<SetSessionRecordingSasUrlResponseInner, SetSessionRecordingSasUrlResponseInner>getLroResult(
            mono, this.client.getHttpPipeline(), SetSessionRecordingSasUrlResponseInner.class,
            SetSessionRecordingSasUrlResponseInner.class, context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the {@link SyncPoller} for polling of response for SetSessionRecordingSasUrl.
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<SetSessionRecordingSasUrlResponseInner>, SetSessionRecordingSasUrlResponseInner>
        beginSetSessionRecordingSasUrl(String resourceGroupName, String bastionHostname, String sasurl) {
        return this.beginSetSessionRecordingSasUrlAsync(resourceGroupName, bastionHostname, sasurl).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<SetSessionRecordingSasUrlResponseInner>, SetSessionRecordingSasUrlResponseInner>
        beginSetSessionRecordingSasUrl(String resourceGroupName, String bastionHostname, String sasurl,
            Context context) {
        return this.beginSetSessionRecordingSasUrlAsync(resourceGroupName, bastionHostname, sasurl, context)
            .getSyncPoller();
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return response for SetSessionRecordingSasUrl on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<SetSessionRecordingSasUrlResponseInner> setSessionRecordingSasUrlAsync(String resourceGroupName,
        String bastionHostname, String sasurl) {
        return beginSetSessionRecordingSasUrlAsync(resourceGroupName, bastionHostname, sasurl).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<SetSessionRecordingSasUrlResponseInner> setSessionRecordingSasUrlAsync(String resourceGroupName,
        String bastionHostname, String sasurl, Context context) {
        return beginSetSessionRecordingSasUrlAsync(resourceGroupName, bastionHostname, sasurl, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return response for SetSessionRecordingSasUrl.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public SetSessionRecordingSasUrlResponseInner setSessionRecordingSasUrl(String resourceGroupName,
        String bastionHostname, String sasurl) {
        return setSessionRecordingSasUrlAsync(resourceGroupName, bastionHostname, sasurl).block();
    }
    ...
    public SetSessionRecordingSasUrlResponseInner setSessionRecordingSasUrl(String resourceGroupName,
        String bastionHostname, String sasurl, Context context) {
        return setSessionRecordingSasUrlAsync(resourceGroupName, bastionHostname, sasurl, context).block();
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return sAS URL for session recording for the Bastion Host along with {@link Response} on successful completion
     * of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> getSessionRecordingSasUrlWithResponseAsync(String resourceGroupName,
        String bastionHostname) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.getSessionRecordingSasUrl(this.client.getEndpoint(),
                this.client.getSubscriptionId(), resourceGroupName, bastionHostname, apiVersion, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> getSessionRecordingSasUrlWithResponseAsync(String resourceGroupName,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.getSessionRecordingSasUrl(this.client.getEndpoint(), this.client.getSubscriptionId(),
            resourceGroupName, bastionHostname, apiVersion, accept, context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the {@link PollerFlux} for polling of sAS URL for session recording for the Bastion Host.
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<String>, String> beginGetSessionRecordingSasUrlAsync(String resourceGroupName,
        String bastionHostname) {
        Mono<Response<Flux<ByteBuffer>>> mono
            = getSessionRecordingSasUrlWithResponseAsync(resourceGroupName, bastionHostname);
    ...
    private PollerFlux<PollResult<String>, String> beginGetSessionRecordingSasUrlAsync(String resourceGroupName,
        ...
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono
            = getSessionRecordingSasUrlWithResponseAsync(resourceGroupName, bastionHostname, context);
        return this.client.<String, String>getLroResult(mono, this.client.getHttpPipeline(), String.class, String.class,
            context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the {@link SyncPoller} for polling of sAS URL for session recording for the Bastion Host.
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<String>, String> beginGetSessionRecordingSasUrl(String resourceGroupName,
        String bastionHostname) {
        return this.beginGetSessionRecordingSasUrlAsync(resourceGroupName, bastionHostname).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<String>, String> beginGetSessionRecordingSasUrl(String resourceGroupName,
        String bastionHostname, Context context) {
        return this.beginGetSessionRecordingSasUrlAsync(resourceGroupName, bastionHostname, context).getSyncPoller();
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return sAS URL for session recording for the Bastion Host on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<String> getSessionRecordingSasUrlAsync(String resourceGroupName, String bastionHostname) {
        return beginGetSessionRecordingSasUrlAsync(resourceGroupName, bastionHostname).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<String> getSessionRecordingSasUrlAsync(String resourceGroupName, String bastionHostname,
        Context context) {
        return beginGetSessionRecordingSasUrlAsync(resourceGroupName, bastionHostname, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return sAS URL for session recording for the Bastion Host.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public String getSessionRecordingSasUrl(String resourceGroupName, String bastionHostname) {
        return getSessionRecordingSasUrlAsync(resourceGroupName, bastionHostname).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public String getSessionRecordingSasUrl(String resourceGroupName, String bastionHostname, Context context) {
        return getSessionRecordingSasUrlAsync(resourceGroupName, bastionHostname, context).block();
    }
    ...
    private Mono<Response<DnsNameAvailabilityResultInner>> checkDnsNameAvailabilityWithResponseAsync(String location,
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.checkDnsNameAvailability(this.client.getEndpoint(), location,
                domainNameLabel, apiVersion, this.client.getSubscriptionId(), accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<DnsNameAvailabilityResultInner>> checkDnsNameAvailabilityWithResponseAsync(String location,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.checkDnsNameAvailability(this.client.getEndpoint(), location, domainNameLabel, apiVersion,
            this.client.getSubscriptionId(), accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ExpressRouteProviderPortInner>>
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.expressRouteProviderPort(this.client.getEndpoint(), providerport,
    ...
    private Mono<Response<ExpressRouteProviderPortInner>> expressRouteProviderPortWithResponseAsync(String providerport,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.expressRouteProviderPort(this.client.getEndpoint(), providerport, apiVersion,
            this.client.getSubscriptionId(), accept, context);
    }
    ...
    private Mono<Response<ActiveConnectivityConfigurationsListResultInner>>
        ...
        return FluxUtil
            .withContext(context -> service.listActiveConnectivityConfigurations(this.client.getEndpoint(), apiVersion,
                this.client.getSubscriptionId(), resourceGroupName, networkManagerName, top, parameters, accept,
                context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<ActiveConnectivityConfigurationsListResultInner>>
        ...
        return service.listActiveConnectivityConfigurations(this.client.getEndpoint(), apiVersion,
            this.client.getSubscriptionId(), resourceGroupName, networkManagerName, top, parameters, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ActiveSecurityAdminRulesListResultInner> listActiveSecurityAdminRulesAsync(String resourceGroupName,
    ...
    private Mono<Response<NetworkManagerEffectiveConnectivityConfigurationListResultInner>>
        ...
        return FluxUtil
            .withContext(context -> service.listNetworkManagerEffectiveConnectivityConfigurations(
                this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName, virtualNetworkName,
                apiVersion, top, parameters, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<NetworkManagerEffectiveConnectivityConfigurationListResultInner>>
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.listNetworkManagerEffectiveConnectivityConfigurations(this.client.getEndpoint(),
            this.client.getSubscriptionId(), resourceGroupName, virtualNetworkName, apiVersion, top, parameters, accept,
            context);
    }
    ...
    private Mono<Response<NetworkManagerEffectiveSecurityAdminRulesListResultInner>>
        ...
        return FluxUtil
            .withContext(context -> service.listNetworkManagerEffectiveSecurityAdminRules(this.client.getEndpoint(),
                this.client.getSubscriptionId(), resourceGroupName, virtualNetworkName, apiVersion, top, parameters,
                accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<NetworkManagerEffectiveSecurityAdminRulesListResultInner>>
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.listNetworkManagerEffectiveSecurityAdminRules(this.client.getEndpoint(),
            this.client.getSubscriptionId(), resourceGroupName, virtualNetworkName, apiVersion, top, parameters, accept,
            context);
    }
    ...
    private Mono<Response<VirtualWanSecurityProvidersInner>>
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.supportedSecurityProviders(this.client.getEndpoint(),
                this.client.getSubscriptionId(), resourceGroupName, virtualWanName, apiVersion, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<VirtualWanSecurityProvidersInner>>
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.supportedSecurityProviders(this.client.getEndpoint(), this.client.getSubscriptionId(),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<VirtualWanSecurityProvidersInner> supportedSecurityProvidersAsync(String resourceGroupName,
    ...
    private Mono<Response<Flux<ByteBuffer>>> generatevirtualwanvpnserverconfigurationvpnprofileWithResponseAsync(
        ...
        return FluxUtil
            .withContext(context -> service.generatevirtualwanvpnserverconfigurationvpnprofile(
                this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName, virtualWanName,
                apiVersion, vpnClientParams, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> generatevirtualwanvpnserverconfigurationvpnprofileWithResponseAsync(
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.generatevirtualwanvpnserverconfigurationvpnprofile(this.client.getEndpoint(),
            this.client.getSubscriptionId(), resourceGroupName, virtualWanName, apiVersion, vpnClientParams, accept,
            context);
    }
