...
public final class FirewallPolicyRuleCollectionGroupProperties {
     ...
     */
    @JsonProperty(value = "ruleCollectionGroupSize", access = JsonProperty.Access.WRITE_ONLY)
    private String ruleCollectionGroupSize;
    ...
    /**
     * Get the ruleCollectionGroupSize property: A read-only string that represents the size of the
     * FirewallPolicyRuleCollectionGroupProperties in MB. (ex 1.2MB).
     *
     * @return the ruleCollectionGroupSize value.
     */
    public String ruleCollectionGroupSize() {
        return this.ruleCollectionGroupSize;
    }
