...
public interface NetworkWatcher {
    ...
    /**
     * Gets the runningOperationIds property: List of running operation IDs.
     *
     * @return the runningOperationIds value.
     */
    List<Integer> runningOperationIds();
    ...
    interface DefinitionStages {
         ...
         */
        interface WithCreate extends DefinitionStages.WithTags, DefinitionStages.WithRunningOperationIds {
            /**
        ...
        /** The stage of the NetworkWatcher definition allowing to specify runningOperationIds. */
        interface WithRunningOperationIds {
            /**
             * Specifies the runningOperationIds property: List of running operation IDs..
             *
             * @param runningOperationIds List of running operation IDs.
             * @return the next definition stage.
             */
            WithCreate withRunningOperationIds(List<Integer> runningOperationIds);
        }
    }
    /**
     ...
     * @throws com.azure.resourcemanager.network.generated.models.ErrorResponseException thrown if the request is
     *     rejected by server.
