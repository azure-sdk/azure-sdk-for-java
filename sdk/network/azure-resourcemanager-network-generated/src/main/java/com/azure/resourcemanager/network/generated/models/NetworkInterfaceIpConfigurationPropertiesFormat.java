...
public interface NetworkInterfaceIpConfigurationPropertiesFormat {
    ...
    /**
     * Gets the privateIpAddressPrefix property: The prefix address in CIDR format.
     * 
     * @return the privateIpAddressPrefix value.
     */
    String privateIpAddressPrefix();

    /**
     * Gets the privateIpAddressPrefixLength property: The /n prefix length of the address prefix. Must be /28 or /32
