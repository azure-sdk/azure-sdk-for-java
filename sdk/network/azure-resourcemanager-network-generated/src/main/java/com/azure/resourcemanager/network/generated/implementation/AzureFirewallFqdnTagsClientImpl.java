...
public final class AzureFirewallFqdnTagsClientImpl implements AzureFirewallFqdnTagsClient {
    ...
    AzureFirewallFqdnTagsClientImpl(NetworkManagementClientImpl client) {
        this.service = RestProxy.create(AzureFirewallFqdnTagsService.class, client.getHttpPipeline(),
    ...
    public interface AzureFirewallFqdnTagsService {
        ...
        Mono<Response<AzureFirewallFqdnTagListResult>> list(@HostParam("$host") String endpoint,
    ...
    private Mono<PagedResponse<AzureFirewallFqdnTagInner>> listSinglePageAsync() {
        ...
        return FluxUtil
            .withContext(context -> service.list(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(),
                accept, context))
            .<PagedResponse<AzureFirewallFqdnTagInner>>map(res -> new PagedResponseBase<>(res.getRequest(),
