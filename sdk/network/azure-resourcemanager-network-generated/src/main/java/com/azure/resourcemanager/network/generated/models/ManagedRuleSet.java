...
public final class ManagedRuleSet {
     ...
     */
    @JsonProperty(value = "computedDisabledRuleGroups", access = JsonProperty.Access.WRITE_ONLY)
    private List<ManagedRuleSetRuleGroup> computedDisabledRuleGroups;
    ...
    /**
     * Get the computedDisabledRuleGroups property: Stores the final list of disabled rule groups.
     * 
     * @return the computedDisabledRuleGroups value.
     */
    public List<ManagedRuleSetRuleGroup> computedDisabledRuleGroups() {
        return this.computedDisabledRuleGroups;
    }
    ...
    public void validate() {
        ...
        if (computedDisabledRuleGroups() != null) {
            computedDisabledRuleGroups().forEach(e -> e.validate());
        }
    }
