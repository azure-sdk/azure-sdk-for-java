...
import com.azure.resourcemanager.network.generated.models.ListVirtualHubIpConfigurationResults;
...
public final class VirtualHubIpConfigurationsClientImpl implements VirtualHubIpConfigurationsClient {
    ...
    private Mono<Response<HubIpConfigurationInner>> getWithResponseAsync(String resourceGroupName,
        String virtualHubName, String ipConfigName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<HubIpConfigurationInner> getAsync(String resourceGroupName, String virtualHubName,
        String ipConfigName) {
    ...
    public HubIpConfigurationInner get(String resourceGroupName, String virtualHubName, String ipConfigName) {
        return getWithResponse(resourceGroupName, virtualHubName, ipConfigName, Context.NONE).getValue();
    }
