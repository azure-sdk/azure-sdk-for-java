...
public final class DscpConfigurationsClientImpl implements DscpConfigurationsClient {
    ...
    private PollerFlux<PollResult<DscpConfigurationInner>, DscpConfigurationInner> beginCreateOrUpdateAsync(
        ...
        return this.client.<DscpConfigurationInner, DscpConfigurationInner>getLroResult(mono,
            this.client.getHttpPipeline(), DscpConfigurationInner.class, DscpConfigurationInner.class, context);
    }
    ...
    public SyncPoller<PollResult<DscpConfigurationInner>, DscpConfigurationInner> beginCreateOrUpdate(
        String resourceGroupName, String dscpConfigurationName, DscpConfigurationInner parameters, Context context) {
        return this.beginCreateOrUpdateAsync(resourceGroupName, dscpConfigurationName, parameters, context)
            .getSyncPoller();
    }
    ...
    private Mono<DscpConfigurationInner> createOrUpdateAsync(String resourceGroupName, String dscpConfigurationName,
        ...
        return beginCreateOrUpdateAsync(resourceGroupName, dscpConfigurationName, parameters, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<Void>, Void> beginDeleteAsync(String resourceGroupName, String dscpConfigurationName,
        Context context) {
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String dscpConfigurationName, Context context) {
        return beginDeleteAsync(resourceGroupName, dscpConfigurationName, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
