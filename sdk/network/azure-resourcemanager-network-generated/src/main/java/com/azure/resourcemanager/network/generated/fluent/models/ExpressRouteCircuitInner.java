...
public final class ExpressRouteCircuitInner extends Resource {
    ...
    /**
     * Set the authorizationStatus property: The authorization status of the Circuit.
     *
     * @param authorizationStatus the authorizationStatus value to set.
     * @return the ExpressRouteCircuitInner object itself.
     */
    public ExpressRouteCircuitInner withAuthorizationStatus(String authorizationStatus) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ExpressRouteCircuitPropertiesFormat();
        }
        this.innerProperties().withAuthorizationStatus(authorizationStatus);
        return this;
    }
