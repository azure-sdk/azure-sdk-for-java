...
public final class FirewallPoliciesImpl implements FirewallPolicies {
    ...
    public Response<FirewallPolicyDraft> createOrUpdateDraftWithResponse(
        ...
        Response<FirewallPolicyDraftInner> inner =
            this
                .serviceClient()
                .createOrUpdateDraftWithResponse(resourceGroupName, firewallPolicyName, parameters, context);
        if (inner != null) {
            return new SimpleResponse<>(
                inner.getRequest(),
                inner.getStatusCode(),
    ...
    public FirewallPolicyDraft createOrUpdateDraft(
        String resourceGroupName, String firewallPolicyName, FirewallPolicyDraftInner parameters) {
        FirewallPolicyDraftInner inner =
            this.serviceClient().createOrUpdateDraft(resourceGroupName, firewallPolicyName, parameters);
        if (inner != null) {
    ...
    public Response<FirewallPolicyDraft> getDraftWithResponse(
        String resourceGroupName, String firewallPolicyName, Context context) {
        Response<FirewallPolicyDraftInner> inner =
            this.serviceClient().getDraftWithResponse(resourceGroupName, firewallPolicyName, context);
        if (inner != null) {
            return new SimpleResponse<>(
                inner.getRequest(),
                inner.getStatusCode(),
    ...
    public FirewallPolicyDraft getDraft(String resourceGroupName, String firewallPolicyName) {
        FirewallPolicyDraftInner inner = this.serviceClient().getDraft(resourceGroupName, firewallPolicyName);
        if (inner != null) {
            return new FirewallPolicyDraftImpl(inner, this.manager());
        } else {
            return null;
    ...
    public FirewallPolicyDraft deployDraft(String resourceGroupName, String firewallPolicyName) {
        FirewallPolicyDraftInner inner = this.serviceClient().deployDraft(resourceGroupName, firewallPolicyName);
        if (inner != null) {
            return new FirewallPolicyDraftImpl(inner, this.manager());
        } else {
            return null;
    ...
    public FirewallPolicyDraft deployDraft(String resourceGroupName, String firewallPolicyName, Context context) {
        FirewallPolicyDraftInner inner =
            this.serviceClient().deployDraft(resourceGroupName, firewallPolicyName, context);
        if (inner != null) {
            return new FirewallPolicyDraftImpl(inner, this.manager());
        } else {
            return null;
    ...
    public Response<Object> deleteDraftWithResponse(
        String resourceGroupName, String firewallPolicyName, Context context) {
        return this.serviceClient().deleteDraftWithResponse(resourceGroupName, firewallPolicyName, context);
    }

    public Object deleteDraft(String resourceGroupName, String firewallPolicyName) {
        return this.serviceClient().deleteDraft(resourceGroupName, firewallPolicyName);
    }
