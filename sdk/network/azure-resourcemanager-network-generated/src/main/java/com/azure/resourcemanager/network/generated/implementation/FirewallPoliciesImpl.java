...
public final class FirewallPoliciesImpl implements FirewallPolicies {
    ...
    public Response<FirewallPolicyDraft> getDraftWithResponse(
        String resourceGroupName, String firewallPolicyName, String expand, Context context) {
        Response<FirewallPolicyDraftInner> inner =
            this.serviceClient().getDraftWithResponse(resourceGroupName, firewallPolicyName, expand, context);
        if (inner != null) {
            return new SimpleResponse<>(
                inner.getRequest(),
                inner.getStatusCode(),
    ...
    public void deployDraft(String resourceGroupName, String firewallPolicyName) {
        this.serviceClient().deployDraft(resourceGroupName, firewallPolicyName);
    }
    ...
    public void deleteDraft(String resourceGroupName, String firewallPolicyName) {
        this.serviceClient().deleteDraft(resourceGroupName, firewallPolicyName);
    }
