...
public final class ConnectivityParameters {
     ...
     * Analysis Modes.
     */
    @JsonProperty(value = "analysisModes")
    private AnalysisModes analysisModes;
    ...
    /**
     * Get the analysisModes property: Analysis Modes.
     *
     * @return the analysisModes value.
     */
    public AnalysisModes analysisModes() {
        return this.analysisModes;
    }

    /**
     * Set the analysisModes property: Analysis Modes.
     *
     * @param analysisModes the analysisModes value to set.
     * @return the ConnectivityParameters object itself.
     */
    public ConnectivityParameters withAnalysisModes(AnalysisModes analysisModes) {
