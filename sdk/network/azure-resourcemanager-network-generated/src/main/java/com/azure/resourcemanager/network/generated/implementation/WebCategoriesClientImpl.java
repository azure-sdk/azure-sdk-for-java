...
public final class WebCategoriesClientImpl implements WebCategoriesClient {
    ...
    public interface WebCategoriesService {
        ...
        Mono<Response<AzureWebCategoryInner>> get(@HostParam("$host") String endpoint, @PathParam("name") String name,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<AzureWebCategoryListResult>> list(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
    ...
    private Mono<PagedResponse<AzureWebCategoryInner>> listSinglePageAsync() {
        ...
        return FluxUtil
            .withContext(context -> service.list(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(),
                accept, context))
            .<PagedResponse<AzureWebCategoryInner>>map(res -> new PagedResponseBase<>(res.getRequest(),
