...
public final class AvailableEndpointServicesClientImpl implements AvailableEndpointServicesClient {
    ...
    public interface AvailableEndpointServicesService {
        ...
        Mono<Response<EndpointServicesListResult>> list(@HostParam("$host") String endpoint,
    ...
    private Mono<PagedResponse<EndpointServiceResultInner>> listSinglePageAsync(String location) {
        ...
        return FluxUtil
            ...
            .<PagedResponse<EndpointServiceResultInner>>map(res -> new PagedResponseBase<>(res.getRequest(),
