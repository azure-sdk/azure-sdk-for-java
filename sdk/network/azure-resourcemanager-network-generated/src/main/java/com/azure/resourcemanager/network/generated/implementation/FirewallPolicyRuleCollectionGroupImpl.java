...
public final class FirewallPolicyRuleCollectionGroupImpl
    ...
    public Response<FirewallPolicyRuleCollectionGroupDraft> createOrUpdateDraftWithResponse(
    ...
    public FirewallPolicyRuleCollectionGroupDraft createOrUpdateDraft(
    ...
    public Response<FirewallPolicyRuleCollectionGroupDraft> getDraftWithResponse(Context context) {
        return serviceManager
            .firewallPolicyRuleCollectionGroups()
            .getDraftWithResponse(resourceGroupName, firewallPolicyName, ruleCollectionGroupName, context);
    }

    public FirewallPolicyRuleCollectionGroupDraft getDraft() {
        return serviceManager
            .firewallPolicyRuleCollectionGroups()
            .getDraft(resourceGroupName, firewallPolicyName, ruleCollectionGroupName);
    }

    public Response<FirewallPolicyRuleCollectionGroup> deleteDraftWithResponse(Context context) {
        return serviceManager
            .firewallPolicyRuleCollectionGroups()
            .deleteDraftWithResponse(resourceGroupName, firewallPolicyName, ruleCollectionGroupName, context);
    }

    public FirewallPolicyRuleCollectionGroup deleteDraft() {
        return serviceManager
            .firewallPolicyRuleCollectionGroups()
            .deleteDraft(resourceGroupName, firewallPolicyName, ruleCollectionGroupName);
    }
