...
import com.azure.resourcemanager.network.generated.models.AzureFirewallAutoScaleSettings;
...
public final class AzureFirewallInner extends Resource {
    ...
    /**
     * Get the autoscaleSettings property: The autoscale settings for Azure Firewall.
     *
     * @return the autoscaleSettings value.
     */
    public AzureFirewallAutoScaleSettings autoscaleSettings() {
        return this.innerProperties() == null ? null : this.innerProperties().autoscaleSettings();
    }

    /**
     * Set the autoscaleSettings property: The autoscale settings for Azure Firewall.
     *
     * @param autoscaleSettings the autoscaleSettings value to set.
     * @return the AzureFirewallInner object itself.
     */
    public AzureFirewallInner withAutoscaleSettings(AzureFirewallAutoScaleSettings autoscaleSettings) {
        if (this.innerProperties() == null) {
            this.innerProperties = new AzureFirewallPropertiesFormat();
        }
        this.innerProperties().withAutoscaleSettings(autoscaleSettings);
        return this;
    }
