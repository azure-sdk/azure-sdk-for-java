...
public final class NetworkInterfaceImpl
    ...
    public NetworkInterface create() {
        this.innerObject =
            serviceManager
                ...
                .createOrUpdateWithResponse(resourceGroupName, networkInterfaceName, this.innerModel(), Context.NONE)
                .getValue();
        return this;
    }
    ...
    public NetworkInterface create(Context context) {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getNetworkInterfaces()
                .createOrUpdateWithResponse(resourceGroupName, networkInterfaceName, this.innerModel(), context)
                .getValue();
        return this;
    }
    ...
    public Response<EffectiveRouteListResult> getEffectiveRouteTableWithResponse(Context context) {
        return serviceManager
            .networkInterfaces()
            .getEffectiveRouteTableWithResponse(resourceGroupName, networkInterfaceName, context);
    }
