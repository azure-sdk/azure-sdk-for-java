...
public final class ApplicationGatewaysImpl implements ApplicationGateways {
    ...
    public void prepareMigration(String resourceGroupName, String applicationGatewayName,
        ...
        this.serviceClient().prepareMigration(resourceGroupName, applicationGatewayName, migrationRequest);
    }

    public void prepareMigration(String resourceGroupName, String applicationGatewayName,
        ApplicationGatewayMigrationRequest migrationRequest, Context context) {
        this.serviceClient().prepareMigration(resourceGroupName, applicationGatewayName, migrationRequest, context);
    }

    public void executeMigration(String resourceGroupName, String applicationGatewayName,
        ApplicationGatewayMigrationRequest migrationRequest) {
        this.serviceClient().executeMigration(resourceGroupName, applicationGatewayName, migrationRequest);
    }

    public void executeMigration(String resourceGroupName, String applicationGatewayName,
        ApplicationGatewayMigrationRequest migrationRequest, Context context) {
        this.serviceClient().executeMigration(resourceGroupName, applicationGatewayName, migrationRequest, context);
    }

    public void commitMigration(String resourceGroupName, String applicationGatewayName,
        ApplicationGatewayMigrationRequest migrationRequest) {
        this.serviceClient().commitMigration(resourceGroupName, applicationGatewayName, migrationRequest);
    }

    public void commitMigration(String resourceGroupName, String applicationGatewayName,
        ApplicationGatewayMigrationRequest migrationRequest, Context context) {
        this.serviceClient().commitMigration(resourceGroupName, applicationGatewayName, migrationRequest, context);
    }
