...
import com.azure.resourcemanager.network.generated.models.ResiliencyModel;
...
public final class VirtualNetworkGatewayImpl
    ...
    public Boolean enableHighBandwidthVpnGateway() {
        return this.innerModel().enableHighBandwidthVpnGateway();
    }
    ...
    public ResiliencyModel resiliencyModel() {
        return this.innerModel().resiliencyModel();
    }
    ...
    public VirtualNetworkGateway reset(String gatewayVip, Context context) {
        return serviceManager.virtualNetworkGateways()
    ...
    public void resetVpnClientSharedKey(Context context) {
        serviceManager.virtualNetworkGateways()
    ...
    public GatewayResiliencyInformation getResiliencyInformation() {
        return serviceManager.virtualNetworkGateways()
            .getResiliencyInformation(resourceGroupName, virtualNetworkGatewayName);
    }

    public GatewayResiliencyInformation getResiliencyInformation(Boolean attemptRefresh, Context context) {
        return serviceManager.virtualNetworkGateways()
            .getResiliencyInformation(resourceGroupName, virtualNetworkGatewayName, attemptRefresh, context);
    }

    public GatewayRouteSetsInformation getRoutesInformation() {
        return serviceManager.virtualNetworkGateways()
            .getRoutesInformation(resourceGroupName, virtualNetworkGatewayName);
    }

    public GatewayRouteSetsInformation getRoutesInformation(Boolean attemptRefresh, Context context) {
        return serviceManager.virtualNetworkGateways()
    ...
    public String stopExpressRouteSiteFailoverSimulation(ExpressRouteFailoverStopApiParameters stopParameters) {
        return serviceManager.virtualNetworkGateways()
    ...
    public VirtualNetworkGatewayImpl withEnableHighBandwidthVpnGateway(Boolean enableHighBandwidthVpnGateway) {
        this.innerModel().withEnableHighBandwidthVpnGateway(enableHighBandwidthVpnGateway);
        return this;
    }
    ...
    public VirtualNetworkGatewayImpl withResiliencyModel(ResiliencyModel resiliencyModel) {
        this.innerModel().withResiliencyModel(resiliencyModel);
        return this;
    }
