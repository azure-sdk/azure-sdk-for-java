...
public final class FirewallPolicyRuleCollectionGroupsImpl implements FirewallPolicyRuleCollectionGroups {
    ...
    public Response<FirewallPolicyDraftRuleCollectionGroup> createOrUpdateDraftWithResponse(
        ...
        Context context) {
        Response<FirewallPolicyDraftRuleCollectionGroupInner> inner =
            this
                .serviceClient()
        ...
        if (inner != null) {
            return new SimpleResponse<>(
                ...
                inner.getStatusCode(),
                inner.getHeaders(),
                new FirewallPolicyDraftRuleCollectionGroupImpl(inner.getValue(), this.manager()));
        } else {
            return null;
        }
    }
    ...
    public FirewallPolicyDraftRuleCollectionGroup createOrUpdateDraft(
        ...
        String ruleCollectionGroupName,
        FirewallPolicyDraftRuleCollectionGroupInner parameters) {
        FirewallPolicyDraftRuleCollectionGroupInner inner =
            this
                .serviceClient()
                .createOrUpdateDraft(resourceGroupName, firewallPolicyName, ruleCollectionGroupName, parameters);
        if (inner != null) {
            return new FirewallPolicyDraftRuleCollectionGroupImpl(inner, this.manager());
        } else {
            return null;
        }
    }
    ...
    public FirewallPolicyDraftRuleCollectionGroup getDraft(
        String resourceGroupName,
        String firewallPolicyName,
        String ruleCollectionGroupName,
        FirewallPolicyRuleCollectionGroupInner parameters) {
        FirewallPolicyDraftRuleCollectionGroupInner inner =
            this.serviceClient().getDraft(resourceGroupName, firewallPolicyName, ruleCollectionGroupName, parameters);
        if (inner != null) {
            return new FirewallPolicyDraftRuleCollectionGroupImpl(inner, this.manager());
        } else {
            return null;
