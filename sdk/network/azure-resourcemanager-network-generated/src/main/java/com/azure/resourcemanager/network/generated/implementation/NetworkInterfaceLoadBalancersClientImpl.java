...
public final class NetworkInterfaceLoadBalancersClientImpl implements NetworkInterfaceLoadBalancersClient {
    ...
    public interface NetworkInterfaceLoadBalancersService {
        ...
        Mono<Response<NetworkInterfaceLoadBalancerListResult>> list(@HostParam("$host") String endpoint,
    ...
    private Mono<PagedResponse<LoadBalancerInner>> listSinglePageAsync(String resourceGroupName,
    ...
    private PagedFlux<LoadBalancerInner> listAsync(String resourceGroupName, String networkInterfaceName) {
