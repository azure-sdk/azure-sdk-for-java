...
public final class PacketCaptureResultInner implements JsonSerializable<PacketCaptureResultInner> {
    ...
    public PacketCaptureStorageSettings storageSettings() {
        return this.innerProperties() == null ? null : this.innerProperties().storageSettings();
    }
     ...
     * @return the PacketCaptureResultInner object itself.
     */
    public PacketCaptureResultInner withStorageSettings(PacketCaptureStorageSettings storageSettings) {
        if (this.innerProperties() == null) {
            this.innerProperties = new PacketCaptureResultProperties();
        }
        this.innerProperties().withStorageSettings(storageSettings);
        return this;
    }
