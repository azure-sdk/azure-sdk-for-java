...
public final class PacketCaptureResultInner {
    ...
    public String queryPacketCaptureLastOperationId() {
        return this.innerProperties() == null ? null : this.innerProperties().queryPacketCaptureLastOperationId();
    }
     ...
     * @return the PacketCaptureResultInner object itself.
     */
    public PacketCaptureResultInner withQueryPacketCaptureLastOperationId(String queryPacketCaptureLastOperationId) {
        if (this.innerProperties() == null) {
            this.innerProperties = new PacketCaptureResultProperties();
        }
        this.innerProperties().withQueryPacketCaptureLastOperationId(queryPacketCaptureLastOperationId);
        return this;
    }
