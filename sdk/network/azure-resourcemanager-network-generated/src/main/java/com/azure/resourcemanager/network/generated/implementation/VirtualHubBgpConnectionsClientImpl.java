...
public final class VirtualHubBgpConnectionsClientImpl implements VirtualHubBgpConnectionsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<PeerRouteListInner>, PeerRouteListInner>
        ...
        return this.client.<PeerRouteListInner, PeerRouteListInner>getLroResult(mono, this.client.getHttpPipeline(),
            PeerRouteListInner.class, PeerRouteListInner.class, this.client.getContext());
    }
    ...
    private PollerFlux<PollResult<PeerRouteListInner>, PeerRouteListInner>
        ...
        return this.client.<PeerRouteListInner, PeerRouteListInner>getLroResult(mono, this.client.getHttpPipeline(),
            PeerRouteListInner.class, PeerRouteListInner.class, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<PeerRouteListInner>, PeerRouteListInner>
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PeerRouteListInner> listLearnedRoutesAsync(String resourceGroupName, String hubName,
        String connectionName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PeerRouteListInner> listAdvertisedRoutesAsync(String resourceGroupName, String hubName,
        String connectionName) {
