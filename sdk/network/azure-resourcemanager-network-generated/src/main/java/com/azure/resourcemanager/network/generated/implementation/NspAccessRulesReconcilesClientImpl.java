 ...
 */
public final class NspAccessRulesReconcilesClientImpl implements NspAccessRulesReconcilesClient {
    /**
     * The proxy service used to perform REST calls.
     */
    private final NspAccessRulesReconcilesService service;
    ...
    /**
     * Initializes an instance of NspAccessRulesReconcilesClientImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    NspAccessRulesReconcilesClientImpl(NetworkManagementClientImpl client) {
        this.service = RestProxy.create(NspAccessRulesReconcilesService.class, client.getHttpPipeline(),
            client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for NetworkManagementClientNspAccessRulesReconciles to be used by the
     * proxy service to perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "NetworkManagementCli")
    public interface NspAccessRulesReconcilesService {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Object> postAsync(String resourceGroupName, String networkSecurityPerimeterName, String profileName,
        String accessRuleName, Object parameters) {
        return postWithResponseAsync(resourceGroupName, networkSecurityPerimeterName, profileName, accessRuleName,
    ...
    public Object post(String resourceGroupName, String networkSecurityPerimeterName, String profileName,
        String accessRuleName, Object parameters) {
        return postWithResponse(resourceGroupName, networkSecurityPerimeterName, profileName, accessRuleName,
