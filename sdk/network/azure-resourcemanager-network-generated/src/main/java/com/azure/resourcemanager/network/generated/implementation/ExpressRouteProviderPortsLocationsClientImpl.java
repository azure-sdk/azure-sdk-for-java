...
public final class ExpressRouteProviderPortsLocationsClientImpl implements ExpressRouteProviderPortsLocationsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ExpressRouteProviderPortListResultInner> listAsync(String filter) {
        return listWithResponseAsync(filter)
            .flatMap(
                (Response<ExpressRouteProviderPortListResultInner> res) -> {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ExpressRouteProviderPortListResultInner> listAsync() {
