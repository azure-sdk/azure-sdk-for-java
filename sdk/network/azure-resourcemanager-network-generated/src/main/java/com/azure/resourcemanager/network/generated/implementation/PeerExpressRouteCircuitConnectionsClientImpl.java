...
import com.azure.resourcemanager.network.generated.models.PeerExpressRouteCircuitConnectionListResult;
...
public final class PeerExpressRouteCircuitConnectionsClientImpl implements PeerExpressRouteCircuitConnectionsClient {
    ...
    public interface PeerExpressRouteCircuitConnectionsService {
        ...
        Mono<Response<PeerExpressRouteCircuitConnectionInner>> get(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<PeerExpressRouteCircuitConnectionListResult>> list(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("circuitName") String circuitName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public PeerExpressRouteCircuitConnectionInner get(String resourceGroupName, String circuitName, String peeringName,
    ...
    private Mono<PagedResponse<PeerExpressRouteCircuitConnectionInner>> listSinglePageAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(context -> service.list(this.client.getEndpoint(), resourceGroupName, circuitName, peeringName,
                apiVersion, this.client.getSubscriptionId(), accept, context))
            .<PagedResponse<PeerExpressRouteCircuitConnectionInner>>map(res -> new PagedResponseBase<>(res.getRequest(),
