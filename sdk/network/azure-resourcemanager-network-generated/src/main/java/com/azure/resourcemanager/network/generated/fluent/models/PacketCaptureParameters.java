...
public class PacketCaptureParameters implements JsonSerializable<PacketCaptureParameters> {
     ...
     */
    private PacketCaptureStorageSettings storageSettings;
    ...
    /**
     * Get the storageSettings property: The storage setting for a packet capture session.
     * 
     * @return the storageSettings value.
     */
    public PacketCaptureStorageSettings storageSettings() {
        return this.storageSettings;
    }

    /**
     * Set the storageSettings property: The storage setting for a packet capture session.
     * 
     * @param storageSettings the storageSettings value to set.
     * @return the PacketCaptureParameters object itself.
     */
    public PacketCaptureParameters withStorageSettings(PacketCaptureStorageSettings storageSettings) {
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("target".equals(fieldName)) {
                    ...
                    deserializedPacketCaptureParameters.storageSettings = PacketCaptureStorageSettings.fromJson(reader);
