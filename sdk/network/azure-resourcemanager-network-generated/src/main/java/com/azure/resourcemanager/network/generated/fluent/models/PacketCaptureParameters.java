...
public class PacketCaptureParameters {
     ...
     */
    @JsonProperty(value = "queryPacketCaptureLastOperationId")
    private String queryPacketCaptureLastOperationId;
    ...
    /**
     * Get the queryPacketCaptureLastOperationId property: The last operation Id of querying packet capture.
     *
     * @return the queryPacketCaptureLastOperationId value.
     */
    public String queryPacketCaptureLastOperationId() {
        return this.queryPacketCaptureLastOperationId;
    }

    /**
     * Set the queryPacketCaptureLastOperationId property: The last operation Id of querying packet capture.
     *
     * @param queryPacketCaptureLastOperationId the queryPacketCaptureLastOperationId value to set.
     * @return the PacketCaptureParameters object itself.
     */
    public PacketCaptureParameters withQueryPacketCaptureLastOperationId(String queryPacketCaptureLastOperationId) {
        this.queryPacketCaptureLastOperationId = queryPacketCaptureLastOperationId;
        return this;
    }
