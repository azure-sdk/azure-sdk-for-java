...
public final class NetworkVirtualApplianceImpl
    ...
    public Response<Void> restartWithResponse(NetworkVirtualApplianceInstanceIds networkVirtualApplianceInstanceIds,
        Context context) {
        return serviceManager.networkVirtualAppliances().restartWithResponse(resourceGroupName,
            networkVirtualApplianceName, networkVirtualApplianceInstanceIds, context);
    }
