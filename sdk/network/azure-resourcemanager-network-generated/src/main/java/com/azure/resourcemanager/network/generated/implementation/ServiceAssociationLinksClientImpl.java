...
public final class ServiceAssociationLinksClientImpl implements ServiceAssociationLinksClient {
    ...
    public interface ServiceAssociationLinksService {
        ...
        Mono<Response<ServiceAssociationLinksListResultInner>> list(@HostParam("$host") String endpoint,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ServiceAssociationLinksListResultInner> listAsync(String resourceGroupName, String virtualNetworkName,
        String subnetName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ServiceAssociationLinksListResultInner> listWithResponse(String resourceGroupName,
        String virtualNetworkName, String subnetName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ServiceAssociationLinksListResultInner list(String resourceGroupName, String virtualNetworkName,
        String subnetName) {
