...
public final class NetworkInterfaceIpConfigurationInner extends SubResource {
    ...
    public String privateIpAddressPrefix() {
        return this.innerProperties() == null ? null : this.innerProperties().privateIpAddressPrefix();
    }
     ...
     * @return the NetworkInterfaceIpConfigurationInner object itself.
     */
    public NetworkInterfaceIpConfigurationInner withPrivateIpAddressPrefix(String privateIpAddressPrefix) {
        if (this.innerProperties() == null) {
            this.innerProperties = new NetworkInterfaceIpConfigurationPropertiesFormatInner();
        }
        this.innerProperties().withPrivateIpAddressPrefix(privateIpAddressPrefix);
        return this;
    }
