...
public final class NetworkManagersClientImpl implements NetworkManagersClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<NetworkManagerInner> createOrUpdateAsync(String resourceGroupName, String networkManagerName,
    ...
    private Mono<Response<Flux<ByteBuffer>>> deleteWithResponseAsync(String resourceGroupName,
        String networkManagerName, Boolean force) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<NetworkManagerInner> patchAsync(String resourceGroupName, String networkManagerName,
