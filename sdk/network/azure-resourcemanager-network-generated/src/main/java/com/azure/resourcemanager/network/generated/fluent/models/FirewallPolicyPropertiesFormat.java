...
public final class FirewallPolicyPropertiesFormat {
     ...
     */
    @JsonProperty(value = "firewallPolicySize", access = JsonProperty.Access.WRITE_ONLY)
    private String firewallPolicySize;
    ...
    /**
     * Get the firewallPolicySize property: A read-only string that represents the size of the
     * FirewallPolicyPropertiesFormat in MB. (ex 0.5MB).
     *
     * @return the firewallPolicySize value.
     */
    public String firewallPolicySize() {
        return this.firewallPolicySize;
    }
