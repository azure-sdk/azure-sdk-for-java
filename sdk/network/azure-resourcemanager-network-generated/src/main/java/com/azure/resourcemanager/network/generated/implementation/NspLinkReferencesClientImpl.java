...
import com.azure.resourcemanager.network.generated.models.NspLinkReferenceListResult;
import java.nio.ByteBuffer;
import reactor.core.publisher.Flux;
import reactor.core.publisher.Mono;

/**
 * An instance of this class provides access to all the operations defined in NspLinkReferencesClient.
 */
public final class NspLinkReferencesClientImpl implements NspLinkReferencesClient {
    /**
     * The proxy service used to perform REST calls.
     */
    private final NspLinkReferencesService service;
    ...
    /**
     * Initializes an instance of NspLinkReferencesClientImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    NspLinkReferencesClientImpl(NetworkManagementClientImpl client) {
        this.service
            = RestProxy.create(NspLinkReferencesService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for NetworkManagementClientNspLinkReferences to be used by the proxy
     * service to perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "NetworkManagementCli")
    public interface NspLinkReferencesService {
