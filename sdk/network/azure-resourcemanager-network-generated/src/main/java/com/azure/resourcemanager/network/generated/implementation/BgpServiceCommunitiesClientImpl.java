...
import com.azure.resourcemanager.network.generated.models.BgpServiceCommunityListResult;
...
public final class BgpServiceCommunitiesClientImpl implements BgpServiceCommunitiesClient {
    ...
    public interface BgpServiceCommunitiesService {
        ...
        Mono<Response<BgpServiceCommunityListResult>> list(@HostParam("$host") String endpoint,
    ...
    private Mono<PagedResponse<BgpServiceCommunityInner>> listSinglePageAsync() {
        ...
        return FluxUtil
            .withContext(context -> service.list(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(),
                accept, context))
            .<PagedResponse<BgpServiceCommunityInner>>map(res -> new PagedResponseBase<>(res.getRequest(),
    ...
    private PagedFlux<BgpServiceCommunityInner> listAsync() {
