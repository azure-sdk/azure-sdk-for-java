...
import com.azure.resourcemanager.network.generated.models.LoadBalancerOutboundRuleListResult;
...
public final class LoadBalancerOutboundRulesClientImpl implements LoadBalancerOutboundRulesClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<OutboundRuleInner> getAsync(String resourceGroupName, String loadBalancerName,
        String outboundRuleName) {
