...
public final class NetworkInterfacesImpl implements NetworkInterfaces {
    ...
    public PagedIterable<NetworkInterface> listCloudServiceRoleInstanceNetworkInterface(
        String resourceGroupName, String cloudServiceName, String roleInstanceName) {
        PagedIterable<NetworkInterfaceInner> inner =
            this
                .serviceClient()
                .listCloudServiceRoleInstanceNetworkInterface(resourceGroupName, cloudServiceName, roleInstanceName);
        return Utils.mapPage(inner, inner1 -> new NetworkInterfaceImpl(inner1, this.manager()));
    }
    ...
    public PagedIterable<NetworkInterface> listCloudServiceNetworkInterface(
        String resourceGroupName, String cloudServiceName) {
        PagedIterable<NetworkInterfaceInner> inner =
            this.serviceClient().listCloudServiceNetworkInterface(resourceGroupName, cloudServiceName);
        return Utils.mapPage(inner, inner1 -> new NetworkInterfaceImpl(inner1, this.manager()));
    }
    ...
    public PagedIterable<NetworkInterface> listCloudServiceNetworkInterface(
        String resourceGroupName, String cloudServiceName, Context context) {
        PagedIterable<NetworkInterfaceInner> inner =
            this.serviceClient().listCloudServiceNetworkInterface(resourceGroupName, cloudServiceName, context);
        return Utils.mapPage(inner, inner1 -> new NetworkInterfaceImpl(inner1, this.manager()));
    }

    public Response<NetworkInterface> getCloudServiceRoleInstanceNetworkInterfaceWithResponse(
        String resourceGroupName,
        String cloudServiceName,
        String roleInstanceName,
        String networkInterfaceName,
    ...
    public NetworkInterface getCloudServiceRoleInstanceNetworkInterface(
        String resourceGroupName, String cloudServiceName, String roleInstanceName, String networkInterfaceName) {
        NetworkInterfaceInner inner =
            this
                .serviceClient()
