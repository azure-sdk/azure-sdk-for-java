...
public final class NetworkInterfacesImpl implements NetworkInterfaces {
    ...
    public Response<Void> deleteByResourceGroupWithResponse(
        ...
        return this.serviceClient().deleteWithResponse(resourceGroupName, networkInterfaceName, context);
    }
    ...
    public Response<EffectiveRouteListResult> getEffectiveRouteTableWithResponse(
        String resourceGroupName, String networkInterfaceName, Context context) {
        Response<EffectiveRouteListResultInner> inner =
            this.serviceClient().getEffectiveRouteTableWithResponse(resourceGroupName, networkInterfaceName, context);
        if (inner != null) {
            return new SimpleResponse<>(
                inner.getRequest(),
                inner.getStatusCode(),
                inner.getHeaders(),
                new EffectiveRouteListResultImpl(inner.getValue(), this.manager()));
        } else {
            return null;
        }
    }
    ...
    public Response<EffectiveNetworkSecurityGroupListResult> listEffectiveNetworkSecurityGroupsWithResponse(
        String resourceGroupName, String networkInterfaceName, Context context) {
        Response<EffectiveNetworkSecurityGroupListResultInner> inner =
            this
                .serviceClient()
                .listEffectiveNetworkSecurityGroupsWithResponse(resourceGroupName, networkInterfaceName, context);
        if (inner != null) {
            return new SimpleResponse<>(
                inner.getRequest(),
                inner.getStatusCode(),
                inner.getHeaders(),
                new EffectiveNetworkSecurityGroupListResultImpl(inner.getValue(), this.manager()));
        } else {
            return null;
        }
    }
    ...
    public void deleteById(String id) {
        ...
        this.deleteByResourceGroupWithResponse(resourceGroupName, networkInterfaceName, Context.NONE);
    }
    ...
    public Response<Void> deleteByIdWithResponse(String id, Context context) {
        ...
        return this.deleteByResourceGroupWithResponse(resourceGroupName, networkInterfaceName, context);
    }
