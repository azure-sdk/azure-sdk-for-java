...
public final class NetworkWatcherImpl implements NetworkWatcher, NetworkWatcher.Definition, NetworkWatcher.Update {
    ...
    public List<Integer> runningOperationIds() {
        List<Integer> inner = this.innerModel().runningOperationIds();
        if (inner != null) {
    ...
    public NetworkWatcherImpl withRunningOperationIds(List<Integer> runningOperationIds) {
        this.innerModel().withRunningOperationIds(runningOperationIds);
        return this;
    }
