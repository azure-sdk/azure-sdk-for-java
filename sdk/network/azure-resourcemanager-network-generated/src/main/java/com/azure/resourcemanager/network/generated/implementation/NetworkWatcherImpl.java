...
public final class NetworkWatcherImpl implements NetworkWatcher, NetworkWatcher.Definition, NetworkWatcher.Update {
    ...
    public FlowLogInformationResponse setFlowLogConfiguration(FlowLogInformationRequest parameters) {
        return serviceManager
            .networkWatchers()
            .setFlowLogConfiguration(resourceGroupName, networkWatcherName, parameters);
    }

    public FlowLogInformationResponse setFlowLogConfiguration(FlowLogInformationRequest parameters, Context context) {
        return serviceManager
            .networkWatchers()
            .setFlowLogConfiguration(resourceGroupName, networkWatcherName, parameters, context);
    }

    public FlowLogInformationResponse getFlowLogStatus(FlowLogStatusParameters parameters) {
        return serviceManager.networkWatchers().getFlowLogStatus(resourceGroupName, networkWatcherName, parameters);
    }

    public FlowLogInformationResponse getFlowLogStatus(FlowLogStatusParameters parameters, Context context) {
        return serviceManager
            .networkWatchers()
