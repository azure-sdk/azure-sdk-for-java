...
public final class NetworkInterfacesClientImpl implements NetworkInterfacesClient {
    ...
    public interface NetworkInterfacesService {
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<NetworkInterfaceInner>> createOrUpdate(
            @HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("networkInterfaceName") String networkInterfaceName,
            @QueryParam("api-version") String apiVersion,
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<EffectiveRouteListResultInner>> getEffectiveRouteTable(
            @HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("networkInterfaceName") String networkInterfaceName,
            @QueryParam("api-version") String apiVersion,
        ...
        @ExpectedResponses({200, 202})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<EffectiveNetworkSecurityGroupListResultInner>> listEffectiveNetworkSecurityGroups(
            @HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("networkInterfaceName") String networkInterfaceName,
            @QueryParam("api-version") String apiVersion,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Void>> deleteWithResponseAsync(String resourceGroupName, String networkInterfaceName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String networkInterfaceName) {
        return deleteWithResponseAsync(resourceGroupName, networkInterfaceName).flatMap(ignored -> Mono.empty());
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<Void> deleteWithResponse(String resourceGroupName, String networkInterfaceName, Context context) {
        return deleteWithResponseAsync(resourceGroupName, networkInterfaceName, context).block();
    }
    ...
    public void delete(String resourceGroupName, String networkInterfaceName) {
        deleteWithResponse(resourceGroupName, networkInterfaceName, Context.NONE);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<NetworkInterfaceInner>> createOrUpdateWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<NetworkInterfaceInner> createOrUpdateWithResponse(
        String resourceGroupName, String networkInterfaceName, NetworkInterfaceInner parameters, Context context) {
        return createOrUpdateWithResponseAsync(resourceGroupName, networkInterfaceName, parameters, context).block();
    }
    ...
    public NetworkInterfaceInner createOrUpdate(
        String resourceGroupName, String networkInterfaceName, NetworkInterfaceInner parameters) {
        return createOrUpdateWithResponse(resourceGroupName, networkInterfaceName, parameters, Context.NONE).getValue();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<EffectiveRouteListResultInner>> getEffectiveRouteTableWithResponseAsync(
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return all route tables applied to a network interface along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<EffectiveRouteListResultInner> getEffectiveRouteTableWithResponse(
        String resourceGroupName, String networkInterfaceName, Context context) {
        return getEffectiveRouteTableWithResponseAsync(resourceGroupName, networkInterfaceName, context).block();
    }
    ...
    public EffectiveRouteListResultInner getEffectiveRouteTable(String resourceGroupName, String networkInterfaceName) {
        return getEffectiveRouteTableWithResponse(resourceGroupName, networkInterfaceName, Context.NONE).getValue();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<EffectiveNetworkSecurityGroupListResultInner>>
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return all network security groups applied to a network interface along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<EffectiveNetworkSecurityGroupListResultInner> listEffectiveNetworkSecurityGroupsWithResponse(
        String resourceGroupName, String networkInterfaceName, Context context) {
        return listEffectiveNetworkSecurityGroupsWithResponseAsync(resourceGroupName, networkInterfaceName, context)
            .block();
    }
    ...
    public EffectiveNetworkSecurityGroupListResultInner listEffectiveNetworkSecurityGroups(
        String resourceGroupName, String networkInterfaceName) {
        return listEffectiveNetworkSecurityGroupsWithResponse(resourceGroupName, networkInterfaceName, Context.NONE)
            .getValue();
    }
