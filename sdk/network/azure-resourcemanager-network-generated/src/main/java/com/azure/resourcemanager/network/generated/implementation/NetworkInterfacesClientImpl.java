...
public final class NetworkInterfacesClientImpl implements NetworkInterfacesClient {
    ...
    public interface NetworkInterfacesService {
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<NetworkInterfaceListResult>> listCloudServiceRoleInstanceNetworkInterface(
            @HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("cloudServiceName") String cloudServiceName,
            @PathParam("roleInstanceName") String roleInstanceName,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<NetworkInterfaceListResult>> listCloudServiceNetworkInterface(
            @HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("cloudServiceName") String cloudServiceName,
            @QueryParam("api-version") String apiVersion,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<NetworkInterfaceInner>> getCloudServiceRoleInstanceNetworkInterface(
            @HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("cloudServiceName") String cloudServiceName,
            @PathParam("roleInstanceName") String roleInstanceName,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<NetworkInterfaceListResult>> listCloudServiceRoleInstanceNetworkInterfaceNext(
            @PathParam(value = "nextLink", encoded = true) String nextLink,
            @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<NetworkInterfaceListResult>> listCloudServiceNetworkInterfaceNext(
            @PathParam(value = "nextLink", encoded = true) String nextLink,
            @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept,
            Context context);
     ...
     * @return information about all network interfaces in a role instance in a cloud service along with {@link
    ...
    public NetworkInterfaceInner getCloudServiceNetworkInterface(
        String resourceGroupName, String cloudServiceName, String roleInstanceName, String networkInterfaceName) {
        final String expand = null;
        return getCloudServiceNetworkInterfaceWithResponse(
                resourceGroupName, cloudServiceName, roleInstanceName, networkInterfaceName, expand, Context.NONE)
            .getValue();
    }
    ...
    public NetworkInterfaceInner getVirtualMachineScaleSetNetworkInterface(
        ...
        String networkInterfaceName) {
        final String expand = null;
        return getVirtualMachineScaleSetNetworkInterfaceWithResponse(
                resourceGroupName,
                virtualMachineScaleSetName,
                virtualmachineIndex,
                networkInterfaceName,
    ...
    public NetworkInterfaceIpConfigurationInner getVirtualMachineScaleSetIpConfiguration(
        ...
        String ipConfigurationName) {
        final String expand = null;
        return getVirtualMachineScaleSetIpConfigurationWithResponse(
                resourceGroupName,
                virtualMachineScaleSetName,
                virtualmachineIndex,
                networkInterfaceName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<NetworkInterfaceInner>> listCloudServiceRoleInstanceNetworkInterfaceSinglePageAsync(
        String resourceGroupName, String cloudServiceName, String roleInstanceName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<NetworkInterfaceInner> listCloudServiceRoleInstanceNetworkInterfaceAsync(
        String resourceGroupName, String cloudServiceName, String roleInstanceName) {
        return new PagedFlux<>(
            () ->
                listCloudServiceRoleInstanceNetworkInterfaceSinglePageAsync(
                    resourceGroupName, cloudServiceName, roleInstanceName),
            nextLink -> listCloudServiceRoleInstanceNetworkInterfaceNextSinglePageAsync(nextLink));
    }
    ...
    private PagedFlux<NetworkInterfaceInner> listCloudServiceRoleInstanceNetworkInterfaceAsync(
        ...
        return new PagedFlux<>(
            () ->
                listCloudServiceRoleInstanceNetworkInterfaceSinglePageAsync(
                    resourceGroupName, cloudServiceName, roleInstanceName, context),
            nextLink -> listCloudServiceRoleInstanceNetworkInterfaceNextSinglePageAsync(nextLink, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<NetworkInterfaceInner> listCloudServiceRoleInstanceNetworkInterface(
        String resourceGroupName, String cloudServiceName, String roleInstanceName) {
        return new PagedIterable<>(
            listCloudServiceRoleInstanceNetworkInterfaceAsync(resourceGroupName, cloudServiceName, roleInstanceName));
    }
    ...
    public PagedIterable<NetworkInterfaceInner> listCloudServiceRoleInstanceNetworkInterface(
        String resourceGroupName, String cloudServiceName, String roleInstanceName, Context context) {
        return new PagedIterable<>(
            listCloudServiceRoleInstanceNetworkInterfaceAsync(
                resourceGroupName, cloudServiceName, roleInstanceName, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<NetworkInterfaceInner>> listCloudServiceNetworkInterfaceSinglePageAsync(
        String resourceGroupName, String cloudServiceName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<NetworkInterfaceInner> listCloudServiceNetworkInterfaceAsync(
        String resourceGroupName, String cloudServiceName) {
        return new PagedFlux<>(
            () -> listCloudServiceNetworkInterfaceSinglePageAsync(resourceGroupName, cloudServiceName),
            nextLink -> listCloudServiceNetworkInterfaceNextSinglePageAsync(nextLink));
    }
    ...
    private PagedFlux<NetworkInterfaceInner> listCloudServiceNetworkInterfaceAsync(
        String resourceGroupName, String cloudServiceName, Context context) {
        return new PagedFlux<>(
            () -> listCloudServiceNetworkInterfaceSinglePageAsync(resourceGroupName, cloudServiceName, context),
            nextLink -> listCloudServiceNetworkInterfaceNextSinglePageAsync(nextLink, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<NetworkInterfaceInner> listCloudServiceNetworkInterface(
        String resourceGroupName, String cloudServiceName) {
        return new PagedIterable<>(listCloudServiceNetworkInterfaceAsync(resourceGroupName, cloudServiceName));
    }
    ...
    public PagedIterable<NetworkInterfaceInner> listCloudServiceNetworkInterface(
        String resourceGroupName, String cloudServiceName, Context context) {
        return new PagedIterable<>(listCloudServiceNetworkInterfaceAsync(resourceGroupName, cloudServiceName, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<NetworkInterfaceInner>> getCloudServiceRoleInstanceNetworkInterfaceWithResponseAsync(
        String resourceGroupName, String cloudServiceName, String roleInstanceName, String networkInterfaceName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<NetworkInterfaceInner> getCloudServiceRoleInstanceNetworkInterfaceAsync(
        String resourceGroupName, String cloudServiceName, String roleInstanceName, String networkInterfaceName) {
        return getCloudServiceRoleInstanceNetworkInterfaceWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<NetworkInterfaceInner> getCloudServiceRoleInstanceNetworkInterfaceWithResponse(
        String resourceGroupName,
        String cloudServiceName,
        String roleInstanceName,
        String networkInterfaceName,
        Context context) {
        return getCloudServiceRoleInstanceNetworkInterfaceWithResponseAsync(
                resourceGroupName, cloudServiceName, roleInstanceName, networkInterfaceName, context)
            .block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public NetworkInterfaceInner getCloudServiceRoleInstanceNetworkInterface(
        String resourceGroupName, String cloudServiceName, String roleInstanceName, String networkInterfaceName) {
        return getCloudServiceRoleInstanceNetworkInterfaceWithResponse(
                resourceGroupName, cloudServiceName, roleInstanceName, networkInterfaceName, Context.NONE)
            .getValue();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<NetworkInterfaceInner>> listCloudServiceRoleInstanceNetworkInterfaceNextSinglePageAsync(
        String nextLink) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
    ...
    private Mono<PagedResponse<NetworkInterfaceInner>> listCloudServiceRoleInstanceNetworkInterfaceNextSinglePageAsync(
        ...
        context = this.client.mergeContext(context);
        return service
            .listCloudServiceRoleInstanceNetworkInterfaceNext(nextLink, this.client.getEndpoint(), accept, context)
            .map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<NetworkInterfaceInner>> listCloudServiceNetworkInterfaceNextSinglePageAsync(
        String nextLink) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        ...
        return FluxUtil
            .withContext(
                context ->
                    service.listCloudServiceNetworkInterfaceNext(nextLink, this.client.getEndpoint(), accept, context))
            .<PagedResponse<NetworkInterfaceInner>>map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(),
    ...
    private Mono<PagedResponse<NetworkInterfaceInner>> listCloudServiceNetworkInterfaceNextSinglePageAsync(
        ...
        context = this.client.mergeContext(context);
        return service
            .listCloudServiceNetworkInterfaceNext(nextLink, this.client.getEndpoint(), accept, context)
            .map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(),
