...
public final class SubnetImpl implements Subnet, Subnet.Definition, Subnet.Update {
    ...
    public List<ServiceEndpointPropertiesFormat> serviceEndpoints() {
        List<ServiceEndpointPropertiesFormatInner> inner = this.innerModel().serviceEndpoints();
        if (inner != null) {
            return Collections.unmodifiableList(inner.stream()
                .map(inner1 -> new ServiceEndpointPropertiesFormatImpl(inner1, this.manager()))
    ...
    public SubnetImpl withServiceEndpoints(List<ServiceEndpointPropertiesFormatInner> serviceEndpoints) {
