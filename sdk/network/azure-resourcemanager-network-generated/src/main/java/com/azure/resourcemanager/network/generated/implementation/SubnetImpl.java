...
public final class SubnetImpl implements Subnet, Subnet.Definition, Subnet.Update {
    ...
    public List<IpamPoolPrefixAllocation> ipamPoolPrefixAllocations() {
        List<IpamPoolPrefixAllocation> inner = this.innerModel().ipamPoolPrefixAllocations();
        if (inner != null) {
            return Collections.unmodifiableList(inner);
        } else {
            return Collections.emptyList();
    ...
    public SubnetImpl withIpamPoolPrefixAllocations(List<IpamPoolPrefixAllocation> ipamPoolPrefixAllocations) {
        this.innerModel().withIpamPoolPrefixAllocations(ipamPoolPrefixAllocations);
        return this;
    }
}
