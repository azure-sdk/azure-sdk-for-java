...
public interface NetworkInterfacesClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<Void> deleteWithResponse(String resourceGroupName, String networkInterfaceName, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<NetworkInterfaceInner> createOrUpdateWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<EffectiveRouteListResultInner> getEffectiveRouteTableWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<EffectiveNetworkSecurityGroupListResultInner> listEffectiveNetworkSecurityGroupsWithResponse(
        String resourceGroupName, String networkInterfaceName, Context context);
