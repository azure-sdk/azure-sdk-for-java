...
public interface NetworkInterfacesClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<NetworkInterfaceInner> listCloudServiceRoleInstanceNetworkInterface(
        String resourceGroupName, String cloudServiceName, String roleInstanceName);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<NetworkInterfaceInner> listCloudServiceNetworkInterface(
        String resourceGroupName, String cloudServiceName);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<NetworkInterfaceInner> getCloudServiceRoleInstanceNetworkInterfaceWithResponse(
        String resourceGroupName,
        String cloudServiceName,
        String roleInstanceName,
        String networkInterfaceName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    NetworkInterfaceInner getCloudServiceRoleInstanceNetworkInterface(
        String resourceGroupName, String cloudServiceName, String roleInstanceName, String networkInterfaceName);
}
