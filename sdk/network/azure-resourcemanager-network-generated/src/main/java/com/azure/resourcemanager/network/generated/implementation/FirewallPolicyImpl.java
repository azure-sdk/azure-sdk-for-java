...
public final class FirewallPolicyImpl implements FirewallPolicy, FirewallPolicy.Definition, FirewallPolicy.Update {
    ...
    public Response<FirewallPolicyDraft> getDraftWithResponse(String expand, Context context) {
        return serviceManager
            .firewallPolicies()
            .getDraftWithResponse(resourceGroupName, firewallPolicyName, expand, context);
    }
    ...
    public void deployDraft() {
        serviceManager.firewallPolicies().deployDraft(resourceGroupName, firewallPolicyName);
    }

    public void deployDraft(Context context) {
        serviceManager.firewallPolicies().deployDraft(resourceGroupName, firewallPolicyName, context);
    }

    public Response<Void> deleteDraftWithResponse(Context context) {
        return serviceManager
            .firewallPolicies()
    ...
    public void deleteDraft() {
        serviceManager.firewallPolicies().deleteDraft(resourceGroupName, firewallPolicyName);
    }
