...
public final class FirewallPolicyImpl implements FirewallPolicy, FirewallPolicy.Definition, FirewallPolicy.Update {
    ...
    public FirewallPolicyDraft createOrUpdateDraft(FirewallPolicyDraftInner parameters) {
        return serviceManager.firewallPolicies().createOrUpdateDraft(resourceGroupName, firewallPolicyName, parameters);
    }

    public Response<FirewallPolicyDraft> getDraftWithResponse(Context context) {
        return serviceManager.firewallPolicies().getDraftWithResponse(resourceGroupName, firewallPolicyName, context);
    }

    public FirewallPolicyDraft getDraft() {
        return serviceManager.firewallPolicies().getDraft(resourceGroupName, firewallPolicyName);
    }

    public FirewallPolicyDraft deployDraft() {
        return serviceManager.firewallPolicies().deployDraft(resourceGroupName, firewallPolicyName);
    }

    public FirewallPolicyDraft deployDraft(Context context) {
        return serviceManager.firewallPolicies().deployDraft(resourceGroupName, firewallPolicyName, context);
    }

    public Response<Object> deleteDraftWithResponse(Context context) {
        return serviceManager
            .firewallPolicies()
            .deleteDraftWithResponse(resourceGroupName, firewallPolicyName, context);
    }

    public Object deleteDraft() {
        return serviceManager.firewallPolicies().deleteDraft(resourceGroupName, firewallPolicyName);
    }
    ...
    public FirewallPolicyImpl withSql(FirewallPolicySql sql) {
        this.innerModel().withSql(sql);
        return this;
    }
