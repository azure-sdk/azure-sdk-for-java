...
public final class ConnectivityConfigurationPropertiesConnectivityCapabilities
     ...
     * configuration.
     */
    private ConnectedGroupPrivateEndpointScale connectedGroupPrivateEndpointScale;
    ...
    /**
     * Get the connectedGroupPrivateEndpointScale property: Option indicating the scale of private endpoints allowed in
     * the connected group of the connectivity configuration.
     * 
     * @return the connectedGroupPrivateEndpointScale value.
     */
    public ConnectedGroupPrivateEndpointScale connectedGroupPrivateEndpointScale() {
        return this.connectedGroupPrivateEndpointScale;
    }

    /**
     * Set the connectedGroupPrivateEndpointScale property: Option indicating the scale of private endpoints allowed in
     * the connected group of the connectivity configuration.
     * 
     * @param connectedGroupPrivateEndpointScale the connectedGroupPrivateEndpointScale value to set.
     * @return the ConnectivityConfigurationPropertiesConnectivityCapabilities object itself.
     */
    public ConnectivityConfigurationPropertiesConnectivityCapabilities
        withConnectedGroupPrivateEndpointScale(ConnectedGroupPrivateEndpointScale connectedGroupPrivateEndpointScale) {
    ...
    public void validate() {
        if (connectedGroupPrivateEndpointScale() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property connectedGroupPrivateEndpointScale in model ConnectivityConfigurationPropertiesConnectivityCapabilities"));
        }
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeStringField("connectedGroupPrivateEndpointScale",
            this.connectedGroupPrivateEndpointScale == null
                ? null
                : this.connectedGroupPrivateEndpointScale.toString());
    ...
    public static ConnectivityConfigurationPropertiesConnectivityCapabilities fromJson(JsonReader jsonReader)
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("connectedGroupPrivateEndpointScale".equals(fieldName)) {
                    deserializedConnectivityConfigurationPropertiesConnectivityCapabilities.connectedGroupPrivateEndpointScale
                        = ConnectedGroupPrivateEndpointScale.fromString(reader.getString());
