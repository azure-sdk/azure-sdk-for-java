...
public interface FirewallPolicyRuleCollectionGroupsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<FirewallPolicyDraftRuleCollectionGroupInner> createOrUpdateDraftWithResponse(
        String resourceGroupName,
        String firewallPolicyName,
        String ruleCollectionGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    FirewallPolicyDraftRuleCollectionGroupInner createOrUpdateDraft(
        String resourceGroupName,
        String firewallPolicyName,
        String ruleCollectionGroupName,
        FirewallPolicyDraftRuleCollectionGroupInner parameters);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<FirewallPolicyDraftRuleCollectionGroupInner> getDraftWithResponse(
        String resourceGroupName,
        String firewallPolicyName,
        String ruleCollectionGroupName,
        FirewallPolicyRuleCollectionGroupInner parameters,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    FirewallPolicyDraftRuleCollectionGroupInner getDraft(
        String resourceGroupName,
        String firewallPolicyName,
        String ruleCollectionGroupName,
        FirewallPolicyRuleCollectionGroupInner parameters);
