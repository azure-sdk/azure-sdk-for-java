...
public interface FirewallPolicyRuleCollectionGroupsClient {
    ...
    Response<FirewallPolicyRuleCollectionGroupDraftInner> getDraftWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    FirewallPolicyRuleCollectionGroupDraftInner getDraft(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<FirewallPolicyRuleCollectionGroupDraftInner> createOrUpdateDraftWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    FirewallPolicyRuleCollectionGroupDraftInner createOrUpdateDraft(
        String resourceGroupName,
        String firewallPolicyName,
        String ruleCollectionGroupName,
        FirewallPolicyRuleCollectionGroupDraftInner parameters);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<FirewallPolicyRuleCollectionGroupInner> deleteDraftWithResponse(
        String resourceGroupName, String firewallPolicyName, String ruleCollectionGroupName, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    FirewallPolicyRuleCollectionGroupInner deleteDraft(
        String resourceGroupName, String firewallPolicyName, String ruleCollectionGroupName);
