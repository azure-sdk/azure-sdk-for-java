...
import com.azure.resourcemanager.network.generated.models.ApplicationGatewayAvailableSslPredefinedPolicies;
...
public final class ApplicationGatewaysClientImpl implements ApplicationGatewaysClient {
    ...
    public interface ApplicationGatewaysService {
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ApplicationGatewayInner>> getByResourceGroup(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("applicationGatewayName") String applicationGatewayName,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ApplicationGatewayInner>> updateTags(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("applicationGatewayName") String applicationGatewayName,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ApplicationGatewayListResult>> listByResourceGroup(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ApplicationGatewayListResult>> list(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200, 202 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Flux<ByteBuffer>>> backendHealth(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("applicationGatewayName") String applicationGatewayName,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
        ...
        @Headers({ "Content-Type: application/json" })
        @Post("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/applicationGateways/{applicationGatewayName}/prepareMigration")
        @ExpectedResponses({ 200, 202 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Flux<ByteBuffer>>> prepareMigration(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("applicationGatewayName") String applicationGatewayName,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @BodyParam("application/json") ApplicationGatewayMigrationRequest migrationRequest,
            @HeaderParam("Accept") String accept, Context context);

        @Headers({ "Content-Type: application/json" })
        @Post("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/applicationGateways/{applicationGatewayName}/executeMigration")
        @ExpectedResponses({ 200, 202 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Flux<ByteBuffer>>> executeMigration(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("applicationGatewayName") String applicationGatewayName,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @BodyParam("application/json") ApplicationGatewayMigrationRequest migrationRequest,
        ...
        @Headers({ "Content-Type: application/json" })
        @Post("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/applicationGateways/{applicationGatewayName}/commitMigration")
        @ExpectedResponses({ 200, 202 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Flux<ByteBuffer>>> commitMigration(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("applicationGatewayName") String applicationGatewayName,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @BodyParam("application/json") ApplicationGatewayMigrationRequest migrationRequest,
        ...
        @ExpectedResponses({ 200, 202 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Flux<ByteBuffer>>> backendHealthOnDemand(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("applicationGatewayName") String applicationGatewayName,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
        ...
        Mono<Response<List<String>>> listAvailableServerVariables(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<Response<List<String>>> listAvailableRequestHeaders(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<Response<List<String>>> listAvailableResponseHeaders(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @HeaderParam("Accept") String accept, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ApplicationGatewayInner>> getByResourceGroupWithResponseAsync(String resourceGroupName,
        String applicationGatewayName) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ApplicationGatewayInner> getByResourceGroupAsync(String resourceGroupName,
        String applicationGatewayName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ApplicationGatewayInner> getByResourceGroupWithResponse(String resourceGroupName,
        String applicationGatewayName, Context context) {
    ...
    private PollerFlux<PollResult<ApplicationGatewayInner>, ApplicationGatewayInner> beginCreateOrUpdateAsync(
        ...
        return this.client.<ApplicationGatewayInner, ApplicationGatewayInner>getLroResult(mono,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ApplicationGatewayInner> createOrUpdateAsync(String resourceGroupName, String applicationGatewayName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ApplicationGatewayInner>> updateTagsWithResponseAsync(String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ApplicationGatewayInner> updateTagsAsync(String resourceGroupName, String applicationGatewayName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ApplicationGatewayInner> updateTagsWithResponse(String resourceGroupName,
        String applicationGatewayName, TagsObject parameters, Context context) {
    ...
    private Mono<PagedResponse<ApplicationGatewayInner>> listByResourceGroupSinglePageAsync(String resourceGroupName) {
        ...
        return FluxUtil
            .withContext(context -> service.listByResourceGroup(this.client.getEndpoint(), resourceGroupName,
                apiVersion, this.client.getSubscriptionId(), accept, context))
            .<PagedResponse<ApplicationGatewayInner>>map(res -> new PagedResponseBase<>(res.getRequest(),
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<Void>, Void> beginStartAsync(String resourceGroupName,
        String applicationGatewayName) {
    ...
    private PollerFlux<PollResult<ApplicationGatewayBackendHealthInner>, ApplicationGatewayBackendHealthInner>
        ...
        return this.client.<ApplicationGatewayBackendHealthInner, ApplicationGatewayBackendHealthInner>getLroResult(
    ...
    /**
     * Validates the feasibility of the specified application gateway in a resource group for v1 to v2 migration and
     * spins up a parallel v2 gateway.
     * 
     * @param resourceGroupName The name of the resource group.
     * @param applicationGatewayName The name of the application gateway.
    ...
    private Mono<Response<Flux<ByteBuffer>>> prepareMigrationWithResponseAsync(String resourceGroupName,
        String applicationGatewayName, ApplicationGatewayMigrationRequest migrationRequest) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        if (migrationRequest == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter migrationRequest is required and cannot be null."));
        } else {
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.prepareMigration(this.client.getEndpoint(), resourceGroupName,
                applicationGatewayName, apiVersion, this.client.getSubscriptionId(), migrationRequest, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> prepareMigrationWithResponseAsync(String resourceGroupName,
        String applicationGatewayName, ApplicationGatewayMigrationRequest migrationRequest, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.prepareMigration(this.client.getEndpoint(), resourceGroupName, applicationGatewayName,
            apiVersion, this.client.getSubscriptionId(), migrationRequest, accept, context);
    }
    ...
    private PollerFlux<PollResult<Void>, Void> beginPrepareMigrationAsync(String resourceGroupName,
        String applicationGatewayName, ApplicationGatewayMigrationRequest migrationRequest) {
        Mono<Response<Flux<ByteBuffer>>> mono
            = prepareMigrationWithResponseAsync(resourceGroupName, applicationGatewayName, migrationRequest);
        return this.client.<Void, Void>getLroResult(mono, this.client.getHttpPipeline(), Void.class, Void.class,
            this.client.getContext());
    }
    ...
    private PollerFlux<PollResult<Void>, Void> beginPrepareMigrationAsync(String resourceGroupName,
        ...
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono
            = prepareMigrationWithResponseAsync(resourceGroupName, applicationGatewayName, migrationRequest, context);
        return this.client.<Void, Void>getLroResult(mono, this.client.getHttpPipeline(), Void.class, Void.class,
            context);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginPrepareMigration(String resourceGroupName,
        String applicationGatewayName, ApplicationGatewayMigrationRequest migrationRequest) {
        return this.beginPrepareMigrationAsync(resourceGroupName, applicationGatewayName, migrationRequest)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginPrepareMigration(String resourceGroupName,
        String applicationGatewayName, ApplicationGatewayMigrationRequest migrationRequest, Context context) {
        return this.beginPrepareMigrationAsync(resourceGroupName, applicationGatewayName, migrationRequest, context)
            .getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> prepareMigrationAsync(String resourceGroupName, String applicationGatewayName,
        ApplicationGatewayMigrationRequest migrationRequest) {
        return beginPrepareMigrationAsync(resourceGroupName, applicationGatewayName, migrationRequest).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> prepareMigrationAsync(String resourceGroupName, String applicationGatewayName,
        ApplicationGatewayMigrationRequest migrationRequest, Context context) {
        return beginPrepareMigrationAsync(resourceGroupName, applicationGatewayName, migrationRequest, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public void prepareMigration(String resourceGroupName, String applicationGatewayName,
        ApplicationGatewayMigrationRequest migrationRequest) {
        prepareMigrationAsync(resourceGroupName, applicationGatewayName, migrationRequest).block();
    }
    ...
    public void prepareMigration(String resourceGroupName, String applicationGatewayName,
        ApplicationGatewayMigrationRequest migrationRequest, Context context) {
        prepareMigrationAsync(resourceGroupName, applicationGatewayName, migrationRequest, context).block();
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> executeMigrationWithResponseAsync(String resourceGroupName,
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.executeMigration(this.client.getEndpoint(), resourceGroupName,
                applicationGatewayName, apiVersion, this.client.getSubscriptionId(), migrationRequest, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> executeMigrationWithResponseAsync(String resourceGroupName,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.executeMigration(this.client.getEndpoint(), resourceGroupName, applicationGatewayName,
            apiVersion, this.client.getSubscriptionId(), migrationRequest, accept, context);
    }
    ...
    private PollerFlux<PollResult<Void>, Void> beginExecuteMigrationAsync(String resourceGroupName,
        String applicationGatewayName, ApplicationGatewayMigrationRequest migrationRequest) {
        Mono<Response<Flux<ByteBuffer>>> mono
            = executeMigrationWithResponseAsync(resourceGroupName, applicationGatewayName, migrationRequest);
        return this.client.<Void, Void>getLroResult(mono, this.client.getHttpPipeline(), Void.class, Void.class,
            this.client.getContext());
    }
    ...
    private PollerFlux<PollResult<Void>, Void> beginExecuteMigrationAsync(String resourceGroupName,
        ...
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono
            = executeMigrationWithResponseAsync(resourceGroupName, applicationGatewayName, migrationRequest, context);
        return this.client.<Void, Void>getLroResult(mono, this.client.getHttpPipeline(), Void.class, Void.class,
            context);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginExecuteMigration(String resourceGroupName,
        String applicationGatewayName, ApplicationGatewayMigrationRequest migrationRequest) {
        return this.beginExecuteMigrationAsync(resourceGroupName, applicationGatewayName, migrationRequest)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginExecuteMigration(String resourceGroupName,
        String applicationGatewayName, ApplicationGatewayMigrationRequest migrationRequest, Context context) {
        return this.beginExecuteMigrationAsync(resourceGroupName, applicationGatewayName, migrationRequest, context)
            .getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> executeMigrationAsync(String resourceGroupName, String applicationGatewayName,
        ApplicationGatewayMigrationRequest migrationRequest) {
        return beginExecuteMigrationAsync(resourceGroupName, applicationGatewayName, migrationRequest).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<Void> executeMigrationAsync(String resourceGroupName, String applicationGatewayName,
        ApplicationGatewayMigrationRequest migrationRequest, Context context) {
        return beginExecuteMigrationAsync(resourceGroupName, applicationGatewayName, migrationRequest, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public void executeMigration(String resourceGroupName, String applicationGatewayName,
        ApplicationGatewayMigrationRequest migrationRequest) {
        executeMigrationAsync(resourceGroupName, applicationGatewayName, migrationRequest).block();
    }
    ...
    public void executeMigration(String resourceGroupName, String applicationGatewayName,
        ApplicationGatewayMigrationRequest migrationRequest, Context context) {
        executeMigrationAsync(resourceGroupName, applicationGatewayName, migrationRequest, context).block();
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> commitMigrationWithResponseAsync(String resourceGroupName,
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.commitMigration(this.client.getEndpoint(), resourceGroupName,
                applicationGatewayName, apiVersion, this.client.getSubscriptionId(), migrationRequest, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> commitMigrationWithResponseAsync(String resourceGroupName,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.commitMigration(this.client.getEndpoint(), resourceGroupName, applicationGatewayName, apiVersion,
            this.client.getSubscriptionId(), migrationRequest, accept, context);
    }
    ...
    private PollerFlux<PollResult<Void>, Void> beginCommitMigrationAsync(String resourceGroupName,
        String applicationGatewayName, ApplicationGatewayMigrationRequest migrationRequest) {
        Mono<Response<Flux<ByteBuffer>>> mono
            = commitMigrationWithResponseAsync(resourceGroupName, applicationGatewayName, migrationRequest);
        return this.client.<Void, Void>getLroResult(mono, this.client.getHttpPipeline(), Void.class, Void.class,
            this.client.getContext());
    }
    ...
    private PollerFlux<PollResult<Void>, Void> beginCommitMigrationAsync(String resourceGroupName,
        ...
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono
            = commitMigrationWithResponseAsync(resourceGroupName, applicationGatewayName, migrationRequest, context);
        return this.client.<Void, Void>getLroResult(mono, this.client.getHttpPipeline(), Void.class, Void.class,
            context);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginCommitMigration(String resourceGroupName,
        String applicationGatewayName, ApplicationGatewayMigrationRequest migrationRequest) {
        return this.beginCommitMigrationAsync(resourceGroupName, applicationGatewayName, migrationRequest)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginCommitMigration(String resourceGroupName,
        String applicationGatewayName, ApplicationGatewayMigrationRequest migrationRequest, Context context) {
        return this.beginCommitMigrationAsync(resourceGroupName, applicationGatewayName, migrationRequest, context)
            .getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> commitMigrationAsync(String resourceGroupName, String applicationGatewayName,
        ApplicationGatewayMigrationRequest migrationRequest) {
        return beginCommitMigrationAsync(resourceGroupName, applicationGatewayName, migrationRequest).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<Void> commitMigrationAsync(String resourceGroupName, String applicationGatewayName,
        ApplicationGatewayMigrationRequest migrationRequest, Context context) {
        return beginCommitMigrationAsync(resourceGroupName, applicationGatewayName, migrationRequest, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public void commitMigration(String resourceGroupName, String applicationGatewayName,
        ApplicationGatewayMigrationRequest migrationRequest) {
        commitMigrationAsync(resourceGroupName, applicationGatewayName, migrationRequest).block();
    }
    ...
    public void commitMigration(String resourceGroupName, String applicationGatewayName,
        ApplicationGatewayMigrationRequest migrationRequest, Context context) {
        commitMigrationAsync(resourceGroupName, applicationGatewayName, migrationRequest, context).block();
    }
    ...
    private
        ...
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono = backendHealthOnDemandWithResponseAsync(resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ApplicationGatewayAvailableWafRuleSetsResultInner>
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ApplicationGatewaySslPredefinedPolicyInner>
