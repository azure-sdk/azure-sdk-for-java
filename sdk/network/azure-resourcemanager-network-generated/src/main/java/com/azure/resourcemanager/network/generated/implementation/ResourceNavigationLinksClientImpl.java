...
public final class ResourceNavigationLinksClientImpl implements ResourceNavigationLinksClient {
    ...
    ResourceNavigationLinksClientImpl(NetworkManagementClientImpl client) {
        this.service = RestProxy.create(ResourceNavigationLinksService.class, client.getHttpPipeline(),
    ...
    public interface ResourceNavigationLinksService {
        ...
        Mono<Response<ResourceNavigationLinksListResultInner>> list(@HostParam("$host") String endpoint,
    ...
    private Mono<Response<ResourceNavigationLinksListResultInner>> listWithResponseAsync(String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ResourceNavigationLinksListResultInner> listAsync(String resourceGroupName, String virtualNetworkName,
        String subnetName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ResourceNavigationLinksListResultInner> listWithResponse(String resourceGroupName,
        String virtualNetworkName, String subnetName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ResourceNavigationLinksListResultInner list(String resourceGroupName, String virtualNetworkName,
        String subnetName) {
