...
import com.azure.resourcemanager.network.generated.models.NetworkSecurityPerimeterListResult;
...
public final class NetworkSecurityPerimetersClientImpl implements NetworkSecurityPerimetersClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<NetworkSecurityPerimeterInner> getByResourceGroupAsync(String resourceGroupName,
        String networkSecurityPerimeterName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<NetworkSecurityPerimeterInner> createOrUpdateAsync(String resourceGroupName,
        String networkSecurityPerimeterName, NetworkSecurityPerimeterInner parameters) {
    ...
    private PollerFlux<PollResult<Void>, Void> beginDeleteAsync(String resourceGroupName,
        ...
        Mono<Response<Flux<ByteBuffer>>> mono
            = deleteWithResponseAsync(resourceGroupName, networkSecurityPerimeterName);
    ...
    private PollerFlux<PollResult<Void>, Void> beginDeleteAsync(String resourceGroupName,
        ...
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono
            = deleteWithResponseAsync(resourceGroupName, networkSecurityPerimeterName, context);
        return this.client.<Void, Void>getLroResult(mono, this.client.getHttpPipeline(), Void.class, Void.class,
            context);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName,
        String networkSecurityPerimeterName) {
        return this.beginDeleteAsync(resourceGroupName, networkSecurityPerimeterName).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String networkSecurityPerimeterName,
        Context context) {
        return this.beginDeleteAsync(resourceGroupName, networkSecurityPerimeterName, context).getSyncPoller();
    }
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String networkSecurityPerimeterName) {
        return beginDeleteAsync(resourceGroupName, networkSecurityPerimeterName).last()
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> deleteAsync(String resourceGroupName, String networkSecurityPerimeterName, Context context) {
        return beginDeleteAsync(resourceGroupName, networkSecurityPerimeterName, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    public void delete(String resourceGroupName, String networkSecurityPerimeterName) {
        deleteAsync(resourceGroupName, networkSecurityPerimeterName).block();
    }
    ...
    public void delete(String resourceGroupName, String networkSecurityPerimeterName, Context context) {
        deleteAsync(resourceGroupName, networkSecurityPerimeterName, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<NetworkSecurityPerimeterInner> patchAsync(String resourceGroupName,
        String networkSecurityPerimeterName, UpdateTagsRequest parameters) {
    ...
    private PagedFlux<NetworkSecurityPerimeterInner> listAsync(Integer top, String skipToken) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<NetworkSecurityPerimeterInner> listAsync() {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<NetworkSecurityPerimeterInner> listByResourceGroupAsync(String resourceGroupName) {
        final Integer top = null;
        final String skipToken = null;
        return new PagedFlux<>(() -> listByResourceGroupSinglePageAsync(resourceGroupName, top, skipToken),
            nextLink -> listNextSinglePageAsync(nextLink));
