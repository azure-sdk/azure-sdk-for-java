...
public final class NetworkSecurityPerimetersClientImpl implements NetworkSecurityPerimetersClient {
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String networkSecurityPerimeterName) {
        return deleteWithResponseAsync(resourceGroupName, networkSecurityPerimeterName)
    ...
    public Response<Void> deleteWithResponse(String resourceGroupName, String networkSecurityPerimeterName,
        Context context) {
        return deleteWithResponseAsync(resourceGroupName, networkSecurityPerimeterName, context).block();
    }
    ...
    public void delete(String resourceGroupName, String networkSecurityPerimeterName) {
        deleteWithResponse(resourceGroupName, networkSecurityPerimeterName, Context.NONE);
    }
