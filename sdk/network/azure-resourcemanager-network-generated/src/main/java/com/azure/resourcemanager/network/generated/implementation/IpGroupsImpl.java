...
public final class IpGroupsImpl implements IpGroups {
    ...
    public IpGroupsImpl(IpGroupsClient innerClient,
        com.azure.resourcemanager.network.generated.NetworkManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public Response<IpGroup> getByResourceGroupWithResponse(String resourceGroupName, String ipGroupsName,
    ...
    public Response<Void> deleteByResourceGroupWithResponse(String resourceGroupName, String ipGroupsName,
        Context context) {
        return this.serviceClient().deleteWithResponse(resourceGroupName, ipGroupsName, context);
    }
    ...
    public PagedIterable<IpGroup> listByResourceGroup(String resourceGroupName) {
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new IpGroupImpl(inner1, this.manager()));
    }
    ...
    public IpGroup getById(String id) {
        ...
        String ipGroupsName = ResourceManagerUtils.getValueFromIdByName(id, "ipGroups");
        if (ipGroupsName == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
                String.format("The resource ID '%s' is not valid. Missing path segment 'ipGroups'.", id)));
        }
        String localExpand = null;
        return this.getByResourceGroupWithResponse(resourceGroupName, ipGroupsName, localExpand, Context.NONE)
            .getValue();
    }
    ...
    public void deleteById(String id) {
        ...
        this.deleteByResourceGroupWithResponse(resourceGroupName, ipGroupsName, Context.NONE);
    }
    ...
    public Response<Void> deleteByIdWithResponse(String id, Context context) {
        ...
        return this.deleteByResourceGroupWithResponse(resourceGroupName, ipGroupsName, context);
    }
