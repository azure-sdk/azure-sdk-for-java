 ...
 */
public final class SecurityPartnerProvidersClientImpl implements SecurityPartnerProvidersClient {
    /**
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> deleteAsync(String resourceGroupName, String securityPartnerProviderName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<SecurityPartnerProviderInner> getByResourceGroupAsync(String resourceGroupName,
        String securityPartnerProviderName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<SecurityPartnerProviderInner> updateTagsAsync(String resourceGroupName,
        String securityPartnerProviderName, TagsObject parameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<SecurityPartnerProviderInner> listAsync() {
