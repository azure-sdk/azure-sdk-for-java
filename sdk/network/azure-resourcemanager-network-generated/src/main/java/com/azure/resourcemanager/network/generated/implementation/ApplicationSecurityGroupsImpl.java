...
public final class ApplicationSecurityGroupsImpl implements ApplicationSecurityGroups {
    ...
    public Response<ApplicationSecurityGroup> updateTagsWithResponse(String resourceGroupName,
        String applicationSecurityGroupName, TagsObject parameters, Context context) {
        Response<ApplicationSecurityGroupInner> inner = this.serviceClient().updateTagsWithResponse(resourceGroupName,
            applicationSecurityGroupName, parameters, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
                new ApplicationSecurityGroupImpl(inner.getValue(), this.manager()));
        } else {
    ...
    public ApplicationSecurityGroup updateTags(String resourceGroupName, String applicationSecurityGroupName,
        TagsObject parameters) {
        ApplicationSecurityGroupInner inner
            = this.serviceClient().updateTags(resourceGroupName, applicationSecurityGroupName, parameters);
        if (inner != null) {
            return new ApplicationSecurityGroupImpl(inner, this.manager());
        } else {
            return null;
    ...
    public PagedIterable<ApplicationSecurityGroup> list() {
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new ApplicationSecurityGroupImpl(inner1, this.manager()));
    }
