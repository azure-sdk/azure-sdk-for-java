...
public final class VirtualNetworkGatewaysImpl implements VirtualNetworkGateways {
    ...
    public GatewayResiliencyInformation getResiliencyInformation(String resourceGroupName,
        String virtualNetworkGatewayName) {
        GatewayResiliencyInformationInner inner
            = this.serviceClient().getResiliencyInformation(resourceGroupName, virtualNetworkGatewayName);
        if (inner != null) {
            return new GatewayResiliencyInformationImpl(inner, this.manager());
        } else {
            return null;
        }
    }
    ...
    public GatewayResiliencyInformation getResiliencyInformation(String resourceGroupName,
        ...
        GatewayResiliencyInformationInner inner = this.serviceClient()
            .getResiliencyInformation(resourceGroupName, virtualNetworkGatewayName, attemptRefresh, context);
        if (inner != null) {
            return new GatewayResiliencyInformationImpl(inner, this.manager());
        } else {
            return null;
    ...
    public GatewayRouteSetsInformation getRoutesInformation(String resourceGroupName,
        String virtualNetworkGatewayName) {
        GatewayRouteSetsInformationInner inner
            = this.serviceClient().getRoutesInformation(resourceGroupName, virtualNetworkGatewayName);
        if (inner != null) {
            return new GatewayRouteSetsInformationImpl(inner, this.manager());
        } else {
            return null;
        }
    }

    public GatewayRouteSetsInformation getRoutesInformation(String resourceGroupName, String virtualNetworkGatewayName,
        Boolean attemptRefresh, Context context) {
        GatewayRouteSetsInformationInner inner = this.serviceClient()
            .getRoutesInformation(resourceGroupName, virtualNetworkGatewayName, attemptRefresh, context);
        if (inner != null) {
            return new GatewayRouteSetsInformationImpl(inner, this.manager());
        } else {
            return null;
    ...
    public List<ExpressRouteFailoverTestDetails> getFailoverAllTestDetails(String resourceGroupName,
        String virtualNetworkGatewayName, String type, boolean fetchLatest) {
        List<ExpressRouteFailoverTestDetailsInner> inner = this.serviceClient()
            .getFailoverAllTestDetails(resourceGroupName, virtualNetworkGatewayName, type, fetchLatest);
        if (inner != null) {
            return Collections.unmodifiableList(inner.stream()
                .map(inner1 -> new ExpressRouteFailoverTestDetailsImpl(inner1, this.manager()))
    ...
    public List<ExpressRouteFailoverTestDetails> getFailoverAllTestDetails(String resourceGroupName,
        ...
        List<ExpressRouteFailoverTestDetailsInner> inner = this.serviceClient()
            .getFailoverAllTestDetails(resourceGroupName, virtualNetworkGatewayName, type, fetchLatest, context);
        if (inner != null) {
            return Collections.unmodifiableList(inner.stream()
                .map(inner1 -> new ExpressRouteFailoverTestDetailsImpl(inner1, this.manager()))
                .collect(Collectors.toList()));
    ...
    public List<ExpressRouteFailoverSingleTestDetails> getFailoverSingleTestDetails(String resourceGroupName,
        String virtualNetworkGatewayName, String peeringLocation, String failoverTestId) {
        List<ExpressRouteFailoverSingleTestDetailsInner> inner = this.serviceClient()
            .getFailoverSingleTestDetails(resourceGroupName, virtualNetworkGatewayName, peeringLocation,
                failoverTestId);
        if (inner != null) {
            return Collections.unmodifiableList(inner.stream()
                .map(inner1 -> new ExpressRouteFailoverSingleTestDetailsImpl(inner1, this.manager()))
                .collect(Collectors.toList()));
        } else {
            return Collections.emptyList();
        }
    ...
    public List<ExpressRouteFailoverSingleTestDetails> getFailoverSingleTestDetails(String resourceGroupName,
        ...
        List<ExpressRouteFailoverSingleTestDetailsInner> inner = this.serviceClient()
            .getFailoverSingleTestDetails(resourceGroupName, virtualNetworkGatewayName, peeringLocation, failoverTestId,
                context);
        if (inner != null) {
            return Collections.unmodifiableList(inner.stream()
                .map(inner1 -> new ExpressRouteFailoverSingleTestDetailsImpl(inner1, this.manager()))
    ...
    public String startExpressRouteSiteFailoverSimulation(String resourceGroupName, String virtualNetworkGatewayName,
        ...
        return this.serviceClient()
            .startExpressRouteSiteFailoverSimulation(resourceGroupName, virtualNetworkGatewayName, peeringLocation);
    }
    ...
    public String stopExpressRouteSiteFailoverSimulation(String resourceGroupName, String virtualNetworkGatewayName,
        ...
        return this.serviceClient()
            .stopExpressRouteSiteFailoverSimulation(resourceGroupName, virtualNetworkGatewayName, stopParameters);
    }
