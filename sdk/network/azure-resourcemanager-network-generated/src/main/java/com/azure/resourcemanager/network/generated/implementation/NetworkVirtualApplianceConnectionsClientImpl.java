...
import com.azure.resourcemanager.network.generated.models.NetworkVirtualApplianceConnectionList;
...
public final class NetworkVirtualApplianceConnectionsClientImpl implements NetworkVirtualApplianceConnectionsClient {
    ...
    NetworkVirtualApplianceConnectionsClientImpl(NetworkManagementClientImpl client) {
        this.service =
            RestProxy
                .create(
                    NetworkVirtualApplianceConnectionsService.class,
    ...
    private PollerFlux<PollResult<NetworkVirtualApplianceConnectionInner>, NetworkVirtualApplianceConnectionInner>
        ...
        return this
            .client
            .<NetworkVirtualApplianceConnectionInner, NetworkVirtualApplianceConnectionInner>getLroResult(
                mono,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<NetworkVirtualApplianceConnectionInner> createOrUpdateAsync(
        String resourceGroupName,
        String networkVirtualApplianceName,
        String connectionName,
        NetworkVirtualApplianceConnectionInner networkVirtualApplianceConnectionParameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public NetworkVirtualApplianceConnectionInner createOrUpdate(
        String resourceGroupName,
        String networkVirtualApplianceName,
        String connectionName,
        NetworkVirtualApplianceConnectionInner networkVirtualApplianceConnectionParameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<NetworkVirtualApplianceConnectionInner>> getWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<NetworkVirtualApplianceConnectionInner> getAsync(
        String resourceGroupName, String networkVirtualApplianceName, String connectionName) {
    ...
    private Mono<Void> deleteAsync(
        String resourceGroupName, String networkVirtualApplianceName, String connectionName) {
        return beginDeleteAsync(resourceGroupName, networkVirtualApplianceName, connectionName)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<NetworkVirtualApplianceConnectionInner>> listSinglePageAsync(
                ...
                context ->
                    service
                        .list(
                            ...
                            accept,
                            context))
            .<PagedResponse<NetworkVirtualApplianceConnectionInner>>map(
                res ->
    ...
    private PagedFlux<NetworkVirtualApplianceConnectionInner> listAsync(
        String resourceGroupName, String networkVirtualApplianceName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<NetworkVirtualApplianceConnectionInner> list(
        String resourceGroupName, String networkVirtualApplianceName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<NetworkVirtualApplianceConnectionInner>> listNextSinglePageAsync(
