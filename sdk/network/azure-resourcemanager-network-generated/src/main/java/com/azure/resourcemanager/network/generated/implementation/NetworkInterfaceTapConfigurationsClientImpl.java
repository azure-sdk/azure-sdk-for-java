...
import com.azure.resourcemanager.network.generated.models.NetworkInterfaceTapConfigurationListResult;
...
public final class NetworkInterfaceTapConfigurationsClientImpl implements NetworkInterfaceTapConfigurationsClient {
    ...
    public interface NetworkInterfaceTapConfigurationsService {
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<NetworkInterfaceTapConfigurationInner>> createOrUpdate(
            @HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("networkInterfaceName") String networkInterfaceName,
            @PathParam("tapConfigurationName") String tapConfigurationName,
    ...
    public Response<Void> deleteWithResponse(
        String resourceGroupName, String networkInterfaceName, String tapConfigurationName, Context context) {
        return deleteWithResponseAsync(resourceGroupName, networkInterfaceName, tapConfigurationName, context).block();
    }
    ...
    public void delete(String resourceGroupName, String networkInterfaceName, String tapConfigurationName) {
        deleteWithResponse(resourceGroupName, networkInterfaceName, tapConfigurationName, Context.NONE);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<NetworkInterfaceTapConfigurationInner>> createOrUpdateWithResponseAsync(
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return tap configuration in a Network Interface along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<NetworkInterfaceTapConfigurationInner> createOrUpdateWithResponse(
        String resourceGroupName,
        String networkInterfaceName,
        String tapConfigurationName,
        NetworkInterfaceTapConfigurationInner tapConfigurationParameters,
    ...
    public NetworkInterfaceTapConfigurationInner createOrUpdate(
        ...
        return createOrUpdateWithResponse(
                resourceGroupName, networkInterfaceName, tapConfigurationName, tapConfigurationParameters, Context.NONE)
            .getValue();
    }
