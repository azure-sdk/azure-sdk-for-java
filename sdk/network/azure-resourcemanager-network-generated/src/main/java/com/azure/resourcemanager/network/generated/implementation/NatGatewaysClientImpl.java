...
public final class NatGatewaysClientImpl implements NatGatewaysClient {
    ...
    /**
     * The interface defining all the services for NetworkManagementClientNatGateways to be used by the proxy service
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String natGatewayName, Context context) {
        return beginDeleteAsync(resourceGroupName, natGatewayName, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<NatGatewayInner>> getByResourceGroupWithResponseAsync(String resourceGroupName,
        String natGatewayName, String expand, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    private PollerFlux<PollResult<NatGatewayInner>, NatGatewayInner> beginCreateOrUpdateAsync(String resourceGroupName,
        ...
        return this.client.<NatGatewayInner, NatGatewayInner>getLroResult(mono, this.client.getHttpPipeline(),
            NatGatewayInner.class, NatGatewayInner.class, context);
    }
    ...
    private Mono<NatGatewayInner> createOrUpdateAsync(String resourceGroupName, String natGatewayName,
        ...
        return beginCreateOrUpdateAsync(resourceGroupName, natGatewayName, parameters, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
