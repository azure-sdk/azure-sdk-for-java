...
public final class ResourceGraphClientImpl implements ResourceGraphClient {
     ...
     * @param endpoint server parameter.
     */
    ResourceGraphClientImpl(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter,
        Duration defaultPollInterval, AzureEnvironment environment, String endpoint, String endpoint) {
