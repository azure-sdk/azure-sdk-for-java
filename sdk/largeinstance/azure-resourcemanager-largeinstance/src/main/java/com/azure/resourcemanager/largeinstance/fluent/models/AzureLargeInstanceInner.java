        ...
        if (location() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property location in model AzureLargeInstanceInner"));
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(AzureLargeInstanceInner.class);
