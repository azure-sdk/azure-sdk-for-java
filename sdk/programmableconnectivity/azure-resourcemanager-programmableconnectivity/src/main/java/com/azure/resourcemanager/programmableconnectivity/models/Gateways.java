...
public interface Gateways {
     ...
     */
    Response<Gateway> getByResourceGroupWithResponse(String resourceGroupName, String name, Context context);
     ...
     * @return a Gateway.
     */
    Gateway getByResourceGroup(String resourceGroupName, String name);
     ...
     */
    Response<GatewayListKeysResult> listKeysWithResponse(
     ...
     */
    GatewayListKeysResult listKeys(String resourceGroupName, String name, GatewayRegenerateKeyRequest body);
