...
public final class ManagedGatewaysOperationsClientImpl implements ManagedGatewaysOperationsClient {
    ...
    public interface ManagedGatewaysOperationsService {
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<ManagedGatewaysOperationsCreateOrUpdateResponse> createOrUpdate(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @QueryParam("api-version") String apiVersion,
            @PathParam("instanceName") String instanceName, @PathParam("managedGatewayName") String managedGatewayName,
            @HeaderParam("Accept") String accept, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ManagedGatewaysOperationsCreateOrUpdateResponse>
        createOrUpdateWithResponseAsync(String resourceGroupName, String instanceName, String managedGatewayName) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ManagedGatewaysOperationsCreateOrUpdateResponse createOrUpdateWithResponse(String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ManagedGatewayInner createOrUpdate(String resourceGroupName, String instanceName,
        String managedGatewayName) {
