...
public final class InstancesImpl implements Instances {
    ...
    public Response<ManagedInstance> getByResourceGroupWithResponse(String resourceGroupName, String instanceName,
        Context context) {
    ...
    public SetServerCountResponseProperties scale(String resourceGroupName, String instanceName,
    ...
    public SetServerCountResponseProperties scale(String resourceGroupName, String instanceName, ScalingProperties body,
        Context context) {
    ...
    public LogAnalyticsConfiguration linkLogAnalytics(String resourceGroupName, String instanceName,
    ...
    public LogAnalyticsUpdateConfiguration updateLogAnalytics(String resourceGroupName, String instanceName,
