...
public final class ManagedGatewaysOperationsImpl implements ManagedGatewaysOperations {
    ...
    public Response<ManagedGateway> createOrUpdateWithResponse(String resourceGroupName, String instanceName,
        String managedGatewayName, Context context) {
        ManagedGatewaysOperationsCreateOrUpdateResponse inner = this.serviceClient()
