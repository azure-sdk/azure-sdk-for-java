...
public final class ManagedInstanceOperationStatus {
     ...
     * Operation message
     */
    @JsonProperty(value = "operationMessage", access = JsonProperty.Access.WRITE_ONLY)
    ...
    /**
     * Get the operationMessage property: Operation message.
     * 
     * @return the operationMessage value.
     */
