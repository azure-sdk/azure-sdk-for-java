...
public final class MonitoredResourcesImpl implements MonitoredResources {
    ...
    public Response<MonitoredResource> getWithResponse(String resourceGroupName, String instanceName,
    ...
    public MonitoredResource getById(String id) {
        ...
        String monitoredResourceName = Utils.getValueFromIdByName(id, "monitoredResources");
        if (monitoredResourceName == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
                String.format("The resource ID '%s' is not valid. Missing path segment 'monitoredResources'.", id)));
        }
        return this.getWithResponse(resourceGroupName, instanceName, monitoredResourceName, Context.NONE).getValue();
    }

    public Response<MonitoredResource> getByIdWithResponse(String id, Context context) {
        String resourceGroupName = Utils.getValueFromIdByName(id, "resourceGroups");
        if (resourceGroupName == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
                String.format("The resource ID '%s' is not valid. Missing path segment 'resourceGroups'.", id)));
        ...
        return this.getWithResponse(resourceGroupName, instanceName, monitoredResourceName, context);
    }
    ...
    public void deleteById(String id) {
        ...
        this.deleteWithResponse(resourceGroupName, instanceName, monitoredResourceName, Context.NONE);
    }
    ...
    public Response<Void> deleteByIdWithResponse(String id, Context context) {
        ...
        return this.deleteWithResponse(resourceGroupName, instanceName, monitoredResourceName, context);
    }
    ...
    public MonitoredResourceImpl define(String name) {
        return new MonitoredResourceImpl(name, this.manager());
    }
}
