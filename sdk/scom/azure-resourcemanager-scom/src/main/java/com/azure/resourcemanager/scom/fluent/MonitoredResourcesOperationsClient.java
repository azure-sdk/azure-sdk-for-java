...
public interface MonitoredResourcesOperationsClient {
    ...
    Response<MonitoredResourceInner> getWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<MonitoredResourceInner> createOrUpdateWithResponse(
        String resourceGroupName, String instanceName, String monitoredResourceName, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<MonitoredResourceInner> listByManagedInstance(
