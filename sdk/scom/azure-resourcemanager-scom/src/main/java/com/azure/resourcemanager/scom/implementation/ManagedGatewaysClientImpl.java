...
import com.azure.resourcemanager.scom.models.ManagedGatewayListResult;
import reactor.core.publisher.Mono;

/**
 * An instance of this class provides access to all the operations defined in ManagedGatewaysClient.
 */
public final class ManagedGatewaysClientImpl implements ManagedGatewaysClient {
    /**
     * The proxy service used to perform REST calls.
     */
    private final ManagedGatewaysService service;
    ...
    /**
     * Initializes an instance of ManagedGatewaysClientImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    ManagedGatewaysClientImpl(AzureApiForManagingScomManagedInstancesAndMonitoredResourcesImpl client) {
        this.service
            = RestProxy.create(ManagedGatewaysService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for
     * AzureApiForManagingScomManagedInstancesAndMonitoredResourcesManagedGateways to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "AzureApiForManagingS")
    public interface ManagedGatewaysService {
        ...
        Mono<Response<ManagedGatewayListResult>> listByManagedInstance(@HostParam("$host") String endpoint,
        ...
        Mono<Response<ManagedGatewayInner>> get(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("instanceName") String instanceName,
            @PathParam("managedGatewayName") String managedGatewayName, @HeaderParam("Accept") String accept,
            Context context);
        ...
        Mono<Response<ManagedGatewayInner>> createOrUpdate(@HostParam("$host") String endpoint,
            ...
            @BodyParam("application/json") ManagedGatewayInner resource, @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ManagedGatewayListResult>> listByManagedInstanceNext(
     ...
     * @return the response of a ManagedGateway list operation along with {@link PagedResponse} on successful completion
     * of {@link Mono}.
     */
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the response of a ManagedGateway list operation as paginated response with {@link PagedFlux}.
     */
    ...
    private Mono<Response<ManagedGatewayInner>> getWithResponseAsync(String resourceGroupName, String instanceName,
        ...
        return FluxUtil
            .withContext(context -> service.get(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, instanceName, managedGatewayName, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<ManagedGatewayInner>> getWithResponseAsync(String resourceGroupName, String instanceName,
        ...
        return service.get(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, instanceName, managedGatewayName, accept, context);
    }
    ...
    private Mono<Response<ManagedGatewayInner>> createOrUpdateWithResponseAsync(String resourceGroupName,
        String instanceName, String managedGatewayName, ManagedGatewayInner resource) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return FluxUtil
            .withContext(context -> service.createOrUpdate(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, instanceName, managedGatewayName, resource, accept,
                context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ManagedGatewayInner>> createOrUpdateWithResponseAsync(String resourceGroupName,
        String instanceName, String managedGatewayName, ManagedGatewayInner resource, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    private Mono<ManagedGatewayInner> createOrUpdateAsync(String resourceGroupName, String instanceName,
        String managedGatewayName, ManagedGatewayInner resource) {
        return createOrUpdateWithResponseAsync(resourceGroupName, instanceName, managedGatewayName, resource)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
    ...
    public Response<ManagedGatewayInner> createOrUpdateWithResponse(String resourceGroupName, String instanceName,
        String managedGatewayName, ManagedGatewayInner resource, Context context) {
        return createOrUpdateWithResponseAsync(resourceGroupName, instanceName, managedGatewayName, resource, context)
            .block();
    }
    ...
    public ManagedGatewayInner createOrUpdate(String resourceGroupName, String instanceName, String managedGatewayName,
        ManagedGatewayInner resource) {
        return createOrUpdateWithResponse(resourceGroupName, instanceName, managedGatewayName, resource, Context.NONE)
            .getValue();
    }
