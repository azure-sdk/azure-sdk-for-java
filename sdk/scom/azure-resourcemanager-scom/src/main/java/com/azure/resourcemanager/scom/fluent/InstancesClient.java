...
public interface InstancesClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<SetServerCountResponsePropertiesInner>, SetServerCountResponsePropertiesInner> beginScale(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    SetServerCountResponsePropertiesInner scale(
        String resourceGroupName, String instanceName, ScalingProperties body, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<PatchServersResponsePropertiesInner>, PatchServersResponsePropertiesInner> beginPatchServers(
        String resourceGroupName, String instanceName);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    LogAnalyticsConfigurationInner linkLogAnalytics(
        String resourceGroupName, String instanceName, LogAnalyticsConfigurationInner body);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    UnlinkLogAnalyticsResponsePropertiesInner unlinkLogAnalytics(
        String resourceGroupName, String instanceName, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    LogAnalyticsUpdateConfigurationInner updateLogAnalytics(
        String resourceGroupName, String instanceName, LogAnalyticsUpdateConfigurationInner body);
