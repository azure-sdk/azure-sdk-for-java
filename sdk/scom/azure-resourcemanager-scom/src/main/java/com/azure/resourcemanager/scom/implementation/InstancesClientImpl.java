...
public final class InstancesClientImpl implements InstancesClient {
    ...
    public interface InstancesService {
        ...
        Mono<Response<Flux<ByteBuffer>>> createOrUpdate(
            ...
            @BodyParam("application/json") ManagedInstanceInner managedInstance,
            @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({200, 202})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Flux<ByteBuffer>>> linkLogAnalytics(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("instanceName") String instanceName,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") LogAnalyticsConfigurationInner body,
            @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({200, 202})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Flux<ByteBuffer>>> unlinkLogAnalytics(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("instanceName") String instanceName,
        ...
        @ExpectedResponses({200, 202})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Flux<ByteBuffer>>> updateLogAnalytics(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("instanceName") String instanceName,
    ...
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<ManagedInstanceInner>, ManagedInstanceInner> beginCreateOrUpdateAsync(
        String resourceGroupName, String instanceName, ManagedInstanceInner managedInstance) {
    ...
    private PollerFlux<PollResult<ManagedInstanceInner>, ManagedInstanceInner> beginCreateOrUpdateAsync(
        ...
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono =
            createOrUpdateWithResponseAsync(resourceGroupName, instanceName, managedInstance, validationMode, context);
        return this
            .client
            .<ManagedInstanceInner, ManagedInstanceInner>getLroResult(
    ...
    public SyncPoller<PollResult<ManagedInstanceInner>, ManagedInstanceInner> beginCreateOrUpdate(
        ...
        final Boolean validationMode = null;
        return this
            .beginCreateOrUpdateAsync(resourceGroupName, instanceName, managedInstance, validationMode)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<ManagedInstanceInner>, ManagedInstanceInner> beginCreateOrUpdate(
        ...
        Context context) {
        return this
            .beginCreateOrUpdateAsync(resourceGroupName, instanceName, managedInstance, validationMode, context)
            .getSyncPoller();
    }
    ...
    private Mono<ManagedInstanceInner> createOrUpdateAsync(
        String resourceGroupName, String instanceName, ManagedInstanceInner managedInstance, Boolean validationMode) {
        return beginCreateOrUpdateAsync(resourceGroupName, instanceName, managedInstance, validationMode)
            .last()
    ...
    private Mono<Response<Flux<ByteBuffer>>> updateWithResponseAsync(
        String resourceGroupName, String instanceName, MonitoringInstancePatch managedInstance) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    private Mono<ManagedInstanceInner> updateAsync(
        String resourceGroupName, String instanceName, MonitoringInstancePatch managedInstance) {
        return beginUpdateAsync(resourceGroupName, instanceName, managedInstance)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<ManagedInstanceInner> updateAsync(
        String resourceGroupName, String instanceName, MonitoringInstancePatch managedInstance, Context context) {
        return beginUpdateAsync(resourceGroupName, instanceName, managedInstance, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return properties for set server count operation along with {@link Response} on successful completion of {@link
     *     Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ...
    private PollerFlux<PollResult<SetServerCountResponsePropertiesInner>, SetServerCountResponsePropertiesInner>
        ...
        return this
            .client
            .<SetServerCountResponsePropertiesInner, SetServerCountResponsePropertiesInner>getLroResult(
                mono,
                this.client.getHttpPipeline(),
                SetServerCountResponsePropertiesInner.class,
                SetServerCountResponsePropertiesInner.class,
                this.client.getContext());
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<SetServerCountResponsePropertiesInner> scaleAsync(
        String resourceGroupName, String instanceName, ScalingProperties body) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public SetServerCountResponsePropertiesInner scale(
        String resourceGroupName, String instanceName, ScalingProperties body) {
    ...
    private PollerFlux<PollResult<PatchServersResponsePropertiesInner>, PatchServersResponsePropertiesInner>
        ...
        return this
            .client
            .<PatchServersResponsePropertiesInner, PatchServersResponsePropertiesInner>getLroResult(
                mono,
                this.client.getHttpPipeline(),
                PatchServersResponsePropertiesInner.class,
                PatchServersResponsePropertiesInner.class,
                this.client.getContext());
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PatchServersResponsePropertiesInner> patchServersAsync(
        String resourceGroupName, String instanceName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public PatchServersResponsePropertiesInner patchServers(
        String resourceGroupName, String instanceName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> linkLogAnalyticsWithResponseAsync(
    ...
    private PollerFlux<PollResult<LogAnalyticsConfigurationInner>, LogAnalyticsConfigurationInner>
        ...
        return this
            .client
            .<LogAnalyticsConfigurationInner, LogAnalyticsConfigurationInner>getLroResult(
                mono,
                this.client.getHttpPipeline(),
                LogAnalyticsConfigurationInner.class,
                LogAnalyticsConfigurationInner.class,
                this.client.getContext());
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return configuration for Log Analytics linking to SCOM managed instance on successful completion of {@link
     *     Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<LogAnalyticsConfigurationInner> linkLogAnalyticsAsync(
        String resourceGroupName, String instanceName, LogAnalyticsConfigurationInner body) {
        return beginLinkLogAnalyticsAsync(resourceGroupName, instanceName, body)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<LogAnalyticsConfigurationInner> linkLogAnalyticsAsync(
        String resourceGroupName, String instanceName, LogAnalyticsConfigurationInner body, Context context) {
        return beginLinkLogAnalyticsAsync(resourceGroupName, instanceName, body, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public LogAnalyticsConfigurationInner linkLogAnalytics(
        String resourceGroupName, String instanceName, LogAnalyticsConfigurationInner body) {
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return properties for unlinking log analytics along with {@link Response} on successful completion of {@link
     *     Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> unlinkLogAnalyticsWithResponseAsync(
        String resourceGroupName, String instanceName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
    ...
    private PollerFlux<PollResult<UnlinkLogAnalyticsResponsePropertiesInner>, UnlinkLogAnalyticsResponsePropertiesInner>
        ...
        return this
            .client
            .<UnlinkLogAnalyticsResponsePropertiesInner, UnlinkLogAnalyticsResponsePropertiesInner>getLroResult(
                mono,
                this.client.getHttpPipeline(),
                UnlinkLogAnalyticsResponsePropertiesInner.class,
                UnlinkLogAnalyticsResponsePropertiesInner.class,
                this.client.getContext());
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<UnlinkLogAnalyticsResponsePropertiesInner> unlinkLogAnalyticsAsync(
        String resourceGroupName, String instanceName) {
        return beginUnlinkLogAnalyticsAsync(resourceGroupName, instanceName)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<UnlinkLogAnalyticsResponsePropertiesInner> unlinkLogAnalyticsAsync(
        String resourceGroupName, String instanceName, Context context) {
        return beginUnlinkLogAnalyticsAsync(resourceGroupName, instanceName, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public UnlinkLogAnalyticsResponsePropertiesInner unlinkLogAnalytics(
        String resourceGroupName, String instanceName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> updateLogAnalyticsWithResponseAsync(
    ...
    private PollerFlux<PollResult<LogAnalyticsUpdateConfigurationInner>, LogAnalyticsUpdateConfigurationInner>
        beginUpdateLogAnalyticsAsync(
            String resourceGroupName, String instanceName, LogAnalyticsUpdateConfigurationInner body) {
        Mono<Response<Flux<ByteBuffer>>> mono =
            updateLogAnalyticsWithResponseAsync(resourceGroupName, instanceName, body);
        return this
            .client
            .<LogAnalyticsUpdateConfigurationInner, LogAnalyticsUpdateConfigurationInner>getLroResult(
                mono,
                this.client.getHttpPipeline(),
                LogAnalyticsUpdateConfigurationInner.class,
                LogAnalyticsUpdateConfigurationInner.class,
                this.client.getContext());
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<LogAnalyticsUpdateConfigurationInner> updateLogAnalyticsAsync(
        String resourceGroupName, String instanceName, LogAnalyticsUpdateConfigurationInner body) {
        return beginUpdateLogAnalyticsAsync(resourceGroupName, instanceName, body)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<LogAnalyticsUpdateConfigurationInner> updateLogAnalyticsAsync(
        String resourceGroupName, String instanceName, LogAnalyticsUpdateConfigurationInner body, Context context) {
        return beginUpdateLogAnalyticsAsync(resourceGroupName, instanceName, body, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public LogAnalyticsUpdateConfigurationInner updateLogAnalytics(
        String resourceGroupName, String instanceName, LogAnalyticsUpdateConfigurationInner body) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<ManagedInstanceInner>> listBySubscriptionNextSinglePageAsync(
        String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
