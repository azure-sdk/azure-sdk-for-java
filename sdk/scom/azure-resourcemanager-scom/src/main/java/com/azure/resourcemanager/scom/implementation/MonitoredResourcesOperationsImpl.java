...
public final class MonitoredResourcesOperationsImpl implements MonitoredResourcesOperations {
    ...
    public Response<MonitoredResource> createOrUpdateWithResponse(String resourceGroupName, String instanceName,
        String monitoredResourceName, Context context) {
        Response<MonitoredResourceInner> inner = this.serviceClient().createOrUpdateWithResponse(resourceGroupName,
            instanceName, monitoredResourceName, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
                new MonitoredResourceImpl(inner.getValue(), this.manager()));
        } else {
    ...
    public MonitoredResource createOrUpdate(String resourceGroupName, String instanceName,
