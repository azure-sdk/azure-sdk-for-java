...
public final class MonitoredResourcesOperationsImpl implements MonitoredResourcesOperations {
    ...
    public MonitoredResourcesOperationsImpl(MonitoredResourcesOperationsClient innerClient,
    ...
    public MonitoredResource getById(String id) {
        ...
        String monitoredResourceName = ResourceManagerUtils.getValueFromIdByName(id, "monitoredResources");
