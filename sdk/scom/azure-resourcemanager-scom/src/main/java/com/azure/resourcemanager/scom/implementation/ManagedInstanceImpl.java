...
public final class ManagedInstanceImpl implements ManagedInstance, ManagedInstance.Definition, ManagedInstance.Update {
    ...
    public ManagedInstance apply() {
        this.innerObject = serviceManager.serviceClient()
            .getInstances()
            .update(resourceGroupName, instanceName, updateManagedInstance, Context.NONE);
        return this;
    }
    ...
    public ManagedInstance apply(Context context) {
        this.innerObject = serviceManager.serviceClient()
            .getInstances()
            .update(resourceGroupName, instanceName, updateManagedInstance, context);
        return this;
    }
    ...
    public ManagedInstanceImpl withProperties(MonitoringInstancePatchProperties properties) {
        this.updateManagedInstance.withProperties(properties);
        return this;
    }
