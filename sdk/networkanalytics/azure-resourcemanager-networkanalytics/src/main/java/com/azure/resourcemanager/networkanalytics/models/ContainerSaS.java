    ...
    public void validate() {
        if (startTimestamp() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Missing required property startTimestamp in model ContainerSaS"));
        }
        if (expiryTimestamp() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Missing required property expiryTimestamp in model ContainerSaS"));
        }
        if (ipAddress() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Missing required property ipAddress in model ContainerSaS"));
        }
    }
