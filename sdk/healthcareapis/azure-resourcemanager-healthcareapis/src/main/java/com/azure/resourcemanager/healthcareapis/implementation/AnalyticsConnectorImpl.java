...
public final class AnalyticsConnectorImpl
    ...
    public String schedulerCronExpression() {
        return this.innerModel().schedulerCronExpression();
    }
    ...
    private AnalyticsConnectorPatchResource updateAnalyticsConnectorPatchResource;
    ...
    public AnalyticsConnectorImpl update() {
        this.updateAnalyticsConnectorPatchResource = new AnalyticsConnectorPatchResource();
        return this;
    }
        ...
        this.innerObject =
            serviceManager
                ...
                .update(
                    ...
                    updateAnalyticsConnectorPatchResource,
                    Context.NONE);
        return this;
    }
    ...
    public AnalyticsConnectorImpl withTags(Map<String, String> tags) {
        if (isInCreateMode()) {
            ...
            this.updateAnalyticsConnectorPatchResource.withTags(tags);
            return this;
        }
    }
    ...
    public AnalyticsConnectorImpl withIdentity(ServiceManagedIdentityIdentity identity) {
        if (isInCreateMode()) {
            ...
            this.updateAnalyticsConnectorPatchResource.withIdentity(identity);
            return this;
        }
    }
    ...
    public AnalyticsConnectorImpl withSchedulerCronExpression(String schedulerCronExpression) {
        this.innerModel().withSchedulerCronExpression(schedulerCronExpression);
        return this;
    }
