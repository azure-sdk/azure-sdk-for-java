...
public final class AnalyticsConnectorInner extends TaggedResource {
    ...
    /** Creates an instance of AnalyticsConnectorInner class. */
    public AnalyticsConnectorInner() {
    }
    ...
    /**
     * Get the schedulerCronExpression property: Scheduler cron expression for Analytics Connector.
     *
     * @return the schedulerCronExpression value.
     */
    public String schedulerCronExpression() {
        return this.innerProperties() == null ? null : this.innerProperties().schedulerCronExpression();
    }

    /**
     * Set the schedulerCronExpression property: Scheduler cron expression for Analytics Connector.
     *
     * @param schedulerCronExpression the schedulerCronExpression value to set.
     * @return the AnalyticsConnectorInner object itself.
     */
    public AnalyticsConnectorInner withSchedulerCronExpression(String schedulerCronExpression) {
        if (this.innerProperties() == null) {
            this.innerProperties = new AnalyticsConnectorProperties();
        }
        this.innerProperties().withSchedulerCronExpression(schedulerCronExpression);
        return this;
    }
