...
public final class StorageConfiguration {
    ...
    /**
     * Get the storageResourceId property: The resource id of external storage account.
     * 
    ...
    /**
     * Set the storageResourceId property: The resource id of external storage account.
     * 
    ...
    /**
     * Get the fileSystemName property: The filesystem name of external storage account.
     * 
    ...
    /**
     * Set the fileSystemName property: The filesystem name of external storage account.
     * 
