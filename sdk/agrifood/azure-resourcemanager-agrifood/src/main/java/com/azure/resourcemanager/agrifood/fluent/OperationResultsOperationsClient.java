 ...
 */
public interface OperationResultsOperationsClient {
    /**
    ...
    Response<ArmAsyncOperationInner> getWithResponse(String subscriptionId, String locations, String operationResultsId,
        Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ArmAsyncOperationInner get(String subscriptionId, String locations, String operationResultsId);
}
