...
public final class DataManagerForAgricultureUpdatePropertiesImpl implements DataManagerForAgricultureUpdateProperties {
    private DataManagerForAgricultureUpdatePropertiesInner innerObject;

    private final com.azure.resourcemanager.agrifood.AgriFoodManager serviceManager;

    DataManagerForAgricultureUpdatePropertiesImpl(
        DataManagerForAgricultureUpdatePropertiesInner innerObject,
    ...
    public DataManagerForAgricultureUpdatePropertiesInner innerModel() {
