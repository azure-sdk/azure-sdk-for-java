...
public final class OperationResultsClientImpl implements OperationResultsClient {
    ...
    public interface OperationResultsService {
        ...
        @Get(
            "/subscriptions/{subscriptionId}/providers/Microsoft.AgFoodPlatform/locations/{locations}/operationResults"
                + "/{operationResultsId}")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ArmAsyncOperationInner>> get(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ArmAsyncOperationInner>> getWithResponseAsync(
        String locations, String operationResultsId, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ArmAsyncOperationInner> getWithResponse(
        String locations, String operationResultsId, Context context) {
