...
public final class DataConnectorsClientImpl implements DataConnectorsClient {
    ...
    public interface DataConnectorsService {
        ...
        Mono<Response<DataConnectorInner>> createOrUpdate(
            ...
            @PathParam("dataConnectorName") String dataConnectorName,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") DataConnectorInner body,
            @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<DataConnectorListResponse>> list(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("dataManagerForAgricultureResourceName") String dataManagerForAgricultureResourceName,
    ...
    private Mono<Response<DataConnectorInner>> getWithResponseAsync(
        String resourceGroupName, String dataManagerForAgricultureResourceName, String dataConnectorName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DataConnectorInner> getAsync(
        String resourceGroupName, String dataManagerForAgricultureResourceName, String dataConnectorName) {
    ...
    public Response<DataConnectorInner> getWithResponse(
        ...
        return getWithResponseAsync(
                resourceGroupName, dataManagerForAgricultureResourceName, dataConnectorName, context)
            .block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public DataConnectorInner get(
        String resourceGroupName, String dataManagerForAgricultureResourceName, String dataConnectorName) {
        return getWithResponse(
                resourceGroupName, dataManagerForAgricultureResourceName, dataConnectorName, Context.NONE)
            .getValue();
    }
    ...
    private Mono<DataConnectorInner> createOrUpdateAsync(
        ...
        return createOrUpdateWithResponseAsync(
                resourceGroupName, dataManagerForAgricultureResourceName, dataConnectorName, body)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
    ...
    public Response<DataConnectorInner> createOrUpdateWithResponse(
        ...
        Context context) {
        return createOrUpdateWithResponseAsync(
                resourceGroupName, dataManagerForAgricultureResourceName, dataConnectorName, body, context)
            .block();
    }
    ...
    public DataConnectorInner createOrUpdate(
        ...
        return createOrUpdateWithResponse(
                resourceGroupName, dataManagerForAgricultureResourceName, dataConnectorName, body, Context.NONE)
            .getValue();
    }
    ...
    private PagedFlux<DataConnectorInner> listAsync(
        String resourceGroupName, String dataManagerForAgricultureResourceName, Integer maxPageSize, String skipToken) {
    ...
    private PagedFlux<DataConnectorInner> listAsync(
        ...
        return new PagedFlux<>(
            () ->
                listSinglePageAsync(
                    resourceGroupName, dataManagerForAgricultureResourceName, maxPageSize, skipToken, context),
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<DataConnectorInner> list(
        String resourceGroupName, String dataManagerForAgricultureResourceName) {
        final Integer maxPageSize = null;
        final String skipToken = null;
