...
import com.azure.resourcemanager.agrifood.models.DataConnectorListResult;
...
public final class DataConnectorsClientImpl implements DataConnectorsClient {
    ...
    public interface DataConnectorsService {
        ...
        Mono<Response<DataConnectorListResult>> listByDataManagerForAgriculture(@HostParam("$host") String endpoint,
        ...
        Mono<Response<DataConnectorInner>> get(@HostParam("$host") String endpoint,
            ...
            @PathParam("dataManagerForAgricultureResourceName") String dataManagerForAgricultureResourceName,
            @PathParam("dataConnectorName") String dataConnectorName, @HeaderParam("Accept") String accept,
            Context context);
        ...
        Mono<Response<DataConnectorInner>> createOrUpdate(@HostParam("$host") String endpoint,
            ...
            @BodyParam("application/json") DataConnectorInner resource, @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<DataConnectorListResult>> listByDataManagerForAgricultureNext(
     ...
     * @return the response of a DataConnector list operation along with {@link PagedResponse} on successful completion
     * of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<DataConnectorInner>> listByDataManagerForAgricultureSinglePageAsync(
        String resourceGroupName, String dataManagerForAgricultureResourceName, Integer maxPageSize, String skipToken) {
        ...
        return FluxUtil
            .withContext(context -> service.listByDataManagerForAgriculture(this.client.getEndpoint(),
                this.client.getApiVersion(), this.client.getSubscriptionId(), resourceGroupName, maxPageSize, skipToken,
    ...
    private Mono<PagedResponse<DataConnectorInner>> listByDataManagerForAgricultureSinglePageAsync(
        ...
        return service
            .listByDataManagerForAgriculture(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, maxPageSize, skipToken,
                dataManagerForAgricultureResourceName, accept, context)
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the response of a DataConnector list operation as paginated response with {@link PagedFlux}.
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<DataConnectorInner> listByDataManagerForAgricultureAsync(String resourceGroupName,
        ...
        return new PagedFlux<>(
            () -> listByDataManagerForAgricultureSinglePageAsync(resourceGroupName,
                dataManagerForAgricultureResourceName, maxPageSize, skipToken),
    ...
    private PagedFlux<DataConnectorInner> listByDataManagerForAgricultureAsync(String resourceGroupName,
        ...
        return new PagedFlux<>(
            () -> listByDataManagerForAgricultureSinglePageAsync(resourceGroupName,
                dataManagerForAgricultureResourceName, maxPageSize, skipToken, context),
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<DataConnectorInner> listByDataManagerForAgriculture(String resourceGroupName,
        String dataManagerForAgricultureResourceName) {
        final Integer maxPageSize = null;
        final String skipToken = null;
    ...
    private Mono<Response<DataConnectorInner>> getWithResponseAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(context -> service.get(this.client.getEndpoint(), this.client.getApiVersion(),
                ...
                dataConnectorName, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<DataConnectorInner>> getWithResponseAsync(String resourceGroupName,
        ...
        return service.get(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, dataManagerForAgricultureResourceName, dataConnectorName, accept, context);
    }
    ...
    private Mono<Response<DataConnectorInner>> createOrUpdateWithResponseAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(context -> service.createOrUpdate(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, dataManagerForAgricultureResourceName,
                dataConnectorName, resource, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<DataConnectorInner> createOrUpdateAsync(String resourceGroupName,
        ...
        return createOrUpdateWithResponseAsync(resourceGroupName, dataManagerForAgricultureResourceName,
            dataConnectorName, resource).flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
    ...
    public Response<DataConnectorInner> createOrUpdateWithResponse(String resourceGroupName,
        ...
        Context context) {
        return createOrUpdateWithResponseAsync(resourceGroupName, dataManagerForAgricultureResourceName,
            dataConnectorName, resource, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<DataConnectorInner>>
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<DataConnectorInner>> listByDataManagerForAgricultureNextSinglePageAsync(String nextLink,
        Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
