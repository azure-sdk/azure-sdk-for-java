...
public final class DataManagerForAgricultureResourcesClientImpl implements DataManagerForAgricultureResourcesClient {
    ...
    DataManagerForAgricultureResourcesClientImpl(AgriFoodManagementClientImpl client) {
        this.service =
            RestProxy
                .create(
                    DataManagerForAgricultureResourcesService.class,
    ...
    public interface DataManagerForAgricultureResourcesService {
        ...
        @Get(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AgFoodPlatform"
                + "/farmBeats/{dataManagerForAgricultureResourceName}")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<DataManagerForAgricultureInner>> getByResourceGroup(
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<DataManagerForAgricultureInner>> createOrUpdate(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("dataManagerForAgricultureResourceName") String dataManagerForAgricultureResourceName,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") DataManagerForAgricultureInner request,
            @HeaderParam("Accept") String accept,
            Context context);
        ...
        Mono<Response<Flux<ByteBuffer>>> update(
            ...
            @PathParam("dataManagerForAgricultureResourceName") String dataManagerForAgricultureResourceName,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") DataManagerForAgricultureUpdateRequestModelInner request,
            @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<DataManagerForAgricultureListResponse>> list(
            @HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<DataManagerForAgricultureListResponse>> listByResourceGroup(
            @HostParam("$host") String endpoint,
            @QueryParam("$maxPageSize") Integer maxPageSize,
            @QueryParam("$skipToken") String skipToken,
            @PathParam("resourceGroupName") String resourceGroupName,
    ...
    private Mono<Response<DataManagerForAgricultureInner>> getByResourceGroupWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DataManagerForAgricultureInner> getByResourceGroupAsync(
        String resourceGroupName, String dataManagerForAgricultureResourceName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<DataManagerForAgricultureInner> getByResourceGroupWithResponse(
        String resourceGroupName, String dataManagerForAgricultureResourceName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public DataManagerForAgricultureInner getByResourceGroup(
        String resourceGroupName, String dataManagerForAgricultureResourceName) {
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return data Manager For Agriculture ARM Resource along with {@link Response} on successful completion of {@link
     *     Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<DataManagerForAgricultureInner>> createOrUpdateWithResponseAsync(
        String resourceGroupName,
        String dataManagerForAgricultureResourceName,
        DataManagerForAgricultureInner request) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DataManagerForAgricultureInner> createOrUpdateAsync(
        String resourceGroupName,
        String dataManagerForAgricultureResourceName,
        DataManagerForAgricultureInner request) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<DataManagerForAgricultureInner> createOrUpdateWithResponse(
        String resourceGroupName,
        String dataManagerForAgricultureResourceName,
        DataManagerForAgricultureInner request,
        Context context) {
        return createOrUpdateWithResponseAsync(
                resourceGroupName, dataManagerForAgricultureResourceName, request, context)
            .block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public DataManagerForAgricultureInner createOrUpdate(
        String resourceGroupName,
        String dataManagerForAgricultureResourceName,
        DataManagerForAgricultureInner request) {
        return createOrUpdateWithResponse(
                resourceGroupName, dataManagerForAgricultureResourceName, request, Context.NONE)
            .getValue();
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> updateWithResponseAsync(
        String resourceGroupName,
        String dataManagerForAgricultureResourceName,
        DataManagerForAgricultureUpdateRequestModelInner request) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    private PollerFlux<PollResult<DataManagerForAgricultureInner>, DataManagerForAgricultureInner> beginUpdateAsync(
        ...
        return this
            .client
            .<DataManagerForAgricultureInner, DataManagerForAgricultureInner>getLroResult(
                mono,
                this.client.getHttpPipeline(),
                DataManagerForAgricultureInner.class,
                DataManagerForAgricultureInner.class,
    ...
    public SyncPoller<PollResult<DataManagerForAgricultureInner>, DataManagerForAgricultureInner> beginUpdate(
        ...
        Context context) {
        return this
            .beginUpdateAsync(resourceGroupName, dataManagerForAgricultureResourceName, request, context)
            .getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DataManagerForAgricultureInner> updateAsync(
        String resourceGroupName,
        String dataManagerForAgricultureResourceName,
        DataManagerForAgricultureUpdateRequestModelInner request) {
        return beginUpdateAsync(resourceGroupName, dataManagerForAgricultureResourceName, request)
            .last()
    ...
    private Mono<DataManagerForAgricultureInner> updateAsync(
        ...
        DataManagerForAgricultureUpdateRequestModelInner request,
        Context context) {
        return beginUpdateAsync(resourceGroupName, dataManagerForAgricultureResourceName, request, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public DataManagerForAgricultureInner update(
        String resourceGroupName,
        String dataManagerForAgricultureResourceName,
        DataManagerForAgricultureUpdateRequestModelInner request) {
                ...
                context ->
                    service
                        .list(
                            ...
                            accept,
                            context))
            .<PagedResponse<DataManagerForAgricultureInner>>map(
                res ->
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<DataManagerForAgricultureInner> listByResourceGroupAsync(
        String resourceGroupName, Integer maxPageSize, String skipToken) {
        return new PagedFlux<>(
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<DataManagerForAgricultureInner> listByResourceGroup(
        String resourceGroupName, Integer maxPageSize, String skipToken, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<DataManagerForAgricultureInner>> listBySubscriptionNextSinglePageAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<DataManagerForAgricultureInner>> listByResourceGroupNextSinglePageAsync(
        String nextLink) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
