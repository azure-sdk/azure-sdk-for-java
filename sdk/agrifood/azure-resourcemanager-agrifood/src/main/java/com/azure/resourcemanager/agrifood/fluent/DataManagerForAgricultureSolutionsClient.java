 ...
 */
public interface DataManagerForAgricultureSolutionsClient {
    /**
    ...
    PagedIterable<DataManagerForAgricultureSolutionInner> listByTenant();
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<DataManagerForAgricultureSolutionInner> listByTenant(List<String> farmBeatsSolutionIds,
