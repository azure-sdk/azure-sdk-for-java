...
public final class DataManagerForAgriculturesImpl implements DataManagerForAgricultures {
    private static final ClientLogger LOGGER = new ClientLogger(DataManagerForAgriculturesImpl.class);

    private final DataManagerForAgriculturesClient innerClient;

    private final com.azure.resourcemanager.agrifood.AgriFoodManager serviceManager;

    public DataManagerForAgriculturesImpl(DataManagerForAgriculturesClient innerClient,
    ...
    public PagedIterable<DataManagerForAgriculture> list(Context context) {
        PagedIterable<DataManagerForAgricultureInner> inner = this.serviceClient().list(context);
        return Utils.mapPage(inner, inner1 -> new DataManagerForAgricultureImpl(inner1, this.manager()));
    }
    ...
    private DataManagerForAgriculturesClient serviceClient() {
