...
public interface ExtensionsClient {
    ...
    Response<ExtensionInner> createOrUpdate2WithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ExtensionInner createOrUpdate2(String resourceGroupName, String farmBeatsResourceName, String extensionId);
