...
public final class DataManagerForAgricultureImpl
    ...
    private DataManagerForAgricultureUpdateRequestModelInner updateRequest;
        ...
        this.innerObject =
            serviceManager
                ...
                .createOrUpdateWithResponse(
                    resourceGroupName, dataManagerForAgricultureResourceName, this.innerModel(), Context.NONE)
                .getValue();
        return this;
    }
    ...
    public DataManagerForAgriculture create(Context context) {
        this.innerObject =
            serviceManager
                ...
                .getDataManagerForAgricultureResources()
                .createOrUpdateWithResponse(
                    resourceGroupName, dataManagerForAgricultureResourceName, this.innerModel(), context)
                .getValue();
        return this;
    }
    ...
    public DataManagerForAgricultureImpl update() {
        this.updateRequest = new DataManagerForAgricultureUpdateRequestModelInner();
        return this;
    }
    ...
    DataManagerForAgricultureImpl(
        DataManagerForAgricultureInner innerObject, com.azure.resourcemanager.agrifood.AgriFoodManager serviceManager) {
    ...
    public DataManagerForAgricultureImpl withSensorIntegration(SensorIntegrationInner sensorIntegration) {
    ...
    public DataManagerForAgricultureImpl withProperties(DataManagerForAgricultureUpdatePropertiesInner properties) {
