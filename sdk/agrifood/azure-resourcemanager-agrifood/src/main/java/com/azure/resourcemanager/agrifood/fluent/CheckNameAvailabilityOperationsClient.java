 ...
 */
public interface CheckNameAvailabilityOperationsClient {
    /**
    ...
    Response<CheckNameAvailabilityResponseInner> checkNameAvailabilityWithResponse(String subscriptionId,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    CheckNameAvailabilityResponseInner checkNameAvailability(String subscriptionId,
