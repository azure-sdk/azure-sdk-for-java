...
public interface DataManagerForAgricultureResourcesClient {
    ...
    Response<DataManagerForAgricultureInner> getByResourceGroupWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    DataManagerForAgricultureInner getByResourceGroup(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<DataManagerForAgricultureInner> createOrUpdateWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    DataManagerForAgricultureInner createOrUpdate(
        String resourceGroupName, String dataManagerForAgricultureResourceName, DataManagerForAgricultureInner request);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    DataManagerForAgricultureInner update(
        String resourceGroupName,
        String dataManagerForAgricultureResourceName,
        DataManagerForAgricultureUpdateRequestModelInner request);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<DataManagerForAgricultureInner> listByResourceGroup(
