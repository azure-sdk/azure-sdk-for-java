...
public final class DataConnectorImpl implements DataConnector, DataConnector.Definition, DataConnector.Update {
    ...
    public DataConnector create() {
        this.innerObject
            = serviceManager
                .serviceClient().getDataConnectors().createOrUpdateWithResponse(resourceGroupName,
                    dataManagerForAgricultureResourceName, dataConnectorName, this.innerModel(), Context.NONE)
                .getValue();
        return this;
    }
    ...
    public DataConnector create(Context context) {
        this.innerObject
            = serviceManager.serviceClient().getDataConnectors().createOrUpdateWithResponse(resourceGroupName,
                dataManagerForAgricultureResourceName, dataConnectorName, this.innerModel(), context).getValue();
        return this;
    }
    ...
    public DataConnectorImpl withCredentials(AuthCredentials credentials) {
