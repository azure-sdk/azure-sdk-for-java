...
/**
 * Resource collection API of DataManagerForAgricultureExtensions.
 */
public interface DataManagerForAgricultureExtensions {
    /**
     ...
     */
    PagedIterable<DataManagerForAgricultureExtension> listByTenant();
     ...
     * @return list of Data Manager For Agriculture extension as paginated response with {@link PagedIterable}.
     */
    PagedIterable<DataManagerForAgricultureExtension> listByTenant(List<String> farmBeatsExtensionIds,
     ...
     */
    Response<DataManagerForAgricultureExtension> getWithResponse(String dataManagerForAgricultureExtensionId,
        Context context);
     ...
     */
    DataManagerForAgricultureExtension get(String dataManagerForAgricultureExtensionId);
}
