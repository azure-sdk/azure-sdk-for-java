...
public final class SolutionListResult {
    ...
    /**
     * Set the value property: The Solution items on this page.
     * 
     * @param value the value value to set.
     * @return the SolutionListResult object itself.
     */
    public SolutionListResult withValue(List<SolutionInner> value) {
        this.value = value;
        return this;
    }
     ...
     * @return the SolutionListResult object itself.
     */
    public SolutionListResult withNextLink(String nextLink) {
    ...
    public void validate() {
        if (value() == null) {
            throw LOGGER.logExceptionAsError(
                new IllegalArgumentException("Missing required property value in model SolutionListResult"));
        } else {
