...
public final class DataConnectorsImpl implements DataConnectors {
    ...
    public DataConnectorsImpl(
        DataConnectorsClient innerClient, com.azure.resourcemanager.agrifood.AgriFoodManager serviceManager) {
    ...
    public PagedIterable<DataConnector> list(
        String resourceGroupName,
        String dataManagerForAgricultureResourceName,
        Integer maxPageSize,
        String skipToken,
