...
public final class DataConnectorsImpl implements DataConnectors {
    ...
    public PagedIterable<DataConnector> listByDataManagerForAgriculture(String resourceGroupName,
    ...
    public PagedIterable<DataConnector> listByDataManagerForAgriculture(String resourceGroupName,
        ...
        PagedIterable<DataConnectorInner> inner = this.serviceClient().listByDataManagerForAgriculture(
    ...
    public Response<DataConnector> getWithResponse(String resourceGroupName,
        ...
        Response<DataConnectorInner> inner = this.serviceClient().getWithResponse(resourceGroupName,
            dataManagerForAgricultureResourceName, dataConnectorName, context);
        if (inner != null) {
