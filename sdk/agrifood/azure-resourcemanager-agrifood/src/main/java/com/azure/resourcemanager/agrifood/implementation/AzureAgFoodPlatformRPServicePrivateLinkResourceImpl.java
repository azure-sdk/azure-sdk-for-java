...
public final class AzureAgFoodPlatformRPServicePrivateLinkResourceImpl
    implements AzureAgFoodPlatformRPServicePrivateLinkResource {
    private AzureAgFoodPlatformRPServicePrivateLinkResourceInner innerObject;

    private final com.azure.resourcemanager.agrifood.AgriFoodManager serviceManager;

    AzureAgFoodPlatformRPServicePrivateLinkResourceImpl(
        AzureAgFoodPlatformRPServicePrivateLinkResourceInner innerObject,
    ...
    public AzureAgFoodPlatformRPServicePrivateLinkResourceInner innerModel() {
