...
public interface DataManagerForAgricultureExtensionsClient {
    ...
    PagedIterable<DataManagerForAgricultureExtensionInner> listByTenant();
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<DataManagerForAgricultureExtensionInner> listByTenant(List<String> farmBeatsExtensionIds,
    ...
    Response<DataManagerForAgricultureExtensionInner> getWithResponse(String dataManagerForAgricultureExtensionId,
        Context context);
