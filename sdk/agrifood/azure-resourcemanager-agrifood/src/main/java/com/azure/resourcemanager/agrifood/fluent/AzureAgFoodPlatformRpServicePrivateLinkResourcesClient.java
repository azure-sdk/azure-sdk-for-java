 ...
 */
public interface AzureAgFoodPlatformRpServicePrivateLinkResourcesClient {
    /**
    ...
    PagedIterable<AzureAgFoodPlatformRPServicePrivateLinkResourceInner>
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<AzureAgFoodPlatformRPServicePrivateLinkResourceInner> listByDataManagerForAgriculture(
    ...
    Response<AzureAgFoodPlatformRPServicePrivateLinkResourceInner> getWithResponse(String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    AzureAgFoodPlatformRPServicePrivateLinkResourceInner get(String resourceGroupName,
