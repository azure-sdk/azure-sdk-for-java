...
public final class DataManagerForAgricultureSolutionProperties {
    ...
    /*
     * Gets or sets scope of the Data Manager For Agriculture related parameters that need to
     ...
     * processing solution request to partner. Example: For gdd they might need weatherScope and satelliteScope.
     *
     ...
     */
    public DataManagerForAgricultureSolutionProperties withMarketplaceOfferDetails(
    ...
    /**
     * Get the inputParametersValidationScopes property: Gets or sets scope of the Data Manager For Agriculture related
     * parameters that need to be validated in solutionInference trigger request. Example. [{ "resourceIdName"
     * :"boundaryId", "resourceType" : "Boundary" }].
     *
