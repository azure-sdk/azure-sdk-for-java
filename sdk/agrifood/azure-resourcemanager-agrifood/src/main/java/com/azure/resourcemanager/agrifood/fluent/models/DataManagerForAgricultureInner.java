...
public final class DataManagerForAgricultureInner extends Resource {
    ...
    private DataManagerForAgriculturePropertiesInner innerProperties;
     ...
     * @return the DataManagerForAgricultureInner object itself.
     */
    public DataManagerForAgricultureInner withSensorIntegration(SensorIntegrationInner sensorIntegration) {
        if (this.innerProperties() == null) {
            this.innerProperties = new DataManagerForAgriculturePropertiesInner();
        }
