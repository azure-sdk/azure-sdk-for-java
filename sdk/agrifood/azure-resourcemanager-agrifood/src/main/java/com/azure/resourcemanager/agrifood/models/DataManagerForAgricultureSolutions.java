...
/**
 * Resource collection API of DataManagerForAgricultureSolutions.
 */
public interface DataManagerForAgricultureSolutions {
    /**
     ...
     */
    PagedIterable<DataManagerForAgricultureSolution> listByTenant();
     ...
     * @return list of Data Manager For Agriculture solutions as paginated response with {@link PagedIterable}.
     */
    PagedIterable<DataManagerForAgricultureSolution> listByTenant(List<String> farmBeatsSolutionIds,
