    ...
    public Extension create(Context context) {
        this.innerObject =
            serviceManager
                ...
                .getExtensions()
                .createOrUpdateWithResponse(
                    resourceGroupName, dataManagerForAgricultureResourceName, extensionId, createRequestBody, context)
                .getValue();
        return this;
    }
    ...
    public Extension apply(Context context) {
        this.innerObject =
            serviceManager
                ...
                .getExtensions()
                .createOrUpdateWithResponse(
                    resourceGroupName, dataManagerForAgricultureResourceName, extensionId, updateRequestBody, context)
                .getValue();
        return this;
    }
