...
public final class ExtensionImpl implements Extension, Extension.Definition, Extension.Update {
    ...
    public Extension create() {
        this.innerObject = serviceManager.serviceClient().getExtensions().createOrUpdateWithResponse(resourceGroupName,
            dataManagerForAgricultureResourceName, extensionId, createRequestBody, Context.NONE).getValue();
        return this;
    }

    public Extension create(Context context) {
        this.innerObject = serviceManager.serviceClient().getExtensions().createOrUpdateWithResponse(resourceGroupName,
            dataManagerForAgricultureResourceName, extensionId, createRequestBody, context).getValue();
        return this;
    }
    ...
    public Extension apply() {
        this.innerObject = serviceManager.serviceClient().getExtensions().createOrUpdateWithResponse(resourceGroupName,
            dataManagerForAgricultureResourceName, extensionId, updateRequestBody, Context.NONE).getValue();
        return this;
    }

    public Extension apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getExtensions().createOrUpdateWithResponse(resourceGroupName,
            dataManagerForAgricultureResourceName, extensionId, updateRequestBody, context).getValue();
        return this;
    }
    ...
    public Extension refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getExtensions()
            .getWithResponse(resourceGroupName, dataManagerForAgricultureResourceName, extensionId, context).getValue();
        return this;
    }
