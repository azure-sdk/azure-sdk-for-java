 ...
 */
public interface AzureAgFoodPlatformRpServicePrivateEndpointConnectionsClient {
    /**
    ...
    PagedIterable<AzureAgFoodPlatformRPServicePrivateEndpointConnectionInner>
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<AzureAgFoodPlatformRPServicePrivateEndpointConnectionInner> listByDataManagerForAgriculture(
    ...
    Response<AzureAgFoodPlatformRPServicePrivateEndpointConnectionInner> getWithResponse(String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    AzureAgFoodPlatformRPServicePrivateEndpointConnectionInner get(String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<AzureAgFoodPlatformRPServicePrivateEndpointConnectionInner> createOrUpdateWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    AzureAgFoodPlatformRPServicePrivateEndpointConnectionInner createOrUpdate(String resourceGroupName,
        String dataManagerForAgricultureResourceName, String privateEndpointConnectionName,
