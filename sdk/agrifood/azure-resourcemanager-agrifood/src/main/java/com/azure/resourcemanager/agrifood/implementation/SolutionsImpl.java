...
public final class SolutionsImpl implements Solutions {
    ...
    public PagedIterable<Solution> listByDataManagerForAgriculture(String resourceGroupName,
        String dataManagerForAgricultureResourceName) {
        PagedIterable<SolutionInner> inner = this.serviceClient().listByDataManagerForAgriculture(resourceGroupName,
    ...
    public Response<Solution> getWithResponse(String resourceGroupName, String dataManagerForAgricultureResourceName,
        ...
        Response<SolutionInner> inner = this.serviceClient().getWithResponse(resourceGroupName,
            dataManagerForAgricultureResourceName, solutionId, context);
        if (inner != null) {
