...
public interface SolutionsClient {
    ...
    Response<SolutionInner> createOrUpdateWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<SolutionInner> getWithResponse(
    ...
    PagedIterable<SolutionInner> list(String resourceGroupName, String dataManagerForAgricultureResourceName);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<SolutionInner> list(
        String resourceGroupName,
        String dataManagerForAgricultureResourceName,
