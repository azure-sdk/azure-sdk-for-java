...
public final class DataManagerForAgricultureExtensionsImpl implements DataManagerForAgricultureExtensions {
    ...
    public PagedIterable<DataManagerForAgricultureExtension> listByTenant() {
        PagedIterable<DataManagerForAgricultureExtensionInner> inner = this.serviceClient().listByTenant();
        return Utils.mapPage(inner, inner1 -> new DataManagerForAgricultureExtensionImpl(inner1, this.manager()));
    }

    public PagedIterable<DataManagerForAgricultureExtension> listByTenant(List<String> farmBeatsExtensionIds,
        ...
        PagedIterable<DataManagerForAgricultureExtensionInner> inner = this.serviceClient().listByTenant(
            farmBeatsExtensionIds, farmBeatsExtensionNames, extensionCategories, publisherIds, maxPageSize, context);
        return Utils.mapPage(inner, inner1 -> new DataManagerForAgricultureExtensionImpl(inner1, this.manager()));
    }
