...
public final class DataManagerForAgricultureExtensionsImpl implements DataManagerForAgricultureExtensions {
    ...
    public DataManagerForAgricultureExtensionsImpl(
        DataManagerForAgricultureExtensionsClient innerClient,
    ...
    public PagedIterable<DataManagerForAgricultureExtension> list(
        ...
        Integer maxPageSize,
        Context context) {
        PagedIterable<DataManagerForAgricultureExtensionInner> inner =
            this
                .serviceClient()
                .list(
    ...
    public Response<DataManagerForAgricultureExtension> getWithResponse(
