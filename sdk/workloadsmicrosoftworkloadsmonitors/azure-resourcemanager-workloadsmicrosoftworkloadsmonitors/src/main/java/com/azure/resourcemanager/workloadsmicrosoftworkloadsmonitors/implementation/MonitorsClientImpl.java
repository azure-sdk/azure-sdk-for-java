...
import com.azure.resourcemanager.workloadsmicrosoftworkloadsmonitors.fluent.MonitorsClient;
import com.azure.resourcemanager.workloadsmicrosoftworkloadsmonitors.fluent.models.MonitorInner;
import com.azure.resourcemanager.workloadsmicrosoftworkloadsmonitors.models.MonitorListResult;
import com.azure.resourcemanager.workloadsmicrosoftworkloadsmonitors.models.UpdateMonitorRequest;
...
public final class MonitorsClientImpl implements MonitorsClient {
    ...
    public interface MonitorsService {
        ...
        Mono<Response<Flux<ByteBuffer>>> create(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("monitorName") String monitorName,
            @BodyParam("application/json") MonitorInner resource, @HeaderParam("Accept") String accept,
            Context context);
        ...
        Mono<Response<Flux<ByteBuffer>>> update(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("monitorName") String monitorName,
            @BodyParam("application/json") UpdateMonitorRequest properties, @HeaderParam("Accept") String accept,
            Context context);
     ...
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
     * @param monitorName Name of the SAP monitor resource.
     * @param resource Request body representing a SAP monitor.
     * @throws IllegalArgumentException thrown if parameters fail the validation.
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> createWithResponseAsync(String resourceGroupName, String monitorName,
        MonitorInner resource, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    private PollerFlux<PollResult<MonitorInner>, MonitorInner> beginCreateAsync(String resourceGroupName,
        String monitorName, MonitorInner resource) {
        Mono<Response<Flux<ByteBuffer>>> mono = createWithResponseAsync(resourceGroupName, monitorName, resource);
    ...
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<MonitorInner>, MonitorInner> beginCreateAsync(String resourceGroupName,
        String monitorName, MonitorInner resource, Context context) {
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono
            = createWithResponseAsync(resourceGroupName, monitorName, resource, context);
        return this.client.<MonitorInner, MonitorInner>getLroResult(mono, this.client.getHttpPipeline(),
    ...
    public SyncPoller<PollResult<MonitorInner>, MonitorInner> beginCreate(String resourceGroupName, String monitorName,
        MonitorInner resource) {
        return this.beginCreateAsync(resourceGroupName, monitorName, resource).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<MonitorInner>, MonitorInner> beginCreate(String resourceGroupName, String monitorName,
        MonitorInner resource, Context context) {
        return this.beginCreateAsync(resourceGroupName, monitorName, resource, context).getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<MonitorInner> createAsync(String resourceGroupName, String monitorName, MonitorInner resource) {
        return beginCreateAsync(resourceGroupName, monitorName, resource).last()
    ...
    private Mono<MonitorInner> createAsync(String resourceGroupName, String monitorName, MonitorInner resource,
        Context context) {
        return beginCreateAsync(resourceGroupName, monitorName, resource, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public MonitorInner create(String resourceGroupName, String monitorName, MonitorInner resource) {
        return createAsync(resourceGroupName, monitorName, resource).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public MonitorInner create(String resourceGroupName, String monitorName, MonitorInner resource, Context context) {
        return createAsync(resourceGroupName, monitorName, resource, context).block();
    }
     ...
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
     * @param monitorName Name of the SAP monitor resource.
     * @param properties The Update SAP workload monitor request body.
     * @throws IllegalArgumentException thrown if parameters fail the validation.
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return sAP monitor info on Azure (ARM properties and SAP monitor properties) along with {@link Response} on
    ...
    private Mono<Response<Flux<ByteBuffer>>> updateWithResponseAsync(String resourceGroupName, String monitorName,
        UpdateMonitorRequest properties) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> updateWithResponseAsync(String resourceGroupName, String monitorName,
        UpdateMonitorRequest properties, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<MonitorInner>, MonitorInner> beginUpdateAsync(String resourceGroupName,
        String monitorName, UpdateMonitorRequest properties) {
    ...
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<MonitorInner>, MonitorInner> beginUpdateAsync(String resourceGroupName,
        String monitorName, UpdateMonitorRequest properties, Context context) {
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<MonitorInner>, MonitorInner> beginUpdate(String resourceGroupName, String monitorName,
        UpdateMonitorRequest properties) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<MonitorInner> updateAsync(String resourceGroupName, String monitorName,
        UpdateMonitorRequest properties) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public MonitorInner update(String resourceGroupName, String monitorName, UpdateMonitorRequest properties) {
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the response of a Monitor list operation along with {@link PagedResponse} on successful completion of
     * {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
