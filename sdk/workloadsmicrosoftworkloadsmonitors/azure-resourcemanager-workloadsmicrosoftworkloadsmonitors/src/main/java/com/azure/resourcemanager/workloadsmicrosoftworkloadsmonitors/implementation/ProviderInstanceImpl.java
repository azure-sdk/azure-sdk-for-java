...
public final class ProviderInstanceImpl implements ProviderInstance, ProviderInstance.Definition {
    ...
    public ProviderInstance create() {
        this.innerObject = serviceManager.serviceClient().getProviderInstances().create(resourceGroupName, monitorName,
            providerInstanceName, this.innerModel(), Context.NONE);
        return this;
    }

    public ProviderInstance create(Context context) {
        this.innerObject = serviceManager.serviceClient().getProviderInstances().create(resourceGroupName, monitorName,
            providerInstanceName, this.innerModel(), context);
        return this;
    }

    ProviderInstanceImpl(String name,
        com.azure.resourcemanager.workloadsmicrosoftworkloadsmonitors.WorkloadsManager serviceManager) {
    ...
    public ProviderInstance refresh() {
        this.innerObject = serviceManager.serviceClient().getProviderInstances()
            .getWithResponse(resourceGroupName, monitorName, providerInstanceName, Context.NONE).getValue();
        return this;
    }

    public ProviderInstance refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getProviderInstances()
            .getWithResponse(resourceGroupName, monitorName, providerInstanceName, context).getValue();
        return this;
    }
