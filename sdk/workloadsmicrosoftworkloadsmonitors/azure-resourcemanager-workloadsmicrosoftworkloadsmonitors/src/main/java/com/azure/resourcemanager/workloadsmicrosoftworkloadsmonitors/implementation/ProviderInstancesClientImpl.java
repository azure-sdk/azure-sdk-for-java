...
import com.azure.resourcemanager.workloadsmicrosoftworkloadsmonitors.models.ProviderInstanceListResult;
...
public final class ProviderInstancesClientImpl implements ProviderInstancesClient {
    ...
    public interface ProviderInstancesService {
        ...
        Mono<Response<ProviderInstanceListResult>> listByMonitor(@HostParam("$host") String endpoint,
        ...
        Mono<Response<Flux<ByteBuffer>>> create(@HostParam("$host") String endpoint,
            ...
            @BodyParam("application/json") ProviderInstanceInner resource, @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ProviderInstanceListResult>> listByMonitorNext(
    ...
    private Mono<PagedResponse<ProviderInstanceInner>> listByMonitorSinglePageAsync(String resourceGroupName,
        String monitorName) {
    ...
    private PagedFlux<ProviderInstanceInner> listByMonitorAsync(String resourceGroupName, String monitorName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<ProviderInstanceInner> listByMonitor(String resourceGroupName, String monitorName) {
    ...
    private Mono<Response<Flux<ByteBuffer>>> createWithResponseAsync(String resourceGroupName, String monitorName,
        String providerInstanceName, ProviderInstanceInner resource) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return FluxUtil
            .withContext(context -> service.create(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, monitorName, providerInstanceName, resource, accept,
                context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> createWithResponseAsync(String resourceGroupName, String monitorName,
        String providerInstanceName, ProviderInstanceInner resource, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service.create(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, monitorName, providerInstanceName, resource, accept, context);
    }
    ...
    private PollerFlux<PollResult<ProviderInstanceInner>, ProviderInstanceInner> beginCreateAsync(
        String resourceGroupName, String monitorName, String providerInstanceName, ProviderInstanceInner resource) {
        Mono<Response<Flux<ByteBuffer>>> mono
            = createWithResponseAsync(resourceGroupName, monitorName, providerInstanceName, resource);
    ...
    private PollerFlux<PollResult<ProviderInstanceInner>, ProviderInstanceInner> beginCreateAsync(
        ...
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono
            = createWithResponseAsync(resourceGroupName, monitorName, providerInstanceName, resource, context);
        return this.client.<ProviderInstanceInner, ProviderInstanceInner>getLroResult(mono,
    ...
    public SyncPoller<PollResult<ProviderInstanceInner>, ProviderInstanceInner> beginCreate(String resourceGroupName,
        String monitorName, String providerInstanceName, ProviderInstanceInner resource) {
        return this.beginCreateAsync(resourceGroupName, monitorName, providerInstanceName, resource).getSyncPoller();
    }
    ...
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<ProviderInstanceInner>, ProviderInstanceInner> beginCreate(String resourceGroupName,
        String monitorName, String providerInstanceName, ProviderInstanceInner resource, Context context) {
        return this.beginCreateAsync(resourceGroupName, monitorName, providerInstanceName, resource, context)
            .getSyncPoller();
    }
    ...
    private Mono<ProviderInstanceInner> createAsync(String resourceGroupName, String monitorName,
        String providerInstanceName, ProviderInstanceInner resource) {
        return beginCreateAsync(resourceGroupName, monitorName, providerInstanceName, resource).last()
    ...
    private Mono<ProviderInstanceInner> createAsync(String resourceGroupName, String monitorName,
        String providerInstanceName, ProviderInstanceInner resource, Context context) {
        return beginCreateAsync(resourceGroupName, monitorName, providerInstanceName, resource, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    public ProviderInstanceInner create(String resourceGroupName, String monitorName, String providerInstanceName,
        ProviderInstanceInner resource) {
        return createAsync(resourceGroupName, monitorName, providerInstanceName, resource).block();
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ProviderInstanceInner create(String resourceGroupName, String monitorName, String providerInstanceName,
        ProviderInstanceInner resource, Context context) {
        return createAsync(resourceGroupName, monitorName, providerInstanceName, resource, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> deleteAsync(String resourceGroupName, String monitorName, String providerInstanceName) {
    ...
    public void delete(String resourceGroupName, String monitorName, String providerInstanceName) {
        deleteAsync(resourceGroupName, monitorName, providerInstanceName).block();
    }
    ...
    public void delete(String resourceGroupName, String monitorName, String providerInstanceName, Context context) {
        deleteAsync(resourceGroupName, monitorName, providerInstanceName, context).block();
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the response of a ProviderInstance list operation along with {@link PagedResponse} on successful
     * completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<ProviderInstanceInner>> listByMonitorNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
