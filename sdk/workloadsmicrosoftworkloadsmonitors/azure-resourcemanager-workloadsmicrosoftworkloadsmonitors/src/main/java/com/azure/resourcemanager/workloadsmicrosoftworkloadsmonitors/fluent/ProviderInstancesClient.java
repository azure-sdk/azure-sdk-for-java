...
public interface ProviderInstancesClient {
    ...
    PagedIterable<ProviderInstanceInner> listByMonitor(String resourceGroupName, String monitorName);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<ProviderInstanceInner> listByMonitor(String resourceGroupName, String monitorName, Context context);
