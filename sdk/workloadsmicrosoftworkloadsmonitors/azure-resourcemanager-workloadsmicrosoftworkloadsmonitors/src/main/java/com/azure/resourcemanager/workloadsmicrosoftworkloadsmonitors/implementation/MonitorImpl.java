...
public final class MonitorImpl implements Monitor, Monitor.Definition, Monitor.Update {
    ...
    public AppServicePlanConfiguration appServicePlanConfiguration() {
        return this.innerModel().appServicePlanConfiguration();
    }
    ...
    private UpdateMonitorRequest updateProperties;
    ...
    public MonitorImpl update() {
        this.updateProperties = new UpdateMonitorRequest();
        return this;
    }
    ...
    public MonitorImpl withIdentity(ManagedServiceIdentity identity) {
        if (isInCreateMode()) {
    ...
    public MonitorImpl withAppServicePlanConfiguration(AppServicePlanConfiguration appServicePlanConfiguration) {
        this.innerModel().withAppServicePlanConfiguration(appServicePlanConfiguration);
        return this;
    }
