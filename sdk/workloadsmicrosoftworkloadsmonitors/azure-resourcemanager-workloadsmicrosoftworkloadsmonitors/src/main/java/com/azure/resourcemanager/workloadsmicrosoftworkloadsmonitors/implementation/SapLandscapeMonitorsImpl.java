...
public final class SapLandscapeMonitorsImpl implements SapLandscapeMonitors {
    ...
    public Response<SapLandscapeMonitor> createWithResponse(String resourceGroupName, String monitorName,
        ...
        Response<SapLandscapeMonitorInner> inner = this.serviceClient().createWithResponse(resourceGroupName,
            monitorName, sapLandscapeMonitorParameter, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
                new SapLandscapeMonitorImpl(inner.getValue(), this.manager()));
        } else {
    ...
    public Response<SapLandscapeMonitor> updateWithResponse(String resourceGroupName, String monitorName,
        SapLandscapeMonitorInner sapLandscapeMonitorParameter, Context context) {
        Response<SapLandscapeMonitorInner> inner = this.serviceClient().updateWithResponse(resourceGroupName,
            monitorName, sapLandscapeMonitorParameter, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
                new SapLandscapeMonitorImpl(inner.getValue(), this.manager()));
