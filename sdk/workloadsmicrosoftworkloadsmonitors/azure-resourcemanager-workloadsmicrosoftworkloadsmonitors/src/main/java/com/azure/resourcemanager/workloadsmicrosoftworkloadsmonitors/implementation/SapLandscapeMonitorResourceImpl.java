...
public final class SapLandscapeMonitorResourceImpl implements SapLandscapeMonitorResource {
    private SapLandscapeMonitorResourceInner innerObject;

    private final com.azure.resourcemanager.workloadsmicrosoftworkloadsmonitors.WorkloadsManager serviceManager;

    SapLandscapeMonitorResourceImpl(SapLandscapeMonitorResourceInner innerObject,
    ...
    public SapLandscapeMonitorResourceInner innerModel() {
