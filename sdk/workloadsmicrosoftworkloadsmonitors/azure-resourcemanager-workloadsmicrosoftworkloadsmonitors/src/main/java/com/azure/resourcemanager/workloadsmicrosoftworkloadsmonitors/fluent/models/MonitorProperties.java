...
public final class MonitorProperties implements JsonSerializable<MonitorProperties> {
     ...
     */
    private AppServicePlanConfiguration appServicePlanConfiguration;
    ...
    /**
     * Get the appServicePlanConfiguration property: App service plan configuration.
     * 
     * @return the appServicePlanConfiguration value.
     */
    public AppServicePlanConfiguration appServicePlanConfiguration() {
        return this.appServicePlanConfiguration;
    }

    /**
     * Set the appServicePlanConfiguration property: App service plan configuration.
     * 
     * @param appServicePlanConfiguration the appServicePlanConfiguration value to set.
     * @return the MonitorProperties object itself.
     */
    public MonitorProperties withAppServicePlanConfiguration(AppServicePlanConfiguration appServicePlanConfiguration) {
    ...
    public void validate() {
        ...
        if (appServicePlanConfiguration() != null) {
            appServicePlanConfiguration().validate();
        }
    }
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeJsonField("appServicePlanConfiguration", this.appServicePlanConfiguration);
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("provisioningState".equals(fieldName)) {
                    ...
                    deserializedMonitorProperties.errors = ManagementError.fromJson(reader);
                ...
                } else if ("appServicePlanConfiguration".equals(fieldName)) {
                    deserializedMonitorProperties.appServicePlanConfiguration
                        = AppServicePlanConfiguration.fromJson(reader);
