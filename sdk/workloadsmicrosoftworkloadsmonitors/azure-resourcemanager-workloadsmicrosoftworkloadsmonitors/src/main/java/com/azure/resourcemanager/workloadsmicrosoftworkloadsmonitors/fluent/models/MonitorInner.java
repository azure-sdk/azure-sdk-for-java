...
public final class MonitorInner extends Resource {
    ...
    public AppServicePlanConfiguration appServicePlanConfiguration() {
        return this.innerProperties() == null ? null : this.innerProperties().appServicePlanConfiguration();
    }
     ...
     * @return the MonitorInner object itself.
     */
    public MonitorInner withAppServicePlanConfiguration(AppServicePlanConfiguration appServicePlanConfiguration) {
        if (this.innerProperties() == null) {
            this.innerProperties = new MonitorProperties();
        }
        this.innerProperties().withAppServicePlanConfiguration(appServicePlanConfiguration);
        return this;
    }
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("id".equals(fieldName)) {
                    ...
                    deserializedMonitorInner.identity = ManagedServiceIdentity.fromJson(reader);
