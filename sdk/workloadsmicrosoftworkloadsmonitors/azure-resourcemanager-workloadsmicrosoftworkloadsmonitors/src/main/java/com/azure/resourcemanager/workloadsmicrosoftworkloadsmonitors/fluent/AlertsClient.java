...
public interface AlertsClient {
    ...
    PagedIterable<AlertInner> list(String resourceGroupName, String monitorName);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<AlertInner> list(String resourceGroupName, String monitorName, Context context);
    ...
    Response<AlertInner> getWithResponse(String resourceGroupName, String monitorName, String alertName,
        Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    AlertInner get(String resourceGroupName, String monitorName, String alertName);
    ...
    SyncPoller<PollResult<AlertInner>, AlertInner> beginCreate(String resourceGroupName, String monitorName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    AlertInner create(String resourceGroupName, String monitorName, String alertName, AlertInner resource);
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String monitorName, String alertName);
