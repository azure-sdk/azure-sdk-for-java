...
@Disabled
public final class IngestionsCreateTests extends MicrosoftPlanetaryComputerProClientTestBase {
    @Test
    @Disabled
    public void testIngestionsCreateTests() {
        ...
        Assertions.assertEquals("e1b1b8aa-0b32-4b0a-a25c-d0f806a9133a", response.getIngestionId());
