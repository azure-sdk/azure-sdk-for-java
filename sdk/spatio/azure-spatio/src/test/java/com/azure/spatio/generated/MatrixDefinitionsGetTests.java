...
import com.azure.spatio.models.TileMatrix;
import com.azure.spatio.models.TileMatrixCornerOfOrigin;
...
@Disabled
public final class MatrixDefinitionsGetTests extends MicrosoftPlanetaryComputerProClientTestBase {
    @Test
    @Disabled
    public void testMatrixDefinitionsGetTests() {
        // method invocation
        ...
        // verify property "crs"
        Assertions.assertNotNull(response.getCrs());
        ...
        List<String> responseTileMatricesFirstItemPointOfOrigin = responseTileMatricesFirstItem.getPointOfOrigin();
        Assertions.assertEquals("90", responseTileMatricesFirstItemPointOfOrigin.iterator().next());
