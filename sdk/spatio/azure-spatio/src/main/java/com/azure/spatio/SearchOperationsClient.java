...
public final class SearchOperationsClient {
    @Generated
    private final SearchOperationsImpl serviceClient;

    /**
     * Initializes an instance of SearchOperationsClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    SearchOperationsClient(SearchOperationsImpl serviceClient) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public void get(String collections, String ids, String bbox, String intersects, String datetime, Integer limit,
        Boolean sign, Integer duration, String query, String sortby, String fields, String filter, String token) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public void create(SearchPostRequest body) {
        // Generated convenience method for createWithResponse
        RequestOptions requestOptions = new RequestOptions();
        createWithResponse(BinaryData.fromObject(body), requestOptions).getValue();
    }
}
