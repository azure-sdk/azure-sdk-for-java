 ...
 */
@Immutable
public final class TitilerCoreModelsResponsesPoint implements JsonSerializable<TitilerCoreModelsResponsesPoint> {
    /*
    ...
    /*
     * ValuesTODO: add description for values
     */
    @Generated
    private final List<Double> values;

    /*
     * Band NamesTODO: add description for bandNames
     */
    @Generated
    private final List<String> bandNames;

    /**
     * Creates an instance of TitilerCoreModelsResponsesPoint class.
     * 
     ...
     */
    @Generated
    private TitilerCoreModelsResponsesPoint(List<Double> coordinates, List<Double> values, List<String> bandNames) {
    ...
    /**
     * Get the values property: ValuesTODO: add description for values.
     * 
    ...
    /**
     * Get the bandNames property: Band NamesTODO: add description for bandNames.
     * 
    ...
    /**
     * Reads an instance of TitilerCoreModelsResponsesPoint from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of TitilerCoreModelsResponsesPoint if the JsonReader was pointing to an instance of it, or
     * null if it was pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the TitilerCoreModelsResponsesPoint.
     */
    @Generated
    public static TitilerCoreModelsResponsesPoint fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            return new TitilerCoreModelsResponsesPoint(coordinates, values, bandNames);
        });
    }
}
