...
import com.azure.spatio.implementation.TileJsonMosaicsTileMatrixSetsImpl;
...
public final class TileJsonMosaicsTileMatrixSetsAsyncClient {
    @Generated
    private final TileJsonMosaicsTileMatrixSetsImpl serviceClient;

    /**
     * Initializes an instance of TileJsonMosaicsTileMatrixSetsAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    TileJsonMosaicsTileMatrixSetsAsyncClient(TileJsonMosaicsTileMatrixSetsImpl serviceClient) {
    ...
    public Mono<Response<BinaryData>> getWithResponse(String tileMatrixSetId, String searchid,
        RequestOptions requestOptions) {
        return this.serviceClient.getWithResponseAsync(tileMatrixSetId, searchid, requestOptions);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<TileJson> get(Tilematrixsetid tileMatrixSetId, String searchid, ImageType tileFormat, Integer tileScale,
        Integer minzoom, Integer maxzoom, Double buffer, String colorFormula, List<String> assets, String expression,
        List<String> assetBidx, Boolean assetAsBand, String collection, String nodata, Boolean unscale,
        Resampling resampling, PixelSelection pixelSelection, Algorithm algorithm, String algorithmParams,
        List<String> rescale, ColorMapNames colormapName, String colormap, Boolean returnMask, Integer scanLimit,
        ...
        return getWithResponse(tileMatrixSetId.toString(), searchid, requestOptions).flatMap(FluxUtil::toMono)
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<TileJson> get(Tilematrixsetid tileMatrixSetId, String searchid) {
        // Generated convenience method for getWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getWithResponse(tileMatrixSetId.toString(), searchid, requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(TileJson.class));
