...
public final class CollectionOperationsClient {
    @Generated
    private final CollectionOperationsImpl serviceClient;

    /**
     * Initializes an instance of CollectionOperationsClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    CollectionOperationsClient(CollectionOperationsImpl serviceClient) {
    ...
    public Response<BinaryData> createOrReplaceWithResponse(String collectionId, BinaryData body,
        ...
        return this.serviceClient.createOrReplaceWithResponse(collectionId, body, requestOptions);
    }
    ...
    public Response<Void> deleteWithResponse(String collectionId, RequestOptions requestOptions) {
        return this.serviceClient.deleteWithResponse(collectionId, requestOptions);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Collections getAll(Boolean sign, Integer duration) {
        ...
        return getAllWithResponse(requestOptions).getValue().toObject(Collections.class);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public GeoCatalogCollection create(CreateOptions options) {
        ...
        return createWithResponse(createRequest1, requestOptions).getValue().toObject(GeoCatalogCollection.class);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Collection get(String collectionId, Boolean sign, Integer duration) {
        ...
        return getWithResponse(collectionId, requestOptions).getValue().toObject(Collection.class);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public GeoCatalogCollection createOrReplace(String collectionId, GeoCatalogCollection body) {
        // Generated convenience method for createOrReplaceWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return createOrReplaceWithResponse(collectionId, BinaryData.fromObject(body), requestOptions).getValue()
    ...
    public void delete(String collectionId) {
        ...
        RequestOptions requestOptions = new RequestOptions();
        deleteWithResponse(collectionId, requestOptions).getValue();
    }
}
