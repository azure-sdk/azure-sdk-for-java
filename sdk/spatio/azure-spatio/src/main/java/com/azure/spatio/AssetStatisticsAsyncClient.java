...
import com.azure.spatio.implementation.AssetStatisticsImpl;
...
public final class AssetStatisticsAsyncClient {
    @Generated
    private final AssetStatisticsImpl serviceClient;

    /**
     * Initializes an instance of AssetStatisticsAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    AssetStatisticsAsyncClient(AssetStatisticsImpl serviceClient) {
     ...
     * <tr><td>assetBidx</td><td>List&lt;String&gt;</td><td>No</td><td>Per asset band indexes. Call
     * {@link RequestOptions#addQueryParam} to add string to array.</td></tr>
     * <tr><td>assetExpression</td><td>List&lt;String&gt;</td><td>No</td><td>Per asset band expression. Call
     * {@link RequestOptions#addQueryParam} to add string to array.</td></tr>
    ...
    public Mono<Response<BinaryData>> getAllWithResponse(String collectionId, String itemId,
        RequestOptions requestOptions) {
        return this.serviceClient.getAllWithResponseAsync(collectionId, itemId, requestOptions);
    }
     ...
     * @param assetBidx Per asset band indexes.
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Map<String, StatisticsInGeoJson>> getAll(String collectionId, String itemId, List<String> assets,
        List<String> assetBidx, List<String> assetExpression, String nodata, Boolean unscale, Resampling resampling,
        Integer maxSize, Integer height, Integer width, Boolean categorical, List<String> c, List<Integer> p,
        ...
        if (assetExpression != null) {
            for (String paramItemValue : assetExpression) {
                if (paramItemValue != null) {
                    requestOptions.addQueryParam("assetExpression", paramItemValue, false);
                }
            }
        }
        if (nodata != null) {
        ...
        return getAllWithResponse(collectionId, itemId, requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(TYPE_REFERENCE_MAP_STRING_STATISTICS_IN_GEO_JSON));
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Map<String, StatisticsInGeoJson>> getAll(String collectionId, String itemId) {
        // Generated convenience method for getAllWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getAllWithResponse(collectionId, itemId, requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(TYPE_REFERENCE_MAP_STRING_STATISTICS_IN_GEO_JSON));
    ...
    @Generated
    private static final TypeReference<Map<String, StatisticsInGeoJson>> TYPE_REFERENCE_MAP_STRING_STATISTICS_IN_GEO_JSON
        = new TypeReference<Map<String, StatisticsInGeoJson>>() {
        };
}
