...
public final class WmtsTileMatrixSetsAsyncClient {
    @Generated
    private final WmtsTileMatrixSetsImpl serviceClient;

    /**
     * Initializes an instance of WmtsTileMatrixSetsAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    WmtsTileMatrixSetsAsyncClient(WmtsTileMatrixSetsImpl serviceClient) {
    ...
    public Mono<Response<BinaryData>> getCapabilitiesXmlWithResponse(String collectionId, String itemId,
        String tileMatrixSetId, RequestOptions requestOptions) {
        return this.serviceClient.getCapabilitiesXmlWithResponseAsync(collectionId, itemId, tileMatrixSetId,
            requestOptions);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<String> getCapabilitiesXml(String collectionId, String itemId, Tilematrixsetid tileMatrixSetId,
