...
public final class IntervalLegendsClient {
    @Generated
    private final IntervalLegendsImpl serviceClient;

    /**
     * Initializes an instance of IntervalLegendsClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    IntervalLegendsClient(IntervalLegendsImpl serviceClient) {
    ...
    public Response<Void> getByClassmapNameWithResponse(String classmapName, RequestOptions requestOptions) {
        return this.serviceClient.getByClassmapNameWithResponse(classmapName, requestOptions);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public void getByClassmapName(String classmapName, Integer trimStart, Integer trimEnd) {
        ...
        getByClassmapNameWithResponse(classmapName, requestOptions).getValue();
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public void getByClassmapName(String classmapName) {
        // Generated convenience method for getByClassmapNameWithResponse
        RequestOptions requestOptions = new RequestOptions();
        getByClassmapNameWithResponse(classmapName, requestOptions).getValue();
    }
