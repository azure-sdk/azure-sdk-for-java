...
/**
 * An instance of this class provides access to all the operations defined in TileJsonTileMatrixSets.
 */
public final class TileJsonTileMatrixSetsImpl {
    /**
     * The proxy service used to perform REST calls.
     */
    private final TileJsonTileMatrixSetsService service;
    ...
    /**
     * Initializes an instance of TileJsonTileMatrixSetsImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    TileJsonTileMatrixSetsImpl(MicrosoftPlanetaryComputerProClientImpl client) {
        this.service = RestProxy.create(TileJsonTileMatrixSetsService.class, client.getHttpPipeline(),
    ...
    /**
     * The interface defining all the services for MicrosoftPlanetaryComputerProClientTileJsonTileMatrixSets to be used
     * by the proxy service to perform REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "MicrosoftPlanetaryCo")
    public interface TileJsonTileMatrixSetsService {
        @Get("/api/collections/{collectionId}/items/{itemId}/{tileMatrixSetId}/tilejson.json")
    ...
    public Mono<Response<BinaryData>> getWithResponseAsync(String tileMatrixSetId, String collectionId, String itemId,
        RequestOptions requestOptions) {
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.get(this.client.getEndpoint(), this.client.getServiceVersion().getVersion(),
                tileMatrixSetId, collectionId, itemId, accept, requestOptions, context));
    }
