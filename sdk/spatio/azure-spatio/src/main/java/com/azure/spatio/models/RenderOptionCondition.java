...
/**
 * Defines a property/value condition for a render config to be enabledTODO: add description for RenderOptionCondition.
 */
@Fluent
public final class RenderOptionCondition implements JsonSerializable<RenderOptionCondition> {
    /*
     * The property attribute name to check.TODO: add description for property
     */
    @Generated
    private final String property;

    /*
     * The value on which to perform an equality check.TODO: add description for value
     */
    @Generated
    ...
    /**
     * Get the property property: The property attribute name to check.TODO: add description for property.
     * 
    ...
    /**
     * Get the value property: The value on which to perform an equality check.TODO: add description for value.
     * 
    ...
    /**
     * Set the value property: The value on which to perform an equality check.TODO: add description for value.
     * 
