...
public final class Metadata implements JsonSerializable<Metadata> {
    ...
    /*
     * AssetsTODO: add description for assets
     */
    @Generated
    ...
    /**
     * Set the type property: TypeTODO: add description for type.
     * 
    ...
    /**
     * Set the bounds property: BoundsTODO: add description for bounds.
     * 
    ...
    /**
     * Set the minzoom property: MinzoomTODO: add description for minzoom.
     * 
    ...
    /**
     * Set the maxzoom property: MaxzoomTODO: add description for maxzoom.
     * 
    ...
    /**
     * Set the name property: NameTODO: add description for name.
     * 
    ...
    /**
     * Get the assets property: AssetsTODO: add description for assets.
     * 
    ...
    /**
     * Set the assets property: AssetsTODO: add description for assets.
     * 
