...
public final class ClassmapLegendsClient {
    @Generated
    private final ClassmapLegendsImpl serviceClient;

    /**
     * Initializes an instance of ClassmapLegendsClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    ClassmapLegendsClient(ClassmapLegendsImpl serviceClient) {
    ...
    public Response<Void> getWithResponse(String classmapName, RequestOptions requestOptions) {
        return this.serviceClient.getWithResponse(classmapName, requestOptions);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public void get(String classmapName, Integer trimStart, Integer trimEnd) {
        ...
        getWithResponse(classmapName, requestOptions).getValue();
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public void get(String classmapName) {
        // Generated convenience method for getWithResponse
        RequestOptions requestOptions = new RequestOptions();
        getWithResponse(classmapName, requestOptions).getValue();
    }
