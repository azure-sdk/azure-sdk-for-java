...
/**
 * An instance of this class provides access to all the operations defined in TileJsonOperations.
 */
public final class TileJsonOperationsImpl {
    /**
     * The proxy service used to perform REST calls.
     */
    private final TileJsonOperationsService service;
    ...
    /**
     * Initializes an instance of TileJsonOperationsImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    TileJsonOperationsImpl(MicrosoftPlanetaryComputerProClientImpl client) {
        this.service = RestProxy.create(TileJsonOperationsService.class, client.getHttpPipeline(),
    ...
    /**
     * The interface defining all the services for MicrosoftPlanetaryComputerProClientTileJsonOperations to be used by
     * the proxy service to perform REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "MicrosoftPlanetaryCo")
    public interface TileJsonOperationsService {
        @Get("/api/collections/{collectionId}/items/{itemId}/tilejson.json")
