...
import com.azure.spatio.implementation.PartsImpl;
...
public final class PartsAsyncClient {
    @Generated
    private final PartsImpl serviceClient;

    /**
     * Initializes an instance of PartsAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    PartsAsyncClient(PartsImpl serviceClient) {
    ...
    public Mono<Response<BinaryData>> getMinxMinyMaxxMaxyWidthxHeightFormatWithResponse(String collectionId,
        ...
        return this.serviceClient.getMinxMinyMaxxMaxyWidthxHeightFormatWithResponseAsync(collectionId, itemId, minx,
            miny, maxx, maxy, width, height, format, accept, requestOptions);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> getMinxMinyMaxxMaxyFormatWithResponse(String collectionId, String itemId,
        String minx, String miny, String maxx, String maxy, String format, String accept,
        RequestOptions requestOptions) {
        return this.serviceClient.getMinxMinyMaxxMaxyFormatWithResponseAsync(collectionId, itemId, minx, miny, maxx,
            maxy, format, accept, requestOptions);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<BinaryData> getMinxMinyMaxxMaxyWidthxHeightFormat(String collectionId, String itemId, String minx,
        String miny, String maxx, String maxy, String width, String height, ImageType format, String accept,
        String colorFormula, String dstCrs, String coordCrs, List<String> assets, String expression,
        List<String> assetBidx, Boolean assetAsBand, String nodata, Boolean unscale, Resampling resampling,
        Integer maxSize, Algorithm algorithm, String algorithmParams, List<String> rescale, ColorMapNames colormapName,
        String colormap, Boolean returnMask) {
        // Generated convenience method for getMinxMinyMaxxMaxyWidthxHeightFormatWithResponse
        ...
        return getMinxMinyMaxxMaxyWidthxHeightFormatWithResponse(collectionId, itemId, minx, miny, maxx, maxy, width,
            height, format.toString(), accept, requestOptions).flatMap(FluxUtil::toMono);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<BinaryData> getMinxMinyMaxxMaxyFormat(String collectionId, String itemId, String minx, String miny,
        String maxx, String maxy, ImageType format, String accept, String colorFormula, String dstCrs, String coordCrs,
        List<String> assets, String expression, List<String> assetBidx, Boolean assetAsBand, String nodata,
        Boolean unscale, Resampling resampling, Integer maxSize, Integer height, Integer width, Algorithm algorithm,
        String algorithmParams, List<String> rescale, ColorMapNames colormapName, String colormap, Boolean returnMask) {
        // Generated convenience method for getMinxMinyMaxxMaxyFormatWithResponse
        RequestOptions requestOptions = new RequestOptions();
        if (colorFormula != null) {
            requestOptions.addQueryParam("colorFormula", colorFormula, false);
        }
        ...
        return getMinxMinyMaxxMaxyFormatWithResponse(collectionId, itemId, minx, miny, maxx, maxy, format.toString(),
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<BinaryData> getMinxMinyMaxxMaxyFormat(String collectionId, String itemId, String minx, String miny,
        String maxx, String maxy, ImageType format, String accept) {
        // Generated convenience method for getMinxMinyMaxxMaxyFormatWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getMinxMinyMaxxMaxyFormatWithResponse(collectionId, itemId, minx, miny, maxx, maxy, format.toString(),
            accept, requestOptions).flatMap(FluxUtil::toMono);
