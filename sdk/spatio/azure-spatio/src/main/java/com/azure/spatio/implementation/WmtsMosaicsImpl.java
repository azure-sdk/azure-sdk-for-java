...
/**
 * An instance of this class provides access to all the operations defined in WmtsMosaics.
 */
public final class WmtsMosaicsImpl {
    /**
     * The proxy service used to perform REST calls.
     */
    private final WmtsMosaicsService service;
    ...
    /**
     * Initializes an instance of WmtsMosaicsImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    WmtsMosaicsImpl(MicrosoftPlanetaryComputerProClientImpl client) {
        this.service
            = RestProxy.create(WmtsMosaicsService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }
    ...
    /**
     * The interface defining all the services for MicrosoftPlanetaryComputerProClientWmtsMosaics to be used by the
     * proxy service to perform REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "MicrosoftPlanetaryCo")
    public interface WmtsMosaicsService {
        @Get("/api/mosaic/{searchid}/WMTSCapabilities.xml")
    ...
    public Mono<Response<BinaryData>> getCapabilitiesXmlWithResponseAsync(String searchid,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<BinaryData> getCapabilitiesXmlWithResponse(String searchid, RequestOptions requestOptions) {
        final String accept = "application/xml";
