...
/**
 * An instance of this class provides access to all the operations defined in MosaicsTileJsonOperations.
 */
public final class MosaicsTileJsonOperationsImpl {
    /**
     * The proxy service used to perform REST calls.
     */
    private final MosaicsTileJsonOperationsService service;
    ...
    /**
     * Initializes an instance of MosaicsTileJsonOperationsImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    MosaicsTileJsonOperationsImpl(MicrosoftPlanetaryComputerProClientImpl client) {
        this.service = RestProxy.create(MosaicsTileJsonOperationsService.class, client.getHttpPipeline(),
    ...
    /**
     * The interface defining all the services for MicrosoftPlanetaryComputerProClientMosaicsTileJsonOperations to be
     * used by the proxy service to perform REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "MicrosoftPlanetaryCo")
    public interface MosaicsTileJsonOperationsService {
        @Get("/api/mosaic/{searchid}/tilejson.json")
