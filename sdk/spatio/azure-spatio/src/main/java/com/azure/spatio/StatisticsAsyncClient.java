...
import com.azure.spatio.implementation.StatisticsImpl;
...
public final class StatisticsAsyncClient {
    @Generated
    private final StatisticsImpl serviceClient;

    /**
     * Initializes an instance of StatisticsAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    StatisticsAsyncClient(StatisticsImpl serviceClient) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Map<String, BandStatistics>> getAll(String collectionId, String itemId, List<String> assets,
        ...
        return getAllWithResponse(collectionId, itemId, requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(TYPE_REFERENCE_MAP_STRING_BAND_STATISTICS));
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Map<String, BandStatistics>> getAll(String collectionId, String itemId) {
        // Generated convenience method for getAllWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getAllWithResponse(collectionId, itemId, requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(TYPE_REFERENCE_MAP_STRING_BAND_STATISTICS));
    ...
    @Generated
    private static final TypeReference<Map<String, BandStatistics>> TYPE_REFERENCE_MAP_STRING_BAND_STATISTICS
        = new TypeReference<Map<String, BandStatistics>>() {
        };
}
