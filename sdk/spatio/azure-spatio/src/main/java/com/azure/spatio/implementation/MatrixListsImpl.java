...
/**
 * An instance of this class provides access to all the operations defined in MatrixLists.
 */
public final class MatrixListsImpl {
    /**
     * The proxy service used to perform REST calls.
     */
    private final MatrixListsService service;
    ...
    /**
     * Initializes an instance of MatrixListsImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    MatrixListsImpl(MicrosoftPlanetaryComputerProClientImpl client) {
        this.service
            = RestProxy.create(MatrixListsService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }
    ...
    /**
     * The interface defining all the services for MicrosoftPlanetaryComputerProClientMatrixLists to be used by the
     * proxy service to perform REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "MicrosoftPlanetaryCo")
    public interface MatrixListsService {
        @Get("/api/tile-matrix-sets")
