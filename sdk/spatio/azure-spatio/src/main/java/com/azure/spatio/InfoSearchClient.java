...
public final class InfoSearchClient {
    @Generated
    private final InfoSearchesImpl serviceClient;

    /**
     * Initializes an instance of InfoSearchClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    InfoSearchClient(InfoSearchesImpl serviceClient) {
     ...
     * @return response model for /info endpoint.TODO: add description for TitilerPgstacModelInfo.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public TitilerPgstacModelInfo get(String searchid) {
        // Generated convenience method for getWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getWithResponse(searchid, requestOptions).getValue().toObject(TitilerPgstacModelInfo.class);
    }
}
