...
/**
 * The CreateRequest1 model.
 */
@Fluent
public final class CreateRequest1 implements JsonSerializable<CreateRequest1> {
    /*
    ...
    /**
     * Creates an instance of CreateRequest1 class.
     * 
     ...
     */
    @Generated
    public CreateRequest1(GeoCatalogCollectionType type, String stacVersion, String id, String description,
     ...
     * @return the CreateRequest1 object itself.
     */
    @Generated
    public CreateRequest1 setStacExtensions(List<String> stacExtensions) {
     ...
     */
    @Generated
    public CreateRequest1 setTitle(String title) {
        this.title = title;
        return this;
    }
     ...
     */
    @Generated
    public CreateRequest1 setKeywords(List<String> keywords) {
     ...
     */
    @Generated
    public CreateRequest1 setProviders(List<Map<String, String>> providers) {
     ...
     */
    @Generated
    public CreateRequest1 setAssets(Map<String, String> assets) {
        this.assets = assets;
        return this;
    }
     ...
     */
    @Generated
    public CreateRequest1 setSummaries(Map<String, String> summaries) {
     ...
     */
    @Generated
    public CreateRequest1 setMsftShortDescription(String msftShortDescription) {
    ...
    /**
     * Reads an instance of CreateRequest1 from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of CreateRequest1 if the JsonReader was pointing to an instance of it, or null if it was
     * pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the CreateRequest1.
     */
    @Generated
    public static CreateRequest1 fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            CreateRequest1 deserializedCreateRequest1
                = new CreateRequest1(type, stacVersion, id, description, links, license, extent);
            deserializedCreateRequest1.stacExtensions = stacExtensions;
            deserializedCreateRequest1.title = title;
            deserializedCreateRequest1.keywords = keywords;
            deserializedCreateRequest1.providers = providers;
            deserializedCreateRequest1.assets = assets;
            deserializedCreateRequest1.summaries = summaries;
            deserializedCreateRequest1.msftShortDescription = msftShortDescription;

            return deserializedCreateRequest1;
        });
    }
}
