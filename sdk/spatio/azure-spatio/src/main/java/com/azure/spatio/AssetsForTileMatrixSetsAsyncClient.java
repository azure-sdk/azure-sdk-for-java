...
public final class AssetsForTileMatrixSetsAsyncClient {
    @Generated
    private final AssetsForTileMatrixSetsImpl serviceClient;

    /**
     * Initializes an instance of AssetsForTileMatrixSetsAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    AssetsForTileMatrixSetsAsyncClient(AssetsForTileMatrixSetsImpl serviceClient) {
    ...
    public Mono<Response<BinaryData>> getZxyAssetsWithResponse(String tileMatrixSetId, String searchid, String z,
        String x, String y, RequestOptions requestOptions) {
        return this.serviceClient.getZxyAssetsWithResponseAsync(tileMatrixSetId, searchid, z, x, y, requestOptions);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<List<GetLonLatAssetsResponse>> getZxyAssets(Tilematrixsetid tileMatrixSetId, String searchid, String z,
        ...
        return getZxyAssetsWithResponse(tileMatrixSetId.toString(), searchid, z, x, y, requestOptions)
