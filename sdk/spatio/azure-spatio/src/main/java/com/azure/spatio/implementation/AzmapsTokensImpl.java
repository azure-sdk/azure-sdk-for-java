...
/**
 * An instance of this class provides access to all the operations defined in AzmapsTokens.
 */
public final class AzmapsTokensImpl {
    /**
     * The proxy service used to perform REST calls.
     */
    private final AzmapsTokensService service;
    ...
    /**
     * Initializes an instance of AzmapsTokensImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    AzmapsTokensImpl(MicrosoftPlanetaryComputerProClientImpl client) {
        this.service
            = RestProxy.create(AzmapsTokensService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }
    ...
    /**
     * The interface defining all the services for MicrosoftPlanetaryComputerProClientAzmapsTokens to be used by the
     * proxy service to perform REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "MicrosoftPlanetaryCo")
    public interface AzmapsTokensService {
        @Get("/api/config/map/token")
