...
/**
 * An instance of this class provides access to all the operations defined in InfoOperations.
 */
public final class InfoOperationsImpl {
    /**
     * The proxy service used to perform REST calls.
     */
    private final InfoOperationsService service;
    ...
    /**
     * Initializes an instance of InfoOperationsImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    InfoOperationsImpl(MicrosoftPlanetaryComputerProClientImpl client) {
        this.service
            = RestProxy.create(InfoOperationsService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }
    ...
    /**
     * The interface defining all the services for MicrosoftPlanetaryComputerProClientInfoOperations to be used by the
     * proxy service to perform REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "MicrosoftPlanetaryCo")
    public interface InfoOperationsService {
        @Get("/api/collections/{collectionId}/items/{itemId}/info")
