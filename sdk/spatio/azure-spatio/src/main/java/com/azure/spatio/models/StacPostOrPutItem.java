 ...
 */
@Immutable
public final class StacPostOrPutItem implements JsonSerializable<StacPostOrPutItem> {
    /*
    ...
    /**
     * Creates an instance of StacPostOrPutItem class.
     * 
     ...
     */
    @Generated
    public StacPostOrPutItem(String type, String stacVersion, List<String> stacExtensions, String id, String geometry,
    ...
    /**
     * Reads an instance of StacPostOrPutItem from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of StacPostOrPutItem if the JsonReader was pointing to an instance of it, or null if it was
     * pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the StacPostOrPutItem.
     */
    @Generated
    public static StacPostOrPutItem fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            return new StacPostOrPutItem(type, stacVersion, stacExtensions, id, geometry, bbox, properties, assets,
                links, collection);
        });
    }
}
