...
public final class ManagedIdentityMetadata implements JsonSerializable<ManagedIdentityMetadata> {
     ...
     */
    @Generated
    private final String recourceId;

    /**
     * Creates an instance of ManagedIdentityMetadata class.
     * 
     * @param objectId the objectId value to set.
     * @param recourceId the recourceId value to set.
     */
    @Generated
    private ManagedIdentityMetadata(String objectId, String recourceId) {
    ...
    /**
     * Get the recourceId property: ARM path or resource id of the managed identity.
     * 
     * @return the recourceId value.
     */
    @Generated
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeStringField("recourceId", this.recourceId);
    ...
    public static ManagedIdentityMetadata fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                } else if ("recourceId".equals(fieldName)) {
                    recourceId = reader.getString();
                } else {
                    reader.skipChildren();
                }
            }
            return new ManagedIdentityMetadata(objectId, recourceId);
        });
    }
}
