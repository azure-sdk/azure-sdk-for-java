...
public final class PartitionTypesAsyncClient {
    @Generated
    private final PartitionTypesImpl serviceClient;

    /**
     * Initializes an instance of PartitionTypesAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    PartitionTypesAsyncClient(PartitionTypesImpl serviceClient) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<Void>> createOrUpdateWithResponse(String collectionId, BinaryData body,
        RequestOptions requestOptions) {
        return this.serviceClient.createOrUpdateWithResponseAsync(collectionId, body, requestOptions);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PartitionType> get(String collectionId) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> createOrUpdate(String collectionId, PartitionType body) {
        // Generated convenience method for createOrUpdateWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return createOrUpdateWithResponse(collectionId, BinaryData.fromObject(body), requestOptions)
