...
/**
 * An instance of this class provides access to all the operations defined in Tiles.
 */
public final class TilesImpl {
    /**
    ...
    /**
     * Initializes an instance of TilesImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    TilesImpl(MicrosoftPlanetaryComputerProClientImpl client) {
        this.service = RestProxy.create(TilesService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }
    ...
    /**
     * The interface defining all the services for MicrosoftPlanetaryComputerProClientTiles to be used by the proxy
     * service to perform REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "MicrosoftPlanetaryCo")
    public interface TilesService {
        @Get("/api/collections/{collectionId}/items/{itemId}/tiles/{z}/{x}/{y}@{scale}x.{format}")
        ...
        Mono<Response<BinaryData>> getZxyScalexFormat(@HostParam("endpoint") String endpoint,
            ...
            @PathParam("itemId") String itemId, @PathParam("z") String z, @PathParam("x") String x,
            @PathParam("y") String y, @PathParam("scale") String scale, @PathParam("format") String format,
        ...
        @Get("/api/collections/{collectionId}/items/{itemId}/tiles/{z}/{x}/{y}@{scale}x")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(value = ClientAuthenticationException.class, code = { 401 })
        @UnexpectedResponseExceptionType(value = ResourceNotFoundException.class, code = { 404 })
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        ...
        Mono<Response<BinaryData>> getZxyScalex(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("collectionId") String collectionId,
            @PathParam("itemId") String itemId, @PathParam("z") String z, @PathParam("x") String x,
            @PathParam("y") String y, @PathParam("scale") String scale, @HeaderParam("Accept") String accept,
        ...
        @Get("/api/collections/{collectionId}/items/{itemId}/tiles/{z}/{x}/{y}.{format}")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(value = ClientAuthenticationException.class, code = { 401 })
        @UnexpectedResponseExceptionType(value = ResourceNotFoundException.class, code = { 404 })
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        ...
        Mono<Response<BinaryData>> getZxyFormat(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("collectionId") String collectionId,
            @PathParam("itemId") String itemId, @PathParam("z") String z, @PathParam("x") String x,
            @PathParam("y") String y, @PathParam("format") String format, @HeaderParam("Accept") String accept,
            RequestOptions requestOptions, Context context);
        ...
        @Get("/api/collections/{collectionId}/items/{itemId}/tiles/{z}/{x}/{y}")
        @ExpectedResponses({ 204 })
        @UnexpectedResponseExceptionType(value = ClientAuthenticationException.class, code = { 401 })
        @UnexpectedResponseExceptionType(value = ResourceNotFoundException.class, code = { 404 })
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        @UnexpectedResponseExceptionType(HttpResponseException.class)
        Mono<Response<Void>> getZxy(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("collectionId") String collectionId,
            @PathParam("itemId") String itemId, @PathParam("z") String z, @PathParam("x") String x,
        ...
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        @UnexpectedResponseExceptionType(HttpResponseException.class)
        Response<Void> getZxySync(@HostParam("endpoint") String endpoint, @QueryParam("api-version") String apiVersion,
    ...
    public Mono<Response<BinaryData>> getZxyScalexFormatWithResponseAsync(String collectionId, String itemId, String z,
        String x, String y, String scale, String format, String accept, RequestOptions requestOptions) {
        return FluxUtil.withContext(context -> service.getZxyScalexFormat(this.client.getEndpoint(),
            this.client.getServiceVersion().getVersion(), collectionId, itemId, z, x, y, scale, format, accept,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<BinaryData> getZxyScalexFormatWithResponse(String collectionId, String itemId, String z, String x,
        String y, String scale, String format, String accept, RequestOptions requestOptions) {
        return service.getZxyScalexFormatSync(this.client.getEndpoint(), this.client.getServiceVersion().getVersion(),
            collectionId, itemId, z, x, y, scale, format, accept, requestOptions, Context.NONE);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> getZxyScalexWithResponseAsync(String collectionId, String itemId, String z,
        String x, String y, String scale, String accept, RequestOptions requestOptions) {
        return FluxUtil.withContext(
            context -> service.getZxyScalex(this.client.getEndpoint(), this.client.getServiceVersion().getVersion(),
                collectionId, itemId, z, x, y, scale, accept, requestOptions, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<BinaryData> getZxyScalexWithResponse(String collectionId, String itemId, String z, String x,
        String y, String scale, String accept, RequestOptions requestOptions) {
        return service.getZxyScalexSync(this.client.getEndpoint(), this.client.getServiceVersion().getVersion(),
            collectionId, itemId, z, x, y, scale, accept, requestOptions, Context.NONE);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> getZxyFormatWithResponseAsync(String collectionId, String itemId, String z,
        String x, String y, String format, String accept, RequestOptions requestOptions) {
        return FluxUtil.withContext(
            context -> service.getZxyFormat(this.client.getEndpoint(), this.client.getServiceVersion().getVersion(),
                collectionId, itemId, z, x, y, format, accept, requestOptions, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<BinaryData> getZxyFormatWithResponse(String collectionId, String itemId, String z, String x,
        String y, String format, String accept, RequestOptions requestOptions) {
        return service.getZxyFormatSync(this.client.getEndpoint(), this.client.getServiceVersion().getVersion(),
            collectionId, itemId, z, x, y, format, accept, requestOptions, Context.NONE);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<Void>> getZxyWithResponseAsync(String collectionId, String itemId, String z, String x,
        ...
        return FluxUtil.withContext(
            context -> service.getZxy(this.client.getEndpoint(), this.client.getServiceVersion().getVersion(),
                collectionId, itemId, z, x, y, accept, requestOptions, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<Void> getZxyWithResponse(String collectionId, String itemId, String z, String x, String y,
        RequestOptions requestOptions) {
        final String accept = "application/json";
        return service.getZxySync(this.client.getEndpoint(), this.client.getServiceVersion().getVersion(), collectionId,
            itemId, z, x, y, accept, requestOptions, Context.NONE);
    }
}
