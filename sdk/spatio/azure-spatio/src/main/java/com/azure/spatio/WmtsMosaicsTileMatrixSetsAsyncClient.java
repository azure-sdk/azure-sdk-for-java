...
import com.azure.spatio.implementation.WmtsMosaicsTileMatrixSetsImpl;
...
public final class WmtsMosaicsTileMatrixSetsAsyncClient {
    @Generated
    private final WmtsMosaicsTileMatrixSetsImpl serviceClient;

    /**
     * Initializes an instance of WmtsMosaicsTileMatrixSetsAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    WmtsMosaicsTileMatrixSetsAsyncClient(WmtsMosaicsTileMatrixSetsImpl serviceClient) {
    ...
    public Mono<Response<BinaryData>> getCapabilitiesXmlWithResponse(String tileMatrixSetId, String searchid,
        RequestOptions requestOptions) {
        return this.serviceClient.getCapabilitiesXmlWithResponseAsync(tileMatrixSetId, searchid, requestOptions);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<String> getCapabilitiesXml(Tilematrixsetid tileMatrixSetId, String searchid, ImageType tileFormat,
        ...
        return getCapabilitiesXmlWithResponse(tileMatrixSetId.toString(), searchid, requestOptions)
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<String> getCapabilitiesXml(Tilematrixsetid tileMatrixSetId, String searchid) {
        // Generated convenience method for getCapabilitiesXmlWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getCapabilitiesXmlWithResponse(tileMatrixSetId.toString(), searchid, requestOptions)
            .flatMap(FluxUtil::toMono)
