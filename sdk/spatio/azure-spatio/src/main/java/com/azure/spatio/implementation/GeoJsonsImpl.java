...
/**
 * An instance of this class provides access to all the operations defined in GeoJsons.
 */
public final class GeoJsonsImpl {
    /**
     * The proxy service used to perform REST calls.
     */
    private final GeoJsonsService service;
    ...
    /**
     * Initializes an instance of GeoJsonsImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    GeoJsonsImpl(MicrosoftPlanetaryComputerProClientImpl client) {
        this.service = RestProxy.create(GeoJsonsService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }
    ...
    /**
     * The interface defining all the services for MicrosoftPlanetaryComputerProClientGeoJsons to be used by the proxy
     * service to perform REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "MicrosoftPlanetaryCo")
    public interface GeoJsonsService {
        @Post("/api/collections/{collectionId}/items/{itemId}/crop/{width}x{height}.{format}")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(value = ClientAuthenticationException.class, code = { 401 })
        @UnexpectedResponseExceptionType(value = ResourceNotFoundException.class, code = { 404 })
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        @UnexpectedResponseExceptionType(HttpResponseException.class)
        Mono<Response<BinaryData>> cropWidthxHeightFormat(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("collectionId") String collectionId,
            @PathParam("itemId") String itemId, @PathParam("width") String width, @PathParam("height") String height,
        ...
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        @UnexpectedResponseExceptionType(HttpResponseException.class)
        Response<BinaryData> cropWidthxHeightFormatSync(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("collectionId") String collectionId,
            @PathParam("itemId") String itemId, @PathParam("width") String width, @PathParam("height") String height,
            @PathParam("format") String format, @HeaderParam("Content-Type") String contentType,
            @HeaderParam("Accept") String accept, @BodyParam("application/json") BinaryData body,
        ...
        @Post("/api/collections/{collectionId}/items/{itemId}/crop.{format}")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(value = ClientAuthenticationException.class, code = { 401 })
        @UnexpectedResponseExceptionType(value = ResourceNotFoundException.class, code = { 404 })
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        @UnexpectedResponseExceptionType(HttpResponseException.class)
        Mono<Response<BinaryData>> cropFormat(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("collectionId") String collectionId,
        ...
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        @UnexpectedResponseExceptionType(HttpResponseException.class)
        Response<BinaryData> cropFormatSync(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("collectionId") String collectionId,
            @PathParam("itemId") String itemId, @PathParam("format") String format,
            @HeaderParam("Content-Type") String contentType, @HeaderParam("Accept") String accept,
            @BodyParam("application/json") BinaryData body, RequestOptions requestOptions, Context context);

        @Post("/api/collections/{collectionId}/items/{itemId}/crop")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(value = ClientAuthenticationException.class, code = { 401 })
        @UnexpectedResponseExceptionType(value = ResourceNotFoundException.class, code = { 404 })
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        @UnexpectedResponseExceptionType(HttpResponseException.class)
        Mono<Response<BinaryData>> cropPost(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("collectionId") String collectionId,
        ...
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        @UnexpectedResponseExceptionType(HttpResponseException.class)
        Response<BinaryData> cropPostSync(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("collectionId") String collectionId,
            @PathParam("itemId") String itemId, @HeaderParam("Content-Type") String contentType,
            @HeaderParam("Accept") String accept, @BodyParam("application/json") BinaryData body,
            RequestOptions requestOptions, Context context);
    ...
    public Mono<Response<BinaryData>> cropWidthxHeightFormatWithResponseAsync(String collectionId, String itemId,
        String width, String height, String format, String accept, BinaryData body, RequestOptions requestOptions) {
        final String contentType = "application/json";
        return FluxUtil.withContext(context -> service.cropWidthxHeightFormat(this.client.getEndpoint(),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<BinaryData> cropWidthxHeightFormatWithResponse(String collectionId, String itemId, String width,
        String height, String format, String accept, BinaryData body, RequestOptions requestOptions) {
        final String contentType = "application/json";
        return service.cropWidthxHeightFormatSync(this.client.getEndpoint(),
            this.client.getServiceVersion().getVersion(), collectionId, itemId, width, height, format, contentType,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> cropFormatWithResponseAsync(String collectionId, String itemId, String format,
        String accept, BinaryData body, RequestOptions requestOptions) {
        final String contentType = "application/json";
        return FluxUtil.withContext(
            context -> service.cropFormat(this.client.getEndpoint(), this.client.getServiceVersion().getVersion(),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<BinaryData> cropFormatWithResponse(String collectionId, String itemId, String format, String accept,
        BinaryData body, RequestOptions requestOptions) {
        final String contentType = "application/json";
        return service.cropFormatSync(this.client.getEndpoint(), this.client.getServiceVersion().getVersion(),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> cropPostWithResponseAsync(String collectionId, String itemId, String accept,
        BinaryData body, RequestOptions requestOptions) {
        final String contentType = "application/json";
        return FluxUtil.withContext(
            context -> service.cropPost(this.client.getEndpoint(), this.client.getServiceVersion().getVersion(),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<BinaryData> cropPostWithResponse(String collectionId, String itemId, String accept, BinaryData body,
        RequestOptions requestOptions) {
        final String contentType = "application/json";
        return service.cropPostSync(this.client.getEndpoint(), this.client.getServiceVersion().getVersion(),
