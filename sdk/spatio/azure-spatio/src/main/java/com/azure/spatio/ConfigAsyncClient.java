...
public final class ConfigAsyncClient {
    @Generated
    private final ConfigsImpl serviceClient;

    /**
     * Initializes an instance of ConfigAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    ConfigAsyncClient(ConfigsImpl serviceClient) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<UserCollectionSettings> get(String collectionId) {
