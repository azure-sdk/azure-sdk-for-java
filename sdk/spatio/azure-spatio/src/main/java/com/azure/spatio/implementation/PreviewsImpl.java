...
/**
 * An instance of this class provides access to all the operations defined in Previews.
 */
public final class PreviewsImpl {
    /**
    ...
    /**
     * Initializes an instance of PreviewsImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    PreviewsImpl(MicrosoftPlanetaryComputerProClientImpl client) {
    ...
    /**
     * The interface defining all the services for MicrosoftPlanetaryComputerProClientPreviews to be used by the proxy
     * service to perform REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "MicrosoftPlanetaryCo")
    public interface PreviewsService {
        @Get("/api/collections/{collectionId}/items/{itemId}/preview.{format}")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(value = ClientAuthenticationException.class, code = { 401 })
        @UnexpectedResponseExceptionType(value = ResourceNotFoundException.class, code = { 404 })
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        @UnexpectedResponseExceptionType(HttpResponseException.class)
        Mono<Response<BinaryData>> getFormat(@HostParam("endpoint") String endpoint,
        ...
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        @UnexpectedResponseExceptionType(HttpResponseException.class)
        Response<BinaryData> getFormatSync(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("collectionId") String collectionId,
            @PathParam("itemId") String itemId, @PathParam("format") String format,
            @HeaderParam("Accept") String accept, RequestOptions requestOptions, Context context);

        @Get("/api/collections/{collectionId}/items/{itemId}/preview")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(value = ClientAuthenticationException.class, code = { 401 })
        @UnexpectedResponseExceptionType(value = ResourceNotFoundException.class, code = { 404 })
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
    ...
    public Mono<Response<BinaryData>> getFormatWithResponseAsync(String collectionId, String itemId, String format,
        String accept, RequestOptions requestOptions) {
        return FluxUtil.withContext(
            context -> service.getFormat(this.client.getEndpoint(), this.client.getServiceVersion().getVersion(),
                collectionId, itemId, format, accept, requestOptions, context));
    }
    ...
    public Response<BinaryData> getFormatWithResponse(String collectionId, String itemId, String format, String accept,
        ...
        return service.getFormatSync(this.client.getEndpoint(), this.client.getServiceVersion().getVersion(),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> getWithResponseAsync(String collectionId, String itemId, String accept,
        RequestOptions requestOptions) {
