...
public final class WmtsMosaicsClient {
    @Generated
    private final WmtsMosaicsImpl serviceClient;

    /**
     * Initializes an instance of WmtsMosaicsClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    WmtsMosaicsClient(WmtsMosaicsImpl serviceClient) {
    ...
    public Response<BinaryData> getCapabilitiesXmlWithResponse(String searchid, RequestOptions requestOptions) {
        return this.serviceClient.getCapabilitiesXmlWithResponse(searchid, requestOptions);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public String getCapabilitiesXml(String searchid, Tilematrixsetid tileMatrixSetId, ImageType tileFormat,
        ...
        return getCapabilitiesXmlWithResponse(searchid, requestOptions).getValue().toObject(String.class);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public String getCapabilitiesXml(String searchid) {
        // Generated convenience method for getCapabilitiesXmlWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getCapabilitiesXmlWithResponse(searchid, requestOptions).getValue().toObject(String.class);
    }
