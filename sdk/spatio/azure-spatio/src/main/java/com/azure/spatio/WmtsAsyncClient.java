...
import com.azure.spatio.implementation.WmtsImpl;
...
public final class WmtsAsyncClient {
    @Generated
    private final WmtsImpl serviceClient;

    /**
     * Initializes an instance of WmtsAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    WmtsAsyncClient(WmtsImpl serviceClient) {
    ...
    public Mono<Response<BinaryData>> getCapabilitiesXmlWithResponse(String collectionId, String itemId,
        ...
        return this.serviceClient.getCapabilitiesXmlWithResponseAsync(collectionId, itemId, requestOptions);
    }
    ...
    public Mono<String> getCapabilitiesXml(String collectionId, String itemId, Tilematrixsetid tileMatrixSetId,
        ...
        return getCapabilitiesXmlWithResponse(collectionId, itemId, requestOptions).flatMap(FluxUtil::toMono)
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<String> getCapabilitiesXml(String collectionId, String itemId) {
        // Generated convenience method for getCapabilitiesXmlWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getCapabilitiesXmlWithResponse(collectionId, itemId, requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(String.class));
