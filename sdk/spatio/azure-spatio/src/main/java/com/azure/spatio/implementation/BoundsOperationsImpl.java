...
/**
 * An instance of this class provides access to all the operations defined in BoundsOperations.
 */
public final class BoundsOperationsImpl {
    /**
     * The proxy service used to perform REST calls.
     */
    private final BoundsService service;
    ...
    /**
     * Initializes an instance of BoundsOperationsImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    BoundsOperationsImpl(MicrosoftPlanetaryComputerProClientImpl client) {
        this.service = RestProxy.create(BoundsService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }
    ...
    /**
     * The interface defining all the services for MicrosoftPlanetaryComputerProClientBoundsOperations to be used by the
     * proxy service to perform REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "MicrosoftPlanetaryCo")
    public interface BoundsService {
        @Get("/api/collections/{collectionId}/items/{itemId}/bounds")
     ...
     * @return dataset Bounding boxTODO: add description for Bounds along with {@link Response} on successful completion
     * of {@link Mono}.
     */
     ...
     * @throws ResourceNotFoundException thrown if the request is rejected by server on status code 404.
     * @throws ResourceModifiedException thrown if the request is rejected by server on status code 409.
     * @return dataset Bounding boxTODO: add description for Bounds along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
