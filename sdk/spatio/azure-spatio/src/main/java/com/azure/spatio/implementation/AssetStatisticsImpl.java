...
/**
 * An instance of this class provides access to all the operations defined in AssetStatistics.
 */
public final class AssetStatisticsImpl {
    /**
     * The proxy service used to perform REST calls.
     */
    private final AssetStatisticsService service;
    ...
    /**
     * Initializes an instance of AssetStatisticsImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    AssetStatisticsImpl(MicrosoftPlanetaryComputerProClientImpl client) {
        this.service
            = RestProxy.create(AssetStatisticsService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }
    ...
    /**
     * The interface defining all the services for MicrosoftPlanetaryComputerProClientAssetStatistics to be used by the
     * proxy service to perform REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "MicrosoftPlanetaryCo")
    public interface AssetStatisticsService {
        @Get("/api/collections/{collectionId}/items/{itemId}/asset_statistics")
