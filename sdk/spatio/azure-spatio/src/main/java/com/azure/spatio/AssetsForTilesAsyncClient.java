...
import com.azure.spatio.implementation.AssetsForTilesImpl;
...
public final class AssetsForTilesAsyncClient {
    @Generated
    private final AssetsForTilesImpl serviceClient;

    /**
     * Initializes an instance of AssetsForTilesAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    AssetsForTilesAsyncClient(AssetsForTilesImpl serviceClient) {
    ...
    public Mono<Response<BinaryData>> getZxyAssetsWithResponse(String searchid, String z, String x, String y,
        RequestOptions requestOptions) {
        return this.serviceClient.getZxyAssetsWithResponseAsync(searchid, z, x, y, requestOptions);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<List<GetLonLatAssetsResponse>> getZxyAssets(String searchid, String z, String x, String y,
        Tilematrixsetid tileMatrixSetId, Integer scanLimit, Integer itemsLimit, Integer timeLimit, Boolean exitwhenfull,
        Boolean skipcovered) {
        ...
        return getZxyAssetsWithResponse(searchid, z, x, y, requestOptions).flatMap(FluxUtil::toMono)
