...
/**
 * An instance of this class provides access to all the operations defined in MosaicsTileMatrixSets.
 */
public final class MosaicsTileMatrixSetsImpl {
    /**
     * The proxy service used to perform REST calls.
     */
    private final MosaicsTileMatrixSetsService service;
    ...
    /**
     * Initializes an instance of MosaicsTileMatrixSetsImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    MosaicsTileMatrixSetsImpl(MicrosoftPlanetaryComputerProClientImpl client) {
        this.service = RestProxy.create(MosaicsTileMatrixSetsService.class, client.getHttpPipeline(),
    ...
    /**
     * The interface defining all the services for MicrosoftPlanetaryComputerProClientMosaicsTileMatrixSets to be used
     * by the proxy service to perform REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "MicrosoftPlanetaryCo")
    public interface MosaicsTileMatrixSetsService {
        @Get("/api/mosaic/{searchid}/tiles/{tileMatrixSetId}/{z}/{x}/{y}@{scale}x.{format}")
        ...
        Mono<Response<BinaryData>> getZxyScalexFormat(@HostParam("endpoint") String endpoint,
            ...
            @PathParam("scale") String scale, @PathParam("format") String format,
            @PathParam("searchid") String searchid, @PathParam("z") String z, @PathParam("x") String x,
            @PathParam("y") String y, @HeaderParam("Accept") String accept, RequestOptions requestOptions,
            Context context);
        ...
        @Get("/api/mosaic/{searchid}/tiles/{tileMatrixSetId}/{z}/{x}/{y}@{scale}x")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(value = ClientAuthenticationException.class, code = { 401 })
        @UnexpectedResponseExceptionType(value = ResourceNotFoundException.class, code = { 404 })
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        ...
        Mono<Response<BinaryData>> getZxyScalex(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("tileMatrixSetId") String tileMatrixSetId,
            @PathParam("scale") String scale, @PathParam("searchid") String searchid, @PathParam("z") String z,
            @PathParam("x") String x, @PathParam("y") String y, @HeaderParam("Accept") String accept,
        ...
        @Get("/api/mosaic/{searchid}/tiles/{tileMatrixSetId}/{z}/{x}/{y}.{format}")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(value = ClientAuthenticationException.class, code = { 401 })
        @UnexpectedResponseExceptionType(value = ResourceNotFoundException.class, code = { 404 })
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        ...
        Mono<Response<BinaryData>> getZxyFormat(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("tileMatrixSetId") String tileMatrixSetId,
            @PathParam("format") String format, @PathParam("searchid") String searchid, @PathParam("z") String z,
            @PathParam("x") String x, @PathParam("y") String y, @HeaderParam("Accept") String accept,
            RequestOptions requestOptions, Context context);
        ...
        @Get("/api/mosaic/{searchid}/tiles/{tileMatrixSetId}/{z}/{x}/{y}")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(value = ClientAuthenticationException.class, code = { 401 })
        @UnexpectedResponseExceptionType(value = ResourceNotFoundException.class, code = { 404 })
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
     ...
     * <tr><td>pixelSelection</td><td>String</td><td>No</td><td>Pixel selection method. Allowed values: "first",
    ...
    public Mono<Response<BinaryData>> getZxyScalexFormatWithResponseAsync(String tileMatrixSetId, String scale,
        String format, String searchid, String z, String x, String y, String accept, RequestOptions requestOptions) {
        return FluxUtil.withContext(context -> service.getZxyScalexFormat(this.client.getEndpoint(),
            this.client.getServiceVersion().getVersion(), tileMatrixSetId, scale, format, searchid, z, x, y, accept,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<BinaryData> getZxyScalexFormatWithResponse(String tileMatrixSetId, String scale, String format,
        String searchid, String z, String x, String y, String accept, RequestOptions requestOptions) {
        return service.getZxyScalexFormatSync(this.client.getEndpoint(), this.client.getServiceVersion().getVersion(),
            tileMatrixSetId, scale, format, searchid, z, x, y, accept, requestOptions, Context.NONE);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> getZxyScalexWithResponseAsync(String tileMatrixSetId, String scale,
        String searchid, String z, String x, String y, String accept, RequestOptions requestOptions) {
        return FluxUtil.withContext(
            context -> service.getZxyScalex(this.client.getEndpoint(), this.client.getServiceVersion().getVersion(),
                tileMatrixSetId, scale, searchid, z, x, y, accept, requestOptions, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<BinaryData> getZxyScalexWithResponse(String tileMatrixSetId, String scale, String searchid,
        ...
        return service.getZxyScalexSync(this.client.getEndpoint(), this.client.getServiceVersion().getVersion(),
            tileMatrixSetId, scale, searchid, z, x, y, accept, requestOptions, Context.NONE);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> getZxyFormatWithResponseAsync(String tileMatrixSetId, String format,
        String searchid, String z, String x, String y, String accept, RequestOptions requestOptions) {
        return FluxUtil.withContext(
            context -> service.getZxyFormat(this.client.getEndpoint(), this.client.getServiceVersion().getVersion(),
                tileMatrixSetId, format, searchid, z, x, y, accept, requestOptions, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<BinaryData> getZxyFormatWithResponse(String tileMatrixSetId, String format, String searchid,
        String z, String x, String y, String accept, RequestOptions requestOptions) {
        return service.getZxyFormatSync(this.client.getEndpoint(), this.client.getServiceVersion().getVersion(),
            tileMatrixSetId, format, searchid, z, x, y, accept, requestOptions, Context.NONE);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> getZxyWithResponseAsync(String tileMatrixSetId, String searchid, String z,
        ...
        return FluxUtil.withContext(
            context -> service.getZxy(this.client.getEndpoint(), this.client.getServiceVersion().getVersion(),
                tileMatrixSetId, searchid, z, x, y, accept, requestOptions, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<BinaryData> getZxyWithResponse(String tileMatrixSetId, String searchid, String z, String x,
        String y, String accept, RequestOptions requestOptions) {
        return service.getZxySync(this.client.getEndpoint(), this.client.getServiceVersion().getVersion(),
            tileMatrixSetId, searchid, z, x, y, accept, requestOptions, Context.NONE);
    }
}
