...
public final class LegendsAsyncClient {
    @Generated
    private final LegendsImpl serviceClient;

    /**
     * Initializes an instance of LegendsAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    LegendsAsyncClient(LegendsImpl serviceClient) {
    ...
    public Mono<Response<Void>> getWithResponse(String cmapName, RequestOptions requestOptions) {
        return this.serviceClient.getWithResponseAsync(cmapName, requestOptions);
    }
     ...
     * 
     * Returns:
     * HTTP response with jpeg encoded image data on successful completion of {@link Mono}.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> get(String cmapName, Double height, Double width, Integer trimStart, Integer trimEnd) {
        ...
        return getWithResponse(cmapName, requestOptions).flatMap(FluxUtil::toMono);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> get(String cmapName) {
        // Generated convenience method for getWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getWithResponse(cmapName, requestOptions).flatMap(FluxUtil::toMono);
    }
