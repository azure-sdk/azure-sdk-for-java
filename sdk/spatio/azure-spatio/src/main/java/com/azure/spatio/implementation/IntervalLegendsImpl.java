...
/**
 * An instance of this class provides access to all the operations defined in IntervalLegends.
 */
public final class IntervalLegendsImpl {
    /**
     * The proxy service used to perform REST calls.
     */
    private final IntervalLegendsService service;
    ...
    /**
     * Initializes an instance of IntervalLegendsImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    IntervalLegendsImpl(MicrosoftPlanetaryComputerProClientImpl client) {
        this.service
            = RestProxy.create(IntervalLegendsService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }
    ...
    /**
     * The interface defining all the services for MicrosoftPlanetaryComputerProClientIntervalLegends to be used by the
     * proxy service to perform REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "MicrosoftPlanetaryCo")
    public interface IntervalLegendsService {
        @Get("/api/legend/interval/{classmapName}")
        @ExpectedResponses({ 204 })
        @UnexpectedResponseExceptionType(value = ClientAuthenticationException.class, code = { 401 })
        @UnexpectedResponseExceptionType(value = ResourceNotFoundException.class, code = { 404 })
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        @UnexpectedResponseExceptionType(HttpResponseException.class)
        Mono<Response<Void>> getByClassmapName(@HostParam("endpoint") String endpoint,
        ...
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        @UnexpectedResponseExceptionType(HttpResponseException.class)
        Response<Void> getByClassmapNameSync(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("classmapName") String classmapName,
            @HeaderParam("Accept") String accept, RequestOptions requestOptions, Context context);
    }
    ...
    public Mono<Response<Void>> getByClassmapNameWithResponseAsync(String classmapName, RequestOptions requestOptions) {
        final String accept = "application/json";
        return FluxUtil.withContext(context -> service.getByClassmapName(this.client.getEndpoint(),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<Void> getByClassmapNameWithResponse(String classmapName, RequestOptions requestOptions) {
        final String accept = "application/json";
        return service.getByClassmapNameSync(this.client.getEndpoint(), this.client.getServiceVersion().getVersion(),
