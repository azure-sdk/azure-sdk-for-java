...
/**
 * UserCollectionSettingsTODO: add description for UserCollectionSettings.
 */
@Immutable
public final class UserCollectionSettings implements JsonSerializable<UserCollectionSettings> {
    ...
    /**
     * Get the tileSettings property: TileSettingsTODO: add description for tileSettings.
     * 
    ...
    /**
     * Get the mosaicInfo property: MosaicInfoTODO: add description for mosaicInfo.
     * 
