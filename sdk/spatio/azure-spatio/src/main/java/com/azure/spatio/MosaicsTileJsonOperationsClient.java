...
import com.azure.spatio.implementation.MosaicsTileJsonOperationsImpl;
...
public final class MosaicsTileJsonOperationsClient {
    @Generated
    private final MosaicsTileJsonOperationsImpl serviceClient;

    /**
     * Initializes an instance of MosaicsTileJsonOperationsClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    MosaicsTileJsonOperationsClient(MosaicsTileJsonOperationsImpl serviceClient) {
     ...
     * <tr><td>tileScale</td><td>Integer</td><td>No</td><td>Tile size scale. 1=256x256, 2=512x512...</td></tr>
    ...
    public Response<BinaryData> getWithResponse(String searchid, RequestOptions requestOptions) {
        return this.serviceClient.getWithResponse(searchid, requestOptions);
    }
     ...
     * not (jpeg).
     * @param tileScale Tile size scale. 1=256x256, 2=512x512...
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public TileJson get(String searchid, Tilematrixsetid tileMatrixSetId, ImageType tileFormat, Integer tileScale,
        ...
        return getWithResponse(searchid, requestOptions).getValue().toObject(TileJson.class);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public TileJson get(String searchid) {
        // Generated convenience method for getWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getWithResponse(searchid, requestOptions).getValue().toObject(TileJson.class);
    }
