...
public final class RegisterSearchClient {
    @Generated
    private final RegisterSearchesImpl serviceClient;

    /**
     * Initializes an instance of RegisterSearchClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    RegisterSearchClient(RegisterSearchesImpl serviceClient) {
    ...
    public Response<BinaryData> registerWithResponse(BinaryData registerRequest, RequestOptions requestOptions) {
        return this.serviceClient.registerWithResponse(registerRequest, requestOptions);
    }
     ...
     * @return response model for /register endpoint.TODO: add description for RegisterResponse.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public RegisterResponse register(RegisterOptions options) {
        ...
        return registerWithResponse(registerRequest, requestOptions).getValue().toObject(RegisterResponse.class);
    }
}
