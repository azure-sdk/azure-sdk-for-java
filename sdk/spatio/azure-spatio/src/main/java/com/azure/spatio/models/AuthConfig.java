...
/**
 * Configuration for MSAL authentication in frontend application.TODO: add description for AuthConfig.
 */
@Immutable
public final class AuthConfig implements JsonSerializable<AuthConfig> {
    /*
     * Authn App IdTODO: add description for authnAppId
     */
    @Generated
    private final String authnAppId;

    /*
     * Tenant IdTODO: add description for tenantId
     */
    @Generated
    private final String tenantId;

    /*
     * InstanceTODO: add description for instance
     */
    @Generated
    private final String instance;

    /*
     * Redirect UriTODO: add description for redirectUri
     */
    @Generated
    ...
    /**
     * Get the authnAppId property: Authn App IdTODO: add description for authnAppId.
     * 
    ...
    /**
     * Get the tenantId property: Tenant IdTODO: add description for tenantId.
     * 
    ...
    /**
     * Get the instance property: InstanceTODO: add description for instance.
     * 
    ...
    /**
     * Get the redirectUri property: Redirect UriTODO: add description for redirectUri.
     * 
