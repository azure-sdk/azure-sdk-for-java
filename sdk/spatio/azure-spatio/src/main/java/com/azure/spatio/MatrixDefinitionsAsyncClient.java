...
public final class MatrixDefinitionsAsyncClient {
    @Generated
    private final MatrixDefinitionsImpl serviceClient;

    /**
     * Initializes an instance of MatrixDefinitionsAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    MatrixDefinitionsAsyncClient(MatrixDefinitionsImpl serviceClient) {
    ...
    public Mono<Response<BinaryData>> getWithResponse(String tileMatrixSetId, RequestOptions requestOptions) {
        return this.serviceClient.getWithResponseAsync(tileMatrixSetId, requestOptions);
    }
     ...
     * ref:
     * https://github.com/opengeospatial/2D-Tile-Matrix-Set/blob/master/schemas/tms/2.0/json/tileMatrixSet.jsonTODO: add
     * description for TileMatrixSet on successful completion of {@link Mono}.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<TileMatrixSet> get(String tileMatrixSetId) {
        // Generated convenience method for getWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getWithResponse(tileMatrixSetId, requestOptions).flatMap(FluxUtil::toMono)
