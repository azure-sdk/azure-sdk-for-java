...
/**
 * An instance of this class provides access to all the operations defined in Wmts.
 */
public final class WmtsImpl {
    /**
     * The proxy service used to perform REST calls.
     */
    private final WmtsService service;
    ...
    /**
     * Initializes an instance of WmtsImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    WmtsImpl(MicrosoftPlanetaryComputerProClientImpl client) {
        this.service = RestProxy.create(WmtsService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }
    ...
    /**
     * The interface defining all the services for MicrosoftPlanetaryComputerProClientWmts to be used by the proxy
     * service to perform REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "MicrosoftPlanetaryCo")
    public interface WmtsService {
        @Get("/api/collections/{collectionId}/items/{itemId}/WMTSCapabilities.xml")
