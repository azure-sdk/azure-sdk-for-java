...
/**
 * An instance of this class provides access to all the operations defined in TileJsonMosaicsTileMatrixSets.
 */
public final class TileJsonMosaicsTileMatrixSetsImpl {
    /**
     * The proxy service used to perform REST calls.
     */
    private final TileJsonMosaicsTileMatrixSetsService service;
    ...
    /**
     * Initializes an instance of TileJsonMosaicsTileMatrixSetsImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    TileJsonMosaicsTileMatrixSetsImpl(MicrosoftPlanetaryComputerProClientImpl client) {
        this.service = RestProxy.create(TileJsonMosaicsTileMatrixSetsService.class, client.getHttpPipeline(),
    ...
    /**
     * The interface defining all the services for MicrosoftPlanetaryComputerProClientTileJsonMosaicsTileMatrixSets to
     * be used by the proxy service to perform REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "MicrosoftPlanetaryCo")
    public interface TileJsonMosaicsTileMatrixSetsService {
        @Get("/api/mosaic/{searchid}/{tileMatrixSetId}/tilejson.json")
    ...
    public Mono<Response<BinaryData>> getWithResponseAsync(String tileMatrixSetId, String searchid,
