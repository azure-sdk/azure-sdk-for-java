...
public final class MosaicsTileJsonOperationsAsyncClient {
    @Generated
    private final MosaicsTileJsonOperationsImpl serviceClient;

    /**
     * Initializes an instance of MosaicsTileJsonOperationsAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    MosaicsTileJsonOperationsAsyncClient(MosaicsTileJsonOperationsImpl serviceClient) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<TileJson> get(String searchid, Tilematrixsetid tileMatrixSetId, ImageType tileFormat, Integer tileScale,
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<TileJson> get(String searchid) {
        // Generated convenience method for getWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getWithResponse(searchid, requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(TileJson.class));
