...
/**
 * An instance of this class provides access to all the operations defined in MosaicsTiles.
 */
public final class MosaicsTilesImpl {
    /**
     * The proxy service used to perform REST calls.
     */
    private final MosaicsTilesService service;
    ...
    /**
     * Initializes an instance of MosaicsTilesImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    MosaicsTilesImpl(MicrosoftPlanetaryComputerProClientImpl client) {
        this.service
            = RestProxy.create(MosaicsTilesService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }
    ...
    /**
     * The interface defining all the services for MicrosoftPlanetaryComputerProClientMosaicsTiles to be used by the
     * proxy service to perform REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "MicrosoftPlanetaryCo")
    public interface MosaicsTilesService {
        @Get("/api/mosaic/{searchid}/tiles/{z}/{x}/{y}@{scale}x.{format}")
        ...
        Mono<Response<BinaryData>> getZxyScalexFormat(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("scale") String scale,
        ...
        @Get("/api/mosaic/{searchid}/tiles/{z}/{x}/{y}@{scale}x")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(value = ClientAuthenticationException.class, code = { 401 })
        @UnexpectedResponseExceptionType(value = ResourceNotFoundException.class, code = { 404 })
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        ...
        @Get("/api/mosaic/{searchid}/tiles/{z}/{x}/{y}.{format}")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(value = ClientAuthenticationException.class, code = { 401 })
        @UnexpectedResponseExceptionType(value = ResourceNotFoundException.class, code = { 404 })
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
        ...
        Mono<Response<BinaryData>> getZxyFormat(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("format") String format,
            @PathParam("searchid") String searchid, @PathParam("z") String z, @PathParam("x") String x,
            @PathParam("y") String y, @HeaderParam("Accept") String accept, RequestOptions requestOptions,
            Context context);
        ...
        @Get("/api/mosaic/{searchid}/tiles/{z}/{x}/{y}")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(value = ClientAuthenticationException.class, code = { 401 })
        @UnexpectedResponseExceptionType(value = ResourceNotFoundException.class, code = { 404 })
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
    ...
    public Mono<Response<BinaryData>> getZxyScalexFormatWithResponseAsync(String scale, String format, String searchid,
        ...
        return FluxUtil.withContext(context -> service.getZxyScalexFormat(this.client.getEndpoint(),
            this.client.getServiceVersion().getVersion(), scale, format, searchid, z, x, y, accept, requestOptions,
            context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<BinaryData> getZxyScalexFormatWithResponse(String scale, String format, String searchid, String z,
        ...
        return service.getZxyScalexFormatSync(this.client.getEndpoint(), this.client.getServiceVersion().getVersion(),
            scale, format, searchid, z, x, y, accept, requestOptions, Context.NONE);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> getZxyScalexWithResponseAsync(String scale, String searchid, String z, String x,
        String y, String accept, RequestOptions requestOptions) {
        return FluxUtil.withContext(context -> service.getZxyScalex(this.client.getEndpoint(),
            this.client.getServiceVersion().getVersion(), scale, searchid, z, x, y, accept, requestOptions, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<BinaryData> getZxyScalexWithResponse(String scale, String searchid, String z, String x, String y,
        String accept, RequestOptions requestOptions) {
        return service.getZxyScalexSync(this.client.getEndpoint(), this.client.getServiceVersion().getVersion(), scale,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> getZxyFormatWithResponseAsync(String format, String searchid, String z, String x,
        String y, String accept, RequestOptions requestOptions) {
        return FluxUtil.withContext(context -> service.getZxyFormat(this.client.getEndpoint(),
            this.client.getServiceVersion().getVersion(), format, searchid, z, x, y, accept, requestOptions, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<BinaryData> getZxyFormatWithResponse(String format, String searchid, String z, String x, String y,
        String accept, RequestOptions requestOptions) {
        return service.getZxyFormatSync(this.client.getEndpoint(), this.client.getServiceVersion().getVersion(), format,
            searchid, z, x, y, accept, requestOptions, Context.NONE);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> getZxyWithResponseAsync(String searchid, String z, String x, String y,
        String accept, RequestOptions requestOptions) {
        return FluxUtil.withContext(context -> service.getZxy(this.client.getEndpoint(),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<BinaryData> getZxyWithResponse(String searchid, String z, String x, String y, String accept,
        RequestOptions requestOptions) {
        return service.getZxySync(this.client.getEndpoint(), this.client.getServiceVersion().getVersion(), searchid, z,
            x, y, accept, requestOptions, Context.NONE);
    }
}
