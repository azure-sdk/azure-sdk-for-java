...
/**
 * An instance of this class provides access to all the operations defined in AssetsForTileMatrixSets.
 */
public final class AssetsForTileMatrixSetsImpl {
    /**
     * The proxy service used to perform REST calls.
     */
    private final AssetsForTileMatrixSetsService service;
    ...
    /**
     * Initializes an instance of AssetsForTileMatrixSetsImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    AssetsForTileMatrixSetsImpl(MicrosoftPlanetaryComputerProClientImpl client) {
        this.service = RestProxy.create(AssetsForTileMatrixSetsService.class, client.getHttpPipeline(),
    ...
    /**
     * The interface defining all the services for MicrosoftPlanetaryComputerProClientAssetsForTileMatrixSets to be used
     * by the proxy service to perform REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "MicrosoftPlanetaryCo")
    public interface AssetsForTileMatrixSetsService {
        @Get("/api/mosaic/{searchid}/tiles/{tileMatrixSetId}/{z}/{x}/{y}/assets")
    ...
    public Mono<Response<BinaryData>> getZxyAssetsWithResponseAsync(String tileMatrixSetId, String searchid, String z,
        String x, String y, RequestOptions requestOptions) {
        final String accept = "application/json";
        return FluxUtil.withContext(
            context -> service.getZxyAssets(this.client.getEndpoint(), this.client.getServiceVersion().getVersion(),
