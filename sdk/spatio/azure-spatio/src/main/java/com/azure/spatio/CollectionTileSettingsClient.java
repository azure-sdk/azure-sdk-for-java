...
public final class CollectionTileSettingsClient {
    @Generated
    private final CollectionTileSettingsImpl serviceClient;

    /**
     * Initializes an instance of CollectionTileSettingsClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    CollectionTileSettingsClient(CollectionTileSettingsImpl serviceClient) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public TileSettings getAll(String collectionId) {
        // Generated convenience method for getAllWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getAllWithResponse(collectionId, requestOptions).getValue().toObject(TileSettings.class);
    }
     ...
     * @throws ResourceModifiedException thrown if the request is rejected by server on status code 409.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return tileSettingsTODO: add description for TileSettings.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public TileSettings createOrReplace(String collectionId, TileSettings body) {
