...
public final class TileMatrixSetsClient {
     ...
     */
    @Generated
    TileMatrixSetsClient(TileMatrixSetsImpl serviceClient) {
    ...
    public Response<BinaryData> getZxyScalexFormatWithResponse(String collectionId, String itemId,
        ...
        return this.serviceClient.getZxyScalexFormatWithResponse(collectionId, itemId, tileMatrixSetId, z, x, y, scale,
    ...
    public Response<BinaryData> getZxyScalexWithResponse(String collectionId, String itemId, String tileMatrixSetId,
        ...
        return this.serviceClient.getZxyScalexWithResponse(collectionId, itemId, tileMatrixSetId, z, x, y, scale,
    ...
    public Response<BinaryData> getZxyFormatWithResponse(String collectionId, String itemId, String tileMatrixSetId,
        ...
        return this.serviceClient.getZxyFormatWithResponse(collectionId, itemId, tileMatrixSetId, z, x, y, format,
            accept, requestOptions);
    }
    ...
    public Response<BinaryData> getZxyWithResponse(String collectionId, String itemId, String tileMatrixSetId, String z,
        ...
        return this.serviceClient.getZxyWithResponse(collectionId, itemId, tileMatrixSetId, z, x, y, accept,
            requestOptions);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public BinaryData getZxyScalexFormat(String collectionId, String itemId, Tilematrixsetid tileMatrixSetId, String z,
        String x, String y, String scale, ImageType format, String accept, Double buffer, String colorFormula,
        ...
        return getZxyScalexFormatWithResponse(collectionId, itemId, tileMatrixSetId.toString(), z, x, y, scale,
            format.toString(), accept, requestOptions).getValue();
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    public BinaryData getZxyScalexFormat(String collectionId, String itemId, Tilematrixsetid tileMatrixSetId, String z,
        String x, String y, String scale, ImageType format, String accept) {
        // Generated convenience method for getZxyScalexFormatWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getZxyScalexFormatWithResponse(collectionId, itemId, tileMatrixSetId.toString(), z, x, y, scale,
            format.toString(), accept, requestOptions).getValue();
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public BinaryData getZxyScalex(String collectionId, String itemId, Tilematrixsetid tileMatrixSetId, String z,
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public BinaryData getZxyFormat(String collectionId, String itemId, Tilematrixsetid tileMatrixSetId, String z,
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public BinaryData getZxy(String collectionId, String itemId, Tilematrixsetid tileMatrixSetId, String z, String x,
        String y, String accept, Integer scale, ImageType format, Double buffer, String colorFormula,
        List<String> assets, String expression, List<String> assetBidx, Boolean assetAsBand, String nodata,
        Boolean unscale, Resampling resampling, Algorithm algorithm, String algorithmParams, List<String> rescale,
        ColorMapNames colormapName, String colormap, Boolean returnMask, String subdatasetName,
        List<String> subdatasetBands) {
