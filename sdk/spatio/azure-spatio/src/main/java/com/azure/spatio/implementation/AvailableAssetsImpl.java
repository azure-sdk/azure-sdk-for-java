...
/**
 * An instance of this class provides access to all the operations defined in AvailableAssets.
 */
public final class AvailableAssetsImpl {
    /**
     * The proxy service used to perform REST calls.
     */
    private final AvailableAssetsService service;
    ...
    /**
     * Initializes an instance of AvailableAssetsImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    AvailableAssetsImpl(MicrosoftPlanetaryComputerProClientImpl client) {
        this.service
            = RestProxy.create(AvailableAssetsService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }
    ...
    /**
     * The interface defining all the services for MicrosoftPlanetaryComputerProClientAvailableAssets to be used by the
     * proxy service to perform REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "MicrosoftPlanetaryCo")
    public interface AvailableAssetsService {
        @Get("/api/collections/{collectionId}/items/{itemId}/assets")
