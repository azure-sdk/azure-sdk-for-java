...
/**
 * An instance of this class provides access to all the operations defined in AuthConfigOperations.
 */
public final class AuthConfigOperationsImpl {
    /**
     * The proxy service used to perform REST calls.
     */
    private final AuthConfigOperationsService service;
    ...
    /**
     * Initializes an instance of AuthConfigOperationsImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    AuthConfigOperationsImpl(MicrosoftPlanetaryComputerProClientImpl client) {
        this.service = RestProxy.create(AuthConfigOperationsService.class, client.getHttpPipeline(),
    ...
    /**
     * The interface defining all the services for MicrosoftPlanetaryComputerProClientAuthConfigOperations to be used by
     * the proxy service to perform REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "MicrosoftPlanetaryCo")
    public interface AuthConfigOperationsService {
        @Get("/api/config/auth")
