...
public final class StatisticsClient {
    ...
    /**
     * Initializes an instance of StatisticsClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    StatisticsClient(StatisticsImpl serviceClient) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Map<String, BandStatistics> getAll(String collectionId, String itemId, List<String> assets,
        ...
        return getAllWithResponse(collectionId, itemId, requestOptions).getValue()
            .toObject(TYPE_REFERENCE_MAP_STRING_BAND_STATISTICS);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Map<String, BandStatistics> getAll(String collectionId, String itemId) {
        // Generated convenience method for getAllWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getAllWithResponse(collectionId, itemId, requestOptions).getValue()
            .toObject(TYPE_REFERENCE_MAP_STRING_BAND_STATISTICS);
