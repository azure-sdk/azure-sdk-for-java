...
public final class InfoGeoJsonOperationsClient {
    @Generated
    private final InfoGeoJsonOperationsImpl serviceClient;

    /**
     * Initializes an instance of InfoGeoJsonOperationsClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    InfoGeoJsonOperationsClient(InfoGeoJsonOperationsImpl serviceClient) {
     ...
     * @return feature ModelTODO: add description for FeaturePolygonDictStrRioTilerModelsInfo.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public FeaturePolygonDictStrRioTilerModelsInfo get(String collectionId, String itemId, List<String> assets) {
        ...
        return getWithResponse(collectionId, itemId, requestOptions).getValue()
            .toObject(FeaturePolygonDictStrRioTilerModelsInfo.class);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public FeaturePolygonDictStrRioTilerModelsInfo get(String collectionId, String itemId) {
        // Generated convenience method for getWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getWithResponse(collectionId, itemId, requestOptions).getValue()
            .toObject(FeaturePolygonDictStrRioTilerModelsInfo.class);
