...
public final class IacTemplateProperties implements JsonSerializable<IacTemplateProperties> {
    ...
    /**
     * Set the quickStartTemplateType property: Determines the authorization status of requests.
     * 
     * @param quickStartTemplateType the quickStartTemplateType value to set.
     * @return the IacTemplateProperties object itself.
     */
    public IacTemplateProperties withQuickStartTemplateType(QuickStartTemplateType quickStartTemplateType) {
