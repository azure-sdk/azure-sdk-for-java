...
public final class DevHubManager {
    ...
    private DevHubManager(HttpPipeline httpPipeline, AzureProfile profile, Duration defaultPollInterval) {
        Objects.requireNonNull(httpPipeline, "'httpPipeline' cannot be null.");
        Objects.requireNonNull(profile, "'profile' cannot be null.");
        this.clientObject = new DeveloperHubServiceClientBuilder().pipeline(httpPipeline)
    ...
    public static DevHubManager authenticate(HttpPipeline httpPipeline, AzureProfile profile) {
        Objects.requireNonNull(httpPipeline, "'httpPipeline' cannot be null.");
        Objects.requireNonNull(profile, "'profile' cannot be null.");
        return new DevHubManager(httpPipeline, profile, null);
    }
    ...
    public static final class Configurable {
         ...
         * @return the DevHub service API instance.
         */
        public DevHubManager authenticate(TokenCredential credential, AzureProfile profile) {
            Objects.requireNonNull(credential, "'credential' cannot be null.");
            Objects.requireNonNull(profile, "'profile' cannot be null.");
