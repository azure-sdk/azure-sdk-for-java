...
public final class GitHubWorkflowProfile implements JsonSerializable<GitHubWorkflowProfile> {
     ...
     */
    private Deployment deploymentProperties;
    ...
    /**
     * Get the deploymentProperties property: Deployment details of the repository associated with the workflow.
     * 
     * @return the deploymentProperties value.
     */
    public Deployment deploymentProperties() {
        return this.deploymentProperties;
    }

    /**
     * Set the deploymentProperties property: Deployment details of the repository associated with the workflow.
     * 
     * @param deploymentProperties the deploymentProperties value to set.
     * @return the GitHubWorkflowProfile object itself.
     */
    public GitHubWorkflowProfile withDeploymentProperties(Deployment deploymentProperties) {
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("repositoryOwner".equals(fieldName)) {
                    ...
                    deserializedGitHubWorkflowProfile.deploymentProperties = Deployment.fromJson(reader);
