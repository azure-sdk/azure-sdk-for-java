...
public final class IacProfileImpl implements IacProfile, IacProfile.Definition, IacProfile.Update {
    ...
    public Response<PrLinkResponse> quickTemplateWithResponse(QuickTemplateRequest parameters, Context context) {
        return serviceManager.iacProfiles()
            .quickTemplateWithResponse(resourceGroupName, iacProfileName, parameters, context);
    }

    public PrLinkResponse quickTemplate(QuickTemplateRequest parameters) {
        return serviceManager.iacProfiles().quickTemplate(resourceGroupName, iacProfileName, parameters);
    }
    ...
    public IacProfileImpl withVersion(String version) {
