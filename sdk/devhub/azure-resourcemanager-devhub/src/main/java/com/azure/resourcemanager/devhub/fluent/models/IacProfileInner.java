    ...
    public void validate() {
        ...
        if (location() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Missing required property location in model IacProfileInner"));
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(IacProfileInner.class);
