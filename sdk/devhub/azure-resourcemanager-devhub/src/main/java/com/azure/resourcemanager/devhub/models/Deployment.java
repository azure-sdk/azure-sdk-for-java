...
public final class Deployment implements JsonSerializable<Deployment> {
     ...
     */
    public Deployment withManifestType(ManifestType manifestType) {
     ...
     * @return the Deployment object itself.
     */
    public Deployment withKubeManifestLocations(List<String> kubeManifestLocations) {
     ...
     * @return the Deployment object itself.
     */
    public Deployment withHelmChartPath(String helmChartPath) {
     ...
     * @return the Deployment object itself.
     */
    public Deployment withHelmValues(String helmValues) {
     ...
     * @return the Deployment object itself.
     */
    public Deployment withOverrides(Map<String, String> overrides) {
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("manifestType".equals(fieldName)) {
                    deserializedDeployment.manifestType = ManifestType.fromString(reader.getString());
                    ...
                    deserializedDeployment.kubeManifestLocations = kubeManifestLocations;
                } else if ("helmChartPath".equals(fieldName)) {
                    deserializedDeployment.helmChartPath = reader.getString();
                } else if ("helmValues".equals(fieldName)) {
                    deserializedDeployment.helmValues = reader.getString();
                } else if ("overrides".equals(fieldName)) {
                    Map<String, String> overrides = reader.readMap(reader1 -> reader1.getString());
                    deserializedDeployment.overrides = overrides;
                } else {
                    reader.skipChildren();
                }
            }
