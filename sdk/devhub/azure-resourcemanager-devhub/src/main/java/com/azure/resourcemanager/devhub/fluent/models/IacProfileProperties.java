...
public final class IacProfileProperties implements JsonSerializable<IacProfileProperties> {
    ...
    /**
     * Get the version property: The version of the profile.
     * 
    ...
    /**
     * Set the version property: The version of the profile.
     * 
     * @param version the version value to set.
     * @return the IacProfileProperties object itself.
     */
    public IacProfileProperties withVersion(String version) {
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("githubProfile".equals(fieldName)) {
                    ...
                    deserializedIacProfileProperties.version = reader.getString();
                } else {
                    reader.skipChildren();
                }
            }
