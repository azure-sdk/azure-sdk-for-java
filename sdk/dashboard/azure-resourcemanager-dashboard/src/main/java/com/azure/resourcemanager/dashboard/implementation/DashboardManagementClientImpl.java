...
public final class DashboardManagementClientImpl implements DashboardManagementClient {
     ...
     */
    DashboardManagementClientImpl(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter,
    ...
    private static final ClientLogger LOGGER = new ClientLogger(DashboardManagementClientImpl.class);
}
