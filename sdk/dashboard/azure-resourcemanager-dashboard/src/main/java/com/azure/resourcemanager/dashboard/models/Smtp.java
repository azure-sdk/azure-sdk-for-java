...
public final class Smtp {
    ...
    /*
     * Password of SMTP auth. If the password contains # or ;, then you have to wrap it with triple quotes. Example:
     * """#password;"""
     */
     ...
     * triple quotes. Example: """#password;""".
     *
     ...
     * Notification" https://pkg.go.dev/net/mail#Address.
     *
