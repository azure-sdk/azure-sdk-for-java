...
public final class VirtualMachineScaleSetManagedDiskParametersTests {
    ...
    public void testDeserialize() throws Exception {
        VirtualMachineScaleSetManagedDiskParameters model = BinaryData.fromString(
            "{\"storageAccountType\":\"Standard_LRS\",\"diskEncryptionSet\":{\"id\":\"e\"},\"securityProfile\":{\"securityEncryptionType\":\"DiskWithVMGuestState\",\"diskEncryptionSet\":{\"id\":\"xxhejjzzvd\"}}}")
        ...
        Assertions.assertEquals("e", model.diskEncryptionSet().id());
        Assertions.assertEquals(SecurityEncryptionTypes.DISK_WITH_VMGUEST_STATE,
            model.securityProfile().securityEncryptionType());
        Assertions.assertEquals("xxhejjzzvd", model.securityProfile().diskEncryptionSet().id());
    }
        ...
        VirtualMachineScaleSetManagedDiskParameters model
            = new VirtualMachineScaleSetManagedDiskParameters().withStorageAccountType(StorageAccountTypes.STANDARD_LRS)
                ...
                .withSecurityProfile(new VMDiskSecurityProfile()
                    ...
                    .withDiskEncryptionSet(new DiskEncryptionSetParameters().withId("xxhejjzzvd")));
