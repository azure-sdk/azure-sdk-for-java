...
public final class WinRMListenerTests {
    ...
    public void testDeserialize() throws Exception {
        WinRMListener model = BinaryData.fromString("{\"protocol\":\"Http\",\"certificateUrl\":\"ljjgpbtoqcjmkl\"}")
            .toObject(WinRMListener.class);
        Assertions.assertEquals(ProtocolTypes.HTTP, model.protocol());
        Assertions.assertEquals("ljjgpbtoqcjmkl", model.certificateUrl());
    }

    @org.junit.jupiter.api.Test
    public void testSerialize() throws Exception {
        WinRMListener model = new WinRMListener().withProtocol(ProtocolTypes.HTTP).withCertificateUrl("ljjgpbtoqcjmkl");
