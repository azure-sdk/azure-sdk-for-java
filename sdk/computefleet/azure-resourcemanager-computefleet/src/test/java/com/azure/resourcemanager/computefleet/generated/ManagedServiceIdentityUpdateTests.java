...
public final class ManagedServiceIdentityUpdateTests {
    ...
    public void testDeserialize() throws Exception {
        ManagedServiceIdentityUpdate model = BinaryData.fromString(
            "{\"type\":\"UserAssigned\",\"userAssignedIdentities\":{\"u\":{\"principalId\":\"rmfqjhhkxbpvj\",\"clientId\":\"jhxxjyn\"},\"j\":{\"principalId\":\"vkr\",\"clientId\":\"wbxqzvszjfau\"},\"lqbhsf\":{\"principalId\":\"xxivetv\",\"clientId\":\"qaqtdoqmcbxvwvxy\"}}}")
    ...
    public void testSerialize() throws Exception {
        ManagedServiceIdentityUpdate model
            = new ManagedServiceIdentityUpdate().withType(ManagedServiceIdentityType.USER_ASSIGNED)
                .withUserAssignedIdentities(mapOf("u", new UserAssignedIdentity(), "j", new UserAssignedIdentity(),
                    "lqbhsf", new UserAssignedIdentity()));
