...
public final class OSImageNotificationProfileTests {
    ...
    public void testDeserialize() throws Exception {
        OSImageNotificationProfile model = BinaryData.fromString("{\"notBeforeTimeout\":\"wpr\",\"enable\":false}")
            .toObject(OSImageNotificationProfile.class);
        Assertions.assertEquals("wpr", model.notBeforeTimeout());
    ...
    public void testSerialize() throws Exception {
        OSImageNotificationProfile model
            = new OSImageNotificationProfile().withNotBeforeTimeout("wpr").withEnable(false);
