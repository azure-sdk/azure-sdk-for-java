...
public final class OSImageNotificationProfileTests {
    ...
    public void testDeserialize() throws Exception {
        OSImageNotificationProfile model = BinaryData.fromString("{\"notBeforeTimeout\":\"yhz\",\"enable\":false}")
            .toObject(OSImageNotificationProfile.class);
        Assertions.assertEquals("yhz", model.notBeforeTimeout());
    ...
    public void testSerialize() throws Exception {
        OSImageNotificationProfile model
            = new OSImageNotificationProfile().withNotBeforeTimeout("yhz").withEnable(false);
