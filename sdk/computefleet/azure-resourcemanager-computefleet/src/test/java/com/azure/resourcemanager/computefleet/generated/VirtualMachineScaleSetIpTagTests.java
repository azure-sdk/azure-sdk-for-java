...
public final class VirtualMachineScaleSetIpTagTests {
    ...
    public void testDeserialize() throws Exception {
        VirtualMachineScaleSetIpTag model
            = BinaryData.fromString("{\"ipTagType\":\"vlvqhjkbegi\",\"tag\":\"nmxiebwwaloayqc\"}")
                .toObject(VirtualMachineScaleSetIpTag.class);
        Assertions.assertEquals("vlvqhjkbegi", model.ipTagType());
        Assertions.assertEquals("nmxiebwwaloayqc", model.tag());
    }

    @org.junit.jupiter.api.Test
    public void testSerialize() throws Exception {
        VirtualMachineScaleSetIpTag model
            = new VirtualMachineScaleSetIpTag().withIpTagType("vlvqhjkbegi").withTag("nmxiebwwaloayqc");
