...
public final class VMAttributes implements JsonSerializable<VMAttributes> {
    ...
    /*
     * The accelerator manufacturers specified as a list. acceleratorSupport should be set to Included or Required to
     * use this VMAttribute.
     */
    private List<AcceleratorManufacturer> acceleratorManufacturers;

    /*
     * The accelerator types specified as a list. acceleratorSupport should be set to Included or Required to use this
     * VMAttribute.
     */
    ...
    /**
     * Get the localStorageInGiB property: The range of local storage in GB specified from Min to Max.
     * 
    ...
    /**
     * Set the localStorageInGiB property: The range of local storage in GB specified from Min to Max.
     * 
    ...
    /**
     * Get the acceleratorManufacturers property: The accelerator manufacturers specified as a list. acceleratorSupport
     * should be set to Included or Required to use this VMAttribute.
     * 
    ...
    /**
     * Set the acceleratorManufacturers property: The accelerator manufacturers specified as a list. acceleratorSupport
     * should be set to Included or Required to use this VMAttribute.
     * 
