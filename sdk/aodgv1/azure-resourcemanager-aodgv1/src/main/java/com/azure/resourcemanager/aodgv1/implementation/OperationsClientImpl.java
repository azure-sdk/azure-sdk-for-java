...
import com.azure.resourcemanager.aodgv1.models.OperationListResult;
...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    OperationsClientImpl(AzureOrbitalImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for AzureOrbitalOperations to be used by the proxy service to perform
     * REST calls.
     */
    @Host("{$host}")
    ...
    public interface OperationsService {
        ...
        @Get("/providers/Microsoft.Orbital/operations")
