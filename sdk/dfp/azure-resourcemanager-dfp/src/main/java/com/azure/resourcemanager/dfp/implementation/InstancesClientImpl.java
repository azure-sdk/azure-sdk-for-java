...
public final class InstancesClientImpl implements InstancesClient {
    ...
    public interface InstancesService {
        ...
        Mono<Response<DfpInstanceInner>> getByResourceGroup(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<DfpInstances>> listByResourceGroup(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<DfpInstances>> list(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<DfpInstances>> listNext(@PathParam(value = "nextLink", encoded = true) String nextLink,
    ...
    private Mono<Response<DfpInstanceInner>> getByResourceGroupWithResponseAsync(String resourceGroupName,
        String instanceName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<DfpInstanceInner> getByResourceGroupWithResponse(String resourceGroupName, String instanceName,
        Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> createWithResponseAsync(String resourceGroupName, String instanceName,
    ...
    private PollerFlux<PollResult<DfpInstanceInner>, DfpInstanceInner> beginCreateAsync(String resourceGroupName,
        ...
        return this.client.<DfpInstanceInner, DfpInstanceInner>getLroResult(mono, this.client.getHttpPipeline(),
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<DfpInstanceInner>, DfpInstanceInner> beginCreate(String resourceGroupName,
        String instanceName, DfpInstanceInner instanceParameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DfpInstanceInner> createAsync(String resourceGroupName, String instanceName,
        DfpInstanceInner instanceParameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<DfpInstanceInner>, DfpInstanceInner> beginUpdateAsync(String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<DfpInstanceInner>, DfpInstanceInner> beginUpdate(String resourceGroupName,
        String instanceName, DfpInstanceUpdateParameters instanceUpdateParameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DfpInstanceInner> updateAsync(String resourceGroupName, String instanceName,
        DfpInstanceUpdateParameters instanceUpdateParameters) {
    ...
    private Mono<PagedResponse<DfpInstanceInner>> listByResourceGroupSinglePageAsync(String resourceGroupName) {
        ...
        return FluxUtil
            .withContext(context -> service.listByResourceGroup(this.client.getEndpoint(), resourceGroupName,
                this.client.getApiVersion(), this.client.getSubscriptionId(), accept, context))
            .<PagedResponse<DfpInstanceInner>>map(res -> new PagedResponseBase<>(res.getRequest(), res.getStatusCode(),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<CheckInstanceNameAvailabilityResultInner> checkNameAvailabilityAsync(String location,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<CheckInstanceNameAvailabilityResultInner> checkNameAvailabilityWithResponse(String location,
