...
public interface InstancesClient {
    ...
    Response<DfpInstanceInner> getByResourceGroupWithResponse(String resourceGroupName, String instanceName,
        Context context);
    ...
    SyncPoller<PollResult<DfpInstanceInner>, DfpInstanceInner> beginCreate(String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<DfpInstanceInner>, DfpInstanceInner> beginUpdate(String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<CheckInstanceNameAvailabilityResultInner> checkNameAvailabilityWithResponse(String location,
