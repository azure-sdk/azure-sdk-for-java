...
public final class InstancesImpl implements Instances {
    ...
    public Response<DfpInstance> getByResourceGroupWithResponse(String resourceGroupName, String instanceName,
        Context context) {
    ...
    public Response<CheckInstanceNameAvailabilityResult> checkNameAvailabilityWithResponse(String location,
