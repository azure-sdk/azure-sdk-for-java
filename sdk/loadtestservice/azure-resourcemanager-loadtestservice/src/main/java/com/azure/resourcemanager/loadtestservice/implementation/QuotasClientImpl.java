...
public final class QuotasClientImpl implements QuotasClient {
     ...
     * @return a list of Quota Bucket details along with {@link PagedResponse} on successful completion of {@link Mono}.
     */
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a list of Quota Bucket details as paginated response with {@link PagedFlux}.
     */
    ...
    public QuotaResourceInner get(String location, String quotaBucketName) {
        return getAsync(location, quotaBucketName).block();
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return check Quota Availability Response along with {@link Response} on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return check Quota Availability Response on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ...
    public CheckQuotaAvailabilityResponseInner checkAvailability(
        String location, String quotaBucketName, QuotaBucketRequest quotaBucketRequest) {
        return checkAvailabilityAsync(location, quotaBucketName, quotaBucketRequest).block();
    }
