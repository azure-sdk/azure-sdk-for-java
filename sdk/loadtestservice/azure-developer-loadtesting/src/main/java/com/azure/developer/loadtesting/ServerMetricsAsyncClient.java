...
public final class ServerMetricsAsyncClient {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> getDefaultMetricsWithResponse(RequestOptions requestOptions) {
        return this.serviceClient.getDefaultMetricsWithResponseAsync(requestOptions);
    }
