...
public final class TestRunClient {
    ...
    public Response<BinaryData> metricNamespacesWithResponse(String testRunId, RequestOptions requestOptions) {
        return this.client.metricNamespacesWithResponse(testRunId, requestOptions).block();
    }
    ...
    public Response<BinaryData> metricDefinitionsWithResponse(
        ...
        return this.client.metricDefinitionsWithResponse(testRunId, metricnamespace, requestOptions).block();
    }
    ...
    public Response<BinaryData> metricsWithResponse(
        ...
        return this.client
                .metricsWithResponse(testRunId, metricname, metricnamespace, resultType, timespan, requestOptions)
                .block();
    }
}
