...
public final class TestRunsImpl {
    ...
    private interface TestRunsService {
        ...
        @Get("/testRuns/{testRunId}/metricNamespaces")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(
                value = ClientAuthenticationException.class,
                code = {401})
        ...
        @UnexpectedResponseExceptionType(
                ...
                code = {409})
        @UnexpectedResponseExceptionType(HttpResponseException.class)
        Mono<Response<BinaryData>> metricNamespaces(
                @HostParam("Endpoint") String endpoint,
                @PathParam("testRunId") String testRunId,
                @QueryParam("api-version") String apiVersion,
                @HeaderParam("Accept") String accept,
        ...
        @Get("/testRuns/{testRunId}/metricDefinitions")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(
                value = ClientAuthenticationException.class,
                code = {401})
        ...
        @UnexpectedResponseExceptionType(
                ...
                code = {409})
        @UnexpectedResponseExceptionType(HttpResponseException.class)
        Mono<Response<BinaryData>> metricDefinitions(
                @HostParam("Endpoint") String endpoint,
                @PathParam("testRunId") String testRunId,
        ...
        @Post("/testRuns/{testRunId}/metrics")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(
                value = ClientAuthenticationException.class,
                code = {401})
        ...
        @UnexpectedResponseExceptionType(
                ...
                code = {409})
        @UnexpectedResponseExceptionType(HttpResponseException.class)
        Mono<Response<BinaryData>> metrics(
                @HostParam("Endpoint") String endpoint,
                @PathParam("testRunId") String testRunId,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> metricNamespacesWithResponseAsync(
            String testRunId, RequestOptions requestOptions) {
        final String accept = "application/json";
        return FluxUtil.withContext(
                context ->
                        service.metricNamespaces(
                                this.client.getEndpoint(),
                                testRunId,
                                this.client.getServiceVersion().getVersion(),
                                accept,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<BinaryData> metricNamespacesWithResponse(String testRunId, RequestOptions requestOptions) {
        return metricNamespacesWithResponseAsync(testRunId, requestOptions).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> metricDefinitionsWithResponseAsync(
            String testRunId, String metricnamespace, RequestOptions requestOptions) {
        final String accept = "application/json";
        return FluxUtil.withContext(
                context ->
                        service.metricDefinitions(
                                this.client.getEndpoint(),
                                testRunId,
                                metricnamespace,
                                this.client.getServiceVersion().getVersion(),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<BinaryData> metricDefinitionsWithResponse(
            String testRunId, String metricnamespace, RequestOptions requestOptions) {
        return metricDefinitionsWithResponseAsync(testRunId, metricnamespace, requestOptions).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> metricsWithResponseAsync(
            String testRunId,
            String metricname,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<BinaryData> metricsWithResponse(
            String testRunId,
            String metricname,
            String metricnamespace,
            String resultType,
            String timespan,
            RequestOptions requestOptions) {
        return metricsWithResponseAsync(testRunId, metricname, metricnamespace, resultType, timespan, requestOptions)
                .block();
    }
