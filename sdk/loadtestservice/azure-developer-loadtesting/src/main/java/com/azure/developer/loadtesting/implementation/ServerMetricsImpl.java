...
public final class ServerMetricsImpl {
    ...
    private interface ServerMetricsService {
        ...
        @UnexpectedResponseExceptionType(
                ...
                code = {409})
        @UnexpectedResponseExceptionType(HttpResponseException.class)
        Mono<Response<BinaryData>> getByTestOrTestRun(
                @HostParam("Endpoint") String endpoint,
        ...
        @UnexpectedResponseExceptionType(
                ...
                code = {409})
        @UnexpectedResponseExceptionType(HttpResponseException.class)
        Mono<Response<BinaryData>> getDefaultMetrics(
                @HostParam("Endpoint") String endpoint,
                @QueryParam("api-version") String apiVersion,
                @HeaderParam("Accept") String accept,
                RequestOptions requestOptions,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> getByTestOrTestRunWithResponseAsync(RequestOptions requestOptions) {
        final String accept = "application/json";
        return FluxUtil.withContext(
                context ->
                        service.getByTestOrTestRun(
                                this.client.getEndpoint(),
    ...
    public Response<BinaryData> getByTestOrTestRunWithResponse(RequestOptions requestOptions) {
        return getByTestOrTestRunWithResponseAsync(requestOptions).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> getDefaultMetricsWithResponseAsync(RequestOptions requestOptions) {
        final String accept = "application/json";
        return FluxUtil.withContext(
                context ->
                        service.getDefaultMetrics(
                                this.client.getEndpoint(),
                                this.client.getServiceVersion().getVersion(),
                                accept,
                                requestOptions,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<BinaryData> getDefaultMetricsWithResponse(RequestOptions requestOptions) {
        return getDefaultMetricsWithResponseAsync(requestOptions).block();
    }
