...
public final class LoadTestingClientImpl {
    ...
    /**
     * Gets Unique name of an existing load test.
     *
     ...
     */
    public LoadTestingClientImpl(String testId, String endpoint, LoadTestingServiceVersion serviceVersion) {
        this(
    ...
    public LoadTestingClientImpl(
            HttpPipeline httpPipeline, String testId, String endpoint, LoadTestingServiceVersion serviceVersion) {
        this(httpPipeline, JacksonAdapter.createDefaultSerializerAdapter(), testId, endpoint, serviceVersion);
    }
