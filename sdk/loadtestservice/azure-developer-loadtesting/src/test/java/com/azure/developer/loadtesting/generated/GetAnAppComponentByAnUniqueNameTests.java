...
public final class GetAnAppComponentByAnUniqueNameTests extends LoadTestingClientTestBase {
    @Test
    @Disabled
    public void testGetAnAppComponentByAnUniqueNameTests() {
        RequestOptions requestOptions = new RequestOptions();
        Response<BinaryData> response =
                appComponentClient.getWithResponse("ee843bd9-a6d4-4364-a45c-427a03c39fa7", requestOptions);
