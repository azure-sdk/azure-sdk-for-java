...
public class CreateOrUpdateATest {
    public static void main(String[] args) {
        TestClient testClient =
                new TestClientBuilder()
                        ...
                        .buildClient();
        // BEGIN:com.azure.developer.loadtesting.generated.testcreateorupdate.createorupdateatest
        BinaryData body =
        ...
        Response<BinaryData> response =
                testClient.createOrUpdateWithResponse("12345678-1234-1234-1234-123456789012", body, requestOptions);
        // END:com.azure.developer.loadtesting.generated.testcreateorupdate.createorupdateatest
    }
}
