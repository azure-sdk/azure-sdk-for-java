...
public class GetATestByAnUniqueName {
    public static void main(String[] args) {
        TestClient testClient =
                new TestClientBuilder()
                        ...
                        .buildClient();
        // BEGIN:com.azure.developer.loadtesting.generated.testget.getatestbyanuniquename
        RequestOptions requestOptions = new RequestOptions();
        Response<BinaryData> response =
                testClient.getWithResponse("12345678-1234-1234-1234-123456789012", requestOptions);
        // END:com.azure.developer.loadtesting.generated.testget.getatestbyanuniquename
    }
}
