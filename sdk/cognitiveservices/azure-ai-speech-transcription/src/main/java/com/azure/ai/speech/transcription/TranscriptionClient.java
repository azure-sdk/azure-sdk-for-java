...
import com.azure.ai.speech.transcription.implementation.models.TranscribeRequest;
...
public final class TranscriptionClient {
     ...
     * @param definition Metadata for a transcription request. This field contains a JSON-serialized object of type
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public TranscriptionResult transcribe(AudioFileDetails audio, TranscriptionOptions definition) {
        ...
        BinaryData transcribeRequest = new MultipartFormDataHelper(requestOptions)
            ...
            .end()
            .getRequestBody();
        return transcribeWithResponse(transcribeRequest, requestOptions).getValue().toObject(TranscriptionResult.class);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public TranscriptionResult transcribe(AudioFileDetails audio) {
        // Generated convenience method for transcribeWithResponse
        RequestOptions requestOptions = new RequestOptions();
