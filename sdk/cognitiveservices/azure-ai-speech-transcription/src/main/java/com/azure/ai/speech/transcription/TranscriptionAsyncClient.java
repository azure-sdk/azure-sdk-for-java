...
public final class TranscriptionAsyncClient {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<TranscriptionResult> transcribe(AudioFileDetails audio, TranscriptionOptions definition) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<TranscriptionResult> transcribe(AudioFileDetails audio) {
        // Generated convenience method for transcribeWithResponse
        RequestOptions requestOptions = new RequestOptions();
