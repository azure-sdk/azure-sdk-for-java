...
public final class TranscriptionOptions implements JsonSerializable<TranscriptionOptions> {
     ...
     */
    @Generated
    private TranscriptionDiarizationOptions diarizationProperties;
     ...
     */
    @Generated
    public TranscriptionDiarizationOptions getDiarizationProperties() {
     ...
     */
    @Generated
    public TranscriptionOptions setDiarizationProperties(TranscriptionDiarizationOptions diarizationProperties) {
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("locales".equals(fieldName)) {
                    ...
                    deserializedTranscriptionOptions.diarizationProperties
