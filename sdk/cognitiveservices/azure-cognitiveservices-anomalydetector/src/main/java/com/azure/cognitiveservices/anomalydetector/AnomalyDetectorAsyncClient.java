...
public final class AnomalyDetectorAsyncClient {
    ...
    public Mono<Response<BinaryData>> breakingChangeDetectEntireSeriesWithResponse(
            BinaryData body, RequestOptions requestOptions) {
        return this.serviceClient.breakingChangeDetectEntireSeriesWithResponseAsync(body, requestOptions);
    }
