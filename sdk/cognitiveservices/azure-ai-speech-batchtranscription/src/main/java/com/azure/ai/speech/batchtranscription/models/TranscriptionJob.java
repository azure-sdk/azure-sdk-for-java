...
public final class TranscriptionJob implements JsonSerializable<TranscriptionJob> {
    ...
    /**
     * Get the sourceContainerUrl property: A URL for an Azure blob container that contains the audio files. A container
     * is allowed to have a maximum size of 5GB and a maximum number of 10000 blobs.
     * The maximum size for a blob is 2.5GB.
     * Container SAS should contain 'r' (read) and 'l' (list) permissions.
     * This property will not be returned in a response.
     * 
     * @return the sourceContainerUrl value.
     */
    @Generated
    public String getSourceContainerUrl() {
        return this.sourceContainerUrl;
    }

    /**
     * Set the sourceContainerUrl property: A URL for an Azure blob container that contains the audio files. A container
     * is allowed to have a maximum size of 5GB and a maximum number of 10000 blobs.
     * The maximum size for a blob is 2.5GB.
     * Container SAS should contain 'r' (read) and 'l' (list) permissions.
     * This property will not be returned in a response.
     * 
     * @param sourceContainerUrl the sourceContainerUrl value to set.
     * @return the TranscriptionJob object itself.
     */
    @Generated
    public TranscriptionJob setSourceContainerUrl(String sourceContainerUrl) {
    ...
    /**
     * Get the created property: The time-stamp when the object was created.
     * The time stamp is encoded as ISO 8601 date and time format
     * ("YYYY-MM-DDThh:mm:ssZ", see https://en.wikipedia.org/wiki/ISO_8601#Combined_date_and_time_representations).
     * 
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeStringField("contentContainerUrl", this.sourceContainerUrl);
    ...
    public static TranscriptionJob fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            String sourceContainerUrl = null;
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("properties".equals(fieldName)) {
                    ...
                    contents = reader.readArray(reader1 -> reader1.getString());
                } else if ("contentContainerUrl".equals(fieldName)) {
                    sourceContainerUrl = reader.getString();
            ...
            deserializedTranscriptionJob.sourceContainerUrl = sourceContainerUrl;
            ...
            deserializedTranscriptionJob.created = created;
