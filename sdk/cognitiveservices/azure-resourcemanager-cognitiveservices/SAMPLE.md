...
public final class AccountsUpdateSamples {
    ...
    public static void updateAccount(com.azure.resourcemanager.cognitiveservices.CognitiveServicesManager manager) {
        Account resource = manager.accounts()
            .getByResourceGroupWithResponse("bvttest", "bingSearch", com.azure.core.util.Context.NONE).getValue();
...
public final class CommitmentPlansCreateOrUpdateSamples {
    ...
    public static void putCommitmentPlan(com.azure.resourcemanager.cognitiveservices.CognitiveServicesManager manager) {
        manager.commitmentPlans().createOrUpdateWithResponse("resourceGroupName", "accountName", "commitmentPlanName",
            new CommitmentPlanInner().withProperties(new CommitmentPlanProperties().withHostingModel(HostingModel.WEB)
                .withPlanType("Speech2Text").withCurrent(new CommitmentPeriod().withTier("T1")).withAutoRenew(true)),
            com.azure.core.util.Context.NONE);
    }
}
```
...
public final class DeploymentsCreateOrUpdateSamples {
    ...
    public static void putDeployment(com.azure.resourcemanager.cognitiveservices.CognitiveServicesManager manager) {
        manager.deployments().define("deploymentName").withExistingAccount("resourceGroupName", "accountName")
            .withSku(new Sku().withName("Standard").withCapacity(1)).withProperties(new DeploymentProperties()
...
public final class RaiPoliciesCreateOrUpdateSamples {
    ...
    public static void putRaiPolicy(com.azure.resourcemanager.cognitiveservices.CognitiveServicesManager manager) {
        manager.raiPolicies().define("raiPolicyName").withExistingAccount("resourceGroupName", "accountName")
            .withProperties(new RaiPolicyProperties().withBasePolicyName("112").withContentFilters(Arrays.asList(
                new RaiPolicyContentFilter().withPolicyName("hate").withAllowedContentLevel(AllowedContentLevel.LOW)
                    .withBlocking(true),
                new RaiPolicyContentFilter().withPolicyName("sexual").withAllowedContentLevel(AllowedContentLevel.LOW),
                new RaiPolicyContentFilter().withPolicyName("violence").withEnabled(false),
                new RaiPolicyContentFilter().withPolicyName("DefaultHateSpeechBlockList").withEnabled(false))))
            .create();
    }
}
```
