...
public interface RaiBlocklistItemOperationsClient {
    /**
    ...
    Response<RaiBlocklistItemInner> getWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<RaiBlocklistItemInner> createOrUpdateWithResponse(
        String resourceGroupName,
        String accountName,
        String raiBlocklistName,
        String raiBlocklistItemName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    RaiBlocklistItemInner createOrUpdate(
        String resourceGroupName,
        String accountName,
        String raiBlocklistName,
        String raiBlocklistItemName,
