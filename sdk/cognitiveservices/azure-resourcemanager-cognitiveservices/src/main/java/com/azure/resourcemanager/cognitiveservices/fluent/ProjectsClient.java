...
public interface ProjectsClient {
    ...
    AccountInner create(String resourceGroupName, String accountName, String projectName, AccountInner project);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    AccountInner update(String resourceGroupName, String accountName, String projectName, AccountInner project);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<AccountInner> getWithResponse(String resourceGroupName, String accountName, String projectName,
        Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    AccountInner get(String resourceGroupName, String accountName, String projectName);
    ...
    PagedIterable<AccountInner> list(String resourceGroupName, String accountName);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<AccountInner> list(String resourceGroupName, String accountName, Context context);
}
