...
public final class CognitiveServicesManagementClientImpl implements CognitiveServicesManagementClient {
    ...
    /** The RaiBlocklistOperationsClient object to access its operations. */
    private final RaiBlocklistOperationsClient raiBlocklistOperations;

    /**
     * Gets the RaiBlocklistOperationsClient object to access its operations.
     *
     * @return the RaiBlocklistOperationsClient object.
     */
    public RaiBlocklistOperationsClient getRaiBlocklistOperations() {
        return this.raiBlocklistOperations;
    }

    /** The RaiBlocklistItemOperationsClient object to access its operations. */
    private final RaiBlocklistItemOperationsClient raiBlocklistItemOperations;

    /**
     * Gets the RaiBlocklistItemOperationsClient object to access its operations.
     *
     * @return the RaiBlocklistItemOperationsClient object.
     */
    public RaiBlocklistItemOperationsClient getRaiBlocklistItemOperations() {
        return this.raiBlocklistItemOperations;
    }
    ...
    CognitiveServicesManagementClientImpl(
        ...
        this.raiBlocklistOperations = new RaiBlocklistOperationsClientImpl(this);
        this.raiBlocklistItemOperations = new RaiBlocklistItemOperationsClientImpl(this);
