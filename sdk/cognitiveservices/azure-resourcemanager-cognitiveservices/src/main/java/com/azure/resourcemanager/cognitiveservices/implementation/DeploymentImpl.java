...
public final class DeploymentImpl implements Deployment, Deployment.Definition, Deployment.Update {
    ...
    public Deployment create() {
        this.innerObject = serviceManager.serviceClient().getDeployments().createOrUpdate(resourceGroupName,
            accountName, deploymentName, this.innerModel(), Context.NONE);
        return this;
    }

    public Deployment create(Context context) {
        this.innerObject = serviceManager.serviceClient().getDeployments().createOrUpdate(resourceGroupName,
            accountName, deploymentName, this.innerModel(), context);
        return this;
    }
    ...
    public Deployment apply() {
        this.innerObject = serviceManager.serviceClient().getDeployments().update(resourceGroupName, accountName,
            deploymentName, updateDeployment, Context.NONE);
        return this;
    }

    public Deployment apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getDeployments().update(resourceGroupName, accountName,
            deploymentName, updateDeployment, context);
        return this;
    }
    ...
    public Deployment refresh() {
        this.innerObject = serviceManager.serviceClient().getDeployments()
            .getWithResponse(resourceGroupName, accountName, deploymentName, Context.NONE).getValue();
        return this;
    }

    public Deployment refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getDeployments()
            .getWithResponse(resourceGroupName, accountName, deploymentName, context).getValue();
        return this;
    }
