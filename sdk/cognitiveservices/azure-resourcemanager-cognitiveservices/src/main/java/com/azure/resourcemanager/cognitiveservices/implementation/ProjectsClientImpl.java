...
public final class ProjectsClientImpl implements ProjectsClient {
    ...
    public interface ProjectsService {
        ...
        Mono<Response<Flux<ByteBuffer>>> create(@HostParam("$host") String endpoint,
            ...
            @PathParam("subscriptionId") String subscriptionId, @BodyParam("application/json") AccountInner project,
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<AccountInner>> get(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("accountName") String accountName,
            @PathParam("projectName") String projectName, @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId, @HeaderParam("Accept") String accept, Context context);
    ...
    private Mono<Response<Flux<ByteBuffer>>> createWithResponseAsync(String resourceGroupName, String accountName,
        String projectName, AccountInner project) {
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> createWithResponseAsync(String resourceGroupName, String accountName,
        String projectName, AccountInner project, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    private PollerFlux<PollResult<AccountInner>, AccountInner> beginCreateAsync(String resourceGroupName,
        String accountName, String projectName, AccountInner project) {
    ...
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<AccountInner>, AccountInner> beginCreateAsync(String resourceGroupName,
        String accountName, String projectName, AccountInner project, Context context) {
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<AccountInner> createAsync(String resourceGroupName, String accountName, String projectName,
        AccountInner project) {
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<AccountInner> createAsync(String resourceGroupName, String accountName, String projectName,
        AccountInner project, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public AccountInner create(String resourceGroupName, String accountName, String projectName, AccountInner project) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<AccountInner> updateAsync(String resourceGroupName, String accountName, String projectName,
        AccountInner project) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public AccountInner update(String resourceGroupName, String accountName, String projectName, AccountInner project) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<AccountInner>> getWithResponseAsync(String resourceGroupName, String accountName,
        String projectName) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<AccountInner> getAsync(String resourceGroupName, String accountName, String projectName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<AccountInner> getWithResponse(String resourceGroupName, String accountName, String projectName,
        Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public AccountInner get(String resourceGroupName, String accountName, String projectName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<AccountInner>> listSinglePageAsync(String resourceGroupName, String accountName) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    private PagedFlux<AccountInner> listAsync(String resourceGroupName, String accountName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<AccountInner> listAsync(String resourceGroupName, String accountName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<AccountInner> list(String resourceGroupName, String accountName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<AccountInner> list(String resourceGroupName, String accountName, Context context) {
