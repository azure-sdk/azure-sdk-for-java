...
public final class RaiContentFiltersClientImpl implements RaiContentFiltersClient {
    ...
    public interface RaiContentFiltersService {
        ...
        @Post("/subscriptions/{subscriptionId}/providers/Microsoft.CognitiveServices/locations/{location}/raiContentFilters")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<RaiContentFilterListResultInner>> list(@HostParam("$host") String endpoint,
