...
public final class RaiBlocklistItemsClientImpl implements RaiBlocklistItemsClient {
    ...
    public interface RaiBlocklistItemsService {
        ...
        Mono<Response<RaiBlockListItemsResult>> list(
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<RaiBlockListItemsResult>> listNext(
    ...
    private Mono<PagedResponse<RaiBlocklistItemInner>> listSinglePageAsync(
                ...
                context ->
                    service
                        .list(
                            ...
                            accept,
                            context))
            .<PagedResponse<RaiBlocklistItemInner>>map(
                res ->
    ...
    private PagedFlux<RaiBlocklistItemInner> listAsync(
        String resourceGroupName, String accountName, String raiBlocklistName) {
        return new PagedFlux<>(
            () -> listSinglePageAsync(resourceGroupName, accountName, raiBlocklistName),
    ...
    private PagedFlux<RaiBlocklistItemInner> listAsync(
        String resourceGroupName, String accountName, String raiBlocklistName, Context context) {
        return new PagedFlux<>(
            () -> listSinglePageAsync(resourceGroupName, accountName, raiBlocklistName, context),
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<RaiBlocklistItemInner> list(
        String resourceGroupName, String accountName, String raiBlocklistName) {
