...
public final class RaiBlocklistsClientImpl implements RaiBlocklistsClient {
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<RaiBlocklistInner>> createOrUpdateWithResponseAsync(String resourceGroupName,
        String accountName, String raiBlocklistName, RaiBlocklistInner raiBlocklist, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String accountName, String raiBlocklistName,
        Context context) {
        return beginDeleteAsync(resourceGroupName, accountName, raiBlocklistName, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
