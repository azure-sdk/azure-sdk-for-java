...
public final class RaiBlocklistsClientImpl implements RaiBlocklistsClient {
    ...
    public interface RaiBlocklistsService {
        ...
        Mono<Response<RaiBlockListResult>> list(
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<RaiBlockListResult>> listNext(
                ...
                context ->
                    service
                        .list(
                            ...
                            accept,
                            context))
            .<PagedResponse<RaiBlocklistInner>>map(
                res ->
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<RaiBlocklistInner>> listSinglePageAsync(
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the custom blocklists associated with the Azure OpenAI account as paginated response with {@link
     *     PagedFlux}.
     */
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<RaiBlocklistInner> listAsync(String resourceGroupName, String accountName, Context context) {
        return new PagedFlux<>(
    ...
    private PollerFlux<PollResult<Void>, Void> beginDeleteAsync(
        ...
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono =
            deleteWithResponseAsync(resourceGroupName, accountName, raiBlocklistName, context);
        return this
            .client
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(
        String resourceGroupName, String accountName, String raiBlocklistName) {
        return this.beginDeleteAsync(resourceGroupName, accountName, raiBlocklistName).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(
        String resourceGroupName, String accountName, String raiBlocklistName, Context context) {
        return this.beginDeleteAsync(resourceGroupName, accountName, raiBlocklistName, context).getSyncPoller();
    }
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String accountName, String raiBlocklistName) {
        return beginDeleteAsync(resourceGroupName, accountName, raiBlocklistName)
            .last()
    ...
    private Mono<Void> deleteAsync(
        String resourceGroupName, String accountName, String raiBlocklistName, Context context) {
        return beginDeleteAsync(resourceGroupName, accountName, raiBlocklistName, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    public void delete(String resourceGroupName, String accountName, String raiBlocklistName) {
        deleteAsync(resourceGroupName, accountName, raiBlocklistName).block();
    }
    ...
    public void delete(String resourceGroupName, String accountName, String raiBlocklistName, Context context) {
        deleteAsync(resourceGroupName, accountName, raiBlocklistName, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<RaiBlocklistInner>> listNextSinglePageAsync(String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        if (this.client.getEndpoint() == null) {
