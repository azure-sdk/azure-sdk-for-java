...
public final class NetworkInjections implements JsonSerializable<NetworkInjections> {
    ...
    /*
     * Specify the subnet for which you Agent Client is injected into.
     */
     ...
     */
    public NetworkInjections withScenario(Scenario scenario) {
        this.scenario = scenario;
        return this;
    }

    /**
     * Get the subnetArmId property: Specify the subnet for which you Agent Client is injected into.
     * 
    ...
    /**
     * Set the subnetArmId property: Specify the subnet for which you Agent Client is injected into.
     * 
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("scenario".equals(fieldName)) {
                    deserializedNetworkInjections.scenario = Scenario.fromString(reader.getString());
