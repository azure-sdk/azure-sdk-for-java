...
public final class RaiBlocklistItemImpl
    ...
    public RaiBlocklistItemImpl withExistingRaiBlocklist(
    ...
    public RaiBlocklistItem create(Context context) {
        this.innerObject =
            serviceManager
                ...
                .getRaiBlocklistItemOperations()
                .createOrUpdateWithResponse(
                    resourceGroupName, accountName, raiBlocklistName, raiBlocklistItemName, this.innerModel(), context)
                .getValue();
        return this;
    }

    RaiBlocklistItemImpl(
    ...
    RaiBlocklistItemImpl(
        RaiBlocklistItemInner innerObject,
