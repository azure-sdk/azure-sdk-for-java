...
public final class CommitmentPlanImpl implements CommitmentPlan, CommitmentPlan.Definition, CommitmentPlan.Update {
    ...
    public CommitmentPlan create() {
        this.innerObject = serviceManager.serviceClient().getCommitmentPlans().createOrUpdatePlan(resourceGroupName,
            commitmentPlanName, this.innerModel(), Context.NONE);
        return this;
    }

    public CommitmentPlan create(Context context) {
        this.innerObject = serviceManager.serviceClient().getCommitmentPlans().createOrUpdatePlan(resourceGroupName,
            commitmentPlanName, this.innerModel(), context);
        return this;
    }
    ...
    public CommitmentPlan apply() {
        this.innerObject = serviceManager.serviceClient().getCommitmentPlans().updatePlan(resourceGroupName,
            commitmentPlanName, updateCommitmentPlan, Context.NONE);
        return this;
    }

    public CommitmentPlan apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getCommitmentPlans().updatePlan(resourceGroupName,
            commitmentPlanName, updateCommitmentPlan, context);
        return this;
    }
    ...
    public CommitmentPlan refresh() {
        this.innerObject = serviceManager.serviceClient().getCommitmentPlans()
            .getByResourceGroupWithResponse(resourceGroupName, commitmentPlanName, Context.NONE).getValue();
        return this;
    }

    public CommitmentPlan refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getCommitmentPlans()
            .getByResourceGroupWithResponse(resourceGroupName, commitmentPlanName, context).getValue();
        return this;
    }
