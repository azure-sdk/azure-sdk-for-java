...
/** Resource collection API of RaiBlocklistItemOperations. */
public interface RaiBlocklistItemOperations {
    /**
     ...
     */
    Response<RaiBlocklistItem> getWithResponse(
