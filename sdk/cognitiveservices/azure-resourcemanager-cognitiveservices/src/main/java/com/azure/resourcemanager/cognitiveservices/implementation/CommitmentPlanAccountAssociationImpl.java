...
public final class CommitmentPlanAccountAssociationImpl implements CommitmentPlanAccountAssociation,
    ...
    public CommitmentPlanAccountAssociation create() {
        this.innerObject = serviceManager.serviceClient().getCommitmentPlans().createOrUpdateAssociation(
            resourceGroupName, commitmentPlanName, commitmentPlanAssociationName, this.innerModel(), Context.NONE);
        return this;
    }
    ...
    public CommitmentPlanAccountAssociation refresh() {
        this.innerObject
            = serviceManager.serviceClient().getCommitmentPlans().getAssociationWithResponse(resourceGroupName,
                commitmentPlanName, commitmentPlanAssociationName, Context.NONE).getValue();
        return this;
    }
