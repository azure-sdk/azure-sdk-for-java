...
public final class ImageAnalysisAsyncClient {
    ...
    Mono<Response<BinaryData>> analyzeFromBufferWithResponse(List<String> visualFeatures, BinaryData imageContent,
        RequestOptions requestOptions) {
        return this.serviceClient.analyzeFromBufferWithResponseAsync(visualFeatures, imageContent, requestOptions);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    Mono<ImageAnalysisResult> analyzeFromBuffer(List<VisualFeatures> visualFeatures, BinaryData imageContent,
