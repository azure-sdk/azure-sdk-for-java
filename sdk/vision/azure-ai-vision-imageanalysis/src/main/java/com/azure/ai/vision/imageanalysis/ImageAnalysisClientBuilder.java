...
public final class ImageAnalysisClientBuilder
        implements HttpTrait<ImageAnalysisClientBuilder>,
                ConfigurationTrait<ImageAnalysisClientBuilder>,
                KeyCredentialTrait<ImageAnalysisClientBuilder>,
                EndpointTrait<ImageAnalysisClientBuilder> {
    ...
    private static final Map<String, String> PROPERTIES =
            CoreUtils.getProperties("azure-ai-vision-imageanalysis.properties");
     ...
     * Service version
     */
    @Generated private ImageAnalysisServiceVersion serviceVersion;
    ...
    private ImageAnalysisClientImpl buildInnerClient() {
        ...
        ImageAnalysisClientImpl client =
                new ImageAnalysisClientImpl(
                        localPipeline,
    ...
    public ImageAnalysisAsyncClient buildAsyncClient() {
        return new ImageAnalysisAsyncClient(buildInnerClient());
    }
    ...
    public ImageAnalysisClient buildClient() {
        return new ImageAnalysisClient(buildInnerClient());
    }
