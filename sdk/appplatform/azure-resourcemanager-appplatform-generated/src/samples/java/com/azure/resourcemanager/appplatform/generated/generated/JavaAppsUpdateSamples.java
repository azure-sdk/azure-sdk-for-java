...
public final class JavaAppsUpdateSamples {
    ...
    public static void patchAnApp(com.azure.resourcemanager.appplatform.generated.AppPlatformManager manager) {
        manager.javaApps().update("rg", "testApp0", new JavaAppForPatch().withLocation("East US")
            ...
            .withConfiguration(new Configuration().withIngress(new Ingress().withExternal(true).withTargetPort(3000)
                ...
                .withIpSecurityRestrictions(Arrays.asList(
                    new IpSecurityRestrictionRule().withName("Allow work IP A subnet")
                        .withDescription("Allowing all IP's within the subnet below to access app").withIpAddressRange(
                            "192.168.1.1/32")
            ...
            .withTemplate(new SpringAppsTemplate()
                ...
                .withContainers(Arrays.asList(new Container().withImage("repo/testApp0:v1").withName("testApp0")
                    .withProbes(Arrays.asList(new ContainerAppProbe()
                        .withHttpGet(new ContainerAppProbeHttpGet().withHttpHeaders(
