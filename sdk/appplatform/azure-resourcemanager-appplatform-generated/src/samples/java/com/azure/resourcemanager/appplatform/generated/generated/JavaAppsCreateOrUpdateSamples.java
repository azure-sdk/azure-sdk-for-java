...
public final class JavaAppsCreateOrUpdateSamples {
    ...
    public static void createOrUpdateAnApp(com.azure.resourcemanager.appplatform.generated.AppPlatformManager manager) {
        manager.javaApps().createOrUpdate("rg", "testApp0", new JavaAppInner().withLocation("East US")
            .withEnvironmentId(
            ...
            .withConfiguration(new Configuration().withIngress(new Ingress().withExternal(true).withTargetPort(3000)
                .withTraffic(Arrays.asList(
                    new TrafficWeight().withRevisionName("testApp0-ab1234").withWeight(100).withLabel("production")))
                ...
                .withIpSecurityRestrictions(Arrays.asList(
                    new IpSecurityRestrictionRule().withName("Allow work IP A subnet")
                        .withDescription("Allowing all IP's within the subnet below to access app")
            ...
            .withTemplate(
                new SpringAppsTemplate()
                    .withInitContainers(Arrays.asList(new InitContainer().withImage("repo/testApp0:v4")
                    ...
                    .withContainers(Arrays.asList(new Container().withImage("repo/testApp0:v1").withName("testApp0")
