...
public final class ClusterResourceProperties implements JsonSerializable<ClusterResourceProperties> {
     ...
     */
    private MaintenanceScheduleConfiguration maintenanceScheduleConfiguration;
    ...
    /**
     * Get the maintenanceScheduleConfiguration property: Additional Service settings for planned maintenance.
     * 
     * @return the maintenanceScheduleConfiguration value.
     */
    public MaintenanceScheduleConfiguration maintenanceScheduleConfiguration() {
        return this.maintenanceScheduleConfiguration;
    }

    /**
     * Set the maintenanceScheduleConfiguration property: Additional Service settings for planned maintenance.
     * 
     * @param maintenanceScheduleConfiguration the maintenanceScheduleConfiguration value to set.
     * @return the ClusterResourceProperties object itself.
     */
    public ClusterResourceProperties
        withMaintenanceScheduleConfiguration(MaintenanceScheduleConfiguration maintenanceScheduleConfiguration) {
        this.maintenanceScheduleConfiguration = maintenanceScheduleConfiguration;
        return this;
    }
    ...
    public void validate() {
        ...
        if (maintenanceScheduleConfiguration() != null) {
            maintenanceScheduleConfiguration().validate();
        }
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeJsonField("maintenanceScheduleConfiguration", this.maintenanceScheduleConfiguration);
        jsonWriter.writeStringField("managedEnvironmentId", this.managedEnvironmentId);
        jsonWriter.writeStringField("infraResourceGroup", this.infraResourceGroup);
    ...
    public static ClusterResourceProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("provisioningState".equals(fieldName)) {
                ...
                } else if ("maintenanceScheduleConfiguration".equals(fieldName)) {
                    deserializedClusterResourceProperties.maintenanceScheduleConfiguration
                        = MaintenanceScheduleConfiguration.fromJson(reader);
                    ...
                    deserializedClusterResourceProperties.managedEnvironmentId = reader.getString();
                } else if ("infraResourceGroup".equals(fieldName)) {
                    deserializedClusterResourceProperties.infraResourceGroup = reader.getString();
