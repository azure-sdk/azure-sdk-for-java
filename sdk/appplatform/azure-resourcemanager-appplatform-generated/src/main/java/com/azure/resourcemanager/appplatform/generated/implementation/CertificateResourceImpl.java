...
public final class CertificateResourceImpl
    ...
    public CertificateResource create() {
        this.innerObject = serviceManager.serviceClient().getCertificates().createOrUpdate(resourceGroupName,
            serviceName, certificateName, this.innerModel(), Context.NONE);
        return this;
    }

    public CertificateResource create(Context context) {
        this.innerObject = serviceManager.serviceClient().getCertificates().createOrUpdate(resourceGroupName,
            serviceName, certificateName, this.innerModel(), context);
        return this;
    }

    CertificateResourceImpl(String name,
    ...
    CertificateResourceImpl(CertificateResourceInner innerObject,
        com.azure.resourcemanager.appplatform.generated.AppPlatformManager serviceManager) {
    ...
    public CertificateResource refresh() {
        this.innerObject = serviceManager.serviceClient().getCertificates()
            .getWithResponse(resourceGroupName, serviceName, certificateName, Context.NONE).getValue();
        return this;
    }

    public CertificateResource refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getCertificates()
            .getWithResponse(resourceGroupName, serviceName, certificateName, context).getValue();
        return this;
    }
