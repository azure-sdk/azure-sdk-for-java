...
@Fluent
public final class DeploymentSettingsAutoGenerated {
    /*
     ...
     * @return the DeploymentSettingsAutoGenerated object itself.
     */
    public DeploymentSettingsAutoGenerated withResourceRequests(ResourceRequests resourceRequests) {
     ...
     * @return the DeploymentSettingsAutoGenerated object itself.
     */
    public DeploymentSettingsAutoGenerated withEnvironmentVariables(Map<String, String> environmentVariables) {
     ...
     * @return the DeploymentSettingsAutoGenerated object itself.
     */
    public DeploymentSettingsAutoGenerated withAddonConfigs(Map<String, Map<String, Object>> addonConfigs) {
     ...
     * @return the DeploymentSettingsAutoGenerated object itself.
     */
    public DeploymentSettingsAutoGenerated withContainerProbeSettings(ContainerProbeSettings containerProbeSettings) {
