...
public final class ApplicationLiveViewResourceCollection
     ...
     */
    private List<ApplicationLiveViewResourceInner> value;
     ...
     */
    public List<ApplicationLiveViewResourceInner> value() {
        return this.value;
    }
     ...
     * @return the ApplicationLiveViewResourceCollection object itself.
     */
    public ApplicationLiveViewResourceCollection withValue(List<ApplicationLiveViewResourceInner> value) {
        this.value = value;
        return this;
    }
     ...
     * @return An instance of ApplicationLiveViewResourceCollection if the JsonReader was pointing to an instance of it,
     * or null if it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the ApplicationLiveViewResourceCollection.
     */
    public static ApplicationLiveViewResourceCollection fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ApplicationLiveViewResourceCollection deserializedApplicationLiveViewResourceCollection
                = new ApplicationLiveViewResourceCollection();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("value".equals(fieldName)) {
                    List<ApplicationLiveViewResourceInner> value
                        = reader.readArray(reader1 -> ApplicationLiveViewResourceInner.fromJson(reader1));
                    deserializedApplicationLiveViewResourceCollection.value = value;
                } else if ("nextLink".equals(fieldName)) {
                    deserializedApplicationLiveViewResourceCollection.nextLink = reader.getString();
                } else {
                    reader.skipChildren();
                }
            }

            return deserializedApplicationLiveViewResourceCollection;
        });
    }
}
