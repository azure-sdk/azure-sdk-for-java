...
public final class GatewayCustomDomainsClientImpl implements GatewayCustomDomainsClient {
    ...
    private Mono<Response<GatewayCustomDomainResourceInner>> getWithResponseAsync(String resourceGroupName,
        ...
        return service.get(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(), resourceGroupName,
            serviceName, gatewayName, domainName, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<GatewayCustomDomainResourceInner> getAsync(String resourceGroupName, String serviceName,
    ...
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String resourceGroupName,
        ...
        return service.createOrUpdate(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(),
            resourceGroupName, serviceName, gatewayName, domainName, gatewayCustomDomainResource, accept, context);
    }
