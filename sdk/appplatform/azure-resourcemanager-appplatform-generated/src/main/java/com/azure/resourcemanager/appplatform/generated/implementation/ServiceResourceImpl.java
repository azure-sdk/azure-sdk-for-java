...
public final class ServiceResourceImpl implements ServiceResource, ServiceResource.Definition, ServiceResource.Update {
    ...
    public SystemAssignedManagedIdentityProperties identity() {
    ...
    public ServiceResource create() {
        this.innerObject = serviceManager.serviceClient().getServices().createOrUpdate(resourceGroupName, serviceName,
    ...
    public ServiceResource apply() {
        this.innerObject = serviceManager.serviceClient().getServices().update(resourceGroupName, serviceName,
            this.innerModel(), Context.NONE);
        return this;
    }
    ...
    public Response<TestKeys> regenerateTestKeyWithResponse(RegenerateTestKeyRequestPayload regenerateTestKeyRequest,
        Context context) {
        return serviceManager.services().regenerateTestKeyWithResponse(resourceGroupName, serviceName,
            regenerateTestKeyRequest, context);
    }
    ...
    public void flushVnetDnsSetting() {
        serviceManager.services().flushVnetDnsSetting(resourceGroupName, serviceName);
    }

    public void flushVnetDnsSetting(Context context) {
        serviceManager.services().flushVnetDnsSetting(resourceGroupName, serviceName, context);
    }

    public Response<GloballyEnabledApms> listGloballyEnabledApmsWithResponse(Context context) {
        return serviceManager.services().listGloballyEnabledApmsWithResponse(resourceGroupName, serviceName, context);
    }

    public GloballyEnabledApms listGloballyEnabledApms() {
        return serviceManager.services().listGloballyEnabledApms(resourceGroupName, serviceName);
    }

    public void enableApmGlobally(ApmReference apm) {
        serviceManager.services().enableApmGlobally(resourceGroupName, serviceName, apm);
    }

    public void enableApmGlobally(ApmReference apm, Context context) {
        serviceManager.services().enableApmGlobally(resourceGroupName, serviceName, apm, context);
    }

    public void disableApmGlobally(ApmReference apm) {
        serviceManager.services().disableApmGlobally(resourceGroupName, serviceName, apm);
    }

    public void disableApmGlobally(ApmReference apm, Context context) {
        serviceManager.services().disableApmGlobally(resourceGroupName, serviceName, apm, context);
    }
    ...
    public ServiceResourceImpl withIdentity(SystemAssignedManagedIdentityProperties identity) {
