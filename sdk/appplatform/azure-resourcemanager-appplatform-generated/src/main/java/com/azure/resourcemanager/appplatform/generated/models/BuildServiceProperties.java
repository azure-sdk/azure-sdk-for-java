...
public final class BuildServiceProperties {
     ...
     */
    @JsonProperty(value = "defaultBuilderConfiguration")
    private DefaultBuilderConfigurationState defaultBuilderConfiguration;
    ...
    /**
     * Get the defaultBuilderConfiguration property: Indicate if the default builder configuration is enabled or
     * disabled.
     * 
     * @return the defaultBuilderConfiguration value.
     */
    public DefaultBuilderConfigurationState defaultBuilderConfiguration() {
        return this.defaultBuilderConfiguration;
    }

    /**
     * Set the defaultBuilderConfiguration property: Indicate if the default builder configuration is enabled or
     * disabled.
     * 
     * @param defaultBuilderConfiguration the defaultBuilderConfiguration value to set.
     * @return the BuildServiceProperties object itself.
     */
    public BuildServiceProperties
        withDefaultBuilderConfiguration(DefaultBuilderConfigurationState defaultBuilderConfiguration) {
        this.defaultBuilderConfiguration = defaultBuilderConfiguration;
        return this;
    }
