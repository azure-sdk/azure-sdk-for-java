...
import com.azure.resourcemanager.appplatform.generated.models.ConfigServerSettingsValidateResultAutoGenerated;
...
public final class ConfigServersImpl implements ConfigServers {
    ...
    public ConfigServerResourceAutoGenerated get(String resourceGroupName, String serviceName) {
        ConfigServerResourceAutoGeneratedInner inner = this.serviceClient().get(resourceGroupName, serviceName);
        if (inner != null) {
            return new ConfigServerResourceAutoGeneratedImpl(inner, this.manager());
        } else {
            return null;
        }
    }

    public Response<ConfigServerResourceAutoGenerated> getWithResponse(
        String resourceGroupName, String serviceName, Context context) {
        Response<ConfigServerResourceAutoGeneratedInner> inner =
            this.serviceClient().getWithResponse(resourceGroupName, serviceName, context);
        if (inner != null) {
            return new SimpleResponse<>(
                inner.getRequest(),
                inner.getStatusCode(),
                inner.getHeaders(),
                new ConfigServerResourceAutoGeneratedImpl(inner.getValue(), this.manager()));
        } else {
            return null;
        }
    }

    public ConfigServerResourceAutoGenerated updatePut(
        String resourceGroupName, String serviceName, ConfigServerResourceAutoGeneratedInner configServerResource) {
        ConfigServerResourceAutoGeneratedInner inner =
            this.serviceClient().updatePut(resourceGroupName, serviceName, configServerResource);
        if (inner != null) {
            return new ConfigServerResourceAutoGeneratedImpl(inner, this.manager());
        } else {
    ...
    public ConfigServerResourceAutoGenerated updatePatch(
        String resourceGroupName, String serviceName, ConfigServerResourceAutoGeneratedInner configServerResource) {
        ConfigServerResourceAutoGeneratedInner inner =
            this.serviceClient().updatePatch(resourceGroupName, serviceName, configServerResource);
        if (inner != null) {
    ...
    public ConfigServerSettingsValidateResultAutoGenerated validate(
        String resourceGroupName, String serviceName, ConfigServerSettingsAutoGenerated configServerSettings) {
        ConfigServerSettingsValidateResultAutoGeneratedInner inner =
            this.serviceClient().validate(resourceGroupName, serviceName, configServerSettings);
        if (inner != null) {
            return new ConfigServerSettingsValidateResultAutoGeneratedImpl(inner, this.manager());
        } else {
            return null;
        }
    }
