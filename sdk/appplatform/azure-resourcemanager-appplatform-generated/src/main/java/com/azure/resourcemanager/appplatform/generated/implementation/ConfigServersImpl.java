...
public final class ConfigServersImpl implements ConfigServers {
    ...
    public ConfigServersImpl(ConfigServersClient innerClient,
        com.azure.resourcemanager.appplatform.generated.AppPlatformManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public Response<ConfigServerResource> getWithResponse(String resourceGroupName, String serviceName,
        Context context) {
    ...
    public ConfigServerResource updatePut(String resourceGroupName, String serviceName,
    ...
    public ConfigServerResource updatePatch(String resourceGroupName, String serviceName,
        ConfigServerResourceInner configServerResource) {
        ConfigServerResourceInner inner
    ...
    public PagedIterable<ConfigServerResource> list(String resourceGroupName, String serviceName) {
        PagedIterable<ConfigServerResourceInner> inner = this.serviceClient().list(resourceGroupName, serviceName);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new ConfigServerResourceImpl(inner1, this.manager()));
    }

    public PagedIterable<ConfigServerResource> list(String resourceGroupName, String serviceName, Context context) {
        PagedIterable<ConfigServerResourceInner> inner
            = this.serviceClient().list(resourceGroupName, serviceName, context);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new ConfigServerResourceImpl(inner1, this.manager()));
    }

    public ConfigServerSettingsValidateResult validate(String resourceGroupName, String serviceName,
