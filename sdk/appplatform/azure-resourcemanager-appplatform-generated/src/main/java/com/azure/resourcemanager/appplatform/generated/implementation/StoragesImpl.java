...
public final class StoragesImpl implements Storages {
    ...
    public Response<StorageResource> getWithResponse(String resourceGroupName, String serviceName, String storageName,
        Context context) {
    ...
    public PagedIterable<StorageResource> list(String resourceGroupName, String serviceName) {
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new StorageResourceImpl(inner1, this.manager()));
    }
