...
public final class ApplicationAcceleratorResourceCollection
    implements JsonSerializable<ApplicationAcceleratorResourceCollection> {
    /*
    ...
    /**
     * Reads an instance of ApplicationAcceleratorResourceCollection from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of ApplicationAcceleratorResourceCollection if the JsonReader was pointing to an instance of
     * it, or null if it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the ApplicationAcceleratorResourceCollection.
     */
    public static ApplicationAcceleratorResourceCollection fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ApplicationAcceleratorResourceCollection deserializedApplicationAcceleratorResourceCollection
                = new ApplicationAcceleratorResourceCollection();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("value".equals(fieldName)) {
                    List<ApplicationAcceleratorResourceInner> value
                        = reader.readArray(reader1 -> ApplicationAcceleratorResourceInner.fromJson(reader1));
                    deserializedApplicationAcceleratorResourceCollection.value = value;
                } else if ("nextLink".equals(fieldName)) {
                    deserializedApplicationAcceleratorResourceCollection.nextLink = reader.getString();
                } else {
                    reader.skipChildren();
                }
            }

            return deserializedApplicationAcceleratorResourceCollection;
        });
    }
}
