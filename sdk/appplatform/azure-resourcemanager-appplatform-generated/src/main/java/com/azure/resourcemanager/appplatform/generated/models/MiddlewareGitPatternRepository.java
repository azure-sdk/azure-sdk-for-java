 ...
 */
@Fluent
public final class MiddlewareGitPatternRepository {
    /*
    ...
    /**
     * Creates an instance of MiddlewareGitPatternRepository class.
     */
    public MiddlewareGitPatternRepository() {
    }
     ...
     * @return the MiddlewareGitPatternRepository object itself.
     */
    public MiddlewareGitPatternRepository withName(String name) {
        this.name = name;
        return this;
    }
     ...
     * @return the MiddlewareGitPatternRepository object itself.
     */
    public MiddlewareGitPatternRepository withPattern(List<String> pattern) {
     ...
     * @return the MiddlewareGitPatternRepository object itself.
     */
    public MiddlewareGitPatternRepository withUri(String uri) {
        this.uri = uri;
        return this;
    }
     ...
     * @return the MiddlewareGitPatternRepository object itself.
     */
    public MiddlewareGitPatternRepository withLabel(String label) {
        this.label = label;
        return this;
    }
     ...
     * @return the MiddlewareGitPatternRepository object itself.
     */
    public MiddlewareGitPatternRepository withSearchPaths(List<String> searchPaths) {
     ...
     * @return the MiddlewareGitPatternRepository object itself.
     */
    public MiddlewareGitPatternRepository withUsername(String username) {
     ...
     * @return the MiddlewareGitPatternRepository object itself.
     */
    public MiddlewareGitPatternRepository withPassword(String password) {
     ...
     * @return the MiddlewareGitPatternRepository object itself.
     */
    public MiddlewareGitPatternRepository withHostKey(String hostKey) {
     ...
     * @return the MiddlewareGitPatternRepository object itself.
     */
    public MiddlewareGitPatternRepository withHostKeyAlgorithm(String hostKeyAlgorithm) {
     ...
     * @return the MiddlewareGitPatternRepository object itself.
     */
    public MiddlewareGitPatternRepository withPrivateKey(String privateKey) {
     ...
     * @return the MiddlewareGitPatternRepository object itself.
     */
    public MiddlewareGitPatternRepository withStrictHostKeyChecking(StrictHostKeyCheckingEnum strictHostKeyChecking) {
    ...
    public void validate() {
        if (name() == null) {
            throw LOGGER.logExceptionAsError(
                new IllegalArgumentException("Missing required property name in model MiddlewareGitPatternRepository"));
        }
        if (uri() == null) {
            throw LOGGER.logExceptionAsError(
                new IllegalArgumentException("Missing required property uri in model MiddlewareGitPatternRepository"));
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(MiddlewareGitPatternRepository.class);
}
