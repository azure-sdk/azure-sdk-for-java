...
public final class GatewayCustomDomainsImpl implements GatewayCustomDomains {
    ...
    public GatewayCustomDomainsImpl(GatewayCustomDomainsClient innerClient,
        com.azure.resourcemanager.appplatform.generated.AppPlatformManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public Response<GatewayCustomDomainResource> getWithResponse(String resourceGroupName, String serviceName,
    ...
    public GatewayCustomDomainResource get(String resourceGroupName, String serviceName, String gatewayName,
        String domainName) {
    ...
    public PagedIterable<GatewayCustomDomainResource> list(String resourceGroupName, String serviceName,
        String gatewayName) {
        ...
        return ResourceManagerUtils.mapPage(inner,
            inner1 -> new GatewayCustomDomainResourceImpl(inner1, this.manager()));
    }
