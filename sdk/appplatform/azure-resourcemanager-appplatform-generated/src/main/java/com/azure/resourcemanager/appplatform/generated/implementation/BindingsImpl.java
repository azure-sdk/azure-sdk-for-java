...
public final class BindingsImpl implements Bindings {
    ...
    public BindingsImpl(BindingsClient innerClient,
        com.azure.resourcemanager.appplatform.generated.AppPlatformManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public Response<BindingResource> getWithResponse(String resourceGroupName, String serviceName, String appName,
    ...
    public PagedIterable<BindingResource> list(String resourceGroupName, String serviceName, String appName) {
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new BindingResourceImpl(inner1, this.manager()));
    }
    ...
    public BindingResource getById(String id) {
        ...
        String bindingName = ResourceManagerUtils.getValueFromIdByName(id, "bindings");
        if (bindingName == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
