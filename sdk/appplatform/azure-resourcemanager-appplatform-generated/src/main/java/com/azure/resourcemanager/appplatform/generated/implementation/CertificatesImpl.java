...
public final class CertificatesImpl implements Certificates {
    ...
    public Response<CertificateResource> getWithResponse(String resourceGroupName, String serviceName,
    ...
    public PagedIterable<CertificateResource> list(String resourceGroupName, String serviceName) {
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new CertificateResourceImpl(inner1, this.manager()));
    }
