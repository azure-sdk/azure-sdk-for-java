...
public interface RuntimeVersionsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    AvailableRuntimeVersionsAutoGeneratedInner listRuntimeVersions();
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<AvailableRuntimeVersionsAutoGeneratedInner> listRuntimeVersionsWithResponse(Context context);
}
