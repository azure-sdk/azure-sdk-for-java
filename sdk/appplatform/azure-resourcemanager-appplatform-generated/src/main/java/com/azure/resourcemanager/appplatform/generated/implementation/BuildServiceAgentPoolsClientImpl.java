...
public final class BuildServiceAgentPoolsClientImpl implements BuildServiceAgentPoolsClient {
    ...
    private Mono<Response<BuildServiceAgentPoolResourceInner>> getWithResponseAsync(String resourceGroupName,
        ...
        return service.get(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(), resourceGroupName,
            serviceName, buildServiceName, agentPoolName, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<BuildServiceAgentPoolResourceInner> getAsync(String resourceGroupName, String serviceName,
    ...
    private Mono<Response<Flux<ByteBuffer>>> updatePutWithResponseAsync(String resourceGroupName, String serviceName,
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.updatePut(this.client.getEndpoint(), apiVersion,
    ...
    private Mono<Response<Flux<ByteBuffer>>> updatePutWithResponseAsync(String resourceGroupName, String serviceName,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.updatePut(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(),
            resourceGroupName, serviceName, buildServiceName, agentPoolName, agentPoolResource, accept, context);
    }
