...
public final class SkusImpl implements Skus {
    ...
    public PagedIterable<ResourceSkuAutoGenerated> list() {
        PagedIterable<ResourceSkuAutoGeneratedInner> inner = this.serviceClient().list();
        return Utils.mapPage(inner, inner1 -> new ResourceSkuAutoGeneratedImpl(inner1, this.manager()));
    }

    public PagedIterable<ResourceSkuAutoGenerated> list(Context context) {
        PagedIterable<ResourceSkuAutoGeneratedInner> inner = this.serviceClient().list(context);
        return Utils.mapPage(inner, inner1 -> new ResourceSkuAutoGeneratedImpl(inner1, this.manager()));
    }
