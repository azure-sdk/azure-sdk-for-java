...
public interface GatewaysClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<GatewayResourceInner>, GatewayResourceInner> beginUpdateCapacity(String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<CustomDomainValidateResultInner> validateDomainWithResponse(String resourceGroupName, String serviceName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    CustomDomainValidateResultInner validateDomain(String resourceGroupName, String serviceName, String gatewayName,
