...
public final class GatewayCustomDomainResourceImpl
    ...
    public GatewayCustomDomainResourceImpl withExistingGateway(String resourceGroupName, String serviceName,
        String gatewayName) {
    ...
    public GatewayCustomDomainResource create() {
        this.innerObject = serviceManager.serviceClient().getGatewayCustomDomains().createOrUpdate(resourceGroupName,
            serviceName, gatewayName, domainName, this.innerModel(), Context.NONE);
        return this;
    }

    public GatewayCustomDomainResource create(Context context) {
        this.innerObject = serviceManager.serviceClient().getGatewayCustomDomains().createOrUpdate(resourceGroupName,
            serviceName, gatewayName, domainName, this.innerModel(), context);
        return this;
    }

    GatewayCustomDomainResourceImpl(String name,
    ...
    GatewayCustomDomainResourceImpl(GatewayCustomDomainResourceInner innerObject,
        com.azure.resourcemanager.appplatform.generated.AppPlatformManager serviceManager) {
    ...
    public GatewayCustomDomainResource refresh() {
        this.innerObject = serviceManager.serviceClient().getGatewayCustomDomains()
            .getWithResponse(resourceGroupName, serviceName, gatewayName, domainName, Context.NONE).getValue();
        return this;
    }

    public GatewayCustomDomainResource refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getGatewayCustomDomains()
            .getWithResponse(resourceGroupName, serviceName, gatewayName, domainName, context).getValue();
        return this;
    }
