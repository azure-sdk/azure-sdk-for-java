...
public final class CustomDomainsImpl implements CustomDomains {
    ...
    public Response<CustomDomainResource> getWithResponse(String resourceGroupName, String serviceName, String appName,
    ...
    public PagedIterable<CustomDomainResource> list(String resourceGroupName, String serviceName, String appName) {
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new CustomDomainResourceImpl(inner1, this.manager()));
    }
