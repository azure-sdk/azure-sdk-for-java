...
@Fluent
public final class NetworkProfileAutoGenerated {
    /*
     ...
     * @return the NetworkProfileAutoGenerated object itself.
     */
    public NetworkProfileAutoGenerated withServiceRuntimeSubnetId(String serviceRuntimeSubnetId) {
     ...
     * @return the NetworkProfileAutoGenerated object itself.
     */
    public NetworkProfileAutoGenerated withAppSubnetId(String appSubnetId) {
     ...
     * @return the NetworkProfileAutoGenerated object itself.
     */
    public NetworkProfileAutoGenerated withServiceCidr(String serviceCidr) {
     ...
     * @return the NetworkProfileAutoGenerated object itself.
     */
    public NetworkProfileAutoGenerated withServiceRuntimeNetworkResourceGroup(
     ...
     * @return the NetworkProfileAutoGenerated object itself.
     */
    public NetworkProfileAutoGenerated withAppNetworkResourceGroup(String appNetworkResourceGroup) {
