...
public final class ServiceResourceInner extends Resource {
     ...
     * @return the ServiceResourceInner object itself.
     */
    public ServiceResourceInner withIdentity(SystemAssignedServiceIdentity identity) {
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("id".equals(fieldName)) {
                    ...
                    deserializedServiceResourceInner.identity = SystemAssignedServiceIdentity.fromJson(reader);
