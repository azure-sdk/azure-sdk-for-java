...
public final class RuntimeVersionsClientImpl implements RuntimeVersionsClient {
    ...
    private interface RuntimeVersionsService {
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<AvailableRuntimeVersionsAutoGeneratedInner>> listRuntimeVersions(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept,
            Context context);
    ...
    private Mono<Response<AvailableRuntimeVersionsInner>> listRuntimeVersionsWithResponseAsync() {
        ...
        return FluxUtil
            .withContext(context -> service.listRuntimeVersions(this.client.getEndpoint(), apiVersion, accept, context))
    ...
    private Mono<Response<AvailableRuntimeVersionsInner>> listRuntimeVersionsWithResponseAsync(Context context) {
        ...
        return service.listRuntimeVersions(this.client.getEndpoint(), apiVersion, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<AvailableRuntimeVersionsAutoGeneratedInner>> listRuntimeVersionsWithResponseAsync() {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<AvailableRuntimeVersionsAutoGeneratedInner> listRuntimeVersionsAsync() {
        return listRuntimeVersionsWithResponseAsync().flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public AvailableRuntimeVersionsAutoGeneratedInner listRuntimeVersions() {
        return listRuntimeVersionsAsync().block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<AvailableRuntimeVersionsAutoGeneratedInner> listRuntimeVersionsWithResponse(Context context) {
        return listRuntimeVersionsWithResponseAsync(context).block();
    }
}
