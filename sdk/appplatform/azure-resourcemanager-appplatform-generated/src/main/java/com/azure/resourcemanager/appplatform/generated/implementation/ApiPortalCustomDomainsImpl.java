...
public final class ApiPortalCustomDomainsImpl implements ApiPortalCustomDomains {
    ...
    public ApiPortalCustomDomainsImpl(ApiPortalCustomDomainsClient innerClient,
        com.azure.resourcemanager.appplatform.generated.AppPlatformManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public Response<ApiPortalCustomDomainResource> getWithResponse(String resourceGroupName, String serviceName,
    ...
    public ApiPortalCustomDomainResource get(String resourceGroupName, String serviceName, String apiPortalName,
        String domainName) {
    ...
    public PagedIterable<ApiPortalCustomDomainResource> list(String resourceGroupName, String serviceName,
        ...
        return ResourceManagerUtils.mapPage(inner,
            inner1 -> new ApiPortalCustomDomainResourceImpl(inner1, this.manager()));
    }
