        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("thumbprint".equals(fieldName)) {
                    deserializedKeyVaultCertificateProperties.withThumbprint(reader.getString());
                } else if ("issuer".equals(fieldName)) {
                    deserializedKeyVaultCertificateProperties.withIssuer(reader.getString());
                } else if ("issuedDate".equals(fieldName)) {
                    deserializedKeyVaultCertificateProperties.withIssuedDate(reader.getString());
                } else if ("expirationDate".equals(fieldName)) {
                    deserializedKeyVaultCertificateProperties.withExpirationDate(reader.getString());
                } else if ("activateDate".equals(fieldName)) {
                    deserializedKeyVaultCertificateProperties.withActivateDate(reader.getString());
                } else if ("subjectName".equals(fieldName)) {
                    deserializedKeyVaultCertificateProperties.withSubjectName(reader.getString());
                } else if ("dnsNames".equals(fieldName)) {
                    List<String> dnsNames = reader.readArray(reader1 -> reader1.getString());
                    deserializedKeyVaultCertificateProperties.withDnsNames(dnsNames);
                } else if ("provisioningState".equals(fieldName)) {
                    deserializedKeyVaultCertificateProperties
