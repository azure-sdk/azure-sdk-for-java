...
public final class ApiPortalResourceImpl
    ...
    public ApiPortalResource create() {
        this.innerObject = serviceManager.serviceClient().getApiPortals().createOrUpdate(resourceGroupName, serviceName,
            apiPortalName, this.innerModel(), Context.NONE);
        return this;
    }

    public ApiPortalResource create(Context context) {
        this.innerObject = serviceManager.serviceClient().getApiPortals().createOrUpdate(resourceGroupName, serviceName,
            apiPortalName, this.innerModel(), context);
        return this;
    }

    ApiPortalResourceImpl(String name,
    ...
    ApiPortalResourceImpl(ApiPortalResourceInner innerObject,
        com.azure.resourcemanager.appplatform.generated.AppPlatformManager serviceManager) {
    ...
    public ApiPortalResource refresh() {
        this.innerObject = serviceManager.serviceClient().getApiPortals()
            .getWithResponse(resourceGroupName, serviceName, apiPortalName, Context.NONE).getValue();
        return this;
    }

    public ApiPortalResource refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getApiPortals()
            .getWithResponse(resourceGroupName, serviceName, apiPortalName, context).getValue();
        return this;
    }

    public Response<CustomDomainValidateResult> validateDomainWithResponse(CustomDomainValidatePayload validatePayload,
        Context context) {
        return serviceManager.apiPortals().validateDomainWithResponse(resourceGroupName, serviceName, apiPortalName,
            validatePayload, context);
    }

    public CustomDomainValidateResult validateDomain(CustomDomainValidatePayload validatePayload) {
        return serviceManager.apiPortals().validateDomain(resourceGroupName, serviceName, apiPortalName,
            validatePayload);
    }
