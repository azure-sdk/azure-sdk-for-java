...
public final class BuildpackBindingsImpl implements BuildpackBindings {
    ...
    public Response<BuildpackBindingResource> getWithResponse(String resourceGroupName, String serviceName,
        ...
        Response<BuildpackBindingResourceInner> inner = this.serviceClient()
            .getWithResponse(resourceGroupName, serviceName, buildServiceName, builderName, buildpackBindingName,
                context);
        if (inner != null) {
    ...
    public BuildpackBindingResource get(String resourceGroupName, String serviceName, String buildServiceName,
        ...
        BuildpackBindingResourceInner inner = this.serviceClient()
