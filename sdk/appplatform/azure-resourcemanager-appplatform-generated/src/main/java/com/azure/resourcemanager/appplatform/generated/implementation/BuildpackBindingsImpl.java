...
public final class BuildpackBindingsImpl implements BuildpackBindings {
    ...
    public BuildpackBindingsImpl(BuildpackBindingsClient innerClient,
        com.azure.resourcemanager.appplatform.generated.AppPlatformManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public PagedIterable<BuildpackBindingResource> listForCluster(String resourceGroupName, String serviceName) {
        PagedIterable<BuildpackBindingResourceInner> inner
            = this.serviceClient().listForCluster(resourceGroupName, serviceName);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new BuildpackBindingResourceImpl(inner1, this.manager()));
    }

    public PagedIterable<BuildpackBindingResource> listForCluster(String resourceGroupName, String serviceName,
        Context context) {
        PagedIterable<BuildpackBindingResourceInner> inner
            = this.serviceClient().listForCluster(resourceGroupName, serviceName, context);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new BuildpackBindingResourceImpl(inner1, this.manager()));
    }

    public Response<BuildpackBindingResource> getWithResponse(String resourceGroupName, String serviceName,
        String buildServiceName, String builderName, String buildpackBindingName, Context context) {
        Response<BuildpackBindingResourceInner> inner = this.serviceClient().getWithResponse(resourceGroupName,
            serviceName, buildServiceName, builderName, buildpackBindingName, context);
        if (inner != null) {
    ...
    public BuildpackBindingResource get(String resourceGroupName, String serviceName, String buildServiceName,
        String builderName, String buildpackBindingName) {
        BuildpackBindingResourceInner inner = this.serviceClient().get(resourceGroupName, serviceName, buildServiceName,
            builderName, buildpackBindingName);
        if (inner != null) {
    ...
    public void delete(String resourceGroupName, String serviceName, String buildServiceName, String builderName,
        ...
        this.serviceClient().delete(resourceGroupName, serviceName, buildServiceName, builderName, buildpackBindingName,
            context);
    }

    public PagedIterable<BuildpackBindingResource> list(String resourceGroupName, String serviceName,
    ...
    public BuildpackBindingResource getById(String id) {
        ...
        String buildpackBindingName = ResourceManagerUtils.getValueFromIdByName(id, "buildpackBindings");
        if (buildpackBindingName == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
                String.format("The resource ID '%s' is not valid. Missing path segment 'buildpackBindings'.", id)));
        }
        return this.getWithResponse(resourceGroupName, serviceName, buildServiceName, builderName, buildpackBindingName,
