...
public final class GatewayRouteConfigsImpl implements GatewayRouteConfigs {
    ...
    public GatewayRouteConfigsImpl(GatewayRouteConfigsClient innerClient,
        com.azure.resourcemanager.appplatform.generated.AppPlatformManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public Response<GatewayRouteConfigResource> getWithResponse(String resourceGroupName, String serviceName,
        String gatewayName, String routeConfigName, Context context) {
        Response<GatewayRouteConfigResourceInner> inner = this.serviceClient().getWithResponse(resourceGroupName,
            serviceName, gatewayName, routeConfigName, context);
        if (inner != null) {
    ...
    public GatewayRouteConfigResource get(String resourceGroupName, String serviceName, String gatewayName,
    ...
    public PagedIterable<GatewayRouteConfigResource> list(String resourceGroupName, String serviceName,
        String gatewayName) {
        ...
        return ResourceManagerUtils.mapPage(inner,
            inner1 -> new GatewayRouteConfigResourceImpl(inner1, this.manager()));
    }
    ...
    public GatewayRouteConfigResource getById(String id) {
        ...
        String routeConfigName = ResourceManagerUtils.getValueFromIdByName(id, "routeConfigs");
        if (routeConfigName == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
                String.format("The resource ID '%s' is not valid. Missing path segment 'routeConfigs'.", id)));
        }
        return this.getWithResponse(resourceGroupName, serviceName, gatewayName, routeConfigName, Context.NONE)
            .getValue();
    }
