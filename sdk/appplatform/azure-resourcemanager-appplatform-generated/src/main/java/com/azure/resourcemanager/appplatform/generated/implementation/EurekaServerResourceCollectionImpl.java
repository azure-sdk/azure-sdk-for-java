...
public final class EurekaServerResourceCollectionImpl implements EurekaServerResourceCollection {
    ...
    EurekaServerResourceCollectionImpl(EurekaServerResourceCollectionInner innerObject,
    ...
    public List<EurekaServerResource> value() {
        ...
        if (inner != null) {
            return Collections.unmodifiableList(inner.stream()
                .map(inner1 -> new EurekaServerResourceImpl(inner1, this.manager())).collect(Collectors.toList()));
        } else {
