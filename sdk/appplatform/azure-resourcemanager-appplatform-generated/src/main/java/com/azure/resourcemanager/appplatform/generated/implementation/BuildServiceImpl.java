...
public final class BuildServiceImpl implements BuildService, BuildService.Definition, BuildService.Update {
    ...
    public BuildService create() {
        this.innerObject = serviceManager.serviceClient().getBuildServices().createOrUpdate(resourceGroupName,
            serviceName, buildServiceName, this.innerModel(), Context.NONE);
        return this;
    }

    public BuildService create(Context context) {
        this.innerObject = serviceManager.serviceClient().getBuildServices().createOrUpdate(resourceGroupName,
            serviceName, buildServiceName, this.innerModel(), context);
        return this;
    }
    ...
    public BuildService refresh() {
        this.innerObject = serviceManager.serviceClient().getBuildServices()
            .getBuildServiceWithResponse(resourceGroupName, serviceName, buildServiceName, Context.NONE).getValue();
        return this;
    }

    public BuildService refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getBuildServices()
            .getBuildServiceWithResponse(resourceGroupName, serviceName, buildServiceName, context).getValue();
        return this;
    }

    public Response<ResourceUploadDefinition> getResourceUploadUrlWithResponse(Context context) {
        return serviceManager.buildServices().getResourceUploadUrlWithResponse(resourceGroupName, serviceName,
            buildServiceName, context);
    }
