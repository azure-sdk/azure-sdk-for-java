...
public final class AppsImpl implements Apps {
    ...
    public AppResourceAutoGenerated get(String resourceGroupName, String serviceName, String appName) {
        AppResourceAutoGeneratedInner inner = this.serviceClient().get(resourceGroupName, serviceName, appName);
        if (inner != null) {
            return new AppResourceAutoGeneratedImpl(inner, this.manager());
        } else {
            return null;
        }
    }

    public Response<AppResourceAutoGenerated> getWithResponse(
        String resourceGroupName, String serviceName, String appName, String syncStatus, Context context) {
        Response<AppResourceAutoGeneratedInner> inner =
            this.serviceClient().getWithResponse(resourceGroupName, serviceName, appName, syncStatus, context);
        if (inner != null) {
            return new SimpleResponse<>(
                inner.getRequest(),
                inner.getStatusCode(),
                inner.getHeaders(),
                new AppResourceAutoGeneratedImpl(inner.getValue(), this.manager()));
        } else {
            return null;
        }
    }
    ...
    public PagedIterable<AppResourceAutoGenerated> list(String resourceGroupName, String serviceName) {
        PagedIterable<AppResourceAutoGeneratedInner> inner = this.serviceClient().list(resourceGroupName, serviceName);
        return Utils.mapPage(inner, inner1 -> new AppResourceAutoGeneratedImpl(inner1, this.manager()));
    }

    public PagedIterable<AppResourceAutoGenerated> list(String resourceGroupName, String serviceName, Context context) {
        PagedIterable<AppResourceAutoGeneratedInner> inner =
    ...
    public AppResourceAutoGenerated setActiveDeployments(
        ...
        String appName,
        ActiveDeploymentCollection activeDeploymentCollection) {
        AppResourceAutoGeneratedInner inner =
            this
                .serviceClient()
                .setActiveDeployments(resourceGroupName, serviceName, appName, activeDeploymentCollection);
        if (inner != null) {
    ...
    public AppResourceAutoGeneratedImpl define(String name) {
        return new AppResourceAutoGeneratedImpl(name, this.manager());
    }
}
