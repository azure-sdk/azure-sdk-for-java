...
public final class AppsImpl implements Apps {
    ...
    public AppsImpl(AppsClient innerClient,
        com.azure.resourcemanager.appplatform.generated.AppPlatformManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public Response<AppResource> getWithResponse(String resourceGroupName, String serviceName, String appName,
    ...
    public PagedIterable<AppResource> list(String resourceGroupName, String serviceName) {
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new AppResourceImpl(inner1, this.manager()));
    }
    ...
    public AppResource setActiveDeployments(String resourceGroupName, String serviceName, String appName,
        ActiveDeploymentCollection activeDeploymentCollection) {
        AppResourceInner inner = this.serviceClient().setActiveDeployments(resourceGroupName, serviceName, appName,
    ...
    public CustomDomainValidateResult validateDomain(String resourceGroupName, String serviceName, String appName,
