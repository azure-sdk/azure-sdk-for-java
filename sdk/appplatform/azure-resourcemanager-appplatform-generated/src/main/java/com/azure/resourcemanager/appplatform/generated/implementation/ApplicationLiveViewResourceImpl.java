...
public final class ApplicationLiveViewResourceImpl
    ...
    public ApplicationLiveViewResource create() {
        this.innerObject = serviceManager.serviceClient().getApplicationLiveViews().createOrUpdate(resourceGroupName,
            serviceName, applicationLiveViewName, this.innerModel(), Context.NONE);
        return this;
    }

    public ApplicationLiveViewResource create(Context context) {
        this.innerObject = serviceManager.serviceClient().getApplicationLiveViews().createOrUpdate(resourceGroupName,
            serviceName, applicationLiveViewName, this.innerModel(), context);
        return this;
    }
    ...
    public ApplicationLiveViewResource refresh() {
        this.innerObject = serviceManager.serviceClient().getApplicationLiveViews()
            .getWithResponse(resourceGroupName, serviceName, applicationLiveViewName, Context.NONE).getValue();
        return this;
    }

    public ApplicationLiveViewResource refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getApplicationLiveViews()
            .getWithResponse(resourceGroupName, serviceName, applicationLiveViewName, context).getValue();
        return this;
    }
