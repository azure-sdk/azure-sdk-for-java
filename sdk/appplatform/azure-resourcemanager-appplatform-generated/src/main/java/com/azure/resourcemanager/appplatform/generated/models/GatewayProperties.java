...
public final class GatewayProperties implements JsonSerializable<GatewayProperties> {
     ...
     */
    private GatewayResponseCacheProperties responseCacheProperties;
    ...
    /**
     * Get the addonConfigs property: Collection of addons for Spring Cloud Gateway.
     * 
    ...
    /**
     * Set the addonConfigs property: Collection of addons for Spring Cloud Gateway.
     * 
     * @param addonConfigs the addonConfigs value to set.
     * @return the GatewayProperties object itself.
     */
    public GatewayProperties withAddonConfigs(Map<String, Object> addonConfigs) {
    ...
    /**
     * Get the responseCacheProperties property: The properties to configure different types of response cache for
     * Spring Cloud Gateway.
     * 
     * @return the responseCacheProperties value.
     */
    public GatewayResponseCacheProperties responseCacheProperties() {
        return this.responseCacheProperties;
    }

    /**
     * Set the responseCacheProperties property: The properties to configure different types of response cache for
     * Spring Cloud Gateway.
     * 
     * @param responseCacheProperties the responseCacheProperties value to set.
     * @return the GatewayProperties object itself.
     */
    public GatewayProperties withResponseCacheProperties(GatewayResponseCacheProperties responseCacheProperties) {
    ...
    public void validate() {
        ...
        if (responseCacheProperties() != null) {
            responseCacheProperties().validate();
        }
    }
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeArrayField("apmTypes", this.apmTypes,
        ...
        jsonWriter.writeMapField("addonConfigs", this.addonConfigs, (writer, element) -> writer.writeUntyped(element));
        jsonWriter.writeJsonField("responseCacheProperties", this.responseCacheProperties);
    ...
    public static GatewayProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("provisioningState".equals(fieldName)) {
                ...
                } else if ("apmTypes".equals(fieldName)) {
                    List<ApmType> apmTypes = reader.readArray(reader1 -> ApmType.fromString(reader1.getString()));
                    deserializedGatewayProperties.apmTypes = apmTypes;
                    ...
                    Map<String, Object> addonConfigs = reader.readMap(reader1 -> reader1.readUntyped());
                    deserializedGatewayProperties.addonConfigs = addonConfigs;
                ...
                } else if ("responseCacheProperties".equals(fieldName)) {
                    deserializedGatewayProperties.responseCacheProperties
                        = GatewayResponseCacheProperties.fromJson(reader);
                } else {
                    reader.skipChildren();
                }
            }
