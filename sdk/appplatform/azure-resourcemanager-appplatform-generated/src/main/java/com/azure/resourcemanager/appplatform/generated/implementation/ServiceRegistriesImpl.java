...
public final class ServiceRegistriesImpl implements ServiceRegistries {
    ...
    public ServiceRegistriesImpl(ServiceRegistriesClient innerClient,
        com.azure.resourcemanager.appplatform.generated.AppPlatformManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public Response<ServiceRegistryResource> getWithResponse(String resourceGroupName, String serviceName,
    ...
    public ServiceRegistryResource createOrUpdate(String resourceGroupName, String serviceName,
    ...
    public PagedIterable<ServiceRegistryResource> list(String resourceGroupName, String serviceName) {
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new ServiceRegistryResourceImpl(inner1, this.manager()));
    }
