...
public final class AppResourceImpl implements AppResource, AppResource.Definition, AppResource.Update {
    ...
    public AppResource create() {
        this.innerObject = serviceManager.serviceClient().getApps().createOrUpdate(resourceGroupName, serviceName,
            appName, this.innerModel(), Context.NONE);
        return this;
    }

    public AppResource create(Context context) {
        this.innerObject = serviceManager.serviceClient().getApps().createOrUpdate(resourceGroupName, serviceName,
            appName, this.innerModel(), context);
        return this;
    }
    ...
    public AppResource apply() {
        this.innerObject = serviceManager.serviceClient().getApps().update(resourceGroupName, serviceName, appName,
    ...
    AppResourceImpl(AppResourceInner innerObject,
    ...
    public AppResource refresh() {
        ...
        this.innerObject = serviceManager.serviceClient().getApps()
            .getWithResponse(resourceGroupName, serviceName, appName, localSyncStatus, Context.NONE).getValue();
        return this;
    }
    ...
    public AppResource refresh(Context context) {
        String localSyncStatus = null;
        this.innerObject = serviceManager.serviceClient().getApps()
            .getWithResponse(resourceGroupName, serviceName, appName, localSyncStatus, context).getValue();
        return this;
    }
    ...
    public AppResource setActiveDeployments(ActiveDeploymentCollection activeDeploymentCollection) {
        return serviceManager.apps().setActiveDeployments(resourceGroupName, serviceName, appName,
    ...
    public AppResource setActiveDeployments(ActiveDeploymentCollection activeDeploymentCollection, Context context) {
        return serviceManager.apps().setActiveDeployments(resourceGroupName, serviceName, appName,
            activeDeploymentCollection, context);
    }

    public Response<CustomDomainValidateResult> validateDomainWithResponse(CustomDomainValidatePayload validatePayload,
        Context context) {
        return serviceManager.apps().validateDomainWithResponse(resourceGroupName, serviceName, appName,
