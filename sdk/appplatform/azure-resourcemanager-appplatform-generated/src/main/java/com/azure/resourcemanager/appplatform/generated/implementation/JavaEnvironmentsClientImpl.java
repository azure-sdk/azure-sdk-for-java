...
public final class JavaEnvironmentsClientImpl implements JavaEnvironmentsClient {
    ...
    public interface JavaEnvironmentsService {
        ...
        Mono<Response<JavaEnvironmentsCollection>> list(
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<JavaEnvironmentsCollection>> listByResourceGroup(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<JavaEnvironmentInner>> getByResourceGroup(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
    ...
    private Mono<PagedResponse<JavaEnvironmentInner>> listSinglePageAsync() {
        ...
        return FluxUtil
            ...
            .<PagedResponse<JavaEnvironmentInner>>map(
                res ->
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<JavaEnvironmentInner>> listByResourceGroupSinglePageAsync(
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a Java Environment and its properties along with {@link Response} on successful completion of {@link
     *     Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<JavaEnvironmentInner>> getByResourceGroupWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<JavaEnvironmentInner> getByResourceGroupWithResponse(
        String resourceGroupName, String javaEnvironmentName, Context context) {
     ...
     *
     * <p>Create a new Java Environment or update an exiting Java Environment.
     *
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
     * @param javaEnvironmentName Name of the Java Environment.
    ...
    private PollerFlux<PollResult<JavaEnvironmentInner>, JavaEnvironmentInner> beginCreateOrUpdateAsync(
        ...
        return this
            .client
            .<JavaEnvironmentInner, JavaEnvironmentInner>getLroResult(
                mono,
                this.client.getHttpPipeline(),
                JavaEnvironmentInner.class,
                JavaEnvironmentInner.class,
    ...
    private PollerFlux<PollResult<JavaEnvironmentInner>, JavaEnvironmentInner> beginCreateOrUpdateAsync(
        ...
        return this
            .client
            .<JavaEnvironmentInner, JavaEnvironmentInner>getLroResult(
                mono, this.client.getHttpPipeline(), JavaEnvironmentInner.class, JavaEnvironmentInner.class, context);
    }
    ...
    public SyncPoller<PollResult<JavaEnvironmentInner>, JavaEnvironmentInner> beginCreateOrUpdate(
        String resourceGroupName, String javaEnvironmentName, JavaEnvironmentInner environmentEnvelope) {
        return this
            .beginCreateOrUpdateAsync(resourceGroupName, javaEnvironmentName, environmentEnvelope)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<JavaEnvironmentInner>, JavaEnvironmentInner> beginCreateOrUpdate(
        ...
        Context context) {
        return this
            .beginCreateOrUpdateAsync(resourceGroupName, javaEnvironmentName, environmentEnvelope, context)
            .getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<JavaEnvironmentInner> createOrUpdateAsync(
        String resourceGroupName, String javaEnvironmentName, JavaEnvironmentInner environmentEnvelope) {
        return beginCreateOrUpdateAsync(resourceGroupName, javaEnvironmentName, environmentEnvelope)
            .last()
    ...
    private Mono<JavaEnvironmentInner> createOrUpdateAsync(
        ...
        JavaEnvironmentInner environmentEnvelope,
        Context context) {
        return beginCreateOrUpdateAsync(resourceGroupName, javaEnvironmentName, environmentEnvelope, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public JavaEnvironmentInner createOrUpdate(
        String resourceGroupName, String javaEnvironmentName, JavaEnvironmentInner environmentEnvelope) {
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String javaEnvironmentName) {
        return beginDeleteAsync(resourceGroupName, javaEnvironmentName)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String javaEnvironmentName, Context context) {
        return beginDeleteAsync(resourceGroupName, javaEnvironmentName, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     *
     * <p>Operation to update an exiting Java Environment.
     *
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
     * @param javaEnvironmentName Name of the Java Environment.
     * @param environmentEnvelope Configuration details of the Java Environment.
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<JavaEnvironmentInner>, JavaEnvironmentInner> beginUpdate(
        String resourceGroupName, String javaEnvironmentName, JavaEnvironmentForPatchBody environmentEnvelope) {
    ...
    public SyncPoller<PollResult<JavaEnvironmentInner>, JavaEnvironmentInner> beginUpdate(
        ...
        Context context) {
        return this
            .beginUpdateAsync(resourceGroupName, javaEnvironmentName, environmentEnvelope, context)
            .getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<JavaEnvironmentInner> updateAsync(
        String resourceGroupName, String javaEnvironmentName, JavaEnvironmentForPatchBody environmentEnvelope) {
        return beginUpdateAsync(resourceGroupName, javaEnvironmentName, environmentEnvelope)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<JavaEnvironmentInner> updateAsync(
        ...
        JavaEnvironmentForPatchBody environmentEnvelope,
        Context context) {
        return beginUpdateAsync(resourceGroupName, javaEnvironmentName, environmentEnvelope, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public JavaEnvironmentInner update(
        String resourceGroupName, String javaEnvironmentName, JavaEnvironmentForPatchBody environmentEnvelope) {
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return collection of Java Environments along with {@link PagedResponse} on successful completion of {@link
     *     Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<JavaEnvironmentInner>> listBySubscriptionNextSinglePageAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<JavaEnvironmentInner>> listByResourceGroupNextSinglePageAsync(
        String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
