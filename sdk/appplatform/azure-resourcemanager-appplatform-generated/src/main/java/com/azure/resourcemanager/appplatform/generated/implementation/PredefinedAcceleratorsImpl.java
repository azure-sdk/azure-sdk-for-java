...
public final class PredefinedAcceleratorsImpl implements PredefinedAccelerators {
    ...
    public Response<PredefinedAcceleratorResource> getWithResponse(String resourceGroupName, String serviceName,
        ...
        Response<PredefinedAcceleratorResourceInner> inner = this.serviceClient().getWithResponse(resourceGroupName,
            serviceName, applicationAcceleratorName, predefinedAcceleratorName, context);
        if (inner != null) {
    ...
    public PredefinedAcceleratorResource get(String resourceGroupName, String serviceName,
        ...
        PredefinedAcceleratorResourceInner inner = this.serviceClient().get(resourceGroupName, serviceName,
    ...
    public void disable(String resourceGroupName, String serviceName, String applicationAcceleratorName,
        ...
        this.serviceClient().disable(resourceGroupName, serviceName, applicationAcceleratorName,
    ...
    public void disable(String resourceGroupName, String serviceName, String applicationAcceleratorName,
        ...
        this.serviceClient().disable(resourceGroupName, serviceName, applicationAcceleratorName,
            predefinedAcceleratorName, context);
    }

    public void enable(String resourceGroupName, String serviceName, String applicationAcceleratorName,
        String predefinedAcceleratorName) {
        this.serviceClient().enable(resourceGroupName, serviceName, applicationAcceleratorName,
            predefinedAcceleratorName);
    }
