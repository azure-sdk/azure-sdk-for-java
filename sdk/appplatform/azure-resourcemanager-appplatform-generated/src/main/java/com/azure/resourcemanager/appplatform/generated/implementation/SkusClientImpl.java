...
public final class SkusClientImpl implements SkusClient {
    ...
    public interface SkusService {
        ...
        Mono<Response<ResourceSkuCollection>> list(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ResourceSkuCollection>> listNext(@PathParam(value = "nextLink", encoded = true) String nextLink,
     ...
     * @return object that includes an array of Azure Spring Apps SKU and a possible link for next set along with
