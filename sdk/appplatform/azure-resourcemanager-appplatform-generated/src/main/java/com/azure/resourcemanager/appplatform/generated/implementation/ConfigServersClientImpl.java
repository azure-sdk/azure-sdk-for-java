...
public final class ConfigServersClientImpl implements ConfigServersClient {
    ...
    private interface ConfigServersService {
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ConfigServerResourceAutoGeneratedInner>> get(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
        ...
        Mono<Response<Flux<ByteBuffer>>> updatePut(
            ...
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("serviceName") String serviceName,
            @BodyParam("application/json") ConfigServerResourceAutoGeneratedInner configServerResource,
            @HeaderParam("Accept") String accept,
            Context context);
        ...
        Mono<Response<Flux<ByteBuffer>>> validate(
            ...
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("serviceName") String serviceName,
            @BodyParam("application/json") ConfigServerSettingsAutoGenerated configServerSettings,
            @HeaderParam("Accept") String accept,
            Context context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ConfigServerResourceAutoGeneratedInner>> getWithResponseAsync(
        String resourceGroupName, String serviceName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ConfigServerResourceAutoGeneratedInner> getAsync(String resourceGroupName, String serviceName) {
        return getWithResponseAsync(resourceGroupName, serviceName).flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ConfigServerResourceAutoGeneratedInner get(String resourceGroupName, String serviceName) {
        return getAsync(resourceGroupName, serviceName).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ConfigServerResourceAutoGeneratedInner> getWithResponse(
        String resourceGroupName, String serviceName, Context context) {
        return getWithResponseAsync(resourceGroupName, serviceName, context).block();
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> updatePutWithResponseAsync(
        String resourceGroupName, String serviceName, ConfigServerResourceAutoGeneratedInner configServerResource) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    private Mono<Response<Flux<ByteBuffer>>> updatePutWithResponseAsync(
        ...
        String serviceName,
        ConfigServerResourceAutoGeneratedInner configServerResource,
        Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<ConfigServerResourceAutoGeneratedInner>, ConfigServerResourceAutoGeneratedInner>
        beginUpdatePutAsync(
            String resourceGroupName, String serviceName, ConfigServerResourceAutoGeneratedInner configServerResource) {
        Mono<Response<Flux<ByteBuffer>>> mono =
            updatePutWithResponseAsync(resourceGroupName, serviceName, configServerResource);
        return this
            .client
            .<ConfigServerResourceAutoGeneratedInner, ConfigServerResourceAutoGeneratedInner>getLroResult(
                mono,
                this.client.getHttpPipeline(),
                ConfigServerResourceAutoGeneratedInner.class,
                ConfigServerResourceAutoGeneratedInner.class,
                this.client.getContext());
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<ConfigServerResourceAutoGeneratedInner>, ConfigServerResourceAutoGeneratedInner>
        beginUpdatePut(
            String resourceGroupName, String serviceName, ConfigServerResourceAutoGeneratedInner configServerResource) {
        return beginUpdatePutAsync(resourceGroupName, serviceName, configServerResource).getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ConfigServerResourceAutoGeneratedInner> updatePutAsync(
        String resourceGroupName, String serviceName, ConfigServerResourceAutoGeneratedInner configServerResource) {
        return beginUpdatePutAsync(resourceGroupName, serviceName, configServerResource)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ConfigServerResourceAutoGeneratedInner updatePut(
        String resourceGroupName, String serviceName, ConfigServerResourceAutoGeneratedInner configServerResource) {
        return updatePutAsync(resourceGroupName, serviceName, configServerResource).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ConfigServerResourceAutoGeneratedInner> updatePatchAsync(
        String resourceGroupName, String serviceName, ConfigServerResourceAutoGeneratedInner configServerResource) {
        return beginUpdatePatchAsync(resourceGroupName, serviceName, configServerResource)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ConfigServerResourceAutoGeneratedInner updatePatch(
        String resourceGroupName, String serviceName, ConfigServerResourceAutoGeneratedInner configServerResource) {
        return updatePatchAsync(resourceGroupName, serviceName, configServerResource).block();
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> validateWithResponseAsync(
        String resourceGroupName, String serviceName, ConfigServerSettingsAutoGenerated configServerSettings) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    private Mono<Response<Flux<ByteBuffer>>> validateWithResponseAsync(
        String resourceGroupName,
        String serviceName,
        ConfigServerSettingsAutoGenerated configServerSettings,
        Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
    ...
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<
            PollResult<ConfigServerSettingsValidateResultAutoGeneratedInner>,
            ConfigServerSettingsValidateResultAutoGeneratedInner>
        beginValidateAsync(
            String resourceGroupName, String serviceName, ConfigServerSettingsAutoGenerated configServerSettings) {
        Mono<Response<Flux<ByteBuffer>>> mono =
            validateWithResponseAsync(resourceGroupName, serviceName, configServerSettings);
        return this
            ...
            .<ConfigServerSettingsValidateResultAutoGeneratedInner,
                ...
                getLroResult(
                    mono,
                    this.client.getHttpPipeline(),
                    ConfigServerSettingsValidateResultAutoGeneratedInner.class,
                    ConfigServerSettingsValidateResultAutoGeneratedInner.class,
                    this.client.getContext());
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ConfigServerSettingsValidateResultAutoGeneratedInner> validateAsync(
        String resourceGroupName, String serviceName, ConfigServerSettingsAutoGenerated configServerSettings) {
        return beginValidateAsync(resourceGroupName, serviceName, configServerSettings)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ConfigServerSettingsValidateResultAutoGeneratedInner validate(
        String resourceGroupName, String serviceName, ConfigServerSettingsAutoGenerated configServerSettings) {
        return validateAsync(resourceGroupName, serviceName, configServerSettings).block();
    }
