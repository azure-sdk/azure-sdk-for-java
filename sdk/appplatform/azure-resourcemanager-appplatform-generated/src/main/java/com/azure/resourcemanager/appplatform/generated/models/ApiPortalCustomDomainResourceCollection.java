...
public final class ApiPortalCustomDomainResourceCollection
    implements JsonSerializable<ApiPortalCustomDomainResourceCollection> {
    /*
    ...
    /**
     * Reads an instance of ApiPortalCustomDomainResourceCollection from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of ApiPortalCustomDomainResourceCollection if the JsonReader was pointing to an instance of
     * it, or null if it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the ApiPortalCustomDomainResourceCollection.
     */
    public static ApiPortalCustomDomainResourceCollection fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ApiPortalCustomDomainResourceCollection deserializedApiPortalCustomDomainResourceCollection
                = new ApiPortalCustomDomainResourceCollection();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("value".equals(fieldName)) {
                    List<ApiPortalCustomDomainResourceInner> value
                        = reader.readArray(reader1 -> ApiPortalCustomDomainResourceInner.fromJson(reader1));
                    deserializedApiPortalCustomDomainResourceCollection.value = value;
                } else if ("nextLink".equals(fieldName)) {
                    deserializedApiPortalCustomDomainResourceCollection.nextLink = reader.getString();
                } else {
                    reader.skipChildren();
                }
            }

            return deserializedApiPortalCustomDomainResourceCollection;
        });
    }
}
