...
public final class JavaAppsClientImpl implements JavaAppsClient {
    ...
    public interface JavaAppsService {
        ...
        Mono<Response<JavaAppsCollection>> list(
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<JavaAppsCollection>> listByResourceGroup(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<JavaAppInner>> getByResourceGroup(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
        ...
        Mono<Response<Flux<ByteBuffer>>> createOrUpdate(
            ...
            @PathParam("appName") String appName,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") JavaAppInner appEnvelope,
            @HeaderParam("Accept") String accept,
            Context context);
        ...
        Mono<Response<Flux<ByteBuffer>>> update(
            ...
            @PathParam("appName") String appName,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") JavaAppForPatch appEnvelope,
            @HeaderParam("Accept") String accept,
            Context context);
     ...
     * @return the JavaApps in a given subscription along with {@link PagedResponse} on successful completion of {@link
     *     Mono}.
     */
    ...
    private Mono<PagedResponse<JavaAppInner>> listSinglePageAsync() {
        ...
        return FluxUtil
            ...
            .<PagedResponse<JavaAppInner>>map(
                res ->
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<JavaAppInner>> listByResourceGroupSinglePageAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<JavaAppInner>> getByResourceGroupWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<JavaAppInner> getByResourceGroupWithResponse(
        String resourceGroupName, String appName, Context context) {
    ...
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(
        String resourceGroupName, String appName, JavaAppInner appEnvelope) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(
        String resourceGroupName, String appName, JavaAppInner appEnvelope, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    private PollerFlux<PollResult<JavaAppInner>, JavaAppInner> beginCreateOrUpdateAsync(
        String resourceGroupName, String appName, JavaAppInner appEnvelope) {
        Mono<Response<Flux<ByteBuffer>>> mono =
            createOrUpdateWithResponseAsync(resourceGroupName, appName, appEnvelope);
        return this
            .client
            .<JavaAppInner, JavaAppInner>getLroResult(
                mono, this.client.getHttpPipeline(), JavaAppInner.class, JavaAppInner.class, this.client.getContext());
    }
    ...
    private PollerFlux<PollResult<JavaAppInner>, JavaAppInner> beginCreateOrUpdateAsync(
        ...
        return this
            .client
            .<JavaAppInner, JavaAppInner>getLroResult(
                mono, this.client.getHttpPipeline(), JavaAppInner.class, JavaAppInner.class, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<JavaAppInner>, JavaAppInner> beginCreateOrUpdate(
        String resourceGroupName, String appName, JavaAppInner appEnvelope) {
    ...
    private Mono<JavaAppInner> createOrUpdateAsync(String resourceGroupName, String appName, JavaAppInner appEnvelope) {
        return beginCreateOrUpdateAsync(resourceGroupName, appName, appEnvelope)
            .last()
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<JavaAppInner> createOrUpdateAsync(
        String resourceGroupName, String appName, JavaAppInner appEnvelope, Context context) {
        return beginCreateOrUpdateAsync(resourceGroupName, appName, appEnvelope, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public JavaAppInner createOrUpdate(
        String resourceGroupName, String appName, JavaAppInner appEnvelope, Context context) {
    ...
    private Mono<Response<Flux<ByteBuffer>>> updateWithResponseAsync(
        String resourceGroupName, String appName, JavaAppForPatch appEnvelope) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> updateWithResponseAsync(
        String resourceGroupName, String appName, JavaAppForPatch appEnvelope, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<JavaAppInner>, JavaAppInner> beginUpdateAsync(
        String resourceGroupName, String appName, JavaAppForPatch appEnvelope) {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<JavaAppInner>, JavaAppInner> beginUpdate(
        String resourceGroupName, String appName, JavaAppForPatch appEnvelope) {
    ...
    private Mono<JavaAppInner> updateAsync(String resourceGroupName, String appName, JavaAppForPatch appEnvelope) {
        return beginUpdateAsync(resourceGroupName, appName, appEnvelope)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<JavaAppInner> updateAsync(
        String resourceGroupName, String appName, JavaAppForPatch appEnvelope, Context context) {
        return beginUpdateAsync(resourceGroupName, appName, appEnvelope, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<Void> startAsync(String resourceGroupName, String appName, Context context) {
        return beginStartAsync(resourceGroupName, appName, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<Void> stopAsync(String resourceGroupName, String appName, Context context) {
        return beginStopAsync(resourceGroupName, appName, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return javaApps collection ARM resource along with {@link PagedResponse} on successful completion of {@link
     *     Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
