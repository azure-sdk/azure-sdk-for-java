...
public interface JavaEnvironmentsClient {
    ...
    Response<JavaEnvironmentInner> getByResourceGroupWithResponse(
    ...
    SyncPoller<PollResult<JavaEnvironmentInner>, JavaEnvironmentInner> beginCreateOrUpdate(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    JavaEnvironmentInner createOrUpdate(
        String resourceGroupName, String javaEnvironmentName, JavaEnvironmentInner environmentEnvelope);
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<JavaEnvironmentInner>, JavaEnvironmentInner> beginUpdate(
