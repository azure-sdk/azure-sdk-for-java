...
@Fluent
public final class ResourceSkuZoneDetailsAutoGenerated {
    /*
     ...
     * @return the ResourceSkuZoneDetailsAutoGenerated object itself.
     */
    public ResourceSkuZoneDetailsAutoGenerated withName(List<String> name) {
        this.name = name;
        return this;
    }
     ...
     * @return the ResourceSkuZoneDetailsAutoGenerated object itself.
     */
    public ResourceSkuZoneDetailsAutoGenerated withCapabilities(List<ResourceSkuCapabilities> capabilities) {
