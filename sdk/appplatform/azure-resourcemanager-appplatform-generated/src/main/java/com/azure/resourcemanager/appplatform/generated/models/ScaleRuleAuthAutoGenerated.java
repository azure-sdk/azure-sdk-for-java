...
public final class ScaleRuleAuthAutoGenerated {
    ...
    /**
     * Get the secretRef property: Name of the Azure Spring Apps App Instance secret from which to pull the auth
     * params.
     * 
    ...
    /**
     * Set the secretRef property: Name of the Azure Spring Apps App Instance secret from which to pull the auth
     * params.
     * 
