...
@Fluent
public final class ScaleRuleAuthAutoGenerated {
    /*
    ...
    /** Creates an instance of ScaleRuleAuthAutoGenerated class. */
    public ScaleRuleAuthAutoGenerated() {
    }

    /**
     * Get the secretRef property: Name of the Azure Spring Apps App Instance secret from which to pull the auth params.
     *
    ...
    /**
     * Set the secretRef property: Name of the Azure Spring Apps App Instance secret from which to pull the auth params.
     *
     * @param secretRef the secretRef value to set.
     * @return the ScaleRuleAuthAutoGenerated object itself.
     */
    public ScaleRuleAuthAutoGenerated withSecretRef(String secretRef) {
     ...
     * @return the ScaleRuleAuthAutoGenerated object itself.
     */
    public ScaleRuleAuthAutoGenerated withTriggerParameter(String triggerParameter) {
