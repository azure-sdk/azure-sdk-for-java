...
public final class BindingResourceImpl implements BindingResource, BindingResource.Definition, BindingResource.Update {
    ...
    public BindingResource create() {
        this.innerObject = serviceManager.serviceClient().getBindings().createOrUpdate(resourceGroupName, serviceName,
            appName, bindingName, this.innerModel(), Context.NONE);
        return this;
    }

    public BindingResource create(Context context) {
        this.innerObject = serviceManager.serviceClient().getBindings().createOrUpdate(resourceGroupName, serviceName,
            appName, bindingName, this.innerModel(), context);
        return this;
    }

    BindingResourceImpl(String name,
    ...
    public BindingResource apply() {
        this.innerObject = serviceManager.serviceClient().getBindings().update(resourceGroupName, serviceName, appName,
            bindingName, this.innerModel(), Context.NONE);
        return this;
    }

    public BindingResource apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getBindings().update(resourceGroupName, serviceName, appName,
            bindingName, this.innerModel(), context);
        return this;
    }

    BindingResourceImpl(BindingResourceInner innerObject,
        com.azure.resourcemanager.appplatform.generated.AppPlatformManager serviceManager) {
        ...
        this.bindingName = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "bindings");
    }

    public BindingResource refresh() {
        this.innerObject = serviceManager.serviceClient().getBindings()
            .getWithResponse(resourceGroupName, serviceName, appName, bindingName, Context.NONE).getValue();
        return this;
    }

    public BindingResource refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getBindings()
            .getWithResponse(resourceGroupName, serviceName, appName, bindingName, context).getValue();
        return this;
    }
