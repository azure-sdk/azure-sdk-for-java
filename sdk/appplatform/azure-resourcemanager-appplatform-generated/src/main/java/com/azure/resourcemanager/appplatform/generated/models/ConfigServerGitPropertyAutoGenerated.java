...
/** Property of git. */
@Fluent
public final class ConfigServerGitPropertyAutoGenerated {
    /*
     * Repositories of git.
     */
     ...
     * @return the ConfigServerGitPropertyAutoGenerated object itself.
     */
    public ConfigServerGitPropertyAutoGenerated withRepositories(List<GitPatternRepository> repositories) {
     ...
     * @return the ConfigServerGitPropertyAutoGenerated object itself.
     */
    public ConfigServerGitPropertyAutoGenerated withUri(String uri) {
        this.uri = uri;
        return this;
    }
     ...
     * @return the ConfigServerGitPropertyAutoGenerated object itself.
     */
    public ConfigServerGitPropertyAutoGenerated withLabel(String label) {
        this.label = label;
        return this;
    }
     ...
     * @return the ConfigServerGitPropertyAutoGenerated object itself.
     */
    public ConfigServerGitPropertyAutoGenerated withSearchPaths(List<String> searchPaths) {
     ...
     * @return the ConfigServerGitPropertyAutoGenerated object itself.
     */
    public ConfigServerGitPropertyAutoGenerated withUsername(String username) {
     ...
     * @return the ConfigServerGitPropertyAutoGenerated object itself.
     */
    public ConfigServerGitPropertyAutoGenerated withPassword(String password) {
     ...
     * @return the ConfigServerGitPropertyAutoGenerated object itself.
     */
    public ConfigServerGitPropertyAutoGenerated withHostKey(String hostKey) {
     ...
     * @return the ConfigServerGitPropertyAutoGenerated object itself.
     */
    public ConfigServerGitPropertyAutoGenerated withHostKeyAlgorithm(String hostKeyAlgorithm) {
     ...
     * @return the ConfigServerGitPropertyAutoGenerated object itself.
     */
    public ConfigServerGitPropertyAutoGenerated withPrivateKey(String privateKey) {
     ...
     * @return the ConfigServerGitPropertyAutoGenerated object itself.
     */
    public ConfigServerGitPropertyAutoGenerated withStrictHostKeyChecking(Boolean strictHostKeyChecking) {
            ...
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException(
                        "Missing required property uri in model ConfigServerGitPropertyAutoGenerated"));
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(ConfigServerGitPropertyAutoGenerated.class);
}
