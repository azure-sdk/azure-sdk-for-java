...
import com.azure.resourcemanager.appplatform.generated.fluent.models.ReplicaPropertiesAutoGenerated;
 ...
 */
@Fluent
public class ReplicaAutoGenerated extends ProxyResource {
    /*
     * Replica resource specific properties
     */
    @JsonProperty(value = "properties")
    private ReplicaPropertiesAutoGenerated innerProperties;
    ...
    /**
     * Creates an instance of ReplicaAutoGenerated class.
     */
    public ReplicaAutoGenerated() {
    }
     ...
     * @return the ReplicaAutoGenerated object itself.
     */
    public ReplicaAutoGenerated withContainers(List<ReplicaContainer> containers) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ReplicaPropertiesAutoGenerated();
        }
     ...
     * @return the ReplicaAutoGenerated object itself.
     */
    public ReplicaAutoGenerated withInitContainers(List<ReplicaContainer> initContainers) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ReplicaPropertiesAutoGenerated();
        }
