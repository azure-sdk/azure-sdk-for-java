...
public interface ConfigServersClient {
    ...
    PagedIterable<ConfigServerResourceInner> list(String resourceGroupName, String serviceName);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<ConfigServerResourceInner> list(String resourceGroupName, String serviceName, Context context);
