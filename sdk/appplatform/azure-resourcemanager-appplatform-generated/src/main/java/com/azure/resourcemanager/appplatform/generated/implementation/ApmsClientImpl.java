...
public final class ApmsClientImpl implements ApmsClient {
    ...
    public interface ApmsService {
        ...
        Mono<Response<ApmResourceCollection>> list(
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ApmResourceInner>> get(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("serviceName") String serviceName,
            @PathParam("apmName") String apmName,
            @HeaderParam("Accept") String accept,
            Context context);
        ...
        Mono<Response<Flux<ByteBuffer>>> createOrUpdate(
            ...
            @PathParam("serviceName") String serviceName,
            @PathParam("apmName") String apmName,
            @BodyParam("application/json") ApmResourceInner apmResource,
            @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ApmSecretKeysInner>> listSecretKeys(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ApmResourceCollection>> listNext(
                ...
                context ->
                    service
                        .list(
                            ...
                            accept,
                            context))
            .<PagedResponse<ApmResourceInner>>map(
                res ->
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<ApmResourceInner>> listSinglePageAsync(
    ...
    private PagedFlux<ApmResourceInner> listAsync(String resourceGroupName, String serviceName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ApmResourceInner>> getWithResponseAsync(
        String resourceGroupName, String serviceName, String apmName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ApmResourceInner> getAsync(String resourceGroupName, String serviceName, String apmName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ApmResourceInner> getWithResponse(
        String resourceGroupName, String serviceName, String apmName, Context context) {
    ...
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(
        String resourceGroupName, String serviceName, String apmName, ApmResourceInner apmResource) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    private PollerFlux<PollResult<ApmResourceInner>, ApmResourceInner> beginCreateOrUpdateAsync(
        ...
        return this
            .client
            .<ApmResourceInner, ApmResourceInner>getLroResult(
                mono,
                this.client.getHttpPipeline(),
                ApmResourceInner.class,
                ApmResourceInner.class,
    ...
    private PollerFlux<PollResult<ApmResourceInner>, ApmResourceInner> beginCreateOrUpdateAsync(
        ...
        return this
            .client
            .<ApmResourceInner, ApmResourceInner>getLroResult(
                mono, this.client.getHttpPipeline(), ApmResourceInner.class, ApmResourceInner.class, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<ApmResourceInner>, ApmResourceInner> beginCreateOrUpdate(
        String resourceGroupName, String serviceName, String apmName, ApmResourceInner apmResource) {
    ...
    public SyncPoller<PollResult<ApmResourceInner>, ApmResourceInner> beginCreateOrUpdate(
        String resourceGroupName, String serviceName, String apmName, ApmResourceInner apmResource, Context context) {
        return this
            .beginCreateOrUpdateAsync(resourceGroupName, serviceName, apmName, apmResource, context)
            .getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ApmResourceInner> createOrUpdateAsync(
        String resourceGroupName, String serviceName, String apmName, ApmResourceInner apmResource) {
        return beginCreateOrUpdateAsync(resourceGroupName, serviceName, apmName, apmResource)
            .last()
    ...
    private Mono<ApmResourceInner> createOrUpdateAsync(
        String resourceGroupName, String serviceName, String apmName, ApmResourceInner apmResource, Context context) {
        return beginCreateOrUpdateAsync(resourceGroupName, serviceName, apmName, apmResource, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ApmResourceInner createOrUpdate(
        String resourceGroupName, String serviceName, String apmName, ApmResourceInner apmResource) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> deleteAsync(String resourceGroupName, String serviceName, String apmName) {
        return beginDeleteAsync(resourceGroupName, serviceName, apmName)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String serviceName, String apmName, Context context) {
        return beginDeleteAsync(resourceGroupName, serviceName, apmName, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ApmSecretKeysInner>> listSecretKeysWithResponseAsync(
        String resourceGroupName, String serviceName, String apmName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ApmSecretKeysInner> listSecretKeysAsync(String resourceGroupName, String serviceName, String apmName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ApmSecretKeysInner> listSecretKeysWithResponse(
        String resourceGroupName, String serviceName, String apmName, Context context) {
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return object that includes an array of APM resources and a possible link for next set along with {@link
