...
public final class BuildServiceAgentPoolsImpl implements BuildServiceAgentPools {
    ...
    public BuildServiceAgentPoolsImpl(BuildServiceAgentPoolsClient innerClient,
        com.azure.resourcemanager.appplatform.generated.AppPlatformManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public PagedIterable<BuildServiceAgentPoolResource> list(String resourceGroupName, String serviceName,
        ...
        return ResourceManagerUtils.mapPage(inner,
            inner1 -> new BuildServiceAgentPoolResourceImpl(inner1, this.manager()));
    }
    ...
    public Response<BuildServiceAgentPoolResource> getWithResponse(String resourceGroupName, String serviceName,
        String buildServiceName, String agentPoolName, Context context) {
        Response<BuildServiceAgentPoolResourceInner> inner = this.serviceClient().getWithResponse(resourceGroupName,
            serviceName, buildServiceName, agentPoolName, context);
        if (inner != null) {
    ...
    public BuildServiceAgentPoolResource get(String resourceGroupName, String serviceName, String buildServiceName,
    ...
    public BuildServiceAgentPoolResource updatePut(String resourceGroupName, String serviceName,
        String buildServiceName, String agentPoolName, BuildServiceAgentPoolResourceInner agentPoolResource) {
        BuildServiceAgentPoolResourceInner inner = this.serviceClient().updatePut(resourceGroupName, serviceName,
