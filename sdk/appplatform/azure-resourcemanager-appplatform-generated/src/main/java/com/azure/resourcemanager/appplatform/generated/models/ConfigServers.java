...
public interface ConfigServers {
     ...
     * @return the config server and its properties.
     */
    ConfigServerResourceAutoGenerated get(String resourceGroupName, String serviceName);
     ...
     * @return the config server and its properties along with {@link Response}.
     */
    Response<ConfigServerResourceAutoGenerated> getWithResponse(
     ...
     * @return config Server resource.
     */
    ConfigServerResourceAutoGenerated updatePut(
     ...
     * @return config Server resource.
     */
    ConfigServerResourceAutoGenerated updatePatch(
        String resourceGroupName, String serviceName, ConfigServerResourceAutoGeneratedInner configServerResource);
     ...
     * @return validation result for config server settings.
     */
    ConfigServerSettingsValidateResultAutoGenerated validate(
