...
import com.azure.resourcemanager.appplatform.generated.models.SupportedApmTypes;
...
public final class ServicesClientImpl implements ServicesClient {
    ...
    public interface ServicesService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<TestKeysInner>> listTestKeys(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("serviceName") String serviceName,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<TestKeysInner>> regenerateTestKey(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("serviceName") String serviceName,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<TestKeysInner>> enableTestEndpoint(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("serviceName") String serviceName,
            @HeaderParam("Accept") String accept, Context context);
    ...
    private Mono<Response<Flux<ByteBuffer>>> updateWithResponseAsync(String resourceGroupName, String serviceName,
        ...
        return service.update(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(), resourceGroupName,
            serviceName, resource, accept, context);
    }
    ...
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<ServiceResourceInner>, ServiceResourceInner>
        beginUpdateAsync(String resourceGroupName, String serviceName, ServiceResourceInner resource) {
    ...
    private Mono<Response<TestKeysInner>> listTestKeysWithResponseAsync(String resourceGroupName, String serviceName) {
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.listTestKeys(this.client.getEndpoint(), apiVersion,
                this.client.getSubscriptionId(), resourceGroupName, serviceName, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<TestKeysInner>> listTestKeysWithResponseAsync(String resourceGroupName, String serviceName,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.listTestKeys(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(),
            resourceGroupName, serviceName, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<TestKeysInner> listTestKeysWithResponse(String resourceGroupName, String serviceName,
        Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<TestKeysInner>> regenerateTestKeyWithResponseAsync(String resourceGroupName,
        String serviceName, RegenerateTestKeyRequestPayload regenerateTestKeyRequest) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        final String apiVersion = "2023-07-01-preview";
        final String accept = "application/json";
        return FluxUtil.withContext(context -> service.regenerateTestKey(this.client.getEndpoint(), apiVersion,
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<TestKeysInner>> regenerateTestKeyWithResponseAsync(String resourceGroupName,
        String serviceName, RegenerateTestKeyRequestPayload regenerateTestKeyRequest, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.regenerateTestKey(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(),
            resourceGroupName, serviceName, regenerateTestKeyRequest, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<TestKeysInner> regenerateTestKeyAsync(String resourceGroupName, String serviceName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<TestKeysInner> regenerateTestKeyWithResponse(String resourceGroupName, String serviceName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public TestKeysInner regenerateTestKey(String resourceGroupName, String serviceName,
        RegenerateTestKeyRequestPayload regenerateTestKeyRequest) {
    ...
    private Mono<Response<Void>> disableTestEndpointWithResponseAsync(String resourceGroupName, String serviceName) {
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.disableTestEndpoint(this.client.getEndpoint(), apiVersion,
                this.client.getSubscriptionId(), resourceGroupName, serviceName, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<Void>> disableTestEndpointWithResponseAsync(String resourceGroupName, String serviceName,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.disableTestEndpoint(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(),
            resourceGroupName, serviceName, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<TestKeysInner>> enableTestEndpointWithResponseAsync(String resourceGroupName,
        String serviceName) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.enableTestEndpoint(this.client.getEndpoint(), apiVersion,
                this.client.getSubscriptionId(), resourceGroupName, serviceName, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<TestKeysInner>> enableTestEndpointWithResponseAsync(String resourceGroupName,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.enableTestEndpoint(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(),
            resourceGroupName, serviceName, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<TestKeysInner> enableTestEndpointWithResponse(String resourceGroupName, String serviceName,
        Context context) {
    ...
    private Mono<Response<Flux<ByteBuffer>>> flushVnetDnsSettingWithResponseAsync(String resourceGroupName,
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.flushVnetDnsSetting(this.client.getEndpoint(), apiVersion,
                this.client.getSubscriptionId(), resourceGroupName, serviceName, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> flushVnetDnsSettingWithResponseAsync(String resourceGroupName,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.flushVnetDnsSetting(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(),
            resourceGroupName, serviceName, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> flushVnetDnsSettingAsync(String resourceGroupName, String serviceName) {
    ...
    private Mono<PagedResponse<SupportedApmTypeInner>> listSupportedApmTypesSinglePageAsync(String resourceGroupName,
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.listSupportedApmTypes(this.client.getEndpoint(), apiVersion,
                this.client.getSubscriptionId(), resourceGroupName, serviceName, accept, context))
    ...
    private Mono<PagedResponse<SupportedApmTypeInner>> listSupportedApmTypesSinglePageAsync(String resourceGroupName,
        ...
        context = this.client.mergeContext(context);
        return service
            .listSupportedApmTypes(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(),
                resourceGroupName, serviceName, accept, context)
    ...
    private Mono<Response<GloballyEnabledApmsInner>> listGloballyEnabledApmsWithResponseAsync(String resourceGroupName,
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.listGloballyEnabledApms(this.client.getEndpoint(), apiVersion,
                this.client.getSubscriptionId(), resourceGroupName, serviceName, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<GloballyEnabledApmsInner>> listGloballyEnabledApmsWithResponseAsync(String resourceGroupName,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.listGloballyEnabledApms(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(),
            resourceGroupName, serviceName, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<GloballyEnabledApmsInner> listGloballyEnabledApmsAsync(String resourceGroupName, String serviceName) {
    ...
    private Mono<Response<Flux<ByteBuffer>>> enableApmGloballyWithResponseAsync(String resourceGroupName,
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.enableApmGlobally(this.client.getEndpoint(), apiVersion,
    ...
    private Mono<Response<Flux<ByteBuffer>>> enableApmGloballyWithResponseAsync(String resourceGroupName,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.enableApmGlobally(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(),
            resourceGroupName, serviceName, apm, accept, context);
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> disableApmGloballyWithResponseAsync(String resourceGroupName,
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.disableApmGlobally(this.client.getEndpoint(), apiVersion,
                this.client.getSubscriptionId(), resourceGroupName, serviceName, apm, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> disableApmGloballyWithResponseAsync(String resourceGroupName,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.disableApmGlobally(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(),
            resourceGroupName, serviceName, apm, accept, context);
    }
    ...
    private Mono<Response<NameAvailabilityInner>> checkNameAvailabilityWithResponseAsync(String location,
        ...
        return service.checkNameAvailability(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(),
            location, availabilityParameters, accept, context);
    }
