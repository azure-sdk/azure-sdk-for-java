...
public final class ServicesClientImpl implements ServicesClient {
    ...
    public interface ServicesService {
        ...
        @ExpectedResponses({200, 202})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Flux<ByteBuffer>>> flushVnetDnsSetting(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<SupportedApmTypes>> listSupportedApmTypes(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<GloballyEnabledApmsInner>> listGloballyEnabledApms(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
        ...
        @ExpectedResponses({200, 202})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Flux<ByteBuffer>>> enableApmGlobally(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("serviceName") String serviceName,
            @BodyParam("application/json") ApmReference apm,
            @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({200, 202})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Flux<ByteBuffer>>> disableApmGlobally(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> flushVnetDnsSettingWithResponseAsync(
        String resourceGroupName, String serviceName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<Void>, Void> beginFlushVnetDnsSettingAsync(
        String resourceGroupName, String serviceName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<Void>, Void> beginFlushVnetDnsSetting(
        String resourceGroupName, String serviceName, Context context) {
    ...
    private Mono<Void> flushVnetDnsSettingAsync(String resourceGroupName, String serviceName) {
        return beginFlushVnetDnsSettingAsync(resourceGroupName, serviceName)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<Void> flushVnetDnsSettingAsync(String resourceGroupName, String serviceName, Context context) {
        return beginFlushVnetDnsSettingAsync(resourceGroupName, serviceName, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<SupportedApmTypeInner>> listSupportedApmTypesSinglePageAsync(
        String resourceGroupName, String serviceName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                ...
                context ->
                    service
                        .listSupportedApmTypes(
                            ...
                            accept,
                            context))
            .<PagedResponse<SupportedApmTypeInner>>map(
                res ->
    ...
    private PagedFlux<SupportedApmTypeInner> listSupportedApmTypesAsync(String resourceGroupName, String serviceName) {
        return new PagedFlux<>(
            () -> listSupportedApmTypesSinglePageAsync(resourceGroupName, serviceName),
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<SupportedApmTypeInner> listSupportedApmTypesAsync(
        String resourceGroupName, String serviceName, Context context) {
        return new PagedFlux<>(
            () -> listSupportedApmTypesSinglePageAsync(resourceGroupName, serviceName, context),
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<SupportedApmTypeInner> listSupportedApmTypes(
        String resourceGroupName, String serviceName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<GloballyEnabledApmsInner>> listGloballyEnabledApmsWithResponseAsync(
        String resourceGroupName, String serviceName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<GloballyEnabledApmsInner> listGloballyEnabledApmsWithResponse(
        String resourceGroupName, String serviceName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> enableApmGloballyWithResponseAsync(
        String resourceGroupName, String serviceName, ApmReference apm) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> enableApmGloballyWithResponseAsync(
        String resourceGroupName, String serviceName, ApmReference apm, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<Void>, Void> beginEnableApmGloballyAsync(
        String resourceGroupName, String serviceName, ApmReference apm) {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<Void>, Void> beginEnableApmGlobally(
        String resourceGroupName, String serviceName, ApmReference apm) {
    ...
    private Mono<Void> enableApmGloballyAsync(String resourceGroupName, String serviceName, ApmReference apm) {
        return beginEnableApmGloballyAsync(resourceGroupName, serviceName, apm)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> enableApmGloballyAsync(
        String resourceGroupName, String serviceName, ApmReference apm, Context context) {
        return beginEnableApmGloballyAsync(resourceGroupName, serviceName, apm, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> disableApmGloballyWithResponseAsync(
        String resourceGroupName, String serviceName, ApmReference apm) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<Void>, Void> beginDisableApmGloballyAsync(
        String resourceGroupName, String serviceName, ApmReference apm) {
        Mono<Response<Flux<ByteBuffer>>> mono =
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<Void>, Void> beginDisableApmGlobally(
        String resourceGroupName, String serviceName, ApmReference apm) {
    ...
    private Mono<Void> disableApmGloballyAsync(String resourceGroupName, String serviceName, ApmReference apm) {
        return beginDisableApmGloballyAsync(resourceGroupName, serviceName, apm)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> disableApmGloballyAsync(
        String resourceGroupName, String serviceName, ApmReference apm, Context context) {
        return beginDisableApmGloballyAsync(resourceGroupName, serviceName, apm, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<SupportedApmTypeInner>> listSupportedApmTypesNextSinglePageAsync(
        ...
        context = this.client.mergeContext(context);
        return service
            .listSupportedApmTypesNext(nextLink, this.client.getEndpoint(), accept, context)
            .map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(),
