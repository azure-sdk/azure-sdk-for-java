...
public final class GatewaysClientImpl implements GatewaysClient {
    ...
    private Mono<Response<Flux<ByteBuffer>>> updateCapacityWithResponseAsync(String resourceGroupName,
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.updateCapacity(this.client.getEndpoint(), this.client.getApiVersion(),
    ...
    private Mono<Response<Flux<ByteBuffer>>> updateCapacityWithResponseAsync(String resourceGroupName,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.updateCapacity(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, serviceName, gatewayName, gatewayCapacityResource,
            accept, context);
    }
    ...
    private Mono<Response<CustomDomainValidateResultInner>> validateDomainWithResponseAsync(String resourceGroupName,
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.validateDomain(this.client.getEndpoint(), this.client.getApiVersion(),
    ...
    private Mono<Response<CustomDomainValidateResultInner>> validateDomainWithResponseAsync(String resourceGroupName,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.validateDomain(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, serviceName, gatewayName, validatePayload, accept,
            context);
    }
