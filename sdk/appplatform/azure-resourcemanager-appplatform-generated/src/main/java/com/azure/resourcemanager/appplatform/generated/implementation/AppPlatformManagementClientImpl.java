...
public final class AppPlatformManagementClientImpl implements AppPlatformManagementClient {
    ...
    /**
     * The JavaAppsClient object to access its operations.
     */
    private final JavaAppsClient javaApps;
     ...
     */
    public JavaAppsClient getJavaApps() {
        return this.javaApps;
    }

    /**
     * The RevisionsClient object to access its operations.
     */
    private final RevisionsClient revisions;
     ...
     */
    public RevisionsClient getRevisions() {
        return this.revisions;
    }

    /**
     * The RevisionReplicasClient object to access its operations.
     */
    private final RevisionReplicasClient revisionReplicas;
     ...
     */
    public RevisionReplicasClient getRevisionReplicas() {
        return this.revisionReplicas;
    }

    /**
     * The JavaEnvironmentsClient object to access its operations.
     */
    private final JavaEnvironmentsClient javaEnvironments;
     ...
     */
    public JavaEnvironmentsClient getJavaEnvironments() {
        return this.javaEnvironments;
    }
    ...
    /**
     * The MiddlewareEurekaServersClient object to access its operations.
     */
    private final MiddlewareEurekaServersClient middlewareEurekaServers;
     ...
     */
    public MiddlewareEurekaServersClient getMiddlewareEurekaServers() {
        return this.middlewareEurekaServers;
    }

    /**
     * The MiddlewareConfigServersClient object to access its operations.
     */
    private final MiddlewareConfigServersClient middlewareConfigServers;
     ...
     */
    public MiddlewareConfigServersClient getMiddlewareConfigServers() {
        return this.middlewareConfigServers;
    }
    ...
    /**
     * The EurekaServersClient object to access its operations.
     */
    private final EurekaServersClient eurekaServers;
     ...
     */
    public EurekaServersClient getEurekaServers() {
        return this.eurekaServers;
    }
    ...
    AppPlatformManagementClientImpl(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter,
        ...
        this.javaApps = new JavaAppsClientImpl(this);
        this.revisions = new RevisionsClientImpl(this);
        this.revisionReplicas = new RevisionReplicasClientImpl(this);
        this.javaEnvironments = new JavaEnvironmentsClientImpl(this);
        this.namespaces = new NamespacesClientImpl(this);
        this.middlewareEurekaServers = new MiddlewareEurekaServersClientImpl(this);
        this.middlewareConfigServers = new MiddlewareConfigServersClientImpl(this);
        this.services = new ServicesClientImpl(this);
        this.apms = new ApmsClientImpl(this);
        this.eurekaServers = new EurekaServersClientImpl(this);
