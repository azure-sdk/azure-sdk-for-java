...
public final class AppPlatformManagementClientImpl implements AppPlatformManagementClient {
    ...
    /**
     * The BuildSettingsClient object to access its operations.
     */
    private final BuildSettingsClient buildSettings;

    /**
     * Gets the BuildSettingsClient object to access its operations.
     * 
     * @return the BuildSettingsClient object.
     */
    public BuildSettingsClient getBuildSettings() {
        return this.buildSettings;
    }

    /**
     * The BuildSettingOperationsClient object to access its operations.
     */
    private final BuildSettingOperationsClient buildSettingOperations;

    /**
     * Gets the BuildSettingOperationsClient object to access its operations.
     * 
     * @return the BuildSettingOperationsClient object.
     */
    public BuildSettingOperationsClient getBuildSettingOperations() {
        return this.buildSettingOperations;
    }
    ...
    /**
     * The JobExecutionsOperationsClient object to access its operations.
     */
    private final JobExecutionsOperationsClient jobExecutionsOperations;

    /**
     * Gets the JobExecutionsOperationsClient object to access its operations.
     * 
     * @return the JobExecutionsOperationsClient object.
     */
    public JobExecutionsOperationsClient getJobExecutionsOperations() {
        return this.jobExecutionsOperations;
    }
    ...
    AppPlatformManagementClientImpl(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter,
        ...
        this.buildSettings = new BuildSettingsClientImpl(this);
        this.buildSettingOperations = new BuildSettingOperationsClientImpl(this);
        ...
        this.jobExecutionsOperations = new JobExecutionsOperationsClientImpl(this);
    }
