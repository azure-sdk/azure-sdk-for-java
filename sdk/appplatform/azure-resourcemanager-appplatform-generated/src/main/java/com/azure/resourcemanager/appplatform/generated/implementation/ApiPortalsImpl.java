...
public final class ApiPortalsImpl implements ApiPortals {
    ...
    public ApiPortalsImpl(ApiPortalsClient innerClient,
        com.azure.resourcemanager.appplatform.generated.AppPlatformManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public Response<ApiPortalResource> getWithResponse(String resourceGroupName, String serviceName,
    ...
    public PagedIterable<ApiPortalResource> list(String resourceGroupName, String serviceName) {
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new ApiPortalResourceImpl(inner1, this.manager()));
    }
    ...
    public CustomDomainValidateResult validateDomain(String resourceGroupName, String serviceName, String apiPortalName,
    ...
    public ApiPortalResource getById(String id) {
        ...
        String apiPortalName = ResourceManagerUtils.getValueFromIdByName(id, "apiPortals");
