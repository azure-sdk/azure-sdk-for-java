...
public interface AppsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    AppResourceAutoGeneratedInner get(String resourceGroupName, String serviceName, String appName);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<AppResourceAutoGeneratedInner> getWithResponse(
        String resourceGroupName, String serviceName, String appName, String syncStatus, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<AppResourceAutoGeneratedInner>, AppResourceAutoGeneratedInner> beginCreateOrUpdate(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    AppResourceAutoGeneratedInner createOrUpdate(
        String resourceGroupName, String serviceName, String appName, AppResourceAutoGeneratedInner appResource);
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<AppResourceAutoGeneratedInner>, AppResourceAutoGeneratedInner> beginUpdate(
        String resourceGroupName, String serviceName, String appName, AppResourceAutoGeneratedInner appResource);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    AppResourceAutoGeneratedInner update(
        String resourceGroupName, String serviceName, String appName, AppResourceAutoGeneratedInner appResource);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<AppResourceAutoGeneratedInner> list(String resourceGroupName, String serviceName);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<AppResourceAutoGeneratedInner> list(String resourceGroupName, String serviceName, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<AppResourceAutoGeneratedInner>, AppResourceAutoGeneratedInner> beginSetActiveDeployments(
        String resourceGroupName,
        String serviceName,
        String appName,
        ActiveDeploymentCollection activeDeploymentCollection);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    AppResourceAutoGeneratedInner setActiveDeployments(
        String resourceGroupName,
        String serviceName,
        String appName,
        ActiveDeploymentCollection activeDeploymentCollection);
