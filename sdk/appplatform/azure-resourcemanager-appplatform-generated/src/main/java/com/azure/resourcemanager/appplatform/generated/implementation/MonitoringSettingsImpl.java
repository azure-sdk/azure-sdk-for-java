...
public final class MonitoringSettingsImpl implements MonitoringSettings {
    ...
    public MonitoringSettingsImpl(MonitoringSettingsClient innerClient,
        com.azure.resourcemanager.appplatform.generated.AppPlatformManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public Response<MonitoringSettingResource> getWithResponse(String resourceGroupName, String serviceName,
        Context context) {
    ...
    public MonitoringSettingResource updatePut(String resourceGroupName, String serviceName,
    ...
    public MonitoringSettingResource updatePatch(String resourceGroupName, String serviceName,
        MonitoringSettingResourceInner monitoringSettingResource) {
        MonitoringSettingResourceInner inner
