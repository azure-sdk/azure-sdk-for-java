...
public final class ApmsImpl implements Apms {
    ...
    public PagedIterable<ApmResource> list(String resourceGroupName, String serviceName) {
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new ApmResourceImpl(inner1, this.manager()));
    }
    ...
    public ApmResource getById(String id) {
        ...
        String apmName = ResourceManagerUtils.getValueFromIdByName(id, "apms");
        if (apmName == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
