...
import com.azure.resourcemanager.appplatform.generated.fluent.models.ContainerAppProperties;
 ...
 */
@Fluent
public class ContainerApp extends Resource {
    /*
    ...
    /**
     * Creates an instance of ContainerApp class.
     */
    public ContainerApp() {
    }
     ...
     * @return the ContainerApp object itself.
     */
    public ContainerApp withExtendedLocation(ExtendedLocation extendedLocation) {
     ...
     * @return the ContainerApp object itself.
     */
    public ContainerApp withIdentity(ManagedServiceIdentity identity) {
     ...
     * @return the ContainerApp object itself.
     */
    public ContainerApp withManagedBy(String managedBy) {
     ...
     */
    @Override
    public ContainerApp withLocation(String location) {
     ...
     */
    @Override
    public ContainerApp withTags(Map<String, String> tags) {
        super.withTags(tags);
        return this;
    }
     ...
     * @return the ContainerApp object itself.
     */
    public ContainerApp withManagedEnvironmentId(String managedEnvironmentId) {
     ...
     * @return the ContainerApp object itself.
     */
    public ContainerApp withEnvironmentId(String environmentId) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ContainerAppProperties();
        }
     ...
     * @return the ContainerApp object itself.
     */
    public ContainerApp withWorkloadProfileName(String workloadProfileName) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ContainerAppProperties();
        }
     ...
     * @return the ContainerApp object itself.
     */
    public ContainerApp withConfiguration(Configuration configuration) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ContainerAppProperties();
        }
     ...
     * @return the ContainerApp object itself.
     */
    public ContainerApp withTemplate(Template template) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ContainerAppProperties();
        }
