...
public final class CustomDomainsClientImpl implements CustomDomainsClient {
    ...
    private Mono<Response<CustomDomainResourceInner>> getWithResponseAsync(String resourceGroupName, String serviceName,
        ...
        return service.get(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(), resourceGroupName,
            serviceName, appName, domainName, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<CustomDomainResourceInner> getAsync(String resourceGroupName, String serviceName, String appName,
        String domainName) {
    ...
    private Mono<Response<Flux<ByteBuffer>>> updateWithResponseAsync(String resourceGroupName, String serviceName,
        ...
        return service.update(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(), resourceGroupName,
            serviceName, appName, domainName, domainResource, accept, context);
    }
    ...
    private PagedFlux<CustomDomainResourceInner> listAsync(String resourceGroupName, String serviceName,
        String appName) {
