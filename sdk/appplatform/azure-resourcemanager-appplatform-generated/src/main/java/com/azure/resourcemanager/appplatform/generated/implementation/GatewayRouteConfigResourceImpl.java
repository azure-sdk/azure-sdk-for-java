...
public final class GatewayRouteConfigResourceImpl
    ...
    public GatewayRouteConfigResource create() {
        this.innerObject = serviceManager.serviceClient()
            ...
            .createOrUpdate(resourceGroupName, serviceName, gatewayName, routeConfigName, this.innerModel(),
                Context.NONE);
        return this;
    }
    ...
    public GatewayRouteConfigResource create(Context context) {
        this.innerObject = serviceManager.serviceClient()
            .getGatewayRouteConfigs()
            .createOrUpdate(resourceGroupName, serviceName, gatewayName, routeConfigName, this.innerModel(), context);
        return this;
    }
