...
public final class GatewayRouteConfigResourceImpl
    ...
    public GatewayRouteConfigResourceImpl withExistingGateway(String resourceGroupName, String serviceName,
        String gatewayName) {
    ...
    public GatewayRouteConfigResource create() {
        this.innerObject = serviceManager.serviceClient().getGatewayRouteConfigs().createOrUpdate(resourceGroupName,
            serviceName, gatewayName, routeConfigName, this.innerModel(), Context.NONE);
        return this;
    }

    public GatewayRouteConfigResource create(Context context) {
        this.innerObject = serviceManager.serviceClient().getGatewayRouteConfigs().createOrUpdate(resourceGroupName,
            serviceName, gatewayName, routeConfigName, this.innerModel(), context);
        return this;
    }

    GatewayRouteConfigResourceImpl(String name,
    ...
    GatewayRouteConfigResourceImpl(GatewayRouteConfigResourceInner innerObject,
        com.azure.resourcemanager.appplatform.generated.AppPlatformManager serviceManager) {
        ...
        this.routeConfigName = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "routeConfigs");
    }

    public GatewayRouteConfigResource refresh() {
        this.innerObject = serviceManager.serviceClient().getGatewayRouteConfigs()
            .getWithResponse(resourceGroupName, serviceName, gatewayName, routeConfigName, Context.NONE).getValue();
        return this;
    }

    public GatewayRouteConfigResource refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getGatewayRouteConfigs()
            .getWithResponse(resourceGroupName, serviceName, gatewayName, routeConfigName, context).getValue();
        return this;
    }
