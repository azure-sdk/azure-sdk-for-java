...
import com.azure.resourcemanager.appplatform.generated.models.AppResourceCollectionAutoGenerated;
...
public final class AppsClientImpl implements AppsClient {
    ...
    private interface AppsService {
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<AppResourceAutoGeneratedInner>> get(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
        ...
        Mono<Response<Flux<ByteBuffer>>> createOrUpdate(
            ...
            @PathParam("serviceName") String serviceName,
            @PathParam("appName") String appName,
            @BodyParam("application/json") AppResourceAutoGeneratedInner appResource,
            @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<AppResourceCollectionAutoGenerated>> list(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<AppResourceAutoGeneratedInner>> getWithResponseAsync(
        String resourceGroupName, String serviceName, String appName, String syncStatus) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<AppResourceAutoGeneratedInner> getAsync(
        String resourceGroupName, String serviceName, String appName, String syncStatus) {
        return getWithResponseAsync(resourceGroupName, serviceName, appName, syncStatus)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<AppResourceAutoGeneratedInner> getAsync(String resourceGroupName, String serviceName, String appName) {
        final String syncStatus = null;
        return getWithResponseAsync(resourceGroupName, serviceName, appName, syncStatus)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public AppResourceAutoGeneratedInner get(String resourceGroupName, String serviceName, String appName) {
        final String syncStatus = null;
        return getAsync(resourceGroupName, serviceName, appName, syncStatus).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<AppResourceAutoGeneratedInner> getWithResponse(
        String resourceGroupName, String serviceName, String appName, String syncStatus, Context context) {
        return getWithResponseAsync(resourceGroupName, serviceName, appName, syncStatus, context).block();
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(
        String resourceGroupName, String serviceName, String appName, AppResourceAutoGeneratedInner appResource) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(
        ...
        String serviceName,
        String appName,
        AppResourceAutoGeneratedInner appResource,
        Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<AppResourceAutoGeneratedInner>, AppResourceAutoGeneratedInner>
        ...
        return this
            .client
            .<AppResourceAutoGeneratedInner, AppResourceAutoGeneratedInner>getLroResult(
                mono,
                this.client.getHttpPipeline(),
                AppResourceAutoGeneratedInner.class,
                AppResourceAutoGeneratedInner.class,
                this.client.getContext());
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<AppResourceAutoGeneratedInner>, AppResourceAutoGeneratedInner> beginCreateOrUpdate(
        String resourceGroupName, String serviceName, String appName, AppResourceAutoGeneratedInner appResource) {
        return beginCreateOrUpdateAsync(resourceGroupName, serviceName, appName, appResource).getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<AppResourceAutoGeneratedInner> createOrUpdateAsync(
        String resourceGroupName, String serviceName, String appName, AppResourceAutoGeneratedInner appResource) {
        return beginCreateOrUpdateAsync(resourceGroupName, serviceName, appName, appResource)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public AppResourceAutoGeneratedInner createOrUpdate(
        String resourceGroupName, String serviceName, String appName, AppResourceAutoGeneratedInner appResource) {
        return createOrUpdateAsync(resourceGroupName, serviceName, appName, appResource).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<AppResourceAutoGeneratedInner>, AppResourceAutoGeneratedInner> beginUpdateAsync(
        String resourceGroupName, String serviceName, String appName, AppResourceAutoGeneratedInner appResource) {
        Mono<Response<Flux<ByteBuffer>>> mono =
            updateWithResponseAsync(resourceGroupName, serviceName, appName, appResource);
        return this
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<AppResourceAutoGeneratedInner>, AppResourceAutoGeneratedInner> beginUpdate(
        String resourceGroupName, String serviceName, String appName, AppResourceAutoGeneratedInner appResource) {
        return beginUpdateAsync(resourceGroupName, serviceName, appName, appResource).getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<AppResourceAutoGeneratedInner> updateAsync(
        String resourceGroupName, String serviceName, String appName, AppResourceAutoGeneratedInner appResource) {
        return beginUpdateAsync(resourceGroupName, serviceName, appName, appResource)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public AppResourceAutoGeneratedInner update(
        String resourceGroupName, String serviceName, String appName, AppResourceAutoGeneratedInner appResource) {
        return updateAsync(resourceGroupName, serviceName, appName, appResource).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<AppResourceAutoGeneratedInner>> listSinglePageAsync(
                ...
                context ->
                    service
                        .list(
                            ...
                            accept,
                            context))
            .<PagedResponse<AppResourceAutoGeneratedInner>>map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(),
                        res.getStatusCode(),
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<AppResourceAutoGeneratedInner> listAsync(String resourceGroupName, String serviceName) {
        return new PagedFlux<>(
            () -> listSinglePageAsync(resourceGroupName, serviceName), nextLink -> listNextSinglePageAsync(nextLink));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<AppResourceAutoGeneratedInner> listAsync(
        String resourceGroupName, String serviceName, Context context) {
        return new PagedFlux<>(
            () -> listSinglePageAsync(resourceGroupName, serviceName, context),
            nextLink -> listNextSinglePageAsync(nextLink, context));
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<AppResourceAutoGeneratedInner> list(String resourceGroupName, String serviceName) {
        return new PagedIterable<>(listAsync(resourceGroupName, serviceName));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<AppResourceAutoGeneratedInner> list(
        String resourceGroupName, String serviceName, Context context) {
        return new PagedIterable<>(listAsync(resourceGroupName, serviceName, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<AppResourceAutoGeneratedInner>, AppResourceAutoGeneratedInner>
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<AppResourceAutoGeneratedInner> setActiveDeploymentsAsync(
        String resourceGroupName,
        String serviceName,
        String appName,
        ActiveDeploymentCollection activeDeploymentCollection) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public AppResourceAutoGeneratedInner setActiveDeployments(
        String resourceGroupName,
        String serviceName,
        String appName,
        ActiveDeploymentCollection activeDeploymentCollection) {
