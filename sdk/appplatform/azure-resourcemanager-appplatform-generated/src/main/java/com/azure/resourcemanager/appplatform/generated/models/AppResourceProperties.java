...
public final class AppResourceProperties {
     ...
     */
    @JsonProperty(value = "testEndpointAuthState")
    ...
    /**
     * Get the kind property: The type of App, whether it's long running app or short lived app.
     * 
     * @return the kind value.
     */
    public AppResourceType kind() {
        return this.kind;
    }

    /**
     * Set the kind property: The type of App, whether it's long running app or short lived app.
     * 
     * @param kind the kind value to set.
     * @return the AppResourceProperties object itself.
     */
    public AppResourceProperties withKind(AppResourceType kind) {
        this.kind = kind;
        return this;
    }
