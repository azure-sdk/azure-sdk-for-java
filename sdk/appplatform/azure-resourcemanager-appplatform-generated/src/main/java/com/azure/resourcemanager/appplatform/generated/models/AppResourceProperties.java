...
public final class AppResourceProperties implements JsonSerializable<AppResourceProperties> {
     ...
     */
    private TestEndpointAuthState testEndpointAuthState;
    ...
    /**
     * Get the workloadProfileName property: The workload profile used for this app. Supported for Consumption +
     * Dedicated plan.
     * 
    ...
    /**
     * Set the workloadProfileName property: The workload profile used for this app. Supported for Consumption +
     * Dedicated plan.
     * 
     * @param workloadProfileName the workloadProfileName value to set.
     * @return the AppResourceProperties object itself.
     */
    public AppResourceProperties withWorkloadProfileName(String workloadProfileName) {
        this.workloadProfileName = workloadProfileName;
        return this;
    }

    /**
     * Get the testEndpointAuthState property: State of test endpoint auth.
     * 
     * @return the testEndpointAuthState value.
     */
    public TestEndpointAuthState testEndpointAuthState() {
        return this.testEndpointAuthState;
    }

    /**
     * Set the testEndpointAuthState property: State of test endpoint auth.
     * 
     * @param testEndpointAuthState the testEndpointAuthState value to set.
     * @return the AppResourceProperties object itself.
     */
    public AppResourceProperties withTestEndpointAuthState(TestEndpointAuthState testEndpointAuthState) {
        this.testEndpointAuthState = testEndpointAuthState;
        return this;
    }
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeStringField("testEndpointAuthState",
            this.testEndpointAuthState == null ? null : this.testEndpointAuthState.toString());
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("public".equals(fieldName)) {
                    ...
                    deserializedAppResourceProperties.secrets = secrets;
                } else if ("workloadProfileName".equals(fieldName)) {
                    deserializedAppResourceProperties.workloadProfileName = reader.getString();
                } else if ("testEndpointAuthState".equals(fieldName)) {
                    deserializedAppResourceProperties.testEndpointAuthState
                        = TestEndpointAuthState.fromString(reader.getString());
                } else {
                    reader.skipChildren();
                }
            }
