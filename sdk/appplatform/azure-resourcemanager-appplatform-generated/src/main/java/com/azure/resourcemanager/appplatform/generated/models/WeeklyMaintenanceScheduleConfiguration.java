...
public final class WeeklyMaintenanceScheduleConfiguration extends MaintenanceScheduleConfiguration {
    ...
    /*
     * The duration time to run the maintenance job
     */
    @JsonProperty(value = "durationHours", access = JsonProperty.Access.WRITE_ONLY)
    ...
    /**
     * Get the durationHours property: The duration time to run the maintenance job.
     *
