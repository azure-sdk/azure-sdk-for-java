...
public final class JobOperationsImpl implements JobOperations {
    ...
    public JobExecution start(String resourceGroupName, String serviceName, String jobName,
        ...
        JobExecutionInner inner
            = this.serviceClient().start(resourceGroupName, serviceName, jobName, properties, context);
        if (inner != null) {
            return new JobExecutionImpl(inner, this.manager());
        } else {
            return null;
    ...
    public Response<Map<String, String>> listEnvSecretsWithResponse(String resourceGroupName, String serviceName,
        ...
        return this.serviceClient().listEnvSecretsWithResponse(resourceGroupName, serviceName, jobName, context);
    }

    public Map<String, String> listEnvSecrets(String resourceGroupName, String serviceName, String jobName) {
        Map<String, String> inner = this.serviceClient().listEnvSecrets(resourceGroupName, serviceName, jobName);
        if (inner != null) {
