...
public final class GatewayRouteConfigResourceCollection
    implements JsonSerializable<GatewayRouteConfigResourceCollection> {
    /*
    ...
    /**
     * Reads an instance of GatewayRouteConfigResourceCollection from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of GatewayRouteConfigResourceCollection if the JsonReader was pointing to an instance of it,
     * or null if it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the GatewayRouteConfigResourceCollection.
     */
    public static GatewayRouteConfigResourceCollection fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            GatewayRouteConfigResourceCollection deserializedGatewayRouteConfigResourceCollection
                = new GatewayRouteConfigResourceCollection();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("value".equals(fieldName)) {
                    List<GatewayRouteConfigResourceInner> value
                        = reader.readArray(reader1 -> GatewayRouteConfigResourceInner.fromJson(reader1));
                    deserializedGatewayRouteConfigResourceCollection.value = value;
                } else if ("nextLink".equals(fieldName)) {
                    deserializedGatewayRouteConfigResourceCollection.nextLink = reader.getString();
                } else {
                    reader.skipChildren();
                }
            }

            return deserializedGatewayRouteConfigResourceCollection;
        });
    }
}
