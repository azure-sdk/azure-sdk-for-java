...
public final class MiddlewareEurekaServersImpl implements MiddlewareEurekaServers {
    ...
    public MiddlewareEurekaServersImpl(
        MiddlewareEurekaServersClient innerClient,
    ...
    public PagedIterable<MiddlewareEurekaServer> list(
    ...
    public Response<MiddlewareEurekaServer> getWithResponse(
