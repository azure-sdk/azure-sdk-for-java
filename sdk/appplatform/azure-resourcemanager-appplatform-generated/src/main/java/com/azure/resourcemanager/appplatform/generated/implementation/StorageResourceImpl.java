...
public final class StorageResourceImpl implements StorageResource, StorageResource.Definition, StorageResource.Update {
    ...
    public StorageResource create() {
        this.innerObject = serviceManager.serviceClient().getStorages().createOrUpdate(resourceGroupName, serviceName,
            storageName, this.innerModel(), Context.NONE);
        return this;
    }

    public StorageResource create(Context context) {
        this.innerObject = serviceManager.serviceClient().getStorages().createOrUpdate(resourceGroupName, serviceName,
            storageName, this.innerModel(), context);
        return this;
    }

    StorageResourceImpl(String name,
    ...
    StorageResourceImpl(StorageResourceInner innerObject,
        com.azure.resourcemanager.appplatform.generated.AppPlatformManager serviceManager) {
    ...
    public StorageResource refresh() {
        this.innerObject = serviceManager.serviceClient().getStorages()
            .getWithResponse(resourceGroupName, serviceName, storageName, Context.NONE).getValue();
        return this;
    }

    public StorageResource refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getStorages()
            .getWithResponse(resourceGroupName, serviceName, storageName, context).getValue();
        return this;
    }
