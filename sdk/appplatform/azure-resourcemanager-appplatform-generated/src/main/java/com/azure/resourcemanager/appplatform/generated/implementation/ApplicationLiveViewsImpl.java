...
public final class ApplicationLiveViewsImpl implements ApplicationLiveViews {
    ...
    public ApplicationLiveViewsImpl(ApplicationLiveViewsClient innerClient,
    ...
    public PagedIterable<ApplicationLiveViewResource> list(String resourceGroupName, String serviceName) {
        ...
        return ResourceManagerUtils.mapPage(inner,
            inner1 -> new ApplicationLiveViewResourceImpl(inner1, this.manager()));
    }
    ...
    public Response<ApplicationLiveViewResource> getWithResponse(String resourceGroupName, String serviceName,
    ...
    public ApplicationLiveViewResource get(String resourceGroupName, String serviceName,
    ...
    public ApplicationLiveViewResource getById(String id) {
        ...
        String applicationLiveViewName = ResourceManagerUtils.getValueFromIdByName(id, "applicationLiveViews");
        if (applicationLiveViewName == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
                String.format("The resource ID '%s' is not valid. Missing path segment 'applicationLiveViews'.", id)));
        }
