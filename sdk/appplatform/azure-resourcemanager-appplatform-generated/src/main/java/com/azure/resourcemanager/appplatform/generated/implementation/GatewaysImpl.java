...
public final class GatewaysImpl implements Gateways {
    ...
    public Response<GatewayResource> getWithResponse(String resourceGroupName, String serviceName, String gatewayName,
        Context context) {
    ...
    public Response<Map<String, String>> listEnvSecretsWithResponse(String resourceGroupName, String serviceName,
        ...
        return this.serviceClient().listEnvSecretsWithResponse(resourceGroupName, serviceName, gatewayName, context);
    }

    public Map<String, String> listEnvSecrets(String resourceGroupName, String serviceName, String gatewayName) {
        Map<String, String> inner = this.serviceClient().listEnvSecrets(resourceGroupName, serviceName, gatewayName);
        if (inner != null) {
    ...
    public void restart(String resourceGroupName, String serviceName, String gatewayName) {
        this.serviceClient().restart(resourceGroupName, serviceName, gatewayName);
    }

    public void restart(String resourceGroupName, String serviceName, String gatewayName, Context context) {
        this.serviceClient().restart(resourceGroupName, serviceName, gatewayName, context);
    }
    ...
    public PagedIterable<GatewayResource> list(String resourceGroupName, String serviceName) {
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new GatewayResourceImpl(inner1, this.manager()));
    }
    ...
    public Response<CustomDomainValidateResult> validateDomainWithResponse(String resourceGroupName, String serviceName,
        String gatewayName, CustomDomainValidatePayload validatePayload, Context context) {
        Response<CustomDomainValidateResultInner> inner = this.serviceClient()
    ...
    public CustomDomainValidateResult validateDomain(String resourceGroupName, String serviceName, String gatewayName,
