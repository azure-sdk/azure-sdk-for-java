 ...
 */
@Fluent
public final class DeploymentResourceCollection implements JsonSerializable<DeploymentResourceCollection> {
    /*
    ...
    /**
     * Reads an instance of DeploymentResourceCollection from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of DeploymentResourceCollection if the JsonReader was pointing to an instance of it, or null
     * if it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the DeploymentResourceCollection.
     */
    public static DeploymentResourceCollection fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            DeploymentResourceCollection deserializedDeploymentResourceCollection = new DeploymentResourceCollection();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("value".equals(fieldName)) {
                    List<DeploymentResourceInner> value
                        = reader.readArray(reader1 -> DeploymentResourceInner.fromJson(reader1));
                    deserializedDeploymentResourceCollection.value = value;
                } else if ("nextLink".equals(fieldName)) {
                    deserializedDeploymentResourceCollection.nextLink = reader.getString();
                } else {
                    reader.skipChildren();
                }
            }

            return deserializedDeploymentResourceCollection;
        });
    }
}
