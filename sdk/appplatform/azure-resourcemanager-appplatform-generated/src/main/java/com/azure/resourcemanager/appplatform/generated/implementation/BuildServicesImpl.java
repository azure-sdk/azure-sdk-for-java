...
public final class BuildServicesImpl implements BuildServices {
    ...
    public BuildServicesImpl(BuildServicesClient innerClient,
    ...
    public PagedIterable<BuildService> listBuildServices(String resourceGroupName, String serviceName) {
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new BuildServiceImpl(inner1, this.manager()));
    }
    ...
    public Response<BuildService> getBuildServiceWithResponse(String resourceGroupName, String serviceName,
        String buildServiceName, Context context) {
        Response<BuildServiceInner> inner = this.serviceClient().getBuildServiceWithResponse(resourceGroupName,
            serviceName, buildServiceName, context);
        if (inner != null) {
    ...
    public PagedIterable<Build> listBuilds(String resourceGroupName, String serviceName, String buildServiceName) {
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new BuildImpl(inner1, this.manager()));
    }
    ...
    public Response<Build> getBuildWithResponse(String resourceGroupName, String serviceName, String buildServiceName,
        String buildName, Context context) {
        Response<BuildInner> inner = this.serviceClient().getBuildWithResponse(resourceGroupName, serviceName,
            buildServiceName, buildName, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
    ...
    public void deleteBuild(String resourceGroupName, String serviceName, String buildServiceName, String buildName) {
        this.serviceClient().deleteBuild(resourceGroupName, serviceName, buildServiceName, buildName);
    }

    public void deleteBuild(String resourceGroupName, String serviceName, String buildServiceName, String buildName,
        Context context) {
        this.serviceClient().deleteBuild(resourceGroupName, serviceName, buildServiceName, buildName, context);
    }

    public PagedIterable<BuildResult> listBuildResults(String resourceGroupName, String serviceName,
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new BuildResultImpl(inner1, this.manager()));
    }

    public PagedIterable<BuildResult> listBuildResults(String resourceGroupName, String serviceName,
        String buildServiceName, String buildName, Context context) {
        PagedIterable<BuildResultInner> inner = this.serviceClient().listBuildResults(resourceGroupName, serviceName,
            buildServiceName, buildName, context);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new BuildResultImpl(inner1, this.manager()));
    }

    public Response<BuildResult> getBuildResultWithResponse(String resourceGroupName, String serviceName,
        String buildServiceName, String buildName, String buildResultName, Context context) {
        Response<BuildResultInner> inner = this.serviceClient().getBuildResultWithResponse(resourceGroupName,
            serviceName, buildServiceName, buildName, buildResultName, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
    ...
    public BuildResult getBuildResult(String resourceGroupName, String serviceName, String buildServiceName,
        String buildName, String buildResultName) {
        BuildResultInner inner = this.serviceClient().getBuildResult(resourceGroupName, serviceName, buildServiceName,
            buildName, buildResultName);
        if (inner != null) {
    ...
    public Response<BuildResultLog> getBuildResultLogWithResponse(String resourceGroupName, String serviceName,
        String buildServiceName, String buildName, String buildResultName, Context context) {
        Response<BuildResultLogInner> inner = this.serviceClient().getBuildResultLogWithResponse(resourceGroupName,
            serviceName, buildServiceName, buildName, buildResultName, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
    ...
    public BuildResultLog getBuildResultLog(String resourceGroupName, String serviceName, String buildServiceName,
        String buildName, String buildResultName) {
        BuildResultLogInner inner = this.serviceClient().getBuildResultLog(resourceGroupName, serviceName,
            buildServiceName, buildName, buildResultName);
        if (inner != null) {
    ...
    public Response<ResourceUploadDefinition> getResourceUploadUrlWithResponse(String resourceGroupName,
        ...
        Response<ResourceUploadDefinitionInner> inner = this.serviceClient()
    ...
    public Response<SupportedBuildpacksCollection> listSupportedBuildpacksWithResponse(String resourceGroupName,
        String serviceName, String buildServiceName, Context context) {
        Response<SupportedBuildpacksCollectionInner> inner = this.serviceClient()
    ...
    public SupportedBuildpacksCollection listSupportedBuildpacks(String resourceGroupName, String serviceName,
        String buildServiceName) {
    ...
    public Response<SupportedBuildpackResource> getSupportedBuildpackWithResponse(String resourceGroupName,
        String serviceName, String buildServiceName, String buildpackName, Context context) {
        Response<SupportedBuildpackResourceInner> inner = this.serviceClient().getSupportedBuildpackWithResponse(
    ...
    public SupportedBuildpackResource getSupportedBuildpack(String resourceGroupName, String serviceName,
        String buildServiceName, String buildpackName) {
        SupportedBuildpackResourceInner inner = this.serviceClient().getSupportedBuildpack(resourceGroupName,
            serviceName, buildServiceName, buildpackName);
        if (inner != null) {
    ...
    public Response<SupportedStacksCollection> listSupportedStacksWithResponse(String resourceGroupName,
        String serviceName, String buildServiceName, Context context) {
        Response<SupportedStacksCollectionInner> inner = this.serviceClient()
    ...
    public SupportedStacksCollection listSupportedStacks(String resourceGroupName, String serviceName,
        String buildServiceName) {
    ...
    public Response<SupportedStackResource> getSupportedStackWithResponse(String resourceGroupName, String serviceName,
        String buildServiceName, String stackName, Context context) {
        Response<SupportedStackResourceInner> inner = this.serviceClient()
    ...
    public SupportedStackResource getSupportedStack(String resourceGroupName, String serviceName,
    ...
    public BuildService getBuildServiceById(String id) {
        ...
        String buildServiceName = ResourceManagerUtils.getValueFromIdByName(id, "buildServices");
        if (buildServiceName == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
                String.format("The resource ID '%s' is not valid. Missing path segment 'buildServices'.", id)));
        }
        return this.getBuildServiceWithResponse(resourceGroupName, serviceName, buildServiceName, Context.NONE)
            .getValue();
    }

    public Response<BuildService> getBuildServiceByIdWithResponse(String id, Context context) {
        String resourceGroupName = ResourceManagerUtils.getValueFromIdByName(id, "resourceGroups");
        if (resourceGroupName == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
                String.format("The resource ID '%s' is not valid. Missing path segment 'resourceGroups'.", id)));
        ...
        return this.getBuildServiceWithResponse(resourceGroupName, serviceName, buildServiceName, context);
    }
    ...
    public Build getBuildById(String id) {
        ...
        return this.getBuildWithResponse(resourceGroupName, serviceName, buildServiceName, buildName, Context.NONE)
            .getValue();
    }
    ...
    public void deleteBuildById(String id) {
        ...
        this.deleteBuild(resourceGroupName, serviceName, buildServiceName, buildName, Context.NONE);
    }

    public void deleteBuildByIdWithResponse(String id, Context context) {
        String resourceGroupName = ResourceManagerUtils.getValueFromIdByName(id, "resourceGroups");
        if (resourceGroupName == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
                String.format("The resource ID '%s' is not valid. Missing path segment 'resourceGroups'.", id)));
        ...
        this.deleteBuild(resourceGroupName, serviceName, buildServiceName, buildName, context);
    }
    ...
    public BuildServiceImpl define(String name) {
        return new BuildServiceImpl(name, this.manager());
    }

    public BuildImpl defineBuild(String name) {
