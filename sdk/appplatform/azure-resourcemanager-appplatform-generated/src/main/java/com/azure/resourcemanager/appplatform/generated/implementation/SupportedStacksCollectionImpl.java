...
public final class SupportedStacksCollectionImpl implements SupportedStacksCollection {
    ...
    SupportedStacksCollectionImpl(SupportedStacksCollectionInner innerObject,
    ...
    public List<SupportedStackResource> value() {
        ...
        if (inner != null) {
            return Collections.unmodifiableList(inner.stream()
                .map(inner1 -> new SupportedStackResourceImpl(inner1, this.manager())).collect(Collectors.toList()));
        } else {
