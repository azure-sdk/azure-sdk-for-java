...
public final class BuilderResourceImpl implements BuilderResource, BuilderResource.Definition, BuilderResource.Update {
    ...
    public BuilderResourceImpl withExistingBuildService(String resourceGroupName, String serviceName,
    ...
    public BuilderResource create() {
        this.innerObject = serviceManager.serviceClient().getBuildServiceBuilders().createOrUpdate(resourceGroupName,
            serviceName, buildServiceName, builderName, this.innerModel(), Context.NONE);
        return this;
    }

    public BuilderResource create(Context context) {
        this.innerObject = serviceManager.serviceClient().getBuildServiceBuilders().createOrUpdate(resourceGroupName,
            serviceName, buildServiceName, builderName, this.innerModel(), context);
        return this;
    }

    BuilderResourceImpl(String name,
    ...
    public BuilderResource refresh() {
        this.innerObject = serviceManager.serviceClient().getBuildServiceBuilders()
            .getWithResponse(resourceGroupName, serviceName, buildServiceName, builderName, Context.NONE).getValue();
        return this;
    }

    public BuilderResource refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getBuildServiceBuilders()
            .getWithResponse(resourceGroupName, serviceName, buildServiceName, builderName, context).getValue();
        return this;
    }

    public Response<DeploymentList> listDeploymentsWithResponse(Context context) {
        return serviceManager.buildServiceBuilders().listDeploymentsWithResponse(resourceGroupName, serviceName,
            buildServiceName, builderName, context);
    }

    public DeploymentList listDeployments() {
        return serviceManager.buildServiceBuilders().listDeployments(resourceGroupName, serviceName, buildServiceName,
            builderName);
    }
