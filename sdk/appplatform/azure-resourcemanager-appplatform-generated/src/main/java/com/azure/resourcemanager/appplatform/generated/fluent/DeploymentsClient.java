...
public interface DeploymentsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    DeploymentResourceAutoGeneratedInner get(
        String resourceGroupName, String serviceName, String appName, String deploymentName);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<DeploymentResourceAutoGeneratedInner> getWithResponse(
        String resourceGroupName, String serviceName, String appName, String deploymentName, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<DeploymentResourceAutoGeneratedInner>, DeploymentResourceAutoGeneratedInner>
        beginCreateOrUpdate(
            String resourceGroupName,
            String serviceName,
            String appName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    DeploymentResourceAutoGeneratedInner createOrUpdate(
        String resourceGroupName,
        String serviceName,
        String appName,
        String deploymentName,
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<DeploymentResourceAutoGeneratedInner>, DeploymentResourceAutoGeneratedInner> beginUpdate(
        String resourceGroupName,
        String serviceName,
        String appName,
        String deploymentName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    DeploymentResourceAutoGeneratedInner update(
        String resourceGroupName,
        String serviceName,
        String appName,
        String deploymentName,
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<DeploymentResourceAutoGeneratedInner> list(
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<DeploymentResourceAutoGeneratedInner> listForCluster(String resourceGroupName, String serviceName);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<DeploymentResourceAutoGeneratedInner> listForCluster(
        String resourceGroupName, String serviceName, List<String> version, Context context);
