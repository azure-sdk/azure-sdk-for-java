 ...
 */
@Fluent
public final class SupportedBuildpacksCollectionInner implements JsonSerializable<SupportedBuildpacksCollectionInner> {
    /*
     ...
     * @return An instance of SupportedBuildpacksCollectionInner if the JsonReader was pointing to an instance of it, or
     * null if it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the SupportedBuildpacksCollectionInner.
     */
    public static SupportedBuildpacksCollectionInner fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            SupportedBuildpacksCollectionInner deserializedSupportedBuildpacksCollectionInner
                = new SupportedBuildpacksCollectionInner();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("value".equals(fieldName)) {
                    List<SupportedBuildpackResourceInner> value
                        = reader.readArray(reader1 -> SupportedBuildpackResourceInner.fromJson(reader1));
                    deserializedSupportedBuildpacksCollectionInner.value = value;
                } else if ("nextLink".equals(fieldName)) {
                    deserializedSupportedBuildpacksCollectionInner.nextLink = reader.getString();
                } else {
                    reader.skipChildren();
                }
            }

            return deserializedSupportedBuildpacksCollectionInner;
        });
    }
}
