...
public final class ServicesImpl implements Services {
    ...
    public Response<ServiceResource> getByResourceGroupWithResponse(String resourceGroupName, String serviceName,
        Context context) {
    ...
    public Response<TestKeys> regenerateTestKeyWithResponse(String resourceGroupName, String serviceName,
        ...
        Response<TestKeysInner> inner = this.serviceClient().regenerateTestKeyWithResponse(resourceGroupName,
            serviceName, regenerateTestKeyRequest, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
                new TestKeysImpl(inner.getValue(), this.manager()));
        } else {
    ...
    public void flushVnetDnsSetting(String resourceGroupName, String serviceName) {
        this.serviceClient().flushVnetDnsSetting(resourceGroupName, serviceName);
    }

    public void flushVnetDnsSetting(String resourceGroupName, String serviceName, Context context) {
        this.serviceClient().flushVnetDnsSetting(resourceGroupName, serviceName, context);
    }

    public PagedIterable<SupportedApmType> listSupportedApmTypes(String resourceGroupName, String serviceName) {
        PagedIterable<SupportedApmTypeInner> inner
            = this.serviceClient().listSupportedApmTypes(resourceGroupName, serviceName);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new SupportedApmTypeImpl(inner1, this.manager()));
    }

    public PagedIterable<SupportedApmType> listSupportedApmTypes(String resourceGroupName, String serviceName,
        Context context) {
        PagedIterable<SupportedApmTypeInner> inner
            = this.serviceClient().listSupportedApmTypes(resourceGroupName, serviceName, context);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new SupportedApmTypeImpl(inner1, this.manager()));
    }

    public Response<GloballyEnabledApms> listGloballyEnabledApmsWithResponse(String resourceGroupName,
        String serviceName, Context context) {
        Response<GloballyEnabledApmsInner> inner
            = this.serviceClient().listGloballyEnabledApmsWithResponse(resourceGroupName, serviceName, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
                new GloballyEnabledApmsImpl(inner.getValue(), this.manager()));
        } else {
            return null;
        }
    }

    public GloballyEnabledApms listGloballyEnabledApms(String resourceGroupName, String serviceName) {
        GloballyEnabledApmsInner inner = this.serviceClient().listGloballyEnabledApms(resourceGroupName, serviceName);
        if (inner != null) {
            return new GloballyEnabledApmsImpl(inner, this.manager());
        } else {
            return null;
        }
    }
    ...
    public PagedIterable<SupportedServerVersion> listSupportedServerVersions(String resourceGroupName,
        String serviceName) {
        PagedIterable<SupportedServerVersionInner> inner
            = this.serviceClient().listSupportedServerVersions(resourceGroupName, serviceName);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new SupportedServerVersionImpl(inner1, this.manager()));
    }

    public PagedIterable<SupportedServerVersion> listSupportedServerVersions(String resourceGroupName,
        String serviceName, Context context) {
        PagedIterable<SupportedServerVersionInner> inner
            = this.serviceClient().listSupportedServerVersions(resourceGroupName, serviceName, context);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new SupportedServerVersionImpl(inner1, this.manager()));
    }
