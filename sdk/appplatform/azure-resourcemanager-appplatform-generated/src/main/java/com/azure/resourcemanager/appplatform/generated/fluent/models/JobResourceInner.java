...
public final class JobResourceInner extends ProxyResource {
     ...
     */
    private JobResourceProperties properties;
    ...
    /**
     * Get the properties property: Properties of the Job resource.
     * 
    ...
    /**
     * Set the properties property: Properties of the Job resource.
     * 
     * @param properties the properties value to set.
     * @return the JobResourceInner object itself.
     */
    public JobResourceInner withProperties(JobResourceProperties properties) {
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("id".equals(fieldName)) {
                    ...
                    deserializedJobResourceInner.properties = JobResourceProperties.fromJson(reader);
