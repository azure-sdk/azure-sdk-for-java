...
public final class BuildImpl implements Build, Build.Definition, Build.Update {
    ...
    public Build create() {
        this.innerObject
            = serviceManager.serviceClient().getBuildServices().createOrUpdateBuildWithResponse(resourceGroupName,
                serviceName, buildServiceName, buildName, this.innerModel(), Context.NONE).getValue();
        return this;
    }
    ...
    public Build create(Context context) {
        this.innerObject
            = serviceManager.serviceClient().getBuildServices().createOrUpdateBuildWithResponse(resourceGroupName,
                serviceName, buildServiceName, buildName, this.innerModel(), context).getValue();
        return this;
    }
    ...
    BuildImpl(BuildInner innerObject,
    ...
    public Build refresh() {
        this.innerObject = serviceManager.serviceClient().getBuildServices()
            .getBuildWithResponse(resourceGroupName, serviceName, buildServiceName, buildName, Context.NONE).getValue();
        return this;
    }

    public Build refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getBuildServices()
            .getBuildWithResponse(resourceGroupName, serviceName, buildServiceName, buildName, context).getValue();
        return this;
    }
