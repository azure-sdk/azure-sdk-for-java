...
public final class SupportedBuildpacksCollectionImpl implements SupportedBuildpacksCollection {
    ...
    SupportedBuildpacksCollectionImpl(SupportedBuildpacksCollectionInner innerObject,
    ...
    public List<SupportedBuildpackResource> value() {
        ...
        if (inner != null) {
            return Collections.unmodifiableList(
                inner.stream().map(inner1 -> new SupportedBuildpackResourceImpl(inner1, this.manager()))
