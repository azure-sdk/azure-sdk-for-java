...
@Fluent
public final class MiddlewareConfigServerSettingsValidateResultInner {
    /*
     * Indicate if the config server settings are valid
     */
    @JsonProperty(value = "isValid")
    private EnumAsBoolean isValid;
    ...
    /** Creates an instance of MiddlewareConfigServerSettingsValidateResultInner class. */
    public MiddlewareConfigServerSettingsValidateResultInner() {
    }
     ...
     * @return the MiddlewareConfigServerSettingsValidateResultInner object itself.
     */
    public MiddlewareConfigServerSettingsValidateResultInner withIsValid(EnumAsBoolean isValid) {
     ...
     * @return the MiddlewareConfigServerSettingsValidateResultInner object itself.
     */
    public MiddlewareConfigServerSettingsValidateResultInner withDetails(
