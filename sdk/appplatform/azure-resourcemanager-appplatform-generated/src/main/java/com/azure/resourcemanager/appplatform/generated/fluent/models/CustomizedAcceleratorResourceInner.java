...
public final class CustomizedAcceleratorResourceInner extends ProxyResource {
     ...
     * @return An instance of CustomizedAcceleratorResourceInner if the JsonReader was pointing to an instance of it, or
     * null if it was pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the CustomizedAcceleratorResourceInner.
     */
    public static CustomizedAcceleratorResourceInner fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            CustomizedAcceleratorResourceInner deserializedCustomizedAcceleratorResourceInner
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("id".equals(fieldName)) {
                    deserializedCustomizedAcceleratorResourceInner.id = reader.getString();
                } else if ("name".equals(fieldName)) {
                    deserializedCustomizedAcceleratorResourceInner.name = reader.getString();
                } else if ("type".equals(fieldName)) {
                    deserializedCustomizedAcceleratorResourceInner.type = reader.getString();
                } else if ("properties".equals(fieldName)) {
                    deserializedCustomizedAcceleratorResourceInner.properties
                        = CustomizedAcceleratorProperties.fromJson(reader);
                } else if ("sku".equals(fieldName)) {
                    deserializedCustomizedAcceleratorResourceInner.sku = Sku.fromJson(reader);
                } else if ("systemData".equals(fieldName)) {
                    deserializedCustomizedAcceleratorResourceInner.systemData = SystemData.fromJson(reader);
                } else {
                    reader.skipChildren();
                }
            }

            return deserializedCustomizedAcceleratorResourceInner;
        });
    }
}
