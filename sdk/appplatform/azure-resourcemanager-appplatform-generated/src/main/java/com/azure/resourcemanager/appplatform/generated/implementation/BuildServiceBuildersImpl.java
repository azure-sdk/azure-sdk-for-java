...
public final class BuildServiceBuildersImpl implements BuildServiceBuilders {
    ...
    public BuildServiceBuildersImpl(BuildServiceBuildersClient innerClient,
        com.azure.resourcemanager.appplatform.generated.AppPlatformManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public Response<BuilderResource> getWithResponse(String resourceGroupName, String serviceName,
        String buildServiceName, String builderName, Context context) {
        Response<BuilderResourceInner> inner = this.serviceClient().getWithResponse(resourceGroupName, serviceName,
            buildServiceName, builderName, context);
        if (inner != null) {
    ...
    public BuilderResource get(String resourceGroupName, String serviceName, String buildServiceName,
        String builderName) {
    ...
    public Response<DeploymentList> listDeploymentsWithResponse(String resourceGroupName, String serviceName,
        String buildServiceName, String builderName, Context context) {
        Response<DeploymentListInner> inner = this.serviceClient().listDeploymentsWithResponse(resourceGroupName,
            serviceName, buildServiceName, builderName, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
                new DeploymentListImpl(inner.getValue(), this.manager()));
        } else {
            return null;
        }
    }

    public DeploymentList listDeployments(String resourceGroupName, String serviceName, String buildServiceName,
        String builderName) {
        DeploymentListInner inner
            = this.serviceClient().listDeployments(resourceGroupName, serviceName, buildServiceName, builderName);
        if (inner != null) {
            return new DeploymentListImpl(inner, this.manager());
        } else {
            return null;
        }
    }
    ...
    public BuilderResource getById(String id) {
        ...
        return this.getWithResponse(resourceGroupName, serviceName, buildServiceName, builderName, Context.NONE)
            .getValue();
    }
