...
public final class ContainerRegistriesClientImpl implements ContainerRegistriesClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ContainerRegistryResourceInner> getAsync(
        String resourceGroupName, String serviceName, String containerRegistryName) {
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String serviceName, String containerRegistryName) {
        return beginDeleteAsync(resourceGroupName, serviceName, containerRegistryName)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<Void> deleteAsync(
        String resourceGroupName, String serviceName, String containerRegistryName, Context context) {
        return beginDeleteAsync(resourceGroupName, serviceName, containerRegistryName, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> validateWithResponseAsync(
        ...
        if (containerRegistryProperties == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
                        "Parameter containerRegistryProperties is required and cannot be null."));
        } else {
    ...
    private PollerFlux<PollResult<ContainerRegistryValidateResultInner>, ContainerRegistryValidateResultInner>
        ...
        Mono<Response<Flux<ByteBuffer>>> mono =
            validateWithResponseAsync(
                resourceGroupName, serviceName, containerRegistryName, containerRegistryProperties);
        return this
            .client
            .<ContainerRegistryValidateResultInner, ContainerRegistryValidateResultInner>getLroResult(
                mono,
                this.client.getHttpPipeline(),
                ContainerRegistryValidateResultInner.class,
                ContainerRegistryValidateResultInner.class,
                this.client.getContext());
    }
    ...
    private PollerFlux<PollResult<ContainerRegistryValidateResultInner>, ContainerRegistryValidateResultInner>
        ...
        Mono<Response<Flux<ByteBuffer>>> mono =
            validateWithResponseAsync(
                resourceGroupName, serviceName, containerRegistryName, containerRegistryProperties, context);
        return this
            .client
            .<ContainerRegistryValidateResultInner, ContainerRegistryValidateResultInner>getLroResult(
                mono,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ContainerRegistryValidateResultInner> validateAsync(
        String resourceGroupName,
        String serviceName,
        String containerRegistryName,
        ContainerRegistryProperties containerRegistryProperties) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ContainerRegistryValidateResultInner validate(
        String resourceGroupName,
        String serviceName,
        String containerRegistryName,
        ContainerRegistryProperties containerRegistryProperties) {
