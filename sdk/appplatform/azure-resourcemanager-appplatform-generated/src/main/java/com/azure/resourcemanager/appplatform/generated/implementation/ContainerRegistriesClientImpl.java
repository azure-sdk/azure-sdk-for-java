...
public final class ContainerRegistriesClientImpl implements ContainerRegistriesClient {
    ...
    private Mono<Response<ContainerRegistryResourceInner>> getWithResponseAsync(String resourceGroupName,
        ...
        return service.get(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(), resourceGroupName,
            serviceName, containerRegistryName, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ContainerRegistryResourceInner> getAsync(String resourceGroupName, String serviceName,
    ...
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String resourceGroupName,
        ...
        return service.createOrUpdate(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(),
            resourceGroupName, serviceName, containerRegistryName, containerRegistryResource, accept, context);
    }
