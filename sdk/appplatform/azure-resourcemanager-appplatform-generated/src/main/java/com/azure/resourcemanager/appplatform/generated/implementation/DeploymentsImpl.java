...
public final class DeploymentsImpl implements Deployments {
    ...
    public DeploymentResourceAutoGenerated get(
        String resourceGroupName, String serviceName, String appName, String deploymentName) {
        DeploymentResourceAutoGeneratedInner inner =
            this.serviceClient().get(resourceGroupName, serviceName, appName, deploymentName);
        if (inner != null) {
            return new DeploymentResourceAutoGeneratedImpl(inner, this.manager());
        } else {
            return null;
        }
    }

    public Response<DeploymentResourceAutoGenerated> getWithResponse(
        String resourceGroupName, String serviceName, String appName, String deploymentName, Context context) {
        Response<DeploymentResourceAutoGeneratedInner> inner =
            this.serviceClient().getWithResponse(resourceGroupName, serviceName, appName, deploymentName, context);
        if (inner != null) {
            return new SimpleResponse<>(
                inner.getRequest(),
                inner.getStatusCode(),
                inner.getHeaders(),
                new DeploymentResourceAutoGeneratedImpl(inner.getValue(), this.manager()));
        } else {
            return null;
        }
    }
    ...
    public PagedIterable<DeploymentResourceAutoGenerated> list(
        String resourceGroupName, String serviceName, String appName) {
        PagedIterable<DeploymentResourceAutoGeneratedInner> inner =
            this.serviceClient().list(resourceGroupName, serviceName, appName);
        return Utils.mapPage(inner, inner1 -> new DeploymentResourceAutoGeneratedImpl(inner1, this.manager()));
    }
    ...
    public PagedIterable<DeploymentResourceAutoGenerated> listForCluster(String resourceGroupName, String serviceName) {
        PagedIterable<DeploymentResourceAutoGeneratedInner> inner =
            this.serviceClient().listForCluster(resourceGroupName, serviceName);
        return Utils.mapPage(inner, inner1 -> new DeploymentResourceAutoGeneratedImpl(inner1, this.manager()));
    }

    public PagedIterable<DeploymentResourceAutoGenerated> listForCluster(
        String resourceGroupName, String serviceName, List<String> version, Context context) {
        PagedIterable<DeploymentResourceAutoGeneratedInner> inner =
            this.serviceClient().listForCluster(resourceGroupName, serviceName, version, context);
        return Utils.mapPage(inner, inner1 -> new DeploymentResourceAutoGeneratedImpl(inner1, this.manager()));
    ...
    public DeploymentResourceAutoGeneratedImpl define(String name) {
        return new DeploymentResourceAutoGeneratedImpl(name, this.manager());
    }
}
