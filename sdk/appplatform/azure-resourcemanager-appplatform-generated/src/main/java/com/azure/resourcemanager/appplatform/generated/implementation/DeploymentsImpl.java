...
public final class DeploymentsImpl implements Deployments {
    ...
    public Response<DeploymentResource> getWithResponse(String resourceGroupName, String serviceName, String appName,
    ...
    public PagedIterable<DeploymentResource> list(String resourceGroupName, String serviceName, String appName) {
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new DeploymentResourceImpl(inner1, this.manager()));
    }

    public PagedIterable<DeploymentResource> list(String resourceGroupName, String serviceName, String appName,
        List<String> version, String expand, Context context) {
        PagedIterable<DeploymentResourceInner> inner
            = this.serviceClient().list(resourceGroupName, serviceName, appName, version, expand, context);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new DeploymentResourceImpl(inner1, this.manager()));
    }
    ...
    public PagedIterable<DeploymentResource> listForCluster(String resourceGroupName, String serviceName,
        List<String> version, String expand, Context context) {
        PagedIterable<DeploymentResourceInner> inner
            = this.serviceClient().listForCluster(resourceGroupName, serviceName, version, expand, context);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new DeploymentResourceImpl(inner1, this.manager()));
    }
    ...
    public RemoteDebugging enableRemoteDebugging(String resourceGroupName, String serviceName, String appName,
        String deploymentName) {
        RemoteDebuggingInner inner
            = this.serviceClient().enableRemoteDebugging(resourceGroupName, serviceName, appName, deploymentName);
        if (inner != null) {
            return new RemoteDebuggingImpl(inner, this.manager());
        } else {
            return null;
        }
    }
    ...
    public RemoteDebugging enableRemoteDebugging(String resourceGroupName, String serviceName, String appName,
        ...
        RemoteDebuggingInner inner = this.serviceClient().enableRemoteDebugging(resourceGroupName, serviceName, appName,
            deploymentName, remoteDebuggingPayload, context);
        if (inner != null) {
            return new RemoteDebuggingImpl(inner, this.manager());
        } else {
            return null;
    ...
    public RemoteDebugging disableRemoteDebugging(String resourceGroupName, String serviceName, String appName,
        String deploymentName) {
        RemoteDebuggingInner inner
            = this.serviceClient().disableRemoteDebugging(resourceGroupName, serviceName, appName, deploymentName);
        if (inner != null) {
            return new RemoteDebuggingImpl(inner, this.manager());
        } else {
            return null;
    ...
    public RemoteDebugging disableRemoteDebugging(String resourceGroupName, String serviceName, String appName,
        String deploymentName, Context context) {
        RemoteDebuggingInner inner = this.serviceClient().disableRemoteDebugging(resourceGroupName, serviceName,
            appName, deploymentName, context);
        if (inner != null) {
            return new RemoteDebuggingImpl(inner, this.manager());
        } else {
            return null;
    ...
    public Response<RemoteDebugging> getRemoteDebuggingConfigWithResponse(String resourceGroupName, String serviceName,
        String appName, String deploymentName, Context context) {
        Response<RemoteDebuggingInner> inner = this.serviceClient()
            .getRemoteDebuggingConfigWithResponse(resourceGroupName, serviceName, appName, deploymentName, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
                new RemoteDebuggingImpl(inner.getValue(), this.manager()));
        } else {
            return null;
        }
    }

    public RemoteDebugging getRemoteDebuggingConfig(String resourceGroupName, String serviceName, String appName,
        String deploymentName) {
        RemoteDebuggingInner inner
            = this.serviceClient().getRemoteDebuggingConfig(resourceGroupName, serviceName, appName, deploymentName);
        if (inner != null) {
            return new RemoteDebuggingImpl(inner, this.manager());
        } else {
            return null;
    ...
    public Response<LogFileUrlResponse> getLogFileUrlWithResponse(String resourceGroupName, String serviceName,
        String appName, String deploymentName, Context context) {
        Response<LogFileUrlResponseInner> inner = this.serviceClient().getLogFileUrlWithResponse(resourceGroupName,
    ...
    public LogFileUrlResponse getLogFileUrl(String resourceGroupName, String serviceName, String appName,
        String deploymentName) {
    ...
    public void generateHeapDump(String resourceGroupName, String serviceName, String appName, String deploymentName,
        ...
        this.serviceClient().generateHeapDump(resourceGroupName, serviceName, appName, deploymentName,
    ...
    public void generateHeapDump(String resourceGroupName, String serviceName, String appName, String deploymentName,
        ...
        this.serviceClient().generateHeapDump(resourceGroupName, serviceName, appName, deploymentName,
            diagnosticParameters, context);
    }

    public void generateThreadDump(String resourceGroupName, String serviceName, String appName, String deploymentName,
        DiagnosticParameters diagnosticParameters) {
        this.serviceClient().generateThreadDump(resourceGroupName, serviceName, appName, deploymentName,
            diagnosticParameters);
    }
    ...
    public DeploymentResource getById(String id) {
        ...
        String appName = ResourceManagerUtils.getValueFromIdByName(id, "apps");
        if (appName == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
