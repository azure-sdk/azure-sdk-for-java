...
@Fluent
public final class ResourceSkuAutoGeneratedInner {
    /*
    ...
    private List<ResourceSkuLocationInfoAutoGenerated> locationInfo;
     ...
     * @return the ResourceSkuAutoGeneratedInner object itself.
     */
    public ResourceSkuAutoGeneratedInner withResourceType(String resourceType) {
     ...
     * @return the ResourceSkuAutoGeneratedInner object itself.
     */
    public ResourceSkuAutoGeneratedInner withName(String name) {
        this.name = name;
        return this;
    }
     ...
     * @return the ResourceSkuAutoGeneratedInner object itself.
     */
    public ResourceSkuAutoGeneratedInner withTier(String tier) {
        this.tier = tier;
        return this;
    }
     ...
     * @return the ResourceSkuAutoGeneratedInner object itself.
     */
    public ResourceSkuAutoGeneratedInner withCapacity(SkuCapacity capacity) {
     ...
     * @return the ResourceSkuAutoGeneratedInner object itself.
     */
    public ResourceSkuAutoGeneratedInner withLocations(List<String> locations) {
     ...
     * @return the ResourceSkuAutoGeneratedInner object itself.
     */
    public ResourceSkuAutoGeneratedInner withLocationInfo(List<ResourceSkuLocationInfoAutoGenerated> locationInfo) {
     ...
     * @return the ResourceSkuAutoGeneratedInner object itself.
     */
    public ResourceSkuAutoGeneratedInner withRestrictions(List<ResourceSkuRestrictions> restrictions) {
