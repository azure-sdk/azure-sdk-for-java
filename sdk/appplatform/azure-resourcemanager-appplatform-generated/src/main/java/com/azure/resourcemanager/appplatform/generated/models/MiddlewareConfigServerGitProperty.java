...
/** Property of git. */
@Fluent
public final class MiddlewareConfigServerGitProperty {
    /*
     * Repositories of git.
     */
    @JsonProperty(value = "repositories")
    private List<MiddlewareGitPatternRepository> repositories;
    ...
    private StrictHostKeyCheckingEnum strictHostKeyChecking;

    /** Creates an instance of MiddlewareConfigServerGitProperty class. */
    public MiddlewareConfigServerGitProperty() {
    }
     ...
     */
    public List<MiddlewareGitPatternRepository> repositories() {
     ...
     * @return the MiddlewareConfigServerGitProperty object itself.
     */
    public MiddlewareConfigServerGitProperty withRepositories(List<MiddlewareGitPatternRepository> repositories) {
     ...
     * @return the MiddlewareConfigServerGitProperty object itself.
     */
    public MiddlewareConfigServerGitProperty withUri(String uri) {
        this.uri = uri;
        return this;
    }
     ...
     * @return the MiddlewareConfigServerGitProperty object itself.
     */
    public MiddlewareConfigServerGitProperty withLabel(String label) {
        this.label = label;
        return this;
    }
     ...
     * @return the MiddlewareConfigServerGitProperty object itself.
     */
    public MiddlewareConfigServerGitProperty withSearchPaths(List<String> searchPaths) {
     ...
     * @return the MiddlewareConfigServerGitProperty object itself.
     */
    public MiddlewareConfigServerGitProperty withUsername(String username) {
     ...
     * @return the MiddlewareConfigServerGitProperty object itself.
     */
    public MiddlewareConfigServerGitProperty withPassword(String password) {
     ...
     * @return the MiddlewareConfigServerGitProperty object itself.
     */
    public MiddlewareConfigServerGitProperty withHostKey(String hostKey) {
     ...
     * @return the MiddlewareConfigServerGitProperty object itself.
     */
    public MiddlewareConfigServerGitProperty withHostKeyAlgorithm(String hostKeyAlgorithm) {
     ...
     * @return the MiddlewareConfigServerGitProperty object itself.
     */
    public MiddlewareConfigServerGitProperty withPrivateKey(String privateKey) {
     ...
     */
    public StrictHostKeyCheckingEnum strictHostKeyChecking() {
     ...
     * @return the MiddlewareConfigServerGitProperty object itself.
     */
    public MiddlewareConfigServerGitProperty withStrictHostKeyChecking(
        StrictHostKeyCheckingEnum strictHostKeyChecking) {
            ...
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException(
                        "Missing required property uri in model MiddlewareConfigServerGitProperty"));
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(MiddlewareConfigServerGitProperty.class);
}
