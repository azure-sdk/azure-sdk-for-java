...
public final class DeploymentResourceImpl
    ...
    public DeploymentResource create() {
        this.innerObject = serviceManager.serviceClient()
            .getDeployments()
            .createOrUpdate(resourceGroupName, serviceName, appName, deploymentName, this.innerModel(), Context.NONE);
        return this;
    }
    ...
    public RemoteDebugging enableRemoteDebugging() {
        return serviceManager.deployments()
            .enableRemoteDebugging(resourceGroupName, serviceName, appName, deploymentName);
    }
    ...
    public RemoteDebugging disableRemoteDebugging() {
        return serviceManager.deployments()
            .disableRemoteDebugging(resourceGroupName, serviceName, appName, deploymentName);
    }
    ...
    public RemoteDebugging getRemoteDebuggingConfig() {
        return serviceManager.deployments()
            .getRemoteDebuggingConfig(resourceGroupName, serviceName, appName, deploymentName);
    }
