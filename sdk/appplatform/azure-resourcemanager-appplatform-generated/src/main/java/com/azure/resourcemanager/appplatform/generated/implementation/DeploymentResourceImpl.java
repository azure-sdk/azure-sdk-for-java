...
public final class DeploymentResourceImpl
    ...
    public DeploymentResource create() {
        this.innerObject = serviceManager.serviceClient().getDeployments().createOrUpdate(resourceGroupName,
            serviceName, appName, deploymentName, this.innerModel(), Context.NONE);
        return this;
    }

    public DeploymentResource create(Context context) {
        this.innerObject = serviceManager.serviceClient().getDeployments().createOrUpdate(resourceGroupName,
            serviceName, appName, deploymentName, this.innerModel(), context);
        return this;
    }

    DeploymentResourceImpl(String name,
    ...
    public DeploymentResource apply() {
        this.innerObject = serviceManager.serviceClient().getDeployments().update(resourceGroupName, serviceName,
            appName, deploymentName, this.innerModel(), Context.NONE);
        return this;
    }

    public DeploymentResource apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getDeployments().update(resourceGroupName, serviceName,
            appName, deploymentName, this.innerModel(), context);
        return this;
    }

    DeploymentResourceImpl(DeploymentResourceInner innerObject,
        com.azure.resourcemanager.appplatform.generated.AppPlatformManager serviceManager) {
        this.innerObject = innerObject;
        this.serviceManager = serviceManager;
        this.resourceGroupName = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "resourceGroups");
        this.serviceName = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "Spring");
        this.appName = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "apps");
    ...
    public DeploymentResource refresh() {
        this.innerObject = serviceManager.serviceClient().getDeployments()
            .getWithResponse(resourceGroupName, serviceName, appName, deploymentName, Context.NONE).getValue();
        return this;
    }

    public DeploymentResource refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getDeployments()
            .getWithResponse(resourceGroupName, serviceName, appName, deploymentName, context).getValue();
        return this;
    }
    ...
    public RemoteDebugging enableRemoteDebugging() {
        return serviceManager.deployments().enableRemoteDebugging(resourceGroupName, serviceName, appName,
            deploymentName);
    }

    public RemoteDebugging enableRemoteDebugging(RemoteDebuggingPayload remoteDebuggingPayload, Context context) {
        return serviceManager.deployments().enableRemoteDebugging(resourceGroupName, serviceName, appName,
            deploymentName, remoteDebuggingPayload, context);
    }

    public RemoteDebugging disableRemoteDebugging() {
        return serviceManager.deployments().disableRemoteDebugging(resourceGroupName, serviceName, appName,
            deploymentName);
    }

    public RemoteDebugging disableRemoteDebugging(Context context) {
        return serviceManager.deployments().disableRemoteDebugging(resourceGroupName, serviceName, appName,
            deploymentName, context);
    }

    public Response<RemoteDebugging> getRemoteDebuggingConfigWithResponse(Context context) {
        return serviceManager.deployments().getRemoteDebuggingConfigWithResponse(resourceGroupName, serviceName,
            appName, deploymentName, context);
    }

    public RemoteDebugging getRemoteDebuggingConfig() {
        return serviceManager.deployments().getRemoteDebuggingConfig(resourceGroupName, serviceName, appName,
            deploymentName);
    }

    public Response<LogFileUrlResponse> getLogFileUrlWithResponse(Context context) {
        return serviceManager.deployments().getLogFileUrlWithResponse(resourceGroupName, serviceName, appName,
            deploymentName, context);
    }
    ...
    public void generateHeapDump(DiagnosticParameters diagnosticParameters) {
        serviceManager.deployments().generateHeapDump(resourceGroupName, serviceName, appName, deploymentName,
    ...
    public void generateThreadDump(DiagnosticParameters diagnosticParameters) {
        serviceManager.deployments().generateThreadDump(resourceGroupName, serviceName, appName, deploymentName,
            diagnosticParameters);
    }
    ...
    public void startJfr(DiagnosticParameters diagnosticParameters) {
        serviceManager.deployments().startJfr(resourceGroupName, serviceName, appName, deploymentName,
            diagnosticParameters);
    }
