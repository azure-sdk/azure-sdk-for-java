...
public final class CustomizedAcceleratorsImpl implements CustomizedAccelerators {
    ...
    public Response<CustomizedAcceleratorResource> getWithResponse(String resourceGroupName, String serviceName,
        ...
        Response<CustomizedAcceleratorResourceInner> inner = this.serviceClient()
            .getWithResponse(resourceGroupName, serviceName, applicationAcceleratorName, customizedAcceleratorName,
                context);
        if (inner != null) {
    ...
    public CustomizedAcceleratorValidateResult validate(String resourceGroupName, String serviceName,
        ...
        CustomizedAcceleratorValidateResultInner inner = this.serviceClient()
            .validate(resourceGroupName, serviceName, applicationAcceleratorName, customizedAcceleratorName,
                properties);
        if (inner != null) {
    ...
    public CustomizedAcceleratorValidateResult validate(String resourceGroupName, String serviceName,
        ...
        Context context) {
        CustomizedAcceleratorValidateResultInner inner = this.serviceClient()
            .validate(resourceGroupName, serviceName, applicationAcceleratorName, customizedAcceleratorName, properties,
                context);
        if (inner != null) {
            return new CustomizedAcceleratorValidateResultImpl(inner, this.manager());
        } else {
