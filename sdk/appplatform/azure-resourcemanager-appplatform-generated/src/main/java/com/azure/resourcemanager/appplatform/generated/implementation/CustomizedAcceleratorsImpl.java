...
public final class CustomizedAcceleratorsImpl implements CustomizedAccelerators {
    ...
    public Response<CustomizedAcceleratorValidateResult> validateWithResponse(String resourceGroupName,
        ...
        Response<CustomizedAcceleratorValidateResultInner> inner = this.serviceClient().validateWithResponse(
            resourceGroupName, serviceName, applicationAcceleratorName, customizedAcceleratorName, properties, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
