...
public interface MiddlewareEurekaServersClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<MiddlewareEurekaServerInner> list(
    ...
    Response<MiddlewareEurekaServerInner> getWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    MiddlewareEurekaServerInner createOrUpdate(
        String resourceGroupName,
        String javaEnvironmentName,
        String eurekaServerName,
        MiddlewareEurekaServerInner eurekaServerResource);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    MiddlewareEurekaServerInner updatePatch(
        String resourceGroupName,
        String javaEnvironmentName,
        String eurekaServerName,
        MiddlewareEurekaServerInner eurekaServerResource);
