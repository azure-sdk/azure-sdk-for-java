 ...
 */
@Fluent
public final class TestKeysInner implements JsonSerializable<TestKeysInner> {
    /*
     * Primary key
     */
    ...
    /**
     * Creates an instance of TestKeysInner class.
     */
    public TestKeysInner() {
    }
    ...
    /**
     * Reads an instance of TestKeysInner from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of TestKeysInner if the JsonReader was pointing to an instance of it, or null if it was
     * pointing to JSON null.
     * @throws IOException If an error occurs while reading the TestKeysInner.
     */
    public static TestKeysInner fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            TestKeysInner deserializedTestKeysInner = new TestKeysInner();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("primaryKey".equals(fieldName)) {
                    deserializedTestKeysInner.primaryKey = reader.getString();
                } else if ("secondaryKey".equals(fieldName)) {
                    deserializedTestKeysInner.secondaryKey = reader.getString();
                } else if ("primaryTestEndpoint".equals(fieldName)) {
                    deserializedTestKeysInner.primaryTestEndpoint = reader.getString();
                } else if ("secondaryTestEndpoint".equals(fieldName)) {
                    deserializedTestKeysInner.secondaryTestEndpoint = reader.getString();
                } else if ("enabled".equals(fieldName)) {
                    deserializedTestKeysInner.enabled = reader.getNullable(JsonReader::getBoolean);
                } else {
                    reader.skipChildren();
                }
            }

            return deserializedTestKeysInner;
        });
    }
}
