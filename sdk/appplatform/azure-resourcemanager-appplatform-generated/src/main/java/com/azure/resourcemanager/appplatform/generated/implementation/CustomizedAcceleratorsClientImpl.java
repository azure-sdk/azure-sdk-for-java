...
import com.azure.resourcemanager.appplatform.generated.models.CustomizedAcceleratorResourceCollection;
...
public final class CustomizedAcceleratorsClientImpl implements CustomizedAcceleratorsClient {
    ...
    CustomizedAcceleratorsClientImpl(AppPlatformManagementClientImpl client) {
        this.service =
            RestProxy
                .create(CustomizedAcceleratorsService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }
    ...
    public interface CustomizedAcceleratorsService {
        ...
        @Get(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AppPlatform/Spring"
                + "/{serviceName}/applicationAccelerators/{applicationAcceleratorName}/customizedAccelerators")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<CustomizedAcceleratorResourceCollection>> list(
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<CustomizedAcceleratorResourceInner>> get(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
        ...
        @Post(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AppPlatform/Spring"
                + "/{serviceName}/applicationAccelerators/{applicationAcceleratorName}/customizedAccelerators"
                + "/{customizedAcceleratorName}/validate")
        @ExpectedResponses({200, 202})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<CustomizedAcceleratorValidateResultInner>> validate(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
    ...
    private Mono<PagedResponse<CustomizedAcceleratorResourceInner>> listSinglePageAsync(
                ...
                context ->
                    service
                        .list(
                            ...
                            accept,
                            context))
            .<PagedResponse<CustomizedAcceleratorResourceInner>>map(
                res ->
    ...
    private PagedFlux<CustomizedAcceleratorResourceInner> listAsync(
        String resourceGroupName, String serviceName, String applicationAcceleratorName) {
        return new PagedFlux<>(
            () -> listSinglePageAsync(resourceGroupName, serviceName, applicationAcceleratorName),
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<CustomizedAcceleratorResourceInner> list(
        String resourceGroupName, String serviceName, String applicationAcceleratorName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<CustomizedAcceleratorResourceInner>> getWithResponseAsync(
        ...
        if (customizedAcceleratorName == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
                        "Parameter customizedAcceleratorName is required and cannot be null."));
        }
        final String accept = "application/json";
        return FluxUtil
            .withContext(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<CustomizedAcceleratorResourceInner> getAsync(
        String resourceGroupName,
        String serviceName,
        String applicationAcceleratorName,
        String customizedAcceleratorName) {
        return getWithResponseAsync(
                resourceGroupName, serviceName, applicationAcceleratorName, customizedAcceleratorName)
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<CustomizedAcceleratorResourceInner> getWithResponse(
        String resourceGroupName,
        String serviceName,
        String applicationAcceleratorName,
        String customizedAcceleratorName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public CustomizedAcceleratorResourceInner get(
        String resourceGroupName,
        String serviceName,
        String applicationAcceleratorName,
        String customizedAcceleratorName) {
    ...
    private PollerFlux<PollResult<CustomizedAcceleratorResourceInner>, CustomizedAcceleratorResourceInner>
        ...
        return this
            .client
            .<CustomizedAcceleratorResourceInner, CustomizedAcceleratorResourceInner>getLroResult(
                mono,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<CustomizedAcceleratorResourceInner> createOrUpdateAsync(
        String resourceGroupName,
        String serviceName,
        String applicationAcceleratorName,
        String customizedAcceleratorName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public CustomizedAcceleratorResourceInner createOrUpdate(
        String resourceGroupName,
        String serviceName,
        String applicationAcceleratorName,
        String customizedAcceleratorName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<CustomizedAcceleratorValidateResultInner>> validateWithResponseAsync(
        String resourceGroupName,
        String serviceName,
        String applicationAcceleratorName,
        String customizedAcceleratorName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<CustomizedAcceleratorValidateResultInner> validateAsync(
        String resourceGroupName,
        String serviceName,
        String applicationAcceleratorName,
        String customizedAcceleratorName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<CustomizedAcceleratorValidateResultInner> validateWithResponse(
        String resourceGroupName,
        String serviceName,
        String applicationAcceleratorName,
        String customizedAcceleratorName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public CustomizedAcceleratorValidateResultInner validate(
        String resourceGroupName,
        String serviceName,
        String applicationAcceleratorName,
        String customizedAcceleratorName,
        CustomizedAcceleratorProperties properties) {
        return validateWithResponse(
                resourceGroupName,
                serviceName,
                applicationAcceleratorName,
                customizedAcceleratorName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<CustomizedAcceleratorResourceInner>> listNextSinglePageAsync(
