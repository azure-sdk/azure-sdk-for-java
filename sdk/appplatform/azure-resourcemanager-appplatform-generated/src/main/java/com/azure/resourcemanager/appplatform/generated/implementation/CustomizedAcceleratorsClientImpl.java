...
public final class CustomizedAcceleratorsClientImpl implements CustomizedAcceleratorsClient {
    ...
    public interface CustomizedAcceleratorsService {
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<CustomizedAcceleratorValidateResultInner>> validate(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("serviceName") String serviceName,
            @PathParam("applicationAcceleratorName") String applicationAcceleratorName,
            @PathParam("customizedAcceleratorName") String customizedAcceleratorName,
    ...
    private Mono<Response<CustomizedAcceleratorResourceInner>> getWithResponseAsync(String resourceGroupName,
        ...
        return service.get(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(), resourceGroupName,
            serviceName, applicationAcceleratorName, customizedAcceleratorName, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<CustomizedAcceleratorResourceInner> getAsync(String resourceGroupName, String serviceName,
    ...
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String resourceGroupName,
        ...
        return service.createOrUpdate(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(),
            ...
            customizedAcceleratorResource, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<CustomizedAcceleratorValidateResultInner>> validateWithResponseAsync(String resourceGroupName,
        String serviceName, String applicationAcceleratorName, String customizedAcceleratorName,
    ...
    private Mono<CustomizedAcceleratorValidateResultInner> validateAsync(String resourceGroupName, String serviceName,
        String applicationAcceleratorName, String customizedAcceleratorName,
        CustomizedAcceleratorProperties properties) {
        return validateWithResponseAsync(resourceGroupName, serviceName, applicationAcceleratorName,
            customizedAcceleratorName, properties).flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<CustomizedAcceleratorValidateResultInner> validateWithResponse(String resourceGroupName,
        String serviceName, String applicationAcceleratorName, String customizedAcceleratorName,
        CustomizedAcceleratorProperties properties, Context context) {
        return validateWithResponseAsync(resourceGroupName, serviceName, applicationAcceleratorName,
            customizedAcceleratorName, properties, context).block();
    }
    ...
    public CustomizedAcceleratorValidateResultInner validate(String resourceGroupName, String serviceName,
        String applicationAcceleratorName, String customizedAcceleratorName,
        CustomizedAcceleratorProperties properties) {
        return validateWithResponse(resourceGroupName, serviceName, applicationAcceleratorName,
            customizedAcceleratorName, properties, Context.NONE).getValue();
    }
