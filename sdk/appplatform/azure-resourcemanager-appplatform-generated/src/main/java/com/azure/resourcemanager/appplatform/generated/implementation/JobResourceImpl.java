...
public final class JobResourceImpl implements JobResource, JobResource.Definition, JobResource.Update {
    ...
    public JobResource create() {
        this.innerObject = serviceManager.serviceClient()
            .getJobOperations()
            .createOrUpdate(resourceGroupName, serviceName, jobName, this.innerModel(), Context.NONE);
        return this;
    }
    ...
    public JobResource create(Context context) {
        this.innerObject = serviceManager.serviceClient()
            .getJobOperations()
            .createOrUpdate(resourceGroupName, serviceName, jobName, this.innerModel(), context);
        return this;
    }
    ...
    public JobResource refresh() {
        this.innerObject = serviceManager.serviceClient()
            .getJobOperations()
            .getWithResponse(resourceGroupName, serviceName, jobName, Context.NONE)
            .getValue();
        return this;
    }
    ...
    public JobResource refresh(Context context) {
        this.innerObject = serviceManager.serviceClient()
            .getJobOperations()
            .getWithResponse(resourceGroupName, serviceName, jobName, context)
            .getValue();
        return this;
    }
    ...
    public JobExecution start(JobExecutionTemplate template, Context context) {
        return serviceManager.jobOperations().start(resourceGroupName, serviceName, jobName, template, context);
    }

    public Response<EnvSecretsCollection> listEnvSecretsWithResponse(Context context) {
        return serviceManager.jobOperations()
            .listEnvSecretsWithResponse(resourceGroupName, serviceName, jobName, context);
    }
