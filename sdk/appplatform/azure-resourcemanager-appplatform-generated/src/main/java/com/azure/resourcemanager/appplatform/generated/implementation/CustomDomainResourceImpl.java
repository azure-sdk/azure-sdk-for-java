...
public final class CustomDomainResourceImpl
    ...
    public CustomDomainResource create() {
        this.innerObject = serviceManager.serviceClient().getCustomDomains().createOrUpdate(resourceGroupName,
            serviceName, appName, domainName, this.innerModel(), Context.NONE);
        return this;
    }

    public CustomDomainResource create(Context context) {
        this.innerObject = serviceManager.serviceClient().getCustomDomains().createOrUpdate(resourceGroupName,
            serviceName, appName, domainName, this.innerModel(), context);
        return this;
    }

    CustomDomainResourceImpl(String name,
    ...
    public CustomDomainResource apply() {
        this.innerObject = serviceManager.serviceClient().getCustomDomains().update(resourceGroupName, serviceName,
            appName, domainName, this.innerModel(), Context.NONE);
        return this;
    }

    public CustomDomainResource apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getCustomDomains().update(resourceGroupName, serviceName,
            appName, domainName, this.innerModel(), context);
        return this;
    }

    CustomDomainResourceImpl(CustomDomainResourceInner innerObject,
        com.azure.resourcemanager.appplatform.generated.AppPlatformManager serviceManager) {
    ...
    public CustomDomainResource refresh() {
        this.innerObject = serviceManager.serviceClient().getCustomDomains()
            .getWithResponse(resourceGroupName, serviceName, appName, domainName, Context.NONE).getValue();
        return this;
    }

    public CustomDomainResource refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getCustomDomains()
            .getWithResponse(resourceGroupName, serviceName, appName, domainName, context).getValue();
        return this;
    }
