...
public final class ConfigurationServicesImpl implements ConfigurationServices {
    ...
    public ConfigurationServicesImpl(ConfigurationServicesClient innerClient,
        com.azure.resourcemanager.appplatform.generated.AppPlatformManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public Response<ConfigurationServiceResource> getWithResponse(String resourceGroupName, String serviceName,
    ...
    public ConfigurationServiceResource get(String resourceGroupName, String serviceName,
    ...
    public PagedIterable<ConfigurationServiceResource> list(String resourceGroupName, String serviceName) {
        ...
        return ResourceManagerUtils.mapPage(inner,
            inner1 -> new ConfigurationServiceResourceImpl(inner1, this.manager()));
    }
    ...
    public ConfigurationServiceSettingsValidateResult validate(String resourceGroupName, String serviceName,
    ...
    public ConfigurationServiceSettingsValidateResult validate(String resourceGroupName, String serviceName,
        ...
        ConfigurationServiceSettingsValidateResultInner inner = this.serviceClient().validate(resourceGroupName,
            serviceName, configurationServiceName, settings, context);
        if (inner != null) {
            return new ConfigurationServiceSettingsValidateResultImpl(inner, this.manager());
        } else {
            return null;
    ...
    public ConfigurationServiceSettingsValidateResult validateResource(String resourceGroupName, String serviceName,
        String configurationServiceName, ConfigurationServiceResourceInner configurationServiceResource) {
        ConfigurationServiceSettingsValidateResultInner inner = this.serviceClient().validateResource(resourceGroupName,
            serviceName, configurationServiceName, configurationServiceResource);
        if (inner != null) {
            return new ConfigurationServiceSettingsValidateResultImpl(inner, this.manager());
        } else {
            return null;
    ...
    public ConfigurationServiceSettingsValidateResult validateResource(String resourceGroupName, String serviceName,
        ...
        Context context) {
        ConfigurationServiceSettingsValidateResultInner inner = this.serviceClient().validateResource(resourceGroupName,
            serviceName, configurationServiceName, configurationServiceResource, context);
        if (inner != null) {
            return new ConfigurationServiceSettingsValidateResultImpl(inner, this.manager());
        } else {
            return null;
    ...
    public ConfigurationServiceResource getById(String id) {
        ...
        String configurationServiceName = ResourceManagerUtils.getValueFromIdByName(id, "configurationServices");
        if (configurationServiceName == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
                String.format("The resource ID '%s' is not valid. Missing path segment 'configurationServices'.", id)));
        }
