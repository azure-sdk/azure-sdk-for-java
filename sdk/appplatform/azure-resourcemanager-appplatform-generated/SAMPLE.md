...
public final class ConfigServersUpdatePutSamples {
     ...
     * @param manager Entry point to AppPlatformManager.
     */
    public static void configServersUpdatePutConsumption(
        com.azure.resourcemanager.appplatform.generated.AppPlatformManager manager) {
        manager
            .configServers()
            .updatePut(
    ...
    public static void customDomainsUpdate(com.azure.resourcemanager.appplatform.generated.AppPlatformManager manager) {
        CustomDomainResource resource =
            manager
                .customDomains()
                .getWithResponse(
                    "myResourceGroup", "myservice", "myapp", "mydomain.com", com.azure.core.util.Context.NONE)
                .getValue();
        resource
            .update()
            .withProperties(
...
public final class CustomizedAcceleratorsListSamples {
     ...
     * @param manager Entry point to AppPlatformManager.
     */
    public static void customizedAcceleratorsList(
        com.azure.resourcemanager.appplatform.generated.AppPlatformManager manager) {
        manager
            .customizedAccelerators()
            .list("myResourceGroup", "myservice", "default", com.azure.core.util.Context.NONE);
...
public final class GatewaysListEnvSecretsSamples {
     ...
     * @param manager Entry point to AppPlatformManager.
     */
    public static void gatewaysListEnvSecrets(
        com.azure.resourcemanager.appplatform.generated.AppPlatformManager manager) {
        manager
            .gateways()
        ...
        manager
            ...
            .createOrUpdate(
                ...
                new JavaAppInner()
                    ...
                    .withEnvironmentId(
                        "/subscriptions/34adfa4f-cedf-4dc0-ba29-b6d1a69ab345/resourceGroups/rg/providers/Microsoft.AppPlatform/javaEnvironments/demokube")
                            ...
                            .withIngress(
                                new Ingress()
                                    ...
                                    .withCorsPolicy(
                                        new CorsPolicy()
                                            .withAllowedOrigins(
                                                Arrays.asList("https://a.test.com", "https://b.test.com"))
                                        ...
                                        Arrays
                                            .asList(
                                                new InitContainer()
                                                    ...
                                                    .withCommand(Arrays.asList("/bin/sh"))
                                                    .withArgs(
                                                        Arrays.asList("-c", "while true; do echo hello; sleep 10;done"))
                                                    .withResources(
...
public final class JavaAppsListSamples {
     ...
     * @param manager Entry point to AppPlatformManager.
     */
    public static void listJavaAppsBySubscription(
        com.azure.resourcemanager.appplatform.generated.AppPlatformManager manager) {
...
public final class JavaAppsListByResourceGroupSamples {
     ...
     * @param manager Entry point to AppPlatformManager.
     */
    public static void listJavaAppsByResourceGroup(
        com.azure.resourcemanager.appplatform.generated.AppPlatformManager manager) {
...
public final class JavaEnvironmentsCreateOrUpdateSamples {
    ...
    public static void createEnvironments(com.azure.resourcemanager.appplatform.generated.AppPlatformManager manager) {
        manager
            ...
            .withInfraResourceGroup("capp-svc-jlaw-demo1-eastus")
            .withZoneRedundant(ZoneRedundantEnum.ZONE_REDUNDANT)
            .create();
    }
...
public final class JavaEnvironmentsGetByResourceGroupSamples {
     ...
     * @param manager Entry point to AppPlatformManager.
     */
    public static void getEnvironmentsByName(
        com.azure.resourcemanager.appplatform.generated.AppPlatformManager manager) {
        manager
            .javaEnvironments()
...
public final class JavaEnvironmentsGetResourceUploadUrlSamples {
    ...
    public static void buildServiceGetResourceUploadUrl(
        ...
        manager
            .javaEnvironments()
            .getResourceUploadUrlWithResponse("myResourceGroup", "testenv", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class MiddlewareConfigServersCreateOrUpdateSamples {
     ...
     * @param manager Entry point to AppPlatformManager.
     */
    public static void createOrUpdateConfigServers(
        com.azure.resourcemanager.appplatform.generated.AppPlatformManager manager) {
        manager
            .middlewareConfigServers()
            .define("default")
            .withExistingJavaEnvironment("myResourceGroup", "myEnv")
            .withEnabledState(ConfigServerEnabledState.ENABLED)
            .withConfigServer(
                new MiddlewareConfigServerSettings()
                    .withGitProperty(
                        new MiddlewareConfigServerGitProperty()
                            .withUri("https://github.com/fake-user/fake-repository.git")
                            .withLabel("master")
                            .withSearchPaths(Arrays.asList("/"))))
            .create();
...
public final class MiddlewareConfigServersGetSamples {
    ...
    public static void getConfigServers(com.azure.resourcemanager.appplatform.generated.AppPlatformManager manager) {
        manager
            .middlewareConfigServers()
            .getWithResponse("myResourceGroup", "myenv", "default", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class MiddlewareConfigServersUpdatePatchSamples {
    ...
    public static void updateConfigServers(com.azure.resourcemanager.appplatform.generated.AppPlatformManager manager) {
        MiddlewareConfigServer resource =
            manager
                .middlewareConfigServers()
                .getWithResponse("myResourceGroup", "myenv", "default", com.azure.core.util.Context.NONE)
                .getValue();
...
public final class MiddlewareConfigServersValidateSamples {
     ...
     * @param manager Entry point to AppPlatformManager.
     */
    public static void validateConfigServers(
        com.azure.resourcemanager.appplatform.generated.AppPlatformManager manager) {
        manager
            .middlewareConfigServers()
            .validate(
...
public final class MiddlewareEurekaServersCreateOrUpdateSamples {
     ...
     * @param manager Entry point to AppPlatformManager.
     */
    public static void createOrUpdateEurekaServers(
        com.azure.resourcemanager.appplatform.generated.AppPlatformManager manager) {
        manager
            .middlewareEurekaServers()
            .define("default")
            .withExistingJavaEnvironment("myResourceGroup", "myenv")
            .withEnabledState(EurekaServerEnabledState.ENABLED)
            .create();
    }
}
```
...
public final class MiddlewareEurekaServersUpdatePatchSamples {
    ...
    public static void updateEurekaServers(com.azure.resourcemanager.appplatform.generated.AppPlatformManager manager) {
        MiddlewareEurekaServer resource =
            manager
                .middlewareEurekaServers()
                .getWithResponse("myResourceGroup", "myenv", "default", com.azure.core.util.Context.NONE)
                .getValue();
        ...
        manager
            ...
            .checkNameAvailabilityWithResponse(
                ...
                new CheckNameAvailabilityRequest()
                    .withName("testspringname")
                    .withType("Microsoft.AppPlatform/javaEnvironments"),
                com.azure.core.util.Context.NONE);
    }
}
```
...
public final class RevisionReplicasGetSamples {
     ...
     * @param manager Entry point to AppPlatformManager.
     */
    public static void getTheRevisionReplicaOfAJavaApp(
        com.azure.resourcemanager.appplatform.generated.AppPlatformManager manager) {
        manager
            .revisionReplicas()
            .getWithResponse(
...
public final class RevisionReplicasListSamples {
     ...
     * @param manager Entry point to AppPlatformManager.
     */
    public static void listReplicasOfAJavaApp(
        com.azure.resourcemanager.appplatform.generated.AppPlatformManager manager) {
        manager
            .revisionReplicas()
            .list("workerapps-rg-xj", "myapp", "myapp--0wlqy09", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class RevisionsActivateSamples {
     ...
     * @param manager Entry point to AppPlatformManager.
     */
    public static void activateTheRevisionOfAnApp(
        com.azure.resourcemanager.appplatform.generated.AppPlatformManager manager) {
...
public final class RevisionsDeactivateSamples {
     ...
     * @param manager Entry point to AppPlatformManager.
     */
    public static void deactivateTheRevisionOfAJavaApp(
        com.azure.resourcemanager.appplatform.generated.AppPlatformManager manager) {
...
public final class RevisionsGetSamples {
     ...
     * @param manager Entry point to AppPlatformManager.
     */
    public static void getTheRevisionOfAnApp(
        com.azure.resourcemanager.appplatform.generated.AppPlatformManager manager) {
...
public final class RevisionsListSamples {
     ...
     * @param manager Entry point to AppPlatformManager.
     */
    public static void listRevisionsOfAnApp(
        com.azure.resourcemanager.appplatform.generated.AppPlatformManager manager) {
...
public final class RevisionsRestartSamples {
     ...
     * @param manager Entry point to AppPlatformManager.
     */
    public static void restartTheRevisionOfAJavaApp(
        com.azure.resourcemanager.appplatform.generated.AppPlatformManager manager) {
...
public final class ServicesCreateOrUpdateSamples {
     ...
     * @param manager Entry point to AppPlatformManager.
     */
    public static void servicesCreateOrUpdateConsumption(
        com.azure.resourcemanager.appplatform.generated.AppPlatformManager manager) {
        manager
            .services()
            .define("myservice")
...
public final class ServicesFlushVnetDnsSettingSamples {
     ...
     * @param manager Entry point to AppPlatformManager.
     */
    public static void servicesFlushVnetDnsSetting(
        com.azure.resourcemanager.appplatform.generated.AppPlatformManager manager) {
...
public final class ServicesGetByResourceGroupSamples {
     ...
     * @param manager Entry point to AppPlatformManager.
     */
    public static void servicesGetConsumption(
        com.azure.resourcemanager.appplatform.generated.AppPlatformManager manager) {
        manager
            .services()
            .getByResourceGroupWithResponse("myResourceGroup", "myservice", com.azure.core.util.Context.NONE);
...
public final class ServicesListGloballyEnabledApmsSamples {
     ...
     * @param manager Entry point to AppPlatformManager.
     */
    public static void servicesListGloballyEnabledApms(
        com.azure.resourcemanager.appplatform.generated.AppPlatformManager manager) {
        manager
            .services()
