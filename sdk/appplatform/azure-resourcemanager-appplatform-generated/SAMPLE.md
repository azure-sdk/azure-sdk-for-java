...
import com.azure.resourcemanager.appplatform.generated.models.PrivateLinkState;
        ...
        manager.services().define("myservice").withRegion("eastus").withExistingResourceGroup("myResourceGroup")
            ...
            .withProperties(new ClusterResourceProperties().withNetworkProfile(new NetworkProfile()
                ...
                .withVnetAddons(new ServiceVNetAddons().withLogStreamPublicEndpoint(true)
                    .withDataPlanePublicEndpoint(true).withPrivateLinkState(PrivateLinkState.ENABLED)
