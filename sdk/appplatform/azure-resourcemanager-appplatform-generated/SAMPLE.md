...
public final class ServicesCreateOrUpdateSamples {
    ...
    public static void servicesCreateOrUpdate(com.azure.resourcemanager.appplatform.generated.AppPlatformManager manager) {
        manager.services().define("myservice").withRegion("eastus").withExistingResourceGroup("myResourceGroup").withTags(mapOf("key1", "fakeTokenPlaceholder")).withSku(new Sku().withName("S0").withTier("Standard")).create();
    }
