...
public final class DppIdentityDetails {
    ...
    /**
     * Get the type property: The identityType which can be either SystemAssigned, UserAssigned or None.
     *
    ...
    /**
     * Set the type property: The identityType which can be either SystemAssigned, UserAssigned or None.
     *
