...
public final class ManagedIdentityType extends ExpandableStringEnum<ManagedIdentityType> {
    /** Static value Unknown for ManagedIdentityType. */
    public static final ManagedIdentityType UNKNOWN = fromString("Unknown");
    ...
    /** Static value SystemAssignedAndUserAssigned for ManagedIdentityType. */
    public static final ManagedIdentityType SYSTEM_ASSIGNED_AND_USER_ASSIGNED =
        fromString("SystemAssignedAndUserAssigned");
