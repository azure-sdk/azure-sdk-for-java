...
public final class ResourceProvidersImpl implements ResourceProviders {
    ...
    public PagedIterable<ResourceGuardProxyBaseResource> dppResourceGuardProxyList(
        ...
        PagedIterable<ResourceGuardProxyBaseResourceInner> inner =
            this.serviceClient().dppResourceGuardProxyList(resourceGroupName, vaultName);
    ...
    public PagedIterable<ResourceGuardProxyBaseResource> dppResourceGuardProxyList(
        ...
        PagedIterable<ResourceGuardProxyBaseResourceInner> inner =
            this.serviceClient().dppResourceGuardProxyList(resourceGroupName, vaultName, context);
        return Utils.mapPage(inner, inner1 -> new ResourceGuardProxyBaseResourceImpl(inner1, this.manager()));
    }
    ...
    public ResourceGuardProxyBaseResource dppResourceGuardProxyGet(
        ...
        ResourceGuardProxyBaseResourceInner inner =
            this.serviceClient().dppResourceGuardProxyGet(resourceGroupName, vaultName, resourceGuardProxyName);
        if (inner != null) {
    ...
    public Response<ResourceGuardProxyBaseResource> dppResourceGuardProxyGetWithResponse(
        ...
        Response<ResourceGuardProxyBaseResourceInner> inner =
            this
                .serviceClient()
                .dppResourceGuardProxyGetWithResponse(resourceGroupName, vaultName, resourceGuardProxyName, context);
        if (inner != null) {
    ...
    public void dppResourceGuardProxyDelete(String resourceGroupName, String vaultName, String resourceGuardProxyName) {
        this.serviceClient().dppResourceGuardProxyDelete(resourceGroupName, vaultName, resourceGuardProxyName);
    }
    ...
    public Response<Void> dppResourceGuardProxyDeleteWithResponse(
        ...
        return this
            .serviceClient()
            .dppResourceGuardProxyDeleteWithResponse(resourceGroupName, vaultName, resourceGuardProxyName, context);
    }
    ...
    public UnlockDeleteResponse dppResourceGuardProxyUnlockDelete(
        ...
        UnlockDeleteResponseInner inner =
            this
                .serviceClient()
                .dppResourceGuardProxyUnlockDelete(resourceGroupName, vaultName, resourceGuardProxyName, parameters);
        if (inner != null) {
    ...
    public ResourceGuardProxyBaseResource dppResourceGuardProxyGetById(String id) {
        ...
        return this
            .dppResourceGuardProxyGetWithResponse(resourceGroupName, vaultName, resourceGuardProxyName, Context.NONE)
            .getValue();
    }
    ...
    public Response<ResourceGuardProxyBaseResource> dppResourceGuardProxyGetByIdWithResponse(
        ...
        return this.dppResourceGuardProxyGetWithResponse(resourceGroupName, vaultName, resourceGuardProxyName, context);
    }
    ...
    public void dppResourceGuardProxyDeleteById(String id) {
        ...
        this
            .dppResourceGuardProxyDeleteWithResponse(
                resourceGroupName, vaultName, resourceGuardProxyName, Context.NONE);
    }
