...
public final class CrossRegionRestoreJobsOperationsClientImpl implements CrossRegionRestoreJobsOperationsClient {
    ...
    private Mono<PagedResponse<AzureBackupJobResourceInner>> listSinglePageAsync(
        String resourceGroupName, String location, CrossRegionRestoreJobsRequest parameters, String filter) {
    ...
    private PagedFlux<AzureBackupJobResourceInner> listAsync(
        ...
        return new PagedFlux<>(
            () -> listSinglePageAsync(resourceGroupName, location, parameters, filter),
    ...
    private PagedFlux<AzureBackupJobResourceInner> listAsync(
        ...
        Context context) {
        return new PagedFlux<>(
            () -> listSinglePageAsync(resourceGroupName, location, parameters, filter, context),
