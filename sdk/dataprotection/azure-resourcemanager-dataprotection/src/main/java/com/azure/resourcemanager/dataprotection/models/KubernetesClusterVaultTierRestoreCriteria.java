...
public final class KubernetesClusterVaultTierRestoreCriteria extends ItemLevelRestoreCriteria {
     ...
     * 
     * Gets or sets the resource modifier template. This property sets the template for resource modifier during
     * restore.
     */
    @JsonProperty(value = "resourceModifierTemplate")
    private NamespacedNameResource resourceModifierTemplate;
    ...
    /**
     * Get the resourceModifierTemplate property: NamespacedNameResource
     * 
     * Gets or sets the resource modifier template. This property sets the template for resource modifier during
     * restore.
     * 
     * @return the resourceModifierTemplate value.
     */
    public NamespacedNameResource resourceModifierTemplate() {
        return this.resourceModifierTemplate;
    }

    /**
     * Set the resourceModifierTemplate property: NamespacedNameResource
     * 
     * Gets or sets the resource modifier template. This property sets the template for resource modifier during
     * restore.
     * 
     * @param resourceModifierTemplate the resourceModifierTemplate value to set.
     * @return the KubernetesClusterVaultTierRestoreCriteria object itself.
     */
    public KubernetesClusterVaultTierRestoreCriteria
        withResourceModifierTemplate(NamespacedNameResource resourceModifierTemplate) {
        this.resourceModifierTemplate = resourceModifierTemplate;
        return this;
    }
    ...
    public void validate() {
        ...
        if (resourceModifierTemplate() != null) {
            resourceModifierTemplate().validate();
        }
    }
}
