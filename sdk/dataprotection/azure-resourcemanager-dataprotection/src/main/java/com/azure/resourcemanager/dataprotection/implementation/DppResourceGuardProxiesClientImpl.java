...
public final class DppResourceGuardProxiesClientImpl implements DppResourceGuardProxiesClient {
    ...
    private interface DppResourceGuardProxiesService {
    ...
    private Mono<ResourceGuardProxyBaseResourceInner> putAsync(
        ...
        String resourceGuardProxyName,
        ResourceGuardProxyBaseResourceInner parameters) {
        return putWithResponseAsync(resourceGroupName, vaultName, resourceGuardProxyName, parameters)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
    ...
    public Response<ResourceGuardProxyBaseResourceInner> putWithResponse(
        ...
        ResourceGuardProxyBaseResourceInner parameters,
        Context context) {
        return putWithResponseAsync(resourceGroupName, vaultName, resourceGuardProxyName, parameters, context).block();
    }
    ...
    public ResourceGuardProxyBaseResourceInner put(
        ...
        String resourceGuardProxyName,
        ResourceGuardProxyBaseResourceInner parameters) {
        return putWithResponse(resourceGroupName, vaultName, resourceGuardProxyName, parameters, Context.NONE)
            .getValue();
    }
