...
public interface BackupInstanceResource {
     ...
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     */
    void validateForModifyBackup(ValidateForModifyBackupRequest parameters);
     ...
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     */
    void validateForModifyBackup(ValidateForModifyBackupRequest parameters, Context context);
