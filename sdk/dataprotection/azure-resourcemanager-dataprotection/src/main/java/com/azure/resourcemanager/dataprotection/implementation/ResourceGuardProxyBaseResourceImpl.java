...
public final class ResourceGuardProxyBaseResourceImpl
    ...
    public ResourceGuardProxyBaseResourceImpl withExistingBackupVault(String vaultName, String resourceGroupName) {
    ...
    public ResourceGuardProxyBaseResource create() {
        this.innerObject =
            serviceManager
                ...
                .dppResourceGuardProxyPutWithResponse(
                    vaultName, resourceGroupName, resourceGuardProxyName, this.innerModel(), Context.NONE)
                .getValue();
        return this;
    }
    ...
    public ResourceGuardProxyBaseResource create(Context context) {
        this.innerObject =
            serviceManager
                ...
                .getResourceProviders()
                .dppResourceGuardProxyPutWithResponse(
                    vaultName, resourceGroupName, resourceGuardProxyName, this.innerModel(), context)
                .getValue();
        return this;
    }
    ...
    public ResourceGuardProxyBaseResource refresh() {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getResourceProviders()
                .dppResourceGuardProxyGetWithResponse(
    ...
    public UnlockDeleteResponse dppResourceGuardProxyUnlockDelete(UnlockDeleteRequest parameters) {
    ...
    public Response<UnlockDeleteResponse> dppResourceGuardProxyUnlockDeleteWithResponse(
        UnlockDeleteRequest parameters, Context context) {
        return serviceManager
            .resourceProviders()
