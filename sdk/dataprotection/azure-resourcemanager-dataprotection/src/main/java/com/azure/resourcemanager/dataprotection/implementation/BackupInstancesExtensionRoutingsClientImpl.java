...
public final class BackupInstancesExtensionRoutingsClientImpl implements BackupInstancesExtensionRoutingsClient {
    ...
    BackupInstancesExtensionRoutingsClientImpl(DataProtectionClientImpl client) {
        this.service =
            RestProxy
                .create(
                    BackupInstancesExtensionRoutingsService.class,
    ...
    private interface BackupInstancesExtensionRoutingsService {
     ...
     * @return a list backup instances associated with a tracked resource along with {@link PagedResponse} on successful
    ...
    private Mono<PagedResponse<BackupInstanceResourceInner>> listSinglePageAsync(String resourceId) {
        ...
        return FluxUtil
            .withContext(
                context ->
                    service.list(this.client.getEndpoint(), this.client.getApiVersion(), resourceId, accept, context))
    ...
    private Mono<PagedResponse<BackupInstanceResourceInner>> listSinglePageAsync(String resourceId, Context context) {
        ...
        return service
            .list(this.client.getEndpoint(), this.client.getApiVersion(), resourceId, accept, context)
            .map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(),
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a list backup instances associated with a tracked resource as paginated response with {@link PagedFlux}.
     */
