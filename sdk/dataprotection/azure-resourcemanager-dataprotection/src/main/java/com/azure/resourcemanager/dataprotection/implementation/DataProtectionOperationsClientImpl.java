...
public final class DataProtectionOperationsClientImpl implements DataProtectionOperationsClient {
    ...
    /**
     * Initializes an instance of DataProtectionOperationsClientImpl.
     *
     * @param client the instance of the service client containing this operation class.
     */
    DataProtectionOperationsClientImpl(DataProtectionClientImpl client) {
        this.service =
            RestProxy
                .create(DataProtectionOperationsService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for DataProtectionClientDataProtectionOperations to be used by the proxy
     * service to perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "DataProtectionClient")
    private interface DataProtectionOperationsService {
