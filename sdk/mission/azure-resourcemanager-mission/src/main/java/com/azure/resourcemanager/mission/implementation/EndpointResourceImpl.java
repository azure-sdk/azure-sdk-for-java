...
public final class EndpointResourceImpl
    ...
    public EndpointResource apply() {
        this.innerObject = serviceManager.serviceClient()
            .getEndpoints()
            .update(resourceGroupName, virtualEnclaveName, endpointName, this.innerModel(), Context.NONE);
        return this;
    }
    ...
    public EndpointResource apply(Context context) {
        this.innerObject = serviceManager.serviceClient()
            .getEndpoints()
            .update(resourceGroupName, virtualEnclaveName, endpointName, this.innerModel(), context);
        return this;
    }
