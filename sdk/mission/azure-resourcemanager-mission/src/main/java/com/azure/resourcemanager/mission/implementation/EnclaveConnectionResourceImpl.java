...
public final class EnclaveConnectionResourceImpl
    ...
    private EnclaveConnectionResourceUpdate updateProperties;
    ...
    public EnclaveConnectionResourceImpl update() {
        this.updateProperties = new EnclaveConnectionResourceUpdate();
        return this;
    }
    ...
    public EnclaveConnectionResourceImpl withSourceResourceId(String sourceResourceId) {
        if (isInCreateMode()) {
            ...
            this.updateProperties.withSourceResourceId(sourceResourceId);
            return this;
        }
    }
    ...
    public EnclaveConnectionResourceImpl withSourceCidr(String sourceCidr) {
        if (isInCreateMode()) {
            ...
            this.updateProperties.withSourceCidr(sourceCidr);
            return this;
        }
    }
    ...
    public EnclaveConnectionResourceImpl withIpGroup(String ipGroup) {
        if (isInCreateMode()) {
            ...
            this.updateProperties.withIpGroup(ipGroup);
            return this;
        }
    }
