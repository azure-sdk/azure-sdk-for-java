...
public interface TransitHubsClient {
    ...
    SyncPoller<PollResult<TransitHubResourceInner>, TransitHubResourceInner> beginUpdate(String resourceGroupName,
        String communityName, String transitHubName, TransitHubResourceInner properties);
    ...
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<TransitHubResourceInner>, TransitHubResourceInner> beginUpdate(String resourceGroupName,
        String communityName, String transitHubName, TransitHubResourceInner properties, Context context);
