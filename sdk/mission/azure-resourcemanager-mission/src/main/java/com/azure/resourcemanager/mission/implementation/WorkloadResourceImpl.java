...
public final class WorkloadResourceImpl
    ...
    private WorkloadResourceUpdate updateProperties;
    ...
    public WorkloadResourceImpl update() {
        this.updateProperties = new WorkloadResourceUpdate();
        return this;
    }
    ...
    public WorkloadResourceImpl withResourceGroupCollection(List<String> resourceGroupCollection) {
        if (isInCreateMode()) {
            ...
            this.updateProperties.withResourceGroupCollection(resourceGroupCollection);
            return this;
        }
    }
