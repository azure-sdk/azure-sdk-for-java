...
public final class WorkloadResourceImpl
    ...
    public WorkloadResource apply() {
        this.innerObject = serviceManager.serviceClient()
            .getWorkloads()
            .update(resourceGroupName, virtualEnclaveName, workloadName, this.innerModel(), Context.NONE);
        return this;
    }
    ...
    public WorkloadResource apply(Context context) {
        this.innerObject = serviceManager.serviceClient()
            .getWorkloads()
            .update(resourceGroupName, virtualEnclaveName, workloadName, this.innerModel(), context);
        return this;
    }
