...
public final class VirtualEnclavesClientImpl implements VirtualEnclavesClient {
    ...
    public interface VirtualEnclavesService {
        ...
        Mono<Response<Flux<ByteBuffer>>> update(@HostParam("$host") String endpoint,
            ...
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("virtualEnclaveName") String virtualEnclaveName,
            @BodyParam("application/json") EnclaveResourceUpdate properties, @HeaderParam("Accept") String accept,
            Context context);
    ...
    private Mono<Response<Flux<ByteBuffer>>> updateWithResponseAsync(String resourceGroupName,
        String virtualEnclaveName, EnclaveResourceUpdate properties) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> updateWithResponseAsync(String resourceGroupName,
        String virtualEnclaveName, EnclaveResourceUpdate properties, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<EnclaveResourceInner>, EnclaveResourceInner>
        beginUpdateAsync(String resourceGroupName, String virtualEnclaveName, EnclaveResourceUpdate properties) {
        Mono<Response<Flux<ByteBuffer>>> mono
    ...
    private PollerFlux<PollResult<EnclaveResourceInner>, EnclaveResourceInner> beginUpdateAsync(
        String resourceGroupName, String virtualEnclaveName, EnclaveResourceUpdate properties, Context context) {
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono
    ...
    private Mono<EnclaveResourceInner> updateAsync(String resourceGroupName, String virtualEnclaveName,
        EnclaveResourceUpdate properties) {
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<EnclaveResourceInner> updateAsync(String resourceGroupName, String virtualEnclaveName,
        EnclaveResourceUpdate properties, Context context) {
