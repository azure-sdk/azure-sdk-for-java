...
public interface EnclaveResource {
     ...
     */
    interface Update extends UpdateStages.WithTags, UpdateStages.WithIdentity, UpdateStages.WithEnclaveVirtualNetwork,
        UpdateStages.WithCommunityResourceId, UpdateStages.WithEnclaveDefaultSettings,
        UpdateStages.WithResourceCollection, UpdateStages.WithManagedResourceGroupConfiguration,
        UpdateStages.WithMaintenanceModeConfiguration, UpdateStages.WithBastionEnabled,
        UpdateStages.WithEnclaveRoleAssignments, UpdateStages.WithWorkloadRoleAssignments {
        /**
    ...
    interface UpdateStages {
        ...
        /**
         * The stage of the EnclaveResource update allowing to specify enclaveVirtualNetwork.
         */
        interface WithEnclaveVirtualNetwork {
            /**
             * Specifies the enclaveVirtualNetwork property: Virtual Network..
             ...
             * @return the next definition stage.
             */
            Update withEnclaveVirtualNetwork(EnclaveVirtualNetwork enclaveVirtualNetwork);
        }

        /**
         * The stage of the EnclaveResource update allowing to specify communityResourceId.
         */
        interface WithCommunityResourceId {
            /**
             * Specifies the communityResourceId property: Community Resource Id..
        ...
        /**
         * The stage of the EnclaveResource update allowing to specify enclaveDefaultSettings.
         */
        interface WithEnclaveDefaultSettings {
            /**
             * Specifies the enclaveDefaultSettings property: Default Settings.
             ...
             * @return the next definition stage.
             */
            Update withEnclaveDefaultSettings(EnclaveDefaultSettings enclaveDefaultSettings);
        }

        /**
         * The stage of the EnclaveResource update allowing to specify resourceCollection.
         */
        interface WithResourceCollection {
            /**
             * Specifies the resourceCollection property: List of resource ids created by Virtual Enclave..
        ...
        /**
         * The stage of the EnclaveResource update allowing to specify managedResourceGroupConfiguration.
         */
        interface WithManagedResourceGroupConfiguration {
            /**
             * Specifies the managedResourceGroupConfiguration property: Managed resource group configuration..
        ...
        /**
         * The stage of the EnclaveResource update allowing to specify maintenanceModeConfiguration.
         */
        interface WithMaintenanceModeConfiguration {
            /**
             * Specifies the maintenanceModeConfiguration property: Maintenance Mode configuration..
             ...
             * @return the next definition stage.
             */
            Update withMaintenanceModeConfiguration(MaintenanceModeConfiguration maintenanceModeConfiguration);
        }

        /**
         * The stage of the EnclaveResource update allowing to specify bastionEnabled.
         */
        interface WithBastionEnabled {
            /**
             * Specifies the bastionEnabled property: Deploy Bastion service (True or False)..
             ...
             * @return the next definition stage.
             */
            Update withBastionEnabled(Boolean bastionEnabled);
        }

        /**
         * The stage of the EnclaveResource update allowing to specify enclaveRoleAssignments.
         */
        interface WithEnclaveRoleAssignments {
            /**
             * Specifies the enclaveRoleAssignments property: Enclave role assignments.
             ...
             * @return the next definition stage.
             */
            Update withEnclaveRoleAssignments(List<RoleAssignmentItem> enclaveRoleAssignments);
        }

        /**
         * The stage of the EnclaveResource update allowing to specify workloadRoleAssignments.
         */
        interface WithWorkloadRoleAssignments {
            /**
             * Specifies the workloadRoleAssignments property: Workload role assignments.
             ...
             * @return the next definition stage.
             */
            Update withWorkloadRoleAssignments(List<RoleAssignmentItem> workloadRoleAssignments);
        }
    }
