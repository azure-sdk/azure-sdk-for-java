...
public final class EnclaveEndpointResourceImpl
    ...
    private EnclaveEndpointResourceUpdate updateProperties;
    ...
    public EnclaveEndpointResourceImpl update() {
        this.updateProperties = new EnclaveEndpointResourceUpdate();
        return this;
    }
    ...
    public EnclaveEndpointResourceImpl withRuleCollection(List<EnclaveEndpointDestinationRule> ruleCollection) {
        if (isInCreateMode()) {
            ...
            this.updateProperties.withRuleCollection(ruleCollection);
            return this;
        }
    }
    ...
    public EnclaveEndpointResourceImpl withApprovalRequired(Boolean approvalRequired) {
        if (isInCreateMode()) {
            this.innerModel().withApprovalRequired(approvalRequired);
            return this;
        } else {
            this.updateProperties.withApprovalRequired(approvalRequired);
            return this;
        }
    }
