...
public final class EnclaveEndpointResourceImpl
    ...
    public EnclaveEndpointResource apply() {
        this.innerObject = serviceManager.serviceClient()
            .getEnclaveEndpoints()
            .update(resourceGroupName, virtualEnclaveName, enclaveEndpointName, this.innerModel(), Context.NONE);
        return this;
    }
    ...
    public EnclaveEndpointResource apply(Context context) {
        this.innerObject = serviceManager.serviceClient()
            .getEnclaveEndpoints()
            .update(resourceGroupName, virtualEnclaveName, enclaveEndpointName, this.innerModel(), context);
        return this;
    }
