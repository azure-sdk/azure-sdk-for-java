...
public interface ApprovalsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ApprovalResourceInner update(String resourceUri, String approvalName, ApprovalResourceUpdate properties);
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<InitiatorCallbackResponseInner>, InitiatorCallbackResponseInner>
