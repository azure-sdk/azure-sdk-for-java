...
public interface EnclaveConnectionsClient {
    ...
    SyncPoller<PollResult<EnclaveConnectionResourceInner>, EnclaveConnectionResourceInner>
        beginUpdate(String resourceGroupName, String enclaveConnectionName, EnclaveConnectionResourceUpdate properties);
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<ApprovalCallbackResponseInner>, ApprovalCallbackResponseInner>
