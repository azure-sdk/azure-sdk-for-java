...
public final class EnclaveEndpointProperties implements JsonSerializable<EnclaveEndpointProperties> {
     ...
     * @return the EnclaveEndpointProperties object itself.
     */
    public EnclaveEndpointProperties withApprovalRequired(Boolean approvalRequired) {
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("ruleCollection".equals(fieldName)) {
                    ...
                    deserializedEnclaveEndpointProperties.approvalRequired = reader.getNullable(JsonReader::getBoolean);
                } else {
                    reader.skipChildren();
                }
            }
