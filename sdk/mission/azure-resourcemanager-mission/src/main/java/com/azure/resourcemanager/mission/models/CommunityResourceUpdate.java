...
import com.azure.resourcemanager.mission.fluent.models.CommunityPropertiesUpdate;
...
public final class CommunityResourceUpdate extends AzureResourceManagerCommonTypesTrackedResourceUpdate {
     ...
     */
    private CommunityPropertiesUpdate innerProperties;
    ...
    public CommunityResourceUpdate withAddressSpace(String addressSpace) {
        if (this.innerProperties() == null) {
            this.innerProperties = new CommunityPropertiesUpdate();
        }
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("id".equals(fieldName)) {
                    ...
                    deserializedCommunityResourceUpdate.innerProperties = CommunityPropertiesUpdate.fromJson(reader);
