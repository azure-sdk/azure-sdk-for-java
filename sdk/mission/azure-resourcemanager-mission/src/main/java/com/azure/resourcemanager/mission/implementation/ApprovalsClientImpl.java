...
public final class ApprovalsClientImpl implements ApprovalsClient {
    ...
    public interface ApprovalsService {
        ...
        Mono<Response<Flux<ByteBuffer>>> update(@HostParam("$host") String endpoint,
            ...
            @PathParam(value = "resourceUri", encoded = true) String resourceUri,
            @PathParam("approvalName") String approvalName,
            @BodyParam("application/json") ApprovalResourceUpdate properties, @HeaderParam("Accept") String accept,
            Context context);
    ...
    private Mono<Response<Flux<ByteBuffer>>> updateWithResponseAsync(String resourceUri, String approvalName,
        ApprovalResourceUpdate properties) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> updateWithResponseAsync(String resourceUri, String approvalName,
        ApprovalResourceUpdate properties, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    private PollerFlux<PollResult<ApprovalResourceInner>, ApprovalResourceInner> beginUpdateAsync(String resourceUri,
        String approvalName, ApprovalResourceUpdate properties) {
    ...
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<ApprovalResourceInner>, ApprovalResourceInner> beginUpdateAsync(String resourceUri,
        String approvalName, ApprovalResourceUpdate properties, Context context) {
        context = this.client.mergeContext(context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ApprovalResourceInner update(String resourceUri, String approvalName, ApprovalResourceUpdate properties) {
