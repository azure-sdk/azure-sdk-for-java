 ...
 */
@Fluent
public final class CommunityEndpointPropertiesUpdate implements JsonSerializable<CommunityEndpointPropertiesUpdate> {
    /*
    ...
    /**
     * Creates an instance of CommunityEndpointPropertiesUpdate class.
     */
    public CommunityEndpointPropertiesUpdate() {
    }
     ...
     * @return the CommunityEndpointPropertiesUpdate object itself.
     */
    public CommunityEndpointPropertiesUpdate withRuleCollection(List<CommunityEndpointDestinationRule> ruleCollection) {
     ...
     * @return the CommunityEndpointPropertiesUpdate object itself.
     */
    public CommunityEndpointPropertiesUpdate withResourceCollection(List<String> resourceCollection) {
     ...
     * @return the CommunityEndpointPropertiesUpdate object itself.
     */
    public CommunityEndpointPropertiesUpdate withApprovalRequired(Boolean approvalRequired) {
    ...
    /**
     * Reads an instance of CommunityEndpointPropertiesUpdate from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of CommunityEndpointPropertiesUpdate if the JsonReader was pointing to an instance of it, or
     * null if it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the CommunityEndpointPropertiesUpdate.
     */
    public static CommunityEndpointPropertiesUpdate fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            CommunityEndpointPropertiesUpdate deserializedCommunityEndpointPropertiesUpdate
                = new CommunityEndpointPropertiesUpdate();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("ruleCollection".equals(fieldName)) {
                    ...
                    deserializedCommunityEndpointPropertiesUpdate.ruleCollection = ruleCollection;
                } else if ("resourceCollection".equals(fieldName)) {
                    List<String> resourceCollection = reader.readArray(reader1 -> reader1.getString());
                    deserializedCommunityEndpointPropertiesUpdate.resourceCollection = resourceCollection;
                } else if ("approvalRequired".equals(fieldName)) {
                    deserializedCommunityEndpointPropertiesUpdate.approvalRequired
            ...
            return deserializedCommunityEndpointPropertiesUpdate;
        });
    }
}
