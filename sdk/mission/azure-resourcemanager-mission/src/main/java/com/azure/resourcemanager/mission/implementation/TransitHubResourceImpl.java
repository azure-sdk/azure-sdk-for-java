...
public final class TransitHubResourceImpl
    ...
    private TransitHubResourceUpdate updateProperties;
    ...
    public TransitHubResourceImpl update() {
        this.updateProperties = new TransitHubResourceUpdate();
        return this;
    }
    ...
    public TransitHubResourceImpl withTransitOption(TransitOption transitOption) {
        if (isInCreateMode()) {
            ...
            this.updateProperties.withTransitOption(transitOption);
            return this;
        }
    }
