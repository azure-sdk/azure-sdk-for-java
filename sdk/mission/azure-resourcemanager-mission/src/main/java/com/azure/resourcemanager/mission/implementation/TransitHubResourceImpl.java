...
public final class TransitHubResourceImpl
    ...
    public TransitHubResource apply() {
        this.innerObject = serviceManager.serviceClient()
            .getTransitHubs()
            .update(resourceGroupName, communityName, transitHubName, this.innerModel(), Context.NONE);
        return this;
    }
    ...
    public TransitHubResource apply(Context context) {
        this.innerObject = serviceManager.serviceClient()
            .getTransitHubs()
            .update(resourceGroupName, communityName, transitHubName, this.innerModel(), context);
        return this;
    }
