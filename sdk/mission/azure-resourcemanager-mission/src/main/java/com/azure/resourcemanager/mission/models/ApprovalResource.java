...
public interface ApprovalResource {
    ...
    interface Update extends UpdateStages.WithParent1, UpdateStages.WithParent2, UpdateStages.WithRequestMetadata,
        UpdateStages.WithApprovers, UpdateStages.WithTicketId, UpdateStages.WithCreatedAt,
        UpdateStages.WithStateChangedAt {
        /**
    ...
    interface UpdateStages {
        ...
        interface WithRequestMetadata {
             ...
             * @return the next definition stage.
             */
            Update withRequestMetadata(RequestMetadata requestMetadata);
        }
        ...
        interface WithApprovers {
             ...
             * @return the next definition stage.
             */
            Update withApprovers(List<Approver> approvers);
        }

        /**
         * The stage of the ApprovalResource update allowing to specify ticketId.
         */
        interface WithTicketId {
            /**
             * Specifies the ticketId property: Ticket ID for the approval request.
             ...
             * @return the next definition stage.
             */
            Update withTicketId(String ticketId);
        }

        /**
         * The stage of the ApprovalResource update allowing to specify createdAt.
         */
        interface WithCreatedAt {
            /**
             * Specifies the createdAt property: Approval request creation time.
        ...
        /**
         * The stage of the ApprovalResource update allowing to specify stateChangedAt.
         */
        interface WithStateChangedAt {
            /**
             * Specifies the stateChangedAt property: Approval request state change time, time at which approval request
             ...
             * @return the next definition stage.
             */
            Update withStateChangedAt(OffsetDateTime stateChangedAt);
        }
    }
