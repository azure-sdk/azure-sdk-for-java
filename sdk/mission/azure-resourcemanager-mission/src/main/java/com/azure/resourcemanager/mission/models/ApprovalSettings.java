...
public final class ApprovalSettings implements JsonSerializable<ApprovalSettings> {
     ...
     */
    private ApprovalSettingsConnectionUpdateMode connectionUpdateMode;
    ...
    /**
     * Get the connectionUpdateMode property: Behavior of enclave connection update workflow after endpoint update is
     * approved (Automatic or Manual).
     * 
     * @return the connectionUpdateMode value.
     */
    public ApprovalSettingsConnectionUpdateMode connectionUpdateMode() {
        return this.connectionUpdateMode;
    }

    /**
     * Set the connectionUpdateMode property: Behavior of enclave connection update workflow after endpoint update is
     * approved (Automatic or Manual).
     * 
     * @param connectionUpdateMode the connectionUpdateMode value to set.
     * @return the ApprovalSettings object itself.
     */
    public ApprovalSettings withConnectionUpdateMode(ApprovalSettingsConnectionUpdateMode connectionUpdateMode) {
        this.connectionUpdateMode = connectionUpdateMode;
        return this;
    }
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeStringField("connectionUpdateMode",
            this.connectionUpdateMode == null ? null : this.connectionUpdateMode.toString());
    ...
    public static ApprovalSettings fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                } else if ("connectionUpdateMode".equals(fieldName)) {
                    deserializedApprovalSettings.connectionUpdateMode
                        = ApprovalSettingsConnectionUpdateMode.fromString(reader.getString());
