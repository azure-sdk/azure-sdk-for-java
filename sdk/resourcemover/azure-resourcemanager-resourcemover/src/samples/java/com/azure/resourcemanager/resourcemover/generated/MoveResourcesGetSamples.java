...
public final class MoveResourcesGetSamples {
    /*
     * x-ms-original-file:
     * specification/resourcemover/resource-manager/Microsoft.Migrate/stable/2024-01-01/examples/MoveResources_Get.json
     */
    /**
    ...
    public static void moveResourcesGet(com.azure.resourcemanager.resourcemover.ResourceMoverManager manager) {
        manager.moveResources().getWithResponse("rg1", "movecollection1", "moveresourcename1",
