...
public final class MoveCollectionsInitiateMoveSamples {
    /*
     * x-ms-original-file: specification/resourcemover/resource-manager/Microsoft.Migrate/stable/2024-01-01/examples/
    ...
    public static void
        ...
        manager.moveCollections().initiateMove("rg1", "movecollection1",
            new ResourceMoveRequest().withValidateOnly(false).withMoveResources(Arrays.asList(
