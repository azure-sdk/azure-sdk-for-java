...
public final class MoveResourcesCreateSamples {
    /*
     * x-ms-original-file:
     * specification/resourcemover/resource-manager/Microsoft.Migrate/stable/2024-01-01/examples/MoveResources_Create.
     * json
     */
    /**
    ...
    public static void moveResourcesCreate(com.azure.resourcemanager.resourcemover.ResourceMoverManager manager) {
        manager.moveResources().define("moveresourcename1").withExistingMoveCollection("rg1", "movecollection1")
            .withProperties(new MoveResourceProperties().withSourceId(
                ...
                .withResourceSettings(new VirtualMachineResourceSettings().withTargetResourceName("westusvm1")
                    ...
                    .withTargetAvailabilityZone(TargetAvailabilityZone.TWO).withTargetAvailabilitySetId(
