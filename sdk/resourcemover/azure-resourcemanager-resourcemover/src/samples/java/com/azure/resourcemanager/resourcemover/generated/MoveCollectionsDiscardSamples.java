...
public final class MoveCollectionsDiscardSamples {
    /*
     * x-ms-original-file:
     * specification/resourcemover/resource-manager/Microsoft.Migrate/stable/2024-01-01/examples/MoveCollections_Discard
     * .json
     */
    /**
    ...
    public static void moveCollectionsDiscard(com.azure.resourcemanager.resourcemover.ResourceMoverManager manager) {
        manager.moveCollections().discard("rg1", "movecollection1",
            new DiscardRequest().withValidateOnly(false).withMoveResources(Arrays.asList(
