...
public final class MoveCollectionsCreateSamples {
    /*
     * x-ms-original-file:
     * specification/resourcemover/resource-manager/Microsoft.Migrate/stable/2024-01-01/examples/MoveCollections_Create.
     * json
     */
    /**
    ...
    public static void moveCollectionsCreate(com.azure.resourcemanager.resourcemover.ResourceMoverManager manager) {
        manager.moveCollections().define("movecollection1").withRegion("eastus2").withExistingResourceGroup("rg1")
