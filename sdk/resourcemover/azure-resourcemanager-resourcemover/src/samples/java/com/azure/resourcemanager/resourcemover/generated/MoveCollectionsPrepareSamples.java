...
public final class MoveCollectionsPrepareSamples {
    /*
     * x-ms-original-file:
     * specification/resourcemover/resource-manager/Microsoft.Migrate/stable/2024-01-01/examples/MoveCollections_Prepare
     * .json
     */
    /**
    ...
    public static void moveCollectionsPrepare(com.azure.resourcemanager.resourcemover.ResourceMoverManager manager) {
        manager.moveCollections().prepare("rg1", "movecollection1",
            new PrepareRequest().withValidateOnly(false).withMoveResources(Arrays.asList(
