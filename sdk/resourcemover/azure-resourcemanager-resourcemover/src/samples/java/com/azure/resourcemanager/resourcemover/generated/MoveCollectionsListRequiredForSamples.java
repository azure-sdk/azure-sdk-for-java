...
public final class MoveCollectionsListRequiredForSamples {
    /*
     * x-ms-original-file:
     * specification/resourcemover/resource-manager/Microsoft.Migrate/stable/2024-01-01/examples/RequiredFor_Get.json
     */
    /**
    ...
    public static void requiredForGet(com.azure.resourcemanager.resourcemover.ResourceMoverManager manager) {
        manager.moveCollections().listRequiredForWithResponse("rg1", "movecollection1",
