...
public final class MoveCollectionsGetByResourceGroupSamples {
    /*
     * x-ms-original-file:
     * specification/resourcemover/resource-manager/Microsoft.Migrate/stable/2024-01-01/examples/MoveCollections_Get.
     * json
     */
    /**
    ...
    public static void moveCollectionsGet(com.azure.resourcemanager.resourcemover.ResourceMoverManager manager) {
        manager.moveCollections().getByResourceGroupWithResponse("rg1", "movecollection1",
