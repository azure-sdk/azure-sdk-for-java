...
public final class MoveCollectionsCommitSamples {
    /*
     * x-ms-original-file:
     * specification/resourcemover/resource-manager/Microsoft.Migrate/stable/2024-01-01/examples/MoveCollections_Commit.
     * json
     */
    /**
    ...
    public static void moveCollectionsCommit(com.azure.resourcemanager.resourcemover.ResourceMoverManager manager) {
        manager.moveCollections().commit("rg1", "movecollection1",
            new CommitRequest().withValidateOnly(false).withMoveResources(Arrays.asList(
