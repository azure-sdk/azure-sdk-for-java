...
public final class MoveCollectionImpl implements MoveCollection, MoveCollection.Definition, MoveCollection.Update {
    ...
    public MoveCollection create() {
        this.innerObject = serviceManager.serviceClient().getMoveCollections()
            .createWithResponse(resourceGroupName, moveCollectionName, this.innerModel(), Context.NONE).getValue();
        return this;
    }

    public MoveCollection create(Context context) {
        this.innerObject = serviceManager.serviceClient().getMoveCollections()
            .createWithResponse(resourceGroupName, moveCollectionName, this.innerModel(), context).getValue();
        return this;
    }
    ...
    public MoveCollection apply() {
        this.innerObject = serviceManager.serviceClient().getMoveCollections()
            .updateWithResponse(resourceGroupName, moveCollectionName, updateBody, Context.NONE).getValue();
        return this;
    }

    public MoveCollection apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getMoveCollections()
            .updateWithResponse(resourceGroupName, moveCollectionName, updateBody, context).getValue();
        return this;
    }
    ...
    public MoveCollection refresh() {
        this.innerObject = serviceManager.serviceClient().getMoveCollections()
            .getByResourceGroupWithResponse(resourceGroupName, moveCollectionName, Context.NONE).getValue();
        return this;
    }

    public MoveCollection refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getMoveCollections()
            .getByResourceGroupWithResponse(resourceGroupName, moveCollectionName, context).getValue();
        return this;
    }
