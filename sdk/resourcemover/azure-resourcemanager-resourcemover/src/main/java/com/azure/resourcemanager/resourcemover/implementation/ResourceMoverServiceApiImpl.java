...
/**
 * Initializes a new instance of the ResourceMoverServiceApiImpl type.
 */
@ServiceClient(builder = ResourceMoverServiceApiBuilder.class)
public final class ResourceMoverServiceApiImpl implements ResourceMoverServiceApi {
    /**
     * The Subscription ID.
     */
     ...
     */
    public MoveCollectionsClient getMoveCollections() {
        return this.moveCollections;
    }

    /**
     * The MoveResourcesClient object to access its operations.
     */
    private final MoveResourcesClient moveResources;
     ...
     */
    public MoveResourcesClient getMoveResources() {
        return this.moveResources;
    }

    /**
     * The UnresolvedDependenciesClient object to access its operations.
     */
    private final UnresolvedDependenciesClient unresolvedDependencies;
     ...
     */
    public UnresolvedDependenciesClient getUnresolvedDependencies() {
        return this.unresolvedDependencies;
    }

    /**
     * The OperationsDiscoveriesClient object to access its operations.
     */
    private final OperationsDiscoveriesClient operationsDiscoveries;
     ...
     */
    public OperationsDiscoveriesClient getOperationsDiscoveries() {
        return this.operationsDiscoveries;
    }
     ...
     */
    ResourceMoverServiceApiImpl(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter,
        ...
        this.operationsDiscoveries = new OperationsDiscoveriesClientImpl(this);
    }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(ResourceMoverServiceApiImpl.class);
}
