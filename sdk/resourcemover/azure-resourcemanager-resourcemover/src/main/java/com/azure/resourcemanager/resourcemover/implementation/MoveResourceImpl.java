...
public final class MoveResourceImpl implements MoveResource, MoveResource.Definition {
    ...
    public MoveResource create() {
        this.innerObject = serviceManager.serviceClient().getMoveResources().create(resourceGroupName,
            moveCollectionName, moveResourceName, this.innerModel(), Context.NONE);
        return this;
    }

    public MoveResource create(Context context) {
        this.innerObject = serviceManager.serviceClient().getMoveResources().create(resourceGroupName,
            moveCollectionName, moveResourceName, this.innerModel(), context);
        return this;
    }
    ...
    public MoveResource refresh() {
        this.innerObject = serviceManager.serviceClient().getMoveResources()
            .getWithResponse(resourceGroupName, moveCollectionName, moveResourceName, Context.NONE).getValue();
        return this;
    }

    public MoveResource refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getMoveResources()
            .getWithResponse(resourceGroupName, moveCollectionName, moveResourceName, context).getValue();
        return this;
    }
