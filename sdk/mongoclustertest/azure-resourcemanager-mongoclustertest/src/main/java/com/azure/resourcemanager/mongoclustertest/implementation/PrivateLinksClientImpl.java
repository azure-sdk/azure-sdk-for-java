...
import com.azure.resourcemanager.mongoclustertest.models.PrivateLinkResourceListResult;
...
public final class PrivateLinksClientImpl implements PrivateLinksClient {
    ...
    public interface PrivateLinksService {
        ...
        Mono<Response<PrivateLinkResourceListResult>> listByMongoCluster(@HostParam("$host") String endpoint,
