...
public final class ReplicaListResult implements JsonSerializable<ReplicaListResult> {
    ...
    /**
     * Set the value property: The Replica items on this page.
     * 
    ...
    public void validate() {
        if (value() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Missing required property value in model ReplicaListResult"));
        } else {
            value().forEach(e -> e.validate());
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(ReplicaListResult.class);
