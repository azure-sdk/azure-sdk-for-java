...
import com.azure.resourcemanager.kubernetesconfigurationmicrosoftkubernetesconfigurationextensions.models.AdditionalDetails;
...
import com.azure.resourcemanager.kubernetesconfigurationmicrosoftkubernetesconfigurationextensions.models.ManagementDetails;
...
public final class ExtensionInner extends ProxyResource {
     ...
     */
    public ExtensionInner withIdentity(ManagedServiceIdentity identity) {
     ...
     * @return the ExtensionInner object itself.
     */
    public ExtensionInner withManagedBy(String managedBy) {
    ...
    /**
     * Get the autoUpgradeMode property: The upgrade mode for auto upgrade. The default is 'compatible'.
     * 
     * @return the autoUpgradeMode value.
     */
    public AutoUpgradeMode autoUpgradeMode() {
        return this.innerProperties() == null ? null : this.innerProperties().autoUpgradeMode();
    }

    /**
     * Set the autoUpgradeMode property: The upgrade mode for auto upgrade. The default is 'compatible'.
     * 
     * @param autoUpgradeMode the autoUpgradeMode value to set.
     * @return the ExtensionInner object itself.
     */
    public ExtensionInner withAutoUpgradeMode(AutoUpgradeMode autoUpgradeMode) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ExtensionProperties();
        }
        this.innerProperties().withAutoUpgradeMode(autoUpgradeMode);
        return this;
    }
    ...
    /**
     * Get the managementDetails property: Metadata about the managing entity and the permitted operations.
     * 
     * @return the managementDetails value.
     */
    public ManagementDetails managementDetails() {
        return this.innerProperties() == null ? null : this.innerProperties().managementDetails();
    }

    /**
     * Get the additionalDetails property: Additional details provided by the publisher of the extension.
     * 
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("id".equals(fieldName)) {
                    ...
                    deserializedExtensionInner.identity = ManagedServiceIdentity.fromJson(reader);
                    ...
                    deserializedExtensionInner.managedBy = reader.getString();
                } else {
                    reader.skipChildren();
                }
            }
