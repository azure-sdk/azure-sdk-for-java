...
public final class ManagedServiceIdentity implements JsonSerializable<ManagedServiceIdentity> {
    ...
    /*
     * The type of identity used for the resource. Only user assigned identities are supported for 'Bring your own
     * Identity' model.
     */
     ...
     */
    private Map<String, UserAssignedIdentitiesAdditionalProperties> userAssignedIdentities;
    ...
    /**
     * Get the type property: The type of identity used for the resource. Only user assigned identities are supported
     * for 'Bring your own Identity' model.
     * 
    ...
    /**
     * Set the type property: The type of identity used for the resource. Only user assigned identities are supported
     * for 'Bring your own Identity' model.
     * 
     ...
     */
    public Map<String, UserAssignedIdentitiesAdditionalProperties> userAssignedIdentities() {
     ...
     */
    public ManagedServiceIdentity
        withUserAssignedIdentities(Map<String, UserAssignedIdentitiesAdditionalProperties> userAssignedIdentities) {
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("principalId".equals(fieldName)) {
                    ...
                    Map<String, UserAssignedIdentitiesAdditionalProperties> userAssignedIdentities
                        = reader.readMap(reader1 -> UserAssignedIdentitiesAdditionalProperties.fromJson(reader1));
