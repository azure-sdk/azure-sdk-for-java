...
public final class ExtensionProperties implements JsonSerializable<ExtensionProperties> {
     ...
     * @return the ExtensionProperties object itself.
     */
    public ExtensionProperties withAutoUpgradeMode(AutoUpgradeMode autoUpgradeMode) {
    ...
    public static ExtensionProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("extensionType".equals(fieldName)) {
                ...
                } else if ("autoUpgradeMode".equals(fieldName)) {
                    deserializedExtensionProperties.autoUpgradeMode = AutoUpgradeMode.fromString(reader.getString());
                    ...
                    deserializedExtensionProperties.managementDetails = ManagementDetails.fromJson(reader);
                } else if ("additionalDetails".equals(fieldName)) {
                    deserializedExtensionProperties.additionalDetails = AdditionalDetails.fromJson(reader);
                } else {
                    reader.skipChildren();
                }
            }
