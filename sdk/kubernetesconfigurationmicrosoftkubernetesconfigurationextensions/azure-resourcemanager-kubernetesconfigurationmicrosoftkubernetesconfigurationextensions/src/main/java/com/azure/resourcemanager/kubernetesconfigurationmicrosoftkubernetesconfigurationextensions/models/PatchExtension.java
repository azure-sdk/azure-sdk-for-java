 ...
 */
@Fluent
public final class PatchExtension implements JsonSerializable<PatchExtension> {
    /*
     ...
     */
    public PatchExtension withIdentity(ManagedServiceIdentity identity) {
     ...
     * @return the PatchExtension object itself.
     */
    public PatchExtension withAutoUpgradeMode(AutoUpgradeMode autoUpgradeMode) {
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("properties".equals(fieldName)) {
                    ...
                    deserializedPatchExtension.identity = ManagedServiceIdentity.fromJson(reader);
                } else {
                    reader.skipChildren();
                }
            }
