    ...
    public void validate() {
            ...
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException(
                        "Missing required property contactDetails in model ReverseShippingDetails"));
        } else {
        ...
        if (shippingAddress() == null) {
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException(
                        "Missing required property shippingAddress in model ReverseShippingDetails"));
        } else {
            shippingAddress().validate();
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(ReverseShippingDetails.class);
}
