...
public final class AzureTrafficCollectorsBySubscriptionsClientImpl
    ...
    private interface AzureTrafficCollectorsBySubscriptionsService {
        ...
        Mono<Response<AzureTrafficCollectorListResult>> list(
    ...
    private Mono<PagedResponse<AzureTrafficCollectorInner>> listSinglePageAsync() {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<AzureTrafficCollectorInner>> listSinglePageAsync(Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    private PagedFlux<AzureTrafficCollectorInner> listAsync() {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<AzureTrafficCollectorInner> listAsync(Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<AzureTrafficCollectorInner> list() {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<AzureTrafficCollectorInner> list(Context context) {
