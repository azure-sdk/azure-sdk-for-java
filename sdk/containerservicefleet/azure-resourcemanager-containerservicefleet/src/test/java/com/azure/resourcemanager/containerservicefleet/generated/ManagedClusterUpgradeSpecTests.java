...
public final class ManagedClusterUpgradeSpecTests {
    ...
    public void testDeserialize() throws Exception {
        ManagedClusterUpgradeSpec model = BinaryData.fromString("{\"type\":\"Full\",\"kubernetesVersion\":\"dokgjl\"}")
            .toObject(ManagedClusterUpgradeSpec.class);
        Assertions.assertEquals(ManagedClusterUpgradeType.FULL, model.type());
        Assertions.assertEquals("dokgjl", model.kubernetesVersion());
    }

    @org.junit.jupiter.api.Test
    public void testSerialize() throws Exception {
        ManagedClusterUpgradeSpec model
            = new ManagedClusterUpgradeSpec().withType(ManagedClusterUpgradeType.FULL).withKubernetesVersion("dokgjl");
