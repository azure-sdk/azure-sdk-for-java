...
public final class SkipTargetTests {
    ...
    public void testDeserialize() throws Exception {
        SkipTarget model
            = BinaryData.fromString("{\"type\":\"Member\",\"name\":\"ywnuzoq\"}").toObject(SkipTarget.class);
        Assertions.assertEquals(TargetType.MEMBER, model.type());
        Assertions.assertEquals("ywnuzoq", model.name());
    }

    @org.junit.jupiter.api.Test
    public void testSerialize() throws Exception {
        SkipTarget model = new SkipTarget().withType(TargetType.MEMBER).withName("ywnuzoq");
