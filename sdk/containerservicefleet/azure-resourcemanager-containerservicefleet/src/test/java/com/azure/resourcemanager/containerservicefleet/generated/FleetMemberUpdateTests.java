...
public final class FleetMemberUpdateTests {
    ...
    public void testDeserialize() throws Exception {
        FleetMemberUpdate model = BinaryData.fromString("{\"properties\":{\"group\":\"azjpqyegualhbxxh\"}}")
            .toObject(FleetMemberUpdate.class);
        Assertions.assertEquals("azjpqyegualhbxxh", model.group());
    }

    @org.junit.jupiter.api.Test
    public void testSerialize() throws Exception {
        FleetMemberUpdate model = new FleetMemberUpdate().withGroup("azjpqyegualhbxxh");
