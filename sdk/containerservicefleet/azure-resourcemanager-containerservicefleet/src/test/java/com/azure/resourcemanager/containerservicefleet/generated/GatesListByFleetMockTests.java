...
public final class GatesListByFleetMockTests {
    ...
    public void testListByFleet() throws Exception {
        String responseStr
            = "{\"value\":[{\"properties\":{\"provisioningState\":\"Failed\",\"displayName\":\"ft\",\"gateType\":\"Approval\",\"target\":{\"updateRunProperties\":{\"name\":\"equi\",\"stage\":\"xicslfao\",\"group\":\"piyylhalnswhccsp\",\"timing\":\"Before\"}},\"state\":\"Completed\"},\"eTag\":\"vwitqscyw\",\"location\":\"gwol\",\"tags\":{\"i\":\"zbwemh\",\"wmsweypqwd\":\"sbrgz\",\"mkttlstvlzywem\":\"ggicccnxqhue\",\"lusiy\":\"zrncsdt\"},\"id\":\"bsfgytguslfea\",\"name\":\"cy\",\"type\":\"qukyhejhzi\"}]}";
        ...
        PagedIterable<Gate> response
            = manager.gates().listByFleet("bminrfdwoyuhhzi", "iefozbhdmsml", com.azure.core.util.Context.NONE);

        Assertions.assertEquals("gwol", response.iterator().next().location());
        Assertions.assertEquals("zbwemh", response.iterator().next().tags().get("i"));
        Assertions.assertEquals("ft", response.iterator().next().displayName());
