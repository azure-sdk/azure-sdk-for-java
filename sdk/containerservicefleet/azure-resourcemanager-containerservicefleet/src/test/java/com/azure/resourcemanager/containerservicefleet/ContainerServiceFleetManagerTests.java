...
public class ContainerServiceFleetManagerTests extends TestProxyTestBase {
    ...
    private ContainerServiceFleetManager containerServiceFleetManager;
    ...
    public void testCreateFleet() {
        ...
        try {
            ...
            Assertions.assertTrue(containerServiceFleetManager.fleets().list().stream().findAny().isPresent());
        } finally {
            if (fleet != null) {
                containerServiceFleetManager.fleets().deleteById(fleet.id());
            }
        }
    }
