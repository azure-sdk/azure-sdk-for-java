...
public final class AutoUpgradeProfilesGetWithResponseMockTests {
    ...
    public void testGetWithResponse() throws Exception {
        String responseStr
            = "{\"properties\":{\"provisioningState\":\"Canceled\",\"updateStrategyId\":\"wqm\",\"channel\":\"Rapid\",\"nodeImageSelection\":{\"type\":\"Latest\"},\"disabled\":false},\"eTag\":\"njijpxacqqudf\",\"id\":\"yxbaaabjyvayf\",\"name\":\"imrzrtuzqog\",\"type\":\"exn\"}";
        ...
        AutoUpgradeProfile response = manager.autoUpgradeProfiles()
            .getWithResponse("yxxrwlycoduh", "kxkgymareqna", "xqugjhkycubedd", com.azure.core.util.Context.NONE)
            .getValue();

        Assertions.assertEquals("wqm", response.updateStrategyId());
