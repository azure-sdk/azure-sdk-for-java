...
public final class AutoUpgradeProfilesGetWithResponseMockTests {
    ...
    public void testGetWithResponse() throws Exception {
        String responseStr
            = "{\"properties\":{\"provisioningState\":\"Failed\",\"updateStrategyId\":\"tvcof\",\"channel\":\"NodeImage\",\"nodeImageSelection\":{\"type\":\"Latest\"},\"disabled\":true},\"eTag\":\"jub\",\"id\":\"knnqvsaznq\",\"name\":\"tor\",\"type\":\"dsg\"}";
        ...
        AutoUpgradeProfile response = manager.autoUpgradeProfiles()
            .getWithResponse("cqdpfuv", "lsbjjcanvxbv", "vudutncor", com.azure.core.util.Context.NONE)
            .getValue();

        Assertions.assertEquals("tvcof", response.updateStrategyId());
