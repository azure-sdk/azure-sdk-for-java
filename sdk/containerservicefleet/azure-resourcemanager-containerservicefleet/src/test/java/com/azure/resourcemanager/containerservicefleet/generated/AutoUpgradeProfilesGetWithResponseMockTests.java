...
public final class AutoUpgradeProfilesGetWithResponseMockTests {
    ...
    public void testGetWithResponse() throws Exception {
        String responseStr
            = "{\"properties\":{\"provisioningState\":\"Succeeded\",\"updateStrategyId\":\"aatjinrvgoupmfi\",\"channel\":\"Rapid\",\"nodeImageSelection\":{\"type\":\"Consistent\"},\"disabled\":true},\"eTag\":\"ool\",\"id\":\"wxkvtkkgll\",\"name\":\"wjygvjayvblmhvk\",\"type\":\"uhbxvvy\"}";
        ...
        AutoUpgradeProfile response = manager.autoUpgradeProfiles()
            .getWithResponse("wfqatmtd", "tmdvypgikdgs", "ywkbirryuzhlhkjo", com.azure.core.util.Context.NONE)
            .getValue();

        Assertions.assertEquals("aatjinrvgoupmfi", response.updateStrategyId());
