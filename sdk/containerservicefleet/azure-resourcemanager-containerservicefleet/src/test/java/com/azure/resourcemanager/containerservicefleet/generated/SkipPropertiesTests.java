...
public final class SkipPropertiesTests {
    ...
    public void testDeserialize() throws Exception {
        SkipProperties model = BinaryData.fromString("{\"targets\":[{\"type\":\"Member\",\"name\":\"cmgyud\"}]}")
            .toObject(SkipProperties.class);
        Assertions.assertEquals(TargetType.MEMBER, model.targets().get(0).type());
        Assertions.assertEquals("cmgyud", model.targets().get(0).name());
    }

    @org.junit.jupiter.api.Test
    public void testSerialize() throws Exception {
        SkipProperties model = new SkipProperties()
            .withTargets(Arrays.asList(new SkipTarget().withType(TargetType.MEMBER).withName("cmgyud")));
