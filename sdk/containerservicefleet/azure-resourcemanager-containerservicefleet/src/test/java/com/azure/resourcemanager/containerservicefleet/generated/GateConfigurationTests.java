...
public final class GateConfigurationTests {
    ...
    public void testDeserialize() throws Exception {
        GateConfiguration model = BinaryData.fromString("{\"displayName\":\"jeputtmrywn\",\"type\":\"Approval\"}")
            .toObject(GateConfiguration.class);
        Assertions.assertEquals("jeputtmrywn", model.displayName());
        Assertions.assertEquals(GateType.APPROVAL, model.type());
    }

    @org.junit.jupiter.api.Test
    public void testSerialize() throws Exception {
        GateConfiguration model = new GateConfiguration().withDisplayName("jeputtmrywn").withType(GateType.APPROVAL);
