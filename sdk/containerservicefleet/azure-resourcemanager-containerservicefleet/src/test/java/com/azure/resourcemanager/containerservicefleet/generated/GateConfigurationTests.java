...
public final class GateConfigurationTests {
    ...
    public void testDeserialize() throws Exception {
        GateConfiguration model = BinaryData.fromString("{\"displayName\":\"qibycnojvknm\",\"type\":\"Approval\"}")
            .toObject(GateConfiguration.class);
        Assertions.assertEquals("qibycnojvknm", model.displayName());
        Assertions.assertEquals(GateType.APPROVAL, model.type());
    }

    @org.junit.jupiter.api.Test
    public void testSerialize() throws Exception {
        GateConfiguration model = new GateConfiguration().withDisplayName("qibycnojvknm").withType(GateType.APPROVAL);
