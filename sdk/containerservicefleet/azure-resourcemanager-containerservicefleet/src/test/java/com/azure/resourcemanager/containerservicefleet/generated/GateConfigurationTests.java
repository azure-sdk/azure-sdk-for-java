...
public final class GateConfigurationTests {
    ...
    public void testDeserialize() throws Exception {
        GateConfiguration model = BinaryData.fromString("{\"displayName\":\"hvgyuguosvmk\",\"type\":\"Approval\"}")
            .toObject(GateConfiguration.class);
        Assertions.assertEquals("hvgyuguosvmk", model.displayName());
        Assertions.assertEquals(GateType.APPROVAL, model.type());
    }

    @org.junit.jupiter.api.Test
    public void testSerialize() throws Exception {
        GateConfiguration model = new GateConfiguration().withDisplayName("hvgyuguosvmk").withType(GateType.APPROVAL);
