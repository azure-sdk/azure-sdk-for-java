...
public final class AutoUpgradeProfileInnerTests {
    ...
    public void testDeserialize() throws Exception {
        AutoUpgradeProfileInner model = BinaryData.fromString(
            "{\"properties\":{\"provisioningState\":\"Failed\",\"updateStrategyId\":\"zhxgktrmgucn\",\"channel\":\"Rapid\",\"nodeImageSelection\":{\"type\":\"Latest\"},\"disabled\":false},\"eTag\":\"llwptfdy\",\"id\":\"fqbuaceopzf\",\"name\":\"rhhuaopppcqeqx\",\"type\":\"lzdahzxctobgbkdm\"}")
            .toObject(AutoUpgradeProfileInner.class);
        Assertions.assertEquals("zhxgktrmgucn", model.updateStrategyId());
    ...
    public void testSerialize() throws Exception {
        AutoUpgradeProfileInner model = new AutoUpgradeProfileInner().withUpdateStrategyId("zhxgktrmgucn")
