...
public final class AutoUpgradeProfileInnerTests {
    ...
    public void testDeserialize() throws Exception {
        AutoUpgradeProfileInner model = BinaryData.fromString(
            "{\"properties\":{\"provisioningState\":\"Failed\",\"updateStrategyId\":\"mkqzeqqkdltfzxmh\",\"channel\":\"NodeImage\",\"nodeImageSelection\":{\"type\":\"Consistent\"},\"disabled\":false},\"eTag\":\"odkwobd\",\"id\":\"xtibqdxbxwakbog\",\"name\":\"xndlkzgxhu\",\"type\":\"iplbpodxunkbebxm\"}")
            .toObject(AutoUpgradeProfileInner.class);
        Assertions.assertEquals("mkqzeqqkdltfzxmh", model.updateStrategyId());
    ...
    public void testSerialize() throws Exception {
        AutoUpgradeProfileInner model = new AutoUpgradeProfileInner().withUpdateStrategyId("mkqzeqqkdltfzxmh")
