...
public final class AutoUpgradeProfileInnerTests {
    ...
    public void testDeserialize() throws Exception {
        AutoUpgradeProfileInner model = BinaryData.fromString(
            "{\"properties\":{\"provisioningState\":\"Canceled\",\"updateStrategyId\":\"eaxib\",\"channel\":\"Rapid\",\"nodeImageSelection\":{\"type\":\"Latest\"},\"disabled\":false},\"eTag\":\"walm\",\"id\":\"yoxa\",\"name\":\"pdkzjancuxr\",\"type\":\"d\"}")
            .toObject(AutoUpgradeProfileInner.class);
        Assertions.assertEquals("eaxib", model.updateStrategyId());
    ...
    public void testSerialize() throws Exception {
        AutoUpgradeProfileInner model = new AutoUpgradeProfileInner().withUpdateStrategyId("eaxib")
