...
public final class ManagedClusterUpdateTests {
    ...
    public void testDeserialize() throws Exception {
        ManagedClusterUpdate model = BinaryData.fromString(
            "{\"upgrade\":{\"type\":\"NodeImageOnly\",\"kubernetesVersion\":\"hkaetcktvfc\"},\"nodeImageSelection\":{\"type\":\"Consistent\",\"customNodeImageVersions\":[{\"version\":\"ymuctqhjfbebrj\"},{\"version\":\"erfuwuttt\"},{\"version\":\"vjrbirphxepcyvah\"},{\"version\":\"ljkyqxjvuuj\"}]}}")
            .toObject(ManagedClusterUpdate.class);
        Assertions.assertEquals(ManagedClusterUpgradeType.NODE_IMAGE_ONLY, model.upgrade().type());
        Assertions.assertEquals("hkaetcktvfc", model.upgrade().kubernetesVersion());
