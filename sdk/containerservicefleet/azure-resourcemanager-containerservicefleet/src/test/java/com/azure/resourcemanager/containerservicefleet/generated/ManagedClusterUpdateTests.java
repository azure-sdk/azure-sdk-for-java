...
public final class ManagedClusterUpdateTests {
    ...
    public void testDeserialize() throws Exception {
        ManagedClusterUpdate model = BinaryData.fromString(
            "{\"upgrade\":{\"type\":\"Full\",\"kubernetesVersion\":\"gzva\"},\"nodeImageSelection\":{\"type\":\"Consistent\",\"customNodeImageVersions\":[{\"version\":\"hpvgqz\"}]}}")
            .toObject(ManagedClusterUpdate.class);
        Assertions.assertEquals(ManagedClusterUpgradeType.FULL, model.upgrade().type());
        Assertions.assertEquals("gzva", model.upgrade().kubernetesVersion());
    ...
    public void testSerialize() throws Exception {
        ManagedClusterUpdate model = new ManagedClusterUpdate()
            .withUpgrade(
                new ManagedClusterUpgradeSpec().withType(ManagedClusterUpgradeType.FULL).withKubernetesVersion("gzva"))
