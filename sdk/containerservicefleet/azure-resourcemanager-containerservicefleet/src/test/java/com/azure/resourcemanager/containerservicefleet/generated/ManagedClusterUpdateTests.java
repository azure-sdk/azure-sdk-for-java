...
public final class ManagedClusterUpdateTests {
    ...
    public void testDeserialize() throws Exception {
        ManagedClusterUpdate model = BinaryData.fromString(
            "{\"upgrade\":{\"type\":\"ControlPlaneOnly\",\"kubernetesVersion\":\"jhtxfvgxbfsmxne\"},\"nodeImageSelection\":{\"type\":\"Consistent\",\"customNodeImageVersions\":[{\"version\":\"xgodebfqkkrbmp\"}]}}")
        ...
        Assertions.assertEquals("jhtxfvgxbfsmxne", model.upgrade().kubernetesVersion());
    ...
    public void testSerialize() throws Exception {
        ManagedClusterUpdate model = new ManagedClusterUpdate()
            .withUpgrade(new ManagedClusterUpgradeSpec().withType(ManagedClusterUpgradeType.CONTROL_PLANE_ONLY)
                .withKubernetesVersion("jhtxfvgxbfsmxne"))
