...
public final class AutoUpgradeProfilesListByFleetMockTests {
    ...
    public void testListByFleet() throws Exception {
        String responseStr
            = "{\"value\":[{\"properties\":{\"provisioningState\":\"Canceled\",\"updateStrategyId\":\"plhlvnuuepzlrp\",\"channel\":\"Rapid\",\"nodeImageSelection\":{\"type\":\"Consistent\"},\"disabled\":false},\"eTag\":\"wey\",\"id\":\"dunvmnnrwrbiorkt\",\"name\":\"lywjhh\",\"type\":\"dnhxmsi\"}]}";
        ...
        PagedIterable<AutoUpgradeProfile> response = manager.autoUpgradeProfiles()
            .listByFleet("bjcrxgibbdaxco", "fozauorsuk", com.azure.core.util.Context.NONE);

        Assertions.assertEquals("plhlvnuuepzlrp", response.iterator().next().updateStrategyId());
