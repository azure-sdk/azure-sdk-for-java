...
public final class AutoUpgradeProfilesListByFleetMockTests {
    ...
    public void testListByFleet() throws Exception {
        String responseStr
            = "{\"value\":[{\"properties\":{\"provisioningState\":\"Failed\",\"updateStrategyId\":\"htywubxcbihwq\",\"channel\":\"Rapid\",\"nodeImageSelection\":{\"type\":\"Consistent\"},\"disabled\":false},\"eTag\":\"jchrdgoihxumw\",\"id\":\"ond\",\"name\":\"jl\",\"type\":\"udfdlwgg\"}]}";
        ...
        PagedIterable<AutoUpgradeProfile> response
            = manager.autoUpgradeProfiles().listByFleet("y", "bfpncurdo", com.azure.core.util.Context.NONE);

        Assertions.assertEquals("htywubxcbihwq", response.iterator().next().updateStrategyId());
