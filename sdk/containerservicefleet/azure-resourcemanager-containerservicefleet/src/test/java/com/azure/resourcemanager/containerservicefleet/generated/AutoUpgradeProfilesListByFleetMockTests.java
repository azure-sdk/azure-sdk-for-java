...
public final class AutoUpgradeProfilesListByFleetMockTests {
    ...
    public void testListByFleet() throws Exception {
        String responseStr
            = "{\"value\":[{\"properties\":{\"provisioningState\":\"Failed\",\"updateStrategyId\":\"ikkx\",\"channel\":\"Rapid\",\"nodeImageSelection\":{\"type\":\"Latest\"},\"disabled\":false},\"eTag\":\"pvuzlmv\",\"id\":\"lfktgplcrpwjxe\",\"name\":\"noigbrnjwmwk\",\"type\":\"nbsazejjoqkag\"}]}";
        ...
        PagedIterable<AutoUpgradeProfile> response
            = manager.autoUpgradeProfiles().listByFleet("sxkm", "waekrrjreafxtsgu", com.azure.core.util.Context.NONE);

        Assertions.assertEquals("ikkx", response.iterator().next().updateStrategyId());
