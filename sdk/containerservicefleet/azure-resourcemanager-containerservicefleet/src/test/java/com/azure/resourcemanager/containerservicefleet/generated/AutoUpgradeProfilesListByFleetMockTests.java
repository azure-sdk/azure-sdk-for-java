...
public final class AutoUpgradeProfilesListByFleetMockTests {
    ...
    public void testListByFleet() throws Exception {
        String responseStr
            = "{\"value\":[{\"properties\":{\"provisioningState\":\"Succeeded\",\"updateStrategyId\":\"taeburuvdm\",\"channel\":\"Rapid\",\"nodeImageSelection\":{\"type\":\"Latest\"},\"disabled\":false},\"eTag\":\"wabm\",\"id\":\"efkifr\",\"name\":\"tpuqujmq\",\"type\":\"gkfbtndoaong\"}]}";
        ...
        PagedIterable<AutoUpgradeProfile> response
            = manager.autoUpgradeProfiles().listByFleet("a", "mkycgra", com.azure.core.util.Context.NONE);

        Assertions.assertEquals("taeburuvdm", response.iterator().next().updateStrategyId());
