...
public final class AutoUpgradeProfilesListByFleetMockTests {
    ...
    public void testListByFleet() throws Exception {
        String responseStr
            = "{\"value\":[{\"properties\":{\"provisioningState\":\"Canceled\",\"updateStrategyId\":\"ytdw\",\"channel\":\"NodeImage\",\"nodeImageSelection\":{\"type\":\"Consistent\"},\"disabled\":false},\"eTag\":\"paxh\",\"id\":\"iilivpdtiirqtd\",\"name\":\"oaxoruzfgsqu\",\"type\":\"fxrxxle\"}]}";
        ...
        PagedIterable<AutoUpgradeProfile> response = manager.autoUpgradeProfiles()
            .listByFleet("vfdnwnwmewzsyyce", "zsoibjudpfrxtr", com.azure.core.util.Context.NONE);

        Assertions.assertEquals("ytdw", response.iterator().next().updateStrategyId());
