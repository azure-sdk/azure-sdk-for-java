...
public final class AutoUpgradeProfilesListByFleetMockTests {
    ...
    public void testListByFleet() throws Exception {
        String responseStr
            = "{\"value\":[{\"properties\":{\"provisioningState\":\"Failed\",\"updateStrategyId\":\"lla\",\"channel\":\"Rapid\",\"nodeImageSelection\":{\"type\":\"Latest\"},\"disabled\":true},\"eTag\":\"piccjzkzivgv\",\"id\":\"nayrhyrnxxmueedn\",\"name\":\"rdvstkwqqtch\",\"type\":\"alm\"}]}";
        ...
        PagedIterable<AutoUpgradeProfile> response = manager.autoUpgradeProfiles()
            .listByFleet("oocrkvcikhnv", "amqgxqquezikyw", com.azure.core.util.Context.NONE);

        Assertions.assertEquals("lla", response.iterator().next().updateStrategyId());
