...
public final class FleetsListCredentialsWithResponseMockTests {
    ...
    public void testListCredentialsWithResponse() throws Exception {
        String responseStr
            = "{\"kubeconfigs\":[{\"name\":\"bnlankxmyskpb\"},{\"name\":\"btkcxywnytnrsyn\"},{\"name\":\"dybyxczfclhaa\"},{\"name\":\"abphlw\"}]}";
        ...
        FleetCredentialResults response = manager.fleets()
            .listCredentialsWithResponse("pnazzm", "jrunmpxtt", com.azure.core.util.Context.NONE)
            .getValue();
