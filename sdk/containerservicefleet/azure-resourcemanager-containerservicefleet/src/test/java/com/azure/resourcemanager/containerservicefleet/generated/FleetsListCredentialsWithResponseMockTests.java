...
public final class FleetsListCredentialsWithResponseMockTests {
    ...
    public void testListCredentialsWithResponse() throws Exception {
        String responseStr
            = "{\"kubeconfigs\":[{\"name\":\"fuzmuvpbtt\"},{\"name\":\"orppxebmnzbtb\"},{\"name\":\"glkfg\"},{\"name\":\"neuelfphsdyhtoz\"}]}";
        ...
        FleetCredentialResults response = manager.fleets()
            .listCredentialsWithResponse("tmuwlauwzi", "xbmp", com.azure.core.util.Context.NONE)
            .getValue();
