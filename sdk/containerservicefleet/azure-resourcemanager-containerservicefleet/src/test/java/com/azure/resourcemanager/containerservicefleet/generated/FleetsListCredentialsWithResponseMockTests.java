...
public final class FleetsListCredentialsWithResponseMockTests {
    ...
    public void testListCredentialsWithResponse() throws Exception {
        String responseStr
            = "{\"kubeconfigs\":[{\"name\":\"ogqxndlkzgxhuri\"},{\"name\":\"podxunkb\"},{\"name\":\"mubyynt\"},{\"name\":\"bqtkoievseotgqr\"}]}";
        ...
        FleetCredentialResults response = manager.fleets()
            .listCredentialsWithResponse("bdagxt", "bqdxbx", com.azure.core.util.Context.NONE)
            .getValue();
