...
public final class AutoUpgradeProfilesCreateOrUpdateMockTests {
    ...
    public void testCreateOrUpdate() throws Exception {
        String responseStr
            = "{\"properties\":{\"provisioningState\":\"Succeeded\",\"updateStrategyId\":\"tgseinqfiufxqkn\",\"channel\":\"Stable\",\"nodeImageSelection\":{\"type\":\"Consistent\"},\"disabled\":true},\"eTag\":\"ttwqmsni\",\"id\":\"cdm\",\"name\":\"nrojlpijnkr\",\"type\":\"frddhcrati\"}";
        ...
        AutoUpgradeProfile response = manager.autoUpgradeProfiles()
            .define("pelmcuvhixbjxyf")
            .withExistingFleet("dscwxqupevzhf", "totxhojujb")
            .withUpdateStrategyId("coolsttpkiwkkb")
            ...
            .withDisabled(true)
            .withIfMatch("umwctondz")
            .withIfNoneMatch("luudfdlwggytsb")
            .create();

        Assertions.assertEquals("tgseinqfiufxqkn", response.updateStrategyId());
