...
public final class AutoUpgradeProfilesCreateOrUpdateMockTests {
    ...
    public void testCreateOrUpdate() throws Exception {
        String responseStr
            = "{\"properties\":{\"provisioningState\":\"Succeeded\",\"updateStrategyId\":\"qytibyowbblgyavu\",\"channel\":\"Rapid\",\"nodeImageSelection\":{\"type\":\"Latest\"},\"disabled\":true},\"eTag\":\"oismsksbpimlqol\",\"id\":\"kcgxxlxsffgcvi\",\"name\":\"qzdwlvwlyoup\",\"type\":\"gfbkjubdyh\"}";
        ...
        AutoUpgradeProfile response = manager.autoUpgradeProfiles()
            .define("chvcyyysfgdo")
            .withExistingFleet("fomiloxgg", "ufiqndieuzaof")
            .withUpdateStrategyId("ip")
            ...
            .withDisabled(false)
            .withIfMatch("bywdxsmicc")
            .withIfNoneMatch("rwfscjfnynszquj")
            .create();

        Assertions.assertEquals("qytibyowbblgyavu", response.updateStrategyId());
