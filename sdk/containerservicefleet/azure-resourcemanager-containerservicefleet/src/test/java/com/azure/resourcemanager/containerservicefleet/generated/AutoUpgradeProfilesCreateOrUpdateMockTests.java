...
public final class AutoUpgradeProfilesCreateOrUpdateMockTests {
    ...
    public void testCreateOrUpdate() throws Exception {
        String responseStr
            = "{\"properties\":{\"provisioningState\":\"Succeeded\",\"updateStrategyId\":\"gsfraoyzkoow\",\"channel\":\"Rapid\",\"nodeImageSelection\":{\"type\":\"Consistent\"},\"disabled\":false},\"eTag\":\"aw\",\"id\":\"ldsyuuximerqfob\",\"name\":\"yznkby\",\"type\":\"utwpfhp\"}";
        ...
        AutoUpgradeProfile response = manager.autoUpgradeProfiles()
            .define("ftwwaezkojvdc")
            .withExistingFleet("jcntuj", "tcje")
            .withUpdateStrategyId("ouicybxarzgszu")
            ...
            .withDisabled(false)
            .withIfMatch("toego")
            .withIfNoneMatch("dwbwhkszzcmrvexz")
            .create();

        Assertions.assertEquals("gsfraoyzkoow", response.updateStrategyId());
