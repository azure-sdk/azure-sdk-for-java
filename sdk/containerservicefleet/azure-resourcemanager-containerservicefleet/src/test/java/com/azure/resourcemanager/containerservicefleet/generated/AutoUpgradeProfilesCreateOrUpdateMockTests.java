...
public final class AutoUpgradeProfilesCreateOrUpdateMockTests {
    ...
    public void testCreateOrUpdate() throws Exception {
        String responseStr
            = "{\"properties\":{\"provisioningState\":\"Succeeded\",\"updateStrategyId\":\"zuempsbzkf\",\"channel\":\"Rapid\",\"nodeImageSelection\":{\"type\":\"Consistent\"},\"disabled\":false},\"eTag\":\"qi\",\"id\":\"invkjjxdxrbuu\",\"name\":\"zclewyhmlw\",\"type\":\"aztz\"}";
        ...
        AutoUpgradeProfile response = manager.autoUpgradeProfiles()
            .define("tdooaoj")
            .withExistingFleet("tramxjez", "lwnwxuqlcvydyp")
            .withUpdateStrategyId("kooebwnu")
            ...
            .withDisabled(true)
            .withIfMatch("gaowpulpqblylsyx")
            .withIfNoneMatch("qjnsjervtia")
            .create();

        Assertions.assertEquals("zuempsbzkf", response.updateStrategyId());
