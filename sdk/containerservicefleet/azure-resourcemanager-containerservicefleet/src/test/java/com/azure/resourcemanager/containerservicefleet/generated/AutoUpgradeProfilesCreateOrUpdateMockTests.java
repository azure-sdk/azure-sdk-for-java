...
public final class AutoUpgradeProfilesCreateOrUpdateMockTests {
    ...
    public void testCreateOrUpdate() throws Exception {
        String responseStr
            = "{\"properties\":{\"provisioningState\":\"Succeeded\",\"updateStrategyId\":\"lddxbjhwua\",\"channel\":\"NodeImage\",\"nodeImageSelection\":{\"type\":\"Latest\"},\"disabled\":false},\"eTag\":\"ph\",\"id\":\"ulpjr\",\"name\":\"xagl\",\"type\":\"vimjwos\"}";
        ...
        AutoUpgradeProfile response = manager.autoUpgradeProfiles()
            .define("vgpiohgwxrt")
            .withExistingFleet("mtdaa", "gdv")
            .withUpdateStrategyId("pxgy")
            ...
            .withDisabled(true)
            .withIfMatch("kzikfjawneaivxwc")
            .withIfNoneMatch("elpcirelsfeaenwa")
            .create();

        Assertions.assertEquals("lddxbjhwua", response.updateStrategyId());
