...
public final class AutoUpgradeProfilesCreateOrUpdateMockTests {
    ...
    public void testCreateOrUpdate() throws Exception {
        String responseStr
            = "{\"properties\":{\"provisioningState\":\"Succeeded\",\"updateStrategyId\":\"cx\",\"channel\":\"Rapid\",\"nodeImageSelection\":{\"type\":\"Latest\"},\"disabled\":false},\"eTag\":\"fbshrnsvbuswd\",\"id\":\"yybyc\",\"name\":\"unvjsrtkfawnopq\",\"type\":\"ikyzirtxdy\"}";
        ...
        AutoUpgradeProfile response = manager.autoUpgradeProfiles()
            .define("gnepttwqmsni")
            .withExistingFleet("tsbwtovvtgse", "nqfiufxqknpi")
            .withUpdateStrategyId("qnrojlpijnkrxfrd")
            ...
            .withDisabled(true)
            .withIfMatch("h")
            .withIfNoneMatch("rghxjb")
            .create();

        Assertions.assertEquals("cx", response.updateStrategyId());
