...
public final class FleetMemberUpdatePropertiesTests {
    ...
    public void testDeserialize() throws Exception {
        FleetMemberUpdateProperties model
            = BinaryData.fromString("{\"group\":\"jzzvdud\"}").toObject(FleetMemberUpdateProperties.class);
        Assertions.assertEquals("jzzvdud", model.group());
    }

    @org.junit.jupiter.api.Test
    public void testSerialize() throws Exception {
        FleetMemberUpdateProperties model = new FleetMemberUpdateProperties().withGroup("jzzvdud");
