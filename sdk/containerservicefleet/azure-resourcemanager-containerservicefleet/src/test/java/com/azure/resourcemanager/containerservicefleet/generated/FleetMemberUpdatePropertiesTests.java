...
public final class FleetMemberUpdatePropertiesTests {
    ...
    public void testDeserialize() throws Exception {
        FleetMemberUpdateProperties model
            = BinaryData.fromString("{\"group\":\"naamde\",\"labels\":{\"rkgqhcjrefo\":\"hfiqscjeypvhe\"}}")
                .toObject(FleetMemberUpdateProperties.class);
        Assertions.assertEquals("naamde", model.group());
        Assertions.assertEquals("hfiqscjeypvhe", model.labels().get("rkgqhcjrefo"));
    }

    @org.junit.jupiter.api.Test
    public void testSerialize() throws Exception {
        FleetMemberUpdateProperties model
            = new FleetMemberUpdateProperties().withGroup("naamde").withLabels(mapOf("rkgqhcjrefo", "hfiqscjeypvhe"));
