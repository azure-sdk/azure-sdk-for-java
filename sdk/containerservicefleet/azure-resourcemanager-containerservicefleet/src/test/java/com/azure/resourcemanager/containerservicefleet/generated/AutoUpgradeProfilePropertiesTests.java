...
public final class AutoUpgradeProfilePropertiesTests {
    ...
    public void testDeserialize() throws Exception {
        AutoUpgradeProfileProperties model = BinaryData.fromString(
            "{\"provisioningState\":\"Failed\",\"updateStrategyId\":\"ourqhakau\",\"channel\":\"Rapid\",\"nodeImageSelection\":{\"type\":\"Consistent\"},\"disabled\":true}")
            .toObject(AutoUpgradeProfileProperties.class);
        Assertions.assertEquals("ourqhakau", model.updateStrategyId());
    ...
    public void testSerialize() throws Exception {
        AutoUpgradeProfileProperties model = new AutoUpgradeProfileProperties().withUpdateStrategyId("ourqhakau")
