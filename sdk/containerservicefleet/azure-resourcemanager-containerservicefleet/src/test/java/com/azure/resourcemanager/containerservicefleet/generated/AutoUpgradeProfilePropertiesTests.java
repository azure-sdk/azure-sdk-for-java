...
public final class AutoUpgradeProfilePropertiesTests {
    ...
    public void testDeserialize() throws Exception {
        AutoUpgradeProfileProperties model = BinaryData.fromString(
            "{\"provisioningState\":\"Canceled\",\"updateStrategyId\":\"xbniwdjs\",\"channel\":\"Rapid\",\"nodeImageSelection\":{\"type\":\"Latest\"},\"disabled\":false}")
            .toObject(AutoUpgradeProfileProperties.class);
        Assertions.assertEquals("xbniwdjs", model.updateStrategyId());
    ...
    public void testSerialize() throws Exception {
        AutoUpgradeProfileProperties model = new AutoUpgradeProfileProperties().withUpdateStrategyId("xbniwdjs")
