...
public final class AutoUpgradeProfilePropertiesTests {
    ...
    public void testDeserialize() throws Exception {
        AutoUpgradeProfileProperties model = BinaryData.fromString(
            "{\"provisioningState\":\"Succeeded\",\"updateStrategyId\":\"guvriuhprwmd\",\"channel\":\"Stable\",\"nodeImageSelection\":{\"type\":\"Latest\"},\"disabled\":true}")
            .toObject(AutoUpgradeProfileProperties.class);
        Assertions.assertEquals("guvriuhprwmd", model.updateStrategyId());
    ...
    public void testSerialize() throws Exception {
        AutoUpgradeProfileProperties model = new AutoUpgradeProfileProperties().withUpdateStrategyId("guvriuhprwmd")
