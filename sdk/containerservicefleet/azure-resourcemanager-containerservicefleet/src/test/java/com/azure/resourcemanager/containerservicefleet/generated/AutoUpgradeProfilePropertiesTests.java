...
public final class AutoUpgradeProfilePropertiesTests {
    ...
    public void testDeserialize() throws Exception {
        AutoUpgradeProfileProperties model = BinaryData.fromString(
            "{\"provisioningState\":\"Succeeded\",\"updateStrategyId\":\"kfssxqukkf\",\"channel\":\"Stable\",\"nodeImageSelection\":{\"type\":\"Latest\"},\"disabled\":true}")
            .toObject(AutoUpgradeProfileProperties.class);
        Assertions.assertEquals("kfssxqukkf", model.updateStrategyId());
    ...
    public void testSerialize() throws Exception {
        AutoUpgradeProfileProperties model = new AutoUpgradeProfileProperties().withUpdateStrategyId("kfssxqukkf")
