...
public final class AutoUpgradeProfilePropertiesTests {
    ...
    public void testDeserialize() throws Exception {
        AutoUpgradeProfileProperties model = BinaryData.fromString(
            "{\"provisioningState\":\"Canceled\",\"updateStrategyId\":\"ukgjnpiucgygevq\",\"channel\":\"NodeImage\",\"nodeImageSelection\":{\"type\":\"Latest\"},\"disabled\":true}")
            .toObject(AutoUpgradeProfileProperties.class);
        Assertions.assertEquals("ukgjnpiucgygevq", model.updateStrategyId());
    ...
    public void testSerialize() throws Exception {
        AutoUpgradeProfileProperties model = new AutoUpgradeProfileProperties().withUpdateStrategyId("ukgjnpiucgygevq")
