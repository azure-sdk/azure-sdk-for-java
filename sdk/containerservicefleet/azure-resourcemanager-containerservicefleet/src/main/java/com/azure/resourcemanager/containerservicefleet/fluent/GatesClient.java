...
public interface GatesClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    GateInner update(String resourceGroupName, String fleetName, String gateName, GateInner properties);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    GateInner update(String resourceGroupName, String fleetName, String gateName, GateInner properties, String ifMatch,
