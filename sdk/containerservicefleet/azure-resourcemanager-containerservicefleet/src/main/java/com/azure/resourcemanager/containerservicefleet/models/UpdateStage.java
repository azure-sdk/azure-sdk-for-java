...
public final class UpdateStage implements JsonSerializable<UpdateStage> {
    ...
    /*
     * A list of Gates that will be created before this Stage is updated.
     */
    private List<GateConfiguration> beforeGates;

    /*
     * A list of Gates that will be created after this Stage is updated.
     */
    ...
    /**
     * Get the beforeGates property: A list of Gates that will be created before this Stage is updated.
     * 
    ...
    /**
     * Set the beforeGates property: A list of Gates that will be created before this Stage is updated.
     * 
    ...
    /**
     * Get the afterGates property: A list of Gates that will be created after this Stage is updated.
     * 
    ...
    /**
     * Set the afterGates property: A list of Gates that will be created after this Stage is updated.
     * 
