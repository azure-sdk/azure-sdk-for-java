 ...
 */
@Fluent
public final class GateInner extends Resource {
    /*
     ...
     */
    @Override
    public GateInner withLocation(String location) {
     ...
     */
    @Override
    public GateInner withTags(Map<String, String> tags) {
        super.withTags(tags);
        return this;
    }
     ...
     * @return the GateInner object itself.
     */
    public GateInner withDisplayName(String displayName) {
        if (this.innerProperties() == null) {
            this.innerProperties = new GateProperties();
        }
     ...
     * @return the GateInner object itself.
     */
    public GateInner withGateType(GateType gateType) {
        if (this.innerProperties() == null) {
            this.innerProperties = new GateProperties();
        }
        this.innerProperties().withGateType(gateType);
        return this;
    }
     ...
     * @return the GateInner object itself.
     */
    public GateInner withTarget(GateTarget target) {
        if (this.innerProperties() == null) {
            this.innerProperties = new GateProperties();
        }
     ...
     * @return the GateInner object itself.
     */
    public GateInner withState(GateState state) {
        if (this.innerProperties() == null) {
            this.innerProperties = new GateProperties();
        }
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("id".equals(fieldName)) {
                    ...
                    deserializedGateInner.withLocation(reader.getString());
                } else if ("tags".equals(fieldName)) {
                    Map<String, String> tags = reader.readMap(reader1 -> reader1.getString());
                    deserializedGateInner.withTags(tags);
