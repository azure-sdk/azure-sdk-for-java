...
public final class GateTarget implements JsonSerializable<GateTarget> {
    ...
    /**
     * Set the updateRunProperties property: The properties of the Update Run that the Gate is targeting.
     * 
     * @param updateRunProperties the updateRunProperties value to set.
     * @return the GateTarget object itself.
     */
    public GateTarget withUpdateRunProperties(UpdateRunGateTargetProperties updateRunProperties) {
        this.updateRunProperties = updateRunProperties;
        return this;
    }
