...
public final class AutoUpgradeProfileImpl
    ...
    public AutoUpgradeProfile create() {
        this.innerObject = serviceManager.serviceClient().getAutoUpgradeProfiles().createOrUpdate(resourceGroupName,
            fleetName, autoUpgradeProfileName, this.innerModel(), createIfMatch, createIfNoneMatch, Context.NONE);
        return this;
    }

    public AutoUpgradeProfile create(Context context) {
        this.innerObject = serviceManager.serviceClient().getAutoUpgradeProfiles().createOrUpdate(resourceGroupName,
            fleetName, autoUpgradeProfileName, this.innerModel(), createIfMatch, createIfNoneMatch, context);
        return this;
    }
    ...
    public AutoUpgradeProfile apply() {
        this.innerObject = serviceManager.serviceClient().getAutoUpgradeProfiles().createOrUpdate(resourceGroupName,
            fleetName, autoUpgradeProfileName, this.innerModel(), updateIfMatch, updateIfNoneMatch, Context.NONE);
        return this;
    }

    public AutoUpgradeProfile apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getAutoUpgradeProfiles().createOrUpdate(resourceGroupName,
            fleetName, autoUpgradeProfileName, this.innerModel(), updateIfMatch, updateIfNoneMatch, context);
        return this;
    }
    ...
    public AutoUpgradeProfile refresh() {
        this.innerObject = serviceManager.serviceClient().getAutoUpgradeProfiles()
            .getWithResponse(resourceGroupName, fleetName, autoUpgradeProfileName, Context.NONE).getValue();
        return this;
    }

    public AutoUpgradeProfile refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getAutoUpgradeProfiles()
            .getWithResponse(resourceGroupName, fleetName, autoUpgradeProfileName, context).getValue();
        return this;
    }
    ...
    public AutoUpgradeProfileImpl withNodeImageSelection(NodeImageSelection nodeImageSelection) {
