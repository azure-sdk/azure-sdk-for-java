...
public interface FleetMembersClient {
    ...
    PagedIterable<FleetMemberInner> listByParent(String resourceGroupName, String fleetName);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<FleetMemberInner> listByParent(String resourceGroupName, String fleetName, Context context);
