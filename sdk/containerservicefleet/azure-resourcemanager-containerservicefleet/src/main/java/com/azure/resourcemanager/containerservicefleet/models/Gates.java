...
public interface Gates {
     ...
     */
    Gate update(String resourceGroupName, String fleetName, String gateName, GateInner properties);
     ...
     * @return a Gate controls the progression during a staged rollout, e.g.
     */
    Gate update(String resourceGroupName, String fleetName, String gateName, GateInner properties, String ifMatch,
