...
public final class GateProperties implements JsonSerializable<GateProperties> {
     ...
     * @return the GateProperties object itself.
     */
    public GateProperties withDisplayName(String displayName) {
    ...
    /**
     * Set the target property: The target that the Gate is controlling, e.g. an Update Run.
     * 
     * @param target the target value to set.
     * @return the GateProperties object itself.
     */
    public GateProperties withTarget(GateTarget target) {
        this.target = target;
        return this;
    }
    ...
    /**
     * Set the gateType property: The type of the Gate determines how it is completed.
     * 
     * @param gateType the gateType value to set.
     * @return the GateProperties object itself.
     */
    public GateProperties withGateType(GateType gateType) {
    ...
    /**
     * Set the status property: The status of the Gate.
     * 
     * @param status the status value to set.
     * @return the GateProperties object itself.
     */
    public GateProperties withStatus(GateState status) {
        this.status = status;
        return this;
    }
    ...
    public void validate() {
        if (displayName() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Missing required property displayName in model GateProperties"));
        }
        if (target() == null) {
            throw LOGGER.atError()
        ...
        if (status() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Missing required property status in model GateProperties"));
        }
    }
    ...
    public static GateProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                } else if ("gateType".equals(fieldName)) {
                    deserializedGateProperties.gateType = GateType.fromString(reader.getString());
                } else if ("status".equals(fieldName)) {
                    deserializedGateProperties.status = GateState.fromString(reader.getString());
