...
public final class GatesClientImpl implements GatesClient {
    ...
    public interface GatesService {
        ...
        @Get("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerService/fleets/{fleetName}/gate/{gateName}")
        ...
        @Patch("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerService/fleets/{fleetName}/gate/{gateName}")
        ...
        Mono<Response<Flux<ByteBuffer>>> update(@HostParam("endpoint") String endpoint,
            ...
            @HeaderParam("Accept") String accept, @BodyParam("application/json") GateInner properties, Context context);

        @Headers({ "Content-Type: application/json" })
        @Get("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerService/fleets/{fleetName}/gate")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
    ...
    private Mono<Response<Flux<ByteBuffer>>> updateWithResponseAsync(String resourceGroupName, String fleetName,
        String gateName, GateInner properties, String ifMatch, String ifNoneMatch) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> updateWithResponseAsync(String resourceGroupName, String fleetName,
        String gateName, GateInner properties, String ifMatch, String ifNoneMatch, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<GateInner>, GateInner> beginUpdateAsync(String resourceGroupName, String fleetName,
        String gateName, GateInner properties) {
    ...
    private Mono<GateInner> updateAsync(String resourceGroupName, String fleetName, String gateName,
        GateInner properties, String ifMatch, String ifNoneMatch) {
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<GateInner> updateAsync(String resourceGroupName, String fleetName, String gateName,
        GateInner properties, String ifMatch, String ifNoneMatch, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public GateInner update(String resourceGroupName, String fleetName, String gateName, GateInner properties) {
        final String ifMatch = null;
        final String ifNoneMatch = null;
