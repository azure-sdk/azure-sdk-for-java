...
public final class UpdateRunGateTargetProperties implements JsonSerializable<UpdateRunGateTargetProperties> {
    ...
    /**
     * Set the timing property: Whether the Gate is placed before or after the update itself.
     * 
     * @param timing the timing value to set.
     * @return the UpdateRunGateTargetProperties object itself.
     */
    public UpdateRunGateTargetProperties withTiming(Timing timing) {
        this.timing = timing;
        return this;
    }
