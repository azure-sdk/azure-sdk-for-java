...
public final class UpdateGroupStatus implements JsonSerializable<UpdateGroupStatus> {
     ...
     */
    private List<UpdateGateStatus> beforeGates;

    /*
     * The list of Gates that will run after this UpdateGroup.
     */
    private List<UpdateGateStatus> afterGates;
     ...
     */
    public List<UpdateGateStatus> beforeGates() {
     ...
     */
    public List<UpdateGateStatus> afterGates() {
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("status".equals(fieldName)) {
                    ...
                    List<UpdateGateStatus> beforeGates
                        = reader.readArray(reader1 -> UpdateGateStatus.fromJson(reader1));
                    deserializedUpdateGroupStatus.beforeGates = beforeGates;
                } else if ("afterGates".equals(fieldName)) {
                    List<UpdateGateStatus> afterGates = reader.readArray(reader1 -> UpdateGateStatus.fromJson(reader1));
