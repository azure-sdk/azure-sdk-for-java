...
public final class UpdateRunsSkipSamples {
    ...
    public static void skipsOneOrMoreMemberGroupStageAfterStageWaitSOfAnUpdateRun(com.azure.resourcemanager.containerservicefleet.ContainerServiceFleetManager manager) {
        manager.updateRuns().skipWithResponse("rg1", "fleet1", "run1", new SkipProperties().withTargets(Arrays.asList(new SkipTarget().withType(TargetType.MEMBER).withName("member-one"), new SkipTarget().withType(TargetType.AFTER_STAGE_WAIT).withName("stage1"))), null, com.azure.core.util.Context.NONE);
    }
}
```
