...
public final class MonitoredSubscriptionsImpl implements MonitoredSubscriptions {
    ...
    public Response<MonitoredSubscriptionProperties> listWithResponse(String resourceGroupName, String monitorName,
        Context context) {
    ...
    public MonitoredSubscriptionProperties list(String resourceGroupName, String monitorName) {
        MonitoredSubscriptionPropertiesInner inner = this.serviceClient().list(resourceGroupName, monitorName);
        if (inner != null) {
