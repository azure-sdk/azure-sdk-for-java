...
public interface MonitoredSubscriptionsClient {
    ...
    Response<MonitoredSubscriptionPropertiesInner> listWithResponse(String resourceGroupName, String monitorName,
        Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    MonitoredSubscriptionPropertiesInner list(String resourceGroupName, String monitorName);
