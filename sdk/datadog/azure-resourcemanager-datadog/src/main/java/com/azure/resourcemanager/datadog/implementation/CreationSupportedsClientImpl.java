...
public final class CreationSupportedsClientImpl implements CreationSupportedsClient {
    ...
    public interface CreationSupportedsService {
        ...
        Mono<Response<CreateResourceSupportedResponseInner>> list(@HostParam("$host") String endpoint,
    ...
    private Mono<Response<CreateResourceSupportedResponseInner>> listWithResponseAsync(String datadogOrganizationId) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<CreateResourceSupportedResponseInner> listAsync(String datadogOrganizationId) {
        return listWithResponseAsync(datadogOrganizationId).flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<CreateResourceSupportedResponseInner> listWithResponse(String datadogOrganizationId,
        Context context) {
        return listWithResponseAsync(datadogOrganizationId, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public CreateResourceSupportedResponseInner list(String datadogOrganizationId) {
        return listWithResponse(datadogOrganizationId, Context.NONE).getValue();
    }
