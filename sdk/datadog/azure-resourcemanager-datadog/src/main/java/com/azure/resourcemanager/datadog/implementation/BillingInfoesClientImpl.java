...
public final class BillingInfoesClientImpl implements BillingInfoesClient {
     ...
     */
    BillingInfoesClientImpl(MicrosoftDatadogClientImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for MicrosoftDatadogClientBillingInfoes to be used by the proxy service
    ...
    public interface BillingInfoesService {
        ...
        @Post("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Datadog/monitors/{monitorName}/getBillingInfo")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<BillingInfoResponseInner>> get(@HostParam("$host") String endpoint,
    ...
    private Mono<Response<BillingInfoResponseInner>> getWithResponseAsync(String resourceGroupName,
        String monitorName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<BillingInfoResponseInner>> getWithResponseAsync(String resourceGroupName, String monitorName,
        Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<BillingInfoResponseInner> getAsync(String resourceGroupName, String monitorName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<BillingInfoResponseInner> getWithResponse(String resourceGroupName, String monitorName,
        Context context) {
