...
public final class PrivateAccessesImpl implements PrivateAccesses {
    ...
    public Response<Void> deleteByResourceGroupWithResponse(String resourceGroupName, String privateAccessName,
        Context context) {
    ...
    public PagedIterable<PrivateLinkResource> getPrivateLinkResources(String resourceGroupName,
    ...
    public PagedIterable<PrivateLinkResource> getPrivateLinkResources(String resourceGroupName,
        ...
        PagedIterable<PrivateLinkResourceInner> inner
            = this.serviceClient().getPrivateLinkResources(resourceGroupName, privateAccessName, context);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new PrivateLinkResourceImpl(inner1, this.manager()));
    }
    ...
    public void deleteAPrivateEndpointConnection(String resourceGroupName, String privateAccessName,
        String privateEndpointConnectionName) {
        this.serviceClient().deleteAPrivateEndpointConnection(resourceGroupName, privateAccessName,
