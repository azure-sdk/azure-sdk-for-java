...
public final class Selector {
    ...
    /*
     * Model that represents available filters that can be applied to a targets list.
     */
    ...
    /**
     * Get the filters property: Model that represents available filters that can be applied to a targets list.
     *
    ...
    /**
     * Set the filters property: Model that represents available filters that can be applied to a targets list.
     *
     * @param filters the filters value to set.
     * @return the Selector object itself.
     */
    public Selector withFilters(Filters filters) {
    ...
    public void validate() {
        ...
        if (filters() == null) {
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException("Missing required property filters in model Selector"));
        } else {
            filters().validate();
        }
    }
