...
public interface CapabilityType {
    ...
    /**
     * Gets the permissionsNecessary property: Array of control and data plane actions necessary to execute capability
     * type.
     *
     * @return the permissionsNecessary value.
     */
    CapabilityTypePropertiesPermissionsNecessary permissionsNecessary();
