...
public final class TargetsClientImpl implements TargetsClient {
    ...
    private interface TargetsService {
        @Headers({"Content-Type: application/json"})
        @Get(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/{parentProviderNamespace}"
                + "/{parentResourceType}/{parentResourceName}/providers/Microsoft.Chaos/targets")
    ...
    public TargetInner get(
        ...
        String parentResourceName,
        String targetName) {
        return getAsync(resourceGroupName, parentProviderNamespace, parentResourceType, parentResourceName, targetName)
            .block();
    }
    ...
    public void delete(
        ...
        String parentResourceName,
        String targetName) {
        deleteAsync(resourceGroupName, parentProviderNamespace, parentResourceType, parentResourceName, targetName)
            .block();
    }
