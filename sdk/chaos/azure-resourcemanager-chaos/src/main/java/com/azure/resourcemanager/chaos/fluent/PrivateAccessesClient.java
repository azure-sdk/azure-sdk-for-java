...
public interface PrivateAccessesClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    PrivateAccessInner update(String resourceGroupName, String privateAccessName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    PrivateAccessInner update(String resourceGroupName, String privateAccessName, PrivateAccessPatch privateAccessPatch,
        Context context);
