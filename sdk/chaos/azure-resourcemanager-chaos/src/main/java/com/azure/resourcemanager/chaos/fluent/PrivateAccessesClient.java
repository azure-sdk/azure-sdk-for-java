...
public interface PrivateAccessesClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<PrivateAccessInner> updateWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    PrivateAccessInner update(String resourceGroupName, String privateAccessName, PrivateAccessUpdate parameters);
