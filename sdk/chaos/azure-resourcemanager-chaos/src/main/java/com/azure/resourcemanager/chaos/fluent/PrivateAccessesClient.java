...
public interface PrivateAccessesClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<PrivateAccessInner> listByResourceGroup(
    ...
    Response<PrivateAccessInner> getByResourceGroupWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<PrivateAccessInner> createOrUpdateWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    PrivateAccessInner createOrUpdate(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<Void> deleteWithResponse(String resourceGroupName, String privateAccessName, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<PrivateLinkResourceInner> getPrivateLinkResources(
        String resourceGroupName, String privateAccessName, Context context);
