...
import com.azure.resourcemanager.chaos.models.CapabilityTypePropertiesPermissionsNecessary;
...
public final class CapabilityTypeProperties {
     ...
     */
    @JsonProperty(value = "permissionsNecessary", access = JsonProperty.Access.WRITE_ONLY)
    private CapabilityTypePropertiesPermissionsNecessary permissionsNecessary;
    ...
    /**
     * Get the permissionsNecessary property: Array of control and data plane actions necessary to execute capability
     * type.
     *
     * @return the permissionsNecessary value.
     */
    public CapabilityTypePropertiesPermissionsNecessary permissionsNecessary() {
        return this.permissionsNecessary;
    }
    ...
    public void validate() {
        if (permissionsNecessary() != null) {
            permissionsNecessary().validate();
        }
