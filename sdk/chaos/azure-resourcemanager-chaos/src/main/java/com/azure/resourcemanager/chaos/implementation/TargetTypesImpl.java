...
public final class TargetTypesImpl implements TargetTypes {
    ...
    public PagedIterable<TargetType> listByLocation(String location) {
        PagedIterable<TargetTypeInner> inner = this.serviceClient().listByLocation(location);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new TargetTypeImpl(inner1, this.manager()));
    }

    public PagedIterable<TargetType> listByLocation(String location, String continuationToken, Context context) {
        PagedIterable<TargetTypeInner> inner
            = this.serviceClient().listByLocation(location, continuationToken, context);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new TargetTypeImpl(inner1, this.manager()));
    }
