...
public interface ExperimentsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<ExperimentStartOperationResultInner>, ExperimentStartOperationResultInner> beginStart(
        String resourceGroupName, String experimentName);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ExperimentStartOperationResultInner start(String resourceGroupName, String experimentName, Context context);
