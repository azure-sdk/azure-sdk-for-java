...
public final class PrivateAccessImpl implements PrivateAccess, PrivateAccess.Definition, PrivateAccess.Update {
    ...
    public PrivateAccess apply() {
        this.innerObject = serviceManager.serviceClient()
            .getPrivateAccesses()
            .patch(resourceGroupName, privateAccessName, updatePrivateAccessPatch, Context.NONE);
        return this;
    }
    ...
    public PrivateAccess apply(Context context) {
        this.innerObject = serviceManager.serviceClient()
            .getPrivateAccesses()
            .patch(resourceGroupName, privateAccessName, updatePrivateAccessPatch, context);
        return this;
    }
