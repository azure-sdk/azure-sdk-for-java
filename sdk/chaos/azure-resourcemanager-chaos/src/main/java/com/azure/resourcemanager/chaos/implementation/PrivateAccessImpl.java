...
public final class PrivateAccessImpl implements PrivateAccess, PrivateAccess.Definition, PrivateAccess.Update {
    ...
    private PrivateAccessPatch updatePrivateAccessPatch;
    ...
    public PrivateAccess create() {
        this.innerObject = serviceManager.serviceClient().getPrivateAccesses().createOrUpdate(resourceGroupName,
            privateAccessName, this.innerModel(), Context.NONE);
        return this;
    }

    public PrivateAccess create(Context context) {
        this.innerObject = serviceManager.serviceClient().getPrivateAccesses().createOrUpdate(resourceGroupName,
            privateAccessName, this.innerModel(), context);
        return this;
    }
    ...
    public PrivateAccessImpl update() {
        this.updatePrivateAccessPatch = new PrivateAccessPatch();
        return this;
    }

    public PrivateAccess apply() {
        this.innerObject = serviceManager.serviceClient().getPrivateAccesses().patch(resourceGroupName,
            privateAccessName, updatePrivateAccessPatch, Context.NONE);
        return this;
    }

    public PrivateAccess apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getPrivateAccesses().patch(resourceGroupName,
            privateAccessName, updatePrivateAccessPatch, context);
        return this;
    }
    ...
    public PrivateAccessImpl withTags(Map<String, String> tags) {
        if (isInCreateMode()) {
            ...
            this.updatePrivateAccessPatch.withTags(tags);
            return this;
        }
    }
