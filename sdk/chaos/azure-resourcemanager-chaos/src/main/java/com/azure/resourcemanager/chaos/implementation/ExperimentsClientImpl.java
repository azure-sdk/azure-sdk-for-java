...
public final class ExperimentsClientImpl implements ExperimentsClient {
    ...
    private Mono<Response<ExperimentExecutionInner>> getExecutionWithResponseAsync(
        String resourceGroupName, String experimentName, String executionId, String expand) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ExperimentExecutionInner>> getExecutionWithResponseAsync(
        String resourceGroupName, String experimentName, String executionId, String expand, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    private Mono<ExperimentExecutionInner> getExecutionAsync(
        ...
        return getExecutionWithResponseAsync(resourceGroupName, experimentName, executionId, expand)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
    ...
    public Response<ExperimentExecutionInner> getExecutionWithResponse(
        String resourceGroupName, String experimentName, String executionId, String expand, Context context) {
        return getExecutionWithResponseAsync(resourceGroupName, experimentName, executionId, expand, context).block();
    }
    ...
    public ExperimentExecutionInner getExecution(String resourceGroupName, String experimentName, String executionId) {
        final String expand = null;
        return getExecutionWithResponse(resourceGroupName, experimentName, executionId, expand, Context.NONE)
            .getValue();
    }
