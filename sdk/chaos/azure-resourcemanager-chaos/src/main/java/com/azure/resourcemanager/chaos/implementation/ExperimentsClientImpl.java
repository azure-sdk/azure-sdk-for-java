...
public final class ExperimentsClientImpl implements ExperimentsClient {
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the {@link PollerFlux} for polling of model that represents the result of a start Experiment operation.
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<ExperimentStartOperationResultInner>, ExperimentStartOperationResultInner>
        ...
        return this
            .client
            .<ExperimentStartOperationResultInner, ExperimentStartOperationResultInner>getLroResult(
                mono,
                this.client.getHttpPipeline(),
                ExperimentStartOperationResultInner.class,
                ExperimentStartOperationResultInner.class,
                this.client.getContext());
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the {@link SyncPoller} for polling of model that represents the result of a start Experiment operation.
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<ExperimentStartOperationResultInner>, ExperimentStartOperationResultInner> beginStart(
        String resourceGroupName, String experimentName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ExperimentStartOperationResultInner> startAsync(
        String resourceGroupName, String experimentName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ExperimentStartOperationResultInner start(String resourceGroupName, String experimentName, Context context) {
