...
public final class ChaosManagementClientImpl implements ChaosManagementClient {
    ...
    /**
     * The OperationStatusesOperationsClient object to access its operations.
     */
    private final OperationStatusesOperationsClient operationStatusesOperations;
     ...
     */
    public OperationStatusesOperationsClient getOperationStatusesOperations() {
        return this.operationStatusesOperations;
    }
    ...
    /**
     * The ExperimentExecutionsClient object to access its operations.
     */
    private final ExperimentExecutionsClient experimentExecutions;
     ...
     */
    public ExperimentExecutionsClient getExperimentExecutions() {
        return this.experimentExecutions;
    }
    ...
    ChaosManagementClientImpl(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter,
        ...
        this.operationStatusesOperations = new OperationStatusesOperationsClientImpl(this);
        this.targetTypes = new TargetTypesClientImpl(this);
        this.capabilityTypes = new CapabilityTypesClientImpl(this);
        this.experimentExecutions = new ExperimentExecutionsClientImpl(this);
    }
