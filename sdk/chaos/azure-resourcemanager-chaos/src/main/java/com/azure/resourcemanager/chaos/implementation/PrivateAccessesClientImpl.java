...
public final class PrivateAccessesClientImpl implements PrivateAccessesClient {
    ...
    private PollerFlux<PollResult<PrivateAccessInner>, PrivateAccessInner> beginUpdateAsync(String resourceGroupName,
        ...
        Mono<Response<Flux<ByteBuffer>>> mono
            = updateWithResponseAsync(resourceGroupName, privateAccessName, privateAccessPatch);
        return this.client.<PrivateAccessInner, PrivateAccessInner>getLroResult(mono, this.client.getHttpPipeline(),
            PrivateAccessInner.class, PrivateAccessInner.class, this.client.getContext());
    }
    ...
    private PollerFlux<PollResult<PrivateAccessInner>, PrivateAccessInner> beginUpdateAsync(String resourceGroupName,
        ...
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono
            = updateWithResponseAsync(resourceGroupName, privateAccessName, privateAccessPatch, context);
        return this.client.<PrivateAccessInner, PrivateAccessInner>getLroResult(mono, this.client.getHttpPipeline(),
            PrivateAccessInner.class, PrivateAccessInner.class, context);
    }
    ...
    public SyncPoller<PollResult<PrivateAccessInner>, PrivateAccessInner> beginUpdate(String resourceGroupName,
        String privateAccessName, PrivateAccessPatch privateAccessPatch) {
        return this.beginUpdateAsync(resourceGroupName, privateAccessName, privateAccessPatch).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<PrivateAccessInner>, PrivateAccessInner> beginUpdate(String resourceGroupName,
        String privateAccessName, PrivateAccessPatch privateAccessPatch, Context context) {
        return this.beginUpdateAsync(resourceGroupName, privateAccessName, privateAccessPatch, context).getSyncPoller();
    }
    ...
    private Mono<PrivateAccessInner> updateAsync(String resourceGroupName, String privateAccessName,
        PrivateAccessPatch privateAccessPatch) {
        return beginUpdateAsync(resourceGroupName, privateAccessName, privateAccessPatch).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<PrivateAccessInner> updateAsync(String resourceGroupName, String privateAccessName,
        PrivateAccessPatch privateAccessPatch, Context context) {
        return beginUpdateAsync(resourceGroupName, privateAccessName, privateAccessPatch, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    public PrivateAccessInner update(String resourceGroupName, String privateAccessName,
        PrivateAccessPatch privateAccessPatch) {
        return updateAsync(resourceGroupName, privateAccessName, privateAccessPatch).block();
    }
    ...
    public PrivateAccessInner update(String resourceGroupName, String privateAccessName,
        PrivateAccessPatch privateAccessPatch, Context context) {
        return updateAsync(resourceGroupName, privateAccessName, privateAccessPatch, context).block();
    }
