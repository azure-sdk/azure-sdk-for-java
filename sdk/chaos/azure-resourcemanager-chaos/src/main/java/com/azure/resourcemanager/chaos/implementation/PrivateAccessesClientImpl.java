...
public final class PrivateAccessesClientImpl implements PrivateAccessesClient {
    ...
    public interface PrivateAccessesService {
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<PrivateLinkResourceListResult>> getPrivateLinkResources(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<PrivateLinkResourceInner>> getPrivateLinkResourcesSinglePageAsync(
        String resourceGroupName, String privateAccessName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the private link resources possible under private access resource as paginated response with {@link
     *     PagedFlux}.
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<PrivateLinkResourceInner> getPrivateLinkResourcesAsync(
        String resourceGroupName, String privateAccessName) {
        return new PagedFlux<>(
            () -> getPrivateLinkResourcesSinglePageAsync(resourceGroupName, privateAccessName),
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<PrivateLinkResourceInner> getPrivateLinkResources(
        String resourceGroupName, String privateAccessName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<PrivateLinkResourceInner>> getPrivateLinkResourcesNextSinglePageAsync(
        ...
        context = this.client.mergeContext(context);
        return service
            .getPrivateLinkResourcesNext(nextLink, this.client.getEndpoint(), accept, context)
            .map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(),
