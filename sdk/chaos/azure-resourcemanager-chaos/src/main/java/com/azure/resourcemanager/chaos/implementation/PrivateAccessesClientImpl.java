...
public final class PrivateAccessesClientImpl implements PrivateAccessesClient {
    ...
    public interface PrivateAccessesService {
        ...
        Mono<Response<Flux<ByteBuffer>>> createOrUpdate(@HostParam("$host") String endpoint,
            ...
            @BodyParam("application/json") PrivateAccessInner resource, @HeaderParam("Accept") String accept,
            Context context);
        ...
        Mono<Response<Flux<ByteBuffer>>> update(@HostParam("$host") String endpoint,
            ...
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("privateAccessName") String privateAccessName,
            @BodyParam("application/json") PrivateAccessPatch properties, @HeaderParam("Accept") String accept,
            Context context);
    ...
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(context -> service.createOrUpdate(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, privateAccessName, resource, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private PollerFlux<PollResult<PrivateAccessInner>, PrivateAccessInner> beginCreateOrUpdateAsync(
        String resourceGroupName, String privateAccessName, PrivateAccessInner resource, Context context) {
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono
            = createOrUpdateWithResponseAsync(resourceGroupName, privateAccessName, resource, context);
        return this.client.<PrivateAccessInner, PrivateAccessInner>getLroResult(mono, this.client.getHttpPipeline(),
    ...
    public SyncPoller<PollResult<PrivateAccessInner>, PrivateAccessInner> beginCreateOrUpdate(String resourceGroupName,
        String privateAccessName, PrivateAccessInner resource) {
        return this.beginCreateOrUpdateAsync(resourceGroupName, privateAccessName, resource).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<PrivateAccessInner>, PrivateAccessInner> beginCreateOrUpdate(String resourceGroupName,
        String privateAccessName, PrivateAccessInner resource, Context context) {
        return this.beginCreateOrUpdateAsync(resourceGroupName, privateAccessName, resource, context).getSyncPoller();
    }
    ...
    private Mono<PrivateAccessInner> createOrUpdateAsync(String resourceGroupName, String privateAccessName,
        ...
        return beginCreateOrUpdateAsync(resourceGroupName, privateAccessName, resource, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    public PrivateAccessInner createOrUpdate(String resourceGroupName, String privateAccessName,
        PrivateAccessInner resource) {
        return createOrUpdateAsync(resourceGroupName, privateAccessName, resource).block();
    }
    ...
    public PrivateAccessInner createOrUpdate(String resourceGroupName, String privateAccessName,
        PrivateAccessInner resource, Context context) {
        return createOrUpdateAsync(resourceGroupName, privateAccessName, resource, context).block();
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> updateWithResponseAsync(String resourceGroupName, String privateAccessName,
        ...
        return FluxUtil
            .withContext(context -> service.update(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, privateAccessName, properties, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> updateWithResponseAsync(String resourceGroupName, String privateAccessName,
        ...
        return service.update(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, privateAccessName, properties, accept, context);
    }
    ...
    private PollerFlux<PollResult<PrivateAccessInner>, PrivateAccessInner> beginUpdateAsync(String resourceGroupName,
        ...
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono
            = updateWithResponseAsync(resourceGroupName, privateAccessName, properties, context);
        return this.client.<PrivateAccessInner, PrivateAccessInner>getLroResult(mono, this.client.getHttpPipeline(),
            PrivateAccessInner.class, PrivateAccessInner.class, context);
    }
    ...
    public SyncPoller<PollResult<PrivateAccessInner>, PrivateAccessInner> beginUpdate(String resourceGroupName,
        String privateAccessName, PrivateAccessPatch properties) {
        return this.beginUpdateAsync(resourceGroupName, privateAccessName, properties).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<PrivateAccessInner>, PrivateAccessInner> beginUpdate(String resourceGroupName,
        String privateAccessName, PrivateAccessPatch properties, Context context) {
        return this.beginUpdateAsync(resourceGroupName, privateAccessName, properties, context).getSyncPoller();
    }
    ...
    private Mono<PrivateAccessInner> updateAsync(String resourceGroupName, String privateAccessName,
        PrivateAccessPatch properties, Context context) {
        return beginUpdateAsync(resourceGroupName, privateAccessName, properties, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    public PrivateAccessInner update(String resourceGroupName, String privateAccessName,
        PrivateAccessPatch properties) {
        return updateAsync(resourceGroupName, privateAccessName, properties).block();
    }
    ...
    public PrivateAccessInner update(String resourceGroupName, String privateAccessName, PrivateAccessPatch properties,
        Context context) {
        return updateAsync(resourceGroupName, privateAccessName, properties, context).block();
    }
