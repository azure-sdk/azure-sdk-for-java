...
public final class PrivateAccessesClientImpl implements PrivateAccessesClient {
    ...
    public interface PrivateAccessesService {
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<PrivateAccessInner>> createOrUpdate(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<PrivateAccessInner>> createOrUpdateWithResponseAsync(String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<PrivateAccessInner> createOrUpdateWithResponse(String resourceGroupName, String privateAccessName,
