...
public final class PrivateAccessesClientImpl implements PrivateAccessesClient {
    ...
    public interface PrivateAccessesService {
        ...
        Mono<Response<PrivateAccessListResult>> list(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<PrivateAccessListResult>> listByResourceGroup(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<PrivateAccessInner>> getByResourceGroup(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
        ...
        Mono<Response<Flux<ByteBuffer>>> createOrUpdate(@HostParam("$host") String endpoint,
            ...
            @BodyParam("application/json") PrivateAccessInner privateAccess, @HeaderParam("Accept") String accept,
            Context context);
        ...
        Mono<Response<Flux<ByteBuffer>>> patch(@HostParam("$host") String endpoint,
            ...
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("privateAccessName") String privateAccessName,
            @BodyParam("application/json") PrivateAccessPatch privateAccessPatch, @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<PrivateLinkResourceListResult>> getPrivateLinkResources(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("privateAccessName") String privateAccessName, @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<PrivateLinkResourceListResult>> getPrivateLinkResourcesNext(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    ...
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(context -> service.createOrUpdate(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, privateAccessName, privateAccess, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private PollerFlux<PollResult<PrivateAccessInner>, PrivateAccessInner>
        beginCreateOrUpdateAsync(String resourceGroupName, String privateAccessName, PrivateAccessInner privateAccess) {
        Mono<Response<Flux<ByteBuffer>>> mono
            = createOrUpdateWithResponseAsync(resourceGroupName, privateAccessName, privateAccess);
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<PrivateAccessInner>, PrivateAccessInner> beginCreateOrUpdateAsync(
        String resourceGroupName, String privateAccessName, PrivateAccessInner privateAccess, Context context) {
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono
            = createOrUpdateWithResponseAsync(resourceGroupName, privateAccessName, privateAccess, context);
        return this.client.<PrivateAccessInner, PrivateAccessInner>getLroResult(mono, this.client.getHttpPipeline(),
            PrivateAccessInner.class, PrivateAccessInner.class, context);
    }
    ...
    public SyncPoller<PollResult<PrivateAccessInner>, PrivateAccessInner> beginCreateOrUpdate(String resourceGroupName,
        String privateAccessName, PrivateAccessInner privateAccess) {
        return this.beginCreateOrUpdateAsync(resourceGroupName, privateAccessName, privateAccess).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<PrivateAccessInner>, PrivateAccessInner> beginCreateOrUpdate(String resourceGroupName,
        String privateAccessName, PrivateAccessInner privateAccess, Context context) {
        return this.beginCreateOrUpdateAsync(resourceGroupName, privateAccessName, privateAccess, context)
            .getSyncPoller();
    }
    ...
    private Mono<PrivateAccessInner> createOrUpdateAsync(String resourceGroupName, String privateAccessName,
        ...
        return beginCreateOrUpdateAsync(resourceGroupName, privateAccessName, privateAccess).last()
    ...
    private Mono<PrivateAccessInner> createOrUpdateAsync(String resourceGroupName, String privateAccessName,
        ...
        return beginCreateOrUpdateAsync(resourceGroupName, privateAccessName, privateAccess, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    public PrivateAccessInner createOrUpdate(String resourceGroupName, String privateAccessName,
        PrivateAccessInner privateAccess) {
        return createOrUpdateAsync(resourceGroupName, privateAccessName, privateAccess).block();
    }
    ...
    public PrivateAccessInner createOrUpdate(String resourceGroupName, String privateAccessName,
        PrivateAccessInner privateAccess, Context context) {
        return createOrUpdateAsync(resourceGroupName, privateAccessName, privateAccess, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> patchWithResponseAsync(String resourceGroupName, String privateAccessName,
        ...
        if (privateAccessPatch == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter privateAccessPatch is required and cannot be null."));
        } else {
            privateAccessPatch.validate();
        }
        final String accept = "application/json";
        return FluxUtil.withContext(context -> service.patch(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, privateAccessName, privateAccessPatch, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> patchWithResponseAsync(String resourceGroupName, String privateAccessName,
        PrivateAccessPatch privateAccessPatch, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service.patch(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, privateAccessName, privateAccessPatch, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<PrivateAccessInner>, PrivateAccessInner> beginPatchAsync(String resourceGroupName,
        String privateAccessName, PrivateAccessPatch privateAccessPatch) {
        Mono<Response<Flux<ByteBuffer>>> mono
            = patchWithResponseAsync(resourceGroupName, privateAccessName, privateAccessPatch);
        return this.client.<PrivateAccessInner, PrivateAccessInner>getLroResult(mono, this.client.getHttpPipeline(),
            PrivateAccessInner.class, PrivateAccessInner.class, this.client.getContext());
    }
    ...
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<PrivateAccessInner>, PrivateAccessInner> beginPatchAsync(String resourceGroupName,
        String privateAccessName, PrivateAccessPatch privateAccessPatch, Context context) {
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono
            = patchWithResponseAsync(resourceGroupName, privateAccessName, privateAccessPatch, context);
        return this.client.<PrivateAccessInner, PrivateAccessInner>getLroResult(mono, this.client.getHttpPipeline(),
            PrivateAccessInner.class, PrivateAccessInner.class, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<PrivateAccessInner>, PrivateAccessInner> beginPatch(String resourceGroupName,
        String privateAccessName, PrivateAccessPatch privateAccessPatch) {
        return this.beginPatchAsync(resourceGroupName, privateAccessName, privateAccessPatch).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<PrivateAccessInner>, PrivateAccessInner> beginPatch(String resourceGroupName,
        String privateAccessName, PrivateAccessPatch privateAccessPatch, Context context) {
        return this.beginPatchAsync(resourceGroupName, privateAccessName, privateAccessPatch, context).getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PrivateAccessInner> patchAsync(String resourceGroupName, String privateAccessName,
        PrivateAccessPatch privateAccessPatch) {
        return beginPatchAsync(resourceGroupName, privateAccessName, privateAccessPatch).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<PrivateAccessInner> patchAsync(String resourceGroupName, String privateAccessName,
        PrivateAccessPatch privateAccessPatch, Context context) {
        return beginPatchAsync(resourceGroupName, privateAccessName, privateAccessPatch, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public PrivateAccessInner patch(String resourceGroupName, String privateAccessName,
        PrivateAccessPatch privateAccessPatch) {
        return patchAsync(resourceGroupName, privateAccessName, privateAccessPatch).block();
    }
    ...
    public PrivateAccessInner patch(String resourceGroupName, String privateAccessName,
        PrivateAccessPatch privateAccessPatch, Context context) {
        return patchAsync(resourceGroupName, privateAccessName, privateAccessPatch, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> deleteWithResponseAsync(String resourceGroupName, String privateAccessName,
        Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        return service.delete(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, privateAccessName, accept, context);
    }
    ...
    private PollerFlux<PollResult<Void>, Void> beginDeleteAsync(String resourceGroupName, String privateAccessName,
        Context context) {
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono = deleteWithResponseAsync(resourceGroupName, privateAccessName, context);
        return this.client.<Void, Void>getLroResult(mono, this.client.getHttpPipeline(), Void.class, Void.class,
            context);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String privateAccessName) {
        return this.beginDeleteAsync(resourceGroupName, privateAccessName).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String privateAccessName,
        Context context) {
        return this.beginDeleteAsync(resourceGroupName, privateAccessName, context).getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> deleteAsync(String resourceGroupName, String privateAccessName, Context context) {
        return beginDeleteAsync(resourceGroupName, privateAccessName, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    public void delete(String resourceGroupName, String privateAccessName) {
        deleteAsync(resourceGroupName, privateAccessName).block();
    }
    ...
    public void delete(String resourceGroupName, String privateAccessName, Context context) {
        deleteAsync(resourceGroupName, privateAccessName, context).block();
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the private link resources possible under private access resource along with {@link PagedResponse} on
     * successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<PrivateLinkResourceInner>>
        getPrivateLinkResourcesSinglePageAsync(String resourceGroupName, String privateAccessName) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<PrivateLinkResourceInner>>
        getPrivateLinkResourcesSinglePageAsync(String resourceGroupName, String privateAccessName, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        context = this.client.mergeContext(context);
        return service
            .getPrivateLinkResources(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, privateAccessName, accept, context)
            .map(res -> new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(),
                res.getValue().value(), res.getValue().nextLink(), null));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<PrivateLinkResourceInner> getPrivateLinkResourcesAsync(String resourceGroupName,
        String privateAccessName) {
        return new PagedFlux<>(() -> getPrivateLinkResourcesSinglePageAsync(resourceGroupName, privateAccessName),
            nextLink -> getPrivateLinkResourcesNextSinglePageAsync(nextLink));
    }
    ...
    private PagedFlux<PrivateLinkResourceInner> getPrivateLinkResourcesAsync(String resourceGroupName,
        ...
        return new PagedFlux<>(
            () -> getPrivateLinkResourcesSinglePageAsync(resourceGroupName, privateAccessName, context),
            nextLink -> getPrivateLinkResourcesNextSinglePageAsync(nextLink, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<PrivateLinkResourceInner> getPrivateLinkResources(String resourceGroupName,
        String privateAccessName) {
        return new PagedIterable<>(getPrivateLinkResourcesAsync(resourceGroupName, privateAccessName));
    }
    ...
    public PagedIterable<PrivateLinkResourceInner> getPrivateLinkResources(String resourceGroupName,
        String privateAccessName, Context context) {
        return new PagedIterable<>(getPrivateLinkResourcesAsync(resourceGroupName, privateAccessName, context));
    }
    ...
    private Mono<Response<PrivateEndpointConnectionInner>> getAPrivateEndpointConnectionWithResponseAsync(
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.getAPrivateEndpointConnection(this.client.getEndpoint(), this.client.getApiVersion(),
    ...
    private Mono<Response<Flux<ByteBuffer>>> deleteAPrivateEndpointConnectionWithResponseAsync(String resourceGroupName,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.deleteAPrivateEndpointConnection(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, privateAccessName, privateEndpointConnectionName,
            accept, context);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDeleteAPrivateEndpointConnection(String resourceGroupName,
        String privateAccessName, String privateEndpointConnectionName) {
        return this.beginDeleteAPrivateEndpointConnectionAsync(resourceGroupName, privateAccessName,
    ...
    private Mono<PagedResponse<PrivateEndpointConnectionInner>> listPrivateEndpointConnectionsSinglePageAsync(
        ...
        context = this.client.mergeContext(context);
        return service
            .listPrivateEndpointConnections(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, privateAccessName, accept, context)
            .map(res -> new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(),
                res.getValue().value(), res.getValue().nextLink(), null));
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return model that represents a list of private access resources and a link for pagination along with
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<PrivateLinkResourceInner>> getPrivateLinkResourcesNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        if (this.client.getEndpoint() == null) {
        ...
        return FluxUtil
            .withContext(
                context -> service.getPrivateLinkResourcesNext(nextLink, this.client.getEndpoint(), accept, context))
            .<PagedResponse<PrivateLinkResourceInner>>map(res -> new PagedResponseBase<>(res.getRequest(),
                res.getStatusCode(), res.getHeaders(), res.getValue().value(), res.getValue().nextLink(), null))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<PagedResponse<PrivateLinkResourceInner>> getPrivateLinkResourcesNextSinglePageAsync(String nextLink,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.getPrivateLinkResourcesNext(nextLink, this.client.getEndpoint(), accept, context)
            .map(res -> new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(),
                res.getValue().value(), res.getValue().nextLink(), null));
    }
