...
public final class ExperimentsDeleteSamples {
    /*
     * x-ms-original-file: specification/chaos/resource-manager/Microsoft.Chaos/preview/2022-10-01-preview/examples/DeleteAExperiment.json
     */
    /**
    ...
    public static void deleteAExperimentInAResourceGroup(com.azure.resourcemanager.chaos.ChaosManager manager) {
        manager.experiments().deleteByResourceGroupWithResponse("exampleRG", "exampleExperiment", Context.NONE);
    }
}
```
