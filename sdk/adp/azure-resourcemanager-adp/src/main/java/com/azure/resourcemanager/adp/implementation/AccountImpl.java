...
public final class AccountImpl implements Account, Account.Definition, Account.Update {
    ...
    AccountImpl(String name, com.azure.resourcemanager.adp.AdpManager serviceManager) {
    ...
    AccountImpl(AccountInner innerObject, com.azure.resourcemanager.adp.AdpManager serviceManager) {
