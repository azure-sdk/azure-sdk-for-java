...
public interface DataPoolsClient {
    ...
    Response<DataPoolInner> getWithResponse(String resourceGroupName, String accountName, String dataPoolName,
        Context context);
    ...
    SyncPoller<PollResult<DataPoolInner>, DataPoolInner> beginUpdate(String resourceGroupName, String accountName,
        String dataPoolName);
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<DataPoolInner>, DataPoolInner> beginCreateOrUpdate(String resourceGroupName,
