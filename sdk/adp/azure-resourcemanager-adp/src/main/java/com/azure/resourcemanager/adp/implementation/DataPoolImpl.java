...
public final class DataPoolImpl implements DataPool, DataPool.Definition, DataPool.Update {
    ...
    public DataPool create() {
        this.innerObject = serviceManager.serviceClient().getDataPools().createOrUpdate(resourceGroupName, accountName,
            dataPoolName, this.innerModel(), Context.NONE);
        return this;
    }

    public DataPool create(Context context) {
        this.innerObject = serviceManager.serviceClient().getDataPools().createOrUpdate(resourceGroupName, accountName,
            dataPoolName, this.innerModel(), context);
        return this;
    }
    ...
    public DataPool apply() {
        this.innerObject = serviceManager.serviceClient().getDataPools().update(resourceGroupName, accountName,
            dataPoolName, updateParameters, Context.NONE);
        return this;
    }

    public DataPool apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getDataPools().update(resourceGroupName, accountName,
            dataPoolName, updateParameters, context);
        return this;
    }
    ...
    DataPoolImpl(DataPoolInner innerObject, com.azure.resourcemanager.adp.AdpManager serviceManager) {
        ...
        this.dataPoolName = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "dataPools");
    }

    public DataPool refresh() {
        this.innerObject = serviceManager.serviceClient().getDataPools()
            .getWithResponse(resourceGroupName, accountName, dataPoolName, Context.NONE).getValue();
        return this;
    }

    public DataPool refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getDataPools()
            .getWithResponse(resourceGroupName, accountName, dataPoolName, context).getValue();
        return this;
    }
