...
public final class AccountsImpl implements Accounts {
    ...
    public AccountsImpl(AccountsClient innerClient, com.azure.resourcemanager.adp.AdpManager serviceManager) {
    ...
    public CheckNameAvailabilityResult checkNameAvailability(AccountCheckNameAvailabilityParameters parameters) {
