...
public final class DataPoolsImpl implements DataPools {
    private static final ClientLogger LOGGER = new ClientLogger(DataPoolsImpl.class);

    private final DataPoolsClient innerClient;

    private final com.azure.resourcemanager.adp.AdpManager serviceManager;

    public DataPoolsImpl(DataPoolsClient innerClient, com.azure.resourcemanager.adp.AdpManager serviceManager) {
    ...
    public PagedIterable<DataPool> list(String resourceGroupName, String accountName) {
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new DataPoolImpl(inner1, this.manager()));
    }
    ...
    public Response<DataPool> getWithResponse(String resourceGroupName, String accountName, String dataPoolName,
        Context context) {
    ...
    public DataPool getById(String id) {
        ...
        String dataPoolName = ResourceManagerUtils.getValueFromIdByName(id, "dataPools");
