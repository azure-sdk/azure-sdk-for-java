...
public final class DataPoolPatch extends ProxyResource {
    ...
    /**
     * Creates an instance of DataPoolPatch class.
     */
    ...
    /**
     * Reads an instance of DataPoolPatch from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of DataPoolPatch if the JsonReader was pointing to an instance of it, or null if it was
     * pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the DataPoolPatch.
     */
    public static DataPoolPatch fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            DataPoolPatch deserializedDataPoolPatch = new DataPoolPatch();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("id".equals(fieldName)) {
                    deserializedDataPoolPatch.id = reader.getString();
                } else if ("name".equals(fieldName)) {
                    deserializedDataPoolPatch.name = reader.getString();
                } else if ("type".equals(fieldName)) {
                    deserializedDataPoolPatch.type = reader.getString();
                } else if ("properties".equals(fieldName)) {
                    deserializedDataPoolPatch.innerProperties = DataPoolBaseProperties.fromJson(reader);
                } else if ("systemData".equals(fieldName)) {
                    deserializedDataPoolPatch.systemData = SystemData.fromJson(reader);
                } else {
                    reader.skipChildren();
                }
            }

            return deserializedDataPoolPatch;
        });
    }
}
