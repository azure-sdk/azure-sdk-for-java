...
import com.azure.resourcemanager.engagementfabric.models.SkuDescriptionList;
...
public final class SKUsClientImpl implements SKUsClient {
     ...
     */
    SKUsClientImpl(EngagementFabricImpl client) {
        this.service = RestProxy.create(SKUsService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for EngagementFabricSKUs to be used by the proxy service to perform REST
     * calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "EngagementFabricSKUs")
