...
public final class ChannelsClientImpl implements ChannelsClient {
    ...
    public interface ChannelsService {
        ...
        Mono<Response<ChannelInner>> createOrUpdate(@HostParam("$host") String endpoint,
            ...
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("accountName") String accountName,
            @PathParam("channelName") String channelName, @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") ChannelInner channel, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ChannelList>> listByAccount(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("accountName") String accountName,
    ...
    private Mono<Response<ChannelInner>> getWithResponseAsync(String resourceGroupName, String accountName,
        String channelName) {
        ...
        return FluxUtil
            .withContext(context -> service.get(this.client.getEndpoint(), this.client.getSubscriptionId(),
                resourceGroupName, accountName, channelName, this.client.getApiVersion(), accept, context))
    ...
    private Mono<Response<ChannelInner>> getWithResponseAsync(String resourceGroupName, String accountName,
        ...
        return service.get(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName, accountName,
            channelName, this.client.getApiVersion(), accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ChannelInner> getWithResponse(String resourceGroupName, String accountName, String channelName,
        Context context) {
    ...
    public ChannelInner get(String resourceGroupName, String accountName, String channelName) {
        return getWithResponse(resourceGroupName, accountName, channelName, Context.NONE).getValue();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ChannelInner>> createOrUpdateWithResponseAsync(String resourceGroupName, String accountName,
        String channelName, ChannelInner channel) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return FluxUtil
            .withContext(context -> service.createOrUpdate(this.client.getEndpoint(), this.client.getSubscriptionId(),
                resourceGroupName, accountName, channelName, this.client.getApiVersion(), channel, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ChannelInner>> createOrUpdateWithResponseAsync(String resourceGroupName, String accountName,
        String channelName, ChannelInner channel, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service.createOrUpdate(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            accountName, channelName, this.client.getApiVersion(), channel, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ChannelInner> createOrUpdateAsync(String resourceGroupName, String accountName, String channelName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ChannelInner> createOrUpdateWithResponse(String resourceGroupName, String accountName,
        String channelName, ChannelInner channel, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ChannelInner createOrUpdate(String resourceGroupName, String accountName, String channelName,
        ChannelInner channel) {
        return createOrUpdateWithResponse(resourceGroupName, accountName, channelName, channel, Context.NONE)
            .getValue();
    }
    ...
    private Mono<Response<Void>> deleteWithResponseAsync(String resourceGroupName, String accountName,
        ...
        return service.delete(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            accountName, channelName, this.client.getApiVersion(), accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<Void> deleteWithResponse(String resourceGroupName, String accountName, String channelName,
        Context context) {
    ...
    public void delete(String resourceGroupName, String accountName, String channelName) {
        deleteWithResponse(resourceGroupName, accountName, channelName, Context.NONE);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<ChannelInner>> listByAccountSinglePageAsync(String resourceGroupName,
        String accountName) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<ChannelInner>> listByAccountSinglePageAsync(String resourceGroupName, String accountName,
        Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
