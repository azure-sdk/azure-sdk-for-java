...
public final class AccountsClientImpl implements AccountsClient {
    ...
    public interface AccountsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<AccountInner>> createOrUpdate(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("accountName") String accountName,
            @QueryParam("api-version") String apiVersion, @BodyParam("application/json") AccountInner account,
        ...
        Mono<Response<AccountInner>> update(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("accountName") String accountName,
            @QueryParam("api-version") String apiVersion, @BodyParam("application/json") AccountPatch accountPatch,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<AccountList>> list(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<AccountList>> listByResourceGroup(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<KeyDescriptionList>> listKeys(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("accountName") String accountName,
            @QueryParam("api-version") String apiVersion, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<KeyDescriptionInner>> regenerateKey(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("accountName") String accountName,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") RegenerateKeyParameter parameter, @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ChannelTypeDescriptionListInner>> listChannelTypes(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("accountName") String accountName,
            @QueryParam("api-version") String apiVersion, @HeaderParam("Accept") String accept, Context context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<AccountInner>> createOrUpdateWithResponseAsync(String resourceGroupName, String accountName,
        ...
        return FluxUtil
            .withContext(context -> service.createOrUpdate(this.client.getEndpoint(), this.client.getSubscriptionId(),
                resourceGroupName, accountName, this.client.getApiVersion(), account, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<AccountInner>> createOrUpdateWithResponseAsync(String resourceGroupName, String accountName,
        ...
        return service.createOrUpdate(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            accountName, this.client.getApiVersion(), account, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<AccountInner> createOrUpdateWithResponse(String resourceGroupName, String accountName,
        AccountInner account, Context context) {
    ...
    public AccountInner createOrUpdate(String resourceGroupName, String accountName, AccountInner account) {
        return createOrUpdateWithResponse(resourceGroupName, accountName, account, Context.NONE).getValue();
    }
    ...
    private Mono<Response<AccountInner>> updateWithResponseAsync(String resourceGroupName, String accountName,
        ...
        return FluxUtil
            .withContext(context -> service.update(this.client.getEndpoint(), this.client.getSubscriptionId(),
                resourceGroupName, accountName, this.client.getApiVersion(), accountPatch, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<AccountInner>> updateWithResponseAsync(String resourceGroupName, String accountName,
        AccountPatch accountPatch, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service.update(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            accountName, this.client.getApiVersion(), accountPatch, accept, context);
    }
    ...
    public AccountInner update(String resourceGroupName, String accountName, AccountPatch accountPatch) {
        return updateWithResponse(resourceGroupName, accountName, accountPatch, Context.NONE).getValue();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<KeyDescriptionInner>> listKeysSinglePageAsync(String resourceGroupName,
        String accountName) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        return FluxUtil
            .withContext(context -> service.listKeys(this.client.getEndpoint(), this.client.getSubscriptionId(),
                resourceGroupName, accountName, this.client.getApiVersion(), accept, context))
            .<PagedResponse<KeyDescriptionInner>>map(res -> new PagedResponseBase<>(res.getRequest(),
    ...
    private Mono<PagedResponse<KeyDescriptionInner>> listKeysSinglePageAsync(String resourceGroupName,
        ...
        context = this.client.mergeContext(context);
        return service
            .listKeys(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName, accountName,
                this.client.getApiVersion(), accept, context)
            .map(res -> new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(),
                res.getValue().value(), null, null));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<KeyDescriptionInner>> regenerateKeyWithResponseAsync(String resourceGroupName,
        String accountName, RegenerateKeyParameter parameter) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return FluxUtil
            .withContext(context -> service.regenerateKey(this.client.getEndpoint(), this.client.getSubscriptionId(),
                resourceGroupName, accountName, this.client.getApiVersion(), parameter, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<KeyDescriptionInner>> regenerateKeyWithResponseAsync(String resourceGroupName,
        String accountName, RegenerateKeyParameter parameter, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service.regenerateKey(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            accountName, this.client.getApiVersion(), parameter, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<KeyDescriptionInner> regenerateKeyAsync(String resourceGroupName, String accountName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<KeyDescriptionInner> regenerateKeyWithResponse(String resourceGroupName, String accountName,
        RegenerateKeyParameter parameter, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public KeyDescriptionInner regenerateKey(String resourceGroupName, String accountName,
        RegenerateKeyParameter parameter) {
        return regenerateKeyWithResponse(resourceGroupName, accountName, parameter, Context.NONE).getValue();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ChannelTypeDescriptionListInner>> listChannelTypesWithResponseAsync(String resourceGroupName,
        String accountName) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.listChannelTypes(this.client.getEndpoint(), this.client.getSubscriptionId(),
                resourceGroupName, accountName, this.client.getApiVersion(), accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<ChannelTypeDescriptionListInner>> listChannelTypesWithResponseAsync(String resourceGroupName,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.listChannelTypes(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            accountName, this.client.getApiVersion(), accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ChannelTypeDescriptionListInner> listChannelTypesWithResponse(String resourceGroupName,
        String accountName, Context context) {
    ...
    public ChannelTypeDescriptionListInner listChannelTypes(String resourceGroupName, String accountName) {
        return listChannelTypesWithResponse(resourceGroupName, accountName, Context.NONE).getValue();
    }
}
