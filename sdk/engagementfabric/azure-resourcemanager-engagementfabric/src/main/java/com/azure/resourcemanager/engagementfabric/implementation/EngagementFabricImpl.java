...
/**
 * Initializes a new instance of the EngagementFabricImpl type.
 */
@ServiceClient(builder = EngagementFabricBuilder.class)
public final class EngagementFabricImpl implements EngagementFabric {
    /**
     * Subscription ID.
     */
     ...
     */
    EngagementFabricImpl(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter, Duration defaultPollInterval,
    ...
    private static final ClientLogger LOGGER = new ClientLogger(EngagementFabricImpl.class);
}
