...
public interface ChannelsClient {
    ...
    Response<ChannelInner> getWithResponse(String resourceGroupName, String accountName, String channelName,
        Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<ChannelInner> createOrUpdateWithResponse(String resourceGroupName, String accountName, String channelName,
        ChannelInner channel, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<Void> deleteWithResponse(String resourceGroupName, String accountName, String channelName,
        Context context);
