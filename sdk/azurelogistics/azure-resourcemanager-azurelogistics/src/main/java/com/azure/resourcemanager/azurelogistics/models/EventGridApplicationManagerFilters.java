...
/** Resource collection API of EventGridApplicationManagerFilters. */
public interface EventGridApplicationManagerFilters {
    /**
     * The get operation.
     *
     ...
     * @return the response.
     */
    EventGridFilter get(String resourceGroupName, String applicationManagerName, String eventGridFilterName);
     ...
     * @return the response body along with {@link Response}.
     */
    Response<EventGridFilter> putWithResponse(
        String resourceGroupName,
        String applicationManagerName,
        String eventGridFilterName,
        EventGridFilterInner eventGridFilter,
     ...
     */
    PagedIterable<EventGridFilter> list(String resourceGroupName, String applicationManagerName);
     ...
     * @return the list of event grid filter resources as paginated response with {@link PagedIterable}.
     */
    PagedIterable<EventGridFilter> list(String resourceGroupName, String applicationManagerName, Context context);
}
