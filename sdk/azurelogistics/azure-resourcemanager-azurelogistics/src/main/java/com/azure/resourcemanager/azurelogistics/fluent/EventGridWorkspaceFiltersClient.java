...
public interface EventGridWorkspaceFiltersClient {
    /**
     * The get operation.
     *
    ...
    EventGridFilterInner get(String resourceGroupName, String workspaceName, String eventGridFilterName);
    ...
    PagedIterable<EventGridFilterInner> list(String resourceGroupName, String workspaceName);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<EventGridFilterInner> list(String resourceGroupName, String workspaceName, Context context);
}
