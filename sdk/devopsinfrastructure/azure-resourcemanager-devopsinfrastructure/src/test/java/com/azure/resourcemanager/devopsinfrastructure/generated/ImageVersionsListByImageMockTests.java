...
public final class ImageVersionsListByImageMockTests {
    ...
    public void testListByImage() throws Exception {
        String responseStr
            = "{\"value\":[{\"properties\":{\"version\":\"lt\"},\"id\":\"mncwsobqwcsdb\",\"name\":\"wdcfhucqdpfuv\",\"type\":\"lsbjjcanvxbv\"}]}";
        ...
        PagedIterable<ImageVersion> response
            = manager.imageVersions().listByImage("tpp", "iolxor", com.azure.core.util.Context.NONE);

        Assertions.assertEquals("lt", response.iterator().next().properties().version());
    }
}
