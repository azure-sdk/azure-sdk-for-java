...
public final class ImageVersionsListByImageMockTests {
    ...
    public void testListByImage() throws Exception {
        String responseStr
            = "{\"value\":[{\"properties\":{\"version\":\"gbjcntujitcjed\"},\"id\":\"wwa\",\"name\":\"zkoj\",\"type\":\"dcpzfoqo\"}]}";
        ...
        PagedIterable<ImageVersion> response
            = manager.imageVersions().listByImage("ifrvtpu", "ujmqlgkfbtndoa", com.azure.core.util.Context.NONE);

        Assertions.assertEquals("gbjcntujitcjed", response.iterator().next().properties().version());
    }
}
