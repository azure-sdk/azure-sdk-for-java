...
public final class PoolsCheckNameAvailabilityWithResponseMockTests {
    ...
    public void testCheckNameAvailabilityWithResponse() throws Exception {
        String responseStr
            = "{\"available\":\"Available\",\"message\":\"fxrxxle\",\"name\":\"tramxjez\",\"reason\":\"AlreadyExists\"}";
        ...
        CheckNameAvailabilityResult response = manager.pools()
            .checkNameAvailabilityWithResponse(
                new CheckNameAvailability().withName("qoaxoruzfgs")
        ...
        Assertions.assertEquals("fxrxxle", response.message());
        Assertions.assertEquals("tramxjez", response.name());
