...
public final class OperationsListMockTests {
    ...
    public void testList() throws Exception {
        String responseStr
            = "{\"value\":[{\"name\":\"kqze\",\"isDataAction\":true,\"display\":{\"provider\":\"tfz\",\"resource\":\"hhvh\",\"operation\":\"r\",\"description\":\"dkwobdagx\"},\"origin\":\"user\",\"actionType\":\"Internal\"}]}";
        ...
        Assertions.assertEquals("tfz", response.iterator().next().display().provider());
        Assertions.assertEquals("hhvh", response.iterator().next().display().resource());
        Assertions.assertEquals("r", response.iterator().next().display().operation());
        Assertions.assertEquals("dkwobdagx", response.iterator().next().display().description());
