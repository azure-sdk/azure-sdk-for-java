...
public final class PoolUpdate implements JsonSerializable<PoolUpdate> {
     ...
     */
    public PoolUpdate withIdentity(AzureResourceManagerCommonTypesManagedServiceIdentityUpdate identity) {
    ...
    /**
     * Get the properties property: The updatable properties of the Pool.
     * 
    ...
    /**
     * Set the properties property: The updatable properties of the Pool.
     * 
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("identity".equals(fieldName)) {
                    deserializedPoolUpdate.identity
