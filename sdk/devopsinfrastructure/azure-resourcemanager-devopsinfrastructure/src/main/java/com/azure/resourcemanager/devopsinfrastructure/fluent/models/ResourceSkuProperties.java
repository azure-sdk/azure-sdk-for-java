...
public final class ResourceSkuProperties {
     ...
     * @return the ResourceSkuProperties object itself.
     */
    public ResourceSkuProperties withResourceType(String resourceType) {
     ...
     * @return the ResourceSkuProperties object itself.
     */
    public ResourceSkuProperties withTier(String tier) {
        this.tier = tier;
        return this;
    }
     ...
     * @return the ResourceSkuProperties object itself.
     */
    public ResourceSkuProperties withSize(String size) {
        this.size = size;
        return this;
    }
     ...
     * @return the ResourceSkuProperties object itself.
     */
    public ResourceSkuProperties withFamily(String family) {
        this.family = family;
        return this;
    }
     ...
     * @return the ResourceSkuProperties object itself.
     */
    public ResourceSkuProperties withLocations(List<String> locations) {
     ...
     * @return the ResourceSkuProperties object itself.
     */
    public ResourceSkuProperties withLocationInfo(List<ResourceSkuLocationInfo> locationInfo) {
     ...
     * @return the ResourceSkuProperties object itself.
     */
    public ResourceSkuProperties withCapabilities(List<ResourceSkuCapabilities> capabilities) {
     ...
     * @return the ResourceSkuProperties object itself.
     */
    public ResourceSkuProperties withRestrictions(List<ResourceSkuRestrictions> restrictions) {
    ...
    public void validate() {
        if (resourceType() == null) {
            throw LOGGER.logExceptionAsError(
                new IllegalArgumentException("Missing required property resourceType in model ResourceSkuProperties"));
        }
        if (tier() == null) {
            throw LOGGER.logExceptionAsError(
                new IllegalArgumentException("Missing required property tier in model ResourceSkuProperties"));
        }
        if (size() == null) {
            throw LOGGER.logExceptionAsError(
                new IllegalArgumentException("Missing required property size in model ResourceSkuProperties"));
        }
        if (family() == null) {
            throw LOGGER.logExceptionAsError(
                new IllegalArgumentException("Missing required property family in model ResourceSkuProperties"));
        }
        if (locations() == null) {
            throw LOGGER.logExceptionAsError(
        ...
        if (locationInfo() == null) {
            throw LOGGER.logExceptionAsError(
                new IllegalArgumentException("Missing required property locationInfo in model ResourceSkuProperties"));
        } else {
            locationInfo().forEach(e -> e.validate());
        }
        if (capabilities() == null) {
            throw LOGGER.logExceptionAsError(
                new IllegalArgumentException("Missing required property capabilities in model ResourceSkuProperties"));
        } else {
            capabilities().forEach(e -> e.validate());
        }
        if (restrictions() == null) {
            throw LOGGER.logExceptionAsError(
                new IllegalArgumentException("Missing required property restrictions in model ResourceSkuProperties"));
        } else {
