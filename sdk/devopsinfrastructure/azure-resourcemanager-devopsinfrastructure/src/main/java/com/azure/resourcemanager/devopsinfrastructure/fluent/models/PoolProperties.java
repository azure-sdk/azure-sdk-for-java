    ...
    public void validate() {
        if (organizationProfile() == null) {
            throw LOGGER.logExceptionAsError(
                new IllegalArgumentException("Missing required property organizationProfile in model PoolProperties"));
        } else {
            organizationProfile().validate();
        }
        if (agentProfile() == null) {
            throw LOGGER.logExceptionAsError(
                new IllegalArgumentException("Missing required property agentProfile in model PoolProperties"));
        } else {
            agentProfile().validate();
        }
        if (fabricProfile() == null) {
            throw LOGGER.logExceptionAsError(
                new IllegalArgumentException("Missing required property fabricProfile in model PoolProperties"));
        } else {
