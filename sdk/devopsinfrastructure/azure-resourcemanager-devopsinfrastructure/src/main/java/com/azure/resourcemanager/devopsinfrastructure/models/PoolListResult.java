...
public final class PoolListResult {
    ...
    /**
     * Set the value property: The Pool items on this page.
     * 
     * @param value the value value to set.
     * @return the PoolListResult object itself.
     */
    public PoolListResult withValue(List<PoolInner> value) {
        this.value = value;
        return this;
    }
     ...
     * @return the PoolListResult object itself.
     */
    public PoolListResult withNextLink(String nextLink) {
    ...
    public void validate() {
        if (value() == null) {
            throw LOGGER.logExceptionAsError(
                new IllegalArgumentException("Missing required property value in model PoolListResult"));
        } else {
