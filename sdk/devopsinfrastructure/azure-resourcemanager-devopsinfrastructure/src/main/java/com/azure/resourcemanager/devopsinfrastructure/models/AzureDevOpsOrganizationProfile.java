...
public final class AzureDevOpsOrganizationProfile extends OrganizationProfile {
    ...
    /*
     * The type of permission which determines which accounts are adming on the Azure DevOps pool.
     */
    ...
    /**
     * Get the permissionProfile property: The type of permission which determines which accounts are adming on the
     * Azure DevOps pool.
     * 
    ...
    /**
     * Set the permissionProfile property: The type of permission which determines which accounts are adming on the
     * Azure DevOps pool.
     * 
