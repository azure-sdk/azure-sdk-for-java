...
import com.azure.resourcemanager.devopsinfrastructure.models.OperationListResult;
...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    OperationsClientImpl(ManagedDevOpsInfrastructureTestImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for ManagedDevOpsInfrastructureTestOperations to be used by the proxy
