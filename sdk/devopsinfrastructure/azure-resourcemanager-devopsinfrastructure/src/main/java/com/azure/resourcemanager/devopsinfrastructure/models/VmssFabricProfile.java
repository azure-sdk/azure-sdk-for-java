    ...
    public void validate() {
        ...
        if (sku() == null) {
            throw LOGGER.logExceptionAsError(
                new IllegalArgumentException("Missing required property sku in model VmssFabricProfile"));
        } else {
            sku().validate();
        }
        if (images() == null) {
            throw LOGGER.logExceptionAsError(
                new IllegalArgumentException("Missing required property images in model VmssFabricProfile"));
        } else {
