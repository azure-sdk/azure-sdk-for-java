    ...
    public void validate() {
        if (location() == null) {
            throw LOGGER.logExceptionAsError(
                new IllegalArgumentException("Missing required property location in model ResourceSkuLocationInfo"));
        }
        if (zones() == null) {
            throw LOGGER.logExceptionAsError(
                new IllegalArgumentException("Missing required property zones in model ResourceSkuLocationInfo"));
        }
        if (zoneDetails() == null) {
            throw LOGGER.logExceptionAsError(
                new IllegalArgumentException("Missing required property zoneDetails in model ResourceSkuLocationInfo"));
        } else {
