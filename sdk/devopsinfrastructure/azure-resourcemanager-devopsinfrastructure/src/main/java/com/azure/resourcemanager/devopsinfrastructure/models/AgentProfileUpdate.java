 ...
 */
@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, property = "kind", defaultImpl = AgentProfileUpdate.class, visible = true)
@JsonTypeName("AgentProfileUpdate")
@JsonSubTypes({
    @JsonSubTypes.Type(name = "Stateful", value = StatefulUpdate.class),
    @JsonSubTypes.Type(name = "Stateless", value = StatelessAgentProfileUpdate.class) })
@Fluent
