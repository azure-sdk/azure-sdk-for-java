...
import com.azure.resourcemanager.devopsinfrastructure.models.ResourceSkuListResult;
...
public final class SkusClientImpl implements SkusClient {
     ...
     */
    SkusClientImpl(ManagedDevOpsInfrastructureTestImpl client) {
        this.service = RestProxy.create(SkusService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for ManagedDevOpsInfrastructureTestSkus to be used by the proxy service
    ...
    public interface SkusService {
        ...
        Mono<Response<ResourceSkuListResult>> listByLocation(@HostParam("$host") String endpoint,
