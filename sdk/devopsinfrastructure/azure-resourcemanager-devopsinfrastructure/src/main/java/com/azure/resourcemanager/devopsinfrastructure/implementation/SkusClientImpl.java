...
public final class SkusClientImpl implements SkusClient {
     ...
     */
    SkusClientImpl(ManagedDevOpsInfrastructureImpl client) {
        this.service = RestProxy.create(SkusService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for ManagedDevOpsInfrastructureSkus to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{$host}")
