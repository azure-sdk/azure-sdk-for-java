...
public final class ResourceDetailsClientImpl implements ResourceDetailsClient {
     ...
     */
    ResourceDetailsClientImpl(ManagedDevOpsInfrastructureTestImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for ManagedDevOpsInfrastructureTestResourceDetails to be used by the
    ...
    public interface ResourceDetailsService {
        ...
        Mono<Response<ResourceDetailsObjectListResult>> listByPool(@HostParam("$host") String endpoint,
