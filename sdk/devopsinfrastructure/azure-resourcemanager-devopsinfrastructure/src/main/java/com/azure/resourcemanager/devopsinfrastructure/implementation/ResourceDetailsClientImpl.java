...
public final class ResourceDetailsClientImpl implements ResourceDetailsClient {
     ...
     */
    ResourceDetailsClientImpl(ManagedDevOpsInfrastructureImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for ManagedDevOpsInfrastructureResourceDetails to be used by the proxy
