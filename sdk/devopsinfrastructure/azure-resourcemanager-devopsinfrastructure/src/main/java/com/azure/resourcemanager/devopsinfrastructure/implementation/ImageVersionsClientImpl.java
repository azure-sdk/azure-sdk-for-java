...
public final class ImageVersionsClientImpl implements ImageVersionsClient {
     ...
     */
    ImageVersionsClientImpl(ManagedDevOpsInfrastructureTestImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for ManagedDevOpsInfrastructureTestImageVersions to be used by the proxy
