...
public final class ImageVersionsClientImpl implements ImageVersionsClient {
     ...
     */
    ImageVersionsClientImpl(ManagedDevOpsInfrastructureImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for ManagedDevOpsInfrastructureImageVersions to be used by the proxy
