...
public final class PoolImpl implements Pool, Pool.Definition, Pool.Update {
    ...
    public Pool create() {
        this.innerObject = serviceManager.serviceClient().getPools().createOrUpdate(resourceGroupName, poolName,
    ...
    public Pool apply() {
        this.innerObject = serviceManager.serviceClient().getPools().update(resourceGroupName, poolName,
    ...
    public Pool refresh() {
        this.innerObject = serviceManager.serviceClient().getPools()
            .getByResourceGroupWithResponse(resourceGroupName, poolName, Context.NONE).getValue();
        return this;
    }

    public Pool refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getPools()
            .getByResourceGroupWithResponse(resourceGroupName, poolName, context).getValue();
        return this;
    }
