...
public final class DevOpsAzureSku {
    ...
    /**
     * Get the tier property: The Azure SKU tier of the machines in the pool.
     * 
    ...
    /**
     * Set the tier property: The Azure SKU tier of the machines in the pool.
     * 
     * @param tier the tier value to set.
     * @return the DevOpsAzureSku object itself.
     */
    public DevOpsAzureSku withTier(String tier) {
        this.tier = tier;
        return this;
    }
    ...
    public void validate() {
        if (name() == null) {
            throw LOGGER.logExceptionAsError(
                new IllegalArgumentException("Missing required property name in model DevOpsAzureSku"));
        }
    }
