...
/**
 * Initializes a new instance of the ManagedDevOpsInfrastructureTestImpl type.
 */
@ServiceClient(builder = ManagedDevOpsInfrastructureTestBuilder.class)
public final class ManagedDevOpsInfrastructureTestImpl implements ManagedDevOpsInfrastructureTest {
    /**
    ...
    /**
     * Initializes an instance of ManagedDevOpsInfrastructureTest client.
     * 
     ...
     */
    ManagedDevOpsInfrastructureTestImpl(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter,
    ...
    private static final ClientLogger LOGGER = new ClientLogger(ManagedDevOpsInfrastructureTestImpl.class);
}
