...
public final class SubscriptionUsagesClientImpl implements SubscriptionUsagesClient {
     ...
     */
    SubscriptionUsagesClientImpl(ManagedDevOpsInfrastructureImpl client) {
    ...
    /**
     * The interface defining all the services for ManagedDevOpsInfrastructureSubscriptionUsages to be used by the proxy
    ...
    public interface SubscriptionUsagesService {
        ...
        Mono<Response<QuotaListResult>> listByLocation(@HostParam("$host") String endpoint,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<QuotaInner>> listByLocationNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<QuotaInner>> listByLocationNextSinglePageAsync(String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        if (this.client.getEndpoint() == null) {
