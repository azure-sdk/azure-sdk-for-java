...
public final class SubscriptionUsagesClientImpl implements SubscriptionUsagesClient {
     ...
     */
    SubscriptionUsagesClientImpl(ManagedDevOpsInfrastructureTestImpl client) {
    ...
    /**
     * The interface defining all the services for ManagedDevOpsInfrastructureTestSubscriptionUsages to be used by the
    ...
    public interface SubscriptionUsagesService {
        ...
        Mono<Response<PagedQuota>> usages(@HostParam("$host") String endpoint,
