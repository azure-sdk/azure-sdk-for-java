...
public final class OffersClientImpl implements OffersClient {
    ...
    public interface OffersService {
        ...
        Mono<Response<OfferListResult>> list(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<OfferListResult>> listBySubscription(@HostParam("$host") String endpoint,
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Flux<ByteBuffer>>> generateAccessToken(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam(value = "resourceUri", encoded = true) String resourceUri, @PathParam("offerId") String offerId,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<DiskAccessTokenInner>> getAccessToken(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam(value = "resourceUri", encoded = true) String resourceUri, @PathParam("offerId") String offerId,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<OfferInner>> listBySubscriptionSinglePageAsync(Integer top, Integer skip,
        Integer maxPageSize, String filter, String skipToken) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<OfferInner> listBySubscriptionAsync(Integer top, Integer skip, Integer maxPageSize, String filter,
        String skipToken) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<OfferInner> listBySubscription(Integer top, Integer skip, Integer maxPageSize, String filter,
        String skipToken, Context context) {
