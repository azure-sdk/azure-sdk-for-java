...
public final class TermsAndConditions {
     ...
     */
    @JsonProperty(value = "legalTermsUri", required = true)
    private String legalTermsUri;

    /*
     * The type of legal terms
     */
    @JsonProperty(value = "legalTermsType", required = true)
    private String legalTermsType;

    /*
     * The privacy policy uri
     */
    @JsonProperty(value = "privacyPolicyUri", required = true)
            ...
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException(
                        "Missing required property legalTermsUri in model TermsAndConditions"));
        }
        if (legalTermsType() == null) {
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException(
                        "Missing required property legalTermsType in model TermsAndConditions"));
        }
        if (privacyPolicyUri() == null) {
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException(
                        "Missing required property privacyPolicyUri in model TermsAndConditions"));
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(TermsAndConditions.class);
}
