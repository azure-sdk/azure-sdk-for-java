...
public final class MarketplaceSkuVersion {
     ...
     */
    @JsonProperty(value = "sizeOnDiskInMb", required = true)
    private int sizeOnDiskInMb;

    /*
     * The size of the download
     */
    @JsonProperty(value = "minimumDownloadSizeInMb", required = true)
    private int minimumDownloadSizeInMb;
     ...
     * @return the MarketplaceSkuVersion object itself.
     */
    public MarketplaceSkuVersion withSizeOnDiskInMb(int sizeOnDiskInMb) {
     ...
     */
    public int minimumDownloadSizeInMb() {
     ...
     * @return the MarketplaceSkuVersion object itself.
     */
    public MarketplaceSkuVersion withMinimumDownloadSizeInMb(int minimumDownloadSizeInMb) {
    ...
    public void validate() {
        ...
        if (stageName() == null) {
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException("Missing required property stageName in model MarketplaceSkuVersion"));
        }
    }
