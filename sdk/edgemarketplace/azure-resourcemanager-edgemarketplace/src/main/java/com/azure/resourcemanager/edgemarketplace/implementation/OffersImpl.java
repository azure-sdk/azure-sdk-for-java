...
public final class OffersImpl implements Offers {
    ...
    public PagedIterable<Offer> list(String resourceUri, Integer top, Integer skip, Integer maxPageSize, String filter,
    ...
    public PagedIterable<Offer> listBySubscription(Integer top, Integer skip, Integer maxPageSize, String filter,
        String skipToken, Context context) {
        PagedIterable<OfferInner> inner
    ...
    public Response<DiskAccessToken> getAccessTokenWithResponse(String resourceUri, String offerId,
