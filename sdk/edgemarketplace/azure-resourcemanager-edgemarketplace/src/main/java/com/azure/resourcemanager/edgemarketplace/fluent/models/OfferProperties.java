...
public final class OfferProperties {
     ...
     * The content version
     */
    @JsonProperty(value = "contentVersion", required = true)
    private String contentVersion;

    /*
     * The content url
     */
    @JsonProperty(value = "contentUrl", required = true)
     ...
     */
    @JsonProperty(value = "marketplaceSkus", required = true)
    ...
    public void validate() {
        if (contentVersion() == null) {
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException("Missing required property contentVersion in model OfferProperties"));
        }
        if (contentUrl() == null) {
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException("Missing required property contentUrl in model OfferProperties"));
        }
            ...
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException(
                        "Missing required property provisioningState in model OfferProperties"));
        }
        if (marketplaceSkus() == null) {
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException("Missing required property marketplaceSkus in model OfferProperties"));
        } else {
