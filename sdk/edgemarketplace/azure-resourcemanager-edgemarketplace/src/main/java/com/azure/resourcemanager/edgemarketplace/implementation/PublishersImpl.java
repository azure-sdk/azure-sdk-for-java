...
public final class PublishersImpl implements Publishers {
    ...
    public PagedIterable<Publisher> list(String resourceUri, Integer top, Integer skip, Integer maxPageSize,
    ...
    public PagedIterable<Publisher> listBySubscription(Integer top, Integer skip, Integer maxPageSize, String filter,
