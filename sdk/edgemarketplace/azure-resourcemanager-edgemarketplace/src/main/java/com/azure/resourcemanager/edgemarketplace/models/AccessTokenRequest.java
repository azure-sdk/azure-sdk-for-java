...
public final class AccessTokenRequest {
     ...
     * The region where the disk will be created.
     */
    @JsonProperty(value = "egeMarketPlaceResourceId", required = true)
     ...
     * The marketplace sku.
     */
    @JsonProperty(value = "marketPlaceSku", required = true)
    private String marketPlaceSku;

    /*
     * The marketplace sku version.
     */
    @JsonProperty(value = "marketPlaceSkuVersion", required = true)
    private String marketPlaceSkuVersion;

    /*
     * The device sku.
     */
    @JsonProperty(value = "deviceSku", required = true)
    private String deviceSku;

    /*
     * The device sku version.
     */
    @JsonProperty(value = "deviceVersion", required = true)
    ...
    public void validate() {
        ...
        if (egeMarketPlaceResourceId() == null) {
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException(
                        "Missing required property egeMarketPlaceResourceId in model AccessTokenRequest"));
        }
        if (hypervGeneration() == null) {
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException(
                        "Missing required property hypervGeneration in model AccessTokenRequest"));
        }
        if (marketPlaceSku() == null) {
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException(
                        "Missing required property marketPlaceSku in model AccessTokenRequest"));
        }
        if (marketPlaceSkuVersion() == null) {
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException(
                        "Missing required property marketPlaceSkuVersion in model AccessTokenRequest"));
        }
        if (deviceSku() == null) {
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException("Missing required property deviceSku in model AccessTokenRequest"));
        }
        if (deviceVersion() == null) {
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException(
                        "Missing required property deviceVersion in model AccessTokenRequest"));
        }
    }
