...
public final class SkuOperatingSystem {
    ...
    public void validate() {
        if (family() == null) {
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException("Missing required property family in model SkuOperatingSystem"));
        }
        if (type() == null) {
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException("Missing required property type in model SkuOperatingSystem"));
        }
        if (name() == null) {
            throw LOGGER
                .logExceptionAsError(
