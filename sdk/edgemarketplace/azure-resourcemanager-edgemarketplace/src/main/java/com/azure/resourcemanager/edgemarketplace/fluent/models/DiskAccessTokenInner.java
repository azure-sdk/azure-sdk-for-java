...
public final class DiskAccessTokenInner {
    ...
    public void validate() {
        if (diskId() == null) {
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException("Missing required property diskId in model DiskAccessTokenInner"));
        }
        if (status() == null) {
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException("Missing required property status in model DiskAccessTokenInner"));
        }
        if (accessToken() == null) {
            throw LOGGER
                .logExceptionAsError(
