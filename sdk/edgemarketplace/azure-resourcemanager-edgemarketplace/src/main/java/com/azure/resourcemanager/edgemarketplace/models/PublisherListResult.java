...
public final class PublisherListResult {
     ...
     * @return the PublisherListResult object itself.
     */
    public PublisherListResult withNextLink(String nextLink) {
    ...
    public void validate() {
        if (value() == null) {
            throw LOGGER.logExceptionAsError(
                new IllegalArgumentException("Missing required property value in model PublisherListResult"));
        } else {
            value().forEach(e -> e.validate());
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(PublisherListResult.class);
}
