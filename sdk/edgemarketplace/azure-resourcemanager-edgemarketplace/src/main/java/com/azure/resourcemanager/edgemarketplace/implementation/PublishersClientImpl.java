...
public final class PublishersClientImpl implements PublishersClient {
    ...
    public interface PublishersService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<PublisherListResult>> listBySubscription(@HostParam("$host") String endpoint,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<PublisherInner>> listBySubscriptionSinglePageAsync(Integer top, Integer skip,
        Integer maxPageSize, String filter, String skipToken) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<PublisherInner> listBySubscriptionAsync(Integer top, Integer skip, Integer maxPageSize,
        String filter, String skipToken) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<PublisherInner> listBySubscription(Integer top, Integer skip, Integer maxPageSize,
        String filter, String skipToken, Context context) {
