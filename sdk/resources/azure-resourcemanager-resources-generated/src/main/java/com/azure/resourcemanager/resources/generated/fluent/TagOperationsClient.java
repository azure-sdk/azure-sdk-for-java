...
public interface TagOperationsClient {
    ...
    SyncPoller<PollResult<TagsResourceInner>, TagsResourceInner> beginCreateOrUpdateAtScope(String scope,
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<TagsResourceInner>, TagsResourceInner> beginUpdateAtScope(String scope,
