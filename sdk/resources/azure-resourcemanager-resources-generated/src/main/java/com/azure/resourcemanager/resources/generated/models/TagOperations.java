...
public interface TagOperations {
     ...
     * @return wrapper resource for tags API requests and responses.
     */
    TagsResource createOrUpdateAtScope(String scope, TagsResourceInner parameters, Context context);
     ...
     * @return wrapper resource for tags API requests and responses.
     */
    TagsResource updateAtScope(String scope, TagsPatchResource parameters, Context context);
