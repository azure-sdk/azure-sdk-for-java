...
public final class ProvidersImpl implements Providers {
    ...
    public ProvidersImpl(ProvidersClient innerClient,
    ...
    public Response<ProviderPermissionListResult> providerPermissionsWithResponse(String resourceProviderNamespace,
        Context context) {
    ...
    public Response<Provider> registerWithResponse(String resourceProviderNamespace,
    ...
    public PagedIterable<Provider> list() {
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new ProviderImpl(inner1, this.manager()));
    }
    ...
    public Response<Provider> getAtTenantScopeWithResponse(String resourceProviderNamespace, String expand,
        Context context) {
        Response<ProviderInner> inner
