...
public final class ResourcesClientImpl implements ResourcesClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Boolean> checkExistenceAsync(String resourceGroupName, String resourceProviderNamespace,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<GenericResourceInner> getAsync(String resourceGroupName, String resourceProviderNamespace,
        String parentResourcePath, String resourceType, String resourceName, String apiVersion) {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<GenericResourceInner>, GenericResourceInner>
