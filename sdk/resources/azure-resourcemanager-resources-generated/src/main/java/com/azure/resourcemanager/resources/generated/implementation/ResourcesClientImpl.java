...
import com.azure.resourcemanager.resources.generated.models.ResourceListResult;
...
public final class ResourcesClientImpl implements ResourcesClient {
    ...
    public interface ResourcesService {
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ResourceListResult>> getByResourceGroup(
            @HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("resourceProviderNamespace") String resourceProviderNamespace,
            @PathParam(value = "parentResourcePath", encoded = true) String parentResourcePath,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ResourceListResult>> listByParentNext(
            @PathParam(value = "nextLink", encoded = true) String nextLink,
            @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept,
            Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<GenericResourceExpandedInner> listByResourceGroupAsync(String resourceGroupName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<GenericResourceExpandedInner>> getByResourceGroupSinglePageAsync(
        String resourceGroupName,
        String resourceProviderNamespace,
        String parentResourcePath,
        String resourceType,
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return list of resource groups as paginated response with {@link PagedFlux}.
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<GenericResourceExpandedInner> getByResourceGroupAsync(
        String resourceGroupName,
        String resourceProviderNamespace,
        String parentResourcePath,
        String resourceType,
        ...
        return new PagedFlux<>(
            () ->
                getByResourceGroupSinglePageAsync(
                    resourceGroupName, resourceProviderNamespace, parentResourcePath, resourceType, apiVersion),
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return list of resource groups as paginated response with {@link PagedIterable}.
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<GenericResourceExpandedInner> getByResourceGroup(
        String resourceGroupName,
        String resourceProviderNamespace,
        String parentResourcePath,
        String resourceType,
    ...
    public PagedIterable<GenericResourceExpandedInner> getByResourceGroup(
        ...
        return new PagedIterable<>(
            getByResourceGroupAsync(
                resourceGroupName, resourceProviderNamespace, parentResourcePath, resourceType, apiVersion, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Boolean> checkExistenceByIdAsync(String resourceId, String apiVersion) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> deleteByIdAsync(String resourceId, String apiVersion) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<GenericResourceInner> getByIdAsync(String resourceId, String apiVersion) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<GenericResourceExpandedInner>> listByParentNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        if (this.client.getEndpoint() == null) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<GenericResourceExpandedInner>> listByParentNextSinglePageAsync(
        String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        ...
        context = this.client.mergeContext(context);
        return service
            .listByParentNext(nextLink, this.client.getEndpoint(), accept, context)
            .map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(),
