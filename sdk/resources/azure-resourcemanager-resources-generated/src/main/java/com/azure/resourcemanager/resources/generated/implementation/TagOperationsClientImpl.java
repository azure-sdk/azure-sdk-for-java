...
import com.azure.resourcemanager.resources.generated.models.TagsListResult;
...
public final class TagOperationsClientImpl implements TagOperationsClient {
    ...
    private Mono<Response<Void>> deleteValueWithResponseAsync(String tagName, String tagValue) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> deleteValueAsync(String tagName, String tagValue) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<TagValueInner> createOrUpdateValueAsync(String tagName, String tagValue) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<TagDetailsInner>> createOrUpdateWithResponseAsync(String tagName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<TagDetailsInner> createOrUpdateAsync(String tagName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Void>> deleteWithResponseAsync(String tagName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> deleteAsync(String tagName) {
    ...
    public SyncPoller<PollResult<TagsResourceInner>, TagsResourceInner> beginCreateOrUpdateAtScope(
        String scope, TagsResourceInner parameters) {
        return beginCreateOrUpdateAtScopeAsync(scope, parameters).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<TagsResourceInner>, TagsResourceInner> beginCreateOrUpdateAtScope(
        String scope, TagsResourceInner parameters, Context context) {
        return beginCreateOrUpdateAtScopeAsync(scope, parameters, context).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<TagsResourceInner>, TagsResourceInner> beginUpdateAtScope(
        String scope, TagsPatchResource parameters) {
        return beginUpdateAtScopeAsync(scope, parameters).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<TagsResourceInner>, TagsResourceInner> beginUpdateAtScope(
        String scope, TagsPatchResource parameters, Context context) {
        return beginUpdateAtScopeAsync(scope, parameters, context).getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<TagsResourceInner> updateAtScopeAsync(String scope, TagsPatchResource parameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<TagsResourceInner> getAtScopeAsync(String scope) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> deleteAtScopeWithResponseAsync(String scope) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<Void>, Void> beginDeleteAtScopeAsync(String scope) {
    ...
    public SyncPoller<PollResult<Void>, Void> beginDeleteAtScope(String scope) {
        return beginDeleteAtScopeAsync(scope).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDeleteAtScope(String scope, Context context) {
        return beginDeleteAtScopeAsync(scope, context).getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> deleteAtScopeAsync(String scope) {
