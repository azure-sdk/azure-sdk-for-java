...
import com.azure.resourcemanager.resources.generated.models.ResourceGroupListResult;
...
public final class ResourceGroupsClientImpl implements ResourceGroupsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Boolean> checkExistenceAsync(String resourceGroupName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ResourceGroupInner> createOrUpdateAsync(String resourceGroupName, ResourceGroupInner parameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> deleteAsync(String resourceGroupName, String forceDeletionTypes) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ResourceGroupInner>> getWithResponseAsync(String resourceGroupName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ResourceGroupInner> getAsync(String resourceGroupName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ResourceGroupInner> updateAsync(String resourceGroupName, ResourceGroupPatchable parameters) {
    ...
    private PagedFlux<ResourceGroupInner> listAsync(String filter, Integer top) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<ResourceGroupInner> listAsync() {
