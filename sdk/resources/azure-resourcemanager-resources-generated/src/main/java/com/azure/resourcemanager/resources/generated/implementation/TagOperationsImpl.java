...
public final class TagOperationsImpl implements TagOperations {
    ...
    public TagsResource createOrUpdateAtScope(String scope, TagsResourceInner parameters, Context context) {
        TagsResourceInner inner = this.serviceClient().createOrUpdateAtScope(scope, parameters, context);
        if (inner != null) {
            return new TagsResourceImpl(inner, this.manager());
        } else {
            return null;
    ...
    public TagsResource updateAtScope(String scope, TagsPatchResource parameters, Context context) {
        TagsResourceInner inner = this.serviceClient().updateAtScope(scope, parameters, context);
        if (inner != null) {
            return new TagsResourceImpl(inner, this.manager());
        } else {
            return null;
    ...
    public void deleteAtScope(String scope, Context context) {
        this.serviceClient().deleteAtScope(scope, context);
    }
