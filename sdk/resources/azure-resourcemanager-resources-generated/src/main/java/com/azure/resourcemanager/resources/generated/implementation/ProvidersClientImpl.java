...
import com.azure.resourcemanager.resources.generated.models.ProviderListResult;
...
public final class ProvidersClientImpl implements ProvidersClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ProviderInner> unregisterAsync(String resourceProviderNamespace) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> registerAtManagementGroupScopeAsync(String resourceProviderNamespace, String groupId) {
    ...
    public void registerAtManagementGroupScope(String resourceProviderNamespace, String groupId) {
        registerAtManagementGroupScopeAsync(resourceProviderNamespace, groupId).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ProviderPermissionListResultInner> providerPermissionsAsync(String resourceProviderNamespace) {
    ...
    public ProviderPermissionListResultInner providerPermissions(String resourceProviderNamespace) {
        return providerPermissionsAsync(resourceProviderNamespace).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ProviderInner> registerAsync(
        String resourceProviderNamespace, ProviderRegistrationRequest properties) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ProviderInner> registerAsync(String resourceProviderNamespace) {
    ...
    public ProviderInner register(String resourceProviderNamespace) {
        final ProviderRegistrationRequest properties = null;
        return registerAsync(resourceProviderNamespace, properties).block();
    }
    ...
    private PagedFlux<ProviderInner> listAsync(String expand) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<ProviderInner> listAtTenantScopeAsync(String expand) {
        return new PagedFlux<>(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ProviderInner> getAsync(String resourceProviderNamespace, String expand) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ProviderInner> getAsync(String resourceProviderNamespace) {
        final String expand = null;
        return getWithResponseAsync(resourceProviderNamespace, expand).flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ProviderInner> getAtTenantScopeAsync(String resourceProviderNamespace, String expand) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ProviderInner> getAtTenantScopeAsync(String resourceProviderNamespace) {
        final String expand = null;
        return getAtTenantScopeWithResponseAsync(resourceProviderNamespace, expand)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
