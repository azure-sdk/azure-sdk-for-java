...
public final class PlaywrightTestingMgmtClientBuilder {
     ...
     * @return the PlaywrightTestingMgmtClientBuilder.
     */
    public PlaywrightTestingMgmtClientBuilder environment(AzureEnvironment environment) {
     ...
     * @return the PlaywrightTestingMgmtClientBuilder.
     */
    public PlaywrightTestingMgmtClientBuilder pipeline(HttpPipeline pipeline) {
     ...
     * @return the PlaywrightTestingMgmtClientBuilder.
     */
    public PlaywrightTestingMgmtClientBuilder defaultPollInterval(Duration defaultPollInterval) {
     ...
     * @return the PlaywrightTestingMgmtClientBuilder.
     */
    public PlaywrightTestingMgmtClientBuilder serializerAdapter(SerializerAdapter serializerAdapter) {
