...
public class TestRunsGetTestRun {
    public static void main(String[] args) {
        TestRunsClient testRunsClient
            = new ReportingClientBuilder().credential(new DefaultAzureCredentialBuilder().build())
                ...
                .buildTestRunsClient();
        // BEGIN:com.azure.developer.microsoftplaywrighttesting.generated.testrunsget.testrunsgettestrun
        TestRun response = testRunsClient.get("eastasia_a56bbc94-fbb7-4c20-9b17-981067e4580a",
            "123e4567-e89b-12d3-a456-426614174000");
        // END:com.azure.developer.microsoftplaywrighttesting.generated.testrunsget.testrunsgettestrun
    }
}
