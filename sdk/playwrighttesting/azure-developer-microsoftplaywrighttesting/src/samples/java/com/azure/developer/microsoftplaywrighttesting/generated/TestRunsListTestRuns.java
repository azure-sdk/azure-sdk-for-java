...
public class TestRunsListTestRuns {
    public static void main(String[] args) {
        TestRunsClient testRunsClient
            = new ReportingClientBuilder().credential(new DefaultAzureCredentialBuilder().build())
                ...
                .buildTestRunsClient();
        // BEGIN:com.azure.developer.microsoftplaywrighttesting.generated.testrunslist.testrunslisttestruns
        PagedIterable<TestRun> response
            = testRunsClient.list("eastasia_a56bbc94-fbb7-4c20-9b17-981067e4580a", 10, 0, "status eq 'Passed'");
        // END:com.azure.developer.microsoftplaywrighttesting.generated.testrunslist.testrunslisttestruns
    }
}
