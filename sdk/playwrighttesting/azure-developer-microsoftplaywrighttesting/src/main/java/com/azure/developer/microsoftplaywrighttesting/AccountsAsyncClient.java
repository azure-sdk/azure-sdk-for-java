...
public final class AccountsAsyncClient {
     ...
     * @return details of the ARM resource mapped to an account for the given accountId along with {@link Response} on
     * successful completion of {@link Mono}.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> getWithResponse(String accountId, RequestOptions requestOptions) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<Void>> getBrowsersWithResponse(String accountId, RequestOptions requestOptions) {
     ...
     * @return details of the ARM resource mapped to an account for the given accountId on successful completion of
     * {@link Mono}.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
     ...
     * @throws ResourceModifiedException thrown if the request is rejected by server on status code 409.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return remote browsers corresponding to given accountId and redirects the client for running MPT tests on
     * successful completion of {@link Mono}.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> getBrowsers(String accountId, String runId, OS os) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> getBrowsers(String accountId) {
        // Generated convenience method for getBrowsersWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getBrowsersWithResponse(accountId, requestOptions).flatMap(FluxUtil::toMono);
    }
