...
/**
 * An account is a parent resource for most of the other service resources. It's directly mapped to an ARM resource and
 * helps to create a link between control-plane and data-plane resources.
 */
@Immutable
public final class Account implements JsonSerializable<Account> {
    ...
    /**
     * Get the resourceId property: The ARM fully-qualified resource id for the account.
     * 
    ...
    /**
     * Get the subscriptionId property: The ARM-based subscription id for the account.
     * 
    ...
    /**
     * Get the subscriptionState property: The ARM-based subscription state - Registered | Unregistered | Warned |
     * Suspended | Deleted.
     * 
    ...
    /**
     * Get the location property: The account resource ARM location, for eg. eastus, southeastasia.
     * 
