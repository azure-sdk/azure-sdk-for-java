...
public final class AccessTokensImpl {
    ...
    public interface AccessTokensService {
        ...
        @Post("/accounts/{accountId}/access-tokens/validate")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(value = ClientAuthenticationException.class, code = { 401 })
        @UnexpectedResponseExceptionType(value = ResourceNotFoundException.class, code = { 404 })
        @UnexpectedResponseExceptionType(value = ResourceModifiedException.class, code = { 409 })
    ...
    public Mono<Response<BinaryData>> createWithResponseAsync(String accountId, String accessTokenId,
        ...
        return FluxUtil.withContext(
            context -> service.create(this.client.getEndpoint(), this.client.getServiceVersion().getVersion(),
                accountId, accessTokenId, accept, resource, requestOptions, context));
    }
    ...
    public Response<BinaryData> createWithResponse(String accountId, String accessTokenId, BinaryData resource,
        ...
        final String accept = "application/json";
        return service.createSync(this.client.getEndpoint(), this.client.getServiceVersion().getVersion(), accountId,
            accessTokenId, accept, resource, requestOptions, Context.NONE);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> getWithResponseAsync(String accountId, String accessTokenId,
        RequestOptions requestOptions) {
        final String accept = "application/json";
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<Void>> deleteWithResponseAsync(String accountId, String accessTokenId,
        RequestOptions requestOptions) {
        final String accept = "application/json";
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<Void>> validateWithResponseAsync(String accountId, RequestOptions requestOptions) {
        final String accept = "application/json";
        return FluxUtil.withContext(context -> service.validate(this.client.getEndpoint(),
            this.client.getServiceVersion().getVersion(), accountId, accept, requestOptions, context));
    }
    ...
    public Response<Void> validateWithResponse(String accountId, RequestOptions requestOptions) {
        final String accept = "application/json";
        return service.validateSync(this.client.getEndpoint(), this.client.getServiceVersion().getVersion(), accountId,
