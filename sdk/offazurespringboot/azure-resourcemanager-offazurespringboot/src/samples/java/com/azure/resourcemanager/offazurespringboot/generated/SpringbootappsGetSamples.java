...
public final class SpringbootappsGetSamples {
     ...
     */
    public static void
        springbootappsGetMinimumSetGen(com.azure.resourcemanager.offazurespringboot.SpringAppDiscoveryManager manager) {
     ...
     */
    public static void
        springbootappsGetMaximumSetGen(com.azure.resourcemanager.offazurespringboot.SpringAppDiscoveryManager manager) {
        manager.springbootapps().getWithResponse("rgspringbootapps", "pdfosfhtemfsaglvwjdyqlyeipucrd",
            "ofjeesoahqtnovlbuvflyknpbhcpeqqhekntvqxyemuwbcqnuxjgfhsf", com.azure.core.util.Context.NONE);
    }
}
