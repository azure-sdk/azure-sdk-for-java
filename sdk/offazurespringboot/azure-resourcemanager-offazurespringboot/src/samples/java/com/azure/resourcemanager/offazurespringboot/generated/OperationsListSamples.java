...
public final class OperationsListSamples {
     ...
     */
    public static void
        operationsListMinimumSetGen(com.azure.resourcemanager.offazurespringboot.SpringAppsDiscoveryManager manager) {
     ...
     */
    public static void
        operationsListMaximumSetGen(com.azure.resourcemanager.offazurespringboot.SpringAppsDiscoveryManager manager) {
        manager.operations().list(com.azure.core.util.Context.NONE);
    }
}
