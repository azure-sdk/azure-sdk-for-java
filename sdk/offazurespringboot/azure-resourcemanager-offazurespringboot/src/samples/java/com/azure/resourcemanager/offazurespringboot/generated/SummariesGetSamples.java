...
public final class SummariesGetSamples {
     ...
     */
    public static void
        summariesGetMaximumSetGen(com.azure.resourcemanager.offazurespringboot.SpringAppDiscoveryManager manager) {
     ...
     */
    public static void
        summariesGetMinimumSetGen(com.azure.resourcemanager.offazurespringboot.SpringAppDiscoveryManager manager) {
        manager.summaries().getWithResponse("rgspringbootdiscovery", "xxkzlvbihwxunadjcpjpjmghmhxrqyvghtpfps", "vjB",
            com.azure.core.util.Context.NONE);
    }
}
