...
public final class SummariesGetSamples {
     ...
     */
    public static void
        summariesGetMaximumSetGen(com.azure.resourcemanager.offazurespringboot.SpringAppsDiscoveryManager manager) {
     ...
     */
    public static void
        summariesGetMinimumSetGen(com.azure.resourcemanager.offazurespringboot.SpringAppsDiscoveryManager manager) {
        manager.summaries().getWithResponse("rgspringbootdiscovery", "xxkzlvbihwxunadjcpjpjmghmhxrqyvghtpfps", "vjB",
            com.azure.core.util.Context.NONE);
    }
}
