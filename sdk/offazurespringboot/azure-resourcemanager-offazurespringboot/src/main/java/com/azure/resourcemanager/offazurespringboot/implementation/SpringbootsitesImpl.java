...
public final class SpringbootsitesImpl implements Springbootsites {
    ...
    public SpringbootsitesImpl(
        SpringbootsitesClient innerClient,
        com.azure.resourcemanager.offazurespringboot.SpringAppsDiscoveryManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public Response<SpringbootsitesModel> getByResourceGroupWithResponse(
    ...
    public Response<SpringbootsitesModel> deleteByResourceGroupWithResponse(
        String resourceGroupName, String springbootsitesName, Context context) {
        Response<SpringbootsitesModelInner> inner =
            this.serviceClient().deleteWithResponse(resourceGroupName, springbootsitesName, context);
        if (inner != null) {
            return new SimpleResponse<>(
                inner.getRequest(),
                inner.getStatusCode(),
    ...
    public SpringbootsitesModel deleteByResourceGroup(String resourceGroupName, String springbootsitesName) {
        SpringbootsitesModelInner inner = this.serviceClient().delete(resourceGroupName, springbootsitesName);
        if (inner != null) {
            return new SpringbootsitesModelImpl(inner, this.manager());
        } else {
            return null;
    ...
    public PagedIterable<SpringbootsitesModel> listByResourceGroup(String resourceGroupName) {
        ...
        return Utils.mapPage(inner, inner1 -> new SpringbootsitesModelImpl(inner1, this.manager()));
    }
    ...
    public SpringbootsitesModel deleteById(String id) {
        String resourceGroupName = Utils.getValueFromIdByName(id, "resourceGroups");
        if (resourceGroupName == null) {
            throw LOGGER
                .logExceptionAsError(
        ...
        return this.deleteByResourceGroupWithResponse(resourceGroupName, springbootsitesName, Context.NONE).getValue();
    }

    public Response<SpringbootsitesModel> deleteByIdWithResponse(String id, Context context) {
        String resourceGroupName = Utils.getValueFromIdByName(id, "resourceGroups");
        if (resourceGroupName == null) {
            throw LOGGER
                .logExceptionAsError(
        ...
        return this.deleteByResourceGroupWithResponse(resourceGroupName, springbootsitesName, context);
    }
