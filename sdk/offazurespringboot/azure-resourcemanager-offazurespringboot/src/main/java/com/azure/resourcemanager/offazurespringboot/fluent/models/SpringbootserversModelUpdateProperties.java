 ...
 */
@Fluent
public final class SpringbootserversModelUpdateProperties {
    /*
    ...
    /**
     * Creates an instance of SpringbootserversModelUpdateProperties class.
     */
    public SpringbootserversModelUpdateProperties() {
    }
     ...
     * @return the SpringbootserversModelUpdateProperties object itself.
     */
    public SpringbootserversModelUpdateProperties withPort(Integer port) {
        this.port = port;
        return this;
    }
     ...
     * @return the SpringbootserversModelUpdateProperties object itself.
     */
    public SpringbootserversModelUpdateProperties withServer(String server) {
        this.server = server;
        return this;
    }
     ...
     * @return the SpringbootserversModelUpdateProperties object itself.
     */
    public SpringbootserversModelUpdateProperties withFqdnAndIpAddressList(List<String> fqdnAndIpAddressList) {
     ...
     * @return the SpringbootserversModelUpdateProperties object itself.
     */
    public SpringbootserversModelUpdateProperties withMachineArmId(String machineArmId) {
     ...
     * @return the SpringbootserversModelUpdateProperties object itself.
     */
    public SpringbootserversModelUpdateProperties withTotalApps(Integer totalApps) {
     ...
     * @return the SpringbootserversModelUpdateProperties object itself.
     */
    public SpringbootserversModelUpdateProperties withSpringBootApps(Integer springBootApps) {
     ...
     * @return the SpringbootserversModelUpdateProperties object itself.
     */
    public SpringbootserversModelUpdateProperties withErrors(List<Error> errors) {
        this.errors = errors;
        return this;
    }
     ...
     * @return the SpringbootserversModelUpdateProperties object itself.
     */
    public SpringbootserversModelUpdateProperties withProvisioningState(ProvisioningState provisioningState) {
