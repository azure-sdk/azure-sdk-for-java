...
public interface SpringbootsitesClient {
    ...
    Response<SpringbootsitesModelInner> getByResourceGroupWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<SpringbootsitesModelInner> createOrUpdateWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    SpringbootsitesModelInner createOrUpdate(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<SpringbootsitesModelInner> deleteWithResponse(
        String resourceGroupName, String springbootsitesName, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    SpringbootsitesModelInner delete(String resourceGroupName, String springbootsitesName);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<SpringbootsitesModelInner> updateWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    SpringbootsitesModelInner update(
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<Void>, Void> beginTriggerRefreshSite(
        String resourceGroupName, String springbootsitesName, Context context);
