...
import com.azure.resourcemanager.offazurespringboot.models.SpringbootsitesListResult;
import com.azure.resourcemanager.offazurespringboot.models.SpringbootsitesPatch;
...
public final class SpringbootsitesClientImpl implements SpringbootsitesClient {
    ...
    public interface SpringbootsitesService {
        ...
        Mono<Response<SpringbootsitesModelInner>> getByResourceGroup(
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<SpringbootsitesModelInner>> createOrUpdate(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("springbootsitesName") String springbootsitesName,
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<SpringbootsitesModelInner>> delete(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("springbootsitesName") String springbootsitesName,
        ...
        @ExpectedResponses({200, 201})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<SpringbootsitesModelInner>> update(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("springbootsitesName") String springbootsitesName,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") SpringbootsitesPatch springbootsites,
            @HeaderParam("Accept") String accept,
            Context context);
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Flux<ByteBuffer>>> triggerRefreshSite(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @QueryParam("api-version") String apiVersion,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<SpringbootsitesListResult>> listByResourceGroup(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @QueryParam("api-version") String apiVersion,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<SpringbootsitesListResult>> list(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept,
    ...
    private Mono<Response<SpringbootsitesModelInner>> getByResourceGroupWithResponseAsync(
        String resourceGroupName, String springbootsitesName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<SpringbootsitesModelInner> getByResourceGroupAsync(
        String resourceGroupName, String springbootsitesName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<SpringbootsitesModelInner> getByResourceGroupWithResponse(
        String resourceGroupName, String springbootsitesName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<SpringbootsitesModelInner>> createOrUpdateWithResponseAsync(
        String resourceGroupName, String springbootsitesName, SpringbootsitesModelInner springbootsites) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<SpringbootsitesModelInner> createOrUpdateAsync(
        String resourceGroupName, String springbootsitesName, SpringbootsitesModelInner springbootsites) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<SpringbootsitesModelInner> createOrUpdateWithResponse(
        String resourceGroupName,
        String springbootsitesName,
        SpringbootsitesModelInner springbootsites,
        Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public SpringbootsitesModelInner createOrUpdate(
        String resourceGroupName, String springbootsitesName, SpringbootsitesModelInner springbootsites) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<SpringbootsitesModelInner>> deleteWithResponseAsync(
        String resourceGroupName, String springbootsitesName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<SpringbootsitesModelInner> deleteAsync(String resourceGroupName, String springbootsitesName) {
        return deleteWithResponseAsync(resourceGroupName, springbootsitesName)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<SpringbootsitesModelInner> deleteWithResponse(
        String resourceGroupName, String springbootsitesName, Context context) {
        return deleteWithResponseAsync(resourceGroupName, springbootsitesName, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public SpringbootsitesModelInner delete(String resourceGroupName, String springbootsitesName) {
        return deleteWithResponse(resourceGroupName, springbootsitesName, Context.NONE).getValue();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<SpringbootsitesModelInner>> updateWithResponseAsync(
        String resourceGroupName, String springbootsitesName, SpringbootsitesPatch springbootsites) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<SpringbootsitesModelInner> updateAsync(
        String resourceGroupName, String springbootsitesName, SpringbootsitesPatch springbootsites) {
        return updateWithResponseAsync(resourceGroupName, springbootsitesName, springbootsites)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<SpringbootsitesModelInner> updateWithResponse(
        String resourceGroupName, String springbootsitesName, SpringbootsitesPatch springbootsites, Context context) {
        return updateWithResponseAsync(resourceGroupName, springbootsitesName, springbootsites, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public SpringbootsitesModelInner update(
        String resourceGroupName, String springbootsitesName, SpringbootsitesPatch springbootsites) {
        return updateWithResponse(resourceGroupName, springbootsitesName, springbootsites, Context.NONE).getValue();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> triggerRefreshSiteWithResponseAsync(
        String resourceGroupName, String springbootsitesName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
    ...
    private PollerFlux<PollResult<Void>, Void> beginTriggerRefreshSiteAsync(
        String resourceGroupName, String springbootsitesName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<Void>, Void> beginTriggerRefreshSite(
        String resourceGroupName, String springbootsitesName) {
    ...
    private Mono<Void> triggerRefreshSiteAsync(String resourceGroupName, String springbootsitesName) {
        return beginTriggerRefreshSiteAsync(resourceGroupName, springbootsitesName)
            .last()
    ...
    private Mono<Void> triggerRefreshSiteAsync(String resourceGroupName, String springbootsitesName, Context context) {
        return beginTriggerRefreshSiteAsync(resourceGroupName, springbootsitesName, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<SpringbootsitesModelInner>> listByResourceGroupSinglePageAsync(
        String resourceGroupName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                ...
                context ->
                    service
                        .listByResourceGroup(
                            ...
                            accept,
                            context))
            .<PagedResponse<SpringbootsitesModelInner>>map(
                res ->
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<SpringbootsitesModelInner>> listByResourceGroupNextSinglePageAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<SpringbootsitesModelInner>> listBySubscriptionNextSinglePageAsync(
        String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
