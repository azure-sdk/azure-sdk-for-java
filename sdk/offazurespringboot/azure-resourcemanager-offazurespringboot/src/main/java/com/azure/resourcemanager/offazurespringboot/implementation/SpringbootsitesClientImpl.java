...
public final class SpringbootsitesClientImpl implements SpringbootsitesClient {
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String springbootsitesName) {
        return beginDeleteAsync(resourceGroupName, springbootsitesName)
            .last()
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String springbootsitesName, Context context) {
        return beginDeleteAsync(resourceGroupName, springbootsitesName, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private PollerFlux<PollResult<SpringbootsitesModelInner>, SpringbootsitesModelInner> beginUpdateAsync(
        ...
        return this
            .client
            .<SpringbootsitesModelInner, SpringbootsitesModelInner>getLroResult(
                mono,
                this.client.getHttpPipeline(),
                SpringbootsitesModelInner.class,
                SpringbootsitesModelInner.class,
    ...
    private Mono<SpringbootsitesModelInner> updateAsync(
        String resourceGroupName, String springbootsitesName, SpringbootsitesPatch springbootsites) {
        return beginUpdateAsync(resourceGroupName, springbootsitesName, springbootsites)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<SpringbootsitesModelInner> updateAsync(
        String resourceGroupName, String springbootsitesName, SpringbootsitesPatch springbootsites, Context context) {
        return beginUpdateAsync(resourceGroupName, springbootsitesName, springbootsites, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
