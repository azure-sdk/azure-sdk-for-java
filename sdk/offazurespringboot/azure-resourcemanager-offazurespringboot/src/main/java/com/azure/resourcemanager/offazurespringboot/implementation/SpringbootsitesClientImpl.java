...
import com.azure.resourcemanager.offazurespringboot.fluent.SpringbootsitesClient;
import com.azure.resourcemanager.offazurespringboot.fluent.models.SpringbootsitesModelInner;
import com.azure.resourcemanager.offazurespringboot.models.SpringbootsitesModelListResult;
...
public final class SpringbootsitesClientImpl implements SpringbootsitesClient {
    ...
    public interface SpringbootsitesService {
        ...
        Mono<Response<SpringbootsitesModelListResult>> list(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<SpringbootsitesModelListResult>> listByResourceGroup(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
        ...
        Mono<Response<SpringbootsitesModelInner>> createOrUpdate(@HostParam("$host") String endpoint,
            ...
            @BodyParam("application/json") SpringbootsitesModelInner resource, @HeaderParam("Accept") String accept,
            Context context);
        ...
        Mono<Response<Flux<ByteBuffer>>> update(@HostParam("$host") String endpoint,
            ...
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("springbootsitesName") String springbootsitesName,
            @BodyParam("application/json") SpringbootsitesModelUpdate properties, @HeaderParam("Accept") String accept,
            Context context);
        ...
        @Headers({ "Content-Type: application/json" })
        @Post("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OffAzureSpringBoot/springbootsites/{springbootsitesName}/triggerRefreshSite")
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<SpringbootsitesModelListResult>> listBySubscriptionNext(
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<SpringbootsitesModelListResult>> listByResourceGroupNext(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    }
     ...
     * @return the response of a SpringbootsitesModel list operation along with {@link PagedResponse} on successful
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the response of a SpringbootsitesModel list operation as paginated response with {@link PagedFlux}.
     */
    ...
    private Mono<Response<SpringbootsitesModelInner>> createOrUpdateWithResponseAsync(String resourceGroupName,
        String springbootsitesName, SpringbootsitesModelInner resource) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return FluxUtil
            .withContext(context -> service.createOrUpdate(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, springbootsitesName, resource, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<SpringbootsitesModelInner>> createOrUpdateWithResponseAsync(String resourceGroupName,
        String springbootsitesName, SpringbootsitesModelInner resource, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    private Mono<SpringbootsitesModelInner> createOrUpdateAsync(String resourceGroupName, String springbootsitesName,
        ...
        return createOrUpdateWithResponseAsync(resourceGroupName, springbootsitesName, resource)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
    ...
    public Response<SpringbootsitesModelInner> createOrUpdateWithResponse(String resourceGroupName,
        String springbootsitesName, SpringbootsitesModelInner resource, Context context) {
        return createOrUpdateWithResponseAsync(resourceGroupName, springbootsitesName, resource, context).block();
    }
    ...
    public SpringbootsitesModelInner createOrUpdate(String resourceGroupName, String springbootsitesName,
        SpringbootsitesModelInner resource) {
        return createOrUpdateWithResponse(resourceGroupName, springbootsitesName, resource, Context.NONE).getValue();
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> updateWithResponseAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(context -> service.update(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, springbootsitesName, properties, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> updateWithResponseAsync(String resourceGroupName,
        ...
        return service.update(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, springbootsitesName, properties, accept, context);
    }
    ...
    private PollerFlux<PollResult<SpringbootsitesModelInner>, SpringbootsitesModelInner>
        beginUpdateAsync(String resourceGroupName, String springbootsitesName, SpringbootsitesModelUpdate properties) {
        Mono<Response<Flux<ByteBuffer>>> mono
            = updateWithResponseAsync(resourceGroupName, springbootsitesName, properties);
    ...
    private PollerFlux<PollResult<SpringbootsitesModelInner>, SpringbootsitesModelInner> beginUpdateAsync(
        String resourceGroupName, String springbootsitesName, SpringbootsitesModelUpdate properties, Context context) {
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono
            = updateWithResponseAsync(resourceGroupName, springbootsitesName, properties, context);
        return this.client.<SpringbootsitesModelInner, SpringbootsitesModelInner>getLroResult(mono,
    ...
    public SyncPoller<PollResult<SpringbootsitesModelInner>, SpringbootsitesModelInner>
        beginUpdate(String resourceGroupName, String springbootsitesName, SpringbootsitesModelUpdate properties) {
        return this.beginUpdateAsync(resourceGroupName, springbootsitesName, properties).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<SpringbootsitesModelInner>, SpringbootsitesModelInner> beginUpdate(
        String resourceGroupName, String springbootsitesName, SpringbootsitesModelUpdate properties, Context context) {
        return this.beginUpdateAsync(resourceGroupName, springbootsitesName, properties, context).getSyncPoller();
    }
    ...
    private Mono<SpringbootsitesModelInner> updateAsync(String resourceGroupName, String springbootsitesName,
        ...
        return beginUpdateAsync(resourceGroupName, springbootsitesName, properties).last()
    ...
    private Mono<SpringbootsitesModelInner> updateAsync(String resourceGroupName, String springbootsitesName,
        ...
        return beginUpdateAsync(resourceGroupName, springbootsitesName, properties, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    public SpringbootsitesModelInner update(String resourceGroupName, String springbootsitesName,
        SpringbootsitesModelUpdate properties) {
        return updateAsync(resourceGroupName, springbootsitesName, properties).block();
    }
    ...
    public SpringbootsitesModelInner update(String resourceGroupName, String springbootsitesName,
        SpringbootsitesModelUpdate properties, Context context) {
        return updateAsync(resourceGroupName, springbootsitesName, properties, context).block();
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> deleteWithResponseAsync(String resourceGroupName,
        ...
        return service.delete(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, springbootsitesName, accept, context);
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> triggerRefreshSiteWithResponseAsync(String resourceGroupName,
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.triggerRefreshSite(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, springbootsitesName, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> triggerRefreshSiteWithResponseAsync(String resourceGroupName,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.triggerRefreshSite(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, springbootsitesName, accept, context);
    }
