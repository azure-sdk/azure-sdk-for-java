...
public final class SpringbootappsClientImpl implements SpringbootappsClient {
    ...
    private Mono<Response<SpringbootappsModelInner>> getWithResponseAsync(
        String resourceGroupName, String siteName, String springbootappsName) {
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<SpringbootappsModelInner>> getWithResponseAsync(
        String resourceGroupName, String siteName, String springbootappsName, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    private PollerFlux<PollResult<SpringbootappsModelInner>, SpringbootappsModelInner> beginUpdateAsync(
        ...
        return this
            .client
            .<SpringbootappsModelInner, SpringbootappsModelInner>getLroResult(
                mono,
                this.client.getHttpPipeline(),
                SpringbootappsModelInner.class,
                SpringbootappsModelInner.class,
    ...
    public SyncPoller<PollResult<SpringbootappsModelInner>, SpringbootappsModelInner> beginUpdate(
        ...
        Context context) {
        return this
            .beginUpdateAsync(resourceGroupName, siteName, springbootappsName, springbootapps, context)
            .getSyncPoller();
    }
    ...
    private Mono<SpringbootappsModelInner> updateAsync(
        String resourceGroupName, String siteName, String springbootappsName, SpringbootappsPatch springbootapps) {
        return beginUpdateAsync(resourceGroupName, siteName, springbootappsName, springbootapps)
            .last()
    ...
    private Mono<SpringbootappsModelInner> updateAsync(
        ...
        SpringbootappsPatch springbootapps,
        Context context) {
        return beginUpdateAsync(resourceGroupName, siteName, springbootappsName, springbootapps, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
