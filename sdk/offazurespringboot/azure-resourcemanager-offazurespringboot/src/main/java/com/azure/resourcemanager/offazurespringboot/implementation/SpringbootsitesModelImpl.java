    ...
    public SpringbootsitesModel apply() {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getSpringbootsites()
                .updateWithResponse(resourceGroupName, springbootsitesName, updateSpringbootsites, Context.NONE)
                .getValue();
        return this;
    }
    ...
    public SpringbootsitesModel apply(Context context) {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getSpringbootsites()
                .updateWithResponse(resourceGroupName, springbootsitesName, updateSpringbootsites, context)
                .getValue();
        return this;
    }

    SpringbootsitesModelImpl(
        SpringbootsitesModelInner innerObject,
