...
public interface Springbootservers {
     ...
     */
    Response<SpringbootserversModel> getWithResponse(
     ...
     */
    SpringbootserversModel get(String siteName, String resourceGroupName, String springbootserversName);
     ...
     */
    PagedIterable<SpringbootserversModel> listByResourceGroup(String siteName, String resourceGroupName);
     ...
     * @return the springbootservers list resource definition as paginated response with {@link PagedIterable}.
     */
    PagedIterable<SpringbootserversModel> listByResourceGroup(
