...
public interface Springbootservers {
     ...
     */
    PagedIterable<SpringbootserversModel> listBySubscription(String springbootsitesName);
     ...
     * @return the response of a SpringbootserversModel list operation as paginated response with {@link PagedIterable}.
     */
    PagedIterable<SpringbootserversModel> listBySubscription(String springbootsitesName, Context context);
     ...
     * @return the response of a SpringbootserversModel list operation as paginated response with {@link PagedIterable}.
     */
    PagedIterable<SpringbootserversModel> listBySpringbootsitesModel(String resourceGroupName,
     ...
     */
    Response<SpringbootserversModel> getWithResponse(String resourceGroupName, String springbootsitesName,
     ...
     */
    SpringbootserversModel get(String resourceGroupName, String springbootsitesName, String springbootserversName);
