...
import com.azure.resourcemanager.offazurespringboot.models.Springbootservers;
...
public final class SpringbootserversImpl implements Springbootservers {
    ...
    public PagedIterable<SpringbootserversModel> listBySubscription(String springbootsitesName) {
        PagedIterable<SpringbootserversModelInner> inner = this.serviceClient().listBySubscription(springbootsitesName);
        return Utils.mapPage(inner, inner1 -> new SpringbootserversModelImpl(inner1, this.manager()));
    }

    public PagedIterable<SpringbootserversModel> listBySubscription(String springbootsitesName, Context context) {
        PagedIterable<SpringbootserversModelInner> inner
            = this.serviceClient().listBySubscription(springbootsitesName, context);
        return Utils.mapPage(inner, inner1 -> new SpringbootserversModelImpl(inner1, this.manager()));
    }

    public PagedIterable<SpringbootserversModel> listBySpringbootsitesModel(String resourceGroupName,
    ...
    public Response<SpringbootserversModel> getWithResponse(String resourceGroupName, String springbootsitesName,
        String springbootserversName, Context context) {
        Response<SpringbootserversModelInner> inner = this.serviceClient().getWithResponse(resourceGroupName,
            springbootsitesName, springbootserversName, context);
        if (inner != null) {
    ...
    public SpringbootserversModel get(String resourceGroupName, String springbootsitesName,
        String springbootserversName) {
        SpringbootserversModelInner inner
            = this.serviceClient().get(resourceGroupName, springbootsitesName, springbootserversName);
        if (inner != null) {
    ...
    public void delete(String resourceGroupName, String springbootsitesName, String springbootserversName) {
        this.serviceClient().delete(resourceGroupName, springbootsitesName, springbootserversName);
    }

    public void delete(String resourceGroupName, String springbootsitesName, String springbootserversName,
        Context context) {
        this.serviceClient().delete(resourceGroupName, springbootsitesName, springbootserversName, context);
    }
    ...
    public SpringbootserversModel getById(String id) {
        ...
        String springbootsitesName = Utils.getValueFromIdByName(id, "springbootsites");
        if (springbootsitesName == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
                String.format("The resource ID '%s' is not valid. Missing path segment 'springbootsites'.", id)));
        }
        String springbootserversName = Utils.getValueFromIdByName(id, "springbootservers");
        if (springbootserversName == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
                String.format("The resource ID '%s' is not valid. Missing path segment 'springbootservers'.", id)));
        }
        return this.getWithResponse(resourceGroupName, springbootsitesName, springbootserversName, Context.NONE)
            .getValue();
    }
    ...
    public Response<SpringbootserversModel> getByIdWithResponse(String id, Context context) {
        ...
        return this.getWithResponse(resourceGroupName, springbootsitesName, springbootserversName, context);
    }
    ...
    public void deleteById(String id) {
        ...
        this.delete(resourceGroupName, springbootsitesName, springbootserversName, Context.NONE);
    }
    ...
    public void deleteByIdWithResponse(String id, Context context) {
        ...
        this.delete(resourceGroupName, springbootsitesName, springbootserversName, context);
    }
