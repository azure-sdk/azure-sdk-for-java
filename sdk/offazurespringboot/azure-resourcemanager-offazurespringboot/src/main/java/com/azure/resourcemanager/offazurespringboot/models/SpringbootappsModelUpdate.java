...
import com.azure.resourcemanager.offazurespringboot.fluent.models.SpringbootappsModelUpdateProperties;
import com.fasterxml.jackson.annotation.JsonProperty;
import java.time.OffsetDateTime;
import java.util.List;

/**
 * The type used for update operations of the SpringbootappsModel.
 */
@Fluent
public final class SpringbootappsModelUpdate {
    /*
     * The updatable properties of the SpringbootappsModel.
     */
    @JsonProperty(value = "properties")
    private SpringbootappsModelUpdateProperties innerProperties;

    /**
     * Creates an instance of SpringbootappsModelUpdate class.
     */
    public SpringbootappsModelUpdate() {
    }

    /**
     * Get the innerProperties property: The updatable properties of the SpringbootappsModel.
     * 
     ...
     * @return the SpringbootappsModelUpdate object itself.
     */
    public SpringbootappsModelUpdate withAppName(String appName) {
        if (this.innerProperties() == null) {
            this.innerProperties = new SpringbootappsModelUpdateProperties();
        }
     ...
     * @return the SpringbootappsModelUpdate object itself.
     */
    public SpringbootappsModelUpdate withArtifactName(String artifactName) {
        if (this.innerProperties() == null) {
            this.innerProperties = new SpringbootappsModelUpdateProperties();
        }
     ...
     * @return the SpringbootappsModelUpdate object itself.
     */
    public SpringbootappsModelUpdate withAppPort(Integer appPort) {
        if (this.innerProperties() == null) {
            this.innerProperties = new SpringbootappsModelUpdateProperties();
        }
     ...
     * @return the SpringbootappsModelUpdate object itself.
     */
    public SpringbootappsModelUpdate withAppType(String appType) {
        if (this.innerProperties() == null) {
            this.innerProperties = new SpringbootappsModelUpdateProperties();
        }
     ...
     * @return the SpringbootappsModelUpdate object itself.
     */
    public SpringbootappsModelUpdate withApplicationConfigurations(
     ...
     * @return the SpringbootappsModelUpdate object itself.
     */
    public SpringbootappsModelUpdate withBindingPorts(List<Integer> bindingPorts) {
        if (this.innerProperties() == null) {
            this.innerProperties = new SpringbootappsModelUpdateProperties();
        }
     ...
     * @return the SpringbootappsModelUpdate object itself.
     */
    public SpringbootappsModelUpdate withBuildJdkVersion(String buildJdkVersion) {
        if (this.innerProperties() == null) {
            this.innerProperties = new SpringbootappsModelUpdateProperties();
        }
     ...
     * @return the SpringbootappsModelUpdate object itself.
     */
    public SpringbootappsModelUpdate withCertificates(List<String> certificates) {
        if (this.innerProperties() == null) {
            this.innerProperties = new SpringbootappsModelUpdateProperties();
        }
     ...
     * @return the SpringbootappsModelUpdate object itself.
     */
    public SpringbootappsModelUpdate withChecksum(String checksum) {
        if (this.innerProperties() == null) {
            this.innerProperties = new SpringbootappsModelUpdateProperties();
        }
     ...
     * @return the SpringbootappsModelUpdate object itself.
     */
    public SpringbootappsModelUpdate withDependencies(List<String> dependencies) {
        if (this.innerProperties() == null) {
            this.innerProperties = new SpringbootappsModelUpdateProperties();
        }
     ...
     * @return the SpringbootappsModelUpdate object itself.
     */
    public SpringbootappsModelUpdate withEnvironments(List<String> environments) {
        if (this.innerProperties() == null) {
            this.innerProperties = new SpringbootappsModelUpdateProperties();
        }
     ...
     * @return the SpringbootappsModelUpdate object itself.
     */
    public SpringbootappsModelUpdate withInstanceCount(Integer instanceCount) {
        if (this.innerProperties() == null) {
            this.innerProperties = new SpringbootappsModelUpdateProperties();
        }
     ...
     * @return the SpringbootappsModelUpdate object itself.
     */
    public SpringbootappsModelUpdate withJarFileLocation(String jarFileLocation) {
        if (this.innerProperties() == null) {
            this.innerProperties = new SpringbootappsModelUpdateProperties();
        }
     ...
     * @return the SpringbootappsModelUpdate object itself.
     */
    public SpringbootappsModelUpdate withJvmMemoryInMB(Integer jvmMemoryInMB) {
        if (this.innerProperties() == null) {
            this.innerProperties = new SpringbootappsModelUpdateProperties();
        }
     ...
     * @return the SpringbootappsModelUpdate object itself.
     */
    public SpringbootappsModelUpdate withJvmOptions(List<String> jvmOptions) {
        if (this.innerProperties() == null) {
            this.innerProperties = new SpringbootappsModelUpdateProperties();
        }
     ...
     * @return the SpringbootappsModelUpdate object itself.
     */
    public SpringbootappsModelUpdate withMiscs(List<SpringbootappsPropertiesMiscsItem> miscs) {
        if (this.innerProperties() == null) {
            this.innerProperties = new SpringbootappsModelUpdateProperties();
        }
     ...
     * @return the SpringbootappsModelUpdate object itself.
     */
    public SpringbootappsModelUpdate withInstances(List<SpringbootappsPropertiesInstancesItem> instances) {
        if (this.innerProperties() == null) {
            this.innerProperties = new SpringbootappsModelUpdateProperties();
        }
     ...
     * @return the SpringbootappsModelUpdate object itself.
     */
    public SpringbootappsModelUpdate withRuntimeJdkVersion(String runtimeJdkVersion) {
        if (this.innerProperties() == null) {
            this.innerProperties = new SpringbootappsModelUpdateProperties();
        }
     ...
     * @return the SpringbootappsModelUpdate object itself.
     */
    public SpringbootappsModelUpdate withServers(List<String> servers) {
        if (this.innerProperties() == null) {
            this.innerProperties = new SpringbootappsModelUpdateProperties();
        }
     ...
     * @return the SpringbootappsModelUpdate object itself.
     */
    public SpringbootappsModelUpdate withMachineArmIds(List<String> machineArmIds) {
        if (this.innerProperties() == null) {
            this.innerProperties = new SpringbootappsModelUpdateProperties();
        }
     ...
     * @return the SpringbootappsModelUpdate object itself.
     */
    public SpringbootappsModelUpdate withSiteName(String siteName) {
        if (this.innerProperties() == null) {
            this.innerProperties = new SpringbootappsModelUpdateProperties();
        }
     ...
     * @return the SpringbootappsModelUpdate object itself.
     */
    public SpringbootappsModelUpdate withSpringBootVersion(String springBootVersion) {
        if (this.innerProperties() == null) {
            this.innerProperties = new SpringbootappsModelUpdateProperties();
        }
     ...
     * @return the SpringbootappsModelUpdate object itself.
     */
    public SpringbootappsModelUpdate withStaticContentLocations(List<String> staticContentLocations) {
        if (this.innerProperties() == null) {
            this.innerProperties = new SpringbootappsModelUpdateProperties();
        }
     ...
     * @return the SpringbootappsModelUpdate object itself.
     */
    public SpringbootappsModelUpdate withConnectionStrings(List<String> connectionStrings) {
        if (this.innerProperties() == null) {
            this.innerProperties = new SpringbootappsModelUpdateProperties();
        }
     ...
     * @return the SpringbootappsModelUpdate object itself.
     */
    public SpringbootappsModelUpdate withLastModifiedTime(OffsetDateTime lastModifiedTime) {
        if (this.innerProperties() == null) {
            this.innerProperties = new SpringbootappsModelUpdateProperties();
        }
     ...
     * @return the SpringbootappsModelUpdate object itself.
     */
    public SpringbootappsModelUpdate withLastUpdatedTime(OffsetDateTime lastUpdatedTime) {
        if (this.innerProperties() == null) {
            this.innerProperties = new SpringbootappsModelUpdateProperties();
        }
     ...
     * @return the SpringbootappsModelUpdate object itself.
     */
    public SpringbootappsModelUpdate withProvisioningState(ProvisioningState provisioningState) {
        if (this.innerProperties() == null) {
            this.innerProperties = new SpringbootappsModelUpdateProperties();
        }
     ...
     * @return the SpringbootappsModelUpdate object itself.
     */
    public SpringbootappsModelUpdate withErrors(List<Error> errors) {
        if (this.innerProperties() == null) {
            this.innerProperties = new SpringbootappsModelUpdateProperties();
        }
