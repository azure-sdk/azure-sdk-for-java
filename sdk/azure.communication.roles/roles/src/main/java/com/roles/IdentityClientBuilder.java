...
import com.roles.implementation.IdentityClientImpl;
 ...
 */
@ServiceClientBuilder(serviceClients = { IdentityClient.class, IdentityAsyncClient.class })
public final class IdentityClientBuilder implements HttpTrait<IdentityClientBuilder>,
    ...
    @Generated
    private static final Map<String, String> PROPERTIES = CoreUtils.getProperties("roles.properties");
    ...
    /**
     * Builds an instance of IdentityAsyncClient class.
     * 
     * @return an instance of IdentityAsyncClient.
     */
    @Generated
    public IdentityAsyncClient buildAsyncClient() {
        return new IdentityAsyncClient(buildInnerClient().getRoles());
    }

    /**
     * Builds an instance of IdentityClient class.
     * 
     * @return an instance of IdentityClient.
     */
    @Generated
    public IdentityClient buildClient() {
        return new IdentityClient(buildInnerClient().getRoles());
    }
