...
public final class RecommendedActionsClientImpl implements RecommendedActionsClient {
     ...
     */
    RecommendedActionsClientImpl(MariaDBManagementClientImpl client) {
        this.service =
    ...
    /**
     * The interface defining all the services for MariaDBManagementClientRecommendedActions to be used by the proxy
    ...
    private interface RecommendedActionsService {
        ...
        @Get(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforMariaDB"
                + "/servers/{serverName}/advisors/{advisorName}/recommendedActions/{recommendedActionName}")
        ...
        @Get(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforMariaDB"
                + "/servers/{serverName}/advisors/{advisorName}/recommendedActions")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
