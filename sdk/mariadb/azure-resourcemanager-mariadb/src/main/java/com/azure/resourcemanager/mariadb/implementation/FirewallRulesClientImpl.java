...
import com.azure.resourcemanager.mariadb.fluent.FirewallRulesClient;
...
public final class FirewallRulesClientImpl implements FirewallRulesClient {
     ...
     */
    FirewallRulesClientImpl(MariaDBManagementClientImpl client) {
        this.service =
    ...
    /**
     * The interface defining all the services for MariaDBManagementClientFirewallRules to be used by the proxy service
