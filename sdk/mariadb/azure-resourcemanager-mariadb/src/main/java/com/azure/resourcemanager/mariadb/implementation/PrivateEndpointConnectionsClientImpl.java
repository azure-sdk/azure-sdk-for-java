...
import com.azure.resourcemanager.mariadb.fluent.PrivateEndpointConnectionsClient;
...
public final class PrivateEndpointConnectionsClientImpl implements PrivateEndpointConnectionsClient {
     ...
     */
    PrivateEndpointConnectionsClientImpl(MariaDBManagementClientImpl client) {
        this.service =
            RestProxy
                .create(
    ...
    /**
     * The interface defining all the services for MariaDBManagementClientPrivateEndpointConnections to be used by the
