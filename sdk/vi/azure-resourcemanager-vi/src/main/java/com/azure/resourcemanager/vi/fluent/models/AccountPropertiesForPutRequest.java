...
public final class AccountPropertiesForPutRequest {
    ...
    /**
     * Get the accountId property: The account's data-plane ID. This can be set only when connecting an existing
     * classic account.
     * 
    ...
    /**
     * Set the accountId property: The account's data-plane ID. This can be set only when connecting an existing
     * classic account.
     * 
