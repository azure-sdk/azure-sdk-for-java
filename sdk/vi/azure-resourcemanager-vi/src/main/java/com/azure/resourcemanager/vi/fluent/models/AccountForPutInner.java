...
@Fluent
public final class AccountForPutInner extends Resource {
    /*
     ...
     * @return the AccountForPutInner object itself.
     */
    public AccountForPutInner withIdentity(ManagedServiceIdentity identity) {
    ...
    /** {@inheritDoc} */
    @Override
    public AccountForPutInner withLocation(String location) {
    ...
    /** {@inheritDoc} */
    @Override
    public AccountForPutInner withTags(Map<String, String> tags) {
        super.withTags(tags);
        return this;
    }
     ...
     * @return the AccountForPutInner object itself.
     */
    public AccountForPutInner withAccountId(String accountId) {
     ...
     * @return the AccountForPutInner object itself.
     */
    public AccountForPutInner withMediaServices(MediaServicesForPutRequest mediaServices) {
        if (this.innerProperties() == null) {
            this.innerProperties = new AccountPropertiesForPutRequest();
        }
