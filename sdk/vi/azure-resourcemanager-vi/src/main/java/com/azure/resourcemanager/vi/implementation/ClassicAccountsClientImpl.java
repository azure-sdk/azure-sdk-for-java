...
public final class ClassicAccountsClientImpl implements ClassicAccountsClient {
     ...
     * @return the properties of an Azure Video Analyzer for Media Classic account along with {@link Response} on
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the properties of an Azure Video Analyzer for Media Classic account on successful completion of {@link
     *     Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the properties of an Azure Video Analyzer for Media Classic account.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the properties of an Azure Video Analyzer for Media Classic account along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
