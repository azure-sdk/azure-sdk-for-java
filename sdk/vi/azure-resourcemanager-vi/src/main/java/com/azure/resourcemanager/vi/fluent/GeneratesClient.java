...
public interface GeneratesClient {
    ...
    Response<AccessTokenInner> accessTokenWithResponse(String resourceGroupName, String accountName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<AccessTokenInner> restrictedViewerAccessTokenWithResponse(String resourceGroupName, String accountName,
