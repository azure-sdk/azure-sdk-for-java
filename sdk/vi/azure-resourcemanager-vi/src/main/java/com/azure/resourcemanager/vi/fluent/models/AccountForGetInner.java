...
@Fluent
public final class AccountForGetInner extends Resource {
    /*
     * List of account properties
     */
    @JsonProperty(value = "properties")
    private AccountPropertiesForGetRequest innerProperties;
     ...
     * @return the AccountForGetInner object itself.
     */
    public AccountForGetInner withIdentity(ManagedServiceIdentity identity) {
    ...
    /** {@inheritDoc} */
    @Override
    public AccountForGetInner withLocation(String location) {
    ...
    /** {@inheritDoc} */
    @Override
    public AccountForGetInner withTags(Map<String, String> tags) {
        super.withTags(tags);
        return this;
    }
     ...
     * @return the AccountForGetInner object itself.
     */
    public AccountForGetInner withMediaServices(MediaServicesForPutRequest mediaServices) {
        if (this.innerProperties() == null) {
            this.innerProperties = new AccountPropertiesForGetRequest();
        }
