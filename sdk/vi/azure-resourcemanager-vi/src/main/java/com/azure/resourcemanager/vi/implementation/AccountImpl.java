...
import com.azure.resourcemanager.vi.models.AccountForPutRequest;
...
public final class AccountImpl implements Account, Account.Definition, Account.Update {
    ...
    private AccountForPutRequest createParameters;
    ...
    public Account create() {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getAccounts()
                .createOrUpdateWithResponse(resourceGroupName, accountName, createParameters, Context.NONE)
                .getValue();
        return this;
    }
    ...
    public Account create(Context context) {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getAccounts()
                .createOrUpdateWithResponse(resourceGroupName, accountName, createParameters, context)
                .getValue();
        return this;
    }
    ...
    AccountImpl(String name, com.azure.resourcemanager.vi.ViManager serviceManager) {
        ...
        this.createParameters = new AccountForPutRequest();
    }
    ...
    public AccountImpl withAccountId(String accountId) {
        this.createParameters.withAccountId(accountId);
        return this;
    }

    public AccountImpl withMediaServices(MediaServicesForPutRequest mediaServices) {
        this.createParameters.withMediaServices(mediaServices);
        return this;
    }
