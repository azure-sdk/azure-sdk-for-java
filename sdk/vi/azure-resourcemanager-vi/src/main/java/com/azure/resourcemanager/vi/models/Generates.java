...
public interface Generates {
     ...
     */
    Response<AccessToken> accessTokenWithResponse(String resourceGroupName, String accountName,
     ...
     * @return azure Video Indexer access token along with {@link Response}.
     */
    Response<AccessToken> restrictedViewerAccessTokenWithResponse(String resourceGroupName, String accountName,
