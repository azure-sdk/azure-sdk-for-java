...
public final class GeneratesClientImpl implements GeneratesClient {
    ...
    public interface GeneratesService {
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<AccessTokenInner>> restrictedViewerAccessToken(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("accountName") String accountName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<AccessTokenInner>> restrictedViewerAccessTokenWithResponseAsync(
        String resourceGroupName, String accountName, GenerateRestrictedViewerAccessTokenParameters parameters) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    private Mono<Response<AccessTokenInner>> restrictedViewerAccessTokenWithResponseAsync(
        ...
        String accountName,
        GenerateRestrictedViewerAccessTokenParameters parameters,
        Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<AccessTokenInner> restrictedViewerAccessTokenWithResponse(
        String resourceGroupName,
        String accountName,
        GenerateRestrictedViewerAccessTokenParameters parameters,
        Context context) {
