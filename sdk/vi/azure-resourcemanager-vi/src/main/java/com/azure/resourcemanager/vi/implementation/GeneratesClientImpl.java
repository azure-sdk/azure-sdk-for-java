...
public final class GeneratesClientImpl implements GeneratesClient {
     ...
     * @return azure Video Analyzer for Media access token along with {@link Response} on successful completion of
     *     {@link Mono}.
     */
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return azure Video Analyzer for Media access token on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return azure Video Analyzer for Media access token.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return azure Video Analyzer for Media access token along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
