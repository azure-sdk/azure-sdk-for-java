...
@Fluent
public final class AccountPropertiesReadOnly {
    /*
     ...
     * @return the AccountPropertiesReadOnly object itself.
     */
    public AccountPropertiesReadOnly withMediaServices(MediaServicesForPutRequest mediaServices) {
