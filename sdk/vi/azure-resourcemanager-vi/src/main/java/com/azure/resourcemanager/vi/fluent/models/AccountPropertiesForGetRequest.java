...
@Fluent
public final class AccountPropertiesForGetRequest {
    /*
     ...
     * @return the AccountPropertiesForGetRequest object itself.
     */
    public AccountPropertiesForGetRequest withMediaServices(MediaServicesForPutRequest mediaServices) {
