...
public final class GeneratesImpl implements Generates {
    ...
    public Response<AccessToken> accessTokenWithResponse(String resourceGroupName, String accountName,
    ...
    public Response<AccessToken> restrictedViewerAccessTokenWithResponse(String resourceGroupName, String accountName,
        GenerateRestrictedViewerAccessTokenParameters parameters, Context context) {
        Response<AccessTokenInner> inner = this.serviceClient()
