...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    OperationsClientImpl(HealthbotClientImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for HealthbotClientOperations to be used by the proxy service to perform
     * REST calls.
     */
    @Host("{$host}")
    ...
    public interface OperationsService {
        ...
        Mono<Response<AvailableOperations>> list(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<AvailableOperations>> listNext(@PathParam(value = "nextLink", encoded = true) String nextLink,
