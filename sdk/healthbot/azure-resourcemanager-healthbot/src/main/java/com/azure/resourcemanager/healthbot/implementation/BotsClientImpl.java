...
public final class BotsClientImpl implements BotsClient {
    ...
    private interface BotsService {
        ...
        @Post(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HealthBot"
                + "/healthBots/{botName}/listSecrets")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<HealthBotKeysResponseInner>> listSecrets(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("botName") String botName,
        ...
        @Post(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HealthBot"
                + "/healthBots/{botName}/regenerateApiJwtSecret")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<HealthBotKeyInner>> regenerateApiJwtSecret(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("botName") String botName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<HealthBotKeysResponseInner>> listSecretsWithResponseAsync(
        String resourceGroupName, String botName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
    ...
    public HealthBotKeysResponseInner listSecrets(String resourceGroupName, String botName) {
        return listSecretsAsync(resourceGroupName, botName).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<HealthBotKeysResponseInner> listSecretsWithResponse(
        String resourceGroupName, String botName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<HealthBotKeyInner>> regenerateApiJwtSecretWithResponseAsync(
        String resourceGroupName, String botName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
    ...
    public HealthBotKeyInner regenerateApiJwtSecret(String resourceGroupName, String botName) {
        return regenerateApiJwtSecretAsync(resourceGroupName, botName).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<HealthBotKeyInner> regenerateApiJwtSecretWithResponse(
        String resourceGroupName, String botName, Context context) {
