...
public class VectorQuery implements JsonSerializable<VectorQuery> {
     ...
     */
    @Generated
    public VectorQuery setK(Integer k) {
        this.k = k;
        return this;
    }
    ...
    /**
     * Get the filterOverride property: The OData filter expression to apply to this specific vector query. If no
     * filter expression is defined at the vector level, the expression defined in the
     * top level filter parameter is used instead.
     * 
    ...
    /**
     * Set the filterOverride property: The OData filter expression to apply to this specific vector query. If no
     * filter expression is defined at the vector level, the expression defined in the
     * top level filter parameter is used instead.
     * 
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("kind".equals(fieldName)) {
                    ...
                    deserializedVectorQuery.k = reader.getNullable(JsonReader::getInt);
