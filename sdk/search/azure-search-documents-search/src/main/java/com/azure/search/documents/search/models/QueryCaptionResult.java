...
public final class QueryCaptionResult implements JsonSerializable<QueryCaptionResult> {
    ...
    /**
     * Get the text property: A representative text passage extracted from the document most relevant to the
     * search query.
     * 
    ...
    /**
     * Get the highlights property: Same text passage as in the Text property with highlighted phrases most
     * relevant to the query.
     * 
