...
public final class SearchClient {
     ...
     * parameter value, such as `extractive|threshold-0.9`. Default threshold is 0.7. Allowed values: "none",
     * "extractive".</td></tr>
     ...
     * to `None`. Allowed values: "none", "extractive".</td></tr>
     ...
     *              (Optional){
     *                 kind: String(vector/text) (Required)
     *                 k: Integer (Optional)
    ...
    public SearchDocumentsResult searchGet(String indexName, String searchText, Boolean includeTotalResultCount,
        ...
        QueryAnswerType answers, QueryCaptionType captions, String semanticQuery) {
