...
public final class VectorizableImageBinaryQuery extends VectorQuery {
    ...
    /**
     * Get the base64Image property: The base 64 encoded binary of an image to be vectorized to perform a vector
     * search query.
     * 
    ...
    /**
     * Set the base64Image property: The base 64 encoded binary of an image to be vectorized to perform a vector
     * search query.
     * 
    ...
    @Generated
    @Override
    public VectorizableImageBinaryQuery setK(Integer k) {
        super.setK(k);
        return this;
    }
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("k".equals(fieldName)) {
                    deserializedVectorizableImageBinaryQuery.setK(reader.getNullable(JsonReader::getInt));
