...
public final class IndexingResult implements JsonSerializable<IndexingResult> {
     ...
     */
    @Generated
    private IndexingResult(String key, boolean status, int statusCode) {
        this.key = key;
        this.status = status;
    ...
    /**
     * Get the status property: A value indicating whether the indexing operation succeeded for the document
     * identified by the key.
     * 
    ...
    public static IndexingResult fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            IndexingResult deserializedIndexingResult = new IndexingResult(key, status, statusCode);
