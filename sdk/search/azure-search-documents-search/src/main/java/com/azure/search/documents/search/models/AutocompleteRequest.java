...
public final class AutocompleteRequest implements JsonSerializable<AutocompleteRequest> {
     ...
     */
    @Generated
    public AutocompleteRequest(String search, String suggesterName) {
        this.search = search;
        this.suggesterName = suggesterName;
    }

    /**
     * Get the search property: The search text on which to base autocomplete results.
     * 
    ...
    /**
     * Get the filter property: An OData expression that filters the documents used to produce completed terms
     * for the Autocomplete result.
     * 
    ...
    /**
     * Set the filter property: An OData expression that filters the documents used to produce completed terms
     * for the Autocomplete result.
     * 
    ...
    /**
     * Get the fuzzy property: A value indicating whether to use fuzzy matching for the autocomplete query.
     * Default is false. When set to true, the query will autocomplete terms even if
     * there's a substituted or missing character in the search text. While this
     * provides a better experience in some scenarios, it comes at a performance cost
     * as fuzzy autocomplete queries are slower and consume more resources.
    ...
    /**
     * Set the fuzzy property: A value indicating whether to use fuzzy matching for the autocomplete query.
     * Default is false. When set to true, the query will autocomplete terms even if
     * there's a substituted or missing character in the search text. While this
     * provides a better experience in some scenarios, it comes at a performance cost
     * as fuzzy autocomplete queries are slower and consume more resources.
     ...
     */
    @Generated
    public AutocompleteRequest setFuzzy(Boolean fuzzy) {
        this.fuzzy = fuzzy;
        return this;
    }
    ...
    /**
     * Get the top property: The number of auto-completed terms to retrieve. This must be a value between 1
     * and 100. The default is 5.
     * 
    ...
    /**
     * Set the top property: The number of auto-completed terms to retrieve. This must be a value between 1
     * and 100. The default is 5.
     * 
    ...
    public static AutocompleteRequest fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            AutocompleteRequest deserializedAutocompleteRequest = new AutocompleteRequest(search, suggesterName);
            deserializedAutocompleteRequest.autocompleteMode = autocompleteMode;
            deserializedAutocompleteRequest.filter = filter;
            deserializedAutocompleteRequest.fuzzy = fuzzy;
