...
import com.azure.search.documents.search.implementation.SearchClientImpl;
...
public final class SearchClientBuilder implements HttpTrait<SearchClientBuilder>,
    ...
    private static final Map<String, String> PROPERTIES
        = CoreUtils.getProperties("azure-search-documents-search.properties");
    ...
    public SearchAsyncClient buildAsyncClient() {
        return new SearchAsyncClient(buildInnerClient().getDocuments());
    }
    ...
    public SearchClient buildClient() {
        return new SearchClient(buildInnerClient().getDocuments());
    }
