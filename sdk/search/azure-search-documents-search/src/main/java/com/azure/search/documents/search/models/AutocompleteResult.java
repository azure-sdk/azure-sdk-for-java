...
public final class AutocompleteResult implements JsonSerializable<AutocompleteResult> {
     ...
     */
    @Generated
    private final List<AutocompleteItem> value;
     ...
     */
    @Generated
    private AutocompleteResult(List<AutocompleteItem> value) {
        this.value = value;
    }
    ...
    /**
     * Get the value property: The list of returned Autocompleted items.
     * 
     * @return the value value.
     */
    @Generated
    public List<AutocompleteItem> getValue() {
        return this.value;
    }
    ...
    public static AutocompleteResult fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            List<AutocompleteItem> value = null;
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("value".equals(fieldName)) {
                    value = reader.readArray(reader1 -> AutocompleteItem.fromJson(reader1));
            ...
            AutocompleteResult deserializedAutocompleteResult = new AutocompleteResult(value);
