...
public final class SearchDocumentsResult implements JsonSerializable<SearchDocumentsResult> {
     ...
     */
    @Generated
    private SearchDocumentsResult(List<SearchResult> value) {
        this.value = value;
    }

    /**
     * Get the count property: The total count of results found by the search operation, or null if the count
     * was not requested. If present, the count may be greater than the number of
     * results in this response. This can happen if you use the $top or $skip
     * parameters, or if the query can't return all the requested documents in a
     * single response.
    ...
    /**
     * Get the facets property: The facet query results for the search operation, organized as a collection of
     * buckets for each faceted field; null if the query did not include any facet
     * expressions.
     * 
    ...
    /**
     * Get the answers property: The answers query results for the search operation; null if the answers query
     * parameter was not specified or set to 'none'.
     * 
    ...
    /**
     * Get the nextLink property: Continuation URL returned when the query can't return all the requested results
     * in a single response. You can use this URL to formulate another GET or POST
     * Search request to get the next part of the search response. Make sure to use
     * the same verb (GET or POST) as the request that produced this response.
     * 
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeMapField("@search.facets", this.facets,
        ...
        jsonWriter.writeStringField("@search.semanticPartialResponseReason",
            this.semanticPartialResponseReason == null ? null : this.semanticPartialResponseReason.toString());
        jsonWriter.writeStringField("@search.semanticPartialResponseType",
            this.semanticPartialResponseType == null ? null : this.semanticPartialResponseType.toString());
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("value".equals(fieldName)) {
                    value = reader.readArray(reader1 -> SearchResult.fromJson(reader1));
            ...
            SearchDocumentsResult deserializedSearchDocumentsResult = new SearchDocumentsResult(value);
