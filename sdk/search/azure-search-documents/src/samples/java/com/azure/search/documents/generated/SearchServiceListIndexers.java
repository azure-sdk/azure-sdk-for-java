    ...
    public static void main(String[] args) {
        IndexersClient indexersClient
            = new SearchClientBuilder().credential(new DefaultAzureCredentialBuilder().build())
                ...
                .buildIndexersClient();
        // BEGIN:com.azure.search.documents.generated.indexerslist.searchservicelistindexers
        ListIndexersResult response = indexersClient.list("*");
        // END:com.azure.search.documents.generated.indexerslist.searchservicelistindexers
    }
}
