...
public final class DocumentsOperationsAsyncClient {
    @Generated
    private final DocumentsOperationsImpl serviceClient;

    /**
     * Initializes an instance of DocumentsOperationsAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    DocumentsOperationsAsyncClient(DocumentsOperationsImpl serviceClient) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Map<String, Object>> get(String key, String indexName, List<String> selectedFields) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Map<String, Object>> get(String key, String indexName) {
        // Generated convenience method for getWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getWithResponse(key, indexName, requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(TYPE_REFERENCE_MAP_STRING_OBJECT));
