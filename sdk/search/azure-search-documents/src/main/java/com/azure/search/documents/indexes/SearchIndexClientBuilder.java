...
public final class SearchIndexClientBuilder implements HttpTrait<SearchIndexClientBuilder>,
    ConfigurationTrait<SearchIndexClientBuilder>, TokenCredentialTrait<SearchIndexClientBuilder>,
    KeyCredentialTrait<SearchIndexClientBuilder>, EndpointTrait<SearchIndexClientBuilder> {
     ...
     *
     * @return an instance of SearchIndexAsyncClient.
     */
    @Generated
    public SearchIndexAsyncClient buildAsyncClient() {
        return new SearchIndexAsyncClient(buildInnerClient());
    }

    /**
     * Builds an instance of SearchIndexClient class.
     *
     * @return an instance of SearchIndexClient.
     */
    @Generated
    public SearchIndexClient buildClient() {
        return new SearchIndexClient(buildInnerClient());
    }
