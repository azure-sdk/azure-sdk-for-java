...
public final class SearchRequest implements JsonSerializable<SearchRequest> {
    ...
    /**
     * Get the searchText property: A full-text search query expression; Use "*" or omit this parameter to match
     * all documents.
     * 
    ...
    /**
     * Set the searchText property: A full-text search query expression; Use "*" or omit this parameter to match
     * all documents.
     * 
