...
/**
 * A builder for creating a new instance of the KnowledgeBaseRetrievalClient type.
 */
@ServiceClientBuilder(serviceClients = { KnowledgeBaseRetrievalClient.class, KnowledgeBaseRetrievalAsyncClient.class })
public final class KnowledgeBaseRetrievalClientBuilder implements HttpTrait<KnowledgeBaseRetrievalClientBuilder>,
    ConfigurationTrait<KnowledgeBaseRetrievalClientBuilder>, TokenCredentialTrait<KnowledgeBaseRetrievalClientBuilder>,
    KeyCredentialTrait<KnowledgeBaseRetrievalClientBuilder>, EndpointTrait<KnowledgeBaseRetrievalClientBuilder> {
    ...
    /**
     * Create an instance of the KnowledgeBaseRetrievalClientBuilder.
     */
    @Generated
    public KnowledgeBaseRetrievalClientBuilder() {
    ...
    @Generated
    @Override
    public KnowledgeBaseRetrievalClientBuilder httpClient(HttpClient httpClient) {
    ...
    @Generated
    @Override
    public KnowledgeBaseRetrievalClientBuilder pipeline(HttpPipeline pipeline) {
    ...
    @Generated
    @Override
    public KnowledgeBaseRetrievalClientBuilder httpLogOptions(HttpLogOptions httpLogOptions) {
    ...
    @Generated
    @Override
    public KnowledgeBaseRetrievalClientBuilder clientOptions(ClientOptions clientOptions) {
    ...
    @Generated
    @Override
    public KnowledgeBaseRetrievalClientBuilder retryOptions(RetryOptions retryOptions) {
    ...
    @Generated
    @Override
    public KnowledgeBaseRetrievalClientBuilder addPolicy(HttpPipelinePolicy customPolicy) {
    ...
    @Generated
    @Override
    public KnowledgeBaseRetrievalClientBuilder configuration(Configuration configuration) {
    ...
    @Generated
    @Override
    public KnowledgeBaseRetrievalClientBuilder credential(TokenCredential tokenCredential) {
    ...
    @Generated
    @Override
    public KnowledgeBaseRetrievalClientBuilder credential(KeyCredential keyCredential) {
    ...
    @Generated
    @Override
    public KnowledgeBaseRetrievalClientBuilder endpoint(String endpoint) {
    ...
    /**
     * Builds an instance of KnowledgeBaseRetrievalAsyncClient class.
     *
     * @return an instance of KnowledgeBaseRetrievalAsyncClient.
     */
    @Generated
    public KnowledgeBaseRetrievalAsyncClient buildAsyncClient() {
        return new KnowledgeBaseRetrievalAsyncClient(buildInnerClient());
    }

    /**
     * Builds an instance of KnowledgeBaseRetrievalClient class.
     *
     * @return an instance of KnowledgeBaseRetrievalClient.
     */
    @Generated
    public KnowledgeBaseRetrievalClient buildClient() {
        return new KnowledgeBaseRetrievalClient(buildInnerClient());
    }
