...
public final class AnalyzeRequest implements JsonSerializable<AnalyzeRequest> {
    ...
    /**
     * Get the analyzer property: The name of the analyzer to use to break the given text. If this parameter is
     * not specified, you must specify a tokenizer instead. The tokenizer and analyzer
     * parameters are mutually exclusive.
     * 
    ...
    /**
     * Set the analyzer property: The name of the analyzer to use to break the given text. If this parameter is
     * not specified, you must specify a tokenizer instead. The tokenizer and analyzer
     * parameters are mutually exclusive.
     * 
    ...
    /**
     * Get the tokenizer property: The name of the tokenizer to use to break the given text. If this parameter is
     * not specified, you must specify an analyzer instead. The tokenizer and analyzer
     * parameters are mutually exclusive.
     * 
    ...
    /**
     * Set the tokenizer property: The name of the tokenizer to use to break the given text. If this parameter is
     * not specified, you must specify an analyzer instead. The tokenizer and analyzer
     * parameters are mutually exclusive.
     * 
