...
/**
 * An instance of this class provides access to all the operations defined in IndexesOperations.
 */
public final class IndexesOperationsImpl {
    /**
    ...
    /**
     * Initializes an instance of IndexesOperationsImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    IndexesOperationsImpl(SearchClientImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for SearchClientIndexesOperations to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "SearchClientIndexesO")
     ...
     * @throws ResourceNotFoundException thrown if the request is rejected by server on status code 404.
     * @throws ResourceModifiedException thrown if the request is rejected by server on status code 409.
     * @return response from a List Indexes request along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
