...
/**
 * An instance of this class provides access to all the operations defined in IndexersOperations.
 */
public final class IndexersOperationsImpl {
    /**
     * The proxy service used to perform REST calls.
     */
    private final IndexersOperationsService service;
    ...
    /**
     * Initializes an instance of IndexersOperationsImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    IndexersOperationsImpl(SearchClientImpl client) {
        this.service = RestProxy.create(IndexersOperationsService.class, client.getHttpPipeline(),
    ...
    /**
     * The interface defining all the services for SearchClientIndexersOperations to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "SearchClientIndexers")
    public interface IndexersOperationsService {
     ...
     *             parsingMode: String(default/text/delimitedText/json/jsonArray/jsonLines) (Optional)
