...
public final class SearchDocumentsResult implements JsonSerializable<SearchDocumentsResult> {
    ...
    public static SearchDocumentsResult fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            SearchDocumentsResult deserializedSearchDocumentsResult = new SearchDocumentsResult();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("value".equals(fieldName)) {
                    List<SearchResult> results = reader.readArray(reader1 -> SearchResult.fromJson(reader1));
                    deserializedSearchDocumentsResult.results = results;
                } else if ("@odata.count".equals(fieldName)) {
                    deserializedSearchDocumentsResult.count = reader.getNullable(JsonReader::getLong);
                } else if ("@search.coverage".equals(fieldName)) {
                    deserializedSearchDocumentsResult.coverage = reader.getNullable(JsonReader::getDouble);
                    ...
                    deserializedSearchDocumentsResult.nextLink = reader.getString();
                } else if ("@search.semanticPartialResponseReason".equals(fieldName)) {
                    deserializedSearchDocumentsResult.semanticPartialResponseReason
                        = SemanticErrorReason.fromString(reader.getString());
