...
public class VectorQuery implements JsonSerializable<VectorQuery> {
    ...
    /**
     * Get the kNearestNeighbors property: Number of nearest neighbors to return as top hits.
     * 
     * @return the kNearestNeighbors value.
     */
    @Generated
     ...
     * 
     * @param kNearestNeighbors the kNearestNeighbors value to set.
     * @return the VectorQuery object itself.
     */
    @Generated
    public VectorQuery setKNearestNeighbors(Integer kNearestNeighbors) {
        this.kNearestNeighbors = kNearestNeighbors;
        return this;
    }

    /**
     * Get the fields property: Vector Fields of type Collection(Edm.Single) to be included in the vector
     * searched.
     * 
    ...
    /**
     * Set the fields property: Vector Fields of type Collection(Edm.Single) to be included in the vector
     * searched.
     * 
    ...
    /**
     * Get the weight property: Relative weight of the vector query when compared to other vector query and/or
     * the text query within the same search request. This value is used when
     * combining the results of multiple ranking lists produced by the different
     * vector queries and/or the results retrieved through the text query. The higher
     * the weight, the higher the documents that matched that query will be in the
    ...
    /**
     * Set the weight property: Relative weight of the vector query when compared to other vector query and/or
     * the text query within the same search request. This value is used when
     * combining the results of multiple ranking lists produced by the different
     * vector queries and/or the results retrieved through the text query. The higher
     * the weight, the higher the documents that matched that query will be in the
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeNumberField("k", this.kNearestNeighbors);
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("kind".equals(fieldName)) {
                    ...
                    deserializedVectorQuery.kNearestNeighbors = reader.getNullable(JsonReader::getInt);
