...
public class VectorQuery implements JsonSerializable<VectorQuery> {
    /*
     * Discriminator property for VectorQuery.
     */
    @Generated
    private String kind = "VectorQuery";
    ...
    /**
     * Get the kind property: Discriminator property for VectorQuery.
     * 
    ...
    static VectorQuery fromJsonKnownDiscriminator(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("kind".equals(fieldName)) {
                    deserializedVectorQuery.kind = reader.getString();
