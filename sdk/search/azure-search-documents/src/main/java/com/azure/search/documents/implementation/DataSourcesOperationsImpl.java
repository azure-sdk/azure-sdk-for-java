...
/**
 * An instance of this class provides access to all the operations defined in DataSourcesOperations.
 */
public final class DataSourcesOperationsImpl {
    /**
     * The proxy service used to perform REST calls.
     */
    private final DataSourcesOperationsService service;
    ...
    /**
     * Initializes an instance of DataSourcesOperationsImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    DataSourcesOperationsImpl(SearchClientImpl client) {
        this.service = RestProxy.create(DataSourcesOperationsService.class, client.getHttpPipeline(),
    ...
    /**
     * The interface defining all the services for SearchClientDataSourcesOperations to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "SearchClientDataSour")
    public interface DataSourcesOperationsService {
     ...
     *     type: String(azuresql/cosmosdb/azureblob/azuretable/mysql/adlsgen2) (Required)
