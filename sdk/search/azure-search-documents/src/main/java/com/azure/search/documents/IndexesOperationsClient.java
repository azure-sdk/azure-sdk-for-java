...
public final class IndexesOperationsClient {
    @Generated
    private final IndexesOperationsImpl serviceClient;

    /**
     * Initializes an instance of IndexesOperationsClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    IndexesOperationsClient(IndexesOperationsImpl serviceClient) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ListIndexesResult list(String select) {
        // Generated convenience method for listWithResponse
        RequestOptions requestOptions = new RequestOptions();
        if (select != null) {
            requestOptions.addQueryParam("$select", select, false);
        }
        return listWithResponse(requestOptions).getValue().toObject(ListIndexesResult.class);
    }
