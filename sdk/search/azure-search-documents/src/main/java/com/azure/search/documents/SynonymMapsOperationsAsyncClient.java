...
public final class SynonymMapsOperationsAsyncClient {
    @Generated
    private final SynonymMapsOperationsImpl serviceClient;

    /**
     * Initializes an instance of SynonymMapsOperationsAsyncClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    SynonymMapsOperationsAsyncClient(SynonymMapsOperationsImpl serviceClient) {
