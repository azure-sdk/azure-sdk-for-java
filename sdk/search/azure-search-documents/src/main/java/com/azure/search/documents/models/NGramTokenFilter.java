...
public final class NGramTokenFilter extends TokenFilter {
    ...
    public static NGramTokenFilter fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            NGramTokenFilter deserializedNGramTokenFilter = new NGramTokenFilter(name);
            deserializedNGramTokenFilter.odataType = odataType;
            deserializedNGramTokenFilter.minGram = minGram;
            deserializedNGramTokenFilter.maxGram = maxGram;
