...
public final class SearchServiceCreateIndexerTests extends SearchClientTestBase {
    ...
    public void testSearchServiceCreateIndexerTests() {
        // method invocation
        SearchIndexer response = indexersClient
            .create(new SearchIndexer("myindexer", "mydatasource", "orders").setDescription("an indexer")
        ...
        Assertions.assertEquals("an indexer", response.getDescription());
