...
public final class SearchIndexerWarning implements JsonSerializable<SearchIndexerWarning> {
     ...
     */
    @Generated
    private SearchIndexerWarning(String message) {
    ...
    /**
     * Get the name property: The name of the source at which the warning originated. For example, this could
     * refer to a particular skill in the attached skillset. This may not be always
     * available.
     * 
    ...
    /**
     * Get the details property: Additional, verbose details about the warning to assist in debugging the
     * indexer. This may not be always available.
     * 
