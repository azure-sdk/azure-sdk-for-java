...
import com.azure.search.documents.indexes.implementation.SearchClientImpl;
...
@ServiceClientBuilder(
    serviceClients = {
        ...
        IndexersClient.class,
        SkillsetsClient.class,
        SynonymMapsClient.class,
        IndexesClient.class,
        AliasesClient.class,
        SearchAsyncClient.class,
        DataSourcesAsyncClient.class,
        IndexersAsyncClient.class,
        SkillsetsAsyncClient.class,
        SynonymMapsAsyncClient.class,
...
public final class SearchClientBuilder implements HttpTrait<SearchClientBuilder>,
    ...
    private static final Map<String, String> PROPERTIES
        = CoreUtils.getProperties("azure-search-documents-indexes.properties");
    ...
    /**
     * Builds an instance of DataSourcesAsyncClient class.
     * 
    ...
    /**
     * Builds an instance of IndexersAsyncClient class.
     * 
     * @return an instance of IndexersAsyncClient.
     */
    @Generated
    public IndexersAsyncClient buildIndexersAsyncClient() {
        return new IndexersAsyncClient(buildInnerClient().getIndexers());
    }

    /**
     * Builds an instance of SkillsetsAsyncClient class.
     * 
     * @return an instance of SkillsetsAsyncClient.
     */
    @Generated
    public SkillsetsAsyncClient buildSkillsetsAsyncClient() {
        return new SkillsetsAsyncClient(buildInnerClient().getSkillsets());
    }

    /**
     * Builds an instance of SynonymMapsAsyncClient class.
     * 
     * @return an instance of SynonymMapsAsyncClient.
     */
    @Generated
    public SynonymMapsAsyncClient buildSynonymMapsAsyncClient() {
        return new SynonymMapsAsyncClient(buildInnerClient().getSynonymMaps());
    }
    ...
    /**
     * Builds an instance of DataSourcesClient class.
     * 
    ...
    /**
     * Builds an instance of IndexersClient class.
     * 
     * @return an instance of IndexersClient.
     */
    @Generated
    public IndexersClient buildIndexersClient() {
        return new IndexersClient(buildInnerClient().getIndexers());
    }

    /**
     * Builds an instance of SkillsetsClient class.
     * 
     * @return an instance of SkillsetsClient.
     */
    @Generated
    public SkillsetsClient buildSkillsetsClient() {
        return new SkillsetsClient(buildInnerClient().getSkillsets());
    }

    /**
     * Builds an instance of SynonymMapsClient class.
     * 
     * @return an instance of SynonymMapsClient.
     */
    @Generated
    public SynonymMapsClient buildSynonymMapsClient() {
        return new SynonymMapsClient(buildInnerClient().getSynonymMaps());
    }
