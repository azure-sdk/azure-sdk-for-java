...
public final class MagnitudeScoringFunction extends ScoringFunction {
     ...
     */
    @Generated
    private final MagnitudeScoringParameters magnitude;
     ...
     * @param magnitude the magnitude value to set.
     */
    @Generated
    public MagnitudeScoringFunction(String fieldName, double boost, MagnitudeScoringParameters magnitude) {
    ...
    /**
     * Get the magnitude property: Parameter values for the magnitude scoring function.
     * 
     * @return the magnitude value.
     */
    @Generated
    public MagnitudeScoringParameters getMagnitude() {
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeJsonField("magnitude", this.magnitude);
    ...
    public static MagnitudeScoringFunction fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            MagnitudeScoringParameters magnitude = null;
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("fieldName".equals(jsonFieldName)) {
                    ...
                    magnitude = MagnitudeScoringParameters.fromJson(reader);
            ...
            MagnitudeScoringFunction deserializedMagnitudeScoringFunction
                = new MagnitudeScoringFunction(fieldName, boost, magnitude);
