...
public final class SearchIndexer implements JsonSerializable<SearchIndexer> {
    ...
    /**
     * Get the disabled property: A value indicating whether the indexer is disabled. Default is false.
     * 
    ...
    /**
     * Set the disabled property: A value indicating whether the indexer is disabled. Default is false.
     * 
     * @param disabled the disabled value to set.
     * @return the SearchIndexer object itself.
     */
    @Generated
    public SearchIndexer setDisabled(Boolean disabled) {
    ...
    /**
     * Get the cache property: Adds caching to an enrichment pipeline to allow for incremental modification
     * steps without having to rebuild the index every time.
     * 
    ...
    /**
     * Set the cache property: Adds caching to an enrichment pipeline to allow for incremental modification
     * steps without having to rebuild the index every time.
     * 
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("name".equals(fieldName)) {
                    ...
                    disabled = reader.getNullable(JsonReader::getBoolean);
            ...
            SearchIndexer deserializedSearchIndexer = new SearchIndexer(name, dataSourceName, targetIndexName);
            ...
            deserializedSearchIndexer.disabled = disabled;
