...
public final class PIIDetectionSkill extends SearchIndexerSkill {
    ...
    /**
     * Get the maskingMode property: A parameter that provides various ways to mask the personal information
     * detected in the input text. Default is 'none'.
     * 
    ...
    /**
     * Set the maskingMode property: A parameter that provides various ways to mask the personal information
     * detected in the input text. Default is 'none'.
     * 
    ...
    /**
     * Get the mask property: The character used to mask the text if the maskingMode parameter is set to
     * replace. Default is '*'.
     * 
    ...
    /**
     * Set the mask property: The character used to mask the text if the maskingMode parameter is set to
     * replace. Default is '*'.
     * 
