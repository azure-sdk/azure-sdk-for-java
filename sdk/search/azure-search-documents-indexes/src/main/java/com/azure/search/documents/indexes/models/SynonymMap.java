...
public final class SynonymMap implements JsonSerializable<SynonymMap> {
     ...
     */
    @Generated
    private final String format = "solr";
    ...
    /**
     * Get the synonyms property: A series of synonym rules in the specified synonym map format. The rules must
     * be separated by newlines.
     * 
    ...
    public static SynonymMap fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            SynonymMap deserializedSynonymMap = new SynonymMap(name, synonyms);
            deserializedSynonymMap.encryptionKey = encryptionKey;
            deserializedSynonymMap.eTag = eTag;
