...
public final class CommonGramTokenFilter extends TokenFilter {
    ...
    /**
     * Get the queryMode property: A value that indicates whether the token filter is in query mode. When in query
     * mode, the token filter generates bigrams and then removes common words and
     * single terms followed by a common word. Default is false.
     * 
    ...
    /**
     * Set the queryMode property: A value that indicates whether the token filter is in query mode. When in query
     * mode, the token filter generates bigrams and then removes common words and
     * single terms followed by a common word. Default is false.
     * 
     ...
     */
    @Generated
    public CommonGramTokenFilter setQueryMode(Boolean queryMode) {
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeBooleanField("queryMode", this.queryMode);
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("name".equals(fieldName)) {
                    ...
                    queryMode = reader.getNullable(JsonReader::getBoolean);
                } else {
                    reader.skipChildren();
                }
            }
            ...
            deserializedCommonGramTokenFilter.ignoreCase = ignoreCase;
            deserializedCommonGramTokenFilter.queryMode = queryMode;
