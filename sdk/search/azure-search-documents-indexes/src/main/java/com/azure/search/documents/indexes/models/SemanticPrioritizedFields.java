...
public final class SemanticPrioritizedFields implements JsonSerializable<SemanticPrioritizedFields> {
    ...
    /**
     * Get the titleField property: Defines the title field to be used for semantic ranking, captions, highlights,
     * and answers. If you don't have a title field in your index, leave this blank.
     * 
    ...
    /**
     * Set the titleField property: Defines the title field to be used for semantic ranking, captions, highlights,
     * and answers. If you don't have a title field in your index, leave this blank.
     * 
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeArrayField("prioritizedContentFields", this.prioritizedContentFields,
            (writer, element) -> writer.writeJson(element));
        jsonWriter.writeArrayField("prioritizedKeywordsFields", this.prioritizedKeywordsFields,
            (writer, element) -> writer.writeJson(element));
