...
public final class VectorSearch implements JsonSerializable<VectorSearch> {
    ...
    /**
     * Get the algorithms property: Contains configuration options specific to the algorithm used during indexing
     * or querying.
     * 
    ...
    /**
     * Set the algorithms property: Contains configuration options specific to the algorithm used during indexing
     * or querying.
     * 
