...
public final class IndexingParametersConfiguration implements JsonSerializable<IndexingParametersConfiguration> {
     ...
     * still index storage metadata for
     * blob content that is too large to process. Oversized blobs are treated as
     * errors by default. For limits on blob size, see
     * https://learn.microsoft.com/azure/search/search-limits-quotas-capacity.
     * 
    ...
    /**
     * Get the documentRoot property: For JSON arrays, given a structured or semi-structured document, you can
     * specify a path to the array using this property.
     * 
    ...
    /**
     * Set the documentRoot property: For JSON arrays, given a structured or semi-structured document, you can
     * specify a path to the array using this property.
     * 
    ...
    /**
     * Get the imageAction property: Determines how to process embedded images and image files in Azure blob
     * storage. Setting the "imageAction" configuration to any value other than
     * "none" requires that a skillset also be attached to that indexer.
     * 
    ...
    /**
     * Set the imageAction property: Determines how to process embedded images and image files in Azure blob
     * storage. Setting the "imageAction" configuration to any value other than
     * "none" requires that a skillset also be attached to that indexer.
     * 
     ...
     */
    @Generated
    public IndexingParametersConfiguration setAdditionalProperties(Map<String, BinaryData> additionalProperties) {
