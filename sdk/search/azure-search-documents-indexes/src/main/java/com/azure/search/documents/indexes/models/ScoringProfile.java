...
public final class ScoringProfile implements JsonSerializable<ScoringProfile> {
    ...
    /**
     * Get the text property: Parameters that boost scoring based on text matches in certain index fields.
     * 
     * @return the text value.
     */
    @Generated
    public TextWeights getText() {
        return this.text;
    }

    /**
     * Set the text property: Parameters that boost scoring based on text matches in certain index fields.
     * 
     * @param text the text value to set.
     * @return the ScoringProfile object itself.
     */
    @Generated
    public ScoringProfile setText(TextWeights text) {
        this.text = text;
        return this;
    }
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("name".equals(fieldName)) {
                    ...
                    text = TextWeights.fromJson(reader);
            ...
            deserializedScoringProfile.text = text;
