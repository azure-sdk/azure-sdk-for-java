...
public final class MagnitudeScoringParameters implements JsonSerializable<MagnitudeScoringParameters> {
     ...
     */
    @Generated
    private Boolean constantBoostBeyondRange;
    ...
    /**
     * Get the constantBoostBeyondRange property: A value indicating whether to apply a constant boost for field values
     * beyond
     * the range end value; default is false.
     * 
     * @return the constantBoostBeyondRange value.
     */
    @Generated
    public Boolean isConstantBoostBeyondRange() {
        return this.constantBoostBeyondRange;
    }

    /**
     * Set the constantBoostBeyondRange property: A value indicating whether to apply a constant boost for field values
     * beyond
     * the range end value; default is false.
     * 
     * @param constantBoostBeyondRange the constantBoostBeyondRange value to set.
     * @return the MagnitudeScoringParameters object itself.
     */
    @Generated
    public MagnitudeScoringParameters setConstantBoostBeyondRange(Boolean constantBoostBeyondRange) {
        this.constantBoostBeyondRange = constantBoostBeyondRange;
        return this;
    }
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeBooleanField("constantBoostBeyondRange", this.constantBoostBeyondRange);
    ...
    public static MagnitudeScoringParameters fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            Boolean constantBoostBeyondRange = null;
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("boostingRangeStart".equals(fieldName)) {
                    ...
                    constantBoostBeyondRange = reader.getNullable(JsonReader::getBoolean);
                } else {
                    reader.skipChildren();
                }
            }
            ...
            deserializedMagnitudeScoringParameters.constantBoostBeyondRange = constantBoostBeyondRange;
