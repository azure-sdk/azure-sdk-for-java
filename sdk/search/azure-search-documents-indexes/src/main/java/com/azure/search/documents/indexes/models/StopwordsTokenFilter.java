...
public final class StopwordsTokenFilter extends TokenFilter {
    ...
    /**
     * Get the stopwords property: The list of stopwords. This property and the stopwords list property cannot
     * both be set.
     * 
    ...
    /**
     * Set the stopwords property: The list of stopwords. This property and the stopwords list property cannot
     * both be set.
     * 
    ...
    /**
     * Get the removeTrailing property: A value indicating whether to ignore the last search term if it's a stop word.
     * Default is true.
     * 
     * @return the removeTrailing value.
     */
    @Generated
    public Boolean isRemoveTrailing() {
        return this.removeTrailing;
    }

    /**
     * Set the removeTrailing property: A value indicating whether to ignore the last search term if it's a stop word.
     * Default is true.
     * 
     * @param removeTrailing the removeTrailing value to set.
     * @return the StopwordsTokenFilter object itself.
     */
    @Generated
    public StopwordsTokenFilter setRemoveTrailing(Boolean removeTrailing) {
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeBooleanField("removeTrailing", this.removeTrailing);
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("name".equals(fieldName)) {
                    ...
                    removeTrailing = reader.getNullable(JsonReader::getBoolean);
                } else {
                    reader.skipChildren();
                }
            }
            ...
            deserializedStopwordsTokenFilter.ignoreCase = ignoreCase;
            deserializedStopwordsTokenFilter.removeTrailing = removeTrailing;
