...
public final class FieldMappingFunction implements JsonSerializable<FieldMappingFunction> {
    ...
    /**
     * Get the parameters property: A dictionary of parameter name/value pairs to pass to the function. Each value
     * must be of a primitive type.
     * 
    ...
    /**
     * Set the parameters property: A dictionary of parameter name/value pairs to pass to the function. Each value
     * must be of a primitive type.
     * 
     ...
     */
    @Generated
    public FieldMappingFunction setParameters(Map<String, BinaryData> parameters) {
