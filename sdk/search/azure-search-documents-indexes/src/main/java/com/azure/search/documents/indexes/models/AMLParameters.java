...
public final class AMLParameters implements JsonSerializable<AMLParameters> {
     ...
     */
    @Generated
    public AMLParameters(String uri) {
        this.uri = uri;
    }

    /**
     * Get the uri property: (Required for no authentication or key authentication) The scoring URI of the
     * AML service to which the JSON payload will be sent. Only the https URI scheme
     * is allowed.
     * 
    ...
    /**
     * Get the key property: (Required for key authentication) The key for the AML service.
     * 
    ...
    /**
     * Set the key property: (Required for key authentication) The key for the AML service.
     * 
     * @param key the key value to set.
     * @return the AMLParameters object itself.
     */
    @Generated
    public AMLParameters setKey(String key) {
        this.key = key;
        return this;
    }

    /**
     * Get the resourceId property: (Required for token authentication). The Azure Resource Manager resource ID of
     * the AML service. It should be in the format
    ...
    /**
     * Set the resourceId property: (Required for token authentication). The Azure Resource Manager resource ID of
     * the AML service. It should be in the format
     * subscriptions/{guid}/resourceGroups/{resource-group-name}/Microsoft.MachineLearningServices/workspaces/{workspace-name}/services/{service_name}.
     * 
    ...
    /**
     * Get the timeout property: (Optional) When specified, indicates the timeout for the http client making the
     * API call.
     * 
    ...
    /**
     * Set the timeout property: (Optional) When specified, indicates the timeout for the http client making the
     * API call.
     * 
    ...
    /**
     * Get the modelName property: The name of the embedding model from the Azure AI Foundry Catalog that is
     * deployed at the provided endpoint.
     * 
    ...
    /**
     * Set the modelName property: The name of the embedding model from the Azure AI Foundry Catalog that is
     * deployed at the provided endpoint.
     * 
     ...
     */
    @Generated
    public AMLParameters setModelName(AIFoundryModelCatalogName modelName) {
    ...
    public static AMLParameters fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            AMLParameters deserializedAMLParameters = new AMLParameters(uri);
            deserializedAMLParameters.key = key;
