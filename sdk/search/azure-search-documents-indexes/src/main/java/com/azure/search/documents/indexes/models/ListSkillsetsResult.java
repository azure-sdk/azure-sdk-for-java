...
public final class ListSkillsetsResult implements JsonSerializable<ListSkillsetsResult> {
     ...
     */
    @Generated
    private final List<SearchIndexerSkillset> value;
     ...
     */
    @Generated
    private ListSkillsetsResult(List<SearchIndexerSkillset> value) {
        this.value = value;
    }

    /**
     * Get the value property: The skillsets defined in the Search service.
     * 
     * @return the value value.
     */
    @Generated
    public List<SearchIndexerSkillset> getValue() {
        return this.value;
    }
    ...
    public static ListSkillsetsResult fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            List<SearchIndexerSkillset> value = null;
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("value".equals(fieldName)) {
                    value = reader.readArray(reader1 -> SearchIndexerSkillset.fromJson(reader1));
                } else {
                    reader.skipChildren();
                }
            }
