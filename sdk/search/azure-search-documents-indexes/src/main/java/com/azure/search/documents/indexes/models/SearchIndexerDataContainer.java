...
public final class SearchIndexerDataContainer implements JsonSerializable<SearchIndexerDataContainer> {
    ...
    /**
     * Get the name property: The name of the table or view (for Azure SQL data source) or collection (for
     * CosmosDB data source) that will be indexed.
     * 
    ...
    /**
     * Get the query property: A query that is applied to this data container. The syntax and meaning of this
     * parameter is datasource-specific. Not supported by Azure SQL datasources.
     * 
    ...
    /**
     * Set the query property: A query that is applied to this data container. The syntax and meaning of this
     * parameter is datasource-specific. Not supported by Azure SQL datasources.
     * 
