...
public final class SearchIndexerSkillset implements JsonSerializable<SearchIndexerSkillset> {
     ...
     */
    @Generated
    private final List<SearchIndexerSkill> skills;

    /*
     * Details about the Azure AI service to be used when running skills.
     */
    @Generated
    private CognitiveServicesAccount cognitiveServices;
     ...
     */
    @Generated
    private SearchIndexerIndexProjection indexProjections;
    ...
    /**
     * Get the cognitiveServices property: Details about the Azure AI service to be used when running skills.
     * 
     * @return the cognitiveServices value.
     */
    @Generated
    public CognitiveServicesAccount getCognitiveServices() {
        return this.cognitiveServices;
    }

    /**
     * Set the cognitiveServices property: Details about the Azure AI service to be used when running skills.
     * 
     * @param cognitiveServices the cognitiveServices value to set.
     * @return the SearchIndexerSkillset object itself.
     */
    @Generated
    public SearchIndexerSkillset setCognitiveServices(CognitiveServicesAccount cognitiveServices) {
     ...
     */
    @Generated
    public SearchIndexerIndexProjection getIndexProjections() {
     ...
     */
    @Generated
    public SearchIndexerSkillset setIndexProjections(SearchIndexerIndexProjection indexProjections) {
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeJsonField("cognitiveServices", this.cognitiveServices);
    ...
    public static SearchIndexerSkillset fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            CognitiveServicesAccount cognitiveServices = null;
            SearchIndexerKnowledgeStore knowledgeStore = null;
            SearchIndexerIndexProjection indexProjections = null;
            String eTag = null;
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("name".equals(fieldName)) {
                    ...
                    cognitiveServices = CognitiveServicesAccount.fromJson(reader);
                    ...
                    indexProjections = SearchIndexerIndexProjection.fromJson(reader);
            ...
            SearchIndexerSkillset deserializedSearchIndexerSkillset = new SearchIndexerSkillset(name, skills);
            deserializedSearchIndexerSkillset.description = description;
            deserializedSearchIndexerSkillset.cognitiveServices = cognitiveServices;
