        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("name".equals(fieldName)) {
                    ...
                    catenateWords = reader.getNullable(JsonReader::getBoolean);
                } else if ("catenateNumbers".equals(fieldName)) {
                    catenateNumbers = reader.getNullable(JsonReader::getBoolean);
            ...
            deserializedWordDelimiterTokenFilter.catenateWords = catenateWords;
            deserializedWordDelimiterTokenFilter.catenateNumbers = catenateNumbers;
