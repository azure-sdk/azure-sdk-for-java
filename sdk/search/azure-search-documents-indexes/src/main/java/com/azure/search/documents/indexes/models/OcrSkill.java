...
public final class OcrSkill extends SearchIndexerSkill {
    ...
    /**
     * Get the detectOrientation property: A value indicating to turn orientation detection on or not. Default is false.
     * 
     * @return the detectOrientation value.
     */
    @Generated
    ...
    /**
     * Set the detectOrientation property: A value indicating to turn orientation detection on or not. Default is false.
     * 
     * @param detectOrientation the detectOrientation value to set.
     * @return the OcrSkill object itself.
     */
    @Generated
    public OcrSkill setDetectOrientation(Boolean detectOrientation) {
        this.detectOrientation = detectOrientation;
        return this;
    }

    /**
     * Get the lineEnding property: Defines the sequence of characters to use between the lines of text recognized
     * by the OCR skill. The default value is "space".
     * 
    ...
    /**
     * Set the lineEnding property: Defines the sequence of characters to use between the lines of text recognized
     * by the OCR skill. The default value is "space".
     * 
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeBooleanField("detectOrientation", this.detectOrientation);
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("inputs".equals(fieldName)) {
                    ...
                    detectOrientation = reader.getNullable(JsonReader::getBoolean);
            ...
            deserializedOcrSkill.detectOrientation = detectOrientation;
