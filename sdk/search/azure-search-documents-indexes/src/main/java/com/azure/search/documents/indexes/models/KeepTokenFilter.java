...
public final class KeepTokenFilter extends TokenFilter {
    ...
    /**
     * Get the keepWordsCase property: A value indicating whether to lower case all words first. Default is false.
     * 
     * @return the keepWordsCase value.
     */
    @Generated
    public Boolean isKeepWordsCase() {
        return this.keepWordsCase;
    }

    /**
     * Set the keepWordsCase property: A value indicating whether to lower case all words first. Default is false.
     * 
     * @param keepWordsCase the keepWordsCase value to set.
     * @return the KeepTokenFilter object itself.
     */
    @Generated
    public KeepTokenFilter setKeepWordsCase(Boolean keepWordsCase) {
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeBooleanField("keepWordsCase", this.keepWordsCase);
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("name".equals(fieldName)) {
                    ...
                    keepWordsCase = reader.getNullable(JsonReader::getBoolean);
                } else {
                    reader.skipChildren();
                }
            }
            ...
            deserializedKeepTokenFilter.keepWordsCase = keepWordsCase;
