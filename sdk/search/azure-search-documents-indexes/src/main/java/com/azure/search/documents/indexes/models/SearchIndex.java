...
public final class SearchIndex implements JsonSerializable<SearchIndex> {
    ...
    /**
     * Get the similarity property: The type of similarity algorithm to be used when scoring and ranking the
     * documents matching a search query. The similarity algorithm can only be defined
     * at index creation time and cannot be modified on existing indexes. If null, the
     * ClassicSimilarity algorithm is used.
     * 
    ...
    /**
     * Set the similarity property: The type of similarity algorithm to be used when scoring and ranking the
     * documents matching a search query. The similarity algorithm can only be defined
     * at index creation time and cannot be modified on existing indexes. If null, the
     * ClassicSimilarity algorithm is used.
     * 
    ...
    /**
     * Set the semantic property: Defines parameters for a search index that influence semantic capabilities.
     * 
     * @param semantic the semantic value to set.
     * @return the SearchIndex object itself.
     */
    @Generated
    public SearchIndex setSemantic(SemanticSearch semantic) {
    ...
    public static SearchIndex fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            SearchIndex deserializedSearchIndex = new SearchIndex(name, fields);
            ...
            deserializedSearchIndex.semantic = semantic;
