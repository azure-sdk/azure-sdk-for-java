...
public final class SplitSkillEncoderModelName extends ExpandableStringEnum<SplitSkillEncoderModelName> {
     ...
     */
    @Generated
    public static final SplitSkillEncoderModelName R50K_BASE = fromString("r50k_base");

    /**
     * A base model with a 50,000 token vocabulary, optimized for prompt-based tasks.
     */
    @Generated
    public static final SplitSkillEncoderModelName P50K_BASE = fromString("p50k_base");
     ...
     */
    @Generated
    public static final SplitSkillEncoderModelName P50K_EDIT = fromString("p50k_edit");

    /**
     * A base model with a 100,000 token vocabulary.
     */
    @Generated
    public static final SplitSkillEncoderModelName CL100K_BASE = fromString("cl100k_base");
