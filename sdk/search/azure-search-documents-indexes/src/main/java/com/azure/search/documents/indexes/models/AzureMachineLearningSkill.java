...
public final class AzureMachineLearningSkill extends SearchIndexerSkill {
    ...
    /**
     * Set the uri property: (Required for no authentication or key authentication) The scoring URI of the
     * AML service to which the JSON payload will be sent. Only the https URI scheme
     * is allowed.
     * 
     ...
     */
    @Generated
    public AzureMachineLearningSkill setUri(String uri) {
        this.uri = uri;
        return this;
    }
     ...
     */
    @Generated
    public AzureMachineLearningSkill setKey(String key) {
        this.key = key;
        return this;
    }
    ...
    public static AzureMachineLearningSkill fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            deserializedAzureMachineLearningSkill.uri = uri;
            deserializedAzureMachineLearningSkill.key = key;
