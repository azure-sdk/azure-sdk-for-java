...
public final class SearchIndexerLimits implements JsonSerializable<SearchIndexerLimits> {
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeStringField("maxRunTime", CoreUtils.durationToStringWithDays(this.maxRunTime));
        jsonWriter.writeNumberField("maxDocumentExtractionSize", this.maxDocumentExtractionSize);
        jsonWriter.writeNumberField("maxDocumentContentCharactersToExtract",
            this.maxDocumentContentCharactersToExtract);
