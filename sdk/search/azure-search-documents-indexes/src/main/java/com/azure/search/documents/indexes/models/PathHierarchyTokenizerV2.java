...
public final class PathHierarchyTokenizerV2 extends LexicalTokenizer {
    ...
    /**
     * Get the reverse property: A value indicating whether to generate tokens in reverse order. Default is
     * false.
     * 
    ...
    /**
     * Set the reverse property: A value indicating whether to generate tokens in reverse order. Default is
     * false.
     * 
     ...
     */
    @Generated
    public PathHierarchyTokenizerV2 setReverse(Boolean reverse) {
        this.reverse = reverse;
        return this;
    }

    /**
     * Get the skip property: The number of initial tokens to skip. Default is 0.
     * 
    ...
    /**
     * Set the skip property: The number of initial tokens to skip. Default is 0.
     * 
     * @param skip the skip value to set.
     * @return the PathHierarchyTokenizerV2 object itself.
     */
    @Generated
    public PathHierarchyTokenizerV2 setSkip(Integer skip) {
        this.skip = skip;
        return this;
    }
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeBooleanField("reverse", this.reverse);
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("name".equals(fieldName)) {
                    ...
                    reverse = reader.getNullable(JsonReader::getBoolean);
            ...
            deserializedPathHierarchyTokenizerV2.reverse = reverse;
            deserializedPathHierarchyTokenizerV2.skip = skip;
