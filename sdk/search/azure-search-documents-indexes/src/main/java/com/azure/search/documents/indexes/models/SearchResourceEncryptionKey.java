...
public final class SearchResourceEncryptionKey implements JsonSerializable<SearchResourceEncryptionKey> {
     ...
     */
    @Generated
    public SearchResourceEncryptionKey(String keyVaultKeyName, String keyVaultUri) {
    ...
    /**
     * Set the keyVaultKeyVersion property: The version of your Azure Key Vault key to be used to encrypt your data at
     * rest.
     * 
     ...
     */
    @Generated
    public SearchResourceEncryptionKey setKeyVaultKeyVersion(String keyVaultKeyVersion) {
    ...
    /**
     * Get the identity property: An explicit managed identity to use for this encryption key. If not specified
     * and the access credentials property is null, the system-assigned managed
     * identity is used. On update to the resource, if the explicit identity is
     * unspecified, it remains unchanged. If "none" is specified, the value of this
     * property is cleared.
    ...
    /**
     * Set the identity property: An explicit managed identity to use for this encryption key. If not specified
     * and the access credentials property is null, the system-assigned managed
     * identity is used. On update to the resource, if the explicit identity is
     * unspecified, it remains unchanged. If "none" is specified, the value of this
     * property is cleared.
    ...
    public static SearchResourceEncryptionKey fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            SearchResourceEncryptionKey deserializedSearchResourceEncryptionKey
                = new SearchResourceEncryptionKey(keyVaultKeyName, keyVaultUri);
            deserializedSearchResourceEncryptionKey.keyVaultKeyVersion = keyVaultKeyVersion;
