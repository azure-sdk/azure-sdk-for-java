...
public final class SharedPrivateLinkResourceProperties {
    ...
    /*
     * Status of the shared private link resource. Can be Pending, Approved, Rejected, Disconnected or other yet to be
     * documented value.
     */
    ...
    /*
     * The provisioning state of the shared private link resource. Can be Updating, Deleting, Failed, Succeeded,
     * Incomplete or other yet to be documented value.
     */
     ...
     * Disconnected or other yet to be documented value.
     *
