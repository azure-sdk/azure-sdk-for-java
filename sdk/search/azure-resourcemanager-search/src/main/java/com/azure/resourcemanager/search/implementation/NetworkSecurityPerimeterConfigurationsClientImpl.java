...
public final class NetworkSecurityPerimeterConfigurationsClientImpl
    ...
    public interface NetworkSecurityPerimeterConfigurationsService {
        ...
        Mono<Response<NetworkSecurityPerimeterConfigurationListResult>> listByService(
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<NetworkSecurityPerimeterConfigurationListResult>> listByServiceNext(
    ...
    private PagedFlux<NetworkSecurityPerimeterConfigurationInner> listByServiceAsync(String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<NetworkSecurityPerimeterConfigurationInner> listByService(String resourceGroupName,
        String searchServiceName) {
    ...
    private PollerFlux<PollResult<Void>, Void> beginReconcileAsync(String resourceGroupName, String searchServiceName,
        String nspConfigName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<Void>, Void> beginReconcile(String resourceGroupName, String searchServiceName,
        String nspConfigName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> reconcileAsync(String resourceGroupName, String searchServiceName, String nspConfigName) {
