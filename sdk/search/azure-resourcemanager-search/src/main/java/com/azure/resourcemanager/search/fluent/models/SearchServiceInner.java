...
public final class SearchServiceInner extends Resource {
    ...
    /**
     * Get the systemData property: Azure Resource Manager metadata of the search service containing createdBy and
    ...
    public OffsetDateTime serviceUpgradeDate() {
        return this.innerProperties() == null ? null : this.innerProperties().serviceUpgradeDate();
    }
