...
public final class OperationListResult {
    /*
     * The list of operations by Azure Cognitive Search, some supported by the resource provider and others by data
     * plane APIs.
     */
    ...
    /**
     * Get the value property: The list of operations by Azure Cognitive Search, some supported by the resource provider
