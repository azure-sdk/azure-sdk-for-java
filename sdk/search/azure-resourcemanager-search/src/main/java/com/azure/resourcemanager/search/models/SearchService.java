...
public interface SearchService {
    ...
    /**
     * Gets the endpoint property: The endpoint of the Azure AI Search service.
     * 
    ...
    /**
     * Gets the computeType property: Configure this property to support the search service using either the Default
    ...
    /**
     * Gets the dataExfiltrationProtections property: A list of data exfiltration scenarios that are explicitly
    ...
    /**
     * Gets the upgradeAvailable property: Indicates if the search service has an upgrade available.
     * 
    ...
    /**
     * Gets the serviceUpgradedAt property: The date and time the search service was last upgraded. This field will be
     * null until the service gets upgraded for the first time.
     * 
     * @return the serviceUpgradedAt value.
     */
    OffsetDateTime serviceUpgradedAt();
    ...
    interface DefinitionStages {
        ...
        interface WithCreate extends DefinitionStages.WithTags, DefinitionStages.WithSku, DefinitionStages.WithIdentity,
            DefinitionStages.WithReplicaCount, DefinitionStages.WithPartitionCount, DefinitionStages.WithEndpoint,
            DefinitionStages.WithHostingMode, DefinitionStages.WithComputeType,
            DefinitionStages.WithPublicNetworkAccess, DefinitionStages.WithNetworkRuleSet,
            DefinitionStages.WithDataExfiltrationProtections, DefinitionStages.WithEncryptionWithCmk,
            DefinitionStages.WithDisableLocalAuth, DefinitionStages.WithAuthOptions,
            DefinitionStages.WithSemanticSearch, DefinitionStages.WithUpgradeAvailable,
        ...
        /**
         * The stage of the SearchService definition allowing to specify endpoint.
         */
        interface WithEndpoint {
            /**
             * Specifies the endpoint property: The endpoint of the Azure AI Search service..
             * 
             * @param endpoint The endpoint of the Azure AI Search service.
             * @return the next definition stage.
             */
        ...
        /**
         * The stage of the SearchService definition allowing to specify computeType.
         */
        interface WithComputeType {
            /**
             * Specifies the computeType property: Configure this property to support the search service using either
             * the Default Compute or Azure Confidential Compute..
             * 
             * @param computeType Configure this property to support the search service using either the Default Compute
             * or Azure Confidential Compute.
             * @return the next definition stage.
             */
            WithCreate withComputeType(ComputeType computeType);
        }
        ...
        /**
         * The stage of the SearchService definition allowing to specify dataExfiltrationProtections.
         */
        interface WithDataExfiltrationProtections {
            /**
             * Specifies the dataExfiltrationProtections property: A list of data exfiltration scenarios that are
             ...
             * 
             * @param dataExfiltrationProtections A list of data exfiltration scenarios that are explicitly disallowed
             * for the search service. Currently, the only supported value is 'All' to disable all possible data export
             * scenarios with more fine grained controls planned for the future.
             * @return the next definition stage.
             */
            WithCreate
        ...
        /**
         * The stage of the SearchService definition allowing to specify upgradeAvailable.
         */
        interface WithUpgradeAvailable {
            /**
             * Specifies the upgradeAvailable property: Indicates if the search service has an upgrade available..
             * 
             * @param upgradeAvailable Indicates if the search service has an upgrade available.
             * @return the next definition stage.
             */
            WithCreate withUpgradeAvailable(UpgradeAvailable upgradeAvailable);
        }
    ...
    interface Update extends UpdateStages.WithTags, UpdateStages.WithSku, UpdateStages.WithIdentity,
        UpdateStages.WithReplicaCount, UpdateStages.WithPartitionCount, UpdateStages.WithEndpoint,
        UpdateStages.WithHostingMode, UpdateStages.WithComputeType, UpdateStages.WithPublicNetworkAccess,
        UpdateStages.WithNetworkRuleSet, UpdateStages.WithDataExfiltrationProtections,
        UpdateStages.WithEncryptionWithCmk, UpdateStages.WithDisableLocalAuth, UpdateStages.WithAuthOptions,
        UpdateStages.WithSemanticSearch, UpdateStages.WithUpgradeAvailable, UpdateStages.WithClientRequestId {
        /**
    ...
    interface UpdateStages {
        ...
        /**
         * The stage of the SearchService update allowing to specify endpoint.
         */
        interface WithEndpoint {
            /**
             * Specifies the endpoint property: The endpoint of the Azure AI Search service..
        ...
        /**
         * The stage of the SearchService update allowing to specify computeType.
         */
        interface WithComputeType {
            /**
             * Specifies the computeType property: Configure this property to support the search service using either
             ...
             * @return the next definition stage.
             */
            Update withComputeType(ComputeType computeType);
        }
        ...
        /**
         * The stage of the SearchService update allowing to specify dataExfiltrationProtections.
         */
        interface WithDataExfiltrationProtections {
            /**
             * Specifies the dataExfiltrationProtections property: A list of data exfiltration scenarios that are
             ...
             * @return the next definition stage.
             */
            Update withDataExfiltrationProtections(List<SearchDataExfiltrationProtection> dataExfiltrationProtections);
        }
        ...
        /**
         * The stage of the SearchService update allowing to specify upgradeAvailable.
         */
        interface WithUpgradeAvailable {
            /**
             * Specifies the upgradeAvailable property: Indicates if the search service has an upgrade available..
             ...
             * @return the next definition stage.
             */
            Update withUpgradeAvailable(UpgradeAvailable upgradeAvailable);
        }
     ...
     * @return describes an Azure AI Search service and its current state.
     */
    SearchService upgrade(Context context);
}
