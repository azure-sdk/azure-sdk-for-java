...
import com.azure.resourcemanager.securitydevops.fluent.OperationsClient;
...
/** Initializes a new instance of the MicrosoftSecurityDevOpsImpl type. */
@ServiceClient(builder = MicrosoftSecurityDevOpsBuilder.class)
public final class MicrosoftSecurityDevOpsImpl implements MicrosoftSecurityDevOps {
    ...
    /** The AzureDevOpsConnectorsClient object to access its operations. */
    private final AzureDevOpsConnectorsClient azureDevOpsConnectors;
     ...
     */
    public AzureDevOpsConnectorsClient getAzureDevOpsConnectors() {
        return this.azureDevOpsConnectors;
    }
    ...
    /** The AzureDevOpsRepoesClient object to access its operations. */
    private final AzureDevOpsRepoesClient azureDevOpsRepoes;
     ...
     */
    public AzureDevOpsRepoesClient getAzureDevOpsRepoes() {
        return this.azureDevOpsRepoes;
    }

    /** The GitHubConnectorsClient object to access its operations. */
    private final GitHubConnectorsClient gitHubConnectors;
     ...
     */
    public GitHubConnectorsClient getGitHubConnectors() {
        return this.gitHubConnectors;
    }
    ...
    /** The GitHubRepoesClient object to access its operations. */
    private final GitHubRepoesClient gitHubRepoes;
     ...
     */
    public GitHubRepoesClient getGitHubRepoes() {
        return this.gitHubRepoes;
    }
    ...
    /**
     * Initializes an instance of MicrosoftSecurityDevOps client.
     *
    ...
    MicrosoftSecurityDevOpsImpl(
        ...
        this.azureDevOpsConnectors = new AzureDevOpsConnectorsClientImpl(this);
        this.azureDevOpsOrgs = new AzureDevOpsOrgsClientImpl(this);
        this.azureDevOpsProjects = new AzureDevOpsProjectsClientImpl(this);
        this.azureDevOpsRepoes = new AzureDevOpsRepoesClientImpl(this);
        this.gitHubConnectors = new GitHubConnectorsClientImpl(this);
        this.gitHubOwners = new GitHubOwnersClientImpl(this);
        this.gitHubRepoes = new GitHubRepoesClientImpl(this);
    ...
    private static final ClientLogger LOGGER = new ClientLogger(MicrosoftSecurityDevOpsImpl.class);
}
