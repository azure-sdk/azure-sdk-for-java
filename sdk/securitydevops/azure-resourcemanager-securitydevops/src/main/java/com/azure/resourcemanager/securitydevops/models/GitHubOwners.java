...
public interface GitHubOwners {
     ...
     */
    PagedIterable<GitHubOwner> list(String resourceGroupName, String gitHubConnectorName);
     ...
     * @return the paginated response with {@link PagedIterable}.
     */
    PagedIterable<GitHubOwner> list(String resourceGroupName, String gitHubConnectorName, Context context);
     ...
     * @return the response body along with {@link Response}.
     */
    Response<GitHubOwner> getByIdWithResponse(String id, Context context);

    /**
     * Begins definition for a new GitHubOwner resource.
     *
     * @param name resource name.
     * @return the first stage of the new GitHubOwner definition.
     */
    GitHubOwner.DefinitionStages.Blank define(String name);
}
