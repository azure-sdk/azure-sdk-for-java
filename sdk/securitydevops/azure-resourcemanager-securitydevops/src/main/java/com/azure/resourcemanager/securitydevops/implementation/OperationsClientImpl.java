...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    OperationsClientImpl(MicrosoftSecurityDevOpsImpl client) {
        this.service =
    ...
    /**
     * The interface defining all the services for MicrosoftSecurityDevOpsOperations to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{$host}")
    ...
    public interface OperationsService {
        ...
        @Get("/providers/Microsoft.SecurityDevOps/operations")
