...
public interface GitHubRepoes {
     ...
     * @param gitHubOwnerName Name of the GitHub Repo Owner.
     ...
     * @return the paginated response with {@link PagedIterable}.
     */
    PagedIterable<GitHubRepo> listByConnector(String resourceGroupName, String gitHubConnectorName);
     ...
     * @return the paginated response with {@link PagedIterable}.
     */
    PagedIterable<GitHubRepo> listByConnector(String resourceGroupName, String gitHubConnectorName, Context context);
     ...
     * @return the response.
     */
    GitHubRepo get(String resourceGroupName, String gitHubConnectorName, String gitHubOwnerName, String gitHubRepoName);
     ...
     * @return the response body along with {@link Response}.
     */
    Response<GitHubRepo> getByIdWithResponse(String id, Context context);

    /**
     * Begins definition for a new GitHubRepo resource.
     *
     * @param name resource name.
     * @return the first stage of the new GitHubRepo definition.
     */
    GitHubRepo.DefinitionStages.Blank define(String name);
}
