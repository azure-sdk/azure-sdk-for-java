...
public final class SqlVirtualMachinesCreateOrUpdateSamples {
    /*
     * x-ms-original-file:
     * specification/sqlvirtualmachine/resource-manager/Microsoft.SqlVirtualMachine/preview/2023-10-01-preview/examples/
    ...
    public static void
        ...
        manager.sqlVirtualMachines().define("testvm").withRegion("northeurope").withExistingResourceGroup("testrg")
            .withVirtualMachineResourceId(
                "/subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/testrg/providers/Microsoft.Compute/virtualMachines/testvm")
            .withSqlServerLicenseType(SqlServerLicenseType.PAYG).withSqlImageSku(SqlImageSku.ENTERPRISE)
    ...
    public static void createsOrUpdatesASQLVirtualMachineWithMaxParameters(
        ...
        manager.sqlVirtualMachines().define("testvm").withRegion("northeurope").withExistingResourceGroup("testrg")
            .withVirtualMachineResourceId(
                "/subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/testrg/providers/Microsoft.Compute/virtualMachines/testvm")
            .withSqlServerLicenseType(SqlServerLicenseType.PAYG).withLeastPrivilegeMode(LeastPrivilegeMode.ENABLED)
            ...
            .withStorageConfigurationSettings(new StorageConfigurationSettings()
                .withSqlDataSettings(new SqlStorageSettings().withLuns(Arrays.asList(0))
                    .withDefaultFilePath("F:\\folderpath\\").withUseStoragePool(false))
                .withSqlLogSettings(new SqlStorageSettings().withLuns(Arrays.asList(1))
                    .withDefaultFilePath("G:\\folderpath\\").withUseStoragePool(false))
                .withSqlTempDbSettings(new SqlTempDbSettings().withDataFileSize(256).withDataGrowth(512)
                    .withLogFileSize(256).withLogGrowth(512).withDataFileCount(8).withLuns(Arrays.asList(2))
                    .withDefaultFilePath("D:\\TEMP").withUseStoragePool(false))
                .withSqlSystemDbOnDataDisk(true).withDiskConfigurationType(DiskConfigurationType.NEW)
                .withStorageWorkloadType(StorageWorkloadType.OLTP).withEnableStorageConfigBlade(true))
