...
public final class SqlVirtualMachineGroupsCreateOrUpdateSamples {
    ...
    public static void createsOrUpdatesASQLVirtualMachineGroup(
        ...
        manager.sqlVirtualMachineGroups().define("testvmgroup").withRegion("northeurope")
            .withExistingResourceGroup("testrg").withTags(mapOf("mytag", "myval")).withSqlImageOffer("SQL2016-WS2016")
            .withSqlImageSku(SqlVmGroupImageSku.ENTERPRISE)
            .withWsfcDomainProfile(new WsfcDomainProfile().withDomainFqdn("testdomain.com")
                .withOuPath("OU=WSCluster,DC=testdomain,DC=com").withClusterBootstrapAccount("testrpadmin")
                .withClusterOperatorAccount("testrp@testdomain.com").withSqlServiceAccount("sqlservice@testdomain.com")
                .withIsSqlServiceAccountGmsa(false).withStorageAccountUrl("https://storgact.blob.core.windows.net/")
