...
public final class SqlVirtualMachineGroupImpl
    ...
    public SqlVirtualMachineGroup create() {
        this.innerObject = serviceManager.serviceClient().getSqlVirtualMachineGroups().createOrUpdate(resourceGroupName,
            sqlVirtualMachineGroupName, this.innerModel(), Context.NONE);
        return this;
    }

    public SqlVirtualMachineGroup create(Context context) {
        this.innerObject = serviceManager.serviceClient().getSqlVirtualMachineGroups().createOrUpdate(resourceGroupName,
            sqlVirtualMachineGroupName, this.innerModel(), context);
        return this;
    }
    ...
    public SqlVirtualMachineGroup apply() {
        this.innerObject = serviceManager.serviceClient().getSqlVirtualMachineGroups().update(resourceGroupName,
            sqlVirtualMachineGroupName, updateParameters, Context.NONE);
        return this;
    }

    public SqlVirtualMachineGroup apply(Context context) {
        this.innerObject = serviceManager.serviceClient().getSqlVirtualMachineGroups().update(resourceGroupName,
            sqlVirtualMachineGroupName, updateParameters, context);
        return this;
    }
    ...
    public SqlVirtualMachineGroup refresh() {
        this.innerObject = serviceManager.serviceClient().getSqlVirtualMachineGroups()
            .getByResourceGroupWithResponse(resourceGroupName, sqlVirtualMachineGroupName, Context.NONE).getValue();
        return this;
    }

    public SqlVirtualMachineGroup refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getSqlVirtualMachineGroups()
            .getByResourceGroupWithResponse(resourceGroupName, sqlVirtualMachineGroupName, context).getValue();
        return this;
    }
