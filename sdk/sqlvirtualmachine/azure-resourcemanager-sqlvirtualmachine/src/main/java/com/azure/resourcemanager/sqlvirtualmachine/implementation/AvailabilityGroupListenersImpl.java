...
public final class AvailabilityGroupListenersImpl implements AvailabilityGroupListeners {
    ...
    public Response<AvailabilityGroupListener> getWithResponse(String resourceGroupName,
        ...
        Response<AvailabilityGroupListenerInner> inner = this.serviceClient().getWithResponse(resourceGroupName,
            sqlVirtualMachineGroupName, availabilityGroupListenerName, expand, context);
        if (inner != null) {
