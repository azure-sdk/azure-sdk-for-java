...
public final class SqlVirtualMachineUpdate {
    ...
    /**
     * Creates an instance of SqlVirtualMachineUpdate class.
     */
     ...
     * @return the SqlVirtualMachineUpdate object itself.
     */
    public SqlVirtualMachineUpdate withVirtualMachineResourceId(String virtualMachineResourceId) {
     ...
     * @return the SqlVirtualMachineUpdate object itself.
     */
    public SqlVirtualMachineUpdate withSqlImageOffer(String sqlImageOffer) {
        if (this.innerProperties() == null) {
            this.innerProperties = new SqlVirtualMachineProperties();
        }
     ...
     * @return the SqlVirtualMachineUpdate object itself.
     */
    public SqlVirtualMachineUpdate withSqlServerLicenseType(SqlServerLicenseType sqlServerLicenseType) {
        if (this.innerProperties() == null) {
            this.innerProperties = new SqlVirtualMachineProperties();
        }
     ...
     * @return the SqlVirtualMachineUpdate object itself.
     */
    public SqlVirtualMachineUpdate withSqlManagement(SqlManagementMode sqlManagement) {
        if (this.innerProperties() == null) {
            this.innerProperties = new SqlVirtualMachineProperties();
        }
     ...
     * @return the SqlVirtualMachineUpdate object itself.
     */
    public SqlVirtualMachineUpdate withLeastPrivilegeMode(LeastPrivilegeMode leastPrivilegeMode) {
        if (this.innerProperties() == null) {
            this.innerProperties = new SqlVirtualMachineProperties();
        }
     ...
     * @return the SqlVirtualMachineUpdate object itself.
     */
    public SqlVirtualMachineUpdate withSqlImageSku(SqlImageSku sqlImageSku) {
        if (this.innerProperties() == null) {
            this.innerProperties = new SqlVirtualMachineProperties();
        }
     ...
     * @return the SqlVirtualMachineUpdate object itself.
     */
    public SqlVirtualMachineUpdate withSqlVirtualMachineGroupResourceId(String sqlVirtualMachineGroupResourceId) {
        if (this.innerProperties() == null) {
            this.innerProperties = new SqlVirtualMachineProperties();
        }
     ...
     * @return the SqlVirtualMachineUpdate object itself.
     */
    public SqlVirtualMachineUpdate withWsfcDomainCredentials(WsfcDomainCredentials wsfcDomainCredentials) {
        if (this.innerProperties() == null) {
            this.innerProperties = new SqlVirtualMachineProperties();
        }
     ...
     * @return the SqlVirtualMachineUpdate object itself.
     */
    public SqlVirtualMachineUpdate withWsfcStaticIp(String wsfcStaticIp) {
        if (this.innerProperties() == null) {
            this.innerProperties = new SqlVirtualMachineProperties();
        }
     ...
     * @return the SqlVirtualMachineUpdate object itself.
     */
    public SqlVirtualMachineUpdate withAutoPatchingSettings(AutoPatchingSettings autoPatchingSettings) {
        if (this.innerProperties() == null) {
            this.innerProperties = new SqlVirtualMachineProperties();
        }
     ...
     * @return the SqlVirtualMachineUpdate object itself.
     */
    public SqlVirtualMachineUpdate withAutoBackupSettings(AutoBackupSettings autoBackupSettings) {
        if (this.innerProperties() == null) {
            this.innerProperties = new SqlVirtualMachineProperties();
        }
     ...
     * @return the SqlVirtualMachineUpdate object itself.
     */
    public SqlVirtualMachineUpdate withServerConfigurationsManagementSettings(
     ...
     * @return the SqlVirtualMachineUpdate object itself.
     */
    public SqlVirtualMachineUpdate withAssessmentSettings(AssessmentSettings assessmentSettings) {
        if (this.innerProperties() == null) {
            this.innerProperties = new SqlVirtualMachineProperties();
        }
     ...
     * @return the SqlVirtualMachineUpdate object itself.
     */
    public SqlVirtualMachineUpdate withEnableAutomaticUpgrade(Boolean enableAutomaticUpgrade) {
        if (this.innerProperties() == null) {
            this.innerProperties = new SqlVirtualMachineProperties();
        }
     ...
     * @return the SqlVirtualMachineUpdate object itself.
     */
    public SqlVirtualMachineUpdate withAdditionalVmPatch(AdditionalOsPatch additionalVmPatch) {
        if (this.innerProperties() == null) {
            this.innerProperties = new SqlVirtualMachineProperties();
        }
        this.innerProperties().withAdditionalVmPatch(additionalVmPatch);
        return this;
    }
