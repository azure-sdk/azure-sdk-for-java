...
public interface ManagedNetworkPeeringPoliciesClient {
    ...
    Response<ManagedNetworkPeeringPolicyInner> getWithResponse(String resourceGroupName, String managedNetworkName,
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    ManagedNetworkPeeringPolicyInner createOrUpdate(String resourceGroupName, String managedNetworkName,
        String managedNetworkPeeringPolicyName, ManagedNetworkPeeringPolicyInner managedNetworkPolicy, Context context);
    ...
    PagedIterable<ManagedNetworkPeeringPolicyInner> listByManagedNetwork(String resourceGroupName,
