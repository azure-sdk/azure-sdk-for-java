...
public final class ManagedNetworkProperties extends ResourceProperties {
    /*
     * The collection of management groups, subscriptions, virtual networks, and subnets by the Managed Network. This
     * is a read-only property that is reflective of all ScopeAssignments for this Managed Network
     */
