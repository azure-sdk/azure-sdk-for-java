...
public interface ManagedNetworkGroupsClient {
    ...
    Response<ManagedNetworkGroupInner> getWithResponse(String resourceGroupName, String managedNetworkName,
    ...
    SyncPoller<PollResult<ManagedNetworkGroupInner>, ManagedNetworkGroupInner> beginCreateOrUpdate(
    ...
    PagedIterable<ManagedNetworkGroupInner> listByManagedNetwork(String resourceGroupName, String managedNetworkName);
