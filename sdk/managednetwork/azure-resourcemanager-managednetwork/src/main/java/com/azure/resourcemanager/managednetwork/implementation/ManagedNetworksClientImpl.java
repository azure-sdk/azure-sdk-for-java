...
public final class ManagedNetworksClientImpl implements ManagedNetworksClient {
    ...
    public interface ManagedNetworksService {
        ...
        Mono<Response<ManagedNetworkInner>> getByResourceGroup(@HostParam("$host") String endpoint,
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ManagedNetworkInner>> createOrUpdate(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("managedNetworkName") String managedNetworkName,
            @BodyParam("application/json") ManagedNetworkInner managedNetwork, @HeaderParam("Accept") String accept,
            Context context);
        ...
        Mono<Response<Flux<ByteBuffer>>> update(@HostParam("$host") String endpoint,
            ...
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("managedNetworkName") String managedNetworkName,
            @BodyParam("application/json") ManagedNetworkUpdate parameters, @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ManagedNetworkListResult>> listByResourceGroup(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
    ...
    private Mono<Response<ManagedNetworkInner>> getByResourceGroupWithResponseAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(context -> service.getByResourceGroup(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, managedNetworkName, accept, context))
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ManagedNetworkInner> getByResourceGroupWithResponse(String resourceGroupName,
        String managedNetworkName, Context context) {
    ...
    public ManagedNetworkInner getByResourceGroup(String resourceGroupName, String managedNetworkName) {
        return getByResourceGroupWithResponse(resourceGroupName, managedNetworkName, Context.NONE).getValue();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ManagedNetworkInner>> createOrUpdateWithResponseAsync(String resourceGroupName,
        String managedNetworkName, ManagedNetworkInner managedNetwork) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return FluxUtil
            .withContext(context -> service.createOrUpdate(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, managedNetworkName, managedNetwork, accept,
                context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ManagedNetworkInner>> createOrUpdateWithResponseAsync(String resourceGroupName,
        String managedNetworkName, ManagedNetworkInner managedNetwork, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service.createOrUpdate(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, managedNetworkName, managedNetwork, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ManagedNetworkInner> createOrUpdateAsync(String resourceGroupName, String managedNetworkName,
        ManagedNetworkInner managedNetwork) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ManagedNetworkInner> createOrUpdateWithResponse(String resourceGroupName, String managedNetworkName,
        ManagedNetworkInner managedNetwork, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ManagedNetworkInner createOrUpdate(String resourceGroupName, String managedNetworkName,
        ManagedNetworkInner managedNetwork) {
        return createOrUpdateWithResponse(resourceGroupName, managedNetworkName, managedNetwork, Context.NONE)
            .getValue();
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> deleteWithResponseAsync(String resourceGroupName,
        ...
        return service.delete(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, managedNetworkName, accept, context);
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String managedNetworkName) {
        return this.beginDeleteAsync(resourceGroupName, managedNetworkName).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String managedNetworkName,
        Context context) {
        return this.beginDeleteAsync(resourceGroupName, managedNetworkName, context).getSyncPoller();
    }
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String managedNetworkName) {
        return beginDeleteAsync(resourceGroupName, managedNetworkName).last()
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String managedNetworkName, Context context) {
        return beginDeleteAsync(resourceGroupName, managedNetworkName, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> updateWithResponseAsync(String resourceGroupName,
        String managedNetworkName, ManagedNetworkUpdate parameters) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return FluxUtil
            .withContext(context -> service.update(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, managedNetworkName, parameters, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> updateWithResponseAsync(String resourceGroupName,
        String managedNetworkName, ManagedNetworkUpdate parameters, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service.update(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, managedNetworkName, parameters, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<ManagedNetworkInner>, ManagedNetworkInner> beginUpdateAsync(String resourceGroupName,
        String managedNetworkName, ManagedNetworkUpdate parameters) {
        Mono<Response<Flux<ByteBuffer>>> mono
            = updateWithResponseAsync(resourceGroupName, managedNetworkName, parameters);
        return this.client.<ManagedNetworkInner, ManagedNetworkInner>getLroResult(mono, this.client.getHttpPipeline(),
            ManagedNetworkInner.class, ManagedNetworkInner.class, this.client.getContext());
    }
    ...
    private PollerFlux<PollResult<ManagedNetworkInner>, ManagedNetworkInner> beginUpdateAsync(String resourceGroupName,
        ...
        return this.client.<ManagedNetworkInner, ManagedNetworkInner>getLroResult(mono, this.client.getHttpPipeline(),
            ManagedNetworkInner.class, ManagedNetworkInner.class, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<ManagedNetworkInner>, ManagedNetworkInner> beginUpdate(String resourceGroupName,
        String managedNetworkName, ManagedNetworkUpdate parameters) {
        return this.beginUpdateAsync(resourceGroupName, managedNetworkName, parameters).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<ManagedNetworkInner>, ManagedNetworkInner> beginUpdate(String resourceGroupName,
        String managedNetworkName, ManagedNetworkUpdate parameters, Context context) {
        return this.beginUpdateAsync(resourceGroupName, managedNetworkName, parameters, context).getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ManagedNetworkInner> updateAsync(String resourceGroupName, String managedNetworkName,
        ManagedNetworkUpdate parameters) {
        return beginUpdateAsync(resourceGroupName, managedNetworkName, parameters).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ManagedNetworkInner> updateAsync(String resourceGroupName, String managedNetworkName,
        ManagedNetworkUpdate parameters, Context context) {
        return beginUpdateAsync(resourceGroupName, managedNetworkName, parameters, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ManagedNetworkInner update(String resourceGroupName, String managedNetworkName,
        ManagedNetworkUpdate parameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<ManagedNetworkInner>> listByResourceGroupSinglePageAsync(String resourceGroupName,
        ...
        return FluxUtil
            ...
            .<PagedResponse<ManagedNetworkInner>>map(res -> new PagedResponseBase<>(res.getRequest(),
    ...
    private PagedFlux<ManagedNetworkInner> listByResourceGroupAsync(String resourceGroupName, Integer top,
        String skiptoken) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<ManagedNetworkInner> listByResourceGroup(String resourceGroupName, Integer top,
        String skiptoken, Context context) {
