...
public final class ManagedNetworkPeeringPolicyImpl
    ...
    public ManagedNetworkPeeringPolicyImpl withExistingManagedNetwork(String resourceGroupName,
    ...
    public ManagedNetworkPeeringPolicy create() {
        this.innerObject = serviceManager.serviceClient()
            ...
            .createOrUpdate(resourceGroupName, managedNetworkName, managedNetworkPeeringPolicyName, this.innerModel(),
                Context.NONE);
        return this;
    }
    ...
    ManagedNetworkPeeringPolicyImpl(String name,
    ...
    ManagedNetworkPeeringPolicyImpl(ManagedNetworkPeeringPolicyInner innerObject,
        com.azure.resourcemanager.managednetwork.ManagedNetworkManager serviceManager) {
        ...
        this.managedNetworkPeeringPolicyName
            = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "managedNetworkPeeringPolicies");
    }
