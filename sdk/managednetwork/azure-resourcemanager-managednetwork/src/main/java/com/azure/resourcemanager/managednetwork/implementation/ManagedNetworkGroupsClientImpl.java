...
public final class ManagedNetworkGroupsClientImpl implements ManagedNetworkGroupsClient {
    ...
    ManagedNetworkGroupsClientImpl(ManagedNetworkManagementClientImpl client) {
        this.service = RestProxy.create(ManagedNetworkGroupsService.class, client.getHttpPipeline(),
    ...
    public interface ManagedNetworkGroupsService {
        ...
        Mono<Response<ManagedNetworkGroupInner>> get(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("managedNetworkName") String managedNetworkName,
            @PathParam("managedNetworkGroupName") String managedNetworkGroupName, @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ManagedNetworkGroupListResult>> listByManagedNetwork(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
    ...
    private Mono<Response<ManagedNetworkGroupInner>> getWithResponseAsync(String resourceGroupName,
        String managedNetworkName, String managedNetworkGroupName) {
        ...
        return FluxUtil
            .withContext(context -> service.get(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, managedNetworkName, managedNetworkGroupName, accept,
                context))
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ManagedNetworkGroupInner>> getWithResponseAsync(String resourceGroupName,
        String managedNetworkName, String managedNetworkGroupName, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service.get(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, managedNetworkName, managedNetworkGroupName, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ManagedNetworkGroupInner> getAsync(String resourceGroupName, String managedNetworkName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ManagedNetworkGroupInner> getWithResponse(String resourceGroupName, String managedNetworkName,
        String managedNetworkGroupName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ManagedNetworkGroupInner get(String resourceGroupName, String managedNetworkName,
        String managedNetworkGroupName) {
        return getWithResponse(resourceGroupName, managedNetworkName, managedNetworkGroupName, Context.NONE).getValue();
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String resourceGroupName,
        String managedNetworkName, String managedNetworkGroupName, ManagedNetworkGroupInner managedNetworkGroup) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return FluxUtil
            .withContext(context -> service.createOrUpdate(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, managedNetworkName, managedNetworkGroupName,
                managedNetworkGroup, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private PollerFlux<PollResult<ManagedNetworkGroupInner>, ManagedNetworkGroupInner> beginCreateOrUpdateAsync(
        ...
        Mono<Response<Flux<ByteBuffer>>> mono = createOrUpdateWithResponseAsync(resourceGroupName, managedNetworkName,
            managedNetworkGroupName, managedNetworkGroup);
        return this.client.<ManagedNetworkGroupInner, ManagedNetworkGroupInner>getLroResult(mono,
            this.client.getHttpPipeline(), ManagedNetworkGroupInner.class, ManagedNetworkGroupInner.class,
    ...
    private PollerFlux<PollResult<ManagedNetworkGroupInner>, ManagedNetworkGroupInner> beginCreateOrUpdateAsync(
        String resourceGroupName, String managedNetworkName, String managedNetworkGroupName,
        ManagedNetworkGroupInner managedNetworkGroup, Context context) {
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono = createOrUpdateWithResponseAsync(resourceGroupName, managedNetworkName,
            managedNetworkGroupName, managedNetworkGroup, context);
        return this.client.<ManagedNetworkGroupInner, ManagedNetworkGroupInner>getLroResult(mono,
            this.client.getHttpPipeline(), ManagedNetworkGroupInner.class, ManagedNetworkGroupInner.class, context);
    }
    ...
    public SyncPoller<PollResult<ManagedNetworkGroupInner>, ManagedNetworkGroupInner> beginCreateOrUpdate(
        ...
        ManagedNetworkGroupInner managedNetworkGroup) {
        return this
            .beginCreateOrUpdateAsync(resourceGroupName, managedNetworkName, managedNetworkGroupName,
                managedNetworkGroup)
            .getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ManagedNetworkGroupInner> createOrUpdateAsync(String resourceGroupName, String managedNetworkName,
        String managedNetworkGroupName, ManagedNetworkGroupInner managedNetworkGroup) {
        return beginCreateOrUpdateAsync(resourceGroupName, managedNetworkName, managedNetworkGroupName,
            managedNetworkGroup).last().flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ManagedNetworkGroupInner> createOrUpdateAsync(String resourceGroupName, String managedNetworkName,
        String managedNetworkGroupName, ManagedNetworkGroupInner managedNetworkGroup, Context context) {
        return beginCreateOrUpdateAsync(resourceGroupName, managedNetworkName, managedNetworkGroupName,
            managedNetworkGroup, context).last().flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ManagedNetworkGroupInner createOrUpdate(String resourceGroupName, String managedNetworkName,
        String managedNetworkGroupName, ManagedNetworkGroupInner managedNetworkGroup) {
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String managedNetworkName,
        String managedNetworkGroupName) {
        return this.beginDeleteAsync(resourceGroupName, managedNetworkName, managedNetworkGroupName).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String managedNetworkName,
        String managedNetworkGroupName, Context context) {
        return this.beginDeleteAsync(resourceGroupName, managedNetworkName, managedNetworkGroupName, context)
            .getSyncPoller();
    }
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String managedNetworkName,
        String managedNetworkGroupName) {
        return beginDeleteAsync(resourceGroupName, managedNetworkName, managedNetworkGroupName).last()
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> deleteAsync(String resourceGroupName, String managedNetworkName, String managedNetworkGroupName,
        Context context) {
        return beginDeleteAsync(resourceGroupName, managedNetworkName, managedNetworkGroupName, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<ManagedNetworkGroupInner>> listByManagedNetworkSinglePageAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(context -> service.listByManagedNetwork(this.client.getEndpoint(), this.client.getApiVersion(),
                ...
                context))
            .<PagedResponse<ManagedNetworkGroupInner>>map(res -> new PagedResponseBase<>(res.getRequest(),
    ...
    private PagedFlux<ManagedNetworkGroupInner> listByManagedNetworkAsync(String resourceGroupName,
        String managedNetworkName, Integer top, String skiptoken) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<ManagedNetworkGroupInner> listByManagedNetwork(String resourceGroupName,
        String managedNetworkName) {
        final Integer top = null;
        final String skiptoken = null;
