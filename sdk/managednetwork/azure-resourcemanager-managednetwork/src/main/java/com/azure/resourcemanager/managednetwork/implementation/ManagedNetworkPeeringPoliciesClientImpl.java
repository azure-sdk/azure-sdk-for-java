...
public final class ManagedNetworkPeeringPoliciesClientImpl implements ManagedNetworkPeeringPoliciesClient {
    ...
    ManagedNetworkPeeringPoliciesClientImpl(ManagedNetworkManagementClientImpl client) {
        this.service = RestProxy.create(ManagedNetworkPeeringPoliciesService.class, client.getHttpPipeline(),
    ...
    public interface ManagedNetworkPeeringPoliciesService {
        ...
        Mono<Response<ManagedNetworkPeeringPolicyInner>> get(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ManagedNetworkPeeringPolicyListResult>> listByManagedNetwork(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("managedNetworkName") String managedNetworkName, @QueryParam("$top") Integer top,
    ...
    private Mono<Response<ManagedNetworkPeeringPolicyInner>> getWithResponseAsync(String resourceGroupName,
        String managedNetworkName, String managedNetworkPeeringPolicyName) {
        ...
        return FluxUtil
            .withContext(context -> service.get(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, managedNetworkName, managedNetworkPeeringPolicyName,
                accept, context))
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ManagedNetworkPeeringPolicyInner>> getWithResponseAsync(String resourceGroupName,
        String managedNetworkName, String managedNetworkPeeringPolicyName, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service.get(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, managedNetworkName, managedNetworkPeeringPolicyName, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ManagedNetworkPeeringPolicyInner> getAsync(String resourceGroupName, String managedNetworkName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ManagedNetworkPeeringPolicyInner> getWithResponse(String resourceGroupName,
        String managedNetworkName, String managedNetworkPeeringPolicyName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ManagedNetworkPeeringPolicyInner get(String resourceGroupName, String managedNetworkName,
        String managedNetworkPeeringPolicyName) {
        return getWithResponse(resourceGroupName, managedNetworkName, managedNetworkPeeringPolicyName, Context.NONE)
            .getValue();
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(context -> service.createOrUpdate(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, managedNetworkName, managedNetworkPeeringPolicyName,
                managedNetworkPolicy, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String resourceGroupName,
        String managedNetworkName, String managedNetworkPeeringPolicyName,
        ManagedNetworkPeeringPolicyInner managedNetworkPolicy, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    private PollerFlux<PollResult<ManagedNetworkPeeringPolicyInner>, ManagedNetworkPeeringPolicyInner>
        beginCreateOrUpdateAsync(String resourceGroupName, String managedNetworkName,
            String managedNetworkPeeringPolicyName, ManagedNetworkPeeringPolicyInner managedNetworkPolicy) {
        Mono<Response<Flux<ByteBuffer>>> mono = createOrUpdateWithResponseAsync(resourceGroupName, managedNetworkName,
            managedNetworkPeeringPolicyName, managedNetworkPolicy);
        return this.client.<ManagedNetworkPeeringPolicyInner, ManagedNetworkPeeringPolicyInner>getLroResult(mono,
            this.client.getHttpPipeline(), ManagedNetworkPeeringPolicyInner.class,
            ManagedNetworkPeeringPolicyInner.class, this.client.getContext());
    }
    ...
    private PollerFlux<PollResult<ManagedNetworkPeeringPolicyInner>, ManagedNetworkPeeringPolicyInner>
        ...
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono = createOrUpdateWithResponseAsync(resourceGroupName, managedNetworkName,
            managedNetworkPeeringPolicyName, managedNetworkPolicy, context);
        return this.client.<ManagedNetworkPeeringPolicyInner, ManagedNetworkPeeringPolicyInner>getLroResult(mono,
            this.client.getHttpPipeline(), ManagedNetworkPeeringPolicyInner.class,
            ManagedNetworkPeeringPolicyInner.class, context);
    }
    ...
    public SyncPoller<PollResult<ManagedNetworkPeeringPolicyInner>, ManagedNetworkPeeringPolicyInner>
        beginCreateOrUpdate(String resourceGroupName, String managedNetworkName, String managedNetworkPeeringPolicyName,
            ManagedNetworkPeeringPolicyInner managedNetworkPolicy) {
        return this
            .beginCreateOrUpdateAsync(resourceGroupName, managedNetworkName, managedNetworkPeeringPolicyName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ManagedNetworkPeeringPolicyInner> createOrUpdateAsync(String resourceGroupName,
        String managedNetworkName, String managedNetworkPeeringPolicyName,
        ManagedNetworkPeeringPolicyInner managedNetworkPolicy) {
        return beginCreateOrUpdateAsync(resourceGroupName, managedNetworkName, managedNetworkPeeringPolicyName,
            managedNetworkPolicy).last().flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<ManagedNetworkPeeringPolicyInner> createOrUpdateAsync(String resourceGroupName,
        ...
        ManagedNetworkPeeringPolicyInner managedNetworkPolicy, Context context) {
        return beginCreateOrUpdateAsync(resourceGroupName, managedNetworkName, managedNetworkPeeringPolicyName,
            managedNetworkPolicy, context).last().flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ManagedNetworkPeeringPolicyInner createOrUpdate(String resourceGroupName, String managedNetworkName,
        String managedNetworkPeeringPolicyName, ManagedNetworkPeeringPolicyInner managedNetworkPolicy) {
        return createOrUpdateAsync(resourceGroupName, managedNetworkName, managedNetworkPeeringPolicyName,
            managedNetworkPolicy).block();
    }
    ...
    public ManagedNetworkPeeringPolicyInner createOrUpdate(String resourceGroupName, String managedNetworkName,
        ...
        Context context) {
        return createOrUpdateAsync(resourceGroupName, managedNetworkName, managedNetworkPeeringPolicyName,
            managedNetworkPolicy, context).block();
    }
    ...
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<Void>, Void> beginDeleteAsync(String resourceGroupName, String managedNetworkName,
        String managedNetworkPeeringPolicyName, Context context) {
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String managedNetworkName,
        String managedNetworkPeeringPolicyName) {
        return this.beginDeleteAsync(resourceGroupName, managedNetworkName, managedNetworkPeeringPolicyName)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(String resourceGroupName, String managedNetworkName,
        String managedNetworkPeeringPolicyName, Context context) {
        return this.beginDeleteAsync(resourceGroupName, managedNetworkName, managedNetworkPeeringPolicyName, context)
            .getSyncPoller();
    }
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String managedNetworkName,
        String managedNetworkPeeringPolicyName) {
        return beginDeleteAsync(resourceGroupName, managedNetworkName, managedNetworkPeeringPolicyName).last()
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String managedNetworkName,
        String managedNetworkPeeringPolicyName, Context context) {
        return beginDeleteAsync(resourceGroupName, managedNetworkName, managedNetworkPeeringPolicyName, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<PagedResponse<ManagedNetworkPeeringPolicyInner>> listByManagedNetworkSinglePageAsync(
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.listByManagedNetwork(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, managedNetworkName, top, skiptoken, accept,
                context))
            .<PagedResponse<ManagedNetworkPeeringPolicyInner>>map(res -> new PagedResponseBase<>(res.getRequest(),
    ...
    private Mono<PagedResponse<ManagedNetworkPeeringPolicyInner>> listByManagedNetworkSinglePageAsync(
        ...
        context = this.client.mergeContext(context);
        return service
            .listByManagedNetwork(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, managedNetworkName, top, skiptoken, accept, context)
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return result of the request to list Managed Network Peering Policies as paginated response with
     * {@link PagedFlux}.
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<ManagedNetworkPeeringPolicyInner> listByManagedNetworkAsync(String resourceGroupName,
        String managedNetworkName, Integer top, String skiptoken) {
    ...
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<ManagedNetworkPeeringPolicyInner> listByManagedNetworkAsync(String resourceGroupName,
        String managedNetworkName, Integer top, String skiptoken, Context context) {
        return new PagedFlux<>(
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<ManagedNetworkPeeringPolicyInner> listByManagedNetwork(String resourceGroupName,
        String managedNetworkName) {
        final Integer top = null;
        final String skiptoken = null;
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<ManagedNetworkPeeringPolicyInner>>
        listByManagedNetworkNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<ManagedNetworkPeeringPolicyInner>>
        listByManagedNetworkNextSinglePageAsync(String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        if (this.client.getEndpoint() == null) {
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.listByManagedNetworkNext(nextLink, this.client.getEndpoint(), accept, context)
            .map(res -> new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(),
                res.getValue().value(), res.getValue().nextLink(), null));
    }
}
