...
public final class ScopeAssignmentsClientImpl implements ScopeAssignmentsClient {
    ...
    public interface ScopeAssignmentsService {
        @Headers({ "Content-Type: application/json" })
        @Get("/{scope}/providers/Microsoft.ManagedNetwork/scopeAssignments/{scopeAssignmentName}")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ScopeAssignmentInner>> get(@HostParam("$host") String endpoint,
            @PathParam(value = "scope", encoded = true) String scope,
            @PathParam("scopeAssignmentName") String scopeAssignmentName, @QueryParam("api-version") String apiVersion,
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ScopeAssignmentInner>> createOrUpdate(@HostParam("$host") String endpoint,
            @PathParam(value = "scope", encoded = true) String scope,
            @PathParam("scopeAssignmentName") String scopeAssignmentName, @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") ScopeAssignmentInner parameters, @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ScopeAssignmentListResult>> list(@HostParam("$host") String endpoint,
    ...
    private Mono<Response<ScopeAssignmentInner>> getWithResponseAsync(String scope, String scopeAssignmentName) {
        ...
        return FluxUtil
            .withContext(context -> service.get(this.client.getEndpoint(), scope, scopeAssignmentName,
    ...
    private Mono<Response<ScopeAssignmentInner>> getWithResponseAsync(String scope, String scopeAssignmentName,
        ...
        return service.get(this.client.getEndpoint(), scope, scopeAssignmentName, this.client.getApiVersion(), accept,
            context);
    }
    ...
    public ScopeAssignmentInner get(String scope, String scopeAssignmentName) {
        return getWithResponse(scope, scopeAssignmentName, Context.NONE).getValue();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ScopeAssignmentInner>> createOrUpdateWithResponseAsync(String scope,
        String scopeAssignmentName, ScopeAssignmentInner parameters) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.createOrUpdate(this.client.getEndpoint(), scope, scopeAssignmentName,
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ScopeAssignmentInner>> createOrUpdateWithResponseAsync(String scope,
        String scopeAssignmentName, ScopeAssignmentInner parameters, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.createOrUpdate(this.client.getEndpoint(), scope, scopeAssignmentName,
            this.client.getApiVersion(), parameters, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ScopeAssignmentInner> createOrUpdateAsync(String scope, String scopeAssignmentName,
        ScopeAssignmentInner parameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ScopeAssignmentInner> createOrUpdateWithResponse(String scope, String scopeAssignmentName,
        ScopeAssignmentInner parameters, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ScopeAssignmentInner createOrUpdate(String scope, String scopeAssignmentName,
        ScopeAssignmentInner parameters) {
        return createOrUpdateWithResponse(scope, scopeAssignmentName, parameters, Context.NONE).getValue();
    }
    ...
    private Mono<Response<Void>> deleteWithResponseAsync(String scope, String scopeAssignmentName) {
        ...
        return FluxUtil
            .withContext(context -> service.delete(this.client.getEndpoint(), scope, scopeAssignmentName,
    ...
    private Mono<Response<Void>> deleteWithResponseAsync(String scope, String scopeAssignmentName, Context context) {
        ...
        context = this.client.mergeContext(context);
        return service.delete(this.client.getEndpoint(), scope, scopeAssignmentName, this.client.getApiVersion(),
            context);
    }
    ...
    public void delete(String scope, String scopeAssignmentName) {
        deleteWithResponse(scope, scopeAssignmentName, Context.NONE);
    }
    ...
    private Mono<PagedResponse<ScopeAssignmentInner>> listSinglePageAsync(String scope) {
        ...
        return FluxUtil
            ...
            .<PagedResponse<ScopeAssignmentInner>>map(res -> new PagedResponseBase<>(res.getRequest(),
