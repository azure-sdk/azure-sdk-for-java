...
public final class ManagedNetworkGroupsImpl implements ManagedNetworkGroups {
    ...
    public ManagedNetworkGroupsImpl(ManagedNetworkGroupsClient innerClient,
        com.azure.resourcemanager.managednetwork.ManagedNetworkManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public Response<ManagedNetworkGroup> getWithResponse(String resourceGroupName, String managedNetworkName,
        String managedNetworkGroupName, Context context) {
        Response<ManagedNetworkGroupInner> inner = this.serviceClient()
    ...
    public ManagedNetworkGroup get(String resourceGroupName, String managedNetworkName,
    ...
    public PagedIterable<ManagedNetworkGroup> listByManagedNetwork(String resourceGroupName,
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new ManagedNetworkGroupImpl(inner1, this.manager()));
    }

    public PagedIterable<ManagedNetworkGroup> listByManagedNetwork(String resourceGroupName, String managedNetworkName,
    ...
    public ManagedNetworkGroup getById(String id) {
        ...
        String managedNetworkGroupName = ResourceManagerUtils.getValueFromIdByName(id, "managedNetworkGroups");
        if (managedNetworkGroupName == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
                String.format("The resource ID '%s' is not valid. Missing path segment 'managedNetworkGroups'.", id)));
        }
        return this.getWithResponse(resourceGroupName, managedNetworkName, managedNetworkGroupName, Context.NONE)
            .getValue();
    }
