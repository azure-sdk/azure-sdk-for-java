...
public interface ManagedNetworks {
     ...
     */
    Response<ManagedNetwork> getByResourceGroupWithResponse(String resourceGroupName, String managedNetworkName,
        Context context);
     ...
     * @return result of the request to list Managed Network as paginated response with {@link PagedIterable}.
     */
    PagedIterable<ManagedNetwork> listByResourceGroup(String resourceGroupName, Integer top, String skiptoken,
        Context context);
