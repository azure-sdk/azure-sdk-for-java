...
/**
 * Entry point to ManagedNetworkManager.
...
public final class ManagedNetworkManager {
    ...
    private ManagedNetworkManager(HttpPipeline httpPipeline, AzureProfile profile, Duration defaultPollInterval) {
        ...
        this.clientObject = new ManagedNetworkManagementClientBuilder().pipeline(httpPipeline)
    ...
    public static final class Configurable {
        ...
        private static final Map<String, String> PROPERTIES
            = CoreUtils.getProperties("azure-resourcemanager-managednetwork.properties");
    ...
    /**
     * Gets wrapped service client ManagedNetworkManagementClient providing direct access to the underlying
     * auto-generated API implementation, based on Azure REST API.
     * 
     * @return Wrapped service client ManagedNetworkManagementClient.
     */
