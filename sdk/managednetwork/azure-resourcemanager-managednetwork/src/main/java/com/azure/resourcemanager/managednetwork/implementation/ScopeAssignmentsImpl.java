...
public final class ScopeAssignmentsImpl implements ScopeAssignments {
    ...
    public Response<Void> deleteByResourceGroupWithResponse(String scope, String scopeAssignmentName, Context context) {
    ...
    public PagedIterable<ScopeAssignment> list(String scope) {
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new ScopeAssignmentImpl(inner1, this.manager()));
    }
    ...
    public ScopeAssignment getById(String id) {
        String scope = ResourceManagerUtils.getValueFromIdByParameterName(id,
            "/{scope}/providers/Microsoft.ManagedNetwork/scopeAssignments/{scopeAssignmentName}", "scope");
        if (scope == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
                String.format("The resource ID '%s' is not valid. Missing path segment 'scope'.", id)));
        }
        String scopeAssignmentName = ResourceManagerUtils.getValueFromIdByParameterName(id,
            "/{scope}/providers/Microsoft.ManagedNetwork/scopeAssignments/{scopeAssignmentName}",
            "scopeAssignmentName");
        if (scopeAssignmentName == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
                String.format("The resource ID '%s' is not valid. Missing path segment 'scopeAssignments'.", id)));
        }
    ...
    public void deleteById(String id) {
        ...
        this.deleteByResourceGroupWithResponse(scope, scopeAssignmentName, Context.NONE);
    }
    ...
    public Response<Void> deleteByIdWithResponse(String id, Context context) {
        ...
        return this.deleteByResourceGroupWithResponse(scope, scopeAssignmentName, context);
    }
