...
public final class ManagedNetworkManagementClientImpl implements ManagedNetworkManagementClient {
     ...
     */
    ManagedNetworkManagementClientImpl(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter,
    ...
    private static final ClientLogger LOGGER = new ClientLogger(ManagedNetworkManagementClientImpl.class);
}
