...
/**
 * Result of the request to list Managed Network operations. It contains a list of operations and a URL link to get the
 * next set of results.
 */
@Fluent
public final class OperationListResult {
    ...
    /**
     * Get the value property: List of Resource Provider operations supported by the Managed Network resource provider.
     *
    ...
    /**
     * Set the value property: List of Resource Provider operations supported by the Managed Network resource provider.
     *
