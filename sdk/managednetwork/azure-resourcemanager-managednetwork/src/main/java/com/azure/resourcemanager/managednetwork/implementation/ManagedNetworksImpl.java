...
public final class ManagedNetworksImpl implements ManagedNetworks {
    ...
    public ManagedNetworksImpl(ManagedNetworksClient innerClient,
        com.azure.resourcemanager.managednetwork.ManagedNetworkManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public Response<ManagedNetwork> getByResourceGroupWithResponse(String resourceGroupName, String managedNetworkName,
        Context context) {
    ...
    public PagedIterable<ManagedNetwork> listByResourceGroup(String resourceGroupName) {
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new ManagedNetworkImpl(inner1, this.manager()));
    }

    public PagedIterable<ManagedNetwork> listByResourceGroup(String resourceGroupName, Integer top, String skiptoken,
        Context context) {
