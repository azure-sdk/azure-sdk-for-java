...
public final class ManagedNetworkGroupImpl
    ...
    public ManagedNetworkGroup create() {
        this.innerObject = serviceManager.serviceClient()
            ...
            .createOrUpdate(resourceGroupName, managedNetworkName, managedNetworkGroupName, this.innerModel(),
                Context.NONE);
        return this;
    }
    ...
    public ManagedNetworkGroup create(Context context) {
        this.innerObject = serviceManager.serviceClient()
            .getManagedNetworkGroups()
            .createOrUpdate(resourceGroupName, managedNetworkName, managedNetworkGroupName, this.innerModel(), context);
        return this;
    }

    ManagedNetworkGroupImpl(String name,
    ...
    ManagedNetworkGroupImpl(ManagedNetworkGroupInner innerObject,
        com.azure.resourcemanager.managednetwork.ManagedNetworkManager serviceManager) {
        ...
        this.managedNetworkGroupName
            = ResourceManagerUtils.getValueFromIdByName(innerObject.id(), "managedNetworkGroups");
    }
    ...
    public ManagedNetworkGroupImpl withRegion(Region location) {
        this.innerModel().withLocation(location.toString());
        return this;
    }

    public ManagedNetworkGroupImpl withRegion(String location) {
