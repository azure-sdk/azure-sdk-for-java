...
public interface ManagedNetworksClient {
    ...
    Response<ManagedNetworkInner> getByResourceGroupWithResponse(String resourceGroupName, String managedNetworkName,
        Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<ManagedNetworkInner> createOrUpdateWithResponse(String resourceGroupName, String managedNetworkName,
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<ManagedNetworkInner>, ManagedNetworkInner> beginUpdate(String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<ManagedNetworkInner> listByResourceGroup(String resourceGroupName, Integer top, String skiptoken,
        Context context);
