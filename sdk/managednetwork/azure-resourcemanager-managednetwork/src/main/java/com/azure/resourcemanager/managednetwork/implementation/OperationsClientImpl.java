...
import com.azure.resourcemanager.managednetwork.models.OperationListResult;
...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    OperationsClientImpl(ManagedNetworkManagementClientImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for ManagedNetworkManagementClientOperations to be used by the proxy
     ...
     * @return result of the request to list Managed Network operations along with {@link PagedResponse} on successful
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return result of the request to list Managed Network operations as paginated response with {@link PagedFlux}.
     */
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return result of the request to list Managed Network operations as paginated response with
     * {@link PagedIterable}.
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
