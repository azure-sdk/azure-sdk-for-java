...
public final class AppServicePlanPatchResourceProperties {
    ...
    /*
     * If Linux app service plan <code>true</code>, <code>false</code> otherwise. This property is required for Linux
     * app service plans.
     */
     ...
     */
    public AppServicePlanPatchResourceProperties withWorkerTierName(String workerTierName) {
     ...
     * @return the AppServicePlanPatchResourceProperties object itself.
     */
    public AppServicePlanPatchResourceProperties withPerSiteScaling(Boolean perSiteScaling) {
     ...
     * @return the AppServicePlanPatchResourceProperties object itself.
     */
    public AppServicePlanPatchResourceProperties withElasticScaleEnabled(Boolean elasticScaleEnabled) {
     ...
     * @return the AppServicePlanPatchResourceProperties object itself.
     */
    public AppServicePlanPatchResourceProperties withMaximumElasticWorkerCount(Integer maximumElasticWorkerCount) {
     ...
     * @return the AppServicePlanPatchResourceProperties object itself.
     */
    public AppServicePlanPatchResourceProperties withIsSpot(Boolean isSpot) {
        this.isSpot = isSpot;
        return this;
    }
     ...
     * @return the AppServicePlanPatchResourceProperties object itself.
     */
    public AppServicePlanPatchResourceProperties withSpotExpirationTime(OffsetDateTime spotExpirationTime) {
     ...
     * @return the AppServicePlanPatchResourceProperties object itself.
     */
    public AppServicePlanPatchResourceProperties withFreeOfferExpirationTime(OffsetDateTime freeOfferExpirationTime) {
     ...
     * &lt;code&gt;false&lt;/code&gt; otherwise. This property is required for Linux app service plans.
     *
     ...
     * @return the AppServicePlanPatchResourceProperties object itself.
     */
    public AppServicePlanPatchResourceProperties withReserved(Boolean reserved) {
     ...
     * @return the AppServicePlanPatchResourceProperties object itself.
     */
    public AppServicePlanPatchResourceProperties withIsXenon(Boolean isXenon) {
     ...
     * @return the AppServicePlanPatchResourceProperties object itself.
     */
    public AppServicePlanPatchResourceProperties withHyperV(Boolean hyperV) {
        this.hyperV = hyperV;
        return this;
    }
     ...
     * @return the AppServicePlanPatchResourceProperties object itself.
     */
    public AppServicePlanPatchResourceProperties withTargetWorkerCount(Integer targetWorkerCount) {
     ...
     * @return the AppServicePlanPatchResourceProperties object itself.
     */
    public AppServicePlanPatchResourceProperties withTargetWorkerSizeId(Integer targetWorkerSizeId) {
     ...
     * @return the AppServicePlanPatchResourceProperties object itself.
     */
    public AppServicePlanPatchResourceProperties withZoneRedundant(Boolean zoneRedundant) {
