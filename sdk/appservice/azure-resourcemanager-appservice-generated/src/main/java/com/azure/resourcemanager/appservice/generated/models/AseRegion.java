 ...
 */
@Fluent
public final class AseRegion extends ProxyOnlyResource {
    /*
    ...
    /**
     * Creates an instance of AseRegion class.
     */
    public AseRegion() {
    }
     ...
     */
    @Override
    public AseRegion withKind(String kind) {
        super.withKind(kind);
        return this;
    }
     ...
     * @return the AseRegion object itself.
     */
    public AseRegion withAvailableSku(List<String> availableSku) {
     ...
     * @return the AseRegion object itself.
     */
    public AseRegion withAvailableOS(List<String> availableOS) {
        if (this.innerProperties() == null) {
            this.innerProperties = new AseRegionProperties();
        }
