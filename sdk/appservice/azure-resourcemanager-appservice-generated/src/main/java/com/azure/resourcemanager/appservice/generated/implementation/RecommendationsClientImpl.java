...
public final class RecommendationsClientImpl implements RecommendationsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> disableAllForHostingEnvironmentAsync(String resourceGroupName, String environmentName,
        String hostingEnvironmentName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> resetAllFiltersForHostingEnvironmentAsync(String resourceGroupName, String environmentName,
        String hostingEnvironmentName) {
