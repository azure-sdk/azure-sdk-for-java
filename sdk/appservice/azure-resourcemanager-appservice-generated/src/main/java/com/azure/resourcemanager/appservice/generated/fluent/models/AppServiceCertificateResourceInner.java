        ...
        if (location() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property location in model AppServiceCertificateResourceInner"));
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(AppServiceCertificateResourceInner.class);
