...
public interface StaticSitesClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<StaticSiteTrafficSplittingPropertiesArmResourceInner> listBasicAuth(
        String resourceGroupName, String name);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<StaticSiteTrafficSplittingPropertiesArmResourceInner> getTrafficSplittingWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    StaticSiteTrafficSplittingPropertiesArmResourceInner getTrafficSplitting(
        String resourceGroupName, String name, TrafficSplittingName trafficSplittingName);

    /**
     * Adds or updates traffic splitting for a static site.
     *
     * <p>Description for Adds or updates traffic splitting for a static site.
     *
     * @param resourceGroupName Name of the resource group to which the resource belongs.
     * @param name Name of the static site.
     * @param trafficSplittingName name of the traffic splitting entry.
     * @param trafficSplittingEnvelope A JSON representation of the traffic splitting properties.
     * @throws IllegalArgumentException thrown if parameters fail the validation.
     * @throws com.azure.resourcemanager.appservice.generated.models.DefaultErrorResponseErrorException thrown if the
     *     request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the {@link SyncPoller} for polling of static site traffic splitting properties ARM resource.
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<
            PollResult<StaticSiteTrafficSplittingPropertiesArmResourceInner>,
            StaticSiteTrafficSplittingPropertiesArmResourceInner>
        beginCreateOrUpdateTrafficSplitting(
            String resourceGroupName,
            String name,
            BasicAuthName trafficSplittingName,
            StaticSiteTrafficSplittingPropertiesArmResourceInner trafficSplittingEnvelope);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    StaticSiteTrafficSplittingPropertiesArmResourceInner createOrUpdateTrafficSplitting(
        String resourceGroupName,
        String name,
        BasicAuthName trafficSplittingName,
        StaticSiteTrafficSplittingPropertiesArmResourceInner trafficSplittingEnvelope);
