...
public final class AppServicePlanImpl implements AppServicePlan, AppServicePlan.Definition, AppServicePlan.Update {
    ...
    private AppServicePlanPatchResource updateAppServicePlanPatch;
    ...
    public AppServicePlanImpl update() {
        this.updateAppServicePlanPatch = new AppServicePlanPatchResource();
        return this;
    }
    ...
    public AppServicePlan apply() {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getAppServicePlans()
                .updateWithResponse(resourceGroupName, name, updateAppServicePlanPatch, Context.NONE)
                .getValue();
        return this;
    }
    ...
    public AppServicePlan apply(Context context) {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getAppServicePlans()
                .updateWithResponse(resourceGroupName, name, updateAppServicePlanPatch, context)
                .getValue();
        return this;
    }
    ...
    public AppServicePlanImpl withKind(String kind) {
        if (isInCreateMode()) {
            ...
            this.updateAppServicePlanPatch.withKind(kind);
            return this;
        }
    }
    ...
    public AppServicePlanImpl withWorkerTierName(String workerTierName) {
        if (isInCreateMode()) {
            ...
            this.updateAppServicePlanPatch.withWorkerTierName(workerTierName);
            return this;
        }
    }
    ...
    public AppServicePlanImpl withPerSiteScaling(Boolean perSiteScaling) {
        if (isInCreateMode()) {
            ...
            this.updateAppServicePlanPatch.withPerSiteScaling(perSiteScaling);
            return this;
        }
    }
    ...
    public AppServicePlanImpl withElasticScaleEnabled(Boolean elasticScaleEnabled) {
        if (isInCreateMode()) {
            ...
            this.updateAppServicePlanPatch.withElasticScaleEnabled(elasticScaleEnabled);
            return this;
        }
    }
    ...
    public AppServicePlanImpl withMaximumElasticWorkerCount(Integer maximumElasticWorkerCount) {
        if (isInCreateMode()) {
            ...
            this.updateAppServicePlanPatch.withMaximumElasticWorkerCount(maximumElasticWorkerCount);
            return this;
        }
    }
    ...
    public AppServicePlanImpl withIsSpot(Boolean isSpot) {
        if (isInCreateMode()) {
            ...
            this.updateAppServicePlanPatch.withIsSpot(isSpot);
            return this;
        }
    }
    ...
    public AppServicePlanImpl withSpotExpirationTime(OffsetDateTime spotExpirationTime) {
        if (isInCreateMode()) {
            ...
            this.updateAppServicePlanPatch.withSpotExpirationTime(spotExpirationTime);
            return this;
        }
    }
    ...
    public AppServicePlanImpl withFreeOfferExpirationTime(OffsetDateTime freeOfferExpirationTime) {
        if (isInCreateMode()) {
            ...
            this.updateAppServicePlanPatch.withFreeOfferExpirationTime(freeOfferExpirationTime);
            return this;
        }
    }
    ...
    public AppServicePlanImpl withTargetWorkerCount(Integer targetWorkerCount) {
        if (isInCreateMode()) {
            ...
            this.updateAppServicePlanPatch.withTargetWorkerCount(targetWorkerCount);
            return this;
        }
    }
    ...
    public AppServicePlanImpl withTargetWorkerSizeId(Integer targetWorkerSizeId) {
        if (isInCreateMode()) {
            ...
            this.updateAppServicePlanPatch.withTargetWorkerSizeId(targetWorkerSizeId);
            return this;
        }
    }
    ...
    public AppServicePlanImpl withKubeEnvironmentProfile(KubeEnvironmentProfile kubeEnvironmentProfile) {
        if (isInCreateMode()) {
            ...
            this.updateAppServicePlanPatch.withKubeEnvironmentProfile(kubeEnvironmentProfile);
            return this;
        }
    }
    ...
    public AppServicePlanImpl withZoneRedundant(Boolean zoneRedundant) {
        if (isInCreateMode()) {
            ...
            this.updateAppServicePlanPatch.withZoneRedundant(zoneRedundant);
            return this;
        }
    }
