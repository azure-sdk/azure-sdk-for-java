 ...
 */
@Fluent
public final class SwiftVirtualNetworkInner implements JsonSerializable<SwiftVirtualNetworkInner> {
    /*
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("subnetResourceId".equals(fieldName)) {
                    deserializedSwiftVirtualNetworkInner.subnetResourceId = reader.getString();
                } else if ("swiftSupported".equals(fieldName)) {
                    deserializedSwiftVirtualNetworkInner.swiftSupported = reader.getNullable(JsonReader::getBoolean);
                } else if ("subnetIpAllocation".equals(fieldName)) {
                    deserializedSwiftVirtualNetworkInner.subnetIpAllocation
                        = SwiftVirtualNetworkSubnetIpAllocation.fromJson(reader);
                } else if ("vnetConnectionAllocation".equals(fieldName)) {
                    deserializedSwiftVirtualNetworkInner.vnetConnectionAllocation
                        = SwiftVirtualNetworkVnetConnectionAllocation.fromJson(reader);
                } else if ("resourceAllocation".equals(fieldName)) {
                    deserializedSwiftVirtualNetworkInner.resourceAllocation
                        = SwiftVirtualNetworkResourceAllocation.fromJson(reader);
                } else {
                    reader.skipChildren();
                }
            }
