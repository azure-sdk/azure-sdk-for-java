...
public final class DiagnosticsImpl implements Diagnostics {
    ...
    public PagedIterable<DetectorResponse> listProviderDetectorResponses(String location, String resourceType) {
        PagedIterable<DetectorResponseInner> inner =
            this.serviceClient().listProviderDetectorResponses(location, resourceType);
        return Utils.mapPage(inner, inner1 -> new DetectorResponseImpl(inner1, this.manager()));
    }

    public PagedIterable<DetectorResponse> listProviderDetectorResponses(
        String location, String resourceType, Context context) {
        PagedIterable<DetectorResponseInner> inner =
            this.serviceClient().listProviderDetectorResponses(location, resourceType, context);
        return Utils.mapPage(inner, inner1 -> new DetectorResponseImpl(inner1, this.manager()));
    }

    public Response<DetectorResponse> getProviderDetectorResponseWithResponse(
        String location,
        String detectorName,
        String resourceType,
    ...
    public DetectorResponse getProviderDetectorResponse(String location, String detectorName, String resourceType) {
        DetectorResponseInner inner =
            this.serviceClient().getProviderDetectorResponse(location, detectorName, resourceType);
        if (inner != null) {
