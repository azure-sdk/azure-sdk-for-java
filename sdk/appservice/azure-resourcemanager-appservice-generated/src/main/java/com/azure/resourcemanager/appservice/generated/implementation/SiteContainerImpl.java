...
public final class SiteContainerImpl implements SiteContainer, SiteContainer.Definition, SiteContainer.Update {
    ...
    public SiteContainer create() {
        this.innerObject
            = serviceManager.serviceClient().getWebApps().createOrUpdateSiteContainerWithResponse(resourceGroupName,
                name, containerName, this.innerModel(), Context.NONE).getValue();
        return this;
    }
    ...
    public SiteContainer refresh() {
        this.innerObject = serviceManager.serviceClient().getWebApps()
            .getSiteContainerWithResponse(resourceGroupName, name, containerName, Context.NONE).getValue();
        return this;
    }

    public SiteContainer refresh(Context context) {
        this.innerObject = serviceManager.serviceClient().getWebApps()
            .getSiteContainerWithResponse(resourceGroupName, name, containerName, context).getValue();
        return this;
    }
