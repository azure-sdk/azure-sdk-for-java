...
public final class AseV3NetworkingConfigurationInner extends ProxyOnlyResource {
    ...
    public Integer numberOfOutboundIpAddresses() {
        return this.innerProperties() == null ? null : this.innerProperties().numberOfOutboundIpAddresses();
    }
     ...
     * @return the AseV3NetworkingConfigurationInner object itself.
     */
    public AseV3NetworkingConfigurationInner withNumberOfOutboundIpAddresses(Integer numberOfOutboundIpAddresses) {
        if (this.innerProperties() == null) {
            this.innerProperties = new AseV3NetworkingConfigurationProperties();
        }
        this.innerProperties().withNumberOfOutboundIpAddresses(numberOfOutboundIpAddresses);
        return this;
    }
    ...
    public Integer targetNumberOfOutboundIpAddresses() {
        return this.innerProperties() == null ? null : this.innerProperties().targetNumberOfOutboundIpAddresses();
    }
