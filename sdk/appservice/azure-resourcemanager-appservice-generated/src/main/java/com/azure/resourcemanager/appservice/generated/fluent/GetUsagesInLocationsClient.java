...
public interface GetUsagesInLocationsClient {
    ...
    PagedIterable<CsmUsageQuotaInner> list(String location, String quotaType);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<CsmUsageQuotaInner> list(String location, String quotaType, Context context);
}
