    ...
    public void validate() {
        ...
        if (location() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Missing required property location in model KubeEnvironmentInner"));
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(KubeEnvironmentInner.class);
