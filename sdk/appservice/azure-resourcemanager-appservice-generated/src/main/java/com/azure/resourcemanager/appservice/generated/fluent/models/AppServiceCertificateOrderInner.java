        ...
        if (location() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property location in model AppServiceCertificateOrderInner"));
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(AppServiceCertificateOrderInner.class);
