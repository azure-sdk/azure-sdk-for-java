    ...
    public void validate() {
        if (volumeSubPath() == null) {
            throw LOGGER.logExceptionAsError(
                new IllegalArgumentException("Missing required property volumeSubPath in model VolumeMount"));
        }
        if (containerMountPath() == null) {
            throw LOGGER.logExceptionAsError(
                new IllegalArgumentException("Missing required property containerMountPath in model VolumeMount"));
        }
    }
