...
public interface WebAppsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<WorkflowEnvelopeInner> listInstanceWorkflowsConfigurationConnectionsSlotWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    WorkflowEnvelopeInner listInstanceWorkflowsConfigurationConnectionsSlot(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<WorkflowEnvelopeInner> listWorkflowsConfigurationWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    WorkflowEnvelopeInner listWorkflowsConfiguration(String resourceGroupName, String name, String configurationName);
}
