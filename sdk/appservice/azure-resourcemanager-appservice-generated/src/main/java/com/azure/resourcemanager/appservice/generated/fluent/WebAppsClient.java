...
public interface WebAppsClient {
     ...
     *     request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the deployment status for an app (or deployment slot, if specified) along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<CsmDeploymentStatusInner> getProductionSiteDeploymentStatusWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<CsmDeploymentStatusInner> getSlotSiteDeploymentStatusSlotWithResponse(
