...
public interface DiagnosticsClient {
    ...
    PagedIterable<DetectorResponseInner> listProviderDetectorResponses(String location, String resourceType);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<DetectorResponseInner> listProviderDetectorResponses(
    ...
    Response<DetectorResponseInner> getProviderDetectorResponseWithResponse(
        String location,
        String detectorName,
        String resourceType,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    DetectorResponseInner getProviderDetectorResponse(String location, String detectorName, String resourceType);
