...
import com.azure.resourcemanager.appservice.generated.models.WorkflowTriggerHistoryListResult;
...
public final class WorkflowTriggerHistoriesClientImpl implements WorkflowTriggerHistoriesClient {
    ...
    private Mono<Void> resubmitAsync(
        String resourceGroupName, String name, String workflowName, String triggerName, String historyName) {
        return resubmitWithResponseAsync(resourceGroupName, name, workflowName, triggerName, historyName)
    ...
    public Response<Void> resubmitWithResponse(
        ...
        String historyName,
        Context context) {
        return resubmitWithResponseAsync(resourceGroupName, name, workflowName, triggerName, historyName, context)
            .block();
    }
