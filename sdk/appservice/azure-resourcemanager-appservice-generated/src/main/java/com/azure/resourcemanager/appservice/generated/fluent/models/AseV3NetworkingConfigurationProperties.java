...
public final class AseV3NetworkingConfigurationProperties {
     ...
     */
    @JsonProperty(value = "numberOfOutboundIpAddresses")
    private Integer numberOfOutboundIpAddresses;
    ...
    /*
     * The targetNumberOfOutboundIpAddresses property.
     */
    @JsonProperty(value = "targetNumberOfOutboundIpAddresses", access = JsonProperty.Access.WRITE_ONLY)
    private Integer targetNumberOfOutboundIpAddresses;
    ...
    /**
     * Get the numberOfOutboundIpAddresses property: Property to set the number of outbound ips on AseV3.
     *
     * @return the numberOfOutboundIpAddresses value.
     */
    public Integer numberOfOutboundIpAddresses() {
        return this.numberOfOutboundIpAddresses;
    }

    /**
     * Set the numberOfOutboundIpAddresses property: Property to set the number of outbound ips on AseV3.
     *
     * @param numberOfOutboundIpAddresses the numberOfOutboundIpAddresses value to set.
     * @return the AseV3NetworkingConfigurationProperties object itself.
     */
    public AseV3NetworkingConfigurationProperties withNumberOfOutboundIpAddresses(Integer numberOfOutboundIpAddresses) {
        this.numberOfOutboundIpAddresses = numberOfOutboundIpAddresses;
        return this;
    }
    ...
    /**
     * Get the targetNumberOfOutboundIpAddresses property: The targetNumberOfOutboundIpAddresses property.
     *
     * @return the targetNumberOfOutboundIpAddresses value.
     */
    public Integer targetNumberOfOutboundIpAddresses() {
        return this.targetNumberOfOutboundIpAddresses;
    }
