...
public final class SitePropertiesInner {
    ...
    /*
     * Azure Resource Manager ID of the customer's selected Container App Environment on which to host this app. This
     * must be of the form
     * /subscriptions/{subscriptionId}/resourceGroups/{resourceGroup}/providers/Microsoft.App/managedEnvironments/{managedEnvironmentName}
     */
    ...
    /**
     * Get the environmentId property: Azure Resource Manager ID of the customer's selected Container App Environment on
    ...
    /**
     * Set the environmentId property: Azure Resource Manager ID of the customer's selected Container App Environment on
     * which to host this app. This must be of the form
     * /subscriptions/{subscriptionId}/resourceGroups/{resourceGroup}/providers/Microsoft.App/managedEnvironments/{managedEnvironmentName}.
     *
     ...
     * @return the SitePropertiesInner object itself.
     */
    public SitePropertiesInner withEnvironmentId(String environmentId) {
