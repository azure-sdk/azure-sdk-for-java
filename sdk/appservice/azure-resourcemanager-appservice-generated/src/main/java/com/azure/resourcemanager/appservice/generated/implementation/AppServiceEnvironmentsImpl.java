...
public final class AppServiceEnvironmentsImpl implements AppServiceEnvironments {
    ...
    public void testUpgradeNotification(String resourceGroupName, String name) {
        this.serviceClient().testUpgradeNotification(resourceGroupName, name);
    }

    public Response<Void> testUpgradeNotificationWithResponse(String resourceGroupName, String name, Context context) {
        return this.serviceClient().testUpgradeNotificationWithResponse(resourceGroupName, name, context);
    }
