...
import com.azure.resourcemanager.appservice.generated.models.HybridConnectionCollection;
import com.azure.resourcemanager.appservice.generated.models.ResourceCollection;
import com.azure.resourcemanager.appservice.generated.models.SwiftVirtualNetworkCollection;
...
public final class AppServicePlansClientImpl implements AppServicePlansClient {
    ...
    public interface AppServicePlansService {
        ...
        @Headers({ "Content-Type: application/json" })
        @Get("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/serverfarms/{name}/virtualNetworkIntegrations/{vnetName}")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(DefaultErrorResponseErrorException.class)
        Mono<Response<SwiftVirtualNetworkInner>> getVirtualNetworkIntegration(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("name") String name,
            @PathParam("vnetName") String vnetName, @PathParam("subscriptionId") String subscriptionId,
            @QueryParam("api-version") String apiVersion, @HeaderParam("Accept") String accept, Context context);

        @Headers({ "Content-Type: application/json" })
        @Get("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/serverfarms/{name}/virtualNetworkIntegrations")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(DefaultErrorResponseErrorException.class)
        Mono<Response<SwiftVirtualNetworkCollection>> getVirtualNetworkIntegrations(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("name") String name,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(DefaultErrorResponseErrorException.class)
        Mono<Response<SwiftVirtualNetworkCollection>> getVirtualNetworkIntegrationsNext(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Object> getServerFarmSkusAsync(String resourceGroupName, String name) {
     ...
     * Get a Virtual Network associated with an App Service plan
     * 
     * Get a Virtual Network associated with an App Service plan and its properties, such as IP allocation and resource
     * allocation.
     * 
     * @param resourceGroupName Name of the resource group to which the resource belongs.
     * @param name Name of the App Service plan.
     ...
     * @throws DefaultErrorResponseErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a Virtual Network associated with an App Service plan and its properties, such as IP allocation and
     * resource allocation along with {@link Response} on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<SwiftVirtualNetworkInner>>
        getVirtualNetworkIntegrationWithResponseAsync(String resourceGroupName, String name, String vnetName) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.getVirtualNetworkIntegration(this.client.getEndpoint(), resourceGroupName,
                name, vnetName, this.client.getSubscriptionId(), this.client.getApiVersion(), accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<SwiftVirtualNetworkInner>> getVirtualNetworkIntegrationWithResponseAsync(
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.getVirtualNetworkIntegration(this.client.getEndpoint(), resourceGroupName, name, vnetName,
            this.client.getSubscriptionId(), this.client.getApiVersion(), accept, context);
    }
     ...
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a Virtual Network associated with an App Service plan and its properties, such as IP allocation and
     * resource allocation on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<SwiftVirtualNetworkInner> getVirtualNetworkIntegrationAsync(String resourceGroupName, String name,
        String vnetName) {
        return getVirtualNetworkIntegrationWithResponseAsync(resourceGroupName, name, vnetName)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a Virtual Network associated with an App Service plan and its properties, such as IP allocation and
     * resource allocation along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<SwiftVirtualNetworkInner> getVirtualNetworkIntegrationWithResponse(String resourceGroupName,
        String name, String vnetName, Context context) {
        return getVirtualNetworkIntegrationWithResponseAsync(resourceGroupName, name, vnetName, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public SwiftVirtualNetworkInner getVirtualNetworkIntegration(String resourceGroupName, String name,
        String vnetName) {
        return getVirtualNetworkIntegrationWithResponse(resourceGroupName, name, vnetName, Context.NONE).getValue();
    }

    /**
     * Get all Virtual Networks associated with an App Service plan
     * 
     * Get all Virtual Networks associated with an App Service plan and their properties, such as IP allocation and
     * resource allocation.
     * 
     * @param resourceGroupName Name of the resource group to which the resource belongs.
     * @param name Name of the App Service plan.
     ...
     * @throws DefaultErrorResponseErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return all Virtual Networks associated with an App Service plan and their properties, such as IP allocation and
     * resource allocation along with {@link PagedResponse} on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<SwiftVirtualNetworkInner>>
        getVirtualNetworkIntegrationsSinglePageAsync(String resourceGroupName, String name) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.getVirtualNetworkIntegrations(this.client.getEndpoint(), resourceGroupName,
                name, this.client.getSubscriptionId(), this.client.getApiVersion(), accept, context))
            .<PagedResponse<SwiftVirtualNetworkInner>>map(res -> new PagedResponseBase<>(res.getRequest(),
                res.getStatusCode(), res.getHeaders(), res.getValue().value(), res.getValue().nextLink(), null))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<SwiftVirtualNetworkInner>>
        getVirtualNetworkIntegrationsSinglePageAsync(String resourceGroupName, String name, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        context = this.client.mergeContext(context);
        return service
            .getVirtualNetworkIntegrations(this.client.getEndpoint(), resourceGroupName, name,
                this.client.getSubscriptionId(), this.client.getApiVersion(), accept, context)
            .map(res -> new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(),
                res.getValue().value(), res.getValue().nextLink(), null));
    }
     ...
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return all Virtual Networks associated with an App Service plan and their properties, such as IP allocation and
     * resource allocation as paginated response with {@link PagedFlux}.
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<SwiftVirtualNetworkInner> getVirtualNetworkIntegrationsAsync(String resourceGroupName,
        String name) {
        return new PagedFlux<>(() -> getVirtualNetworkIntegrationsSinglePageAsync(resourceGroupName, name),
            nextLink -> getVirtualNetworkIntegrationsNextSinglePageAsync(nextLink));
    }
    ...
    private PagedFlux<SwiftVirtualNetworkInner> getVirtualNetworkIntegrationsAsync(String resourceGroupName,
        String name, Context context) {
        return new PagedFlux<>(() -> getVirtualNetworkIntegrationsSinglePageAsync(resourceGroupName, name, context),
            nextLink -> getVirtualNetworkIntegrationsNextSinglePageAsync(nextLink, context));
    }
     ...
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return all Virtual Networks associated with an App Service plan and their properties, such as IP allocation and
     * resource allocation as paginated response with {@link PagedIterable}.
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<SwiftVirtualNetworkInner> getVirtualNetworkIntegrations(String resourceGroupName,
        String name) {
        return new PagedIterable<>(getVirtualNetworkIntegrationsAsync(resourceGroupName, name));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<SwiftVirtualNetworkInner> getVirtualNetworkIntegrations(String resourceGroupName, String name,
        Context context) {
        return new PagedIterable<>(getVirtualNetworkIntegrationsAsync(resourceGroupName, name, context));
    }
     ...
     * @throws DefaultErrorResponseErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return collection of Swift Virtual Networks along with {@link PagedResponse} on successful completion of
     * {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<SwiftVirtualNetworkInner>>
        getVirtualNetworkIntegrationsNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        if (this.client.getEndpoint() == null) {
        ...
        final String accept = "application/json";
        return FluxUtil.withContext(
            context -> service.getVirtualNetworkIntegrationsNext(nextLink, this.client.getEndpoint(), accept, context))
            .<PagedResponse<SwiftVirtualNetworkInner>>map(res -> new PagedResponseBase<>(res.getRequest(),
                res.getStatusCode(), res.getHeaders(), res.getValue().value(), res.getValue().nextLink(), null))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<SwiftVirtualNetworkInner>>
        getVirtualNetworkIntegrationsNextSinglePageAsync(String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        if (this.client.getEndpoint() == null) {
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.getVirtualNetworkIntegrationsNext(nextLink, this.client.getEndpoint(), accept, context)
            .map(res -> new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(),
                res.getValue().value(), res.getValue().nextLink(), null));
    }
}
