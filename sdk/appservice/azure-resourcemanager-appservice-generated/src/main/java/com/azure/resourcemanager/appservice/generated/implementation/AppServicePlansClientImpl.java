...
public final class AppServicePlansClientImpl implements AppServicePlansClient {
    ...
    public interface AppServicePlansService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(DefaultErrorResponseErrorException.class)
        Mono<Response<SwiftVirtualNetworkCollection>> listByVirtualNetworkIntegrations(
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(DefaultErrorResponseErrorException.class)
        Mono<Response<SwiftVirtualNetworkCollection>> listByVirtualNetworkIntegrationsNext(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    }
    ...
    private Mono<PagedResponse<SwiftVirtualNetworkInner>>
        listByVirtualNetworkIntegrationsSinglePageAsync(String resourceGroupName, String name) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.listByVirtualNetworkIntegrations(this.client.getEndpoint(),
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<SwiftVirtualNetworkInner>>
        listByVirtualNetworkIntegrationsSinglePageAsync(String resourceGroupName, String name, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        context = this.client.mergeContext(context);
        return service
            .listByVirtualNetworkIntegrations(this.client.getEndpoint(), resourceGroupName, name,
                this.client.getSubscriptionId(), this.client.getApiVersion(), accept, context)
            .map(res -> new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(),
                res.getValue().value(), res.getValue().nextLink(), null));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<SwiftVirtualNetworkInner> listByVirtualNetworkIntegrationsAsync(String resourceGroupName,
        String name) {
        return new PagedFlux<>(() -> listByVirtualNetworkIntegrationsSinglePageAsync(resourceGroupName, name),
            nextLink -> listByVirtualNetworkIntegrationsNextSinglePageAsync(nextLink));
    }
    ...
    private PagedFlux<SwiftVirtualNetworkInner> listByVirtualNetworkIntegrationsAsync(String resourceGroupName,
        String name, Context context) {
        return new PagedFlux<>(() -> listByVirtualNetworkIntegrationsSinglePageAsync(resourceGroupName, name, context),
            nextLink -> listByVirtualNetworkIntegrationsNextSinglePageAsync(nextLink, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<SwiftVirtualNetworkInner> listByVirtualNetworkIntegrations(String resourceGroupName,
        String name) {
        return new PagedIterable<>(listByVirtualNetworkIntegrationsAsync(resourceGroupName, name));
    }
    ...
    public PagedIterable<SwiftVirtualNetworkInner> listByVirtualNetworkIntegrations(String resourceGroupName,
        String name, Context context) {
        return new PagedIterable<>(listByVirtualNetworkIntegrationsAsync(resourceGroupName, name, context));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<SwiftVirtualNetworkInner>>
        listByVirtualNetworkIntegrationsNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        if (this.client.getEndpoint() == null) {
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.listByVirtualNetworkIntegrationsNext(nextLink, this.client.getEndpoint(),
                accept, context))
            .<PagedResponse<SwiftVirtualNetworkInner>>map(res -> new PagedResponseBase<>(res.getRequest(),
                res.getStatusCode(), res.getHeaders(), res.getValue().value(), res.getValue().nextLink(), null))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<SwiftVirtualNetworkInner>>
        listByVirtualNetworkIntegrationsNextSinglePageAsync(String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        if (this.client.getEndpoint() == null) {
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.listByVirtualNetworkIntegrationsNext(nextLink, this.client.getEndpoint(), accept, context)
            .map(res -> new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(),
                res.getValue().value(), res.getValue().nextLink(), null));
    }
}
