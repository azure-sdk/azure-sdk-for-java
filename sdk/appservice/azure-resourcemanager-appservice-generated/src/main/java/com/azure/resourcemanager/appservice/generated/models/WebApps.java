...
public interface WebApps {
     ...
     * @return collection of Kudu workflow information elements as paginated response with {@link PagedIterable}.
     */
    PagedIterable<WorkflowEnvelope> listInstanceWorkflowsSlot(
        String resourceGroupName, String name, String slot, Context context);
     ...
     */
    Response<WorkflowEnvelope> getInstanceWorkflowSlotWithResponse(
     ...
     * @param name Site name.
     * @param slot Name of the deployment slot.
     * @param configurationName Name of workflow configurations.
     * @param context The context to associate with this operation.
     * @throws IllegalArgumentException thrown if parameters fail the validation.
     * @throws com.azure.resourcemanager.appservice.generated.models.DefaultErrorResponseErrorException thrown if the
     *     request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return workflow app's configurations connections information by its ID for web site, or a deployment slot along
     *     with {@link Response}.
     */
    Response<WorkflowEnvelope> listInstanceWorkflowsConfigurationConnectionsSlotWithResponse(
     ...
     *     request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return workflow app's configurations connections information by its ID for web site, or a deployment slot.
     */
    WorkflowEnvelope listInstanceWorkflowsConfigurationConnectionsSlot(
     ...
     * @return workflow information by its ID for web site, or a deployment slot along with {@link Response}.
     */
    Response<WorkflowEnvelope> getWorkflowWithResponse(
     ...
     *     with {@link Response}.
     */
    Response<WorkflowEnvelope> listWorkflowsConfigurationWithResponse(
     ...
     * @return workflow app's configurations connections information by its ID for web site, or a deployment slot.
     */
    WorkflowEnvelope listWorkflowsConfiguration(String resourceGroupName, String name, String configurationName);
