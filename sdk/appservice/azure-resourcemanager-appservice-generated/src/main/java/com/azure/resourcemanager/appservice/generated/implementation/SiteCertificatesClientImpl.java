...
public final class SiteCertificatesClientImpl implements SiteCertificatesClient {
    ...
    private Mono<Response<CertificateInner>> createOrUpdateSlotWithResponseAsync(String resourceGroupName, String name,
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.createOrUpdateSlot(this.client.getEndpoint(),
                this.client.getSubscriptionId(), resourceGroupName, name, slot, certificateName,
    ...
    private Mono<Response<CertificateInner>> createOrUpdateSlotWithResponseAsync(String resourceGroupName, String name,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.createOrUpdateSlot(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
