...
public interface AppServiceEnvironments {
     ...
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     */
    void testUpgradeNotification(String resourceGroupName, String name);
     ...
     */
    Response<Void> testUpgradeNotificationWithResponse(String resourceGroupName, String name, Context context);
