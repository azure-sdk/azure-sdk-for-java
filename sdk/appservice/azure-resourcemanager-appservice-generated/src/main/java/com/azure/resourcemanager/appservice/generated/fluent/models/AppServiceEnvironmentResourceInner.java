...
public final class AppServiceEnvironmentResourceInner extends Resource {
    ...
    /**
     * Get the multiSize property: Front-end VM size, e.g. "Medium", "Large". (v2 only).
     *
    ...
    /**
     * Set the multiSize property: Front-end VM size, e.g. "Medium", "Large". (v2 only).
     *
    ...
    /**
     * Get the ipsslAddressCount property: Number of IP SSL addresses reserved for the App Service Environment. (v2
     * only).
     *
    ...
    /**
     * Set the ipsslAddressCount property: Number of IP SSL addresses reserved for the App Service Environment. (v2
     * only).
     *
    ...
    /**
     * Get the dnsSuffix property: DNS suffix of the App Service Environment. (v2 only).
     *
    ...
    /**
     * Set the dnsSuffix property: DNS suffix of the App Service Environment. (v2 only).
     *
    ...
    /**
     * Get the frontEndScaleFactor property: Scale factor for front-ends. (v2 only).
     *
    ...
    /**
     * Set the frontEndScaleFactor property: Scale factor for front-ends. (v2 only).
     *
    ...
    /**
     * Get the userWhitelistedIpRanges property: User added list of IP Ranges allowed on ASE db. (v2 only).
     *
    ...
    /**
     * Set the userWhitelistedIpRanges property: User added list of IP Ranges allowed on ASE db. (v2 only).
     *
    ...
    /**
     * Get the dedicatedHostCount property: Dedicated Host Count. (v3 only).
     *
    ...
    /**
     * Set the dedicatedHostCount property: Dedicated Host Count. (v3 only).
     *
    ...
    /**
     * Get the zoneRedundant property: Whether or not this App Service Environment is zone-redundant. (v3 only).
     *
    ...
    /**
     * Set the zoneRedundant property: Whether or not this App Service Environment is zone-redundant. (v3 only).
     *
    ...
    /**
     * Get the customDnsSuffixConfiguration property: Full view of the custom domain suffix configuration for ASE.
     *
    ...
    /**
     * Set the customDnsSuffixConfiguration property: Full view of the custom domain suffix configuration for ASE.
     *
    ...
    /**
     * Get the networkingConfiguration property: Full view of networking configuration for an ASEv3.
     *
    ...
    /**
     * Set the networkingConfiguration property: Full view of networking configuration for an ASEv3.
     *
