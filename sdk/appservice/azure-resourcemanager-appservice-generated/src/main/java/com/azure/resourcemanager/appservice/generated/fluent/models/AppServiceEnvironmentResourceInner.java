        ...
        if (location() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property location in model AppServiceEnvironmentResourceInner"));
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(AppServiceEnvironmentResourceInner.class);
