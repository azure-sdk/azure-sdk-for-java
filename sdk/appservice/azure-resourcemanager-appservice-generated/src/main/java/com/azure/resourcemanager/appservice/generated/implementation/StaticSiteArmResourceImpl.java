...
public final class StaticSiteArmResourceImpl
    ...
    public void zipDeploy(StaticSiteZipDeployArmResource staticSiteEnvelope) {
        serviceManager.staticSites().zipDeploy(resourceGroupName, name, staticSiteEnvelope);
    }

    public void zipDeploy(StaticSiteZipDeployArmResource staticSiteEnvelope, Context context) {
        serviceManager.staticSites().zipDeploy(resourceGroupName, name, staticSiteEnvelope, context);
    }
