...
public final class StaticSiteArmResourceImpl
    ...
    public void purgeStaticSite() {
        serviceManager.staticSites().purgeStaticSite(resourceGroupName, name);
    }

    public void purgeStaticSite(Context context) {
        serviceManager.staticSites().purgeStaticSite(resourceGroupName, name, context);
    }
