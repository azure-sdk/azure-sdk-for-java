...
public final class StaticSiteArmResourceImpl
    ...
    public String targetResourceGroupResourceId() {
        return this.innerModel().targetResourceGroupResourceId();
    }
    ...
    public StaticSiteArmResourceImpl withTargetResourceGroupResourceId(String targetResourceGroupResourceId) {
        if (isInCreateMode()) {
            this.innerModel().withTargetResourceGroupResourceId(targetResourceGroupResourceId);
            return this;
        } else {
            this.updateStaticSiteEnvelope.withTargetResourceGroupResourceId(targetResourceGroupResourceId);
            return this;
        }
    }
