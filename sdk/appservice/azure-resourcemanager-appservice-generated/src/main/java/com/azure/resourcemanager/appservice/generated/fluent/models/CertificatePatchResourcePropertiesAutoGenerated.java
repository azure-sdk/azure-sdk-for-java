 ...
 */
@Fluent
public final class CertificatePatchResourcePropertiesAutoGenerated
    implements JsonSerializable<CertificatePatchResourcePropertiesAutoGenerated> {
    /*
    ...
    /**
     * Creates an instance of CertificatePatchResourcePropertiesAutoGenerated class.
     */
    public CertificatePatchResourcePropertiesAutoGenerated() {
    }
     ...
     * @return the CertificatePatchResourcePropertiesAutoGenerated object itself.
     */
    public CertificatePatchResourcePropertiesAutoGenerated withPassword(String password) {
     ...
     * @return the CertificatePatchResourcePropertiesAutoGenerated object itself.
     */
    public CertificatePatchResourcePropertiesAutoGenerated withHostNames(List<String> hostNames) {
     ...
     * @return the CertificatePatchResourcePropertiesAutoGenerated object itself.
     */
    public CertificatePatchResourcePropertiesAutoGenerated withPfxBlob(byte[] pfxBlob) {
     ...
     * @return the CertificatePatchResourcePropertiesAutoGenerated object itself.
     */
    public CertificatePatchResourcePropertiesAutoGenerated withKeyVaultId(String keyVaultId) {
     ...
     * @return the CertificatePatchResourcePropertiesAutoGenerated object itself.
     */
    public CertificatePatchResourcePropertiesAutoGenerated withKeyVaultSecretName(String keyVaultSecretName) {
     ...
     * @return the CertificatePatchResourcePropertiesAutoGenerated object itself.
     */
    public CertificatePatchResourcePropertiesAutoGenerated withServerFarmId(String serverFarmId) {
     ...
     * @return the CertificatePatchResourcePropertiesAutoGenerated object itself.
     */
    public CertificatePatchResourcePropertiesAutoGenerated withCanonicalName(String canonicalName) {
     ...
     * @return the CertificatePatchResourcePropertiesAutoGenerated object itself.
     */
    public CertificatePatchResourcePropertiesAutoGenerated withDomainValidationMethod(String domainValidationMethod) {
    ...
    /**
     * Reads an instance of CertificatePatchResourcePropertiesAutoGenerated from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of CertificatePatchResourcePropertiesAutoGenerated if the JsonReader was pointing to an
     * instance of it, or null if it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the CertificatePatchResourcePropertiesAutoGenerated.
     */
    public static CertificatePatchResourcePropertiesAutoGenerated fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            CertificatePatchResourcePropertiesAutoGenerated deserializedCertificatePatchResourcePropertiesAutoGenerated
                = new CertificatePatchResourcePropertiesAutoGenerated();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("password".equals(fieldName)) {
                    deserializedCertificatePatchResourcePropertiesAutoGenerated.password = reader.getString();
                } else if ("friendlyName".equals(fieldName)) {
                    deserializedCertificatePatchResourcePropertiesAutoGenerated.friendlyName = reader.getString();
                } else if ("subjectName".equals(fieldName)) {
                    deserializedCertificatePatchResourcePropertiesAutoGenerated.subjectName = reader.getString();
                } else if ("hostNames".equals(fieldName)) {
                    List<String> hostNames = reader.readArray(reader1 -> reader1.getString());
                    deserializedCertificatePatchResourcePropertiesAutoGenerated.hostNames = hostNames;
                } else if ("pfxBlob".equals(fieldName)) {
                    deserializedCertificatePatchResourcePropertiesAutoGenerated.pfxBlob = reader.getBinary();
                } else if ("siteName".equals(fieldName)) {
                    deserializedCertificatePatchResourcePropertiesAutoGenerated.siteName = reader.getString();
                } else if ("selfLink".equals(fieldName)) {
                    deserializedCertificatePatchResourcePropertiesAutoGenerated.selfLink = reader.getString();
                } else if ("issuer".equals(fieldName)) {
                    deserializedCertificatePatchResourcePropertiesAutoGenerated.issuer = reader.getString();
                } else if ("issueDate".equals(fieldName)) {
                    deserializedCertificatePatchResourcePropertiesAutoGenerated.issueDate = reader
                        .getNullable(nonNullReader -> CoreUtils.parseBestOffsetDateTime(nonNullReader.getString()));
                } else if ("expirationDate".equals(fieldName)) {
                    deserializedCertificatePatchResourcePropertiesAutoGenerated.expirationDate = reader
                        .getNullable(nonNullReader -> CoreUtils.parseBestOffsetDateTime(nonNullReader.getString()));
                } else if ("thumbprint".equals(fieldName)) {
                    deserializedCertificatePatchResourcePropertiesAutoGenerated.thumbprint = reader.getString();
                } else if ("valid".equals(fieldName)) {
                    deserializedCertificatePatchResourcePropertiesAutoGenerated.valid
                        = reader.getNullable(JsonReader::getBoolean);
                } else if ("cerBlob".equals(fieldName)) {
                    deserializedCertificatePatchResourcePropertiesAutoGenerated.cerBlob = reader.getBinary();
                } else if ("publicKeyHash".equals(fieldName)) {
                    deserializedCertificatePatchResourcePropertiesAutoGenerated.publicKeyHash = reader.getString();
                } else if ("hostingEnvironmentProfile".equals(fieldName)) {
                    deserializedCertificatePatchResourcePropertiesAutoGenerated.hostingEnvironmentProfile
                        = HostingEnvironmentProfile.fromJson(reader);
                } else if ("keyVaultId".equals(fieldName)) {
                    deserializedCertificatePatchResourcePropertiesAutoGenerated.keyVaultId = reader.getString();
                } else if ("keyVaultSecretName".equals(fieldName)) {
                    deserializedCertificatePatchResourcePropertiesAutoGenerated.keyVaultSecretName = reader.getString();
                } else if ("keyVaultSecretStatus".equals(fieldName)) {
                    deserializedCertificatePatchResourcePropertiesAutoGenerated.keyVaultSecretStatus
                        = KeyVaultSecretStatus.fromString(reader.getString());
                } else if ("serverFarmId".equals(fieldName)) {
                    deserializedCertificatePatchResourcePropertiesAutoGenerated.serverFarmId = reader.getString();
                } else if ("canonicalName".equals(fieldName)) {
                    deserializedCertificatePatchResourcePropertiesAutoGenerated.canonicalName = reader.getString();
                } else if ("domainValidationMethod".equals(fieldName)) {
                    deserializedCertificatePatchResourcePropertiesAutoGenerated.domainValidationMethod
                        = reader.getString();
                } else {
                    reader.skipChildren();
                }
            ...
            return deserializedCertificatePatchResourcePropertiesAutoGenerated;
        });
    }
}
