...
public final class StaticSitePatchResource extends ProxyOnlyResource {
    ...
    /**
     * Get the targetResourceGroupResourceId property: Target resource group id for trial migration.
     *
     * @return the targetResourceGroupResourceId value.
     */
    public String targetResourceGroupResourceId() {
        return this.innerProperties() == null ? null : this.innerProperties().targetResourceGroupResourceId();
    }

    /**
     * Set the targetResourceGroupResourceId property: Target resource group id for trial migration.
     *
     * @param targetResourceGroupResourceId the targetResourceGroupResourceId value to set.
     * @return the StaticSitePatchResource object itself.
     */
    public StaticSitePatchResource withTargetResourceGroupResourceId(String targetResourceGroupResourceId) {
        if (this.innerProperties() == null) {
            this.innerProperties = new StaticSite();
        }
        this.innerProperties().withTargetResourceGroupResourceId(targetResourceGroupResourceId);
        return this;
    }
