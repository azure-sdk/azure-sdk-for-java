 ...
 */
@Fluent
public final class SwiftVirtualNetworkAutoGeneratedInner extends ProxyOnlyResource {
    /*
    ...
    /**
     * Creates an instance of SwiftVirtualNetworkAutoGeneratedInner class.
     */
    public SwiftVirtualNetworkAutoGeneratedInner() {
    }
     ...
     */
    @Override
    public SwiftVirtualNetworkAutoGeneratedInner withKind(String kind) {
        super.withKind(kind);
        return this;
    }
     ...
     * @return the SwiftVirtualNetworkAutoGeneratedInner object itself.
     */
    public SwiftVirtualNetworkAutoGeneratedInner withSubnetResourceId(String subnetResourceId) {
     ...
     * @return the SwiftVirtualNetworkAutoGeneratedInner object itself.
     */
    public SwiftVirtualNetworkAutoGeneratedInner withSwiftSupported(Boolean swiftSupported) {
        if (this.innerProperties() == null) {
            this.innerProperties = new SwiftVirtualNetworkProperties();
        }
