...
import com.azure.resourcemanager.appservice.generated.models.AutoGeneratedDomainNameLabelScope;
...
import com.azure.resourcemanager.appservice.generated.models.IpMode;
...
public final class SiteImpl implements Site, Site.Definition, Site.Update {
    ...
    public OutboundVnetRouting outboundVnetRouting() {
        return this.innerModel().outboundVnetRouting();
    }
    ...
    public Boolean clientAffinityProxyEnabled() {
        return this.innerModel().clientAffinityProxyEnabled();
    }
    ...
    public IpMode ipMode() {
        return this.innerModel().ipMode();
    }

    public Boolean endToEndEncryptionEnabled() {
        return this.innerModel().endToEndEncryptionEnabled();
    }

    public Boolean sshEnabled() {
        return this.innerModel().sshEnabled();
    }
    ...
    public Response<Object> updateMachineKeyWithResponse(Context context) {
        return serviceManager.webApps().updateMachineKeyWithResponse(resourceGroupName, name, context);
    }

    public Object updateMachineKey() {
        return serviceManager.webApps().updateMachineKey(resourceGroupName, name);
    }
    ...
    public SiteImpl withOutboundVnetRouting(OutboundVnetRouting outboundVnetRouting) {
        this.innerModel().withOutboundVnetRouting(outboundVnetRouting);
        return this;
    }
    ...
    public SiteImpl withDaprConfig(DaprConfig daprConfig) {
        this.innerModel().withDaprConfig(daprConfig);
        return this;
    }

    public SiteImpl withWorkloadProfileName(String workloadProfileName) {
        this.innerModel().withWorkloadProfileName(workloadProfileName);
        return this;
    }

    public SiteImpl withResourceConfig(ResourceConfig resourceConfig) {
        this.innerModel().withResourceConfig(resourceConfig);
        return this;
    }
    ...
    public SiteImpl withClientAffinityProxyEnabled(Boolean clientAffinityProxyEnabled) {
        if (isInCreateMode()) {
            this.innerModel().withClientAffinityProxyEnabled(clientAffinityProxyEnabled);
            return this;
        } else {
            this.updateSiteEnvelope.withClientAffinityProxyEnabled(clientAffinityProxyEnabled);
            return this;
        }
    }
    ...
    public SiteImpl withIpMode(IpMode ipMode) {
        this.innerModel().withIpMode(ipMode);
        return this;
    }

    public SiteImpl withEndToEndEncryptionEnabled(Boolean endToEndEncryptionEnabled) {
        this.innerModel().withEndToEndEncryptionEnabled(endToEndEncryptionEnabled);
        return this;
    }

    public SiteImpl withSshEnabled(Boolean sshEnabled) {
        this.innerModel().withSshEnabled(sshEnabled);
        return this;
    }
