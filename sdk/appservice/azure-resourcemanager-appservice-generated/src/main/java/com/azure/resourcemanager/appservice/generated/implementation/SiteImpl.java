...
public final class SiteImpl implements Site, Site.Definition, Site.Update {
    ...
    public String managedEnvironment() {
        return this.innerModel().managedEnvironment();
    }
    ...
    public SiteImpl withManagedEnvironment(String managedEnvironment) {
        this.innerModel().withManagedEnvironment(managedEnvironment);
        return this;
    }
