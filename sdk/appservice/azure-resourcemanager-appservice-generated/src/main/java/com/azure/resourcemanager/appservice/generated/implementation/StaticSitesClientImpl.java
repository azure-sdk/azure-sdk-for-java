...
public final class StaticSitesClientImpl implements StaticSitesClient {
    ...
    public interface StaticSitesService {
        ...
        @Headers({ "Content-Type: application/json" })
        @Post("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/staticSites/{name}/builds/{environmentName}/deploy")
        @ExpectedResponses({ 202 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Flux<ByteBuffer>>> zipDeployStaging(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("name") String name,
            @PathParam("environmentName") String environmentName, @PathParam("subscriptionId") String subscriptionId,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") StaticSiteZipDeployArmResource staticSiteEnvelope,
            @HeaderParam("Accept") String accept, Context context);
        ...
        @Headers({ "Content-Type: application/json" })
        @Post("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/staticSites/{name}/deploy")
        @ExpectedResponses({ 202 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Flux<ByteBuffer>>> zipDeploy(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("name") String name,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") StaticSiteZipDeployArmResource staticSiteEnvelope,
            @HeaderParam("Accept") String accept, Context context);
    ...
    /**
     * Deploys zipped content to a static site onto a specified static sites environment.
     * 
     ...
     * @param name Name of the static site.
     * @param environmentName The stage site identifier.
     * @param staticSiteEnvelope A JSON representation of the StaticSiteZipDeployStaging properties. See example.
     * @throws IllegalArgumentException thrown if parameters fail the validation.
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> zipDeployStagingWithResponseAsync(String resourceGroupName, String name,
        String environmentName, StaticSiteZipDeployArmResource staticSiteEnvelope) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return FluxUtil
            .withContext(
                context -> service.zipDeployStaging(this.client.getEndpoint(), resourceGroupName, name, environmentName,
                    this.client.getSubscriptionId(), this.client.getApiVersion(), staticSiteEnvelope, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> zipDeployStagingWithResponseAsync(String resourceGroupName, String name,
        String environmentName, StaticSiteZipDeployArmResource staticSiteEnvelope, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.zipDeployStaging(this.client.getEndpoint(), resourceGroupName, name, environmentName,
            this.client.getSubscriptionId(), this.client.getApiVersion(), staticSiteEnvelope, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<Void>, Void> beginZipDeployStagingAsync(String resourceGroupName, String name,
        String environmentName, StaticSiteZipDeployArmResource staticSiteEnvelope) {
        Mono<Response<Flux<ByteBuffer>>> mono
            = zipDeployStagingWithResponseAsync(resourceGroupName, name, environmentName, staticSiteEnvelope);
        return this.client.<Void, Void>getLroResult(mono, this.client.getHttpPipeline(), Void.class, Void.class,
            this.client.getContext());
    }
    ...
    private PollerFlux<PollResult<Void>, Void> beginZipDeployStagingAsync(String resourceGroupName, String name,
        ...
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono
            = zipDeployStagingWithResponseAsync(resourceGroupName, name, environmentName, staticSiteEnvelope, context);
        return this.client.<Void, Void>getLroResult(mono, this.client.getHttpPipeline(), Void.class, Void.class,
            context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<Void>, Void> beginZipDeployStaging(String resourceGroupName, String name,
        String environmentName, StaticSiteZipDeployArmResource staticSiteEnvelope) {
        return this.beginZipDeployStagingAsync(resourceGroupName, name, environmentName, staticSiteEnvelope)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginZipDeployStaging(String resourceGroupName, String name,
        String environmentName, StaticSiteZipDeployArmResource staticSiteEnvelope, Context context) {
        return this.beginZipDeployStagingAsync(resourceGroupName, name, environmentName, staticSiteEnvelope, context)
            .getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> zipDeployStagingAsync(String resourceGroupName, String name, String environmentName,
        StaticSiteZipDeployArmResource staticSiteEnvelope) {
        return beginZipDeployStagingAsync(resourceGroupName, name, environmentName, staticSiteEnvelope).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> zipDeployStagingAsync(String resourceGroupName, String name, String environmentName,
        StaticSiteZipDeployArmResource staticSiteEnvelope, Context context) {
        return beginZipDeployStagingAsync(resourceGroupName, name, environmentName, staticSiteEnvelope, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public void zipDeployStaging(String resourceGroupName, String name, String environmentName,
        StaticSiteZipDeployArmResource staticSiteEnvelope) {
        zipDeployStagingAsync(resourceGroupName, name, environmentName, staticSiteEnvelope).block();
    }
    ...
    public void zipDeployStaging(String resourceGroupName, String name, String environmentName,
        StaticSiteZipDeployArmResource staticSiteEnvelope, Context context) {
        zipDeployStagingAsync(resourceGroupName, name, environmentName, staticSiteEnvelope, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> zipDeployWithResponseAsync(String resourceGroupName, String name,
        StaticSiteZipDeployArmResource staticSiteEnvelope) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.zipDeploy(this.client.getEndpoint(), resourceGroupName, name,
                this.client.getSubscriptionId(), this.client.getApiVersion(), staticSiteEnvelope, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> zipDeployWithResponseAsync(String resourceGroupName, String name,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.zipDeploy(this.client.getEndpoint(), resourceGroupName, name, this.client.getSubscriptionId(),
            this.client.getApiVersion(), staticSiteEnvelope, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<Void>, Void> beginZipDeployAsync(String resourceGroupName, String name,
        StaticSiteZipDeployArmResource staticSiteEnvelope) {
        Mono<Response<Flux<ByteBuffer>>> mono = zipDeployWithResponseAsync(resourceGroupName, name, staticSiteEnvelope);
        return this.client.<Void, Void>getLroResult(mono, this.client.getHttpPipeline(), Void.class, Void.class,
            this.client.getContext());
    }
    ...
    private PollerFlux<PollResult<Void>, Void> beginZipDeployAsync(String resourceGroupName, String name,
        ...
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono
            = zipDeployWithResponseAsync(resourceGroupName, name, staticSiteEnvelope, context);
        return this.client.<Void, Void>getLroResult(mono, this.client.getHttpPipeline(), Void.class, Void.class,
            context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<Void>, Void> beginZipDeploy(String resourceGroupName, String name,
        StaticSiteZipDeployArmResource staticSiteEnvelope) {
        return this.beginZipDeployAsync(resourceGroupName, name, staticSiteEnvelope).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginZipDeploy(String resourceGroupName, String name,
        StaticSiteZipDeployArmResource staticSiteEnvelope, Context context) {
        return this.beginZipDeployAsync(resourceGroupName, name, staticSiteEnvelope, context).getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> zipDeployAsync(String resourceGroupName, String name,
        StaticSiteZipDeployArmResource staticSiteEnvelope) {
        return beginZipDeployAsync(resourceGroupName, name, staticSiteEnvelope).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<Void> zipDeployAsync(String resourceGroupName, String name,
        StaticSiteZipDeployArmResource staticSiteEnvelope, Context context) {
        return beginZipDeployAsync(resourceGroupName, name, staticSiteEnvelope, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public void zipDeploy(String resourceGroupName, String name, StaticSiteZipDeployArmResource staticSiteEnvelope) {
        zipDeployAsync(resourceGroupName, name, staticSiteEnvelope).block();
    }
    ...
    public void zipDeploy(String resourceGroupName, String name, StaticSiteZipDeployArmResource staticSiteEnvelope,
        Context context) {
        zipDeployAsync(resourceGroupName, name, staticSiteEnvelope, context).block();
    }
