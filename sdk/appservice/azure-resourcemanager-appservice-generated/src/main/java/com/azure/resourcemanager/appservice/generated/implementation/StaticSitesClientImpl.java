...
public final class StaticSitesClientImpl implements StaticSitesClient {
    ...
    private interface StaticSitesService {
        ...
        @Post(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/staticSites"
                + "/{name}/builds/{environmentName}/purge")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(DefaultErrorResponseErrorException.class)
        Mono<Response<Flux<ByteBuffer>>> purgeStaticSiteBuild(
            @HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("name") String name,
            @PathParam("environmentName") String environmentName,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(DefaultErrorResponseErrorException.class)
        Mono<Response<Flux<ByteBuffer>>> purgeStaticSite(
            @HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("name") String name,
            @PathParam("subscriptionId") String subscriptionId,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> purgeStaticSiteBuildWithResponseAsync(
        String resourceGroupName, String name, String environmentName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<Void>, Void> beginPurgeStaticSiteBuildAsync(
        String resourceGroupName, String name, String environmentName) {
        Mono<Response<Flux<ByteBuffer>>> mono =
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<Void>, Void> beginPurgeStaticSiteBuild(
        String resourceGroupName, String name, String environmentName) {
        return beginPurgeStaticSiteBuildAsync(resourceGroupName, name, environmentName).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginPurgeStaticSiteBuild(
        String resourceGroupName, String name, String environmentName, Context context) {
        return beginPurgeStaticSiteBuildAsync(resourceGroupName, name, environmentName, context).getSyncPoller();
    }
    ...
    private Mono<Void> purgeStaticSiteBuildAsync(String resourceGroupName, String name, String environmentName) {
        return beginPurgeStaticSiteBuildAsync(resourceGroupName, name, environmentName)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> purgeStaticSiteBuildAsync(
        String resourceGroupName, String name, String environmentName, Context context) {
        return beginPurgeStaticSiteBuildAsync(resourceGroupName, name, environmentName, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> purgeStaticSiteWithResponseAsync(
        String resourceGroupName, String name, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<Void>, Void> beginPurgeStaticSiteAsync(
        String resourceGroupName, String name, Context context) {
        context = this.client.mergeContext(context);
    ...
    public SyncPoller<PollResult<Void>, Void> beginPurgeStaticSite(String resourceGroupName, String name) {
        return beginPurgeStaticSiteAsync(resourceGroupName, name).getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<Void>, Void> beginPurgeStaticSite(
        String resourceGroupName, String name, Context context) {
        return beginPurgeStaticSiteAsync(resourceGroupName, name, context).getSyncPoller();
    }
    ...
    private Mono<Void> purgeStaticSiteAsync(String resourceGroupName, String name, Context context) {
        return beginPurgeStaticSiteAsync(resourceGroupName, name, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> unlinkBackendAsync(
        String resourceGroupName, String name, String linkedBackendName, Boolean isCleaningAuthConfig) {
