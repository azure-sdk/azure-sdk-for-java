...
public final class StaticSitesClientImpl implements StaticSitesClient {
    ...
    public interface StaticSitesService {
        ...
        @Headers({ "Content-Type: application/json" })
        @Post("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/staticSites/{name}/builds/{environmentName}/purge")
        @ExpectedResponses({ 200, 202 })
        @UnexpectedResponseExceptionType(DefaultErrorResponseErrorException.class)
        Mono<Response<Flux<ByteBuffer>>> purgeStaticSiteBuild(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("name") String name,
            @PathParam("environmentName") String environmentName, @PathParam("subscriptionId") String subscriptionId,
            @QueryParam("api-version") String apiVersion, @HeaderParam("Accept") String accept, Context context);
        ...
        @Headers({ "Content-Type: application/json" })
        @Post("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/staticSites/{name}/purge")
        @ExpectedResponses({ 200, 202 })
        @UnexpectedResponseExceptionType(DefaultErrorResponseErrorException.class)
        Mono<Response<Flux<ByteBuffer>>> purgeStaticSite(@HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("name") String name,
            @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> purgeStaticSiteBuildWithResponseAsync(String resourceGroupName,
        String name, String environmentName) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.purgeStaticSiteBuild(this.client.getEndpoint(), resourceGroupName, name,
                environmentName, this.client.getSubscriptionId(), this.client.getApiVersion(), accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> purgeStaticSiteBuildWithResponseAsync(String resourceGroupName,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.purgeStaticSiteBuild(this.client.getEndpoint(), resourceGroupName, name, environmentName,
            this.client.getSubscriptionId(), this.client.getApiVersion(), accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<Void>, Void> beginPurgeStaticSiteBuildAsync(String resourceGroupName, String name,
        String environmentName) {
        Mono<Response<Flux<ByteBuffer>>> mono
            = purgeStaticSiteBuildWithResponseAsync(resourceGroupName, name, environmentName);
        return this.client.<Void, Void>getLroResult(mono, this.client.getHttpPipeline(), Void.class, Void.class,
            this.client.getContext());
    }
    ...
    private PollerFlux<PollResult<Void>, Void> beginPurgeStaticSiteBuildAsync(String resourceGroupName, String name,
        ...
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono
            = purgeStaticSiteBuildWithResponseAsync(resourceGroupName, name, environmentName, context);
        return this.client.<Void, Void>getLroResult(mono, this.client.getHttpPipeline(), Void.class, Void.class,
            context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<Void>, Void> beginPurgeStaticSiteBuild(String resourceGroupName, String name,
        String environmentName) {
        return this.beginPurgeStaticSiteBuildAsync(resourceGroupName, name, environmentName).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginPurgeStaticSiteBuild(String resourceGroupName, String name,
        String environmentName, Context context) {
        return this.beginPurgeStaticSiteBuildAsync(resourceGroupName, name, environmentName, context).getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> purgeStaticSiteBuildAsync(String resourceGroupName, String name, String environmentName) {
        return beginPurgeStaticSiteBuildAsync(resourceGroupName, name, environmentName).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<Void> purgeStaticSiteBuildAsync(String resourceGroupName, String name, String environmentName,
        Context context) {
        return beginPurgeStaticSiteBuildAsync(resourceGroupName, name, environmentName, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public void purgeStaticSiteBuild(String resourceGroupName, String name, String environmentName) {
        purgeStaticSiteBuildAsync(resourceGroupName, name, environmentName).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public void purgeStaticSiteBuild(String resourceGroupName, String name, String environmentName, Context context) {
        purgeStaticSiteBuildAsync(resourceGroupName, name, environmentName, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> purgeStaticSiteWithResponseAsync(String resourceGroupName, String name) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.purgeStaticSite(this.client.getEndpoint(), resourceGroupName, name,
                this.client.getSubscriptionId(), this.client.getApiVersion(), accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> purgeStaticSiteWithResponseAsync(String resourceGroupName, String name,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.purgeStaticSite(this.client.getEndpoint(), resourceGroupName, name,
            this.client.getSubscriptionId(), this.client.getApiVersion(), accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<Void>, Void> beginPurgeStaticSiteAsync(String resourceGroupName, String name) {
        Mono<Response<Flux<ByteBuffer>>> mono = purgeStaticSiteWithResponseAsync(resourceGroupName, name);
        return this.client.<Void, Void>getLroResult(mono, this.client.getHttpPipeline(), Void.class, Void.class,
            this.client.getContext());
    }
    ...
    private PollerFlux<PollResult<Void>, Void> beginPurgeStaticSiteAsync(String resourceGroupName, String name,
        Context context) {
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono = purgeStaticSiteWithResponseAsync(resourceGroupName, name, context);
        return this.client.<Void, Void>getLroResult(mono, this.client.getHttpPipeline(), Void.class, Void.class,
            context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<Void>, Void> beginPurgeStaticSite(String resourceGroupName, String name) {
        return this.beginPurgeStaticSiteAsync(resourceGroupName, name).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginPurgeStaticSite(String resourceGroupName, String name,
        Context context) {
        return this.beginPurgeStaticSiteAsync(resourceGroupName, name, context).getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> purgeStaticSiteAsync(String resourceGroupName, String name) {
        return beginPurgeStaticSiteAsync(resourceGroupName, name).last().flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> purgeStaticSiteAsync(String resourceGroupName, String name, Context context) {
        return beginPurgeStaticSiteAsync(resourceGroupName, name, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public void purgeStaticSite(String resourceGroupName, String name) {
        purgeStaticSiteAsync(resourceGroupName, name).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public void purgeStaticSite(String resourceGroupName, String name, Context context) {
        purgeStaticSiteAsync(resourceGroupName, name, context).block();
    }
