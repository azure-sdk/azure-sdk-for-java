...
public final class StaticSitesClientImpl implements StaticSitesClient {
    ...
    private interface StaticSitesService {
        ...
        @Get(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/staticSites"
                + "/{name}/config/basicAuth")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(DefaultErrorResponseErrorException.class)
        Mono<Response<StaticSiteBasicAuthPropertiesArmResourceInner>> getStaticSiteBasicAuth(
            @HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("name") String name,
            @PathParam("subscriptionId") String subscriptionId,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(DefaultErrorResponseErrorException.class)
        Mono<Response<StaticSiteBasicAuthPropertiesArmResourceInner>> createOrUpdateStaticSiteBasicAuth(
            @HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("name") String name,
            @PathParam("subscriptionId") String subscriptionId,
     ...
     * @throws DefaultErrorResponseErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the basic auth state of a static site along with {@link Response} on successful completion of {@link
     *     Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<StaticSiteBasicAuthPropertiesArmResourceInner>> getStaticSiteBasicAuthWithResponseAsync(
        String resourceGroupName, String name) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     * @throws DefaultErrorResponseErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the basic auth state of a static site on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<StaticSiteBasicAuthPropertiesArmResourceInner> getStaticSiteBasicAuthAsync(
        String resourceGroupName, String name) {
        return getStaticSiteBasicAuthWithResponseAsync(resourceGroupName, name)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     * @throws DefaultErrorResponseErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the basic auth state of a static site along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<StaticSiteBasicAuthPropertiesArmResourceInner> getStaticSiteBasicAuthWithResponse(
        String resourceGroupName, String name, Context context) {
        return getStaticSiteBasicAuthWithResponseAsync(resourceGroupName, name, context).block();
    }
     ...
     * @throws DefaultErrorResponseErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the basic auth state of a static site.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public StaticSiteBasicAuthPropertiesArmResourceInner getStaticSiteBasicAuth(String resourceGroupName, String name) {
        return getStaticSiteBasicAuthWithResponse(resourceGroupName, name, Context.NONE).getValue();
    }
    ...
    private Mono<Response<StaticSiteBasicAuthPropertiesArmResourceInner>>
        createOrUpdateStaticSiteBasicAuthWithResponseAsync(
            String resourceGroupName, String name, StaticSiteBasicAuthPropertiesArmResourceInner basicAuthEnvelope) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<StaticSiteBasicAuthPropertiesArmResourceInner> createOrUpdateStaticSiteBasicAuthAsync(
        String resourceGroupName, String name, StaticSiteBasicAuthPropertiesArmResourceInner basicAuthEnvelope) {
        return createOrUpdateStaticSiteBasicAuthWithResponseAsync(resourceGroupName, name, basicAuthEnvelope)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<StaticSiteBasicAuthPropertiesArmResourceInner> createOrUpdateStaticSiteBasicAuthWithResponse(
        String resourceGroupName,
        String name,
        StaticSiteBasicAuthPropertiesArmResourceInner basicAuthEnvelope,
        Context context) {
        return createOrUpdateStaticSiteBasicAuthWithResponseAsync(resourceGroupName, name, basicAuthEnvelope, context)
            .block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public StaticSiteBasicAuthPropertiesArmResourceInner createOrUpdateStaticSiteBasicAuth(
        String resourceGroupName, String name, StaticSiteBasicAuthPropertiesArmResourceInner basicAuthEnvelope) {
        return createOrUpdateStaticSiteBasicAuthWithResponse(resourceGroupName, name, basicAuthEnvelope, Context.NONE)
            .getValue();
    }
