...
public final class GetUsagesInLocationsImpl implements GetUsagesInLocations {
    ...
    public GetUsagesInLocationsImpl(
        GetUsagesInLocationsClient innerClient,
        com.azure.resourcemanager.appservice.generated.AppServiceManager serviceManager) {
        this.innerClient = innerClient;
        this.serviceManager = serviceManager;
    }

    public PagedIterable<CsmUsageQuota> list(String location, String quotaType) {
        PagedIterable<CsmUsageQuotaInner> inner = this.serviceClient().list(location, quotaType);
        return Utils.mapPage(inner, inner1 -> new CsmUsageQuotaImpl(inner1, this.manager()));
    }

    public PagedIterable<CsmUsageQuota> list(String location, String quotaType, Context context) {
        PagedIterable<CsmUsageQuotaInner> inner = this.serviceClient().list(location, quotaType, context);
        return Utils.mapPage(inner, inner1 -> new CsmUsageQuotaImpl(inner1, this.manager()));
    }
