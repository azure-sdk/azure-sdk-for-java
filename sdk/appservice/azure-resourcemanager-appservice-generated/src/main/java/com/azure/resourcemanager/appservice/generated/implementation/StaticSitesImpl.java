...
public final class StaticSitesImpl implements StaticSites {
    ...
    public PagedIterable<StaticSiteTrafficSplittingPropertiesArmResource> listBasicAuth(
        String resourceGroupName, String name) {
        PagedIterable<StaticSiteTrafficSplittingPropertiesArmResourceInner> inner =
            this.serviceClient().listBasicAuth(resourceGroupName, name);
        return Utils
            .mapPage(inner, inner1 -> new StaticSiteTrafficSplittingPropertiesArmResourceImpl(inner1, this.manager()));
    }
    ...
    public Response<StaticSiteTrafficSplittingPropertiesArmResource> getTrafficSplittingWithResponse(
        String resourceGroupName, String name, TrafficSplittingName trafficSplittingName, Context context) {
        Response<StaticSiteTrafficSplittingPropertiesArmResourceInner> inner =
            this
                .serviceClient()
        ...
        if (inner != null) {
            return new SimpleResponse<>(
                ...
                inner.getStatusCode(),
                inner.getHeaders(),
                new StaticSiteTrafficSplittingPropertiesArmResourceImpl(inner.getValue(), this.manager()));
        } else {
            return null;
        }
    }

    public StaticSiteTrafficSplittingPropertiesArmResource getTrafficSplitting(
        String resourceGroupName, String name, TrafficSplittingName trafficSplittingName) {
        StaticSiteTrafficSplittingPropertiesArmResourceInner inner =
            this.serviceClient().getTrafficSplitting(resourceGroupName, name, trafficSplittingName);
        if (inner != null) {
            return new StaticSiteTrafficSplittingPropertiesArmResourceImpl(inner, this.manager());
        } else {
            return null;
        }
    }

    public Response<Void> deleteTrafficSplittingWithResponse(
        String resourceGroupName, String name, TrafficSplittingName trafficSplittingName, Context context) {
        return this
            .serviceClient()
            .deleteTrafficSplittingWithResponse(resourceGroupName, name, trafficSplittingName, context);
    }

    public void deleteTrafficSplitting(
        String resourceGroupName, String name, TrafficSplittingName trafficSplittingName) {
        this.serviceClient().deleteTrafficSplitting(resourceGroupName, name, trafficSplittingName);
    }
    ...
    public StaticSiteTrafficSplittingPropertiesArmResource getTrafficSplittingById(String id) {
        String resourceGroupName = Utils.getValueFromIdByName(id, "resourceGroups");
        if (resourceGroupName == null) {
            throw LOGGER
                .logExceptionAsError(
        ...
        String trafficSplittingNameLocal = Utils.getValueFromIdByName(id, "trafficSplitting");
        if (trafficSplittingNameLocal == null) {
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException(
                        String
                            .format(
                                "The resource ID '%s' is not valid. Missing path segment 'trafficSplitting'.", id)));
        }
        TrafficSplittingName trafficSplittingName = TrafficSplittingName.fromString(trafficSplittingNameLocal);
        return this
            .getTrafficSplittingWithResponse(resourceGroupName, name, trafficSplittingName, Context.NONE)
            .getValue();
    }

    public Response<StaticSiteTrafficSplittingPropertiesArmResource> getTrafficSplittingByIdWithResponse(
        String id, Context context) {
        String resourceGroupName = Utils.getValueFromIdByName(id, "resourceGroups");
        if (resourceGroupName == null) {
            throw LOGGER
        ...
        TrafficSplittingName trafficSplittingName = TrafficSplittingName.fromString(trafficSplittingNameLocal);
        return this.getTrafficSplittingWithResponse(resourceGroupName, name, trafficSplittingName, context);
    }
    ...
    public void deleteTrafficSplittingById(String id) {
        String resourceGroupName = Utils.getValueFromIdByName(id, "resourceGroups");
        if (resourceGroupName == null) {
            throw LOGGER
                .logExceptionAsError(
        ...
        TrafficSplittingName trafficSplittingName = TrafficSplittingName.fromString(trafficSplittingNameLocal);
        this.deleteTrafficSplittingWithResponse(resourceGroupName, name, trafficSplittingName, Context.NONE);
    }

    public Response<Void> deleteTrafficSplittingByIdWithResponse(String id, Context context) {
        String resourceGroupName = Utils.getValueFromIdByName(id, "resourceGroups");
        if (resourceGroupName == null) {
            throw LOGGER
                .logExceptionAsError(
        ...
        TrafficSplittingName trafficSplittingName = TrafficSplittingName.fromString(trafficSplittingNameLocal);
        return this.deleteTrafficSplittingWithResponse(resourceGroupName, name, trafficSplittingName, context);
    }
    ...
    public StaticSiteTrafficSplittingPropertiesArmResourceImpl defineTrafficSplitting(BasicAuthName name) {
        return new StaticSiteTrafficSplittingPropertiesArmResourceImpl(name, this.manager());
    }
