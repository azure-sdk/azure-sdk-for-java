...
public final class StaticSitesImpl implements StaticSites {
    ...
    public Response<FreeTrialStaticWebAppsProxyEntityCollection> listFreeTrialStaticWebAppsWithResponse(
        Context context) {
        Response<FreeTrialStaticWebAppsProxyEntityCollectionInner> inner =
            this.serviceClient().listFreeTrialStaticWebAppsWithResponse(context);
        if (inner != null) {
            return new SimpleResponse<>(
                inner.getRequest(),
                inner.getStatusCode(),
                inner.getHeaders(),
                new FreeTrialStaticWebAppsProxyEntityCollectionImpl(inner.getValue(), this.manager()));
        } else {
            return null;
        }
    }

    public FreeTrialStaticWebAppsProxyEntityCollection listFreeTrialStaticWebApps() {
        FreeTrialStaticWebAppsProxyEntityCollectionInner inner = this.serviceClient().listFreeTrialStaticWebApps();
        if (inner != null) {
            return new FreeTrialStaticWebAppsProxyEntityCollectionImpl(inner, this.manager());
        } else {
            return null;
        }
    }

    public Response<FreeTrialStaticWebAppsProxyEntity> getFreeTrialStaticWebAppWithResponse(
        String freeTrialStaticWebAppName, Context context) {
        Response<FreeTrialStaticWebAppsProxyEntityInner> inner =
            this.serviceClient().getFreeTrialStaticWebAppWithResponse(freeTrialStaticWebAppName, context);
        if (inner != null) {
            return new SimpleResponse<>(
                inner.getRequest(),
                inner.getStatusCode(),
                inner.getHeaders(),
                new FreeTrialStaticWebAppsProxyEntityImpl(inner.getValue(), this.manager()));
        } else {
            return null;
        }
    }

    public FreeTrialStaticWebAppsProxyEntity getFreeTrialStaticWebApp(String freeTrialStaticWebAppName) {
        FreeTrialStaticWebAppsProxyEntityInner inner =
            this.serviceClient().getFreeTrialStaticWebApp(freeTrialStaticWebAppName);
        if (inner != null) {
            return new FreeTrialStaticWebAppsProxyEntityImpl(inner, this.manager());
        } else {
            return null;
        }
    }

    public Response<FreeTrialStaticWebAppsProxyEntity> createFreeTrialStaticWebAppWithResponse(
        ...
        Response<FreeTrialStaticWebAppsProxyEntityInner> inner =
            this
                .serviceClient()
                .createFreeTrialStaticWebAppWithResponse(freeTrialStaticWebAppName, freeTrialStaticWebApp, context);
        if (inner != null) {
            return new SimpleResponse<>(
                inner.getRequest(),
                inner.getStatusCode(),
    ...
    public FreeTrialStaticWebAppsProxyEntity createFreeTrialStaticWebApp(
        String freeTrialStaticWebAppName, FreeTrialStaticWebAppsProxyEntityInner freeTrialStaticWebApp) {
        FreeTrialStaticWebAppsProxyEntityInner inner =
            this.serviceClient().createFreeTrialStaticWebApp(freeTrialStaticWebAppName, freeTrialStaticWebApp);
        if (inner != null) {
            return new FreeTrialStaticWebAppsProxyEntityImpl(inner, this.manager());
        } else {
            return null;
    ...
    public Response<Void> deleteFreeTrialStaticWebAppWithResponse(String freeTrialStaticWebAppName, Context context) {
        return this.serviceClient().deleteFreeTrialStaticWebAppWithResponse(freeTrialStaticWebAppName, context);
    }

    public void deleteFreeTrialStaticWebApp(String freeTrialStaticWebAppName) {
        this.serviceClient().deleteFreeTrialStaticWebApp(freeTrialStaticWebAppName);
    }
    ...
    public Response<Void> upgradeFreeTrialStaticWebAppWithResponse(
        ...
        return this
            .serviceClient()
            .upgradeFreeTrialStaticWebAppWithResponse(freeTrialStaticWebAppName, freeTrialStaticWebApp, context);
    }

    public void upgradeFreeTrialStaticWebApp(
        String freeTrialStaticWebAppName, FreeTrialStaticWebAppsProxyEntityInner freeTrialStaticWebApp) {
        this.serviceClient().upgradeFreeTrialStaticWebApp(freeTrialStaticWebAppName, freeTrialStaticWebApp);
    }
