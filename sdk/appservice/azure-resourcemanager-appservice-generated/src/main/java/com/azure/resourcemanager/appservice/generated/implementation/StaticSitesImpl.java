...
public final class StaticSitesImpl implements StaticSites {
    ...
    public Response<StaticSiteBasicAuthPropertiesArmResource> getStaticSiteBasicAuthWithResponse(
        String resourceGroupName, String name, Context context) {
        Response<StaticSiteBasicAuthPropertiesArmResourceInner> inner =
            this.serviceClient().getStaticSiteBasicAuthWithResponse(resourceGroupName, name, context);
        if (inner != null) {
            return new SimpleResponse<>(
                inner.getRequest(),
                inner.getStatusCode(),
    ...
    public StaticSiteBasicAuthPropertiesArmResource getStaticSiteBasicAuth(String resourceGroupName, String name) {
        StaticSiteBasicAuthPropertiesArmResourceInner inner =
            this.serviceClient().getStaticSiteBasicAuth(resourceGroupName, name);
        if (inner != null) {
    ...
    public Response<StaticSiteBasicAuthPropertiesArmResource> createOrUpdateStaticSiteBasicAuthWithResponse(
        String resourceGroupName,
        String name,
        ...
        Response<StaticSiteBasicAuthPropertiesArmResourceInner> inner =
            this
                .serviceClient()
                .createOrUpdateStaticSiteBasicAuthWithResponse(resourceGroupName, name, basicAuthEnvelope, context);
        if (inner != null) {
            return new SimpleResponse<>(
                inner.getRequest(),
                inner.getStatusCode(),
    ...
    public StaticSiteBasicAuthPropertiesArmResource createOrUpdateStaticSiteBasicAuth(
        String resourceGroupName, String name, StaticSiteBasicAuthPropertiesArmResourceInner basicAuthEnvelope) {
        StaticSiteBasicAuthPropertiesArmResourceInner inner =
            this.serviceClient().createOrUpdateStaticSiteBasicAuth(resourceGroupName, name, basicAuthEnvelope);
        if (inner != null) {
            return new StaticSiteBasicAuthPropertiesArmResourceImpl(inner, this.manager());
        } else {
            return null;
