...
public final class StaticSitesImpl implements StaticSites {
    ...
    public void zipDeployStaging(String resourceGroupName, String name, String environmentName,
        ...
        this.serviceClient().zipDeployStaging(resourceGroupName, name, environmentName, staticSiteEnvelope);
    }

    public void zipDeployStaging(String resourceGroupName, String name, String environmentName,
        StaticSiteZipDeployArmResource staticSiteEnvelope, Context context) {
        this.serviceClient().zipDeployStaging(resourceGroupName, name, environmentName, staticSiteEnvelope, context);
    }
    ...
    public void zipDeploy(String resourceGroupName, String name, StaticSiteZipDeployArmResource staticSiteEnvelope) {
        this.serviceClient().zipDeploy(resourceGroupName, name, staticSiteEnvelope);
    }

    public void zipDeploy(String resourceGroupName, String name, StaticSiteZipDeployArmResource staticSiteEnvelope,
        Context context) {
        this.serviceClient().zipDeploy(resourceGroupName, name, staticSiteEnvelope, context);
    }
