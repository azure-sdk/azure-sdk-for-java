...
/**
 * Scale and concurrency settings for an Azure Functions app.
 */
@Fluent
public final class FunctionsScaleAndConcurrency {
    /*
     * 'Always Ready' configuration for an Azure Function app.
     */
    @JsonProperty(value = "alwaysReady")
    private List<FunctionsAlwaysReadyConfig> alwaysReady;

    /*
     * The maximum number of VM instances for the Azure Functions app.
     */
    @JsonProperty(value = "maximumInstanceCount")
    private Float maximumInstanceCount;

    /*
     * Set the amount of memory allocated to each instance of the function app in MiB; CPU and network bandwidth are
    ...
    /*
     * Scale and concurrency settings for Azure Functions triggers.
     */
    ...
    /**
     * Get the alwaysReady property: 'Always Ready' configuration for an Azure Function app.
     * 
    ...
    /**
     * Set the alwaysReady property: 'Always Ready' configuration for an Azure Function app.
     * 
    ...
    /**
     * Get the maximumInstanceCount property: The maximum number of VM instances for the Azure Functions app.
     * 
    ...
    /**
     * Set the maximumInstanceCount property: The maximum number of VM instances for the Azure Functions app.
     * 
    ...
    /**
     * Get the instanceMemoryMB property: Set the amount of memory allocated to each instance of the function app in
     * MiB; CPU and network bandwidth are allocated proportionally.
     * 
    ...
    /**
     * Set the instanceMemoryMB property: Set the amount of memory allocated to each instance of the function app in
     * MiB; CPU and network bandwidth are allocated proportionally.
     * 
    ...
    /**
     * Get the triggers property: Scale and concurrency settings for Azure Functions triggers.
     * 
    ...
    /**
     * Set the triggers property: Scale and concurrency settings for Azure Functions triggers.
     * 
