...
import com.azure.resourcemanager.appservice.generated.models.StaticSiteTrafficSplittingProperties;
...
public final class StaticSite {
    ...
    /*
     * Traffic splitting distribution for the static site
     */
    @JsonProperty(value = "trafficSplitting", access = JsonProperty.Access.WRITE_ONLY)
    private StaticSiteTrafficSplittingProperties trafficSplitting;
    ...
    /**
     * Get the trafficSplitting property: Traffic splitting distribution for the static site.
     *
     * @return the trafficSplitting value.
     */
    public StaticSiteTrafficSplittingProperties trafficSplitting() {
        return this.trafficSplitting;
    }
    ...
    public void validate() {
        ...
        if (trafficSplitting() != null) {
            trafficSplitting().validate();
        }
    }
}
