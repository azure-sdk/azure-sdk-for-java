...
public interface AppServicePlansClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<SwiftVirtualNetworkInner> getVirtualNetworkIntegrationWithResponse(String resourceGroupName, String name,
        String vnetName, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    SwiftVirtualNetworkInner getVirtualNetworkIntegration(String resourceGroupName, String name, String vnetName);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<SwiftVirtualNetworkInner> listByVirtualNetworkIntegrations(String resourceGroupName, String name);
