...
public final class WebAppsImpl implements WebApps {
    ...
    public Response<WorkflowEnvelope> listInstanceWorkflowsConfigurationConnectionsSlotWithResponse(
        ...
        Response<WorkflowEnvelopeInner> inner =
            this
                .serviceClient()
                .listInstanceWorkflowsConfigurationConnectionsSlotWithResponse(resourceGroupName, name, slot, context);
        if (inner != null) {
            return new SimpleResponse<>(
                inner.getRequest(),
                inner.getStatusCode(),
    ...
    public WorkflowEnvelope listInstanceWorkflowsConfigurationConnectionsSlot(
        String resourceGroupName, String name, String slot) {
        WorkflowEnvelopeInner inner =
            this.serviceClient().listInstanceWorkflowsConfigurationConnectionsSlot(resourceGroupName, name, slot);
        if (inner != null) {
            return new WorkflowEnvelopeImpl(inner, this.manager());
        } else {
            return null;
    ...
    public Response<WorkflowEnvelope> listWorkflowsConfigurationWithResponse(
        String resourceGroupName, String name, Context context) {
        Response<WorkflowEnvelopeInner> inner =
            this.serviceClient().listWorkflowsConfigurationWithResponse(resourceGroupName, name, context);
        if (inner != null) {
            return new SimpleResponse<>(
                inner.getRequest(),
                inner.getStatusCode(),
    ...
    public WorkflowEnvelope listWorkflowsConfiguration(String resourceGroupName, String name) {
        WorkflowEnvelopeInner inner = this.serviceClient().listWorkflowsConfiguration(resourceGroupName, name);
        if (inner != null) {
            return new WorkflowEnvelopeImpl(inner, this.manager());
        } else {
            return null;
