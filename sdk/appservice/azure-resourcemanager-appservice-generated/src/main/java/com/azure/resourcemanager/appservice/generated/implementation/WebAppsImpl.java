...
public final class WebAppsImpl implements WebApps {
    ...
    public Response<CsmDeploymentStatus> getProductionSiteDeploymentStatusWithResponse(
        String resourceGroupName, String name, String deploymentStatusId, Context context) {
        Response<CsmDeploymentStatusInner> inner =
            this
                .serviceClient()
                .getProductionSiteDeploymentStatusWithResponse(resourceGroupName, name, deploymentStatusId, context);
        if (inner != null) {
            return new SimpleResponse<>(
                inner.getRequest(),
                inner.getStatusCode(),
                inner.getHeaders(),
                new CsmDeploymentStatusImpl(inner.getValue(), this.manager()));
        } else {
            return null;
        }
    }
    ...
    public Response<CsmDeploymentStatus> getSlotSiteDeploymentStatusSlotWithResponse(
        ...
        Response<CsmDeploymentStatusInner> inner =
            this
                ...
                .getSlotSiteDeploymentStatusSlotWithResponse(
                    resourceGroupName, name, slot, deploymentStatusId, context);
        if (inner != null) {
            return new SimpleResponse<>(
                inner.getRequest(),
                inner.getStatusCode(),
