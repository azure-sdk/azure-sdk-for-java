...
public final class WebAppsImpl implements WebApps {
    ...
    public Response<WorkflowEnvelope> listInstanceWorkflowsConfigurationConnectionsSlotWithResponse(
        String resourceGroupName, String name, String slot, String configurationName, Context context) {
        Response<WorkflowEnvelopeInner> inner =
            this
                .serviceClient()
                .listInstanceWorkflowsConfigurationConnectionsSlotWithResponse(
                    resourceGroupName, name, slot, configurationName, context);
        if (inner != null) {
            return new SimpleResponse<>(
                inner.getRequest(),
                inner.getStatusCode(),
    ...
    public WorkflowEnvelope listInstanceWorkflowsConfigurationConnectionsSlot(
        String resourceGroupName, String name, String slot, String configurationName) {
        WorkflowEnvelopeInner inner =
            this
                .serviceClient()
                .listInstanceWorkflowsConfigurationConnectionsSlot(resourceGroupName, name, slot, configurationName);
        if (inner != null) {
            return new WorkflowEnvelopeImpl(inner, this.manager());
        } else {
            return null;
    ...
    public Response<WorkflowEnvelope> listWorkflowsConfigurationWithResponse(
        String resourceGroupName, String name, String configurationName, Context context) {
        Response<WorkflowEnvelopeInner> inner =
            this
                .serviceClient()
                .listWorkflowsConfigurationWithResponse(resourceGroupName, name, configurationName, context);
        if (inner != null) {
            return new SimpleResponse<>(
                inner.getRequest(),
                inner.getStatusCode(),
    ...
    public WorkflowEnvelope listWorkflowsConfiguration(
        String resourceGroupName, String name, String configurationName) {
        WorkflowEnvelopeInner inner =
            this.serviceClient().listWorkflowsConfiguration(resourceGroupName, name, configurationName);
        if (inner != null) {
            return new WorkflowEnvelopeImpl(inner, this.manager());
        } else {
            return null;
