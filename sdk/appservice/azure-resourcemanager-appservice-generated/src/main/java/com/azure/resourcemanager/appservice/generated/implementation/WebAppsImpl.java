...
import com.azure.resourcemanager.appservice.generated.models.OneDeployRequest;
...
public final class WebAppsImpl implements WebApps {
    ...
    public SiteConfigResource getConfiguration(String resourceGroupName, String name, Context context) {
        SiteConfigResourceInner inner = this.serviceClient().getConfiguration(resourceGroupName, name, context);
        if (inner != null) {
            return new SiteConfigResourceImpl(inner, this.manager());
        } else {
            return null;
    ...
    public Response<Deployment> getOneDeployStatusWithResponse(String resourceGroupName, String name, Context context) {
        Response<DeploymentInner> inner =
            this.serviceClient().getOneDeployStatusWithResponse(resourceGroupName, name, context);
        if (inner != null) {
            return new SimpleResponse<>(
                inner.getRequest(),
                inner.getStatusCode(),
    ...
    public Deployment getOneDeployStatus(String resourceGroupName, String name) {
        DeploymentInner inner = this.serviceClient().getOneDeployStatus(resourceGroupName, name);
        if (inner != null) {
            return new DeploymentImpl(inner, this.manager());
        } else {
            return null;
    ...
    public Response<Deployment> createOneDeployOperationWithResponse(
        String resourceGroupName, String name, OneDeployRequest request, Context context) {
        Response<DeploymentInner> inner =
            this.serviceClient().createOneDeployOperationWithResponse(resourceGroupName, name, request, context);
        if (inner != null) {
            return new SimpleResponse<>(
                inner.getRequest(),
                inner.getStatusCode(),
    ...
    public Deployment createOneDeployOperation(String resourceGroupName, String name) {
        DeploymentInner inner = this.serviceClient().createOneDeployOperation(resourceGroupName, name);
        if (inner != null) {
            return new DeploymentImpl(inner, this.manager());
        } else {
            return null;
    ...
    public Response<VnetInfoResource> getVnetConnectionSlotWithResponse(
    ...
    public Response<VnetInfoResource> getVnetConnectionWithResponse(
    ...
    public Response<VnetInfoResource> createOrUpdateVnetConnectionWithResponse(
        String resourceGroupName,
        String name,
        String vnetName,
