...
public final class WebAppsImpl implements WebApps {
    ...
    public Response<SwiftVirtualNetworkAutoGenerated>
        getSwiftVirtualNetworkConnectionWithResponse(String resourceGroupName, String name, Context context) {
        Response<SwiftVirtualNetworkAutoGeneratedInner> inner
            = this.serviceClient().getSwiftVirtualNetworkConnectionWithResponse(resourceGroupName, name, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
                new SwiftVirtualNetworkAutoGeneratedImpl(inner.getValue(), this.manager()));
        } else {
            return null;
        }
    }

    public SwiftVirtualNetworkAutoGenerated getSwiftVirtualNetworkConnection(String resourceGroupName, String name) {
        SwiftVirtualNetworkAutoGeneratedInner inner
            = this.serviceClient().getSwiftVirtualNetworkConnection(resourceGroupName, name);
        if (inner != null) {
            return new SwiftVirtualNetworkAutoGeneratedImpl(inner, this.manager());
        } else {
            return null;
        }
    }

    public Response<SwiftVirtualNetworkAutoGenerated> createOrUpdateSwiftVirtualNetworkConnectionWithCheckWithResponse(
        String resourceGroupName, String name, SwiftVirtualNetworkAutoGeneratedInner connectionEnvelope,
        Context context) {
        Response<SwiftVirtualNetworkAutoGeneratedInner> inner
    ...
    public SwiftVirtualNetworkAutoGenerated createOrUpdateSwiftVirtualNetworkConnectionWithCheck(
        String resourceGroupName, String name, SwiftVirtualNetworkAutoGeneratedInner connectionEnvelope) {
        SwiftVirtualNetworkAutoGeneratedInner inner = this.serviceClient()
    ...
    public Response<SwiftVirtualNetworkAutoGenerated> updateSwiftVirtualNetworkConnectionWithCheckWithResponse(
        String resourceGroupName, String name, SwiftVirtualNetworkAutoGeneratedInner connectionEnvelope,
        Context context) {
        Response<SwiftVirtualNetworkAutoGeneratedInner> inner
    ...
    public SwiftVirtualNetworkAutoGenerated updateSwiftVirtualNetworkConnectionWithCheck(String resourceGroupName,
        String name, SwiftVirtualNetworkAutoGeneratedInner connectionEnvelope) {
        SwiftVirtualNetworkAutoGeneratedInner inner = this.serviceClient()
    ...
    public Response<SwiftVirtualNetworkAutoGenerated> getSwiftVirtualNetworkConnectionSlotWithResponse(
        String resourceGroupName, String name, String slot, Context context) {
        Response<SwiftVirtualNetworkAutoGeneratedInner> inner = this.serviceClient()
    ...
    public SwiftVirtualNetworkAutoGenerated getSwiftVirtualNetworkConnectionSlot(String resourceGroupName, String name,
        String slot) {
        SwiftVirtualNetworkAutoGeneratedInner inner
    ...
    public Response<SwiftVirtualNetworkAutoGenerated>
        createOrUpdateSwiftVirtualNetworkConnectionWithCheckSlotWithResponse(String resourceGroupName, String name,
            String slot, SwiftVirtualNetworkAutoGeneratedInner connectionEnvelope, Context context) {
        Response<SwiftVirtualNetworkAutoGeneratedInner> inner
    ...
    public SwiftVirtualNetworkAutoGenerated createOrUpdateSwiftVirtualNetworkConnectionWithCheckSlot(
        String resourceGroupName, String name, String slot, SwiftVirtualNetworkAutoGeneratedInner connectionEnvelope) {
        SwiftVirtualNetworkAutoGeneratedInner inner
    ...
    public Response<SwiftVirtualNetworkAutoGenerated> updateSwiftVirtualNetworkConnectionWithCheckSlotWithResponse(
        String resourceGroupName, String name, String slot, SwiftVirtualNetworkAutoGeneratedInner connectionEnvelope,
        Context context) {
        Response<SwiftVirtualNetworkAutoGeneratedInner> inner
    ...
    public SwiftVirtualNetworkAutoGenerated updateSwiftVirtualNetworkConnectionWithCheckSlot(String resourceGroupName,
        String name, String slot, SwiftVirtualNetworkAutoGeneratedInner connectionEnvelope) {
        SwiftVirtualNetworkAutoGeneratedInner inner = this.serviceClient()
