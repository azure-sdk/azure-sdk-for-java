...
public final class WebAppsImpl implements WebApps {
    private static final ClientLogger LOGGER = new ClientLogger(WebAppsImpl.class);

    private final WebAppsClient innerClient;

    private final com.azure.resourcemanager.appservice.generated.AppServiceManager serviceManager;

    public WebAppsImpl(WebAppsClient innerClient,
    ...
    public void delete(String resourceGroupName, String name, Boolean deleteMetrics, Boolean deleteEmptyServerFarm,
        Context context) {
        this.serviceClient().delete(resourceGroupName, name, deleteMetrics, deleteEmptyServerFarm, context);
    }

    public Response<CustomHostnameAnalysisResult> analyzeCustomHostnameWithResponse(String resourceGroupName,
        String name, String hostname, Context context) {
    ...
    public Response<BackupItem> backupWithResponse(String resourceGroupName, String name, BackupRequestInner request,
        Context context) {
    ...
    public Response<Void> deleteBackupWithResponse(String resourceGroupName, String name, String backupId,
        Context context) {
    ...
    public BackupItem listBackupStatusSecrets(String resourceGroupName, String name, String backupId,
    ...
    public Response<CsmPublishingCredentialsPoliciesEntity> updateFtpAllowedWithResponse(String resourceGroupName,
    ...
    public CsmPublishingCredentialsPoliciesEntity updateFtpAllowed(String resourceGroupName, String name,
    ...
    public Response<CsmPublishingCredentialsPoliciesEntity> getScmAllowedWithResponse(String resourceGroupName,
        String name, Context context) {
        Response<CsmPublishingCredentialsPoliciesEntityInner> inner
    ...
    public Response<CsmPublishingCredentialsPoliciesEntity> updateScmAllowedWithResponse(String resourceGroupName,
        String name, CsmPublishingCredentialsPoliciesEntityInner csmPublishingAccessPoliciesEntity, Context context) {
        Response<CsmPublishingCredentialsPoliciesEntityInner> inner = this.serviceClient()
    ...
    public CsmPublishingCredentialsPoliciesEntity updateScmAllowed(String resourceGroupName, String name,
        CsmPublishingCredentialsPoliciesEntityInner csmPublishingAccessPoliciesEntity) {
        CsmPublishingCredentialsPoliciesEntityInner inner
    ...
    public Response<StringDictionary> listApplicationSettingsWithResponse(String resourceGroupName, String name,
        Context context) {
    ...
    public Response<SiteAuthSettings> updateAuthSettingsWithResponse(String resourceGroupName, String name,
    ...
    public SiteAuthSettings updateAuthSettings(String resourceGroupName, String name,
    ...
    public Response<SiteAuthSettings> getAuthSettingsWithResponse(String resourceGroupName, String name,
        Context context) {
        Response<SiteAuthSettingsInner> inner
    ...
    public Response<SiteAuthSettingsV2> getAuthSettingsV2WithoutSecretsWithResponse(String resourceGroupName,
        String name, Context context) {
    ...
    public Response<SiteAuthSettingsV2> updateAuthSettingsV2WithResponse(String resourceGroupName, String name,
        SiteAuthSettingsV2Inner siteAuthSettingsV2, Context context) {
        Response<SiteAuthSettingsV2Inner> inner = this.serviceClient()
            .updateAuthSettingsV2WithResponse(resourceGroupName, name, siteAuthSettingsV2, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
                new SiteAuthSettingsV2Impl(inner.getValue(), this.manager()));
        } else {
    ...
    public SiteAuthSettingsV2 updateAuthSettingsV2(String resourceGroupName, String name,
    ...
    public Response<SiteAuthSettingsV2> getAuthSettingsV2WithResponse(String resourceGroupName, String name,
        Context context) {
        Response<SiteAuthSettingsV2Inner> inner
    ...
    public Response<AzureStoragePropertyDictionaryResource> updateAzureStorageAccountsWithResponse(
        ...
        Context context) {
        Response<AzureStoragePropertyDictionaryResourceInner> inner = this.serviceClient()
    ...
    public AzureStoragePropertyDictionaryResource updateAzureStorageAccounts(String resourceGroupName, String name,
    ...
    public Response<AzureStoragePropertyDictionaryResource>
        listAzureStorageAccountsWithResponse(String resourceGroupName, String name, Context context) {
    ...
    public Response<BackupRequest> updateBackupConfigurationWithResponse(String resourceGroupName, String name,
    ...
    public Response<Void> deleteBackupConfigurationWithResponse(String resourceGroupName, String name,
        Context context) {
    ...
    public Response<BackupRequest> getBackupConfigurationWithResponse(String resourceGroupName, String name,
        Context context) {
        Response<BackupRequestInner> inner
    ...
    public ConnectionStringDictionary updateConnectionStrings(String resourceGroupName, String name,
    ...
    public ConnectionStringDictionary updateConnectionStrings(String resourceGroupName, String name,
        ...
        ConnectionStringDictionaryInner inner
            = this.serviceClient().updateConnectionStrings(resourceGroupName, name, connectionStrings, context);
        if (inner != null) {
            return new ConnectionStringDictionaryImpl(inner, this.manager());
        } else {
            return null;
    ...
    public Response<ConnectionStringDictionary> listConnectionStringsWithResponse(String resourceGroupName, String name,
        Context context) {
    ...
    public Response<SiteLogsConfig> getDiagnosticLogsConfigurationWithResponse(String resourceGroupName, String name,
        Context context) {
    ...
    public Response<SiteLogsConfig> updateDiagnosticLogsConfigWithResponse(String resourceGroupName, String name,
        SiteLogsConfigInner siteLogsConfig, Context context) {
        Response<SiteLogsConfigInner> inner = this.serviceClient()
    ...
    public SiteLogsConfig updateDiagnosticLogsConfig(String resourceGroupName, String name,
    ...
    public Response<StringDictionary> updateMetadataWithResponse(String resourceGroupName, String name,
    ...
    public Response<PushSettings> updateSitePushSettingsWithResponse(String resourceGroupName, String name,
    ...
    public Response<PushSettings> listSitePushSettingsWithResponse(String resourceGroupName, String name,
        Context context) {
        Response<PushSettingsInner> inner
    ...
    public Response<SlotConfigNamesResource> listSlotConfigurationNamesWithResponse(String resourceGroupName,
        String name, Context context) {
    ...
    public Response<SlotConfigNamesResource> updateSlotConfigurationNamesWithResponse(String resourceGroupName,
        String name, SlotConfigNamesResourceInner slotConfigNames, Context context) {
        Response<SlotConfigNamesResourceInner> inner = this.serviceClient()
    ...
    public SlotConfigNamesResource updateSlotConfigurationNames(String resourceGroupName, String name,
    ...
    public Response<SiteConfigResource> getConfigurationWithResponse(String resourceGroupName, String name,
        Context context) {
    ...
    public SiteConfigResource updateConfiguration(String resourceGroupName, String name,
        SiteConfigResourceInner siteConfig) {
    ...
    public SiteConfigResource updateConfiguration(String resourceGroupName, String name,
        SiteConfigResourceInner siteConfig, Context context) {
        SiteConfigResourceInner inner
            = this.serviceClient().updateConfiguration(resourceGroupName, name, siteConfig, context);
        if (inner != null) {
            return new SiteConfigResourceImpl(inner, this.manager());
        } else {
            return null;
    ...
    public Response<BinaryData> getWebSiteContainerLogsWithResponse(String resourceGroupName, String name,
        Context context) {
    ...
    public Response<BinaryData> getContainerLogsZipWithResponse(String resourceGroupName, String name,
        Context context) {
    ...
    public Response<Void> deleteContinuousWebJobWithResponse(String resourceGroupName, String name, String webJobName,
        Context context) {
    ...
    public Response<Void> startContinuousWebJobWithResponse(String resourceGroupName, String name, String webJobName,
        Context context) {
    ...
    public Response<Void> stopContinuousWebJobWithResponse(String resourceGroupName, String name, String webJobName,
        Context context) {
    ...
    public Response<Void> deleteDeploymentWithResponse(String resourceGroupName, String name, String id,
        Context context) {
    ...
    public Response<Deployment> listDeploymentLogWithResponse(String resourceGroupName, String name, String id,
        Context context) {
        Response<DeploymentInner> inner
    ...
    public Response<RestoreRequest> discoverBackupWithResponse(String resourceGroupName, String name,
    ...
    public Identifier getDomainOwnershipIdentifier(String resourceGroupName, String name,
    ...
    public Response<MSDeployStatus> getMSDeployStatusWithResponse(String resourceGroupName, String name,
        Context context) {
    ...
    public Response<Object> createOneDeployOperationWithResponse(String resourceGroupName, String name,
        Context context) {
    ...
    public Response<FunctionEnvelope> getFunctionWithResponse(String resourceGroupName, String name,
    ...
    public Response<Void> deleteFunctionWithResponse(String resourceGroupName, String name, String functionName,
        Context context) {
    ...
    public KeyInfo createOrUpdateFunctionSecret(String resourceGroupName, String name, String functionName,
    ...
    public Response<StringDictionary> listFunctionKeysWithResponse(String resourceGroupName, String name,
        String functionName, Context context) {
        Response<StringDictionaryInner> inner
    ...
    public Response<FunctionSecrets> listFunctionSecretsWithResponse(String resourceGroupName, String name,
        String functionName, Context context) {
    ...
    public KeyInfo createOrUpdateHostSecret(String resourceGroupName, String name, String keyType, String keyName,
        KeyInfoInner key) {
        KeyInfoInner inner
    ...
    public Response<Void> deleteHostSecretWithResponse(String resourceGroupName, String name, String keyType,
        String keyName, Context context) {
    ...
    public Response<Void> deleteHostnameBindingWithResponse(String resourceGroupName, String name, String hostname,
        Context context) {
    ...
    public Response<HybridConnection> listHybridConnectionsWithResponse(String resourceGroupName, String name,
        Context context) {
    ...
    public Response<RelayServiceConnectionEntity> listRelayServiceConnectionsWithResponse(String resourceGroupName,
        String name, Context context) {
    ...
    public Response<RelayServiceConnectionEntity> getRelayServiceConnectionWithResponse(String resourceGroupName,
    ...
    public RelayServiceConnectionEntity getRelayServiceConnection(String resourceGroupName, String name,
        String entityName) {
        RelayServiceConnectionEntityInner inner
    ...
    public Response<MSDeployStatus> getInstanceMsDeployStatusWithResponse(String resourceGroupName, String name,
        String instanceId, Context context) {
        Response<MSDeployStatusInner> inner
    ...
    public Response<MSDeployLog> getInstanceMSDeployLogWithResponse(String resourceGroupName, String name,
        String instanceId, Context context) {
        Response<MSDeployLogInner> inner
    ...
    public Response<ProcessModuleInfo> getInstanceProcessModuleWithResponse(String resourceGroupName, String name,
        ...
        Response<ProcessModuleInfoInner> inner = this.serviceClient()
            .getInstanceProcessModuleWithResponse(resourceGroupName, name, processId, baseAddress, instanceId, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
    ...
    public StorageMigrationResponse migrateStorage(String subscriptionName, String resourceGroupName, String name,
    ...
    public Response<MigrateMySqlStatus> getMigrateMySqlStatusWithResponse(String resourceGroupName, String name,
        Context context) {
    ...
    public Response<SwiftVirtualNetworkProxy> getSwiftVirtualNetworkConnectionWithResponse(String resourceGroupName,
        String name, Context context) {
        Response<SwiftVirtualNetworkProxyInner> inner
            = this.serviceClient().getSwiftVirtualNetworkConnectionWithResponse(resourceGroupName, name, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
                new SwiftVirtualNetworkProxyImpl(inner.getValue(), this.manager()));
        } else {
            return null;
        }
    }

    public SwiftVirtualNetworkProxy getSwiftVirtualNetworkConnection(String resourceGroupName, String name) {
        SwiftVirtualNetworkProxyInner inner
            = this.serviceClient().getSwiftVirtualNetworkConnection(resourceGroupName, name);
        if (inner != null) {
            return new SwiftVirtualNetworkProxyImpl(inner, this.manager());
        } else {
            return null;
        }
    }

    public Response<SwiftVirtualNetworkProxy> createOrUpdateSwiftVirtualNetworkConnectionWithCheckWithResponse(
        String resourceGroupName, String name, SwiftVirtualNetworkProxyInner connectionEnvelope, Context context) {
        Response<SwiftVirtualNetworkProxyInner> inner
    ...
    public SwiftVirtualNetworkProxy createOrUpdateSwiftVirtualNetworkConnectionWithCheck(String resourceGroupName,
        String name, SwiftVirtualNetworkProxyInner connectionEnvelope) {
        SwiftVirtualNetworkProxyInner inner = this.serviceClient()
    ...
    public Response<Void> deleteSwiftVirtualNetworkWithResponse(String resourceGroupName, String name,
        Context context) {
    ...
    public Response<SwiftVirtualNetworkProxy> updateSwiftVirtualNetworkConnectionWithCheckWithResponse(
        String resourceGroupName, String name, SwiftVirtualNetworkProxyInner connectionEnvelope, Context context) {
        Response<SwiftVirtualNetworkProxyInner> inner
    ...
    public SwiftVirtualNetworkProxy updateSwiftVirtualNetworkConnectionWithCheck(String resourceGroupName, String name,
        SwiftVirtualNetworkProxyInner connectionEnvelope) {
        SwiftVirtualNetworkProxyInner inner = this.serviceClient()
    ...
    public Response<NetworkFeatures> listNetworkFeaturesWithResponse(String resourceGroupName, String name, String view,
        Context context) {
    ...
    public Response<Object> getNetworkTraceOperationWithResponse(String resourceGroupName, String name,
    ...
    public Response<List<NetworkTrace>> getNetworkTracesWithResponse(String resourceGroupName, String name,
        String operationId, Context context) {
    ...
    public Response<List<NetworkTrace>> getNetworkTracesV2WithResponse(String resourceGroupName, String name,
        String operationId, Context context) {
        Response<List<NetworkTraceInner>> inner
    ...
    public Response<Void> generateNewSitePublishingPasswordWithResponse(String resourceGroupName, String name,
        Context context) {
    ...
    public Response<PremierAddOn> listPremierAddOnsWithResponse(String resourceGroupName, String name,
        Context context) {
    ...
    public Response<PremierAddOn> getPremierAddOnWithResponse(String resourceGroupName, String name,
    ...
    public Response<Void> deletePremierAddOnWithResponse(String resourceGroupName, String name, String premierAddOnName,
        Context context) {
    ...
    public Response<PrivateAccess> getPrivateAccessWithResponse(String resourceGroupName, String name,
        Context context) {
    ...
    public Response<PrivateAccess> putPrivateAccessVnetWithResponse(String resourceGroupName, String name,
    ...
    public Response<Void> deleteProcessWithResponse(String resourceGroupName, String name, String processId,
        Context context) {
    ...
    public Response<BinaryData> getProcessDumpWithResponse(String resourceGroupName, String name, String processId,
        Context context) {
    ...
    public PagedIterable<ProcessModuleInfo> listProcessModules(String resourceGroupName, String name,
        String processId) {
        PagedIterable<ProcessModuleInfoInner> inner
    ...
    public ProcessModuleInfo getProcessModule(String resourceGroupName, String name, String processId,
        String baseAddress) {
    ...
    public PagedIterable<ProcessThreadInfo> listProcessThreads(String resourceGroupName, String name,
        String processId) {
        PagedIterable<ProcessThreadInfoInner> inner
    ...
    public Response<Void> restartWithResponse(String resourceGroupName, String name, Boolean softRestart,
    ...
    public Response<Void> deleteSiteExtensionWithResponse(String resourceGroupName, String name, String siteExtensionId,
        Context context) {
    ...
    public Response<Site> updateSlotWithResponse(String resourceGroupName, String name, String slot,
    ...
    public Response<CustomHostnameAnalysisResult> analyzeCustomHostnameSlotWithResponse(String resourceGroupName,
    ...
    public Response<BackupItem> backupSlotWithResponse(String resourceGroupName, String name, String slot,
        BackupRequestInner request, Context context) {
        Response<BackupItemInner> inner
    ...
    public Response<Void> deleteBackupSlotWithResponse(String resourceGroupName, String name, String backupId,
        String slot, Context context) {
    ...
    public Response<BackupItem> listBackupStatusSecretsSlotWithResponse(String resourceGroupName, String name,
    ...
    public BackupItem listBackupStatusSecretsSlot(String resourceGroupName, String name, String backupId, String slot,
        BackupRequestInner request) {
        BackupItemInner inner
    ...
    public void restoreSlot(String resourceGroupName, String name, String backupId, String slot,
    ...
    public CsmPublishingCredentialsPoliciesEntity getFtpAllowedSlot(String resourceGroupName, String name,
        String slot) {
        CsmPublishingCredentialsPoliciesEntityInner inner
    ...
    public Response<CsmPublishingCredentialsPoliciesEntity> getScmAllowedSlotWithResponse(String resourceGroupName,
        String name, String slot, Context context) {
        Response<CsmPublishingCredentialsPoliciesEntityInner> inner
    ...
    public CsmPublishingCredentialsPoliciesEntity getScmAllowedSlot(String resourceGroupName, String name,
        String slot) {
        CsmPublishingCredentialsPoliciesEntityInner inner
    ...
    public PagedIterable<SiteConfigResource> listConfigurationsSlot(String resourceGroupName, String name,
        String slot) {
        PagedIterable<SiteConfigResourceInner> inner
    ...
    public StringDictionary updateApplicationSettingsSlot(String resourceGroupName, String name, String slot,
        StringDictionaryInner appSettings) {
        StringDictionaryInner inner
    ...
    public Response<StringDictionary> listApplicationSettingsSlotWithResponse(String resourceGroupName, String name,
        String slot, Context context) {
        Response<StringDictionaryInner> inner
    ...
    public Response<SiteAuthSettings> updateAuthSettingsSlotWithResponse(String resourceGroupName, String name,
        String slot, SiteAuthSettingsInner siteAuthSettings, Context context) {
        Response<SiteAuthSettingsInner> inner = this.serviceClient()
    ...
    public SiteAuthSettings updateAuthSettingsSlot(String resourceGroupName, String name, String slot,
        SiteAuthSettingsInner siteAuthSettings) {
        SiteAuthSettingsInner inner
    ...
    public Response<SiteAuthSettings> getAuthSettingsSlotWithResponse(String resourceGroupName, String name,
        String slot, Context context) {
        Response<SiteAuthSettingsInner> inner
    ...
    public Response<SiteAuthSettingsV2> getAuthSettingsV2WithoutSecretsSlotWithResponse(String resourceGroupName,
        String name, String slot, Context context) {
        Response<SiteAuthSettingsV2Inner> inner = this.serviceClient()
    ...
    public Response<SiteAuthSettingsV2> updateAuthSettingsV2SlotWithResponse(String resourceGroupName, String name,
    ...
    public SiteAuthSettingsV2 updateAuthSettingsV2Slot(String resourceGroupName, String name, String slot,
        SiteAuthSettingsV2Inner siteAuthSettingsV2) {
        SiteAuthSettingsV2Inner inner
    ...
    public Response<SiteAuthSettingsV2> getAuthSettingsV2SlotWithResponse(String resourceGroupName, String name,
        String slot, Context context) {
        Response<SiteAuthSettingsV2Inner> inner
    ...
    public Response<AzureStoragePropertyDictionaryResource> updateAzureStorageAccountsSlotWithResponse(
        ...
        Response<AzureStoragePropertyDictionaryResourceInner> inner = this.serviceClient()
            .updateAzureStorageAccountsSlotWithResponse(resourceGroupName, name, slot, azureStorageAccounts, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
                new AzureStoragePropertyDictionaryResourceImpl(inner.getValue(), this.manager()));
        } else {
    ...
    public AzureStoragePropertyDictionaryResource updateAzureStorageAccountsSlot(String resourceGroupName, String name,
    ...
    public AzureStoragePropertyDictionaryResource listAzureStorageAccountsSlot(String resourceGroupName, String name,
        String slot) {
        AzureStoragePropertyDictionaryResourceInner inner
    ...
    public Response<BackupRequest> updateBackupConfigurationSlotWithResponse(String resourceGroupName, String name,
        String slot, BackupRequestInner request, Context context) {
        Response<BackupRequestInner> inner = this.serviceClient()
    ...
    public BackupRequest updateBackupConfigurationSlot(String resourceGroupName, String name, String slot,
        BackupRequestInner request) {
    ...
    public Response<Void> deleteBackupConfigurationSlotWithResponse(String resourceGroupName, String name, String slot,
        Context context) {
    ...
    public Response<BackupRequest> getBackupConfigurationSlotWithResponse(String resourceGroupName, String name,
        String slot, Context context) {
        Response<BackupRequestInner> inner
    ...
    public Response<ApiKVReference> getAppSettingKeyVaultReferenceSlotWithResponse(String resourceGroupName,
        String name, String appSettingKey, String slot, Context context) {
        Response<ApiKVReferenceInner> inner = this.serviceClient()
    ...
    public ApiKVReference getAppSettingKeyVaultReferenceSlot(String resourceGroupName, String name,
        String appSettingKey, String slot) {
        ApiKVReferenceInner inner
    ...
    public Response<ConnectionStringDictionary> updateConnectionStringsSlotWithResponse(String resourceGroupName,
        String name, String slot, ConnectionStringDictionaryInner connectionStrings, Context context) {
        Response<ConnectionStringDictionaryInner> inner = this.serviceClient()
    ...
    public ConnectionStringDictionary updateConnectionStringsSlot(String resourceGroupName, String name, String slot,
        ConnectionStringDictionaryInner connectionStrings) {
        ConnectionStringDictionaryInner inner
    ...
    public Response<ConnectionStringDictionary> listConnectionStringsSlotWithResponse(String resourceGroupName,
        String name, String slot, Context context) {
        Response<ConnectionStringDictionaryInner> inner
    ...
    public Response<SiteLogsConfig> getDiagnosticLogsConfigurationSlotWithResponse(String resourceGroupName,
        String name, String slot, Context context) {
        Response<SiteLogsConfigInner> inner = this.serviceClient()
            .getDiagnosticLogsConfigurationSlotWithResponse(resourceGroupName, name, slot, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
                new SiteLogsConfigImpl(inner.getValue(), this.manager()));
        } else {
    ...
    public Response<SiteLogsConfig> updateDiagnosticLogsConfigSlotWithResponse(String resourceGroupName, String name,
    ...
    public SiteLogsConfig updateDiagnosticLogsConfigSlot(String resourceGroupName, String name, String slot,
        SiteLogsConfigInner siteLogsConfig) {
        SiteLogsConfigInner inner
    ...
    public Response<StringDictionary> updateMetadataSlotWithResponse(String resourceGroupName, String name, String slot,
        StringDictionaryInner metadata, Context context) {
        Response<StringDictionaryInner> inner
    ...
    public StringDictionary updateMetadataSlot(String resourceGroupName, String name, String slot,
    ...
    public Response<StringDictionary> listMetadataSlotWithResponse(String resourceGroupName, String name, String slot,
        Context context) {
        Response<StringDictionaryInner> inner
    ...
    public Response<PushSettings> updateSitePushSettingsSlotWithResponse(String resourceGroupName, String name,
        String slot, PushSettingsInner pushSettings, Context context) {
        Response<PushSettingsInner> inner = this.serviceClient()
    ...
    public PushSettings updateSitePushSettingsSlot(String resourceGroupName, String name, String slot,
    ...
    public Response<PushSettings> listSitePushSettingsSlotWithResponse(String resourceGroupName, String name,
        String slot, Context context) {
        Response<PushSettingsInner> inner
    ...
    public Response<SiteConfigResource> getConfigurationSlotWithResponse(String resourceGroupName, String name,
        String slot, Context context) {
        Response<SiteConfigResourceInner> inner
    ...
    public Response<SiteConfigResource> createOrUpdateConfigurationSlotWithResponse(String resourceGroupName,
        String name, String slot, SiteConfigResourceInner siteConfig, Context context) {
    ...
    public SiteConfigResource createOrUpdateConfigurationSlot(String resourceGroupName, String name, String slot,
        SiteConfigResourceInner siteConfig) {
        SiteConfigResourceInner inner
    ...
    public Response<SiteConfigResource> updateConfigurationSlotWithResponse(String resourceGroupName, String name,
    ...
    public SiteConfigResource updateConfigurationSlot(String resourceGroupName, String name, String slot,
        SiteConfigResourceInner siteConfig) {
        SiteConfigResourceInner inner
    ...
    public SiteConfigResource getConfigurationSnapshotSlot(String resourceGroupName, String name, String snapshotId,
        String slot) {
        SiteConfigResourceInner inner
    ...
    public Response<BinaryData> getWebSiteContainerLogsSlotWithResponse(String resourceGroupName, String name,
        String slot, Context context) {
    ...
    public Response<BinaryData> getContainerLogsZipSlotWithResponse(String resourceGroupName, String name, String slot,
        Context context) {
    ...
    public PagedIterable<ContinuousWebJob> listContinuousWebJobsSlot(String resourceGroupName, String name,
        String slot) {
        PagedIterable<ContinuousWebJobInner> inner
    ...
    public Response<ContinuousWebJob> getContinuousWebJobSlotWithResponse(String resourceGroupName, String name,
        ...
        Response<ContinuousWebJobInner> inner = this.serviceClient()
    ...
    public ContinuousWebJob getContinuousWebJobSlot(String resourceGroupName, String name, String webJobName,
        String slot) {
    ...
    public Deployment createDeploymentSlot(String resourceGroupName, String name, String id, String slot,
    ...
    public Response<Void> deleteDeploymentSlotWithResponse(String resourceGroupName, String name, String id,
        String slot, Context context) {
    ...
    public Response<Deployment> listDeploymentLogSlotWithResponse(String resourceGroupName, String name, String id,
        String slot, Context context) {
        Response<DeploymentInner> inner
    ...
    public Response<RestoreRequest> discoverBackupSlotWithResponse(String resourceGroupName, String name, String slot,
        RestoreRequestInner request, Context context) {
        Response<RestoreRequestInner> inner
    ...
    public RestoreRequest discoverBackupSlot(String resourceGroupName, String name, String slot,
        RestoreRequestInner request) {
    ...
    public Response<MSDeployStatus> getMSDeployStatusSlotWithResponse(String resourceGroupName, String name,
        String slot, Context context) {
        Response<MSDeployStatusInner> inner
    ...
    public MSDeployStatus createMSDeployOperationSlot(String resourceGroupName, String name, String slot,
        MSDeploy mSDeploy) {
        MSDeployStatusInner inner
    ...
    public Response<MSDeployLog> getMSDeployLogSlotWithResponse(String resourceGroupName, String name, String slot,
        Context context) {
        Response<MSDeployLogInner> inner
    ...
    public PagedIterable<FunctionEnvelope> listInstanceFunctionsSlot(String resourceGroupName, String name,
        String slot) {
        PagedIterable<FunctionEnvelopeInner> inner
    ...
    public Response<FunctionEnvelope> getInstanceFunctionSlotWithResponse(String resourceGroupName, String name,
        String functionName, String slot, Context context) {
        Response<FunctionEnvelopeInner> inner = this.serviceClient()
    ...
    public FunctionEnvelope getInstanceFunctionSlot(String resourceGroupName, String name, String functionName,
        String slot) {
    ...
    public StringDictionary listFunctionKeysSlot(String resourceGroupName, String name, String functionName,
        String slot) {
        StringDictionaryInner inner
    ...
    public Response<FunctionSecrets> listFunctionSecretsSlotWithResponse(String resourceGroupName, String name,
        String functionName, String slot, Context context) {
        Response<FunctionSecretsInner> inner = this.serviceClient()
    ...
    public FunctionSecrets listFunctionSecretsSlot(String resourceGroupName, String name, String functionName,
        String slot) {
    ...
    public Response<HostKeys> listHostKeysSlotWithResponse(String resourceGroupName, String name, String slot,
        Context context) {
    ...
    public Response<Void> listSyncStatusSlotWithResponse(String resourceGroupName, String name, String slot,
        Context context) {
    ...
    public Response<Void> syncFunctionsSlotWithResponse(String resourceGroupName, String name, String slot,
        Context context) {
    ...
    public KeyInfo createOrUpdateHostSecretSlot(String resourceGroupName, String name, String keyType, String keyName,
    ...
    public Response<HybridConnection> getHybridConnectionSlotWithResponse(String resourceGroupName, String name,
    ...
    public HybridConnection getHybridConnectionSlot(String resourceGroupName, String name, String namespaceName,
    ...
    public Response<HybridConnection> listHybridConnectionsSlotWithResponse(String resourceGroupName, String name,
        String slot, Context context) {
        Response<HybridConnectionInner> inner
    ...
    public Response<RelayServiceConnectionEntity> listRelayServiceConnectionsSlotWithResponse(String resourceGroupName,
        String name, String slot, Context context) {
        Response<RelayServiceConnectionEntityInner> inner
    ...
    public RelayServiceConnectionEntity listRelayServiceConnectionsSlot(String resourceGroupName, String name,
        String slot) {
        RelayServiceConnectionEntityInner inner
    ...
    public Response<RelayServiceConnectionEntity> getRelayServiceConnectionSlotWithResponse(String resourceGroupName,
    ...
    public RelayServiceConnectionEntity getRelayServiceConnectionSlot(String resourceGroupName, String name,
    ...
    public RelayServiceConnectionEntity createOrUpdateRelayServiceConnectionSlot(String resourceGroupName, String name,
        String entityName, String slot, RelayServiceConnectionEntityInner connectionEnvelope) {
        RelayServiceConnectionEntityInner inner = this.serviceClient()
            .createOrUpdateRelayServiceConnectionSlot(resourceGroupName, name, entityName, slot, connectionEnvelope);
        if (inner != null) {
            return new RelayServiceConnectionEntityImpl(inner, this.manager());
        } else {
            return null;
    ...
    public RelayServiceConnectionEntity updateRelayServiceConnectionSlot(String resourceGroupName, String name,
        String entityName, String slot, RelayServiceConnectionEntityInner connectionEnvelope) {
        RelayServiceConnectionEntityInner inner = this.serviceClient()
    ...
    public WebSiteInstanceStatus getInstanceInfoSlot(String resourceGroupName, String name, String instanceId,
        String slot) {
    ...
    public Response<MSDeployStatus> getInstanceMsDeployStatusSlotWithResponse(String resourceGroupName, String name,
        String slot, String instanceId, Context context) {
        Response<MSDeployStatusInner> inner = this.serviceClient()
    ...
    public MSDeployStatus getInstanceMsDeployStatusSlot(String resourceGroupName, String name, String slot,
        String instanceId) {
        MSDeployStatusInner inner
    ...
    public Response<MSDeployLog> getInstanceMSDeployLogSlotWithResponse(String resourceGroupName, String name,
        String slot, String instanceId, Context context) {
        Response<MSDeployLogInner> inner = this.serviceClient()
    ...
    public MSDeployLog getInstanceMSDeployLogSlot(String resourceGroupName, String name, String slot,
        String instanceId) {
    ...
    public ProcessInfo getInstanceProcessSlot(String resourceGroupName, String name, String processId, String slot,
        String instanceId) {
        ProcessInfoInner inner
    ...
    public Response<MigrateMySqlStatus> getMigrateMySqlStatusSlotWithResponse(String resourceGroupName, String name,
        String slot, Context context) {
        Response<MigrateMySqlStatusInner> inner
    ...
    public Response<SwiftVirtualNetworkProxy> getSwiftVirtualNetworkConnectionSlotWithResponse(String resourceGroupName,
        String name, String slot, Context context) {
        Response<SwiftVirtualNetworkProxyInner> inner = this.serviceClient()
    ...
    public SwiftVirtualNetworkProxy getSwiftVirtualNetworkConnectionSlot(String resourceGroupName, String name,
        String slot) {
        SwiftVirtualNetworkProxyInner inner
    ...
    public Response<SwiftVirtualNetworkProxy> createOrUpdateSwiftVirtualNetworkConnectionWithCheckSlotWithResponse(
        String resourceGroupName, String name, String slot, SwiftVirtualNetworkProxyInner connectionEnvelope,
        Context context) {
        Response<SwiftVirtualNetworkProxyInner> inner
    ...
    public SwiftVirtualNetworkProxy createOrUpdateSwiftVirtualNetworkConnectionWithCheckSlot(String resourceGroupName,
        String name, String slot, SwiftVirtualNetworkProxyInner connectionEnvelope) {
        SwiftVirtualNetworkProxyInner inner
            = this.serviceClient().createOrUpdateSwiftVirtualNetworkConnectionWithCheckSlot(resourceGroupName, name,
                slot, connectionEnvelope);
        if (inner != null) {
            return new SwiftVirtualNetworkProxyImpl(inner, this.manager());
        } else {
            return null;
    ...
    public Response<Void> deleteSwiftVirtualNetworkSlotWithResponse(String resourceGroupName, String name, String slot,
        Context context) {
    ...
    public Response<SwiftVirtualNetworkProxy> updateSwiftVirtualNetworkConnectionWithCheckSlotWithResponse(
        String resourceGroupName, String name, String slot, SwiftVirtualNetworkProxyInner connectionEnvelope,
        Context context) {
        Response<SwiftVirtualNetworkProxyInner> inner
    ...
    public SwiftVirtualNetworkProxy updateSwiftVirtualNetworkConnectionWithCheckSlot(String resourceGroupName,
        String name, String slot, SwiftVirtualNetworkProxyInner connectionEnvelope) {
        SwiftVirtualNetworkProxyInner inner = this.serviceClient()
    ...
    public Response<NetworkFeatures> listNetworkFeaturesSlotWithResponse(String resourceGroupName, String name,
    ...
    public Response<List<NetworkTrace>> getNetworkTracesSlotWithResponse(String resourceGroupName, String name,
        String operationId, String slot, Context context) {
    ...
    public List<NetworkTrace> getNetworkTracesSlot(String resourceGroupName, String name, String operationId,
        String slot) {
    ...
    public Response<List<NetworkTrace>> getNetworkTracesSlotV2WithResponse(String resourceGroupName, String name,
        String operationId, String slot, Context context) {
        Response<List<NetworkTraceInner>> inner = this.serviceClient()
    ...
    public List<NetworkTrace> getNetworkTracesSlotV2(String resourceGroupName, String name, String operationId,
        String slot) {
        List<NetworkTraceInner> inner
    ...
    public Response<PremierAddOn> listPremierAddOnsSlotWithResponse(String resourceGroupName, String name, String slot,
        Context context) {
        Response<PremierAddOnInner> inner
    ...
    public PremierAddOn getPremierAddOnSlot(String resourceGroupName, String name, String premierAddOnName,
        String slot) {
    ...
    public PremierAddOn addPremierAddOnSlot(String resourceGroupName, String name, String premierAddOnName, String slot,
    ...
    public Response<PrivateAccess> getPrivateAccessSlotWithResponse(String resourceGroupName, String name, String slot,
        Context context) {
        Response<PrivateAccessInner> inner
    ...
    public Response<PrivateAccess> putPrivateAccessVnetSlotWithResponse(String resourceGroupName, String name,
    ...
    public PrivateAccess putPrivateAccessVnetSlot(String resourceGroupName, String name, String slot,
    ...
    public RemotePrivateEndpointConnectionArmResource getPrivateEndpointConnectionSlot(String resourceGroupName,
    ...
    public Response<Void> deleteProcessSlotWithResponse(String resourceGroupName, String name, String processId,
        String slot, Context context) {
    ...
    public Response<BinaryData> getProcessDumpSlotWithResponse(String resourceGroupName, String name, String processId,
        String slot, Context context) {
    ...
    public ProcessModuleInfo getProcessModuleSlot(String resourceGroupName, String name, String processId,
    ...
    public PublicCertificate getPublicCertificateSlot(String resourceGroupName, String name, String slot,
    ...
    public void restoreFromBackupBlobSlot(String resourceGroupName, String name, String slot,
        RestoreRequestInner request) {
    ...
    public void restoreFromDeletedAppSlot(String resourceGroupName, String name, String slot,
    ...
    public void restoreSnapshotSlot(String resourceGroupName, String name, String slot,
    ...
    public Response<SiteContainer> getSiteContainerSlotWithResponse(String resourceGroupName, String name, String slot,
        String containerName, Context context) {
        Response<SiteContainerInner> inner = this.serviceClient().getSiteContainerSlotWithResponse(resourceGroupName,
            name, slot, containerName, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
                new SiteContainerImpl(inner.getValue(), this.manager()));
        } else {
    ...
    public Response<SiteContainer> createOrUpdateSiteContainerSlotWithResponse(String resourceGroupName, String name,
        ...
        Response<SiteContainerInner> inner = this.serviceClient().createOrUpdateSiteContainerSlotWithResponse(
            resourceGroupName, name, slot, containerName, request, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
                new SiteContainerImpl(inner.getValue(), this.manager()));
        } else {
    ...
    public SiteContainer createOrUpdateSiteContainerSlot(String resourceGroupName, String name, String slot,
        ...
        SiteContainerInner inner = this.serviceClient().createOrUpdateSiteContainerSlot(resourceGroupName, name, slot,
    ...
    public Response<Void> deleteSiteContainerSlotWithResponse(String resourceGroupName, String name, String slot,
        String containerName, Context context) {
        return this.serviceClient().deleteSiteContainerSlotWithResponse(resourceGroupName, name, slot, containerName,
            context);
    }
    ...
    public Response<SiteExtensionInfo> getSiteExtensionSlotWithResponse(String resourceGroupName, String name,
        ...
        Response<SiteExtensionInfoInner> inner = this.serviceClient()
    ...
    public SiteExtensionInfo getSiteExtensionSlot(String resourceGroupName, String name, String siteExtensionId,
        String slot) {
        SiteExtensionInfoInner inner
    ...
    public SiteExtensionInfo installSiteExtensionSlot(String resourceGroupName, String name, String siteExtensionId,
        String slot) {
        SiteExtensionInfoInner inner
    ...
    public Response<SiteSourceControl> updateSourceControlSlotWithResponse(String resourceGroupName, String name,
        String slot, SiteSourceControlInner siteSourceControl, Context context) {
        Response<SiteSourceControlInner> inner = this.serviceClient()
    ...
    public SiteSourceControl updateSourceControlSlot(String resourceGroupName, String name, String slot,
        SiteSourceControlInner siteSourceControl) {
        SiteSourceControlInner inner
    ...
    public Response<Void> stopNetworkTraceSlotWithResponse(String resourceGroupName, String name, String slot,
        Context context) {
    ...
    public Response<Void> syncRepositorySlotWithResponse(String resourceGroupName, String name, String slot,
        Context context) {
    ...
    public Response<Void> syncFunctionTriggersSlotWithResponse(String resourceGroupName, String name, String slot,
        Context context) {
    ...
    public Response<TriggeredWebJob> getTriggeredWebJobSlotWithResponse(String resourceGroupName, String name,
        String webJobName, String slot, Context context) {
        Response<TriggeredWebJobInner> inner = this.serviceClient()
            .getTriggeredWebJobSlotWithResponse(resourceGroupName, name, webJobName, slot, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
    ...
    public TriggeredWebJob getTriggeredWebJobSlot(String resourceGroupName, String name, String webJobName,
        String slot) {
    ...
    public Response<TriggeredJobHistory> getTriggeredWebJobHistorySlotWithResponse(String resourceGroupName,
        String name, String webJobName, String id, String slot, Context context) {
        Response<TriggeredJobHistoryInner> inner = this.serviceClient()
    ...
    public TriggeredJobHistory getTriggeredWebJobHistorySlot(String resourceGroupName, String name, String webJobName,
    ...
    public Response<VnetInfoResource> getVnetConnectionSlotWithResponse(String resourceGroupName, String name,
    ...
    public Response<VnetGateway> getVnetConnectionGatewaySlotWithResponse(String resourceGroupName, String name,
    ...
    public VnetGateway getVnetConnectionGatewaySlot(String resourceGroupName, String name, String vnetName,
    ...
    public SiteSourceControl createOrUpdateSourceControl(String resourceGroupName, String name,
        SiteSourceControlInner siteSourceControl) {
        SiteSourceControlInner inner
    ...
    public Response<Void> deleteSourceControlWithResponse(String resourceGroupName, String name, String additionalFlags,
        Context context) {
    ...
    public Response<SiteSourceControl> updateSourceControlWithResponse(String resourceGroupName, String name,
        SiteSourceControlInner siteSourceControl, Context context) {
        Response<SiteSourceControlInner> inner
    ...
    public SiteSourceControl updateSourceControl(String resourceGroupName, String name,
        SiteSourceControlInner siteSourceControl) {
        SiteSourceControlInner inner
    ...
    public Response<Void> deleteTriggeredWebJobWithResponse(String resourceGroupName, String name, String webJobName,
        Context context) {
    ...
    public TriggeredJobHistory getTriggeredWebJobHistory(String resourceGroupName, String name, String webJobName,
        String id) {
        TriggeredJobHistoryInner inner
    ...
    public Response<Void> runTriggeredWebJobWithResponse(String resourceGroupName, String name, String webJobName,
        Context context) {
    ...
    public Response<VnetInfoResource> getVnetConnectionWithResponse(String resourceGroupName, String name,
    ...
    public Response<VnetInfoResource> createOrUpdateVnetConnectionWithResponse(String resourceGroupName, String name,
        ...
        Response<VnetInfoResourceInner> inner = this.serviceClient()
            .createOrUpdateVnetConnectionWithResponse(resourceGroupName, name, vnetName, connectionEnvelope, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
                new VnetInfoResourceImpl(inner.getValue(), this.manager()));
        } else {
    ...
    public VnetInfoResource createOrUpdateVnetConnection(String resourceGroupName, String name, String vnetName,
    ...
    public Response<Void> deleteVnetConnectionWithResponse(String resourceGroupName, String name, String vnetName,
        Context context) {
    ...
    public VnetInfoResource updateVnetConnection(String resourceGroupName, String name, String vnetName,
        VnetInfoResourceInner connectionEnvelope) {
        VnetInfoResourceInner inner
    ...
    public VnetGateway getVnetConnectionGateway(String resourceGroupName, String name, String vnetName,
        String gatewayName) {
        VnetGatewayInner inner
    ...
    public PagedIterable<WorkflowEnvelope> listInstanceWorkflowsSlot(String resourceGroupName, String name,
        String slot) {
    ...
    public WorkflowEnvelope getInstanceWorkflowSlot(String resourceGroupName, String name, String slot,
        String workflowName) {
    ...
    public Response<WorkflowEnvelope> listWorkflowsConnectionsSlotWithResponse(String resourceGroupName, String name,
        String slot, Context context) {
    ...
    public Response<WorkflowEnvelope> listWorkflowsConnectionsWithResponse(String resourceGroupName, String name,
        Context context) {
        Response<WorkflowEnvelopeInner> inner
    ...
    public HybridConnection getHybridConnectionById(String id) {
        ...
        return this.getHybridConnectionWithResponse(resourceGroupName, name, namespaceName, relayName, Context.NONE)
            .getValue();
    }
    ...
    public PublicCertificate getPublicCertificateById(String id) {
        ...
        return this.getPublicCertificateWithResponse(resourceGroupName, name, publicCertificateName, Context.NONE)
            .getValue();
    }
    ...
    public void deleteById(String id) {
        ...
        this.delete(resourceGroupName, name, localDeleteMetrics, localDeleteEmptyServerFarm, Context.NONE);
    }

    public void deleteByIdWithResponse(String id, Boolean deleteMetrics, Boolean deleteEmptyServerFarm,
        Context context) {
        String resourceGroupName = ResourceManagerUtils.getValueFromIdByName(id, "resourceGroups");
        if (resourceGroupName == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
        ...
        this.delete(resourceGroupName, name, deleteMetrics, deleteEmptyServerFarm, context);
    }
    ...
    public void deleteDeploymentById(String id) {
        ...
        this.deleteDeploymentWithResponse(resourceGroupName, name, varId, Context.NONE);
    }
    ...
    public void deleteDomainOwnershipIdentifierById(String id) {
        ...
        this.deleteDomainOwnershipIdentifierWithResponse(resourceGroupName, name, domainOwnershipIdentifierName,
            Context.NONE);
    }
    ...
    public Response<Void> deleteDomainOwnershipIdentifierByIdWithResponse(String id, Context context) {
        ...
        return this.deleteDomainOwnershipIdentifierWithResponse(resourceGroupName, name, domainOwnershipIdentifierName,
            context);
    }
    ...
    public void deleteFunctionById(String id) {
        ...
        this.deleteFunctionWithResponse(resourceGroupName, name, functionName, Context.NONE);
    }
    ...
    public void deleteHostnameBindingById(String id) {
        ...
        this.deleteHostnameBindingWithResponse(resourceGroupName, name, hostname, Context.NONE);
    }
    ...
    public void deleteHybridConnectionById(String id) {
        ...
        this.deleteHybridConnectionWithResponse(resourceGroupName, name, namespaceName, relayName, Context.NONE);
    }
    ...
    public void deleteRelayServiceConnectionById(String id) {
        ...
        this.deleteRelayServiceConnectionWithResponse(resourceGroupName, name, entityName, Context.NONE);
    }
    ...
    public void deletePremierAddOnById(String id) {
        ...
        this.deletePremierAddOnWithResponse(resourceGroupName, name, premierAddOnName, Context.NONE);
    }
    ...
    public void deletePublicCertificateById(String id) {
        ...
        this.deletePublicCertificateWithResponse(resourceGroupName, name, publicCertificateName, Context.NONE);
    }
    ...
    public void deleteVnetConnectionSlotById(String id) {
        ...
        this.deleteVnetConnectionSlotWithResponse(resourceGroupName, name, vnetName, slot, Context.NONE);
    }
    ...
    public VnetInfoResourceImpl defineVnetConnectionSlot(String name) {
        return new VnetInfoResourceImpl(name, this.manager());
    }
