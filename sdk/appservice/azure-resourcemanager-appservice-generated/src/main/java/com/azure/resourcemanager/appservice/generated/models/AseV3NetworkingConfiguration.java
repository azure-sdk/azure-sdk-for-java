...
public interface AseV3NetworkingConfiguration {
    ...
    /**
     * Gets the numberOfOutboundIpAddresses property: Property to set the number of outbound ips on AseV3.
     *
     * @return the numberOfOutboundIpAddresses value.
     */
    Integer numberOfOutboundIpAddresses();

    /**
     * Gets the inboundIpAddressOverride property: Customer provided Inbound IP Address.
     *
    ...
    /**
     * Gets the targetNumberOfOutboundIpAddresses property: The targetNumberOfOutboundIpAddresses property.
     *
     * @return the targetNumberOfOutboundIpAddresses value.
     */
    Integer targetNumberOfOutboundIpAddresses();
