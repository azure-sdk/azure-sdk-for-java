...
public final class SiteInner extends Resource {
    ...
    /**
     * Get the managedEnvironment property: containerapp environment ID. It is used to indentify customer's
     * kube/centauri environment.
     *
     * @return the managedEnvironment value.
     */
    public String managedEnvironment() {
        return this.innerProperties() == null ? null : this.innerProperties().managedEnvironment();
    }

    /**
     * Set the managedEnvironment property: containerapp environment ID. It is used to indentify customer's
     * kube/centauri environment.
     *
     * @param managedEnvironment the managedEnvironment value to set.
     * @return the SiteInner object itself.
     */
    public SiteInner withManagedEnvironment(String managedEnvironment) {
        if (this.innerProperties() == null) {
            this.innerProperties = new SitePropertiesInner();
        }
        this.innerProperties().withManagedEnvironment(managedEnvironment);
        return this;
    }
