...
public final class SiteInner extends Resource {
    ...
    /**
     * Get the ipMode property: Specifies the IP mode of the app.
     * 
    ...
    /**
     * Set the ipMode property: Specifies the IP mode of the app.
     * 
    ...
    public SiteInner withIpMode(IpMode ipMode) {
        ...
        this.innerProperties().withIpMode(ipMode);
        return this;
    }

    /**
     * Get the endToEndEncryptionEnabled property: Whether to use end to end encryption between the FrontEnd and the
     * Worker.
     * 
     * @return the endToEndEncryptionEnabled value.
     */
    public Boolean endToEndEncryptionEnabled() {
        return this.innerProperties() == null ? null : this.innerProperties().endToEndEncryptionEnabled();
    }

    /**
     * Set the endToEndEncryptionEnabled property: Whether to use end to end encryption between the FrontEnd and the
     * Worker.
     * 
     * @param endToEndEncryptionEnabled the endToEndEncryptionEnabled value to set.
     * @return the SiteInner object itself.
     */
    public SiteInner withEndToEndEncryptionEnabled(Boolean endToEndEncryptionEnabled) {
        if (this.innerProperties() == null) {
            this.innerProperties = new SitePropertiesInner();
        }
    ...
    /**
     * Get the autoGeneratedDomainNameLabelScope property: Specifies the scope of uniqueness for the default hostname
    ...
    /**
     * Set the autoGeneratedDomainNameLabelScope property: Specifies the scope of uniqueness for the default hostname
     * during resource creation.
     * 
    ...
    /**
     * Get the sku property: Current SKU of application based on associated App Service Plan. Some valid SKU values are
    ...
    public void validate() {
        ...
        if (location() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Missing required property location in model SiteInner"));
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(SiteInner.class);
