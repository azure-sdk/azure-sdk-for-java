...
import com.azure.resourcemanager.appservice.generated.models.StaticSiteRegion;
...
public final class ResourceProvidersImpl implements ResourceProviders {
    ...
    public PagedIterable<StaticSiteRegion> listStaticSiteRegions() {
        PagedIterable<StaticSiteRegionInner> inner = this.serviceClient().listStaticSiteRegions();
        return ResourceManagerUtils.mapPage(inner, inner1 -> new StaticSiteRegionImpl(inner1, this.manager()));
    }

    public PagedIterable<StaticSiteRegion> listStaticSiteRegions(SkuName sku, Context context) {
        PagedIterable<StaticSiteRegionInner> inner = this.serviceClient().listStaticSiteRegions(sku, context);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new StaticSiteRegionImpl(inner1, this.manager()));
    }
