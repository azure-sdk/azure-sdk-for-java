...
public final class ResourceProvidersImpl implements ResourceProviders {
    ...
    public Response<SwiftVirtualNetwork> listVirtualNetworkIntegrationsWithResponse(String location,
        VirtualNetworkIntegrationRequest request, Context context) {
        Response<SwiftVirtualNetworkInner> inner
            = this.serviceClient().listVirtualNetworkIntegrationsWithResponse(location, request, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
    ...
    public SwiftVirtualNetwork listVirtualNetworkIntegrations(String location,
        VirtualNetworkIntegrationRequest request) {
        SwiftVirtualNetworkInner inner = this.serviceClient().listVirtualNetworkIntegrations(location, request);
        if (inner != null) {
