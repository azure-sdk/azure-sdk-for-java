...
public final class ResourceProvidersImpl implements ResourceProviders {
    ...
    public Response<AseRegionCollection> listAseRegionsWithResponse(Context context) {
        Response<AseRegionCollectionInner> inner = this.serviceClient().listAseRegionsWithResponse(context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
                new AseRegionCollectionImpl(inner.getValue(), this.manager()));
        } else {
            return null;
        }
    }

    public AseRegionCollection listAseRegions() {
        AseRegionCollectionInner inner = this.serviceClient().listAseRegions();
        if (inner != null) {
            return new AseRegionCollectionImpl(inner, this.manager());
        } else {
            return null;
        }
    }
