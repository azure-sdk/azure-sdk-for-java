...
public final class ResourceProvidersImpl implements ResourceProviders {
    ...
    public Response<DnlResourceNameAvailability> checkNameAvailabilityWithResponse(String location,
        DnlResourceNameAvailabilityRequest request, Context context) {
        Response<DnlResourceNameAvailabilityInner> inner
            = this.serviceClient().checkNameAvailabilityWithResponse(location, request, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
                new DnlResourceNameAvailabilityImpl(inner.getValue(), this.manager()));
        } else {
            return null;
        }
    }

    public DnlResourceNameAvailability checkNameAvailability(String location,
        DnlResourceNameAvailabilityRequest request) {
        DnlResourceNameAvailabilityInner inner = this.serviceClient().checkNameAvailability(location, request);
        if (inner != null) {
            return new DnlResourceNameAvailabilityImpl(inner, this.manager());
        } else {
            return null;
        }
    }
