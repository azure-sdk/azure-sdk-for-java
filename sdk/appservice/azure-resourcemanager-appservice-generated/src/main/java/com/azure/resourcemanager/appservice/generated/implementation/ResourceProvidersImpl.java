...
public final class ResourceProvidersImpl implements ResourceProviders {
    ...
    public Response<CsmUsageQuotaCollection> getUsagesInLocationWithResponse(String location, Context context) {
        Response<CsmUsageQuotaCollectionInner> inner =
            this.serviceClient().getUsagesInLocationWithResponse(location, context);
        if (inner != null) {
            return new SimpleResponse<>(
                inner.getRequest(),
                inner.getStatusCode(),
                inner.getHeaders(),
                new CsmUsageQuotaCollectionImpl(inner.getValue(), this.manager()));
        } else {
            return null;
        }
    }

    public CsmUsageQuotaCollection getUsagesInLocation(String location) {
        CsmUsageQuotaCollectionInner inner = this.serviceClient().getUsagesInLocation(location);
        if (inner != null) {
            return new CsmUsageQuotaCollectionImpl(inner, this.manager());
        } else {
            return null;
        }
    }

    public Response<CsmUsageQuotaCollection> getZoneRedundantUsagesInLocationWithResponse(
        String location, Context context) {
        Response<CsmUsageQuotaCollectionInner> inner =
            this.serviceClient().getZoneRedundantUsagesInLocationWithResponse(location, context);
        if (inner != null) {
            return new SimpleResponse<>(
                inner.getRequest(),
                inner.getStatusCode(),
    ...
    public CsmUsageQuotaCollection getZoneRedundantUsagesInLocation(String location) {
        CsmUsageQuotaCollectionInner inner = this.serviceClient().getZoneRedundantUsagesInLocation(location);
        if (inner != null) {
            return new CsmUsageQuotaCollectionImpl(inner, this.manager());
        } else {
            return null;
