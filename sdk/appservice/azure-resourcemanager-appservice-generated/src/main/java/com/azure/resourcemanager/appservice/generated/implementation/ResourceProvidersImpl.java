...
public final class ResourceProvidersImpl implements ResourceProviders {
    ...
    public PagedIterable<BillingMeter> list() {
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new BillingMeterImpl(inner1, this.manager()));
    }
    ...
    public PagedIterable<CustomHostnameSites> listCustomHostnameSites() {
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new CustomHostnameSitesImpl(inner1, this.manager()));
    }
    ...
    public PagedIterable<AseRegion> listAseRegions() {
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new AseRegionImpl(inner1, this.manager()));
    }
    ...
    public PagedIterable<PremierAddOnOffer> listPremierAddOnOffers() {
        ...
        return ResourceManagerUtils.mapPage(inner, inner1 -> new PremierAddOnOfferImpl(inner1, this.manager()));
    }
    ...
    public Response<SwiftVirtualNetwork> virtualNetworkIntegrationsWithResponse(String location,
        VirtualNetworkIntegrationRequest request, Context context) {
        Response<SwiftVirtualNetworkInner> inner
            = this.serviceClient().virtualNetworkIntegrationsWithResponse(location, request, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
    ...
    public SwiftVirtualNetwork virtualNetworkIntegrations(String location, VirtualNetworkIntegrationRequest request) {
        SwiftVirtualNetworkInner inner = this.serviceClient().virtualNetworkIntegrations(location, request);
        if (inner != null) {
    ...
    public Response<VirtualNetworkIntegrationResponse> purgeUnusedVirtualNetworkIntegrationsWithResponse(
        String location, VirtualNetworkIntegrationRequest request, Context context) {
        Response<VirtualNetworkIntegrationResponseInner> inner
            = this.serviceClient().purgeUnusedVirtualNetworkIntegrationsWithResponse(location, request, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
                new VirtualNetworkIntegrationResponseImpl(inner.getValue(), this.manager()));
        } else {
            return null;
        }
    }

    public VirtualNetworkIntegrationResponse purgeUnusedVirtualNetworkIntegrations(String location,
        VirtualNetworkIntegrationRequest request) {
        VirtualNetworkIntegrationResponseInner inner
            = this.serviceClient().purgeUnusedVirtualNetworkIntegrations(location, request);
        if (inner != null) {
            return new VirtualNetworkIntegrationResponseImpl(inner, this.manager());
        } else {
            return null;
        }
    }
