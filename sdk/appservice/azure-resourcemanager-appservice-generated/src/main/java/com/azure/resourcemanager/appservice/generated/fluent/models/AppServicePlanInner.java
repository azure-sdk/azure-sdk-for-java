...
public final class AppServicePlanInner extends Resource {
    ...
    public void validate() {
        ...
        if (location() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException("Missing required property location in model AppServicePlanInner"));
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(AppServicePlanInner.class);
     ...
     * @return An instance of AppServicePlanInner if the JsonReader was pointing to an instance of it, or null if it was
     * pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the AppServicePlanInner.
     */
