...
public final class AppServicePlansImpl implements AppServicePlans {
    ...
    public PagedIterable<SwiftVirtualNetwork> getVirtualNetworkIntegrations(String resourceGroupName, String name) {
        PagedIterable<SwiftVirtualNetworkInner> inner
            = this.serviceClient().getVirtualNetworkIntegrations(resourceGroupName, name);
    ...
    public PagedIterable<SwiftVirtualNetwork> getVirtualNetworkIntegrations(String resourceGroupName, String name,
        Context context) {
        PagedIterable<SwiftVirtualNetworkInner> inner
            = this.serviceClient().getVirtualNetworkIntegrations(resourceGroupName, name, context);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new SwiftVirtualNetworkImpl(inner1, this.manager()));
    }
