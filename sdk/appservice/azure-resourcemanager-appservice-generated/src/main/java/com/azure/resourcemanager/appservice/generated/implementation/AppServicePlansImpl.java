...
public final class AppServicePlansImpl implements AppServicePlans {
    ...
    public Response<SwiftVirtualNetwork> getVirtualNetworkIntegrationWithResponse(String resourceGroupName, String name,
        String vnetName, Context context) {
        Response<SwiftVirtualNetworkInner> inner
            = this.serviceClient().getVirtualNetworkIntegrationWithResponse(resourceGroupName, name, vnetName, context);
        if (inner != null) {
            return new SimpleResponse<>(inner.getRequest(), inner.getStatusCode(), inner.getHeaders(),
    ...
    public SwiftVirtualNetwork getVirtualNetworkIntegration(String resourceGroupName, String name, String vnetName) {
        SwiftVirtualNetworkInner inner
            = this.serviceClient().getVirtualNetworkIntegration(resourceGroupName, name, vnetName);
        if (inner != null) {
    ...
    public PagedIterable<SwiftVirtualNetwork> listByVirtualNetworkIntegrations(String resourceGroupName, String name) {
        PagedIterable<SwiftVirtualNetworkInner> inner
            = this.serviceClient().listByVirtualNetworkIntegrations(resourceGroupName, name);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new SwiftVirtualNetworkImpl(inner1, this.manager()));
    }

    public PagedIterable<SwiftVirtualNetwork> listByVirtualNetworkIntegrations(String resourceGroupName, String name,
        Context context) {
        PagedIterable<SwiftVirtualNetworkInner> inner
            = this.serviceClient().listByVirtualNetworkIntegrations(resourceGroupName, name, context);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new SwiftVirtualNetworkImpl(inner1, this.manager()));
    }
