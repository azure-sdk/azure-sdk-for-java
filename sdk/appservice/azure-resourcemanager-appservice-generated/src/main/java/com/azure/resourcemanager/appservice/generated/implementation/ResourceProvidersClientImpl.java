...
import com.azure.resourcemanager.appservice.generated.models.PurgedUnusedVirtualNetworkSuccessResponse;
...
public final class ResourceProvidersClientImpl implements ResourceProvidersClient {
    ...
    public interface ResourceProvidersService {
        ...
        @Headers({ "Content-Type: application/json" })
        @Post("/subscriptions/{subscriptionId}/providers/Microsoft.Web/locations/{location}/virtualNetworkIntegrations")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(DefaultErrorResponseErrorException.class)
        Mono<Response<SwiftVirtualNetworkInner>> virtualNetworkIntegrations(@HostParam("$host") String endpoint,
            @PathParam("location") String location, @PathParam("subscriptionId") String subscriptionId,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") VirtualNetworkIntegrationRequest request,
            @HeaderParam("Accept") String accept, Context context);

        @Headers({ "Content-Type: application/json" })
        @Post("/subscriptions/{subscriptionId}/providers/Microsoft.Web/locations/{location}/purgeUnusedVirtualNetworkIntegration")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(DefaultErrorResponseErrorException.class)
        Mono<Response<PurgedUnusedVirtualNetworkSuccessResponse>> purgeUnusedVirtualNetworkIntegrations(
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<AseRegionInner> listAseRegionsAsync() {
    ...
    /**
     * Retrieve information regarding the provided virtual network integration
     * 
     * Retrieve information regarding the provided virtual network integration, such as its allocated resources and its
     * allocated IP.
     * 
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<SwiftVirtualNetworkInner>> virtualNetworkIntegrationsWithResponseAsync(String location,
        VirtualNetworkIntegrationRequest request) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.virtualNetworkIntegrations(this.client.getEndpoint(), location,
                this.client.getSubscriptionId(), this.client.getApiVersion(), request, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<SwiftVirtualNetworkInner>> virtualNetworkIntegrationsWithResponseAsync(String location,
        VirtualNetworkIntegrationRequest request, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.virtualNetworkIntegrations(this.client.getEndpoint(), location, this.client.getSubscriptionId(),
            this.client.getApiVersion(), request, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<SwiftVirtualNetworkInner> virtualNetworkIntegrationsAsync(String location,
        VirtualNetworkIntegrationRequest request) {
        return virtualNetworkIntegrationsWithResponseAsync(location, request)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<SwiftVirtualNetworkInner> virtualNetworkIntegrationsWithResponse(String location,
        VirtualNetworkIntegrationRequest request, Context context) {
        return virtualNetworkIntegrationsWithResponseAsync(location, request, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public SwiftVirtualNetworkInner virtualNetworkIntegrations(String location,
        VirtualNetworkIntegrationRequest request) {
        return virtualNetworkIntegrationsWithResponse(location, request, Context.NONE).getValue();
    }

    /**
     * Delete orphaned (unused) VNET integration
     * 
     * Delete orphaned (unused) VNET integration, otherwise fail the call if there are sites that are still using the
     * VNET integration.
     * 
     * @param location The name of the Azure region.
     * @param request Object contains the subnetResourceId.
     ...
     * @throws DefaultErrorResponseErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return response content upon successful deletion of an unused virtual network along with {@link Response} on
     * successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<PurgedUnusedVirtualNetworkSuccessResponse>>
        purgeUnusedVirtualNetworkIntegrationsWithResponseAsync(String location,
            VirtualNetworkIntegrationRequest request) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.purgeUnusedVirtualNetworkIntegrations(this.client.getEndpoint(), location,
                this.client.getSubscriptionId(), this.client.getApiVersion(), request, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<PurgedUnusedVirtualNetworkSuccessResponse>>
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.purgeUnusedVirtualNetworkIntegrations(this.client.getEndpoint(), location,
            this.client.getSubscriptionId(), this.client.getApiVersion(), request, accept, context);
    }
     ...
     * @throws DefaultErrorResponseErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return response content upon successful deletion of an unused virtual network on successful completion of
     * {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PurgedUnusedVirtualNetworkSuccessResponse> purgeUnusedVirtualNetworkIntegrationsAsync(String location,
        VirtualNetworkIntegrationRequest request) {
        return purgeUnusedVirtualNetworkIntegrationsWithResponseAsync(location, request)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     * @throws DefaultErrorResponseErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return response content upon successful deletion of an unused virtual network along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<PurgedUnusedVirtualNetworkSuccessResponse> purgeUnusedVirtualNetworkIntegrationsWithResponse(
        String location, VirtualNetworkIntegrationRequest request, Context context) {
        return purgeUnusedVirtualNetworkIntegrationsWithResponseAsync(location, request, context).block();
    }
     ...
     * @throws DefaultErrorResponseErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return response content upon successful deletion of an unused virtual network.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public PurgedUnusedVirtualNetworkSuccessResponse purgeUnusedVirtualNetworkIntegrations(String location,
        VirtualNetworkIntegrationRequest request) {
        return purgeUnusedVirtualNetworkIntegrationsWithResponse(location, request, Context.NONE).getValue();
    }
