...
public final class ResourceProvidersClientImpl implements ResourceProvidersClient {
    ...
    public interface ResourceProvidersService {
        ...
        @Headers({ "Content-Type: application/json" })
        @Post("/subscriptions/{subscriptionId}/providers/Microsoft.Web/locations/{location}/listVirtualNetworkIntegrations")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(DefaultErrorResponseErrorException.class)
        Mono<Response<SwiftVirtualNetworkInner>> listVirtualNetworkIntegrations(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(DefaultErrorResponseErrorException.class)
        Mono<Response<VirtualNetworkIntegrationResponseInner>> purgeUnusedVirtualNetworkIntegrations(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<SwiftVirtualNetworkInner>> listVirtualNetworkIntegrationsWithResponseAsync(String location,
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.listVirtualNetworkIntegrations(this.client.getEndpoint(), location,
                this.client.getSubscriptionId(), this.client.getApiVersion(), request, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<SwiftVirtualNetworkInner>> listVirtualNetworkIntegrationsWithResponseAsync(String location,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.listVirtualNetworkIntegrations(this.client.getEndpoint(), location,
            this.client.getSubscriptionId(), this.client.getApiVersion(), request, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<SwiftVirtualNetworkInner> listVirtualNetworkIntegrationsAsync(String location,
        VirtualNetworkIntegrationRequest request) {
        return listVirtualNetworkIntegrationsWithResponseAsync(location, request)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<SwiftVirtualNetworkInner> listVirtualNetworkIntegrationsWithResponse(String location,
        VirtualNetworkIntegrationRequest request, Context context) {
        return listVirtualNetworkIntegrationsWithResponseAsync(location, request, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public SwiftVirtualNetworkInner listVirtualNetworkIntegrations(String location,
        VirtualNetworkIntegrationRequest request) {
        return listVirtualNetworkIntegrationsWithResponse(location, request, Context.NONE).getValue();
    }
     ...
     * @throws DefaultErrorResponseErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return response wrapper for PurgedUnusedVirtualNetworkIntegrations along with {@link Response} on successful
     * completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<VirtualNetworkIntegrationResponseInner>>
     ...
     * @throws DefaultErrorResponseErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return response wrapper for PurgedUnusedVirtualNetworkIntegrations on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<VirtualNetworkIntegrationResponseInner> purgeUnusedVirtualNetworkIntegrationsAsync(String location,
        VirtualNetworkIntegrationRequest request) {
     ...
     * @throws DefaultErrorResponseErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return response wrapper for PurgedUnusedVirtualNetworkIntegrations along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<VirtualNetworkIntegrationResponseInner> purgeUnusedVirtualNetworkIntegrationsWithResponse(
     ...
     * @throws DefaultErrorResponseErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return response wrapper for PurgedUnusedVirtualNetworkIntegrations.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public VirtualNetworkIntegrationResponseInner purgeUnusedVirtualNetworkIntegrations(String location,
        VirtualNetworkIntegrationRequest request) {
