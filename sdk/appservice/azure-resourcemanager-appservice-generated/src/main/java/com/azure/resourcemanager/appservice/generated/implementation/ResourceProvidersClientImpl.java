...
public final class ResourceProvidersClientImpl implements ResourceProvidersClient {
    ...
    public interface ResourceProvidersService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(DefaultErrorResponseErrorException.class)
        Mono<Response<DnlResourceNameAvailabilityInner>> checkNameAvailability(@HostParam("$host") String endpoint,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<DnlResourceNameAvailabilityInner>> checkNameAvailabilityWithResponseAsync(String location,
    ...
    private Mono<Response<DnlResourceNameAvailabilityInner>> checkNameAvailabilityWithResponseAsync(String location,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.checkNameAvailability(this.client.getEndpoint(), location, this.client.getSubscriptionId(),
            this.client.getApiVersion(), request, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DnlResourceNameAvailabilityInner> checkNameAvailabilityAsync(String location,
        DnlResourceNameAvailabilityRequest request) {
        return checkNameAvailabilityWithResponseAsync(location, request)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<DnlResourceNameAvailabilityInner> checkNameAvailabilityWithResponse(String location,
        DnlResourceNameAvailabilityRequest request, Context context) {
        return checkNameAvailabilityWithResponseAsync(location, request, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public DnlResourceNameAvailabilityInner checkNameAvailability(String location,
        DnlResourceNameAvailabilityRequest request) {
        return checkNameAvailabilityWithResponse(location, request, Context.NONE).getValue();
    }
