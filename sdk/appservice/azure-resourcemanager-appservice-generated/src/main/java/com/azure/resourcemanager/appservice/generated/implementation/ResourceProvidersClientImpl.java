...
import com.azure.resourcemanager.appservice.generated.models.StaticSiteRegionCollection;
...
public final class ResourceProvidersClientImpl implements ResourceProvidersClient {
    ...
    public interface ResourceProvidersService {
        ...
        @Headers({ "Content-Type: application/json" })
        @Get("/subscriptions/{subscriptionId}/providers/Microsoft.Web/staticSiteRegions")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(DefaultErrorResponseErrorException.class)
        Mono<Response<StaticSiteRegionCollection>> listStaticSiteRegions(@HostParam("$host") String endpoint,
            @QueryParam("sku") SkuName sku, @PathParam("subscriptionId") String subscriptionId,
            @QueryParam("api-version") String apiVersion, @HeaderParam("Accept") String accept, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(DefaultErrorResponseErrorException.class)
        Mono<Response<StaticSiteRegionCollection>> listStaticSiteRegionsNext(
            @PathParam(value = "nextLink", encoded = true) String nextLink, @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept, Context context);
    }
    ...
    /**
     * Get a list of available Static Site regions.
     * 
     ...
     * @throws DefaultErrorResponseErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return collection of Static Site regions along with {@link PagedResponse} on successful completion of
     * {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<StaticSiteRegionInner>> listStaticSiteRegionsSinglePageAsync(SkuName sku) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.listStaticSiteRegions(this.client.getEndpoint(), sku,
                this.client.getSubscriptionId(), this.client.getApiVersion(), accept, context))
            .<PagedResponse<StaticSiteRegionInner>>map(res -> new PagedResponseBase<>(res.getRequest(),
                res.getStatusCode(), res.getHeaders(), res.getValue().value(), res.getValue().nextLink(), null))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<PagedResponse<StaticSiteRegionInner>> listStaticSiteRegionsSinglePageAsync(SkuName sku,
        ...
        context = this.client.mergeContext(context);
        return service
            .listStaticSiteRegions(this.client.getEndpoint(), sku, this.client.getSubscriptionId(),
                this.client.getApiVersion(), accept, context)
            .map(res -> new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(),
                res.getValue().value(), res.getValue().nextLink(), null));
    }
     ...
     * @throws DefaultErrorResponseErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return collection of Static Site regions as paginated response with {@link PagedFlux}.
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<StaticSiteRegionInner> listStaticSiteRegionsAsync(SkuName sku) {
        return new PagedFlux<>(() -> listStaticSiteRegionsSinglePageAsync(sku),
            nextLink -> listStaticSiteRegionsNextSinglePageAsync(nextLink));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<StaticSiteRegionInner> listStaticSiteRegionsAsync() {
        final SkuName sku = null;
        return new PagedFlux<>(() -> listStaticSiteRegionsSinglePageAsync(sku),
            nextLink -> listStaticSiteRegionsNextSinglePageAsync(nextLink));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<StaticSiteRegionInner> listStaticSiteRegionsAsync(SkuName sku, Context context) {
        return new PagedFlux<>(() -> listStaticSiteRegionsSinglePageAsync(sku, context),
            nextLink -> listStaticSiteRegionsNextSinglePageAsync(nextLink, context));
    }
     ...
     * @throws DefaultErrorResponseErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return collection of Static Site regions as paginated response with {@link PagedIterable}.
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<StaticSiteRegionInner> listStaticSiteRegions() {
        final SkuName sku = null;
        return new PagedIterable<>(listStaticSiteRegionsAsync(sku));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<StaticSiteRegionInner> listStaticSiteRegions(SkuName sku, Context context) {
        return new PagedIterable<>(listStaticSiteRegionsAsync(sku, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<StaticSiteRegionInner>> listStaticSiteRegionsNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        if (this.client.getEndpoint() == null) {
        ...
        return FluxUtil
            .withContext(
                context -> service.listStaticSiteRegionsNext(nextLink, this.client.getEndpoint(), accept, context))
            .<PagedResponse<StaticSiteRegionInner>>map(res -> new PagedResponseBase<>(res.getRequest(),
                res.getStatusCode(), res.getHeaders(), res.getValue().value(), res.getValue().nextLink(), null))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<PagedResponse<StaticSiteRegionInner>> listStaticSiteRegionsNextSinglePageAsync(String nextLink,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.listStaticSiteRegionsNext(nextLink, this.client.getEndpoint(), accept, context)
            .map(res -> new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(),
                res.getValue().value(), res.getValue().nextLink(), null));
    }
}
