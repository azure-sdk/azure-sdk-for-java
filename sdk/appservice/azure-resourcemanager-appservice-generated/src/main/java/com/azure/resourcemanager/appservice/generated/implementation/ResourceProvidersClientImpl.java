...
public final class ResourceProvidersClientImpl implements ResourceProvidersClient {
    ...
    public interface ResourceProvidersService {
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(DefaultErrorResponseErrorException.class)
        Mono<Response<CsmUsageQuotaCollectionInner>> getUsagesInLocation(
            @HostParam("$host") String endpoint,
        ...
        @Headers({"Content-Type: application/json"})
        @Get("/subscriptions/{subscriptionId}/providers/Microsoft.Web/locations/{location}/zoneRedundant/usages")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(DefaultErrorResponseErrorException.class)
        Mono<Response<CsmUsageQuotaCollectionInner>> getZoneRedundantUsagesInLocation(
            @HostParam("$host") String endpoint,
            @PathParam("location") String location,
            @PathParam("subscriptionId") String subscriptionId,
            @QueryParam("api-version") String apiVersion,
    ...
    /**
     * Gets subscription core usages for location.
     *
     * <p>Gets the usage in cores for a subscription in a given location.
     *
     * @param location The location for which to check usages.
     * @throws IllegalArgumentException thrown if parameters fail the validation.
     * @throws DefaultErrorResponseErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the usage in cores for a subscription in a given location along with {@link Response} on successful
     *     completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<CsmUsageQuotaCollectionInner>> getUsagesInLocationWithResponseAsync(String location) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<CsmUsageQuotaCollectionInner>> getUsagesInLocationWithResponseAsync(
     ...
     * @throws DefaultErrorResponseErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the usage in cores for a subscription in a given location on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<CsmUsageQuotaCollectionInner> getUsagesInLocationAsync(String location) {
        return getUsagesInLocationWithResponseAsync(location).flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     * @throws DefaultErrorResponseErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the usage in cores for a subscription in a given location along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<CsmUsageQuotaCollectionInner> getUsagesInLocationWithResponse(String location, Context context) {
        return getUsagesInLocationWithResponseAsync(location, context).block();
    }
     ...
     * @throws DefaultErrorResponseErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the usage in cores for a subscription in a given location.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public CsmUsageQuotaCollectionInner getUsagesInLocation(String location) {
        return getUsagesInLocationWithResponse(location, Context.NONE).getValue();
    }

    /**
     * Gets zone Redundant subscription core usages for location.
     *
     * <p>Gets the usage in cores for a subscription in a given location, with zone redundance.
     *
     * @param location The location for which to check ZR usages.
     * @throws IllegalArgumentException thrown if parameters fail the validation.
     * @throws DefaultErrorResponseErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the usage in cores for a subscription in a given location, with zone redundance along with {@link
     *     Response} on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<CsmUsageQuotaCollectionInner>> getZoneRedundantUsagesInLocationWithResponseAsync(
        String location) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
        ...
        return FluxUtil
            .withContext(
                context ->
                    service
                        .getZoneRedundantUsagesInLocation(
                            this.client.getEndpoint(),
                            location,
                            this.client.getSubscriptionId(),
                            this.client.getApiVersion(),
     ...
     * @throws DefaultErrorResponseErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the usage in cores for a subscription in a given location, with zone redundance on successful completion
     *     of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<CsmUsageQuotaCollectionInner> getZoneRedundantUsagesInLocationAsync(String location) {
        return getZoneRedundantUsagesInLocationWithResponseAsync(location)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<CsmUsageQuotaCollectionInner> getZoneRedundantUsagesInLocationWithResponse(
        String location, Context context) {
        return getZoneRedundantUsagesInLocationWithResponseAsync(location, context).block();
    }
     ...
     * @throws DefaultErrorResponseErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the usage in cores for a subscription in a given location, with zone redundance.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public CsmUsageQuotaCollectionInner getZoneRedundantUsagesInLocation(String location) {
        return getZoneRedundantUsagesInLocationWithResponse(location, Context.NONE).getValue();
    }
