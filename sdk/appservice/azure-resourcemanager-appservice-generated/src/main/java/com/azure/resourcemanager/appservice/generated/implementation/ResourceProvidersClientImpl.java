...
public final class ResourceProvidersClientImpl implements ResourceProvidersClient {
    ...
    public interface ResourceProvidersService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(DefaultErrorResponseErrorException.class)
        Mono<Response<String>> purgeUnusedVirtualNetworkIntegrations(@HostParam("$host") String endpoint,
            @PathParam("location") String location, @PathParam("subscriptionId") String subscriptionId,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") VirtualNetworkIntegrationRequest request,
            @HeaderParam("Accept") String accept, Context context);
    ...
    /**
     * Delete orphaned (unused) VNET
     * 
     * Delete orphaned (unused) VNET, otherwise fail the call if there are sites that are still using the VNET.
     * 
     * @param location The name of the Azure region.
     * @param request Object contains the subnetResourceId.
     * @throws IllegalArgumentException thrown if parameters fail the validation.
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<String>> purgeUnusedVirtualNetworkIntegrationsWithResponseAsync(String location,
        VirtualNetworkIntegrationRequest request) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<String> purgeUnusedVirtualNetworkIntegrationsAsync(String location,
        VirtualNetworkIntegrationRequest request) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<String> purgeUnusedVirtualNetworkIntegrationsWithResponse(String location,
        VirtualNetworkIntegrationRequest request, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public String purgeUnusedVirtualNetworkIntegrations(String location, VirtualNetworkIntegrationRequest request) {
