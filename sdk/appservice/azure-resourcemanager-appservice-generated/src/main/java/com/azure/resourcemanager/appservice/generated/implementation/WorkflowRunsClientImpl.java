...
import com.azure.resourcemanager.appservice.generated.models.WorkflowRunListResult;
...
public final class WorkflowRunsClientImpl implements WorkflowRunsClient {
     ...
     */
    WorkflowRunsClientImpl(WebSiteManagementClientImpl client) {
        this.service =
    ...
    private Mono<Void> cancelAsync(String resourceGroupName, String name, String workflowName, String runName) {
        return cancelWithResponseAsync(resourceGroupName, name, workflowName, runName)
