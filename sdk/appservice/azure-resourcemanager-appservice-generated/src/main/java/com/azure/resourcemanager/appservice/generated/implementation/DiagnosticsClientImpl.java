...
public final class DiagnosticsClientImpl implements DiagnosticsClient {
    ...
    public interface DiagnosticsService {
        ...
        @Get("/subscriptions/{subscriptionId}/providers/Microsoft.Web/locations/{location}/detectors")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(DefaultErrorResponseErrorException.class)
        Mono<Response<DetectorResponseCollection>> listProviderDetectorResponses(
        ...
        @Headers({"Content-Type: application/json"})
        @Get("/subscriptions/{subscriptionId}/providers/Microsoft.Web/locations/{location}/detectors/{detectorName}")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(DefaultErrorResponseErrorException.class)
        Mono<Response<DetectorResponseInner>> getProviderDetectorResponse(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("location") String location,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(DefaultErrorResponseErrorException.class)
        Mono<Response<DetectorResponseCollection>> listProviderDetectorResponsesNext(
    ...
    /**
     * List Provider Detector Responses
     *
     * <p>List Detector responses applicable for the provider.
     *
    ...
    private Mono<PagedResponse<DetectorResponseInner>> listProviderDetectorResponsesSinglePageAsync(
    ...
    private PagedFlux<DetectorResponseInner> listProviderDetectorResponsesAsync(String location, String resourceType) {
        return new PagedFlux<>(
            () -> listProviderDetectorResponsesSinglePageAsync(location, resourceType),
            nextLink -> listProviderDetectorResponsesNextSinglePageAsync(nextLink));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<DetectorResponseInner> listProviderDetectorResponsesAsync(
        String location, String resourceType, Context context) {
        return new PagedFlux<>(
            () -> listProviderDetectorResponsesSinglePageAsync(location, resourceType, context),
            nextLink -> listProviderDetectorResponsesNextSinglePageAsync(nextLink, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<DetectorResponseInner> listProviderDetectorResponses(String location, String resourceType) {
        return new PagedIterable<>(listProviderDetectorResponsesAsync(location, resourceType));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<DetectorResponseInner> listProviderDetectorResponses(
        String location, String resourceType, Context context) {
        return new PagedIterable<>(listProviderDetectorResponsesAsync(location, resourceType, context));
    }

    /**
     * Get Provider Detector Response
     *
     * <p>Get Detector response for the provider.
     *
     * @param location The name of a supported Azure region.
     ...
     * @throws DefaultErrorResponseErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return detector response for the provider along with {@link Response} on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<DetectorResponseInner>> getProviderDetectorResponseWithResponseAsync(
        String location,
        String detectorName,
        String resourceType,
     ...
     * @throws DefaultErrorResponseErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return detector response for the provider on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DetectorResponseInner> getProviderDetectorResponseAsync(
        String location, String detectorName, String resourceType) {
        final OffsetDateTime startTime = null;
        final OffsetDateTime endTime = null;
        final String timeGrain = null;
        return getProviderDetectorResponseWithResponseAsync(
                location, detectorName, resourceType, startTime, endTime, timeGrain)
     ...
     * @throws DefaultErrorResponseErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return detector response for the provider along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<DetectorResponseInner> getProviderDetectorResponseWithResponse(
        String location,
        String detectorName,
        String resourceType,
        OffsetDateTime startTime,
        ...
        Context context) {
        return getProviderDetectorResponseWithResponseAsync(
                location, detectorName, resourceType, startTime, endTime, timeGrain, context)
            .block();
    }
     ...
     * @throws DefaultErrorResponseErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return detector response for the provider.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public DetectorResponseInner getProviderDetectorResponse(
        String location, String detectorName, String resourceType) {
        final OffsetDateTime startTime = null;
        final OffsetDateTime endTime = null;
        final String timeGrain = null;
        return getProviderDetectorResponseWithResponse(
                location, detectorName, resourceType, startTime, endTime, timeGrain, Context.NONE)
            .getValue();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DetectorResponseInner> getHostingEnvironmentDetectorResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DetectorResponseInner> getSiteDetectorResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DiagnosticCategoryInner> getSiteDiagnosticCategoryAsync(
        String resourceGroupName, String siteName, String diagnosticCategory) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<AnalysisDefinitionInner> getSiteAnalysisAsync(
        String resourceGroupName, String siteName, String diagnosticCategory, String analysisName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DiagnosticAnalysisInner> executeSiteAnalysisAsync(
        String resourceGroupName, String siteName, String diagnosticCategory, String analysisName) {
        final OffsetDateTime startTime = null;
        final OffsetDateTime endTime = null;
        final String timeGrain = null;
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DetectorDefinitionResourceInner> getSiteDetectorAsync(
        String resourceGroupName, String siteName, String diagnosticCategory, String detectorName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DiagnosticDetectorResponseInner> executeSiteDetectorAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DetectorResponseInner> getSiteDetectorResponseSlotAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DiagnosticCategoryInner> getSiteDiagnosticCategorySlotAsync(
        String resourceGroupName, String siteName, String diagnosticCategory, String slot) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<AnalysisDefinitionInner> getSiteAnalysisSlotAsync(
        String resourceGroupName, String siteName, String diagnosticCategory, String analysisName, String slot) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DiagnosticAnalysisInner> executeSiteAnalysisSlotAsync(
        String resourceGroupName, String siteName, String diagnosticCategory, String analysisName, String slot) {
        final OffsetDateTime startTime = null;
        final OffsetDateTime endTime = null;
        final String timeGrain = null;
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DetectorDefinitionResourceInner> getSiteDetectorSlotAsync(
        String resourceGroupName, String siteName, String diagnosticCategory, String detectorName, String slot) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DiagnosticDetectorResponseInner> executeSiteDetectorSlotAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<DetectorResponseInner>> listProviderDetectorResponsesNextSinglePageAsync(
        String nextLink) {
        if (nextLink == null) {
        ...
        return FluxUtil
            .withContext(
                context ->
                    service.listProviderDetectorResponsesNext(nextLink, this.client.getEndpoint(), accept, context))
            .<PagedResponse<DetectorResponseInner>>map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(),
    ...
    private Mono<PagedResponse<DetectorResponseInner>> listProviderDetectorResponsesNextSinglePageAsync(
        ...
        context = this.client.mergeContext(context);
        return service
            .listProviderDetectorResponsesNext(nextLink, this.client.getEndpoint(), accept, context)
            .map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(),
