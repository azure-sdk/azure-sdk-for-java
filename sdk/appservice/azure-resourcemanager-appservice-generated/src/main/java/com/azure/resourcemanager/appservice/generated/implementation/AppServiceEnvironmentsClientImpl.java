...
public final class AppServiceEnvironmentsClientImpl implements AppServiceEnvironmentsClient {
    ...
    private interface AppServiceEnvironmentsService {
        ...
        @Post(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web"
                + "/hostingEnvironments/{name}/migrate")
        @ExpectedResponses({200, 202})
        @UnexpectedResponseExceptionType(DefaultErrorResponseErrorException.class)
        Mono<Response<Object>> migrate(
            @HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("name") String name,
            ...
            @PathParam("subscriptionId") String subscriptionId,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") AseMigrationOptions migrationOptionsEnvelope,
            @HeaderParam("Accept") String accept,
            Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<AseV3NetworkingConfigurationInner> updateAseNetworkingConfigurationAsync(
        String resourceGroupName, String name, AseV3NetworkingConfigurationInner aseNetworkingConfiguration) {
     ...
     * @param resourceGroupName Name of the resource group to which the resource belongs.
     * @param name Name of the App Service Environment.
     * @param phase Specify &lt;code&gt;Validation&lt;/code&gt; to validate, &lt;code&gt;PreMigration&lt;/code&gt; to
     *     generate new IP addresses and &lt;code&gt;FullMigration&lt;/code&gt; to migrate the ASE.
     * @param migrationOptionsEnvelope Additional options and configurations that will be applied to the App Service
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Object>> migrateWithResponseAsync(
        String resourceGroupName, String name, String phase, AseMigrationOptions migrationOptionsEnvelope) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
        ...
        if (phase == null) {
            return Mono.error(new IllegalArgumentException("Parameter phase is required and cannot be null."));
        }
        if (this.client.getSubscriptionId() == null) {
            return Mono
                .error(
        ...
        if (migrationOptionsEnvelope == null) {
            return Mono
                .error(
                    new IllegalArgumentException("Parameter migrationOptionsEnvelope is required and cannot be null."));
        } else {
            migrationOptionsEnvelope.validate();
        }
        final String accept = "application/json";
        return FluxUtil
            .withContext(
    ...
    private Mono<Response<Object>> migrateWithResponseAsync(
        ...
        String name,
        String phase,
        AseMigrationOptions migrationOptionsEnvelope,
        Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Object> migrateAsync(
        String resourceGroupName, String name, String phase, AseMigrationOptions migrationOptionsEnvelope) {
        return migrateWithResponseAsync(resourceGroupName, name, phase, migrationOptionsEnvelope)
            .flatMap(
                (Response<Object> res) -> {
                    if (res.getValue() != null) {
                        return Mono.just(res.getValue());
    ...
    public Object migrate(
        String resourceGroupName, String name, String phase, AseMigrationOptions migrationOptionsEnvelope) {
        return migrateAsync(resourceGroupName, name, phase, migrationOptionsEnvelope).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<Object> migrateWithResponse(
        String resourceGroupName,
        String name,
        String phase,
        AseMigrationOptions migrationOptionsEnvelope,
        Context context) {
        return migrateWithResponseAsync(resourceGroupName, name, phase, migrationOptionsEnvelope, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<WorkerPoolResourceInner> updateMultiRolePoolAsync(
        String resourceGroupName, String name, WorkerPoolResourceInner multiRolePoolEnvelope) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<WorkerPoolResourceInner> updateWorkerPoolAsync(
        String resourceGroupName, String name, String workerPoolName, WorkerPoolResourceInner workerPoolEnvelope) {
