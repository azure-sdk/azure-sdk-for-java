...
public final class AppServiceEnvironmentsClientImpl implements AppServiceEnvironmentsClient {
    ...
    private interface AppServiceEnvironmentsService {
        ...
        @Post(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web"
                + "/hostingEnvironments/{name}/testUpgradeNotification")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(DefaultErrorResponseErrorException.class)
        Mono<Response<Void>> testUpgradeNotification(
            @HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("name") String name,
            @PathParam("subscriptionId") String subscriptionId,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Void>> testUpgradeNotificationWithResponseAsync(String resourceGroupName, String name) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Void>> testUpgradeNotificationWithResponseAsync(
        String resourceGroupName, String name, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> testUpgradeNotificationAsync(String resourceGroupName, String name) {
        return testUpgradeNotificationWithResponseAsync(resourceGroupName, name).flatMap(ignored -> Mono.empty());
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public void testUpgradeNotification(String resourceGroupName, String name) {
        testUpgradeNotificationAsync(resourceGroupName, name).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<Void> testUpgradeNotificationWithResponse(String resourceGroupName, String name, Context context) {
        return testUpgradeNotificationWithResponseAsync(resourceGroupName, name, context).block();
    }
