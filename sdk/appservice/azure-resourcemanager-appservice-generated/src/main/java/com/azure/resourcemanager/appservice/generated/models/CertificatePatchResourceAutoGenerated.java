...
import com.azure.resourcemanager.appservice.generated.fluent.models.CertificatePatchResourcePropertiesAutoGenerated;
 ...
 */
@Fluent
public final class CertificatePatchResourceAutoGenerated extends ProxyOnlyResource {
    private static final byte[] EMPTY_BYTE_ARRAY = new byte[0];

    /*
     * CertificatePatchResource resource specific properties
     */
    private CertificatePatchResourcePropertiesAutoGenerated innerProperties;
    ...
    /**
     * Creates an instance of CertificatePatchResourceAutoGenerated class.
     */
    public CertificatePatchResourceAutoGenerated() {
    }
     ...
     */
    @Override
    public CertificatePatchResourceAutoGenerated withKind(String kind) {
        super.withKind(kind);
        return this;
    }
     ...
     * @return the CertificatePatchResourceAutoGenerated object itself.
     */
    public CertificatePatchResourceAutoGenerated withPassword(String password) {
        if (this.innerProperties() == null) {
            this.innerProperties = new CertificatePatchResourcePropertiesAutoGenerated();
        }
     ...
     * @return the CertificatePatchResourceAutoGenerated object itself.
     */
    public CertificatePatchResourceAutoGenerated withHostNames(List<String> hostNames) {
        if (this.innerProperties() == null) {
            this.innerProperties = new CertificatePatchResourcePropertiesAutoGenerated();
        }
     ...
     * @return the CertificatePatchResourceAutoGenerated object itself.
     */
    public CertificatePatchResourceAutoGenerated withPfxBlob(byte[] pfxBlob) {
        if (this.innerProperties() == null) {
            this.innerProperties = new CertificatePatchResourcePropertiesAutoGenerated();
        }
     ...
     * @return the CertificatePatchResourceAutoGenerated object itself.
     */
    public CertificatePatchResourceAutoGenerated withKeyVaultId(String keyVaultId) {
        if (this.innerProperties() == null) {
            this.innerProperties = new CertificatePatchResourcePropertiesAutoGenerated();
        }
     ...
     * @return the CertificatePatchResourceAutoGenerated object itself.
     */
    public CertificatePatchResourceAutoGenerated withKeyVaultSecretName(String keyVaultSecretName) {
        if (this.innerProperties() == null) {
            this.innerProperties = new CertificatePatchResourcePropertiesAutoGenerated();
        }
     ...
     * @return the CertificatePatchResourceAutoGenerated object itself.
     */
    public CertificatePatchResourceAutoGenerated withServerFarmId(String serverFarmId) {
        if (this.innerProperties() == null) {
            this.innerProperties = new CertificatePatchResourcePropertiesAutoGenerated();
        }
     ...
     * @return the CertificatePatchResourceAutoGenerated object itself.
     */
    public CertificatePatchResourceAutoGenerated withCanonicalName(String canonicalName) {
        if (this.innerProperties() == null) {
            this.innerProperties = new CertificatePatchResourcePropertiesAutoGenerated();
        }
     ...
     * @return the CertificatePatchResourceAutoGenerated object itself.
     */
    public CertificatePatchResourceAutoGenerated withDomainValidationMethod(String domainValidationMethod) {
        if (this.innerProperties() == null) {
            this.innerProperties = new CertificatePatchResourcePropertiesAutoGenerated();
        }
    ...
    /**
     * Reads an instance of CertificatePatchResourceAutoGenerated from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of CertificatePatchResourceAutoGenerated if the JsonReader was pointing to an instance of it,
     * or null if it was pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the CertificatePatchResourceAutoGenerated.
     */
    public static CertificatePatchResourceAutoGenerated fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            CertificatePatchResourceAutoGenerated deserializedCertificatePatchResourceAutoGenerated
                = new CertificatePatchResourceAutoGenerated();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("id".equals(fieldName)) {
                    deserializedCertificatePatchResourceAutoGenerated.id = reader.getString();
                } else if ("name".equals(fieldName)) {
                    deserializedCertificatePatchResourceAutoGenerated.name = reader.getString();
                } else if ("type".equals(fieldName)) {
                    deserializedCertificatePatchResourceAutoGenerated.type = reader.getString();
                } else if ("kind".equals(fieldName)) {
                    deserializedCertificatePatchResourceAutoGenerated.withKind(reader.getString());
                } else if ("properties".equals(fieldName)) {
                    deserializedCertificatePatchResourceAutoGenerated.innerProperties
                        = CertificatePatchResourcePropertiesAutoGenerated.fromJson(reader);
                } else {
                    reader.skipChildren();
                }
            }

            return deserializedCertificatePatchResourceAutoGenerated;
        });
    }
}
