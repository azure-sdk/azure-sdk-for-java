...
public final class AppServiceEnvironmentResourceImpl
    ...
    public void testUpgradeNotification() {
        serviceManager.appServiceEnvironments().testUpgradeNotification(resourceGroupName, name);
    }

    public Response<Void> testUpgradeNotificationWithResponse(Context context) {
        return serviceManager
            .appServiceEnvironments()
            .testUpgradeNotificationWithResponse(resourceGroupName, name, context);
    }
