...
- [GetUsagesInLocation](#resourceprovider_getusagesinlocation)
- [GetZoneRedundantUsagesInLocation](#resourceprovider_getzoneredundantusagesinlocation)
    ...
    public static void getDomainOwnershipIdentifier(
        ...
        manager
            ...
            .getOwnershipIdentifierWithResponse(
                "testrg123", "example.com", "SampleOwnershipId", com.azure.core.util.Context.NONE);
    }
}
```
        ...
        manager
            ...
            .listRecommendations(
                new DomainRecommendationSearchParameters()
                    .withKeywords("fakeTokenPlaceholder")
                    .withMaxDomainRecommendations(10),
                com.azure.core.util.Context.NONE);
    }
}
```
...
### ResourceProvider_GetUsagesInLocation
...
### ResourceProvider_GetZoneRedundantUsagesInLocation
    ...
    public static void listFullDetailsOfDatabaseConnectionsForTheStaticSiteBuild(
        ...
        manager
            ...
            .getBuildDatabaseConnectionsWithDetails(
                "rg", "testStaticSite0", "default", com.azure.core.util.Context.NONE);
    }
}
```
    ...
    public static void getDetailsOfTheLinkedBackendRegisteredWithAStaticSiteBuildByName(
        ...
        manager
            ...
            .getLinkedBackendForBuildWithResponse(
                "rg", "testStaticSite0", "default", "testBackend", com.azure.core.util.Context.NONE);
    }
}
```
    ...
    public static void unlinkABackendFromAStaticSiteBuild(
        ...
        manager
            ...
            .unlinkBackendFromBuildWithResponse(
                "rg", "testStaticSite0", "12", "testBackend", null, com.azure.core.util.Context.NONE);
    }
}
```
...
public final class WebAppsAnalyzeCustomHostnameSamples {
     ...
     * @param manager Entry point to AppServiceManager.
     */
    public static void analyzeCustomHostnameForWebapp(
        com.azure.resourcemanager.appservice.generated.AppServiceManager manager) {
        manager
            .webApps()
    ...
    public static void analyzeCustomHostnameForSlot(
        ...
        manager
            ...
            .analyzeCustomHostnameSlotWithResponse(
                "testrg123", "sitef6141", "staging", null, com.azure.core.util.Context.NONE);
    }
}
```
    ...
    public static void applyWebAppSlotConfig(com.azure.resourcemanager.appservice.generated.AppServiceManager manager) {
        manager
            ...
            .applySlotConfigToProductionWithResponse(
                "testrg123",
                "sitef6141",
                new CsmSlotEntity().withTargetSlot("staging").withPreserveVnet(true),
                com.azure.core.util.Context.NONE);
    }
}
```
...
public final class WebAppsDeployWorkflowArtifactsSamples {
     ...
     * @param manager Entry point to AppServiceManager.
     */
    public static void deleteWorkflowArtifacts(
        com.azure.resourcemanager.appservice.generated.AppServiceManager manager) {
        manager
            .webApps()
            .deployWorkflowArtifactsWithResponse(
...
public final class WebAppsGetAuthSettingsV2WithoutSecretsSamples {
     ...
     * @param manager Entry point to AppServiceManager.
     */
    public static void listAuthSettingsWithoutSecrets(
        com.azure.resourcemanager.appservice.generated.AppServiceManager manager) {
        manager
            .webApps()
    ...
    public static void getDeploymentStatus(com.azure.resourcemanager.appservice.generated.AppServiceManager manager) {
        manager
            ...
            .getProductionSiteDeploymentStatus(
                "rg", "testSite", "eacfd68b-3bbd-4ad9-99c5-98614d89c8e5", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class WebAppsListSamples {
     ...
     * @param manager Entry point to AppServiceManager.
     */
    public static void listWebAppsForSubscription(
        com.azure.resourcemanager.appservice.generated.AppServiceManager manager) {
...
public final class WebAppsListBackupStatusSecretsSamples {
     ...
     * @param manager Entry point to AppServiceManager.
     */
    public static void getWebAppBackupWithSecrets(
        com.azure.resourcemanager.appservice.generated.AppServiceManager manager) {
        manager
            .webApps()
    ...
    public static void listPublishingCredentialsPolicies(
        ...
        manager
            ...
            .listBasicPublishingCredentialsPoliciesSlot(
                "testrg123", "testsite", "staging", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class WebAppsListByResourceGroupSamples {
     ...
     * @param manager Entry point to AppServiceManager.
     */
    public static void listWebAppsByResourceGroup(
        com.azure.resourcemanager.appservice.generated.AppServiceManager manager) {
...
public final class WebAppsListConfigurationsSamples {
     ...
     * @param manager Entry point to AppServiceManager.
     */
    public static void listWebAppConfigurations(
        com.azure.resourcemanager.appservice.generated.AppServiceManager manager) {
    ...
    public static void listTheInstanceWorkflowsConfigurationConnectionsSlot(
        ...
        manager
            ...
            .listWorkflowsConnectionsSlotWithResponse(
                "testrg123", "testsite2", "staging", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class WebAppsRestoreSamples {
     ...
     * @param manager Entry point to AppServiceManager.
     */
    public static void restoreWebAppFromBackup(
        com.azure.resourcemanager.appservice.generated.AppServiceManager manager) {
        manager
            .webApps()
            .restore(
        ...
        manager
            ...
            .updateAuthSettingsV2WithResponse(
                ...
                new SiteAuthSettingsV2Inner()
                    ...
                    .withLogin(
                        new Login()
                            .withRoutes(new LoginRoutes().withLogoutEndpoint("https://app.com/logout"))
                            .withTokenStore(
                                new TokenStore()
                                    .withEnabled(true)
...
public final class WebAppsUpdateAzureStorageAccountsSamples {
     ...
     * @param manager Entry point to AppServiceManager.
     */
    public static void updateAzureStorageAccounts(
        com.azure.resourcemanager.appservice.generated.AppServiceManager manager) {
        manager
            .webApps()
...
public final class WorkflowRunActionRepetitionsListExpressionTracesSamples {
     ...
     * @param manager Entry point to AppServiceManager.
     */
    public static void listExpressionTracesForARepetition(
        com.azure.resourcemanager.appservice.generated.AppServiceManager manager) {
        manager
            .workflowRunActionRepetitions()
...
public final class WorkflowRunActionRepetitionsRequestHistoriesGetSamples {
     ...
     * @param manager Entry point to AppServiceManager.
     */
    public static void getARepetitionRequestHistory(
        com.azure.resourcemanager.appservice.generated.AppServiceManager manager) {
        manager
            .workflowRunActionRepetitionsRequestHistories()
            .getWithResponse(
...
public final class WorkflowRunActionRepetitionsRequestHistoriesListSamples {
     ...
     * @param manager Entry point to AppServiceManager.
     */
    public static void listRepetitionRequestHistory(
        com.azure.resourcemanager.appservice.generated.AppServiceManager manager) {
        manager
            .workflowRunActionRepetitionsRequestHistories()
            .list(
...
public final class WorkflowRunActionsListSamples {
     ...
     * @param manager Entry point to AppServiceManager.
     */
    public static void listAWorkflowRunActions(
        com.azure.resourcemanager.appservice.generated.AppServiceManager manager) {
        manager
            .workflowRunActions()
            .list(
...
public final class WorkflowTriggerHistoriesGetSamples {
     ...
     * @param manager Entry point to AppServiceManager.
     */
    public static void getAWorkflowTriggerHistory(
        com.azure.resourcemanager.appservice.generated.AppServiceManager manager) {
        manager
            .workflowTriggerHistories()
            .getWithResponse(
...
public final class WorkflowTriggerHistoriesListSamples {
     ...
     * @param manager Entry point to AppServiceManager.
     */
    public static void listAWorkflowTriggerHistory(
        com.azure.resourcemanager.appservice.generated.AppServiceManager manager) {
        manager
            .workflowTriggerHistories()
            .list(
...
public final class WorkflowVersionsListSamples {
     ...
     * @param manager Entry point to AppServiceManager.
     */
    public static void listAWorkflowsVersions(
        com.azure.resourcemanager.appservice.generated.AppServiceManager manager) {
        manager
            .workflowVersions()
