    ...
    public static void listTheInstanceWorkflowsConfigurationConnectionsSlot(
        ...
        manager
            ...
            .listInstanceWorkflowsConfigurationConnectionsSlotWithResponse(
                "testrg123", "testsite2", "staging", "connections", Context.NONE);
    }
}
```
...
public final class WebAppsListWorkflowsConfigurationSamples {
    ...
    public static void listTheInstanceWorkflowsConfigurationConnections(
        com.azure.resourcemanager.appservice.generated.AppServiceManager manager) {
        manager.webApps().listWorkflowsConfigurationWithResponse("testrg123", "testsite2", "connections", Context.NONE);
    }
}
```
