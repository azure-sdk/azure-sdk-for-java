...
- [GetProviderDetectorResponse](#diagnostics_getproviderdetectorresponse)
...
- [ListProviderDetectorResponses](#diagnostics_listproviderdetectorresponses)
...
### Diagnostics_GetProviderDetectorResponse
...
### Diagnostics_ListProviderDetectorResponses
...
public final class WorkflowTriggersRunSamples {
    ...
    public static void runAWorkflowTrigger(com.azure.resourcemanager.appservice.generated.AppServiceManager manager) {
        manager.workflowTriggers().run("test-resource-group", "test-name", "test-workflow", "manual", Context.NONE);
    }
}
```
