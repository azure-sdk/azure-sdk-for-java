...
public final class WebAppsUpdateApplicationSettingsSamples {
    ...
    public static void updateAppSettings(com.azure.resourcemanager.appservice.generated.AppServiceManager manager) {
        manager.webApps().updateApplicationSettingsWithResponse("testrg123", "sitef6141", new StringDictionaryInner().withProperties(mapOf("Setting1", "Value1", "Setting2", "Value2")), com.azure.core.util.Context.NONE);
    }
