...
- [PurgeStaticSite](#staticsites_purgestaticsite)
- [PurgeStaticSiteBuild](#staticsites_purgestaticsitebuild)
...
public final class StaticSitesApproveOrRejectPrivateEndpointConnectionSamples {
    ...
    public static void approvesOrRejectsAPrivateEndpointConnectionForASite(com.azure.resourcemanager.appservice.generated.AppServiceManager manager) {
        manager.staticSites().approveOrRejectPrivateEndpointConnection("rg", "testSite", "connection", new RemotePrivateEndpointConnectionArmResourceInner().withPrivateLinkServiceConnectionState(new PrivateLinkConnectionState().withStatus("Approved").withDescription("Approved by admin.").withActionsRequired("")), com.azure.core.util.Context.NONE);
    }
}
```
...
public final class StaticSitesPurgeStaticSiteSamples {
    /*
     * x-ms-original-file: specification/web/resource-manager/Microsoft.Web/stable/2023-01-01/examples/PurgeStaticSite.json
     */
    /**
...
### StaticSites_PurgeStaticSiteBuild
...
public final class StaticSitesPurgeStaticSiteBuildSamples {
    /*
     * x-ms-original-file: specification/web/resource-manager/Microsoft.Web/stable/2023-01-01/examples/PurgeStaticSiteBuild.json
     */
    /**
    ...
    public static void purgeAStaticSiteBuild(com.azure.resourcemanager.appservice.generated.AppServiceManager manager) {
        manager.staticSites().purgeStaticSiteBuild("rg", "testStaticSite0", "12", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class WebAppsApproveOrRejectPrivateEndpointConnectionSamples {
     ...
     */
    public static void approvesOrRejectsAPrivateEndpointConnectionForASite(com.azure.resourcemanager.appservice.generated.AppServiceManager manager) {
        manager.webApps().approveOrRejectPrivateEndpointConnection("rg", "testSite", "connection", new RemotePrivateEndpointConnectionArmResourceInner().withPrivateLinkServiceConnectionState(new PrivateLinkConnectionState().withStatus("Approved").withDescription("Approved by admin.").withActionsRequired("")), com.azure.core.util.Context.NONE);
    }
}
```
...
public final class WebAppsApproveOrRejectPrivateEndpointConnectionSlotSamples {
     ...
     */
    public static void approvesOrRejectsAPrivateEndpointConnectionForASite(com.azure.resourcemanager.appservice.generated.AppServiceManager manager) {
        manager.webApps().approveOrRejectPrivateEndpointConnectionSlot("rg", "testSite", "connection", "stage", new RemotePrivateEndpointConnectionArmResourceInner().withPrivateLinkServiceConnectionState(new PrivateLinkConnectionState().withStatus("Approved").withDescription("Approved by admin.").withActionsRequired("")), com.azure.core.util.Context.NONE);
    }
}
```
