...
public final class ManagedEnvironmentsStoragesCreateOrUpdateSamples {
    ...
    public static void createOrUpdateEnvironmentsStorageForNFSAzureFile(
        ...
        manager.managedEnvironmentsStorages().define("jlaw-demo1")
            .withExistingManagedEnvironment("examplerg", "managedEnv").withNfsAzureFile(new NfsAzureFileProperties()
    ...
    public static void
        ...
        manager.managedEnvironmentsStorages().define("jlaw-demo1")
            ...
            .withAzureFile(new AzureFileProperties().withAccountName("account1").withAccountKey("fakeTokenPlaceholder")
