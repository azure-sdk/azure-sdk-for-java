        ...
        if (location() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property location in model ManagedCertificateInner"));
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(ManagedCertificateInner.class);
