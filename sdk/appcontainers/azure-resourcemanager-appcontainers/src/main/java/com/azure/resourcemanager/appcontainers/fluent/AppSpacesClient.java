...
public interface AppSpacesClient {
    ...
    Response<AppSpaceInner> getByResourceGroupWithResponse(String resourceGroupName, String appSpaceName,
        Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<AppSpaceInner> createOrUpdateWithResponse(String resourceGroupName, String appSpaceName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<AppSpaceInner> updateWithResponse(String resourceGroupName, String appSpaceName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    AppSpaceInner update(String resourceGroupName, String appSpaceName, AppSpacePatch appSpaceEnvelope);
}
