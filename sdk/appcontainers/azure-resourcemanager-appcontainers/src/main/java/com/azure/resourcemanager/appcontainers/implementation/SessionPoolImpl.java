...
import com.azure.resourcemanager.appcontainers.models.ManagedServiceIdentityUpdate;
...
public final class SessionPoolImpl implements SessionPool, SessionPool.Definition, SessionPool.Update {
    ...
    public SessionPoolImpl withIdentity(ManagedServiceIdentityAutoGenerated identity) {
    ...
    public SessionPoolImpl withIdentity(ManagedServiceIdentityUpdate identity) {
