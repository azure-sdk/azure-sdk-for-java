...
public final class ContainerAppsSourceControlsClientImpl implements ContainerAppsSourceControlsClient {
    ...
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String resourceGroupName,
        ...
        if (xMsGithubAuxiliary == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter xMsGithubAuxiliary is required and cannot be null."));
        }
    ...
    private PollerFlux<PollResult<SourceControlInner>, SourceControlInner> beginCreateOrUpdateAsync(
        String resourceGroupName, String containerAppName, String sourceControlName, String xMsGithubAuxiliary,
        SourceControlInner sourceControlEnvelope) {
        Mono<Response<Flux<ByteBuffer>>> mono = createOrUpdateWithResponseAsync(resourceGroupName, containerAppName,
            sourceControlName, xMsGithubAuxiliary, sourceControlEnvelope);
    ...
    private PollerFlux<PollResult<SourceControlInner>, SourceControlInner> beginCreateOrUpdateAsync(
        ...
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono = createOrUpdateWithResponseAsync(resourceGroupName, containerAppName,
            sourceControlName, xMsGithubAuxiliary, sourceControlEnvelope, context);
        return this.client.<SourceControlInner, SourceControlInner>getLroResult(mono, this.client.getHttpPipeline(),
    ...
    public SyncPoller<PollResult<SourceControlInner>, SourceControlInner> beginCreateOrUpdate(String resourceGroupName,
        ...
        SourceControlInner sourceControlEnvelope) {
        return this
            .beginCreateOrUpdateAsync(resourceGroupName, containerAppName, sourceControlName, xMsGithubAuxiliary,
    ...
    private Mono<SourceControlInner> createOrUpdateAsync(String resourceGroupName, String containerAppName,
        String sourceControlName, String xMsGithubAuxiliary, SourceControlInner sourceControlEnvelope) {
        return beginCreateOrUpdateAsync(resourceGroupName, containerAppName, sourceControlName, xMsGithubAuxiliary,
            sourceControlEnvelope).last().flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<SourceControlInner> createOrUpdateAsync(String resourceGroupName, String containerAppName,
        ...
        Context context) {
        return beginCreateOrUpdateAsync(resourceGroupName, containerAppName, sourceControlName, xMsGithubAuxiliary,
            sourceControlEnvelope, context).last().flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    public SourceControlInner createOrUpdate(String resourceGroupName, String containerAppName,
        String sourceControlName, String xMsGithubAuxiliary, SourceControlInner sourceControlEnvelope) {
        return createOrUpdateAsync(resourceGroupName, containerAppName, sourceControlName, xMsGithubAuxiliary,
            sourceControlEnvelope).block();
    }
    ...
    public SourceControlInner createOrUpdate(String resourceGroupName, String containerAppName,
        ...
        Context context) {
        return createOrUpdateAsync(resourceGroupName, containerAppName, sourceControlName, xMsGithubAuxiliary,
            sourceControlEnvelope, context).block();
    }
