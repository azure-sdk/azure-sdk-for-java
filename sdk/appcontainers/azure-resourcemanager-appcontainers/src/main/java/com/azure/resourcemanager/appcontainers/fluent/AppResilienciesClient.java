...
public interface AppResilienciesClient {
    ...
    Response<AppResiliencyInner> createOrUpdateWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    AppResiliencyInner createOrUpdate(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<AppResiliencyInner> patchWithResponse(
        String resourceGroupName, String appName, String name, AppResiliencyInner resiliencyEnvelope, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<AppResiliencyInner> getWithResponse(
