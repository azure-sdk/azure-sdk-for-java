...
public final class MaintenanceConfigurationsImpl implements MaintenanceConfigurations {
    ...
    public PagedIterable<MaintenanceConfigurationResource> listByManagedEnvironmentResource(String resourceGroupName,
        String environmentName) {
        PagedIterable<MaintenanceConfigurationResourceInner> inner
            = this.serviceClient().listByManagedEnvironmentResource(resourceGroupName, environmentName);
    ...
    public PagedIterable<MaintenanceConfigurationResource> listByManagedEnvironmentResource(String resourceGroupName,
        ...
        PagedIterable<MaintenanceConfigurationResourceInner> inner
            = this.serviceClient().listByManagedEnvironmentResource(resourceGroupName, environmentName, context);
        return ResourceManagerUtils.mapPage(inner,
            inner1 -> new MaintenanceConfigurationResourceImpl(inner1, this.manager()));
    }
    ...
    public MaintenanceConfigurationResource getById(String id) {
        ...
        String environmentName = ResourceManagerUtils.getValueFromIdByName(id, "managedEnvironment");
        if (environmentName == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
                String.format("The resource ID '%s' is not valid. Missing path segment 'managedEnvironment'.", id)));
        }
