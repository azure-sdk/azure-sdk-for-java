...
import com.azure.resourcemanager.appcontainers.models.ManagedHttpRouteConfigCollection;
...
public final class HttpRouteConfigsClientImpl implements HttpRouteConfigsClient {
    ...
    public interface HttpRouteConfigsService {
        ...
        @Get("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.App/managedEnvironments/{environmentName}/httpRoutes/{httpRouteName}")
        ...
        @Headers({ "Content-Type: application/json" })
        @Put("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.App/managedEnvironments/{environmentName}/httpRoutes/{httpRouteName}")
        ...
        Mono<Response<HttpRouteConfigInner>> createOrUpdate(@HostParam("$host") String endpoint,
            ...
            @BodyParam("application/json") HttpRouteConfigInner managedHttpRouteEnvelope,
            @HeaderParam("Accept") String accept, Context context);

        @Headers({ "Content-Type: application/json" })
        @Patch("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.App/managedEnvironments/{environmentName}/httpRoutes/{httpRouteName}")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(DefaultErrorResponseErrorException.class)
        Mono<Response<HttpRouteConfigInner>> update(@HostParam("$host") String endpoint,
            ...
            @PathParam("environmentName") String environmentName, @PathParam("httpRouteName") String httpRouteName,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") ManagedHttpRoutePatch managedHttpRouteEnvelope,
            @HeaderParam("Accept") String accept, Context context);

        @Headers({ "Content-Type: application/json" })
        @Delete("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.App/managedEnvironments/{environmentName}/httpRoutes/{httpRouteName}")
        ...
        @Headers({ "Content-Type: application/json" })
        @Get("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.App/managedEnvironments/{environmentName}/httpRoutes")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(DefaultErrorResponseErrorException.class)
        Mono<Response<ManagedHttpRouteConfigCollection>> list(@HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(DefaultErrorResponseErrorException.class)
        Mono<Response<ManagedHttpRouteConfigCollection>> listNext(
    ...
    public Response<HttpRouteConfigInner> getWithResponse(String resourceGroupName, String environmentName,
        String httpRouteName, Context context) {
        return getWithResponseAsync(resourceGroupName, environmentName, httpRouteName, context).block();
    }
     ...
     * @param environmentName Name of the Managed Environment.
     * @param httpRouteName Name of the Http Route Config Resource.
     * @param managedHttpRouteEnvelope Http Route config to be created or updated.
     * @throws IllegalArgumentException thrown if parameters fail the validation.
     * @throws DefaultErrorResponseErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
    ...
    private Mono<Response<HttpRouteConfigInner>> createOrUpdateWithResponseAsync(String resourceGroupName,
        String environmentName, String httpRouteName, HttpRouteConfigInner managedHttpRouteEnvelope) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        if (managedHttpRouteEnvelope != null) {
            managedHttpRouteEnvelope.validate();
        }
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.createOrUpdate(this.client.getEndpoint(), this.client.getSubscriptionId(),
                resourceGroupName, environmentName, httpRouteName, this.client.getApiVersion(),
                managedHttpRouteEnvelope, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<HttpRouteConfigInner>> createOrUpdateWithResponseAsync(String resourceGroupName,
        String environmentName, String httpRouteName, HttpRouteConfigInner managedHttpRouteEnvelope, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service.createOrUpdate(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            environmentName, httpRouteName, this.client.getApiVersion(), managedHttpRouteEnvelope, accept, context);
    }
    ...
    private Mono<HttpRouteConfigInner> createOrUpdateAsync(String resourceGroupName, String environmentName,
        String httpRouteName) {
        final HttpRouteConfigInner managedHttpRouteEnvelope = null;
        return createOrUpdateWithResponseAsync(resourceGroupName, environmentName, httpRouteName,
            managedHttpRouteEnvelope).flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
    ...
    public Response<HttpRouteConfigInner> createOrUpdateWithResponse(String resourceGroupName, String environmentName,
        String httpRouteName, HttpRouteConfigInner managedHttpRouteEnvelope, Context context) {
        return createOrUpdateWithResponseAsync(resourceGroupName, environmentName, httpRouteName,
            managedHttpRouteEnvelope, context).block();
    }
    ...
    public HttpRouteConfigInner createOrUpdate(String resourceGroupName, String environmentName, String httpRouteName) {
        final HttpRouteConfigInner managedHttpRouteEnvelope = null;
        return createOrUpdateWithResponse(resourceGroupName, environmentName, httpRouteName, managedHttpRouteEnvelope,
     ...
     * @param environmentName Name of the Managed Environment.
     * @param httpRouteName Name of the Http Route Config Resource.
     * @param managedHttpRouteEnvelope Properties of http route config that need to be updated.
     * @throws IllegalArgumentException thrown if parameters fail the validation.
     * @throws DefaultErrorResponseErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return advanced Ingress routing for path/header based routing for a Container App Environment along with
    ...
    private Mono<Response<HttpRouteConfigInner>> updateWithResponseAsync(String resourceGroupName,
        String environmentName, String httpRouteName, ManagedHttpRoutePatch managedHttpRouteEnvelope) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        if (managedHttpRouteEnvelope == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter managedHttpRouteEnvelope is required and cannot be null."));
        } else {
            managedHttpRouteEnvelope.validate();
        }
        final String accept = "application/json";
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<HttpRouteConfigInner>> updateWithResponseAsync(String resourceGroupName,
        String environmentName, String httpRouteName, ManagedHttpRoutePatch managedHttpRouteEnvelope, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    private Mono<HttpRouteConfigInner> updateAsync(String resourceGroupName, String environmentName,
        String httpRouteName, ManagedHttpRoutePatch managedHttpRouteEnvelope) {
        return updateWithResponseAsync(resourceGroupName, environmentName, httpRouteName, managedHttpRouteEnvelope)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
    ...
    public Response<HttpRouteConfigInner> updateWithResponse(String resourceGroupName, String environmentName,
        String httpRouteName, ManagedHttpRoutePatch managedHttpRouteEnvelope, Context context) {
        return updateWithResponseAsync(resourceGroupName, environmentName, httpRouteName, managedHttpRouteEnvelope,
            context).block();
    }
    ...
    public HttpRouteConfigInner update(String resourceGroupName, String environmentName, String httpRouteName,
        ManagedHttpRoutePatch managedHttpRouteEnvelope) {
        return updateWithResponse(resourceGroupName, environmentName, httpRouteName, managedHttpRouteEnvelope,
            Context.NONE).getValue();
    }
    ...
    public Response<Void> deleteWithResponse(String resourceGroupName, String environmentName, String httpRouteName,
        Context context) {
        return deleteWithResponseAsync(resourceGroupName, environmentName, httpRouteName, context).block();
    }
     ...
     * @throws DefaultErrorResponseErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return collection of Advanced Ingress Routing Config resources along with {@link PagedResponse} on successful
     * completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<HttpRouteConfigInner>> listNextSinglePageAsync(String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        if (this.client.getEndpoint() == null) {
