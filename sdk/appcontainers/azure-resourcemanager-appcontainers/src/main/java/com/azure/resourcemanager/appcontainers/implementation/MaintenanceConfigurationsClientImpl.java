...
public final class MaintenanceConfigurationsClientImpl implements MaintenanceConfigurationsClient {
    ...
    public interface MaintenanceConfigurationsService {
        ...
        Mono<Response<MaintenanceConfigurationCollection>> listByManagedEnvironmentResource(
        ...
        @Headers({ "Content-Type: application/json" })
        @Put("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.App/managedEnvironment/{environmentName}/maintenanceConfigurations/{configName}")
        ...
        @Headers({ "Content-Type: application/json" })
        @Delete("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.App/managedEnvironment/{environmentName}/maintenanceConfigurations/{configName}")
        ...
        @Headers({ "Content-Type: application/json" })
        @Get("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.App/managedEnvironment/{environmentName}/maintenanceConfigurations/{configName}")
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(DefaultErrorResponseErrorException.class)
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(DefaultErrorResponseErrorException.class)
        Mono<Response<MaintenanceConfigurationCollection>> listByManagedEnvironmentResourceNext(
    ...
    private Mono<PagedResponse<MaintenanceConfigurationResourceInner>>
        listByManagedEnvironmentResourceSinglePageAsync(String resourceGroupName, String environmentName) {
        ...
        return FluxUtil
            .withContext(context -> service.listByManagedEnvironmentResource(this.client.getEndpoint(),
                this.client.getSubscriptionId(), resourceGroupName, environmentName, this.client.getApiVersion(),
                accept, context))
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<MaintenanceConfigurationResourceInner>> listByManagedEnvironmentResourceSinglePageAsync(
        ...
        return service
            .listByManagedEnvironmentResource(this.client.getEndpoint(), this.client.getSubscriptionId(),
    ...
    private PagedFlux<MaintenanceConfigurationResourceInner>
        listByManagedEnvironmentResourceAsync(String resourceGroupName, String environmentName) {
        return new PagedFlux<>(
            () -> listByManagedEnvironmentResourceSinglePageAsync(resourceGroupName, environmentName),
            nextLink -> listByManagedEnvironmentResourceNextSinglePageAsync(nextLink));
    }
    ...
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<MaintenanceConfigurationResourceInner>
        listByManagedEnvironmentResourceAsync(String resourceGroupName, String environmentName, Context context) {
        return new PagedFlux<>(
            () -> listByManagedEnvironmentResourceSinglePageAsync(resourceGroupName, environmentName, context),
            nextLink -> listByManagedEnvironmentResourceNextSinglePageAsync(nextLink, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<MaintenanceConfigurationResourceInner>
        listByManagedEnvironmentResource(String resourceGroupName, String environmentName) {
        return new PagedIterable<>(listByManagedEnvironmentResourceAsync(resourceGroupName, environmentName));
    }
    ...
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<MaintenanceConfigurationResourceInner>
        listByManagedEnvironmentResource(String resourceGroupName, String environmentName, Context context) {
        return new PagedIterable<>(listByManagedEnvironmentResourceAsync(resourceGroupName, environmentName, context));
    }
    ...
    public Response<MaintenanceConfigurationResourceInner> createOrUpdateWithResponse(String resourceGroupName,
        ...
        MaintenanceConfigurationResourceInner maintenanceConfigurationEnvelope, Context context) {
        return createOrUpdateWithResponseAsync(resourceGroupName, environmentName, configName,
            maintenanceConfigurationEnvelope, context).block();
    }
    ...
    public Response<Void> deleteWithResponse(String resourceGroupName, String environmentName, String configName,
        Context context) {
        return deleteWithResponseAsync(resourceGroupName, environmentName, configName, context).block();
    }
    ...
    public Response<MaintenanceConfigurationResourceInner> getWithResponse(String resourceGroupName,
        String environmentName, String configName, Context context) {
        return getWithResponseAsync(resourceGroupName, environmentName, configName, context).block();
    }
     ...
     * @throws DefaultErrorResponseErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the response of list maintenance configuration resources along with {@link PagedResponse} on successful
     * completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<MaintenanceConfigurationResourceInner>>
        listByManagedEnvironmentResourceNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.listByManagedEnvironmentResourceNext(nextLink, this.client.getEndpoint(),
                accept, context))
            .<PagedResponse<MaintenanceConfigurationResourceInner>>map(res -> new PagedResponseBase<>(res.getRequest(),
                res.getStatusCode(), res.getHeaders(), res.getValue().value(), res.getValue().nextLink(), null))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<MaintenanceConfigurationResourceInner>>
        listByManagedEnvironmentResourceNextSinglePageAsync(String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        if (this.client.getEndpoint() == null) {
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.listByManagedEnvironmentResourceNext(nextLink, this.client.getEndpoint(), accept, context)
            .map(res -> new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(),
                res.getValue().value(), res.getValue().nextLink(), null));
    }
}
