    ...
    public AppResiliency apply() {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getAppResiliencies()
                .patchWithResponse(resourceGroupName, appName, name, this.innerModel(), Context.NONE)
                .getValue();
        return this;
    }
    ...
    public AppResiliency apply(Context context) {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getAppResiliencies()
                .patchWithResponse(resourceGroupName, appName, name, this.innerModel(), context)
                .getValue();
        return this;
    }

    AppResiliencyImpl(
        AppResiliencyInner innerObject,
        com.azure.resourcemanager.appcontainers.ContainerAppsApiManager serviceManager) {
        this.innerObject = innerObject;
        this.serviceManager = serviceManager;
        this.resourceGroupName = Utils.getValueFromIdByName(innerObject.id(), "resourceGroups");
        this.appName = Utils.getValueFromIdByName(innerObject.id(), "containerApps");
        this.name = Utils.getValueFromIdByName(innerObject.id(), "resiliencyPolicies");
    }
