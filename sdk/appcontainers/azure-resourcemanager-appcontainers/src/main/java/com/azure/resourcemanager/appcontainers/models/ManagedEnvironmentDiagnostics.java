...
public interface ManagedEnvironmentDiagnostics {
     ...
     */
    DiagnosticsCollection listDetectors(String resourceGroupName, String name);
     ...
     *     Response}.
     */
    Response<DiagnosticsCollection> listDetectorsWithResponse(String resourceGroupName, String name, Context context);
     ...
     */
    Diagnostics getDetector(String resourceGroupName, String name, String detectorName);
