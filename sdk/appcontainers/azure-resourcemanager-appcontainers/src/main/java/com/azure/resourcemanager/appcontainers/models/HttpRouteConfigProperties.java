...
public final class HttpRouteConfigProperties implements JsonSerializable<HttpRouteConfigProperties> {
     ...
     */
    private List<CustomDomainAutoGenerated> customDomains;
     ...
     */
    public List<CustomDomainAutoGenerated> customDomains() {
     ...
     */
    public HttpRouteConfigProperties withCustomDomains(List<CustomDomainAutoGenerated> customDomains) {
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("provisioningState".equals(fieldName)) {
                    ...
                    List<CustomDomainAutoGenerated> customDomains
                        = reader.readArray(reader1 -> CustomDomainAutoGenerated.fromJson(reader1));
