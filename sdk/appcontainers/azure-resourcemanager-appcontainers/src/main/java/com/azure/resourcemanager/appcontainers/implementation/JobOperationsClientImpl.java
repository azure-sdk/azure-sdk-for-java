...
public final class JobOperationsClientImpl implements JobOperationsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<JobExecutionInner>> executionsSinglePageAsync(String resourceGroupName, String jobName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    private PagedFlux<JobExecutionInner> executionsAsync(String resourceGroupName, String jobName) {
        return new PagedFlux<>(
            () -> executionsSinglePageAsync(resourceGroupName, jobName),
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<JobExecutionInner> executionsAsync(String resourceGroupName, String jobName, Context context) {
        return new PagedFlux<>(
            () -> executionsSinglePageAsync(resourceGroupName, jobName, context),
    ...
    public PagedIterable<JobExecutionInner> executions(String resourceGroupName, String jobName) {
        return new PagedIterable<>(executionsAsync(resourceGroupName, jobName));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<JobExecutionInner> executions(String resourceGroupName, String jobName, Context context) {
        return new PagedIterable<>(executionsAsync(resourceGroupName, jobName, context));
    }
