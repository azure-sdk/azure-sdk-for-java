...
public final class HttpRouteConfigsImpl implements HttpRouteConfigs {
    ...
    public HttpRouteConfig getById(String id) {
        ...
        String httpRouteName = ResourceManagerUtils.getValueFromIdByName(id, "httpRoutes");
        if (httpRouteName == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
                String.format("The resource ID '%s' is not valid. Missing path segment 'httpRoutes'.", id)));
        }
