...
public interface JavaComponents {
     ...
     */
    PagedIterable<JavaComponent> list(String resourceGroupName, String environmentName);
     ...
     * @return the Java Components for a managed environment as paginated response with {@link PagedIterable}.
     */
    PagedIterable<JavaComponent> list(String resourceGroupName, String environmentName, Context context);
     ...
     */
    Response<JavaComponent> getWithResponse(String resourceGroupName, String environmentName, String name,
        Context context);
     ...
     * @return the first stage of the new JavaComponent definition.
     */
    JavaComponent.DefinitionStages.Blank define(String name);
}
