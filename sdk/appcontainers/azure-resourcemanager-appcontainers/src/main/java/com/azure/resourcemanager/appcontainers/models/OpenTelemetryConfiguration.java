...
public final class OpenTelemetryConfiguration {
     ...
     */
    @JsonProperty(value = "includeSystemTelemetry")
    private Boolean includeSystemTelemetry;
    ...
    /**
     * Get the includeSystemTelemetry property: Boolean indicating if including system telemetry.
     * 
     * @return the includeSystemTelemetry value.
     */
    public Boolean includeSystemTelemetry() {
        return this.includeSystemTelemetry;
    }

    /**
     * Set the includeSystemTelemetry property: Boolean indicating if including system telemetry.
     * 
     * @param includeSystemTelemetry the includeSystemTelemetry value to set.
     * @return the OpenTelemetryConfiguration object itself.
     */
    public OpenTelemetryConfiguration withIncludeSystemTelemetry(Boolean includeSystemTelemetry) {
        this.includeSystemTelemetry = includeSystemTelemetry;
        return this;
    }
