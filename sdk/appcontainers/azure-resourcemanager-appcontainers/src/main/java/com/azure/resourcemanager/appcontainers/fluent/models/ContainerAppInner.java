...
public final class ContainerAppInner extends Resource {
    ...
    public String workloadProfile() {
        return this.innerProperties() == null ? null : this.innerProperties().workloadProfile();
    }
     ...
     * @return the ContainerAppInner object itself.
     */
    public ContainerAppInner withWorkloadProfile(String workloadProfile) {
        if (this.innerProperties() == null) {
            this.innerProperties = new ContainerAppProperties();
        }
        this.innerProperties().withWorkloadProfile(workloadProfile);
        return this;
    }
