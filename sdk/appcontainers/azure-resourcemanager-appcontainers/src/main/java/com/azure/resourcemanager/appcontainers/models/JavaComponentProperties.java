...
@JsonTypeInfo(
    ...
    defaultImpl = JavaComponentProperties.class)
@JsonTypeName("JavaComponentProperties")
@JsonSubTypes({
    @JsonSubTypes.Type(name = "SpringCloudGateway", value = SpringCloudGatewayComponent.class),
    @JsonSubTypes.Type(name = "SpringBootAdmin", value = SpringBootAdminComponent.class),
    @JsonSubTypes.Type(name = "Nacos", value = NacosComponent.class),
    @JsonSubTypes.Type(name = "SpringCloudEureka", value = SpringCloudEurekaComponent.class),
    @JsonSubTypes.Type(name = "SpringCloudConfig", value = SpringCloudConfigComponent.class) })
@Fluent
