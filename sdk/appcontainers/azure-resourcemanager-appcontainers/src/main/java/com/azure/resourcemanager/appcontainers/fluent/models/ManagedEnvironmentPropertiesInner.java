...
@Fluent
public final class ManagedEnvironmentPropertiesInner {
    /*
    ...
    /*
     * Dapr Resiliency Default Policies
     */
    @JsonProperty(value = "daprResiliencyDefaults")
    private DaprResiliencyDefaultsInner daprResiliencyDefaults;
    ...
    /** Creates an instance of ManagedEnvironmentPropertiesInner class. */
    public ManagedEnvironmentPropertiesInner() {
    }
     ...
     * @return the ManagedEnvironmentPropertiesInner object itself.
     */
    public ManagedEnvironmentPropertiesInner withDaprAIInstrumentationKey(String daprAIInstrumentationKey) {
     ...
     * @return the ManagedEnvironmentPropertiesInner object itself.
     */
    public ManagedEnvironmentPropertiesInner withDaprAIConnectionString(String daprAIConnectionString) {
     ...
     * @return the ManagedEnvironmentPropertiesInner object itself.
     */
    public ManagedEnvironmentPropertiesInner withVnetConfiguration(VnetConfiguration vnetConfiguration) {
    ...
    public DaprResiliencyDefaultsInner daprResiliencyDefaults() {
        return this.daprResiliencyDefaults;
    }
     ...
     * @return the ManagedEnvironmentPropertiesInner object itself.
     */
    public ManagedEnvironmentPropertiesInner withDaprResiliencyDefaults(
        DaprResiliencyDefaultsInner daprResiliencyDefaults) {
        this.daprResiliencyDefaults = daprResiliencyDefaults;
        return this;
    }
     ...
     * @return the ManagedEnvironmentPropertiesInner object itself.
     */
    public ManagedEnvironmentPropertiesInner withAppLogsConfiguration(AppLogsConfiguration appLogsConfiguration) {
     ...
     * @return the ManagedEnvironmentPropertiesInner object itself.
     */
    public ManagedEnvironmentPropertiesInner withZoneRedundant(Boolean zoneRedundant) {
     ...
     * @return the ManagedEnvironmentPropertiesInner object itself.
     */
    public ManagedEnvironmentPropertiesInner withCustomDomainConfiguration(
     ...
     * @return the ManagedEnvironmentPropertiesInner object itself.
     */
    public ManagedEnvironmentPropertiesInner withWorkloadProfiles(List<WorkloadProfile> workloadProfiles) {
     ...
     * @return the ManagedEnvironmentPropertiesInner object itself.
     */
    public ManagedEnvironmentPropertiesInner withKedaConfiguration(KedaConfiguration kedaConfiguration) {
     ...
     * @return the ManagedEnvironmentPropertiesInner object itself.
     */
    public ManagedEnvironmentPropertiesInner withDaprConfiguration(DaprConfiguration daprConfiguration) {
    ...
    public void validate() {
        ...
        if (daprResiliencyDefaults() != null) {
            daprResiliencyDefaults().validate();
        }
