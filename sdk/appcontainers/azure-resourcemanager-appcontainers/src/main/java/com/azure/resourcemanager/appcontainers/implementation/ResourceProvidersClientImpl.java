...
public final class ResourceProvidersClientImpl implements ResourceProvidersClient {
    ...
    public interface ResourceProvidersService {
        ...
        @Headers({"Content-Type: application/json"})
        @Post("/subscriptions/{subscriptionId}/providers/Microsoft.App/getVerificationId")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(DefaultErrorResponseErrorException.class)
        Mono<Response<String>> getVerificationId(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<String>> getVerificationIdWithResponseAsync() {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<String>> getVerificationIdWithResponseAsync(Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<String> getVerificationIdAsync() {
        return getVerificationIdWithResponseAsync().flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
    ...
    public Response<String> getVerificationIdWithResponse(Context context) {
        return getVerificationIdWithResponseAsync(context).block();
    }
    ...
    public String getVerificationId() {
        return getVerificationIdWithResponse(Context.NONE).getValue();
    }
}
