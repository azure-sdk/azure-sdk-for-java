...
public final class SessionPoolUpdatableProperties implements JsonSerializable<SessionPoolUpdatableProperties> {
     ...
     */
    public SessionPoolUpdatableProperties withIdentity(ManagedServiceIdentityUpdate identity) {
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("identity".equals(fieldName)) {
                    deserializedSessionPoolUpdatableProperties.identity = ManagedServiceIdentityUpdate.fromJson(reader);
