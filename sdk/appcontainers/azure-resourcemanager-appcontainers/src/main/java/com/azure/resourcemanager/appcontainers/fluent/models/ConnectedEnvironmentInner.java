        ...
        if (location() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property location in model ConnectedEnvironmentInner"));
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(ConnectedEnvironmentInner.class);
