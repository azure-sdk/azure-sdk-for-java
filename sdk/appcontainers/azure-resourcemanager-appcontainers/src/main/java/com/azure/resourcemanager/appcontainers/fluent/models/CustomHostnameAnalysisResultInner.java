...
public final class CustomHostnameAnalysisResultInner {
    ...
    /*
     * <code>true</code> if there is a conflict on the Container App's environment; otherwise, <code>false</code>.
     */
    @JsonProperty(value = "hasConflictOnEnvironment", access = JsonProperty.Access.WRITE_ONLY)
    private Boolean hasConflictOnEnvironment;

    /*
     * Name of the conflicting Container App on the Environment if it's within the same subscription.
     */
    ...
    /**
     * Get the hasConflictOnEnvironment property: &lt;code&gt;true&lt;/code&gt; if there is a conflict on the Container
     * App's environment; otherwise, &lt;code&gt;false&lt;/code&gt;.
     *
     * @return the hasConflictOnEnvironment value.
     */
    public Boolean hasConflictOnEnvironment() {
        return this.hasConflictOnEnvironment;
    }

    /**
     * Get the conflictingContainerAppResourceId property: Name of the conflicting Container App on the Environment if
