 ...
 */
@Fluent
public final class HttpRouteConfigPatchProperties implements JsonSerializable<HttpRouteConfigPatchProperties> {
    /*
    ...
    /**
     * Creates an instance of HttpRouteConfigPatchProperties class.
     */
    public HttpRouteConfigPatchProperties() {
    }
     ...
     * @return the HttpRouteConfigPatchProperties object itself.
     */
    public HttpRouteConfigPatchProperties withCustomDomains(List<CustomDomain> customDomains) {
     ...
     * @return the HttpRouteConfigPatchProperties object itself.
     */
    public HttpRouteConfigPatchProperties withRules(List<HttpRouteRule> rules) {
        this.rules = rules;
        return this;
    }
    ...
    /**
     * Reads an instance of HttpRouteConfigPatchProperties from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of HttpRouteConfigPatchProperties if the JsonReader was pointing to an instance of it, or
     * null if it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the HttpRouteConfigPatchProperties.
     */
    public static HttpRouteConfigPatchProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            HttpRouteConfigPatchProperties deserializedHttpRouteConfigPatchProperties
                = new HttpRouteConfigPatchProperties();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("provisioningState".equals(fieldName)) {
                    deserializedHttpRouteConfigPatchProperties.provisioningState
                    ...
                    deserializedHttpRouteConfigPatchProperties.provisioningErrors = provisioningErrors;
                } else if ("fqdn".equals(fieldName)) {
                    deserializedHttpRouteConfigPatchProperties.fqdn = reader.getString();
                    ...
                    deserializedHttpRouteConfigPatchProperties.customDomains = customDomains;
                } else if ("rules".equals(fieldName)) {
                    List<HttpRouteRule> rules = reader.readArray(reader1 -> HttpRouteRule.fromJson(reader1));
                    deserializedHttpRouteConfigPatchProperties.rules = rules;
                } else {
                    reader.skipChildren();
                }
            }

            return deserializedHttpRouteConfigPatchProperties;
        });
    }
}
