...
public final class BuilderResourceImpl implements BuilderResource, BuilderResource.Definition, BuilderResource.Update {
    ...
    public List<ContainerRegistries> containerRegistries() {
        List<ContainerRegistries> inner = this.innerModel().containerRegistries();
        if (inner != null) {
    ...
    public BuilderResourceImpl withContainerRegistries(List<ContainerRegistries> containerRegistries) {
