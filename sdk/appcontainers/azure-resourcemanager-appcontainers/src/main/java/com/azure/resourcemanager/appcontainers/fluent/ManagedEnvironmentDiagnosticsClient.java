...
public interface ManagedEnvironmentDiagnosticsClient {
    ...
    DiagnosticsCollectionInner listDetectors(String resourceGroupName, String name);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    DiagnosticsInner getDetector(String resourceGroupName, String name, String detectorName);
