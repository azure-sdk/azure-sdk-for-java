...
public final class PatchesClientImpl implements PatchesClient {
    ...
    public interface PatchesService {
        ...
        Mono<Response<Flux<ByteBuffer>>> skipConfigure(
            ...
            @PathParam("builderName") String builderName,
            @PathParam("patchName") String patchName,
            @PathParam("patchSkipConfig") boolean patchSkipConfig,
            @HeaderParam("Accept") String accept,
            Context context);
     ...
     * @return the response of a PatchResource list resources along with {@link Response} on successful completion of
     *     {@link Mono}.
     */
     ...
     * @throws DefaultErrorResponseErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the response of a PatchResource list resources on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
     ...
     * @throws DefaultErrorResponseErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the resource representation of a patch along with {@link Response} on successful completion of {@link
     *     Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
     ...
     * @throws DefaultErrorResponseErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the {@link PollerFlux} for polling of the resource representation of a patch.
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
     ...
     * @throws DefaultErrorResponseErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the {@link SyncPoller} for polling of the resource representation of a patch.
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
     ...
     * @throws DefaultErrorResponseErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the resource representation of a patch on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
