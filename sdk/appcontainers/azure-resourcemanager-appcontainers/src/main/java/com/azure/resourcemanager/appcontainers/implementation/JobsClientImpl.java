...
public final class JobsClientImpl implements JobsClient {
    ...
    public interface JobsService {
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(DefaultErrorResponseErrorException.class)
        Mono<Response<JobsCollectionInner>> proxyList(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("jobName") String jobName,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(DefaultErrorResponseErrorException.class)
        Mono<Response<JobInner>> proxyGet(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("jobName") String jobName,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(DefaultErrorResponseErrorException.class)
        Mono<Response<JobsCollectionInner>> list(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(DefaultErrorResponseErrorException.class)
        Mono<Response<JobsCollectionInner>> listByResourceGroup(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @QueryParam("api-version") String apiVersion,
        ...
        @ExpectedResponses({200, 202})
        @UnexpectedResponseExceptionType(DefaultErrorResponseErrorException.class)
        Mono<Response<Flux<ByteBuffer>>> stopExecution(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @QueryParam("api-version") String apiVersion,
        ...
        @ExpectedResponses({200, 202})
        @UnexpectedResponseExceptionType(DefaultErrorResponseErrorException.class)
        Mono<Response<Flux<ByteBuffer>>> stopMultipleExecutions(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @QueryParam("api-version") String apiVersion,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(DefaultErrorResponseErrorException.class)
        Mono<Response<JobsCollectionInner>> listBySubscriptionNext(
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(DefaultErrorResponseErrorException.class)
        Mono<Response<JobsCollectionInner>> listByResourceGroupNext(
            @PathParam(value = "nextLink", encoded = true) String nextLink,
            @HostParam("$host") String endpoint,
            @HeaderParam("Accept") String accept,
            Context context);
     ...
     *
     * <p>Get the list of diagnostics for a Container App Job.
     *
     ...
     *
     * <p>Get the diagnostics data for a Container App Job.
     *
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
     * @param jobName Job Name.
    ...
    private Mono<Response<DiagnosticsInner>> getDetectorWithResponseAsync(
        String resourceGroupName, String jobName, String detectorName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    /**
     * Get the list of proxy properties for a given Container App Job.
     *
     * <p>Get the proxy properties of a Container App Job.
     *
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
     * @param jobName Job Name.
     * @throws IllegalArgumentException thrown if parameters fail the validation.
     * @throws DefaultErrorResponseErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the proxy properties of a Container App Job along with {@link Response} on successful completion of
     *     {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<JobsCollectionInner>> proxyListWithResponseAsync(String resourceGroupName, String jobName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<JobsCollectionInner>> proxyListWithResponseAsync(
        String resourceGroupName, String jobName, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     * @throws DefaultErrorResponseErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the proxy properties of a Container App Job on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<JobsCollectionInner> proxyListAsync(String resourceGroupName, String jobName) {
        return proxyListWithResponseAsync(resourceGroupName, jobName).flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     * @throws DefaultErrorResponseErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the proxy properties of a Container App Job along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<JobsCollectionInner> proxyListWithResponse(
        String resourceGroupName, String jobName, Context context) {
        return proxyListWithResponseAsync(resourceGroupName, jobName, context).block();
    }
     ...
     * @throws DefaultErrorResponseErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the proxy properties of a Container App Job.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public JobsCollectionInner proxyList(String resourceGroupName, String jobName) {
        return proxyListWithResponse(resourceGroupName, jobName, Context.NONE).getValue();
    }

    /**
     * Get the properties for a given Container App Job.
     *
     * <p>Get the properties of a Container App Job.
     *
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
     * @param jobName Job Name.
     ...
     * @throws DefaultErrorResponseErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the properties of a Container App Job along with {@link Response} on successful completion of {@link
     *     Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<JobInner>> proxyGetWithResponseAsync(
        String resourceGroupName, String jobName, String apiName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<JobInner>> proxyGetWithResponseAsync(
        String resourceGroupName, String jobName, String apiName, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<JobInner> proxyGetWithResponse(
        String resourceGroupName, String jobName, String apiName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<JobExecutionBaseInner>, JobExecutionBaseInner> beginStartAsync(
        String resourceGroupName, String jobName, JobExecutionTemplate template) {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<JobExecutionBaseInner>, JobExecutionBaseInner> beginStart(
        String resourceGroupName, String jobName) {
        final JobExecutionTemplate template = null;
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<JobExecutionBaseInner> startAsync(
        String resourceGroupName, String jobName, JobExecutionTemplate template) {
        return beginStartAsync(resourceGroupName, jobName, template)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<JobExecutionBaseInner> startAsync(
        String resourceGroupName, String jobName, JobExecutionTemplate template, Context context) {
        return beginStartAsync(resourceGroupName, jobName, template, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public JobExecutionBaseInner start(
        String resourceGroupName, String jobName, JobExecutionTemplate template, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> stopExecutionWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<Void>, Void> beginStopExecutionAsync(
        String resourceGroupName, String jobName, String jobExecutionName) {
        Mono<Response<Flux<ByteBuffer>>> mono =
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<Void>, Void> beginStopExecution(
        String resourceGroupName, String jobName, String jobExecutionName) {
    ...
    private Mono<Void> stopExecutionAsync(String resourceGroupName, String jobName, String jobExecutionName) {
        return beginStopExecutionAsync(resourceGroupName, jobName, jobExecutionName)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> stopExecutionAsync(
        String resourceGroupName, String jobName, String jobExecutionName, Context context) {
        return beginStopExecutionAsync(resourceGroupName, jobName, jobExecutionName, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> stopMultipleExecutionsWithResponseAsync(
        String resourceGroupName, String jobName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ContainerAppJobExecutionsInner> stopMultipleExecutionsAsync(
        String resourceGroupName, String jobName, Context context) {
