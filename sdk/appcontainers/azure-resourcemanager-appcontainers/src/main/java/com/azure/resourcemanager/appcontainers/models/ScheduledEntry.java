...
public final class ScheduledEntry implements JsonSerializable<ScheduledEntry> {
     ...
     * @return the ScheduledEntry object itself.
     */
    public ScheduledEntry withDurationHours(Integer durationHours) {
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeNumberField("durationHours", this.durationHours);
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("weekDay".equals(fieldName)) {
                    ...
                    deserializedScheduledEntry.durationHours = reader.getNullable(JsonReader::getInt);
                } else {
                    reader.skipChildren();
                }
            }
