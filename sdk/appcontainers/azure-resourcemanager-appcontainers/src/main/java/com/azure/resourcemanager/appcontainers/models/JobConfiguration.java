...
public final class JobConfiguration {
    ...
    /*
     * Optional settings for Managed Identities that are assigned to the Container App Job. If a Managed Identity is
     * not specified here, default settings will be used.
     */
