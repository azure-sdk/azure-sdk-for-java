        ...
        if (location() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property location in model EnvironmentAuthTokenInner"));
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(EnvironmentAuthTokenInner.class);
