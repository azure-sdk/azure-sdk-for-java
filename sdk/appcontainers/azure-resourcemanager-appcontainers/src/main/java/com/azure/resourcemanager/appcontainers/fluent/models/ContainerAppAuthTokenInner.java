        ...
        if (location() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property location in model ContainerAppAuthTokenInner"));
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(ContainerAppAuthTokenInner.class);
