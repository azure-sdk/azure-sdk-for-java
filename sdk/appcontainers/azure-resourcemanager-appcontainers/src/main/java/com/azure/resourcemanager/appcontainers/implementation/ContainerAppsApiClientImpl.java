...
public final class ContainerAppsApiClientImpl implements ContainerAppsApiClient {
    ...
    /**
     * The ManagedEnvironmentSecretsClient object to access its operations.
     */
    private final ManagedEnvironmentSecretsClient managedEnvironmentSecrets;

    /**
     * Gets the ManagedEnvironmentSecretsClient object to access its operations.
     * 
     * @return the ManagedEnvironmentSecretsClient object.
     */
    public ManagedEnvironmentSecretsClient getManagedEnvironmentSecrets() {
        return this.managedEnvironmentSecrets;
    }
    ...
    ContainerAppsApiClientImpl(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter,
        ...
        this.managedEnvironmentSecrets = new ManagedEnvironmentSecretsClientImpl(this);
