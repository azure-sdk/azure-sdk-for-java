...
public final class ContainerAppsApiClientImpl implements ContainerAppsApiClient {
    ...
    /** The AppSpacesClient object to access its operations. */
    private final AppSpacesClient appSpaces;
     ...
     */
    public AppSpacesClient getAppSpaces() {
        return this.appSpaces;
    }

    /** The AppSpaceResourcesClient object to access its operations. */
    private final AppSpaceResourcesClient appSpaceResources;
     ...
     */
    public AppSpaceResourcesClient getAppSpaceResources() {
        return this.appSpaceResources;
    }
    ...
    ContainerAppsApiClientImpl(
        ...
        this.appSpaces = new AppSpacesClientImpl(this);
        this.appSpaceResources = new AppSpaceResourcesClientImpl(this);
