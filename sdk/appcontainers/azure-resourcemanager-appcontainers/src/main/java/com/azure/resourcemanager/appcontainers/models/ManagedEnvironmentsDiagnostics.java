...
public interface ManagedEnvironmentsDiagnostics {
     ...
     */
    ManagedEnvironment getRoot(String resourceGroupName, String name);
     ...
     */
    Response<ManagedEnvironment> getRootWithResponse(String resourceGroupName, String name, Context context);
}
