...
public final class ContainerAppImpl implements ContainerApp, ContainerApp.Definition, ContainerApp.Update {
    ...
    public String workloadProfile() {
        return this.innerModel().workloadProfile();
    }
    ...
    public ContainerAppImpl withWorkloadProfile(String workloadProfile) {
        this.innerModel().withWorkloadProfile(workloadProfile);
        return this;
    }
