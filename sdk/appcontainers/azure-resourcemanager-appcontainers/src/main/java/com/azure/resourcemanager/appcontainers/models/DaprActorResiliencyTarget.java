...
@Fluent
public final class DaprActorResiliencyTarget {
    /*
     * Name of the dapr actor type to apply policies to.
     */
    ...
    /*
     * Circuit breakers for actors are scoped by 'id', 'type' or 'both'.
     */
    @JsonProperty(value = "circuitBreakerScope")
    private String circuitBreakerScope;

    /** Creates an instance of DaprActorResiliencyTarget class. */
    public DaprActorResiliencyTarget() {
    }

    /**
     * Get the target property: Name of the dapr actor type to apply policies to.
     *
    ...
    /**
     * Set the target property: Name of the dapr actor type to apply policies to.
     *
     * @param target the target value to set.
     * @return the DaprActorResiliencyTarget object itself.
     */
    public DaprActorResiliencyTarget withTarget(String target) {
        this.target = target;
        return this;
    }
     ...
     * @return the DaprActorResiliencyTarget object itself.
     */
    public DaprActorResiliencyTarget withRetry(String retry) {
        this.retry = retry;
        return this;
    }
     ...
     * @return the DaprActorResiliencyTarget object itself.
     */
    public DaprActorResiliencyTarget withTimeout(String timeout) {
     ...
     * @return the DaprActorResiliencyTarget object itself.
     */
    public DaprActorResiliencyTarget withCircuitBreaker(String circuitBreaker) {
     ...
     * @return the DaprActorResiliencyTarget object itself.
     */
    public DaprActorResiliencyTarget withCircuitBreakerCacheSize(Integer circuitBreakerCacheSize) {
        this.circuitBreakerCacheSize = circuitBreakerCacheSize;
        return this;
    }

    /**
     * Get the circuitBreakerScope property: Circuit breakers for actors are scoped by 'id', 'type' or 'both'.
     *
    ...
    /**
     * Set the circuitBreakerScope property: Circuit breakers for actors are scoped by 'id', 'type' or 'both'.
     *
     * @param circuitBreakerScope the circuitBreakerScope value to set.
     * @return the DaprActorResiliencyTarget object itself.
     */
    public DaprActorResiliencyTarget withCircuitBreakerScope(String circuitBreakerScope) {
            ...
            throw LOGGER
                .logExceptionAsError(
                    new IllegalArgumentException(
                        "Missing required property target in model DaprActorResiliencyTarget"));
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(DaprActorResiliencyTarget.class);
}
