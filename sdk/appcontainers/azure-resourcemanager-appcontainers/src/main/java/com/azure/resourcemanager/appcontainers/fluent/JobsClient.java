...
public interface JobsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<JobsCollectionInner> proxyListWithResponse(String resourceGroupName, String jobName, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    JobsCollectionInner proxyList(String resourceGroupName, String jobName);
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    SyncPoller<PollResult<JobExecutionBaseInner>, JobExecutionBaseInner> beginStart(
