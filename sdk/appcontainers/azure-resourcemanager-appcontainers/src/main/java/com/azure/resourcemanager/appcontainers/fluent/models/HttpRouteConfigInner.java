 ...
 */
@Fluent
public final class HttpRouteConfigInner extends Resource {
    /*
     ...
     */
    @Override
    public HttpRouteConfigInner withLocation(String location) {
     ...
     */
    @Override
    public HttpRouteConfigInner withTags(Map<String, String> tags) {
        super.withTags(tags);
        return this;
    }
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("id".equals(fieldName)) {
                    ...
                    deserializedHttpRouteConfigInner.withLocation(reader.getString());
                } else if ("tags".equals(fieldName)) {
                    Map<String, String> tags = reader.readMap(reader1 -> reader1.getString());
                    deserializedHttpRouteConfigInner.withTags(tags);
