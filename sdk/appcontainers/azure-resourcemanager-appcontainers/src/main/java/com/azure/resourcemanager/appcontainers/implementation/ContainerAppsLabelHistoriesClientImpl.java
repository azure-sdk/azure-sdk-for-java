...
public final class ContainerAppsLabelHistoriesClientImpl implements ContainerAppsLabelHistoriesClient {
    ...
    private Mono<PagedResponse<LabelHistoryInner>> listLabelHistorySinglePageAsync(String resourceGroupName,
        ...
        return service
            .listLabelHistory(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
    ...
    private PagedFlux<LabelHistoryInner> listLabelHistoryAsync(String resourceGroupName, String containerAppName,
        ...
        return new PagedFlux<>(
            () -> listLabelHistorySinglePageAsync(resourceGroupName, containerAppName, filter, context),
            nextLink -> listLabelHistoryNextSinglePageAsync(nextLink, context));
    }
    ...
    public PagedIterable<LabelHistoryInner> listLabelHistory(String resourceGroupName, String containerAppName) {
        final String filter = null;
        return new PagedIterable<>(listLabelHistoryAsync(resourceGroupName, containerAppName, filter));
    }
    ...
    public PagedIterable<LabelHistoryInner> listLabelHistory(String resourceGroupName, String containerAppName,
        String filter, Context context) {
        return new PagedIterable<>(listLabelHistoryAsync(resourceGroupName, containerAppName, filter, context));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<LabelHistoryInner>> getLabelHistoryWithResponseAsync(String resourceGroupName,
        String containerAppName, String labelName, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.getLabelHistory(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            containerAppName, labelName, this.client.getApiVersion(), accept, context);
    }
    ...
    public Response<LabelHistoryInner> getLabelHistoryWithResponse(String resourceGroupName, String containerAppName,
        ...
        return getLabelHistoryWithResponseAsync(resourceGroupName, containerAppName, labelName, context).block();
    }
    ...
    private Mono<Response<Void>> deleteLabelHistoryWithResponseAsync(String resourceGroupName, String containerAppName,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.deleteLabelHistory(this.client.getEndpoint(), this.client.getSubscriptionId(), resourceGroupName,
            containerAppName, labelName, this.client.getApiVersion(), accept, context);
    }
    ...
    public Response<Void> deleteLabelHistoryWithResponse(String resourceGroupName, String containerAppName,
        String labelName, Context context) {
        return deleteLabelHistoryWithResponseAsync(resourceGroupName, containerAppName, labelName, context).block();
    }
     ...
     * @throws DefaultErrorResponseErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return container App Label History collection ARM resource along with {@link PagedResponse} on successful
    ...
    private Mono<PagedResponse<LabelHistoryInner>> listLabelHistoryNextSinglePageAsync(String nextLink,
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.listLabelHistoryNext(nextLink, this.client.getEndpoint(), accept, context)
            .map(res -> new PagedResponseBase<>(res.getRequest(), res.getStatusCode(), res.getHeaders(),
                res.getValue().value(), res.getValue().nextLink(), null));
    }
}
