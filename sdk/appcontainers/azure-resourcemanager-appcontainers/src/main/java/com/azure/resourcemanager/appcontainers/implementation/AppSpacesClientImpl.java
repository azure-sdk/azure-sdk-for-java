...
public final class AppSpacesClientImpl implements AppSpacesClient {
    ...
    public interface AppSpacesService {
        ...
        @Get(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.App/appSpaces/{appSpaceName}/spaceResources")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(DefaultErrorResponseErrorException.class)
        Mono<Response<AppSpaceResourcesCollection>> listByResourceGroup(
        ...
        @Headers({"Content-Type: application/json"})
        @Get("/subscriptions/{subscriptionId}/providers/Microsoft.App/appSpaces")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(DefaultErrorResponseErrorException.class)
        Mono<Response<AppSpacesCollection>> list(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept,
        ...
        @Headers({"Content-Type: application/json"})
        @Get("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.App/appSpaces")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(DefaultErrorResponseErrorException.class)
        Mono<Response<AppSpacesCollection>> listByResourceGroup(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @QueryParam("api-version") String apiVersion,
        ...
        @Headers({"Content-Type: application/json"})
        @Get(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.App/appSpaces/{appSpaceName}")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(DefaultErrorResponseErrorException.class)
        Mono<Response<AppSpaceInner>> getByResourceGroup(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("appSpaceName") String appSpaceName,
        ...
        @UnexpectedResponseExceptionType(DefaultErrorResponseErrorException.class)
        Mono<Response<AppSpaceInner>> createOrUpdate(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("appSpaceName") String appSpaceName,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") AppSpaceInner appSpaceEnvelope,
            @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(DefaultErrorResponseErrorException.class)
        Mono<Response<AppSpaceInner>> update(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("appSpaceName") String appSpaceName,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(DefaultErrorResponseErrorException.class)
        Mono<Response<AppSpaceResourcesCollection>> listByResourceGroupNext(
    ...
    private Mono<PagedResponse<AppSpaceResourceInner>> listByResourceGroupSinglePageAsync(
        String resourceGroupName, String appSpaceName) {
                ...
                context ->
                    service
                        .listByResourceGroup(
                            ...
                            accept,
                            context))
            .<PagedResponse<AppSpaceResourceInner>>map(
                res ->
    ...
    private PagedFlux<AppSpaceResourceInner> listByResourceGroupAsync(String resourceGroupName, String appSpaceName) {
        return new PagedFlux<>(
            () -> listByResourceGroupSinglePageAsync(resourceGroupName, appSpaceName),
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<AppSpaceResourceInner> listByResourceGroupAsync(
        String resourceGroupName, String appSpaceName, Context context) {
        return new PagedFlux<>(
            () -> listByResourceGroupSinglePageAsync(resourceGroupName, appSpaceName, context),
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<AppSpaceResourceInner> listByResourceGroup(String resourceGroupName, String appSpaceName) {
        return new PagedIterable<>(listByResourceGroupAsync(resourceGroupName, appSpaceName));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<AppSpaceResourceInner> listByResourceGroup(
        String resourceGroupName, String appSpaceName, Context context) {
        return new PagedIterable<>(listByResourceGroupAsync(resourceGroupName, appSpaceName, context));
    }
                ...
                context ->
                    service
                        .list(
                            ...
                            accept,
                            context))
            .<PagedResponse<AppSpaceInner>>map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(),
                        res.getStatusCode(),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<AppSpaceInner>> listByResourceGroupSinglePageAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<AppSpaceInner>> getByResourceGroupWithResponseAsync(
        String resourceGroupName, String appSpaceName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<AppSpaceInner> getByResourceGroupWithResponse(
        String resourceGroupName, String appSpaceName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<AppSpaceInner>> createOrUpdateWithResponseAsync(
        String resourceGroupName, String appSpaceName, AppSpaceInner appSpaceEnvelope) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<AppSpaceInner> createOrUpdateAsync(
        String resourceGroupName, String appSpaceName, AppSpaceInner appSpaceEnvelope) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<AppSpaceInner> createOrUpdateWithResponse(
        String resourceGroupName, String appSpaceName, AppSpaceInner appSpaceEnvelope, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<AppSpaceInner>> updateWithResponseAsync(
        String resourceGroupName, String appSpaceName, AppSpaceInner appSpaceEnvelope) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<AppSpaceInner> updateAsync(
        String resourceGroupName, String appSpaceName, AppSpaceInner appSpaceEnvelope) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<AppSpaceInner> updateWithResponse(
        String resourceGroupName, String appSpaceName, AppSpaceInner appSpaceEnvelope, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public AppSpaceInner update(String resourceGroupName, String appSpaceName, AppSpaceInner appSpaceEnvelope) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<AppSpaceResourceInner>> listByResourceGroupNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<AppSpaceResourceInner>> listByResourceGroupNextSinglePageAsync(
     ...
     * @throws DefaultErrorResponseErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return app Space collection ARM resource along with {@link PagedResponse} on successful completion of {@link
     *     Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
