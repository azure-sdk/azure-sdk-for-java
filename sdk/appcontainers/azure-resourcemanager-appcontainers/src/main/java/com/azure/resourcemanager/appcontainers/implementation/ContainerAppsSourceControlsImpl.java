...
public final class ContainerAppsSourceControlsImpl implements ContainerAppsSourceControls {
    ...
    public void delete(String resourceGroupName, String containerAppName, String sourceControlName,
        ...
        this.serviceClient()
            .delete(resourceGroupName, containerAppName, sourceControlName, ignoreWorkflowDeletionFailure,
    ...
    public void deleteById(String id) {
        ...
        this.delete(resourceGroupName, containerAppName, sourceControlName, localIgnoreWorkflowDeletionFailure,
            localDeleteWorkflow, Context.NONE);
    }

    public void deleteByIdWithResponse(String id, Boolean ignoreWorkflowDeletionFailure, Boolean deleteWorkflow,
        Context context) {
        String resourceGroupName = ResourceManagerUtils.getValueFromIdByName(id, "resourceGroups");
        if (resourceGroupName == null) {
            throw LOGGER.logExceptionAsError(new IllegalArgumentException(
        ...
        this.delete(resourceGroupName, containerAppName, sourceControlName, ignoreWorkflowDeletionFailure,
            deleteWorkflow, context);
    }
