...
public interface Job {
     ...
     */
    JobExecutionBase run(JobExecutionTemplate template);
     ...
     * @return container App's Job execution name.
     */
    JobExecutionBase run(JobExecutionTemplate template, Context context);
     ...
     */
    PagedIterable<JobExecution> executions();
     ...
     * @return a Container Apps Job's executions as paginated response with {@link PagedIterable}.
     */
    PagedIterable<JobExecution> executions(Context context);
}
