...
public final class ManagedEnvironmentInner extends Resource {
    ...
    /*
     * The list of availability zones to use for dedicated workloadProfiles
     */
    ...
    /**
     * Get the zones property: The list of availability zones to use for dedicated workloadProfiles.
     * 
    ...
    /**
     * Set the zones property: The list of availability zones to use for dedicated workloadProfiles.
     * 
     * @param zones the zones value to set.
     * @return the ManagedEnvironmentInner object itself.
     */
    public ManagedEnvironmentInner withZones(List<String> zones) {
        this.zones = zones;
        return this;
    }
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("id".equals(fieldName)) {
                    ...
                    deserializedManagedEnvironmentInner.zones = zones;
