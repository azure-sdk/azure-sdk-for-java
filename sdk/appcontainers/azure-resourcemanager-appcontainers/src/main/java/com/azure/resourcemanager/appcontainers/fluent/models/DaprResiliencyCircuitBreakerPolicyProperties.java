...
public final class DaprResiliencyCircuitBreakerPolicyProperties {
    ...
    /*
     * Cyclical period of time used by the CB to clear its internal counts. Valid values are of the form 200ms, 15s,
     * 2m, 1h30m, etc.
     */
    ...
    /*
     * The period of the open state until the CB switches to half-open. Valid values are of the form 200ms, 15s, 2m,
     * 1h30m, etc.
     */
