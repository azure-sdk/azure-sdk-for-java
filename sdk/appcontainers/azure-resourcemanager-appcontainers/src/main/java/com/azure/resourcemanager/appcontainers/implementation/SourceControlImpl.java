...
public final class SourceControlImpl implements SourceControl, SourceControl.Definition, SourceControl.Update {
    ...
    public SourceControl create() {
        this.innerObject = serviceManager.serviceClient()
            ...
            .createOrUpdate(resourceGroupName, containerAppName, sourceControlName, createXMsGithubAuxiliary,
    ...
    public SourceControl apply() {
        this.innerObject = serviceManager.serviceClient()
            .getContainerAppsSourceControls()
            .createOrUpdate(resourceGroupName, containerAppName, sourceControlName, updateXMsGithubAuxiliary,
                this.innerModel(), Context.NONE);
        return this;
    }
