...
public final class AppResilienciesClientImpl implements AppResilienciesClient {
    ...
    public interface AppResilienciesService {
        ...
        Mono<Response<AppResiliencyInner>> createOrUpdate(
            ...
            @BodyParam("application/json") AppResiliencyInner resiliencyEnvelope,
        ...
        @UnexpectedResponseExceptionType(DefaultErrorResponseErrorException.class)
        Mono<Response<AppResiliencyInner>> patch(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("appName") String appName,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(DefaultErrorResponseErrorException.class)
        Mono<Response<AppResiliencyInner>> get(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("appName") String appName,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(DefaultErrorResponseErrorException.class)
        Mono<Response<AppResiliencyCollection>> list(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("appName") String appName,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(DefaultErrorResponseErrorException.class)
        Mono<Response<AppResiliencyCollection>> listNext(
     ...
     * @return configuration to setup App Resiliency along with {@link Response} on successful completion of {@link
     *     Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<AppResiliencyInner>> createOrUpdateWithResponseAsync(
        String resourceGroupName, String appName, String name, AppResiliencyInner resiliencyEnvelope) {
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<AppResiliencyInner>> createOrUpdateWithResponseAsync(
        String resourceGroupName, String appName, String name, AppResiliencyInner resiliencyEnvelope, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<AppResiliencyInner> createOrUpdateAsync(
        String resourceGroupName, String appName, String name, AppResiliencyInner resiliencyEnvelope) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<AppResiliencyInner> createOrUpdateWithResponse(
        String resourceGroupName, String appName, String name, AppResiliencyInner resiliencyEnvelope, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public AppResiliencyInner createOrUpdate(
        String resourceGroupName, String appName, String name, AppResiliencyInner resiliencyEnvelope) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<AppResiliencyInner>> patchWithResponseAsync(
        String resourceGroupName, String appName, String name, AppResiliencyInner resiliencyEnvelope) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<AppResiliencyInner> patchAsync(
        String resourceGroupName, String appName, String name, AppResiliencyInner resiliencyEnvelope) {
        return patchWithResponseAsync(resourceGroupName, appName, name, resiliencyEnvelope)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<AppResiliencyInner> patchWithResponse(
        String resourceGroupName, String appName, String name, AppResiliencyInner resiliencyEnvelope, Context context) {
        return patchWithResponseAsync(resourceGroupName, appName, name, resiliencyEnvelope, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public AppResiliencyInner patch(
        String resourceGroupName, String appName, String name, AppResiliencyInner resiliencyEnvelope) {
        return patchWithResponse(resourceGroupName, appName, name, resiliencyEnvelope, Context.NONE).getValue();
    }
    ...
    private Mono<Response<Void>> deleteWithResponseAsync(
        String resourceGroupName, String appName, String name, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     * @throws DefaultErrorResponseErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return an application's resiliency policy along with {@link Response} on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<AppResiliencyInner>> getWithResponseAsync(
        String resourceGroupName, String appName, String name) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     * @throws DefaultErrorResponseErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return an application's resiliency policy on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
     ...
     * @throws DefaultErrorResponseErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return an application's resiliency policy along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<AppResiliencyInner> getWithResponse(
        String resourceGroupName, String appName, String name, Context context) {
     ...
     * @throws DefaultErrorResponseErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return an application's resiliency policy.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
     ...
     * @throws DefaultErrorResponseErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return collection of AppResiliency policies along with {@link PagedResponse} on successful completion of {@link
     *     Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
                ...
                context ->
                    service
                        .list(
                            ...
                            accept,
                            context))
            .<PagedResponse<AppResiliencyInner>>map(
                res ->
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<AppResiliencyInner>> listSinglePageAsync(
    ...
    private PagedFlux<AppResiliencyInner> listAsync(String resourceGroupName, String appName) {
        return new PagedFlux<>(
            () -> listSinglePageAsync(resourceGroupName, appName), nextLink -> listNextSinglePageAsync(nextLink));
    }
    ...
    private PagedFlux<AppResiliencyInner> listAsync(String resourceGroupName, String appName, Context context) {
        return new PagedFlux<>(
            () -> listSinglePageAsync(resourceGroupName, appName, context),
