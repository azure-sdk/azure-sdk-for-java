...
public final class LabelHistoryRecordItem implements JsonSerializable<LabelHistoryRecordItem> {
     ...
     */
    private LabelHistoryRecordItemStatus status;
     ...
     */
    public LabelHistoryRecordItemStatus status() {
        return this.status;
    }
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("revision".equals(fieldName)) {
                    ...
                    deserializedLabelHistoryRecordItem.status
                        = LabelHistoryRecordItemStatus.fromString(reader.getString());
                } else {
                    reader.skipChildren();
                }
            }
