...
public final class ManagedEnvironmentsDiagnosticsClientImpl implements ManagedEnvironmentsDiagnosticsClient {
    ...
    private interface ManagedEnvironmentsDiagnosticsService {
        ...
        @Get(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.App"
                + "/managedEnvironments/{name}/detectorproperties/rootApi/")
    ...
    private Mono<Response<ManagedEnvironmentInner>> getRootWithResponseAsync(String resourceGroupName, String name) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ManagedEnvironmentInner> getRootAsync(String resourceGroupName, String name) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ManagedEnvironmentInner getRoot(String resourceGroupName, String name) {
