...
- [ListByManagedEnvironmentResource](#maintenanceconfigurations_listbymanagedenvironmentresource)
...
### MaintenanceConfigurations_ListByManagedEnvironmentResource

```java
/**
 * Samples for MaintenanceConfigurations ListByManagedEnvironmentResource.
 */
public final class MaintenanceConfigurationsListByManagedEnvironmentResourceSamples {
    /*
     * x-ms-original-file: specification/app/resource-manager/Microsoft.App/preview/2024-10-02-preview/examples/
    ...
    public static void managedEnvironmentMaintenanceConfigurationsList(
        com.azure.resourcemanager.appcontainers.ContainerAppsApiManager manager) {
        manager.maintenanceConfigurations()
            .listByManagedEnvironmentResource("rg1", "managedEnv", com.azure.core.util.Context.NONE);
    }
}
```
