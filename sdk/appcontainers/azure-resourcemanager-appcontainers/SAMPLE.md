...
- [CreateOrUpdate](#appspaceresources_createorupdate)
- [Delete](#appspaceresources_delete)
- [Get](#appspaceresources_get)
- [Update](#appspaceresources_update)

## AppSpaces

- [CreateOrUpdate](#appspaces_createorupdate)
- [Delete](#appspaces_delete)
- [GetByResourceGroup](#appspaces_getbyresourcegroup)
- [List](#appspaces_list)
- [ListByResourceGroup](#appspaces_listbyresourcegroup)
- [Update](#appspaces_update)
...
public final class AppResiliencyCreateOrUpdateSamples {
     ...
     */
    public static void createOrUpdateAppResiliency(
        ...
        manager
            ...
            .withHttpRetryPolicy(
                new HttpRetryPolicy()
                    ...
                    .withErrors(
                        Arrays
                            .asList("5xx", "connect-failure", "reset", "retriable-headers", "retriable-status-codes")))
            .withTcpRetryPolicy(new TcpRetryPolicy().withMaxConnectAttempts(3))
            .withCircuitBreakerPolicy(
                new CircuitBreakerPolicy()
                    .withConsecutiveErrors(5)
...
### AppSpaceResources_CreateOrUpdate
...
### AppSpaceResources_Get

```java
/** Samples for AppSpaceResources Get. */
public final class AppSpaceResourcesGetSamples {
    /*
     * x-ms-original-file: specification/app/resource-manager/Microsoft.App/preview/2023-08-01-preview/examples/AppSpaceResources_Get.json
     */
    /**
...
```java
/** Samples for AppSpaces Delete. */
public final class AppSpacesDeleteSamples {
    /*
     * x-ms-original-file: specification/app/resource-manager/Microsoft.App/preview/2023-08-01-preview/examples/AppSpaces_Delete.json
     */
    /**
     * Sample code: Delete App Space.
     *
     * @param manager Entry point to ContainerAppsApiManager.
     */
    public static void deleteAppSpace(com.azure.resourcemanager.appcontainers.ContainerAppsApiManager manager) {
        manager.appSpaces().deleteByResourceGroupWithResponse("rg", "testAppSpace0", com.azure.core.util.Context.NONE);
    }
}
```

### AppSpaces_GetByResourceGroup
...
public final class AppSpacesListSamples {
    /*
     * x-ms-original-file: specification/app/resource-manager/Microsoft.App/preview/2023-08-01-preview/examples/AppSpaces_ListBySubscription.json
     */
    /**
     ...
     * @param manager Entry point to ContainerAppsApiManager.
     */
    public static void listAppSpacesBySubscription(
        com.azure.resourcemanager.appcontainers.ContainerAppsApiManager manager) {
...
### AppSpaces_ListByResourceGroup

```java
/** Samples for AppSpaces ListByResourceGroup. */
public final class AppSpacesListByResourceGroupSamples {
    /*
     * x-ms-original-file: specification/app/resource-manager/Microsoft.App/preview/2023-08-01-preview/examples/AppSpaceResources_ListByAppSpace.json
     */
    /**
     ...
     * @param manager Entry point to ContainerAppsApiManager.
     */
    public static void listAppSpacesByResourceGroup(
        com.azure.resourcemanager.appcontainers.ContainerAppsApiManager manager) {
        manager.appSpaces().listByResourceGroup("rg", "testappSpace0", com.azure.core.util.Context.NONE);
    }

    /*
     * x-ms-original-file: specification/app/resource-manager/Microsoft.App/preview/2023-08-01-preview/examples/AppSpaces_ListByResourceGroup.json
     */
    /**
     * Sample code: List App Spaces by resource group.
     *
...
public final class AppSpacesUpdateSamples {
    /*
     * x-ms-original-file: specification/app/resource-manager/Microsoft.App/preview/2023-08-01-preview/examples/AppSpaces_Patch.json
     */
    /**
     * Sample code: Patch Container App.
     *
    ...
    public static void patchContainerApp(com.azure.resourcemanager.appcontainers.ContainerAppsApiManager manager) {
        AppSpace resource =
            manager.appSpaces().getByResourceGroupWithResponse("rg", null, com.azure.core.util.Context.NONE).getValue();
        resource
            .update()
            .withTags(mapOf("tag1", "value1", "tag2", "value2"))
            .withFriendlyName("Test App Space 0")
                    ...
                    .asList(
                        new ContainerRegistry()
                            ...
                            .withIdentityResourceId(
                                "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.ManagedIdentity/userAssignedIdentities/identity1"),
                        new ContainerRegistry()
                            .withContainerRegistryServer("test2.azurecr.io")
                            .withIdentityResourceId(
                                "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.ManagedIdentity/userAssignedIdentities/identity1")))
            .create();
    }
        ...
        manager
            ...
            .withEncryptionSettings(
                new EncryptionSettings()
                    .withContainerAppAuthEncryptionSecretName("fakeTokenPlaceholder")
...
public final class DaprComponentResiliencyPoliciesDeleteSamples {
     ...
     * @param manager Entry point to ContainerAppsApiManager.
     */
    public static void deleteDaprComponentResiliencyPolicy(
        com.azure.resourcemanager.appcontainers.ContainerAppsApiManager manager) {
        manager
            .daprComponentResiliencyPolicies()
            .deleteWithResponse(
...
public final class DaprComponentResiliencyPoliciesGetSamples {
     ...
     * @param manager Entry point to ContainerAppsApiManager.
     */
    public static void getDaprComponentResiliencyPolicy(
        com.azure.resourcemanager.appcontainers.ContainerAppsApiManager manager) {
        manager
            .daprComponentResiliencyPolicies()
            .getWithResponse(
...
public final class DaprComponentResiliencyPoliciesListSamples {
     ...
     * @param manager Entry point to ContainerAppsApiManager.
     */
    public static void listDaprComponentResiliencyPolicies(
        com.azure.resourcemanager.appcontainers.ContainerAppsApiManager manager) {
        manager
            .daprComponentResiliencyPolicies()
                        ...
                        Arrays
                            .asList(
                                new DaprSubscriptionRouteRule()
                                    .withMatch("event.type == 'widget'")
                                    .withPath("/widgets"),
                                new DaprSubscriptionRouteRule()
                                    .withMatch("event.type == 'gadget'")
                                    .withPath("/gadgets")))
...
public final class JobsGetDetectorSamples {
     ...
     * @param manager Entry point to ContainerAppsApiManager.
     */
    public static void getDiagnosticDataForAContainerAppJob(
        com.azure.resourcemanager.appcontainers.ContainerAppsApiManager manager) {
        manager
            .jobs()
            .getDetectorWithResponse(
                "mikono-workerapp-test-rg", "mikonojob1", "containerappjobnetworkIO", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class ManagedEnvironmentUsagesListSamples {
     ...
     * @param manager Entry point to ContainerAppsApiManager.
     */
    public static void listManagedEnvironmentUsages(
        com.azure.resourcemanager.appcontainers.ContainerAppsApiManager manager) {
