...
```java
import com.azure.resourcemanager.appcontainers.models.BindingType;
import com.azure.resourcemanager.appcontainers.models.CustomDomainAutoGenerated;
    ...
    public static void
        ...
        manager.httpRouteConfigs()
            ...
            .withProperties(new HttpRouteConfigProperties()
                .withCustomDomains(Arrays.asList(new CustomDomainAutoGenerated().withName("example.com")
                    .withBindingType(BindingType.SNI_ENABLED)
                    .withCertificateId(
                ...
                .withRules(Arrays.asList(new HttpRouteRule()
                    .withTargets(Arrays.asList(new HttpRouteTarget().withRevisionName("rev-1").withWeight(100)))
                    .withRoutes(Arrays
...
public final class HttpRouteConfigDeleteSamples {
    /*
     * x-ms-original-file:
     * specification/app/resource-manager/Microsoft.App/preview/2024-08-02-preview/examples/HttpRouteConfig_Delete.json
     */
    /**
     * Sample code: Delete Certificate.
     * 
    ...
    public static void deleteCertificate(com.azure.resourcemanager.appcontainers.ContainerAppsApiManager manager) {
        manager.httpRouteConfigs()
            .deleteWithResponse("examplerg", "testcontainerenv", "test-http-route", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class HttpRouteConfigGetSamples {
    /*
     * x-ms-original-file:
     * specification/app/resource-manager/Microsoft.App/preview/2024-08-02-preview/examples/HttpRouteConfig_Get.json
     */
    /**
