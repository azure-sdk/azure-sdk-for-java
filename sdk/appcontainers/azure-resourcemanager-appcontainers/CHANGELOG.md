...
#### `models.LifecycleConfiguration` was removed

#### `models.LifecycleType` was removed
...
#### `models.SessionPool$Update` was modified

* `withTags(java.util.Map)` was removed

#### `models.DynamicPoolConfiguration` was modified

* `withLifecycleConfiguration(models.LifecycleConfiguration)` was removed
* `lifecycleConfiguration()` was removed
...
* `withCooldownPeriodInSeconds(java.lang.Integer)` was added
* `withExecutionType(models.ExecutionType)` was added
* `cooldownPeriodInSeconds()` was added
* `executionType()` was added
