...
* `scopes()` was removed
* `secretStoreComponent()` was removed
* `ignoreErrors()` was removed
* `version()` was removed
* `componentType()` was removed
* `initTimeout()` was removed
* `secrets()` was removed
...
* `models.DaprComponentProperties` was added
...
* `models.ConnectedEnvironmentDaprComponentProperties` was added
...
* `withProperties(models.DaprComponentProperties)` was added
