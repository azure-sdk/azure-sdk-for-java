...
public final class AzureBareMetalStorageInstanceInner extends Resource {
     ...
     */
    public AzureBareMetalStorageInstanceInner withIdentity(AzureBareMetalStorageInstanceIdentity identity) {
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("id".equals(fieldName)) {
                    ...
                    deserializedAzureBareMetalStorageInstanceInner.identity
