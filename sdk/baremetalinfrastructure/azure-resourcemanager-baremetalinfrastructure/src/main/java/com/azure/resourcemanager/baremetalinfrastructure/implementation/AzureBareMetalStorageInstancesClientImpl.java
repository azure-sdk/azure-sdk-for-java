...
public final class AzureBareMetalStorageInstancesClientImpl implements AzureBareMetalStorageInstancesClient {
    ...
    public interface AzureBareMetalStorageInstancesService {
        ...
        Mono<Response<AzureBareMetalStorageInstanceInner>> update(@HostParam("$host") String endpoint,
            ...
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("azureBareMetalStorageInstanceName") String azureBareMetalStorageInstanceName,
            @BodyParam("application/json") AzureBareMetalStorageInstanceBody azureBareMetalStorageInstanceBodyParameter,
            @HeaderParam("Accept") String accept, Context context);
     ...
     * 
     * Patches the Tags field of a Azure BareMetalStorage instance for the specified subscription, resource group, and
     * instance name.
     * 
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
     * @param azureBareMetalStorageInstanceName Name of the Azure Bare Metal Storage Instance, also known as the
     * ResourceName.
     * @param azureBareMetalStorageInstanceBodyParameter Request body that only contains the Tags and Identity Field.
     * @throws IllegalArgumentException thrown if parameters fail the validation.
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return azureBareMetalStorageInstance info on Azure (ARM properties and AzureBareMetalStorage properties) along
    ...
    private Mono<Response<AzureBareMetalStorageInstanceInner>> updateWithResponseAsync(String resourceGroupName,
        String azureBareMetalStorageInstanceName,
        AzureBareMetalStorageInstanceBody azureBareMetalStorageInstanceBodyParameter) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        if (azureBareMetalStorageInstanceBodyParameter == null) {
            return Mono.error(new IllegalArgumentException(
                "Parameter azureBareMetalStorageInstanceBodyParameter is required and cannot be null."));
        } else {
            azureBareMetalStorageInstanceBodyParameter.validate();
        }
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.update(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, azureBareMetalStorageInstanceName,
                azureBareMetalStorageInstanceBodyParameter, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<AzureBareMetalStorageInstanceInner>> updateWithResponseAsync(String resourceGroupName,
        String azureBareMetalStorageInstanceName,
        AzureBareMetalStorageInstanceBody azureBareMetalStorageInstanceBodyParameter, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service.update(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, azureBareMetalStorageInstanceName, azureBareMetalStorageInstanceBodyParameter, accept,
            context);
    }
    ...
    private Mono<AzureBareMetalStorageInstanceInner> updateAsync(String resourceGroupName,
        String azureBareMetalStorageInstanceName,
        AzureBareMetalStorageInstanceBody azureBareMetalStorageInstanceBodyParameter) {
        return updateWithResponseAsync(resourceGroupName, azureBareMetalStorageInstanceName,
            azureBareMetalStorageInstanceBodyParameter).flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
    ...
    public Response<AzureBareMetalStorageInstanceInner> updateWithResponse(String resourceGroupName,
        ...
        AzureBareMetalStorageInstanceBody azureBareMetalStorageInstanceBodyParameter, Context context) {
        return updateWithResponseAsync(resourceGroupName, azureBareMetalStorageInstanceName,
            azureBareMetalStorageInstanceBodyParameter, context).block();
    }
    ...
    public AzureBareMetalStorageInstanceInner update(String resourceGroupName, String azureBareMetalStorageInstanceName,
        AzureBareMetalStorageInstanceBody azureBareMetalStorageInstanceBodyParameter) {
        return updateWithResponse(resourceGroupName, azureBareMetalStorageInstanceName,
            azureBareMetalStorageInstanceBodyParameter, Context.NONE).getValue();
    }
