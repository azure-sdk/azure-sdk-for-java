 ...
 */
@Immutable
public final class AssessedWebAppV3PropertiesRecommendationsItem
    implements JsonSerializable<AssessedWebAppV3PropertiesRecommendationsItem> {
    /*
     ...
     * The Skus list.
     */
    private List<AssessedWebAppV3PropertiesRecommendationsPropertiesItemsItem> skus;

    /**
     * Creates an instance of AssessedWebAppV3PropertiesRecommendationsItem class.
     */
    public AssessedWebAppV3PropertiesRecommendationsItem() {
    }
     ...
     */
    public List<AssessedWebAppV3PropertiesRecommendationsPropertiesItemsItem> skus() {
        return this.skus;
    }
    ...
    /**
     * Reads an instance of AssessedWebAppV3PropertiesRecommendationsItem from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of AssessedWebAppV3PropertiesRecommendationsItem if the JsonReader was pointing to an
     * instance of it, or null if it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the AssessedWebAppV3PropertiesRecommendationsItem.
     */
    public static AssessedWebAppV3PropertiesRecommendationsItem fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            AssessedWebAppV3PropertiesRecommendationsItem deserializedAssessedWebAppV3PropertiesRecommendationsItem
                = new AssessedWebAppV3PropertiesRecommendationsItem();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("configuration".equals(fieldName)) {
                    deserializedAssessedWebAppV3PropertiesRecommendationsItem.configuration
                        = Configuration.fromJson(reader);
                } else if ("recommendedFor".equals(fieldName)) {
                    deserializedAssessedWebAppV3PropertiesRecommendationsItem.recommendedFor
                        = RecommendedFor.fromJson(reader);
                } else if ("migrationPlatform".equals(fieldName)) {
                    deserializedAssessedWebAppV3PropertiesRecommendationsItem.migrationPlatform
                        = MigrationPlatform.fromString(reader.getString());
                } else if ("confidenceScore".equals(fieldName)) {
                    deserializedAssessedWebAppV3PropertiesRecommendationsItem.confidenceScore
                        = reader.getNullable(JsonReader::getFloat);
                } else if ("migrationSuitability".equals(fieldName)) {
                    deserializedAssessedWebAppV3PropertiesRecommendationsItem.migrationSuitability
                        = MigrationSuitability.fromJson(reader);
                } else if ("securitySuitability".equals(fieldName)) {
                    deserializedAssessedWebAppV3PropertiesRecommendationsItem.securitySuitability
                    ...
                    deserializedAssessedWebAppV3PropertiesRecommendationsItem.totalCost = totalCost;
                    ...
                    deserializedAssessedWebAppV3PropertiesRecommendationsItem.totalSavings = totalSavings;
                    ...
                    deserializedAssessedWebAppV3PropertiesRecommendationsItem.migrationIssues = migrationIssues;
                } else if ("skus".equals(fieldName)) {
                    List<AssessedWebAppV3PropertiesRecommendationsPropertiesItemsItem> skus = reader.readArray(
                        reader1 -> AssessedWebAppV3PropertiesRecommendationsPropertiesItemsItem.fromJson(reader1));
                    deserializedAssessedWebAppV3PropertiesRecommendationsItem.skus = skus;
                } else {
                    reader.skipChildren();
                }
            }

            return deserializedAssessedWebAppV3PropertiesRecommendationsItem;
        });
    }
}
