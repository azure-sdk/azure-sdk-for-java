...
import com.azure.resourcemanager.migration.assessment.models.MachineAssessmentV2ListResult;
 ...
 */
public final class MachineAssessmentsV2OperationsClientImpl implements MachineAssessmentsV2OperationsClient {
    /**
     * The proxy service used to perform REST calls.
     */
    private final MachineAssessmentsV2OperationsService service;
    ...
    /**
     * Initializes an instance of MachineAssessmentsV2OperationsClientImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    MachineAssessmentsV2OperationsClientImpl(MigrationAssessmentManagementClientImpl client) {
        this.service = RestProxy.create(MachineAssessmentsV2OperationsService.class, client.getHttpPipeline(),
            client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for MigrationAssessmentManagementClientMachineAssessmentsV2Operations to
     * be used by the proxy service to perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "MigrationAssessmentM")
    public interface MachineAssessmentsV2OperationsService {
        ...
        Mono<Response<MachineAssessmentV2ListResult>> listByParent(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<MachineAssessmentV2Inner>> get(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("projectName") String projectName,
        ...
        Mono<Response<Flux<ByteBuffer>>> create(@HostParam("$host") String endpoint,
            ...
            @BodyParam("application/json") MachineAssessmentV2Inner resource, @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<MachineAssessmentV2ListResult>> listByParentNext(
     ...
     * @return the response of a MachineAssessmentV2 list operation along with {@link PagedResponse} on successful
     * completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<MachineAssessmentV2Inner>> listByParentSinglePageAsync(String resourceGroupName,
        String projectName) {
        ...
        return FluxUtil
            ...
            .<PagedResponse<MachineAssessmentV2Inner>>map(res -> new PagedResponseBase<>(res.getRequest(),
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the response of a MachineAssessmentV2 list operation as paginated response with {@link PagedFlux}.
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<MachineAssessmentV2Inner> listByParentAsync(String resourceGroupName, String projectName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<MachineAssessmentV2Inner> listByParent(String resourceGroupName, String projectName) {
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a MachineAssessmentV2 along with {@link Response} on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<MachineAssessmentV2Inner>> getWithResponseAsync(String resourceGroupName, String projectName,
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a MachineAssessmentV2 on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<MachineAssessmentV2Inner> getAsync(String resourceGroupName, String projectName,
        String assessmentName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<MachineAssessmentV2Inner> getWithResponse(String resourceGroupName, String projectName,
        String assessmentName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public MachineAssessmentV2Inner get(String resourceGroupName, String projectName, String assessmentName) {
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return machine assessment V2 resource along with {@link Response} on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> createWithResponseAsync(String resourceGroupName, String projectName,
        String assessmentName, MachineAssessmentV2Inner resource) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> createWithResponseAsync(String resourceGroupName, String projectName,
        String assessmentName, MachineAssessmentV2Inner resource, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the {@link PollerFlux} for polling of machine assessment V2 resource.
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<MachineAssessmentV2Inner>, MachineAssessmentV2Inner> beginCreateAsync(
        String resourceGroupName, String projectName, String assessmentName, MachineAssessmentV2Inner resource) {
        Mono<Response<Flux<ByteBuffer>>> mono
            = createWithResponseAsync(resourceGroupName, projectName, assessmentName, resource);
        return this.client.<MachineAssessmentV2Inner, MachineAssessmentV2Inner>getLroResult(mono,
            this.client.getHttpPipeline(), MachineAssessmentV2Inner.class, MachineAssessmentV2Inner.class,
    ...
    private PollerFlux<PollResult<MachineAssessmentV2Inner>, MachineAssessmentV2Inner> beginCreateAsync(
        ...
        return this.client.<MachineAssessmentV2Inner, MachineAssessmentV2Inner>getLroResult(mono,
            this.client.getHttpPipeline(), MachineAssessmentV2Inner.class, MachineAssessmentV2Inner.class, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<MachineAssessmentV2Inner>, MachineAssessmentV2Inner> beginCreate(
        String resourceGroupName, String projectName, String assessmentName, MachineAssessmentV2Inner resource) {
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return machine assessment V2 resource on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<MachineAssessmentV2Inner> createAsync(String resourceGroupName, String projectName,
        String assessmentName, MachineAssessmentV2Inner resource) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public MachineAssessmentV2Inner create(String resourceGroupName, String projectName, String assessmentName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<MachineAssessmentV2Inner>> listByParentNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
