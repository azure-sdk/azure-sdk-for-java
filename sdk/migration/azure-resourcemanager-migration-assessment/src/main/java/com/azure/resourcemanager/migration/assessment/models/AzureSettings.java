...
public final class AzureSettings implements JsonSerializable<AzureSettings> {
     ...
     */
    private Map<String, Float> perYearMigrationCompletionPercentage;
     ...
     */
    public Map<String, Float> perYearMigrationCompletionPercentage() {
     ...
     */
    public AzureSettings
        withPerYearMigrationCompletionPercentage(Map<String, Float> perYearMigrationCompletionPercentage) {
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeMapField("perYearMigrationCompletionPercentage", this.perYearMigrationCompletionPercentage,
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("targetLocation".equals(fieldName)) {
                    ...
                    Map<String, Float> perYearMigrationCompletionPercentage
                        = reader.readMap(reader1 -> reader1.getFloat());
