 ...
 */
public interface WebAppServicePlanV2OperationsClient {
    /**
    ...
    PagedIterable<WebAppServicePlanV2Inner> listByWebAppAssessmentV2(String resourceGroupName, String projectName,
    ...
    Response<WebAppServicePlanV2Inner> getWithResponse(String resourceGroupName, String projectName, String groupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    WebAppServicePlanV2Inner get(String resourceGroupName, String projectName, String groupName, String assessmentName,
