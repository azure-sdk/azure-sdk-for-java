...
public final class CostDetailsCommon implements JsonSerializable<CostDetailsCommon> {
     ...
     */
    private List<CostDetailsCommonCostDetailItem> costDetail;

    /**
     * Creates an instance of CostDetailsCommon class.
     */
    public CostDetailsCommon() {
    }
     ...
     */
    public List<CostDetailsCommonCostDetailItem> costDetail() {
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("savingOptions".equals(fieldName)) {
                    ...
                    List<CostDetailsCommonCostDetailItem> costDetail
                        = reader.readArray(reader1 -> CostDetailsCommonCostDetailItem.fromJson(reader1));
