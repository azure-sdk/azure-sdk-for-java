...
public final class AssessedMachineNetworkAdaptersV3 implements JsonSerializable<AssessedMachineNetworkAdaptersV3> {
     ...
     */
    public AssessedMachineNetworkAdaptersV3() {
    }
     ...
     * @return the AssessedMachineNetworkAdaptersV3 object itself.
     */
    public AssessedMachineNetworkAdaptersV3 withNetGigabytesTransmittedPerMonth(Float netGigabytesTransmittedPerMonth) {
     ...
     * @return the AssessedMachineNetworkAdaptersV3 object itself.
     */
    public AssessedMachineNetworkAdaptersV3 withMacAddress(String macAddress) {
     ...
     * @return the AssessedMachineNetworkAdaptersV3 object itself.
     */
    public AssessedMachineNetworkAdaptersV3 withMegabytesPerSecondRecieved(Float megabytesPerSecondRecieved) {
     ...
     * @return the AssessedMachineNetworkAdaptersV3 object itself.
     */
    public AssessedMachineNetworkAdaptersV3 withMegabytesPerSecondTransmitted(Float megabytesPerSecondTransmitted) {
