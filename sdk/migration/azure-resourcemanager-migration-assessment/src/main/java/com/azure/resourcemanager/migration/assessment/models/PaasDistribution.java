...
public final class PaasDistribution implements JsonSerializable<PaasDistribution> {
     ...
     */
    private Map<String, Integer> webAppDistribution;
     ...
     */
    public Map<String, Integer> webAppDistribution() {
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("sqlServers".equals(fieldName)) {
                    ...
                    Map<String, Integer> webAppDistribution = reader.readMap(reader1 -> reader1.getInt());
