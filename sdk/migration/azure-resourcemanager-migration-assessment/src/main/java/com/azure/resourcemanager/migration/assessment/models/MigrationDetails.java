...
public final class MigrationDetails implements JsonSerializable<MigrationDetails> {
     ...
     */
    private List<MigrationDetailsReadinessSummaryItem> readinessSummary;
     ...
     */
    public List<MigrationDetailsReadinessSummaryItem> readinessSummary() {
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("readinessSummary".equals(fieldName)) {
                    List<MigrationDetailsReadinessSummaryItem> readinessSummary
                        = reader.readArray(reader1 -> MigrationDetailsReadinessSummaryItem.fromJson(reader1));
