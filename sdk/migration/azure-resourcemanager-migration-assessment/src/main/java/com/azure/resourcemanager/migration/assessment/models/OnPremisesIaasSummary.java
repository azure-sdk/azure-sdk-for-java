...
public final class OnPremisesIaasSummary implements JsonSerializable<OnPremisesIaasSummary> {
     ...
     */
    private CarbonEmissionsDetails onPremisesIaasSustainabilityDetails;
    ...
    /**
     * Get the onPremisesIaasSustainabilityDetails property: The on premises Iaas Sustainability details.
     * 
     * @return the onPremisesIaasSustainabilityDetails value.
     */
    public CarbonEmissionsDetails onPremisesIaasSustainabilityDetails() {
        return this.onPremisesIaasSustainabilityDetails;
    }

    /**
     * Get the onPremisesIaasDecommissionedSustainabilityDetails property: The on premises Iaas Sustainability details
     * for Decommissioned.
     * 
     * @return the onPremisesIaasDecommissionedSustainabilityDetails value.
     */
    public CarbonEmissionsDetails onPremisesIaasDecommissionedSustainabilityDetails() {
        return this.onPremisesIaasDecommissionedSustainabilityDetails;
    }
    ...
    public void validate() {
        ...
        if (onPremisesIaasSustainabilityDetails() != null) {
            onPremisesIaasSustainabilityDetails().validate();
        }
        if (onPremisesIaasDecommissionedSustainabilityDetails() != null) {
            onPremisesIaasDecommissionedSustainabilityDetails().validate();
        }
    }
    ...
    public static OnPremisesIaasSummary fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                } else if ("onPremisesIaasSustainabilityDetails".equals(fieldName)) {
                    deserializedOnPremisesIaasSummary.onPremisesIaasSustainabilityDetails
                        = CarbonEmissionsDetails.fromJson(reader);
                } else if ("onPremisesIaasDecommissionedSustainabilityDetails".equals(fieldName)) {
                    deserializedOnPremisesIaasSummary.onPremisesIaasDecommissionedSustainabilityDetails
                        = CarbonEmissionsDetails.fromJson(reader);
                } else {
                    reader.skipChildren();
                }
