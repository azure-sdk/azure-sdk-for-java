...
public final class HypervCollectorsOperationsClientImpl implements HypervCollectorsOperationsClient {
    ...
    public interface HypervCollectorsOperationsService {
        ...
        Mono<Response<HypervCollectorListResult>> listByParent(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<HypervCollectorListResult>> listByParentNext(
    ...
    private Mono<PagedResponse<HypervCollectorInner>> listByParentSinglePageAsync(String resourceGroupName,
        String projectName) {
    ...
    private PagedFlux<HypervCollectorInner> listByParentAsync(String resourceGroupName, String projectName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<HypervCollectorInner> listByParent(String resourceGroupName, String projectName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<HypervCollectorInner>> listByParentNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
