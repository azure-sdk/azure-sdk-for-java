 ...
 */
public interface AvsAssessmentsV2OperationsClient {
    /**
    ...
    PagedIterable<AvsAssessmentV2Inner> listByParent(String resourceGroupName, String projectName);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<AvsAssessmentV2Inner> listByParent(String resourceGroupName, String projectName, Context context);
    ...
    Response<AvsAssessmentV2Inner> getWithResponse(String resourceGroupName, String projectName, String assessmentName,
        Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    AvsAssessmentV2Inner get(String resourceGroupName, String projectName, String assessmentName);
    ...
    SyncPoller<PollResult<AvsAssessmentV2Inner>, AvsAssessmentV2Inner> beginCreate(String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    AvsAssessmentV2Inner create(String resourceGroupName, String projectName, String assessmentName,
