...
public final class ManagementDetails implements JsonSerializable<ManagementDetails> {
     ...
     */
    private List<ManagementDetailsReadinessSummaryItem> readinessSummary;
     ...
     */
    public List<ManagementDetailsReadinessSummaryItem> readinessSummary() {
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("name".equals(fieldName)) {
                    ...
                    List<ManagementDetailsReadinessSummaryItem> readinessSummary
                        = reader.readArray(reader1 -> ManagementDetailsReadinessSummaryItem.fromJson(reader1));
