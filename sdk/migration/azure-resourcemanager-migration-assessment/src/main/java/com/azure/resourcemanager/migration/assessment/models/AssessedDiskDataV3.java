...
public final class AssessedDiskDataV3 implements JsonSerializable<AssessedDiskDataV3> {
     ...
     * @return the AssessedDiskDataV3 object itself.
     */
    public AssessedDiskDataV3 withGigabytesProvisioned(Float gigabytesProvisioned) {
     ...
     * @return the AssessedDiskDataV3 object itself.
     */
    public AssessedDiskDataV3 withMegabytesPerSecondOfRead(Float megabytesPerSecondOfRead) {
     ...
     * @return the AssessedDiskDataV3 object itself.
     */
    public AssessedDiskDataV3 withMegabytesPerSecondOfWrite(Float megabytesPerSecondOfWrite) {
     ...
     * @return the AssessedDiskDataV3 object itself.
     */
    public AssessedDiskDataV3 withNumberOfReadOperationsPerSecond(Float numberOfReadOperationsPerSecond) {
     ...
     * @return the AssessedDiskDataV3 object itself.
     */
    public AssessedDiskDataV3 withNumberOfWriteOperationsPerSecond(Float numberOfWriteOperationsPerSecond) {
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("name".equals(fieldName)) {
                    ...
                    deserializedAssessedDiskDataV3.gigabytesProvisioned = reader.getNullable(JsonReader::getFloat);
                } else if ("megabytesPerSecondOfRead".equals(fieldName)) {
                    deserializedAssessedDiskDataV3.megabytesPerSecondOfRead = reader.getNullable(JsonReader::getFloat);
                } else if ("megabytesPerSecondOfWrite".equals(fieldName)) {
                    deserializedAssessedDiskDataV3.megabytesPerSecondOfWrite = reader.getNullable(JsonReader::getFloat);
