...
import com.azure.resourcemanager.migration.assessment.models.WebAppAssessmentV3ListResult;
...
public final class WebAppAssessmentV3OperationsClientImpl implements WebAppAssessmentV3OperationsClient {
     ...
     */
    private final WebAppAssessmentV3OperationsService service;
    ...
    /**
     * Initializes an instance of WebAppAssessmentV3OperationsClientImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    WebAppAssessmentV3OperationsClientImpl(MigrationAssessmentManagementClientImpl client) {
        this.service = RestProxy.create(WebAppAssessmentV3OperationsService.class, client.getHttpPipeline(),
            client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for MigrationAssessmentManagementClientWebAppAssessmentV3Operations to be
     * used by the proxy service to perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "MigrationAssessmentM")
    public interface WebAppAssessmentV3OperationsService {
        ...
        Mono<Response<WebAppAssessmentV3ListResult>> listByParent(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<WebAppAssessmentV3Inner>> get(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("projectName") String projectName,
        ...
        Mono<Response<Flux<ByteBuffer>>> create(@HostParam("$host") String endpoint,
            ...
            @BodyParam("application/json") WebAppAssessmentV3Inner resource, @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<WebAppAssessmentV3ListResult>> listByParentNext(
     ...
     * @return the response of a WebAppAssessmentV3 list operation along with {@link PagedResponse} on successful
     * completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<WebAppAssessmentV3Inner>> listByParentSinglePageAsync(String resourceGroupName,
        String projectName) {
        ...
        return FluxUtil
            ...
            .<PagedResponse<WebAppAssessmentV3Inner>>map(res -> new PagedResponseBase<>(res.getRequest(),
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the response of a WebAppAssessmentV3 list operation as paginated response with {@link PagedFlux}.
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<WebAppAssessmentV3Inner> listByParentAsync(String resourceGroupName, String projectName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<WebAppAssessmentV3Inner> listByParent(String resourceGroupName, String projectName) {
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a WebAppAssessmentV3 along with {@link Response} on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<WebAppAssessmentV3Inner>> getWithResponseAsync(String resourceGroupName, String projectName,
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a WebAppAssessmentV3 on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<WebAppAssessmentV3Inner> getAsync(String resourceGroupName, String projectName,
        String assessmentName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<WebAppAssessmentV3Inner> getWithResponse(String resourceGroupName, String projectName,
        String assessmentName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public WebAppAssessmentV3Inner get(String resourceGroupName, String projectName, String assessmentName) {
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return webApp assessment resource along with {@link Response} on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> createWithResponseAsync(String resourceGroupName, String projectName,
        String assessmentName, WebAppAssessmentV3Inner resource) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> createWithResponseAsync(String resourceGroupName, String projectName,
        String assessmentName, WebAppAssessmentV3Inner resource, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the {@link PollerFlux} for polling of webApp assessment resource.
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<WebAppAssessmentV3Inner>, WebAppAssessmentV3Inner> beginCreateAsync(
        String resourceGroupName, String projectName, String assessmentName, WebAppAssessmentV3Inner resource) {
        Mono<Response<Flux<ByteBuffer>>> mono
            = createWithResponseAsync(resourceGroupName, projectName, assessmentName, resource);
        return this.client.<WebAppAssessmentV3Inner, WebAppAssessmentV3Inner>getLroResult(mono,
            this.client.getHttpPipeline(), WebAppAssessmentV3Inner.class, WebAppAssessmentV3Inner.class,
    ...
    private PollerFlux<PollResult<WebAppAssessmentV3Inner>, WebAppAssessmentV3Inner> beginCreateAsync(
        ...
        return this.client.<WebAppAssessmentV3Inner, WebAppAssessmentV3Inner>getLroResult(mono,
            this.client.getHttpPipeline(), WebAppAssessmentV3Inner.class, WebAppAssessmentV3Inner.class, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<WebAppAssessmentV3Inner>, WebAppAssessmentV3Inner> beginCreate(
        String resourceGroupName, String projectName, String assessmentName, WebAppAssessmentV3Inner resource) {
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return webApp assessment resource on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<WebAppAssessmentV3Inner> createAsync(String resourceGroupName, String projectName,
        String assessmentName, WebAppAssessmentV3Inner resource) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public WebAppAssessmentV3Inner create(String resourceGroupName, String projectName, String assessmentName,
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return data model of Download URL for assessment report along with {@link Response} on successful completion of
     * {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the {@link PollerFlux} for polling of data model of Download URL for assessment report.
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return data model of Download URL for assessment report on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<WebAppAssessmentV3Inner>> listByParentNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
