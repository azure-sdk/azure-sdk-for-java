...
import com.azure.resourcemanager.migration.assessment.models.SqlAssessmentV3ListResult;
 ...
 */
public final class SqlAssessmentV3OperationsClientImpl implements SqlAssessmentV3OperationsClient {
    /**
     * The proxy service used to perform REST calls.
     */
    private final SqlAssessmentV3OperationsService service;
    ...
    /**
     * Initializes an instance of SqlAssessmentV3OperationsClientImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    SqlAssessmentV3OperationsClientImpl(MigrationAssessmentManagementClientImpl client) {
        this.service = RestProxy.create(SqlAssessmentV3OperationsService.class, client.getHttpPipeline(),
            client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for MigrationAssessmentManagementClientSqlAssessmentV3Operations to be
     * used by the proxy service to perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "MigrationAssessmentM")
    public interface SqlAssessmentV3OperationsService {
        ...
        Mono<Response<SqlAssessmentV3ListResult>> listByParent(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<SqlAssessmentV3Inner>> get(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("projectName") String projectName,
        ...
        Mono<Response<Flux<ByteBuffer>>> create(@HostParam("$host") String endpoint,
            ...
            @BodyParam("application/json") SqlAssessmentV3Inner resource, @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<SqlAssessmentV3ListResult>> listByParentNext(
     ...
     * @return the response of a SqlAssessmentV3 list operation along with {@link PagedResponse} on successful
     * completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<SqlAssessmentV3Inner>> listByParentSinglePageAsync(String resourceGroupName,
        String projectName) {
        ...
        return FluxUtil
            ...
            .<PagedResponse<SqlAssessmentV3Inner>>map(res -> new PagedResponseBase<>(res.getRequest(),
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the response of a SqlAssessmentV3 list operation as paginated response with {@link PagedFlux}.
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<SqlAssessmentV3Inner> listByParentAsync(String resourceGroupName, String projectName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<SqlAssessmentV3Inner> listByParent(String resourceGroupName, String projectName) {
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a SqlAssessmentV3 along with {@link Response} on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<SqlAssessmentV3Inner>> getWithResponseAsync(String resourceGroupName, String projectName,
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a SqlAssessmentV3 on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<SqlAssessmentV3Inner> getAsync(String resourceGroupName, String projectName, String assessmentName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<SqlAssessmentV3Inner> getWithResponse(String resourceGroupName, String projectName,
        String assessmentName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public SqlAssessmentV3Inner get(String resourceGroupName, String projectName, String assessmentName) {
    ...
    private Mono<Response<Flux<ByteBuffer>>> createWithResponseAsync(String resourceGroupName, String projectName,
        String assessmentName, SqlAssessmentV3Inner resource) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> createWithResponseAsync(String resourceGroupName, String projectName,
        String assessmentName, SqlAssessmentV3Inner resource, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    private PollerFlux<PollResult<SqlAssessmentV3Inner>, SqlAssessmentV3Inner> beginCreateAsync(
        String resourceGroupName, String projectName, String assessmentName, SqlAssessmentV3Inner resource) {
        Mono<Response<Flux<ByteBuffer>>> mono
            = createWithResponseAsync(resourceGroupName, projectName, assessmentName, resource);
        return this.client.<SqlAssessmentV3Inner, SqlAssessmentV3Inner>getLroResult(mono, this.client.getHttpPipeline(),
            SqlAssessmentV3Inner.class, SqlAssessmentV3Inner.class, this.client.getContext());
    }
    ...
    private PollerFlux<PollResult<SqlAssessmentV3Inner>, SqlAssessmentV3Inner> beginCreateAsync(
        ...
        return this.client.<SqlAssessmentV3Inner, SqlAssessmentV3Inner>getLroResult(mono, this.client.getHttpPipeline(),
            SqlAssessmentV3Inner.class, SqlAssessmentV3Inner.class, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<PollResult<SqlAssessmentV3Inner>, SqlAssessmentV3Inner> beginCreate(String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<SqlAssessmentV3Inner> createAsync(String resourceGroupName, String projectName, String assessmentName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public SqlAssessmentV3Inner create(String resourceGroupName, String projectName, String assessmentName,
        SqlAssessmentV3Inner resource) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<SqlAssessmentV3Inner>> listByParentNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
