...
public final class AksClusterOperationsClientImpl implements AksClusterOperationsClient {
    ...
    public interface AksClusterOperationsService {
        ...
        Mono<Response<AksClusterListResult>> listByParent(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<AksClusterListResult>> listByParentNext(
    ...
    private Mono<PagedResponse<AksClusterInner>> listByParentSinglePageAsync(String resourceGroupName,
    ...
    private PagedFlux<AksClusterInner> listByParentAsync(String resourceGroupName, String projectName,
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<AksClusterInner> listByParent(String resourceGroupName, String projectName,
        String assessmentName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<AksClusterInner>> listByParentNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<AksClusterInner>> listByParentNextSinglePageAsync(String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        if (this.client.getEndpoint() == null) {
