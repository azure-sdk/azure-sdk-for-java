 ...
 */
@Immutable
public class AssessedWebApp extends WebApp {
    /*
    ...
    /**
     * Creates an instance of AssessedWebApp class.
     */
    public AssessedWebApp() {
    }
    ...
    /**
     * Set the suitabilityResult property: Gets suitability result.
     * 
     * @param suitabilityResult the suitabilityResult value to set.
     * @return the AssessedWebApp object itself.
     */
    AssessedWebApp withSuitabilityResult(SuitabilityResult suitabilityResult) {
        this.suitabilityResult = suitabilityResult;
        return this;
    }
    ...
    /**
     * Set the recommendationResult property: Gets recommendation result.
     * 
     * @param recommendationResult the recommendationResult value to set.
     * @return the AssessedWebApp object itself.
     */
    AssessedWebApp withRecommendationResult(RecommendationResult recommendationResult) {
    ...
    /**
     * Reads an instance of AssessedWebApp from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of AssessedWebApp if the JsonReader was pointing to an instance of it, or null if it was
     * pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the AssessedWebApp.
     */
    public static AssessedWebApp fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            AssessedWebApp deserializedAssessedWebApp = new AssessedWebApp();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("discoveryArmId".equals(fieldName)) {
                    deserializedAssessedWebApp.discoveryArmId = reader.getString();
                } else if ("displayName".equals(fieldName)) {
                    deserializedAssessedWebApp.displayName = reader.getString();
                } else if ("webServerArmId".equals(fieldName)) {
                    deserializedAssessedWebApp.webServerArmId = reader.getString();
                } else if ("webServerDisplayName".equals(fieldName)) {
                    deserializedAssessedWebApp.webServerDisplayName = reader.getString();
                } else if ("machineArmId".equals(fieldName)) {
                    deserializedAssessedWebApp.machineArmId = reader.getString();
                } else if ("machineDisplayName".equals(fieldName)) {
                    deserializedAssessedWebApp.machineDisplayName = reader.getString();
                } else if ("webAppType".equals(fieldName)) {
                    deserializedAssessedWebApp.webAppType = WebAppType.fromString(reader.getString());
                } else if ("suitabilityResult".equals(fieldName)) {
                    deserializedAssessedWebApp.suitabilityResult = SuitabilityResult.fromJson(reader);
                } else if ("recommendationResult".equals(fieldName)) {
                    deserializedAssessedWebApp.recommendationResult = RecommendationResult.fromJson(reader);
                } else {
                    reader.skipChildren();
                }
            }

            return deserializedAssessedWebApp;
        });
    }
}
