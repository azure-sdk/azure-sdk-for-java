...
public final class ScopeType extends ExpandableStringEnum<ScopeType> {
    /**
     * Static value ServerGroupId for ScopeType.
     */
    public static final ScopeType SERVER_GROUP_ID = fromString("ServerGroupId");

    /**
     * Static value AzureResourceGraphQuery for ScopeType.
     */
    public static final ScopeType AZURE_RESOURCE_GRAPH_QUERY = fromString("AzureResourceGraphQuery");
