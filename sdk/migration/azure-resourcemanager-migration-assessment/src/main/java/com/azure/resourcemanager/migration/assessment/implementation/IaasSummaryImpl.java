...
public final class IaasSummaryImpl implements IaasSummary {
    private IaasSummaryInner innerObject;

    private final com.azure.resourcemanager.migration.assessment.MigrationAssessmentManager serviceManager;

    IaasSummaryImpl(IaasSummaryInner innerObject,
    ...
    public IaasSummaryInner innerModel() {
