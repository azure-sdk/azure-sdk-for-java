...
import com.azure.resourcemanager.migration.assessment.models.CompoundAssessmentListResult;
...
public final class CompoundAssessmentOperationsClientImpl implements CompoundAssessmentOperationsClient {
     ...
     */
    CompoundAssessmentOperationsClientImpl(MigrationAssessmentManagementClientImpl client) {
    ...
    /**
     * The interface defining all the services for MigrationAssessmentManagementClientCompoundAssessmentOperations to be
    ...
    public interface CompoundAssessmentOperationsService {
        ...
        Mono<Response<CompoundAssessmentListResult>> listByParent(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<CompoundAssessmentInner>> get(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("projectName") String projectName,
        ...
        Mono<Response<Flux<ByteBuffer>>> create(@HostParam("$host") String endpoint,
            ...
            @BodyParam("application/json") CompoundAssessmentInner resource, @HeaderParam("Accept") String accept,
            Context context);
    ...
    private Mono<Response<Flux<ByteBuffer>>> createWithResponseAsync(String resourceGroupName, String projectName,
        ...
        return FluxUtil
            .withContext(context -> service.create(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, projectName, compoundAssessmentName, resource,
                accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> createWithResponseAsync(String resourceGroupName, String projectName,
        ...
        return service.create(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, projectName, compoundAssessmentName, resource, accept, context);
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> downloadUrlWithResponseAsync(String resourceGroupName, String projectName,
        String compoundAssessmentName, Object body) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return FluxUtil
            .withContext(context -> service.downloadUrl(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, projectName, compoundAssessmentName, body, accept,
                context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> downloadUrlWithResponseAsync(String resourceGroupName, String projectName,
        String compoundAssessmentName, Object body, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    private PollerFlux<PollResult<DownloadUrlInner>, DownloadUrlInner> beginDownloadUrlAsync(String resourceGroupName,
        String projectName, String compoundAssessmentName, Object body) {
        Mono<Response<Flux<ByteBuffer>>> mono
    ...
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    private PollerFlux<PollResult<DownloadUrlInner>, DownloadUrlInner> beginDownloadUrlAsync(String resourceGroupName,
        String projectName, String compoundAssessmentName, Object body, Context context) {
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono
