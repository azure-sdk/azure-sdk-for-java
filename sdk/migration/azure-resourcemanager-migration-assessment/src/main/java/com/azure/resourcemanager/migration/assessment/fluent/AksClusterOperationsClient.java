 ...
 */
public interface AksClusterOperationsClient {
    /**
    ...
    PagedIterable<AksClusterInner> listByParent(String resourceGroupName, String projectName, String assessmentName);
    ...
    Response<AksClusterInner> getWithResponse(String resourceGroupName, String projectName, String assessmentName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    AksClusterInner get(String resourceGroupName, String projectName, String assessmentName, String clusterName);
}
