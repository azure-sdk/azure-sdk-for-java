...
public final class CompoundAssessmentDetails implements JsonSerializable<CompoundAssessmentDetails> {
     ...
     */
    public CompoundAssessmentDetails() {
    }
    ...
    /**
     * Set the createdTimestamp property: Timestamp when the assessment was created.
     * 
     * @param createdTimestamp the createdTimestamp value to set.
     * @return the CompoundAssessmentDetails object itself.
     */
    public CompoundAssessmentDetails withCreatedTimestamp(OffsetDateTime createdTimestamp) {
    ...
    /**
     * Set the updatedTimestamp property: Timestamp when the assessment was last updated.
     * 
     * @param updatedTimestamp the updatedTimestamp value to set.
     * @return the CompoundAssessmentDetails object itself.
     */
    public CompoundAssessmentDetails withUpdatedTimestamp(OffsetDateTime updatedTimestamp) {
    ...
    /**
     * Set the status property: Status of the assessment.
     * 
     * @param status the status value to set.
     * @return the CompoundAssessmentDetails object itself.
     */
    public CompoundAssessmentDetails withStatus(AssessmentStatus status) {
        this.status = status;
        return this;
    }
