 ...
 */
public interface PrivateLinkResourceOperationsClient {
    /**
    ...
    Response<PrivateLinkResourceInner> getWithResponse(String resourceGroupName, String projectName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    PrivateLinkResourceInner get(String resourceGroupName, String projectName, String privateLinkResourceName);
}
