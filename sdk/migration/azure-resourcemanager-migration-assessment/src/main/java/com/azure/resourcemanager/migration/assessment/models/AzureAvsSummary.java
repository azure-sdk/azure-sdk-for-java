...
public final class AzureAvsSummary implements JsonSerializable<AzureAvsSummary> {
     ...
     */
    private CarbonEmissionsDetails azureAvsSustainabilityDetails;
    ...
    /**
     * Get the azureAvsSustainabilityDetails property: The AVS Azure Sustainability Details.
     * 
     * @return the azureAvsSustainabilityDetails value.
     */
    public CarbonEmissionsDetails azureAvsSustainabilityDetails() {
        return this.azureAvsSustainabilityDetails;
    }
    ...
    public void validate() {
        ...
        if (azureAvsSustainabilityDetails() != null) {
            azureAvsSustainabilityDetails().validate();
        }
    }
    ...
    public static AzureAvsSummary fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                } else if ("azureAvsSustainabilityDetails".equals(fieldName)) {
                    deserializedAzureAvsSummary.azureAvsSustainabilityDetails = CarbonEmissionsDetails.fromJson(reader);
                } else {
                    reader.skipChildren();
                }
            }
