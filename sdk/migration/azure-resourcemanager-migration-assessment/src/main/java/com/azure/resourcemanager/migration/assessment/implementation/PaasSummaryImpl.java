...
public final class PaasSummaryImpl implements PaasSummary {
    private PaasSummaryInner innerObject;

    private final com.azure.resourcemanager.migration.assessment.MigrationAssessmentManager serviceManager;

    PaasSummaryImpl(PaasSummaryInner innerObject,
    ...
    public PaasSummaryInner innerModel() {
