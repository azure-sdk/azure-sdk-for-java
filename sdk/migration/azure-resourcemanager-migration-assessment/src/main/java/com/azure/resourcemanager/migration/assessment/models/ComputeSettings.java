...
public final class ComputeSettings implements JsonSerializable<ComputeSettings> {
     ...
     */
    private float computeHardwareMaintenanceCost;

    /*
     * VM Oversubscription Ratio.
     */
    private float vmOversubscriptionRatio;

    /*
     * CPU Oversubscription Ratio.
     */
    private float cpuOversubscriptionRatio;
    ...
    /**
     * Get the computeHardwareMaintenanceCost property: Compute Hardware Maintenance Cost.
     * 
     * @return the computeHardwareMaintenanceCost value.
     */
    public float computeHardwareMaintenanceCost() {
        return this.computeHardwareMaintenanceCost;
    }

    /**
     * Set the computeHardwareMaintenanceCost property: Compute Hardware Maintenance Cost.
     * 
     * @param computeHardwareMaintenanceCost the computeHardwareMaintenanceCost value to set.
     * @return the ComputeSettings object itself.
     */
    public ComputeSettings withComputeHardwareMaintenanceCost(float computeHardwareMaintenanceCost) {
        this.computeHardwareMaintenanceCost = computeHardwareMaintenanceCost;
        return this;
    }

    /**
     * Get the vmOversubscriptionRatio property: VM Oversubscription Ratio.
     * 
     * @return the vmOversubscriptionRatio value.
     */
    public float vmOversubscriptionRatio() {
        return this.vmOversubscriptionRatio;
    }

    /**
     * Set the vmOversubscriptionRatio property: VM Oversubscription Ratio.
     * 
     * @param vmOversubscriptionRatio the vmOversubscriptionRatio value to set.
     * @return the ComputeSettings object itself.
     */
    public ComputeSettings withVmOversubscriptionRatio(float vmOversubscriptionRatio) {
        this.vmOversubscriptionRatio = vmOversubscriptionRatio;
        return this;
    }

    /**
     * Get the cpuOversubscriptionRatio property: CPU Oversubscription Ratio.
     * 
     * @return the cpuOversubscriptionRatio value.
     */
    public float cpuOversubscriptionRatio() {
        return this.cpuOversubscriptionRatio;
    }

    /**
     * Set the cpuOversubscriptionRatio property: CPU Oversubscription Ratio.
     * 
     * @param cpuOversubscriptionRatio the cpuOversubscriptionRatio value to set.
     * @return the ComputeSettings object itself.
     */
    public ComputeSettings withCpuOversubscriptionRatio(float cpuOversubscriptionRatio) {
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeFloatField("computeHardwareMaintenanceCost", this.computeHardwareMaintenanceCost);
        jsonWriter.writeFloatField("vmOversubscriptionRatio", this.vmOversubscriptionRatio);
        jsonWriter.writeFloatField("cpuOversubscriptionRatio", this.cpuOversubscriptionRatio);
    ...
    public static ComputeSettings fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                } else if ("computeHardwareMaintenanceCost".equals(fieldName)) {
                    deserializedComputeSettings.computeHardwareMaintenanceCost = reader.getFloat();
                } else if ("vmOversubscriptionRatio".equals(fieldName)) {
                    deserializedComputeSettings.vmOversubscriptionRatio = reader.getFloat();
                } else if ("cpuOversubscriptionRatio".equals(fieldName)) {
                    deserializedComputeSettings.cpuOversubscriptionRatio = reader.getFloat();
