...
public final class AksAssessmentOperationsImpl implements AksAssessmentOperations {
    ...
    public PagedIterable<AksAssessment> listByAssessmentProject(String resourceGroupName, String projectName) {
    ...
    public PagedIterable<AksAssessment> listByAssessmentProject(String resourceGroupName, String projectName,
        ...
        PagedIterable<AksAssessmentInner> inner = this.serviceClient()
            .listByAssessmentProject(resourceGroupName, projectName, continuationToken, top, filter, totalRecordCount,
                context);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new AksAssessmentImpl(inner1, this.manager()));
    }
