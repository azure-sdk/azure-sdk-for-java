 ...
 */
@Immutable
public final class AzureAppServiceSummary implements JsonSerializable<AzureAppServiceSummary> {
    /*
     ...
     * Distribution by SKU.
     */
    private List<AppServiceSku> distributionBySku;
    ...
    /**
     * Creates an instance of AzureAppServiceSummary class.
     */
    public AzureAppServiceSummary() {
    }
     ...
     */
    public List<AppServiceSku> distributionBySku() {
    ...
    /**
     * Reads an instance of AzureAppServiceSummary from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of AzureAppServiceSummary if the JsonReader was pointing to an instance of it, or null if it
     * was pointing to JSON null.
     * @throws IOException If an error occurs while reading the AzureAppServiceSummary.
     */
    public static AzureAppServiceSummary fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            AzureAppServiceSummary deserializedAzureAppServiceSummary = new AzureAppServiceSummary();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("estimatedCostByOffer".equals(fieldName)) {
                    ...
                    deserializedAzureAppServiceSummary.estimatedCostByOffer = estimatedCostByOffer;
                } else if ("distributionBySku".equals(fieldName)) {
                    List<AppServiceSku> distributionBySku
                        = reader.readArray(reader1 -> AppServiceSku.fromJson(reader1));
                    deserializedAzureAppServiceSummary.distributionBySku = distributionBySku;
                    ...
                    deserializedAzureAppServiceSummary.distributionByApp = distributionByApp;
                } else {
                    reader.skipChildren();
                }
            }

            return deserializedAzureAppServiceSummary;
        });
    }
}
