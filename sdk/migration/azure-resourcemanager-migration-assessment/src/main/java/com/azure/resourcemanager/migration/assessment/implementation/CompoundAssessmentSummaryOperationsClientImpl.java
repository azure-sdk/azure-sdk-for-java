...
import com.azure.resourcemanager.migration.assessment.models.WebAppCompoundAssessmentSummaryListResult;
...
public final class CompoundAssessmentSummaryOperationsClientImpl implements CompoundAssessmentSummaryOperationsClient {
     ...
     */
    CompoundAssessmentSummaryOperationsClientImpl(MigrationAssessmentManagementClientImpl client) {
     ...
     * MigrationAssessmentManagementClientCompoundAssessmentSummaryOperations to be used by the proxy service to perform
     * REST calls.
     */
    @Host("{$host}")
    ...
    public interface CompoundAssessmentSummaryOperationsService {
        ...
        Mono<Response<WebAppCompoundAssessmentSummaryListResult>> listByParent(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<WebAppCompoundAssessmentSummaryInner>> get(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("projectName") String projectName,
