...
public final class OverviewSummaryProperties implements JsonSerializable<OverviewSummaryProperties> {
     ...
     */
    private CarbonEmissionsDetails totalOnPremisesSustainabilityDetails;

    /*
     * The total azure sustainability estimates.
     */
    private CarbonEmissionsDetails totalAzureSustainabilityDetails;
    ...
    /**
     * Get the totalOnPremisesSustainabilityDetails property: The total on-premises sustainability estimates.
     * 
     * @return the totalOnPremisesSustainabilityDetails value.
     */
    public CarbonEmissionsDetails totalOnPremisesSustainabilityDetails() {
        return this.totalOnPremisesSustainabilityDetails;
    }

    /**
     * Get the totalAzureSustainabilityDetails property: The total azure sustainability estimates.
     * 
     * @return the totalAzureSustainabilityDetails value.
     */
    public CarbonEmissionsDetails totalAzureSustainabilityDetails() {
        return this.totalAzureSustainabilityDetails;
    }
    ...
    public void validate() {
        ...
        if (totalOnPremisesSustainabilityDetails() != null) {
            totalOnPremisesSustainabilityDetails().validate();
        }
        if (totalAzureSustainabilityDetails() != null) {
            totalAzureSustainabilityDetails().validate();
        }
    }
    ...
    public static OverviewSummaryProperties fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("totalOnPremisesSustainabilityDetails".equals(fieldName)) {
                    deserializedOverviewSummaryProperties.totalOnPremisesSustainabilityDetails
                        = CarbonEmissionsDetails.fromJson(reader);
                } else if ("totalAzureSustainabilityDetails".equals(fieldName)) {
                    deserializedOverviewSummaryProperties.totalAzureSustainabilityDetails
                        = CarbonEmissionsDetails.fromJson(reader);
                } else if ("totalAzureCost".equals(fieldName)) {
