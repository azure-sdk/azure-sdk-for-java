...
import com.azure.resourcemanager.migration.assessment.models.AssessedWebAppV2ListResult;
import reactor.core.publisher.Mono;

/**
 * An instance of this class provides access to all the operations defined in AssessedWebAppV2OperationsClient.
 */
public final class AssessedWebAppV2OperationsClientImpl implements AssessedWebAppV2OperationsClient {
    /**
     * The proxy service used to perform REST calls.
     */
    private final AssessedWebAppV2OperationsService service;
    ...
    /**
     * Initializes an instance of AssessedWebAppV2OperationsClientImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    AssessedWebAppV2OperationsClientImpl(MigrationAssessmentManagementClientImpl client) {
        this.service = RestProxy.create(AssessedWebAppV2OperationsService.class, client.getHttpPipeline(),
            client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for MigrationAssessmentManagementClientAssessedWebAppV2Operations to be
     * used by the proxy service to perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "MigrationAssessmentM")
    public interface AssessedWebAppV2OperationsService {
        ...
        Mono<Response<AssessedWebAppV2ListResult>> listByWebAppAssessmentV2(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<AssessedWebAppV2Inner>> get(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<AssessedWebAppV2ListResult>> listByWebAppAssessmentV2Next(
     ...
     * @return the response of a AssessedWebAppV2 list operation along with {@link PagedResponse} on successful
     * completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<AssessedWebAppV2Inner>> listByWebAppAssessmentV2SinglePageAsync(String resourceGroupName,
        ...
        return FluxUtil
            ...
            .<PagedResponse<AssessedWebAppV2Inner>>map(res -> new PagedResponseBase<>(res.getRequest(),
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the response of a AssessedWebAppV2 list operation as paginated response with {@link PagedFlux}.
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<AssessedWebAppV2Inner> listByWebAppAssessmentV2Async(String resourceGroupName, String projectName,
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the response of a AssessedWebAppV2 list operation as paginated response with {@link PagedIterable}.
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<AssessedWebAppV2Inner> listByWebAppAssessmentV2(String resourceGroupName, String projectName,
        String groupName, String assessmentName) {
        final String filter = null;
        final Integer pageSize = null;
        final String continuationToken = null;
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a AssessedWebAppV2 along with {@link Response} on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<AssessedWebAppV2Inner>> getWithResponseAsync(String resourceGroupName, String projectName,
        String groupName, String assessmentName, String assessedWebAppName) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return FluxUtil
            .withContext(context -> service.get(this.client.getEndpoint(), this.client.getApiVersion(),
                ...
                assessedWebAppName, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<AssessedWebAppV2Inner>> getWithResponseAsync(String resourceGroupName, String projectName,
        String groupName, String assessmentName, String assessedWebAppName, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service.get(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, projectName, groupName, assessmentName, assessedWebAppName, accept, context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a AssessedWebAppV2 on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<AssessedWebAppV2Inner> getAsync(String resourceGroupName, String projectName, String groupName,
        String assessmentName, String assessedWebAppName) {
        return getWithResponseAsync(resourceGroupName, projectName, groupName, assessmentName, assessedWebAppName)
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a AssessedWebAppV2 along with {@link Response}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<AssessedWebAppV2Inner> getWithResponse(String resourceGroupName, String projectName,
        String groupName, String assessmentName, String assessedWebAppName, Context context) {
        return getWithResponseAsync(resourceGroupName, projectName, groupName, assessmentName, assessedWebAppName,
            context).block();
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return a AssessedWebAppV2.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public AssessedWebAppV2Inner get(String resourceGroupName, String projectName, String groupName,
        String assessmentName, String assessedWebAppName) {
        return getWithResponse(resourceGroupName, projectName, groupName, assessmentName, assessedWebAppName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<AssessedWebAppV2Inner>> listByWebAppAssessmentV2NextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
