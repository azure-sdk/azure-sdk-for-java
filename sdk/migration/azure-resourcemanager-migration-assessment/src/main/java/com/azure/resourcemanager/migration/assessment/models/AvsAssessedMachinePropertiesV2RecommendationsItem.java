 ...
 */
@Fluent
public final class AvsAssessedMachinePropertiesV2RecommendationsItem
    implements JsonSerializable<AvsAssessedMachinePropertiesV2RecommendationsItem> {
    /*
     ...
     * The Skus list.
     */
    private List<AvsAssessedMachinePropertiesV2RecommendationsPropertiesItemsItem> skus;
    ...
    /**
     * Creates an instance of AvsAssessedMachinePropertiesV2RecommendationsItem class.
     */
    public AvsAssessedMachinePropertiesV2RecommendationsItem() {
    }
     ...
     */
    public List<AvsAssessedMachinePropertiesV2RecommendationsPropertiesItemsItem> skus() {
        return this.skus;
    }
     ...
     * @return the AvsAssessedMachinePropertiesV2RecommendationsItem object itself.
     */
    public AvsAssessedMachinePropertiesV2RecommendationsItem
        withFallbackMachineAssessmentArmId(String fallbackMachineAssessmentArmId) {
    ...
    /**
     * Reads an instance of AvsAssessedMachinePropertiesV2RecommendationsItem from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of AvsAssessedMachinePropertiesV2RecommendationsItem if the JsonReader was pointing to an
     * instance of it, or null if it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the AvsAssessedMachinePropertiesV2RecommendationsItem.
     */
    public static AvsAssessedMachinePropertiesV2RecommendationsItem fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            AvsAssessedMachinePropertiesV2RecommendationsItem deserializedAvsAssessedMachinePropertiesV2RecommendationsItem
                = new AvsAssessedMachinePropertiesV2RecommendationsItem();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("configuration".equals(fieldName)) {
                    deserializedAvsAssessedMachinePropertiesV2RecommendationsItem.configuration
                        = Configuration.fromJson(reader);
                } else if ("recommendedFor".equals(fieldName)) {
                    deserializedAvsAssessedMachinePropertiesV2RecommendationsItem.recommendedFor
                        = RecommendedFor.fromJson(reader);
                } else if ("migrationPlatform".equals(fieldName)) {
                    deserializedAvsAssessedMachinePropertiesV2RecommendationsItem.migrationPlatform
                        = MigrationPlatform.fromString(reader.getString());
                } else if ("confidenceScore".equals(fieldName)) {
                    deserializedAvsAssessedMachinePropertiesV2RecommendationsItem.confidenceScore
                        = reader.getNullable(JsonReader::getFloat);
                } else if ("migrationSuitability".equals(fieldName)) {
                    deserializedAvsAssessedMachinePropertiesV2RecommendationsItem.migrationSuitability
                        = MigrationSuitability.fromJson(reader);
                } else if ("securitySuitability".equals(fieldName)) {
                    deserializedAvsAssessedMachinePropertiesV2RecommendationsItem.securitySuitability
                    ...
                    deserializedAvsAssessedMachinePropertiesV2RecommendationsItem.totalCost = totalCost;
                    ...
                    deserializedAvsAssessedMachinePropertiesV2RecommendationsItem.totalSavings = totalSavings;
                    ...
                    deserializedAvsAssessedMachinePropertiesV2RecommendationsItem.migrationIssues = migrationIssues;
                } else if ("skus".equals(fieldName)) {
                    List<AvsAssessedMachinePropertiesV2RecommendationsPropertiesItemsItem> skus = reader.readArray(
                        reader1 -> AvsAssessedMachinePropertiesV2RecommendationsPropertiesItemsItem.fromJson(reader1));
                    deserializedAvsAssessedMachinePropertiesV2RecommendationsItem.skus = skus;
                } else if ("fallbackMachineAssessmentArmId".equals(fieldName)) {
                    deserializedAvsAssessedMachinePropertiesV2RecommendationsItem.fallbackMachineAssessmentArmId
                        = reader.getString();
                } else {
                    reader.skipChildren();
                }
            ...
            return deserializedAvsAssessedMachinePropertiesV2RecommendationsItem;
        });
    }
}
