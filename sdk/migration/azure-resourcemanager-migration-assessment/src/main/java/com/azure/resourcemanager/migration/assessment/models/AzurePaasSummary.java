...
public final class AzurePaasSummary implements JsonSerializable<AzurePaasSummary> {
     ...
     */
    private CarbonEmissionsDetails azurePaasSustainabilityDetails;
    ...
    /**
     * Get the azurePaasSustainabilityDetails property: The Azure PaaS Sustainability Emissions Details.
     * 
     * @return the azurePaasSustainabilityDetails value.
     */
    public CarbonEmissionsDetails azurePaasSustainabilityDetails() {
        return this.azurePaasSustainabilityDetails;
    }
    ...
    public void validate() {
        ...
        if (azurePaasSustainabilityDetails() != null) {
            azurePaasSustainabilityDetails().validate();
        }
    }
    ...
    public static AzurePaasSummary fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                } else if ("azurePaasSustainabilityDetails".equals(fieldName)) {
                    deserializedAzurePaasSummary.azurePaasSustainabilityDetails
