...
public final class AksAssessmentOperationsClientImpl implements AksAssessmentOperationsClient {
    ...
    public interface AksAssessmentOperationsService {
        ...
        Mono<Response<AksAssessmentListResult>> listByParent(@HostParam("$host") String endpoint,
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<AksAssessmentListResult>> listByParentNext(
    ...
    private Mono<PagedResponse<AksAssessmentInner>> listByParentSinglePageAsync(String resourceGroupName,
        String projectName) {
    ...
    private PagedFlux<AksAssessmentInner> listByParentAsync(String resourceGroupName, String projectName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<AksAssessmentInner> listByParent(String resourceGroupName, String projectName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<AksAssessmentInner>> listByParentNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<AksAssessmentInner>> listByParentNextSinglePageAsync(String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        if (this.client.getEndpoint() == null) {
